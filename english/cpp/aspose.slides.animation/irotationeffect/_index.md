...
type: docs
weight: 352
url: /cpp/aspose.slides.animation/irotationeffect/
---
...
| virtual **float** [get_By](./get_by/)() | Describes the relative offset value for the animation. Read **float**. |
| virtual **float** [get_From](./get_from/)() | Describes the starting value for the animation. Read **float**. |
...
| virtual **float** [get_To](./get_to/)() | Describes the ending value for the animation. Read **float**. |
...
| virtual void [set_By](./set_by/)(**float**) | Describes the relative offset value for the animation. Write **float**. |
| virtual void [set_From](./set_from/)(**float**) | Describes the starting value for the animation. Write **float**. |
...
| virtual void [set_To](./set_to/)(**float**) | Describes the ending value for the animation. Write **float**. |
