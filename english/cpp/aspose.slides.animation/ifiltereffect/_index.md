...
type: docs
weight: 261
url: /cpp/aspose.slides.animation/ifiltereffect/
---
## IFilterEffect class
...
| virtual [FilterEffectRevealType](../filtereffectrevealtype/) [get_Reveal](./get_reveal/)() | Represents that effect with behavior must reveal (in/out) Read [FilterEffectRevealType](../filtereffectrevealtype/). |
| virtual [FilterEffectSubtype](../filtereffectsubtype/) [get_Subtype](./get_subtype/)() | Represents subtype of filter effect. Read [FilterEffectSubtype](../filtereffectsubtype/). |
...
| virtual [FilterEffectType](../filtereffecttype/) [get_Type](./get_type/)() | Represents type of filter effect. Read [FilterEffectType](../filtereffecttype/). |
...
| virtual void [set_Reveal](./set_reveal/)([FilterEffectRevealType](../filtereffectrevealtype/)) | Represents that effect with behavior must reveal (in/out) Write [FilterEffectRevealType](../filtereffectrevealtype/). |
| virtual void [set_Subtype](./set_subtype/)([FilterEffectSubtype](../filtereffectsubtype/)) | Represents subtype of filter effect. Write [FilterEffectSubtype](../filtereffectsubtype/). |
...
| virtual void [set_Type](./set_type/)([FilterEffectType](../filtereffecttype/)) | Represents type of filter effect. Write [FilterEffectType](../filtereffecttype/). |
