...
type: docs
weight: 365
url: /cpp/aspose.slides.animation/iscaleeffect/
---
## IScaleEffect class
...
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_To](./get_to/)() | Specifies the target location for an animation scale effect (in percents). Read [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_ZoomContent](./get_zoomcontent/)() | Determines whether a content should be zoomed. Read [NullableBool](../../aspose.slides/nullablebool/). |
...
| virtual void [set_To](./set_to/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Specifies the target location for an animation scale effect (in percents). Write [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_ZoomContent](./set_zoomcontent/)([NullableBool](../../aspose.slides/nullablebool/)) | Determines whether a content should be zoomed. Write [NullableBool](../../aspose.slides/nullablebool/). |
