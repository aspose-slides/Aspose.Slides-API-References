...
type: docs
weight: 144
url: /cpp/aspose.slides.export/igifoptions/
---
## IGifOptions class
...
| virtual **int32_t** [get_DefaultDelay](./get_defaultdelay/)() | Gets default delay time [ms]. This value will be used if the [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/) method was not called. The default value is 1000. |
...
| virtual **bool** [get_ExportHiddenSlides](./get_exporthiddenslides/)() | Determines whether hidden slides will be exported. The default value is false. |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_FrameSize](./get_framesize/)() | Gets frame size. |
...
| virtual **int32_t** [get_TransitionFps](./get_transitionfps/)() | Gets transition FPS [frames/sec] The default value is 25. |
...
| virtual void [set_DefaultDelay](./set_defaultdelay/)(**int32_t**) | Sets default delay time [ms]. This value will be used if the [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/) method was not called. The default value is 1000. |
...
| virtual void [set_ExportHiddenSlides](./set_exporthiddenslides/)(**bool**) | Determines whether hidden slides will be exported. The default value is false. |
| virtual void [set_FrameSize](./set_framesize/)([System::Drawing::Size](../../system.drawing/size/)) | Sets frame size. |
...
| virtual void [set_TransitionFps](./set_transitionfps/)(**int32_t**) | Sets transition FPS [frames/sec] The default value is 25. |
