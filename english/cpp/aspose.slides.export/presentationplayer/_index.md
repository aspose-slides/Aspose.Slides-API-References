...
description: Represents the player of animations associated with the Presentation.
type: docs
weight: 573
url: /cpp/aspose.slides.export/presentationplayer/
---
...
| Method | Description |
| --- | --- |
| void [Dispose](./dispose/)() override | Disposes the instance of the [PresentationPlayer](./). |
...
| **int32_t** [get_FrameIndex](./get_frameindex/)() | Gets the frame index. |
...
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | Creates new instance of the [PresentationPlayer](./). |
...
| Typedef | Description |
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | Represents the frame tick handler of **PresentationPlayer::FrameTick** event. |
## Remarks
