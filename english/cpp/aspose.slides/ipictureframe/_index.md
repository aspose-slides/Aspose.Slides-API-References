...
type: docs
weight: 3069
url: /cpp/aspose.slides/ipictureframe/
---
## IPictureFrame class
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_PictureFormat](./get_pictureformat/)() | Returns the [PictureFillFormat](../picturefillformat/) object for a picture frame. Read-only [IPictureFillFormat](../ipicturefillformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFrameLock](../ipictureframelock/)\> [get_PictureFrameLock](./get_pictureframelock/)() | Returns [PictureFrame](../pictureframe/)'s locks. Read-only [IPictureFrameLock](../ipictureframelock/). |
...
| virtual **float** [get_RelativeScaleHeight](./get_relativescaleheight/)() | Returns the scale of height(relative to original picture size) of the picture frame. Value 1.0 corresponds to 100%. Read **float**. |
| virtual **float** [get_RelativeScaleWidth](./get_relativescalewidth/)() | Returns the scale of width (relative to original picture size) of the picture frame. Value 1.0 corresponds to 100%. Read **float**. |
...
| virtual void [set_RelativeScaleHeight](./set_relativescaleheight/)(**float**) | Sets the scale of height(relative to original picture size) of the picture frame. Value 1.0 corresponds to 100%. Write **float**. |
| virtual void [set_RelativeScaleWidth](./set_relativescalewidth/)(**float**) | Sets the scale of width (relative to original picture size) of the picture frame. Value 1.0 corresponds to 100%. Write **float**. |
