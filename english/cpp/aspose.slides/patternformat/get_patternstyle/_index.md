...
type: docs
weight: 1
url: /cpp/aspose.slides/patternformat/get_patternstyle/
---
## PatternFormat::get_PatternStyle() method


Returns the pattern style. Read [Slides::PatternStyle](../../patternstyle/).

```cpp
Aspose::Slides::PatternStyle Aspose::Slides::PatternFormat::get_PatternStyle() override
```
