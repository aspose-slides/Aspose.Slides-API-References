...
type: docs
weight: 443
url: /cpp/aspose.slides/commonslideviewproperties/
---
...
| void [set_Scale](./set_scale/)(**int32_t**) override | Specifies the view scaling ratio in percentages. Write **int32_t**. |
| void [set_VariableScale](./set_variablescale/)(**bool**) override | Specifies that the view content should automatically scale to best fit the current window size. Write **bool**. |
...
The following example shows how to set the zoom value for slide of PowerPoint [Presentation](../presentation/). 
```cpp
