...
type: docs
weight: 1301
url: /cpp/aspose.slides/iautoshape/
---
## IAutoShape class
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShapeLock](../iautoshapelock/)\> [get_AutoShapeLock](./get_autoshapelock/)() | Returns [AutoShape](../autoshape/)'s locks. Read-only [IAutoShapeLock](../iautoshapelock/). |
...
| virtual **bool** [get_IsTextBox](./get_istextbox/)() | Specifies if the shape is a text box. |
...
| virtual void [set_UseBackgroundFill](./set_usebackgroundfill/)(**bool**) | Determines whether this autoshape should be filled with slide's background fill instead of specified by style or fill format. Write **bool**. |
