...
| Struct | Description |
| --- | --- |
| [SystemInformation](./systeminformation/) | Dummy class to make translated code that uses [SystemInformation](./systeminformation/) class compilable. Methods are not implemented. This is a static type with no instance services. You should never create instances of it by any means. |
## Enums
