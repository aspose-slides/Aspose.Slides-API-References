...
description: "Checks if a type has data() method. If it does, inherits std::true_type, otherwise inherits std::false_type."
type: docs
weight: 1
url: /cpp/system.testpredicates.typetraits/has_data_method/
---
