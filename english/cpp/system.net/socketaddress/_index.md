...
| [Sockets::AddressFamily](../../system.net.sockets/addressfamily/) [get_Family](./get_family/)() | Returns the address family. |
| **int32_t** [get_Size](./get_size/)() | Returns the underlying buffer size. |
...
| **uint8_t** [idx_get](./idx_get/)(**int32_t**) | Gets a value of the underlying buffer at the specified index. |
| void [idx_set](./idx_set/)(**int32_t**, **uint8_t**) | Sets a value of the underlying buffer at the specified index. |
...
|  [SocketAddress](./socketaddress/)([Sockets::AddressFamily](../../system.net.sockets/addressfamily/)) | Constructs a new instance. |
|  [SocketAddress](./socketaddress/)([Sockets::AddressFamily](../../system.net.sockets/addressfamily/), **int32_t**) | Constructs a new instance. |
