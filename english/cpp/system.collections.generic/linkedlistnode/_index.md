...
| [SharedPtr](../../system/sharedptr/)\<[LinkedList](../linkedlist/)\<T\>\> [get_List](./get_list/)() const | Gets containing list. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Next](./get_next/)() const | Gets next node. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Previous](./get_previous/)() const | Gets previous node. |
| T [get_Value](./get_value/)() const | Gets stored value. |
...
| void [set_Value](./set_value/)(const T\&) | Sets stored value. |
