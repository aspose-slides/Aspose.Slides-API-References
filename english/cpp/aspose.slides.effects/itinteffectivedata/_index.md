...
type: docs
weight: 963
url: /cpp/aspose.slides.effects/itinteffectivedata/
---
...
| virtual **float** [get_Amount](./get_amount/)() | Returns effect amount. Read-only **float**. |
| virtual **float** [get_Hue](./get_hue/)() | Returns hue. Read-only **float**. |
