...
type: docs
weight: 1366
url: /cpp/system/weakreference_tmpl_t__end_tmpl/
---
...
| **bool** [operator!=](./operator_not_equal/)(std::nullptr_t) const | Checks if referenced object is not null. |
| **bool** [operator!=](./operator_not_equal/)(const [WeakReference](./weakreference/)\<T\>\&) const | Compares referenced object to another instance WeakReference class. |
...
| **bool** [operator==](./operator_equal_equal/)(std::nullptr_t) const | Checks if referenced object is null. |
| **bool** [operator==](./operator_equal_equal/)(const [WeakReference](./weakreference/)\<T\>\&) const | Compares referenced object to another instance WeakReference class. |
...
| void [reset](./reset/)() |  |
| void [SetTarget](./settarget/)(const [SmartPtr](../smartptr/)\<T\>\&) | Sets the object (the target) referenced by the current WeakReference object. |
...
| **bool** [TryGetTarget](./trygettarget/)(const [SmartPtr](../smartptr/)\<T\>\&) const | Gets the object (the target) referenced by the current WeakReference object. |
...
|  [WeakReference](./weakreference/)(const [SmartPtr](../smartptr/)\<T\>\&) | Initializes a new instance of the WeakReference class, referencing the specified object. |
|  [WeakReference](./weakreference/)(const [SmartPtr](../smartptr/)\<T\>\&, **bool**) | Initializes a new instance of the WeakReference class, referencing the specified object. |
