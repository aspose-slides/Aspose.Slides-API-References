...
type: docs
weight: 365
url: /cpp/system/details_exception/
---
...
| Method | Description |
| --- | --- |
| virtual void [DoThrow](./dothrow/)(const [ExceptionPtr](../exceptionptr/)\&) const | Throws exception instance wrapped by exception wrapper. |
...
| virtual [String](../string/) [get_StackTrace](./get_stacktrace/)() const | Returns the string containing the stack trace. |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](./)\> [GetBaseException](./getbaseexception/)() const | Returns the copy of Exception object representing the inner-most exception. |
...
| void [set_HResult](./set_hresult/)(**int32_t**) | Sets HRESULT, a coded numerical value that is assigned to a specific exception. |
...
| [String](../string/) [ToString](./tostring/)() const override | Returns the string representation of the current object. |
