...
| --- | --- |
| [ChartDataPointCollection(ChartSeries parentImmediate)](#ChartDataPointCollection-com.aspose.slides.ChartSeries-) |  |
## Methods
...
### ChartDataPointCollection(ChartSeries parentImmediate) {#ChartDataPointCollection-com.aspose.slides.ChartSeries-}
```
 ChartDataPointCollection(ChartSeries parentImmediate)
```
