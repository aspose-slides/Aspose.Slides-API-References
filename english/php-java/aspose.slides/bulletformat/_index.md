...
| [setBulletHardColor](setbullethardcolor)(OrderedDictionary) | Determines whether the bullet has own color or inherits it from the first portion in the paragraph. NullableBool.True if bullet has own color and NullableBool.False if bullet inherits color from the first portion in the paragraph. Read/write NullableBool. |
| [setBulletHardColor](setbullethardcolor)(Hashtable) | Determines whether the bullet has own color or inherits it from the first portion in the paragraph. NullableBool.True if bullet has own color and NullableBool.False if bullet inherits color from the first portion in the paragraph. Read/write NullableBool. |
| [setBulletHardColor](setbullethardcolor)(LinkedList) | Determines whether the bullet has own color or inherits it from the first portion in the paragraph. NullableBool.True if bullet has own color and NullableBool.False if bullet inherits color from the first portion in the paragraph. Read/write NullableBool. |
| [setBulletHardFont](setbullethardfont)(OrderedDictionary) | Determines whether the bullet has own font or inherits it from the first portion in the paragraph. NullableBool.True if bullet has own font and NullableBool.False if bullet inherits font from the first portion in the paragraph. Read/write NullableBool. |
| [setBulletHardFont](setbullethardfont)(Hashtable) | Determines whether the bullet has own font or inherits it from the first portion in the paragraph. NullableBool.True if bullet has own font and NullableBool.False if bullet inherits font from the first portion in the paragraph. Read/write NullableBool. |
| [setBulletHardFont](setbullethardfont)(LinkedList) | Determines whether the bullet has own font or inherits it from the first portion in the paragraph. NullableBool.True if bullet has own font and NullableBool.False if bullet inherits font from the first portion in the paragraph. Read/write NullableBool. |
...
| [setNumberedBulletStyle](setnumberedbulletstyle)(OrderedDictionary) | Returns or sets the style of a numbered bullet with no inheritance. Read/write NumberedBulletStyle. |
| [setNumberedBulletStyle](setnumberedbulletstyle)(Hashtable) | Returns or sets the style of a numbered bullet with no inheritance. Read/write NumberedBulletStyle. |
| [setNumberedBulletStyle](setnumberedbulletstyle)(LinkedList) | Returns or sets the style of a numbered bullet with no inheritance. Read/write NumberedBulletStyle. |
| [setType](settype)(OrderedDictionary) | Returns or sets the bullet type of a paragraph with no inheritance. Read/write BulletType. |
| [setType](settype)(Hashtable) | Returns or sets the bullet type of a paragraph with no inheritance. Read/write BulletType. |
| [setType](settype)(LinkedList) | Returns or sets the bullet type of a paragraph with no inheritance. Read/write BulletType. |
