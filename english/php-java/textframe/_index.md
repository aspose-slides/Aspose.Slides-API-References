...
| [highlightRegex](highlightregex)(String, Color, TextHighlightingOptions) | Highlight all matches of regular expression in text frame text using specified color. |
| [highlightText](highlighttext)(String, Color) | Highlight all matches of sample in text frame text using specified color. |
| [highlightText](highlighttext)(String, Color, TextHighlightingOptions) | Highlight all matches of sample in text frame text using specified color. |
