...
| [add](add)(IChartDataCell, int) | Creates new chart series from ChartDataCell and adds it to the collection. |
| [add](add)(IChartCellCollection, int) | Creates new chart series from ChartCellCollection and adds it to the collection. |
...
| [indexOf](indexof)(IChartSeries) | Searches for the specified ChartSeries and returns the zero-based index of the first occurrence within the entire Collection |
