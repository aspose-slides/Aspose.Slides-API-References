...
| Name | Description |
| --- | --- |
| [addClone](addclone)(Column, boolean) | Creates a copy of the specified template row and inserts it at the bottom of a table. |
...
| [insertClone](insertclone)(int, Column, boolean) | Creates a copy of the specified template column and insert it at the specified position in a table. |
