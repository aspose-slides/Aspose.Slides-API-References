...
| [setHtmlFormatter](sethtmlformatter)(HtmlFormatter) | Returns or sets HTML template. Read/write IHtmlFormatter. |
...
| [setSlideImageFormat](setslideimageformat)(SlideImageFormat) | Returns or sets slide image format options. Read/write ISlideImageFormat. |
