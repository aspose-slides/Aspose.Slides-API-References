...
| Name | Description |
| --- | --- |
| [add](add)(ChartDataCell) | If category exists in collection, return it. Else creates new chart category from IChartDataCell and adds it to the collection. |
...
| [indexOf](indexof)(ChartCategory) | Searches for the specified ChartCategory and returns the zero-based index of the first occurrence within the entire Collection. |
...
| [remove](remove)(ChartCategory) | Removes the specified value. |
