...
| Name | Description |
| --- | --- |
| [add](add)(IChartDataCell) | If category exists in collection, return it. Else creates new chart category from IChartDataCell and adds it to the collection. |
...
| [indexOf](indexof)(IChartCategory) | Searches for the specified ChartCategory and returns the zero-based index of the first occurrence within the entire Collection. |
