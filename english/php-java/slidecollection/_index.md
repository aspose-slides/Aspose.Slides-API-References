...
| [addClone](addclone)(ISlide, IMasterSlide, boolean) | Adds a copy of a specified source slide to the end of the collection. Appropriate layout will be selected automatically from the specified master (appropriate layout is the layout with the same Type or Name as of layout of the source slide). If there is no appropriate layout then layout of the source slide will be cloned (if allowCloneMissingLayout is true) or PptxEditException will be thrown (if allowCloneMissingLayout is false). |
...
| [addFromHtml](addfromhtml)(InputStream, IExternalResourceResolver, String) | Creates slides from HTML text and adds them to the end of the collection. |
...
| [insertClone](insertclone)(int, ISlide, IMasterSlide, boolean) | Inserts a copy of a specified source slide to specified position of the collection. Appropriate layout will be selected automatically from the specified master (appropriate layout is the layout with the same Type or Name as of layout of the source slide). If there is no appropriate layout then layout of the source slide will be cloned (if allowCloneMissingLayout is true) or PptxEditException will be thrown (if allowCloneMissingLayout is false). |
...
| [insertFromHtml](insertfromhtml)(int, InputStream, IExternalResourceResolver, String) | Creates slides from HTML text and inserts them to the collection at the specified position. |
