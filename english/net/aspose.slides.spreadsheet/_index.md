...
type: docs
weight: 150
url: /net/aspose.slides.spreadsheet/
---
...
| class [CellInvalidReferenceException](./cellinvalidreferenceexception) | The exception that is thrown when an invalid cell reference is encountered. |
| class [CellUnsupportedDataException](./cellunsupporteddataexception) | The exception that is thrown when an unsupported data is encountered in a spreadsheet cell. |
