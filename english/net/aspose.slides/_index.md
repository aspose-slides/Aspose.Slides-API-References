...
| class [Comment](./comment) | Represents a comment on a slide. |
| class [CommentAuthor](./commentauthor) | Represents an author of comments. |
| class [CommentAuthorCollection](./commentauthorcollection) | Represents a collection of comment authors. |
| class [CommentCollection](./commentcollection) | Represents a collection of comments of one author. |
| class [CommonSlideViewProperties](./commonslideviewproperties) | Represents common slide view properties. |
| class [Connector](./connector) | Represents a connector. |
| class [ConnectorLock](./connectorlock) | Determines which operations are disabled on the parent Connector. |
...
| class [FontFallBackRulesCollection](./fontfallbackrulescollection) | Represents a collection of FontFallBack rules, defined by user |
| class [Fonts](./fonts) | Fonts collection. |
...
| class [GradientStopEffectiveData](./gradientstopeffectivedata) | Immutable object which represents a gradient stop. |
| class [GraphicalObject](./graphicalobject) | Represents abstract graphical object. |
| class [GraphicalObjectLock](./graphicalobjectlock) | Determines which operations are disabled on the parent GraphicalObject. |
...
| interface [IAnimationTimeLine](./ianimationtimeline) | Represents timeline of animation. |
| interface [IAudio](./iaudio) | Represents an embedded audio file. |
| interface [IAudioCollection](./iaudiocollection) | Represents a collection of embedded audio files. |
| interface [IAudioFrame](./iaudioframe) | Represents an audio clip on a slide. |
| interface [IAutoShape](./iautoshape) | Represents an AutoShape. |
| interface [IAutoShapeLock](./iautoshapelock) | Determines which operations are disabled on the parent AutoshapeEx. |
| interface [IBackdrop3DScene](./ibackdrop3dscene) | Defines a plane in which effects, such as glow and shadow, are applied in relation to the shape they are being applied to. |
| interface [IBackground](./ibackground) | Represents background of a slide. |
| interface [IBackgroundEffectiveData](./ibackgroundeffectivedata) | Immutable object which contains effective background properties. |
| interface [IBaseHandoutNotesSlideHeaderFooterManag](./ibasehandoutnotesslideheaderfootermanag) | Represents manager which holds behavior of the placeholders, including header placeholder for all types handout and notes slides. |
| interface [IBaseHeaderFooterManager](./ibaseheaderfootermanager) | Represents manager which holds behavior of the footer, date-time, page number placeholders for all slide types. |
| interface [IBasePortionFormat](./ibaseportionformat) | This class contains the text portion formatting properties. Unlike [`IPortionFormatEffectiveData`](aspose.slides/iportionformateffectivedata), all properties of this class are writeable. |
| interface [IBasePortionFormatEffectiveData](./ibaseportionformateffectivedata) | Base interface for immutable objects which contain effective text portion formatting properties. |
| interface [IBaseShapeLock](./ibaseshapelock) | Represents Shape lock (disabled operation). |
| interface [IBaseSlide](./ibaseslide) | Represents common data for all slide types. |
| interface [IBaseSlideHeaderFooterManager](./ibaseslideheaderfootermanager) | Represents manager which holds behavior of the footer, date-time, page number placeholders for all slide types. |
| interface [IBaseTableFormatEffectiveData](./ibasetableformateffectivedata) | Base interface for immutable objects which contain effective table formatting properties. |
| interface [IBlobManagementOptions](./iblobmanagementoptions) | A Binary Large Object (BLOB) is a binary data stored as a single entity - i.e. BLOB can be an audio, video or presentation itself. A number of techniques are used to optimize memory consumption while working with BLOBs - which was already stored in the presentation or be added later programmatically. Using [`IBlobManagementOptions`](aspose.slides/iblobmanagementoptions) you can change a different behavior aspects regarding BLOBs handling for the [`IPresentation`](aspose.slides/ipresentation) instance lifetime. |
| interface [IBulkTextFormattable](./ibulktextformattable) | Represents an object with possibility of bulk setting child text elements' formats. |
| interface [IBulletFormat](./ibulletformat) | Represents paragraph bullet formatting properties. |
| interface [IBulletFormatEffectiveData](./ibulletformateffectivedata) | Immutable object which contains effective paragraph bullet formatting properties. |
| interface [ICamera](./icamera) | Represents Camera. |
| interface [ICameraEffectiveData](./icameraeffectivedata) | Immutable object which contains effective camera properties. |
| interface [ICell](./icell) | Represents a cell in a table. |
| interface [ICellCollection](./icellcollection) | Represents a collection of cells. |
| interface [ICellFormat](./icellformat) | Represents format of a table cell. |
| interface [ICellFormatEffectiveData](./icellformateffectivedata) | Immutable object which contains effective table cell formatting properties. |
| interface [IColorFormat](./icolorformat) | Represents a color used in a presentation. |
| interface [IColorOperation](./icoloroperation) | Represents different color operations used for color transformations. |
| interface [IColorOperationCollection](./icoloroperationcollection) | Represents a collection of color transform operations. |
| interface [IColumn](./icolumn) | Represents a column in a table. |
| interface [IColumnCollection](./icolumncollection) | Represents collection of columns in a table. |
| interface [IColumnFormat](./icolumnformat) | Represents format of a table column. |
| interface [IColumnFormatEffectiveData](./icolumnformateffectivedata) | Immutable object which contains effective table column formatting properties. |
| interface [IComment](./icomment) | Represents a comment on a slide. |
| interface [ICommentAuthor](./icommentauthor) | Represents an author of comments. |
| interface [ICommentAuthorCollection](./icommentauthorcollection) | Represents a collection of comment authors. |
| interface [ICommentCollection](./icommentcollection) | Represents a collection of comments of one author. |
| interface [ICommonSlideViewProperties](./icommonslideviewproperties) | Represents common slide view properties. |
| interface [IConnector](./iconnector) | Represents a connector. |
| interface [IConnectorLock](./iconnectorlock) | Determines which operations are disabled on the parent Connector. |
| interface [IControl](./icontrol) | Represents an ActiveX control. |
| interface [IControlCollection](./icontrolcollection) | A collection of ActiveX controls. |
| interface [IControlPropertiesCollection](./icontrolpropertiescollection) | A collection of ActiveX controls. |
| interface [ICustomData](./icustomdata) | Represents container for custom data. |
| interface [ICustomXmlPart](./icustomxmlpart) | Represents custom xml part. |
| interface [ICustomXmlPartCollection](./icustomxmlpartcollection) | Represents collection of custom xml parts. |
| interface [IDigitalSignature](./idigitalsignature) | Digital signature in signed file. |
| interface [IDigitalSignatureCollection](./idigitalsignaturecollection) | Represents a collection of digital signatures attached to a document. |
| interface [IDocumentProperties](./idocumentproperties) | Represents properties of a presentation. |
| interface [IEffectFormat](./ieffectformat) | Represents effect properties of shape. |
| interface [IEffectFormatEffectiveData](./ieffectformateffectivedata) | Imutable object which contains effective effect formatting properties. |
| interface [IEffectParamSource](./ieffectparamsource) | Auxiliary effect parameters interface. |
| interface [IField](./ifield) | Represents a field. |
| interface [IFieldType](./ifieldtype) | Represents a type of field. This value determines which text will be set to the field portion when it will be updated. |
| interface [IFillFormat](./ifillformat) | Represents a fill formatting options. |
| interface [IFillFormatEffectiveData](./ifillformateffectivedata) | Immutable object which contains effective fill formatting properties. |
| interface [IFillParamSource](./ifillparamsource) | Auxiliary fill parameters interface. |
| interface [IFontData](./ifontdata) | Represents a font definition. |
| interface [IFontDataFactory](./ifontdatafactory) | FontData factory interface |
| interface [IFontFallBackRule](./ifontfallbackrule) | Represents font fallback rule |
| interface [IFontFallBackRulesCollection](./ifontfallbackrulescollection) | Represents a collection of FontFallBack rules, defined by user |
| interface [IFonts](./ifonts) | Represents fonts collection. |
| interface [IFontsEffectiveData](./ifontseffectivedata) | Immutable object which contains effective fonts set. |
| interface [IFontsLoader](./ifontsloader) | Class for loading custom fonts defined by user. Should be used before creating any presentation objects. |
| interface [IFontsManager](./ifontsmanager) | Manages fonts across the presentation. |
| interface [IFontSources](./ifontsources) | Provides file and memory sources for external fonts. |
| interface [IFontSubstRule](./ifontsubstrule) | Represents font subtituition information |
| interface [IFontSubstRuleCollection](./ifontsubstrulecollection) | Represents collection of fonts substitution. |
| interface [IFormatFactory](./iformatfactory) | Allows to create formats via COM interface. |
| interface [IGenericCloneable&lt;T&gt;](./igenericcloneable-1) | Represents generic version of ICloneable |
| interface [IGenericCollection&lt;T&gt;](./igenericcollection-1) | Auxiliary generic collection interface. |
| interface [IGeometryPath](./igeometrypath) | Represents geometry path of GeometryShape |
| interface [IGeometryShape](./igeometryshape) | Represents the parent class for all geometric shapes. |
| interface [IGlobalLayoutSlideCollection](./igloballayoutslidecollection) | Represents a collection of all layout slides in presentation. Extends ILayoutSlideCollection interface with methods for adding/cloning layout slides in context of uniting of the individual collections of master's layout slides. |
| interface [IGradientFormat](./igradientformat) | Represent a gradient format. |
| interface [IGradientFormatEffectiveData](./igradientformateffectivedata) | Imutable object which contains effective gradient filling properties. |
| interface [IGradientStop](./igradientstop) | Represents a gradient format. |
| interface [IGradientStopCollection](./igradientstopcollection) | Represnts a collection of gradient stops. |
| interface [IGradientStopCollectionEffectiveData](./igradientstopcollectioneffectivedata) | Represents a collection of GradientStopDataEx objects. |
| interface [IGradientStopEffectiveData](./igradientstopeffectivedata) | immutable object which represents a gradient stop. |
| interface [IGraphicalObject](./igraphicalobject) | Represents abstract graphical object. |
| interface [IGraphicalObjectLock](./igraphicalobjectlock) | Determines which operations are disabled on the parent GraphicalObjectEx. |
| interface [IGroupShape](./igroupshape) | Represents a group of shapes on a slide. |
| interface [IGroupShapeLock](./igroupshapelock) | Determines which operations are disabled on the parent GroupShape. |
| interface [IHyperlink](./ihyperlink) | Represents a hyperlink. |
| interface [IHyperlinkContainer](./ihyperlinkcontainer) | Represents hyperlink object. |
| interface [IHyperlinkManager](./ihyperlinkmanager) | Provide hyperlinks management (adding, removing). |
| interface [IHyperlinkQueries](./ihyperlinkqueries) | Provide easy access to contained hyperlinks. |
| interface [IImageCollection](./iimagecollection) | Represents collection of PPImage. |
| interface [IImageWrapper](./iimagewrapper) | System.Drawing.Image wrapper for COM interface. |
| interface [IImageWrapperFactory](./iimagewrapperfactory) | This interface allows to initialize IBitmapWrapper. |
| interface [IInterruptionToken](./iinterruptiontoken) | This class represents the token to use for signaling long running tasks whether the interruption was requested. |
| interface [IInterruptionTokenSource](./iinterruptiontokensource) | Represents the source of [`IInterruptionToken`](aspose.slides/iinterruptiontoken). |
| interface [ILayoutSlide](./ilayoutslide) | Represents a layout slide. |
| interface [ILayoutSlideCollection](./ilayoutslidecollection) | Represents a base class for collection of a layout slides. |
| interface [ILayoutSlideHeaderFooterManager](./ilayoutslideheaderfootermanager) | Represents manager which holds behavior of the layout slide footer, date-time, page number placeholders and all child placeholders. Child placeholders mean placeholders are contained on depending slides. Depending slides use and depend on layout slide. |
| interface [ILegacyDiagram](./ilegacydiagram) | Represents a legacy diagram object |
| interface [ILicense](./ilicense) | Provides methods to license the component. |
| interface [ILightRig](./ilightrig) | Represents LightRig. |
| interface [ILightRigEffectiveData](./ilightrigeffectivedata) | Immutable object which contains effective light rig properties. |
| interface [ILineFillFormat](./ilinefillformat) | Represents properties for lines filling. |
| interface [ILineFillFormatEffectiveData](./ilinefillformateffectivedata) | Immutable object which contains effective line filling properties. |
| interface [ILineFormat](./ilineformat) | Represents format of a line. |
...
| interface [IMasterLayoutSlideCollection](./imasterlayoutslidecollection) | Represents a collections of all layout slides of defined master slide. Extends ILayoutSlideCollection interface with methods for adding/inserting/removing/cloning layout slides in context of the individual collections of master's layout slides. |
| interface [IMasterNotesSlide](./imasternotesslide) | Represents master slide for notes. |
...
| interface [IMasterNotesSlideManager](./imasternotesslidemanager) | Master notes slide manager. |
| interface [IMasterSlide](./imasterslide) | Represents a master slide in a presentation. |
| interface [IMasterSlideCollection](./imasterslidecollection) | Represents a collection of master slides. |
| interface [IMasterSlideHeaderFooterManager](./imasterslideheaderfootermanager) | Represents manager which holds behavior of the master slide footer, date-time, page number placeholders and all child placeholders. Child placeholders mean placeholders are contained on depending layout slides and depending slides. Depending layout slides and slides use and depend on master slide. |
| interface [IMetered](./imetered) | Provides methods to set metered key. |
| interface [IModernComment](./imoderncomment) | Represents a comment on a slide. |
| interface [INormalViewProperties](./inormalviewproperties) | Represents normal view properties. The normal view consists of three content regions: the slide itself, a side content region, and a bottom content region. |
| interface [INormalViewRestoredProperties](./inormalviewrestoredproperties) | Specifies the sizing of the slide region ((width when a child of restoredTop, height when a child of restoredLeft) of the normal view, when the region is of a variable restored size(neither minimized nor maximized). |
| interface [INotesSize](./inotessize) | Represents a size of notes slide. |
...
| interface [IParagraphCollection](./iparagraphcollection) | Represents a collection of a paragraphs. |
| interface [IParagraphFactory](./iparagraphfactory) | Allows to create paragraphs |
| interface [IParagraphFormat](./iparagraphformat) | This class contains the paragraph formatting properties. Unlike [`IParagraphFormatEffectiveData`](aspose.slides/iparagraphformateffectivedata), all properties of this class are writeable. |
| interface [IParagraphFormatEffectiveData](./iparagraphformateffectivedata) | Immutable object which contains effective paragraph formatting properties. |
| interface [IPathSegment](./ipathsegment) | Represents segment of graphics path of GeometryShape |
| interface [IPatternFormat](./ipatternformat) | Represents a pattern to fill a shape. |
| interface [IPatternFormatEffectiveData](./ipatternformateffectivedata) | Immutable object which contains effective pattern filling properties. |
| interface [IPictureEffectiveData](./ipictureeffectivedata) | Immutable object which contains effective picture properties. |
| interface [IPictureFillFormat](./ipicturefillformat) | Represents a picture fill style. |
| interface [IPictureFillFormatEffectiveData](./ipicturefillformateffectivedata) | Immutable object which contains the properties of picture fill. |
| interface [IPictureFrame](./ipictureframe) | Represents a frame with a picture inside. |
| interface [IPictureFrameLock](./ipictureframelock) | Determines which operations are disabled on the parent PictureFrameEx. |
| interface [IPlaceholder](./iplaceholder) | Represents a placeholder on a slide. |
| interface [IPortion](./iportion) | Represents a portion of text inside a text paragraph. |
| interface [IPortionCollection](./iportioncollection) | Represents a collection of a portions. |
| interface [IPortionFactory](./iportionfactory) | Allows to create test portions |
| interface [IPortionFormat](./iportionformat) | This class contains the text portion formatting properties. Unlike [`IPortionFormatEffectiveData`](aspose.slides/iportionformateffectivedata), all properties of this class are writeable. |
| interface [IPortionFormatEffectiveData](./iportionformateffectivedata) | Immutable object which contains effective text portion formatting properties. |
| interface [IPPImage](./ippimage) | Represents an image in a presentation. |
| interface [IPresentation](./ipresentation) | Presentation document |
| interface [IPresentationComponent](./ipresentationcomponent) | Represents a component of a presentation. |
| interface [IPresentationFactory](./ipresentationfactory) | Allows to create presentation via COM interface |
| interface [IPresentationHeaderFooterManager](./ipresentationheaderfootermanager) | Represents manager which holds behavior of all footer, date-time and page number placeholders of presentation. |
| interface [IPresentationInfo](./ipresentationinfo) | Information about presentation file |
| interface [IPresentationText](./ipresentationtext) | Represents the text extracted from the slide |
| interface [IProgressCallback](./iprogresscallback) | Represents a callback object for saving progress updates in percentage. |
| interface [IProtectionManager](./iprotectionmanager) | Presentation password protestion management. |
| interface [IResourceLoadingArgs](./iresourceloadingargs) | Interface for external resource loading arguments. |
| interface [IResourceLoadingCallback](./iresourceloadingcallback) | Callback interface used to manage external resources loading. |
| interface [IRow](./irow) | Represents a row in a table. |
| interface [IRowCollection](./irowcollection) | Represents table row collection. |
| interface [IRowFormat](./irowformat) | Represents format of a table row. |
| interface [IRowFormatEffectiveData](./irowformateffectivedata) | Immutable object which contains effective table row formatting properties. |
| interface [ISection](./isection) | Represents section of slides. |
| interface [ISectionCollection](./isectioncollection) | Represents a collection of sections. |
| interface [ISectionSlideCollection](./isectionslidecollection) | Represents a collection of a slides in the section. |
| interface [ISectionZoomFrame](./isectionzoomframe) | Represents a Section Zoom object in a slide. |
| interface [IShape](./ishape) | Represents a shape on a slide. |
| interface [IShapeBevel](./ishapebevel) | Represents properties of shape's main face relief. |
| interface [IShapeBevelEffectiveData](./ishapebeveleffectivedata) | Immutable object which contains effective shape's face relief properties. |
| interface [IShapeCollection](./ishapecollection) | Represents a collection of a shapes. |
| interface [IShapeElement](./ishapeelement) | Represents a part of shape with same outline and fill properties. |
| interface [IShapeFrame](./ishapeframe) | Represents shape frame's properties. |
| interface [IShapeStyle](./ishapestyle) | Represent shape's style reference. |
| interface [ISketchFormat](./isketchformat) | Represents properties for lines sketch format. |
| interface [ISketchFormatEffectiveData](./isketchformateffectivedata) | Immutable object which contains effective line sketch properties. |
| interface [ISlide](./islide) | Represents a slide in a presentation. |
| interface [ISlideCollection](./islidecollection) | Represents a collection of a slides. |
| interface [ISlideComponent](./islidecomponent) | Represents a component of a slide. |
| interface [ISlideHeaderFooterManager](./islideheaderfootermanager) | Represents manager which holds behavior of the slide footer, date-time, page number placeholders. |
| interface [ISlideShowTransition](./islideshowtransition) | Represents slide show transition. |
| interface [ISlideSize](./islidesize) | Represents a size of slide. |
| interface [ISlidesPicture](./islidespicture) | Represents a picture in a presentation. |
| interface [ISlideText](./islidetext) | Represents the text extracted from the slide |
| interface [ISpreadsheetOptions](./ispreadsheetoptions) | Represents options which can be used to specify additional spreadsheets behavior. |
| interface [IStreamWrapper](./istreamwrapper) | Aspose.IO.Stream wrapper for COM interface. |
| interface [IStreamWrapperFactory](./istreamwrapperfactory) | Factory of StreamWrappers. For COM interface. |
| interface [ISummaryZoomFrame](./isummaryzoomframe) | Represents a Summary Zoom frame in a slide. |
| interface [ISummaryZoomSection](./isummaryzoomsection) | Represents a Summary Zoom Section object in a Summary Zoom frame. |
| interface [ISummaryZoomSectionCollection](./isummaryzoomsectioncollection) | Represents a collection of Summary Zoom Section objects. |
| interface [ISvgImage](./isvgimage) | Represents an SVG image. |
| interface [ITab](./itab) | Represents a tabulation for a text. |
| interface [ITabCollection](./itabcollection) | Represents a collection of tabs. |
| interface [ITabEffectiveData](./itabeffectivedata) | Immutable object which contains effective text's tabulation stop properties. |
| interface [ITabFactory](./itabfactory) | Allow to create ITab instances |
| interface [ITable](./itable) | Represents a table on a slide. |
| interface [ITableFormat](./itableformat) | Represents format of a table. |
| interface [ITableFormatEffectiveData](./itableformateffectivedata) | Immutable object which contains effective table formatting properties. |
| interface [ITagCollection](./itagcollection) | Represents the collection of tags (user defined pairs of strings) |
| interface [ITextFrame](./itextframe) | Represents a TextFrame. |
| interface [ITextFrameFormat](./itextframeformat) | Contains the TextFrame's formatting properties. |
| interface [ITextFrameFormatEffectiveData](./itextframeformateffectivedata) | Immutable object which contains effective text frame formatting properties. |
| interface [ITextHighlightingOptions](./itexthighlightingoptions) | Represents options which can be used to highlight text in text frame. |
| interface [ITextStyle](./itextstyle) | Text style formatting properties. |
| interface [ITextStyleEffectiveData](./itextstyleeffectivedata) | Immutable object which contains effective text style properties. |
| interface [IThreeDFormat](./ithreedformat) | Represents 3-D properties. |
| interface [IThreeDFormatEffectiveData](./ithreedformateffectivedata) | Immutable object which represents effective 3-D formatting properties. |
| interface [IThreeDParamSource](./ithreedparamsource) | 3D properties source auxiliary interface |
| interface [IVideo](./ivideo) | Represents a video embedded into a presentation. |
| interface [IVideoCollection](./ivideocollection) | Represents a collection of Video objects. |
| interface [IVideoFrame](./ivideoframe) | Represents a video clip on a slide. |
...
| enum [LineArrowheadStyle](./linearrowheadstyle) | Represents the style of an arrowhead. |
