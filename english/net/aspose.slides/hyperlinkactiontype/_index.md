...
| JumpNextSlide | `4` | Jubp to the next slide. |
...
| JumpSpecificSlide | `8` | Jump to the specific slide, referred by [`TargetSlide`](../ihyperlink/targetslide) property. |
| StartCustomSlideShow | `9` | Start custom slideshow. |
| OpenFile | `10` | Open referrenced file. |
| OpenPresentation | `11` | Open referrenced presentation. |
