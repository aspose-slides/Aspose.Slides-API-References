...
| [Presentation](presentation) { get; } | Returns the parent presentation of a cell. Read-only [`IPresentation`](../ipresentation). |
...
| [Slide](slide) { get; } | Returns the parent slide of a cell. Read-only [`IBaseSlide`](../ibaseslide). |
