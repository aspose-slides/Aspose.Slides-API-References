...
type: docs
weight: 6760
url: /net/aspose.slides/islidesize/
---
...
| [SetSize](setsize)(…) | Sets the type of slide size and scales content using scale type. Assigning any value except Custom will change [`Size`](./size) accordingly, but will keep [`Orientation`](./orientation) intact. (2 methods) |
