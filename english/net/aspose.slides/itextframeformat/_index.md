...
| [KeepTextFlat](keeptextflat) { get; set; } | Returns or set keeping text out of 3D scene entirely. Read/write Boolean. |
...
| [TextStyle](textstyle) { get; } | Returns text's style. Read-only [`ITextStyle`](../itextstyle). |
