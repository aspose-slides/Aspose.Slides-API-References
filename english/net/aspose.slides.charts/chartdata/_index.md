...
| [DataSourceType](datasourcetype) { get; } | Represents external workbook path if external data source, null otherwise |
| [ExternalWorkbookPath](externalworkbookpath) { get; } | Represents data source of the chart |
