...
| [InvertedSolidFillColor](invertedsolidfillcolor) { get; } | Specifies invert solid color for series. To apply color setting set series format FillType to FillType.Solid. Read/write [`ColorFormat`](../../aspose.slides/colorformat). |
...
| [Marker](marker) { get; } | Marker. Read-only [`IMarker`](../imarker). |
| [Name](name) { get; } | Return series name. Read-only [`IStringChartValue`](../istringchartvalue). |
| [NumberFormatOfBubbleSizes](numberformatofbubblesizes) { get; set; } | NumberFormatOfBubbleSizes. Read/write String. |
| [NumberFormatOfValues](numberformatofvalues) { get; set; } | NumberFormatOfValues. Read/write String. |
| [NumberFormatOfXValues](numberformatofxvalues) { get; set; } | NumberFormatOfXValues. Read/write String. |
| [NumberFormatOfYValues](numberformatofyvalues) { get; set; } | NumberFormatOfYValues. Read/write String. |
...
| [ParentSeriesGroup](parentseriesgroup) { get; } | ParentSeriesGroup. Read-only [`IChartSeriesGroup`](../ichartseriesgroup). |
...
| [PlotOnSecondAxis](plotonsecondaxis) { get; set; } | Indicates if this series is plotted on secondary axis. Read/write Boolean. |
...
| [ShowMeanLine](showmeanline) { get; set; } | Represents mean line. True if mean line are shown on the BoxAndWhisker chart. Applies only to BoxAndWhisker charts. Read/write Boolean. |
