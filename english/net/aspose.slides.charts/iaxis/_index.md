...
| [ShowMajorGridLines](showmajorgridlines) { get; } | Represents if the major gridlines showed. Read-only Boolean. |
| [ShowMinorGridLines](showminorgridlines) { get; } | Represents if the minor gridlines showed. Read-only Boolean. |
...
| [TickLabelSpacing](ticklabelspacing) { get; set; } | Specifies how many tick labels to skip between label that is drawn. Read/write UInt32. |
