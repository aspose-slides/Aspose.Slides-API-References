...
description: Creates the new data point and adds it to the end of collection. Applicable for series which chartType is one of Bubble subtypes see also IsChartTypeBubbleaspose.slides.charts/charttypecharacterizer/ischarttypebubble method.
type: docs
weight: 130
