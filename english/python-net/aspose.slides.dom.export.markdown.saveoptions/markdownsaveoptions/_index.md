...
type: docs
weight: 10
url: /python-net/aspose.slides.dom.export.markdown.saveoptions/markdownsaveoptions/
---
...
|flavor|Specifies markdown specification to convert presentation.<br/>            Default is|

### See Also

* namespace [aspose.slides.dom.export.markdown.saveoptions](/slides/python-net/aspose.slides.dom.export.markdown.saveoptions/)
