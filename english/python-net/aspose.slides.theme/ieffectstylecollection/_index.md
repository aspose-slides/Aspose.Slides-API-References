...
type: docs
weight: 150
url: /python-net/aspose.slides.theme/ieffectstylecollection/
---
...
| Name | Description |
| :- | :- |
|[index]|Returns an element at specified position.<br/>            Read-only [IEffectStyle](/slides/python-net/aspose.slides.theme/ieffectstyle/).|
