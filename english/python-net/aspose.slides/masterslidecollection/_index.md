...
type: docs
weight: 3080
url: /python-net/aspose.slides/masterslidecollection/
---
...
| Name | Description |
| :- | :- |
|[index]|Gets the element at the specified index.<br/>            Read-only [MasterSlide](/slides/python-net/aspose.slides/masterslide/).|
## Methods
| Name | Description |
| :- | :- |
