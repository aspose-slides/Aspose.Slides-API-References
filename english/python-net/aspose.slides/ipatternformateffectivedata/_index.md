...
type: docs
weight: 2100
url: /python-net/aspose.slides/ipatternformateffectivedata/
---
...
| Name | Description |
| :- | :- |
|pattern_style|Returns the pattern style.<br/>            Read-only [PatternStyle](/slides/python-net/aspose.slides/patternstyle/).|
