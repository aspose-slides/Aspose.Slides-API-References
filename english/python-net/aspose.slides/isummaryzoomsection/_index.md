...
type: docs
weight: 2610
url: /python-net/aspose.slides/isummaryzoomsection/
---
...
|target_section|Gets or sets the section object that the Section Zoom object is linked to.<br/>            Read/write [ISection](/slides/python-net/aspose.slides/isection/).|
|as_i_zoom_object|Returns IZoomObject interface.|
|image_type|Gets or sets the image type of a zoom object.<br/>            Read/write [ZoomImageType](/slides/python-net/aspose.slides/zoomimagetype/).<br/>            Default value: Preview|
...
|image|Gets or sets image for zoom object.<br/>            Read/write [IPPImage](/slides/python-net/aspose.slides/ippimage/).|
