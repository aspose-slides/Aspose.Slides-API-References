...
|header_footer_manager|Returns HeaderFooter manager of the master notes slide.<br/>            Read-only [IMasterHandoutSlideHeaderFooterManager](/slides/python-net/aspose.slides/imasterhandoutslideheaderfootermanager/).|
...
|notes_style|Returns the style of a notes text.<br/>            Read-only [ITextStyle](/slides/python-net/aspose.slides/itextstyle/).|
