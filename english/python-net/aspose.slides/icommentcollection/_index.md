...
type: docs
weight: 1160
url: /python-net/aspose.slides/icommentcollection/
---
...
| Name | Description |
| :- | :- |
|[index]|Gets the element at the specified index.<br/>            Read-only [IComment](/slides/python-net/aspose.slides/icomment/).|
## Methods
| Name | Description |
| :- | :- |
