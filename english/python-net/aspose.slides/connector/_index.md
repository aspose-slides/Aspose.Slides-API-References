...
type: docs
weight: 360
url: /python-net/aspose.slides/connector/
---
...
|shape_type|Returns or sets the AutoShape type.<br/>            Read/write [ShapeType](/slides/python-net/aspose.slides/shapetype/).|
...
|connector_lock|Returns connector's locks.<br/>            Read-only [IConnectorLock](/slides/python-net/aspose.slides/iconnectorlock/).|
|start_shape_connected_to|Returns or sets the shape to attach the beginning of the connector to.<br/>            Read/write [IShape](/slides/python-net/aspose.slides/ishape/).|
|end_shape_connected_to|Returns or sets the shape to attach the end of the connector to.<br/>            Read/write [IShape](/slides/python-net/aspose.slides/ishape/).|
