...
type: docs
weight: 1200
url: /python-net/aspose.slides/icontrol/
---
...
|substitute_picture_format|Returns ControlEx image fill properties object.<br/>            Read-only [IPictureFillFormat](/slides/python-net/aspose.slides/ipicturefillformat/).|
|frame|Returns or sets control's frame.<br/>            Read/write [IShapeFrame](/slides/python-net/aspose.slides/ishapeframe/).|
|properties|Returns a collection of ActiveX properties.<br/>            Read-only [IControlPropertiesCollection](/slides/python-net/aspose.slides/icontrolpropertiescollection/).|
