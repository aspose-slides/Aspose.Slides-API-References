...
type: docs
weight: 2070
url: /python-net/aspose.slides/iparagraphformateffectivedata/
---
...
| Name | Description |
| :- | :- |
|bullet|Returns a bullet format of a paragraph.<br/>            Read-only [IBulletFormatEffectiveData](/slides/python-net/aspose.slides/ibulletformateffectivedata/).|
|depth|Returns a depth of a paragraph.<br/>            Read-only int.|
|alignment|Returns the text alignment in a paragraph.<br/>            Read-only [TextAlignment](/slides/python-net/aspose.slides/textalignment/).|
...
|tabs|Returns tabulations of a paragraph.<br/>            Read-only [ITabEffectiveData](/slides/python-net/aspose.slides/itabeffectivedata/)[].|
|font_alignment|Returns a font alignment in a paragraph.<br/>            Read-only [FontAlignment](/slides/python-net/aspose.slides/fontalignment/).|
|default_portion_format|Returns default portion format of a paragraph.<br/>            Read-only [IPortionFormatEffectiveData](/slides/python-net/aspose.slides/iportionformateffectivedata/).|
