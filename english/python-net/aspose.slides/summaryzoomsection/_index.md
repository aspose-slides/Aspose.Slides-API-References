...
type: docs
weight: 3840
url: /python-net/aspose.slides/summaryzoomsection/
---
...
|target_section|Gets or sets the section object that the Section Zoom object links to.<br/>            Read/write [ISection](/slides/python-net/aspose.slides/isection/).|
