...
type: docs
weight: 1890
url: /python-net/aspose.slides/imasternotesslide/
---
...
| Name | Description |
| :- | :- |
|header_footer_manager|Returns HeaderFooter manager of the master notes slide.<br/>            Read-only [IMasterNotesSlideHeaderFooterManager](/slides/python-net/aspose.slides/imasternotesslideheaderfootermanager/).|
