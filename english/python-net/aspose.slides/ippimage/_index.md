...
type: docs
weight: 2050
url: /python-net/aspose.slides/ippimage/
---
...
|content_type|Returns a MIME type of an image, encoded in [binary_data](/slides/python-net/aspose.slides/ippimage/).<br/>            Read-only string.|
