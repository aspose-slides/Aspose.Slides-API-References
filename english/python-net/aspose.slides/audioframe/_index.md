...
type: docs
weight: 50
url: /python-net/aspose.slides/audioframe/
---
...
|volume|Returns or sets the audio volume.<br/>            Read/write [AudioVolumeMode](/slides/python-net/aspose.slides/audiovolumemode/).|
|play_mode|Returns or sets the audio play mode.<br/>            Read/write [AudioPlayModePreset](/slides/python-net/aspose.slides/audioplaymodepreset/).|
...
|embedded_audio|Returns or sets embedded audio object.<br/>            Read/write [IAudio](/slides/python-net/aspose.slides/iaudio/).|
