...
type: docs
weight: 3350
url: /python-net/aspose.slides/pictureframe/
---
...
|shape_lock|Returns shape's locks.<br/>            Read-only [IPictureFrameLock](/slides/python-net/aspose.slides/ipictureframelock/).|
...
|picture_frame_lock|Returns shape's locks.<br/>            Read-only [IPictureFrameLock](/slides/python-net/aspose.slides/ipictureframelock/).|
|picture_format|Returns the PictureFillFormat object for a picture frame.<br/>            Read-only [IPictureFillFormat](/slides/python-net/aspose.slides/ipicturefillformat/).|
