...
type: docs
weight: 1570
url: /python-net/aspose.slides/igraphicalobjectlock/
---
...
|as_i_base_shape_lock|Allows to get base IBaseShapeLock interface.<br/>            Read-only [IBaseShapeLock](/slides/python-net/aspose.slides/ibaseshapelock/).|
