...
type: docs
weight: 860
url: /python-net/aspose.slides/ibackground/
---
...
|style_color|Returns a ColorFormat for a BackgroundType.Themed fill.<br/>            Read-only [IColorFormat](/slides/python-net/aspose.slides/icolorformat/).|
