...
type: docs
weight: 3320
url: /python-net/aspose.slides/picturefillformat/
---
...
|picture_fill_mode|Returns or sets the picture fill mode.<br/>            Read/write [PictureFillMode](/slides/python-net/aspose.slides/picturefillmode/).|
|picture|Returns the picture.<br/>            Read-only [ISlidesPicture](/slides/python-net/aspose.slides/islidespicture/).|
