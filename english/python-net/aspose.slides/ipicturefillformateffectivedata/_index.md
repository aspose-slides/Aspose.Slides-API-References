...
type: docs
weight: 2160
url: /python-net/aspose.slides/ipicturefillformateffectivedata/
---
...
|picture_fill_mode|Returns the picture fill mode.<br/>            Read-only [PictureFillMode](/slides/python-net/aspose.slides/picturefillmode/).|
|picture|Returns the picture.<br/>            Read-only [IPictureEffectiveData](/slides/python-net/aspose.slides/ipictureeffectivedata/).|
