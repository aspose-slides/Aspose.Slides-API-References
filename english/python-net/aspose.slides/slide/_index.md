...
type: docs
weight: 3730
url: /python-net/aspose.slides/slide/
---
...
|slide_number|Returns a number of slide.<br/>            Index of slide in [slides](/slides/python-net/aspose.slides/presentation/) collection is always equal to SlideNumber - Presentation.FirstSlideNumber.<br/>            Read/write|
