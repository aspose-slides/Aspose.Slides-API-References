...
type: docs
weight: 1650
url: /python-net/aspose.slides/iimagewrapper/
---
...
| Name | Description |
| :- | :- |
|image|Gets the Syste.Drawing.Image<br/>            Read-only [image](/slides/python-net/aspose.slides/iimagewrapper/).|
|size|Gets the width and height, in pixels, of the Image<br/>            Read-only [size](/slides/python-net/aspose.slides/iimagewrapper/).|
