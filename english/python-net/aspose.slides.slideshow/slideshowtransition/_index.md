...
type: docs
weight: 320
url: /python-net/aspose.slides.slideshow/slideshowtransition/
---
...
| Name | Description |
| :- | :- |
|sound|Returns or sets the embedded audio data.<br/>            Read/write [IAudio](/slides/python-net/aspose.slides/iaudio/).|
...
|type|Type of transition.<br/>            Read/write [TransitionType](/slides/python-net/aspose.slides.slideshow/transitiontype/).|
...
|sound_name|Specifies a human readable name for the sound of the transition. The [sound](/slides/python-net/aspose.slides.slideshow/slideshowtransition/) property must be assigned to get or set the sound name.<br/>            Read-write string.|
