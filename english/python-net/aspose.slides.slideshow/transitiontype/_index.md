...
type: docs
weight: 470
url: /python-net/aspose.slides.slideshow/transitiontype/
---
...
|WIPE||
|ZOOM|Relates to transition Shape (with options In/Out) in PowerPoint 2010.<br/>            See also [WARP](/slides/python-net/aspose.slides.slideshow/transitiontype/) that relates to transition Zoom in PowerPoint 2010.|
