...
type: docs
weight: 350
url: /python-net/aspose.slides.export/itexttohtmlconversionoptions/
---
...
|text_inheritance_limit|Returns or sets inhering depth for text properties.<br/>            Read/write [text_inheritance_limit](/slides/python-net/aspose.slides.export/itexttohtmlconversionoptions/).|
|link_embed_controller|Returns or sets a callback object which controlls how external object will be stored.<br/>            Read/write [ILinkEmbedController](/slides/python-net/aspose.slides.export/ilinkembedcontroller/).|
