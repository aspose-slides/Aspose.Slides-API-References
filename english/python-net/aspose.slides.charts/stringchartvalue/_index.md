...
type: docs
weight: 1040
url: /python-net/aspose.slides.charts/stringchartvalue/
---
...
|as_cells|Null value assigning is not allowed.<br/>            Returning value always is not null.<br/>            Read/write [IChartCellCollection](/slides/python-net/aspose.slides.charts/ichartcellcollection/).|
