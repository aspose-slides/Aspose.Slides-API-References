...
type: docs
weight: 70
url: /python-net/aspose.slides.charts/chart/
---
...
|text_format|Returns chart text format.<br/>            The property is not applicable for the following types: [TREEMAP](/slides/python-net/aspose.slides.charts/charttype/), [SUNBURST](/slides/python-net/aspose.slides.charts/charttype/),<br/>            [WATERFALL](/slides/python-net/aspose.slides.charts/charttype/), [HISTOGRAM](/slides/python-net/aspose.slides.charts/charttype/), [FUNNEL](/slides/python-net/aspose.slides.charts/charttype/),[BOX_AND_WHISKER](/slides/python-net/aspose.slides.charts/charttype/).<br/>            Read-only [IChartTextFormat](/slides/python-net/aspose.slides.charts/icharttextformat/).|
|theme_manager|Returns theme manager.<br/>            Read-only [IOverrideThemeManager](/slides/python-net/aspose.slides.theme/ioverridethememanager/).|
...
|as_i_themeable|Allows to get base IThemeable interface.<br/>            Read-only [IThemeable](/slides/python-net/aspose.slides.theme/ithemeable/).|
