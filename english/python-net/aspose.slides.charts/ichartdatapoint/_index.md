...
type: docs
weight: 530
url: /python-net/aspose.slides.charts/ichartdatapoint/
---
...
| Name | Description |
| :- | :- |
|x_value|Returns the x value of chart data point.<br/>            Read-only [IStringOrDoubleChartValue](/slides/python-net/aspose.slides.charts/istringordoublechartvalue/).|
|y_value|Returns the y value of chart data point.<br/>            Read-only [IDoubleChartValue](/slides/python-net/aspose.slides.charts/idoublechartvalue/).|
|bubble_size|Returns the bubble size of chart data point.<br/>            Read-only [IDoubleChartValue](/slides/python-net/aspose.slides.charts/idoublechartvalue/).|
|value|Returns the value of chart data point.<br/>            Read-only [IDoubleChartValue](/slides/python-net/aspose.slides.charts/idoublechartvalue/).|
...
|label|Represents the lable of chart data point.<br/>            Read-only [IDataLabel](/slides/python-net/aspose.slides.charts/idatalabel/).|
