...
type: docs
weight: 350
url: /python-net/aspose.slides.charts/datatable/
---
...
| Name | Description |
| :- | :- |
|format|Returns the line, fill, and effect styles of an object.<br/>            Read-only [IFormat](/slides/python-net/aspose.slides.charts/iformat/).|
...
|chart|Returns chart.<br/>            Read-only [IChart](/slides/python-net/aspose.slides.charts/ichart/).|
