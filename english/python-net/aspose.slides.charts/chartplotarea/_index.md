...
type: docs
weight: 220
url: /python-net/aspose.slides.charts/chartplotarea/
---
...
| Name | Description |
| :- | :- |
|format|Returns the format of a plot area.<br/>            Read-only [IFormat](/slides/python-net/aspose.slides.charts/iformat/).|
...
|chart|Chart.<br/>            Read-only [IChart](/slides/python-net/aspose.slides.charts/ichart/).|
