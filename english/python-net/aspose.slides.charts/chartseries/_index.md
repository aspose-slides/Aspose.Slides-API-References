...
type: docs
weight: 240
url: /python-net/aspose.slides.charts/chartseries/
---
...
|parent_series_group|ParentSeriesGroup.<br/>            Read-only [IChartSeriesGroup](/slides/python-net/aspose.slides.charts/ichartseriesgroup/).|
...
|marker|Marker.<br/>            Read-only [IMarker](/slides/python-net/aspose.slides.charts/imarker/).|
...
|inverted_solid_fill_color|Specifies invert solid color for series. To apply color setting set series format FillType to FillType.Solid.<br/>            Read/write [ColorFormat](/slides/python-net/aspose.slides/colorformat/).|
