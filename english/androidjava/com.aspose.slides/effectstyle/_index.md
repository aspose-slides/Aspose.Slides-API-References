...
Returns an effect format. Read-only [IEffectFormat](../../com.aspose.slides/ieffectformat).
...
Returns an 3d format. Read-only [IThreeDFormat](../../com.aspose.slides/ithreedformat).
