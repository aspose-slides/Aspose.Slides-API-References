...
type: docs
weight: 933
url: /androidjava/com.aspose.slides/inormalviewrestoredproperties/
---```
...
| Method | Description |
| --- | --- |
| [getDimensionSize()](#getDimensionSize--) | Specifies the size of the slide region (width when a child of RestoredTop, height when a child of RestoredLeft). |
