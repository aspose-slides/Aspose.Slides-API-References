...
type: docs
weight: 8180
url: /de/net/aspose.slides.mathtext/mathnaryoperator/
---
...
| [GrowToMatchOperandHeight](../../aspose.slides.mathtext/mathnaryoperator/growtomatchoperandheight) { get; set; } | Operatorzeichen wächst vertikal, um seiner Operandenhöhe zu entsprechen |
| [HideSubscript](../../aspose.slides.mathtext/mathnaryoperator/hidesubscript) { get; set; } | Hide Subscript |
| [HideSuperscript](../../aspose.slides.mathtext/mathnaryoperator/hidesuperscript) { get; set; } | Hochgestellt ausblenden |
| [LimitLocation](../../aspose.slides.mathtext/mathnaryoperator/limitlocation) { get; set; } | Die Position der Grenzen (tiefgestellt und hochgestellt) |
| [Operator](../../aspose.slides.mathtext/mathnaryoperator/operator) { get; set; } | Nary Operator Character Zum Beispiel: '∑', '∫' |
| [Subscript](../../aspose.slides.mathtext/mathnaryoperator/subscript) { get; } | Gibt ein tiefgestelltes Argument an, das beispielsweise bei einem Integral die untere Grenze festlegt |
| [Superscript](../../aspose.slides.mathtext/mathnaryoperator/superscript) { get; } | Gibt ein Superscript-Argument an, das beispielsweise bei einem Integral die Obergrenze festlegt |
...
| [GetChildren](../../aspose.slides.mathtext/mathnaryoperator/getchildren)() | Holen Sie sich untergeordnete Elemente |
