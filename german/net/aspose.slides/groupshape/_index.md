...
type: docs
weight: 4650
url: /de/net/aspose.slides/groupshape/
---
## GroupShape class
...
| [AsIShape](../../aspose.slides/groupshape/asishape) { get; } | Ermöglicht das Abrufen der Basis-IShape-Schnittstelle. Schreibgeschützt[`IShape`](../ishape) . |
...
| override [LineFormat](../../aspose.slides/groupshape/lineformat) { get; } | Gibt das LineFormat-Objekt zurück, das Linienformatierungseigenschaften für eine Form enthält. Hinweis: Gibt null für GroupShape-Objekte zurück, da sie keine Linieneigenschaften haben. Schreibgeschützt[`ILineFormat`](../ilineformat) . |
...
| [ShapeLock](../../aspose.slides/groupshape/shapelock) { get; } | Gibt die Sperren der Form zurück. Schreibgeschützt[`IGroupShapeLock`](../igroupshapelock) . (2 properties) |
