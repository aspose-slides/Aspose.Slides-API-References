...
description: Stellt ein älteres Diagrammobjekt dar.
type: docs
weight: 7000
url: /de/net/aspose.slides/legacydiagram/
---
## LegacyDiagram class

Stellt ein älteres Diagrammobjekt dar.
...
| [AsIGraphicalObject](../../aspose.slides/legacydiagram/asigraphicalobject) { get; } | Ermöglicht das Abrufen der IGraphicalObject-Basisschnittstelle. Schreibgeschützt[`IGraphicalObject`](../igraphicalobject) . |
...
| [ConvertToGroupShape](../../aspose.slides/legacydiagram/converttogroupshape)() | Konvertiert ein altes Diagramm in eine bearbeitbare Gruppenform. Das erstellte GroupShape-Objekt wird der Form der übergeordneten Gruppe an derselben Position hinzugefügt. |
| [ConvertToSmartArt](../../aspose.slides/legacydiagram/converttosmartart)() | Konvertiert Legacy-Diagramm in bearbeitbares SmartArt-Objekt. Das erstellte SmartArt-Objekt wird der Form der übergeordneten Gruppe an derselben Position hinzugefügt. |
