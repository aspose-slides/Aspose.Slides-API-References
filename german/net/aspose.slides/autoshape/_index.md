...
type: docs
weight: 800
url: /de/net/aspose.slides/autoshape/
---
## AutoShape class
...
| [AutoShapeLock](../../aspose.slides/autoshape/autoshapelock) { get; } | Gibt die Sperren der automatischen Form zurück. Schreibgeschützt[`IAutoShapeLock`](../iautoshapelock) . |
...
| [ShapeLock](../../aspose.slides/autoshape/shapelock) { get; } | Gibt die Sperren der Form zurück. Schreibgeschützt[`IAutoShapeLock`](../iautoshapelock) . (2 properties) |
...
| [TextFrame](../../aspose.slides/autoshape/textframe) { get; } | Gibt TextFrame-Objekt für die AutoForm zurück. Schreibgeschützt[`ITextFrame`](../itextframe) . |
...
| [UseBackgroundFill](../../aspose.slides/autoshape/usebackgroundfill) { get; set; } | Legt fest, ob diese automatische Form mit der Hintergrundfüllung der Folie gefüllt werden soll, anstatt durch Stil oder Füllformat angegeben zu werden. Lesen/SchreibenBoolean . |
...
| virtual [AddTextFrame](../../aspose.slides/autoshape/addtextframe)(string) | Fügt einer Form einen neuen TextFrame hinzu. Wenn die Form bereits über TextFrame verfügt, ändert sie einfach ihren Text. |
