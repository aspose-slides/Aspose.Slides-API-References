...
description: Fügen Sie einen AudioFrame mit eingebetteter Audiodatei ein. Eingebetteter AudiodateiSound kann nur eine WAVDatei sein. Es fügt der Presentation.AudiosListe neues Audio hinzu.
type: docs
weight: 230
url: /de/net/aspose.slides/ishapecollection/insertaudioframeembedded/
---
## InsertAudioFrameEmbedded(int, float, float, float, float, Stream) {#insertaudioframeembedded_1}

Fügen Sie einen AudioFrame mit eingebetteter Audiodatei ein. Eingebetteter Audiodatei-Sound kann nur eine WAV-Datei sein. Es fügt der Presentation.Audios-Liste neues Audio hinzu.
