...
type: docs
weight: 770
url: /de/net/aspose.slides/audioframe/
---
## AudioFrame class
...
| [AudioCdEndTrack](../../aspose.slides/audioframe/audiocdendtrack) { get; set; } | Gibt einen Index für die letzte Spur zurück oder setzt ihn. Lesen/SchreibenInt32 . |
| [AudioCdEndTrackTime](../../aspose.slides/audioframe/audiocdendtracktime) { get; set; } | Gibt eine letzte Trackzeit zurück oder setzt sie. Lesen/SchreibenInt32 . |
| [AudioCdStartTrack](../../aspose.slides/audioframe/audiocdstarttrack) { get; set; } | Gibt einen Startspurindex zurück oder setzt ihn. Lesen/SchreibenInt32 . |
| [AudioCdStartTrackTime](../../aspose.slides/audioframe/audiocdstarttracktime) { get; set; } | Gibt eine Startspurzeit zurück oder stellt sie ein. Lesen/SchreibenInt32 . |
...
| [Embedded](../../aspose.slides/audioframe/embedded) { get; } | Legt fest, ob ein Ton in eine Präsentation eingebettet wird. SchreibgeschütztBoolean . |
| [EmbeddedAudio](../../aspose.slides/audioframe/embeddedaudio) { get; set; } | Gibt eingebettetes Audioobjekt zurück oder setzt es. Lesen/Schreiben[`IAudio`](../iaudio) . |
...
| [HideAtShowing](../../aspose.slides/audioframe/hideatshowing) { get; set; } | Bestimmt, ob ein AudioFrame ausgeblendet ist. Lesen/SchreibenBoolean . |
...
| [LinkPathLong](../../aspose.slides/audioframe/linkpathlong) { get; set; } | Gibt den Namen einer Audiodatei zurück, die mit einem AudioFrame verknüpft ist, oder setzt ihn. Lesen/SchreibenString . |
...
| [PlayAcrossSlides](../../aspose.slides/audioframe/playacrossslides) { get; set; } | Legt fest, ob Audio über die Folien wiedergegeben wird. Lesen/SchreibenBoolean . |
| [PlayLoopMode](../../aspose.slides/audioframe/playloopmode) { get; set; } | Bestimmt, ob ein Audio geloopt wird. Lesen/SchreibenBoolean . |
| [PlayMode](../../aspose.slides/audioframe/playmode) { get; set; } | Gibt den Audiowiedergabemodus zurück oder legt ihn fest. Lesen/Schreiben[`AudioPlayModePreset`](../audioplaymodepreset) . |
...
| [RewindAudio](../../aspose.slides/audioframe/rewindaudio) { get; set; } | Legt fest, ob Audio nach dem Abspielen automatisch zum Start zurückgespult wird. Lesen/SchreibenBoolean . |
...
| [Volume](../../aspose.slides/audioframe/volume) { get; set; } | Gibt die Audiolautstärke zurück oder stellt sie ein. Lesen/Schreiben[`AudioVolumeMode`](../audiovolumemode) . |
