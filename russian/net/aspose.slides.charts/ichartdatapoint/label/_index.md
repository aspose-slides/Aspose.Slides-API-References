...
description: Представляет метку точки данных диаграммы. Только для чтенияIDataLabelaspose.slides.charts/idatalabel .
type: docs
weight: 100
url: /ru/net/aspose.slides.charts/ichartdatapoint/label/
---
