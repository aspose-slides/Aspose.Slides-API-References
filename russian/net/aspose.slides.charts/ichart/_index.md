...
| [Floor](../../aspose.slides.charts/ichart/floor) { get; } | Возвращает объект, позволяющий изменить формат нижней части 3D-диаграммы. Только для чтения[`IChartWall`](../ichartwall) . |
...
| [HasLegend](../../aspose.slides.charts/ichart/haslegend) { get; set; } | Определяет наличие легенды на диаграмме. Чтение/записьBoolean . |
