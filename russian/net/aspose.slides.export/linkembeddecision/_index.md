...
description: Определяет как будет обрабатываться объект во время сохранения.
type: docs
weight: 3880
...
Определяет, как будет обрабатываться объект во время сохранения.
...
| --- | --- | --- |
| Link | `0` | Объект будет храниться снаружи, на который ссылается URL |
