...
description: Вызывается для записи html нижнего колонтитула слайда. Вызывается один раз для каждого слайда.
type: docs
weight: 80
...
Вызывается для записи html нижнего колонтитула слайда. Вызывается один раз для каждого слайда.
