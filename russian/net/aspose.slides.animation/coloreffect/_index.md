...
| [Direction](../../aspose.slides.animation/coloreffect/direction) { get; set; } | Указывает, в каком направлении менять оттенок по цветовому кругу. Чтение/запись[`ColorDirection`](../colordirection) . |
