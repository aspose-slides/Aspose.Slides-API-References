...
description: Неизменяемый объект представляющий предварительно заданный эффект тени.
type: docs
weight: 3290
...
Неизменяемый объект, представляющий предварительно заданный эффект тени.
