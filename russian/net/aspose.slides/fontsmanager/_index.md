...
| [FontSubstRuleList](../../aspose.slides/fontsmanager/fontsubstrulelist) { get; set; } | Подстановки шрифтов для использования при рендеринге. Чтение/запись[`IFontSubstRuleCollection`](../ifontsubstrulecollection) . |
...
| [ReplaceFont](../../aspose.slides/fontsmanager/replacefont#replacefont_2)(IFontSubstRuleCollection) | Заменить шрифт в презентации, используя информацию из набора[`FontSubstRule`](../fontsubstrule) |
