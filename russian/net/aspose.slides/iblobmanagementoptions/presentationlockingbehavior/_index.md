...
type: docs
weight: 30
url: /ru/net/aspose.slides/iblobmanagementoptions/presentationlockingbehavior/
---
...
using (Presentation pres = new Presentation("pres.pptx", loadOptions)) {
  // Будет выброшено исключение IOException, потому что pres.pptx заблокирован на время жизни презентации
