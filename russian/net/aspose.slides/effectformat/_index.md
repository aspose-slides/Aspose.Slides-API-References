...
type: docs
weight: 2660
url: /ru/net/aspose.slides/effectformat/
---
## EffectFormat class
...
| [IsNoEffects](../../aspose.slides/effectformat/isnoeffects) { get; } | Возвращает true, если все эффекты отключены (как только что созданный объект EffectFormat по умолчанию). Только для чтенияBoolean . |
...
| [DisablePresetShadowEffect](../../aspose.slides/effectformat/disablepresetshadoweffect)() | Отключает предустановленный эффект тени. |
| [DisableReflectionEffect](../../aspose.slides/effectformat/disablereflectioneffect)() | Отключает эффект отражения. |
| [DisableSoftEdgeEffect](../../aspose.slides/effectformat/disablesoftedgeeffect)() | Отключает эффект мягких краев. |
...
| [EnableSoftEdgeEffect](../../aspose.slides/effectformat/enablesoftedgeeffect)() | Включает эффект мягких краев. |
| override [Equals](../../aspose.slides/pviobject/equals)(object) | Сравнивает с указанным объектом. |
| [GetEffective](../../aspose.slides/effectformat/geteffective)() | Получает данные форматирования эффективного эффекта с применением наследования. |
