...
| [AudioCdStartTrack](../../aspose.slides/audioframe/audiocdstarttrack) { get; set; } | Возвращает или устанавливает индекс начальной дорожки. Чтение/записьInt32. |
...
| [Embedded](../../aspose.slides/audioframe/embedded) { get; } | Определяет, встроен ли звук в презентацию. Только чтениеBoolean. |
...
| [PlayLoopMode](../../aspose.slides/audioframe/playloopmode) { get; set; } | Определяет, зациклен ли звук. Чтение/записьBoolean. |
| [PlayMode](../../aspose.slides/audioframe/playmode) { get; set; } | Возвращает или устанавливает режим воспроизведения звука. Чтение/запись[`AudioPlayModePreset`](../audioplaymodepreset). |
