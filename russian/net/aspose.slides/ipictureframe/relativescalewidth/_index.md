...
description: Возвращает или задает масштаб ширины относительно исходного размера изображения рамки изображения. Значение 1.0 соответствует 100. Чтение/записьSingle .
type: docs
weight: 50
