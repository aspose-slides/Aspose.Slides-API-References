...
type: docs
weight: 8580
url: /ru/net/aspose.slides/paragraphformat/
---
...
| Имя | Описание |
| --- | --- |
| [ParagraphFormat](paragraphformat)() | Инициализирует новый экземпляр[`ParagraphFormat`](../paragraphformat) класс. |
...
| [DefaultTabSize](../../aspose.slides/paragraphformat/defaulttabsize) { get; set; } | Возвращает или задает размер табуляции по умолчанию без наследования. Чтение/записьSingle . |
...
| [GetEffective](../../aspose.slides/paragraphformat/geteffective)() | Получает действующие данные форматирования абзаца с применением наследования. |
