...
| [NotesTextFrame](../../aspose.slides/notesslide/notestextframe) { get; } | Возвращает TextFrame с текстом заметки, если он есть. Только для чтения[`ITextFrame`](../itextframe) . |
