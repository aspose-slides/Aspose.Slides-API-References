...
description: Возвращает коллекцию элементов управления ActiveX на слайде. Только для чтенияIControlCollectionaspose.slides/icontrolcollection .
type: docs
weight: 30
url: /ru/net/aspose.slides/ibaseslide/controls/
---
