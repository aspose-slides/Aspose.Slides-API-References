...
type: docs
weight: 11030
url: /ru/net/aspose.slides/zoomframe/
---
## ZoomFrame class
...
| [TargetSlide](../../aspose.slides/zoomframe/targetslide) { get; set; } | Получает или задает объект слайда, на который ссылается объект «Масштаб слайда». Чтение/запись[`ISlide`](../islide) . |
