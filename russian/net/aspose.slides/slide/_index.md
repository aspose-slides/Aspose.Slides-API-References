...
type: docs
weight: 9180
url: /ru/net/aspose.slides/slide/
---
## Slide class
...
| [SlideNumber](../../aspose.slides/slide/slidenumber) { get; set; } | Возвращает номер слайда. Индекс слайда в[`Slides`](../presentation/slides) коллекция всегда равна SlideNumber - Presentation.FirstSlideNumber. Чтение/записьInt32 . |
