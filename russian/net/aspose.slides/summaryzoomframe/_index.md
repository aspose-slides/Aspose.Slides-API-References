...
description: Представляет объект сводного масштаба на слайде.
type: docs
weight: 9960
...
Представляет объект сводного масштаба на слайде.
...
| [Layout](../../aspose.slides/summaryzoomframe/layout) { get; } | Получает макет разделов сводного масштабирования в кадре. Значение по умолчанию — GridLayout. |
