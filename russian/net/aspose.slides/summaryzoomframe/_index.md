...
description: Представляет объект Сводное масштабирование на слайде.
type: docs
weight: 9960
url: /ru/net/aspose.slides/summaryzoomframe/
---
## SummaryZoomFrame class

Представляет объект "Сводное масштабирование" на слайде.
...
| [Layout](../../aspose.slides/summaryzoomframe/layout) { get; } | Получает расположение разделов сводного масштабирования в кадре. Значение по умолчанию — GridLayout. |
...
| [SummaryZoomCollection](../../aspose.slides/summaryzoomframe/summaryzoomcollection) { get; } | Получает[`ISummaryZoomSectionCollection`](../isummaryzoomsectioncollection)для объекта Сводная рамка масштабирования. |
