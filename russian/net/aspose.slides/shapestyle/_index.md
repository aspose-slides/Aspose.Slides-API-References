...
type: docs
weight: 9130
url: /ru/net/aspose.slides/shapestyle/
---
## ShapeStyle class
...
| [FillStyleIndex](../../aspose.slides/shapestyle/fillstyleindex) { get; set; } | Возвращает или задает индекс столбца заливки фигуры в матрицах стилей. 0 означает отсутствие заливки, положительное значение — индекс в стилях заливки темы, отрицательное значение — индекс в стилях фона темы. Чтение/записьInt16 . |
| [FontCollectionIndex](../../aspose.slides/shapestyle/fontcollectionindex) { get; set; } | Возвращает или задает индекс шрифта формы в коллекции шрифтов. Чтение/запись[`FontCollectionIndex`](../fontcollectionindex) . |
...
| [LineStyleIndex](../../aspose.slides/shapestyle/linestyleindex) { get; set; } | Возвращает или задает индекс столбца строки в матрице стилей. Чтение/записьUInt16 . |
