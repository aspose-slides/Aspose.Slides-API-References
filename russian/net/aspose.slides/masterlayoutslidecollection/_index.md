...
description: Представляет коллекции всех слайдов макета определенного эталонного слайда. Расширяет класс LayoutSlideCollection методами добавления/вставки/удаления/клонирования/изменения порядка слайдов макета в контексте отдельных коллекций слайдов макета мастера.
type: docs
weight: 7290
...
Представляет коллекции всех слайдов макета определенного эталонного слайда. Расширяет класс LayoutSlideCollection методами добавления/вставки/удаления/клонирования/изменения порядка слайдов макета в контексте отдельных коллекций слайдов макета мастера.
