...
description: Представляет устаревший объект схемы.
type: docs
weight: 6970
url: /ru/net/aspose.slides/legacydiagram/
---
## LegacyDiagram class

Представляет устаревший объект схемы.
...
| [ConvertToGroupShape](../../aspose.slides/legacydiagram/converttogroupshape)() | Преобразует устаревшую диграмму в редактируемую форму группы. Созданный объект GroupShape добавляется к фигуре родительской группы в той же позиции. |
| [ConvertToSmartArt](../../aspose.slides/legacydiagram/converttosmartart)() | Преобразует устаревшую диграмму в редактируемый объект SmartArt. Созданный объект SmartArt добавляется к фигуре родительской группы в той же позиции. |
