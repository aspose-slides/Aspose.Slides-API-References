...
Вы можете получить доступ к альтернативному API для добавления/вставки/удаления/клонирования слайдов макета с помощью[`LayoutSlides`](../../ipresentation/layoutslides) свойство.
