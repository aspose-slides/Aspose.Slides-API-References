...
type: docs
weight: 800
url: /ru/net/aspose.slides/autoshape/
---
## AutoShape class
...
| [AutoShapeLock](../../aspose.slides/autoshape/autoshapelock) { get; } | Возвращает блокировки автошейпа. Только для чтения[`IAutoShapeLock`](../iautoshapelock). |
...
| [ShapeLock](../../aspose.slides/autoshape/shapelock) { get; } | Возвращает блокировки формы. Только для чтения[`IAutoShapeLock`](../iautoshapelock). (2 properties) |
...
| virtual [ShapeType](../../aspose.slides/geometryshape/shapetype) { get; set; } | Возвращает или задает тип предустановки геометрии. Примечание:при изменении значения все значения регулировки будут возвращены к значениям по умолчанию. Чтение/запись[`ShapeType`](../shapetype). |
| [Slide](../../aspose.slides/shape/slide) { get; } | Возвращает родительский слайд фигуры. Только для чтения[`IBaseSlide`](../ibaseslide). |
| [TextFrame](../../aspose.slides/autoshape/textframe) { get; } | Возвращает объект TextFrame для автофигуры. Только для чтения[`ITextFrame`](../itextframe). |
...
| [UseBackgroundFill](../../aspose.slides/autoshape/usebackgroundfill) { get; set; } | Определяет, следует ли заполнять автофигуру фоновой заливкой слайда, а не заданной стилем или форматом заливки. Чтение/записьBoolean. |
...
| virtual [AddTextFrame](../../aspose.slides/autoshape/addtextframe)(string) | Добавляет к фигуре новый TextFrame. Если фигура уже имеет TextFrame, то просто меняет ее текст. |
