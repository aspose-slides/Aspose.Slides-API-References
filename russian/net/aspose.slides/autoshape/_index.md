...
| [AutoShapeLock](../../aspose.slides/autoshape/autoshapelock) { get; } | Возвращает блокировки автофигуры. Только для чтения[`IAutoShapeLock`](../iautoshapelock) . |
...
| [UseBackgroundFill](../../aspose.slides/autoshape/usebackgroundfill) { get; set; } | Определяет, следует ли заполнять эту автофигуру заливкой фона слайда, а не заданной стилем или форматом заливки. Чтение/записьBoolean . |
...
| virtual [AddTextFrame](../../aspose.slides/autoshape/addtextframe)(string) | Добавляет новый TextFrame в фигуру. Если фигура уже имеет TextFrame, просто меняет его текст. |
