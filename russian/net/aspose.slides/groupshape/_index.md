...
| [ShapeLock](../../aspose.slides/groupshape/shapelock) { get; } | Возвращает блокировки фигуры. Только для чтения[`IGroupShapeLock`](../igroupshapelock). (2 properties) |
| [Shapes](../../aspose.slides/groupshape/shapes) { get; } | Возвращает набор фигур внутри группы. Только чтение[`IShapeCollection`](../ishapecollection). |
