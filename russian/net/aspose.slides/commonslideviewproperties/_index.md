...
type: docs
weight: 2510
url: /ru/net/aspose.slides/commonslideviewproperties/
---
...
| Имя | Описание |
| --- | --- |
| [Scale](../../aspose.slides/commonslideviewproperties/scale) { get; set; } | Указывает коэффициент масштабирования представления в процентах. Чтение/записьInt32 . |
