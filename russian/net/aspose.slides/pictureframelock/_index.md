...
| [ArrowheadsLocked](../../aspose.slides/pictureframelock/arrowheadslocked) { get; set; } | Определяет, запрещено ли изменение наконечников стрелок. Чтение/записьBoolean . |
...
| [RotationLocked](../../aspose.slides/pictureframelock/rotationlocked) { get; set; } | Определяет, запрещено ли изменение угла поворота этой формы. Чтение/записьBoolean . |
| [SelectLocked](../../aspose.slides/pictureframelock/selectlocked) { get; set; } | Определяет, запрещен ли выбор этой фигуры. Чтение/записьBoolean . |
