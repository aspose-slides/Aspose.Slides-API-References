...
type: docs
weight: 10050
url: /ru/net/aspose.slides/table/
---
## Table class
...
| [StylePreset](../../aspose.slides/table/stylepreset) { get; set; } | Получает или задает встроенный стиль таблицы. Чтение/запись[`TableStylePreset`](../tablestylepreset) . |
...
| [SetTextFormat](../../aspose.slides/table/settextformat#settextformat)(IParagraphFormat) | Задает определенные свойства формата абзаца для всех абзацев ячеек таблицы. |
...
| [SetTextFormat](../../aspose.slides/table/settextformat#settextformat_2)(ITextFrameFormat) | Задает определенные свойства формата текстового фрейма для всех текстовых фреймов ячеек таблицы. |
