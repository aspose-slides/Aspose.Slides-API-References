...
| [IsSynchronized](../../aspose.slides/slidecollection/issynchronized) { get; } | Возвращает значение, указывающее, является ли доступ к коллекции синхронизированным (потокобезопасным). Только для чтенияBoolean . |
...
| [CopyTo](../../aspose.slides/slidecollection/copyto)(Array, int) | Копирует все элементы коллекции в указанный массив. |
| [GetEnumerator](../../aspose.slides/slidecollection/getenumerator)() | Возвращает перечислитель, который выполняет итерацию по коллекции. |
...
| [ToArray](../../aspose.slides/slidecollection/toarray#toarray_1)(int, int) | Создает и возвращает массив со всеми слайдами из указанного диапазона. Индекс первого слайда для добавления.Несколько слайдов для добавления. |
