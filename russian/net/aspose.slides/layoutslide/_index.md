...
type: docs
weight: 6940
url: /ru/net/aspose.slides/layoutslide/
---
## LayoutSlide class
...
| [HasDependingSlides](../../aspose.slides/layoutslide/hasdependingslides) { get; } | Возвращает значение true, если существует хотя бы один слайд, который зависит от этого слайда макета. Только для чтенияBoolean . |
| [HeaderFooterManager](../../aspose.slides/layoutslide/headerfootermanager) { get; } | Возвращает менеджер HeaderFooter макета слайда. Только для чтения[`ILayoutSlideHeaderFooterManager`](../ilayoutslideheaderfootermanager) . |
...
| [MasterSlide](../../aspose.slides/layoutslide/masterslide) { get; set; } | Возвращает или задает мастер-слайд для макета. Чтение/запись[`IMasterSlide`](../imasterslide) . |
...
| override [ShowMasterShapes](../../aspose.slides/layoutslide/showmastershapes) { get; set; } | Указывает, должны ли фигуры на мастер-слайде отображаться на слайдах или нет. Чтение/записьBoolean . |
...
| [ThemeManager](../../aspose.slides/layoutslide/thememanager) { get; } | Возвращает приоритетный менеджер тем. Только для чтения[`IOverrideThemeManager`](../../aspose.slides.theme/ioverridethememanager) . |
...
| [GetDependingSlides](../../aspose.slides/layoutslide/getdependingslides)() | Возвращает массив со всеми слайдами, которые зависят от этого макета слайда. |
