...
type: docs
weight: 9380
url: /ru/net/aspose.slides.slideshow/irevealtransition/
---
...
| [ThroughBlack](../../aspose.slides.slideshow/irevealtransition/throughblack) { get; set; } | Определяет, исчезает ли переход через черный цвет. Чтение/записьBoolean . |
