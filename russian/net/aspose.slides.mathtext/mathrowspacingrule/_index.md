...
type: docs
weight: 8250
url: /ru/net/aspose.slides.mathtext/mathrowspacingrule/
---
...
| OneAndAHalfLineGap | `1` | Промежуток в полторы строки |
| TwoLineGap | `2` | Две строки gap |
| Exactly | `3` | Точно (полагаться на значение свойства RowSpacing, измеряемое в пунктах) |
