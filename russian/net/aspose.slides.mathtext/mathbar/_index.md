...
| Имя | Описание |
| --- | --- |
| [MathBar](mathbar#constructor)(IMathElement) | Инициализирует MathBar с верхней чертой (верхнее положение) |
...
| [Position](../../aspose.slides.mathtext/mathbar/position) { get; set; } | Положение такта. По умолчанию:Верх |
