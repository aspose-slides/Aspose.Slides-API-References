...
type: docs
weight: 7850
url: /ru/net/aspose.slides.mathtext/mathbar/
---
## MathBar class
...
| Имя | Описание |
| --- | --- |
| [MathBar](mathbar#constructor)(IMathElement) | Инициализирует MathBar с верхней полосой (верхнее положение) |
...
| [Position](../../aspose.slides.mathtext/mathbar/position) { get; set; } | Положение тактовой черты. По умолчанию: Top |
...
| [GetChildren](../../aspose.slides.mathtext/mathbar/getchildren)() | Получить дочерние элементы |
