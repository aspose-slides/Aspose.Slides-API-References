...
type: docs
weight: 8210
url: /ru/net/aspose.slides.mathtext/mathradical/
---
## MathRadical class
...
| Имя | Описание |
| --- | --- |
| [Base](../../aspose.slides.mathtext/mathradical/base) { get; } | Базовый аргумент |
| [Degree](../../aspose.slides.mathtext/mathradical/degree) { get; } | Аргумент степени |
| [HideDegree](../../aspose.slides.mathtext/mathradical/hidedegree) { get; set; } | Скрыть степень Когда установлено значение true, степень не отображается, как в √𝑥 |
...
| [GetChildren](../../aspose.slides.mathtext/mathradical/getchildren)() | Получить дочерние элементы |
