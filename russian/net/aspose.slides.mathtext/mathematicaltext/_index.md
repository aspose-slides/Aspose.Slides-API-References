...
type: docs
weight: 8330
url: /ru/net/aspose.slides.mathtext/mathematicaltext/
---
...
| Имя | Описание |
| --- | --- |
| [MathematicalText](mathematicaltext#constructor)() | Конструктор по умолчанию (создать String.Empty Value) |
| [MathematicalText](mathematicaltext#constructor_1)(char) | Создать MathText с одиночным символом |
| [MathematicalText](mathematicaltext#constructor_2)(string) | Создать MathematicalText из текста |
| [MathematicalText](mathematicaltext#constructor_3)(string, IPortionFormat) | Создать MathematicalText из текста и настроек формата |
...
| [Value](../../aspose.slides.mathtext/mathematicaltext/value) { get; set; } | Текстовое значение |
