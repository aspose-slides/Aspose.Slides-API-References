...
description: Заключает дочерние элементы этого блока в указанные символы такие как круглые скобки или другие такие как framing и разделяет символом разделителя
type: docs
weight: 40
