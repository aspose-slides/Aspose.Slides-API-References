...
type: docs
weight: 8000
url: /ru/net/aspose.slides.mathtext/mathfunction/
---
## MathFunction class
...
| [Name](../../aspose.slides.mathtext/mathfunction/name) { get; } | Имя функции Например, именами функций являются sin и cos |
...
| [GetChildren](../../aspose.slides.mathtext/mathfunction/getchildren)() | Получить дочерние элементы |
