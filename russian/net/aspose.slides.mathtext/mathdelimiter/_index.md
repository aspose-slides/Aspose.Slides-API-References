...
| Имя | Описание |
| --- | --- |
| [MathDelimiter](mathdelimiter)(IMathElement) | Инициализирует MathDelimiter с указанным элементом в качестве одного базового аргумента |
...
| [BeginningCharacter](../../aspose.slides.mathtext/mathdelimiter/beginningcharacter) { get; set; } | Начальный символ-разделитель определяет начальный или открывающий символ-разделитель. Математические разделители заключают в себя символы, такие как скобки, квадратные и фигурные скобки. Значение по умолчанию: '('. |
| [DelimiterShape](../../aspose.slides.mathtext/mathdelimiter/delimitershape) { get; set; } | Определяет форму разделителей в объекте-разделителе. Когда MathDelimiterShape.Centered, разделители центрируются вокруг математической оси математического текста и по-прежнему должны соответствовать всей высоте их содержимого. Когда MathDelimiterShape.Match, их высота и форма изменяются, чтобы точно соответствовать их содержимому . |
| [EndingCharacter](../../aspose.slides.mathtext/mathdelimiter/endingcharacter) { get; set; } | Символ окончания разделителя определяет конечный или закрывающий символ разделителя. Математические разделители заключают в себя символы, такие как скобки, квадратные и фигурные скобки. Значение по умолчанию: ')'. |
| [GrowToMatchOperandHeight](../../aspose.slides.mathtext/mathdelimiter/growtomatchoperandheight) { get; set; } | Определяет рост BeginningCharacter, SeparatorCharacter, EndingCharacter При значении true разделители увеличиваются по вертикали, чтобы соответствовать высоте операнда. Значение по умолчанию — true |
| [SeparatorCharacter](../../aspose.slides.mathtext/mathdelimiter/separatorcharacter) { get; set; } | Символ разделителя-разделителя указывает символ, который разделяет аргументы в объекте-разделителе. По умолчанию: '&#x7C;'. |
...
| [Delimit](../../aspose.slides.mathtext/mathdelimiter/delimit)(char) | Разграничивает аргументы, используя указанный символ-разделитель |
...
| override [Enclose](../../aspose.slides.mathtext/mathdelimiter/enclose#enclose_1)(char, char) | Заключает математический элемент в указанные символы, такие как круглые скобки или другие символы, такие как framing |
