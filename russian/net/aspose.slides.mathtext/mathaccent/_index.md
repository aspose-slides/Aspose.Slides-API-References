...
type: docs
weight: 7810
url: /ru/net/aspose.slides.mathtext/mathaccent/
---
## MathAccent class
...
| Имя | Описание |
| --- | --- |
| [MathAccent](mathaccent#constructor)(IMathElement) | Создает математический акцент, применяемый к указанному математическому элементу со значением символа акцента по умолчанию |
...
| Имя | Описание |
| --- | --- |
| [Base](../../aspose.slides.mathtext/mathaccent/base) { get; } | Аргумент, к которому был применен ударение |
| [Character](../../aspose.slides.mathtext/mathaccent/character) { get; set; } | Символ ударения Значение должно быть в диапазоне (U+0300–U+036F) или (U+20D0–U+20EF ) Значение по умолчанию:Объединение акцента циркумфлекса (U+0302) |
...
| [GetChildren](../../aspose.slides.mathtext/mathaccent/getchildren)() | Получить дочерние элементы |
