...
type: docs
weight: 7890
url: /ru/net/aspose.slides.mathtext/mathborderbox/
---
## MathBorderBox class
...
| [StrikethroughTopLeftToBottomRight](../../aspose.slides.mathtext/mathborderbox/strikethroughtoplefttobottomright) { get; set; } | Зачеркнутый верхний левый нижний правый угол (по умолчанию false). Определяет скрытое или отображаемое состояние зачеркнутой диагональной линии от верхнего левого угла до нижнего правого угла рамки. |
| [StrikethroughVertical](../../aspose.slides.mathtext/mathborderbox/strikethroughvertical) { get; set; } | Зачеркнутая вертикаль (по умолчанию false) — указывает скрытое или отображаемое состояние зачеркнутой вертикальной линии. |
