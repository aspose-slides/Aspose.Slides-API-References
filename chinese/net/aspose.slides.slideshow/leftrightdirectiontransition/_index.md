...
| 姓名 | 描述 |
| --- | --- |
| [Direction](../../aspose.slides.slideshow/leftrightdirectiontransition/direction) { get; set; } | 转换方向。 读/写[`TransitionLeftRightDirectionType`](../transitionleftrightdirectiontype). |
