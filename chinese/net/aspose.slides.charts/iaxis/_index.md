...
| [AggregationType](../../aspose.slides.charts/iaxis/aggregationtype) { get; set; } | 表示类别轴的聚合类型（分箱）。应用于类别。仅与直方图或直方图帕累托系列一起使用。 |
...
| [BinWidth](../../aspose.slides.charts/iaxis/binwidth) { get; set; } | 指定当 AggregationType 属性值设置为 AxisAggregationType.ByBinWidth 时的 bin 宽度。 应用于类别轴。仅与直方图或直方图帕累托系列一起使用。 |
...
| [CrossType](../../aspose.slides.charts/iaxis/crosstype) { get; set; } | 表示另一轴相交的指定轴上的 CrossType。 读/写[`CrossesType`](../crossestype). |
...
| [HasTitle](../../aspose.slides.charts/iaxis/hastitle) { get; set; } | 确定轴是否有可见标题。 读/写Boolean. |
...
| [IsAutomaticTickLabelSpacing](../../aspose.slides.charts/iaxis/isautomaticticklabelspacing) { get; set; } | 指定自动刻度标签间距值。如果为假：使用 TickLabelSpacing 属性。 读/写Boolean. |
| [IsAutomaticTickMarksSpacing](../../aspose.slides.charts/iaxis/isautomatictickmarksspacing) { get; set; } | 指定自动刻度线间距值。如果为假：使用 TickMarksSpacing 属性。 读/写Boolean. |
| [IsAutomaticUnderflowBin](../../aspose.slides.charts/iaxis/isautomaticunderflowbin) { get; set; } | 指定自动下溢 bin 值。如果为假：使用 UnderflowBin 属性。 |
...
| [MajorTickMark](../../aspose.slides.charts/iaxis/majortickmark) { get; set; } | 表示指定轴的主要刻度线的类型。 读/写[`TickMarkType`](../tickmarktype). |
...
| [MinorTickMark](../../aspose.slides.charts/iaxis/minortickmark) { get; set; } | 表示指定轴的次刻度标记的类型。 读/写[`TickMarkType`](../tickmarktype). |
| [MinorUnit](../../aspose.slides.charts/iaxis/minorunit) { get; set; } | 表示日期或数值轴的次要单位。 读/写Double. |
...
| [NumberOfBins](../../aspose.slides.charts/iaxis/numberofbins) { get; set; } | 指定当 AggregationType 属性值设置为 AxisAggregationType.ByNumberOfBins 时的 bin 数。 应用于类别轴。仅与直方图或直方图帕累托系列一起使用。 |
...
| [TickMarksSpacing](../../aspose.slides.charts/iaxis/tickmarksspacing) { get; set; } | 指定在绘制下一个 之前应跳过多少个刻度线。应用于类别或系列轴。 读/写UInt16. |
