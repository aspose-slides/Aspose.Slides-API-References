...
type: docs
weight: 1890
url: /zh/net/aspose.slides.charts/idatalabelcollection/
---
...
| [IsVisible](../../aspose.slides.charts/idatalabelcollection/isvisible) { get; } | False 表示默认情况下数据标签不可见（因此 DefaultDataLabelFormat 属性的所有 Show*-flags (ShowValue, ...) 均为 false）。 只读Boolean. |
...
| 姓名 | 描述 |
| --- | --- |
| [Hide](../../aspose.slides.charts/idatalabelcollection/hide)() | 通过将 DefaultDataLabelFormat 属性的所有 Show*-flags (ShowValue, ...) 设置为 false 状态，默认隐藏数据标签。 在此之后 IsVisible 将为 false。 |
