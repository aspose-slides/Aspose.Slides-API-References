...
| [AggregationType](../../aspose.slides.charts/axis/aggregationtype) { get; set; } | 表示类别轴的聚合类型（分箱）。应用于类别。仅与直方图或直方图帕累托系列一起使用。 |
...
| [BinWidth](../../aspose.slides.charts/axis/binwidth) { get; set; } | 指定当 AggregationType 属性值设置为 AxisAggregationType.ByBinWidth 时的 bin 宽度。 应用于类别轴。仅与直方图或直方图帕累托系列一起使用。 |
...
| [CrossType](../../aspose.slides.charts/axis/crosstype) { get; set; } | 表示另一轴相交的指定轴上的 CrossType。 读/写[`CrossesType`](../crossestype). |
| [DisplayUnit](../../aspose.slides.charts/axis/displayunit) { get; set; } | 指定数值轴显示单位的缩放值。 读/写[`DisplayUnitType`](../displayunittype). |
| [Format](../../aspose.slides.charts/axis/format) { get; } | 表示轴的格式。 只读[`IAxisFormat`](../iaxisformat). |
| [HasTitle](../../aspose.slides.charts/axis/hastitle) { get; set; } | 确定轴是否有可见标题。 读/写Boolean. |
...
| [IsAutomaticOverflowBin](../../aspose.slides.charts/axis/isautomaticoverflowbin) { get; set; } | 指定自动溢出箱值。如果为假：使用 OverflowBin 属性。 |
| [IsAutomaticTickLabelSpacing](../../aspose.slides.charts/axis/isautomaticticklabelspacing) { get; set; } | 指定自动刻度标签间距值。如果为假：使用 TickLabelSpacing 属性。 读/写Boolean. |
| [IsAutomaticTickMarksSpacing](../../aspose.slides.charts/axis/isautomatictickmarksspacing) { get; set; } | 指定自动刻度线间距值。如果为假：使用 TickMarksSpacing 属性。 读/写Boolean. |
| [IsAutomaticUnderflowBin](../../aspose.slides.charts/axis/isautomaticunderflowbin) { get; set; } | 指定自动下溢 bin 值。如果为假：使用 UnderflowBin 属性。 |
...
| [MajorTickMark](../../aspose.slides.charts/axis/majortickmark) { get; set; } | 表示指定轴的主要刻度线的类型。 读/写[`TickMarkType`](../tickmarktype). |
...
| [MinorTickMark](../../aspose.slides.charts/axis/minortickmark) { get; set; } | 表示指定轴的次刻度标记的类型。 读/写[`TickMarkType`](../tickmarktype). |
| [MinorUnit](../../aspose.slides.charts/axis/minorunit) { get; set; } | 表示日期或数值轴的次要单位。 读/写Double. |
...
| [NumberOfBins](../../aspose.slides.charts/axis/numberofbins) { get; set; } | 指定当 AggregationType 属性值设置为 AxisAggregationType.ByNumberOfBins 时的 bin 数。 应用于类别轴。仅与直方图或直方图帕累托系列一起使用。 |
...
| [TickMarksSpacing](../../aspose.slides.charts/axis/tickmarksspacing) { get; set; } | 指定在绘制下一个 之前应跳过多少个刻度线。应用于类别或系列轴。 读/写UInt16. |
