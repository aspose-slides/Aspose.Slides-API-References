...
| [AsLiteralDouble](../../aspose.slides.charts/stringordoublechartvalue/asliteraldouble) { get; set; } | 将值返回或设置为双精度字面值。 读/写Double. |
| [AsLiteralString](../../aspose.slides.charts/stringordoublechartvalue/asliteralstring) { get; set; } | 以文字字符串的形式返回或设置值。 读/写String. |
