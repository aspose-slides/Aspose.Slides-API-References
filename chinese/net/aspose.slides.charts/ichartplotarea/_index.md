...
| [AsILayoutable](../../aspose.slides.charts/ichartplotarea/asilayoutable) { get; } | 允许获取基本 ILayoutable 接口。 只读[`ILayoutable`](../ilayoutable). |
| [Format](../../aspose.slides.charts/ichartplotarea/format) { get; } | 返回绘图区域的格式。 只读[`IFormat`](../iformat). |
| [LayoutTargetType](../../aspose.slides.charts/ichartplotarea/layouttargettype) { get; set; } | 如果手动定义绘图区域的布局，此属性指定 是按其内部（不包括轴和轴标签）还是外部 （包括轴和轴标签）来布局绘图区域。 读/写[`LayoutTargetType`](./layouttargettype). |
