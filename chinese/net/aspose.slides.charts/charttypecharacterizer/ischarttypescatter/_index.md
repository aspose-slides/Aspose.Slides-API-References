...
description: 如果 chartType 是 Scatter 子类型之一则返回 true 子类型集对应于 PowerPoint 中的相应集参见 PowerPoint 中的更改图表类型对话框 ChartTypeScatterWithMarkers ScatterWithSmoothLines ScatterWithSmoothLinesAndMarkers ScatterWithStraightLines ScatterWithStraightLinesAndMarkers
type: docs
weight: 130
