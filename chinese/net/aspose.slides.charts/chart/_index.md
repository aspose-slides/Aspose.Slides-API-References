...
type: docs
weight: 1120
url: /zh/net/aspose.slides.charts/chart/
---
## Chart class
...
| [Floor](../../aspose.slides.charts/chart/floor) { get; } | 返回一个允许更改 3D 图表地板格式的对象。 只读[`IChartWall`](../ichartwall). |
...
| [HasDataTable](../../aspose.slides.charts/chart/hasdatatable) { get; set; } | 判断一个图表是否有数据表。 读/写Boolean. |
...
| [PlotVisibleCellsOnly](../../aspose.slides.charts/chart/plotvisiblecellsonly) { get; set; } | 确定是否仅绘制可见单元格。绘制可见和隐藏单元格的错误。 读/写Boolean. |
