...
| [Compressed](../../aspose.slides.export/iswfoptions/compressed) { get; set; } | 指定是否应压缩生成的 SWF 文档。 默认为`真的` |
...
| [LogoLink](../../aspose.slides.export/iswfoptions/logolink) { get; set; } | 获取或设置徽标的完整超链接地址。 仅当[`LogoImageBytes`](./logoimagebytes)被指定。 |
...
| [ShowHiddenSlides](../../aspose.slides.export/iswfoptions/showhiddenslides) { get; set; } | 指定生成的文档是否应包含隐藏幻灯片。 默认为`错误的` |
...
| [ViewerIncluded](../../aspose.slides.export/iswfoptions/viewerincluded) { get; set; } | 指定生成的 SWF 文档是否应包含集成文档查看器。 默认为`真的` |
