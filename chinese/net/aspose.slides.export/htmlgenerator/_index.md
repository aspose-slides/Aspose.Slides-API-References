...
| 姓名 | 描述 |
| --- | --- |
| [NextSlideIndex](../../aspose.slides.export/htmlgenerator/nextslideindex) { get; } | 返回幻灯片的索引，将在当前幻灯片之后呈现，如果当前呈现最后一张幻灯片，则为 -1。 只读Int32. |
...
| [AddText](../../aspose.slides.export/htmlgenerator/addtext#addtext)(char[]) | 将纯文本添加到 html 文件，用 html 实体替换特殊字符。 不替换换行符和空格。 |
| [AddText](../../aspose.slides.export/htmlgenerator/addtext#addtext_2)(string) | 将纯文本添加到 html 文件，用 html 实体替换特殊字符。 不替换换行符和空格。 |
| [AddText](../../aspose.slides.export/htmlgenerator/addtext#addtext_1)(char[], int, int) | 将纯文本添加到 html 文件，用 html 实体替换特殊字符。 不替换换行符和空格。 |
