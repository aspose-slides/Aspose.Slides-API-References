...
| 姓名 | 描述 |
| --- | --- |
| [Compressed](../../aspose.slides.export/swfoptions/compressed) { get; set; } | 指定是否应压缩生成的 SWF 文档。 默认为`真的` |
...
| [LogoImageBytes](../../aspose.slides.export/swfoptions/logoimagebytes) { get; set; } | 将在查看器右上角显示为徽标的图像。 图像应为 32x64 像素的 PNG 图像，否则徽标可能无法正常显示。 |
| [LogoLink](../../aspose.slides.export/swfoptions/logolink) { get; set; } | 获取或设置徽标的完整超链接地址。 仅当[`LogoImageBytes`](./logoimagebytes)被指定。 |
...
| [ShowHiddenSlides](../../aspose.slides.export/swfoptions/showhiddenslides) { get; set; } | 指定生成的文档是否应包含隐藏幻灯片。 默认为`错误的` |
...
| [ViewerIncluded](../../aspose.slides.export/swfoptions/viewerincluded) { get; set; } | 指定生成的 SWF 文档是否应包含集成文档查看器。 默认为`真的` |
