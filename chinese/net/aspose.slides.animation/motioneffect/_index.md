...
| [PathEditMode](../../aspose.slides.animation/motioneffect/patheditmode) { get; set; } | 指定形状移动时运动路径如何移动。 读/写[`MotionPathEditMode`](../motionpatheditmode). |
...
| [RotationCenter](../../aspose.slides.animation/motioneffect/rotationcenter) { get; set; } | 描述用于将运动路径旋转 X 角度的旋转中心。 读/写PointF. |
