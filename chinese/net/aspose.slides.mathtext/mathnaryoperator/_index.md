...
type: docs
weight: 8150
url: /zh/net/aspose.slides.mathtext/mathnaryoperator/
---
...
| [GrowToMatchOperandHeight](../../aspose.slides.mathtext/mathnaryoperator/growtomatchoperandheight) { get; set; } | 操作符垂直增长以匹配其操作数高度 |
...
| [LimitLocation](../../aspose.slides.mathtext/mathnaryoperator/limitlocation) { get; set; } | 界限的位置（下标和上标） |
