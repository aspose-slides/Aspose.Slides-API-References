...
description: 指定相对于周围文本的垂直对齐方式 可能的值是顶部底部和中心 默认值Center
type: docs
weight: 20
url: /zh/net/aspose.slides.mathtext/imathmatrix/basejustification/
---
## IMathMatrix.BaseJustification property

指定相对于周围文本的垂直对齐方式。 可能的值是顶部、底部和中心。 默认值：Center
