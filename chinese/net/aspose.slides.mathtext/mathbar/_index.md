...
type: docs
weight: 7850
url: /zh/net/aspose.slides.mathtext/mathbar/
---
## MathBar class
...
| 姓名 | 描述 |
| --- | --- |
| [MathBar](mathbar#constructor)(IMathElement) | 用overbar（顶部位置）初始化MathBar |
| [MathBar](mathbar#constructor_1)(IMathElement, MathTopBotPositions) | 用指定位置初始化 MathBar |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [Base](../../aspose.slides.mathtext/mathbar/base) { get; } | 基本参数 |
| [Position](../../aspose.slides.mathtext/mathbar/position) { get; set; } | 柱线的位置。 默认值:顶部 |
