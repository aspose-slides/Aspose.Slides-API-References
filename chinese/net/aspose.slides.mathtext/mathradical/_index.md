...
type: docs
weight: 8210
url: /zh/net/aspose.slides.mathtext/mathradical/
---
## MathRadical class
...
| 姓名 | 描述 |
| --- | --- |
| [Base](../../aspose.slides.mathtext/mathradical/base) { get; } | 基本参数 |
| [Degree](../../aspose.slides.mathtext/mathradical/degree) { get; } | 度数参数 |
| [HideDegree](../../aspose.slides.mathtext/mathradical/hidedegree) { get; set; } | 隐藏度数 当为真时，度数不显示，如√𝑥 |
