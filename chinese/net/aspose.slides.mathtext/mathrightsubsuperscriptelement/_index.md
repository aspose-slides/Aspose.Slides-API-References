...
type: docs
weight: 8230
url: /zh/net/aspose.slides.mathtext/mathrightsubsuperscriptelement/
---
...
| 姓名 | 描述 |
| --- | --- |
| [AlignScripts](../../aspose.slides.mathtext/mathrightsubsuperscriptelement/alignscripts) { get; set; } | 指定下标/上标的对齐方式。 true 时，下标和上标相互水平对齐。 false 时，它们与base 的形状紧缩。 默认值为false。 |
