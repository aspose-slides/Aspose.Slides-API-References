...
| [IsReadOnly](../../aspose.slides.mathtext/mathblock/isreadonly) { get; } | 返回 false，因为子元素集合可以修改。 |
...
| override [Enclose](../../aspose.slides.mathtext/mathblock/enclose#enclose_1)(char, char) | 将此块的子元素括在指定字符中，例如括号或其他字符，如 framing |
...
| [JoinBlock](../../aspose.slides.mathtext/mathblock/joinblock)(IMathBlock) | 将另一个数学块与这个 连接起来 |
...
| [WriteAsMathMl](../../aspose.slides.mathtext/mathblock/writeasmathml)(Stream) | 保存此内容[`MathBlock`](../mathblock)作为 MathML |
