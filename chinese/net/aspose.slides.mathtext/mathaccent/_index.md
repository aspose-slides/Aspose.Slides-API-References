...
description: 指定重音函数由一个基础和一个组合变音标记组成 示例́
type: docs
weight: 7810
...
| [Character](../../aspose.slides.mathtext/mathaccent/character) { get; set; } | 重音字符 该值应在 (U+0300–U+036F) 或 (U+20D0–U+20EF) 的范围内 默认值：结合 Circumflex Accent (U+0302) |
