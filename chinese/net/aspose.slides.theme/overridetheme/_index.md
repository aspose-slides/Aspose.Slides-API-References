...
| [IsEmpty](../../aspose.slides.theme/overridetheme/isempty) { get; } | 真值意味着 ColorScheme、FontScheme、FormatScheme 为 null，并且禁用了使用此主题对象的任何覆盖。 只读Boolean. |
...
| [InitColorSchemeFromInherited](../../aspose.slides.theme/overridetheme/initcolorschemefrominherited)() | 使用新对象初始化 ColorScheme，以覆盖 InheritedTheme 的 ColorScheme。并用 InheritedTheme. 的 ColorScheme 的数据初始化这个新对象的数据 |
| [InitFontScheme](../../aspose.slides.theme/overridetheme/initfontscheme)() | 使用用于覆盖 InheritedTheme 的 FontScheme 的新对象初始化 FontScheme。 |
| [InitFontSchemeFrom](../../aspose.slides.theme/overridetheme/initfontschemefrom)(IFontScheme) | 使用用于覆盖 InheritedTheme 的 FontScheme 的新对象初始化 FontScheme。 |
