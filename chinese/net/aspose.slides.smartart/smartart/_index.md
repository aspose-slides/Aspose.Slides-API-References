...
type: docs
weight: 9790
url: /zh/net/aspose.slides.smartart/smartart/
---
## SmartArt class
...
| [IsReversed](../../aspose.slides.smartart/smartart/isreversed) { get; set; } | 如果图表支持反转，则返回或设置 SmartArt 图表关于（从左到右）LTR 或（从右到左）RTL 的状态。 读/写Boolean. |
