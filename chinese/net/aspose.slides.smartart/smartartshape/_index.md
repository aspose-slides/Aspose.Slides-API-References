...
description: 代表 SmartArt 形状
type: docs
weight: 9850
url: /zh/net/aspose.slides.smartart/smartartshape/
---
## SmartArtShape class
...
| virtual [FillFormat](../../aspose.slides/shape/fillformat) { get; } | 返回包含形状填充格式属性的 FillFormat 对象。 注意：对于没有填充属性的某些类型的形状可以返回 null。 只读[`IFillFormat`](../../aspose.slides/ifillformat). |
...
| virtual [LineFormat](../../aspose.slides/shape/lineformat) { get; } | 返回包含形状的线条格式属性的 LineFormat 对象。 注意：对于没有线条属性的某些类型的形状，可以返回 null。 只读[`ILineFormat`](../../aspose.slides/ilineformat). |
| [Name](../../aspose.slides/shape/name) { get; set; } | 返回或设置形状的名称。 不能为空。如果需要，使用空字符串值。 读/写String. |
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | 获取幻灯片范围内的唯一形状标识符。 只读UInt32. 另请参阅[`UniqueId`](../../aspose.slides/shape/uniqueid)用于在表示范围内获取唯一的形状标识符。 |
...
| override [ShapeType](../../aspose.slides.smartart/smartartshape/shapetype) { get; set; } | 返回或设置几何预设类型。 注意：在更改值时，所有调整值将重置为其默认值。 读/写[`ShapeType`](../../aspose.slides/shapetype). |
...
| virtual [ThreeDFormat](../../aspose.slides/shape/threedformat) { get; } | 返回对形状产生 3d 影响的 ThreeDFormat 对象。 注意：对于不具有 3d 属性的某些类型的形状，可以返回 null。 只读[`IThreeDFormat`](../../aspose.slides/ithreedformat). |
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | 获取表示范围内的唯一形状标识符。 只读UInt32. 另请参阅[`OfficeInteropShapeId`](../../aspose.slides/shape/officeinteropshapeid)用于在幻灯片范围内获取唯一的形状标识符。 |
...
| [SetGeometryPath](../../aspose.slides/geometryshape/setgeometrypath)(IGeometryPath) | 更新形状几何[`IGeometryPath`](../../aspose.slides/igeometrypath)目的。坐标必须相对于形状的 left 上角。 更改形状的类型（[`ShapeType`](../../aspose.slides/geometryshape/shapetype) ） 至Custom |
| [SetGeometryPaths](../../aspose.slides/geometryshape/setgeometrypaths)(IGeometryPath[]) | 从数组更新形状几何[`IGeometryPath`](../../aspose.slides/igeometrypath).坐标必须相对于形状的 left 上角。 更改形状的类型（[`ShapeType`](../../aspose.slides/geometryshape/shapetype) ） 至Custom |
