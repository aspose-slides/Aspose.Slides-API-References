...
description: 更改母版幻灯片页码占位符和所有子页码占位符的可见性 子占位符意味着占位符包含在依赖的笔记幻灯片上 依赖于笔记幻灯片使用并依赖于主笔记幻灯片
type: docs
weight: 70
...
更改母版幻灯片页码占位符和所有子页码占位符的可见性。 子占位符意味着占位符包含在依赖的笔记幻灯片上。 依赖于笔记幻灯片使用并依赖于主笔记幻灯片。
