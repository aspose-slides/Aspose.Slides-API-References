...
| [FirstCol](../../aspose.slides/table/firstcol) { get; set; } | 确定表格的第一列是否必须使用特殊格式绘制。 读/写Boolean. |
| [FirstRow](../../aspose.slides/table/firstrow) { get; set; } | 确定表格的第一行是否必须使用特殊格式绘制。 读/写Boolean. |
...
| [LastCol](../../aspose.slides/table/lastcol) { get; set; } | 确定表格的最后一列是否必须使用特殊格式绘制。 读/写Boolean. |
| [LastRow](../../aspose.slides/table/lastrow) { get; set; } | 确定表格的最后一行是否必须使用特殊格式绘制。 读/写Boolean. |
...
| [RightToLeft](../../aspose.slides/table/righttoleft) { get; set; } | 判断表是否有从右到左的读取顺序。 读写Boolean. |
