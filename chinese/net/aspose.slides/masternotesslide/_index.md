...
type: docs
weight: 7300
url: /zh/net/aspose.slides/masternotesslide/
---
...
| override [ShowMasterShapes](../../aspose.slides/masternotesslide/showmastershapes) { get; set; } | 指定母版幻灯片上的形状是否应显示在幻灯片上。 对于母版幻灯片本身，此属性始终返回`错误的`. 读/写Boolean. |
