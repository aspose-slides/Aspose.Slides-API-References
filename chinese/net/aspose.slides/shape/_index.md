...
| [OfficeInteropShapeId](../../aspose.slides/shape/officeinteropshapeid) { get; } | 获取幻灯片范围内的唯一形状标识符。 只读UInt32. 另请参阅[`UniqueId`](./uniqueid)用于在表示范围内获取唯一的形状标识符。 |
...
| [UniqueId](../../aspose.slides/shape/uniqueid) { get; } | 获取表示范围内的唯一形状标识符。 只读UInt32. 另请参阅[`OfficeInteropShapeId`](./officeinteropshapeid)用于在幻灯片范围内获取唯一的形状标识符。 |
...
| [GetThumbnail](../../aspose.slides/shape/getthumbnail#getthumbnail)() | 返回形状缩略图。 ShapeThumbnailBounds。默认使用形状缩略图边界类型。 |
