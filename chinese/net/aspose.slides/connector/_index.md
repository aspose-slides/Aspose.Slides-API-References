...
type: docs
weight: 2520
url: /zh/net/aspose.slides/connector/
---
## Connector class
...
| [EndShapeConnectionSiteIndex](../../aspose.slides/connector/endshapeconnectionsiteindex) { get; set; } | 返回或设置结束形状的连接点索引。 读/写UInt32. |
...
| [StartShapeConnectedTo](../../aspose.slides/connector/startshapeconnectedto) { get; set; } | 返回或设置将连接器的开头附加到的形状。 读/写[`IShape`](../ishape). |
