...
| [Height](../../aspose.slides/row/height) { get; } | 返回行高。 只读Double. |
...
| [SetTextFormat](../../aspose.slides/row/settextformat#settextformat_2)(ITextFrameFormat) | 将定义的文本框架格式属性设置为所有行单元格的文本框架。 |
