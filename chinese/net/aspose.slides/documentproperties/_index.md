...
type: docs
weight: 2640
url: /zh/net/aspose.slides/documentproperties/
---
...
| 姓名 | 描述 |
| --- | --- |
| [DocumentProperties](documentproperties)() | 初始化类的新实例[`DocumentProperties`](../documentproperties). |
...
| [Comments](../../aspose.slides/documentproperties/comments) { get; set; } | 返回或设置演示文稿的评论。 读/写String. |
...
| [LastSavedTime](../../aspose.slides/documentproperties/lastsavedtime) { get; set; } | 返回上次修改演示文稿的日期。 在 Presentation.DocumentProperties 的情况下为只读（因为它将在 IPresentation 对象保存过程中在内部更新）。 可以通过方法返回的 DocumentProperties 实例进行更改[`ReadDocumentProperties`](../ipresentationinfo/readdocumentproperties) 请参见示例[`UpdateDocumentProperties`](../ipresentationinfo/updatedocumentproperties)方法摘要. |
...
| [Subject](../../aspose.slides/documentproperties/subject) { get; set; } | 返回或设置演示文稿的主题。 读/写String. |
...
| [GetCustomPropertyValue](../../aspose.slides/documentproperties/getcustompropertyvalue#getcustompropertyvalue_3)(string, out float) | 从自定义属性中获取一个命名的浮点值。 |
...
| [SetCustomPropertyValue](../../aspose.slides/documentproperties/setcustompropertyvalue#setcustompropertyvalue)(string, bool) | 设置一个命名的布尔自定义属性。 |
...
| [SetCustomPropertyValue](../../aspose.slides/documentproperties/setcustompropertyvalue#setcustompropertyvalue_1)(string, double) | 设置命名的双重自定义属性。 |
| [SetCustomPropertyValue](../../aspose.slides/documentproperties/setcustompropertyvalue#setcustompropertyvalue_3)(string, float) | 设置一个命名的浮动自定义属性。 |
