...
type: docs
weight: 760
url: /zh/net/aspose.slides/audiocollection/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Count](../../aspose.slides/audiocollection/count) { get; } | 返回集合中的多个音频文件。 只读Int32. |
...
| 姓名 | 描述 |
| --- | --- |
| [AddAudio](../../aspose.slides/audiocollection/addaudio#addaudio_1)(byte[]) | 从字节数组创建音频并将其添加到演示文稿中。 |
| [AddAudio](../../aspose.slides/audiocollection/addaudio#addaudio)(IAudio) | 添加来自另一个演示文稿的音频文件的副本。 |
| [AddAudio](../../aspose.slides/audiocollection/addaudio#addaudio_2)(Stream) | 从流中创建音频并将其添加到演示文稿中。 |
| [AddAudio](../../aspose.slides/audiocollection/addaudio#addaudio_3)(Stream, LoadingStreamBehavior) | 从流中创建音频并将其添加到演示文稿中。 |
