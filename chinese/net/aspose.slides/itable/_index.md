...
type: docs
weight: 6650
url: /zh/net/aspose.slides/itable/
---
## ITable interface
...
| 姓名 | 描述 |
| --- | --- |
| [AsIBulkTextFormattable](../../aspose.slides/itable/asibulktextformattable) { get; } | 允许获取基本 IBulkTextFormattable 接口。 只读[`IBulkTextFormattable`](../ibulktextformattable). |
...
| [FirstCol](../../aspose.slides/itable/firstcol) { get; set; } | 确定表格的第一列是否必须使用特殊格式绘制。 读/写Boolean. |
| [FirstRow](../../aspose.slides/itable/firstrow) { get; set; } | 确定表格的第一行是否必须使用特殊格式绘制。 读/写Boolean. |
...
| [LastCol](../../aspose.slides/itable/lastcol) { get; set; } | 确定表格的最后一列是否必须使用特殊格式绘制。 读/写Boolean. |
| [LastRow](../../aspose.slides/itable/lastrow) { get; set; } | 确定表格的最后一行是否必须使用特殊格式绘制。 读/写Boolean. |
| [RightToLeft](../../aspose.slides/itable/righttoleft) { get; set; } | 判断表是否有从右到左的读取顺序。 读写Boolean. |
