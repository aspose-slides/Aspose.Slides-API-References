...
description: 此类包含文本部分格式属性不像IPortionFormatEffectiveData./iportionformateffectivedata 这个类的所有属性都是可写的
type: docs
weight: 8760
...
此类包含文本部分格式属性。不像[`IPortionFormatEffectiveData`](../iportionformateffectivedata) 这个类的所有属性都是可写的。
...
| 姓名 | 描述 |
| --- | --- |
| [PortionFormat](portionformat)() | 初始化一个新的实例[`PortionFormat`](../portionformat)类. |
...
| [ComplexScriptFont](../../aspose.slides/baseportionformat/complexscriptfont) { get; set; } | 返回或设置复杂脚本字体信息。 Null 表示字体未定义，应从 Master 继承。 读/写[`IFontData`](../ifontdata). |
...
| [IsHardUnderlineFill](../../aspose.slides/baseportionformat/ishardunderlinefill) { get; set; } | 确定下划线样式是否有自己的 FillFormat 属性或继承自文本的 FillFormat 属性 。 读/写[`NullableBool`](../nullablebool). |
| [IsHardUnderlineLine](../../aspose.slides/baseportionformat/ishardunderlineline) { get; set; } | 确定下划线样式是有自己的 LineFormat 属性还是继承自文本的 LineFormat 属性 读/写[`NullableBool`](../nullablebool). |
...
| [NormaliseHeight](../../aspose.slides/baseportionformat/normaliseheight) { get; set; } | 确定是否应标准化文本的高度。未应用继承。 读/写[`NullableBool`](../nullablebool). |
| [ProofDisabled](../../aspose.slides/baseportionformat/proofdisabled) { get; set; } | 确定是否不应校对文本。未应用继承。 读/写[`NullableBool`](../nullablebool). |
| [SmartTagClean](../../aspose.slides/portionformat/smarttagclean) { get; set; } | 确定是否应清理智能标记。未应用继承。 读/写Boolean. |
...
| [UnderlineLineFormat](../../aspose.slides/baseportionformat/underlinelineformat) { get; } | 返回用于勾画下划线的 LineFormat 属性。未应用继承。 只读[`ILineFormat`](../ilineformat). |
...
| [GetEffective](../../aspose.slides/portionformat/geteffective)() | 获取应用了继承的有效部分格式化数据。 |
...
为了获得有效的格式化参数值，包括继承你需要使用[`GetEffective`](./geteffective) 方法返回一个[`IPortionFormatEffectiveData`](../iportionformateffectivedata)实例。
