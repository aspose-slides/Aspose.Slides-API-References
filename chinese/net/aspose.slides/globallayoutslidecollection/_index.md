...
description: 表示演示文稿中所有布局幻灯片的集合 使用添加/克隆 布局幻灯片的方法扩展 LayoutSlideCollection 类以合并主布局幻灯片的各个集合
type: docs
weight: 4520
url: /zh/net/aspose.slides/globallayoutslidecollection/
---
## GlobalLayoutSlideCollection class

表示演示文稿中所有布局幻灯片的集合。 使用添加/克隆 布局幻灯片的方法扩展 LayoutSlideCollection 类，以合并主布局幻灯片的各个集合。
...
| [AddClone](../../aspose.slides/globallayoutslidecollection/addclone#addclone)(ILayoutSlide) | 将指定布局幻灯片的副本添加到演示文稿中。 |
| [AddClone](../../aspose.slides/globallayoutslidecollection/addclone#addclone_1)(ILayoutSlide, IMasterSlide) | 将指定布局幻灯片的副本添加到演示文稿中。 |
