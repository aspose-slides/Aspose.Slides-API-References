...
type: docs
weight: 8500
url: /zh/net/aspose.slides/oleobjectframe/
---
...
| [EmbeddedFileName](../../aspose.slides/oleobjectframe/embeddedfilename) { get; } | 返回嵌入式 OLE 对象的路径 |
...
| [SetEmbeddedData](../../aspose.slides/oleobjectframe/setembeddeddata)(IOleEmbeddedDataInfo) | 设置有关 OLE 嵌入数据的信息。  此方法更改对象的属性以反映新数据， 将 IsObjectLink 标志设置为 false，表示 OLE 对象已嵌入。 |
