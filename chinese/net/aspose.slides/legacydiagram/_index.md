...
| [ConvertToGroupShape](../../aspose.slides/legacydiagram/converttogroupshape)() | 将旧图转换为可编辑的组形状。 创建的 GroupShape 对象在同一位置添加到父组形状。 |
| [ConvertToSmartArt](../../aspose.slides/legacydiagram/converttosmartart)() | 将旧图转换为可编辑的 SmartArt 对象。 创建的 SmartArt 对象在同一位置添加到父组形状。 |
