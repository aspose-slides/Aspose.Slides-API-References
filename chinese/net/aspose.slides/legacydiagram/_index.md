...
type: docs
weight: 6970
url: /zh/net/aspose.slides/legacydiagram/
---
## LegacyDiagram class
...
| [ConvertToGroupShape](../../aspose.slides/legacydiagram/converttogroupshape)() | 将旧式图表转换为可编辑的组形状。 创建的 GroupShape 对象在相同位置添加到父组形状。 |
| [ConvertToSmartArt](../../aspose.slides/legacydiagram/converttosmartart)() | 将旧图转换为可编辑的 SmartArt 对象。 创建的 SmartArt 对象添加到父组形状的相同位置。 |
