...
| [Shape](../../aspose.slides/imoderncomment/shape) { get; } | 返回与评论关联的形状。 只读[`IShape`](../ishape). |
...
| [TextSelectionStart](../../aspose.slides/imoderncomment/textselectionstart) { get; set; } | 如果注释与自选图形关联，则返回或设置文本框内文本选择的起始位置。 读/写Int32. |
