...
| [getChartsFromWorksheet(String worksheetName)](#getChartsFromWorksheet-java.lang.String-) | Mengambil kamus berisi indeks dan nama semua grafik di worksheet yang ditentukan dari workbook Excel. |
...
| --- | --- | --- |
| formula | java.lang.String | Formula atau ekspresi rentang (mis., "Sheet1!A1:B3") yang digunakan untuk mengidentifikasi sel target. |
| skipHiddenCells | boolean | Jika true, sel tersembunyi (mis., pada baris atau kolom tersembunyi) akan dikecualikan dari hasil. |

**Mengembalikan:**
com.aspose.ms.System.Collections.Generic.List<com.aspose.slides.IExcelDataCell> - Daftar hanya-baca dari sel yang cocok dengan formula yang ditentukan.
...
Mengambil kamus berisi indeks dan nama semua grafik di worksheet yang ditentukan dari workbook Excel.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| worksheetName | java.lang.String | Nama worksheet untuk mencari grafik. |

**Mengembalikan:**
com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.Integer,java.lang.String> - Kamus dimana kunci adalah indeks grafik dan nilai adalah nama grafik.
