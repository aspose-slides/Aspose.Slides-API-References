...
>      // Menambahkan sebuah bingkai audio ke slide dengan posisi dan ukuran yang ditentukan.
...
| [isCameo()](#isCameo--) | Menentukan apakah PictureFrame adalah objek Cameo atau bukan. |
...
Mengembalikan atau mengatur tipe AutoShape untuk PictureFrame. Terdapat semua item yang diizinkan dari set [ShapeType](../../com.aspose.slides/shapetype), kecuali semua jenis garis:
...
Mengembalikan atau mengatur skala tinggi (relatif terhadap ukuran gambar asli) dari bingkai gambar. Nilai 1.0 mengacu pada 100%. Baca/tulis float.
...
Mengembalikan atau mengatur skala lebar (relatif terhadap ukuran gambar asli) dari bingkai gambar. Nilai 1.0 mengacu pada 100%. Baca/tulis float.
...
Menentukan apakah PictureFrame adalah objek Cameo atau bukan. Hanya-baca boolean.
