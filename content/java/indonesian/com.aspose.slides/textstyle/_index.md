...
| [getEffective()](#getEffective--) | Mendapatkan data pemformatan gaya teks yang efektif dengan pewarisan yang diterapkan. |
### getVersion() {#getVersion--}
```
...
| --- | --- | --- |
| index | int | Indeks level berbasis nol. Harus berada dalam interval 0..8. |
