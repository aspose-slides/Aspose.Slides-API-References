...
Objek tidak dapat diubah yang berisi properti format bullet paragraf yang efektif.
...
| Method | Description |
| --- | --- |
| [getType()](#getType--) | Mengembalikan jenis bullet dari sebuah paragraf. |
...
| [getNumberedBulletStartWith()](#getNumberedBulletStartWith--) | Mengembalikan angka pertama yang digunakan untuk grup bullet bernomor. |
...
| [getFillFormat()](#getFillFormat--) | Mengembalikan format isi bullet dari sebuah paragraf. |
### getType() {#getType--}
```
...
Mengembalikan jenis bullet dari sebuah paragraf. Hanya-baca [BulletType](../../com.aspose.slides/bullettype).
...
Mengembalikan angka pertama yang digunakan untuk grup bullet bernomor. Hanya-baca short.
...
Mengembalikan format isi bullet dari sebuah paragraf. Hanya-baca [IFillFormatEffectiveData](../../com.aspose.slides/ifillformateffectivedata).
...
>  try {
>      // Anggap bahwa shape pertama pada slide pertama adalah AutoShape dengan beberapa teks...
