...
| [getBasePath()](#getBasePath--) | Menentukan jalur dasar di mana dokumen dengan sumber daya akan disimpan. |
| [setBasePath(String value)](#setBasePath-java.lang.String-) | Menentukan jalur dasar di mana dokumen dengan sumber daya akan disimpan. |
...
| [getHandleRepeatedSpaces()](#getHandleRepeatedSpaces--) | Menentukan bagaimana karakter spasi reguler berulang harus ditangani selama ekspor Markdown. |
| [setHandleRepeatedSpaces(int value)](#setHandleRepeatedSpaces-int-) | Menentukan bagaimana karakter spasi reguler berulang harus ditangani selama ekspor Markdown. |
| [getRemoveEmptyLines()](#getRemoveEmptyLines--) | Jika diatur ke true, menghapus baris kosong atau hanya spasi dari output Markdown akhir. |
| [setRemoveEmptyLines(boolean value)](#setRemoveEmptyLines-boolean-) | Jika diatur ke true, menghapus baris kosong atau hanya spasi dari output Markdown akhir. |
...
Menentukan jalur dasar di mana dokumen dengan sumber daya akan disimpan. Default adalah direktori saat ini dari aplikasi.
...
Mendapatkan atau mengatur string format yang digunakan untuk header nomor slide dalam output Markdown. Format harus menyertakan placeholder "\{0\}", yang akan diganti dengan indeks slide saat ekspor. Contoh: "\# Slide \{0\}" akan menghasilkan "\# Slide 1", "\# Slide 2", dll.
...
Menentukan bagaimana karakter spasi reguler berulang harus ditangani selama ekspor Markdown. Properti ini mendefinisikan apakah spasi berurutan: - dipertahankan sebagai spasi reguler, - bergantian antara spasi reguler dan entitas non-breaking space (�), - atau sepenuhnya diganti (setelah yang pertama) dengan non-breaking space untuk mempertahankan keselarasan visual dalam output Markdown. Nilai default adalah [HandleRepeatedSpaces.AlternateSpacesToNbsp](../../com.aspose.slides/handlerepeatedspaces\#AlternateSpacesToNbsp).
...
Jika diatur ke true, menghapus baris kosong atau hanya spasi dari output Markdown akhir. Default adalah false.
...
Terjadi untuk setiap gambar SVG selama ekspor Markdown. Memungkinkan mengganti penyimpanan default dan pembuatan tautan. Jika tidak ditangani, SVG disimpan secara lokal dengan tautan relatif.
