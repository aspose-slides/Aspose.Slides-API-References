...
**Mengembalikan:**
[ITab](../../com.aspose.slides/itab) - Tab ditambahkan.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| obj | java.lang.Object | TabsEx yang dibandingkan dengan TabsEx saat ini. |

**Mengembalikan:**
boolean - **true** jika TabsEx yang ditentukan sama dengan TabsEx saat ini; jika tidak, **false**.
### iterator() {#iterator--}
```
