...
| Metode | Deskripsi |
| --- | --- |
| [getSequence()](#getSequence--) | Mengembalikan urutan untuk efek. |
...
| [getTiming()](#getTiming--) | Mendefinisikan nilai timing untuk efek. |
| [setTiming(ITiming value)](#setTiming-com.aspose.slides.ITiming-) | Mendefinisikan nilai timing untuk efek. |
...
| [getAfterAnimationType()](#getAfterAnimationType--) | Mendefinisikan tipe after animation untuk efek. |
| [setAfterAnimationType(int value)](#setAfterAnimationType-int-) | Mendefinisikan tipe after animation untuk efek. |
| [getAfterAnimationColor()](#getAfterAnimationColor--) | Mendefinisikan warna after animation untuk efek. |
| [setAfterAnimationColor(IColorFormat value)](#setAfterAnimationColor-com.aspose.slides.IColorFormat-) | Mendefinisikan warna after animation untuk efek. |
| [getAnimateTextType()](#getAnimateTextType--) | Mendefinisikan tipe animate text untuk efek. |
| [setAnimateTextType(int value)](#setAnimateTextType-int-) | Mendefinisikan tipe animate text untuk efek. |
...
Mengembalikan urutan untuk efek. Baca-saja [ISequence](../../com.aspose.slides/isequence).
...
Mendefinisikan nilai timing untuk efek. Baca/tulis [ITiming](../../com.aspose.slides/itiming).
...
Mendefinisikan tipe after animation untuk efek. Baca/tulis AfterAnimationType (\#getAfterAnimationType.getAfterAnimationType/\#setAfterAnimationType(int).setAfterAnimationType(int)).
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Ubah After animation efek menjadi "Hide on Next Mouse Click"
...
Mendefinisikan warna after animation untuk efek. Baca/tulis [IColorFormat](../../com.aspose.slides/icolorformat).
...
Mendefinisikan tipe animate text untuk efek. Teks bentuk dapat dianimasikan per huruf, per kata, atau sekaligus. Baca/tulis AnimateTextType (\#getAnimateTextType.getAnimateTextType/\#setAnimateTextType(int).setAnimateTextType(int)).
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Ubah tipe Animate text efek menjadi "Per huruf"
