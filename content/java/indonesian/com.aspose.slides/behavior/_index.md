...
| [getAccumulate()](#getAccumulate--) | Mewakili apakah perilaku animasi terakumulasi. |
| [setAccumulate(byte value)](#setAccumulate-byte-) | Mewakili apakah perilaku animasi terakumulasi. |
...
| [getTiming()](#getTiming--) | Mewakili properti waktu untuk perilaku efek. |
| [setTiming(ITiming value)](#setTiming-com.aspose.slides.ITiming-) | Mewakili properti waktu untuk perilaku efek. |
### getParent_Immediate() {#getParent-Immediate--}
```
...
Mewakili apakah perilaku animasi terakumulasi. Baca/tulis [NullableBool](../../com.aspose.slides/nullablebool).
...
Mewakili properti perilaku. Hanya-baca [IBehaviorPropertyCollection](../../com.aspose.slides/ibehaviorpropertycollection).
...
Mewakili properti waktu untuk perilaku efek. Baca/tulis [ITiming](../../com.aspose.slides/itiming).
