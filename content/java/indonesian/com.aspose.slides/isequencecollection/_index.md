...
| Metode | Deskripsi |
| --- | --- |
| [getCount()](#getCount--) | Mengembalikan jumlah elemen dalam koleksi Read-only int. |
...
Mengembalikan jumlah elemen dalam koleksi Read-only int.
...
| --- | --- | --- |
| shapeTrigger | [IShape](../../com.aspose.slides/ishape) | Shape objek [IShape](../../com.aspose.slides/ishape) |
