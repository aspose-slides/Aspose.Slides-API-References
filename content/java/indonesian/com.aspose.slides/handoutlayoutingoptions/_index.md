...
Mewakili mode tata letak handout presentasi untuk ekspor.
## Konstruktor
...
| [getPrintSlideNumbers()](#getPrintSlideNumbers--) | Menentukan apakah akan mencetak nomor slide yang ditampilkan atau tidak. |
| [setPrintSlideNumbers(boolean value)](#setPrintSlideNumbers-boolean-) | Menentukan apakah akan mencetak nomor slide yang ditampilkan atau tidak. |
| [getPrintFrameSlide()](#getPrintFrameSlide--) | Menentukan apakah menggambar bingkai di sekitar slide yang ditampilkan atau tidak. |
| [setPrintFrameSlide(boolean value)](#setPrintFrameSlide-boolean-) | Menentukan apakah menggambar bingkai di sekitar slide yang ditampilkan atau tidak. |
| [getPrintComments()](#getPrintComments--) | Menentukan apakah akan menampilkan komentar pada slide atau tidak |
| [setPrintComments(boolean value)](#setPrintComments-boolean-) | Menentukan apakah akan menampilkan komentar pada slide atau tidak |
...
Menentukan apakah akan mencetak nomor slide yang ditampilkan atau tidak.
...
Menentukan apakah akan menampilkan komentar pada slide atau tidak
