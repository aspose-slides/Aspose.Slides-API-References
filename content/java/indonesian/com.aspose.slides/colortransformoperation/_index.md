...
| Bidang | Deskripsi |
| --- | --- |
| [Tint](#Tint) | Memberi nuansa pada warna. |
| [Shade](#Shade) | Memberi bayangan pada warna. |
...
| [SetAlpha](#SetAlpha) | Mendefinisikan komponen alfa dari warna. |
...
| [MultiplyBlue](#MultiplyBlue) | Mengalikan komponen biru warna dengan nilai parameter. |
| [Gamma](#Gamma) | Koreksi gamma. |
| [InverseGamma](#InverseGamma) | Koreksi gamma terbalik. |
### Tint {#Tint}
```
public static final int Tint
```

Memberi nuansa pada warna. Parameter berada dalam rentang antara 0 (warna asli) dan 1 (putih).
...
Memberi bayangan pada warna. Parameter berada dalam rentang antara 0 (warna asli) dan 1 (hitam).
...
Mendefinisikan komponen alfa warna. Parameter berada dalam rentang antara 0 (transparan) dan 1 (tidak tembus).
...
Koreksi gamma terbalik. Parameter diabaikan.