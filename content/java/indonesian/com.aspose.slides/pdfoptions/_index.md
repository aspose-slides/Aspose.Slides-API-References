...
Menawarkan opsi yang mengontrol bagaimana presentasi disimpan dalam format Pdf.
...
| [getInkOptions()](#getInkOptions--) | Menawarkan opsi yang mengontrol tampilan objek Ink dalam dokumen yang diekspor. |
...
| [getRasterizeUnsupportedFontStyles()](#getRasterizeUnsupportedFontStyles--) | Menunjukkan apakah teks harus di-raster menjadi bitmap dan disimpan ke PDF ketika font tidak mendukung gaya tebal. |
| [setRasterizeUnsupportedFontStyles(boolean value)](#setRasterizeUnsupportedFontStyles-boolean-) | Menunjukkan apakah teks harus di-raster menjadi bitmap dan disimpan ke PDF ketika font tidak mendukung gaya tebal. |
...
Pemilihan rasio kompresi gambar terbaik memerlukan komputasi berat dan memakan RAM tambahan, dan opsi ini false secara default.
...
Menentukan apakah Aspose.Slides akan menyematkan font umum untuk teks ASCII (rentang kode 33..127). Font untuk kode karakter lebih dari 127 selalu disematkan. Daftar font umum mencakup 14 font dasar PDF dan font tambahan yang ditentukan pengguna. Baca/tulis boolean.
...
Menunjukkan apakah teks harus di-raster menjadi bitmap dan disimpan ke PDF ketika font tidak mendukung gaya tebal. Pendekatan ini dapat meningkatkan kualitas teks dalam PDF yang dihasilkan untuk font tertentu. Baca/tulis boolean.
...
Default adalah **true**. Dokumen PDF dapat berisi grafis vektor dan gambar raster. Jika SaveMetafilesAsPng disetel true maka gambar Metafile sumber dikonversi ke format Png dan disimpan ke Pdf sebagai gambar raster. Jika SaveMetafilesAsPng disetel false maka Metafile sumber dikonversi ke grafis vektor Pdf. Setiap pendekatan memiliki kelebihan dan kekurangan. Misalnya, jika Metafile dikonversi ke PNG, maka beberapa kehilangan kualitas mungkin terjadi selama skala dokumen yang dihasilkan. Jika Metafile dikonversi ke grafis vektor Pdf, maka masalah kinerja pada alat penampil Pdf mungkin terjadi.
...
Nilai: Efek parameter ini tergantung pada beberapa faktor. Algoritma berusaha mendapatkan ukuran gambar keluaran terbaik berdasarkan nilai properti, ukuran gambar sumber, dan ukuran bingkai gambar. Penggunaan nilai properti yang serupa dapat memberikan hasil yang sama. Disarankan menggunakan langkah 16 atau 32 untuk mendapatkan efek yang terlihat.
