...
| Metode | Deskripsi |
| --- | --- |
| [getAsCells()](#getAsCells--) | Tidak diperbolehkan menetapkan nilai null. |
| [setAsCells(IChartCellCollection value)](#setAsCells-com.aspose.slides.IChartCellCollection-) | Tidak diperbolehkan menetapkan nilai null. |
...
| [getCellsAddressInWorkbook()](#getCellsAddressInWorkbook--) | Jika properti DataSourceType adalah DataSourceType.Worksheet maka metode ini mengembalikan alamat sel di workbook yang mewakili data string. |
...
Tidak diperbolehkan menetapkan nilai null. Nilai yang dikembalikan selalu tidak null. Baca/tulis [IChartCellCollection](../../com.aspose.slides/ichartcellcollection).
...
Jika properti DataSourceType adalah DataSourceType.Worksheet maka metode ini mengembalikan alamat sel di workbook yang mewakili data string. Jika tidak, mengembalikan string kosong.
