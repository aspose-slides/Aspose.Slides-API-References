...
| [getDefaultDataLabelFormat()](#getDefaultDataLabelFormat--) | Mengembalikan format default semua label data dalam koleksi. |
| [getLeaderLinesFormat()](#getLeaderLinesFormat--) | Mewakili format garis pemimpin label data. |
| [isVisible()](#isVisible--) | False berarti label data tidak terlihat secara default (dan sehingga semua flag Show*- (ShowValue, ...) dari properti DefaultDataLabelFormat adalah false). |
| [hide()](#hide--) | Sembunyikan label data secara default dengan mengatur semua flag Show*- (ShowValue, ...) pada properti DefaultDataLabelFormat ke keadaan false. |
...
| [getParentSeries()](#getParentSeries--) | Mengembalikan seri diagram induk. |
...
Mengembalikan format default semua label data dalam koleksi. Hanya-baca [IDataLabelFormat](../../com.aspose.slides/idatalabelformat).
...
False berarti label data tidak terlihat secara default (dan sehingga semua flag Show*- (ShowValue, ...) dari properti DefaultDataLabelFormat adalah false). Hanya-baca  boolean .

--------------------

Jika label data terlihat secara default, Anda dapat menyembunyikannya secara default dengan metode Hide(). Tetapi jika label data tidak terlihat secara default (IsVisible false) Anda dapat membuat label data "terlihat secara default" dengan mengatur flag Show*- (ShowValue, ...) pada properti DefaultDataLabelFormat ke keadaan true.
...
Sembunyikan label data secara default dengan mengatur semua flag Show*- (ShowValue, ...) pada properti DefaultDataLabelFormat ke keadaan false. IsVisible akan menjadi false setelah ini.
...
Mengembalikan seri diagram induk. Hanya-baca [IChartSeries](../../com.aspose.slides/ichartseries).
...
**Mengembalikan:**
int - Indeks dari DataLabel atau -1 jika DataLabel tidak berasal dari koleksi ini.