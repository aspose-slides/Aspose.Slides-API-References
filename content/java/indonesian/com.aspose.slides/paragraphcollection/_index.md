...
| [copyTo(IParagraph[] array, int arrayIndex)](#copyTo-com.aspose.slides.IParagraph---int-) | Menyalin elemen [IGenericCollection](../../com.aspose.slides/igenericcollection) ke dalam Array, mulai pada indeks Array tertentu. |
| [removeAt(int index)](#removeAt-int-) | Menghapus elemen pada indeks yang ditentukan dalam koleksi. |
| [remove(IParagraph item)](#remove-com.aspose.slides.IParagraph-) | Menghapus kejadian pertama dari objek tertentu dari [IGenericCollection](../../com.aspose.slides/igenericcollection). |
| [iterator()](#iterator--) | Mengembalikan enumerator yang mengiterasi koleksi. |
| [iteratorJava()](#iteratorJava--) | Mengembalikan iterator java untuk seluruh koleksi. |
| [getSlide()](#getSlide--) | Mengembalikan slide induk dari kumpulan paragraf. |
| [getPresentation()](#getPresentation--) | Mengembalikan presentasi induk dari kumpulan paragraf. |
...
| [exportToHtml(int firstParagraphIndex, int paragraphsCount, ITextToHtmlConversionOptions options)](#exportToHtml-int-int-com.aspose.slides.ITextToHtmlConversionOptions-) | Mengonversi paragraf yang ditentukan menjadi HTML dan mengembalikannya sebagai objek String. |
### getCount() {#getCount--}
```
...
Mendapatkan jumlah elemen yang sebenarnya terdapat dalam koleksi. int baca-saja.
...
**Mengembalikan:**
boolean - true jika [IGenericCollection](../../com.aspose.slides/igenericcollection) hanya-baca; selain itu, false.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| index | int | Indeks berbasis nol di mana Paragraph harus disisipkan. |
| value | [IParagraph](../../com.aspose.slides/iparagraph) | Paragraph yang disisipkan. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| index | int | Indeks berbasis nol di mana paragraf harus disisipkan. |
| value | [IParagraphCollection](../../com.aspose.slides/iparagraphcollection) | Paragraf yang disisipkan. |
### clear() {#clear--}
```
...
Menghapus kejadian pertama dari objek tertentu dari [IGenericCollection](../../com.aspose.slides/igenericcollection).
...
Mengembalikan slide induk dari kumpulan paragraf. [BaseSlide](../../com.aspose.slides/baseslide) baca-saja.
...
Mengembalikan presentasi induk dari kumpulan paragraf. [IPresentation](../../com.aspose.slides/ipresentation) baca-saja.
