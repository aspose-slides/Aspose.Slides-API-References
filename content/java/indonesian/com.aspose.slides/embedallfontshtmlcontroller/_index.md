...
| [writeAllFonts(IHtmlGenerator generator, IPresentation presentation)](#writeAllFonts-com.aspose.slides.IHtmlGenerator-com.aspose.slides.IPresentation-) | Menulis semua font yang terdapat dalam [Presentation](../../com.aspose.slides/presentation). |
...
Dipanggil sebelum rendering shape. Dipanggil sekali per setiap shape. Jika fungsi ini menulis apa pun ke generator, pembuatan gambar slide saat ini akan selesai, fragmen html yang ditambahkan akan disisipkan, dan gambar baru akan dimulai di atas gambar sebelumnya.
...
Menulis semua font yang terdapat dalam [Presentation](../../com.aspose.slides/presentation).
...
| originalFont | [IFontData](../../com.aspose.slides/ifontdata) | Font yang akan diserialkan |
| substitutedFont | [IFontData](../../com.aspose.slides/ifontdata) | Font yang diganti (jika substitusi font terjadi), null jika tidak |
