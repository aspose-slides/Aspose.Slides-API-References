...
| Metode | Deskripsi |
| --- | --- |
| [<TValue>put(String key, TValue value)](#-TValue-put-java.lang.String-TValue-) | Memasukkan nilai ke dalam penyimpanan. |
| [<TValue>get(String key)](#-TValue-get-java.lang.String-) | Mengambil data dari penyimpanan. |
| [containsKey(String key)](#containsKey-java.lang.String-) | Menentukan apakah penyimpanan berisi elemen dengan kunci yang ditentukan. |
### Storage() {#Storage--}
```
public Storage()
```
...
Memasukkan nilai ke dalam penyimpanan.
