...
| Metode | Deskripsi |
| --- | --- |
| [getSound()](#getSound--) | Mengembalikan atau menetapkan data audio yang disematkan. |
| [setSound(IAudio value)](#setSound-com.aspose.slides.IAudio-) | Mengembalikan atau menetapkan data audio yang disematkan. |
| [getSoundMode()](#getSoundMode--) | Menetapkan atau mengembalikan mode suara untuk transisi slide. |
| [setSoundMode(int value)](#setSoundMode-int-) | Menetapkan atau mengembalikan mode suara untuk transisi slide. |
| [getSoundLoop()](#getSoundLoop--) | Atribut ini menentukan apakah suara akan diputar berulang hingga peristiwa suara berikutnya terjadi dalam pertunjukan slide. |
| [setSoundLoop(boolean value)](#setSoundLoop-boolean-) | Atribut ini menentukan apakah suara akan diputar berulang hingga peristiwa suara berikutnya terjadi dalam pertunjukan slide. |
| [getAdvanceOnClick()](#getAdvanceOnClick--) | Menentukan apakah klik mouse akan memajukan slide atau tidak. |
| [setAdvanceOnClick(boolean value)](#setAdvanceOnClick-boolean-) | Menentukan apakah klik mouse akan memajukan slide atau tidak. |
...
| [getDuration()](#getDuration--) | Mengambil atau menetapkan durasi efek transisi slide dalam milidetik. |
| [setDuration(int value)](#setDuration-int-) | Mengambil atau menetapkan durasi efek transisi slide dalam milidetik. |
### getSound() {#getSound--}
```
...
Mengembalikan atau menetapkan data audio yang disematkan. Baca-tulis [IAudio](../../com.aspose.slides/iaudio).
...
Menetapkan atau mengembalikan mode suara untuk transisi slide. Baca-tulis [TransitionSoundMode](../../com.aspose.slides/transitionsoundmode).
...
Atribut ini menentukan apakah suara akan diputar berulang hingga peristiwa suara berikutnya terjadi dalam pertunjukan slide. Baca-tulis boolean.
...
Menentukan apakah klik mouse akan memajukan slide atau tidak. Jika atribut ini tidak ditentukan, maka nilai true diasumsikan. Baca-tulis boolean.
...
Menentukan waktu, dalam milidetik, setelah itu transisi harus dimulai. Pengaturan ini dapat digunakan bersama atribut advClick. Jika atribut ini tidak ditentukan, maka diasumsikan tidak ada auto-advance. Baca-tulis long.
...
Menentukan apakah suara ini merupakan suara bawaan atau tidak. Jika atribut ini diset ke true, maka aplikasi pembuat akan memeriksa atribut name yang ditentukan untuk suara ini dalam daftar suara bawaan dan dapat menampilkan nama khusus atau UI yang diperlukan. Baca-tulis boolean.
...
Menentukan nama yang dapat dibaca manusia untuk suara transisi. Properti (\#getSound.getSound/\#setSound(IAudio).setSound(IAudio)) harus diakses untuk mendapatkan atau mengatur nama suara. Baca-tulis String.
...
Mengambil atau menetapkan durasi efek transisi slide dalam milidetik. Baca/tulis int.

--------------------

Menyamakan dengan atribut p14:dur pada elemen p:transition dalam skema PresentationML. Jika tidak diset, durasi ditentukan secara otomatis berdasarkan properti \#getSpeed.getSpeed/\#setSpeed(int).setSpeed(int) dan jenis transisi.
