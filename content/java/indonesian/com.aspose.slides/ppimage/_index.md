...
description: Merepresentasikan sebuah gambar dalam presentasi.
type: docs
...
| [getContentType()](#getContentType--) | Mengembalikan tipe MIME gambar, yang dikodekan dalam  BinaryData (\#getBinaryData.getBinaryData). |
...
Mengganti data gambar. Perhatian: ketika Image adalah metafile - akan dirasterisasi. Gunakan ReplaceImage(byte[]) sebagai gantinya
...
Mengembalikan tipe MIME gambar, yang dikodekan dalam  BinaryData (\#getBinaryData.getBinaryData). Hanya-baca String.
