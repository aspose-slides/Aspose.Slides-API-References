...
description: Paragraf matematika yang merupakan kontainer untuk blok matematika IMathBlock
type: docs
...
Paragraf matematika yang merupakan kontainer untuk blok matematika (IMathBlock)
...
| --- | --- |
| [MathParagraph()](#MathParagraph--) | Menginisialisasi sebuah instance baru dari kelas MathParagraph. |
| [MathParagraph(IMathBlock mathBlock)](#MathParagraph-com.aspose.slides.IMathBlock-) | Menginisialisasi sebuah instance baru dari kelas MathParagraph. |
## Metode
...
| [writeAsMathMl(OutputStream stream)](#writeAsMathMl-java.io.OutputStream-) | Menyimpan konten dari [MathParagraph](../../com.aspose.slides/mathparagraph) ini sebagai MathML |
| [toLatex()](#toLatex--) | Mendapatkan persamaan matematika dalam format LaTeX |
### MathParagraph() {#MathParagraph--}
```
public MathParagraph()
```

Menginisialisasi sebuah instance baru dari kelas MathParagraph.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | Sebuah blok matematika yang akan ditambahkan ke akhir koleksi |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| index | int | Indeks berbasis nol pada posisi mana item harus disisipkan. |
...
Menyimpan konten dari [MathParagraph](../../com.aspose.slides/mathparagraph) ini sebagai MathML
