...
| Method | Description |
| --- | --- |
| [getConformance()](#getConformance--) | Menentukan kelas kesesuaian yang dipatuhi dokumen Presentation. |
| [setConformance(int value)](#setConformance-int-) | Menentukan kelas kesesuaian yang dipatuhi dokumen Presentation. |
...
Menentukan kelas kesesuaian yang dipatuhi dokumen Presentation. Nilai default adalah [Conformance.Ecma376\_2006](../../com.aspose.slides/conformance\#Ecma376-2006)
...
Tingkat kompresi yang lebih tinggi menghasilkan file yang lebih kecil tetapi memerlukan waktu pemrosesan lebih lama. Rasio kompresi aktual bergantung pada konten presentasi.
