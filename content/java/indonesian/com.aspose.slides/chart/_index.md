...
description: Mewakili sebuah bagan grafik pada slide.
type: docs
...
Mewakili sebuah bagan grafik pada slide.
## Metode
...
| [getDisplayBlanksAs()](#getDisplayBlanksAs--) | Mengembalikan atau mengatur cara memplot sel kosong pada bagan. |
| [setDisplayBlanksAs(int value)](#setDisplayBlanksAs-int-) | Mengembalikan atau mengatur cara memplot sel kosong pada bagan. |
| [getChartData()](#getChartData--) | Mengembalikan informasi tentang data terhubung atau tertanam yang terkait dengan bagan. |
...
| [getChartDataTable()](#getChartDataTable--) | Mengembalikan tabel data sebuah bagan. |
...
| [getType()](#getType--) | Mengembalikan atau mengatur tipe bagan. |
| [setType(int value)](#setType-int-) | Mengembalikan atau mengatur tipe bagan. |
| [getPlotArea()](#getPlotArea--) | Mewakili area plot sebuah bagan. |
| [getRotation3D()](#getRotation3D--) | Mengembalikan rotasi 3D sebuah bagan. |
| [getBackWall()](#getBackWall--) | Mengembalikan objek yang memungkinkan mengubah format dinding belakang sebuah bagan 3D. |
| [getSideWall()](#getSideWall--) | Mengembalikan objek yang memungkinkan mengubah format dinding samping sebuah bagan 3D. |
| [getFloor()](#getFloor--) | Mengembalikan objek yang memungkinkan mengubah format lantai sebuah bagan 3D. |
...
| [getAxes()](#getAxes--) | Memberikan akses ke sumbu bagan. |
...
Mengembalikan atau mengatur cara memplot sel kosong pada bagan. Baca/tulis [DisplayBlanksAsType](../../com.aspose.slides/displayblanksastype).
...
Mengembalikan informasi tentang data terhubung atau tertanam yang terkait dengan bagan. Baca-saja [IChartData](../../com.aspose.slides/ichartdata).
...
Mengembalikan tabel data sebuah bagan. Baca-saja [IDataTable](../../com.aspose.slides/idatatable).
...
Mengembalikan atau mengatur tipe bagan. Baca/tulis [ChartType](../../com.aspose.slides/charttype).
...
Mewakili area plot sebuah bagan. Baca-saja [IChartPlotArea](../../com.aspose.slides/ichartplotarea).
...
Mengembalikan rotasi 3D sebuah bagan. Baca-saja [IRotation3D](../../com.aspose.slides/irotation3d).
...
Mengembalikan objek yang memungkinkan mengubah format dinding belakang sebuah bagan 3D. Baca-saja [IChartWall](../../com.aspose.slides/ichartwall).
...
Mengembalikan objek yang memungkinkan mengubah format dinding samping sebuah bagan 3D. Baca-saja [IChartWall](../../com.aspose.slides/ichartwall).
...
Mengembalikan objek yang memungkinkan mengubah format lantai sebuah bagan 3D. Baca-saja [IChartWall](../../com.aspose.slides/ichartwall).
...
Mengembalikan format teks bagan. Properti ini tidak berlaku untuk tipe berikut: [ChartType.Treemap](../../com.aspose.slides/charttype\#Treemap), [ChartType.Sunburst](../../com.aspose.slides/charttype\#Sunburst), [ChartType.Waterfall](../../com.aspose.slides/charttype\#Waterfall), [ChartType.Histogram](../../com.aspose.slides/charttype\#Histogram), [ChartType.Funnel](../../com.aspose.slides/charttype\#Funnel),[ChartType.BoxAndWhisker](../../com.aspose.slides/charttype\#BoxAndWhisker). Baca-saja [IChartTextFormat](../../com.aspose.slides/icharttextformat).
...
Memberikan akses ke sumbu bagan. Baca-saja [IAxesManager](../../com.aspose.slides/iaxesmanager).
