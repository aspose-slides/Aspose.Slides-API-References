...
description: Mewakili error bars dari seri diagram.
type: docs
...
Mewakili error bars dari seri diagram. Nilai khusus ErrorBars berada di IChartDataPointCollection (pada properti [IChartDataPoint.getErrorBarsCustomValues](../../com.aspose.slides/ichartdatapoint\#getErrorBarsCustomValues)).
...
| [hasEndCap()](#hasEndCap--) | Menentukan bahwa penutup ujung tidak digambar pada error bars. |
| [setEndCap(boolean value)](#setEndCap-boolean-) | Menentukan bahwa penutup ujung tidak digambar pada error bars. |
...
Menentukan bahwa penutup ujung tidak digambar pada error bars. Baca/tulis boolean.
