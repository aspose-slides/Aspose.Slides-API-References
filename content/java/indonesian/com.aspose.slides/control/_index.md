...
| [getSubstitutePictureFormat()](#getSubstitutePictureFormat--) | Mengembalikan objek properti isian gambar kontrol. |
| [getFrame()](#getFrame--) | Mendapatkan atau mengatur frame kontrol. |
| [setFrame(IShapeFrame value)](#setFrame-com.aspose.slides.IShapeFrame-) | Mendapatkan atau mengatur frame kontrol. |
| [getProperties()](#getProperties--) | Mengembalikan koleksi properti ActiveX. |
| [getActiveXControlBinary()](#getActiveXControlBinary--) | Menentukan keberlangsungan kontrol ActiveX ketika metode yang digunakan untuk menyimpan adalah PersistStream, PersistStreamInit, atau PersistStorage. |
| [getSlide()](#getSlide--) |  |
...
>  else
>  {
>      YourMethodHere(control.getActiveXControlBinary()); //Gunakan metode Anda sendiri untuk mengelola properti ActiveX yang disimpan dalam file biner
>  }
> ```
...
Mengembalikan objek properti isian gambar kontrol. Hanya baca [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
Mendapatkan atau mengatur frame kontrol. Baca/tulis [IShapeFrame](../../com.aspose.slides/ishapeframe).
...
Catatan: Aspose.Slides hanya mendukung properti ActiveX berbasis XML. Jika properti disimpan dalam format biner, properti ini akan mengembalikan null.
