...
description: Mewakili nilai double yang dapat disimpan dalam dokumen presentasi pptx dengan dua cara: 1) dalam sel/sel workbook yang terkait dengan chart; 2) sebagai nilai literal.
type: docs
...
| Metode | Deskripsi |
| --- | --- |
| [getAsCell()](#getAsCell--) | Mengembalikan atau mengatur sel data chart. |
| [setAsCell(IChartDataCell value)](#setAsCell-com.aspose.slides.IChartDataCell-) | Mengembalikan atau mengatur sel data chart. |
...
Mengembalikan atau mengatur sel data chart. Baca/tulis [IChartDataCell](../../com.aspose.slides/ichartdatacell).
...
**Mengembalikan:**
double - Mengembalikan LiteralDouble jika DataSourceType sama dengan DoubleLiterals. Jika DataSourceType sama dengan Worksheet mengembalikan nilai sel yang berhasil dikonversi ke double, jika tidak mengembalikan NaN.