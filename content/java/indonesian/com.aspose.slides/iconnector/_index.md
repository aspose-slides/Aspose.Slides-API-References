...
| Metode | Deskripsi |
| --- | --- |
| [getShapeLock()](#getShapeLock--) | Mengembalikan shape's locks. |
| [getConnectorLock()](#getConnectorLock--) | Mengembalikan Connector's locks. |
...
| [reroute()](#reroute--) | Mengarahkan ulang connector sehingga mengambil jalur terpendek antara shape yang terhubung. |
### getShapeLock() {#getShapeLock--}
```
public abstract IConnectorLock getShapeLock()
```

Mengembalikan shape's locks. Baca-saja [IConnectorLock](../../com.aspose.slides/iconnectorlock).
...
Mengembalikan Connector's locks. Baca-saja [IConnectorLock](../../com.aspose.slides/iconnectorlock).
...
Mengarahkan ulang connector sehingga mengambil jalur terpendek antara shape yang terhubung.