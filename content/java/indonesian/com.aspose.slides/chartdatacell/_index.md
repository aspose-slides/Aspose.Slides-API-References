...
Mengembalikan indeks baris lembar kerja tempat sel berada. Read-only int.
...
Mengembalikan indeks kolom lembar kerja tempat sel berada. Read-only int.
...
Mendapatkan atau mengatur nilai sebuah sel. Read/write  Object .
...
Mendapatkan lembar kerja. Read-only [IChartDataWorksheet](../../com.aspose.slides/ichartdataworksheet).
...
Menentukan apakah sel disembunyikan. Read-only boolean.
...
Mendapatkan atau mengatur format tampilan khusus untuk angka dan tanggal. Jika nilai kosong akan digunakan nilai PresetNumberFormat. Read/write String.
...
Mendapatkan atau mengatur format tampilan bawaan untuk angka dan tanggal. Nomor preset harus berada dalam [0..22] atau [37..49]. Read/write byte.
