...
| [getJpegQuality()](#getJpegQuality--) | Mengembalikan atau mengatur nilai yang menentukan kualitas gambar JPEG di dalam dokumen PDF. |
| [setJpegQuality(byte value)](#setJpegQuality-byte-) | Mengembalikan atau mengatur nilai yang menentukan kualitas gambar JPEG di dalam dokumen PDF. |
...
| [getSvgResponsiveLayout()](#getSvgResponsiveLayout--) | Benar untuk mengecualikan atribut lebar dan tinggi dari kontainer svg - yang akan membuat tata letak responsif. |
| [setSvgResponsiveLayout(boolean value)](#setSvgResponsiveLayout-boolean-) | Benar untuk mengecualikan atribut lebar dan tinggi dari kontainer svg - yang akan membuat tata letak responsif. |
...
Berpengaruh hanya ketika sebuah dokumen berisi gambar JPEG. Gunakan properti ini untuk mendapatkan atau mengatur kualitas gambar di dalam dokumen saat menyimpan dalam format PDF. Nilainya dapat bervariasi dari 0 hingga 100 dimana 0 berarti kualitas terburuk tetapi kompresi maksimum dan 100 berarti kualitas terbaik tetapi kompresi minimum. Nilai default adalah **95**.
...
Bendera boolean yang menunjukkan apakah bagian yang dipotong tetap menjadi bagian dari dokumen. Jika true, bagian yang dipotong akan dihapus, jika false mereka akan diserialisasi dalam dokumen (yang dapat menyebabkan file lebih besar)
...
Benar untuk mengecualikan atribut lebar dan tinggi dari kontainer svg - yang akan membuat tata letak responsif. False - sebaliknya. Baca/tulis boolean.
