...
| Metode | Deskripsi |
| --- | --- |
| [shapes(Presentation pres)](#shapes-com.aspose.slides.Presentation-) | Mengumpulkan semua instance dari [Shape](../../com.aspose.slides/shape) di dalam [Presentation](../../com.aspose.slides/presentation). |
### Collect() {#Collect--}
```
public Collect()
```
...
Mengumpulkan semua instance dari [Shape](../../com.aspose.slides/shape) di dalam [Presentation](../../com.aspose.slides/presentation).
...
| --- | --- | --- |
| pres | [Presentation](../../com.aspose.slides/presentation) | Presentation untuk mengumpulkan shape |

**Mengembalikan:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.slides.Shape> - Koleksi semua shape yang terdapat dalam presentasi