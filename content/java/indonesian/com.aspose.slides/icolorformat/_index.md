...
| [setColor(Color value)](#setColor-java.awt.Color-) | Mengembalikan warna hasil (dengan semua transformasi warna diterapkan). |
...
| [getColorTransform()](#getColorTransform--) | Mengembalikan koleksi transformasi warna yang diterapkan pada warna. |
| [toString(int format)](#toString-int-) | Mengembalikan String yang mewakili format warna saat ini. |
| [copyFrom(IColorFormat color)](#copyFrom-com.aspose.slides.IColorFormat-) | Salin format warna dari "color". |
...
Mengembalikan warna hasil (dengan semua transformasi warna diterapkan). Mengatur warna RGB dan menghapus semua transformasi warna. Baca/tulis java.awt.Color.
...
Mengembalikan koleksi transformasi warna yang diterapkan pada warna. Hanya baca [IColorOperationCollection](../../com.aspose.slides/icoloroperationcollection).
...
**Mengembalikan:**
java.lang.String - String yang mewakili format warna saat ini.
