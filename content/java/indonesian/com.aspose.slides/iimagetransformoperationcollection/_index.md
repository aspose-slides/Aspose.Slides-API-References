...
description: Mewakili koleksi efek yang diterapkan pada sebuah gambar.
type: docs
...
| Metode | Deskripsi |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Mengembalikan [IImageTransformOperation](../../com.aspose.slides/iimagetransformoperation) dari koleksi berdasarkan indeksnya. |
...
Mengembalikan [IImageTransformOperation](../../com.aspose.slides/iimagetransformoperation) dari koleksi berdasarkan indeksnya.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| amount | float | Persentase untuk mengubah nilai alpha. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| threshold | float | Ambang luminansi untuk efek Bi-Level. Nilai yang sama atau lebih besar dari ambang akan menjadi putih. Nilai yang lebih kecil akan menjadi hitam. |
...
| grow | boolean | Menentukan apakah batas objek harus diperluas akibat efek blur. True menunjukkan batas diperluas sementara false menunjukkan tidak. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| brightness | float | Persentase perubahan kecerahan. |
| contrast | float | Persentase perubahan kontras. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| hue | float | Hue yang akan ditetapkan sebagai tujuan tint. |
