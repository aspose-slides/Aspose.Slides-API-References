...
| [getUseCells()](#getUseCells--) | Jika true maka lembar kerja digunakan untuk menyimpan kategori (kasus ini mendukung kategori bertingkat multilevel). |
| [setUseCells(boolean value)](#setUseCells-boolean-) | Jika true maka lembar kerja digunakan untuk menyimpan kategori (kasus ini mendukung kategori bertingkat multilevel). |
...
Jika true maka lembar kerja digunakan untuk menyimpan kategori (kasus ini mendukung kategori bertingkat multilevel). Jika false maka lembar kerja TIDAK digunakan untuk menyimpan nilai (dan kasus ini tidak mendukung kategori bertingkat multilevel). Baca/tulis boolean.
...
Mengembalikan jumlah tingkat pengelompokan kategori yang digunakan. Lebih dari satu untuk kategori multilevel. Baca-saja int.
...
Metode ini menambahkan lembar kerja dengan nama AUTO_DATA dan menambahkan semua nilai di sana. Jika Anda menggunakan [IChartDataWorkbook](../../com.aspose.slides/ichartdataworkbook) untuk menambah atau mengedit nilai sel, pastikan Anda tidak menggunakan lembar kerja ini. Jumlah maksimum nilai yang ditambahkan menggunakan metode ini tidak boleh melebihi 16711680 |

**Mengembalikan:**
[IChartCategory](../../com.aspose.slides/ichartcategory) - [IChartCategory](../../com.aspose.slides/ichartcategory) yang ditambahkan.
