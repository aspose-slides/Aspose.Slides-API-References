...
Mewakili kumpulan semua slide tata letak dalam presentasi. Memperluas ILayoutSlideCollection antarmuka dengan metode untuk menambahkan/men-clone slide tata letak dalam konteks penggabungan koleksi individual slide tata letak master.
...
Saat men-clone tata letak antara presentasi yang berbeda, master tata letak dapat di-clone juga untuk mempertahankan pemformatan sumber. Registri internal digunakan untuk melacak master yang di-clone secara otomatis guna mencegah pembuatan beberapa klon dari slide master yang sama. Cloning manual slide master tidak akan dicegah maupun terdaftar.
...
Tata letak baru akan ditautkan dengan master yang ditentukan dalam presentasi tujuan. Jadi ini merupakan analog dari copy/paste dengan opsi "Use Destination Theme" di PowerPoint.
...
| layoutName | java.lang.String | Nama untuk tata letak baru. Jika nama yang diberikan sudah digunakan, ArgumentException akan dilempar. Jika parameter null diberikan, maka nama akan dihasilkan secara otomatis sesuai dengan tipe tata letak yang diberikan (misalnya "Title Slide" atau "1_Title Slide", "2_..", dll.). |

--------------------

1) Tata letak yang ditambahkan untuk nilai SlideLayoutType.Custom dari layoutType tidak berisi placeholder dan tidak memiliki bentuk. 2) Analogi dari metode ini adalah metode [IMasterLayoutSlideCollection.add(byte,String)](../../com.aspose.slides/imasterlayoutslidecollection\#add-byte-String-) yang diakses dengan properti ([IMasterSlide.getLayoutSlides](../../com.aspose.slides/imasterslide\#getLayoutSlides)).
