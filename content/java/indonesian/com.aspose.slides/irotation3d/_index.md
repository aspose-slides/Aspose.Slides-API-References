...
Mengembalikan atau mengatur derajat rotasi di sekitar sumbu X, yaitu ke arah Y untuk diagram 3D (antara -90 dan 90 derajat). Properti ini cocok dengan item rotX (X Rotation) 21.2.2.157 dalam ECMA-376 dan dengan opsi "Y Rotation" di PowerPoint 2007+. Baca/tulis byte.
...
Mengembalikan atau mengatur derajat rotasi di sekitar sumbu Y, yaitu ke arah X untuk diagram 3D (antara 0 dan 360 derajat). Properti ini cocok dengan item rotY (Y Rotation) 21.2.2.158 dalam ECMA-376 dan dengan opsi "X Rotation" di PowerPoint 2007+. Baca/tulis int.
