...
| [get_Item(int index)](#get-Item-int-) | Mengembalikan efek pada indeks yang ditentukan. |
...
Mengembalikan jumlah efek dalam sequense. Read-only int.
...
Mengembalikan atau mengatur target shape untuk urutan INTERACTIVE. Jika urutan tidak interaktif maka mengembalikan null. Read/write [IShape](../../com.aspose.slides/ishape).
...
| subtype | int | Subtype efek animasi [EffectSubtype](../../com.aspose.slides/effectsubtype) |
