...
| Metode | Deskripsi |
| --- | --- |
| [getCount()](#getCount--) | Mengembalikan jumlah elemen dalam koleksi Baca-saja int. |
...
Menambahkan urutan interaktif baru. Baca/tulis [Sequence](../../com.aspose.slides/sequence).
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| item | [ISequence](../../com.aspose.slides/isequence) | Urutan yang dihapus. |
