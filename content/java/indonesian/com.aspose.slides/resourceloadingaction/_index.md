...
| [UserProvided](#UserProvided) | Aspose.Slides akan menggunakan byte array yang diberikan oleh pengguna dalam [IResourceLoadingArgs.setData(byte[])](../../com.aspose.slides/iresourceloadingargs\#setData-byte---) sebagai data gambar. |
### Default {#Default}
```
...
Aspose.Slides akan menggunakan byte array yang diberikan oleh pengguna dalam [IResourceLoadingArgs.setData(byte[])](../../com.aspose.slides/iresourceloadingargs\#setData-byte---) sebagai data gambar.