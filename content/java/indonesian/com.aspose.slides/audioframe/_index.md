...
| [getRewindAudio()](#getRewindAudio--) | Menentukan apakah audio secara otomatis diputar kembali ke awal setelah diputar. |
| [setRewindAudio(boolean value)](#setRewindAudio-boolean-) | Menentukan apakah audio secara otomatis diputar kembali ke awal setelah diputar. |
...
>       // Atur Audio untuk diputar lintas slide
>       audioFrame.setPlayAcrossSlides(true);
>       // Atur Audio untuk otomatis memutar kembali ke awal setelah diputar
>       audioFrame.setRewindAudio(true);
...
Menentukan apakah audio secara otomatis diputar kembali ke awal setelah diputar. Baca/tulis boolean.
...
>      // Tetapkan durasi fade awal selama 200ms
...
>      IAudio audio = pres.getAudios().addAudio(audioStream, LoadingStreamBehavior.ReadStreamAndRelease);
>      IAudioFrame audioFrame = pres.getSlides().get_Item(0).getShapes().addAudioFrameEmbedded(50, 50, 100, 100, audio);
>      // Tetapkan durasi fade akhir selama 500ms
...
Mendapatkan koleksi caption tertutup yang terkait dengan frame audio. Properti ini baca-saja dan mengembalikan sebuah [ICaptionsCollection](../../com.aspose.slides/icaptionscollection) berisi semua trek caption.
