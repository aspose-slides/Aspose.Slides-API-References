...
| [isSeriesUsesXValueCoordinate(int seriesType)](#isSeriesUsesXValueCoordinate-int-) | Mengembalikan true jika tipe seri yang ditentukan menggunakan koordinat nilai X. |
| [isSeriesUsesYValueCoordinate(int seriesType)](#isSeriesUsesYValueCoordinate-int-) | Mengembalikan true jika tipe seri yang ditentukan menggunakan koordinat nilai Y. |
| [isSeriesUsesValueCoordinate(int seriesType)](#isSeriesUsesValueCoordinate-int-) | Mengembalikan true jika tipe seri yang ditentukan menggunakan koordinat nilai. |
| [isSeriesUsesBubbleSizeCoordinate(int seriesType)](#isSeriesUsesBubbleSizeCoordinate-int-) | Mengembalikan true jika koordinat ukuran gelembung dapat digunakan untuk tipe seri yang ditentukan. |
| [hasSeriesTrendLines(int seriesType)](#hasSeriesTrendLines-int-) | Mengembalikan true jika ada garis tren seri untuk tipe seri yang ditentukan. |
| [isErrorBarsXAllowed(int seriesType)](#isErrorBarsXAllowed-int-) | Mengembalikan true jika batang kesalahan X diizinkan untuk tipe seri yang ditentukan. |
| [isErrorBarsYAllowed(int seriesType)](#isErrorBarsYAllowed-int-) | Mengembalikan true jika batang kesalahan Y diizinkan untuk tipe seri yang ditentukan. |
### ChartTypeCharacterizer() {#ChartTypeCharacterizer--}
```
...
Mengembalikan true jika tipe seri yang ditentukan menggunakan koordinat nilai X.
...
Mengembalikan true jika tipe seri yang ditentukan menggunakan koordinat nilai Y.
...
Mengembalikan true jika tipe seri yang ditentukan menggunakan koordinat nilai.
...
Mengembalikan true jika koordinat ukuran gelembung dapat digunakan untuk tipe seri yang ditentukan.
...
Mengembalikan true jika ada garis tren seri untuk tipe seri yang ditentukan.
...
Mengembalikan true jika batang kesalahan X diizinkan untuk tipe seri yang ditentukan.
...
Mengembalikan true jika batang kesalahan Y diizinkan untuk tipe seri yang ditentukan.
