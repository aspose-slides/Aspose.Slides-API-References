...
type: docs
url: /id/com.aspose.slides/igeometryshape/
---
...
| Metode | Deskripsi |
| --- | --- |
| [getGeometryPaths()](#getGeometryPaths--) | Mengembalikan salinan jalur dari bentuk geometris. |
...
| [getShapeType()](#getShapeType--) | Mengembalikan atau menetapkan tipe preset geometri. |
| [setShapeType(int value)](#setShapeType-int-) | Mengembalikan atau menetapkan tipe preset geometri. |
...
Mengembalikan salinan jalur dari bentuk geometris. Koordinat bersifat relatif terhadap sudut kiri atas bentuk.
...
Mengembalikan objek gaya bentuk. Baca-saja [IShapeStyle](../../com.aspose.slides/ishapestyle).
...
Mengembalikan atau menetapkan tipe preset geometri. Catatan: saat nilai diubah semua nilai penyesuaian akan direset ke nilai default mereka. Baca/tulis [ShapeType](../../com.aspose.slides/shapetype).
...
Mengembalikan koleksi nilai penyesuaian bentuk. Baca-saja [IAdjustValueCollection](../../com.aspose.slides/iadjustvaluecollection).
...
**Mengembalikan:**
com.aspose.slides.IShapeElement[] - Array dari [IShapeElement](../../com.aspose.slides/ishapeelement)