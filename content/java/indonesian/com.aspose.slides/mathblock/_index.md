...
description: Menentukan sebuah instance teks matematika yang terdapat dalam MathParagraph dan dimulai pada barisnya sendiri.
type: docs
...
Menentukan sebuah instance teks matematika yang terdapat dalam MathParagraph dan dimulai pada barisnya sendiri. Semua zona matematika, termasuk persamaan, ekspresi, array persamaan atau ekspresi, dan formula direpresentasikan oleh blok matematika.
...
| [isReadOnly()](#isReadOnly--) | Mengembalikan false karena koleksi elemen anak dapat diubah. |
...
| [remove(IMathElement item)](#remove-com.aspose.slides.IMathElement-) | Menghapus kejadian pertama dari objek tertentu dari koleksi. |
...
| [delimit(char separatorCharacter)](#delimit-char-) | Membedakan elemen anak dengan karakter pemisah (tanpa tanda kurung) |
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | Membungkus elemen anak dari blok ini dengan karakter tertentu seperti tanda kurung atau karakter lain sebagai bingkai |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | Membungkus elemen anak dari blok ini dengan karakter tertentu seperti tanda kurung atau karakter lain sebagai bingkai dan memisahkan dengan karakter pemisah |
...
Mendapatkan jumlah elemen matematika anak yang sebenarnya terdapat dalam koleksi. int baca-saja.
...
Mengembalikan false karena koleksi elemen anak dapat diubah.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| array | [IMathElement\[\]](../../com.aspose.slides/imathelement) | Array yang akan disalin ke. |
...
**Mengembalikan:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IMathElement> - IGenericEnumerator yang dapat digunakan untuk mengiterasi koleksi.
...
**Mengembalikan:**
com.aspose.ms.System.Collections.IEnumerator - java.util.Iterator untuk seluruh koleksi.
...
**Mengembalikan:**
[IMathBlock](../../com.aspose.slides/imathblock) - Instansi IMathBlock saat ini
...
**Mengembalikan:**
[IMathBlock](../../com.aspose.slides/imathblock) - IMathBlock baru yang berisi instansi ini dan argumen yang ditentukan
...
**Mengembalikan:**
[IMathBlock](../../com.aspose.slides/imathblock) - blok matematika ini setelah penggabungan
...
Membedakan elemen anak dengan karakter pemisah (tanpa tanda kurung)
...
**Mengembalikan:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - Elemen matematika tipe [IMathDelimiter](../../com.aspose.slides/imathdelimiter)
...
Membungkus elemen anak dari blok ini dengan karakter tertentu seperti tanda kurung atau karakter lain sebagai bingkai
...
**Mengembalikan:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - Elemen matematika tipe [IMathDelimiter](../../com.aspose.slides/imathdelimiter) yang mencakup karakter tertentu sebagai bingkai
...
Membungkus elemen anak dari blok ini dengan karakter tertentu seperti tanda kurung atau karakter lain sebagai bingkai dan memisahkan dengan karakter pemisah
...
**Mengembalikan:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - Elemen matematika tipe [IMathDelimiter](../../com.aspose.slides/imathdelimiter) yang mencakup karakter tertentu sebagai bingkai dan pemisah
