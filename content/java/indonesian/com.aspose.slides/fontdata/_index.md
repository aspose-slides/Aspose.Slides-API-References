...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| theme | [IThemeEffectiveData](../../com.aspose.slides/ithemeeffectivedata) | Tema dari mana nama font bertema harus diambil. Tanggung jawab pemanggil menyediakan nilai yang benar. Lihat [IThemeable.createThemeEffective](../../com.aspose.slides/ithemeable\#createThemeEffective) |
...
**Mengembalikan:**
boolean - **true** jika FontData yang ditentukan sama dengan FontData saat ini; jika tidak, **false**.
### hashCode() {#hashCode--}
```
public int hashCode()
```
