...
description: Kelas pengontrol format yang digunakan untuk menyematkan font dalam format WOFF
type: docs
...
Kelas pengontrol format yang digunakan untuk menyematkan font dalam format WOFF
## Konstruktor
...
Dipanggil sebelum merender shape. Dipanggil sekali per setiap shape. Jika fungsi ini menulis apa pun ke generator, pembuatan gambar slide saat ini akan selesai, fragmen html yang ditambahkan akan disisipkan dan gambar baru akan dimulai di atas yang sebelumnya.
