...
| [insert(int index, int type)](#insert-int-int-) | Membuat seri chart baru dan menyisipkannya ke dalam koleksi. |
...
Jika seri chart dibuat dari sel yang sama sudah ada dalam koleksi maka metode tidak menambahkan apa pun dan mengembalikan indeksnya. |
