...
| [toBinary()](#toBinary--) | Mengembalikan representasi biner dari proyek VBA sebagai kontainer OLE |
...
Konstruktor ini membuat proyek VBA baru dari awal. Proyek akan dibuat dalam codepage Windows Latin 1 (ANSI) 1252
...
Mengembalikan nama proyek VBA. String hanya-baca.
...
Mengembalikan daftar semua modul yang terdapat dalam proyek VBA. Hanya-baca [IVbaModuleCollection](../../com.aspose.slides/ivbamodulecollection).
...
Mengembalikan daftar semua referensi yang terdapat dalam proyek VBA. Hanya-baca [IVbaReferenceCollection](../../com.aspose.slides/ivbareferencecollection).
...
**Mengembalikan:**
byte[] - Representasi biner dari proyek VBA sebagai kontainer OLE
### isPasswordProtected() {#isPasswordProtected--}
```
public final boolean isPasswordProtected()
```

Menunjukkan apakah VBAProject dilindungi oleh kata sandi untuk melihat properti proyek. Hanya-baca boolean .
