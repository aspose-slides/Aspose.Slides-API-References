...
| [getFillFormat()](#getFillFormat--) | Mengembalikan format isian garis. |
| [getSketchFormat()](#getSketchFormat--) | Mengembalikan format sketsa garis. |
| [getWidth()](#getWidth--) | Mengembalikan atau mengatur lebar garis. |
| [setWidth(double value)](#setWidth-double-) | Mengembalikan atau mengatur lebar garis. |
...
| [getMiterLimit()](#getMiterLimit--) | Mengembalikan atau mengatur batas miter garis. |
| [setMiterLimit(float value)](#setMiterLimit-float-) | Mengembalikan atau mengatur batas miter garis. |
...
Mengembalikan true jika format garis tidak didefinisikan (seperti baru dibuat, default). Baca-saja  boolean .
...
Mengembalikan format isian garis. Baca-saja [ILineFillFormat](../../com.aspose.slides/ilinefillformat).
...
Mengembalikan format sketsa garis. Baca-saja [ILineFillFormat](../../com.aspose.slides/ilinefillformat).
...
Mengembalikan atau mengatur batas miter garis. Baca/tulis  float .
