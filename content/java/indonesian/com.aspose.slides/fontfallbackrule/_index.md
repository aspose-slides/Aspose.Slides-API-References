...
> ```
> // Membuat instance baru FantFallBackRule dengan satu font.
>  IFontFallBackRule newRule = new FontFallBackRule(0x3040, 0x309F, "MS Mincho");
>  // Membuat instance baru FantFallBackRule dengan beberapa font.
...
| --- | --- | --- |
| startIndex | long | Indeks mulai dari rentang unicode |
| endIndex | long | Indeks akhir dari rentang unicode |
| fontNames | java.lang.String | Nama atau nama font (dipisahkan dengan koma) untuk FallBack |
...
> ```
> // Membuat instance baru FantFallBackRule dengan dua font
...
> ```
> // Membuat instance baru FontFallBackRule
>  IFontFallBackRule newRule = new FontFallBackRule(0x3040, 0x309F, "MS Mincho");
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| fontName | java.lang.String | Nama atau nama font (dipisahkan dengan koma) untuk FallBack |
...
Mendapatkan jumlah font yang sebenarnya didefinisikan untuk rentang. Baca-saja int.
...
Mendapatkan nama font pada indeks yang ditentukan. Baca-saja [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule).
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| fontName | java.lang.String | Nama font yang akan dicari. |
