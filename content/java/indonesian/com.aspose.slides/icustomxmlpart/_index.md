...
| [getItemId()](#getItemId--) | Menentukan pengenal unik global (GUID) yang secara unik mengidentifikasi satu bagian XML khusus dalam dokumen Office Open XML. |
| [setItemId(UUID value)](#setItemId-java.util.UUID-) | Menentukan pengenal unik global (GUID) yang secara unik mengidentifikasi satu bagian XML khusus dalam dokumen Office Open XML. |
...
Menentukan pengenal unik global (GUID) yang secara unik mengidentifikasi satu bagian XML khusus dalam dokumen Office Open XML. Baca-saja java.util.UUID.
...
Mengembalikan koleksi skema XML yang terkait dengan bagian XML khusus. Baca-saja String[].
