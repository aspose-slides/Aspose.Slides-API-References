...
| Metode | Deskripsi |
| --- | --- |
| [getHeaderFooterManager()](#getHeaderFooterManager--) | Mengembalikan manager HeaderFooter dari slide tata letak. |
| [getPlaceholderManager()](#getPlaceholderManager--) | Mengembalikan manager placeholder dari slide tata letak. |
...
| [getThemeManager()](#getThemeManager--) | Mengembalikan manager tema yang menggantikan. |
| [getLayoutType()](#getLayoutType--) | Mengembalikan tipe tata letak dari slide tata letak ini. |
| [getDependingSlides()](#getDependingSlides--) | Mengembalikan sebuah array dengan semua slide yang bergantung pada slide tata letak ini. |
...
| [getDrawingGuides()](#getDrawingGuides--) | Mengembalikan sebuah koleksi panduan gambar untuk slide tata letak. |
...
Mengembalikan manager HeaderFooter dari slide tata letak. Hanya baca [ILayoutSlideHeaderFooterManager](../../com.aspose.slides/ilayoutslideheaderfootermanager).
...
Mengembalikan manager placeholder dari slide tata letak. Hanya baca [ILayoutPlaceholderManager](../../com.aspose.slides/ilayoutplaceholdermanager).
...
Mengembalikan manager tema yang menggantikan. Hanya baca [IOverrideThemeManager](../../com.aspose.slides/ioverridethememanager).
...
Mengembalikan tipe tata letak dari slide tata letak ini. Hanya baca [SlideLayoutType](../../com.aspose.slides/slidelayouttype).
...
Mengembalikan sebuah array dengan semua slide yang bergantung pada slide tata letak ini.
...
Mengembalikan true jika ada setidaknya satu slide yang bergantung pada slide tata letak ini. Hanya baca  boolean .
...
Mengembalikan sebuah koleksi panduan gambar untuk slide tata letak. Hanya baca [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
