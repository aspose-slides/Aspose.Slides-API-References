...
| Metode | Deskripsi |
| --- | --- |
| [getSourceFont()](#getSourceFont--) | Font yang akan diganti. |
| [getDestFont()](#getDestFont--) | Font yang akan digunakan untuk penggantian. |
| [getReplaceFontCondition()](#getReplaceFontCondition--) | Aturan yang diterapkan untuk penggantian. |
...
Font yang akan diganti. Baca-saja [IFontData](../../com.aspose.slides/ifontdata).
...
Font yang akan digunakan untuk penggantian. Baca-saja [IFontData](../../com.aspose.slides/ifontdata).
...
Aturan yang diterapkan untuk penggantian. Baca-saja [FontSubstCondition](../../com.aspose.slides/fontsubstcondition).
