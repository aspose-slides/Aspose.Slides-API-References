...
| Method | Description |
| --- | --- |
| [isFormatNotDefined()](#isFormatNotDefined--) | Mengembalikan true jika format garis tidak terdefinisi (seperti baru dibuat, default). |
...
| [getBeginArrowheadStyle()](#getBeginArrowheadStyle--) | Mengembalikan atau mengatur gaya kepala panah di awal sebuah garis. |
| [setBeginArrowheadStyle(byte value)](#setBeginArrowheadStyle-byte-) | Mengembalikan atau mengatur gaya kepala panah di awal sebuah garis. |
| [getEndArrowheadStyle()](#getEndArrowheadStyle--) | Mengembalikan atau mengatur gaya kepala panah di akhir sebuah garis. |
| [setEndArrowheadStyle(byte value)](#setEndArrowheadStyle-byte-) | Mengembalikan atau mengatur gaya kepala panah di akhir sebuah garis. |
| [getBeginArrowheadWidth()](#getBeginArrowheadWidth--) | Mengembalikan atau mengatur lebar kepala panah di awal sebuah garis. |
| [setBeginArrowheadWidth(byte value)](#setBeginArrowheadWidth-byte-) | Mengembalikan atau mengatur lebar kepala panah di awal sebuah garis. |
| [getEndArrowheadWidth()](#getEndArrowheadWidth--) | Mengembalikan atau mengatur lebar kepala panah di akhir sebuah garis. |
| [setEndArrowheadWidth(byte value)](#setEndArrowheadWidth-byte-) | Mengembalikan atau mengatur lebar kepala panah di akhir sebuah garis. |
| [getBeginArrowheadLength()](#getBeginArrowheadLength--) | Mengembalikan atau mengatur panjang kepala panah di awal sebuah garis. |
| [setBeginArrowheadLength(byte value)](#setBeginArrowheadLength-byte-) | Mengembalikan atau mengatur panjang kepala panah di awal sebuah garis. |
| [getEndArrowheadLength()](#getEndArrowheadLength--) | Mengembalikan atau mengatur panjang kepala panah di akhir sebuah garis. |
| [setEndArrowheadLength(byte value)](#setEndArrowheadLength-byte-) | Mengembalikan atau mengatur panjang kepala panah di akhir sebuah garis. |
...
Mengembalikan true jika format garis tidak terdefinisi (seperti baru dibuat, default). Boolean hanya-baca.
...
Mengembalikan format isi sebuah garis. Hanya-baca [ILineFillFormat](../../com.aspose.slides/ilinefillformat).
...
Mengembalikan format sketsa sebuah garis. Hanya-baca [ISketchFormat](../../com.aspose.slides/isketchformat).
...
Mengembalikan atau mengatur gaya kepala panah di awal sebuah garis. Baca/tulis [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
Mengembalikan atau mengatur gaya kepala panah di akhir sebuah garis. Baca/tulis [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
Mengembalikan atau mengatur lebar kepala panah di awal sebuah garis. Baca/tulis [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
Mengembalikan atau mengatur lebar kepala panah di akhir sebuah garis. Baca/tulis [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
Mengembalikan atau mengatur panjang kepala panah di awal sebuah garis. Baca/tulis [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
Mengembalikan atau mengatur panjang kepala panah di akhir sebuah garis. Baca/tulis [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
**Mengembalikan:**
boolean - **true** jika LineFormat yang ditentukan sama dengan LineFormat saat ini; jika tidak, **false**.
