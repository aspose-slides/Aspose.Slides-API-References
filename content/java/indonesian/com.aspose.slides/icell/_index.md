...
| [getColSpan()](#getColSpan--) | Mengembalikan jumlah kolom grid dalam tabel induk yang akan dilewati oleh sel saat ini. |
| [getRowSpan()](#getRowSpan--) | Mengembalikan jumlah baris yang dicakup oleh sel yang digabung. |
| [getTextFrame()](#getTextFrame--) | Mengembalikan frame teks dari sebuah sel. |
...
Mengembalikan jumlah kolom grid dalam tabel induk yang akan dilewati oleh sel saat ini. Properti ini memungkinkan sel memiliki tampilan seolah-olah digabung, karena mereka melintasi batas vertikal sel lain dalam tabel. Hanya-baca int.
...
Mengembalikan frame teks dari sebuah sel. Hanya-baca [ITextFrame](../../com.aspose.slides/itextframe).
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| height | double | Tinggi sebuah baris. |
