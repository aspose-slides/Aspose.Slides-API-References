...
| [getVariableScale()](#getVariableScale--) | Menentukan bahwa konten tampilan harus secara otomatis menyesuaikan skala agar paling cocok dengan ukuran jendela saat ini. |
| [setVariableScale(boolean value)](#setVariableScale-boolean-) | Menentukan bahwa konten tampilan harus secara otomatis menyesuaikan skala agar paling cocok dengan ukuran jendela saat ini. |
...
Menentukan bahwa konten tampilan harus secara otomatis menyesuaikan skala agar paling cocok dengan ukuran jendela saat ini. Baca/tulis boolean.
