...
| [getAdvanceOnClick()](#getAdvanceOnClick--) | Menentukan apakah klik mouse akan maju ke slide berikutnya atau tidak. |
| [setAdvanceOnClick(boolean value)](#setAdvanceOnClick-boolean-) | Menentukan apakah klik mouse akan maju ke slide berikutnya atau tidak. |
| [getAdvanceAfter()](#getAdvanceAfter--) | Atribut ini menentukan apakah pertunjukan slide akan pindah ke slide berikutnya setelah waktu tertentu. |
| [setAdvanceAfter(boolean value)](#setAdvanceAfter-boolean-) | Atribut ini menentukan apakah pertunjukan slide akan pindah ke slide berikutnya setelah waktu tertentu. |
...
| [getSpeed()](#getSpeed--) | Menentukan kecepatan transisi yang akan digunakan ketika berpindah dari slide saat ini ke slide berikutnya. |
| [setSpeed(int value)](#setSpeed-int-) | Menentukan kecepatan transisi yang akan digunakan ketika berpindah dari slide saat ini ke slide berikutnya. |
...
| [getDuration()](#getDuration--) | Mengambil atau mengatur durasi efek transisi slide dalam milidetik. |
| [setDuration(int value)](#setDuration-int-) | Mengambil atau mengatur durasi efek transisi slide dalam milidetik. |
...
Menentukan apakah klik mouse akan maju ke slide berikutnya atau tidak. Jika atribut ini tidak ditentukan, nilai true diasumsikan. Baca/tulis boolean.
...
Atribut ini menentukan apakah pertunjukan slide akan pindah ke slide berikutnya setelah waktu tertentu. Baca/tulis boolean.
...
> 
>      // Periksa apakah flag Advance Slide After sudah dicentang
...
Menentukan waktu, dalam milidetik, setelah itu transisi harus dimulai. Pengaturan ini dapat digunakan bersama atribut advClick. Jika atribut ini tidak ditentukan, diasumsikan tidak ada auto-advance. Baca/tulis long.
...
Menentukan kecepatan transisi yang akan digunakan ketika berpindah dari slide saat ini ke slide berikutnya. Baca/tulis [TransitionSpeed](../../com.aspose.slides/transitionspeed).
...
Nilai transisi pertunjukan slide. Hanya-baca [ITransitionValueBase](../../com.aspose.slides/itransitionvaluebase).
...
Menentukan apakah suara ini merupakan suara bawaan atau tidak. Jika atribut ini diset true, maka aplikasi pembuat akan memeriksa atribut name yang ditentukan untuk suara ini dalam daftar suara bawaan dan dapat menampilkan nama khusus atau UI yang diperlukan. Baca/tulis boolean.
...
Menentukan nama yang dapat dibaca manusia untuk suara transisi. Properti Sound (\#getSound.getSound/\#setSound(IAudio).setSound(IAudio)) harus ditetapkan untuk mengambil atau mengatur nama suara. Baca/tulis String.
...
Mengambil atau mengatur durasi efek transisi slide dalam milidetik. Baca/tulis int.

--------------------

Berkaitan dengan atribut p14:dur pada elemen p:transition dalam skema PresentationML. Jika tidak diset, durasi ditentukan secara otomatis berdasarkan properti \#getSpeed.getSpeed/\#setSpeed(int).setSpeed(int) dan jenis transisi.
...
**Mengembalikan:**
boolean - **true** jika SlideShowTransition yang ditentukan sama dengan SlideShowTransition saat ini; selainnya, **false**.
...
Di-override untuk membuat kompiler senang. Selalu mengembalikan nilai konstan karena objek bersifat mutable.