...
description: Mewakili nilai string yang dapat disimpan dalam dokumen presentasi pptx dengan dua cara: 1) dalam sel/sel-sel buku kerja yang terkait dengan bagan; 2) sebagai nilai literal.
type: docs
...
Mewakili nilai string yang dapat disimpan dalam dokumen presentasi pptx dengan dua cara: 1) dalam sel/sel-sel buku kerja yang terkait dengan bagan; 2) sebagai nilai literal.
## Metode
...
| [getCellsAddressInWorkbook()](#getCellsAddressInWorkbook--) | Jika properti DataSourceType adalah DataSourceType.Worksheet maka metode ini mengembalikan alamat sel-sel dalam buku kerja yang mewakili data string. |
...
Jika properti DataSourceType adalah DataSourceType.Worksheet maka metode ini mengembalikan alamat sel-sel dalam buku kerja yang mewakili data string. Jika tidak, mengembalikan string kosong.

**Mengembalikan:**
java.lang.String - String nilai String