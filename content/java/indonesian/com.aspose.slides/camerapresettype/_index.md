...
description: Konstanta yang mendefinisikan tipe preset kamera.
type: docs
url: /id/com.aspose.slides/camerapresettype/
---
**Pewarisan:**
...
Konstanta yang mendefinisikan tipe preset kamera.
## Bidang
...
### IsometricOffAxis4Left {#IsometricOffAxis4Left}
```
public static final int IsometricOffMatrix4Left
```
