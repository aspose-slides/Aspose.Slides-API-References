...
| [getValue()](#getValue--) | Mendapatkan atau mengatur nilai sebuah sel. |
| [setValue(Object value)](#setValue-java.lang.Object-) | Mendapatkan atau mengatur nilai sebuah sel. |
| [getFormula()](#getFormula--) | Mendapatkan atau mengatur rumus dalam gaya A1. |
| [setFormula(String value)](#setFormula-java.lang.String-) | Mendapatkan atau mengatur rumus dalam gaya A1. |
| [getR1C1Formula()](#getR1C1Formula--) | Mendapatkan atau mengatur rumus dalam gaya R1C1. |
| [setR1C1Formula(String value)](#setR1C1Formula-java.lang.String-) | Mendapatkan atau mengatur rumus dalam gaya R1C1. |
| [getChartDataWorksheet()](#getChartDataWorksheet--) | Mendapatkan lembar kerja. |
| [isHidden()](#isHidden--) | Menentukan apakah sel tersembunyi. |
| [getCustomNumberFormat()](#getCustomNumberFormat--) | Mendapatkan atau mengatur format tampilan kustom untuk angka dan tanggal. |
| [setCustomNumberFormat(String value)](#setCustomNumberFormat-java.lang.String-) | Mendapatkan atau mengatur format tampilan kustom untuk angka dan tanggal. |
...
| [calculate(boolean updateValues)](#calculate-boolean-) | Jika sel berisi rumus, nilai akan diperbarui berdasarkan rumus tersebut. |
### getRow() {#getRow--}
```
...
Mendapatkan atau mengatur nilai sebuah sel. Baca/tulis Object.
...
Mendapatkan atau mengatur rumus dalam gaya R1C1.
...
Mendapatkan atau mengatur format tampilan kustom untuk angka dan tanggal. Jika nilai kosong akan digunakan nilai PresetNumberFormat. Baca/tulis String.
...
Mendapatkan atau mengatur format tampilan bawaan untuk angka dan tanggal. Nomor preset harus berada dalam [0..22] atau [37..49]. Baca/tulis byte.
