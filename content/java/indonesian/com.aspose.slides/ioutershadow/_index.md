...
| [getScaleHorizontal()](#getScaleHorizontal--) | Faktor skala horizontal, dalam persen dari ukuran asli. |
| [setScaleHorizontal(double value)](#setScaleHorizontal-double-) | Faktor skala horizontal, dalam persen dari ukuran asli. |
| [getScaleVertical()](#getScaleVertical--) | Faktor skala vertikal, dalam persen dari ukuran asli. |
| [setScaleVertical(double value)](#setScaleVertical-double-) | Faktor skala vertikal, dalam persen dari ukuran asli. |
...
Warna bayangan. Nilai default - hitam otomatis (tergantung tema). Baca-saja [IColorFormat](../../com.aspose.slides/icolorformat).
...
Faktor skala vertikal, dalam persen dari ukuran asli. Skala negatif menyebabkan pembalikan. Nilai default - 100 %. Baca/tulis double.
