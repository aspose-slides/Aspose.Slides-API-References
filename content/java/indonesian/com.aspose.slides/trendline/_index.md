...
| Metode | Deskripsi |
| --- | --- |
| [getTrendlineName()](#getTrendlineName--) | Mengambil atau mengatur nama garis tren. |
| [setTrendlineName(String value)](#setTrendlineName-java.lang.String-) | Mengambil atau mengatur nama garis tren. |
| [getTrendlineType()](#getTrendlineType--) | Mengambil atau mengatur tipe garis tren. |
| [setTrendlineType(int value)](#setTrendlineType-int-) | Mengambil atau mengatur tipe garis tren. |
...
| [getBackward()](#getBackward--) | Menentukan jumlah kategori (atau unit pada diagram sebar) yang garis tren memperluas sebelum data untuk seri yang sedang ditrend. |
| [setBackward(double value)](#setBackward-double-) | Menentukan jumlah kategori (atau unit pada diagram sebar) yang garis tren memperluas sebelum data untuk seri yang sedang ditrend. |
| [getForward()](#getForward--) | Menentukan jumlah kategori (atau unit pada diagram sebar) yang garis tren memperluas setelah data untuk seri yang sedang ditrend. |
| [setForward(double value)](#setForward-double-) | Menentukan jumlah kategori (atau unit pada diagram sebar) yang garis tren memperluas setelah data untuk seri yang sedang ditrend. |
| [getIntercept()](#getIntercept--) | Menentukan nilai di mana garis tren memotong sumbu y. |
| [setIntercept(double value)](#setIntercept-double-) | Menentukan nilai di mana garis tren memotong sumbu y. |
...
| [getDisplayRSquaredValue()](#getDisplayRSquaredValue--) | Menentukan bahwa nilai R-kuadrat dari garis tren ditampilkan pada diagram (dalam label yang sama dengan persamaan). |
| [setDisplayRSquaredValue(boolean value)](#setDisplayRSquaredValue-boolean-) | Menentukan bahwa nilai R-kuadrat dari garis tren ditampilkan pada diagram (dalam label yang sama dengan persamaan). |
...
Mengambil atau mengatur nama garis tren. Baca/tulis String.
...
Mengambil atau mengatur tipe garis tren. Baca/tulis [TrendlineType](../../com.aspose.slides/trendlinetype).
...
Menentukan jumlah kategori (atau unit pada diagram sebar) yang garis tren memperluas sebelum data untuk seri yang sedang ditrend. Pada diagram sebar dan non-sebar, nilai harus berupa nilai non-negatif. Baca/tulis double.
...
Menentukan jumlah kategori (atau unit pada diagram sebar) yang garis tren memperluas setelah data untuk seri yang sedang ditrend. Pada diagram sebar dan non-sebar, nilai harus berupa nilai non-negatif. Baca/tulis double.
...
Menentukan nilai di mana garis tren memotong sumbu y. Properti ini hanya didukung ketika tipe garis tren adalah exp, linear, atau poly. Baca/tulis double.
...
Menentukan bahwa nilai R-kuadrat dari garis tren ditampilkan pada diagram (dalam label yang sama dengan persamaan). Baca/tulis boolean.
...
Inisialisasi TextFrameForOverriding dengan teks dalam parameter "text". Jika TextFrameForOverriding sudah diinisialisasi maka cukup ubah teksnya.
