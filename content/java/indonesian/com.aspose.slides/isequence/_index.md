...
| Method | Description |
| --- | --- |
| [getCount()](#getCount--) | Mengembalikan jumlah efek dalam sequense. |
...
| [addEffect(IChart chart, int type, int index, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-) | Menambahkan efek animasi diagram baru untuk kategori atau seri ke akhir urutan. |
| [addEffect(IChart chart, int type, int seriesIndex, int categoriesIndex, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-int-) | Menambahkan efek animasi diagram baru untuk elemen dalam kategori atau seri ke akhir urutan. |
...
Mengembalikan jumlah efek dalam sequense. Hanya-baca int.
...
| Parameter | Type | Description |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | Objek shape [IShape](../../com.aspose.slides/ishape) |
...
Menambahkan efek animasi diagram baru untuk kategori atau seri ke akhir urutan.
...
Menambahkan efek animasi diagram baru untuk elemen dalam kategori atau seri ke akhir urutan.
...
| chart | [IChart](../../com.aspose.slides/ichart) | Objek Chart [IChart](../../com.aspose.slides/ichart) |
| type | int | Tipe efek animasi [EffectChartMinorGroupingType](../../com.aspose.slides/effectchartminorgroupingtype) |
| seriesIndex | int | Indeks series chart int |
