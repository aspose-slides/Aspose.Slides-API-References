...
type: docs
url: /id/com.aspose.slides/effectformat/
---
**Pewarisan:**
...
| [isNoEffects()](#isNoEffects--) | Mengembalikan true jika semua efek dinonaktifkan (seperti baru dibuat, default EffectFormat object). |
...
| [getGlowEffect()](#getGlowEffect--) | Efek glow. |
| [setGlowEffect(IGlow value)](#setGlowEffect-com.aspose.slides.IGlow-) | Efek glow. |
...
| [setBlurEffect(double radius, boolean grow)](#setBlurEffect-double-boolean-) | Mengatur efek blur. |
| [enableFillOverlayEffect()](#enableFillOverlayEffect--) | Mengaktifkan efek overlay isi. |
| [enableGlowEffect()](#enableGlowEffect--) | Mengaktifkan efek glow. |
...
| [disableGlowEffect()](#disableGlowEffect--) | Menonaktifkan efek glow. |
...
| [getEffective()](#getEffective--) | Mendapatkan data pemformatan efek efektif dengan pewarisan yang diterapkan. |
### getVersion() {#getVersion--}
```
...
Mengembalikan true jika semua efek dinonaktifkan (seperti baru dibuat, default EffectFormat object). Baca-saja  boolean .
...
Efek glow. Baca/tulis [IGlow](../../com.aspose.slides/iglow).
