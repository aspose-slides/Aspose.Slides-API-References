...
description: Mewakili sekumpulan titik yang akan digambar pada pai atau batang kedua pada diagram bar-of-pie atau pie-of-pie dengan pemisahan khusus.
type: docs
...
Mewakili sekumpulan titik yang akan digambar pada pai atau batang kedua pada diagram bar-of-pie atau pie-of-pie dengan pemisahan khusus.
## Metode

| Metode | Deskripsi |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Mengembalikan titik data grafik berdasarkan indeks. |
...
Mengembalikan titik data grafik berdasarkan indeks.
...
**Mengembalikan:**
[IChartDataPoint](../../com.aspose.slides/ichartdatapoint) - Titik data grafik.
