...
Menentukan objek pecahan, yang terdiri dari pembilang dan penyebut yang dipisahkan oleh garis pecahan. Garis pecahan dapat horizontal atau diagonal, tergantung pada properti pecahan. Objek pecahan juga digunakan untuk mewakili fungsi stack, yang menempatkan satu elemen di atas elemen lain, tanpa garis pecahan.
...
| --- | --- |
| [MathFraction(IMathElement numerator, IMathElement denominator, int fractionType)](#MathFraction-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-int-) | Menginisialisasi MathFraction dengan numerator, denominator, dan tipe yang ditentukan |
| [MathFraction(IMathElement numerator, IMathElement denominator)](#MathFraction-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-) | Menginisialisasi MathFraction dengan tipe 'Bar' menggunakan numerator dan denominator yang ditentukan |
## Metode
...
Menginisialisasi MathFraction dengan numerator, denominator, dan tipe yang ditentukan
...
Menginisialisasi MathFraction dengan tipe 'Bar' menggunakan numerator dan denominator yang ditentukan
