...
description: Mewakili sekumpulan aturan FontFallBack yang didefinisikan oleh pengguna
type: docs
...
Mewakili sekumpulan aturan FontFallBack, yang didefinisikan oleh pengguna
## Constructors
...
| Metode | Deskripsi |
| --- | --- |
| [size()](#size--) | Mengambil jumlah aturan yang sebenarnya terdapat dalam koleksi. |
...
| [get_Item(int index)](#get-Item-int-) | Mengambil aturan pada indeks yang ditentukan. |
...
Mengambil jumlah aturan yang sebenarnya terdapat dalam koleksi. Read-only int.
...
>      //Mengambil objek dari aturan pertama dalam koleksi
...
Mengambil aturan pada indeks yang ditentukan. Read-only [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule).
