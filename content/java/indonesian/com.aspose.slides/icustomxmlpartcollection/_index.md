...
| [remove(ICustomXmlPart item)](#remove-com.aspose.slides.ICustomXmlPart-) | Menghapus kejadian pertama dari objek tertentu dari koleksi. |
...
| --- | --- | --- |
| index | int | Indeks berbasis nol dari elemen yang ingin diakses. |
