...
| Metode | Deskripsi |
| --- | --- |
| [getPortionFormat()](#getPortionFormat--) | Mengembalikan objek pemformatan yang berisi properti pemformatan yang ditetapkan secara eksplisit pada bagian teks tanpa pewarisan diterapkan. |
...
| [removeField()](#removeField--) | Mengonversi bidang bagian ini menjadi bagian sederhana. |
| [getRect()](#getRect--) | Mendapatkan koordinat persegi yang membatasi bagian. |
...
Mengembalikan objek pemformatan yang berisi properti pemformatan yang ditetapkan secara eksplisit pada bagian teks tanpa pewarisan diterapkan. Hanya-baca [IPortionFormat](../../com.aspose.slides/iportionformat).
...
Mengembalikan bidang dari bagian ini. Hanya-baca [IField](../../com.aspose.slides/ifield).
...
Mengonversi bidang bagian ini menjadi bagian sederhana.
...
Mendapatkan koordinat persegi yang membatasi bagian. Persegi mencakup semua baris teks dalam bagian, termasuk yang kosong.
...
**Mengembalikan:**
java.awt.geom.Rectangle2D.Float - Persegi panjang yang membatasi bagian java.awt.geom.Rectangle2D.Float
...
Mendapatkan koordinat awal bagian. Koordinat X titik mewakili awal bagian dari karakter pertama termasuk bearing sisi kiri. Koordinat Y mencakup bearing sisi atas.

**Mengembalikan:**
java.awt.geom.Point2D.Float - Koordinat awal bagian java.awt.geom.Point2D.Float