...
type: docs
url: /id/com.aspose.slides/extracolorschemecollection/
---
**Warisan:**
java.lang.Object
...
| [get_Item(int index)](#get-Item-int-) | Mengembalikan skema warna berdasarkan indeks. |
...
| [isSynchronized()](#isSynchronized--) | Mengembalikan nilai yang menunjukkan apakah akses ke ArrayList disinkronkan (aman terhadap thread). |
...
Mengembalikan skema warna berdasarkan indeks. Hanya-baca [ExtraColorScheme](../../com.aspose.slides/extracolorscheme).
...
Mengembalikan nilai yang menunjukkan apakah akses ke ArrayList disinkronkan (aman terhadap thread). Hanya-baca boolean.
...
Mengembalikan objek yang dapat digunakan untuk menyinkronkan akses ke koleksi. Hanya-baca Object.
