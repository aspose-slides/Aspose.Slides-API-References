...
| [getSiteId()](#getSiteId--) | Mengembalikan atau mengatur pengidentifikasi situs Azure Active Directory (Azure AD) yang terkait dengan kebijakan label sensitivitas yang mendeskripsikan label sensitivitas. |
| [setSiteId(UUID value)](#setSiteId-java.util.UUID-) | Mengembalikan atau mengatur pengidentifikasi situs Azure Active Directory (Azure AD) yang terkait dengan kebijakan label sensitivitas yang mendeskripsikan label sensitivitas. |
...
| [getContentMarkTypes()](#getContentMarkTypes--) | Mengembalikan daftar tipe penandaan konten yang harus diterapkan pada file. |
### getId() {#getId--}
```
...
Mengembalikan atau mengatur pengidentifikasi situs Azure Active Directory (Azure AD) yang terkait dengan kebijakan label sensitivitas yang mendeskripsikan label sensitivitas. Baca/tulis java.util.UUID.
...
Mengembalikan daftar tipe penandaan konten yang harus diterapkan pada file.
