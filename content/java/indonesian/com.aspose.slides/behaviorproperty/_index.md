...
description: Mewakili jenis properti untuk perilaku animasi.
type: docs
...
| [isCustom()](#isCustom--) | Menunjukkan apakah properti ini tidak termasuk dalam daftar properti yang telah ditentukan dalam spesifikasi: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx |
| [getPptX()](#getPptX--) | Mewakili properti 'ppt\_x' |
| [getPptY()](#getPptY--) | Mewakili properti 'ppt\_y' |
| [getPptW()](#getPptW--) | Mewakili properti 'ppt\_w' |
| [getPptH()](#getPptH--) | Mewakili properti 'ppt\_h' |
| [getPptC()](#getPptC--) | Mewakili properti 'ppt\_c' |
| [getPptR()](#getPptR--) | Mewakili properti 'ppt\_r' |
...
| [equals(Object obj)](#equals-java.lang.Object-) | Memeriksa apakah objek ini sama dengan yang lain. |
| [hashCode()](#hashCode--) | Menghitung dan mengembalikan kode hash berdasarkan properti (#getValue.getValue) |
| [getOrCreateByValue(String propertyValue)](#getOrCreateByValue-java.lang.String-) | Mencari properti perilaku yang ada berdasarkan nilai atau membuat yang baru dengan nilai yang ditentukan |
### getValue() {#getValue--}
```
...
Mewakili 'imageData.chromakey' properti
...
Mewakili 'fill.opacity' properti
...
Mewakili 'fill.opacity2' properti
...
Mewakili 'fill.focusposition.y' properti
...
Mewakili 'fill.focussize.x' properti
...
Mewakili 'fill.focussize.y' properti
...
Mewakili 'stroke.color' properti
...
Mewakili 'stroke.weight' properti
...
Mewakili 'stroke.linestyle' properti
...
Mewakili 'stroke.dashstyle' properti
...
Mewakili 'stroke.filltype' properti
...
Mewakili 'stroke.color2' properti
...
Mewakili 'stroke.imagesize.x' properti
...
Mewakili 'stroke.imagesize.y' properti
...
Mewakili 'stroke.startArrow' properti
...
Mewakili 'stroke.startArrowWidth' properti
...
Mewakili 'stroke.startArrowLength' properti
...
Mewakili 'stroke.endArrowWidth' properti
...
Mewakili 'stroke.endArrowLength' properti
...
Mewakili 'shadow.color' properti
...
Mewakili 'shadow.color2' properti
...
Mewakili 'shadow.opacity' properti
...
Mewakili 'shadow.offset.x' properti
...
Mewakili 'shadow.offset.y' properti
...
Mewakili 'shadow.offset2.x' properti
...
Mewakili 'shadow.origin.x' properti
...
Mewakili 'shadow.origin.y' properti
...
Mewakili 'shadow.matrix.xtox' properti
...
Mewakili 'shadow.matrix.xtoy' properti
...
Mewakili 'shadow.matrix.ytox' properti
...
Mewakili 'shadow.matrix.ytoy' properti
...
Mewakili 'shadow.matrix.perspectiveX' properti
...
Mewakili 'shadow.matrix.perspectiveY' properti
...
Mewakili 'skew.offset.y' properti
...
Mewakili 'skew.origin.x' properti
...
Mewakili 'skew.origin.y' properti
...
Mewakili 'skew.matrix.xtox' properti
...
Mewakili 'skew.matrix.ytoy' properti
...
Mewakili 'skew.matrix.perspectiveX' properti
...
Mewakili 'skew.matrix.perspectiveY' properti
...
Mewakili 'extrusion.on' properti
...
Mewakili 'extrusion.type' properti
...
Mewakili 'extrusion.render' properti
...
Mewakili 'extrusion.viewpointorigin.x' properti
...
Mewakili 'extrusion.viewpointorigin.y' properti
...
Mewakili 'extrusion.viewpoint.y' properti
...
Mewakili 'extrusion.viewpoint.z' properti
...
Mewakili 'extrusion.plane' properti
...
Mewakili 'extrusion.skewangle' properti
...
Mewakili 'extrusion.backdepth' properti
...
Mewakili 'extrusion.foredepth' properti
...
Mewakili 'extrusion.orientation.x' properti
...
Mewakili 'extrusion.orientation.y' properti
...
Mewakili 'extrusion.orientation.z' properti
...
Mewakili 'extrusion.color' properti
...
Mewakili 'extrusion.rotationangle.x' properti
...
Mewakili 'extrusion.rotationangle.y' properti
...
Mewakili 'extrusion.lockrotationcenter' properti
...
Mewakili 'extrusion.autorotationcenter' properti
...
Mewakili 'extrusion.rotationcenter.x' properti
...
Mewakili 'extrusion.rotationcenter.y' properti
...
Mewakili 'extrusion.rotationcenter.z' properti
...
Mewakili 'extrusion.colormode' properti
...
Mencari properti perilaku yang ada berdasarkan nilai atau membuat yang baru dengan nilai yang ditentukan
...
**Mengembalikan:**
[BehaviorProperty](../../com.aspose.slides/behaviorproperty) - instansi BehaviorProperty