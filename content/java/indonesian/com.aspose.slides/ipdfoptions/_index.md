...
| Metode | Deskripsi |
| --- | --- |
| [getTextCompression()](#getTextCompression--) | Menentukan jenis kompresi yang akan digunakan untuk semua konten tekstual dalam dokumen. |
| [setTextCompression(int value)](#setTextCompression-int-) | Menentukan jenis kompresi yang akan digunakan untuk semua konten tekstual dalam dokumen. |
...
| [getAdditionalCommonFontFamilies()](#getAdditionalCommonFontFamilies--) | Mengembalikan atau mengatur array nama-nama keluarga font yang ditentukan pengguna yang harus dianggap umum oleh Aspose.Slides. |
| [setAdditionalCommonFontFamilies(String[] value)](#setAdditionalCommonFontFamilies-java.lang.String---) | Mengembalikan atau mengatur array nama-nama keluarga font yang ditentukan pengguna yang harus dianggap umum oleh Aspose.Slides. |
...
| [getRasterizeUnsupportedFontStyles()](#getRasterizeUnsupportedFontStyles--) | Menunjukkan apakah teks harus dirasterkan sebagai bitmap dan disimpan ke PDF ketika font tidak mendukung gaya tebal. |
| [setRasterizeUnsupportedFontStyles(boolean value)](#setRasterizeUnsupportedFontStyles-boolean-) | Menunjukkan apakah teks harus dirasterkan sebagai bitmap dan disimpan ke PDF ketika font tidak mendukung gaya tebal. |
...
| [getPassword()](#getPassword--) | Mengatur kata sandi pengguna untuk melindungi dokumen PDF. |
| [setPassword(String value)](#setPassword-java.lang.String-) | Mengatur kata sandi pengguna untuk melindungi dokumen PDF. |
...
| [setImageTransparentColor(Color value)](#setImageTransparentColor-java.awt.Color-) | Mendapatkan atau mengatur warna transparan gambar. |
...
| [getIncludeOleData()](#getIncludeOleData--) | True untuk mengonversi semua data OLE dari presentasi menjadi berkas tersemat dalam PDF yang dihasilkan. |
| [setIncludeOleData(boolean value)](#setIncludeOleData-boolean-) | True untuk mengonversi semua data OLE dari presentasi menjadi berkas tersemat dalam PDF yang dihasilkan. |
...
Menentukan jenis kompresi yang akan digunakan untuk semua konten tekstual dalam dokumen. Baca/tulis [PdfTextCompression](../../com.aspose.slides/pdftextcompression).

--------------------

Default adalah [PdfTextCompression.Flate](../../com.aspose.slides/pdftextcompression\#Flate).
...
Menunjukkan apakah kompresi paling efektif (bukan yang default) untuk setiap gambar harus dipilih secara otomatis. Jika disetel true, untuk setiap gambar dalam presentasi algoritma kompresi yang paling tepat akan dipilih, yang akan menghasilkan ukuran PDF yang lebih kecil.

--------------------

Pemilihan rasio kompresi gambar terbaik memerlukan komputasi yang intensif dan menggunakan RAM tambahan, dan opsi ini bernilai false secara default.
...
Mengembalikan atau mengatur array nama-nama keluarga font yang ditentukan pengguna yang harus dianggap umum oleh Aspose.Slides. Baca/tulis String[].
...
Gunakan properti ini untuk mendapatkan atau mengatur kualitas gambar dalam dokumen saat menyimpan dalam format PDF. Nilai dapat bervariasi dari 0 hingga 100 dimana 0 berarti kualitas terburuk tetapi kompresi maksimum dan 100 berarti kualitas terbaik tetapi kompresi minimum.
...
Default adalah [PdfCompliance.Pdf17](../../com.aspose.slides/pdfcompliance\#Pdf17).
...
Default adalah **true**. Dokumen PDF dapat berisi grafik vektor dan gambar raster. Jika SaveMetafilesAsPng disetel true maka gambar Metafile sumber dikonversi ke format Png dan disimpan ke Pdf sebagai gambar raster. Jika SaveMetafilesAsPng disetel false maka Metafile sumber dikonversi ke grafik vektor Pdf. Setiap pendekatan memiliki kelebihan dan kekurangan. Misalnya, jika Metafile dikonversi ke PNG, beberapa kehilangan kualitas dapat terjadi saat skala dokumen hasil. Jika Metafile dikonversi ke grafik vektor Pdf, masalah kinerja pada penampil Pdf dapat terjadi.
...
Nilai: Efek parameter ini tergantung pada beberapa faktor. Algoritma mencoba mendapatkan ukuran gambar output terbaik berdasarkan nilai properti, ukuran gambar sumber, dan ukuran bingkai gambar. Penggunaan nilai properti yang serupa dapat memberikan hasil yang sama. Disarankan menggunakan langkah 16 atau 32 untuk mendapatkan efek yang terlihat.
...
True untuk mengonversi semua data OLE dari presentasi menjadi berkas tersemat dalam PDF yang dihasilkan. Baca/tulis boolean.
