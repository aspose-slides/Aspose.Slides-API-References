...
description: Merepresentasikan nilai double yang dapat disimpan dalam dokumen presentasi pptx dengan dua cara: 1) dalam sel/sel workbook yang terkait dengan chart; 2) sebagai nilai literal.
type: docs
...
Merepresentasikan nilai double yang dapat disimpan dalam dokumen presentasi pptx dengan dua cara: 1) dalam cell/cells workbook yang terkait dengan chart; 2) sebagai nilai literal.
## Metode
