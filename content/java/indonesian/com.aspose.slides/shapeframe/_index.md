...
| Metode | Deskripsi |
| --- | --- |
| [getX()](#getX--) | Mengembalikan koordinat X sudut kiri-atas sebuah bingkai. |
| [getY()](#getY--) | Mengembalikan koordinat Y sudut kiri-atas sebuah bingkai. |
| [getWidth()](#getWidth--) | Mengembalikan lebar sebuah bingkai. |
| [getHeight()](#getHeight--) | Mengembalikan tinggi sebuah bingkai. |
| [getRotation()](#getRotation--) | Mengembalikan jumlah derajat bingkai diputar di sekitar sumbu z. |
| [getCenterX()](#getCenterX--) | Mengembalikan koordinat X pusat sebuah bingkai. |
| [getCenterY()](#getCenterY--) | Mengembalikan koordinat Y pusat sebuah bingkai. |
| [getFlipH()](#getFlipH--) | Menentukan apakah bingkai dibalik secara horizontal. |
| [getFlipV()](#getFlipV--) | Menentukan apakah bingkai dibalik secara vertikal. |
| [getRectangle()](#getRectangle--) | Mengembalikan koordinat sebuah bingkai. |
| [deepClone()](#deepClone--) | Mengkloning |
| [cloneT()](#cloneT--) | Mengkloning. |
| [hashCode()](#hashCode--) |  |
...
| --- | --- | --- |
| x | float | Koordinat X sebuah bingkai. |
| y | float | Koordinat Y sebuah bingkai. |
| width | float | Lebar sebuah bingkai. |
| height | float | Tinggi sebuah bingkai. |
| flipH | byte | Benar jika bingkai dibalik secara horizontal. |
| flipV | byte | Benar jika bingkai dibalik secara vertikal. |
...
Mengembalikan koordinat X sudut kiri-atas sebuah bingkai. Baca-saja float.
...
Mengembalikan koordinat Y sudut kiri-atas sebuah bingkai. Baca-saja float.
...
Mengembalikan jumlah derajat bingkai diputar di sekitar sumbu z. Nilai positif menunjukkan rotasi searah jarum jam; nilai negatif menunjukkan rotasi berlawanan arah jarum jam. Baca-saja float.
...
Mengembalikan koordinat X pusat sebuah bingkai. Baca-saja float.
...
Mengembalikan koordinat Y pusat sebuah bingkai. Baca-saja float.
...
Menentukan apakah bingkai dibalik secara horizontal. Baca-saja [NullableBool](../../com.aspose.slides/nullablebool).
...
Menentukan apakah bingkai dibalik secara vertikal. Baca-saja [NullableBool](../../com.aspose.slides/nullablebool).
...
Mengembalikan koordinat sebuah bingkai. Baca-saja java.awt.geom.Rectangle2D.Float.
...
**Mengembalikan:**
java.lang.Object - Bingkai bentuk yang di-kloning.
...
**Mengembalikan:**
[IShapeFrame](../../com.aspose.slides/ishapeframe) - Bingkai bentuk yang di-kloning.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| value | [ShapeFrame](../../com.aspose.slides/shapeframe) | ShapeFRameEx untuk dibandingkan dengan instance ini. |
