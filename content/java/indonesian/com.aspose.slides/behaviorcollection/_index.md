...
| [copyTo(IBehavior[] array, int arrayIndex)](#copyTo-com.aspose.slides.IBehavior---int-) | Menyalin elemen-elemen [IGenericCollection](../../com.aspose.slides/igenericcollection) ke dalam Array, dimulai pada indeks Array tertentu. |
...
Mengembalikan jumlah perilaku dalam sebuah koleksi. int baca-saja.
...
| --- | --- | --- |
| item | [IBehavior](../../com.aspose.slides/ibehavior) | Perilaku untuk ditambahkan. |
...
| item | [IBehavior](../../com.aspose.slides/ibehavior) | Perilaku untuk disisipkan. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| array | [IBehavior\[\]](../../com.aspose.slides/ibehavior) | Array satu dimensi yang menjadi tujuan elemen yang disalin dari [IGenericCollection](../../com.aspose.slides/igenericcollection). Array harus menggunakan indeks berbasis nol. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| item | [IBehavior](../../com.aspose.slides/ibehavior) | Perilaku untuk dihapus. |
