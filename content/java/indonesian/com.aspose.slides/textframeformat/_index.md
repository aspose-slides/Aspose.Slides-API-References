...
Berisi properti formatTextFrameFormatting TextFrame.

## Konstruktor

| Konstruktor | Deskripsi |
| --- | --- |
| [TextFrameFormat()](#TextFrameFormat--) | Menginisialisasi sebuah instance baru dari kelas [TextFrameFormat](../../com.aspose.slides/textframeformat). |
...
| [getMarginLeft()](#getMarginLeft--) | Mengembalikan atau mengatur margin kiri (points) dalam TextFrame. |
| [setMarginLeft(double value)](#setMarginLeft-double-) | Mengembalikan atau mengatur margin kiri (points) dalam TextFrame. |
| [getMarginRight()](#getMarginRight--) | Mengembalikan atau mengatur margin kanan (points) dalam TextFrame. |
| [setMarginRight(double value)](#setMarginRight-double-) | Mengembalikan atau mengatur margin kanan (points) dalam TextFrame. |
| [getMarginTop()](#getMarginTop--) | Mengembalikan atau mengatur margin atas (points) dalam TextFrame. |
| [setMarginTop(double value)](#setMarginTop-double-) | Mengembalikan atau mengatur margin atas (points) dalam TextFrame. |
| [getMarginBottom()](#getMarginBottom--) | Mengembalikan atau mengatur margin bawah (points) dalam TextFrame. |
| [setMarginBottom(double value)](#setMarginBottom-double-) | Mengembalikan atau mengatur margin bawah (points) dalam TextFrame. |
...
| [getCenterText()](#getCenterText--) | Jika NullableBool.True maka teks harus dipusatkan secara horizontal di dalam kotak. |
| [setCenterText(byte value)](#setCenterText-byte-) | Jika NullableBool.True maka teks harus dipusatkan secara horizontal di dalam kotak. |
...
| [getColumnSpacing()](#getColumnSpacing--) | Mengembalikan atau mengatur spasi antar kolom teks di area teks (dalam points). |
| [setColumnSpacing(double value)](#setColumnSpacing-double-) | Mengembalikan atau mengatur spasi antar kolom teks di area teks (dalam points). |
...
| [getKeepTextFlat()](#getKeepTextFlat--) | Mendapatkan atau mengatur agar teks tetap datar meskipun efek Rotasi 3-D diterapkan. |
| [setKeepTextFlat(boolean value)](#setKeepTextFlat-boolean-) | Mendapatkan atau mengatur agar teks tetap datar meskipun efek Rotasi 3-D diterapkan. |
...
Menginisialisasi sebuah instance baru dari kelas [TextFrameFormat](../../com.aspose.slides/textframeformat).
...
Mengembalikan atau mengatur margin kiri (points) dalam TextFrame. Baca/tulis double.
...
Mengembalikan atau mengatur margin kanan (points) dalam TextFrame. Baca/tulis double.
...
Mengembalikan atau mengatur margin atas (points) dalam TextFrame. Baca/tulis double.
...
Jika NullableBool.True maka teks harus dipusatkan secara horizontal di dalam kotak. Baca/tulis [NullableBool](../../com.aspose.slides/nullablebool).
...
Menentukan orientasi teks. Nilai rotasi visual yang dihasilkan diringkas dari properti ini dan sudut khusus pada properti RotationAngle. Baca/tulis [TextVerticalType](../../com.aspose.slides/textverticaltype).
...
Mengembalikan atau mengatur jumlah kolom di area teks. Nilai ini harus berupa angka positif. Jika tidak, nilai akan diatur menjadi nol. Nilai 0 berarti nilai tidak terdefinisi. Baca/tulis int.

--------------------

> ```
> Kode contoh berikut menunjukkan cara menambahkan kolom dalam Text frame di dalam Presentasi PowerPoint.
>  
>  Presentation pres = new Presentation();
>  try {
...
Mengembalikan atau mengatur spasi antar kolom teks di area teks (dalam points). Ini hanya berlaku ketika ada lebih dari 1 kolom. Nilai ini harus berupa angka positif. Jika tidak, nilai akan diatur menjadi nol. Baca/tulis double.
...
Menentukan rotasi khusus yang diterapkan pada teks di dalam kotak pembatas. Jika tidak ditentukan, rotasi bentuk yang menyertainya digunakan. Jika ditentukan, maka ini diterapkan secara independen dari bentuk. Artinya bentuk dapat memiliki rotasi selain rotasi teks itu sendiri. Nilai rotasi visual yang dihasilkan diringkas dari properti ini dan tipe vertikal yang telah ditentukan pada properti TextVerticalType. Baca/tulis float.

--------------------

> ```
> Pertimbangkan kasus di mana sebuah bentuk memiliki rotasi sebesar 90 derajat searah jarum jam yang diterapkan padanya. 
>  Selain itu, tubuh teks itu sendiri memiliki rotasi sebesar -90 derajat 
>  berlawanan arah jarum jam yang diterapkan padanya. Kemudian bentuk yang dihasilkan akan tampak
>  terrotasi tetapi teks di dalamnya akan tampak seolah-olah tidak pernah diputar sama sekali.
> ```
