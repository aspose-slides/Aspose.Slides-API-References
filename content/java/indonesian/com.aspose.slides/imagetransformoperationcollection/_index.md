...
| [size()](#size--) | Mengembalikan jumlah efek gambar dalam koleksi. |
...
| [clear()](#clear--) | Menghapus semua efek gambar dari koleksi. |
...
| [copyToTArray(IImageTransformOperation[] array, int arrayIndex)](#copyToTArray-com.aspose.slides.IImageTransformOperation---int-) | Menyalin elemen-elemen [IGenericCollection](../../com.aspose.slides/igenericcollection) ke sebuah Array, mulai pada indeks Array tertentu. |
| [removeItem(IImageTransformOperation item)](#removeItem-com.aspose.slides.IImageTransformOperation-) | Menghapus kemunculan pertama objek tertentu dari [IGenericCollection](../../com.aspose.slides/igenericcollection). |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| amount | float | Persentase jumlah untuk mengskalakan alpha. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| alpha | float | Nilai opacity baru. |
...
| grow | boolean | Menentukan apakah batas objek harus diperluas akibat blur. True menunjukkan batas diperluas, false menunjukkan tidak. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| hue | float | Jumlah derajat yang mengubah hue. |
| saturation | float | Persentase yang mengubah saturasi. |
| luminance | float | Persentase yang mengubah luminansi. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| brightness | float | Persentase untuk mengubah kecerahan. |
| contrast | float | Persentase untuk mengubah kontras. |
...
Mengembalikan jumlah efek gambar dalam koleksi. Hanya-baca int .
...
**Mengembalikan:**
boolean - true jika [IGenericCollection](../../com.aspose.slides/igenericcollection) bersifat hanya-baca; selainnya false.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| item | [IImageTransformOperation](../../com.aspose.slides/iimagetransformoperation) | Objek yang akan dicari di [IGenericCollection](../../com.aspose.slides/igenericcollection). |

**Mengembalikan:**
boolean - true jika item ditemukan di [IGenericCollection](../../com.aspose.slides/igenericcollection); selainnya false.
...
Menyalin elemen-elemen [IGenericCollection](../../com.aspose.slides/igenericcollection) ke sebuah Array, mulai pada indeks Array tertentu.
...
Menghapus kemunculan pertama objek tertentu dari [IGenericCollection](../../com.aspose.slides/igenericcollection).
...
**Mengembalikan:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IImageTransformOperation> - Sebuah IGenericEnumerator yang dapat digunakan untuk mengiterasi koleksi.
...
**Mengembalikan:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IImageTransformOperation> - Sebuah java.util.Iterator untuk seluruh koleksi.