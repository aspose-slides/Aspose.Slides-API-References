...
| [getLevel()](#getLevel--) | Mengembalikan tingkat nesting node. |
| [getBulletFillFormat()](#getBulletFillFormat--) | Mengembalikan objek FillFormat yang berisi properti pemformatan isian untuk bullet node. |
...
| [getOrganizationChartLayout()](#getOrganizationChartLayout--) | Mengembalikan atau mengatur tipe layout bagan organisasi yang terkait dengan node saat ini. |
| [setOrganizationChartLayout(int value)](#setOrganizationChartLayout-int-) | Mengembalikan atau mengatur tipe layout bagan organisasi yang terkait dengan node saat ini. |
...
Mengembalikan tingkat nesting node. Hanya-baca int.
...
Mengembalikan objek FillFormat yang berisi properti pemformatan isian untuk bullet node. Catatan: dapat mengembalikan null untuk tipe layout SmartArt tertentu yang tidak menyediakan bullet untuk node. Hanya-baca [IFillFormat](../../com.aspose.slides/ifillformat).
...
Mengembalikan atau mengatur tipe layout bagan organisasi yang terkait dengan node saat ini. Baca/tulis [OrganizationChartLayoutType](../../com.aspose.slides/organizationchartlayouttype).
