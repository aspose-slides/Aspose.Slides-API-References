...
>      // Konfigurasikan Portion dari TextFrame dan konfigurasikan properti PortionFormat.
...
| [getEffective()](#getEffective--) | Mendapatkan data format 3D efektif dengan pewarisan yang diterapkan. |
### getVersion() {#getVersion--}
```
...
Mendapatkan data format 3D efektif dengan pewarisan yang diterapkan.

--------------------

> ```
> Contoh ini menunjukkan cara mendapatkan properti efektif untuk kamera, rig cahaya, dan bevel atas shape.
>  
