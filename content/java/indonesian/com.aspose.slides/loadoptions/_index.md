...
| [LoadOptions(int loadFormat)](#LoadOptions-int-) | Membuat opsi pemuatan baru. |
## Metode
...
| [getPassword()](#getPassword--) | Mendapatkan atau mengatur kata sandi. |
| [setPassword(String value)](#setPassword-java.lang.String-) | Mendapatkan atau mengatur kata sandi. |
...
| [getBlobManagementOptions()](#getBlobManagementOptions--) | Mewakili opsi yang dapat digunakan untuk mengelola perilaku penanganan Binary Large Objects (BLOBs), seperti penggunaan file sementara atau maksimum byte BLOBs dalam memori. |
| [setBlobManagementOptions(IBlobManagementOptions value)](#setBlobManagementOptions-com.aspose.slides.IBlobManagementOptions-) | Mewakili opsi yang dapat digunakan untuk mengelola perilaku penanganan Binary Large Objects (BLOBs), seperti penggunaan file sementara atau maksimum byte BLOBs dalam memori. |
...
| [getSpreadsheetOptions()](#getSpreadsheetOptions--) | Mendapatkan opsi untuk spreadsheet. |
| [setSpreadsheetOptions(ISpreadsheetOptions value)](#setSpreadsheetOptions-com.aspose.slides.ISpreadsheetOptions-) | Mendapatkan opsi untuk spreadsheet. |
...
| [getDeleteEmbeddedBinaryObjects()](#getDeleteEmbeddedBinaryObjects--) | Menentukan apakah Aspose.Slides akan menghapus semua objek biner tertanam selama pemuatan presentasi. |
| [setDeleteEmbeddedBinaryObjects(boolean value)](#setDeleteEmbeddedBinaryObjects-boolean-) | Menentukan apakah Aspose.Slides akan menghapus semua objek biner tertanam selama pemuatan presentasi. |
### LoadOptions() {#LoadOptions--}
```
public LoadOptions()
```

Membuat opsi pemuatan default baru.
...
Properti ini masuk akal jika berkas presentasi dilindungi kata sandi. Nilai true berarti hanya properti dokumen yang harus dimuat dari berkas presentasi yang terenkripsi dan kata sandi diabaikan. Nilai false berarti seluruh presentasi yang terenkripsi harus dimuat dengan menggunakan kata sandi yang benar. Jika presentasi tidak terenkripsi maka nilai properti selalu diabaikan. Jika properti dokumen dari berkas terenkripsi tidak publik dan nilai properti true maka properti dokumen tidak dapat dimuat dan pengecualian akan dilempar. Baca/tulis boolean.
...
Mewakili opsi yang dapat digunakan untuk mengelola perilaku penanganan Binary Large Objects (BLOBs), seperti penggunaan file sementara atau maksimum byte BLOBs dalam memori. Opsi-opsi ini dimaksudkan untuk mengatur rasio kinerja/consumsi memori terbaik untuk lingkungan atau kebutuhan tertentu.

--------------------

Sebuah Binary Large Object (BLOB) adalah data biner yang disimpan sebagai satu entitas – yaitu BLOB dapat berupa audio, video, atau presentasi itu sendiri.
...
Mendapatkan opsi untuk spreadsheet. Misalnya, opsi-opsi ini memengaruhi perhitungan rumus untuk bagan.
...
Menentukan apakah Aspose.Slides akan menghapus semua objek biner tertanam selama pemuatan presentasi.

Tipe objek biner tertanam:
...
> ```
> Contoh berikut menunjukkan cara memuat presentasi tanpa objek biner tertanam.
>  
>  LoadOptions loadOptions = new LoadOptions();
>  loadOptions.setDeleteEmbeddedBinaryObjects(true);
>  Presentation pres = new Presentation("pres.ppt", loadOptions);
