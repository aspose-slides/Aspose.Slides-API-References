...
| [getSiteId()](#getSiteId--) | Mengembalikan atau mengatur pengidentifikasi situs Azure Active Directory (Azure AD) yang sesuai dengan kebijakan label sensitifitas yang menggambarkan label sensitivitas. |
| [setSiteId(UUID value)](#setSiteId-java.util.UUID-) | Mengembalikan atau mengatur pengidentifikasi situs Azure Active Directory (Azure AD) yang sesuai dengan kebijakan label sensitifitas yang menggambarkan label sensitivitas. |
