...
| Metode | Deskripsi |
| --- | --- |
| [getFontSubstRuleList()](#getFontSubstRuleList--) | Substitusi font yang digunakan saat rendering Read/write [IFontSubstRuleCollection](../../com.aspose.slides/ifontsubstrulecollection). |
| [setFontSubstRuleList(IFontSubstRuleCollection value)](#setFontSubstRuleList-com.aspose.slides.IFontSubstRuleCollection-) | Substitusi font yang digunakan saat rendering Read/write [IFontSubstRuleCollection](../../com.aspose.slides/ifontsubstrulecollection). |
| [getFontFallBackRulesCollection()](#getFontFallBackRulesCollection--) | Mewakili koleksi pengguna dari aturan FontFallBack untuk mengelola koleksi font guna substitusi yang tepat melalui fungsi fallback Read/write [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection). |
| [setFontFallBackRulesCollection(IFontFallBackRulesCollection value)](#setFontFallBackRulesCollection-com.aspose.slides.IFontFallBackRulesCollection-) | Mewakili koleksi pengguna dari aturan FontFallBack untuk mengelola koleksi font guna substitusi yang tepat melalui fungsi fallback Read/write [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection). |
...
| [replaceFont(IFontData sourceFont, IFontData destFont)](#replaceFont-com.aspose.slides.IFontData-com.aspose.slides.IFontData-) | Ganti font dalam presentasi |
| [replaceFont(IFontSubstRule substRule)](#replaceFont-com.aspose.slides.IFontSubstRule-) | Ganti font dalam presentasi menggunakan informasi yang diberikan dalam [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) |
| [replaceFont(IFontSubstRuleCollection substRules)](#replaceFont-com.aspose.slides.IFontSubstRuleCollection-) | Ganti font dalam presentasi menggunakan informasi yang diberikan dalam koleksi [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) |
| [getFontBytes(IFontData fontData, int fontStyle)](#getFontBytes-com.aspose.slides.IFontData-int-) | Mengambil array byte yang mewakili data font untuk gaya font dan data font tertentu. |
...
Substitusi font yang digunakan saat rendering Read/write [IFontSubstRuleCollection](../../com.aspose.slides/ifontsubstrulecollection).
...
Mewakili koleksi pengguna dari aturan FontFallBack untuk mengelola koleksi font guna substitusi yang tepat melalui fungsi fallback Read/write [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection).
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| slides | int[] | Array indeks slide untuk mengambil informasi substitusi font, dimulai dari 1. |
...
Perlu diingat saat menyalin font apa pun bahwa kebanyakan font memiliki hak cipta. Pertama, temukan lisensi font tersebut terlebih dahulu dan pastikan dapat dipindahkan secara bebas ke mesin lain. |
...
Perlu diingat saat menambahkan font apa pun bahwa kebanyakan font memiliki hak cipta. Pertama, temukan lisensi font tersebut terlebih dahulu dan pastikan dapat dipindahkan secara bebas ke mesin lain. |
...
Ganti font dalam presentasi menggunakan informasi yang diberikan dalam [IFontSubstRule](../../com.aspose.slides/ifontsubstrule)
...
Ganti font dalam presentasi menggunakan informasi yang diberikan dalam koleksi [IFontSubstRule](../../com.aspose.slides/ifontsubstrule)
...
>      // Mendapatkan array byte yang mewakili gaya regular dari font pertama dalam presentasi
...
>      // Dapatkan array byte yang mewakili gaya regular dari font pertama dalam presentasi
