...
| विधि | विवरण |
| --- | --- |
| [getTraces()](#getTraces--) | IInk तत्व [IInkTrace](../../com.aspose.slides/iinktrace) में शामिल सभी ट्रेसेस प्राप्त करता है। |
### getTraces() {#getTraces--}
```
public abstract IInkTrace[] getTraces()
```

IInk तत्व [IInkTrace](../../com.aspose.slides/iinktrace) में शामिल सभी ट्रेसेस प्राप्त करता है। केवल-पढ़ने योग्य।
