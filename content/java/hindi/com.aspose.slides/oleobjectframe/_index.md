...
>  
>  // PPTX को एक प्रस्तुति वस्तु में लोड करता है
...
| विधि | विवरण |
| --- | --- |
| [getSubstitutePictureFormat()](#getSubstitutePictureFormat--) | OleObject image fill properties object को लौटाता है। |
...
| [getLinkFileName()](#getLinkFileName--) | लिंक्ड फ़ाइल का पूर्ण पथ लौटाता है। |
| [getLinkPathLong()](#getLinkPathLong--) | लिंक्ड फ़ाइल का पूर्ण पथ लौटाता है। |
| [setLinkPathLong(String value)](#setLinkPathLong-java.lang.String-) | लिंक्ड फ़ाइल का पूर्ण पथ लौटाता है। |
| [getLinkPathRelative()](#getLinkPathRelative--) | यदि मौजूद है तो लिंक्ड फ़ाइल का सापेक्ष पथ लौटाता है, अन्यथा खाली स्ट्रिंग लौटाता है। |
...
| [getEmbeddedData()](#getEmbeddedData--) | OLE एम्बेडेड डेटा के बारे में जानकारी प्राप्त करता है या सेट करता है। |
...
| [isObjectIcon()](#isObjectIcon--) | निर्धारित करता है कि ऑब्जेक्ट आइकन के रूप में दिखाई देता है या नहीं। |
| [setObjectIcon(boolean value)](#setObjectIcon-boolean-) | निर्धारित करता है कि ऑब्जेक्ट आइकन के रूप में दिखाई देता है या नहीं। |
| [isObjectLink()](#isObjectLink--) | निर्धारित करता है कि ऑब्जेक्ट बाहरी फ़ाइल से लिंक्ड है या नहीं। |
| [getUpdateAutomatic()](#getUpdateAutomatic--) | निर्धारित करता है कि लिंक्ड एम्बेडेड ऑब्जेक्ट प्रस्तुति के खुलने या प्रिंट होने पर स्वचालित रूप से अपडेट होता है या नहीं। |
| [setUpdateAutomatic(boolean value)](#setUpdateAutomatic-boolean-) | निर्धारित करता है कि लिंक्ड एम्बेडेड ऑब्जेक्ट प्रस्तुति के खुलने या प्रिंट होने पर स्वचालित रूप से अपडेट होता है या नहीं। |
...
OleObject image fill properties object को लौटाता है। केवल-पढ़ने योग्य [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat)।
...
OleObject आइकन के शीर्षक को लौटाता है या सेट करता है। पढ़ने/लिखने योग्य स्ट्रिंग।

--------------------

जब IsObjectIcon == false हो तो यह मान अनदेखा किया जाता है। स्ट्रिंग को Ole आइकन के आकार के अनुसार ट्रंकेट किया जा सकता है।
...
ऑब्जेक्ट का नाम लौटाता है या सेट करता है। पढ़ने/लिखने योग्य स्ट्रिंग।
...
ऑब्जेक्ट का ProgID लौटाता है। केवल-पढ़ने योग्य स्ट्रिंग।
...
लिंक्ड फ़ाइल का पूर्ण पथ लौटाता है। छोटा फ़ाइल नाम उपयोग किया जाएगा। केवल-पढ़ने योग्य स्ट्रिंग।
...
लिंक्ड फ़ाइल का पूर्ण पथ लौटाता है। लंबा फ़ाइल नाम उपयोग किया जाएगा। पढ़ने/लिखने योग्य स्ट्रिंग।
...
यदि मौजूद है तो लिंक्ड फ़ाइल का सापेक्ष पथ लौटाता है, अन्यथा खाली स्ट्रिंग लौटाता है। केवल-पढ़ने योग्य स्ट्रिंग।
...
OLE एम्बेडेड डेटा के बारे में जानकारी प्राप्त करता है या सेट करता है। पढ़ने/लिखने योग्य [IOleEmbeddedDataInfo](../../com.aspose.slides/ioleembeddeddatainfo)।
...
यह विधि ऑब्जेक्ट के गुणों को नए डेटा को दर्शाने के लिए बदलती है और IsObjectLink फ़्लैग को false सेट करती है, यह दर्शाते हुए कि OLE ऑब्जेक्ट एम्बेडेड है।
...
ऑब्जेक्ट आइकन के रूप में दिखाई देता है या नहीं निर्धारित करता है। पढ़ने/लिखने योग्य बूलियन।
...
ऑब्जेक्ट बाहरी फ़ाइल से लिंक्ड है या नहीं निर्धारित करता है। केवल-पढ़ने योग्य बूलियन।
...
जब प्रस्तुति खोली या प्रिंट की जाती है तो लिंक्ड एम्बेडेड ऑब्जेक्ट स्वचालित रूप से अपडेट होता है या नहीं निर्धारित करता है। पढ़ने/लिखने योग्य बूलियन।
