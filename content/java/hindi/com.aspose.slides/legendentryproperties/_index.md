...
second_title: Aspose.Slides फ़ॉर जावा API रेफ़रेंस
description: एक चार्ट की लेजेंड गुणों का प्रतिनिधित्व करता है।
type: docs
url: /hi/com.aspose.slides/legendentryproperties/
---
**विरासत:**  
java.lang.Object
...
एक चार्ट की लेजेंड गुणों का प्रतिनिधित्व करता है।
...
| [getHide()](#getHide--) | निर्धारित करता है कि लेजेंड प्रविष्टि छिपी हुई है या नहीं। |
| [setHide(boolean value)](#setHide-boolean-) | निर्धारित करता है कि लेजेंड प्रविष्टि छिपी हुई है या नहीं। |
| [getParent_Immediate()](#getParent-Immediate--) |  |
| [getChart()](#getChart--) | पैरेंट चार्ट लौटाता है। |
| [getSlide()](#getSlide--) | FillFormat का पैरेंट स्लाइड लौटाता है। |
| [getPresentation()](#getPresentation--) | FillFormat की पैरेंट प्रेज़ेंटेशन लौटाता है। |
...
निर्धारित करता है कि लेजेंड प्रविष्टि छिपी हुई है या नहीं। पढ़ने/लिखने योग्य बूलियन।
...
FillFormat की पैरेंट प्रेज़ेंटेशन लौटाता है। केवल-पढ़ने योग्य [IPresentation](../../com.aspose.slides/ipresentation)।
