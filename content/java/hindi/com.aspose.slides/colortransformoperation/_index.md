...
description: रंग परिवर्तन ऑपरेशन को परिभाषित करता है।
type: docs
...
| [Complement](#Complement) | रंग को एक RGB पूरक रंग में बदलता है। |
| [Inverse](#Inverse) | रंग को उलटा रंग में बदलता है। |
| [Grayscale](#Grayscale) | रंग को समान चमक वाला ग्रे रंग बनाता है। |
| [SetAlpha](#SetAlpha) | रंग का अल्फा घटक परिभाषित करता है। |
| [AddAlpha](#AddAlpha) | पैरामीटर का मान रंग के अल्फा घटक में जोड़ता है। |
...
| [AddHue](#AddHue) | पैरामीटर का मान ह्यू घटक में जोड़ता है। |
...
| [AddSaturation](#AddSaturation) | पैरामीटर का मान सैचुरेशन घटक में जोड़ता है। |
...
| [AddLuminance](#AddLuminance) | पैरामीटर का मान ल्यूमिनेंस घटक में जोड़ता है। |
...
| [AddRed](#AddRed) | पैरामीटर का मान लाल घटक में जोड़ता है। |
...
| [AddGreen](#AddGreen) | पैरामीटर को हरे घटक में जोड़ता है। |
...
| [AddBlue](#AddBlue) | पैरामीटर का मान नीले घटक में जोड़ता है। |
...
रंग को टिंट करता है। पैरामीटर 0 (मूल रंग) से 1 (सफ़ेद) के बीच के मान में होता है।
...
रंग को शेड करता है। पैरामीटर 0 (मूल रंग) से 1 (काला) के बीच के मान में होता है।
...
रंग को एक RGB पूरक रंग में बदलता है। m = Max(r, g, b); r = m - r; g = m - g; b = m - b;
...
रंग को उलटा रंग बनाता है। r = 1 - r; g = 1 - g; b = 1 - b;
...
रंग को समान लाइटनेस वाला ग्रे रंग बनाता है। पैरामीटर को नजरअंदाज किया जाता है।
...
रंग का अल्फा घटक परिभाषित करता है। पैरामीटर 0 (पारदर्शी) से 1 (अपारदर्शी) के बीच के मान में होता है।
...
पैरामीटर का मान रंग के अल्फा घटक में जोड़ता है। पैरामीटर -1 से 1 के बीच के मान में होता है।
...
रंग के ह्यू घटक को पैरामीटर के मान में बदलता है। पैरामीटर 0 से 360 के बीच के मान में होता है।
...
पैरामीटर का मान ह्यू घटक में जोड़ता है। पैरामीटर -360 से 360 के बीच के मान में होता है।
...
रंग के सैचुरेशन घटक को पैरामीटर के मान में बदलता है। पैरामीटर 0 से 1 के बीच के मान में होता है।
...
पैरामीटर का मान सैचुरेशन घटक में जोड़ता है। पैरामीटर -1 से 1 के बीच के मान में होता है।
...
रंग के ल्यूमिनेंस घटक को पैरामीटर के मान में बदलता है। पैरामीटर 0 से 1 के बीच के मान में होता है।
...
पैरामीटर का मान ल्यूमिनेंस घटक में जोड़ता है। पैरामीटर -1 से 1 के बीच के मान में होता है।
...
रंग के लाल घटक को पैरामीटर के मान में बदलता है। पैरामीटर 0 से 1 के बीच के मान में होता है।
...
पैरामीटर का मान लाल घटक में जोड़ता है। पैरामीटर -1 से 1 के बीच के मान में होता है।
...
रंग के हरे घटक को पैरामीटर के मान में बदलता है। पैरामीटर 0 से 1 के बीच के मान में होता है।
...
पैरामीटर को हरे घटक में जोड़ता है। पैरामीटर -1 से 1 के बीच के मान में होता है।
...
रंग के नीले घटक को पैरामीटर के मान में बदलता है। पैरामीटर 0 से 360 के बीच के मान में होता है।
...
पैरामीटर का मान नीले घटक में जोड़ता है। पैरामीटर -1 से 1 के बीच के मान में होता है।
...
नीला घटक पैरामीटर के मान से गुणा करता है।
...
गामा सुधार। पैरामीटर को नजरअंदाज किया जाता है।
...
उलटा गामा सुधार। पैरामीटर को नजरअंदाज किया जाता है।