...
description: फ़िल फ़ॉर्मेटिंग विकल्प का प्रतिनिधित्व करता है।
type: docs
...
एक फ़िल फॉर्मेटिंग विकल्प का प्रतिनिधित्व करता है।
## विधियां
...
| [getRotateWithShape()](#getRotateWithShape--) | निर्धारित करता है कि भरण को आकार के साथ घुमाया जाना चाहिए या नहीं। |
| [setRotateWithShape(byte value)](#setRotateWithShape-byte-) | निर्धारित करता है कि भरण को आकार के साथ घुमाया जाना चाहिए या नहीं। |
| [getEffective()](#getEffective--) | विरासत लागू होने पर प्रभावी भरण फॉर्मेटिंग डेटा प्राप्त करता है। |
### getVersion() {#getVersion--}
```
...
निर्धारित करता है कि भरण को आकार के साथ घुमाया जाना चाहिए या नहीं। पढ़ें/लिखें [NullableBool](../../com.aspose.slides/nullablebool).
...
विरासत लागू होने पर प्रभावी भरण फॉर्मेटिंग डेटा प्राप्त करता है।

--------------------

> ```
> यह उदाहरण आकार के प्रभावी फ़िल फ़ॉर्मेट गुण प्राप्त करने को दर्शाता है।
>  
