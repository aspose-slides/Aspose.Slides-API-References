...
| [getChartDataWorksheet()](#getChartDataWorksheet--) | वर्कशीट को प्राप्त करता है। |
| [isHidden()](#isHidden--) | निर्धारित करता है कि सेल छिपा है या नहीं। |
| [getCustomNumberFormat()](#getCustomNumberFormat--) | संख्याओं और तिथियों के कस्टम डिस्प्ले फ़ॉर्मेट को प्राप्त करता है या सेट करता है। |
| [setCustomNumberFormat(String value)](#setCustomNumberFormat-java.lang.String-) | संख्याओं और तिथियों के कस्टम डिस्प्ले फ़ॉर्मेट को प्राप्त करता है या सेट करता है। |
| [getPresetNumberFormat()](#getPresetNumberFormat--) | संख्याओं और तिथियों के अंतर्निहित डिस्प्ले फ़ॉर्मेट को प्राप्त करता है या सेट करता है। |
| [setPresetNumberFormat(byte value)](#setPresetNumberFormat-byte-) | संख्याओं और तिथियों के अंतर्निहित डिस्प्ले फ़ॉर्मेट को प्राप्त करता है या सेट करता है। |
...
सेल स्थित वर्कशीट की पंक्ति का सूचकांक लौटाता है। केवल-पठन int.
...
सेल स्थित वर्कशीट के कॉलम का सूचकांक लौटाता है। केवल-पठन int.
...
सेल के मान को प्राप्त करता है या सेट करता है। पढ़ना/लिखना Object.
...
वर्कशीट को प्राप्त करता है। केवल-पठन [IChartDataWorksheet](../../com.aspose.slides/ichartdataworksheet)।
...
निर्धारित करता है कि सेल छिपा है या नहीं। केवल-पठन boolean.
...
संख्याओं और तिथियों के कस्टम डिस्प्ले फ़ॉर्मेट को प्राप्त करता है या सेट करता है। यदि मान खाली है तो PresetNumberFormat मान उपयोग होगा। पढ़ना/लिखना String.
...
संख्याओं और तिथियों के अंतर्निहित डिस्प्ले फ़ॉर्मेट को प्राप्त करता है या सेट करता है। Preset संख्या [0..22] या [37..49] में होनी चाहिए। पढ़ना/लिखना byte.
