...
description: विभिन्न प्रकार के ओवरराइड किए गए थीम तक पहुँच प्रदान करने वाले क्लासों के लिए बेस क्लास।
type: docs
...
विभिन्न प्रकार के ओवरराइड किए गए थीम तक पहुँच प्रदान करने वाले क्लासों के लिए बेस क्लास।
...
निर्धारित करता है कि OverrideTheme विरासत में मिली प्रभावी थीम को ओवरराइड करता है या नहीं। ओवरराइड करने के लिए OverrideTheme.Init*() मेथड्स का उपयोग करें। ओवरराइड से हटाने के लिए OverrideTheme.Clear() मेथड का उपयोग करें। केवल पढ़ने योग्य बूलियन।
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| scheme | [IExtraColorScheme](../../com.aspose.slides/iextracolorscheme) | यह [IExtraColorScheme](../../com.aspose.slides/iextracolorscheme) ऑब्जेक्ट। |