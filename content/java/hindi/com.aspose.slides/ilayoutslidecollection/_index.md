...
| [remove(ILayoutSlide value)](#remove-com.aspose.slides.ILayoutSlide-) | संग्रह से एक लेआउट को हटाता है। |
| [removeUnused()](#removeUnused--) | अप्रयुक्त लेआउट स्लाइड्स को हटाता है (जिन लेआउट स्लाइड्स की HasDependingSlides false है)। |
...
1) PptxEditException को थ्रो होने से बचने के लिए लेआउट की HasDependingSlides प्रॉपर्टी पहले जाँचें। 2) कोड को सरल बनाने के लिए आप [ILayoutSlide.remove](../../com.aspose.slides/ilayoutslide\#remove) मेथड भी उपयोग कर सकते हैं। |
### removeUnused() {#removeUnused--}
```
public abstract void removeUnused()
```

अप्रयुक्त लेआउट स्लाइड्स को हटाता है (जिन लेआउट स्लाइड्स की HasDependingSlides false है)।