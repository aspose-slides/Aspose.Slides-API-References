...
type: docs
url: /hi/com.aspose.slides/axisformat/
---
**विरासत:**
...
| विधि | विवरण |
| --- | --- |
| [getFill()](#getFill--) | एक अक्ष की भराव शैली गुणों को लौटाता है। |
| [getLine()](#getLine--) | एक अक्ष की लाइन शैली गुणों को लौटाता है। |
| [getEffect()](#getEffect--) | एक अक्ष के लिए उपयोग किए गए इफ़ेक्ट्स को लौटाता है। |
...
एक अक्ष की भराव शैली गुणों को लौटाता है। केवल-पढ़ने योग्य [IFillFormat](../../com.aspose.slides/ifillformat)।
...
एक अक्ष की लाइन शैली गुणों को लौटाता है। केवल-पढ़ने योग्य [ILineFormat](../../com.aspose.slides/ilineformat)।
...
एक अक्ष के लिए उपयोग किए गए इफ़ेक्ट्स को लौटाता है। केवल-पढ़ने योग्य [IEffectFormat](../../com.aspose.slides/ieffectformat)।
