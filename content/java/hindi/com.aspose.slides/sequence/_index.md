...
एक क्रम (प्रभावों का संग्रह) का प्रतिनिधित्व करता है।
## विधियाँ

| विधि | विवरण |
| --- | --- |
| [getCount()](#getCount--) | एक sequense में प्रभावों की संख्या लौटाता है। |
| [remove(IEffect item)](#remove-com.aspose.slides.IEffect-) | एक संग्रह से निर्दिष्ट प्रभाव को हटाता है। |
| [removeAt(int index)](#removeAt-int-) | एक संग्रह से प्रभाव को हटाता है। |
| [clear()](#clear--) | एक संग्रह से सभी प्रभावों को हटाता है। |
| [get_Item(int index)](#get-Item-int-) | निर्दिष्ट अनुक्रमांक पर प्रभाव लौटाता है। |
| [iterator()](#iterator--) | एक एन्युमरेटर लौटाता है जो संग्रह के माध्यम से इटररेट करता है। |
| [iteratorJava()](#iteratorJava--) | पूरा संग्रह के लिए एक java इटेरेटर लौटाता है। |
| [getTriggerShape()](#getTriggerShape--) | INTERACTIVE क्रम के लिए shape लक्ष्य को प्राप्त या सेट करता है। |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | INTERACTIVE क्रम के लिए shape लक्ष्य को प्राप्त या सेट करता है। |
...
| [addEffect(IShape shape, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IShape-int-int-int-) | क्रम के अंत में नया प्रभाव जोड़ता है। |
| [addEffect(IParagraph paragraph, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IParagraph-int-int-int-) | क्रम के अंत में पैराग्राफ के लिए नया एनीमेशन प्रभाव जोड़ता है। |
...
| [addEffect(IChart chart, int type, int seriesIndex, int categoriesIndex, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-int-) | क्रम के अंत में वर्ग या श्रृंखला के तत्वों के लिए नया चार्ट एनीमेशन प्रभाव जोड़ता है। |
### getCount() {#getCount--}
```
public final int getCount()
```

एक sequense में प्रभावों की संख्या लौटाता है। केवल-पढ़ने योग्य int।
...
एक संग्रह से निर्दिष्ट प्रभाव को हटाता है।
...
एक संग्रह से प्रभाव को हटाता है।
...
निर्दिष्ट इंडेक्स पर प्रभाव लौटाता है।
...
एक एन्युमरेटर लौटाता है जो संग्रह के माध्यम से इटररेट करता है।

**रिटर्न:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffect> - एक IGenericEnumerator जो संग्रह के माध्यम से इटररेट करने के लिये उपयोग किया जा सकता है।
### iteratorJava() {#iteratorJava--}
```
public final System.Collections.Generic.IGenericEnumerator<IEffect> iteratorJava()
```

पूरे संग्रह के लिये एक java इटेरेटर लौटाता है।

**रिटर्न:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffect> - पूरे संग्रह के लिये एक java.util.Iterator।
### getTriggerShape() {#getTriggerShape--}
```
public final IShape getTriggerShape()
```

INTERACTIVE क्रम के लिए shape लक्ष्य को प्राप्त या सेट करता है। यदि क्रम इंटरएक्टिव नहीं है तो null लौटाता है। पढ़ने/लिखने योग्य [IShape](../../com.aspose.slides/ishape)।
...
निर्दिष्ट shape के लिये प्रभाव हटाता है।
...
निर्दिष्ट shape के लिये प्रभावों की array लौटाता है।
...
निर्दिष्ट पैराग्राफ के लिये प्रभावों की array लौटाता है।
...
निर्दिष्ट shape के लिये प्रभावों की गिनती लौटाता है।
...
क्रम के अंत में नया प्रभाव जोड़ता है।

**पैरामीटर:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | इफ़ेक्ट जोड़ने के लिये Shape ऑब्जेक्ट [IShape](../../com.aspose.slides/ishape) |
...
क्रम के अंत में पैराग्राफ के लिये नया एनीमेशन प्रभाव जोड़ता है।
...
क्रम के अंत में श्रेणी या श्रृंखला के लिये नया चार्ट एनीमेशन प्रभाव जोड़ता है।
...
क्रम के अंत में श्रेणी या श्रृंखला के तत्वों के लिये नया चार्ट एनीमेशन प्रभाव जोड़ता है।
