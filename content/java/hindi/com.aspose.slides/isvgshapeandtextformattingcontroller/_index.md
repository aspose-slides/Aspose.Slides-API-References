...
description: SVG आकार और पाठ निर्माण को नियंत्रित करता है।
type: docs
...
SVG आकार और पाठ निर्माण को नियंत्रित करता है।
...
| मेथड | विवरण |
| --- | --- |
| [formatText(ISvgTSpan svgTSpan, IPortion portion, ITextFrame textFrame)](#formatText-com.aspose.slides.ISvgTSpan-com.aspose.slides.IPortion-com.aspose.slides.ITextFrame-) | यह फ़ंक्शन SVG में पाठ भाग को रेंडर करने से पहले कॉल किया जाता है ताकि उपयोगकर्ता परिणामस्वरूप SVG को नियंत्रित कर सके। |
...
यह फ़ंक्शन SVG में पाठ भाग को रेंडर करने से पहले कॉल किया जाता है ताकि उपयोगकर्ता परिणामस्वरूप SVG को नियंत्रित कर सके।
