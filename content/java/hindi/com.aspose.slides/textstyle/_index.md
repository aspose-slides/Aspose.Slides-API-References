...
यह क्लास टेक्स्ट शैली स्वरूपण गुणों को सम्मिलित करती है।
## मेथड्स

| मेथड | विवरण |
| --- | --- |
| [getVersion()](#getVersion--) |  |
| [getLevel(int index)](#getLevel-int-) | यदि शैली का स्तर मौजूद है तो उसे वापस करता है, अन्यथा null लौटाता है। |
| [getDefaultParagraphFormat()](#getDefaultParagraphFormat--) | डिफ़ॉल्ट पैराग्राफ गुण। |
| [getEffective()](#getEffective--) | विरासत लागू होने के साथ प्रभावी पाठ शैली स्वरूपण डेटा प्राप्त करता है। |
### getVersion() {#getVersion--}
```
...
यदि शैली का स्तर मौजूद है तो उसे वापस करता है, अन्यथा null लौटाता है।
...
विरासत लागू होने के साथ प्रभावी पाठ शैली स्वरूपण डेटा प्राप्त करता है।
