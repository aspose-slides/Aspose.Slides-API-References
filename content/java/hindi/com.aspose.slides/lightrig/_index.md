...
Light direction. पढ़ें/लिखें [LightingDirection](../../com.aspose.slides/lightingdirection).
...
Represents a preset light right that can be applied to a shape. The light rig represents a group of lights oriented in a specific way relative to a 3D scene. पढ़ें/लिखें [LightRigPresetType](../../com.aspose.slides/lightrigpresettype).
