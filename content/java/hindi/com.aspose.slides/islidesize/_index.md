...
| [setSize(int type, int scaleType)](#setSize-int-int-) | टाइप द्वारा स्लाइड आकार सेट करता है और मौजूदा सामग्री को स्केल करता है। |
...
एक नया मान असाइन करने से \#getType.getType प्रॉपर्टी [SlideSizeType.Custom](../../com.aspose.slides/slidesizetype\#Custom) पर रीसेट हो जाती है और \#getOrientation.getOrientation/\#setOrientation(int).setOrientation(int) सेट होता है।
...
[SlideSizeType.Custom](../../com.aspose.slides/slidesizetype\#Custom) के अलावा कोई भी मान असाइन करने पर \#getSize.getSize पूर्वनिर्धारित आयामों के अनुसार समायोजित होता है, जबकि वर्तमान \#getOrientation.getOrientation/\#setOrientation(int).setOrientation(int) बरकरार रहता है।
...
इस मान को बदलने से स्लाइड की चौड़ाई और ऊँचाई अदली-बदली हो जाती है।
...
[SlideSizeType.Custom](../../com.aspose.slides/slidesizetype\#Custom) के अलावा कोई भी मान असाइन करने पर चुने हुए प्रकार के आधार पर \#getSize.getSize समायोजित होता है, जबकि \#getOrientation.getOrientation/\#setOrientation(int).setOrientation(int) संरक्षित रहता है। |
...
| height | float | नई स्लाइड ऊँचाई, बिंदुओं में। |
| scaleType | int | उपयोग करने के लिए सामग्री स्केलिंग मोड। |
