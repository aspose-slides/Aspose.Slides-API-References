...
description: सेक्शनों का एक संग्रह दर्शाता है।
type: docs
...
| [addSection(String name, ISlide startedFromSlide)](#addSection-java.lang.String-com.aspose.slides.ISlide-) | विशिष्ट स्लाइड से शुरू होने वाला नया सेक्शन जोड़ें। |
| [addEmptySection(String name, int index)](#addEmptySection-java.lang.String-int-) | संग्रह में निर्दिष्ट स्थान पर खाली सेक्शन जोड़ें। |
| [removeSectionWithSlides(ISection section)](#removeSectionWithSlides-com.aspose.slides.ISection-) | सेक्शन और उसमें सम्मिलित स्लाइड्स को हटाएँ। |
| [removeSection(ISection section)](#removeSection-com.aspose.slides.ISection-) | सेक्शन हटाएँ। |
| [reorderSectionWithSlides(ISection section, int index)](#reorderSectionWithSlides-com.aspose.slides.ISection-int-) | सेक्शन और उसकी स्लाइड्स को संग्रह से लेकर निर्दिष्ट स्थान पर ले जाएँ। |
...
संग्रह में निर्दिष्ट स्थान पर खाली सेक्शन जोड़ें।

**पैरामीटर:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| name | java.lang.String | सेक्शन का नाम |
| index | int | नया सेक्शन का इंडेक्स। |
...
सेक्शन और उसमें सम्मिलित स्लाइड्स को हटाएँ।
...
सेक्शन और उसकी स्लाइड्स को संग्रह से लेकर निर्दिष्ट स्थान पर ले जाएँ।
...
संग्रह के अंत में खाली सेक्शन जोड़ें।
