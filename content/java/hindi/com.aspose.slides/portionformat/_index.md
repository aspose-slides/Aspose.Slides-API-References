...
description: यह वर्ग टेक्स्ट भाग फ़ॉर्मेटिंग गुणों को सम्मिलित करता है।
type: docs
...
यह वर्ग टेक्स्ट भाग फ़ॉर्मेटिंग गुणों को सम्मिलित करता है। [IPortionFormatEffectiveData](../../com.aspose.slides/iportionformateffectivedata) के विपरीत, इस वर्ग के सभी गुण लिखने योग्य हैं।
...
>  
>  //एक प्रस्तुति फ़ाइल का प्रतिनिधित्व करने वाला प्रस्तुति ऑब्जेक्ट बनाता है
...
>      //+mj-lt -Heading फ़ॉन्ट लैटिन (मेजर लैटिन फ़ॉन्ट)
...
यह वर्ग विशिष्ट भाग के लिए परिभाषित टेक्स्ट भाग फ़ॉर्मेटिंग गुणों को वापस करने और संशोधित करने के लिए उपयोग किया जाता है। इसका मतलब है कि मान प्राप्त करते समय कोई विरासत लागू नहीं होती, इसलिए अधिकांश मामलों में आपको मान "अपरिभाषित" मिलेगा।

विरासत सहित प्रभावी फ़ॉर्मेटिंग पैरामीटर मान प्राप्त करने के लिए आपको [getEffective](../../com.aspose.slides/portionformat\#getEffective) विधि का उपयोग करना चाहिए जो एक [IPortionFormatEffectiveData](../../com.aspose.slides/iportionformateffectivedata) उदाहरण लौटाता है।

## निर्माता

| निर्माता | विवरण |
| --- | --- |
| [PortionFormat()](#PortionFormat--) | एक नया [PortionFormat](../../com.aspose.slides/portionformat) वर्ग को आरंभ करता है। |
...
| [setSmartTagClean(boolean value)](#setSmartTagClean-boolean-) | निर्धारित करता है कि स्मार्ट टैग को साफ किया जाना चाहिए या नहीं। |
...
| [getHyperlinkManager()](#getHyperlinkManager--) | हाइपरलिंक प्रबंधक। |
| [getEffective()](#getEffective--) | विरासत लागू करके प्रभावी भाग फ़ॉर्मेटिंग डेटा प्राप्त करता है। |
...
एक नया [PortionFormat](../../com.aspose.slides/portionformat) वर्ग आरंभ करता है।
...
निर्धारित करता है कि स्मार्ट टैग को साफ किया जाना चाहिए या नहीं। कोई विरासत लागू नहीं। पढ़ें/लिखें boolean।
...
हाइपरलिंक प्रबंधक। केवल-पढ़ें [IHyperlinkManager](../../com.aspose.slides/ihyperlinkmanager)।
...
विरासत लागू कर प्रभावी भाग फ़ॉर्मेटिंग डेटा प्राप्त करता है।
