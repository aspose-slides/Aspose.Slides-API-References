...
description: डेटा बिंदु स्तर का प्रतिनिधित्व करता है।
type: docs
...
डेटा बिंदु स्तर का प्रतिनिधित्व करता है। Treemap और Sunburst चार्ट के लिए लागू होता है।
## विधियां

| विधि | विवरण |
| --- | --- |
| [getFormat()](#getFormat--) | डेटा बिंदु स्तर के स्वरूपण गुणों का प्रतिनिधित्व करता है। |
| [getLabel()](#getLabel--) | डेटा बिंदु स्तर का डेटा लेबल दर्शाता है। |
### getFormat() {#getFormat--}
```
public abstract IFormat getFormat()
```

डेटा बिंदु स्तर के स्वरूपण गुणों का प्रतिनिधित्व करता है। पढ़ने/लिखने [IFormat](../../com.aspose.slides/iformat)।
...
डेटा बिंदु स्तर का डेटा लेबल दर्शाता है। Treemap और Sunburst sereis प्रकारों के लिए लागू। केवल-पढ़ने योग्य [IDataLabel](../../com.aspose.slides/idatalabel)।
