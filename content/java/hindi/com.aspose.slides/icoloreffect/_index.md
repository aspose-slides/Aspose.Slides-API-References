...
| [getBy()](#getBy--) | रंग एनीमेशन के लिए संबंधित ऑफ़सेट मान का वर्णन करता है। |
| [setBy(IColorOffset value)](#setBy-com.aspose.slides.IColorOffset-) | रंग एनीमेशन के लिए संबंधित ऑफ़सेट मान का वर्णन करता है। |
...
| [getDirection()](#getDirection--) | रंग पहिये के चारों ओर ह्यू को किस दिशा में घुमाना है, निर्धारित करता है। |
| [setDirection(int value)](#setDirection-int-) | रंग पहिये के चारों ओर ह्यू को किस दिशा में घुमाना है, निर्धारित करता है। |
### getFrom() {#getFrom--}
```
...
रंग एनीमेशन के लिए संबंधित ऑफ़सेट मान का वर्णन करता है। पढ़ें/लिखें [IColorOffset](../../com.aspose.slides/icoloroffset).
...
रंग पहिये के चारों ओर ह्यू को किस दिशा में घुमाना है, निर्धारित करता है। पढ़ें/लिखें [ColorDirection](../../com.aspose.slides/colordirection).
