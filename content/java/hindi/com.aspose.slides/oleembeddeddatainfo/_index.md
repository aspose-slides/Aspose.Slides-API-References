...
| [OleEmbeddedDataInfo(byte[] embeddedFileData, String embeddedFileExtension)](#OleEmbeddedDataInfo-byte---java.lang.String-) | OLE ऑब्जेक्ट के लिए एम्बेडेड डेटा जानकारी की नई इंस्टेंस बनाता है। |
## मेथड

| मेथड | विवरण |
| --- | --- |
| [getEmbeddedFileData()](#getEmbeddedFileData--) | एक एम्बेडेड OLE ऑब्जेक्ट के फ़ाइल डेटा को लौटाता है, केवल-पढ़ने योग्य byte[]। |
| [getEmbeddedFileExtension()](#getEmbeddedFileExtension--) | वर्तमान एम्बेडेड OLE ऑब्जेक्ट के फ़ाइल एक्सटेंशन को लौटाता है, केवल-पढ़ने योग्य String। |
...
OLE ऑब्जेक्ट के लिए एम्बेडेड डेटा जानकारी की नई इंस्टेंस बनाता है।

**पैरामीटर:**
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| embeddedFileData | byte[] | एक एम्बेडेड OLE ऑब्जेक्ट का फ़ाइल डेटा byte[]। |
| embeddedFileExtension | java.lang.String | वर्तमान एम्बेडेड OLE ऑब्जेक्ट के फ़ाइल एक्सटेंशन String। |
...
एक एम्बेडेड OLE ऑब्जेक्ट के फ़ाइल डेटा को लौटाता है, केवल-पढ़ने योग्य byte[]।
...
वर्तमान एम्बेडेड OLE ऑब्जेक्ट के फ़ाइल एक्सटेंशन को लौटाता है, केवल-पढ़ने योग्य String।
