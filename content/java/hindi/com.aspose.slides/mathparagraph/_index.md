...
description: गणितीय पैराग्राफ जो गणितीय ब्लॉक्स IMathBlock के लिए कंटेनर है
type: docs
...
गणितीय पैराग्राफ जो गणितीय ब्लॉक्स (IMathBlock) के लिए कंटेनर है
...
| कंस्ट्रक्टर | विवरण |
| --- | --- |
| [MathParagraph()](#MathParagraph--) | MathParagraph क्लास की नई इंस्टेंस को इनिशियलाइज़ करता है। |
| [MathParagraph(IMathBlock mathBlock)](#MathParagraph-com.aspose.slides.IMathBlock-) | MathParagraph क्लास की नई इंस्टेंस को इनिशियलाइज़ करता है। |
## मेथड्स

| मेथड | विवरण |
| --- | --- |
| [getJustification()](#getJustification--) | पैराग्राफ जस्टिफिकेशन का डिफॉल्ट मान: CenteredAsGroup |
| [setJustification(int value)](#setJustification-int-) | पैराग्राफ जस्टिफिकेशन का डिफॉल्ट मान: CenteredAsGroup |
| [getParent_Immediate()](#getParent-Immediate--) | Parent_Immediate ऑब्जेक्ट वापस देता है। |
...
| [remove(IMathBlock mathBlock)](#remove-com.aspose.slides.IMathBlock-) | कलेक्शन से किसी विशिष्ट ऑब्जेक्ट की पहली आवृत्ति को हटाता है। |
| [contains(IMathBlock mathBlock)](#contains-com.aspose.slides.IMathBlock-) | निर्धारित करता है कि कलेक्शन में कोई विशिष्ट वैल्यू मौजूद है या नहीं। |
| [indexOf(IMathBlock mathBlock)](#indexOf-com.aspose.slides.IMathBlock-) | कलेक्शन में किसी विशिष्ट IMathBlock का इंडेक्स निर्धारित करता है। |
| [insert(int index, IMathBlock mathBlock)](#insert-int-com.aspose.slides.IMathBlock-) | निर्दिष्ट इंडेक्स पर कलेक्शन में IMathBlock डालता है। |
| [removeAt(int index)](#removeAt-int-) | कलेक्शन में निर्दिष्ट इंडेक्स पर आइटम को हटाता है। |
| [iterator()](#iterator--) |  |
...
| [toLatex()](#toLatex--) | LaTeX फॉर्मेट में गणितीय समीकरण प्राप्त करता है। |
...
MathParagraph क्लास की नई इंस्टेंस को इनिशियलाइज़ करता है।
...
पैराग्राफ जस्टिफिकेशन का डिफॉल्ट मान: CenteredAsGroup
...
Parent_Immediate ऑब्जेक्ट वापस देता है। केवल पढ़ने योग्य IDOMObject।
...
कलेक्शन से किसी विशिष्ट ऑब्जेक्ट की पहली आवृत्ति को हटाता है।
...
निर्धारित करता है कि कलेक्शन में कोई विशिष्ट वैल्यू मौजूद है या नहीं।
...
कलेक्शन में किसी विशिष्ट IMathBlock का इंडेक्स निर्धारित करता है।
...
निर्दिष्ट इंडेक्स पर कलेक्शन में IMathBlock डालता है।
...
LaTeX फॉर्मेट में गणितीय समीकरण प्राप्त करता है।
