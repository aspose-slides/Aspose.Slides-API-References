...
description: एक एनीमेशन प्रभाव का प्रकार दर्शाता है।
type: docs
url: /hi/com.aspose.slides/effecttype/
---
**विरासत:**
...
एक एनिमेशन इफ़ेक्ट का प्रकार दर्शाता है।
## फ़ील्ड्स
...
Appear इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
CurveUpDown इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Ascend इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
उपर की दिशा वाला Float इफ़ेक्ट। यह Ascend प्रकार का उपनाम है। क्लास **Entrance** या **Exit**।
...
Blinds इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
BoldFlash इफ़ेक्ट। क्लास **Emphasis**।
...
BoldReveal इफ़ेक्ट। क्लास **Emphasis**।
...
Boomerang इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Bounce इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Box इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
BrushOnColor इफ़ेक्ट। क्लास **Emphasis**।
...
BrushOnUnderline इफ़ेक्ट। क्लास **Emphasis**।
...
CenterRevolve इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
ChangeFillColor इफ़ेक्ट। क्लास **Emphasis**।
...
ChangeFont इफ़ेक्ट। क्लास **Emphasis**।
...
ChangeFontColor इफ़ेक्ट। क्लास **Emphasis**।
...
ChangeFontSize इफ़ेक्ट। क्लास **Emphasis**।
...
ChangeLineColor इफ़ेक्ट। क्लास **Emphasis**।
...
Checkerboard इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
ColorBlend इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
ColorWave इफ़ेक्ट। क्लास **Emphasis**।
...
ComplementaryColor इफ़ेक्ट। क्लास **Emphasis**।
...
ComplementaryColor2 इफ़ेक्ट। क्लास **Emphasis**।
...
Compress इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
ContrastingColor इफ़ेक्ट। क्लास **Emphasis**।
...
Crawl इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Credits इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Desaturate इफ़ेक्ट। क्लास **Emphasis**।
...
Descend इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
नीचे की दिशा वाला Float इफ़ेक्ट। यह Descend प्रकार का उपनाम है। क्लास **Entrance** या **Exit**।
...
Diamond इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Dissolve इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Expand इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Fade इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
FadedSwivel इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
FadedZoom इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
FlashBulb इफ़ेक्ट। क्लास **Emphasis**।
...
FlashOnce इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Flicker इफ़ेक्ट। क्लास **Emphasis**।
...
Flip इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Float इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Fly इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Fold इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
Glide इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
GrowAndTurn इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
GrowShrink इफ़ेक्ट। क्लास **Emphasis**।
...
GrowWithColor इफ़ेक्ट। क्लास **Emphasis**।
...
Lighten इफ़ेक्ट। क्लास **Emphasis**।
...
LightSpeed इफ़ेक्ट। क्लास **Entrance** या **Exit**।
...
MediaPause इफ़ेक्ट। क्लास **Media**।
...
Path4PointStar इफ़ेक्ट। क्लास **Path**।
...
Path5PointStar इफ़ेक्ट। क्लास **Path**।
...
Path6PointStar इफ़ेक्ट। क्लास **Path**।
...
Path8PointStar इफ़ेक्ट। क्लास **Path**।
...
PathArcDown इफ़ेक्ट। क्लास **Path**।
...
PathArcRight प्रभाव। क्लास **Path**।
...
PathBounceLeft प्रभाव। क्लास **Path**।
...
PathBounceRight प्रभाव। क्लास **Path**।
...
PathCrescentMoon प्रभाव। क्लास **Path**।
...
PathCurvedSquare प्रभाव। क्लास **Path**।
...
PathCurvyLeft प्रभाव। क्लास **Path**।
...
PathCurvyRight प्रभाव। क्लास **Path**।
...
PathCurvyStar प्रभाव। क्लास **Path**।
...
PathDecayingWave प्रभाव। क्लास **Path**।
...
PathDiagonalDownRight प्रभाव। क्लास **Path**।
...
PathDiagonalUpRight प्रभाव। क्लास **Path**।
...
PathEqualTriangle प्रभाव। क्लास **Path**।
...
PathFigure8Four प्रभाव। क्लास **Path**।
...
PathFootball प्रभाव। क्लास **Path**।
...
PathHeartbeat प्रभाव। क्लास **Path**।
...
PathHorizontalFigure8 प्रभाव। क्लास **Path**।
...
PathInvertedSquare प्रभाव। क्लास **Path**।
...
PathInvertedTriangle प्रभाव। क्लास **Path**।
...
PathLoopdeLoop प्रभाव। क्लास **Path**।
...
PathParallelogram प्रभाव। क्लास **Path**।
...
PathPentagon प्रभाव। क्लास **Path**।
...
PathPointyStar प्रभाव। क्लास **Path**।
...
PathRightTriangle प्रभाव। क्लास **Path**।
...
PathSineWave प्रभाव। क्लास **Path**।
...
PathSpiralLeft प्रभाव। क्लास **Path**।
...
PathSpiralRight प्रभाव। क्लास **Path**।
...
PathStairsDown प्रभाव। क्लास **Path**।
...
PathTeardrop प्रभाव। क्लास **Path**।
...
PathTrapezoid प्रभाव। क्लास **Path**।
...
PathTurnDown प्रभाव। क्लास **Path**।
...
PathTurnRight प्रभाव। क्लास **Path**।
...
PathTurnUpRight प्रभाव। क्लास **Path**।
...
PathVerticalFigure8 प्रभाव। क्लास **Path**।
...
Peek प्रभाव। क्लास **Entrance** या **Exit**।
...
Pinwheel प्रभाव। क्लास **Entrance** या **Exit**।
...
Plus प्रभाव। क्लास **Entrance** या **Exit**।
...
RandomBars प्रभाव। क्लास **Entrance** या **Exit**।
...
RandomEffects प्रभाव। क्लास **Entrance** या **Exit**।
...
Sling प्रभाव। क्लास **Entrance** या **Exit**।
...
Spiral प्रभाव। क्लास **Entrance** या **Exit**।
...
Split प्रभाव। क्लास **Entrance** या **Exit**।
...
Stretch प्रभाव। क्लास **Entrance** या **Exit**।
...
Strips प्रभाव। क्लास **Entrance** या **Exit**।
...
StyleEmphasis प्रभाव। क्लास **Emphasis**।
...
Swish प्रभाव। क्लास **Entrance** या **Exit**।
...
Swivel प्रभाव। क्लास **Entrance** या **Exit**।
...
Transparency प्रभाव। क्लास **Emphasis**।
...
Unfold प्रभाव। क्लास **Entrance** या **Exit**।
...
VerticalGrow प्रभाव। क्लास **Emphasis**।
...
Wedge प्रभाव। क्लास **Entrance** या **Exit**।
...
Wheel प्रभाव। क्लास **Entrance** या **Exit**।
...
Whip प्रभाव। क्लास **Entrance** या **Exit**।
...
Wipe प्रभाव। क्लास **Entrance** या **Exit**।
...
Magnify प्रभाव। क्लास **Entrance** या **Exit**।
...
Zoom प्रभाव। क्लास **Entrance** या **Exit**।

वैध उपप्रकार:

 *  EffectSubtype.In
 *  EffectSubtype.Out
 *  EffectSubtype.InCenter - केवल Entrance वर्ग के लिये
 *  EffectSubtype.OutBottom - केवल Entrance वर्ग के लिये
 *  EffectSubtype.OutSlightly
 *  EffectSubtype.InSlightly
 *  EffectSubtype.OutCenter - केवल Exit वर्ग के लिये
 *  EffectSubtype.InBottom - केवल Exit वर्ग के लिये
...
OLEObjectShow प्रभाव। क्लास **OLEActionVerbs**।
...
OLEObjectEdit प्रभाव। क्लास **OLEActionVerbs**।
...
OLEObjectOpen प्रभाव। क्लास **OLEActionVerbs**।
