...
description: Formateringskontrollerklassen som ska användas för inbäddning av teckensnitt i EOT-format
type: docs
...
Formateringskontrollerklassen som ska användas för inbäddning av teckensnitt i EOT-format
## Konstruktorer
...
Anropas för att skriva html-dokumentets rubrik. Anropas en gång per presentationens konvertering.
...
Anropas för att skriva html-dokumentets sidfot. Anropas en gång per presentationens konvertering.
...
Anropas för att skriva html-slide-rubrik. Anropas en gång per varje bild.
...
Anropas för att skriva html-slide-sidfot. Anropas en gång per varje bild.
...
Anropas innan formens rendering. Anropas en gång per varje form. Om denna funktion skriver något till generatorn, avslutas den aktuella bildens bildgenerering, det tillagda html-fragmentet infogas och en ny bild startas ovanpå den föregående.
