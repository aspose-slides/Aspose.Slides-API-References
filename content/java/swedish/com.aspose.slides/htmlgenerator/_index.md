...
| [getSlideImageSizeUnit()](#getSlideImageSizeUnit--) | Returnerar en enhet som bildstorleken för bilden anges i. |
| [getSlideImageSizeUnitCode()](#getSlideImageSizeUnitCode--) | Returnerar en css-kod för enheten som bildstorleken för bilden anges i. |
...
Returnerar en enhet som bildstorleken för bilden anges i. Skrivskyddad [SvgCoordinateUnit](../../com.aspose.slides/svgcoordinateunit).
...
Returnerar en css-kod för enheten som bildstorleken för bilden anges i. Skrivskyddad String.
