...
| Metod | Beskrivning |
| --- | --- |
| [getOverrideTheme()](#getOverrideTheme--) | Returnerar det åsidosättande temaobjektet. |
| [setOverrideTheme(IMasterTheme value)](#setOverrideTheme-com.aspose.slides.IMasterTheme-) | Returnerar det åsidosättande temaobjektet. |
| [createThemeEffective()](#createThemeEffective--) | Returnerar temaobjektet. |
| [isOverrideThemeEnabled()](#isOverrideThemeEnabled--) | Bestämmer om OverrideTheme åsidosätter ärvt effektivt tema (Presentation.MasterTheme) eller inte. |
| [setOverrideThemeEnabled(boolean value)](#setOverrideThemeEnabled-boolean-) | Bestämmer om OverrideTheme åsidosätter ärvt effektivt tema (Presentation.MasterTheme) eller inte. |
...
Returnerar det åsidosättande temaobjektet. Läs/skriv [IMasterTheme](../../com.aspose.slides/imastertheme).
