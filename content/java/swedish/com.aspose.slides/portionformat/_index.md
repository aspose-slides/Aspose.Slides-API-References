...
>      // +mn-ea - Kroppstextfont East Asian (Minor East Asian Font)
>      // +mj-ea - Kroppstextfont East Asian (Minor East Asian Font)
...
För att få de effektiva formateringsparametervärdena inklusive ärvda måste du använda [getEffective](../../com.aspose.slides/portionformat\#getEffective)-metoden som returnerar en [IPortionFormatEffectiveData](../../com.aspose.slides/iportionformateffectivedata)-instans.
## Konstruktörer

| Konstruktor | Beskrivning |
| --- | --- |
| [PortionFormat()](#PortionFormat--) | Initialiserar en ny instans av [PortionFormat](../../com.aspose.slides/portionformat)-klassen. |
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [getBookmarkId()](#getBookmarkId--) | Returnerar eller anger bokmärkeidentifierare. |
| [setBookmarkId(String value)](#setBookmarkId-java.lang.String-) | Returnerar eller anger bokmärkeidentifierare. |
| [getSmartTagClean()](#getSmartTagClean--) | Bestämmer om smarttaggen ska rensas. |
| [setSmartTagClean(boolean value)](#setSmartTagClean-boolean-) | Bestämmer om smarttaggen ska rensas. |
...
| [getHyperlinkMouseOver()](#getHyperlinkMouseOver--) | Returnerar eller anger hyperlänken som definierats för musöver. |
| [setHyperlinkMouseOver(IHyperlink value)](#setHyperlinkMouseOver-com.aspose.slides.IHyperlink-) | Returnerar eller anger hyperlänken som definierats för musöver. |
| [getHyperlinkManager()](#getHyperlinkManager--) | Hyperlänks-hanterare. |
...
Initialiserar en ny instans av [PortionFormat](../../com.aspose.slides/portionformat)-klassen.
...
Returnerar eller anger bokmärkeidentifierare. Läs/skriv String.
...
Bestämmer om smarttaggen ska rensas. Ingen arv tillämpas. Läs/skriv boolean.
...
Returnerar eller anger hyperlänken som definierats för musöver. Läs/skriv [IHyperlink](../../com.aspose.slides/ihyperlink).
...
Hyperlänks-hanterare. Läs-endast [IHyperlinkManager](../../com.aspose.slides/ihyperlinkmanager).
