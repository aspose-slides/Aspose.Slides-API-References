...
description: Representerar samlingen av taggar med användardefinierade par av strängar
type: docs
...
| [getValueByIndex(int index)](#getValueByIndex-int-) | Returnerar värdet på en tagg på det angivna indexet. |
...
| [get_Item(String name)](#get-Item-java.lang.String-) | Returnerar eller sätter ett nyckel-värde-par för en tagg. |
| [set_Item(String name, String value)](#set-Item-java.lang.String-java.lang.String-) | Returnerar eller sätter ett nyckel-värde-par för en tagg. |
...
Returnerar värdet på en tagg på det angivna indexet.
...
**Returnerar:**
java.lang.String - Värdet på en tagg.
...
Returnerar eller sätter ett nyckel-värde-par för en tagg.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| name | java.lang.String | Nyckel för en tagg. |
