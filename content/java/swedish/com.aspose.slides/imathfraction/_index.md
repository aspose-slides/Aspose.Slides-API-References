...
description: Specificerar bråkobjektet som består av en täljare och en nämnare separerade med ett bråkstreck.
type: docs
...
Specificerar bråkobjektet, bestående av en täljare och en nämnare separerade med ett bråkstreck. Bråkstrecket kan vara horisontellt eller diagonalt, beroende på bråkegenskaperna. Bråkobjektet används även för att representera stack-funktionen, som placerar ett element ovanpå ett annat, utan bråkstreck.
