...
| [removeByShape(IShape shape)](#removeByShape-com.aspose.slides.IShape-) | Ta bort effekt för den angivna formen. |
| [getEffectsByShape(IShape shape)](#getEffectsByShape-com.aspose.slides.IShape-) | Returnerar en array med effekter för den angivna formen. |
| [getEffectsByParagraph(IParagraph paragraph)](#getEffectsByParagraph-com.aspose.slides.IParagraph-) | Returnerar en array med effekter för det angivna stycket. |
| [getCount(IShape shape)](#getCount-com.aspose.slides.IShape-) | Returnerar antalet effekter för den angivna formen. |
| [addEffect(IShape shape, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IShape-int-int-int-) | Lägg till en ny effekt i slutet av sekvensen. |
| [addEffect(IParagraph paragraph, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IParagraph-int-int-int-) | Lägg till en ny animeringseffekt för stycket i slutet av sekvensen. |
| [addEffect(IChart chart, int type, int index, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-) | Lägger till den nya diagramanimereffekten för kategori eller serie i slutet av sekvensen. |
| [addEffect(IChart chart, int type, int seriesIndex, int categoriesIndex, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-int-) | Lägger till den nya diagramanimereffekten för element i kategori eller serie i slutet av sekvensen. |
### getCount() {#getCount--}
```
public final int getCount()
```

Returnerar antalet effekter i en sekvens. Endast läsning int.
...
Returnerar en array med effekter för den angivna formen.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | Formobjekt [IShape](../../com.aspose.slides/ishape) för att lägga till en effekt |
...
| triggerType | int | Utlösartyps av effekt [EffectTriggerType](../../com.aspose.slides/effecttriggertype) |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| paragraph | [IParagraph](../../com.aspose.slides/iparagraph) | Styckeobjekt [IParagraph](../../com.aspose.slides/iparagraph) |
| effectType | int | Typ av en animeringseffekt [EffectType](../../com.aspose.slides/effecttype) |
| subtype | int | Undertyper av animeringseffekt [EffectSubtype](../../com.aspose.slides/effectsubtype) |
| triggerType | int | Utlösartyps av effekt [EffectTriggerType](../../com.aspose.slides/effecttriggertype) |
...
Lägger till den nya diagramanimereffekten för kategori eller serie i slutet av sekvensen.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| chart | [IChart](../../com.aspose.slides/ichart) | Diagramobjekt [IChart](../../com.aspose.slides/ichart) |
...
Lägger till den nya diagramanimereffekten för element i kategori eller serie i slutet av sekvensen.
