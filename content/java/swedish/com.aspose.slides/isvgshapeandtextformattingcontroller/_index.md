...
| Metod | Beskrivning |
| --- | --- |
| [formatText(ISvgTSpan svgTSpan, IPortion portion, ITextFrame textFrame)](#formatText-com.aspose.slides.ISvgTSpan-com.aspose.slides.IPortion-com.aspose.slides.ITextFrame-) | Denna funktion anropas före rendering av textdel till SVG för att låta användaren styra resulterande SVG. |
...
Denna funktion anropas före rendering av textdel till SVG för att låta användaren styra resulterande SVG.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| svgTSpan | [ISvgTSpan](../../com.aspose.slides/isvgtspan) | Objekt för att styra SVG tspan-generering. |
