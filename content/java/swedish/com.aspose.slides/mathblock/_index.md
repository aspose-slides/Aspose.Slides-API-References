...
Specificerar en instans av matematisk text som finns inom ett MathParagraph och börjar på en egen rad. Alla mattezoner, inklusive ekvationer, uttryck, matriser av ekvationer eller uttryck, och formler representeras av ett math-block.
...
| [MathBlock(IMathElement mathElement)](#MathBlock-com.aspose.slides.IMathElement-) | Skapar ett nytt matematiskt block och placerar det specificerade elementet i det |
| [MathBlock(System.Collections.Generic.IGenericEnumerable<IMathElement> mathElements)](#MathBlock-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.slides.IMathElement--) | Skapar ett nytt matematiskt block och placerar de specificerade elementen i det |
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [getCount()](#getCount--) | Hämtar antalet underordnade matematiska element som faktiskt finns i samlingen. |
| [get_Item(int index)](#get-Item-int-) | Hämtar eller anger IMathElement på det angivna indexet. |
| [set_Item(int index, IMathElement value)](#set-Item-int-com.aspose.slides.IMathElement-) | Hämtar eller anger IMathElement på det angivna indexet. |
...
| [copyTo(IMathElement[] array, int arrayIndex)](#copyTo-com.aspose.slides.IMathElement---int-) | Kopiera till specificerad array. |
...
| [indexOf(IMathElement item)](#indexOf-com.aspose.slides.IMathElement-) | Avgör indexet för ett specifikt matematiskt element i samlingen. |
...
| [delimit(char separatorCharacter)](#delimit-char-) | Avgränsar underordnade element med ett separator-tecken (utan hakparenteser) |
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | Inramar underordnade element i detta block med specificerade tecken såsom parenteser eller andra tecken. |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | Inramar underordnade element i detta block med specificerade tecken såsom parenteser eller andra som ramverk och avgränsar med ett separator-tecken. |
| [toMathArray()](#toMathArray--) | Placera underordnade element i en vertikal matris |
| [writeAsMathMl(OutputStream stream)](#writeAsMathMl-java.io.OutputStream-) | Sparar innehållet i denna [MathBlock](../../com.aspose.slides/mathblock) som MathML |
### MathBlock() {#MathBlock--}
```
public MathBlock()
```
...
Skapar ett nytt matematiskt block och placerar det specificerade elementet i det
...
Skapar ett nytt matematiskt block och placerar de specificerade elementen i det
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| index | int | Det nollbaserade indexet för objektet |
...
**Returnerar:**
boolean – true om objektet framgångsrikt togs bort från samlingen; annars false. Denna metod returnerar också false om objektet inte finns i den ursprungliga samlingen.
### iterator() {#iterator--}
```
...
Avgör indexet för ett specifikt matematiskt element i samlingen.
...
**Returnerar:**
int – Index för objektet om det finns i samlingen; annars -1.
...
| item | [IMathElement](../../com.aspose.slides/imathelement) | MathElement som ska infogas. |
...
**Returnerar:**
[IMathBlock](../../com.aspose.slides/imathblock) – Den aktuella IMathBlock-instansen
...
**Returnerar:**
[IMathBlock](../../com.aspose.slides/imathblock) – Ett nytt IMathBlock som innehåller detta objekt och det specificerade argumentet
...
**Returnerar:**
[IMathBlock](../../com.aspose.slides/imathblock) – detta matematiska block efter sammanslagning
### delimit(char separatorCharacter) {#delimit-char-}
```
public final IMathDelimiter delimit(char separatorCharacter)
```

Avgränsar underordnade element med ett separator-tecken (utan hakparenteser)
...
**Returnerar:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) – Det matematiska elementet av typen [IMathDelimiter](../../com.aspose.slides/imathdelimiter)
...
Inramar underordnade element i detta block med specificerade tecken såsom parenteser eller andra tecken som ramverk
...
**Returnerar:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) – Det matematiska elementet av typen [IMathDelimiter](../../com.aspose.slides/imathdelimiter) som inkluderar angivna tecken som ramverk
...
Inramar underordnade element i detta block med specificerade tecken såsom parenteser eller andra som ramverk och avgränsar med ett separator-tecken
...
**Returnerar:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) – Det matematiska elementet av typen [IMathDelimiter](../../com.aspose.slides/imathdelimiter) som inkluderar angivna tecken som ramverk och avgränsare
...
Sparar innehållet i detta [MathBlock](../../com.aspose.slides/mathblock) som MathML

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| stream | java.io.OutputStream | Målstöm |