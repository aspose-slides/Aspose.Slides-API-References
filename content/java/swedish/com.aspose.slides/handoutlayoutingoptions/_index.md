...
description: Representerar handouts presentationslayoutläge för export.
type: docs
...
Representerar handouts presentationslayoutläge för export.
## Konstruktörer
...
| Metod | Beskrivning |
| --- | --- |
| [getHandout()](#getHandout--) | Anger hur många bilder och i vilken sekvens som kommer att placeras på sidan [HandoutType](../../com.aspose.slides/handouttype). |
| [setHandout(int value)](#setHandout-int-) | Anger hur många bilder och i vilken sekvens som kommer att placeras på sidan [HandoutType](../../com.aspose.slides/handouttype). |
...
Anger hur många bilder och i vilken sekvens som kommer att placeras på sidan [HandoutType](../../com.aspose.slides/handouttype).
...
Standardvärde är  **HandoutType.Handouts6Horizontal** .
