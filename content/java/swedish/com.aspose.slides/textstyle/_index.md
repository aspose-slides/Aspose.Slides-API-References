...
description: Denna klass innehåller egenskaper för formatering av textstil.
type: docs
...
Denna klass innehåller egenskaper för textstilformatering.
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [getVersion()](#getVersion--) |  |
| [getLevel(int index)](#getLevel-int-) | Om stilnivå finns returneras den, annars returneras null. |
| [getDefaultParagraphFormat()](#getDefaultParagraphFormat--) | Standardparagrafens egenskaper. |
| [getEffective()](#getEffective--) | Hämtar effektiva formateringsdata för textstil med arv tillämpat. |
### getVersion() {#getVersion--}
```
...
Standardparagrafens egenskaper. Skrivskyddad [IParagraphFormat](../../com.aspose.slides/iparagraphformat).
...
Hämtar effektiva formateringsdata för textstil med arv tillämpat.

--------------------

> ```
> Detta exempel visar hur man hämtar vissa effektiva textstilegenskaper.
>  
