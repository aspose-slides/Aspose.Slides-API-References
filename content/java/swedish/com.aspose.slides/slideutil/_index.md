...
| [findAndReplaceText(IPresentation presentation, boolean withMasters, String find, String replace)](#findAndReplaceText-com.aspose.slides.IPresentation-boolean-java.lang.String-java.lang.String-) | Hittar och ersätter text i presentationen med givet format. |
| [findAndReplaceText(IPresentation presentation, boolean withMasters, String find, String replace, PortionFormat format)](#findAndReplaceText-com.aspose.slides.IPresentation-boolean-java.lang.String-java.lang.String-com.aspose.slides.PortionFormat-) | Hittar och ersätter text i presentationen med givet format. |
...
| [getTextBoxesContainsText(IBaseSlide slide, String text, boolean checkPlaceholderText)](#getTextBoxesContainsText-com.aspose.slides.IBaseSlide-java.lang.String-boolean-) | Returnerar alla textramar på den angivna bilden som innehåller den angivna texten. |
...
**Returnerar:**
[IShape](../../com.aspose.slides/ishape) - Form eller null.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| slide | [IBaseSlide](../../com.aspose.slides/ibaseslide) | Bilden att söka efter former på. |
| placeholderType | byte | Typen av platshållare att filtrera former efter. |
...
Ändrar placeringen av alla former på bilden. Justerar formerna till marginalerna eller bildens kant eller justerar dem relativt till varandra.
...
Ändrar placeringen av valda former på bilden. Justerar formerna till marginalerna eller bildens kant eller justerar dem relativt till varandra.
...
Ändrar placeringen av alla former inom gruppformen. Justerar formerna till marginalerna eller gruppformens kant eller justerar dem relativt till varandra.
...
Ändrar placeringen av valda former inom gruppformen. Justerar formerna till marginalerna eller gruppformens kant eller justerar dem relativt till varandra.
...
Söker och ersätter text i presentationen med givet format
...
| find | java.lang.String | Strängvärde att söka efter. |
...
| format | [PortionFormat](../../com.aspose.slides/portionformat) | Format för att ersätta textdel. Om null kommer formatet för det första tecknet i den hittade strängen att användas |
...
**Returnerar:**
com.aspose.slides.ITextFrame[] - en array av [TextFrame](../../com.aspose.slides/textframe)-objekt.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| slide | [IBaseSlide](../../com.aspose.slides/ibaseslide) | Bilden att söka i. |
| text | java.lang.String | Texten att söka efter i textramarna. |
