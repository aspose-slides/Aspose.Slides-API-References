...
| [getTextFrame()](#getTextFrame--) | Returnerar eller anger text för noden. |
...
Returnerar eller anger text för noden. Endast läsning [ITextFrame](../../com.aspose.slides/itextframe).
...
Returnerar FillFormat-objektet som innehåller fyllningsformateringsegenskaper för en nodpunkt. Observera: kan returnera null för vissa typer av SmartArt-layout som inte tillhandahåller punkter för noder. Endast läsning [IFillFormat](../../com.aspose.slides/ifillformat).
...
Returnerar true om den här noden är en dold nod i datamodellen. Endast läsning boolean.
