...
| [getVersion()](#getVersion--) | Returnerar versionen av Aspose.Slides för Java. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| namePath | java.lang.String | Kan vara ett fullständigt eller kort filnamn eller namn på en inbäddad resurs. Använd en tom sträng för att växla till utvärderingsläge. |
...
Returnerar versionen av Aspose.Slides för Java.
...
Återställer licensen. Använd den här metoden för att återställa licensen i komponenten.
