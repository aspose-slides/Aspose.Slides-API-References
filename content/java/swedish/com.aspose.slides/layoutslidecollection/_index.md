...
| [get_Item(int index)](#get-Item-int-) | Returnerar layout-bilden enligt index. |
...
Returnerar layout-bilden enligt index. Skrivskyddad [LayoutSlide](../../com.aspose.slides/layoutslide).
...
**Returnerar:**
[ILayoutSlide](../../com.aspose.slides/ilayoutslide) - [LayoutSlide](../../com.aspose.slides/layoutslide) med angiven typ eller null om inga layouter hittas.
...
1) För att undvika att PptxEditException kastas, kontrollera layoutens HasDependingSlides-egenskap i förväg. 2) Du kan också använda [ILayoutSlide.remove](../../com.aspose.slides/ilayoutslide\#remove)-metoden för att förenkla koden. |
