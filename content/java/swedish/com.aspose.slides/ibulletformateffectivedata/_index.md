...
description: Oföränderligt objekt som innehåller effektiva styckepunktformateringsegenskaper.
type: docs
...
| Method | Description |
| --- | --- |
| [getType()](#getType--) | Returnerar punktens typ för ett stycke. |
...
| [getFillFormat()](#getFillFormat--) | Returnerar fyllningsformatet för punkten i ett stycke. |
### getType() {#getType--}
```
...
Returnerar punktens typ för ett stycke. Skrivskyddad [BulletType](../../com.aspose.slides/bullettype).
...
Bestämmer om punkten har egen färg eller ärver den från den första delen i stycket. Returnerar **true** om punkten har egen färg och **false** om punkten ärver färgen från den första delen i stycket. Skrivskyddad boolean.
...
Bestämmer om punkten har eget teckensnitt eller ärver det från den första delen i stycket. Returnerar **true** om punkten har eget teckensnitt och **true** om punkten ärver teckensnittet från den första delen i stycket. Skrivskyddad boolean.
...
Returnerar fyllningsformatet för punkten i ett stycke. Skrivskyddad [IFillFormatEffectiveData](../../com.aspose.slides/ifillformateffectivedata).
...
>      // Skriv ut information om styckenas punkter
