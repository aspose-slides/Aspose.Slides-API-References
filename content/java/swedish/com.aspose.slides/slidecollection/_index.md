...
| [insertClone(int index, ISlide sourceSlide)](#insertClone-int-com.aspose.slides.ISlide-) | Infogar en kopia av en specificerad bild på specificerad position i samlingen. |
...
| [insertEmptySlide(int index, ILayoutSlide layout)](#insertEmptySlide-int-com.aspose.slides.ILayoutSlide-) | Infogar en kopia av en specificerad bild på specificerad position i samlingen. |
...
| [insertClone(int index, ISlide sourceSlide, ILayoutSlide destLayout)](#insertClone-int-com.aspose.slides.ISlide-com.aspose.slides.ILayoutSlide-) | Infogar en kopia av en specificerad bild på specificerad position i samlingen. |
...
| [insertClone(int index, ISlide sourceSlide, IMasterSlide destMaster, boolean allowCloneMissingLayout)](#insertClone-int-com.aspose.slides.ISlide-com.aspose.slides.IMasterSlide-boolean-) | Infogar en kopia av en specificerad källbild på specificerad position i samlingen. |
...
| [removeAt(int index)](#removeAt-int-) | Tar bort elementet på det specificerade indexet i samlingen. |
...
| [insertFromHtml(int index, String htmlText, IExternalResourceResolver resolver, String uri)](#insertFromHtml-int-java.lang.String-com.aspose.slides.IExternalResourceResolver-java.lang.String-) | Skapar bilder från HTML-text och infogar dem i samlingen på den specificerade positionen. |
| [insertFromHtml(int index, String htmlText, IExternalResourceResolver resolver, String uri, boolean useSlideWithIndexAsStart)](#insertFromHtml-int-java.lang.String-com.aspose.slides.IExternalResourceResolver-java.lang.String-boolean-) | Skapar bilder från HTML-text och infogar dem i samlingen på den specificerade positionen. |
| [insertFromHtml(int index, String htmlText)](#insertFromHtml-int-java.lang.String-) | Skapar bilder från HTML-text och infogar dem i samlingen på den specificerade positionen. |
| [insertFromHtml(int index, String htmlText, boolean useSlideWithIndexAsStart)](#insertFromHtml-int-java.lang.String-boolean-) | Skapar bilder från HTML-text och infogar dem i samlingen på den specificerade positionen. |
| [insertFromHtml(int index, InputStream htmlStream, IExternalResourceResolver resolver, String uri)](#insertFromHtml-int-java.io.InputStream-com.aspose.slides.IExternalResourceResolver-java.lang.String-) | Skapar bilder från HTML-text och infogar dem i samlingen på den specificerade positionen. |
| [insertFromHtml(int index, InputStream htmlStream, IExternalResourceResolver resolver, String uri, boolean useSlideWithIndexAsStart)](#insertFromHtml-int-java.io.InputStream-com.aspose.slides.IExternalResourceResolver-java.lang.String-boolean-) | Skapar bilder från HTML-text och infogar dem i samlingen på den specificerade positionen. |
| [insertFromHtml(int index, InputStream htmlStream)](#insertFromHtml-int-java.io.InputStream-) | Skapar bilder från HTML-text och infogar dem i samlingen på den specificerade positionen. |
| [insertFromHtml(int index, InputStream htmlStream, boolean useSlideWithIndexAsStart)](#insertFromHtml-int-java.io.InputStream-boolean-) | Skapar bilder från HTML-text och infogar dem i samlingen på den specificerade positionen. |
...
Hämtar elementet på det specificerade indexet. Read-only [Slide](../../com.aspose.slides/slide).
...
Infogar en kopia av en specificerad bild på specificerad position i samlingen.
...
>  The following example shows how to clone at another position within Presentation.
>  
>  // Skapa ett Presentation-objekt för att läsa in källpresentationen
>  Presentation srcPres = new Presentation("CloneAtEndOfAnother.pptx");
>  try {
>      // Skapa ett Presentation-objekt för destinations-PPTX (där bilden ska klonas)
...
När en bild klonas mellan olika presentationer kan bildens master också klonas. Ett internt register används för att spåra automatiskt klonade master för att förhindra att flera kloner av samma masterbild skapas. Manuell kloning av masterbilder kommer varken att förhindras eller registreras. Om du behöver mer kontroll över kloningsprocessen kan du använda \#insertClone(int,ISlide,ILayoutSlide).insertClone(int,ISlide,ILayoutSlide) eller \#insertClone(int,ISlide,IMasterSlide,boolean).insertClone(int,ISlide,IMasterSlide,boolean) för kloning av bilder och [IMasterSlideCollection.addClone(IMasterSlide)](../../com.aspose.slides/imasterslidecollection\#addClone-IMasterSlide-) för kloning av master.
...
Lägger till en kopia av en specificerad källbild i slutet av samlingen. Ett lämpligt layout kommer att väljas automatiskt från den specificerade master-bilder (lämpligt layout är det layout som har samma typ eller namn som layouten på källbilden). Om det inte finns ett lämpligt layout kommer layouten på källbilden att klonas (om allowCloneMissingLayout är true) eller så kastas PptxEditException (om allowCloneMissingLayout är false).

**Parametrar:**
| Parameter | Type | Description |
| --- | --- | --- |
| sourceSlide | [ISlide](../../com.aspose.slides/islide) | Bild att klona. |
| destMaster | [IMasterSlide](../../com.aspose.slides/imasterslide) | Master-bild för en ny bild. |
| allowCloneMissingLayout | boolean | Om det inte finns ett lämpligt layout i specificerad master klonas layouten på källbilden (om allowCloneMissingLayout är true) eller så kastas PptxEditException (om allowCloneMissingLayout är false). |
...
Infogar en kopia av en specificerad källbild på specificerad position i samlingen. Ett lämpligt layout kommer att väljas automatiskt från den specificerade master-bilder (lämpligt layout är det layout som har samma typ eller namn som layouten på källbilden). Om det inte finns ett lämpligt layout klonas layouten på källbilden (om allowCloneMissingLayout är true) eller så kastas PptxEditException (om allowCloneMissingLayout är false).
...
Tar bort elementet på det specificerade indexet i samlingen.
...
Flyttar bilder från samlingen till den angivna positionen. Bilder placeras med början från index i den ordning de förekommer i listan.
...
| resolver | [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver) | Ett återkallningsobjekt som används för att hämta externa objekt. Om denna parameter är null ignoreras alla externa objekt. |
| uri | java.lang.String | En URI för den angivna HTML-koden. Används för att lösa relativa länkar. |
...
**Returnerar:**
com.aspose.slides.ISSlide[] - Tillagda bilder
...
Returnerar ett värde som indikerar om åtkomst till samlingen är synkroniserad (trådsäker). Endast läsbar boolean.
...
Returnerar ett synkroniseringsrot. Endast läsbar Object.
