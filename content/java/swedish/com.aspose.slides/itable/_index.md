...
| [getRightToLeft()](#getRightToLeft--) | Bestämmer om tabellen har läsordning från höger till vänster. |
| [setRightToLeft(boolean value)](#setRightToLeft-boolean-) | Bestämmer om tabellen har läsordning från höger till vänster. |
| [getFirstRow()](#getFirstRow--) | Bestämmer om den första raden i en tabell ska ritas med en specifik formatering. |
| [setFirstRow(boolean value)](#setFirstRow-boolean-) | Bestämmer om den första raden i en tabell ska ritas med en specifik formatering. |
| [getFirstCol()](#getFirstCol--) | Bestämmer om den första kolumnen i en tabell ska ritas med en specifik formatering. |
| [setFirstCol(boolean value)](#setFirstCol-boolean-) | Bestämmer om den första kolumnen i en tabell ska ritas med en specifik formatering. |
| [getLastRow()](#getLastRow--) | Bestämmer om den sista raden i en tabell ska ritas med en specifik formatering. |
| [setLastRow(boolean value)](#setLastRow-boolean-) | Bestämmer om den sista raden i en tabell ska ritas med en specifik formatering. |
| [getLastCol()](#getLastCol--) | Bestämmer om den sista kolumnen i en tabell ska ritas med en specifik formatering. |
| [setLastCol(boolean value)](#setLastCol-boolean-) | Bestämmer om den sista kolumnen i en tabell ska ritas med en specifik formatering. |
...
Returnerar cellen på de angivna kolumn- och radindexen. Skrivskyddad [ICell](../../com.aspose.slides/icell).
...
Bestämmer om tabellen har läsordning från höger till vänster. Läs/skriv boolesk.
...
Bestämmer om den första raden i en tabell ska ritas med en specifik formatering. Läs/skriv boolesk.
...
Bestämmer om den första kolumnen i en tabell ska ritas med en specifik formatering. Läs/skriv boolesk.
...
Bestämmer om den sista raden i en tabell ska ritas med en specifik formatering. Läs/skriv boolesk.
...
Bestämmer om den sista kolumnen i en tabell ska ritas med en specifik formatering. Läs/skriv boolesk.
...
Bestämmer om jämna rader ska ritas med en annan formatering. Läs/skriv boolesk.
...
Bestämmer om jämna kolumner ska ritas med en annan formatering. Läs/skriv boolesk.
...
**Returnerar:**
[ICell](../../com.aspose.slides/icell) - Slagen ihop cell.