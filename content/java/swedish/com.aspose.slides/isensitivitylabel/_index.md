...
| [getSiteId()](#getSiteId--) | Returnerar eller anger Azure Active Directory (Azure AD)-webbplatsidentifieraren som motsvarar den känslighetsetikettpolicy som beskriver känslighetsetiketten. |
| [setSiteId(UUID value)](#setSiteId-java.util.UUID-) | Returnerar eller anger Azure Active Directory (Azure AD)-webbplatsidentifieraren som motsvarar den känslighetsetikettpolicy som beskriver känslighetsetiketten. |
...
| [getContentMarkTypes()](#getContentMarkTypes--) | Returnerar listan över typer av innehållsmärkning som bör tillämpas på en fil. |
### getId() {#getId--}
```
...
Returnerar eller anger Azure Active Directory (Azure AD)-webbplatsidentifieraren som motsvarar den känslighetsetikettpolicy som beskriver känslighetsetiketten. Läs/skriv java.util.UUID.
