...
| [getPoints()](#getPoints--) | Hämtar punkter för IInkLine java.awt.geom.Point2D.Float Skrivskyddad. |
### getBrush() {#getBrush--}
```
...
Hämtar punkter för IInkLine java.awt.geom.Point2D.Float Skrivskyddad.
