...
Anger legendens position i ett diagram. Icke-NaN-värden för X, Y, Width, Height-egenskaperna åsidosätter effekten av denna egenskap. Läs/skriv [LegendPositionType](../../com.aspose.slides/legendpositiontype).
