...
description: Tillåter att skapa format via COM-gränssnittet.
type: docs
...
Tillåter att skapa format via COM-gränssnittet.
## Konstruktörer
...
| Metod | Beskrivning |
| --- | --- |
| [getInstance()](#getInstance--) | Statisk instans av formatfabrik. |
...
Statisk instans av formatfabrik. Skrivskyddad [FormatFactory](../../com.aspose.slides/formatfactory).
...
**Returnerar:**
[IPortionFormat](../../com.aspose.slides/iportionformat) - Nytt avsnittsformat.
