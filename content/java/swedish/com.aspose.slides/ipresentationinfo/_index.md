...
| [isPasswordProtected()](#isPasswordProtected--) | Returnerar ett värde som indikerar om den bundna presentationen är skyddad av ett lösenord för att öppna. |
| [isWriteProtected()](#isWriteProtected--) | Returnerar ett värde som indikerar om den bundna presentationen är skrivskyddad. |
...
| [checkWriteProtection(String password)](#checkWriteProtection-java.lang.String-) | Kontrollerar om ett lösenord för modifiering är korrekt för en skrivskyddad presentation. |
...
Returnerar True om den bundna presentationen är krypterad, annars False. Endast läsbar boolean.
...
Returnerar ett värde som indikerar om den bundna presentationen är skyddad av ett lösenord för att öppna.
...
Returnerar ett värde som indikerar om den bundna presentationen är skrivskyddad.
...
Om presentationen är skyddad av ett lösenord för att öppna, är egenskapsvärdet lika med NotDefined. Se [NullableBool](../../com.aspose.slides/nullablebool)-enumerationen.
...
Returnerar formatet för den bundna presentationen. Endast läsbar [LoadFormat](../../com.aspose.slides/loadformat).
...
När lösenordet är null eller tomt, returnerar den här metoden false. |
...
Kontrollerar om ett lösenord för modifiering är korrekt för en skrivskyddad presentation.
...
> ```
> Detta exempel visar hur man anropar metoden #updateDocumentProperties(IDocumentProperties).updateDocumentProperties(IDocumentProperties) för att
>  uppdatera dokumentegenskaperna som returneras av anropet till metoden #readDocumentProperties.readDocumentProperties.
>  
>  IPresentationInfo info = PresentationFactory.getInstance().getPresentationInfo("pres.pptx");
