...
description: Representerar en Blur-effekt som tillämpas på hela formen inklusive dess fyllning.
type: docs
...
| [setGrow(boolean value)](#setGrow-boolean-) | Bestämmer om objektets gränser ska utökas som ett resultat av oskärpan. |
| [getEffective()](#getEffective--) | Hämtar effektiv Blur-effektsdata med arv tillämpat. |
...
Hämtar effektiv Blur-effektsdata med arv tillämpat.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| obj | java.lang.Object | Den [Blur](../../com.aspose.slides/blur) att jämföra. |
