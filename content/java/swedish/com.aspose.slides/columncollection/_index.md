...
Returnerar antalet kolumner i en samling. Läs-endast int.
...
Returnerar kolumnen på det angivna indexet. Läs-endast [Column](../../com.aspose.slides/column).
...
| withAttachedColumns | boolean | Sant för att även kopiera alla kolumner som är bifogade till mallraden. |
...
Skapar en kopia av den angivna mallkolumnen och infogar den på den angivna platsen i en tabell.
