...
description: Representerar gemensamma egenskaper för bildvyn.
type: docs
...
Representerar gemensamma egenskaper för bildvyn.
## Metoder
...
| [getVariableScale()](#getVariableScale--) | Anger att innehållet i vyn automatiskt ska skalas för att bäst passa den aktuella fönsterstorleken. |
| [setVariableScale(boolean value)](#setVariableScale-boolean-) | Anger att innehållet i vyn automatiskt ska skalas för att bäst passa den aktuella fönsterstorleken. |
...
Returnerar samlingen av ritningsguider. Skrivskyddad [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
