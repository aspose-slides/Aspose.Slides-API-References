...
description: Specificerar Matrix-objektet bestående av underordnade element placerade i en eller flera rader och kolumner.
type: docs
...
| --- | --- |
| [MathMatrix(int rowCount, int columnCount)](#MathMatrix-int-int-) | Initialiserar en ny instans av MathMatrix-klassen. |
## Metoder
...
| [getHidePlaceholders()](#getHidePlaceholders--) | Dölj platshållarna för tomma matrixelement Standard: false |
| [setHidePlaceholders(boolean value)](#setHidePlaceholders-boolean-) | Dölj platshållarna för tomma matrixelement Standard: false |
...
| [getMinColumnWidth()](#getMinColumnWidth--) | Minsta kolumnbredd i twips (1/20 av en punkt) Gapavståndet (även kallat \\u201cColumn Gap\\u201d eller \\u201cGap Width\\u201d) läggs till MinColumnWidth för att bestämma den totala matrisens kolumnavstånd (avståndet mellan samma kanter på olika kolumner). |
| [setMinColumnWidth(long value)](#setMinColumnWidth-long-) | Minsta kolumnbredd i twips (1/20 av en punkt) Gapavståndet (även kallat \\u201cColumn Gap\\u201d eller \\u201cGap Width\\u201d) läggs till MinColumnWidth för att bestämma den totala matrisens kolumnavstånd (avståndet mellan samma kanter på olika kolumner). |
...
| [getRowGapRule()](#getRowGapRule--) | Typen av vertikalt avstånd mellan rader i en matris; vertikala avståndsenheter kan vara linjer eller punkter (lagrade som twips). |
| [setRowGapRule(int value)](#setRowGapRule-int-) | Typen av vertikalt avstånd mellan rader i en matris; vertikala avståndsenheter kan vara linjer eller punkter (lagrade som twips). |
| [getRowGap()](#getRowGap--) | Värdet på vertikalt avstånd mellan rader i en matris; om RowGapRule är satt till 3 (\"Exactly\"), tolkas enheten som twips (1/20 av en punkt) Om RowGapRule är satt till 4 (\"Multiple\"), tolkas enheten som halva linjer. |
| [setRowGap(long value)](#setRowGap-long-) | Värdet på vertikalt avstånd mellan rader i en matris; om RowGapRule är satt till 3 (\"Exactly\"), tolkas enheten som twips (1/20 av en punkt) Om RowGapRule är satt till 4 (\"Multiple\"), tolkas enheten som halva linjer. |
...
| [getColumnAlignment(int columnIndex)](#getColumnAlignment-int-) | Hämta den horisontella justeringen för den angivna kolumnen |
| [setColumnAlignment(int columnIndex, int val)](#setColumnAlignment-int-int-) | Ställ in den horisontella justeringen för den angivna kolumnen |
| [setColumnsAlignment(int columnIndex, long columnsCount, int val)](#setColumnsAlignment-int-long-int-) | Ställ in den horisontella justeringen för de angivna kolumnerna |
...
Initialiserar en ny instans av MathMatrix-klassen.
...
Dölj platshållarna för tomma matrixelement Standard: false
...
Minsta kolumnbredd i twips (1/20 av en punkt) Gapavståndet (även kallat \\u201cColumn Gap\\u201d eller \\u201cGap Width\\u201d) läggs till MinColumnWidth för att bestämma den totala matrisens kolumnavstånd (avståndet mellan samma kanter på olika kolumner). Standard: 0.
...
Typen av vertikalt avstånd mellan rader i en matris; vertikala avståndsenheter kan vara linjer eller punkter (lagrade som twips). Standard: SingleSpacingGap (0)
...
Värdet på vertikalt avstånd mellan rader i en matris; om RowGapRule är satt till 3 (\"Exactly\"), tolkas enheten som twips (1/20 av en punkt) Om RowGapRule är satt till 4 (\"Multiple\"), tolkas enheten som halva linjer. Standard: 0
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| row | int | Index (nollbaserat) för raden att hämta |
| column | int | Index (nollbaserat) för kolumnen att hämta |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| columnIndex | int | Index (nollbaserat) för kolumnen |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| columnIndex | int | Index (nollbaserat) för den första kolumnen att justera |
| columnsCount | long | Antal kolumner som ska få justeringen |
| val | int | Nytt värde för horisontell justering av angiven kolumn |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| rowIndex | int | Index för raden före vilken en ny rad ska infogas |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| rowIndex | int | Index för raden efter vilken en ny rad ska infogas |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| rowIndex | int | Index (nollbaserat) för raden som ska tas bort. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| columnIndex | int | Index för kolumnen före vilken en ny kolumn ska infogas |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| columnIndex | int | Index för kolumnen efter vilken en ny kolumn ska infogas |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| columnIndex | int | Index (nollbaserat) för kolumnen som ska tas bort. |
