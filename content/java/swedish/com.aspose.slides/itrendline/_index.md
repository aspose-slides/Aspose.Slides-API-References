...
| [getBackward()](#getBackward--) | Anger antalet kategorier (eller enheter på ett spridningsdiagram) som trendlinjen sträcker sig innan data för den serie som trenderas. |
| [setBackward(double value)](#setBackward-double-) | Anger antalet kategorier (eller enheter på ett spridningsdiagram) som trendlinjen sträcker sig innan data för den serie som trenderas. |
...
| [getIntercept()](#getIntercept--) | Anger värdet där trendlinjen ska skära y-axeln. |
| [setIntercept(double value)](#setIntercept-double-) | Anger värdet där trendlinjen ska skära y-axeln. |
...
| [getRelatedLegendEntry()](#getRelatedLegendEntry--) | Representerar förklaringspost relaterad till denna trendlinje Endast läsning [ILegendEntryProperties](../../com.aspose.slides/ilegendentryproperties). |
...
Anger antalet kategorier (eller enheter på ett spridningsdiagram) som trendlinjen sträcker sig innan data för den serie som trenderas. På spridnings- och icke-spridningsdiagram skall värdet vara ett icke-negativt tal. Läs/skriv double.
...
Anger antalet kategorier (eller enheter på ett spridningsdiagram) som trendlinjen sträcker sig efter data för den serie som trenderas. På spridnings- och icke-spridningsdiagram skall värdet vara ett icke-negativt tal. Läs/skriv double.
...
Anger värdet där trendlinjen ska skära y-axeln. Denna egenskap stöds endast när trendlinjetypen är exp, linear eller poly. Läs/skriv double.
...
Representerar förklaringspost relaterad till denna trendlinje Endast läsning [ILegendEntryProperties](../../com.aspose.slides/ilegendentryproperties).
