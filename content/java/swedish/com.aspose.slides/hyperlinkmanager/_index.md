...
| [setInternalHyperlinkClick(ISlide targetSlide)](#setInternalHyperlinkClick-com.aspose.slides.ISlide-) | Ställ in intern hyperlänk vid klick. |
| [removeHyperlinkClick()](#removeHyperlinkClick--) | Ta bort hyperlänk vid klick. |
| [setExternalHyperlinkMouseOver(String url)](#setExternalHyperlinkMouseOver-java.lang.String-) | Ställ in extern hyperlänk när musen hålls över. |
| [setInternalHyperlinkMouseOver(ISlide targetSlide)](#setInternalHyperlinkMouseOver-com.aspose.slides.ISlide-) | Ställ in intern hyperlänk när musen hålls över. |
| [removeHyperlinkMouseOver()](#removeHyperlinkMouseOver--) | Ta bort hyperlänk när musen hålls över. |
...
>      // Lägger till ett AutoShape-objekt med typen inställd på rektangel
