...
| --- | --- | --- |
| filename | java.lang.String | Sökvägen till filen där bilden ska sparas. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| stream | java.io.OutputStream | Strömmen där bilden ska sparas. |
| format | int | Bildformatet. |
...
| filename | java.lang.String | Sökvägen till filen där bilden ska sparas. |
| format | int | Bildformatet. |
| quality | int | Kvaliteten på den sparade bilden (0 till 100). Denna parameter påverkar endast sparning i [ImageFormat.Jpeg](../../com.aspose.slides/imageformat\#Jpeg); för alla andra format ignoreras den. |
