...
| Metod | Beskrivning |
| --- | --- |
| [validateChartLayout()](#validateChartLayout--) | Beräknar faktiska värden för diagramelement. |
| [getPlotVisibleCellsOnly()](#getPlotVisibleCellsOnly--) | Bestämmer om endast synliga celler plottas. |
| [setPlotVisibleCellsOnly(boolean value)](#setPlotVisibleCellsOnly-boolean-) | Bestämmer om endast synliga celler plottas. |
...
| [getChartData()](#getChartData--) | Returnerar information om den länkade eller inbäddade data som är associerad med ett diagram. |
| [hasTitle()](#hasTitle--) | Bestämmer om ett diagram har en synlig titel. |
| [setTitle(boolean value)](#setTitle-boolean-) | Bestämmer om ett diagram har en synlig titel. |
| [getChartTitle()](#getChartTitle--) | Returnerar eller anger en diagramtitel. |
| [hasDataTable()](#hasDataTable--) | Bestämmer om ett diagram har en datatabell. |
| [setDataTable(boolean value)](#setDataTable-boolean-) | Bestämmer om ett diagram har en datatabell. |
| [hasLegend()](#hasLegend--) | Bestämmer om ett diagram har en förklaring. |
| [setLegend(boolean value)](#setLegend-boolean-) | Bestämmer om ett diagram har en förklaring. |
...
| [getUserShapes()](#getUserShapes--) | Specificerar formerna som ritas ovanpå diagrammet. |
...
Bestämmer om ett diagram har en förklaring. Läs/skriv boolesk.
...
Returnerar eller anger en förklaring för ett diagram. Endast läsning [ILegend](../../com.aspose.slides/ilegend).
...
Representerar plotområdet för ett diagram. Endast läsning [IChartPlotArea](../../com.aspose.slides/ichartplotarea).
...
Returnerar ett objekt som möjliggör att ändra formatet på bakväggen i ett 3D-diagram. Endast läsning [IChartWall](../../com.aspose.slides/ichartwall).
...
Returnerar ett objekt som möjliggör att ändra formatet på sidoväggen i ett 3D-diagram. Endast läsning [IChartWall](../../com.aspose.slides/ichartwall).
...
Returnerar ett objekt som möjliggör att ändra formatet på golvet i ett 3D-diagram. Endast läsning [IChartWall](../../com.aspose.slides/ichartwall).
...
Returnerar temahanterare. Endast läsning [IOverrideThemeManager](../../com.aspose.slides/ioverridethememanager).
...
Specificerar formerna som ritas ovanpå diagrammet. Endast läsning [IGroupShape](../../com.aspose.slides/igroupshape).
