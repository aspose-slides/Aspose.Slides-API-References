...
description: Representerar datapunktnivå.
type: docs
...
| Metod | Beskrivning |
| --- | --- |
| [getFormat()](#getFormat--) | Representerar formateringsegenskaper för datapunktnivå. |
| [getLabel()](#getLabel--) | Representerar datamärket för datapunktnivå. |
### getFormat() {#getFormat--}
```
...
Representerar formateringsegenskaper för datapunktnivå. Läs/skriv [IFormat](../../com.aspose.slides/iformat).
...
Representerar datamärket för datapunktnivå. Tillämpas för Treemap- och Sunburst-serietyper. Skrivskyddad [IDataLabel](../../com.aspose.slides/idatalabel).
