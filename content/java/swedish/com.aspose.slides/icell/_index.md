...
| [getFirstRowIndex()](#getFirstRowIndex--) | Returnerar indexet för den första raden som täcks av cellen. |
...
| [getMarginLeft()](#getMarginLeft--) | Returnerar eller anger vänster marginal i en TextFrame. |
| [setMarginLeft(double value)](#setMarginLeft-double-) | Returnerar eller anger vänster marginal i en TextFrame. |
| [getMarginRight()](#getMarginRight--) | Returnerar eller anger högra marginalen i en TextFrame. |
| [setMarginRight(double value)](#setMarginRight-double-) | Returnerar eller anger högra marginalen i en TextFrame. |
| [getMarginTop()](#getMarginTop--) | Returnerar eller anger övre marginalen i en TextFrame. |
| [setMarginTop(double value)](#setMarginTop-double-) | Returnerar eller anger övre marginalen i en TextFrame. |
| [getMarginBottom()](#getMarginBottom--) | Returnerar eller anger nedre marginalen i en TextFrame. |
| [setMarginBottom(double value)](#setMarginBottom-double-) | Returnerar eller anger nedre marginalen i en TextFrame. |
...
| [getAnchorCenter()](#getAnchorCenter--) | Avgör om textlådan är centrerad i en cell eller inte. |
| [setAnchorCenter(boolean value)](#setAnchorCenter-boolean-) | Avgör om textlådan är centrerad i en cell eller inte. |
| [getFirstColumn()](#getFirstColumn--) | Hämtar cellens första kolumn. |
| [getFirstRow()](#getFirstRow--) | Hämtar cellens första rad. |
| [getColSpan()](#getColSpan--) | Returnerar antalet rutnätkolumner i föräldertabellens tabellrutnät som den aktuella cellen ska spänna över. |
...
| [isMergedCell()](#isMergedCell--) | Returnerar true om cellen är sammanslagen med någon annan cell, annars false. |
...
Returnerar indexet för den första raden som täcks av cellen. Skrivskyddad int.
...
Returnerar cellens minsta höjd. Detta är summan av de minsta höjderna för alla rader som täcks av cellen. Skrivskyddad double.
...
Returnerar eller anger vänster marginal i en TextFrame. Läs/skriv double.
...
Returnerar eller anger högra marginalen i en TextFrame. Läs/skriv double.
...
Returnerar eller anger övre marginalen i en TextFrame. Läs/skriv double.
...
Returnerar eller anger nedre marginalen i en TextFrame. Läs/skriv double.
...
Avgör om textlådan är centrerad i en cell eller inte. Läs/skriv boolean.
...
Hämtar cellens första kolumn. Skrivskyddad [IColumn](../../com.aspose.slides/icolumn).
...
Hämtar cellens första rad. Skrivskyddad [IRow](../../com.aspose.slides/irow).
...
Returnerar antalet rutnätkolumner i föräldertabellens tabellrutnät som den aktuella cellen ska spänna över. Denna egenskap tillåter celler att ha utseendet av att vara sammanslagna, då de spänner över vertikala gränser för andra celler i tabellen. Skrivskyddad int.
...
Returnerar antalet rader som en sammanslagen cell spänner över. Detta används i kombination med vMerge-attributet på andra celler för att ange den inledande cellen för en horisontell sammanslagning. Skrivskyddad int.
