...
| [getBackward()](#getBackward--) | Anger antalet kategorier (eller enheter på ett spridningsdiagram) som trendlinjen sträcker sig före data för serien som trenderas. |
| [setBackward(double value)](#setBackward-double-) | Anger antalet kategorier (eller enheter på ett spridningsdiagram) som trendlinjen sträcker sig före data för serien som trenderas. |
...
| [getDisplayEquation()](#getDisplayEquation--) | Anger att ekvationen för trendlinjen visas på diagrammet (i samma etikett som Rsquaredvärdet). |
| [setDisplayEquation(boolean value)](#setDisplayEquation-boolean-) | Anger att ekvationen för trendlinjen visas på diagrammet (i samma etikett som Rsquaredvärdet). |
...
| [getDisplayRSquaredValue()](#getDisplayRSquaredValue--) | Anger att R-kvadrerat-värdet för trendlinjen visas på diagrammet (i samma etikett som ekvationen). |
| [setDisplayRSquaredValue(boolean value)](#setDisplayRSquaredValue-boolean-) | Anger att R-kvadrerat-värdet för trendlinjen visas på diagrammet (i samma etikett som ekvationen). |
| [getRelatedLegendEntry()](#getRelatedLegendEntry--) | Representerar legendpost relaterad till denna trendlinje Endast läsning [ILegendEntryProperties](../../com.aspose.slides/ilegendentryproperties). |
...
| [getSlide()](#getSlide--) | Returnerar föräldersliden för ett FillFormat. |
| [getPresentation()](#getPresentation--) | Returnerar föräldrepresentationen för ett FillFormat. |
...
Anger antalet kategorier (eller enheter på ett spridningsdiagram) som trendlinjen sträcker sig före data för serien som trenderas. På spridnings- och icke-spridningsdiagram ska värdet vara ett icke-negativt värde. Läs/skriv double.
...
Anger antalet kategorier (eller enheter på ett spridningsdiagram) som trendlinjen sträcker sig efter data för serien som trenderas. På spridnings- och icke-spridningsdiagram ska värdet vara ett icke-negativt värde. Läs/skriv double.
...
Anger att ekvationen för trendlinjen visas på diagrammet (i samma etikett som Rsquaredvärdet). Läs/skriv boolean.
...
Anger perioden för trendlinjen för ett glidande medelvärde. Den ignoreras för andra trendlinjevarianter. Värdet måste vara mellan 2 och 255. Läs/skriv byte.
...
Anger att R-kvadrerat-värdet för trendlinjen visas på diagrammet (i samma etikett som ekvationen). Läs/skriv boolean.
...
Representerar legendpost relaterad till denna trendlinje Endast läsning [ILegendEntryProperties](../../com.aspose.slides/ilegendentryproperties).
...
Kan innehålla en rik formaterad text. Om denna egenskap inte är null så åsidosätter detta formaterade textvärde den automatiskt genererade texten för datamärket. Automatiskt genererad text för datamärket betyder text som hanteras av egenskaperna ShowSeriesName, ShowValue, ... och som formateras med TextFormatManager.TextFormat-egenskapen. Endast läsning [ITextFrame](../../com.aspose.slides/itextframe).
...
Returnerar textformat. Endast läsning [IChartTextFormat](../../com.aspose.slides/icharttextformat).
...
Returnerar föräldersliden för ett FillFormat. Endast läsning [BaseSlide](../../com.aspose.slides/baseslide).
...
Returnerar föräldrepresentationen för ett FillFormat. Endläsning [IPresentation](../../com.aspose.slides/ipresentation).
