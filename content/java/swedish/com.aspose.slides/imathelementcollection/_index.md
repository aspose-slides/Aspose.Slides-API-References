...
| [copyTo(IMathElement[] array, int arrayIndex)](#copyTo-com.aspose.slides.IMathElement---int-) | Kopierar till angiven array. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | Det IMathElement som ska läggas till i slutet av samlingen. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| index | int | Det nollbaserade indexet för det index där IMathElement ska infogas. |
| item | [IMathElement](../../com.aspose.slides/imathelement) | IMathElement som ska infogas. |
...
**Returnerar:**
boolean - true om objektet hittas i samlingen; annars false.
...
**Returnerar:**
boolean - true om objektet har tagits bort från samlingen; annars false. Denna metod returnerar också false om objektet inte finns i den ursprungliga samlingen.
...
| arrayIndex | int | Index där kopieringen ska börja. |