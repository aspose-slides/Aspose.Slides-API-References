...
type: docs
url: /sv/com.aspose.slides/field/
---
**Arv:**
...
| Metod | Beskrivning |
| --- | --- |
| [getType()](#getType--) | Returnerar eller sätter fältets typ. |
| [setType(IFieldType value)](#setType-com.aspose.slides.IFieldType-) | Returnerar eller sätter fältets typ. |
| [getSlide()](#getSlide--) | Returnerar den överordnade sliden för ett stycke. |
...
Returnerar eller sätter fältets typ. Läs/skriv [IFieldType](../../com.aspose.slides/ifieldtype).
...
Returnerar den överordnade sliden för ett stycke. Skrivskyddad [BaseSlide](../../com.aspose.slides/baseslide).
