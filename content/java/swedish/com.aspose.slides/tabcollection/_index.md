...
| [add(double position, int align)](#add-double-int-) | Lägger till en flik i samlingen. |
| [add(ITab value)](#add-com.aspose.slides.ITab-) | Lägger till en flik i samlingen. |
...
Lägger till en flik i samlingen.
...
**Returnerar:**
[ITab](../../com.aspose.slides/itab) - Tillagd flik.
...
**Returnerar:**
int - Indexet där fliken lades till.
### clear() {#clear--}
```
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| obj | java.lang.Object | TabsEx som ska jämföras med den aktuella TabsEx. |
