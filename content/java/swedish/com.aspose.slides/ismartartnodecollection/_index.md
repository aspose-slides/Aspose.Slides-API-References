...
| Metod | Beskrivning |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Returnerar noden efter index. |
| [addNode()](#addNode--) | Lägg till ny nod eller undernod. |
| [removeNode(int index)](#removeNode-int-) | Ta bort nod eller undernod efter index. |
| [removeNode(ISmartArtNode nodeObj)](#removeNode-com.aspose.slides.ISmartArtNode-) | Ta bort nod eller undernod. |
| [addNodeByPosition(int position)](#addNodeByPosition-int-) | Lägg till ny nod på den valda positionen i nodsamlingen. |
...
Returnerar noden efter index. Skrivskyddad [ISmartArtNode](../../com.aspose.slides/ismartartnode)
...
Lägg till ny nod eller undernod.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| index | int | Nollbaserat index för nod |
...
Lägg till ny nod på den valda positionen i nodsamlingen.
