...
Representerar en Fill Overlay-effekt. En fill overlay kan användas för att ange ett extra fyllningsalternativ för ett objekt och blanda de två fyllningarna tillsammans.
## Metoder
...
| [getEffective()](#getEffective--) | Hämtar effektiv Fill Overlay-effektdata med arv tillämpat. |
...
Fyllformat. Läs-endast [IFillFormat](../../com.aspose.slides/ifillformat).
...
Hämtar effektiv Fill Overlay-effektdata med arv tillämpat.
