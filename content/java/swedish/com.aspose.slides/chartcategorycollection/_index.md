...
| [getGroupingLevelCount()](#getGroupingLevelCount--) | Returnerar antalet grupperingnivåer för kategori som används. |
| [add(IChartDataCell chartDataCell)](#add-com.aspose.slides.IChartDataCell-) | Om kategorin finns i samlingen, returnera den. |
| [add(Object value)](#add-java.lang.Object-) | Skapar ny [ChartCategory](../../com.aspose.slides/chartcategory) från värdet och lägger till den i samlingen. |
...
Returnerar antalet grupperingnivåer för kategori som används. Är fler än ett för flernivåkategorier. Läs-endast int.
...
Om kategorin finns i samlingen, returnera den. Annars skapar den en ny diagramkategori från [IChartDataCell](../../com.aspose.slides/ichartdatacell) och lägger till den i samlingen.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| chartDataCell | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Cell som används för att skapa diagramkategorin. |
...
Skapar ny [ChartCategory](../../com.aspose.slides/chartcategory) från värdet och lägger till den i samlingen.
...
Denna metod lägger till ett arbetsblad med namnet AUTO_DATA och lägger till alla värden där. Om du använder [ChartDataWorkbook](../../com.aspose.slides/chartdataworkbook) för att lägga till eller redigera cellvärden, se till att du inte använder detta arbetsblad. Maximalt antal värden som kan läggas till med denna metod får inte överstiga 16711680.
...
Returnerar antalet element i samlingen. Läs-endast int.
...
Returnerar ett värde som indikerar om åtkomst till listan är synkroniserad (trådsäker). Läs-endast boolean.
...
Returnerar en synkroniseringsrot. Läs-endast Object.
