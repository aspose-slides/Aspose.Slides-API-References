...
| Metod | Beskrivning |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Returnerar nod efter index |
| [size()](#size--) | Returnerar antalet noder i samlingen Skrivskyddad  int  Skrivskyddad  int . |
| [addNode()](#addNode--) | Lägg till en ny smart art-nod eller undernod. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| array | com.aspose.ms.System.Array | Målarrayen. |
