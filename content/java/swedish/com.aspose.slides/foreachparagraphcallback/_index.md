...
description: 
type: docs
url: /sv/com.aspose.slides/foreach.foreachparagraphcallback/
---```
...
| Metod | Beskrivning |
| --- | --- |
| [invoke(Paragraph para, BaseSlide slide, int index)](#invoke-com.aspose.slides.Paragraph-com.aspose.slides.BaseSlide-int-) | Återanrop som kommer att anropas för varje \#paragraph(Presentation,ForEachParagraphCallback).paragraph(Presentation,ForEachParagraphCallback) på [BaseSlide](../../com.aspose.slides/baseslide). |
