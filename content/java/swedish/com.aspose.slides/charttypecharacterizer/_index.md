...
Hjälpmedel för att få ytterligare information om diagram och serier via dess ChartType.
...
| [isSeriesUsesXValueCoordinate(int seriesType)](#isSeriesUsesXValueCoordinate-int-) | Returnerar om angiven serietyp använder X-värdekoordinater. |
| [isSeriesUsesYValueCoordinate(int seriesType)](#isSeriesUsesYValueCoordinate-int-) | Returnerar om angiven serietyp använder Y-värdekoordinater. |
| [isSeriesUsesValueCoordinate(int seriesType)](#isSeriesUsesValueCoordinate-int-) | Returnerar om angiven serietyp använder värdekoordinater. |
| [isSeriesUsesBubbleSizeCoordinate(int seriesType)](#isSeriesUsesBubbleSizeCoordinate-int-) | Returnerar om bubbelstorlekskoordinater kan användas för angiven serietyp. |
| [hasSeriesTrendLines(int seriesType)](#hasSeriesTrendLines-int-) | Returnerar om det finns serietrendlinjer för angiven serietyp. |
| [isErrorBarsXAllowed(int seriesType)](#isErrorBarsXAllowed-int-) | Returnerar om felstaplar X är tillåtna för angiven serietyp. |
| [isErrorBarsYAllowed(int seriesType)](#isErrorBarsYAllowed-int-) | Returnerar om felstaplar Y är tillåtna för angiven serietyp. |
...
Returnerar om angiven serietyp använder X-värdekoordinater.
...
Returnerar om angiven serietyp använder Y-värdekoordinater.
...
Returnerar om angiven serietyp använder värdekoordinater.
...
Returnerar om det finns serietrendlinjer för angiven serietyp.
...
Returnerar om felstaplar X är tillåtna för angiven serietyp.
...
Returnerar om felstaplar Y är tillåtna för angiven serietyp.
