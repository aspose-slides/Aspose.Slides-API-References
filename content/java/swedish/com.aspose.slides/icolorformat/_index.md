...
| [getColor()](#getColor--) | Returnerar den resulterande färgen (med alla färgtransformeringar tillämpade). |
| [setColor(Color value)](#setColor-java.awt.Color-) | Returnerar den resulterande färgen (med alla färgtransformeringar tillämpade). |
| [getPresetColor()](#getPresetColor--) | Returnerar eller anger färgförinställningen. |
| [setPresetColor(int value)](#setPresetColor-int-) | Returnerar eller anger färgförinställningen. |
...
Returnerar den resulterande färgen (med alla färgtransformeringar tillämpade). Anger RGB-färger och rensar alla färgtransformeringar. Läs/skriv java.awt.Color.
...
Returnerar eller anger färgförinställningen. Läs/skriv [PresetColor](../../com.aspose.slides/presetcolor).
...
Returnerar eller anger nyanskomponenten i en färg i HSL-representation. Alla färgtransformeringar ignoreras. Läs/skriv float.
...
Returnerar eller anger mättnadskomponenten i en färg i HSL-representation. Alla färgtransformeringar ignoreras. Läs/skriv float.
...
Returnerar eller anger luminanskomponenten i en färg i HSL-representation. Alla färgtransformeringar ignoreras. Läs/skriv float.
