...
| Metod | Beskrivning |
| --- | --- |
| [getLayout()](#getLayout--) | Hämtar layout för Summary Zoom-sektioner i ramen. |
| [getSummaryZoomCollection()](#getSummaryZoomCollection--) | Hämtar [ISummaryZoomSectionCollection](../../com.aspose.slides/isummaryzoomsectioncollection) för Summary Zoom Frame object. |
### getLayout() {#getLayout--}
```
