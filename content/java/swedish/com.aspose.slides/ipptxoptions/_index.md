...
| [getRefreshThumbnail()](#getRefreshThumbnail--) | Anger om presentationsminiatyren kommer att uppdateras. |
| [setRefreshThumbnail(boolean value)](#setRefreshThumbnail-boolean-) | Anger om presentationsminiatyren kommer att uppdateras. |
...
Anger om presentationsminiatyren kommer att uppdateras. Läs/skriv boolesk. Standardvärdet är **true**.
...
När alternativvärdet är **false** sparas den befintliga miniatyren som den är.
