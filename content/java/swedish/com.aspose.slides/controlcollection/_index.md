...
| Metod | Beskrivning |
| --- | --- |
| [size()](#size--) | Returnerar ett antal objekt i samlingen. |
...
| x | float | X-koordinaten för vänster sida av formens ram. |
| y | float | Y-koordinaten för överkant av formens ram. |
...
**Returnerar:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IControl> - En IGenericEnumerator som kan användas för att iterera igenom samlingen.
