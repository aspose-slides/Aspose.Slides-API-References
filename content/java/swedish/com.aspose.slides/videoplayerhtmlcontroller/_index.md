...
| --- | --- |
| [VideoPlayerHtmlController(String path, String fileName, String baseUri)](#VideoPlayerHtmlController-java.lang.String-java.lang.String-java.lang.String-) | Skapar en ny instans av controller |
## Metoder
...
| --- | --- | --- |
| path | java.lang.String | Sökvägen där video- och ljudfilerna kommer att genereras |
| fileName | java.lang.String | Namnet på HTML-filen |
| baseUri | java.lang.String | Bas-URI som kommer att användas för generering av länkar |
...
Anropas för att skriva HTML-slide-rubrik. Anropas en gång för varje slide.
...
Anropas för att skriva HTML-slide-sidfot. Anropas en gång för varje slide.
...
Anropas innan formens rendering. Anropas en gång för varje form. Om denna funktion skriver något till generatorn, avslutas den aktuella bildgenereringen för sliden, det tillagda HTML-fragmentet sätts in och en ny bild startas ovanpå den tidigare.
...
Denna funktion anropas innan rendering av form till SVG för att låta användaren styra den resulterande SVG:n.
