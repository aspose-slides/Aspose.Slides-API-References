---
title: Background
second_title: Aspose.Slides för Java API-referensen
...
| [getStyleIndex()](#getStyleIndex--) | Returnerar ett index för BackgroundType.Themed-fyllning i bakgrundstemat samling. |
| [setStyleIndex(int value)](#setStyleIndex-int-) | Returnerar ett index för BackgroundType.Themed-fyllning i bakgrundstemat samling. |
| [getEffective()](#getEffective--) | Hämtar effektiv bakgrundsdata med arv tillämpat. |
...
Returnerar ett index för BackgroundType.Themed-fyllning i bakgrundstemat samling. 0 betyder ingen fyllning. 1..999 – index. Läs/skriv int.
