...
| [getRow()](#getRow--) | Hämtar nollbaserat index för raden i kalkylbladet där cellen är placerad. |
| [getColumn()](#getColumn--) | Hämtar nollbaserat index för kolumnen i kalkylbladet där cellen är placerad. |
### getValue() {#getValue--}
```
...
Hämtar nollbaserat index för raden i kalkylbladet där cellen är placerad. Skrivskyddad int.
...
Hämtar nollbaserat index för kolumnen i kalkylbladet där cellen är placerad. Skrivskyddad int.
