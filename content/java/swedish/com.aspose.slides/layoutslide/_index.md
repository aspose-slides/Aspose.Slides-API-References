...
| [getLayoutType()](#getLayoutType--) | Returnerar layouttyp för denna layout-bild. |
...
| [getDrawingGuides()](#getDrawingGuides--) | Returnerar en samling ritguider för layout-bilden. |
...
Returnerar layouttyp för denna layout-bild. Skrivskyddad [SlideLayoutType](../../com.aspose.slides/slidelayouttype).
...
Returnerar en samling ritguider för layout-bilden. Skrivskyddad [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
...
>      // Lägger till den nya vertikala ritguiden till vänster om bildens centrum
