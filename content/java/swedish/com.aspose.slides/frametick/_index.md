...
description: Representerar ram-tick-hanteraren för FrameTickDelegate.FrameTickDelegate-händelsen.
type: docs
url: /sv/com.aspose.slides/presentationplayer.frametick/
---```
public static interface PresentationPlayer.FrameTick
```

Representerar ram-tick-hanteraren för \#FrameTickDelegate.FrameTickDelegate-händelsen.
## Metoder
