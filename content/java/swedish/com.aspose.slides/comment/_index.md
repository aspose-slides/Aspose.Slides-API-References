...
description: Representerar en kommentar på en slide.
type: docs
...
Representerar en kommentar på en slide.
...
| Metod | Beskrivning |
| --- | --- |
| [getText()](#getText--) | Returnerar eller anger den vanliga texten för en slide-kommentar. |
| [setText(String value)](#setText-java.lang.String-) | Returnerar eller anger den vanliga texten för en slide-kommentar. |
| [getCreatedTime()](#getCreatedTime--) | Returnerar eller anger tidpunkten för en kommentarskapning. |
| [setCreatedTime(Date value)](#setCreatedTime-java.util.Date-) | Returnerar eller anger tidpunkten för en kommentarskapning. |
| [getSlide()](#getSlide--) | Returnerar eller anger den föräldraslide som kommentaren tillhör. |
| [getAuthor()](#getAuthor--) | Returnerar författaren till en kommentar. |
| [getPosition()](#getPosition--) | Returnerar eller anger positionen för en kommentar på en slide. |
| [setPosition(Point2D.Float value)](#setPosition-java.awt.geom.Point2D.Float-) | Returnerar eller anger positionen för en kommentar på en slide. |
...
Returnerar eller anger den vanliga texten för en slide-kommentar. Läs/skriv String.
...
Returnerar eller anger tidpunkten för en kommentarskapning. Att sätta denna egenskap till java.util.Date(Long.MIN_VALUE) betyder att ingen kommentartid är angiven. Läs/skriv java.util.Date.
...
Returnerar eller anger den föräldraslide som kommentaren tillhör. Endast läsning [ISlide](../../com.aspose.slides/islide).
...
Returnerar eller anger positionen för en kommentar på en slide. Läs/skriv java.awt.geom.Point2D.Float.
