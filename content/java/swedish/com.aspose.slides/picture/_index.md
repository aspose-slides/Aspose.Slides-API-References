...
| [getImage()](#getImage--) | Returnerar eller sätter den inbäddade bilden. |
| [setImage(IPPImage value)](#setImage-com.aspose.slides.IPPImage-) | Returnerar eller sätter den inbäddade bilden. |
...
| [getSlide()](#getSlide--) | Returnerar den överordnade sliden för en bild. |
### getParent_Immediate() {#getParent-Immediate--}
```
...
Returnerar eller sätter den inbäddade bilden. Läs/skriv [IPPImage](../../com.aspose.slides/ippimage).
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| obj | java.lang.Object | Objekt att jämföra med. |
...
Returnerar den överordnade sliden för en bild. Skrivskyddad [IBaseSlide](../../com.aspose.slides/ibaseslide).
