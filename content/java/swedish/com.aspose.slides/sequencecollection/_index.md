...
| [removeAt(int index)](#removeAt-int-) | Tar bort sekvens på angivet index. |
| [clear()](#clear--) | Tar bort alla sekvenser från en samling. |
| [get_Item(int index)](#get-Item-int-) | Returnerar en sekvens på angivet index. |
...
Lägg till ny interaktiv sekvens. Läs/skriv [Sequence](../../com.aspose.slides/sequence).
...
Tar bort sekvens på angivet index.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| index | int | Index för den sekvens som ska tas bort. |
...
Returnerar en sekvens på angivet index.
