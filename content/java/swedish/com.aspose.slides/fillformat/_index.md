...
| [getEffective()](#getEffective--) | Hämtar effektiv fyllningsformateringsdata med ärvda inställningar tillämpade. |
### getVersion() {#getVersion--}
```
...
Hämtar effektiv fyllningsformateringsdata med ärvda inställningar tillämpade.
