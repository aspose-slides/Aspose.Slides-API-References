...
description: Tillhandahåller alternativ som styr utseendet på Ink-objekt i ett exporterat dokument.
type: docs
...
Tillhandahåller alternativ som styr utseendet på Ink-objekt i ett exporterat dokument.
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [getHideInk()](#getHideInk--) | Visar eller döljer Ink-element i ett exporterat dokument. |
| [setHideInk(boolean value)](#setHideInk-boolean-) | Visar eller döljer Ink-element i ett exporterat dokument. |
...
Visar eller döljer Ink-element i ett exporterat dokument.
