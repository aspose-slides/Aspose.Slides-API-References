...
| Metod | Beskrivning |
| --- | --- |
| [getRow()](#getRow--) | Returnerar indexet för den rad i kalkylbladet där cellen är placerad. |
| [getColumn()](#getColumn--) | Returnerar indexet för den kolumn i kalkylbladet där cellen är placerad. |
| [getValue()](#getValue--) | Hämtar eller anger värdet i en cell. |
| [setValue(Object value)](#setValue-java.lang.Object-) | Hämtar eller anger värdet i en cell. |
...
| [calculate(boolean updateValues)](#calculate-boolean-) | Om cellen innehåller en formel kommer värdet att uppdateras baserat på den formeln. |
### getRow() {#getRow--}
```
...
Returnerar indexet för den rad i kalkylbladet där cellen är placerad. Skrivskyddad int.
...
Returnerar indexet för den kolumn i kalkylbladet där cellen är placerad. Skrivskyddad int.
...
Hämtar eller anger värdet i en cell. Läs/skriv  Object .
...
Hämtar eller anger det anpassade visningsformatet för tal och datum. Om värdet är tomt används PresetNumberFormat. Läs/skriv String.
...
Om cellen innehåller en formel kommer värdet att uppdateras baserat på den formeln.
