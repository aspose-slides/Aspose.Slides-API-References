...
| [isValid()](#isValid--) | Om denna digitala signatur är giltig och dokumentet inte har manipulerats, kommer detta värde att vara true. |
...
| --- | --- | --- |
| certData | byte[] | en byte-array som innehåller certifikatet |
...
Om denna digitala signatur är giltig och dokumentet inte har manipulerats, kommer detta värde att vara true. Skrivskyddad boolean.
