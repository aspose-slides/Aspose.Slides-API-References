...
| [indexOf(IBehaviorProperty item)](#indexOf-com.aspose.slides.IBehaviorProperty-) | Bestämmer indexet för ett specifikt objekt i Listan. |
...
| [insert(int index, IBehaviorProperty item)](#insert-int-com.aspose.slides.IBehaviorProperty-) | Infogar en ny egenskap i samlingen på angivet index. |
...
| [copyTo(IBehaviorProperty[] array, int arrayIndex)](#copyTo-com.aspose.slides.IBehaviorProperty---int-) | Kopierar elementen från [IGenericCollection](../../com.aspose.slides/igenericcollection) till en Array, med start vid ett specifikt Array-index. |
...
| [removeAt(int index)](#removeAt-int-) | Tar bort egenskap på angivet index. |
...
| [get_Item(int index)](#get-Item-int-) | Returnerar en egenskap på angivet index. |
| [set_Item(int index, IBehaviorProperty value)](#set-Item-int-com.aspose.slides.IBehaviorProperty-) | Ställer in en egenskap på angivet index. |
...
Returnerar antalet egenskaper som lagras i samlingen. Read-only int.
...
Hämtar ett värde som indikerar om [IGenericCollection](../../com.aspose.slides/igenericcollection) är skrivskyddad. Read-only boolean.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | Objektet att hitta i Listan. |
...
Infogar en ny egenskap i samlingen på angivet index.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| array | [IBehaviorProperty\[\]](../../com.aspose.slides/ibehaviorproperty) | Den endimensionella Array som är destinationsplats för elementen kopierade från [IGenericCollection](../../com.aspose.slides/igenericcollection). Arrayen måste ha nollbaserad indexering. |
...
Tar bort egenskap på angivet index.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| index | int | Index för egenskapen som ska tas bort. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | Egenskapen att hitta i [IGenericCollection](../../com.aspose.slides/igenericcollection). |

**Returnerar:**
boolean - true om objektet hittar i [IGenericCollection](../../com.aspose.slides/igenericcollection); annars false.
...
**Returnerar:**
boolean - true om propertyValue hittar i [IGenericCollection](../../com.aspose.slides/igenericcollection); annars false.
...
Returnerar en egenskap på angivet index.
...
Ställer in en egenskap på angivet index.
