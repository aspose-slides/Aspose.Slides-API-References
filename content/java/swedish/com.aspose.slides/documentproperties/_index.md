...
| --- | --- |
| [DocumentProperties()](#DocumentProperties--) | Initierar ny instans av klass [DocumentProperties](../../com.aspose.slides/documentproperties). |
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [getAppVersion()](#getAppVersion--) | Returnerar appens version. |
| [getNameOfApplication()](#getNameOfApplication--) | Returnerar eller anger namn på applikationen. |
| [setNameOfApplication(String value)](#setNameOfApplication-java.lang.String-) | Returnerar eller anger namn på applikationen. |
...
| [getManager()](#getManager--) | Returnerar eller anger chefegenskapen. |
| [setManager(String value)](#setManager-java.lang.String-) | Returnerar eller anger chefegenskapen. |
...
| [getSharedDoc()](#getSharedDoc--) | Avgör om presentationen delas mellan flera personer. |
| [setSharedDoc(boolean value)](#setSharedDoc-boolean-) | Avgör om presentationen delas mellan flera personer. |
...
| [getLastSavedTime()](#getLastSavedTime--) | Returnerar datumet då en presentation senast modifierades. |
| [setLastSavedTime(Date value)](#setLastSavedTime-java.util.Date-) | Returnerar datumet då en presentation senast modifierades. |
...
| [getLastSavedBy()](#getLastSavedBy--) | Returnerar eller anger namnet på den senaste personen som modifierade en presentation. |
| [setLastSavedBy(String value)](#setLastSavedBy-java.lang.String-) | Returnerar eller anger namnet på den senaste personen som modifierade en presentation. |
| [getRevisionNumber()](#getRevisionNumber--) | Returnerar eller anger presentationsversionsnumret. |
| [setRevisionNumber(int value)](#setRevisionNumber-int-) | Returnerar eller anger presentationsversionsnumret. |
...
| [getCountOfCustomProperties()](#getCountOfCustomProperties--) | Returnerar antalet egna egenskaper som faktiskt finns i en samling. |
| [getCustomPropertyName(int index)](#getCustomPropertyName-int-) | Returnerar ett eget egenskapsnamn vid angivet index. |
| [removeCustomProperty(String name)](#removeCustomProperty-java.lang.String-) | Tar bort en egen egenskap associerad med ett angivet namn. |
| [containsCustomProperty(String name)](#containsCustomProperty-java.lang.String-) | Kontrollerar närvaro av en egen egenskap med ett angivet namn. |
| [get_Item(String name)](#get-Item-java.lang.String-) | Returnerar eller anger den egna egenskapen associerad med ett angivet namn. |
| [set_Item(String name, Object value)](#set-Item-java.lang.String-java.lang.Object-) | Returnerar eller anger den egna egenskapen associerad med ett angivet namn. |
...
| [setCustomPropertyValue(String name, boolean value)](#setCustomPropertyValue-java.lang.String-boolean-) | Ställer in en namngiven boolesk egen egenskap. |
| [setCustomPropertyValue(String name, int value)](#setCustomPropertyValue-java.lang.String-int-) | Ställer in en namngiven heltals-egen egenskap. |
| [setCustomPropertyValue(String name, Date value)](#setCustomPropertyValue-java.lang.String-java.util.Date-) | Ställer in en namngiven DateTime-egen egenskap. |
| [setCustomPropertyValue(String name, String value)](#setCustomPropertyValue-java.lang.String-java.lang.String-) | Ställer in en namngiven sträng-egen egenskap. |
| [setCustomPropertyValue(String name, float value)](#setCustomPropertyValue-java.lang.String-float-) | Ställer in en namngiven float-egen egenskap. |
| [setCustomPropertyValue(String name, double value)](#setCustomPropertyValue-java.lang.String-double-) | Ställer in en namngiven double-egen egenskap. |
| [clearCustomProperties()](#clearCustomProperties--) | Tar bort alla egna egenskaper. |
| [getSensitivityLabels()](#getSensitivityLabels--) | Hämtar en array av känslighetsetiketter från de egna dokumentegenskaperna (Microsoft Information Protection SDK Metadata). |
| [clearBuiltInProperties()](#clearBuiltInProperties--) | Rensar och anger standardvärden för alla inbyggda egenskaper. |
| [getScaleCrop()](#getScaleCrop--) | Indikerar visningsläget för dokumentets miniatyr. |
| [setScaleCrop(boolean value)](#setScaleCrop-boolean-) | Indikerar visningsläget för dokumentets miniatyr. |
...
Initierar ny instans av klass [DocumentProperties](../../com.aspose.slides/documentproperties).
...
Returnerar eller anger namn på applikationen. Läs/skriv String.
...
Returnerar eller anger chefegenskapen. Läs/skriv String.
...
Avgör om presentationen delas mellan flera personer. Läs/skriv boolean.
...
Returnerar eller anger namnet på den senast person som ändrade en presentation. Läs/skriv String.
...
Returnerar eller anger presentations revisionsnummer. Läs/skriv int.
...
**Returnerar:**
java.lang.String – Användarnamn för egenskapen på det angivna indexet.
...
Värdet kan vara **int**, **float**, **String**, **boolean** eller **Date**.
...
| value | boolean[] | Anslaget för egenskapens värde |
...
| --- | --- | --- |
| name | java.lang.String | Namnet på den anpassade egenskapen att hämta |
| value | int[] | Anslaget för egenskapens värde |
...
| --- | --- | --- |
| name | java.lang.String | Namnet på den anpassade egenskapen att hämta |
| value | java.util.Date[] | Anslaget för egenskapens värde |
...
| --- | --- | --- |
| name | java.lang.String | Namnet på den anpassade egenskapen att hämta |
| value | java.lang.String[] | Anslaget för egenskapens värde |
...
| --- | --- | --- |
| name | java.lang.String | Namnet på den anpassade egenskapen att hämta |
| value | float[] | Anslaget för egenskapens värde |
### getCustomPropertyValue(String name, double[] value) {#getCustomPropertyValue-java.lang.String-double---}
```
public final void getCustomPropertyValue(String name, double[] value)
```

Hämtar ett namngett dubbeltalvärde från de anpassade egenskaperna.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| name | java.lang.String | Namnet på den anpassade egenskapen att hämta. |
| value | double[] | Anslaget för egenskapens värde |
### setCustomPropertyValue(String name, boolean value) {#setCustomPropertyValue-java.lang.String-boolean-}
```
public final void setCustomPropertyValue(String name, boolean value)
```

Anger en namngett boolesk anpassad egenskap.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| name | java.lang.String | Namnet på den anpassade egenskapen att ange |
| value | boolean | Värdet för egenskapen |
### setCustomPropertyValue(String name, int value) {#setCustomPropertyValue-java.lang.String-int-}
```
public final void setCustomPropertyValue(String name, int value)
```

Anger en namngett heltals-anpassad egenskap.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| name | java.lang.String | Namnet på den anpassade egenskapen att ange |
| value | int | Värdet för egenskapen |
### setCustomPropertyValue(String name, Date value) {#setCustomPropertyValue-java.lang.String-java.util.Date-}
```
public final void setCustomPropertyValue(String name, Date value)
```

Anger en namngett DateTime-anpassad egenskap.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| name | java.lang.String | Namnet på den anpassade egenskapen att ange |
| value | java.util.Date | Värdet för egenskapen |
### setCustomPropertyValue(String name, String value) {#setCustomPropertyValue-java.lang.String-java.lang.String-}
```
public final void setCustomPropertyValue(String name, String value)
```

Anger en namngett sträng-anpassad egenskap.
...
Anger en namngett flyttals-anpassad egenskap.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| name | java.lang.String | Namnet på den anpassade egenskapen att ange |
| value | float | Värdet för egenskapen |
### setCustomPropertyValue(String name, double value) {#setCustomPropertyValue-java.lang.String-double-}
```
public final void setCustomPropertyValue(String name, double value)
```

Anger en namngett dubbeltals-anpassad egenskap.

**Parametrar:**
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| name | java.lang.String | Namnet på den anpassade egenskapen att ange |
| value | double | Värdet för egenskapen |
...
>          // Här kan du lägga till en kontroll för etikettinformationens giltighet (etiketten är tillgänglig osv)
...
Indikerar visningsläget för dokumentets miniatyrbild. Sätt detta element till **true** för att möjliggöra skalning av miniatyrbilden till skärmen. Sätt detta element till **false** för att möjliggöra beskärning av miniatyrbilden så att endast sektioner som passar skärmen visas. Läs/skriv boolean.
...
Indikerar om hyperlänkar i ett dokument är aktuella. Sätt detta element till **true** för att ange att hyperlänkar är uppdaterade. Sätt detta element till **false** för att ange att hyperlänkar är föråldrade. Läs/skriv boolean.
...
```
Anger om hyperlänkar i ett dokument är aktuella. Sätt detta element till **true** för att ange att hyperlänkar är uppdaterade. Sätt detta element till **false** för att ange att hyperlänkar är föråldrade. Läs/skriv boolean.
...
Anger att en eller flera hyperlänkar i den här delen uppdaterades uteslutande i den här delen av en producent. Nästa producent som öppnar detta dokument ska uppdatera hyperlänksrelationerna med de nya hyperlänkar som specificerats i den här delen. Läs/skriv boolean.
...
Returnerar det totala antalet bildspel i ett presentationsdokument. Skrivskyddad int.
...
Returnerar antalet dolda bildspel i ett presentationsdokument. Skrivskyddad int.
...
Returnerar antalet bildspel i en presentation som innehåller anteckningar. Skrivskyddad int.
...
Returnerar det totala antalet stycken som hittats i ett dokument om tillämpligt. Skrivskyddad int.
...
Returnerar det totala antalet ord som finns i ett dokument. Skrivskyddad int.
...
Anger grupperingen av dokumentdelar och antalet delar i varje grupp. Skrivskyddad IHeadingPair[].
...
**Returnerar:**
[IDocumentProperties](../../com.aspose.slides/idocumentproperties) - Klon