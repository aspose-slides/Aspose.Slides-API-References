...
| [get_Item(int index)](#get-Item-int-) | Returnerar eller sätter operationen på det angivna indexet. |
| [set_Item(int index, IColorOperation value)](#set-Item-int-com.aspose.slides.IColorOperation-) | Returnerar eller sätter operationen på det angivna indexet. |
...
| [deepClone()](#deepClone--) | Skapar en kopia av en ColorOperationCollection collection. |
...
Returnerar eller sätter operationen på det angivna indexet. Läs/skriv [ColorOperation](../../com.aspose.slides/coloroperation).
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| index | int | Index för färgoperationen som ska tas bort. |
...
Skapar en kopia av en ColorOperationCollection collection.

**Returnerar:**
java.lang.Object - Ny [ColorOperationCollection](../../com.aspose.slides/coloroperationcollection) collection.
### cloneT() {#cloneT--}
```
