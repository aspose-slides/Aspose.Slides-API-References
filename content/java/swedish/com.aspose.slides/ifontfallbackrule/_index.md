...
Representerar fontfallback-regel
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [addFallBackFonts(String fontName)](#addFallBackFonts-java.lang.String-) | Lägger till nya teckensnitt i listan med FallBack-teckensnitt. |
...
| [getCount()](#getCount--) | Hämtar antalet teckensnitt som faktiskt är definierade för intervallet. |
...
>  //Lägg till ett tredje och ett fjärde teckensnitt till regeln 
...
| --- | --- | --- |
| fontName | java.lang.String | Teckensnittets namn eller namn (avgränsade med komma) för FallBack |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| fontNames | java.lang.String[] | Teckensnittets namn eller namn (avgränsade med komma) för FallBack |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| fontName | java.lang.String | Teckensnittets namn att hitta. |

**Returnerar:**
int - Index för ett teckensnitt eller -1 om teckensnittet inte hittas i listan.