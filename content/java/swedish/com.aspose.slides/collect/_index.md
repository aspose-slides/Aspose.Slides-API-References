...
Representerar en grupp metoder avsedda att samla modellobjekt av olika typer från [Presentation](../../com.aspose.slides/presentation).
...
>      {
>          // ... ändra formatering av shape eller andra egenskaper
>      }
>  } finally {
...
>      for (IShape shape : Collect.shapes(pres))
>      {
>          // om shape är AutoShape, lägg till en svart solid kant
