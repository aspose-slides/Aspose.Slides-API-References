...
Representerar ett sträng- eller dubbelvärde som kan lagras i pptx-presentationdokument på två sätt: 1) i cell/celler i arbetsbok relaterad till diagram; 2) som ett bokstavligt värde.
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [getAsCell()](#getAsCell--) | Returnerar eller anger diagramdatas cell. |
| [setAsCell(IChartDataCell value)](#setAsCell-com.aspose.slides.IChartDataCell-) | Returnerar eller anger diagramdatas cell. |
...
Returnerar eller anger diagramdatas cell. Läs/skriv [IChartDataCell](../../com.aspose.slides/ichartdatacell).
...
Returnerar eller anger värde som bokstavlig dubbel. Läs/skriv double.
