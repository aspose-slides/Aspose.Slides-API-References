...
description: Denna struktur representerar informationen om teckensnittsbytet när den kommer att renderas.
type: docs
...
Denna struktur representerar informationen om teckensnittsbytet när den kommer att renderas.
...
| [getSubstitutedFontName()](#getSubstitutedFontName--) | Anger ersättningsteckensnittets namn för originalteckensnittet. |
...
| substFontName | java.lang.String | Ersättningsteckensnittets namn för originalteckensnittet String |
...
Anger ersättningsteckensnittets namn för originalteckensnittet. Skrivskyddad String
