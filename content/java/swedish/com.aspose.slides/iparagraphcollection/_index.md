...
| [add(IParagraphCollection value)](#add-com.aspose.slides.IParagraphCollection-) | Lägger till innehållet i ParagraphCollection i slutet av samlingen. |
...
| [insert(int index, IParagraphCollection value)](#insert-int-com.aspose.slides.IParagraphCollection-) | Infogar innehållet i ParagraphCollection i samlingen på det angivna indexet. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| value | [IParagraph](../../com.aspose.slides/iparagraph) | Det Paragraph som ska läggas till i slutet av samlingen. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| value | [IParagraphCollection](../../com.aspose.slides/iparagraphcollection) | Den ParagraphCollection som ska läggas till i slutet av samlingen. |
...
| value | [IParagraphCollection](../../com.aspose.slides/iparagraphcollection) | De stycken som ska infogas. |
...
**Returnerar:**
boolean - sant om objektet togs bort framgångsrikt; annars falskt.
### addFromHtml(String text) {#addFromHtml-java.lang.String-}
```
public abstract void addFromHtml(String text)
```

Lägger till text från specificerad html-sträng till samlingen.
