...
| Metod | Beskrivning |
| --- | --- |
| [getDataSourceType()](#getDataSourceType--) | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktuell. |
| [setDataSourceType(int value)](#setDataSourceType-int-) | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktuell. |
