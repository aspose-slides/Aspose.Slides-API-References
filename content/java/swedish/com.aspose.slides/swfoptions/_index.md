...
| [getLogoImageBytes()](#getLogoImageBytes--) | Bild som kommer att visas som logotyp i det övre högra hörnet av visaren. |
| [setLogoImageBytes(byte[] value)](#setLogoImageBytes-byte---) | Bild som kommer att visas som logotyp i det övre högra hörnet av visaren. |
| [getLogoLink()](#getLogoLink--) | Hämtar eller anger den fullständiga hyperlänksadressen för en logotyp. |
| [setLogoLink(String value)](#setLogoLink-java.lang.String-) | Hämtar eller anger den fullständiga hyperlänksadressen för en logotyp. |
...
| [getSlidesLayoutOptions()](#getSlidesLayoutOptions--) | Hämtar eller anger läget i vilket bilder placeras på sidan när en presentation [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions). |
| [setSlidesLayoutOptions(ISlidesLayoutOptions value)](#setSlidesLayoutOptions-com.aspose.slides.ISlidesLayoutOptions-) | Hämtar eller anger läget i vilket bilder placeras på sidan när en presentation [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions). |
...
Anger om det genererade dokumentet ska inkludera dolda bilder eller inte. Standardvärdet är falskt.
...
Anger om det genererade SWF-dokumentet ska komprimeras eller inte. Standardvärdet är sant.
...
Anger om det genererade SWF-dokumentet ska inkludera den integrerade dokumentvisaren eller inte. Standardvärdet är sant.
...
Anger om kantlinjen runt sidor ska visas. Standardvärdet är sant.
...
Visa/dölj helskärmsknapp. Kan åsidosättas i flashvars. Standardvärdet är sant.
...
Visa/dölj sidstegare. Kan åsidosättas i flashvars. Standardvärdet är sant.
...
Visa/dölj söksektion. Kan åsidosättas i flashvars. Standardvärdet är sant.
...
Visa/dölj hela övre panelen. Kan åsidosättas i flashvars. Standardvärdet är sant.
...
Visa/dölj nedre panelen. Kan åsidosättas i flashvars. Standardvärdet är sant.
...
Visa/dölj vänsterpanel. Kan åsidosättas i flashvars. Standardvärdet är sant.
...
Starta med öppnad vänsterpanel. Kan åsidosättas i flashvars. Standardvärdet är falskt.
...
Aktivera/inaktivera snabbmenyn. Standardvärdet är sant.
...
Hämtar eller anger den fullständiga hyperlänksadressen för en logotyp. Har endast effekt om en (\#getLogoImageBytes.getLogoImageBytes/\#setLogoImageBytes(byte[]).setLogoImageBytes(byte[])) anges.
...
Hämtar eller anger läget i vilket bilder placeras på sidan när en presentation [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions). Denna egenskap stöder inte tilldelning av objekt av typ [HandoutLayoutingOptions](../../com.aspose.slides/handoutlayoutingoptions)
