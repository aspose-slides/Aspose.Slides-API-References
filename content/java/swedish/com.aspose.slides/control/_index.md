...
| [getName()](#getName--) | Hämtar eller anger namnet på den här kontrollen. |
| [setName(String value)](#setName-java.lang.String-) | Hämtar eller anger namnet på den här kontrollen. |
| [getClassId()](#getClassId--) | Hämtar klass-id för den här kontrollen. |
| [setClassId(UUID value)](#setClassId-java.util.UUID-) | Hämtar klass-id för den här kontrollen. |
| [getSubstitutePictureFormat()](#getSubstitutePictureFormat--) | Returnerar objektet för kontrollens bildfyllnings-egenskaper. |
...
| [getActiveXControlBinary()](#getActiveXControlBinary--) | Anger beständigheten för en ActiveX-kontroll när metoden som används för beständighet är antingen PersistStream, PersistStreamInit eller PersistStorage. |
| [getSlide()](#getSlide--) |  |
...
Returnerar objektet för kontrollens bildfyllnings-egenskaper. Endast läsning [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
Obs! Aspose.Slides stöder endast XML-baserade ActiveX-egenskaper. Om egenskaper lagras i binärt format kommer denna egenskap att returnera null.
...
Anger beständigheten för en ActiveX-kontroll när metoden som används för beständighet är antingen PersistStream, PersistStreamInit eller PersistStorage.
...
Returnerar grund-bilden. Endast läsning [IBaseSlide](../../com.aspose.slides/ibaseslide).
