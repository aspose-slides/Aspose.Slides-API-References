...
description: Representerar en samling med textanimationer.
type: docs
...
Representerar en samling med textanimationer.
## Konstruktorer
...
| [get_Item(int index)](#get-Item-int-) | Returnerar elementet på angivet index. |
...
| [getSyncRoot()](#getSyncRoot--) | Returnerar ett synkroniseringsroten. |
### TextAnimationCollection() {#TextAnimationCollection--}
```
...
Returnerar elementet på angivet index.
...
Returnerar ett synkroniseringsroten. Skrivskyddad Object.
