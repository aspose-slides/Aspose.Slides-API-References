...
Konverterar legacy-diagram till redigerbart SmartArt-objekt. Det skapade SmartArt-objektet läggs till i föräldragruppens form på samma position.
...
Konverterar legacy-diagram till redigerbar gruppform. Det skapade GroupShape-objektet läggs till i föräldragruppens form på samma position.
