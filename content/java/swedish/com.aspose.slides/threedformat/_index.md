...
| [getBevelTop()](#getBevelTop--) | Returnerar eller anger typen på en övre 3D-fasning. |
| [getBevelBottom()](#getBevelBottom--) | Returnerar eller anger typen på en nedre 3D-fasning. |
...
| [getLightRig()](#getLightRig--) | Returnerar eller anger typen på ett ljus. |
| [getMaterial()](#getMaterial--) | Returnerar eller anger typen på ett material. |
| [setMaterial(int value)](#setMaterial-int-) | Returnerar eller anger typen på ett material. |
...
Returnerar eller anger typen på en övre 3D-fasning. Endast läsning [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Returnerar eller anger typen på en nedre 3D-fasning. Endast läsning [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Returnerar eller anger färgen på en kontur. Endast läsning [IColorFormat](../../com.aspose.slides/icolorformat).
...
Returnerar eller anger färgen på en extrudering. Endast läsning [IColorFormat](../../com.aspose.slides/icolorformat).
...
Returnerar eller anger inställningarna för en kamera. Endast läsning [ICamera](../../com.aspose.slides/icamera).
...
Returnerar eller anger typen på ett ljus. Endast läsning [ILightRig](../../com.aspose.slides/ilightrig).
...
Returnerar eller anger typen på ett material. Läs/skriv [MaterialPresetType](../../com.aspose.slides/materialpresettype).
