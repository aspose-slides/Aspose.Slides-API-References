...
| [getCell(int worksheetIndex, String cellName)](#getCell-int-java.lang.String-) | Hämtar en cell från det angivna kalkylbladet med dess index och Excel-stilens cellnamn (t.ex. "B2"). |
| [getCell(String worksheetName, String cellName)](#getCell-java.lang.String-java.lang.String-) | Hämtar en cell från det angivna kalkylbladet med Excel-stilens cellnamn (t.ex. "B2"). |
...
| --- | --- | --- |
| filePath | java.lang.String | Den fullständiga sökvägen till Excel-arbetsboksfilen. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| stream | java.io.InputStream | En ström som innehåller Excel-arbetsboksdata. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| formula | java.lang.String | En formel eller områdeuttryck (t.ex. "Sheet1!A1:B3") som används för att identifiera målcellena. |
| skipHiddenCells | boolean | Om true, exkluderas dolda celler (t.ex. i dolda rader eller kolumner) från resultatet. |
...
Hämtar en cell från det angivna kalkylbladet med dess index och Excel-stilens cellnamn (t.ex. "B2").
...
| --- | --- | --- |
| worksheetIndex | int | Nollbaserat index för kalkylbladet. |
| cellName | java.lang.String | Excel-stilens cellreferens (t.ex. "A1", "C5"). |
...
Hämtar en cell från det angivna kalkylbladet med Excel-stilens cellnamn (t.ex. "B2").
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| worksheetName | java.lang.String | Namnet på kalkylbladet där diagram ska sökas. |
