...
| Metod | Beskrivning |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Returnerar layout-bilden efter index. |
...
| [removeUnused()](#removeUnused--) | Tar bort oanvända layout-bilder (layout-bilder vars HasHavingSlides är falskt). |
...
Returnerar layout-bilden efter index. Skrivskyddad [ILayoutSlide](../../com.aspose.slides/ilayoutslide).
...
Tar bort oanvända layout-bilder (layout-bilder vars HasDependingSlides är falskt).