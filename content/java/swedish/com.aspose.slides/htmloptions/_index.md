...
description: Representerar HTML-exportalternativ.
type: docs
...
| --- | --- |
| [HtmlOptions(ILinkEmbedController linkEmbedController)](#HtmlOptions-com.aspose.slides.ILinkEmbedController-) | Skapar ett nytt HtmlOptions-objekt som specificerar återanrop. |
...
| [getSlideImageFormat()](#getSlideImageFormat--) | Returnerar eller anger alternativ för bildformat på bildspel. |
| [setSlideImageFormat(ISlideImageFormat value)](#setSlideImageFormat-com.aspose.slides.ISlideImageFormat-) | Returnerar eller anger alternativ för bildformat på bildspel. |
...
Hämtar eller anger ett värde som indikerar om text renderas utan ligaturer. När satt till sant, kommer ligaturer att inaktiveras i den renderade utdata. Som standard är detta egenskap satt till falskt.
...
Returnerar eller anger alternativ för bildformat på bildspel. Läs/skriv [ISlideImageFormat](../../com.aspose.slides/islideimageformat).
...
En boolesk flagga indikerar om de beskurna delarna förblir som en del av dokumentet. Om sant kommer de beskurna delarna att tas bort, om falskt kommer de att serialiseras i dokumentet (vilket kan leda till en större fil)
