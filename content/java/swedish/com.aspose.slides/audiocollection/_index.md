...
| [addAudio(InputStream stream)](#addAudio-java.io.InputStream-) | Skapar och lägger till ett ljud i en presentation från ett flöde. |
| [addAudio(InputStream stream, int loadingStreamBehavior)](#addAudio-java.io.InputStream-int-) | Skapar och lägger till ett ljud i en presentation från ett flöde. |
| [addAudio(byte[] audioData)](#addAudio-byte---) | Skapar och lägger till ett ljud i en presentation från en byte-array. |
| [copyTo(System.Array array, int index)](#copyTo-com.aspose.ms.System.Array-int-) | Kopierar ljud till angiven array med start från angivet index. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| audio | [IAudio](../../com.aspose.slides/iaudio) | Källljud. |
...
Skapar och lägger till ett ljud i en presentation från ett flöde.

**Parametrar:**
| Parameter | Type | Description |
| --- | --- | --- |
| stream | java.io.InputStream | Flöde att lägga till ljud från. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| stream | java.io.InputStream | Flöde att lägga till video-ljud från. |
| loadingStreamBehavior | int | Beteendet som kommer att tillämpas på flödet. |
...
Kopierar ljud till angiven array med start från angivet index.
