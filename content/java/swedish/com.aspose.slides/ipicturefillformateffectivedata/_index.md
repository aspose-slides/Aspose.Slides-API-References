...
| [getCropLeft()](#getCropLeft--) | Returnerar antalet procent av den faktiska bildbredden som beskärs bort från bildens vänstra sida. |
| [getCropTop()](#getCropTop--) | Returnerar antalet procent av den faktiska bildhöjden som beskärs bort från bildens övre sida. |
| [getCropRight()](#getCropRight--) | Returnerar antalet procent av den faktiska bildbredden som beskärs bort från bildens högra sida. |
| [getCropBottom()](#getCropBottom--) | Returnerar antalet procent av den faktiska bildhöjden som beskärs bort från bildens nedre sida. |
### getDpi() {#getDpi--}
```
...
Returnerar antalet procent av den faktiska bildbredden som beskärs bort från bildens vänstra sida. Skrivskyddad float.
...
Returnerar antalet procent av den faktiska bildhöjden som beskärs bort från bildens övre sida. Skrivskyddad float.
...
Returnerar antalet procent av den faktiska bildbredden som beskärs bort från bildens högra sida. Skrivskyddad float.
...
Returnerar antalet procent av den faktiska bildhöjden som beskärs bort från bildens nedre sida. Skrivskyddad float.
