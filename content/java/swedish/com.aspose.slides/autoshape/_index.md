...
| Metod | Beskrivning |
| --- | --- |
| [getShapeLock()](#getShapeLock--) | Returnerar figurens lås. |
...
| [getUseBackgroundFill()](#getUseBackgroundFill--) | Bestämmer om denna autoshape ska fyllas med slide's background fill istället för den som anges av style eller fill format. |
| [setUseBackgroundFill(boolean value)](#setUseBackgroundFill-boolean-) | Bestämmer om denna autoshape ska fyllas med slide's background fill istället för den som anges av style eller fill format. |
| [addTextFrame(String text)](#addTextFrame-java.lang.String-) | Lägger till en ny TextFrame till en figur. |
| [isTextBox()](#isTextBox--) | Anger om figuren är en textruta. |
### getShapeLock() {#getShapeLock--}
```
public final IAutoShapeLock getShapeLock()
```

Returnerar figurens lås. Endast läs [IAutoShapeLock](../../com.aspose.slides/iautoshapelock).
...
Returnerar autoshapens lås. Endast läs [IAutoShapeLock](../../com.aspose.slides/iautoshapelock).
...
Returnerar TextFrame-objekt för AutoShape. Endast läs [ITextFrame](../../com.aspose.slides/itextframe).
...
Bestämmer om denna autoshape ska fyllas med slide's background fill istället för den som anges av style eller fill format. Läs/skriv boolean.
...
Lägger till en ny TextFrame till en figur. Om figuren redan har en TextFrame ändras bara dess text.
...
Anger om figuren är en textruta.

--------------------

Om en figur inte är specificerad som en textruta betyder det inte att den inte kan ha text kopplad till sig. En textruta är bara en specialiserad figur med specifika egenskaper.
