...
| [getProgressCallback()](#getProgressCallback--) | Representerar ett återuppringningsobjekt för sparande av framstegsuppdateringar i procent. |
| [setProgressCallback(IProgressCallback value)](#setProgressCallback-com.aspose.slides.IProgressCallback-) | Representerar ett återuppringningsobjekt för sparande av framstegsuppdateringar i procent. |
| [getDefaultRegularFont()](#getDefaultRegularFont--) | Returnerar eller anger teckensnitt som används om källeteckensnittet inte hittas. |
| [setDefaultRegularFont(String value)](#setDefaultRegularFont-java.lang.String-) | Returnerar eller anger teckensnitt som används om källeteckensnittet inte hittas. |
...
Returnerar eller anger ett objekt som tar emot varningar och bestämmer om laddningsprocessen ska fortsätta eller avbrytas. Läsa/skriva [IWarningCallback](../../com.aspose.slides/iwarningcallback).
...
Representerar ett återuppringningsobjekt för sparande av framstegsuppdateringar i procent. Se [IProgressCallback](../../com.aspose.slides/iprogresscallback).
...
Returnerar eller anger teckensnitt som används om källeteckensnittet inte hittas. Läsa-skriva String.
...
Returnerar eller anger den visuella stilen för gradienten. Läsa/skriva [GradientStyle](../../com.aspose.slides/gradientstyle).
...
Anger om hyperlänkar med JavaScript-anrop ska hoppas över när presentationen sparas. Läsa/skriva boolean. Standardvärdet är false.
...
När denna egenskap är satt till false sparas alla hyperlänkar.
