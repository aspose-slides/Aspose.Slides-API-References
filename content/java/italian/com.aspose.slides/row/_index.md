...
| [setTextFormat(IPortionFormat source)](#setTextFormat-com.aspose.slides.IPortionFormat-) | Imposta le proprietà del formato di porzione definite a tutte le porzioni delle celle della riga. |
| [setTextFormat(IParagraphFormat source)](#setTextFormat-com.aspose.slides.IParagraphFormat-) | Imposta le proprietà del formato di paragrafo definite a tutti i paragrafi delle celle della riga. |
| [setTextFormat(ITextFrameFormat source)](#setTextFormat-com.aspose.slides.ITextFrameFormat-) | Imposta le proprietà del formato di cornice di testo definite a tutte le cornici di testo delle celle della riga. |
...
Imposta le proprietà del formato di porzione definite a tutte le porzioni delle celle della riga.
...
Imposta le proprietà del formato di paragrafo definite a tutti i paragrafi delle celle della riga.
...
Imposta le proprietà del formato di cornice di testo definite a tutte le cornici di testo delle celle della riga.
