...
Restituisce un tipo MIME di un audio, codificato in (\#getBinaryData.getBinaryData). Sola lettura String.
...
Restituisce una copia dei dati di un audio. Nel caso di una grande quantità di dati, considerare l'uso del metodo \#getStream.getStream per evitare il caricamento non necessario dei dati audio in memoria o addirittura un OutOfMemoryException. Sola lettura byte[].
