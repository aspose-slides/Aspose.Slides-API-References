...
Questa classe è utilizzata per restituire e manipolare le proprietà di formattazione della porzione di testo definite per la porzione specifica. Ciò significa che non viene applicata alcuna eredità quando si ottengono i valori, quindi nella maggior parte dei casi si otterranno valori che significano "non definito".

Per ottenere i valori dei parametri di formattazione effettivi, inclusi quelli ereditati, è necessario utilizzare il metodo [IPortionFormat.getEffective](../../com.aspose.slides/iportionformat\#getEffective) che restituisce un'istanza [IPortionFormatEffectiveData](../../com.aspose.slides/iportionformateffectivedata).
...
| [getFontItalic()](#getFontItalic--) | Determina se il carattere è corsivo. |
| [setFontItalic(byte value)](#setFontItalic-byte-) | Determina se il carattere è corsivo. |
| [getKumimoji()](#getKumimoji--) | Determina se i numeri devono ignorare il layout verticale del testo specifico per le lingue dell'Est. |
| [setKumimoji(byte value)](#setKumimoji-byte-) | Determina se i numeri devono ignorare il layout verticale del testo specifico per le lingue dell'Est. |
...
| [getLatinFont()](#getLatinFont--) | Restituisce o imposta le informazioni del carattere Latin. |
| [setLatinFont(IFontData value)](#setLatinFont-com.aspose.slides.IFontData-) | Restituisce o imposta le informazioni del carattere Latin. |
| [getEastAsianFont()](#getEastAsianFont--) | Restituisce o imposta le informazioni del carattere East Asian. |
| [setEastAsianFont(IFontData value)](#setEastAsianFont-com.aspose.slides.IFontData-) | Restituisce o imposta le informazioni del carattere East Asian. |
| [getComplexScriptFont()](#getComplexScriptFont--) | Restituisce o imposta le informazioni del carattere per script complesso. |
| [setComplexScriptFont(IFontData value)](#setComplexScriptFont-com.aspose.slides.IFontData-) | Restituisce o imposta le informazioni del carattere per script complesso. |
| [getSymbolFont()](#getSymbolFont--) | Restituisce o imposta le informazioni del carattere simbolico. |
| [setSymbolFont(IFontData value)](#setSymbolFont-com.aspose.slides.IFontData-) | Restituisce o imposta le informazioni del carattere simbolico. |
...
| [getKerningMinimalSize()](#getKerningMinimalSize--) | Restituisce o imposta la dimensione minima del carattere per cui il kerning deve essere attivato. |
| [setKerningMinimalSize(float value)](#setKerningMinimalSize-float-) | Restituisce o imposta la dimensione minima del carattere per cui il kerning deve essere attivato. |
...
Restituisce le proprietà LineFormat usate per delineare la linea di sottolineatura. Nessuna eredità applicata. Solo lettura [ILineFormat](../../com.aspose.slides/ilineformat).
...
Determina se il carattere è in grassetto. Nessuna eredità applicata. Lettura/scrittura [NullableBool](../../com.aspose.slides/nullablebool).
...
Determina se il carattere è corsivo. Nessuna eredità applicata. Lettura/scrittura [NullableBool](../../com.aspose.slides/nullablebool).
...
Determina se i numeri devono ignorare il layout verticale del testo specifico per le lingue dell'Est. Nessuna eredità applicata. Lettura/scrittura [NullableBool](../../com.aspose.slides/nullablebool).
...
Restituisce o imposta l'altezza del carattere di una porzione. **Float.NaN** significa che l'altezza è indefinita e deve essere ereditata dal Master. Lettura/scrittura float.
...
Restituisce o imposta le informazioni del carattere Latin. Null significa che il carattere è indefinito e deve essere ereditato dal Master. Lettura/scrittura [IFontData](../../com.aspose.slides/ifontdata).
...
Restituisce o imposta le informazioni del carattere East Asian. Null significa che il carattere è indefinito e deve essere ereditato dal Master. Lettura/scrittura [IFontData](../../com.aspose.slides/ifontdata).
...
Restituisce o imposta le informazioni del carattere per script complesso. Null significa che il carattere è indefinito e deve essere ereditato dal Master. Lettura/scrittura [IFontData](../../com.aspose.slides/ifontdata).
...
Restituisce o imposta le informazioni del carattere simbolico. Null significa che il carattere è indefinito e deve essere ereditato dal Master. Lettura/scrittura [IFontData](../../com.aspose.slides/ifontdata).
...
Restituisce o imposta il testo in apice o pedice. Valore da -100% (pedice) a 100% (apice). **Float.NaN** significa che il valore è indefinito e deve essere ereditato dal Master. Lettura/scrittura float.
...
Restituisce o imposta la dimensione minima del carattere per cui il kerning deve essere attivato. **Float.NaN** significa che il valore è indefinito e deve essere ereditato dal Master. Lettura/scrittura float.
...
Restituisce o imposta l'incremento di spaziatura intercarattere. **Float.NaN** significa che il valore è indefinito e deve essere ereditato dal Master. Lettura/scrittura float.
