...
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | Unisce gli intervalli con la stessa formattazione in tutti i paragrafi di tutte le forme accettabili. |
| [equals(IBaseSlide slide)](#equals-com.aspose.slides.IBaseSlide-) | Determina se le due istanze IBaseSlide sono uguali. |
### getShapes() {#getShapes--}
```
...
Unisce gli intervalli con la stessa formattazione in tutti i paragrafi di tutte le forme accettabili.
