...
Restituisce i blocchi della forma. Sola lettura [IAutoShapeLock](../../com.aspose.slides/iautoshapelock).
...
Restituisce i blocchi dell'autoshape. Sola lettura [IAutoShapeLock](../../com.aspose.slides/iautoshapelock).
...
Restituisce l'oggetto TextFrame per l'AutoShape. Sola lettura [ITextFrame](../../com.aspose.slides/itextframe).
...
Determina se questo autoshape deve essere riempito con il riempimento di sfondo della diapositiva invece di quello specificato dallo stile o dal formato di riempimento. Booleano lettura/scrittura.
...
Aggiunge un nuovo TextFrame a una forma. Se la forma ha già un TextFrame, allora semplicemente ne modifica il testo.
...
>      // Specificare il numero di colonne nel TextFrame
>      format.setColumnCount(3);
>      // Specificare lo spazio tra le colonne
...
Se la forma non è specificata come casella di testo non significa che non possa avere del testo allegato. Una casella di testo è semplicemente una forma specializzata con proprietà specifiche.
