...
| Metodo | Descrizione |
| --- | --- |
| [getPreferredCulture()](#getPreferredCulture--) | Ottiene o imposta le informazioni sulla cultura preferita per il calcolo di alcune funzioni destinate all'uso con lingue che utilizzano il set di caratteri a doppio byte (DBCS). |
| [setPreferredCulture(Locale value)](#setPreferredCulture-java.util.Locale-) | Ottiene o imposta le informazioni sulla cultura preferita per il calcolo di alcune funzioni destinate all'uso con lingue che utilizzano il set di caratteri a doppio byte (DBCS). |
