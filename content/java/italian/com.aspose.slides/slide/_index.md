...
| [getShowMasterShapes()](#getShowMasterShapes--) | Specifica se le forme sulla diapositiva master devono essere visualizzate sulle diapositive o no. |
| [setShowMasterShapes(boolean value)](#setShowMasterShapes-boolean-) | Specifica se le forme sulla diapositiva master devono essere visualizzate sulle diapositive o no. |
| [getImage(float scaleX, float scaleY)](#getImage-float-float-) | Restituisce un oggetto Thumbnail Image con ridimensionamento personalizzato. |
| [getImage()](#getImage--) | Restituisce un oggetto Thumbnail Image (20 % della dimensione reale). |
| [getImage(Dimension imageSize)](#getImage-java.awt.Dimension-) | Restituisce un oggetto Thumbnail Image con dimensione specificata. |
| [getImage(ITiffOptions options)](#getImage-com.aspose.slides.ITiffOptions-) | Restituisce un oggetto thumbnail tiff con parametri specificati. |
| [getImage(IRenderingOptions options)](#getImage-com.aspose.slides.IRenderingOptions-) | Restituisce un oggetto Thumbnail Image. |
| [getImage(IRenderingOptions options, float scaleX, float scaleY)](#getImage-com.aspose.slides.IRenderingOptions-float-float-) | Restituisce un oggetto Thumbnail Image con ridimensionamento personalizzato. |
| [getImage(IRenderingOptions options, Dimension imageSize)](#getImage-com.aspose.slides.IRenderingOptions-java.awt.Dimension-) | Restituisce un oggetto Thumbnail Image con dimensione specificata. |
...
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | Unisce le run con la stessa formattazione in tutti i paragrafi in tutte le forme accettabili. |
...
Specifica se le forme sulla diapositiva master devono essere visualizzate sulle diapositive o no. Lettura/scrittura boolean.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| scaleX | float | Il valore di scala per l’asse X di questa miniatura. |
| scaleY | float | Il valore di scala per l’asse Y di questa miniatura. |

**Restituisce:**
[IImage](../../com.aspose.slides/iimage) - oggetto IImage.
### getImage() {#getImage--}
```
...
Restituisce un oggetto thumbnail tiff con parametri specificati.
...
>      // Converte la prima diapositiva della presentazione in un oggetto BufferedImage
...
Unisce le run con la stessa formattazione in tutti i paragrafi in tutte le forme accettabili.