...
| [getNotesText()](#getNotesText--) | Il testo sulle forme della pagina note per questa diapositiva |
...
Il testo sulle forme della pagina note per questa diapositiva
...
Questo campo è vuoto quando il testo è estratto usando la modalità Arranged.
