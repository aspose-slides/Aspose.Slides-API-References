...
Restituisce il numero di immagini nella collezione. Sola lettura  int .
...
Ottiene l'elemento all'indice specificato. Sola lettura [IPPImage](../../com.aspose.slides/ippimage).
