...
Restituisce i dati SVG. Di sola lettura byte[].
...
Restituisce l'interfaccia di callback usata per risolvere risorse esterne durante l'importazione di documenti Svg. Di sola lettura [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver).
...
Restituisce l'URI di base dello Svg specificato. Usato per risolvere collegamenti relativi. Di sola lettura String.
...
Restituisce il contenuto SVG. Di sola lettura String.
