...
description: Classe di base per IMathElement con l'implementazione di alcuni metodi comuni a tutte le classi derivate. Solo per uso interno.
type: docs
...
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | Racchiude un elemento matematico in caratteri specificati, come parentesi o altri caratteri, come cornice |
...
| [setSubscript(IMathElement subscript)](#setSubscript-com.aspose.slides.IMathElement-) | Crea pedice |
| [setSubscript(String subscript)](#setSubscript-java.lang.String-) | Crea pedice |
| [setSuperscript(IMathElement superscript)](#setSuperscript-com.aspose.slides.IMathElement-) | Crea apice |
| [setSuperscript(String superscript)](#setSuperscript-java.lang.String-) | Crea apice |
...
| [radical(IMathElement degree)](#radical-com.aspose.slides.IMathElement-) | Specifica la radice matematica del grado indicato dall'argomento specificato. |
| [radical(String degree)](#radical-java.lang.String-) | Specifica la radice matematica del grado indicato dall'argomento specificato. |
...
| [group(char character, int position, int verticalJustification)](#group-char-int-int-) | Colloca questo elemento in un gruppo usando un carattere di raggruppamento, come una parentesi graffa inferiore o altro |
| [toBorderBox()](#toBorderBox--) | Colloca questo elemento in un riquadro bordato |
| [toBorderBox(boolean hideTop, boolean hideBottom, boolean hideLeft, boolean hideRight, boolean strikethroughHorizontal, boolean strikethroughVertical, boolean strikethroughBottomLeftToTopRight, boolean strikethroughTopLeftToBottomRight)](#toBorderBox-boolean-boolean-boolean-boolean-boolean-boolean-boolean-boolean-) | Colloca questo elemento in un riquadro bordato |
| [toBox()](#toBox--) | Colloca questo elemento in una casella non visiva (raggruppamento logico) usata per raggruppare componenti di un'equazione o altra istanza di testo matematico. |
...
**Restituisce:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - L'elemento matematico di tipo [IMathDelimiter](../../com.aspose.slides/imathdelimiter) che include i caratteri specificati come cornice
...
Colloca questo elemento in un gruppo usando una graffa inferiore
...
Colloca questo elemento in un gruppo usando un carattere di raggruppamento come la graffa inferiore o un altro
...
| verticalJustification | int | Giustificazione verticale del carattere di gruppo. Specifica l'allineamento dell'oggetto rispetto alla linea base. Ad esempio, quando il carattere di gruppo è sopra l'oggetto, VerticalJustification di Top indica che la parte superiore dell'oggetto cade sulla linea base; quando VerticalJustification è impostato a Bottom, la parte inferiore dell'oggetto è sulla linea base |
...
Colloca questo elemento in una border-box
...
**Restituisce:**
[IMathBorderBox](../../com.aspose.slides/imathborderbox) - Border-box con questo elemento inserito all'interno
...
| strikethroughHorizontal | boolean | Barrato orizzontale della Border Box |
| strikethroughVertical | boolean | Barrato verticale della Border Box |
| strikethroughBottomLeftToTopRight | boolean | Barrato della Border Box da basso-sinistra a alto-destra |
| strikethroughTopLeftToBottomRight | boolean | Barrato della Border Box da alto-sinistra a basso-destra |
...
Colloca questo elemento in una scatola non visiva (raggruppamento logico) utilizzata per raggruppare componenti di un'equazione o di un altro blocco di testo matematico. Un oggetto racchiuso può (per esempio) fungere da emulatore di operatore con o senza punto di allineamento, fungere da punto di interruzione di riga, oppure essere raggruppato in modo tale da non consentire interruzioni di riga all'interno.
