...
| [size()](#size--) | Restituisce il numero di gradient stop nella collezione. |
| [get_Item(int index)](#get-Item-int-) | Restituisce il gradient stop per indice. |
| [add(float position, Color color)](#add-float-java.awt.Color-) | Crea un nuovo gradient stop e lo aggiunge alla fine della collezione. |
...
| [insert(int index, float position, Color color)](#insert-int-float-java.awt.Color-) | Crea un nuovo gradient stop e lo inserisce all'indice specificato nella collezione. |
...
| [clear()](#clear--) | Rimuove tutti i gradient stop dalla collezione. |
...
Restituisce il numero di gradient stop nella collezione. Solo lettura int .
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| index | int | Indice nella collezione dove verrà inserito il nuovo gradient stop. |
| position | float | Posizione del nuovo gradient stop. |
| color | java.awt.Color | Colore del nuovo gradient stop. |
...
Rimuove tutti i gradient stop dalla collezione.
