...
| [indexOf(IMathBlock mathBlock)](#indexOf-com.aspose.slides.IMathBlock-) | Determina l'indice di un IMathBlock specifico nella collezione. |
...
**Restituisce:**
boolean - true se mathBlock è stato rimosso con successo dalla collezione; altrimenti, false. Questo metodo restituisce false anche se mathBlock non è stato trovato nella collezione originale.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | L'elemento da individuare nella collezione. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| index | int | L'indice (basato su zero) al quale un elemento dovrebbe essere inserito. |
