...
second_title: Aspose.Slides for Java Riferimento API
...
Rappresenta la classe genitore per tutte le forme geometriche.
## Metodi
...
| [getShapeType()](#getShapeType--) | Restituisce o imposta il tipo di preset geometrico. |
| [setShapeType(int value)](#setShapeType-int-) | Restituisce o imposta il tipo di preset geometrico. |
| [getAdjustments()](#getAdjustments--) | Restituisce una raccolta dei valori di regolazione della forma. |
...
Restituisce o imposta il tipo di preset geometrico. Nota: al cambiamento del valore tutti i valori di regolazione verranno ripristinati ai loro valori predefiniti. Lettura/scrittura [ShapeType](../../com.aspose.slides/shapetype).
...
Restituisce una raccolta dei valori di regolazione della forma. Solo lettura [IAdjustValueCollection](../../com.aspose.slides/iadjustvaluecollection).
