...
Restituisce la cella negli indici di colonna e riga specificati. Solo lettura [ICell](../../com.aspose.slides/icell).
...
Determina se la tabella ha ordine di lettura da destra a sinistra. Booleano a lettura-scrittura.
...
Determina se la prima riga di una tabella deve essere disegnata con una formattazione speciale. Booleano a lettura-scrittura.
...
Determina se la prima colonna di una tabella deve essere disegnata con una formattazione speciale. Booleano a lettura-scrittura.
...
Determina se l'ultima riga di una tabella deve essere disegnata con una formattazione speciale. Booleano a lettura-scrittura.
...
Determina se l'ultima colonna di una tabella deve essere disegnata con una formattazione speciale. Booleano a lettura-scrittura.
...
Determina se le righe pari devono essere disegnate con una formattazione diversa. Booleano a lettura-scrittura.
...
Determina se le colonne pari devono essere disegnate con una formattazione diversa. Booleano a lettura-scrittura.
