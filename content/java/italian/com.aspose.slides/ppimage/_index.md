...
| [getImage()](#getImage--) | Restituisce una copia dell'immagine. |
...
Restituisce una copia dei dati dell'immagine. Solo lettura byte[] .
...
Restituisce una copia dell'immagine. Solo lettura [IImage](../../com.aspose.slides/iimage).
...
Sostituisce i dati dell'immagine. Attenzione: quando l'Image è metafile - verrà rasterizzata. Usa ReplaceImage(byte[]) invece
