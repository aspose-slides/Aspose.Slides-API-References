...
| [add(String id, UUID siteId, boolean isEnabled, int methodType)](#add-java.lang.String-java.util.UUID-boolean-int-) | Aggiunge l'etichetta di sensibilità alla fine della collezione. |
| [add(ISensitivityLabel label)](#add-com.aspose.slides.ISensitivityLabel-) | Aggiunge una SensitivityLabel alla collezione. |
...
| [getCount()](#getCount--) | Ottiene il numero di tutti gli elementi nella collezione. |
...
Restituisce l'etichetta di sensibilità per indice. Solo lettura [ISensitivityLabel](../../com.aspose.slides/isensitivitylabel).
...
Aggiunge l'etichetta di sensibilità alla fine della collezione.
...
Aggiunge una SensitivityLabel alla collezione.

**Parametri:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| label | [ISensitivityLabel](../../com.aspose.slides/isensitivitylabel) | L'oggetto SensitivityLabel da aggiungere alla fine della collezione. |
...
Ottiene il numero di tutti gli elementi nella collezione. Solo lettura  int .
