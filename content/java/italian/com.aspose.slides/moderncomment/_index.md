...
| [getTextSelectionStart()](#getTextSelectionStart--) | Ottiene o imposta la posizione iniziale della selezione di testo nella cornice di testo se il commento è associato a AutoShape. |
| [setTextSelectionStart(int value)](#setTextSelectionStart-int-) | Ottiene o imposta la posizione iniziale della selezione di testo nella cornice di testo se il commento è associato a AutoShape. |
| [getTextSelectionLength()](#getTextSelectionLength--) | Ottiene o imposta la lunghezza della selezione di testo nella cornice di testo se il commento è associato a AutoShape. |
| [setTextSelectionLength(int value)](#setTextSelectionLength-int-) | Ottiene o imposta la lunghezza della selezione di testo nella cornice di testo se il commento è associato a AutoShape. |
...
Ottiene o imposta la posizione iniziale della selezione di testo nella cornice di testo se il commento è associato a AutoShape. Lettura/scrittura int.
...
Ottiene o imposta la lunghezza della selezione di testo nella cornice di testo se il commento è associato a AutoShape. Lettura/scrittura int.
