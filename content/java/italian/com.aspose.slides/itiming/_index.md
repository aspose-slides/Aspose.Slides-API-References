...
| Metodo | Descrizione |
| --- | --- |
| [getAccelerate()](#getAccelerate--) | Descrive la percentuale della durata dell'effetto di accelerazione del comportamento. |
| [setAccelerate(float value)](#setAccelerate-float-) | Descrive la percentuale della durata dell'effetto di accelerazione del comportamento. |
| [getDecelerate()](#getDecelerate--) | Descrive la percentuale della durata dell'effetto di decelerazione del comportamento. |
| [setDecelerate(float value)](#setDecelerate-float-) | Descrive la percentuale della durata dell'effetto di decelerazione del comportamento. |
| [getAutoReverse()](#getAutoReverse--) | Descrive se riprodurre automaticamente l'animazione al contrario dopo averla riprodotta nella direzione in avanti. |
| [setAutoReverse(boolean value)](#setAutoReverse-boolean-) | Descrive se riprodurre automaticamente l'animazione al contrario dopo averla riprodotta nella direzione in avanti. |
...
| [getSpeed()](#getSpeed--) | Specifica la percentuale con cui accelerare (o rallentare) il timing. |
| [setSpeed(float value)](#setSpeed-float-) | Specifica la percentuale con cui accelerare (o rallentare) il timing. |
...
Descrive la percentuale della durata dell'effetto di accelerazione del comportamento. Lettura/scrittura float.
...
Descrive la percentuale della durata dell'effetto di decelerazione del comportamento. Lettura/scrittura float.
...
Descrive se riprodurre automaticamente l'animazione al contrario dopo averla riprodotta nella direzione in avanti. Lettura/scrittura boolean.
...
>      // Modifica il timing/ripetizione dell'effetto in "Until End of Slide"
...
>      // Ottieni il primo effetto della sequenza principale.
>      IEffect effect = effectsSequence.get_Item(0);
>      // Modifica il timing/ripetizione dell'effetto in "Until Next Click"
...
Specifică se un effetto deve riavviarsi al completamento. Lettura/scrittura [EffectRestartType](../../com.aspose.slides/effectrestarttype).
...
Specifică la percentuale con cui accelerare (o rallentare) il timing. Lettura/scrittura float.
