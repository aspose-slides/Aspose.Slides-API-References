...
description: Rappresenta un workbook che fornisce l'accesso ai dati Excel per uso generale.
type: docs
...
| --- | --- |
| [ExcelDataWorkbook(String filePath)](#ExcelDataWorkbook-java.lang.String-) | Inizializza una nuova istanza utilizzando il percorso file specificato. |
| [ExcelDataWorkbook(InputStream stream)](#ExcelDataWorkbook-java.io.InputStream-) | Inizializza una nuova istanza della classe utilizzando lo stream fornito. |
## Metodi
...
| --- | --- | --- |
| filePath | java.lang.String | Il percorso completo al file del workbook Excel. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| stream | java.io.InputStream | Uno stream contenente i dati del workbook Excel. |
...
| skipHiddenCells | boolean | Se vero, le celle nascoste (ad es., in righe o colonne nascoste) saranno escluse dal risultato. |

**Restituisce:**
com.aspose.ms.System.Collections.Generic.List<com.aspose.slides.IExcelDataCell> - Un elenco di sola lettura di celle che corrispondono alla formula specificata.
...
| --- | --- | --- |
| worksheetIndex | int | Indice basato su zero del foglio di lavoro. |
| cellName | java.lang.String | Il riferimento di cella in stile Excel (ad es., "A1", "C5"). |
...
**Restituisce:**
com.aspose.ms.System.Collections.Generic.List<java.lang.String> - Un elenco di nomi di fogli di lavoro