...
description: Specifica l'oggetto Matrix costituito da elementi figli disposti in una o più righe e colonne.
type: docs
...
| [getHidePlaceholders()](#getHidePlaceholders--) | Nasconde i segnaposti per gli elementi vuoti della matrice Predefinito: false |
| [setHidePlaceholders(boolean value)](#setHidePlaceholders-boolean-) | Nasconde i segnaposti per gli elementi vuoti della matrice Predefinito: false |
...
| [getMinColumnWidth()](#getMinColumnWidth--) | Larghezza minima della colonna in twips (1/20th of a point). La spaziatura del gap (anche denominata \\u201cColumn Gap\\u201d o \\u201cGap Width\\u201d) è aggiunta a MinColumnWidth per determinare la spaziatura totale della colonna della matrice (distanza tra gli stessi bordi di colonne diverse). |
| [setMinColumnWidth(long value)](#setMinColumnWidth-long-) | Larghezza minima della colonna in twips (1/20th of a point). La spaziatura del gap (anche denominata \\u201cColumn Gap\\u201d o \\u201cGap Width\\u201d) è aggiunta a MinColumnWidth per determinare la spaziatura totale della colonna della matrice (distanza tra gli stessi bordi di colonne diverse). |
| [getColumnGapRule()](#getColumnGapRule--) | Il tipo di spaziatura orizzontale tra le colonne di una matrice; le unità di spaziatura orizzontale possono essere ems o punti (memorizzati come twip). |
| [setColumnGapRule(int value)](#setColumnGapRule-int-) | Il tipo di spaziatura orizzontale tra le colonne di una matrice; le unità di spaziatura orizzontale possono essere ems o punti (memorizzati come twip). |
| [getColumnGap()](#getColumnGap--) | Il valore della spaziatura orizzontale tra le colonne di una matrice; Se ColumnGapRule è impostato a 3 (\"Exactly\"), l'unità è interpretata come twip (1/20th of a point). Se ColumnGapRule è impostato a 4 (\"Multiple\"), l'unità è interpretata come numero di incrementi di 0,5 em. In altri casi ignorato. Predefinito: 0 |
| [setColumnGap(long value)](#setColumnGap-long-) | Il valore della spaziatura orizzontale tra le colonne di una matrice; Se ColumnGapRule è impostato a 3 (\"Exactly\"), l'unità è interpretata come twip (1/20th of a point). Se ColumnGapRule è impostato a 4 (\"Multiple\"), l'unità è interpretata come numero di incrementi di 0,5 em. In altri casi ignorato. Predefinito: 0 |
...
| [getRowGap()](#getRowGap--) | Il valore della spaziatura verticale tra le righe di una matrice; Se RowGapRule è impostato a 3 (\"Exactly\"), l'unità è interpretata come twip (1/20th of a point). Se RowGapRule è impostato a 4 (\"Multiple\"), l'unità è interpretata come mezze linee. In altri casi ignorato. Predefinito: 0 |
| [setRowGap(long value)](#setRowGap-long-) | Il valore della spaziatura verticale tra le righe di una matrice; Se RowGapRule è impostato a 3 (\"Exactly\"), l'unità è interpretata come twip (1/20th of a point). Se RowGapRule è impostato a 4 (\"Multiple\"), l'unità è interpretata come mezze linee. In altri casi ignorato. Predefinito: 0 |
...
| [insertRowBefore(int rowIndex)](#insertRowBefore-int-) | Inserisci una nuova riga prima di quella specificata. Inizialmente tutti gli elementi della nuova riga sono null. |
| [insertRowAfter(int rowIndex)](#insertRowAfter-int-) | Inserisci una nuova riga dopo quella specificata. Inizialmente tutti gli elementi della nuova riga sono null. |
| [deleteRow(int rowIndex)](#deleteRow-int-) | Elimina la riga specificata |
| [insertColumnBefore(int columnIndex)](#insertColumnBefore-int-) | Inserisci una nuova colonna prima di quella specificata. Inizialmente tutti gli elementi della nuova colonna sono null. |
| [insertColumnAfter(int columnIndex)](#insertColumnAfter-int-) | Inserisci una nuova colonna dopo quella specificata. Inizialmente tutti gli elementi della nuova colonna sono null. |
...
| --- | --- | --- |
| rowCount | int | numero di righe |
| columnCount | int | numero di colonne |
...
Nasconde i segnaposti per gli elementi vuoti della matrice Predefinito: false
...
Larghezza minima della colonna in twips (1/20th of a point). La spaziatura del gap (anche denominata \\u201cColumn Gap\\u201d o \\u201cGap Width\\u201d) è aggiunta a MinColumnWidth per determinare la spaziatura totale della colonna della matrice (distanza tra gli stessi bordi di colonne diverse). Predefinito: 0.
...
Il tipo di spaziatura orizzontale tra le colonne di una matrice; le unità di spaziatura orizzontale possono essere ems o punti (memorizzati come twip). Predefinito: SingleSpacingGap (0)
...
Il valore della spaziatura orizzontale tra le colonne di una matrice; Se ColumnGapRule è impostato a 3 (\"Exactly\"), l'unità è interpretata come twip (1/20th of a point). Se ColumnGapRule è impostato a 4 (\"Multiple\"), l'unità è interpretata come numero di incrementi di 0,5 em. In altri casi ignorato. Predefinito: 0
...
Il valore della spaziatura verticale tra le righe di una matrice; Se RowGapRule è impostato a 3 (\"Exactly\"), l'unità è interpretata come twip (1/20th of a point). Se RowGapRule è impostato a 4 (\"Multiple\"), l'unità è interpretata come mezze linee. Predefinito: 0
...
| columnsCount | long | Il numero di colonne per le quali impostare l'allineamento |
| val | int | Nuovo valore dell'allineamento orizzontale della colonna specificata |
...
Inserisci una nuova riga prima di quella specificata. Inizialmente tutti gli elementi della nuova riga sono null.
...
Inserisci una nuova riga dopo quella specificata. Inizialmente tutti gli elementi della nuova riga sono null.
...
Inserisci una nuova colonna prima di quella specificata. Inizialmente tutti gli elementi della nuova colonna sono null.
...
Inserisci una nuova colonna dopo quella specificata. Inizialmente tutti gli elementi della nuova colonna sono null.
