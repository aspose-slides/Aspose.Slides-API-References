...
Specifica un'istanza di testo matematico contenuta all'interno di un MathParagraph e che inizia su una propria riga. Tutte le zone matematiche, incluse equazioni, espressioni, array di equazioni o espressioni e formule sono rappresentate da math block.
...
| [MathBlock(IMathElement mathElement)](#MathBlock-com.aspose.slides.IMathElement-) | Crea un nuovo blocco matematico e inserisce l'elemento specificato al suo interno |
| [MathBlock(System.Collections.Generic.IGenericEnumerable<IMathElement> mathElements)](#MathBlock-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.slides.IMathElement--) | Crea un nuovo blocco matematico e inserisce gli elementi specificati al suo interno |
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [getCount()](#getCount--) | Restituisce il numero di elementi matematici figlio effettivamente contenuti nella collezione. |
| [get_Item(int index)](#get-Item-int-) | Restituisce o imposta IMathElement all'indice specificato. |
| [set_Item(int index, IMathElement value)](#set-Item-int-com.aspose.slides.IMathElement-) | Restituisce o imposta IMathElement all'indice specificato. |
...
| [add(IMathElement item)](#add-com.aspose.slides.IMathElement-) | Aggiunge un math element alla fine della collezione. |
...
| [join(IMathElement mathElement)](#join-com.aspose.slides.IMathElement-) | Unisce un elemento matematico con questo blocco matematico |
| [join(String mathText)](#join-java.lang.String-) | Unisce un testo matematico con questo blocco matematico |
...
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | Racchiude gli elementi figlio di questo blocco nei caratteri specificati, come parentesi o altri caratteri di inquadratura |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | Racchiude gli elementi figlio di questo blocco nei caratteri specificati, come parentesi o altri, e li delimita con un carattere separatore |
...
Restituisce il numero di elementi matematici figlio effettivamente contenuti nella collezione. int di sola lettura.
...
Restituisce o imposta IMathElement all'indice specificato.
...
Aggiunge un math element alla fine della collezione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| array | [IMathElement\[\]](../../com.aspose.slides/imathelement) | Array in cui copiare. |
...
**Restituisce:**
boolean - true se l'elemento è stato rimosso con successo dalla collezione; altrimenti, false. Questo metodo restituisce anche false se l'elemento non è stato trovato nella collezione originale.
### iterator() {#iterator--}
```
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| index | int | L'indice basato su zero al quale il MathElement dovrebbe essere inserito. |
...
Unisce un elemento matematico con questo blocco matematico
...
Unisce un testo matematico con questo blocco matematico
...
Racchiude gli elementi figlio di questo blocco nei caratteri specificati, come parentesi o altri caratteri di inquadratura
...
Racchiude gli elementi figlio di questo blocco nei caratteri specificati, come parentesi o altri, e li delimita con un carattere separatore
