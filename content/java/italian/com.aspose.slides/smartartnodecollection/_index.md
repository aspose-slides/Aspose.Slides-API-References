...
| [size()](#size--) | Restituisce il conteggio dei nodi nella raccolta Solo lettura  int  Solo lettura  int . |
| [addNode()](#addNode--) | Aggiunge un nuovo nodo smart art o un sotto-nodo. |
| [removeNode(int index)](#removeNode-int-) | Rimuove il nodo o sotto-nodo per indice |
| [removeNode(ISmartArtNode node)](#removeNode-com.aspose.slides.ISmartArtNode-) | Rimuove il nodo o sotto-nodo |
...
Restituisce il conteggio dei nodi nella raccolta Solo lettura  int  Solo lettura  int .
...
Aggiunge un nuovo nodo smart art o un sotto-nodo.
...
**Restituisce:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISmartArtNode> - Un IGenericEnumerator che può essere usato per iterare attraverso la raccolta.
...
**Restituisce:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISmartArtNode> - Un java.util.Iterator per l'intera raccolta.
