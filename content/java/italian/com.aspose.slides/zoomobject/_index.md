...
> ```
> Il prossimo esempio dimostra come modificare il Tipo Immagine al valore Preview. 
>  In questo caso l'immagine corrente di un oggetto Zoom cambia in immagine della diapositiva:
>  
...
> ```
> Il prossimo esempio dimostra come cambiare il Tipo Immagine al valore Preview. 
>  In questo caso l'immagine corrente di un oggetto Zoom cambia in immagine della diapositiva:
>  
>  Presentation pres = new Presentation("pres.pptx");
>  try {
...
Il valore true della proprietà specifica il comportamento di navigazione "ritorna al genitore" nella presentazione.
...
> ```
> l'esempio dimostra come cambiare la durata della transizione tra Zoom e diapositiva:
>  
>  Presentation pres = new Presentation("pres.pptx");
>  try {
>       IZoomFrame zoomFrame = pres.getSlides().get_Item(0).getShapes().addZoomFrame(150, 20, 50, 50, pres.getSlides().get_Item(1));
