...
| Metodo | Descrizione |
| --- | --- |
| [getCount()](#getCount--) | Restituisce il numero di elementi in una collezione Solo lettura int. |
| [add(IShape shapeTrigger)](#add-com.aspose.slides.IShape-) | Aggiungi nuova sequenza interattiva. |
...
Restituisce il numero di elementi in una collezione Solo lettura int.
...
Aggiungi nuova sequenza interattiva. Lettura/scrittura [Sequence](../../com.aspose.slides/sequence).
