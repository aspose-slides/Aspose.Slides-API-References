...
| [getBevelTop()](#getBevelTop--) | Restituisce o imposta il tipo di un bevel superiore 3D. |
| [getBevelBottom()](#getBevelBottom--) | Restituisce o imposta il tipo di un bevel inferiore 3D. |
...
Restituisce o imposta il tipo di un bevel superiore 3D. Sola lettura [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Restituisce o imposta il tipo di un bevel inferiore 3D. Sola lettura [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Restituisce o imposta il colore di un contorno. Sola lettura [IColorFormat](../../com.aspose.slides/icolorformat).
...
Restituisce o imposta il colore di un’estrusione. Sola lettura [IColorFormat](../../com.aspose.slides/icolorformat).
...
Restituisce o imposta le impostazioni di una fotocamera. Sola lettura [ICamera](../../com.aspose.slides/icamera).
...
Restituisce o imposta il tipo di una luce. Sola lettura [ILightRig](../../com.aspose.slides/ilightrig).
