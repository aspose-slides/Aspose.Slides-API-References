...
| Metodo | Descrizione |
| --- | --- |
| [size()](#size--) | Restituisce il numero di righe effettivamente contenute nella collezione. |
...
Restituisce il numero di righe effettivamente contenute nella collezione. Solo lettura int.
