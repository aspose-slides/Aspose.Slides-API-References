...
description: Rappresenta le proprietà degli effetti di una forma.
type: docs
...
Rappresenta le proprietà degli effetti di una forma.
## Metodi
...
| [getBlurEffect()](#getBlurEffect--) | Effetto di sfocatura. |
| [setBlurEffect(IBlur value)](#setBlurEffect-com.aspose.slides.IBlur-) | Effetto di sfocatura. |
...
| [setBlurEffect(double radius, boolean grow)](#setBlurEffect-double-boolean-) | Imposta l'effetto di sfocatura. |
...
| [enableInnerShadowEffect()](#enableInnerShadowEffect--) | Abilita l'effetto ombra interna. |
| [enableOuterShadowEffect()](#enableOuterShadowEffect--) | Abilita l'effetto ombra esterna. |
| [enablePresetShadowEffect()](#enablePresetShadowEffect--) | Abilita l'effetto ombre predefinite. |
| [enableReflectionEffect()](#enableReflectionEffect--) | Abilita l'effetto di riflesso. |
| [enableSoftEdgeEffect()](#enableSoftEdgeEffect--) | Abilita l'effetto bordo morbido. |
| [disableBlurEffect()](#disableBlurEffect--) | Disabilita l'effetto di sfocatura. |
...
| [disableInnerShadowEffect()](#disableInnerShadowEffect--) | Disabilita l'effetto ombra interna. |
| [disableOuterShadowEffect()](#disableOuterShadowEffect--) | Disabilita l'effetto ombra esterna. |
| [disablePresetShadowEffect()](#disablePresetShadowEffect--) | Disabilita l'effetto ombra predefinita. |
| [disableReflectionEffect()](#disableReflectionEffect--) | Disabilita l'effetto di riflesso. |
| [disableSoftEdgeEffect()](#disableSoftEdgeEffect--) | Disabilita l'effetto bordo morbido. |
| [getEffective()](#getEffective--) | Ottiene i dati di formattazione degli effetti efficaci con l'ereditarietà applicata. |
...
Effetto di sfocatura. Lettura/scrittura [IBlur](../../com.aspose.slides/iblur).
...
Abilita l'effetto ombre predefinite.
...
Disabilita l'effetto ombra predefinita.
...
Ottiene i dati di formattazione degli effetti efficaci con l'ereditarietà applicata.
