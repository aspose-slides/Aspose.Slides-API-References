...
| --- | --- | --- |
| path | java.lang.String | Il percorso dove verranno generati i file video e audio |
| fileName | java.lang.String | Il nome del file HTML |
| baseUri | java.lang.String | L'URI di base che verrà utilizzato per la generazione dei collegamenti |
...
Chiamato per scrivere l'intestazione della slide html. Chiamato una volta per ogni slide.
...
Chiamato per scrivere il piè di pagina della slide html. Chiamato una volta per ogni slide.
...
Chiamato prima del rendering della forma. Chiamato una volta per ogni forma. Se questa funzione scrive qualcosa nel generatore, la generazione dell'immagine della slide corrente sarà terminata, il frammento html aggiunto sarà inserito e una nuova immagine verrà avviata sopra la precedente.
...
Questa funzione è chiamata prima del rendering della forma in SVG per consentire all'utente di controllare lo SVG risultante.
...
Determina dove l'oggetto deve essere archiviato. Questo metodo è chiamato una volta per ogni id di oggetto. Non è garantito che non esistano due oggetti con gli stessi dati, semanticName e contentType ma con id diversi.
