...
| [copyTo(IParagraph[] array, int arrayIndex)](#copyTo-com.aspose.slides.IParagraph---int-) | Copia gli elementi del [IGenericCollection](../../com.aspose.slides/igenericcollection) in un Array, iniziando da un indice specifico dell'Array. |
| [removeAt(int index)](#removeAt-int-) | Rimuove l'elemento all'indice specificato della collezione. |
| [remove(IParagraph item)](#remove-com.aspose.slides.IParagraph-) | Rimuove la prima occorrenza di un oggetto specifico dal [IGenericCollection](../../com.aspose.slides/igenericcollection). |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| item | [IParagraph](../../com.aspose.slides/iparagraph) | L'oggetto da trovare nella List. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| index | int | L'indice basato su zero al quale il Paragraph dovrebbe essere inserito. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| item | [IParagraph](../../com.aspose.slides/iparagraph) | L'oggetto da trovare nel [IGenericCollection](../../com.aspose.slides/igenericcollection). |
...
Copia gli elementi del [IGenericCollection](../../com.aspose.slides/igenericcollection) in un Array, iniziando da un indice specifico dell'Array.
...
**Restituisce:**
boolean - true se l'elemento è stato rimosso con successo dal [IGenericCollection](../../com.aspose.slides/igenericcollection); altrimenti, false. Questo metodo restituisce anche false se l'elemento non è stato trovato nell'originale [IGenericCollection](../../com.aspose.slides/igenericcollection).
...
**Restituisce:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IParagraph> - A IGenericEnumerator che può essere usato per iterare attraverso la collezione.
...
**Restituisce:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IParagraph> - An java.util.Iterator per l'intera collezione.
...
Restituisce la slide padre di una collezione di paragrafi. [BaseSlide](../../com.aspose.slides/baseslide) di sola lettura.
...
Restituisce la presentazione padre di una collezione di paragrafi. [IPresentation](../../com.aspose.slides/ipresentation) di sola lettura.
