...
type: docs
url: /it/com.aspose.slides/extracolorschemecollection/
---
**Eredità:**
java.lang.Object
...
| [get_Item(int index)](#get-Item-int-) | Restituisce uno schema di colore per indice. |
...
| [isSynchronized()](#isSynchronized--) | Restituisce un valore che indica se l'accesso all'ArrayList è sincronizzato (thread safe). |
...
Restituisce uno schema di colore per indice. Solo lettura [ExtraColorScheme](../../com.aspose.slides/extracolorscheme).
...
**Restituisce:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IExtraColorScheme> - Un IGenericEnumerator che può essere usato per iterare attraverso la collezione.
...
**Restituisce:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IExtraColorScheme> - Un java.util.Iterator per l'intera collezione.
...
Restituisce un valore che indica se l'accesso all'ArrayList è sincronizzato (thread safe). Solo lettura boolean.
...
Restituisce un oggetto che può essere usato per sincronizzare l'accesso alla collezione. Solo lettura Object.
