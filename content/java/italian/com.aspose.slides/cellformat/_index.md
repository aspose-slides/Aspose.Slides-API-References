...
| [getBorderDiagonalDown()](#getBorderDiagonalDown--) | Restituisce un oggetto di proprietà della linea diagonale dall'angolo in alto a sinistra a quello in basso a destra. |
| [getBorderDiagonalUp()](#getBorderDiagonalUp--) | Restituisce un oggetto di proprietà della linea diagonale dall'angolo in basso a sinistra a quello in alto a destra. |
| [getEffective()](#getEffective--) | Ottiene le proprietà di formattazione della cella di tabella effettive con ereditarietà e stili di tabella applicati. |
...
Restituisce un oggetto di proprietà della linea diagonale dall'angolo in alto a sinistra a quello in basso a destra. Solo lettura [ILineFormat](../../com.aspose.slides/ilineformat).
...
Restituisce un oggetto di proprietà della linea diagonale dall'angolo in basso a sinistra a quello in alto a destra. Solo lettura [ILineFormat](../../com.aspose.slides/ilineformat).
...
Ottiene le proprietà di formattazione della cella di tabella effettive con ereditarietà e stili di tabella applicati.

--------------------

> ```
> Questo esempio dimostra come ottenere il formato di riempimento effettivo per diverse parti logiche della tabella.
>  Nota che la formattazione delle celle ha sempre priorità più alta rispetto a quella delle righe, le righe hanno priorità più alta rispetto alle colonne, le colonne hanno priorità più alta rispetto all'intera tabella.
>  Quindi, alla fine, le proprietà di CellFormatEffectiveData sono sempre usate per disegnare la tabella. Il codice seguente è solo un esempio di API.
>  
