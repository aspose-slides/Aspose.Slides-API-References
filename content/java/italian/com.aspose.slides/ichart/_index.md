...
Rappresenta un grafico illustrativo su una diapositiva.
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [getPlotVisibleCellsOnly()](#getPlotVisibleCellsOnly--) | Determina se solo le celle visibili sono tracciate. |
| [setPlotVisibleCellsOnly(boolean value)](#setPlotVisibleCellsOnly-boolean-) | Determina se solo le celle visibili sono tracciate. |
| [getDisplayBlanksAs()](#getDisplayBlanksAs--) | Restituisce o imposta il modo in cui vengono tracciate le celle vuote in un grafico. |
| [setDisplayBlanksAs(int value)](#setDisplayBlanksAs-int-) | Restituisce o imposta il modo in cui vengono tracciate le celle vuote in un grafico. |
...
| [getChartTitle()](#getChartTitle--) | Restituisce o imposta il titolo del grafico Solo lettura [IChartTitle](../../com.aspose.slides/icharttitle). |
...
| [getShowDataLabelsOverMaximum()](#getShowDataLabelsOverMaximum--) | Specifica se le etichette dei dati sopra il massimo del grafico devono essere mostrate. |
| [setShowDataLabelsOverMaximum(boolean value)](#setShowDataLabelsOverMaximum-boolean-) | Specifica se le etichette dei dati sopra il massimo del grafico devono essere mostrate. |
...
Determina se solo le celle visibili sono tracciate. False per tracciare sia le celle visibili che quelle nascoste. Lettura/Scrittura boolean.
...
Restituisce o imposta il modo in cui vengono tracciate le celle vuote in un grafico. Lettura/Scrittura [DisplayBlanksAsType](../../com.aspose.slides/displayblanksastype).
...
Restituisce o imposta il titolo del grafico Solo lettura [IChartTitle](../../com.aspose.slides/icharttitle).
...
Specifica se le etichette dei dati sopra il massimo del grafico devono essere mostrate. Lettura/Scrittura boolean.
