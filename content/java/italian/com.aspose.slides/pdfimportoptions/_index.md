...
| Metodo | Descrizione |
| --- | --- |
| [getDetectTables()](#getDetectTables--) | Determina se rilevare le tabelle durante l'importazione del file PDF. |
| [setDetectTables(boolean value)](#setDetectTables-boolean-) | Determina se rilevare le tabelle durante l'importazione del file PDF. |
### PdfImportOptions() {#PdfImportOptions--}
```
