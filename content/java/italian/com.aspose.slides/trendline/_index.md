...
| [getBackward()](#getBackward--) | Specifica il numero di categorie (o unità su un grafico a dispersione) che la linea di tendenza si estende prima dei dati per la serie che viene tracciata. |
| [setBackward(double value)](#setBackward-double-) | Specifica il numero di categorie (o unità su un grafico a dispersione) che la linea di tendenza si estende prima dei dati per la serie che viene tracciata. |
| [getForward()](#getForward--) | Specifica il numero di categorie (o unità su un grafico a dispersione) che la linea di tendenza si estende dopo i dati per la serie che viene tracciata. |
| [setForward(double value)](#setForward-double-) | Specifica il numero di categorie (o unità su un grafico a dispersione) che la linea di tendenza si estende dopo i dati per la serie che viene tracciata. |
...
| [getDisplayEquation()](#getDisplayEquation--) | Specifica che l'equazione della linea di tendenza viene visualizzata sul grafico (nella stessa etichetta del valore Rsquared). |
| [setDisplayEquation(boolean value)](#setDisplayEquation-boolean-) | Specifica che l'equazione della linea di tendenza viene visualizzata sul grafico (nella stessa etichetta del valore Rsquared). |
...
| [getDisplayRSquaredValue()](#getDisplayRSquaredValue--) | Specifica che il valore R-squared della linea di tendenza viene visualizzato sul grafico (nella stessa etichetta dell'equazione). |
| [setDisplayRSquaredValue(boolean value)](#setDisplayRSquaredValue-boolean-) | Specifica che il valore R-squared della linea di tendenza viene visualizzato sul grafico (nella stessa etichetta dell'equazione). |
| [getRelatedLegendEntry()](#getRelatedLegendEntry--) | Rappresenta la voce della legenda correlata a questa linea di tendenza Sola lettura [ILegendEntryProperties](../../com.aspose.slides/ilegendentryproperties). |
...
Specifică il numero di categorie (o unità su un grafico a dispersione) che la linea di tendenza si estende prima dei dati per la serie che viene tracciata. Su grafici a dispersione e non a dispersione, il valore deve essere qualsiasi valore non negativo. Lettura/scrittura double.
...
Specifică il numero di categorie (o unità su un grafico a dispersione) che la linea di tendenza si estende dopo i dati per la serie che viene tracciata. Su grafici a dispersione e non a dispersione, il valore deve essere qualsiasi valore non negativo. Lettura/scrittura double.
...
Specifică che l'equazione della linea di tendenza viene visualizzata sul grafico (nella stessa etichetta del valore Rsquared). Lettura/scrittura boolean.
...
Specifică che il valore R-squared della linea di tendenza viene visualizzato sul grafico (nella stessa etichetta dell'equazione). Lettura/scrittura boolean.
...
Rappresenta la voce della legenda correlata a questa linea di tendenza Sola lettura [ILegendEntryProperties](../../com.aspose.slides/ilegendentryproperties).
...
Inizializza TextFrameForOverriding con il testo nel parametro "text". Se TextFrameForOverriding è già inizializzato, allora semplicemente cambia il suo testo.
...
Può contenere un testo formattato riccamente. Se questa proprietà non è null, questo valore di testo formattato sovrascrive il testo auto-generato dell'etichetta dati. Il testo auto-generato dell'etichetta dati significa il testo gestito dalle proprietà ShowSeriesName, ShowValue, ... e formattato con la proprietà TextFormatManager.TextFormat. Sola lettura [ITextFrame](../../com.aspose.slides/itextframe).
...
Restituisce il grafico principale. Sola lettura [IChart](../../com.aspose.slides/ichart).
...
Restituisce la diapositiva principale di un FillFormat. Sola lettura [BaseSlide](../../com.aspose.slides/baseslide).
...
Restituisce la presentazione principale di un FillFormat. Sola lettura [IPresentation](../../com.aspose.slides/ipresentation).
