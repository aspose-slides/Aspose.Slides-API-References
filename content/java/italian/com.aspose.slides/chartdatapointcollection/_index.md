...
| Metodo | Descrizione |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Restituisce il punto dati di serie per indice (il suo numero di serie in questa collezione). |
...
| [getDataSourceTypeForXValues()](#getDataSourceTypeForXValues--) | Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà XValue dei punti dati. |
| [setDataSourceTypeForXValues(int value)](#setDataSourceTypeForXValues-int-) | Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà XValue dei punti dati. |
| [getDataSourceTypeForYValues()](#getDataSourceTypeForYValues--) | Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà YValue dei punti dati. |
| [setDataSourceTypeForYValues(int value)](#setDataSourceTypeForYValues-int-) | Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà YValue dei punti dati. |
| [getDataSourceTypeForBubbleSizes()](#getDataSourceTypeForBubbleSizes--) | Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà BubbleSize dei punti dati. |
| [setDataSourceTypeForBubbleSizes(int value)](#setDataSourceTypeForBubbleSizes-int-) | Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà BubbleSize dei punti dati. |
| [getDataSourceTypeForValues()](#getDataSourceTypeForValues--) | Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà Value dei punti dati. |
| [setDataSourceTypeForValues(int value)](#setDataSourceTypeForValues-int-) | Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà Value dei punti dati. |
| [getDataSourceTypeForErrorBarsCustomValues()](#getDataSourceTypeForErrorBarsCustomValues--) | Specifica i tipi di valori nell'elenco delle proprietà ChartDataPoint.ErrorBarsCustomValues. |
...
Restituisce il punto dati di serie per indice (il suo numero di serie in questa collezione).
...
Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà XValue dei punti dati. In altre parole specifica il tipo di valore della proprietà ChartDataPoint.XValue.Data. Lettura/Scrittura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà YValue dei punti dati. In altre parole specifica il tipo di valore della proprietà ChartDataPoint.YValue.Data. Lettura/Scrittura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà BubbleSize dei punti dati. In altre parole specifica il tipo di valore della proprietà ChartDataPoint.BubbleSize.Data. Lettura/Scrittura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Specifica se la proprietà AsCell o AsLiteralString o AsLiteralDouble è attiva nell'oggetto della proprietà Value dei punti dati. In altre parole specifica il tipo di valore della proprietà ChartDataPoint.Value.Data. Lettura/Scrittura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Specifica i tipi di valori nell'elenco delle proprietà ChartDataPoint.ErrorBarsCustomValues. Sola lettura [IDataSourceTypeForErrorBarsCustomValues](../../com.aspose.slides/idatasourcetypeforerrorbarscustomvalues).
...
Ottiene il numero di elementi effettivamente contenuti nella collezione. Sola lettura int.
...
```
Crea il nuovo punto dati e lo aggiunge alla fine della raccolta. Applicabile alle serie il cui chartType è uno dei sottotipi Stock (vedi anche il metodo [ChartTypeCharacterizer.isChartTypeStock(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeStock-int-)).
...
Crea il nuovo punto dati e lo aggiunge alla fine della raccolta. Applicabile alle serie il cui chartType è uno dei sottotipi Line (vedi anche il metodo [ChartTypeCharacterizer.isChartTypeLine(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeLine-int-)).
...
Crea il nuovo punto dati e lo aggiunge alla fine della raccolta. Applicabile alle serie il cui chartType è uno dei sottotipi Scatter (vedi anche il metodo [ChartTypeCharacterizer.isChartTypeScatter(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeScatter-int-)).

**Parametri:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valore X del punto dati |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valore Y del punto dati |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| xValue | double | Valore X del punto dati |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valore Y del punto dati |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| xValue | java.lang.String | Valore X del punto dati |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valore Y del punto dati |
...
| --- | --- | --- |
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valore X del punto dati |
| yValue | double | Valore Y del punto dati |
...
Crea il nuovo punto dati e lo aggiunge alla fine della raccolta. Applicabile alle serie il cui chartType è uno dei sottotipi Radar (vedi anche il metodo [ChartTypeCharacterizer.isChartTypeRadar(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeRadar-int-)).
...
Crea il nuovo punto dati e lo aggiunge alla fine della raccolta. Applicabile alle serie il cui chartType è uno dei sottotipi Area (vedi anche il metodo [ChartTypeCharacterizer.isChartTypeArea(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeArea-int-)).
...
Crea il nuovo punto dati e lo aggiunge alla fine della raccolta. Applicabile alle serie il cui chartType è uno dei sottotipi Pie (vedi anche il metodo [ChartTypeCharacterizer.isChartTypePie(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypePie-int-)).
...
Crea il nuovo punto dati e lo aggiunge alla fine della raccolta. Applicabile alle serie il cui chartType è uno dei sottotipi Doughnut (vedi anche il metodo [ChartTypeCharacterizer.isChartTypeDoughnut(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeDoughnut-int-)).
...
Crea il nuovo punto dati e lo aggiunge alla fine della raccolta. Applicabile alle serie il cui chartType è uno dei sottotipi Bubble (vedi anche il metodo [ChartTypeCharacterizer.isChartTypeBubble(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeBubble-int-)).
...
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valore X del punto dati |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valore Y del punto dati |
| bubbleSize | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Dimensione della bolla del punto dati |
