...
| Metodo | Descrizione |
| --- | --- |
| [addFallBackFonts(String fontName)](#addFallBackFonts-java.lang.String-) | Aggiunge un nuovo font (o più font) all'elenco dei font FallBack. |
...
| [toArray(int startIndex, int count)](#toArray-int-int-) | Crea e restituisce un array con tutti i font FallBack dall'intervallo specificato nell'elenco. |
...
> ```
> //Creazione di una nuova istanza di FantFallBackRule
...
| --- | --- | --- |
| fontName | java.lang.String | Nome del font o dei font (separati da virgola) per il FallBack |
...
> ```
> //Creazione di una nuova istanza di FontFallBackRule
>  IFontFallBackRule newRule = new FontFallBackRule(0x3040, 0x309F, "MS Mincho");
>  //Aggiunta di altri tre font alla regola 
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| fontNames | java.lang.String[] | Nome del font o dei font (separati da virgola) per il FallBack |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| fontName | java.lang.String | Il nome del font da rimuovere dall'elenco. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| index | int | L'indice (basato su zero) del font da rimuovere. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| startIndex | int | Un indice del primo font da aggiungere. |
| count | int | Il numero di font da aggiungere. |
