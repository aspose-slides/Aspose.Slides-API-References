...
description: Rappresenta una collezione di effetti in sequenza.
type: docs
...
| [getTriggerShape()](#getTriggerShape--) | Restituisce o imposta l'obiettivo shape per la sequenza INTERACTIVE. |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | Restituisce o imposta l'obiettivo shape per la sequenza INTERACTIVE. |
| [removeByShape(IShape shape)](#removeByShape-com.aspose.slides.IShape-) | Rimuove l'effetto per la shape specificata. |
| [getEffectsByShape(IShape shape)](#getEffectsByShape-com.aspose.slides.IShape-) | Restituisce un array di effetti per la shape specificata. |
...
| [getCount(IShape shape)](#getCount-com.aspose.slides.IShape-) | Restituisce il conteggio degli effetti per la shape specificata. |
| [addEffect(IShape shape, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IShape-int-int-int-) | Aggiunge nuovo effetto alla fine della sequenza. |
| [addEffect(IParagraph paragraph, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IParagraph-int-int-int-) | Aggiunge nuovo effetto di animazione per il paragrafo alla fine della sequenza. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| index | int | Indice dell'effetto da rimuovere. |
...
**Restituisce:**
[IEffect](../../com.aspose.slides/ieffect) - L'[IEffect](../../com.aspose.slides/ieffect) oggetto.
...
Restituisce o imposta l'obiettivo shape per la sequenza INTERACTIVE. Se la sequenza non è interattiva restituisce null. Lettura/scrittura [IShape](../../com.aspose.slides/ishape).
...
Rimuove l'effetto per la shape specificata.
...
Restituisce un array di effetti per la shape specificata.
...
Restituisce il conteggio degli effetti per la shape specificata.
...
Aggiunge nuovo effetto alla fine della sequenza.
...
Aggiunge nuovo effetto di animazione per il paragrafo alla fine della sequenza.
