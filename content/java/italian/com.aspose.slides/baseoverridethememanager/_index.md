...
| [setOverrideTheme(IOverrideTheme value)](#setOverrideTheme-com.aspose.slides.IOverrideTheme-) | Restituisce l'oggetto tema di override. |
...
Restituisce l'oggetto tema di override. Lettura/Scrittura [IOverrideTheme](../../com.aspose.slides/ioverridetheme).
...
Determina se OverrideTheme sovrascrive il tema efficace ereditato o meno. Per abilitare OverrideTheme per l'override, usa i metodi OverrideTheme.Init\*(). Per disabilitare OverrideTheme dall'override, usa il metodo OverrideTheme.Clear(). Solo lettura boolean.
