...
| [getDirection()](#getDirection--) | Specifica la direzione in cui ciclicare la tonalità attorno alla ruota dei colori. |
| [setDirection(int value)](#setDirection-int-) | Specifica la direzione in cui ciclicare la tonalità attorno alla ruota dei colori. |
### getFrom() {#getFrom--}
```
...
Specifica la direzione in cui ciclicare la tonalità attorno alla ruota dei colori. Lettura/scrittura [ColorDirection](../../com.aspose.slides/colordirection).
