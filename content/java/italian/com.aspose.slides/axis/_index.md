...
| [getAxisBetweenCategories()](#getAxisBetweenCategories--) | Indica se l'asse dei valori attraversa l'asse delle categorie tra le categorie. |
| [setAxisBetweenCategories(boolean value)](#setAxisBetweenCategories-boolean-) | Indica se l'asse dei valori attraversa l'asse delle categorie tra le categorie. |
...
| [isLogarithmic()](#isLogarithmic--) | Indica se il tipo di scala dell'asse dei valori è logaritmico o meno. |
| [setLogarithmic(boolean value)](#setLogarithmic-boolean-) | Indica se il tipo di scala dell'asse dei valori è logaritmico o meno. |
...
| [isPlotOrderReversed()](#isPlotOrderReversed--) | Indica se MS PowerPoint traccia i punti dati dall'ultimo al primo. |
| [setPlotOrderReversed(boolean value)](#setPlotOrderReversed-boolean-) | Indica se MS PowerPoint traccia i punti dati dall'ultimo al primo. |
| [isVisible()](#isVisible--) | Indica se l'asse è visibile. |
| [setVisible(boolean value)](#setVisible-boolean-) | Indica se l'asse è visibile. |
| [getMajorTickMark()](#getMajorTickMark--) | Rappresenta il tipo di marcatura principale per l'asse specificato. |
| [setMajorTickMark(int value)](#setMajorTickMark-int-) | Rappresenta il tipo di marcatura principale per l'asse specificato. |
| [getMinorTickMark()](#getMinorTickMark--) | Rappresenta il tipo di marcatura secondaria per l'asse specificato. |
| [setMinorTickMark(int value)](#setMinorTickMark-int-) | Rappresenta il tipo di marcatura secondaria per l'asse specificato. |
| [getTickLabelPosition()](#getTickLabelPosition--) | Rappresenta la posizione delle etichette di marcatura sull'asse specificato. |
| [setTickLabelPosition(int value)](#setTickLabelPosition-int-) | Rappresenta la posizione delle etichette di marcatura sull'asse specificato. |
...
| [getMinorGridLinesFormat()](#getMinorGridLinesFormat--) | Rappresenta il formato delle linee di griglia secondarie su un asse del grafico. |
| [getMajorGridLinesFormat()](#getMajorGridLinesFormat--) | Rappresenta il formato delle linee di griglia principali su un asse del grafico. |
| [getShowMinorGridLines()](#getShowMinorGridLines--) | Per nascondere la linea di griglia secondaria, impostare MinorGridLinesFormat.Line.FillFormat.FillType su FillType.NoFill. |
| [getShowMajorGridLines()](#getShowMajorGridLines--) | Per nascondere la linea di griglia principale, impostare MajorGridLinesFormat.Line.FillFormat.FillType su FillType.NoFill. |
...
| [getTickLabelRotationAngle()](#getTickLabelRotationAngle--) | Rappresenta l'angolo di rotazione delle etichette delle marcature. |
| [setTickLabelRotationAngle(float value)](#setTickLabelRotationAngle-float-) | Rappresenta l'angolo di rotazione delle etichette delle marcature. |
| [getTickLabelSpacing()](#getTickLabelSpacing--) | Specifica quante etichette di marcatura saltare tra le etichette disegnate. |
| [setTickLabelSpacing(long value)](#setTickLabelSpacing-long-) | Specifica quante etichette di marcatura saltare tra le etichette disegnate. |
| [isAutomaticTickLabelSpacing()](#isAutomaticTickLabelSpacing--) | Specifica il valore di spaziatura automatico delle etichette di marcatura. |
| [setAutomaticTickLabelSpacing(boolean value)](#setAutomaticTickLabelSpacing-boolean-) | Specifica il valore di spaziatura automatico delle etichette di marcatura. |
| [getTickMarksSpacing()](#getTickMarksSpacing--) | Specifica quante marcature devono essere saltate prima che la successiva venga disegnata. |
| [setTickMarksSpacing(long value)](#setTickMarksSpacing-long-) | Specifica quante marcature devono essere saltate prima che la successiva venga disegnata. |
| [isAutomaticTickMarksSpacing()](#isAutomaticTickMarksSpacing--) | Specifica il valore di spaziatura automatico delle marcature. |
| [setAutomaticTickMarksSpacing(boolean value)](#setAutomaticTickMarksSpacing-boolean-) | Specifica il valore di spaziatura automatico delle marcature. |
...
| [isOverflowBin()](#isOverflowBin--) | Specifica se il bin di overflow è applicato. |
| [setOverflowBin(boolean value)](#setOverflowBin-boolean-) | Specifica se il bin di overflow è applicato. |
...
| [isUnderflowBin()](#isUnderflowBin--) | Specifica se il bin di underflow è applicato. |
| [setUnderflowBin(boolean value)](#setUnderflowBin-boolean-) | Specifica se il bin di underflow è applicato. |
...
Indica se l'asse dei valori attraversa l'asse delle categorie tra le categorie. Questa proprietà si applica solo agli assi delle categorie e non si applica ai grafici 3-D. Lettura/scrittura boolean.
...
Specifica il tipo dell'asse delle categorie. Lettura/scrittura [CategoryAxisType](../../com.aspose.slides/categoryaxistype).
...
Specifica il valore di scala delle unità di visualizzazione per l'asse dei valori. Lettura/scrittura [DisplayUnitType](../../com.aspose.slides/displayunittype).
...
Specifica il valore massimo effettivo sull'asse. Chiamare in precedenza il metodo IChart.ValidateChartLayout() per ottenere il valore effettivo.
...
Specifica il valore minimo effettivo sull'asse. Chiamare in precedenza il metodo IChart.ValidateChartLayout() per ottenere il valore effettivo.
...
Specifica l'unità principale effettiva dell'asse. Chiamare in precedenza il metodo IChart.ValidateChartLayout() per ottenere il valore effettivo.
...
Specifica l'unità secondaria effettiva dell'asse. Chiamare in precedenza il metodo IChart.ValidateChartLayout() per ottenere il valore effettivo.
...
Specifica la scala dell'unità principale effettiva dell'asse. Chiamare in precedenza il metodo IChart.ValidateChartLayout() per ottenere il valore effettivo.
...
Specifica la scala dell'unità secondaria effettiva dell'asse. Chiamare in precedenza il metodo IChart.ValidateChartLayout() per ottenere il valore effettivo.
...
Rappresenta le unità principali per l'asse di data o valore. Lettura/Scrittura double.
...
Rappresenta il tipo di segno di spunta minore per l'asse specificato. Lettura/Scrittura [TickMarkType](../../com.aspose.slides/tickmarktype).
...
Rappresenta la scala dell'unità principale per l'asse di data. Lettura/Scrittura [TimeUnitType](../../com.aspose.slides/timeunittype).
...
Specifica l'unità di tempo più piccola rappresentata sull'asse di data. Lettura/Scrittura [TimeUnitType](../../com.aspose.slides/timeunittype).
...
Rappresenta il formato delle linee di griglia minori su un asse del grafico. Sola lettura [IChartLinesFormat](../../com.aspose.slides/ichartlinesformat).
...
Rappresenta il formato delle linee di griglia maggiori su un asse del grafico. Sola lettura [IChartLinesFormat](../../com.aspose.slides/ichartlinesformat).
...
Per nascondere la linea di griglia minore, impostare MinorGridLinesFormat.Line.FillFormat.FillType su FillType.NoFill. Sola lettura boolean.
...
Per nascondere la linea di griglia maggiore, impostare MajorGridLinesFormat.Line.FillFormat.FillType su FillType.NoFill. Sola lettura boolean.
...
Rappresenta il formato dell'asse. Sola lettura [IAxisFormat](../../com.aspose.slides/iaxisformat).
...
Rappresenta il formato del testo. Sola lettura [IChartTextFormat](../../com.aspose.slides/icharttextformat).
...
Ottiene il titolo dell'asse. Sola lettura [IChartTitle](../../com.aspose.slides/icharttitle).
...
Specifica quanti etichette dei segni di spunta saltare tra le etichette disegnate. Applicato all'asse di categoria o di serie. Lettura/Scrittura long.
...
Specifica il valore di spaziatura automatica delle etichette dei segni di spunta. Se false: usare la proprietà TickLabelSpacing. Lettura/Scrittura boolean.
...
Specifica quanti segni di spunta devono essere saltati prima che quello successivo sia disegnato. Applicato all'asse di categoria o di serie. Lettura/Scrittura int.
...
Specifica il valore di spaziatura automatica dei segni di spunta. Se false: usare la proprietà TickMarksSpacing. Lettura/Scrittura boolean.
...
Rappresenta il tipo di aggregazione dell'asse di categoria (binning). Applicato alla categoria. Utilizzato solo con le serie Histogram o HistogramPareto.
...
Specifica il numero di bin quando il valore della proprietà AggregationType è impostato su AxisAggregationType.ByNumberOfBins. Applicato agli assi di categoria. Utilizzato solo con le serie Histogram o HistogramPareto.
...
Specifica se il bin di overflow è applicato. Usa IsAutomaticOverflowBin e OverflowBin per regolare il valore del bin di overflow.
...
Specifica il valore automatico del bin di overflow. Se false: utilizza la proprietà OverflowBin.
...
Specifica il valore automatico del bin di underflow. Se false: utilizza la proprietà UnderflowBin.
...
Restituisce la slide principale di un FillFormat. Solo lettura [BaseSlide](../../com.aspose.slides/baseslide).
