...
description: Rappresenta una raccolta di punti per il punto di divisione in un grafico a barra di torta o a torta di torta con divisione personalizzata.
type: docs
...
Rappresenta una raccolta di punti per il punto di divisione in un grafico a torta con barra o a torta con torta con divisione personalizzata.
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Restituisce il punto dati del grafico per l'indice specificato. |
| [add(int dataPointIndex)](#add-int-) | Aggiunge il punto dati per il suo indice nella collezione dei punti della serie padre. |
| [addItem(IChartDataPoint dataPoint)](#addItem-com.aspose.slides.IChartDataPoint-) | Aggiunge un punto dati alla collezione. |
| [removeItem(IChartDataPoint dataPoint)](#removeItem-com.aspose.slides.IChartDataPoint-) | Rimuove l'elemento dalla collezione. |
| [remove(int dataPointIndex)](#remove-int-) | Rimuove l'elemento dalla collezione per il suo indice nella collezione dei punti della serie padre. |
...
Aggiunge un punto dati per il suo indice nella collezione dei punti della serie padre.

**Parametri:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| dataPointIndex | int | Indice del punto dati nella collezione dei punti della serie padre. |
### addItem(IChartDataPoint dataPoint) {#addItem-com.aspose.slides.IChartDataPoint-}
```
public void addItem(IChartDataPoint dataPoint)
```

Aggiunge un punto dati alla collezione.
...
Rimuove l'elemento dalla collezione per il suo indice nella collezione dei punti della serie padre.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| array | [IChartDataPoint\[\]](../../com.aspose.slides/ichartdatapoint) | L'Array unidimensionale che è la destinazione degli elementi copiati da [IGenericCollection](../../com.aspose.slides/igenericcollection). L'Array deve avere un indice basato su zero. |
...
Restituisce o imposta il conteggio dei punti dati del grafico. Intero di sola lettura.
...
Restituisce un valore che indica se il [IGenericCollection](../../com.aspose.slides/igenericcollection) è di sola lettura. Boolean di sola lettura.
