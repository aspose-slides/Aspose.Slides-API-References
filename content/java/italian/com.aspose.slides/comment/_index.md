...
>      // Rimuove commento1 e tutte le sue risposte
>      comment1.remove();
...
Restituisce o imposta l'ora di creazione di un commento. Impostare questa proprietà a java.util.Date(Long.MIN\_VALUE) significa che l'ora del commento non è impostata. Lettura/scrittura java.util.Date.

--------------------

Il tempo del commento è un parametro facoltativo.
...
Restituisce o imposta la diapositiva principale di un commento. Solo lettura [ISlide](../../com.aspose.slides/islide).
...
Restituisce l'oggetto Parent\_Immediate. Solo lettura IDOMObject.
