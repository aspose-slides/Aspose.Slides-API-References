...
| [getBeginArrowheadStyle()](#getBeginArrowheadStyle--) | Restituisce o imposta lo stile della punta di freccia all'inizio di una linea. |
| [setBeginArrowheadStyle(byte value)](#setBeginArrowheadStyle-byte-) | Restituisce o imposta lo stile della punta di freccia all'inizio di una linea. |
| [getEndArrowheadStyle()](#getEndArrowheadStyle--) | Restituisce o imposta lo stile della punta di freccia alla fine di una linea. |
| [setEndArrowheadStyle(byte value)](#setEndArrowheadStyle-byte-) | Restituisce o imposta lo stile della punta di freccia alla fine di una linea. |
| [getBeginArrowheadWidth()](#getBeginArrowheadWidth--) | Restituisce o imposta la larghezza della punta di freccia all'inizio di una linea. |
| [setBeginArrowheadWidth(byte value)](#setBeginArrowheadWidth-byte-) | Restituisce o imposta la larghezza della punta di freccia all'inizio di una linea. |
| [getEndArrowheadWidth()](#getEndArrowheadWidth--) | Restituisce o imposta la larghezza della punta di freccia alla fine di una linea. |
| [setEndArrowheadWidth(byte value)](#setEndArrowheadWidth-byte-) | Restituisce o imposta la larghezza della punta di freccia alla fine di una linea. |
| [getBeginArrowheadLength()](#getBeginArrowheadLength--) | Restituisce o imposta la lunghezza della punta di freccia all'inizio di una linea. |
| [setBeginArrowheadLength(byte value)](#setBeginArrowheadLength-byte-) | Restituisce o imposta la lunghezza della punta di freccia all'inizio di una linea. |
| [getEndArrowheadLength()](#getEndArrowheadLength--) | Restituisce o imposta la lunghezza della punta di freccia alla fine di una linea. |
| [setEndArrowheadLength(byte value)](#setEndArrowheadLength-byte-) | Restituisce o imposta la lunghezza della punta di freccia alla fine di una linea. |
| [equals(ILineFormat lineFormat)](#equals-com.aspose.slides.ILineFormat-) | Determina se le due istanze di LineFormat sono uguali. |
| [getEffective()](#getEffective--) | Ottiene i dati di formattazione effective della linea con l'ereditarietà applicata. |
### getVersion() {#getVersion--}
```
...
Restituisce true se il formato della linea non è definito (come appena creato, predefinito). Sola lettura  boolean .
...
Restituisce il formato di riempimento di una linea. Sola lettura [ILineFillFormat](../../com.aspose.slides/ilinefillformat).
...
Restituisce il formato di schizzo di una linea. Sola lettura [ILineFillFormat](../../com.aspose.slides/ilinefillformat).
...
Restituisce o imposta lo stile della punta di freccia all'inizio di una linea. Lettura/Scrittura [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
Restituisce o imposta lo stile della punta di freccia alla fine di una linea. Lettura/Scrittura [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
Restituisce o imposta la larghezza della punta di freccia all'inizio di una linea. Lettura/Scrittura [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
Restituisce o imposta la larghezza della punta di freccia alla fine di una linea. Lettura/Scrittura [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
Restituisce o imposta la lunghezza della punta di freccia all'inizio di una linea. Lettura/Scrittura [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
Restituisce o imposta la lunghezza della punta di freccia alla fine di una linea. Lettura/Scrittura [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| lineFormat | [ILineFormat](../../com.aspose.slides/ilineformat) | Il LineFormat da confrontare con l'istanza corrente. |

**Restituisce:**
boolean - **true** se il LineFormat specificato è uguale a quello corrente; altrimenti, **false**.
### getEffective() {#getEffective--}
```
public final ILineFormatEffectiveData getEffective()
```

Ottiene i dati di formattazione effective della linea con l'ereditarietà applicata.
