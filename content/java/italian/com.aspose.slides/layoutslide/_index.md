...
| [getPlaceholderManager()](#getPlaceholderManager--) | Restituisce il gestore placeholder della diapositiva di layout. |
...
| [getShowMasterShapes()](#getShowMasterShapes--) | Specifica se le forme sulla diapositiva master devono essere mostrate sulle diapositive o no. |
| [setShowMasterShapes(boolean value)](#setShowMasterShapes-boolean-) | Specifica se le forme sulla diapositiva master devono essere mostrate sulle diapositive o no. |
| [getDrawingGuides()](#getDrawingGuides--) | Restituisce una raccolta di guide di disegno per la diapositiva di layout. |
...
Restituisce il gestore placeholder della diapositiva di layout. Solo lettura [ILayoutPlaceholderManager](../../com.aspose.slides/ilayoutplaceholdermanager).
...
Specifica se le forme sulla diapositiva master devono essere mostrate sulle diapositive o no. Lettura/scrittura boolean.
...
Restituisce una raccolta di guide di disegno per la diapositiva di layout. Solo lettura [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
