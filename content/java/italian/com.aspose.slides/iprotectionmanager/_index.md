...
Questa proprietà ha senso, se la presentazione è protetta da password. Se true allora le proprietà del documento sono crittografate nel file della presentazione. Se false allora le proprietà del documento sono pubbliche mentre la presentazione è crittografata. Booleano di lettura/scrittura.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| password | java.lang.String | La password per il controllo.
