...
Restituisce un oggetto di proprietà di riempimento della tabella. Sola lettura [IFillFormat](../../com.aspose.slides/ifillformat).
...
>  Si noti che la formattazione delle celle ha sempre priorità più alta rispetto alla formattazione delle righe, la riga - più alta della colonna, la colonna - più alta dell'intera tabella.
>  Pertanto, le proprietà CellFormatEffectiveData sono sempre utilizzate per disegnare la tabella. Il seguente codice è solo un esempio di API.
>  
