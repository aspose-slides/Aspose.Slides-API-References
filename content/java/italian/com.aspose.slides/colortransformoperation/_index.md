...
| [Shade](#Shade) | Oscura il colore. |
| [Complement](#Complement) | Cambia il colore in uno complementare RGB. |
| [Inverse](#Inverse) | Cambia il colore in un colore invertito. |
| [Grayscale](#Grayscale) | Cambia il colore in un grigio con la stessa luminosità. |
...
| [SetHue](#SetHue) | Cambia il componente tonalità del colore al valore di un parametro. |
| [AddHue](#AddHue) | Aggiunge il valore di un parametro al componente tonalità del colore. |
| [MultiplyHue](#MultiplyHue) | Moltiplica un componente tonalità per il valore di un parametro. |
| [SetSaturation](#SetSaturation) | Cambia il componente saturazione del colore al valore di un parametro. |
...
| [SetLuminance](#SetLuminance) | Cambia il componente luminanza del colore al valore di un parametro. |
...
| [SetRed](#SetRed) | Cambia il componente rosso del colore al valore di un parametro. |
...
| [SetGreen](#SetGreen) | Cambia il componente verde del colore al valore di un parametro. |
...
| [SetBlue](#SetBlue) | Cambia il componente blu del colore al valore di un parametro. |
...
Oscura il colore. Il parametro è compreso tra 0 (colore originale) e 1 (nero).
...
Cambia il colore in uno complementare RGB. m = Max(r, g, b); r = m - r; g = m - g; b = m - b;
...
Cambia il colore in un colore invertito. r = 1 - r; g = 1 - g; b = 1 - b;
...
Cambia il colore in un grigio con la stessa luminosità. Il parametro è ignorato.
...
Cambia il componente tonalità del colore al valore di un parametro. Il parametro è compreso tra 0 e 360.
...
Aggiunge il valore di un parametro al componente tonalità del colore. Il parametro è compreso tra -360 e 360.
...
Cambia il componente saturazione del colore al valore di un parametro. Il parametro è compreso tra 0 e 1.
...
Cambia il componente luminanza del colore al valore di un parametro. Il parametro è compreso tra 0 e 1.
...
Cambia il componente rosso del colore al valore di un parametro. Il parametro è compreso tra 0 e 1.
...
Cambia il componente verde del colore al valore di un parametro. Il parametro è compreso tra 0 e 1.
...
Cambia il componente blu del colore al valore di un parametro. Il parametro è compreso tra 0 e 360.
...
Correzione gamma. Il parametro è ignorato.
...
Correzione gamma inversa. Il parametro è ignorato.