...
| Metodo | Descrizione |
| --- | --- |
| [get_Item(int columnIndex, int rowIndex)](#get-Item-int-int-) | Restituisce la cella negli indici di colonna e riga specificati. |
...
| [getStylePreset()](#getStylePreset--) | Ottiene o imposta lo stile di tabella predefinito. |
| [setStylePreset(int value)](#setStylePreset-int-) | Ottiene o imposta lo stile di tabella predefinito. |
...
| [setTextFormat(IPortionFormat source)](#setTextFormat-com.aspose.slides.IPortionFormat-) | Imposta le proprietà di formattazione delle porzioni definite a tutte le porzioni delle celle della tabella. |
| [setTextFormat(IParagraphFormat source)](#setTextFormat-com.aspose.slides.IParagraphFormat-) | Imposta le proprietà di formattazione dei paragrafi definite a tutti i paragrafi delle celle della tabella. |
| [setTextFormat(ITextFrameFormat source)](#setTextFormat-com.aspose.slides.ITextFrameFormat-) | Imposta le proprietà di formattazione del frame di testo definite a tutti i frame di testo delle celle della tabella. |
...
Restituisce la cella negli indici di colonna e riga specificati. Solo lettura [Cell](../../com.aspose.slides/cell).
...
Ottiene o imposta lo stile di tabella predefinito. Lettura/scrittura [TableStylePreset](../../com.aspose.slides/tablestylepreset).
...
Imposta le proprietà di formattazione delle porzioni definite a tutte le porzioni delle celle della tabella.
...
Imposta le proprietà di formattazione dei paragrafi definite a tutti i paragrafi delle celle della tabella.
...
Imposta le proprietà di formattazione del frame di testo definite a tutti i frame di testo delle celle della tabella.
