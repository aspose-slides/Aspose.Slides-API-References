...
description: Definisce un piano in cui gli effetti come bagliore e ombra sono applicati in relazione alla forma a cui vengono applicati.
type: docs
...
Restituisce o imposta un vettore normale. Per essere più preciso, questo attributo definisce un vettore perpendicolare alla faccia del piano di sfondo. Vettore rappresentato da un array di 3 valori float che definiscono le coordinate X, Y e Z. Lettura/scrittura float[].
...
Restituisce o imposta un vettore che rappresenta l'alto. Per essere più preciso, questo attributo definisce un vettore che rappresenta l'alto rispetto alla faccia del piano di sfondo. Vettore rappresentato da un array di 3 valori float che definiscono le coordinate X, Y e Z. Lettura/scrittura float[].
