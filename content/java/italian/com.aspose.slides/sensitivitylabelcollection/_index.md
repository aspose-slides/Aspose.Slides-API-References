...
| [add(ISensitivityLabel label)](#add-com.aspose.slides.ISensitivityLabel-) | Aggiunge un SensitivityLabel alla raccolta. |
...
| [copyTo(ISensitivityLabel[] array, int index)](#copyTo-com.aspose.slides.ISensitivityLabel---int-) | Copia tutti gli elementi dalla raccolta nell'array specificato. |
...
**Restituisce:**
int - L'indice al quale il SensitivityLabel è stato aggiunto.
