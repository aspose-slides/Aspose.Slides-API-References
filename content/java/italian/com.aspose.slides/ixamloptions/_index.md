...
| Metodo | Descrizione |
| --- | --- |
| [getExportHiddenSlides()](#getExportHiddenSlides--) | Determina se le slide nascoste verranno esportate. |
| [setExportHiddenSlides(boolean value)](#setExportHiddenSlides-boolean-) | Determina se le slide nascoste verranno esportate. |
...
Determina se le slide nascoste verranno esportate.
