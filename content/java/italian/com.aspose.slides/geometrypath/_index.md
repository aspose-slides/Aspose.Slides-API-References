...
| [moveTo(Point2D.Float point)](#moveTo-java.awt.geom.Point2D.Float-) | Imposta la posizione del punto successivo. |
...
| --- | --- | --- |
| index | int | Indice del percorso geometrico da eliminare. |
...
| startAngle | float | Angolo iniziale. |
