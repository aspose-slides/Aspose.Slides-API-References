...
| [getLabel()](#getLabel--) | Rappresenta l'etichetta dei dati del livello del punto dati. |
### getFormat() {#getFormat--}
```
...
Rappresenta l'etichetta dei dati del livello del punto dati. Applicato ai tipi di serie Treemap e Sunburst. Solo lettura [IDataLabel](../../com.aspose.slides/idatalabel).
