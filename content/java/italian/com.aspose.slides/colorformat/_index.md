...
type: docs
url: /it/com.aspose.slides/colorformat/
---
**Eredità:**  
...
| [getColor()](#getColor--) | Restituisce il colore risultante (con tutte le trasformazioni di colore applicate). |
| [setColor(Color value)](#setColor-java.awt.Color-) | Restituisce il colore risultato (con tutte le trasformazioni di colore applicate). |
| [getPresetColor()](#getPresetColor--) | Restituisce o imposta il preset colore. |
| [setPresetColor(int value)](#setPresetColor-int-) | Restituisce o imposta il preset colore. |
...
| [getSchemeColor()](#getSchemeColor--) | Restituisce o imposta il colore identificato da uno schema colore. |
| [setSchemeColor(int value)](#setSchemeColor-int-) | Restituisce o imposta il colore identificato da uno schema colore. |
...
| [getHue()](#getHue--) | Restituisce o imposta la componente tonalità di un colore nella rappresentazione HSL. |
| [setHue(float value)](#setHue-float-) | Restituisce o imposta la componente tonalità di un colore nella rappresentazione HSL. |
| [getSaturation()](#getSaturation--) | Restituisce o imposta la componente saturazione di un colore nella rappresentazione HSL. |
| [setSaturation(float value)](#setSaturation-float-) | Restituisce o imposta la componente saturazione di un colore nella rappresentazione HSL. |
| [getLuminance()](#getLuminance--) | Restituisce o imposta la componente luminanza di un colore nella rappresentazione HSL. |
| [setLuminance(float value)](#setLuminance-float-) | Restituisce o imposta la componente luminanza di un colore nella rappresentazione HSL. |
| [getColorTransform()](#getColorTransform--) | Restituisce la raccolta delle trasformazioni colore applicate a un colore. |
...
| [equals(Object obj)](#equals-java.lang.Object-) | Verifica l'uguaglianza con l'oggetto specificato. |
...
Restituisce il colore risultante (con tutte le trasformazioni di colore applicate). Imposta i colori RGB e cancella tutte le trasformazioni colore. Lettura/scrittura java.awt.Color.
...
Restituisce o imposta il preset colore. Lettura/scrittura [PresetColor](../../com.aspose.slides/presetcolor).
...
Restituisce o imposta il colore identificato da uno schema colore. Lettura/scrittura [SchemeColor](../../com.aspose.slides/schemecolor).
...
Restituisce o imposta la componente verde di un colore. Tutte le trasformazioni colore sono ignorate.
...
Restituisce o imposta la componente tonalità di un colore nella rappresentazione HSL. Tutte le trasformazioni colore sono ignorate. Lettura/scrittura float.
...
Restituisce o imposta la componente saturazione di un colore nella rappresentazione HSL. Tutte le trasformazioni colore sono ignorate. Lettura/scrittura float.
...
Restituisce o imposta la componente luminanza di un colore nella rappresentazione HSL. Tutte le trasformazioni colore sono ignorate. Lettura/scrittura float.
...
Restituisce la raccolta delle trasformazioni colore applicate a un colore. Solo lettura [IColorOperationCollection](../../com.aspose.slides/icoloroperationcollection).
