...
| [indexOf(IChartCategory value)](#indexOf-com.aspose.slides.IChartCategory-) | Cerca il [IChartCategory](../../com.aspose.slides/ichartcategory) specificato e restituisce l'indice basato su zero della prima occorrenza nell'intera Collection |
...
Se true, il foglio di lavoro è usato per memorizzare le categorie (questo caso supporta categorie a più livelli). Se false, il foglio di lavoro NON è usato per memorizzare i valori (e questo caso non supporta categorie a più livelli). Booleano read/write.
...
Restituisce il conteggio dei livelli di raggruppamento delle categorie utilizzati. È più di uno per categorie a più livelli. int read-only.
...
Questo metodo aggiunge un foglio di lavoro con nome AUTO_DATA e vi aggiunge tutti i valori. Se utilizzi [IChartDataWorkbook](../../com.aspose.slides/ichartdataworkbook) per aggiungere o modificare i valori delle celle, assicurati di non utilizzare questo foglio di lavoro. Il numero massimo di valori aggiunti con questo metodo non deve superare 16711680 |
...
Cerca il [IChartCategory](../../com.aspose.slides/ichartcategory) specificato e restituisce l'indice basato su zero della prima occorrenza nell'intera Collection
