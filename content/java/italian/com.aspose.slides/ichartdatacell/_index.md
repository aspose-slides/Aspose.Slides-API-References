...
| [getPresetNumberFormat()](#getPresetNumberFormat--) | Ottiene o imposta il formato di visualizzazione integrato di numeri e date. |
| [setPresetNumberFormat(byte value)](#setPresetNumberFormat-byte-) | Ottiene o imposta il formato di visualizzazione integrato di numeri e date. |
...
Restituisce l'indice della riga del foglio di lavoro in cui si trova la cella. Sola lettura int.
...
Restituisce l'indice della colonna del foglio di lavoro in cui si trova la cella. Sola lettura int.
...
Ottiene il foglio di lavoro. Sola lettura [IChartDataWorksheet](../../com.aspose.slides/ichartdataworksheet).
...
Determina se la cella è nascosta. Sola lettura boolean.
...
Ottiene o imposta il formato di visualizzazione integrato di numeri e date. Il numero predefinito deve essere in [0..22] o [37..49]. Lettura/scrittura byte.
...
| Parameter | Type | Description |
| --- | --- | --- |
| updateValues | boolean | Se false, nessun calcolo reale verrà eseguito. Usare true per il controllo di eventuali eccezioni. |