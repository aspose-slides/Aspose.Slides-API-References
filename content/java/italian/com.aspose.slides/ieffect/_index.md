...
>      {
>          // Cambia il suono del secondo effetto Enhancements/Sound in "Stop Previous Sound"
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Cambia l'animazione dopo l'effetto in "Hide on Next Mouse Click"
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Cambia il tipo di animazione dopo l'effetto in "Color"
>      firstSlideEffect.setAfterAnimationType(AfterAnimationType.Color);
> 
>      // Imposta il colore di animazione dopo l'effetto.
...
Definisce un tipo di animazione del testo per l'effetto. Il testo della forma può essere animato per lettera, per parola o tutto insieme. Lettura/Scrittura AnimateTextType (\#getAnimateTextType.getAnimateTextType/\#setAnimateTextType(int).setAnimateTextType(int)).
