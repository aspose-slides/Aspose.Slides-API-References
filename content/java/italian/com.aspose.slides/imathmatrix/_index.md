...
| [getHidePlaceholders()](#getHidePlaceholders--) | Nascondi i segnaposti per gli elementi vuoti della matrice Predefinito: false |
| [setHidePlaceholders(boolean value)](#setHidePlaceholders-boolean-) | Nascondi i segnaposti per gli elementi vuoti della matrice Predefinito: false |
...
| --- | --- | --- |
| row | int | L'indice basato su zero della riga da ottenere |
| column | int | L'indice basato su zero della colonna da ottenere |
...
Larghezza minima della colonna in twip (1/20 di punto). La spaziatura di interruzione (nota anche come \u201cColumn Gap\u201d o \u201cGap Width\u201d) viene aggiunta a MinColumnWidth per determinare la spaziatura totale delle colonne della matrice (distanza tra gli stessi bordi di colonne diverse). Predefinito: 0.
...
Il valore della spaziatura orizzontale tra le colonne di una matrice; se ColumnGapRule è impostato a 3 ("Exactly"), l'unità è interpretata come twip (1/20 di punto). Se ColumnGapRule è impostato a 4 ("Multiple"), l'unità è interpretata come numero di incrementi di 0.5 em. In altri casi è ignorato. Predefinito: 0
...
| columnsCount | long | Numero di colonne per le quali impostare l'allineamento |
| val | int | Nuovo valore dell'allineamento orizzontale della colonna specificata |
