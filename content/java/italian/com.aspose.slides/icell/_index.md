...
| [getColSpan()](#getColSpan--) | Restituisce il numero di colonne della griglia della tabella genitore che devono essere coperte dalla cella corrente. |
| [getRowSpan()](#getRowSpan--) | Restituisce il numero di righe coperte da una cella unita. |
...
| [isMergedCell()](#isMergedCell--) | Restituisce true se la cella è unita con un'altra cella, false altrimenti. |
| [getCellFormat()](#getCellFormat--) | Restituisce l'oggetto CellFormat che contiene le proprietà di formattazione per questa cella. |
| [splitByColSpan(int index)](#splitByColSpan-int-) | Divide la cella in due celle in base all'indice della colonna. |
| [splitByRowSpan(int index)](#splitByRowSpan-int-) | Divide la cella in due celle in base all'indice della riga. |
...
Restituisce il numero di colonne della griglia della tabella genitore che devono essere coperte dalla cella corrente. Questa proprietà consente alle celle di apparire unite, poiché si estendono su confini verticali di altre celle nella tabella. Solo lettura int.
...
Restituisce il numero di righe coperte da una cella unita. Viene usato in combinazione con l'attributo vMerge su altre celle per specificare la cella iniziale di un'unione orizzontale. Solo lettura int.
...
Restituisce true se la cella è unita con un'altra cella, false altrimenti. Solo lettura boolean.
...
Divide la cella in due celle in base all'indice della colonna.
