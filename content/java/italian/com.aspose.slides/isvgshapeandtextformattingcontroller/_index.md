...
description: Controlla la forma SVG e la generazione del testo.
type: docs
...
Controlla la forma SVG e la generazione del testo.
...
| Metodo | Descrizione |
| --- | --- |
| [formatText(ISvgTSpan svgTSpan, IPortion portion, ITextFrame textFrame)](#formatText-com.aspose.slides.ISvgTSpan-com.aspose.slides.IPortion-com.aspose.slides.ITextFrame-) | Questa funzione viene chiamata prima del rendering della parte di testo in SVG per consentire all'utente di controllare l'SVG risultante. |
...
Questa funzione viene chiamata prima del rendering della parte di testo in SVG per consentire all'utente di controllare l'SVG risultante.
