...
description: Oggetto immutabile che contiene le proprietà di formattazione di riempimento effettive.
type: docs
...
Questa interfaccia è usata insieme all'interfaccia [IFillFormat](../../com.aspose.slides/ifillformat) per restituire i valori di formattazione effettivi con l'ereditarietà applicata.
## Metodi
...
| [getSolidFillSchemeColor()](#getSolidFillSchemeColor--) | Ottiene il colore di riempimento definito da uno schema colore. |
...
Restituisce il colore di riempimento. Solo lettura java.awt.Color.
...
Ottiene il colore di riempimento definito da uno schema colore. Il valore [SchemeColor.NotDefined](../../com.aspose.slides/schemecolor\#NotDefined) indica che il SolidFillColor (\#getSolidFillColor.getSolidFillColor) non è un colore di schema. Solo lettura [SchemeColor](../../com.aspose.slides/schemecolor).
...
Restituisce il formato di riempimento gradiente. Solo lettura [IGradientFormatEffectiveData](../../com.aspose.slides/igradientformateffectivedata).
