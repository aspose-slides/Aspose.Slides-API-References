...
| Metodo | Descrizione |
| --- | --- |
| [save(String filename)](#save-java.lang.String-) | Salva l'immagine su un file. |
| [save(String filename, int format)](#save-java.lang.String-int-) | Salva l'immagine su un file nel formato specificato. |
| [save(OutputStream stream, int format)](#save-java.io.OutputStream-int-) | Salva l'immagine su uno stream nel formato specificato. |
| [save(String filename, int format, int quality)](#save-java.lang.String-int-int-) | Salva l'immagine su un file nel formato e nella qualità specificati. |
| [save(OutputStream stream, int format, int quality)](#save-java.io.OutputStream-int-int-) | Salva l'immagine su uno stream nel formato e nella qualità specificati. |
...
| --- | --- | --- |
| filename | java.lang.String | Il percorso del file in cui l'immagine sarà salvata. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| stream | java.io.OutputStream | Lo stream in cui l'immagine sarà salvata. |
| format | int | Il formato dell'immagine. |
...
Salva l'immagine su un file nel formato e nella qualità specificati.
