...
L'eccezione che viene generata quando viene rilevato un riferimento di cella non valido.
## Costruttori
...
| Metodo | Descrizione |
| --- | --- |
| [getReference()](#getReference--) | Ottiene un riferimento di cella non valido. |
...
Ottiene un riferimento di cella non valido.
