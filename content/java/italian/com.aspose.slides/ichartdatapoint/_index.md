...
| [getErrorBarsCustomValues()](#getErrorBarsCustomValues--) | Rappresenta i valori delle barre di errore della serie in caso di tipo di valore Custom. |
...
| [getAutomaticDataPointColor()](#getAutomaticDataPointColor--) | Restituisce un colore automatico del punto dati basato sull'indice della serie, sull'indice del punto dati, sulla proprietà ParentSeriesGroup.IsColorVaried e sullo stile del grafico. |
| [getRelatedLegendEntry()](#getRelatedLegendEntry--) | Proprietà della voce della legenda corrispondente nel caso di un tipo di grafico da questo elenco: ChartType.BarOfPie, ChartType.ExplodedPie, ChartType.ExplodedPie3D, ChartType.Pie, ChartType.Pie3D, ChartType.PieOfPie. |
...
Restituisce il valore x del punto dati del grafico. Sola lettura [IStringOrDoubleChartValue](../../com.aspose.slides/istringordoublechartvalue).
...
Restituisce il valore y del punto dati del grafico. Sola lettura [IDoubleChartValue](../../com.aspose.slides/idoublechartvalue).
...
Restituisce la dimensione della bolla del punto dati del grafico. Sola lettura [IDoubleChartValue](../../com.aspose.slides/idoublechartvalue).
...
Restituisce il valore del punto dati del grafico. Sola lettura [IDoubleChartValue](../../com.aspose.slides/idoublechartvalue).
...
Restituisce il valore di dimensione del punto dati del grafico. Usato con i grafici Treemap e Sunburst. Sola lettura [IDoubleChartValue](../../com.aspose.slides/idoublechartvalue).
...
Restituisce il valore di colore del punto dati del grafico. Usato con i grafici Map. Sola lettura [IDoubleChartValue](../../com.aspose.slides/idoublechartvalue).
...
Rappresenta i valori delle barre di errore della serie in caso di tipo di valore Custom. Sola lettura [IErrorBarsCustomValues](../../com.aspose.slides/ierrorbarscustomvalues).
...
Rappresenta l'etichetta del punto dati del grafico. Sola lettura [IDataLabel](../../com.aspose.slides/idatalabel).
...
Specifica la quantità con cui il punto dati deve essere spostato dal centro della torta. Lettura/Scrittura int.
...
Specifica un marcatore dati. Sola lettura [IMarker](../../com.aspose.slides/imarker).
...
Restituisce un colore automatico del punto dati basato sull'indice della serie, sull'indice del punto dati, sulla proprietà ParentSeriesGroup.IsColorVaried e sullo stile del grafico. Questo colore è usato per impostazione predefinita se FillType è uguale a NotDefined.

**Restituisce:**
java.awt.Color - Colore automatico del punto dati java.awt.Color
### getRelatedLegendEntry() {#getRelatedLegendEntry--}
```
public abstract ILegendEntryProperties getRelatedLegendEntry()
```

Proprietà della voce della legenda corrispondente nel caso di un tipo di grafico da questo elenco: ChartType.BarOfPie, ChartType.ExplodedPie, ChartType.ExplodedPie3D, ChartType.Pie, ChartType.Pie3D, ChartType.PieOfPie. Sola lettura [ILegendEntryProperties](../../com.aspose.slides/ilegendentryproperties).
