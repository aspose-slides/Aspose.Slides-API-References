...
| [hashCode()](#hashCode--) | Calcola e restituisce il codice hach basato sulla proprietà (\#getValue.getValue) |
| [getOrCreateByValue(String propertyValue)](#getOrCreateByValue-java.lang.String-) | Cerca una proprietà di comportamento esistente per valore o ne crea una nuova personalizzata con il valore specificato |
...
**Restituisce:**
int - Restituisce il codice hash per questo oggetto
...
**Restituisce:**
[BehaviorProperty](../../com.aspose.slides/behaviorproperty) - istanza di BehaviorProperty