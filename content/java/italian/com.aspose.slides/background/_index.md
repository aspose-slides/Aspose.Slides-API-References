...
| Metodo | Descrizione |
| --- | --- |
| [getType()](#getType--) | Restituisce un tipo di riempimento dello sfondo. |
| [setType(byte value)](#setType-byte-) | Restituisce un tipo di riempimento dello sfondo. |
...
Restituisce un tipo di riempimento dello sfondo. Lettura/scrittura [BackgroundType](../../com.aspose.slides/backgroundtype).
