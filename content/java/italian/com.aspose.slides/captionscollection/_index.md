...
Restituisce i sottotitoli chiusi all'indice specificato. Sola lettura [ICaptions](../../com.aspose.slides/icaptions).
...
| --- | --- | --- |
| label | java.lang.String | L'etichetta dei sottotitoli chiusi. |
| stream | java.io.InputStream | Lo stream di input contenente dati nel formato WebVTT. |
