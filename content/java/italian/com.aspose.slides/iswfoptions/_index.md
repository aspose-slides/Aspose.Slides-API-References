...
type: docs
url: /it/com.aspose.slides/iswfoptions/
---
...
| Metodo | Descrizione |
| --- | --- |
| [getCompressed()](#getCompressed--) | Specifica se il documento SWF generato deve essere compresso o meno. |
| [setCompressed(boolean value)](#setCompressed-boolean-) | Specifica se il documento SWF generato deve essere compresso o meno. |
| [getViewerIncluded()](#getViewerIncluded--) | Specifica se il documento SWF generato deve includere il visualizzatore di documenti integrato o meno. |
| [setViewerIncluded(boolean value)](#setViewerIncluded-boolean-) | Specifica se il documento SWF generato deve includere il visualizzatore di documenti integrato o meno. |
| [getShowPageBorder()](#getShowPageBorder--) | Specifica se il bordo attorno alle pagine deve essere mostrato. |
| [setShowPageBorder(boolean value)](#setShowPageBorder-boolean-) | Specifica se il bordo attorno alle pagine deve essere mostrato. |
...
| [getShowTopPane()](#getShowTopPane--) | Mostra/nascondi pannello superiore completo. |
| [setShowTopPane(boolean value)](#setShowTopPane-boolean-) | Mostra/nascondi pannello superiore completo. |
...
| [getStartOpenLeftPane()](#getStartOpenLeftPane--) | Avvia con il pannello sinistro aperto. |
| [setStartOpenLeftPane(boolean value)](#setStartOpenLeftPane-boolean-) | Avvia con il pannello sinistro aperto. |
| [getEnableContextMenu()](#getEnableContextMenu--) | Abilita/disabilita il menu contestuale. |
| [setEnableContextMenu(boolean value)](#setEnableContextMenu-boolean-) | Abilita/disabilita il menu contestuale. |
...
| [getLogoLink()](#getLogoLink--) | Ottiene o imposta l'indirizzo hyperlink completo per un logo. |
| [setLogoLink(String value)](#setLogoLink-java.lang.String-) | Ottiene o imposta l'indirizzo hyperlink completo per un logo. |
...
Specifica se il documento SWF generato deve includere il visualizzatore di documenti integrato o meno. Il valore predefinito è true.
...
Specifică? Actually Italian: "Specifica se il bordo attorno alle pagine deve essere mostrato. Il valore predefinito è true."
...
Specifică? Italian: "Specifica se il documento generato deve includere le diapositive nascoste o meno. Il valore predefinito è false."
...
Mostra/nascondi pannello superiore completo. Può essere sovrascritto in flashvars. Il valore predefinito è true.
...
Avvia con il pannello sinistro aperto. Può essere sovrascritto in flashvars. Il valore predefinito è false.
...
Immagine che verrà visualizzata come logo nell'angolo in alto a destra del visualizzatore. L'immagine deve essere un PNG di 32 × 64 pixel, altrimenti il logo potrebbe essere visualizzato in modo errato.
...
Ottiene o imposta l'indirizzo hyperlink completo per un logo. Ha effetto solo se è specificato un (\#getLogoImageBytes.getLogoImageBytes/\#setLogoImageBytes(byte[]).setLogoImageBytes(byte[])).
...
Specifică? Italian: "Specifica la qualità delle immagini JPEG. Il valore predefinito è 95."
