...
| [getLevel(int index)](#getLevel-int-) | Se esiste il livello di stile lo restituisce, altrimenti restituisce null. |
| [getDefaultParagraphFormat()](#getDefaultParagraphFormat--) | Proprietà predefinite del paragrafo. |
| [getEffective()](#getEffective--) | Ottiene i dati di formattazione efficace dello stile del testo con l'ereditarietà applicata. |
### getVersion() {#getVersion--}
```
...
Se esiste il livello di stile lo restituisce, altrimenti restituisce null.
...
Proprietà predefinite del paragrafo. Di sola lettura [IParagraphFormat](../../com.aspose.slides/iparagraphformat).
...
Ottiene i dati di formattazione efficace dello stile del testo con l'ereditarietà applicata.
