...
True per convertire tutti i metafili usati in una presentazione in immagini PNG. Read/write booleano.
...
True per disegnare una cornice nera attorno a ogni diapositiva. Read/write booleano.
