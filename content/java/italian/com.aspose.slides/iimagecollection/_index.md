...
description: Rappresenta la raccolta di PPImage.
type: docs
...
| [addImage(InputStream stream)](#addImage-java.io.InputStream-) | Aggiunge un'immagine a una presentazione da uno stream. |
| [addImage(InputStream stream, int loadingStreamBehavior)](#addImage-java.io.InputStream-int-) | Crea e aggiunge un'immagine a una presentazione da uno stream. |
