...
La classe di controller di formattazione da utilizzare per l'incorporamento dei font in formato EOT
## Costruttori
...
Chiamato per scrivere il piede del documento html. Chiamato una volta per conversione della presentazione.
...
Chiamato per scrivere il piede della diapositiva html. Chiamato una volta per ciascuna diapositiva.
...
Chiamato prima del rendering della shape. Chiamato una volta per ciascuna shape. Se questa funzione scrive qualcosa nel generator, la generazione dell'immagine della diapositiva corrente sarà terminata, il frammento html aggiunto sarà inserito e una nuova immagine sarà avviata sopra la precedente.
