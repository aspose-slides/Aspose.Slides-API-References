...
description: Il grafico opera con un set limitato di proprietà di formato del testo.
type: docs
...
Il grafico opera con un set limitato di proprietà di formato del testo. Le interfacce IChartTextFormat, IChartTextBlockFormat, IChartParagraphFormat, IChartPortionFormat descrivono questo set limitato.
## Metodi
...
Restituisce il formato per gli elementi di testo del grafico. Sola lettura [IChartTextBlockFormat](../../com.aspose.slides/icharttextblockformat).
...
Restituisce il formato del paragrafo. Sola lettura [IChartParagraphFormat](../../com.aspose.slides/ichartparagraphformat).
...
Restituisce il formato della porzione. Sola lettura [IChartPortionFormat](../../com.aspose.slides/ichartportionformat).
...
| --- | --- | --- |
| destTextFrame | [ITextFrame](../../com.aspose.slides/itextframe) | Frame di testo a cui copiare il formato del testo. |
