...
| Metodo | Descrizione |
| --- | --- |
| [getAllNodes()](#getAllNodes--) | Restituisce le raccolte di tutti i nodi nell'oggetto SmartArt. |
| [getNodes()](#getNodes--) | Restituisce le raccolte dei nodi radice nell'oggetto SmartArt. |
...
| [isReversed()](#isReversed--) | Restituisce o imposta lo stato del diagramma SmartArt riguardo a (da sinistra a destra) LTR o (da destra a sinistra) RTL, se il diagramma supporta l'inversione. |
| [setReversed(boolean value)](#setReversed-boolean-) | Restituisce o imposta lo stato del diagramma SmartArt riguardo a (da sinistra a destra) LTR o (da destra a sinistra) RTL, se il diagramma supporta l'inversione. |
...
Restituisce le raccolte di tutti i nodi nell'oggetto SmartArt. Solo lettura [ISmartArtNodeCollection](../../com.aspose.slides/ismartartnodecollection).
...
Restituisce le raccolte dei nodi radice nell'oggetto SmartArt. Solo lettura [ISmartArtNodeCollection](../../com.aspose.slides/ismartartnodecollection).
...
Restituisce o imposta lo stato del diagramma SmartArt riguardo a (da sinistra a destra) LTR o (da destra a sinistra) RTL, se il diagramma supporta l'inversione. Lettura/Scrittura boolean.
