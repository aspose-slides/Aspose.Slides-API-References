...
| Metodo | Descrizione |
| --- | --- |
| [isEmpty()](#isEmpty--) | Il valore true indica che ColorScheme, FontScheme, FormatScheme è null e qualsiasi sovrascrittura con questo oggetto tema è disabilitata. |
...
| [clear()](#clear--) | Imposta ColorScheme, FontScheme, FormatScheme a null per disabilitare qualsiasi sovrascrittura con questo oggetto tema. |
### isEmpty() {#isEmpty--}
```
...
Il valore true indica che ColorScheme, FontScheme, FormatScheme è null e qualsiasi sovrascrittura con questo oggetto tema è disabilitata. Solo lettura boolean.
