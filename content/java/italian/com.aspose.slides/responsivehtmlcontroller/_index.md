...
| --- | --- | --- |
| controller | [IHtmlFormattingController](../../com.aspose.slides/ihtmlformattingcontroller) |  |
...
Chiamato prima del rendering della shape. Chiamato una volta per ciascuna shape. Se questa funzione scrive qualcosa nel generator, la generazione dell'immagine della diapositiva corrente sarà completata, il frammento html aggiunto sarà inserito e una nuova immagine verrà avviata sopra la precedente.
