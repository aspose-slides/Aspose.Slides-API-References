...
| [getSlide()](#getSlide--) | Restituisce la diapositiva padre dell'immagine. |
### getParent_Immediate() {#getParent-Immediate--}
```
...
Restituisce la diapositiva padre di un'immagine. Solo lettura [IBaseSlide](../../com.aspose.slides/ibaseslide).
