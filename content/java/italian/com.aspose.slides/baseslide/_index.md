...
| [getControls()](#getControls--) | Restituisce la raccolta di controlli ActiveX su una diapositiva. |
...
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | Unisce le porzioni con la stessa formattazione in tutti i paragrafi di tutte le forme accettabili. |
| [joinPortionsWithSameFormatting(IShapeCollection collection)](#joinPortionsWithSameFormatting-com.aspose.slides.IShapeCollection-) | Unisce le porzioni con la stessa formattazione in tutti i paragrafi di tutte le forme accettabili. |
| [createThemeEffective()](#createThemeEffective--) | Restituisce un tema effettivo per questa diapositiva. |
...
Restituisce la raccolta di controlli ActiveX su una diapositiva. Solo lettura [IControlCollection](../../com.aspose.slides/icontrolcollection).
...
Unisce le porzioni con la stessa formattazione in tutti i paragrafi di tutte le forme accettabili.
...
Restituisce un tema effettivo per questa diapositiva.
...
Specifica se le forme sulla diapositiva master devono essere visualizzate sulle diapositive o meno. Per la diapositiva master stessa questa proprietà restituisce sempre false. Lettura/Scrittura boolean.
...
**Restituisce:**  
[IShape](../../com.aspose.slides/ishape) - Shape object o null.
### getParent_Immediate() {#getParent-Immediate--}
```
