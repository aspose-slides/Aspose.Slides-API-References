...
| Metodo | Descrizione |
| --- | --- |
| [isEncrypted()](#isEncrypted--) | Restituisce True se la presentazione associata è crittografata, altrimenti False. |
| [isPasswordProtected()](#isPasswordProtected--) | Restituisce un valore che indica se la presentazione associata è protetta da una password per l'apertura. |
| [isWriteProtected()](#isWriteProtected--) | Restituisce un valore che indica se la presentazione associata è protetta da scrittura. |
| [getLoadFormat()](#getLoadFormat--) | Restituisce il formato della presentazione associata. |
...
| [readDocumentProperties()](#readDocumentProperties--) | Restituisce le proprietà del documento della presentazione associata. |
| [updateDocumentProperties(IDocumentProperties documentProperties)](#updateDocumentProperties-com.aspose.slides.IDocumentProperties-) | Aggiorna le proprietà della presentazione associata. |
| [writeBindedPresentation(OutputStream stream)](#writeBindedPresentation-java.io.OutputStream-) | Scrive la presentazione associata in uno stream. |
| [writeBindedPresentation(String file)](#writeBindedPresentation-java.lang.String-) | Scrive la presentazione associata su file. |
### isEncrypted() {#isEncrypted--}
```
public abstract boolean isEncrypted()
```

Restituisce True se la presentazione associata è crittografata, altrimenti False. Booleano sola lettura.
...
Restituisce un valore che indica se la presentazione associata è protetta da una password per l'apertura.
...
Restituisce un valore che indica se la presentazione associata è protetta da scrittura.
...
Restituisce il formato della presentazione associata. [LoadFormat](../../com.aspose.slides/loadformat) sola lettura.
...
**Restituisce:**
boolean - True se la presentazione è protetta da password di apertura e la password è corretta, altrimenti false.
...
1. È consigliato verificare la proprietà (\#isWriteProtected.isWriteProtected) prima di chiamare questo metodo. 2. Quando la password è null o vuota, questo metodo restituisce false. |
...
Restituisce le proprietà del documento della presentazione associata.
...
Scrive la presentazione associata su stream.
...
Scrive la presentazione associata su file.
