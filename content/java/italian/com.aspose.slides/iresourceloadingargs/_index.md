...
| Metodo | Descrizione |
| --- | --- |
| [getOriginalUri()](#getOriginalUri--) | URI originale della risorsa così come specificato nella presentazione importata. |
...
| [setData(byte[] data)](#setData-byte---) | Imposta i dati forniti dall'utente della risorsa utilizzata se [IResourceLoadingCallback.resourceLoading(IResourceLoadingArgs)](../../com.aspose.slides/iresourceloadingcallback\#resourceLoading-IResourceLoadingArgs-) restituisce [ResourceLoadingAction.UserProvided](../../com.aspose.slides/resourceloadingaction\#UserProvided). |
...
URI originale della risorsa così come specificato nella presentazione importata.
...
Imposta i dati forniti dall'utente della risorsa utilizzata se [IResourceLoadingCallback.resourceLoading(IResourceLoadingArgs)](../../com.aspose.slides/iresourceloadingcallback\#resourceLoading-IResourceLoadingArgs-) restituisce [ResourceLoadingAction.UserProvided](../../com.aspose.slides/resourceloadingaction\#UserProvided).
