...
| Metodo | Descrizione |
| --- | --- |
| [getOriginalFontName()](#getOriginalFontName--) | Indica il nome del font di origine nella presentazione. |
...
| --- | --- | --- |
| originFontName | java.lang.String | Nome del font di origine nella presentazione String |
...
Indica il nome del font di origine nella presentazione. String di sola lettura
...
Indica il nome del font di sostituzione per il font originale. String di sola lettura
