...
description: Rappresenta l'etichetta di sensibilità da Microsoft Purview Information Protection.
type: docs
...
Rappresenta l'etichetta di sensibilità da Microsoft Purview Information Protection.
## Metodi
...
| [getSiteId()](#getSiteId--) | Restituisce o imposta l'identificatore del sito di Azure Active Directory (Azure AD) corrispondente alla policy dell'etichetta di sensibilità. |
| [setSiteId(UUID value)](#setSiteId-java.util.UUID-) | Restituisce o imposta l'identificatore del sito di Azure Active Directory (Azure AD) corrispondente alla policy dell'etichetta di sensibilità. |
...
Restituisce o imposta l'identificatore del sito di Azure Active Directory (Azure AD) corrispondente alla policy dell'etichetta di sensibilità. Lettura/Scrittura java.util.UUID.
