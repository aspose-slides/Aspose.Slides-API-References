...
description: Rappresenta una collezione di un punto dati di una serie.
type: docs
...
| Metodo | Descrizione |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Restituisce il punto dati della serie per indice (il suo numero seriale in questa collezione). |
| [get_Item(IChartDataPoint pt)](#get-Item-com.aspose.slides.IChartDataPoint-) | Restituisce l'indice (numero seriale in questa collezione) del punto dati in questa collezione. |
| [getDataSourceTypeForXValues()](#getDataSourceTypeForXValues--) | Specifica se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà XValue dei punti dati. |
| [setDataSourceTypeForXValues(int value)](#setDataSourceTypeForXValues-int-) | Specifica se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà XValue dei punti dati. |
| [getDataSourceTypeForYValues()](#getDataSourceTypeForYValues--) | Specifica se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà YValue dei punti dati. |
| [setDataSourceTypeForYValues(int value)](#setDataSourceTypeForYValues-int-) | Specifica se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà YValue dei punti dati. |
| [getDataSourceTypeForBubbleSizes()](#getDataSourceTypeForBubbleSizes--) | Specifica se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà BubbleSize dei punti dati. |
| [setDataSourceTypeForBubbleSizes(int value)](#setDataSourceTypeForBubbleSizes-int-) | Specifica se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà BubbleSize dei punti dati. |
| [getDataSourceTypeForValues()](#getDataSourceTypeForValues--) | Specifica se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà Value dei punti dati. |
| [setDataSourceTypeForValues(int value)](#setDataSourceTypeForValues-int-) | Specifica se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà Value dei punti dati. |
...
Restituisce l'indice (numero seriale in questa collezione) del punto dati in questa collezione.
...
Specifică se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà XValue dei punti dati. In altre parole specifica il tipo di valore della proprietà ChartDataPointEx.XValue.Data. Lettura/scrittura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Specifică se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà YValue dei punti dati. In altre parole specifica il tipo di valore della proprietà ChartDataPointEx.YValue.Data. Lettura/scrittura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Specifică se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà BubbleSize dei punti dati. In altre parole specifica il tipo di valore della proprietà ChartDataPointEx.BubbleSize.Data. Lettura/scrittura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Specifică se la proprietà AsCell, AsLiteralString o AsLiteralDouble è attuale nell'oggetto della proprietà Value dei punti dati. In altre parole specifica il tipo di valore della proprietà ChartDataPoint.Value.Data. Lettura/scrittura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Specifică il tipo di valori nella lista delle proprietà ChartDataPoint.ErrorBarsCustomValues. Sola lettura [IDataSourceTypeForErrorBarsCustomValues](../../com.aspose.slides/idatasourcetypeforerrorbarscustomvalues).
...
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Punto dati XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Punto dati YValue |
...
Crea il nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile per le serie il cui chartType è uno dei sottotipi Scatter (vedi anche il metodo ChartTypeCharacterizer.IsChartTypeScatter(ChartType) method).

**Parametri:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| xValue | double | Punto dati XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Punto dati YValue |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| xValue | java.lang.String | Punto dati XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Punto dati YValue |
...
| --- | --- | --- |
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Punto dati XValue |
| yValue | double | Punto dati YValue |
...
Crea il nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile per le serie il cui chartType è uno dei sottotipi Radar (vedi anche il metodo ChartTypeCharacterizer.IsChartTypeRadar(ChartType) method).

**Parametri:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| value | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Punto dati Value |
...
Crea il nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile per le serie il cui chartType è uno dei sottotipi Column o Bar (vedi anche il metodo ChartTypeCharacterizer.IsChartTypeColumn(ChartType) and ChartTypeCharacterizer.IsChartTypeBar(ChartType) method).
...
Crea il nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile per le serie il cui chartType è uno dei sottotipi Area (vedi anche il metodo ChartTypeCharacterizer.IsChartTypeArea(ChartType) method).
...
Crea il nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile per le serie il cui chartType è uno dei sottotipi Pie (vedi anche il metodo ChartTypeCharacterizer.IsChartTypePie(ChartType) method).
...
Crea il nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile per le serie il cui chartType è uno dei sottotipi Doughnut (vedi anche il metodo ChartTypeCharacterizer.IsChartTypeDoughnut(ChartType) method).
...
Crea il nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile per le serie il cui chartType è uno dei sottotipi Bubble (vedi anche il metodo ChartTypeCharacterizer.IsChartTypeBubble(ChartType) method).
...
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Punto dati XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Punto dati YValue |
| bubbleSize | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Punto dati BubbleSize |
...
```
Crea un nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile alle serie il cui chartType è uno dei sottotipi Bubble (vedi anche il metodo ChartTypeCharacterizer.IsChartTypeBubble(ChartType) method).
...
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | punto dati XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | punto dati YValue |
| bubbleSize | double | punto dati BubbleSize |
...
Crea un nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile alle serie il cui chartType è uno dei sottotipi Surface (vedi anche il metodo ChartTypeCharacterizer.IsChartTypeSurface(ChartType) method).
...
Crea un nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile alle serie il cui chart type è Sunburst.

**Parametri:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| sizeValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | punto dati SizeValue |
...
Crea un nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile alle serie il cui chart type è Waterfall.
...
Crea un nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile alle serie il cui chart type è BoxAndWhisker.
...
Crea un nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile alle serie il cui chart type è Treemap.
...
Crea un nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile alle serie il cui chart type è Histogram.
...
Crea un nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile alle serie il cui chart type è Funnel.
...
Crea un nuovo punto dati e lo aggiunge alla fine della collezione. Applicabile alle serie il cui chart type è Map.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| value | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | punto dati ColorValue |
