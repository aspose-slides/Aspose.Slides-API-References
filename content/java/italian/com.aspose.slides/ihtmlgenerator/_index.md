...
| [addAttributeValue(String value)](#addAttributeValue-java.lang.String-) | Inserisce tra virgolette il valore dell'attributo e lo aggiunge al file HTML. |
| [addAttributeValue(char[] value)](#addAttributeValue-char---) | Inserisce tra virgolette il valore dell'attributo e lo aggiunge al file HTML. |
| [addAttributeValue(char[] value, int startIndex, int length)](#addAttributeValue-char---int-int-) | Inserisce tra virgolette il valore dell'attributo e lo aggiunge al file HTML. |
...
| [getPreviousSlideIndex()](#getPreviousSlideIndex--) | Restituisce l'indice della diapositiva precedentemente renderizzata o -1 se è in fase di rendering la prima diapositiva. |
| [getSlideIndex()](#getSlideIndex--) | Restituisce l'indice della diapositiva attualmente in fase di rendering. |
| [getNextSlideIndex()](#getNextSlideIndex--) | Restituisce l'indice di una diapositiva che verrà renderizzata dopo quella corrente o -1 se la diapositiva corrente è l'ultima. |
...
| --- | --- | --- |
| html | char[] | Testo da aggiungere. |
| startIndex | int | Indice di partenza della porzione da aggiungere. |
...
Restituisce l'indice della diapositiva precedentemente renderizzata o -1 se è in fase di rendering la prima diapositiva. Solo lettura int.
...
Restituisce l'indice di una diapositiva che verrà renderizzata dopo quella corrente o -1 se la diapositiva corrente è l'ultima. Solo lettura int.
