...
| [getProgressCallback()](#getProgressCallback--) | Rappresenta un oggetto callback per gli aggiornamenti di avanzamento del salvataggio in percentuale. |
| [setProgressCallback(IProgressCallback value)](#setProgressCallback-com.aspose.slides.IProgressCallback-) | Rappresenta un oggetto callback per gli aggiornamenti di avanzamento del salvataggio in percentuale. |
| [getDefaultRegularFont()](#getDefaultRegularFont--) | Restituisce o imposta il carattere utilizzato nel caso in cui il carattere sorgente non sia trovato. |
| [setDefaultRegularFont(String value)](#setDefaultRegularFont-java.lang.String-) | Restituisce o imposta il carattere utilizzato nel caso in cui il carattere sorgente non sia trovato. |
...
| [getSkipJavaScriptLinks()](#getSkipJavaScriptLinks--) | Specificare se saltare i collegamenti ipertestuali con chiamate JavaScript durante il salvataggio della presentazione. |
| [setSkipJavaScriptLinks(boolean value)](#setSkipJavaScriptLinks-boolean-) | Specificare se saltare i collegamenti ipertestuali con chiamate JavaScript durante il salvataggio della presentazione. |
...
Rappresenta un oggetto callback per gli aggiornamenti di avanzamento del salvataggio in percentuale. Vedi [IProgressCallback](../../com.aspose.slides/iprogresscallback).
...
Restituisce o imposta il carattere utilizzato nel caso in cui il carattere sorgente non sia trovato. Lettura-scrittura String.
...
Specificare se saltare i collegamenti ipertestuali con chiamate JavaScript durante il salvataggio della presentazione. Lettura/scrittura boolean. Il valore predefinito è false.
