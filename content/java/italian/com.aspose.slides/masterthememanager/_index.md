...
| Metodo | Descrizione |
| --- | --- |
| [getOverrideTheme()](#getOverrideTheme--) | Restituisce l'oggetto tema di override. |
| [setOverrideTheme(IMasterTheme value)](#setOverrideTheme-com.aspose.slides.IMasterTheme-) | Restituisce l'oggetto tema di override. |
| [createThemeEffective()](#createThemeEffective--) | Restituisce l'oggetto tema. |
| [isOverrideThemeEnabled()](#isOverrideThemeEnabled--) | Determina se OverrideTheme sovrascrive o meno il tema efficace ereditato (Presentation.MasterTheme). |
| [setOverrideThemeEnabled(boolean value)](#setOverrideThemeEnabled-boolean-) | Determina se OverrideTheme sovrascrive o meno il tema efficace ereditato (Presentation.MasterTheme). |
...
Restituisce l'oggetto tema di override. Lettura/Scrittura [IMasterTheme](../../com.aspose.slides/imastertheme).
...
Determina se OverrideTheme sovrascrive o meno il tema efficace ereditato (Presentation.MasterTheme). Lettura/Scrittura boolean.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| scheme | [IExtraColorScheme](../../com.aspose.slides/iextracolorscheme) | [IExtraColorScheme](../../com.aspose.slides/iextracolorscheme) oggetto. |