...
description: Rappresenta un progetto VBA con macro della presentazione.
type: docs
...
| [isPasswordProtected()](#isPasswordProtected--) | Indica se VBAProject è protetto da una password per visualizzare le proprietà del progetto. |
### getName() {#getName--}
```
...
Indica se VBAProject è protetto da una password per visualizzare le proprietà del progetto. Sola lettura boolean.
