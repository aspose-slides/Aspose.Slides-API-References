...
description: Specifica un'istanza di testo matematico contenuto all'interno di un MathParagraph e che inizia su una sua linea.
type: docs
...
Specifica un'istanza di testo matematico contenuto all'interno di un MathParagraph e che inizia su una sua linea. Tutte le zone matematiche, incluse equazioni, espressioni, array di equazioni o espressioni e formule sono rappresentate da un blocco matematico.
...
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | Inserisce gli elementi figli di questo blocco nei caratteri specificati, come parentesi o altri, come inquadratura e delimita con un carattere separatore |
...
Inserisce gli elementi figli di questo blocco nei caratteri specificati, come parentesi o altri, come inquadratura e delimita con un carattere separatore
...
**Restituisce:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - L'elemento math di tipo [IMathDelimiter](../../com.aspose.slides/imathdelimiter) che include i caratteri specificati come inquadratura e delimitatore
