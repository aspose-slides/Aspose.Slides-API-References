...
type: docs
url: /it/com.aspose.slides/overridetheme/
---
**Ereditarietà:**  
...
| [getFormatScheme()](#getFormatScheme--) | Restituisce lo schema di formato delle forme. |
| [isEmpty()](#isEmpty--) | Un valore true indica che ColorScheme, FontScheme e FormatScheme sono null e qualsiasi sovrascrittura con questo oggetto tema è disabilitata. |
| [clear()](#clear--) | Imposta ColorScheme, FontScheme e FormatScheme a null per disabilitare qualsiasi sovrascrittura con questo oggetto tema. |
...
Restituisce lo schema dei font. Solo lettura [IFontScheme](../../com.aspose.slides/ifontscheme).
...
Restituisce lo schema di formato delle forme. Solo lettura [IFormatScheme](../../com.aspose.slides/iformatscheme).
...
Un valore true indica che ColorScheme, FontScheme e FormatScheme sono null e qualsiasi sovrascrittura con questo oggetto tema è disabilitata. Booleano solo lettura.
...
Imposta ColorScheme, FontScheme e FormatScheme a null per disabilitare qualsiasi sovrascrittura con questo oggetto tema.
