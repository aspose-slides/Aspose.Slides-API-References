...
| [getDepthPercents()](#getDepthPercents--) | Devuelve o establece la profundidad de un gráfico 3D como un porcentaje del ancho del gráfico (entre 20 y 2000 por ciento). |
| [setDepthPercents(int value)](#setDepthPercents-int-) | Devuelve o establece la profundidad de un gráfico 3D como un porcentaje del ancho del gráfico (entre 20 y 2000 por ciento). |
| [getHeightPercents()](#getHeightPercents--) | Especifica la altura de un gráfico 3D como un porcentaje del ancho del gráfico (entre 5 y 500 por ciento). |
| [setHeightPercents(int value)](#setHeightPercents-int-) | Especifica la altura de un gráfico 3D como un porcentaje del ancho del gráfico (entre 5 y 500 por ciento). |
...
Devuelve o establece el valor de perspectiva (ángulo de campo de visión) para gráficos 3D (entre 0 y 100). Se ignora si el valor de la propiedad RightAngleAxes es true. Lectura/escritura byte.
...
Devuelve o establece la profundidad de un gráfico 3D como un porcentaje del ancho del gráfico (entre 20 y 2000 por ciento). Lectura/escritura int.
...
Especifica la altura de un gráfico 3D como un porcentaje del ancho del gráfico (entre 5 y 500 por ciento). Lectura/escritura int.
