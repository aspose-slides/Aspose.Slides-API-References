...
| [getShowPageStepper()](#getShowPageStepper--) | Mostrar/ocultar selector de página. |
| [setShowPageStepper(boolean value)](#setShowPageStepper-boolean-) | Mostrar/ocultar selector de página. |
...
Mostrar/ocultar botón de pantalla completa. Puede sobreescribirse en flashvars. El valor predeterminado es true.
...
Mostrar/ocultar selector de página. Puede sobreescribirse en flashvars. El valor predeterminado es true.
...
Mostrar/ocultar sección de búsqueda. Puede sobreescribirse en flashvars. El valor predeterminado es true.
...
Mostrar/ocultar todo el panel superior. Puede sobreescribirse en flashvars. El valor predeterminado es true.
...
Mostrar/ocultar panel inferior. Puede sobreescribirse en flashvars. El valor predeterminado es true.
...
Mostrar/ocultar panel izquierdo. Puede sobreescribirse en flashvars. El valor predeterminado es true.
...
Iniciar con el panel izquierdo abierto. Puede sobreescribirse en flashvars. El valor predeterminado es false.
...
Obtiene o establece la dirección completa del hipervínculo para un logotipo. Solo tiene efecto si se especifica (\#getLogoImageBytes.getLogoImageBytes/\#setLogoImageBytes(byte[]).setLogoImageBytes(byte[])).
