...
Si la presentación está protegida por una contraseña para abrir, el valor de la propiedad es NotDefined. Ver la enumeración [NullableBool](../../com.aspose.slides/nullablebool).
...
> ```
> Este ejemplo muestra cómo llamar al método #updateDocumentProperties(IDocumentProperties).updateDocumentProperties(IDocumentProperties) para
