...
type: docs
url: /es/com.aspose.slides/effectstylecollection/
---
**Herencia:**
...
| Método | Descripción |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Devuelve un elemento en la posición especificada. |
...
| [isSynchronized()](#isSynchronized--) | Devuelve un valor que indica si el acceso a la colección está sincronizado (a prueba de hilos). |
...
Devuelve un elemento en la posición especificada. Solo lectura [EffectStyle](../../com.aspose.slides/effectstyle).

**Parámetros:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| index | int | Posición del elemento. |

**Devuelve:**
[IEffectStyle](../../com.aspose.slides/ieffectstyle) - Elemento en la posición especificada.
### iterator() {#iterator--}
```
...
**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffectStyle> - Un IGenericEnumerator que puede usarse para iterar a través de la colección.
...
**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffectStyle> - Un java.util.Iterator para toda la colección.
### size() {#size--}
```
public final int size()
```

Devuelve el número de elementos en la colección. Solo lectura int, Solo lectura int.
...
Devuelve un valor que indica si el acceso a la colección está sincronizado (a prueba de hilos). Solo lectura boolean.
