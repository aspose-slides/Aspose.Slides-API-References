...
| [getPathPoints()](#getPathPoints--) | Obtiene una matriz de puntos que definen la geometría de la ruta del elemento. |
...
Obtiene una matriz de puntos que definen la geometría de la ruta del elemento.
