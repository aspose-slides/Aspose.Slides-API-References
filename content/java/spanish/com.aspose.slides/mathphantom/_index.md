...
description: Representa un objeto matemático fantasma ltmphantgt que afecta la disposición de su elemento hijo sin necesariamente mostrarse.
type: docs
...
Representa un objeto matemático fantasma (<m:phant>) que afecta la disposición de su elemento hijo sin necesariamente mostrarlo. Un fantasma puede ocultar su expresión base mientras conserva su anchura, altura o profundidad para alinear fórmulas o reservar espacio. La visibilidad y el comportamiento geométrico se controlan mediante propiedades como Show, ZeroWid, ZeroAsc, ZeroDesc y Transp.
...
>  phantom.setZeroWidth(false);     // Mantener la anchura
> ```
## Constructores
...
| [getZeroWidth()](#getZeroWidth--) | Obtiene o establece un valor que indica si la anchura del elemento base debe tratarse como cero. |
| [setZeroWidth(boolean value)](#setZeroWidth-boolean-) | Obtiene o establece un valor que indica si la anchura del elemento base debe tratarse como cero. |
...
| [getTransp()](#getTransp--) | Obtiene o establece un valor que indica si el fantasma es transparente para reglas de espaciado basadas en clase. |
| [setTransp(boolean value)](#setTransp-boolean-) | Obtiene o establece un valor que indica si el fantasma es transparente para reglas de espaciado basadas en clase. |
...
Cuando es false, el elemento base está oculto pero puede seguir ocupando espacio dependiendo de otras configuraciones del fantasma. Corresponde al atributo OMML m:show.
...
Obtiene o establece un valor que indica si la anchura del elemento base debe tratarse como cero.
...
Obtiene o establece un valor que indica si el fantasma es transparente para reglas de espaciado basadas en clase.

--------------------

Cuando es true, los operadores y símbolos dentro del fantasma siguen afectando el espaciado matemático alrededor del fantasma (como si fuera visible). Cuando es false, el espaciado basado en clase se ignora. Corresponde al atributo OMML m:transp.
