...
type: docs
url: /es/com.aspose.slides/ieffectformateffectivedata/
---
...
Esta interfaz se usa junto con la interfaz [IEffectFormat](../../com.aspose.slides/ieffectformat) para devolver valores de formato efectivos con herencia aplicada.
## Métodos

| Método | Descripción |
| --- | --- |
| [isNoEffects()](#isNoEffects--) | Devuelve true si todos los efectos están deshabilitados (como en el objeto EffectFormat predeterminado recién creado). |
...
Devuelve true si todos los efectos están deshabilitados (como en el objeto EffectFormat predeterminado recién creado). Sólo lectura boolean.
...
Efecto de desenfoque. Sólo lectura [IBlurEffectiveData](../../com.aspose.slides/iblureffectivedata).
...
Efecto de superposición de relleno. Sólo lectura [IFillOverlayEffectiveData](../../com.aspose.slides/ifilloverlayeffectivedata).
...
Efecto de resplandor. Sólo lectura [IGlowEffectiveData](../../com.aspose.slides/igloweffectivedata).
...
Sombra interna. Sólo lectura [IInnerShadowEffectiveData](../../com.aspose.slides/iinnershadoweffectivedata).
...
Sombra externa. Sólo lectura [IOuterShadowEffectiveData](../../com.aspose.slides/ioutershadoweffectivedata).
...
Sombra predefinida. Sólo lectura [IPresetShadowEffectiveData](../../com.aspose.slides/ipresetshadoweffectivedata).
...
Reflexión. Sólo lectura [IReflectionEffectiveData](../../com.aspose.slides/ireflectioneffectivedata).
...
Borde suave. Sólo lectura [ISoftEdgeEffectiveData](../../com.aspose.slides/isoftedgeeffectivedata).
