...
description: Objeto inmutable que contiene propiedades de formato efectivas del marco de texto.
type: docs
...
Objeto inmutable que contiene propiedades de formato efectivas del marco de texto.

--------------------

Esta interfaz se usa junto con la [ITextFrameFormat](../../com.aspose.slides/itextframeformat) interfaz para devolver valores de formato efectivos con herencia aplicada.
## Methods
...
| [getWrapText()](#getWrapText--) | Devuelve si el texto se ajusta en los márgenes del TextFrame. |
| [getAnchoringType()](#getAnchoringType--) | Devuelve el anclaje vertical del texto en un TextFrame. |
| [getCenterText()](#getCenterText--) | Devuelve si el texto debe centrarse horizontalmente en el recuadro. |
| [getTextVerticalType()](#getTextVerticalType--) | Devuelve la orientación del texto. |
| [getAutofitType()](#getAutofitType--) | Devuelve el modo de ajuste automático del texto. |
...
Devuelve si el texto se ajusta en los márgenes del TextFrame. Solo lectura boolean.
...
Devuelve si el texto debe centrarse horizontalmente en el recuadro. Solo lectura boolean.
...
Devuelve el modo de ajuste automático del texto. Solo lectura [TextAutofitType](../../com.aspose.slides/textautofittype).
