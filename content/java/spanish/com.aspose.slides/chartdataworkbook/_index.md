...
| [getCell(String worksheetName, int row, int column)](#getCell-java.lang.String-int-int-) | Obtiene la celda que puede usarse para series o categorías de gráficos |
| [getCell(int worksheetIndex, int row, int column)](#getCell-int-int-int-) | Obtiene la celda que puede usarse para series o categorías de gráficos |
| [getCell(int worksheetIndex, String cellName)](#getCell-int-java.lang.String-) | Obtiene la celda que puede usarse para series o categorías de gráficos |
| [getCell(int worksheetIndex, String cellName, Object value)](#getCell-int-java.lang.String-java.lang.Object-) | Obtiene la celda que puede usarse para series o categorías de gráficos |
| [getCell(int worksheetIndex, int row, int column, Object value)](#getCell-int-int-int-java.lang.Object-) | Obtiene la celda que puede usarse para series o categorías de gráficos |
...
Obtiene la celda que puede usarse para series o categorías de gráficos
