...
Representa una sola celda en un libro de Excel.
## Métodos
...
| [getRow()](#getRow--) | Obtiene el índice basado en cero de la fila en la hoja donde se encuentra la celda. |
| [getColumn()](#getColumn--) | Obtiene el índice basado en cero de la columna en la hoja donde se encuentra la celda. |
### getValue() {#getValue--}
```
...
Obtiene el índice basado en cero de la fila en la hoja donde se encuentra la celda. Sólo lectura int.
...
Obtiene el índice basado en cero de la columna en la hoja donde se encuentra la celda. Sólo lectura int.
