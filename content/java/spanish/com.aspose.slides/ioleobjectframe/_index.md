...
| Método | Descripción |
| --- | --- |
| [getSubstitutePictureFormat()](#getSubstitutePictureFormat--) | Devuelve OleObject image fill properties object. |
...
| [getSubstitutePictureTitle()](#getSubstitutePictureTitle--) | Devuelve o establece el título para el icono OleObject. |
| [setSubstitutePictureTitle(String value)](#setSubstitutePictureTitle-java.lang.String-) | Devuelve o establece el título para el icono OleObject. |
### getSubstitutePictureFormat() {#getSubstitutePictureFormat--}
```
public abstract IPictureFillFormat getSubstitutePictureFormat()
```

Devuelve OleObject image fill properties object. Solo lectura [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
Devuelve la ruta completa a un archivo vinculado. Se usará el nombre de archivo corto. Solo lectura String.
...
Devuelve la ruta completa a un archivo vinculado. Se usará el nombre de archivo largo. Lectura/escritura String.
...
Devuelve o establece el título para el icono OleObject. Lectura/escritura String.
