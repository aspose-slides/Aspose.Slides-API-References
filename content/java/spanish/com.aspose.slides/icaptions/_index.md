...
| Method | Description |
| --- | --- |
| [getCaptionId()](#getCaptionId--) | Devuelve el identificador único global (GUID) de los subtítulos cerrados. |
...
| [getDataAsString()](#getDataAsString--) | Devuelve los datos de los subtítulos cerrados como cadena codificada en UTF-8. Sólo lectura String. |
...
Devuelve el identificador único global (GUID) de los subtítulos cerrados. Sólo lectura java.util.UUID.
...
Devuelve los datos binarios de los subtítulos cerrados. Sólo lectura byte[].
...
Devuelve los datos de los subtítulos cerrados como cadena codificada en UTF-8. Sólo lectura String.
