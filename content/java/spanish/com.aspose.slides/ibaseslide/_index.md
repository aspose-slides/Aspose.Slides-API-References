...
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | Une secuencias con el mismo formato en todos los párrafos de todas las formas aceptables. |
...
Une secuencias con el mismo formato en todos los párrafos de todas las formas aceptables.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| slide | [IBaseSlide](../../com.aspose.slides/ibaseslide) | El IBaseSlide con el que comparar el IBaseSlide actual. |
