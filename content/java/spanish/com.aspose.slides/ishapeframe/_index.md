...
type: docs
url: /es/com.aspose.slides/ishapeframe/
---
...
Devuelve el número de grados que un marco está rotado alrededor del eje z. Un valor positivo indica rotación horaria; un valor negativo indica rotación antihoraria. Solo lectura float.
...
Devuelve la coordenada X del centro de un marco. Solo lectura float.
...
Devuelve la coordenada Y del centro de un marco. Solo lectura float.
...
Determina si un marco está volteado horizontalmente. Solo lectura [NullableBool](../../com.aspose.slides/nullablebool).
...
Determina si un marco está volteado verticalmente. Solo lectura [NullableBool](../../com.aspose.slides/nullablebool).
...
Devuelve las coordenadas de un marco. Solo lectura java.awt.geom.Rectangle2D.Float.
