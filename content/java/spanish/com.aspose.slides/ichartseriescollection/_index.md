...
description: Representa la colección de
type: docs
...
Representa la colección de [IChartSeries](../../com.aspose.slides/ichartseries)
## Métodos
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| index | int | Índice para inserción |
...
**Devuelve:**
int - El índice basado en cero de la primera ocurrencia del valor dentro de todo el CollectionBase, si se encuentra; de lo contrario, -1.
