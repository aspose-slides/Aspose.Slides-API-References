...
| [isPasswordProtected()](#isPasswordProtected--) | Obtiene un valor que indica si la presentación vinculada está protegida por una contraseña para abrirla. |
...
| [writeBindedPresentation(OutputStream stream)](#writeBindedPresentation-java.io.OutputStream-) | Escribe la presentación vinculada a un flujo. |
| [writeBindedPresentation(String file)](#writeBindedPresentation-java.lang.String-) | Escribe la presentación vinculada a un archivo. |
...
Obtiene un valor que indica si la presentación vinculada está protegida por una contraseña para abrirla.
...
Cuando la contraseña es nula o vacía, este método devuelve false.
...
Escribe la presentación vinculada a un flujo.

**Parámetros:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| stream | java.io.OutputStream | El flujo debe ser buscable y escribible. |
### writeBindedPresentation(String file) {#writeBindedPresentation-java.lang.String-}
```
public final void writeBindedPresentation(String file)
```

Escribe la presentación vinculada a un archivo.
