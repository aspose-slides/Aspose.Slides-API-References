...
type: docs
url: /es/com.aspose.slides/timing/
---
**Herencia:**  
java.lang.Object
...
Representa la sincronización de la animación.

## Métodos

| Método | Descripción |
| --- | --- |
| [getAccelerate()](#getAccelerate--) | Describe el porcentaje de la duración del efecto de comportamiento de aceleración. |
| [setAccelerate(float value)](#setAccelerate-float-) | Describe el porcentaje de la duración del efecto de comportamiento de aceleración. |
| [getDecelerate()](#getDecelerate--) | Describe el porcentaje de la duración del efecto de comportamiento de desaceleración. |
| [setDecelerate(float value)](#setDecelerate-float-) | Describe el porcentaje de la duración del efecto de comportamiento de desaceleración. |
| [getAutoReverse()](#getAutoReverse--) | Describe si la animación se reproduce automáticamente en reversa después de reproducirla en dirección normal. |
| [setAutoReverse(boolean value)](#setAutoReverse-boolean-) | Describe si la animación se reproduce automáticamente en reversa después de reproducirla en dirección normal. |
...
| [getRepeatUntilNextClick()](#getRepeatUntilNextClick--) | Este atributo especifica si el efecto se repetirá hasta el próximo clic. |
| [setRepeatUntilNextClick(boolean value)](#setRepeatUntilNextClick-boolean-) | Este atributo especifica si el efecto se repetirá hasta el próximo clic. |
...
| [getRewind()](#getRewind--) | Este atributo especifica si el efecto se rebobinará cuando haya terminado de reproducirse. |
| [setRewind(boolean value)](#setRewind-boolean-) | Este atributo especifica si el efecto se rebobinará cuando haya terminado de reproducirse. |
| [getSpeed()](#getSpeed--) | Especifica el porcentaje en que se debe acelerar (o ralentizar) la sincronización. |
| [setSpeed(float value)](#setSpeed-float-) | Especifica el porcentaje en que se debe acelerar (o ralentizar) la sincronización. |
| [getTriggerDelayTime()](#getTriggerDelayTime--) | Describe el tiempo de retraso después del disparador. |
| [setTriggerDelayTime(float value)](#setTriggerDelayTime-float-) | Describe el tiempo de retraso después del disparador. |
...
Describe el porcentaje de la duración del efecto de comportamiento de aceleración. Lectura/escritura float.
...
Describe el porcentaje de la duración del efecto de comportamiento de desaceleración. Lectura/escritura float.
...
Describe si la animación se reproduce automáticamente en reversa después de reproducirla en dirección normal. Lectura/escritura boolean.
...
>      // Cambie la sincronización/repetición del efecto a "Until End of Slide"
...
Este atributo especifica si el efecto se repetirá hasta el próximo clic. Lectura/escritura boolean.
...
Este atributo especifica si el efecto se rebobinará cuando haya terminado de reproducirse. Lectura/escritura boolean.
...
Especifica el porcentaje en que se debe acelerar (o ralentizar) la sincronización. Lectura/escritura float.
...
Describe el tiempo de retraso después del disparador. Lectura/escritura float.
