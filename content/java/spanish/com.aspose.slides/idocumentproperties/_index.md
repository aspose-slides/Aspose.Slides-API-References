...
| [getManager()](#getManager--) | Devuelve o establece la propiedad del administrador. |
| [setManager(String value)](#setManager-java.lang.String-) | Devuelve o establece la propiedad del administrador. |
...
| [getLastSavedTime()](#getLastSavedTime--) | Devuelve la fecha en que una presentación fue modificada por última vez. |
| [setLastSavedTime(Date value)](#setLastSavedTime-java.util.Date-) | Devuelve la fecha en que una presentación fue modificada por última vez. |
| [getLastPrinted()](#getLastPrinted--) | Devuelve la fecha en que una presentación fue impresa por última vez. |
| [setLastPrinted(Date value)](#setLastPrinted-java.util.Date-) | Devuelve la fecha en que una presentación fue impresa por última vez. |
...
| [getHyperlinkBase()](#getHyperlinkBase--) | Devuelve o establece la propiedad HyperlinkBase del documento. |
| [setHyperlinkBase(String value)](#setHyperlinkBase-java.lang.String-) | Devuelve o establece la propiedad HyperlinkBase del documento. |
...
| [getMultimediaClips()](#getMultimediaClips--) | Especifica el número total de clips de sonido o video que están presentes en el documento. |
...
| [containsCustomProperty(String name)](#containsCustomProperty-java.lang.String-) | Verifica la presencia de una propiedad personalizada con un nombre especificado. |
...
| [getCustomPropertyValue(String name, String[] value)](#getCustomPropertyValue-java.lang.String-java.lang.String---) | Obtiene un valor de cadena con nombre de las propiedades personalizadas. |
...
| [setCustomPropertyValue(String name, String value)](#setCustomPropertyValue-java.lang.String-java.lang.String-) | Establece una propiedad personalizada de cadena con nombre. |
| [setCustomPropertyValue(String name, float value)](#setCustomPropertyValue-java.lang.String-float-) | Establece una propiedad personalizada float con nombre. |
| [setCustomPropertyValue(String name, double value)](#setCustomPropertyValue-java.lang.String-double-) | Establece una propiedad personalizada double con nombre. |
...
El contenido de este elemento debe estar en la forma XX.YYYY, donde X e Y representan valores numéricos; de lo contrario, el documento se considerará no conforme. Aspose.Slides representa su versión en el formato XX.YY.ZZ, donde: XX - versión mayor YY - versión menor ZZ - versión de parche. Por ejemplo, el valor 23.0105 significa la versión 23.1.5 de Aspose.Slides.
...
Devuelve o establece la propiedad del administrador. Lectura/escritura String.
...
Devuelve o establece la propiedad del documento HyperlinkBase. Lectura/escritura String.
...
Indica el modo de visualización de la miniatura del documento. Establezca este elemento a **true** para habilitar el escalado de la miniatura del documento a la pantalla. Establezca este elemento a **false** para habilitar el recorte de la miniatura del documento y mostrar solo las secciones que se ajusten a la pantalla. Lectura/escritura boolean.
...
Indica si los hipervínculos en un documento están actualizados. Establezca este elemento a **true** para indicar que los hipervínculos están actualizados. Establezca este elemento a **false** para indicar que los hipervínculos están desactualizados. Lectura/escritura boolean.
...
Especifica que uno o más hipervínculos en esta parte fueron actualizados exclusivamente en esta parte por un productor. El próximo productor que abra este documento deberá actualizar las relaciones de hipervínculos con los nuevos hipervínculos especificados en esta parte. Lectura/escritura boolean.
...
Especifica el número total de diapositivas en un documento de presentación. Solo lectura int.
...
Especifica el número de diapositivas ocultas en un documento de presentación. Solo lectura int.
...
Especifica el número de diapositivas en una presentación que contienen notas. Solo lectura int.
...
Especifica el número total de párrafos encontrados en un documento si corresponde. Solo lectura int.
...
Especifica el número total de palabras contenidas en un documento. Solo lectura int.
...
Especifica el número total de clips de sonido o vídeo presentes en el documento. Solo lectura int.
...
Devuelve o establece la propiedad personalizada asociada con un nombre especificado. Lectura/escritura Object.
...
Limpia y establece los valores predeterminados para todas las propiedades integradas.
...
Establece una propiedad personalizada de tipo cadena con nombre.
...
Establece una propiedad personalizada de tipo flotante con nombre.
...
Establece una propiedad personalizada de tipo doble con nombre.
...
Obtiene una matriz de etiquetas de sensibilidad de las propiedades de documento personalizadas (Microsoft Information Protection SDK Metadata).
