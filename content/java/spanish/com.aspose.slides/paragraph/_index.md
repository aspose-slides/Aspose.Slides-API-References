...
| [getText()](#getText--) | Obtiene o establece el texto simple de un párrafo. |
| [setText(String value)](#setText-java.lang.String-) | Obtiene o establece el texto simple de un párrafo. |
...
| [getSlide()](#getSlide--) | Devuelve la diapositiva padre de un párrafo. |
| [getPresentation()](#getPresentation--) | Devuelve la presentación padre de un párrafo. |
...
Para obtener los valores efectivos, incluidas las herencias, utilice el método [ParagraphFormat.getEffective](../../com.aspose.slides/paragraphformat\#getEffective).
...
Obtiene o establece el texto simple de un párrafo. Lectura/escritura String.
...
**Devuelve:**
int - Número de líneas en un párrafo
...
**Devuelve:**
[IImage](../../com.aspose.slides/iimage) - Una imagen que contiene el párrafo renderizado, o null si el párrafo no se encuentra en su colección padre, no tiene límites de renderizado válidos, o ocurre un error al renderizar la imagen.
...
> ```
> El siguiente ejemplo muestra cómo renderizar cada párrafo de cuadro de texto en una diapositiva como una imagen con escalado personalizado:
>   
...
Devuelve la diapositiva padre de un párrafo. Solo lectura [BaseSlide](../../com.aspose.slides/baseslide).
...
Devuelve la presentación padre de un párrafo. Solo lectura [IPresentation](../../com.aspose.slides/ipresentation).
