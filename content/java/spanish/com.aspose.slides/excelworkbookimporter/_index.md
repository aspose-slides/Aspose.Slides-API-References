...
Recupera un gráfico del libro de Excel especificado y lo agrega al final de la colección de formas dada en las coordenadas especificadas.
...
| worksheetName | java.lang.String | El nombre de la hoja que contiene el gráfico. |
| chartIndex | int | El índice basado en cero de la forma de gráfico a insertar. Este índice puede obtenerse usando el método [IExcelDataWorkbook.getChartsFromWorksheet(String)](../../com.aspose.slides/iexceldataworkbook\#getChartsFromWorksheet-String-). |
| embedAllWorkbook | boolean | Si es true, todo el libro se incrustará en el gráfico; si es false, solo se incrustarán los datos del gráfico. |
...
| x | float | La coordenada X para posicionar el gráfico. |
| y | float | La coordenada Y para posicionar el gráfico. |
| workbookPath | java.lang.String | La ruta al archivo del libro que contiene el gráfico. |
| worksheetName | java.lang.String | El nombre de la hoja que contiene el gráfico. |
| chartName | java.lang.String | El nombre del gráfico a agregar. |
| embedWorkbook | boolean | Si es true, el libro se incrustará en el gráfico; si es false, el gráfico enlazará al libro externo. |
...
Recupera una tabla del libro de Excel especificado y la agrega al final de la colección de formas dada en las coordenadas especificadas.
...
| workbook | [IExcelDataWorkbook](../../com.aspose.slides/iexceldataworkbook) | El libro de Excel. |
| worksheetName | java.lang.String | El nombre de la hoja que contiene la tabla. |
...
Recupera una tabla del archivo de libro de Excel especificado y la agrega al final de la colección de formas dada en las coordenadas especificadas.
