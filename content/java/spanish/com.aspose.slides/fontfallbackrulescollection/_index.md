...
| [add(IFontFallBackRule sourceRule)](#add-com.aspose.slides.IFontFallBackRule-) | Añade una regla FallBack especificada al final de la colección. |
...
Añade una regla FallBack especificada al final de la colección.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| targetRule | [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule) | La regla que se eliminará de la colección. |
...
**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IFontFallBackRule> - Un IGenericEnumerator que puede usarse para iterar la colección.
