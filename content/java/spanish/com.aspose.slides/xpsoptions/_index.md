...
| [getSaveMetafilesAsPng()](#getSaveMetafilesAsPng--) | True para convertir todos los metaficheros utilizados en una presentación a imágenes PNG. |
| [setSaveMetafilesAsPng(boolean value)](#setSaveMetafilesAsPng-boolean-) | True para convertir todos los metaficheros utilizados en una presentación a imágenes PNG. |
...
True para convertir todos los metaficheros utilizados en una presentación a imágenes PNG. Booleano de lectura/escritura.
...
True para dibujar un marco negro alrededor de cada diapositiva. Booleano de lectura/escritura.
