...
description: La clase de controlador de formato a usar para incrustar todas las fuentes de la presentación en formato WOFF.
type: docs
...
La clase de controlador de formato a usar para incrustar todas las fuentes de la presentación en formato WOFF.
## Constructores
...
| Método | Descripción |
| --- | --- |
| [writeDocumentStart(IHtmlGenerator generator, IPresentation presentation)](#writeDocumentStart-com.aspose.slides.IHtmlGenerator-com.aspose.slides.IPresentation-) | Llamado para escribir el encabezado del documento html. |
| [writeDocumentEnd(IHtmlGenerator generator, IPresentation presentation)](#writeDocumentEnd-com.aspose.slides.IHtmlGenerator-com.aspose.slides.IPresentation-) | Llamado para escribir el pie del documento html. |
| [writeSlideStart(IHtmlGenerator generator, ISlide slide)](#writeSlideStart-com.aspose.slides.IHtmlGenerator-com.aspose.slides.ISlide-) | Llamado para escribir el encabezado de la diapositiva html. |
| [writeSlideEnd(IHtmlGenerator generator, ISlide slide)](#writeSlideEnd-com.aspose.slides.IHtmlGenerator-com.aspose.slides.ISlide-) | Llamado para escribir el pie de la diapositiva html. |
| [writeShapeStart(IHtmlGenerator generator, IShape shape)](#writeShapeStart-com.aspose.slides.IHtmlGenerator-com.aspose.slides.IShape-) | Llamado antes de renderizar la forma. |
| [writeShapeEnd(IHtmlGenerator generator, IShape shape)](#writeShapeEnd-com.aspose.slides.IHtmlGenerator-com.aspose.slides.IShape-) | Llamado antes de renderizar la forma. |
...
Llamado para escribir el pie del documento html. Llamado una vez por conversión de presentación.
...
Llamado para escribir el encabezado de la diapositiva html. Llamado una vez por cada diapositiva.
...
Llamado para escribir el pie de la diapositiva html. Llamado una vez por cada diapositiva.
...
Llamado antes de renderizar la forma. Llamado una vez por cada forma. Si esta función escribe algo en el generador, la generación de la imagen de la diapositiva actual se terminará, el fragmento html añadido se insertará y se iniciará una nueva imagen encima de la anterior.
...
| substitutedFont | [IFontData](../../com.aspose.slides/ifontdata) | Fuente sustituida (si se realizó sustitución de fuente), null de lo contrario |
| fontStyle | java.lang.String | Estilo de fuente |
| fontWeight | java.lang.String | Peso de fuente |
| fontData | byte[] | Datos de la fuente |