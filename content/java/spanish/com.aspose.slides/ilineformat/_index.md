...
| Método | Descripción |
| --- | --- |
| [isFormatNotDefined()](#isFormatNotDefined--) | Devuelve true si el formato de línea no está definido (tal como recién creado, por defecto). |
...
| [equals(ILineFormat lineFormat)](#equals-com.aspose.slides.ILineFormat-) | Determina si los dos objetos LineFormat son iguales. |
...
Devuelve true si el formato de línea no está definido (tal como recién creado, por defecto). Boolean de solo lectura.
...
Determina si los dos objetos LineFormat son iguales.

**Parámetros:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| lineFormat | [ILineFormat](../../com.aspose.slides/ilineformat) | El LineFormat con el que comparar el LineFormat actual. |
