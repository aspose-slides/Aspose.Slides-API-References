...
| [getAnchorCenter()](#getAnchorCenter--) | Determina si el cuadro de texto está centrado dentro de la celda. |
| [setAnchorCenter(boolean value)](#setAnchorCenter-boolean-) | Determina si el cuadro de texto está centrado dentro de la celda. |
...
| [getColSpan()](#getColSpan--) | Devuelve el número de columnas de la cuadrícula de la tabla principal que debe abarcar la celda actual. |
| [getRowSpan()](#getRowSpan--) | Devuelve el número de filas que ocupa una celda combinada. |
| [getTextFrame()](#getTextFrame--) | Devuelve el TextFrame de una celda. |
| [getTable()](#getTable--) | Devuelve el objeto Table principal de una celda. |
| [isMergedCell()](#isMergedCell--) | Devuelve verdadero si la celda está combinada con alguna celda ajustada, falso de lo contrario. |
...
| [getSlide()](#getSlide--) | Devuelve la diapositiva principal de una celda. |
| [getPresentation()](#getPresentation--) | Devuelve la presentación principal de una celda. |
...
Determina si el cuadro de texto está centrado dentro de la celda. Lectura/escritura boolean.
...
Devuelve el número de columnas de la cuadrícula de la tabla principal que debe abarcar la celda actual. Esta propiedad permite que las celdas parezcan combinadas, ya que abarcan los bordes verticales de otras celdas en la tabla. Solo lectura int.
...
Devuelve el número de filas que ocupa una celda combinada. Se usa en combinación con el atributo vMerge en otras celdas para especificar la celda inicial de una combinación horizontal. Solo lectura int.
...
Devuelve el TextFrame de una celda. Sólo lectura [ITextFrame](../../com.aspose.slides/itextframe).
...
Devuelve el objeto Table principal de una celda. Sólo lectura [ITable](../../com.aspose.slides/itable).
...
Devuelve verdadero si la celda está combinada con alguna celda ajustada, falso de lo contrario. Sólo lectura boolean.
...
Devuelve el objeto CellFormat que contiene las propiedades de formato para esta celda. Sólo lectura [ICellFormat](../../com.aspose.slides/icellformat).
...
Devuelve la diapositiva principal de una celda. Sólo lectura [IBaseSlide](../../com.aspose.slides/ibaseslide).
...
Devuelve la presentación principal de una celda. Sólo lectura [IPresentation](../../com.aspose.slides/ipresentation).
