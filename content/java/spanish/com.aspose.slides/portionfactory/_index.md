...
| [createPortion(IPortion portion)](#createPortion-com.aspose.slides.IPortion-) | Crea una porción usando datos de una porción especificada. |
### PortionFactory() {#PortionFactory--}
```
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| portion | [IPortion](../../com.aspose.slides/iportion) | Una porción para usar. |
