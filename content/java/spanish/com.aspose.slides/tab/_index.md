...
Devuelve o establece la posición de una tabulación. Asignar esta propiedad puede cambiar el índice de la tabulación en la colección e invalidar el Enumerator. Lectura/escritura double.
...
**Devuelve:**
int - Un entero de 32 bits que indica el orden relativo de los comparandos. El valor de retorno tiene los siguientes significados: 
