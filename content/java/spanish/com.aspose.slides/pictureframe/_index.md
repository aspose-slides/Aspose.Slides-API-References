...
| Método | Descripción |
| --- | --- |
| [getPictureFrameLock()](#getPictureFrameLock--) | Devuelve los bloqueos de la forma. |
...
Devuelve los bloqueos de la forma. Solo lectura [IPictureFrameLock](../../com.aspose.slides/ipictureframelock).
...
Devuelve o establece el tipo AutoShape para un PictureFrame. Todos los elementos del conjunto [ShapeType](../../com.aspose.slides/shapetype) son permitidos, excepto todo tipo de líneas:
