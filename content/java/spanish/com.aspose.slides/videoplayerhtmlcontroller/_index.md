...
Se llama antes de la renderización de la forma. Se llama una vez por cada forma. Si esta función escribe algo en el generador, la generación de la imagen de la diapositiva actual terminará, se insertará el fragmento HTML añadido y se iniciará una nueva imagen sobre la anterior.
...
Determina dónde se debe almacenar el objeto. Este método se llama una vez por cada id de objeto. No se garantiza que no haya dos objetos con los mismos datos, semanticName y contentType pero con id diferentes.
