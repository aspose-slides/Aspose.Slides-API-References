...
| [setCategoryAxisTypeAutomatically()](#setCategoryAxisTypeAutomatically--) | Establece la propiedad IAxis.CategoryAxisType con un valor que se determina automáticamente en función de los datos del eje. |
...
| [getBaseUnitScale()](#getBaseUnitScale--) | Especifica la unidad de tiempo más pequeña que se representa en el eje de fechas. |
| [setBaseUnitScale(int value)](#setBaseUnitScale-int-) | Especifica la unidad de tiempo más pequeña que se representa en el eje de fechas. |
| [getMinorGridLinesFormat()](#getMinorGridLinesFormat--) | Representa el formato de líneas de cuadrícula menores en el eje de un gráfico. |
| [getMajorGridLinesFormat()](#getMajorGridLinesFormat--) | Representa el formato de líneas de cuadrícula mayores en el eje de un gráfico. |
| [getShowMinorGridLines()](#getShowMinorGridLines--) | Para ocultar la línea de cuadrícula menor, establezca MinorGridLinesFormat.Line.FillFormat.FillType a FillType.NoFill. |
| [getShowMajorGridLines()](#getShowMajorGridLines--) | Para ocultar la línea de cuadrícula mayor, establezca MajorGridLinesFormat.Line.FillFormat.FillType a FillType.NoFill. |
...
| [getLabelOffset()](#getLabelOffset--) | Especifica la distancia de las etiquetas desde el eje. |
| [setLabelOffset(int value)](#setLabelOffset-int-) | Especifica la distancia de las etiquetas desde el eje. |
| [getAggregationType()](#getAggregationType--) | Representa el tipo de agregación del eje de categorías (agrupamiento). |
| [setAggregationType(int value)](#setAggregationType-int-) | Representa el tipo de agregación del eje de categorías (agrupamiento). |
| [getBinWidth()](#getBinWidth--) | Especifica el ancho del intervalo cuando el valor de la propiedad AggregationType se establece en AxisAggregationType.ByBinWidth. |
| [setBinWidth(double value)](#setBinWidth-double-) | Especifica el ancho del intervalo cuando el valor de la propiedad AggregationType se establece en AxisAggregationType.ByBinWidth. |
| [getNumberOfBins()](#getNumberOfBins--) | Especifica el número de intervalos cuando el valor de la propiedad AggregationType se establece en AxisAggregationType.ByNumberOfBins. |
| [setNumberOfBins(long value)](#setNumberOfBins-long-) | Especifica el número de intervalos cuando el valor de la propiedad AggregationType se establece en AxisAggregationType.ByNumberOfBins. |
| [isOverflowBin()](#isOverflowBin--) | Especifica si se aplica el intervalo de desbordamiento. |
| [setOverflowBin(boolean value)](#setOverflowBin-boolean-) | Especifica si se aplica el intervalo de desbordamiento. |
...
| [isUnderflowBin()](#isUnderflowBin--) | Especifica si se aplica el intervalo de subdesbordamiento. |
| [setUnderflowBin(boolean value)](#setUnderflowBin-boolean-) | Especifica si se aplica el intervalo de subdesbordamiento. |
...
Representa si el eje de valores cruza el eje de categorías entre categorías. Esta propiedad solo se aplica a ejes de categorías y no se aplica a gráficos 3-D. Lectura/escritura boolean.
...
Representa las unidades mayores para el eje de fecha o de valor. Lectura/escritura double.
...
Para ocultar la línea de cuadrícula menor, establezca MinorGridLinesFormat.Line.FillFormat.FillType a FillType.NoFill. Solo lectura boolean.
...
Para ocultar la línea de cuadrícula mayor, establezca MajorGridLinesFormat.Line.FillFormat.FillType a FillType.NoFill. Solo lectura boolean.
...
Representa el CrossType en el eje especificado donde el otro eje cruza. Lectura/escritura [CrossesType](../../com.aspose.slides/crossestype).
...
Especifica cuántas etiquetas de graduación se omiten entre la etiqueta que se dibuja. Aplicado a eje de categoría o de serie. Lectura/escritura long.
...
Especifica el valor automático del espaciado de etiquetas de graduación. Si false: usar la propiedad TickLabelSpacing. Lectura/escritura boolean.
...
Especifica cuántas marcas de graduación se omiten antes de dibujar la siguiente. Aplicado a eje de categoría o de serie. Lectura/escritura int.
...
Especifica el valor automático del espaciado de marcas de graduación. Si false: usar la propiedad TickMarksSpacing. Lectura/escritura boolean.
...
Especifica la distancia de las etiquetas desde el eje. Aplicado a eje de categoría o de fecha. El valor debe estar entre 0% y 1000%. Lectura/escritura int.
...
Representa el tipo de agregación del eje de categorías (agrupación en contenedores). Aplicado a la categoría. Usado solo con series Histogram o HistogramPareto.
...
Especifica el ancho del contenedor cuando el valor de la propiedad AggregationType se establece en AxisAggregationType.ByBinWidth. Aplicado a los ejes de categoría. Usado solo con series Histogram o HistogramPareto.
...
Especifica el número de contenedores cuando el valor de la propiedad AggregationType se establece en AxisAggregationType.ByNumberOfBins. Aplicado a los ejes de categoría. Usado solo con series Histogram o HistogramPareto.
...
Especifica el valor automático del contenedor de desbordamiento. Si es false: use la propiedad OverflowBin.
...
Especifica el valor personalizado del contenedor de desbordamiento. Aplicado cuando la propiedad IsAutomaticOverflowBin está establecida en false y la propiedad IsOverflowBin es true.
...
Especifica si se aplica el contenedor de subdesbordamiento. Utilice IsAutomaticUnderflowBin y UnderflowBin para ajustar el valor del contenedor de subdesbordamiento.
...
Especifica el valor automático del contenedor de subdesbordamiento. Si es false: use la propiedad UnderflowBin.
...
Especifica el valor personalizado del contenedor de subdesbordamiento. Aplicado cuando la propiedad IsAutomaticUnderflowBin está establecida en false y la propiedad IsUnderflowBin es true.
