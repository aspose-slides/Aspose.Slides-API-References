...
| [add(IBehavior item)](#add-com.aspose.slides.IBehavior-) | Añade un nuevo comportamiento a una colección. |
...
Devuelve el número de comportamientos en una colección. Sólo lectura int.
...
Añade un nuevo comportamiento a una colección.
...
**Devuelve:**
boolean - Verdadero si un comportamiento se eliminó correctamente boolean
...
**Devuelve:**
boolean - verdadero si el elemento se encuentra en el [IGenericCollection](../../com.aspose.slides/igenericcollection); de lo contrario, false.