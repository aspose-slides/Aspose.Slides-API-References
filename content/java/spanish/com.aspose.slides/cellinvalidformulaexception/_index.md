...
| [CellInvalidFormulaException(String message, String reference)](#CellInvalidFormulaException-java.lang.String-java.lang.String-) | Inicializa una nueva instancia de la clase [CellInvalidFormulaException](../../com.aspose.slides/cellinvalidformulaexception) con un mensaje de error especificado y una referencia de celda que contiene la fórmula no válida. |
## Métodos

| Método | Descripción |
| --- | --- |
| [getReference()](#getReference--) | Obtiene una referencia de celda que contiene la fórmula no válida. |
...
Inicializa una nueva instancia de la clase [CellInvalidFormulaException](../../com.aspose.slides/cellinvalidformulaexception) con un mensaje de error especificado y una referencia de celda que contiene la fórmula no válida.
