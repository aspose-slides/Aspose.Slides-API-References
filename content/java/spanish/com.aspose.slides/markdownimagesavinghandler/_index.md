...
Representa el controlador de guardado de imágenes markdown del evento \#ImageSavingDelegate.ImageSavingDelegate.

## Métodos

| Method | Descripción |
| --- | --- |
| [invoke(IImage image, int format, String[] link)](#invoke-com.aspose.slides.IImage-int-java.lang.String---) | Se invoca para cada imagen que no sea SVG (bitmap o metafile) durante la exportación a Markdown. |
...
Se invoca para cada imagen que no sea SVG (bitmap o metafile) durante la exportación a Markdown. Devuelva true para usar el enlace especificado, o false para aplicar la lógica de guardado predeterminada.

**Parámetros:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| image | [IImage](../../com.aspose.slides/iimage) | La imagen que se exporta (bitmap o metafile). |
