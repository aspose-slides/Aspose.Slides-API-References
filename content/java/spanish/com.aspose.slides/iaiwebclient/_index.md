...
| Método | Descripción |
| --- | --- |
| [callChat(String instruction)](#callChat-java.lang.String-) | Envía una instrucción de chat al modelo AI usando una instancia HttpConnection proporcionada y devuelve el mensaje de respuesta a la instrucción dada. |
