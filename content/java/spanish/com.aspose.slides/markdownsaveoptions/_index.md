...
| [getNewLineType()](#getNewLineType--) | Especifica si el documento generado debe tener nuevas líneas \\\\r(Macintosh) de \\\\n(Unix) o \\\\r\\\\n(Windows). |
| [setNewLineType(int value)](#setNewLineType-int-) | Especifica si el documento generado debe tener nuevas líneas \\\\r(Macintosh) de \\\\n(Unix) o \\\\r\\\\n(Windows). |
...
| [getSlideNumberFormat()](#getSlideNumberFormat--) | Obtiene o establece la cadena de formato usada para los encabezados de número de diapositiva en la salida Markdown. |
| [setSlideNumberFormat(String value)](#setSlideNumberFormat-java.lang.String-) | Obtiene o establece la cadena de formato usada para los encabezados de número de diapositiva en la salida Markdown. |
...
| [getRemoveEmptyLines()](#getRemoveEmptyLines--) | Si se establece a true, elimina líneas vacías o que contengan solo espacios en blanco del resultado final de Markdown. |
| [setRemoveEmptyLines(boolean value)](#setRemoveEmptyLines-boolean-) | Si se establece a true, elimina líneas vacías o que contengan solo espacios en blanco del resultado final de Markdown. |
| [setImageSaving(MarkdownSaveOptions.MarkdownImageSavingHandler event)](#setImageSaving-com.aspose.slides.MarkdownSaveOptions.MarkdownImageSavingHandler-) | Ocurre para cada imagen que no sea SVG (bitmap o metarchivo) durante la exportación a Markdown. |
| [setSvgImageSaving(MarkdownSaveOptions.MarkdownSvgImageSavingHandler event)](#setSvgImageSaving-com.aspose.slides.MarkdownSaveOptions.MarkdownSvgImageSavingHandler-) | Ocurre para cada imagen SVG durante la exportación a Markdown. |
...
Especifica la especificación markdown para convertir la presentación. El valor predeterminado es  TextOnly .
...
Especifica el nombre de la carpeta donde se guardarán las imágenes. El valor predeterminado es  Images .
...
Especifica si el documento generado debe tener nuevas líneas \\\\r(Macintosh) de \\\\n(Unix) o \\\\r\\\\n(Windows). El valor predeterminado es  Unix .
...
Especifica si el documento generado debe mostrar comentarios o no. El valor predeterminado es false.
...
Especifica la especificación markdown para convertir la presentación. El valor predeterminado es  Multi-markdown .
...
Obtiene o establece la cadena de formato usada para los encabezados de número de diapositiva en la salida Markdown. El formato debe incluir el "\{0\}" marcador de posición, que será reemplazado por el índice de la diapositiva durante la exportación. Ejemplo: "\# Slide \{0\}" producirá "\# Slide 1", "\# Slide 2", etc.
...
Si se establece a true, elimina líneas vacías o que contengan solo espacios en blanco del resultado final de Markdown. El valor predeterminado es false.
...
Ocurre para cada imagen que no sea SVG (bitmap o metarchivo) durante la exportación a Markdown. Permite personalizar cómo se guarda y referencia la imagen. Si no se maneja, la imagen se guarda localmente con un enlace relativo.
...
Ocurre para cada imagen SVG durante la exportación a Markdown. Permite sobrescribir la guardado y generación de enlaces predeterminados. Si no se maneja, el SVG se guarda localmente con un enlace relativo.
