...
| [isSynchronized()](#isSynchronized--) | Devuelve un valor que indica si el acceso a ArrayList está sincronizado (seguro para subprocesos). |
...
| index | int | Índice de inicio en el array. |
...
Devuelve un valor que indica si el acceso a ArrayList está sincronizado (seguro para subprocesos). Solo lectura boolean.
