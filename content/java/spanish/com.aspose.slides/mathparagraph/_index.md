...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | Un bloque matemático que se añadirá al final de la colección |
...
**Devuelve:**
boolean - true si mathBlock fue eliminado con éxito de la colección; de lo contrario, false. Este método también devuelve false si mathBlock no se encuentra en la colección original.
