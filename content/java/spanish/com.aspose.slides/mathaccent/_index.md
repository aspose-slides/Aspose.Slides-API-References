...
description: Especifica la función de acento compuesta por una base y una marca diacrítica combinante Ejemplo ud835udc4eu0301
type: docs
...
Especifica la función de acento, compuesta por una base y una marca diacrítica combinante Ejemplo: \\ud835\\udc4e\\u0301
...
| --- | --- |
| [MathAccent(IMathElement element)](#MathAccent-com.aspose.slides.IMathElement-) | Crea un acento matemático aplicado a un elemento matemático especificado con el valor de carácter de acento predeterminado |
| [MathAccent(IMathElement element, char accentCharacter)](#MathAccent-com.aspose.slides.IMathElement-char-) | Crea un acento matemático aplicado a un elemento matemático especificado |
## Métodos

| Método | Descripción |
| --- | --- |
| [getBase()](#getBase--) | El argumento al que se aplicó el acento |
| [getCharacter()](#getCharacter--) | Carácter de acento El valor debe estar dentro del rango de (U+0300\\u2013U+036F) o(U+20D0\\u2013U+20EF) Valor predeterminado: Acento circunflejo combinante (U+0302) |
| [setCharacter(char value)](#setCharacter-char-) | Carácter de acento El valor debe estar dentro del rango de (U+0300\\u2013U+036F) o(U+20D0\\u2013U+20EF) Valor predeterminado: Acento circunflejo combinante (U+0302) |
...
Crea un acento matemático aplicado a un elemento matemático especificado con el valor de carácter de acento predeterminado
