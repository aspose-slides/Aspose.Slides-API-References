...
| Método | Descripción |
| --- | --- |
| [getHeaderFooterManager()](#getHeaderFooterManager--) | Devuelve el gestor HeaderFooter de la diapositiva maestra. |
...
Devuelve el gestor HeaderFooter de la diapositiva maestra. Solo lectura [IMasterSlideHeaderFooterManager](../../com.aspose.slides/imasterslideheaderfootermanager).
...
**Devuelve:**
[IMasterSlide](../../com.aspose.slides/imasterslide) - Nueva MasterSlide con tema.
...
Puede acceder a una API alternativa para agregar/insertar/eliminar/clonar diapositivas de diseño usando la propiedad ([IPresentation.getLayoutSlides](../../com.aspose.slides/ipresentation\#getLayoutSlides)).
...
Determina si la maestra correspondiente se elimina cuando se eliminan todas las diapositivas que siguen a esa maestra. Nota: Aspose.Slides nunca eliminará ninguna maestra no usada por sí mismo, para eliminar realmente maestras no usadas llame a [IMasterSlideCollection.removeUnused(boolean)](../../com.aspose.slides/imasterslidecollection\#removeUnused-boolean-) boolean de lectura/escritura.
