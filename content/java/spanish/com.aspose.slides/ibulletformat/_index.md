...
| [applyDefaultParagraphIndentsShifts()](#applyDefaultParagraphIndentsShifts--) | Establece desplazamientos predeterminados distintos de cero para el sangrado efectivo del párrafo y MarginLeft cuando las viñetas están habilitadas (como hace PowerPoint al habilitar viñetas/numeración en un párrafo). |
...
Determina si la viñeta tiene color propio o lo hereda de la primera porción del párrafo. **NullableBool\#True** si la viñeta tiene color propio y **NullableBool\#False** si hereda el color de la primera porción del párrafo. Lectura/escritura [NullableBool](../../com.aspose.slides/nullablebool).
...
Determina si la viñeta tiene fuente propia o la hereda de la primera porción del párrafo. **NullableBool\#True** si la viñeta tiene fuente propia y **NullableBool\#False** si la fuente se hereda de la primera porción del párrafo. Lectura/escritura [NullableBool](../../com.aspose.slides/nullablebool).
...
Establece desplazamientos predeterminados distintos de cero para el sangrado efectivo del párrafo y MarginLeft cuando las viñetas están habilitadas (como hace PowerPoint al habilitar viñetas/numeración en un párrafo). Si las viñetas están deshabilitadas, simplemente restablece Indent y MarginLeft del párrafo (como hace PowerPoint al desactivar viñetas/numeración). Los desplazamientos de sangrado se aplican respecto al contexto actual de la viñeta: IBulletFormat.Type, .NumberedBulletStyle y FontHeight de la primera porción. Los desplazamientos de sangrado distintos de cero se aplican al Indent y MarginLeft efectivos del párrafo actual (haciendo que los valores resultantes sean locales).
