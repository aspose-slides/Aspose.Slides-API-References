...
Si es verdadero, la propiedad AsCell es actual. En otras palabras, la hoja de cálculo se utiliza para almacenar la categoría (este caso admite una categoría multinivel). Si es falso, la propiedad AsLiteral es actual. En otras palabras, la hoja de cálculo NO se utiliza para almacenar la categoría (y este caso no admite categorías multinivel). Solo lectura boolean.
...
Devuelve o establece el objeto IChartDataCell. Si la categoría es multinivel, se utiliza el objeto IChartDataCell para el nivel "0". Lectura/escritura [IChartDataCell](../../com.aspose.slides/ichartdatacell).
