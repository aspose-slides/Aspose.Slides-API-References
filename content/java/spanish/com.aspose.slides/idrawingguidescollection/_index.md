...
| [add(byte orientation, float position)](#add-byte-float-) | Añade la guía de dibujo al final de la colección. |
...
Añade la guía de dibujo al final de la colección.
...
Obtiene el número de todos los elementos de la colección. int de solo lectura.
