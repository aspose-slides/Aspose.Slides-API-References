...
| [isErrorBarsXAllowed(int seriesType)](#isErrorBarsXAllowed-int-) | Devuelve si las barras de error X están permitidas para el tipo de serie especificado. |
| [isErrorBarsYAllowed(int seriesType)](#isErrorBarsYAllowed-int-) | Devuelve si las barras de error Y están permitidas para el tipo de serie especificado. |
### ChartTypeCharacterizer() {#ChartTypeCharacterizer--}
```
...
Devuelve true si chartType es uno de los subtipos Bubble. El conjunto de subtipos corresponde al conjunto apropiado en PowerPoint (ver el cuadro de diálogo "Change Chart Type" en PowerPoint): [ChartType.Bubble](../../com.aspose.slides/charttype\#Bubble), [ChartType.BubbleWith3D](../../com.aspose.slides/charttype\#BubbleWith3D).
...
**Devuelve:**
boolean - True si se usa, de lo contrario false.
