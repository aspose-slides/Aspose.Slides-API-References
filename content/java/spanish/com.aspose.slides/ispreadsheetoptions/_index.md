...
second_title: Aspose.Slides for Java Referencia de API
...
| Método | Descripción |
| --- | --- |
| [getPreferredCulture()](#getPreferredCulture--) | Obtiene o establece la información de cultura preferida para calcular algunas funciones destinadas a usarse con lenguajes que utilizan el conjunto de caracteres de doble byte (DBCS). |
| [setPreferredCulture(Locale value)](#setPreferredCulture-java.util.Locale-) | Obtiene o establece la información de cultura preferida para calcular algunas funciones destinadas a usarse con lenguajes que utilizan el conjunto de caracteres de doble byte (DBCS). |
...
Obtiene o establece la información de cultura preferida para calcular algunas funciones destinadas a usarse con lenguajes que utilizan el conjunto de caracteres de doble byte (DBCS).
