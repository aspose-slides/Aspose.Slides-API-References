...
| [getPreserve()](#getPreserve--) | Determina si la diapositiva maestra correspondiente se elimina cuando se eliminan todas las diapositivas que la siguen. |
| [setPreserve(boolean value)](#setPreserve-boolean-) | Determina si la diapositiva maestra correspondiente se elimina cuando se eliminan todas las diapositivas que la siguen. |
...
Puede acceder a la API alternativa para añadir/insertar/eliminar/clonar diapositivas de diseño mediante la propiedad ([IPresentation.getLayoutSlides](../../com.aspose.slides/ipresentation\#getLayoutSlides)) .
...
Determina si la diapositiva maestra correspondiente se elimina cuando se eliminan todas las diapositivas que la siguen. Nota: Aspose.Slides nunca eliminará automáticamente una maestra no utilizada; para eliminar realmente maestras no utilizadas llame a [MasterSlideCollection.removeUnused(boolean)](../../com.aspose.slides/masterslidecollection\#removeUnused-boolean-) Lectura/escritura  boolean .
