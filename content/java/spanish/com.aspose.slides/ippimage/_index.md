...
Devuelve una copia de una imagen. Solo lectura \#getImage.getImage.
...
Reemplaza la imagen. Atención: cuando la Imagen es un metarchivo, se rasterizará. Use replaceImage(byte[]) en su lugar
...
Devuelve un tipo MIME de una imagen, codificado en \#getBinaryData.getBinaryData. Solo lectura String.
