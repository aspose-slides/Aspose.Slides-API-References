...
| [getActualMajorUnitScale()](#getActualMajorUnitScale--) | Especifica la escala de unidad mayor real del eje. |
| [getActualMinorUnitScale()](#getActualMinorUnitScale--) | Especifica la escala de unidad menor real del eje. |
...
| [getMinorUnit()](#getMinorUnit--) | Representa las unidades menores para el eje de fecha o de valores. |
| [setMinorUnit(double value)](#setMinorUnit-double-) | Representa las unidades menores para el eje de fecha o de valores. |
...
| [getMajorUnit()](#getMajorUnit--) | Representa las unidades mayores para el eje de fecha o de valores. |
| [setMajorUnit(double value)](#setMajorUnit-double-) | Representa las unidades mayores para el eje de fecha o de valores. |
...
| [getMajorTickMark()](#getMajorTickMark--) | Representa el tipo de marcador mayor para el eje especificado. |
| [setMajorTickMark(int value)](#setMajorTickMark-int-) | Representa el tipo de marcador mayor para el eje especificado. |
| [getMinorTickMark()](#getMinorTickMark--) | Representa el tipo de marcador menor para el eje especificado. |
| [setMinorTickMark(int value)](#setMinorTickMark-int-) | Representa el tipo de marcador menor para el eje especificado. |
| [getTickLabelPosition()](#getTickLabelPosition--) | Representa la posición de las etiquetas de los marcadores en el eje especificado. |
| [setTickLabelPosition(int value)](#setTickLabelPosition-int-) | Representa la posición de las etiquetas de los marcadores en el eje especificado. |
| [getMajorUnitScale()](#getMajorUnitScale--) | Representa la escala de unidad mayor para el eje de fecha. |
| [setMajorUnitScale(int value)](#setMajorUnitScale-int-) | Representa la escala de unidad mayor para el eje de fecha. |
| [getMinorUnitScale()](#getMinorUnitScale--) | Representa la escala de unidad mayor para el eje de fecha. |
| [setMinorUnitScale(int value)](#setMinorUnitScale-int-) | Representa la escala de unidad mayor para el eje de fecha. |
| [getBaseUnitScale()](#getBaseUnitScale--) | Especifica la unidad de tiempo más pequeña que se representa en el eje de fecha. |
| [setBaseUnitScale(int value)](#setBaseUnitScale-int-) | Especifica la unidad de tiempo más pequeña que se representa en el eje de fecha. |
| [getMinorGridLinesFormat()](#getMinorGridLinesFormat--) | Representa el formato de las líneas de cuadrícula menores en un eje de gráfico. |
| [getMajorGridLinesFormat()](#getMajorGridLinesFormat--) | Representa el formato de las líneas de cuadrícula mayores en un eje de gráfico. |
...
| [getCrossType()](#getCrossType--) | Representa el CrossType en el eje especificado donde cruza el otro eje. |
| [setCrossType(int value)](#setCrossType-int-) | Representa el CrossType en el eje especificado donde cruza el otro eje. |
...
| [isNumberFormatLinkedToSource()](#isNumberFormatLinkedToSource--) | Indica si el formato está vinculado a los datos de origen. |
| [setNumberFormatLinkedToSource(boolean value)](#setNumberFormatLinkedToSource-boolean-) | Indica si el formato está vinculado a los datos de origen. |
| [getTickLabelRotationAngle()](#getTickLabelRotationAngle--) | Representa el ángulo de rotación de las etiquetas de los marcadores Lectura/escritura float. |
| [setTickLabelRotationAngle(float value)](#setTickLabelRotationAngle-float-) | Representa el ángulo de rotación de las etiquetas de los marcadores Lectura/escritura float. |
| [getTickLabelSpacing()](#getTickLabelSpacing--) | Especifica cuántas etiquetas de marcador se omiten entre las que se dibujan. |
| [setTickLabelSpacing(long value)](#setTickLabelSpacing-long-) | Especifica cuántas etiquetas de marcador se omiten entre las que se dibujan. |
| [isAutomaticTickLabelSpacing()](#isAutomaticTickLabelSpacing--) | Especifica el valor de espaciado automático de etiquetas de marcador. |
| [setAutomaticTickLabelSpacing(boolean value)](#setAutomaticTickLabelSpacing-boolean-) | Especifica el valor de espaciado automático de etiquetas de marcador. |
| [getTickMarksSpacing()](#getTickMarksSpacing--) | Especifica cuántos marcadores se omiten antes de dibujar el siguiente. |
| [setTickMarksSpacing(long value)](#setTickMarksSpacing-long-) | Especifica cuántos marcadores se omiten antes de dibujar el siguiente. |
| [isAutomaticTickMarksSpacing()](#isAutomaticTickMarksSpacing--) | Especifica el valor de espaciado automático de marcadores. |
| [setAutomaticTickMarksSpacing(boolean value)](#setAutomaticTickMarksSpacing-boolean-) | Especifica el valor de espaciado automático de marcadores. |
| [getLabelOffset()](#getLabelOffset--) | Especifica la distancia de las etiquetas al eje. |
| [setLabelOffset(int value)](#setLabelOffset-int-) | Especifica la distancia de las etiquetas al eje. |
| [getCategoryAxisType()](#getCategoryAxisType--) | Especifica el tipo de eje de categoría. |
| [setCategoryAxisType(int value)](#setCategoryAxisType-int-) | Especifica el tipo de eje de categoría. |
...
| [getAggregationType()](#getAggregationType--) | Representa el tipo de agregación del eje de categoría (agrupamiento). |
| [setAggregationType(int value)](#setAggregationType-int-) | Representa el tipo de agregación del eje de categoría (agrupamiento). |
| [getBinWidth()](#getBinWidth--) | Especifica el ancho del intervalo cuando la propiedad AggregationType se establece en AxisAggregationType.ByBinWidth. |
| [setBinWidth(double value)](#setBinWidth-double-) | Especifica el ancho del intervalo cuando la propiedad AggregationType se establece en AxisAggregationType.ByBinWidth. |
| [getNumberOfBins()](#getNumberOfBins--) | Especifica el número de intervalos cuando la propiedad AggregationType se establece en AxisAggregationType.ByNumberOfBins. |
| [setNumberOfBins(long value)](#setNumberOfBins-long-) | Especifica el número de intervalos cuando la propiedad AggregationType se establece en AxisAggregationType.ByNumberOfBins. |
| [isOverflowBin()](#isOverflowBin--) | Especifica si se aplica un intervalo de desbordamiento. |
| [setOverflowBin(boolean value)](#setOverflowBin-boolean-) | Especifica si se aplica un intervalo de desbordamiento. |
| [isAutomaticOverflowBin()](#isAutomaticOverflowBin--) | Especifica el valor automático del intervalo de desbordamiento. |
| [setAutomaticOverflowBin(boolean value)](#setAutomaticOverflowBin-boolean-) | Especifica el valor automático del intervalo de desbordamiento. |
| [getOverflowBin()](#getOverflowBin--) | Especifica el valor personalizado del intervalo de desbordamiento. |
| [setOverflowBin(double value)](#setOverflowBin-double-) | Especifica el valor personalizado del intervalo de desbordamiento. |
| [isUnderflowBin()](#isUnderflowBin--) | Especifica si se aplica un intervalo de subdesbordamiento. |
| [setUnderflowBin(boolean value)](#setUnderflowBin-boolean-) | Especifica si se aplica un intervalo de subdesbordamiento. |
| [isAutomaticUnderflowBin()](#isAutomaticUnderflowBin--) | Especifica el valor automático del intervalo de subdesbordamiento. |
| [setAutomaticUnderflowBin(boolean value)](#setAutomaticUnderflowBin-boolean-) | Especifica el valor automático del intervalo de subdesbordamiento. |
| [getUnderflowBin()](#getUnderflowBin--) | Especifica el valor personalizado del intervalo de subdesbordamiento. |
| [setUnderflowBin(double value)](#setUnderflowBin-double-) | Especifica el valor personalizado del intervalo de subdesbordamiento. |
...
Representa si el eje de valores cruza el eje de categorías entre categorías. Esta propiedad solo se aplica a ejes de categoría y no se aplica a gráficos 3-D. Lectura/escritura boolean.
...
Especifica el valor máximo real en el eje. Llama previamente al método IChart.ValidateChartLayout() para obtener el valor real.
...
Especifica el valor mínimo real en el eje. Llama previamente al método IChart.ValidateChartLayout() para obtener el valor real.
...
Especifica la unidad mayor real del eje. Llama previamente al método IChart.ValidateChartLayout() para obtener el valor real.
...
Especifica la unidad menor real del eje. Llama previamente al método IChart.ValidateChartLayout() para obtener el valor real.
...
Especifica la escala de unidad mayor real del eje. Llama previamente al método IChart.ValidateChartLayout() para obtener el valor real.
...
Especifica la escala de unidad menor real del eje. Llama previamente al método IChart.ValidateChartLayout() para obtener el valor real.
...
Representa las unidades menores para el eje de fecha o de valores. Lectura/escritura double.
...
Representa las unidades mayores para el eje de fecha o de valores. Lectura/escritura double.
...
Representa la escala de unidad mayor para el eje de fecha. Lectura/escritura [TimeUnitType](../../com.aspose.slides/timeunittype).
...
Especifica la unidad de tiempo más pequeña que se representa en el eje de fecha. Lectura/escritura [TimeUnitType](../../com.aspose.slides/timeunittype).
...
Representa el CrossType en el eje especificado donde cruza el otro eje. Lectura/escritura [CrossesType](../../com.aspose.slides/crossestype).
...
Indica si el formato está vinculado a los datos de origen. Lectura/escritura boolean.
...
Especifica cuántas etiquetas de graduación se omiten entre las etiquetas que se dibujan. Lectura/escritura long.
...
Especifica el valor de espaciado automático de etiquetas de graduación. Si es false: use la propiedad TickLabelSpacing. Lectura/escritura boolean.
...
Especifica cuántas marcas de graduación se deben omitir antes de dibujar la siguiente. Aplicado al eje de categoría o de series. Lectura/escritura int.
...
Especifica el valor de espaciado automático de marcas de graduación. Si es false: use la propiedad TickMarksSpacing. Lectura/escritura boolean.
...
Especifica la distancia de las etiquetas del eje. Aplicado al eje de categoría o de fecha. El valor debe estar entre 0% y 1000%. Lectura/escritura int.
...
Especifica el tipo del eje de categoría. Lectura/escritura [CategoryAxisType](../../com.aspose.slides/categoryaxistype)(\#getCategoryAxisType.getCategoryAxisType/\#setCategoryAxisType(int).setCategoryAxisType(int)).
...
Representa el tipo de agregación del eje de categoría (agrupamiento). Aplicado a categoría. Usado solo con series Histogram o HistogramPareto.
...
Especifica el ancho del intervalo cuando el valor de la propiedad AggregationType se establece en AxisAggregationType.ByBinWidth. Se aplica a los ejes de categoría. Se usa solo con series Histogram o HistogramPareto.
...
Especifica el número de intervalos cuando el valor de la propiedad AggregationType se establece en AxisAggregationType.ByNumberOfBins. Se aplica a los ejes de categoría. Se usa solo con series Histogram o HistogramPareto.
...
Especifica si se aplica el intervalo de desbordamiento. Use IsAutomaticOverflowBin y OverflowBin para ajustar el valor del intervalo de desbordamiento.
...
Especifica el valor automático del intervalo de desbordamiento. Si false: use OverflowBin property.
...
Especifica el valor personalizado del intervalo de desbordamiento. Se aplica cuando la propiedad IsAutomaticOverflowBin se establece en false y la propiedad IsOverflowBin es true.
...
Especifica si se aplica el intervalo de subdesbordamiento. Use IsAutomaticUnderflowBin y UnderflowBin para ajustar el valor del intervalo de subdesbordamiento.
...
Especifica el valor automático del intervalo de subdesbordamiento. Si false: use UnderflowBin property.
...
Especifica el valor personalizado del intervalo de subdesbordamiento. Se aplica cuando la propiedad IsAutomaticUnderflowBin se establece en false y la propiedad IsUnderflowBin es true.
