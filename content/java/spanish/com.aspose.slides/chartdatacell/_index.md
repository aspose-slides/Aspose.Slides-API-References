...
Obtiene o establece el formato de visualización incorporado de números y fechas. El número predefinido debe estar en [0..22] o [37..49]. Lectura/escritura byte.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| updateValues | boolean | Si es false, no se realizará ningún cálculo real. Use true para posible verificación de excepciones. |