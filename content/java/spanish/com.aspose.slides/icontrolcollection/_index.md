...
| [addControl(int controlType, float x, float y, float width, float height)](#addControl-int-float-float-float-float-) | Crea y añade un nuevo control a la colección. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| controlType | int | Tipo de control a añadir. |
| x | float | La coordenada X para el lado izquierdo del marco de la forma. |
| y | float | La coordenada Y para el lado superior del marco de la forma. |
