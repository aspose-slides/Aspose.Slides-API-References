...
Determina si solo se trazan las celdas visibles. Falso para trazar tanto celdas visibles como ocultas. Lectura/escritura boolean.
...
Devuelve o establece el título del gráfico. Solo lectura [IChartTitle](../../com.aspose.slides/icharttitle).
...
Devuelve el formato de texto del gráfico. La propiedad no es aplicable para los siguientes tipos: [ChartType.Treemap](../../com.aspose.slides/charttype\#Treemap), [ChartType.Sunburst](../../com.aspose.slides/charttype\#Sunburst), [ChartType.Waterfall](../../com.aspose.slides/charttype\#Waterfall), [ChartType.Histogram](../../com.aspose.slides/charttype\#Histogram), [ChartType.Funnel](../../com.aspose.slides/charttype\#Funnel),[ChartType.BoxAndWhisker](../../com.aspose.slides/charttype\#BoxAndWhisker). Solo lectura [IChartTextFormat](../../com.aspose.slides/icharttextformat).
...
Devuelve el administrador de temas. Solo lectura [IOverrideThemeManager](../../com.aspose.slides/ioverridethememanager).
