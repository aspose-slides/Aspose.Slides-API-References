...
description: Define un plano en el que los efectos como brillo y sombra se aplican en relación con la forma a la que se aplican.
type: docs
...
Define un plano en el que los efectos, como brillo y sombra, se aplican en relación con la forma a la que se están aplicando.
## Métodos
...
| [getUpVector()](#getUpVector--) | Devuelve o establece un vector que representa la dirección hacia arriba. |
| [setUpVector(float[] value)](#setUpVector-float---) | Devuelve o establece un vector que representa la dirección hacia arriba. |
...
Devuelve o establece un vector que representa la dirección hacia arriba. Para ser más preciso, este atributo define un vector que representa la dirección hacia arriba en relación con la cara del plano de fondo. Vector representado por una matriz de 3 valores float que definen las coordenadas X, Y y Z. Lectura/escritura float[].
