...
| [isSynchronized()](#isSynchronized--) | Devuelve un valor que indica si el acceso a la colección está sincronizado (a prueba de subprocesos). |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| stream | java.io.InputStream | Flujo desde el cual añadir la imagen.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| stream | java.io.InputStream | Flujo desde el cual añadir el archivo de imagen. |
...
Devuelve un valor que indica si el acceso a la colección está sincronizado (a prueba de subprocesos). Solo lectura  boolean .
