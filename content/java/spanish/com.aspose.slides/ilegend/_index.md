...
| Método | Descripción |
| --- | --- |
| [getOverlay()](#getOverlay--) | Determina si se permitirá que otros elementos del gráfico se superpongan a la leyenda. |
| [setOverlay(boolean value)](#setOverlay-boolean-) | Determina si se permitirá que otros elementos del gráfico se superpongan a la leyenda. |
...
Determina si se permitirá que otros elementos del gráfico se superpongan a la leyenda. Lectura/escritura boolean.
...
Especifica la posición de la leyenda en un gráfico. Los valores que no son NaN de las propiedades X, Y, Width, Heigt sobrescriben el efecto de esta propiedad. Lectura/escritura [LegendPositionType](../../com.aspose.slides/legendpositiontype).
