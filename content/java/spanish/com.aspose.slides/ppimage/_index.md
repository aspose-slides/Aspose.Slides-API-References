...
Devuelve una copia de los datos de una imagen. Solo lectura byte[] .
...
Devuelve una copia de una imagen. Solo lectura [IImage](../../com.aspose.slides/iimage).
...
Reemplaza los datos de la imagen. Atención: cuando Image es metafile, será rasterizada. Use ReplaceImage(byte[]) en su lugar
...
Devuelve un tipo MIME de una imagen, codificado en BinaryData (\#getBinaryData.getBinaryData). Solo lectura String.
...
Devuelve el ancho de una imagen. Solo lectura int .
...
Devuelve la altura de una imagen. Solo lectura int .
...
Devuelve el desplazamiento X de una imagen. Solo lectura int .
...
Devuelve el desplazamiento Y de una imagen. Solo lectura int .
