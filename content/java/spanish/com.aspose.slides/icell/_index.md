...
| [isMergedCell()](#isMergedCell--) | Devuelve true si la celda está combinada con alguna celda adyacente, false en caso contrario. |
| [getCellFormat()](#getCellFormat--) | Devuelve el objeto CellFormat que contiene las propiedades de formato de esta celda. |
...
Devuelve el número de columnas de la cuadrícula de la tabla principal que debe abarcar la celda actual. Esta propiedad permite que las celdas parezcan combinadas, ya que abarcan los límites verticales de otras celdas en la tabla. Solo lectura int.
...
Devuelve true si la celda está combinada con alguna celda ajustada, false en caso contrario. Solo lectura boolean.
...
Devuelve el objeto CellFormat que contiene las propiedades de formato de esta celda. Solo lectura [ICellFormat](../../com.aspose.slides/icellformat).
