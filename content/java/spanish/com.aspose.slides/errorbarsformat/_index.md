...
description: Representa barras de error de series de gráficos.
type: docs
...
Representa barras de error de series de gráfico. Los valores personalizados de ErrorBars están en IChartDataPointCollection (en la propiedad ([IChartDataPoint.getErrorBarsCustomValues](../../com.aspose.slides/ichartdatapoint\#getErrorBarsCustomValues))).
...
| [getValueType()](#getValueType--) | Representa formas posibles de determinar la longitud de las barras de error. |
| [setValueType(int value)](#setValueType-int-) | Representa formas posibles de determinar la longitud de las barras de error. |
...
Representa formas posibles de determinar la longitud de las barras de error. En caso de tipo de valor personalizado, use la propiedad ([IChartDataPoint.getErrorBarsCustomValues](../../com.aspose.slides/ichartdatapoint\#getErrorBarsCustomValues)) del punto de datos específico en la colección DataPoints de la serie. En caso de tipo de valor Fixed, Percentage o StandardDeviation, use la propiedad Value para especificar el valor. Lectura/escritura [ErrorBarValueType](../../com.aspose.slides/errorbarvaluetype).
