...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| script | java.lang.String | El código de script BCP-47 (p. ej., "Latn", "Cyrl", "Jpan") utilizado para identificar un sistema de escritura. |

**Devuelve:**
java.lang.String - El nombre de la fuente utilizada para el script especificado, o  null  si el script no está definido.
