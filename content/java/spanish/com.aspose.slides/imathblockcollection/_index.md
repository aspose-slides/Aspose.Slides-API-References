...
| [remove(IMathBlock item)](#remove-com.aspose.slides.IMathBlock-) | Elimina la primera aparición de un objeto específico de la colección. |
...
| --- | --- | --- |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | Un bloque matemático que se añadirá al final de la colección |
