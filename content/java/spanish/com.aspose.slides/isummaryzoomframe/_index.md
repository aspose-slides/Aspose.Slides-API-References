...
description: Representa un marco de Summary Zoom en una diapositiva.
type: docs
...
Representa un marco de Summary Zoom en una diapositiva.
## Métodos

| Método | Descripción |
| --- | --- |
| [getLayout()](#getLayout--) | Obtiene el diseño de Summary Zoom Sections en el marco. |
