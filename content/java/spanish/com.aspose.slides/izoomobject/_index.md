...
Obtiene o establece el tipo de imagen de un objeto Zoom. Read/write [ZoomImageType](../../com.aspose.slides/zoomimagetype). Valor predeterminado: Preview

--------------------

> ```
> Este ejemplo muestra cómo cambiar el tipo de imagen al valor Preview. 
>  En este caso la imagen actual de un objeto Zoom cambia a la imagen de la diapositiva:
>  
...
Obtiene o establece el comportamiento de navegación en la presentación. Read/write boolean. Valor predeterminado: false
...
El valor verdadero de la propiedad especifica el comportamiento de navegación de retorno al padre en la presentación.
...
Obtiene o establece el valor que especifica si el Zoom usará el fondo de la diapositiva de destino. Read/write boolean. Valor predeterminado: true
...
Obtiene o establece la imagen para el objeto Zoom. Read/write [IPPImage](../../com.aspose.slides/ippimage).
...
Obtiene o establece la duración de la transición entre Zoom y diapositiva. Read/write float. Valor predeterminado: 1.0f
