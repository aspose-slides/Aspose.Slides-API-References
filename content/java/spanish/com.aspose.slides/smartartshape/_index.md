...
| Método | Descripción |
| --- | --- |
| [getShapeType()](#getShapeType--) | Devuelve o establece el tipo preestablecido de geometría. |
| [setShapeType(int value)](#setShapeType-int-) | Devuelve o establece el tipo preestablecido de geometría. |
...
Devuelve o establece el tipo preestablecido de geometría. Nota: al cambiar el valor, todos los valores de ajuste se restablecerán a sus valores predeterminados. Lectura/escritura [ShapeType](../../com.aspose.slides/shapetype).
