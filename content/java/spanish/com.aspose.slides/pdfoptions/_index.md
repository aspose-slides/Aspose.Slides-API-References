...
>      // Establece el comportamiento para los metaficheros
...
| [getEmbedFullFonts()](#getEmbedFullFonts--) | Determina si todos los caracteres de la fuente deben incrustarse o solo un subconjunto utilizado. |
| [setEmbedFullFonts(boolean value)](#setEmbedFullFonts-boolean-) | Determina si todos los caracteres de la fuente deben incrustarse o solo un subconjunto utilizado. |
...
| [getPassword()](#getPassword--) | Establecer la contraseña de usuario para proteger el documento PDF. |
| [setPassword(String value)](#setPassword-java.lang.String-) | Establecer la contraseña de usuario para proteger el documento PDF. |
...
| [getSaveMetafilesAsPng()](#getSaveMetafilesAsPng--) | Verdadero para convertir todos los metaficheros utilizados en una presentación a imágenes PNG. |
| [setSaveMetafilesAsPng(boolean value)](#setSaveMetafilesAsPng-boolean-) | Verdadero para convertir todos los metaficheros utilizados en una presentación a imágenes PNG. |
...
Indica si la compresión más eficaz (en lugar de la predeterminada) para cada imagen debe seleccionarse automáticamente. Si se establece en true, para cada imagen en la presentación se elegirá el algoritmo de compresión más apropiado, lo que producirá un tamaño menor del PDF resultante.

--------------------

La selección de la mejor razón de compresión de imágenes es computacionalmente costosa y requiere memoria RAM adicional, y esta opción es false por defecto.
...
Determina si todos los caracteres de la fuente deben incrustarse o solo un subconjunto utilizado. **Lectura/escritura** boolean.
...
Establecer la contraseña de usuario para proteger el documento PDF. **Lectura/escritura** String.
...
Contiene un conjunto de indicadores que especifican qué permisos de acceso deben concederse cuando el documento se abre con acceso de usuario. Ver [PdfAccessPermissions](../../com.aspose.slides/pdfaccesspermissions).
