...
type: docs
url: /es/com.aspose.slides/legacydiagram/
---
**Herencia:**
...
| [convertToGroupShape()](#convertToGroupShape--) | Convierte el diagrama heredado en un grupo de formas editable. |
...
Convierte el diagrama heredado en un objeto SmartArt editable. El objeto SmartArt creado se agrega al grupo de formas padre en la misma posición.
...
Convierte el diagrama heredado en un grupo de formas editable. El objeto GroupShape creado se agrega al grupo de formas padre en la misma posición.
