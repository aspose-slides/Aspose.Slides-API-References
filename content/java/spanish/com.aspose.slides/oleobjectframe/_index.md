...
Returns OleObject image fill properties object. Solo lectura [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
Returns or sets the title for OleObject icon. Lectura/escritura String.
...
Returns or sets the name of an object. Lectura/escritura String.
...
Returns the ProgID of an object. Solo lectura String.
...
Returns the full path to a linked file. Short file name will be used. Solo lectura String.
...
Returns the full path to a linked file. Long file name will be used. Lectura/escritura String.
...
Returns the relative path to a linked file if present, otherwise returns an empty string. Solo lectura String.
...
Gets or sets information about OLE embedded data. Lectura/escritura [IOleEmbeddedDataInfo](../../com.aspose.slides/ioleembeddeddatainfo).
...
Determines whether an object is visible as icon. Lectura/escritura boolean.
...
Determines whether an object is linked to external file. Solo lectura boolean.
...
Determines if the linked embedded object is automatically updated when the presentation is opened or printed. Lectura/escritura boolean.
