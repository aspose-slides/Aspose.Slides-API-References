...
Esta clase se usa para devolver y manipular las propiedades de formato de párrafo definidas para el párrafo particular. Esto significa que no se aplica herencia al obtener valores, por lo que en la mayoría de los casos se obtendrán valores que significan “indefinido”.

Para obtener los valores de los parámetros de formato efectivos, incluyendo los heredados, es necesario usar el método [getEffective](../../com.aspose.slides/paragraphformat\#getEffective) que devuelve una instancia [IParagraphFormatEffectiveData](../../com.aspose.slides/iparagraphformateffectivedata).
## Constructores
...
| [getIndent()](#getIndent--) | Devuelve o establece la sangría de la primera línea/sangría colgante del párrafo sin herencia. |
| [setIndent(float value)](#setIndent-float-) | Devuelve o establece la sangría de la primera línea/sangría colgante del párrafo sin herencia. |
...
| [getFontAlignment()](#getFontAlignment--) | Devuelve o establece una alineación de fuente en un párrafo sin herencia. |
| [setFontAlignment(int value)](#setFontAlignment-int-) | Devuelve o establece una alineación de fuente en un párrafo sin herencia. |
...
>      // Accediendo a la primera diapositiva
>      ISlide slide = pres.getSlides().get_Item(0);
>      // Accediendo al primer y segundo marcador de posición en la diapositiva y convirtiéndolos a AutoShape
>      ITextFrame tf1 = ((IAutoShape)slide.getShapes().get_Item(0)).getTextFrame();
>      ITextFrame tf2 = ((IAutoShape)slide.getShapes().get_Item(1)).getTextFrame();
>      // Cambiar el texto en ambos marcadores de posición
>      tf1.setText("Center Align by Aspose");
...
Devuelve o establece la cantidad de espacio entre líneas base en un párrafo. Un valor positivo significa porcentaje, uno negativo tamaño en puntos. No se aplica herencia. Lectura/escritura float .
...
Devuelve o establece la sangría de la primera línea/sangría colgante del párrafo sin herencia. La sangría colgante puede definirse con valores negativos. Lectura/escritura float .
...
Devuelve o establece una alineación de fuente en un párrafo sin herencia. Lectura/escritura [FontAlignment](../../com.aspose.slides/fontalignment).
...
> ```
> Este ejemplo demuestra cómo obtener algunas propiedades de formato de párrafo efectivas.
>  
