...
description: Clase de controlador de formato para usar al incrustar fuentes en formato EOT
type: docs
...
Se llama antes de renderizar la forma. Se llama una vez por cada forma. Si esta función escribe algo en el generador, la generación de la imagen de la diapositiva actual se terminará, se insertará el fragmento html añadido y se iniciará una nueva imagen sobre la anterior.
