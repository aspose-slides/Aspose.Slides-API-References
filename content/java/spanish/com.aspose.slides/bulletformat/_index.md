...
| [applyDefaultParagraphIndentsShifts()](#applyDefaultParagraphIndentsShifts--) | Establece desplazamientos predeterminados diferentes de cero para el sangrado y MarginLeft efectivos del párrafo cuando las viñetas están habilitadas (como hace PowerPoint al habilitar viñetas/numeración de párrafo). |
...
Un valor de altura negativo significa que la altura se da en puntos y un valor positivo indica que la altura es un porcentaje del texto circundante.
...
Establece desplazamientos predeterminados diferentes de cero para el sangrado y MarginLeft efectivos del párrafo cuando las viñetas están habilitadas (como hace PowerPoint al habilitar viñetas/numeración de párrafo). Si las viñetas están deshabilitadas, simplemente restablece el sangrado y MarginLeft del párrafo (como hace PowerPoint al deshabilitar viñetas/numeración de párrafo). Los desplazamientos de sangrado se aplican en relación al contexto actual de la viñeta: IBulletFormat.Type, .NumberedBulletStyle y FontHeight de la primera porción. Los desplazamientos de sangrado diferentes de cero se aplican al sangrado y MarginLeft efectivos del párrafo actual (haciendo que los valores resultantes sean valores locales).
