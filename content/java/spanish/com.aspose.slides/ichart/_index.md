...
| [getDisplayBlanksAs()](#getDisplayBlanksAs--) | Devuelve o establece la forma de representar celdas en blanco en un gráfico. |
| [setDisplayBlanksAs(int value)](#setDisplayBlanksAs-int-) | Devuelve o establece la forma de representar celdas en blanco en un gráfico. |
...
| [getChartTitle()](#getChartTitle--) | Devuelve o establece el título de un gráfico Solo lectura [IChartTitle](../../com.aspose.slides/icharttitle). |
...
Devuelve o establece la forma de representar celdas en blanco en un gráfico. Lectura/escritura [DisplayBlanksAsType](../../com.aspose.slides/displayblanksastype).
...
Devuelve o establece el título de un gráfico Solo lectura [IChartTitle](../../com.aspose.slides/icharttitle).
