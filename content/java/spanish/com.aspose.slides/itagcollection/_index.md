...
| [get_Item(String name)](#get-Item-java.lang.String-) | Devuelve o establece un par clave y valor de una etiqueta. |
| [set_Item(String name, String value)](#set-Item-java.lang.String-java.lang.String-) | Devuelve o establece un par clave y valor de una etiqueta. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| index | int | Índice de una etiqueta a devolver. |
...
Devuelve o establece un par clave y valor de una etiqueta.
