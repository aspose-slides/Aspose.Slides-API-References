...
| [getSlide()](#getSlide--) | Devuelve la diapositiva principal de una imagen. |
### getParent_Immediate() {#getParent-Immediate--}
```
...
Devuelve la diapositiva principal de una imagen. Solo lectura [IBaseSlide](../../com.aspose.slides/ibaseslide).
