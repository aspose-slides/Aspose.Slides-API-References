...
| [save(String filename, int format, int quality)](#save-java.lang.String-int-int-) | Guarda la imagen en un archivo en el formato especificado y con calidad. |
| [save(OutputStream stream, int format, int quality)](#save-java.io.OutputStream-int-int-) | Guarda la imagen en un flujo en el formato especificado y con calidad. |
...
Guarda la imagen en un archivo en el formato especificado y con calidad.
...
| filename | java.lang.String | La ruta al archivo donde se guardará la imagen. |
| format | int | El formato de la imagen. |
| quality | int | La calidad de la imagen guardada (0 a 100). Este parámetro solo afecta el guardado en [ImageFormat.Jpeg](../../com.aspose.slides/imageformat\#Jpeg); para todos los demás formatos, se ignora. |
...
Guarda la imagen en un flujo en el formato especificado y con calidad.
