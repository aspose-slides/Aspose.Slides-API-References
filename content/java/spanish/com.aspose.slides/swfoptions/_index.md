...
| [getLogoLink()](#getLogoLink--) | Obtiene o establece la dirección de hipervínculo completa para un logotipo. |
| [setLogoLink(String value)](#setLogoLink-java.lang.String-) | Obtiene o establece la dirección de hipervínculo completa para un logotipo. |
...
Mostrar/ocultar el botón de pantalla completa. Puede sobrescribirse mediante flashvars. El valor predeterminado es true.
...
Mostrar/ocultar el selector de página. Puede sobrescribirse mediante flashvars. El valor predeterminado es true.
...
Mostrar/ocultar la sección de búsqueda. Puede sobrescribirse mediante flashvars. El valor predeterminado es true.
...
Mostrar/ocultar el panel inferior. Puede sobrescribirse mediante flashvars. El valor predeterminado es true.
...
Mostrar/ocultar el panel izquierdo. Puede sobrescribirse mediante flashvars. El valor predeterminado es true.
...
Imagen que se mostrará como logotipo en la esquina superior derecha del visor. La imagen debe ser PNG de 32x64 píxeles; de lo contrario, el logotipo puede mostrarse de forma incorrecta.
...
Obtiene o establece la dirección de hipervínculo completa para un logotipo. Tiene efecto solo si se especifica (\#getLogoImageBytes.getLogoImageBytes/\#setLogoImageBytes(byte[]).setLogoImageBytes(byte[])).
