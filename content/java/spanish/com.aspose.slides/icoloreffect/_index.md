...
| [getDirection()](#getDirection--) | Especifica la dirección en que se recorre el matiz alrededor de la rueda de colores. |
| [setDirection(int value)](#setDirection-int-) | Especifica la dirección en que se recorre el matiz alrededor de la rueda de colores. |
### getFrom() {#getFrom--}
```
...
Especifica la dirección en que se recorre el matiz alrededor de la rueda de colores. Lectura/escritura [ColorDirection](../../com.aspose.slides/colordirection).
