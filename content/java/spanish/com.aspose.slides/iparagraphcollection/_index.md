...
| [remove(IParagraph item)](#remove-com.aspose.slides.IParagraph-) | Elimina la primera ocurrencia de un párrafo específico. |
| [addFromHtml(String text)](#addFromHtml-java.lang.String-) | Agrega texto de la cadena html especificada a la colección. |
| [addFromHtml(String text, IExternalResourceResolver resolver, String uri)](#addFromHtml-java.lang.String-com.aspose.slides.IExternalResourceResolver-java.lang.String-) | Agrega texto de la cadena html especificada a la colección. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| index | int | El índice base cero en el que se debe insertar el Paragraph. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| index | int | El índice base cero en el que se deben insertar los párrafos. |
...
| --- | --- | --- |
| text | java.lang.String | Texto HTML. |
| resolver | [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver) | Objeto de devolución de llamada del resolver que resuelve URIs y recupera objetos referenciados. |
| uri | java.lang.String | URI para añadir el documento HTML. Utilizado para resolver enlaces relativos.
...
| paragraphsCount | int | Cantidad de párrafos int |
