...
| [getImage(Dimension imageSize)](#getImage-java.awt.Dimension-) | Devuelve un objeto Thumbnail Image con tamaño especificado. |
...
| [getImage(IRenderingOptions options, Dimension imageSize)](#getImage-com.aspose.slides.IRenderingOptions-java.awt.Dimension-) | Devuelve un objeto Thumbnail Image con tamaño especificado. |
...
Devuelve el número de diapositiva. El índice de la diapositiva en la colección [Presentation.getSlides](../../com.aspose.slides/presentation\#getSlides) siempre es igual a SlideNumber - Presentation.FirstSlideNumber. Lectura/escritura int.
...
>      // Establecer el ancho del área de comentarios
>      notesCommentsLayouting.setCommentsAreaWidth(500);
>      // Establecer el color del área de comentarios
...
>      // Convertir la primera diapositiva de la presentación a un objeto BufferedImage
