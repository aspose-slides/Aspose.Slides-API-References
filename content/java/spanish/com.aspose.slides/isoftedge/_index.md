...
type: docs
url: /es/com.aspose.slides/isoftedge/
---
...
| Método | Descripción |
| --- | --- |
| [getRadius()](#getRadius--) | Especifica el radio de desenfoque que se aplicará a los bordes. |
| [setRadius(double value)](#setRadius-double-) | Especifica el radio de desenfoque que se aplicará a los bordes. |
### getRadius() {#getRadius--}
```
