...
| [add(IChartDataCell chartDataCell)](#add-com.aspose.slides.IChartDataCell-) | Agrega una nueva celda a la colección. |
| [add(Object value)](#add-java.lang.Object-) | Crea [IChartDataCell](../../com.aspose.slides/ichartdatacell) a partir del valor especificado y lo agrega a la colección. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| chartDataCell | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Nueva celda a agregar. |
...
Crea [IChartDataCell](../../com.aspose.slides/ichartdatacell) a partir del valor especificado y lo agrega a la colección.
...
Este método agrega una hoja de cálculo con el nombre AUTO_DATA y agrega allí todos los valores. Si usa [IChartDataWorkbook](../../com.aspose.slides/ichartdataworkbook) para agregar o editar valores de celda, asegúrese de no usar esta hoja de cálculo. El número máximo de valores agregados con este método no debe superar 16711680 |
