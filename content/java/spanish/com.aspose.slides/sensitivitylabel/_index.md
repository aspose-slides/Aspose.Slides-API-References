...
| [getContentMarkTypes()](#getContentMarkTypes--) | Devuelve la lista de tipos de marcas de contenido que deben aplicarse a un archivo. |
### getId() {#getId--}
```
...
Devuelve la lista de tipos de marcas de contenido que deben aplicarse a un archivo.

**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericList<java.lang.Integer> - Una lista de tipos de contenido [SensitivityLabelContentType](../../com.aspose.slides/sensitivitylabelcontenttype)