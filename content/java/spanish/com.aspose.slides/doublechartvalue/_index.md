...
**Devuelve:**
double - Devuelve LiteralDouble si DataSourceType es igual a DoubleLiterals. Si DataSourceType es igual a Worksheet devuelve el valor de celda convertido exitosamente a double, de lo contrario devuelve NaN.