...
| [getHtmlFormatter()](#getHtmlFormatter--) | Obtiene o establece la plantilla HTML. |
| [setHtmlFormatter(IHtmlFormatter value)](#setHtmlFormatter-com.aspose.slides.IHtmlFormatter-) | Obtiene o establece la plantilla HTML. |
...
| [getSlideImageFormat()](#getSlideImageFormat--) | Obtiene o establece las opciones de formato de imagen de diapositiva. |
| [setSlideImageFormat(ISlideImageFormat value)](#setSlideImageFormat-com.aspose.slides.ISlideImageFormat-) | Obtiene o establece las opciones de formato de imagen de diapositiva. |
| [getJpegQuality()](#getJpegQuality--) | Obtiene o establece un valor que determina la calidad de las imágenes JPEG dentro del documento PDF. |
| [setJpegQuality(byte value)](#setJpegQuality-byte-) | Obtiene o establece un valor que determina la calidad de las imágenes JPEG dentro del documento PDF. |
...
| [getSvgResponsiveLayout()](#getSvgResponsiveLayout--) | Verdadero para excluir los atributos width y height del contenedor svg, lo que hará que el diseño sea responsivo. |
| [setSvgResponsiveLayout(boolean value)](#setSvgResponsiveLayout-boolean-) | Verdadero para excluir los atributos width y height del contenedor svg, lo que hará que el diseño sea responsivo. |
...
Crea un nuevo objeto HtmlOptions especificando la devolución de llamada.

**Parámetros:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| linkEmbedController | [ILinkEmbedController](../../com.aspose.slides/ilinkembedcontroller) | Objeto de devolución de llamada que controla el guardado del proyecto. |
...
Obtiene o establece la plantilla HTML. Lectura/escritura [IHtmlFormatter](../../com.aspose.slides/ihtmlformatter).
...
Obtiene o establece las opciones de formato de imagen de diapositiva. Lectura/escritura [ISlideImageFormat](../../com.aspose.slides/islideimageformat).
...
Obtiene o establece un valor que determina la calidad de las imágenes JPEG dentro del documento PDF. Lectura/escritura byte.

--------------------

Tiene efecto solo cuando un documento contiene imágenes JPEG.

Utilice esta propiedad para obtener o establecer la calidad de las imágenes dentro de un documento al guardarlo en formato PDF. El valor puede variar de 0 a 100, donde 0 significa la peor calidad pero máxima compresión y 100 significa la mejor calidad pero mínima compresión.
...
Una bandera booleana indica si las partes recortadas permanecen como parte del documento. Si es true, las partes recortadas se eliminarán; si es false, se serializarán en el documento (lo que puede llevar a un archivo más grande)
...
Verdadero para excluir los atributos width y height del contenedor svg, lo que hará que el diseño sea responsivo. Falso en caso contrario. Lectura/escritura boolean.
