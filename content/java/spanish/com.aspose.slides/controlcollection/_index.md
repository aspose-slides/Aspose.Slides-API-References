...
| [isSynchronized()](#isSynchronized--) | Devuelve un valor que indica si el acceso a la colección está sincronizado (seguro para subhilos). |
...
**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IControl> - Un IGenericEnumerator que puede usarse para recorrer la colección.
...
**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IControl> - Un java.util.Iterator para toda la colección.
...
Devuelve un valor que indica si el acceso a la colección está sincronizado (seguro para subhilos). Solo lectura boolean.
