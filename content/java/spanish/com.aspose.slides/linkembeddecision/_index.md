...
| [Embed](#Embed) | El objeto debe incrustarse en un archivo generado si es posible. |
...
El objeto debe incrustarse en un archivo generado si es posible. Si la incrustación es imposible, se llamará a GetUrl y, según el resultado, el objeto será referenciado por URL o será ignorado.
