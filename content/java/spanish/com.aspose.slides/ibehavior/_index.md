...
Representa el comportamiento base del efecto.
## Métodos
...
| [getTiming()](#getTiming--) | Representa las propiedades de tiempo para el comportamiento del efecto. |
| [setTiming(ITiming value)](#setTiming-com.aspose.slides.ITiming-) | Representa las propiedades de tiempo para el comportamiento del efecto. |
...
Representa las propiedades de tiempo para el comportamiento del efecto. Lectura/escritura [ITiming](../../com.aspose.slides/itiming).
