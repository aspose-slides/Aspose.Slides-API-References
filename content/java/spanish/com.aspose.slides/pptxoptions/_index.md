---
title: PptxOptions
second_title: Referencia de API Aspose.Slides para Java
...
| Método | Descripción |
| --- | --- |
| [getConformance()](#getConformance--) | Especifica la clase de conformidad a la que el documento Presentation se ajusta. |
| [setConformance(int value)](#setConformance-int-) | Especifica la clase de conformidad a la que el documento Presentation se ajusta. |
| [getZip64Mode()](#getZip64Mode--) | Especifica si se usa el formato ZIP64 para el documento Presentation. |
| [setZip64Mode(int value)](#setZip64Mode-int-) | Especifica si se usa el formato ZIP64 para el documento Presentation. |
...
Especifica la clase de conformidad a la que el documento Presentation se ajusta. El valor predeterminado es [Conformance.Ecma376\_2006](../../com.aspose.slides/conformance\#Ecma376-2006)
...
Especifica si se usa el formato ZIP64 para el documento Presentation. El valor predeterminado es [Zip64Mode.IfNecessary](../../com.aspose.slides/zip64mode\#IfNecessary)
...
Especifica si la miniatura de la presentación se actualizará. Lectura/escritura booleano. El valor predeterminado es **true**.
...
Los niveles de compresión más altos producen archivos más pequeños pero requieren más tiempo de procesamiento. La proporción de compresión real depende del contenido de la presentación.
