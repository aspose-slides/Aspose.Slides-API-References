...
| [getShowBackground()](#getShowBackground--) | Obtiene o establece el valor que indica si el Zoom usará el fondo de la diapositiva de destino. |
| [setShowBackground(boolean value)](#setShowBackground-boolean-) | Obtiene o establece el valor que indica si el Zoom usará el fondo de la diapositiva de destino. |
...
> ```
> El siguiente ejemplo muestra cómo cambiar el tipo de imagen a valor Preview. 
...
> ```
> El siguiente ejemplo muestra cómo cambiar el tipo de imagen al valor Preview. 
>  En este caso, la imagen actual de un objeto Zoom cambia a la imagen de la diapositiva:
>  
>  Presentation pres = new Presentation("pres.pptx");
>  try {
...
El valor verdadero de la propiedad indica el comportamiento de navegación de regreso al elemento padre en la presentación.
...
Obtiene o establece el valor que indica si el Zoom usará el fondo de la diapositiva de destino. Lectura/escritura boolean. Valor predeterminado: true
