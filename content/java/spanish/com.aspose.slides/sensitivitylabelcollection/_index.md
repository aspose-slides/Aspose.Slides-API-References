...
| siteId | java.util.UUID | El identificador del sitio Azure Active Directory (Azure AD). |
| isEnabled | boolean | Indicador que indica si la etiqueta de sensibilidad está habilitada. |
