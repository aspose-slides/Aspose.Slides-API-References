...
> ```
> El ejemplo muestra cómo obtener el elemento Summary Zoom Section por índice:
>  
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| section | [ISection](../../com.aspose.slides/isection) | Sección para la cual se eliminará el elemento Summary Zoom Section [ISection](../../com.aspose.slides/isection). |
