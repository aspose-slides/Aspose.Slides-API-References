...
type: docs
url: /es/com.aspose.slides/overridetheme/
---
**Herencia:**
...
| [isEmpty()](#isEmpty--) | Un valor verdadero indica que ColorScheme, FontScheme y FormatScheme son nulos y cualquier sobrescritura con este objeto de tema está deshabilitada. |
| [clear()](#clear--) | Establece ColorScheme, FontScheme y FormatScheme a null para deshabilitar cualquier sobrescritura con este objeto de tema. |
...
| --- | --- | --- |
| colorScheme | [IColorScheme](../../com.aspose.slides/icolorscheme) | Datos para inicializar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| fontScheme | [IFontScheme](../../com.aspose.slides/ifontscheme) | Datos para inicializar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| formatScheme | [IFormatScheme](../../com.aspose.slides/iformatscheme) | Datos para inicializar. |
...
Un valor verdadero indica que ColorScheme, FontScheme y FormatScheme son nulos y cualquier sobrescritura con este objeto de tema está deshabilitada. Booleano solo lectura.
...
Establece ColorScheme, FontScheme y FormatScheme a null para deshabilitar cualquier sobrescritura con este objeto de tema.
