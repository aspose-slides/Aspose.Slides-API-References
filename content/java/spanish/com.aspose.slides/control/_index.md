...
| [getActiveXControlBinary()](#getActiveXControlBinary--) | Especifica la persistencia de un control ActiveX cuando el método utilizado para persistir es PersistStream, PersistStreamInit o PersistStorage. |
| [getSlide()](#getSlide--) |  |
...
Obtiene el método utilizado para almacenar las propiedades del control ActiveX. Solo lectura [PersistenceType](../../com.aspose.slides/persistencetype).
...
>  else
>  {
>      YourMethodHere(control.getActiveXControlBinary()); //Utilice su propio método para gestionar las propiedades ActiveX almacenadas en su archivo binario
>  }
> ```
