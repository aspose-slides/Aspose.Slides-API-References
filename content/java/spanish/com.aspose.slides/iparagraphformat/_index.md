...
Esta clase contiene las propiedades de formato de párrafo. A diferencia de [IParagraphFormatEffectiveData](../../com.aspose.slides/iparagraphformateffectivedata), todas las propiedades de esta clase son escribibles.

--------------------

Esta clase se utiliza para devolver y manipular las propiedades de formato de párrafo definidas para el párrafo en particular. Esto significa que no se aplica herencia al obtener valores, por lo que en la mayoría de los casos obtendrá valores que significan "undefined".

Para obtener los valores de los parámetros de formato efectivos, incluido lo heredado, debe usar el método [getEffective](../../com.aspose.slides/iparagraphformat\#getEffective) que devuelve una instancia de [IParagraphFormatEffectiveData](../../com.aspose.slides/iparagraphformateffectivedata).
## Métodos
...
| [getAlignment()](#getAlignment--) | Devuelve o establece la alineación de texto en un párrafo sin herencia. |
| [setAlignment(int value)](#setAlignment-int-) | Devuelve o establece la alineación de texto en un párrafo sin herencia. |
...
Devuelve o establece la alineación de texto en un párrafo sin herencia. Lectura/escritura [TextAlignment](../../com.aspose.slides/textalignment).
...
Devuelve o establece la cantidad de espacio entre líneas base en un párrafo. Un valor positivo significa porcentaje, un valor negativo — tamaño en puntos. No se aplica herencia. Lectura/escritura float.
