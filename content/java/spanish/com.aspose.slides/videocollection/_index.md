...
| [addVideo(byte[] videoData)](#addVideo-byte---) | Crea y agrega un video a una presentación desde un arreglo de bytes. |
| [copyTo(System.Array array, int index)](#copyTo-com.aspose.ms.System.Array-int-) | Copia videos al arreglo especificado comenzando desde el índice especificado. |
...
**Parámetro** | **Tipo** | **Descripción**
--- | --- | ---
stream | java.io.InputStream | Flujo del que agregar el archivo de video.
...
Copia videos al arreglo especificado comenzando desde el índice especificado.

**Parámetro** | **Tipo** | **Descripción**
--- | --- | ---
array | com.aspose.ms.System.Array | Arreglo.
index | int | Índice.
