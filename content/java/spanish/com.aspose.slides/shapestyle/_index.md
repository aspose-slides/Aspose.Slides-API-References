...
description: Representa la referencia de estilo de las formas.
type: docs
url: /es/com.aspose.slides/shapestyle/
---
**Herencia:**
...
| Método | Descripción |
| --- | --- |
| [getLineColor()](#getLineColor--) | Devuelve el color del contorno de una forma. |
...
| [getEffectColor()](#getEffectColor--) | Devuelve el color del efecto de una forma. |
| [getEffectStyleIndex()](#getEffectStyleIndex--) | Devuelve o establece el índice de columna del efecto en una matriz de estilo. |
| [setEffectStyleIndex(long value)](#setEffectStyleIndex-long-) | Devuelve o establece el índice de columna del efecto en una matriz de estilo. |
...
Devuelve el color del contorno de una forma. Solo lectura [IColorFormat](../../com.aspose.slides/icolorformat).
...
Devuelve el color del efecto de una forma. Solo lectura [IColorFormat](../../com.aspose.slides/icolorformat).
