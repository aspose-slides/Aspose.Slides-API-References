...
| [getBorderLeft()](#getBorderLeft--) | Devuelve un objeto de propiedades de línea de borde izquierdo. |
| [getBorderTop()](#getBorderTop--) | Devuelve un objeto de propiedades de línea de borde superior. |
| [getBorderRight()](#getBorderRight--) | Devuelve un objeto de propiedades de línea de borde derecho. |
| [getBorderBottom()](#getBorderBottom--) | Devuelve un objeto de propiedades de línea de borde inferior. |
...
Devuelve un objeto de propiedades de línea de borde izquierdo. Solo lectura [ILineFormat](../../com.aspose.slides/ilineformat).
...
Devuelve un objeto de propiedades de línea de borde superior. Solo lectura [ILineFormat](../../com.aspose.slides/ilineformat).
...
Devuelve un objeto de propiedades de línea de borde derecho. Solo lectura [ILineFormat](../../com.aspose.slides/ilineformat).
...
Devuelve un objeto de propiedades de línea de borde inferior. Solo lectura [ILineFormat](../../com.aspose.slides/ilineformat).
