...
| [getDataSourceTypeForXValues()](#getDataSourceTypeForXValues--) | Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad XValue de los puntos de datos. |
| [setDataSourceTypeForXValues(int value)](#setDataSourceTypeForXValues-int-) | Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad XValue de los puntos de datos. |
| [getDataSourceTypeForYValues()](#getDataSourceTypeForYValues--) | Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad YValue de los puntos de datos. |
| [setDataSourceTypeForYValues(int value)](#setDataSourceTypeForYValues-int-) | Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad YValue de los puntos de datos. |
| [getDataSourceTypeForBubbleSizes()](#getDataSourceTypeForBubbleSizes--) | Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad BubbleSize de los puntos de datos. |
| [setDataSourceTypeForBubbleSizes(int value)](#setDataSourceTypeForBubbleSizes-int-) | Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad BubbleSize de los puntos de datos. |
| [getDataSourceTypeForValues()](#getDataSourceTypeForValues--) | Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad Value de los puntos de datos. |
| [setDataSourceTypeForValues(int value)](#setDataSourceTypeForValues-int-) | Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad Value de los puntos de datos. |
...
| [getOrCreateDataPointByIdx(long index)](#getOrCreateDataPointByIdx-long-) | Si la colección ya contiene un punto de datos con el índice index entonces devuelve este punto de datos. |
| [size()](#size--) | Obtiene el número de elementos realmente contenidos en la colección. |
| [copyTo(System.Array array, int arrayIndex)](#copyTo-com.aspose.ms.System.Array-int-) | Copia al arreglo especificado. |
...
Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad XValue de los puntos de datos. En otras palabras, especifica el tipo de valor de la propiedad ChartDataPoint.XValue.Data. Lectura/escritura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad YValue de los puntos de datos. En otras palabras, especifica el tipo de valor de la propiedad ChartDataPoint.YValue.Data. Lectura/escritura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad BubbleSize de los puntos de datos. En otras palabras, especifica el tipo de valor de la propiedad ChartDataPoint.BubbleSize.Data. Lectura/escritura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Especifica si la propiedad AsCell o AsLiteralString o AsLiteralDouble es actual en el objeto de la propiedad Value de los puntos de datos. En otras palabras, especifica el tipo de valor de la propiedad ChartDataPoint.Value.Data. Lectura/escritura [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Copia al arreglo especificado.

**Parámetros:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| array | com.aspose.ms.System.Array | Arreglo al que copiar. |
| arrayIndex | int | Índice desde donde comenzar a copiar. |
...
**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IChartDataPoint> - Un IGenericEnumerator que puede usarse para recorrer la colección.
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Stock (ver también el método [ChartTypeCharacterizer.isChartTypeStock(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeStock-int-)).
...
```
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Stock (consulte también el método [ChartTypeCharacterizer.isChartTypeStock(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeStock-int-)).
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Line (consulte también el método [ChartTypeCharacterizer.isChartTypeLine(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeLine-int-)).
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Scatter (consulte también el método [ChartTypeCharacterizer.isChartTypeScatter(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeScatter-int-)).

**Parámetros:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valor X del punto de datos |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valor Y del punto de datos |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| xValue | java.lang.String | Valor X del punto de datos |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valor Y del punto de datos |
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Radar (consulte también el método [ChartTypeCharacterizer.isChartTypeRadar(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeRadar-int-)).
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Column o Bar (consulte también los métodos [ChartTypeCharacterizer.isChartTypeColumn(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeColumn-int-) y [ChartTypeCharacterizer.isChartTypeBar(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeBar-int-)).
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Area (consulte también el método [ChartTypeCharacterizer.isChartTypeArea(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeArea-int-)).
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Pie (consulte también el método [ChartTypeCharacterizer.isChartTypePie(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypePie-int-)).
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Doughnut (consulte también el método [ChartTypeCharacterizer.isChartTypeDoughnut(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeDoughnut-int-)).
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Bubble (consulte también el método [ChartTypeCharacterizer.isChartTypeBubble(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeBubble-int-)).
...
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valor X del punto de datos |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valor Y del punto de datos |
| bubbleSize | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Tamaño de burbuja del punto de datos |
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Bubble (ver también el método [ChartTypeCharacterizer.isChartTypeBubble(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeBubble-int-)).
...
Crea el nuevo punto de datos y lo agrega al final de la colección. Aplicable a series cuyo chartType es uno de los subtipos Surface (ver también el método [ChartTypeCharacterizer.isChartTypeSurface(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeSurface-int-)).

**Parámetros:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Value del punto de datos |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | double | Value del punto de datos |
