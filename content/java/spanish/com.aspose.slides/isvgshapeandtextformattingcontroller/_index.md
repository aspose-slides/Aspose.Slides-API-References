...
description: Controla la generación de forma y texto SVG.
type: docs
...
| Método | Descripción |
| --- | --- |
| [formatText(ISvgTSpan svgTSpan, IPortion portion, ITextFrame textFrame)](#formatText-com.aspose.slides.ISvgTSpan-com.aspose.slides.IPortion-com.aspose.slides.ITextFrame-) | Esta función se llama antes de renderizar la porción de texto a SVG para permitir al usuario controlar el SVG resultante. |
