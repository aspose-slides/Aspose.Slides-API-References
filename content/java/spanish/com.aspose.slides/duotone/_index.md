...
| Método | Descripción |
| --- | --- |
| [getColor1()](#getColor1--) | Devuelve el formato de color de destino para píxeles oscuros. |
| [getColor2()](#getColor2--) | Devuelve el formato de color de destino para píxeles claros. |
| [getEffective()](#getEffective--) | Obtiene los datos efectivos del efecto Duotone con la herencia aplicada. |
...
Devuelve el formato de color de destino para píxeles oscuros. Sólo lectura [IColorFormat](../../com.aspose.slides/icolorformat).
...
Devuelve el formato de color de destino para píxeles claros. Sólo lectura [IColorFormat](../../com.aspose.slides/icolorformat).
...
Obtiene los datos efectivos del efecto Duotone con la herencia aplicada.
