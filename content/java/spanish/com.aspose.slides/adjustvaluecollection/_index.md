...
| [get_Item(int index)](#get-Item-int-) | Devuelve un ajuste por índice. |
...
Devuelve un valor que indica si el acceso a la colección está sincronizado (thread-safe). boolean de solo lectura.
