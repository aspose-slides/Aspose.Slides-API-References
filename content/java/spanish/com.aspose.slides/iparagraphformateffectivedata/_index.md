...
description: Objeto inmutable que contiene las propiedades de formato de párrafo efectivas.
type: docs
...
Esta interfaz se utiliza junto con la [IParagraphFormat](../../com.aspose.slides/iparagraphformat) interfaz para devolver valores de formato efectivos con herencia aplicada.
## Métodos
...
| [getEastAsianLineBreak()](#getEastAsianLineBreak--) | Determina si se utiliza la ruptura de línea oriental en un párrafo. |
| [getRightToLeft()](#getRightToLeft--) | Determina si se utiliza la escritura de derecha a izquierda en un párrafo. |
| [getLatinLineBreak()](#getLatinLineBreak--) | Determina si se utiliza la ruptura de línea latina en un párrafo. |
...
| [getIndent()](#getIndent--) | Devuelve el First Line Indent/Hanging Indent del párrafo. |
...
| [getFontAlignment()](#getFontAlignment--) | Devuelve una alineación de fuente en un párrafo. |
...
Determina si se utiliza la ruptura de línea oriental en un párrafo. Solo lectura boolean.
...
Determina si se utiliza la escritura de derecha a izquierda en un párrafo. Solo lectura boolean.
...
Determina si se utiliza la ruptura de línea latina en un párrafo. Solo lectura boolean.
...
Determina si se utiliza la puntuación colgante en un párrafo. Solo lectura boolean.
...
Devuelve el First Line Indent/Hanging Indent del párrafo. Hanging Indent puede definirse con valores negativos. Solo lectura float.
...
Devuelve una alineación de fuente en un párrafo. Solo lectura [FontAlignment](../../com.aspose.slides/fontalignment).
