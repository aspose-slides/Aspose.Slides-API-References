...
| [getSyncRoot()](#getSyncRoot--) | Devuelve un nodo raíz de sincronización. |
### getParent_Immediate() {#getParent-Immediate--}
```
...
Devuelve una celda por su posición. Solo lectura [Cell](../../com.aspose.slides/cell).

--------------------

Un objeto Cell puede ser devuelto para varios índices en caso de que la celda esté fusionada.
...
**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICell> - Un IGenericEnumerator que puede usarse para recorrer la colección.
...
**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICell> - Un java.util.Iterator para toda la colección.
### getSlide() {#getSlide--}
```
...
Devuelve un nodo raíz de sincronización. Solo lectura Object.
