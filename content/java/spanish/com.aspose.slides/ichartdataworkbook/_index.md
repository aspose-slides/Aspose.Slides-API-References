...
| Método | Descripción |
| --- | --- |
| [calculateFormulas()](#calculateFormulas--) | Calcula todas las fórmulas en el libro y actualiza los valores de las celdas correspondientes. |
...
Calcula todas las fórmulas en el libro y actualiza los valores de las celdas correspondientes.
