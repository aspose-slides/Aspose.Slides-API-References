...
| [add(double position, int align)](#add-double-int-) | Agrega una Tab a la colección. |
| [add(ITab value)](#add-com.aspose.slides.ITab-) | Agrega una Tab a la colección. |
...
Agrega una Tab a la colección.

**Parámetros:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| position | double | Posición de la Tab. |
| align | int | Alineación de la Tab. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | [ITab](../../com.aspose.slides/itab) | El objeto Tab que se agregará al final de la colección. |

**Devuelve:**
int - El índice en el que se agregó la pestaña.
### clear() {#clear--}
```
