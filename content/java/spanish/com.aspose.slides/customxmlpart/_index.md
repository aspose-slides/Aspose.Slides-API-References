...
| [getItemId()](#getItemId--) | Especifica un identificador único global (GUID) que identifica de manera única una única parte XML personalizada dentro de un documento Office Open XML. |
| [setItemId(UUID value)](#setItemId-java.util.UUID-) | Especifica un identificador único global (GUID) que identifica de manera única una única parte XML personalizada dentro de un documento Office Open XML. |
...
Especifica un identificador único global (GUID) que identifica de manera única una única parte XML personalizada dentro de un documento Office Open XML. Solo lectura java.util.UUID.
