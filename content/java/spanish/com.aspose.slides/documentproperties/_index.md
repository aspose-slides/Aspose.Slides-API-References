...
| [getCompany()](#getCompany--) | Devuelve o establece la propiedad company. |
| [setCompany(String value)](#setCompany-java.lang.String-) | Devuelve o establece la propiedad company. |
| [getManager()](#getManager--) | Devuelve o establece la propiedad manager. |
| [setManager(String value)](#setManager-java.lang.String-) | Devuelve o establece la propiedad manager. |
...
| [getApplicationTemplate()](#getApplicationTemplate--) | Devuelve o establece el template de una aplicación. |
| [setApplicationTemplate(String value)](#setApplicationTemplate-java.lang.String-) | Devuelve o establece el template de una aplicación. |
...
| [setCustomPropertyValue(String name, String value)](#setCustomPropertyValue-java.lang.String-java.lang.String-) | Establece una propiedad personalizada string con nombre. |
...
| [clearBuiltInProperties()](#clearBuiltInProperties--) | Borra y establece los valores predeterminados para todas las propiedades builtIn. |
...
| [getMultimediaClips()](#getMultimediaClips--) | Devuelve el número total de clips de sonido o video que están presentes en el documento. |
...
Devuelve o establece la propiedad company. Lectura/escritura String.
...
Devuelve o establece la propiedad manager. Lectura/escritura String.
...
Devuelve o establece el template de una aplicación. Lectura/escritura String.
...
Devuelve o establece el estado de contenido de una presentación. Lectura/escritura String.
...
Establece una propiedad personalizada boolean con nombre.
...
Elimina y establece valores predeterminados para todas las propiedades integradas.
...
Indica el modo de visualización de la miniatura del documento. Establezca este elemento en **true** para habilitar el escalado de la miniatura del documento a la pantalla. Establezca este elemento en **false** para habilitar el recorte de la miniatura del documento y mostrar solo las secciones que caben en la pantalla. Lectura/escritura boolean.
...
Devuelve el número total de clips de sonido o video que están presentes en el documento. Solo lectura int.
...
**Devuelve:**
[IDocumentProperties](../../com.aspose.slides/idocumentproperties) - Clon