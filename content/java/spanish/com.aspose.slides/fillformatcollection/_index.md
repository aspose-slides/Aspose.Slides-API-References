...
type: docs
url: /es/com.aspose.slides/fillformatcollection/
---
**Herencia:**
...
Obtiene el elemento en el índice especificado. Sólo de lectura [IFillFormat](../../com.aspose.slides/ifillformat).
...
**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IFillFormat> - Un IGenericEnumerator que puede usarse para iterar a través de la colección.
...
**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IFillFormat> - Un java.util.Iterator para toda la colección.
### size() {#size--}
```
public final int size()
```

Obtiene el número de elementos realmente contenidos en la colección. Sólo de lectura int.
...
Devuelve un valor que indica si el acceso a la colección está sincronizado (seguro para subprocesos). Sólo de lectura boolean.
...
Devuelve una raíz de sincronización. Sólo de lectura Object.
