...
| Método | Descripción |
| --- | --- |
| [getCertificate()](#getCertificate--) | Objeto certificado que se utilizó para firmar el documento. |
...
Objeto certificado que se utilizó para firmar el documento. Solo lectura byte[].
