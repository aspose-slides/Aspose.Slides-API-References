...
| [getPerspective()](#getPerspective--) | Devuelve o establece el valor de perspectiva (ángulo de campo de visión) para gráficos 3D (entre 0 y 240). |
| [setPerspective(byte value)](#setPerspective-byte-) | Devuelve o establece el valor de perspectiva (ángulo de campo de visión) para gráficos 3D (entre 0 y 240). |
...
Devuelve o establece el grado de rotación alrededor del eje X, es decir, en la dirección Y para gráficos 3D (entre –90 y 90 grados). La propiedad coincide con el elemento 21.2.2.157 rotX (X Rotation) de ECMA-376 y con la opción "Y Rotation" en PowerPoint 2007+. Lectura/escritura byte.
...
Devuelve o establece el grado de rotación alrededor del eje Y, es decir, en la dirección X para gráficos 3D (entre 0 y 360 grados). La propiedad coincide con el elemento 21.2.2.158 rotY (Y Rotation) de ECMA-376 y con la opción "X Rotation" en PowerPoint 2007+. Lectura/escritura int.
...
Devuelve o establece el valor de perspectiva (ángulo de campo de visión) para gráficos 3D (entre 0 y 240). Se ignora si el valor de la propiedad RightAngleAxes es verdadero. Lectura/escritura byte.
...
Determina si los ejes del gráfico forman ángulos rectos, en lugar de dibujarse en perspectiva. En otras palabras, determina si los ángulos de los ejes del gráfico son independientes de la rotación o elevación del gráfico. Lectura/escritura boolean.
