...
| [getEffective()](#getEffective--) | Obtiene los datos del efecto Outer Shadow efectivo con la herencia aplicada. |
...
Dirección de la sombra, en grados. Valor predeterminado - 0 � (de izquierda a derecha). Lectura/escritura float.
...
Factor de escala horizontal, en porcentaje del tamaño original. Un escalado negativo provoca una inversión. Valor predeterminado - 100 %. Lectura/escritura double.
...
Factor de escala vertical, en porcentaje del tamaño original. Un escalado negativo provoca una inversión. Valor predeterminado - 100 %. Lectura/escritura double.
...
Obtiene los datos del efecto Outer Shadow efectivo con la herencia aplicada.
