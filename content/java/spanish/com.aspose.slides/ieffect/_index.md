...
| [getTextAnimation()](#getTextAnimation--) | Devuelve la animación de texto. |
...
| [getBehaviors()](#getBehaviors--) | Devuelve la colección de comportamiento para el efecto. |
| [setBehaviors(IBehaviorCollection value)](#setBehaviors-com.aspose.slides.IBehaviorCollection-) | Devuelve la colección de comportamiento para el efecto. |
| [getTiming()](#getTiming--) | Define el valor de tiempo para el efecto. |
| [setTiming(ITiming value)](#setTiming-com.aspose.slides.ITiming-) | Define el valor de tiempo para el efecto. |
| [getTargetShape()](#getTargetShape--) | Devuelve la forma objetivo para el efecto. |
| [getSound()](#getSound--) | Define el sonido incrustado para el efecto. |
| [setSound(IAudio value)](#setSound-com.aspose.slides.IAudio-) | Define el sonido incrustado para el efecto. |
...
| [getAfterAnimationType()](#getAfterAnimationType--) | Define un tipo de animación posterior para el efecto. |
| [setAfterAnimationType(int value)](#setAfterAnimationType-int-) | Define un tipo de animación posterior para el efecto. |
| [getAfterAnimationColor()](#getAfterAnimationColor--) | Define un color de animación posterior para el efecto. |
| [setAfterAnimationColor(IColorFormat value)](#setAfterAnimationColor-com.aspose.slides.IColorFormat-) | Define un color de animación posterior para el efecto. |
...
| [getDelayBetweenTextParts()](#getDelayBetweenTextParts--) | Define un retraso entre partes de texto animado (palabras o letras). |
| [setDelayBetweenTextParts(float value)](#setDelayBetweenTextParts-float-) | Define un retraso entre partes de texto animado (palabras o letras). |
...
Devuelve la animación de texto. Solo lectura [ITextAnimation](../../com.aspose.slides/itextanimation).
...
Devuelve la colección de comportamiento para el efecto. Lectura/escritura [IBehaviorCollection](../../com.aspose.slides/ibehaviorcollection).
...
Define el valor de tiempo para el efecto. Lectura/escritura [ITiming](../../com.aspose.slides/itiming).
...
Devuelve la forma objetivo para el efecto. Solo lectura [IShape](../../com.aspose.slides/ishape).
...
Define el sonido incrustado para el efecto. Lectura/escritura [IAudio](../../com.aspose.slides/iaudio).
...
Define un tipo de animación posterior para el efecto. Lectura/escritura AfterAnimationType (\#getAfterAnimationType.getAfterAnimationType/\#setAfterAnimationType(int).setAfterAnimationType(int)).
...
Define un color de animación posterior para el efecto. Lectura/escritura [IColorFormat](../../com.aspose.slides/icolorformat).
...
> 
>      // Establece el color de animación posterior del efecto.
...
Define un retraso entre partes de texto animado (palabras o letras). Un valor positivo especifica el porcentaje de la duración del efecto. Un valor negativo especifica el retraso en segundos. Lectura/escritura float .
...
> 
>      // Establece el retraso entre partes de texto animado al 20% de la duración del efecto.
