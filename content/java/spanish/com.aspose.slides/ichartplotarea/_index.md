...
| [getLayoutTargetType()](#getLayoutTargetType--) | Si la disposición del área de trazado se define manualmente, esta propiedad especifica si disponer el área de trazado por su interior (sin incluir ejes y etiquetas de ejes) o por su exterior (incluyendo ejes y etiquetas de ejes). |
| [setLayoutTargetType(int value)](#setLayoutTargetType-int-) | Si la disposición del área de trazado se define manualmente, esta propiedad especifica si disponer el área de trazado por su interior (sin incluir ejes y etiquetas de ejes) o por su exterior (incluyendo ejes y etiquetas de ejes). |
