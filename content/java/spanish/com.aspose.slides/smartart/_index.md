...
type: docs
url: /es/com.aspose.slides/smartart/
---
**Herencia:**
...
| [isReversed()](#isReversed--) | Devuelve o establece el estado del diagrama SmartArt respecto a (izquierda-a-derecha) LTR o (derecha-a-izquierda) RTL, si el diagrama admite inversión. |
| [setReversed(boolean value)](#setReversed-boolean-) | Devuelve o establece el estado del diagrama SmartArt respecto a (izquierda-a-derecha) LTR o (derecha-a-izquierda) RTL, si el diagrama admite inversión. |
...
Devuelve o establece el estado del diagrama SmartArt respecto a (izquierda-a-derecha) LTR o (derecha-a-izquierda) RTL, si el diagrama admite inversión. Lectura/escritura boolean .
