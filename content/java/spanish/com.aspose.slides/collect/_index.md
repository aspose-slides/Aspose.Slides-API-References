...
>      for (IShape shape : Collect.shapes(pres))
>      {
>          // si la forma es AutoShape, añadir un borde sólido negro
...
| --- | --- | --- |
| pres | [Presentation](../../com.aspose.slides/presentation) | Presentación para recopilar formas |

**Devuelve:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.slides.Shape> - Colección de todas las formas que contiene la presentación