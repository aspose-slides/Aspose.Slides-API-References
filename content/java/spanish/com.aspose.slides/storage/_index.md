...
| --- | --- | --- |
| key | java.lang.String | Clave para el valor. |
| value | TValue | Valor. |
...
**Devuelve:**
TValue - Valor de datos si está presente en la colección de datos, null en caso contrario.
...
**Devuelve:**
boolean - True si el almacenamiento contiene un elemento con la clave especificada, false en caso contrario.