...
| [getNoAction()](#getNoAction--) | Devuelve un hipervínculo especial "do nothing". |
| [getMedia()](#getMedia--) | Devuelve un hipervínculo especial "play mediafile". |
...
| [getEndShow()](#getEndShow--) | Devuelve un hipervínculo que finaliza la presentación. |
...
| [getExternalUrlOriginal()](#getExternalUrlOriginal--) | Representa un hipervínculo establecido para esta porción sin tener en cuenta el contenido real de la porción. |
| [getTargetFrame()](#getTargetFrame--) | Devuelve el marco dentro del conjunto de marcos HTML principal para el destino del hipervínculo padre cuando existe. |
| [setTargetFrame(String value)](#setTargetFrame-java.lang.String-) | Devuelve el marco dentro del conjunto de marcos HTML principal para el destino del hipervínculo padre cuando existe. |
| [getTooltip()](#getTooltip--) | Devuelve la cadena que puede mostrarse en una interfaz de usuario como asociada al hipervínculo padre. |
| [setTooltip(String value)](#setTooltip-java.lang.String-) | Devuelve la cadena que puede mostrarse en una interfaz de usuario como asociada al hipervínculo padre. |
| [getHistory()](#getHistory--) | Determina si el objetivo del hipervínculo padre debe añadirse a una lista de hipervínculos vistos cuando es invocado. |
| [setHistory(boolean value)](#setHistory-boolean-) | Determina si el objetivo del hipervínculo padre debe añadirse a una lista de hipervínculos vistos cuando es invocado. |
...
| [getColorSource()](#getColorSource--) | Representa la fuente del color del hipervínculo: ya sea estilos o formato de porción. |
| [setColorSource(int value)](#setColorSource-int-) | Representa la fuente del color del hipervínculo: ya sea estilos o formato de porción. |
| [equals(Object obj)](#equals-java.lang.Object-) | Determina si dos instancias de Hyperlink son iguales. |
| [equals(IHyperlink hlink)](#equals-com.aspose.slides.IHyperlink-) | Determina si dos instancias de Hyperlink son iguales. |
...
| [hashCode()](#hashCode--) | Funciona como una función hash para un tipo particular, adecuada para usar en algoritmos de hashing y estructuras de datos como una tabla hash. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| source | [Hyperlink](../../com.aspose.slides/hyperlink) | Hipervínculo origen |
| targetFrame | java.lang.String | Marco objetivo |
| tooltip | java.lang.String | Texto de información sobre herramienta |
| history | boolean | Determina si el objetivo del hipervínculo padre debe añadirse a una lista de hipervínculos vistos cuando es invocado. |
...
Devuelve un hipervínculo especial "do nothing". Solo lectura [Hyperlink](../../com.aspose.slides/hyperlink).
...
Devuelve un hipervínculo especial "play mediafile". Utilizado en AudioFrame y VideoFrame. Solo lectura [Hyperlink](../../com.aspose.slides/hyperlink).
...
Devuelve un hipervínculo que finaliza la presentación. Solo lectura [Hyperlink](../../com.aspose.slides/hyperlink).
...
Representa un hipervínculo establecido para esta porción sin tener en cuenta el contenido real de la porción.

--------------------

PowerPoint se comporta de forma específica para los enlaces y el texto correspondiente en una porción. Permite crear texto para el hipervínculo en forma de una URL válida, diferente de la dirección real del enlace. En este caso, cuando se visualiza el enlace en la ventana de edición, se modificará para que coincida con la porción de texto. Esta propiedad representa el valor original del hipervínculo.
...
Devuelve el marco dentro del conjunto de marcos HTML principal para el destino del hipervínculo padre cuando existe. Lectura/escritura String.
...
Devuelve la cadena que puede mostrarse en una interfaz de usuario como asociada al hipervínculo padre. Lectura/escritura String.
...
Determina si el objetivo del hipervínculo padre debe añadirse a una lista de hipervínculos vistos cuando es invocado. Lectura/escritura boolean.
...
Representa la fuente del color del hipervínculo: ya sea estilos o formato de porción. Lectura/escritura [HyperlinkColorSource](../../com.aspose.slides/hyperlinkcolorsource).
...
Determina si dos instancias de Hyperlink son iguales.

**Parámetros:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| obj | java.lang.Object | El Hyperlink a comparar con el Hyperlink actual. |
...
Funciona como una función hash para un tipo particular, adecuada para usar en algoritmos de hashing y estructuras de datos como una tabla hash.
