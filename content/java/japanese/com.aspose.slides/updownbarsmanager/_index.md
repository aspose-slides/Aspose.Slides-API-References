...
type: docs
url: /ja/com.aspose.slides/updownbarsmanager/
---
**継承:**  
...
Line-またはStock-チャートの上/下バーへのアクセスを提供します。

## メソッド

| メソッド | 説明 |
| --- | --- |
| [getUpBarsFormat()](#getUpBarsFormat--) | UpBars の形式を返します。 |
| [getDownBarsFormat()](#getDownBarsFormat--) | DownBars の形式を返します。 |
...
UpBars の形式を返します。 読み取り専用 [IFormat](../../com.aspose.slides/iformat)。
...
DownBars の形式を返します。 読み取り専用 [IFormat](../../com.aspose.slides/iformat)。
