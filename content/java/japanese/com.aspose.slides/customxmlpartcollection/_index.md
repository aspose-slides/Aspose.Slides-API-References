...
| [copyTo(System.Array array, int index)](#copyTo-com.aspose.ms.System.Array-int-) | 指定された配列へコピーします。 |
...
**戻り値:**
boolean - アイテムが正常に削除された場合は true、それ以外の場合は false。
...
**戻り値:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICustomXmlPart> - コレクションを反復処理するために使用できる IGenericEnumerator。
