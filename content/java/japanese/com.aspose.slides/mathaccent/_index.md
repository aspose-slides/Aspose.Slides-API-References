...
description: ベースと結合ダイアクリティカルマークからなるアクセント機能を指定します 例: ud835udc4eu0301
type: docs
...
ベースと結合ダイアクリティカルマークからなるアクセント機能を指定します 例: \\ud835\\udc4e\\u0301
...
| コンストラクタ | 説明 |
| --- | --- |
| [MathAccent(IMathElement element)](#MathAccent-com.aspose.slides.IMathElement-) | 指定された数式要素にデフォルトのアクセント文字の値を適用する数式アクセントを作成します |
| [MathAccent(IMathElement element, char accentCharacter)](#MathAccent-com.aspose.slides.IMathElement-char-) | 指定された数式要素にアクセントを適用する数式アクセントを作成します |
## メソッド

| メソッド | 説明 |
| --- | --- |
| [getBase()](#getBase--) | アクセントが適用された引数 |
| [getCharacter()](#getCharacter--) | アクセント文字 値は (U+0300\\u2013U+036F) または (U+20D0\\u2013U+20EF) の範囲内である必要があります デフォルト値: 結合サーカムフレックスアクセント (U+0302) |
| [setCharacter(char value)](#setCharacter-char-) | アクセント文字 値は (U+0300\\u2013U+036F) または (U+20D0\\u2013U+20EF) の範囲内である必要があります デフォルト値: 結合サーカムフレックスアクセント (U+0302) |
...
指定された数式要素にデフォルトのアクセント文字の値を適用する数式アクセントを作成します
...
指定された数式要素にアクセントを適用する数式アクセントを作成します
