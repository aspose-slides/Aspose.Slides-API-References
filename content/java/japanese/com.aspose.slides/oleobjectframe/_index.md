...
| [getLinkFileName()](#getLinkFileName--) | リンクされたファイルへの完全パスを返します。 |
| [getLinkPathLong()](#getLinkPathLong--) | リンクされたファイルへの完全パスを返します。 |
| [setLinkPathLong(String value)](#setLinkPathLong-java.lang.String-) | リンクされたファイルへの完全パスを返します。 |
...
| [getUpdateAutomatic()](#getUpdateAutomatic--) | プレゼンテーションが開かれたり印刷されたりしたときに、リンクされた埋め込みオブジェクトが自動的に更新されるかどうかを判定します。 |
| [setUpdateAutomatic(boolean value)](#setUpdateAutomatic-boolean-) | プレゼンテーションが開かれたり印刷されたりしたときに、リンクされた埋め込みオブジェクトが自動的に更新されるかどうかを判定します。 |
...
リンクされたファイルへの完全パスを返します。短いファイル名が使用されます。読み取り専用 String。
...
リンクされたファイルへの完全パスを返します。長いファイル名が使用されます。読み書き String。
...
Ppt プレゼンテーションでは、いくつかの Ole オブジェクトリンクが相対表現を持つことがあります。
...
OLE 埋め込みデータに関する情報を取得または設定します。読み書き [IOleEmbeddedDataInfo](../../com.aspose.slides/ioleembeddeddatainfo)。
...
プレゼンテーションが開かれたり印刷されたりしたときに、リンクされた埋め込みオブジェクトが自動的に更新されるかどうかを判定します。読み書き  boolean 。
