...
| メソッド | 説明 |
| --- | --- |
| [size()](#size--) | コレクションに実際に含まれる行の数を取得します。 |
...
コレクションに実際に含まれる行の数を取得します。 読み取り専用 int。
...
| withAttachedRows | boolean | テンプレート行に添付されたすべての行もコピーする場合は true にします。 |
...
| withAttachedRows | boolean | 添付されたすべての行も削除する場合は true にします。 |
...
**戻り値:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IRow> - コレクションを反復処理できる IGenericEnumerator。
