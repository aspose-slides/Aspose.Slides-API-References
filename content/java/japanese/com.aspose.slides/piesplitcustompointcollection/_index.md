...
description: カスタム スプリットを使用したバー オブ パイまたはパイ オブ パイ チャートの分割ポイント用のポイント コレクションを表します。
type: docs
...
カスタム スプリットを使用したバー オブ パイ または パイ オブ パイ チャートの分割ポイントのためのポイント コレクションを表します。
## メソッド
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| dataPoint | [IChartDataPoint](../../com.aspose.slides/ichartdatapoint) | 追加されるデータポイント。 |
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| dataPoint | [IChartDataPoint](../../com.aspose.slides/ichartdatapoint) | 削除されるデータポイント。 |

**戻り値:**
boolean - 項目が正常に削除された場合は true、それ以外の場合は false。このメソッドは、項目が System.Collections.Generic.List\{T\} に見つからなかった場合も false を返します。
...
**戻り値:**
boolean - [IGenericCollection](../../com.aspose.slides/igenericcollection) に項目が見つかった場合は true、それ以外の場合は false。
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| array | [IChartDataPoint\[\]](../../com.aspose.slides/ichartdatapoint) | [IGenericCollection](../../com.aspose.slides/igenericcollection) からコピーされた要素の宛先となる一次元配列。配列はゼロベースインデックスである必要があります。 |
