...
description: 基線上のテキストと、その直上または直下にある縮小サイズのテキストから構成される Limit オブジェクトを指定します。
type: docs
...
基線上のテキストと、その直上または直下にある縮小サイズのテキストから構成される Limit オブジェクトを指定します。
...
| [MathLimit(IMathElement baseArg, IMathElement limit)](#MathLimit-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-) | 下限付きで MathLimit クラスの新しいインスタンスを初期化します。 |
## メソッド

| メソッド | 説明 |
| --- | --- |
| [getBase()](#getBase--) | 基本引数 |
| [getLimit()](#getLimit--) | 上限引数 |
