...
description: pptx プレゼンテーション ドキュメントに保存できる文字列または double 値を、2 つの方法で表します: 1) チャートに関連付けられたブックのセル/セル群に、2) リテラル値として。
type: docs
...
pptx プレゼンテーション ドキュメントに保存できる文字列または double 値を表します。2 つの方法で保存できます: 1) チャートに関連付けられたブックのセル/セル群に; 2) リテラル値として。
...
DataSourceType プロパティが DataSourceType.StringLiterals の場合、リテラル文字列を取得または設定します。読み書き可能 String。
...
DataSourceType プロパティが DataSourceType.DoubleLiterals の場合、リテラル double を取得または設定します。読み書き可能 double。
