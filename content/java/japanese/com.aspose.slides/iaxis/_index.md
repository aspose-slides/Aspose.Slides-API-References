...
description: チャート軸を表すオブジェクトをカプセル化します。
type: docs
...
| [getMinorUnit()](#getMinorUnit--) | 日付軸または値軸の小単位を表します。 |
| [setMinorUnit(double value)](#setMinorUnit-double-) | 日付軸または値軸の小単位を表します。 |
| [isAutomaticMinorUnit()](#isAutomaticMinorUnit--) | 軸の小単位が自動的に割り当てられるかどうかを示します。 |
| [setAutomaticMinorUnit(boolean value)](#setAutomaticMinorUnit-boolean-) | 軸の小単位が自動的に割り当てられるかどうかを示します。 |
...
| [getMajorTickMark()](#getMajorTickMark--) | 指定された軸の主目盛りのタイプを表します。 |
| [setMajorTickMark(int value)](#setMajorTickMark-int-) | 指定された軸の主目盛りのタイプを表します。 |
...
| [getMinorGridLinesFormat()](#getMinorGridLinesFormat--) | チャート軸上の副グリッドラインの書式を表します。 |
| [getMajorGridLinesFormat()](#getMajorGridLinesFormat--) | チャート軸上の主グリッドラインの書式を表します。 |
| [getShowMinorGridLines()](#getShowMinorGridLines--) | 副グリッドラインが表示されているかどうかを表します。 |
| [getShowMajorGridLines()](#getShowMajorGridLines--) | 主グリッドラインが表示されているかどうかを表します。 |
...
| [hasTitle()](#hasTitle--) | 軸に表示可能なタイトルがあるかどうかを判断します。 |
| [setTitle(boolean value)](#setTitle-boolean-) | 軸に表示可能なタイトルがあるかどうかを判断します。 |
...
| [getTickLabelRotationAngle()](#getTickLabelRotationAngle--) | 目盛りラベルの回転角度を表します。読み取り/書き込み float。 |
| [setTickLabelRotationAngle(float value)](#setTickLabelRotationAngle-float-) | 目盛りラベルの回転角度を表します。読み取り/書き込み float。 |
| [getTickLabelSpacing()](#getTickLabelSpacing--) | 描画されるラベル間でスキップする目盛りラベルの数を指定します。 |
| [setTickLabelSpacing(long value)](#setTickLabelSpacing-long-) | 描画されるラベル間でスキップする目盛りラベルの数を指定します。 |
| [isAutomaticTickLabelSpacing()](#isAutomaticTickLabelSpacing--) | 自動目盛りラベル間隔の値を指定します。 |
| [setAutomaticTickLabelSpacing(boolean value)](#setAutomaticTickLabelSpacing-boolean-) | 自動目盛りラベル間隔の値を指定します。 |
...
| [isAutomaticTickMarksSpacing()](#isAutomaticTickMarksSpacing--) | 自動目盛り間隔の値を指定します。 |
| [setAutomaticTickMarksSpacing(boolean value)](#setAutomaticTickMarksSpacing-boolean-) | 自動目盛り間隔の値を指定します。 |
...
| [getAggregationType()](#getAggregationType--) | カテゴリ軸の集計タイプ（ビニング）を表します。 |
| [setAggregationType(int value)](#setAggregationType-int-) | カテゴリ軸の集計タイプ（ビニング）を表します。 |
| [getBinWidth()](#getBinWidth--) | AggregationType プロパティの値が AxisAggregationType.ByBinWidth に設定された場合のビン幅を指定します。 |
| [setBinWidth(double value)](#setBinWidth-double-) | AggregationType プロパティの値が AxisAggregationType.ByBinWidth に設定された場合のビン幅を指定します。 |
| [getNumberOfBins()](#getNumberOfBins--) | AggregationType プロパティの値が AxisAggregationType.ByNumberOfBins に設定された場合のビン数を指定します。 |
| [setNumberOfBins(long value)](#setNumberOfBins-long-) | AggregationType プロパティの値が AxisAggregationType.ByNumberOfBins に設定された場合のビン数を指定します。 |
...
値軸がカテゴリ軸をカテゴリ間で交差するかを表します。このプロパティはカテゴリ軸にのみ適用され、3-D チャートには適用されません。読み取り/書き込み boolean。
...
軸上の実際の最大値を指定します。実際の値を取得するには、事前に IChart.ValidateChartLayout() メソッドを呼び出します。
...
軸上の実際の最小値を指定します。実際の値を取得するには、事前に IChart.ValidateChartLayout() メソッドを呼び出します。
...
軸の実際の主単位を指定します。実際の値を取得するには、事前に IChart.ValidateChartLayout() メソッドを呼び出します。
...
軸の実際の副単位を指定します。実際の値を取得するには、事前に IChart.ValidateChartLayout() メソッドを呼び出します。
...
軸の実際の主単位スケールを指定します。実際の値を取得するには、事前に IChart.ValidateChartLayout() メソッドを呼び出します。
...
軸の実際の副単位スケールを指定します。実際の値を取得するには、事前に IChart.ValidateChartLayout() メソッドを呼び出します。
...
日付軸または値軸の小単位を表します。読み取り/書き込み double。
...
軸の小単位が自動的に割り当てられるかどうかを示します。読み取り/書き込み boolean。
...
対数の基数を表します。デフォルト値は 10 です。読み取り/書き込み double.
...
MS PowerPoint がデータ ポイントを最後から最初へプロットするかどうかを表します。読み取り/書き込み boolean.
...
指定された軸の目盛りラベルの位置を表します。読み取り/書き込み [TickLabelPositionType](../../com.aspose.slides/ticklabelpositiontype).
...
日付軸上で表される最小の時間単位を指定します。読み取り/書き込み [TimeUnitType](../../com.aspose.slides/timeunittype).
...
チャート軸上の副グリッド線の書式を表します。読み取り専用 [IChartLinesFormat](../../com.aspose.slides/ichartlinesformat).
...
チャート軸上の主グリッド線の書式を表します。読み取り専用 [IChartLinesFormat](../../com.aspose.slides/ichartlinesformat).
...
副グリッド線が表示されているかどうかを表します。読み取り専用 boolean.
...
主グリッド線が表示されているかどうかを表します。読み取り専用 boolean.
...
他軸が交差する位置における指定軸の CrossType を表します。読み取り/書き込み [CrossesType](../../com.aspose.slides/crossestype).
...
書式がソース データにリンクされているかどうかを示します。読み取り/書き込み boolean.
...
目盛りラベルの回転角度を表します。読み取り/書き込み float.
...
描画されるラベル間でスキップする目盛りラベルの数を指定します。読み取り/書き込み long.
...
自動目盛りラベル間隔の値を指定します。false の場合は TickLabelSpacing プロパティを使用します。読み取り/書き込み boolean.
...
カテゴリ軸または日付軸に適用され、ラベルと軸の距離を指定します。値は 0% から 1000% の間である必要があります。読み取り/書き込み int.
...
IAxis.CategoryAxisType プロパティを、軸データに基づき自動的に決定される値で設定します。
...
カテゴリ軸（ビニング）の集計タイプを表します。カテゴリに適用され、Histogram または HistogramPareto 系列でのみ使用されます。
...
オーバーフロービンが適用されるかどうかを指定します。オーバーフロービンの値を調整するには IsAutomaticOverflowBin と OverflowBin を使用します。
...
アンダーフロービンが適用されるかどうかを指定します。アンダーフロービンの値を調整するには IsAutomaticUnderflowBin と UnderflowBin を使用します。
