...
description: アニメーション 動作のコマンド効果を表します。
type: docs
...
| [getShapeTarget()](#getShapeTarget--) | コマンド効果のシェイプ対象を定義します。 |
| [setShapeTarget(IShape value)](#setShapeTarget-com.aspose.slides.IShape-) | コマンド効果のシェイプ対象を定義します。 |
### getType() {#getType--}
```
...
コマンド効果のシェイプ対象を定義します。読み取り/書き込み [IShape](../../com.aspose.slides/ishape)。
