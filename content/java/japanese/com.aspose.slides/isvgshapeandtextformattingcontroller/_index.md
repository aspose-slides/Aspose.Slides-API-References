...
| メソッド | 説明 |
| --- | --- |
| [formatText(ISvgTSpan svgTSpan, IPortion portion, ITextFrame textFrame)](#formatText-com.aspose.slides.ISvgTSpan-com.aspose.slides.IPortion-com.aspose.slides.ITextFrame-) | この関数は、テキスト部分を SVG にレンダリングする前に呼び出され、ユーザーが生成される SVG を制御できるようにします。 |
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| svgTSpan | [ISvgTSpan](../../com.aspose.slides/isvgtspan) | SVG tspan の生成を制御するオブジェクト。 |
| portion | [IPortion](../../com.aspose.slides/iportion) | 元の部分。 |
| textFrame | [ITextFrame](../../com.aspose.slides/itextframe) | 元の部分のテキストフレーム。 |