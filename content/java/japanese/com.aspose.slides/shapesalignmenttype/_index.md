...
description: スライド上の選択されたシェイプの配置を変更する方法を定義します。
type: docs
url: /ja/com.aspose.slides/shapesalignmenttype/
---
**継承:**
...
選択したシェイプのスライド上の配置を変更する方法を定義します。
## フィールド
...
| [AlignCenter](#AlignCenter) | 中央揃え |
| [AlignTop](#AlignTop) | 上揃え |
| [AlignMiddle](#AlignMiddle) | 中央揃え |
| [AlignBottom](#AlignBottom) | 下揃え |
| [DistributeHorizontally](#DistributeHorizontally) | 水平に等間隔配置 |
| [DistributeVertically](#DistributeVertically) | 垂直に等間隔配置 |
### AlignLeft {#AlignLeft}
```
