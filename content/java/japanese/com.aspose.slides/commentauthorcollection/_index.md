...
| Method | Description |
| --- | --- |
| [size()](#size--) | コレクションに実際に格納されている要素数を取得します。 |
...
| [removeAt(int index)](#removeAt-int-) | コレクションの指定インデックスにある作成者を削除します。 |
| [remove(ICommentAuthor author)](#remove-com.aspose.slides.ICommentAuthor-) | コレクション内で指定された作成者の最初の出現を削除します。 |
...
コレクションに実際に格納されている要素数を取得します。 読み取り専用 int.
...
**戻り値:**
com.aspose.slides.ICommentAuthor[] - Author または null.
...
**戻り値:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICommentAuthor> - コレクションを反復処理できる IGenericEnumerator。
