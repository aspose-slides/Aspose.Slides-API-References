...
| メソッド | 説明 |
| --- | --- |
| [getCount()](#getCount--) | コレクション内のプロパティの数を返します。 |
...
| [getNamesOfProperties()](#getNamesOfProperties--) | コレクション内のプロパティの数を返します。 |
...
コレクション内のプロパティの数を返します。読み取り専用 int。
...
| value | java.lang.String | プロパティの alue。 |
...
コレクション内のプロパティの数を返します。読み取り専用 [IGenericCollection](../../com.aspose.slides/igenericcollection)。
