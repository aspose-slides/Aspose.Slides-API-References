...
| [compareTo(Object obj)](#compareTo-java.lang.Object-) | 同じ型の別のオブジェクトと現在のインスタンスを比較します。 |
...
タブの位置を取得または設定します。このプロパティを割り当てると、コレクション内のタブのインデックスが変更され、Enumerator が無効になる可能性があります。読み取り/書き込み可能な double。
...
タブの配置スタイルを取得または設定します。読み取り/書き込み可能な [TabAlignment](../../com.aspose.slides/tabalignment)。
...
**戻り値:**
int - 比較対象の相対的な順序を示す 32 ビット整数です。戻り値の意味は以下のとおりです： 
