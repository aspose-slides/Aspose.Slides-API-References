...
| メソッド | 説明 |
| --- | --- |
| [getFontSubstRuleList()](#getFontSubstRuleList--) | レンダリング時に使用するフォント置換（Read/write [IFontSubstRuleCollection](../../com.aspose.slides/ifontsubstrulecollection)）。 |
| [setFontSubstRuleList(IFontSubstRuleCollection value)](#setFontSubstRuleList-com.aspose.slides.IFontSubstRuleCollection-) | レンダリング時に使用するフォント置換（Read/write [IFontSubstRuleCollection](../../com.aspose.slides/ifontsubstrulecollection)）。 |
| [getFontFallBackRulesCollection()](#getFontFallBackRulesCollection--) | フォントのコレクションを管理し、適切な置換を行うための FontFallBack ルールのユーザーコレクションを表します（Read/write [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection)）。 |
| [setFontFallBackRulesCollection(IFontFallBackRulesCollection value)](#setFontFallBackRulesCollection-com.aspose.slides.IFontFallBackRulesCollection-) | フォントのコレクションを管理し、適切な置換を行うための FontFallBack ルールのユーザーコレクションを表します（Read/write [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection)）。 |
...
| [replaceFont(IFontSubstRule substRule)](#replaceFont-com.aspose.slides.IFontSubstRule-) | [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) が提供する情報を使用してプレゼンテーション内のフォントを置換します |
| [replaceFont(IFontSubstRuleCollection substRules)](#replaceFont-com.aspose.slides.IFontSubstRuleCollection-) | [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) のコレクションが提供する情報を使用してプレゼンテーション内のフォントを置換します |
| [getFontBytes(IFontData fontData, int fontStyle)](#getFontBytes-com.aspose.slides.IFontData-int-) | 指定されたフォントスタイルとフォントデータに対応するフォントデータのバイト配列を取得します。 |
...
レンダリング時に使用するフォント置換（Read/write [IFontSubstRuleCollection](../../com.aspose.slides/ifontsubstrulecollection)）。
...
フォントのコレクションを管理し、適切な置換を行うための FontFallBack ルールのユーザーコレクションを表します（Read/write [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection)）。
...
**戻り値:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.slides.FontSubstitutionInfo> - すべてのフォント置換 [FontSubstitutionInfo](../../com.aspose.slides/fontsubstitutioninfo) のコレクション。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| fontData | [IFontData](../../com.aspose.slides/ifontdata) | フォント データ オブジェクト [IFontData](../../com.aspose.slides/ifontdata) |
...
| --- | --- | --- |
| fontData | [IFontData](../../com.aspose.slides/ifontdata) | フォント データ オブジェクト [IFontData](../../com.aspose.slides/ifontdata) |
| embedFontRule | int | 埋め込みフォント ルール [EmbedFontCharacters](../../com.aspose.slides/embedfontcharacters)

--------------------

フォントをコピーする際は、ほとんどのフォントが著作権で保護されていることに留意してください。事前にフォントのライセンスを確認し、別のマシンへ自由に転送できるかどうかを確認してください。 |
...
フォントを追加する際は、ほとんどのフォントが著作権で保護されていることに留意してください。事前にフォントのライセンスを確認し、別のマシンへ自由に転送できるかどうかを確認してください。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| sourceFont | [IFontData](../../com.aspose.slides/ifontdata) | ソース フォント |
...
[IFontSubstRule](../../com.aspose.slides/ifontsubstrule) が提供する情報を使用してプレゼンテーション内のフォントを置換します
...
[IFontSubstRule](../../com.aspose.slides/ifontsubstrule) のコレクションが提供する情報を使用してプレゼンテーション内のフォントを置換します
...
指定されたフォントスタイルとフォントデータに対応するフォントデータのバイト配列を取得します。
...
>      // プレゼンテーション内の最初のフォントの標準スタイルを表すバイト配列を取得します
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| fontData | [IFontData](../../com.aspose.slides/ifontdata) | フォントデータオブジェクト（[IFontData](../../com.aspose.slides/ifontdata) に関する情報を含む）。 |
...
>      // プレゼンテーション内の最初のフォントの標準スタイルを表すバイト配列を取得
