...
description: アニメーションのジェネレータを表します。
type: docs
...
[Presentation](../../com.aspose.slides/presentation) のアニメーションのジェネレータを表します。
...
| [PresentationAnimationsGenerator(Dimension frameSize)](#PresentationAnimationsGenerator-java.awt.Dimension-) | [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) の新しいインスタンスを作成します。 |
| [PresentationAnimationsGenerator(Dimension2D frameSize)](#PresentationAnimationsGenerator-java.awt.geom.Dimension2D-) | [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) の新しいインスタンスを作成します。 |
## メソッド
...
| [getDefaultDelay()](#getDefaultDelay--) | 既定の遅延時間[ms]を取得または設定します。 |
| [setDefaultDelay(int value)](#setDefaultDelay-int-) | 既定の遅延時間[ms]を取得または設定します。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| presentation | [Presentation](../../com.aspose.slides/presentation) | [Presentation.getSlideSize](../../com.aspose.slides/presentation\#getSlideSize) に従ってフレームサイズが設定されます。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| frameSize | java.awt.Dimension | フレームサイズです。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| frameSize | java.awt.geom.Dimension2D | フレームサイズです。 |
