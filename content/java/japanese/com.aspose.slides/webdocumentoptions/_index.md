...
description: 保存のためのオプションセットを表します。
type: docs
url: /ja/com.aspose.slides/webdocumentoptions/
---
**継承:**  
java.lang.Object  
```
...
[WebDocument](../../com.aspose.slides/webdocument) の保存用オプションセットを表します。
...
| メソッド | 説明 |
| --- | --- |
| [getTemplateEngine()](#getTemplateEngine--) | テンプレートエンジンを取得または設定します。 |
| [setTemplateEngine(ITemplateEngine value)](#setTemplateEngine-com.aspose.slides.ITemplateEngine-) | テンプレートエンジンを取得または設定します。 |
| [getOutputSaver()](#getOutputSaver--) | 出力セーバーを取得または設定します。 |
| [setOutputSaver(IOutputSaver value)](#setOutputSaver-com.aspose.slides.IOutputSaver-) | 出力セーバーを取得または設定します。 |
...
| [getAnimateTransitions()](#getAnimateTransitions--) | トランジションアニメーションオプションを取得または設定します。 |
| [setAnimateTransitions(boolean value)](#setAnimateTransitions-boolean-) | トランジションアニメーションオプションを取得または設定します。 |
...
テンプレートエンジンを取得または設定します。 読み取り/書き込み [ITemplateEngine](../../com.aspose.slides/itemplateengine)。
...
出力セーバーを取得または設定します。 読み取り/書き込み [IOutputSaver](../../com.aspose.slides/ioutputsaver)。
...
トランジションアニメーションオプションを取得または設定します。 読み取り/書き込み boolean。
...
シェイプアニメーションオプションを取得または設定します。 読み取り/書き込み boolean。
