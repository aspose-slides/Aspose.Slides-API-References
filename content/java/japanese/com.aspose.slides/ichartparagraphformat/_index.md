...
| Method | Description |
| --- | --- |
| [getAlignment()](#getAlignment--) | 段落内のテキスト配置を取得または設定します。 |
| [setAlignment(int value)](#setAlignment-int-) | 段落内のテキスト配置を取得または設定します。 |
| [getSpaceWithin()](#getSpaceWithin--) | 段落内の基準線間のスペース量を取得または設定します。 |
| [setSpaceWithin(float value)](#setSpaceWithin-float-) | 段落内の基準線間のスペース量を取得または設定します。 |
...
| [getTabs()](#getTabs--) | 段落のタブ位置を取得します。 |
| [getFontAlignment()](#getFontAlignment--) | 段落内のフォント配置を取得または設定します。 |
| [setFontAlignment(int value)](#setFontAlignment-int-) | 段落内のフォント配置を取得または設定します。 |
### getAlignment() {#getAlignment--}
```
public abstract int getAlignment()
```

段落内のテキスト配置を取得または設定します。 読み取り/書き込み [TextAlignment](../../com.aspose.slides/textalignment)。
...
段落内の基準線間のスペース量を取得または設定します。 読み取り/書き込み float。
...
段落の最初の行の前のスペース量を取得または設定します。 読み取り/書き込み float。
...
段落の最後の行の後のスペース量を取得または設定します。 読み取り/書き込み float。
...
段落で東アジアの改行が使用されているかどうかを判定します。 読み取り/書き込み [NullableBool](../../com.aspose.slides/nullablebool)。
...
段落で右から左への書字が使用されているかどうかを判定します。 読み取り/書き込み [NullableBool](../../com.aspose.slides/nullablebool)。
...
段落でラテン文字の改行が使用されているかどうかを判定します。 読み取り/書き込み [NullableBool](../../com.aspose.slides/nullablebool)。
...
段落でハンギング句読点が使用されているかどうかを判定します。 読み取り/書き込み [NullableBool](../../com.aspose.slides/nullablebool)。
...
段落の左余白を取得または設定します。 読み取り/書き込み float。
...
段落の右余白を取得または設定します。 読み取り/書き込み float。
...
段落の最初の行インデント/ハンギングインデントを取得または設定します。 ハンギングインデントは負の値で定義できます。 読み取り/書き込み float。
...
デフォルトのタブ幅を取得または設定します。 読み取り/書き込み float。
...
段落のタブ位置を取得します。 読み取り専用 [ITabCollection](../../com.aspose.slides/itabcollection)。
...
段落内のフォント配置を取得または設定します。 読み取り/書き込み [FontAlignment](../../com.aspose.slides/fontalignment)。
