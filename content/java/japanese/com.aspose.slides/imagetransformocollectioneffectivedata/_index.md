...
名前 IImageTransformOperationCollectionEffectiveData は、COM 名の長さが 39 文字を超えてはいけないため、IImageTransformOCollectionEffectiveData に短縮されました。
## コンストラクタ
...
| [hashCode()](#hashCode--) | 特定の型に対するハッシュ関数として機能し、ハッシュテーブルなどのハッシュアルゴリズムやデータ構造での使用に適しています。 |
...
**戻り値:**
[IEffectEffectiveData](../../com.aspose.slides/ieffecteffectivedata) - [IEffectEffectiveData](../../com.aspose.slides/ieffecteffectivedata) オブジェクト。
...
特定の型に対するハッシュ関数として機能し、ハッシュテーブルなどのハッシュアルゴリズムやデータ構造での使用に適しています。
...
**戻り値:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffectEffectiveData> - コレクションを反復するために使用できる IGenericEnumerator。
