...
type: docs
url: /ja/com.aspose.slides/igroupshapelock/
---
**実装されているすべてのインターフェイス:**
...
| メソッド | 説明 |
| --- | --- |
| [getGroupingLocked()](#getGroupingLocked--) | このシェイプをグループに追加できないかどうかを判断します。 |
| [setGroupingLocked(boolean value)](#setGroupingLocked-boolean-) | このシェイプをグループに追加できないかどうかを判断します。 |
| [getUngroupingLocked()](#getUngroupingLocked--) | この groupshape を分割できないかどうかを判断します。 |
| [setUngroupingLocked(boolean value)](#setUngroupingLocked-boolean-) | この groupshape を分割できないかどうかを判断します。 |
| [getSelectLocked()](#getSelectLocked--) | このシェイプの選択が禁止されているかどうかを判断します。 |
| [setSelectLocked(boolean value)](#setSelectLocked-boolean-) | このシェイプの選択が禁止されているかどうかを判断します。 |
| [getRotationLocked()](#getRotationLocked--) | このシェイプの回転角度の変更が禁止されているかどうかを判断します。 |
| [setRotationLocked(boolean value)](#setRotationLocked-boolean-) | このシェイプの回転角度の変更が禁止されているかどうかを判断します。 |
| [getAspectRatioLocked()](#getAspectRatioLocked--) | リサイズ時にシェイプがアスペクト比を保持しなければならないかどうかを判断します。 |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | リサイズ時にシェイプがアスペクト比を保持しなければならないかどうかを判断します。 |
| [getPositionLocked()](#getPositionLocked--) | このシェイプの移動が禁止されているかどうかを判断します。 |
| [setPositionLocked(boolean value)](#setPositionLocked-boolean-) | このシェイプの移動が禁止されているかどうかを判断します。 |
| [getSizeLocked()](#getSizeLocked--) | このシェイプのサイズ変更が禁止されているかどうかを判断します。 |
| [setSizeLocked(boolean value)](#setSizeLocked-boolean-) | このシェイプのサイズ変更が禁止されているかどうかを判断します。 |
...
このシェイプをグループに追加できないかどうかを判断します。 読み書き可能な boolean。
...
この groupshape を分割できないかどうかを判断します。 読み書き可能な boolean。
...
このシェイプの選択が禁止されているかどうかを判断します。 読み書き可能な boolean。
...
このシェイプの回転角度の変更が禁止されているかどうかを判断します。 読み書き可能な boolean。
...
リサイズ時にシェイプがアスペクト比を保持しなければならないかどうかを判断します。 読み書き可能な boolean。
...
このシェイプのサイズ変更が禁止されているかどうかを判断します。 読み書き可能な boolean。
