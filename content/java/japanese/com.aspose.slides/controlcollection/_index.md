...
| メソッド | 説明 |
| --- | --- |
| [size()](#size--) | コレクション内のオブジェクトの数を返します。 |
...
コレクション内のオブジェクトの数を返します。 読み取り専用 int.
...
**戻り値:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IControl> - コレクションを反復するために使用できる IGenericEnumerator。
