...
type: docs
url: /ja/com.aspose.slides/axisformat/
---
**継承:**
...
| メソッド | 説明 |
| --- | --- |
| [getFill()](#getFill--) | 軸の塗りつぶしスタイルプロパティを返します。 |
| [getLine()](#getLine--) | 軸の線スタイルプロパティを返します。 |
| [getEffect()](#getEffect--) | 軸で使用されるエフェクトを返します。 |
...
軸の塗りつぶしスタイルプロパティを返します。読み取り専用 [IFillFormat](../../com.aspose.slides/ifillformat)。
...
軸の線スタイルプロパティを返します。読み取り専用 [ILineFormat](../../com.aspose.slides/ilineformat)。
...
軸で使用されるエフェクトを返します。読み取り専用 [IEffectFormat](../../com.aspose.slides/ieffectformat)。
