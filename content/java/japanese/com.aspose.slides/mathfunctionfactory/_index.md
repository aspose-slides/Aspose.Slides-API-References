...
| メソッド | 説明 |
| --- | --- |
| [createMathFunction(IMathElement funcName, IMathElement baseArgument)](#createMathFunction-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-) | 数式関数を作成します |
| [createMathFunction(String funcName, IMathElement baseArgument)](#createMathFunction-java.lang.String-com.aspose.slides.IMathElement-) | 数式関数を作成します |
### MathFunctionFactory() {#MathFunctionFactory--}
```
...
**戻り値:**
[IMathFunction](../../com.aspose.slides/imathfunction) - 新しい数式関数
