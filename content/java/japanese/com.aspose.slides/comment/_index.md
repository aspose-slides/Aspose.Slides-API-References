...
| [setPosition(Point2D.Float value)](#setPosition-java.awt.geom.Point2D.Float-) | スライド上のコメントの位置を取得または設定します。 |
...
コメント作成時刻を取得または設定します。 このプロパティに java.util.Date(Long.MIN\_VALUE) を設定すると、コメント時刻が設定されていないことを意味します。 読み書き java.util.Date.
...
スライド上のコメントの位置を取得または設定します。 読み書き java.awt.geom.Point2D.Float。
...
親コメントを取得または設定します。 読み書き [IComment](../../com.aspose.slides/icomment)。
