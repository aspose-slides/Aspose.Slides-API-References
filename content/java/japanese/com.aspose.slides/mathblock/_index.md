...
MathParagraph 内に含まれ、独自の行で開始する数式テキストのインスタンスを指定します。数式ブロックは、方程式、式、方程式や式の配列、そして数式全般を表すすべての数式領域を表現します。
...
| [MathBlock(IMathElement mathElement)](#MathBlock-com.aspose.slides.IMathElement-) | 新しい数式ブロックを作成し、指定された要素をブロックに配置します |
| [MathBlock(System.Collections.Generic.IGenericEnumerable<IMathElement> mathElements)](#MathBlock-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.slides.IMathElement--) | 新しい数式ブロックを作成し、指定された要素群をブロックに配置します |
## メソッド
...
| [isReadOnly()](#isReadOnly--) | 子要素コレクションは変更可能なため、false を返します。 |
...
| [contains(IMathElement item)](#contains-com.aspose.slides.IMathElement-) | コレクションに特定の値が含まれているかどうかを判断します。 |
...
| [indexOf(IMathElement item)](#indexOf-com.aspose.slides.IMathElement-) | コレクション内の特定の数式要素のインデックスを決定します。 |
...
| [joinBlock(IMathBlock other)](#joinBlock-com.aspose.slides.IMathBlock-) | このブロックに別の数式ブロックを結合します |
| [delimit(char separatorCharacter)](#delimit-char-) | 区切り文字（括弧なし）で子要素を区切ります |
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | 括弧やその他の文字で子要素を囲みます |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | 括弧やその他の文字で子要素を囲み、区切り文字で区切ります |
| [toMathArray()](#toMathArray--) | 子要素を垂直配列に配置します |
...
新しい数式ブロックを作成し、指定された要素をブロックに配置します
...
新しい数式ブロックを作成し、指定された要素群をブロックに配置します
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| mathElements | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.slides.IMathElement> | ブロックに配置する数式要素群 |
...
**戻り値:**
boolean - アイテムがコレクションに存在すれば true、存在しなければ false。
...
**戻り値:**
boolean - アイテムが正常に削除された場合は true、そうでない場合は false。アイテムが元のコレクションに存在しなかった場合も false が返されます。
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| index | int | MathElement を挿入すべきゼロベースインデックス |
...
指定された文字（括弧や他の文字）でこのブロックの子要素を囲みます
...
**戻り値:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - 型 [IMathDelimiter](../../com.aspose.slides/imathdelimiter) の数式要素（指定文字でフレーム化）
...
**戻り値:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - 型 [IMathDelimiter](../../com.aspose.slides/imathdelimiter) の数式要素（指定文字でフレーム化かつ区切りあり）
