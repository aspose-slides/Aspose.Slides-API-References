...
| [insert(int index, IBehavior item)](#insert-int-com.aspose.slides.IBehavior-) | 指定されたインデックスに新しいビヘイビアを挿入します。 |
| [remove(IBehavior item)](#remove-com.aspose.slides.IBehavior-) | コレクションから指定されたビヘイビアを削除します。 |
| [removeAt(int index)](#removeAt-int-) | 指定されたインデックスのコレクションからビヘイビアを削除します。 |
...
**戻り値:**
boolean - ビヘイビアが正常に削除された場合は true boolean
