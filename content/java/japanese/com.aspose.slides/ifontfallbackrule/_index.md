...
| メソッド | 説明 |
| --- | --- |
| [addFallBackFonts(String fontName)](#addFallBackFonts-java.lang.String-) | 新しいフォントを FallBack フォントのリストに追加します。 |
| [addFallBackFonts(String[] fontNames)](#addFallBackFonts-java.lang.String---) | 新しいフォントを FallBack フォントのリストに追加します。 |
...
| [removeAt(int index)](#removeAt-int-) | リストの指定されたインデックスにある FallBack フォントを削除します。 |
| [toArray()](#toArray--) | このルールのすべての FallBack フォントを含む配列を作成して返します。 |
| [toArray(int startIndex, int count)](#toArray-int-int-) | リスト内の指定された範囲からすべての FallBack フォントを含む配列を作成して返します。 |
...
新しいフォントを FallBack フォントのリストに追加します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| fontName | java.lang.String | FallBack 用のフォント名またはカンマ区切りの複数名 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| fontNames | java.lang.String[] | FallBack 用のフォント名またはカンマ区切りの複数名 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| fontName | java.lang.String | リストから削除するフォント名 |
...
リストの指定されたインデックスにある FallBack フォントを削除します。
...
このルールのすべての FallBack フォントを含む配列を作成して返します。
...
リスト内の指定された範囲からすべての FallBack フォントを含む配列を作成して返します。
...
**戻り値:**
int - フォントのインデックス、またはリストに存在しない場合は -1。