...
description: 親 PictureFrameEx で無効化されている操作を判定します。
type: docs
url: /ja/com.aspose.slides/ipictureframelock/
---
**実装されているすべてのインターフェイス:**
...
親 PictureFrameEx で無効化されている操作を判定します。
...
| [getSelectLocked()](#getSelectLocked--) | このシェイプを選択することが禁止されているかどうかを判定します。 |
| [setSelectLocked(boolean value)](#setSelectLocked-boolean-) | このシェイプを選択することが禁止されているかどうかを判定します。 |
| [getRotationLocked()](#getRotationLocked--) | このシェイプの回転角度を変更することが禁止されているかどうかを判定します。 |
| [setRotationLocked(boolean value)](#setRotationLocked-boolean-) | このシェイプの回転角度を変更することが禁止されているかどうかを判定します。 |
| [getAspectRatioLocked()](#getAspectRatioLocked--) | シェイプがサイズ変更時にアスペクト比を保持しなければならないかどうかを判定します。 |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | シェイプがサイズ変更時にアスペクト比を保持しなければならないかどうかを判定します。 |
| [getPositionLocked()](#getPositionLocked--) | このシェイプを移動することが禁止されているかどうかを判定します。 |
| [setPositionLocked(boolean value)](#setPositionLocked-boolean-) | このシェイプを移動することが禁止されているかどうかを判定します。 |
| [getSizeLocked()](#getSizeLocked--) | このシェイプをサイズ変更することが禁止されているかどうかを判定します。 |
| [setSizeLocked(boolean value)](#setSizeLocked-boolean-) | このシェイプをサイズ変更することが禁止されているかどうかを判定します。 |
| [getEditPointsLocked()](#getEditPointsLocked--) | このシェイプの輪郭を直接変更することが禁止されているかどうかを判定します。 |
| [setEditPointsLocked(boolean value)](#setEditPointsLocked-boolean-) | このシェイプの輪郭を直接変更することが禁止されているかどうかを判定します。 |
| [getAdjustHandlesLocked()](#getAdjustHandlesLocked--) | 調整ハンドルの値を変更することが禁止されているかどうかを判定します。 |
| [setAdjustHandlesLocked(boolean value)](#setAdjustHandlesLocked-boolean-) | 調整ハンドルの値を変更することが禁止されているかどうかを判定します。 |
| [getArrowheadsLocked()](#getArrowheadsLocked--) | 矢じりを変更することが禁止されているかどうかを判定します。 |
| [setArrowheadsLocked(boolean value)](#setArrowheadsLocked-boolean-) | 矢じりを変更することが禁止されているかどうかを判定します。 |
| [getShapeTypeLocked()](#getShapeTypeLocked--) | シェイプの種類を変更することが禁止されているかどうかを判定します。 |
| [setShapeTypeLocked(boolean value)](#setShapeTypeLocked-boolean-) | シェイプの種類を変更することが禁止されているかどうかを判定します。 |
| [getCropLocked()](#getCropLocked--) | 画像のトリミングが禁止されているかどうかを判定します。 |
| [setCropLocked(boolean value)](#setCropLocked-boolean-) | 画像のトリミングが禁止されているかどうかを判定します。 |
...
このシェイプをグループに追加することが禁止されているかどうかを判定します。 読み書き可能な boolean。
...
このシェイプを選択することが禁止されているかどうかを判定します。 読み書き可能な boolean。
...
このシェイプの回転角度を変更することが禁止されているかどうかを判定します。 読み書き可能な boolean。
...
シェイプがサイズ変更時にアスペクト比を保持しなければならないかどうかを判定します。 読み書き可能な boolean。
...
このシェイプを移動することが禁止されているかどうかを判定します。 読み書き可能な boolean。
...
このシェイプをサイズ変更することが禁止されているかどうかを判定します。 読み書き可能な boolean。
...
このシェイプの輪郭を直接変更することが禁止されているかどうかを判定します。 読み書き可能な boolean。
...
調整ハンドルの値を変更することが禁止されているかどうかを判定します。 読み書き可能な boolean。
...
矢じりを変更することが禁止されているかどうかを判定します。 読み書き可能な boolean。
...
シェイプの種類を変更することが禁止されているかどうかを判定します。 読み書き可能な boolean。
...
画像のトリミングが禁止されているかどうかを判定します。 読み書き可能な boolean。
