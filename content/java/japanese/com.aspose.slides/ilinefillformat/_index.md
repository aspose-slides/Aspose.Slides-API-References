...
| [getRotateWithShape()](#getRotateWithShape--) | 塗りつぶしをシェイプとともに回転させるかどうかを決定します。 |
| [setRotateWithShape(byte value)](#setRotateWithShape-byte-) | 塗りつぶしをシェイプとともに回転させるかどうかを決定します。 |
### getFillType() {#getFillType--}
```
public abstract byte getFillType()
```

塗りつぶしタイプを取得または設定します。 読み書き [FillType](../../com.aspose.slides/filltype)。
...
塗りつぶしをシェイプとともに回転させるかどうかを決定します。 読み書き [NullableBool](../../com.aspose.slides/nullablebool)。
