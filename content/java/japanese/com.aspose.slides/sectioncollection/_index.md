...
**戻り値:**
int - セクションのインデックス、コレクションに属さない場合は -1。
...
**戻り値:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISection> - コレクションを反復処理できる IGenericEnumerator。
...
**戻り値:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISection> - コレクション全体の java.util.Iterator。