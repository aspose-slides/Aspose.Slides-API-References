...
description: 数学要素MathElementのコレクションを表します。
type: docs
...
| [add(IMathElement item)](#add-com.aspose.slides.IMathElement-) | 数式要素をコレクションの末尾に追加します。 |
| [indexOf(IMathElement item)](#indexOf-com.aspose.slides.IMathElement-) | コレクション内の特定の数式要素のインデックスを決定します。 |
| [insert(int index, IMathElement item)](#insert-int-com.aspose.slides.IMathElement-) | 指定されたインデックスに数式要素を挿入します。 |
| [clear()](#clear--) | コレクションからすべての要素を削除します。 |
| [contains(IMathElement item)](#contains-com.aspose.slides.IMathElement-) | コレクションが特定の値を含むかどうかを判断します。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| index | int | 取得するアイテムのゼロベースインデックス |
...
**戻り値:**
int - コレクション内にアイテムが見つかった場合のインデックス。見つからない場合は -1。
...
**戻り値:**
boolean - コレクション内にアイテムが見つかった場合は true、そうでなければ false。
...
**戻り値:**
boolean - アイテムがコレクションから正常に削除された場合は true、そうでなければ false。元のコレクションにアイテムが見つからなかった場合も false を返します。 
