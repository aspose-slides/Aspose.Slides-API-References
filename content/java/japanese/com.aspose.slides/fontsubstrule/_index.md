...
| メソッド | 説明 |
| --- | --- |
| [getSourceFont()](#getSourceFont--) | 置換対象のフォント。 |
...
| destFont | [IFontData](../../com.aspose.slides/ifontdata) | デスティネーションフォント。 |
...
置換対象のフォント。読み取り専用 [IFontData](../../com.aspose.slides/ifontdata)。
