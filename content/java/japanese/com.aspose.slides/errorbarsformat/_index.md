...
チャート系列のエラーバーを表します。ErrorBars のカスタム値は IChartDataPointCollection にあり、([IChartDataPoint.getErrorBarsCustomValues](../../com.aspose.slides/ichartdatapoint\#getErrorBarsCustomValues)) プロパティ内です。

## メソッド

| メソッド | 説明 |
| --- | --- |
| [getType()](#getType--) | エラーバーの種類を取得または設定します。 |
| [setType(int value)](#setType-int-) | エラーバーの種類を取得または設定します。 |
...
| [isVisible()](#isVisible--) | エラーバーの可視性を取得または設定します。 |
| [setVisible(boolean value)](#setVisible-boolean-) | エラーバーの可視性を取得または設定します。 |
...
エラーバーの種類を取得または設定します。読み書き可能 [ErrorBarType](../../com.aspose.slides/errorbartype)。
...
エラーバーの長さを決定する可能な方法を表します。カスタム値タイプの場合は、系列の DataPoints コレクション内の特定のデータ ポイントの ([IChartDataPoint.getErrorBarsCustomValues](../../com.aspose.slides/ichartdatapoint\#getErrorBarsCustomValues)) プロパティを使用して値を指定します。Fixed、Percentage、StandardDeviation 値タイプの場合は Value プロパティを使用して値を指定します。読み書き可能 [ErrorBarValueType](../../com.aspose.slides/errorbarvaluetype)。
...
エラーバーにエンドキャップが描画されないことを指定します。読み書き可能 boolean。
...
Fixed、Percentage、StandardDeviation の値タイプでエラーバーの長さを決定するために使用される値を取得または設定します。その他の場合は NaN を返します。読み書き可能 float。
...
エラーバーの書式を表します。読み書き可能 [IFormat](../../com.aspose.slides/iformat)。
...
エラーバーの可視性を取得または設定します。読み書き可能 boolean。
