...
description: 数式マトリックスを作成できます
type: docs
url: /ja/com.aspose.slides/mathmatrixfactory/
---
**継承:**
java.lang.Object
...
| メソッド | 説明 |
| --- | --- |
| [createMathMatrix(int rowCount, int columnCount)](#createMathMatrix-int-int-) | 数式マトリックスを作成します |
### MathMatrixFactory() {#MathMatrixFactory--}
```
...
**戻り値:**
[IMathMatrix](../../com.aspose.slides/imathmatrix) - 新しい数式マトリックス