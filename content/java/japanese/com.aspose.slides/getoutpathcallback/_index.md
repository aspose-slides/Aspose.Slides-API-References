...
| メソッド | 説明 |
| --- | --- |
| [invoke(Slide slide, int index)](#invoke-com.aspose.slides.Slide-int-) | 各[Slide](../../com.aspose.slides/slide)ごとに呼び出されるコールバックで、出力パスが返されることが期待されます。 |
...
各[Slide](../../com.aspose.slides/slide)ごとに呼び出されるコールバックで、出力パスが返されることが期待されます。
