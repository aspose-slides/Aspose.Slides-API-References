...
| [getStyleIndex()](#getStyleIndex--) | BackgroundType.Themed 塗りつぶしのインデックスを背景テーマコレクションから返します。 |
| [setStyleIndex(int value)](#setStyleIndex-int-) | BackgroundType.Themed 塗りつぶしのインデックスを背景テーマコレクションから返します。 |
...
BackgroundType.Themed 塗りつぶしのインデックスを背景テーマコレクションから返します。0 は塗りつぶしなしを意味します。1..999 はインデックスです。読み書き int。
...
**戻り値:**
[IBackgroundEffectiveData](../../com.aspose.slides/ibackgroundeffectivedata) - [IBackgroundEffectiveData](../../com.aspose.slides/ibackgroundeffectivedata) のインスタンス。
### getVersion() {#getVersion--}
```
