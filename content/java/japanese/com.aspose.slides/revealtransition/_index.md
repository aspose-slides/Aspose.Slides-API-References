...
type: docs
url: /ja/com.aspose.slides/revealtransition/
---
**継承:**
...
| [getThroughBlack()](#getThroughBlack--) | 遷移が黒でフェードするかどうかを指定します。 |
| [setThroughBlack(boolean value)](#setThroughBlack-boolean-) | 遷移が黒でフェードするかどうかを指定します。 |
...
遷移の方向。読み書き [TransitionLeftRightDirectionType](../../com.aspose.slides/transitionleftrightdirectiontype)。
...
遷移が黒でフェードするかどうかを指定します。読み書き boolean。
