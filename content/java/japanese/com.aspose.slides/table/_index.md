...
| [getTableFormat()](#getTableFormat--) | このテーブルの書式プロパティを含む TableFormat オブジェクトを返します。 |
...
| [getFirstRow()](#getFirstRow--) | テーブルの最初の行を特別な書式で描画するかどうかを判断します。 |
| [setFirstRow(boolean value)](#setFirstRow-boolean-) | テーブルの最初の行を特別な書式で描画するかどうかを判断します。 |
| [getFirstCol()](#getFirstCol--) | テーブルの最初の列を特別な書式で描画するかどうかを判断します。 |
| [setFirstCol(boolean value)](#setFirstCol-boolean-) | テーブルの最初の列を特別な書式で描画するかどうかを判断します。 |
| [getLastRow()](#getLastRow--) | テーブルの最後の行を特別な書式で描画するかどうかを判断します。 |
| [setLastRow(boolean value)](#setLastRow-boolean-) | テーブルの最後の行を特別な書式で描画するかどうかを判断します。 |
| [getLastCol()](#getLastCol--) | テーブルの最後の列を特別な書式で描画するかどうかを判断します。 |
| [setLastCol(boolean value)](#setLastCol-boolean-) | テーブルの最後の列を特別な書式で描画するかどうかを判断します。 |
| [getHorizontalBanding()](#getHorizontalBanding--) | 偶数行が別の書式で描画されるかどうかを判断します。 |
| [setHorizontalBanding(boolean value)](#setHorizontalBanding-boolean-) | 偶数行が別の書式で描画されるかどうかを判断します。 |
| [getVerticalBanding()](#getVerticalBanding--) | 偶数列が別の書式で描画されるかどうかを判断します。 |
| [setVerticalBanding(boolean value)](#setVerticalBanding-boolean-) | 偶数列が別の書式で描画されるかどうかを判断します。 |
| [setTextFormat(IPortionFormat source)](#setTextFormat-com.aspose.slides.IPortionFormat-) | 定義されたパーション書式プロパティをすべてのテーブルセルのパーションに設定します。 |
...
指定された列と行のインデックスにあるセルを返します。読み取り専用 [Cell](../../com.aspose.slides/cell)。
...
このテーブルの書式プロパティを含む TableFormat オブジェクトを返します。読み取り専用 [ITableFormat](../../com.aspose.slides/itableformat)。
...
テーブルが右から左への読み順かどうかを判断します。読み書き可能 boolean 。
...
テーブルの最初の行を特別な書式で描画するかどうかを判断します。読み書き可能 boolean 。
...
テーブルの最初の列を特別な書式で描画するかどうかを判断します。読み書き可能 boolean 。
...
テーブルの最後の行を特別な書式で描画するかどうかを判断します。読み書き可能 boolean 。
...
テーブルの最後の列を特別な書式で描画するかどうかを判断します。読み書き可能 boolean 。
...
偶数行が別の書式で描画されるかどうかを判断します。読み書き可能 boolean 。
...
偶数列が別の書式で描画されるかどうかを判断します。読み書き可能 boolean 。
...
定義されたパーション書式プロパティをすべてのテーブルセルのパーションに設定します。
