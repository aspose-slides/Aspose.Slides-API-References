...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| index | int | レベルのゼロベースのインデックス。0..8 の範囲である必要があります。 |

**戻り値:**
[IParagraphFormat](../../com.aspose.slides/iparagraphformat) - [IParagraphFormat](../../com.aspose.slides/iparagraphformat) の書式設定。
...
デフォルトの段落プロパティです。読み取り専用 [IParagraphFormat](../../com.aspose.slides/iparagraphformat)。
