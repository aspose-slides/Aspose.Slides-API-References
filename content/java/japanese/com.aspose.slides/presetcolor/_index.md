...
type: docs
url: /ja/com.aspose.slides/presetcolor/
---
**継承:**  
...
| フィールド | 説明 |
| --- | --- |
| [NotDefined](#NotDefined) | 色のプリセットが定義されていません。 |
| [AliceBlue](#AliceBlue) |  |
...
### PaleTurquoise {#PaleTurquoise}
`````
**Note:** The request is to translate comments in the given code block. However, the provided code block contains no comments (//, /* */, or #). Therefore, there is nothing to translate.
