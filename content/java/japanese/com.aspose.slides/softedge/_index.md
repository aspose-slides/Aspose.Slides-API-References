...
ソフトエッジ効果を表します。シェイプのエッジはぼかされますが、塗りは影響を受けません。
...
| [equals(Object obj)](#equals-java.lang.Object-) | 指定された [SoftEdge](../../com.aspose.slides/softedge) が現在の [SoftEdge](../../com.aspose.slides/softedge) と等しいかどうかを判定します。 |
...
指定された [SoftEdge](../../com.aspose.slides/softedge) が現在の [SoftEdge](../../com.aspose.slides/softedge) と等しいかどうかを判定します。

**パラメータ:**
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| obj | java.lang.Object | 比較対象の [SoftEdge](../../com.aspose.slides/softedge)。 |
