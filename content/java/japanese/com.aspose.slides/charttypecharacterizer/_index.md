...
description: ChartType によってチャートと系列の追加情報を取得するためのヘルパーです。
type: docs
...
ChartType によってチャートと系列の追加情報を取得するためのヘルパーです。
...
| メソッド | 説明 |
| --- | --- |
| [isBar3DChart(int chartType)](#isBar3DChart-int-) | chartType が bar3DChart のサブタイプ（3D 列または棒）のいずれかである場合に true を返します。 |
...
| [isSeriesUsesBubbleSizeCoordinate(int seriesType)](#isSeriesUsesBubbleSizeCoordinate-int-) | 指定された series type でバブルサイズ座標を使用できるかどうかを返します。 |
| [hasSeriesTrendLines(int seriesType)](#hasSeriesTrendLines-int-) | 指定された series type に系列トレンドラインがあるかどうかを返します。 |
...
chartType が bar3DChart のサブタイプ（3D 列または棒）のいずれかである場合に true を返します。
...
chartType が Pie のサブタイプのいずれかである場合に true を返します。サブタイプの集合は PowerPoint の「チャートの種類の変更」ダイアログに対応しています: [ChartType.BarOfPie](../../com.aspose.slides/charttype\#BarOfPie), [ChartType.ExplodedPie](../../com.aspose.slides/charttype\#ExplodedPie), [ChartType.ExplodedPie3D](../../com.aspose.slides/charttype\#ExplodedPie3D), [ChartType.Pie](../../com.aspose.slides/charttype\#Pie), [ChartType.Pie3D](../../com.aspose.slides/charttype\#Pie3D), [ChartType.PieOfPie](../../com.aspose.slides/charttype\#PieOfPie).
...
chartType が Stock のサブタイプのいずれかである場合に true を返します。サブタイプの集合は PowerPoint の「チャートの種類の変更」ダイアログに対応しています: [ChartType.HighLowClose](../../com.aspose.slides/charttype\#HighLowClose), [ChartType.OpenHighLowClose](../../com.aspose.slides/charttype\#OpenHighLowClose), [ChartType.VolumeHighLowClose](../../com.aspose.slides/charttype\#VolumeHighLowClose), [ChartType.VolumeOpenHighLowClose](../../com.aspose.slides/charttype\#VolumeOpenHighLowClose).
...
chartType が Surface のサブタイプのいずれかである場合に true を返します。サブタイプの集合は PowerPoint の「チャートの種類の変更」ダイアログに対応しています: [ChartType.Surface3D](../../com.aspose.slides/charttype\#Surface3D), [ChartType.WireframeSurface3D](../../com.aspose.slides/charttype\#WireframeSurface3D), [ChartType.Contour](../../com.aspose.slides/charttype\#Contour), [ChartType.WireframeContour](../../com.aspose.slides/charttype\#WireframeContour).
...
chartType が Doughnut のサブタイプのいずれかである場合に true を返します。サブタイプの集合は PowerPoint の「チャートの種類の変更」ダイアログに対応しています: [ChartType.Doughnut](../../com.aspose.slides/charttype\#Doughnut), [ChartType.ExplodedDoughnut](../../com.aspose.slides/charttype\#ExplodedDoughnut).
...
chartType が Bubble のサブタイプのいずれかである場合に true を返します。サブタイプの集合は PowerPoint の「チャートの種類の変更」ダイアログに対応しています: [ChartType.Bubble](../../com.aspose.slides/charttype\#Bubble), [ChartType.BubbleWith3D](../../com.aspose.slides/charttype\#BubbleWith3D).
...
chartType が Radar のサブタイプのいずれかである場合に true を返します。サブタイプの集合は PowerPoint の「チャートの種類の変更」ダイアログに対応しています: [ChartType.FilledRadar](../../com.aspose.slides/charttype\#FilledRadar), [ChartType.Radar](../../com.aspose.slides/charttype\#Radar), [ChartType.RadarWithMarkers](../../com.aspose.slides/charttype\#RadarWithMarkers).
...
**戻り値:**
boolean - 使用する場合は true、そうでない場合は false。
...
指定された series type でバブルサイズ座標を使用できるかどうかを返します。
...
**戻り値:**
boolean - 使用できる場合は true、そうでない場合は false。
...
指定された series type に系列トレンドラインがあるかどうかを返します。
...
**戻り値:**
boolean - 存在する場合は true、そうでない場合は false。
...
**戻り値:**
boolean - 許可されている場合は true、そうでない場合は false。
