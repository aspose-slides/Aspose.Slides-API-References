...
| メソッド | 説明 |
| --- | --- |
| [getAudioCdStartTrack()](#getAudioCdStartTrack--) | 開始トラック インデックスを取得または設定します。 |
| [setAudioCdStartTrack(int value)](#setAudioCdStartTrack-int-) | 開始トラック インデックスを取得または設定します。 |
...
| [getAudioCdEndTrack()](#getAudioCdEndTrack--) | 最後のトラック インデックスを取得または設定します（読み取り/書き込み int）。 |
| [setAudioCdEndTrack(int value)](#setAudioCdEndTrack-int-) | 最後のトラック インデックスを取得または設定します（読み取り/書き込み int）。 |
...
| [getVolume()](#getVolume--) | 音声の音量を取得または設定します。 |
| [setVolume(int value)](#setVolume-int-) | 音声の音量を取得または設定します。 |
...
| [getPlayAcrossSlides()](#getPlayAcrossSlides--) | スライド全体で音声が再生されるかどうかを判定します。 |
| [setPlayAcrossSlides(boolean value)](#setPlayAcrossSlides-boolean-) | スライド全体で音声が再生されるかどうかを判定します。 |
...
| [getLinkPathLong()](#getLinkPathLong--) | AudioFrame にリンクされている音声ファイル名を取得または設定します。 |
| [setLinkPathLong(String value)](#setLinkPathLong-java.lang.String-) | AudioFrame にリンクされている音声ファイル名を取得または設定します。 |
| [getEmbeddedAudio()](#getEmbeddedAudio--) | 埋め込み音声オブジェクトを取得または設定します。 |
| [setEmbeddedAudio(IAudio value)](#setEmbeddedAudio-com.aspose.slides.IAudio-) | 埋め込み音声オブジェクトを取得または設定します。 |
| [getFadeInDuration()](#getFadeInDuration--) | メディアの初期フェードインの時間長さ（ミリ秒）を指定します。 |
| [setFadeInDuration(float value)](#setFadeInDuration-float-) | メディアの初期フェードインの時間長さ（ミリ秒）を指定します。 |
| [getFadeOutDuration()](#getFadeOutDuration--) | メディアの終了フェードアウトの時間長さ（ミリ秒）を指定します。 |
| [setFadeOutDuration(float value)](#setFadeOutDuration-float-) | メディアの終了フェードアウトの時間長さ（ミリ秒）を指定します。 |
| [getVolumeValue()](#getVolumeValue--) | 音量をパーセンテージで取得または設定します。 |
| [setVolumeValue(float value)](#setVolumeValue-float-) | 音量をパーセンテージで取得または設定します。 |
| [getTrimFromStart()](#getTrimFromStart--) | 再生中にメディアの開始部分から削除する時間長さ（ミリ秒）を指定します。 |
| [setTrimFromStart(float value)](#setTrimFromStart-float-) | 再生中にメディアの開始部分から削除する時間長さ（ミリ秒）を指定します。 |
| [getTrimFromEnd()](#getTrimFromEnd--) | 再生中にメディアの末尾から削除する時間長さ（ミリ秒）を指定します。 |
| [setTrimFromEnd(float value)](#setTrimFromEnd-float-) | 再生中にメディアの末尾から削除する時間長さ（ミリ秒）を指定します。 |
| [getCaptionTracks()](#getCaptionTracks--) | AudioFrame に関連付けられたクローズドキャプションのコレクションを取得します。 |
### getAudioCdStartTrack() {#getAudioCdStartTrack--}
```
public abstract int getAudioCdStartTrack()
```

開始トラック インデックスを取得または設定します（読み取り/書き込み int）。
...
最後のトラック インデックスを取得または設定します（読み取り/書き込み int）。
...
音声の音量を取得または設定します（読み取り/書き込み [AudioVolumeMode](../../com.aspose.slides/audiovolumemode)）。
...
スライド全体で音声が再生されるかどうかを判定します（読み取り/書き込み boolean）。
...
AudioFrame にリンクされている音声ファイル名を取得または設定します（読み取り/書き込み String）。
...
埋め込み音声オブジェクトを取得または設定します（読み取り/書き込み [IAudio](../../com.aspose.slides/iaudio)）。
...
メディアの初期フェードインの時間長さ（ミリ秒）を指定します（読み取り/書き込み float）。
...
メディアの終了フェードアウトの時間長さ（ミリ秒）を指定します（読み取り/書き込み float）。
...
再生中にメディアの開始部分から削除する時間長さ（ミリ秒）を指定します（読み取り/書き込み float）。
...
再生中にメディアの末尾から削除する時間長さ（ミリ秒）を指定します（読み取り/書き込み float）。
...
AudioFrame に関連付けられたクローズドキャプションのコレクションを取得します。このプロパティは読み取り専用で、すべてのキャプション トラックを含む [ICaptionsCollection](../../com.aspose.slides/icaptionscollection) を返します。
