...
description: MathParagraph 内に含まれ、独自の行で開始される数学テキストのインスタンスを指定します。
type: docs
...
MathParagraph 内に含まれ、独自の行で開始される数学テキストのインスタンスを指定します。方程式、式、方程式や式の配列、数式などのすべての数学領域は、math ブロックで表されます。
...
| メソッド | 説明 |
| --- | --- |
| [delimit(char separatorCharacter)](#delimit-char-) | 区切り文字で子要素すべてを区切ります（角括弧は除く） |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | このブロックの子要素を、括弧などの指定文字で囲み、区切り文字で区切ります |
| [joinBlock(IMathBlock other)](#joinBlock-com.aspose.slides.IMathBlock-) | 別の数学ブロックをこのブロックに結合します |
...
**戻り値:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - [IMathDelimiter](../../com.aspose.slides/imathdelimiter) 型の数学要素で、指定された文字を枠と区切りとして含みます
...
| パラメータ | 型 | 説明 |
| --- | --- | --- |
| other | [IMathBlock](../../com.aspose.slides/imathblock) | 結合ブロック |

**戻り値:**
[IMathBlock](../../com.aspose.slides/imathblock) - 結合後のこの数学ブロック
