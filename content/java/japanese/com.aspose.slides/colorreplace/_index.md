...
Color Replacement エフェクトを表します。すべてのエフェクトカラーは固定色に変更されます。アルファ値は影響を受けません。

## メソッド

| メソッド | 説明 |
| --- | --- |
| [getColor()](#getColor--) | すべてのピクセルの色を置き換える色フォーマットを返します。 |
...
すべてのピクセルの色を置き換える色フォーマットを返します。読み取り専用 [IColorFormat](../../com.aspose.slides/icolorformat)。
