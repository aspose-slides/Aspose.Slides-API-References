...
生成された SWF ドキュメントに統合ドキュメントビューアーを含めるかどうかを指定します。既定は true です。
...
ページ周囲の境界線を表示するかどうかを指定します。既定は true です。
...
フルスクリーンボタンを表示/非表示にします。flashvars で上書き可能です。既定は true です。
...
フルスクリーンボタンを表示/非表示にします。flashvars で上書き可能です。既定は trueです。
...
ページステッパーを表示/非表示にします。flashvars で上書き可能です。既定は true です。
...
検索セクションを表示/非表示にします。flashvars で上書き可能です。既定は true です。
...
上部全体ペインを表示/非表示にします。flashvars で上書き可能です。既定は true です。
...
下部ペインを表示/非表示にします。flashvars で上書き可能です。既定は true です。
...
左ペインを表示/非表示にします。flashvars で上書き可能です。既定は true です。
...
左ペインを開いた状態で開始します。flashvars で上書き可能です。既定は false です。
...
コンテキストメニューを有効/無効にします。既定は true です。
