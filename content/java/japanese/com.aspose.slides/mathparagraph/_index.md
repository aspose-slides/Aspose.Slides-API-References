...
description: 数式ブロック IMathBlock のコンテナである数学的段落
type: docs
...
| メソッド | 説明 |
| --- | --- |
| [getJustification()](#getJustification--) | 段落の配置 デフォルト値: CenteredAsGroup |
| [setJustification(int value)](#setJustification-int-) | 段落の配置 デフォルト値: CenteredAsGroup |
| [getParent_Immediate()](#getParent-Immediate--) | Parent_Immediate オブジェクトを返します。 |
| [getCount()](#getCount--) | コレクションに実際に含まれている要素の数を取得します。 |
...
| [indexOf(IMathBlock mathBlock)](#indexOf-com.aspose.slides.IMathBlock-) | コレクション内の特定の IMathBlock のインデックスを判断します。 |
| [insert(int index, IMathBlock mathBlock)](#insert-int-com.aspose.slides.IMathBlock-) | 指定されたインデックスで IMathBlock をコレクションに挿入します。 |
| [removeAt(int index)](#removeAt-int-) | コレクションの指定されたインデックスの項目を削除します。 |
| [iterator()](#iterator--) |  |
| [iteratorJava()](#iteratorJava--) |  |
| [writeAsMathMl(OutputStream stream)](#writeAsMathMl-java.io.OutputStream-) | この [MathParagraph](../../com.aspose.slides/mathparagraph) の内容を MathML として保存します |
...
コレクションに実際に含まれている要素の数を取得します。 読み取り専用 int。
...
**戻り値:**
[IMathBlock](../../com.aspose.slides/imathblock) - 数式テキストのブロック。
...
| --- | --- | --- |
| index | int | 取得する項目のゼロベースインデックス |
| value | [IMathBlock](../../com.aspose.slides/imathblock) | 数式テキストのブロック。 |
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | コレクションの末尾に追加される数式ブロック |
...
**戻り値:**
boolean - mathBlock がコレクションから正常に削除された場合は true、そうでない場合は false。 mathBlock が元のコレクションに見つからない場合も false を返します。
...
| パラメーター | 型 | 説明 |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | コレクション内で検索する項目。 |

**戻り値:**
int - コレクション内に mathBlock が見つかった場合のインデックス。見つからない場合は -1。
...
指定されたインデックスで IMathBlock をコレクションに挿入します。
...
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | 挿入する IMathBlock。 |
...
この [MathParagraph](../../com.aspose.slides/mathparagraph) の内容を MathML として保存します。
