...
| メソッド | 説明 |
| --- | --- |
| [getPlotVisibleCellsOnly()](#getPlotVisibleCellsOnly--) | 表示されているセルのみがプロットされるかどうかを判断します。 |
| [setPlotVisibleCellsOnly(boolean value)](#setPlotVisibleCellsOnly-boolean-) | 表示されているセルのみがプロットされるかどうかを判断します。 |
| [getDisplayBlanksAs()](#getDisplayBlanksAs--) | 空白セルをチャートにプロットする方法を取得または設定します。 |
| [setDisplayBlanksAs(int value)](#setDisplayBlanksAs-int-) | 空白セルをチャートにプロットする方法を取得または設定します。 |
| [getChartData()](#getChartData--) | チャートに関連付けられたリンクまたは埋め込みデータの情報を取得します。 |
| [hasTitle()](#hasTitle--) | チャートに表示されるタイトルがあるかどうかを判断します。 |
| [setTitle(boolean value)](#setTitle-boolean-) | チャートに表示されるタイトルがあるかどうかを判断します。 |
| [getChartTitle()](#getChartTitle--) | チャートタイトルを取得または設定します（読み取り専用 [IChartTitle](../../com.aspose.slides/icharttitle)）。 |
...
| [getFloor()](#getFloor--) | 3Dチャートのフロアの書式を変更できるオブジェクトを取得します。 |
| [getUserShapes()](#getUserShapes--) | チャートの上に描画される形状を指定します。 |
...
| [hasRoundedCorners()](#hasRoundedCorners--) | チャート領域に角丸を付けるかどうかを指定します。 |
| [setRoundedCorners(boolean value)](#setRoundedCorners-boolean-) | チャート領域に角丸を付けるかどうかを指定します。 |
...
表示されているセルのみがプロットされるかどうかを判断します。表示されたセルと非表示のセルの両方をプロットする場合は false を指定します。読み取り/書き込み boolean.
...
空白セルをチャートにプロットする方法を取得または設定します。読み取り/書き込み [DisplayBlanksAsType](../../com.aspose.slides/displayblanksastype).
...
チャートに関連付けられたリンクまたは埋め込みデータの情報を取得します。読み取り専用 [IChartData](../../com.aspose.slides/ichartdata).
...
チャートに表示されるタイトルがあるかどうかを判断します。読み取り/書き込み boolean.
...
チャートタイトルを取得または設定します（読み取り専用 [IChartTitle](../../com.aspose.slides/icharttitle)）。
...
チャートに凡例があるかどうかを判断します。読み取り/書き込み boolean.
...
3Dチャートのフロアの書式を変更できるオブジェクトを取得します。読み取り専用 [IChartWall](../../com.aspose.slides/ichartwall).
...
チャートの上に描画される形状を指定します。読み取り専用 [IGroupShape](../../com.aspose.slides/igroupshape).
...
チャート要素の実際の値を計算します。実際の値には IActualLayout インターフェイスを実装した要素の位置（IActualLayout.ActualX、IActualLayout.ActualY、IActualLayout.ActualWidth、IActualLayout.ActualHeight）と実際の軸値（IAxis.ActualMaxValue、IAxis.ActualMinValue、IAxis.ActualMajorUnit、IAxis.ActualMinorUnit、IAxis.ActualMajorUnitScale、IAxis.ActualMinorUnitScale）が含まれます。
...
チャート領域に角丸を付けるかどうかを指定します。読み取り/書き込み boolean.
