...
description: 変換することを目的としたメソッドのグループを表します。
type: docs
...
| メソッド | 説明 |
| --- | --- |
| [autoByExtension(String presPath, String outPath)](#autoByExtension-java.lang.String-java.lang.String-) | 渡された出力パスの拡張子を使用して [Presentation](../../com.aspose.slides/presentation) を変換し、必要なエクスポート形式を決定します。 |
...
| [toJpeg(Presentation pres, String outputFileName, Dimension imageSize)](#toJpeg-com.aspose.slides.Presentation-java.lang.String-java.awt.Dimension-) | 入力プレゼンテーションを JPEG 形式の画像セットに変換します。 |
...
| [toPng(Presentation pres, String outputFileName, Dimension imageSize)](#toPng-com.aspose.slides.Presentation-java.lang.String-java.awt.Dimension-) | 入力プレゼンテーションを PNG 形式の画像セットに変換します。 |
...
渡された出力パスの拡張子を使用して [Presentation](../../com.aspose.slides/presentation) を変換し、必要なエクスポート形式を決定します。
...
入力プレゼンテーションを JPEG 形式の画像セットに変換します。出力ファイル名を "myPath/myFilename.jpeg" と指定した場合、結果は "myPath/myFilename\_N.jpeg" という名前のファイルセットとして保存され、N はスライド番号です。
...
| pres | [Presentation](../../com.aspose.slides/presentation) | 入力プレゼンテーション |
| outputFileName | java.lang.String | 出力ファイル名 |
| imageSize | java.awt.Dimension | 生成される各画像のサイズ |
...
入力プレゼンテーションを PNG 形式の画像セットに変換します。出力ファイル名を "myPath/myFilename.png" と指定した場合、結果は "myPath/myFilename\_N.png" という名前のファイルセットとして保存され、N はスライド番号です。
...
入力プレゼンテーションを TIFF 形式の画像セットに変換します。出力ファイル名を "myPath/myFilename.tiff" と指定した場合、結果は "myPath/myFilename\_N.tiff" という名前のファイルセットとして保存され、N はスライド番号です。
...
カスタムオプションで入力プレゼンテーションを TIFF 形式に変換します。出力ファイル名を "myPath/myFilename.tiff" とし、multipage が false の場合、結果は "myPath/myFilename\_N.tiff" という名前のファイルセットとして保存され、N はスライド番号です。multipage が true の場合、結果は単一のマルチページ TIFF ドキュメント "myPath/myFilename.tiff" となります。
...
| multipage | boolean | 生成される TIFF ドキュメントがマルチページであるかどうかを指定します。 |