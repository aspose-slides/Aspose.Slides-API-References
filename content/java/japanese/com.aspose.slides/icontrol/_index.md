...
| [getSubstitutePictureFormat()](#getSubstitutePictureFormat--) | ControlEx 画像塗りつぶしプロパティオブジェクトを返します。 |
...
| [getActiveXControlBinary()](#getActiveXControlBinary--) | PersistStream、PersistStreamInit、または PersistStorage のいずれかの永続化方法が使用される場合の ActiveX コントロールの永続性を指定します。 |
### getName() {#getName--}
```
...
ControlEx 画像塗りつぶしプロパティオブジェクトを返します。読み取り専用 [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat)。
...
PersistStream、PersistStreamInit、または PersistStorage のいずれかの永続化方法が使用される場合の ActiveX コントロールの永続性を指定します。
