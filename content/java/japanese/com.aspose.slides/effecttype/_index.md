...
description: アニメーション効果のタイプを表します。
type: docs
url: /ja/com.aspose.slides/effecttype/
---
**継承:**  
...
Appear エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
CurveUpDown エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Ascend エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Float エフェクト（方向 Up）。これは Ascend のエイリアスです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Blinds エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
...
BoldFlash エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
BoldReveal エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
Boomerang エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Bounce エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Box エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.In
*  EffectSubtype.Out
...
BrushOnColor エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
BrushOnUnderline エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
CenterRevolve エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
ChangeFillColor エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
...
ChangeFont エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.Instant
*  EffectSubtype.Gradual
...
ChangeFontColor エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.Instant
*  EffectSubtype.Gradual
*  EffectSubtype.GradualAndCycleClockwise
...
ChangeFontSize エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.Instant
*  EffectSubtype.Gradual
...
ChangeLineColor エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.Instant
*  EffectSubtype.Gradual
*  EffectSubtype.GradualAndCycleClockwise
...
Checkerboard エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.Vertical
...
ColorBlend エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.In
*  EffectSubtype.Out
...
ColorWave エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
ComplementaryColor エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
ComplementaryColor2 エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
Compress エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
ContrastingColor エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
Crawl エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.Right
*  EffectSubtype.Left
*  EffectSubtype.Top
...
Credits エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Desaturate エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
Descend エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Float エフェクト（方向 Down）。これは Descend のエイリアスです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Diamond エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.In
*  EffectSubtype.Out
...
Dissolve エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Expand エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Fade エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
FadedSwivel エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
FadedZoom エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
FlashBulb エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
FlashOnce エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Flip エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Float エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Fly エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.Right
*  EffectSubtype.Left
*  EffectSubtype.Top
...
Fold エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Glide エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
GrowAndTurn エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
GrowShrink エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
GrowWithColor エフェクトです。クラス **Emphasis**。
有効なサブタイプ:
*  EffectSubtype.None
...
LightSpeed エフェクトです。クラス **Entrance** または **Exit**。
有効なサブタイプ:
*  EffectSubtype.None
...
Path4PointStar エフェクトです。クラス **Path**。
有効なサブタイプ:
*  EffectSubtype.None
...
Path5PointStar エフェクトです。クラス **Path**。
有効なサブタイプ:
*  EffectSubtype.None
...
Path6PointStar エフェクトです。クラス **Path**。
有効なサブタイプ:
*  EffectSubtype.None
...
Path8PointStar エフェクトです。クラス **Path**。
有効なサブタイプ:
*  EffectSubtype.None
...
PathBounceRight エフェクト。クラス **Path**。
...
PathCrescentMoon エフェクト。クラス **Path**。
...
PathCurvedSquare エフェクト。クラス **Path**。
...
PathDecayingWave エフェクト。クラス **Path**。
...
PathDiagonalDownRight エフェクト。クラス **Path**。
...
PathDiagonalUpRight エフェクト。クラス **Path**。
...
PathEqualTriangle エフェクト。クラス **Path**。
...
PathFigure8Four エフェクト。クラス **Path**。
...
PathHorizontalFigure8 エフェクト。クラス **Path**。
...
PathInvertedSquare エフェクト。クラス **Path**。
...
PathInvertedTriangle エフェクト。クラス **Path**。
...
PathParallelogram エフェクト。クラス **Path**。
...
PathRightTriangle エフェクト。クラス **Path**。
...
PathSpiralRight エフェクト。クラス **Path**。
...
PathTurnUpRight エフェクト。クラス **Path**。
...
PathVerticalFigure8 エフェクト。クラス **Path**。
...
Peek エフェクト。クラス **Entrance** または **Exit**。
...
Pinwheel エフェクト。クラス **Entrance** または **Exit**。
...
Plus エフェクト。クラス **Entrance** または **Exit**。
...
RandomBars エフェクト。クラス **Entrance** または **Exit**。
...
RandomEffects エフェクト。クラス **Entrance** または **Exit**。
...
RandomEffects エフェクト。クラス **Entrance**。
...
Spiral エフェクト。クラス **Entrance** または **Exit**。
...
Split エフェクト。クラス **Entrance** または **Exit**。
...
Stretch エフェクト。クラス **Entrance** または **Exit**。
...
StyleEmphasis エフェクト。クラス **Emphasis**。
...
Swish エフェクト。クラス **Entrance** または **Exit**。
...
Swivel エフェクト。クラス **Entrance** または **Exit**。
...
Transparency エフェクト。クラス **Emphasis**。
...
Unfold エフェクト。クラス **Entrance** または **Exit**。
...
VerticalGrow エフェクト。クラス **Emphasis**。
...
Wedge エフェクト。クラス **Entrance** または **Exit**。
...
Whip エフェクト。クラス **Entrance** または **Exit**。
...
Magnify エフェクト。クラス **Entrance** または **Exit**。
...
Zoom エフェクト。クラス **Entrance** または **Exit**。
...
OLEObjectShow エフェクト。クラス **OLEActionVerbs**。
...
OLEObjectEdit の効果です。クラス **OLEActionVerbs**。
...
OLEObjectOpen の効果です。クラス **OLEActionVerbs**。
