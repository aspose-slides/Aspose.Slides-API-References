...
description: アニメーションの振る舞いのプロパティタイプを表します。
type: docs
...
アニメーション 動作のプロパティタイプを表します。 https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx と https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx のプロパティ一覧に従います。
## メソッド

| メソッド | 説明 |
| --- | --- |
| [getValue()](#getValue--) | プロパティの値 |
| [isCustom()](#isCustom--) | このプロパティが仕様の事前定義されたプロパティリストに属さないかを示します: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx |
...
| [equals(Object obj)](#equals-java.lang.Object-) | このオブジェクトが別のオブジェクトと等しいかどうかをチェックします。 |
| [hashCode()](#hashCode--) | (\#getValue.getValue) プロパティに基づいてハッシュコードを計算し、返します |
| [getOrCreateByValue(String propertyValue)](#getOrCreateByValue-java.lang.String-) | 値で既存のビヘイビアプロパティを検索するか、指定された値で新しいカスタムプロパティを作成します |
### getValue() {#getValue--}
```
...
このプロパティが仕様の事前定義されたプロパティリストに属さないかを示します: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx
...
(\#getValue.getValue) プロパティに基づいてハッシュコードを計算し、返します
...
指定された値で、既存の behavior プロパティを検索するか、新しいカスタムプロパティを作成します
