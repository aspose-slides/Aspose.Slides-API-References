...
description: ベースと、ベースの右側に配置された下付き文字と上付き文字で構成されるサブ・スーパー添字オブジェクトを指定します。
type: docs
...
基底と、基底の右側に配置された下付き文字と上付き文字で構成されるサブ・スーパー添字オブジェクトを指定します。
...
| メソッド | 説明 |
| --- | --- |
| [getSubscript()](#getSubscript--) | 下付き文字の引数 |
| [getSuperscript()](#getSuperscript--) | 上付き文字の引数 |
...
下付き文字/上付き文字の配置を指定します。true の場合、下付き文字と上付き文字は水平方向に揃えられます。false の場合、基底の形状に合わせて字間調整されます。デフォルト値は false です。
