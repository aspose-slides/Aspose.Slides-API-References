...
| [indexOf(IChartSeries value)](#indexOf-com.aspose.slides.IChartSeries-) | Ищет указанный [ChartSeries](../../com.aspose.slides/chartseries) и возвращает нулевой индекс первого вхождения во всей коллекции |
| [remove(IChartSeries value)](#remove-com.aspose.slides.IChartSeries-) | Удаляет указанное значение. |
| [removeAt(int index)](#removeAt-int-) | Удаляет ActiveX-контроль, хранящийся в указанной позиции, из коллекции. |
...
**Возвращаемое значение:**
[IChartSeries](../../com.aspose.slides/ichartseries) - Добавленная серия диаграммы или уже существующая в коллекции.
...
Ищет указанный [ChartSeries](../../com.aspose.slides/chartseries) и возвращает нулевой индекс первого вхождения во всей коллекции
...
**Возвращаемое значение:**
int - Нулевой индекс первого вхождения value во всей CollectionBase, если найден; иначе -1.
...
Удаляет ActiveX-контроль, хранящийся в указанной позиции, из коллекции.

**Параметры:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| index | int | Индекс элемента управления, подлежащего удалению. |
