...
| [getChartData()](#getChartData--) | Возвращает информацию о связанном или встраиваемом наборе данных, связанном с диаграммой. |
...
| [getShowDataLabelsOverMaximum()](#getShowDataLabelsOverMaximum--) | Указывает, должна ли отображаться подпись данных над максимумом диаграммы. |
| [setShowDataLabelsOverMaximum(boolean value)](#setShowDataLabelsOverMaximum-boolean-) | Указывает, должна ли отображаться подпись данных над максимумом диаграммы. |
| [hasRoundedCorners()](#hasRoundedCorners--) | Указывает, должна ли область диаграммы иметь закруглённые уголки. |
| [setRoundedCorners(boolean value)](#setRoundedCorners-boolean-) | Указывает, должна ли область диаграммы иметь закруглённые уголки. |
| [getChart()](#getChart--) |  |
...
Определяет, отображаются ли только видимые ячейки. False — для отображения как видимых, так и скрытых ячеек. Чтение/запись boolean.
...
Возвращает информацию о связанном или встраиваемом наборе данных, связанном с диаграммой. Только для чтения [IChartData](../../com.aspose.slides/ichartdata).
...
Возвращает текстовый формат диаграммы. Свойство не применяется к следующим типам: [ChartType.Treemap](../../com.aspose.slides/charttype\#Treemap), [ChartType.Sunburst](../../com.aspose.slides/charttype\#Sunburst), [ChartType.Waterfall](../../com.aspose.slides/charttype\#Waterfall), [ChartType.Histogram](../../com.aspose.slides/charttype\#Histogram), [ChartType.Funnel](../../com.aspose.slides/charttype\#Funnel),[ChartType.BoxAndWhisker](../../com.aspose.slides/charttype\#BoxAndWhisker). Только для чтения [IChartTextFormat](../../com.aspose.slides/icharttextformat).
...
Указывает, должна ли отображаться подпись данных над максимумом диаграммы. Чтение/запись boolean.
...
Указывает, должна ли область диаграммы иметь закруглённые уголки. Чтение/запись boolean.
