...
| [setMacroHyperlinkClick(String macroName)](#setMacroHyperlinkClick-java.lang.String-) | Устанавливает макросную гиперссылку при щелчке. |
...
>      // Преобразует форму к типу AutoShape
...
Устанавливает макросную гиперссылку при щелчке.
...
**Возвращаемое значение:**
[IHyperlink](../../com.aspose.slides/ihyperlink) - Hyperlink объект [IHyperlink](../../com.aspose.slides/ihyperlink)
### getParent_Immediate() {#getParent-Immediate--}
```
