...
| [getGroupingLevelCount()](#getGroupingLevelCount--) | Возвращает количество используемых уровней группировки категорий. |
...
| [indexOf(IChartCategory value)](#indexOf-com.aspose.slides.IChartCategory-) | Ищет указанный [IChartCategory](../../com.aspose.slides/ichartcategory) и возвращает нулевой индекс первого вхождения во всю коллекцию |
...
Если true, то лист используется для хранения категорий (в этом случае поддерживаются многоуровневые категории). Если false, то лист НЕ используется для хранения значений (и этот случай не поддерживает многоуровневые категории). Чтение/запись boolean.
...
Возвращает количество используемых уровней группировки категорий. Больше одного для многоуровневых категорий. Только чтение int.
...
--------------------
Этот метод добавляет лист с именем AUTO_DATA и добавляет туда все значения. Если вы используете [IChartDataWorkbook](../../com.aspose.slides/ichartdataworkbook) для добавления или редактирования значений ячеек, убедитесь, что вы не используете этот лист. Максимальное количество значений, добавляемых с помощью этого метода, не должно превышать 16711680 |

**Возвращаемое значение:**
[IChartCategory](../../com.aspose.slides/ichartcategory) - Добавлено [IChartCategory](../../com.aspose.slides/ichartcategory).
...
Ищет указанный [IChartCategory](../../com.aspose.slides/ichartcategory) и возвращает нулевой индекс первого вхождения во всю коллекцию
...
**Возвращаемое значение:**
int - Нулевой индекс первого вхождения значения во всю CollectionBase, если найдено; иначе -1.
