...
description: Представляет эффект мягкой границы.
type: docs
url: /ru/com.aspose.slides/isoftedge/
---
...
Представляет эффект мягкой границы. Края фигуры размыты, в то время как заливка не затронута.
## Методы
