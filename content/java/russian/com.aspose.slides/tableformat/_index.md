...
>  Обратите внимание, что форматирование ячейки всегда имеет более высокий приоритет, чем форматирование строки, строка — выше, чем столбец, столбец — выше, чем вся таблица.
>  Таким образом, свойства CellFormatEffectiveData в конечном итоге всегда используются для отрисовки таблицы. Следующий код — лишь пример использования API.
>  
