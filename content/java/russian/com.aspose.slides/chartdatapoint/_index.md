...
| [getErrorBarsCustomValues()](#getErrorBarsCustomValues--) | Представляет значения полос ошибок серии в случае типа значения Custom. |
| [getLabel()](#getLabel--) | Label. |
| [isBubble3D()](#isBubble3D--) | Указывает, что пузырьки имеют применённый 3-D эффект. |
| [setBubble3D(boolean value)](#setBubble3D-boolean-) | Указывает, что пузырьки имеют применённый 3-D эффект. |
| [getExplosion()](#getExplosion--) | Указывает количество, на которое точка данных должна быть смещена от центра пирога. |
| [setExplosion(int value)](#setExplosion-int-) | Указывает количество, на которое точка данных должна быть смещена от центра пирога. |
...
| [getSetAsTotal()](#getSetAsTotal--) | Устанавливает точку данных как итог. |
| [setSetAsTotal(boolean value)](#setSetAsTotal-boolean-) | Устанавливает точку данных как итог. |
...
Возвращает значение размера точки данных диаграммы. Используется с диаграммами Treemap и Sunburst. Только для чтения [IDoubleChartValue](../../com.aspose.slides/idoublechartvalue).
...
Представляет значения полос ошибок серии в случае типа значения Custom. Только для чтения [IErrorBarsCustomValues](../../com.aspose.slides/ierrorbarscustomvalues).
...
Указывает, что пузырьки имеют применённый 3-D эффект. Чтение/запись boolean.
...
Указывает количество, на которое точка данных должна быть смещена от центра пирога. Чтение/запись int.
...
Устанавливает точку данных как итог. Применяется только для типа серии Waterfall.
