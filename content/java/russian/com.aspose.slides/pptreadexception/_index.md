...
type: docs
url: /ru/com.aspose.slides/pptreadexception/
---
**Наследование:**
...
| --- | --- |
| [PptReadException()](#PptReadException--) | Конструктор по умолчанию. |
| [PptReadException(String message)](#PptReadException-java.lang.String-) | Конструктор, позволяющий добавить сообщение к этому исключению. |
| [PptReadException(String message, Exception exception)](#PptReadException-java.lang.String-java.lang.Exception-) | Конструктор исключения, содержащего сообщение и вложенное исключение. |
...
Конструктор исключения, содержащего сообщение и вложенное исключение.
