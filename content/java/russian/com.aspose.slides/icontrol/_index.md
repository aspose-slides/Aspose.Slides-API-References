...
Представляет ActiveX-элемент управления.
## Методы
...
| [getFrame()](#getFrame--) | Возвращает или задает рамку элемента управления. |
| [setFrame(IShapeFrame value)](#setFrame-com.aspose.slides.IShapeFrame-) | Возвращает или задает рамку элемента управления. |
...
| [getActiveXControlBinary()](#getActiveXControlBinary--) | Указывает, как сохраняется ActiveX-элемент управления, когда используемый метод сохранения — PersistStream, PersistStreamInit или PersistStorage. |
### getName() {#getName--}
```
...
Возвращает или задает рамку элемента управления. Чтение/запись [IShapeFrame](../../com.aspose.slides/ishapeframe).
...
Указывает, как сохраняется ActiveX-элемент управления, когда используемый метод сохранения — PersistStream, PersistStreamInit или PersistStorage.
