...
| [getEffective()](#getEffective--) | Получает данные эффективного эффекта предустановленной тени с применённым наследованием. |
...
Получает данные эффективного эффекта предустановленной тени с применённым наследованием.

**Возвращаемое значение:**
[IPresetShadowEffectiveData](../../com.aspose.slides/ipresetshadoweffectivedata) - объект [IPresetShadowEffectiveData](../../com.aspose.slides/ipresetshadoweffectivedata).
### getParent_Immediate() {#getParent-Immediate--}
```
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| obj | java.lang.Object | Объект [PresetShadow](../../com.aspose.slides/presetshadow) для сравнения. |
