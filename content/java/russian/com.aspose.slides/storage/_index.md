...
TValue - Значение данных, если оно присутствует в коллекции данных, иначе null.
...
**Возвращаемое значение:**
boolean - True, если хранилище содержит элемент с указанным ключом, false в противном случае.