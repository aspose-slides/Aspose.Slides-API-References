...
| Method | Description |
| --- | --- |
| [getPortionFormat()](#getPortionFormat--) | Возвращает объект форматирования, содержащий явно установленные свойства форматирования части текста без применения наследования. |
...
Возвращает объект форматирования, содержащий явно установленные свойства форматирования части текста без применения наследования. Только для чтения [IPortionFormat](../../com.aspose.slides/iportionformat).
...
**Возвращаемое значение:**
java.awt.geom.Rectangle2D.Float - Прямоугольник, ограничивающий часть java.awt.geom.Rectangle2D.Float
...
**Возвращаемое значение:**
java.awt.geom.Point2D.Float - Координаты начала части java.awt.geom.Point2D.Float