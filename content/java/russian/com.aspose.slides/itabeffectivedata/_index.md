...
Возвращает позицию табуляции. Присвоение этого свойства может изменить индекс табуляции в коллекции и сделать недействительным Enumerator. Только для чтения double.
