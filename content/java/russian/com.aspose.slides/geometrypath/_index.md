...
| [removeAt(int index)](#removeAt-int-) | Удаляет сегмент по указанному индексу геометрического пути. |
...
| [arcTo(float width, float heigth, float startAngle, float sweepAngle)](#arcTo-float-float-float-float-) | Добавляет указанный дугу к пути. |
| [getFillMode()](#getFillMode--) | Устанавливает режим заливки |
| [setFillMode(byte value)](#setFillMode-byte-) | Устанавливает режим заливки |
| [getStroke()](#getStroke--) | Устанавливает внешний вид обводки |
| [setStroke(boolean value)](#setStroke-boolean-) | Устанавливает внешний вид обводки |
...
Добавляет указанный дугу к пути.
