...
| [getDisplayBlanksAs()](#getDisplayBlanksAs--) | Возвращает или устанавливает способ отображения пустых ячеек на диаграмме. |
| [setDisplayBlanksAs(int value)](#setDisplayBlanksAs-int-) | Возвращает или устанавливает способ отображения пустых ячеек на диаграмме. |
...
| [getChartTitle()](#getChartTitle--) | Возвращает или устанавливает заголовок диаграммы. Только для чтения [IChartTitle](../../com.aspose.slides/icharttitle). |
...
| [getLegend()](#getLegend--) | Возвращает или устанавливает легенду для диаграммы. |
| [getChartDataTable()](#getChartDataTable--) | Возвращает таблицу данных диаграммы. |
| [getStyle()](#getStyle--) | Возвращает или устанавливает стиль диаграммы. |
| [setStyle(int value)](#setStyle-int-) | Возвращает или устанавливает стиль диаграммы. |
| [getType()](#getType--) | Возвращает или устанавливает тип диаграммы. |
| [setType(int value)](#setType-int-) | Возвращает или устанавливает тип диаграммы. |
...
| [getBackWall()](#getBackWall--) | Возвращает объект, позволяющий изменить формат задней стены 3D-диаграммы. |
| [getSideWall()](#getSideWall--) | Возвращает объект, позволяющий изменить формат боковой стены 3D-диаграммы. |
| [getFloor()](#getFloor--) | Возвращает объект, позволяющий изменить формат пола 3D-диаграммы. |
| [getUserShapes()](#getUserShapes--) | Указывает фигуры, рисуемые поверх диаграммы. |
| [getAxes()](#getAxes--) | Предоставляет доступ к осям диаграммы. |
| [validateChartLayout()](#validateChartLayout--) | Вычисляет фактические значения элементов диаграммы. |
| [getShowDataLabelsOverMaximum()](#getShowDataLabelsOverMaximum--) | Указывает, следует ли показывать подписи данных выше максимального значения диаграммы. |
| [setShowDataLabelsOverMaximum(boolean value)](#setShowDataLabelsOverMaximum-boolean-) | Указывает, следует ли показывать подписи данных выше максимального значения диаграммы. |
...
Возвращает или устанавливает способ отображения пустых ячеек на диаграмме. Чтение/запись [DisplayBlanksAsType](../../com.aspose.slides/displayblanksastype).
...
Возвращает или устанавливает заголовок диаграммы. Только для чтения [IChartTitle](../../com.aspose.slides/icharttitle).
...
Возвращает или устанавливает легенду для диаграммы. Только для чтения [ILegend](../../com.aspose.slides/ilegend).
...
Возвращает или устанавливает стиль диаграммы. Чтение/запись [StyleType](../../com.aspose.slides/styletype).
...
Возвращает или устанавливает тип диаграммы. Чтение/запись [ChartType](../../com.aspose.slides/charttype).
...
Возвращает объект, позволяющий изменить формат задней стены 3D-диаграммы. Только для чтения [IChartWall](../../com.aspose.slides/ichartwall).
...
Возвращает объект, позволяющий изменить формат боковой стены 3D-диаграммы. Только для чтения [IChartWall](../../com.aspose.slides/ichartwall).
...
Возвращает объект, позволяющий изменить формат пола 3D-диаграммы. Только для чтения [IChartWall](../../com.aspose.slides/ichartwall).
...
Указывает фигуры, рисуемые поверх диаграммы. Только для чтения [IGroupShape](../../com.aspose.slides/igroupshape).
...
Предоставляет доступ к осям диаграммы. Только для чтения [IAxesManager](../../com.aspose.slides/iaxesmanager).
...
Вычисляет фактические значения элементов диаграммы. Фактические значения включают позицию элементов, реализующих интерфейс IActualLayout (IActualLayout.ActualX, IActualLayout.ActualY, IActualLayout.ActualWidth, IActualLayout.ActualHeight) и реальные значения осей (IAxis.ActualMaxValue, IAxis.ActualMinValue, IAxis.ActualMajorUnit, IAxis.ActualMinorUnit, IAxis.ActualMajorUnitScale, IAxis.ActualMinorUnitScale)
### getShowDataLabelsOverMaximum() {#getShowDataLabelsOverMaximum--}
```
public abstract boolean getShowDataLabelsOverMaximum()
```

Указывает, следует ли показывать подписи данных выше максимального значения диаграммы. Чтение/запись boolean.
