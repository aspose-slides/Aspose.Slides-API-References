...
Возвращает коллекцию направляющих черчения. Только чтение [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
...
>      // Добавление новой вертикальной направляющей к правой стороне центра слайда
>      guides.add(Orientation.Vertical, (float)(slideSize.getWidth()) / 2 + 12.5f);
>      // Добавление новой горизонтальной направляющей под центр слайда
