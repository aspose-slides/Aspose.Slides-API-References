...
Определяет символ группировки над или под выражением, обычно для подсветки взаимосвязи между элементами
...
| --- | --- |
| [MathGroupingCharacter(IMathElement element)](#MathGroupingCharacter-com.aspose.slides.IMathElement-) | Инициализирует новый экземпляр класса MathGroupingCharacter со значением символа группировки по умолчанию U+23DF (BOTTOM CURLY BRACKET) |
...
| [getVerticalJustification()](#getVerticalJustification--) | Вертикальное выравнивание символа группы. |
| [setVerticalJustification(int value)](#setVerticalJustification-int-) | Вертикальное выравнивание символа группы. |
...
Инициализирует новый экземпляр класса MathGroupingCharacter со значением символа группировки по умолчанию U+23DF (BOTTOM CURLY BRACKET)
...
| --- | --- | --- |
| element | [IMathElement](../../com.aspose.slides/imathelement) | Базовый элемент, к которому применяется штрих |
...
| verticalJustification | int | Вертикальное выравнивание символа группы |
...
Вертикальное выравнивание символа группы. Указывает выравнивание объекта относительно базовой линии. Например, когда символ группы находится над объектом, вертикальное выравнивание Top означает, что верх объекта находится на базовой линии; когда вертикальное выравнивание установлено в Bottom, нижняя часть объекта находится на базовой линии. По умолчанию: Bottom для Position=Top и Top для Position=Bottom
