...
| [getImage()](#getImage--) | Возвращает или устанавливает встроенное изображение. |
| [setImage(IPPImage value)](#setImage-com.aspose.slides.IPPImage-) | Возвращает или устанавливает встроенное изображение. |
| [getLinkPathLong()](#getLinkPathLong--) | Возвращает или устанавливает URL связанного изображения. |
| [setLinkPathLong(String value)](#setLinkPathLong-java.lang.String-) | Возвращает или устанавливает URL связанного изображения. |
...
Возвращает или устанавливает встроенное изображение. Чтение/запись [IPPImage](../../com.aspose.slides/ippimage).
...
Возвращает или устанавливает URL связанного изображения. Чтение/запись String.
