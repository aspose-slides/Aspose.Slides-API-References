...
description: Определяет функцию акцента, состоящую из базовой части и комбинирующего диакритического знака. Пример ud835udc4eu0301
type: docs
...
Определяет функцию акцента, состоящую из базовой части и комбинирующего диакритического знака Пример: \\ud835\\udc4e\\u0301
...
| Метод | Описание |
| --- | --- |
| [getBase()](#getBase--) | Аргумент, к которому применён акцент |
