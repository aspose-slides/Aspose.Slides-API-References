...
description: Представляет коллекцию только для чтения
type: docs
url: /ru/com.aspose.slides/ichartseriesreadonlycollection/
---
...
Представляет коллекцию только для чтения [IChartSeries](../../com.aspose.slides/ichartseries)
## Методы
