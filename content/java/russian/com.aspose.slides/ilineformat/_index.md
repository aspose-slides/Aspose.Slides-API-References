...
| [getCapStyle()](#getCapStyle--) | Возвращает или задаёт стиль конца линии. |
| [setCapStyle(byte value)](#setCapStyle-byte-) | Возвращает или задаёт стиль конца линии. |
...
Возвращает или задаёт стиль конца линии. Чтение/запись [LineCapStyle](../../com.aspose.slides/linecapstyle).
