...
| [add(String path, IAudio audio)](#add-java.lang.String-com.aspose.slides.IAudio-) | Добавляет выходной элемент для аудио. |
...
| [getResourcePath(Object obj)](#getResourcePath-java.lang.Object-) | Возвращает путь для заданного ресурса. |
...
Добавляет выходной элемент для аудио.
...
Возвращает путь для заданного ресурса.
