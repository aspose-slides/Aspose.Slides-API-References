...
type: docs
url: /ru/com.aspose.slides/invalidpasswordexception/
---
**Наследование:**
...
| --- | --- |
| [InvalidPasswordException()](#InvalidPasswordException--) | Конструктор по умолчанию. |
| [InvalidPasswordException(String message)](#InvalidPasswordException-java.lang.String-) | Конструктор, позволяющий добавить сообщение к этому исключению. |
| [InvalidPasswordException(String message, RuntimeException exception)](#InvalidPasswordException-java.lang.String-java.lang.RuntimeException-) | Конструктор для исключения, содержащего сообщение и вложенное исключение. |
