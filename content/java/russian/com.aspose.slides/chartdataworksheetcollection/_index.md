...
Представляет коллекцию листов рабочего листа данных диаграммы.
...
**Возвращаемое значение:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IChartDataWorksheet> - IGenericEnumerator, который можно использовать для обхода коллекции.
### iterator() {#iterator--}
```
...
| arrayIndex | int | Индекс, с которого начинать копирование. |
