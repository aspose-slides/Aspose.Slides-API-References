...
description: Предоставляет параметры, позволяющие управлять сохранением презентации в формате TIFF.
type: docs
...
| Метод | Описание |
| --- | --- |
| [getInkOptions()](#getInkOptions--) | Предоставляет параметры, которые управляют видом объектов Ink в экспортируемом документе. |
| [getShowHiddenSlides()](#getShowHiddenSlides--) | Указывает, должно ли сгенерированный документ включать скрытые слайды или нет. |
| [setShowHiddenSlides(boolean value)](#setShowHiddenSlides-boolean-) | Указывает, должно ли сгенерированный документ включать скрытые слайды или нет. |
| [getImageSize()](#getImageSize--) | Указывает размер сгенерированного изображения TIFF. |
| [setImageSize(Dimension value)](#setImageSize-java.awt.Dimension-) | Указывает размер сгенерированного изображения TIFF. |
...
| [getPixelFormat()](#getPixelFormat--) | Указывает формат пикселей для сгенерированных изображений. |
| [setPixelFormat(int value)](#setPixelFormat-int-) | Указывает формат пикселей для сгенерированных изображений. |
...
Предоставляет параметры, которые управляют видом объектов Ink в экспортируемом документе. Только для чтения [IInkOptions](../../com.aspose.slides/iinkoptions)
...
Указывает, должно ли сгенерированный документ включать скрытые слайды или нет. По умолчанию false.
...
Указывает размер сгенерированного изображения TIFF. Значение по умолчанию 0x0, что означает, что размеры сгенерированного изображения будут вычислены на основе размера слайда презентации. Чтение/запись java.awt.Dimension.
...
Указывает формат пикселей для сгенерированных изображений. Чтение/запись [ImagePixelFormat](../../com.aspose.slides/imagepixelformat).
...
Указывает алгоритм преобразования цветного изображения в черно-белое. Эта опция будет применяться только если CompressionType (\#getCompressionType.getCompressionType/\#setCompressionType(int).setCompressionType(int)) установлен в [TiffCompressionTypes.CCITT4](../../com.aspose.slides/tiffcompressiontypes\#CCITT4) или [TiffCompressionTypes.CCITT3](../../com.aspose.slides/tiffcompressiontypes\#CCITT3) Чтение/запись [BlackWhiteConversionMode](../../com.aspose.slides/blackwhiteconversionmode). По умолчанию [BlackWhiteConversionMode.Default](../../com.aspose.slides/blackwhiteconversionmode\#Default).
