...
description: Событие указывает, что была сгенерирована новая анимация.
type: docs
url: /ru/com.aspose.slides/presentationanimationsgenerator.newanimation/
---```
public static interface PresentationAnimationsGenerator.NewAnimation
```

Событие указывает, что была сгенерирована новая анимация.
## Методы
