...
| Метод | Описание |
| --- | --- |
| [createMathAccent(IMathElement element)](#createMathAccent-com.aspose.slides.IMathElement-) | Создает математический акцент, применяемый к указанному математическому элементу, используя значение символа акцента по умолчанию |
