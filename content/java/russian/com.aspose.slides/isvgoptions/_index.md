...
| [getDisableLineEndCropping()](#getDisableLineEndCropping--) | В SVG 1.1 нет возможности задавать отступы для маркеров. |
| [setDisableLineEndCropping(boolean value)](#setDisableLineEndCropping-boolean-) | В SVG 1.1 нет возможности задавать отступы для маркеров. |
...
| [getShapeFormattingController()](#getShapeFormattingController--) | Возвращает и задаёт интерфейс обратного вызова, позволяющий управлять конвертацией фигур. |
| [setShapeFormattingController(ISvgShapeFormattingController value)](#setShapeFormattingController-com.aspose.slides.ISvgShapeFormattingController-) | Возвращает и задаёт интерфейс обратного вызова, позволяющий управлять конвертацией фигур. |
...
| [getUseFrameRotation()](#getUseFrameRotation--) | Определяет, следует ли выполнять указанное вращение фигуры при рендеринге. |
| [setUseFrameRotation(boolean value)](#setUseFrameRotation-boolean-) | Определяет, следует ли выполнять указанное вращение фигуры при рендеринге. |
...
| [getInkOptions()](#getInkOptions--) | Предоставляет параметры, контролирующие внешний вид Ink-объектов в экспортируемом документе. |
| [getDisableFontLigatures()](#getDisableFontLigatures--) | Получает или задаёт значение, указывающее, будет ли текст отображаться без лигатур. |
| [setDisableFontLigatures(boolean value)](#setDisableFontLigatures-boolean-) | Получает или задаёт значение, указывающее, будет ли текст отображаться без лигатур. |
...
В SVG 1.1 нет возможности задавать отступы для маркеров. Движок записи SVG Aspose.Slides имеет обходное решение: он обрезает конец линии со стрелкой, чтобы линия не перекрывала маркеры. Эта опция отключает такое поведение. Чтение/запись boolean.
...
Возвращает и задаёт интерфейс обратного вызова, позволяющий управлять конвертацией фигур. Чтение/запись [ISvgShapeFormattingController](../../com.aspose.slides/isvgshapeformattingcontroller).
...
Булевый флаг, указывающий, остаются ли обрезанные части частью документа. Если true, обрезанные части будут удалены; если false, они будут сериализованы в документе (что может привести к увеличению размера файла). Чтение/запись boolean.
...
Определяет, следует ли выполнять указанное вращение фигуры при рендеринге. Чтение/запись boolean. Значение по умолчанию — true.
...
Предоставляет параметры, контролирующие внешний вид Ink-объектов в экспортируемом документе. Только для чтения [IInkOptions](../../com.aspose.slides/iinkoptions)
...
Получает или задаёт значение, указывающее, будет ли текст отображаться без лигатур. При установке в true лигатуры будут отключены в выводе. По умолчанию свойство равно false.
