...
| [isSynchronized()](#isSynchronized--) | Возвращает значение, указывающее, синхронизирован ли доступ к коллекции (безопасен для потоков). |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| xmlString | java.lang.String | XML-строка новой части, которая будет добавлена. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| xmlData | byte[] | XML-данные новой части, которые будут добавлены. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| inputStream | java.io.InputStream | InputStream с XML-данными новой части, которая будет добавлена. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| index | int | Нулевой индекс элемента для удаления. |
...
| index | int | Индекс, с которого начинать копирование. |
...
**Возвращаемое значение:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICustomXmlPart> - Перечислитель, который можно использовать для обхода коллекции.
...
**Возвращаемое значение:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICustomXmlPart> - java.util.Iterator для всей коллекции.
