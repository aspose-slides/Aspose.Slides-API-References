...
| [getCount()](#getCount--) | Возвращает количество всех элементов в коллекции. |
...
| methodType | int | Метод назначения для метки чувствительности. |
...
Возвращает количество всех элементов в коллекции. Только для чтения int .
