...
description: Представляет исключение, генерируемое при обнаружении ошибки редактирования презентации.
type: docs
url: /ru/com.aspose.slides/ppteditexception/
---
**Наследование:**
...
Представляет исключение, генерируемое при обнаружении ошибки редактирования презентации.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [PptEditException()](#PptEditException--) | Конструктор по умолчанию. |
| [PptEditException(String message)](#PptEditException-java.lang.String-) | Конструктор, позволяющий добавить сообщение к этому исключению. |
| [PptEditException(String message, RuntimeException exception)](#PptEditException-java.lang.String-java.lang.RuntimeException-) | Конструктор для исключения, содержащего сообщение и вложенное исключение. |
