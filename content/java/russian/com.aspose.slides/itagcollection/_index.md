...
| [getNameByIndex(int index)](#getNameByIndex-int-) | Возвращает имя тега по указанному индексу. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| name | java.lang.String | Имя тега для удаления. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| name | java.lang.String | Имя, которое нужно найти в коллекции. |
...
Возвращает имя тега по указанному индексу.
