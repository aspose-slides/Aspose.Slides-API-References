...
| [getDrawingGuides()](#getDrawingGuides--) | Возвращает коллекцию направляющих рисования для главного слайда раздаточного материала. |
...
Возвращает коллекцию направляющих рисования для главного слайда раздаточного материала. Только для чтения [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
...
>      // Добавление новой горизонтальной направляющей рисунка над центром слайда
