...
| slide | [ISlide](../../com.aspose.slides/islide) | Слайд в презентации, в который будет добавлен новый комментарий. |
| position | java.awt.geom.Point2D.Float | Позиция на слайде, где будет добавлен новый комментарий. |
...
| slide | [ISlide](../../com.aspose.slides/islide) | Слайд в презентации, в который будет добавлен новый современный комментарий. |
| shape | [IShape](../../com.aspose.slides/ishape) | Фигура на слайде, к которой будет привязан новый современный комментарий. |
| position | java.awt.geom.Point2D.Float | Позиция на слайде, где будет добавлен новый современный комментарий. |
...
**Возвращаемое значение:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IComment> - IGenericEnumerator, который можно использовать для перебора коллекции.
