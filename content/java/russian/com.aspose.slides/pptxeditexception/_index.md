...
type: docs
url: /ru/com.aspose.slides/pptxeditexception/
---
**Наследование:**
...
| --- | --- |
| [PptxEditException()](#PptxEditException--) | Конструктор по умолчанию. |
| [PptxEditException(String message)](#PptxEditException-java.lang.String-) | Конструктор, позволяющий добавить сообщение к этому исключению. |
| [PptxEditException(String message, RuntimeException exception)](#PptxEditException-java.lang.String-java.lang.RuntimeException-) | Конструктор для исключения, содержащего сообщение и вложенное исключение. |
