...
| Метод | Описание |
| --- | --- |
| [getPortionFormat()](#getPortionFormat--) | Возвращает объект форматирования, содержащий явно заданные свойства форматирования части текста без применения наследования. |
...
Возвращает объект форматирования, содержащий явно заданные свойства форматирования части текста без применения наследования. Только для чтения [IPortionFormat](../../com.aspose.slides/iportionformat).

--------------------

Объект форматирования содержит параметры форматирования, определённые только для текущей части, наследуемые данные не применяются.

Чтобы получить эффективные значения, включая наследуемые, используйте метод [PortionFormat.getEffective](../../com.aspose.slides/portionformat\#getEffective).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| internalString | java.lang.String | Внутреннее имя FieldType. |
...
Получает координаты начала части. Координата X точки представляет начало части с первого символа, включая левый боковой отступ. Координата Y включает верхний боковой отступ.
