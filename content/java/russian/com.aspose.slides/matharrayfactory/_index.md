...
type: docs
url: /ru/com.aspose.slides/matharrayfactory/
---
**Наследование:**
java.lang.Object
...
| Метод | Описание |
| --- | --- |
| [createMathArray(IMathElement element)](#createMathArray-com.aspose.slides.IMathElement-) | Создает математический массив и помещает в него указанный элемент |
| [createMathArray(IMathElementCollection elements)](#createMathArray-com.aspose.slides.IMathElementCollection-) | Создает математический массив и помещает в него указанные элементы |
### MathArrayFactory() {#MathArrayFactory--}
```
...
| --- | --- | --- |
| element | [IMathElement](../../com.aspose.slides/imathelement) | математический элемент для размещения в массиве |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elements | [IMathElementCollection](../../com.aspose.slides/imathelementcollection) | математические элементы для размещения в массиве |
