...
Возвращает коллекцию интерактивных последовательностей. Эта последовательность может содержать только эффекты по "click on shape" с указанной целевой фигурой. Только для чтения [ISequenceCollection](../../com.aspose.slides/isequencecollection).
