...
| [getTextFrame()](#getTextFrame--) | Возвращает текстовый фрейм узла. |
...
| [getLevel()](#getLevel--) | Возвращает уровень вложения узла. |
| [getBulletFillFormat()](#getBulletFillFormat--) | Возвращает объект FillFormat, который содержит свойства заполнения маркера узла. |
| [getPosition()](#getPosition--) | Возвращает или задает позицию узла среди соседних узлов, начиная с нуля. |
| [setPosition(int value)](#setPosition-int-) | Возвращает или задает позицию узла среди соседних узлов, начиная с нуля. |
...
Возвращает текстовый фрейм узла. Только для чтения [ITextFrame](../../com.aspose.slides/itextframe).
...
Возвращает уровень вложения узла. Только для чтения int.
...
Возвращает объект FillFormat, который содержит свойства заполнения маркера узла. Примечание: может вернуть null для некоторых типов макета SmartArt, которые не предоставляют маркеров для узлов. Только для чтения [IFillFormat](../../com.aspose.slides/ifillformat).
...
Возвращает или задает позицию узла среди соседних узлов, начиная с нуля. Чтение/запись int.
