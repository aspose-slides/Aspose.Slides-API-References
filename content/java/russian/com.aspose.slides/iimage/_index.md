...
| filename | java.lang.String | Путь к файлу, в который будет сохранено изображение. |
| format | int | Формат изображения. |
| quality | int | Качество сохраняемого изображения (0 – 100). Этот параметр влияет только на сохранение в [ImageFormat.Jpeg](../../com.aspose.slides/imageformat\#Jpeg); для всех остальных форматов игнорируется. |
