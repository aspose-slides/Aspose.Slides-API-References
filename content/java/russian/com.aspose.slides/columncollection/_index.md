...
| [addClone(IColumn templ, boolean withAttachedColumns)](#addClone-com.aspose.slides.IColumn-boolean-) | Создаёт копию указанного шаблонного ряда и вставляет её в конец таблицы. |
...
Создаёт копию указанного шаблонного ряда и вставляет её в конец таблицы.

**Параметры:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| templ | [IColumn](../../com.aspose.slides/icolumn) | Столбец, используемый в качестве шаблона. |
| withAttachedColumns | boolean | true, чтобы скопировать также все столбцы, прикреплённые к шаблонному ряду. |
...
| templ | [IColumn](../../com.aspose.slides/icolumn) | Столбец, используемый в качестве шаблона. |
| withAttachedColumns | boolean | true, чтобы скопировать также все столбцы, прикреплённые к шаблонному столбцу. |
...
| withAttachedRows | boolean | true, чтобы удалить также все прикреплённые столбцы. |
