...
type: docs
url: /ru/com.aspose.slides/lineformatcollection/
---
**Наследование:**
...
| [size()](#size--) | Получает количество реально содержащихся в коллекции элементов. |
...
Получает элемент по указанному индексу. Только для чтения [ILineFormat](../../com.aspose.slides/ilineformat).
...
**Возвращаемое значение:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ILineFormat> - IGenericEnumerator, который можно использовать для перебора коллекции.
...
**Возвращаемое значение:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ILineFormat> - java.util.Iterator для всей коллекции.
### size() {#size--}
```
public final int size()
```

Получает количество реально содержащихся в коллекции элементов. Только для чтения int.
