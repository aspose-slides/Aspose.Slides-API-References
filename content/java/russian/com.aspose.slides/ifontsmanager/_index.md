...
| [getFontFallBackRulesCollection()](#getFontFallBackRulesCollection--) | Представляет пользовательскую коллекцию правил FontFallBack для управления коллекциями шрифтов с правильными подстановками через функциональность fallback Чтение/запись [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection). |
| [setFontFallBackRulesCollection(IFontFallBackRulesCollection value)](#setFontFallBackRulesCollection-com.aspose.slides.IFontFallBackRulesCollection-) | Представляет пользовательскую коллекцию правил FontFallBack для управления коллекциями шрифтов с правильными подстановками через функциональность fallback Чтение/запись [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection). |
...
| [getEmbeddedFonts()](#getEmbeddedFonts--) | Возвращает шрифты, внедрённые в презентацию |
| [removeEmbeddedFont(IFontData fontData)](#removeEmbeddedFont-com.aspose.slides.IFontData-) | Удаляет внедрённый шрифт |
| [addEmbeddedFont(IFontData fontData, int embedFontRule)](#addEmbeddedFont-com.aspose.slides.IFontData-int-) | Добавляет внедрённый шрифт. |
| [addEmbeddedFont(byte[] fontData, int embedFontRule)](#addEmbeddedFont-byte---int-) | Добавляет внедрённый шрифт |
...
| [getFontBytes(IFontData fontData, int fontStyle)](#getFontBytes-com.aspose.slides.IFontData-int-) | Извлекает массив байтов, представляющий данные шрифта для указанного стиля и данных шрифта. |
| [getFontEmbeddingLevel(byte[] fontBytes, String fontName)](#getFontEmbeddingLevel-byte---java.lang.String-) | Определяет уровень внедрения шрифта из заданного массива байтов и имени шрифта. |
...
Представляет пользовательскую коллекцию правил FontFallBack для управления коллекциями шрифтов с правильными подстановками через функциональность fallback Чтение/запись [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection).
...
Возвращает шрифты, внедрённые в презентацию

**Возвращаемое значение:**
com.aspose.slides.IFontData[] - Внедрённые шрифты IFontData[]
### removeEmbeddedFont(IFontData fontData) {#removeEmbeddedFont-com.aspose.slides.IFontData-}
```
public abstract void removeEmbeddedFont(IFontData fontData)
```

Удаляет внедрённый шрифт
...
Добавляет внедрённый шрифт.

**Параметры:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| fontData | [IFontData](../../com.aspose.slides/ifontdata) | Объект данных шрифта [IFontData](../../com.aspose.slides/ifontdata) |
| embedFontRule | int | Правило внедрения шрифта [EmbedFontCharacters](../../com.aspose.slides/embedfontcharacters)

--------------------

Имейте в виду, что при копировании любых шрифтов большинство из них защищено авторским правом. Сначала найдите лицензию шрифта и убедитесь, что её можно свободно перенести на другую машину. |
...
Имейте в виду, что при добавлении любых шрифтов большинство из них защищено авторским правом. Сначала найдите лицензию шрифта и убедитесь, что её можно свободно перенести на другую машину. |
...
Извлекает массив байтов, представляющий данные шрифта для указанного стиля и данных шрифта.
...
| fontStyle | int | Стиль шрифта, для которого необходимо получить данные [FontStyleType](../../com.aspose.slides/fontstyletype). |
...
**Возвращаемое значение:**
int - Уровень внедрения указанного шрифта.