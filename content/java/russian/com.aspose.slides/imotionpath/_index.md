...
| Метод | Описание |
| --- | --- |
| [add(int type, Point2D.Float[] pts, int ptsType, boolean bRelativeCoord)](#add-int-java.awt.geom.Point2D.Float---int-boolean-) | Добавить новую команду в путь |
| [getCount()](#getCount--) | Возвращает количество путей в коллекции. |
| [insert(int index, int type, Point2D.Float[] pts, int ptsType, boolean bRelativeCoord)](#insert-int-int-java.awt.geom.Point2D.Float---int-boolean-) | Вставить новую команду в путь |
...
| pts | java.awt.geom.Point2D.Float[] | Массив точек java.awt.geom.Point2D.Float[] |
