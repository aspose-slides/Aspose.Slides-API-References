...
second_title: Aspose.Slides для Java – справочная документация API
description: Определяет формат, в котором изображение слайда будет сохраняться при экспорте презентации в HTML.
type: docs
...
Определяет формат, в котором будет сохраняться изображение слайда для экспорта презентации в HTML.
## Конструкторы
...
| --- | --- | --- |
| options | [SVGOptions](../../com.aspose.slides/svgoptions) | Параметры экспорта SVG. |
