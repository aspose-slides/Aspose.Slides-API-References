...
| --- | --- |
| [FontData(String fontName)](#FontData-java.lang.String-) | Создаёт новый объект FontData с указанным именем шрифта. |
## Методы
...
Создаёт новый объект FontData с указанным именем шрифта.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| theme | [IThemeEffectiveData](../../com.aspose.slides/ithemeeffectivedata) | Тема, из которой следует взять тематическое имя шрифта. Ответственность за предоставление корректного значения лежит на вызывающем. См. [IThemeable.createThemeEffective](../../com.aspose.slides/ithemeable\#createThemeEffective) |
