...
| [loadExternalFont(byte[] data)](#loadExternalFont-byte---) | Добавляет шрифт из бинарных данных. |
| [getFontFolders()](#getFontFolders--) | Получает папки шрифтов. |
| [clearCache()](#clearCache--) | Удаляет все пользовательские шрифты, определённые пользователем |
...
>  // Загрузка пользовательских шрифтов из директории
>  FontsLoader.loadExternalFonts(folders);
>  // Выполнить некоторые операции и рендеринг презентации/слайдов
...
| --- | --- | --- |
| directories | java.lang.String[] | Каталоги для чтения дополнительных шрифтов. |
...
Удаляет все пользовательские шрифты, определённые пользователем

--------------------

Этот метод должен очистить кеш пользовательских шрифтов, определённых пользователем.