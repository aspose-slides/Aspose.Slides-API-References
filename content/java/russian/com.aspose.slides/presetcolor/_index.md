...
description: Представляет предопределённые предустановки цветов.
type: docs
url: /ru/com.aspose.slides/presetcolor/
---
**Наследование:**  
...
Представляет предопределённые предустановки цветов.
## Поля

| Поле | Описание |
| --- | --- |
| [NotDefined](#NotDefined) | Предустановка цвета не определена. |
| [AliceBlue](#AliceBlue) |  |
...
Предустановка цвета не определена.
