...
| [getBehaviors()](#getBehaviors--) | Возвращает коллекцию поведений для эффекта. |
| [setBehaviors(IBehaviorCollection value)](#setBehaviors-com.aspose.slides.IBehaviorCollection-) | Возвращает коллекцию поведений для эффекта. |
...
| [getStopPreviousSound()](#getStopPreviousSound--) | Этот атрибут указывает, останавливает ли анимационный эффект предыдущее звучание. |
| [setStopPreviousSound(boolean value)](#setStopPreviousSound-boolean-) | Этот атрибут указывает, останавливает ли анимационный эффект предыдущее звучание. |
| [getAfterAnimationType()](#getAfterAnimationType--) | Определён тип анимации после эффекта. |
| [setAfterAnimationType(int value)](#setAfterAnimationType-int-) | Определён тип анимации после эффекта. |
| [getAfterAnimationColor()](#getAfterAnimationColor--) | Определён цвет анимации после эффекта. |
| [setAfterAnimationColor(IColorFormat value)](#setAfterAnimationColor-com.aspose.slides.IColorFormat-) | Определён цвет анимации после эффекта. |
| [getAnimateTextType()](#getAnimateTextType--) | Определяет тип анимации текста для эффекта. |
| [setAnimateTextType(int value)](#setAnimateTextType-int-) | Определяет тип анимации текста для эффекта. |
...
Возвращает коллекцию поведений для эффекта. Чтение/запись [IBehaviorCollection](../../com.aspose.slides/ibehaviorcollection).
...
Этот атрибут указывает, останавливает ли анимационный эффект предыдущее звучание. Чтение/запись boolean .
...
Определён тип анимации после эффекта. Чтение/запись AfterAnimationType (\#getAfterAnimationType.getAfterAnimationType/\#setAfterAnimationType(int).setAfterAnimationType(int)).
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Изменить тип анимации после эффекта на "Hide on Next Mouse Click"
...
Определён цвет анимации после эффекта. Чтение/запись [IColorFormat](../../com.aspose.slides/icolorformat).
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Изменить тип анимации после эффекта на "Color"
>      firstSlideEffect.setAfterAnimationType(AfterAnimationType.Color);
> 
>      // Установить цвет анимации после эффекта.
...
Определяет тип анимации текста для эффекта. Текст формы может анимироваться по буквам, по словам или сразу полностью. Чтение/запись AnimateTextType (\#getAnimateTextType.getAnimateTextType/\#setAnimateTextType(int).setAnimateTextType(int)).
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Изменить тип анимации текста эффекта на "по буквам"
>      firstSlideEffect.setAnimateTextType(AnimateTextType.ByLetter);
>  } finally {
>      if (presentation != null) presentation.dispose();
>  }
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Изменить тип анимации текста эффекта на "By word"
>      firstSlideEffect.setAnimateTextType(AnimateTextType.ByWord);
> 
>      // Установить задержку между частями анимированного текста в 20% от длительности эффекта.
