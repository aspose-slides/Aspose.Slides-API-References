...
type: docs
url: /ru/com.aspose.slides/odpexception/
---
**Наследование:**
...
| --- | --- |
| [OdpException()](#OdpException--) | Конструктор по умолчанию |
| [OdpException(String message)](#OdpException-java.lang.String-) | Конструктор, позволяющий добавить сообщение к этому исключению. |
| [OdpException(String message, RuntimeException exception)](#OdpException-java.lang.String-java.lang.RuntimeException-) | Конструктор для исключения, содержащего сообщение и вложенное исключение. |
