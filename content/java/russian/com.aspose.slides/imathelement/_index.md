...
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | Обрамляет этот элемент указанными символами, такими как скобки или другие символы в качестве рамки |
...
| [setUpperLimit(IMathElement limit)](#setUpperLimit-com.aspose.slides.IMathElement-) | Берёт верхний предел |
| [setUpperLimit(String limit)](#setUpperLimit-java.lang.String-) | Берёт верхний предел |
| [setLowerLimit(IMathElement limit)](#setLowerLimit-com.aspose.slides.IMathElement-) | Берёт нижний предел |
| [setLowerLimit(String limit)](#setLowerLimit-java.lang.String-) | Берёт нижний предел |
...
| [group(char character, int position, int verticalJustification)](#group-char-int-int-) | Размещает этот элемент в группе, используя символ группировки, такой как нижняя фигурная скобка или другой |
| [toBorderBox()](#toBorderBox--) | Размещает этот элемент в рамке |
...
Обрамляет этот элемент указанными символами, такими как скобки или другие символы в качестве рамки
...
| Parameter | Type | Description |
| --- | --- | --- |
| beginningCharacter | char | Начальный символ (обычно левый скобка) |
| endingCharacter | char | Конечный символ (обычно правый скобка) |
...
| Parameter | Type | Description |
| --- | --- | --- |
| functionType | int | Одна из общих функций с одним аргументом |
...
| Parameter | Type | Description |
| --- | --- | --- |
| functionType | int | Одна из общих функций с двумя аргументами: Log, Lim, Min, Max |
...
| --- | --- | --- |
| subscript | java.lang.String | Подстрочный (нижний индекс справа) |
| superscript | java.lang.String | Надстрочный (верхний индекс справа) |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| subscript | [IMathElement](../../com.aspose.slides/imathelement) | Подстрочный (нижний индекс слева) |
| superscript | [IMathElement](../../com.aspose.slides/imathelement) | Надстрочный (верхний индекс слева) |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| subscript | java.lang.String | Подстрочный (нижний индекс слева) |
| superscript | java.lang.String | Надстрочный (верхний индекс слева) |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| accentCharacter | char | Символ акцента. Значение должно принадлежать диапазону (U+0300\\u2013U+036F) или (U+20D0\\u2013U+20EF) |
...
Устанавливает полосу над этим элементом
--------------------
...
Устанавливает полосу под этим элементом
--------------------
...
| verticalJustification | int | Вертикальное выравнивание символа группы. Указывает выравнивание объекта относительно базовой линии. Например, когда символ группы находится над объектом, вертикальное выравнивание Top означает, что верхняя часть объекта лежит на базовой линии; когда установлено Bottom, нижняя часть объекта находится на базовой линии |
...
Размещает этот элемент в границе-коробке
--------------------
...
**Возвращаемое значение:**
[IMathBorderBox](../../com.aspose.slides/imathborderbox) - Граница-коробка с помещённым внутри элементом
...
| strikethroughHorizontal | boolean | Перечёркнуть горизонтально в границе-коробке |
| strikethroughVertical | boolean | Перечёркнуть вертикально в границе-коробке |
| strikethroughBottomLeftToTopRight | boolean | Перечёркнуть от нижнего левого к верхнему правому в границе-коробке |
| strikethroughTopLeftToBottomRight | boolean | Перечёркнуть от верхнего левого к нижнему правому в границе-коробке |
...
Размещает этот элемент в невизуальном блоке (логической группировке), который используется для группировки компонентов уравнения или другого фрагмента математического текста. Блок-коробка может, например, служить эмулятором оператора с точкой выравнивания или без неё, служить точкой разрыва строки или группироваться так, чтобы не разрешать разрывы строк внутри.
--------------------
...
**Возвращаемое значение:**
[IMathBox](../../com.aspose.slides/imathbox) - Логический блок с помещённым внутри элементом