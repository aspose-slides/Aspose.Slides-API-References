...
type: docs
url: /ru/com.aspose.slides/ifontsubstrulecollection/
---
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) | Правило замены шрифта [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) | Модуль, который следует удалить из коллекции. |