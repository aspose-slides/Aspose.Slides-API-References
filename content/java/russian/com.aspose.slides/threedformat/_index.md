...
>  try {
>      // Добавьте фигуру с помощью метода AddAutoShape method
>      IAutoShape shape = pres.getSlides().get_Item(0).getShapes().addAutoShape(ShapeType.Rectangle, 200, 150, 200, 200);
>      // Определите TextFrame и его свойства
>      shape.getTextFrame().setText("3D");
>      shape.getTextFrame().getParagraphs().get_Item(0).getParagraphFormat().getDefaultPortionFormat().setFontHeight(64);
>      // Определите свойства ThreeDFormat Properties
...
>      // Настройте Portion TextFrame и свойства PortionFormat
...
>      // настроить трансформ "Arch Up" WordArt
...
Возвращает или задает цвет выдавливания. Только для чтения [IColorFormat](../../com.aspose.slides/icolorformat).
