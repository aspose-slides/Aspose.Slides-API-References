...
Указывает позицию легенды на диаграмме. Значения свойств X, Y, Width, Heigt, отличные от NaN, переопределяют действие этого свойства. Чтение/запись [LegendPositionType](../../com.aspose.slides/legendpositiontype).
...
Возвращает формат легенды. Только для чтения [IFormat](../../com.aspose.slides/iformat).
...
Получает элементы легенды. Только для чтения [ILegendEntryCollection](../../com.aspose.slides/ilegendentrycollection).
