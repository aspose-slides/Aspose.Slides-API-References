...
type: docs
url: /ru/com.aspose.slides/connectorlock/
---
**Наследование:**
...
Определяет, какие операции отключены у родительского Connector.
## Методы
...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Определяет, должна ли фигура сохранять пропорции при изменении размера. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Определяет, должна ли фигура сохранять пропорции при изменении размера. |
| [getPositionMove()](#getPositionMove--) | Определяет, запрещено ли перемещение этой фигуры. |
| [setPositionMove(boolean value)](#setPositionMove-boolean-) | Определяет, запрещено ли перемещение этой фигуры. |
| [getSizeLocked()](#getSizeLocked--) | Определяет, запрещено ли изменение размеров этой фигуры. |
| [setSizeLocked(boolean value)](#setSizeLocked-boolean-) | Определяет, запрещено ли изменение размеров этой фигуры. |
...
| [getAdjustHandlesLocked()](#getAdjustHandlesLocked--) | Определяет, запрещено ли изменение значений корректировки. |
| [setAdjustHandlesLocked(boolean value)](#setAdjustHandlesLocked-boolean-) | Определяет, запрещено ли изменение значений корректировки. |
| [getArrowheadsLocked()](#getArrowheadsLocked--) | Определяет, запрещено ли изменение стрелок. |
| [setArrowheadsLocked(boolean value)](#setArrowheadsLocked-boolean-) | Определяет, запрещено ли изменение стрелок. |
...
Определяет, должна ли фигура сохранять пропорции при изменении размера. Чтение/запись boolean.
...
Определяет, запрещено ли изменение размеров этой фигуры. Чтение/запись boolean.
...
Определяет, запрещено ли изменение значений корректировки. Чтение/запись boolean.
...
Определяет, запрещено ли изменение стрелок. Чтение/запись boolean.
