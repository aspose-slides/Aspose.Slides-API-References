...
| [remove(IMathBlock item)](#remove-com.aspose.slides.IMathBlock-) | Удаляет первое вхождение конкретного объекта из коллекции. |
| [removeAt(int index)](#removeAt-int-) | Удаляет элемент по указанному индексу в коллекции. |
| [contains(IMathBlock item)](#contains-com.aspose.slides.IMathBlock-) | Определяет, содержит ли коллекция конкретное значение. |
| [indexOf(IMathBlock item)](#indexOf-com.aspose.slides.IMathBlock-) | Определяет индекс конкретного IMMathBlock в коллекции. |
...
| item | [IMathBlock](../../com.aspose.slides/imathblock) | IMathBlock для вставки. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | Объект, который необходимо удалить из коллекции. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | Объект, который нужно найти в коллекции. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | Элемент, который нужно найти в коллекции. |

**Возвращаемое значение:**
int - Индекс элемента, если он найден в коллекции; в противном случае -1.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| index | int | Нулевой индекс элемента, который нужно установить. |
