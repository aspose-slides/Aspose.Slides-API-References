...
| [getEffective()](#getEffective--) | Получает эффективные данные эффекта Alpha Bi-Level с учётом наследования. |
...
Получает эффективные данные эффекта Alpha Bi-Level с учётом наследования.
