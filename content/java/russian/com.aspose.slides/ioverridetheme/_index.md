...
Истинное значение означает, что ColorScheme, FontScheme, FormatScheme равны null, и любое переопределение с помощью этого объекта темы отключено. Только для чтения, булево значение.
