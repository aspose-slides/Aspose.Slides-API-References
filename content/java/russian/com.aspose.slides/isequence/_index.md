...
| [getTriggerShape()](#getTriggerShape--) | Возвращает или задает целевую фигуру для интерактивной последовательности. |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | Возвращает или задает целевую фигуру для интерактивной последовательности. |
| [removeByShape(IShape shape)](#removeByShape-com.aspose.slides.IShape-) | Удалить эффект для указанной фигуры. |
| [getEffectsByShape(IShape shape)](#getEffectsByShape-com.aspose.slides.IShape-) | Возвращает массив эффектов для указанной фигуры. |
...
| [getCount(IShape shape)](#getCount-com.aspose.slides.IShape-) | Возвращает количество эффектов для указанной фигуры. |
...
Возвращает или задает целевую фигуру для интерактивной последовательности. Если последовательность не интерактивна, возвращает null. Чтение/запись [IShape](../../com.aspose.slides/ishape).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | Объект фигуры [IShape](../../com.aspose.slides/ishape) |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | Объект фигуры [IShape](../../com.aspose.slides/ishape) для добавления эффекта |
