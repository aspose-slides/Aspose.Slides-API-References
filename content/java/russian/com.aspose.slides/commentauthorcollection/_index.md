...
| [findByName(String name)](#findByName-java.lang.String-) | Ищет автора в коллекции по имени. |
| [findByNameAndInitials(String name, String initials)](#findByNameAndInitials-java.lang.String-java.lang.String-) | Ищет автора в коллекции по имени и инициалам. |
...
Ищет автора в коллекции по имени.
...
Ищет автора в коллекции по имени и инициалам.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| author | [ICommentAuthor](../../com.aspose.slides/icommentauthor) | Автор для удаления из коллекции. |
