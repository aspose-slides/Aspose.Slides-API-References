...
| Метод | Описание |
| --- | --- |
| [getRow()](#getRow--) | Возвращает индекс строки листа, в которой находится ячейка. |
| [getColumn()](#getColumn--) | Возвращает индекс столбца листа, в которой находится ячейка. |
...
| [getChartDataWorksheet()](#getChartDataWorksheet--) | Получает лист. |
...
Возвращает индекс строки листа, в которой находится ячейка. Только для чтения int.
...
Возвращает индекс столбца листа, в которой находится ячейка. Только для чтения int.
...
Получает лист. Только для чтения [IChartDataWorksheet](../../com.aspose.slides/ichartdataworksheet).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| updateValues | boolean | Если false, реальное вычисление не будет выполнено. Используйте true для проверки возможных исключений. |