...
type: docs
url: /ru/com.aspose.slides/smartart/
---
**Наследование:**
...
| [isReversed()](#isReversed--) | Возвращает или задает состояние диаграммы SmartArt относительно (слева направо) LTR или (справа налево) RTL, если диаграмма поддерживает инверсию. |
| [setReversed(boolean value)](#setReversed-boolean-) | Возвращает или задает состояние диаграммы SmartArt относительно (слева направо) LTR или (справа налево) RTL, если диаграмма поддерживает инверсию. |
...
Возвращает или задает состояние диаграммы SmartArt относительно (слева направо) LTR или (справа налево) RTL, если диаграмма поддерживает инверсию. **Чтение/запись** boolean .
