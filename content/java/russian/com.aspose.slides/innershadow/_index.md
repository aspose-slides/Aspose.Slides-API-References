...
| [getEffective()](#getEffective--) | Получает данные эффекта внутренней тени с применённым наследованием. |
...
Получает данные эффекта внутренней тени с применённым наследованием.
