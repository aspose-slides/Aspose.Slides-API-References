...
**Возвращает:**
[IPortionFormat](../../com.aspose.slides/iportionformat) - Новый формат фрагмента.
...
**Возвращает:**
[ITextFrameFormat](../../com.aspose.slides/itextframeformat) - Новый формат текстовой рамки.