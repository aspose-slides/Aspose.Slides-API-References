...
| Метод | Описание |
| --- | --- |
| [get_Item(int level)](#get-Item-int-) | Возвращает объект IChartDataCell для определённого уровня. |
| [setGroupingItem(int level, Object value)](#setGroupingItem-int-java.lang.Object-) | Устанавливает элемент группировки для определённого уровня. |
| [deleteGroupingItem(int level)](#deleteGroupingItem-int-) | Удаляет элемент группировки для определённого уровня. |
...
Возвращает объект IChartDataCell для определённого уровня.
...
Устанавливает элемент группировки для определённого уровня.
...
Удаляет элемент группировки для определённого уровня.
