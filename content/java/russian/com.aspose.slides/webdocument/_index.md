...
| --- | --- | --- |
| options | [WebDocumentOptions](../../com.aspose.slides/webdocumentoptions) | Параметры, установленные для документа. |
...
> 
>   // поместить свойство "slideMargin" для использования из шаблонов
>   document.getGlobal().put("slideMargin", 10);
> 
>   // ... установить другие параметры документа, а затем сохранить документ
>   document.save();
> ```
