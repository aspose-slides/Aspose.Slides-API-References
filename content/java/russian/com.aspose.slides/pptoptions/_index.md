...
description: Предоставляет параметры, позволяющие управлять тем, как презентация сохраняется в формате PPT.
type: docs
...
Предоставляет параметры, позволяющие управлять тем, как презентация сохраняется в формате PPT.
## Конструкторы
