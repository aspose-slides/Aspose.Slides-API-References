...
type: docs
url: /ru/com.aspose.slides/pptxunsupportedformatexception/
---
**Наследование:**
...
| --- | --- |
| [PptxUnsupportedFormatException()](#PptxUnsupportedFormatException--) | Конструктор по умолчанию. |
| [PptxUnsupportedFormatException(String message)](#PptxUnsupportedFormatException-java.lang.String-) | Конструктор, позволяющий добавить сообщение к этому исключению. |
| [PptxUnsupportedFormatException(String message, RuntimeException exception)](#PptxUnsupportedFormatException-java.lang.String-java.lang.RuntimeException-) | Конструктор для исключения, содержащего сообщение и вложенное исключение. |
...
| --- | --- | --- |
| message | java.lang.String | message |
| exception | java.lang.RuntimeException | исходное исключение |