...
type: docs
url: /ru/com.aspose.slides/pptunsupportedformatexception/
---
**Наследование:**
...
| --- | --- |
| [PptUnsupportedFormatException()](#PptUnsupportedFormatException--) | Конструктор по умолчанию. |
| [PptUnsupportedFormatException(String message)](#PptUnsupportedFormatException-java.lang.String-) | Конструктор, позволяющий добавить сообщение к этому исключению. |
| [PptUnsupportedFormatException(String message, RuntimeException exception)](#PptUnsupportedFormatException-java.lang.String-java.lang.RuntimeException-) | Конструктор для исключения, содержащего сообщение и вложенное исключение. |
...
| --- | --- | --- |
| message | java.lang.String | сообщение |
| exception | java.lang.RuntimeException | оригинальное исключение |