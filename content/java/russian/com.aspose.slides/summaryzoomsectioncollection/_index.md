...
| [getSummarySection(ISection section)](#getSummarySection-com.aspose.slides.ISection-) | Возвращает элемент Summary Zoom Section для заданного раздела. |
...
Получает элемент по указанному индексу. Точно только для чтения [ISummaryZoomSection](../../com.aspose.slides/isummaryzoomsection).
...
Если элемент для этого раздела уже существует в коллекции, будет возвращён существующий элемент. |
...
Получает количество элементов, фактически содержащихся в коллекции. Точно только для чтения int.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| section | [ISection](../../com.aspose.slides/isection) | Раздел, для которого необходимо удалить элемент Summary Zoom Section [ISection](../../com.aspose.slides/isection). |
...
Возвращает значение, указывающее, синхронизирован ли доступ к коллекции (потокобезопасный). Точно только для чтения boolean.
...
Возвращает объект синхронизации. Точно только для чтения Object.
...
**Возвращаемое значение:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISummaryZoomSection> - IGenericEnumerator, который можно использовать для перебора коллекции.
