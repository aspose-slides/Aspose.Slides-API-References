...
description: Неизменяемый объект, содержащий эффективные свойства форматирования абзаца маркера.
type: docs
...
Неизменяемый объект, содержащий эффективные свойства форматирования абзаца маркера.
...
Определяет, имеет ли маркер собственный цвет или наследует его от первой части абзаца. Возвращает **true**, если у маркера есть собственный цвет, и **false**, если маркер наследует цвет от первой части абзаца. Только для чтения boolean.
...
Определяет, имеет ли маркер собственный шрифт или наследует его от первой части абзаца. Возвращает **true**, если у маркера есть собственный шрифт, и **true**, если маркер наследует шрифт от первой части абзаца. Только для чтения boolean.
...
>  try {
>      // Предположим, что первая фигура на первом слайде — AutoShape с некоторым текстом...
