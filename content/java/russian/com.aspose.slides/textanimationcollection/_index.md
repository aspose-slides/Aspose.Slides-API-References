...
| [add()](#add--) | Добавляет новую анимацию текста в коллекцию. |
...
**Возвращаемое значение:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ITextAnimation> - Перечислитель IGenericEnumerator, который может использоваться для перебора элементов коллекции.
