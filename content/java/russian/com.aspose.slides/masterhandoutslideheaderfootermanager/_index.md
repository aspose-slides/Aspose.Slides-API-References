...
description: Представляет менеджер, который хранит поведение заполнителей слайдов раздаточного материала мастера, включая заполнитель заголовка.
type: docs
url: /ru/com.aspose.slides/masterhandoutslideheaderfootermanager/
---
**Наследование:**
...
Представляет менеджер, который хранит поведение заполнителей слайдов раздаточного материала мастера, включая заполнитель заголовка.