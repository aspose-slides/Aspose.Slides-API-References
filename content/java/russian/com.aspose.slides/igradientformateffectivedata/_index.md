...
description: Неизменяемый объект, содержащий свойства эффективного градиентного заполнения.
type: docs
...
Неизменяемый объект, содержащий свойства эффективного градиентного заполнения.
...
| [getGradientStops()](#getGradientStops--) | Возвращает коллекцию градиентных остановок. |
...
Возвращает коллекцию градиентных остановок. Только для чтения [IGradientStopCollectionEffectiveData](../../com.aspose.slides/igradientstopcollectioneffectivedata).
