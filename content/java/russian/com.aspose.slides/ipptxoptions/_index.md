...
| Метод | Описание |
| --- | --- |
| [getConformance()](#getConformance--) | Указывает класс соответствия, к которому относится документ Presentation. |
| [setConformance(int value)](#setConformance-int-) | Указывает класс соответствия, к которому относится документ Presentation. |
...
Указывает класс соответствия, к которому относится документ Presentation. Значение по умолчанию [Conformance.Ecma376\_2006](../../com.aspose.slides/conformance\#Ecma376-2006)
...
Более высокие уровни сжатия дают более мелкие файлы, но требуют больше времени обработки. Фактическое соотношение сжатия зависит от содержания презентации.
