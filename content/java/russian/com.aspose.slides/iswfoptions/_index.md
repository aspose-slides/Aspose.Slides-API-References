...
| Метод | Описание |
| --- | --- |
| [getCompressed()](#getCompressed--) | Указывает, следует ли сжимать сгенерированный SWF-документ, или нет. |
| [setCompressed(boolean value)](#setCompressed-boolean-) | Указывает, следует ли сжимать сгенерированный SWF-документ, или нет. |
| [getViewerIncluded()](#getViewerIncluded--) | Указывает, должен ли сгенерированный SWF-документ включать встроенный просмотрщик документа, или нет. |
| [setViewerIncluded(boolean value)](#setViewerIncluded-boolean-) | Указывает, должен ли сгенерированный SWF-документ включать встроенный просмотрщик документа, или нет. |
| [getShowPageBorder()](#getShowPageBorder--) | Указывает, следует ли показывать рамку вокруг страниц. |
| [setShowPageBorder(boolean value)](#setShowPageBorder-boolean-) | Указывает, следует ли показывать рамку вокруг страниц. |
...
| [getStartOpenLeftPane()](#getStartOpenLeftPane--) | Запуск с открытой левой панелью. |
| [setStartOpenLeftPane(boolean value)](#setStartOpenLeftPane-boolean-) | Запуск с открытой левой панелью. |
...
Указывает, следует ли сжимать сгенерированный SWF-документ, или нет. По умолчанию true.
...
Указывает, должен ли сгенерированный SWF-документ включать встроенный просмотрщик документа, или нет. По умолчанию true.
...
Указывает, следует ли показывать рамку вокруг страниц. По умолчанию true.
...
Запуск с открытой левой панелью. Может быть переопределено в flashvars. По умолчанию false.
...
Изображение, которое будет отображаться как логотип в правом верхнем углу просмотрщика. Должно быть PNG-изображением размером 32×64 пикселя, иначе логотип может отображаться некорректно.
...
Получает или задает режим расположения слайдов на странице при экспорте презентации [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions). Это свойство не поддерживает назначение объектов типа [HandoutLayoutingOptions](../../com.aspose.slides/handoutlayoutingoptions)
