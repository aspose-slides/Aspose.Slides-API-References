...
Представляет параметры сохранения презентаций OpenXml (PPTX, PPSX, POTX, PPTM, PPSM, POTM).
## Конструкторы
...
| [getRefreshThumbnail()](#getRefreshThumbnail--) | Указывает, будет ли эскиз презентации обновлён. |
| [setRefreshThumbnail(boolean value)](#setRefreshThumbnail-boolean-) | Указывает, будет ли эскиз презентации обновлён. |
...
Создаёт новый экземпляр PptxOptions
...
Указывает, будет ли эскиз презентации обновлён. Boolean с правом чтения/записи. Значение по умолчанию — **true**.
