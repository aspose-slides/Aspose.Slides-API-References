...
| Параметр | Тип | Описание |
| --- | --- | --- |
| index | int | Индекс, в котором должно быть вставлено новое свойство. |
| propertyValue | java.lang.String | Значение свойства для добавления. |
...
**Возвращаемое значение:**
boolean - true, если propertyValue найдено в [IGenericCollection](../../com.aspose.slides/igenericcollection); иначе false