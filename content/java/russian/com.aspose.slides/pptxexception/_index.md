...
type: docs
url: /ru/com.aspose.slides/pptxexception/
---
**Наследование:**
...
| --- | --- |
| [PptxException()](#PptxException--) | Конструктор по умолчанию. |
| [PptxException(String message)](#PptxException-java.lang.String-) | Конструктор, позволяющий добавить сообщение к этому исключению. |
| [PptxException(String message, RuntimeException exception)](#PptxException-java.lang.String-java.lang.RuntimeException-) | Конструктор для исключения, содержащего сообщение и вложенное исключение. |
