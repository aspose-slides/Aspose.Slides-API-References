...
**Возвращает:**
[ISmartArtShape](../../com.aspose.slides/ismartartshape) – Фигура SmartArt
...
**Возвращает:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISmartArtShape> – IGenericEnumerator, который можно использовать для перебора элементов коллекции.
