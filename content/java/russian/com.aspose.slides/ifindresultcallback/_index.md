...
| Метод | Описание |
| --- | --- |
| [foundResult(ITextFrame textFrame, String sourceText, String foundText, int textPosition)](#foundResult-com.aspose.slides.ITextFrame-java.lang.String-java.lang.String-int-) | Метод обратного вызова, получающий данные о найденном тексте. |
...
Метод обратного вызова, получающий данные о найденном тексте.

**Параметры:**
| Параметр | Тип | Описание |
| --- | --- | --- |
| textFrame | [ITextFrame](../../com.aspose.slides/itextframe) | Объект [ITextFrame](../../com.aspose.slides/itextframe), в котором найден текст. |
| sourceText | java.lang.String | Исходный текст, в котором найден текст. |
