...
| Метод | Описание |
| --- | --- |
| [getLayout()](#getLayout--) | Получает расположение секций Summary Zoom в кадре. |
...
Получает расположение секций Summary Zoom в кадре. Значение по умолчанию — GridLayout.
