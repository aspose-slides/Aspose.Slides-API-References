...
type: docs
url: /ru/com.aspose.slides/legendentryproperties/
---
**Наследование:**
java.lang.Object
...
| [getHide()](#getHide--) | Определяет, скрыт ли элемент легенды. |
| [setHide(boolean value)](#setHide-boolean-) | Определяет, скрыт ли элемент легенды. |
...
Определяет, скрыт ли элемент легенды. Чтение/запись boolean.
