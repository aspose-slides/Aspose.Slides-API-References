...
description: Указывает объект надстрочного текста, который состоит из базового элемента и уменьшенного надстрочного, размещённого выше и правее
type: docs
...
Указывает объект надстрочного текста, который состоит из базового элемента и уменьшенного надстрочного, размещённого выше и правее
...
> Example:
>  
>  IMMathSuperscriptElement superscriptElement = new MathematicalText("N").setSuperscript("i");
> ```
## Конструкторы
