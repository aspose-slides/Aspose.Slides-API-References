...
| --- | --- |
| [ParagraphFormat()](#ParagraphFormat--) | Инициализирует новый экземпляр класса [ParagraphFormat](../../com.aspose.slides/paragraphformat). |
...
| [getSpaceWithin()](#getSpaceWithin--) | Возвращает или задаёт величину расстояния между базовыми линиями в абзаце. |
| [setSpaceWithin(float value)](#setSpaceWithin-float-) | Возвращает или задаёт величину расстояния между базовыми линиями в абзаце. |
...
| [getEastAsianLineBreak()](#getEastAsianLineBreak--) | Определяет, используется ли восточноазиатский разрыв строки в абзаце. |
| [setEastAsianLineBreak(byte value)](#setEastAsianLineBreak-byte-) | Определяет, используется ли восточноазиатский разрыв строки в абзаце. |
...
Инициализирует новый экземпляр класса [ParagraphFormat](../../com.aspose.slides/paragraphformat).
...
Возвращает или задаёт величину пространства перед первой строкой в абзаце без наследования. Положительное значение указывает процент от размера шрифта, который должен составлять пробел. Отрицательное значение указывает размер пробела в пунктах. Чтение/запись  float .
...
Возвращает или задаёт величину пространства после последней строки в абзаце без наследования. Положительное значение указывает процент от размера шрифта, который должен составлять пробел. Отрицательное значение указывает размер пробела в пунктах. Чтение/запись  float .
...
Определяет, используется ли восточноазиатский разрыв строки в абзаце. Наследование не применяется. Чтение/запись [NullableBool](../../com.aspose.slides/nullablebool).
...
Возвращает или задаёт отступ первой строки/висячий отступ абзаца без наследования. Висячий отступ может быть задан отрицательными значениями. Чтение/запись  float .
...
**Возвращаемое значение:**
[IParagraphFormatEffectiveData](../../com.aspose.slides/iparagraphformateffectivedata) - [IParagraphFormatEffectiveData](../../com.aspose.slides/iparagraphformateffectivedata).
