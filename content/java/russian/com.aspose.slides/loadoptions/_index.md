...
| [getDefaultRegularFont()](#getDefaultRegularFont--) | Возвращает или задает обычный шрифт, используемый в случае, если исходный шрифт не найден. |
| [setDefaultRegularFont(String value)](#setDefaultRegularFont-java.lang.String-) | Возвращает или задает обычный шрифт, используемый в случае, если исходный шрифт не найден. |
| [getDefaultSymbolFont()](#getDefaultSymbolFont--) | Возвращает или задает символный шрифт, используемый в случае, если исходный шрифт не найден. |
| [setDefaultSymbolFont(String value)](#setDefaultSymbolFont-java.lang.String-) | Возвращает или задает символный шрифт, используемый в случае, если исходный шрифт не найден. |
| [getDefaultAsianFont()](#getDefaultAsianFont--) | Возвращает или задает азиатский шрифт, используемый в случае, если исходный шрифт не найден. |
| [setDefaultAsianFont(String value)](#setDefaultAsianFont-java.lang.String-) | Возвращает или задает азиатский шрифт, используемый в случае, если исходный шрифт не найден. |
...
| [getBlobManagementOptions()](#getBlobManagementOptions--) | Представляет параметры, которые могут использоваться для управления поведением обработки Binary Large Objects (BLOB), например, использованием временных файлов или максимальным объёмом BLOB в памяти. |
| [setBlobManagementOptions(IBlobManagementOptions value)](#setBlobManagementOptions-com.aspose.slides.IBlobManagementOptions-) | Представляет параметры, которые могут использоваться для управления поведением обработки Binary Large Objects (BLOB), например, использованием временных файлов или максимальным объёмом BLOB в памяти. |
...
| [getDeleteEmbeddedBinaryObjects()](#getDeleteEmbeddedBinaryObjects--) | Определяет, будет ли Aspose.Slides удалять все внедрённые бинарные объекты при загрузке презентации. |
| [setDeleteEmbeddedBinaryObjects(boolean value)](#setDeleteEmbeddedBinaryObjects-boolean-) | Определяет, будет ли Aspose.Slides удалять все внедрённые бинарные объекты при загрузке презентации. |
...
Возвращает или задает обычный шрифт, используемый в случае, если исходный шрифт не найден. Чтение/запись String.
...
>  
>  // Используйте параметры загрузки, чтобы задать шрифты по умолчанию для обычного и азиатского текста
...
Возвращает или задает символный шрифт, используемый в случае, если исходный шрифт не найден. Чтение/запись String.
...
Возвращает или задает азиатский шрифт, используемый в случае, если исходный шрифт не найден. Чтение/запись String.
...
Это свойство имеет смысл, если файл презентации защищен паролем. Значение true означает, что необходимо загрузить только свойства документа из зашифрованного файла презентации, а пароль игнорировать. Значение false означает, что вся зашифрованная презентация должна быть загружена с использованием правильного пароля. Если презентация не зашифрована, значение свойства всегда игнорируется. Если свойства документа зашифрованного файла не публичны и значение свойства равно true, то свойства документа загрузить нельзя, будет выброшено исключение. Чтение/запись boolean.
...
Представляет параметры, которые могут использоваться для управления поведением обработки Binary Large Objects (BLOB), например, использованием временных файлов или максимальным объёмом BLOB в памяти. Эти параметры предназначены для настройки оптимального соотношения производительности и потребления памяти для конкретной среды или требований.

--------------------

Binary Large Object (BLOB) — это бинарные данные, хранящиеся как единый объект; BLOB может быть аудио, видео или сама презентация.
...
Указывает источники внешних шрифтов, используемых в презентации. Эти шрифты доступны презентации на протяжении всего её жизненного цикла и не разделяются с другими презентациями.
...
Определяет, будет ли Aspose.Slides удалять все внедрённые бинарные объекты при загрузке презентации.

Типы внедрённых бинарных объектов:
...
> ```
> Следующий пример показывает, как загрузить презентацию без каких-либо внедрённых бинарных объектов.
>  
>  LoadOptions loadOptions = new LoadOptions();
