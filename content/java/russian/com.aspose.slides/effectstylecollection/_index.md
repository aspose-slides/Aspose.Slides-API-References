...
**Возвращаемое значение:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffectStyle> - IGenericEnumerator, который можно использовать для обхода коллекции.
