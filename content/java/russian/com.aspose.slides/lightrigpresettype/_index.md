...
description: Константы, определяющие типы предустановленного освещения.
type: docs
url: /ru/com.aspose.slides/lightrigpresettype/
---
**Наследование:**
...
Константы, определяющие типы предустановок света.
## Поля
