...
| Метод | Описание |
| --- | --- |
| [addEffect(int effectType, int subtype, int triggerType)](#addEffect-int-int-int-) | Добавить новый эффект в конец текущей последовательности групповой анимации текста. |
...
Добавить новый эффект в конец текущей последовательности групповой анимации текста. Действительно только если количество текстовых абзацев равно или превышает количество эффектов в этой группе!
...
Список типов построения (например Параграф 1,2,3, Все сразу) анимации текста. Чтение/запись [BuildType](../../com.aspose.slides/buildtype).
