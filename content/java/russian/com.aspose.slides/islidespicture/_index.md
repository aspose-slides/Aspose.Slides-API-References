...
| [getImageTransform()](#getImageTransform--) | Возвращает набор эффектов трансформации изображения. |
### getImage() {#getImage--}
```
...
Возвращает набор эффектов трансформации изображения. Только для чтения [IImageTransformOperationCollection](../../com.aspose.slides/iimagetransformoperationcollection).
