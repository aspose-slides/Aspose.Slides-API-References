...
| Метод | Описание |
| --- | --- |
| [getRow()](#getRow--) | Возвращает индекс строки листа, в которой расположена ячейка. |
| [getColumn()](#getColumn--) | Возвращает индекс столбца листа, в котором расположена ячейка. |
...
Возвращает индекс строки листа, в которой расположена ячейка. Только для чтения int.
...
Возвращает индекс столбца листа, в котором расположена ячейка. Только для чтения int.
