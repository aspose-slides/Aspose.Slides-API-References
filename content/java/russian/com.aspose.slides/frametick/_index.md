...
description: Представляет обработчик тика кадра события FrameTickDelegate.FrameTickDelegate.
type: docs
url: /ru/com.aspose.slides/presentationplayer.frametick/
---```
public static interface PresentationPlayer.FrameTick
```

Представляет обработчик тика кадра события #FrameTickDelegate.FrameTickDelegate.
