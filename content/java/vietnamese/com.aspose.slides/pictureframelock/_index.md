...
description: Xác định các thao tác bị vô hiệu trên PictureFrame cha.
type: docs
url: /vi/com.aspose.slides/pictureframelock/
---
**Kế thừa:**
...
Xác định các thao tác bị vô hiệu trên PictureFrame cha.
## Phương thức
...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Xác định xem hình cần duy trì tỷ lệ khung hình khi thay đổi kích thước hay không. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Xác định xem hình cần duy trì tỷ lệ khung hình khi thay đổi kích thước hay không. |
...
Xác định xem hình cần duy trì tỷ lệ khung hình khi thay đổi kích thước hay không. Đọc/ghi boolean.
...
Xác định xem việc thay đổi đầu mũi tên có bị cấm hay không. Đọc/ghi boolean.
