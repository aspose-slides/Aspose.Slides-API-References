...
| [getFormat()](#getFormat--) | Trả về các kiểu tô đầy, đường viền, hiệu ứng của tiêu đề. |
...
Trả về các kiểu tô đầy, đường viền, hiệu ứng của tiêu đề. Chỉ đọc [IFormat](../../com.aspose.slides/iformat).
