...
| Phương thức | Mô tả |
| --- | --- |
| [get_Item(int columnIndex, int rowIndex)](#get-Item-int-int-) | Trả về ô tại các chỉ số cột và hàng được chỉ định. |
...
| [getFirstRow()](#getFirstRow--) | Xác định xem hàng đầu tiên của bảng có cần được vẽ với định dạng đặc biệt hay không. |
| [setFirstRow(boolean value)](#setFirstRow-boolean-) | Xác định xem hàng đầu tiên của bảng có cần được vẽ với định dạng đặc biệt hay không. |
| [getFirstCol()](#getFirstCol--) | Xác định xem cột đầu tiên của bảng có cần được vẽ với định dạng đặc biệt hay không. |
| [setFirstCol(boolean value)](#setFirstCol-boolean-) | Xác định xem cột đầu tiên của bảng có cần được vẽ với định dạng đặc biệt hay không. |
| [getLastRow()](#getLastRow--) | Xác định xem hàng cuối cùng của bảng có cần được vẽ với định dạng đặc biệt hay không. |
| [setLastRow(boolean value)](#setLastRow-boolean-) | Xác định xem hàng cuối cùng của bảng có cần được vẽ với định dạng đặc biệt hay không. |
| [getLastCol()](#getLastCol--) | Xác định xem cột cuối cùng của bảng có cần được vẽ với định dạng đặc biệt hay không. |
| [setLastCol(boolean value)](#setLastCol-boolean-) | Xác định xem cột cuối cùng của bảng có cần được vẽ với định dạng đặc biệt hay không. |
| [getHorizontalBanding()](#getHorizontalBanding--) | Xác định xem các hàng chẵn có cần được vẽ với định dạng khác không. |
| [setHorizontalBanding(boolean value)](#setHorizontalBanding-boolean-) | Xác định xem các hàng chẵn có cần được vẽ với định dạng khác không. |
| [getVerticalBanding()](#getVerticalBanding--) | Xác định xem các cột chẵn có cần được vẽ với định dạng khác không. |
| [setVerticalBanding(boolean value)](#setVerticalBanding-boolean-) | Xác định xem các cột chẵn có cần được vẽ với định dạng khác không. |
| [mergeCells(ICell cell1, ICell cell2, boolean allowSplitting)](#mergeCells-com.aspose.slides.ICell-com.aspose.slides.ICell-boolean-) | Hợp nhất các ô liền nhau. |
### get_Item(int columnIndex, int rowIndex) {#get-Item-int-int-}
```
public abstract ICell get_Item(int columnIndex, int rowIndex)
```

Trả về ô tại các chỉ số cột và hàng được chỉ định. Chỉ đọc [ICell](../../com.aspose.slides/icell).
...
Xác định xem hàng đầu tiên của bảng có cần được vẽ với định dạng đặc biệt hay không. Đọc/ghi boolean.
...
Xác định xem cột đầu tiên của bảng có cần được vẽ với định dạng đặc biệt hay không. Đọc/ghi boolean.
...
Xác định xem các hàng chẵn có cần được vẽ với định dạng khác không. Đọc/ghi boolean.
...
Xác định xem các cột chẵn có cần được vẽ với định dạng khác không. Đọc/ghi boolean.
