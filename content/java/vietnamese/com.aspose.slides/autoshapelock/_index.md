...
type: docs
url: /vi/com.aspose.slides/autoshapelock/
---
**Kế thừa:**  
...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Xác định liệu hình phải duy trì tỉ lệ khung hình khi thay đổi kích thước hay không. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Xác định liệu hình phải duy trì tỉ lệ khung hình khi thay đổi kích thước hay không. |
...
| [getTextLocked()](#getTextLocked--) | Xác định việc chỉnh sửa văn bản có bị cấm hay không. |
| [setTextLocked(boolean value)](#setTextLocked-boolean-) | Xác định việc chỉnh sửa văn bản có bị cấm hay không. |
...
Xác định liệu hình phải duy trì tỉ lệ khung hình khi thay đổi kích thước hay không. đọc/ghi boolean.
...
Xác định việc chỉnh sửa văn bản có bị cấm hay không. đọc/ghi boolean.
