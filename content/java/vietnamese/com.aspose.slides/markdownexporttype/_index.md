...
description: Kiểu tài liệu hiển thị.
type: docs
...
| Trường | Mô tả |
| --- | --- |
| [Sequential](#Sequential) | Hiển thị tất cả các mục riêng biệt. |
...
Hiển thị tất cả các mục riêng biệt. Từng cái một.
