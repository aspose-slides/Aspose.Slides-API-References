...
| [isFormatNotDefined()](#isFormatNotDefined--) | Trả về true nếu định dạng đường chưa được xác định (khi vừa tạo, mặc định). |
...
| [getCapStyle()](#getCapStyle--) | Trả về hoặc đặt kiểu đầu mũi của đường. |
| [setCapStyle(byte value)](#setCapStyle-byte-) | Trả về hoặc đặt kiểu đầu mũi của đường. |
...
| [getJoinStyle()](#getJoinStyle--) | Trả về hoặc đặt kiểu nối đường. |
| [setJoinStyle(byte value)](#setJoinStyle-byte-) | Trả về hoặc đặt kiểu nối đường. |
| [getMiterLimit()](#getMiterLimit--) | Trả về hoặc đặt giới hạn góc găm của một đường. |
| [setMiterLimit(float value)](#setMiterLimit-float-) | Trả về hoặc đặt giới hạn góc găm của một đường. |
...
| [equals(ILineFormat lineFormat)](#equals-com.aspose.slides.ILineFormat-) | Xác định xem hai thể hiện LineFormat có bằng nhau hay không. |
| [getEffective()](#getEffective--) | Lấy dữ liệu định dạng đường hiệu lực với việc kế thừa đã được áp dụng. |
### getVersion() {#getVersion--}
```
...
Trả về true nếu định dạng đường chưa được xác định (khi vừa tạo, mặc định). Chỉ đọc boolean.
...
Trả về hoặc đặt kiểu đầu mũi của đường. Đọc/ghi [LineCapStyle](../../com.aspose.slides/linecapstyle).
...
Trả về hoặc đặt kiểu nối đường. Đọc/ghi [LineJoinStyle](../../com.aspose.slides/linejoinstyle).
...
Trả về hoặc đặt giới hạn góc găm của một đường. Đọc/ghi float.
...
Lấy dữ liệu định dạng đường hiệu lực với việc kế thừa đã được áp dụng.

--------------------

> ```
> Ví dụ này minh họa cách lấy các thuộc tính định dạng đường hiệu lực của hình.
>  
