...
Biểu diễn một đối tượng OLE trên một bản trình chiếu.
...
>      // Ép kiểu shape thành OleObjectFrame
...
| [getLinkPathRelative()](#getLinkPathRelative--) | Trả về đường dẫn tương đối tới tệp được liên kết nếu có, nếu không trả về chuỗi rỗng. |
...
| [getUpdateAutomatic()](#getUpdateAutomatic--) | Xác định xem đối tượng nhúng được liên kết có tự động cập nhật khi bản trình chiếu được mở hoặc in hay không. |
| [setUpdateAutomatic(boolean value)](#setUpdateAutomatic-boolean-) | Xác định xem đối tượng nhúng được liên kết có tự động cập nhật khi bản trình chiếu được mở hoặc in hay không. |
...
Khi IsObjectIcon == false giá trị này sẽ bị bỏ qua. Chuỗi có thể bị cắt ngắn tùy thuộc vào kích thước của biểu tượng Ole.
...
Trả về đường dẫn tương đối tới tệp được liên kết nếu có, nếu không trả về chuỗi rỗng. Chỉ đọc String.
