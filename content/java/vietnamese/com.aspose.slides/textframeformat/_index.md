...
| [getThreeDFormat()](#getThreeDFormat--) | Trả về đối tượng ThreeDFormat mô tả các thuộc tính hiệu ứng 3D cho văn bản. |
...
| [getWrapText()](#getWrapText--) | Đúng nếu văn bản được cuộn lại ở lề của TextFrame. |
| [setWrapText(byte value)](#setWrapText-byte-) | Đúng nếu văn bản được cuộn lại ở lề của TextFrame. |
...
| [getCenterText()](#getCenterText--) | Nếu NullableBool.True thì văn bản sẽ được căn giữa theo chiều ngang trong hộp. |
| [setCenterText(byte value)](#setCenterText-byte-) | Nếu NullableBool.True thì văn bản sẽ được căn giữa theo chiều ngang trong hộp. |
...
| [getAutofitType()](#getAutofitType--) | Trả về hoặc đặt chế độ tự vừa khít của văn bản. |
| [setAutofitType(byte value)](#setAutofitType-byte-) | Trả về hoặc đặt chế độ tự vừa khít của văn bản. |
...
| [getColumnSpacing()](#getColumnSpacing--) | Trả về hoặc đặt khoảng cách giữa các cột văn bản trong khu vực văn bản (điểm). |
| [setColumnSpacing(double value)](#setColumnSpacing-double-) | Trả về hoặc đặt khoảng cách giữa các cột văn bản trong khu vực văn bản (điểm). |
| [getRotationAngle()](#getRotationAngle--) | Chỉ định góc xoay tùy chỉnh được áp dụng cho văn bản trong hộp bao quanh. |
| [setRotationAngle(float value)](#setRotationAngle-float-) | Chỉ định góc xoay tùy chỉnh được áp dụng cho văn bản trong hộp bao quanh. |
...
| [getKeepTextFlat()](#getKeepTextFlat--) | Lấy hoặc đặt việc giữ văn bản phẳng ngay cả khi đã áp dụng hiệu ứng Xoay 3D. |
| [setKeepTextFlat(boolean value)](#setKeepTextFlat-boolean-) | Lấy hoặc đặt việc giữ văn bản phẳng ngay cả khi đã áp dụng hiệu ứng Xoay 3D. |
...
Trả về đối tượng ThreeDFormat mô tả các thuộc tính hiệu ứng 3D cho văn bản. chỉ đọc [IThreeDFormat](../../com.aspose.slides/ithreedformat).
...
Đúng nếu văn bản được cuộn lại ở lề của TextFrame. Đọc/ghi [NullableBool](../../com.aspose.slides/nullablebool).
...
Nếu NullableBool.True thì văn bản sẽ được căn giữa theo chiều ngang trong hộp. Đọc/ghi [NullableBool](../../com.aspose.slides/nullablebool).
...
Trả về hoặc đặt chế độ tự vừa khít của văn bản. Đọc/ghi [TextAutofitType](../../com.aspose.slides/textautofittype).
...
Trả về hoặc đặt khoảng cách giữa các cột văn bản trong khu vực văn bản (điểm). Điều này chỉ áp dụng khi có hơn 1 cột. Giá trị này phải là số dương. Nếu không, giá trị sẽ được đặt thành 0. Đọc/ghi double.
...
Chỉ định góc xoay tùy chỉnh được áp dụng cho văn bản trong hộp bao quanh. Nếu không được chỉ định, sẽ sử dụng góc xoay của hình dạng đi kèm. Nếu được chỉ định, thì sẽ được áp dụng độc lập với hình dạng. Nghĩa là hình dạng có thể có góc xoay riêng cộng với văn bản cũng có góc xoay. Giá trị kết quả của góc quay trực quan được tổng hợp từ thuộc tính này và kiểu dọc đã định nghĩa trước trong thuộc tính TextVerticalType. Đọc/ghi float.
...
Lấy hoặc đặt việc giữ văn bản phẳng ngay cả khi đã áp dụng hiệu ứng Xoay 3D. Đọc/ghi boolean.
...
**Trả về:**
[ITextFrameFormatEffectiveData](../../com.aspose.slides/itextframeformateffectivedata) - một [ITextFrameFormatEffectiveData](../../com.aspose.slides/itextframeformateffectivedata).