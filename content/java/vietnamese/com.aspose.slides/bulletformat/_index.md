...
description: Biểu diễn các thuộc tính định dạng dấu đầu dòng của đoạn văn.
type: docs
url: /vi/com.aspose.slides/bulletformat/
---
**Inheritance:**
...
Biểu diễn các thuộc tính định dạng dấu đầu dòng của đoạn văn.
## Phương thức
...
| [getNumberedBulletStartWith()](#getNumberedBulletStartWith--) | Trả về hoặc đặt số đầu tiên được sử dụng cho nhóm các dấu đầu dòng có đánh số không kế thừa. |
| [setNumberedBulletStartWith(short value)](#setNumberedBulletStartWith-short-) | Trả về hoặc đặt số đầu tiên được sử dụng cho nhóm các dấu đầu dòng có đánh số không kế thừa. |
| [getNumberedBulletStyle()](#getNumberedBulletStyle--) | Trả về hoặc đặt kiểu của dấu đầu dòng có đánh số không kế thừa. |
| [setNumberedBulletStyle(byte value)](#setNumberedBulletStyle-byte-) | Trả về hoặc đặt kiểu của dấu đầu dòng có đánh số không kế thừa. |
...
| [applyDefaultParagraphIndentsShifts()](#applyDefaultParagraphIndentsShifts--) | Đặt các dịch chuyển mặc định khác không cho Indent và MarginLeft của đoạn văn hiệu quả khi bật dấu đầu dòng (giống như PowerPoint làm khi bật dấu đầu dòng/đánh số cho đoạn văn). |
...
Giá trị chiều cao âm có nghĩa là chiều cao được tính bằng điểm, và giá trị dương có nghĩa là chiều cao là tỷ lệ phần trăm của văn bản xung quanh.
...
Trả về hoặc đặt số đầu tiên được sử dụng cho nhóm các dấu đầu dòng có đánh số không kế thừa. Đọc/ghi short .
...
Trả về hoặc đặt kiểu của dấu đầu dòng có đánh số không kế thừa. Đọc/ghi [NumberedBulletStyle](../../com.aspose.slides/numberedbulletstyle).
...
Đặt các dịch chuyển mặc định khác không cho Indent và MarginLeft của đoạn văn hiệu quả khi bật dấu đầu dòng (giống như PowerPoint làm khi bật dấu đầu dòng/đánh số cho đoạn văn). Nếu dấu đầu dòng bị tắt thì chỉ đặt lại Indent và MarginLeft của đoạn văn (giống như PowerPoint làm khi tắt dấu đầu dòng/đánh số cho đoạn văn). Các dịch chuyển dấu đầu dòng được áp dụng dựa trên ngữ cảnh hiện tại – IBulletFormat.Type, .NumberedBulletStyle và FontHeight của phần đầu tiên. Các dịch chuyển khác không được áp dụng cho Indent và MarginLeft hiệu quả của đoạn hiện tại (kết quả là các giá trị trở thành giá trị cục bộ).
