...
description: Biểu diễn tập hợp các thẻ, các cặp chuỗi do người dùng định nghĩa
type: docs
...
Biểu diễn tập hợp các thẻ (cặp chuỗi do người dùng định nghĩa)
...
| [get_Item(String name)](#get-Item-java.lang.String-) | Trả về hoặc đặt một cặp khóa và giá trị của thẻ. |
| [set_Item(String name, String value)](#set-Item-java.lang.String-java.lang.String-) | Trả về hoặc đặt một cặp khóa và giá trị của thẻ. |
...
Trả về số lượng thẻ trong bộ sưu tập. int chỉ đọc.
...
**Trả về:**
boolean - Đúng nếu bộ sưu tập chứa một thẻ với khóa được chỉ định; nếu không, sai.
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| index | int | Chỉ mục bắt đầu từ 0 của thẻ cần xóa. |
### clear() {#clear--}
```
...
**Trả về:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.ms.System.Collections.Generic.KeyValuePair<java.lang.String,java.lang.String>> - Một IGenericEnumerator có thể được dùng để lặp qua bộ sưu tập.
...
**Trả về:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.ms.System.Collections.Generic.KeyValuePair<java.lang.String,java.lang.String>> - Một java.util.Iterator cho toàn bộ bộ sưu tập.