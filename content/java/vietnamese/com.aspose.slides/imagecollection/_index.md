...
| [addImage(IPPImage imageSource)](#addImage-com.aspose.slides.IPPImage-) | Thêm một bản sao của hình ảnh từ một bản trình bày khác. |
| [addImage(IImage image)](#addImage-com.aspose.slides.IImage-) | Thêm một hình ảnh vào bản trình bày. |
| [addImage(InputStream stream)](#addImage-java.io.InputStream-) | Thêm một hình ảnh vào bản trình bày từ luồng. |
| [addImage(InputStream stream, int loadingStreamBehavior)](#addImage-java.io.InputStream-int-) | Tạo và thêm một hình ảnh vào bản trình bày từ luồng. |
| [addImage(byte[] buffer)](#addImage-byte---) | Thêm một hình ảnh vào bản trình bày từ bộ đệm được chỉ định. |
| [addImage(ISvgImage svgImage)](#addImage-com.aspose.slides.ISvgImage-) | Thêm một hình ảnh vào bản trình bày từ đối tượng Svg. |
...
| [isSynchronized()](#isSynchronized--) | Trả về giá trị cho biết liệu việc truy cập bộ sưu tập có được đồng bộ (an toàn với đa luồng) hay không. |
...
Phương thức này chuyển đổi các tệp metafile WMF/EMF sang ảnh PNG raster trước khi chèn vào bản trình bày.
...
Phương thức này có thể thêm các tệp metafile WMF/EMF vào bản trình bày mà không chuyển chúng sang ảnh PNG raster.
...
**Trả về:**  
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IPPImage> - Một IGenericEnumerator có thể được sử dụng để duyệt qua bộ sưu tập.
