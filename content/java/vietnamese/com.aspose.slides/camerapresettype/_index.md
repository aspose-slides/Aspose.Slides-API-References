...
second_title: Tham khảo API Aspose.Slides dành cho Java
description: Các hằng số định nghĩa loại cài đặt máy ảnh.
type: docs
url: /vi/com.aspose.slides/camerapresettype/
---
**Kế thừa:**
...
Các hằng số định nghĩa loại cài đặt máy ảnh.
## Trường
