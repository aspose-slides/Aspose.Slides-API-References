...
description: Lớp này cho phép xuất video và tệp âm thanh thành HTML
type: docs
...
Lớp này cho phép xuất video và tệp âm thanh thành HTML
## Hàm khởi tạo
...
| fileName | java.lang.String | Tên của tệp HTML |
| baseUri | java.lang.String | URI cơ sở sẽ được sử dụng cho việc tạo liên kết |
...
Được gọi để ghi phần đầu tài liệu html. Được gọi một lần cho mỗi lần chuyển đổi bài thuyết trình.
...
Được gọi để ghi phần cuối tài liệu html. Được gọi một lần cho mỗi lần chuyển đổi bài thuyết trình.
...
Được gọi trước khi vẽ shape. Được gọi một lần cho mỗi shape. Nếu hàm này ghi bất kỳ nội dung nào vào generator, việc tạo ảnh slide hiện tại sẽ kết thúc, đoạn html được thêm sẽ được chèn và ảnh mới sẽ được bắt đầu trên ảnh trước đó.
...
Hàm này được gọi trước khi render shape sang SVG để cho phép người dùng kiểm soát SVG kết quả.
...
Xác định nơi đối tượng nên được lưu trữ. Phương thức này được gọi một lần cho mỗi id đối tượng. Không đảm bảo rằng sẽ không có hai đối tượng có cùng dữ liệu, semanticName và contentType nhưng có id khác nhau.
