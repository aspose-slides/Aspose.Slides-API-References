...
| [remove(ICaptions captions)](#remove-com.aspose.slides.ICaptions-) | Xóa phụ đề đóng đã chỉ định khỏi bộ sưu tập. |
...
Thêm phụ đề đóng WebVTT vào cuối bộ sưu tập từ luồng.
...
Xóa phụ đề đóng đã chỉ định khỏi bộ sưu tập.
