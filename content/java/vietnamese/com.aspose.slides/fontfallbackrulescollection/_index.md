...
Biểu diễn một bộ sưu tập các quy tắc FontFallBack, được người dùng định nghĩa
## Các hàm khởi tạo
...
| Phương thức | Mô tả |
| --- | --- |
| [size()](#size--) | Lấy số lượng quy tắc thực sự có trong bộ sưu tập. |
...
| [isSynchronized()](#isSynchronized--) | Trả về một giá trị cho biết việc truy cập bộ sưu tập có được đồng bộ (an toàn luồng) hay không. |
...
Lấy số lượng quy tắc thực sự có trong bộ sưu tập. int chỉ đọc.
...
Lấy quy tắc tại chỉ mục được chỉ định. [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule) chỉ đọc.
...
Trả về một giá trị cho biết việc truy cập bộ sưu tập có được đồng bộ (an toàn luồng) hay không. boolean chỉ đọc.
