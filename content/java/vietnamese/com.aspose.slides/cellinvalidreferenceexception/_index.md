...
Ngoại lệ được ném khi gặp một tham chiếu ô không hợp lệ.
## Các hàm khởi tạo
...
| [CellInvalidReferenceException(String message, RuntimeException innerException)](#CellInvalidReferenceException-java.lang.String-java.lang.RuntimeException-) | Khởi tạo một thể hiện mới của lớp [CellInvalidReferenceException](../../com.aspose.slides/cellinvalidreferenceexception) với một thông báo lỗi được chỉ định và một tham chiếu tới ngoại lệ bên trong là nguyên nhân gây ra ngoại lệ này. |
...
Khởi tạo một thể hiện mới của lớp [CellInvalidReferenceException](../../com.aspose.slides/cellinvalidreferenceexception) với một thông báo lỗi được chỉ định và một tham chiếu tới ngoại lệ bên trong là nguyên nhân gây ra ngoại lệ này.
