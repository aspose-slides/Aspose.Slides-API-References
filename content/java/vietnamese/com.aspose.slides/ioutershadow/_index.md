...
| [setRectangleAlign(byte value)](#setRectangleAlign-byte-) | Cân hình chữ nhật. |
...
| [getScaleHorizontal()](#getScaleHorizontal--) | Hệ số co dọc ngang, tính bằng phần trăm của kích thước gốc. |
| [setScaleHorizontal(double value)](#setScaleHorizontal-double-) | Hệ số co dọc ngang, tính bằng phần trăm của kích thước gốc. |
| [getScaleVertical()](#getScaleVertical--) | Hệ số co dọc dọc, tính bằng phần trăm của kích thước gốc. |
| [setScaleVertical(double value)](#setScaleVertical-double-) | Hệ số co dọc dọc, tính bằng phần trăm của kích thước gốc. |
...
Hướng của bóng, tính bằng độ. Giá trị mặc định - 0 � (left-to-right). Đọc/ghi float.
...
Hệ số co dọc ngang, tính bằng phần trăm của kích thước gốc. Negative scaling causes a flip. Giá trị mặc định - 100 %. Đọc/ghi double.
...
Hệ số co dọc dọc, tính bằng phần trăm của kích thước gốc. Negative scaling causes a flip. Giá trị mặc định - 100 %. Đọc/ghi double.
