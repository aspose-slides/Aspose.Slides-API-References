...
| [MathBlock(IMathElement mathElement)](#MathBlock-com.aspose.slides.IMathElement-) | Tạo một khối toán học mới và đặt phần tử được chỉ định vào trong đó |
| [MathBlock(System.Collections.Generic.IGenericEnumerable<IMathElement> mathElements)](#MathBlock-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.slides.IMathElement--) | Tạo một khối toán học mới và đặt các phần tử được chỉ định vào trong đó |
## Các phương thức

| Phương thức | Mô tả |
| --- | --- |
| [getCount()](#getCount--) | Lấy số lượng các yếu tố toán học con thực tế được chứa trong bộ sưu tập. |
| [get_Item(int index)](#get-Item-int-) | Lấy hoặc đặt IMathElement tại chỉ số được chỉ định. |
| [set_Item(int index, IMathElement value)](#set-Item-int-com.aspose.slides.IMathElement-) | Lấy hoặc đặt IMathElement tại chỉ số được chỉ định. |
...
| [getParent_Immediate()](#getParent-Immediate--) | Trả về đối tượng Parent\_Immediate. |
| [add(IMathElement item)](#add-com.aspose.slides.IMathElement-) | Thêm một yếu tố toán học vào cuối bộ sưu tập. |
...
| [indexOf(IMathElement item)](#indexOf-com.aspose.slides.IMathElement-) | Xác định chỉ số của một yếu tố toán học cụ thể trong bộ sưu tập. |
| [insert(int index, IMathElement item)](#insert-int-com.aspose.slides.IMathElement-) | Chèn một MathElement vào bộ sưu tập tại chỉ số được chỉ định. |
| [removeAt(int index)](#removeAt-int-) | Xóa phần tử tại chỉ số được chỉ định trong bộ sưu tập. |
| [join(IMathElement mathElement)](#join-com.aspose.slides.IMathElement-) | Kết hợp một yếu tố toán học với khối toán học này |
| [join(String mathText)](#join-java.lang.String-) | Kết hợp một văn bản toán học với khối toán học này |
| [joinBlock(IMathBlock other)](#joinBlock-com.aspose.slides.IMathBlock-) | Kết hợp một khối toán học khác với khối này |
| [delimit(char separatorCharacter)](#delimit-char-) | Phân tách các phần tử con bằng ký tự phân cách (không có dấu ngoặc) |
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | Bao quanh các phần tử con của khối này bằng các ký tự chỉ định như dấu ngoặc hoặc các ký tự khác làm khung |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | Bao quanh các phần tử con của khối này bằng các ký tự chỉ định như dấu ngoặc hoặc các ký tự khác làm khung và phân tách bằng ký tự phân cách |
...
Tạo một khối toán học mới và đặt phần tử được chỉ định vào trong đó
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| mathElement | [IMathElement](../../com.aspose.slides/imathelement) | Yếu tố toán học để đặt vào khối |
...
Tạo một khối toán học mới và đặt các phần tử được chỉ định vào trong đó
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| mathElements | com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.slides.IMathElement> | Các yếu tố toán học để đặt vào khối |
...
Lấy số lượng các yếu tố toán học con thực tế được chứa trong bộ sưu tập. int chỉ đọc.
...
Lấy hoặc đặt IMathElement tại chỉ số được chỉ định.
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| index | int | Chỉ mục dựa trên số 0 của mục |

**Trả về:**
[IMathElement](../../com.aspose.slides/imathelement) - Yếu tố toán học.
...
| --- | --- | --- |
| index | int | Chỉ mục dựa trên số 0 của mục |
| value | [IMathElement](../../com.aspose.slides/imathelement) | Yếu tố toán học. |
...
Thêm một yếu tố toán học vào cuối bộ sưu tập.
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | IMathElement để thêm vào cuối bộ sưu tập. |
...
**Trả về:**
boolean - true nếu item được tìm thấy trong bộ sưu tập; ngược lại, false.
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| array | [IMathElement\[\]](../../com.aspose.slides/imathelement) | Mảng cần sao chép tới. |
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | Đối tượng cần xóa khỏi bộ sưu tập. |

**Trả về:**
boolean - true nếu item đã được xóa thành công khỏi bộ sưu tập; ngược lại, false. Phương thức này cũng trả về false nếu item không được tìm thấy trong bộ sưu tập gốc.
### iterator() {#iterator--}
```
...
Xác định chỉ số của một yếu tố toán học cụ thể trong bộ sưu tập.
...
**Trả về:**
int - Chỉ số của item nếu được tìm thấy trong bộ sưu tập; nếu không, -1.
### insert(int index, IMathElement item) {#insert-int-com.aspose.slides.IMathElement-}
```
public final void insert(int index, IMathElement item)
```

Chèn một MathElement vào bộ sưu tập tại chỉ số được chỉ định.
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| index | int | Chỉ mục dựa trên số 0 mà tại đó MathElement sẽ được chèn. |
| item | [IMathElement](../../com.aspose.slides/imathelement) | MathElement cần chèn. |
...
Kết hợp một yếu tố toán học với khối toán học này
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| mathElement | [IMathElement](../../com.aspose.slides/imathelement) | Yếu tố cần được kết hợp |

**Trả về:**
[IMathBlock](../../com.aspose.slides/imathblock) - Bản hiện tại của IMathBlock
### join(String mathText) {#join-java.lang.String-}
```
public IMathBlock join(String mathText)
```

Kết hợp một văn bản toán học với khối toán học này
...
**Trả về:**
[IMathBlock](../../com.aspose.slides/imathblock) - Một IMathBlock mới chứa instance này và đối số đã chỉ định
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| other | [IMathBlock](../../com.aspose.slides/imathblock) | Khối cần được kết hợp |

**Trả về:**
[IMathBlock](../../com.aspose.slides/imathblock) - khối toán học này sau khi kết hợp
...
**Trả về:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - Yếu tố toán học loại [IMathDelimiter](../../com.aspose.slides/imathdelimiter)
### enclose(char beginningCharacter, char endingCharacter) {#enclose-char-char-}
```
public IMathDelimiter enclose(char beginningCharacter, char endingCharacter)
```

Bao quanh các phần tử con của khối này bằng các ký tự chỉ định như dấu ngoặc hoặc các ký tự khác làm khung
...
**Trả về:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - Yếu tố toán học loại [IMathDelimiter](../../com.aspose.slides/imathdelimiter) bao gồm các ký tự chỉ định làm khung
...
Bao quanh các phần tử con của khối này bằng các ký tự chỉ định như dấu ngoặc hoặc các ký tự khác làm khung và phân tách bằng ký tự phân cách
...
**Trả về:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - Yếu tố toán học loại [IMathDelimiter](../../com.aspose.slides/imathdelimiter) bao gồm các ký tự chỉ định làm khung và ký tự phân cách
...
**Trả về:**
[IMathArray](../../com.aspose.slides/imatharray) - Đối tượng mới của loại [IMathArray](../../com.aspose.slides/imatharray)
