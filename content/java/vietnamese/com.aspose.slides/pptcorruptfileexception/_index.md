...
description: Ngoại lệ được ném khi tệp trình chiếu có khả năng bị hỏng.
type: docs
url: /vi/com.aspose.slides/pptcorruptfileexception/
---
**Kế thừa:**
...
Exception được ném khi tệp trình chiếu có khả năng bị hỏng.
## Các hàm tạo

| Constructor | Description |
| --- | --- |
| [PptCorruptFileException()](#PptCorruptFileException--) | Hàm tạo mặc định. |
| [PptCorruptFileException(String message)](#PptCorruptFileException-java.lang.String-) | Hàm tạo cho phép thêm thông điệp vào exception này. |
| [PptCorruptFileException(String message, RuntimeException exception)](#PptCorruptFileException-java.lang.String-java.lang.RuntimeException-) | Hàm tạo cho một exception chứa thông điệp và một exception nhúng. |
...
Hàm tạo cho phép thêm thông điệp vào exception này.
...
Hàm tạo cho một exception chứa thông điệp và một exception nhúng.

**Tham số:**
| Parameter | Type | Description |
| --- | --- | --- |
| message | java.lang.String | message |
| exception | java.lang.RuntimeException | exception gốc |