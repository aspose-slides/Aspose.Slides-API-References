...
**Tất cả các Interface đã thực hiện:**
...
| Hàm khởi tạo | Mô tả |
| --- | --- |
| [MathematicalText()](#MathematicalText--) | Hàm khởi tạo mặc định (tạo giá trị String.Empty) |
...
Hàm khởi tạo mặc định (tạo giá trị String.Empty)
