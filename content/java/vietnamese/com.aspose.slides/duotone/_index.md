...
description: Đại diện cho hiệu ứng Duotone.
type: docs
...
Đại diện cho hiệu ứng Duotone. Đối với mỗi pixel, kết hợp Color1 và Color2 thông qua nội suy tuyến tính để xác định màu mới cho pixel đó.
...
| [getEffective()](#getEffective--) | Lấy dữ liệu hiệu ứng Duotone thực tế với kế thừa được áp dụng. |
...
| [hashCode()](#hashCode--) | Đóng vai trò là hàm băm cho một loại cụ thể. |
...
Lấy dữ liệu hiệu ứng Duotone thực tế với kế thừa được áp dụng.
...
Đóng vai trò là hàm băm cho một loại cụ thể.
