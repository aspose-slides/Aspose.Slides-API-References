...
| Phương thức | Mô tả |
| --- | --- |
| [getBinaryData()](#getBinaryData--) | Trả về bản sao dữ liệu của một hình ảnh. |
| [getImage()](#getImage--) | Trả về bản sao của một hình ảnh. |
...
| [getWidth()](#getWidth--) | Trả về chiều rộng của một hình ảnh. |
| [getHeight()](#getHeight--) | Trả về chiều cao của một hình ảnh. |
| [getX()](#getX--) | Trả về độ dịch X của một hình ảnh. |
| [getY()](#getY--) | Trả về độ dịch Y của một hình ảnh. |
### getBinaryData() {#getBinaryData--}
```
public abstract byte[] getBinaryData()
```

Trả về bản sao dữ liệu của một hình ảnh. Chỉ đọc byte[].
...
Trả về bản sao của một hình ảnh. Chỉ đọc \#getImage.getImage.
...
Thay thế hình ảnh. Chú ý: khi Image là metafile - nó sẽ được raster hóa. Hãy sử dụng replaceImage(byte[]) thay thế
...
Trả về chiều rộng của một hình ảnh. Chỉ đọc int.
...
Trả về chiều cao của một hình ảnh. Chỉ đọc int.
...
Trả về độ dịch X của một hình ảnh. Chỉ đọc int.
...
Trả về độ dịch Y của một hình ảnh. Chỉ đọc int.
