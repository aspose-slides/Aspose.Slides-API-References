...
description: Đại diện cho một bộ sưu tập các phần tử đầu ra cho IWebDocument.
type: docs
...
Đại diện cho một bộ sưu tập các phần tử đầu ra cho IWebDocument.
## Phương thức
...
**Trả về:**
[IOutputFile](../../com.aspose.slides/ioutputfile) - [IOutputFile](../../com.aspose.slides/ioutputfile) đối tượng cho context object.
...
**Trả về:**
[IOutputFile](../../com.aspose.slides/ioutputfile) - [IOutputFile](../../com.aspose.slides/ioutputfile) đối tượng cho image.
...
**Trả về:**
[IOutputFile](../../com.aspose.slides/ioutputfile) - [IOutputFile](../../com.aspose.slides/ioutputfile) đối tượng cho audio.
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| path | java.lang.String | Đường dẫn tệp nơi phông chữ xuất sẽ được lưu. |
...
**Trả về:**
[IOutputFile](../../com.aspose.slides/ioutputfile) - Một [IOutputFile](../../com.aspose.slides/ioutputfile) thể hiện cho phông chữ đã tạo.
...
**Trả về:**
[IOutputFile](../../com.aspose.slides/ioutputfile) - [IOutputFile](../../com.aspose.slides/ioutputfile) đối tượng cho text content.
