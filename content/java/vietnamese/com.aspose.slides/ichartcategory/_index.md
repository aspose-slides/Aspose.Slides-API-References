...
| [getGroupingLevels()](#getGroupingLevels--) | Bộ chứa được quản lý của các giá trị trong các mức nhóm danh mục biểu đồ. |
...
Để thay đổi giá trị của thuộc tính này (cho tất cả danh mục trong bộ sưu tập) đặt giá trị mới cho thuộc tính [ChartCategoryCollection.getUseCells()](../../com.aspose.slides/chartcategorycollection\#getUseCells--) property.
...
Bộ chứa được quản lý của các giá trị trong các mức nhóm danh mục biểu đồ. Danh mục đa cấp chứa nhiều hơn một mức nhóm. Chỉ mục các mức nhóm bắt đầu từ không. Chỉ đọc [IChartCategoryLevelsManager](../../com.aspose.slides/ichartcategorylevelsmanager).
