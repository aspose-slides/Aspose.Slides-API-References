...
| [isSynchronized()](#isSynchronized--) | Trả về một giá trị cho biết việc truy cập vào tập hợp có được đồng bộ (an toàn với đa luồng) hay không. |
...
**Trả về:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ITextAnimation> - A IGenericEnumerator có thể được sử dụng để duyệt qua tập hợp.
...
Trả về một giá trị cho biết việc truy cập vào tập hợp có được đồng bộ (an toàn với đa luồng) hay không. boolean chỉ đọc.
