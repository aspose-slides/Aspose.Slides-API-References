...
| [removeAt(int index)](#removeAt-int-) | Xóa phần tử tại chỉ mục được chỉ định trong tập hợp. |
...
**Trả về:**
int - Chỉ mục mà tab đã được thêm.
### clear() {#clear--}
```
...
Xóa phần tử tại chỉ mục được chỉ định trong tập hợp.
