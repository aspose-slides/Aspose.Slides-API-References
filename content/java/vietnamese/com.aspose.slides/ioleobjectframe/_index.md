...
description: Biểu diễn một đối tượng OLE trên slide.
type: docs
...
Biểu diễn một đối tượng OLE trên slide.
## Phương thức
...
| [getEmbeddedData()](#getEmbeddedData--) | Lấy thông tin về dữ liệu nhúng OLE. |
| [setEmbeddedData(IOleEmbeddedDataInfo embeddedData)](#setEmbeddedData-com.aspose.slides.IOleEmbeddedDataInfo-) | Đặt thông tin về dữ liệu nhúng OLE. |
...
| [getLinkFileName()](#getLinkFileName--) | Trả về đường dẫn đầy đủ tới tệp liên kết. |
| [getLinkPathLong()](#getLinkPathLong--) | Trả về đường dẫn đầy đủ tới tệp liên kết. |
| [setLinkPathLong(String value)](#setLinkPathLong-java.lang.String-) | Trả về đường dẫn đầy đủ tới tệp liên kết. |
| [getLinkPathRelative()](#getLinkPathRelative--) | Trả về đường dẫn tương đối tới tệp liên kết nếu có, nếu không trả về chuỗi trống. |
| [getEmbeddedFileLabel()](#getEmbeddedFileLabel--) | Trả về tên tệp của đối tượng OLE nhúng |
| [getEmbeddedFileName()](#getEmbeddedFileName--) | Trả về đường dẫn của đối tượng OLE nhúng |
...
| [getUpdateAutomatic()](#getUpdateAutomatic--) | Xác định liệu đối tượng nhúng được liên kết có tự động cập nhật khi bài thuyết trình được mở hoặc in hay không. |
| [setUpdateAutomatic(boolean value)](#setUpdateAutomatic-boolean-) | Xác định liệu đối tượng nhúng được liên kết có tự động cập nhật khi bài thuyết trình được mở hoặc in hay không. |
...
Lấy thông tin về dữ liệu nhúng OLE. Chỉ đọc [IOleEmbeddedDataInfo](../../com.aspose.slides/ioleembeddeddatainfo).
...
Trả về đường dẫn đầy đủ tới tệp liên kết. Tên tệp ngắn sẽ được sử dụng. Chỉ đọc String.
...
Trả về đường dẫn tương đối tới tệp liên kết nếu có, nếu không trả về chuỗi trống. Chỉ đọc String.
...
Trả về tên tệp của đối tượng OLE nhúng
...
Xác định liệu đối tượng nhúng được liên kết có tự động cập nhật khi bài thuyết trình được mở hoặc in hay không. Đọc/ghi boolean.
