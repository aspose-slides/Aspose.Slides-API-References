...
description: Xác định chức năng dấu nhấn bao gồm một cơ sở và một ký tự dấu nhấn kết hợp. Ví dụ ud835udc4eu0301
type: docs
...
Xác định chức năng dấu nhấn, bao gồm một cơ sở và một ký tự dấu nhấn kết hợp. Ví dụ: \\ud835\\udc4e\\u0301
...
| [getCharacter()](#getCharacter--) | Ký tự dấu nhấn Giá trị phải nằm trong phạm vi (U+0300\\u2013U+036F) hoặc (U+20D0\\u2013U+20EF) Giá trị mặc định: Ký tự dấu mũ kết hợp (U+0302) |
| [setCharacter(char value)](#setCharacter-char-) | Ký tự dấu nhấn Giá trị phải nằm trong phạm vi (U+0300\\u2013U+036F) hoặc (U+20D0\\u2013U+20EF) Giá trị mặc định: Ký tự dấu mũ kết hợp (U+0302) |
...
Ký tự dấu nhấn Giá trị phải nằm trong phạm vi (U+0300\\u2013U+036F) hoặc (U+20D0\\u2013U+20EF) Giá trị mặc định: Ký tự dấu mũ kết hợp (U+0302)
