...
| Phương thức | Mô tả |
| --- | --- |
| [getScale()](#getScale--) | Xác định tỷ lệ thu phóng của chế độ xem tính bằng phần trăm. |
| [setScale(int value)](#setScale-int-) | Xác định tỷ lệ thu phóng của chế độ xem tính bằng phần trăm. |
| [getVariableScale()](#getVariableScale--) | Xác định rằng nội dung chế độ xem sẽ tự động thu phóng để phù hợp nhất với kích thước cửa sổ hiện tại. |
| [setVariableScale(boolean value)](#setVariableScale-boolean-) | Xác định rằng nội dung chế độ xem sẽ tự động thu phóng để phù hợp nhất với kích thước cửa sổ hiện tại. |
...
Xác định tỷ lệ thu phóng của chế độ xem tính bằng phần trăm. Đọc/ghi int.
...
Xác định rằng nội dung chế độ xem sẽ tự động thu phóng để phù hợp nhất với kích thước cửa sổ hiện tại. Đọc/ghi boolean.
...
>      // Thêm hướng dẫn vẽ dọc mới sang phía bên phải của trung tâm slide
