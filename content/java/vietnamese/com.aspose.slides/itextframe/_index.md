...
| [getHyperlinkQueries()](#getHyperlinkQueries--) | Cung cấp truy cập dễ dàng tới các siêu liên kết chứa trong đó. |
| [getParentShape()](#getParentShape--) | Trả về hình dạng cha hoặc null nếu đối tượng cha không thực thi giao diện IShape. Chỉ đọc [IShape](../../com.aspose.slides/ishape). |
| [getParentCell()](#getParentCell--) | Trả về ô cha hoặc null nếu đối tượng cha không thực thi giao diện ICell. |
...
| [highlightText(String text, Color highlightColor)](#highlightText-java.lang.String-java.awt.Color-) | Tô sáng tất cả các khớp của đoạn văn mẫu bằng màu đã chỉ định. |
| [splitTextByColumns()](#splitTextByColumns--) | Tách nội dung văn bản của [ITextFrame](../../com.aspose.slides/itextframe) thành một mảng các chuỗi, trong đó mỗi phần tử tương ứng với một cột văn bản riêng biệt trong khung. |
| [highlightText(String text, Color highlightColor, ITextHighlightingOptions options)](#highlightText-java.lang.String-java.awt.Color-com.aspose.slides.ITextHighlightingOptions-) | Tô sáng tất cả các khớp của đoạn văn mẫu bằng màu đã chỉ định. |
| [highlightText(String text, Color highlightColor, ITextSearchOptions options, IFindResultCallback callback)](#highlightText-java.lang.String-java.awt.Color-com.aspose.slides.ITextSearchOptions-com.aspose.slides.IFindResultCallback-) | Tô sáng tất cả các khớp của đoạn văn mẫu bằng màu đã chỉ định. |
| [highlightRegex(Pattern regex, Color highlightColor, IFindResultCallback callback)](#highlightRegex-java.util.regex.Pattern-java.awt.Color-com.aspose.slides.IFindResultCallback-) | Tô sáng tất cả các khớp của biểu thức chính quy bằng màu đã chỉ định. |
| [highlightRegex(String regex, Color highlightColor, ITextHighlightingOptions options)](#highlightRegex-java.lang.String-java.awt.Color-com.aspose.slides.ITextHighlightingOptions-) | Tô sáng tất cả các khớp của biểu thức chính quy bằng màu đã chỉ định. |
...
Cung cấp truy cập dễ dàng tới các siêu liên kết chứa trong đó. Chỉ đọc [IHyperlinkQueries](../../com.aspose.slides/ihyperlinkqueries).
...
Trả về hình dạng cha hoặc null nếu đối tượng cha không thực thi giao diện IShape. Chỉ đọc [IShape](../../com.aspose.slides/ishape).
...
Trả về ô cha hoặc null nếu đối tượng cha không thực thi giao diện ICell. Chỉ đọc [ICell](../../com.aspose.slides/icell).
...
Tô sáng tất cả các khớp của đoạn văn mẫu bằng màu đã chỉ định.

**Tham số:**
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| text | java.lang.String | Văn bản cần tô sáng. |
| highlightColor | java.awt.Color | Màu sắc để tô sáng văn bản. |
### splitTextByColumns() {#splitTextByColumns--}
```
public abstract String[] splitTextByColumns()
```

Tách nội dung văn bản của [ITextFrame](../../com.aspose.slides/itextframe) thành một mảng các chuỗi, trong đó mỗi phần tử tương ứng với một cột văn bản riêng biệt trong khung.
...
>  try {
>      // Lấy hình dạng đầu tiên trên slide và chuyển đổi sang ITextFrame
...
Nếu khung văn bản không chứa nhiều cột, mảng trả về sẽ có một phần tử duy nhất chứa toàn bộ văn bản. Các cột trống sẽ được đại diện bằng các chuỗi rỗng trong mảng.
...
>      // tô sáng tất cả các từ 'the' riêng biệt
...
Tô sáng tất cả các khớp của biểu thức chính quy bằng màu đã chỉ định.
...
>      // tô sáng tất cả các từ có độ dài 5 ký tự hoặc hơn
...
>  try {
>      Pattern regex = Pattern.compile("\\b[^\\s]{5,}\\b");
>      // Thay thế tất cả các từ có độ dài 5 ký tự hoặc hơn bằng '***'
