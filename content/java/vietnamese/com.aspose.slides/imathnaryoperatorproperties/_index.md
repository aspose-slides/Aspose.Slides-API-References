...
| [getLimitLocation()](#getLimitLocation--) | Vị trí của giới hạn (chỉ số dưới và chỉ số trên) |
| [setLimitLocation(int value)](#setLimitLocation-int-) | Vị trí của giới hạn (chỉ số dưới và chỉ số trên) |
...
Vị trí của giới hạn (chỉ số dưới và chỉ số trên)
