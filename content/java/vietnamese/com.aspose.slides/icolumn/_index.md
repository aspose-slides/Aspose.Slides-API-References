...
| Phương thức | Mô tả |
| --- | --- |
| [getWidth()](#getWidth--) | Trả về hoặc đặt chiều rộng của một cột. |
| [setWidth(double value)](#setWidth-double-) | Trả về hoặc đặt chiều rộng của một cột. |
...
Trả về hoặc đặt chiều rộng của một cột. Đọc/ghi double.
