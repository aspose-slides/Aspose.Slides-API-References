...
| [getConcatenatedValuesFromCells()](#getConcatenatedValuesFromCells--) | Chuỗi nối từ tất cả các giá trị chuỗi của ô. |
...
| [add(Object value)](#add-java.lang.Object-) | Tạo [IChartDataCell](../../com.aspose.slides/ichartdatacell) từ giá trị được chỉ định và thêm nó vào tập hợp. |
...
Tạo [IChartDataCell](../../com.aspose.slides/ichartdatacell) từ giá trị được chỉ định và thêm nó vào tập hợp.
...
Phương thức này thêm worksheet có tên AUTO_DATA và thêm tất cả các giá trị vào đó. Nếu bạn sử dụng [IChartDataWorkbook](../../com.aspose.slides/ichartdataworkbook) để thêm hoặc chỉnh sửa giá trị của Cell, hãy chắc chắn rằng bạn không sử dụng worksheet này. Số lượng tối đa các giá trị được thêm bằng phương pháp này không được vượt quá 16711680 |
