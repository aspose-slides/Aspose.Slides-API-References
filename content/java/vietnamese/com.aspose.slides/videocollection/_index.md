...
| Phương thức | Mô tả |
| --- | --- |
| [size()](#size--) | Trả về số lượng tệp video trong tập hợp. |
| [get_Item(int index)](#get-Item-int-) | Lấy phần tử tại chỉ mục xác định. |
...
| [copyTo(System.Array array, int index)](#copyTo-com.aspose.ms.System.Array-int-) | Sao chép video vào mảng được chỉ định bắt đầu từ chỉ mục xác định. |
| [isSynchronized()](#isSynchronized--) | Trả về một giá trị cho biết việc truy cập vào tập hợp có được đồng bộ (an toàn đa luồng) hay không. |
| [getSyncRoot()](#getSyncRoot--) | Trả về gốc đồng bộ. |
| [iterator()](#iterator--) | Trả về một bộ liệt kê cho phép duyệt qua tập hợp. |
...
Trả về số lượng tệp video trong tập hợp. Chỉ đọc int.
...
Lấy phần tử tại chỉ mục xác định. Chỉ đọc [IVideo](../../com.aspose.slides/ivideo).
...
Sao chép video vào mảng được chỉ định bắt đầu từ chỉ mục xác định.
...
Trả về một giá trị cho biết việc truy cập vào tập hợp có được đồng bộ (an toàn đa luồng) hay không. Chỉ đọc boolean.
...
**Trả về:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IVideo> - Một IGenericEnumerator có thể được sử dụng để duyệt qua tập hợp.
...
**Trả về:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IVideo> - Một java.util.Iterator cho toàn bộ tập hợp.