...
description: Xác định các thao tác nào bị vô hiệu hoá trên đối tượng cha PictureFrameEx.
type: docs
url: /vi/com.aspose.slides/ipictureframelock/
---
...
Xác định các thao tác nào bị vô hiệu hoá trên đối tượng cha PictureFrameEx.
## Phương thức
...
| [getRotationLocked()](#getRotationLocked--) | Xác định xem việc thay đổi góc quay của hình này có bị cấm hay không. |
| [setRotationLocked(boolean value)](#setRotationLocked-boolean-) | Xác định xem việc thay đổi góc quay của hình này có bị cấm hay không. |
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Xác định xem hình có phải giữ tỷ lệ khung hình khi thay đổi kích thước hay không. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Xác định xem hình có phải giữ tỷ lệ khung hình khi thay đổi kích thước hay không. |
...
| [getSizeLocked()](#getSizeLocked--) | Xác định xem việc thay đổi kích thước hình này có bị cấm hay không. |
| [setSizeLocked(boolean value)](#setSizeLocked-boolean-) | Xác định xem việc thay đổi kích thước hình này có bị cấm hay không. |
...
| [getAdjustHandlesLocked()](#getAdjustHandlesLocked--) | Xác định xem việc thay đổi các giá trị chỉnh sửa có bị cấm hay không. |
| [setAdjustHandlesLocked(boolean value)](#setAdjustHandlesLocked-boolean-) | Xác định xem việc thay đổi các giá trị chỉnh sửa có bị cấm hay không. |
...
| [getShapeTypeLocked()](#getShapeTypeLocked--) | Xác định xem việc thay đổi kiểu hình có bị cấm hay không. |
| [setShapeTypeLocked(boolean value)](#setShapeTypeLocked-boolean-) | Xác định xem việc thay đổi kiểu hình có bị cấm hay không. |
| [getCropLocked()](#getCropLocked--) | Xác định xem việc cắt ảnh có bị cấm hay không. |
| [setCropLocked(boolean value)](#setCropLocked-boolean-) | Xác định xem việc cắt ảnh có bị cấm hay không. |
...
Xác định xem hình có phải giữ tỷ lệ khung hình khi thay đổi kích thước hay không. Đọc/ghi boolean.
...
Xác định xem việc thay đổi trực tiếp đường viền của hình này có bị cấm hay không. Đọc/ghi boolean.
...
Xác định xem việc thay đổi các giá trị chỉnh sửa có bị cấm hay không. Đọc/ghi boolean.
...
Xác định xem việc thay đổi kiểu hình có bị cấm hay không. Đọc/ghi boolean.
...
Xác định xem việc cắt ảnh có bị cấm hay không. Đọc/ghi boolean.
