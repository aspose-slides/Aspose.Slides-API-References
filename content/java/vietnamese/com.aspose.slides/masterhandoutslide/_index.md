...
description: Đại diện cho slide master cho tài liệu phát tay.
type: docs
...
Đại diện cho slide master cho handouts.
## Phương thức
...
| [getHeaderFooterManager()](#getHeaderFooterManager--) | Trả về trình quản lý HeaderFooter của slide handout master. |
| [getThemeManager()](#getThemeManager--) | Trả về trình quản lý theme. |
| [getDrawingGuides()](#getDrawingGuides--) | Trả về một bộ sưu tập các hướng dẫn vẽ cho slide handout master. |
...
Trả về trình quản lý HeaderFooter của slide handout master. Chỉ đọc [IMasterHandoutSlideHeaderFooterManager](../../com.aspose.slides/imasterhandoutslideheaderfootermanager).
...
Trả về một bộ sưu tập các hướng dẫn vẽ cho slide handout master. Chỉ đọc [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
