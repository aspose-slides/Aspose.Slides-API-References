...
| [isSynchronized()](#isSynchronized--) | Trả về một giá trị chỉ ra liệu việc truy cập bộ sưu tập có được đồng bộ (an toàn với luồng) hay không. |
...
Trả về một giá trị chỉ ra liệu việc truy cập bộ sưu tập có được đồng bộ (an toàn với luồng) hay không. Chỉ đọc boolean.
