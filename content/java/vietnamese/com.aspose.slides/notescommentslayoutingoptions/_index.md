...
description: Cung cấp các tùy chọn kiểm soát giao diện bố trí ghi chú và bình luận trong tài liệu xuất ra.
type: docs
...
| [getCommentsPosition()](#getCommentsPosition--) | Lấy hoặc đặt vị trí của bình luận trên trang. |
| [setCommentsPosition(int value)](#setCommentsPosition-int-) | Lấy hoặc đặt vị trí của bình luận trên trang. |
| [getCommentsAreaColor()](#getCommentsAreaColor--) | Lấy hoặc đặt màu của khu vực bình luận (Chỉ áp dụng nếu bình luận được hiển thị ở phía bên phải). |
| [setCommentsAreaColor(Color value)](#setCommentsAreaColor-java.awt.Color-) | Lấy hoặc đặt màu của khu vực bình luận (Chỉ áp dụng nếu bình luận được hiển thị ở phía bên phải). |
| [getCommentsAreaWidth()](#getCommentsAreaWidth--) | Lấy hoặc đặt chiều rộng của khu vực đầu ra bình luận tính bằng pixel (Chỉ áp dụng nếu bình luận được hiển thị ở phía bên phải). |
| [setCommentsAreaWidth(int value)](#setCommentsAreaWidth-int-) | Lấy hoặc đặt chiều rộng của khu vực đầu ra bình luận tính bằng pixel (Chỉ áp dụng nếu bình luận được hiển thị ở phía bên phải). |
...
Lấy hoặc đặt vị trí của bình luận trên trang.
...
Lấy hoặc đặt màu của khu vực bình luận (Chỉ áp dụng nếu bình luận được hiển thị ở phía bên phải).
...
Lấy hoặc đặt chiều rộng của khu vực đầu ra bình luận tính bằng pixel (Chỉ áp dụng nếu bình luận được hiển thị ở phía bên phải).
