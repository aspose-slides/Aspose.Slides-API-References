...
description: Cho phép tạo các tham chiếu dự án VBA thông qua giao diện COM
type: docs
...
| Phương thức | Mô tả |
| --- | --- |
| [getInstance()](#getInstance--) | Tham chiếu dự án VBA, thể hiện tĩnh của nhà máy. |
...
Tham chiếu dự án VBA, thể hiện tĩnh của nhà máy. Chỉ đọc [VbaReferenceFactory](../../com.aspose.slides/vbareferencefactory).
