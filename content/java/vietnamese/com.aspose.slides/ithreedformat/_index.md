...
| [getExtrusionHeight()](#getExtrusionHeight--) | Trả về hoặc đặt chiều cao của hiệu ứng đùn. |
| [setExtrusionHeight(double value)](#setExtrusionHeight-double-) | Trả về hoặc đặt chiều cao của hiệu ứng đùn. |
...
| [getEffective()](#getEffective--) | Lấy dữ liệu định dạng 3D hiệu quả với kế thừa được áp dụng. |
...
Trả về hoặc đặt chiều cao của hiệu ứng đùn. Đọc/ghi double.
...
Lấy dữ liệu định dạng 3D hiệu quả với kế thừa được áp dụng.
