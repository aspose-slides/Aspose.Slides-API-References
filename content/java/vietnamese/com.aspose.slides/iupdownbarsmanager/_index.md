...
| [hasUpDownBars()](#hasUpDownBars--) | Xác định liệu biểu đồ có thanh lên/xuống hay không. |
| [setUpDownBars(boolean value)](#setUpDownBars-boolean-) | Xác định liệu biểu đồ có thanh lên/xuống hay không. |
| [getGapWidth()](#getGapWidth--) | Trả về hoặc đặt độ rộng khoảng trống. |
| [setGapWidth(int value)](#setGapWidth-int-) | Trả về hoặc đặt độ rộng khoảng trống. |
...
Xác định liệu biểu đồ có thanh lên/xuống hay không. Đọc/ghi boolean.
...
Trả về hoặc đặt độ rộng khoảng trống. Đọc/ghi int.
