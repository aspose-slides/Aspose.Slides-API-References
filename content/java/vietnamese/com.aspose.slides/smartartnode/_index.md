...
description: Mô tả một nút của đối tượng SmartArt
type: docs
...
Mô tả một nút của đối tượng SmartArt
## Phương thức

| Phương thức | Mô tả |
| --- | --- |
| [getChildNodes()](#getChildNodes--) | Trả về bộ sưu tập các nút con của nút hiện tại. |
| [getShapes()](#getShapes--) | Trả về bộ sưu tập tất cả các hình dạng liên kết với nút. |
...
| [getBulletFillFormat()](#getBulletFillFormat--) | Trả về đối tượng FillFormat chứa các thuộc tính định dạng màu nền cho dấu đầu dòng của nút. |
| [getPosition()](#getPosition--) | Trả về hoặc đặt vị trí dựa trên chỉ số 0 của nút trong số các nút anh em. |
| [setPosition(int value)](#setPosition-int-) | Trả về hoặc đặt vị trí dựa trên chỉ số 0 của nút trong số các nút anh em. |
...
Trả về bộ sưu tập các nút con của nút hiện tại. Chỉ đọc [ISmartArtNodeCollection](../../com.aspose.slides/ismartartnodecollection).
...
Trả về bộ sưu tập tất cả các hình dạng liên kết với nút. Chỉ đọc [ISmartArtShapeCollection](../../com.aspose.slides/ismartartshapecollection).
...
Trả về đối tượng FillFormat chứa các thuộc tính định dạng màu nền cho dấu đầu dòng của nút. Lưu ý: có thể trả về null cho một số kiểu bố cục SmartArt không cung cấp dấu đầu dòng cho các nút. Chỉ đọc [IFillFormat](../../com.aspose.slides/ifillformat).
...
Trả về hoặc đặt vị trí dựa trên chỉ số 0 của nút trong số các nút anh em. Đọc/ghi int.
