...
Biểu diễn hiệu ứng Outer Shadow.
## Phương thức
...
| [getEffective()](#getEffective--) | Lấy dữ liệu hiệu ứng Outer Shadow thực tế với tính kế thừa đã áp dụng. |
| [getParent_Immediate()](#getParent-Immediate--) |  |
| [getVersion()](#getVersion--) |  |
| [getParent_IPresentationComponent()](#getParent-IPresentationComponent--) |  |
| [equals(Object obj)](#equals-java.lang.Object-) | Xác định liệu [OuterShadow](../../com.aspose.slides/outershadow) được chỉ định có bằng với [OuterShadow](../../com.aspose.slides/outershadow) hiện tại hay không. |
...
Hệ số co dọc ngang, tính bằng phần trăm kích thước gốc. Co âm gây lật. Giá trị mặc định - 100 %. Đọc/ghi double.
...
Hệ số co dọc dọc, tính bằng phần trăm kích thước gốc. Co âm gây lật. Giá trị mặc định - 100 %. Đọc/ghi double.
...
Lấy dữ liệu hiệu ứng Outer Shadow thực tế với tính kế thừa đã áp dụng.
...
Xác định liệu [OuterShadow](../../com.aspose.slides/outershadow) được chỉ định có bằng với [OuterShadow](../../com.aspose.slides/outershadow) hiện tại hay không.
