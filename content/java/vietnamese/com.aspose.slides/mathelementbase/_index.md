...
description: Lớp cơ sở cho IMathElement với triển khai một số phương thức chung cho tất cả các lớp kế thừa. Chỉ dùng cho nội bộ.
type: docs
...
Lớp cơ sở cho IMathElement với việc triển khai một số phương thức chung cho tất cả các lớp kế thừa. Chỉ sử dụng cho nội bộ. Lớp kế thừa phải là IMathElement.
## Phương thức
...
| [join(String mathText)](#join-java.lang.String-) | Kết hợp một đoạn văn bản toán học và tạo một khối toán học |
...
| [enclose()](#enclose--) | Bao một phần tử toán học trong dấu ngoặc đơn |
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | Bao một phần tử toán học trong các ký tự được chỉ định như dấu ngoặc hoặc ký tự khác làm khung |
...
| [asArgumentOfFunction(int functionType, IMathElement additionalArgument)](#asArgumentOfFunction-int-com.aspose.slides.IMathElement-) | Lấy hàm đã chỉ định sử dụng thể hiện này làm đối số và đối số bổ sung được chỉ định |
| [asArgumentOfFunction(int functionType, String additionalArgument)](#asArgumentOfFunction-int-java.lang.String-) | Lấy hàm đã chỉ định sử dụng thể hiện này làm đối số và đối số bổ sung được chỉ định |
...
| [radical(IMathElement degree)](#radical-com.aspose.slides.IMathElement-) | Xác định căn bậc toán học của cấp đã cho từ đối số được chỉ định. |
| [radical(String degree)](#radical-java.lang.String-) | Xác định căn bậc toán học của cấp đã cho từ đối số được chỉ định. |
...
| [overbar()](#overbar--) | Đặt một gạch ngang ở trên phần tử này |
| [underbar()](#underbar--) | Đặt một gạch ngang ở dưới phần tử này |
| [group()](#group--) | Đặt phần tử này vào một nhóm sử dụng dấu ngoặc nhọn dưới |
| [group(char character, int position, int verticalJustification)](#group-char-int-int-) | Đặt phần tử này vào một nhóm sử dụng ký tự nhóm như dấu ngoặc nhọn dưới hoặc ký tự khác |
...
| [toBox()](#toBox--) | Đặt phần tử này vào một hộp không hiển thị (nhóm logic) được sử dụng để nhóm các thành phần của một phương trình hoặc các đoạn văn bản toán học khác. |
...
| --- | --- | --- |
| mathElement | [IMathElement](../../com.aspose.slides/imathelement) | Phần tử cần kết hợp |
...
Kết hợp một đoạn văn bản toán học và tạo một khối toán học
...
| Parameter | Type | Description |
| --- | --- | --- |
| mathText | java.lang.String | Văn bản toán học cần kết hợp |
...
| --- | --- | --- |
| denominator | [IMathElement](../../com.aspose.slides/imathelement) | Mẫu số |
| fractionType | int | Loại phân số: Bar, NoBar, Skewed, Linear |
...
Bao một phần tử toán học trong dấu ngoặc đơn
...
Bao một phần tử toán học trong các ký tự được chỉ định như dấu ngoặc hoặc ký tự khác làm khung
...
| Parameter | Type | Description |
| --- | --- | --- |
| functionType | int | Một trong các loại hàm chung với một đối số |
...
Lấy hàm đã chỉ định sử dụng thể hiện này làm đối số và đối số bổ sung được chỉ định
...
| Parameter | Type | Description |
| --- | --- | --- |
| functionType | int | Một trong các loại hàm chung với hai đối số: Log, Lim, Min, Max |
...
| Parameter | Type | Description |
| --- | --- | --- |
| subscript | [IMathElement](../../com.aspose.slides/imathelement) | Chỉ số dưới (chỉ số thấp ở phía bên phải) |
...
| Parameter | Type | Description |
| --- | --- | --- |
| subscript | java.lang.String | Chỉ số dưới (chỉ số thấp ở phía bên phải) |
...
| Parameter | Type | Description |
| --- | --- | --- |
| superscript | [IMathElement](../../com.aspose.slides/imathelement) | Chỉ số trên (chỉ số cao ở phía bên phải) |
...
| Parameter | Type | Description |
| --- | --- | --- |
| superscript | java.lang.String | Chỉ số trên (chỉ số cao ở phía bên phải) |
...
Tạo chỉ số dưới và chỉ số trên ở phía trái
...
Xác định căn bậc của độ lớn đã cho từ đối số được chỉ định
...
**Giá trị trả về:**
[IMathRadical](../../com.aspose.slides/imathradical) - Thực thể mới loại [IMathRadical](../../com.aspose.slides/imathradical)
...
**Giá trị trả về:**
[IMathLimit](../../com.aspose.slides/imathlimit) - Thực thể mới loại [IMathLimit](../../com.aspose.slides/imathlimit)
...
**Giá trị trả về:**
[IMathNaryOperator](../../com.aspose.slides/imathnaryoperator) - Thực thể mới loại [IMathNaryOperator](../../com.aspose.slides/imathnaryoperator)
...
**Giá trị trả về:**
[IMathArray](../../com.aspose.slides/imatharray) - Thực thể mới loại [IMathArray](../../com.aspose.slides/imatharray)
...
**Giá trị trả về:**
[IMathAccent](../../com.aspose.slides/imathaccent) - Thực thể mới loại [IMathAccent](../../com.aspose.slides/imathaccent)
### overbar() {#overbar--}
```
...
**Giá trị trả về:**
[IMathBar](../../com.aspose.slides/imathbar) - Thực thể mới loại [IMathBar](../../com.aspose.slides/imathbar)
### underbar() {#underbar--}
```
...
**Giá trị trả về:**
[IMathGroupingCharacter](../../com.aspose.slides/imathgroupingcharacter) - Thực thể mới loại [IMathGroupingCharacter](../../com.aspose.slides/imathgroupingcharacter)
### group(char character, int position, int verticalJustification) {#group-char-int-int-}
```
public final IMathGroupingCharacter group(char character, int position, int verticalJustification)
```

Đặt phần tử này vào một nhóm dùng ký tự nhóm như dấu ngoặc nhọn phía dưới hoặc ký tự khác
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| character | char | Ký tự nhóm như DẤU NGOẶC NHỌN PHÍA DƯỚI (U+23DF) hoặc bất kỳ ký tự nào khác |
| position | int | Vị trí của ký tự nhóm |
| verticalJustification | int | Căn dọc của ký tự nhóm. Xác định cách căn chỉnh của đối tượng so với đường baseline. Ví dụ, khi ký tự nhóm ở trên đối tượng, VerticalJustification Top có nghĩa là đỉnh của đối tượng nằm trên baseline; khi VerticalJustification được đặt thành Bottom, đáy của đối tượng nằm trên baseline |
...
| strikethroughHorizontal | boolean | Gạch ngang ngang trong hộp viền |
| strikethroughVertical | boolean | Gạch ngang dọc trong hộp viền |
| strikethroughBottomLeftToTopRight | boolean | Gạch chéo từ dưới trái lên trên phải trong hộp viền |
| strikethroughTopLeftToBottomRight | boolean | Gạch chéo từ trên trái xuống dưới phải trong hộp viền |
...
Đặt phần tử này vào một hộp không hiển thị (nhóm logic) được dùng để nhóm các thành phần của một phương trình hoặc đoạn văn bản toán học khác. Một đối tượng được đóng khung có thể (ví dụ) đóng vai trò như một bộ mô phỏng toán tử có hoặc không có điểm căn chỉnh, phục vụ làm điểm ngắt dòng, hoặc được nhóm để không cho phép ngắt dòng bên trong.
