...
type: docs
url: /vi/com.aspose.slides/connectorlock/
---
**Kế thừa:**
...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Xác định việc hình này phải giữ tỷ lệ khung hình khi thay đổi kích thước hay không. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Xác định việc hình này phải giữ tỷ lệ khung hình khi thay đổi kích thước hay không. |
...
| [getAdjustHandlesLocked()](#getAdjustHandlesLocked--) | Xác định việc thay đổi giá trị điều chỉnh có bị cấm hay không. |
| [setAdjustHandlesLocked(boolean value)](#setAdjustHandlesLocked-boolean-) | Xác định việc thay đổi giá trị điều chỉnh có bị cấm hay không. |
| [getArrowheadsLocked()](#getArrowheadsLocked--) | Xác định việc thay đổi đầu mũi tên có bị cấm hay không. |
| [setArrowheadsLocked(boolean value)](#setArrowheadsLocked-boolean-) | Xác định việc thay đổi đầu mũi tên có bị cấm hay không. |
...
Xác định việc hình này phải giữ tỷ lệ khung hình khi thay đổi kích thước hay không. Đọc/ghi boolean.
...
Xác định việc thay đổi kích thước hình này có bị cấm hay không. Đọc/ghi boolean.
...
Xác định việc thay đổi giá trị điều chỉnh có bị cấm hay không. Đọc/ghi boolean.
...
Xác định việc thay đổi đầu mũi tên có bị cấm hay không. Đọc/ghi boolean.
