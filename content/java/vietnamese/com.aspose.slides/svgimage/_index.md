...
| [getExternalResourceResolver()](#getExternalResourceResolver--) | Trả về giao diện callback dùng để giải quyết tài nguyên bên ngoài khi nhập tài liệu Svg. |
...
| --- | --- | --- |
| data | byte[] | Dữ liệu Svg. |
| externalResResolver | [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver) | Đối tượng callback dùng để lấy các đối tượng bên ngoài. Nếu tham số này là null, tất cả các đối tượng bên ngoài sẽ bị bỏ qua. |
| baseUri | java.lang.String | URI cơ sở của Svg được chỉ định. Dùng để giải quyết các liên kết tương đối. |
...
Trả về giao diện callback dùng để giải quyết tài nguyên bên ngoài khi nhập tài liệu Svg. Chỉ đọc [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver).
...
Trả về URI cơ sở của Svg được chỉ định. Dùng để giải quyết các liên kết tương đối. Chỉ đọc String.
...
>  // Lưu hình ảnh SVG dưới dạng một metafille
