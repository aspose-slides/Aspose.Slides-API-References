...
description: Xác định đối tượng Sub-Superscript, bao gồm một base và các chỉ số subscript và superscript được đặt phía bên trái của base.
type: docs
...
Xác định đối tượng Sub-Superscript, bao gồm một base và các chỉ số subscript và superscript được đặt phía bên trái của base.
