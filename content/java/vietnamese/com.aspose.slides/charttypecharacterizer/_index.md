...
description: Trợ giúp để lấy thông tin bổ sung về biểu đồ và chuỗi dựa trên ChartType của chúng.
type: docs
...
Trợ giúp để lấy thông tin bổ sung về biểu đồ và chuỗi dựa trên ChartType của chúng.
## Hàm tạo
...
| [is2DChart(int chartType)](#is2DChart-int-) | Trả về true nếu chartType là một trong các kiểu biểu đồ 2D. |
| [is3DChart(int chartType)](#is3DChart-int-) | Trả về true nếu chartType là một trong các kiểu biểu đồ 3D. |
...
| [isSeriesUsesBubbleSizeCoordinate(int seriesType)](#isSeriesUsesBubbleSizeCoordinate-int-) | Trả về nếu tọa độ kích thước bubble có thể được sử dụng cho loại series được chỉ định. |
...
| [isErrorBarsXAllowed(int seriesType)](#isErrorBarsXAllowed-int-) | Trả về nếu error bars X được cho phép cho loại series được chỉ định. |
| [isErrorBarsYAllowed(int seriesType)](#isErrorBarsYAllowed-int-) | Trả về nếu error bars Y được cho phép cho loại series được chỉ định. |
...
Trả về true nếu chartType là một trong các kiểu biểu đồ 2D.
...
Trả về true nếu chartType là một trong các kiểu biểu đồ 3D.
...
Trả về true nếu chartType là một trong các kiểu phụ Doughnut. Tập hợp các kiểu phụ tương ứng với tập hợp thích hợp trong PowerPoint (xem hộp thoại "Change Chart Type" trong PowerPoint): [ChartType.Doughnut](../../com.aspose.slides/charttype\#Doughnut), [ChartType.ExplodedDoughnut](../../com.aspose.slides/charttype\#ExplodedDoughnut).
...
Trả về true nếu chartType là một trong các kiểu phụ Bubble. Tập hợp các kiểu phụ tương ứng với tập hợp thích hợp trong PowerPoint (xem hộp thoại "Change Chart Type" trong PowerPoint): [ChartType.Bubble](../../com.aspose.slides/charttype\#Bubble), [ChartType.BubbleWith3D](../../com.aspose.slides/charttype\#BubbleWith3D).
...
Trả về nếu tọa độ kích thước bubble có thể được sử dụng cho loại series được chỉ định.
...
**Giá trị trả về:**
boolean - True nếu tồn tại, ngược lại false.
...
Trả về nếu error bars X được cho phép cho loại series được chỉ định.
...
**Giá trị trả về:**
boolean - True nếu được cho phép, ngược lại false.
...
Trả về nếu error bars Y được cho phép cho loại series được chỉ định.
