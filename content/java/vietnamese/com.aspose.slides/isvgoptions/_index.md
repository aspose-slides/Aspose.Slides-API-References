...
| [getDisableGradientSplit()](#getDisableGradientSplit--) | Vô hiệu hóa việc chia tách gradient FromCornerX và FromCenter. |
| [setDisableGradientSplit(boolean value)](#setDisableGradientSplit-boolean-) | Vô hiệu hóa việc chia tách gradient FromCornerX và FromCenter. |
| [getDisableLineEndCropping()](#getDisableLineEndCropping--) | SVG 1.1 không hỗ trợ định nghĩa khoảng chèn cho các marker. |
| [setDisableLineEndCropping(boolean value)](#setDisableLineEndCropping-boolean-) | SVG 1.1 không hỗ trợ định nghĩa khoảng chèn cho các marker. |
...
| [getPicturesCompression()](#getPicturesCompression--) | Đại diện cho mức nén ảnh. Đọc/ghi \#getPicturesCompression.getPicturesCompression/\#setPicturesCompression(int).setPicturesCompression(int). |
| [setPicturesCompression(int value)](#setPicturesCompression-int-) | Đại diện cho mức nén ảnh. Đọc/ghi \#getPicturesCompression.getPicturesCompression/\#setPicturesCompression(int).setPicturesCompression(int). |
...
| [getUseFrameRotation()](#getUseFrameRotation--) | Xác định liệu thực hiện quay hình đã chỉ định khi render hay không. |
| [setUseFrameRotation(boolean value)](#setUseFrameRotation-boolean-) | Xác định liệu thực hiện quay hình đã chỉ định khi render hay không. |
...
| [getDisableFontLigatures()](#getDisableFontLigatures--) | Đọc/ghi giá trị cho biết liệu văn bản có được render mà không sử dụng ligatures hay không. |
| [setDisableFontLigatures(boolean value)](#setDisableFontLigatures-boolean-) | Đọc/ghi giá trị cho biết liệu văn bản có được render mà không sử dụng ligatures hay không. |
...
Vô hiệu hóa việc chia tách gradient FromCornerX và FromCenter. Đọc/ghi boolean.
...
SVG 1.1 không hỗ trợ định nghĩa khoảng chèn cho các marker. Động cơ viết SVG của Aspose.Slides có cách khắc phục: nó cắt phần cuối của đường có mũi tên, vì vậy đường không chồng lên marker. Tùy chọn này tắt hành vi đó. Đọc/ghi boolean.
...
Đại diện cho mức nén ảnh. Đọc/ghi \#getPicturesCompression.getPicturesCompression/\#setPicturesCompression(int).setPicturesCompression(int).
...
Xác định liệu thực hiện quay hình đã chỉ định khi render hay không. Đọc/ghi boolean. Giá trị mặc định là true.
...
Đọc/ghi giá trị cho biết liệu văn bản có được render mà không sử dụng ligatures hay không. Khi được đặt thành true, ligatures sẽ bị vô hiệu hoá trong output được render. Mặc định, thuộc tính này được đặt là false.
