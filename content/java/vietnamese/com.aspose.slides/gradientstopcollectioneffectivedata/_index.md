...
Biểu diễn một tập hợp các đối tượng GradientStopData.

## Phương thức

| Phương thức | Mô tả |
| --- | --- |
| [size()](#size--) | Trả về số lượng điểm dừng gradient trong một tập hợp. |
| [get_Item(int index)](#get-Item-int-) | Trả về điểm dừng gradient theo chỉ mục. |
| [iterator()](#iterator--) | Trả về một enumerator cho phép lặp qua tập hợp. |
...
Trả về số lượng điểm dừng gradient trong một tập hợp. int chỉ đọc.
...
Trả về một enumerator cho phép lặp qua tập hợp.
...
Trả về giá trị cho biết liệu việc truy cập vào tập hợp có được đồng bộ (thread-safe) hay không. boolean chỉ đọc.
