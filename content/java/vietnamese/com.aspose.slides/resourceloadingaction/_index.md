...
| [UserProvided](#UserProvided) | Aspose.Slides sẽ sử dụng mảng byte do người dùng cung cấp trong [IResourceLoadingArgs.setData(byte[])](../../com.aspose.slides/iresourceloadingargs\#setData-byte---) làm dữ liệu hình ảnh. |
### Mặc định {#Default}
```
...
Aspose.Slides sẽ sử dụng mảng byte do người dùng cung cấp trong [IResourceLoadingArgs.setData(byte[])](../../com.aspose.slides/iresourceloadingargs\#setData-byte---) làm dữ liệu hình ảnh.