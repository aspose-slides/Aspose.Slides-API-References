...
description: Mô tả định dạng của một ô bảng.
type: docs
...
Mô tả định dạng của một ô bảng.
...
| [getFillFormat()](#getFillFormat--) | Trả về một đối tượng thuộc tính tô màu ô. |
...
| [getBorderDiagonalDown()](#getBorderDiagonalDown--) | Trả về một đối tượng thuộc tính đường chéo từ trên-trái tới dưới-phải. |
| [getBorderDiagonalUp()](#getBorderDiagonalUp--) | Trả về một đối tượng thuộc tính đường chéo từ dưới-trái tới trên-phải. |
| [getEffective()](#getEffective--) | Lấy các thuộc tính định dạng ô bảng hiệu quả với kế thừa và kiểu bảng đã áp dụng. |
...
Trả về một đối tượng thuộc tính tô màu ô. Chỉ đọc [IFillFormat](../../com.aspose.slides/ifillformat).
...
Trả về một đối tượng thuộc tính đường viền trái. Chỉ đọc [ILineFormat](../../com.aspose.slides/ilineformat).
...
Trả về một đối tượng thuộc tính đường viền phải. Chỉ đọc [ILineFormat](../../com.aspose.slides/ilineformat).
...
Trả về một đối tượng thuộc tính đường chéo từ trên-trái tới dưới-phải. Chỉ đọc [ILineFormat](../../com.aspose.slides/ilineformat).
...
Trả về một đối tượng thuộc tính đường chéo từ dưới-trái tới trên-phải. Chỉ đọc [ILineFormat](../../com.aspose.slides/ilineformat).
...
Lấy các thuộc tính định dạng ô bảng hiệu quả với kế thừa và kiểu bảng đã áp dụng.
