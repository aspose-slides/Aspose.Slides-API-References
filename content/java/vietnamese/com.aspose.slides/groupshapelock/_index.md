...
description: Xác định các thao tác bị vô hiệu hoá trên GroupShape cha.
type: docs
url: /vi/com.aspose.slides/groupshapelock/
---
**Kế thừa:**
...
| [getUngroupingLocked()](#getUngroupingLocked--) | Xác định việc tách GroupShape này có bị cấm hay không. |
| [setUngroupingLocked(boolean value)](#setUngroupingLocked-boolean-) | Xác định việc tách GroupShape này có bị cấm hay không. |
...
| [getRotationLocked()](#getRotationLocked--) | Xác định việc thay đổi góc quay của hình này có bị cấm hay không. |
| [setRotationLocked(boolean value)](#setRotationLocked-boolean-) | Xác định việc thay đổi góc quay của hình này có bị cấm hay không. |
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Xác định hình này phải giữ tỷ lệ khung hình khi thay đổi kích thước. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Xác định hình này phải giữ tỷ lệ khung hình khi thay đổi kích thước. |
...
Xác định việc tách GroupShape này có bị cấm hay không. Đọc/ghi boolean.
...
Xác định hình này phải giữ tỷ lệ khung hình khi thay đổi kích thước. Đọc/ghi boolean.
