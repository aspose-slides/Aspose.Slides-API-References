...
| [getShapes()](#getShapes--) | Trả về tập hợp các hình dạng liên kết với nút. |
...
| [getLevel()](#getLevel--) | Trả về cấp độ lồng nhau của nút. |
| [getBulletFillFormat()](#getBulletFillFormat--) | Trả về đối tượng FillFormat chứa các thuộc tính định dạng tô màu cho dấu chấm đầu dòng của nút. |
| [getPosition()](#getPosition--) | Trả về hoặc đặt vị trí dựa trên số không của nút trong số các nút cùng cấp. |
| [setPosition(int value)](#setPosition-int-) | Trả về hoặc đặt vị trí dựa trên số không của nút trong số các nút cùng cấp. |
...
Trả về tập hợp các hình dạng liên kết với nút. Chỉ đọc [ISmartArtShapeCollection](../../com.aspose.slides/ismartartshapecollection).
...
Trả về cấp độ lồng nhau của nút. Chỉ đọc int.
...
Trả về đối tượng FillFormat chứa các thuộc tính định dạng tô màu cho dấu chấm đầu dòng của nút. Lưu ý: có thể trả về null cho một số loại bố cục SmartArt không cung cấp dấu chấm đầu dòng cho các nút. Chỉ đọc [IFillFormat](../../com.aspose.slides/ifillformat).
...
Trả về hoặc đặt vị trí dựa trên số không của nút trong số các nút cùng cấp. Đọc/ghi int.
