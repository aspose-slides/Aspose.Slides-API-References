...
description: Cung cấp các tùy chọn kiểm soát cách một bản trình chiếu được lưu ở định dạng TIFF.
type: docs
...
| [setImageSize(Dimension value)](#setImageSize-java.awt.Dimension-) | Xác định kích thước của ảnh TIFF được tạo. |
| [getDpiX()](#getDpiX--) | Xác định độ phân giải ngang tính bằng dấu chấm trên mỗi inch. |
| [setDpiX(long value)](#setDpiX-long-) | Xác định độ phân giải ngang tính bằng dấu chấm trên mỗi inch. |
| [getDpiY()](#getDpiY--) | Xác định độ phân giải dọc tính bằng dấu chấm trên mỗi inch. |
| [setDpiY(long value)](#setDpiY-long-) | Xác định độ phân giải dọc tính bằng dấu chấm trên mỗi inch. |
...
| [getCompressionType()](#getCompressionType--) | Xác định kiểu nén. |
| [setCompressionType(int value)](#setCompressionType-int-) | Xác định kiểu nén. |
...
Xác định kích thước của ảnh TIFF được tạo. Giá trị mặc định là 0x0, có nghĩa là kích thước ảnh được tạo sẽ được tính dựa trên giá trị kích thước slide của bản trình chiếu. Đọc/ghi java.awt.Dimension.
...
Xác định độ phân giải ngang tính bằng dấu chấm trên mỗi inch. Đọc/ghi long.
...
Xác định độ phân giải dọc tính bằng dấu chấm trên mỗi inch. Đọc/ghi long.
...
Xác định kiểu nén. Đọc/ghi [TiffCompressionTypes](../../com.aspose.slides/tiffcompressiontypes).
...
Xác định thuật toán chuyển đổi ảnh màu sang ảnh đen trắng. Tùy chọn này sẽ được áp dụng chỉ nếu CompressionType (\#getCompressionType.getCompressionType/\#setCompressionType(int).setCompressionType(int)) được đặt thành [TiffCompressionTypes.CCITT4](../../com.aspose.slides/tiffcompressiontypes\#CCITT4) hoặc [TiffCompressionTypes.CCITT3](../../com.aspose.slides/tiffcompressiontypes\#CCITT3) Đọc/ghi [BlackWhiteConversionMode](../../com.aspose.slides/blackwhiteconversionmode). Mặc định là [BlackWhiteConversionMode.Default](../../com.aspose.slides/blackwhiteconversionmode\#Default).
