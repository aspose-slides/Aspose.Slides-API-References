...
| [getSubstitutePictureFormat()](#getSubstitutePictureFormat--) | Trả về đối tượng thuộc tính fill ảnh của ControlEx. |
...
| [getPersistence()](#getPersistence--) | Lấy phương pháp được dùng để lưu trữ các thuộc tính của điều khiển ActiveX. |
| [getActiveXControlBinary()](#getActiveXControlBinary--) | Xác định tính bền vững của một điều khiển ActiveX khi phương pháp được dùng để duy trì là PersistStream, PersistStreamInit hoặc PersistStorage. |
### getName() {#getName--}
```
...
Trả về đối tượng thuộc tính fill ảnh của ControlEx. Chỉ đọc [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
Lấy phương pháp được dùng để lưu trữ các thuộc tính của điều khiển ActiveX. Chỉ đọc [PersistenceType](../../com.aspose.slides/persistencetype).
...
Xác định tính bền vững của một điều khiển ActiveX khi phương pháp được dùng để duy trì là PersistStream, PersistStreamInit hoặc PersistStorage.
