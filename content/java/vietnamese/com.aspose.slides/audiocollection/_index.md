...
| [copyTo(System.Array array, int index)](#copyTo-com.aspose.ms.System.Array-int-) | Sao chép các âm thanh vào mảng được chỉ định bắt đầu từ chỉ mục được chỉ định. |
...
Trả về số lượng tệp âm thanh trong bộ sưu tập. int chỉ-đọc.
...
Sao chép các âm thanh vào mảng được chỉ định bắt đầu từ chỉ mục được chỉ định.
...
Trả về giá trị cho biết liệu việc truy cập bộ sưu tập có được đồng bộ (an toàn đa luồng) hay không. Boolean chỉ-đọc.
...
**Trả về:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IAudio> - Một IGenericEnumerator có thể được sử dụng để duyệt qua bộ sưu tập.
...
**Trả về:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IAudio> - Một java.util.Iterator cho toàn bộ bộ sưu tập.