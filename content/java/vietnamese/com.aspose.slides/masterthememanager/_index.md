...
| [isOverrideThemeEnabled()](#isOverrideThemeEnabled--) | Xác định xem OverrideTheme có ghi đè chủ đề hiệu quả kế thừa (Presentation.MasterTheme) hay không. |
| [setOverrideThemeEnabled(boolean value)](#setOverrideThemeEnabled-boolean-) | Xác định xem OverrideTheme có ghi đè chủ đề hiệu quả kế thừa (Presentation.MasterTheme) hay không. |
| [applyColorScheme(IExtraColorScheme scheme)](#applyColorScheme-com.aspose.slides.IExtraColorScheme-) | Áp dụng sơ đồ màu bổ sung cho một slide. |
...
Xác định xem OverrideTheme có ghi đè chủ đề hiệu quả kế thừa (Presentation.MasterTheme) hay không. Đọc/ghi boolean.
...
Áp dụng sơ đồ màu bổ sung cho một slide.
