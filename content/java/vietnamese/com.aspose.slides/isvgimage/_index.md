...
| [getExternalResourceResolver()](#getExternalResourceResolver--) | Trả về giao diện callback được sử dụng để giải quyết các tài nguyên bên ngoài trong quá trình nhập tài liệu SVG. |
| [getBaseUri()](#getBaseUri--) | Trả về URI cơ sở của SVG đã chỉ định. |
...
Trả về giao diện callback được sử dụng để giải quyết các tài nguyên bên ngoài trong quá trình nhập tài liệu SVG. Chỉ đọc [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver).
...
Trả về URI cơ sở của SVG đã chỉ định. Được sử dụng để giải quyết các liên kết tương đối. Chỉ đọc String.
...
>  // Lưu hình ảnh SVG dưới dạng metafille
