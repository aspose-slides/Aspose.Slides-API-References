...
| [getExplicitBreak()](#getExplicitBreak--) | Ngắt rõ ràng chỉ định liệu có ngắt dòng ở đầu đối tượng Box hay không, sao cho dòng được gói lại ở đầu đối tượng box. |
| [setExplicitBreak(byte value)](#setExplicitBreak-byte-) | Ngắt rõ ràng chỉ định liệu có ngắt dòng ở đầu đối tượng Box hay không, sao cho dòng được gói lại ở đầu đối tượng box. |
### getBase() {#getBase--}
```
...
Không ngắt. Thuộc tính này chỉ định thuộc tính "không thể phá vỡ" trên hộp đối tượng. Khi đúng, không có ngắt dòng nào có thể xảy ra bên trong hộp. Điều này có thể quan trọng đối với trình giả lập toán tử bao gồm nhiều hơn một toán tử nhị phân. Khi phần tử này không được chỉ định, việc ngắt dòng có thể xảy ra bên trong hộp. Mặc định: true
...
Vi phân. Khi đúng, hộp hoạt động như một vi phân (ví dụ, \\ud835\\udc51\\ud835\\udc65 trong một hàm tích phân), và nhận khoảng cách ngang phù hợp cho vi phân toán học. Mặc định: false
...
Ngắt rõ ràng chỉ định liệu có ngắt dòng ở đầu đối tượng Box hay không, sao cho dòng được gói lại ở đầu đối tượng box. Xác định số của toán tử trên dòng văn bản toán học trước đó sẽ được sử dụng làm điểm căn chỉnh cho dòng văn bản toán học hiện tại. Giá trị khả dụng: 1..255 Mặc định: 0 (không có ngắt rõ ràng)
