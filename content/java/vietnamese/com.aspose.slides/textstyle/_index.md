...
| [getDefaultParagraphFormat()](#getDefaultParagraphFormat--) | Các thuộc tính đoạn văn mặc định. |
| [getEffective()](#getEffective--) | Lấy dữ liệu định dạng kiểu văn bản hiệu quả với việc áp dụng kế thừa. |
### getVersion() {#getVersion--}
```
...
**Trả về:**
[IParagraphFormat](../../com.aspose.slides/iparagraphformat) - Định dạng của mức độ [IParagraphFormat](../../com.aspose.slides/iparagraphformat).
### getDefaultParagraphFormat() {#getDefaultParagraphFormat--}
```
public final IParagraphFormat getDefaultParagraphFormat()
```

Các thuộc tính đoạn văn mặc định. Chỉ đọc [IParagraphFormat](../../com.aspose.slides/iparagraphformat).
...
Lấy dữ liệu định dạng kiểu văn bản hiệu quả với việc áp dụng kế thừa.
