...
>      // Vô hiệu hoá vòng lặp cho audio
>      audioFrame.setPlayLoopMode(false);
>      // Ẩn AudioFrame trong khi trình chiếu
>      audioFrame.setHideAtShowing(true);
>      // Tua lại audio về đầu sau khi phát
...
| [getAudioCdEndTrack()](#getAudioCdEndTrack--) | Trả về hoặc đặt một chỉ mục track cuối. Đọc/ghi int. |
| [setAudioCdEndTrack(int value)](#setAudioCdEndTrack-int-) | Trả về hoặc đặt một chỉ mục track cuối. Đọc/ghi int. |
...
| [getRewindAudio()](#getRewindAudio--) | Xác định liệu âm thanh có được tua lại tự động tới đầu sau khi phát hay không. |
| [setRewindAudio(boolean value)](#setRewindAudio-boolean-) | Xác định liệu âm thanh có được tua lại tự động tới đầu sau khi phát hay không. |
| [getEmbedded()](#getEmbedded--) | Xác định liệu âm thanh có được nhúng vào bản trình bày hay không. |
...
| [getVolumeValue()](#getVolumeValue--) | Trả về hoặc đặt mức âm lượng tính bằng phần trăm. |
| [setVolumeValue(float value)](#setVolumeValue-float-) | Trả về hoặc đặt mức âm lượng tính bằng phần trăm. |
| [getTrimFromStart()](#getTrimFromStart--) | Xác định khoảng thời gian cần loại bỏ từ đầu media trong quá trình phát, tính bằng mili giây. |
| [setTrimFromStart(float value)](#setTrimFromStart-float-) | Xác định khoảng thời gian cần loại bỏ từ đầu media trong quá trình phát, tính bằng mili giây. |
| [getTrimFromEnd()](#getTrimFromEnd--) | Xác định khoảng thời gian cần loại bỏ từ cuối media trong quá trình phát, tính bằng mili giây. |
| [setTrimFromEnd(float value)](#setTrimFromEnd-float-) | Xác định khoảng thời gian cần loại bỏ từ cuối media trong quá trình phát, tính bằng mili giây. |
...
Trả về hoặc đặt một chỉ mục track cuối. Đọc/ghi int.
...
Xác định liệu âm thanh có được tua lại tự động tới đầu sau khi phát hay không. Đọc/ghi boolean.
...
Xác định liệu âm thanh có được nhúng vào bản trình bày hay không. Chỉ-đọc boolean.
...
Trả về hoặc đặt mức âm lượng tính bằng phần trăm. Đọc/ghi float.
...
Xác định khoảng thời gian cần loại bỏ từ đầu media trong quá trình phát, tính bằng mili giây. Đọc/ghi float.
...
Xác định khoảng thời gian cần loại bỏ từ cuối media trong quá trình phát, tính bằng mili giây. Đọc/ghi float.
