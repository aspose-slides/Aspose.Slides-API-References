...
Xác định xem thuộc tính AsCell hoặc AsLiteralString hoặc AsLiteralDouble là thực tế hay không. Nói cách khác, nó xác định kiểu giá trị của thuộc tính Data. Thuộc tính này chỉ đọc. Để thay đổi giá trị của thuộc tính này, bạn có thể sử dụng một trong các thuộc tính ChartDataPointCollection.DataSourceTypeFor<...>. Đọc/ghi [DataSourceType](../../com.aspose.slides/datasourcetype)(\#getDataSourceType.getDataSourceType/\#setDataSourceType(int).setDataSourceType(int)).
