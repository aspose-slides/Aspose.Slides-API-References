...
| Phương thức | Mô tả |
| --- | --- |
| [getEffective()](#getEffective--) | Lấy các thuộc tính định dạng cột bảng hiệu quả có kế thừa và áp dụng kiểu bảng. |
...
Lấy các thuộc tính định dạng cột bảng hiệu quả có kế thừa và áp dụng kiểu bảng.

--------------------

> ```
> Ví dụ này minh họa cách lấy định dạng tô đầy hiệu quả cho các phần logic khác nhau của bảng.
>  Lưu ý rằng định dạng ô luôn có độ ưu tiên cao hơn định dạng hàng, hàng - cao hơn cột, cột - cao hơn toàn bộ bảng.
