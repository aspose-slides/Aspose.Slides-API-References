...
description: Các hằng số xác định các kiểu ánh sáng được cài sẵn.
type: docs
url: /vi/com.aspose.slides/lightrigpresettype/
---
**Kế thừa:**
...
Các hằng số xác định các kiểu ánh sáng được cài sẵn.
## Trường
