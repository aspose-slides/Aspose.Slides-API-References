...
description: Mô tả hiệu ứng hoạt hình.
type: docs
url: /vi/com.aspose.slides/effect/
---
**Kế thừa:**
java.lang.Object
...
Mô tả hiệu ứng hoạt hình.
## Phương thức

| Method | Description |
| --- | --- |
| [getSequence()](#getSequence--) | Trả về một chuỗi cho hiệu ứng. |
| [getTextAnimation()](#getTextAnimation--) | TextAnimation chỉ đọc [ITextAnimation](../../com.aspose.slides/itextanimation). |
...
| [getBehaviors()](#getBehaviors--) | Trả về bộ sưu tập hành vi cho hiệu ứng. |
| [setBehaviors(IBehaviorCollection value)](#setBehaviors-com.aspose.slides.IBehaviorCollection-) | Trả về bộ sưu tập hành vi cho hiệu ứng. |
...
| [getSound()](#getSound--) | Định nghĩa âm thanh nhúng cho hiệu ứng. |
| [setSound(IAudio value)](#setSound-com.aspose.slides.IAudio-) | Định nghĩa âm thanh nhúng cho hiệu ứng. |
| [getStopPreviousSound()](#getStopPreviousSound--) | Thuộc tính này xác định liệu hiệu ứng hoạt hình có dừng âm thanh trước đó hay không. |
| [setStopPreviousSound(boolean value)](#setStopPreviousSound-boolean-) | Thuộc tính này xác định liệu hiệu ứng hoạt hình có dừng âm thanh trước đó hay không. |
| [getAfterAnimationType()](#getAfterAnimationType--) | Xác định loại hoạt hình sau cho hiệu ứng. |
| [setAfterAnimationType(int value)](#setAfterAnimationType-int-) | Xác định loại hoạt hình sau cho hiệuứng. |
| [getAfterAnimationColor()](#getAfterAnimationColor--) | Xác định màu sắc hoạt hình sau cho hiệu ứng. |
| [setAfterAnimationColor(IColorFormat value)](#setAfterAnimationColor-com.aspose.slides.IColorFormat-) | Xác định màu sắc hoạt hình sau cho hiệu ứng. |
...
| [getDelayBetweenTextParts()](#getDelayBetweenTextParts--) | Xác định độ trễ giữa các phần văn bản hoạt hình (từ hoặc ký tự). |
| [setDelayBetweenTextParts(float value)](#setDelayBetweenTextParts-float-) | Xác định độ trễ giữa các phần văn bản hoạt hình (từ hoặc ký tự). |
...
TextAnimation chỉ đọc [ITextAnimation](../../com.aspose.slides/itextanimation).
...
Trả về bộ sưu tập hành vi cho hiệu ứng. Đọc/ghi [IBehaviorCollection](../../com.aspose.slides/ibehaviorcollection).
...
Định nghĩa âm thanh nhúng cho hiệu ứng. Đọc/ghi [IAudio](../../com.aspose.slides/iaudio).
...
>      {
>          // Thay đổi hiệu ứng thứ hai Enhancements/Sound thành "Stop Previous Sound"
...
Xác định loại hoạt hình sau cho hiệu ứng. Đọc/ghi [AfterAnimationType](../../com.aspose.slides/afteranimationtype)(\#getAfterAnimationType.getAfterAnimationType/\#setAfterAnimationType(int).setAfterAnimationType(int)).
...
Xác định màu sắc hoạt hình sau cho hiệu ứng. Đọc/ghi [IColorFormat](../../com.aspose.slides/icolorformat).
...
Xác định loại văn bản hoạt hình cho hiệu ứng. Văn bản hình dạng có thể được hoạt hình theo ký tự, theo từ hoặc đồng thời. Đọc/ghi  AnimateTextType (\#getAnimateTextType.getAnimateTextType/\#setAnimateTextType(int).setAnimateTextType(int)).
...
Xác định độ trễ giữa các phần văn bản hoạt hình (từ hoặc ký tự). Giá trị dương chỉ phần trăm thời lượng hiệu ứng. Giá trị âm chỉ độ trễ tính bằng giây. Đọc/ghi  float .
...
> 
>      // Đặt độ trễ giữa các phần văn bản hoạt hình thành 20% thời lượng hiệu ứng.
