...
description: Biểu thị trình tự là tập hợp các hiệu ứng.
type: docs
...
Biểu thị trình tự (tập hợp các hiệu ứng).
## Phương thức

| Phương thức | Mô tả |
| --- | --- |
| [getCount()](#getCount--) | Trả về số lượng hiệu ứng trong một trình tự. |
...
| [getTriggerShape()](#getTriggerShape--) | Trả về hoặc đặt mục tiêu shape cho trình tự INTERACTIVE. |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | Trả về hoặc đặt mục tiêu shape cho trình tự INTERACTIVE. |
...
| [addEffect(IShape shape, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IShape-int-int-int-) | Thêm hiệu ứng mới vào cuối trình tự. |
| [addEffect(IParagraph paragraph, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IParagraph-int-int-int-) | Thêm hiệu ứng hoạt hình mới cho đoạn văn vào cuối trình tự. |
| [addEffect(IChart chart, int type, int index, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-) | Thêm hiệu ứng hoạt hình biểu đồ mới cho danh mục hoặc chuỗi vào cuối trình tự. |
| [addEffect(IChart chart, int type, int seriesIndex, int categoriesIndex, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-int-) | Thêm hiệu ứng hoạt hình biểu đồ mới cho các phần tử trong danh mục hoặc chuỗi vào cuối trình tự. |
### getCount() {#getCount--}
```
public final int getCount()
```

Trả về số lượng hiệu ứng trong một trình tự. Kiểu int chỉ đọc.
...
Trả về hoặc đặt mục tiêu shape cho trình tự INTERACTIVE. Nếu trình tự không tương tác thì trả về null. Đọc/ghi [IShape](../../com.aspose.slides/ishape).
...
Thêm hiệu ứng mới vào cuối trình tự.

**Tham số:**
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | Đối tượng Shape [IShape](../../com.aspose.slides/ishape) để thêm hiệu ứng |
| effectType | int | Kiểu của hiệu ứng hoạt hình [EffectType](../../com.aspose.slides/effecttype) |
| subtype | int | Các loại phụ của hiệu ứng hoạt hình [EffectSubtype](../../com.aspose.slides/effectsubtype) |
...
Thêm hiệu ứng hoạt hình mới cho đoạn văn vào cuối trình tự.
...
Thêm hiệu ứng hoạt hình biểu đồ mới cho danh mục hoặc chuỗi vào cuối trình tự.

**Tham số:**
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| chart | [IChart](../../com.aspose.slides/ichart) | Đối tượng Chart [IChart](../../com.aspose.slides/ichart) |
| type | int | Kiểu của hiệu ứng hoạt hình [EffectChartMinorGroupingType](../../com.aspose.slides/effectchartminorgroupingtype) |
...
Thêm hiệu ứng hoạt hình biểu đồ mới cho các phần tử trong danh mục hoặc chuỗi vào cuối trình tự.
