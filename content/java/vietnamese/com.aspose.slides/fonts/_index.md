...
| Phương thức | Mô tả |
| --- | --- |
| [getScriptFontMap()](#getScriptFontMap--) | Trả về một từ điển chứa tất cả các định nghĩa phông chữ cho các script trong bản trình chiếu. |
| [getScriptFont(String script)](#getScriptFont-java.lang.String-) | Lấy tên phông chữ liên kết với một thẻ script cụ thể từ chủ đề của bản trình chiếu. |
...
| [removeScriptFont(String script)](#removeScriptFont-java.lang.String-) | Xóa cài đặt phông chữ liên kết với một thẻ script cụ thể khỏi bộ sưu tập phông chữ của chủ đề. |
...
| [getComplexScriptFont()](#getComplexScriptFont--) | Trả về hoặc đặt phông chữ script phức hợp. |
| [setComplexScriptFont(IFontData value)](#setComplexScriptFont-com.aspose.slides.IFontData-) | Trả về hoặc đặt phông chữ script phức hợp. |
...
Trả về một từ điển chứa tất cả các định nghĩa phông chữ cho các script trong bản trình chiếu.
...
Lấy tên phông chữ liên kết với một thẻ script cụ thể từ chủ đề của bản trình chiếu.
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| script | java.lang.String | Mã script BCP-47 (ví dụ: "Latn", "Cyrl", "Jpan") được dùng để xác định một hệ thống viết. |
...
Xóa cài đặt phông chữ liên kết với một thẻ script cụ thể khỏi bộ sưu tập phông chữ của chủ đề.
...
Trả về hoặc đặt phông chữ script phức hợp. Đọc/ghi [IFontData](../../com.aspose.slides/ifontdata).
