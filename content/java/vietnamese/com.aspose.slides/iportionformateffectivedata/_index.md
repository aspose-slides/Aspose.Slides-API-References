...
Giao diện này được sử dụng cùng với giao diện [IPortionFormat](../../com.aspose.slides/iportionformat) để trả về các giá trị định dạng hiệu quả có áp dụng kế thừa.
## Phương thức
