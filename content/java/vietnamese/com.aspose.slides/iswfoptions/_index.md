...
| Phương thức | Mô tả |
| --- | --- |
| [getCompressed()](#getCompressed--) | Chỉ định liệu tài liệu SWF được tạo có nên nén hay không. |
| [setCompressed(boolean value)](#setCompressed-boolean-) | Chỉ định liệu tài liệu SWF được tạo có nên nén hay không. |
| [getViewerIncluded()](#getViewerIncluded--) | Chỉ định liệu tài liệu SWF được tạo có nên bao gồm trình xem tài liệu tích hợp hay không. |
| [setViewerIncluded(boolean value)](#setViewerIncluded-boolean-) | Chỉ định liệu tài liệu SWF được tạo có nên bao gồm trình xem tài liệu tích hợp hay không. |
...
| [getShowHiddenSlides()](#getShowHiddenSlides--) | Chỉ định liệu tài liệu được tạo có nên bao gồm các slide ẩn hay không. |
| [setShowHiddenSlides(boolean value)](#setShowHiddenSlides-boolean-) | Chỉ định liệu tài liệu được tạo có nên bao gồm các slide ẩn hay không. |
...
| [getShowPageStepper()](#getShowPageStepper--) | Hiển thị/ẩn bộ điều chỉnh trang. |
| [setShowPageStepper(boolean value)](#setShowPageStepper-boolean-) | Hiển thị/ẩn bộ điều chỉnh trang. |
...
| [getShowTopPane()](#getShowTopPane--) | Hiển thị/ẩn toàn bộ khung trên cùng. |
| [setShowTopPane(boolean value)](#setShowTopPane-boolean-) | Hiển thị/ẩn toàn bộ khung trên cùng. |
| [getShowBottomPane()](#getShowBottomPane--) | Hiển thị/ẩn khung dưới cùng. |
| [setShowBottomPane(boolean value)](#setShowBottomPane-boolean-) | Hiển thị/ẩn khung dưới cùng. |
| [getShowLeftPane()](#getShowLeftPane--) | Hiển thị/ẩn khung bên trái. |
| [setShowLeftPane(boolean value)](#setShowLeftPane-boolean-) | Hiển thị/ẩn khung bên trái. |
| [getStartOpenLeftPane()](#getStartOpenLeftPane--) | Bắt đầu với khung bên trái mở. |
| [setStartOpenLeftPane(boolean value)](#setStartOpenLeftPane-boolean-) | Bắt đầu với khung bên trái mở. |
...
| [getJpegQuality()](#getJpegQuality--) | Chỉ định chất lượng của hình ảnh JPEG. |
| [setJpegQuality(int value)](#setJpegQuality-int-) | Chỉ định chất lượng của hình ảnh JPEG. |
| [getSlidesLayoutOptions()](#getSlidesLayoutOptions--) | Lấy hoặc đặt chế độ sắp xếp slide trên trang khi xuất bản trình chiếu [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions). |
| [setSlidesLayoutOptions(ISlidesLayoutOptions value)](#setSlidesLayoutOptions-com.aspose.slides.ISlidesLayoutOptions-) | Lấy hoặc đặt chế độ sắp xếp slide trên trang khi xuất bản trình chiếu [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions). |
...
Chỉ định liệu tài liệu SWF được tạo có nên nén hay không. Mặc định là true.
...
Chỉ định liệu tài liệu SWF được tạo có nên bao gồm trình xem tài liệu tích hợp hay không. Mặc định là true.
...
Chỉ định liệu tài liệu được tạo có nên bao gồm các slide ẩn hay không. Mặc định là false.
...
Hiển thị/ẩn bộ điều chỉnh trang. Có thể được ghi đè trong flashvars. Mặc định là true.
...
Hiển thị/ẩn toàn bộ khung trên cùng. Có thể được ghi đè trong flashvars. Mặc định là true.
...
Hiển thị/ẩn khung dưới cùng. Có thể được ghi đè trong flashvars. Mặc định là true.
...
Bắt đầu với khung bên trái mở. Có thể được ghi đè trong flashvars. Mặc định là false.
...
Chỉ định chất lượng của hình ảnh JPEG. Mặc định là 95.
...
Lấy hoặc đặt chế độ sắp xếp slide trên trang khi xuất bản trình chiếu [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions). Thuộc tính này không hỗ trợ gán các đối tượng kiểu [HandoutLayoutingOptions](../../com.aspose.slides/handoutlayoutingoptions)
