...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| licenseName | java.lang.String | Có thể là tên tệp đầy đủ hoặc ngắn hoặc tên của tài nguyên nhúng. Sử dụng chuỗi rỗng để chuyển sang chế độ đánh giá. |

--------------------

Thử tìm giấy phép ở các vị trí sau:
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| stream | java.io.InputStream | Một stream chứa giấy phép.
