...
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | Ghép các đoạn có cùng định dạng. |
...
Ghép các đoạn có cùng định dạng.
...
**Trả về:**
java.awt.geom.Rectangle2D.Float - Hình chữ nhật bao quanh đoạn văn java.awt.geom.Rectangle2D.Float
...
**Trả về:**
[IImage](../../com.aspose.slides/iimage) - Một hình ảnh chứa đoạn văn đã được render, hoặc null nếu không thể tìm thấy đoạn văn trong bộ sưu tập cha, không có giới hạn render hợp lệ, hoặc xảy ra lỗi khi render hình ảnh.
