...
description: Bao bọc đối tượng đại diện cho trục biểu đồ.
type: docs
...
| [getCategoryAxisType()](#getCategoryAxisType--) | Xác định loại của trục danh mục. |
| [setCategoryAxisType(int value)](#setCategoryAxisType-int-) | Xác định loại của trục danh mục. |
| [setCategoryAxisTypeAutomatically()](#setCategoryAxisTypeAutomatically--) | Đặt thuộc tính IAxis.CategoryAxisType với một giá trị được xác định tự động dựa trên dữ liệu trục. |
...
| [getDisplayUnit()](#getDisplayUnit--) | Xác định giá trị tỉ lệ của đơn vị hiển thị cho trục giá trị. |
| [setDisplayUnit(int value)](#setDisplayUnit-int-) | Xác định giá trị tỉ lệ của đơn vị hiển thị cho trục giá trị. |
...
| [getActualMajorUnitScale()](#getActualMajorUnitScale--) | Xác định tỉ lệ đơn vị chính thực tế của trục. |
| [getActualMinorUnitScale()](#getActualMinorUnitScale--) | Xác định tỉ lệ đơn vị phụ thực tế của trục. |
...
| [isLogarithmic()](#isLogarithmic--) | Biểu thị nếu loại tỉ lệ trục giá trị là logarit hay không. |
| [setLogarithmic(boolean value)](#setLogarithmic-boolean-) | Biểu thị nếu loại tỉ lệ trục giá trị là logarit hay không. |
...
| [getMajorTickMark()](#getMajorTickMark--) | Biểu thị loại dấu tick chính cho trục đã chỉ định. |
| [setMajorTickMark(int value)](#setMajorTickMark-int-) | Biểu thị loại dấu tick chính cho trục đã chỉ định. |
| [getMinorTickMark()](#getMinorTickMark--) | Biểu thị loại dấu tick phụ cho trục đã chỉ định. |
| [setMinorTickMark(int value)](#setMinorTickMark-int-) | Biểu thị loại dấu tick phụ cho trục đã chỉ định. |
| [getTickLabelPosition()](#getTickLabelPosition--) | Biểu thị vị trí của nhãn dấu tick trên trục đã chỉ định. |
| [setTickLabelPosition(int value)](#setTickLabelPosition-int-) | Biểu thị vị trí của nhãn dấu tick trên trục đã chỉ định. |
| [getMajorUnitScale()](#getMajorUnitScale--) | Biểu thị tỉ lệ đơn vị chính cho trục ngày. |
| [setMajorUnitScale(int value)](#setMajorUnitScale-int-) | Biểu thị tỉ lệ đơn vị chính cho trục ngày. |
| [getMinorUnitScale()](#getMinorUnitScale--) | Biểu thị tỉ lệ đơn vị chính cho trục ngày. |
| [setMinorUnitScale(int value)](#setMinorUnitScale-int-) | Biểu thị tỉ lệ đơn vị chính cho trục ngày. |
...
| [getMinorGridLinesFormat()](#getMinorGridLinesFormat--) | Biểu thị định dạng đường lưới phụ trên trục biểu đồ. |
| [getMajorGridLinesFormat()](#getMajorGridLinesFormat--) | Biểu thị định dạng đường lưới chính trên trục biểu đồ. |
| [getShowMinorGridLines()](#getShowMinorGridLines--) | Để ẩn đường lưới phụ, đặt MinorGridLinesFormat.Line.FillFormat.FillType thành FillType.NoFill. |
| [getShowMajorGridLines()](#getShowMajorGridLines--) | Để ẩn đường lưới chính, đặt MajorGridLinesFormat.Line.FillFormat.FillType thành FillType.NoFill. |
...
| [getCrossType()](#getCrossType--) | Biểu thị CrossType trên trục đã chỉ định nơi trục còn lại cắt qua. |
| [setCrossType(int value)](#setCrossType-int-) | Biểu thị CrossType trên trục đã chỉ định nơi trục còn lại cắt qua. |
...
| [getTickMarksSpacing()](#getTickMarksSpacing--) | Xác định số dấu tick sẽ bị bỏ qua trước khi vẽ dấu tiếp theo. |
| [setTickMarksSpacing(long value)](#setTickMarksSpacing-long-) | Xác định số dấu tick sẽ bị bỏ qua trước khi vẽ dấu tiếp theo. |
...
| [isOverflowBin()](#isOverflowBin--) | Xác định liệu bin tràn được áp dụng hay không. |
| [setOverflowBin(boolean value)](#setOverflowBin-boolean-) | Xác định liệu bin tràn được áp dụng hay không. |
...
| [isUnderflowBin()](#isUnderflowBin--) | Xác định liệu bin thiếu được áp dụng hay không. |
| [setUnderflowBin(boolean value)](#setUnderflowBin-boolean-) | Xác định liệu bin thiếu được áp dụng hay không. |
...
Xác định loại của trục danh mục. Đọc/ghi [CategoryAxisType](../../com.aspose.slides/categoryaxistype).
...
Xác định giá trị tỉ lệ của đơn vị hiển thị cho trục giá trị. Đọc/ghi [DisplayUnitType](../../com.aspose.slides/displayunittype).
...
Xác định giá trị tối đa thực tế trên trục. Gọi phương thức IChart.ValidateChartLayout() trước để có giá trị thực tế.
...
Xác định giá trị tối thiểu thực tế trên trục. Gọi phương thức IChart.ValidateChartLayout() trước để có giá trị thực tế.
...
Xác định đơn vị chính thực tế của trục. Gọi phương thức IChart.ValidateChartLayout() trước để có giá trị thực tế.
...
Xác định đơn vị phụ thực tế của trục. Gọi phương thức IChart.ValidateChartLayout() trước để có giá trị thực tế.
...
Xác định tỉ lệ đơn vị chính thực tế của trục. Gọi phương thức IChart.ValidateChartLayout() trước để có giá trị thực tế.
...
Xác định tỉ lệ đơn vị phụ thực tế của trục. Gọi phương thức IChart.ValidateChartLayout() trước để có giá trị thực tế.
...
Biểu diễn các đơn vị chính cho trục ngày hoặc giá trị. Đọc/ghi double.
...
Biểu diễn nếu loại thang đo trục giá trị là logarit hay không. Đọc/ghi boolean.
...
Biểu diễn nếu MS PowerPoint vẽ các điểm dữ liệu từ cuối tới đầu. Đọc/ghi boolean.
...
Biểu diễn nếu trục hiển thị. Đọc/ghi boolean.
...
Biểu diễn tỉ lệ đơn vị chính cho trục ngày. Đọc/ghi [TimeUnitType](../../com.aspose.slides/timeunittype).
...
Biểu diễn định dạng của văn bản. Chỉ-đọc [IChartTextFormat](../../com.aspose.slides/icharttextformat).
...
Biểu diễn CrossType trên trục đã chỉ định nơi trục khác cắt. Đọc/ghi [CrossesType](../../com.aspose.slides/crossestype).
...
Cho biết liệu định dạng có liên kết với dữ liệu nguồn hay không. Đọc/ghi boolean.
...
Biểu diễn góc quay của nhãn tick. Đọc/ghi float.
...
Xác định số nhãn tick sẽ bỏ qua giữa các nhãn được vẽ. Áp dụng cho trục danh mục hoặc series. Đọc/ghi long.
...
Xác định số dấu tick sẽ bỏ qua trước khi vẽ dấu tiếp theo. Áp dụng cho trục danh mục hoặc series. Đọc/ghi int.
...
Xác định khoảng cách của nhãn so với trục. Áp dụng cho trục danh mục hoặc ngày. Giá trị phải nằm trong khoảng 0% và 1000%. Đọc/ghi int.
...
Biểu diễn loại tổng hợp của trục danh mục (nhóm). Áp dụng cho danh mục. Chỉ dùng với series Histogram hoặc HistogramPareto.
...
Chỉ định độ rộng bin khi giá trị thuộc tính AggregationType được đặt thành AxisAggregationType.ByBinWidth. Áp dụng cho các trục danh mục. Chỉ dùng với series Histogram hoặc HistogramPareto.
...
Chỉ định số lượng bin khi giá trị thuộc tính AggregationType được đặt thành AxisAggregationType.ByNumberOfBins. Áp dụng cho các trục danh mục. Chỉ dùng với series Histogram hoặc HistogramPareto.
...
Chỉ định nếu bin tràn được áp dụng. Sử dụng IsAutomaticOverflowBin và OverflowBin để điều chỉnh giá trị bin tràn.
...
Chỉ định giá trị bin tràn tự động. Nếu false: sử dụng thuộc tính OverflowBin.
...
Chỉ định giá trị tùy chỉnh cho bin tràn. Áp dụng khi thuộc tính IsAutomaticOverflowBin được đặt thành false và thuộc tính IsOverflowBin bằng true.
...
Chỉ định nếu bin thiếu được áp dụng. Sử dụng IsAutomaticUnderflowBin và UnderflowBin để điều chỉnh giá trị bin thiếu.
...
Chỉ định giá trị bin thiếu tự động. Nếu false: sử dụng thuộc tính UnderflowBin.
...
Chỉ định giá trị tùy chỉnh cho bin thiếu. Áp dụng khi thuộc tính IsAutomaticUnderflowBin được đặt thành false và thuộc tính IsUnderflowBin bằng true.
...
Trả về bản thuyết trình cha của một FillFormat. Chỉ đọc [IPresentation](../../com.aspose.slides/ipresentation).
