...
| [getItemId()](#getItemId--) | Xác định định danh toàn toàn duy nhất (GUID) xác định duy nhất một phần XML tùy chỉnh trong tài liệu Office Open XML. |
| [setItemId(UUID value)](#setItemId-java.util.UUID-) | Xác định định danh toàn toàn duy nhất (GUID) xác định duy nhất một phần XML tùy chỉnh trong tài liệu Office Open XML. |
...
Xác định định danh toàn toàn duy nhất (GUID) xác định duy nhất một phần XML tùy chỉnh trong tài liệu Office Open XML. Chỉ đọc java.util.UUID.
