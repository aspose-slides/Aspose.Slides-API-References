...
| Phương thức | Mô tả |
| --- | --- |
| [getRow()](#getRow--) | Trả về chỉ số hàng của worksheet mà ô nằm trong đó. |
| [getColumn()](#getColumn--) | Trả về chỉ số cột của worksheet mà ô nằm trong đó. |
...
| [getCustomNumberFormat()](#getCustomNumberFormat--) | Lấy hoặc đặt định dạng hiển thị tùy chỉnh của số và ngày. |
| [setCustomNumberFormat(String value)](#setCustomNumberFormat-java.lang.String-) | Lấy hoặc đặt định dạng hiển thị tùy chỉnh của số và ngày. |
| [getPresetNumberFormat()](#getPresetNumberFormat--) | Lấy hoặc đặt định dạng hiển thị tích hợp của số và ngày. |
| [setPresetNumberFormat(byte value)](#setPresetNumberFormat-byte-) | Lấy hoặc đặt định dạng hiển thị tích hợp của số và ngày. |
...
Trả về chỉ số hàng của worksheet mà ô nằm trong đó. Chỉ đọc int.
...
Trả về chỉ số cột của worksheet mà ô nằm trong đó. Chỉ đọc int.
...
Lấy hoặc đặt định dạng hiển thị tùy chỉnh của số và ngày. Nếu giá trị trống sẽ được sử dụng giá trị PresetNumberFormat. Đọc/ghi String.
...
Lấy hoặc đặt định dạng hiển thị tích hợp của số và ngày. Số preset phải nằm trong [0..22] hoặc [37..49]. Đọc/ghi byte.
...
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| updateValues | boolean | Nếu false, sẽ không thực hiện tính toán thực tế. Sử dụng true để kiểm tra ngoại lệ có thể xảy ra. |