...
| [getInterpretMaskOpAsOpacity()](#getInterpretMaskOpAsOpacity--) | Sử dụng thao tác ROP hoặc Độ mờ cho việc vẽ bút. |
| [setInterpretMaskOpAsOpacity(boolean value)](#setInterpretMaskOpAsOpacity-boolean-) | Sử dụng thao tác ROP hoặc Độ mờ cho việc vẽ bút. |
...
Sử dụng thao tác ROP hoặc Độ mờ cho việc vẽ bút.
