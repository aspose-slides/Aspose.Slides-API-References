...
| [getEffective()](#getEffective--) | Lấy các thuộc tính định dạng ô bảng hiệu quả với việc kế thừa và áp dụng kiểu bảng. |
...
Lấy các thuộc tính định dạng ô bảng hiệu quả với việc kế thừa và áp dụng kiểu bảng.
