...
Biểu diễn một hiệu ứng Alpha Bi-Level. Các giá trị Alpha (Opacity) nhỏ hơn ngưỡng sẽ được thay đổi thành 0 (hoàn toàn trong suốt) và các giá trị alpha lớn hơn hoặc bằng ngưỡng sẽ được thay đổi thành 100% (hoàn toàn không trong suốt).
## Phương thức
...
| [getEffective()](#getEffective--) | Lấy dữ liệu hiệu ứng Alpha Bi-Level đã áp dụng kế thừa. |
| [equals(Object obj)](#equals-java.lang.Object-) | Xác định xem [AlphaBiLevel](../../com.aspose.slides/alphabilevel) được chỉ định có bằng với [AlphaBiLevel](../../com.aspose.slides/alphabilevel) hiện tại hay không. |
| [hashCode()](#hashCode--) | Đóng vai trò là hàm băm cho một kiểu nhất định. |
...
Lấy dữ liệu hiệu ứng Alpha Bi-Level đã áp dụng kế thừa.
...
Xác định xem [AlphaBiLevel](../../com.aspose.slides/alphabilevel) được chỉ định có bằng với [AlphaBiLevel](../../com.aspose.slides/alphabilevel) hiện tại hay không.
...
Đóng vai trò là hàm băm cho một kiểu nhất định.
