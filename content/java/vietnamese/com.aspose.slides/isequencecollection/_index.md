...
| Phương thức | Mô tả |
| --- | --- |
| [getCount()](#getCount--) | Trả về số phần tử trong bộ sưu tập. Chỉ đọc int. |
...
| [removeAt(int index)](#removeAt-int-) | Xóa chuỗi tại chỉ số được chỉ định. |
| [clear()](#clear--) | Xóa tất cả các chuỗi khỏi bộ sưu tập. |
| [get_Item(int index)](#get-Item-int-) | Trả về một chuỗi tại chỉ số được chỉ định. |
### getCount() {#getCount--}
```
...
Xóa chuỗi tại chỉ số được chỉ định.

**Tham số:**
| Tham số | Kiểu | Mô tả |
| --- | --- | --- |
| index | int | Chỉ số của phần tử trong bộ sưu tập int |
### clear() {#clear--}
```
...
Trả về một chuỗi tại chỉ số được chỉ định.
