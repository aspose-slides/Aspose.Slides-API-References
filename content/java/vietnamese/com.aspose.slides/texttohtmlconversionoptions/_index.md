...
| [getLinkEmbedController()](#getLinkEmbedController--) | Trả về hoặc đặt một đối tượng callback điều khiển cách lưu trữ đối tượng bên ngoài. |
| [setLinkEmbedController(ILinkEmbedController value)](#setLinkEmbedController-com.aspose.slides.ILinkEmbedController-) | Trả về hoặc đặt một đối tượng callback điều khiển cách lưu trữ đối tượng bên ngoài. |
...
Trả về hoặc đặt một đối tượng callback điều khiển cách lưu trữ đối tượng bên ngoài. Đọc/ghi [ILinkEmbedController](../../com.aspose.slides/ilinkembedcontroller).
...
Trả về hoặc đặt tên mã hoá html. Giá trị này sẽ được lưu vào tệp HTML đã tạo, nhưng việc đảm bảo tệp được lưu với mã hoá này là trách nhiệm của người gọi. Đọc/ghi String.
