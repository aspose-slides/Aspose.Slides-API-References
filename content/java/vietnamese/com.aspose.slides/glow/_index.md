...
description: Đại diện cho hiệu ứng Glow trong đó một đường viền màu mờ được thêm vào phía ngoài các cạnh của đối tượng.
type: docs
...
Mô tả một hiệu ứng Glow, trong đó một đường viền màu mờ được thêm vào phía ngoài các cạnh của đối tượng.
## Phương thức
...
| [getEffective()](#getEffective--) | Lấy dữ liệu hiệu ứng Glow thực tế với kế thừa được áp dụng. |
| [getParent_Immediate()](#getParent-Immediate--) |  |
| [getVersion()](#getVersion--) |  |
| [getParent_IPresentationComponent()](#getParent-IPresentationComponent--) |  |
| [equals(Object obj)](#equals-java.lang.Object-) | Xác định xem [Glow](../../com.aspose.slides/glow) được chỉ định có bằng với [Glow](../../com.aspose.slides/glow) hiện tại không. |
...
Lấy dữ liệu hiệu ứng Glow thực tế với kế thừa được áp dụng.
...
Trả về parent IPresentationComponent. Chỉ đọc [IPresentationComponent](../../com.aspose.slides/ipresentationcomponent).
...
Xác định xem [Glow](../../com.aspose.slides/glow) được chỉ định có bằng với [Glow](../../com.aspose.slides/glow) hiện tại không.
