...
| [getContourWidth()](#getContourWidth--) | Trả về hoặc đặt chiều rộng của một đường viền 3D. |
| [setContourWidth(double value)](#setContourWidth-double-) | Trả về hoặc đặt chiều rộng của một đường viền 3D. |
| [getExtrusionHeight()](#getExtrusionHeight--) | Trả về hoặc đặt chiều cao của một hiệu ứng nhô ra. |
| [setExtrusionHeight(double value)](#setExtrusionHeight-double-) | Trả về hoặc đặt chiều cao của một hiệu ứng nhô ra. |
| [getDepth()](#getDepth--) | Trả về hoặc đặt độ sâu của một hình 3D. |
| [setDepth(double value)](#setDepth-double-) | Trả về hoặc đặt độ sâu của một hình 3D. |
| [getBevelTop()](#getBevelTop--) | Trả về hoặc đặt loại viền trên 3D. |
| [getBevelBottom()](#getBevelBottom--) | Trả về hoặc đặt loại viền dưới 3D. |
| [getContourColor()](#getContourColor--) | Trả về hoặc đặt màu của một đường viền. |
| [getExtrusionColor()](#getExtrusionColor--) | Trả về hoặc đặt màu của một hiệu ứng nhô ra. |
| [getCamera()](#getCamera--) | Trả về hoặc đặt cài đặt của một máy ảnh. |
| [getLightRig()](#getLightRig--) | Trả về hoặc đặt loại ánh sáng. |
| [getMaterial()](#getMaterial--) | Trả về hoặc đặt loại vật liệu. |
| [setMaterial(int value)](#setMaterial-int-) | Trả về hoặc đặt loại vật liệu. |
| [getEffective()](#getEffective--) | Lấy dữ liệu định dạng 3D có hiệu lực với kế thừa đã được áp dụng. |
### getVersion() {#getVersion--}
```
...
Trả về hoặc đặt chiều rộng của một đường viền 3D. Đọc/ghi double.
...
Trả về hoặc đặt chiều cao của một hiệu ứng nhô ra. Đọc/ghi double.
...
Trả về hoặc đặt độ sâu của một hình 3D. Đọc/ghi double.
...
Trả về hoặc đặt loại viền trên 3D. Chỉ đọc [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Trả về hoặc đặt loại viền dưới 3D. Chỉ đọc [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Trả về hoặc đặt màu của một hiệu ứng nhô ra. Chỉ đọc [IColorFormat](../../com.aspose.slides/icolorformat).
...
Trả về hoặc đặt loại ánh sáng. Chỉ đọc [ILightRig](../../com.aspose.slides/ilightrig).
...
Trả về hoặc đặt loại vật liệu. Đọc/ghi [MaterialPresetType](../../com.aspose.slides/materialpresettype).
...
Lấy dữ liệu định dạng 3D có hiệu lực với kế thừa đã được áp dụng.

--------------------

> ```
> Ví dụ này minh họa cách lấy các thuộc tính hiệu lực cho máy ảnh, bộ đèn và viền trên của hình dạng.
>  
