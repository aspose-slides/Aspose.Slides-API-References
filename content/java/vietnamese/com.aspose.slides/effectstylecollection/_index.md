...
Đại diện cho một tập hợp các kiểu hiệu ứng.
...
| [isSynchronized()](#isSynchronized--) | Trả về một giá trị cho biết việc truy cập vào tập hợp có được đồng bộ (an toàn với luồng) hay không. |
...
**Trả về:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffectStyle> - Một IGenericEnumerator có thể được dùng để duyệt qua tập hợp.
...
Trả về một giá trị cho biết việc truy cập vào tập hợp có được đồng bộ (an toàn với luồng) hay không. Chỉ đọc boolean.
