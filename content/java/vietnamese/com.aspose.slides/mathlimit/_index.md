...
description: Xác định đối tượng Limit, bao gồm văn bản trên đường baseline và văn bản kích thước giảm ngay trên hoặc dưới nó.
type: docs
...
Xác định đối tượng Limit, bao gồm văn bản trên đường baseline và văn bản kích thước giảm ngay trên hoặc dưới nó.
...
| [getLimit()](#getLimit--) | Tham số giới hạn |
