...
| Phương thức | Mô tả |
| --- | --- |
| [getType()](#getType--) | Trả về một loại nền fill. |
| [setType(byte value)](#setType-byte-) | Trả về một loại nền fill. |
...
| [getEffective()](#getEffective--) | Lấy dữ liệu nền thực tế sau khi áp dụng kế thừa. |
...
Trả về một loại nền fill. Đọc/ghi [BackgroundType](../../com.aspose.slides/backgroundtype).
...
Lấy dữ liệu nền thực tế sau khi áp dụng kế thừa.
