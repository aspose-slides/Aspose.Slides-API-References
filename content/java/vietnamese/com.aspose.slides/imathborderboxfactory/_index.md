...
| strikethroughBottomLeftToTopRight | boolean | Gạch ngang hộp viền từ dưới-trái tới trên-phải |
| strikethroughTopLeftToBottomRight | boolean | Gạch ngang hộp viền từ trên-trái tới dưới-phải |
