...
Cung cấp các tùy chọn kiểm soát cách trình chiếu/slide được hiển thị.
...
Lấy hoặc đặt giá trị cho biết liệu văn bản có được hiển thị mà không sử dụng các ligature hay không. Khi được đặt thành true, các ligature sẽ bị tắt trong đầu ra đã render. Mặc định, thuộc tính này được đặt là false.
