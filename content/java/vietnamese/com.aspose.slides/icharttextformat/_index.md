...
description: Biểu đồ hoạt động với một tập hợp hạn chế các thuộc tính định dạng văn bản.
type: docs
...
Biểu đồ hoạt động với một tập hợp hạn chế các thuộc tính định dạng văn bản. Các giao diện IChartTextFormat, IChartTextBlockFormat, IChartParagraphFormat, IChartPortionFormat mô tả tập hợp hạn chế này.
## Phương thức

| Phương thức | Mô tả |
| --- | --- |
| [getTextBlockFormat()](#getTextBlockFormat--) | Trả về định dạng cho các phần tử văn bản của biểu đồ. |
...
Trả về định dạng cho các phần tử văn bản của biểu đồ. Chỉ đọc [IChartTextBlockFormat](../../com.aspose.slides/icharttextblockformat).
