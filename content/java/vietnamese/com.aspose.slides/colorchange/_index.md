...
| [getEffective()](#getEffective--) | Lấy dữ liệu hiệu ứng Color Change hiệu quả với tính kế thừa đã được áp dụng. |
...
Lấy dữ liệu hiệu ứng Color Change hiệu quả với tính kế thừa đã được áp dụng.
