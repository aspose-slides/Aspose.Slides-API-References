...
| Phương thức | Mô tả |
| --- | --- |
| [getCertificate()](#getCertificate--) | Đối tượng Certificate được sử dụng để ký tài liệu. |
| [isValid()](#isValid--) | Nếu chữ ký số này hợp lệ và tài liệu không bị thay đổi, giá trị này sẽ là true. |
...
Đối tượng Certificate được sử dụng để ký tài liệu. Chỉ đọc byte[].
