...
نمایانگر گروهی از متدها است که برای جمع‌آوری اشیای مدل از انواع مختلف از [Presentation](../../com.aspose.slides/presentation) طراحی شده‌اند.
...
>      {
>          // ... تغییر قالب‌بندی شکل یا سایر ویژگی‌ها
>      }
>  } finally {
...
| متد | توضیح |
| --- | --- |
| [shapes(Presentation pres)](#shapes-com.aspose.slides.Presentation-) | تمام نمونه‌های [Shape](../../com.aspose.slides/shape) را در [Presentation](../../com.aspose.slides/presentation) جمع می‌کند. |
### Collect() {#Collect--}
```
public Collect()
```
...
تمام نمونه‌های [Shape](../../com.aspose.slides/shape) را در [Presentation](../../com.aspose.slides/presentation) جمع می‌کند.
...
>      for (IShape shape : Collect.shapes(pres))
>      {
>          // اگر shape AutoShape باشد، یک حاشیه مشکی ثابت اضافه کنید
...
**بازگشت:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.slides.Shape> - مجموعه‌ای از تمام اشکالی که در ارائه وجود دارند