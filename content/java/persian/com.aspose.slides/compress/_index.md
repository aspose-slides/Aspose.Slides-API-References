...
description: نمایش‌دهندهٔ گروهی از متدها که برای فشرده‌سازی .
type: docs
...
نمایش‌دهندهٔ گروهی از متدها که برای فشرده‌سازی [Presentation](../../com.aspose.slides/presentation) هدف‌گذاری شده‌اند.
...
| [compressEmbeddedFonts(Presentation pres)](#compressEmbeddedFonts-com.aspose.slides.Presentation-) | فشرده‌سازی [Presentation](../../com.aspose.slides/presentation) را با حذف کاراکترهای استفاده‌نشده از فونت‌های جاسازی‌شده انجام می‌دهد. |
### Compress() {#Compress--}
```
public Compress()
```
...
| پارامتر | نوع | توضیح |
| --- | --- | --- |
| pres | [Presentation](../../com.aspose.slides/presentation) | نمونه ارائه |
...
فشرده‌سازی [Presentation](../../com.aspose.slides/presentation) را با حذف کاراکترهای استفاده‌نشده از فونت‌های جاسازی‌شده انجام می‌دهد.
