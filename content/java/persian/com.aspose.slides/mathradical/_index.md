...
description: تابع رادیکال را که شامل یک پایه و یک درجهٔ اختیاری است، مشخص می‌کند.
type: docs
...
توابع رادیکال را مشخص می‌کند که شامل یک پایه و یک درجهٔ اختیاری است. مثال شی رادیکال ‎\\u221a\\ud835\\udc65‎ است.
...
| متد | توضیح |
| --- | --- |
| [getBase()](#getBase--) | آرگمان پایه |
| [getDegree()](#getDegree--) | آرگمان درجه |
| [getHideDegree()](#getHideDegree--) | پنهان کردن درجه. وقتی مقدار true باشد، درجه نشان داده نمی‌شود، همانند ‎\\u221a\\ud835\\udc65‎ |
| [setHideDegree(boolean value)](#setHideDegree-boolean-) | پنهان کردن درجه. وقتی مقدار true باشد، درجه نشان داده نمی‌شود، همانند ‎\\u221a\\ud835\\udc65‎ |
...
پنهان کردن درجه. وقتی مقدار true باشد، درجه نشان داده نمی‌شود، همانند ‎\\u221a\\ud835\\udc65‎
