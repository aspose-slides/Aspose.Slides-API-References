...
description: یک نظر روی اسلاید را نمایندگی می‌کند.
type: docs
...
یک نظر روی اسلاید را نمایندگی می‌کند.
...
>  try {
>      // تکرار بر روی CommentAuthors
>      for (ICommentAuthor commentAuthor : presentation.getCommentAuthors())
>      {
>          CommentAuthor author = (CommentAuthor) commentAuthor;
>          // تکرار بر روی Comments
...
| [getPosition()](#getPosition--) | موقعیت یک نظر بر روی اسلاید را برمی‌گرداند یا تنظیم می‌کند. |
| [setPosition(Point2D.Float value)](#setPosition-java.awt.geom.Point2D.Float-) | موقعیت یک نظر بر روی اسلاید را برمی‌گرداند یا تنظیم می‌کند. |
...
زمان ایجاد یک نظر را برمی‌گرداند یا تنظیم می‌کند. تنظیم این خصوصیت به java.util.Date(Long.MIN\_VALUE) به این معناست که زمان نظر تنظیم نشده است. خواندنی/نوشتنی java.util.Date.
...
موقعیت یک نظر بر روی اسلاید را برمی‌گرداند یا تنظیم می‌کند. خواندنی/نوشتنی java.awt.geom.Point2D.Float.
...
نظر والد را برمی‌گیرد یا تنظیم می‌کند. خواندنی/نوشتنی [IComment](../../com.aspose.slides/icomment).
