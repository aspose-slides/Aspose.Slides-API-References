...
description: نمایان‌گر قالب یک خط است.
type: docs
...
| [isFormatNotDefined()](#isFormatNotDefined--) | در صورتی که قالب خط تعریف نشده باشد (به‌عنوان تازه ایجاد شده، پیش‌فرض) مقدار true را برمی‌گرداند. |
| [getFillFormat()](#getFillFormat--) | قالب پر کردن یک خط را برمی‌گرداند. |
| [getSketchFormat()](#getSketchFormat--) | قالب کش‌خط یک خط را برمی‌گرداند. |
...
| [getDashStyle()](#getDashStyle--) | سبک خط تیره یک خط را برمی‌گرداند یا تنظیم می‌کند. |
| [setDashStyle(byte value)](#setDashStyle-byte-) | سبک خط تیره یک خط را برمی‌گرداند یا تنظیم می‌کند. |
| [getCustomDashPattern()](#getCustomDashPattern--) | الگوی خط تیره سفارشی را برمی‌گرداند یا تنظیم می‌کند. |
| [setCustomDashPattern(float[] value)](#setCustomDashPattern-float---) | الگوی خط تیره سفارشی را برمی‌گرداند یا تنظیم می‌کند. |
...
| [getAlignment()](#getAlignment--) | ترازبندی خط را برمی‌گرداند یا تنظیم می‌کند. |
| [setAlignment(byte value)](#setAlignment-byte-) | ترازبندی خط را برمی‌گرداند یا تنظیم می‌کند. |
...
| [getMiterLimit()](#getMiterLimit--) | حد مقدار میتر یک خط را برمی‌گرداند یا تنظیم می‌کند. |
| [setMiterLimit(float value)](#setMiterLimit-float-) | حد مقدار میتر یک خط را برمی‌گرداند یا تنظیم می‌کند. |
...
| [getEffective()](#getEffective--) | داده‌های قالب‌بندی خط مؤثر را با اعمال وراثت دریافت می‌کند. |
...
در صورتی که قالب خط تعریف نشده باشد (به‌عنوان تازه ایجاد شده، پیش‌فرض) مقدار true را برمی‌گرداند. فقط‌خواندنی boolean.
...
قالب کش‌خط یک خط را برمی‌گرداند. فقط‌خواندنی [ILineFillFormat](../../com.aspose.slides/ilinefillformat).
...
عرض یک خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن double.
...
سبک خط تیره یک خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن [LineDashStyle](../../com.aspose.slides/linedashstyle).
...
الگوی خط تیره سفارشی را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن float[].
...
سبک انتهای خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن [LineCapStyle](../../com.aspose.slides/linecapstyle).
...
سبک خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن [LineStyle](../../com.aspose.slides/linestyle).
...
ترازبندی خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن [LineAlignment](../../com.aspose.slides/linealignment).
...
سبک اتصال خطوط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن [LineJoinStyle](../../com.aspose.slides/linejoinstyle).
...
حد مقدار میتر یک خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن float.
...
سبک سرپیکان در ابتدای خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
سبک سرپیکان در انتهای خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
عرض سرپیکان در ابتدای خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
عرض سرپیکان در انتهای خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
طول سرپیکان در ابتدای خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
طول سرپیکان در انتهای خط را برمی‌گرداند یا تنظیم می‌کند. خواندنی/قابل‌نوشتن [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
**بازمی‌گرداند:**
boolean - **true** اگر LineFormat مشخص‌شده برابر با LineFormat فعلی باشد؛ در غیر این صورت **false**.
...
> ```
> این مثال نشان می‌دهد که چگونه ویژگی‌های قالب خط مؤثر یک شکل را دریافت کنیم.
>  
