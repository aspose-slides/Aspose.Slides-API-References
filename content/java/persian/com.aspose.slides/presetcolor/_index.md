...
description: نمایانگر پیش‌تنظیم‌های رنگی از پیش تعریف‌شده.
type: docs
url: /fa/com.aspose.slides/presetcolor/
---
**وارثت:**  
...
نمایشگر پیش‌تنظیم‌های رنگی از پیش تعریف‌شده.
## فیلدها

| فیلد | توضیح |
| --- | --- |
| [NotDefined](#NotDefined) | پیش‌تنظیم رنگ تعریف نشده است. |
| [AliceBlue](#AliceBlue) |  |
