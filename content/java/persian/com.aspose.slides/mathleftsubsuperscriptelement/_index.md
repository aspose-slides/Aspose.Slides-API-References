...
description: شی Sub-Superscript را مشخص می‌کند که از یک پایه و زیرنویس و بالانویس تشکیل شده است و به سمت چپ پایه قرار می‌گیرد.
type: docs
...
شی Sub-Superscript را مشخص می‌کند که از یک پایه و زیرنویس و بالانویس تشکیل شده است و به سمت چپ پایه قرار می‌گیرد.
