...
description: ثابت‌هایی که نوع پیش‌تنظیم دوربین را تعریف می‌کنند.
type: docs
url: /fa/com.aspose.slides/camerapresettype/
---
**وراثت:**
...
ثابت‌هایی که نوع پیش‌تنظیم دوربین را تعریف می‌کنند.
## فیلدها
...
### IsometricOffAxis2Right {#IsometricOffAxis2Right}
```
public static final int IsometricOffMatrix2Right
```
