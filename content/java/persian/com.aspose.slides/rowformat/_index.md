...
| متد | توضیح |
| --- | --- |
| [getEffective()](#getEffective--) | ویژگی‌های قالب‌بندی ردیف جدول مؤثر را با ارث‌بری و اعمال استایل‌های جدول دریافت می‌کند. |
...
ویژگی‌های قالب‌بندی ردیف جدول مؤثر را با ارث‌بری و اعمال استایل‌های جدول دریافت می‌کند.
...
**بازگشت:**
[IRowFormatEffectiveData](../../com.aspose.slides/irowformateffectivedata) - یک [IRowFormatEffectiveData](../../com.aspose.slides/irowformateffectivedata).
### getVersion() {#getVersion--}
```
