...
description: کلاس کنترلر قالب‌بندی برای استفاده در تعبیهٔ قلم‌ها در فرمت WOFF
type: docs
...
| سازنده | توضیح |
| --- | --- |
| [EmbeddedWoffFontsHtmlController()](#EmbeddedWoffFontsHtmlController--) | ایجاد یک نمونه جدید. |
| [EmbeddedWoffFontsHtmlController(IHtmlFormattingController controller)](#EmbeddedWoffFontsHtmlController-com.aspose.slides.IHtmlFormattingController-) | ایجاد یک نمونه جدید. |
## متدها
...
برای نوشتن پایانهٔ سند html فراخوانی می‌شود. یک بار برای هر تبدیل ارائه فراخوانی می‌شود.
...
برای نوشتن پایانهٔ اسلاید html فراخوانی می‌شود. یک بار برای هر اسلاید فراخوانی می‌شود.
...
قبل از رندر شکل فراخوانی می‌شود. یک بار برای هر شکل فراخوانی می‌شود. اگر این تابع چیزی به generator بنویسد، تولید تصویر اسلاید جاری پایان می‌یابد، تکه html اضافه شده وارد می‌شود و تصویر جدیدی روی تصویر قبلی شروع می‌شود.
