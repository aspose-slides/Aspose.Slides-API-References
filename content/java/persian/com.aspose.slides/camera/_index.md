...
description: نمایش‌دهنده دوربین.
type: docs
...
نوع دوربین. قابل خواندن/نوشتن [CameraPresetType](../../com.aspose.slides/camerapresettype).
...
Camera FOV (0-180 deg, field of View). قابل خواندن/نوشتن float.
...
Camera zoom (positive value in percentage). قابل خواندن/نوشتن float.
