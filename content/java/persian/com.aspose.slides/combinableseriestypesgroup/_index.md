...
شمارشی از گروه‌های انواع سری‌های ترکیبی. هر عنصر به گروهی از انواع سری‌های نمودار مربوط می‌شود که می‌توانند به‌صورت همزمان در یک ChartSeriesGroup موجود باشند. برای مثال: سری‌های ChartType.PercentsStackedArea نمی‌توانند به‌همراه سری‌های ChartType.StackedArea در یک ChartSeriesGroup باشند. اما دو یا چند سری ChartType.PercentsStackedArea می‌توانند به‌صورت همزمان در یک ChartSeriesGroup باشند (CombinableSeriesTypesGroup.AreaChart_PercentsStackedArea). و سری‌های ChartType.Line می‌توانند به‌همراه سری‌های ChartType.LineWithMarkers به‌صورت همزمان در یک CombinableSeriesTypesGroup.LineChart_Line ChartSeriesGroup حضور داشته باشند.
