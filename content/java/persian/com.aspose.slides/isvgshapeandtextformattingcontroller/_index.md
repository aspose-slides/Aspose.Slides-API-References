...
| متد | توضیح |
| --- | --- |
| [formatText(ISvgTSpan svgTSpan, IPortion portion, ITextFrame textFrame)](#formatText-com.aspose.slides.ISvgTSpan-com.aspose.slides.IPortion-com.aspose.slides.ITextFrame-) | این تابع قبل از رندر کردن بخش متن به SVG فراخوانی می‌شود تا به کاربر اجازه کنترل SVG حاصل را بدهد. |
...
این تابع قبل از رندر کردن بخش متن به SVG فراخوانی می‌شود تا به کاربر اجازه کنترل SVG حاصل را بدهد.

**پارامترها:**
| پارامتر | نوع | توضیح |
| --- | --- | --- |
| svgTSpan | [ISvgTSpan](../../com.aspose.slides/isvgtspan) | شیئی برای کنترل تولید tspan SVG. |
