...
description: متدهایی برای نمونه‌سازی و کار با .
type: docs
url: /fa/com.aspose.slides/images/
---
**ارث‌بری:**
java.lang.Object
```
...
متدهایی برای نمونه‌سازی و کار با [IImage](../../com.aspose.slides/iimage).
## سازنده‌ها
...
یک تصویر را از آرایه بایت ایجاد می‌کند.
...
یک تصویر را از جریان ایجاد می‌کند.
