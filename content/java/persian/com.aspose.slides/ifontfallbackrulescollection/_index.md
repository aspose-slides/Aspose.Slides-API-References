...
description: نمایش یک مجموعه از قوانین FontFallBack که توسط کاربر تعریف شده است
type: docs
...
نمایش یک مجموعه از قوانین FontFallBack که توسط کاربر تعریف شده است  
## متدها

| متد | توضیح |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | قانون را در ایندکس مشخص شده دریافت می‌کند. |
| [add(IFontFallBackRule sourceRule)](#add-com.aspose.slides.IFontFallBackRule-) | یک قانون FallBack جدید را به انتهای مجموعه اضافه می‌کند. |
| [remove(IFontFallBackRule targetRule)](#remove-com.aspose.slides.IFontFallBackRule-) | اولین وقوع یک قانون FallBack خاص را از مجموعه حذف می‌کند. |
...
اولین وقوع یک قانون FallBack خاص را از مجموعه حذف می‌کند.
