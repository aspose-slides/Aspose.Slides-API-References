...
| سازنده | توضیح |
| --- | --- |
| [MathematicalText()](#MathematicalText--) | سازنده پیش‌فرض (create String.Empty Value) |
| [MathematicalText(char mathSymbol)](#MathematicalText-char-) | ایجاد MathText با یک نماد |
...
سازنده پیش‌فرض (create String.Empty Value)
