...
| متد | توضیح |
| --- | --- |
| [getScriptFontMap()](#getScriptFontMap--) | یک دیکشنری از تمام تعریف‌های قلم اسکریپت در ارائه را برمی‌گرداند. |
| [getScriptFont(String script)](#getScriptFont-java.lang.String-) | نام قلم مربوط به یک برچسب اسکریپت خاص را از تم ارائه دریافت می‌کند. |
| [setScriptFont(String script, String fontName)](#setScriptFont-java.lang.String-java.lang.String-) | یک نام قلم را به یک برچسب اسکریپت خاص اختصاص می‌دهد که تعیین می‌کند متن آن اسکریپت در ارائه چگونه رندر شود. |
| [removeScriptFont(String script)](#removeScriptFont-java.lang.String-) | تنظیم قلم مربوط به یک برچسب اسکریپت خاص را از مجموعه قلم‌های تم حذف می‌کند. |
...
| [getEastAsianFont()](#getEastAsianFont--) | قلم آسیای شرقی را برمی‌گرداند یا تنظیم می‌کند. |
| [setEastAsianFont(IFontData value)](#setEastAsianFont-com.aspose.slides.IFontData-) | قلم آسیای شرقی را برمی‌گرداند یا تنظیم می‌کند. |
...
نام قلم مربوط به یک برچسب اسکریپت خاص را از تم ارائه دریافت می‌کند.
...
یک نام قلم را به یک برچسب اسکریپت خاص اختصاص می‌دهد که تعیین می‌کند متن آن اسکریپت در ارائه چگونه رندر شود.
...
تنظیم قلم مربوط به یک برچسب اسکریپت خاص را از مجموعه قلم‌های تم حذف می‌کند.
...
قلم لاتین را برمی‌گرداند یا تنظیم می‌کند. خواند/نوشت [IFontData](../../com.aspose.slides/ifontdata).
...
قلم آسیای شرقی را برمی‌گرداند یا تنظیم می‌کند. خواند/نوشت [IFontData](../../com.aspose.slides/ifontdata).
...
قلم اسکریپت پیچیده را برمی‌گرداند یا تنظیم می‌کند. خواند/نوشت [IFontData](../../com.aspose.slides/ifontdata).
