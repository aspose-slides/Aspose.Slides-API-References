...
| متد | توضیح |
| --- | --- |
| [remove(IControl item)](#remove-com.aspose.slides.IControl-) | کنترل ActiveX را از مجموعه حذف می‌کند. |
...
| [get_Item(int index)](#get-Item-int-) | کنترلی را در موقعیت مشخص برمی‌گرداند. |
...
کنترل ActiveX را از مجموعه حذف می‌کند.
...
کنترلی را در موقعیت مشخص برمی‌گرداند.
...
**بازگشت:**
[IControl](../../com.aspose.slides/icontrol) - کنترل ایجادشده [IControl](../../com.aspose.slides/icontrol).