...
| [getInkEffectImages()](#getInkEffectImages--) | Haalt de collectie van aangepaste afbeeldingen op die worden gebruikt om visuele effecten voor inktkwasten te simuleren. |
### getTraces() {#getTraces--}
```
...
Deze eigenschap maakt het mogelijk om de standaard inkt-effecttexturen te vervangen door door de gebruiker gedefinieerde, wat vooral handig is wanneer standaardassets beperkt zijn door licenties of niet beschikbaar zijn tijdens uitvoering. Elke invoer in het woordenboek moet een [InkEffectType](../../com.aspose.slides/inkeffecttype)-waarde koppelen aan een overeenkomstig [IImage](../../com.aspose.slides/iimage)-object (bijv. Bitmap, of een Aspose-afbeeldingsinterface).
