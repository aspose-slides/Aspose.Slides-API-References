...
type: docs
url: /nl/com.aspose.slides/extracolorschemecollection/
---
**Erfenis:**
java.lang.Object
...
| [get_Item(int index)](#get-Item-int-) | Retourneert een kleurenschema op index. |
...
| [isSynchronized()](#isSynchronized--) | Retourneert een waarde die aangeeft of de toegang tot de ArrayList gesynchroniseerd is (thread-safe). |
...
Retourneert een kleurenschema op index. Alleen-lezen [ExtraColorScheme](../../com.aspose.slides/extracolorscheme).
