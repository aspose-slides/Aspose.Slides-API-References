...
description: Representeert een collectie van digitale handtekeningen die aan een document zijn gekoppeld.
type: docs
...
Stelt een collectie van digitale handtekeningen voor die aan een document zijn gekoppeld.
## Methoden
...
Retourneert de handtekening op basis van de index.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| index | int | Index van de te verwijderen handtekening. |
