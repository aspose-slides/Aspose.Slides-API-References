...
>      // Opmerking bij nieuwe digitale handtekening
...
| --- | --- |
| [getCertificate()](#getCertificate--) | Certificaatobject dat werd gebruikt om het document te ondertekenen. |
| [isValid()](#isValid--) | Als deze digitale handtekening geldig is en het document niet is gemanipuleerd, zal deze waarde waar zijn. |
| [getSignTime()](#getSignTime--) | Het moment waarop het document is ondertekend. |
...
| --- | --- | --- |
| certData | byte[] | een byte-array met het certificaat |
| password | java.lang.String | Wachtwoord dat nodig is om toegang te krijgen tot het certificaat. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| filePath | java.lang.String | Pad naar het bestand met het certificaat. |
| password | java.lang.String | Wachtwoord dat nodig is om toegang te krijgen tot het certificaat. |
...
Certificaatobject dat werd gebruikt om het document te ondertekenen. Alleen-lezen `byte[]`.
...
Als deze digitale handtekening geldig is en het document niet is gemanipuleerd, zal deze waarde waar zijn. Alleen-lezen boolean.
...
Het moment waarop het document is ondertekend. Alleen-lezen `java.util.Date`.
