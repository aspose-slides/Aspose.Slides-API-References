...
description: Stelt een collectie van kleurtransformatie-operaties voor.
type: docs
...
Stelt een collectie van kleurtransformatie-operaties voor.
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [size()](#size--) | Retourneert het aantal bewerkingen in een collectie. |
...
| [insert(int position, int operation, float parameter)](#insert-int-int-float-) | Voegt de nieuwe bewerking in in een collectie. |
| [insert(int position, int operation)](#insert-int-int-) | Voegt de nieuwe bewerking in in een collectie. |
| [removeAt(int index)](#removeAt-int-) | Verwijdert de kleurbewerking uit een collectie. |
...
Retourneert het aantal bewerkingen in een collectie. Alleen-lezen int.
...
Voegt de nieuwe bewerking in in een collectie.
...
Verwijdert de kleurbewerking uit een collectie.
