...
description: Stelt een groep methoden voor die bedoeld zijn om modelobjecten van verschillende types te verzamelen uit .
type: docs
...
| Method | Description |
| --- | --- |
| [shapes(Presentation pres)](#shapes-com.aspose.slides.Presentation-) | Verzamelt alle instanties van [Shape](../../com.aspose.slides/shape) in de [Presentation](../../com.aspose.slides/presentation). |
### Collect() {#Collect--}
```
public Collect()
```
...
Verzamelt alle instanties van [Shape](../../com.aspose.slides/shape) in de [Presentation](../../com.aspose.slides/presentation).
...
**Retourwaarde:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.slides.Shape> - Collectie van alle shapes die zich in de presentatie bevinden