...
Stelt het gegevenspuntniveau voor. Geldt voor Treemap- en Sunburst-diagram.
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [getFormat()](#getFormat--) | Stelt opmaak-eigenschappen van het gegevenspuntniveau voor. |
| [getLabel()](#getLabel--) | Stelt gegevenslabel van het gegevenspuntniveau voor. |
### getFormat() {#getFormat--}
```
...
Stelt gegevenslabel van het gegevenspuntniveau voor. Toegepast op Treemap- en Sunburst-reeks-typen. Alleen-lezen [IDataLabel](../../com.aspose.slides/idatalabel).
