...
description: Stelt een collectie van de verstelbare tekenrichtlijnen voor.
type: docs
...
Stelt een collectie van de verstelbare tekenrichtlijnen voor.
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Retourneert de tekenrichtlijn op index. |
| [add(byte orientation, float position)](#add-byte-float-) | Voegt de tekenrichtlijn toe aan het einde van de collectie. |
| [removeAt(int index)](#removeAt-int-) | Verwijdert de tekenrichtlijn op de opgegeven index. |
...
Retourneert de tekenrichtlijn op index. Alleen-lezen [IDrawingGuide](../../com.aspose.slides/idrawingguide).
...
Voegt de tekenrichtlijn toe aan het einde van de collectie.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| orientation | byte | Oriëntatie van de tekenrichtlijn. |
| position | float | Positie van de tekenrichtlijn in punten. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| index | int | Index van de tekenrichtlijn die moet worden verwijderd. |
...
**Retour:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IDrawingGuide> - Een java.util.Iterator voor de gehele collectie.
### getCount() {#getCount--}
```
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| array | [IDrawingGuide\[\]](../../com.aspose.slides/idrawingguide) | Doelarray. |
