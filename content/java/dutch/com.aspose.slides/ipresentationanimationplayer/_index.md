...
Animaties gegenereerd door [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) via zijn PresentationAnimationsGenerator.NewAnimation event.
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [getDuration()](#getDuration--) | Ophalen animatieduur [ms] |
...
| [getFrame()](#getFrame--) | Ophalen het frame voor de huidige tijdpositie die eerder is ingesteld met de \#setTimePosition(double).setTimePosition(double)-methode. |
