...
description: Representeert een collectie van gradient stops.
type: docs
...
| [add(float position, Color color)](#add-float-java.awt.Color-) | Maakt de nieuwe gradient stop aan en voegt deze toe aan het einde van de collectie. |
...
| [insert(int index, float position, Color color)](#insert-int-float-java.awt.Color-) | Maakt de nieuwe gradient stop aan en voegt deze in op de opgegeven index in de collectie. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| index | int | Index in de collectie waar de nieuwe gradient stop zal worden ingevoegd. |
| position | float | Positie van de nieuwe gradient stop. |
| color | java.awt.Color | Kleur van de nieuwe gradient stop. |
...
**Retour:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IGradientStop> - Een java.util.Iterator voor de volledige collectie.
