...
| [isFormatNotDefined()](#isFormatNotDefined--) | Retourneert true als de lijnindeling niet gedefinieerd is (net gemaakt, standaard). |
...
| [getJoinStyle()](#getJoinStyle--) | Retourneert of stelt de verbindingsstijl van lijnen in. |
| [setJoinStyle(byte value)](#setJoinStyle-byte-) | Retourneert of stelt de verbindingsstijl van lijnen in. |
| [getMiterLimit()](#getMiterLimit--) | Retourneert of stelt de versteklimiet van een lijn in. |
| [setMiterLimit(float value)](#setMiterLimit-float-) | Retourneert of stelt de versteklimiet van een lijn in. |
| [getBeginArrowheadStyle()](#getBeginArrowheadStyle--) | Retourneert of stelt de pijlkopstijl aan het begin van een lijn in. |
| [setBeginArrowheadStyle(byte value)](#setBeginArrowheadStyle-byte-) | Retourneert of stelt de pijlkopstijl aan het begin van een lijn in. |
| [getEndArrowheadStyle()](#getEndArrowheadStyle--) | Retourneert of stelt de pijlkopstijl aan het einde van een lijn in. |
| [setEndArrowheadStyle(byte value)](#setEndArrowheadStyle-byte-) | Retourneert of stelt de pijlkopstijl aan het einde van een lijn in. |
| [getBeginArrowheadWidth()](#getBeginArrowheadWidth--) | Retourneert of stelt de pijlkopbreedte aan het begin van een lijn in. |
| [setBeginArrowheadWidth(byte value)](#setBeginArrowheadWidth-byte-) | Retourneert of stelt de pijlkopbreedte aan het begin van een lijn in. |
| [getEndArrowheadWidth()](#getEndArrowheadWidth--) | Retourneert of stelt de pijlkopbreedte aan het einde van een lijn in. |
| [setEndArrowheadWidth(byte value)](#setEndArrowheadWidth-byte-) | Retourneert of stelt de pijlkopbreedte aan het einde van een lijn in. |
| [getBeginArrowheadLength()](#getBeginArrowheadLength--) | Retourneert of stelt de pijlkoplengte aan het begin van een lijn in. |
| [setBeginArrowheadLength(byte value)](#setBeginArrowheadLength-byte-) | Retourneert of stelt de pijlkoplengte aan het begin van een lijn in. |
| [getEndArrowheadLength()](#getEndArrowheadLength--) | Retourneert of stelt de pijlkoplengte aan het einde van een lijn in. |
| [setEndArrowheadLength(byte value)](#setEndArrowheadLength-byte-) | Retourneert of stelt de pijlkoplengte aan het einde van een lijn in. |
| [equals(ILineFormat lineFormat)](#equals-com.aspose.slides.ILineFormat-) | Bepaalt of de twee LineFormat-instanties gelijk zijn. |
| [getEffective()](#getEffective--) | Haalt effectieve lijnopmaakgegevens op met de toegepaste erfenis. |
...
Retourneert true als de lijnindeling niet gedefinieerd is (net gemaakt, standaard). Alleen-lezen  boolean .
...
Retourneert of stelt de streepjesstijl van de lijn in. Lezen/Schrijven [LineDashStyle](../../com.aspose.slides/linedashstyle).
...
Retourneert of stelt de verbindingsstijl van lijnen in. Lezen/Schrijven [LineJoinStyle](../../com.aspose.slides/linejoinstyle).
...
Retourneert of stelt de versteklimiet van een lijn in. Lezen/Schrijven  float .
...
Retourneert of stelt de pijlkopstijl aan het begin van een lijn in. Lezen/Schrijven [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
Retourneert of stelt de pijlkopstijl aan het einde van een lijn in. Lezen/Schrijven [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
Retourneert of stelt de pijlkopbreedte aan het begin van een lijn in. Lezen/Schrijven [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
Retourneert of stelt de pijlkopbreedte aan het einde van een lijn in. Lezen/Schrijven [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
Retourneert of stelt de pijlkoplengte aan het begin van een lijn in. Lezen/Schrijven [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
Retourneert of stelt de pijlkoplengte aan het einde van een lijn in. Lezen/Schrijven [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
Haalt effectieve lijnopmaakgegevens op met de toegepaste erfenis.

--------------------

> ```
> Dit voorbeeld toont het verkrijgen van de effectieve lijnopmaak-eigenschappen van een shape.
>  
