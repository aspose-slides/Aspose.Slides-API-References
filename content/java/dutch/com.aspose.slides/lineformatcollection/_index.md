...
type: docs
url: /nl/com.aspose.slides/lineformatcollection/
---
**Overerving:**
...
| [size()](#size--) | Haalt het aantal daadwerkelijk in de collectie aanwezige elementen op. |
...
Haalt het element op op de opgegeven index. Alleen-lezen [ILineFormat](../../com.aspose.slides/ilineformat).
...
**Retourneert:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ILineFormat> - Een IGenericEnumerator die kan worden gebruikt om door de collectie te itereren.
...
**Retourneert:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ILineFormat> - Een java.util.Iterator voor de volledige collectie.
### size() {#size--}
```
...
Haalt het aantal daadwerkelijk in de collectie aanwezige elementen op. Alleen-lezen int.
...
| index | int | Begin-index in de doel-array. |
