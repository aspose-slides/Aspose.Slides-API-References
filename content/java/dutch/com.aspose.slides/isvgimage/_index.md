...
| [getExternalResourceResolver()](#getExternalResourceResolver--) | Retourneert callback-interface die wordt gebruikt om externe bronnen op te lossen tijdens het importeren van SVG-documenten. |
| [getBaseUri()](#getBaseUri--) | Retourneert de basis-URI van de opgegeven SVG. |
...
Retourneert callback-interface die wordt gebruikt om externe bronnen op te lossen tijdens het importeren van SVG-documenten. Alleen-lezen [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver).
