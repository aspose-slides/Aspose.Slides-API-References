...
| --- | --- |
| [save(String filename)](#save-java.lang.String-) | Slaat de afbeelding op naar een bestand. |
...
Slaat de afbeelding op naar een bestand.
...
| --- | --- | --- |
| filename | java.lang.String | Het pad naar het bestand waarin de afbeelding wordt opgeslagen. |
| format | int | Het afbeeldingformaat. |
