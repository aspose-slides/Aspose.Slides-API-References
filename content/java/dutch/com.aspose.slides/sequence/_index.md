...
description: Stelt een reekscollectie van effecten voor.
type: docs
...
| [remove(IEffect item)](#remove-com.aspose.slides.IEffect-) | Verwijdert opgegeven effect uit een collectie. |
...
| [iteratorJava()](#iteratorJava--) | Retourneert een java-iterator voor de hele collectie. |
| [getTriggerShape()](#getTriggerShape--) | Retourneert of stelt vormdoel in voor INTERACTIVE reeks. |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | Retourneert of stelt vormdoel in voor INTERACTIVE reeks. |
...
| [addEffect(IShape shape, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IShape-int-int-int-) | Voeg een nieuw effect toe aan het einde van de reeks. |
| [addEffect(IParagraph paragraph, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IParagraph-int-int-int-) | Voeg een nieuw animatie-effect toe voor alinea aan het einde van de reeks. |
...
Verwijdert opgegeven effect uit een collectie.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| index | int | Index van een effect dat verwijderd moet worden. |
### clear() {#clear--}
```
...
**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffect> - Een IGenericEnumerator die kan worden gebruikt om door de collectie te itereren.
### iteratorJava() {#iteratorJava--}
```
public final System.Collections.Generic.IGenericEnumerator<IEffect> iteratorJava()
```

Retourneert een java-iterator voor de hele collectie.

**Returns:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffect> - Een java.util.Iterator voor de hele collectie.
### getTriggerShape() {#getTriggerShape--}
```
public final IShape getTriggerShape()
```

Retourneert of stelt vormdoel in voor INTERACTIVE reeks. Als de reeks niet interactief is, wordt null geretourneerd. Lezen/Schrijven [IShape](../../com.aspose.slides/ishape).
