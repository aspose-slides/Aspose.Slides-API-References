...
description: Vertegenwoordigt een werkmap die toegang biedt tot Excel-gegevens voor algemeen gebruik.
type: docs
...
Vertegenwoordigt een werkmap die toegang biedt tot Excel-gegevens voor algemeen gebruik.
## Methoden
...
| [getCell(String worksheetName, String cellName)](#getCell-java.lang.String-java.lang.String-) | Haalt een cel op uit het opgegeven werkblad met behulp van Excel-stijl celnaam (bijv. "B2"). |
| [getChartsFromWorksheet(String worksheetName)](#getChartsFromWorksheet-java.lang.String-) | Haalt een woordenboek op met de indexen en namen van alle grafieken in het opgegeven werkblad van een Excel-werkmap. |
| [getWorksheetNames()](#getWorksheetNames--) | Haalt de namen op van alle werkbladen die in de Excel-werkmap zijn opgenomen. |
...
| --- | --- | --- |
| formula | java.lang.String | Een formule of bereikexpressie (bijv. "Sheet1!A1:B3") die wordt gebruikt om de doelcellen te identificeren. |
...
Haalt een cel op uit het opgegeven werkblad met behulp van Excel-stijl celnaam (bijv. "B2").
...
Haalt een woordenboek op met de indexen en namen van alle grafieken in het opgegeven werkblad van een Excel-werkmap.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| worksheetName | java.lang.String | De naam van het werkblad waarin naar grafieken moet worden gezocht. |

**Retour:**
com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.Integer,java.lang.String> - Een woordenboek waarbij de sleutel de grafiek-index is en de waarde de grafieknaam.
### getWorksheetNames() {#getWorksheetNames--}
```
public abstract System.Collections.Generic.List<String> getWorksheetNames()
```

Haalt de namen op van alle werkbladen die in de Excel-werkmap zijn opgenomen.
