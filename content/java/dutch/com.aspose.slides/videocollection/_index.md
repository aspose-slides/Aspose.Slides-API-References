...
| [copyTo(System.Array array, int index)](#copyTo-com.aspose.ms.System.Array-int-) | Kopieert video's naar de opgegeven array, beginnend bij de opgegeven index. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| stream | java.io.InputStream | Stream van waaruit het videobestand moet worden toegevoegd. |
| loadingStreamBehavior | int | Het gedrag dat op de stream zal worden toegepast. |

**Retour:**
[IVideo](../../com.aspose.slides/ivideo) - Toegevoegde [IVideo](../../com.aspose.slides/ivideo).
...
Kopieert video's naar de opgegeven array, beginnend bij de opgegeven index.
