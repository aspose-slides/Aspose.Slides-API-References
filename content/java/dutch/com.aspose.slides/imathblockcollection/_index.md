...
| [insert(int index, IMathBlock item)](#insert-int-com.aspose.slides.IMathBlock-) | Voegt IMathBlock in de collectie in op de gespecificeerde index. |
| [remove(IMathBlock item)](#remove-com.aspose.slides.IMathBlock-) | Verwijdert het eerste voorkomen van een specifiek object uit de collectie. |
| [removeAt(int index)](#removeAt-int-) | Verwijdert een item op de gespecificeerde index van de collectie. |
| [contains(IMathBlock item)](#contains-com.aspose.slides.IMathBlock-) | Bepaalt of de collectie een specifieke waarde bevat. |
| [indexOf(IMathBlock item)](#indexOf-com.aspose.slides.IMathBlock-) | Bepaalt de index van een specifieke IMathBlock in de collectie. |
| [getCount()](#getCount--) | Retourneert het aantal elementen dat daadwerkelijk in de collectie aanwezig is. |
| [get_Item(int index)](#get-Item-int-) | Retourneert het item op de gespecificeerde index. |
| [set_Item(int index, IMathBlock value)](#set-Item-int-com.aspose.slides.IMathBlock-) | Retourneert het item op de gespecificeerde index. |
...
Voegt IMathBlock in de collectie in op de gespecificeerde index.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| index | int | De nul-gebaseerde index waarop een item moet worden ingevoegd. |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | De IMathBlock die moet worden ingevoegd. |
...
**Retour:**
boolean - true als item succesvol uit de collectie is verwijderd; anders false. Deze methode geeft ook false terug als het item niet in de oorspronkelijke collectie wordt gevonden.
### removeAt(int index) {#removeAt-int-}
```
public abstract void removeAt(int index)
```

Verwijdert een item op de gespecificeerde index van de collectie.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| index | int | De nul-gebaseerde index van het te verwijderen item. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | Het object dat gezocht moet worden in de collectie. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | Het item dat gezocht moet worden in de collectie. |
...
Retourneert het aantal elementen dat daadwerkelijk in de collectie aanwezig is. Alleen-lezen int.
...
Retourneert het item op de gespecificeerde index. Alleen-lezen [IMathBlock](../../com.aspose.slides/imathblock).
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| index | int | De nul-gebaseerde index van het item dat moet worden opgehaald. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| index | int | De nul-gebaseerde index van het item dat moet worden ingesteld. |
