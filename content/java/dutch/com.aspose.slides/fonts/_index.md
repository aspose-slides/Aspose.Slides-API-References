...
description: Lettertypeverzameling.
type: docs
...
| [setScriptFont(String script, String fontName)](#setScriptFont-java.lang.String-java.lang.String-) | Wijs een lettertype-naam toe aan een specifieke script-tag, die bepaalt hoe tekst van dat script in de presentatie wordt weergegeven. |
| [removeScriptFont(String script)](#removeScriptFont-java.lang.String-) | Verwijdert de lettertype-instelling die gekoppeld is aan een specifieke script-tag uit de lettertypeverzameling van het thema. |
...
| [getComplexScriptFont()](#getComplexScriptFont--) | Retourneert of stelt het complexe scriptlettertype in. |
| [setComplexScriptFont(IFontData value)](#setComplexScriptFont-com.aspose.slides.IFontData-) | Retourneert of stelt het complexe scriptlettertype in. |
...
**Retour:**
com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.String,java.lang.String> - Een woordenboek dat scriptcodes map naar lettertype-namen.
...
| --- | --- | --- |
| script | java.lang.String | De BCP-47 scriptcode (bijv. "Latn", "Cyrl", "Jpan") die een schrijfsysteem identificeert. |
...
Wijs een lettertype-naam toe aan een specifieke script-tag, die bepaalt hoe tekst van dat script in de presentatie wordt weergegeven.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| script | java.lang.String | De BCP-47 scriptcode (bijv. "Arab", "Hebr", "Hans") die het schrift identificeert. |
...
> ```
> Dit voorbeeld laat zien hoe je de lettertypekoppeling voor het Hebreeuwse script verwijdert:
>  
...
Retourneert of stelt het complexe scriptlettertype in. Lezen/Schrijven [IFontData](../../com.aspose.slides/ifontdata).
