...
| [addNodeByPosition(int position)](#addNodeByPosition-int-) | Voeg nieuw knooppunt toe op de geselecteerde positie van de knooppuntencollectie. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| nodeObj | [ISmartArtNode](../../com.aspose.slides/ismartartnode) | Knooppunt om te verwijderen. |
...
Voeg nieuw knooppunt toe op de geselecteerde positie van de knooppuntencollectie.
