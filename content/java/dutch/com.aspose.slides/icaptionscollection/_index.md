...
description: Stelt een verzameling van de ondertitels voor.
type: docs
...
Stelt een verzameling van de ondertitels voor.
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Retourneert de ondertitels op de opgegeven index. |
| [add(String label, String filePath)](#add-java.lang.String-java.lang.String-) | Voegt WebVTT-ondertitels toe aan het einde van de verzameling. |
| [add(String label, InputStream stream)](#add-java.lang.String-java.io.InputStream-) | Voegt WebVTT-ondertitels toe aan het einde van de verzameling vanuit een stream. |
| [remove(ICaptions captions)](#remove-com.aspose.slides.ICaptions-) | Verwijdert de opgegeven ondertitels uit de verzameling. |
| [removeAt(int index)](#removeAt-int-) | Verwijdert de ondertitels op de opgegeven index. |
| [clear()](#clear--) | Verwijdert alle ondertitels uit de verzameling. |
...
Voegt WebVTT-ondertitels toe aan het einde van de verzameling.
...
Voegt WebVTT-ondertitels toe aan het einde van de verzameling vanuit een stream.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| label | java.lang.String | Het label van de ondertitels. |
| stream | java.io.InputStream | De invoerstroom die gegevens in WebVTT-formaat bevat. |
...
Verwijdert de opgegeven ondertitels uit de verzameling.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| captions | [ICaptions](../../com.aspose.slides/icaptions) | De ondertitels om te verwijderen. |
...
Verwijdert alle ondertitels uit de verzameling.
