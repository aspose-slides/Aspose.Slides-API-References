...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| stream | java.io.InputStream | Stream om audio van toe te voegen. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| stream | java.io.InputStream | Stream om video-audio van toe te voegen. |
| loadingStreamBehavior | int | De [LoadingStreamBehavior](../../com.aspose.slides/loadingstreambehavior) die op de stream wordt toegepast. |
