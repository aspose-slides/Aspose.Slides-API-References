...
description: Specificeert een instantie van wiskundige tekst die zich binnen een MathParagraph bevindt en op een eigen regel begint.
type: docs
...
| [MathBlock(IMathElement mathElement)](#MathBlock-com.aspose.slides.IMathElement-) | Maakt een nieuw wiskundig blok en plaatst het opgegeven element erin |
| [MathBlock(System.Collections.Generic.IGenericEnumerable<IMathElement> mathElements)](#MathBlock-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.slides.IMathElement--) | Maakt een nieuw wiskundig blok en plaatst de opgegeven elementen erin |
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [getCount()](#getCount--) | Haalt het aantal onderliggende math-elementen op dat daadwerkelijk in de collectie zit. |
| [get_Item(int index)](#get-Item-int-) | Haalt of stelt IMathElement in op de opgegeven index. |
| [set_Item(int index, IMathElement value)](#set-Item-int-com.aspose.slides.IMathElement-) | Haalt of stelt IMathElement in op de opgegeven index. |
| [isReadOnly()](#isReadOnly--) | Retourneert false omdat de collectie van onderliggende elementen kan worden gewijzigd. |
...
| [join(IMathElement mathElement)](#join-com.aspose.slides.IMathElement-) | Voegt een wiskundig element samen met dit wiskundige blok |
| [join(String mathText)](#join-java.lang.String-) | Voegt een wiskundige tekst samen met dit wiskundige blok |
| [joinBlock(IMathBlock other)](#joinBlock-com.aspose.slides.IMathBlock-) | Voegt een ander wiskundig blok samen met dit blok |
| [delimit(char separatorCharacter)](#delimit-char-) | Scheidt onderliggende elementen met een scheidingsteken (zonder de haakjes) |
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | Omringt onderliggende elementen van dit blok met opgegeven tekens, zoals haakjes of andere tekens als omlijsting |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | Omringt onderliggende elementen van dit blok met opgegeven tekens, zoals haakjes of andere, als omlijsting en scheidt met een scheidingsteken |
| [toMathArray()](#toMathArray--) | Plaatst onderliggende elementen in een verticale array |
...
Haalt het aantal onderliggende math-elementen op dat daadwerkelijk in de collectie zit. Alleen-lezen int.
...
Haalt of stelt IMathElement in op de opgegeven index.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | Het object om in de collectie te vinden. |
...
**Retourneert:**
boolean - true als het item succesvol uit de collectie is verwijderd; anders false. Deze methode retourneert ook false als het item niet in de oorspronkelijke collectie wordt gevonden.
### iterator() {#iterator--}
```
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | Het element om in de collectie te vinden. |

**Retourneert:**
int - De index van het item als het in de collectie wordt gevonden; anders -1.
...
| item | [IMathElement](../../com.aspose.slides/imathelement) | Het MathElement dat moet worden ingevoegd. |
...
Voegt een wiskundig element samen met dit wiskundige blok
...
**Retourneert:**
[IMathBlock](../../com.aspose.slides/imathblock) - Het huidige exemplaar van IMathBlock
### join(String mathText) {#join-java.lang.String-}
```
public IMathBlock join(String mathText)
```

Voegt een wiskundige tekst samen met dit wiskundige blok
...
Omringt onderliggende elementen van dit blok met opgegeven tekens, zoals haakjes of andere tekens als omlijsting
...
Omringt onderliggende elementen van dit blok met opgegeven tekens, zoals haakjes of andere, als omlijsting en scheidt met een scheidingsteken
...
Plaatst onderliggende elementen in een verticale array
