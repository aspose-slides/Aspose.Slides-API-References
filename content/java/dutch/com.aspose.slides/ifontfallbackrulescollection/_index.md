...
description: Stelt een verzameling van FontFallBack-regels voor die door de gebruiker zijn gedefinieerd
type: docs
...
Stelt een verzameling van FontFallBack-regels voor, gedefinieerd door de gebruiker
## Methoden
...
| [remove(IFontFallBackRule targetRule)](#remove-com.aspose.slides.IFontFallBackRule-) | Verwijdert de eerste voorkomen van een specifieke FallBack-regel uit de collectie. |
...
Verwijdert de eerste voorkomen van een specifieke FallBack-regel uit de collectie.
