...
| [removeAt(int index)](#removeAt-int-) | Verwijdert het element op de gespecificeerde index van de collectie. |
| [getParent_Immediate()](#getParent-Immediate--) |  |
| [equals(Object obj)](#equals-java.lang.Object-) | Bepaalt of twee TabsEx-instanties gelijk zijn. |
| [iterator()](#iterator--) | Retourneert een enumerator die door de collectie iteratie. |
...
| [isSynchronized()](#isSynchronized--) | Retourneert een waarde die aangeeft of toegang tot de collectie gesynchroniseerd is (thread-safe). |
...
Haalt het element op op de gespecificeerde index. Alleen-lezen [Tab](../../com.aspose.slides/tab).
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| obj | java.lang.Object | De TabsEx die moet worden vergeleken met de huidige TabsEx. |

**Retour:**
boolean - **true** als de opgegeven TabsEx gelijk is aan de huidige TabsEx; anders, **false**.
### iterator() {#iterator--}
```
public final System.Collections.Generic.IGenericEnumerator<ITab> iterator()
```

Retourneert een enumerator die door de collectie iteratie.
