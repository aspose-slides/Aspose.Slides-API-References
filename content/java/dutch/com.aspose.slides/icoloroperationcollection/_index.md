...
| [add(int operation, float parameter)](#add-int-float-) | Voegt een nieuwe bewerking toe aan het einde van de verzameling. |
| [add(int operation)](#add-int-) | Voegt een nieuwe bewerking toe aan het einde van de verzameling. |
| [insert(int position, int operation, float parameter)](#insert-int-int-float-) | Voegt de nieuwe bewerking toe aan een verzameling. |
| [insert(int position, int operation)](#insert-int-int-) | Voegt de nieuwe bewerking toe aan een verzameling. |
...
Voegt een nieuwe bewerking toe aan het einde van de verzameling.
