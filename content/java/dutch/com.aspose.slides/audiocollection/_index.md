...
| [addAudio(InputStream stream)](#addAudio-java.io.InputStream-) | Maakt en voegt een audio toe aan een presentatie vanuit een stream. |
| [addAudio(InputStream stream, int loadingStreamBehavior)](#addAudio-java.io.InputStream-int-) | Maakt en voegt een audio toe aan een presentatie vanuit een stream. |
| [addAudio(byte[] audioData)](#addAudio-byte---) | Maakt en voegt een audio toe aan een presentatie vanuit een byte-array. |
