...
description: Deze klasse maakt export van video- en audiobestanden naar HTML mogelijk
type: docs
...
| --- | --- |
| [VideoPlayerHtmlController(String path, String fileName, String baseUri)](#VideoPlayerHtmlController-java.lang.String-java.lang.String-java.lang.String-) | Maakt een nieuw exemplaar van de controller |
## Methoden
...
Wordt aangeroepen vóór het renderen van de shape. Wordt één keer per shape aangeroepen. Als deze functie iets naar de generator schrijft, wordt de huidige slide-afbeeldingsgeneratie beëindigd, wordt het toegevoegde html-fragment ingevoegd en wordt een nieuwe afbeelding bovenop de vorige gestart.
...
Deze functie wordt aangeroepen vóór het renderen van de shape naar SVG om de gebruiker toe te staan het resulterende SVG te beïnvloeden.
...
Bepaalt waar het object moet worden opgeslagen. Deze methode wordt één keer per object-id aangeroepen. Het is niet gegarandeerd dat er niet twee objecten met dezelfde data, semanticName en contentType maar met een verschillend id bestaan.
