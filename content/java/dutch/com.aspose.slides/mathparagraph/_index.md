...
| --- | --- |
| [MathParagraph()](#MathParagraph--) | Initialiseert een nieuw exemplaar van de MathParagraph-klasse. |
| [MathParagraph(IMathBlock mathBlock)](#MathParagraph-com.aspose.slides.IMathBlock-) | Initialiseert een nieuw exemplaar van de MathParagraph-klasse. |
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [getJustification()](#getJustification--) | Alinea-uitlijning Standaardwaarde: CenteredAsGroup |
| [setJustification(int value)](#setJustification-int-) | Alinea-uitlijning Standaardwaarde: CenteredAsGroup |
...
| [remove(IMathBlock mathBlock)](#remove-com.aspose.slides.IMathBlock-) | Verwijdert de eerste voorkomen van een specifiek object uit de collectie. |
| [contains(IMathBlock mathBlock)](#contains-com.aspose.slides.IMathBlock-) | Bepaalt of de collectie een specifieke waarde bevat. |
| [indexOf(IMathBlock mathBlock)](#indexOf-com.aspose.slides.IMathBlock-) | Bepaalt de index van een specifieke IMMathBlock in de collectie. |
...
| [toLatex()](#toLatex--) | Haalt de wiskundige vergelijking op in LaTeX-indeling |
...
Alinea-uitlijning Standaardwaarde: CenteredAsGroup
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | Een wiskundig blok dat wordt toegevoegd aan het einde van de collectie |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | Het object dat uit de collectie moet worden verwijderd. |

**Retour:**
boolean - true als mathBlock succesvol uit de collectie is verwijderd; anders false. Deze methode geeft ook false terug als mathBlock niet in de oorspronkelijke collectie wordt gevonden.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | Het object dat in de collectie moet worden gezocht. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | Het item dat in de collectie moet worden gezocht. |

**Retour:**
int - De index van mathBlock als deze wordt gevonden in de collectie; anders -1.
...
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | De IMMathBlock die moet worden ingevoegd. |
