...
Vertegenwoordigt een collectie van [IChartCategory](../../com.aspose.slides/ichartcategory)
## Methoden
...
| [add(IChartDataCell chartDataCell)](#add-com.aspose.slides.IChartDataCell-) | Als de categorie bestaat in de collectie, wordt deze geretourneerd. |
...
| [indexOf(IChartCategory value)](#indexOf-com.aspose.slides.IChartCategory-) | Zoekt naar de opgegeven [IChartCategory](../../com.aspose.slides/ichartcategory) en retourneert de nulgebaseerde index van de eerste voorkomen binnen de volledige Collection. |
...
Retourneert het aantal gebruikte groeperingsniveaus voor categorieën. Is meer dan één voor meervoudige niveaucategorieën. Alleen-lezen int.
...
Als de categorie bestaat in de collectie, retourneer deze. Anders maakt het een nieuwe diagramcategorie aan van [IChartDataCell](../../com.aspose.slides/ichartdatacell) en voegt deze toe aan de collectie.

**Parameters:**
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| chartDataCell | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Cel die wordt gebruikt om een diagramcategorie te maken. |
...
Maakt een nieuw [IChartCategory](../../com.aspose.slides/ichartcategory) van de waarde en voegt deze toe aan de collectie.
...
Zoekt naar de opgegeven [IChartCategory](../../com.aspose.slides/ichartcategory) en retourneert de nulgebaseerde index van het eerste voorkomen binnen de volledige Collection.
...
**Retour:**
int - De nulgebaseerde index van het eerste voorkomen van waarde binnen de volledige CollectionBase, indien gevonden; anders -1.
