...
Basisklasse voor IMathElement met de implementatie van enkele methoden die gemeenschappelijk zijn voor alle afgeleide klassen. Alleen voor intern gebruik. Afgeleide klasse moet IMathElement zijn.
## Methoden
...
| [divide(IMathElement denominator)](#divide-com.aspose.slides.IMathElement-) | Maakt een breuk met deze teller en opgegeven noemer |
| [divide(String denominator)](#divide-java.lang.String-) | Maakt een breuk met deze teller en opgegeven noemer |
| [divide(IMathElement denominator, int fractionType)](#divide-com.aspose.slides.IMathElement-int-) | Maakt een breuk van het opgegeven type met deze teller en opgegeven noemer |
| [divide(String denominator, int fractionType)](#divide-java.lang.String-int-) | Maakt een breuk van het opgegeven type met deze teller en opgegeven noemer |
| [enclose()](#enclose--) | Omsluit een wiskundig element in haakjes |
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | Omsluit een wiskundig element in opgegeven tekens, zoals haakjes of andere tekens als omkadering |
| [function(IMathElement functionArgument)](#function-com.aspose.slides.IMathElement-) | Neemt een functie van een argument waarbij dit exemplaar als functienaam wordt gebruikt |
| [function(String functionArgument)](#function-java.lang.String-) | Neemt een functie van een argument waarbij dit exemplaar als functienaam wordt gebruikt |
| [asArgumentOfFunction(IMathElement functionName)](#asArgumentOfFunction-com.aspose.slides.IMathElement-) | Neemt een opgegeven functie waarbij dit exemplaar als argument wordt gebruikt |
| [asArgumentOfFunction(String functionName)](#asArgumentOfFunction-java.lang.String-) | Neemt een opgegeven functie waarbij dit exemplaar als argument wordt gebruikt |
| [asArgumentOfFunction(int functionType)](#asArgumentOfFunction-int-) | Neemt een opgegeven functie waarbij dit exemplaar als argument wordt gebruikt |
| [asArgumentOfFunction(int functionType, IMathElement additionalArgument)](#asArgumentOfFunction-int-com.aspose.slides.IMathElement-) | Neemt een opgegeven functie waarbij dit exemplaar als argument wordt gebruikt en een extra argument |
| [asArgumentOfFunction(int functionType, String additionalArgument)](#asArgumentOfFunction-int-java.lang.String-) | Neemt een opgegeven functie waarbij dit exemplaar als argument wordt gebruikt en een extra argument |
| [setSubscript(IMathElement subscript)](#setSubscript-com.aspose.slides.IMathElement-) | Maakt subscripttes |
| [setSubscript(String subscript)](#setSubscript-java.lang.String-) | Maakt subscripttes |
| [setSuperscript(IMathElement superscript)](#setSuperscript-com.aspose.slides.IMathElement-) | Maakt superscripttes |
| [setSuperscript(String superscript)](#setSuperscript-java.lang.String-) | Maakt superscripttes |
| [setSubSuperscriptOnTheRight(IMathElement subscript, IMathElement superscript)](#setSubSuperscriptOnTheRight-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-) | Maakt subscripttes en superscripttes aan de rechterkant |
| [setSubSuperscriptOnTheRight(String subscript, String superscript)](#setSubSuperscriptOnTheRight-java.lang.String-java.lang.String-) | Maakt subscripttes en superscripttes aan de rechterkant |
| [setSubSuperscriptOnTheLeft(IMathElement subscript, IMathElement superscript)](#setSubSuperscriptOnTheLeft-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-) | Maakt subscripttes en superscripttes aan de linkerkant |
| [setSubSuperscriptOnTheLeft(String subscript, String superscript)](#setSubSuperscriptOnTheLeft-java.lang.String-java.lang.String-) | Maakt subscripttes en superscripttes aan de linkerkant |
...
| [integral(int integralType)](#integral-int-) | Neemt de integraal zonder limieten |
...
| [accent(char accentCharacter)](#accent-char-) | Zet een accentteken (een teken bovenop dit element) |
| [overbar()](#overbar--) | Zet een balk bovenop dit element |
| [underbar()](#underbar--) | Zet een balk onder dit element |
| [group()](#group--) | Plaatst dit element in een groep met een accolade onderaan |
| [group(char character, int position, int verticalJustification)](#group-char-int-int-) | Plaatst dit element in een groep met een groeppunt, zoals een accolade onderaan of een ander teken |
...
| --- | --- | --- |
| mathElement | [IMathElement](../../com.aspose.slides/imathelement) | Het element dat moet worden toegevoegd |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| mathText | java.lang.String | Wiskundige tekst die moet worden toegevoegd |
...
Maakt een breuk met deze teller en opgegeven noemer
...
Maakt een breuk van het opgegeven type met deze teller en opgegeven noemer
...
Omsluit een wiskundig element in haakjes
...
Omsluit een wiskundig element in opgegeven tekens, zoals haakjes of andere tekens als omkadering
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| beginningCharacter | char | Beginteken (gewoonlijk linker haak) |
| endingCharacter | char | Eindteken (gewoonlijk rechter haak) |

**Retour:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - Het wiskundige element van type [IMathDelimiter](../../com.aspose.slides/imathdelimiter) dat de opgegeven tekens als omkadering bevat
...
Neemt een opgegeven functie waarbij dit exemplaar als argument wordt gebruikt
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| functionType | int | Eén van de algemene functietypen met één argument |
...
Neemt een opgegeven functie waarbij dit exemplaar als argument wordt gebruikt en een extra argument
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| functionType | int | Eén van de algemene functietypen met twee argumenten: Log, Lim, Min, Max |
| additionalArgument | [IMathElement](../../com.aspose.slides/imathelement) | Extra argument afhankelijk van het functietype |
...
| --- | --- | --- |
| functionType | int | Eén van de algemene functietypen met twee argumenten: Log, Lim, Min, Max |
| additionalArgument | java.lang.String | Extra argument afhankelijk van het functietype |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| superscript | [IMathElement](../../com.aspose.slides/imathelement) | Superscript (bov-index aan de rechterkant) |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| superscript | java.lang.String | Superscript (bov-index aan de rechterkant) |
...
Maakt subscripttes en superscripttes aan de rechterkant
...
| --- | --- | --- |
| subscript | java.lang.String | Subscript (onderindex aan de rechterkant) |
| superscript | java.lang.String | Superscript (bovenindex aan de rechterkant) |
...
Maakt onderindex en bovenindex aan de linkerkant
...
| superscript | [IMathElement](../../com.aspose.slides/imathelement) | Superscript (bovenindex aan de linkerkant) |
...
| superscript | java.lang.String | Superscript (bovenindex aan de linkerkant) |
...
Specificeert de wiskundige wortel van de opgegeven graad van het opgegeven argument.
...
| Parameter | Type | Description |
| --- | --- | --- |
| type | int | Het type van de N-ary operator |
...
| Parameter | Type | Description |
| --- | --- | --- |
| integralType | int | Type van integraal |
...
| limitLocations | int | Locatie van grenzen |
...
Plaatst dit element in een groep met behulp van een groepeerkarakter zoals een onderste accolade of een ander
...
| verticalJustification | int | Verticale uitlijning van het groepeerkarakter. Bepaalt de uitlijning van het object ten opzichte van de basislijn. Bijvoorbeeld, wanneer het groepeerkarakter boven het object staat, betekent VerticalJustification Top dat de bovenkant van het object op de basislijn ligt; wanneer VerticalJustification Bottom is, ligt de onderkant van het object op de basislijn |
...
Plaatst dit element in een randvak
...
**Retour:**
[IMathBorderBox](../../com.aspose.slides/imathborderbox) - Randvak met dit element erin geplaatst
...
| strikethroughHorizontal | boolean | Horizontale doorhaling van randvak |
| strikethroughVertical | boolean | Verticale doorhaling van randvak |
| strikethroughBottomLeftToTopRight | boolean | Doorhaling van linksonder naar rechtsboven |
| strikethroughTopLeftToBottomRight | boolean | Doorhaling van linksboven naar rechtsonder |
...
Plaatst dit element in een niet-visuele box (logische groepering) die wordt gebruikt om componenten van een vergelijking of andere wiskundige tekst te groeperen. Een gedefinieerd object kan (bijvoorbeeld) dienen als een operator-emulator met of zonder uitlijningspunt, dienen als een regeleinde, of gegroepeerd worden zodat er geen regeleinden binnen worden toegestaan.
