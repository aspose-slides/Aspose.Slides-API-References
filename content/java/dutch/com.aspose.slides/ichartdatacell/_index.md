...
Haalt het ingebouwde weergaveformaat van getallen en datums op of stelt dit in. Het preset-nummer moet in [0..22] of [37..49] vallen. Lezen/schrijven byte.
...
| Parameter | Type | Description |
| --- | --- | --- |
| updateValues | boolean | Als false, wordt er geen echte berekening uitgevoerd. Gebruik true voor een mogelijke uitzondering controle. |