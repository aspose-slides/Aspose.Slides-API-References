...
type: docs
url: /nl/com.aspose.slides/effect/
---
**Erfenis:**
java.lang.Object
...
Vertegenwoordigt animatie-effect.
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [getSequence()](#getSequence--) | Retourneert een reeks voor een effect. |
| [getTextAnimation()](#getTextAnimation--) | TextAnimation Alleen-lezen [ITextAnimation](../../com.aspose.slides/itextanimation). |
...
| [getSound()](#getSound--) | Definieert ingesloten geluid voor effect. |
| [setSound(IAudio value)](#setSound-com.aspose.slides.IAudio-) | Definieert ingesloten geluid voor effect. |
...
| [getAfterAnimationType()](#getAfterAnimationType--) | Definieert een type voor na-animatie voor effect. |
| [setAfterAnimationType(int value)](#setAfterAnimationType-int-) | Definieert een type voor na-animatie voor effect. |
| [getAfterAnimationColor()](#getAfterAnimationColor--) | Definieert een kleur voor na-animatie voor effect. |
| [setAfterAnimationColor(IColorFormat value)](#setAfterAnimationColor-com.aspose.slides.IColorFormat-) | Definieert een kleur voor na-animatie voor effect. |
| [getAnimateTextType()](#getAnimateTextType--) | Definieert een type voor geanimeerde tekst voor effect. |
| [setAnimateTextType(int value)](#setAnimateTextType-int-) | Definieert een type voor geanimeerde tekst voor effect. |
...
TextAnimation Alleen-lezen [ITextAnimation](../../com.aspose.slides/itextanimation).
...
Definieert ingesloten geluid voor effect. Lezen/schrijven [IAudio](../../com.aspose.slides/iaudio).
...
>      {
>          // Wijzig het geluid van het tweede effect naar "Stop Previous Sound"
...
Definieert een type voor na-animatie voor effect. Lezen/schrijven [AfterAnimationType](../../com.aspose.slides/afteranimationtype)(\#getAfterAnimationType.getAfterAnimationType/\#setAfterAnimationType(int).setAfterAnimationType(int)).
...
Definieert een kleur voor na-animatie voor effect. Lezen/schrijven [IColorFormat](../../com.aspose.slides/icolorformat).
...
Definieert een type voor geanimeerde tekst voor effect. De vormtekst kan worden geanimeerd per letter, per woord of in één keer. Lezen/schrijven AnimateTextType (\#getAnimateTextType.getAnimateTextType/\#setAnimateTextType(int).setAnimateTextType(int)).
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Wijzig het effect Animate text type naar "By letter"
