...
Om de waarde van deze eigenschap te wijzigen (voor alle categorieën in de collectie), stel de nieuwe waarde in op de eigenschap [ChartCategoryCollection.getUseCells()](../../com.aspose.slides/chartcategorycollection\#getUseCells--).
...
Beheerde container van de waarden van de groeperingsniveaus van diagramcategorieën. Een meerlagige categorie bevat meer dan één groeperingsniveau. Indexering van groeperingsniveaus is nulgebaseerd. Alleen-lezen [IChartCategoryLevelsManager](../../com.aspose.slides/ichartcategorylevelsmanager).
...
Verwijdert de categorie uit het diagram.