...
Haalt het ingebouwde weergaveformaat van getallen en datums op of stelt dit in. Het ingestelde nummer moet in [0..22] of [37..49] liggen. Lezen/schrijven byte.
...
| Parameter | Type | Description |
| --- | --- | --- |
| updateValues | boolean | Als false, wordt er geen berekening uitgevoerd. Gebruik true om mogelijke uitzonderingen te controleren. |