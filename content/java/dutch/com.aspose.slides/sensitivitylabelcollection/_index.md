...
| [copyTo(ISensitivityLabel[] array, int index)](#copyTo-com.aspose.slides.ISensitivityLabel---int-) | Kopieert alle elementen uit de collectie naar de opgegeven array. |
...
| siteId | java.util.UUID | De Azure Active Directory (Azure AD) site-identifier. |
...
**Retourneert:**
int - De index waarop de SensitivityLabel werd toegevoegd.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| array | [ISensitivityLabel\[\]](../../com.aspose.slides/isensitivitylabel) | Doelarray. |
| index | int | Startindex in het doelarray. |