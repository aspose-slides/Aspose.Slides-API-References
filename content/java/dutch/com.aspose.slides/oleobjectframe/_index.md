...
>      // Cast de shape naar OleObjectFrame
>      OleObjectFrame oleObjectFrame = (OleObjectFrame) sld.getShapes().get_Item(0);
>      // Leest het OLE-object en schrijft het naar schijf
>      if (oleObjectFrame != null) {
>          // Haalt ingebedde bestandsgegevens op
>          byte[] data = oleObjectFrame.getEmbeddedData().getEmbeddedFileData();
>          // Haalt ingebedde bestandsextensie op
...
| [getSubstitutePictureTitle()](#getSubstitutePictureTitle--) | Retourneert of stelt de titel in voor OleObject icon. |
| [setSubstitutePictureTitle(String value)](#setSubstitutePictureTitle-java.lang.String-) | Retourneert of stelt de titel in voor OleObject icon. |
...
| [getLinkPathRelative()](#getLinkPathRelative--) | Retourneert het relatieve pad naar een gekoppeld bestand indien aanwezig, anders retourneert het een lege string. |
...
| [getEmbeddedData()](#getEmbeddedData--) | Haalt of stelt informatie over OLE embedded data in. |
...
Retourneert of stelt de titel in voor OleObject icon. Lezen/Schrijven String.
...
Retourneert het relatieve pad naar een gekoppeld bestand indien aanwezig, anders retourneert het een lege string. Alleen-lezen String.
...
Haalt of stelt informatie over OLE embedded data in. Lezen/Schrijven [IOleEmbeddedDataInfo](../../com.aspose.slides/ioleembeddeddatainfo).
...
Deze methode wijzigt de eigenschappen van het object om de nieuwe gegevens weer te geven en zet de IsObjectLink-vlag op false, wat aangeeft dat het OLE-object is ingebed. |
