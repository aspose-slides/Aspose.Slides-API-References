...
| [getSummarySection(ISection section)](#getSummarySection-com.aspose.slides.ISection-) | Retourneert het Summary Zoom Section element voor de gegeven sectie. |
| [removeSummaryZoomSection(ISection section)](#removeSummaryZoomSection-com.aspose.slides.ISection-) | Verwijdert het Summary Zoom Section object uit de collectie. |
...
> ```
> Dit voorbeeld toont hoe een Summary Zoom Section element op te halen via index:
>  
...
Als een element voor deze sectie al bestaat in de collectie, wordt het bestaande element geretourneerd.
...
Retourneert het Summary Zoom Section element voor de gegeven sectie.
...
Verwijdert het Summary Zoom Section object uit de collectie.
