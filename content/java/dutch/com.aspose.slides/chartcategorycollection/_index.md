...
Vertegenwoordigt een verzameling van [ChartCategory](../../com.aspose.slides/chartcategory)
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Haalt het element op op de opgegeven index. |
| [getUseCells()](#getUseCells--) | Als true, dan wordt het werkblad gebruikt voor het opslaan van categorieën (dit geval ondersteunt meerlagige categorieën). |
| [setUseCells(boolean value)](#setUseCells-boolean-) | Als true, dan wordt het werkblad gebruikt voor het opslaan van categorieën (dit geval ondersteunt meerlagige categorieën). |
...
| [add(Object value)](#add-java.lang.Object-) | Maakt een nieuw [ChartCategory](../../com.aspose.slides/chartcategory) van de waarde en voegt deze toe aan de collectie. |
| [indexOf(IChartCategory value)](#indexOf-com.aspose.slides.IChartCategory-) | Zoekt naar de gespecificeerde [ChartCategory](../../com.aspose.slides/chartcategory) en retourneert de nulgebaseerde index van de eerste voorkoming binnen de gehele collectie. |
| [remove(IChartCategory value)](#remove-com.aspose.slides.IChartCategory-) | Verwijdert de opgegeven waarde. |
| [removeAt(int index)](#removeAt-int-) | Verwijdert het element op de gegeven index. |
...
Retourneert het aantal gebruikte groeperingsniveaus voor categorieën. Is meer dan één voor meerniveaucategorieën. Alleen-lezen int.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| chartDataCell | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Cel gebruikt om een grafiekcategorie te maken. |
...
Maakt een nieuw [ChartCategory](../../com.aspose.slides/chartcategory) van de waarde en voegt deze toe aan de collectie.
...
Zoekt naar de gespecificeerde [ChartCategory](../../com.aspose.slides/chartcategory) en retourneert de nulgebaseerde index van de eerste voorkoming binnen de volledige collectie.
...
**Retourneert:**
int - De nulgebaseerde index van de eerste voorkoming van de waarde binnen de volledige CollectionBase, indien gevonden; anders -1.
