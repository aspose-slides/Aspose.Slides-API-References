...
Deze interface wordt samen met de [ILineFormat](../../com.aspose.slides/ilineformat) interface gebruikt om effectieve opmaakwaarden met overerving toe te passen.
## Methoden
...
| [getDashStyle()](#getDashStyle--) | Retourneert de streepjesstijl van de lijn. |
| [getCustomDashPattern()](#getCustomDashPattern--) | Retourneert het aangepaste streepjespatroon. |
| [getCapStyle()](#getCapStyle--) | Retourneert de eindstijl van de lijn. |
...
| [getMiterLimit()](#getMiterLimit--) | Retourneert de snijpuntlimiet van een lijn. |
...
Retourneert het opvulformaat van een lijn. Alleen-lezen [ILineFillFormatEffectiveData](../../com.aspose.slides/ilinefillformateffectivedata).
...
Retourneert de streepjesstijl van de lijn. Alleen-lezen [LineDashStyle](../../com.aspose.slides/linedashstyle).
...
Retourneert de eindstijl van de lijn. Alleen-lezen [LineCapStyle](../../com.aspose.slides/linecapstyle).
...
Retourneert de snijpuntlimiet van een lijn. Alleen-lezen float.
