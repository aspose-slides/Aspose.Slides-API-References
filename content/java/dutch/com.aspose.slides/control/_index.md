...
Vertegenwoordigt een ActiveX-besturingselement.
## Methoden
...
| [getSubstitutePictureFormat()](#getSubstitutePictureFormat--) | Retourneert het object met eigenschappen voor het invullen van de afbeelding van het besturingselement. |
...
>  else
>  {
>      YourMethodHere(control.getActiveXControlBinary()); //Gebruik uw eigen methode voor het beheren van ActiveX-eigenschappen die zijn opgeslagen in het binaire bestand
>  }
> ```
...
Retourneert het object met eigenschappen voor het invullen van de afbeelding van het besturingselement. Alleen-lezen [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
>  else
>  {
>      YourMethodHere(control.getActiveXControlBinary()); //Gebruik uw eigen methode voor het beheren van ActiveX-eigenschappen die in het binaire bestand zijn opgeslagen
>  }
> ```
