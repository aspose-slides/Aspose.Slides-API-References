...
Representeert een collectie van effecten die op een afbeelding worden toegepast.
## Methoden

| Methode | Beschrijving |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Retourneert een [IImageTransformOperation](../../com.aspose.slides/iimagetransformoperation) uit de collectie op basis van de index. |
...
Retourneert een [IImageTransformOperation](../../com.aspose.slides/iimagetransformoperation) uit de collectie op basis van de index.
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| threshold | float | De luminantiedrempel voor het Bi-Level effect. Waarden die groter dan of gelijk aan de drempel zijn worden wit. Waarden die lager zijn dan de drempel worden zwart. |
...
| grow | boolean | Geeft aan of de grenzen van het object moeten worden vergroot als gevolg van de vervaging. Waar betekent dat de grenzen worden vergroot, onwaar betekent dat ze niet worden vergroot. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| brightness | float | Het percentage waarmee de helderheid wordt veranderd. |
| contrast | float | Het percentage waarmee het contrast wordt veranderd. |
...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| hue | float | De tint waartoe wordt getint. |
| amount | float | Geeft aan met hoeveel de kleurwaarde wordt verschoven. |
