...
| --- | --- |
| [size()](#size--) | Retourneert het aantal aanpassingen. |
| [get_Item(int index)](#get-Item-int-) | Retourneert een aanpassing op index. |
...
| [iterator()](#iterator--) | Retourneert een enumerator voor de volledige collectie. |
### size() {#size--}
```
public final int size()
```

Retourneert het aantal aanpassingen. Alleen-lezen int.
...
Retourneert een aanpassing op index.
