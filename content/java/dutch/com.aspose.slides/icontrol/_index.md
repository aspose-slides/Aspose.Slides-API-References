...
| --- | --- |
| [getName()](#getName--) | Retourneert de naam van dit besturingselement. |
| [setName(String value)](#setName-java.lang.String-) | Retourneert de naam van dit besturingselement. |
| [getClassId()](#getClassId--) | Haalt de class id van dit besturingselement op. |
...
| [getActiveXControlBinary()](#getActiveXControlBinary--) | Specificeert de persistentie van een ActiveX-besturingselement wanneer de gebruikte persisteringsmethode PersistStream, PersistStreamInit of PersistStorage is. |
### getName() {#getName--}
```
...
Haalt de class id van dit besturingselement op. Alleen-lezen java.util.UUID.
...
Specificeert de persistentie van een ActiveX-besturingselement wanneer de gebruikte persisteringsmethode PersistStream, PersistStreamInit of PersistStorage is.
