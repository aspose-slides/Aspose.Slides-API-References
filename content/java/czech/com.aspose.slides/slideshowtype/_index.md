...
Základní nastavení prezentace. Předci představují typy prezentace: [PresentedBySpeaker](../../com.aspose.slides/presentedbyspeaker) Prezentováno řečníkem (celá obrazovka) [BrowsedByIndividual](../../com.aspose.slides/browsedbyindividual) Prohlíženo jednotlivcem (okno) [BrowsedAtKiosk](../../com.aspose.slides/browsedatkiosk) Prohlíženo na kiosku (celá obrazovka)
