...
>  try {
>      // Nastavování vlastností zobrazení prezentace
>      pres.getViewProperties().getSlideViewProperties().setScale(100); // Hodnota přiblížení v procentech pro zobrazení snímku
>      pres.getViewProperties().getNotesViewProperties().setScale(100); // Hodnota přiblížení v procentech pro zobrazení poznámek
...
| [getVariableScale()](#getVariableScale--) | Určuje, že obsah zobrazení by měl být automaticky měněn tak, aby co nejlépe vyplnil aktuální velikost okna. |
| [setVariableScale(boolean value)](#setVariableScale-boolean-) | Určuje, že obsah zobrazení by měl být automaticky měněn tak, aby co nejlépe vyplnil aktuální velikost okna. |
...
Určuje poměr měřítka zobrazení v procentech. Číst/Zapisovat int.
...
Určuje, že obsah zobrazení by měl být automaticky měněn tak, aby co nejlépe vyplnil aktuální velikost okna. Číst/Zapisovat boolean.
...
>      // Přidání nového vodorovného kreslicího vodítka pod středem snímku
