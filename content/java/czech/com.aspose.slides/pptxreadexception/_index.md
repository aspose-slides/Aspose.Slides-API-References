...
type: docs
url: /cs/com.aspose.slides/pptxreadexception/
---
**Dědičnost:**
...
| Konstruktor | Popis |
| --- | --- |
| [PptxReadException()](#PptxReadException--) | Výchozí konstruktor. |
| [PptxReadException(String message)](#PptxReadException-java.lang.String-) | Konstruktor umožňující přidat zprávu k této výjimce. |
| [PptxReadException(String message, RuntimeException exception)](#PptxReadException-java.lang.String-java.lang.RuntimeException-) | Konstruktor pro výjimku obsahující zprávu a vloženou výjimku. |
