...
| Metoda | Popis |
| --- | --- |
| [getShowHiddenSlides()](#getShowHiddenSlides--) | Určuje, zda by vygenerovaný dokument měl zahrnovat skryté snímky, nebo ne. |
| [setShowHiddenSlides(boolean value)](#setShowHiddenSlides-boolean-) | Určuje, zda by vygenerovaný dokument měl zahrnovat skryté snímky, nebo ne. |
| [getSaveMetafilesAsPng()](#getSaveMetafilesAsPng--) | True k převodu všech metafilek používaných v prezentaci na obrázky PNG. |
| [setSaveMetafilesAsPng(boolean value)](#setSaveMetafilesAsPng-boolean-) | True k převodu všech metafilek používaných v prezentaci na obrázky PNG. |
...
Určuje, zda by vygenerovaný dokument měl zahrnovat skryté snímky, nebo ne. Výchozí je false.
...
True k převodu všech metafilek používaných v prezentaci na obrázky PNG. Čtení/zápis boolean.
