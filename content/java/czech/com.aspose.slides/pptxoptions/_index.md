...
| [getCompressionLevel()](#getCompressionLevel--) | Určuje úroveň komprese používanou při ukládání dokumentu Presentation. |
| [setCompressionLevel(int value)](#setCompressionLevel-int-) | Určuje úroveň komprese používanou při ukládání dokumentu Presentation. |
...
Když je hodnota možnosti **true**, bude nová miniatura vygenerována.
...
Určuje úroveň komprese používanou při ukládání dokumentu Presentation. Výchozí hodnota je [CompressionLevel.Level6](../../com.aspose.slides/compressionlevel\#Level6).
