...
| [getViewerIncluded()](#getViewerIncluded--) | Určuje, zda má vygenerovaný SWF dokument zahrnovat integrovaný prohlížeč dokumentu, nebo ne. |
| [setViewerIncluded(boolean value)](#setViewerIncluded-boolean-) | Určuje, zda má vygenerovaný SWF dokument zahrnovat integrovaný prohlížeč dokumentu, nebo ne. |
| [getShowPageBorder()](#getShowPageBorder--) | Určuje, zda má být zobrazena ohraničení okolo stránek. |
| [setShowPageBorder(boolean value)](#setShowPageBorder-boolean-) | Určuje, zda má být zobrazena ohraničení okolo stránek. |
...
| [getLogoLink()](#getLogoLink--) | Získá nebo nastaví úplnou adresu hypertextového odkazu pro logo. |
| [setLogoLink(String value)](#setLogoLink-java.lang.String-) | Získá nebo nastaví úplnou adresu hypertextového odkazu pro logo. |
...
Určuje, zda má být zobrazena ohraničení okolo stránek. Výchozí hodnota je true.
...
Zobrazit/skrýt krokovač stránek. Lze přepsat pomocí flashvars. Výchozí hodnota je true.
...
Zobrazit/skrýt sekci hledání. Lze přepsat pomocí flashvars. Výchozí hodnota je true.
...
Zobrazit/skrýt celý horní panel. Lze přepsat pomocí flashvars. Výchozí hodnota je true.
...
Zobrazit/skrýt spodní panel. Lze přepsat pomocí flashvars. Výchozí hodnota je true.
...
Zobrazit/skrýt levý panel. Lze přepsat pomocí flashvars. Výchozí hodnota je true.
...
Spustit s otevřeným levým panelem. Lze přepsat pomocí flashvars. Výchozí hodnota je false.
...
Obrázek, který bude zobrazen jako logo v pravém horním rohu prohlížeče. Obrázek by měl být PNG o rozměrech 32 × 64 pixelů, jinak může být logo zobrazeno nesprávně.
...
Získá nebo nastaví úplnou adresu hypertextového odkazu pro logo. Má efekt jen pokud je specifikován (\#getLogoImageBytes.getLogoImageBytes/\#setLogoImageBytes(byte[]).setLogoImageBytes(byte[])).
...
Získá nebo nastaví režim, ve kterém jsou snímky umístěny na stránce při exportu prezentace [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions). Tato vlastnost nepodporuje přiřazení objektů typu [HandoutLayoutingOptions](../../com.aspose.slides/handoutlayoutingoptions)
