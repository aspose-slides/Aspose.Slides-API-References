...
| [getCropLeft()](#getCropLeft--) | Vrací nebo nastavuje počet procent skutečné šířky obrázku, která je oříznuta na levé straně obrázku. |
| [setCropLeft(float value)](#setCropLeft-float-) | Vrací nebo nastavuje počet procent skutečné šířky obrázku, která je oříznuta na levé straně obrázku. |
| [getCropTop()](#getCropTop--) | Vrací nebo nastavuje počet procent skutečné výšky obrázku, která je oříznuta na horní straně obrázku. |
| [setCropTop(float value)](#setCropTop-float-) | Vrací nebo nastavuje počet procent skutečné výšky obrázku, která je oříznuta na horní straně obrázku. |
| [getCropRight()](#getCropRight--) | Vrací nebo nastavuje počet procent skutečné šířky obrázku, která je oříznuta na pravé straně obrázku. |
| [setCropRight(float value)](#setCropRight-float-) | Vrací nebo nastavuje počet procent skutečné šířky obrázku, která je oříznuta na pravé straně obrázku. |
| [getCropBottom()](#getCropBottom--) | Vrací nebo nastavuje počet procent skutečné výšky obrázku, která je oříznuta na spodní straně obrázku. |
| [setCropBottom(float value)](#setCropBottom-float-) | Vrací nebo nastavuje počet procent skutečné výšky obrázku, která je oříznuta na spodní straně obrázku. |
...
| [getTileOffsetX()](#getTileOffsetX--) | Vrací nebo nastavuje horizontální posun textury od počátku tvaru v bodech. |
| [setTileOffsetX(float value)](#setTileOffsetX-float-) | Vrací nebo nastavuje horizontální posun textury od počátku tvaru v bodech. |
| [getTileOffsetY()](#getTileOffsetY--) | Vrací nebo nastavuje vertikální posun textury od počátku tvaru v bodech. |
| [setTileOffsetY(float value)](#setTileOffsetY-float-) | Vrací nebo nastavuje vertikální posun textury od počátku tvaru v bodech. |
| [getTileScaleX()](#getTileScaleX--) | Vrací nebo nastavuje horizontální měřítko výplně textury v procentech. |
| [setTileScaleX(float value)](#setTileScaleX-float-) | Vrací nebo nastavuje horizontální měřítko výplně textury v procentech. |
| [getTileScaleY()](#getTileScaleY--) | Vrací nebo nastavuje vertikální měřítko výplně textury v procentech. |
| [setTileScaleY(float value)](#setTileScaleY-float-) | Vrací nebo nastavuje vertikální měřítko výplně textury v procentech. |
...
| [getTileFlip()](#getTileFlip--) | Převrací texturovou dlaždici kolem její horizontální, vertikální nebo obou os. |
| [setTileFlip(int value)](#setTileFlip-int-) | Převrací texturovou dlaždici kolem její horizontální, vertikální nebo obou os. |
...
Vrací nebo nastavuje počet procent skutečné šířky obrázku, která je oříznuta na levé straně obrázku. Čtení/zápis float.
...
Vrací nebo nastavuje počet procent skutečné výšky obrázku, která je oříznuta na horní straně obrázku. Čtení/zápis float.
...
Vrací nebo nastavuje počet procent skutečné šířky obrázku, která je oříznuta na pravé straně obrázku. Čtení/zápis float.
...
Vrací nebo nastavuje počet procent skutečné výšky obrázku, která je oříznuta na spodní straně obrázku. Čtení/zápis float.
...
**Vrací:**
[IPPImage](../../com.aspose.slides/ippimage) - Oříznutý obrázek nebo původní obrázek, pokud není oříznutí nutné.

--------------------

Tato metoda převádí WMF/EMF metafily na rastrový PNG obrázek při ořezávání.
