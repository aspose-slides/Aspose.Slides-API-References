...
description: Representuje kolekci bodů pro dělicí bod v grafu typu bar-of-pie nebo pie-of-pie s vlastním dělením.
type: docs
...
Representuje kolekci bodů pro dělicí bod v grafu typu bar-of-pie nebo pie-of-pie s vlastním dělením.
...
| [copyToTArray(IChartDataPoint[] array, int arrayIndex)](#copyToTArray-com.aspose.slides.IChartDataPoint---int-) | Zkopíruje prvky [IGenericCollection](../../com.aspose.slides/igenericcollection) do pole, počínaje konkrétním indexem pole. |
| [size()](#size--) | Vrací nebo nastavuje počet datových bodů grafu. |
| [isReadOnly()](#isReadOnly--) | Získá hodnotu indikující, zda je [IGenericCollection](../../com.aspose.slides/igenericcollection) jen pro čtení. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| item | [IChartDataPoint](../../com.aspose.slides/ichartdatapoint) | Objekt, který se má najít v [IGenericCollection](../../com.aspose.slides/igenericcollection). |
...
| arrayIndex | int | Nulový index v poli, od kterého kopírování začíná. |
...
Získá hodnotu indikující, zda je [IGenericCollection](../../com.aspose.slides/igenericcollection) jen pro čtení. Pouze pro čtení boolean.
