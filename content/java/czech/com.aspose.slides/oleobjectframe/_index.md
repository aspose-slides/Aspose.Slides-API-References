...
| [getSubstitutePictureTitle()](#getSubstitutePictureTitle--) | Vrací nebo nastavuje název pro ikonu OleObject. |
| [setSubstitutePictureTitle(String value)](#setSubstitutePictureTitle-java.lang.String-) | Vrací nebo nastavuje název pro ikonu OleObject. |
...
Vrací objekt vlastností výplně obrázku OleObject. Jen pro čtení [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
Vrací ProgID objektu. Jen pro čtení String.
...
Vrací úplnou cestu k propojenému souboru. Použije se krátký název souboru. Jen pro čtení String.
...
Vrací relativní cestu k propojenému souboru, pokud existuje, jinak vrací prázdný řetězec. Jen pro čtení String.
...
Tato metoda změní vlastnosti objektu tak, aby odrážely nová data, a nastaví příznak IsObjectLink na false, což značí, že OLE objekt je vložen. |
...
Určuje, zda je objekt propojen s externím souborem. Jen pro čtení boolean .
