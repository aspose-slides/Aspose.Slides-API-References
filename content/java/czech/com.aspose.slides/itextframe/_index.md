...
| Metoda | Popis |
| --- | --- |
| [getParagraphs()](#getParagraphs--) | Vrací seznam všech odstavců v rámu. |
...
| [getHyperlinkQueries()](#getHyperlinkQueries--) | Umožňuje snadný přístup k obsaženým hypertextovým odkazům. |
...
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | Spojuje běhy se stejným formátováním ve všech odstavcích. |
...
| [splitTextByColumns()](#splitTextByColumns--) | Rozděluje textový obsah [ITextFrame](../../com.aspose.slides/itextframe) do pole řetězců, kde každý prvek odpovídá samostatnému textovému sloupci v rámu. |
| [highlightText(String text, Color highlightColor, ITextHighlightingOptions options)](#highlightText-java.lang.String-java.awt.Color-com.aspose.slides.ITextHighlightingOptions-) | Zvýrazní všechny shody vzorového textu zadanou barvou. |
...
| [highlightRegex(String regex, Color highlightColor, ITextHighlightingOptions options)](#highlightRegex-java.lang.String-java.awt.Color-com.aspose.slides.ITextHighlightingOptions-) | Zvýrazní všechny shody regulárního výrazu zadanou barvou. |
...
Vrací seznam všech odstavců v rámu. Pouze pro čtení [IParagraphCollection](../../com.aspose.slides/iparagraphcollection).
...
Umožňuje snadný přístup k obsaženým hypertextovým odkazům. Pouze pro čtení [IHyperlinkQueries](../../com.aspose.slides/ihyperlinkqueries).
...
Spojuje běhy se stejným formátováním ve všech odstavcích.
...
Rozděluje textový obsah [ITextFrame](../../com.aspose.slides/itextframe) do pole řetězců, kde každý prvek odpovídá samostatnému textovému sloupci v rámci.
...
Pokud TextFrame neobsahuje více sloupců, vrácené pole bude mít jediný prvek obsahující celý text. Prázdné sloupce budou v poli reprezentovány prázdnými řetězci.
...
| callback | [IFindResultCallback](../../com.aspose.slides/ifindresultcallback) | Objekt zpětného volání pro příjem výsledků vyhledávání [IFindResultCallback](../../com.aspose.slides/ifindresultcallback). |
...
>      // zvýraznění všech slov dlouhých 5 a více znaků
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| regex | java.util.regex.Pattern | Regulární výraz java.util.regex.Pattern, jehož řetězce se mají zvýraznit. |
| highlightColor | java.awt.Color | Barva pro zvýraznění textu. |
| callback | [IFindResultCallback](../../com.aspose.slides/ifindresultcallback) | Objekt zpětného volání pro příjem výsledků vyhledávání [IFindResultCallback](../../com.aspose.slides/ifindresultcallback). |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| regex | java.lang.String | Text regulárního výrazu, který se má zvýraznit. |
| highlightColor | java.awt.Color | Barva pro zvýraznění textu. |
| options | [ITextHighlightingOptions](../../com.aspose.slides/itexthighlightingoptions) | Možnosti zvýraznění. |
...
>      TextSearchOptions textSearchOptions = new TextSearchOptions();
>      textSearchOptions.setWholeWordsOnly(true);
>      // Nahrazuje všechny samostatné výskyty 'the' řetězcem '***'
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| oldText | java.lang.String | Řetězec, který se má nahradit. |
...
>  try {
>      Pattern regex = Pattern.compile("\\b[^\\s]{5,}\\b");
>      // Nahrazuje všechna slova dlouhá 5 a více znaků řetězcem '***'
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| regex | java.util.regex.Pattern | Regulární výraz java.util.regex.Pattern, jehož řetězce se mají nahradit. |
| newText | java.lang.String | Řetězec, kterým se nahradí všechny výskyty nahrazovaných řetězců. |
| callback | [IFindResultCallback](../../com.aspose.slides/ifindresultcallback) | Objekt zpětného volání pro příjem výsledků vyhledávání [IFindResultCallback](../../com.aspose.slides/ifindresultcallback).