...
| [getChartData()](#getChartData--) | Vrací informace o propojených nebo vložených datech spojených s diagramem. |
| [hasTitle()](#hasTitle--) | Určuje, zda má diagram viditelný nadpis. |
| [setTitle(boolean value)](#setTitle-boolean-) | Určuje, zda má diagram viditelný nadpis. |
| [getChartTitle()](#getChartTitle--) | Vrací nebo nastavuje nadpis diagramu Pouze pro čtení [IChartTitle](../../com.aspose.slides/icharttitle). |
...
| [getPlotArea()](#getPlotArea--) | Zastupuje oblast vykreslení diagramu. |
...
| [getUserShapes()](#getUserShapes--) | Určuje tvary nakreslené nad diagramem. |
...
| [getShowDataLabelsOverMaximum()](#getShowDataLabelsOverMaximum--) | Specifikuje, že se mají zobrazit popisky dat nad maximem diagramu. |
| [setShowDataLabelsOverMaximum(boolean value)](#setShowDataLabelsOverMaximum-boolean-) | Specifikuje, že se mají zobrazit popisky dat nad maximem diagramu. |
| [hasRoundedCorners()](#hasRoundedCorners--) | Specifikuje, že oblast diagramu má mít zaoblené rohy. |
| [setRoundedCorners(boolean value)](#setRoundedCorners-boolean-) | Specifikuje, že oblast diagramu má mít zaoblené rohy. |
### getPlotVisibleCellsOnly() {#getPlotVisibleCellsOnly--}
```
public abstract boolean getPlotVisibleCellsOnly()
```

Určuje, zda jsou vykreslovány pouze viditelné buňky. False k vykreslení jak viditelných, tak skrytých buněk. Čtení/Zápis boolean.
...
Vrací informace o propojených nebo vložených datech spojených s diagramem. Pouze pro čtení [IChartData](../../com.aspose.slides/ichartdata).
...
Určuje, zda má diagram viditelný nadpis. Čtení/Zápis boolean.
...
Vrací nebo nastavuje nadpis diagramu Pouze pro čtení [IChartTitle](../../com.aspose.slides/icharttitle).
...
Zastupuje oblast vykreslení diagramu. Pouze pro čtení [IChartPlotArea](../../com.aspose.slides/ichartplotarea).
...
Určuje tvary nakreslené nad diagramem. Pouze pro čtení [IGroupShape](../../com.aspose.slides/igroupshape).
...
Specifikuje, že se mají zobrazit popisky dat nad maximem diagramu. Čtení/Zápis boolean.
...
Specifikuje, že oblast diagramu má mít zaoblené rohy. Čtení/Zápis boolean.
