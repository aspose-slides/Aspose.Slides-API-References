...
description: Representuje přechodový formát prezentace pro uložení do webového formátu.
type: docs
...
Representuje přechodový formát prezentace pro uložení do webového formátu.
## Konstruktory
...
> 
>   // nastavte vlastnost "slideMargin" pro použití ze šablon
>   document.getGlobal().put("slideMargin", 10);
> 
>   // ... nastavte další možnosti dokumentu a poté dokument uložíte
>   document.save();
> ```
