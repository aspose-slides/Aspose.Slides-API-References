...
Představuje možnosti exportu do HTML.
...
| [HtmlOptions()](#HtmlOptions--) | Vytvoří nový objekt HtmlOptions pro uložení do jedného souboru HTML. |
...
| [getShowHiddenSlides()](#getShowHiddenSlides--) | Určuje, zda vygenerovaný dokument má obsahovat skryté snímky, či nikoli. |
| [setShowHiddenSlides(boolean value)](#setShowHiddenSlides-boolean-) | Určuje, zda vygenerovaný dokument má obsahovat skryté snímky, či nikoli. |
...
| [getJpegQuality()](#getJpegQuality--) | Vrací nebo nastaví hodnotu určující kvalitu JPEG obrázků v PDF dokumentu. |
| [setJpegQuality(byte value)](#setJpegQuality-byte-) | Vrací nebo nastaví hodnotu určující kvalitu JPEG obrázků v PDF dokumentu. |
...
| [getDeletePicturesCroppedAreas()](#getDeletePicturesCroppedAreas--) | Booleanový příznak označuje, zda oříznuté části zůstávají součástí dokumentu. |
| [setDeletePicturesCroppedAreas(boolean value)](#setDeletePicturesCroppedAreas-boolean-) | Booleanový příznak označuje, zda oříznuté části zůstávají součástí dokumentu. |
| [getSvgResponsiveLayout()](#getSvgResponsiveLayout--) | True pro vyloučení atributů šířka a výška ze SVG kontejneru – to způsobí responzivní rozvržení. |
| [setSvgResponsiveLayout(boolean value)](#setSvgResponsiveLayout-boolean-) | True pro vyloučení atributů šířka a výška ze SVG kontejneru – to způsobí responzivní rozvržení. |
...
Vytvoří nový objekt HtmlOptions pro uložení do jedného souboru HTML.
...
Určuje, zda vygenerovaný dokument má obsahovat skryté snímky, či nikoli. Výchozí hodnota je false.
...
Získá nebo nastaví hodnotu určující, zda je text vykreslován bez použití ligatur. Pokud je nastaveno na true, ligatury budou ve výstupu zakázány. Ve výchozím nastavení je tato vlastnost nastavena na false.
...
Vrací nebo nastaví hodnotu určující kvalitu JPEG obrázků v PDF dokumentu. Čtení/Zápis byte.

Má efekt pouze pokud dokument obsahuje JPEG obrázky.

Použijte tuto vlastnost pro získání nebo nastavení kvality obrázků v dokumentu při ukládání ve formátu PDF. Hodnota může být od 0 do 100, kde 0 znamená nejhorší kvalitu, ale maximální kompresi, a 100 znamená nejlepší kvalitu, ale minimální kompresi.
...
Booleanový příznak označuje, zda oříznuté části zůstávají součástí dokumentu. Pokud je true, oříznuté části budou odstraněny, pokud je false, budou v dokumentu serializovány (což může vést k většímu souboru).
...
True pro vyloučení atributů šířka a výška ze SVG kontejneru – to způsobí responzivní rozvržení. False – v opačném případě. Čtení/Zápis boolean.
