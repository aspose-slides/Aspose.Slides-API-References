...
description: Představuje skupinu metod určených k shromažďování modelových objektů různých typů z .
type: docs
...
Reprezentuje skupinu metod určených k shromažďování modelových objektů různých typů z [Presentation](../../com.aspose.slides/presentation).
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| pres | [Presentation](../../com.aspose.slides/presentation) | Prezentace pro shromažďování tvarů |
