...
| Metoda | Popis |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Získá pravidlo na uvedeném indexu. |
| [add(IFontFallBackRule sourceRule)](#add-com.aspose.slides.IFontFallBackRule-) | Přidá nové pravidlo FallBack na konec kolekce. |
| [remove(IFontFallBackRule targetRule)](#remove-com.aspose.slides.IFontFallBackRule-) | Odebere první výskyt konkrétního pravidla FallBack z kolekce. |
### get_Item(int index) {#get-Item-int-}
```
public abstract IFontFallBackRule get_Item(int index)
```

Získá pravidlo na uvedeném indexu. Jen pro čtení [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule).
...
>      //Načtení objektu prvního pravidla v kolekci
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| sourceRule | [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule) | Určené pravidlo pro přidání |
...
Odebere první výskyt konkrétního pravidla FallBack z kolekce.
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| targetRule | [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule) | Pravidlo, které se má odebrat z kolekce. |