...
description: Poskytuje funkci pro import obsahu z Excel sešitu do prezentace.
type: docs
...
Poskytuje funkci pro import obsahu z Excel sešitu do prezentace.
## Metody
...
Načte graf ze specifikovaného Excel sešitu a přidá jej na konec uvedené kolekce tvarů na zadaných souřadnicích.
...
| chartIndex | int | Nulový index (od nuly) tvaru grafu, který má být vložen. Tento index lze získat pomocí metody [IExcelDataWorkbook.getChartsFromWorksheet(String)](../../com.aspose.slides/iexceldataworkbook\#getChartsFromWorksheet-String-). |
| embedAllWorkbook | boolean | Pokud je true, celý sešit bude vložen do grafu; pokud je false, bude vložena pouze data grafu. |
...
| x | float | Souřadnice X pro umístění grafu. |
| y | float | Souřadnice Y pro umístění grafu. |
| workbookStream | java.io.InputStream | Proud obsahující data sešitu. |
| worksheetName | java.lang.String | Název listu, který obsahuje graf. |
| chartName | java.lang.String | Název grafu, který má být přidán. |
| embedAllWorkbook | boolean | Pokud je true, celý sešit bude vložen do grafu; pokud je false, bude vložena pouze data grafu. |
...
| x | float | Souřadnice X pro umístění grafu. |
| y | float | Souřadnice Y pro umístění grafu. |
| workbookPath | java.lang.String | Cesta k souboru sešitu obsahujícímu graf. |
| worksheetName | java.lang.String | Název listu, který obsahuje graf. |
| chartName | java.lang.String | Název grafu, který má být přidán. |
...
Načte tabulku ze specifikovaného Excel sešitu a přidá ji na konec uvedené kolekce tvarů na zadaných souřadnicích.
...
**Návratová hodnota:**
[ITable](../../com.aspose.slides/itable) - Tabulka, která byla přadded to the shape collection.