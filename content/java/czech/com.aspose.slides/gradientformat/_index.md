...
type: docs
url: /cs/com.aspose.slides/gradientformat/
---
**Inheritance:**
...
| [getTileFlip()](#getTileFlip--) | Vrací nebo nastavuje režim otáčení pro gradient. |
| [setTileFlip(int value)](#setTileFlip-int-) | Vrací nebo nastavuje režim otáčení pro gradient. |
...
Vrací kolekci zastávek gradientu. Pouze pro čtení [IGradientStopCollection](../../com.aspose.slides/igradientstopcollection).
