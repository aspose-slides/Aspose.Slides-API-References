...
description: Reprezentuje režim rozložení prezentace jako podklady pro export.
type: docs
...
Reprezentuje režim rozložení prezentace jako podklady pro export.
## Konstruktory
...
| [getPrintSlideNumbers()](#getPrintSlideNumbers--) | Určuje, zda se mají tisknout zobrazovaná čísla snímků. |
| [setPrintSlideNumbers(boolean value)](#setPrintSlideNumbers-boolean-) | Určuje, či se mají tisknout zobrazovaná čísla snímků. |
| [getPrintFrameSlide()](#getPrintFrameSlide--) | Určuje, zda se mají kolem zobrazovaných snímků kreslit rámečky. |
| [setPrintFrameSlide(boolean value)](#setPrintFrameSlide-boolean-) | Určuje, či se mají kolem zobrazovaných snímků kreslit rámečky. |
| [getPrintComments()](#getPrintComments--) | Určuje, zda se mají zobrazovat komentáře na snímcích |
| [setPrintComments(boolean value)](#setPrintComments-boolean-) | Určuje, či se mají zobrazovat komentáře na snímcích |
...
Určuje, zda se mají tisknout zobrazovaná čísla snímků.
