...
Reprezentuje efekt Fill Overlay. Fill overlay může být použit k určení další výplně pro objekt a smíchání dvou výplní dohromady.
## Metody
...
| [getFillFormat()](#getFillFormat--) | Formát výplně. |
### getBlend() {#getBlend--}
```
...
Formát výplně. Pouze pro čtení [IFillFormat](../../com.aspose.slides/ifillformat).
