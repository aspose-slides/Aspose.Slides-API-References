...
| Parametr | Typ | Popis |
| --- | --- | --- |
| sourceSlide | [ISlide](../../com.aspose.slides/islide) | Snímek, který se má klonovat. |
...
| allowCloneMissingLayout | boolean | Pokud neexistuje vhodné rozvržení v zadaném masteru, bude rozvržení zdrojového snímku klonováno (pokud je allowCloneMissingLayout true) nebo bude vyvolána výjimka PptxEditException (pokud je allowCloneMissingLayout false). |
...
| slide | [ISlide](../../com.aspose.slides/islide) | Snímek, který se má přesunout. |
...
Přesune snímky z kolekce na zadanou pozici. Snímek budou umístěny začínajíce od indexu v pořadí, v jakém se objeví v seznamu.

**Parametry:**
| Parametr | Typ | Popis |
| --- | --- | --- |
| index | int | Cílový index. |
| slides | [ISlide\[\]](../../com.aspose.slides/islide) | Snímek, který se má přesunout. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| slide | [ISlide](../../com.aspose.slides/islide) | Snímek, který se má najít. |
...
Vytvoří snímky z PDF dokumentu a přidá je na konec kolekce s přihlédnutím k možnostem importu PDF.
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| pdfStream | java.io.InputStream | Datový proud, který bude použit jako zdroj PDF dokumentu |
| pdfImportOptions | [PdfImportOptions](../../com.aspose.slides/pdfimportoptions) | Možnosti pro import PDF |
...
| resolver | [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver) | Objekt zpětného volání používaný k načtení externích objektů. Pokud je tento parametr null, všechny externí objekty budou ignorovány. |
| uri | java.lang.String | URI specifikovaného HTML. Používá se k vyřešení relativních odkazů. |
...
| index | int | Pozice pro vložení. |
| htmlText | java.lang.String | HTML k přidání. |
| useSlideWithIndexAsStart | boolean | Tato vlajka určuje, jak začít vkládání: od nového snímku nebo od snímku se zadaným indexem. Pokud je **true**, začne vkládání dat z prázdného prostoru na snímku se zadaným indexem. Pokud je **false**, data budou přidána k vytvořeným snímkům. |
