...
| Pole | Popis |
| --- | --- |
| [Tint](#Tint) | Zabarvuje barvu. |
| [Shade](#Shade) | Stínuje barvu. |
| [Complement](#Complement) | Mění barvu na RGB komplementární. |
| [Inverse](#Inverse) | Mění barvu na invertovanou barvu. |
| [Grayscale](#Grayscale) | Mění barvu na šedou se stejnou světlostí. |
...
| [SetHue](#SetHue) | Mění komponentu odstínu barvy na hodnotu parametru. |
| [AddHue](#AddHue) | Přidá hodnotu parametru ke komponentě odstínu barvy. |
| [MultiplyHue](#MultiplyHue) | Vynásobí komponentu odstínu hodnotou parametru. |
| [SetSaturation](#SetSaturation) | Mění komponentu nasycení barvy na hodnotu parametru. |
| [AddSaturation](#AddSaturation) | Přidá hodnotu parametru ke komponentě nasycení barvy. |
| [MultiplySaturation](#MultiplySaturation) | Vynásobí komponentu nasycení hodnotou parametru. |
| [SetLuminance](#SetLuminance) | Mění komponentu jasnosti barvy na hodnotu parametru. |
| [AddLuminance](#AddLuminance) | Přidá hodnotu parametru ke komponentě jasnosti barvy. |
| [MultiplyLuminance](#MultiplyLuminance) | Vynásobí komponentu jasnosti hodnotou parametru. |
| [SetRed](#SetRed) | Mění červenou komponentu barvy na hodnotu parametru. |
...
| [SetGreen](#SetGreen) | Mění zelenou komponentu barvy na hodnotu parametru. |
...
| [SetBlue](#SetBlue) | Mění modrou komponentu barvy na hodnotu parametru. |
...
Zabarvuje barvu. Parametr je v rozsahu mezi 0 (originální barva) a 1 (bílá).
...
Stínuje barvu. Parametr je v rozsahu mezi 0 (originální barva) a 1 (černá).
...
Mění barvu na RGB komplementární. m = Max(r, g, b); r = m - r; g = m - g; b = m - b;
...
Mění barvu na invertovanou barvu. r = 1 - r; g = 1 - g; b = 1 - b;
...
Mění barvu na šedou se stejnou světlostí. Parametr je ignorován.
...
Definuje alfa komponentu barvy. Parametr je v rozsahu mezi 0 (průhledná) a 1 (neprůhledná).
...
Mění komponentu odstínu barvy na hodnotu parametru. Parametr je v rozsahu mezi 0 a 360.
...
Přidá hodnotu parametru ke komponentě odstínu barvy. Parametr je v rozsahu mezi -360 a 360.
...
Mění komponentu nasycení barvy na hodnotu parametru. Parametr je v rozsahu mezi 0 a 1.
...
Přidá hodnotu parametru ke komponentě nasycení barvy. Parametr je v rozsahu mezi -1 a 1.
...
Vynásobí komponentu nasycení hodnotou parametru.
...
Mění komponentu jasnosti barvy na hodnotu parametru. Parametr je v rozsahu mezi 0 a 1.
...
Přidá hodnotu parametru ke komponentě jasnosti barvy. Parametr je v rozsahu mezi -1 a 1.
...
Vynásobí komponentu jasnosti hodnotou parametru.
...
Mění červenou komponentu barvy na hodnotu parametru. Parametr je v rozsahu mezi 0 a 1.
...
Mění zelenou komponentu barvy na hodnotu parametru. Parametr je v rozsahu mezi 0 a 1.
...
Mění modrou komponentu barvy na hodnotu parametru. Parametr je v rozsahu mezi 0 a 360.
