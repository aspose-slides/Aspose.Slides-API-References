...
| [getColSpan()](#getColSpan--) | Vrací počet sloupců v mřížce nadřazené tabulky, které má aktuální buňka přesahovat. |
| [getRowSpan()](#getRowSpan--) | Vrací počet řádků, které sloučená buňka přesahuje. |
| [getTextFrame()](#getTextFrame--) | Vrací textový rám buňky. |
| [getTable()](#getTable--) | Vrací objekt nadřazené Tabulky pro buňku. |
| [isMergedCell()](#isMergedCell--) | Vrací true, pokud je buňka sloučena s jakoukoli připojenou buňkou, jinak false. |
...
Vrací vzdálenost z horní strany tabulky k horní straně buňky. Pouze pro čtení double.
...
Vrací index prvního řádku, který buňka pokrývá. Pouze pro čtení int.
...
Vrací minimální výšku buňky. Jedná se o součet minimálních výšek všech řádků, které buňka pokrývá. Pouze pro čtení double.
...
Získá první řádek buňky. Pouze pro čtení [IRow](../../com.aspose.slides/irow).
...
Vrací počet sloupců v mřížce nadřazené tabulky, které má aktuální buňka přesahovat. Tento atribut umožňuje buňkám vypadat jako sloučené, protože přesahují vertikální hranice ostatních buněk v tabulce. Pouze pro čtení int.
...
Vrací počet řádků, které sloučená buňka přesahuje. Používá se ve spojení s atributem vMerge u ostatních buněk za účelem určení počáteční buňky horizontálního sloučení. Pouze pro čtení int.
...
Vrací textový rám buňky. Pouze pro čtení [ITextFrame](../../com.aspose.slides/itextframe).
...
Vrací true, pokud je buňka sloučena s jakoukoli připojenou buňkou, jinak false. Pouze pro čtení boolean.
