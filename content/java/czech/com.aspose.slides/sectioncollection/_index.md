...
description: Representuje kolekci sekcí.
type: docs
...
| [addSection(String name, ISlide startedFromSlide)](#addSection-java.lang.String-com.aspose.slides.ISlide-) | Přidá sekci snímků, která začíná od konkrétního snímku. |
...
| [removeSectionWithSlides(ISection section)](#removeSectionWithSlides-com.aspose.slides.ISection-) | Odstraní sekci a snímky v ní obsažené. |
...
| [copyTo(System.Array array, int index)](#copyTo-com.aspose.ms.System.Array-int-) | Zkopíruje celou kolekci do určeného pole. |
| [isSynchronized()](#isSynchronized--) | Vrátí hodnotu udávající, zda je přístup ke kolekci synchronizován (vláknově bezpečný). |
...
Získá prvek na zadaném indexu. Pouze ke čtení [ISection](../../com.aspose.slides/isection).
...
Přidá sekci snímků, která začíná od konkrétního snímku.
...
Odstraní sekci a snímky v ní obsažené.

**Parametry:**
| Parametr | Typ | Popis |
| --- | --- | --- |
| section | [ISection](../../com.aspose.slides/isection) | Sekce k odstranění z kolekce. |
### removeSection(ISection section) {#removeSection-com.aspose.slides.ISection-}
```
public final void removeSection(ISection section)
```

Odstraní sekci. Snímky v sekci budou sloučeny do předchozí sekce.
...
Vrátí hodnotu udávající, zda je přístup ke kolekci synchronizován (vláknově bezpečný). Pouze ke čtení boolean.
...
**Návratová hodnota:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISection> - IGenericEnumerator, který lze použít k iteraci přes kolekci.
...
**Návratová hodnota:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISection> - java.util.Iterator pro celou kolekci.