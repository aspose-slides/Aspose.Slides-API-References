...
Určuje seskupovací symbol nad nebo pod výrazem, obvykle pro zvýraznění vztahu mezi prvky
...
| [getCharacter()](#getCharacter--) | Seskupovací znak Výchozí hodnota: U+23DF (BOTTOM CURLY BRACKET) |
| [setCharacter(char value)](#setCharacter-char-) | Seskupovací znak Výchozí hodnota: U+23DF (BOTTOM CURLY BRACKET) |
...
Seskupovací znak Výchozí hodnota: U+23DF (BOTTOM CURLY BRACKET)
...
Vertikální zarovnání znaku skupiny. Určuje zarovnání objektu vzhledem k osnově. Například když je znak skupiny nad objektem, VerticalJustification of Top označuje, že horní část objektu leží na osnově; když je VerticalJustification nastaveno na Bottom, spodní část objektu leží na osnově. Výchozí: Bottom pro Position=Top a Top pro Position=Bottom
