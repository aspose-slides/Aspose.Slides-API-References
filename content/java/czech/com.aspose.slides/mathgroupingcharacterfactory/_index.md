...
| --- | --- | --- |
| element | [IMathElement](../../com.aspose.slides/imathelement) | matematický prvek, na který se použije seskupovací znak |
| character | char | seskupovací znak |
| position | int | pozice seskupovacího znaku |
| verticalJustification | int | vertikální zarovnání |

**Návratová hodnota:**
[IMathGroupingCharacter](../../com.aspose.slides/imathgroupingcharacter) - nový prvek seskupovacího znaku
