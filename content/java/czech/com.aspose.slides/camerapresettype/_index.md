...
description: Konstanty, které definují typ přednastavení kamery.
type: docs
url: /cs/com.aspose.slides/camerapresettype/
---
**Dědičnost:**
...
Konstanty, které definují typ přednastavení kamery.
## Pole
...
### IsometricOffAxis4Right {#IsometricOffAxis4Right}
```
public static final int IsometricOffCubeleteRight
```
