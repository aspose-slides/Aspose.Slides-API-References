...
| Metoda | Popis |
| --- | --- |
| [size()](#size--) | Vrací počet obrázků v kolekci. |
...
| [copyTo(System.Array array, int index)](#copyTo-com.aspose.ms.System.Array-int-) | Kopíruje všechny prvky z kolekce do specifikovaného pole. |
| [isSynchronized()](#isSynchronized--) | Vrací hodnotu, která určuje, zda je přístup ke kolekci synchronizován (thread-safe). |
...
Vrací počet obrázků v kolekci. Pouze pro čtení  int .
...
Tato metoda převádí WMF/EMF meta soubory na rastrový PNG obrázek před vložením do prezentace. |
...
Tato metoda může přidat WMF/EMF meta soubory do prezentace bez převodu na rastrový PNG obrázek. |
...
Kopíruje všechny prvky z kolekce do specifikovaného pole.
