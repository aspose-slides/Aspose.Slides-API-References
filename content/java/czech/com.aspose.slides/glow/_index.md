...
description: Reprezentuje efekt záře, ve kterém je po stranách objektu přidán rozostřený obrys barvy.
type: docs
...
Reprezentuje efekt záře, ve kterém je po stranách objektu přidán rozostřený obrys barvy.
## Metody
...
| [getEffective()](#getEffective--) | Získá efektivní data efektu Glow s použitím dědičnosti. |
...
Získá efektivní data efektu Glow s použitím dědičnosti.
...
Vrátí nadřazený IPresentationComponent. Pouze pro čtení [IPresentationComponent](../../com.aspose.slides/ipresentationcomponent).
