...
Pro získání efektivních hodnot parametrů formátování včetně zděděných je nutné použít metodu [getEffective](../../com.aspose.slides/iparagraphformat\#getEffective), která vrací instanci [IParagraphFormatEffectiveData](../../com.aspose.slides/iparagraphformateffectivedata).
...
| [getSpaceAfter()](#getSpaceAfter--) | Vrací nebo nastavuje množství prostoru za poslední řádkou v odstavci bez dědičnosti. |
| [setSpaceAfter(float value)](#setSpaceAfter-float-) | Vrací nebo nastavuje množství prostoru za poslední řádkou v odstavci bez dědičnosti. |
...
| [getIndent()](#getIndent--) | Vrací nebo nastavuje první řádek odsazení/zavěšené odsazení odstavce bez dědičnosti. |
| [setIndent(float value)](#setIndent-float-) | Vrací nebo nastavuje první řádek odsazení/zavěšené odsazení odstavce bez dědičnosti. |
...
Vrací nebo nastavuje množství prostoru mezi základními řádky v odstavci. Kladná hodnota znamená procenta, záporná – velikost v bodech. Nepoužita dědičnost. Čtení/Zápis float.
...
Vrací nebo nastavuje množství prostoru před první řádkou v odstavci bez dědičnosti. Kladná hodnota určuje procento velikosti písma, které by měl bílý prostor zabírat. Záporná hodnota udává velikost bílého prostoru v bodech. Čtení/Zápis float.
...
Vrací nebo nastavuje množství prostoru za poslední řádkou v odstavci bez dědičnosti. Kladná hodnota určuje procento velikosti písma, které by měl bílý prostor zabírat. Záporná hodnota udává velikost bílého prostoru v bodech. Čtení/Zápis float.
...
Určuje, zda se v odstavci používá asijské zalomení řádku. Nepoužita dědičnost. Čtení/Zápis [NullableBool](../../com.aspose.slides/nullablebool).
...
Určuje, zda se v odstavci používá zápis zprava doleva. Nepoužita dědičnost. Čtení/Zápis [NullableBool](../../com.aspose.slides/nullablebool).
...
Určuje, zda se v odstavci používá latinské zalomení řádku. Nepoužita dědičnost. Čtení/Zápis [NullableBool](../../com.aspose.slides/nullablebool).
...
Určuje, zda se v odstavci používá závěsná interpunkce. Nepoužita dědičnost. Čtení/Zápis [NullableBool](../../com.aspose.slides/nullablebool).
...
Vrací nebo nastavuje první řádek odsazení/zavěšené odsazení odstavce bez dědičnosti. Zavěšené odsazení lze definovat zápornými hodnotami. Čtení/Zápis float.
...
Vrací tabulátory odstavce. Nepoužita dědičnost. Pouze pro čtení [ITabCollection](../../com.aspose.slides/itabcollection).
...
Vrací výchozí formát části odstavce. Nepoužita dědičnost. Pouze pro čtení [IPortionFormat](../../com.aspose.slides/iportionformat).
