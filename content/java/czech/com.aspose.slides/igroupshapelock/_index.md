...
type: docs
url: /cs/com.aspose.slides/igroupshapelock/
---
...
| [getRotationLocked()](#getRotationLocked--) | Určuje, zda je změna úhlu rotace tohoto tvaru zakázána. |
| [setRotationLocked(boolean value)](#setRotationLocked-boolean-) | Určuje, zda je změna úhlu rotace tohoto tvaru zakázána. |
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Určuje, zda má tvar zachovávat poměr stran při změně velikosti. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Určuje, zda má tvar zachovávat poměr stran při změně velikosti. |
...
Určuje, zda je změna úhlu rotace tohoto tvaru zakázána. Čtení/zápis boolean.
...
Určuje, zda má tvar zachovávat poměr stran při změně velikosti. Čtení/zápis boolean.
