...
| Konstruktor | Popis |
| --- | --- |
| [DigitalSignature(byte[] certData, String password)](#DigitalSignature-byte---java.lang.String-) | Vytváří nový objekt DigitalSignature se zadaným certifikátem. |
| [DigitalSignature(String filePath, String password)](#DigitalSignature-java.lang.String-java.lang.String-) | Vytváří nový objekt DigitalSignature se zadanou cestou k souboru s certifikátem a heslem. |
## Metody

| Metoda | Popis |
| --- | --- |
| [getCertificate()](#getCertificate--) | Objekt certifikátu, který byl použit k podepsání dokumentu. |
| [isValid()](#isValid--) | Pokud je tento digitální podpis platný a dokument nebyl pozměněn, tato hodnota bude true. |
...
Vytváří nový objekt DigitalSignature se zadaným certifikátem.
...
Vytváří nový objekt DigitalSignature se zadanou cestou k souboru s certifikátem a heslem.
...
Objekt certifikátu, který byl použit k podepsání dokumentu. Pouze ke čtení byte[].
...
Pokud je tento digitální podpis platný a dokument nebyl pozměněn, tato hodnota bude true. Pouze ke čtení boolean.
...
Čas, kdy byl dokument podepsán. Pouze ke čtení java.util.Date.
