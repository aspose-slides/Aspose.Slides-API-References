...
**Návratová hodnota:**
[SlideImageFormat](../../com.aspose.slides/slideimageformat) - [SlideImageFormat](../../com.aspose.slides/slideimageformat) objekt.
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| scale | float | Faktor, kterým se mění velikost výstupního obrázku. |
