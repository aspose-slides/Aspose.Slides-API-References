...
Represents 3D rotation of a chart. → **Představuje 3D rotaci grafu.**
## Metody
...
Vrací nebo nastavuje hodnotu perspektivy (úhel zorného pole) pro 3D grafy (mezi 0 a 240). Ignorováno, pokud je hodnota vlastnosti RightAngleAxes pravdivá. Čtení/zápis byte.
...
Určuje, zda jsou osy grafu pravé úhly, místo aby byly vykresleny v perspektivě. Jinými slovy určuje, zda jsou úhly os nezávislé na rotaci nebo nadvzdušnosti grafu. Čtení/zápis boolean.
