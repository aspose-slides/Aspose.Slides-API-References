...
description: Representuje kolekci digitálních podpisů připojených k dokumentu.
type: docs
...
| [add(IDigitalSignature digitalSignature)](#add-com.aspose.slides.IDigitalSignature-) | Přidá podpis na konec kolekce. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| digitalSignature | [IDigitalSignature](../../com.aspose.slides/idigitalsignature) | Podpis, který se má přidat. |
