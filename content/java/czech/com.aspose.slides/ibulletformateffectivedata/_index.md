...
| [getActualBulletValue()](#getActualBulletValue--) | Vrací aktuální hodnotu odrážky pro nadřazený odstavec. |
...
Vrací aktuální hodnotu odrážky pro nadřazený odstavec. Pouze pro čtení String.
...
Určuje, zda má odrážka vlastní písmo nebo jej dědí z první části odstavce. Vrací **true**, pokud má odrážka vlastní písmo, a **false**, pokud odrážka dědí písmo z první části odstavce. Pouze pro čtení boolean.
...
>  try {
>      // Předpokládejte, že první tvar na první snímku je AutoShape s nějakým textem...
>      // Vypište informace o odrážkách odstavců textu
