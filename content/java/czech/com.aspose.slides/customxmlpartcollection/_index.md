...
| [copyTo(System.Array array, int index)](#copyTo-com.aspose.ms.System.Array-int-) | Zkopíruje do určeného pole. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| index | int | Index prvku (číslovaný od nuly), který se má získat. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| xmlString | java.lang.String | Řetězec xml nové části, která se má přidat. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| xmlData | byte[] | Data xml nové části, která se má přidat. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| inputStream | java.io.InputStream | Vstupní stream s xml daty nové části, která se má přidat. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| index | int | Index prvku (číslovaný od nuly), který se má odstranit. |
...
**Vrací:**
boolean – true, pokud byl položka úspěšně odstraněna; jinak false.
### clear() {#clear--}
```
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| array | com.aspose.ms.System.Array | Pole, do kterého se bude kopírovat. |
...
**Vrací:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICustomXmlPart> – IGenericEnumerator, který lze použít k iteraci přes kolekci.
