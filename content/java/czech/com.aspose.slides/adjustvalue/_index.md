...
description: Reprezentuje hodnotu úpravy geometrických tvarů.
type: docs
url: /cs/com.aspose.slides/adjustvalue/
---
**Dědičnost:**
java.lang.Object
...
Reprezentuje hodnotu úpravy geometrického tvaru. Tyto hodnoty ovlivňují tvar tělesa.
## Metody

| Metoda | Popis |
| --- | --- |
| [getRawValue()](#getRawValue--) | Vrací nebo nastavuje hodnotu úpravy „as is“. |
| [setRawValue(long value)](#setRawValue-long-) | Vrací nebo nastavuje hodnotu úpravy „as is“. |
...
Vrací nebo nastavuje hodnotu úpravy „as is“. Čtení/zápis long.
...
Vrací typ úpravy tvaru. Pouze ke čtení [ShapeAdjustmentType](../../com.aspose.slides/shapeadjustmenttype).
