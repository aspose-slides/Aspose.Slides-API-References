...
| [UserProvided](#UserProvided) | Aspose.Slides použije pole bajtů poskytnuté uživatelem v [IResourceLoadingArgs.setData(byte[])](../../com.aspose.slides/iresourceloadingargs\#setData-byte---) jako data obrázku. |
### Default {#Default}
```
...
Aspose.Slides použije pole bajtů poskytnuté uživatelem v [IResourceLoadingArgs.setData(byte[])](../../com.aspose.slides/iresourceloadingargs\#setData-byte---) jako data obrázku.