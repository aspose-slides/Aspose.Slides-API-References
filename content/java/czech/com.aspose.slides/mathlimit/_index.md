...
description: Určuje objekt Limit, který se skládá z textu na základní lince a zmenšeného textu těsně nad nebo pod ní.
type: docs
...
Určuje objekt Limit, který se skládá z textu na základní lince a zmenšeného textu těsně nad nebo pod ní.
