...
Určuje, zda OverrideTheme přepisuje zděděný efektivní motiv, nebo ne. Pro povolení OverrideTheme pro přepisování použijte metody OverrideTheme.Init\*(). Pro zakázání OverrideTheme z přepisování použijte metodu OverrideTheme.Clear(). Pouze pro čtení boolean.
