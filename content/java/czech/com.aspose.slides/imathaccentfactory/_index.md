...
| Metoda | Popis |
| --- | --- |
| [createMathAccent(IMathElement element)](#createMathAccent-com.aspose.slides.IMathElement-) | Vytvoří matematický akcent aplikovaný na určený matematický prvek s výchozí hodnotou znaku akcentu |
| [createMathAccent(IMathElement element, char accentCharacter)](#createMathAccent-com.aspose.slides.IMathElement-char-) | Vytvoří matematický akcent aplikovaný na určený matematický prvek |
### createMathAccent(IMathElement element) {#createMathAccent-com.aspose.slides.IMathElement-}
```
public abstract IMathAccent createMathAccent(IMathElement element)
```

Vytvoří matematický akcent aplikovaný na určený matematický prvek s výchozí hodnotou znaku akcentu
...
Vytvoří matematický akcent aplikovaný na určený matematický prvek
