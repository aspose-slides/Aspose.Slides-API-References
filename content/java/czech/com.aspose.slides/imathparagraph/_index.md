...
| Metoda | Popis |
| --- | --- |
| [getJustification()](#getJustification--) | Paragraph Justification Výchozí hodnota: CenteredAsGroup |
| [setJustification(int value)](#setJustification-int-) | Paragraph Justification Výchozí hodnota: CenteredAsGroup |
...
Paragraph Justification Výchozí hodnota: CenteredAsGroup
