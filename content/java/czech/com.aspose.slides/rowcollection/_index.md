...
| [addClone(IRow templ, boolean withAttachedRows)](#addClone-com.aspose.slides.IRow-boolean-) | Vytvoří kopii zadaného šablonového řádku a vloží ji na konec tabulky. |
| [insertClone(int index, IRow templ, boolean withAttachedRows)](#insertClone-int-com.aspose.slides.IRow-boolean-) | Vytvoří kopii zadaného šablonového řádku a vloží ji na zadanou pozici v tabulce. |
...
Získá počet řádků skutečně obsažených v kolekci. Pouze pro čtení int.
...
Vrací řádek na zadaném indexu. Pouze pro čtení [Row](../../com.aspose.slides/row).
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| templ | [IRow](../../com.aspose.slides/irow) | Řádek použitý jako šablona. |
| withAttachedRows | boolean | True, pokud také zkopírovat všechny řádky připojené k šablonovému řádku. |

**Vrací:**
com.aspose.slides.IRrow[] - Přidané řádky.
...
| withAttachedRows | boolean | True, pokud také odstranit všechny připojené řádky. |
