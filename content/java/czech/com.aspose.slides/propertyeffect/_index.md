...
type: docs
url: /cs/com.aspose.slides/propertyeffect/
---
**Dědičnost:**
...
| [getBy()](#getBy--) | Určuje relativní posun hodnoty animace vzhledem k jejímu umístění před zahájením animace. |
| [setBy(String value)](#setBy-java.lang.String-) | Určuje relativní posun hodnoty animace vzhledem k jejímu umístění před zahájením animace. |
...
| [getCalcMode()](#getCalcMode--) | Určuje režim interpolace animace Čtení/Zápis [PropertyCalcModeType](../../com.aspose.slides/propertycalcmodetype). |
| [setCalcMode(int value)](#setCalcMode-int-) | Určuje režim interpolace animace Čtení/Zápis [PropertyCalcModeType](../../com.aspose.slides/propertycalcmodetype). |
...
Určuje relativní posun hodnoty animace vzhledem k jejímu umístění před zahájením animace. Čtení/Zápis String.
...
Určuje režim interpolace animace Čtení/Zápis [PropertyCalcModeType](../../com.aspose.slides/propertycalcmodetype).
