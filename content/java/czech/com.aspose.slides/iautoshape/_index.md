...
| [getUseBackgroundFill()](#getUseBackgroundFill--) | Určuje, zda by měl být tento autoshape vyplněn pozadím snímku místo vyplnění určeného stylem nebo formátem výplně. |
| [setUseBackgroundFill(boolean value)](#setUseBackgroundFill-boolean-) | Určuje, zda by měl být tento autoshape vyplněn pozadím snímku místo vyplnění určeného stylem nebo formátem výplně. |
...
Určuje, zda by měl být tento autoshape vyplněn pozadím snímku místo vyplnění určeného stylem nebo formátem výplně. Čtení/zápis boolean.
...
**Vrací:**
[ITextFrame](../../com.aspose.slides/itextframe) - Nový [ITextFrame](../../com.aspose.slides/itextframe) objekt.
### isTextBox() {#isTextBox--}
```
...
Pokud není tvar specifikován jako textové pole, neznamená to, že by nemohl mít připojený text. Textové pole je jen specializovaný tvar se specifickými vlastnostmi.
