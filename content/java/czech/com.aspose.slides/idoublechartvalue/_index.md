...
Reprezentuje hodnotu typu double, která může být uložena v dokumentu pptx prezentace dvěma způsoby: 1) v buňce/buňkách sešitu souvisejícího s grafem; 2) jako doslovná hodnota.
## Metody
