...
type: docs
url: /cs/com.aspose.slides/groupshapelock/
---
**Dědičnost:**
...
Určuje, které operace jsou zakázány na nadřazeném GroupShape.
## Metody
...
| [getUngroupingLocked()](#getUngroupingLocked--) | Určuje, zda je rozdělení tohoto groupshape zakázáno. |
| [setUngroupingLocked(boolean value)](#setUngroupingLocked-boolean-) | Určuje, zda je rozdělení tohoto groupshape zakázáno. |
...
| [getRotationLocked()](#getRotationLocked--) | Určuje, zda je změna úhlu otočení tohoto tvaru zakázána. |
| [setRotationLocked(boolean value)](#setRotationLocked-boolean-) | Určuje, zda je změna úhlu otočení tohoto tvaru zakázána. |
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Určuje, zda tvar musí při změně velikosti zachovat poměr stran. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Určuje, zda tvar musí při změně velikosti zachovat poměr stran. |
| [getPositionLocked()](#getPositionLocked--) | Určuje, zda je přesun tohoto tvaru zakázán. |
| [setPositionLocked(boolean value)](#setPositionLocked-boolean-) | Určuje, zda je přesun tohoto tvaru zakázán. |
...
Určuje, zda je rozdělení tohoto groupshape zakázáno. Číst/Zapisovat boolean.
...
Určuje, zda tvar musí při změně velikosti zachovat poměr stran. Číst/Zapisovat boolean.
...
Určuje, zda je přesun tohoto tvaru zakázán. Číst/Zapisovat boolean.
