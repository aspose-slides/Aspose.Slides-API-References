...
description: Representuje rastrový nebo vektorový obrázek.
type: docs
...
| [save(String filename, int format)](#save-java.lang.String-int-) | Uloží obrázek do souboru ve specifikovaném formátu. |
| [save(OutputStream stream, int format)](#save-java.io.OutputStream-int-) | Uloží obrázek do proudu ve specifikovaném formátu. |
| [save(String filename, int format, int quality)](#save-java.lang.String-int-int-) | Uloží obrázek do souboru ve specifikovaném formátu a kvalitě. |
| [save(OutputStream stream, int format, int quality)](#save-java.io.OutputStream-int-int-) | Uloží obrázek do proudu ve specifikovaném formátu a kvalitě. |
...
| filename | java.lang.String | Cesta k souboru, do kterého bude obrázek uložen. |
| format | int | Formát obrázku. |
| quality | int | Kvalita uloženého obrázku (0 až 100). Tento parametr ovlivňuje pouze ukládání ve formátu [ImageFormat.Jpeg](../../com.aspose.slides/imageformat\#Jpeg); pro všechny ostatní formáty je ignorován. |
