...
| Metoda | Popis |
| --- | --- |
| [getWarningCallback()](#getWarningCallback--) | Vrací nebo nastavuje objekt, který přijímá varování a rozhoduje, zda proces načítání bude pokračovat nebo bude přerušen. |
| [setWarningCallback(IWarningCallback value)](#setWarningCallback-com.aspose.slides.IWarningCallback-) | Vrací nebo nastavuje objekt, který přijímá varování a rozhoduje, zda proces načítání bude pokračovat nebo bude přerušen. |
| [getProgressCallback()](#getProgressCallback--) | Představuje zpětné volání pro aktualizace postupu ukládání v procentech. |
| [setProgressCallback(IProgressCallback value)](#setProgressCallback-com.aspose.slides.IProgressCallback-) | Představuje zpětné volání pro aktualizace postupu ukládání v procentech. |
...
Vrací nebo nastavuje objekt, který přijímá varování a rozhoduje, zda proces načítání bude pokračovat nebo bude přerušen. Číst/zapisovat [IWarningCallback](../../com.aspose.slides/iwarningcallback).
...
Představuje zpětné volání pro aktualizace postupu ukládání v procentech. Viz [IProgressCallback](../../com.aspose.slides/iprogresscallback).
