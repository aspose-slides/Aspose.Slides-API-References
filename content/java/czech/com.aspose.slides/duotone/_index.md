...
Representuje efekt Duotone. Pro každý pixel kombinuje Color1 a Color2 lineární interpolací pro určení nové barvy pixelu.
## Metody
...
| [getEffective()](#getEffective--) | Získává efektivní data Duotone efektu s aplikovanou dědičností. |
| [getVersion()](#getVersion--) |  |
| [equals(Object obj)](#equals-java.lang.Object-) | Určuje, zda je zadaný [Duotone](../../com.aspose.slides/duotone) roven aktuálnímu [Duotone](../../com.aspose.slides/duotone). |
...
Získává efektivní data Duotone efektu s aplikovanou dědičností.
...
Určuje, zda je zadaný [Duotone](../../com.aspose.slides/duotone) roven aktuálnímu [Duotone](../../com.aspose.slides/duotone).

**Parametry:**
| Parametr | Typ | Popis |
| --- | --- | --- |
| obj | java.lang.Object | [Duotone](../../com.aspose.slides/duotone) k porovnání. |
