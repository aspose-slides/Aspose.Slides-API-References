...
| Metoda | Popis |
| --- | --- |
| [getPreferredCulture()](#getPreferredCulture--) | Získá nebo nastaví informace o preferované kultuře pro výpočet některých funkcí určených pro jazyky používající dvojbytovou znakovou sadu (DBCS). |
| [setPreferredCulture(Locale value)](#setPreferredCulture-java.util.Locale-) | Získá nebo nastaví informace o preferované kultuře pro výpočet některých funkcí určených pro jazyky používající dvojbytovou znakovou sadu (DBCS). |
...
Získá nebo nastaví informace o preferované kultuře pro výpočet některých funkcí určených pro jazyky používající dvojbytovou znakovou sadu (DBCS).
