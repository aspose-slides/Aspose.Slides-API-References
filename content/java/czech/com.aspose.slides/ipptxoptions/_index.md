...
description: Reprezentuje možnosti ukládání OpenXml prezentací PPTX, PPSX, POTX, PPTM, PPSM, POTM.
type: docs
...
Reprezentuje možnosti ukládání OpenXml prezentací (PPTX, PPSX, POTX, PPTM, PPSM, POTM).
## Metody

| Metoda | Popis |
| --- | --- |
| [getConformance()](#getConformance--) | Určuje třídu shody, ke které se dokument Presentation vztahuje. |
| [setConformance(int value)](#setConformance-int-) | Určuje třídu shody, ke které se dokument Presentation vztahuje. |
...
Určuje třídu shody, ke které se dokument Presentation vztahuje. Výchozí hodnota je [Conformance.Ecma376\_2006](../../com.aspose.slides/conformance\#Ecma376-2006)
...
Když je hodnota možnosti **false**, bude aktuální miniatura uložena tak, jak je.
