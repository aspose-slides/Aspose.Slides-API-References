...
type: docs
url: /cs/com.aspose.slides/iconnectorlock/
---
...
| [getRotateLocked()](#getRotateLocked--) | Určuje, zda je změna úhlu otočení tohoto tvaru zakázána. |
| [setRotateLocked(boolean value)](#setRotateLocked-boolean-) | Určuje, zda je změna úhlu otočení tohoto tvaru zakázána. |
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Určuje, zda má tvar při změně velikosti zachovat poměr stran. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Určuje, zda má tvar při změně velikosti zachovat poměr stran. |
...
Určuje, zda je změna úhlu otočení tohoto tvaru zakázána. Čtení/zápis boolean.
...
Určuje, zda má tvar při změně velikosti zachovat poměr stran. Čtení/zápis boolean.
