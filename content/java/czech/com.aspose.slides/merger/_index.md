...
description: Představuje skupinu metod pro sloučení prezentací PowerPoint stejného formátu do jednoho souboru.
type: docs
...
Představuje skupinu metod pro sloučení prezentací PowerPoint stejného formátu do jednoho souboru.
## Metody

| Metoda | Popis |
| --- | --- |
| [process(String[] inputFileNames, String outputFileName)](#process-java.lang.String---java.lang.String-) | Sloučí více prezentací PowerPoint stejného formátu do jednoho souboru prezentace. |
| [process(String[] inputFileNames, String outputFileName, ISaveOptions options)](#process-java.lang.String---java.lang.String-com.aspose.slides.ISaveOptions-) | Sloučí více prezentací PowerPoint stejného formátu do jednoho souboru prezentace. |
| [process(String[] inputFileNames, OutputStream outputStream)](#process-java.lang.String---java.io.OutputStream-) | Sloučí více prezentací PowerPoint stejného formátu do jednoho souboru prezentace. |
| [process(String[] inputFileNames, OutputStream outputStream, ISaveOptions options)](#process-java.lang.String---java.io.OutputStream-com.aspose.slides.ISaveOptions-) | Sloučí více prezentací PowerPoint stejného formátu do jednoho souboru prezentace. |
...
Sloučí více prezentací PowerPoint stejného formátu do jednoho souboru prezentace.
...
| inputFileNames | java.lang.String[] | Pole názvů vstupních souborů prezentací. |
| outputFileName | java.lang.String | Název výstupního souboru výsledné sloučené prezentace. |
| options | [ISaveOptions](../../com.aspose.slides/isaveoptions) | Další možnosti, které určují, jak je sloučená prezentace uložena. |
...
| --- | --- | --- |
| inputFileNames | java.lang.String[] | Pole názvů vstupních souborů prezentací. |
| outputStream | java.io.OutputStream | Výstupní proud. |
