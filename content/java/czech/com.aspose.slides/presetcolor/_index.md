...
description: Reprezentuje předdefinované předvolby barev.
type: docs
url: /cs/com.aspose.slides/presetcolor/
---
**Inheritance:**
...
Reprezentuje předdefinované předvolby barev.
## Pole

| Pole | Popis |
| --- | --- |
| [NotDefined](#NotDefined) | Předvolba barvy není definována. |
| [AliceBlue](#AliceBlue) |  |
...
Předvolba barvy není definována.
...
### GhostWhite {#GhostWhite}
```
public          public          static          final          int          GhostWhite
```
