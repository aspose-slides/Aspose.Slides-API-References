...
| [addNodeByPosition(int position)](#addNodeByPosition-int-) | Přidá nový uzel ve vybrané pozici kolekce uzlů. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| index | int | Index uzlu počítaný od nuly |
...
Přidá nový uzel ve vybrané pozici kolekce uzlů.

**Parametry:**
| Parametr | Typ | Popis |
| --- | --- | --- |
| position | int | Pozice uzlu počítaná od nuly. |
