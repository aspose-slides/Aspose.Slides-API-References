...
>      shape.getTextFrame().getParagraphs().get_Item(0).getParagraphFormat().getDefaultPortionFormat().setFontHeight(64);
>      // Nakaonfigurujte FillFormat.FillType jako FillType.Gradient a definujte vlastnosti gradientu.
...
>      // Nakaonfigurujte FillFormat.FillType jako FillType.NoFill.
>      shape.getFillFormat().setFillType(FillType.NoFill);
>      shape.getLineFormat().getFillFormat().setFillType(FillType.NoFill);
>      // Nakaonfigurujte část TextFrame a nastavte vlastnosti PortionFormat.
...
| [getExtrusionHeight()](#getExtrusionHeight--) | Vrací nebo nastavuje výšku efektu vytlačení. |
| [setExtrusionHeight(double value)](#setExtrusionHeight-double-) | Vrací nebo nastavuje výšku efektu vytlačení. |
...
| [getBevelBottom()](#getBevelBottom--) | Vrací nebo nastavuje typ dolního 3D zkosení. |
| [getContourColor()](#getContourColor--) | Vrací nebo nastavuje barvu kontury. |
| [getExtrusionColor()](#getExtrusionColor--) | Vrací nebo nastavuje barvu vytlačení. |
...
| [getEffective()](#getEffective--) | Získá efektivní 3D formátovací data s aplikovaným děděním. |
### getVersion() {#getVersion--}
```
...
Vrací nebo nastavuje výšku efektu vytlačení. Čtení/Zápis double.
...
Vrací nebo nastavuje typ dolního 3D zkosení. Pouze pro čtení [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Vrací nebo nastavuje barvu vytlačení. Pouze pro čtení [IColorFormat](../../com.aspose.slides/icolorformat).
...
Získá efektivní 3D formátovací data s aplikovaným děděním.
