...
| [get_Item(int index)](#get-Item-int-) | Vrátí [ImageTransformOperation](../../com.aspose.slides/imagetransformoperation) ze sbírky podle jeho indexu. |
| [removeAt(int index)](#removeAt-int-) | Odstraní efekt obrázku ze sbírky na zadaném indexu. |
...
| [isReadOnly()](#isReadOnly--) | Získává hodnotu určující, zda je [IGenericCollection](../../com.aspose.slides/igenericcollection) pouze ke čtení. |
...
| [copyToTArray(IImageTransformOperation[] array, int arrayIndex)](#copyToTArray-com.aspose.slides.IImageTransformOperation---int-) | Kopíruje prvky [IGenericCollection](../../com.aspose.slides/igenericcollection) do pole, počínaje zadaným indexem pole. |
...
| [iterator()](#iterator--) | Vrací enumerátor, který iteruje přes sbírku. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| alpha | float | Nová hodnota průhlednosti. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| threshold | float | Práh luminance pro efekt Bi-Level. Hodnoty větší nebo rovny prahu jsou nastaveny na bílou. Hodnoty menší než práh jsou nastaveny na černou. |
...
| grow | boolean | Určuje, zda mají být hranice objektu rozšířeny v důsledku rozostření. True znamená, že jsou rozšířeny, false že nejsou. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| hue | float | Počet stupňů, o který se upravuje odstín. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| hue | float | Odstín, ke kterému se provádí tónování. |
...
Vrací počet efektů obrázku ve sbírce. Pouze ke čtení int .
...
Získává hodnotu určující, zda je [IGenericCollection](../../com.aspose.slides/igenericcollection) pouze ke čtení. Pouze ke čtení boolean.
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| item | [IImageTransformOperation](../../com.aspose.slides/iimagetransformoperation) | Objekt, který se má vyhledat v [IGenericCollection](../../com.aspose.slides/igenericcollection). |
...
Kopíruje prvky [IGenericCollection](../../com.aspose.slides/igenericcollection) do pole, počínaje zadaným indexem pole.
...
| arrayIndex | int | Nulový index v poli, kde začíná kopírování. |
...
| Parametr | Typ | Popis |
| --- | --- | --- |
| item | [IImageTransformOperation](../../com.aspose.slides/iimagetransformoperation) | Objekt, který se má odstranit z [IGenericCollection](../../com.aspose.slides/igenericcollection). |
...
Vrací enumerátor, který iteruje přes sbírku.

**Vrací:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IImageTransformOperation> - IGenericEnumerator, který lze použít k iteraci přes sbírku.
...
**Vrací:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IImageTransformOperation> - java.util.Iterator pro celou sbírku.