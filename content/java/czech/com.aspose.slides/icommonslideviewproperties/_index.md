...
description: Zastupuje obecné vlastnosti zobrazení snímků.
type: docs
...
Zastupuje obecné vlastnosti zobrazení snímků.
## Metody
...
| [getVariableScale()](#getVariableScale--) | Určuje, že obsah zobrazení se má automaticky přizpůsobit tak, aby nejlépe vyhovoval aktuální velikosti okna. |
| [setVariableScale(boolean value)](#setVariableScale-boolean-) | Určuje, že obsah zobrazení se má automaticky přizpůsobit tak, aby nejlépe vyhovoval aktuální velikosti okna. |
...
Určuje, že obsah zobrazení se má automaticky přizpůsobit tak, aby nejlépe vyhovoval aktuální velikosti okna. Čtení/zápis boolean.
...
>      // Přidání nového vodorovného kreslicího vodítka pod středu snímku
