...
description: Představuje uzel objektu SmartArt
type: docs
...
Představuje uzel objektu SmartArt
## Metody

| Metoda | Popis |
| --- | --- |
| [getChildNodes()](#getChildNodes--) | Vrací kolekce všech poduzlů aktuálního uzlu. |
...
| [getPosition()](#getPosition--) | Vrací nebo nastavuje nulový index pozice uzlu mezi sourozeneckými uzly. |
| [setPosition(int value)](#setPosition-int-) | Vrací nebo nastavuje nulový index pozice uzlu mezi sourozeneckými uzly. |
...
Vrací kolekce všech poduzlů aktuálního uzlu. Pouze pro čtení [ISmartArtNodeCollection](../../com.aspose.slides/ismartartnodecollection).
...
Vrací objekt FillFormat, který obsahuje vlastnosti výplně pro odrážku uzlu. Poznámka: může vrátit null pro některé typy rozvržení SmartArt, které neposkytují odrážky pro uzly. Pouze pro čtení [IFillFormat](../../com.aspose.slides/ifillformat).
...
Vrací nebo nastavuje nulový index pozice uzlu mezi sourozeneckými uzly. Čtení/zápis int .
