...
Aby uzyskać efektywne wartości parametrów formatowania, w tym odziedziczone, należy użyć metody [getEffective](../../com.aspose.slides/iparagraphformat\#getEffective), która zwraca instancję [IParagraphFormatEffectiveData](../../com.aspose.slides/iparagraphformateffectivedata).
...
| [setHangingPunctuation(byte value)](#setHangingPunctuation-byte-) | Określa, czy w akapicie używana jest wieszająca interpunkcja. |
...
| [getIndent()](#getIndent--) | Zwraca lub ustawia wcięcie pierwszej linii/wieszające wcięcie akapitu bez dziedziczenia. |
| [setIndent(float value)](#setIndent-float-) | Zwraca lub ustawia wcięcie pierwszej linii/wieszające wcięcie akapitu bez dziedziczenia. |
...
| [getEffective()](#getEffective--) | Pobiera efektywne dane formatowania akapitu z zastosowanym dziedziczeniem. |
...
Zwraca lub ustawia ilość odstępu przed pierwszą linią w akapicie bez dziedziczenia. Dodatnia wartość określa procent rozmiaru czcionki, jaki powinien wynosić odstęp. Ujemna wartość określa rozmiar odstępu w punktach. Odczyt/zapis float.
...
Zwraca lub ustawia ilość odstępu po ostatniej linii w akapicie bez dziedziczenia. Dodatnia wartość określa procent rozmiaru czcionki, jaki powinien wynosić odstęp. Ujemna wartość określa rozmiar odstępu w punktach. Odczyt/zapis float.
...
Określa, czy w akapicie używany jest podział linii w stylu wschodnioazjatyckim. Nie stosuje się dziedziczenia. Odczyt/zapis [NullableBool](../../com.aspose.slides/nullablebool).
...
Określa, czy w akapicie używany jest łaciński podział linii. Nie stosuje się dziedziczenia. Odczyt/zapis [NullableBool](../../com.aspose.slides/nullablebool).
...
Określa, czy w akapicie używana jest wieszająca interpunkcja. Nie stosuje się dziedziczenia. Odczyt/zapis [NullableBool](../../com.aspose.slides/nullablebool).
...
Zwraca lub ustawia wcięcie pierwszej linii/wieszające wcięcie akapitu bez dziedziczenia. Wieszające wcięcie może być określone wartościami ujemnymi. Odczyt/zapis float.
...
Zwraca domyślny format fragmentu akapitu. Nie stosuje się dziedziczenia. Tylko do odczytu [IPortionFormat](../../com.aspose.slides/iportionformat).
