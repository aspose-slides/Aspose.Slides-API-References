...
type: docs
url: /pl/com.aspose.slides/effect/
---
**Dziedziczenie:**
java.lang.Object
...
| [getTextAnimation()](#getTextAnimation--) | TextAnimation Tylko do odczytu [ITextAnimation](../../com.aspose.slides/itextanimation). |
...
| [getSound()](#getSound--) | Zdefiniowano osadzony dźwięk dla efektu. |
| [setSound(IAudio value)](#setSound-com.aspose.slides.IAudio-) | Zdefiniowano osadzony dźwięk dla efektu. |
...
| [getAfterAnimationType()](#getAfterAnimationType--) | Definiuje typ animacji po zakończeniu efektu. |
| [setAfterAnimationType(int value)](#setAfterAnimationType-int-) | Definiuje typ animacji po zakończeniu efektu. |
| [getAfterAnimationColor()](#getAfterAnimationColor--) | Definiuje kolor animacji po zakończeniu efektu. |
| [setAfterAnimationColor(IColorFormat value)](#setAfterAnimationColor-com.aspose.slides.IColorFormat-) | Definiuje kolor animacji po zakończeniu efektu. |
| [getAnimateTextType()](#getAnimateTextType--) | Definiuje typ animacji tekstu dla efektu. |
| [setAnimateTextType(int value)](#setAnimateTextType-int-) | Definiuje typ animacji tekstu dla efektu. |
...
TextAnimation Tylko do odczytu [ITextAnimation](../../com.aspose.slides/itextanimation).
...
Definiuje klasę efektu. Odczyt/zapis [EffectPresetClassType](../../com.aspose.slides/effectpresetclasstype).
...
Definiuje typ efektu. Odczyt/zapis [EffectType](../../com.aspose.slides/effecttype).
...
Definiuje podtyp efektu. Odczyt/zapis [EffectSubtype](../../com.aspose.slides/effectsubtype).
...
Definiuje wartość czasu dla efektu. Odczyt/zapis [ITiming](../../com.aspose.slides/itiming).
...
Zdefiniowano osadzony dźwięk dla efektu. Odczyt/zapis [IAudio](../../com.aspose.slides/iaudio).
...
>      {
>          // Zmień dźwięk drugiego efektu w sekcji Enhancements/Sound na "Stop Previous Sound"
...
Definiuje typ animacji po zakończeniu efektu. Odczyt/zapis [AfterAnimationType](../../com.aspose.slides/afteranimationtype)(\#getAfterAnimationType.getAfterAnimationType/\#setAfterAnimationType(int).setAfterAnimationType(int)).
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Zmień animację po zakończeniu efektu na "Hide on Next Mouse Click"
...
Definiuje kolor animacji po zakończeniu efektu. Odczyt/zapis [IColorFormat](../../com.aspose.slides/icolorformat).
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Zmień typ animacji po zakończeniu efektu na "Color"
...
Definiuje typ animacji tekstu dla efektu. Tekst kształtu może być animowany literą, słowem lub jednocześnie. Odczyt/zapis AnimateTextType (\#getAnimateTextType.getAnimateTextType/\#setAnimateTextType(int).setAnimateTextType(int)).
...
Definiuje opóźnienie między częściami animowanego tekstu (słowa lub litery). Dodatnia wartość określa procent czasu trwania efektu. Ujemna wartość określa opóźnienie w sekundach. Odczyt/zapis float.
