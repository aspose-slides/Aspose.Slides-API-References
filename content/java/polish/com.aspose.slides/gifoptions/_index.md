...
| [getTransitionFps()](#getTransitionFps--) | Pobiera lub ustawia FPS przejścia [frames/sec] Domyślna wartość to 25. |
| [setTransitionFps(int value)](#setTransitionFps-int-) | Pobiera lub ustawia FPS przejścia [frames/sec] Domyślna wartość to 25. |
...
Pobiera lub ustawia FPS przejścia [frames/sec] Domyślna wartość to 25.
