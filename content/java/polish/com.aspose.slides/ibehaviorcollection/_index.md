...
| [indexOf(IBehavior item)](#indexOf-com.aspose.slides.IBehavior-) | Określa indeks określonego elementu w List. |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| item | [IBehavior](../../com.aspose.slides/ibehavior) | Obiekt do zlokalizowania w List. |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks, pod którym należy wstawić nowe zachowanie. |
...
**Zwraca:**
boolean - true jeśli zachowanie zostało pomyślnie usunięte boolean
