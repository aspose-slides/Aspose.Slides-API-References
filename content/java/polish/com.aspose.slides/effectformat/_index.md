...
type: docs
url: /pl/com.aspose.slides/effectformat/
---
**Dziedziczenie:**
...
| [isNoEffects()](#isNoEffects--) | Zwraca true, jeśli wszystkie efekty są wyłączone (tak jak po utworzeniu, domyślny obiekt EffectFormat). |
...
| [getEffective()](#getEffective--) | Pobiera dane formatowania efektów z uwzględnieniem dziedziczenia. |
### getVersion() {#getVersion--}
```
...
Pobiera dane formatowania efektów z uwzględnieniem dziedziczenia.
