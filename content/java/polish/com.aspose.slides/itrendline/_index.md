...
| [getBackward()](#getBackward--) | Określa liczbę kategorii (lub jednostek na wykresie punktowym), które linia trendu rozciąga przed danymi serii, którą trenduje się. |
| [setBackward(double value)](#setBackward-double-) | Określa liczbę kategorii (lub jednostek na wykresie punktowym), które linia trendu rozciąga przed danymi serii, którą trenduje się. |
| [getForward()](#getForward--) | Określa liczbę kategorii (lub jednostek na wykresie punktowym), które linia trendu rozciąga po danych serii, którą trenduje się. |
| [setForward(double value)](#setForward-double-) | Określa liczbę kategorii (lub jednostek na wykresie punktowym), które linia trendu rozciąga po danych serii, którą trenduje się. |
...
| [getPeriod()](#getPeriod--) | Określa okres linii trendu dla średniej kroczącej. |
| [setPeriod(byte value)](#setPeriod-byte-) | Określa okres linii trendu dla średniej kroczącej. |
...
| [getRelatedLegendEntry()](#getRelatedLegendEntry--) | Reprezentuje element legendy powiązany z tą linią trendu. Tylko do odczytu [ILegendEntryProperties](../../com.aspose.slides/ilegendentryproperties). |
...
Określa liczbę kategorii (lub jednostek na wykresie punktowym), które linia trendu rozciąga przed danymi serii, którą trenduje się. Dla wykresów punktowych i innych wykresów wartość może być dowolną nieujemną wartością. Odczyt/zapis double.
...
Określa liczbę kategorii (lub jednostek na wykresie punktowym), które linia trendu rozciąga po danych serii, którą trenduje się. Dla wykresów punktowych i innych wykresów wartość może być dowolną nieujemną wartością. Odczyt/zapis double.
...
Określa wartość, w której linia trendu przecina oś Y. Właściwość jest obsługiwana wyłącznie, gdy typ linii trendu to exp, linear lub poly. Odczyt/zapis double.
...
Określa stopień wielomianowej linii trendu. Jest ignorowany dla innych typów linii trendu. Wartość musi wynosić od 2 do 6. Odczyt/zapis byte.
...
Określa okres linii trendu dla średniej kroczącej. Jest ignorowany dla innych wariantów linii trendu. Wartość musi wynosić od 2 do 255. Odczyt/zapis byte.
...
Reprezentuje element legendy powiązany z tą linią trendu. Tylko do odczytu [ILegendEntryProperties](../../com.aspose.slides/ilegendentryproperties).
