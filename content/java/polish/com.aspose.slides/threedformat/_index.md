...
>  try {
>      // Dodaj kształt przy użyciu metody AddAutoShape.
...
>      // Skonfiguruj fragment TextFrame i właściwości PortionFormat.
...
| [getContourWidth()](#getContourWidth--) | Zwraca lub ustawia szerokość konturu 3-D. |
| [setContourWidth(double value)](#setContourWidth-double-) | Zwraca lub ustawia szerokość konturu 3-D. |
...
| [getDepth()](#getDepth--) | Zwraca lub ustawia głębokość kształtu 3-D. |
| [setDepth(double value)](#setDepth-double-) | Zwraca lub ustawia głębokość kształtu 3-D. |
| [getBevelTop()](#getBevelTop--) | Zwraca lub ustawia typ górnego 3-D bevel. |
| [getBevelBottom()](#getBevelBottom--) | Zwraca lub ustawia typ dolnego 3-D bevel. |
...
Zwraca lub ustawia szerokość konturu 3-D. Odczyt/zapis double.
...
Zwraca lub ustawia głębokość kształtu 3-D. Odczyt/zapis double.
...
Zwraca lub ustawia typ górnego 3-D bevel. Tylko do odczytu [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Zwraca lub ustawia typ dolnego 3-D bevel. Tylko do odczytu [IShapeBevel](../../com.aspose.slides/ishapebevel).
