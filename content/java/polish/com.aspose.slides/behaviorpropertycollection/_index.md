...
| [add(String propertyValue)](#add-java.lang.String-) | Dodaje nową właściść do kolekcji. |
| [indexOf(IBehaviorProperty item)](#indexOf-com.aspose.slides.IBehaviorProperty-) | Określa indeks określonego elementu w List. |
| [indexOf(String propertyValue)](#indexOf-java.lang.String-) | Określa indeks określonego elementu według wartości właściwości w List. |
...
Określa indeks określonego elementu w List.

**Parametry:**
| Parametr | Typ | Opis |
| --- | --- | --- |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | Obiekt do zlokalizowania w List. |
...
Określa indeks określonego elementu według wartości właściwości w List.
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks, pod którym nowa właściwość ma zostać wstawiona. |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | Właściwość do dodania. |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| array | [IBehaviorProperty\[\]](../../com.aspose.slides/ibehaviorproperty) | Jednowymiarowa tablica będąca celem elementów kopiowanych z [IGenericCollection](../../com.aspose.slides/igenericcollection). Tablica musi mieć indeksowanie zerowe. |
...
**Zwraca:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IBehaviorProperty> - IGenericEnumerator, którego można użyć do iteracji po kolekcji.
