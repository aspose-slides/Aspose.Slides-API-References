...
| [getPlayLoopMode()](#getPlayLoopMode--) | Określa, czy wideo jest zapętlone. |
| [setPlayLoopMode(boolean value)](#setPlayLoopMode-boolean-) | Określa, czy wideo jest zapętlone. |
...
| [getTrimFromStart()](#getTrimFromStart--) | Przytnij początek [ms] |
| [setTrimFromStart(float value)](#setTrimFromStart-float-) | Przytnij początek [ms] |
| [getTrimFromEnd()](#getTrimFromEnd--) | Przytnij koniec [ms] |
| [setTrimFromEnd(float value)](#setTrimFromEnd-float-) | Przytnij koniec [ms] |
...
Określa, czy wideo jest zapętlone. Odczyt/zapis boolean.
...
>      //ustaw czas przycięcia początkowego 1s
>      videoFrame.setTrimFromStart(1000f);
>      //ustaw czas przycięcia końcowego 2s
