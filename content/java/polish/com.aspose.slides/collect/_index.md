...
| Metoda | Opis |
| --- | --- |
| [shapes(Presentation pres)](#shapes-com.aspose.slides.Presentation-) | Zbiera wszystkie wystąpienia [Shape](../../com.aspose.slides/shape) w [Presentation](../../com.aspose.slides/presentation). |
### Collect() {#Collect--}
```
public Collect()
```
...
Zbiera wszystkie wystąpienia [Shape](../../com.aspose.slides/shape) w [Presentation](../../com.aspose.slides/presentation).
...
>      for (IShape shape : Collect.shapes(pres))
>      {
>          // jeśli kształt jest AutoShape, dodaj czarną jednolitą ramkę
...
**Zwraca:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.slides.Shape> - Kolekcja wszystkich kształtów znajdujących się w prezentacji