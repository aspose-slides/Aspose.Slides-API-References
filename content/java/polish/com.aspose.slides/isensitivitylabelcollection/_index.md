...
| [add(String id, UUID siteId, boolean isEnabled, int methodType)](#add-java.lang.String-java.util.UUID-boolean-int-) | Dodaje etykietę wrażliwości na koniec kolekcji. |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| label | [ISensitivityLabel](../../com.aspose.slides/isensitivitylabel) | Obiekt SensitivityLabel, który ma zostać dodany na koniec kolekcji. |

**Zwraca:**
int - Indeks, pod którym SensitivityLabel został dodany.
