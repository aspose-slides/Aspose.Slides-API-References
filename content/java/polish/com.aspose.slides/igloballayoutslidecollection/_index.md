...
Podczas klonowania układu między różnymi prezentacjami, master układu może zostać również sklonowany, aby zachować formatowanie źródłowe. Wewnętrzny rejestr jest używany do śledzenia automatycznie sklonowanych masterów w celu zapobieżenia tworzeniu wielu klonów tego samego slajdu master. Ręczne klonowanie slajdów master nie będzie ani zapobiegane, ani rejestrowane. |
...
Nowy układ zostanie powiązany z określonym masterem w prezentacji docelowej. Jest to więc odpowiednik kopiuj/wklej z opcją „Use Destination Theme” w programie PowerPoint. |
...
| layoutName | java.lang.String | Nazwa dla nowego układu. Jeśli przekazana nazwa jest już używana, zostanie wyrzucony ArgumentException. Jeśli przekazany parametr jest null, nazwa zostanie wygenerowana automatycznie w zależności od podanego typu układu (np. „Title Slide” lub „1\_Title Slide”, „2\_..” itd.). |
