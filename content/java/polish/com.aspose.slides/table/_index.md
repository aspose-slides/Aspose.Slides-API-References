...
| Metoda | Opis |
| --- | --- |
| [get_Item(int columnIndex, int rowIndex)](#get-Item-int-int-) | Zwraca komórkę o podanych indeksach kolumny i wiersza. |
...
| [getFirstRow()](#getFirstRow--) | Określa, czy pierwszy wiersz tabeli ma być wyświetlany ze specjalnym formatowaniem. |
| [setFirstRow(boolean value)](#setFirstRow-boolean-) | Określa, czy pierwszy wiersz tabeli ma być wyświetlany ze specjalnym formatowaniem. |
| [getFirstCol()](#getFirstCol--) | Określa, czy pierwsza kolumna tabeli ma być wyświetlana ze specjalnym formatowaniem. |
| [setFirstCol(boolean value)](#setFirstCol-boolean-) | Określa, czy pierwsza kolumna tabeli ma być wyświetlana ze specjalnym formatowaniem. |
| [getLastRow()](#getLastRow--) | Określa, czy ostatni wiersz tabeli ma być wyświetlany ze specjalnym formatowaniem. |
| [setLastRow(boolean value)](#setLastRow-boolean-) | Określa, czy ostatni wiersz tabeli ma być wyświetlany ze specjalnym formatowaniem. |
| [getLastCol()](#getLastCol--) | Określa, czy ostatnia kolumna tabeli ma być wyświetlana ze specjalnym formatowaniem. |
| [setLastCol(boolean value)](#setLastCol-boolean-) | Określa, czy ostatnia kolumna tabeli ma być wyświetlana ze specjalnym formatowaniem. |
| [getHorizontalBanding()](#getHorizontalBanding--) | Określa, czy parzyste wiersze mają być wyświetlane z innym formatowaniem. |
| [setHorizontalBanding(boolean value)](#setHorizontalBanding-boolean-) | Określa, czy parzyste wiersze mają być wyświetlane z innym formatowaniem. |
| [getVerticalBanding()](#getVerticalBanding--) | Określa, czy parzyste kolumny mają być wyświetlane z innym formatowaniem. |
| [setVerticalBanding(boolean value)](#setVerticalBanding-boolean-) | Określa, czy parzyste kolumny mają być wyświetlane z innym formatowaniem. |
| [setTextFormat(IPortionFormat source)](#setTextFormat-com.aspose.slides.IPortionFormat-) | Ustawia określone właściwości formatu części dla wszystkich części komórek tabeli. |
...
| [getFillFormat()](#getFillFormat--) | Zwraca obiekt TableFormat.FillFormat zawierający formatowanie wypełnienia tabeli. |
### get_Item(int columnIndex, int rowIndex) {#get-Item-int-int-}
```
public final ICell get_Item(int columnIndex, int rowIndex)
```

Zwraca komórkę o podanych indeksach kolumny i wiersza. Tylko do odczytu [Cell](../../com.aspose.slides/cell).
...
Określa, czy pierwszy wiersz tabeli ma być wyświetlany ze specjalnym formatowaniem. Odczyt/zapis  boolean .
...
Określa, czy pierwsza kolumna tabeli ma być wyświetlana ze specjalnym formatowaniem. Odczyt/zapis  boolean .
...
Określa, czy ostatni wiersz tabeli ma być wyświetlany ze specjalnym formatowaniem. Odczyt/zapis  boolean .
...
Określa, czy ostatnia kolumna tabeli ma być wyświetlana ze specjalnym formatowaniem. Odczyt/zapis  boolean .
...
Określa, czy parzyste wiersze mają być wyświetlane z innym formatowaniem. Odczyt/zapis  boolean .
...
Określa, czy parzyste kolumny mają być wyświetlane z innym formatowaniem. Odczyt/zapis  boolean .
...
Ustawia określone właściwości formatu części dla wszystkich części komórek tabeli.
...
Zwraca obiekt TableFormat.FillFormat zawierający formatowanie wypełnienia tabeli. Tylko do odczytu [IFillFormat](../../com.aspose.slides/ifillformat).
