...
| Metoda | Opis |
| --- | --- |
| [getImageSize()](#getImageSize--) | Określa rozmiar generowanego obrazu TIFF. |
| [setImageSize(Dimension value)](#setImageSize-java.awt.Dimension-) | Określa rozmiar generowanego obrazu TIFF. |
...
Określa rozmiar generowanego obrazu TIFF. Domyślna wartość to 0x0, co oznacza, że rozmiary generowanych obrazów będą obliczane na podstawie wartości rozmiaru slajdu prezentacji. Odczyt/zapis java.awt.Dimension.
...
Określa, czy wygenerowany dokument ma zawierać ukryte slajdy, czy nie. Domyślna wartość to false.
