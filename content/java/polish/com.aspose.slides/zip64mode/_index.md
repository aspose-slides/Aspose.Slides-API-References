...
Plik OpenXML jest archiwum ZIP, które ma limit 4 GB (2^32 bajtów) na nie skompresowany rozmiar pliku, skompresowany rozmiar pliku oraz łączny rozmiar archiwum, a także limit 65 535 (2^16-1) plików w archiwum. Rozszerzenia formatu ZIP64 zwiększają limity do 2^64.
## Pola

| Pole | Opis |
| --- | --- |
| [Never](#Never) | Nie używaj rozszerzeń formatu ZIP64. |
| [IfNecessary](#IfNecessary) | Użyj rozszerzeń formatu ZIP64, jeśli to konieczne. |
...
Użyj rozszerzeń formatu ZIP64, jeśli to konieczne.
