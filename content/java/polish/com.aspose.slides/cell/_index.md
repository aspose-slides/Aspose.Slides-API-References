...
| [getColSpan()](#getColSpan--) | Zwraca liczbę kolumn siatki tabeli nadrzędnej, które mają być objęte przez bieżącą komórkę. |
...
| [getTable()](#getTable--) | Zwraca obiekt Table będący rodzicem komórki. |
| [isMergedCell()](#isMergedCell--) | Zwraca true, jeśli komórka jest połączona z inną dostosowaną komórką, w przeciwnym razie false. |
...
| [getSlide()](#getSlide--) | Zwraca slajd nadrzędny komórki. |
| [getPresentation()](#getPresentation--) | Zwraca prezentację nadrzędną komórki. |
...
Zwraca liczbę kolumn siatki tabeli nadrzędnej, które mają być objęte przez bieżącą komórkę. To własność umożliwiająca efekt połączenia komórek, ponieważ obejmują one pionowe granice innych komórek w tabeli. Tylko do odczytu int.
...
Zwraca liczbę wierszy, które obejmuje połączona komórka. Używane w połączeniu z atrybutem vMerge innych komórek w celu określenia komórki początkowej poziomego połączenia. Tylko do odczytu int.
...
Zwraca obiekt Table będący rodzicem komórki. Tylko do odczytu [ITable](../../com.aspose.slides/itable).
...
Zwraca true, jeśli komórka jest połączona z inną dostosowaną komórką, w przeciwnym razie false. Tylko do odczytu boolean.
...
Zwraca slajd nadrzędny komórki. Tylko do odczytu [IBaseSlide](../../com.aspose.slides/ibaseslide).
...
Zwraca prezentację nadrzędną komórki. Tylko do odczytu [IPresentation](../../com.aspose.slides/ipresentation).
