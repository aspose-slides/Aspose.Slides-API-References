...
Zwraca lub ustawia typ predefiniowanej geometrii. Uwaga: przy zmianie wartości wszystkie wartości dopasowań zostaną zresetowane do ich wartości domyślnych. Odczyt/zapis [ShapeType](../../com.aspose.slides/shapetype).
