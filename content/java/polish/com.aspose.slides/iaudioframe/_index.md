...
| [getAudioCdStartTrackTime()](#getAudioCdStartTrackTime--) | Zwraca lub ustawia czas rozpoczęcia ścieżki. |
| [setAudioCdStartTrackTime(int value)](#setAudioCdStartTrackTime-int-) | Zwraca lub ustawia czas rozpoczęcia ścieżki. |
...
| [getAudioCdEndTrackTime()](#getAudioCdEndTrackTime--) | Zwraca lub ustawia czas końcowy ścieżki. |
| [setAudioCdEndTrackTime(int value)](#setAudioCdEndTrackTime-int-) | Zwraca lub ustawia czas końcowy ścieżki. |
...
| [getLinkPathLong()](#getLinkPathLong--) | Zwraca lub ustawia nazwę pliku audio powiązanego z AudioFrame. |
| [setLinkPathLong(String value)](#setLinkPathLong-java.lang.String-) | Zwraca lub ustawia nazwę pliku audio powiązanego z AudioFrame. |
...
| [getFadeInDuration()](#getFadeInDuration--) | Określa czas trwania początkowego wygaszenia mediów w milisekundach. |
| [setFadeInDuration(float value)](#setFadeInDuration-float-) | Określa czas trwania początkowego wygaszenia mediów w milisekundach. |
| [getFadeOutDuration()](#getFadeOutDuration--) | Określa czas trwania końcowego wygaszenia mediów w milisekundach. |
| [setFadeOutDuration(float value)](#setFadeOutDuration-float-) | Określa czas trwania końcowego wygaszenia mediów w milisekundach. |
...
| [getTrimFromStart()](#getTrimFromStart--) | Określa czas, który ma zostać usunięty od początku mediów podczas odtwarzania, w milisekundach. |
| [setTrimFromStart(float value)](#setTrimFromStart-float-) | Określa czas, który ma zostać usunięty od początku mediów podczas odtwarzania, w milisekundach. |
| [getTrimFromEnd()](#getTrimFromEnd--) | Określa czas, który ma zostać usunięty od końca mediów podczas odtwarzania, w milisekundach. |
| [setTrimFromEnd(float value)](#setTrimFromEnd-float-) | Określa czas, który ma zostać usunięty od końca mediów podczas odtwarzania, w milisekundach. |
| [getCaptionTracks()](#getCaptionTracks--) | Pobiera kolekcję zamkniętych napisów powiązanych z klatką audio. |
...
Zwraca lub ustawia czas rozpoczęcia ścieżki. Odczyt/zapis int.
...
Zwraca lub ustawia czas końcowy ścieżki. Odczyt/zapis int.
...
Zwraca lub ustawia nazwę pliku audio powiązanego z AudioFrame. Odczyt/zapis String.
...
Określa czas trwania początkowego wygaszenia mediów w milisekundach. Odczyt/zapis float.
...
>      // Ustaw czas trwania początkowego wygaszenia na 200ms
...
Określa czas trwania końcowego wygaszenia mediów w milisekundach. Odczyt/zapis float.
...
Określa czas, który ma zostać usunięty od początku mediów podczas odtwarzania, w milisekundach. Odczyt/zapis float.
...
>      IAudio audio = pres.getAudios().addAudio(audioStream, LoadingStreamBehavior.ReadStreamAndRelease);
>      IAudioFrame audioFrame = pres.getSlides().get_Item(0).getShapes().addAudioFrameEmbedded(50, 50, 100, 100, audio);
>      // Ustaw czas przycięcia początkowego na 1,5 sekundy
...
Określa czas, który ma zostać usunięty od końca mediów podczas odtwarzania, w milisekundach. Odczyt/zapis float.
...
>      IAudio audio = pres.getAudios().addAudio(audioStream, LoadingStreamBehavior.ReadStreamAndRelease);
>      IAudioFrame audioFrame = pres.getSlides().get_Item(0).getShapes().addAudioFrameEmbedded(50, 50, 100, 100, audio);
>      // Ustaw czas przycięcia końcowego na 2 sekundy
...
Pobiera kolekcję zamkniętych napisów powiązanych z klatką audio. Ta własność jest tylko do odczytu i zwraca [ICaptionsCollection](../../com.aspose.slides/icaptionscollection) zawierające wszystkie ścieżki napisów.
