...
| [add(IShape shapeTrigger)](#add-com.aspose.slides.IShape-) | Dodaj nową interaktywną sekwencję. |
...
Dodaj nową interaktywną sekwencję. Odczyt/zapis [Sequence](../../com.aspose.slides/sequence).
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks sekwencji, która ma zostać usunięta. |
### clear() {#clear--}
```
...
**Zwraca:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISequence> - IGenericEnumerator, który może być użyty do iteracji po kolekcji.
...
**Zwraca:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISequence> - Iterator java.util.Iterator dla całej kolekcji.