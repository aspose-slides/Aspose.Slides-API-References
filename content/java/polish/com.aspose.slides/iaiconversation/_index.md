...
| Metoda | Opis |
| --- | --- |
| [getResponse(String instruction)](#getResponse-java.lang.String-) | Wysyła wiadomość żądania konwersacji, uwzględniając cały kontekst i zwraca odpowiedź. |
### getResponse(String instruction) {#getResponse-java.lang.String-}
```
public abstract String getResponse(String instruction)
```

Wysyła wiadomość żądania konwersacji, uwzględniając cały kontekst i zwraca odpowiedź.
