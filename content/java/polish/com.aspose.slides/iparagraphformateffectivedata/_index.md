...
Ten interfejs jest używany razem z interfejsem [IParagraphFormat](../../com.aspose.slides/iparagraphformat) w celu zwrócenia efektywnych wartości formatowania z zastosowanym dziedziczeniem.
## Metody
...
| [getSpaceWithin()](#getSpaceWithin--) | Zwraca ilość odstępu pomiędzy liniami bazowymi w akapicie. |
...
| [getIndent()](#getIndent--) | Zwraca wcięcie pierwszej linii/ wieszające wcięcie akapitu. |
...
Zwraca ilość odstępu pomiędzy liniami bazowymi w akapicie. Tylko do odczytu float.
...
Określa, czy w akapicie używany jest podział linii wschodnioazjatycki. Tylko do odczytu boolean.
...
Określa, czy w akapicie używany jest podział linii łaciński. Tylko do odczytu boolean.
...
Zwraca wcięcie pierwszej linii/ wieszające wcięcie akapitu. Wieszające wcięcie może być określone wartościami ujemnymi. Tylko do odczytu float.
...
Zwraca domyślny format fragmentu akapitu. Tylko do odczytu [IPortionFormatEffectiveData](../../com.aspose.slides/iportionformateffectivedata).
