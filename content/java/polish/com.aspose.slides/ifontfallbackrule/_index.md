...
| Metoda | Opis |
| --- | --- |
| [addFallBackFonts(String fontName)](#addFallBackFonts-java.lang.String-) | Dodaje nową (nowe) czcionki do listy czcionek FallBack. |
...
| [getCount()](#getCount--) | Pobiera liczbę czcionek faktycznie zdefiniowanych dla zakresu. |
| [get_Item(int index)](#get-Item-int-) | Pobiera nazwę czcionki na określonym indeksie. |
...
| [removeAt(int index)](#removeAt-int-) | Usuwa czcionkę FallBack pod określonym indeksem z listy. |
...
Dodaje nową (nowe) czcionki do listy czcionek FallBack.
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| fontName | java.lang.String | Nazwa lub nazwy czcionki (oddzielone przecinkami) dla FallBack |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| fontNames | java.lang.String[] | Nazwa lub nazwy czcionki (oddzielone przecinkami) dla FallBack |
...
Pobiera liczbę czcionek faktycznie zdefiniowanych dla zakresu.
...
Pobiera nazwę czcionki na określonym indeksie.
...
Usuwa czcionkę FallBack pod określonym indeksem w liście.
...
> // Utwórz regułę zawierającą listę czcionek.
>  IFontFallBackRule newRule = new FontFallBackRule(0x3040, 0x309F, "MS Mincho, MS Gothic, Tahoma, Times New Roman");
>  //Pobierz ostatnie dwie nazwy czcionek jako tablicę
