...
| [setFrameSize(Dimension value)](#setFrameSize-java.awt.Dimension-) | Pobiera lub ustawia rozmiar klatki. |
...
| [getTransitionFps()](#getTransitionFps--) | Pobiera lub ustawia liczbę klatek na sekundę przejścia [frames/sec]. Domyślna wartość to 25. |
| [setTransitionFps(int value)](#setTransitionFps-int-) | Pobiera lub ustawia liczbę klatek na sekundę przejścia [frames/sec]. Domyślna wartość to 25. |
...
Pobiera lub ustawia liczbę klatek na sekundę przejścia [frames/sec]. Domyślna wartość to 25.
