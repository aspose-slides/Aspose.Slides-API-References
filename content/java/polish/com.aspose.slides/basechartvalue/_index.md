...
second_title: Odniesienie API Aspose.Slides dla Java
...
Określa, czy właściwość AsCell, AsCells, AsLiteralString lub AsLiteralDouble jest aktualna w klasach pochodnych. Inaczej określa typ wartości właściwości Data. Odczyt/zapis [DataSourceType](../../com.aspose.slides/datasourcetype).

--------------------

Dla punktów w ChartDataPointCollection ta właściwość jest tylko do odczytu. W takim przypadku, aby zmienić wartość tej właściwości, można użyć jednej z właściwości ChartDataPointCollection.DataSourceTypeFor<...>.
