...
| [addChart(int type, float x, float y, float width, float height)](#addChart-int-float-float-float-float-) | Tworzy nowy chart, inicjalizuje go przykładowymi danymi serii i ustawieniami oraz dodaje go na koniec kolekcji kształtów. |
| [addChart(int type, float x, float y, float width, float height, boolean initWithSample)](#addChart-int-float-float-float-float-boolean-) | Tworzy nowy chart, inicjalizuje go przykładowymi danymi serii i ustawieniami oraz dodaje go na koniec kolekcji kształtów. |
| [addSmartArt(float x, float y, float width, float height, int layoutType)](#addSmartArt-float-float-float-float-int-) | Tworzy nowy diagram SmartArt i dodaje go na koniec kolekcji kształtów. |
| [insertChart(int type, float x, float y, float width, float height, int index)](#insertChart-int-float-float-float-float-int-) | Tworzy nowy chart, inicjalizuje go przykładowymi danymi serii i ustawieniami oraz wstawia go do kolekcji kształtów pod wskazanym indeksem. |
| [insertChart(int type, float x, float y, float width, float height, int index, boolean initWithSample)](#insertChart-int-float-float-float-float-int-boolean-) | Tworzy nowy chart, inicjalizuje go przykładowymi danymi serii i ustawieniami oraz wstawia go do kolekcji kształtów pod wskazanym indeksem. |
...
| [insertZoomFrame(int index, float x, float y, float width, float height, ISlide slide)](#insertZoomFrame-int-float-float-float-float-com.aspose.slides.ISlide-) | Tworzy nową ramkę Zoom i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
| [insertZoomFrame(int index, float x, float y, float width, float height, ISlide slide, IPPImage image)](#insertZoomFrame-int-float-float-float-float-com.aspose.slides.ISlide-com.aspose.slides.IPPImage-) | Tworzy nową ramkę Zoom z zdefiniowanym obrazem i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
...
| [addSectionZoomFrame(float x, float y, float width, float height, ISection section, IPPImage image)](#addSectionZoomFrame-float-float-float-float-com.aspose.slides.ISection-com.aspose.slides.IPPImage-) | Tworzy nową ramkę Zoom sekcji z zdefiniowanym obrazem i dodaje ją na koniec kolekcji kształtów. |
| [insertSectionZoomFrame(int index, float x, float y, float width, float height, ISection section)](#insertSectionZoomFrame-int-float-float-float-float-com.aspose.slides.ISection-) | Tworzy nową ramkę Zoom sekcji i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
| [insertSectionZoomFrame(int index, float x, float y, float width, float height, ISection section, IPPImage image)](#insertSectionZoomFrame-int-float-float-float-float-com.aspose.slides.ISection-com.aspose.slides.IPPImage-) | Tworzy nową ramkę Zoom sekcji z zdefiniowanym obrazem i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
...
| [insertSummaryZoomFrame(int index, float x, float y, float width, float height)](#insertSummaryZoomFrame-int-float-float-float-float-) | Tworzy nową ramkę Zoom podsumowania i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
...
| [insertOleObjectFrame(int index, float x, float y, float width, float height, IOleEmbeddedDataInfo dataInfo)](#insertOleObjectFrame-int-float-float-float-float-com.aspose.slides.IOleEmbeddedDataInfo-) | Tworzy nową ramkę obiektu OLE i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
| [insertOleObjectFrame(int index, float x, float y, float width, float height, String className, String path)](#insertOleObjectFrame-int-float-float-float-float-java.lang.String-java.lang.String-) | Tworzy nową ramkę obiektu OLE i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
...
| [insertVideoFrame(int index, float x, float y, float width, float height, String fname)](#insertVideoFrame-int-float-float-float-float-java.lang.String-) | Tworzy nową ramkę wideo i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
...
| [insertAudioFrameCD(int index, float x, float y, float width, float height)](#insertAudioFrameCD-int-float-float-float-float-) | Tworzy nową ramkę audio powiązaną z utworem CD i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
...
| [insertAudioFrameLinked(int index, float x, float y, float width, float height, String fname)](#insertAudioFrameLinked-int-float-float-float-float-java.lang.String-) | Tworzy nową ramkę audio powiązaną z zewnętrznym plikiem audio i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
...
| [insertAudioFrameEmbedded(int index, float x, float y, float width, float height, InputStream audio_stream)](#insertAudioFrameEmbedded-int-float-float-float-float-java.io.InputStream-) | Tworzy nową ramkę audio z osadzonym plikiem WAV i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
...
| [insertAudioFrameEmbedded(int index, float x, float y, float width, float height, IAudio audio)](#insertAudioFrameEmbedded-int-float-float-float-float-com.aspose.slides.IAudio-) | Tworzy nową ramkę audio i wstawia ją do kolekcji kształtów pod wskazanym indeksem, używając istniejącego obiektu audio z listy Presentation.Audios. |
| [indexOf(IShape shape)](#indexOf-com.aspose.slides.IShape-) | Zwraca indeks zerowy pierwszego wystąpienia określonego kształtu w kolekcji. |
...
| [reorder(int index, IShape shape)](#reorder-int-com.aspose.slides.IShape-) | Przesuwa określony kształt na nową pozycję w kolekcji kształtów. |
| [reorder(int index, IShape[] shapes)](#reorder-int-com.aspose.slides.IShape...-) | Przesuwa określone kształty w kolekcji kształtów, umieszczając je począwszy od podanego indeksu. |
| [addAutoShape(int shapeType, float x, float y, float width, float height)](#addAutoShape-int-float-float-float-float-) | Tworzy nowy auto shape z domyślnym formatowaniem i dodaje go na koniec kolekcji kształtów. |
| [addAutoShape(int shapeType, float x, float y, float width, float height, boolean createFromTemplate)](#addAutoShape-int-float-float-float-float-boolean-) | Tworzy nowy auto shape i dodaje go na koniec kolekcji kształtów, opcjonalnie inicjalizując go domyślnym formatowaniem szablonu. |
| [addMathShape(float x, float y, float width, float height)](#addMathShape-float-float-float-float-) | Tworzy nowy prostokątny auto shape do hostowania treści matematycznych i dodaje go na koniec kolekcji kształtów. |
| [insertAutoShape(int index, int shapeType, float x, float y, float width, float height)](#insertAutoShape-int-int-float-float-float-float-) | Tworzy nowy auto shape i wstawia go do kolekcji kształtów pod wskazanym indeksem, stosując domyślne formatowanie szablonu. |
| [insertAutoShape(int index, int shapeType, float x, float y, float width, float height, boolean createFromTemplate)](#insertAutoShape-int-int-float-float-float-float-boolean-) | Tworzy nowy auto shape i wstawia go do kolekcji kształtów pod wskazanym indeksem, opcjonalnie inicjalizując go domyślnym stylem szablonu. |
| [addGroupShape()](#addGroupShape--) | Tworzy nową pustą grupę kształtów i dodaje ją na koniec kolekcji kształtów. |
| [addGroupShape(ISvgImage svgImage, float x, float y, float width, float height)](#addGroupShape-com.aspose.slides.ISvgImage-float-float-float-float-) | Tworzy nową grupę kształtów, konwertuje podany obraz SVG na poszczególne kształty i dodaje wynikową grupę na koniec kolekcji kształtów. |
| [insertGroupShape(int index)](#insertGroupShape-int-) | Tworzy nową pustą grupę kształtów i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
| [addConnector(int shapeType, float x, float y, float width, float height)](#addConnector-int-float-float-float-float-) | Tworzy nowy łącznik z domyślnym stylem szablonu i dodaje go na koniec kolekcji kształtów. |
| [addConnector(int shapeType, float x, float y, float width, float height, boolean createFromTemplate)](#addConnector-int-float-float-float-float-boolean-) | Tworzy nowy łącznik i dodaje go na koniec kolekcji kształtów, opcjonalnie stosując domyślny styl szablonu. |
| [insertConnector(int index, int shapeType, float x, float y, float width, float height)](#insertConnector-int-int-float-float-float-float-) | Tworzy nowy łącznik i wstawia go do kolekcji kształtów pod wskazanym indeksem, stosując domyślny styl szablonu. |
| [insertConnector(int index, int shapeType, float x, float y, float width, float height, boolean createFromTemplate)](#insertConnector-int-int-float-float-float-float-boolean-) | Tworzy nowy łącznik i wstawia go do kolekcji kształtów pod wskazanym indeksem, opcjonalnie stosując domyślny styl szablonu. |
...
| [insertPictureFrame(int index, int shapeType, float x, float y, float width, float height, IPPImage image)](#insertPictureFrame-int-int-float-float-float-float-com.aspose.slides.IPPImage-) | Tworzy nową ramkę obrazu zawierającą podany obraz i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
...
| [insertTable(int index, float x, float y, double[] columnWidths, double[] rowHeights)](#insertTable-int-float-float-double---double---) | Tworzy nową tabelę i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
| [removeAt(int index)](#removeAt-int-) | Usuwa kształt pod wskazanym indeksem z kolekcji kształtów. |
...
| [getParentGroup()](#getParentGroup--) | Zwraca obiekt grupy rodzica dla kolekcji kształtów. |
...
| [insertClone(int index, IShape sourceShape, float x, float y, float width, float height)](#insertClone-int-com.aspose.slides.IShape-float-float-float-float-) | Tworzy kopię określonego kształtu i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
| [insertClone(int index, IShape sourceShape, float x, float y)](#insertClone-int-com.aspose.slides.IShape-float-float-) | Tworzy kopię określonego kształtu i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
| [insertClone(int index, IShape sourceShape)](#insertClone-int-com.aspose.slides.IShape-) | Tworzy kopię określonego kształtu i wstawia ją do kolekcji kształtów pod wskazanym indeksem. |
...
Tworzy nowy chart, inicjalizuje go przykładowymi danymi serii i ustawieniami oraz dodaje go na koniec kolekcji kształtów.
...
>      // Dodaje wykres wraz z domyślnymi danymi
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| type | int | Typ chartu do dodania. |
| x | float | Współrzędna x nowego chartu, w punktach. |
| y | float | Współrzędna y nowego chartu, w punktach. |
| width | float | Szerokość chartu, w punktach. |
| height | float | Wysokość chartu, w punktach. |
...
| width | float | Szerokość chartu, w punktach. |
| height | float | Wysokość chartu, w punktach. |
| initWithSample | boolean | True, aby zainicjować nowy chart przykładowymi danymi serii i ustawieniami; false, aby utworzyć chart bez serii i z minimalnym ustawieniem, co przyspiesza tworzenie. |
...
Tworzy nowy chart, inicjalizuje go przykładowymi danymi serii i ustawieniami oraz wstawia go do kolekcji kształtów pod wskazanym indeksem.

**Parametry:**
| Parametr | Typ | Opis |
| --- | --- | --- |
| type | int | Typ chartu do utworzenia. |
| x | float | Współrzędna x nowego chartu, w punktach. |
| y | float | Współrzędna y nowego chartu, w punktach. |
| width | float | Szerokość nowego chartu, w punktach. |
| height | float | Wysokość nowego chartu, w punktach. |
| index | int | Indeks zerowy, pod którym wstawić nowy chart w kolekcji kształtów. |
...
| index | int | Indeks zero-bazowy, w którym należy wstawić nowy wykres w kolekcji kształtów. |
| initWithSample | boolean | true, aby zainicjować nowy wykres z przykładowymi danymi serii i ustawieniami; false, aby utworzyć wykres bez serii i jedynie z minimalnymi ustawieniami, co przyspiesza tworzenie. |
...
>  (zakładając, że w prezentacji "Presentation.pptx" jest co najmniej dwa slajdy):
>  
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks zero-bazowy, w którym należy wstawić ramkę Zoom. |
| x | float | Współrzędna x nowej ramki Zoom, w punktach. |
| y | float | Współrzędna y nowej ramki Zoom, w punktach. |
| width | float | Szerokość nowej ramki Zoom, w punktach. |
| height | float | Wysokość nowej ramki Zoom, w punktach. |
...
> ```
> Ten przykład demonstruje tworzenie i wstawianie obiektu Zoom w określonym indeksie kolekcji
>  (zakładając, że w prezentacji "Presentation.pptx" jest co najmniej dwa slajdy):
>  
>  Presentation pres = new Presentation("Presentation.pptx");
>  try {
...
>  (zakładając, że w prezentacji "Presentation.pptx" jest co najmniej dwie sekcje):
>  
>  Presentation pres = new Presentation("Presentation.pptx");
>  try {
...
Tworzy nową ramkę Zoom sekcji i wstawia ją do kolekcji kształtów w określonym indeksie.

--------------------

> ```
> Ten przykład demonstruje tworzenie i wstawianie obiektu Section Zoom w określonym indeksie kolekcji
>  (zakładając, że w prezentacji "Presentation.pptx" jest co najmniej dwie sekcje):
>  
>  Presentation pres = new Presentation("Presentation.pptx");
>  try {
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks zero-bazowy, w którym należy wstawić ramkę Zoom sekcji. |
| x | float | Współrzędna x nowej ramki Zoom sekcji, w punktach. |
| y | float | Współrzędna y nowej ramki Zoom sekcji, w punktach. |
| width | float | Szerokość nowej ramki Zoom sekcji, w punktach. |
| height | float | Wysokość nowej ramki Zoom sekcji, w punktach. |
...
Tworzy nową ramkę Zoom sekcji z predefiniowanym obrazem i wstawia ją do kolekcji kształtów w określonym indeksie.
...
Ta metoda tworzy nowe podsumowanie Zoom i umieszcza w nim kolekcję obiektów dla wszystkich sekcji w tej prezentacji. |
...
Tworzy nową ramkę Zoom podsumowania i wstawia ją do kolekcji kształtów w określonym indeksie.

--------------------

> ```
> Ten przykład demonstruje tworzenie i wstawianie obiektu Summary Zoom w określonym indeksie kolekcji
>  (zakładając, że w prezentacji "Presentation.pptx" są co najmniej dwie sekcje):
>  
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks zero-bazowy, w którym należy wstawić ramkę Zoom podsumowania. |
| x | float | Współrzędna x nowej ramki Zoom podsumowania, w punktach. |
| y | float | Współrzędna y nowej ramki Zoom podsumowania, w punktach. |
| width | float | Szerokość nowej ramki Zoom podsumowania, w punktach. |
| height | float | Wysokość nowej ramki Zoom podsumowania, w punktach. |
...
> 
>      // Dodaje kształt Ole Object Frame
...
> ```
> Ten przykład demonstruje wstawianie obiektu OLE na drugim indeksie:
>  
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks zero-bazowy, w którym należy wstawić ramkę obiektu OLE. |
| x | float | Współrzędna x nowej ramki OLE, w punktach. |
| y | float | Współrzędna y nowej ramki OLE, w punktach. |
| width | float | Szerokość nowej ramki OLE, w punktach. |
| height | float | Wysokość nowej ramki OLE, w punktach. |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks zerowy, w którym wstawia się ramkę obiektu OLE. |
| x | float | Współrzędna x nowej ramki OLE, w punktach. |
| y | float | Współrzędna y nowej ramki OLE, w punktach. |
| width | float | Szerokość nowej ramki OLE, w punktach. |
| height | float | Wysokość nowej ramki OLE, w punktach. |
| className | java.lang.String | Nazwa klasy obiektu OLE. |
| path | java.lang.String | Ścieżka do połączonego pliku. |

Ta ścieżka jest przechowywana w dokładnej formie w prezentacji. Jeśli podana jest ścieżka względna, plik będzie niedostępny przy otwieraniu prezentacji z innego katalogu.

**Zwraca:**
[IOleObjectFrame](../../com.aspose.slides/ioleobjectframe) - Nowo utworzona ramka obiektu OLE.
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks zerowy, w którym wstawia się ramkę wideo. |
| x | float | Współrzędna x nowej ramki wideo, w punktach. |
| y | float | Współrzędna y nowej ramki wideo, w punktach. |
| width | float | Szerokość nowej ramki wideo, w punktach. |
| height | float | Wysokość nowej ramki wideo, w punktach. |
...
**Zwraca:**
[IAudioFrame](../../com.aspose.slides/iaudioframe) - Nowo utworzona [IAudioFrame](../../com.aspose.slides/iaudioframe).
### insertAudioFrameCD(int index, float x, float y, float width, float height) {#insertAudioFrameCD-int-float-float-float-float-}
```
public final IAudioFrame insertAudioFrameCD(int index, float x, float y, float width, float height)
```

Tworzy nową ramkę audio powiązaną z ścieżką CD i wstawia ją do kolekcji kształtów w określonym indeksie.

**Parametry:**
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks zerowy, w którym wstawia się ramkę audio. |
| x | float | Współrzędna x nowej ramki audio, w punktach. |
| y | float | Współrzędna y nowej ramki audio, w punktach. |
| width | float | Szerokość nowej ramki audio, w punktach. |
| height | float | Wysokość nowej ramki audio, w punktach. |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | Kształt do odnalezienia w kolekcji. |

**Zwraca:**
int - Indeks zerowy pierwszego wystąpienia kształtu w kolekcji kształtów, jeśli znaleziono; w przeciwnym razie \\u20131.
### toArray() {#toArray--}
```
...
Przesuwa określony kształt na nową pozycję w kolekcji kształtów.

**Parametry:**
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks zerowy docelowy, w którym kształt zostanie umieszczony. |
...
Przesuwa określone kształty w kolekcji kształtów, umieszczając je zaczynając od podanego indeksu.

**Parametry:**
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks zerowy docelowy, w którym zostanie umieszczony pierwszy określony kształt; kolejne kształty będą umieszczane w podanej kolejności. |
| shapes | [IShape\[\]](../../com.aspose.slides/ishape) | Jedna lub więcej [IShape](../../com.aspose.slides/ishape) instancji do przeniesienia w ramach zbioru. |
...
| --- | --- | --- |
| shapeType | int | [ShapeType](../../com.aspose.slides/shapetype) auto shape do dodania. |
...
| width | float | Szerokość ramki kształtu, w punktach. |
| height | float | Wysokość ramki kształtu, w punktach. |
| createFromTemplate | boolean | Prawda, aby zastosować domyślne formatowanie szablonu (prosty styl, wyśrodkowany tekst i niepustą nazwę) do nowego kształtu; fałsz, aby utworzyć kształt ze wszystkimi właściwościami ustawionymi na wartości domyślne. |
...
| shapeType | int | [ShapeType](../../com.aspose.slides/shapetype) auto shape do wstawienia. |
| x | float | Współrzędna x ramki kształtu, w punktach. |
| y | float | Współrzędna y ramki kształtu, w punktach. |
| width | float | Szerokość ramki kształtu, w punktach. |
| height | float | Wysokość ramki kształtu, w punktach. |
...
| width | float | Szerokość ramki kształtu, w punktach. |
| height | float | Wysokość ramki kształtu, w punktach. |
| createFromTemplate | boolean | Prawda, aby zastosować domyślne formatowanie szablonu (w tym niepustą nazwę, prosty styl i wyśrodkowany tekst); fałsz, aby utworzyć kształt ze wszystkimi właściwościami ustawionymi na wartości domyślne. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| index | int | Indeks zerowy, pod którym wstawić kształt grupy. |
...
| width | float | Szerokość ramki łącznika, w punktach. |
| height | float | Wysokość ramki łącznika, w punktach. |
| createFromTemplate | boolean | Prawda, aby zastosować domyślne formatowanie szablonu (niepusta nazwa, prosty styl); fałsz, aby utworzyć łącznik z domyślnymi wartościami właściwości. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| index | int | Indeks zerowy, pod którym wstawić łącznik. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| shapeType | int | Określa typ kształtu zawarty w [ShapeType](../../com.aspose.slides/shapetype), z wyłączeniem wszystkich rodzajów linii:
...
| Parameter | Type | Description |
| --- | --- | --- |
| index | int | Indeks zerowy, pod którym wstawić ramkę obrazu. |
| shapeType | int | Określa typ kształtu zawarty w [ShapeType](../../com.aspose.slides/shapetype), z wyłączeniem wszystkich rodzajów linii:
...
>      ISlide sld = pres.getSlides().get_Item(0);
> 
>      // Definiuje kolumny o podanej szerokości oraz wiersze o podanej wysokości
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks bazujący na zerze, w którym wstawiona zostanie tabela. |
| x | float | Współrzędna x tabeli, w punktach. |
| y | float | Współrzędna y tabeli, w punktach. |
| columnWidths | double[] | Tablica liczb typu double określająca szerokości kolumn tabeli, w punktach. |
| rowHeights | double[] | Tablica liczb typu double określająca wysokości wierszy tabeli, w punktach. |
...
**Zwraca:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IShape> - IGenericEnumerator, który może być użyty do iteracji po kolekcji.
...
```
Tworzy kopię określonego kształtu i dodaje ją na koniec kolekcji kształtów. Nowy kształt zachowuje szerokość i wysokość shape sourceShape.
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks (liczony od zera), pod którym wstawiany jest sklonowany kształt. |
| sourceShape | [IShape](../../com.aspose.slides/ishape) | Obiekt [IShape](../../com.aspose.slides/ishape) do sklonowania. |
...
Tworzy kopię określonego kształtu i wstawia ją do kolekcji kształtów pod wskazanym indeksem. Nowy kształt zachowuje szerokość i wysokość shape sourceShape.
