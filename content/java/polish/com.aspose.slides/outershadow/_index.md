...
type: docs
url: /pl/com.aspose.slides/outershadow/
---
**Dziedziczenie:**
java.lang.Object
...
| [getSkewHorizontal()](#getSkewHorizontal--) | Kąt pochylenia poziomego, w stopniach. |
| [setSkewHorizontal(double value)](#setSkewHorizontal-double-) | Kąt pochylenia poziomego, w stopniach. |
| [getSkewVertical()](#getSkewVertical--) | Kąt pochylenia pionowego, w stopniach. |
| [setSkewVertical(double value)](#setSkewVertical-double-) | Kąt pochylenia pionowego, w stopniach. |
...
| [getScaleHorizontal()](#getScaleHorizontal--) | Poziomy współczynnik skalowania, w procentach pierwotnego rozmiaru. |
| [setScaleHorizontal(double value)](#setScaleHorizontal-double-) | Poziomy współczynnik skalowania, w procentach pierwotnego rozmiaru. |
| [getScaleVertical()](#getScaleVertical--) | Pionowy współczynnik skalowania, w procentach pierwotnego rozmiaru. |
| [setScaleVertical(double value)](#setScaleVertical-double-) | Pionowy współczynnik skalowania, w procentach pierwotnego rozmiaru. |
| [getEffective()](#getEffective--) | Pobiera skuteczne dane efektu zewnętrznego cienia z uwzględnionym dziedziczeniem. |
| [getParent_Immediate()](#getParent-Immediate--) |  |
| [getVersion()](#getVersion--) |  |
| [getParent_IPresentationComponent()](#getParent-IPresentationComponent--) |  |
| [equals(Object obj)](#equals-java.lang.Object-) | Określa, czy podany [OuterShadow](../../com.aspose.slides/outershadow) jest równy bieżącemu [OuterShadow](../../com.aspose.slides/outershadow). |
...
Kierunek cienia, w stopniach. Domyślna wartość - 0 � (od lewej do prawej). Odczyt/zapis float.
...
Kolor cienia. Domyślna wartość - automatyczna czerń (zależna od motywu). Tylko do odczytu [IColorFormat](../../com.aspose.slides/icolorformat).
...
Kąt pochylenia poziomego, w stopniach. Domyślna wartość - 0 �. Odczyt/zapis double.
...
Kąt pochylenia pionowego, w stopniach. Domyślna wartość - 0 �. Odczyt/zapis double.
...
Poziomy współczynnik skalowania, w procentach pierwotnego rozmiaru. Ujemne skalowanie powoduje odbicie. Domyślna wartość - 100 %. Odczyt/zapis double.
...
Pionowy współczynnik skalowania, w procentach pierwotnego rozmiaru. Ujemne skalowanie powoduje odbicie. Domyślna wartość - 100 %. Odczyt/zapis double.
...
Pobiera skuteczne dane efektu zewnętrznego cienia z uwzględnionym dziedziczeniem.
...
Określa, czy podany [OuterShadow](../../com.aspose.slides/outershadow) jest równy bieżącemu [OuterShadow](../../com.aspose.slides/outershadow).

**Parametry:**
| Parametr | Typ | Opis |
| --- | --- | --- |
| obj | java.lang.Object | [OuterShadow](../../com.aspose.slides/outershadow) do porównania. |
