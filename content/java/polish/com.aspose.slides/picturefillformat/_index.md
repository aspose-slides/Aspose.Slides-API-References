...
| [getDpi()](#getDpi--) | Zwraca lub ustawia dpi używany do wypełniania obrazem. |
| [setDpi(int value)](#setDpi-int-) | Zwraca lub ustawia dpi używany do wypełniania obrazem. |
| [getPictureFillMode()](#getPictureFillMode--) | Zwraca lub ustawia tryb wypełnienia obrazem. |
| [setPictureFillMode(int value)](#setPictureFillMode-int-) | Zwraca lub ustawia tryb wypełnienia obrazem. |
...
| [compressImage(boolean deleteCroppedAreasOfImage, int resolution)](#compressImage-boolean-int-) | Kompresuje obraz poprzez zmniejszenie jego rozmiaru na podstawie rozmiaru kształtu i określonej rozdzielczości. |
| [compressImage(boolean deleteCroppedAreasOfImage, float resolution)](#compressImage-boolean-float-) | Kompresuje obraz poprzez zmniejszenie jego rozmiaru na podstawie rozmiaru kształtu i określonej rozdzielczości. |
| [getStretchOffsetLeft()](#getStretchOffsetLeft--) | Zwraca lub ustawia lewą krawędź prostokąta wypełnienia, definiowaną jako procentowy offset od lewej krawędzi ramki ograniczającej kształt. |
| [setStretchOffsetLeft(float value)](#setStretchOffsetLeft-float-) | Zwraca lub ustawia lewą krawędź prostokąta wypełnienia, definiowaną jako procentowy offset od lewej krawędzi ramki ograniczającej kształt. |
| [getStretchOffsetTop()](#getStretchOffsetTop--) | Zwraca lub ustawia górną krawędź prostokąta wypełnienia, definiowaną jako procentowy offset od górnej krawędzi ramki ograniczającej kształt. |
| [setStretchOffsetTop(float value)](#setStretchOffsetTop-float-) | Zwraca lub ustawia górną krawędź prostokąta wypełnienia, definiowaną jako procentowy offset od górnej krawędzi ramki ograniczającej kształt. |
| [getStretchOffsetRight()](#getStretchOffsetRight--) | Zwraca lub ustawia prawą krawędź prostokąta wypełnienia, definiowaną jako procentowy offset od prawej krawędzi ramki ograniczającej kształt. |
| [setStretchOffsetRight(float value)](#setStretchOffsetRight-float-) | Zwraca lub ustawia prawą krawędź prostokąta wypełnienia, definiowaną jako procentowy offset od prawej krawędzi ramki ograniczającej kształt. |
| [getStretchOffsetBottom()](#getStretchOffsetBottom--) | Zwraca lub ustawia dolną krawędź prostokąta wypełnienia, definiowaną jako procentowy offset od dolnej krawędzi ramki ograniczającej kształt. |
| [setStretchOffsetBottom(float value)](#setStretchOffsetBottom-float-) | Zwraca lub ustawia dolną krawędź prostokąta wypełnienia, definiowaną jako procentowy offset od dolnej krawędzi ramki ograniczającej kształt. |
| [getTileOffsetX()](#getTileOffsetX--) | Zwraca lub ustawia poziomy offset tekstury od pochodzenia kształtu w punktach. |
| [setTileOffsetX(float value)](#setTileOffsetX-float-) | Zwraca lub ustawia poziomy offset tekstury od pochodzenia kształtu w punktach. |
| [getTileOffsetY()](#getTileOffsetY--) | Zwraca lub ustawia pionowy offset tekstury od pochodzenia kształtu w punktach. |
| [setTileOffsetY(float value)](#setTileOffsetY-float-) | Zwraca lub ustawia pionowy offset tekstury od pochodzenia kształtu w punktach. |
...
| [getTileFlip()](#getTileFlip--) | Odwraca kafelek tekstury wzdłuż osi poziomej, pionowej lub obu. |
| [setTileFlip(int value)](#setTileFlip-int-) | Odwraca kafelek tekstury wzdłuż osi poziomej, pionowej lub obu. |
### getVersion() {#getVersion--}
```
...
Zwraca lub ustawia dpi używany do wypełniania obrazem. Odczyt/zapis int .
...
Zwraca lub ustawia tryb wypełnienia obrazem. Odczyt/zapis [PictureFillMode](../../com.aspose.slides/picturefillmode).
...
**Zwraca:**
[IPPImage](../../com.aspose.slides/ippimage) - Obraz przycięty lub oryginalny, jeśli przycinanie nie jest konieczne.
...
Kompresuje obraz poprzez zmniejszenie jego rozmiaru na podstawie rozmiaru kształtu i określonej rozdzielczości. Opcjonalnie usuwa także przycięte obszary.
...
> CompressImage
> ``` metoda zmniejszająca rozmiar obrazu w prezentacji poprzez ustawienie docelowej rozdzielczości i usunięcie przyciętych obszarów:
>  
>  Presentation presentation = new Presentation("demo.pptx");
>  try {
>      ISlide slide = presentation.getSlides().get_Item(0);
...
> ```
> Poniższy przykład pokazuje, jak użyć ```
> CompressImage
> ```
 metody do zmniejszenia rozmiaru obrazu w prezentacji poprzez ustawienie docelowej rozdzielczości i usunięcie przyciętych obszarów:
>   
>  Presentation presentation = new Presentation("demo.pptx");
>  try {
>      ISlide slide = presentation.getSlides().get_Item(0);
