...
| [removeAt(int index)](#removeAt-int-) | Usuwa element podanym indeksie. |
...
Jeśli kolekcja już zawiera punkt danych o podanym indeksie, zwraca ten punkt danych. Jeśli kolekcja nie zawiera punktu danych o indeksie index==N (gdy liczba punktów danych w kolekcji jest mniejsza lub równa N), dodaje brakujące punkty danych i zwraca ostatni (który ma żądany indeks). Przykład: indeksy kolekcji to {0, 1, 2}, żądany indeks to 5. Wtedy metoda dodaje brakujące punkty: {0, 1, 2, 3, 4, 5} i zwraca punkt danych z indeksem 5.
...
**Zwraca:**  
[IChartDataPoint](../../com.aspose.slides/ichartdatapoint) – zwraca punkt danych z żądanym indeksem.
...
**Zwraca:**  
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IChartDataPoint> – iterator umożliwiający przeglądanie kolekcji.
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Ma zastosowanie do serii, których typ wykresu jest jednym z podtypów Stock (zobacz także metodę [ChartTypeCharacterizer.isChartTypeStock(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeStock-int-)).
...
```
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, której chartType jest jednym z podtypów Stock (zobacz także metodę [ChartTypeCharacterizer.isChartTypeStock(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeStock-int-)).
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, której chartType jest jednym z podtypów Line (zobacz także metodę [ChartTypeCharacterizer.isChartTypeLine(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeLine-int-)).
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, której chartType jest jednym z podtypów Scatter (zobacz także metodę [ChartTypeCharacterizer.isChartTypeScatter(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeScatter-int-)).
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, której chartType jest jednym z podtypów Radar (zobacz także metodę [ChartTypeCharacterizer.isChartTypeRadar(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeRadar-int-)).
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, której chartType jest jednym z podtypów Column lub Bar (zobacz także metodę [ChartTypeCharacterizer.isChartTypeColumn(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeColumn-int-) i [ChartTypeCharacterizer.isChartTypeBar(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeBar-int-)).
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, której chartType jest jednym z podtypów Area (zobacz także metodę [ChartTypeCharacterizer.isChartTypeArea(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeArea-int-)).
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, której chartType jest jednym z podtypów Pie (zobacz także metodę [ChartTypeCharacterizer.isChartTypePie(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypePie-int-)).
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, której chartType jest jednym z podtypów Doughnut (zobacz także metodę [ChartTypeCharacterizer.isChartTypeDoughnut(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeDoughnut-int-)).
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, której chartType jest jednym z podtypów Bubble (zobacz także metodę [ChartTypeCharacterizer.isChartTypeBubble(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeBubble-int-)).
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| xValue | java.lang.String | Wartość X punktu danych |
| yValue | double | Wartość Y punktu danych |
| bubbleSize | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Wartość BubbleSize punktu danych |
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, których chartType jest jednym z podtypów Bubble (zobacz także metodę [ChartTypeCharacterizer.isChartTypeBubble(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeBubble-int-)).

**Parametry:**
| Parametr | Typ | Opis |
| --- | --- | --- |
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Wartość X punktu danych |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Wartość Y punktu danych |
| bubbleSize | double | Wartość BubbleSize punktu danych |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| xValue | double | Wartość X punktu danych |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Wartość Y punktu danych |
| bubbleSize | double | Wartość BubbleSize punktu danych |
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, których chartType jest jednym z podtypów Surface (zobacz także metodę [ChartTypeCharacterizer.isChartTypeSurface(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeSurface-int-)).
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| sizeValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Wartość SizeValue punktu danych |
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, których typ wykresu to Waterfall.
...
Tworzy nowy punkt danych i dodaje go na koniec kolekcji. Dotyczy serii, których typ wykresu to Histogram.
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| value | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Wartość ColorValue punktu danych |
