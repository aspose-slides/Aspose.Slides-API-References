---
title: IControl
second_title: Odnośnik API Aspose.Slides dla Javy
...
| [getActiveXControlBinary()](#getActiveXControlBinary--) | Określa trwałość kontrolki ActiveX, gdy metodą zapisu jest PersistStream, PersistStreamInit lub PersistStorage. |
### getName() {#getName--}
```
...
Określa trwałość kontrolki ActiveX, gdy metodą zapisu jest PersistStream, PersistStreamInit lub PersistStorage.
