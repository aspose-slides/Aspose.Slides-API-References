...
description: Udostępnia metody ułatwiające wyszukiwanie kształtów i tekstu w prezentacji.
type: docs
...
| [alignShapes(int alignmentType, boolean alignToSlide, IGroupShape groupShape)](#alignShapes-int-boolean-com.aspose.slides.IGroupShape-) | Zmienia położenie wszystkich kształtów w obrębie grupy kształtów. |
| [alignShapes(int alignmentType, boolean alignToSlide, IGroupShape groupShape, int[] shapeIndexes)](#alignShapes-int-boolean-com.aspose.slides.IGroupShape-int---) | Zmienia położenie wybranych kształtów w obrębie grupy kształtów. |
| [findAndReplaceText(IPresentation presentation, boolean withMasters, String find, String replace)](#findAndReplaceText-com.aspose.slides.IPresentation-boolean-java.lang.String-java.lang.String-) | Znajduje i zamienia tekst w prezentacji przy użyciu podanego formatu. |
| [findAndReplaceText(IPresentation presentation, boolean withMasters, String find, String replace, PortionFormat format)](#findAndReplaceText-com.aspose.slides.IPresentation-boolean-java.lang.String-java.lang.String-com.aspose.slides.PortionFormat-) | Znajduje i zamienia tekst w prezentacji przy użyciu podanego formatu. |
...
**Zwraca:**
[IShape](../../com.aspose.slides/ishape) - Shape lub null.
...
| placeholderType | byte | Typ placeholdera, według którego filtrowane są kształt. |
...
Zmienia położenie wszystkich kształtów na slajdzie. Ustawia kształty względem marginesów lub krawędzi slajdu albo wyrównuje je względem siebie.
...
Zmienia położenie wybranych kształtów na slajdzie. Ustawia kształty względem marginesów lub krawędzi slajdu albo wyrównuje je względem siebie.
...
| alignToSlide | boolean | Jeśli true, kształty będą wyrównane względem krawędzi slajdu. |
| slide | [IBaseSlide](../../com.aspose.slides/ibaseslide) | Slajd nadrzędny. |
| shapeIndexes | int[] | Indeksy kształtów, które mają być wyrównane. |
...
Zmienia położenie wszystkich kształtów w obrębie grupy kształtów. Ustawia kształty względem marginesów lub krawędzi slajdu albo wyrównuje je względem siebie.
...
Zmienia położenie wybranych kształtów w obrębie grupy kształtów. Ustawia kształty względem marginesów lub krawędzi slajdu albo wyrównuje je względem siebie.
...
| withMasters | boolean | Określa, czy slajdy master mają być skanowane. |
| find | java.lang.String | Wartość łańcucha do wyszukania. |
| replace | java.lang.String | Wartość łańcucha do zamiany. znak znalezionego ciągu |
...
| withMasters | boolean | Określa, czy slajdy master mają być skanowane. |
| find | java.lang.String | Wartość łańcucha do wyszukania. |
| replace | java.lang.String | Wartość łańcucha do zamiany. |
| format | [PortionFormat](../../com.aspose.slides/portionformat) | Format do zamiany części tekstu. Jeśli null, zostanie użyty format pierwszego znaku znalezionego ciągu. |
...
| text | java.lang.String | Tekst, którego szukamy w ramach tekstowych. |
| checkPlaceholderText | boolean | Wskazuje, czy uwzględnić ramki tekstowe, które są puste, ale ich tekst placeholdera zawiera szukany tekst. |
...
**Zwraca:**
int - Odpowiadająca wartość [SaveFormat](../../com.aspose.slides/saveformat).