...
| [getPlaceholderManager()](#getPlaceholderManager--) | Zwraca menedżera placeholder slajdu układu. |
...
| [getLayoutType()](#getLayoutType--) | Zwraca typ układu tego slajdu. |
| [getDependingSlides()](#getDependingSlides--) | Zwraca tablicę ze wszystkimi slajdami, które zależą od tego slajdu układu. |
| [hasDependingSlides()](#hasDependingSlides--) | Zwraca true, jeśli istnieje co najmniej jeden slajd zależący od tego slajdu układu. |
...
Zwraca menedżera placeholder slajdu układu. Tylko do odczytu [ILayoutPlaceholderManager](../../com.aspose.slides/ilayoutplaceholdermanager).
...
Zwraca typ układu tego slajdu. Tylko do odczytu [SlideLayoutType](../../com.aspose.slides/slidelayouttype).
...
Zwraca true, jeśli istnieje co najmniej jeden slajd zależący od tego slajdu układu. Tylko do odczytu  boolean .
...
>      // Dodawanie nowej pionowej linii pomocniczej po lewej stronie środka slajdu
