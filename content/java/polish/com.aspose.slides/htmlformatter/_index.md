...
| [createSlideShowFormatter(String css, boolean showSlideTitle)](#createSlideShowFormatter-java.lang.String-boolean-) | Tworzy i zwraca formatator HTML dla prostego pokazu slajdów w HTML, który wyświetla slajdy kolejno po sobie. |
...
Tworzy i zwraca formatator HTML dla prostego pokazu slajdów w HTML, który wyświetla slajdy kolejno po sobie.

**Parametry:**
| Parametr | Typ | Opis |
| --- | --- | --- |
| css | java.lang.String | Określa URL pliku CCS używanego. |
| showSlideTitle | boolean | Dodaje tytuł slajdu, jeśli istnieje nad obrazem slajdu. |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| formattingController | [IHtmlFormattingController](../../com.aspose.slides/ihtmlformattingcontroller) | Interfejs wywołania zwrotnego, który kontroluje generowanie pliku HTML. |
