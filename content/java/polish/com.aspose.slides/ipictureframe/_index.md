...
| Metoda | Opis |
| --- | --- |
| [getPictureFrameLock()](#getPictureFrameLock--) | Zwraca blokady PictureFrame. |
...
Zwraca blokady PictureFrame. Tylko do odczytu [IPictureFrameLock](../../com.aspose.slides/ipictureframelock).
...
Zwraca lub ustawia skalę wysokości (względem oryginalnego rozmiaru obrazu) ramki obrazu. Wartość 1,0 odpowiada 100%. Float do odczytu i zapisu.
...
Zwraca lub ustawia skalę szerokości (względem oryginalnego rozmiaru obrazu) ramki obrazu. Wartość 1,0 odpowiada 100%. Float do odczytu i zapisu.
