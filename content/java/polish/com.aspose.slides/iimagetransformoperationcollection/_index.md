...
| [removeAt(int index)](#removeAt-int-) | Usuwa efekt obrazu z kolekcji pod określonym indeksem. |
...
Usuwa efekt obrazu z kolekcji pod określonym indeksem.
...
| grow | boolean | Określa, czy granice obiektu mają być powiększone w wyniku rozmycia. Prawda oznacza, że granice są powiększane, fałsz – że nie są. |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| hue | float | Odcień, do którego ma być zastosowany tint. |
