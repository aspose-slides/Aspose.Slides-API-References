...
| [getVariableScale()](#getVariableScale--) | Określa, że zawartość widoku powinna automatycznie skalować się, aby najlepiej pasować do bieżącego rozmiaru okna. |
| [setVariableScale(boolean value)](#setVariableScale-boolean-) | Określa, że zawartość widoku powinna automatycznie skalować się, aby najlepiej pasować do bieżącego rozmiaru okna. |
...
Określa, że zawartość widoku powinna automatycznie skalować się, aby najlepiej pasować do bieżącego rozmiaru okna. Odczyt/zapis boolean.
