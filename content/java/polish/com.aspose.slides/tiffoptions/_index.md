...
>      // Jednostka rozdzielczości zawsze wynosi 2 (punkty na cal)
...
| Konstruktor | Opis |
| --- | --- |
| [TiffOptions()](#TiffOptions--) | Domyślny konstruktor. |
## Metody
...
| [setImageSize(Dimension value)](#setImageSize-java.awt.Dimension-) | Określa rozmiar wygenerowanego obrazu TIFF. |
...
Określa rozmiar wygenerowanego obrazu TIFF. Domyślna wartość to 0x0, co oznacza, że rozmiary wygenerowanych obrazów będą obliczane na podstawie rozmiaru slajdu prezentacji. Odczyt/zapis java.awt.Dimension.
