...
description: Reprezentuje własności legendy wykresów.
type: docs
...
Określa pozycję legendy na wykresie. Wartości nie-NaN właściwości X, Y, Width, Heigt nadpisują efekt tej właściwości. Odczyt/zapis [LegendPositionType](../../com.aspose.slides/legendpositiontype).
