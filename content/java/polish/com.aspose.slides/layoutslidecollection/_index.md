...
| [removeUnused()](#removeUnused--) | Usuwa niewykorzystane slajdy układu (slajdy układu, których właściwość HasDependingSlides jest false). |
...
| [isSynchronized()](#isSynchronized--) | Zwraca wartość wskazującą, czy dostęp do kolekcji jest zsynchronizowany (wielowątkowy). |
...
**Zwraca:**
[ILayoutSlide](../../com.aspose.slides/ilayoutslide) – [LayoutSlide](../../com.aspose.slides/layoutslide) o określonym typie lub null, jeśli nie znaleziono układów.
...
--------------------
1) Aby uniknąć rzucenia PptxEditException, sprawdź wcześniej własność HasDependingSlides układu. 2) Można także użyć metody [ILayoutSlide.remove](../../com.aspose.slides/ilayoutslide\#remove), aby uprościć kod. |
...
Usuwa niewykorzystane slajdy układu (slajdy układu, których właściwość HasDependingSlides jest false).
...
**Zwraca:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ILayoutSlide> - IGenericEnumerator, który może być użyty do iteracji po kolekcji.
...
**Zwraca:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ILayoutSlide> - java.util.Iterator dla całej kolekcji.
...
Zwraca wartość wskazującą, czy dostęp do kolekcji jest zsynchronizowany (wielowątkowy). Tylko do odczytu boolean.
