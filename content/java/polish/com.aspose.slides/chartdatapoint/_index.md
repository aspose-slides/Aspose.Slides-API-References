...
| [getExplosion()](#getExplosion--) | Określa odległość, o jaką punkt danych ma być przesunięty od środka koła. |
| [setExplosion(int value)](#setExplosion-int-) | Określa odległość, o jaką punkt danych ma być przesunięty od środka koła. |
...
Zwraca wartość rozmiaru punktu danych wykresu. Używane z wykresami Treemap i Sunburst. Tylko do odczytu [IDoubleChartValue](../../com.aspose.slides/idoublechartvalue).
...
Zwraca wartość koloru punktu danych wykresu. Używane z wykresami map. Tylko do odczytu [IDoubleChartValue](../../com.aspose.slides/idoublechartvalue).
...
Określa odległość, o jaką punkt danych ma być przesunięty od środka koła. Odczyt/zapis int.
...
Zwraca kontener poziomów punktu danych. Stosowane dla serii Treeamp i Sunburst. Indeksowanie poziomów punktu danych zaczyna się od zera.
...
Określa, że punkt danych ma odwrócić kolory, jeśli wartość jest ujemna. Odczyt/zapis boolean.
...
Określa rzeczywistą pozycję x (lewo) elementu wykresu względem lewego górnego rogu wykresu. Należy wywołać metodę IChart.ValidateChartLayout() przed pobraniem rzeczywistych wartości. Odczyt float.
...
Określa rzeczywistą górną pozycję elementu wykresu względem lewego górnego rogu wykresu. Należy wywołać metodę IChart.ValidateChartLayout() przed pobraniem rzeczywistych wartości. Odczyt float.
...
Określa rzeczywistą szerokość elementu wykresu. Należy wywołać metodę IChart.ValidateChartLayout() przed pobraniem rzeczywistych wartości. Odczyt float.
...
Określa rzeczywistą wysokość elementu wykresu. Należy wywołać metodę IChart.ValidateChartLayout() przed pobraniem rzeczywistych wartości. Odczyt float.
