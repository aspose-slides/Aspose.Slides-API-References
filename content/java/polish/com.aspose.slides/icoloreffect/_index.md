...
| [getTo()](#getTo--) | Opisuje wynikowy kolor zmiany koloru animacji. |
| [setTo(IColorFormat value)](#setTo-com.aspose.slides.IColorFormat-) | Opisuje wynikowy kolor zmiany koloru animacji. |
...
| [getColorSpace()](#getColorSpace--) | Reprezentuje przestrzeń kolorów zachowania. |
| [setColorSpace(int value)](#setColorSpace-int-) | Reprezentuje przestrzeń kolorów zachowania. |
...
Opisuje wynikowy kolor zmiany koloru animacji. Odczyt/zapis [IColorFormat](../../com.aspose.slides/icolorformat).
...
Reprezentuje przestrzeń kolorów zachowania. Odczyt/zapis [ColorSpace](../../com.aspose.slides/colorspace)(\#getColorSpace.getColorSpace/\#setColorSpace(int).setColorSpace(int)).
