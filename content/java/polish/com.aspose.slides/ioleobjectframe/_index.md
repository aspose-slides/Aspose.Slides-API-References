...
| [getLinkFileName()](#getLinkFileName--) | Zwraca pełną ścieżkę do pliku powiązanego. |
| [getLinkPathLong()](#getLinkPathLong--) | Zwraca pełną ścieżkę do pliku powiązanego. |
| [setLinkPathLong(String value)](#setLinkPathLong-java.lang.String-) | Zwraca pełną ścieżkę do pliku powiązanego. |
| [getLinkPathRelative()](#getLinkPathRelative--) | Zwraca względną ścieżkę do pliku powiązanego, jeśli istnieje, w przeciwnym razie zwraca pusty ciąg. |
...
| [isObjectLink()](#isObjectLink--) | Określa, czy obiekt jest powiązany z zewnętrznym plikiem. |
| [getUpdateAutomatic()](#getUpdateAutomatic--) | Określa, czy powiązany osadzony obiekt jest automatycznie aktualizowany, gdy prezentacja jest otwierana lub drukowana. |
| [setUpdateAutomatic(boolean value)](#setUpdateAutomatic-boolean-) | Określa, czy powiązany osadzony obiekt jest automatycznie aktualizowany, gdy prezentacja jest otwierana lub drukowana. |
...
Zwraca pełną ścieżkę do pliku powiązanego. Używana będzie długa nazwa pliku. Odczyt/zapis String.
...
Zwraca względną ścieżkę do pliku powiązanego, jeśli istnieje, w przeciwnym razie zwraca pusty ciąg. Tylko do odczytu String.
...
Określa, czy obiekt jest powiązany z zewnętrznym plikiem. Tylko do odczytu boolean.
...
Określa, czy powiązany osadzony obiekt jest automatycznie aktualizowany, gdy prezentacja jest otwierana lub drukowana. Odczyt/zapis boolean.
