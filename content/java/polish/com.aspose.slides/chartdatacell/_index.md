...
Reprezentuje komórkę dla danych wykresu.
...
| [getColumn()](#getColumn--) | Zwraca indeks kolumny arkusza, w którym znajduje się komórka. |
...
Zwraca indeks kolumny arkusza, w którym znajduje się komórka. Tylko do odczytu int.
...
Pobiera lub ustawia wbudowany format wyświetlania liczb i dat. Numer wbudowany musi być w przedziale [0..22] lub [37..49]. Odczyt/zapis byte.
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| updateValues | boolean | Jeśli false, nie zostanie wykonane rzeczywiste obliczenie. Użyj true aby sprawdzić możliwe wyjątki. |