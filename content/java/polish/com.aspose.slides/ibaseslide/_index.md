...
| [getHyperlinkQueries()](#getHyperlinkQueries--) | Umożliwia prosty dostęp do zawartych hiperłączy. |
...
| [findShapeByAltText(String altText)](#findShapeByAltText-java.lang.String-) | Znajduje pierwsze wystąpienie kształtu z określonym tekstem alternatywnym. |
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | Łączy zakresy o tym samym formatowaniu we wszystkich akapitach we wszystkich dopuszczalnych kształtach. |
...
Zwraca kształty slajdu. Tylko odczyt [IShapeCollection](../../com.aspose.slides/ishapecollection).
...
Zwraca kolekcję kontrolek ActiveX na slajdzie. Tylko odczyt [IControlCollection](../../com.aspose.slides/icontrolcollection).
...
Zwraca identyfikator slajdu. Tylko odczyt long.
...
Zwraca własne dane slajdu. Tylko odczyt [ICustomData](../../com.aspose.slides/icustomdata).
...
Zwraca obiekt osi czasu animacji. Tylko odczyt [IAnimationTimeLine](../../com.aspose.slides/ianimationtimeline).
...
Zwraca obiekt TransitionEx, który zawiera informacje o tym, jak określony slajd przechodzi w trakcie pokazu slajdów. Tylko odczyt [ISlideShowTransition](../../com.aspose.slides/islideshowtransition).
...
Zwraca tło slajdu. Tylko odczyt [IBackground](../../com.aspose.slides/ibackground).
...
Umożliwia prosty dostęp do zawartych hiperłączy. Tylko odczyt [IHyperlinkQueries](../../com.aspose.slides/ihyperlinkqueries).
...
Znajduje pierwsze wystąpienie kształtu z określonym tekstem alternatywnym.
...
Łączy zakresy o tym samym formatowaniu we wszystkich akapitach we wszystkich dopuszczalnych kształtach.
...
Określa, czy dwa wystąpienia IBaseSlide są równe. Zwracana wartość jest obliczana na podstawie struktury slajdu i treści statycznej. Dwa slajdy są równe, jeśli wszystkie kształty, style, teksty, animacje i inne ustawienia itp. są równe. Porównanie nie uwzględnia unikalnych wartości identyfikatorów, np. SlideId oraz treści dynamicznej, np. bieżącej wartości daty w zastępniki daty.
