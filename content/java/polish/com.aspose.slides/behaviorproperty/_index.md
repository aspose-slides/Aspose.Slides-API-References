...
description: Reprezentuje typy właściwości dla zachowań animacji.
type: docs
...
Reprezentuje typy własności zachowania animacji. Opiera się na liście właściwości z https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx i https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx
## Metody

| Metoda | Opis |
| --- | --- |
| [getValue()](#getValue--) | Wartość właściwości |
| [isCustom()](#isCustom--) | Pokazuje, czy ta właściwość nie należy do listy predefiniowanych właściwości w specyfikacji: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx |
...
| [getOrCreateByValue(String propertyValue)](#getOrCreateByValue-java.lang.String-) | Wyszukuje istniejącą właściwość zachowania według wartości lub tworzy nową niestandardową z podaną wartością |
...
Oblicza i zwraca kod skrótu na podstawie właściwości (\#getValue.getValue)

**Zwraca:**
int - Zwraca kod skrótu dla tego obiektu
...
Wyszukuje istniejącą właściwość zachowania według wartości lub tworzy nową niestandardową z podaną wartością
