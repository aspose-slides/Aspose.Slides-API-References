...
| Metoda | Opis |
| --- | --- |
| [getOverlay()](#getOverlay--) | Określa, czy inne elementy wykresu mają mieć możliwość nakładania się na tytuł. |
| [setOverlay(boolean value)](#setOverlay-boolean-) | Określa, czy inne elementy wykresu mają mieć możliwość nakładania się na tytuł. |
...
Określa, czy inne elementy wykresu mają mieć możliwość nakładania się na tytuł. Odczyt/zapis boolean.
