...
| [removeAt(int index)](#removeAt-int-) | Usuwa sekwencję o określonym indeksie. |
| [clear()](#clear--) | Usuwa wszystkie sekwencje z kolekcji. |
| [get_Item(int index)](#get-Item-int-) | Zwraca sekwencję o określonym indeksie. |
### getCount() {#getCount--}
```
...
Usuwa sekwencję o określonym indeksie.
...
Zwraca sekwencję o określonym indeksie.
