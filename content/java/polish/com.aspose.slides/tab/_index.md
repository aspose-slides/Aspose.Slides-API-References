...
| Konstruktor | Opis |
| --- | --- |
| [Tab(double position, int align)](#Tab-double-int-) | Tworzy nowy Tab |
## Metody
...
**Zwraca:**
int - 32-bitowa liczba całkowita wskazująca względny porządek porównywanych obiektów. Wartość zwracana ma następujące znaczenia: 
