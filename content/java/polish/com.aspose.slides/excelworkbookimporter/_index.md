...
Pobiera wykres z określonego skoroszytu Excel i dodaje go na koniec podanej kolekcji kształtów w podanych współrzędnych.
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| shapes | [IShapeCollection](../../com.aspose.slides/ishapecollection) | Kolekcja kształtów, do której wykres zostanie dodany. |
| x | float | Współrzędna X służąca do pozycjonowania wykresu. |
| y | float | Współrzędna Y służąca do pozycjonowania wykresu. |
...
| chartIndex | int | Indeks wykresu (zerowy) określający pozycję kształtu wykresu do wstawienia. Ten indeks można uzyskać przy użyciu metody [IExcelDataWorkbook.getChartsFromWorksheet(String)](../../com.aspose.slides/iexceldataworkbook\#getChartsFromWorksheet-String-). |
| embedAllWorkbook | boolean | Jeśli prawda, cały skoroszyt zostanie osadzony w wykresie; jeśli fałsz, zostaną osadzone tylko dane wykresu. |
...
| workbook | [IExcelDataWorkbook](../../com.aspose.slides/iexceldataworkbook) | Skoroszyt Excel. |
| worksheetName | java.lang.String | Nazwa arkusza zawierającego wykres. |
| chartName | java.lang.String | Nazwa wykresu, który ma zostać dodany. |
| embedAllWorkbook | boolean | Jeśli prawda, cały skoroszyt zostanie osadzony w wykresie; jeśli fałsz, zostaną osadzone tylko dane wykresu. |
...
| x | float | Współrzędna X służąca do pozycjonowania wykresu. |
| y | float | Współrzędna Y służąca do pozycjonowania wykresu. |
| workbookPath | java.lang.String | Ścieżka pliku do skoroszytu zawierającego wykres. |
| worksheetName | java.lang.String | Nazwa arkusza zawierającego wykres. |
| chartName | java.lang.String | Nazwa wykresu, który ma zostać dodany. |
| embedWorkbook | boolean | Jeśli prawda, skoroszyt zostanie osadzony w wykresie; jeśli fałsz, wykres będzie odwoływał się do zewnętrznego skoroszytu. |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| shapes | [IShapeCollection](../../com.aspose.slides/ishapecollection) | Kolekcja kształtów, do której tabela zostanie dodana. |
