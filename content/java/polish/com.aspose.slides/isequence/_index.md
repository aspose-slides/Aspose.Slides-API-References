...
description: Reprezentuje sekwencję, czyli kolekcję efektów.
type: docs
...
| [get_Item(int index)](#get-Item-int-) | Zwraca efekt o określonym indeksie. |
| [getTriggerShape()](#getTriggerShape--) | Zwraca lub ustawia docelowy kształt dla INTERACTIVE sequence. |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | Zwraca lub ustawia docelowy kształt dla INTERACTIVE sequence. |
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| index | int | Indeks efektu do usunięcia int |
...
Zwraca lub ustawia docelowy kształt dla INTERACTIVE sequence. If sequence is not interactive then returns null. Odczyt/zapis [IShape](../../com.aspose.slides/ishape).
...
>  try
>  {
>     // wybierz akapit do dodania efektu
