...
| [getAdditive()](#getAdditive--) | Określa, czy bieżące zachowanie animacji jest łączone z innymi trwającymi animacjami. |
| [setAdditive(int value)](#setAdditive-int-) | Określa, czy bieżące zachowanie animacji jest łączone z innymi trwającymi animacjami. |
...
Określa, czy bieżące zachowanie animacji jest łączone z innymi trwającymi animacjami. Odczyt/zapis [BehaviorAdditiveType](../../com.aspose.slides/behavioradditivetype).
