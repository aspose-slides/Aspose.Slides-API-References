...
description: Reprezentuje obsługę ticka klatek zdarzenia FrameTickDelegate.FrameTickDelegate.
type: docs
url: /pl/com.aspose.slides/presentationplayer.frametick/
---```
public static interface PresentationPlayer.FrameTick
```

Reprezentuje obsługę ticka klatek zdarzenia \#FrameTickDelegate.FrameTickDelegate.
