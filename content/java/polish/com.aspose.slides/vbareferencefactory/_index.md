...
Umożliwia tworzenie odwołań do projektu VBA za pośrednictwem interfejsu COM
## Konstruktory
...
| Metoda | Opis |
| --- | --- |
| [getInstance()](#getInstance--) | Statyczna instancja fabryki odwołań do projektu VBA. |
...
Statyczna instancja fabryki odwołań do projektu VBA. Tylko do odczytu [VbaReferenceFactory](../../com.aspose.slides/vbareferencefactory).
