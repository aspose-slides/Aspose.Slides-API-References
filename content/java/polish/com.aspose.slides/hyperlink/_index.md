...
| [Hyperlink(ISlide slide)](#Hyperlink-com.aspose.slides.ISlide-) | Tworzy instancję hiperłącza, które wskazuje konkretny slajd. |
| [Hyperlink(Hyperlink source, String targetFrame, String tooltip, boolean history, boolean stopSoundsOnClick, boolean highlightClick)](#Hyperlink-com.aspose.slides.Hyperlink-java.lang.String-java.lang.String-boolean-boolean-boolean-) | Tworzy instancję hiperłącza przy użyciu innego hiperłącza jako źródła, nadpisując właściwości drugorzędne. |
## Metody
...
| [getLastVievedSlide()](#getLastVievedSlide--) | Zwraca hiperłącze do ostatniego oglądanego slajdu. |
| [getEndShow()](#getEndShow--) | Zwraca hiperłącze, które kończy pokaz. |
| [getActionType()](#getActionType--) | Zwraca typ akcji hiperłącza. |
| [getExternalUrl()](#getExternalUrl--) | Określa zewnętrzny URL. |
| [getTargetSlide()](#getTargetSlide--) | Jeśli hiperłącze wskazuje konkretny slajd, zwraca ten slajd. |
| [getExternalUrlOriginal()](#getExternalUrlOriginal--) | Reprezentuje hiperłącze ustawione dla tej części, niezależnie od rzeczywistej zawartości części. |
| [getTargetFrame()](#getTargetFrame--) | Zwraca ramkę w rodzicielskim zestawie ramek HTML dla celu rodzicielskiego hiperłącza, jeśli istnieje. |
| [setTargetFrame(String value)](#setTargetFrame-java.lang.String-) | Zwraca ramkę w rodzicielskim zestawie ramek HTML dla celu rodzicielskiego hiperłącza, jeśli istnieje. |
| [getTooltip()](#getTooltip--) | Zwraca ciąg znaków, który może być wyświetlany w interfejsie użytkownika jako powiązany z rodzicielskim hiperłączem. |
| [setTooltip(String value)](#setTooltip-java.lang.String-) | Zwraca ciąg znaków, który może być wyświetlany w interfejsie użytkownika jako powiązany z rodzicielskim hiperłączem. |
| [getHistory()](#getHistory--) | Określa, czy cel rodzicielskiego hiperłącza ma być dodany do listy oglądanych hiperłącz po wywołaniu. |
| [setHistory(boolean value)](#setHistory-boolean-) | Określa, czy cel rodzicielskiego hiperłącza ma być dodany do listy oglądanych hiperłącz po wywołaniu. |
...
| [hashCode()](#hashCode--) | Służy jako funkcja skrótu dla określonego typu, odpowiednia do użycia w algorytmach haszujących i strukturach danych, takich jak tablica hash. |
...
Tworzy instancję hiperłącza, które wskazuje konkretny slajd. Uwaga: stworzone hiperłącze powinno być przypisane do obiektu z tej samej prezentacji, w przeciwnym razie link zostanie zapisany jako NoAction.

**Parametry:**
| Parametr | Typ | Opis |
| --- | --- | --- |
| slide | [ISlide](../../com.aspose.slides/islide) | Docelowy slajd. |
...
Tworzy instancję hiperłącza przy użyciu innego hiperłącza jako źródła, nadpisując właściwości drugorzędne.

**Parametry:**
| Parametr | Typ | Opis |
| --- | --- | --- |
| source | [Hyperlink](../../com.aspose.slides/hyperlink) | Źródłowe hiperłącze |
| targetFrame | java.lang.String | Ramka docelowa |
| tooltip | java.lang.String | Tekst podpowiedzi |
| history | boolean | Określa, czy cel rodzicielskiego hiperłącza ma być dodany do listy oglądanych hiperłącz po wywołaniu. |
...
Zwraca hiperłącze do ostatniego oglądanego slajdu. Tylko do odczytu [Hyperlink](../../com.aspose.slides/hyperlink).
...
Zwraca hiperłącze, które kończy pokaz. Tylko do odczytu [Hyperlink](../../com.aspose.slides/hyperlink).
...
Jeśli hiperłącze wskazuje konkretny slajd, zwraca ten slajd. Tylko do odczytu [ISlide](../../com.aspose.slides/islide).
...
PowerPoint zachowuje się w szczególny sposób względem linków i odpowiadającego im tekstu w części. Umożliwia tworzenie tekstu hiperłącza w formie prawidłowego URL, różnego od rzeczywistego adresu linku. W takim przypadku, gdy przeglądasz link w oknie edycji, zostanie on zmieniony, aby pasował do tekstu części. Ta właściwość reprezentuje oryginalną wartość hiperłącza.
...
Zwraca ramkę w rodzicielskim zestawie ramek HTML dla celu rodzicielskiego hiperłącza, jeśli istnieje. Tylko do odczytu/zapisu String.
...
Zwraca ciąg znaków, który może być wyświetlany w interfejsie użytkownika jako powiązany z rodzicielskim hiperłączem. Odczyt/zapis String.
...
Określa, czy cel rodzicielskiego hiperłącza ma być dodany do listy oglądanych hiperłącz po wywołaniu. Odczyt/zapis boolean.
...
>      {
>          // Wyodrębnij dźwięk hiperłącza w postaci tablicy bajtów
...
Służy jako funkcja skrótu dla określonego typu, odpowiednia do użycia w algorytmach haszujących i strukturach danych, takich jak tablica hash.

**Zwraca:**
int - Kod hash dla URL.
### getParent_Immediate() {#getParent-Immediate--}
```
