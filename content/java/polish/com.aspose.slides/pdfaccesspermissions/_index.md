...
description: Zawiera zestaw flag określających, które uprawnienia dostępu powinny być przyznane, gdy dokument jest otwierany z dostępem użytkownika.
type: docs
...
Zawiera zestaw flag określających, które uprawnienia dostępu powinny być przyznane, gdy dokument jest otwierany z dostępem użytkownika.
## Pola

| Pole | Opis |
| --- | --- |
| [None](#None) | Określa, że użytkownik nie ma uprawnień dostępu. |
| [PrintDocument](#PrintDocument) | Określa, czy użytkownik może drukować dokument (być może nie w najwyższej jakości, w zależności od tego, czy bit [HighQualityPrint](../../com.aspose.slides/pdfaccesspermissions\#HighQualityPrint) jest także ustawiony). |
...
| [AddOrModifyFields](#AddOrModifyFields) | Określa, czy użytkownik może dodawać lub modyfikować adnotacje tekstowe, wypełniać interaktywne pola formularzy oraz, jeśli bit [ModifyContent](../../com.aspose.slides/pdfaccesspermissions\#ModifyContent) jest także ustawiony, tworzyć lub modyfikować interaktywne pola formularzy (w tym pola podpisu). |
| [FillExistingFields](#FillExistingFields) | Określa, czy użytkownik może wypełniać istniejące interaktywne pola formularzy (w tym pola podpisu), nawet jeśli bit [AddOrModifyFields](../../com.aspose.slides/pdfaccesspermissions\#AddOrModifyFields) jest wyczyszczony. |
...
Określa, czy użytkownik może drukować dokument (być może nie w najwyższej jakości, w zależności od tego, czy bit [HighQualityPrint](../../com.aspose.slides/pdfaccesspermissions\#HighQualityPrint) jest także ustawiony).
...
Określa, czy użytkownik może dodawać lub modyfikować adnotacje tekstowe, wypełniać interaktywne pola formularzy oraz, jeśli bit [ModifyContent](../../com.aspose.slides/pdfaccesspermissions\#ModifyContent) jest także ustawiony, tworzyć lub modyfikować interaktywne pola formularzy (w tym pola podpisu).
...
Określa, czy użytkownik może wypełniać istniejące interaktywne pola formularzy (w tym pola podpisu), nawet jeśli bit [AddOrModifyFields](../../com.aspose.slides/pdfaccesspermissions\#AddOrModifyFields) jest wyczyszczony.
...
Określa, czy użytkownik może drukować dokument do reprezentacji, z której można wygenerować wierną cyfrową kopię zawartości PDF. Gdy ten bit jest wyczyszczony (a bit [PrintDocument](../../com.aspose.slides/pdfaccesspermissions\#PrintDocument) jest ustawiony), drukowanie jest ograniczone do niskopoziomowej reprezentacji wyglądu, być może o obniżonej jakości.