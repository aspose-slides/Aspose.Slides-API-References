...
| Metoda | Opis |
| --- | --- |
| [getAudioCdStartTrack()](#getAudioCdStartTrack--) | Zwraca lub ustawia indeks początkowej ścieżki. |
| [setAudioCdStartTrack(int value)](#setAudioCdStartTrack-int-) | Zwraca lub ustawia indeks początkowej ścieżki. |
| [getAudioCdStartTrackTime()](#getAudioCdStartTrackTime--) | Zwraca lub ustawia czas początkowej ścieżki. |
| [setAudioCdStartTrackTime(int value)](#setAudioCdStartTrackTime-int-) | Zwraca lub ustawia czas początkowej ścieżki. |
...
| [getHideAtShowing()](#getHideAtShowing--) | Określa, czy AudioFrame jest ukryta. |
| [setHideAtShowing(boolean value)](#setHideAtShowing-boolean-) | Określa, czy AudioFrame jest ukryta. |
| [getPlayLoopMode()](#getPlayLoopMode--) | Określa, czy audio jest w pętli. |
| [setPlayLoopMode(boolean value)](#setPlayLoopMode-boolean-) | Określa, czy audio jest w pętli. |
...
| [getFadeInDuration()](#getFadeInDuration--) | Określa czas trwania początkowego zanikania (fade-in) mediów w milisekundach. |
| [setFadeInDuration(float value)](#setFadeInDuration-float-) | Określa czas trwania początkowego zanikania (fade-in) mediów w milisekundach. |
| [getFadeOutDuration()](#getFadeOutDuration--) | Określa czas trwania końcowego zanikania (fade-out) mediów w milisekundach. |
| [setFadeOutDuration(float value)](#setFadeOutDuration-float-) | Określa czas trwania końcowego zanikania (fade-out) mediów w milisekundach. |
...
Zwraca lub ustawia indeks początkowej ścieżki. Odczyt/zapis int .
...
Zwraca lub ustawia czas początkowej ścieżki. Odczyt/zapis int .
...
Określa, czy AudioFrame jest ukryta. Odczyt/zapis boolean .
...
Określa, czy audio jest w pętli. Odczyt/zapis boolean .
...
Określa czas trwania początkowego zanikania (fade-in) mediów w milisekundach. Odczyt/zapis float.
...
Określa czas trwania końcowego zanikania (fade-out) mediów w milisekundach. Odczyt/zapis float.
