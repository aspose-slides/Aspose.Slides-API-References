...
Określa funkcję pierwiastkową, składającą się z podstawy i opcjonalnego stopnia. Przykład obiektu pierwiastkowego to \\u221a\\ud835\\udc65.
...
| [getHideDegree()](#getHideDegree--) | Ukryj stopień: gdy jest prawda, stopień nie jest wyświetlany, tak jak w \\u221a\\ud835\\udc65 |
| [setHideDegree(boolean value)](#setHideDegree-boolean-) | Ukryj stopień: gdy jest prawda, stopień nie jest wyświetlany, tak jak w \\u221a\\ud835\\udc65 |
### getBase() {#getBase--}
```
...
Ukryj stopień: gdy jest prawda, stopień nie jest wyświetlany, tak jak w \\u221a\\ud835\\udc65
