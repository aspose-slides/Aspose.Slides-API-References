...
description: Określa wystąpienie tekstu matematycznego zawartego w MathParagraph i rozpoczynającego się w osobnym wierszu.
type: docs
...
Specyfikuje wystąpienie tekstu matematycznego zawartego w MathParagraph i rozpoczynającego się w osobnym wierszu. Wszystkie strefy matematyczne, w tym równania, wyrażenia, tablice równań lub wyrażeń oraz formuły są reprezentowane przez blok matematyczny.
...
| Metoda | Opis |
| --- | --- |
| [delimit(char separatorCharacter)](#delimit-char-) | Oddziela wszystkie elementy potomne przy użyciu znaku separatora (bez nawiasów) |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | Otacza elementy potomne tego bloku określonymi znakami, takimi jak nawiasy lub inne, pełniącymi funkcję ramki, i oddziela je znakiem separatora |
...
Oddziela wszystkie elementy potomne przy użyciu znaku separatora (bez nawiasów)
...
> Example:
>  
>  IMMathBlock mathBlock = new MathematicalText("x").join("y");
...
Otacza elementy potomne tego bloku określonymi znakami, takimi jak nawiasy lub inne, pełniącymi funkcję ramki, i oddziela je znakiem separatora
...
**Zwraca:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - Element matematyczny typu [IMathDelimiter](../../com.aspose.slides/imathdelimiter), który zawiera określone znaki jako ramkę i separator
