...
| [getInkEffectImages()](#getInkEffectImages--) | Pobiera kolekcję niestandardowych obrazów używanych do symulacji efektów wizualnych dla pędzli atramentu. |
### getTraces() {#getTraces--}
```
...
Ta właściwość umożliwia zastąpienie domyślnych tekstur efektu atramentu własnymi, co jest szczególnie przydatne, gdy domyślne zasoby są ograniczone licencją lub niedostępne w czasie działania. Każdy wpis w słowniku musi powiązać wartość [InkEffectType](../../com.aspose.slides/inkeffecttype) z odpowiednim obiektem [IImage](../../com.aspose.slides/iimage) (np. Bitmap lub interfejsem obrazu Aspose).
