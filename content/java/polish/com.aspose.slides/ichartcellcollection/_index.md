...
| [add(IChartDataCell chartDataCell)](#add-com.aspose.slides.IChartDataCell-) | Dodaj nową komórkę do kolekcji. |
...
**Zwraca:**
java.lang.String - Wynikowy ciąg String
...
Ta metoda dodaje arkusz o nazwie AUTO_DATA i wstawia tam wszystkie wartości. Jeśli używasz [IChartDataWorkbook](../../com.aspose.slides/ichartdataworkbook) do dodawania lub edycji wartości komórek, upewnij się, że nie używasz tego arkusza. Maksymalna liczba wartości dodawanych przy użyciu tej metody nie może przekroczyć 16711680
