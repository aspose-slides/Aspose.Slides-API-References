...
| [get_Item(int index)](#get-Item-int-) | Zwraca regułę o podanym indeksie. |
...
| [getSyncRoot()](#getSyncRoot--) | Zwraca element bazowy do synchronizacji. |
### FontFallBackRulesCollection() {#FontFallBackRulesCollection--}
```
...
Zwraca liczbę reguł faktycznie zawartych w kolekcji. Tylko do odczytu int.
...
Zwraca regułę o podanym indeksie. Tylko do odczytu [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule).
...
Zwraca element bazowy do synchronizacji. Tylko do odczytu Object.
