...
| [getTextSelectionStart()](#getTextSelectionStart--) | Zwraca lub ustawia pozycję początkową zaznaczenia tekstu w ramce tekstowej, jeśli komentarz jest powiązany z AutoShape. |
| [setTextSelectionStart(int value)](#setTextSelectionStart-int-) | Zwraca lub ustawia pozycję początkową zaznaczenia tekstu w ramce tekstowej, jeśli komentarz jest powiązany z AutoShape. |
...
Zwraca lub ustawia pozycję początkową zaznaczenia tekstu w ramce tekstowej, jeśli komentarz jest powiązany z AutoShape. Odczyt/zapis int.
