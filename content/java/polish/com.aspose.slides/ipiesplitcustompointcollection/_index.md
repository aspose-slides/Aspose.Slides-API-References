...
description: Reprezentuje zbiór punktów, które mają być rysowane w drugim wykresie kołowym lub słupkowym w wykresie słupko-kołowym lub koło-słupkowym z niestandardowym podziałem.
type: docs
...
Reprezentuje zbiór punktów, które mają być rysowane w drugim wykresie kołowym lub słupkowym w wykresie słupko-kołowym lub koło-słupkowym z niestandardowym podziałem.
## Metody
