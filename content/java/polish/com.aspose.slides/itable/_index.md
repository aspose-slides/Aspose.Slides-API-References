...
| [getHorizontalBanding()](#getHorizontalBanding--) | Określa, czy parzyste wiersze mają być rysowane innym formatowaniem. |
| [setHorizontalBanding(boolean value)](#setHorizontalBanding-boolean-) | Określa, czy parzyste wiersze mają być rysowane innym formatowaniem. |
| [getVerticalBanding()](#getVerticalBanding--) | Określa, czy parzyste kolumny mają być rysowane innym formatowaniem. |
| [setVerticalBanding(boolean value)](#setVerticalBanding-boolean-) | Określa, czy parzyste kolumny mają być rysowane innym formatowaniem. |
| [mergeCells(ICell cell1, ICell cell2, boolean allowSplitting)](#mergeCells-com.aspose.slides.ICell-com.aspose.slides.ICell-boolean-) | Łączy sąsiadujące komórki. |
...
Zwraca obiekt TableFormat, który zawiera właściwości formatowania tej tabeli. Tylko do odczytu [ITableFormat](../../com.aspose.slides/itableformat).
...
Określa, czy parzyste wiersze mają być rysowane innym formatowaniem. Odczyt/zapis boolean.
...
Określa, czy parzyste kolumny mają być rysowane innym formatowaniem. Odczyt/zapis boolean.
...
| allowSplitting | boolean | Prawda, aby zezwolić na podział komórek. |
