...
| [getSkewHorizontal()](#getSkewHorizontal--) | Kąt pochylenia w poziomie, w stopniach. |
| [setSkewHorizontal(double value)](#setSkewHorizontal-double-) | Kąt pochylenia w poziomie, w stopniach. |
| [getSkewVertical()](#getSkewVertical--) | Kąt pochylenia w pionie, w stopniach. |
| [setSkewVertical(double value)](#setSkewVertical-double-) | Kąt pochylenia w pionie, w stopniach. |
...
Kierunek cienia, w stopniach. Wartość domyślna - 0 � (od lewa do prawo). Odczyt/zapis float.
...
Odległość cienia od obiektu, w punktach. Wartość domyślna - 0 pt. Odczyt/zapis double.
...
Kolor cienia. Wartość domyślna - automatyczna czerń (zależna od motywu). Tylko do odczytu [IColorFormat](../../com.aspose.slides/icolorformat).
...
Wyrównanie prostokąta. Wartość domyślna - [RectangleAlignment.Bottom](../../com.aspose.slides/rectanglealignment\#Bottom). Odczyt/zapis [RectangleAlignment](../../com.aspose.slides/rectanglealignment).
...
Kąt pochylenia w poziomie, w stopniach. Wartość domyślna - 0 �. Odczyt/zapis double.
...
Poziomy współczynnik skalowania, w procentach oryginalnego rozmiaru. Ujemne skalowanie powoduje odbicie. Wartość domyślna - 100 %. Odczyt/zapis double.
...
Pionowy współczynnik skalowania, w procentach oryginalnego rozmiaru. Ujemne skalowanie powoduje odbicie. Wartość domyślna - 100 %. Odczyt/zapis double.
