...
>  Dlatego właściwości CellFormatEffectiveData są zawsze używane do rysowania tabeli. Poniższy kod jest tylko przykładem użycia API.
>  
...
**Zwraca:**
[ICellFormatEffectiveData](../../com.aspose.slides/icellformateffectivedata) - Obiekt [ICellFormatEffectiveData](../../com.aspose.slides/icellformateffectivedata).
