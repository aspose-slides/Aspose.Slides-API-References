...
| [checkPassword(String password)](#checkPassword-java.lang.String-) | Sprawdza, czy hasło jest prawidłowe dla prezentacji chronionej hasłem otwierającym. |
| [checkWriteProtection(String password)](#checkWriteProtection-java.lang.String-) | Sprawdza, czy hasło do modyfikacji jest prawidłowe dla prezentacji chronionej przed zapisem. |
...
Jeśli prezentacja jest chroniona hasłem do otwarcia, wartość właściwości jest równa NotDefined.
...
Sprawdza, czy hasło jest prawidłowe dla prezentacji chronionej hasłem otwierającym.
...
**Zwraca:**
boolean - True, jeśli prezentacja jest chroniona hasłem otwierającym i hasło jest prawidłowe, oraz false w przeciwnym wypadku.
...
1. Powinieneś sprawdzić właściwość (\#isWriteProtected.isWriteProtected) przed wywołaniem tej metody. 2. Gdy hasło jest równe null lub jest puste, ta metoda zwraca false. |

**Zwraca:**
boolean - True, jeśli prezentacja jest chroniona przed zapisem i hasło jest prawidłowe. False w przeciwnym wypadku.
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| stream | java.io.OutputStream | Strumień musi być możliwy do przeszukiwania i zapisu. |
