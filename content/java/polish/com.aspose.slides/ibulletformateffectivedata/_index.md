...
description: Obiekt niezmienny, który zawiera skuteczne właściwości formatowania wypunktowania akapitu.
type: docs
...
Obiekt niezmienny, który zawiera skuteczne właściwości formatowania wypunktowania akapitu.
...
| [getNumberedBulletStartWith()](#getNumberedBulletStartWith--) | Zwraca pierwszą liczbę używaną w grupie numerowanych wypunktowań. |
...
Zwraca pierwszą liczbę używaną w grupie numerowanych wypunktowań. Tylko do odczytu short.
...
Określa, czy wypunktowanie ma własny kolor, czy dziedziczy go z pierwszej części w akapicie. Zwraca **true**, jeśli wypunktowanie ma własny kolor i **false**, jeśli wypunktowanie dziedziczy kolor z pierwszej części w akapicie. Tylko do odczytu boolean.
...
Określa, czy wypunktowanie ma własną czcionkę, czy dziedziczy ją z pierwszej części w akapicie. Zwraca **true**, jeśli wypunktowanie ma własną czcionkę i **true**, jeśli wypunktowanie dziedziczy czcionkę z pierwszej części w akapicie. Tylko do odczytu boolean.
...
>  try {
>      // Załóżmy, że pierwszy kształt na pierwszym slajdzie to AutoShape z pewnym tekstem...
>      // Wyświetl informacje o wypunktowaniach akapitów tekstu
