...
| [removeAt(int index)](#removeAt-int-) | Usuwa etykietę wrażliwości pod określonym indeksem. |
...
Usuwa etykietę wrażliwości pod określonym indeksem.
...
**Zwraca:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISensitivityLabel> - Enumerator System.Collections.Generic.IEnumerator1, który może być użyty do iteracji po kolekcji.
### getCount() {#getCount--}
```
...
| Parametr | Typ | Opis |
| --- | --- | --- |
| array | [ISensitivityLabel\[\]](../../com.aspose.slides/isensitivitylabel) | Tablica docelowa. |
