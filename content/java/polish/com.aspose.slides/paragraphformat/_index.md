...
Aby uzyskać skuteczne wartości parametrów formatowania, w tym dziedziczone, należy użyć metody [getEffective](../../com.aspose.slides/paragraphformat\#getEffective), która zwraca instancję [IParagraphFormatEffectiveData](../../com.aspose.slides/iparagraphformateffectivedata).
...
| [getEastAsianLineBreak()](#getEastAsianLineBreak--) | Określa, czy w akapicie używany jest podział linii w stylu wschodnio-azjatyckim. |
| [setEastAsianLineBreak(byte value)](#setEastAsianLineBreak-byte-) | Określa, czy w akapicie używany jest podział linii w stylu wschodnio-azjatyckim. |
| [getRightToLeft()](#getRightToLeft--) | Określa, czy w akapicie używane jest pisanie od prawej do lewej. |
| [setRightToLeft(byte value)](#setRightToLeft-byte-) | Określa, czy w akapicie używane jest pisanie od prawej do lewej. |
| [getLatinLineBreak()](#getLatinLineBreak--) | Określa, czy w akapicie używany jest podział linii w stylu łacińskim. |
| [setLatinLineBreak(byte value)](#setLatinLineBreak-byte-) | Określa, czy w akapicie używany jest podział linii w stylu łacińskim. |
...
| [getIndent()](#getIndent--) | Zwraca lub ustawia wcięcie pierwszej linii/odwieszenie w akapicie bez dziedziczenia. |
| [setIndent(float value)](#setIndent-float-) | Zwraca lub ustawia wcięcie pierwszej linii/odwieszenie w akapicie bez dziedziczenia. |
...
Zwraca lub ustawia głębokość akapitu. Wartość 0 oznacza wartość nieokreśloną. Odczyt/zapis  short .
...
>      // Dostęp do pierwszego i drugiego placeholdera w slajdzie oraz rzutowanie ich na AutoShape
>      ITextFrame tf1 = ((IAutoShape)slide.getShapes().get_Item(0)).getTextFrame();
>      ITextFrame tf2 = ((IAutoShape)slide.getShapes().get_Item(1)).getTextFrame();
>      // Zmien tekst w obu placeholderach
>      tf1.setText("Center Align by Aspose");
>      tf2.setText("Center Align by Aspose");
>      // Pobieranie pierwszego akapitu z placeholderów
...
>      // Dostęp do pierwszego slajdu
>      ISlide slide = pres.getSlides().get_Item(0);
>      // Dostęp do pierwszego i drugiego placeholdera w slajdzie oraz rzutowanie go na AutoShape
>      ITextFrame tf1 = ((IAutoShape)slide.getShapes().get_Item(0)).getTextFrame();
>      ITextFrame tf2 = ((IAutoShape)slide.getShapes().get_Item(1)).getTextFrame();
...
Zwraca lub ustawia ilość odstępu między liniami bazowymi w akapicie. Dodatnia wartość oznacza procent, ujemna – rozmiar w punktach. Nie stosuje się dziedziczenia. Odczyt/zapis  float .
...
Zwraca lub ustawia ilość odstępu przed pierwszą linią w akapicie bez dziedziczenia. Dodatnia wartość określa procent rozmiaru czcionki, jaki ma stanowić biały odstęp. Ujemna wartość określa rozmiar białego odstępu w punktach. Odczyt/zapis  float .
...
Zwraca lub ustawia ilość odstępu po ostatniej linii w akapicie bez dziedziczenia. Dodatnia wartość określa procent rozmiaru czcionki, jaki ma stanowić biały odstęp. Ujemna wartość określa rozmiar białego odstępu w punktach. Odczyt/zapis  float .
...
Określa, czy w akapicie używany jest podział linii w stylu wschodnio-azjatyckim. Nie stosuje się dziedziczenia. Odczyt/zapis [NullableBool](../../com.aspose.slides/nullablebool).
...
Określa, czy w akapicie używane jest pisanie od prawej do lewej. Nie stosuje się dziedziczenia. Odczyt/zapis [NullableBool](../../com.aspose.slides/nullablebool).
...
Określa, czy w akapicie używany jest podział linii w stylu łacińskim. Nie stosuje się dziedziczenia. Odczyt/zapis [NullableBool](../../com.aspose.slides/nullablebool).
...
Określa, czy w akapicie używana jest wisząca interpunkcja. Nie stosuje się dziedziczenia. Odczyt/zapis [NullableBool](../../com.aspose.slides/nullablebool).
...
Zwraca lub ustawia wcięcie pierwszej linii/odwieszenie w akapicie bez dziedziczenia. Odwieszenie można definiować ujemnymi wartościami. Odczyt/zapis  float .
...
Zwraca domyślny format fragmentu w akapicie. Nie stosuje się dziedziczenia. Tylko do odczytu [IPortionFormat](../../com.aspose.slides/iportionformat).
...
> ```
> Ten przykład demonstruje pobieranie niektórych właściwości efektywnego formatowania akapitu.
>  
