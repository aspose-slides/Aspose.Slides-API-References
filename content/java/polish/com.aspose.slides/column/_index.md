...
| [setTextFormat(IPortionFormat source)](#setTextFormat-com.aspose.slides.IPortionFormat-) | Ustawia określone właściwości formatu porcji dla wszystkich porcji komórek kolumny. |
| [setTextFormat(IParagraphFormat source)](#setTextFormat-com.aspose.slides.IParagraphFormat-) | Ustawia określone właściwości formatu akapitu dla wszystkich akapitów komórek kolumny. |
| [setTextFormat(ITextFrameFormat source)](#setTextFormat-com.aspose.slides.ITextFrameFormat-) | Ustawia określone właściwości formatu ramki tekstowej dla wszystkich ramek tekstowych komórek kolumny. |
...
Ustawia określone właściwości formatu porcji dla wszystkich porcji komórek kolumny.
...
Ustawia określone właściwości formatu akapitu dla wszystkich akapitów komórek kolumny.
...
Ustawia określone właściwości formatu ramki tekstowej dla wszystkich ramek tekstowych komórek kolumny.
