...
type: docs
url: /pl/com.aspose.slides/charttitle/
---
**Dziedziczenie:**
java.lang.Object
...
| [getOverlay()](#getOverlay--) | Określa, czy inne elementy wykresu mogą zachodzić na tytuł. |
| [setOverlay(boolean value)](#setOverlay-boolean-) | Określa, czy inne elementy wykresu mogą zachodzić na tytuł. |
...
| [getActualY()](#getActualY--) | Określa rzeczywistą pozycję y (górę) elementu wykresu względem lewego górnego rogu wykresu. |
...
Określa, czy inne elementy wykresu mogą zachodzić na tytuł. Odczyt/zapis boolean.
...
Może zawierać tekst sformatowany bogato. Jeśli ta właściwość nie jest równa null, ten sformatowany tekst zastępuje automatycznie wygenerowany tekst. Automatycznie wygenerowany tekst jest domyślną właściwością etykiety danych, etykiety jednostki wyświetlania osi wartości, tytułu osi, tytułu wykresu, etykiety linii trendu. Automatycznie wygenerowany tekst jest formatowany właściwością IFormattedTextContainer.TextFormat. Tylko do odczytu [ITextFrame](../../com.aspose.slides/itextframe).
...
Określa rzeczywistą pozycję x (lewy) elementu wykresu względem lewego górnego rogu wykresu. Wywołaj metodę IChart.validateChartLayout() przed pobraniem rzeczywistych wartości. Odczyt float.
...
Określa rzeczywistą pozycję y (górę) elementu wykresu względem lewego górnego rogu wykresu. Wywołaj metodę IChart.validateChartLayout() przed pobraniem rzeczywistych wartości. Odczyt float.
