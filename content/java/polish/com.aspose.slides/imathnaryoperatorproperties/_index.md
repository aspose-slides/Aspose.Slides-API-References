...
| Metoda | Opis |
| --- | --- |
| [getOperator()](#getOperator--) | Znak operatora nary. Na przykład: '\\u2211', '\\u222b' |
| [setOperator(char value)](#setOperator-char-) | Znak operatora nary. Na przykład: '\\u2211', '\\u222b' |
| [getLimitLocation()](#getLimitLocation--) | Położenie limitów (indeks dolny i indeks górny) |
| [setLimitLocation(int value)](#setLimitLocation-int-) | Położenie limitów (indeks dolny i indeks górny) |
