...
| Metoda | Opis |
| --- | --- |
| [getImageType()](#getImageType--) | Pobiera lub ustawia typ obrazu obiektu powiększenia. |
| [setImageType(int value)](#setImageType-int-) | Pobiera lub ustawia typ obrazu obiektu powiększenia. |
...
| [getZoomImage()](#getZoomImage--) | Pobiera lub ustawia obraz dla obiektu powiększenia. |
| [setZoomImage(IPPImage value)](#setZoomImage-com.aspose.slides.IPPImage-) | Pobiera lub ustawia obraz dla obiektu powiększenia. |
...
Pobiera lub ustawia typ obrazu obiektu powiększenia. Odczyt/zapis [ZoomImageType](../../com.aspose.slides/zoomimagetype). Domyślna wartość: Preview
...
Prawdziwa wartość właściwości określa zachowanie powrotu do nadrzędnego w pokazie slajdów.
...
> ```
> Przykład pokazuje usuwanie tła obrazu obiektu Zoom:
>  
>  Presentation pres = new Presentation("pres.pptx");
>  try {
>       IZoomFrame zoomFrame = pres.getSlides().get_Item(0).getShapes().addZoomFrame(150, 20, 50, 50, pres.getSlides().get_Item(1));
...
Pobiera lub ustawia obraz dla obiektu powiększenia. Odczyt/zapis [IPPImage](../../com.aspose.slides/ippimage).
