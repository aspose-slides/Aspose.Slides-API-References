...
description: Reprezentuje styl wypełnienia obrazu.
type: docs
...
Reprezentuje styl wypełnienia obrazu.
## Metody

| Metoda | Opis |
| --- | --- |
| [getDpi()](#getDpi--) | Zwraca lub ustawia DPI używane do wypełniania obrazu. |
| [setDpi(int value)](#setDpi-int-) | Zwraca lub ustawia DPI używane do wypełniania obrazu. |
...
| [getStretchOffsetLeft()](#getStretchOffsetLeft--) | Zwraca lub ustawia lewą krawędź prostokąta wypełnienia określoną jako offset procentowy od lewej krawędzi obramowania kształtu. |
| [setStretchOffsetLeft(float value)](#setStretchOffsetLeft-float-) | Zwraca lub ustawia lewą krawędź prostokąta wypełnienia określoną jako offset procentowy od lewej krawędzi obramowania kształtu. |
| [getStretchOffsetTop()](#getStretchOffsetTop--) | Zwraca lub ustawia górną krawędź prostokąta wypełnienia określoną jako offset procentowy od górnej krawędzi obramowania kształtu. |
| [setStretchOffsetTop(float value)](#setStretchOffsetTop-float-) | Zwraca lub ustawia górną krawędź prostokąta wypełnienia określoną jako offset procentowy od górnej krawędzi obramowania kształtu. |
| [getStretchOffsetRight()](#getStretchOffsetRight--) | Zwraca lub ustawia prawą krawędź prostokąta wypełnienia określoną jako offset procentowy od prawej krawędzi obramowania kształtu. |
| [setStretchOffsetRight(float value)](#setStretchOffsetRight-float-) | Zwraca lub ustawia prawą krawędź prostokąta wypełnienia określoną jako offset procentowy od prawej krawędzi obramowania kształtu. |
| [getStretchOffsetBottom()](#getStretchOffsetBottom--) | Zwraca lub ustawia dolną krawędź prostokąta wypełnienia określoną jako offset procentowy od dolnej krawędzi obramowania kształtu. |
| [setStretchOffsetBottom(float value)](#setStretchOffsetBottom-float-) | Zwraca lub ustawia dolną krawędź prostokąta wypełnienia określoną jako offset procentowy od dolnej krawędzi obramowania kształtu. |
| [deletePictureCroppedAreas()](#deletePictureCroppedAreas--) | Usuwa przycięte obszary obrazu wypełnienia. |
| [compressImage(boolean deleteCroppedAreasOfImage, int resolution)](#compressImage-boolean-int-) | Kompresuje obraz, zmniejszając jego rozmiar w zależności od rozmiaru kształtu i podanej rozdzielczości. |
| [compressImage(boolean deleteCroppedAreasOfImage, float resolution)](#compressImage-boolean-float-) | Kompresuje obraz, zmniejszając jego rozmiar w zależności od rozmiaru kształtu i podanej rozdzielczości. |
...
| [getTileFlip()](#getTileFlip--) | Odwraca kafelek tekstury wzdłuż osi poziomej, pionowej lub obu jednocześnie. |
| [setTileFlip(int value)](#setTileFlip-int-) | Odwraca kafelek tekstury wzdłuż osi poziomej, pionowej lub obu jednocześnie. |
...
Zwraca lub ustawia DPI używane do wypełniania obrazu. Odczyt/zapis int.
...
Zwraca lub ustawia lewą krawędź prostokąta wypełnienia określoną jako offset procentowy od lewej krawędzi obramowania kształtu. Dodatni procent oznacza wcięcie, ujemny — wystawienie. Odczyt/zapis float.
...
Zwraca lub ustawia górną krawędź prostokąta wypełnienia określoną jako offset procentowy od górnej krawędzi obramowania kształtu. Dodatni procent oznacza wcięcie, ujemny — wystawienie. Odczyt/zapis float.
...
Zwraca lub ustawia prawą krawędź prostokąta wypełnienia określoną jako offset procentowy od prawej krawędzi obramowania kształtu. Dodatni procent oznacza wcięcie, ujemny — wystawienie. Odczyt/zapis float.
...
Zwraca lub ustawia dolną krawędź prostokąta wypełnienia określoną jako offset procentowy od dolnej krawędzi obramowania kształtu. Dodatni procent oznacza wcięcie, ujemny — wystawienie. Odczyt/zapis float.
...
**Zwraca:**
[IPPImage](../../com.aspose.slides/ippimage) - Przycięty obraz lub oryginalny obraz, jeśli przycinanie nie jest potrzebne.

--------------------

Ta metoda konwertuje pliki metafile WMF/EMF na rastrowy obraz PNG, przycinając go.
### compressImage(boolean deleteCroppedAreasOfImage, int resolution) {#compressImage-boolean-int-}
```
public abstract boolean compressImage(boolean deleteCroppedAreasOfImage, int resolution)
```

Kompresuje obraz, zmniejszając jego rozmiar w zależności od rozmiaru kształtu i podanej rozdzielczości. Opcjonalnie usuwa także przycięte obszary.
...
> CompressImage
> ``` metoda zmniejszająca rozmiar obrazu w prezentacji przez ustawienie docelowej rozdzielczości i usunięcie przyciętych obszarów:
>  
>  Presentation presentation = new Presentation("demo.pptx");
>  try {
>      ISlide slide = presentation.getSlides().get_Item(0);
...
Domyślnie jest [RectangleAlignment.TopLeft](../../com.aspose.slides/rectanglealignment\#TopLeft).
