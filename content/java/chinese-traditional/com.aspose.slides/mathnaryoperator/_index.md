...
指定一個 N 元數學物件，例如 Summation 與 Integral。它由運算子、基底（或運算元）以及可選的上限與下限組成。N 元運算子的例子包括：Summation、Union、Intersection、Integral
...
| 建構函式 | 說明 |
| --- | --- |
| [MathNaryOperator(char operatorSymbol, IMathElement baseArgument, IMathElement lowerLimit, IMathElement upperLimit)](#MathNaryOperator-char-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-) | 初始化 MathNaryOperator 類別的新實例。 |
| [MathNaryOperator(char operatorSymbol, IMathElement baseArgument, IMathElement lowerLimit)](#MathNaryOperator-char-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-) | 初始化 MathNaryOperator 類別的新實例。 |
| [MathNaryOperator(char operatorSymbol, IMathElement baseArgument)](#MathNaryOperator-char-com.aspose.slides.IMathElement-) | 初始化 MathNaryOperator 類別的新實例。 |
## 方法

| 方法 | 說明 |
| --- | --- |
| [getBase()](#getBase--) | 基底參數 |
| [getSubscript()](#getSubscript--) | 指定下標參數，例如在 Integral 的情況下，設定下限 |
| [getSuperscript()](#getSuperscript--) | 指定上標參數，例如在 Integral 的情況下，設定上限 |
| [getOperator()](#getOperator--) | N 元運算子字元，例如：'\\u2211', '\\u222b' |
| [setOperator(char value)](#setOperator-char-) | N 元運算子字元，例如：'\\u2211', '\\u222b' |
| [getLimitLocation()](#getLimitLocation--) | 限制的位置（下標與上標） |
| [setLimitLocation(int value)](#setLimitLocation-int-) | 限制的位置（下標與上標） |
| [getGrowToMatchOperandHeight()](#getGrowToMatchOperandHeight--) | 運算子字元垂直增長以匹配其運算元高度 |
| [setGrowToMatchOperandHeight(boolean value)](#setGrowToMatchOperandHeight-boolean-) | 運算子字元垂直增長以匹配其運算元高度 |
