...
| [getTo()](#getTo--) | 描述動畫顏色變更的結果顏色。 |
| [setTo(IColorFormat value)](#setTo-com.aspose.slides.IColorFormat-) | 描述動畫顏色變更的結果顏色。 |
| [getBy()](#getBy--) | 描述顏色動畫的相對位移值。 |
| [setBy(IColorOffset value)](#setBy-com.aspose.slides.IColorOffset-) | 描述顏色動畫的相對位移值。 |
| [getColorSpace()](#getColorSpace--) | 表示行為的顏色空間。 |
| [setColorSpace(int value)](#setColorSpace-int-) | 表示行為的顏色空間。 |
| [getDirection()](#getDirection--) | 指定在色輪上循環色相的方向。 |
| [setDirection(int value)](#setDirection-int-) | 指定在色輪上循環色相的方向。 |
### getFrom() {#getFrom--}
```
public abstract IColorFormat getFrom()
```

此值用於指定行為的起始顏色。可讀寫 [IColorFormat](../../com.aspose.slides/icolorformat)。
...
描述動畫顏色變更的結果顏色。可讀寫 [IColorFormat](../../com.aspose.slides/icolorformat)。
...
描述顏色動畫的相對位移值。可讀寫 [IColorOffset](../../com.aspose.slides/icoloroffset)。
...
表示行為的顏色空間。可讀寫 [ColorSpace](../../com.aspose.slides/colorspace)(\#getColorSpace.getColorSpace/\#setColorSpace(int).setColorSpace(int))。
...
指定在色輪上循環色相的方向。可讀寫 [ColorDirection](../../com.aspose.slides/colordirection)。
