...
代表 [Presentation](../../com.aspose.slides/presentation) 中的動畫產生器。
...
| 建構子 | 說明 |
| --- | --- |
| [PresentationAnimationsGenerator(Presentation presentation)](#PresentationAnimationsGenerator-com.aspose.slides.Presentation-) | 建立 [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) 的新執行個體。 |
| [PresentationAnimationsGenerator(Dimension frameSize)](#PresentationAnimationsGenerator-java.awt.Dimension-) | 建立 [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) 的新執行個體。 |
| [PresentationAnimationsGenerator(Dimension2D frameSize)](#PresentationAnimationsGenerator-java.awt.geom.Dimension2D-) | 建立 [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) 的新執行個體。 |
## 方法

| 方法 | 說明 |
| --- | --- |
| [dispose()](#dispose--) | 釋放 [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) 的執行個體。 |
| [getFrameSize()](#getFrameSize--) | 取得框架大小。 |
| [getDefaultDelay()](#getDefaultDelay--) | 取得或設定預設延遲時間 [ms]。 |
| [setDefaultDelay(int value)](#setDefaultDelay-int-) | 取得或設定預設延遲時間 [ms]。 |
| [getIncludeHiddenSlides()](#getIncludeHiddenSlides--) | 取得或設定是否應包括隱藏投影片。 |
| [setIncludeHiddenSlides(boolean value)](#setIncludeHiddenSlides-boolean-) | 取得或設定是否應包括隱藏投影片。 |
| [getExportedSlides()](#getExportedSlides--) | 取得匯出投影片的計數。 |
...
| [run(System.Collections.Generic.IGenericEnumerable<ISlide> slides)](#run-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.slides.ISlide--) | 為每張投影片執行動畫事件的產生。 |
| [run(System.Collections.Generic.IGenericEnumerable<ISlide> slides, int fps, PresentationPlayer.FrameTick onFrame)](#run-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.slides.ISlide--int-com.aspose.slides.PresentationPlayer.FrameTick-) | 為每張投影片執行動畫事件的產生。 |
...
建立 [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator) 的新執行個體。

**參數：**
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| presentation | [Presentation](../../com.aspose.slides/presentation) | 框架大小將依 [Presentation.getSlideSize](../../com.aspose.slides/presentation\#getSlideSize) 設定。 |
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| frameSize | java.awt.Dimension | 框架大小。 |
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| frameSize | java.awt.geom.Dimension2D | 框架大小。 |
...
>      try {
>          animationsGenerator.setDefaultDelay(1000); // 1 秒
>          // ...
