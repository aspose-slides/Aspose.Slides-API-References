...
| [getExtrusionHeight()](#getExtrusionHeight--) | 傳回或設定 擠出效果的高度。 |
| [setExtrusionHeight(double value)](#setExtrusionHeight-double-) | 傳回或設定 擠出效果的高度。 |
| [getDepth()](#getDepth--) | 傳回或設定 3D 形狀的深度。 |
| [setDepth(double value)](#setDepth-double-) | 傳回或設定 3D 形狀的深度。 |
| [getBevelTop()](#getBevelTop--) | 傳回或設定 頂部 3D 斜角的類型。 |
| [getBevelBottom()](#getBevelBottom--) | 傳回或設定 底部 3D 斜角的類型。 |
| [getContourColor()](#getContourColor--) | 傳回或設定 輪廓的顏色。 |
| [getExtrusionColor()](#getExtrusionColor--) | 傳回或設定 擠出的顏色。 |
| [getCamera()](#getCamera--) | 傳回或設定 攝影機的設定。 |
| [getLightRig()](#getLightRig--) | 傳回或設定 光源的類型。 |
| [getMaterial()](#getMaterial--) | 傳回或設定 材質的類型。 |
| [setMaterial(int value)](#setMaterial-int-) | 傳回或設定 材質的類型。 |
| [getEffective()](#getEffective--) | 取得套用繼承後的有效 3-D 格式化資料。 |
### getVersion() {#getVersion--}
```
...
傳回或設定 頂部 3D 斜角的類型。唯讀 [IShapeBevel](../../com.aspose.slides/ishapebevel)。
...
傳回或設定 底部 3D 斜角的類型。唯讀 [IShapeBevel](../../com.aspose.slides/ishapebevel)。
...
傳回或設定 擠出的顏色。唯讀 [IColorFormat](../../com.aspose.slides/icolorformat)。
...
傳回或設定 攝影機的設定。唯讀 [ICamera](../../com.aspose.slides/icamera)。
