...
| [getExternalResourceResolver()](#getExternalResourceResolver--) | 返回用於在 SVG 文件匯入期間解析外部資源的回呼介面。 |
...
返回用於在 SVG 文件匯入期間解析外部資源的回呼介面。 唯讀 [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver)。
