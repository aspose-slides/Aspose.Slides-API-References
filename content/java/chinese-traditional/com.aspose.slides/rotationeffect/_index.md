...
type: docs
url: /zh-hant/com.aspose.slides/rotationeffect/
---
**繼承:**
...
| 方法 | 說明 |
| --- | --- |
| [getFrom()](#getFrom--) | 說明動畫的起始值。 |
| [setFrom(float value)](#setFrom-float-) | 說明動畫的起始值。 |
| [getTo()](#getTo--) | 說明動畫的結束值。 |
| [setTo(float value)](#setTo-float-) | 說明動畫的結束值。 |
| [getBy()](#getBy--) | 說明動畫的相對偏移值。 |
| [setBy(float value)](#setBy-float-) | 說明動畫的相對偏移值。 |
### RotationEffect() {#RotationEffect--}
```
