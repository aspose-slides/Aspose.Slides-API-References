...
| 方法 | 描述 |
| --- | --- |
| [formatText(ISvgTSpan svgTSpan, IPortion portion, ITextFrame textFrame)](#formatText-com.aspose.slides.ISvgTSpan-com.aspose.slides.IPortion-com.aspose.slides.ITextFrame-) | 此函式會在文字部分渲染成 SVG 之前被呼叫，以允許使用者控制產生的 SVG。 |
...
此函式會在文字部分渲染成 SVG 之前被呼叫，以允許使用者控制產生的 SVG。

**參數：**
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| svgTSpan | [ISvgTSpan](../../com.aspose.slides/isvgtspan) | 用於控制 SVG tspan 產生的物件。 |
| portion | [IPortion](../../com.aspose.slides/iportion) | 來源部份。 |
| textFrame | [ITextFrame](../../com.aspose.slides/itextframe) | 來源部份的文字框。 |