...
type: docs
url: /zh-hant/com.aspose.slides/effectformat/
---
**繼承：**
...
| [isNoEffects()](#isNoEffects--) | 如果所有效果已停用，則傳回 true（剛建立時的預設 EffectFormat 物件）。 |
...
| [setFillOverlayEffect(IFillOverlay value)](#setFillOverlayEffect-com.aspose.slides.IFillOverlay-) | 填充覆蓋效果。 |
| [getGlowEffect()](#getGlowEffect--) | 發光效果。 |
| [setGlowEffect(IGlow value)](#setGlowEffect-com.aspose.slides.IGlow-) | 發光效果。 |
| [getInnerShadowEffect()](#getInnerShadowEffect--) | 內部陰影。 |
| [setInnerShadowEffect(IInnerShadow value)](#setInnerShadowEffect-com.aspose.slides.IInnerShadow-) | 內部陰影。 |
| [getOuterShadowEffect()](#getOuterShadowEffect--) | 外部陰影。 |
| [setOuterShadowEffect(IOuterShadow value)](#setOuterShadowEffect-com.aspose.slides.IOuterShadow-) | 外部陰影。 |
| [getPresetShadowEffect()](#getPresetShadowEffect--) | 預設陰影。 |
| [setPresetShadowEffect(IPresetShadow value)](#setPresetShadowEffect-com.aspose.slides.IPresetShadow-) | 預設陰影。 |
...
| [setSoftEdgeEffect(ISoftEdge value)](#setSoftEdgeEffect-com.aspose.slides.ISoftEdge-) | 柔和邊緣。 |
| [setBlurEffect(double radius, boolean grow)](#setBlurEffect-double-boolean-) | 設定模糊效果。 |
| [enableFillOverlayEffect()](#enableFillOverlayEffect--) | 啟用填充覆蓋效果。 |
| [enableGlowEffect()](#enableGlowEffect--) | 啟用發光效果。 |
| [enableInnerShadowEffect()](#enableInnerShadowEffect--) | 啟用內部陰影效果。 |
| [enableOuterShadowEffect()](#enableOuterShadowEffect--) | 啟用外部陰影效果。 |
| [enablePresetShadowEffect()](#enablePresetShadowEffect--) | 啟用預設陰影效果。 |
| [enableReflectionEffect()](#enableReflectionEffect--) | 啟用反射效果。 |
| [enableSoftEdgeEffect()](#enableSoftEdgeEffect--) | 啟用柔和邊緣效果。 |
| [disableBlurEffect()](#disableBlurEffect--) | 停用模糊效果。 |
| [disableFillOverlayEffect()](#disableFillOverlayEffect--) | 停用填充覆蓋效果。 |
| [disableGlowEffect()](#disableGlowEffect--) | 停用發光效果。 |
| [disableInnerShadowEffect()](#disableInnerShadowEffect--) | 停用內部陰影效果。 |
| [disableOuterShadowEffect()](#disableOuterShadowEffect--) | 停用外部陰影效果。 |
| [disablePresetShadowEffect()](#disablePresetShadowEffect--) | 停用預設陰影效果。 |
| [disableReflectionEffect()](#disableReflectionEffect--) | 停用反射效果。 |
| [disableSoftEdgeEffect()](#disableSoftEdgeEffect--) | 停用柔和邊緣效果。 |
| [getEffective()](#getEffective--) | 取得套用繼承的有效效果格式化資料。 |
### getVersion() {#getVersion--}
```
...
如果所有效果已停用，則傳回 true（剛建立時的預設 EffectFormat 物件）。只讀 boolean .
...
模糊效果。可讀寫 [IBlur](../../com.aspose.slides/iblur)。
...
填充覆蓋效果。可讀寫 [IFillOverlay](../../com.aspose.slides/ifilloverlay)。
...
發光效果。可讀寫 [IGlow](../../com.aspose.slides/iglow)。
...
內部陰影。可讀寫 [IInnerShadow](../../com.aspose.slides/iinnershadow)。
...
外部陰影。可讀寫 [IOuterShadow](../../com.aspose.slides/ioutershadow)。
...
預設陰影。可讀寫 [IPresetShadow](../../com.aspose.slides/ipresetshadow)。
...
反射。可讀寫 [IReflection](../../com.aspose.slides/ireflection)。
...
柔和邊緣。可讀寫 [ISoftEdge](../../com.aspose.slides/isoftedge)。
...
**傳回值：**
[IEffectFormatEffectiveData](../../com.aspose.slides/ieffectformateffectivedata) - 一個 [IEffectFormatEffectiveData](../../com.aspose.slides/ieffectformateffectivedata).