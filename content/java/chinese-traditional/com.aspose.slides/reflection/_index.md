...
| 方法 | 說明 |
| --- | --- |
| [getStartPosAlpha()](#getStartPosAlpha--) | 指定起始 alpha 值（以百分比表示）在 alpha 漸層斜坡上的起始位置。 |
| [setStartPosAlpha(float value)](#setStartPosAlpha-float-) | 指定起始 alpha 值（以百分比表示）在 alpha 漸層斜坡上的起始位置。 |
| [getEndPosAlpha()](#getEndPosAlpha--) | 指定結束 alpha 值（以百分比表示）在 alpha 漸層斜坡上的結束位置。 |
| [setEndPosAlpha(float value)](#setEndPosAlpha-float-) | 指定結束 alpha 值（以百分比表示）在 alpha 漸層斜坡上的結束位置。 |
...
| [setSkewHorizontal(double value)](#setSkewHorizontal-double-) | 指定水平斜切角度。 |
| [getSkewVertical()](#getSkewVertical--) | 指定垂直斜切角度。 |
| [setSkewVertical(double value)](#setSkewVertical-double-) | 指定垂直斜切角度。 |
...
| [setScaleHorizontal(double value)](#setScaleHorizontal-double-) | 指定水平縮放因子，負值縮放會導致翻轉。 |
| [getScaleVertical()](#getScaleVertical--) | 指定垂直縮放因子，負值縮放會導致翻轉。 |
| [setScaleVertical(double value)](#setScaleVertical-double-) | 指定垂直縮放因子，負值縮放會導致翻轉。 |
...
指定起始 alpha 值（以百分比表示）在 alpha 漸層斜坡上的起始位置。讀寫 float。
...
指定結束 alpha 值（以百分比表示）在 alpha 漸層斜坡上的結束位置。讀寫 float。
...
指定水平縮放因子，負值縮放會導致翻轉。（百分比）讀寫 double。
...
指定垂直縮放因子，負值縮放會導致翻轉。（百分比）讀寫 double。
