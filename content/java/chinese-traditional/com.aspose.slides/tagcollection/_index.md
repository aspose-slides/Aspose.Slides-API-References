...
| 方法 | 說明 |
| --- | --- |
| [size()](#size--) | 傳回集合中標記的數量。 |
| [add(String name, String value)](#add-java.lang.String-java.lang.String-) | 將新標記加入集合。 |
| [remove(String name)](#remove-java.lang.String-) | 從集合中移除具有指定名稱的標記。 |
...
| [removeAt(int index)](#removeAt-int-) | 從集合中移除指定索引處的標記。 |
| [clear()](#clear--) | 從集合中移除所有標記。 |
| [getValueByIndex(int index)](#getValueByIndex-int-) | 傳回指定索引處的標記值。 |
| [getNameByIndex(int index)](#getNameByIndex-int-) | 傳回指定索引處的標記鍵。 |
| [getNamesOfTags()](#getNamesOfTags--) | 傳回標記的名稱。 |
| [get_Item(String name)](#get-Item-java.lang.String-) | 傳回或設定標記的鍵和值。 |
| [set_Item(String name, String value)](#set-Item-java.lang.String-java.lang.String-) | 傳回或設定標記的鍵和值。 |
...
| 參數 | 型別 | 說明 |
| --- | --- | --- |
| name | java.lang.String | 標記的名稱。 |
| value | java.lang.String | 標記的值。 |
...
| 參數 | 型別 | 說明 |
| --- | --- | --- |
| name | java.lang.String | 要移除的標記名稱。 |
...
**傳回:**
boolean - 若集合包含具有指定鍵的標記則傳回 true；否則傳回 false。
