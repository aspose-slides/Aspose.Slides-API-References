...
description: 指定產生圖像的像素格式。
type: docs
url: /zh-hant/com.aspose.slides/imagepixelformat/
---
**繼承：**
...
| 欄位 | 描述 |
| --- | --- |
| [Format1bppIndexed](#Format1bppIndexed) | 每像素 1 位，索引模式。 |
| [Format4bppIndexed](#Format4bppIndexed) | 每像素 4 位，索引模式。 |
| [Format8bppIndexed](#Format8bppIndexed) | 每像素 8 位，索引模式。 |
| [Format24bppRgb](#Format24bppRgb) | 每像素 24 位，RGB。 |
| [Format32bppArgb](#Format32bppArgb) | 每像素 32 位，ARGB。 |
