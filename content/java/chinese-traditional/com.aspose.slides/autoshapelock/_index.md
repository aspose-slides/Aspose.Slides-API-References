...
description: 判斷在父層 AutoshapeEx 上哪些操作被停用。
type: docs
url: /zh-hant/com.aspose.slides/autoshapelock/
---
**繼承關係：**
...
判斷在父層 AutoshapeEx 上哪些操作被停用。
## 方法

| 方法 | 說明 |
| --- | --- |
| [getGroupingLocked()](#getGroupingLocked--) | 判斷是否禁止將此形狀新增至群組。 |
| [setGroupingLocked(boolean value)](#setGroupingLocked-boolean-) | 判斷是否禁止將此形狀新增至群組。 |
...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | 判斷在調整大小時是否必須保持形狀的長寬比。 |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | 判斷在調整大小時是否必須保持形狀的長寬比。 |
...
| [getArrowheadsLocked()](#getArrowheadsLocked--) | 判斷是否禁止變更箭頭頭端。 |
| [setArrowheadsLocked(boolean value)](#setArrowheadsLocked-boolean-) | 判斷是否禁止變更箭頭頭端。 |
