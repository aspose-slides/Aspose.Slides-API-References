...
description: 指定 Sub-Superscript 物件，其由基底以及放置於基底右側的下標與上標組成。
type: docs
...
指定 Sub-Superscript 物件，其由基底以及放置於基底右側的下標與上標組成。
...
指定下標/上標的對齊方式。當值為 true 時，下標與上標會水平對齊。當值為 false 時，會根據基底的形狀進行字距調整。預設值為 false。
