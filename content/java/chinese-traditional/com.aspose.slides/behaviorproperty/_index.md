...
表示動畫行為的屬性類型。參考以下屬性清單：https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx 與 https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx
## 方法
...
| [getPptX()](#getPptX--) | 表示 'ppt\_x' 屬性 |
| [getPptY()](#getPptY--) | 表示 'ppt\_y' 屬性 |
| [getPptW()](#getPptW--) | 表示 'ppt\_w' 屬性 |
| [getPptH()](#getPptH--) | 表示 'ppt\_h' 屬性 |
| [getPptC()](#getPptC--) | 表示 'ppt\_c' 屬性 |
| [getPptR()](#getPptR--) | 表示 'ppt\_r' 屬性 |
...
| [hashCode()](#hashCode--) | 根據 (\#getValue.getValue) 屬性計算並返回雜湊碼 |
| [getOrCreateByValue(String propertyValue)](#getOrCreateByValue-java.lang.String-) | 依值搜尋現有行為屬性，或以指定值建立新的自訂屬性 |
