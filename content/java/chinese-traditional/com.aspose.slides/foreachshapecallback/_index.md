...
| 方法 | 描述 |
| --- | --- |
| [invoke(Shape shape, BaseSlide slide, int index)](#invoke-com.aspose.slides.Shape-com.aspose.slides.BaseSlide-int-) | 將在 [Presentation](../../com.aspose.slides/presentation) 中為每個 [Shape](../../com.aspose.slides/shape) 觸發的回呼。 |
...
將在 [Presentation](../../com.aspose.slides/presentation) 中為每個 [Shape](../../com.aspose.slides/shape) 觸發的回呼。
