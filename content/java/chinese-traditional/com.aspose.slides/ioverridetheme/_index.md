...
| Method | Description |
| --- | --- |
| [isEmpty()](#isEmpty--) | True 值表示 ColorScheme、FontScheme、FormatScheme 為 null，且任何對此主題物件的覆寫均已停用。 |
...
| [clear()](#clear--) | 將 ColorScheme、FontScheme、FormatScheme 設為 null，以停用任何對此主題物件的覆寫。 |
### isEmpty() {#isEmpty--}
```
public abstract boolean isEmpty()
```

True 值表示 ColorScheme、FontScheme、FormatScheme 為 null，且任何對此主題物件的覆寫均已停用。唯讀 boolean。
...
將 ColorScheme、FontScheme、FormatScheme 設為 null，以停用任何對此主題物件的覆寫。