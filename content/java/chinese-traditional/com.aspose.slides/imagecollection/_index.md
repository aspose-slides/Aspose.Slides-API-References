...
| [addImage(IPPImage imageSource)](#addImage-com.aspose.slides.IPPImage-) | 從另一個簡報中新增圖像的副本。 |
| [addImage(IImage image)](#addImage-com.aspose.slides.IImage-) | 將圖像新增至簡報。 |
| [addImage(InputStream stream)](#addImage-java.io.InputStream-) | 從串流將圖像新增至簡報。 |
| [addImage(InputStream stream, int loadingStreamBehavior)](#addImage-java.io.InputStream-int-) | 從串流建立並將圖像新增至簡報。 |
| [addImage(byte[] buffer)](#addImage-byte---) | 從指定的緩衝區將圖像新增至簡報。 |
| [addImage(ISvgImage svgImage)](#addImage-com.aspose.slides.ISvgImage-) | 從 Svg 物件將圖像新增至簡報。 |
...
**返回:**
[IPPImage](../../com.aspose.slides/ippimage) - 已新增的圖像。
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| image | [IImage](../../com.aspose.slides/iimage) | 要新增的圖像。 |

--------------------

此方法會在將 WMF/EMF 中繪圖檔案插入簡報之前，先將其轉換為點陣 PNG 圖像。 |
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| stream | java.io.InputStream | 要從中新增圖像的串流。 |

--------------------

此方法可將 WMF/EMF 中繪圖檔案直接新增至簡報，而不需轉換為點陣 PNG 圖像。 |
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| stream | java.io.InputStream | 要從中新增圖像檔案的串流。 |
| loadingStreamBehavior | int | 將套用於串流的行為。 |

**返回:**
[IPPImage](../../com.aspose.slides/ippimage) - 已新增 [IPPImage](../../com.aspose.slides/ippimage)。
...
**返回:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IPPImage> - 整個集合的 java.util.Iterator。
