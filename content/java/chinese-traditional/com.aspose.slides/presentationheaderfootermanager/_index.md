...
| 方法 | 說明 |
| --- | --- |
| [setAllHeadersVisibility(boolean isVisible)](#setAllHeadersVisibility-boolean-) | 更改所有標頭佔位符的可見性，包括註解母片、註解投影片和講義母片。 |
| [setAllFootersVisibility(boolean isVisible)](#setAllFootersVisibility-boolean-) | 更改所有頁腳佔位符的可見性，包括母片、版面投影片、投影片、註解母片、註解投影片和講義母片。 |
| [setAllSlideNumbersVisibility(boolean isVisible)](#setAllSlideNumbersVisibility-boolean-) | 更改所有頁碼佔位符的可見性，包括母片、版面投影片、投影片、註解母片、註解投影片和講義母片。 |
| [setAllDateTimesVisibility(boolean isVisible)](#setAllDateTimesVisibility-boolean-) | 更改所有日期時間佔位符的可見性，包括母片、版面投影片、投影片、註解母片、註解投影片和講義母片。 |
| [setAllHeadersText(String text)](#setAllHeadersText-java.lang.String-) | 設定所有標頭佔位符的文字，包括註解母片、註解投影片和講義母片。 |
| [setAllFootersText(String text)](#setAllFootersText-java.lang.String-) | 設定所有頁腳佔位符的文字，包括母片、版面投影片、投影片、註解母片、註解投影片和講義母片。 |
| [setAllDateTimesText(String text)](#setAllDateTimesText-java.lang.String-) | 設定所有日期時間佔位符的文字，包括母片、版面投影片、投影片、註解母片、註解投影片和講義母片。 |
| [setVisibilityOnAllTitleSlides(boolean isVisible)](#setVisibilityOnAllTitleSlides-boolean-) | 更改所有標題投影片以及第一個版面投影片的頁腳、日期時間和頁碼佔位符的可見性。 |
...
更改所有標頭佔位符的可見性，包括註解母片、註解投影片和講義母片。
...
更改所有頁腳佔位符的可見性，包括母片、版面投影片、投影片、註解母片、註解投影片和講義母片。
...
更改所有頁碼佔位符的可見性，包括母片、版面投影片、投影片、註解母片、註解投影片和講義母片。
...
更改所有日期時間佔位符的可見性，包括母片、版面投影片、投影片、註解母片、註解投影片和講義母片。
...
設定所有標頭佔位符的文字，包括註解母片、註解投影片和講義母片。
...
設定所有頁腳佔位符的文字，包括母片、版面投影片、投影片、註解母片、註解投影片和講義母片。
...
設定所有日期時間佔位符的文字，包括母片、版面投影片、投影片、註解母片、註解投影片和講義母片。
...
更改所有標題投影片以及第一個版面投影片的頁腳、日期時間和頁碼佔位符的可見性。 Title slides \\u2013 以第一個版面投影片為基礎的投影片（不論此第一個版面投影片的類型）。
