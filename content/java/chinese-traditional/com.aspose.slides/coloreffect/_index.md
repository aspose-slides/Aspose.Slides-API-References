...
type: docs
url: /zh-hant/com.aspose.slides/coloreffect/
---
**繼承:**  
...
| [getTo()](#getTo--) | 描述動畫顏色變化的最終顏色。 |
| [setTo(IColorFormat value)](#setTo-com.aspose.slides.IColorFormat-) | 描述動畫顏色變化的最終顏色。 |
...
此值用於指定行為的起始顏色。讀/寫 [IColorFormat](../../com.aspose.slides/icolorformat)。
...
描述動畫顏色變化的最終顏色。讀/寫 [IColorFormat](../../com.aspose.slides/icolorformat)。
...
描述顏色動畫的相對偏移值。讀/寫 [IColorOffset](../../com.aspose.slides/icoloroffset)。
...
表示行為的顏色空間。讀/寫 [ColorSpace](../../com.aspose.slides/colorspace)。
...
指定在色輪上循環色相的方向。讀/寫 [ColorDirection](../../com.aspose.slides/colordirection)。
