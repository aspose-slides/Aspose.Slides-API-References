...
| [add(IParagraph value)](#add-com.aspose.slides.IParagraph-) | 在集合末端新增一個 Paragraph。 |
| [add(IParagraphCollection value)](#add-com.aspose.slides.IParagraphCollection-) | 在集合末端新增 ParagraphCollection 的內容。 |
...
| [contains(IParagraph item)](#contains-com.aspose.slides.IParagraph-) | 確定 [IGenericCollection](../../com.aspose.slides/igenericcollection) 是否包含特定值。 |
| [copyTo(IParagraph[] array, int arrayIndex)](#copyTo-com.aspose.slides.IParagraph---int-) | 將 [IGenericCollection](../../com.aspose.slides/igenericcollection) 的元素複製到陣列，從特定的陣列索引開始。 |
| [removeAt(int index)](#removeAt-int-) | 移除集合中指定索引處的元素。 |
| [remove(IParagraph item)](#remove-com.aspose.slides.IParagraph-) | 從 [IGenericCollection](../../com.aspose.slides/igenericcollection) 中移除特定物件的首次出現。 |
...
| [addFromHtml(String text)](#addFromHtml-java.lang.String-) | 將指定的 HTML 字串文字新增至集合。 |
| [addFromHtml(String text, IExternalResourceResolver resolver, String uri)](#addFromHtml-java.lang.String-com.aspose.slides.IExternalResourceResolver-java.lang.String-) | 將指定的 HTML 字串文字新增至集合。 |
...
**返回值：**
boolean - 若 [IGenericCollection](../../com.aspose.slides/igenericcollection) 為唯讀則傳回 true；否則傳回 false。
...
在集合末端新增 ParagraphCollection 的內容。
...
**返回值：**
boolean - 若在 [IGenericCollection](../../com.aspose.slides/igenericcollection) 中找到項目則傳回 true；否則傳回 false。
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| array | [IParagraph\[\]](../../com.aspose.slides/iparagraph) | 作為從 [IGenericCollection](../../com.aspose.slides/igenericcollection) 複製元素之目的地的一維陣列。陣列必須使用零基索引。 |
| arrayIndex | int | 複製開始於陣列的零基索引。 |
...
**返回值：**
boolean - 若項目已成功從 [IGenericCollection](../../com.aspose.slides/igenericcollection) 中移除則傳回 true；否則傳回 false。若在原始 [IGenericCollection](../../com.aspose.slides/igenericcollection) 中找不到項目，此方法亦傳回 false。
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| firstParagraphIndex | int | 第一個段落的索引 int |
