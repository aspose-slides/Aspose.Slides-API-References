...
| 建構式 | 說明 |
| --- | --- |
| [SwfOptions()](#SwfOptions--) | 預設建構式。 |
## 方法

| 方法 | 說明 |
| --- | --- |
| [getShowHiddenSlides()](#getShowHiddenSlides--) | 指定產生的文件是否應包括隱藏投影片。 |
| [setShowHiddenSlides(boolean value)](#setShowHiddenSlides-boolean-) | 指定產生的文件是否應包括隱藏投影片。 |
...
| [getShowPageBorder()](#getShowPageBorder--) | 指定是否顯示頁面的邊框。 |
| [setShowPageBorder(boolean value)](#setShowPageBorder-boolean-) | 指定是否顯示頁面的邊框。 |
...
| [getStartOpenLeftPane()](#getStartOpenLeftPane--) | 預設左側面板為打開狀態。 |
| [setStartOpenLeftPane(boolean value)](#setStartOpenLeftPane-boolean-) | 預設左側面板為打開狀態。 |
...
| [getLogoImageBytes()](#getLogoImageBytes--) | 圖像將顯示於檢視器右上角的標誌。 |
| [setLogoImageBytes(byte[] value)](#setLogoImageBytes-byte---) | 圖像將顯示於檢視器右上角的標誌。 |
...
預設左側面板為打開狀態。可在 flashvars 中覆寫。預設為 false。
...
圖像將顯示於檢視器右上角的標誌。圖像應為 32x64 像素的 PNG 圖檔，否則標誌可能顯示不正常。
...
取得或設定標誌的完整超連結位址。僅在指定 (\#getLogoImageBytes.getLogoImageBytes/\#setLogoImageBytes(byte[]).setLogoImageBytes(byte[])) 時才有作用。
