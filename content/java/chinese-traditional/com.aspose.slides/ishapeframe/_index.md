...
| 方法 | 說明 |
| --- | --- |
| [getX()](#getX--) | 返回框架左上角的 X 坐標。 |
| [getY()](#getY--) | 返回框架左上角的 Y 坐標。 |
| [getWidth()](#getWidth--) | 返回框架的寬度。 |
| [getHeight()](#getHeight--) | 返回框架的高度。 |
| [getRotation()](#getRotation--) | 返回框架繞 Z 軸旋轉的角度（度數）。 |
| [getCenterX()](#getCenterX--) | 返回框架中心的 X 坐標。 |
| [getCenterY()](#getCenterY--) | 返回框架中心的 Y 坐標。 |
...
返回框架繞 Z 軸旋轉的角度（度數）。正值表示順時針旋轉；負值表示逆時針旋轉。唯讀 float。
...
返回框架的座標。唯讀 java.awt.geom.Rectangle2D.Float。
