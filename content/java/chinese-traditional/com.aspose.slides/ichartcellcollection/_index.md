...
| [getConcatenatedValuesFromCells()](#getConcatenatedValuesFromCells--) | 從所有儲存格字串值拼接而成的字串。 |
| [get_Item(int index)](#get-Item-int-) | 依據索引返回一個儲存格 (IChartDataCell)。 |
| [add(IChartDataCell chartDataCell)](#add-com.aspose.slides.IChartDataCell-) | 將新儲存格新增至集合中。 |
| [add(Object value)](#add-java.lang.Object-) | 根據指定的值建立 [IChartDataCell](../../com.aspose.slides/ichartdatacell)，並將其新增至集合中。 |
| [removeAt(int index)](#removeAt-int-) | 依據索引從集合中移除儲存格。 |
...
根據指定的值建立 [IChartDataCell](../../com.aspose.slides/ichartdatacell)，並將其新增至集合中。
...
此方法會新增名稱為 AUTO_DATA 的工作表，並將所有值新增至該工作表。如果您使用 [IChartDataWorkbook](../../com.aspose.slides/ichartdataworkbook) 來新增或編輯儲存格的值，請確保不要使用此工作表。使用此方法新增的值的最大數量不得超過 16711680 |
