...
| [addClone(IRow templ, boolean withAttachedRows)](#addClone-com.aspose.slides.IRow-boolean-) | 建立指定範本列的副本，並將其插入表格的底部。 |
...
| [removeAt(int firstRowIndex, boolean withAttachedRows)](#removeAt-int-boolean-) | 從表格中移除指定位置的列。 |
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| templ | [IRow](../../com.aspose.slides/irow) | 作為範本的列。 |
| withAttachedRows | boolean | True 以同時複製所有附屬於範本列的列。 |
...
| withAttachedRows | boolean | True 以同時刪除所有附屬的列。 |