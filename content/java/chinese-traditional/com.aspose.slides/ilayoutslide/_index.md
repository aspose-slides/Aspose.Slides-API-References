...
| 方法 | 說明 |
| --- | --- |
| [getHeaderFooterManager()](#getHeaderFooterManager--) | 傳回 HeaderFooter 管理員於版面投影片。 |
| [getPlaceholderManager()](#getPlaceholderManager--) | 傳回版面投影片的 placeholder 管理員。 |
...
| [getDependingSlides()](#getDependingSlides--) | 傳回包含所有依賴此版面投影片之投影片的陣列。 |
...
傳回 HeaderFooter 管理員於版面投影片。唯讀 [ILayoutSlideHeaderFooterManager](../../com.aspose.slides/ilayoutslideheaderfootermanager)。
...
傳回版面投影片的 placeholder 管理員。唯讀 [ILayoutPlaceholderManager](../../com.aspose.slides/ilayoutplaceholdermanager)。
...
**傳回：**
com.aspose.slides.ISlide[] - 陣列，包含所有依賴此版面投影片的投影片
### remove() {#remove--}
```
