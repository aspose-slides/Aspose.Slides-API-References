...
| 方法 | 說明 |
| --- | --- |
| [getShowMasterShapes()](#getShowMasterShapes--) | 指定是否在投影片上顯示母投影片上的形狀。 |
| [setShowMasterShapes(boolean value)](#setShowMasterShapes-boolean-) | 指定是否在投影片上顯示母投影片上的形狀。 |
...
指定是否在投影片上顯示母投影片上的形狀。對於母投影片本身，此屬性始終傳回 false。可讀寫布林值。
