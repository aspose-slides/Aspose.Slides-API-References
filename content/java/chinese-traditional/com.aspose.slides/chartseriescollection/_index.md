...
代表 [ChartSeries](../../com.aspose.slides/chartseries) 的集合
## 方法
...
| [indexOf(IChartSeries value)](#indexOf-com.aspose.slides.IChartSeries-) | 搜尋指定的 [ChartSeries](../../com.aspose.slides/chartseries)，並回傳整個 Collection 中首次出現的零基索引。 |
...
| [copyTo(System.Array array, int index)](#copyTo-com.aspose.ms.System.Array-int-) | 將整個集合複製至指定的陣列。 |
...
如果從相同的儲存格建立的圖表系列已經在集合中，則此方法不會新增任何內容，並返回其索引。
...
搜尋指定的 [ChartSeries](../../com.aspose.slides/chartseries)，並回傳整個 CollectionBase 中首次出現的零基索引，如果找到；否則返回 -1。
...
**傳回值：**
int - 如果找到，返回整個 CollectionBase 中該值首次出現的零基索引；否則返回 -1。
...
**傳回值：**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IChartSeries> - 用於遍歷集合的 java.util.Iterator。
