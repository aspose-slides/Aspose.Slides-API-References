...
description: 表示 FrameTickDelegate.FrameTickDelegate 事件的框架刻度處理程序。
type: docs
url: /zh-hant/com.aspose.slides/presentationplayer.frametick/
---```
public static interface PresentationPlayer.FrameTick
```

表示 \#FrameTickDelegate.FrameTickDelegate 事件的框架刻度處理程序。
## 方法
