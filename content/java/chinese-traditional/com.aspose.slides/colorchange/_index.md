...
| [getToColor()](#getToColor--) | 用來取代的顏色。 |
| [getEffective()](#getEffective--) | 取得套用繼承後的有效 Color Change 效果資料。 |
...
用來取代的顏色。唯讀 [IColorFormat](../../com.aspose.slides/icolorformat)。
