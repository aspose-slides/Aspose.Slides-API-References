...
| [isFormatNotDefined()](#isFormatNotDefined--) | 若線條格式未定義（即剛建立時的預設），則返回 true。 |
| [getFillFormat()](#getFillFormat--) | 返回線條的填充格式。 |
| [getSketchFormat()](#getSketchFormat--) | 返回線條的素描格式。 |
...
| [getCustomDashPattern()](#getCustomDashPattern--) | 返回或設定自訂虛線圖案。 |
| [setCustomDashPattern(float[] value)](#setCustomDashPattern-float---) | 返回或設定自訂虛線圖案。 |
| [getCapStyle()](#getCapStyle--) | 返回或設定線條的端點樣式。 |
| [setCapStyle(byte value)](#setCapStyle-byte-) | 返回或設定線條的端點樣式。 |
| [getStyle()](#getStyle--) | 返回或設定線條的樣式。 |
| [setStyle(byte value)](#setStyle-byte-) | 返回或設定線條的樣式。 |
| [getAlignment()](#getAlignment--) | 返回或設定線條的對齊方式。 |
| [setAlignment(byte value)](#setAlignment-byte-) | 返回或設定線條的對齊方式。 |
| [getJoinStyle()](#getJoinStyle--) | 返回或設定線條的接合樣式。 |
| [setJoinStyle(byte value)](#setJoinStyle-byte-) | 返回或設定線條的接合樣式。 |
| [getMiterLimit()](#getMiterLimit--) | 返回或設定線條的斜接限制。 |
| [setMiterLimit(float value)](#setMiterLimit-float-) | 返回或設定線條的斜接限制。 |
...
若線條格式未定義（即剛建立時的預設），則返回 true。唯讀 boolean 。
...
返回線條的素描格式。唯讀 [ILineFillFormat](../../com.aspose.slides/ilinefillformat)。
...
返回或設定線條的樣式。可讀寫 [LineStyle](../../com.aspose.slides/linestyle)。
...
返回或設定線條的對齊方式。可讀寫 [LineAlignment](../../com.aspose.slides/linealignment)。
...
**返回：**
boolean - **true** 若指定的 LineFormat 與目前的 LineFormat 相等；否則 **false**。
