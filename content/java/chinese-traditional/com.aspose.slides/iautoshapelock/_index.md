...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | 判斷是否必須在調整大小時保持長寬比例。 |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | 判斷是否必須在調整大小時保持長寬比例。 |
