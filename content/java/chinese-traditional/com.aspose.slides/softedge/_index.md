...
表示柔化邊緣效果。形狀的邊緣會被模糊，而填充不受影響。

## 方法

| 方法 | 說明 |
| --- | --- |
| [getRadius()](#getRadius--) | 指定套用於邊緣的模糊半徑。 |
| [setRadius(double value)](#setRadius-double-) | 指定套用於邊緣的模糊半徑。 |
