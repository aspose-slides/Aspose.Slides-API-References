...
| 方法 | 說明 |
| --- | --- |
| [getTitle()](#getTitle--) | 返回 Summary Zoom Section 物件的文字標題。 |
| [setTitle(String value)](#setTitle-java.lang.String-) | 返回 Summary Zoom Section 物件的文字標題。 |
| [getDescription()](#getDescription--) | 返回 Summary Zoom Section 物件的文字描述。 |
| [setDescription(String value)](#setDescription-java.lang.String-) | 返回 Summary Zoom Section 物件的文字描述。 |
### getTitle() {#getTitle--}
```
