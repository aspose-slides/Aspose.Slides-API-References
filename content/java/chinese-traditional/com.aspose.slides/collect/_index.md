...
description: 表示一組旨在從中收集不同類型模型物件的方法。
type: docs
...
| 方法 | 說明 |
| --- | --- |
| [shapes(Presentation pres)](#shapes-com.aspose.slides.Presentation-) | 收集 [Shape](../../com.aspose.slides/shape) 在 [Presentation](../../com.aspose.slides/presentation) 中的所有實例。 |
### Collect() {#Collect--}
```
public Collect()
```
...
收集 [Shape](../../com.aspose.slides/shape) 在 [Presentation](../../com.aspose.slides/presentation) 中的所有實例。
