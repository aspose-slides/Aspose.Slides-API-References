...
type: docs
url: /zh-hant/com.aspose.slides/ilegendentryproperties/
---
**所有已實作的介面：**
...
| 方法 | 描述 |
| --- | --- |
| [getHide()](#getHide--) | 返回或設定圖例項目的隱藏旗標。 |
| [setHide(boolean value)](#setHide-boolean-) | 返回或設定圖例項目的隱藏旗標。 |
### getHide() {#getHide--}
```
public abstract boolean getHide()
```

返回或設定圖例項目的隱藏旗標。讀/寫 布林值。
