...
| 方法 | 說明 |
| --- | --- |
| [getCompressed()](#getCompressed--) | 指定產生的 SWF 文件是否應該壓縮。 |
| [setCompressed(boolean value)](#setCompressed-boolean-) | 指定產生的 SWF 文件是否應該壓縮。 |
| [getViewerIncluded()](#getViewerIncluded--) | 指定產生的 SWF 文件是否應該包含內建的文件檢視器。 |
| [setViewerIncluded(boolean value)](#setViewerIncluded-boolean-) | 指定產生的 SWF 文件是否應該包含內建的文件檢視器。 |
| [getShowPageBorder()](#getShowPageBorder--) | 指定是否顯示頁面周圍的邊框。 |
| [setShowPageBorder(boolean value)](#setShowPageBorder-boolean-) | 指定是否顯示頁面周圍的邊框。 |
| [getShowHiddenSlides()](#getShowHiddenSlides--) | 指定產生的文件是否應該包含隱藏投影片。 |
| [setShowHiddenSlides(boolean value)](#setShowHiddenSlides-boolean-) | 指定產生的文件是否應該包含隱藏投影片。 |
...
| [getShowTopPane()](#getShowTopPane--) | 顯示/隱藏頂部整個面板。 |
| [setShowTopPane(boolean value)](#setShowTopPane-boolean-) | 顯示/隱藏頂部整個面板。 |
...
| [getEnableContextMenu()](#getEnableContextMenu--) | 啟用/停用功能表。 |
| [setEnableContextMenu(boolean value)](#setEnableContextMenu-boolean-) | 啟用/停用功能表。 |
| [getLogoImageBytes()](#getLogoImageBytes--) | 將作為檢視器右上角標誌顯示的圖片。 |
| [setLogoImageBytes(byte[] value)](#setLogoImageBytes-byte---) | 將作為檢視器右上角標誌顯示的圖片。 |
...
| [getSlidesLayoutOptions()](#getSlidesLayoutOptions--) | 取得或設定匯出演示文稿時投影片在頁面上的排列模式 [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions)。 |
| [setSlidesLayoutOptions(ISlidesLayoutOptions value)](#setSlidesLayoutOptions-com.aspose.slides.ISlidesLayoutOptions-) | 取得或設定匯出演示文稿時投影片在頁面上的排列模式 [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions)。 |
...
指定產生的 SWF 文件是否應該包含內建的文件檢視器。預設為 true。
...
顯示/隱藏頂部整個面板。可在 flashvars 中覆寫。預設為 true。
...
將作為檢視器右上角標誌顯示的圖片。圖片應為 32x64 像素的 PNG 圖片，否則標誌可能顯示不正常。
...
取得或設定標誌的完整超連結位址。僅在指定 (\#getLogoImageBytes.getLogoImageBytes/\#setLogoImageBytes(byte[]).setLogoImageBytes(byte[])) 時才有效。
...
取得或設定匯出演示文稿時投影片在頁面上的排列模式 [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions)。此屬性不支援指派 [HandoutLayoutingOptions](../../com.aspose.slides/handoutlayoutingoptions) 類型的物件。
