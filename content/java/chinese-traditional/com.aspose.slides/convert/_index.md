...
| 方法 | 描述 |
| --- | --- |
| [autoByExtension(String presPath, String outPath)](#autoByExtension-java.lang.String-java.lang.String-) | 使用傳入的輸出路徑副檔名以確定所需的匯出格式，將 [Presentation](../../com.aspose.slides/presentation) 轉換。 |
...
| [toJpeg(Presentation pres, String outputFileName)](#toJpeg-com.aspose.slides.Presentation-java.lang.String-) | 將輸入簡報轉換為一組 JPEG 格式的影像。 |
| [toJpeg(Presentation pres, String outputFileName, Dimension imageSize)](#toJpeg-com.aspose.slides.Presentation-java.lang.String-java.awt.Dimension-) | 將輸入簡報轉換為一組 JPEG 格式的影像。 |
| [toJpeg(Presentation pres, String outputFileName, float scale, IRenderingOptions options)](#toJpeg-com.aspose.slides.Presentation-java.lang.String-float-com.aspose.slides.IRenderingOptions-) | 將輸入簡報轉換為一組 JPEG 格式的影像。 |
| [toPng(Presentation pres, String outputFileName)](#toPng-com.aspose.slides.Presentation-java.lang.String-) | 將輸入簡報轉換為一組 PNG 格式的影像。 |
| [toPng(Presentation pres, String outputFileName, Dimension imageSize)](#toPng-com.aspose.slides.Presentation-java.lang.String-java.awt.Dimension-) | 將輸入簡報轉換為一組 PNG 格式的影像。 |
| [toPng(Presentation pres, String outputFileName, float scale, IRenderingOptions options)](#toPng-com.aspose.slides.Presentation-java.lang.String-float-com.aspose.slides.IRenderingOptions-) | 將輸入簡報轉換為一組 PNG 格式的影像。 |
| [toTiff(Presentation pres, String outputFileName)](#toTiff-com.aspose.slides.Presentation-java.lang.String-) | 將輸入簡報轉換為一組 TIFF 格式的影像。 |
| [toTiff(Presentation pres, String outputFileName, ITiffOptions options, boolean multipage)](#toTiff-com.aspose.slides.Presentation-java.lang.String-com.aspose.slides.ITiffOptions-boolean-) | 以自訂選項將輸入簡報轉換為 TIFF 格式。 |
...
使用傳入的輸出路徑副檔名以確定所需的匯出格式，將 [Presentation](../../com.aspose.slides/presentation) 轉換。
...
| presPath | java.lang.String | 輸入簡報的路徑 |
| outPath | java.lang.String | 輸出路徑 |
| options | [IPdfOptions](../../com.aspose.slides/ipdfoptions) | 輸出 PDF 選項 |
...
| --- | --- | --- |
| presPath | java.lang.String | 輸入簡報的路徑 |
| getOutPath | [GetOutPathCallback](../../com.aspose.slides/getoutpathcallback) | 為簡報中每張投影片返回 SVG 輸出路徑的回呼函式 |
...
將輸入簡報轉換為一組 JPEG 格式的影像。若輸出檔名為 "myPath/myFilename.jpeg"，結果將儲存為一組 "myPath/myFilename\_N.jpeg" 檔案，其中 N 為投影片編號。
...
| pres | [Presentation](../../com.aspose.slides/presentation) | 輸入簡報 |
| outputFileName | java.lang.String | 輸出檔名。 |
| imageSize | java.awt.Dimension | 每張產生影像的尺寸。 |
...
將輸入簡報轉換為一組 PNG 格式的影像。若輸出檔名為 "myPath/myFilename.png"，結果將儲存為一組 "myPath/myFilename\_N.png" 檔案，其中 N 為投影片編號。
...
以自訂選項將輸入簡報轉換為 TIFF 格式。若輸出檔名為 "myPath/myFilename.tiff" 且 multipage 為 false，結果將儲存為一組 "myPath/myFilename\_N.tiff" 檔案，其中 N 為投影片編號。若 multipage 為 true，則結果將是一個多頁的 "myPath/myFilename.tiff" 文件。
