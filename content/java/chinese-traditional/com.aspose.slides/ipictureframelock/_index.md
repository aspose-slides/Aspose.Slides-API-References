...
description: 判斷在父 PictureFrameEx 上哪些操作被停用。
type: docs
...
| Method | Description |
| --- | --- |
| [getGroupingLocked()](#getGroupingLocked--) | 判斷是否禁止將此形狀加入至群組。 |
| [setGroupingLocked(boolean value)](#setGroupingLocked-boolean-) | 判斷是否禁止將此形狀加入至群組。 |
...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | 判斷在調整大小時是否必須維持此形狀的長寬比。 |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | 判斷在調整大小時是否必須維持此形狀的長寬比。 |
...
| [getArrowheadsLocked()](#getArrowheadsLocked--) | 判斷是否禁止變更箭頭形狀。 |
| [setArrowheadsLocked(boolean value)](#setArrowheadsLocked-boolean-) | 判斷是否禁止變更箭頭形狀。 |
...
| [getCropLocked()](#getCropLocked--) | 判斷是否禁止對影像進行裁剪。 |
| [setCropLocked(boolean value)](#setCropLocked-boolean-) | 判斷是否禁止對影像進行裁剪。 |
### getGroupingLocked() {#getGroupingLocked--}
```
public abstract boolean getGroupingLocked()
```

判斷是否禁止將此形狀加入至群組。可讀寫 boolean。
...
判斷在調整大小時是否必須維持此形狀的長寬比。可讀寫 boolean。
