...
| [getVersion()](#getVersion--) | 傳回 Aspose.Slides for Java 的版本。 |
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| stream | java.io.InputStream | 包含授權的串流。使用 null 以切換至評估模式。 |
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| namePath | java.lang.String | 可以是完整或簡短的檔案名稱，或是嵌入式資源的名稱。使用空字串以切換至評估模式。 |
