...
| [removeAllHyperlinks()](#removeAllHyperlinks--) | 移除所有包含的 HyperlinkClick 和 HyperlinkMouseOver 超連結（於所有 IHyperlinkContainer 子物件中）。 |
...
移除所有包含的 HyperlinkClick 和 HyperlinkMouseOver 超連結（於所有 IHyperlinkContainer 子物件中）。
