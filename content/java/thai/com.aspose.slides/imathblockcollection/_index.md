...
| เมธอด | คำอธิบาย |
| --- | --- |
| [add(IMathBlock item)](#add-com.aspose.slides.IMathBlock-) | เพิ่ม IMathBlock ไปยังท้ายของคอลเลกชัน. |
| [insert(int index, IMathBlock item)](#insert-int-com.aspose.slides.IMathBlock-) | แทรก IMathBlock ลงในคอลเลกชันที่ตำแหน่งที่ระบุ. |
| [remove(IMathBlock item)](#remove-com.aspose.slides.IMathBlock-) | ลบการปรากฏครั้งแรกของอ็อบเจกต์เฉพาะจากคอลเลกชัน. |
| [removeAt(int index)](#removeAt-int-) | ลบรายการที่ตำแหน่งที่ระบุของคอลเลกชัน. |
| [contains(IMathBlock item)](#contains-com.aspose.slides.IMathBlock-) | ตรวจสอบว่าคอลเลกชันมีค่าที่ระบุหรือไม่. |
| [indexOf(IMathBlock item)](#indexOf-com.aspose.slides.IMathBlock-) | ตรวจสอบดัชนีของ IMathBlock เฉพาะในคอลเลกชัน. |
| [getCount()](#getCount--) | รับจำนวนองค์ประกอบที่มีอยู่จริงในคอลเลกชัน. |
...
| --- | --- | --- |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | บล็อกคณิตศาสตร์ที่จะเพิ่มไปยังท้ายของคอลเลกชัน |
...
แทรก IMMathBlock ลงในคอลเลกชันที่ตำแหน่งที่ระบุ.
...
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| --- | --- | --- |
| index | int | ดัชนีเริ่มจากศูนย์ที่ต้องการแทรกรายการ. |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | IMathBlock ที่จะใส่เข้าไป. |
...
ลบการปรากฏครั้งแรกของอ็อบเจกต์เฉพาะจากคอลเลกชัน.
...
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| --- | --- | --- |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | อ็อบเจกต์ที่จะลบจากคอลเลกชัน. |

**ผลลัพธ์:**
boolean - true หาก item ถูกลบออกจากคอลเลกชันสำเร็จ; มิฉะนั้น false. วิธีการนี้ยังคืนค่า false หากไม่พบ item ในคอลเลกชันต้นฉบับ.
### removeAt(int index) {#removeAt-int-}
```
public abstract void removeAt(int index)
```

ลบรายการที่ตำแหน่งที่ระบุของคอลเลกชัน.
...
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| --- | --- | --- |
| index | int | ดัชนีเริ่มจากศูนย์ของรายการที่จะลบ. |
...
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| --- | --- | --- |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | อ็อบเจกต์ที่ต้องการค้นหาในคอลเลกชัน. |

**ผลลัพธ์:**
boolean - true หากพบ item ในคอลเลกชัน; มิฉะนั้น false.
### indexOf(IMathBlock item) {#indexOf-com.aspose.slides.IMathBlock-}
```
public abstract int indexOf(IMathBlock item)
```

ตรวจสอบดัชนีของ IMathBlock เฉพาะในคอลเลกชัน.
...
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| --- | --- | --- |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | รายการที่ต้องการค้นหาในคอลเลกชัน. |
...
รับจำนวนองค์ประกอบที่มีอยู่จริงในคอลเลกชัน. อ่านอย่างเดียว int.
...
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| --- | --- | --- |
| index | int | ดัชนีเริ่มจากศูนย์ของรายการที่ต้องการรับ. |
...
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| --- | --- | --- |
| index | int | ดัชนีเริ่มจากศูนย์ของรายการที่จะตั้งค่า. |
