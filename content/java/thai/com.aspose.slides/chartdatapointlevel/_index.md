...
แสดงระดับจุดข้อมูล. ใช้ได้กับแผนภูมิ Treemap และ Sunburst.

## วิธีการ

| เมธอด | คำอธิบาย |
| --- | --- |
| [getFormat()](#getFormat--) | แสดงคุณสมบัติการจัดรูปแบบของระดับจุดข้อมูล. |
...
แสดงคุณสมบัติการจัดรูปแบบของระดับจุดข้อมูล. อ่าน/เขียน [IFormat](../../com.aspose.slides/iformat).
