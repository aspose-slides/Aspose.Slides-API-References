...
| [getDefaultParagraphFormat()](#getDefaultParagraphFormat--) | คุณสมบัติของย่อหน้าเริ่มต้น. |
| [getEffective()](#getEffective--) | ดึงข้อมูลการจัดรูปแบบสไตล์ข้อความที่มีผลพร้อมการสืบทอดที่ใช้. |
### getVersion() {#getVersion--}
```
...
คุณสมบัติของย่อหน้าเริ่มต้น. อ่านอย่างเดียว [IParagraphFormat](../../com.aspose.slides/iparagraphformat).
...
**คืนค่า:**
[ITextStyleEffectiveData](../../com.aspose.slides/itextstyleeffectivedata) - หนึ่ง [ITextStyleEffectiveData](../../com.aspose.slides/itextstyleeffectivedata).