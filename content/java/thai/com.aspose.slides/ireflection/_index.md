...
description: แสดงเอฟเฟกต์การสะท้อน.
type: docs
...
แสดงเอฟเฟกต์การสะท้อน
## เมธอด

| เมธอด | คำอธิบาย |
| --- | --- |
| [getStartPosAlpha()](#getStartPosAlpha--) | ระบุตำแหน่งเริ่มต้น (ตามแนวลาดของกราเดียนต์อัลฟ่า) ของค่าอัลฟ่าเริ่มต้น (เปอร์เซ็นต์) |
| [setStartPosAlpha(float value)](#setStartPosAlpha-float-) | ระบุตำแหน่งเริ่มต้น (ตามแนวลาดของกราเดียนต์อัลฟ่า) ของค่าอัลฟ่าเริ่มต้น (เปอร์เซ็นต์) |
| [getEndPosAlpha()](#getEndPosAlpha--) | ระบุตำแหน่งสิ้นสุด (ตามแนวลาดของกราเดียนต์อัลฟ่า) ของค่าอัลฟ่าเมื่อสิ้นสุด (เปอร์เซ็นต์) |
| [setEndPosAlpha(float value)](#setEndPosAlpha-float-) | ระบุตำแหน่งสิ้นสุด (ตามแนวลาดของกราเดียนต์อัลฟ่า) ของค่าอัลฟ่าเมื่อสิ้นสุด (เปอร์เซ็นต์) |
| [getFadeDirection()](#getFadeDirection--) | ระบุทิศทางเพื่อเลื่อนการสะท้อน |
| [setFadeDirection(float value)](#setFadeDirection-float-) | ระบุทิศทางเพื่อเลื่อนการสะท้อน |
...
| [setRectangleAlign(byte value)](#setRectangleAlign-byte-) | การจัดแนวสี่เหลี่ยม |
...
| [getRotateShadowWithShape()](#getRotateShadowWithShape--) | ระบุว่าการสะท้อนควรหมุนตามรูปทรงหากรูปทรงถูกหมุนหรือไม่ |
| [setRotateShadowWithShape(boolean value)](#setRotateShadowWithShape-boolean-) | ระบุว่าการสะท้อนควรหมุนตามรูปทรงหากรูปทรงถูกหมุนหรือไม่ |
| [getScaleHorizontal()](#getScaleHorizontal--) | ระบุอัตราสเกลแนวนอน, การสเกลลบทำให้กลับด้าน |
| [setScaleHorizontal(double value)](#setScaleHorizontal-double-) | ระบุอัตราสเกลแนวนอน, การสเกลลบทำให้กลับด้าน |
| [getScaleVertical()](#getScaleVertical--) | ระบุอัตราสเกลแนวตั้ง, การสเกลลบทำให้กลับด้าน |
| [setScaleVertical(double value)](#setScaleVertical-double-) | ระบุอัตราสเกลแนวตั้ง, การสเกลลบทำให้กลับด้าน |
...
ระบุตำแหน่งเริ่มต้น (ตามแนวลาดของกราเดียนต์อัลฟ่า) ของค่าอัลฟ่าเริ่มต้น (เปอร์เซ็นต์) อ่าน/เขียน float.
...
ระบุตำแหน่งสิ้นสุด (ตามแนวลาดของกราเดียนต์อัลฟ่า) ของค่าอัลฟ่าเมื่อสิ้นสุด (เปอร์เซ็นต์) อ่าน/เขียน float.
...
ระบุทิศทางเพื่อเลื่อนการสะท้อน (angle) อ่าน/เขียน float.
...
การจัดแนวสี่เหลี่ยม อ่าน/เขียน [RectangleAlignment](../../com.aspose.slides/rectanglealignment).
...
ระบุว่าการสะท้อนควรหมุนตามรูปทรงหากรูปทรงถูกหมุนหรือไม่ อ่าน/เขียน boolean.
...
ระบุอัตราสเกลแนวนอน, การสเกลลบทำให้กลับด้าน (percents) อ่าน/เขียน double.
...
ระบุอัตราสเกลแนวตั้ง, การสเกลลบทำให้กลับด้าน (percents) อ่าน/เขียน double.
