...
| [getByType(byte type)](#getByType-byte-) | ส่งคืนสไลด์เค้าโครงแรกของประเภทที่กำหนด |
| [remove(ILayoutSlide value)](#remove-com.aspose.slides.ILayoutSlide-) | ลบเค้าโครงจากคอลเลกชัน |
...
ส่งคืนสไลด์เค้าโครงแรกของประเภทที่กำหนด
...
**ผลลัพธ์:**
[ILayoutSlide](../../com.aspose.slides/ilayoutslide) - [ILayoutSlide](../../com.aspose.slides/ilayoutslide) ที่มีประเภทที่กำหนด หรือ null หากไม่มีเค้าโครงพบ
### remove(ILayoutSlide value) {#remove-com.aspose.slides.ILayoutSlide-}
```
public abstract void remove(ILayoutSlide value)
```

ลบเค้าโครงจากคอลเลกชัน
...
1) เพื่อหลีกเลี่ยงการโยน PptxEditException ให้ตรวจสอบคุณสมบัติ HasDependingSlides ของเค้าโครงก่อน 2) คุณยังสามารถใช้เมธอด [ILayoutSlide.remove](../../com.aspose.slides/ilayoutslide\#remove) เพื่อทำให้โค้ดง่ายขึ้น
