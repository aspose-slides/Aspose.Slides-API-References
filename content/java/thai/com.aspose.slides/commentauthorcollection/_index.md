...
แทนคอลเลกชันของผู้เขียนความคิดเห็น.
## เมธอด

| เมธอด | คำอธิบาย |
| --- | --- |
| [size()](#size--) | รับจำนวนของรายการที่มีอยู่จริงในคอลเลกชัน. |
| [get_Item(int index)](#get-Item-int-) | รับรายการที่ตำแหน่งที่กำหนด. |
| [addAuthor(String name, String initials)](#addAuthor-java.lang.String-java.lang.String-) | เพิ่มผู้เขียนใหม่ที่ท้ายของคอลเลกชัน. |
| [toArray()](#toArray--) | สร้างและส่งกลับอาร์เรย์ที่มีผู้เขียนทั้งหมด. |
...
| [removeAt(int index)](#removeAt-int-) | ลบผู้เขียนที่ตำแหน่งที่กำหนดของคอลเลกชัน. |
| [remove(ICommentAuthor author)](#remove-com.aspose.slides.ICommentAuthor-) | ลบการเกิดขึ้นครั้งแรกของผู้เขียนที่ระบุในคอลเลกชัน. |
| [clear()](#clear--) | ลบผู้เขียนทั้งหมดออกจากคอลเลกชัน. |
| [iterator()](#iterator--) | ส่งกลับ enumerator ที่ทำการวนผ่านคอลเลกชัน. |
| [iteratorJava()](#iteratorJava--) | ส่งกลับ java iterator สำหรับคอลเลกชันทั้งหมด. |
...
| [isSynchronized()](#isSynchronized--) | ส่งค่าที่บ่งบอกว่าการเข้าถึงคอลเลกชันเป็นแบบ synchronized (ปลอดภัยต่อเธรด). |
| [getSyncRoot()](#getSyncRoot--) | ส่งรากของการซิงโครไนส์. |
### size() {#size--}
```
...
รับจำนวนของรายการที่มีอยู่จริงในคอลเลกชัน. อ่านอย่างเดียว int.
...
รับรายการที่ตำแหน่งที่กำหนด. อ่านอย่างเดียว [ICommentAuthor](../../com.aspose.slides/icommentauthor).
...
สร้างและส่งกลับอาร์เรย์ที่มีผู้เขียนทั้งหมด.
...
ลบผู้เขียนที่ตำแหน่งที่กำหนดของคอลเลกชัน.

**พารามิเตอร์:**
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| --- | --- | --- |
| index | int | ดัชนีศูนย์ฐานของรายการที่ต้องการลบ. |
...
ส่งกลับ enumerator ที่ทำการวนผ่านคอลเลกชัน.

**คืนค่า:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICommentAuthor> - IGenericEnumerator ที่สามารถใช้เพื่อวนผ่านคอลเลกชัน.
...
ส่งกลับ java iterator สำหรับคอลเลกชันทั้งหมด.
...
ส่งค่าที่บ่งบอกว่าการเข้าถึงคอลเลกชันเป็นแบบ synchronized (ปลอดภัยต่อเธรด). อ่านอย่างเดียว boolean.
...
ส่งรากของการซิงโครไนส์. อ่านอย่างเดียว Object.
