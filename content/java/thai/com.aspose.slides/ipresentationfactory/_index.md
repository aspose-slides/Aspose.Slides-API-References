...
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| --- | --- | --- |
| stream | java.io.InputStream | สตรีมอินพุตเพื่ออ่าน |
...
**คืนค่า:**
[IPresentationText](../../com.aspose.slides/ipresentationtext) - อินสแตนซ์ของ PresentationText ที่มีอาเรย์ SlideText แสดงข้อความดิบของสไลด์
