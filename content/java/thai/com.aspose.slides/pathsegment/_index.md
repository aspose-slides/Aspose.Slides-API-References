...
description: แทนส่วนของเส้นกราฟิกของ GeometryShape
type: docs
url: /th/com.aspose.slides/pathsegment/
---
**การสืบทอด:**
java.lang.Object
...
แทนส่วนหนึ่งของเส้นกราฟิกของ GeometryShape
## วิธีการ

| เมธอด | คำอธิบาย |
| --- | --- |
| [getSegmentData()](#getSegmentData--) | ข้อมูลเส้นทางของส่วน |
| [getPathCommand()](#getPathCommand--) | ประเภทเส้นทางของส่วน |
