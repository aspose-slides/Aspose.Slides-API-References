...
description: เป็นผู้จัดการที่เก็บพฤติกรรมของตำแหน่งส่วนท้ายสไลด์แม่แบบ วันที่-เวลา ตัวเลขหน้า และตำแหน่งพื้นฐานทั้งหมดรวมถึงตำแหน่งพื้นฐานลูกทั้งหมด
type: docs
...
เป็นผู้จัดการที่มีพฤติกรรมของตำแหน่งส่วนท้ายสไลด์แม่แบบ, วัน-เวลา, ตัวเลขหน้าและตำแหน่งพื้นฐานลูกทั้งหมด ตำแหน่งพื้นฐานลูกหมายถึงตำแหน่งที่อยู่บนสไลด์ที่อ้างอิง สไลด์ที่อ้างอิงใช้และพึ่งพาสไลด์แม่แบบ
...
เปลี่ยนการมองเห็นของตำแหน่งส่วนท้ายสไลด์แม่แบบและตำแหน่งส่วนท้ายลูกทั้งหมด ตำแหน่งพื้นฐานลูกหมายถึงตำแหน่งที่อยู่บนสไลด์ที่อ้างอิง สไลด์ที่อ้างอิงใช้และพึ่งพาสไลด์แม่แบบ

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| isVisible | boolean | true - makes a footer placeholders visible, otherwise - hides them. |
| isVisible | boolean | true - ทำให้ตำแหน่งส่วนท้ายแสดง, มิฉะนั้น - ซ่อนมัน. |
...
เปลี่ยนการมองเห็นของตำแหน่งตัวเลขหน้าสไลด์แม่แบบและตำแหน่งตัวเลขหน้าลูกทั้งหมด ตำแหน่งพื้นฐานลูกหมายถึงตำแหน่งที่อยู่บนสไลด์ที่อ้างอิง สไลด์ที่อ้างอิงใช้และพึ่งพาสไลด์แม่แบบ

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| isVisible | boolean | true - makes a page number placeholders visible, otherwise - hides them. |
| isVisible | boolean | true - ทำให้ตำแหน่งเลขหน้าแสดง, มิฉะนั้น - ซ่อนมัน. |
...
เปลี่ยนการมองเห็นของตำแหน่งวัน-เวลาในสไลด์แม่แบบและตำแหน่งวัน-เวลาในสไลด์ลูกทั้งหมด ตำแหน่งพื้นฐานลูกหมายถึงตำแหน่งที่อยู่บนสไลด์ที่อ้างอิง สไลด์ที่อ้างอิงใช้และพึ่งพาสไลด์แม่แบบ

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| isVisible | boolean | true - makes a date-time placeholders visible, otherwise - hides them. |
| isVisible | boolean | true - ทำให้ตำแหน่งวัน-เวลาแสดง, มิฉะนั้น - ซ่อนมัน. |
...
ตั้งค่าข้อความให้กับตำแหน่งส่วนท้ายสไลด์แม่แบบและตำแหน่งส่วนท้ายลูกทั้งหมด ตำแหน่งพื้นฐานลูกหมายถึงตำแหน่งที่อยู่บนสไลด์ที่อ้างอิง สไลด์ที่อ้างอิงใช้และพึ่งพาสไลด์แม่แบบ
...
ตั้งค่าข้อความให้กับตำแหน่งวัน-เวลาในสไลด์แม่แบบและตำแหน่งวัน-เวลาในสไลด์ลูกทั้งหมด ตำแหน่งพื้นฐานลูกหมายถึงตำแหน่งที่อยู่บนสไลด์ที่อ้างอิง สไลด์ที่อ้างอิงใช้และพึ่งพาสไลด์แม่แบบ
