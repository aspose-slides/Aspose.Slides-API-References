...
| Method | Description |
| --- | --- |
| [invoke(Paragraph para, BaseSlide slide, int index)](#invoke-com.aspose.slides.Paragraph-com.aspose.slides.BaseSlide-int-) | คอลแบ็กที่จะถูกเรียกใช้สำหรับแต่ละ \#paragraph(Presentation,ForEachParagraphCallback).paragraph(Presentation,ForEachParagraphCallback) บน [BaseSlide](../../com.aspose.slides/baseslide). |
...
| --- | --- | --- |
| para | [Paragraph](../../com.aspose.slides/paragraph) | ย่อหน้าที่กำลังวนซ้ำ |
| slide | [BaseSlide](../../com.aspose.slides/baseslide) | สไลด์ที่กำลังวนซ้ำ |
