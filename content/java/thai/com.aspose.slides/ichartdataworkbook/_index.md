...
description: ให้การเข้าถึงเวิร์กบุ๊ก Excel ที่ฝังรวม
type: docs
...
ให้การเข้าถึงเวิร์กบุ๊ก Excel ที่ฝังรวม
## เมธอด
...
| [getCell(String worksheetName, int row, int column)](#getCell-java.lang.String-int-int-) | รับเซลล์ที่สามารถใช้สำหรับซีรีส์แผนภูมิหรือหมวดหมู่ |
| [getCell(int worksheetIndex, int row, int column)](#getCell-int-int-int-) | รับเซลล์ที่สามารถใช้สำหรับซีรีส์แผนภูมิหรือหมวดหมู่ |
| [getCell(int worksheetIndex, String cellName)](#getCell-int-java.lang.String-) | รับเซลล์ที่สามารถใช้สำหรับซีรีส์แผนภูมิหรือหมวดหมู่ |
| [getCell(int worksheetIndex, String cellName, Object value)](#getCell-int-java.lang.String-java.lang.Object-) | รับเซลล์ที่สามารถใช้สำหรับซีรีส์แผนภูมิหรือหมวดหมู่ |
| [getCell(int worksheetIndex, int row, int column, Object value)](#getCell-int-int-int-java.lang.Object-) | รับเซลล์ที่สามารถใช้สำหรับซีรีส์แผนภูมิหรือหมวดหมู่ |
| [clear(int sheetIndex)](#clear-int-) | ลบค่าทั้งหมดของเซลล์ในชีต |
...
รับเซลล์ที่สามารถใช้สำหรับซีรีส์แผนภูมิหรือหมวดหมู่
...
**ผลลัพธ์:**
[IChartDataCell](../../com.aspose.slides/ichartdatacell) - อ็อบเจ็กต์ Cell
