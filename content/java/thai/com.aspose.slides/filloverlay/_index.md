...
**อินเทอร์เฟซที่ถูกนำไปใช้งานทั้งหมด:**
...
เป็นเอฟเฟกต์ Fill Overlay. Fill overlay สามารถใช้เพื่อระบุการเติมสีเพิ่มเติมสำหรับวัตถุและผสานการเติมสองแบบเข้าด้วยกัน.
## เมธอด
...
| [getEffective()](#getEffective--) | รับข้อมูลเอฟเฟกต์ Fill Overlay ที่มีประสิทธิภาพโดยมีการสืบทอดที่ใช้. |
| [getVersion()](#getVersion--) |  |
| [equals(Object obj)](#equals-java.lang.Object-) | กำหนดว่า [FillOverlay](../../com.aspose.slides/filloverlay) ที่ระบุเทียบเท่ากับ [FillOverlay](../../com.aspose.slides/filloverlay) ปัจจุบันหรือไม่. |
...
รับข้อมูลเอฟเฟกต์ Fill Overlay ที่มีประสิทธิภาพโดยมีการสืบทอดที่ใช้.
...
กำหนดว่า [FillOverlay](../../com.aspose.slides/filloverlay) ที่ระบุเทียบเท่ากับ [FillOverlay](../../com.aspose.slides/filloverlay) ปัจจุบันหรือไม่.

**พารามิเตอร์:**
| พารามิเตอร์ | ประเภท | คำอธิบาย |
| --- | --- | --- |
| obj | java.lang.Object | [FillOverlay](../../com.aspose.slides/filloverlay) ที่จะเปรียบเทียบ. |
