...
type: docs
url: /th/com.aspose.slides/updownbarsmanager/
---
**การสืบทอด:**
...
ให้การเข้าถึงแถบขึ้น/ลงของแผนภูมิ Line หรือ Stock-chart.
## เมธอด

| เมธอด | คำอธิบาย |
| --- | --- |
| [getUpBarsFormat()](#getUpBarsFormat--) | Returns the UpBars format. |
| [getDownBarsFormat()](#getDownBarsFormat--) | Returns the DownBars format. |
...
ส่งคืนรูปแบบ UpBars. อ่านอย่างเดียว [IFormat](../../com.aspose.slides/iformat).
...
ส่งคืนรูปแบบ DownBars. อ่านอย่างเดียว [IFormat](../../com.aspose.slides/iformat).
