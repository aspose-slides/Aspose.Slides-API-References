...
| เมธอด | คำอธิบาย |
| --- | --- |
| [addEffect(int effectType, int subtype, int triggerType)](#addEffect-int-int-int-) | เพิ่มเอฟเฟกต์ใหม่ไปยังตำแหน่งสุดท้ายของลำดับปัจจุบันจนถึงสุดท้ายของกลุ่มการเคลื่อนไหวของข้อความ. |
| [getBuildType()](#getBuildType--) | รายการของประเภทการสร้าง (สำหรับตัวอย่าง |
| [setBuildType(int value)](#setBuildType-int-) | รายการของประเภทการสร้าง (สำหรับตัวอย่าง |
...
เพิ่มเอฟเฟกต์ใหม่ไปยังตำแหน่งสุดท้ายของลำดับปัจจุบันจนถึงสุดท้ายของกลุ่มการเคลื่อนไหวของข้อความ. ใช้ได้เฉพาะเมื่อจำนวนย่อหน้าข้อความเท่ากับหรือมากกว่าจำนวนเอฟเฟกต์ของกลุ่มนี้!
...
รายการของประเภทการสร้าง (เช่น ย่อหน้า 1,2,3, ทั้งหมดพร้อมกัน) ของการเคลื่อนไหวของข้อความ. อ่าน/เขียน [BuildType](../../com.aspose.slides/buildtype).
