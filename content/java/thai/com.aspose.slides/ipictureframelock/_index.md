...
description: กำหนดว่าการดำเนินการใดบ้างถูกปิดการใช้งานบนพาเรนท์ PictureFrameEx.
type: docs
...
กำหนดว่าการดำเนินการใดถูกปิดการใช้งานบน PictureFrameEx พาเรนท์
## เมธอด
...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | กำหนดว่ารูปร่างต้องรักษาส่วนสัดส่วนเมื่อปรับขนาดหรือไม่ |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | กำหนดว่ารูปร่างต้องรักษาส่วนสัดส่วนเมื่อปรับขนาดหรือไม่ |
...
| [getAdjustHandlesLocked()](#getAdjustHandlesLocked--) | กำหนดว่าการปรับค่าการปรับแต่งเป็นสิ่งต้องห้ามหรือไม่ |
| [setAdjustHandlesLocked(boolean value)](#setAdjustHandlesLocked-boolean-) | กำหนดว่าการปรับค่าการปรับแต่งเป็นสิ่งต้องห้ามหรือไม่ |
...
กำหนดว่ารูปร่างต้องรักษาส่วนสัดส่วนเมื่อปรับขนาดหรือไม่. อ่าน/เขียน boolean.
...
กำหนดว่าการปรับค่าการปรับแต่งเป็นสิ่งต้องห้ามหรือไม่. อ่าน/เขียน boolean.
