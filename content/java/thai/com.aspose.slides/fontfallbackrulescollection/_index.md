...
| Method | Description |
| --- | --- |
| [size()](#size--) | รับจำนวนกฎที่มีอยู่จริงในคอลเลกชัน |
| [add(IFontFallBackRule sourceRule)](#add-com.aspose.slides.IFontFallBackRule-) | เพิ่มกฎ FallBack ที่ระบุลงท้ายคอลเลกชัน |
| [remove(IFontFallBackRule targetRule)](#remove-com.aspose.slides.IFontFallBackRule-) | ลบการปรากฏครั้งแรกของกฎ FallBack เฉพาะจากคอลเลกชัน |
...
| [isSynchronized()](#isSynchronized--) | คืนค่าที่บ่งชี้ว่าการเข้าถึงคอลเลกชันมีการซิงโครไนซ์ (ปลอดภัยต่อเธรด) |
...
รับจำนวนกฎที่มีอยู่จริงในคอลเลกชันนี้. อ่านอย่างเดียว int.
...
เพิ่มกฎ FallBack ที่ระบุลงท้ายคอลเลกชัน
...
>  try
>  {
>      //ดึงคอลเลกชันกฎที่ว่างหรือเตรียมไว้ล่วงหน้าจาก FontsManager
>      IFontFallBackRulesCollection rulesList = pres.getFontsManager().getFontFallBackRulesCollection();
>      //เพิ่มกฎใหม่ลงในคอลเลกชัน
...
ลบการปรากฏครั้งแรกของกฎ FallBack เฉพาะจากคอลเลกชัน
...
**คืนค่า:**  
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IFontFallBackRule> - ตัว IGenericEnumerator ที่สามารถใช้เพื่อวนผ่านคอลเลกชัน
...
คืนค่าที่บ่งชี้ว่าการเข้าถึงคอลเลกชันมีการซิงโครไนซ์ (ปลอดภัยต่อเธรด). อ่านอย่างเดียว boolean.
