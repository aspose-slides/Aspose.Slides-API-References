...
| [getEffective()](#getEffective--) | รับข้อมูลพื้นหลังที่มีผลโดยใช้การสืบทอด. |
| [getVersion()](#getVersion--) |  |
| [getParent_Immediate()](#getParent-Immediate--) |  |
| [getSlide()](#getSlide--) | คืนค่าสไลด์แม่ของรูปทรง. |
| [getPresentation()](#getPresentation--) | คืนค่าการนำเสนอแม่ของสไลด์. |
### getType() {#getType--}
```
...
รับข้อมูลพื้นหลังที่มีผลโดยใช้การสืบทอด.
...
คืนค่าสไลด์แม่ของรูปทรง. อ่านอย่างเดียว [IBaseSlide](../../com.aspose.slides/ibaseslide).
...
คืนค่าการนำเสนอแม่ของสไลด์. อ่านอย่างเดียว [IPresentation](../../com.aspose.slides/ipresentation).
