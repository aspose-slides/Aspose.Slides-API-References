...
description: เป็นตัวแทนของคุณสมบัติบทหัวแผนภูมิ.
type: docs
...
เป็นตัวแทนของคุณสมบัติบทหัวแผนภูมิ.
## Methods
...
ส่งคืนรูปแบบของพื้นที่พล็อต. อ่านเท่านั้น [IFormat](../../com.aspose.slides/iformat).
...
หากการจัดวางพื้นที่พล็อตกำหนดด้วยตนเอง คุณสมบัตินี้ระบุว่าจะจัดวางพื้นที่พล็อตโดยภายใน (ไม่รวมแกนและป้ายแกน) หรือภายนอก (รวมแกนและป้ายแกน). อ่าน/เขียน [LayoutTargetType](../../com.aspose.slides/layouttargettype)(\#getLayoutTargetType.getLayoutTargetType/\#setLayoutTargetType(int).setLayoutTargetType(int)).
