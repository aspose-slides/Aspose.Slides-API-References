...
description: แสดงประเภทของคุณสมบัติเพื่อพฤติกรรมแอนิเมชัน
type: docs
...
แสดงประเภทของ property สำหรับพฤติกรรมการเคลื่อนไหว. ตามรายการของ property จาก https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx และ https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx
## เมธอด

| เมธอด | คำอธิบาย |
| --- | --- |
| [getValue()](#getValue--) | ค่าของคุณสมบัติ |
| [isCustom()](#isCustom--) | แสดงว่าคุณสมบัตินี้ไม่ได้อยู่ในรายการคุณสมบัติกำหนดล่วงหน้าในข้อกำหนด: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx |
| [getPptX()](#getPptX--) | แสดงคุณสมบัติ 'ppt\_x' |
| [getPptY()](#getPptY--) | แสดงคุณสมบัติ 'ppt\_y' |
| [getPptW()](#getPptW--) | แสดงคุณสมบัติ 'ppt\_w' |
| [getPptH()](#getPptH--) | แสดงคุณสมบัติ 'ppt\_h' |
| [getPptC()](#getPptC--) | แสดงคุณสมบัติ 'ppt\_c' |
| [getPptR()](#getPptR--) | แสดงคุณสมบัติ 'ppt\_r' |
| [getXShear()](#getXShear--) | แสดงคุณสมบัติ 'xshear' |
| [getYShear()](#getYShear--) | แสดงคุณสมบัติ 'yshear' |
| [getImage()](#getImage--) | แสดงคุณสมบัติ 'image' |
| [getScaleX()](#getScaleX--) | แสดงคุณสมบัติ 'ScaleX' |
| [getScaleY()](#getScaleY--) | แสดงคุณสมบัติ 'ScaleY' |
| [getR()](#getR--) | แสดงคุณสมบัติ 'r' |
| [getFillColor()](#getFillColor--) | แสดงคุณสมบัติ 'fillcolor' |
| [getStyleOpacity()](#getStyleOpacity--) | แสดงคุณสมบัติ 'style.opacity' |
| [getStyleRotation()](#getStyleRotation--) | แสดงคุณสมบัติ 'style.rotation' |
| [getStyleVisibility()](#getStyleVisibility--) | แสดงคุณสมบัติ 'style.visibility' |
| [getStyleColor()](#getStyleColor--) | แสดงคุณสมบัติ 'style.color' |
| [getStyleFontSize()](#getStyleFontSize--) | แสดงคุณสมบัติ 'style.fontSize' |
| [getStyleFontWeight()](#getStyleFontWeight--) | แสดงคุณสมบัติ 'style.fontWeight' |
| [getStyleFontStyle()](#getStyleFontStyle--) | แสดงคุณสมบัติ 'style.fontStyle' |
| [getStyleFontFamily()](#getStyleFontFamily--) | แสดงคุณสมบัติ 'style.fontFamily' |
| [getStyleTextEffectEmboss()](#getStyleTextEffectEmboss--) | แสดงคุณสมบัติ 'style.textEffectEmboss' |
| [getStyleTextShadow()](#getStyleTextShadow--) | แสดงคุณสมบัติ 'style.textShadow' |
| [getStyleTextTransform()](#getStyleTextTransform--) | แสดงคุณสมบัติ 'style.textTransform' |
| [getStyleTextDecorationUnderline()](#getStyleTextDecorationUnderline--) | แสดงคุณสมบัติ 'style.textDecorationUnderline' |
| [getStyleTextEffectOutline()](#getStyleTextEffectOutline--) | แสดงคุณสมบัติ 'style.textEffectOutline' |
| [getStyleTextDecorationLineThrough()](#getStyleTextDecorationLineThrough--) | แสดงคุณสมบัติ 'style.textDecorationLineThrough' |
| [getStyleSRotation()](#getStyleSRotation--) | แสดงคุณสมบัติ 'style.sRotation' |
| [getImageDataCropTop()](#getImageDataCropTop--) | แสดงคุณสมบัติ 'imageData.cropTop' |
| [getImageDataCropBottom()](#getImageDataCropBottom--) | แสดงคุณสมบัติ 'imageData.cropBottom' |
| [getImageDataCropLeft()](#getImageDataCropLeft--) | แสดงคุณสมบัติ 'imageData.cropLeft' |
| [getImageDataCropRight()](#getImageDataCropRight--) | แสดงคุณสมบัติ 'imageData.cropRight' |
| [getImageDataGain()](#getImageDataGain--) | แสดงคุณสมบัติ 'imageData.gain' |
| [getImageDataBlacklevel()](#getImageDataBlacklevel--) | แสดงคุณสมบัติ 'imageData.blacklevel' |
| [getImageDataGamma()](#getImageDataGamma--) | แสดงคุณสมบัติ 'imageData.gamma' |
| [getImageDataGrayscale()](#getImageDataGrayscale--) | แสดงคุณสมบัติ 'imageData.grayscale' |
| [getImageDataChromakey()](#getImageDataChromakey--) | แสดงคุณสมบัติ 'imageData.chromakey' |
| [getFillOn()](#getFillOn--) | แสดงคุณสมบัติ 'fill.on' |
| [getFillType()](#getFillType--) | แสดงคุณสมบัติ 'fill.type' |
| [getFill_Color()](#getFill-Color--) | แสดงคุณสมบัติ 'fill.color' |
| [getFillOpacity()](#getFillOpacity--) | แสดงคุณสมบัติ 'fill.opacity' |
| [getFillColor2()](#getFillColor2--) | แสดงคุณสมบัติ 'fill.color2' |
| [getFillMethod()](#getFillMethod--) | แสดงคุณสมบัติ 'fill.method' |
| [getFillOpacity2()](#getFillOpacity2--) | แสดงคุณสมบัติ 'fill.opacity2' |
| [getFillAngle()](#getFillAngle--) | แสดงคุณสมบัติ 'fill.angle' |
| [getFillFocus()](#getFillFocus--) | แสดงคุณสมบัติ 'fill.focus' |
| [getFillFocusPositionX()](#getFillFocusPositionX--) | แสดงคุณสมบัติ 'fill.focusposition.x' |
| [getFillFocusPositionY()](#getFillFocusPositionY--) | แสดงคุณสมบัติ 'fill.focusposition.y' |
| [getFillFocusSizeX()](#getFillFocusSizeX--) | แสดงคุณสมบัติ 'fill.focussize.x' |
| [getFillFocusSizeY()](#getFillFocusSizeY--) | แสดงคุณสมบัติ 'fill.focussize.y' |
| [getStrokeOn()](#getStrokeOn--) | แสดงคุณสมบัติ 'stroke.on' |
| [getStrokeColor()](#getStrokeColor--) | แสดงคุณสมบัติ 'stroke.color' |
| [getStrokeWeight()](#getStrokeWeight--) | แสดงคุณสมบัติ 'stroke.weight' |
| [getStrokeOpacity()](#getStrokeOpacity--) | แสดงคุณสมบัติ 'stroke.opacity' |
| [getStrokeLineStyle()](#getStrokeLineStyle--) | แสดงคุณสมบัติ 'stroke.linestyle' |
| [getStrokeDashStyle()](#getStrokeDashStyle--) | แสดงคุณสมบัติ 'stroke.dashstyle' |
| [getStrokeFillType()](#getStrokeFillType--) | แสดงคุณสมบัติ 'stroke.filltype' |
| [getStrokeSrc()](#getStrokeSrc--) | แสดงคุณสมบัติ 'stroke.src' |
| [getStrokeColor2()](#getStrokeColor2--) | แสดงคุณสมบัติ 'stroke.color2' |
| [getStrokeImageSizeX()](#getStrokeImageSizeX--) | แสดงคุณสมบัติ 'stroke.imagesize.x' |
| [getStrokeImageSizeY()](#getStrokeImageSizeY--) | แสดงคุณสมบัติ 'stroke.imagesize.y' |
| [getStrokeStartArrow()](#getStrokeStartArrow--) | แสดงคุณสมบัติ 'stroke.startArrow' |
| [getStrokeEndArrow()](#getStrokeEndArrow--) | แสดงคุณสมบัติ 'stroke.endArrow' |
| [getStrokeStartArrowWidth()](#getStrokeStartArrowWidth--) | แสดงคุณสมบัติ 'stroke.startArrowWidth' |
| [getStrokeStartArrowLength()](#getStrokeStartArrowLength--) | แสดงคุณสมบัติ 'stroke.startArrowLength' |
| [getStrokeEndArrowWidth()](#getStrokeEndArrowWidth--) | แสดงคุณสมบัติ 'stroke.endArrowWidth' |
| [getStrokeEndArrowLength()](#getStrokeEndArrowLength--) | แสดงคุณสมบัติ 'stroke.endArrowLength' |
| [getShadowOn()](#getShadowOn--) | แสดงคุณสมบัติ 'shadow.on' |
| [getShadowType()](#getShadowType--) | แสดงคุณสมบัติ 'shadow.type' |
| [getShadowColor()](#getShadowColor--) | แสดงคุณสมบัติ 'shadow.color' |
| [getShadowColor2()](#getShadowColor2--) | แสดงคุณสมบัติ 'shadow.color2' |
| [getShadowOpacity()](#getShadowOpacity--) | แสดงคุณสมบัติ 'shadow.opacity' |
| [getShadowOffsetX()](#getShadowOffsetX--) | แสดงคุณสมบัติ 'shadow.offset.x' |
| [getShadowOffsetY()](#getShadowOffsetY--) | แสดงคุณสมบัติ 'shadow.offset.y' |
| [getShadowOffset2X()](#getShadowOffset2X--) | แสดงคุณสมบัติ 'shadow.offset2.x' |
| [getShadowOffset2Y()](#getShadowOffset2Y--) | แสดงคุณสมบัติ 'shadow.offset2.y' |
| [getShadowOriginX()](#getShadowOriginX--) | แสดงคุณสมบัติ 'shadow.origin.x' |
| [getShadowOriginY()](#getShadowOriginY--) | แสดงคุณสมบัติ 'shadow.origin.y' |
| [getShadowMatrixXtoX()](#getShadowMatrixXtoX--) | แสดงคุณสมบัติ 'shadow.matrix.xtox' |
| [getShadowMatrixXtoY()](#getShadowMatrixXtoY--) | แสดงคุณสมบัติ 'shadow.matrix.xtoy' |
| [getShadowMatrixYtoX()](#getShadowMatrixYtoX--) | แสดงคุณสมบัติ 'shadow.matrix.ytox' |
| [getShadowMatrixYtoY()](#getShadowMatrixYtoY--) | แสดงคุณสมบัติ 'shadow.matrix.ytoy' |
| [getShadowMatrixPerspectiveX()](#getShadowMatrixPerspectiveX--) | แสดงคุณสมบัติ 'shadow.matrix.perspectiveX' |
| [getShadowMatrixPerspectiveY()](#getShadowMatrixPerspectiveY--) | แสดงคุณสมบัติ 'shadow.matrix.perspectiveY' |
| [getSkewOn()](#getSkewOn--) | แสดงคุณสมบัติ 'skew.on' |
| [getSkewOffsetX()](#getSkewOffsetX--) | แสดงคุณสมบัติ 'skew.offset.x' |
| [getSkewOffsetY()](#getSkewOffsetY--) | แสดงคุณสมบัติ 'skew.offset.y' |
| [getSkewOriginX()](#getSkewOriginX--) | แสดงคุณสมบัติ 'skew.origin.x' |
| [getSkewOriginY()](#getSkewOriginY--) | แสดงคุณสมบัติ 'skew.origin.y' |
| [getSkewMatrixXtoX()](#getSkewMatrixXtoX--) | แสดงคุณสมบัติ 'skew.matrix.xtox' |
| [getSkewMatrixXtoY()](#getSkewMatrixXtoY--) | แสดงคุณสมบัติ 'skew.matrix.xtoy' |
| [getSkewMatrixYtoX()](#getSkewMatrixYtoX--) | แสดงคุณสมบัติ 'skew.matrix.ytox' |
| [getSkewMatrixYtoY()](#getSkewMatrixYtoY--) | แสดงคุณสมบัติ 'skew.matrix.ytoy' |
| [getSkewMatrixPerspectiveX()](#getSkewMatrixPerspectiveX--) | แสดงคุณสมบัติ 'skew.matrix.perspectiveX' |
| [getSkewMatrixPerspectiveY()](#getSkewMatrixPerspectiveY--) | แสดงคุณสมบัติ 'skew.matrix.perspectiveY' |
| [getExtrusionOn()](#getExtrusionOn--) | แสดงคุณสมบัติ 'extrusion.on' |
| [getExtrusionType()](#getExtrusionType--) | แสดงคุณสมบัติ 'extrusion.type' |
| [getExtrusionRender()](#getExtrusionRender--) | แสดงคุณสมบัติ 'extrusion.render' |
| [getExtrusionViewPointOriginX()](#getExtrusionViewPointOriginX--) | แสดงคุณสมบัติ 'extrusion.viewpointorigin.x' |
| [getExtrusionViewPointOriginY()](#getExtrusionViewPointOriginY--) | แสดงคุณสมบัติ 'extrusion.viewpointorigin.y' |
| [getExtrusionViewPointX()](#getExtrusionViewPointX--) | แสดงคุณสมบัติ 'extrusion.viewpoint.x' |
| [getExtrusionViewPointY()](#getExtrusionViewPointY--) | แสดงคุณสมบัติ 'extrusion.viewpoint.y' |
| [getExtrusionViewPointZ()](#getExtrusionViewPointZ--) | แสดงคุณสมบัติ 'extrusion.viewpoint.z' |
| [getExtrusionPlane()](#getExtrusionPlane--) | แสดงคุณสมบัติ 'extrusion.plane' |
| [getExtrusionSkewAngle()](#getExtrusionSkewAngle--) | แสดงคุณสมบัติ 'extrusion.skewangle' |
| [getExtrusionSkewAmt()](#getExtrusionSkewAmt--) | แสดงคุณสมบัติ 'extrusion.skewamt' |
| [getExtrusionBackDepth()](#getExtrusionBackDepth--) | แสดงคุณสมบัติ 'extrusion.backdepth' |
| [getExtrusionForeDepth()](#getExtrusionForeDepth--) | แสดงคุณสมบัติ 'extrusion.foredepth' |
| [getExtrusionOrientationX()](#getExtrusionOrientationX--) | แสดงคุณสมบัติ 'extrusion.orientation.x' |
| [getExtrusionOrientationY()](#getExtrusionOrientationY--) | แสดงคุณสมบัติ 'extrusion.orientation.y' |
| [getExtrusionOrientationZ()](#getExtrusionOrientationZ--) | แสดงคุณสมบัติ 'extrusion.orientation.z' |
| [getExtrusionOrientationAngle()](#getExtrusionOrientationAngle--) | แสดงคุณสมบัติ 'extrusion.orientationangle' |
| [getExtrusionColor()](#getExtrusionColor--) | แสดงคุณสมบัติ 'extrusion.color' |
| [getExtrusionRotationAngleX()](#getExtrusionRotationAngleX--) | แสดงคุณสมบัติ 'extrusion.rotationangle.x' |
| [getExtrusionRotationAngleY()](#getExtrusionRotationAngleY--) | แสดงคุณสมบัติ 'extrusion.rotationangle.y' |
| [getExtrusionLockRotationCenter()](#getExtrusionLockRotationCenter--) | แสดงคุณสมบัติ 'extrusion.lockrotationcenter' |
| [getExtrusionAutoRotationCenter()](#getExtrusionAutoRotationCenter--) | แสดงคุณสมบัติ 'extrusion.autorotationcenter' |
| [getExtrusionRotationCenterX()](#getExtrusionRotationCenterX--) | แสดงคุณสมบัติ 'extrusion.rotationcenter.x' |
| [getExtrusionRotationCenterY()](#getExtrusionRotationCenterY--) | แสดงคุณสมบัติ 'extrusion.rotationcenter.y' |
| [getExtrusionRotationCenterZ()](#getExtrusionRotationCenterZ--) | แสดงคุณสมบัติ 'extrusion.rotationcenter.z' |
| [getExtrusionColorMode()](#getExtrusionColorMode--) | แสดงคุณสมบัติ 'extrusion.colormode' |
| [equals(Object obj)](#equals-java.lang.Object-) | ตรวจสอบว่าวัตถุนี้เท่ากับออบเจ็กต์อื่นหรือไม่ |
| [hashCode()](#hashCode--) | คำนวณและคืนค่า hash code ตามคุณสมบัติ (\#getValue.getValue) |
| [getOrCreateByValue(String propertyValue)](#getOrCreateByValue-java.lang.String-) | ค้นหาคุณสมบัติพฤติกรรมที่มีอยู่ตามค่า หรือสร้างค่าใหม่ตามที่ระบุ |
...
แสดงว่าคุณสมบัตินี้ไม่ได้อยู่ในรายการคุณสมบัติกำหนดล่วงหน้าในข้อกำหนด: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx
...
แสดงคุณสมบัติ 'style.visibility'
...
แสดงคุณสมบัติ 'style.fontWeight'
...
แสดงคุณสมบัติ 'style.fontFamily'
...
แสดงคุณสมบัติ 'style.textEffectEmboss'
...
แสดงคุณสมบัติ 'style.textShadow'
...
แสดงคุณสมบัติ 'style.textTransform'
...
แสดงคุณสมบัติ 'style.textEffectOutline'
...
แสดงคุณสมบัติ 'style.textDecorationLineThrough'
...
แสดงคุณสมบัติ 'imageData.cropTop'
...
แสดงคุณสมบัติ 'imageData.cropBottom'
...
แสดงคุณสมบัติ 'imageData.cropLeft'
...
แสดงคุณสมบัติ 'imageData.cropRight'
...
ตรวจสอบว่าอ็อบเจ็กต์นี้เท่ากับอ็อบเจ็กต์อื่นหรือไม่
...
**คืนค่า:**
boolean - true หากอ็อบเจ็กต์เท่ากัน
### hashCode() {#hashCode--}
```
public boolean equals(Object obj)
```
...
**คืนค่า:**
int - คืนค่า hash code สำหรับอ็อบเจ็กต์นี้
...
ค้นหาคุณสมบัติ behavior ที่มีค่าเดิมหรือสร้างใหม่ด้วยค่าที่ระบุ
