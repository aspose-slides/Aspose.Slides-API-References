...
description: เป็นตัวแทนของเอฟเฟกต์ Alpha Replace.
type: docs
url: /th/com.aspose.slides/alphareplace/
---
**Inheritance:**
...
เป็นตัวแทนของเอฟเฟกต์ Alpha Replace. ค่าความทึบ (opacity) ของเอฟเฟกต์จะถูกแทนที่ด้วยค่าอัลฟ่าคงที่.
## Methods
