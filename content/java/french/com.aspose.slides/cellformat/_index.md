...
| [getBorderDiagonalDown()](#getBorderDiagonalDown--) | Renvoie un objet de propriétés de ligne diagonale du coin supérieur gauche au coin inférieur droit. |
| [getBorderDiagonalUp()](#getBorderDiagonalUp--) | Renvoie un objet de propriétés de ligne diagonale du coin inférieur gauche au coin supérieur droit. |
| [getEffective()](#getEffective--) | Obtient les propriétés de mise en forme effectives de la cellule de tableau avec l'héritage et les styles de tableau appliqués. |
...
Renvoie un objet de propriétés de ligne diagonale du coin supérieur gauche au coin inférieur droit. Lecture seule [ILineFormat](../../com.aspose.slides/ilineformat).
...
Renvoie un objet de propriétés de ligne diagonale du coin inférieur gauche au coin supérieur droit. Lecture seule [ILineFormat](../../com.aspose.slides/ilineformat).
...
Obtient les propriétés de mise en forme effectives de la cellule de tableau avec l'héritage et les styles de tableau appliqués.
