...
| Méthode | Description |
| --- | --- |
| [formatShape(ISvgShape svgShape, IShape shape)](#formatShape-com.aspose.slides.ISvgShape-com.aspose.slides.IShape-) | Cette fonction est appelée avant le rendu de la forme en SVG afin de permettre à l'utilisateur de contrôler le SVG résultant. |
...
| --- | --- | --- |
| svgShape | [ISvgShape](../../com.aspose.slides/isvgshape) | Objet pour contrôler la génération de formes SVG. |
