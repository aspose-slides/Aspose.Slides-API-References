...
| [getTiming()](#getTiming--) | Représente les propriétés de synchronisation du comportement d'effet. |
| [setTiming(ITiming value)](#setTiming-com.aspose.slides.ITiming-) | Représente les propriétés de synchronisation du comportement d'effet. |
### getParent_Immediate() {#getParent-Immediate--}
```
...
Représente les propriétés de synchronisation du comportement d'effet. Lecture/écriture [ITiming](../../com.aspose.slides/itiming).
