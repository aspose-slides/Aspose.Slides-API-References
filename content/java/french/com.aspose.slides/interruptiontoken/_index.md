...
description: Cette classe représente le jeton à utiliser pour signaler les tâches de longue durée lorsqu’une interruption a été demandée.
type: docs
...
Cette classe représente le jeton à utiliser pour signaler les tâches de longue durée lorsque l’interruption a été demandée.
...
| [isInterruptionRequested()](#isInterruptionRequested--) | Renvoie true si une interruption a été demandée. |
