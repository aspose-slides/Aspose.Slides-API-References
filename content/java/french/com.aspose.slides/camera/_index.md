...
| [setFieldOfViewAngle(float value)](#setFieldOfViewAngle-float-) | FOV de la caméra (0-180 deg, champ de vision). |
...
FOV de la caméra (0-180 deg, champ de vision). Lecture/écriture float.
