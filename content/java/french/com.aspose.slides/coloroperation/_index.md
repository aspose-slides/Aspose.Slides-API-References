...
| Paramètre | Type | Description |
| --- | --- | --- |
| obj | java.lang.Object | La ColorOperation à comparer avec la ColorOperation courante. |

**Renvoie :**
boolean - **true** si la ColorOperation spécifiée est égale à la ColorOperation courante ; sinon, **false**.
