...
| Méthode | Description |
| --- | --- |
| [getCount()](#getCount--) | Retourne le nombre de comportements dans une collection. |
...
| [copyTo(IBehavior[] array, int arrayIndex)](#copyTo-com.aspose.slides.IBehavior---int-) | Copie les éléments du [IGenericCollection](../../com.aspose.slides/igenericcollection) vers un Array, en commençant à un index d'Array particulier. |
...
| [get_Item(int index)](#get-Item-int-) | Retourne un comportement à l'index spécifié. |
...
Retourne le nombre de comportements dans une collection. Lecture seule int.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| item | [IBehavior](../../com.aspose.slides/ibehavior) | L'objet à localiser dans la List. |
...
Copie les éléments du [IGenericCollection](../../com.aspose.slides/igenericcollection) vers un Array, en commençant à un index d'Array particulier.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | Index d'un comportement à supprimer. |
...
Retourne un comportement à l'index spécifié.

**Paramètres:**
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | Index d'un comportement à retourner. |
