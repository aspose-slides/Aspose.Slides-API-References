...
| [getEndShapeConnectionSiteIndex()](#getEndShapeConnectionSiteIndex--) | Renvoie ou définit l'index du site de connexion pour la forme d'arrivée. |
| [setEndShapeConnectionSiteIndex(long value)](#setEndShapeConnectionSiteIndex-long-) | Renvoie ou définit l'index du site de connexion pour la forme d'arrivée. |
...
Renvoie ou définit l'index du site de connexion pour la forme d'arrivée. Lecture/écriture long.
