...
| Méthode | Description |
| --- | --- |
| [getRawValue()](#getRawValue--) | Renvoie ou définit la valeur d'ajustement « as is ». |
| [setRawValue(long value)](#setRawValue-long-) | Renvoie ou définit la valeur d'ajustement « as is ». |
...
| [getType()](#getType--) | Renvoie le type de l'ajustement de la forme. |
...
Renvoie ou définit la valeur d'ajustement « as is ». Lecture/écriture long.
...
Renvoie le type de l'ajustement de la forme. Lecture seule [ShapeAdjustmentType](../../com.aspose.slides/shapeadjustmenttype).
