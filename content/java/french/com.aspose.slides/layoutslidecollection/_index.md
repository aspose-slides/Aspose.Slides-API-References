...
| [removeUnused()](#removeUnused--) | Supprime les diapositives de mise en page inutilisées (diapositives de mise en page dont HasDependingSlides est false). |
...
Renvoie la diapositive de mise en page par indice. Lecture seule [LayoutSlide](../../com.aspose.slides/layoutslide).
...
**Renvoie :**
[ILayoutSlide](../../com.aspose.slides/ilayoutslide) - [LayoutSlide](../../com.aspose.slides/layoutslide) avec le type spécifié ou null si aucune mise en page n'est trouvée.
...
Supprime les diapositives de mise en page inutilisées (diapositives de mise en page dont HasDependingSlides est false).
