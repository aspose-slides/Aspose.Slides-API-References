...
Cette interface est utilisée avec l'interface [ITextFrameFormat](../../com.aspose.slides/itextframeformat) pour renvoyer les valeurs de formatage effectives avec l'héritage appliqué.

## Méthodes

| Méthode | Description |
| --- | --- |
| [getTextStyle()](#getTextStyle--) | Renvoie le style du texte effectif. |
...
| [getWrapText()](#getWrapText--) | Renvoie si le texte est renvoyé à la ligne aux marges du TextFrame. |
...
Renvoie le style du texte effectif. Lecture seule [ITextStyleEffectiveData](../../com.aspose.slides/itextstyleeffectivedata).
...
Renvoie si le texte est renvoyé à la ligne aux marges du TextFrame. Lecture seule boolean.
