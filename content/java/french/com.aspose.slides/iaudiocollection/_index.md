...
Récupère l'élément à l'index spécifié. Lecture seule [IAudio](../../com.aspose.slides/iaudio).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| stream | java.io.InputStream | Flux à partir duquel ajouter l'audio. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| stream | java.io.InputStream | Flux à partir duquel ajouter l'audio vidéo. |
