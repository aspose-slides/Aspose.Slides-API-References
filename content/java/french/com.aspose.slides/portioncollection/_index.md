...
| [copyTo(IPortion[] array, int arrayIndex)](#copyTo-com.aspose.slides.IPortion---int-) | Copie les éléments du [IGenericCollection](../../com.aspose.slides/igenericcollection) dans un tableau, en commençant à un index de tableau particulier. |
...
Obtient une valeur indiquant si le [IGenericCollection](../../com.aspose.slides/igenericcollection) est en lecture seule. Lecture seule booléen.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | L'index basé sur zéro à lequel le Portion doit être inséré. |
...
**Retour :**  
booléen - true si l'élément a été supprimé avec succès du [IGenericCollection](../../com.aspose.slides/igenericcollection) ; sinon, false. Cette méthode renvoie également false si l'élément n'est pas trouvé dans le [IGenericCollection](../../com.aspose.slides/igenericcollection) original.
