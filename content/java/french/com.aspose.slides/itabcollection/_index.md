...
Obtient l'élément à l'index spécifié. Lecture seule [ITab](../../com.aspose.slides/itab).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [ITab](../../com.aspose.slides/itab) | L'objet Onglet à ajouter à la fin de la collection. |
