...
type: docs
url: /fr/com.aspose.slides/notesslide/
---
**Héritage :**  
...
| [getNotesTextFrame()](#getNotesTextFrame--) | Renvoie un TextFrame contenant le texte des notes s'il existe. |
| [getThemeManager()](#getThemeManager--) | Renvoie le gestionnaire de thème de substitution. |
| [getParentSlide()](#getParentSlide--) | Renvoie la diapositive parente. |
...
Renvoie un TextFrame contenant le texte des notes s'il existe. Lecture seule [ITextFrame](../../com.aspose.slides/itextframe).
...
Renvoie la diapositive parente. Lecture seule [ISlide](../../com.aspose.slides/islide).
