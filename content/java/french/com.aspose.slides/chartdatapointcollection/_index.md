...
| [getDataSourceTypeForXValues()](#getDataSourceTypeForXValues--) | Spécifie si la propriété AsCell ou AsLiteralString ou AsLiteralDouble est effective dans l'objet de la propriété XValue des points de données. |
| [setDataSourceTypeForXValues(int value)](#setDataSourceTypeForXValues-int-) | Spécifie si la propriété AsCell ou AsLiteralString ou AsLiteralDouble est effective dans l'objet de la propriété XValue des points de données. |
| [getDataSourceTypeForYValues()](#getDataSourceTypeForYValues--) | Spécifie si la propriété AsCell ou AsLiteralString ou AsLiteralDouble est effective dans l'objet de la propriété YValue des points de données. |
| [setDataSourceTypeForYValues(int value)](#setDataSourceTypeForYValues-int-) | Spécifie si la propriété AsCell ou AsLiteralString ou AsLiteralDouble est effective dans l'objet de la propriété YValue des points de données. |
| [getDataSourceTypeForBubbleSizes()](#getDataSourceTypeForBubbleSizes--) | Spécifie si la propriété AsCell ou AsLiteralString ou AsLiteralDouble est effective dans l'objet de la propriété BubbleSize des points de données. |
| [setDataSourceTypeForBubbleSizes(int value)](#setDataSourceTypeForBubbleSizes-int-) | Spécifie si la propriété AsCell ou AsLiteralString ou AsLiteralDouble est effective dans l'objet de la propriété BubbleSize des points de données. |
| [getDataSourceTypeForValues()](#getDataSourceTypeForValues--) | Spécifie si la propriété AsCell ou AsLiteralString ou AsLiteralDouble est effective dans l'objet de la propriété Value des points de données. |
| [setDataSourceTypeForValues(int value)](#setDataSourceTypeForValues-int-) | Spécifie si la propriété AsCell ou AsLiteralString ou AsLiteralDouble est effective dans l'objet de la propriété Value des points de données. |
| [getDataSourceTypeForErrorBarsCustomValues()](#getDataSourceTypeForErrorBarsCustomValues--) | Spécifie les types de valeurs dans la liste de propriétés ChartDataPoint.ErrorBarsCustomValues. |
| [getOrCreateDataPointByIdx(long index)](#getOrCreateDataPointByIdx-long-) | Si la collection contient déjà un point de données avec l'indice index, alors retourne ce point de données. |
| [size()](#size--) | Obtient le nombre d'éléments effectivement contenus dans la collection. |
| [copyTo(System.Array array, int arrayIndex)](#copyTo-com.aspose.ms.System.Array-int-) | Copie dans le tableau spécifié. |
...
Spécifie si la propriété AsCell ou AsLiteralString ou AsLiteralDouble est effective dans l'objet de la propriété XValue des points de données. En d’autres termes, elle indique le type de valeur de la propriété ChartDataPoint.XValue.Data. Lecture/écriture [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Spécifie si la propriété AsCell ou AsLiteralString ou AsLiteralDouble est effective dans l'objet de la propriété YValue des points de données. En d’autres termes, elle indique le type de valeur de la propriété ChartDataPoint.YValue.Data. Lecture/écriture [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Spécifie si la propriété AsCell ou AsLiteralString ou AsLiteralDouble est effective dans l'objet de la propriété Value des points de données. En d’autres termes, elle indique le type de valeur de la propriété ChartDataPoint.Value.Data. Lecture/écriture [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Spécifie les types de valeurs dans la liste de propriétés ChartDataPoint.ErrorBarsCustomValues. Lecture seule [IDataSourceTypeForErrorBarsCustomValues](../../com.aspose.slides/idatasourcetypeforerrorbarscustomvalues).
...
Si la collection contient déjà un point de données avec l'indice index, alors retourne ce point de données. Si la collection ne contient pas de point de données avec index == N (lorsque le nombre de points de données dans cette collection est inférieur ou égal à N), alors ajoute les points manquants et retourne le dernier (qui possède l'indice demandé). Par exemple, les indices de la collection sont {0, 1, 2} et l'indice demandé est 5. La méthode ajoute alors les points manquants : {0, 1, 2, 3, 4, 5} et renvoie le point de données d’indice 5.
...
Obtient le nombre d'éléments effectivement contenus dans la collection. int en lecture seule.
...
| arrayIndex | int | Index de départ pour la copie. |
...
**Renvoie :**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IChartDataPoint> - Un IGenericEnumerator pouvant être utilisé pour parcourir la collection.
...
```
Crée le nouveau point de données et l’ajoute à la fin de la collection. Applicable aux séries dont le chartType est l’un des sous-types Stock (voir également la méthode [ChartTypeCharacterizer.isChartTypeStock(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeStock-int-)).
...
Crée le nouveau point de données et l’ajoute à la fin de la collection. Applicable aux séries dont le chartType est l’un des sous-types Line (voir également la méthode [ChartTypeCharacterizer.isChartTypeLine(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeLine-int-)).
...
Crée le nouveau point de données et l’ajoute à la fin de la collection. Applicable aux séries dont le chartType est l’un des sous-types Scatter (voir également la méthode [ChartTypeCharacterizer.isChartTypeScatter(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeScatter-int-)).

**Paramètres:**
| Paramètre | Type | Description |
| --- | --- | --- |
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valeur X du point de données |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valeur Y du point de données |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| xValue | java.lang.String | Valeur X du point de données |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valeur Y du point de données |
...
Crée le nouveau point de données et l’ajoute à la fin de la collection. Applicable aux séries dont le chartType est l’un des sous-types Radar (voir également la méthode [ChartTypeCharacterizer.isChartTypeRadar(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeRadar-int-)).
...
Crée le nouveau point de données et l’ajoute à la fin de la collection. Applicable aux séries dont le chartType est l’un des sous-types Column ou Bar (voir également les méthodes [ChartTypeCharacterizer.isChartTypeColumn(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeColumn-int-) et [ChartTypeCharacterizer.isChartTypeBar(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeBar-int-)).
...
Crée le nouveau point de données et l’ajoute à la fin de la collection. Applicable aux séries dont le chartType est l’un des sous-types Area (voir également la méthode [ChartTypeCharacterizer.isChartTypeArea(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeArea-int-)).
...
Crée le nouveau point de données et l’ajoute à la fin de la collection. Applicable aux séries dont le chartType est l’un des sous-types Pie (voir également la méthode [ChartTypeCharacterizer.isChartTypePie(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypePie-int-)).
...
Crée le nouveau point de données et l’ajoute à la fin de la collection. Applicable aux séries dont le chartType est l’un des sous-types Doughnut (voir également la méthode [ChartTypeCharacterizer.isChartTypeDoughnut(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeDoughnut-int-)).
...
Crée le nouveau point de données et l’ajoute à la fin de la collection. Applicable aux séries dont le chartType est l’un des sous-types Bubble (voir également la méthode [ChartTypeCharacterizer.isChartTypeBubble(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeBubble-int-)).
...
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valeur X du point de données |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Valeur Y du point de données |
| bubbleSize | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Taille de la bulle du point de données |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| xValue | java.lang.String | Point de données XValue |
| yValue | double | Point de données YValue |
| bubbleSize | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Point de données BubbleSize |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Point de données XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Point de données YValue |
| bubbleSize | double | Point de données BubbleSize |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| xValue | double | Point de données XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Point de données YValue |
| bubbleSize | double | Point de données BubbleSize |
...
Crée le nouveau point de données et l’ajoute à la fin de la collection. Applicable aux séries dont le chartType est l’un des sous-types Surface (voir également la méthode [ChartTypeCharacterizer.isChartTypeSurface(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeSurface-int-)).

**Paramètres :**
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Point de données Value |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | double | Point de données Value |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| sizeValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Point de données SizeValue |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Point de données ColorValue |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [IChartDataPoint](../../com.aspose.slides/ichartdatapoint) | La valeur. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | Index d’un point de données à supprimer. |