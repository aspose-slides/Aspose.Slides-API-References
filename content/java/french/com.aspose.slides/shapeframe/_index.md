...
| [getRotation()](#getRotation--) | Renvoie le nombre de degrés de rotation du cadre autour de l’axe z. |
| [getCenterX()](#getCenterX--) | Renvoie la coordonnée X du centre du cadre. |
| [getCenterY()](#getCenterY--) | Renvoie la coordonnée Y du centre du cadre. |
| [getFlipH()](#getFlipH--) | Détermine si le cadre est retourné horizontalement. |
| [getFlipV()](#getFlipV--) | Détermine si le cadre est retourné verticalement. |
...
Renvoie le nombre de degrés de rotation du cadre autour de l’axe z. Une valeur positive indique une rotation dans le sens horaire ; une valeur négative indique une rotation dans le sens anti-horaire. Lecture seule float.
...
Renvoie la coordonnée X du centre du cadre. Lecture seule float.
...
Renvoie la coordonnée Y du centre du cadre. Lecture seule float.
...
Détermine si le cadre est retourné horizontalement. Lecture seule [NullableBool](../../com.aspose.slides/nullablebool).
...
Détermine si le cadre est retourné verticalement. Lecture seule [NullableBool](../../com.aspose.slides/nullablebool).
...
Renvoie les coordonnées d’un cadre. Lecture seule java.awt.geom.Rectangle2D.Float.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| obj | java.lang.Object | L’objet à comparer à cette instance. |

**Renvoie :**  
boolean - **true** si obj est un ShapeFrame dont la valeur est identique à celle de cette instance ; sinon, **false**.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [ShapeFrame](../../com.aspose.slides/shapeframe) | Le ShapeFRameEx à comparer à cette instance. |

**Renvoie :**  
boolean - **true** si value est un ShapeFrame dont la valeur est identique à celle de cette instance ; sinon, **false**.