...
| [getSlide()](#getSlide--) | Renvoie la diapositive parente d'un CellCollection. |
| [getPresentation()](#getPresentation--) | Renvoie la présentation parente d'un CellCollection. |
...
Renvoie la diapositive parente d'un CellCollection. Lecture seule [IBaseSlide](../../com.aspose.slides/ibaseslide).
...
Renvoie la présentation parente d'un CellCollection. Lecture seule [IPresentation](../../com.aspose.slides/ipresentation).
