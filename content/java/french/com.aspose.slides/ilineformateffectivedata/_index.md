...
description: Objet immuable qui contient les propriétés de formatage effectif des lignes.
type: docs
...
Objet immuable qui contient les propriétés de formatage effectif des lignes.

--------------------

Cette interface est utilisée conjointement avec l'interface [ILineFormat](../../com.aspose.slides/ilineformat) pour renvoyer les valeurs de formatage effectif avec l'héritage appliqué.
## Méthodes
...
| [getDashStyle()](#getDashStyle--) | Renvoie le style de tiret de la ligne. |
| [getCustomDashPattern()](#getCustomDashPattern--) | Renvoie le motif de tiret personnalisé. |
| [getCapStyle()](#getCapStyle--) | Renvoie le style d'extrémité de la ligne. |
| [getStyle()](#getStyle--) | Renvoie le style de la ligne. |
...
| [getMiterLimit()](#getMiterLimit--) | Renvoie la limite de chanfrein d'une ligne. |
...
Renvoie le style de tiret de la ligne. Lecture seule [LineDashStyle](../../com.aspose.slides/linedashstyle).
...
Renvoie le style d'extrémité de la ligne. Lecture seule [LineCapStyle](../../com.aspose.slides/linecapstyle).
...
Renvoie le style de la ligne. Lecture seule [LineStyle](../../com.aspose.slides/linestyle).
...
Renvoie la limite de chanfrein d'une ligne. Lecture seule float.
...
| --- | --- | --- |
| lf | [ILineFormatEffectiveData](../../com.aspose.slides/ilineformateffectivedata) | Le ILineFormatEffectiveData à comparer avec le ILineFormatEffectiveData actuel. |
