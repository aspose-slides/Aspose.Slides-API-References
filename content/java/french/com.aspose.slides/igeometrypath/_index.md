...
| [closeFigure()](#closeFigure--) | Ferme la figure courante de ce chemin |
| [moveTo(Point2D.Float point)](#moveTo-java.awt.geom.Point2D.Float-) | Définit la position du prochain point. |
| [moveTo(float x, float y)](#moveTo-float-float-) | Définit la position du prochain point. |
...
| [getStroke()](#getStroke--) | Définit l'apparence du contour |
| [setStroke(boolean value)](#setStroke-boolean-) | Définit l'apparence du contour |
...
Ferme la figure courante de ce chemin
