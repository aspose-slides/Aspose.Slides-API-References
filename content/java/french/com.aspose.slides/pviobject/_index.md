...
description: Encapsule l'infrastructure de service de base pour les objets pouvant être sujets à l'héritage des valeurs de propriété.
type: docs
...
Encapsule l'infrastructure de service de base pour les objets qui peuvent être sujets à l'héritage des valeurs de propriété.
## Méthodes
...
Renvoie l'objet Parent\_Immediate. Lecture seule IDOMObject.
