...
| [getChartData()](#getChartData--) | Renvoie des informations sur les données liées ou intégrées associées à un graphique. |
...
| [getChartTitle()](#getChartTitle--) | Renvoie ou définit le titre d'un graphique. |
| [hasDataTable()](#hasDataTable--) | Détermine si un graphique possède une table de données. |
| [setDataTable(boolean value)](#setDataTable-boolean-) | Détermine si un graphique possède une table de données. |
...
| [getChartDataTable()](#getChartDataTable--) | Renvoie une table de données d'un graphique. |
...
| [getType()](#getType--) | Renvoie ou définit le type de graphique. |
| [setType(int value)](#setType-int-) | Renvoie ou définit le type de graphique. |
...
Renvoie des informations sur les données liées ou intégrées associées à un graphique. Lecture seule [IChartData](../../com.aspose.slides/ichartdata).
...
Détermine si un graphique possède une table de données. Lecture/écriture booléen.
...
Renvoie une table de données d'un graphique. Lecture seule [IDataTable](../../com.aspose.slides/idatatable).
...
Renvoie ou définit le type de graphique. Lecture/écriture [ChartType](../../com.aspose.slides/charttype).
...
Renvoie le gestionnaire de thème. Lecture seule [IOverrideThemeManager](../../com.aspose.slides/ioverridethememanager).
