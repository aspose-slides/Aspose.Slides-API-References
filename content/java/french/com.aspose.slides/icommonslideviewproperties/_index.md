...
description: Représente les propriétés de vue communes.
type: docs
...
Représente les propriétés de vue communes.
## Méthodes

| Méthode | Description |
| --- | --- |
| [getScale()](#getScale--) | Spécifie le ratio d'échelle de la vue en pourcentage. |
| [setScale(int value)](#setScale-int-) | Spécifie le ratio d'échelle de la vue en pourcentage. |
...
Spécifie le ratio d'échelle de la vue en pourcentage. Lecture/écriture int.
