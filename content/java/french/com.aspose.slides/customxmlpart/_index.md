...
| [getItemId()](#getItemId--) | Spécifie un identifiant global unique (GUID) qui identifie de manière unique une partie XML personnalisée unique dans un document Office Open XML. |
| [setItemId(UUID value)](#setItemId-java.util.UUID-) | Spécifie un identifiant global unique (GUID) qui identifie de manière unique une partie XML personnalisée unique dans un document Office Open XML. |
...
Spécifie un identifiant global unique (GUID) qui identifie de manière unique une partie XML personnalisée unique dans un document Office Open XML. Lecture seule java.util.UUID.
