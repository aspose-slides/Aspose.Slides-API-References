...
| [getAnchorPoint()](#getAnchorPoint--) | Renvoie ou définit un point en 3D. |
| [setAnchorPoint(float[] value)](#setAnchorPoint-float---) | Renvoie ou définit un point en 3D. |
...
Renvoie ou définit un point en 3D. Ce point est le point d'ancrage du plan d'arrière-plan. Point 3D représenté par un tableau de 3 valeurs float qui définissent les coordonnées X, Y et Z. Lecture/écriture float[].
