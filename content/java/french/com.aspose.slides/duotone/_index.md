...
| [getEffective()](#getEffective--) | Obtient les données d’effet Duotone effectives avec l’héritage appliqué. |
...
Obtient les données d’effet Duotone effectives avec l’héritage appliqué.
