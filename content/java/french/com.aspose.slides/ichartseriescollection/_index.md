...
Représente une collection de [IChartSeries](../../com.aspose.slides/ichartseries)
## Méthodes
...
| [indexOf(IChartSeries value)](#indexOf-com.aspose.slides.IChartSeries-) | Recherche le [IChartSeries](../../com.aspose.slides/ichartseries) spécifié et renvoie l'index zéro-base de la première occurrence dans l'ensemble de la Collection |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | Index pour l'insertion |
...
Si une série de graphique créée à partir de la même cellule est déjà dans la collection, alors la méthode n'ajoute rien et renvoie son index. |
...
Recherche le [IChartSeries](../../com.aspose.slides/ichartseries) spécifié et renvoie l'index zéro-base de la première occurrence dans l'ensemble de la Collection
...
**Retour :**
int - L'index zéro-base de la première occurrence de la valeur dans l'ensemble de la CollectionBase, si trouvé ; sinon -1.
