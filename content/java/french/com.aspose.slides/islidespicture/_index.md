...
| Méthode | Description |
| --- | --- |
| [getImage()](#getImage--) | Renvoie ou définit l'image incorporée. |
| [setImage(IPPImage value)](#setImage-com.aspose.slides.IPPImage-) | Renvoie ou définit l'image incorporée. |
...
Renvoie ou définit l'image incorporée. Lecture/écriture [IPPImage](../../com.aspose.slides/ippimage).
