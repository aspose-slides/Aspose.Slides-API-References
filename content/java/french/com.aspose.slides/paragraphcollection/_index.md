...
| [addFromHtml(String text)](#addFromHtml-java.lang.String-) | Ajoute du texte depuis la chaîne html spécifiée à la collection. |
| [addFromHtml(String text, IExternalResourceResolver resolver, String uri)](#addFromHtml-java.lang.String-com.aspose.slides.IExternalResourceResolver-java.lang.String-) | Ajoute du texte depuis la chaîne html spécifiée à la collection. |
...
**Renvoie:**
boolean - vrai si le [IGenericCollection](../../com.aspose.slides/igenericcollection) est en lecture seule ; sinon, false.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | L'index basé sur zéro à laquelle le Paragraph doit être inséré. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | L'index basé sur zéro à laquelle les paragraphs doivent être insérés. |
| value | [IParagraphCollection](../../com.aspose.slides/iparagraphcollection) | Les paragraphs à insérer. |
...
**Renvoie:**
boolean - vrai si l'item est trouvé dans le [IGenericCollection](../../com.aspose.slides/igenericcollection) ; sinon, false.
...
| arrayIndex | int | L'index basé sur zéro dans le tableau à partir duquel la copie commence. |
...
**Renvoie:**
boolean - vrai si l'item a été supprimé avec succès du [IGenericCollection](../../com.aspose.slides/igenericcollection) ; sinon, false. Cette méthode renvoie également false si l'item n'est pas trouvé dans le [IGenericCollection](../../com.aspose.slides/igenericcollection) original.
### iterator() {#iterator--}
```
...
**Renvoie:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IParagraph> - Un IGenericEnumerator qui peut être utilisé pour parcourir la collection.
...
Renvoie la diapositive parente d'une collection de paragraphes. Lecture seule [BaseSlide](../../com.aspose.slides/baseslide).
...
Renvoie la présentation parente d'une collection de paragraphes. Lecture seule [IPresentation](../../com.aspose.slides/ipresentation).
...
Ajoute du texte depuis la chaîne html spécifiée à la collection.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| firstParagraphIndex | int | Premier index de paragraphe |
