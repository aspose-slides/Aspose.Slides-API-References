...
description: Représente un ensemble d'options pour la sauvegarde.
type: docs
url: /fr/com.aspose.slides/webdocumentoptions/
---
**Héritage:**
java.lang.Object
```
...
Représente un jeu d'options pour [WebDocument](../../com.aspose.slides/webdocument) sauvegarde.
## Constructeurs
...
| Méthode | Description |
| --- | --- |
| [getTemplateEngine()](#getTemplateEngine--) | Renvoie ou définit le moteur de modèles. |
| [setTemplateEngine(ITemplateEngine value)](#setTemplateEngine-com.aspose.slides.ITemplateEngine-) | Renvoie ou définit le moteur de modèles. |
| [getOutputSaver()](#getOutputSaver--) | Renvoie ou définit le sauvegardeur de sortie. |
| [setOutputSaver(IOutputSaver value)](#setOutputSaver-com.aspose.slides.IOutputSaver-) | Renvoie ou définit le sauvegardeur de sortie. |
...
Renvoie ou définit le moteur de modèles. Lecture/écriture [ITemplateEngine](../../com.aspose.slides/itemplateengine).
...
Renvoie ou définit le sauvegardeur de sortie. Lecture/écriture [IOutputSaver](../../com.aspose.slides/ioutputsaver).
