...
| [getEffective()](#getEffective--) | Obtient les données effectives du Soft Edge avec l’héritage appliqué. |
...
Obtient les données effectives du Soft Edge avec l’héritage appliqué.
