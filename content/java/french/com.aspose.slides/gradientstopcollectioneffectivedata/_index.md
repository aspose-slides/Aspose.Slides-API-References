...
type: docs
url: /fr/com.aspose.slides/gradientstopcollectioneffectivedata/
---
**Héritage :**
java.lang.Object
...
| Méthode | Description |
| --- | --- |
| [size()](#size--) | Renvoie le nombre de points d'arrêt de dégradé dans la collection. |
| [get_Item(int index)](#get-Item-int-) | Renvoie le point d'arrêt de dégradé selon l'index. |
...
Renvoie le nombre de points d'arrêt de dégradé dans la collection. Lecture seule int.
...
Renvoie le point d'arrêt de dégradé selon l'index.
