...
---
**Héritage:** [com.aspose.slides.PVIObject](../../com.aspose.slides/pviobject)

**Toutes les interfaces implémentées:** [com.aspose.slides.IBasePortionFormat](../../com.aspose.slides/ibaseportionformat)
```
...
| [getKumimoji()](#getKumimoji--) | Détermine si les nombres doivent ignorer la mise en page verticale spécifique aux langues orientales du texte. |
| [setKumimoji(byte value)](#setKumimoji-byte-) | Détermine si les nombres doivent ignorer la mise en page verticale spécifique aux langues orientales du texte. |
...
| [getProofDisabled()](#getProofDisabled--) | Détermine si le texte ne doit pas être relu. |
| [setProofDisabled(byte value)](#setProofDisabled-byte-) | Détermine si le texte ne doit pas être relu. |
...
| [getStrikethroughType()](#getStrikethroughType--) | Renvoie ou définit le type de barré du texte. |
| [setStrikethroughType(byte value)](#setStrikethroughType-byte-) | Renvoie ou définit le type de barré du texte. |
...
| [getSpacing()](#getSpacing--) | Renvoie ou définit l'incrément de l'espacement intercaractères. |
| [setSpacing(float value)](#setSpacing-float-) | Renvoie ou définit l'incrément de l'espacement intercaractères. |
...
Détermine si les nombres doivent ignorer la mise en page verticale spécifique aux langues orientales du texte. Aucun héritage appliqué. Lecture/écriture [NullableBool](../../com.aspose.slides/nullablebool).
...
Détermine si le texte ne doit pas être relu. Aucun héritage appliqué. Lecture/écriture [NullableBool](../../com.aspose.slides/nullablebool).
...
Renvoie ou définit le type de barré du texte. Aucun héritage appliqué. Lecture/écriture [TextStrikethroughType](../../com.aspose.slides/textstrikethroughtype).
...
Renvoie ou définit la hauteur de police d'une portion. **Float.NaN** signifie que la hauteur n'est pas définie et doit être héritée du maître. Lecture/écriture float.
...
Renvoie ou définit les informations de police Latin. Null signifie que la police n'est pas définie et doit être héritée du maître. Lecture/écriture [IFontData](../../com.aspose.slides/ifontdata).
...
Renvoie ou définit les informations de police Est-asiatique. Null signifie que la police n'est pas définie et doit être héritée du maître. Lecture/écriture [IFontData](../../com.aspose.slides/ifontdata).
...
Renvoie ou définit les informations de police de script complexe. Null signifie que la police n'est pas définie et doit être héritée du maître. Lecture/écriture [IFontData](../../com.aspose.slides/ifontdata).
...
Renvoie ou définit les informations de police symbolique. Null signifie que la police n'est pas définie et doit être héritée du maître. Lecture/écriture [IFontData](../../com.aspose.slides/ifontdata).
...
Renvoie ou définit le texte en exposant ou indice. Valeur de -100% (indice) à 100% (exposant). **Float.NaN** signifie que la valeur n'est pas définie et doit être héritée du maître. Lecture/écriture float.
...
Renvoie ou définit la taille minimale de police pour laquelle le crénage doit être activé. **Float.NaN** signifie que la valeur n'est pas définie et doit être héritée du maître. Lecture/écriture float.
...
Renvoie ou définit l'incrément de l'espacement intercaractères. **Float.NaN** signifie que la valeur n'est pas définie et doit être héritée du maître. Lecture/écriture float.
