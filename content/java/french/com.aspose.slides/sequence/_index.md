...
description: Représente une collection de séquence d'effets.
type: docs
...
Renvoie ou définit la forme cible pour la séquence INTERACTIVE. Si la séquence n'est pas interactive, renvoie null. Lecture/écriture [IShape](../../com.aspose.slides/ishape).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| paragraph | [IParagraph](../../com.aspose.slides/iparagraph) | Objet Paragraph [IParagraph](../../com.aspose.slides/iparagraph) |
| effectType | int | Type d'un effet d'animation [EffectType](../../com.aspose.slides/effecttype) |
| subtype | int | Sous-types d'un effet d'animation [EffectSubtype](../../com.aspose.slides/effectsubtype) |
| triggerType | int | Type de déclenchement de l'effet [EffectTriggerType](../../com.aspose.slides/effecttriggertype) |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| chart | [IChart](../../com.aspose.slides/ichart) | Objet Chart [IChart](../../com.aspose.slides/ichart) |
