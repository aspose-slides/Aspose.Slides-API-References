...
type: docs
url: /fr/com.aspose.slides/coloreffect/
---
**Héritage:**
...
| [getDirection()](#getDirection--) | Spécifie la direction dans laquelle faire tourner la teinte autour de la roue des couleurs. |
| [setDirection(int value)](#setDirection-int-) | Spécifie la direction dans laquelle faire tourner la teinte autour de la roue des couleurs. |
...
Représente l'espace colorimétrique du comportement. Lecture/écriture [ColorSpace](../../com.aspose.slides/colorspace).
...
Spécifie la direction dans laquelle faire tourner la teinte autour de la roue des couleurs. Lecture/écriture [ColorDirection](../../com.aspose.slides/colordirection).
