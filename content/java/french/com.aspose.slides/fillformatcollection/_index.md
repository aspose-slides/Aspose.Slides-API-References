...
type: docs
url: /fr/com.aspose.slides/fillformatcollection/
---
**Héritage :**
...
| [iteratorJava()](#iteratorJava--) | Retourne un itérateur java pour l'intégralité de la collection. |
...
Obtient l'élément à l'index spécifié. Lecture seule [IFillFormat](../../com.aspose.slides/ifillformat).
...
Retourne un itérateur java pour l'intégralité de la collection.
...
Retourne une valeur indiquant si l'accès à la collection est synchronisé (thread-safe). Lecture seule boolean.
