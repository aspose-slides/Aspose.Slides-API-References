...
| [getUnderlineLineFormat()](#getUnderlineLineFormat--) | Renvoie les propriétés LineFormat utilisées pour tracer la ligne de soulignement. |
...
| [getNormaliseHeight()](#getNormaliseHeight--) | Détermine si la hauteur du texte doit être normalisée. |
...
| [getStrikethroughType()](#getStrikethroughType--) | Renvoie le type de barré du texte. |
...
| [getFontHeight()](#getFontHeight--) | Renvoie la hauteur de police de la portion de texte, en points. |
| [getLatinFont()](#getLatinFont--) | Renvoie les informations de police Latin. |
| [getEastAsianFont()](#getEastAsianFont--) | Renvoie les informations de police Est-Asiatique. |
| [getComplexScriptFont()](#getComplexScriptFont--) | Renvoie les informations de police script complexe. |
| [getSymbolFont()](#getSymbolFont--) | Renvoie les informations de police symbolique. |
| [getEscapement()](#getEscapement--) | Renvoie le texte en exposant ou indice. |
...
| [getLanguageId()](#getLanguageId--) | Renvoie l'identifiant d'une langue. |
| [getAlternativeLanguageId()](#getAlternativeLanguageId--) | Renvoie l'identifiant d'une langue alternative. |
| [getSpacing()](#getSpacing--) | Renvoie l'incrément d'espacement intercaractères, en points. |
...
Renvoie la couleur utilisée pour mettre en évidence un texte. Lecture seule java.awt.Color.
...
Renvoie les propriétés LineFormat utilisées pour tracer la ligne de soulignement. Lecture seule [ILineFormatEffectiveData](../../com.aspose.slides/ilineformateffectivedata).
...
Détermine si la police est italique. Lecture seule boolean.
...
Détermine si les chiffres doivent ignorer la mise en page verticale spécifique aux langues orientales du texte. Lecture seule boolean.
...
Détermine si la hauteur du texte doit être normalisée. Lecture seule boolean.
...
Détermine si le texte ne doit pas être relu. Lecture seule boolean.
...
Renvoie le type de barré du texte. Lecture seule [TextStrikethroughType](../../com.aspose.slides/textstrikethroughtype).
...
Détermine si la smart tag doit être nettoyée. Lecture seule boolean.
...
Renvoie la hauteur de police de la portion de texte, en points. Lecture seule float.
...
Renvoie les informations de police Latin. Lecture seule [IFontData](../../com.aspose.slides/ifontdata).
...
Renvoie les informations de police Est-Asiatique. Lecture seule [IFontData](../../com.aspose.slides/ifontdata).
...
Renvoie les informations de police script complexe. Lecture seule [IFontData](../../com.aspose.slides/ifontdata).
...
Renvoie les informations de police symbolique. Lecture seule [IFontData](../../com.aspose.slides/ifontdata).
...
Renvoie le texte en exposant ou indice. Valeur de -100% (indice) à 100% (exposant). Lecture seule float.
...
Renvoie l'identifiant d'une langue. Lecture seule String.
...
Renvoie l'identifiant d'une langue alternative. Lecture seule String.
...
Renvoie l'incrément d'espacement intercaractères, en points. Lecture seule float.
