...
| [CellInvalidFormulaException(String message, String reference)](#CellInvalidFormulaException-java.lang.String-java.lang.String-) | Initialise une nouvelle instance de la classe [CellInvalidFormulaException](../../com.aspose.slides/cellinvalidformulaexception) avec un message d'erreur spécifié et une référence de cellule contenant la formule invalide. |
## Méthodes

| Méthode | Description |
| --- | --- |
| [getReference()](#getReference--) | Obtient une référence de cellule contenant la formule invalide. |
...
Initialise une nouvelle instance de la classe [CellInvalidFormulaException](../../com.aspose.slides/cellinvalidformulaexception) avec un message d'erreur spécifié et une référence de cellule contenant la formule invalide.
