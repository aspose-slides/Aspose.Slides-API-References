---
title: Picture
second_title: Référence d'API Aspose.Slides pour Java
...
Renvoie la collection des effets de transformation d'image. En lecture seule [IImageTransformOperationCollection](../../com.aspose.slides/iimagetransformoperationcollection).
...
Renvoie la présentation. En lecture seule [IPresentation](../../com.aspose.slides/ipresentation).
...
**Renvoie :**  
boolean - vrai si les objets sont égaux, sinon false.
...
Renvoie la diapositive parente d'une image. En lecture seule [IBaseSlide](../../com.aspose.slides/ibaseslide).
