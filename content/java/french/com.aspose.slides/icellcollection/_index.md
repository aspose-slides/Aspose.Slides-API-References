...
| Méthode | Description |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Renvoie une cellule à sa position. |
### get_Item(int index) {#get-Item-int-}
```
public abstract ICell get_Item(int index)
```

Renvoie une cellule à sa position. En lecture seule [ICell](../../com.aspose.slides/icell).

--------------------

Un objet CellEx peut être renvoyé pour plusieurs index lorsqu'une cellule est fusionnée.
