...
description: Représente les propriétés de synchronisation du comportement de l'effet.
type: docs
...
Représente les propriétés de synchronisation du comportement de l'effet.
...
| [indexOf(String propertyValue)](#indexOf-java.lang.String-) | Détermine l’index d’un élément spécifique par la valeur de la propriété dans la List. |
...
Détermine l’index d’un élément spécifique par la valeur de la propriété dans la List.
...
**Retourne :**  
boolean - true si une propriété a été supprimée avec succès boolean
