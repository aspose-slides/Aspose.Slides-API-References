...
| Méthode | Description |
| --- | --- |
| [getCount()](#getCount--) | Retourne le nombre d'éléments dans une collection en lecture seule int. |
...
| [get_Item(int index)](#get-Item-int-) | Retourne une séquence à l'index spécifié. |
...
Retourne le nombre d'éléments dans une collection en lecture seule int.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | Index d'une séquence qui doit être supprimée. |
...
Retourne une séquence à l'index spécifié.
