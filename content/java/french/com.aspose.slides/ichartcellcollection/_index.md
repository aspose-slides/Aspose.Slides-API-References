...
| [getConcatenatedValuesFromCells()](#getConcatenatedValuesFromCells--) | Chaîne de concaténation à partir de toutes les valeurs de chaîne des cellules. |
| [get_Item(int index)](#get-Item-int-) | Renvoie une cellule (IChartDataCell) par indice. |
...
| [removeAt(int index)](#removeAt-int-) | Supprime une cellule de la collection par indice. |
...
Renvoie une cellule (IChartDataCell) par indice.
...
Supprime une cellule de la collection par indice.

**Paramètres :**
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | Indice d'une cellule à supprimer. |
