...
description: La classe de contrôleur de formatage à utiliser pour l’intégration des polices au format WOFF
type: docs
...
Appelé pour écrire l’en-tête du diapositive html. Appelé une fois pour chaque diapositive.
...
Appelé pour écrire le pied de page du diapositive html. Appelé une fois pour chaque diapositive.
...
Appelé avant le rendu de la forme. Appelé une fois pour chaque forme. Si cette fonction écrit quelque chose dans le générateur, la génération d’image de la diapositive en cours sera terminée, le fragment html ajouté sera inséré et une nouvelle image sera démarrée au-dessus de la précédente.
