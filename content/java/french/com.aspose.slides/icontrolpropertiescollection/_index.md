...
| [getNamesOfProperties()](#getNamesOfProperties--) | Renvoie le nombre de propriétés dans la collection. |
...
Renvoie le nombre de propriétés dans la collection. Lecture seule [IGenericCollection](../../com.aspose.slides/igenericcollection).
