...
| [bitmap(float scale, int imageFormat)](#bitmap-float-int-) | Les diapositives doivent être converties en image matricielle. |
### SlideImageFormat() {#SlideImageFormat--}
```
...
| --- | --- | --- |
| options | [SVGOptions](../../com.aspose.slides/svgoptions) | Options pour l'exportation SVG. |
...
Les diapositives doivent être converties en image matricielle.

**Paramètres:**
| Paramètre | Type | Description |
| --- | --- | --- |
| scale | float | Le facteur par lequel mettre à l'échelle l'image de sortie. |
