...
type: docs
url: /fr/com.aspose.slides/captions/
---
**Héritage :**
java.lang.Object
...
| Méthode | Description |
| --- | --- |
| [getCaptionId()](#getCaptionId--) | Renvoie l'identifiant unique global (GUID) des sous-titres fermés. |
| [getLabel()](#getLabel--) | Renvoie ou définit le libellé des sous-titres fermés. |
| [setLabel(String value)](#setLabel-java.lang.String-) | Renvoie ou définit le libellé des sous-titres fermés. |
...
Renvoie l'identifiant unique global (GUID) des sous-titres fermés. Lecture seule java.util.UUID.
...
Renvoie ou définit le libellé des sous-titres fermés. Lecture/écriture String.
