...
| [remove(String name)](#remove-java.lang.String-) | Supprime l'étiquette avec un nom spécifié de la collection. |
| [indexOfName(String name)](#indexOfName-java.lang.String-) | Renvoie l'index basé sur zéro de la clé spécifiée dans la collection. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| name | java.lang.String | Le nom à localiser dans la collection. |

**Renvoie :**
int - L'index basé sur zéro de la clé, si la clé est trouvée dans la collection ; sinon, -1.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | L'index basé sur zéro de l'étiquette à supprimer. |
### clear() {#clear--}
```
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | Index d'une étiquette à renvoyer. |
