...
description: Représente un stockage temporaire de données pour .
type: docs
...
Représente un stockage temporaire de données pour [WebDocument](../../com.aspose.slides/webdocument).
## Constructeurs
...
**Retour :**
boolean - Vrai si le stockage contient un élément avec la clé spécifiée, false sinon.