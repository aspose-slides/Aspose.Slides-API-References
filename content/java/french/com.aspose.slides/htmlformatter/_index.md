...
| [createSlideShowFormatter(String css, boolean showSlideTitle)](#createSlideShowFormatter-java.lang.String-boolean-) | Crée et renvoie un formateur HTML pour une présentation de diapositives simple qui affiche les diapositives les unes après les autres. |
...
Crée et renvoie un formateur HTML pour une présentation de diapositives simple qui affiche les diapositives les unes après les autres.
