...
| Paramètre | Type | Description |
| --- | --- | --- |
| ignorePreserveField | boolean | Détermine si cette méthode doit supprimer les maîtres inutilisés même si leurs propriétés [IMasterSlide.getPreserve](../../com.aspose.slides/imasterslide\#getPreserve)/[IMasterSlide.setPreserve(boolean)](../../com.aspose.slides/imasterslide\#setPreserve-boolean-) sont définies sur true. |
