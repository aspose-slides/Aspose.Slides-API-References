...
| [getBy()](#getBy--) | Décrit la valeur de décalage relative pour l'animation de couleur. |
| [setBy(IColorOffset value)](#setBy-com.aspose.slides.IColorOffset-) | Décrit la valeur de décalage relative pour l'animation de couleur. |
| [getColorSpace()](#getColorSpace--) | Représente l'espace couleur du comportement. |
| [setColorSpace(int value)](#setColorSpace-int-) | Représente l'espace couleur du comportement. |
| [getDirection()](#getDirection--) | Spécifie la direction dans laquelle faire tourner la teinte autour de la roue chromatique. |
| [setDirection(int value)](#setDirection-int-) | Spécifie la direction dans laquelle faire tourner la teinte autour de la roue chromatique. |
### getFrom() {#getFrom--}
```
...
Décrit la valeur de décalage relative pour l'animation de couleur. Lecture/écriture [IColorOffset](../../com.aspose.slides/icoloroffset).
...
Représente l'espace couleur du comportement. Lecture/écriture [ColorSpace](../../com.aspose.slides/colorspace)(\#getColorSpace.getColorSpace/\#setColorSpace(int).setColorSpace(int)).
...
Spécifie la direction dans laquelle faire tourner la teinte autour de la roue chromatique. Lecture/écriture [ColorDirection](../../com.aspose.slides/colordirection).
