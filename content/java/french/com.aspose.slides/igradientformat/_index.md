...
| [getGradientStops()](#getGradientStops--) | Renvoie la collection des arrêts du dégradé. |
...
Renvoie la collection des arrêts du dégradé. Lecture seule [IGradientStopCollection](../../com.aspose.slides/igradientstopcollection).
