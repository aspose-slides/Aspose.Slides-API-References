...
description: Classe de contrôleur de mise en forme à utiliser pour l'incorporation des polices au format EOT
type: docs
...
La classe de contrôleur de mise en forme à utiliser pour l'incorporation des polices au format EOT
## Constructeurs
...
| --- | --- | --- |
| controller | [IHtmlFormattingController](../../com.aspose.slides/ihtmlformattingcontroller) | contrôleur de mise en forme HTML. |
