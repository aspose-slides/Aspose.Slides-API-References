...
| [getBulletFillFormat()](#getBulletFillFormat--) | Renvoie l'objet FillFormat qui contient les propriétés de mise en forme de remplissage pour le puce d'un nœud. |
...
| [getOrganizationChartLayout()](#getOrganizationChartLayout--) | Renvoie ou définit le type de disposition du diagramme d'organisation associé au nœud actuel. |
| [setOrganizationChartLayout(int value)](#setOrganizationChartLayout-int-) | Renvoie ou définit le type de disposition du diagramme d'organisation associé au nœud actuel. |
...
Renvoie l'objet FillFormat qui contient les propriétés de mise en forme de remplissage pour le puce d'un nœud. Remarque : peut renvoyer null pour certains types de mise en page SmartArt qui ne prévoient pas de puces pour les nœuds. Lecture seule [IFillFormat](../../com.aspose.slides/ifillformat).
...
Renvoie ou définit le type de disposition du diagramme d'organisation associé au nœud actuel. Lecture/écriture [OrganizationChartLayoutType](../../com.aspose.slides/organizationchartlayouttype).
...
**Renvoie :**
booléen - vrai si supprimé avec succès, sinon false.