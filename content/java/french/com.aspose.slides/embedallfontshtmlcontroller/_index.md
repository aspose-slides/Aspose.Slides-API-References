...
Appelé avant le rendu de la forme. Appelé une fois par chaque forme. Si cette fonction écrit quoi que ce soit dans le générateur, la génération de l'image de la diapositive en cours sera terminée, le fragment html ajouté sera inséré et une nouvelle image sera démarrée au-dessus de la précédente.
...
| substitutedFont | [IFontData](../../com.aspose.slides/ifontdata) | Police substituée (si une substitution de police a eu lieu), sinon null |
| fontStyle | java.lang.String | Style de police |
| fontWeight | java.lang.String | Poids de police |
