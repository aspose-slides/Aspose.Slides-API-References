...
**Retour :**
int - L'index de l'élément si trouvé dans la collection ; sinon, -1.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | L'index basé sur zéro où le Portion doit être inséré. |
...
**Retour :**
boolean - true si l'élément a été supprimé avec succès du [IGenericCollection](../../com.aspose.slides/igenericcollection) ; sinon, false. Cette méthode renvoie également false si l'élément n'est pas trouvé dans le [IGenericCollection](../../com.aspose.slides/igenericcollection) original.
