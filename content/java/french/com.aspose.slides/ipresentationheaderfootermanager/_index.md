...
| Méthode | Description |
| --- | --- |
| [setAllHeadersVisibility(boolean isVisible)](#setAllHeadersVisibility-boolean-) | Modifie la visibilité de tous les espaces réservés d'en-tête, y compris le maître des notes, les diapositives de notes et le maître du document de distribution. |
...
| [setAllHeadersText(String text)](#setAllHeadersText-java.lang.String-) | Définit le texte de tous les espaces réservés d'en-tête, y compris le maître des notes, les diapositives de notes et le maître du document de distribution. |
...
Modifie la visibilité de tous les espaces réservés d'en-tête, y compris le maître des notes, les diapositives de notes et le maître du document de distribution.
...
Définit le texte de tous les espaces réservés d'en-tête, y compris le maître des notes, les diapositives de notes et le maître du document de distribution.
...
Modifie la visibilité des espaces réservés de pied de page, de date-heure et de numéro de page pour toutes les diapositives de titre et pour la première diapositive de mise en page. Diapositives de titre \\u2013 diapositives basées sur la première diapositive de mise en page (indépendamment du type de cette première mise en page).
