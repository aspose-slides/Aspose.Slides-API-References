...
| [getMajorTickMark()](#getMajorTickMark--) | Représente le type de marque de graduation majeure pour l'axe spécifié. |
| [setMajorTickMark(int value)](#setMajorTickMark-int-) | Représente le type de marque de graduation majeure pour l'axe spécifié. |
| [getMinorTickMark()](#getMinorTickMark--) | Représente le type de marque de graduation mineure pour l'axe spécifié. |
| [setMinorTickMark(int value)](#setMinorTickMark-int-) | Représente le type de marque de graduation mineure pour l'axe spécifié. |
...
| [getMajorUnitScale()](#getMajorUnitScale--) | Représente l'échelle de l'unité majeure pour l'axe des dates. |
| [setMajorUnitScale(int value)](#setMajorUnitScale-int-) | Représente l'échelle de l'unité majeure pour l'axe des dates. |
| [getMinorUnitScale()](#getMinorUnitScale--) | Représente l'échelle de l'unité majeure pour l'axe des dates. |
| [setMinorUnitScale(int value)](#setMinorUnitScale-int-) | Représente l'échelle de l'unité majeure pour l'axe des dates. |
| [getBaseUnitScale()](#getBaseUnitScale--) | Spécifie la plus petite unité de temps représentée sur l'axe des dates. |
| [setBaseUnitScale(int value)](#setBaseUnitScale-int-) | Spécifie la plus petite unité de temps représentée sur l'axe des dates. |
...
| [getShowMinorGridLines()](#getShowMinorGridLines--) | Pour masquer la grille mineure, définissez MinorGridLinesFormat.Line.FillFormat.FillType sur FillType.NoFill. |
| [getShowMajorGridLines()](#getShowMajorGridLines--) | Pour masquer la grille majeure, définissez MajorGridLinesFormat.Line.FillFormat.FillType sur FillType.NoFill. |
...
| [getCrossType()](#getCrossType--) | Représente le CrossType sur l'axe spécifié où l'autre axe le traverse. |
| [setCrossType(int value)](#setCrossType-int-) | Représente le CrossType sur l'axe spécifié où l'autre axe le traverse. |
...
| [hasTitle()](#hasTitle--) | Détermine si un axe a un titre visible. |
| [setTitle(boolean value)](#setTitle-boolean-) | Détermine si un axe a un titre visible. |
...
| [getTickLabelRotationAngle()](#getTickLabelRotationAngle--) | Représente l'angle de rotation des étiquettes de graduation. |
| [setTickLabelRotationAngle(float value)](#setTickLabelRotationAngle-float-) | Représente l'angle de rotation des étiquettes de graduation. |
| [getTickLabelSpacing()](#getTickLabelSpacing--) | Spécifie le nombre d'étiquettes de graduation à ignorer entre les étiquettes dessinées. |
| [setTickLabelSpacing(long value)](#setTickLabelSpacing-long-) | Spécifie le nombre d'étiquettes de graduation à ignorer entre les étiquettes dessinées. |
...
| [getTickMarksSpacing()](#getTickMarksSpacing--) | Spécifie le nombre de marques de graduation à ignorer avant que la suivante ne soit dessinée. |
| [setTickMarksSpacing(long value)](#setTickMarksSpacing-long-) | Spécifie le nombre de marques de graduation à ignorer avant que la suivante ne soit dessinée. |
...
| [getAggregationType()](#getAggregationType--) | Représente le type d'agrégation de l'axe des catégories (regroupement). |
| [setAggregationType(int value)](#setAggregationType-int-) | Représente le type d'agrégation de l'axe des catégories (regroupement). |
...
Indique si l'axe des valeurs croise l'axe des catégories entre les catégories. Cette propriété s'applique uniquement aux axes de catégorie et ne s'applique pas aux graphiques 3-D. Lecture/écriture booléen.
...
Représente la valeur minimale sur l'axe de valeur. Lecture/écriture double.
...
Représente si le type d'échelle de l'axe de valeur est logarithmique ou non. Lecture/écriture booléen.
...
Représente le CrossType sur l'axe spécifié où l'autre axe le traverse. Lecture/écriture [CrossesType](../../com.aspose.slides/crossestype).
...
Représente la chaîne de format pour les libellés de l'axe. Lecture/écriture String.
...
Spécifie le nombre de libellés de repère à sauter entre chaque libellé affiché. Appliqué à l'axe de catégorie ou de série. Lecture/écriture long.
...
Spécifie la valeur automatique d'espacement des libellés de repère. Si false : utilise la propriété TickLabelSpacing. Lecture/écriture booléen.
...
Spécifie le nombre de repères à sauter avant d'en dessiner un nouveau. Appliqué à l'axe de catégorie ou de série. Lecture/écriture int.
...
Spécifie la valeur automatique d'espacement des repères. Si false : utilise la propriété TickMarksSpacing. Lecture/écriture booléen.
...
Spécifie la distance des libellés par rapport à l'axe. Appliqué à l'axe de catégorie ou de date. La valeur doit être comprise entre 0 % et 1000 %. Lecture/écriture int.
...
Représente le type d'agrégation de l'axe des catégories (regroupement). Appliqué à la catégorie. Utilisé uniquement avec les séries Histogram ou HistogramPareto.
...
Spécifie la valeur personnalisée du bin de dépassement. Appliqué lorsque la propriété IsAutomaticOverflowBin est définie sur false et que la propriété IsOverflowBin est égale à true.
...
Indique si un bin de sous-flux est appliqué. Utilisez IsAutomaticUnderflowBin et UnderflowBin pour ajuster la valeur du bin de sous-flux.
...
Spécifie la valeur automatique du bin de sous-flux. Si false : utilisez la propriété UnderflowBin.
...
Spécifie la valeur personnalisée du bin de sous-flux. Appliqué lorsque la propriété IsAutomaticUnderflowBin est définie sur false et que la propriété IsUnderflowBin est égale à true.
