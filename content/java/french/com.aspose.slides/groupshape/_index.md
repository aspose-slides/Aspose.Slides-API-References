...
| Méthode | Description |
| --- | --- |
| [getLineFormat()](#getLineFormat--) | Renvoie l'objet LineFormat qui contient les propriétés de format de ligne pour une forme. |
...
Renvoie l'objet LineFormat qui contient les propriétés de format de ligne pour une forme. Remarque : Renvoie null pour les objets GroupShape car ils n'ont pas de propriétés de ligne. Lecture seule [ILineFormat](../../com.aspose.slides/ilineformat).
