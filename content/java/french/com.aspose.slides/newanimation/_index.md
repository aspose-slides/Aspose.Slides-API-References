...
description: Un événement indique qu'une nouvelle animation a été générée.
type: docs
url: /fr/com.aspose.slides/presentationanimationsgenerator.newanimation/
---```
public static interface PresentationAnimationsGenerator.NewAnimation
```

Un événement indique qu'une nouvelle animation a été générée.
## Méthodes
