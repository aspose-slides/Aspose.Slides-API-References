...
type: docs
url: /fr/com.aspose.slides/charttitle/
---
**Héritage :**
java.lang.Object
...
| Méthode | Description |
| --- | --- |
| [getX()](#getX--) | Renvoie ou définit la coordonnée x d’un titre comme une fraction de la largeur du graphique. |
| [setX(float value)](#setX-float-) | Renvoie ou définit la coordonnée x d’un titre comme une fraction de la largeur du graphique. |
| [getY()](#getY--) | Renvoie ou définit la coordonnée y d’un titre comme une fraction de la hauteur du graphique. |
| [setY(float value)](#setY-float-) | Renvoie ou définit la coordonnée y d’un titre comme une fraction de la hauteur du graphique. |
| [getWidth()](#getWidth--) | Renvoie ou définit la largeur d’un titre comme une fraction de la largeur du graphique. |
| [setWidth(float value)](#setWidth-float-) | Renvoie ou définit la largeur d’un titre comme une fraction de la largeur du graphique. |
| [getHeight()](#getHeight--) | Renvoie ou définit la hauteur d’un titre comme une fraction de la hauteur du graphique. |
| [setHeight(float value)](#setHeight-float-) | Renvoie ou définit la hauteur d’un titre comme une fraction de la hauteur du graphique. |
| [getRight()](#getRight--) | Droite. |
| [getBottom()](#getBottom--) | Bas. |
| [getOverlay()](#getOverlay--) | Détermine si d’autres éléments du graphique peuvent se superposer au titre. |
| [setOverlay(boolean value)](#setOverlay-boolean-) | Détermine si d’autres éléments du graphique peuvent se superposer au titre. |
| [getFormat()](#getFormat--) | Renvoie les styles de remplissage, de ligne et d’effet d’un titre. |
| [addTextFrameForOverriding(String text)](#addTextFrameForOverriding-java.lang.String-) | Initialise TextFrameForOverriding avec le texte du paramètre "text". Si TextFrameForOverriding est déjà initialisé, il modifie simplement son texte. |
...
Renvoie ou définit la coordonnée x d’un titre comme une fraction de la largeur du graphique. Lecture/écriture float.
...
Renvoie ou définit la coordonnée y d’un titre comme une fraction de la hauteur du graphique. Lecture/écriture float.
...
Renvoie ou définit la largeur d’un titre comme une fraction de la largeur du graphique. Lecture/écriture float.
...
Renvoie ou définit la hauteur d’un titre comme une fraction de la hauteur du graphique. Lecture/écriture float.
...
Détermine si d’autres éléments du graphique peuvent se superposer au titre. Lecture/écriture boolean.
