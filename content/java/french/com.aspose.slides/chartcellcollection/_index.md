...
| [getConcatenatedValuesFromCells()](#getConcatenatedValuesFromCells--) | Chaîne de concaténation des valeurs de chaîne de toutes les cellules. |
...
| [getCount()](#getCount--) | Renvoie le nombre de cellules dans la collection. |
...
**Valeur de retour :**
[IChartDataCell](../../com.aspose.slides/ichartdatacell) - Cellule avec des données.
...
Renvoie le nombre de cellules dans la collection. Lecture seule int.
...
**Valeur de retour :**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IChartDataCell> - Un IGenericEnumerator qui peut être utilisé pour itérer à travers la collection.
...
**Valeur de retour :**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IChartDataCell> - Un java.util.Iterator pour l'ensemble de la collection.
### getParent_Immediate() {#getParent-Immediate--}
```
