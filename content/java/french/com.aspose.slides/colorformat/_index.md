...
type: docs
url: /fr/com.aspose.slides/colorformat/
---
**Héritage:**
...
| Méthode | Description |
| --- | --- |
| [getColorType()](#getColorType--) | Renvoie ou définit la méthode de définition de couleur. |
| [setColorType(int value)](#setColorType-int-) | Renvoie ou définit la méthode de définition de couleur. |
...
| [getPresetColor()](#getPresetColor--) | Renvoie ou définit le préréglage de couleur. |
| [setPresetColor(int value)](#setPresetColor-int-) | Renvoie ou définit le préréglage de couleur. |
| [getSystemColor()](#getSystemColor--) | Renvoie ou définit la couleur identifiée par la table de couleurs du système. |
| [setSystemColor(int value)](#setSystemColor-int-) | Renvoie ou définit la couleur identifiée par la table de couleurs du système. |
...
| [getColorTransform()](#getColorTransform--) | Renvoie la collection de transformations de couleur appliquées à une couleur. |
...
| [equals(Object obj)](#equals-java.lang.Object-) | Vérifie l'égalité avec l'objet spécifié. |
...
Renvoie ou définit la méthode de définition de couleur. Lecture/écriture [ColorType](../../com.aspose.slides/colortype).
...
Renvoie la couleur résultante (avec toutes les transformations de couleur appliquées). Définit les couleurs RVB et supprime toutes les transformations de couleur. Lecture/écriture java.awt.Color.
...
Renvoie ou définit le préréglage de couleur. Lecture/écriture [PresetColor](../../com.aspose.slides/presetcolor).
...
Renvoie ou définit la couleur identifiée par la table de couleurs du système. Lecture/écriture [SystemColor](../../com.aspose.slides/systemcolor).
...
Renvoie la collection de transformations de couleur appliquées à une couleur. Lecture seule [IColorOperationCollection](../../com.aspose.slides/icoloroperationcollection).
...
Renvoie une String qui représente le format de couleur actuel.
