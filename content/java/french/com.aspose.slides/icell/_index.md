...
| [getColSpan()](#getColSpan--) | Renvoie le nombre de colonnes de la grille du tableau parent qui doivent être traversées par la cellule actuelle. |
...
| [isMergedCell()](#isMergedCell--) | Renvoie true si la cellule est fusionnée avec une cellule ajustée, false sinon. |
...
Détermine si la zone de texte est centrée à l'intérieur d'une cellule. Lecture/écriture booléen.
...
Renvoie le nombre de colonnes de la grille du tableau parent qui doivent être traversées par la cellule actuelle. Cette propriété permet aux cellules d'avoir l'apparence d'une fusion, car elles traversent les limites verticales des autres cellules du tableau. Lecture seule int.
...
Renvoie le nombre de lignes qu'une cellule fusionnée couvre. Cette valeur est utilisée en combinaison avec l'attribut vMerge sur d'autres cellules afin de spécifier la cellule de départ d'une fusion horizontale. Lecture seule int.
...
Renvoie true si la cellule est fusionnée avec une cellule ajustée, false sinon. Lecture seule booléen.
