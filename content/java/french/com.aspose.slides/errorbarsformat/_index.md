...
| [hasEndCap()](#hasEndCap--) | Spécifie qu'une extrémité n'est pas dessinée sur les barres d'erreur. |
| [setEndCap(boolean value)](#setEndCap-boolean-) | Spécifie qu'une extrémité n'est pas dessinée sur les barres d'erreur. |
...
Spécifie qu'une extrémité n'est pas dessinée sur les barres d'erreur. Lecture/écriture booléen.
...
Obtient ou définit la valeur utilisée avec les types de valeur Fixed, Percentage et StandardDeviation pour déterminer la longueur des barres d'erreur. Dans tout autre cas, renvoie NaN. Lecture/écriture flottant.
