...
| [getChartData()](#getChartData--) | Renvoie les informations sur les données liées ou incorporées associées à un graphique. |
| [hasTitle()](#hasTitle--) | Détermine si un graphique a un titre visible. |
| [setTitle(boolean value)](#setTitle-boolean-) | Détermine si un graphique a un titre visible. |
...
| [getChartDataTable()](#getChartDataTable--) | Renvoie le tableau de données d'un graphique. |
...
| [getFloor()](#getFloor--) | Renvoie un objet qui permet de modifier le format du sol d'un graphique 3D. |
...
Détermine si seules les cellules visibles sont tracées. False pour tracer les cellules visibles et cachées. Lecture/écriture boolean.
...
Renvoie les informations sur les données liées ou incorporées associées à un graphique. Lecture seule [IChartData](../../com.aspose.slides/ichartdata).
...
Détermine si un graphique possède un titre visible. Lecture/écriture boolean.
...
Détermine si un graphique possède un tableau de données. Lecture/écriture boolean.
...
Détermine si un graphique possède une légende. Lecture/écriture boolean.
...
Renvoie le tableau de données d'un graphique. Lecture seule [IDataTable](../../com.aspose.slides/idatatable).
...
Renvoie un objet qui permet de modifier le format du sol d'un graphique 3D. Lecture seule [IChartWall](../../com.aspose.slides/ichartwall).
...
Spécifie que les étiquettes de données au-dessus du maximum du graphique doivent être affichées. Lecture/écriture boolean.
...
Spécifie que la zone du graphique doit avoir des coins arrondis. Lecture/écriture boolean.
