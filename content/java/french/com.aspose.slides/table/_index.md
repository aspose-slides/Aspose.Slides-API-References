...
| [getRows()](#getRows--) | Renvoie la collection des lignes. |
| [getColumns()](#getColumns--) | Renvoie la collection des colonnes. |
| [getTableFormat()](#getTableFormat--) | Renvoie l'objet TableFormat qui contient les propriétés de formatage pour ce tableau. |
...
Renvoie la cellule aux index de colonne et de ligne spécifiés. Lecture seule [Cell](../../com.aspose.slides/cell).
...
Renvoie la collection des lignes. Lecture seule [IRowCollection](../../com.aspose.slides/irowcollection).
...
Renvoie la collection des colonnes. Lecture seule [IColumnCollection](../../com.aspose.slides/icolumncollection).
...
Renvoie l'objet TableFormat qui contient les propriétés de formatage pour ce tableau. Lecture seule [ITableFormat](../../com.aspose.slides/itableformat).
...
Détermine si le tableau a un ordre de lecture de droite à gauche. Lecture/écriture  boolean .
...
Détermine si la première ligne d'un tableau doit être dessinée avec un formatage spécial. Lecture/écriture  boolean .
...
Détermine si la première colonne d'un tableau doit être dessinée avec un formatage spécial. Lecture/écriture  boolean .
...
Détermine si la dernière ligne d'un tableau doit être dessinée avec un formatage spécial. Lecture/écriture  boolean .
...
Détermine si la dernière colonne d'un tableau doit être dessinée avec un formatage spécial. Lecture/écriture  boolean .
...
Détermine si les lignes paires doivent être dessinées avec un formatage différent. Lecture/écriture  boolean .
...
Détermine si les colonnes paires doivent être dessinées avec un formatage différent. Lecture/écriture  boolean .
