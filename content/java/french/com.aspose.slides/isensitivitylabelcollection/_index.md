...
| [add(ISensitivityLabel label)](#add-com.aspose.slides.ISensitivityLabel-) | Ajoute une SensitivityLabel à la collection. |
...
| methodType | int | La méthode d'attribution pour l'étiquette de sensibilité. |
...
Ajoute une SensitivityLabel à la collection.
...
**Valeur retournée :**
int - L'indice auquel la SensitivityLabel a été ajoutée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | Indice de l'étiquette de sensibilité qui doit être supprimée. |
