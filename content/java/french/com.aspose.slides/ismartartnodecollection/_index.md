...
| [removeNode(int index)](#removeNode-int-) | Supprime le nœud ou le sous-nœud par index. |
| [removeNode(ISmartArtNode nodeObj)](#removeNode-com.aspose.slides.ISmartArtNode-) | Supprime le nœud ou le sous-nœud. |
...
Supprime le nœud ou le sous-nœud par index.
