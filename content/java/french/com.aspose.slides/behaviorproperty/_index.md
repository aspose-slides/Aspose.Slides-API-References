...
| [getPptX()](#getPptX--) | Représente la propriété 'ppt\_x' |
| [getPptY()](#getPptY--) | Représente la propriété 'ppt\_y' |
| [getPptW()](#getPptW--) | Représente la propriété 'ppt\_w' |
| [getPptH()](#getPptH--) | Représente la propriété 'ppt\_h' |
| [getPptC()](#getPptC--) | Représente la propriété 'ppt\_c' |
| [getPptR()](#getPptR--) | Représente la propriété 'ppt\_r' |
...
Représente la propriété 'ppt\_x'
...
Représente la propriété 'ppt\_y'
...
Représente la propriété 'ppt\_w'
...
Représente la propriété 'ppt\_h'
...
Représente la propriété 'ppt\_c'
...
Représente la propriété 'ppt\_r'
...
```
public static BehaviorFontWeight getStyleFontWeight()
```
...
**Renvoie :**
int - Renvoie le code de hachage pour cet objet
...
Recherche une propriété de comportement existante par valeur ou crée une nouvelle personnalisée avec la valeur spécifiée
