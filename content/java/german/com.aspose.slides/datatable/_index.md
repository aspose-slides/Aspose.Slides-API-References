...
type: docs
url: /de/com.aspose.slides/datatable/
---
**Vererbung:**
...
| --- | --- |
| [getFormat()](#getFormat--) | Returns the line, fill, and effect styles of an object. |
| [hasBorderHorizontal()](#hasBorderHorizontal--) | True if the chart data table has horizontal cell borders. |
| [setBorderHorizontal(boolean value)](#setBorderHorizontal-boolean-) | True if the chart data table has horizontal cell borders. |
| [hasBorderOutline()](#hasBorderOutline--) | True if the chart data table has outline borders. |
| [setBorderOutline(boolean value)](#setBorderOutline-boolean-) | True if the chart data table has outline borders. |
| [hasBorderVertical()](#hasBorderVertical--) | True if the chart data table has vertical cell borders. |
| [setBorderVertical(boolean value)](#setBorderVertical-boolean-) | True if the chart data table has vertical cell borders. |
...
| [getChart()](#getChart--) | Returns chart. |
...
Returns the line, fill, and effect styles of an object. Nur-Lesen [IFormat](../../com.aspose.slides/iformat).
...
True if the chart data table has horizontal cell borders. Lesen/Schreiben boolean.
...
True if the chart data table has outline borders. Lesen/Schreiben boolean.
...
True if the chart data table has vertical cell borders. Lesen/Schreiben boolean.
...
True if the data label legend key is visible. Lesen/Schreiben boolean.
...
Returns chart. Nur-Lesen [IChart](../../com.aspose.slides/ichart).
...
Returns text format. Nur-Lesen [IChartTextFormat](../../com.aspose.slides/icharttextformat).
...
Returns the parent slide of a FillFormat. Nur-Lesen [BaseSlide](../../com.aspose.slides/baseslide).
...
Returns the parent presentation of a FillFormat. Nur-Lesen [IPresentation](../../com.aspose.slides/ipresentation).
