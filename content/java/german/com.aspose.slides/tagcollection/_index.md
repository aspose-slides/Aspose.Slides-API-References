...
description: Stellt die Sammlung von Tags dar, benutzerdefinierte Zeichenkettenpaare
type: docs
...
Stellt die Sammlung von Tags dar (benutzerdefinierte Zeichenkettenpaare)
...
| [get_Item(String name)](#get-Item-java.lang.String-) | Gibt ein Schlüssel- und Wertpaar eines Tags zurück oder setzt es. |
| [set_Item(String name, String value)](#set-Item-java.lang.String-java.lang.String-) | Gibt ein Schlüssel- und Wertpaar eines Tags zurück oder setzt es. |
...
**Rückgabe:**
int - Der nullbasierte Index des Schlüssels, falls der Schlüssel gefunden wird; andernfalls -1.
...
**Rückgabe:**
boolean - Wahr, wenn die Sammlung ein Tag mit dem angegebenen Schlüssel enthält; andernfalls false.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| index | int | Index des zurückzugebenden Tags. |
...
Gibt ein Schlüssel- und Wertpaar eines Tags zurück oder setzt es.
...
| index | int | Startposition im Ziel-Array. |
...
Gibt die Synchronisationswurzel zurück. Nur lesend Object.
