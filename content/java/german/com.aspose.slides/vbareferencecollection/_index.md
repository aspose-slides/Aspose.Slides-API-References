...
| --- | --- |
| [size()](#size--) | Gibt die tatsächliche Anzahl der im Sammelobjekt enthaltenen Elemente zurück. |
| [add(IVbaReference value)](#add-com.aspose.slides.IVbaReference-) | Fügt den neuen Verweis zur Verweissammlung hinzu. |
...
Gibt die tatsächliche Anzahl der im Sammelobjekt enthaltenen Elemente zurück. Nur lesbarer int.
...
Fügt den neuen Verweis zur Verweissammlung hinzu.
...
**Rückgabewert:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IVbaReference> - Ein IGenericEnumerator, der verwendet werden kann, um durch die Sammlung zu iterieren.
