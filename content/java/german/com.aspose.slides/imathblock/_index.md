...
description: Gibt eine Instanz mathematischen Textes an, die sich innerhalb eines MathParagraph befindet und in einer eigenen Zeile beginnt.
type: docs
...
Gibt eine Instanz mathematischen Textes an, die sich innerhalb eines MathParagraph befindet und in einer eigenen Zeile beginnt. Alle mathematischen Zonen, einschließlich Gleichungen, Ausdrücken, Arrays von Gleichungen oder Ausdrücken und Formeln, werden durch einen math block dargestellt.
...
| --- | --- |
| [delimit(char separatorCharacter)](#delimit-char-) | Begrenzt alle Kind-Elemente mit einem Trennzeichen (ohne die Klammern) |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | Umschließt Kind-Elemente dieses Blocks in angegebenen Zeichen wie Klammern oder anderen als Rahmen und begrenzt sie mit einem Trennzeichen |
...
Begrenzt alle Kind-Elemente mit einem Trennzeichen (ohne die Klammern)
...
Umschließt Kind-Elemente dieses Blocks in angegebenen Zeichen wie Klammern oder anderen als Rahmen und begrenzt sie mit einem Trennzeichen
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| other | [IMathBlock](../../com.aspose.slides/imathblock) | Der zusammenzufügende Block |
