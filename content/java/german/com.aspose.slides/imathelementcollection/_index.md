...
| [indexOf(IMathElement item)](#indexOf-com.aspose.slides.IMathElement-) | Ermittelt den Index eines bestimmten mathematischen Elements in der Sammlung. |
...
| [contains(IMathElement item)](#contains-com.aspose.slides.IMathElement-) | Ermittelt, ob die Sammlung einen bestimmten Wert enthält. |
...
Ruft das Element am angegebenen Index ab. Nur-Lesen [IMathElement](../../com.aspose.slides/imathelement).
...
Ruft die tatsächlich in der Sammlung enthaltene Anzahl von Elementen ab. Nur-Lesen int.
...
Ermittelt den Index eines bestimmten mathematischen Elements in der Sammlung.
...
**Rückgabewert:**
int - Der Index des Elements, wenn es in der Sammlung gefunden wird; andernfalls -1.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| index | int | Der nullbasierte Index, an dem IMathElement eingefügt werden soll. |
...
Ermittelt, ob die Sammlung einen bestimmten Wert enthält.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | Das zu findende Objekt in der Sammlung. |

**Rückgabewert:**
boolean - true, wenn das Objekt in der Sammlung gefunden wird; sonst false.
...
**Rückgabewert:**
boolean - true, wenn das Objekt erfolgreich aus der Sammlung entfernt wurde; sonst false. Diese Methode gibt ebenfalls false zurück, wenn das Objekt in der ursprünglichen Sammlung nicht gefunden wurde.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| array | [IMathElement\[\]](../../com.aspose.slides/imathelement) | Ziel-Array. |
