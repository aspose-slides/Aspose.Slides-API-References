...
| [getVersion()](#getVersion--) | Gibt die Version von Aspose.Slides für Java zurück. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| namePath | java.lang.String | Kann ein voller oder kurzer Dateiname oder der Name einer eingebetteten Ressource sein. Verwenden Sie eine leere Zeichenkette, um in den Evaluierungsmodus zu wechseln. |
...
Gibt die Version von Aspose.Slides für Java zurück.
