...
| [getTriggerShape()](#getTriggerShape--) | Gibt das Shape-Ziel für die INTERACTIVE-Sequenz zurück oder setzt es. |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | Gibt das Shape-Ziel für die INTERACTIVE-Sequenz zurück oder setzt es. |
...
| [addEffect(IParagraph paragraph, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IParagraph-int-int-int-) | Fügt einen neuen Animations-Effekt für einen Absatz am Ende der Sequenz hinzu. |
...
Gibt das Shape-Ziel für die INTERACTIVE-Sequenz zurück oder setzt es. Wenn die Sequenz nicht interaktiv ist, wird null zurückgegeben. Lese/Schreib [IShape](../../com.aspose.slides/ishape).
...
| subtype | int | Subtypen des Animations-Effekts [EffectSubtype](../../com.aspose.slides/effectsubtype) |
...
>      // Fly-Animationseffekt zum ausgewählten Paragraphen hinzufügen
...
| chart | [IChart](../../com.aspose.slides/ichart) | Diagramm-Objekt [IChart](../../com.aspose.slides/ichart) |
| type | int | Typ eines Animations-Effekts [EffectChartMinorGroupingType](../../com.aspose.slides/effectchartminorgroupingtype) |
| seriesIndex | int | Index der Diagramm-Serie |
| categoriesIndex | int | Index der Kategorie |
| effectType | int | Typ eines Animations-Effekts [EffectType](../../com.aspose.slides/effecttype) |
| subtype | int | Subtypen des Animations-Effekts [EffectSubtype](../../com.aspose.slides/effectsubtype) |
| triggerType | int | Auslösetyp des Effekts [EffectTriggerType](../../com.aspose.slides/effecttriggertype) |
