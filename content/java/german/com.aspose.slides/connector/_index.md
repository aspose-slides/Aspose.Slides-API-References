...
| [getStartShapeConnectedTo()](#getStartShapeConnectedTo--) | Gibt die Form zurück oder legt sie fest, an die der Beginn des Verbinders angehängt wird. |
| [setStartShapeConnectedTo(IShape value)](#setStartShapeConnectedTo-com.aspose.slides.IShape-) | Gibt die Form zurück oder legt sie fest, an die der Beginn des Verbinders angehängt wird. |
| [getEndShapeConnectedTo()](#getEndShapeConnectedTo--) | Gibt die Form zurück oder legt sie fest, an die das Ende des Verbinders angehängt wird. |
| [setEndShapeConnectedTo(IShape value)](#setEndShapeConnectedTo-com.aspose.slides.IShape-) | Gibt die Form zurück oder legt sie fest, an die das Ende des Verbinders angehängt wird. |
...
| [reroute()](#reroute--) | Leitet den Verbinder um, sodass er den kürzesten möglichen Pfad zwischen den verbundenen Formen nimmt. |
...
Gibt die Sperren des Verbinders zurück. Nur-Lesen [IConnectorLock](../../com.aspose.slides/iconnectorlock).
...
Gibt die Form zurück oder legt sie fest, an die der Beginn des Verbinders angehängt wird. Lese-/Schreib [IShape](../../com.aspose.slides/ishape).
...
Gibt die Form zurück oder legt sie fest, an die das Ende des Verbinders angehängt wird. Lese-/Schreib [IShape](../../com.aspose.slides/ishape).
...
Gibt den Index der Verbindungsstelle für die Endform zurück oder legt ihn fest. Lese-/Schreib long.
...
Leitet den Verbinder um, sodass er den kürzesten möglichen Pfad zwischen den verbundenen Formen nimmt.