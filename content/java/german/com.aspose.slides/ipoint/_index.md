...
| [getFormula()](#getFormula--) | Formeln innerhalb von Werten sowie den Attributen from, to, by können aus den folgenden Elementen bestehen: Standardarithmetische Operatoren: '+', '-', '\*', '/', '^', '%' (mod). Konstanten: 'pi' 'e'. Bedingte Operatoren: 'abs', 'min', 'max', '?' (if). Vergleichsoperatoren: '==', '>=', '', '!=', '!'. Trigonometrische Operatoren: 'sin()', 'cos()', 'tan()', 'asin()', 'acos()', 'atan()'. Natürlicher Logarithmus 'ln()'. Property-Referenzen (vom Host unterstützte Eigenschaften), zum Beispiel: "\#ppt\_x+(cos(-2\*pi\*(1-$))\*-\#ppt\_x-sin(-2\*pi\*(1-$))\*(1-\#ppt\_y))\*(1-$)" Lesen/Schreiben String. |
