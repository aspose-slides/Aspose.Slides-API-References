...
| [getVariableScale()](#getVariableScale--) | Gibt an, dass der Ansichtinhalt automatisch skaliert werden soll, um die aktuelle Fenstergröße optimal anzupassen. |
| [setVariableScale(boolean value)](#setVariableScale-boolean-) | Gibt an, dass der Ansichtinhalt automatisch skaliert werden soll, um die aktuelle Fenstergröße optimal anzupassen. |
...
Gibt das Ansichtsskalierungsverhältnis in Prozent an. Lesen/Schreiben int.
...
Gibt an, dass der Ansichtinhalt automatisch skaliert werden soll, um die aktuelle Fenstergröße optimal anzupassen. Lesen/Schreiben boolean.
...
>      // Fügt die neue vertikale Zeichenhilfe rechts vom Folienmittelpunkt hinzu
>      guides.add(Orientation.Vertical, (float)(slideSize.getWidth()) / 2 + 12.5f);
>      // Fügt die neue horizontale Zeichenhilfe unterhalb des Folienmittelpunkts hinzu
