...
description: Diese Klasse enthält die Textstil-Formatierungseigenschaften.
type: docs
...
Diese Klasse enthält die Textstil-Formatierungseigenschaften.
## Methoden
...
| [getEffective()](#getEffective--) | Ermittelt die wirksamen Textstil-Formatierungsdaten mit angewendeter Vererbung. |
### getVersion() {#getVersion--}
```
...
Ermittelt die wirksamen Textstil-Formatierungsdaten mit angewendeter Vererbung.
