...
| [Complement](#Complement) | Ändert die Farbe zu einer RGB-komplementären Farbe. |
| [Inverse](#Inverse) | Ändert die Farbe zu einer invertierten Farbe. |
| [Grayscale](#Grayscale) | Ändert die Farbe zu einem Grauton mit derselben Helligkeit. |
...
| [SetLuminance](#SetLuminance) | Ändert die Leuchtkomponente der Farbe auf den Wert eines Parameters. |
| [AddLuminance](#AddLuminance) | Addiert den Wert eines Parameters zur Leuchtkomponente der Farbe. |
| [MultiplyLuminance](#MultiplyLuminance) | Multipliziert die Leuchtkomponente mit dem Wert eines Parameters. |
...
| [Gamma](#Gamma) | Gamma-Korrektur. |
| [InverseGamma](#InverseGamma) | Inverse Gamma-Korrektur. |
### Tint {#Tint}
```
...
Ändert die Farbe zu einer RGB-komplementären Farbe. m = Max(r, g, b); r = m - r; g = m - g; b = m - b;
### Inverse {#Inverse}
```
public static final int Inverse
```

Ändert die Farbe zu einer invertierten Farbe. r = 1 - r; g = 1 - g; b = 1 - b;
### Grayscale {#Grayscale}
```
public static final int Grayscale
```

Ändert die Farbe zu einem Grauton mit derselben Helligkeit. Parameter wird ignoriert.
### SetAlpha {#SetAlpha}
```
...
Ändert die Leuchtkomponente der Farbe auf den Wert eines Parameters. Der Parameter liegt im Bereich zwischen 0 und 1.
### AddLuminance {#AddLuminance}
```
public static final int AddLuminance
```

Addiert den Wert eines Parameters zur Leuchtkomponente der Farbe. Der Parameter liegt im Bereich zwischen -1 und 1.
### MultiplyLuminance {#MultiplyLuminance}
```
public static final int MultiplyLuminance
```

Multipliziert die Leuchtkomponente mit dem Wert eines Parameters.
### SetRed {#SetRed}
```
...
Gamma-Korrektur. Parameter wird ignoriert.
### InverseGamma {#InverseGamma}
```
public static final int InverseGamma
```

Inverse Gamma-Korrektur. Parameter wird ignoriert.