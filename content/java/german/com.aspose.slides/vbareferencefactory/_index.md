...
description: Ermöglicht das Erstellen von VBA-Projektreferenzen über die COM-Schnittstelle
type: docs
...
| --- | --- |
| [getInstance()](#getInstance--) | Statische Fabrikinstanz für VBA-Projektreferenzen. |
...
Statische Fabrikinstanz für VBA-Projektreferenzen. Nur-Lesen [VbaReferenceFactory](../../com.aspose.slides/vbareferencefactory).
