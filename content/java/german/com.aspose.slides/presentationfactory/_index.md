...
| [getPresentationInfo(String file)](#getPresentationInfo-java.lang.String-) | Erstellt ein neues PresentationInfo-Objekt aus einer Datei und bindet die Präsentation daran. |
| [getPresentationInfo(InputStream stream)](#getPresentationInfo-java.io.InputStream-) | Erstellt ein neues PresentationInfo-Objekt aus einem Stream und bindet die Präsentation daran. |
...
**Rückgabe:**
[IPresentationInfo](../../com.aspose.slides/ipresentationinfo) - Präsentationsinfo, an die Präsentation gebunden.
...
Erstellt ein neues PresentationInfo-Objekt aus einem Stream und bindet die Präsentation daran. Liefert Informationen über die Präsentation im angegebenen Stream.

**Parameter:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| stream | java.io.InputStream | Präsentations-Stream. |
