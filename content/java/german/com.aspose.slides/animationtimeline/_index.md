...
| [getMainSequence()](#getMainSequence--) | Gibt die Hauptsequenz zurück, die nur die Haupt-Effekt-Sammlung enthalten kann. |
...
Gibt eine Sammlung interaktiver Sequenzen zurück. Diese Sequenzen können nur Effekte durch „Klick auf Form“ mit angegebenem Ziel-Shape enthalten. Nur lesbar [ISequenceCollection](../../com.aspose.slides/isequencecollection).
...
Gibt die Hauptsequenz zurück, die nur die Haupt-Effekt-Sammlung enthalten kann. Nur lesbar [ISequence](../../com.aspose.slides/isequence).
