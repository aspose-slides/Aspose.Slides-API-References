...
description: Stellt eine Sammlung von FontFallBack-Regeln dar, die vom Benutzer definiert wird
type: docs
...
Stellt eine Sammlung von FontFallBack-Regeln dar, definiert vom Benutzer
## Methoden
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| targetRule | [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule) | Die Regel, die aus der Sammlung entfernt werden soll. |