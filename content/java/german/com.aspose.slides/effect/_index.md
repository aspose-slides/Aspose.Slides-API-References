...
description: Repräsentiert einen Animationseffekt.
type: docs
url: /de/com.aspose.slides/effect/
---
**Vererbung:**
java.lang.Object
...
Repräsentiert einen Animationseffekt.
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [getSequence()](#getSequence--) | Gibt eine Sequenz für einen Effekt zurück. |
| [getTextAnimation()](#getTextAnimation--) | TextAnimation Nur lesbar [ITextAnimation](../../com.aspose.slides/itextanimation). |
...
| [getSubtype()](#getSubtype--) | Definiert den Untertyp des Effekts. |
| [setSubtype(int value)](#setSubtype-int-) | Definiert den Untertyp des Effekts. |
...
| [getSound()](#getSound--) | Definierter eingebetteter Sound für den Effekt. |
| [setSound(IAudio value)](#setSound-com.aspose.slides.IAudio-) | Definierter eingebetteter Sound für den Effekt. |
...
| [getAfterAnimationType()](#getAfterAnimationType--) | Definiert einen Nach-Animations-Typ für den Effekt. |
| [setAfterAnimationType(int value)](#setAfterAnimationType-int-) | Definiert einen Nach-Animations-Typ für den Effekt. |
| [getAfterAnimationColor()](#getAfterAnimationColor--) | Definiert eine Nach-Animations-Farbe für den Effekt. |
| [setAfterAnimationColor(IColorFormat value)](#setAfterAnimationColor-com.aspose.slides.IColorFormat-) | Definiert eine Nach-Animations-Farbe für den Effekt. |
...
TextAnimation Nur lesbar [ITextAnimation](../../com.aspose.slides/itextanimation).
...
Definiert den Untertyp des Effekts. Lesen/Schreiben [EffectSubtype](../../com.aspose.slides/effectsubtype).
...
Gibt die Sammlung von Verhalten für den Effekt zurück. Lesen/Schreiben [IBehaviorCollection](../../com.aspose.slides/ibehaviorcollection).
...
Definierter eingebetteter Sound für den Effekt. Lesen/Schreiben [IAudio](../../com.aspose.slides/iaudio).
...
> Presentation presentation = new Presentation("demo.pptx");
>  try {
>      // Ermittelt den ersten Effekt der ersten Folie.
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Ermittelt den ersten Effekt der zweiten Folie.
>      IEffect secondSlideEffect = presentation.getSlides().get_Item(1).getTimeline().getMainSequence().get_Item(0);
> 
>      if (firstSlideEffect.getSound() != null)
>      {
>          // Ändert das Enhancements/Sound des zweiten Effekts zu "Stop Previous Sound"
...
Definiert einen Nach-Animations-Typ für den Effekt. Lesen/Schreiben [AfterAnimationType](../../com.aspose.slides/afteranimationtype)(\#getAfterAnimationType.getAfterAnimationType/\#setAfterAnimationType(int).setAfterAnimationType(int)).
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Ändert die Nachanimation des Effekts zu "Ausblenden beim nächsten Mausklick"
...
Definiert eine Nach-Animations-Farbe für den Effekt. Lesen/Schreiben [IColorFormat](../../com.aspose.slides/icolorformat).
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Ändert den Nachanimations-Typ des Effekts zu "Color"
>      firstSlideEffect.setAfterAnimationType(AfterAnimationType.Color);
> 
>      // Setzt die Nachanimations-Farbe des Effekts.
...
Definiert einen animierten Texttyp für den Effekt. Der Text einer Form kann Buchstabe für Buchstabe, Wort für Wort oder gleichzeitig animiert werden. Lesen/Schreiben AnimateTextType (\#getAnimateTextType.getAnimateTextType/\#setAnimateTextType(int).setAnimateTextType(int)).
...
Definiert eine Verzögerung zwischen animierten Textteilen (Wörtern oder Buchstaben). Ein positiver Wert gibt den Prozentsatz der Effekt-Dauer an. Ein negativer Wert gibt die Verzögerung in Sekunden an. Lesen/Schreiben float .
...
Gibt Parent_Immediate-Objekt zurück. Nur lesbar IDOMObject.
