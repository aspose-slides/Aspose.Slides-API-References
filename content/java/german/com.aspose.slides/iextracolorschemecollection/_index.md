...
type: docs
url: /de/com.aspose.slides/iextracolorschemecollection/
---
...
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Gibt ein Farbschema nach Index zurück. |
### get_Item(int index) {#get-Item-int-}
```
public abstract IExtraColorScheme get_Item(int index)
```

Gibt ein Farbschema nach Index zurück. Nur lesbar [IExtraColorScheme](../../com.aspose.slides/iextracolorscheme).
