...
| --- | --- |
| [getRow()](#getRow--) | Gibt den Index der Zeile des Arbeitsblatts zurück, in dem die Zelle enthalten ist. |
| [getColumn()](#getColumn--) | Gibt den Index der Spalte des Arbeitsblatts zurück, in dem die Zelle enthalten ist. |
...
| [isHidden()](#isHidden--) | Ermittelt, ob die Zelle ausgeblendet ist. |
| [getCustomNumberFormat()](#getCustomNumberFormat--) | Liest oder setzt das benutzerdefinierte Anzeigeformat für Zahlen und Datumswerte. |
| [setCustomNumberFormat(String value)](#setCustomNumberFormat-java.lang.String-) | Liest oder setzt das benutzerdefinierte Anzeigeformat für Zahlen und Datumswerte. |
| [getPresetNumberFormat()](#getPresetNumberFormat--) | Liest oder setzt das integrierte Anzeigeformat für Zahlen und Datumswerte. |
| [setPresetNumberFormat(byte value)](#setPresetNumberFormat-byte-) | Liest oder setzt das integrierte Anzeigeformat für Zahlen und Datumswerte. |
...
Gibt den Index der Zeile des Arbeitsblatts zurück, in dem die Zelle enthalten ist. Nur lesbar int.
...
Gibt den Index der Spalte des Arbeitsblatts zurück, in dem die Zelle enthalten ist. Nur lesbar int.
...
Liest oder setzt den Wert einer Zelle. Lesen/Schreiben Object .
...
Gibt das Arbeitsblatt zurück. Nur lesbar [IChartDataWorksheet](../../com.aspose.slides/ichartdataworksheet).
...
Ermittelt, ob die Zelle ausgeblendet ist. Nur lesbar boolean.
...
Liest oder setzt das benutzerdefinierte Anzeigeformat für Zahlen und Datumswerte. Wird, wenn der Wert leer ist, der PresetNumberFormat-Wert verwendet. Lesen/Schreiben String.
...
Liest oder setzt das integrierte Anzeigeformat für Zahlen und Datumswerte. Der voreingestellte Wert muss in [0..22] oder [37..49] liegen. Lesen/Schreiben byte.
...
Falls die Zelle eine Formel enthält, wird der Wert basierend auf dieser Formel aktualisiert.

**Parameter:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| updateValues | boolean | Wenn false, wird keine eigentliche Berechnung durchgeführt. Verwenden Sie true, um mögliche Ausnahmemeldungen zu prüfen. |