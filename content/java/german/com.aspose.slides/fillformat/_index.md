...
| [getEffective()](#getEffective--) | Liefert effektive Füllformatierungsdaten mit angewandter Vererbung. |
### getVersion() {#getVersion--}
```
...
Gibt das Bild-Füllformat zurück. Nur-Lesen [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
Liefert effektive Füllformatierungsdaten mit angewandter Vererbung.
