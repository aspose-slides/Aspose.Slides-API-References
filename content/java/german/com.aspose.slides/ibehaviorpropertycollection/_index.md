...
Fügt der Sammlung an der angegebenen Position eine neue Eigenschaft (mit dem angegebenen Eigenschaftswert) ein.
...
**Rückgabewert:**
boolean - Wahr, wenn eine Eigenschaft erfolgreich entfernt wurde boolean
...
**Rückgabewert:**
boolean - wahr, wenn propertyValue im [IGenericCollection](../../com.aspose.slides/igenericcollection) gefunden wird; andernfalls falsch.