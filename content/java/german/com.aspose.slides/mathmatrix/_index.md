...
description: Gibt das Matrix-Objekt an, das aus Kind-Elementen besteht, die in einer oder mehreren Zeilen und Spalten angeordnet sind.
type: docs
...
Gibt das Matrix-Objekt an, das aus Kindelementen besteht, die in einer oder mehreren Zeilen und Spalten angeordnet sind. Es ist wichtig zu beachten, dass Matrizen keine integrierten Trennzeichen haben. Um die Matrix in Klammern zu setzen, sollten Sie das Trennzeichenobjekt (IMathDelimiter) verwenden. Null-Argumente können verwendet werden, um Lücken in Matrizen zu erzeugen.
...
| --- | --- |
| [MathMatrix(int rowCount, int columnCount)](#MathMatrix-int-int-) | Initialisiert eine neue Instanz der Klasse MathMatrix. |
## Methoden
...
| [getMinColumnWidth()](#getMinColumnWidth--) | Mindestspaltenbreite in Twips (1/20 eines Punktes). Der Abstand (auch als \\u201cColumn Gap\\u201d oder \\u201cGap Width\\u201d bezeichnet) wird zur MinColumnWidth addiert, um den gesamten Spaltenabstand der Matrix zu bestimmen (Entfernung zwischen den gleichen Kanten verschiedener Spalten). |
| [setMinColumnWidth(long value)](#setMinColumnWidth-long-) | Mindestspaltenbreite in Twips (1/20 eines Punktes). Der Abstand (auch als \\u201cColumn Gap\\u201d oder \\u201cGap Width\\u201d bezeichnet) wird zur MinColumnWidth addiert, um den gesamten Spaltenabstand der Matrix zu bestimmen (Entfernung zwischen den gleichen Kanten verschiedener Spalten). |
...
| [getColumnGap()](#getColumnGap--) | Der Wert des horizontalen Abstands zwischen Spalten einer Matrix; Falls ColumnGapRule auf 3 („Exactly“) gesetzt ist, wird die Einheit als Twips (1/20 eines Punktes) interpretiert. Falls ColumnGapRule auf 4 („Multiple“) gesetzt ist, wird die Einheit als Anzahl von 0,5-em-Schritten interpretiert. |
| [setColumnGap(long value)](#setColumnGap-long-) | Der Wert des horizontalen Abstands zwischen Spalten einer Matrix; Falls ColumnGapRule auf 3 („Exactly“) gesetzt ist, wird die Einheit als Twips (1/20 eines Punktes) interpretiert. Falls ColumnGapRule auf 4 („Multiple“) gesetzt ist, wird die Einheit als Anzahl von 0,5-em-Schritten interpretiert. |
...
| [getRowGap()](#getRowGap--) | Der Wert des vertikalen Abstands zwischen Zeilen einer Matrix; Falls RowGapRule auf 3 („Exactly“) gesetzt ist, wird die Einheit als Twips (1/20 eines Punktes) interpretiert. Falls RowGapRule auf 4 („Multiple“) gesetzt ist, wird die Einheit als halbe Zeilen interpretiert. |
| [setRowGap(long value)](#setRowGap-long-) | Der Wert des vertikalen Abstands zwischen Zeilen einer Matrix; Falls RowGapRule auf 3 („Exactly“) gesetzt ist, wird die Einheit als Twips (1/20 eines Punktes) interpretiert. Falls RowGapRule auf 4 („Multiple“) gesetzt ist, wird die Einheit als halbe Zeilen interpretiert. |
...
Initialisiert eine neue Instanz der Klasse MathMatrix.
...
Gibt die vertikale Ausrichtung in Bezug auf den umgebenden Text an. Mögliche Werte sind top, bottom, and center. Standard: Center
...
Mindestspaltenbreite in Twips (1/20 eines Punktes). Der Abstand (auch als \\u201cColumn Gap\\u201d oder \\u201cGap Width\\u201d bezeichnet) wird zur MinColumnWidth addiert, um den gesamten Spaltenabstand der Matrix zu bestimmen (Entfernung zwischen den gleichen Kanten verschiedener Spalten). Standard: 0.
...
Der Wert des horizontalen Abstands zwischen Spalten einer Matrix; Falls ColumnGapRule auf 3 („Exactly“) gesetzt ist, wird die Einheit als Twips (1/20 eines Punktes) interpretiert. Falls ColumnGapRule auf 4 („Multiple“) gesetzt ist, wird die Einheit als Anzahl von 0,5-em-Schritten interpretiert. In anderen Fällen ignoriert. Standard: 0
...
Der Wert des vertikalen Abstands zwischen Zeilen einer Matrix; Falls RowGapRule auf 3 („Exactly“) gesetzt ist, wird die Einheit als Twips (1/20 eines Punktes) interpretiert. Falls RowGapRule auf 4 („Multiple“) gesetzt ist, wird die Einheit als halbe Zeilen interpretiert. Standard: 0
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| row | int | Der nullbasierte Index der Zeile, aus der das Element abgerufen werden soll |
| column | int | Der nullbasierte Index der Spalte, aus der das Element abgerufen werden soll |
...
| columnsCount | long | Die Anzahl der Spalten, für die die Ausrichtung festgelegt werden soll |
| val | int | Neuer Wert der horizontalen Ausrichtung der angegebenen Spalte |
