...
| [getSvgImage()](#getSvgImage--) | Gibt das ISvgImage-Objekt zurück oder setzt [ISvgImage](../../com.aspose.slides/isvgimage) |
| [setSvgImage(ISvgImage value)](#setSvgImage-com.aspose.slides.ISvgImage-) | Gibt das ISvgImage-Objekt zurück oder setzt [ISvgImage](../../com.aspose.slides/isvgimage) |
...
| [getContentType()](#getContentType--) | Gibt den MIME-Typ eines Bildes zurück, codiert in  BinaryData (\#getBinaryData.getBinaryData). |
...
| [hashCode()](#hashCode--) | Gibt den Hash-Code eines Bildes zurück. |
...
Gibt eine Kopie des Bildes zurück. Nur-Lese [IImage](../../com.aspose.slides/iimage).
...
Gibt das ISvgImage-Objekt zurück oder setzt [ISvgImage](../../com.aspose.slides/isvgimage)
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| newImageData | byte[] | Die neuen Bilddaten. |
...
Ersetzt Bilddaten. Hinweis: Wenn das Bild eine Metadatei ist, wird es gerastert. Verwenden Sie stattdessen ReplaceImage(byte[]).
...
Gibt den MIME-Typ eines Bildes zurück, codiert in  BinaryData (\#getBinaryData.getBinaryData). Nur-Lese String.
...
Gibt die Breite eines Bildes zurück. Nur-Lese  int .
...
Gibt die Höhe eines Bildes zurück. Nur-Lese  int .
...
Gibt den X-Versatz eines Bildes zurück. Nur-Lese  int .
...
Gibt den Y-Versatz eines Bildes zurück. Nur-Lese  int .
