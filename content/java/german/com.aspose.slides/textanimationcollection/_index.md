...
| --- | --- |
| [size()](#size--) | Gibt die Anzahl von Elementen in der Sammlung zurück. |
| [add()](#add--) | Fügt der Sammlung eine neue Textanimation hinzu. |
| [get_Item(int index)](#get-Item-int-) | Gibt das Element am Index zurück. |
...
Gibt die Anzahl von Elementen in der Sammlung zurück. Nur lesbar int.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | [IShape](../../com.aspose.slides/ishape) zum Entfernen. |
