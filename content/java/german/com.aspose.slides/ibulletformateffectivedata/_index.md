...
description: Unveränderliches Objekt, das wirksame Absatz-Aufzählungs-Formatierungseigenschaften enthält.
type: docs
...
Unveränderliches Objekt, das wirksame Absatz-Aufzählungs-Formatierungseigenschaften enthält.
...
| [getNumberedBulletStartWith()](#getNumberedBulletStartWith--) | Gibt die erste Nummer zurück, die für eine Gruppe nummerierter Aufzählungen verwendet wird. |
...
| [getFillFormat()](#getFillFormat--) | Gibt das Aufzählungsfüllformat eines Absatzes zurück. |
### getType() {#getType--}
```
...
Gibt die erste Nummer zurück, die für eine Gruppe nummerierter Aufzählungen verwendet wird. Nur lesbar short.
...
Gibt das Aufzählungsfüllformat eines Absatzes zurück. Nur lesbar [IFillFormatEffectiveData](../../com.aspose.slides/ifillformateffectivedata).
...
>      // Gibt Informationen über die Aufzählungszeichen der Textabsätze aus
