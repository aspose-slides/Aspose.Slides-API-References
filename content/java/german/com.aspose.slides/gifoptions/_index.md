...
| --- | --- |
| [GifOptions()](#GifOptions--) | Initialisiert eine neue Instanz der Klasse GifOptions. |
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [getFrameSize()](#getFrameSize--) | Liest oder setzt die Framegröße. |
| [setFrameSize(Dimension value)](#setFrameSize-java.awt.Dimension-) | Liest oder setzt die Framegröße. |
| [getExportHiddenSlides()](#getExportHiddenSlides--) | Bestimmt, ob ausgeblendete Folien exportiert werden. |
| [setExportHiddenSlides(boolean value)](#setExportHiddenSlides-boolean-) | Bestimmt, ob ausgeblendete Folien exportiert werden. |
...
Bestimmt, ob ausgeblendete Folien exportiert werden. Der Standardwert ist false.
