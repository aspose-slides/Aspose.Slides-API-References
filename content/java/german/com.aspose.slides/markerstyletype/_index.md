...
description: Bestimmt die Form des Markers an den Datenpunkten von Diagrammen.
type: docs
url: /de/com.aspose.slides/markerstyletype/
---
**Vererbung:**
...
| [X](#X) | Gibt an, dass an jedem Datenpunkt ein X gezeichnet werden soll. |
### NotDefined {#NotDefined}
```
...
Gibt an, dass an jedem Datenpunkt ein X gezeichnet werden soll.