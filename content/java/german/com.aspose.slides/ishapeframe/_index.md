...
type: docs
url: /de/com.aspose.slides/ishapeframe/
---
...
| --- | --- |
| [getX()](#getX--) | Gibt die X-Koordinate der oberen linken Ecke eines Rahmens zurück. |
| [getY()](#getY--) | Gibt die Y-Koordinate der oberen linken Ecke eines Rahmens zurück. |
...
Gibt die X-Koordinate der oberen linken Ecke eines Rahmens zurück. Nur lesbar float.
...
Gibt die Y-Koordinate der oberen linken Ecke eines Rahmens zurück. Nur lesbar float.
...
Gibt die Anzahl der Grad zurück, um die ein Rahmen um die Z-Achse gedreht ist. Ein positiver Wert bedeutet eine Drehung im Uhrzeigersinn; ein negativer Wert bedeutet eine Drehung gegen den Uhrzeigersinn. Nur lesbar float.
