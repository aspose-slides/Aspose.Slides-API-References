...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| threshold | float | Der Luminanzschwellenwert für den Bi-Level-Effekt. Werte, die größer oder gleich dem Schwellenwert sind, werden auf Weiß gesetzt. Werte, die kleiner als der Schwellenwert sind, werden auf Schwarz gesetzt. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| hue | float | Die Anzahl von Grad, um die der Farbton angepasst wird. |
