...
type: docs
url: /de/com.aspose.slides/graphicalobject/
---
**Vererbung:**
...
| --- | --- |
| [getGraphicalObjectLock()](#getGraphicalObjectLock--) | Gibt die Sperren des Shapes zurück. |
### getGraphicalObjectLock() {#getGraphicalObjectLock--}
```
public final IGraphicalObjectLock getGraphicalObjectLock()
```

Gibt die Sperren des Shapes zurück. Nur lesbar [IGraphicalObjectLock](../../com.aspose.slides/igraphicalobjectlock).
