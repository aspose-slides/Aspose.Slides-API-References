...
description: Stellt die Datenpunkt-Ebene dar.
type: docs
...
| --- | --- |
| [getFormat()](#getFormat--) | Stellt die Formatierungseigenschaften der Datenpunkt-Ebene dar. |
| [getLabel()](#getLabel--) | Stellt die Datenbeschriftung der Datenpunkt-Ebene dar. |
### getFormat() {#getFormat--}
```
...
Stellt die Formatierungseigenschaften der Datenpunkt-Ebene dar. Lesen/Schreiben [IFormat](../../com.aspose.slides/iformat).
...
Stellt die Datenbeschriftung der Datenpunkt-Ebene dar. Angewendet für Treemap- und Sunburst-Serientypen. Nur-Lesen [IDataLabel](../../com.aspose.slides/idatalabel).
