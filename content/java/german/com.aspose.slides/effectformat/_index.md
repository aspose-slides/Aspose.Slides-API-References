...
type: docs
url: /de/com.aspose.slides/effectformat/
---
**Inheritance:**
...
| [isNoEffects()](#isNoEffects--) | Gibt true zurück, wenn alle Effekte deaktiviert sind (wie gerade erstellt, default EffectFormat object). |
...
| [enableFillOverlayEffect()](#enableFillOverlayEffect--) | Aktiviert Füllüberlagerungs-Effekt. |
| [enableGlowEffect()](#enableGlowEffect--) | Aktiviert Leuchteffekt. |
| [enableInnerShadowEffect()](#enableInnerShadowEffect--) | Aktiviert inneren Schatten-Effekt. |
| [enableOuterShadowEffect()](#enableOuterShadowEffect--) | Aktiviert äußeren Schatten-Effekt. |
| [enablePresetShadowEffect()](#enablePresetShadowEffect--) | Aktiviert voreingestellte Schatten-Effekte. |
| [enableReflectionEffect()](#enableReflectionEffect--) | Aktiviert Reflexions-Effekt. |
| [enableSoftEdgeEffect()](#enableSoftEdgeEffect--) | Aktiviert weichen Kanten-Effekt. |
| [disableBlurEffect()](#disableBlurEffect--) | Deaktiviert Unschärfe-Effekt. |
| [disableFillOverlayEffect()](#disableFillOverlayEffect--) | Deaktiviert Füllüberlagerungs-Effekt. |
| [disableGlowEffect()](#disableGlowEffect--) | Deaktiviert Leuchteffekt. |
| [disableInnerShadowEffect()](#disableInnerShadowEffect--) | Deaktiviert inneren Schatten-Effekt. |
| [disableOuterShadowEffect()](#disableOuterShadowEffect--) | Deaktiviert äußeren Schatten-Effekt. |
| [disablePresetShadowEffect()](#disablePresetShadowEffect--) | Deaktiviert voreingestellten Schatten-Effekt. |
| [disableReflectionEffect()](#disableReflectionEffect--) | Deaktiviert Reflexions-Effekt. |
| [disableSoftEdgeEffect()](#disableSoftEdgeEffect--) | Deaktiviert weichen Kanten-Effekt. |
| [getEffective()](#getEffective--) | Ruft effektive Effektformatierungsdaten mit angewandter Vererbung ab. |
...
Gibt true zurück, wenn alle Effekte deaktiviert sind (wie gerade erstellt, default EffectFormat object). Nur lesbar boolean .
...
Unschärfe-Effekt. Lesen/Schreiben [IBlur](../../com.aspose.slides/iblur).
...
Füllüberlagerungs-Effekt. Lesen/Schreiben [IFillOverlay](../../com.aspose.slides/ifilloverlay).
...
Leuchteffekt. Lesen/Schreiben [IGlow](../../com.aspose.slides/iglow).
...
Innerer Schatten. Lesen/Schreiben [IInnerShadow](../../com.aspose.slides/iinnershadow).
...
Äußerer Schatten. Lesen/Schreiben [IOuterShadow](../../com.aspose.slides/ioutershadow).
...
Voreingestellter Schatten. Lesen/Schreiben [IPresetShadow](../../com.aspose.slides/ipresetshadow).
...
Reflexion. Lesen/Schreiben [IReflection](../../com.aspose.slides/ireflection).
...
Weiche Kante. Lesen/Schreiben [ISoftEdge](../../com.aspose.slides/isoftedge).
...
Aktiviert Füllüberlagerungs-Effekt.
...
Aktiviert inneren Schatten-Effekt.
...
Aktiviert äußeren Schatten-Effekt.
...
Aktiviert voreingestellte Schatten-Effekte.
...
Aktiviert weichen Kanten-Effekt.
...
Deaktiviert Füllüberlagerungs-Effekt.
...
Deaktiviert inneren Schatten-Effekt.
...
Deaktiviert äußeren Schatten-Effekt.
...
Deaktiviert voreingestellten Schatten-Effekt.
...
Deaktiviert weichen Kanten-Effekt.
...
Liefert effektive Effektformatierungsdaten mit angewandter Vererbung ab.
