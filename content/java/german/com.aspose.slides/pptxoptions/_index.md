...
| [getRefreshThumbnail()](#getRefreshThumbnail--) | Gibt an, ob das Präsentations-Miniaturbild aktualisiert wird. |
| [setRefreshThumbnail(boolean value)](#setRefreshThumbnail-boolean-) | Gibt an, ob das Präsentations-Miniaturbild aktualisiert wird. |
...
Gibt an, ob das Präsentations-Miniaturbild aktualisiert wird. Lesen/Schreiben Boolean. Standardwert ist **true**.
