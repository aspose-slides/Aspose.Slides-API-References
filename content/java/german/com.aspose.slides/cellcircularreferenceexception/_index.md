...
| --- | --- |
| [getReference()](#getReference--) | Gibt eine zirkuläre Zellreferenz zurück. |
...
| --- | --- | --- |
| message | java.lang.String | Ein String, der den Fehler beschreibt. |
| reference | java.lang.String | Eine zirkuläre Zellreferenz. |
...
Gibt eine zirkuläre Zellreferenz zurück.
