...
description: Gibt die Balkenfunktion an, die aus einem Basisargument und einem Ober- oder Unterbalken besteht
type: docs
...
Gibt die Balkenfunktion an, die aus einem Basisargument und einem Ober- oder Unterbalken besteht
...
| --- | --- |
| [MathBar(IMathElement element)](#MathBar-com.aspose.slides.IMathElement-) | Initialisiert MathBar mit Oberbalken (obere Position) |
...
Initialisiert MathBar mit Oberbalken (obere Position)
