...
| [insert(int index, IMathBlock item)](#insert-int-com.aspose.slides.IMathBlock-) | Fügt IMathBlock an der angegebenen Stelle in die Sammlung ein. |
...
| item | [IMathBlock](../../com.aspose.slides/imathblock) | Der einzufügende IMathBlock. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| item | [IMathBlock](../../com.aspose.slides/imathblock) | Das zu findende Element in der Sammlung. |
...
Ermittelt das Element am angegebenen Index. Nur-Lesen [IMathBlock](../../com.aspose.slides/imathblock).
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| index | int | Der nullbasierte Index des zu ermittelnden Elements. |
