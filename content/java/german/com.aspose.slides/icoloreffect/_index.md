...
| --- | --- |
| [getFrom()](#getFrom--) | Dieser Wert wird verwendet, um die Startfarbe des Verhaltens anzugeben. |
| [setFrom(IColorFormat value)](#setFrom-com.aspose.slides.IColorFormat-) | Dieser Wert wird verwendet, um die Startfarbe des Verhaltens anzugeben. |
...
| [getBy()](#getBy--) | Beschreibt den relativen Versatzwert für die Farbanimation. |
| [setBy(IColorOffset value)](#setBy-com.aspose.slides.IColorOffset-) | Beschreibt den relativen Versatzwert für die Farbanimation. |
...
| [getDirection()](#getDirection--) | Gibt an, in welche Richtung der Farbton auf dem Farbrad durchlaufen wird. |
| [setDirection(int value)](#setDirection-int-) | Gibt an, in welche Richtung der Farbton auf dem Farbrad durchlaufen wird. |
### getFrom() {#getFrom--}
```
...
Dieser Wert wird verwendet, um die Startfarbe des Verhaltens anzugeben. Lesen/Schreiben [IColorFormat](../../com.aspose.slides/icolorformat).
...
Beschreibt den relativen Versatzwert für die Farbanimation. Lesen/Schreiben [IColorOffset](../../com.aspose.slides/icoloroffset).
...
Gibt an, in welche Richtung der Farbton auf dem Farbrad durchlaufen wird. Lesen/Schreiben [ColorDirection](../../com.aspose.slides/colordirection).
