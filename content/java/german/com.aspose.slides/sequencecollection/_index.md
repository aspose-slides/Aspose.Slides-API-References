...
| --- | --- |
| [getCount()](#getCount--) | Gibt die Anzahl der Elemente in einer Sammlung zurück. Nur lesbar int. |
...
Gibt die Anzahl der Elemente in einer Sammlung zurück. Nur lesbar int.
...
Fügt eine neue interaktive Sequenz hinzu. Lese/Schreib [Sequence](../../com.aspose.slides/sequence).
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| index | int | Index einer zu löschenden Sequenz. |
