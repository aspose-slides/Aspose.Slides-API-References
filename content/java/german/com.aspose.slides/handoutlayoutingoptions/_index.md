...
description: Stellt den Handout-Präsentationslayoutmodus für den Export dar.
type: docs
...
Stellt den Handout-Präsentationslayoutmodus für den Export dar.
## Konstruktoren
...
| [getPrintSlideNumbers()](#getPrintSlideNumbers--) | Gibt an, ob die angezeigten Foliennummern gedruckt werden sollen oder nicht. |
| [setPrintSlideNumbers(boolean value)](#setPrintSlideNumbers-boolean-) | Gibt an, ob die angezeigten Foliennummern gedruckt werden sollen oder nicht. |
...
| [getPrintComments()](#getPrintComments--) | Gibt an, ob Kommentare auf Folien angezeigt werden sollen oder nicht |
| [setPrintComments(boolean value)](#setPrintComments-boolean-) | Gibt an, ob Kommentare auf Folien angezeigt werden sollen oder nicht |
