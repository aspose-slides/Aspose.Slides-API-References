...
| [isReadOnly()](#isReadOnly--) | Ermittelt einen Wert, der angibt, ob das [IGenericCollection](../../com.aspose.slides/igenericcollection) schreibgeschützt ist. |
...
| [insert(int index, IParagraph value)](#insert-int-com.aspose.slides.IParagraph-) | Fügt ein Paragraph an dem angegebenen Index in die Sammlung ein. |
...
| [copyTo(IParagraph[] array, int arrayIndex)](#copyTo-com.aspose.slides.IParagraph---int-) | Kopiert die Elemente von [IGenericCollection](../../com.aspose.slides/igenericcollection) in ein Array, beginnend an einem bestimmten Array-Index. |
| [removeAt(int index)](#removeAt-int-) | Entfernt das Element am angegebenen Index der Sammlung. |
| [remove(IParagraph item)](#remove-com.aspose.slides.IParagraph-) | Entfernt das erste Vorkommen eines bestimmten Objekts aus [IGenericCollection](../../com.aspose.slides/igenericcollection). |
| [iterator()](#iterator--) | Gibt einen Enumerator zurück, der die Sammlung durchläuft. |
| [iteratorJava()](#iteratorJava--) | Gibt einen java Iterator für die gesamte Sammlung zurück. |
| [getSlide()](#getSlide--) | Gibt die übergeordnete Folie einer Paragraphs-Sammlung zurück. |
| [getPresentation()](#getPresentation--) | Gibt die übergeordnete Präsentation einer Paragraphs-Sammlung zurück. |
...
| [exportToHtml(int firstParagraphIndex, int paragraphsCount, ITextToHtmlConversionOptions options)](#exportToHtml-int-int-com.aspose.slides.ITextToHtmlConversionOptions-) | Konvertiert angegebene Absätze zu HTML und gibt das Ergebnis als String-Objekt zurück. |
...
Ermittelt einen Wert, der angibt, ob das [IGenericCollection](../../com.aspose.slides/igenericcollection) schreibgeschützt ist. Nur lesbar boolean.
...
**Rückgabewert:**
int - Der Index, an dem das Paragraph hinzugefügt wurde, oder -1, wenn nichts hinzuzufügen war.
...
**Rückgabewert:**
int - Der Index des Elements, falls es in der Liste gefunden wurde; andernfalls -1.
### insert(int index, IParagraph value) {#insert-int-com.aspose.slides.IParagraph-}
```
public final void insert(int index, IParagraph value)
```

Fügt ein Paragraph an dem angegebenen Index in die Sammlung ein.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| item | [IParagraph](../../com.aspose.slides/iparagraph) | Das Objekt, das im [IGenericCollection](../../com.aspose.slides/igenericcollection) gesucht werden soll. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| array | [IParagraph\[\]](../../com.aspose.slides/iparagraph) | Das eindimensionale Array, das das Ziel der von [IGenericCollection](../../com.aspose.slides/igenericcollection) kopierten Elemente ist. Das Array muss nullbasierte Indizierung besitzen. |
...
**Rückgabewert:**
boolean - true, wenn das Element erfolgreich aus [IGenericCollection](../../com.aspose.slides/igenericcollection) entfernt wurde; andernfalls false. Diese Methode gibt ebenfalls false zurück, wenn das Element im ursprünglichen [IGenericCollection](../../com.aspose.slides/igenericcollection) nicht gefunden wird.
### iterator() {#iterator--}
```
...
Gibt die übergeordnete Folie einer Paragraphs-Sammlung zurück. Nur lesbar [BaseSlide](../../com.aspose.slides/baseslide).
...
Gibt die übergeordnete Präsentation einer Paragraphs-Sammlung zurück. Nur lesbar [IPresentation](../../com.aspose.slides/ipresentation).
...
| uri | java.lang.String | URI zum Hinzufügen des HTML-Dokuments. Wird zur Auflösung relativer Links verwendet. |
...
Konvertiert angegebene Absätze zu HTML und gibt das Ergebnis als String-Objekt zurück.
