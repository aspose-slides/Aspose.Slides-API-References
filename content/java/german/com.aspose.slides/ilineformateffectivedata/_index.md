...
description: Unveränderliches Objekt, das effektive Zeilenformatierungs-Eigenschaften enthält.
type: docs
...
Unveränderliches Objekt, das effektive Zeilenformatierungs-Eigenschaften enthält.

--------------------

Dieses Interface wird zusammen mit dem [ILineFormat](../../com.aspose.slides/ilineformat) Interface verwendet, um effektive Formatierungswerte mit angewandter Vererbung zurückzugeben.
## Methoden
...
| [getCapStyle()](#getCapStyle--) | Gibt den Endkapstil der Zeile zurück. |
| [getStyle()](#getStyle--) | Gibt den Zeilenstil zurück. |
| [getAlignment()](#getAlignment--) | Gibt die Zeilenausrichtung zurück. |
| [getJoinStyle()](#getJoinStyle--) | Gibt den Verbindungsstil der Zeilen zurück. |
| [getMiterLimit()](#getMiterLimit--) | Gibt die Gehrungsbegrenzung einer Zeile zurück. |
...
| [getBeginArrowheadLength()](#getBeginArrowheadLength--) | Gibt die Pfeilspitzengröße am Anfang einer Zeile zurück. |
| [getEndArrowheadLength()](#getEndArrowheadLength--) | Gibt die Pfeilspitzengröße am Ende einer Zeile zurück. |
...
Gibt den Endkapstil der Zeile zurück. Nur lesbar [LineCapStyle](../../com.aspose.slides/linecapstyle).
...
Gibt die Zeilenausrichtung zurück. Nur lesbar [LineAlignment](../../com.aspose.slides/linealignment).
...
Gibt die Gehrungsbegrenzung einer Zeile zurück. Nur lesbar float.
...
Gibt die Pfeilspitzengröße am Anfang einer Zeile zurück. Nur lesbar [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
Gibt die Pfeilspitzengröße am Ende einer Zeile zurück. Nur lesbar [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
| --- | --- | --- |
| lf | [ILineFormatEffectiveData](../../com.aspose.slides/ilineformateffectivedata) | Die ILineFormatEffectiveData, die mit der aktuellen ILineFormatEffectiveData verglichen wird. |
