...
description: Die Ausnahme, die ausgelöst wird, wenn ein ungültiger Zellverweis auftritt.
type: docs
...
Die Ausnahme, die ausgelöst wird, wenn ein ungültiger Zellverweis auftritt.
## Konstruktoren
...
Initialisiert eine neue Instanz der [CellCircularReferenceException](../../com.aspose.slides/cellcircularreferenceexception) Klasse mit einer angegebenen Fehlermeldung und einem ungültigen Zellverweis.

**Parameter:**
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| message | java.lang.String | Eine Zeichenkette, die den Fehler beschreibt. |
| reference | java.lang.String | Ein ungültiger Zellverweis. |
...
Ruft einen ungültigen Zellverweis ab.
