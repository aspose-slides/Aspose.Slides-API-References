...
| [getExternalResourceResolver()](#getExternalResourceResolver--) | Gibt das Callback-Interface zurück, das zum Auflösen externer Ressourcen beim Import von SVG-Dokumenten verwendet wird. |
...
Gibt den SVG-Inhalt zurück. Nur lesbarer String.
...
Gibt die SVG-Daten zurück. Nur lesbares byte[].
...
Gibt das Callback-Interface zurück, das zum Auflösen externer Ressourcen beim Import von SVG-Dokumenten verwendet wird. Nur lesbarer [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver).
...
Gibt die Basis-URI des angegebenen SVG zurück. Wird zum Auflösen relativer Links verwendet. Nur lesbarer String.
