...
Ermittelt das Element am angegebenen Index. Nur lesbar [Tab](../../com.aspose.slides/tab).
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| obj | java.lang.Object | Der TabsEx, mit dem der aktuelle TabsEx verglichen werden soll. |

**Rückgabe:**
boolean - **true**, wenn der angegebene TabsEx dem aktuellen TabsEx entspricht; andernfalls **false**.
### iterator() {#iterator--}
```
