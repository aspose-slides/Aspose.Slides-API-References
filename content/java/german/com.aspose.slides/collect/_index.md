...
>      for (IShape shape : Collect.shapes(pres))
>      {
>          // wenn die Form AutoShape ist, füge eine schwarze feste Umrandung hinzu
...
| --- | --- | --- |
| pres | [Presentation](../../com.aspose.slides/presentation) | Präsentation zum Sammeln von Formen |

**Rückgabewert:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.slides.Shape> - Sammlung aller Formen, die in der Präsentation enthalten sind