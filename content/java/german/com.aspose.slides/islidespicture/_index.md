...
| [getImageTransform()](#getImageTransform--) | Gibt die Sammlung von Bild-Transformations-Effekten zurück. |
### getImage() {#getImage--}
```
...
Gibt die Sammlung von Bild-Transformations-Effekten zurück. Nur-Lesen [IImageTransformOperationCollection](../../com.aspose.slides/iimagetransformoperationcollection).
