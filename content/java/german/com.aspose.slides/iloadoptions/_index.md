...
| [getBlobManagementOptions()](#getBlobManagementOptions--) | Stellt die Optionen dar, die zum Verwalten des Verhaltens von Binary Large Objects (BLOBs) verwendet werden können, z. B. die Nutzung temporärer Dateien oder maximaler BLOB-Bytes im Speicher. |
| [setBlobManagementOptions(IBlobManagementOptions value)](#setBlobManagementOptions-com.aspose.slides.IBlobManagementOptions-) | Stellt die Optionen dar, die zum Verwalten des Verhaltens von Binary Large Objects (BLOBs) verwendet werden können, z. B. die Nutzung temporärer Dateien oder maximaler BLOB-Bytes im Speicher. |
...
| [getInterruptionToken()](#getInterruptionToken--) | Das Token zum Überwachen von Unterbrechungsanforderungen. |
| [setInterruptionToken(IInterruptionToken value)](#setInterruptionToken-com.aspose.slides.IInterruptionToken-) | Das Token zum Überwachen von Unterbrechungsanforderungen. |
...
| [getSpreadsheetOptions()](#getSpreadsheetOptions--) | Stellt Optionen dar, die zum Festlegen zusätzlichen Tabellenkalkulationsverhaltens verwendet werden können. |
| [setSpreadsheetOptions(ISpreadsheetOptions value)](#setSpreadsheetOptions-com.aspose.slides.ISpreadsheetOptions-) | Stellt Optionen dar, die zum Festlegen zusätzlichen Tabellenkalkulationsverhaltens verwendet werden können. |
...
Stellt die Optionen dar, die zum Verwalten des Verhaltens von Binary Large Objects (BLOBs) verwendet werden können, z. B. die Nutzung temporärer Dateien oder maximaler BLOB-Bytes im Speicher. Diese Optionen dienen dazu, das optimale Verhältnis von Leistung zu Speicherverbrauch für eine bestimmte Umgebung oder Anforderung einzustellen.

--------------------

Ein Binary Large Object (BLOB) ist ein binäres Datum, das als einzelne Einheit gespeichert wird – z. B. kann ein BLOB ein Audio-, Video- oder Präsentations-Datei sein.
...
Das Token zum Überwachen von Unterbrechungsanforderungen.

--------------------

Dieses Token verwaltet die gesamte [IPresentation](../../com.aspose.slides/ipresentation)-Instanzlebensdauer. Jeder langlaufende Vorgang, wie das Laden oder Speichern einer Präsentation, wird durch Aufruf der [IInterruptionTokenSource.interrupt](../../com.aspose.slides/iinterruptiontokensource\#interrupt)-Methode des [IInterruptionTokenSource](../../com.aspose.slides/iinterruptiontokensource) unterbrochen.
...
Stellt Optionen dar, die zum Festlegen zusätzlichen Tabellenkalkulationsverhaltens verwendet werden können.
...
Bestimmt, ob Aspose.Slides beim Laden einer Präsentation alle eingebetteten Binärobjekte löscht.
