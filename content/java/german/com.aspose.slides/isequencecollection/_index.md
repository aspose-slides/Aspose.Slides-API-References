...
| --- | --- |
| [getCount()](#getCount--) | Gibt die Anzahl der Elemente in einer Sammlung zurück. Read-only int. |
...
Gibt die Anzahl der Elemente in einer Sammlung zurück. Read-only int.
