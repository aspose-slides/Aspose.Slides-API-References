...
| [getUpperLimit()](#getUpperLimit--) | Gibt die obere oder untere Grenze an |
| [setUpperLimit(boolean value)](#setUpperLimit-boolean-) | Gibt die obere oder untere Grenze an |
### getBase() {#getBase--}
```
