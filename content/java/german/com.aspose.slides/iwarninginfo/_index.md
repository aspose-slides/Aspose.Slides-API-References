...
| --- | --- |
| [sendWarning(IWarningCallback receiver)](#sendWarning-com.aspose.slides.IWarningCallback-) | Wenn receiver nicht null ist, beendet die Warnung an einen angegebenen receiver und wirft die AbortRequestedException, wenn receiver beschlossen hat, den Vorgang abzubrechen. |
| [getWarningType()](#getWarningType--) | Gibt einen Typ der Warnung zurück. |
...
Wenn receiver nicht null ist, beendet die Warnung an einen angegebenen receiver und wirft die AbortRequestedException, wenn receiver beschlossen hat, den Vorgang abzubrechen.
...
Gibt einen Typ der Warnung zurück. Nur lesbar [WarningType](../../com.aspose.slides/warningtype)(\#getWarningType.getWarningType).
