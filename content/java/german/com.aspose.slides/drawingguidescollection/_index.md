...
description: Stellt eine Sammlung einstellbarer Zeichenhilfen dar.
type: docs
...
Stellt eine Sammlung einstellbarer Zeichenhilfen dar.
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Gibt die Zeichenhilfe anhand des Index zurück. |
...
Gibt die Zeichenhilfe anhand des Index zurück. Nur-Lesen [IDrawingGuide](../../com.aspose.slides/idrawingguide).
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| array | [IDrawingGuide\[\]](../../com.aspose.slides/idrawingguide) | Zielarray. |
