...
| [getMasterSlide()](#getMasterSlide--) | Gibt die Master-Folie für ein Layout zurück oder legt sie fest. |
| [setMasterSlide(IMasterSlide value)](#setMasterSlide-com.aspose.slides.IMasterSlide-) | Gibt die Master-Folie für ein Layout zurück oder legt sie fest. |
| [getLayoutType()](#getLayoutType--) | Gibt den Layout-Typ dieser Layout-Folie zurück. |
...
Gibt die Master-Folie für ein Layout zurück oder legt sie fest. Lese/Schreib [IMasterSlide](../../com.aspose.slides/imasterslide).
...
Gibt den Layout-Typ dieser Layout-Folie zurück. Nur-Lesen [SlideLayoutType](../../com.aspose.slides/slidelayouttype).
