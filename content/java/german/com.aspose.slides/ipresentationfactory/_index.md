...
| [getPresentationInfo(String file)](#getPresentationInfo-java.lang.String-) | Ruft Informationen über die Präsentation in der angegebenen Datei ab. |
| [getPresentationInfo(InputStream stream)](#getPresentationInfo-java.io.InputStream-) | Ruft Informationen über die Präsentation im angegebenen Stream ab. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| stream | java.io.InputStream | Ein zu lesender Eingabestream |
...
**Rückgabe:**
[IPresentationText](../../com.aspose.slides/ipresentationtext) - Die Instanz von PresentationText, die das SlideText-Array enthält, das den Rohtext der Folien darstellt
