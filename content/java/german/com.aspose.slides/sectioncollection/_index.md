...
| [addSection(String name, ISlide startedFromSlide)](#addSection-java.lang.String-com.aspose.slides.ISlide-) | Fügt einen Folienabschnitt hinzu, der von einer bestimmten Folie aus startet. |
...
| [reorderSectionWithSlides(ISection section, int index)](#reorderSectionWithSlides-com.aspose.slides.ISection-int-) | Verschiebt den Abschnitt und seine Folien aus der Sammlung an die angegebene Position. |
...
Ermittelt das Element am angegebenen Index. Nur lesbar [ISection](../../com.aspose.slides/isection).
...
Fügt einen Folienabschnitt hinzu, der von einer bestimmten Folie aus startet.
...
**Rückgabewert:**
int - Index eines Abschnitts oder -1, wenn der Abschnitt nicht zu dieser Sammlung gehört.
...
Entfernt den Abschnitt. Folien, die im Abschnitt enthalten sind, werden in den vorherigen Abschnitt verschmolzen.
...
Verschiebt den Abschnitt und seine Folien aus der Sammlung an die angegebene Position.
...
**Rückgabewert:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISection> - Ein IGenericEnumerator, der verwendet werden kann, um die Sammlung zu durchlaufen.
...
**Rückgabewert:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISection> - Ein java.util.Iterator für die gesamte Sammlung.