...
| [getBaseJustification()](#getBaseJustification--) | Gibt die Ausrichtung des Arrays relativ zum umgebenden Text an. Text außerhalb des Arrays kann am unteren Rand, oberen Rand oder in der Mitte eines Array-Objekts ausgerichtet werden. |
| [setBaseJustification(int value)](#setBaseJustification-int-) | Gibt die Ausrichtung des Arrays relativ zum umgebenden Text an. Text außerhalb des Arrays kann am unteren Rand, oberen Rand oder in der Mitte eines Array-Objekts ausgerichtet werden. |
...
| [getRowSpacing()](#getRowSpacing--) | Abstand zwischen den Zeilen eines Arrays. Wird nur verwendet, wenn RowSpacingRule auf 3 gesetzt ist. Genau in diesem Fall ist die Maßeinheit Punkte, oder Multiple, wobei die Maßeinheit halbe Zeilen ist. |
| [setRowSpacing(long value)](#setRowSpacing-long-) | Abstand zwischen den Zeilen eines Arrays. Wird nur verwendet, wenn RowSpacingRule auf 3 gesetzt ist. Genau in diesem Fall ist die Maßeinheit Punkte, oder Multiple, wobei die Maßeinheit halbe Zeilen ist. |
...
Gibt die Ausrichtung des Arrays relativ zum umgebenden Text an. Text außerhalb des Arrays kann am unteren Rand, oberen Rand oder in der Mitte eines Array-Objekts ausgerichtet werden. Standardwert: Center
...
Abstand zwischen den Zeilen eines Arrays. Wird nur verwendet, wenn RowSpacingRule auf 3 gesetzt ist. Genau in diesem Fall ist die Maßeinheit Punkte, oder Multiple, wobei die Maßeinheit halbe Zeilen ist. Standard: 0
