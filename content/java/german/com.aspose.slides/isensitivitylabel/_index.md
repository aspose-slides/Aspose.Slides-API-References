...
| [getSiteId()](#getSiteId--) | Gibt die Azure Active Directory (Azure AD) Site-Kennung zurück oder setzt sie, die der Sensitivitätslabel-Richtlinie entspricht, welche das Sensitivitätslabel beschreibt. |
| [setSiteId(UUID value)](#setSiteId-java.util.UUID-) | Gibt die Azure Active Directory (Azure AD) Site-Kennung zurück oder setzt sie, die der Sensitivitätslabel-Richtlinie entspricht, welche das Sensitivitätslabel beschreibt. |
| [isEnabled()](#isEnabled--) | Zeigt an, ob das Sensitivitätslabel aktiviert ist. |
| [setEnabled(boolean value)](#setEnabled-boolean-) | Zeigt an, ob das Sensitivitätslabel aktiviert ist. |
| [isRemoved()](#isRemoved--) | Zeigt an, ob das Sensitivitätslabel entfernt wurde. |
| [setRemoved(boolean value)](#setRemoved-boolean-) | Zeigt an, ob das Sensitivitätslabel entfernt wurde. |
...
| [getContentMarkTypes()](#getContentMarkTypes--) | Gibt die Liste der Typen von Inhaltskennzeichnungen zurück, die auf eine Datei angewendet werden sollen. |
### getId() {#getId--}
```
...
Gibt die Azure Active Directory (Azure AD) Site-Kennung zurück oder setzt sie, die der Sensitivitätslabel-Richtlinie entspricht, welche das Sensitivitätslabel beschreibt. Lesen/Schreiben java.util.UUID.
...
Zeigt an, ob das Sensitivitätslabel aktiviert ist.
...
Zeigt an, ob das Sensitivitätslabel entfernt wurde.
...
Gibt die Liste der Typen von Inhaltskennzeichnungen zurück, die auf eine Datei angewendet werden sollen.
