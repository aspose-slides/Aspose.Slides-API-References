...
| [getSlide()](#getSlide--) | 返回 FillFormat 所在的父幻灯片。 |
| [getPresentation()](#getPresentation--) | 返回 FillFormat 所在的父演示文稿。 |
...
返回 FillFormat 所在的父幻灯片。只读 [BaseSlide](../../com.aspose.slides/baseslide)。
...
返回 FillFormat 所在的父演示文稿。只读 [IPresentation](../../com.aspose.slides/ipresentation)。
