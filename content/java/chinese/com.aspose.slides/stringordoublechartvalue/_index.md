...
表示可以以两种方式存储在 pptx 演示文稿中的字符串或双精度值：1) 在与图表关联的工作簿的单元格/单元格中；2) 作为文字值。
## 方法
...
| [getAsLiteralString()](#getAsLiteralString--) | 返回或设置值为文字字符串。 |
| [setAsLiteralString(String value)](#setAsLiteralString-java.lang.String-) | 返回或设置值为文字字符串。 |
| [getAsLiteralDouble()](#getAsLiteralDouble--) | 返回或设置值为文字双精度数。 |
| [setAsLiteralDouble(double value)](#setAsLiteralDouble-double-) | 返回或设置值为文字双精度数。 |
