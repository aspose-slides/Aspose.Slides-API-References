...
| [getFillFormat()](#getFillFormat--) | 返回文本的 FillFormat 属性。 |
| [getEffectFormat()](#getEffectFormat--) | 返回文本的 EffectFormat 属性。 |
...
| [setKumimoji(byte value)](#setKumimoji-byte-) | 确定数字是否应忽略文本的东亚语言特定垂直布局。 |
...
| [getStrikethroughType()](#getStrikethroughType--) | 返回或设置文本的删除线类型。 |
| [setStrikethroughType(byte value)](#setStrikethroughType-byte-) | 返回或设置文本的删除线类型。 |
| [isHardUnderlineLine()](#isHardUnderlineLine--) | 确定下划线样式是否拥有独立的 LineFormat 属性，或从文本的 LineFormat 属性继承。 |
| [setHardUnderlineLine(byte value)](#setHardUnderlineLine-byte-) | 确定下划线样式是否拥有独立的 LineFormat 属性，或从文本的 LineFormat 属性继承。 |
| [isHardUnderlineFill()](#isHardUnderlineFill--) | 确定下划线样式是否拥有独立的 FillFormat 属性，或从文本的 FillFormat 属性继承。 |
| [setHardUnderlineFill(byte value)](#setHardUnderlineFill-byte-) | 确定下划线样式是否拥有独立的 FillFormat 属性，或从文本的 FillFormat 属性继承。 |
| [getFontHeight()](#getFontHeight--) | 返回或设置文本段的字体高度。 |
| [setFontHeight(float value)](#setFontHeight-float-) | 返回或设置文本段的字体高度。 |
...
| [getKerningMinimalSize()](#getKerningMinimalSize--) | 返回或设置应启用字距调整的最小字体大小。 |
| [setKerningMinimalSize(float value)](#setKerningMinimalSize-float-) | 返回或设置应启用字距调整的最小字体大小。 |
...
| [getSpellCheck()](#getSpellCheck--) | 获取或设置指示文本段是否启用拼写检查的值。 |
| [setSpellCheck(boolean value)](#setSpellCheck-boolean-) | 获取或设置指示文本段是否启用拼写检查的值。 |
...
返回文本轮廓的 LineFormat 属性。不应用继承。只读 [ILineFormat](../../com.aspose.slides/ilineformat)。
...
返回文本的 FillFormat 属性。不应用继承。只读 [IFillFormat](../../com.aspose.slides/ifillformat)。
...
返回文本的 EffectFormat 属性。不应用继承。只读 [IEffectFormat](../../com.aspose.slides/ieffectformat)。
...
返回用于高亮文本的颜色。不应用继承。只读 [IColorFormat](../../com.aspose.slides/icolorformat)。
...
返回用于描绘下划线的 LineFormat 属性。不应用继承。只读 [ILineFormat](../../com.aspose.slides/ilineformat)。
...
返回下划线的 FillFormat 属性。不应用继承。只读 [IFillFormat](../../com.aspose.slides/ifillformat)。
...
确定字体是否为粗体。不应用继承。读/写 [NullableBool](../../com.aspose.slides/nullablebool)。
...
确定字体是否为斜体。不应用继承。读/写 [NullableBool](../../com.aspose.slides/nullablebool)。
...
确定数字是否应忽略文本的东亚语言特定垂直布局。不应用继承。读/写 [NullableBool](../../com.aspose.slides/nullablebool)。
...
确定文本的高度是否应标准化。不应用继承。读/写 [NullableBool](../../com.aspose.slides/nullablebool)。
...
确定文本是否不进行校对。不应用继承。读/写 [NullableBool](../../com.aspose.slides/nullablebool)。
...
返回或设置文本下划线类型。不应用继承。读/写 [TextUnderlineType](../../com.aspose.slides/textunderlinetype)。
...
返回或设置文本大小写类型。不应用继承。读/写 [TextCapType](../../com.aspose.slides/textcaptype)。
...
返回或设置文本的删除线类型。不应用继承。读/写 [TextStrikethroughType](../../com.aspose.slides/textstrikethroughtype)。
...
确定下划线样式是否拥有独立的 LineFormat 属性，或从文本的 LineFormat 属性继承。读/写 [NullableBool](../../com.aspose.slides/nullablebool)。
...
确定下划线样式是否拥有独立的 FillFormat 属性，或从文本的 FillFormat 属性继承。读/写 [NullableBool](../../com.aspose.slides/nullablebool)。
...
返回或设置文本段的字体高度。**Float.NaN** 表示高度未定义，应从母版继承。读/写  float 。
...
返回或设置拉丁字体信息。Null 表示字体未定义，应从母版继承。读/写 [IFontData](../../com.aspose.slides/ifontdata)。
...
返回或设置东亚字体信息。Null 表示字体未定义，应从母版继承。读/写 [IFontData](../../com.aspose.slides/ifontdata)。
...
返回或设置复杂脚本字体信息。Null 表示字体未定义，应从母版继承。读/写 [IFontData](../../com.aspose.slides/ifontdata)。
...
返回或设置符号字体信息。Null 表示字体未定义，应从母版继承。读/写 [IFontData](../../com.aspose.slides/ifontdata)。
...
返回或设置上标或下标文本。值范围为 -100%（下标）到 100%（上标）。**Float.NaN** 表示值未定义，应从母版继承。读/写  float 。
...
返回或设置应启用字距调整的最小字体大小。**Float.NaN** 表示值未定义，应从母版继承。读/写  float 。
...
返回或设置校对语言的 Id。用于拼写和语法检查。读/写 String。
...
返回或设置字符间距增量。**Float.NaN** 表示值未定义，应从母版继承。读/写  float 。
...
获取或设置指示文本段是否启用拼写检查的值。当此属性设置为 false 时，文本元素的拼写检查被抑制。当设置为 true 时，允许拼写检查。默认值为 false 。
