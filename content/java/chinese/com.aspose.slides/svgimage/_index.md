...
| [getExternalResourceResolver()](#getExternalResourceResolver--) | 返回在 Svg 文档导入期间用于解析外部资源的回调接口。 |
...
| --- | --- | --- |
| data | byte[] | Svg 数据。 |
| externalResResolver | [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver) | 用于获取外部对象的回调对象。如果此参数为 null，则所有外部对象将被忽略。 |
...
返回在 Svg 文档导入期间用于解析外部资源的回调接口。只读 [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver)。
