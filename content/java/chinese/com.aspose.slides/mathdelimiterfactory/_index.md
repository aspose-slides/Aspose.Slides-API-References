...
| 方法 | 描述 |
| --- | --- |
| [createMathDelimiter(IMathElement element)](#createMathDelimiter-com.aspose.slides.IMathElement-) | 通过应用于元素创建数学分隔符 |
| [createMathDelimiter(IMathElementCollection mathElements)](#createMathDelimiter-com.aspose.slides.IMathElementCollection-) | 通过应用于元素创建数学分隔符 |
### MathDelimiterFactory() {#MathDelimiterFactory--}
```
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| mathElements | [IMathElementCollection](../../com.aspose.slides/imathelementcollection) | 用于应用分隔符的数学元素集合 |
