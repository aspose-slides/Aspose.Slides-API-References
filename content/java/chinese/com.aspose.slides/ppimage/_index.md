...
| [getContentType()](#getContentType--) | 返回图像的 MIME 类型，已在 BinaryData (\#getBinaryData.getBinaryData) 中编码。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| newImage | [IImage](../../com.aspose.slides/iimage) | 新的图像。 |
...
返回图像的 MIME 类型，已在 BinaryData (\#getBinaryData.getBinaryData) 中编码。只读 String。
