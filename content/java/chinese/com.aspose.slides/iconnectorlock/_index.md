...
type: docs
url: /zh/com.aspose.slides/iconnectorlock/
---
**所有实现的接口:**
...
| [getRotateLocked()](#getRotateLocked--) | 确定是否禁止更改此形状的旋转角度。 |
| [setRotateLocked(boolean value)](#setRotateLocked-boolean-) | 确定是否禁止更改此形状的旋转角度。 |
| [getAspectRatioLocked()](#getAspectRatioLocked--) | 确定在调整大小时是否必须保持形状的纵横比。 |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | 确定在调整大小时是否必须保持形状的纵横比。 |
| [getPositionMove()](#getPositionMove--) | 确定是否禁止移动此形状。 |
| [setPositionMove(boolean value)](#setPositionMove-boolean-) | 确定是否禁止移动此形状。 |
...
| [getArrowheadsLocked()](#getArrowheadsLocked--) | 确定是否禁止更改箭头。 |
| [setArrowheadsLocked(boolean value)](#setArrowheadsLocked-boolean-) | 确定是否禁止更改箭头。 |
...
确定在调整大小时是否必须保持形状的纵横比。读/写 boolean。
