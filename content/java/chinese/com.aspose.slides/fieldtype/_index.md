...
| [equals(Object obj)](#equals-java.lang.Object-) | 检查此字段是否等于另一个。 |
...
| [getDateTime()](#getDateTime--) | 渲染应用程序的默认日期时间格式的当前日期和时间。 |
| [getDateTime1()](#getDateTime1--) | 第一种预定义格式的当前日期和时间（英文为 MM/DD/YYYY）。 |
| [getDateTime2()](#getDateTime2--) | 第二种预定义格式的当前日期和时间（英文为 Day, Month DD, YYYY）。 |
| [getDateTime3()](#getDateTime3--) | 第三种预定义格式的当前日期和时间（英文为 DD Month YYYY）。 |
| [getDateTime4()](#getDateTime4--) | 第四种预定义格式的当前日期和时间（英文为 Month DD, YYYY）。 |
| [getDateTime5()](#getDateTime5--) | 第五种预定义格式的当前日期和时间（英文为 DD-Mon-YY）。 |
| [getDateTime6()](#getDateTime6--) | 第六种预定义格式的当前日期和时间（英文为 Month YY）。 |
| [getDateTime7()](#getDateTime7--) | 第七种预定义格式的当前日期和时间（英文为 Mon-YY）。 |
| [getDateTime8()](#getDateTime8--) | 第八种预定义格式的当前日期和时间（英文为 MM/DD/YYYY hh:mm AM/PM）。 |
| [getDateTime9()](#getDateTime9--) | 第九种预定义格式的当前日期和时间（英文为 MM/DD/YYYY hh:mm:ss AM/PM）。 |
| [getDateTime10()](#getDateTime10--) | 第十种预定义格式的当前日期和时间（英文为 hh:mm）。 |
| [getDateTime11()](#getDateTime11--) | 第十一种预定义格式的当前日期和时间（英文为 hh:mm:ss）。 |
| [getDateTime12()](#getDateTime12--) | 第十二种预定义格式的当前日期和时间（英文为 hh:mm AM/PM）。 |
| [getDateTime13()](#getDateTime13--) | 第十三种预定义格式的当前日期和时间（英文为 hh:mm:ss AM/PM）。 |
...
返回此 FieldType 对象的内部名称。可读/可写 String。
...
渲染应用程序的默认日期时间格式的当前日期和时间。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第一种预定义格式的当前日期和时间（英文为 MM/DD/YYYY）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第二种预定义格式的当前日期和时间（英文为 Day, Month DD, YYYY）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第三种预定义格式的当前日期和时间（英文为 DD Month YYYY）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第四种预定义格式的当前日期和时间（英文为 Month DD, YYYY）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第五种预定义格式的当前日期和时间（英文为 DD-Mon-YY）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第六种预定义格式的当前日期和时间（英文为 Month YY）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第七种预定义格式的当前日期和时间（英文为 Mon-YY）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第八种预定义格式的当前日期和时间（英文为 MM/DD/YYYY hh:mm AM/PM）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第九种预定义格式的当前日期和时间（英文为 MM/DD/YYYY hh:mm:ss AM/PM）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第十种预定义格式的当前日期和时间（英文为 hh:mm）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第十一种预定义格式的当前日期和时间（英文为 hh:mm:ss）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第十二种预定义格式的当前日期和时间（英文为 hh:mm AM/PM）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
...
第十三种预定义格式的当前日期和时间（英文为 hh:mm:ss AM/PM）。只读 [FieldType](../../com.aspose.slides/fieldtype)。
