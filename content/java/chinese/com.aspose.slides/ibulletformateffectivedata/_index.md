...
| [getNumberedBulletStartWith()](#getNumberedBulletStartWith--) | 返回用于编号项目符号组的第一个数字。 |
| [getNumberedBulletStyle()](#getNumberedBulletStyle--) | 返回编号项目符号的样式。 |
| [isBulletHardColor()](#isBulletHardColor--) | 确定项目符号是否拥有自己的颜色，或从段落的第一部分继承颜色。 |
| [isBulletHardFont()](#isBulletHardFont--) | 确定项目符号是否拥有自己的字体，或从段落的第一部分继承字体。 |
...
确定项目符号是否拥有自己的颜色，或从段落的第一部分继承颜色。如果项目符号拥有自己的颜色则返回 **true**，如果项目符号从段落的第一部分继承颜色则返回 **false**。只读 boolean。
...
确定项目符号是否拥有自己的字体，或从段落的第一部分继承字体。如果项目符号拥有自己的字体则返回 **true**，如果项目符号从段落的第一部分继承字体则返回 **true**。只读 boolean。
