...
description: 表示数据表属性。
type: docs
url: /zh/com.aspose.slides/idatatable/
---
**所有实现的接口：**
...
| [hasBorderHorizontal()](#hasBorderHorizontal--) | 如果图表数据表具有水平单元格边框，则返回 true。 |
| [setBorderHorizontal(boolean value)](#setBorderHorizontal-boolean-) | 如果图表数据表具有水平单元格边框，则返回 true。 |
| [hasBorderOutline()](#hasBorderOutline--) | 如果图表数据表具有轮廓边框，则返回 true。 |
| [setBorderOutline(boolean value)](#setBorderOutline-boolean-) | 如果图表数据表具有轮廓边框，则返回 true。 |
| [hasBorderVertical()](#hasBorderVertical--) | 如果图表数据表具有垂直单元格边框，则返回 true。 |
| [setBorderVertical(boolean value)](#setBorderVertical-boolean-) | 如果图表数据表具有垂直单元格边框，则返回 true。 |
| [getShowLegendKey()](#getShowLegendKey--) | 如果数据标签图例键可见，则返回 true。 |
| [setShowLegendKey(boolean value)](#setShowLegendKey-boolean-) | 如果数据标签图例键可见，则返回 true。 |
### getFormat() {#getFormat--}
```
...
如果图表数据表具有水平单元格边框，则返回 true。读写 boolean。
...
如果图表数据表具有轮廓边框，则返回 true。读写 boolean。
...
如果图表数据表具有垂直单元格边框，则返回 true。读写 boolean。
...
如果数据标签图例键可见，则返回 true。读写 boolean。
