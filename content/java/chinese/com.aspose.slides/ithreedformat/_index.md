...
| [getLightRig()](#getLightRig--) | 返回或设置 灯光的类型。 |
...
返回或设置 灯光的类型。只读 [ILightRig](../../com.aspose.slides/ilightrig)。
...
返回或设置 材质的类型。读/写 [MaterialPresetType](../../com.aspose.slides/materialpresettype)。
...
**返回值：**
[IThreeDFormatEffectiveData](../../com.aspose.slides/ithreedformateffectivedata) - 一个 [IThreeDFormatEffectiveData](../../com.aspose.slides/ithreedformateffectivedata)。