...
type: docs
url: /zh/com.aspose.slides/rowformat/
---
**继承：**
...
| 方法 | 描述 |
| --- | --- |
| [getEffective()](#getEffective--) | 获取在继承和表格样式应用后的有效表格行格式属性。 |
...
>  因此，最终始终使用 CellFormatEffectiveData 属性来绘制表格。下面的代码仅为 API 示例。
>  
...
**返回：**
[IRowFormatEffectiveData](../../com.aspose.slides/irowformateffectivedata) - 一个 [IRowFormatEffectiveData](../../com.aspose.slides/irowformateffectivedata)。
### getVersion() {#getVersion--}
```
