...
| 构造函数 | 描述 |
| --- | --- |
| [OleEmbeddedDataInfo()](#OleEmbeddedDataInfo--) | 为 OLE 对象创建新的嵌入数据信息。 |
| [OleEmbeddedDataInfo(byte[] embeddedFileData, String embeddedFileExtension)](#OleEmbeddedDataInfo-byte---java.lang.String-) | 为 OLE 对象创建嵌入数据信息的新实例。 |
## 方法
