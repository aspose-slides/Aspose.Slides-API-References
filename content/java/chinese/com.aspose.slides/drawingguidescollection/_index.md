...
| 方法 | 描述 |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | 返回指定索引处的绘图指南。 |
| [add(byte orientation, float position)](#add-byte-float-) | 在集合的末尾添加绘图指南。 |
| [removeAt(int index)](#removeAt-int-) | 移除指定索引处的绘图指南。 |
...
返回指定索引处的绘图指南。只读 [IDrawingGuide](../../com.aspose.slides/idrawingguide)。
...
**返回：**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IDrawingGuide> - 可以用于遍历集合的 IGenericEnumerator。
