...
description: 表示 Hue/Saturation/Luminance 效果。
type: docs
...
表示一个 Hue/Saturation/Luminance 效果。Hue、Saturation 和 Luminance 可以相对于其当前值进行调整。

## 方法

| 方法 | 描述 |
| --- | --- |
| [getEffective()](#getEffective--) | 获取在应用继承后有效的 Hue/Saturation/Luminance 效果数据。 |
...
获取在应用继承后有效的 Hue/Saturation/Luminance 效果数据。
