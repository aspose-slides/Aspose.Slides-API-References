...
返回或设置墙体厚度，作为绘图体积最大维度的百分比。可读写 int.
...
返回或设置图片类型。可读写 [PictureType](../../com.aspose.slides/picturetype)(\#getPictureType.getPictureType/\#setPictureType(int).setPictureType(int))。
