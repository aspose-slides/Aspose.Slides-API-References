...
| [getImage(float scaleX, float scaleY)](#getImage-float-float-) | 返回具有自定义缩放的图像对象。 |
| [getImage()](#getImage--) | 返回缩略图图像对象（实际大小的 20%）。 |
| [getImage(Dimension imageSize)](#getImage-java.awt.Dimension-) | 返回具有指定大小的图像对象。 |
| [getImage(ITiffOptions options)](#getImage-com.aspose.slides.ITiffOptions-) | 返回具有指定参数的缩略图 TIFF 位图对象。 |
| [getImage(IRenderingOptions options)](#getImage-com.aspose.slides.IRenderingOptions-) | 返回缩略图位图对象。 |
| [getImage(IRenderingOptions options, float scaleX, float scaleY)](#getImage-com.aspose.slides.IRenderingOptions-float-float-) | 返回具有自定义缩放的缩略图位图对象。 |
| [getImage(IRenderingOptions options, Dimension imageSize)](#getImage-com.aspose.slides.IRenderingOptions-java.awt.Dimension-) | 返回具有指定大小的缩略图位图对象。 |
...
**返回 HeaderFooter 管理器。只读 [ISlideHeaderFooterManager](../../com.aspose.slides/islideheaderfootermanager)。**
...
**返回幻灯片的编号。[IPresentation.getSlides](../../com.aspose.slides/ipresentation\#getSlides) 集合中的幻灯片索引始终等于 SlideNumber - 1。可读写 int。**
...
**确定在幻灯片放映期间指定的幻灯片是否隐藏。可读写 boolean。**
...
**返回：**
[IImage](../../com.aspose.slides/iimage) - 图像对象 java.awt.image.BufferedImage
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| imageSize | java.awt.Dimension | 要创建的图像尺寸。 |

**返回：**
[IImage](../../com.aspose.slides/iimage) - 位图对象。
...
**返回：**
[IImage](../../com.aspose.slides/iimage) - 图像对象。
...
**返回：**
com.aspose.slides.IComment[] - [IComment](../../com.aspose.slides/icomment) 数组。
