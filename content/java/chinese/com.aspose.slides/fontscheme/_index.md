...
| 方法 | 描述 |
| --- | --- |
| [getMinor()](#getMinor--) | 返回幻灯片的“正文”部分的字体集合。 |
| [getMajor()](#getMajor--) | 返回幻灯片的“标题”部分的字体集合。 |
...
返回幻灯片的“正文”部分的字体集合。只读 [IFonts](../../com.aspose.slides/ifonts)。
...
返回幻灯片的“标题”部分的字体集合。只读 [IFonts](../../com.aspose.slides/ifonts)。
