...
| [hasTitle()](#hasTitle--) | 确定图表是否有可见标题。 |
| [setTitle(boolean value)](#setTitle-boolean-) | 确定图表是否有可见标题。 |
| [getChartTitle()](#getChartTitle--) | 返回或设置图表标题。 |
| [hasDataTable()](#hasDataTable--) | 确定图表是否有数据表。 |
| [setDataTable(boolean value)](#setDataTable-boolean-) | 确定图表是否有数据表。 |
| [hasLegend()](#hasLegend--) | 确定图表是否有图例。 |
| [setLegend(boolean value)](#setLegend-boolean-) | 确定图表是否有图例。 |
...
| [getPlotArea()](#getPlotArea--) | 表示图表的绘图区。 |
...
| [getFloor()](#getFloor--) | 返回一个对象，允许更改 3D 图表底部的格式。 |
...
| [hasRoundedCorners()](#hasRoundedCorners--) | 指定图表区域应有圆角。 |
| [setRoundedCorners(boolean value)](#setRoundedCorners-boolean-) | 指定图表区域应有圆角。 |
| [getChart()](#getChart--) |  |
...
确定是否仅绘制可见单元格。设置为 false 可绘制可见和隐藏的单元格。读写布尔值。
...
表示图表的绘图区。只读 [IChartPlotArea](../../com.aspose.slides/ichartplotarea)。
...
返回一个对象，允许更改 3D 图表底部的格式。只读 [IChartWall](../../com.aspose.slides/ichartwall)。
