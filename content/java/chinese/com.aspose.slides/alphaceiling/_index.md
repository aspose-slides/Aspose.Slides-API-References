...
表示 Alpha Ceiling 效果。Alpha（opacity）值大于零的将被更改为 100%。换句话说，任何部分不透明的对象将变为完全不透明。
## 方法

| 方法 | 描述 |
| --- | --- |
| [getEffective()](#getEffective--) | 获取在应用继承后有效的 Alpha Ceiling 效果数据。 |
...
获取在应用继承后有效的 Alpha Ceiling 效果数据。
