...
表示动画行为的属性类型。遵循以下属性列表自 https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx 和 https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx
## 方法
...
| [getPptX()](#getPptX--) | 表示 'ppt\_x' 属性 |
| [getPptY()](#getPptY--) | 表示 'ppt\_y' 属性 |
| [getPptW()](#getPptW--) | 表示 'ppt\_w' 属性 |
| [getPptH()](#getPptH--) | 表示 'ppt\_h' 属性 |
| [getPptC()](#getPptC--) | 表示 'ppt\_c' 属性 |
| [getPptR()](#getPptR--) | 表示 'ppt\_r' 属性 |
...
| [equals(Object obj)](#equals-java.lang.Object-) | 检查此对象是否等于另一个。 |
| [hashCode()](#hashCode--) | 根据 (\#getValue.getValue) 属性计算并返回哈希代码 |
| [getOrCreateByValue(String propertyValue)](#getOrCreateByValue-java.lang.String-) | 按值查找现有行为属性或使用指定值创建新的自定义属性 |
...
根据 (\#getValue.getValue) 属性计算并返回哈希码
