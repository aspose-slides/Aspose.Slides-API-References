...
type: docs
url: /zh/com.aspose.slides/pathcommandtype/
---
**继承:**
...
| --- | --- |
| [Close](#Close) | 关闭几何路径 |
| [MoveTo](#MoveTo) | 设置几何路径的下一个点位置 |
| [LineTo](#LineTo) | 向几何路径追加直线 |
| [ArcTo](#ArcTo) | 向几何路径追加指定的弧线。 |
| [QuadBezierTo](#QuadBezierTo) | 向几何路径追加二次贝塞尔曲线 |
| [CubicBezierTo](#CubicBezierTo) | 向几何路径追加三次贝塞尔曲线 |
### Close {#Close}
```
