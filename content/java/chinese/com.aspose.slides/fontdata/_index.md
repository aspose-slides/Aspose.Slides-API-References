...
| 构造函数 | 描述 |
| --- | --- |
| [FontData(String fontName)](#FontData-java.lang.String-) | 使用指定的字体名称创建新的 FontData 对象。 |
## 方法
...
| [hashCode()](#hashCode--) | 作为特定类型的哈希函数，可用于哈希算法和类似哈希表的数据结构。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| theme | [IThemeEffectiveData](../../com.aspose.slides/ithemeeffectivedata) | 应获取主题字体名称的主题。调用者需提供正确的值。参见 [IThemeable.createThemeEffective](../../com.aspose.slides/ithemeable\#createThemeEffective) |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| obj | java.lang.Object | 用于与当前 FontData 比较的 FontData。 |
...
作为特定类型的哈希函数，可用于哈希算法和类似哈希表的数据结构。
