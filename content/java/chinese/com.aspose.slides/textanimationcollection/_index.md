...
| [get_Item(int index)](#get-Item-int-) | 按索引返回元素。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | [IShape](../../com.aspose.slides/ishape) 用于移除。 |
...
**返回:**  
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ITextAnimation> - 整个集合的 java.util.Iterator。
