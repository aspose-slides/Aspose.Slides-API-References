...
| 方法 | 描述 |
| --- | --- |
| [getEffective()](#getEffective--) | 获取应用继承后的有效 Alpha Replace 效果数据。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| obj | java.lang.Object | 用于比较的 [AlphaReplace](../../com.aspose.slides/alphareplace)。 |
