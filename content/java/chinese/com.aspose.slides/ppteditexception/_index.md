...
type: docs
url: /zh/com.aspose.slides/ppteditexception/
---
**继承:**
...
| 构造函数 | 描述 |
| --- | --- |
| [PptEditException()](#PptEditException--) | 默认构造函数。 |
| [PptEditException(String message)](#PptEditException-java.lang.String-) | 允许向此异常添加消息的构造函数。 |
| [PptEditException(String message, RuntimeException exception)](#PptEditException-java.lang.String-java.lang.RuntimeException-) | 包含消息和嵌入异常的异常构造函数。 |
