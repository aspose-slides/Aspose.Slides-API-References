...
| 方法 | 描述 |
| --- | --- |
| [getRewindVideo()](#getRewindVideo--) | 确定视频是否在影片播放完毕后自动倒回到起始位置。 |
| [setRewindVideo(boolean value)](#setRewindVideo-boolean-) | 确定视频是否在影片播放完毕后自动倒回到起始位置。 |
...
确定视频是否在影片播放完毕后自动倒回到起始位置。读/写 boolean.
