...
| 构造函数 | 描述 |
| --- | --- |
| [OpenAIWebClient(String model, String apiKey, String organizationId)](#OpenAIWebClient-java.lang.String-java.lang.String-java.lang.String-) | 创建 OpenAI 网络客户端的实例。 |
| [OpenAIWebClient(String model, String apiKey, String organizationId, HttpURLConnection httpClient)](#OpenAIWebClient-java.lang.String-java.lang.String-java.lang.String-java.net.HttpURLConnection-) | 创建一个使用外部管理的 HttpClient 的 OpenAI 网络客户端实例。 |
## 方法
...
创建一个使用外部管理的 HttpClient 的 OpenAI 网络客户端实例。提供的 HttpClient 不会被此实例释放，仍归调用方所有。
...
使用提供的 HttpConnection 实例向 AI 模型发送聊天指令，并返回指令的响应消息。
