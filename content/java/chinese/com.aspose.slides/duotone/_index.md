...
表示 Duotone 效果。对每个像素，通过线性插值将 Color1 和 Color2 结合，以确定该像素的新颜色。
## 方法
...
| [getEffective()](#getEffective--) | 获取应用继承后的有效 Duotone 效果数据。 |
...
获取应用继承后的有效 Duotone 效果数据。

**返回：**
[IDuotoneEffectiveData](../../com.aspose.slides/iduotoneeffectivedata) - 一个 [IDuotoneEffectiveData](../../com.aspose.slides/iduotoneeffectivedata)。
### getVersion() {#getVersion--}
```
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| obj | java.lang.Object | 用于比较的 [Duotone](../../com.aspose.slides/duotone)。 |
