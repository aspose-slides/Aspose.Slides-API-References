...
| withAttachedRows | boolean | 若为 true，则还复制所有附加到模板行的行。 |
...
| withAttachedRows | boolean | 若为 true，则还删除所有附加的行。 |
...
**返回：**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IRow> - 整个集合的 java.util.Iterator。
