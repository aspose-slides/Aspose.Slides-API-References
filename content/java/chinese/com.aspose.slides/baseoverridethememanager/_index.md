...
description: 为提供访问不同类型覆盖主题的类提供的基类。
type: docs
...
| [applyColorScheme(IExtraColorScheme scheme)](#applyColorScheme-com.aspose.slides.IExtraColorScheme-) | 将额外配色方案应用于幻灯片。 |
...
返回覆盖主题对象。读/写 [IOverrideTheme](../../com.aspose.slides/ioverridetheme)。
...
确定 OverrideTheme 是否覆盖继承的有效主题。要启用 OverrideTheme 进行覆盖，请使用 OverrideTheme.Init*() 方法。要禁用 OverrideTheme 的覆盖，请使用 OverrideTheme.Clear() 方法。只读 boolean。
