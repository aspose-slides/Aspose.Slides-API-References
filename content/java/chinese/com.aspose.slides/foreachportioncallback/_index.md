...
| 方法 | 描述 |
| --- | --- |
| [invoke(Portion portion, Paragraph para, BaseSlide slide, int index)](#invoke-com.aspose.slides.Portion-com.aspose.slides.Paragraph-com.aspose.slides.BaseSlide-int-) | 在 [BaseSlide](../../com.aspose.slides/baseslide) 上为每个 \#paragraph(Presentation,ForEachParagraphCallback).paragraph(Presentation,ForEachParagraphCallback) 调用的回调。 |
...
在 [BaseSlide](../../com.aspose.slides/baseslide) 上为每个 \#paragraph(Presentation,ForEachParagraphCallback).paragraph(Presentation,ForEachParagraphCallback) 调用的回调。
