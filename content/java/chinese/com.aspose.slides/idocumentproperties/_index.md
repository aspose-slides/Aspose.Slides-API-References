...
| [getManager()](#getManager--) | 返回或设置管理者属性。 |
| [setManager(String value)](#setManager-java.lang.String-) | 返回或设置管理者属性。 |
...
| [getLastSavedBy()](#getLastSavedBy--) | 返回或设置最后修改演示文稿的人员姓名。 |
| [setLastSavedBy(String value)](#setLastSavedBy-java.lang.String-) | 返回或设置最后修改演示文稿的人员姓名。 |
...
| [getHyperlinksChanged()](#getHyperlinksChanged--) | 指定此部分中的一个或多个超链接仅由此部分的生成者更新。 |
| [setHyperlinksChanged(boolean value)](#setHyperlinksChanged-boolean-) | 指定此部分中的一个或多个超链接仅由此部分的生成者更新。 |
| [getSlides()](#getSlides--) | 指定演示文稿文档中的幻灯片总数。 |
| [getHiddenSlides()](#getHiddenSlides--) | 指定演示文稿文档中隐藏的幻灯片数量。 |
| [getNotes()](#getNotes--) | 指定包含备注的演示文稿幻灯片数量。 |
| [getParagraphs()](#getParagraphs--) | 指定文档中找到的段落总数（如果适用）。 |
| [getWords()](#getWords--) | 指定文档中包含的单词总数。 |
| [getMultimediaClips()](#getMultimediaClips--) | 指定文档中存在的声音或视频剪辑的总数。 |
| [getTitlesOfParts()](#getTitlesOfParts--) | 指定每个文档部分的标题。 |
| [getHeadingPairs()](#getHeadingPairs--) | 指示文档部分的分组以及每组的部分数量。 |
...
| [containsCustomProperty(String name)](#containsCustomProperty-java.lang.String-) | 检查具有指定名称的自定义属性是否存在。 |
...
| [getCustomPropertyValue(String name, boolean[] value)](#getCustomPropertyValue-java.lang.String-boolean---) | 从自定义属性中获取具名布尔值。 |
| [getCustomPropertyValue(String name, int[] value)](#getCustomPropertyValue-java.lang.String-int---) | 从自定义属性中获取具名整数值。 |
| [getCustomPropertyValue(String name, Date[] value)](#getCustomPropertyValue-java.lang.String-java.util.Date---) | 从自定义属性中获取具名日期时间值。 |
| [getCustomPropertyValue(String name, String[] value)](#getCustomPropertyValue-java.lang.String-java.lang.String---) | 从自定义属性中获取具名字符串值。 |
| [getCustomPropertyValue(String name, float[] value)](#getCustomPropertyValue-java.lang.String-float---) | 从自定义属性中获取具名浮点值。 |
| [getCustomPropertyValue(String name, double[] value)](#getCustomPropertyValue-java.lang.String-double---) | 从自定义属性中获取具名双精度值。 |
...
| [setCustomPropertyValue(String name, Date value)](#setCustomPropertyValue-java.lang.String-java.util.Date-) | 设置具名日期时间自定义属性。 |
| [setCustomPropertyValue(String name, String value)](#setCustomPropertyValue-java.lang.String-java.lang.String-) | 设置具名字符串自定义属性。 |
| [setCustomPropertyValue(String name, float value)](#setCustomPropertyValue-java.lang.String-float-) | 设置具名浮点自定义属性。 |
| [setCustomPropertyValue(String name, double value)](#setCustomPropertyValue-java.lang.String-double-) | 设置具名双精度自定义属性。 |
| [getSensitivityLabels()](#getSensitivityLabels--) | 获取自定义文档属性中的敏感度标签数组（Microsoft Information Protection SDK 元数据）。 |
...
此元素的内容应采用 XX.YYYY 形式，其中 X 和 Y 代表数值；否则，文档将被视为不合规。Aspose.Slides 以 XX.YY.ZZ 格式表示其版本，其中：XX - 主版本号 YY - 次版本号 ZZ - 补丁版本号。例如，值 23.0105 表示 Aspose.Slides 版本 23.1.5。
...
返回演示文稿创建的日期。值为 UTC 时间。读/写 java.util.Date。
...
返回演示文稿最后一次修改的日期。值为 UTC 时间。在 Presentation.DocumentProperties 情况下为只读（因为在 IPresentation 对象保存过程内部会更新）。可以通过方法 [IPresentationInfo.readDocumentProperties](../../com.aspose.slides/ipresentationinfo\#readDocumentProperties) 返回的 DocumentProperties 实例进行更改。请参阅 [IPresentationInfo.updateDocumentProperties(IDocumentProperties)](../../com.aspose.slides/ipresentationinfo\#updateDocumentProperties-IDocumentProperties-) 方法摘要中的示例。
...
返回演示文稿上次打印的日期。读/写 java.util.Date。
...
返回或设置最后一次修改演示文稿的人的名称。读/写 String。
...
返回或设置 HyperlinkBase 文档属性。读/写 String。
...
指示文档缩略图的显示模式。将此元素设为 **true** 可对文档缩略图进行缩放以适应显示。将此元素设为 **false** 可裁剪文档缩略图，仅显示适合显示的部分。读/写 boolean。
...
指示文档中的超链接是否是最新的。将此元素设为 **true** 表示已更新超链接。将此元素设为 **false** 表示超链接已过期。读/写 boolean。
...
指定此部分中的一个或多个超链接仅在本部分由生产者更新。下一个打开此文档的生产者应使用本部分中指定的新超链接更新超链接关系。读/写 boolean。
...
指定每个文档部分的标题。这些部分不是文档部分，而是文档章节的概念性表示。只读 String[]。
...
指示文档部分的分组以及每组中的部分数。只读 IHeadingPair[]。
...
**返回：**
boolean - 如果属性被移除则返回 true，否则返回 false。
...
**返回：**
boolean - 如果属性存在则返回 true，否则返回 false。
### get_Item(String name) {#get-Item-java.lang.String-}
```
public abstract Object get_Item(String name)
```

返回或设置与指定名称关联的自定义属性。读/写 Object。
...
| name | java.lang.String | 要获取的自定义属性的名称 |
| value | double[] | 自定义属性值 |
| name | java.lang.String | 获取的自定义属性的名称。 |
| value | double[] | 自定义属性值 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| name | java.lang.String | 设置的自定义属性的名称 |
| value | boolean | 自定义属性值 |
