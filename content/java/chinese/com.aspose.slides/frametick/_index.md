...
description: 表示 FrameTickDelegate.FrameTickDelegate 事件的帧滴处理程序。
type: docs
url: /zh/com.aspose.slides/presentationplayer.frametick/
---```
public static interface PresentationPlayer.FrameTick
```

表示 FrameTickDelegate.FrameTickDelegate 事件的帧滴处理程序。
## 方法
