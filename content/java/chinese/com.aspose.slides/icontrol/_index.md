...
| [getClassId()](#getClassId--) | 获取此控件的类 ID。 |
...
| [getActiveXControlBinary()](#getActiveXControlBinary--) | 指定当持久化方法为 PersistStream、PersistStreamInit 或 PersistStorage 时 ActiveX 控件的持久化方式。 |
### getName() {#getName--}
```
...
指定当持久化方法为 PersistStream、PersistStreamInit 或 PersistStorage 时 ActiveX 控件的持久化方式。
