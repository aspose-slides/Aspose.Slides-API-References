...
| 方法 | 描述 |
| --- | --- |
| [getConformance()](#getConformance--) | 指定演示文稿符合的兼容类。 |
| [setConformance(int value)](#setConformance-int-) | 指定演示文稿符合的兼容类。 |
| [getZip64Mode()](#getZip64Mode--) | 指定演示文稿是否使用 ZIP64 格式。 |
| [setZip64Mode(int value)](#setZip64Mode-int-) | 指定演示文稿是否使用 ZIP64 格式。 |
...
指定演示文稿符合的兼容类。默认值为 [Conformance.Ecma376\_2006](../../com.aspose.slides/conformance\#Ecma376-2006)
...
指定演示文稿是否使用 ZIP64 格式。默认值为 [Zip64Mode.IfNecessary](../../com.aspose.slides/zip64mode\#IfNecessary)
