...
type: docs
url: /zh/com.aspose.slides/shapeelementfillsource/
---
**继承:**
...
| 字段 | 描述 |
| --- | --- |
| [NoFill](#NoFill) | 不要填充原始对象。 |
| [Shape](#Shape) | 使用形状的填充。 |
| [Lighten](#Lighten) | 使用变亮形状的填充。 |
| [LightenLess](#LightenLess) | 使用较少变亮形状的填充。 |
| [Darken](#Darken) | 使用变暗形状的填充。 |
| [DarkenLess](#DarkenLess) | 使用较少变暗形状的填充。 |
### NoFill {#NoFill}
```
