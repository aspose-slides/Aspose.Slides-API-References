...
表示一种颜色替换效果。所有效果颜色都将更改为固定颜色。Alpha 值不受影响。
...
**返回:**
[IColorReplaceEffectiveData](../../com.aspose.slides/icolorreplaceeffectivedata) - 一个 [IColorReplaceEffectiveData](../../com.aspose.slides/icolorreplaceeffectivedata)。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| obj | java.lang.Object | 用于比较的 [ColorReplace](../../com.aspose.slides/colorreplace)。 |
