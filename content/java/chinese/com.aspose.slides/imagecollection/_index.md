...
| [addImage(InputStream stream, int loadingStreamBehavior)](#addImage-java.io.InputStream-int-) | 从流创建并向演示文稿添加图像。 |
| [addImage(byte[] buffer)](#addImage-byte---) | 向演示文稿添加图像。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| stream | java.io.InputStream | 要从中添加图像的流。

--------------------

此方法可以在不将 WMF/EMF 元文件转换为光栅 PNG 图像的情况下将其添加到演示文稿。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| stream | java.io.InputStream | 要从中添加图像文件的流。 |
...
**返回：**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IPPImage> - java.util.Iterator，用于遍历整个集合。
