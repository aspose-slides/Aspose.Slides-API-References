...
| [getEffective()](#getEffective--) | 获取在应用继承后的有效 Inner Shadow 效果数据。 |
...
| Parameter | Type | Description |
| --- | --- | --- |
| obj | java.lang.Object | 用于比较的 [InnerShadow](../../com.aspose.slides/innershadow)。 |
