...
description: 代表来自 Microsoft Purview 信息保护的敏感度标签。
type: docs
...
代表来自 Microsoft Purview 信息保护的敏感度标签。
## 方法
...
| [getSiteId()](#getSiteId--) | 返回或设置与描述该敏感度标签的敏感度标签策略对应的 Azure Active Directory（Azure AD）站点标识符。 |
| [setSiteId(UUID value)](#setSiteId-java.util.UUID-) | 返回或设置与描述该敏感度标签的敏感度标签策略对应的 Azure Active Directory（Azure AD）站点标识符。 |
...
返回或设置与描述该敏感度标签的敏感度标签策略对应的 Azure Active Directory（Azure AD）站点标识符。读/写 java.util.UUID。
