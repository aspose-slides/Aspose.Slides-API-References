...
| [setStartPosAlpha(float value)](#setStartPosAlpha-float-) | 指定起始 alpha 值（百分比）的起始位置（沿 alpha 梯度坡道）。 |
| [getEndPosAlpha()](#getEndPosAlpha--) | 指定结束 alpha 值（百分比）的结束位置（沿 alpha 梯度坡道）。 |
| [setEndPosAlpha(float value)](#setEndPosAlpha-float-) | 指定结束 alpha 值（百分比）的结束位置（沿 alpha 梯度坡道）。 |
...
| [getRotateShadowWithShape()](#getRotateShadowWithShape--) | 指定当形状旋转时反射是否随形状旋转。 |
| [setRotateShadowWithShape(boolean value)](#setRotateShadowWithShape-boolean-) | 指定当形状旋转时反射是否随形状旋转。 |
| [getScaleHorizontal()](#getScaleHorizontal--) | 指定水平缩放因子，负值会导致翻转。 |
| [setScaleHorizontal(double value)](#setScaleHorizontal-double-) | 指定水平缩放因子，负值会导致翻转。 |
| [getScaleVertical()](#getScaleVertical--) | 指定垂直缩放因子，负值会导致翻转。 |
| [setScaleVertical(double value)](#setScaleVertical-double-) | 指定垂直缩放因子，负值会导致翻转。 |
| [getEffective()](#getEffective--) | 获取应用继承后的有效 Reflection 效果数据。 |
| [getParent_Immediate()](#getParent-Immediate--) |  |
| [getVersion()](#getVersion--) |  |
| [getParent_IPresentationComponent()](#getParent-IPresentationComponent--) |  |
| [equals(Object obj)](#equals-java.lang.Object-) | 确定指定的 [Reflection](../../com.aspose.slides/reflection) 是否等于当前的 [Reflection](../../com.aspose.slides/reflection)。 |
...
指定起始 alpha 值（百分比）的起始位置（沿 alpha 梯度坡道）。读取/写入 float。
...
指定结束 alpha 值（百分比）的结束位置（沿 alpha 梯度坡道）。读取/写入 float。
...
矩形对齐方式。读取/写入 [RectangleAlignment](../../com.aspose.slides/rectanglealignment)。
...
指定当形状旋转时反射是否随形状旋转。读取/写入 boolean。
...
指定水平缩放因子，负值会导致翻转。（百分比）读取/写入 double。
...
指定垂直缩放因子，负值会导致翻转。（百分比）读取/写入 double。
...
获取应用继承后的有效 Reflection 效果数据。

**返回值：**
[IReflectionEffectiveData](../../com.aspose.slides/ireflectioneffectivedata) - 一个 [IReflectionEffectiveData](../../com.aspose.slides/ireflectioneffectivedata)。
### getParent_Immediate() {#getParent-Immediate--}
```
...
确定指定的 [Reflection](../../com.aspose.slides/reflection) 是否等于当前的 [Reflection](../../com.aspose.slides/reflection)。

**参数：**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| obj | java.lang.Object | 要比较的 [Reflection](../../com.aspose.slides/reflection)。 |
