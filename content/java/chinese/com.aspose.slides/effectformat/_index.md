...
type: docs
url: /zh/com.aspose.slides/effectformat/
---
**继承：** java.lang.Object, [com.aspose.slides.PVIObject](../../com.aspose.slides/pviobject)
...
| [isNoEffects()](#isNoEffects--) | 返回 true，如果所有效果均已禁用（如刚创建的默认 EffectFormat 对象）。 |
...
| [setSoftEdgeEffect(ISoftEdge value)](#setSoftEdgeEffect-com.aspose.slides.ISoftEdge-) | 柔边。 |
...
| [enableSoftEdgeEffect()](#enableSoftEdgeEffect--) | 启用柔边效果。 |
...
| [disableSoftEdgeEffect()](#disableSoftEdgeEffect--) | 禁用柔边效果。 |
...
返回 true，如果所有效果均已禁用（如刚创建的默认 EffectFormat 对象）。只读 boolean 。
...
柔边。可读写 [ISoftEdge](../../com.aspose.slides/isoftedge)。
...
**返回：**
[IEffectFormatEffectiveData](../../com.aspose.slides/ieffectformateffectivedata) - 一个 [IEffectFormatEffectiveData](../../com.aspose.slides/ieffectformateffectivedata).