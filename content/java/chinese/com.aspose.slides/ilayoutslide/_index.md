...
| [getDrawingGuides()](#getDrawingGuides--) | 返回布局幻灯片的绘图参考线集合。 |
...
**返回：**
com.aspose.slides.ISlide[] - 包含所有依赖此布局幻灯片的幻灯片的数组
### remove() {#remove--}
```
...
返回布局幻灯片的绘图参考线集合。只读 [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
