...
description: 当演示文稿文件可能已损坏时抛出的异常。
type: docs
url: /zh/com.aspose.slides/pptxcorruptfileexception/
---
**继承：**
...
| 构造函数 | 描述 |
| --- | --- |
| [PptxCorruptFileException()](#PptxCorruptFileException--) | 默认构造函数。 |
| [PptxCorruptFileException(String message)](#PptxCorruptFileException-java.lang.String-) | 允许向此异常添加消息的构造函数。 |
| [PptxCorruptFileException(String message, RuntimeException exception)](#PptxCorruptFileException-java.lang.String-java.lang.RuntimeException-) | 包含消息和内部异常的异常的构造函数。 |
