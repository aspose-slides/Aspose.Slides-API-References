...
| [getTileFlip()](#getTileFlip--) | 返回或设置渐变的翻转模式。 |
| [setTileFlip(int value)](#setTileFlip-int-) | 返回或设置渐变的翻转模式。 |
| [getGradientDirection()](#getGradientDirection--) | 返回或设置渐变的样式。 |
| [setGradientDirection(int value)](#setGradientDirection-int-) | 返回或设置渐变的样式。 |
| [getLinearGradientAngle()](#getLinearGradientAngle--) | 返回或设置渐变的角度。 |
| [setLinearGradientAngle(float value)](#setLinearGradientAngle-float-) | 返回或设置渐变的角度。 |
| [getLinearGradientScaled()](#getLinearGradientScaled--) | 确定渐变是否被缩放。 |
| [setLinearGradientScaled(byte value)](#setLinearGradientScaled-byte-) | 确定渐变是否被缩放。 |
| [getGradientShape()](#getGradientShape--) | 返回或设置渐变的形状。 |
| [setGradientShape(byte value)](#setGradientShape-byte-) | 返回或设置渐变的形状。 |
...
返回或设置渐变的翻转模式。读/写 [TileFlip](../../com.aspose.slides/tileflip)。
...
返回或设置渐变的样式。读/写 [GradientDirection](../../com.aspose.slides/gradientdirection)。
...
确定渐变是否被缩放。读/写 [NullableBool](../../com.aspose.slides/nullablebool)。
...
返回或设置渐变的形状。读/写 [GradientShape](../../com.aspose.slides/gradientshape)。
...
返回渐变停止点的集合。只读 [IGradientStopCollection](../../com.aspose.slides/igradientstopcollection)。
