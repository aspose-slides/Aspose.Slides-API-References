...
description: 通过其 ChartType 获取图表和系列的附加信息的帮助类。
type: docs
...
用于通过其 ChartType 获取有关图表和系列的附加信息的帮助类。
...
| 方法 | 描述 |
| --- | --- |
| [isBar3DChart(int chartType)](#isBar3DChart-int-) | 如果 chartType 是 bar3DChart 子类型之一（3D 列或条形），则返回 true。 |
| [is2DChart(int chartType)](#is2DChart-int-) | 如果 chartType 是 2D 图表类型之一，则返回 true。 |
| [is3DChart(int chartType)](#is3DChart-int-) | 如果 chartType 是 3D 图表类型之一，则返回 true。 |
| [isChartTypeColumn(int chartType)](#isChartTypeColumn-int-) | 如果 chartType 是 Column 子类型之一，则返回 true。 |
| [isChartTypeLine(int chartType)](#isChartTypeLine-int-) | 如果 chartType 是 Line 子类型之一，则返回 true。 |
| [isChartTypePie(int chartType)](#isChartTypePie-int-) | 如果 chartType 是 Pie 子类型之一，则返回 true。 |
| [isChartTypeBar(int chartType)](#isChartTypeBar-int-) | 如果 chartType 是 Bar 子类型之一，则返回 true。 |
| [isChartTypeArea(int chartType)](#isChartTypeArea-int-) | 如果 chartType 是 Area 子类型之一，则返回 true。 |
| [isChartTypeScatter(int chartType)](#isChartTypeScatter-int-) | 如果 chartType 是 Scatter 子类型之一，则返回 true。 |
| [isChartTypeStock(int chartType)](#isChartTypeStock-int-) | 如果 chartType 是 Stock 子类型之一，则返回 true。 |
| [isChartTypeSurface(int chartType)](#isChartTypeSurface-int-) | 如果 chartType 是 Surface 子类型之一，则返回 true。 |
| [isChartTypeDoughnut(int chartType)](#isChartTypeDoughnut-int-) | 如果 chartType 是 Doughnut 子类型之一，则返回 true。 |
| [isChartTypeBubble(int chartType)](#isChartTypeBubble-int-) | 如果 chartType 是 Bubble 子类型之一，则返回 true。 |
| [isChartTypeRadar(int chartType)](#isChartTypeRadar-int-) | 如果 chartType 是 Radar 子类型之一，则返回 true。 |
| [isSeriesUsesXValueCoordinate(int seriesType)](#isSeriesUsesXValueCoordinate-int-) | 如果指定的 series type 使用 X 值坐标，则返回 true。 |
| [isSeriesUsesYValueCoordinate(int seriesType)](#isSeriesUsesYValueCoordinate-int-) | 如果指定的 series type 使用 Y 值坐标，则返回 true。 |
| [isSeriesUsesValueCoordinate(int seriesType)](#isSeriesUsesValueCoordinate-int-) | 如果指定的 series type 使用值坐标，则返回 true。 |
| [isSeriesUsesBubbleSizeCoordinate(int seriesType)](#isSeriesUsesBubbleSizeCoordinate-int-) | 如果可以为指定的 series type 使用气泡大小坐标，则返回 true。 |
| [hasSeriesTrendLines(int seriesType)](#hasSeriesTrendLines-int-) | 如果指定的 series type 存在系列趋势线，则返回 true。 |
| [isErrorBarsXAllowed(int seriesType)](#isErrorBarsXAllowed-int-) | 如果指定的 series type 允许 X 误差线，则返回 true。 |
| [isErrorBarsYAllowed(int seriesType)](#isErrorBarsYAllowed-int-) | 如果指定的 series type 允许 Y 误差线，则返回 true。 |
...
如果 chartType 是 bar3DChart 子类型之一（3D 列或条形），则返回 true。
...
如果 chartType 是 Doughnut 子类型之一。子类型集合对应 PowerPoint 中的相应集合（请参阅 PowerPoint 中的“更改图表类型”对话框）：[ChartType.Doughnut](../../com.aspose.slides/charttype\#Doughnut), [ChartType.ExplodedDoughnut](../../com.aspose.slides/charttype\#ExplodedDoughnut)。
...
如果 chartType 是 Bubble 子类型之一。子类型集合对应 PowerPoint 中的相应集合（请参阅 PowerPoint 中的“更改图表类型”对话框）：[ChartType.Bubble](../../com.aspose.slides/charttype\#Bubble), [ChartType.BubbleWith3D](../../com.aspose.slides/charttype\#BubbleWith3D)。
...
如果 chartType 是 Radar 子类型之一。子类型集合对应 PowerPoint 中的相应集合（请参阅 PowerPoint 中的“更改图表类型”对话框）：[ChartType.FilledRadar](../../com.aspose.slides/charttype\#FilledRadar), [ChartType.Radar](../../com.aspose.slides/charttype\#Radar), [ChartType.RadarWithMarkers](../../com.aspose.slides/charttype\#RadarWithMarkers)。
...
如果指定的 series type 使用 X 值坐标，则返回 true。
...
如果指定的 series type 使用 Y 值坐标，则返回 true。
...
如果指定的 series type 使用值坐标，则返回 true。
...
如果可以为指定的 series type 使用气泡大小坐标，则返回 true。
...
如果指定的 series type 存在系列趋势线，则返回 true。
...
如果指定的 series type 允许 X 误差线，则返回 true。
...
如果指定的 series type 允许 Y 误差线，则返回 true。
