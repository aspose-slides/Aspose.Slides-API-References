...
| [get_Item(int index)](#get-Item-int-) | 按索引返回布局幻灯片。 |
...
按索引返回布局幻灯片。只读 [LayoutSlide](../../com.aspose.slides/layoutslide)。
...
**返回：**  
[ILayoutSlide](../../com.aspose.slides/ilayoutslide) - [LayoutSlide](../../com.aspose.slides/layoutslide) 具有指定类型的布局幻灯片，若未找到则返回 null。
...
**返回：**  
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ILayoutSlide> - 用于整个集合的 java.util.Iterator。
