...
指定图表元素相对于图表左上角的实际 x 位置（左）。在获取实际值前请调用 IChart.validateChartLayout() 方法。只读 float。
...
指定图表元素相对于图表左上角的实际顶部位置。在获取实际值前请调用 IChart.validateChartLayout() 方法。只读 float。
...
指定图表元素的实际宽度。在获取实际值前请调用 IChart.validateChartLayout() 方法。只读 float。
...
指定图表元素的实际高度。在获取实际值前请调用 IChart.validateChartLayout() 方法。只读 float。
