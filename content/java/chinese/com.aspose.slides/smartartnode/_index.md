...
| 方法 | 描述 |
| --- | --- |
| [getChildNodes()](#getChildNodes--) | 返回当前节点的所有子节点集合。 |
| [getShapes()](#getShapes--) | 返回与节点关联的所有形状集合。 |
| [getTextFrame()](#getTextFrame--) | 返回节点的文本框。 |
| [isAssistant()](#isAssistant--) | 返回或设置节点为 assistant。 |
| [setAssistant(boolean value)](#setAssistant-boolean-) | 返回或设置节点为 assistant。 |
...
| [getOrganizationChartLayout()](#getOrganizationChartLayout--) | 返回或设置当前节点关联的组织结构图布局类型。 |
| [setOrganizationChartLayout(int value)](#setOrganizationChartLayout-int-) | 返回或设置当前节点关联的组织结构图布局类型。 |
...
返回当前节点的所有子节点集合。只读 [ISmartArtNodeCollection](../../com.aspose.slides/ismartartnodecollection)。
...
返回与节点关联的所有形状集合。只读 [ISmartArtShapeCollection](../../com.aspose.slides/ismartartshapecollection)。
...
返回包含节点项目符号填充格式属性的 FillFormat 对象。注：对于某些不为节点提供项目符号的 SmartArt 布局类型，可能返回 null。只读 [IFillFormat](../../com.aspose.slides/ifillformat)。
...
返回或设置当前节点关联的组织结构图布局类型。读写 [OrganizationChartLayoutType](../../com.aspose.slides/organizationchartlayouttype)。
...
**返回：**
boolean - 如果成功移除则为 true，否则为 false