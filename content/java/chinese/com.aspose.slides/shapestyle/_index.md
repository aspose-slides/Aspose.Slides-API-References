...
返回或设置样式矩阵中形状的填充列索引。0 表示无填充，正值 - 主题填充样式索引，负值 - 主题背景样式索引。读写 short。
...
返回或设置字体集合中形状的字体索引。读写 [FontCollectionIndex](../../com.aspose.slides/fontcollectionindex)。
