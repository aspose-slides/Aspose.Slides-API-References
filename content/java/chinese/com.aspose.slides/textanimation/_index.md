...
| [getEffectAnimateBackgroundShape()](#getEffectAnimateBackgroundShape--) | 带组或不带组的链接形状效果（null）。 |
| [setEffectAnimateBackgroundShape(IEffect value)](#setEffectAnimateBackgroundShape-com.aspose.slides.IEffect-) | 带组或不带组的链接形状效果（null）。 |
...
文本动画的构建类型列表（例如段落 1、2、3、一次性）。读/写 [BuildType](../../com.aspose.slides/buildtype)。
...
带组或不带组的链接形状效果（null）。读/写 [IEffect](../../com.aspose.slides/ieffect)。
