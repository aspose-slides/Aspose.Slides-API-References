...
| [getLinearGradientScaled()](#getLinearGradientScaled--) | 确定梯度是否被缩放。 |
| [setLinearGradientScaled(byte value)](#setLinearGradientScaled-byte-) | 确定梯度是否被缩放。 |
...
确定梯度是否被缩放。读/写 [NullableBool](../../com.aspose.slides/nullablebool)。
