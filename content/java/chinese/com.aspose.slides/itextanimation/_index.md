...
| 方法 | 描述 |
| --- | --- |
| [addEffect(int effectType, int subtype, int triggerType)](#addEffect-int-int-int-) | 在当前序列的末尾添加新的效果到组文本动画的末尾。 |
| [getBuildType()](#getBuildType--) | 构建类型列表（例如 |
| [setBuildType(int value)](#setBuildType-int-) | 构建类型列表（例如 |
| [getEffectAnimateBackgroundShape()](#getEffectAnimateBackgroundShape--) | 链接的形状效果，可带组或不带组（null），读/写 [IEffect](../../com.aspose.slides/ieffect)。 |
| [setEffectAnimateBackgroundShape(IEffect value)](#setEffectAnimateBackgroundShape-com.aspose.slides.IEffect-) | 链接的形状效果，可带组或不带组（null），读/写 [IEffect](../../com.aspose.slides/ieffect)。 |
### addEffect(int effectType, int subtype, int triggerType) {#addEffect-int-int-int-}
```
public abstract IEffect addEffect(int effectType, int subtype, int triggerType)
```

在当前序列的末尾添加新的效果到组文本动画的末尾。仅当文本段落的计数大于或等于该组效果的计数时有效！
...
文本动画的构建类型列表（例如段落 1、2、3、一次全部）。读/写 \#getBuildType.getBuildType/\#setBuildType(int).setBuildType(int)。
...
链接的形状效果，可带组或不带组（null），读/写 [IEffect](../../com.aspose.slides/ieffect)。
