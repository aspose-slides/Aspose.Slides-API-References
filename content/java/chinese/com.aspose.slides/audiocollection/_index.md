...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| stream | java.io.InputStream | 用于添加音频的流。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| stream | java.io.InputStream | 用于添加视频音频的流。 |
...
#### 返回：
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IAudio> - 可用于遍历集合的 IGenericEnumerator。
...
#### 返回：
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IAudio> - 整个集合的 java.util.Iterator。