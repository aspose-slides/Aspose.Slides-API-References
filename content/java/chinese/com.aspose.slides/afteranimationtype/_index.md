...
description: 表示动画效果的后置动画类型。
type: docs
url: /zh/com.aspose.slides/afteranimationtype/
---
**继承:**  
...
| 字段 | 描述 |
| --- | --- |
| [DoNotDim](#DoNotDim) | 动画后不变暗类型。 |
| [Color](#Color) | 动画后颜色类型。 |
| [HideAfterAnimation](#HideAfterAnimation) | 动画后隐藏类型 |
| [HideOnNextMouseClick](#HideOnNextMouseClick) | 下一次鼠标点击后隐藏类型。 |
### DoNotDim {#DoNotDim}
```
