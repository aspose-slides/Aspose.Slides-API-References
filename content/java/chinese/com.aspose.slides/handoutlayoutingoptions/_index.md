...
| 方法 | 描述 |
| --- | --- |
| [getHandout()](#getHandout--) | 指定在页面 [HandoutType](../../com.aspose.slides/handouttype) 上放置多少张幻灯片以及顺序。 |
| [setHandout(int value)](#setHandout-int-) | 指定在页面 [HandoutType](../../com.aspose.slides/handouttype) 上放置多少张幻灯片以及顺序。 |
...
| [getPrintComments()](#getPrintComments--) | 指定是否在幻灯片上显示注释 |
| [setPrintComments(boolean value)](#setPrintComments-boolean-) | 指定是否在幻灯片上显示注释 |
...
指定在页面 [HandoutType](../../com.aspose.slides/handouttype) 上放置多少张幻灯片以及顺序。
