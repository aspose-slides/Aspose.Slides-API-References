...
| 方法 | 描述 |
| --- | --- |
| [getFillType()](#getFillType--) | 返回填充的类型。 |
| [getSolidFillColor()](#getSolidFillColor--) | 返回填充颜色。 |
| [getSolidFillSchemeColor()](#getSolidFillSchemeColor--) | 获取由配色方案定义的填充颜色。 |
...
返回填充的类型。只读 [FillType](../../com.aspose.slides/filltype)。
...
获取由配色方案定义的填充颜色。[SchemeColor.NotDefined](../../com.aspose.slides/schemecolor\#NotDefined) 值表示 SolidFillColor (\#getSolidFillColor.getSolidFillColor) 不是方案颜色。只读 [SchemeColor](../../com.aspose.slides/schemecolor)。
