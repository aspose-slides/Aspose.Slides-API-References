...
| [getItemId()](#getItemId--) | 指定全局唯一标识符 (GUID)，该标识符唯一标识 Office Open XML 文档中的单个自定义 XML 部分。 |
| [setItemId(UUID value)](#setItemId-java.util.UUID-) | 指定全局唯一标识符 (GUID)，该标识符唯一标识 Office Open XML 文档中的单个自定义 XML 部分。 |
...
指定全局唯一标识符 (GUID)，该标识符唯一标识 Office Open XML 文档中的单个自定义 XML 部分。只读 java.util.UUID。
