...
| [addChart(int type, float x, float y, float width, float height)](#addChart-int-float-float-float-float-) | 创建一个新图表，使用示例系列数据和设置进行初始化，并将其添加到形状集合的末尾。 |
| [addChart(int type, float x, float y, float width, float height, boolean initWithSample)](#addChart-int-float-float-float-float-boolean-) | 创建一个新图表，使用示例系列数据和设置进行初始化，并将其添加到形状集合的末尾。 |
...
| [insertChart(int type, float x, float y, float width, float height, int index)](#insertChart-int-float-float-float-float-int-) | 创建一个新图表，使用示例系列数据和设置进行初始化，并将其插入到形状集合的指定索引处。 |
| [insertChart(int type, float x, float y, float width, float height, int index, boolean initWithSample)](#insertChart-int-float-float-float-float-int-boolean-) | 创建一个新图表，使用示例系列数据和设置进行初始化，并将其插入到形状集合的指定索引处。 |
...
| [insertZoomFrame(int index, float x, float y, float width, float height, ISlide slide)](#insertZoomFrame-int-float-float-float-float-com.aspose.slides.ISlide-) | 创建一个新的 Zoom 框架并将其插入到形状集合的指定索引处。 |
| [insertZoomFrame(int index, float x, float y, float width, float height, ISlide slide, IPPImage image)](#insertZoomFrame-int-float-float-float-float-com.aspose.slides.ISlide-com.aspose.slides.IPPImage-) | 使用预定义图像创建一个新的 Zoom 框架，并将其插入到形状集合的指定索引处。 |
| [addSectionZoomFrame(float x, float y, float width, float height, ISection section)](#addSectionZoomFrame-float-float-float-float-com.aspose.slides.ISection-) | 创建一个新的章节 Zoom 框架并将其添加到形状集合的末尾。 |
| [addSectionZoomFrame(float x, float y, float width, float height, ISection section, IPPImage image)](#addSectionZoomFrame-float-float-float-float-com.aspose.slides.ISection-com.aspose.slides.IPPImage-) | 使用预定义图像创建一个新的章节 Zoom 框架并将其添加到形状集合的末尾。 |
| [insertSectionZoomFrame(int index, float x, float y, float width, float height, ISection section)](#insertSectionZoomFrame-int-float-float-float-float-com.aspose.slides.ISection-) | 创建一个新的章节 Zoom 框架并将其插入到形状集合的指定索引处。 |
| [insertSectionZoomFrame(int index, float x, float y, float width, float height, ISection section, IPPImage image)](#insertSectionZoomFrame-int-float-float-float-float-com.aspose.slides.ISection-com.aspose.slides.IPPImage-) | 使用预定义图像创建一个新的章节 Zoom 框架并将其插入到形状集合的指定索引处。 |
| [addSummaryZoomFrame(float x, float y, float width, float height)](#addSummaryZoomFrame-float-float-float-float-) | 创建一个新的摘要 Zoom 框架并将其添加到形状集合的末尾。 |
| [insertSummaryZoomFrame(int index, float x, float y, float width, float height)](#insertSummaryZoomFrame-int-float-float-float-float-) | 创建一个新的摘要 Zoom 框架并将其插入到形状集合的指定索引处。 |
...
| [insertOleObjectFrame(int index, float x, float y, float width, float height, IOleEmbeddedDataInfo dataInfo)](#insertOleObjectFrame-int-float-float-float-float-com.aspose.slides.IOleEmbeddedDataInfo-) | 创建一个新的 OLE 对象框架并将其插入到形状集合的指定索引处。 |
| [insertOleObjectFrame(int index, float x, float y, float width, float height, String className, String path)](#insertOleObjectFrame-int-float-float-float-float-java.lang.String-java.lang.String-) | 创建一个新的 OLE 对象框架并将其插入到形状集合的指定索引处。 |
| [addVideoFrame(float x, float y, float width, float height, String fname)](#addVideoFrame-float-float-float-float-java.lang.String-) | 创建一个新视频框架并将其添加到形状集合的末尾。 |
| [addVideoFrame(float x, float y, float width, float height, IVideo video)](#addVideoFrame-float-float-float-float-com.aspose.slides.IVideo-) | 创建一个新视频框架并将其添加到形状集合的末尾。 |
| [insertVideoFrame(int index, float x, float y, float width, float height, String fname)](#insertVideoFrame-int-float-float-float-float-java.lang.String-) | 创建一个新视频框架并将其插入到形状集合的指定索引处。 |
| [addAudioFrameCD(float x, float y, float width, float height)](#addAudioFrameCD-float-float-float-float-) | 创建一个链接到 CD 曲目的新音频框架并将其添加到形状集合的末尾。 |
| [insertAudioFrameCD(int index, float x, float y, float width, float height)](#insertAudioFrameCD-int-float-float-float-float-) | 创建一个链接到 CD 曲目的新音频框架并将其插入到形状集合的指定索引处。 |
| [addAudioFrameLinked(float x, float y, float width, float height, String fname)](#addAudioFrameLinked-float-float-float-float-java.lang.String-) | 创建一个链接到外部音频文件的新音频框架并将其添加到形状集合的末尾。 |
| [insertAudioFrameLinked(int index, float x, float y, float width, float height, String fname)](#insertAudioFrameLinked-int-float-float-float-float-java.lang.String-) | 创建一个链接到外部音频文件的新音频框架并将其插入到形状集合的指定索引处。 |
| [addAudioFrameEmbedded(float x, float y, float width, float height, InputStream audio_stream)](#addAudioFrameEmbedded-float-float-float-float-java.io.InputStream-) | 创建一个带嵌入 WAV 文件的新音频框架并将其添加到形状集合的末尾。 |
| [insertAudioFrameEmbedded(int index, float x, float y, float width, float height, InputStream audio_stream)](#insertAudioFrameEmbedded-int-float-float-float-float-java.io.InputStream-) | 创建一个带嵌入 WAV 文件的新音频框架并将其插入到形状集合的指定索引处。 |
| [addAudioFrameEmbedded(float x, float y, float width, float height, IAudio audio)](#addAudioFrameEmbedded-float-float-float-float-com.aspose.slides.IAudio-) | 使用 Presentation.Audios 列表中的现有音频对象，创建一个新音频框架并将其添加到形状集合的末尾。 |
| [insertAudioFrameEmbedded(int index, float x, float y, float width, float height, IAudio audio)](#insertAudioFrameEmbedded-int-float-float-float-float-com.aspose.slides.IAudio-) | 使用 Presentation.Audios 列表中的现有音频对象，创建一个新音频框架并将其插入到形状集合的指定索引处。 |
| [indexOf(IShape shape)](#indexOf-com.aspose.slides.IShape-) | 返回指定形状在集合中第一次出现的零基索引。 |
...
| [addAutoShape(int shapeType, float x, float y, float width, float height)](#addAutoShape-int-float-float-float-float-) | 使用默认格式创建一个新自动形状并将其添加到形状集合的末尾。 |
| [addAutoShape(int shapeType, float x, float y, float width, float height, boolean createFromTemplate)](#addAutoShape-int-float-float-float-float-boolean-) | 创建一个新自动形状并将其添加到形状集合的末尾，可选地使用默认模板格式进行初始化。 |
| [addMathShape(float x, float y, float width, float height)](#addMathShape-float-float-float-float-) | 创建一个用于承载数学内容的新矩形自动形状并将其添加到形状集合的末尾。 |
| [insertAutoShape(int index, int shapeType, float x, float y, float width, float height)](#insertAutoShape-int-int-float-float-float-float-) | 创建一个新自动形状并将其插入到形状集合的指定索引处，应用默认模板格式。 |
| [insertAutoShape(int index, int shapeType, float x, float y, float width, float height, boolean createFromTemplate)](#insertAutoShape-int-int-float-float-float-float-boolean-) | 创建一个新自动形状并将其插入到形状集合的指定索引处，可选地使用默认模板样式进行初始化。 |
| [addGroupShape()](#addGroupShape--) | 创建一个新的空组形状并将其添加到形状集合的末尾。 |
| [addGroupShape(ISvgImage svgImage, float x, float y, float width, float height)](#addGroupShape-com.aspose.slides.ISvgImage-float-float-float-float-) | 创建一个新组形状，将指定的 SVG 图像转换为单个形状，并将生成的组添加到形状集合的末尾。 |
| [insertGroupShape(int index)](#insertGroupShape-int-) | 创建一个新的空组形状并将其插入到形状集合的指定索引处。 |
| [addConnector(int shapeType, float x, float y, float width, float height)](#addConnector-int-float-float-float-float-) | 使用默认模板样式创建一个新连接器形状并将其添加到形状集合的末尾。 |
| [addConnector(int shapeType, float x, float y, float width, float height, boolean createFromTemplate)](#addConnector-int-float-float-float-float-boolean-) | 创建一个新连接器形状并将其添加到形状集合的末尾，可选地应用默认模板样式。 |
| [insertConnector(int index, int shapeType, float x, float y, float width, float height)](#insertConnector-int-int-float-float-float-float-) | 创建一个新连接器形状并将其插入到形状集合的指定索引处，应用默认模板样式。 |
| [insertConnector(int index, int shapeType, float x, float y, float width, float height, boolean createFromTemplate)](#insertConnector-int-int-float-float-float-float-boolean-) | 创建一个新连接器形状并将其插入到形状集合的指定索引处，可选地应用默认模板样式。 |
...
| [insertPictureFrame(int index, int shapeType, float x, float y, float width, float height, IPPImage image)](#insertPictureFrame-int-int-float-float-float-float-com.aspose.slides.IPPImage-) | 创建一个包含指定图像的新图片框架并将其插入到形状集合的指定索引处。 |
| [addTable(float x, float y, double[] columnWidths, double[] rowHeights)](#addTable-float-float-double---double---) | 创建一个新表并将其添加到形状集合的末尾。 |
| [insertTable(int index, float x, float y, double[] columnWidths, double[] rowHeights)](#insertTable-int-float-float-double---double---) | 创建一个新表并将其插入到形状集合的指定索引处。 |
| [removeAt(int index)](#removeAt-int-) | 从形状集合中删除指定索引处的形状。 |
| [remove(IShape shape)](#remove-com.aspose.slides.IShape-) | 从形状集合中删除指定形状的第一次出现。 |
| [clear()](#clear--) | 从形状集合中删除所有形状。 |
...
| [insertClone(int index, IShape sourceShape, float x, float y, float width, float height)](#insertClone-int-com.aspose.slides.IShape-float-float-float-float-) | 创建指定形状的副本并将其插入到形状集合的指定索引处。 |
| [insertClone(int index, IShape sourceShape, float x, float y)](#insertClone-int-com.aspose.slides.IShape-float-float-) | 创建指定形状的副本并将其插入到形状集合的指定索引处。 |
| [insertClone(int index, IShape sourceShape)](#insertClone-int-com.aspose.slides.IShape-) | 创建指定形状的副本并将其插入到形状集合的指定索引处。 |
...
| --- | --- | --- |
| type | int | 要添加的图表类型。 |
| x | float | 新图表的 X 坐标，单位为 points。 |
| y | float | 新图表的 Y 坐标，单位为 points。 |
| width | float | 图表的宽度，单位为 points。 |
| height | float | 图表的高度，单位为 points。 |
...
| width | float | 图表的宽度，单位为 points。 |
| height | float | 图表的高度，单位为 points。 |
| initWithSample | boolean | 若为 true，则使用示例系列数据和设置初始化新图表；若为 false，则创建不带系列且仅含最小设置的图表，以加快创建速度。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| x | float | 图表框架的 X 坐标，单位为 points。 |
| y | float | 图表框架的 Y 坐标，单位为 points。 |
| width | float | 图表框架的宽度，单位为 points。 |
| height | float | 图表框架的高度，单位为 points。 |
...
创建一个新图表，使用示例系列数据和设置进行初始化，并将其插入到形状集合的指定索引处。
...
| x | float | 新图表的 X 坐标，单位为 points。 |
| y | float | 新图表的 Y 坐标，单位为 points。 |
| width | float | 新图表的宽度，单位为 points。 |
| height | float | 新图表的高度，单位为 points。 |
...
| index | int | 在形状集合中插入新图表的零基索引。 |
| initWithSample | boolean | True 表示使用示例系列数据和设置初始化新图表；false 表示创建没有系列且仅包含最小设置的图表，从而加快创建速度。 |
...
| slide | [ISlide](../../com.aspose.slides/islide) | Zoom 框引用的 [ISlide](../../com.aspose.slides/islide)；必须属于此演示文稿。 |
...
| height | float | 新 Zoom 框的高度（单位：点）。 |
| slide | [ISlide](../../com.aspose.slides/islide) | Zoom 框引用的 [ISlide](../../com.aspose.slides/islide)；必须属于此演示文稿。 |
| image | [IPPImage](../../com.aspose.slides/ippimage) | 引用的幻灯片 [IPPImage](../../com.aspose.slides/ippimage) 的图像。 |
...
| width | float | 新 Zoom 框的宽度（单位：点）。 |
| height | float | 新 Zoom 框的高度（单位：点）。 |
| slide | [ISlide](../../com.aspose.slides/islide) | Zoom 框引用的 [ISlide](../../com.aspose.slides/islide)。 |
...
创建一个带预定义图像的 Zoom 框，并在指定索引处将其插入形状集合。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| x | float | 新章节 Zoom 框的 x 坐标（单位：点）。 |
| y | float | 新章节 Zoom 框的 y 坐标（单位：点）。 |
| width | float | 新章节 Zoom 框的宽度（单位：点）。 |
| height | float | 新章节 Zoom 框的高度（单位：点）。 |
| section | [ISection](../../com.aspose.slides/isection) | 章节 Zoom 框引用的 [ISection](../../com.aspose.slides/isection)；必须属于此演示文稿且至少包含一张幻灯片。 |
...
创建一个带预定义图像的章节 Zoom 框并将其添加到形状集合的末尾。
...
| height | float | 新章节 Zoom 框的高度（单位：点）。 |
| section | [ISection](../../com.aspose.slides/isection) | 章节 Zoom 框引用的 [ISection](../../com.aspose.slides/isection)；必须属于此演示文稿且至少包含一张幻灯片。 |
| image | [IPPImage](../../com.aspose.slides/ippimage) | 在章节 Zoom 框内显示的 [IPPImage](../../com.aspose.slides/ippimage)。 |
...
创建一个带预定义图像的章节 Zoom 框，并在指定索引处将其插入形状集合。
...
| height | float | 新章节 Zoom 框的高度（单位：点）。 |
| section | [ISection](../../com.aspose.slides/isection) | 章节 Zoom 框引用的 [ISection](../../com.aspose.slides/isection)；必须属于此演示文稿且至少包含一张幻灯片。 |
| image | [IPPImage](../../com.aspose.slides/ippimage) | 在章节 Zoom 框内显示的图像。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| x | float | 新汇总 Zoom 框的 x 坐标（单位：点）。 |
| y | float | 新汇总 Zoom 框的 y 坐标（单位：点）。 |
| width | float | 新汇总 Zoom 框的宽度（单位：点）。 |
| height | float | 新汇总 Zoom 框的高度（单位：点）。 |

此方法创建一个新的汇总 Zoom，并为本演示文稿中的所有章节放置一组对象。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| index | int | 插入汇总 Zoom 框的零基索引。 |
| x | float | 新汇总 Zoom 框的 x 坐标（单位：点）。 |
| y | float | 新汇总 Zoom 框的 y 坐标（单位：点）。 |
| width | float | 新汇总 Zoom 框的宽度（单位：点）。 |
| height | float | 新汇总 Zoom 框的高度（单位：点）。 |

此方法创建一个汇总 Zoom 框，聚合演示文稿中所有章节的汇总链接。
...
> ```
> 以下示例展示如何向 PowerPoint 演示文稿的幻灯片中添加 OLE 对象框。
>  
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| x | float | 新 OLE 框的 x 坐标（单位：点）。 |
| y | float | 新 OLE 框的 y 坐标（单位：点）。 |
| width | float | 新 OLE 框的宽度（单位：点）。 |
| height | float | 新 OLE 框的高度（单位：点）。 |
| dataInfo | [IOleEmbeddedDataInfo](../../com.aspose.slides/ioleembeddeddatainfo) | 嵌入 OLE 数据的信息（[IOleEmbeddedDataInfo](../../com.aspose.slides/ioleembeddeddatainfo)）。 |
...
| path | java.lang.String | 链接文件的路径。此路径在演示文稿中原样保存。如果指定相对路径，在从不同目录打开演示文稿时文件将不可访问。 |
...
创建一个新的 OLE 对象框，并将其插入到指定索引的形状集合中。
...
此路径会原样存储在演示文稿中。如果指定相对路径，则在从不同目录打开演示文稿时文件将不可访问。

**返回：**
[IOleObjectFrame](../../com.aspose.slides/ioleobjectframe) - 新创建的 OLE 对象框。
...
创建一个新的视频框，并将其添加到形状集合的末尾。

**参数：**
| Parameter | Type | Description |
| --- | --- | --- |
| x | float | 新视频框的 x 坐标，单位为点。 |
| y | float | 新视频框的 y 坐标，单位为点。 |
| width | float | 新视频框的宽度，单位为点。 |
| height | float | 新视频框的高度，单位为点。 |
...
| width | float | 新视频框的宽度，单位为点。 |
| height | float | 新视频框的高度，单位为点。 |
| video | [IVideo](../../com.aspose.slides/ivideo) | 要嵌入到视频框中的 [IVideo](../../com.aspose.slides/ivideo)。 |
...
创建一个新的视频框，并将其插入到指定索引的形状集合中。

**参数：**
| Parameter | Type | Description |
| --- | --- | --- |
| index | int | 要插入视频框的基于零的索引。 |
| x | float | 新视频框的 x 坐标，单位为点。 |
| y | float | 新视频框的 y 坐标，单位为点。 |
| width | float | 新视频框的宽度，单位为点。 |
| height | float | 新视频框的高度，单位为点。 |
...
创建一个链接到 CD 曲目的新音频框，并将其添加到形状集合的末尾。
...
创建一个链接到 CD 曲目的新音频框，并将其插入到指定索引的形状集合中。

**参数：**
| Parameter | Type | Description |
| --- | --- | --- |
| index | int | 要插入音频框的基于零的索引。 |
| x | float | 新音频框的 x 坐标，单位为点。 |
| y | float | 新音频框的 y 坐标，单位为点。 |
| width | float | 新音频框的宽度，单位为点。 |
| height | float | 新音频框的高度，单位为点。 |
...
| width | float | 新音频框的宽度，单位为点。 |
| height | float | 新音频框的高度，单位为点。 |
| fname | java.lang.String | 外部音频文件的路径或名称。 |
...
创建一个链接到外部音频文件的新音频框，并将其插入到指定索引的形状集合中。
...
创建一个带有嵌入 WAV 文件的新音频框，并将其添加到形状集合的末尾。嵌入的音频会被添加到 Presentation.Audios 集合中。
...
创建一个带有嵌入 WAV 文件的音频框，并将其插入到指定索引的形状集合中。嵌入的音频会被添加到 Presentation.Audios 集合中。
...
创建一个新音频框，并使用 Presentation.Audios 列表中现有的音频对象将其添加到形状集合的末尾。
...
创建一个新音频框，并使用 Presentation.Audios 列表中现有的音频对象将其插入到指定索引的形状集合中。
...
**返回：**
int - 如果找到，则返回形状在形状集合中首次出现的基于零的索引；否则返回 \\u20131。
...
**返回：**
com.aspose.slides.IShape[] - 一个包含 [IShape](../../com.aspose.slides/ishape) 对象的数组。
...
| Parameter | Type | Description |
| --- | --- | --- |
| index | int | 第一个指定形状将被放置的基于零的目标索引；随后形状按提供的顺序依次放置。 |
| shapes | [IShape\[\]](../../com.aspose.slides/ishape) | 一个或多个 [IShape](../../com.aspose.slides/ishape) 实例，用于在集合中移动。 |
...
| width | float | 形状框的宽度，单位为点。 |
| height | float | 形状框的高度，单位为点。 |
| createFromTemplate | boolean | True 表示将默认模板样式（简易样式、居中文本以及非空名称）应用于新形状；false 表示使用所有属性默认值创建形状。 |
...
创建一个新的矩形自动形状用于承载数学内容，并将其添加到形状集合的末尾。
...
创建一个新自动形状并在指定索引处插入到形状集合中，应用默认模板格式。
...
创建一个新自动形状并在指定索引处插入到形状集合中，可选择使用默认模板样式进行初始化。
...
| width | float | 形状框的宽度，单位为点。 |
| height | float | 形状框的高度，单位为点。 |
| createFromTemplate | boolean | True 表示将默认模板样式（包括非空名称、简易样式和居中文本）应用于新形状；false 表示使用所有属性的默认值创建形状。 |
...
创建一个新的空组形状并将其添加到形状集合的末尾。组的框会自动调整以容纳添加的任何形状。
...
创建一个新的空组形状并在指定索引处插入到形状集合中。组的框会自动调整以容纳添加的任何形状。
...
| x | float | 连接器框的 x 坐标，单位为点。 |
| y | float | 连接器框的 y 坐标，单位为点。 |
| width | float | 连接器框的宽度，单位为点。 |
| height | float | 连接器框的高度，单位为点。 |
...
| width | float | 连接器框的宽度，单位为点。 |
| height | float | 连接器框的高度，单位为点。 |
| createFromTemplate | boolean | True 表示将默认模板样式（非空名称、简易样式）应用于新连接器；false 表示使用默认属性值创建连接器。 |
...
创建一个新连接器形状并在指定索引处插入到形状集合中，应用默认模板样式。
...
创建一个新连接器形状并在指定索引处插入到形状集合中，可选择应用默认模板样式。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| shapeType | int | 指定 [ShapeType](../../com.aspose.slides/shapetype) 中包含的形状类型，除所有线形之外：
...
创建一个包含指定图像的新图片框，并在指定索引处插入到形状集合中。

**参数：**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| index | int | 插入图片框的零基索引。 |
| shapeType | int | 指定 [ShapeType](../../com.aspose.slides/shapetype) 中包含的形状类型，除所有线形之外：
...
| columnWidths | double[] | 表示表格列宽的 double 数组，单位为点。 |
| rowHeights | double[] | 表示表格行高的 double 数组，单位为点。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | 要删除的 [IShape](../../com.aspose.slides/ishape)。 |
...
创建指定形状的副本并将其插入到形状集合的指定索引处。克隆的形状保留原始的位置信息和大小。
