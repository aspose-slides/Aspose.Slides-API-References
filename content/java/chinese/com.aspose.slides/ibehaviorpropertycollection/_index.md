...
| 方法 | 描述 |
| --- | --- |
| [add(String propertyValue)](#add-java.lang.String-) | 向集合添加一个新属性。 |
| [indexOf(String propertyValue)](#indexOf-java.lang.String-) | 通过属性值确定列表中特定项的索引。 |
| [insert(int index, String propertyValue)](#insert-int-java.lang.String-) | 在指定索引处向集合插入一个新属性（使用指定的属性值）。 |
