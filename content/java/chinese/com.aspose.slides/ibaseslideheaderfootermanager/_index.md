...
description: 表示管理器，保持所有幻灯片类型的页脚、日期时间和页码占位符的行为。
type: docs
...
表示管理器，保持所有幻灯片类型的页脚、日期时间和页码占位符的行为。
## 方法
...
| [setFooterText(String text)](#setFooterText-java.lang.String-) | 为幻灯片页脚占位符设置文本。 |
| [setDateTimeText(String text)](#setDateTimeText-java.lang.String-) | 为幻灯片日期时间占位符设置文本。 |
### isFooterVisible() {#isFooterVisible--}
```
public abstract boolean isFooterVisible()
```

获取指示页脚占位符是否存在的值。只读 boolean。
