...
| [getTo()](#getTo--) | 描述动画颜色更改的结果颜色。 |
| [setTo(IColorFormat value)](#setTo-com.aspose.slides.IColorFormat-) | 描述动画颜色更改的结果颜色。 |
...
描述动画颜色更改的结果颜色。读/写 [IColorFormat](../../com.aspose.slides/icolorformat)。
