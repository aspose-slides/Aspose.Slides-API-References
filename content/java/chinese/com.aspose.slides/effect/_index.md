...
| [getTiming()](#getTiming--) | 定义效果的计时值。 |
| [setTiming(ITiming value)](#setTiming-com.aspose.slides.ITiming-) | 定义效果的计时值。 |
| [getTargetShape()](#getTargetShape--) | 返回效果的目标形状。 |
| [getSound()](#getSound--) | 为效果定义嵌入的声音。 |
| [setSound(IAudio value)](#setSound-com.aspose.slides.IAudio-) | 为效果定义嵌入的声音。 |
| [getStopPreviousSound()](#getStopPreviousSound--) | 此属性指定动画效果是否停止之前的声音。 |
| [setStopPreviousSound(boolean value)](#setStopPreviousSound-boolean-) | 此属性指定动画效果是否停止之前的声音。 |
...
| [getAnimateTextType()](#getAnimateTextType--) | 定义效果的动画文本类型。 |
| [setAnimateTextType(int value)](#setAnimateTextType-int-) | 定义效果的动画文本类型。 |
...
定义效果的计时值。可读写 [ITiming](../../com.aspose.slides/itiming)。
...
为效果定义嵌入的声音。可读写 [IAudio](../../com.aspose.slides/iaudio)。
...
此属性指定动画效果是否停止之前的声音。可读写 boolean 。
...
定义效果的后动画类型。可读写 [AfterAnimationType](../../com.aspose.slides/afteranimationtype)(\#getAfterAnimationType.getAfterAnimationType/\#setAfterAnimationType(int).setAfterAnimationType(int))。
...
定义效果的后动画颜色。可读写 [IColorFormat](../../com.aspose.slides/icolorformat)。
...
定义效果的动画文本类型。The shape text can be animated by letter, by word or all at once. 可读写 AnimateTextType (\#getAnimateTextType.getAnimateTextType/\#setAnimateTextType(int).setAnimateTextType(int))。
...
定义动画文本部分（单词或字母）之间的延迟。A positive value specifies the percentage of effect duration. A negative value specifies the delay in seconds. 可读写 float 。
