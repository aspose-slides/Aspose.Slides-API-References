...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | 确定在调整大小时形状是否必须保持宽高比。 |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | 确定在调整大小时形状是否必须保持宽高比。 |
