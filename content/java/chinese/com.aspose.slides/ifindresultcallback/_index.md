...
| 方法 | 描述 |
| --- | --- |
| [foundResult(ITextFrame textFrame, String sourceText, String foundText, int textPosition)](#foundResult-com.aspose.slides.ITextFrame-java.lang.String-java.lang.String-int-) | 接收关于找到的文本的数据的回调方法。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| textFrame | [ITextFrame](../../com.aspose.slides/itextframe) | 找到文本的 [ITextFrame](../../com.aspose.slides/itextframe)。 |
