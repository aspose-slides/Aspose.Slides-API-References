...
description: 除整数外的 Nary 操作符 IMathNaryOperator 类型，整数的情况
type: docs
url: /zh/com.aspose.slides/mathnaryoperatortypes/
---
**继承：**
...
Nary operator IMathNaryOperator 类型（排除整数） 对于整数 [MathIntegralTypes](../../com.aspose.slides/mathintegraltypes)
## 字段
...
| [Product](#Product) | 乘积：'\\u220f' |
| [CoProduct](#CoProduct) | 共积：'\\u2210' |
| [Intersection](#Intersection) | 交集：'\\u2229' |
| [Union](#Union) | 并集：'\\u222a' |
| [LogicalAnd](#LogicalAnd) | 逻辑与：'\\u2227' |
| [LogicalOr](#LogicalOr) | 逻辑或：'\\u2228' |
### 求和 {#Summation}
```
