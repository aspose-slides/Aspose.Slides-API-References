...
| [insert(int index, IParagraph value)](#insert-int-com.aspose.slides.IParagraph-) | 在指定索引处向集合插入一个 Paragraph。 |
| [insert(int index, IParagraphCollection value)](#insert-int-com.aspose.slides.IParagraphCollection-) | 在指定索引处向集合插入 ParagraphCollection 的内容。 |
...
**返回值：**
int - 添加 Paragraph 的索引；如果没有可添加的内容则为 -1。
...
在指定索引处向集合插入 ParagraphCollection 的内容。
...
| --- | --- | --- |
| text | java.lang.String | HTML 文本。 |
| resolver | [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver) | 用于解析 URI 并获取引用对象的解析回调对象。 |
