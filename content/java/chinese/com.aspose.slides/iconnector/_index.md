...
| [getStartShapeConnectedTo()](#getStartShapeConnectedTo--) | 返回或设置将连接器起始端附加到的形状。 |
| [setStartShapeConnectedTo(IShape value)](#setStartShapeConnectedTo-com.aspose.slides.IShape-) | 返回或设置将连接器起始端附加到的形状。 |
| [getEndShapeConnectedTo()](#getEndShapeConnectedTo--) | 返回或设置将连接器结束端附加到的形状。 |
| [setEndShapeConnectedTo(IShape value)](#setEndShapeConnectedTo-com.aspose.slides.IShape-) | 返回或设置将连接器结束端附加到的形状。 |
...
| [reroute()](#reroute--) | 重新路由连接器，使其在所连接的形状之间走最短的路径。 |
...
返回或设置将连接器起始端附加到的形状。读写 [IShape](../../com.aspose.slides/ishape)。
...
返回或设置将连接器结束端附加到的形状。读写 [IShape](../../com.aspose.slides/ishape)。
