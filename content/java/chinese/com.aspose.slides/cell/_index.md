...
| [getFirstRowIndex()](#getFirstRowIndex--) | 返回该单元格覆盖的第一行的索引。 |
| [getFirstColumnIndex()](#getFirstColumnIndex--) | 返回该单元格覆盖的第一列的索引。 |
...
| [getTextVerticalType()](#getTextVerticalType--) | 返回或设置竖排文字的类型。 |
| [setTextVerticalType(byte value)](#setTextVerticalType-byte-) | 返回或设置竖排文字的类型。 |
| [getTextAnchorType()](#getTextAnchorType--) | 返回或设置文本锚点类型。 |
| [setTextAnchorType(byte value)](#setTextAnchorType-byte-) | 返回或设置文本锚点类型。 |
| [getAnchorCenter()](#getAnchorCenter--) | 确定文本框是否在单元格内居中。 |
| [setAnchorCenter(boolean value)](#setAnchorCenter-boolean-) | 确定文本框是否在单元格内居中。 |
...
| [getTextFrame()](#getTextFrame--) | 返回单元格的文本框。 |
...
| [getSlide()](#getSlide--) | 返回单元格的父幻灯片。 |
| [getPresentation()](#getPresentation--) | 返回单元格的父演示文稿。 |
...
返回单元格的最小高度。这是该单元格覆盖的所有行的最小高度之和。只读 double。
...
返回或设置 TextFrame 中的左边距。读写 double。
...
返回或设置 TextFrame 中的右边距。读写 double。
...
返回或设置 TextFrame 中的上边距。读写 double。
...
返回或设置 TextFrame 中的下边距。读写 double。
...
返回或设置竖排文字的类型。读写 [TextVerticalType](../../com.aspose.slides/textverticaltype)。
...
返回或设置文本锚点类型。读写 [TextAnchorType](../../com.aspose.slides/textanchortype)。
...
返回父表格的表格网格中当前单元格跨越的列数。此属性允许单元格看起来被合并，因为它跨越表格中其他单元格的垂直边界。只读 int。
...
返回单元格的文本框。只读 [ITextFrame](../../com.aspose.slides/itextframe)。
...
返回单元格的父幻灯片。只读 [IBaseSlide](../../com.aspose.slides/ibaseslide)。
...
返回单元格的父演示文稿。只读 [IPresentation](../../com.aspose.slides/ipresentation)。
