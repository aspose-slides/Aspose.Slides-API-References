...
此接口与 [ITextFrameFormat](../../com.aspose.slides/itextframeformat) 接口一起使用，以返回已应用继承的有效格式值。
...
| [getMarginLeft()](#getMarginLeft--) | 返回 TextFrame 中左边距（点）。 |
| [getMarginRight()](#getMarginRight--) | 返回 TextFrame 中右边距（点）。 |
| [getMarginTop()](#getMarginTop--) | 返回 TextFrame 中上边距（点）。 |
| [getMarginBottom()](#getMarginBottom--) | 返回 TextFrame 中下边距（点）。 |
| [getWrapText()](#getWrapText--) | 返回文本是否在 TextFrame 的边距处换行。 |
| [getAnchoringType()](#getAnchoringType--) | 返回 TextFrame 中的垂直锚点文本。 |
| [getCenterText()](#getCenterText--) | 返回文本是否在水平上居中显示在盒子中。 |
| [getTextVerticalType()](#getTextVerticalType--) | 返回文本方向。 |
| [getAutofitType()](#getAutofitType--) | 返回文本自动适配模式。 |
| [getColumnCount()](#getColumnCount--) | 指定在边界矩形中的文本列数。 |
