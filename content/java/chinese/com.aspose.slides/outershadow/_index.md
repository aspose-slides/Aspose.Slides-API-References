...
| 方法 | 描述 |
| --- | --- |
| [getBlurRadius()](#getBlurRadius--) | 模糊半径，以点为单位。 |
| [setBlurRadius(double value)](#setBlurRadius-double-) | 模糊半径，以点为单位。 |
| [getDirection()](#getDirection--) | 阴影方向，以度为单位。 |
| [setDirection(float value)](#setDirection-float-) | 阴影方向，以度为单位。 |
...
| [getSkewHorizontal()](#getSkewHorizontal--) | 水平倾斜角度，以度为单位。 |
| [setSkewHorizontal(double value)](#setSkewHorizontal-double-) | 水平倾斜角度，以度为单位。 |
| [getSkewVertical()](#getSkewVertical--) | 垂直倾斜角度，以度为单位。 |
| [setSkewVertical(double value)](#setSkewVertical-double-) | 垂直倾斜角度，以度为单位。 |
...
| [getScaleHorizontal()](#getScaleHorizontal--) | 水平缩放因子，原始大小的百分比。 |
| [setScaleHorizontal(double value)](#setScaleHorizontal-double-) | 水平缩放因子，原始大小的百分比。 |
| [getScaleVertical()](#getScaleVertical--) | 垂直缩放因子，原始大小的百分比。 |
| [setScaleVertical(double value)](#setScaleVertical-double-) | 垂直缩放因子，原始大小的百分比。 |
| [getEffective()](#getEffective--) | 获取在应用继承后有效的外部阴影效果数据。 |
...
模糊半径，以点为单位。默认值 - 0 pt。可读写 double。
...
阴影方向，以度为单位。默认值 - 0 � (left-to-right)。可读写 float。
...
阴影颜色。默认值 - 自动黑色（取决于主题）。只读 [IColorFormat](../../com.aspose.slides/icolorformat)。
...
水平缩放因子，原始大小的百分比。负缩放会导致翻转。默认值 - 100%。可读写 double。
...
垂直缩放因子，原始大小的百分比。负缩放会导致翻转。默认值 - 100%。可读写 double。
