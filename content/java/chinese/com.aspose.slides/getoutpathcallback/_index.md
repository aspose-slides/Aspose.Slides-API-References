...
| 方法 | 描述 |
| --- | --- |
| [invoke(Slide slide, int index)](#invoke-com.aspose.slides.Slide-int-) | 回调将在每个[Slide](../../com.aspose.slides/slide)时被调用，期望返回输出路径。 |
### invoke(Slide slide, int index) {#invoke-com.aspose.slides.Slide-int-}
```
public abstract String invoke(Slide slide, int index)
```

回调将在每个[Slide](../../com.aspose.slides/slide)时被调用，期望返回输出路径。
