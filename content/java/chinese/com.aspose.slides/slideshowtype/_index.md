...
基本幻灯片放映设置。祖先表示幻灯片放映的类型： [PresentedBySpeaker](../../com.aspose.slides/presentedbyspeaker) 由演讲者呈现（全屏） [BrowsedByIndividual](../../com.aspose.slides/browsedbyindividual) 由个人浏览（窗口） [BrowsedAtKiosk](../../com.aspose.slides/browsedatkiosk) 在自助终端浏览（全屏）
