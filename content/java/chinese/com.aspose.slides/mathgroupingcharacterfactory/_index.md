...
| 方法 | 描述 |
| --- | --- |
| [createMathGroupingCharacter(IMathElement element, char character, int position, int verticalJustification)](#createMathGroupingCharacter-com.aspose.slides.IMathElement-char-int-int-) | 创建一个数学分组字符 |
| [createMathGroupingCharacter(IMathElement element)](#createMathGroupingCharacter-com.aspose.slides.IMathElement-) | 创建一个数学分组字符 |
### MathGroupingCharacterFactory() {#MathGroupingCharacterFactory--}
```
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| element | [IMathElement](../../com.aspose.slides/imathelement) | 要应用分组字符的数学元素 |
| character | char | 分组字符 |
| position | int | 分组字符的位置 |
| verticalJustification | int | 垂直对齐方式 |
