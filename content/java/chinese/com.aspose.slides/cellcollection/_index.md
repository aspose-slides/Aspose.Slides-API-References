...
| [get_Item(int index)](#get-Item-int-) | 按位置返回单元格。 |
...
按位置返回单元格。只读 [Cell](../../com.aspose.slides/cell)。

--------------------

如果单元格已合并，则一个 Cell 对象可以对应多个索引返回。
...
**返回：**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICell> - 一个可用于遍历集合的 IGenericEnumerator。
...
**返回：**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICell> - 一个用于整个集合的 java.util.Iterator。
### getSlide() {#getSlide--}
```
