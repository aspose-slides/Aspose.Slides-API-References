...
description: 表示一种图表类型。
type: docs
url: /zh/com.aspose.slides/charttype/
---
**继承：**
...
| 字段 | 描述 |
| --- | --- |
| [ClusteredColumn](#ClusteredColumn) | 表示聚簇柱形图。 |
| [StackedColumn](#StackedColumn) | 表示堆积柱形图。 |
| [PercentsStackedColumn](#PercentsStackedColumn) | 表示100% 堆积柱形图。 |
| [ClusteredColumn3D](#ClusteredColumn3D) | 表示3D 聚簇柱形图。 |
| [StackedColumn3D](#StackedColumn3D) | 表示3D 堆积柱形图。 |
| [PercentsStackedColumn3D](#PercentsStackedColumn3D) | 表示3D 100% 堆积柱形图。 |
| [Column3D](#Column3D) | 表示3D 柱形图。 |
| [ClusteredCylinder](#ClusteredCylinder) | 表示圆柱图。 |
| [StackedCylinder](#StackedCylinder) | 表示堆积圆柱图。 |
| [PercentsStackedCylinder](#PercentsStackedCylinder) | 表示100% 堆积圆柱图。 |
| [Cylinder3D](#Cylinder3D) | 表示3D 圆柱形图。 |
| [ClusteredCone](#ClusteredCone) | 表示圆锥图。 |
| [StackedCone](#StackedCone) | 表示堆积圆锥图。 |
| [PercentsStackedCone](#PercentsStackedCone) | 表示100% 堆积圆锥图。 |
| [Cone3D](#Cone3D) | 表示3D 圆锥形图。 |
| [ClusteredPyramid](#ClusteredPyramid) | 表示金字塔图。 |
| [StackedPyramid](#StackedPyramid) | 表示堆积金字塔图。 |
| [PercentsStackedPyramid](#PercentsStackedPyramid) | 表示100% 堆积金字塔图。 |
| [Pyramid3D](#Pyramid3D) | 表示3D 金字塔图。 |
| [Line](#Line) | 表示折线图。 |
| [StackedLine](#StackedLine) | 表示堆积折线图。 |
| [PercentsStackedLine](#PercentsStackedLine) | 表示100% 堆积折线图。 |
| [LineWithMarkers](#LineWithMarkers) | 表示带数据标记的折线图。 |
| [StackedLineWithMarkers](#StackedLineWithMarkers) | 表示带数据标记的堆积折线图。 |
| [PercentsStackedLineWithMarkers](#PercentsStackedLineWithMarkers) | 表示带数据标记的100% 堆积折线图。 |
| [Line3D](#Line3D) | 表示3D 折线图。 |
| [Pie](#Pie) | 表示饼图。 |
| [Pie3D](#Pie3D) | 表示3D 饼图。 |
| [PieOfPie](#PieOfPie) | 表示饼中饼图。 |
| [ExplodedPie](#ExplodedPie) | 表示爆炸饼图。 |
| [ExplodedPie3D](#ExplodedPie3D) | 表示3D 爆炸饼图。 |
| [BarOfPie](#BarOfPie) | 表示条形饼图。 |
| [PercentsStackedBar](#PercentsStackedBar) | 表示100% 堆积条形图。 |
| [ClusteredBar3D](#ClusteredBar3D) | 表示3D 聚簇条形图。 |
| [ClusteredBar](#ClusteredBar) | 表示聚簇条形图。 |
| [StackedBar](#StackedBar) | 表示堆积条形图。 |
| [StackedBar3D](#StackedBar3D) | 表示3D 堆积条形图。 |
| [PercentsStackedBar3D](#PercentsStackedBar3D) | 表示3D 100% 堆积条形图。 |
| [ClusteredHorizontalCylinder](#ClusteredHorizontalCylinder) | 表示圆柱条形图。 |
| [StackedHorizontalCylinder](#StackedHorizontalCylinder) | 表示堆积圆柱条形图。 |
| [PercentsStackedHorizontalCylinder](#PercentsStackedHorizontalCylinder) | 表示100% 堆积圆柱条形图。 |
| [ClusteredHorizontalCone](#ClusteredHorizontalCone) | 表示圆锥条形图。 |
| [StackedHorizontalCone](#StackedHorizontalCone) | 表示堆积圆锥条形图。 |
| [PercentsStackedHorizontalCone](#PercentsStackedHorizontalCone) | 表示100% 堆积圆锥条形图。 |
| [ClusteredHorizontalPyramid](#ClusteredHorizontalPyramid) | 表示金字塔条形图。 |
| [StackedHorizontalPyramid](#StackedHorizontalPyramid) | 表示堆积金字塔条形图。 |
| [PercentsStackedHorizontalPyramid](#PercentsStackedHorizontalPyramid) | 表示100% 堆积金字塔条形图。 |
| [Area](#Area) | 表示区域图。 |
| [StackedArea](#StackedArea) | 表示堆积区域图。 |
| [PercentsStackedArea](#PercentsStackedArea) | 表示100% 堆积区域图。 |
| [Area3D](#Area3D) | 表示3D 区域图。 |
| [StackedArea3D](#StackedArea3D) | 表示3D 堆积区域图。 |
| [PercentsStackedArea3D](#PercentsStackedArea3D) | 表示3D 100% 堆积区域图。 |
| [ScatterWithMarkers](#ScatterWithMarkers) | 表示散点图。 |
| [ScatterWithSmoothLinesAndMarkers](#ScatterWithSmoothLinesAndMarkers) | 表示带数据标记的曲线连接散点图。 |
| [ScatterWithSmoothLines](#ScatterWithSmoothLines) | 表示曲线连接的散点图（无数据标记）。 |
| [ScatterWithStraightLinesAndMarkers](#ScatterWithStraightLinesAndMarkers) | 表示带数据标记的直线连接散点图。 |
| [ScatterWithStraightLines](#ScatterWithStraightLines) | 表示直线连接的散点图（无数据标记）。 |
| [HighLowClose](#HighLowClose) | 表示高低收盘股票图。 |
| [OpenHighLowClose](#OpenHighLowClose) | 表示开盘-高-低-收盘股票图。 |
| [VolumeHighLowClose](#VolumeHighLowClose) | 表示成交量-高-低-收盘股票图。 |
| [VolumeOpenHighLowClose](#VolumeOpenHighLowClose) | 表示成交量-开盘-高-低-收盘股票图。 |
| [Surface3D](#Surface3D) | 表示3D 表面图。 |
| [WireframeSurface3D](#WireframeSurface3D) | 表示线框 3D 表面图。 |
| [Contour](#Contour) | 表示等高线图。 |
| [WireframeContour](#WireframeContour) | 表示线框等高线图。 |
| [Doughnut](#Doughnut) | 表示圆环图。 |
| [ExplodedDoughnut](#ExplodedDoughnut) | 表示爆炸圆环图。 |
| [Bubble](#Bubble) | 表示气泡图。 |
| [BubbleWith3D](#BubbleWith3D) | 表示3D 气泡图。 |
| [Radar](#Radar) | 表示雷达图。 |
| [RadarWithMarkers](#RadarWithMarkers) | 表示带数据标记的雷达图。 |
| [FilledRadar](#FilledRadar) | 表示填充雷达图。 |
| [SeriesOfMixedTypes](#SeriesOfMixedTypes) | 此值只能由 ChartEx.Type 属性返回。 |
| [Treemap](#Treemap) | 表示矩形树图。 |
| [Sunburst](#Sunburst) | 表示放射状图。 |
| [Histogram](#Histogram) | 表示直方图。 |
| [ParetoLine](#ParetoLine) | 表示 Pareto 线系列类型（直方图 Pareto 图）。 |
| [BoxAndWhisker](#BoxAndWhisker) | 表示箱线图。 |
| [Waterfall](#Waterfall) | 表示瀑布图。 |
| [Funnel](#Funnel) | 表示漏斗图。 |
| [Map](#Map) | 表示地图图表。 |
...
此值只能由 ChartEx.Type 属性返回。 这意味着图表具有混合类型的系列。
