...
| [getBeginArrowheadStyle()](#getBeginArrowheadStyle--) | 返回线起点的箭头样式。 |
| [getEndArrowheadStyle()](#getEndArrowheadStyle--) | 返回线终点的箭头样式。 |
| [getBeginArrowheadWidth()](#getBeginArrowheadWidth--) | 返回线起点的箭头宽度。 |
| [getEndArrowheadWidth()](#getEndArrowheadWidth--) | 返回线终点的箭头宽度。 |
| [getBeginArrowheadLength()](#getBeginArrowheadLength--) | 返回线起点的箭头长度。 |
| [getEndArrowheadLength()](#getEndArrowheadLength--) | 返回线终点的箭头长度。 |
| [equals(ILineFormatEffectiveData lf)](#equals-com.aspose.slides.ILineFormatEffectiveData-) | 确定两个 ILineFormatEffectiveData 实例是否相等。 |
...
返回线起点的箭头样式。只读 [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle)。
...
返回线终点的箭头样式。只读 [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle)。
...
返回线起点的箭头宽度。只读 [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth)。
...
返回线终点的箭头宽度。只读 [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth)。
...
返回线起点的箭头长度。只读 [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength)。
...
返回线终点的箭头长度。只读 [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength)。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| lf | [ILineFormatEffectiveData](../../com.aspose.slides/ilineformateffectivedata) | 要与当前 ILineFormatEffectiveData 比较的 ILineFormatEffectiveData。 |

**返回:**
boolean - **true** 如果指定的 ILineFormatEffectiveData 等于当前的 ILineFormatEffectiveData；否则，**false**.