...
| 方法 | 描述 |
| --- | --- |
| [isNoEffects()](#isNoEffects--) | 如果所有效果都被禁用（如刚创建的默认 EffectFormat 对象），则返回 true。 |
...
| [getGlowEffect()](#getGlowEffect--) | 发光效果。 |
| [setGlowEffect(IGlow value)](#setGlowEffect-com.aspose.slides.IGlow-) | 发光效果。 |
| [getInnerShadowEffect()](#getInnerShadowEffect--) | 内阴影。 |
| [setInnerShadowEffect(IInnerShadow value)](#setInnerShadowEffect-com.aspose.slides.IInnerShadow-) | 内阴影。 |
| [getOuterShadowEffect()](#getOuterShadowEffect--) | 外阴影。 |
| [setOuterShadowEffect(IOuterShadow value)](#setOuterShadowEffect-com.aspose.slides.IOuterShadow-) | 外阴影。 |
...
| [getSoftEdgeEffect()](#getSoftEdgeEffect--) | 柔边缘。 |
| [setSoftEdgeEffect(ISoftEdge value)](#setSoftEdgeEffect-com.aspose.slides.ISoftEdge-) | 柔边缘。 |
...
| [enableGlowEffect()](#enableGlowEffect--) | 启用发光效果。 |
| [enableInnerShadowEffect()](#enableInnerShadowEffect--) | 启用内阴影效果。 |
| [enableOuterShadowEffect()](#enableOuterShadowEffect--) | 启用外阴影效果。 |
| [enablePresetShadowEffect()](#enablePresetShadowEffect--) | 启用预设阴影效果。 |
| [enableReflectionEffect()](#enableReflectionEffect--) | 启用反射效果。 |
| [enableSoftEdgeEffect()](#enableSoftEdgeEffect--) | 启用柔边缘效果。 |
| [disableBlurEffect()](#disableBlurEffect--) | 禁用模糊效果。 |
| [disableFillOverlayEffect()](#disableFillOverlayEffect--) | 禁用填充叠加效果。 |
| [disableGlowEffect()](#disableGlowEffect--) | 禁用发光效果。 |
| [disableInnerShadowEffect()](#disableInnerShadowEffect--) | 禁用内阴影效果。 |
| [disableOuterShadowEffect()](#disableOuterShadowEffect--) | 禁用外阴影效果。 |
| [disablePresetShadowEffect()](#disablePresetShadowEffect--) | 禁用预设阴影效果。 |
| [disableReflectionEffect()](#disableReflectionEffect--) | 禁用反射效果。 |
| [disableSoftEdgeEffect()](#disableSoftEdgeEffect--) | 禁用柔边缘效果。 |
...
如果所有效果都被禁用（如刚创建的默认 EffectFormat 对象），则返回 true。只读 boolean。
...
发光效果。可读写 [IGlow](../../com.aspose.slides/iglow)。
...
内阴影。可读写 [IInnerShadow](../../com.aspose.slides/iinnershadow)。
...
外阴影。可读写 [IOuterShadow](../../com.aspose.slides/ioutershadow)。
...
反射。可读写 [IReflection](../../com.aspose.slides/ireflection)。
...
柔边缘。可读写 [ISoftEdge](../../com.aspose.slides/isoftedge)。
