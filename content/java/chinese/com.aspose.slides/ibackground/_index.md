...
| [getFillFormat()](#getFillFormat--) | 返回 FillFormat，用于 BackgroundType.OwnBackground 填充。 |
| [getEffectFormat()](#getEffectFormat--) | 返回 EffectFormat，用于 BackgroundType.OwnBackground 填充。 |
| [getStyleColor()](#getStyleColor--) | 返回 ColorFormat，用于 BackgroundType.Themed 填充。 |
...
返回 FillFormat，用于 BackgroundType.OwnBackground 填充。只读 [IFillFormat](../../com.aspose.slides/ifillformat)。
...
返回 EffectFormat，用于 BackgroundType.OwnBackground 填充。只读 [IEffectFormat](../../com.aspose.slides/ieffectformat)。
...
返回 ColorFormat，用于 BackgroundType.Themed 填充。只读 [IColorFormat](../../com.aspose.slides/icolorformat)。
...
返回 BackgroundType.Themed 填充在背景主题集合中的索引。0 表示无填充。1..999 - 索引。读/写 int。
...
**返回:**
[IBackgroundEffectiveData](../../com.aspose.slides/ibackgroundeffectivedata) - 一个 [IBackgroundEffectiveData](../../com.aspose.slides/ibackgroundeffectivedata).