...
type: docs
url: /zh/com.aspose.slides/iextracolorschemecollection/
---
**所有实现的接口：**
...
| 方法 | 描述 |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | 按索引返回配色方案。 |
...
按索引返回配色方案。只读 [IExtraColorScheme](../../com.aspose.slides/iextracolorscheme)。
