...
type: docs
url: /zh/com.aspose.slides/pptcorruptfileexception/
---
**继承：**
...
| 构造函数 | 描述 |
| --- | --- |
| [PptCorruptFileException()](#PptCorruptFileException--) | 默认构造函数。 |
| [PptCorruptFileException(String message)](#PptCorruptFileException-java.lang.String-) | 允许向此异常添加消息的构造函数。 |
| [PptCorruptFileException(String message, RuntimeException exception)](#PptCorruptFileException-java.lang.String-java.lang.RuntimeException-) | 用于包含消息和内部异常的异常的构造函数。 |
