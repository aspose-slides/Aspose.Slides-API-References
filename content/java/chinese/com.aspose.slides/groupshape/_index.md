...
| 方法 | 描述 |
| --- | --- |
| [getLineFormat()](#getLineFormat--) | 返回包含形状线格式属性的 LineFormat 对象。 |
...
返回包含形状线格式属性的 LineFormat 对象。注意：对于 GroupShape 对象返回 null，因为它们没有线属性。只读 [ILineFormat](../../com.aspose.slides/ilineformat)。
