...
type: docs
url: /zh/com.aspose.slides/pptxeditexception/
---
**继承:**
...
| 构造函数 | 描述 |
| --- | --- |
| [PptxEditException()](#PptxEditException--) | 默认构造函数。 |
| [PptxEditException(String message)](#PptxEditException-java.lang.String-) | 允许向此异常添加消息的构造函数。 |
| [PptxEditException(String message, RuntimeException exception)](#PptxEditException-java.lang.String-java.lang.RuntimeException-) | 包含消息和嵌入异常的构造函数。 |
