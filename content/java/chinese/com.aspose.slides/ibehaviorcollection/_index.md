...
| [remove(IBehavior item)](#remove-com.aspose.slides.IBehavior-) | 从集合中移除指定行为。 |
...
**返回值:**
boolean - 如果在 [IGenericCollection](../../com.aspose.slides/igenericcollection) 中找到该项则返回 true；否则返回 false.