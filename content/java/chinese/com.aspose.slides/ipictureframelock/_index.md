...
description: 确定在父 PictureFrameEx 上哪些操作被禁用。
type: docs
...
| [getArrowheadsLocked()](#getArrowheadsLocked--) | 确定是否禁止更改箭头样式。 |
| [setArrowheadsLocked(boolean value)](#setArrowheadsLocked-boolean-) | 确定是否禁止更改箭头样式。 |
...
| [getCropLocked()](#getCropLocked--) | 确定是否禁止对图像进行裁剪。 |
| [setCropLocked(boolean value)](#setCropLocked-boolean-) | 确定是否禁止对图像进行裁剪。 |
