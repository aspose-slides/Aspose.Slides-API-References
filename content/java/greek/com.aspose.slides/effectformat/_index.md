...
| [getEffective()](#getEffective--) | Παίρνει τα δεδομένα μορφοποίησης εφέ με την κληρονομικότητα εφαρμοσμένη. |
### getVersion() {#getVersion--}
```
...
Επιστρέφει true εάν όλα τα εφέ είναι απενεργοποιημένα (όπως μόλις δημιουργήθηκε, προεπιλεγμένο αντικείμενο EffectFormat). Μόνο-ανάγνωση boolean .
...
Μαλακό άκρο. Ανάγνωση/εγγραφή [ISoftEdge](../../com.aspose.slides/isoftedge).
...
Παίρνει τα δεδομένα μορφοποίησης εφέ με την κληρονομικότητα εφαρμοσμένη.
