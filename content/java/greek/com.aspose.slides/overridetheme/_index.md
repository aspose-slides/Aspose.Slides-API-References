...
description: Αναπαριστά ένα θέμα αντικατάστασης.
type: docs
url: /el/com.aspose.slides/overridetheme/
---
**Κληρονομικότητα:**  
...
| [getColorScheme()](#getColorScheme--) | Επιστρέφει το ColorScheme. |
| [getFontScheme()](#getFontScheme--) | Επιστρέφει το FontScheme. |
| [getFormatScheme()](#getFormatScheme--) | Επιστρέφει το FormatScheme. |
| [isEmpty()](#isEmpty--) | Η αληθής τιμή σημαίνει ότι το ColorScheme, το FontScheme και το FormatScheme είναι null και οποιαδήποτε αντικατάσταση με αυτό το αντικείμενο θέματος είναι απενεργοποιημένη. |
| [clear()](#clear--) | Ορίστε το ColorScheme, το FontScheme και το FormatScheme σε null για να απενεργοποιήσετε οποιαδήποτε αντικατάσταση με αυτό το αντικείμενο θέματος. |
...
Επιστρέφει το ColorScheme. Μόνο για ανάγνωση [IColorScheme](../../com.aspose.slides/icolorscheme).
...
Επιστρέφει το FontScheme. Μόνο για ανάγνωση [IFontScheme](../../com.aspose.slides/ifontscheme).
...
Επιστρέφει το FormatScheme. Μόνο για ανάγνωση [IFormatScheme](../../com.aspose.slides/iformatscheme).
...
Η αληθής τιμή σημαίνει ότι το ColorScheme, το FontScheme και το FormatScheme είναι null και οποιαδήποτε αντικατάσταση με αυτό το αντικείμενο θέματος είναι απενεργοποιημένη. Μόνο για ανάγνωση boolean.
...
Ορίστε το ColorScheme, το FontScheme και το FormatScheme σε null για να απενεργοποιήσετε οποιαδήποτε αντικατάσταση με αυτό το αντικείμενο θέματος.
