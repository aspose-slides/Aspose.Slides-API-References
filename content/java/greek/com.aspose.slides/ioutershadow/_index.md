...
| [getSkewHorizontal()](#getSkewHorizontal--) | Οριζόντια γωνία στρέβλωσης, σε μοίρες. |
| [setSkewHorizontal(double value)](#setSkewHorizontal-double-) | Οριζόντια γωνία στρέβλωσης, σε μοίρες. |
| [getSkewVertical()](#getSkewVertical--) | Κάθετη γωνία στρέβλωσης, σε μοίρες. |
| [setSkewVertical(double value)](#setSkewVertical-double-) | Κάθετη γωνία στρέβλωσης, σε μοίρες. |
...
| [getScaleHorizontal()](#getScaleHorizontal--) | Οριζόντιος παράγοντας κλιμάκωσης, σε ποσοστό του αρχικού μεγέθους. |
| [setScaleHorizontal(double value)](#setScaleHorizontal-double-) | Οριζόντιος παράγοντας κλιμάκωσης, σε ποσοστό του αρχικού μεγέθους. |
| [getScaleVertical()](#getScaleVertical--) | Κάθετος παράγοντας κλιμάκωσης, σε ποσοστό του αρχικού μεγέθους. |
| [setScaleVertical(double value)](#setScaleVertical-double-) | Κάθετος παράγοντας κλιμάκωσης, σε ποσοστό του αρχικού μεγέθους. |
...
Κατεύθυνση της σκιάς, σε μοίρες. Προεπιλεγμένη τιμή - 0 � (αριστερά προς δεξιά). Ανάγνωση/εγγραφή float.
...
Στοίχιση ορθογωνίου. Προεπιλεγμένη τιμή - [RectangleAlignment.Bottom](../../com.aspose.slides/rectanglealignment\#Bottom). Ανάγνωση/εγγραφή [RectangleAlignment](../../com.aspose.slides/rectanglealignment).
...
Οριζόντια γωνία στρέβλωσης, σε μοίρες. Προεπιλεγμένη τιμή - 0 �. Ανάγνωση/εγγραφή double.
...
Κάθετη γωνία στρέβλωσης, σε μοίρες. Προεπιλεγμένη τιμή - 0 �. Ανάγνωση/εγγραφή double.
...
Οριζόντιος παράγοντας κλιμάκωσης, σε ποσοστό του αρχικού μεγέθους. Η αρνητική κλιμάκωση προκαλεί αναστροφή. Προεπιλεγμένη τιμή - 100 %. Ανάγνωση/εγγραφή double.
...
Κάθετος παράγοντας κλιμάκωσης, σε ποσοστό του αρχικού μεγέθους. Η αρνητική κλιμάκωση προκαλεί αναστροφή. Προεπιλεγμένη τιμή - 100 %. Ανάγνωση/εγγραφή double.
