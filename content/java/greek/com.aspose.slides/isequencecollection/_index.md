...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [getCount()](#getCount--) | Επιστρέφει τον αριθμό των στοιχείων σε μια συλλογή int μόνο για ανάγνωση. |
...
| [removeAt(int index)](#removeAt-int-) | Αφαιρεί την ακολουθία στο καθορισμένο ευρετήριο. |
| [clear()](#clear--) | Αφαιρεί όλες τις ακολουθίες από μια συλλογή. |
| [get_Item(int index)](#get-Item-int-) | Επιστρέφει μια ακολουθία στο καθορισμένο ευρετήριο. |
### getCount() {#getCount--}
```
...
Επιστρέφει τον αριθμό των στοιχείων σε μια συλλογή int μόνο για ανάγνωση.
...
Αφαιρεί την ακολουθία στο καθορισμένο ευρετήριο.
...
Επιστρέφει μια ακολουθία στο καθορισμένο ευρετήριο.

**Παράμετροι:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| index | int | Δείκτης στοιχείου. |
