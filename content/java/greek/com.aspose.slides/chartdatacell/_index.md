...
| [getFormula()](#getFormula--) | Λαμβάνει ή ορίζει τον τύπο σε στυλ A1. |
| [setFormula(String value)](#setFormula-java.lang.String-) | Λαμβάνει ή ορίζει τον τύπο σε στυλ A1. |
| [getR1C1Formula()](#getR1C1Formula--) | Λαμβάνει ή ορίζει τον τύπο σε στυλ R1C1. |
| [setR1C1Formula(String value)](#setR1C1Formula-java.lang.String-) | Λαμβάνει ή ορίζει τον τύπο σε στυλ R1C1. |
| [getChartDataWorksheet()](#getChartDataWorksheet--) | Λαμβάνει το φύλλο εργασίας. |
| [isHidden()](#isHidden--) | Καθορίζει αν το κελί είναι κρυφό. |
...
| [setPresetNumberFormat(byte value)](#setPresetNumberFormat-byte-) | Λαμβάνει ή ορίζει την ενσωματωμένη μορφή εμφάνισης αριθμών και ημερομηνιών. |
...
Λαμβάνει ή ορίζει τον τύπο σε στυλ R1C1.
...
Λαμβάνει το φύλλο εργασίας. Μόνο για ανάγνωση [IChartDataWorksheet](../../com.aspose.slides/ichartdataworksheet).
...
Καθορίζει αν το κελί είναι κρυφό. Μόνο για ανάγνωση boolean.
...
Λαμβάνει ή ορίζει την ενσωματωμένη μορφή εμφάνισης αριθμών και ημερομηνιών. Ο προκαθορισμένος αριθμός πρέπει να είναι στο [0..22] ή [37..49]. Ανάγνωση/εγγραφή byte.
