...
| [getSlide()](#getSlide--) | Επιστρέφει τη γονική διαφάνεια μιας CellCollection. |
| [getPresentation()](#getPresentation--) | Επιστρέφει την γονική παρουσίαση μιας CellCollection. |
...
Επιστρέφει ένα κελί με βάση τη θέση του. Μόνο για ανάγνωση [Cell](../../com.aspose.slides/cell).

--------------------

Ένα αντικείμενο Cell μπορεί να επιστραφεί για πολλούς δείκτες σε περίπτωση που το κελί είναι συγχωνευμένο.
...
Επιστρέφει τη γονική διαφάνεια μιας CellCollection. Μόνο για ανάγνωση [IBaseSlide](../../com.aspose.slides/ibaseslide).
...
Επιστρέφει την γονική παρουσίαση μιας CellCollection. Μόνο για ανάγνωση [IPresentation](../../com.aspose.slides/ipresentation).
