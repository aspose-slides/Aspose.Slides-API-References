...
| [getColumnFormat()](#getColumnFormat--) | Επιστρέφει το αντικείμενο ColumnFormat που περιέχει τις ιδιότητες μορφοποίησης για αυτήν τη στήλη. |
### getWidth() {#getWidth--}
```
...
Επιστρέφει το αντικείμενο ColumnFormat που περιέχει τις ιδιότητες μορφοποίησης για αυτήν τη στήλη. Μόνο για ανάγνωση [IColumnFormat](../../com.aspose.slides/icolumnformat).
