...
description: Αντιπροσωπεύει μια συλλογή σημείων δεδομένων μιας σειράς.
type: docs
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Επιστρέφει το σημείο δεδομένων σειράς με βάση το δείκτη (τον σειριακό αριθμό του σε αυτή τη συλλογή). |
| [get_Item(IChartDataPoint pt)](#get-Item-com.aspose.slides.IChartDataPoint-) | Επιστρέφει τον δείκτη (σειριακό αριθμός) του σημείου δεδομένων σε αυτή τη συλλογή. |
...
| [getDataSourceTypeForErrorBarsCustomValues()](#getDataSourceTypeForErrorBarsCustomValues--) | Καθορίζει τύπους τιμών στη λίστα ιδιοτήτων ChartDataPoint.ErrorBarsCustomValues. |
| [getOrCreateDataPointByIdx(long index)](#getOrCreateDataPointByIdx-long-) | Εάν η συλλογή περιέχει ήδη σημείο δεδομένων με δείκτη index, τότε επιστρέφει αυτό το σημείο δεδομένων. |
| [size()](#size--) | Ανακτά τον αριθμό των στοιχείων που περιέχονται πραγματικά στη συλλογή. |
| [copyTo(System.Array array, int arrayIndex)](#copyTo-com.aspose.ms.System.Array-int-) | Αντιγραφή σε καθορισμένο πίνακα. |
...
Επιστρέφει το σημείο δεδομένων σειράς με βάση το δείκτη (τον σειριακό αριθμό του σε αυτή τη συλλογή).
...
Καθορίζει αν η ιδιότητα AsCell ή AsLiteralString ή AsLiteralDouble είναι ενεργή στο αντικείμενο ιδιότητας XValue των σημείων δεδομένων. Με άλλα λόγια, καθορίζει τον τύπο της τιμής της ιδιότητας ChartDataPoint.XValue.Data. Ανάγωση/εγγραφή [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Καθορίζει αν η ιδιότητα AsCell ή AsLiteralString ή AsLiteralDouble είναι ενεργή στο αντικείμενο ιδιότητας YValue των σημείων δεδομένων. Με άλλα λόγια, καθορίζει τον τύπο της τιμής της ιδιότητας ChartDataPoint.YValue.Data. Ανάγωση/εγγραφή [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Καθορίζει αν η ιδιότητα AsCell ή AsLiteralString ή AsLiteralDouble είναι ενεργή στο αντικείμενο ιδιότητας BubbleSize των σημείων δεδομένων. Με άλλα λόγια, καθορίζει τον τύπο της τιμής της ιδιότητας ChartDataPoint.BubbleSize.Data. Ανάγωση/εγγραφή [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Καθορίζει αν η ιδιότητα AsCell ή AsLiteralString ή AsLiteralDouble είναι ενεργή στο αντικείμενο ιδιότητας Value των σημείων δεδομένων. Με άλλα λόγια, καθορίζει τον τύπο της τιμής της ιδιότητας ChartDataPoint.Value.Data. Ανάγωση/εγγραφή [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Καθορίζει τύπους τιμών στη λίστα ιδιοτήτων ChartDataPoint.ErrorBarsCustomValues. Μόνο ανάγνωση [IDataSourceTypeForErrorBarsCustomValues](../../com.aspose.slides/idatasourcetypeforerrorbarscustomvalues).
...
Εάν η συλλογή περιέχει ήδη σημείο δεδομένων με δείκτη index, τότε επιστρέφει αυτό το σημείο δεδομένων. Εάν η συλλογή δεν περιέχει σημείο δεδομένων με δείκτη index==N (όταν ο αριθμός των σημείων δεδομένων σε αυτή τη συλλογή είναι μικρότερος ή ίσος του N), τότε προσθέτει ελλιπή σημεία δεδομένων και επιστρέφει το τελευταίο (το οποίο έχει ζητημένο δείκτη). Για παράδειγμα, οι δείκτες της συλλογής είναι {0, 1, 2}, και ο ζητημένος δείκτης είναι 5. Τότε η μέθοδος προσθέτει ελλιπή σημεία δεδομένων: {0, 1, 2, 3, 4, 5}. Και επιστρέφει το σημείο δεδομένων με δείκτη 5.
...
**Επιστρέφει:**
[IChartDataPoint](../../com.aspose.slides/ichartdatapoint) - Επιστρέφει το σημείο δεδομένων με τον ζητημένο δείκτη.
### size() {#size--}
```
public final int size()
```

Ανακτά τον αριθμό των στοιχείων που περιέχονται πραγματικά στη συλλογή. Μόνο ανάγνωση int.
...
**Επιστρέφει:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IChartDataPoint> - Ένας IGenericEnumerator που μπορεί να χρησιμοποιηθεί για επανάληψη στη συλλογή.
...
**Επιστρέφει:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IChartDataPoint> - Ένα java.util.Iterator για ολόκληρη τη συλλογή.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| value | double | Σημείο δεδομένων Value. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| value | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων Value. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων YValue |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| xValue | double | Σημείο δεδομένων XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων YValue |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| xValue | java.lang.String | Σημείο δεδομένων XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων YValue |
...
| --- | --- | --- |
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων XValue |
| yValue | double | Σημείο δεδομένων YValue |
...
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων YValue |
| bubbleSize | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων BubbleSize |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| xValue | java.lang.String | Στοιχείο δεδομένων XValue |
| yValue | double | Στοιχείο δεδομένων YValue |
| bubbleSize | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Στοιχείο δεδομένων BubbleSize |
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένα από τα υποτύπους Bubble (δείτε επίσης τη μέθοδο [ChartTypeCharacterizer.isChartTypeBubble(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeBubble-int-)).

**Παράμετροι:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Στοιχείο δεδομένων XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Στοιχείο δεδομένων YValue |
| bubbleSize | double | Στοιχείο δεδομένων BubbleSize |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| xValue | double | Στοιχείο δεδομένων XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Στοιχείο δεδομένων YValue |
| bubbleSize | double | Στοιχείο δεδομένων BubbleSize |
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένα από τα υποτύπους Surface (δείτε επίσης τη μέθοδο [ChartTypeCharacterizer.isChartTypeSurface(int)](../../com.aspose.slides/charttypecharacterizer\#isChartTypeSurface-int-)).

**Παράμετροι:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| value | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Στοιχείο δεδομένων Value |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| value | double | Στοιχείο δεδομένων Value |
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Sunburst.

**Παράμετροι:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| sizeValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Στοιχείο δεδομένων SizeValue |
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Treemap.
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου BoxAndWhisker.
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Waterfall.
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Histogram.
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Funnel.
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Map.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| value | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Στοιχείο δεδομένων ColorValue |
...
Αφαιρεί το στοιχείο στο συγκεκριμένο δείκτη.

**Παράμετροι:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| index | int | Δείκτης του σημείου δεδομένων προς αφαίρεση. |