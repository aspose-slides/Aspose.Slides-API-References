...
type: docs
url: /el/com.aspose.slides/pptxcorruptfileexception/
---
**Κληρονόμηση:**
...
| --- | --- |
| [PptxCorruptFileException()](#PptxCorruptFileException--) | Προεπιλεγμένος κατασκευαστής. |
| [PptxCorruptFileException(String message)](#PptxCorruptFileException-java.lang.String-) | Κατασκευαστής που επιτρέπει την προσθήκη μηνύματος σε αυτήν την εξαίρεση. |
| [PptxCorruptFileException(String message, RuntimeException exception)](#PptxCorruptFileException-java.lang.String-java.lang.RuntimeException-) | Κατασκευαστής για μια εξαίρεση που περιέχει ένα μήνυμα και μια ενσωματωμένη εξαίρεση. |
