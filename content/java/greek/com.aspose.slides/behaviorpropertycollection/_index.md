...
description: Αντιπροσωπεύει τις ιδιότητες χρονομέτρησης για τη συμπεριφορά του εφέ.
type: docs
...
Αντιπροσωπεύει τις ιδιότητες χρονομέτρησης για τη συμπεριφορά του εφέ.
## Μέθοδοι
...
| [indexOf(IBehaviorProperty item)](#indexOf-com.aspose.slides.IBehaviorProperty-) | Καθορίζει το δείκτη ενός συγκεκριμένου αντικειμένου στη Λίστα. |
| [indexOf(String propertyValue)](#indexOf-java.lang.String-) | Καθορίζει το δείκτη ενός συγκεκριμένου αντικειμένου με βάση την τιμή της ιδιότητας στη Λίστα. |
| [insert(int index, IBehaviorProperty item)](#insert-int-com.aspose.slides.IBehaviorProperty-) | Εισάγει μια νέα ιδιότητα στη συλλογή στην καθορισμένη θέση. |
| [insert(int index, String propertyValue)](#insert-int-java.lang.String-) | Εισάγει μια νέα ιδιότητα (με την καθορισμένη τιμή ιδιότητας) στη συλλογή στην καθορισμένη θέση. |
| [copyTo(IBehaviorProperty[] array, int arrayIndex)](#copyTo-com.aspose.slides.IBehaviorProperty---int-) | Αντιγράφει τα στοιχεία του [IGenericCollection](../../com.aspose.slides/igenericcollection) σε έναν Πίνακα, ξεκινώντας από ένα συγκεκριμένο δείκτη Πίνακα. |
...
| [removeAt(int index)](#removeAt-int-) | Αφαιρεί την ιδιότητα στην καθορισμένη θέση. |
...
| [get_Item(int index)](#get-Item-int-) | Επιστρέφει μια ιδιότητα στην καθορισμένη θέση. |
| [set_Item(int index, IBehaviorProperty value)](#set-Item-int-com.aspose.slides.IBehaviorProperty-) | Ορίζει μια ιδιότητα στην καθορισμένη θέση. |
...
| --- | --- | --- |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | Ιδιότητα για προσθήκη. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| propertyValue | java.lang.String | Τιμή της ιδιότητας για προσθήκη. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | Το αντικείμενο για να εντοπιστεί στη Λίστα. |

**Επιστρέφει:**
int - Ο δείκτης του αντικειμένου αν βρεθεί στη λίστα· διαφορετικά, -1.
...
Καθορίζει το δείκτη ενός συγκεκριμένου αντικειμένου με βάση την τιμή της ιδιότητας στη Λίστα.
...
**Επιστρέφει:**
int - Το δείκτης της ιδιότητας με την καθορισμένη τιμή
...
Εισάγει μια νέα ιδιότητα στη συλλογή στην καθορισμένη θέση.
...
Εισάγει μια νέα ιδιότητα (με την καθορισμένη τιμή ιδιότητας) στη συλλογή στην καθορισμένη θέση.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| array | [IBehaviorProperty\[\]](../../com.aspose.slides/ibehaviorproperty) | Ο μονοδιάστατος Πίνακας που είναι ο προορισμός των στοιχείων που αντιγράφηκαν από το [IGenericCollection](../../com.aspose.slides/igenericcollection). Ο Πίνακας πρέπει να έχει μηδενική δεικτοδότηση. |
| arrayIndex | int | Ο μηδενικός δείκτης στο array από όπου ξεκινά η αντιγραφή. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | Ιδιότητα για αφαίρεση. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| propertyValue | java.lang.String | Τιμή της ιδιότητας για αφαίρεση. |
...
Αφαιρεί την ιδιότητα στην καθορισμένη θέση.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | Η ιδιότητα για εντοπισμό στο [IGenericCollection](../../com.aspose.slides/igenericcollection). |
...
**Επιστρέφει:**
boolean - true εάν propertyValue βρεθεί στο [IGenericCollection](../../com.aspose.slides/igenericcollection)· διαφορετικά, false.
...
Επιστρέφει μια ιδιότητα στην καθορισμένη θέση.

**Παράμετροι:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| index | int | Δείκτης μιας ιδιότητας για επιστροφή. |

**Επιστρέφει:**
[IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) - Ιδιότητα συμπεριφοράς animation.
...
Ορίζει μια ιδιότητα στην καθορισμένη θέση.
...
**Επιστρέφει:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IBehaviorProperty> - Ένας IGenericEnumerator που μπορεί να χρησιμοποιηθεί για την επανάληψη στη συλλογή.
