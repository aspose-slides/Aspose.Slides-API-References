...
description: Καθορίζει μια παρουσία κειμένου μαθηματικού που περιέχεται σε ένα MathParagraph και αρχίζει σε ξεχωριστή γραμμή.
type: docs
...
Καθορίζει μια παρουσία κειμένου μαθηματικού που περιέχεται σε ένα MathParagraph και αρχίζει σε ξεχωριστή γραμμή. Όλες οι ζώνες μαθηματικών, συμπεριλαμβανομένων των εξισώσεων, εκφράσεων, πινάκων εξισώσεων ή εκφράσεων και τύπων, αντιπροσωπεύονται από μπλοκ μαθηματικών.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [delimit(char separatorCharacter)](#delimit-char-) | Οριοθετεί όλα τα παιδικά στοιχεία με χαρακτήρα διαχωριστή (χωρίς τις αγκύλες) |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | Περιβάλλει τα παιδικά στοιχεία αυτού του μπλοκ σε καθορισμένους χαρακτήρες, όπως παρενθέσεις ή άλλους, ως πλαίσιο και οριοθετεί με χαρακτήρα διαχωριστή |
...
Οριοθετεί όλα τα παιδικά στοιχεία με χαρακτήρα διαχωριστή (χωρίς τις αγκύλες)
...
| --- | --- | --- |
| separatorCharacter | char | Χαρακτήρας που χρησιμοποιείται ως διαχωριστής |

**Επιστρέφει:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - Παράδειγμα του στοιχείου IMathDelimiter
...
Περιβάλλει τα παιδικά στοιχεία αυτού του μπλοκ σε καθορισμένους χαρακτήρες, όπως παρενθέσεις ή άλλους, ως πλαίσιο και οριοθετεί με χαρακτήρα διαχωριστή
...
**Επιστρέφει:**
[IMathBlock](../../com.aspose.slides/imathblock) - αυτό το μαθηματικό μπλοκ μετά τη σύνδεση
