...
description: Αναπαριστά μια συλλογή των TrendlineEx
type: docs
...
Αναπαριστά μια συλλογή των TrendlineEx
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Παίρνει το στοιχείο στο καθορισμένο δείκτη. |
| [getCount()](#getCount--) | Παίρνει τον αριθμό των στοιχείων που πραγματικά περιέχονται στη συλλογή. |
...
Παίρνει το στοιχείο στο καθορισμένο δείκτη. Μόνο για ανάγνωση [ITrendline](../../com.aspose.slides/itrendline).
...
Παίρνει τον αριθμό των στοιχείων που πραγματικά περιέχονται στη συλλογή. Μόνο για ανάγνωση int.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| value | [ITrendline](../../com.aspose.slides/itrendline) | Trendline προς αφαίρεση [ITrendline](../../com.aspose.slides/itrendline) |