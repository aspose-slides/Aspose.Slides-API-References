...
Αναπαριστά τη συμπεριφορά του ιδιότητας εφέ.
## Μέθοδοι
...
| [getTo()](#getTo--) | Καθορίζει την τελική τιμή του animation. |
| [setTo(String value)](#setTo-java.lang.String-) | Καθορίζει την τελική τιμή του animation. |
| [getBy()](#getBy--) | Καθορίζει μια σχετική τιμή μετατόπισης για το animation σε σχέση με τη θέση του πριν την έναρξη του animation. |
| [setBy(String value)](#setBy-java.lang.String-) | Καθορίζει μια σχετική τιμή μετατόπισης για το animation σε σχέση με τη θέση του πριν την έναρξη του animation. |
...
Καθορίζει την τελική τιμή του animation. Ανάγνωση/εγγραφή String.
...
Καθορίζει μια σχετική τιμή μετατόπισης για το animation σε σχέση με τη θέση του πριν την έναρξη του animation. Ανάγνωση/εγγραφή String.
