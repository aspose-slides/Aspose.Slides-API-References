...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [getColor()](#getColor--) | Επιστρέφει μορφή χρώματος που θα αντικαταστήσει το χρώμα κάθε pixel. |
| [getEffective()](#getEffective--) | Λαμβάνει τα αποτελεσματικά δεδομένα του εφέ Αντικατάστασης Χρώματος με την κληρονομία να έχει εφαρμοστεί. |
| [getVersion()](#getVersion--) |  |
| [equals(Object obj)](#equals-java.lang.Object-) | Καθορίζει αν το συγκεκριμένο [ColorReplace](../../com.aspose.slides/colorreplace) είναι ίσο με το τρέχον [ColorReplace](../../com.aspose.slides/colorreplace). |
...
Επιστρέφει μορφή χρώματος που θα αντικαταστήσει το χρώμα κάθε pixel. Μόνο-ανάγνωση [IColorFormat](../../com.aspose.slides/icolorformat).
...
Λαμβάνει τα αποτελεσματικά δεδομένα του εφέ Αντικατάστασης Χρώματος με την κληρονομία να έχει εφαρμοστεί.
...
Καθορίζει αν το συγκεκριμένο [ColorReplace](../../com.aspose.slides/colorreplace) είναι ίσο με το τρέχον [ColorReplace](../../com.aspose.slides/colorreplace).
