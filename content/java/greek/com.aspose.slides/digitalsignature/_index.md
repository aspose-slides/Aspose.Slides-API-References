...
>  try {
>     // Δημιουργία DigitalSignature αντικειμένου με αρχείο PFX και κωδικό PFX
>      DigitalSignature signature = new DigitalSignature("testsignature1.pfx", "testpass1");
>      // Σχόλιο στην νέα ψηφιακή υπογραφή
...
| [DigitalSignature(String filePath, String password)](#DigitalSignature-java.lang.String-java.lang.String-) | Δημιουργεί ένα νέο αντικείμενο DigitalSignature με τη συγκεκριμένη διαδρομή αρχείου πιστοποιητικού και κωδικό πρόσβασης. |
## Μέθοδοι
...
| [getSignTime()](#getSignTime--) | Ο χρόνος κατά τον οποίο υπογράφηκε το έγγραφο. |
...
| password | java.lang.String | Κωδικός πρόσβασης που απαιτείται για την πρόσβαση στο πιστοποιητικό. |
...
Δημιουργεί ένα νέο αντικείμενο DigitalSignature με τη συγκεκριμένη διαδρομή αρχείου πιστοποιητικού και κωδικό πρόσβασης.
...
Ο χρόνος κατά τον οποίο υπογράφηκε το έγγραφο. Μόνο για ανάγνωση java.util.Date.
