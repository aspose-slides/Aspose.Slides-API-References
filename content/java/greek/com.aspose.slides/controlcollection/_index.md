...
| [isSynchronized()](#isSynchronized--) | Επιστέφει μια τιμή που υποδεικνύει αν η πρόσβαση στη συλλογή είναι συγχρονισμένη (thread-safe). |
| [getSyncRoot()](#getSyncRoot--) | Επιστέφει μια ρίζα συγχρονισμού. |
...
Επιστρέφει τον αριθμό των αντικειμένων στη συλλογή. Μόνο ανάγνωση int.
...
| --- | --- | --- |
| controlType | int | Τύπος του ελέγχου προς προσθήκη. |
...
**Επιστρέφει:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IControl> - Ένα IGenericEnumerator που μπορεί να χρησιμοποιηθεί για την επανάληψη στη συλλογή.
...
Επιστέφει μια τιμή που υποδεικνύει αν η πρόσβαση στη συλλογή είναι συγχρονισμένη (thread-safe). Μόνο ανάγνωση boolean.
...
Επιστέφει μια ρίζα συγχρονισμού. Μόνο ανάγνωση Object.
...
Επιστέφει το αντικείμενο Parent_Immediate. Μόνο ανάγνωση IDOMObject.
