...
description: Καθορίζει το αντικείμενο υποδείκτη το οποίο αποτελείται από μια βάση και έναν μειωμένου μεγέθους υποδείκτη τοποθετημένο κάτω και δεξιά.
type: docs
...
Καθορίζει το αντικείμενο υποδείκτη, το οποίο αποτελείται από μια βάση και έναν μειωμένου μεγέθους υποδείκτη που τοποθετείται κάτω και δεξιά.
...
| --- | --- |
| [MathSubscriptElement(IMathElement baseArg, IMathElement subScript)](#MathSubscriptElement-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-) | Δημιουργεί ένα νέο αντικείμενο της κλάσης MathSubscriptElement. |
## Μέθοδοι
...
Δημιουργεί ένα νέο αντικείμενο της κλάσης MathSubscriptElement.
