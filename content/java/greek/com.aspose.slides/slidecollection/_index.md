...
| [addClone(ISlide sourceSlide, IMasterSlide destMaster, boolean allowCloneMissingLayout)](#addClone-com.aspose.slides.ISlide-com.aspose.slides.IMasterSlide-boolean-) | Προσθέτει ένα αντίγραφο μιας συγκεκριμένης πηγής διαφάνειας στο τέλος της συλλογής. |
| [insertClone(int index, ISlide sourceSlide, IMasterSlide destMaster, boolean allowCloneMissingLayout)](#insertClone-int-com.aspose.slides.ISlide-com.aspose.slides.IMasterSlide-boolean-) | Εισάγει ένα αντίγραφο μιας συγκεκριμένης πηγής διαφάνειας στη καθορισμένη θέση της συλλογής. |
...
| [iterator()](#iterator--) | Επιστρέφει έναν εναλλάκτη που διατρέχει τη συλλογή. |
...
| [isSynchronized()](#isSynchronized--) | Επιστρέφει μια τιμή που υποδεικνύει αν η πρόσβαση στη συλλογή είναι συγχρονισμένη (ασφαλής για νήματα). |
...
Επιστρέφει το στοιχείο στον καθορισμένο δείκτη. Μόνο ανάγνωση [Slide](../../com.aspose.slides/slide).
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| sourceSlide | [ISlide](../../com.aspose.slides/islide) | Διαφάνεια για κλωνοποίηση. |

--------------------

Κατά την κλωνοποίηση μιας διαφάνειας μεταξύ διαφορετικών παρουσιάσεων, ο master της διαφάνειας μπορεί επίσης να κλωνοποιηθεί. Χρησιμοποιείται εσωτερικό μητρώο για την παρακολούθηση αυτόματα κλωνοποιημένων master ώστε να αποτραπεί η δημιουργία πολλαπλών κλώνων του ίδιου master slide. Η χειροκίνητη κλωνοποίηση των master slides δεν θα αποτραπεί ούτε θα καταγραφεί. Εάν χρειάζεστε μεγαλύτερο έλεγχο στη διαδικασία κλωνοποίησης, χρησιμοποιήστε \#addClone(ISlide,ILayoutSlide).addClone(ISlide,ILayoutSlide) ή \#addClone(ISlide,IMasterSlide,boolean).addClone(ISlide,IMasterSlide,boolean) για κλωνοποίηση διαφανειών, [IGlobalLayoutSlideCollection.addClone(ILayoutSlide)](../../com.aspose.slides/igloballayoutslidecollection\#addClone-ILayoutSlide-) ή [IGlobalLayoutSlideCollection.addClone(ILayoutSlide,IMasterSlide)](../../com.aspose.slides/igloballayoutslidecollection\#addClone-ILayoutSlide-IMasterSlide-) για κλωνοποίηση διατάξεων και [IMasterSlideCollection.addClone(IMasterSlide)](../../com.aspose.slides/imasterslidecollection\#addClone-IMasterSlide-) για κλωνοποίηση master.
...
Κατά την κλωνοποίηση μιας διαφάνειας μεταξύ διαφορετικών παρουσιάσεων, ο master της διαφάνειας μπορεί επίσης να κλωνοποιηθεί. Χρησιμοποιείται εσωτερικό μητρώο για την παρακολούθηση αυτόματα κλωνοποιημένων master ώστε να αποτραπεί η δημιουργία πολλαπλών κλώνων του ίδιου master slide. Η χειροκίνητη κλωνοποίηση των master slides δεν θα αποτραπεί ούτε θα καταγραφεί. Εάν χρειάζεστε μεγαλύτερο έλεγχο στη διαδικασία κλωνοποίησης, χρησιμοποιήστε \#insertClone(int,ISlide,ILayoutSlide).insertClone(int,ISlide,ILayoutSlide) ή \#insertClone(int,ISlide,IMasterSlide,boolean).insertClone(int,ISlide,IMasterSlide,boolean) για κλωνοποίηση διαφανειών και [IMasterSlideCollection.addClone(IMasterSlide)](../../com.aspose.slides/imasterslidecollection\#addClone-IMasterSlide-) για κλωνοποίηση master.
...
| --- | --- | --- |
| sourceSlide | [ISlide](../../com.aspose.slides/islide) | Διαφάνεια για κλωνοποίηση. |
| destLayout | [ILayoutSlide](../../com.aspose.slides/ilayoutslide) | Διάταξη για τη νέα διαφάνεια. |
...
Προσθέτει ένα αντίγραφο μιας συγκεκριμένης πηγής διαφάνειας στο τέλος της συλλογής. Η κατάλληλη διάταξη θα επιλεγεί αυτόματα από τον καθορισμένο master (η κατάλληλη διάταξη είναι αυτή που έχει τον ίδιο Type ή Name με τη διάταξη της πηγής διαφάνειας). Εάν δεν υπάρχει κατάλληλη διάταξη, η διάταξη της πηγής διαφάνειας θα κλωνοποιηθεί (αν το allowCloneMissingLayout είναι true) ή θα ριχθεί PptxEditException (αν είναι false).

**Παράμετροι:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| sourceSlide | [ISlide](../../com.aspose.slides/islide) | Διαφάνεια για κλωνοποίηση. |
| destMaster | [IMasterSlide](../../com.aspose.slides/imasterslide) | Master slide για τη νέα διαφάνεια. |
| allowCloneMissingLayout | boolean | Εάν δεν υπάρχει κατάλληλη διάταξη στον καθορισμένο master, η διάταξη της πηγής διαφάνειας θα κλωνοποιηθεί (αν είναι true) ή θα ριχθεί PptxEditException (αν είναι false). |
...
Εισάγει ένα αντίγραφο μιας συγκεκριμένης πηγής διαφάνειας στη καθορισμένη θέση της συλλογής. Η κατάλληλη διάταξη θα επιλεγεί αυτόματα από τον καθορισμένο master (η κατάλληλη διάταξη είναι αυτή που έχει τον ίδιο Type ή Name με τη διάταξη της πηγής διαφάνειας). Εάν δεν υπάρχει κατάλληλη διάταξη, η διάταξη της πηγής διαφάνειας θα κλωνοποιηθεί (αν το allowCloneMissingLayout είναι true) ή θα ριχθεί PptxEditException (αν είναι false).
...
Επιστρέφει έναν εναλλάκτη που διατρέχει τη συλλογή.

**Επιστρέφει:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISlide> - Ένας IGenericEnumerator που μπορεί να χρησιμοποιηθεί για την επανάληψη στη συλλογή.
...
**Επιστρέφει:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISlide> - Ένα java.util.Iterator για ολόκληρη τη συλλογή.
...
**Επιστρέφει:**
com.aspose.slides.ISlide[] - Πίνακας του [Slide](../../com.aspose.slides/slide)
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| startIndex | int | Δείκτης της πρώτης διαφάνειας που θα προστεθεί. |
| count | int | Αριθμός διαφανειών που θα προστεθούν. |
...
Μετακινεί διαφάνειες από τη συλλογή στη καθορισμένη θέση. Οι διαφάνειες θα τοποθετηθούν ξεκινώντας από το index με τη σειρά που εμφανίζονται στη λίστα.
...
Επιστρέφει έναν δείκτη της συγκεκριμένης διαφάνειας στη συλλογή.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| pdfStream | java.io.InputStream | Ροή που θα χρησιμοποιηθεί ως πηγή του εγγράφου PDF |
...
| resolver | [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver) | Αντικείμενο callback που χρησιμοποιείται για την ανάκτηση εξωτερικών αντικειμένων. Εάν αυτή η παράμετρος είναι null, όλα τα εξωτερικά αντικειμένα θα αγνοηθούν. |
| uri | java.lang.String | URI του συγκεκριμένου HTML. Χρησιμοποιείται για την επίλυση σχετικών συνδέσμων. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| htmlStream | java.io.InputStream | Αντικείμενο Stream που θα χρησιμοποιηθεί ως πηγή ενός αρχείου HTML. |
| resolver | [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver) | Αντικείμενο callback που χρησιμοποιείται για την ανάκτηση εξωτερικών αντικειμένων. Εάν αυτή η παράμετρος είναι null, όλα τα εξωτερικά αντικειμένα θα αγνοηθούν. |
| uri | java.lang.String | URI του συγκεκριμένου HTML. Χρησιμοποιείται για την επίλυση σχετικών συνδέσμων. |
...
>      // Κλήση της μεθόδου AddFromHtml και μεταβίβαση του αρχείου HTML.
>      pres.getSlides().addFromHtml(html);
>      // Χρήση της μεθόδου Save για αποθήκευση του αρχείου ως έγγραφο PowerPoint.
...
| resolver | [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver) | Αντικείμενο callback που χρησιμοποιείται για την ανάκτηση εξωτερικών αντικειμένων. Εάν αυτή η παράμετρος είναι null, όλα τα εξωτερικά αντικειμένα θα αγνοηθούν. |
| uri | java.lang.String | URI του συγκεκριμένου HTML. Χρησιμοποιείται για την επίλυση σχετικών συνδέσμων. |
| useSlideWithIndexAsStart | boolean | Αυτή η σημαία καθορίζει πώς θα ξεκινήσει η εισαγωγή: από μια νέα διαφάνεια ή από τη διαφάνεια με το καθορισμένο δείκτη. Εάν **true**, τότε η εισαγωγή δεδομένων θα αρχίσει από ένα κενό χώρο στη διαφάνεια με το καθορισμένο δείκτη. Εάν **false**, τότε τα δεδομένα θα προστεθούν στις δημιουργημένες διαφάνειες. |
...
Επιστρέφει μια τιμή που υποδεικνύει εάν η πρόσβαση στη συλλογή είναι συγχρονισμένη (ασφαλής για νήματα). Μόνο για ανάγνωση boolean.
...
Επιστρέφει έναν ριζικό αντικειμενικό συγχρονισμού. Μόνο για ανάγνωση Object.
