...
description: Αντιπροσωπεί τη διάταξη παρουσίασης σημειώσεων για εξαγωγή.
type: docs
...
Αντιπροσωπεί τη διάταξη παρουσίασης σημειώσεων για εξαγωγή.
## Κατασκευαστές
...
| [getPrintSlideNumbers()](#getPrintSlideNumbers--) | Καθορίζει αν θα εκτυπωθούν ή όχι οι εμφανιζόμενοι αριθμοί διαφανειών. |
| [setPrintSlideNumbers(boolean value)](#setPrintSlideNumbers-boolean-) | Καθορίζει αν θα εκτυπωθούν ή όχι οι εμφανιζόμενοι αριθμοί διαφανειών. |
| [getPrintFrameSlide()](#getPrintFrameSlide--) | Καθορίζει αν θα σχεδιαστούν ή όχι περιγράμματα γύρω από τις εμφανιζόμενες διαφάνειες. |
| [setPrintFrameSlide(boolean value)](#setPrintFrameSlide-boolean-) | Καθορίζει αν θα σχεδιαστούν ή όχι περιγράμματα γύρω από τις εμφανιζόμενες διαφάνειες. |
...
Καθορίζει αν θα εκτυπωθούν ή όχι οι εμφανιζόμενοι αριθμοί διαφανειών.
...
Καθορίζει αν θα σχεδιαστούν ή όχι περιγράμματα γύρω από τις εμφανιζόμενες διαφάνειες.
