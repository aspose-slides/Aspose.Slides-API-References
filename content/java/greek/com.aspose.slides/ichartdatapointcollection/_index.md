...
description: Αντιπροσωπεύει τη συλλογή σημείων δεδομένων μιας σειράς.
type: docs
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Επιστρέφει το σημείο δεδομένων σειράς με βάση το ευρετήριο (τον σειριακό αριθμό του στη συλλογή). |
| [get_Item(IChartDataPoint pt)](#get-Item-com.aspose.slides.IChartDataPoint-) | Επιστρέφει το ευρετήριο (τον σειριακό αριθμό στη συλλογή) του σημείου δεδομένων στη συλλογή. |
...
Επιστρέφει το σημείο δεδομένων σειράς με βάση το ευρετήριο (τον σειριακό αριθμό του στη συλλογή).
...
Επιστρέφει το ευρετήριο (τον σειριακό αριθμό στη συλλογή) του σημείου δεδομένων στη συλλογή.
...
Καθορίζει εάν η ιδιότητα AsCell ή AsLiteralString ή ΑsLiteralDouble είναι ενεργή στο αντικείμενο ιδιότητας YValue των σημείων δεδομένων. Με άλλα λόγια καθορίζει τον τύπο της τιμής της ιδιότητας ChartDataPointEx.YValue.Data. Ανάγνωση/Εγγραφή [DataSourceType](../../com.aspose.slides/datasourcetype).
...
Εάν η συλλογή περιέχει ήδη σημείο δεδομένων με το ευρετήριο index, τότε επιστρέφει αυτό το σημείο δεδομένων. Εάν η συλλογή δεν περιέχει σημείο δεδομένων με ευρετήριο index==N (όταν ο αριθμός των σημείων δεδομένων στη συλλογή είναι μικρότερος ή ίσος με N), τότε προσθέτει ελλιπή σημεία δεδομένων και επιστρέφει το τελευταίο (το οποίο έχει το ζητούμενο ευρετήριο). Για παράδειγμα, τα ευρετήρια της συλλογής είναι \{0, 1, 2\}, και το ζητούμενο ευρετήριο είναι 5. Τότε η μέθοδος προσθέτει ελλιπή σημεία δεδομένων: \{0, 1, 2, 3, 4, 5\}. Και επιστρέφει το σημείο δεδομένων με ευρετήριο 5.

**Παράμετροι:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| index | long | Ευρετήριο. |
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Εφαρμόσιμο για σειρές των οποίων το chartType είναι ένας από τους τύπους Stock (δείτε επίσης τη μέθοδο ChartTypeCharacterizer.IsChartTypeStock(ChartType)).
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Εφαρμόσιμο για σειρές των οποίων το chartType είναι ένας από τους τύπους Line (δείτε επίσης τη μέθοδο ChartTypeCharacterizer.IsChartTypeLine(ChartType)).
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Εφαρμόσιμο για σειρές των οποίων το chartType είναι ένας από τους τύπους Scatter (δείτε επίσης τη μέθοδο ChartTypeCharacterizer.IsChartTypeScatter(ChartType)).
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Scatter (δείτε επίσης ChartTypeCharacterizer.IsChartTypeScatter(ChartType) method).
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Radar (δείτε επίσης ChartTypeCharacterizer.IsChartTypeRadar(ChartType) method).
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Column ή Bar (δείτε επίσης ChartTypeCharacterizer.IsChartTypeColumn(ChartType) και ChartTypeCharacterizer.IsChartTypeBar(ChartType) method).
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Area (δείτε επίσης ChartTypeCharacterizer.IsChartTypeArea(ChartType) method).
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Pie (δείτε επίσης ChartTypeCharacterizer.IsChartTypePie(ChartType) method).
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Doughnut (δείτε επίσης ChartTypeCharacterizer.IsChartTypeDoughnut(ChartType) method).
...
Δημιουργεί το νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Bubble (δείτε επίσης ChartTypeCharacterizer.IsChartTypeBubble(ChartType) method).
...
```
Δημιουργεί ένα νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Bubble (βλ. επίσης τη μέθοδο ChartTypeCharacterizer.IsChartTypeBubble(ChartType)).
...
| xValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων XValue |
| yValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων YValue |
| bubbleSize | double | Σημείο δεδομένων BubbleSize |
...
Δημιουργεί ένα νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές των οποίων το chartType είναι ένας από τους υποτύπους Surface (βλ. επίσης τη μέθοδο ChartTypeCharacterizer.IsChartTypeSurface(ChartType)).
...
Δημιουργεί ένα νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Sunburst.

**Παράμετροι:**
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| sizeValue | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων SizeValue |
...
Δημιουργεί ένα νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Waterfall.
...
Δημιουργεί ένα νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου BoxAndWhisker.
...
Δημιουργεί ένα νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Treemap.
...
Δημιουργεί ένα νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Histogram.
...
Δημιουργεί ένα νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Funnel.
...
Δημιουργεί ένα νέο σημείο δεδομένων και το προσθέτει στο τέλος της συλλογής. Ισχύει για σειρές του τύπου Map.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| value | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Σημείο δεδομένων ColorValue |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| index | int | Δείκτης σημείου δεδομένων προς αφαίρεση. |