...
description: Αναπαριστά μια συλλογή ψηφιακών υπογραφών που είναι συνδεδεμένες με ένα έγγραφο.
type: docs
...
| [removeAt(int index)](#removeAt-int-) | Αφαιρεί την υπογραφή στον καθορισμένο δείκτη. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| signature | [IDigitalSignature](../../com.aspose.slides/idigitalsignature) | Υπογραφή προς προσθήκη. |
...
| index | int | Αρχικός δείκτης στο πίνακα-στόχο. |