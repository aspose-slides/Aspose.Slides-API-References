...
description: Αναπαριστά κείμενο που μπορεί να αντικατασταθεί για ένα διάγραμμα.
type: docs
...
Αναπαριστά κείμενο που μπορεί να αντικατασταθεί για ένα διάγραμμα.
## Methods
