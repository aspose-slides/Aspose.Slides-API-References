...
description: Αντιπροσωπεύει μια συλλογή επιπλέον σχημάτων χρώματος.
type: docs
...
Αναπαριστά μια συλλογή πρόσθετων συνόλων χρωμάτων.
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [size()](#size--) | Επιστρέφει έναν αριθμό στοιχείων στη συλλογή. |
| [get_Item(int index)](#get-Item-int-) | Επιστρέφει ένα σύνολο χρωμάτων βάσει δείκτη. |
...
Επιστρέφει έναν αριθμό στοιχείων στη συλλογή. Μόνο για ανάγνωση int.
...
Επιστρέφει ένα σύνολο χρωμάτων βάσει δείκτη. Μόνο για ανάγνωση [ExtraColorScheme](../../com.aspose.slides/extracolorscheme).
...
**Επιστρέφει:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IExtraColorScheme> - Ένας IGenericEnumerator που μπορεί να χρησιμοποιηθεί για την επανάληψη της συλλογής.
...
Επιστρέφει μια τιμή που υποδεικνύει αν η πρόσβαση στο ArrayList είναι συγχρονισμένη (thread safe). Μόνο για ανάγνωση boolean.
