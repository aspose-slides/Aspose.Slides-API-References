...
description: Αναπαριστά προκαθορισμένα χρώματα συστήματος.
type: docs
url: /el/com.aspose.slides/systemcolor/
---
**Κληρονομικότητα:**
...
| Πεδίο | Περιγραφή |
| --- | --- |
| [NotDefined](#NotDefined) | Το σύστημα χρώματος δεν έχει οριστεί. |
| [ScrollBar](#ScrollBar) |  |
...
Το σύστημα χρώματος δεν έχει οριστεί.
