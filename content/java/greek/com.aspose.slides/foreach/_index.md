...
description: Αντιπροσωπεύει μια ομάδα μεθόδων που προορίζονται για επανάληψη πάνω σε διαφορετικά αντικείμενα μοντέλου.
type: docs
...
Αντιπροσωπεύει μια ομάδα μεθόδων που προορίζονται για επανάληψη πάνω σε διαφορετικά [Presentation](../../com.aspose.slides/presentation) αντικείμενα μοντέλου. Αυτές οι μέθοδοι μπορεί να είναι χρήσιμες εάν χρειάζεται να επαναλάβετε και να αλλάξετε τη μορφοποίηση ή το περιεχόμενο κάποιων στοιχείων της Presentation, π.χ. να αλλάξετε τη μορφοποίηση κάθε τμήματος.
...
| --- | --- | --- |
| pres | [Presentation](../../com.aspose.slides/presentation) | Presentation για επανάληψη διαφανειών |
| forEachSlide | [ForEachSlideCallback](../../com.aspose.slides/foreachslidecallback) | Callback που θα κληθεί για κάθε διαφάνεια |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| pres | [Presentation](../../com.aspose.slides/presentation) | Presentation για επανάληψη master διαφανειών |
| forEachMasterSlide | [ForEachMasterSlideCallback](../../com.aspose.slides/foreachmasterslidecallback) | Callback που θα κληθεί για κάθε master διαφάνεια |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| pres | [Presentation](../../com.aspose.slides/presentation) | Presentation για επανάληψη layout διαφανειών |
| forEachLayoutSlide | [ForEachLayoutSlideCallback](../../com.aspose.slides/foreachlayoutslidecallback) | Callback που θα κληθεί για κάθε layout διαφάνεια |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| pres | [Presentation](../../com.aspose.slides/presentation) | Presentation για επανάληψη layout σχημάτων |
| forEachShape | [ForEachShapeCallback](../../com.aspose.slides/foreachshapecallback) | Callback που θα κληθεί για κάθε σχήμα |

Τα σχήματα θα επαναληφθούν σε όλους τους τύπους διαφανειών - \#slide(Presentation,ForEachSlideCallback).slide(Presentation,ForEachSlideCallback), \#masterSlide(Presentation,ForEachMasterSlideCallback).masterSlide(Presentation,ForEachMasterSlideCallback) και \#layoutSlide(Presentation,ForEachLayoutSlideCallback).layoutSlide(Presentation,ForEachLayoutSlideCallback) |
...
Τα σχήματα θα επαναληφθούν σε όλους τους τύπους διαφανειών - \#slide(Presentation,ForEachSlideCallback).slide(Presentation,ForEachSlideCallback), \#masterSlide(Presentation,ForEachMasterSlideCallback).masterSlide(Presentation,ForEachMasterSlideCallback), \#layoutSlide(Presentation,ForEachLayoutSlideCallback).layoutSlide(Presentation,ForEachLayoutSlideCallback) και [NotesSlide](../../com.aspose.slides/notesslide) εφόσον απαιτείται. |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| baseSlide | [BaseSlide](../../com.aspose.slides/baseslide) | Slide για επανάληψη layout σχημάτων |
| forEachShape | [ForEachShapeCallback](../../com.aspose.slides/foreachshapecallback) | Callback που θα κληθεί για κάθε σχήμα |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| pres | [Presentation](../../com.aspose.slides/presentation) | Presentation για επανάληψη παραγράφων |
| forEachParagraph | [ForEachParagraphCallback](../../com.aspose.slides/foreachparagraphcallback) | Callback που θα κληθεί για κάθε παράγραφο |
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| pres | [Presentation](../../com.aspose.slides/presentation) | Presentation για επανάληψη τμημάτων |
| forEachPortion | [ForEachPortionCallback](../../com.aspose.slides/foreachportioncallback) | Callback που θα κληθεί για κάθε τμήμα |

Τα τμήματα θα επαναληφθούν σε όλους τους τύπους διαφανειών - \#slide(Presentation,ForEachSlideCallback).slide(Presentation,ForEachSlideCallback), \#masterSlide(Presentation,ForEachMasterSlideCallback).masterSlide(Presentation,ForEachMasterSlideCallback) και \#layoutSlide(Presentation,ForEachLayoutSlideCallback).layoutSlide(Presentation,ForEachLayoutSlideCallback) |
