...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [isFormatNotDefined()](#isFormatNotDefined--) | Επιστρέφει true εάν η μορφή της γραμμής δεν είναι ορισμένη (όπως μόλις δημιουργήθηκε, προεπιλογή). |
| [getFillFormat()](#getFillFormat--) | Επιστρέφει τη μορφή γέμισης μιας γραμμής. |
...
| [getDashStyle()](#getDashStyle--) | Επιστρέφει ή ορίζει το στυλ παύσεων της γραμμής. |
| [setDashStyle(byte value)](#setDashStyle-byte-) | Επιστρέφει ή ορίζει το στυλ παύσεων της γραμμής. |
| [getCustomDashPattern()](#getCustomDashPattern--) | Επιστρέφει ή ορίζει το προσαρμοσμένο μοτίβο παύσεων. |
| [setCustomDashPattern(float[] value)](#setCustomDashPattern-float---) | Επιστρέφει ή ορίζει το προσαρμοσμένο μοτίβο παύσεων. |
...
| [getJoinStyle()](#getJoinStyle--) | Επιστρέφει ή ορίζει το στυλ συνένωσης των γραμμών. |
| [setJoinStyle(byte value)](#setJoinStyle-byte-) | Επιστρέφει ή ορίζει το στυλ συνένωσης των γραμμών. |
...
| [getBeginArrowheadStyle()](#getBeginArrowheadStyle--) | Επιστρέφει ή ορίζει το στυλ κεφαλής βέλους στην αρχή της γραμμής. |
| [setBeginArrowheadStyle(byte value)](#setBeginArrowheadStyle-byte-) | Επιστρέφει ή ορίζει το στυλ κεφαλής βέλους στην αρχή της γραμμής. |
| [getEndArrowheadStyle()](#getEndArrowheadStyle--) | Επιστρέφει ή ορίζει το στυλ κεφαλής βέλους στο τέλος της γραμμής. |
| [setEndArrowheadStyle(byte value)](#setEndArrowheadStyle-byte-) | Επιστρέφει ή ορίζει το στυλ κεφαλής βέλους στο τέλος της γραμμής. |
| [getBeginArrowheadWidth()](#getBeginArrowheadWidth--) | Επιστρέφει ή ορίζει το πλάτος κεφαλής βέλους στην αρχή της γραμμής. |
| [setBeginArrowheadWidth(byte value)](#setBeginArrowheadWidth-byte-) | Επιστρέφει ή ορίζει το πλάτος κεφαλής βέλους στην αρχή της γραμμής. |
| [getEndArrowheadWidth()](#getEndArrowheadWidth--) | Επιστρέφει ή ορίζει το πλάτος κεφαλής βέλους στο τέλος της γραμμής. |
| [setEndArrowheadWidth(byte value)](#setEndArrowheadWidth-byte-) | Επιστρέφει ή ορίζει το πλάτος κεφαλής βέλους στο τέλος της γραμμής. |
| [getBeginArrowheadLength()](#getBeginArrowheadLength--) | Επιστρέφει ή ορίζει το μήκος κεφαλής βέλους στην αρχή της γραμμής. |
| [setBeginArrowheadLength(byte value)](#setBeginArrowheadLength-byte-) | Επιστρέφει ή ορίζει το μήκος κεφαλής βέλους στην αρχή της γραμμής. |
| [getEndArrowheadLength()](#getEndArrowheadLength--) | Επιστρέφει ή ορίζει το μήκος κεφαλής βέλους στο τέλος της γραμμής. |
| [setEndArrowheadLength(byte value)](#setEndArrowheadLength-byte-) | Επιστρέφει ή ορίζει το μήκος κεφαλής βέλους στο τέλος της γραμμής. |
| [equals(ILineFormat lineFormat)](#equals-com.aspose.slides.ILineFormat-) | Προσδιορίζει εάν τα δύο αντικείμενα LineFormat είναι ίσα. |
...
Επιστρέφει true εάν η μορφή της γραμμής δεν είναι ορισμένη (όπως μόλις δημιουργήθηκε, προεπιλογή). Μόνο-ανάγνωση boolean.
...
Επιστρέφει τη μορφή γέμισης μιας γραμμής. Μόνο-ανάγνωση [ILineFillFormat](../../com.aspose.slides/ilinefillformat).
...
Επιστρέφει ή ορίζει το στυλ παύσεων της γραμμής. Ανάγνωση/Εγγραφή [LineDashStyle](../../com.aspose.slides/linedashstyle).
...
Επιστρέφει ή ορίζει το προσαρμοσμένο μοτίβο παύσεων. Ανάγνωση/Εγγραφή float[].
...
Επιστρέφει ή ορίζει το στυλ συνένωσης των γραμμών. Ανάγνωση/Εγγραφή [LineJoinStyle](../../com.aspose.slides/linejoinstyle).
...
Προσδιορίζει εάν τα δύο αντικείμενα LineFormat είναι ίσα.
...
**Επιστρέφει:**
[ILineFormatEffectiveData](../../com.aspose.slides/ilineformateffectivedata) - Ένα [ILineFormatEffectiveData](../../com.aspose.slides/ilineformateffectivedata).