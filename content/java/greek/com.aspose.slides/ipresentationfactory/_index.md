...
description: Επιτρέπει τη δημιουργία παρουσίασης μέσω της διεπαφής COM
type: docs
...
Επιτρέπει τη δημιουργία παρουσίασης μέσω της διεπαφής COM
## Μέθοδοι
...
| [getPresentationInfo(String file)](#getPresentationInfo-java.lang.String-) | Λαμβάνει πληροφορίες για την παρουσίαση στο συγκεκριμένο αρχείο. |
| [getPresentationInfo(InputStream stream)](#getPresentationInfo-java.io.InputStream-) | Λαμβάνει πληροφορίες για την παρουσίαση στο συγκεκριμένο ρεύμα. |
...
| [readPresentation(InputStream stream)](#readPresentation-java.io.InputStream-) | Διαβάζει υπάρχουσα παρουσίαση από ρεύμα |
| [readPresentation(InputStream stream, ILoadOptions options)](#readPresentation-java.io.InputStream-com.aspose.slides.ILoadOptions-) | Διαβάζει υπάρχουσα παρουσίαση από ρεύμα με πρόσθετες επιλογές φόρτωσης |
| [readPresentation(String file)](#readPresentation-java.lang.String-) | Διαβάζει υπάρχουσα παρουσίαση από αρχείο |
| [readPresentation(String file, ILoadOptions options)](#readPresentation-java.lang.String-com.aspose.slides.ILoadOptions-) | Διαβάζει υπάρχουσα παρουσίαση από ρεύμα με πρόσθετες επιλογές φόρτωσης |
...
Λαμβάνει πληροφορίες για την παρουσίαση στο συγκεκριμένο αρχείο.
...
Λαμβάνει πληροφορίες για την παρουσίαση στο συγκεκριμένο ρεύμα.
...
**Επιστρέφει:**
[IPresentation](../../com.aspose.slides/ipresentation) - Αναγνωσμένη παρουσίαση
...
Διαβάζει υπάρχουσα παρουσίαση από ρεύμα
...
Διαβάζει υπάρχουσα παρουσίαση από ρεύμα με πρόσθετες επιλογές φόρτωσης
...
Διαβάζει υπάρχουσα παρουσίαση από αρχείο με πρόσθετες επιλογές φόρτωσης
...
**Επιστρέφει:**
[IPresentationText](../../com.aspose.slides/ipresentationtext) - Το στιγμιότυπο της PresentationText που περιέχει τον πίνακα SlideText που αντιπροσωπεύει το ακατέργαστο κείμενο των διαφανειών
