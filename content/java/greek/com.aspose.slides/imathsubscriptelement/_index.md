...
description: Καθορίζει το αντικείμενο δείκτη που αποτελείται από μια βάση και έναν μειωμένου μεγέθους δείκτη τοποθετημένο κάτω και δεξιά.
type: docs
...
Καθορίζει το αντικείμενο δείκτη, το οποίο αποτελείται από μια βάση και ένα μειωμένου μεγέθους δείκτη που τοποθετείται κάτω και δεξιά.
