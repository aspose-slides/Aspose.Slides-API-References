...
| [isValid()](#isValid--) | Εάν αυτή η ψηφιακή υπογραφή είναι έγκυρη και το έγγραφο δεν έχει παραποιηθεί, αυτή η τιμή θα είναι true. |
...
Εάν αυτή η ψηφιακή υπογραφή είναι έγκυρη και το έγγραφο δεν έχει παραποιηθεί, αυτή η τιμή θα είναι true. Μόνο για ανάγνωση boolean.
