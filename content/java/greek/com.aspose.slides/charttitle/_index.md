...
type: docs
url: /el/com.aspose.slides/charttitle/
---
**Κληρονομικότητα:**
java.lang.Object
...
| [getOverlay()](#getOverlay--) | Καθορίζει αν άλλα στοιχεία του διαγράμματος θα επιτρέπεται να επικαλύψουν τον τίτλο. |
| [setOverlay(boolean value)](#setOverlay-boolean-) | Καθορίζει αν άλλα στοιχεία του διαγράμματος θα επιτρέπεται να επικαλύψουν τον τίτλο. |
...
| [getActualX()](#getActualX--) | Καθορίζει την πραγματική θέση x (αριστερά) του στοιχείου του διαγράμματος σε σχέση με την αριστερή επάνω γωνία του διαγράμματος. |
| [getActualY()](#getActualY--) | Καθορίζει το πραγματικό πάνω μέρος του στοιχείου του διαγράμματος σε σχέση με την αριστερή επάνω γωνία του διαγράμματος. |
...
Καθορίζει αν άλλα στοιχεία του διαγράμματος θα επιτρέπεται να επικαλύψουν τον τίτλο. Ανάγνωση/εγγραφή boolean.
...
Αρχικοποιεί το TextFrameForOverriding με το κείμενο στην παράμετρο "text". Εάν το TextFrameForOverriding είναι ήδη αρχικοποιημένο, τότε απλώς αλλάζει το κειμένου του.
...
Μπορεί να περιέχει πλούσιο μορφοποιημένο κείμενο. Εάν αυτή η ιδιότητα δεν είναι null, τότε αυτή η μορφοποιημένη τιμή κειμένου αντικαθιστά το αυτόματα δημιουργηθέν κείμενο. Το αυτόματα δημιουργηθέν κείμενο είναι μια έμμεση ιδιότητα της ετικέτας δεδομένων, της ετικέτας μονάδας εμφάνισης του άξονα τιμών, του τίτλου άξονα, του τίτλου διαγράμματος, της ετικέτας της γραμμής τάσης. Το αυτόματα δημιουργηθέν κείμενο μορφοποιείται με την ιδιότητα IFormattedTextContainer.TextFormat. Μόνο ανάγνωση [ITextFrame](../../com.aspose.slides/itextframe).
...
Καθορίζει την πραγματική θέση x (αριστερά) του στοιχείου του διαγράμματος σε σχέση με την αριστερή επάνω γωνία του διαγράμματος. Καλεί τη μέθοδο IChart.validateChartLayout() πριν για να λάβετε τις πραγματικές τιμές. Ανάγνωση float.
...
Καθορίζει το πραγματικό πάνω μέρος του στοιχείου του διαγράμματος σε σχέση με την αριστερή επάνω γωνία του διαγράμματος. Καλεί τη μέθοδο IChart.validateChartLayout() πριν για να λάβετε τις πραγματικές τιμές. Ανάγνωση float.
...
Καθορίζει το πραγματικό πλάτος του στοιχείου του διαγράμματος. Καλεί τη μέθοδο IChart.validateChartLayout() πριν για να λάβετε τις πραγματικές τιμές. Ανάγνωση float.
...
Καθορίζει το πραγματικό ύψος του στοιχείου του διαγράμματος. Καλεί τη μέθοδο IChart.validateChartLayout() πριν για να λάβετε τις πραγματικές τιμές. Ανάγνωση float.
