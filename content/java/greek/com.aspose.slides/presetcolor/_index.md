...
description: Αντιπροσωπεύει προεπιλεγμένες ρυθμίσεις χρώματος.
type: docs
url: /el/com.aspose.slides/presetcolor/
---
**Κληρονομικότητα:**
...
Αντιπροσωπεύει προεπιλεγμένες ρυθμίσεις χρώματος.
## Πεδία

| Πεδίο | Περιγραφή |
| --- | --- |
| [NotDefined](#NotDefined) | Η προεπιλογή χρώματος δεν είναι ορισμένη. |
| [AliceBlue](#AliceBlue) |  |
...
Η προεπιλογή χρώματος δεν είναι ορισμένη.
