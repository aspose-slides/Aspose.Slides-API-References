...
description: Αναπαριστά μια μορφή μετάβασης της παρουσίασης για αποθήκευση σε μορφή web.
type: docs
...
Αναπαριστά μια μορφή μετάβασης της παρουσίασης για αποθήκευση σε μορφή web.
...
| --- | --- | --- |
| options | [WebDocumentOptions](../../com.aspose.slides/webdocumentoptions) | Επιλογές που ορίζονται για το έγγραφο. |
