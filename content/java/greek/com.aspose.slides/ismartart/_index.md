...
description: Αντιπροσωπεύει ένα διάγραμμα SmartArt.
type: docs
...
Αντιπροσωπεύει ένα διάγραμμα SmartArt.
## Μέθοδοι
...
| [getColorStyle()](#getColorStyle--) | Επιστρέφει ή ορίζει το χρωματικό στυλ του αντικειμένου SmartArt. |
| [setColorStyle(int value)](#setColorStyle-int-) | Επιστρέφει ή ορίζει το χρωματικό στυλ του αντικειμένου SmartArt. |
| [isReversed()](#isReversed--) | Επιστρέφει ή ορίζει την κατάσταση του διαγράμματος SmartArt σε σχέση με (αριστερά προς δεξιά) LTR ή (δεξιά προς αριστερά) RTL, εάν το διάγραμμα υποστηρίζει αντιστροφή. |
| [setReversed(boolean value)](#setReversed-boolean-) | Επιστρέφει ή ορίζει την κατάσταση του διαγράμματος SmartArt σε σχέση με (αριστερά προς δεξιά) LTR ή (δεξιά προς αριστερά) RTL, εάν το διάγραμμα υποστηρίζει αντιστροφή. |
...
Επιστρέφει ή ορίζει το χρωματικό στυλ του αντικειμένου SmartArt. Ανάγνωση/εγγραφή [SmartArtColorType](../../com.aspose.slides/smartartcolortype).
