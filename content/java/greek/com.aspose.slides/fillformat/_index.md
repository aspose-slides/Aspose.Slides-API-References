...
| [getPatternFormat()](#getPatternFormat--) | Επιστρέφει τη μορφή προτύπου γεμίσματος. |
| [getPictureFillFormat()](#getPictureFillFormat--) | Επιστρέφει τη μορφή εικόνας γεμίσματος. |
| [getRotateWithShape()](#getRotateWithShape--) | Καθορίζει εάν το γέμισμα πρέπει να περιστραφεί με το σχήμα. |
| [setRotateWithShape(byte value)](#setRotateWithShape-byte-) | Καθορίζει εάν το γέμισμα πρέπει να περιστραφεί με το σχήμα. |
| [getEffective()](#getEffective--) | Αποκτά τα αποτελεσματικά δεδομένα μορφοποίησης γεμίσματος με την κληρονομικότητα εφαρμοσμένη. |
### getVersion() {#getVersion--}
```
...
Επιστρέφει τη μορφή διαβάθμισης γεμίσματος. Μόνο για ανάγνωση [IGradientFormat](../../com.aspose.slides/igradientformat).
...
Επιστρέφει τη μορφή προτύπου γεμίσματος. Μόνο για ανάγνωση [IPatternFormat](../../com.aspose.slides/ipatternformat).
...
Επιστρέφει τη μορφή εικόνας γεμίσματος. Μόνο για ανάγνωση [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
Καθορίζει εάν το γέμισμα πρέπει να περιστραφεί με το σχήμα. Ανάγνωση/εγγραφή [NullableBool](../../com.aspose.slides/nullablebool).
...
Αποκτά τα αποτελεσματικά δεδομένα μορφοποίησης γεμίσματος με την κληρονομικότητα εφαρμοσμένη.
