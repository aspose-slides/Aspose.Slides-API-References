...
description: Καθορίζει το αντικείμενο Sub-Superscript, το οποίο αποτελείται από μια βάση και έναν δείκτη και έναν εκθέτη τοποθετημένα δεξιά της βάσης.
type: docs
...
Καθορίζει το αντικείμενο Sub-Superscript, το οποίο αποτελείται από μια βάση και έναν δείκτη και έναν εκθέτη τοποθετημένα δεξιά της βάσης.
...
Καθορίζει την ευθυγράμμιση του δείκτη/εκθέτη. Όταν είναι true, ο δείκτης και ο εκθέτης ευθυγραμμίζονται οριζόντια μεταξύ τους. Όταν είναι false, προσαρμόζονται στη μορφή της βάσης. Η προεπιλεγμένη τιμή είναι false.
