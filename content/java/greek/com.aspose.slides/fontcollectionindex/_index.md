...
description: Αντιπροσωπεύει τον δείκτη των γραμματοσειρών σε μια συλλογή.
type: docs
url: /el/com.aspose.slides/fontcollectionindex/
---
**Κληρονομικότητα:**
...
Αντιπροσωπεύει το δείκτη της γραμματοσειράς σε μια συλλογή.
## Πεδία
