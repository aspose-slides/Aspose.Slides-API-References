...
| [getExtrusionHeight()](#getExtrusionHeight--) | Επιστρέφει ή ορίζει το ύψος μιας εξώθησης. |
| [setExtrusionHeight(double value)](#setExtrusionHeight-double-) | Επιστρέφει ή ορίζει το ύψος μιας εξώθησης. |
...
| [getBevelTop()](#getBevelTop--) | Επιστρέφει ή ορίζει τον τύπο ενός επάνω 3D bevel. |
| [getBevelBottom()](#getBevelBottom--) | Επιστρέφει ή ορίζει τον τύπο ενός κάτω 3D bevel. |
...
| [getEffective()](#getEffective--) | Παίρνει τα ενεργά δεδομένα μορφοποίησης 3-D με την κληρονομικότητα εφαρμοσμένη. |
...
Επιστρέφει ή ορίζει το ύψος μιας εξώθησης. Ανάγνωση/εγγραφή double.
...
Επιστρέφει ή ορίζει τον τύπο ενός επάνω 3D bevel. Μόνο για ανάγνωση [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Επιστρέφει ή ορίζει τον τύπο ενός κάτω 3D bevel. Μόνο για ανάγνωση [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Παίρνει τα ενεργά δεδομένα μορφοποίησης 3-D με την κληρονομικότητα εφαρμοσμένη.
