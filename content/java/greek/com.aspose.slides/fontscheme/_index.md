...
type: docs
url: /el/com.aspose.slides/fontscheme/
---
**Κληρονομία:**
java.lang.Object
...
Επιστρέφει τη συλλογή γραμματοσειρών για το τμήμα "body" της διαφάνειας. Μόνο για ανάγνωση [IFonts](../../com.aspose.slides/ifonts).
...
Επιστρέφει τη συλλογή γραμματοσειρών για το τμήμα "heading" της διαφάνειας. Μόνο για ανάγνωση [IFonts](../../com.aspose.slides/ifonts).
