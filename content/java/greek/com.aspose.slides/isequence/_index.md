...
| [get_Item(int index)](#get-Item-int-) | Επιστρέφει ένα εφέ στον καθορισμένο δείκτη. |
| [getTriggerShape()](#getTriggerShape--) | Επιστρέφει ή ορίζει το σχήμα-στόχο για την INTERACTIVE ακολουθία. |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | Επιστρέφει ή ορίζει το σχήμα-στόχο για την INTERACTIVE ακολουθία. |
...
Επιστρέφει τον αριθμό των εφέ σε μια ακολουθία. Read-only int.
...
Επιστρέφει ή ορίζει το σχήμα-στόχο για την INTERACTIVE ακολουθία. Εάν η ακολουθία δεν είναι διαδραστική, επιστρέφει null. Read/write [IShape](../../com.aspose.slides/ishape).
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | Αντικείμενο σχήματος [IShape](../../com.aspose.slides/ishape) για την προσθήκη εφέ |
...
| triggerType | int | Τύπος ενεργοποιητή εφέ [EffectTriggerType](../../com.aspose.slides/effecttriggertype) |
...
| chart | [IChart](../../com.aspose.slides/ichart) | Αντικείμενο γραφήματος [IChart](../../com.aspose.slides/ichart) |
| type | int | Τύπος εφέ κίνησης [EffectChartMinorGroupingType](../../com.aspose.slides/effectchartminorgroupingtype) |
| seriesIndex | int | Δείκτης σειράς γραφήματος int |
