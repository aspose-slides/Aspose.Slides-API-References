...
description: Σταθερές που ορίζουν τον τύπο προεπιλογής κάμερας.
type: docs
url: /el/com.aspose.slides/camerapresettype/
---
**Κληρονομικότητα:**
...
### IsometricOffAxis4Right {#IsometricOffAxis4Right}
```
public static final int IsometricOffGrid4Right
```
...
### LegacyObliqueTopLeft {#LegacyObliqueTopLeft}
```
public static final int LegacyObsoleteTopLeft
```
