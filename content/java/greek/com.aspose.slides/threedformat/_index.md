...
description: Αναπαριστά ιδιότητες 3-D.
type: docs
...
>  try {
>      // Προσθέστε ένα σχήμα χρησιμοποιώντας τη μέθοδο AddAutoShape.
>      IAutoShape shape = pres.getSlides().get_Item(0).getShapes().addAutoShape(ShapeType.Rectangle, 200, 150, 200, 200);
>      // Ορίστε το TextFrame και τις ιδιότητές του.
>      shape.getTextFrame().setText("3D");
>      shape.getTextFrame().getParagraphs().get_Item(0).getParagraphFormat().getDefaultPortionFormat().setFontHeight(64);
>      // Ορίστε τις ιδιότητες ThreeDFormat.
...
>      // Αποθηκεύστε το αρχείο Presentation.
...
>      shape.getTextFrame().getParagraphs().get_Item(0).getParagraphFormat().getDefaultPortionFormat().setFontHeight(64);
>      // Ρυθμίστε το FillFormat.FillType σε FillType.Gradient και ορίστε τις ιδιότητες κλιμάκωσης.
...
>      // Ρυθμίστε το FillFormat.FillType σε FillType.NoFill
>      shape.getFillFormat().setFillType(FillType.NoFill);
>      shape.getLineFormat().getFillFormat().setFillType(FillType.NoFill);
>      // Ρυθμίστε το Portion του TextFrame και τις ιδιότητες του PortionFormat.
...
| [getBevelTop()](#getBevelTop--) | Επιστρέφει ή ορίζει τον τύπο ενός επάνω 3D λοξογκύλιου. |
| [getBevelBottom()](#getBevelBottom--) | Επιστρέφει ή ορίζει τον τύπο ενός κάτω 3D λοξογκύλιου. |
...
| [getEffective()](#getEffective--) | Λαμβάνει τα αποτελεσματικά δεδομένα μορφοποίησης 3-D με την κληρονομικότητα να εφαρμόζεται. |
...
Επιστρέφει ή ορίζει τον τύπο ενός επάνω 3D λοξογκύλιου. Μόνο για ανάγνωση [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Επιστρέφει ή ορίζει τον τύπο ενός κάτω 3D λοξογκύλιου. Μόνο για ανάγνωση [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Επιστρέφει ή ορίζει τον τύπο ενός φωτός. Μόνο για ανάγνωση [ILightRig](../../com.aspose.slides/ilightrig).
...
Λαμβάνει τα αποτελεσματικά δεδομένα μορφοποίησης 3-D με την κληρονομικότητα να εφαρμόζεται.
