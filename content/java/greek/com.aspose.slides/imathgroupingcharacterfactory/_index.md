...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [createMathGroupingCharacter(IMathElement element, char character, int position, int verticalJustification)](#createMathGroupingCharacter-com.aspose.slides.IMathElement-char-int-int-) | Δημιουργεί έναν χαρακτήρα ομαδοποίησης μαθηματικών |
| [createMathGroupingCharacter(IMathElement element)](#createMathGroupingCharacter-com.aspose.slides.IMathElement-) | Δημιουργεί έναν χαρακτήρα ομαδοποίησης μαθηματικών |
