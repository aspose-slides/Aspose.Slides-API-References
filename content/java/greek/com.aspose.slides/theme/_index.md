...
| [getFontScheme()](#getFontScheme--) | Επιστρέφει το σχήμα γραμματοσειρών. |
...
| [getEffective()](#getEffective--) | Λαμβάνει τα αποτελεσματικά δεδομένα θέματος με την κληρονομικότητα που έχει εφαρμοστεί. |
...
Επιστρέφει το σχήμα χρωμάτων. Μόνο για ανάγνωση [IColorScheme](../../com.aspose.slides/icolorscheme).
...
Επιστρέφει το σχήμα γραμματοσειρών. Μόνο για ανάγνωση [IFontScheme](../../com.aspose.slides/ifontscheme).
...
Λαμβάνει τα αποτελεσματικά δεδομένα θέματος με την κληρονομικότητα που έχει εφαρμοστεί.
...
Επιστρέφει τη γονική IPresentationComponent. Μόνο για ανάγνωση [IPresentationComponent](../../com.aspose.slides/ipresentationcomponent).
