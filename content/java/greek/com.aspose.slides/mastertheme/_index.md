...
| [getExtraColorSchemes()](#getExtraColorSchemes--) | Επιστρέφει τη συλλογή επιπλέον χρωματικών σχημάτων. |
...
Επιστρέφει το χρωματικό σχήμα. Μόνο ανάγνωση [IColorScheme](../../com.aspose.slides/icolorscheme).
...
Επιστρέφει τη συλλογή επιπλέον χρωματικών σχημάτων. Αυτά τα σχήματα δεν επηρεάζουν την εμφάνιση της παρουσίασης, μπορούν να επιλεγούν ως κύριο χρωματικό σχήμα για μια διαφάνεια. Μόνο ανάγνωση [IExtraColorSchemeCollection](../../com.aspose.slides/iextracolorschemecollection).
