...
Αντιπροσωπεύει μια συλλογή κανόνων FontFallBack, ορισμένων από τον χρήστη
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Λαμβάνει τον κανόνα στον καθορισμένο δείκτη. |
...
Λαμβάνει τον κανόνα στον καθορισμένο δείκτη. Μόνο για ανάγνωση [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule).
