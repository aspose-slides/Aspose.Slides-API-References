...
description: Αναπαριστά μια συλλογή λειτουργιών μετασχηματισμού χρώματος.
type: docs
...
Αναπαριστά μια συλλογή λειτουργιών μετασχηματισμού χρώματος.
## Μεθόδοι
...
Επιστρέφει ή ορίζει τη λειτουργία στο καθορισμένο δείκτη. Ανάγνωση/εγγραφή [IColorOperation](../../com.aspose.slides/icoloroperation).
...
**Επιστρέφει:**
[IColorOperation](../../com.aspose.slides/icoloroperation) - Προστέθηκε λειτουργία.
