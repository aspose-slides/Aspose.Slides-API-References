...
| Method | Περιγραφή |
| --- | --- |
| [getGroupingLocked()](#getGroupingLocked--) | Καθορίζει εάν η προσθήκη αυτού του σχήματος σε μια ομάδα απαγορεύεται. |
| [setGroupingLocked(boolean value)](#setGroupingLocked-boolean-) | Καθορίζει εάν η προσθήκη αυτού του σχήματος σε μια ομάδα απαγορεύεται. |
...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Καθορίζει εάν ένα σχήμα πρέπει να διατηρεί την αναλογία διαστάσεων κατά την αλλαγή μεγέθους. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Καθορίζει εάν ένα σχήμα πρέπει να διατηρεί την αναλογία διαστάσεων κατά την αλλαγή μεγέθους. |
...
| [getEditPointsLocked()](#getEditPointsLocked--) | Καθορίζει εάν η άμεση αλλαγή του περιγράμματος αυτού του σχήματος απαγορεύεται. |
| [setEditPointsLocked(boolean value)](#setEditPointsLocked-boolean-) | Καθορίζει εάν η άμεση αλλαγή του περιγράμματος αυτού του σχήματος απαγορεύεται. |
...
| [getShapeTypeLocked()](#getShapeTypeLocked--) | Καθορίζει εάν η αλλαγή του τύπου σχήματος απαγορεύεται. |
| [setShapeTypeLocked(boolean value)](#setShapeTypeLocked-boolean-) | Καθορίζει εάν η αλλαγή του τύπου σχήματος απαγορεύεται. |
...
Καθορίζει εάν η επιλογή αυτού του σχήματος απαγορεύεται. Αναγνώσιμη/εγγράψιμη boolean.
...
Καθορίζει εάν η αλλαγή της γωνίας περιστροφής αυτού του σχήματος απαγορεύεται. Αναγνώσιμη/εγγράψιμη boolean.
...
Καθορίζει εάν ένα σχήμα πρέπει να διατηρεί την αναλογία διαστάσεων κατά την αλλαγή μεγέθους. Αναγνώσιμη/εγγράψιμη boolean.
...
Καθορίζει εάν η αλλαγή μεγέθους αυτού του σχήματος απαγορεύεται. Αναγνώσιμη/εγγράψιμη boolean.
...
Καθορίζει εάν η άμεση αλλαγή του περιγράμματος αυτού του σχήματος απαγορεύεται. Αναγνώσιμη/εγγράψιμη boolean.
...
Καθορίζει εάν η αλλαγή των άκρων βέλους απαγορεύεται. Αναγνώσιμη/εγγράψιμη boolean.
...
Καθορίζει εάν η αλλαγή του τύπου σχήματος απαγορεύεται. Αναγνώσιμη/εγγράψιμη boolean.
