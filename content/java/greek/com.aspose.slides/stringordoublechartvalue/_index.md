...
description: Αναπαριστά συμβολοσειρά ή δεκαδική τιμή που μπορεί να αποθηκευτεί σε έγγραφο παρουσίασης pptx με δύο τρόπους: 1) σε κελί/κελιά του φύλλου εργασίας που σχετίζονται με το διάγραμμα· 2) ως κυριολεκτική τιμή.
type: docs
...
Αναπαριστά τιμή συμβολοσειράς ή δεκαδικού αριθμού που μπορεί να αποθηκευτεί σε έγγραφο παρουσίασης pptx με δύο τρόπους: 1) σε κελί/κελιά του φύλλου εργασίας που σχετίζονται με το διάγραμμα· 2) ως κυριολεκτική τιμή.
## Μέθοδοι

| Μέθοδος | Περιγραφή |
| --- | --- |
| [getAsCell()](#getAsCell--) | Επιστρέφει ή ορίζει το κελί δεδομένων του διαγράμματος. |
| [setAsCell(IChartDataCell value)](#setAsCell-com.aspose.slides.IChartDataCell-) | Επιστρέφει ή ορίζει το κελί δεδομένων του διαγράμματος. |
...
| [getAsLiteralDouble()](#getAsLiteralDouble--) | Επιστρέφει ή ορίζει την τιμή ως κυριολεκτικό δεκαδικό αριθμό. |
| [setAsLiteralDouble(double value)](#setAsLiteralDouble-double-) | Επιστρέφει ή ορίζει την τιμή ως κυριολεκτικό δεκαδικό αριθμό. |
...
Επιστρέφει ή ορίζει την τιμή ως κυριολεκτικό δεκαδικό αριθμό. Ανάγνωση/εγγραφή double.
