...
| [createPortion(String str)](#createPortion-java.lang.String-) | Δημιουργεί ένα τμήμα κειμένου από συγκεκριμένη συμβολοσειρά. |
| [createPortion(IPortion portion)](#createPortion-com.aspose.slides.IPortion-) | Δημιουργεί ένα τμήμα χρησιμοποιώντας δεδομένα συγκεκριμένου τμήματος. |
...
Δημιουργεί ένα τμήμα κειμένου από συγκεκριμένη συμβολοσειρά.
...
Δημιουργεί ένα τμήμα χρησιμοποιώντας δεδομένα συγκεκριμένου τμήματος.
