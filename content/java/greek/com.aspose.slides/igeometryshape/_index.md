...
second_title: Aspose.Slides για το API Java
description: Αναπαριστά τη γονική κλάση για όλα τα γεωμετρικά σχήματα.
type: docs
...
| [setGeometryPaths(IGeometryPath[] geometryPaths)](#setGeometryPaths-com.aspose.slides.IGeometryPath---) | Ενημερώνει τη γεωμετρία του σχήματος από πίνακα του [IGeometryPath](../../com.aspose.slides/igeometrypath). |
| [getShapeStyle()](#getShapeStyle--) | Επιστρέφει το αντικείμενο στυλ του σχήματος. |
| [getShapeType()](#getShapeType--) | Επιστρέφει ή ορίζει τον προρυθμισμένο τύπο γεωμετρίας. |
| [setShapeType(int value)](#setShapeType-int-) | Επιστρέφει ή ορίζει τον προρυθμισμένο τύπο γεωμετρίας. |
| [getAdjustments()](#getAdjustments--) | Επιστρέφει μια συλλογή των τιμών ρύθμισης του σχήματος. |
...
**Επιστρέφει:**
com.aspose.slides.IGeometryPath[] - Πίνακας του [IGeometryPath](../../com.aspose.slides/igeometrypath)
...
Ενημερώνει τη γεωμετρία του σχήματος από πίνακα του [IGeometryPath](../../com.aspose.slides/igeometrypath). Οι συντεταγμένες πρέπει να είναι σχετικές με την αριστερή πάνω γωνία του σχήματος. Αλλάζει τον τύπο του σ shape (ShapeType(\#getShapeType.getShapeType/\#setShapeType(int).setShapeType(int))) σε [ShapeType.Custom](../../com.aspose.slides/shapetype\#Custom).
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| geometryPaths | [IGeometryPath\[\]](../../com.aspose.slides/igeometrypath) | Πίνακας γεωμετρικών διαδρομών |
...
Επιστρέφει ή ορίζει τον προρυθμισμένο τύπο γεωμετρίας. Σημείωση: κατά την αλλαγή τιμής όλες οι τιμές ρύθμισης θα επανέλθουν στις προεπιλεγμένες τιμές τους. Ανάγνωση/εγγραφή [ShapeType](../../com.aspose.slides/shapetype).
...
Επιστρέφει μια συλλογή των τιμών ρύθμισης του σχήματος. Μόνο για ανάγνωση [IAdjustValueCollection](../../com.aspose.slides/iadjustvaluecollection).
...
**Επιστρέφει:**
com.aspose.slides.IShapeElement[] - Πίνακας του [IShapeElement](../../com.aspose.slides/ishapeelement)