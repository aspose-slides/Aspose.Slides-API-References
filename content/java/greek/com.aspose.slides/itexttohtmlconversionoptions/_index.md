...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [getAddClipboardFragmentHeader()](#getAddClipboardFragmentHeader--) | Επιστρέφει ή ορίζει την τιμή, που υποδεικνύει αν πρέπει να προστεθούν κεφαλίδες Clipboard. |
| [setAddClipboardFragmentHeader(boolean value)](#setAddClipboardFragmentHeader-boolean-) | Επιστρέφει ή ορίζει την τιμή, που υποδεικνύει αν πρέπει να προστεθούν κεφαλίδες Clipboard. |
...
Επιστρέφει ή ορίζει την τιμή, που υποδεικνύει αν πρέπει να προστεθούν κεφαλίδες Clipboard. Ανάγνωση/εγγραφή boolean.
