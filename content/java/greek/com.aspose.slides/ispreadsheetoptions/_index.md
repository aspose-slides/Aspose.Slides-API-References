...
description: Αντιπροσωπεύει επιλογές που μπορούν να χρησιμοποιηθούν για τον καθορισμό πρόσθετης συμπεριφοράς υπολογιστικών φύλλων.
type: docs
...
Αντιπροσωπεύει επιλογές που μπορούν να χρησιμοποιηθούν για τον καθορισμό πρόσθετης συμπεριφοράς υπολογιστικών φύλλων.
## Μέθοδοι
...
| [getRecoverWorkbookFromChartCache()](#getRecoverWorkbookFromChartCache--) | Εάν η πηγή δεδομένων για το γράφημα είναι εξωτερικό βιβλίο εργασίας και δεν είναι διαθέσιμη, θα ανακτηθεί από την κρυφή μνήμη του γράφηματος. |
| [setRecoverWorkbookFromChartCache(boolean value)](#setRecoverWorkbookFromChartCache-boolean-) | Εάν η πηγή δεδομένων για το γράφημα είναι εξωτερικό βιβλίο εργασίας και δεν είναι διαθέσιμη, θα ανακτηθεί από την κρυφή μνήμη του γράφηματος. |
...
Εάν η πηγή δεδομένων για το γράφημα είναι εξωτερικό βιβλίο εργασίας και δεν είναι διαθέσιμη, θα ανακτηθεί από την κρυφή μνήμη του γράφηματος.
