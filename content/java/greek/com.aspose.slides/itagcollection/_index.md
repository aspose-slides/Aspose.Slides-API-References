...
description: Αντιπροσωπεύει τη συλλογή ετικετών, ζευγάρια συμβολοσειρών ορισμένα από το χρήστη
type: docs
...
Αντιπροσωπεύει τη συλλογή ετικετών (ζευγάρια συμβολοσειρών ορισμένων από το χρήστη)
## Μέθοδοι
...
| [indexOfName(String name)](#indexOfName-java.lang.String-) | Επιστρέφει τον μηδενικό δείκτη του συγκεκριμένου κλειδιού στη συλλογή. |
...
**Επιστρέφει:**
int - Ο δείκτης της προστιθεμένης ετικέτας.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| name | java.lang.String | Το όνομα της ετικέτας προς απομάκρυνση. |
### indexOfName(String name) {#indexOfName-java.lang.String-}
```
public abstract int indexOfName(String name)
```

Επιστρέφει τον μηδενικό δείκτη του συγκεκριμένου κλειδιού στη συλλογή.
...
**Επιστρέφει:**
int - Ο μηδενικός δείκτης του κλειδιού, αν βρεθεί στη συλλογή· διαφορετικά, -1.
...
**Επιστρέφει:**
boolean - True αν η συλλογή περιέχει μια ετικέτα με το συγκεκριμένο κλειδί· διαφορετικά, false.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| index | int | Ο μηδενικός δείκτης της ετικέτας προς απομάκρυνση. |
### clear() {#clear--}
```
