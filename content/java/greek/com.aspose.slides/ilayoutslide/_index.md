...
| [hasDependingSlides()](#hasDependingSlides--) | Επιστρέφει true εάν υπάρχει τουλάχιστον μία διαφάνεια που εξαρτάται από αυτή τη διαφάνεια διάταξης. |
...
| [remove()](#remove--) | Καταργεί τη διάταξη από την παρουσίαση. |
...
Καταργεί τη διάταξη από την παρουσίαση.
...
Επιστρέφει μια συλλογή από οδηγούς σχεδίασης για τη διαφάνεια διάταξης. Μόνο για ανάγνωση [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
...
>      // Προσθήκη του νέου κατακόρυφου οδηγού σχεδίασης αριστερά του κέντρου της διαφάνειας
