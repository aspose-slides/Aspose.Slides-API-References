...
type: docs
url: /el/com.aspose.slides/pptxreadexception/
---
**Κληρονομικότητα:**
...
| --- | --- |
| [PptxReadException()](#PptxReadException--) | Προεπιλεγμένος κατασκευαστής. |
| [PptxReadException(String message)](#PptxReadException-java.lang.String-) | Κατασκευαστής που επιτρέπει την προσθήκη μηνύματος σε αυτήν την εξαίρεση. |
| [PptxReadException(String message, RuntimeException exception)](#PptxReadException-java.lang.String-java.lang.RuntimeException-) | Κατασκευαστής για μια εξαίρεση που περιέχει μήνυμα και ενσωματωμένη εξαίρεση. |
