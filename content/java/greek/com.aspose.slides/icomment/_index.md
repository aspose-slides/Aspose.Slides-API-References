...
| [getCreatedTime()](#getCreatedTime--) | Επιστρέφει ή ορίζει το χρόνο δημιουργίας ενός σχολίου. |
| [setCreatedTime(Date value)](#setCreatedTime-java.util.Date-) | Επιστρέφει ή ορίζει το χρόνο δημιουργίας ενός σχολίου. |
...
| [setPosition(Point2D.Float value)](#setPosition-java.awt.geom.Point2D.Float-) | Επιστρέφει ή ορίζει τη θέση ενός σχολίου σε μια διαφάνεια. |
| [remove()](#remove--) | Αφαιρεί το σχόλιο και όλες τις απαντήσεις του από τη γονική συλλογή. |
| [getParentComment()](#getParentComment--) | Αποκτά ή ορίζει το γονικό σχόλιο. |
| [setParentComment(IComment value)](#setParentComment-com.aspose.slides.IComment-) | Αποκτά ή ορίζει το γονικό σχόλιο. |
### getText() {#getText--}
```
...
Επιστρέφει ή ορίζει το χρόνο δημιουργίας ενός σχολίου. Ο ορισμός αυτής της ιδιότητας σε java.util.Date(Long.MIN_VALUE) σημαίνει ότι δεν έχει οριστεί χρόνος σχολίου. Ανάγνωση/εγγραφή java.util.Date.
...
Επιστρέφει ή ορίζει τη θέση ενός σχολίου σε μια διαφάνεια. Ανάγνωση/εγγραφή java.awt.geom.Point2D.Float.
...
Αποκτά ή ορίζει το γονικό σχόλιο. Ανάγνωση/εγγραφή [IComment](../../com.aspose.slides/icomment).
