...
| الطريقة | الوصف |
| --- | --- |
| [formatText(ISvgTSpan svgTSpan, IPortion portion, ITextFrame textFrame)](#formatText-com.aspose.slides.ISvgTSpan-com.aspose.slides.IPortion-com.aspose.slides.ITextFrame-) | يتم استدعاء هذه الدالة قبل تصيير جزء النص إلى SVG للسماح للمستخدم بالتحكم في SVG الناتج. |
...
يتم استدعاء هذه الدالة قبل تصيير جزء النص إلى SVG للسماح للمستخدم بالتحكم في SVG الناتج.

**المعلمات:**
| الوسيط | النوع | الوصف |
| --- | --- | --- |
| svgTSpan | [ISvgTSpan](../../com.aspose.slides/isvgtspan) | كائن للتحكم في إنشاء tspan الخاص بـ SVG. |
