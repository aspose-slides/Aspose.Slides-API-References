...
| [remove(ICustomXmlPart item)](#remove-com.aspose.slides.ICustomXmlPart-) | يزيل التواجد الأول لكائن معين من المجموعة. |
...
| الوسيط | النوع | الوصف |
| --- | --- | --- |
| inputStream | java.io.InputStream | تدفق الإدخال الذي يحتوي على بيانات XML للجزء الجديد المراد إضافته. |
...
| الوسيط | النوع | الوصف |
| --- | --- | --- |
| item | [ICustomXmlPart](../../com.aspose.slides/icustomxmlpart) | جزء XML المخصص للإزالة. |
