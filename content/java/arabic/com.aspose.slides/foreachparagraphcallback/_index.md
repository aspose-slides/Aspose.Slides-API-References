...
| الطريقة | الوصف |
| --- | --- |
| [invoke(Paragraph para, BaseSlide slide, int index)](#invoke-com.aspose.slides.Paragraph-com.aspose.slides.BaseSlide-int-) | ستتم استدعاء الـ Callback لكل \#paragraph(Presentation,ForEachParagraphCallback).paragraph(Presentation,ForEachParagraphCallback) على [BaseSlide](../../com.aspose.slides/baseslide). |
...
ستتم استدعاء الـ Callback لكل \#paragraph(Presentation,ForEachParagraphCallback).paragraph(Presentation,ForEachParagraphCallback) على [BaseSlide](../../com.aspose.slides/baseslide).
