...
second_title: Aspose.Slides لواجهة برمجة التطبيقات لجافا
description: تمثل مجموعة أوراق العمل لدفتر بيانات المخطط.
type: docs
...
**القيمة المرجعة:**
[IChartDataWorksheet](../../com.aspose.slides/ichartdataworksheet) - مثيل من IChartDataWorksheet.