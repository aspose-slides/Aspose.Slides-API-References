...
| الطريقة | الوصف |
| --- | --- |
| [get_Item(int columnIndex, int rowIndex)](#get-Item-int-int-) | يعيد الخلية عند الفهارس المحددة للعمود والصف. |
...
| [mergeCells(ICell cell1, ICell cell2, boolean allowSplitting)](#mergeCells-com.aspose.slides.ICell-com.aspose.slides.ICell-boolean-) | يُدمج الخلايا المجاورة. |
...
يعيد الخلية عند الفهارس المحددة للعمود والصف. للقراءة فقط [ICell](../../com.aspose.slides/icell).
...
يحصل أو يعيّن نمط الجدول المدمج. قابل للقراءة والكتابة [TableStylePreset](../../com.aspose.slides/tablestylepreset).
...
يحدد ما إذا كان للجدول ترتيب قراءة من اليمين إلى اليسار. قابل للقراءة والكتابة من نوع boolean.
...
يحدد ما إذا كان يجب رسم الصف الأول للجدول بتنسيق خاص. قابل للقراءة والكتابة من نوع boolean.
...
يحدد ما إذا كان يجب رسم العمود الأول للجدول بتنسيق خاص. قابل للقراءة والكتابة من نوع boolean.
...
يحدد ما إذا كان يجب رسم الصف الأخير للجدول بتنسيق خاص. قابل للقراءة والكتابة من نوع<boolean>.
...
يحدد ما إذا كان يجب رسم العمود الأخير للجدول بتنسيق خاص. قابل للقراءة والكتابة من نوع boolean.
...
يحدد ما إذا كان يجب رسم الصفوف الزوجية بتنسيق مختلف. قابل للقراءة والكتابة من نوع boolean.
...
يحدد ما إذا كان يجب رسم الأعمدة الزوجية بتنسيق مختلف. قابل للقراءة والكتابة من نوع boolean.
