...
description: يمثل إعداد حجم الشريحة مسبقًا.
type: docs
url: /ar/com.aspose.slides/slidesizetype/
---
**الوراثة:**
...
يمثل إعداد حجم الشريحة مسبقًا.
## الحقول

| الحقل | الوصف |
| --- | --- |
| [OnScreen](#OnScreen) | على الشاشة 4x3 |
| [LetterPaper](#LetterPaper) | Letter |
| [A4Paper](#A4Paper) | A4 |
| [Slide35mm](#Slide35mm) | شريحة 35مم |
...
| [HagakiCard](#HagakiCard) | بطاقة Hagaki |
| [OnScreen16x9](#OnScreen16x9) | على الشاشة 16x9 |
| [OnScreen16x10](#OnScreen16x10) | على الشاشة 16x10 |
| [Widescreen](#Widescreen) | شاشة عريضة |
### OnScreen {#OnScreen}
```
