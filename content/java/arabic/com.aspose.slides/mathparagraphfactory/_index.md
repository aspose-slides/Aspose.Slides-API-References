...
type: docs
url: /ar/com.aspose.slides/mathparagraphfactory/
---
**الوراثة:**
java.lang.Object
...
| [createMathParagraph(IMathBlock mathBlock)](#createMathParagraph-com.aspose.slides.IMathBlock-) | إنشاء فقرة رياضية ووضع كتلة الرياضيات المحددة فيها |
### MathParagraphFactory() {#MathParagraphFactory--}
```
...
إنشاء فقرة رياضية ووضع كتلة الرياضيات المحددة فيها

**المعلمات:**
| المعامل | النوع | الوصف |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | كتلة الرياضيات التي توضع في الفقرة |
