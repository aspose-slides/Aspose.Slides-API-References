...
يمثل مجموعة من قواعد FontFallBack، المحددة بواسطة المستخدم
## الطرق

| طريقة | الوصف |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | يحصل على القاعدة في الفهرس المحدد. |
...
يحصل على القاعدة في الفهرس المحدد. للقراءة فقط [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule).
