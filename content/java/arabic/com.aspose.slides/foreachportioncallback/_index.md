...
| طريقة | الوصف |
| --- | --- |
| [invoke(Portion portion, Paragraph para, BaseSlide slide, int index)](#invoke-com.aspose.slides.Portion-com.aspose.slides.Paragraph-com.aspose.slides.BaseSlide-int-) | ستتم استدعاء Callback لكل \#paragraph(Presentation,ForEachParagraphCallback).paragraph(Presentation,ForEachParagraphCallback) على الـ [BaseSlide](../../com.aspose.slides/baseslide). |
...
ستتم استدعاء Callback لكل \#paragraph(Presentation,ForEachParagraphCallback).paragraph(Presentation,ForEachParagraphCallback) على الـ [BaseSlide](../../com.aspose.slides/baseslide).
