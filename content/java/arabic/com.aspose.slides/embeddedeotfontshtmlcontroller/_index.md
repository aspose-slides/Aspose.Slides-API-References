...
description: فئة المتحكم في التنسيق المستخدمة لتضمين الخطوط بصيغة EOT
type: docs
...
الفئة المتحكم في التنسيق المستخدمة لتضمين الخطوط بصيغة EOT format
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [EmbeddedEotFontsHtmlController()](#EmbeddedEotFontsHtmlController--) | ينشئ كائنًا جديدًا. |
| [EmbeddedEotFontsHtmlController(IHtmlFormattingController controller)](#EmbeddedEotFontsHtmlController-com.aspose.slides.IHtmlFormattingController-) | ينشئ كائنًا جديدًا. |
## الأساليب
...
| المعامل | النوع | الوصف |
| --- | --- | --- |
| controller | [IHtmlFormattingController](../../com.aspose.slides/ihtmlformattingcontroller) | المتحكم في تنسيق HTML. |
...
يُستدعى قبل عرض الشكل. يُستدعى مرة واحدة لكل شكل. إذا كتبت هذه الدالة أي شيء إلى المولد، سوف يتم إنهاء إنشاء صورة الشريحة الحالية، يُدرج الجزء المضاف من html وستبدأ صورة جديدة فوق السابقة.
