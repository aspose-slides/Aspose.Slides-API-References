...
| [getStyleIndex()](#getStyleIndex--) | إرجاع الفهرس لتعبئة BackgroundType.Themed في مجموعة سمات الخلفية. |
| [setStyleIndex(int value)](#setStyleIndex-int-) | إرجاع الفهرس لتعبئة BackgroundType.Themed في مجموعة سمات الخلفية. |
...
إرجاع الفهرس لتعبئة BackgroundType.Themed في مجموعة سمات الخلفية. 0 يعني لا تعبئة. 1..999 - الفهرس. قراءة/كتابة int.
