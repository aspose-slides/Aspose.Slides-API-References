...
description: يمثل مجموعة من الأساليب المصممة لجمع كائنات النموذج من أنواع مختلفة.
type: docs
...
يمثل مجموعة من الأساليب المصممة لجمع كائنات النماذج من أنواع مختلفة من [Presentation](../../com.aspose.slides/presentation).
...
| الطريقة | الوصف |
| --- | --- |
| [shapes(Presentation pres)](#shapes-com.aspose.slides.Presentation-) | يجمع كل النسخ من [Shape](../../com.aspose.slides/shape) في [Presentation](../../com.aspose.slides/presentation). |
### Collect() {#Collect--}
```
public Collect()
```
...
يجمع كل النسخ من [Shape](../../com.aspose.slides/shape) في [Presentation](../../com.aspose.slides/presentation).
