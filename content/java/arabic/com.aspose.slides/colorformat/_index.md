...
يمثل لونًا مستخدمًا في عرض تقديمي.
## الطرق
...
| [getColor()](#getColor--) | إرجاع اللون الناتج (مع تطبيق جميع تحولات اللون). |
| [setColor(Color value)](#setColor-java.awt.Color-) | إرجاع اللون الناتج (مع تطبيق جميع تحولات اللون). |
| [getPresetColor()](#getPresetColor--) | إرجاع أو تعيين اللون المسبق. |
| [setPresetColor(int value)](#setPresetColor-int-) | إرجاع أو تعيين اللون المسبق. |
...
| [getSchemeColor()](#getSchemeColor--) | إرجاع أو تعيين اللون المحدد بواسطة مخطط ألوان. |
| [setSchemeColor(int value)](#setSchemeColor-int-) | إرجاع أو تعيين اللون المحدد بواسطة مخطط ألوان. |
...
| [getColorTransform()](#getColorTransform--) | إرجاع مجموعة تحولات اللون المطبقة على اللون. |
| [toString(int format)](#toString-int-) | إرجاع سلسلة تمثّل تنسيق اللون الحالي. |
| [copyFrom(IColorFormat color)](#copyFrom-com.aspose.slides.IColorFormat-) | نسخ تنسيق اللون من "color". |
| [equals(Object obj)](#equals-java.lang.Object-) | التحقق من المساواة مع الكائن المحدد. |
...
إرجاع اللون الناتج (مع تطبيق جميع تحولات اللون). تعيين ألوان RGB وإزالة جميع تحولات اللون. قراءة/كتابة java.awt.Color.
...
إرجاع أو تعيين اللون المسبق. قراءة/كتابة [PresetColor](../../com.aspose.slides/presetcolor).
...
إرجاع أو تعيين اللون المحدد بواسطة مخطط ألوان. قراءة/كتابة [SchemeColor](../../com.aspose.slides/schemecolor).
...
إرجاع أو تعيين المكوّن الأحمر للون. يتم تجاهل جميع تحولات اللون. قراءة/كتابة  byte .
...
إرجاع أو تعيين المكوّن الأزرق للون. يتم تجاهل جميع تحولات اللون. قراءة/كتابة  byte .
...
إرجاع أو تعيين المكوّن الأحمر للون. يتم تجاهل جميع تحولات اللون. قراءة/كتابة  float .
...
إرجاع أو تعيين المكوّن الأخضر للون. يتم تجاهل جميع تحولات اللون. قراءة/كتابة  float .
...
إرجاع أو تعيين المكوّن الأزرق للون. يتم تجاهل جميع تحولات اللون. قراءة/كتابة  float .
...
إرجاع أو تعيين مكوّن الصبغة للون في تمثيل HSL. يتم تجاهل جميع تحولات اللون. قراءة/كتابة  float .
...
إرجاع أو تعيين مكوّن التشبع للون في تمثيل HSL. يتم تجاهل جميع تحولات اللون. قراءة/كتابة  float .
...
إرجاع أو تعيين مكوّن الإضاءة للون في تمثيل HSL. يتم تجاهل جميع تحولات اللون. قراءة/كتابة  float .
...
إرجاع مجموعة تحولات اللون المطبقة على اللون. قراءة فقط [IColorOperationCollection](../../com.aspose.slides/icoloroperationcollection).
...
إرجاع سلسلة تمثّل تنسيق اللون الحالي.
...
التحقق من المساواة مع الكائن المحدد.

**المعاملات:**
| المعامل | النوع | الوصف |
| --- | --- | --- |
| obj | java.lang.Object | كائن. |
