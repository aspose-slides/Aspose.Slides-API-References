...
description: تمثّل مجموعة من PPImage.
type: docs
...
Returns a number of images in the collection. قراءة فقط  int .
...
Gets the element at the specified index. قراءة فقط [IPPImage](../../com.aspose.slides/ippimage).
...
Returns a value indicating whether access to the collection is synchronized (thread-safe). قراءة فقط  boolean .
...
Returns a synchronization root. قراءة فقط  Object .
