...
| [getGridSpacing()](#getGridSpacing--) | يعود أو يضبط تباعد الشبكة الذي يجب استخدامه للشبكة التي تدعم مستند العرض التقديمي، بالنقاط. |
| [setGridSpacing(float value)](#setGridSpacing-float-) | يعود أو يضبط تباعد الشبكة الذي يجب استخدامه للشبكة التي تدعم مستند العرض التقديمي، بالنقاط. |
...
يعيد أو يضبط تباعد الشبكة الذي يجب استخدامه للشبكة التي تدعم مستند العرض التقديمي، بالنقاط. قراءة/كتابة float.
...
يجب أن تكون قيمة تباعد الشبكة رقمًا موجبًا. النطاق النموذجي للقيمة هو من 1 ملم (2.8349607 نقاط) إلى 2 بوصة (144 نقطة).
