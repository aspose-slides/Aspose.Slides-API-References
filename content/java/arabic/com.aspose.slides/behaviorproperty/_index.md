...
تمثّل أنواع الخصائص لسلوك الرسوم المتحركة. يتبع قائمة الخصائص من https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx و https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx
## الطرق

| طريقة | الوصف |
| --- | --- |
| [getValue()](#getValue--) | قيمة الخاصية |
| [isCustom()](#isCustom--) | يظهر ما إذا كانت هذه الخاصية لا تنتمي إلى قائمة الخصائص المعرفة مسبقًا في المواصفة: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx |
...
| [equals(Object obj)](#equals-java.lang.Object-) | يتحقق مما إذا كان هذا الكائن مساويًا لكائن آخر. |
| [hashCode()](#hashCode--) | يحساب ويعيد رمز التجزئة بناءً على الخاصية (\#getValue.getValue) |
| [getOrCreateByValue(String propertyValue)](#getOrCreateByValue-java.lang.String-) | يبحث عن خاصية سلوك موجودة بالقيمة أو ينشئ واحدة مخصصة جديدة بالقيمة المحددة |
### getValue() {#getValue--}
```
...
يظهر ما إذا كانت هذه الخاصية لا تنتمي إلى قائمة الخصائص المعرفة مسبقًا في المواصفة: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx
...
يفحص ما إذا كان هذا الكائن يساوي كائنًا آخر.
...
**الإرجاع:**
boolean - صحيح إذا كانت الكائنات متساوية.
### hashCode() {#hashCode--}
```
public int hashCode()
```
...
**الإرجاع:**
int - يرجع قيمة التجزئة لهذا الكائن
...
يبحث عن خاصية سلوك موجودة بالقيمة أو ينشئ واحدة مخصصة جديدة بالقيمة المحددة
...
**الإرجاع:**
[BehaviorProperty](../../com.aspose.slides/behaviorproperty) - كائن من نوع BehaviorProperty