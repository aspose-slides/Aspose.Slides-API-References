...
| Method | Description |
| --- | --- |
| [getStartPosAlpha()](#getStartPosAlpha--) | يحدد موقع البداية (على طول منحدر تدرج ألفا) لقيمة ألفا البداية (نسبة مئوية). |
| [setStartPosAlpha(float value)](#setStartPosAlpha-float-) | يحدد موقع البداية (على طول منحدر تدرج ألفا) لقيمة ألفا البداية (نسبة مئوية). |
| [getEndPosAlpha()](#getEndPosAlpha--) | يحدد موقع النهاية (على طول منحدر تدرج ألفا) لقيمة ألفا النهاية (نسبة مئوية). |
| [setEndPosAlpha(float value)](#setEndPosAlpha-float-) | يحدد موقع النهاية (على طول منحدر تدرج ألفا) لقيمة ألفا النهاية (نسبة مئوية). |
| [getFadeDirection()](#getFadeDirection--) | يحدد الاتجاه لإزاحة الانعكاس. |
| [setFadeDirection(float value)](#setFadeDirection-float-) | يحدد الاتجاه لإزاحة الانعكاس. |
...
| [getSkewHorizontal()](#getSkewHorizontal--) | يحدد زاوة الانحراف الأفقي. |
| [setSkewHorizontal(double value)](#setSkewHorizontal-double-) | يحدد زاوة الانحراف الأفقي. |
| [getSkewVertical()](#getSkewVertical--) | يحدد زاوة الانحراف العمودي. |
| [setSkewVertical(double value)](#setSkewVertical-double-) | يحدد زاوة الانحراف العمودي. |
| [getRotateShadowWithShape()](#getRotateShadowWithShape--) | يحدد ما إذا كان الانعكاس يجب أن يدور مع الشكل إذا تم تدوير الشكل. |
| [setRotateShadowWithShape(boolean value)](#setRotateShadowWithShape-boolean-) | يحدد ما إذا كان الانعكاس يجب أن يدور مع الشكل إذا تم تدوير الشكل. |
| [getScaleHorizontal()](#getScaleHorizontal--) | يحدد عامل التحجيم الأفقي، التحجيم السالب يؤدي إلى انعكاس. |
| [setScaleHorizontal(double value)](#setScaleHorizontal-double-) | يحدد عامل التحجيم الأفقي، التحجيم السالب يؤدي إلى انعكاس. |
| [getScaleVertical()](#getScaleVertical--) | يحدد عامل التحجيم العمودي، التحجيم السالب يؤدي إلى انعكاس. |
| [setScaleVertical(double value)](#setScaleVertical-double-) | يحدد عامل التحجيم العمودي، التحجيم السالب يؤدي إلى انعكاس. |
| [getEffective()](#getEffective--) | يحصل على بيانات تأثير الانعكاس الفعّالة مع تطبيق الوراثة. |
| [getParent_Immediate()](#getParent-Immediate--) |  |
| [getVersion()](#getVersion--) |  |
| [getParent_IPresentationComponent()](#getParent-IPresentationComponent--) |  |
| [equals(Object obj)](#equals-java.lang.Object-) | يحدد ما إذا كان [Reflection](../../com.aspose.slides/reflection) المحدد يساوي [Reflection](../../com.aspose.slides/reflection) الحالي. |
...
يحدد موقع البداية (على طول منحدر تدرج ألفا) لقيمة ألفا البداية (نسبة مئوية). قراءة/كتابة float.
...
يحدد موقع النهاية (على طول منحدر تدرج ألفا) لقيمة ألفا النهاية (نسبة مئوية). قراءة/كتابة float.
...
يحدد الاتجاه لإزاحة الانعكاس. (زاوية). قراءة/كتابة float.
...
يحدد زاوة الانحراف الأفقي. قراءة/كتابة double.
...
يحدد زاوة الانحراف العمودي. قراءة/كتابة double.
...
يحدد ما إذا كان الانعكاس يجب أن يدور مع الشكل إذا تم تدوير الشكل. قراءة/كتابة boolean.
...
يحدد عامل التحجيم الأفقي، التحجيم السالب يؤدي إلى انعكاس. (نسبة مئوية) قراءة/كتابة double.
...
يحدد عامل التحجيم العمودي، التحجيم السالب يؤدي إلى انعكاس. (نسبة مئوية) قراءة/كتابة double.
...
إرجاع IPresentationComponent الأصل. قراءة فقط [IPresentationComponent](../../com.aspose.slides/ipresentationcomponent).
...
يحدد ما إذا كان [Reflection](../../com.aspose.slides/reflection) المحدد يساوي [Reflection](../../com.aspose.slides/reflection) الحالي.
