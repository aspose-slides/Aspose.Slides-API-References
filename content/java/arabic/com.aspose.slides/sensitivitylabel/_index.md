...
يمثّل تسمية الحساسية من Microsoft Purview Information Protection.

## الطرق

| Method | Description |
| --- | --- |
| [getId()](#getId--) | إرجاع أو تعيين معرف تسمية الحساسية. |
| [setId(String value)](#setId-java.lang.String-) | إرجاع أو تعيين معرف تسمية الحساسية. |
| [getSiteId()](#getSiteId--) | إرجاع أو تعيين معرف موقع Azure Active Directory (Azure AD) المتعلق بسياسة تسمية الحساسية التي تصف تسمية الحساسية. |
| [setSiteId(UUID value)](#setSiteId-java.util.UUID-) | إرجاع أو تعيين معرف موقع Azure Active Directory (Azure AD) المتعلق بسياسة تسمية الحساسية التي تصف تسمية الحساسية. |
...
| [isRemoved()](#isRemoved--) | يشير إلى ما إذا تم حذف تسمية الحساسية. |
| [setRemoved(boolean value)](#setRemoved-boolean-) | يشير إلى ما إذا تم حذف تسمية الحساسية. |
...
| [getContentMarkTypes()](#getContentMarkTypes--) | إرجاع قائمة بأنواع تمييز المحتوى التي يجب تطبيقها على ملف. |
...
إرجاع أو تعيين معرف تسمية الحساسية. قراءة/كتابة String.
...
إرجاع أو تعيين معرف موقع Azure Active Directory (Azure AD) المتعلق بسياسة تسمية الحساسية التي تصف تسمية الحساسية. قراءة/كتابة java.util.UUID.
...
يشير إلى ما إذا تم حذف تسمية الحساسية.
...
إرجاع قائمة بأنواع تمييز المحتوى التي يجب تطبيقها على ملف.
