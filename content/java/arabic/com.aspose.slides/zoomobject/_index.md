...
| [getShowBackground()](#getShowBackground--) | الحصول على أو تعيين القيمة التي تحدد ما إذا كان Zoom سيستخدم خلفية الشريحة المستهدفة. |
| [setShowBackground(boolean value)](#setShowBackground-boolean-) | الحصول على أو تعيين القيمة التي تحدد ما إذا كان Zoom سيستخدم خلفية الشريحة المستهدفة. |
| [getZoomImage()](#getZoomImage--) | الحصول على أو تعيين صورة لكائن Zoom. |
| [setZoomImage(IPPImage value)](#setZoomImage-com.aspose.slides.IPPImage-) | الحصول على أو تعيين صورة لكائن Zoom. |
...
الحصول على أو تعيين القيمة التي تحدد ما إذا كان Zoom سيستخدم خلفية الشريحة المستهدفة. قراءة/كتابة boolean. القيمة الافتراضية: true
...
الحصول على أو تعيين صورة لكائن Zoom. قراءة/كتابة [IPPImage](../../com.aspose.slides/ippimage).
...
إذا لم يتم تحديده (TransitionDur = 0)، سيستخدم انتقال الشريحة المستهدفة والتوقيتات المرتبطة بذلك الانتقال.
