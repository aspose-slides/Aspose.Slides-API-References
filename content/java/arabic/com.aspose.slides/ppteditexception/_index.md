...
type: docs
url: /ar/com.aspose.slides/ppteditexception/
---
**الوراثة:**
...
| المُنشئ | الوصف |
| --- | --- |
| [PptEditException()](#PptEditException--) | المنشئ الافتراضي. |
| [PptEditException(String message)](#PptEditException-java.lang.String-) | منشئ يسمح بإضافة رسالة إلى هذا الاستثناء. |
| [PptEditException(String message, RuntimeException exception)](#PptEditException-java.lang.String-java.lang.RuntimeException-) | منشئ لاستثناء يحتوي على رسالة واستثناء مضمّن. |
...
| المعلمة | النوع | الوصف |
| --- | --- | --- |
| message | java.lang.String | رسالة |
