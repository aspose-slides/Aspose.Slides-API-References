...
| المنشئ | الوصف |
| --- | --- |
| [DigitalSignature(byte[] certData, String password)](#DigitalSignature-byte---java.lang.String-) | ينشئ كائن DigitalSignature جديد باستخدام الشهادة المحددة. |
| [DigitalSignature(String filePath, String password)](#DigitalSignature-java.lang.String-java.lang.String-) | ينشئ كائن DigitalSignature جديد باستخدام مسار ملف الشهادة وكلمة المرور المحددة. |
## الطرق

| الطريقة | الوصف |
| --- | --- |
| [getCertificate()](#getCertificate--) | كائن الشهادة الذي تم استخدامه لتوقيع المستند. |
| [isValid()](#isValid--) | إذا كان هذا التوقيع الرقمي صالحًا ولم يتم العبث بالمستند، ستكون القيمة true. |
...
ينشئ كائن DigitalSignature جديد باستخدام الشهادة المحددة.
...
ينشئ كائن DigitalSignature جديد باستخدام مسار ملف الشهادة وكلمة المرور المحددة.

**المعلمات:**
| المعلمة | النوع | الوصف |
| --- | --- | --- |
| filePath | java.lang.String | مسار الملف الذي يحتوي على الشهادة. |
| password | java.lang.String | كلمة المرور المطلوبة للوصول إلى الشهادة. |
...
كائن الشهادة الذي تم استخدامه لتوقيع المستند. قراءة فقط byte[].
...
إذا كان هذا التوقيع الرقمي صالحًا ولم يتم العبث بالمستند، ستكون القيمة true. قراءة فقط boolean.
...
الوقت الذي تم فيه توقيع المستند. قراءة فقط java.util.Date.
