...
description: استثناء يُرمى عندما يكون ملف العرض على الأرجح تالفًا.
type: docs
url: /ar/com.aspose.slides/pptxcorruptfileexception/
---
**الوراثة:**
...
استثناء يُرمى عندما يكون ملف العرض على الأرجح تالفًا.
## المُنشئات

| المُنشئ | الوصف |
| --- | --- |
| [PptxCorruptFileException()](#PptxCorruptFileException--) | المنشئ الافتراضي. |
| [PptxCorruptFileException(String message)](#PptxCorruptFileException-java.lang.String-) | منشئ يسمح بإضافة رسالة إلى هذا الاستثناء. |
| [PptxCorruptFileException(String message, RuntimeException exception)](#PptxCorruptFileException-java.lang.String-java.lang.RuntimeException-) | منشئ لاستثناء يحتوي على رسالة واستثناء مضمّن. |
