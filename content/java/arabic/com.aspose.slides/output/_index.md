...
| [getResourcePath(Object obj)](#getResourcePath-java.lang.Object-) | يعيد المسار لمورد معين. |
...
| المعامل | النوع | الوصف |
| --- | --- | --- |
| path | java.lang.String | مسار الملف حيث سيتم حفظ الخط. |
| fontData | [IFontData](../../com.aspose.slides/ifontdata) | بيانات الخط التي ستكتب إلى الإخراج. |
| fontStyle | int | نمط الخط (مثل Regular, Bold, Italic). |

**القيمة المرجعة:**
[IOutputFile](../../com.aspose.slides/ioutputfile) - نسخة [IOutputFile](../../com.aspose.slides/ioutputfile) للخط المُنشأ.
