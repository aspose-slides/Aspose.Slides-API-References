...
type: docs
url: /tr/com.aspose.slides/pictureframelock/
---
**Kalıtım:**
...
| [getRotationLocked()](#getRotationLocked--) | Bu şeklin döndürme açısının değiştirilmesinin yasak olup olmadığını belirler. |
| [setRotationLocked(boolean value)](#setRotationLocked-boolean-) | Bu şeklin döndürme açısının değiştirilmesinin yasak olup olmadığını belirler. |
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Bir şeklin yeniden boyutlandırmada en boy oranını koruması gerekip gerekmediğini belirler. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Bir şeklin yeniden boyutlandırmada en boy oranını koruması gerekip gerekmediğini belirler. |
| [getPositionLocked()](#getPositionLocked--) | Bu şeklin taşınmasının yasak olup olmadığını belirler. |
| [setPositionLocked(boolean value)](#setPositionLocked-boolean-) | Bu şeklin taşınmasının yasak olup olmadığını belirler. |
...
| [getArrowheadsLocked()](#getArrowheadsLocked--) | Ok uçlarının değiştirilmesinin yasak olup olmadığını belirler. |
| [setArrowheadsLocked(boolean value)](#setArrowheadsLocked-boolean-) | Ok uçlarının değiştirilmesinin yasak olup olmadığını belirler. |
| [getShapeTypeLocked()](#getShapeTypeLocked--) | Bir şekil tipinin değiştirilmesinin yasak olup olmadığını belirler. |
| [setShapeTypeLocked(boolean value)](#setShapeTypeLocked-boolean-) | Bir şekil tipinin değiştirilmesinin yasak olup olmadığını belirler. |
| [getCropLocked()](#getCropLocked--) | Bir resmin kırpılmasının yasak olup olmadığını belirler. |
| [setCropLocked(boolean value)](#setCropLocked-boolean-) | Bir resmin kırpılmasının yasak olup olmadığını belirler. |
...
Bu şeklin döndürme açısının değiştirilmesinin yasak olup olmadığını belirler. Okuma/Yazma boolean.
...
Bir şeklin yeniden boyutlandırmada en boy oranını koruması gerekip gerekmediğini belirler. Okuma/Yazma boolean.
...
Ayar değerlerinin değiştirilmesinin yasak olup olmadığını belirler. Okuma/Yazma boolean.
...
Ok uçlarının değiştirilmesinin yasak olup olmadığını belirler. Okuma/Yazma boolean.
...
Bir resmin kırpılmasının yasak olup olmadığını belirler. Okuma/Yazma boolean.
