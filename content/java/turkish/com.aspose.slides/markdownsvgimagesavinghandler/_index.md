...
| Yöntem | Açıklama |
| --- | --- |
| [invoke(ISvgImage svgImage, String[] link)](#invoke-com.aspose.slides.ISvgImage-java.lang.String---) | Markdown dışa aktarımı sırasında her SVG görüntü için çağrılır. |
...
Markdown dışa aktarımı sırasında her SVG görüntü için çağrılır. Belirtilen bağlantıyı kullanmak için true, varsayılan kaydetme mantığını uygulamak için false döndürün.
