...
| Yöntem | Açıklama |
| --- | --- |
| [getCount()](#getCount--) | Dizideki efekt sayısını döndürür. |
...
| [clear()](#clear--) | Bir koleksiyondaki tüm efektleri kaldırır. |
| [get_Item(int index)](#get-Item-int-) | Belirtilen indeksteki bir efekti döndürür. |
| [getTriggerShape()](#getTriggerShape--) | INTERACTIVE dizisi için şekil hedefini döndürür veya ayarlar. |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | INTERACTIVE dizisi için şekil hedefini döndürür veya ayarlar. |
...
| [addEffect(IChart chart, int type, int index, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-) | Kategori ya da seri için yeni bir grafik animasyon efektini dizinin sonuna ekler. |
| [addEffect(IChart chart, int type, int seriesIndex, int categoriesIndex, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-int-) | Kategori ya da serideki öğeler için yeni bir grafik animasyon efektini dizinin sonuna ekler. |
### getCount() {#getCount--}
```
public abstract int getCount()
```

Bir dizideki efekt sayısını döndürür. Salt okunur int.
...
INTERACTIVE dizisi için şekil hedefini döndürür veya ayarlar. Dizi etkileşimli değilse null döndürür. Okuma/Yazma [IShape](../../com.aspose.slides/ishape).
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | Efekt eklemek için Şekil nesnesi [IShape](../../com.aspose.slides/ishape) |
...
| triggerType | int | Efektin tetik türü [EffectTriggerType](../../com.aspose.slides/effecttriggertype) |
...
Kategori ya da seri için yeni bir grafik animasyon efektini dizinin sonuna ekler.
...
Kategori ya da serideki öğeler için yeni bir grafik animasyon efektini dizinin sonuna ekler.
