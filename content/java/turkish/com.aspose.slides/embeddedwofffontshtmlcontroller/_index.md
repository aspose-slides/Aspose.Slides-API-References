...
description: WOFF formatında yazı tiplerini gömmek için kullanılacak biçimlendirme denetleyici sınıfı
type: docs
...
WOFF formatında yazı tiplerini gömmek için kullanılacak biçimlendirme denetleyici sınıfı
## Yapıcılar
...
Şekil işlenmeden önce çağrılır. Her şekil için bir kez çağrılır. Bu işlev generator'e bir şey yazarsa, mevcut slayt görüntüsü oluşturma tamamlanır, ek HTML parçası eklenir ve yeni görüntü bir öncekinin üzerine başlatılır.
