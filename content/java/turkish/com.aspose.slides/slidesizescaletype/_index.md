...
type: docs
url: /tr/com.aspose.slides/slidesizescaletype/
---
**Kalıtım:**
...
Slide içeriğinin ölçek türünü temsil eder.
## Alanlar

| Alan | Açıklama |
| --- | --- |
| [DoNotScale](#DoNotScale) | Ölçeklendirme yapma. |
| [EnsureFit](#EnsureFit) | Uyum sağlamak için ölçekle. |
| [Maximize](#Maximize) | İçeriğin boyutunu en üst seviyeye çıkar. |
...
İçeriğin boyutunu en üst seviyeye çıkar.