...
>  try {
>      // AddAutoShape yöntemi kullanarak bir şekil ekle.
...
>      // ITextFrame'in ThreeDFormat özelliklerini belirle.
...
| [getContourWidth()](#getContourWidth--) | 3D konturunun genişliğini döndürür veya ayarlar. |
| [setContourWidth(double value)](#setContourWidth-double-) | 3D konturunun genişliğini döndürür veya ayarlar. |
| [getExtrusionHeight()](#getExtrusionHeight--) | Ekstrüzyon efektinin yüksekliğini döndürür veya ayarlar. |
| [setExtrusionHeight(double value)](#setExtrusionHeight-double-) | Ekstrüzyon efektinin yüksekliğini döndürür veya ayarlar. |
...
| [getEffective()](#getEffective--) | Miras uygulanmış etkili 3-D biçimlendirme verilerini alır. |
### getVersion() {#getVersion--}
```
...
3D konturunun genişliğini döndürür veya ayarlar. Okunur/yazılır double.
...
Ekstrüzyon efektinin yüksekliğini döndürür veya ayarlar. Okunur/yazılır double.
...
Üst 3D köşebentinin tipini döndürür veya ayarlar. Yalnızca okunabilir [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Alt 3D köşebentinin tipini döndürür veya ayarlar. Yalnızca okunabilir [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Konturun rengini döndürür veya ayarlar. Yalnızca okunabilir [IColorFormat](../../com.aspose.slides/icolorformat).
...
Ekstrüzyonun rengini döndürür veya ayarlar. Yalnızca okunabilir [IColorFormat](../../com.aspose.slides/icolorformat).
...
Kameranın ayarlarını döndürür veya ayarlar. Yalnızca okunabilir [ICamera](../../com.aspose.slides/icamera).
...
Işığın tipini döndürür veya ayarlar. Yalnızca okunabilir [ILightRig](../../com.aspose.slides/ilightrig).
