...
| [getRotateWithShape()](#getRotateWithShape--) | Dolgunun bir şekille döndürülüp döndürülmeyeceğini belirler. |
| [setRotateWithShape(byte value)](#setRotateWithShape-byte-) | Dolgunun bir şekille döndürülüp döndürülmeyeceğini belirler. |
...
Dolgu türünü döndürür veya ayarlar. Okuma/yazma [FillType](../../com.aspose.slides/filltype).
...
Dolgunun bir şekille döndürülüp döndürülmeyeceğini belirler. Okuma/yazma [NullableBool](../../com.aspose.slides/nullablebool).
