...
description: Üst bağlayıcıda hangi işlemlerin devre dışı bırakıldığını belirler.
type: docs
...
| [getAdjustHandlesLocked()](#getAdjustHandlesLocked--) | Bu şeklin ayar değerlerinin değiştirilmesinin yasak olup olmadığını belirler. |
| [setAdjustHandlesLocked(boolean value)](#setAdjustHandlesLocked-boolean-) | Bu şeklin ayar değerlerinin değiştirilmesinin yasak olup olmadığını belirler. |
| [getArrowheadsLocked()](#getArrowheadsLocked--) | Bu şeklin ok başlarının değiştirilmesinin yasak olup olmadığını belirler. |
| [setArrowheadsLocked(boolean value)](#setArrowheadsLocked-boolean-) | Bu şeklin ok başlarının değiştirilmesinin yasak olup olmadığını belirler. |
| [getShapeTypeLocked()](#getShapeTypeLocked--) | Bu şeklin tipinin değiştirilmesinin yasak olup olmadığını belirler. |
| [setShapeTypeLocked(boolean value)](#setShapeTypeLocked-boolean-) | Bu şeklin tipinin değiştirilmesinin yasak olup olmadığını belirler. |
...
Bir şeklin yeniden boyutlandırma sırasında en boy oranını koruması gerekip gerekmediğini belirler. Okunur/yazılır boolean.
...
Bu şeklin ayar değerlerinin değiştirilmesinin yasak olup olmadığını belirler. Okunur/yazılır boolean.
...
Bu şeklin ok başlarının değiştirilmesinin yasak olup olmadığını belirler. Okunur/yazılır boolean.
...
Bu şeklin tipinin değiştirilmesinin yasak olup olmadığını belirler. Okunur/yazılır boolean.
