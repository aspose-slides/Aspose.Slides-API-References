...
| Metot | Açıklama |
| --- | --- |
| [size()](#size--) | Gerçekte koleksiyonda bulunan satır sayısını alır. |
| [get_Item(int index)](#get-Item-int-) | Belirtilen indeksdeki satırı döndürür. |
...
Gerçekte koleksiyonda bulunan satır sayısını alır. Salt okunur int.
...
Belirtilen indeksdeki satırı döndürür. Salt okunur [Row](../../com.aspose.slides/row).
...
| withAttachedRows | boolean | Tüm ekli satırları da silmek için true. |
...
**Döndürür:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IRow> - Koleksiyon üzerinden yineleme yapmak için kullanılabilen bir IGenericEnumerator.
