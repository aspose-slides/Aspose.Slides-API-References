...
| chartIndex | int | Eklenecek grafik şeklinin sıfır tabanlı dizini. Bu dizin [IExcelDataWorkbook.getChartsFromWorksheet(String)](../../com.aspose.slides/iexceldataworkbook\#getChartsFromWorksheet-String-) metodu kullanılarak elde edilebilir. |
| embedAllWorkbook | boolean | Doğru ise, tüm çalışma kitabı grafik içine gömülür; yanlış ise, yalnızca grafik verileri gömülür. |
...
| x | float | Grafiği konumlandırmak için X koordinatı. |
| y | float | Grafiği konumlandırmak için Y koordinatı. |
| workbookStream | java.io.InputStream | Çalışma kitabı verilerini içeren akış. |
| worksheetName | java.lang.String | Grafiği içeren çalışma sayfasının adı. |
| chartName | java.lang.String | Eklenecek grafiğin adı. |
| embedAllWorkbook | boolean | Doğru ise, tüm çalışma kitabı grafik içine gömülür; yanlış ise, yalnızca grafik verileri gömülür. |
...
| worksheetName | java.lang.String | Grafiği içeren çalışma sayfasının adı. |
| chartName | java.lang.String | Eklenecek grafiğin adı. |
| embedWorkbook | boolean | Doğru ise, çalışma kitabı grafik içine gömülür; yanlış ise, grafik harici çalışma kitabına bağlanır. |
