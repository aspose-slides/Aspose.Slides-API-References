...
Bu sınıf, metin bölümünün biçimlendirme özelliklerini içerir. [IPortionFormatEffectiveData](../../com.aspose.slides/iportionformateffectivedata)'in aksine, bu sınıfın tüm özellikleri yazılabilir.
...
Bu sınıf, belirli bölüm için tanımlanan metin bölümünün biçimlendirme özelliklerini döndürmek ve değiştirmek için kullanılır. Bu, değerler alınırken hiçbir kalıtım uygulanmadığı anlamına gelir, bu yüzden çoğu durumda "tanımsız" anlamına gelen değerler alırsınız.

Kalıtım dahil olmak üzere efektif biçimlendirme parametresi değerlerini almak için [getEffective](../../com.aspose.slides/portionformat\#getEffective) metodunu kullanmanız gerekir; bu metod bir [IPortionFormatEffectiveData](../../com.aspose.slides/iportionformateffectivedata) örneği döndürür.
...
| [getEffective()](#getEffective--) | Kalıtım uygulanmış efektif bölüm biçimlendirme verilerini alır. |
...
Fare tıklaması için tanımlanan köprüyü döndürür veya ayarlar. Okunur/yazılır [IHyperlink](../../com.aspose.slides/ihyperlink).
...
Fare üzerindeyken tanımlanan köprüyü döndürür veya ayarlar. Okunur/yazılır [IHyperlink](../../com.aspose.slides/ihyperlink).
...
Köprü yöneticisi. Yalnızca okunur [IHyperlinkManager](../../com.aspose.slides/ihyperlinkmanager).
...
Kalıtım uygulanmış efektif bölüm biçimlendirme verilerini alır.
