...
| [add(IFontSubstRule value)](#add-com.aspose.slides.IFontSubstRule-) | Yeni yazı tipi ikamesi kuralını koleksiyona ekler |
| [remove(IFontSubstRule value)](#remove-com.aspose.slides.IFontSubstRule-) | Koleksiyondan belirli bir nesnenin ilk oluşumunu kaldırır. |
...
Yeni yazı tipi ikamesi kuralını koleksiyona ekler
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) | Koleksiyondan kaldırılacak yazı tipi ikamesi kuralı. |
