...
description: pptx sunum belgesinde saklanabilen dize veya double değeri iki şekilde temsil eder: 1) grafikle ilişkili çalışma kitabının hücre/hücrelerinde, 2) literal değer olarak.
type: docs
...
pptx sunum belgesinde saklanabilen dize veya double değeri iki şekilde temsil eder: 1) grafikle ilişkili çalışma kitabının hücre/hücrelerinde; 2) literal değer olarak.
## Yöntemler
