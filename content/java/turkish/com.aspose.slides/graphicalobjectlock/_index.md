...
description: Üst GraphicalObject nesnesinde hangi işlemlerin devre dışı bırakıldığını belirler.
type: docs
url: /tr/com.aspose.slides/graphicalobjectlock/
---
**Kalıtım:**
...
Üst GraphicalObject nesnesinde hangi işlemlerin devre dışı bırakıldığını belirler.
## Yöntemler
...
| [getDrilldownLocked()](#getDrilldownLocked--) | Bu nesnenin alt şekillerinin seçilmesinin yasak olup olmadığını belirler. |
| [setDrilldownLocked(boolean value)](#setDrilldownLocked-boolean-) | Bu nesnenin alt şekillerinin seçilmesinin yasak olup olmadığını belirler. |
...
Şeklin yeniden boyutlandırma sırasında en-boy oranını koruması gerekip gerekmediğini belirler. Okunur/yazılabilir boolean.
