...
description: Efektlerin bir sıra koleksiyonunu temsil eder.
type: docs
...
Bir dizi (etki koleksiyonu) temsil eder.
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [getCount()](#getCount--) | Bir dizi içindeki efektlerin sayısını döndürür. |
...
| [get_Item(int index)](#get-Item-int-) | Belirtilen indekste bir efekti döndürür. |
| [iterator()](#iterator--) | Koleksiyon içinde yineleme yapan bir enumerator döndürür. |
| [iteratorJava()](#iteratorJava--) | Tüm koleksiyon için bir java iterator döndürür. |
| [getTriggerShape()](#getTriggerShape--) | INTERACTIVE dizi için şekil hedefini döndürür veya ayarlar. |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | INTERACTIVE dizi için şekil hedefini döndürür veya ayarlar. |
| [removeByShape(IShape shape)](#removeByShape-com.aspose.slides.IShape-) | Belirtilen şekil için efekti kaldır. |
...
| [addEffect(IChart chart, int type, int index, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-) | Kategori veya seriye yeni bir grafik animasyon efektini dizinin sonuna ekler. |
...
Bir dizi içindeki efekt sayısını döndürür. Salt okunur int.
...
Belirtilen indekste bir efekti döndürür.
...
**Döndürür:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffect> - Koleksiyon içinde yineleme yapmak için kullanılabilen bir IGenericEnumerator.
...
INTERACTIVE dizi için şekil hedefini döndürür veya ayarlar. Dizi etkileşimli değilse null döndürür. Okunur/yazılabilir [IShape](../../com.aspose.slides/ishape).
...
>   try
>   {        
>      // etkisi eklenecek paragrafı seç
>      IAutoShape autoShape = (IAutoShape)presentation.getSlides().get_Item(0).getShapes().get_Item(0);
>      IParagraph paragraph = autoShape.getTextFrame().getParagraphs().get_Item(0);
>      // seçili paragrafa Fly animasyon etkisi ekle
...
Kategori veya seriye yeni bir grafik animasyon efektini dizinin sonuna ekler.

**Parametreler:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| chart | [IChart](../../com.aspose.slides/ichart) | [IChart](../../com.aspose.slides/ichart) grafik nesnesi |
| type | int | Bir animasyon efektinin türü [EffectChartMinorGroupingType](../../com.aspose.slides/effectchartminorgroupingtype) |
