...
| Yöntem | Açıklama |
| --- | --- |
| [getShapeType()](#getShapeType--) | Geometri ön ayar tipini alır veya ayarlar. |
| [setShapeType(int value)](#setShapeType-int-) | Geometri ön ayar tipini alır veya ayarlar. |
...
Geometri ön ayar tipini alır veya ayarlar. Not: değer değiştirildiğinde tüm ayar değerleri varsayılan değerlerine sıfırlanır. Okunabilir/yazılabilir [ShapeType](../../com.aspose.slides/shapetype).
