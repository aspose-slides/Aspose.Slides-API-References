...
description: Ebeveyn Connector'da hangi işlemlerin devre dışı bırakıldığını belirler.
type: docs
url: /tr/com.aspose.slides/connectorlock/
---
**Kalıtım:**
...
Ebeveyn Connector'da hangi işlemlerin devre dışı bırakıldığını belirler.
## Yöntemler
...
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Bir şeklin yeniden boyutlandırma sırasında en-boy oranını koruması gerekip gerekmediğini belirler. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Bir şeklin yeniden boyutlandırma sırasında en-boy oranını koruması gerekip gerekmediğini belirler. |
...
Bir şeklin yeniden boyutlandırma sırasında en-boy oranını koruması gerekip gerekmediğini belirler. Okuma/yazma boolean.
...
Ayarlama değerlerinin değiştirilmesinin yasak olup olmadığını belirler. Okuma/yazma boolean.
