...
| [getCount()](#getCount--) | Koleksiyonun gerçekte içerdiği öğe sayısını alır. |
...
**Dönüş Değeri:**
boolean - öğe koleksiyondan başarılı bir şekilde kaldırıldıysa true; aksi takdirde false. Öğenin orijinal koleksiyonda bulunmaması durumunda da false döner.
