...
| Yöntem | Açıklama |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Belirtilen indeksdeki kuralı alır. |
...
| [remove(IFontFallBackRule targetRule)](#remove-com.aspose.slides.IFontFallBackRule-) | Koleksiyondan belirli bir FallBack kuralının ilk oluşumunu kaldırır. |
### get_Item(int index) {#get-Item-int-}
```
public abstract IFontFallBackRule get_Item(int index)
```

Belirtilen indeksdeki kuralı alır. Yalnızca okuma [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule).
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| sourceRule | [IFontFallBackRule](../../com.aspose.slides/ifontfallbackrule) | Eklemek için belirtilen kural |
