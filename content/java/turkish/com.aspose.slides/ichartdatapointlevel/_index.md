...
| [getLabel()](#getLabel--) | Veri noktası seviyesinin veri etiketini temsil eder. |
### getFormat() {#getFormat--}
```
...
Veri noktası seviyesinin veri etiketini temsil eder. Treemap ve Sunburst seri tipleri için uygulanır. Salt Okunur [IDataLabel](../../com.aspose.slides/idatalabel).
