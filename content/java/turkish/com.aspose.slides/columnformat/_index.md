...
| Yöntem | Açıklama |
| --- | --- |
| [getEffective()](#getEffective--) | Kalıtım ve tablo stilleri uygulanmış etkili tablo sütunu biçimlendirme özelliklerini alır. |
...
Üst IPresentationComponent döndürür. Salt-okunur [IPresentationComponent](../../com.aspose.slides/ipresentationcomponent).
