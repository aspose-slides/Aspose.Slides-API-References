...
| [setRotateWithShape(byte value)](#setRotateWithShape-byte-) | Dolgunun şekil ile birlikte döndürülüp döndürülmeyeceğini belirler. |
| [getEffective()](#getEffective--) | Uygulanan kalıtımla etkili dolgu biçimlendirme verilerini alır. |
### getVersion() {#getVersion--}
```
...
Resim dolgu biçimini döndürür. Salt okunur [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
Dolgunun şekil ile birlikte döndürülüp döndürülmeyeceğini belirler. Okunur/yazılabilir [NullableBool](../../com.aspose.slides/nullablebool).
...
Uygulanan kalıtımla etkili dolgu biçimlendirme verilerini alır.
