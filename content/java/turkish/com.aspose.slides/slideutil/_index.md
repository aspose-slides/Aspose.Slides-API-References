...
description: Sunumda şekilleri ve metni aramaya yardımcı yöntemler sunar.
type: docs
...
| Yöntem | Açıklama |
| --- | --- |
| [findShape(IPresentation pres, String altText)](#findShape-com.aspose.slides.IPresentation-java.lang.String-) | PPTX sunumunda alternatif metne göre şekil bulur. |
| [findShape(IBaseSlide slide, String altText)](#findShape-com.aspose.slides.IBaseSlide-java.lang.String-) | PPTX sunumundaki bir slaytta alternatif metne göre şekil bulur. |
...
| [alignShapes(int alignmentType, boolean alignToSlide, IBaseSlide slide)](#alignShapes-int-boolean-com.aspose.slides.IBaseSlide-) | Slayttaki tüm şekillerin yerleşimini değiştirir. |
| [alignShapes(int alignmentType, boolean alignToSlide, IBaseSlide slide, int[] shapeIndexes)](#alignShapes-int-boolean-com.aspose.slides.IBaseSlide-int---) | Slayttaki seçilen şekillerin yerleşimini değiştirir. |
| [alignShapes(int alignmentType, boolean alignToSlide, IGroupShape groupShape)](#alignShapes-int-boolean-com.aspose.slides.IGroupShape-) | Grup şeklindeki tüm şekillerin yerleşimini değiştirir. |
| [alignShapes(int alignmentType, boolean alignToSlide, IGroupShape groupShape, int[] shapeIndexes)](#alignShapes-int-boolean-com.aspose.slides.IGroupShape-int---) | Grup şekli içindeki seçilen şekillerin yerleşimini değiştirir. |
| [findAndReplaceText(IPresentation presentation, boolean withMasters, String find, String replace)](#findAndReplaceText-com.aspose.slides.IPresentation-boolean-java.lang.String-java.lang.String-) | Sunumda verilen formatta metin bulur ve değiştirir |
| [findAndReplaceText(IPresentation presentation, boolean withMasters, String find, String replace, PortionFormat format)](#findAndReplaceText-com.aspose.slides.IPresentation-boolean-java.lang.String-java.lang.String-com.aspose.slides.PortionFormat-) | Sunumda verilen formatta metin bulur ve değiştirir |
| [getAllTextBoxes(IBaseSlide slide)](#getAllTextBoxes-com.aspose.slides.IBaseSlide-) | PPTX sunumundaki bir slayttaki tüm metin çerçevelerini döndürür. |
...
| [getAllTextFrames(IPresentation pres, boolean withMasters)](#getAllTextFrames-com.aspose.slides.IPresentation-boolean-) | PPTX sunumundaki tüm metin çerçevelerini döndürür. |
...
PPTX sunumundaki bir slaytta alternatif metne göre şekil bulur.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| slide | [IBaseSlide](../../com.aspose.slides/ibaseslide) | Şekilleri aramak için slayt. |
| placeholderType | byte | Şekilleri filtrelemek için kullanılan yer tutucu türü. |

**Döndürür:**
com.aspose.slides.IShape[] - Belirtilen yer tutucu türüyle eşleşen [IShape](../../com.aspose.slides/ishape) nesnelerinin bir dizisi.
...
Slayttaki tüm şekillerin yerleşimini değiştirir. Şekilleri kenar boşluklarına veya slayt kenarına hizalar ya da birbirlerine göre hizalar.
...
| alignToSlide | boolean | Doğru ise, şekiller slayt kenarlarına göre hizalanır. |
...
Slayttaki seçilen şekillerin yerleşimini değiştirir. Şekilleri kenar boşluklarına veya slayt kenarına hizalar ya da birbirlerine göre hizalar.
...
Grup şekli içindeki tüm şekillerin yerleşimini değiştirir. Şekilleri kenar boşluklarına veya slayt kenarına hizalar ya da birbirlerine göre hizalar.
...
Grup şekli içindeki seçilen şekillerin yerleşimini değiştirir. Şekilleri kenar boşluklarına veya slayt kenarına hizalar ya da birbirlerine göre hizalar.
...
Sunumda verilen formatta metin bulur ve değiştirir
...
| replace | java.lang.String | Değiştirilecek dize değeri. character of the found string |
...
| format | [PortionFormat](../../com.aspose.slides/portionformat) | Metin kısmını değiştirmek için format. Null ise bulunan dizenin ilk karakterinin formatı kullanılacak |
...
PPTX sunumundaki bir slayttaki tüm metin çerçevelerini döndürür.
...
**Döndürür:**
com.aspose.slides.ITextFrame[] - [TextFrame](../../com.aspose.slides/textframe) nesnelerinin dizisi.
...
| checkPlaceholderText | boolean | Metin çerçevelerinin boş olup, ancak yer tutucu metni arama metnini içerip içermediğini belirler. |
...
PPTX sunumundaki tüm metin çerçevelerini döndürür.
...
Bir kaynak dosya formatını karşılık gelen [SaveFormat](../../com.aspose.slides/saveformat)'ye dönüştürür.
