...
| [getActiveXControlBinary()](#getActiveXControlBinary--) | PersistStream, PersistStreamInit veya PersistStorage yöntemi kullanıldığında bir ActiveX denetiminin kalıcılığını belirtir. |
### getName() {#getName--}
```
...
Bu denetimin adını döndürür. Okunur/Yazılabilir String.
...
Denetimin çerçevesini döndürür veya ayarlar. Okunur/Yazılabilir [IShapeFrame](../../com.aspose.slides/ishapeframe).
...
PersistStream, PersistStreamInit veya PersistStorage yöntemi kullanıldığında bir ActiveX denetiminin kalıcılığını belirtir.
