...
| [add(IShape shapeTrigger)](#add-com.aspose.slides.IShape-) | Yeni bir etkileşimli dizi ekle. |
| [remove(ISequence item)](#remove-com.aspose.slides.ISequence-) | Belirtilen diziyi bir koleksiyondan kaldırır. |
| [removeAt(int index)](#removeAt-int-) | Belirtilen indeksdeki diziyi kaldırır. |
| [clear()](#clear--) | Bir koleksiyondaki tüm dizileri kaldırır. |
| [get_Item(int index)](#get-Item-int-) | Belirtilen indeksdeki bir diziyi döndürür. |
### getCount() {#getCount--}
```
...
Yeni bir etkileşimli dizi ekle.
...
Belirtilen indeksdeki bir diziyi döndürür.
