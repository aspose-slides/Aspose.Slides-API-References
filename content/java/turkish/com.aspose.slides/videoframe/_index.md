...
| Yöntem | Açıklama |
| --- | --- |
| [getRewindVideo()](#getRewindVideo--) | Bir videonun film bittiğinde otomatik olarak başa sarıp sarılmayacağını belirler. |
| [setRewindVideo(boolean value)](#setRewindVideo-boolean-) | Bir videonun film bittiğinde otomatik olarak başa sarıp sarılmayacağını belirler. |
...
Bir videonun film bittiğinde otomatik olarak başa sarıp sarılmayacağını belirler. Okunur/yazılır boolean.
...
Ses seviyesini döndürür veya ayarlar. Okunur/yazılır [AudioVolumeMode](../../com.aspose.slides/audiovolumemode).
...
Video oynatma modunu döndürür veya ayarlar. Okunur/yazılır [VideoPlayModePreset](../../com.aspose.slides/videoplaymodepreset).
...
Bir videonun tam ekran modunda gösterilip gösterilmediğini belirler. Okunur/yazılır boolean.
...
VideoFrame'e bağlı bir video dosyasının adını döndürür veya ayarlar. Okunur/yazılır String.
...
Gömülü video nesnesini döndürür veya ayarlar. Okunur/yazılır [IVideo](../../com.aspose.slides/ivideo).
...
>      //kırpma başlangıç zamanını 1sn olarak ayarla
>      //kırpma bitiş zamanını 2sn olarak ayarla
>  } finally {
...
Video çerçevesiyle ilişkili kapalı altyazıların koleksiyonunu alır. Bu özellik yalnızca okunabilir ve tüm altyazı parçacıklarını içeren bir [ICaptionsCollection](../../com.aspose.slides/icaptionscollection) döndürür.
