...
type: docs
url: /tr/com.aspose.slides/autoshapelock/
---
**Kalıtım:**
...
| [getRotateLocked()](#getRotateLocked--) | Bu şeklin dönüş açısının değiştirilmesinin yasak olup olmadığını belirler. |
| [setRotateLocked(boolean value)](#setRotateLocked-boolean-) | Bu şeklin dönüş açısının değiştirilmesinin yasak olup olmadığını belirler. |
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Bu şeklin yeniden boyutlandırıldığında en-boy oranını koruması gerekip gerekmediğini belirler. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Bu şeklin yeniden boyutlandırıldığında en-boy oranını koruması gerekip gerekmediğini belirler. |
...
| [getAdjustHandlesLocked()](#getAdjustHandlesLocked--) | Ayarlama değerlerinin değiştirilmesinin yasak olup olmadığını belirler. |
| [setAdjustHandlesLocked(boolean value)](#setAdjustHandlesLocked-boolean-) | Ayarlama değerlerinin değiştirilmesinin yasak olup olmadığını belirler. |
...
| [getTextLocked()](#getTextLocked--) | Metnin düzenlenmesinin yasak olup olmadığını belirler. |
| [setTextLocked(boolean value)](#setTextLocked-boolean-) | Metnin düzenlenmesinin yasak olup olmadığını belirler. |
...
Bu şeklin yeniden boyutlandırıldığında en-boy oranını koruması gerekip gerekmediğini belirler. Okunur/yazılır boolean.
...
Ayarlama değerlerinin değiştirilmesinin yasak olup olmadığını belirler. Okunur/yazılır boolean.
...
Ok uçlarının değiştirilmesinin yasak olup olmadığını belirler. Okunur/yazılır boolean.
...
Şekil tipinin değiştirilmesinin yasak olup olmadığını belirler. Okunur/yazılır boolean.
...
Metnin düzenlenmesinin yasak olup olmadığını belirler. Okunur/yazılır boolean.
