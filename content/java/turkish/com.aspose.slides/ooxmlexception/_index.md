...
| [OOXMLException(String message)](#OOXMLException-java.lang.String-) | Bu istisna için bir mesaj eklemeye olanak tanıyan yapıcı. |
...
Bu istisna için bir mesaj eklemeye olanak tanıyan yapıcı.
