...
| [getVersion()](#getVersion--) | Aspose.Slides for Java sürümünü döndürür. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| namePath | java.lang.String | Tam veya kısa bir dosya adı ya da gömülü kaynağın adı olabilir. Değerlendirme moduna geçmek için boş bir dize kullanın. |
...
Aspose.Slides for Java sürümünü döndürür.
