...
| Yapıcı | Açıklama |
| --- | --- |
| [ExcelDataWorkbook(String filePath)](#ExcelDataWorkbook-java.lang.String-) | Belirtilen dosya yolunu kullanarak yeni bir örnek başlatır. |
| [ExcelDataWorkbook(InputStream stream)](#ExcelDataWorkbook-java.io.InputStream-) | Sağlanan akışı kullanarak sınıfın yeni bir örneğini başlatır. |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [getCells(String formula, boolean skipHiddenCells)](#getCells-java.lang.String-boolean-) | Belirtilen formüle uyan hücrelerin bir koleksiyonunu çalışma kitabından alır. |
| [getCell(int worksheetIndex, int row, int column)](#getCell-int-int-int-) | Belirtilen çalışma sayfasından, dizin ve hücre koordinatlarını kullanarak bir hücre alır. |
...
| [getCell(int worksheetIndex, String cellName)](#getCell-int-java.lang.String-) | Belirtilen çalışma sayfasından, dizin ve Excel tarzı hücre adı (örn. "B2") kullanarak bir hücre alır. |
...
| [getChartsFromWorksheet(String worksheetName)](#getChartsFromWorksheet-java.lang.String-) | Belirtilen Excel çalışma kitabının çalışma sayfasındaki tüm grafikleri içeren dizin ve adları içeren bir sözlüğü alır. |
...
Belirtilen formüle uyan hücrelerin bir koleksiyonunu çalışma kitabından alır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| formula | java.lang.String | Hedef hücreleri tanımlamak için kullanılan bir formül veya aralık ifadesi (örn. "Sheet1!A1:B3"). |
| skipHiddenCells | boolean | Doğru ise, gizli hücreler (ör. gizli satır veya sütunlarda) sonuçtan hariç tutulur. |

**Döndürür:**
com.aspose.ms.System.Collections.Generic.List<com.aspose.slides.IExcelDataCell> - Belirtilen formüle uyan hücrelerin salt okunur bir listesi.
### getCell(int worksheetIndex, int row, int column) {#getCell-int-int-int-}
```
public final IExcelDataCell getCell(int worksheetIndex, int row, int column)
```

Belirtilen çalışma sayfasından, dizin ve hücre koordinatlarını kullanarak bir hücre alır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| worksheetIndex | int | Çalışma sayfasının sıfır tabanlı dizini. |
...
Belirtilen çalışma sayfasından, dizin ve Excel tarzı hücre adı (örn. "B2") kullanarak bir hücre alır.
...
Belirtilen Excel çalışma kitabının çalışma sayfasındaki tüm grafikleri içeren dizin ve adları içeren bir sözlüğü alır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| worksheetName | java.lang.String | Grafikleri aramak için çalışma sayfasının adı. |

**Döndürür:**
com.aspose.ms.System.Collections.Generic.Dictionary<java.lang.Integer,java.lang.String> - Anahtarın grafik indeksi, değerin ise grafik adı olduğu bir sözlük.
