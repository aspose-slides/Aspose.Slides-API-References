...
description: Microsoft Purview Information Protection tarafından sağlanan duyarlılık etiketini temsil eder.
type: docs
...
Microsoft Purview Information Protection tarafından sağlanan duyarlılık etiketini temsil eder.

## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [getId()](#getId--) | Duyarlılık etiketinin id'sini döndürür veya ayarlar. |
| [setId(String value)](#setId-java.lang.String-) | Duyarlılık etiketinin id'sini döndürür veya ayarlar. |
...
| [getContentMarkTypes()](#getContentMarkTypes--) | Bir dosyaya uygulanması gereken içerik işaretleme tiplerinin listesini döndürür. |
...
Duyarlılık etiketinin id'sini döndürür veya ayarlar. Read/write String.
...
Duyarlılık etiketini tanımlayan duyarlılık etiketi politikasına karşılık gelen Azure Active Directory (Azure AD) site tanımlayıcısını döndürür veya ayarlar. Read/write java.util.UUID.
...
Duyarlılık etiketi için atama yöntemini döndürür veya ayarlar. Read/write [SensitivityLabelAssignmentType](../../com.aspose.slides/sensitivitylabelassignmenttype).
...
Bir dosyaya uygulanması gereken içerik işaretleme tiplerinin listesini döndürür.
