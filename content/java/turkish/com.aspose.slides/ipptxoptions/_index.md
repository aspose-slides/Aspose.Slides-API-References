...
| [getZip64Mode()](#getZip64Mode--) | Sunum belgesinde ZIP64 formatının kullanılıp kullanılmadığını belirtir. |
| [setZip64Mode(int value)](#setZip64Mode-int-) | Sunum belgesinde ZIP64 formatının kullanılıp kullanılmadığını belirtir. |
...
Sunum belgesinde ZIP64 formatının kullanılıp kullanılmadığını belirtir. Varsayılan değer [Zip64Mode.IfNecessary](../../com.aspose.slides/zip64mode\#IfNecessary)
...
Sunum küçük resminin yenilenip yenilenmeyeceğini belirtir. Okunabilir/yazılabilir boolean. Varsayılan değer **true**.
