...
description: Base'in sol tarafına yerleştirilen bir temel ve alt indis ve üst indis içeren Sub-Superscript nesnesini belirtir.
type: docs
...
Base'in sol tarafına yerleştirilen bir temel ve alt ve üst indis içeren Sub-Superscript nesnesini belirtir.
...
| Yöntem | Açıklama |
| --- | --- |
| [getSubscript()](#getSubscript--) | Alt indeks |
| [getSuperscript()](#getSuperscript--) | Üst indeks |
