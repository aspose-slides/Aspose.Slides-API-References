...
Bir çerçevenin z ekseni etrafında döndürüldüğü derece sayısını döndürür. Pozitif değer saat yönünde, negatif değer saat yönünün tersine döndürülmeyi gösterir. Salt okunur float.
...
Bir çerçevenin koordinatlarını döndürür. Salt okunur java.awt.geom.Rectangle2D.Float.
