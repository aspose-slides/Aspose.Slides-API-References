...
1) PptxEditException이 발생하는 것을 방지하려면 레이아웃의 HasDependingSlides 속성을 미리 확인하십시오. 2) 코드를 단순화하려면 [ILayoutSlide.remove](../../com.aspose.slides/ilayoutslide\#remove) 메서드도 사용할 수 있습니다. |
