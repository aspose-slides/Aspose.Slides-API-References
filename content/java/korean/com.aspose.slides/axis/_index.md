...
| [getAxisBetweenCategories()](#getAxisBetweenCategories--) | 값 축이 범주 축을 범주 사이에서 교차하는지 나타냅니다. |
| [setAxisBetweenCategories(boolean value)](#setAxisBetweenCategories-boolean-) | 값 축이 범주 축을 범주 사이에서 교차하는지 나타냅니다. |
| [getCategoryAxisType()](#getCategoryAxisType--) | 범주 축의 유형을 지정합니다. |
| [setCategoryAxisType(int value)](#setCategoryAxisType-int-) | 범주 축의 유형을 지정합니다. |
| [setCategoryAxisTypeAutomatically()](#setCategoryAxisTypeAutomatically--) | 축 데이터에 따라 자동으로 결정되는 값을 사용하여 IAxis.CategoryAxisType 속성을 설정합니다. |
| [getCrossAt()](#getCrossAt--) | 축이 수직 축과 교차하는 지점을 나타냅니다. |
| [setCrossAt(float value)](#setCrossAt-float-) | 축이 수직 축과 교차하는 지점을 나타냅니다. |
| [getDisplayUnit()](#getDisplayUnit--) | 값 축의 표시 단위에 대한 스케일 값을 지정합니다. |
| [setDisplayUnit(int value)](#setDisplayUnit-int-) | 값 축의 표시 단위에 대한 스케일 값을 지정합니다. |
...
| [isPlotOrderReversed()](#isPlotOrderReversed--) | MS PowerPoint가 데이터 포인트를 마지막부터 처음으로 플롯하는지 여부를 나타냅니다. |
| [setPlotOrderReversed(boolean value)](#setPlotOrderReversed-boolean-) | MS PowerPoint가 데이터 포인트를 마지막부터 처음으로 플롯하는지 여부를 나타냅니다. |
...
| [getShowMajorGridLines()](#getShowMajorGridLines--) | 주 그리드선을 숨기려면 MajorGridLinesFormat.Line.FillFormat.FillType을 FillType.NoFill로 설정합니다. |
| [getFormat()](#getFormat--) | 축의 형식을 나타냅니다. |
| [getTextFormat()](#getTextFormat--) | 텍스트 형식을 나타냅니다. |
...
| [hasTitle()](#hasTitle--) | 축에 표시되는 제목이 있는지 여부를 판단합니다. |
| [setTitle(boolean value)](#setTitle-boolean-) | 축에 표시되는 제목이 있는지 여부를 판단합니다. |
...
| [isNumberFormatLinkedToSource()](#isNumberFormatLinkedToSource--) | 형식이 연결된 원본 데이터인지 여부를 나타냅니다. |
| [setNumberFormatLinkedToSource(boolean value)](#setNumberFormatLinkedToSource-boolean-) | 형식이 연결된 원본 데이터인지 여부를 나타냅니다. |
...
| [getTickLabelSpacing()](#getTickLabelSpacing--) | 그려지는 레이블 사이에 건너뛸 눈금 레이블 수를 지정합니다. |
| [setTickLabelSpacing(long value)](#setTickLabelSpacing-long-) | 그려지는 레이블 사이에 건너뛸 눈금 레이블 수를 지정합니다. |
...
| [getLabelOffset()](#getLabelOffset--) | 레이블이 축으로부터 떨어진 거리를 지정합니다. |
| [setLabelOffset(int value)](#setLabelOffset-int-) | 레이블이 축으로부터 떨어진 거리를 지정합니다. |
| [getAggregationType()](#getAggregationType--) | 범주 축(구간화)의 집계 유형을 나타냅니다. |
| [setAggregationType(int value)](#setAggregationType-int-) | 범주 축(구간화)의 집계 유형을 나타냅니다. |
| [getBinWidth()](#getBinWidth--) | AggregationType 속성 값이 AxisAggregationType.ByBinWidth로 설정될 때 구간 너비를 지정합니다. |
| [setBinWidth(double value)](#setBinWidth-double-) | AggregationType 속성 값이 AxisAggregationType.ByBinWidth로 설정될 때 구간 너비를 지정합니다. |
| [getNumberOfBins()](#getNumberOfBins--) | AggregationType 속성 값이 AxisAggregationType.ByNumberOfBins로 설정될 때 구간 수를 지정합니다. |
| [setNumberOfBins(long value)](#setNumberOfBins-long-) | AggregationType 속성 값이 AxisAggregationType.ByNumberOfBins로 설정될 때 구간 수를 지정합니다. |
| [isOverflowBin()](#isOverflowBin--) | 오버플로우 구간이 적용되는지 지정합니다. |
| [setOverflowBin(boolean value)](#setOverflowBin-boolean-) | 오버플로우 구간이 적용되는지 지정합니다. |
| [isAutomaticOverflowBin()](#isAutomaticOverflowBin--) | 자동 오버플로우 구간 값을 지정합니다. |
| [setAutomaticOverflowBin(boolean value)](#setAutomaticOverflowBin-boolean-) | 자동 오버플로우 구간 값을 지정합니다. |
| [getOverflowBin()](#getOverflowBin--) | 오버플로우 구간 사용자 정의 값을 지정합니다. |
| [setOverflowBin(double value)](#setOverflowBin-double-) | 오버플로우 구간 사용자 정의 값을 지정합니다. |
| [isUnderflowBin()](#isUnderflowBin--) | 언더플로우 구간이 적용되는지 지정합니다. |
| [setUnderflowBin(boolean value)](#setUnderflowBin-boolean-) | 언더플로우 구간이 적용되는지 지정합니다. |
| [isAutomaticUnderflowBin()](#isAutomaticUnderflowBin--) | 자동 언더플로우 구간 값을 지정합니다. |
| [setAutomaticUnderflowBin(boolean value)](#setAutomaticUnderflowBin-boolean-) | 자동 언더플로우 구간 값을 지정합니다. |
| [getUnderflowBin()](#getUnderflowBin--) | 언더플로우 구간 사용자 정의 값을 지정합니다. |
| [setUnderflowBin(double value)](#setUnderflowBin-double-) | 언더플로우 구간 사용자 정의 값을 지정합니다. |
...
값 축이 범주 축을 범주 사이에서 교차하는지 나타냅니다. 이 속성은 범주 축에만 적용되며 3D 차트에는 적용되지 않습니다. 읽기/쓰기 부울.
...
범주 축의 유형을 지정합니다. 읽기/쓰기 [CategoryAxisType](../../com.aspose.slides/categoryaxistype).
...
축이 수직 축과 교차하는 지점을 나타냅니다. 읽기/쓰기 float.
...
값 축의 표시 단위에 대한 스케일 값을 지정합니다. 읽기/쓰기 [DisplayUnitType](../../com.aspose.slides/displayunittype).
...
최대 값이 자동으로 할당되는지 여부를 나타냅니다. 읽기/쓰기 부울.
...
날짜 또는 값 축의 주요 단위를 나타냅니다. 읽기/쓰기 double.
...
값 축 눈금 유형이 로그인지 여부를 나타냅니다. 읽기/쓰기 boolean.
...
MS PowerPoint가 데이터 포인트를 마지막에서 첫 번째로 플롯하는지 여부를 나타냅니다. 읽기/쓰기 boolean.
...
지정된 축에 대한 마이너 눈금 표시 유형을 나타냅니다. 읽기/쓰기 [TickMarkType](../../com.aspose.slides/tickmarktype).
...
날짜 축에 대한 주요 단위 눈금 비율을 나타냅니다. 읽기/쓰기 [TimeUnitType](../../com.aspose.slides/timeunittype).
...
차트 축에 대한 마이너 그리드라인 형식을 나타냅니다. 읽기 전용 [IChartLinesFormat](../../com.aspose.slides/ichartlinesformat).
...
차트 축에 대한 주요 그리드라인 형식을 나타냅니다. 읽기 전용 [IChartLinesFormat](../../com.aspose.slides/ichartlinesformat).
...
마이너 그리드라인을 숨기려면 MinorGridLinesFormat.Line.FillFormat.FillType을 FillType.NoFill으로 설정합니다. 읽기 전용 boolean.
...
주요 그리드라인을 숨기려면 MajorGridLinesFormat.Line.FillFormat.FillType을 FillType.NoFill으로 설정합니다. 읽기 전용 boolean.
...
텍스트 형식을 나타냅니다. 읽기 전용 [IChartTextFormat](../../com.aspose.slides/icharttextformat).
...
축에 보이는 제목이 있는지 여부를 판단합니다. 읽기/쓰기 boolean.
...
그려지는 레이블 사이에 건너뛸 눈금 레이블 수를 지정합니다. 카테고리 또는 시리즈 축에 적용됩니다. 읽기/쓰기 long.
...
다음 눈금이 그려지기 전까지 건너뛸 눈금 수를 지정합니다. 카테고리 또는 시리즈 축에 적용됩니다. 읽기/쓰기 int.
...
라벨을 축에서 떨어뜨린 거리를 지정합니다. 카테고리 또는 날짜 축에 적용됩니다. 값은 0%와 1000% 사이여야 합니다. 읽기/쓰기 int.
...
카테고리 축(구간화)의 집계 유형을 나타냅니다. 카테고리에 적용됩니다. Histogram 또는 HistogramPareto 시리즈에서만 사용됩니다.
...
AggregationType 속성값이 AxisAggregationType.ByBinWidth로 설정된 경우 구간 너비를 지정합니다. 카테고리 축에 적용됩니다. Histogram 또는 HistogramPareto 시리즈에서만 사용됩니다.
...
AggregationType 속성값이 AxisAggregationType.ByNumberOfBins로 설정된 경우 구간 수를 지정합니다. 카테고리 축에 적용됩니다. Histogram 또는 HistogramPareto 시리즈에서만 사용됩니다.
...
오버플로우 구간이 적용되는지 지정합니다. 오버플로우 구간 값을 조정하려면 IsAutomaticOverflowBin 및 OverflowBin을 사용하십시오.
...
자동 오버플로우 구간 값을 지정합니다. false인 경우 OverflowBin 속성을 사용합니다.
...
사용자 지정 오버플로우 구간 값을 지정합니다. IsAutomaticOverflowBin 속성이 false로 설정되고 IsOverflowBin 속성이 true인 경우 적용됩니다.
...
언더플로우 구간이 적용되는지 지정합니다. 언더플로우 구간 값을 조정하려면 IsAutomaticUnderflowBin 및 UnderflowBin을 사용하십시오.
...
자동 언더플로우 구간 값을 지정합니다. false인 경우 UnderflowBin 속성을 사용합니다.
...
사용자 지정 언더플로우 구간 값을 지정합니다. IsAutomaticUnderflowBin 속성이 false로 설정되고 IsUnderflowBin 속성이 true인 경우 적용됩니다.
