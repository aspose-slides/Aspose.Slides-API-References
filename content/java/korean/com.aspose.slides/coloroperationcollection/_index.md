...
컬러 변환 연산의 컬렉션을 나타냅니다.
## 메서드

| Method | Description |
| --- | --- |
| [size()](#size--) | 컬렉션에 포함된 연산 수를 반환합니다. |
| [get_Item(int index)](#get-Item-int-) | 지정된 인덱스의 연산을 반환하거나 설정합니다. |
| [set_Item(int index, IColorOperation value)](#set-Item-int-com.aspose.slides.IColorOperation-) | 지정된 인덱스의 연산을 반환하거나 설정합니다. |
| [add(int operation, float parameter)](#add-int-float-) | 새 연산을 컬렉션 끝에 추가합니다. |
| [add(int operation)](#add-int-) | 새 연산을 컬렉션 끝에 추가합니다. |
| [insert(int position, int operation, float parameter)](#insert-int-int-float-) | 새 연산을 컬렉션에 삽입합니다. |
| [insert(int position, int operation)](#insert-int-int-) | 새 연산을 컬렉션에 삽입합니다. |
| [removeAt(int index)](#removeAt-int-) | 컬렉션에서 컬러 연산을 제거합니다. |
| [clear()](#clear--) | 모든 컬러 연산을 제거합니다. |
...
컬렉션에 포함된 연산 수를 반환합니다. 읽기 전용 int.
...
지정된 인덱스의 연산을 반환하거나 설정합니다. 읽기/쓰기 [ColorOperation](../../com.aspose.slides/coloroperation).
...
**반환:**  
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IColorOperation> - 컬렉션을 순회하는 IGenericEnumerator.
...
**반환:**  
java.lang.Object - 새로운 [ColorOperationCollection](../../com.aspose.slides/coloroperationcollection) 컬렉션.
### cloneT() {#cloneT--}
```
