...
description: 수학 텍스트 인스턴스를 지정하며, 이는 MathParagraph 내부에 포함되고 자체 라인에서 시작합니다.
type: docs
...
수학 텍스트 인스턴스를 지정하며, 이는 MathParagraph 내부에 포함되고 자체 라인에서 시작합니다. 방정식, 식, 방정식 또는 식의 배열 및 수식과 같은 모든 수학 영역은 수학 블록으로 표현됩니다.
...
| 메서드 | 설명 |
| --- | --- |
| [delimit(char separatorCharacter)](#delimit-char-) | 구분자 문자(괄호 없이)로 모든 하위 요소를 구분합니다. |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | 이 블록의 하위 요소를 괄호 등의 지정 문자로 둘러싸고 구분자 문자로 구분합니다. |
...
구분자 문자(괄호 없이)로 모든 하위 요소를 구분합니다.
...
이 블록의 하위 요소를 괄호 등의 지정 문자로 둘러싸고 구분자 문자로 구분합니다.
...
**반환값:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - 지정 문자로 프레임 및 구분자를 포함하는 [IMathDelimiter](../../com.aspose.slides/imathdelimiter) 타입의 수학 요소
...
| 매개 변수 | 형식 | 설명 |
| --- | --- | --- |
| other | [IMathBlock](../../com.aspose.slides/imathblock) | 결합 블록 |
