...
| 메서드 | 설명 |
| --- | --- |
| [invoke(Paragraph para, BaseSlide slide, int index)](#invoke-com.aspose.slides.Paragraph-com.aspose.slides.BaseSlide-int-) | 각 #paragraph(Presentation,ForEachParagraphCallback).paragraph(Presentation,ForEachParagraphCallback)에 대해 [BaseSlide](../../com.aspose.slides/baseslide)에서 호출되는 콜백입니다. |
