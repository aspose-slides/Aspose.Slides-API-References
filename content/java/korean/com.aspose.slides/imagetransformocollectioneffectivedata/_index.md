...
이름 IImageTransformOperationCollectionEffectiveData는 COM 이름 길이 제한으로 39자를 초과할 수 없어 IImageTransformOCollectionEffectiveData로 잘렸습니다.
## 생성자
...
| 메서드 | 설명 |
| --- | --- |
| [size()](#size--) | 컬렉션에 있는 이미지 효과의 수를 반환합니다. |
...
컬렉션에 있는 이미지 효과의 수를 반환합니다. 읽기 전용 int.
...
**반환:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffectEffectiveData> - 컬렉션을 순회하는 데 사용할 수 있는 IGenericEnumerator.
