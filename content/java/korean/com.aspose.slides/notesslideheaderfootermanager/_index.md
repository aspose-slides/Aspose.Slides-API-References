...
description: 헤더 자리표시자를 포함한 노트 슬라이드 자리표시자의 동작을 관리하는 매니저를 나타냅니다.
type: docs
url: /ko/com.aspose.slides/notesslideheaderfootermanager/
---
**상속:**
...
헤더 자리표시자를 포함한 노트 슬라이드 자리표시자의 동작을 관리하는 매니저를 나타냅니다.