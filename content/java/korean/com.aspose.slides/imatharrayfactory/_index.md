...
| 메서드 | 설명 |
| --- | --- |
| [createMathArray(IMathElement element)](#createMathArray-com.aspose.slides.IMathElement-) | 수학 배열을 생성하고 지정된 요소를 배열에 배치합니다 |
| [createMathArray(IMathElementCollection elements)](#createMathArray-com.aspose.slides.IMathElementCollection-) | 수학 배열을 생성하고 지정된 요소들을 배열에 배치합니다 |
