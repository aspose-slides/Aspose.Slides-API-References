...
| [add(String label, String filePath)](#add-java.lang.String-java.lang.String-) | 컬렉션의 끝에 WebVTT 닫힌 캡션을 추가합니다. |
| [add(String label, InputStream stream)](#add-java.lang.String-java.io.InputStream-) | 스트림에서 컬렉션의 끝에 WebVTT 닫힌 캡션을 추가합니다. |
| [remove(ICaptions captions)](#remove-com.aspose.slides.ICaptions-) | 컬렉션에서 지정된 닫힌 캡션을 제거합니다. |
