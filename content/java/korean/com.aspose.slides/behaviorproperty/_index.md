...
description: 애니메이션 동작을 위한 속성 유형을 나타냅니다.
type: docs
...
| [isCustom()](#isCustom--) | 이 속성이 사양에 정의된 미리 정의된 속성 목록에 포함되지 않는지 표시합니다: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx |
| [getPptX()](#getPptX--) | ‘ppt_x’ 속성을 나타냅니다 |
| [getPptY()](#getPptY--) | ‘ppt_y’ 속성을 나타냅니다 |
| [getPptW()](#getPptW--) | ‘ppt_w’ 속성을 나타냅니다 |
| [getPptH()](#getPptH--) | ‘ppt_h’ 속성을 나타냅니다 |
| [getPptC()](#getPptC--) | ‘ppt_c’ 속성을 나타냅니다 |
| [getPptR()](#getPptR--) | ‘ppt_r’ 속성을 나타냅니다 |
...
| [getOrCreateByValue(String propertyValue)](#getOrCreateByValue-java.lang.String-) | 값으로 기존 동작 속성을 찾거나 지정된 값으로 새로운 사용자 정의 속성을 만듭니다. |
...
이 속성이 사양에 정의된 미리 정의된 속성 목록에 포함되지 않는지 표시합니다: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx
...
값으로 기존 behavior 속성을 찾거나 지정된 값으로 새 사용자 지정 속성을 생성합니다.
