...
| [copyTo(IBehavior[] array, int arrayIndex)](#copyTo-com.aspose.slides.IBehavior---int-) | [IGenericCollection](../../com.aspose.slides/igenericcollection)의 요소를 배열에 복사하며, 특정 배열 인덱스에서 시작합니다. |
...
| [contains(IBehavior item)](#contains-com.aspose.slides.IBehavior-) | [IGenericCollection](../../com.aspose.slides/igenericcollection)에 특정 값이 포함되어 있는지 확인합니다. |
...
**반환:**
boolean - [IGenericCollection](../../com.aspose.slides/igenericcollection)가 읽기 전용인 경우 true; 그렇지 않으면 false.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| item | [IBehavior](../../com.aspose.slides/ibehavior) | 리스트에서 찾을 객체. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| array | [IBehavior\[\]](../../com.aspose.slides/ibehavior) | [IGenericCollection](../../com.aspose.slides/igenericcollection)에서 복사된 요소들의 대상이 되는 1차원 배열입니다. 배열은 0부터 시작하는 인덱스를 가져야 합니다. |
| arrayIndex | int | 복사를 시작하는 배열의 0 기반 인덱스. |
