...
| [getContentType()](#getContentType--) | 이미지의 MIME 유형을 반환합니다, BinaryData (\#getBinaryData.getBinaryData)에서 인코딩됩니다. |
...
이미지의 MIME 유형을 반환합니다, BinaryData (\#getBinaryData.getBinaryData)에서 인코딩됩니다. 읽기 전용 String.
