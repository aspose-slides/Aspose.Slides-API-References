...
| 메서드 | 설명 |
| --- | --- |
| [size()](#size--) | 컬렉션에 있는 레이아웃 슬라이드 수를 반환합니다. |
...
컬렉션에 있는 레이아웃 슬라이드 수를 반환합니다. 읽기 전용 int.
...
**반환값:**
[ILayoutSlide](../../com.aspose.slides/ilayoutslide) - 지정된 유형을 가진 [LayoutSlide](../../com.aspose.slides/layoutslide) 또는 레이아웃을 찾지 못하면 null.
...
1) PptxEditException이 발생하는 것을 방지하려면 먼저 레이아웃의 HasDependingSlides 속성을 확인하십시오. 2) 또한 [ILayoutSlide.remove](../../com.aspose.slides/ilayoutslide\#remove) 메서드를 사용하여 코드를 단순화할 수 있습니다. |
