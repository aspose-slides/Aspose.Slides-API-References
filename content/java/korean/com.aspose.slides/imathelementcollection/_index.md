...
type: docs
url: /ko/com.aspose.slides/imatheelementcollection/
---
**구현된 모든 인터페이스:**  
...
| [insert(int index, IMathElement item)](#insert-int-com.aspose.slides.IMathElement-) | 지정된 인덱스에 수학 요소를 컬렉션에 삽입합니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | 컬렉션의 끝에 추가할 IMathElement입니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | 컬렉션에서 찾을 요소입니다. |

**반환:**
int - 항목이 컬렉션에 있으면 해당 인덱스; 없으면 -1.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| index | int | IMathElement가 삽입될 0부터 시작하는 인덱스입니다. |
| item | [IMathElement](../../com.aspose.slides/imathelement) | 삽입할 IMathElement입니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | 컬렉션에서 찾을 객체입니다. |

**반환:**
boolean - 컬렉션에 항목이 있으면 true; 그렇지 않으면 false.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | 컬렉션에서 제거할 객체입니다. |

**반환:**
boolean - 컬렉션에서 항목을 성공적으로 제거하면 true; 그렇지 않으면 false. 원본 컬렉션에 항목이 없을 경우에도 false를 반환합니다.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| array | [IMathElement\[\]](../../com.aspose.slides/imathelement) | 복사 대상 배열입니다. |
| arrayIndex | int | 복사를 시작할 인덱스입니다. |