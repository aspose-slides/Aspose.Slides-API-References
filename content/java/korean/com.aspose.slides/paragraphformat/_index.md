...
이 클래스는 특정 단락에 정의된 단락 서식 속성을 반환하고 조작하는 데 사용됩니다. 이는 값을 가져올 때 상속이 적용되지 않으며 대부분의 경우 “정의되지 않음”을 의미하는 값을 얻게 됨을 의미합니다.
...
| 생성자 | 설명 |
| --- | --- |
| [ParagraphFormat()](#ParagraphFormat--) | 새 인스턴스를 초기화합니다 [ParagraphFormat](../../com.aspose.slides/paragraphformat) 클래스. |
...
| [getSpaceWithin()](#getSpaceWithin--) | 단락의 기본선 사이의 간격을 반환하거나 설정합니다. |
| [setSpaceWithin(float value)](#setSpaceWithin-float-) | 단락의 기본선 사이의 간격을 반환하거나 설정합니다. |
| [getSpaceBefore()](#getSpaceBefore--) | 상속 없이 단락의 첫 번째 줄 앞의 공간 양을 반환하거나 설정합니다. |
| [setSpaceBefore(float value)](#setSpaceBefore-float-) | 상속 없이 단락의 첫 번째 줄 앞의 공간 양을 반환하거나 설정합니다. |
| [getSpaceAfter()](#getSpaceAfter--) | 상속 없이 단락의 마지막 줄 뒤의 공간 양을 반환하거나 설정합니다. |
| [setSpaceAfter(float value)](#setSpaceAfter-float-) | 상속 없이 단락의 마지막 줄 뒤의 공간 양을 반환하거나 설정합니다. |
| [getEastAsianLineBreak()](#getEastAsianLineBreak--) | 단락에서 동아시아 줄 바꿈이 사용되는지 여부를 판단합니다. |
| [setEastAsianLineBreak(byte value)](#setEastAsianLineBreak-byte-) | 단락에서 동아시아 줄 바꿈이 사용되는지 여부를 판단합니다. |
| [getRightToLeft()](#getRightToLeft--) | 단락에서 오른쪽에서 왼쪽으로 쓰기가 사용되는지 여부를 판단합니다. |
| [setRightToLeft(byte value)](#setRightToLeft-byte-) | 단락에서 오른쪽에서 왼쪽으로 쓰기가 사용되는지 여부를 판단합니다. |
| [getLatinLineBreak()](#getLatinLineBreak--) | 단락에서 라틴 줄 바꿈이 사용되는지 여부를 판단합니다. |
| [setLatinLineBreak(byte value)](#setLatinLineBreak-byte-) | 단락에서 라틴 줄 바꿈이 사용되는지 여부를 판단합니다. |
| [getHangingPunctuation()](#getHangingPunctuation--) | 단락에서 매달림 구두점이 사용되는지 여부를 판단합니다. |
| [setHangingPunctuation(byte value)](#setHangingPunctuation-byte-) | 단락에서 매달림 구두점이 사용되는지 여부를 판단합니다. |
...
| [getIndent()](#getIndent--) | 상속 없이 단락의 첫 줄 들여쓰기/매달림 들여쓰기를 반환하거나 설정합니다. |
| [setIndent(float value)](#setIndent-float-) | 상속 없이 단락의 첫 줄 들여쓰기/매달림 들여쓰기를 반환하거나 설정합니다. |
...
| [getTabs()](#getTabs--) | 단락의 탭 정보를 반환합니다. |
...
단락의 기본선 사이의 공간 양을 반환하거나 설정합니다. 양수 값은 백분율을 의미하고, 음수는 포인트 단위 크기를 의미합니다. 상속이 적용되지 않습니다. 읽기/쓰기 float .
...
상속 없이 단락의 첫 번째 줄 앞의 공간 양을 반환하거나 설정합니다. 양수 값은 글꼴 크기의 백분율을, 음수 값은 포인트 크기의 공백을 지정합니다. 읽기/쓰기 float .
...
상속 없이 단락의 마지막 줄 뒤의 공간 양을 반환하거나 설정합니다. 양수 값은 글꼴 크기의 백분율을, 음수 값은 포인트 크기의 공백을 지정합니다. 읽기/쓰기 float .
...
동아시아 줄 바꿈이 단락에서 사용되는지 여부를 판단합니다. 상속이 적용되지 않습니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
...
오른쪽에서 왼쪽으로 쓰기가 단락에서 사용되는지 여부를 판단합니다. 상속이 적용되지 않습니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
...
라틴 줄 바꿈이 단락에서 사용되는지 여부를 판단합니다. 상속이 적용되지 않습니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
...
매달림 구두점이 단락에서 사용되는지 여부를 판단합니다. 상속이 적용되지 않습니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
...
상속 없이 단락의 첫 줄 들여쓰기/매달림 들여쓰기를 반환하거나 설정합니다. 매달림 들여쓰기는 음수 값으로 정의될 수 있습니다. 읽기/쓰기 float .
...
단락의 탭 정보를 반환합니다. 상속이 적용되지 않습니다. 읽기 전용 [ITabCollection](../../com.aspose.slides/itabcollection).
