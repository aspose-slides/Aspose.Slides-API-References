...
추가 색 구성표 컬렉션을 반환합니다. 이러한 색 구성표는 프레젠테이션의 모양에 영향을 주지 않으며, 슬라이드의 기본 색 구성표로 선택될 수 있습니다. 읽기 전용 [IExtraColorSchemeCollection](../../com.aspose.slides/iextracolorschemecollection).
