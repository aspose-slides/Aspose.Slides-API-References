...
Alpha Modulate Fixed 효과를 나타냅니다. 효과 알파(불투명도) 값이 고정 비율로 곱해집니다.
## 메서드

| 메서드 | 설명 |
| --- | --- |
| [getAmount()](#getAmount--) | 효과량을 백분율로 반환합니다. |
| [setAmount(float value)](#setAmount-float-) | 효과량을 백분율로 반환합니다. |
| [getEffective()](#getEffective--) | 상속이 적용된 효과적인 Alpha Modulate Fixed 효과 데이터를 가져옵니다. |
| [equals(Object obj)](#equals-java.lang.Object-) | 지정된 [AlphaModulateFixed](../../com.aspose.slides/alphamodulatefixed)가 현재 [AlphaModulateFixed](../../com.aspose.slides/alphamodulatefixed)와 같은지 여부를 판단합니다. |
...
상속이 적용된 효과적인 Alpha Modulate Fixed 효과 데이터를 가져옵니다.
...
지정된 [AlphaModulateFixed](../../com.aspose.slides/alphamodulatefixed)가 현재 [AlphaModulateFixed](../../com.aspose.slides/alphamodulatefixed)와 같은지 여부를 판단합니다.

**매개변수:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| obj | java.lang.Object | [AlphaModulateFixed](../../com.aspose.slides/alphamodulatefixed)을(를) 비교합니다. |
