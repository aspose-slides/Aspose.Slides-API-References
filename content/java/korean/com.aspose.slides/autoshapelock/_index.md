...
type: docs
url: /ko/com.aspose.slides/autoshapelock/
---
**Inheritance:**  
상속: java.lang.Object, [com.aspose.slides.BaseShapeLock](../../com.aspose.slides/baseshapelock)
...
| [getRotateLocked()](#getRotateLocked--) | 이 도형의 회전 각도를 변경하는 것이 금지되는지 여부를 결정합니다. |
| [setRotateLocked(boolean value)](#setRotateLocked-boolean-) | 이 도형의 회전 각도를 변경하는 것이 금지되는지 여부를 결정합니다. |
...
| [getTextLocked()](#getTextLocked--) | 텍스트를 편집하는 것이 금지되는지 여부를 결정합니다. |
| [setTextLocked(boolean value)](#setTextLocked-boolean-) | 텍스트를 편집하는 것이 금지되는지 여부를 결정합니다. |
...
이 도형의 회전 각도를 변경하는 것이 금지되는지 여부를 결정합니다. 읽기/쓰기 boolean.
...
텍스트를 편집하는 것이 금지되는지 여부를 결정합니다. 읽기/쓰기 boolean.
