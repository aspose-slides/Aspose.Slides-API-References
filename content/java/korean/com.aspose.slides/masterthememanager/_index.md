...
| 메서드 | 설명 |
| --- | --- |
| [getOverrideTheme()](#getOverrideTheme--) | 덮어쓰기 테마 객체를 반환합니다. |
| [setOverrideTheme(IMasterTheme value)](#setOverrideTheme-com.aspose.slides.IMasterTheme-) | 덮어쓰기 테마 객체를 반환합니다. |
| [createThemeEffective()](#createThemeEffective--) | 테마 객체를 반환합니다. |
| [isOverrideThemeEnabled()](#isOverrideThemeEnabled--) | OverrideTheme이 상속된 유효 테마 (Presentation.MasterTheme)를 덮어쓰는지 여부를 확인합니다. |
| [setOverrideThemeEnabled(boolean value)](#setOverrideThemeEnabled-boolean-) | OverrideTheme이 상속된 유효 테마 (Presentation.MasterTheme)를 덮어쓰는지 여부를 확인합니다. |
...
덮어쓰기 테마 객체를 반환합니다. 읽기/쓰기 [IMasterTheme](../../com.aspose.slides/imastertheme).
...
OverrideTheme이 상속된 유효 테마 (Presentation.MasterTheme)를 덮어쓰는지 여부를 확인합니다. 읽기/쓰기 boolean.
