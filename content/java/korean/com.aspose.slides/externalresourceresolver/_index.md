...
이 해결자를 사용하면 클라이언트가 제공한 HTML 또는 SVG 파일이 서버 소프트웨어가 로컬 또는 네트워크 파일을 얻도록 만들 수 있어 취약점이 발생할 수 있습니다. 주의해서 사용하십시오. ExternalResourceResolver를 전혀 지정하지 않는 것이 권장됩니다(임베디드 객체만 읽힘) 또는 지정된 uri가 유효한지 확인하는 하위 클래스를 생성하십시오.
...
| 메서드 | 설명 |
| --- | --- |
| [resolveUri(String baseUri, String relativeUri)](#resolveUri-java.lang.String-java.lang.String-) | 베이스와 상대 URI에서 절대 URI를 해결합니다. |
...
베이스와 상대 URI에서 절대 URI를 해결합니다.

**매개변수:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| baseUri | java.lang.String | 링크된 객체의 기본 URI |
