...
| [getTriggerShape()](#getTriggerShape--) | INTERACTIVE 시퀀스의 shape 대상(목표)을 반환하거나 설정합니다. |
| [setTriggerShape(IShape value)](#setTriggerShape-com.aspose.slides.IShape-) | INTERACTIVE 시퀀스의 shape 대상(목표)를 반환하거나 설정합니다. |
...
| [getEffectsByParagraph(IParagraph paragraph)](#getEffectsByParagraph-com.aspose.slides.IParagraph-) | 지정된 단락에 대한 효과 배열을 반환합니다. |
| [getCount(IShape shape)](#getCount-com.aspose.slides.IShape-) | 지정된 shape에 대한 효과 수를 반환합니다. |
| [addEffect(IShape shape, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IShape-int-int-int-) | 시퀀스 끝에 새로운 효과를 추가합니다. |
| [addEffect(IParagraph paragraph, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IParagraph-int-int-int-) | 시퀀스 끝에 단락에 대한 새로운 애니메이션 효과를 추가합니다. |
| [addEffect(IChart chart, int type, int index, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-) | 시퀀스 끝에 카테고리 또는 시리즈에 대한 새로운 차트 애니메이션 효과를 추가합니다. |
| [addEffect(IChart chart, int type, int seriesIndex, int categoriesIndex, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-int-) | 시퀀스 끝에 카테고리 또는 시리즈 내 요소에 대한 새로운 차트 애니메이션 효과를 추가합니다. |
...
**반환:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffect> - java.util.Iterator for the entire collection.
...
INTERACTIVE 시퀀스의 shape 대상(목표)을 반환하거나 설정합니다. 시퀀스가 인터랙티브하지 않으면 null을 반환합니다. 읽기/쓰기 [IShape](../../com.aspose.slides/ishape).
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| paragraph | [IParagraph](../../com.aspose.slides/iparagraph) | 단락 객체 [IParagraph](../../com.aspose.slides/iparagraph) |
| effectType | int | 애니메이션 효과의 유형 [EffectType](../../com.aspose.slides/effecttype) |
| subtype | int | 애니메이션 효과의 하위 유형 [EffectSubtype](../../com.aspose.slides/effectsubtype) |
| triggerType | int | 효과의 트리거 유형 [EffectTriggerType](../../com.aspose.slides/effecttriggertype) |
...
시퀀스 끝에 카테고리 또는 시리즈에 대한 새로운 차트 애니메이션 효과를 추가합니다.

**매개변수:**
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| chart | [IChart](../../com.aspose.slides/ichart) | 차트 객체 [IChart](../../com.aspose.slides/ichart) |
...
시퀀스 끝에 카테고리 또는 시리즈 내 요소에 대한 새로운 차트 애니메이션 효과를 추가합니다.
...
| chart | [IChart](../../com.aspose.slides/ichart) | 차트 객체 [IChart](../../com.aspose.slides/ichart) |
| type | int | 애니메이션 효과의 유형 [EffectChartMinorGroupingType](../../com.aspose.slides/effectchartminorgroupingtype) |
| seriesIndex | int | 차트 시리즈 인덱스 |
| categoriesIndex | int | 카테고리 인덱스 |
| effectType | int | 애니메이션 효과의 유형 [EffectType](../../com.aspose.slides/effecttype) |
| subtype | int | 애니메이션 효과의 하위 유형 [EffectSubtype](../../com.aspose.slides/effectsubtype) |
| triggerType | int | 효과의 트리거 유형 [EffectTriggerType](../../com.aspose.slides/effecttriggertype) |
