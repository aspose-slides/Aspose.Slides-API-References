...
| 메서드 | 설명 |
| --- | --- |
| [getRow()](#getRow--) | 셀의 위치가 있는 워크시트 행 인덱스를 반환합니다. |
| [getColumn()](#getColumn--) | 셀의 위치가 있는 워크시트 열 인덱스를 반환합니다. |
...
| [isHidden()](#isHidden--) | 셀의 숨김 여부를 판단합니다. |
...
| [getPresetNumberFormat()](#getPresetNumberFormat--) | 숫자와 날짜의 기본 제공 표시 형식을 가져오거나 설정합니다. |
| [setPresetNumberFormat(byte value)](#setPresetNumberFormat-byte-) | 숫자와 날짜의 기본 제공 표시 형식을 가져오거나 설정합니다. |
...
셀의 위치가 있는 워크시트 행 인덱스를 반환합니다. 읽기 전용 int.
...
셀의 위치가 있는 워크시트 열 인덱스를 반환합니다. 읽기 전용 int.
...
숫자와 날짜의 기본 제공 표시 형식을 가져오거나 설정합니다. 사전 설정 번호는 [0..22] 또는 [37..49] 범위에 있어야 합니다. 읽기/쓰기 byte.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| updateValues | boolean | false인 경우 실제 계산이 수행되지 않습니다. 예외 가능성을 확인하려면 true를 사용하십시오. |