...
| [setPresetShadowEffect(IPresetShadow value)](#setPresetShadowEffect-com.aspose.slides.IPresetShadow-) | 사전 설정 그림자. |
...
| [enablePresetShadowEffect()](#enablePresetShadowEffect--) | 사전 설정 그림자 효과를 활성화합니다. |
...
| [disablePresetShadowEffect()](#disablePresetShadowEffect--) | 사전 설정 그림자 효과를 비활성화합니다. |
...
| [getEffective()](#getEffective--) | 상속이 적용된 효과 서식 데이터를 가져옵니다. |
...
사전 설정 그림자. 읽기/쓰기 [IPresetShadow](../../com.aspose.slides/ipresetshadow).
