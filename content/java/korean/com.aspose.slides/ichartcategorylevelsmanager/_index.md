...
| [setGroupingItem(int level, Object value)](#setGroupingItem-int-java.lang.Object-) | 정의된 레벨에 그룹화 항목을 설정합니다. |
| [deleteGroupingItem(int level)](#deleteGroupingItem-int-) | 정의된 레벨에 그룹화 항목을 삭제합니다. |
...
정의된 레벨에 그룹화 항목을 설정합니다.

**매개변수:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| level | int | 카테고리 레벨 int |
| value | java.lang.Object | 그룹화 항목 객체 |
