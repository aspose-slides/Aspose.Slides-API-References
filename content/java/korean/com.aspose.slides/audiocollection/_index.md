...
| [isSynchronized()](#isSynchronized--) | 컬렉션에 대한 접근이 동기화(쓰레드 안전)인지 여부를 나타내는 값을 반환합니다. |
...
지정된 인덱스의 요소를 가져옵니다. 읽기 전용 [IAudio](../../com.aspose.slides/iaudio).
...
| 매개 변수 | 형식 | 설명 |
| --- | --- | --- |
| audio | [IAudio](../../com.aspose.slides/iaudio) | 원본 오디오. |
...
컬렉션에 대한 접근이 동기화(쓰레드 안전)인지 여부를 나타내는 값을 반환합니다. 읽기 전용 boolean.
...
**반환:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IAudio> - 컬렉션을 순회하는 데 사용할 수 있는 IGenericEnumerator.
