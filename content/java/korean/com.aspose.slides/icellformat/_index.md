...
| [getBorderDiagonalDown()](#getBorderDiagonalDown--) | 좌상단에서 우하단으로 대각선 선 속성 객체를 반환합니다. |
| [getBorderDiagonalUp()](#getBorderDiagonalUp--) | 좌하단에서 우상단으로 대각선 선 속성 객체를 반환합니다. |
...
| [getEffective()](#getEffective--) | 상속 및 테이블 스타일이 적용된 유효한 테이블 셀 서식 속성을 가져옵니다. |
...
좌상단에서 우하단으로 대각선 선 속성 객체를 반환합니다. 읽기 전용 [ILineFormat](../../com.aspose.slides/ilineformat).
...
좌하단에서 우상단으로 대각선 선 속성 객체를 반환합니다. 읽기 전용 [ILineFormat](../../com.aspose.slides/ilineformat).
...
상속 및 테이블 스타일이 적용된 유효한 테이블 셀 서식 속성을 가져옵니다.
