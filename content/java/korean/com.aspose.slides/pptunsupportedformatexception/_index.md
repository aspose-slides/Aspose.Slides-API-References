...
type: docs
url: /ko/com.aspose.slides/pptunsupportedformatexception/
---
**상속:**
...
| 생성자 | 설명 |
| --- | --- |
| [PptUnsupportedFormatException()](#PptUnsupportedFormatException--) | 기본 생성자. |
| [PptUnsupportedFormatException(String message)](#PptUnsupportedFormatException-java.lang.String-) | 예외에 메시지를 추가할 수 있는 생성자. |
| [PptUnsupportedFormatException(String message, RuntimeException exception)](#PptUnsupportedFormatException-java.lang.String-java.lang.RuntimeException-) | 메시지와 포함된 예외를 갖는 예외를 위한 생성자. |
