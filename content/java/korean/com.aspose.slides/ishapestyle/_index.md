...
| [getFillStyleIndex()](#getFillStyleIndex--) | 스타일 매트릭스에서 도형의 채우기 열 인덱스를 반환하거나 설정합니다. |
| [setFillStyleIndex(short value)](#setFillStyleIndex-short-) | 스타일 매트릭스에서 도형의 채우기 열 인덱스를 반환하거나 설정합니다. |
| [getEffectColor()](#getEffectColor--) | 도형의 효과 색상을 반환합니다. |
| [getEffectStyleIndex()](#getEffectStyleIndex--) | 스타일 매트릭스에서 도형의 효과 열 인덱스를 반환하거나 설정합니다. |
| [setEffectStyleIndex(long value)](#setEffectStyleIndex-long-) | 스타일 매트릭스에서 도형의 효과 열 인덱스를 반환하거나 설정합니다. |
...
스타일 매트릭스에서 도형의 채우기 열 인덱스를 반환하거나 설정합니다. 0은 채우기가 없음을 의미하고, 양수 값은 테마의 채우기 스타일 인덱스를, 음수 값은 테마의 배경 스타일 인덱스를 의미합니다. 읽기/쓰기 short.
...
스타일 매트릭스에서 도형의 효과 열 인덱스를 반환하거나 설정합니다. 읽기/쓰기 long.
