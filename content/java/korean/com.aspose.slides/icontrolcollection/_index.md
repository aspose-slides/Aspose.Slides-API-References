...
description: ActiveX 컨트롤 컬렉션입니다.
type: docs
...
| [addControl(int controlType, float x, float y, float width, float height)](#addControl-int-float-float-float-float-) | 새 컨트롤을 생성하여 컬렉션에 추가합니다. |
...
새 컨트롤을 생성하여 컬렉션에 추가합니다.

**매개변수:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| controlType | int | 추가할 컨트롤의 유형. |
| x | float | 도형 프레임의 왼쪽 면에 대한 X 좌표. |
| y | float | 도형 프레임의 상단 면에 대한 Y 좌표. |
