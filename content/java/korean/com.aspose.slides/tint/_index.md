...
Tint 효과를 나타냅니다. 지정된 양만큼 색상 값을 색조 방향으로 또는 반대 방향으로 이동시킵니다.
...
| [equals(Object obj)](#equals-java.lang.Object-) | 지정된 [Tint](../../com.aspose.slides/tint)가 현재 [Tint](../../com.aspose.slides/tint)와 같은지 확인합니다. |
| [hashCode()](#hashCode--) | 특정 형식에 대한 해시 함수를 제공합니다. |
...
**반환:**  
[ITintEffectiveData](../../com.aspose.slides/itinteffectivedata) - [ITintEffectiveData](../../com.aspose.slides/itinteffectivedata).
...
지정된 [Tint](../../com.aspose.slides/tint)가 현재 [Tint](../../com.aspose.slides/tint)와 같은지 확인합니다.
