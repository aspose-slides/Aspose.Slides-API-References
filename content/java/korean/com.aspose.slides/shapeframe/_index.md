...
| 생성자 | 설명 |
| --- | --- |
| [ShapeFrame(float x, float y, float width, float height, byte flipH, byte flipV, float rotationAngle)](#ShapeFrame-float-float-float-float-byte-byte-float-) | 새 형상 프레임 속성을 생성합니다. |
...
| [deepClone()](#deepClone--) | 복제합니다 |
| [cloneT()](#cloneT--) | 복제합니다. |
| [hashCode()](#hashCode--) |  |
| [equals(Object obj)](#equals-java.lang.Object-) | 이 인스턴스가 지정된 객체와 동일한지 여부를 나타내는 값을 반환합니다. |
| [equals(ShapeFrame value)](#equals-com.aspose.slides.ShapeFrame-) | 이 인스턴스가 지정된 객체와 동일한지 여부를 나타내는 값을 반환합니다. |
...
| rotationAngle | float | 프레임이 회전된 각도. |
...
**반환:**  
[IShapeFrame](../../com.aspose.slides/ishapeframe) - 복제된 형상 프레임.
...
**반환:**  
boolean - **true**는 obj가 이 인스턴스와 동일한 값을 가진 ShapeFrame인 경우; 그렇지 않으면 **false**.
...
**반환:**  
boolean - **true**는 value가 이 인스턴스와 동일한 값을 가진 ShapeFrame인 경우; 그렇지 않으면 **false**.