...
| [getPlaceholderManager()](#getPlaceholderManager--) | 레이아웃 슬라이드의 placeholder 관리자를 반환합니다. |
...
| [getDrawingGuides()](#getDrawingGuides--) | 레이아웃 슬라이드에 대한 그리기 가이드 컬렉션을 반환합니다. |
...
레이아웃 슬라이드의 placeholder 관리자를 반환합니다. 읽기 전용 [ILayoutPlaceholderManager](../../com.aspose.slides/ilayoutplaceholdermanager).
...
레이아웃 슬라이드에 대한 그리기 가이드 컬렉션을 반환합니다. 읽기 전용 [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
...
>      // 슬라이드 중심 왼쪽에 새로운 수직 그리기 가이드를 추가합니다
