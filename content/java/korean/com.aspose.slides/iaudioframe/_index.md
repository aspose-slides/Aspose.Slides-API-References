...
| [getHideAtShowing()](#getHideAtShowing--) | AudioFrame이 숨겨져 있는지 여부를 결정합니다. |
| [setHideAtShowing(boolean value)](#setHideAtShowing-boolean-) | AudioFrame이 숨겨져 있는지 여부를 결정합니다. |
| [getPlayLoopMode()](#getPlayLoopMode--) | 오디오가 반복되는지 여부를 결정합니다. |
| [setPlayLoopMode(boolean value)](#setPlayLoopMode-boolean-) | 오디오가 반복되는지 여부를 결정합니다. |
| [getPlayAcrossSlides()](#getPlayAcrossSlides--) | 오디오가 슬라이드 전체에서 재생되는지 여부를 결정합니다. |
| [setPlayAcrossSlides(boolean value)](#setPlayAcrossSlides-boolean-) | 오디오가 슬라이드 전체에서 재생되는지 여부를 결정합니다. |
| [getRewindAudio()](#getRewindAudio--) | 오디오가 재생 후 자동으로 시작 지점으로 되감기는지 여부를 결정합니다. |
| [setRewindAudio(boolean value)](#setRewindAudio-boolean-) | 오디오가 재생 후 자동으로 시작 지점으로 되감기는지 여부를 결정합니다. |
| [getEmbedded()](#getEmbedded--) | 사운드가 프레젠테이션에 포함되어 있는지 여부를 결정합니다. |
...
| [getEmbeddedAudio()](#getEmbeddedAudio--) | 임베드된 오디오 객체를 반환하거나 설정합니다. |
| [setEmbeddedAudio(IAudio value)](#setEmbeddedAudio-com.aspose.slides.IAudio-) | 임베드된 오디오 객체를 반환하거나 설정합니다. |
...
| [getVolumeValue()](#getVolumeValue--) | 오디오 볼륨을 퍼센트로 반환하거나 설정합니다. |
| [setVolumeValue(float value)](#setVolumeValue-float-) | 오디오 볼륨을 퍼센트로 반환하거나 설정합니다. |
...
오디오가 재생 후 자동으로 시작 지점으로 되감기는지 여부를 결정합니다. 읽기/쓰기 boolean.
...
사운드가 프레젠테이션에 포함되어 있는지 여부를 결정합니다. 읽기 전용 boolean.
...
임베드된 오디오 객체를 반환하거나 설정합니다. 읽기/쓰기 [IAudio](../../com.aspose.slides/iaudio).
...
오디오 볼륨을 퍼센트로 반환하거나 설정합니다. 읽기/쓰기 float.
