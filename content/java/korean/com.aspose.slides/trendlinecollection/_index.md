...
| [add(int trendlineType)](#add-int-) | 새 Trendline을 컬렉션의 끝에 추가하고 반환합니다. |
...
지정된 인덱스의 요소를 가져옵니다. 읽기 전용 [Trendline](../../com.aspose.slides/trendline).
...
새 Trendline을 컬렉션의 끝에 추가하고 반환합니다.
...
**반환값:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ITrendline> - 컬렉션을 순회하는데 사용할 수 있는 IGenericEnumerator입니다.
...
**반환값:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ITrendline> - 전체 컬렉션에 대한 java.util.Iterator입니다.
### getCount() {#getCount--}
```
