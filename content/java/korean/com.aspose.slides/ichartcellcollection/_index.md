...
| [getConcatenatedValuesFromCells()](#getConcatenatedValuesFromCells--) | 모든 셀 문자열 값들을 연결한 문자열. |
| [get_Item(int index)](#get-Item-int-) | 인덱스로 셀(IChartDataCell)을 반환합니다. |
| [add(IChartDataCell chartDataCell)](#add-com.aspose.slides.IChartDataCell-) | 컬렉션에 새 셀을 추가합니다. |
| [add(Object value)](#add-java.lang.Object-) | 지정된 값으로 [IChartDataCell](../../com.aspose.slides/ichartdatacell)를 생성하고 컬렉션에 추가합니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| chartDataCell | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | 새로 추가할 셀. |
...
지정된 값으로 [IChartDataCell](../../com.aspose.slides/ichartdatacell)를 생성하고 컬렉션에 추가합니다.
...
이 메서드는 이름이 AUTO_DATA인 워크시트를 추가하고 모든 값을 그곳에 넣습니다. [IChartDataWorkbook](../../com.aspose.slides/ichartdataworkbook)를 사용하여 셀 값을 추가하거나 편집하는 경우, 이 워크시트를 사용하지 않도록 하십시오. 이 메서드를 사용하여 추가된 값의 최대 수는 16711680을 초과해서는 안 됩니다 |
