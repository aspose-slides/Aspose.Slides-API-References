...
| [getSvgContent()](#getSvgContent--) | SVG 내용을 반환합니다. |
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| svgContent | java.lang.String | Svg 내용. |
...
| baseUri | java.lang.String | 지정된 Svg의 기본 URI. 상대 링크를 해결하는 데 사용됩니다. |
