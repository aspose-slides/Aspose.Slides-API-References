...
| [clear()](#clear--) | 컬렉션의 모든 SummaryZoomSection 객체를 제거합니다. |
...
이미 해당 섹션에 대한 요소가 컬렉션에 존재하는 경우, 기존 요소가 반환됩니다. |
...
**반환값:**
[ISummaryZoomSection](../../com.aspose.slides/isummaryzoomsection) - [ISummaryZoomSection](../../com.aspose.slides/isummaryzoomsection) 또는 컬렉션에 해당 섹션 요소가 없을 경우 null.
...
컬렉션의 모든 SummaryZoomSection 객체를 제거합니다.
