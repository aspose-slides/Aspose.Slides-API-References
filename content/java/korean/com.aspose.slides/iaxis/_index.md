...
| 메서드 | 설명 |
| --- | --- |
| [getAxisBetweenCategories()](#getAxisBetweenCategories--) | 값 축이 카테고리 축을 카테고리 사이에서 교차하는지 여부를 나타냅니다. |
| [setAxisBetweenCategories(boolean value)](#setAxisBetweenCategories-boolean-) | 값 축이 카테고리 축을 카테고리 사이에서 교차하는지 여부를 나타냅니다. |
...
| [getActualMinorUnit()](#getActualMinorUnit--) | 축의 실제 미세 단위를 지정합니다. |
| [getActualMajorUnitScale()](#getActualMajorUnitScale--) | 축의 실제 주요 단위 스케일을 지정합니다. |
| [getActualMinorUnitScale()](#getActualMinorUnitScale--) | 축의 실제 미세 단위 스케일을 지정합니다. |
...
| [getMinorUnit()](#getMinorUnit--) | 날짜 또는 값 축에 대한 미세 단위를 나타냅니다. |
| [setMinorUnit(double value)](#setMinorUnit-double-) | 날짜 또는 값 축에 대한 미세 단위를 나타냅니다. |
| [isAutomaticMinorUnit()](#isAutomaticMinorUnit--) | 축의 미세 단위가 자동으로 할당되는지 여부를 나타냅니다. |
| [setAutomaticMinorUnit(boolean value)](#setAutomaticMinorUnit-boolean-) | 축의 미세 단위가 자동으로 할당되는지 여부를 나타냅니다. |
...
| [isPlotOrderReversed()](#isPlotOrderReversed--) | MS PowerPoint가 데이터 포인트를 마지막부터 첫 번째까지 표시하는지 여부를 나타냅니다. |
| [setPlotOrderReversed(boolean value)](#setPlotOrderReversed-boolean-) | MS PowerPoint가 데이터 포인트를 마지막부터 첫 번째까지 표시하는지 여부를 나타냅니다. |
| [isVisible()](#isVisible--) | 축이 표시되는지 여부를 나타냅니다. |
| [setVisible(boolean value)](#setVisible-boolean-) | 축이 표시되는지 여부를 나타냅니다. |
...
| [getTickLabelPosition()](#getTickLabelPosition--) | 지정된 축에 대한 눈금 라벨 위치를 나타냅니다. |
| [setTickLabelPosition(int value)](#setTickLabelPosition-int-) | 지정된 축에 대한 눈금 라벨 위치를 나타냅니다. |
...
| [getMinorGridLinesFormat()](#getMinorGridLinesFormat--) | 차트 축에 대한 부 눈금선 형식을 나타냅니다. |
| [getMajorGridLinesFormat()](#getMajorGridLinesFormat--) | 차트 축에 대한 주요 눈금선 형식을 나타냅니다. |
| [getShowMinorGridLines()](#getShowMinorGridLines--) | 부 눈금선이 표시되는지 여부를 나타냅니다. |
| [getShowMajorGridLines()](#getShowMajorGridLines--) | 주 눈금선이 표시되는지 여부를 나타냅니다. |
...
| [hasTitle()](#hasTitle--) | 축에 표시되는 제목이 있는지 여부를 결정합니다. |
| [setTitle(boolean value)](#setTitle-boolean-) | 축에 표시되는 제목이 있는지 여부를 결정합니다. |
...
| [getTickLabelRotationAngle()](#getTickLabelRotationAngle--) | 눈금 라벨의 회전 각도를 나타냅니다. 읽기/쓰기 float. |
| [setTickLabelRotationAngle(float value)](#setTickLabelRotationAngle-float-) | 눈금 라벨의 회전 각도를 나타냅니다. 읽기/쓰기 float. |
...
| [getTickMarksSpacing()](#getTickMarksSpacing--) | 다음 눈금이 그려지기 전 건너뛸 눈금 수를 지정합니다. |
| [setTickMarksSpacing(long value)](#setTickMarksSpacing-long-) | 다음 눈금이 그려지기 전 건너뛸 눈금 수를 지정합니다. |
...
| [getLabelOffset()](#getLabelOffset--) | 라벨이 축으로부터 떨어진 거리를 지정합니다. |
| [setLabelOffset(int value)](#setLabelOffset-int-) | 라벨이 축으로부터 떨어진 거리를 지정합니다. |
...
| [getBinWidth()](#getBinWidth--) | AggregationType 속성 값이 AxisAggregationType.ByBinWidth로 설정된 경우 빈 너비를 지정합니다. |
| [setBinWidth(double value)](#setBinWidth-double-) | AggregationType 속성 값이 AxisAggregationType.ByBinWidth로 설정된 경우 빈 너비를 지정합니다. |
| [getNumberOfBins()](#getNumberOfBins--) | AggregationType 속성 값이 AxisAggregationType.ByNumberOfBins로 설정된 경우 빈의 수를 지정합니다. |
| [setNumberOfBins(long value)](#setNumberOfBins-long-) | AggregationType 속성 값이 AxisAggregationType.ByNumberOfBins로 설정된 경우 빈의 수를 지정합니다. |
| [isOverflowBin()](#isOverflowBin--) | 오버플로 빈이 적용되는지 여부를 지정합니다. |
| [setOverflowBin(boolean value)](#setOverflowBin-boolean-) | 오버플로 빈이 적용되는지 여부를 지정합니다. |
| [isAutomaticOverflowBin()](#isAutomaticOverflowBin--) | 자동 오버플로 빈 값을 지정합니다. |
| [setAutomaticOverflowBin(boolean value)](#setAutomaticOverflowBin-boolean-) | 자동 오버플로 빈 값을 지정합니다. |
| [getOverflowBin()](#getOverflowBin--) | 오버플로 빈 사용자 지정 값을 지정합니다. |
| [setOverflowBin(double value)](#setOverflowBin-double-) | 오버플로 빈 사용자 지정 값을 지정합니다. |
| [isUnderflowBin()](#isUnderflowBin--) | 언더플로 빈이 적용되는지 여부를 지정합니다. |
| [setUnderflowBin(boolean value)](#setUnderflowBin-boolean-) | 언더플로 빈이 적용되는지 여부를 지정합니다. |
| [isAutomaticUnderflowBin()](#isAutomaticUnderflowBin--) | 자동 언더플로 빈 값을 지정합니다. |
| [setAutomaticUnderflowBin(boolean value)](#setAutomaticUnderflowBin-boolean-) | 자동 언더플로 빈 값을 지정합니다. |
| [getUnderflowBin()](#getUnderflowBin--) | 언더플로 빈 사용자 지정 값을 지정합니다. |
| [setUnderflowBin(double value)](#setUnderflowBin-double-) | 언더플로 빈 사용자 지정 값을 지정합니다. |
...
값 축이 카테고리 축을 카테고리 사이에서 교차하는지 여부를 나타냅니다. 이 속성은 카테고리 축에만 적용되며 3-D 차트에는 적용되지 않습니다. 읽기/쓰기 boolean.
...
축의 실제 최대 값을 지정합니다. 실제 값을 얻기 위해 이전에 IChart.ValidateChartLayout() 메서드를 호출해야 합니다.
...
축의 실제 최소 값을 지정합니다. 실제 값을 얻기 위해 이전에 IChart.ValidateChartLayout() 메서드를 호출해야 합니다.
...
축의 실제 주요 단위를 지정합니다. 실제 값을 얻기 위해 이전에 IChart.ValidateChartLayout() 메서드를 호출해야 합니다.
...
축의 실제 미세 단위를 지정합니다. 실제 값을 얻기 위해 이전에 IChart.ValidateChartLayout() 메서드를 호출해야 합니다.
...
축의 실제 주요 단위 스케일을 지정합니다. 실제 값을 얻기 위해 이전에 IChart.ValidateChartLayout() 메서드를 호출해야 합니다.
...
축의 실제 미세 단위 스케일을 지정합니다. 실제 값을 얻기 위해 이전에 IChart.ValidateChartLayout() 메서드를 호출해야 합니다.
...
날짜 또는 값 축에 대한 미세 단위를 나타냅니다. 읽기/쓰기 double.
...
축의 미세 단위가 자동으로 할당되는지 여부를 나타냅니다. 읽기/쓰기 boolean.
...
값 축의 눈금 유형이 로그인지 여부를 나타냅니다. 읽기/쓰기 boolean.
...
MS PowerPoint가 데이터 포인트를 마지막부터 첫번째까지 플롯하는지 여부를 나타냅니다. 읽기/쓰기 boolean.
...
지정된 축에 대한 보조 눈금 표시 유형을 나타냅니다. 읽기/쓰기 [TickMarkType](../../com.aspose.slides/tickmarktype).
...
지정된 축에 대한 눈금 라벨 위치를 나타냅니다. 읽기/쓰기 [TickLabelPositionType](../../com.aspose.slides/ticklabelpositiontype).
...
차트 축의 보조 격자선 형식을 나타냅니다. 읽기 전용 [IChartLinesFormat](../../com.aspose.slides/ichartlinesformat).
...
차트 축의 주요 격자선 형식을 나타냅니다. 읽기 전용 [IChartLinesFormat](../../com.aspose.slides/ichartlinesformat).
...
보조 격자선이 표시되는지 여부를 나타냅니다. 읽기 전용 boolean.
...
주요 격자선이 표시되는지 여부를 나타냅니다. 읽기 전용 boolean.
...
축에 가시적인 제목이 있는지 여부를 판정합니다. 읽기/쓰기 boolean.
...
축 레이블의 형식 문자열을 나타냅니다. 읽기/쓰기 String.
...
눈금 라벨의 회전 각도를 나타냅니다. 읽기/쓰기 float.
...
그려지는 라벨 사이에 건너뛰는 눈금 라벨 수를 지정합니다. 읽기/쓰기 long.
...
다음 눈금이 그려지기 전에 건너뛰어야 할 눈금 개수를 지정합니다. 범주 축 또는 계열 축에 적용됩니다. 읽기/쓰기 int.
...
라벨을 축으로부터 떨어뜨리는 거리를 지정합니다. 범주 축 또는 날짜 축에 적용됩니다. 값은 0%에서 1000% 사이여야 합니다. 읽기/쓰기 int.
...
범주 축의 유형을 지정합니다. 읽기/쓰기 [CategoryAxisType](../../com.aspose.slides/categoryaxistype)(\#getCategoryAxisType.getCategoryAxisType/\#setCategoryAxisType(int).setCategoryAxisType(int)).
...
IAxis.CategoryAxisType 속성을 축 데이터에 따라 자동으로 결정되는 값으로 설정합니다.
...
범주 축(구간화)의 집계 유형을 나타냅니다. 범주에 적용됩니다. 히스토그램 또는 HistogramPareto 계열에서만 사용됩니다.
...
AggregationType 속성 값이 AxisAggregationType.ByNumberOfBins 로 설정된 경우 bin 수를 지정합니다. 범주 축에 적용됩니다. Histogram 또는 HistogramPareto 시리즈와 함께 사용할 수 있습니다.
...
오버플로우 bin이 적용되는지 지정합니다. 오버플로우 bin 값을 조정하려면 IsAutomaticOverflowBin 및 OverflowBin을 사용하십시오.
...
자동 오버플로우 bin 값을 지정합니다. false인 경우: OverflowBin 속성을 사용합니다.
...
오버플로우 bin 사용자 지정 값을 지정합니다. IsAutomaticOverflowBin 속성이 false로 설정되고 IsOverflowBin 속성이 true인 경우에 적용됩니다.
...
언더플로우 bin이 적용되는지 지정합니다. 언더플로우 bin 값을 조정하려면 IsAutomaticUnderflowBin 및 UnderflowBin을 사용하십시오.
...
자동 언더플로우 bin 값을 지정합니다. false인 경우: UnderflowBin 속성을 사용합니다.
...
언더플로우 bin 사용자 지정 값을 지정합니다. IsAutomaticUnderflowBin 속성이 false로 설정되고 IsUnderflowBin 속성이 true인 경우에 적용됩니다.
