...
Bi-Level (black/white) 효과를 나타냅니다. 지정된 임계값보다 낮은 휘도를 가진 입력 색상은 검은색으로 변경됩니다. 지정된 값보다 크거나 같거나 같은 휘도의 입력 색상은 흰색으로 설정됩니다. 알파 효과 값은 이 효과에 의해 영향을 받지 않습니다.
...
| [equals(Object obj)](#equals-java.lang.Object-) | 지정된 [BiLevel](../../com.aspose.slides/bilevel) 가 현재 [BiLevel](../../com.aspose.slides/bilevel) 와 같은지 여부를 확인합니다. |
...
**반환값:**  
[IBiLevelEffectiveData](../../com.aspose.slides/ibileveleffectivedata) - 하나의 [IBiLevelEffectiveData](../../com.aspose.slides/ibileveleffectivedata).
...
지정된 [BiLevel](../../com.aspose.slides/bilevel) 가 현재 [BiLevel](../../com.aspose.slides/bilevel) 와 같은지 여부를 확인합니다.
