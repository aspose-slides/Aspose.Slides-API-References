...
| [getThroughBlack()](#getThroughBlack--) | 전환이 검은색을 통해 페이드되는지 지정합니다. |
| [setThroughBlack(boolean value)](#setThroughBlack-boolean-) | 전환이 검은색을 통해 페이드되는지 지정합니다. |
...
전환이 검은색을 통해 페이드되는지 지정합니다. 읽기/쓰기 boolean.
