...
| [getVariableScale()](#getVariableScale--) | 보기 내용이 현재 창 크기에 맞게 자동으로 확대/축소되도록 지정합니다. |
| [setVariableScale(boolean value)](#setVariableScale-boolean-) | 보기 내용이 현재 창 크기에 맞게 자동으로 확대/축소되도록 지정합니다. |
...
보기 내용이 현재 창 크기에 맞게 자동으로 확대/축소되도록 지정합니다. 읽기/쓰기 boolean.
