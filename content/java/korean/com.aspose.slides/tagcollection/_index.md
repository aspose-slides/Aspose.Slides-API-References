...
description: 태그의 사용자 정의 문자열 쌍 컬렉션을 나타냅니다
type: docs
...
**반환:**
int - 컬렉션에 키가 존재하면 0부터 시작하는 인덱스, 없으면 -1.
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| index | int | 제거할 태그의 0부터 시작하는 인덱스. |
### clear() {#clear--}
```
...
**반환:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.ms.System.Collections.Generic.KeyValuePair<java.lang.String,java.lang.String>> - 컬렉션을 순회하는 데 사용할 수 있는 IGenericEnumerator.
