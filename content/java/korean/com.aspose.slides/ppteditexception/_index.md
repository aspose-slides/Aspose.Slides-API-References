...
type: docs
url: /ko/com.aspose.slides/ppteditexception/
---
**상속:**
...
| 생성자 | 설명 |
| --- | --- |
| [PptEditException()](#PptEditException--) | 기본 생성자. |
| [PptEditException(String message)](#PptEditException-java.lang.String-) | 이 예외에 메시지를 추가할 수 있는 생성자. |
| [PptEditException(String message, RuntimeException exception)](#PptEditException-java.lang.String-java.lang.RuntimeException-) | 메시지와 포함된 예외를 포함하는 예외에 대한 생성자. |
