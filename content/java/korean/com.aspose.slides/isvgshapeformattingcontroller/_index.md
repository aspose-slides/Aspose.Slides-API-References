...
| 메서드 | 설명 |
| --- | --- |
| [formatShape(ISvgShape svgShape, IShape shape)](#formatShape-com.aspose.slides.ISvgShape-com.aspose.slides.IShape-) | 이 함수는 모양을 SVG로 렌더링하기 전에 호출되어 사용자가 결과 SVG를 제어할 수 있도록 합니다. |
...
이 함수는 모양을 SVG로 렌더링하기 전에 호출되어 사용자가 결과 SVG를 제어할 수 있도록 합니다.
