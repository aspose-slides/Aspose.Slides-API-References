...
| 메서드 | 설명 |
| --- | --- |
| [isFormatNotDefined()](#isFormatNotDefined--) | 라인 형식이 정의되지 않은 경우(방금 생성된 기본값) true를 반환합니다. |
...
| [getBeginArrowheadStyle()](#getBeginArrowheadStyle--) | 라인 시작 지점의 화살표 머리 스타일을 반환하거나 설정합니다. |
| [setBeginArrowheadStyle(byte value)](#setBeginArrowheadStyle-byte-) | 라인 시작 지점의 화살표 머리 스타일을 반환하거나 설정합니다. |
| [getEndArrowheadStyle()](#getEndArrowheadStyle--) | 라인 끝 지점의 화살표 머리 스타일을 반환하거나 설정합니다. |
| [setEndArrowheadStyle(byte value)](#setEndArrowheadStyle-byte-) | 라인 끝 지점의 화살표 머리 스타일을 반환하거나 설정합니다. |
| [getBeginArrowheadWidth()](#getBeginArrowheadWidth--) | 라인 시작 지점의 화살표 머리 너비를 반환하거나 설정합니다. |
| [setBeginArrowheadWidth(byte value)](#setBeginArrowheadWidth-byte-) | 라인 시작 지점의 화살표 머리 너비를 반환하거나 설정합니다. |
| [getEndArrowheadWidth()](#getEndArrowheadWidth--) | 라인 끝 지점의 화살표 머리 너비를 반환하거나 설정합니다. |
| [setEndArrowheadWidth(byte value)](#setEndArrowheadWidth-byte-) | 라인 끝 지점의 화살표 머리 너비를 반환하거나 설정합니다. |
| [getBeginArrowheadLength()](#getBeginArrowheadLength--) | 라인 시작 지점의 화살표 머리 길이를 반환하거나 설정합니다. |
| [setBeginArrowheadLength(byte value)](#setBeginArrowheadLength-byte-) | 라인 시작 지점의 화살표 머리 길이를 반환하거나 설정합니다. |
| [getEndArrowheadLength()](#getEndArrowheadLength--) | 라인 끝 지점의 화살표 머리 길이를 반환하거나 설정합니다. |
| [setEndArrowheadLength(byte value)](#setEndArrowheadLength-byte-) | 라인 끝 지점의 화살표 머리 길이를 반환하거나 설정합니다. |
| [equals(ILineFormat lineFormat)](#equals-com.aspose.slides.ILineFormat-) | 두 LineFormat 인스턴스가 동일한지 여부를 판단합니다. |
...
라인 시작 지점의 화살표 머리 스타일을 반환하거나 설정합니다. 읽기/쓰기 [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
라인 끝 지점의 화살표 머리 스타일을 반환하거나 설정합니다. 읽기/쓰기 [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
라인 시작 지점의 화살표 머리 너비를 반환하거나 설정합니다. 읽기/쓰기 [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
라인 끝 지점의 화살표 머리 너비를 반환하거나 설정합니다. 읽기/쓰기 [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
라인 시작 지점의 화살표 머리 길이를 반환하거나 설정합니다. 읽기/쓰기 [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
라인 끝 지점의 화살표 머리 길이를 반환하거나 설정합니다. 읽기/쓰기 [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
두 LineFormat 인스턴스가 동일한지 여부를 판단합니다.
...
**반환:**
boolean - **true** 지정된 LineFormat이 현재 LineFormat과 동일하면; 그렇지 않으면 **false**.
