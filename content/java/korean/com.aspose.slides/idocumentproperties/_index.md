...
| [getSharedDoc()](#getSharedDoc--) | 프레젠테이션이 여러 사람과 공유되는지 확인합니다. |
| [setSharedDoc(boolean value)](#setSharedDoc-boolean-) | 프레젠테이션이 여러 사람과 공유되는지 확인합니다. |
...
| [getTotalEditingTime()](#getTotalEditingTime--) | 프레젠테이션의 총 편집 시간. |
| [setTotalEditingTime(double value)](#setTotalEditingTime-double-) | 프레젠테이션의 총 편집 시간. |
...
| [getAuthor()](#getAuthor--) | 프레젠테이션의 작성자를 반환하거나 설정합니다. |
| [setAuthor(String value)](#setAuthor-java.lang.String-) | 프레젠테이션의 작성자를 반환하거나 설정합니다. |
...
| [getLinksUpToDate()](#getLinksUpToDate--) | 문서의 하이퍼링크가 최신인지 여부를 나타냅니다. |
| [setLinksUpToDate(boolean value)](#setLinksUpToDate-boolean-) | 문서의 하이퍼링크가 최신인지 여부를 나타냅니다. |
| [getHyperlinksChanged()](#getHyperlinksChanged--) | 생산자가 이 부분에서 독점적으로 업데이트한 하나 이상의 하이퍼링크가 있음을 지정합니다. |
| [setHyperlinksChanged(boolean value)](#setHyperlinksChanged-boolean-) | 생산자가 이 부분에서 독점적으로 업데이트한 하나 이상의 하이퍼링크가 있음을 지정합니다. |
| [getSlides()](#getSlides--) | 프레젠테이션 문서의 전체 슬라이드 수를 지정합니다. |
| [getHiddenSlides()](#getHiddenSlides--) | 프레젠테이션 문서의 숨김 슬라이드 수를 지정합니다. |
| [getNotes()](#getNotes--) | 노트를 포함한 프레젠테이션 슬라이드 수를 지정합니다. |
| [getParagraphs()](#getParagraphs--) | 해당되는 경우 문서에서 발견된 전체 단락 수를 지정합니다. |
| [getWords()](#getWords--) | 문서에 포함된 전체 단어 수를 지정합니다. |
| [getMultimediaClips()](#getMultimediaClips--) | 문서에 포함된 전체 오디오 또는 비디오 클립 수를 지정합니다. |
| [getTitlesOfParts()](#getTitlesOfParts--) | 각 문서 부분의 제목을 지정합니다. |
| [getHeadingPairs()](#getHeadingPairs--) | 문서 부분의 그룹화와 각 그룹의 부분 수를 나타냅니다. |
...
| [clearBuiltInProperties()](#clearBuiltInProperties--) | 모든 builtIn 속성을 초기화하고 기본값을 설정합니다. |
| [getCustomPropertyValue(String name, boolean[] value)](#getCustomPropertyValue-java.lang.String-boolean---) | 사용자가 정의한 속성에서 지정된 boolean 값을 가져옵니다. |
| [getCustomPropertyValue(String name, int[] value)](#getCustomPropertyValue-java.lang.String-int---) | 사용자가 정의한 속성에서 지정된 정수 값을 가져옵니다. |
| [getCustomPropertyValue(String name, Date[] value)](#getCustomPropertyValue-java.lang.String-java.util.Date---) | 사용자가 정의한 속성에서 지정된 DateTime 값을 가져옵니다. |
| [getCustomPropertyValue(String name, String[] value)](#getCustomPropertyValue-java.lang.String-java.lang.String---) | 사용자가 정의한 속성에서 지정된 문자열 값을 가져옵니다. |
| [getCustomPropertyValue(String name, float[] value)](#getCustomPropertyValue-java.lang.String-float---) | 사용자가 정의한 속성에서 지정된 float 값을 가져옵니다. |
| [getCustomPropertyValue(String name, double[] value)](#getCustomPropertyValue-java.lang.String-double---) | 사용자가 정의한 속성에서 지정된 double 값을 가져옵니다. |
| [setCustomPropertyValue(String name, boolean value)](#setCustomPropertyValue-java.lang.String-boolean-) | 지정된 boolean 사용자 정의 속성을 설정합니다. |
| [setCustomPropertyValue(String name, int value)](#setCustomPropertyValue-java.lang.String-int-) | 지정된 정수 사용자 정의 속성을 설정합니다. |
| [setCustomPropertyValue(String name, Date value)](#setCustomPropertyValue-java.lang.String-java.util.Date-) | 지정된 DateTime 사용자 정의 속성을 설정합니다. |
| [setCustomPropertyValue(String name, String value)](#setCustomPropertyValue-java.lang.String-java.lang.String-) | 지정된 문자열 사용자 정의 속성을 설정합니다. |
| [setCustomPropertyValue(String name, float value)](#setCustomPropertyValue-java.lang.String-float-) | 지정된 float 사용자 정의 속성을 설정합니다. |
| [setCustomPropertyValue(String name, double value)](#setCustomPropertyValue-java.lang.String-double-) | 지정된 double 사용자 정의 속성을 설정합니다. |
| [getSensitivityLabels()](#getSensitivityLabels--) | 사용자 정의 문서 속성에서 민감도 레이블 배열을 가져옵니다 (Microsoft Information Protection SDK 메타데이터). |
...
이 요소의 내용은 XX.YYYY 형식이어야 하며, 여기서 X와 Y는 숫자 값입니다; 그렇지 않을 경우 문서는 비준수로 간주됩니다. Aspose.Slides는 버전을 XX.YY.ZZ 형식으로 나타냅니다, 여기서: XX - 주요 버전 YY - 부 버전 ZZ - 패치 버전 예를 들어, 값 23.0105는 Aspose.Slides 버전 23.1.5를 의미합니다.
...
프레젠테이션이 여러 사람과 공유되는지 확인합니다. 읽기/쓰기 boolean.
...
프레젠테이션의 작성자를 반환하거나 설정합니다. 읽기/쓰기 String.
...
프레젠테이션이 마지막으로 수정된 날짜를 반환합니다. 값은 UTC 기준입니다. Presentation.DocumentProperties의 경우 읽기 전용(Presentation.DocumentProperties는 저장 과정 중 내부에서 업데이트되기 때문). [IPresentationInfo.readDocumentProperties](../../com.aspose.slides/ipresentationinfo\#readDocumentProperties) 메서드가 반환하는 DocumentProperties 인스턴스를 통해 변경할 수 있습니다. [IPresentationInfo.updateDocumentProperties(IDocumentProperties)](../../com.aspose.slides/ipresentationinfo\#updateDocumentProperties-IDocumentProperties-) 메서드 요약의 예제를 참조하십시오.
...
프레젠테이션 리비전 번호를 반환하거나 설정합니다. 읽기/쓰기 int.
...
문서 썸네일의 표시 모드를 나타냅니다. 이 요소를 **true** 로 설정하면 문서 썸네일이 디스플레이에 맞게 확대됩니다. **false** 로 설정하면 디스플레이에 맞는 섹션만 표시하도록 썸네일이 자릅니다. 읽기/쓰기 boolean.
...
문서의 하이퍼링크가 최신 상태인지 여부를 나타냅니다. **true** 로 설정하면 하이퍼링크가 업데이트되었음을 나타냅니다. **false** 로 설정하면 하이퍼링크가 오래되었음을 나타냅니다. 읽기/쓰기 boolean.
...
이 파트에서 하나 이상의 하이퍼링크가 해당 파트에서만 생산자에 의해 업데이트되었음을 지정합니다. 다음 생산자가 문서를 열 때 이 파트에 지정된 새로운 하이퍼링크로 하이퍼링크 관계를 업데이트해야 합니다. 읽기/쓰기 boolean.
...
프레젠테이션 문서에서 숨겨진 슬라이드 수를 지정합니다. 읽기 전용 int.
...
노트가 포함된 슬라이드 수를 지정합니다. 읽기 전용 int.
...
문서에 포함된 총 단락 수를 지정합니다. 읽기 전용 int.
...
문서에 포함된 총 단어 수를 지정합니다. 읽기 전용 int.
...
문서에 포함된 전체 사운드 또는 비디오 클립 수를 지정합니다. 읽기 전용 int.
...
각 문서 부분의 제목을 지정합니다. 이 부분은 실제 문서 부분이 아니라 문서 섹션의 개념적 표현입니다. 읽기 전용 String[].
...
문서 부분의 그룹화와 각 그룹의 부분 수를 나타냅니다. 읽기 전용 IHeadingPair[].
...
사용자 정의 속성에서 지정된 이름의 문자열 값을 가져옵니다.
...
| 이름 | java.lang.String | 가져올 사용자 정의 속성의 이름. |
| 값 | double[] | 사용자 정의 속성 값 |
