...
type: docs
url: /ko/com.aspose.slides/pptcorruptfileexception/
---
**상속:**  
...
| 생성자 | 설명 |
| --- | --- |
| [PptCorruptFileException()](#PptCorruptFileException--) | 기본 생성자. |
| [PptCorruptFileException(String message)](#PptCorruptFileException-java.lang.String-) | 예외에 메시지를 추가할 수 있는 생성자. |
| [PptCorruptFileException(String message, RuntimeException exception)](#PptCorruptFileException-java.lang.String-java.lang.RuntimeException-) | 메시지와 포함된 예외를 가진 예외를 위한 생성자. |
