...
| 메서드 | 설명 |
| --- | --- |
| [getMasterNotesSlide()](#getMasterNotesSlide--) | 프레젠테이션에 마스터 노트 슬라이드가 있으면 해당 마스터를 반환하고, 없으면 null을 반환합니다. |
...
프레젠테이션에 마스터 노트 슬라이드가 있으면 해당 마스터를 반환하고, 없으면 null을 반환합니다. 읽기 전용 [IMasterNotesSlide](../../com.aspose.slides/imasternotesslide).
