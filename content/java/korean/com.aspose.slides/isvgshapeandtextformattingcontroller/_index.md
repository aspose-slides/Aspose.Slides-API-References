...
| 메서드 | 설명 |
| --- | --- |
| [formatText(ISvgTSpan svgTSpan, IPortion portion, ITextFrame textFrame)](#formatText-com.aspose.slides.ISvgTSpan-com.aspose.slides.IPortion-com.aspose.slides.ITextFrame-) | 이 함수는 SVG로 텍스트 부분을 렌더링하기 전에 호출되어 사용자가 결과 SVG를 제어할 수 있도록 합니다. |
...
이 함수는 SVG로 텍스트 부분을 렌더링하기 전에 호출되어 사용자가 결과 SVG를 제어할 수 있도록 합니다.

**매개변수:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| svgTSpan | [ISvgTSpan](../../com.aspose.slides/isvgtspan) | SVG tspan 생성을 제어하기 위한 객체. |
| portion | [IPortion](../../com.aspose.slides/iportion) | 원본 구간. |
| textFrame | [ITextFrame](../../com.aspose.slides/itextframe) | 원본 구간 텍스트 프레임. |