...
type: docs
url: /ko/com.aspose.slides/iglittertransition/
---
**구현된 모든 인터페이스:**
...
| [getPattern()](#getPattern--) | 전환 중에 사용되는 시각 자료의 모양을 지정합니다. |
| [setPattern(int value)](#setPattern-int-) | 전환 중에 사용되는 시각 자료의 모양을 지정합니다. |
### getDirection() {#getDirection--}
```
public abstract int getDirection()
```

전환 방향. 읽기/쓰기 [TransitionSideDirectionType](../../com.aspose.slides/transitionsidedirectiontype).
...
전환 중에 사용되는 시각 자료의 모양을 지정합니다. 읽기/쓰기 [TransitionPattern](../../com.aspose.slides/transitionpattern).
