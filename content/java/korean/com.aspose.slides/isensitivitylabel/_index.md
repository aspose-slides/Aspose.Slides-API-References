...
| [getAssignmentMethodType()](#getAssignmentMethodType--) | 민감도 레이블에 대한 할당 방식을 반환하거나 설정합니다. |
| [setAssignmentMethodType(int value)](#setAssignmentMethodType-int-) | 민감도 레이블에 대한 할당 방식을 반환하거나 설정합니다. |
...
민감도 레이블에 대한 할당 방식을 반환하거나 설정합니다. 읽기/쓰기 [SensitivityLabelAssignmentType](../../com.aspose.slides/sensitivitylabelassignmenttype).
