...
| [isNoEffects()](#isNoEffects--) | 모든 효과가 비활성화된 경우 true를 반환합니다 (생성 직후, 기본 EffectFormat 객체와 같이). |
...
모든 효과가 비활성화된 경우 true를 반환합니다 (생성 직후, 기본 EffectFormat 객체와 같이). 읽기 전용 boolean .
...
> ```
> 이 예제는 도형의 효과 속성 중 일부를 가져오는 방법을 보여줍니다.
>  
