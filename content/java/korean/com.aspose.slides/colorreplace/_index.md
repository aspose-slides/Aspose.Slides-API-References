...
Color Replacement 효과를 나타냅니다. 모든 효과 색상이 고정된 색상으로 변경됩니다. 알파 값은 영향을 받지 않습니다.
...
| [getEffective()](#getEffective--) | 상속이 적용된 실제 Color Replacement 효과 데이터를 가져옵니다. |
...
상속이 적용된 실제 Color Replacement 효과 데이터를 가져옵니다.
