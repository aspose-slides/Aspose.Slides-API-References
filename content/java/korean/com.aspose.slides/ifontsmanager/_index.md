...
| [getFontFallBackRulesCollection()](#getFontFallBackRulesCollection--) | 사용자의 FontFallBack 규칙 컬렉션을 나타내며, 폰트 컬렉션을 적절히 대체하기 위한 폴백 기능을 관리합니다 (읽기/쓰기) [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection). |
| [setFontFallBackRulesCollection(IFontFallBackRulesCollection value)](#setFontFallBackRulesCollection-com.aspose.slides.IFontFallBackRulesCollection-) | 사용자의 FontFallBack 규칙 컬렉션을 나타내며, 폰트 컬렉션을 적절히 대체하기 위한 폴백 기능을 관리합니다 (읽기/쓰기) [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection). |
| [getFonts()](#getFonts--) | 프레젠테이션에서 사용된 글꼴을 반환합니다 |
...
| [replaceFont(IFontData sourceFont, IFontData destFont)](#replaceFont-com.aspose.slides.IFontData-com.aspose.slides.IFontData-) | 프레젠테이션에서 글꼴을 교체합니다 |
| [replaceFont(IFontSubstRule substRule)](#replaceFont-com.aspose.slides.IFontSubstRule-) | 제공된 [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) 정보를 사용하여 프레젠테이션에서 글꼴을 교체합니다 |
| [replaceFont(IFontSubstRuleCollection substRules)](#replaceFont-com.aspose.slides.IFontSubstRuleCollection-) | 컬렉션 [IFontSubstRule](../../com.aspose.slides/ifontsubstrule)에 제공된 정보를 사용하여 프레젠테이션에서 글꼴을 교체합니다 |
...
| [getFontEmbeddingLevel(byte[] fontBytes, String fontName)](#getFontEmbeddingLevel-byte---java.lang.String-) | 주어진 바이트 배열과 글꼴 이름을 사용하여 글꼴의 임베딩 레벨을 판단합니다. |
...
사용자의 FontFallBack 규칙 컬렉션을 나타내며, 폰트 컬렉션을 적절히 대체하기 위한 폴백 기능을 관리합니다 (읽기/쓰기) [IFontFallBackRulesCollection](../../com.aspose.slides/ifontfallbackrulescollection).
...
**반환값:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.slides.FontSubstitutionInfo> - 모든 글꼴 대체의 컬렉션 [FontSubstitutionInfo](../../com.aspose.slides/fontsubstitutioninfo).
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| slides | int[] | 폰트 대체 정보를 가져올 슬라이드 인덱스 배열이며, 1부터 시작합니다. |

**반환값:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerable<com.aspose.slides.FontSubstitutionInfo> - 지정된 슬라이드에 대한 모든 글꼴 대체 컬렉션 ([FontSubstitutionInfo](../../com.aspose.slides/fontsubstitutioninfo)).
...
| --- | --- | --- |
| fontData | [IFontData](../../com.aspose.slides/ifontdata) | 글꼴 데이터 객체 [IFontData](../../com.aspose.slides/ifontdata) |
| embedFontRule | int | 임베드된 글꼴 규칙 [EmbedFontCharacters](../../com.aspose.slides/embedfontcharacters)

--------------------

폰트를 복사할 때 대부분의 글꼴이 저작권에 보호받고 있음을 기억하십시오. 먼저 글꼴 라이선스를 확인하고 다른 컴퓨터로 자유롭게 이전할 수 있는지 확인하십시오. |
...
폰트를 추가할 때 대부분의 글꼴이 저작권에 보호받고 있음을 기억하십시오. 먼저 글꼴 라이선스를 확인하고 다른 컴퓨터로 자유롭게 이전할 수 있는지 확인하십시오. |
...
제공된 [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) 정보를 사용하여 프레젠테이션에서 글꼴을 교체합니다
...
컬렉션 [IFontSubstRule](../../com.aspose.slides/ifontsubstrule)에 제공된 정보를 사용하여 프레젠테이션에서 글꼴을 교체합니다
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| fontData | [IFontData](../../com.aspose.slides/ifontdata) | 글꼴에 대한 정보를 포함하는 글꼴 데이터 객체 [IFontData](../../com.aspose.slides/ifontdata). |
| fontStyle | int | 데이터를 가져올 글꼴 스타일 [FontStyleType](../../com.aspose.slides/fontstyletype). |

**반환값:**
byte[] - 지정된 글꼴 스타일에 대한 글꼴 데이터를 포함하는 바이트 배열. 글꼴 데이터나 스타일을 찾을 수 없으면 null을 반환합니다.
...
주어진 바이트 배열과 글꼴 이름을 사용하여 글꼴의 임베딩 레벨을 판단합니다.
