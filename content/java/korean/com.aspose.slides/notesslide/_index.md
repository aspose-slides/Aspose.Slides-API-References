...
| [getNotesTextFrame()](#getNotesTextFrame--) | 노트 텍스트가 있는 경우 해당 텍스트가 포함된 TextFrame을 반환합니다. |
| [getThemeManager()](#getThemeManager--) | 재정의된 테마 관리자를 반환합니다. |
...
노트 텍스트가 있는 경우 해당 텍스트가 포함된 TextFrame을 반환합니다. 읽기 전용 [ITextFrame](../../com.aspose.slides/itextframe).
...
재정의된 테마 관리자를 반환합니다. 읽기 전용 [IOverrideThemeManager](../../com.aspose.slides/ioverridethememanager).
