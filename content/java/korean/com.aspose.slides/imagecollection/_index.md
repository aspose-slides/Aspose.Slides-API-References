...
| Method | Description |
| --- | --- |
| [size()](#size--) | 컬렉션에 있는 이미지 수를 반환합니다. |
...
컬렉션에 있는 이미지 수를 반환합니다. 읽기 전용  int .
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| imageSource | [IPPImage](../../com.aspose.slides/ippimage) | 원본 이미지. |
...
**반환:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IPPImage> - 컬렉션을 반복하는 데 사용할 수 있는 IGenericEnumerator
