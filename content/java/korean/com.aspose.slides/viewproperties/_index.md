...
| [getSlideViewProperties()](#getSlideViewProperties--) | 슬라이드 보기 모드와 관련된 공통 보기 속성을 지정합니다. |
| [getNotesViewProperties()](#getNotesViewProperties--) | 노트 보기 모드와 관련된 공통 보기 속성을 지정합니다. |
| [getGridSpacing()](#getGridSpacing--) | 프레젠테이션 문서에 기반한 그리드의 간격을 포인트 단위로 반환하거나 설정합니다. |
| [setGridSpacing(float value)](#setGridSpacing-float-) | 프레젠테이션 문서에 기반한 그리드의 간격을 포인트 단위로 반환하거나 설정합니다. |
...
일반 보기 속성을 나타냅니다. 일반 보기는 슬라이드 자체, 측면 콘텐츠 영역, 하단 콘텐츠 영역의 세 가지 콘텐츠 영역으로 구성됩니다. 읽기 전용 [INormalViewProperties](../../com.aspose.slides/inormalviewproperties).
...
슬라이드 보기 모드와 관련된 공통 보기 속성을 지정합니다. 읽기 전용 [ICommonSlideViewProperties](../../com.aspose.slides/icommonslideviewproperties).
...
노트 보기 모드와 관련된 공통 보기 속성을 지정합니다. 읽기 전용 [ICommonSlideViewProperties](../../com.aspose.slides/icommonslideviewproperties).
...
프레젠테이션 문서에 기반한 그리드의 간격을 포인트 단위로 반환하거나 설정합니다. 읽기/쓰기 float.
