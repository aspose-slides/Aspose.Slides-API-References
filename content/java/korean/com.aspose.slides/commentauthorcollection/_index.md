...
| [toArray()](#toArray--) | 모든 작성자를 포함하는 배열을 생성하고 반환합니다. |
...
| [remove(ICommentAuthor author)](#remove-com.aspose.slides.ICommentAuthor-) | 컬렉션에서 지정된 작성자의 첫 번째 항목을 제거합니다. |
