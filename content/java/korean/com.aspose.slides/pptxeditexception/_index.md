...
type: docs
url: /ko/com.aspose.slides/pptxeditexception/
---
**상속:**
...
| 생성자 | 설명 |
| --- | --- |
| [PptxEditException()](#PptxEditException--) | 기본 생성자. |
| [PptxEditException(String message)](#PptxEditException-java.lang.String-) | 예외에 메시지를 추가할 수 있는 생성자. |
| [PptxEditException(String message, RuntimeException exception)](#PptxEditException-java.lang.String-java.lang.RuntimeException-) | 메시지와 포함된 예외를 갖는 예외에 대한 생성자. |
