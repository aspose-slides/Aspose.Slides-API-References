...
| [getTo()](#getTo--) | 애니메이션의 끝 값을 지정합니다. |
| [setTo(String value)](#setTo-java.lang.String-) | 애니메이션의 끝 값을 지정합니다. |
...
| [getCalcMode()](#getCalcMode--) | 애니메이션 보간 모드를 지정합니다. 읽기/쓰기 [PropertyCalcModeType](../../com.aspose.slides/propertycalcmodetype). |
| [setCalcMode(int value)](#setCalcMode-int-) | 애니메이션 보간 모드를 지정합니다. 읽기/쓰기 [PropertyCalcModeType](../../com.aspose.slides/propertycalcmodetype). |
...
애니메이션의 끝 값을 지정합니다. 읽기/쓰기 String.
...
애니메이션 보간 모드를 지정합니다. 읽기/쓰기 [PropertyCalcModeType](../../com.aspose.slides/propertycalcmodetype).
