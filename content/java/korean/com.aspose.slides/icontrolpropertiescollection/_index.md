...
| 메서드 | 설명 |
| --- | --- |
| [getCount()](#getCount--) | 컬렉션에 있는 속성 수를 반환합니다. |
...
| [getNamesOfProperties()](#getNamesOfProperties--) | 컬렉션에 있는 속성 수를 반환합니다. |
...
| value | java.lang.String | 속성의 값입니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| name | java.lang.String | 제거할 속성의 이름입니다. |
...
컬렉션에 있는 속성 수를 반환합니다. 읽기 전용 [IGenericCollection](../../com.aspose.slides/igenericcollection).
