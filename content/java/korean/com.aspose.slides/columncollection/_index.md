...
| [removeAt(int firstColumnIndex, boolean withAttachedRows)](#removeAt-int-boolean-) | 테이블에서 지정된 위치의 열을 제거합니다. |
...
| withAttachedColumns | boolean | True를 지정하면 템플릿 행에 연결된 모든 열도 복사합니다. |
...
| withAttachedRows | boolean | True를 지정하면 연결된 모든 열도 삭제합니다. |
...
**반환:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IColumn> - 컬렉션을 순회하는 데 사용할 수 있는 IGenericEnumerator.
