...
description: pptx 프레젠테이션 문서에 저장될 수 있는 문자열 또는 실수 값을 두 가지 방식으로 나타냅니다 1) 차트와 관련된 워크북의 셀/셀에, 2) 리터럴 값으로.
type: docs
...
pptx 프레젠테이션 문서에 저장될 수 있는 문자열 또는 실수 값을 두 가지 방법으로 나타냅니다: 1) 차트와 관련된 워크북의 셀/셀에; 2) 리터럴 값으로.
