...
이 인터페이스는 [IFillFormat](../../com.aspose.slides/ifillformat) 인터페이스와 함께 사용되어 상속이 적용된 효과적인 서식 값을 반환합니다.
...
| [getSolidFillSchemeColor()](#getSolidFillSchemeColor--) | 색 구성표에 의해 정의된 채우기 색상을 가져옵니다. |
...
| [getRotateWithShape()](#getRotateWithShape--) | 채우기가 도형과 함께 회전되어야 하는지 여부를 판단합니다. |
...
채우기 색상을 반환합니다. 읽기 전용 java.awt.Color.
...
색 구성표에 의해 정의된 채우기 색상을 가져옵니다. [SchemeColor.NotDefined](../../com.aspose.slides/schemecolor\#NotDefined) 값은 SolidFillColor (\#getSolidFillColor.getSolidFillColor)가 색 구성표 색상이 아님을 나타냅니다. 읽기 전용 [SchemeColor](../../com.aspose.slides/schemecolor).
...
채우기가 도형과 함께 회전되어야 하는지 여부를 판단합니다. 읽기 전용 boolean.
