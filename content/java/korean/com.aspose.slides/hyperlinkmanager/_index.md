...
| [setExternalHyperlinkMouseOver(String url)](#setExternalHyperlinkMouseOver-java.lang.String-) | 마우스를 올렸을 때 외부 하이퍼링크를 설정합니다. |
| [setInternalHyperlinkMouseOver(ISlide targetSlide)](#setInternalHyperlinkMouseOver-com.aspose.slides.ISlide-) | 마우스를 올렸을 때 내부 하이퍼링크를 설정합니다. |
...
>      // 타입이 Rectangle으로 설정된 AutoShape 객체를 추가합니다.
>      IShape pptxShape = slide.getShapes().addAutoShape(ShapeType.Rectangle, 150, 150, 150, 50);
>      // shape을 AutoShape으로 형변환합니다.
