...
description: MathParagraph 내에 포함되고 자체 라인에서 시작되는 수학 텍스트 인스턴스를 지정합니다.
type: docs
...
수학 텍스트 인스턴스를 지정하며, MathParagraph 내부에 포함되고 자체 라인에서 시작합니다. 방정식, 표현식, 방정식 또는 표현식 배열, 그리고 수식 등 모든 수학 영역은 MathBlock으로 표시됩니다.
...
| [MathBlock(IMathElement mathElement)](#MathBlock-com.aspose.slides.IMathElement-) | 새 수학 블록을 만들고 지정된 요소를 그 안에 넣습니다 |
| [MathBlock(System.Collections.Generic.IGenericEnumerable<IMathElement> mathElements)](#MathBlock-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.slides.IMathElement--) | 새 수학 블록을 만들고 지정된 요소들을 그 안에 넣습니다 |
## 메서드

| Method | Description |
| --- | --- |
| [getCount()](#getCount--) | 컬렉션에 실제로 포함된 하위 수학 요소의 개수를 가져옵니다. |
...
| [isReadOnly()](#isReadOnly--) | 하위 요소 컬렉션을 수정할 수 있으므로 false를 반환합니다. |
| [getChildren()](#getChildren--) | 하위 요소를 가져옵니다 |
| [getParent_Immediate()](#getParent-Immediate--) | Parent_Immediate 객체를 반환합니다. |
| [add(IMathElement item)](#add-com.aspose.slides.IMathElement-) | 수학 요소를 컬렉션 끝에 추가합니다. |
...
| [join(IMathElement mathElement)](#join-com.aspose.slides.IMathElement-) | 수학 요소를 이 수학 블록에 연결합니다 |
| [join(String mathText)](#join-java.lang.String-) | 수학 텍스트를 이 수학 블록에 연결합니다 |
| [joinBlock(IMathBlock other)](#joinBlock-com.aspose.slides.IMathBlock-) | 다른 수학 블록을 이 블록에 연결합니다 |
| [delimit(char separatorCharacter)](#delimit-char-) | 괄호 없이 구분 문자로 하위 요소들을 구분합니다 |
| [enclose(char beginningCharacter, char endingCharacter)](#enclose-char-char-) | 괄호와 같은 지정된 문자로 이 블록의 하위 요소들을 프레이밍합니다 |
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | 괄호와 같은 지정된 문자로 이 블록의 하위 요소들을 프레이밍하고 구분 문자로 구분합니다 |
| [toMathArray()](#toMathArray--) | 하위 요소들을 수직 배열에 배치합니다 |
...
컬렉션에 실제로 포함된 하위 수학 요소의 개수를 가져옵니다. 읽기 전용 int.
...
하위 요소 컬렉션을 수정할 수 있으므로 false를 반환합니다.
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | 컬렉션 끝에 추가할 IMathElement. |
...
**반환값:**
boolean - 컬렉션에서 항목이 발견되면 true, 그렇지 않으면 false.
...
**반환값:**
boolean - 항목이 컬렉션에서 성공적으로 제거되면 true, 그렇지 않으면 false. 항목이 원래 컬렉션에 없으면 이 메서드도 false를 반환합니다.
### iterator() {#iterator--}
```
...
**반환값:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IMathElement> - 컬렉션을 순회하는 데 사용할 수 있는 IGenericEnumerator.
...
**반환값:**
int - 컬렉션에서 항목이 발견되면 그 인덱스, 없으면 -1.
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| other | [IMathBlock](../../com.aspose.slides/imathblock) | 연결할 블록. |

**반환값:**
[IMathBlock](../../com.aspose.slides/imathblock) - 연결 후 이 수학 블록.
...
괄호와 같은 지정된 문자로 이 블록의 하위 요소들을 프레이밍합니다.
...
**반환값:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - [IMathDelimiter](../../com.aspose.slides/imathdelimiter) 유형의 수학 요소(지정된 문자를 프레이밍에 포함).
...
괄호와 같은 지정된 문자로 이 블록의 하위 요소들을 프레이밍하고 구분 문자로 구분합니다.
...
**반환값:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - [IMathDelimiter](../../com.aspose.slides/imathdelimiter) 유형의 수학 요소(지정된 문자를 프레이밍 및 구분자로 포함).
