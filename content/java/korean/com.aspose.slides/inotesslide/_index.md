...
| [getNotesTextFrame()](#getNotesTextFrame--) | 노트가 있을 경우 해당 텍스트가 포함된 TextFrame을 반환합니다. |
...
노트가 있을 경우 해당 텍스트가 포함된 TextFrame을 반환합니다. 읽기 전용 [ITextFrame](../../com.aspose.slides/itextframe).
