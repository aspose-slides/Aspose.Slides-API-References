...
type: docs
url: /ko/com.aspose.slides/ifontsubstrulecollection/
---
**모든 구현된 인터페이스:**
...
| [add(IFontSubstRule value)](#add-com.aspose.slides.IFontSubstRule-) | 새 글꼴 대체 규칙을 컬렉션에 추가합니다. |
| [remove(IFontSubstRule value)](#remove-com.aspose.slides.IFontSubstRule-) | 컬렉션에서 특정 객체의 첫 번째 항목을 제거합니다. |
...
새 글꼴 대체 규칙을 컬렉션에 추가합니다.

**매개변수:**
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) | 글꼴 대체 규칙 [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) | 컬렉션에서 제거할 모듈. |