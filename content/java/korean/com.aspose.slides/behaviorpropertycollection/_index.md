...
| [indexOf(IBehaviorProperty item)](#indexOf-com.aspose.slides.IBehaviorProperty-) | List에서 특정 항목의 인덱스를 확인합니다. |
| [indexOf(String propertyValue)](#indexOf-java.lang.String-) | List에서 속성 값으로 특정 항목의 인덱스를 확인합니다. |
| [insert(int index, IBehaviorProperty item)](#insert-int-com.aspose.slides.IBehaviorProperty-) | 지정된 인덱스에 새 속성을 삽입합니다. |
| [insert(int index, String propertyValue)](#insert-int-java.lang.String-) | 지정된 속성 값을 사용하여 지정된 인덱스에 새 속성을 삽입합니다. |
| [copyTo(IBehaviorProperty[] array, int arrayIndex)](#copyTo-com.aspose.slides.IBehaviorProperty---int-) | [IGenericCollection](../../com.aspose.slides/igenericcollection)의 요소를 배열에 복사하며, 특정 배열 인덱스부터 시작합니다. |
| [remove(IBehaviorProperty item)](#remove-com.aspose.slides.IBehaviorProperty-) | 지정된 속성을 컬렉션에서 제거합니다. |
| [remove(String propertyValue)](#remove-java.lang.String-) | 지정된 속성을 컬렉션에서 제거합니다. |
| [removeAt(int index)](#removeAt-int-) | 지정된 인덱스의 속성을 제거합니다. |
| [clear()](#clear--) | 컬렉션의 모든 속성을 제거합니다. |
| [contains(IBehaviorProperty item)](#contains-com.aspose.slides.IBehaviorProperty-) | [IGenericCollection](../../com.aspose.slides/igenericcollection)에 특정 값이 포함되어 있는지 확인합니다. |
| [contains(String propertyValue)](#contains-java.lang.String-) | [IGenericCollection](../../com.aspose.slides/igenericcollection)에 특정 값이 포함되어 있는지 확인합니다. |
| [get_Item(int index)](#get-Item-int-) | 지정된 인덱스의 속성을 반환합니다. |
...
List에서 특정 항목의 인덱스를 확인합니다.

**매개변수:**
| 매개변수 | 타입 | 설명 |
| --- | --- | --- |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | List에서 찾을 객체. |

**반환값:**  
int - 리스트에서 항목을 찾은 경우 해당 인덱스; 찾지 못하면 -1.
...
List에서 속성 값으로 특정 항목의 인덱스를 확인합니다.
...
지정된 인덱스에 새 속성을 삽입합니다.

**매개변수:**
| 매개변수 | 타입 | 설명 |
| --- | --- | --- |
| index | int | 새 속성이 삽입될 인덱스. |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | 추가할 속성. |
...
지정된 속성 값을 사용하여 지정된 인덱스에 새 속성을 삽입합니다.
...
| 매개변수 | 타입 | 설명 |
| --- | --- | --- |
| array | [IBehaviorProperty\[\]](../../com.aspose.slides/ibehaviorproperty) | [IGenericCollection](../../com.aspose.slides/igenericcollection)에서 복사된 요소들의 대상이 되는 1차원 배열입니다. 배열은 0부터 시작하는 인덱스를 가져야 합니다. |
...
| 매개변수 | 타입 | 설명 |
| --- | --- | --- |
| propertyValue | java.lang.String | [IGenericCollection](../../com.aspose.slides/igenericcollection)에서 찾을 속성의 값. |
