...
| [add(IParagraph value)](#add-com.aspose.slides.IParagraph-) | Paragraph를 컬렉션 끝에 추가합니다. |
| [add(IParagraphCollection value)](#add-com.aspose.slides.IParagraphCollection-) | ParagraphCollection의 내용을 컬렉션 끝에 추가합니다. |
...
| [remove(IParagraph item)](#remove-com.aspose.slides.IParagraph-) | 특정 paragraph의 첫 번째 발생을 제거합니다. |
...
| [exportToHtml(int firstParagraphIndex, int paragraphsCount, ITextToHtmlConversionOptions options)](#exportToHtml-int-int-com.aspose.slides.ITextToHtmlConversionOptions-) | 지정된 paragraph를 HTML로 변환하고 String 객체로 반환합니다. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| index | int | Paragraph를 삽입할 0 기반 인덱스입니다. |
| value | [IParagraph](../../com.aspose.slides/iparagraph) | 삽입할 Paragraph입니다. |
...
| --- | --- | --- |
| index | int | paragraph를 삽입할 0 기반 인덱스입니다. |
| value | [IParagraphCollection](../../com.aspose.slides/iparagraphcollection) | 삽입할 paragraph들입니다. |
...
특정 paragraph의 첫 번째 발생을 제거합니다.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| item | [IParagraph](../../com.aspose.slides/iparagraph) | 컬렉션에서 제거할 paragraph입니다. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| text | java.lang.String | HTML 텍스트입니다. |
...
| --- | --- | --- |
| text | java.lang.String | HTML 텍스트입니다. |
| resolver | [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver) | URI를 해결하고 참조된 객체를 가져오는 Resolver 콜백 객체입니다. |
...
지정된 paragraph를 HTML로 변환하고 String 객체로 반환합니다.

**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| firstParagraphIndex | int | 첫 번째 paragraph 인덱스 |
| paragraphsCount | int | paragraph 개수 |
