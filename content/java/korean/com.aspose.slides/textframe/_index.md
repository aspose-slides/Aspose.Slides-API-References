...
| [getTextFrameFormat()](#getTextFrameFormat--) | 이 TextFrame 객체의 서식 객체를 반환합니다. |
| [getHyperlinkQueries()](#getHyperlinkQueries--) | 포함된 하이퍼링크에 쉽게 접근할 수 있습니다. |
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | 모든 단락에서 동일한 서식의 실행을 결합합니다. |
| [highlightText(String text, Color highlightColor)](#highlightText-java.lang.String-java.awt.Color-) | 지정된 색상으로 샘플 텍스트와 일치하는 모든 항목을 강조 표시합니다. |
| [highlightText(String text, Color highlightColor, ITextHighlightingOptions options)](#highlightText-java.lang.String-java.awt.Color-com.aspose.slides.ITextHighlightingOptions-) | 지정된 색상으로 샘플 텍스트와 일치하는 모든 항목을 강조 표시합니다. |
...
| [highlightText(String text, Color highlightColor, ITextSearchOptions options, IFindResultCallback callback)](#highlightText-java.lang.String-java.awt.Color-com.aspose.slides.ITextSearchOptions-com.aspose.slides.IFindResultCallback-) | 지정된 색상으로 샘플 텍스트와 일치하는 모든 항목을 강조 표시합니다. |
| [highlightRegex(String regex, Color highlightColor, ITextHighlightingOptions options)](#highlightRegex-java.lang.String-java.awt.Color-com.aspose.slides.ITextHighlightingOptions-) | 지정된 색상으로 정규식과 일치하는 모든 항목을 강조 표시합니다. |
| [highlightRegex(Pattern regex, Color highlightColor, IFindResultCallback callback)](#highlightRegex-java.util.regex.Pattern-java.awt.Color-com.aspose.slides.IFindResultCallback-) | 지정된 색상으로 정규식과 일치하는 모든 항목을 강조 표시합니다. |
...
| [getSlide()](#getSlide--) | TextFrame의 상위 슬라이드를 반환합니다. |
| [getPresentation()](#getPresentation--) | TextFrame의 상위 프레젠테이션을 반환합니다. |
| [getParentShape()](#getParentShape--) | 부모 객체가 IShape 인터페이스를 구현하지 않으면 부모 도형을 반환하거나 null을 반환합니다. 읽기 전용 [IShape](../../com.aspose.slides/ishape). |
| [getParentCell()](#getParentCell--) | 부모 객체가 ICell 인터페이스를 구현하지 않으면 부모 셀을 반환하거나 null을 반환합니다. |
...
이 TextFrame 객체의 서식 객체를 반환합니다. 읽기 전용 [ITextFrameFormat](../../com.aspose.slides/itextframeformat).
...
포함된 하이퍼링크에 쉽게 접근할 수 있습니다. 읽기 전용 [IHyperlinkQueries](../../com.aspose.slides/ihyperlinkqueries).
...
텍스트 프레임에 여러 열이 포함되지 않은 경우, 반환된 배열은 전체 텍스트를 포함하는 단일 요소를 갖습니다. 빈 열은 배열에서 빈 문자열로 표시됩니다.
...
지정된 색상으로 정규식과 일치하는 모든 항목을 강조 표시합니다.
...
| options | [ITextSearchOptions](../../com.aspose.slides/itextsearchoptions) | 텍스트 검색 옵션 [ITextSearchOptions](../../com.aspose.slides/itextsearchoptions). |
| callback | [IFindResultCallback](../../com.aspose.slides/ifindresultcallback) | 교체 작업 결과 저장을 위한 콜백 객체 [IFindResultCallback](../../com.aspose.slides/ifindresultcallback). |
...
> ```
> 지정된 문자열을 사용하여 정규식을 이용해 텍스트를 교체하는 샘플 코드입니다.
>  
>  Presentation presentation = new Presentation("SomePresentation.pptx");
>  try {
>      Pattern regex = Pattern.compile("\\b[^\\s]{5,}\\b");
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| regex | java.util.regex.Pattern | 교체될 문자열을 얻기 위한 정규식 java.util.regex.Pattern. |
...
TextFrame의 상위 슬라이드를 반환합니다. 읽기 전용 [IBaseSlide](../../com.aspose.slides/ibaseslide).
...
TextFrame의 상위 프레젠테이션을 반환합니다. 읽기 전용 [IPresentation](../../com.aspose.slides/ipresentation).
...
부모 객체가 IShape 인터페이스를 구현하지 않으면 부모 도형을 반환하거나 null을 반환합니다. 읽기 전용 [IShape](../../com.aspose.slides/ishape).
...
부모 객체가 ICell 인터페이스를 구현하지 않으면 부모 셀을 반환하거나 null을 반환합니다. 읽기 전용 [ICell](../../com.aspose.slides/icell).
