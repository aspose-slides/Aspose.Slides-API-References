...
| [getApplicationTemplate()](#getApplicationTemplate--) | 앱의 템플릿을 반환하거나 설정합니다. |
| [setApplicationTemplate(String value)](#setApplicationTemplate-java.lang.String-) | 앱의 템플릿을 반환하거나 설정합니다. |
...
| [getComments()](#getComments--) | 프레젠테이션의 댓글을 반환하거나 설정합니다. |
| [setComments(String value)](#setComments-java.lang.String-) | 프레젠테이션의 댓글을 반환하거나 설정합니다. |
...
| [getRevisionNumber()](#getRevisionNumber--) | 프레젠테이션 리비전 번호를 반환하거나 설정합니다. |
| [setRevisionNumber(int value)](#setRevisionNumber-int-) | 프레젠테이션 리비전 번호를 반환하거나 설정합니다. |
...
| [setCustomPropertyValue(String name, boolean value)](#setCustomPropertyValue-java.lang.String-boolean-) | 명명된 boolean 사용자 정의 속성을 설정합니다. |
| [setCustomPropertyValue(String name, int value)](#setCustomPropertyValue-java.lang.String-int-) | 명명된 integer 사용자 정의 속성을 설정합니다. |
| [setCustomPropertyValue(String name, Date value)](#setCustomPropertyValue-java.lang.String-java.util.Date-) | 명명된 DateTime 사용자 정의 속성을 설정합니다. |
| [setCustomPropertyValue(String name, String value)](#setCustomPropertyValue-java.lang.String-java.lang.String-) | 명명된 string 사용자 정의 속성을 설정합니다. |
| [setCustomPropertyValue(String name, float value)](#setCustomPropertyValue-java.lang.String-float-) | 명명된 float 사용자 정의 속성을 설정합니다. |
| [setCustomPropertyValue(String name, double value)](#setCustomPropertyValue-java.lang.String-double-) | 명명된 double 사용자 정의 속성을 설정합니다. |
...
| [clearBuiltInProperties()](#clearBuiltInProperties--) | 모든 builtIn 속성을 지우고 기본값을 설정합니다. |
...
| [getHyperlinksChanged()](#getHyperlinksChanged--) | 제작자에 의해 이 파트에서만 하나 이상의 하이퍼링크가 업데이트되었음을 지정합니다. |
| [setHyperlinksChanged(boolean value)](#setHyperlinksChanged-boolean-) | 제작자에 의해 이 파트에서만 하나 이상의 하이퍼링크가 업데이트되었음을 지정합니다. |
| [getSlides()](#getSlides--) | 프레젠테이션 문서의 총 슬라이드 수를 반환합니다. |
| [getHiddenSlides()](#getHiddenSlides--) | 프레젠테이션 문서의 숨겨진 슬라이드 수를 반환합니다. |
| [getNotes()](#getNotes--) | 노트를 포함한 프레젠테이션의 슬라이드 수를 반환합니다. |
| [getParagraphs()](#getParagraphs--) | 해당되는 경우 문서에서 발견된 총 단락 수를 반환합니다. |
| [getWords()](#getWords--) | 문서에 포함된 총 단어 수를 반환합니다. |
| [getMultimediaClips()](#getMultimediaClips--) | 문서에 존재하는 사운드 또는 비디오 클립의 총 수를 반환합니다. |
...
앱의 템플릿을 반환하거나 설정합니다. 읽기/쓰기 String.
...
프레젠테이션의 댓글을 반환하거나 설정합니다. 읽기/쓰기 String.
...
프레젠테이션이 마지막으로 수정된 날짜를 반환합니다. 값은 UTC 기준입니다. Presentation.DocumentProperties의 경우 읽기 전용입니다( IPresentation 객체 저장 과정에서 내부적으로 업데이트됩니다). [IPresentationInfo.readDocumentProperties](../../com.aspose.slides/ipresentationinfo\#readDocumentProperties) 메서드가 반환하는 DocumentProperties 인스턴스를 통해 변경할 수 있습니다. [IPresentationInfo.updateDocumentProperties(IDocumentProperties)](../../com.aspose.slides/ipresentationinfo\#updateDocumentProperties-IDocumentProperties-) 메서드 요약의 예제를 참조하십시오.
...
프레젠테이션의 개정 번호를 반환하거나 설정합니다. 읽기/쓰기 int.
...
컬렉션에 실제로 포함된 사용자 정의 속성의 개수를 반환합니다. 읽기 전용 int.
...
| 매개변수 | 타입 | 설명 |
| --- | --- | --- |
| index | int | 가져올 사용자 정의 속성의 0부터 시작하는 인덱스. |
...
사용자 정의 문서 속성에서 민감도 레이블 배열을 가져옵니다 (Microsoft Information Protection SDK 메타데이터).
...
>      {
>          // 레이블을 컬렉션에 추가합니다
>          // 여기서 레이블 정보의 유효성을 확인하는 검사(레벨이 사용 가능한지 등)를 추가할 수 있습니다
...
모든 builtIn 속성을 기본값으로 초기화하고 설정합니다.
...
문서 썸네일의 표시 모드를 나타냅니다. 이 요소를 **true** 로 설정하면 썸네일이 디스플레이에 맞게 확대됩니다. **false** 로 설정하면 썸네일이 디스플레이에 맞는 섹션만 표시하도록 자릅니다. 읽기/쓰기 boolean.
...
문서의 하이퍼링크가 최신 상태인지 여부를 나타냅니다. 이 요소를 **true** 로 설정하면 하이퍼링크가 업데이트된 것으로 표시됩니다. **false** 로 설정하면 하이퍼링크가 오래된 것으로 표시됩니다. 읽기/쓰기 boolean.
...
```
Indicates whether hyperlinks in a document are up-to-date. Set this element to **true** to indicate that hyperlinks are updated. Set this element to **false** to indicate that hyperlinks are outdated. 읽기/쓰기 boolean.
...
Specifies that one or more hyperlinks in this part were updated exclusively in this part by a producer. The next producer to open this document shall update the hyperlink relationships with the new hyperlinks specified in this part. 읽기/쓰기 boolean.
...
Returns the total number of slides in a presentation document. 읽기 전용 int.
...
Returns the number of hidden slides in a presentation document. 읽기 전용 int.
...
Returns the number of slides in a presentation containing notes. 읽기 전용 int.
...
Returns the total number of paragraphs found in a document if applicable. 읽기 전용 int.
...
Returns the total number of words contained in a document. 읽기 전용 int.
...
Returns the total number of sound or video clips that are present in the document. 읽기 전용 int.
...
Specifies the title of each document part. These parts are not document parts but conceptual representations of document sections. 읽기 전용 String[].
...
Indicates the grouping of document parts and the number of parts in each group. 읽기 전용 IHeadingPair[].
