...
| [getColumnFormat()](#getColumnFormat--) | 이 열에 대한 서식 속성을 포함하는 ColumnFormat 개체를 반환합니다. |
### getWidth() {#getWidth--}
```
...
이 열에 대한 서식 속성을 포함하는 ColumnFormat 개체를 반환합니다. 읽기 전용 [IColumnFormat](../../com.aspose.slides/icolumnformat).
