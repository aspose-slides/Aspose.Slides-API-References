...
지정된 위치에 있는 요소를 반환합니다. 읽기 전용 [EffectStyle](../../com.aspose.slides/effectstyle).
...
**반환값:**
[IEffectStyle](../../com.aspose.slides/ieffectstyle) - 지정된 위치에 있는 요소.
### iterator() {#iterator--}
```
...
**반환값:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffectStyle> - 컬렉션을 순회하는 데 사용할 수 있는 IGenericEnumerator.
...
컬렉션에 포함된 요소 수를 반환합니다. 읽기 전용 int, 읽기 전용 int.
...
컬렉션에 대한 접근이 동기화(스레드 안전) 되었는지 여부를 나타내는 값을 반환합니다. 읽기 전용 boolean.
