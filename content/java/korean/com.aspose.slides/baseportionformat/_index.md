...
| [getHighlightColor()](#getHighlightColor--) | 텍스트를 강조 표시하는 색상을 반환합니다. |
| [getUnderlineLineFormat()](#getUnderlineLineFormat--) | 밑줄 라인의 윤곽선에 사용되는 LineFormat 속성을 반환합니다. |
...
| [getKumimoji()](#getKumimoji--) | 숫자가 텍스트 동아시아 언어 특정 수직 레이아웃을 무시해야 하는지 여부를 결정합니다. |
| [setKumimoji(byte value)](#setKumimoji-byte-) | 숫자가 텍스트 동아시아 언어 특정 수직 레이아웃을 무시해야 하는지 여부를 결정합니다. |
| [getNormaliseHeight()](#getNormaliseHeight--) | 텍스트 높이가 정규화되어야 하는지 여부를 결정합니다. |
| [setNormaliseHeight(byte value)](#setNormaliseHeight-byte-) | 텍스트 높이가 정규화되어야 하는지 여부를 결정합니다. |
| [getProofDisabled()](#getProofDisabled--) | 텍스트가 교정되지 않아야 하는지 여부를 결정합니다. |
| [setProofDisabled(byte value)](#setProofDisabled-byte-) | 텍스트가 교정되지 않아야 하는지 여부를 결정합니다. |
...
| [isHardUnderlineLine()](#isHardUnderlineLine--) | 밑줄 스타일이 자체 LineFormat 속성을 가지는지, 텍스트의 LineFormat 속성에서 상속되는지 결정합니다. |
| [setHardUnderlineLine(byte value)](#setHardUnderlineLine-byte-) | 밑줄 스타일이 자체 LineFormat 속성을 가지는지, 텍스트의 LineFormat 속성에서 상속되는지 결정합니다. |
| [isHardUnderlineFill()](#isHardUnderlineFill--) | 밑줄 스타일이 자체 FillFormat 속성을 가지는지, 텍스트의 FillFormat 속성에서 상속되는지 결정합니다. |
| [setHardUnderlineFill(byte value)](#setHardUnderlineFill-byte-) | 밑줄 스타일이 자체 FillFormat 속성을 가지는지, 텍스트의 FillFormat 속성에서 상속되는지 결정합니다. |
| [getFontHeight()](#getFontHeight--) | 텍스트 부분의 글꼴 높이를 반환하거나 설정합니다. |
| [setFontHeight(float value)](#setFontHeight-float-) | 텍스트 부분의 글꼴 높이를 반환하거나 설정합니다. |
...
| [getKerningMinimalSize()](#getKerningMinimalSize--) | 커닝이 켜져야 하는 최소 글꼴 크기를 반환하거나 설정합니다. |
| [setKerningMinimalSize(float value)](#setKerningMinimalSize-float-) | 커닝이 켜져야 하는 최소 글꼴 크기를 반환하거나 설정합니다. |
...
| [getSpacing()](#getSpacing--) | 문자 간 간격 증가량을 반환하거나 설정합니다. |
| [setSpacing(float value)](#setSpacing-float-) | 문자 간 간격 증가량을 반환하거나 설정합니다. |
| [getSpellCheck()](#getSpellCheck--) | 텍스트 부분에 대한 맞춤법 검사가 활성화되어 있는지 여부를 가져오거나 설정합니다. |
| [setSpellCheck(boolean value)](#setSpellCheck-boolean-) | 텍스트 부분에 대한 맞춤법 검사가 활성화되어 있는지 여부를 가져오고 설정합니다. |
### getVersion() {#getVersion--}
```
...
텍스트를 강조 표시하는 색상을 반환합니다. 상속이 적용되지 않습니다. 읽기 전용 [IColorFormat](../../com.aspose.slides/icolorformat).
...
밑줄 라인의 윤곽선에 사용되는 LineFormat 속성을 반환합니다. 상속이 적용되지 않습니다. 읽기 전용 [ILineFormat](../../com.aspose.slides/ilineformat).
...
숫자가 텍스트 동아시아 언어 특정 수직 레이아웃을 무시해야 하는지 여부를 결정합니다. 상속이 적용되지 않습니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
...
텍스트 높이가 정규화되어야 하는지 여부를 결정합니다. 상속이 적용되지 않습니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
...
텍스트가 교정되지 않아야 하는지 여부를 결정합니다. 상속이 적용되지 않습니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
...
밑줄 스타일이 자체 LineFormat 속성을 가지는지, 텍스트의 LineFormat 속성에서 상속되는지 결정합니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
...
밑줄 스타일이 자체 FillFormat 속성을 가지는지, 텍스트의 FillFormat 속성에서 상속되는지 결정합니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
...
텍스트 부분의 글꼴 높이를 반환하거나 설정합니다. **Float.NaN** 은 높이가 정의되지 않았으며 마스터에서 상속되어야 함을 의미합니다. 읽기/쓰기 float .
...
라틴 글꼴 정보를 반환하거나 설정합니다. Null 은 글꼴이 정의되지 않았으며 마스터에서 상속되어야 함을 의미합니다. 읽기/쓰기 [IFontData](../../com.aspose.slides/ifontdata).
...
동아시아 글꼴 정보를 반환하거나 설정합니다. Null 은 글꼴이 정의되지 않았으며 마스터에서 상속되어야 함을 의미합니다. 읽기/쓰기 [IFontData](../../com.aspose.slides/ifontdata).
...
복합 스크립트 글꼴 정보를 반환하거나 설정합니다. Null 은 글꼴이 정의되지 않았으며 마스터에서 상속되어야 함을 의미합니다. 읽기/쓰기 [IFontData](../../com.aspose.slides/ifontdata).
...
기호 글꼴 정보를 반환하거나 설정합니다. Null 은 글꼴이 정의되지 않았으며 마스터에서 상속되어야 함을 의미합니다. 읽기/쓰기 [IFontData](../../com.aspose.slides/ifontdata).
...
위첨자 또는 아래첨자 텍스트를 반환하거나 설정합니다. 값은 -100% (아래첨자)에서 100% (위첨자)까지입니다. **Float.NaN** 은 값이 정의되지 않았으며 마스터에서 상속되어야 함을 의미합니다. 읽기/쓰기 float .
...
커닝이 켜져야 하는 최소 글꼴 크기를 반환하거나 설정합니다. **Float.NaN** 은 값이 정의되지 않았으며 마스터에서 상속되어야 함을 의미합니다. 읽기/쓰기 float .
...
문자 간 간격 증가량을 반환하거나 설정합니다. **Float.NaN** 은 값이 정의되지 않았으며 마스터에서 상속되어야 함을 의미합니다. 읽기/쓰기 float .
...
텍스트 부분에 대한 맞춤법 검사가 활성화되어 있는지 여부를 가져오거나 설정합니다. 이 속성이 false 로 설정되면 텍스트 요소에 대한 맞춤법 검사가 억제됩니다. true 로 설정하면 맞춤법 검사가 허용됩니다. 기본값은 false 입니다.
