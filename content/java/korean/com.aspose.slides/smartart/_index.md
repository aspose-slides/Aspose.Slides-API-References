...
description: 스마트아트 다이어그램을 나타냅니다
type: docs
...
| [isReversed()](#isReversed--) | 다이어그램이 반전 기능을 지원하는 경우, SmartArt 다이어그램의 상태를 (왼쪽에서 오른쪽) LTR 또는 (오른쪽에서 왼쪽) RTL에 따라 반환하거나 설정합니다. |
| [setReversed(boolean value)](#setReversed-boolean-) | 다이어그램이 반전 기능을 지원하는 경우, SmartArt 다이어그램의 상태를 (왼쪽에서 오른쪽) LTR 또는 (오른쪽에서 왼쪽) RTL에 따라 반환하거나 설정합니다. |
...
다이어그램이 반전 기능을 지원하는 경우, SmartArt 다이어그램의 상태를 (왼쪽에서 오른쪽) LTR 또는 (오른쪽에서 왼쪽) RTL에 따라 반환하거나 설정합니다. 읽기/쓰기 boolean .
