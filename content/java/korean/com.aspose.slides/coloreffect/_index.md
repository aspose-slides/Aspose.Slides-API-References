...
구현된 모든 인터페이스: [com.aspose.slides.IColorEffect](../../com.aspose.slides/icoloreffect) ```
...
| [getDirection()](#getDirection--) | 색상 휠 주위에서 색조를 순환시킬 방향을 지정합니다. |
| [setDirection(int value)](#setDirection-int-) | 색상 휠 주위에서 색조를 순환시킬 방향을 지정합니다. |
...
색상 휠 주위에서 색조를 순환시킬 방향을 지정합니다. 읽기/쓰기 [ColorDirection](../../com.aspose.slides/colordirection).
