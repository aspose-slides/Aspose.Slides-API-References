...
---
**Inheritance:** 상속: java.lang.Object, com.aspose.slides.DomObject
...
| [removeAt(int index)](#removeAt-int-) | 지정된 인덱스에 있는 민감도 레이블을 제거합니다. |
| [clear()](#clear--) | 컬렉션의 모든 요소를 제거합니다. |
| [iterator()](#iterator--) | 컬렉션을 순회하는 열거자를 반환합니다. |
| [getCount()](#getCount--) | 컬렉션의 요소 개수를 반환합니다. |
| [copyTo(ISensitivityLabel[] array, int index)](#copyTo-com.aspose.slides.ISensitivityLabel---int-) | 컬렉션의 모든 요소를 지정된 배열로 복사합니다. |
...
| isEnabled | boolean | 민감도 레이블이 활성화되어 있는지 나타내는 플래그. |
