...
description: 효과적인 라인 채우기 속성을 포함하는 불변 객체입니다.
type: docs
...
| [getSolidFillColor()](#getSolidFillColor--) | 단색 채우기의 색을 반환합니다. |
...
단색 채우기의 색을 반환합니다. 읽기 전용 java.awt.Color.
...
채우기가 도형과 함께 회전해야 하는지 여부를 결정합니다. 읽기 전용 boolean.
