...
| [getHideAtShowing()](#getHideAtShowing--) | AudioFrame이 숨겨져 있는지 여부를 확인합니다. |
| [setHideAtShowing(boolean value)](#setHideAtShowing-boolean-) | AudioFrame이 숨겨져 있는지 여부를 확인합니다. |
| [getPlayLoopMode()](#getPlayLoopMode--) | 오디오가 반복 재생되는지 여부를 확인합니다. |
| [setPlayLoopMode(boolean value)](#setPlayLoopMode-boolean-) | 오디오가 반복 재생되는지 여부를 확인합니다. |
| [getPlayAcrossSlides()](#getPlayAcrossSlides--) | 오디오가 슬라이드 전반에 걸쳐 재생되는지 여부를 확인합니다. |
| [setPlayAcrossSlides(boolean value)](#setPlayAcrossSlides-boolean-) | 오디오가 슬라이드 전반에 걸쳐 재생되는지 여부를 확인합니다. |
| [getRewindAudio()](#getRewindAudio--) | 오디오가 재생 후 자동으로 시작 지점으로 되감는지 여부를 확인합니다. |
| [setRewindAudio(boolean value)](#setRewindAudio-boolean-) | 오디오가 재생 후 자동으로 시작 지점으로 되감는지 여부를 확인합니다. |
| [getEmbedded()](#getEmbedded--) | 사운드가 프레젠테이션에 포함되어 있는지 여부를 확인합니다. |
| [getLinkPathLong()](#getLinkPathLong--) | AudioFrame에 연결된 오디오 파일의 이름을 반환하거나 설정합니다. |
| [setLinkPathLong(String value)](#setLinkPathLong-java.lang.String-) | AudioFrame에 연결된 오디오 파일의 이름을 반환하거나 설정합니다. |
...
| [getTrimFromStart()](#getTrimFromStart--) | 재생 중 미디어 시작 부분에서 제거할 시간 길이를 밀리초 단위로 지정합니다. |
| [setTrimFromStart(float value)](#setTrimFromStart-float-) | 재생 중 미디어 시작 부분에서 제거할 시간 길이를 밀리초 단위로 지정합니다. |
| [getTrimFromEnd()](#getTrimFromEnd--) | 재생 중 미디어 끝 부분에서 제거할 시간 길이를 밀리초 단위로 지정합니다. |
| [setTrimFromEnd(float value)](#setTrimFromEnd-float-) | 재생 중 미디어 끝 부분에서 제거할 시간 길이를 밀리초 단위로 지정합니다. |
...
AudioFrame이 숨겨져 있는지 여부를 확인합니다. 읽기/쓰기 boolean.
...
오디오가 반복 재생되는지 여부를 확인합니다. 읽기/쓰기 boolean.
...
오디오가 슬라이드 전반에 걸쳐 재생되는지 여부를 확인합니다. 읽기/쓰기 boolean.
...
>       // 오디오를 슬라이드 전체에 걸쳐 재생하도록 설정합니다
>       audioFrame.setPlayAcrossSlides(true);
>       // 오디오를 재생 후 자동으로 시작 위치로 되감도록 설정합니다
>       audioFrame.setRewindAudio(true);
...
오디오가 재생 후 자동으로 시작 지점으로 되감는지 여부를 확인합니다. 읽기/쓰기 boolean.
...
사운드가 프레젠테이션에 포함되어 있는지 여부를 확인합니다. 읽기 전용 boolean.
...
재생 중 미디어 시작 부분에서 제거할 시간 길이를 밀리초 단위로 지정합니다. 읽기/쓰기 float.
...
재생 중 미디어 끝 부분에서 제거할 시간 길이를 밀리초 단위로 지정합니다. 읽기/쓰기 float.
