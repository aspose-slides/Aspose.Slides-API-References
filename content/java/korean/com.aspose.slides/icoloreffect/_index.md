...
| [getDirection()](#getDirection--) | 색상 휠을 중심으로 색조를 순환시킬 방향을 지정합니다. |
| [setDirection(int value)](#setDirection-int-) | 색상 휠을 중심으로 색조를 순환시킬 방향을 지정합니다. |
### getFrom() {#getFrom--}
```
...
동작의 색상 공간을 나타냅니다. 읽기/쓰기 [ColorSpace](../../com.aspose.slides/colorspace)(\#getColorSpace.getColorSpace/\#setColorSpace(int).setColorSpace(int)).
...
색상 휠을 중심으로 색조를 순환시킬 방향을 지정합니다. 읽기/쓰기 [ColorDirection](../../com.aspose.slides/colordirection).
