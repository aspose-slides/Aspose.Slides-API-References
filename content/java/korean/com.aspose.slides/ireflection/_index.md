...
| [getFadeDirection()](#getFadeDirection--) | 반사 오프셋 방향을 지정합니다. |
| [setFadeDirection(float value)](#setFadeDirection-float-) | 반사 오프셋 방향을 지정합니다. |
...
| [setDirection(float value)](#setDirection-float-) | 반사의 방향. |
...
| [getRotateShadowWithShape()](#getRotateShadowWithShape--) | 형상이 회전된 경우 반사도 형상과 함께 회전해야 하는지 여부를 지정합니다. |
| [setRotateShadowWithShape(boolean value)](#setRotateShadowWithShape-boolean-) | 형상이 회전된 경우 반사도 형상과 함께 회전해야 하는지 여부를 지정합니다. |
...
반사 오프셋 방향을 지정합니다. (angle). 읽기/쓰기 float.
...
시작 반사 불투명도. (percents). 읽기/쓰기 float.
...
끝 반사 불투명도. (percents). 읽기/쓰기 float.
...
형상이 회전된 경우 반사도 형상과 함께 회전해야 하는지 여부를 지정합니다. 읽기/쓰기 boolean.
...
수평 스케일링 계수를 지정합니다. 음수 스케일링은 뒤집기를 일으킵니다. (percents) 읽기/쓰기 double.
...
수직 스케일링 계수를 지정합니다. 음수 스케일링은 뒤집기를 일으킵니다. (percents) 읽기/쓰기 double.
