...
| [add(IFontSubstRule value)](#add-com.aspose.slides.IFontSubstRule-) | 새로운 폰트 대체 규칙을 컬렉션에 추가합니다. |
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| value | [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) | 컬렉션에서 제거할 폰트 대체 규칙. |
