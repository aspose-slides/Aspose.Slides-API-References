...
| 메서드 | 설명 |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | 지정된 인덱스의 동작을 반환합니다. |
| [set_Item(int index, IBehavior value)](#set-Item-int-com.aspose.slides.IBehavior-) | 지정된 인덱스의 동작을 반환합니다. |
...
| [removeAt(int index)](#removeAt-int-) | 지정된 인덱스의 컬렉션에서 동작을 제거합니다. |
...
**반환:**
boolean - 동작이 성공적으로 제거되면 True, 그렇지 않으면 false.
