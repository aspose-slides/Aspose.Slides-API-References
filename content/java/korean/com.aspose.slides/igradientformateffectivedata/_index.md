...
| 메서드 | 설명 |
| --- | --- |
| [getTileFlip()](#getTileFlip--) | 그라디언트의 플리핑 모드를 반환합니다. |
...
| [getLinearGradientScaled()](#getLinearGradientScaled--) | 그라디언트가 스케일링되는지 여부를 판단합니다. |
...
그라디언트의 플리핑 모드를 반환합니다. 읽기 전용 [TileFlip](../../com.aspose.slides/tileflip).
...
그라디언트가 스케일링되는지 여부를 판단합니다. 읽기 전용 boolean.
...
그라디언트 스톱 컬렉션을 반환합니다. 읽기 전용 [IGradientStopCollectionEffectiveData](../../com.aspose.slides/igradientstopcollectioneffectivedata).
