...
| 메서드 | 설명 |
| --- | --- |
| [getLineFormat()](#getLineFormat--) | 형상의 라인 서식 속성을 포함하는 LineFormat 객체를 반환합니다. |
| [getGroupShapeLock()](#getGroupShapeLock--) | 도형의 잠금 정보를 반환합니다. |
| [getShapes()](#getShapes--) | 그룹 내부에 있는 도형들의 컬렉션을 반환합니다. |
### getLineFormat() {#getLineFormat--}
```
public ILineFormat getLineFormat()
```

형상의 라인 서식 속성을 포함하는 LineFormat 객체를 반환합니다. 참고: GroupShape 객체에 대해서는 라인 속성이 없으므로 null을 반환합니다. 읽기 전용 [ILineFormat](../../com.aspose.slides/ilineformat).
...
그룹 내부에 있는 도형들의 컬렉션을 반환합니다. 읽기 전용 [IShapeCollection](../../com.aspose.slides/ishapecollection).
