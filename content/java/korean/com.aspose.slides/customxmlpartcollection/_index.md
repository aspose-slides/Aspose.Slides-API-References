...
description: 사용자 지정 XML 파트 컬렉션을 나타냅니다.
type: docs
...
사용자 지정 XML 파트 컬렉션을 나타냅니다.
## 메서드

| 메서드 | 설명 |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | 지정된 인덱스에 있는 요소를 반환합니다. |
| [size()](#size--) | 컬렉션에 포함된 사용자 지정 XML 파트의 수를 반환합니다. |
| [add(String xmlString)](#add-java.lang.String-) | 새로운 사용자 지정 XML 파트를 추가합니다. |
| [add(byte[] xmlData)](#add-byte---) | 새로운 사용자 지정 XML 파트를 추가합니다. |
| [add(InputStream inputStream)](#add-java.io.InputStream-) | 새로운 사용자 지정 XML 파트를 추가합니다. |
| [removeAt(int index)](#removeAt-int-) | 지정된 인덱스에 있는 사용자 지정 XML 파트를 제거합니다. |
...
| [isSynchronized()](#isSynchronized--) | 컬렉션에 대한 접근이 동기화되어 있는지(스레드 안전) 여부를 나타내는 값을 반환합니다. |
...
**반환값:**
[ICustomXmlPart](../../com.aspose.slides/icustomxmlpart) - 지정된 인덱스에 있는 요소.
...
컬렉션에 포함된 사용자 지정 XML 파트의 수를 반환합니다. 읽기 전용 int.
...
새로운 사용자 지정 XML 파트를 추가합니다.

**매개변수:**
| 매개변수 | 타입 | 설명 |
| --- | --- | --- |
| xmlString | java.lang.String | 추가할 새로운 파트의 XML 문자열입니다. |

**반환값:**
[ICustomXmlPart](../../com.aspose.slides/icustomxmlpart) - 생성된 사용자 지정 XML 파트.
...
| 매개변수 | 타입 | 설명 |
| --- | --- | --- |
| xmlData | byte[] | 추가할 새로운 파트의 XML 데이터입니다. |
...
| 매개변수 | 타입 | 설명 |
| --- | --- | --- |
| inputStream | java.io.InputStream | 추가할 새로운 파트의 XML 데이터를 포함하는 InputStream입니다. |
...
| 매개변수 | 타입 | 설명 |
| --- | --- | --- |
| item | [ICustomXmlPart](../../com.aspose.slides/icustomxmlpart) | 제거할 사용자 지정 XML 파트입니다. |
...
컬렉션에 대한 접근이 동기화되어 있는지(스레드 안전) 여부를 나타내는 값을 반환합니다. 읽기 전용 boolean.
...
**반환값:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICustomXmlPart> - 컬렉션을 반복하는 데 사용할 수 있는 IGenericEnumerator.
...
**반환값:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICustomXmlPart> - 전체 컬렉션에 대한 java.util.Iterator.
