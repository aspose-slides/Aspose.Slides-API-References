...
| 메서드 | 설명 |
| --- | --- |
| [getImage()](#getImage--) | 임베디드 이미지를 반환하거나 설정합니다. |
| [setImage(IPPImage value)](#setImage-com.aspose.slides.IPPImage-) | 임베디드 이미지를 반환하거나 설정합니다. |
...
임베디드 이미지를 반환하거나 설정합니다. 읽기/쓰기 [IPPImage](../../com.aspose.slides/ippimage).
