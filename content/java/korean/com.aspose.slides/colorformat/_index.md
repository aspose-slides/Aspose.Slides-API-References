...
| [getColor()](#getColor--) | 모든 색 변환이 적용된 결과 색상을 반환합니다. |
| [setColor(Color value)](#setColor-java.awt.Color-) | 모든 색 변환이 적용된 결과 색상을 반환합니다. |
| [getPresetColor()](#getPresetColor--) | 색 프리셋을 반환하거나 설정합니다. |
| [setPresetColor(int value)](#setPresetColor-int-) | 색 프리셋을 반환하거나 설정합니다. |
| [getSystemColor()](#getSystemColor--) | 시스템 색상 표에서 식별된 색상을 반환하거나 설정합니다. |
| [setSystemColor(int value)](#setSystemColor-int-) | 시스템 색상 표에서 식별된 색상을 반환하거나 설정합니다. |
| [getSchemeColor()](#getSchemeColor--) | 색 구성표에서 식별된 색상을 반환하거나 설정합니다. |
| [setSchemeColor(int value)](#setSchemeColor-int-) | 색 구성표에서 식별된 색상을 반환하거나 설정합니다. |
...
| [equals(Object obj)](#equals-java.lang.Object-) | 지정된 객체와의 동등성을 검사합니다. |
...
모든 색 변환이 적용된 결과 색상을 반환합니다. RGB 색을 설정하고 모든 색 변환을 지웁니다. 읽기/쓰기 java.awt.Color.
...
시스템 색상 표에서 식별된 색상을 반환하거나 설정합니다. 읽기/쓰기 [SystemColor](../../com.aspose.slides/systemcolor).
...
색 구성표에서 식별된 색상을 반환하거나 설정합니다. 읽기/쓰기 [SchemeColor](../../com.aspose.slides/schemecolor).
