...
>  셀 서식은 항상 행 서식보다 높은 우선순위를 가지며, 행은 열보다, 열은 전체 테이블보다 높은 우선순위를 가집니다.
>  따라서 최종적으로 CellFormatEffectiveData 속성이 항상 테이블을 그리는 데 사용됩니다. 다음 코드는 API 예시일 뿐입니다.
>  
...
IPresentationComponent의 상위 요소를 반환합니다. 읽기 전용 [IPresentationComponent](../../com.aspose.slides/ipresentationcomponent).
