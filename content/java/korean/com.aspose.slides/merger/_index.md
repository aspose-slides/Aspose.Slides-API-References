...
| 메서드 | 설명 |
| --- | --- |
| [process(String[] inputFileNames, String outputFileName)](#process-java.lang.String---java.lang.String-) | 동일한 형식의 여러 PowerPoint 프레젠테이션을 단일 프레젠테이션 파일로 병합합니다. |
| [process(String[] inputFileNames, String outputFileName, ISaveOptions options)](#process-java.lang.String---java.lang.String-com.aspose.slides.ISaveOptions-) | 동일한 형식의 여러 PowerPoint 프레젠테이션을 단일 프레젠테이션 파일로 병합합니다. |
| [process(String[] inputFileNames, OutputStream outputStream)](#process-java.lang.String---java.io.OutputStream-) | 동일한 형식의 여러 PowerPoint 프레젠테이션을 단일 프레젠테이션 파일로 병합합니다. |
| [process(String[] inputFileNames, OutputStream outputStream, ISaveOptions options)](#process-java.lang.String---java.io.OutputStream-com.aspose.slides.ISaveOptions-) | 동일한 형식의 여러 PowerPoint 프레젠테이션을 단일 프레젠테이션 파일로 병합합니다. |
...
| outputFileName | java.lang.String | 결과로 병합된 프레젠테이션 파일의 출력 파일 이름입니다. |
