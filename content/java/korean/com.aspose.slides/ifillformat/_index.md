...
| [getPictureFillFormat()](#getPictureFillFormat--) | 이미지 채우기 형식을 반환합니다. |
| [getRotateWithShape()](#getRotateWithShape--) | 채우기가 도형과 함께 회전되는지 여부를 결정합니다. |
| [setRotateWithShape(byte value)](#setRotateWithShape-byte-) | 채우기가 도형과 함께 회전되는지 여부를 결정합니다. |
| [getEffective()](#getEffective--) | 상속이 적용된 실제 채우기 서식 데이터를 가져옵니다. |
...
이미지 채우기 형식을 반환합니다. 읽기 전용 [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
채우기가 도형과 함께 회전되는지 여부를 결정합니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
