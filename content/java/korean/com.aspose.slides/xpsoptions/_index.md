...
| 메서드 | 설명 |
| --- | --- |
| [getShowHiddenSlides()](#getShowHiddenSlides--) | 생성된 문서에 숨김 슬라이드를 포함할지 여부를 지정합니다. |
| [setShowHiddenSlides(boolean value)](#setShowHiddenSlides-boolean-) | 생성된 문서에 숨김 슬라이드를 포함할지 여부를 지정합니다. |
...
생성된 문서에 숨김 슬라이드를 포함할지 여부를 지정합니다. 기본값은 false.
