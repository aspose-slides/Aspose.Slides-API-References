...
| 메서드 | 설명 |
| --- | --- |
| [getJustification()](#getJustification--) | 문단 정렬 기본값: CenteredAsGroup |
| [setJustification(int value)](#setJustification-int-) | 문단 정렬 기본값: CenteredAsGroup |
| [getParent_Immediate()](#getParent-Immediate--) | Parent_Immediate 객체를 반환합니다. |
| [getCount()](#getCount--) | 컬렉션에 실제로 포함된 요소 수를 가져옵니다. |
| [get_Item(int index)](#get-Item-int-) | 지정된 인덱스에 있는 항목을 가져옵니다. |
| [set_Item(int index, IMathBlock value)](#set-Item-int-com.aspose.slides.IMathBlock-) | 지정된 인덱스에 있는 항목을 가져옵니다. |
| [clear()](#clear--) | 컬렉션의 모든 요소를 제거합니다. |
| [add(IMathBlock mathBlock)](#add-com.aspose.slides.IMathBlock-) | IMMathBlock을 컬렉션의 끝에 추가합니다. |
...
| [indexOf(IMathBlock mathBlock)](#indexOf-com.aspose.slides.IMathBlock-) | 컬렉션에서 특정 IMathBlock의 인덱스를 확인합니다. |
| [insert(int index, IMathBlock mathBlock)](#insert-int-com.aspose.slides.IMathBlock-) | 지정된 인덱스에 IMMathBlock을 삽입합니다. |
| [removeAt(int index)](#removeAt-int-) | 컬렉션의 지정된 인덱스에 있는 항목을 제거합니다. |
| [iterator()](#iterator--) |  |
| [iteratorJava()](#iteratorJava--) |  |
| [writeAsMathMl(OutputStream stream)](#writeAsMathMl-java.io.OutputStream-) | 이 [MathParagraph](../../com.aspose.slides/mathparagraph)의 내용을 MathML로 저장합니다. |
...
지정된 인덱스에 있는 항목을 가져옵니다. 읽기 전용 [IMathBlock](../../com.aspose.slides/imathblock).
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | 컬렉션의 끝에 추가될 수학 블록 |
...
**반환값:**
boolean - mathBlock이 컬렉션에서 성공적으로 제거된 경우 true; 그렇지 않으면 false. 이 메서드는 원래 컬렉션에 mathBlock이 없을 경우에도 false를 반환합니다.
...
**반환값:**
int - 컬렉션에 mathBlock이 있으면 해당 인덱스; 없으면 -1.
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| index | int | 항목을 삽입할 0 기반 인덱스 |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | 삽입할 IMMathBlock |
...
이 [MathParagraph](../../com.aspose.slides/mathparagraph)의 내용을 MathML로 저장합니다.
