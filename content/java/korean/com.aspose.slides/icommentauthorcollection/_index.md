...
| [toArray()](#toArray--) | 모든 작성자가 포함된 배열을 생성하고 반환합니다. |
| [findByName(String name)](#findByName-java.lang.String-) | 컬렉션에서 이름으로 작성자를 찾습니다. |
...
| [removeAt(int index)](#removeAt-int-) | 컬렉션에서 지정된 인덱스의 작성자를 제거합니다. |
...
지정된 인덱스의 요소를 가져옵니다. 읽기 전용 [ICommentAuthor](../../com.aspose.slides/icommentauthor).
...
모든 작성자가 포함된 배열을 생성하고 반환합니다.

**반환:**
com.aspose.slides.ICommentAuthor[] - [ICommentAuthor](../../com.aspose.slides/icommentauthor)의 배열
### findByName(String name) {#findByName-java.lang.String-}
```
public abstract ICommentAuthor[] findByName(String name)
```

컬렉션에서 이름으로 작성자를 찾습니다.
