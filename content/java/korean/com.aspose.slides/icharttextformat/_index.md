...
차트는 제한된 텍스트 형식 속성 집합으로 작동합니다. IChartTextFormat, IChartTextBlockFormat, IChartParagraphFormat, IChartPortionFormat 인터페이스는 이 제한된 집합을 설명합니다.
## 메서드

| 메서드 | 설명 |
| --- | --- |
| [getTextBlockFormat()](#getTextBlockFormat--) | 차트 텍스트 요소에 대한 형식을 반환합니다. |
| [getParagraphFormat()](#getParagraphFormat--) | 문단 형식을 반환합니다. |
...
문단 형식을 반환합니다. 읽기 전용 [IChartParagraphFormat](../../com.aspose.slides/ichartparagraphformat).
