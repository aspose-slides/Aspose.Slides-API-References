...
| [isSynchronized()](#isSynchronized--) | 컬렉션에 대한 액세스가 동기화(스레드 안전) 되었는지 여부를 나타내는 값을 반환합니다. |
...
컬렉션에 대한 액세스가 동기화(스레드 안전) 되었는지 여부를 나타내는 값을 반환합니다. 읽기 전용 boolean.
...
**반환값:**  
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISlide> - 컬렉션을 순회하는 데 사용할 수 있는 IGenericEnumerator.
