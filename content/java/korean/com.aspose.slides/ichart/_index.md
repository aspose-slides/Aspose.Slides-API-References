...
| 메서드 | 설명 |
| --- | --- |
| [getPlotVisibleCellsOnly()](#getPlotVisibleCellsOnly--) | 오직 표시된 셀만 플롯되는지 여부를 결정합니다. |
| [setPlotVisibleCellsOnly(boolean value)](#setPlotVisibleCellsOnly-boolean-) | 오직 표시된 셀만 플롯되는지 여부를 결정합니다. |
...
| [getBackWall()](#getBackWall--) | 3D 차트의 뒤쪽 벽 형식을 변경할 수 있는 객체를 반환합니다. |
...
오직 표시된 셀만 플롯되는지 여부를 결정합니다. 표시된 셀과 숨겨진 셀 모두를 플롯하려면 false를 사용합니다. 읽기/쓰기 boolean.
...
3D 차트의 뒤쪽 벽 형식을 변경할 수 있는 객체를 반환합니다. 읽기 전용 [IChartWall](../../com.aspose.slides/ichartwall).
...
차트 최대값을 초과하는 데이터 레이블을 표시하도록 지정합니다. 읽기/쓰기 boolean.
