...
>      shape.getTextFrame().getParagraphs().get_Item(0).getParagraphFormat().getDefaultPortionFormat().setFontHeight(64);
>      // FillFormat.FillType을 FillType.Gradient으로 설정하고 그라디언트 속성을 정의합니다.
...
>      // FillFormat.FillType을 FillType.NoFill으로 설정합니다.
...
| [getDepth()](#getDepth--) | 3D 도형의 깊이를 반환하거나 설정합니다. |
| [setDepth(double value)](#setDepth-double-) | 3D 도형의 깊이를 반환하거나 설정합니다. |
...
| [getLightRig()](#getLightRig--) | 빛의 유형을 반환하거나 설정합니다. |
| [getMaterial()](#getMaterial--) | 재질의 유형을 반환하거나 설정합니다. |
| [setMaterial(int value)](#setMaterial-int-) | 재질의 유형을 반환하거나 설정합니다. |
...
돌출의 색상을 반환하거나 설정합니다. 읽기 전용 [IColorFormat](../../com.aspose.slides/icolorformat).
...
빛의 유형을 반환하거나 설정합니다. 읽기 전용 [ILightRig](../../com.aspose.slides/ilightrig).
...
재질의 유형을 반환하거나 설정합니다. 읽기/쓰기 [MaterialPresetType](../../com.aspose.slides/materialpresettype).
