...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| options | [WebDocumentOptions](../../com.aspose.slides/webdocumentoptions) | 문서에 설정된 옵션. |
...
> 
>   // "slideMargin" 속성을 템플릿에서 사용하도록 설정
