...
description: 프레젠테이션 읽기 오류 시 발생하는 예외를 나타냅니다.
type: docs
...
| [PptReadException(String message, Exception exception)](#PptReadException-java.lang.String-java.lang.Exception-) | 메시지와 내포된 예외를 포함하는 예외에 대한 생성자. |
