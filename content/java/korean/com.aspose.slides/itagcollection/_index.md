...
| 메서드 | 설명 |
| --- | --- |
| [add(String name, String value)](#add-java.lang.String-java.lang.String-) | 컬렉션에 새 태그를 추가합니다. |
| [remove(String name)](#remove-java.lang.String-) | 지정된 이름을 가진 태그를 컬렉션에서 제거합니다. |
| [indexOfName(String name)](#indexOfName-java.lang.String-) | 컬렉션에서 지정된 키의 0부터 시작하는 인덱스를 반환합니다. |
...
| [getNamesOfTags()](#getNamesOfTags--) | 태그의 이름을 반환합니다. |
| [get_Item(String name)](#get-Item-java.lang.String-) | 태그의 키와 값 쌍을 가져오거나 설정합니다. |
| [set_Item(String name, String value)](#set-Item-java.lang.String-java.lang.String-) | 태그의 키와 값 쌍을 가져오거나 설정합니다. |
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| name | java.lang.String | 태그의 이름입니다. |
| value | java.lang.String | 태그의 값입니다. |
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| name | java.lang.String | 제거할 태그의 이름입니다. |
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| name | java.lang.String | 컬렉션에서 찾을 이름입니다. |

**반환값:**
int - 키가 컬렉션에 있으면 해당 0부터 시작하는 인덱스, 없으면 -1.
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| index | int | 제거할 태그의 0부터 시작하는 인덱스입니다. |
...
태그의 키와 값 쌍을 가져오거나 설정합니다.

**매개변수:**
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| name | java.lang.String | 태그의 키입니다. |
