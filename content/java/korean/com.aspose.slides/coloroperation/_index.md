...
색 변환에 사용되는 다양한 색상 연산을 나타냅니다. 불변 객체.
## 생성자

| 생성자 | 설명 |
| --- | --- |
| [ColorOperation(int op)](#ColorOperation-int-) | 새로운 색 변환 작업을 생성합니다. |
| [ColorOperation(int op, float parameter)](#ColorOperation-int-float-) | 새로운 색 변환 작업을 생성합니다. |
## 메서드
...
| [equals(Object obj)](#equals-java.lang.Object-) | 두 ColorOperation 인스턴스가 동일한지 판단합니다. |
| [hashCode()](#hashCode--) | 특정 유형에 대한 해시 함수로 동작하며, 해시 알고리즘 및 해시 테이블과 같은 데이터 구조에서 사용할 수 있습니다. |
...
두 ColorOperation 인스턴스가 동일한지 판단합니다.
...
특정 유형에 대한 해시 함수로 동작하며, 해시 알고리즘 및 해시 테이블과 같은 데이터 구조에서 사용할 수 있습니다.
