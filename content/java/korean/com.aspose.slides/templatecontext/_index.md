...
| [getLocal()](#getLocal--) | 현재 템플릿 컨텍스트의 로컬 저장소를 반환합니다. |
| [getGlobal()](#getGlobal--) | 호스트 문서의 전역 저장소를 반환합니다. |
...
**반환값:**
[TemplateContext](../../com.aspose.slides/templatecontext) - 지정된 모델과 상위의 출력 컬렉션 및 전역 저장소를 가진 새로운 템플릿 컨텍스트.
...
현재 템플릿 컨텍스트의 로컬 저장소를 반환합니다. 읽기 전용 [Storage](../../com.aspose.slides/storage).
...
호스트 문서의 전역 저장소를 반환합니다. 읽기 전용 [Storage](../../com.aspose.slides/storage).
