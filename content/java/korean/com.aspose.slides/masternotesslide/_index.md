...
| [getDrawingGuides()](#getDrawingGuides--) | 마스터 노트 슬라이드에 대한 그리기 가이드 컬렉션을 반환합니다. |
...
마스터 슬라이드의 도형을 슬라이드에 표시할지 여부를 지정합니다. 마스터 슬라이드 자체에서는 이 속성이 항상 false를 반환합니다. 읽기/쓰기 부울.
...
마스터 노트 슬라이드에 대한 그리기 가이드 컬렉션을 반환합니다. 읽기 전용 [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
