...
| [getShowPageBorder()](#getShowPageBorder--) | 페이지 주변 테두리를 표시할지 여부를 지정합니다. |
| [setShowPageBorder(boolean value)](#setShowPageBorder-boolean-) | 페이지 주변 테두리를 표시할지 여부를 지정합니다. |
...
| [getShowTopPane()](#getShowTopPane--) | 전체 상단 페인을 표시/숨깁니다. |
| [setShowTopPane(boolean value)](#setShowTopPane-boolean-) | 전체 상단 페인을 표시/숨깁니다. |
| [getShowBottomPane()](#getShowBottomPane--) | 하단 페인을 표시/숨깁니다. |
| [setShowBottomPane(boolean value)](#setShowBottomPane-boolean-) | 하단 페인을 표시/숨깁니다. |
| [getShowLeftPane()](#getShowLeftPane--) | 좌측 페인을 표시/숨깁니다. |
| [setShowLeftPane(boolean value)](#setShowLeftPane-boolean-) | 좌측 페인을 표시/숨깁니다. |
| [getStartOpenLeftPane()](#getStartOpenLeftPane--) | 좌측 페인을 열린 상태로 시작합니다. |
| [setStartOpenLeftPane(boolean value)](#setStartOpenLeftPane-boolean-) | 좌측 페인을 열린 상태로 시작합니다. |
| [getEnableContextMenu()](#getEnableContextMenu--) | 컨텍스트 메뉴를 사용/사용 안 함으로 설정합니다. |
| [setEnableContextMenu(boolean value)](#setEnableContextMenu-boolean-) | 컨텍스트 메뉴를 사용/사용 안 함으로 설정합니다. |
| [getLogoImageBytes()](#getLogoImageBytes--) | 뷰어 오른쪽 상단 모서리에 로고로 표시될 이미지입니다. |
| [setLogoImageBytes(byte[] value)](#setLogoImageBytes-byte---) | 뷰어 오른쪽 상단 모서리에 로고로 표시될 이미지입니다. |
...
페이지 주변 테두리를 표시할지 여부를 지정합니다. 기본값은 true입니다.
...
전체 상단 페인을 표시/숨깁니다. flashvars에서 재정의할 수 있습니다. 기본값은 true입니다.
...
하단 페인을 표시/숨깁니다. flashvars에서 재정의할 수 있습니다. 기본값은 true입니다.
...
좌측 페인을 표시/숨깁니다. flashvars에서 재정의할 수 있습니다. 기본값은 true입니다.
...
좌측 페인을 열린 상태로 시작합니다. flashvars에서 재정의할 수 있습니다. 기본값은 false입니다.
...
컨텍스트 메뉴를 사용/사용 안 함으로 설정합니다. 기본값은 true입니다.
...
뷰어 오른쪽 상단 모서리에 로고로 표시될 이미지입니다. 이미지가 32x64 픽셀 PNG 이미지가 아니면 로고가 제대로 표시되지 않을 수 있습니다.
...
로고에 대한 전체 하이퍼링크 주소를 가져오거나 설정합니다. (\#getLogoImageBytes.getLogoImageBytes/\#setLogoImageBytes(byte[]).setLogoImageBytes(byte[]))이 지정된 경우에만 영향을 줍니다.
