...
description: 이 클래스는 중단 요청 여부를 알리기 위해 장기 실행 작업에 사용할 토큰을 나타냅니다.
type: docs
...
이 클래스는 중단 요청 여부를 알리기 위해 장기 실행 작업에 사용할 토큰을 나타냅니다.
## 메서드
...
이 토큰을 사용할 때 [InterruptionTokenSource.interrupt](../../com.aspose.slides/interruptiontokensource\#interrupt)을 통해 장기 실행 작업이 중단되지 않습니다.
