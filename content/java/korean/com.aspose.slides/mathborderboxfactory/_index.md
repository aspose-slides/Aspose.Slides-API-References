...
| strikethroughHorizontal | boolean | 경계 상자 수평 취소선 |
| strikethroughVertical | boolean | 경계 상자 수직 취소선 |
| strikethroughBottomLeftToTopRight | boolean | 좌하단에서 우상단까지 경계 상자 취소선 |
| strikethroughTopLeftToBottomRight | boolean | 좌상단에서 우하단까지 경계 상자 취소선 |
