...
| 메서드 | 설명 |
| --- | --- |
| [getRow()](#getRow--) | 셀이 위치한 워크시트 행의 인덱스를 반환합니다. |
| [getColumn()](#getColumn--) | 셀이 위치한 워크시트 열의 인덱스를 반환합니다. |
...
| [isHidden()](#isHidden--) | 셀이 숨겨져 있는지 여부를 확인합니다. |
...
| [getPresetNumberFormat()](#getPresetNumberFormat--) | 숫자 및 날짜의 기본 제공 표시 형식을 가져오거나 설정합니다. |
| [setPresetNumberFormat(byte value)](#setPresetNumberFormat-byte-) | 숫자 및 날짜의 기본 제공 표시 형식을 가져오거나 설정합니다. |
| [calculate(boolean updateValues)](#calculate-boolean-) | 셀에 수식이 포함된 경우, 값이 해당 수식에 따라 업데이트됩니다. |
### getRow() {#getRow--}
```
...
셀(셀)이 위치한 워크시트 행의 인덱스를 반환합니다. 읽기 전용 int.
...
셀(셀)이 위치한 워크시트 열의 인덱스를 반환합니다. 읽기 전용 int.
...
셀(셀)이 숨겨져 있는지 여부를 확인합니다. 읽기 전용 boolean.
...
숫자 및 날짜의 기본 제공 표시 형식을 가져오거나 설정합니다. 프리셋 번호는 [0..22] 또는 [37..49] 범위에 있어야 합니다. 읽기/쓰기 byte.
...
셀에 수식이 포함된 경우, 값이 해당 수식에 따라 업데이트됩니다.
