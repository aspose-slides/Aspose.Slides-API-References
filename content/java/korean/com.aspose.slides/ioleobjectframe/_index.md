...
슬라이드에 있는 OLE 객체를 나타냅니다.
## 메서드

| 메서드 | 설명 |
| --- | --- |
| [getSubstitutePictureFormat()](#getSubstitutePictureFormat--) | OleObject 이미지 채우기 속성 객체를 반환합니다. |
...
OleObject 이미지 채우기 속성 객체를 반환합니다. 읽기 전용 [IPictureFillFormat](../../com.aspose.slides/ipicturefillformat).
...
IsObjectIcon이 false일 때 이 값은 무시됩니다. 문자열은 OLE 아이콘의 크기에 따라 잘릴 수 있습니다.
