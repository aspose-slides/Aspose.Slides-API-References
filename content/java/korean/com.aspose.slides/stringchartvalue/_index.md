...
description: pptx 프레젠테이션 문서에 저장될 수 있는 문자열 값을 두 가지 방법으로 나타냅니다. 1) 차트와 관련된 워크북의 셀/셀에 저장, 2) 문자 그대로 값으로 저장.
type: docs
...
pptx 프레젠테이션 문서에 저장될 수 있는 문자열 값을 두 가지 방법으로 나타냅니다: 1) 차트와 관련된 워크북의 셀/셀들에 저장; 2) 문자 그대로 값으로 저장.
## 메서드

| 메서드 | 설명 |
| --- | --- |
| [getAsCells()](#getAsCells--) | null 값을 할당할 수 없습니다. |
| [setAsCells(IChartCellCollection value)](#setAsCells-com.aspose.slides.IChartCellCollection-) | null 값을 할당할 수 없습니다. |
| [getAsLiteralString()](#getAsLiteralString--) | 값을 문자 그대로 문자열로 반환하거나 설정합니다. |
| [setAsLiteralString(String value)](#setAsLiteralString-java.lang.String-) | 값을 문자 그대로 문자열로 반환하거나 설정합니다. |
...
null 값을 할당할 수 없습니다. 반환값은 항상 null이 아닙니다. 읽기/쓰기 [IChartCellCollection](../../com.aspose.slides/ichartcellcollection).
...
값을 문자 그대로 문자열로 반환하거나 설정합니다. 읽기/쓰기 String.
