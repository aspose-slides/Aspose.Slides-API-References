...
| 메서드 | 설명 |
| --- | --- |
| [getTargetSection()](#getTargetSection--) | Section Zoom 객체와 연결된 section 객체를 가져오거나 설정합니다. |
| [setTargetSection(ISection value)](#setTargetSection-com.aspose.slides.ISection-) | Section Zoom 객체와 연결된 section 객체를 가져오거나 설정합니다. |
### getTargetSection() {#getTargetSection--}
```
public abstract ISection getTargetSection()
```

Section Zoom 객체와 연결된 section 객체를 가져오거나 설정합니다. 읽기/쓰기 [ISection](../../com.aspose.slides/isection).
