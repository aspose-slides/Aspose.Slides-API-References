...
description: 기하학 도형의 미리 정의된 기하학을 나타냅니다.
type: docs
url: /ko/com.aspose.slides/shapetype/
---
**상속:**
...
미리 정의된 기하학 도형을 나타냅니다.
## 필드

| 필드 | 설명 |
| --- | --- |
| [NotDefined](#NotDefined) | 정의되지 않음. |
| [Custom](#Custom) | 사용자 정의 모양. |
| [Line](#Line) | 선 모양. |
| [LineInverse](#LineInverse) | 역선 모양. |
| [Triangle](#Triangle) | 삼각형 모양. |
| [RightTriangle](#RightTriangle) | 직각삼각형 모양. |
| [Rectangle](#Rectangle) | 사각형 모양. |
| [Diamond](#Diamond) | 다이아몬드 모양. |
| [Parallelogram](#Parallelogram) | 평행사변형 모양. |
| [Trapezoid](#Trapezoid) | 사다리꼴 모양. |
| [NonIsoscelesTrapezoid](#NonIsoscelesTrapezoid) | 비정삼각형 사다리꼴 모양. |
| [Pentagon](#Pentagon) | 오각형 모양. |
| [Hexagon](#Hexagon) | 육각형 모양. |
| [Heptagon](#Heptagon) | 칠각형 모양. |
| [Octagon](#Octagon) | 팔각형 모양. |
| [Decagon](#Decagon) | 십각형 모양. |
| [Dodecagon](#Dodecagon) | 십이각형 모양. |
| [FourPointedStar](#FourPointedStar) | 네 꼭지 별 모양. |
| [FivePointedStar](#FivePointedStar) | 오 꼭지 별 모양. |
| [SixPointedStar](#SixPointedStar) | 육 꼭지 별 모양. |
| [SevenPointedStar](#SevenPointedStar) | 칠 꼭지 별 모양. |
| [EightPointedStar](#EightPointedStar) | 팔 꼭지 별 모양. |
| [TenPointedStar](#TenPointedStar) | 십 꼭지 별 모양. |
| [TwelvePointedStar](#TwelvePointedStar) | 십이 꼭지 별 모양. |
| [SixteenPointedStar](#SixteenPointedStar) | 십육 꼭지 별 모양. |
| [TwentyFourPointedStar](#TwentyFourPointedStar) | 이십사 꼭지 별 모양. |
| [ThirtyTwoPointedStar](#ThirtyTwoPointedStar) | 삼십이 꼭지 별 모양. |
| [RoundCornerRectangle](#RoundCornerRectangle) | 둥근 모서리 사각형 모양. |
| [OneRoundCornerRectangle](#OneRoundCornerRectangle) | 하나의 둥근 모서리 사각형 모양. |
| [TwoSamesideRoundCornerRectangle](#TwoSamesideRoundCornerRectangle) | 두 개 같은 면 둥근 모서리 사각형 모양. |
| [TwoDiagonalRoundCornerRectangle](#TwoDiagonalRoundCornerRectangle) | 두 개 대각선 둥근 모서리 사각형 모양. |
| [OneSnipOneRoundCornerRectangle](#OneSnipOneRoundCornerRectangle) | 한쪽 자른 하나의 둥근 모서리 사각형 모양. |
| [OneSnipCornerRectangle](#OneSnipCornerRectangle) | 한쪽 자른 모서리 사각형 모양. |
| [TwoSamesideSnipCornerRectangle](#TwoSamesideSnipCornerRectangle) | 두 개 같은 면 자른 모서리 사각형 모양. |
| [TwoDiagonalSnipCornerRectangle](#TwoDiagonalSnipCornerRectangle) | 두 개 대각선 자른 모서리 사각형 모양. |
| [Plaque](#Plaque) | 플라크 모양. |
| [Ellipse](#Ellipse) | 타원 모양. |
| [Teardrop](#Teardrop) | 눈물방울 모양. |
| [HomePlate](#HomePlate) | 홈 플레이트 모양. |
| [Chevron](#Chevron) | 쉐브론 모양. |
| [PieWedge](#PieWedge) | 파이 웨지 모양. |
| [Pie](#Pie) | 파이 모양. |
| [BlockArc](#BlockArc) | 블록 호 모양. |
| [Donut](#Donut) | 도넛 모양. |
| [NoSmoking](#NoSmoking) | 금연 모양. |
| [RightArrow](#RightArrow) | 오른쪽 화살표 모양. |
| [LeftArrow](#LeftArrow) | 왼쪽 화살표 모양. |
| [UpArrow](#UpArrow) | 위쪽 화살표 모양. |
| [DownArrow](#DownArrow) | 아래쪽 화살표 모양. |
| [StripedRightArrow](#StripedRightArrow) | 줄무늬 오른쪽 화살표 모양. |
| [NotchedRightArrow](#NotchedRightArrow) | 톱니 오른쪽 화살표 모양. |
| [BentUpArrow](#BentUpArrow) | 꺾인 위쪽 화살표 모양. |
| [LeftRightArrow](#LeftRightArrow) | 좌우 화살표 모양. |
| [UpDownArrow](#UpDownArrow) | 위아래 화살표 모양. |
| [LeftUpArrow](#LeftUpArrow) | 좌상 화살표 모양. |
| [LeftRightUpArrow](#LeftRightUpArrow) | 좌우 위 화살표 모양. |
| [QuadArrow](#QuadArrow) | 쿼드 화살표 모양. |
| [CalloutLeftArrow](#CalloutLeftArrow) | 콜아웃 왼쪽 화살표 모양. |
| [CalloutRightArrow](#CalloutRightArrow) | 콜아웃 오른쪽 화살표 모양. |
| [CalloutUpArrow](#CalloutUpArrow) | 콜아웃 위쪽 화살표 모양. |
| [CalloutDownArrow](#CalloutDownArrow) | 콜아웃 아래쪽 화살표 모양. |
| [CalloutLeftRightArrow](#CalloutLeftRightArrow) | 콜아웃 좌우 화살표 모양. |
| [CalloutUpDownArrow](#CalloutUpDownArrow) | 콜아웃 위아래 화살표 모양. |
| [CalloutQuadArrow](#CalloutQuadArrow) | 콜아웃 쿼드 화살표 모양. |
| [BentArrow](#BentArrow) | 꺾인 화살표 모양. |
| [UTurnArrow](#UTurnArrow) | U자형 화살표 모양. |
| [CircularArrow](#CircularArrow) | 원형 화살표 모양. |
| [LeftCircularArrow](#LeftCircularArrow) | 좌측 원형 화살표 모양. |
| [LeftRightCircularArrow](#LeftRightCircularArrow) | 좌우 원형 화살표 모양. |
| [CurvedRightArrow](#CurvedRightArrow) | 곡선 오른쪽 화살표 모양. |
| [CurvedLeftArrow](#CurvedLeftArrow) | 곡선 왼쪽 화살표 모양. |
| [CurvedUpArrow](#CurvedUpArrow) | 곡선 위쪽 화살표 모양. |
| [CurvedDownArrow](#CurvedDownArrow) | 곡선 아래쪽 화살표 모양. |
| [SwooshArrow](#SwooshArrow) | 스우시 화살표 모양. |
| [Cube](#Cube) | 큐브 모양. |
| [Can](#Can) | 캔 모양. |
| [LightningBolt](#LightningBolt) | 번개 모양. |
| [Heart](#Heart) | 하트 모양. |
| [Sun](#Sun) | 태양 모양. |
| [Moon](#Moon) | 달 모양. |
| [SmileyFace](#SmileyFace) | 스마일 얼굴 모양. |
| [IrregularSeal1](#IrregularSeal1) | 불규칙 봉인 1 모양. |
| [IrregularSeal2](#IrregularSeal2) | 불규칙 봉인 2 모양. |
| [FoldedCorner](#FoldedCorner) | 접힌 모서리 모양. |
| [Bevel](#Bevel) | 베벨 모양. |
| [Frame](#Frame) | 프레임 모양. |
| [HalfFrame](#HalfFrame) | 절반 프레임 모양. |
| [Corner](#Corner) | 모서리 모양. |
| [DiagonalStripe](#DiagonalStripe) | 대각선 스트라이프 모양. |
| [Chord](#Chord) | 코드 모양. |
| [CurvedArc](#CurvedArc) | 곡선 호 모양. |
| [LeftBracket](#LeftBracket) | 왼쪽 대괄호 모양. |
| [RightBracket](#RightBracket) | 오른쪽 대괄호 모양. |
| [LeftBrace](#LeftBrace) | 왼쪽 중괄호 모양. |
| [RightBrace](#RightBrace) | 오른쪽 중괄호 모양. |
| [BracketPair](#BracketPair) | 대괄호 쌍 모양. |
| [BracePair](#BracePair) | 중괄호 쌍 모양. |
| [StraightConnector1](#StraightConnector1) | 직선 커넥터 1 모양. |
| [BentConnector2](#BentConnector2) | 굽은 커넥터 2 모양. |
| [BentConnector3](#BentConnector3) | 굽은 커넥터 3 모양. |
| [BentConnector4](#BentConnector4) | 굽은 커넥터 4 모양. |
| [BentConnector5](#BentConnector5) | 굽은 커넥터 5 모양. |
| [CurvedConnector2](#CurvedConnector2) | 곡선 커넥터 2 모양. |
| [CurvedConnector3](#CurvedConnector3) | 곡선 커넥터 3 모양. |
| [CurvedConnector4](#CurvedConnector4) | 곡선 커넥터 4 모양. |
| [CurvedConnector5](#CurvedConnector5) | 곡선 커넥터 5 모양. |
| [Callout1](#Callout1) | 콜아웃 1 모양. |
| [Callout2](#Callout2) | 콜아웃 2 모양. |
| [Callout3](#Callout3) | 콜아웃 3 모양. |
| [Callout1WithAccent](#Callout1WithAccent) | 강조가 있는 콜아웃 1 모양. |
| [Callout2WithAccent](#Callout2WithAccent) | 강조가 있는 콜아웃 2 모양. |
| [Callout3WithAccent](#Callout3WithAccent) | 강조가 있는 콜아웃 3 모양. |
| [Callout1WithBorder](#Callout1WithBorder) | 테두리가 있는 콜아웃 1 모양. |
| [Callout2WithBorder](#Callout2WithBorder) | 테두리가 있는 콜아웃 2 모양. |
| [Callout3WithBorder](#Callout3WithBorder) | 테두리가 있는 콜아웃 3 모양. |
| [Callout1WithBorderAndAccent](#Callout1WithBorderAndAccent) | 테두리와 강조가 있는 콜아웃 1 모양. |
| [Callout2WithBorderAndAccent](#Callout2WithBorderAndAccent) | 테두리와 강조가 있는 콜아웃 2 모양. |
| [Callout3WithBorderAndAccent](#Callout3WithBorderAndAccent) | 테두리와 강조가 있는 콜아웃 3 모양. |
| [CalloutWedgeRectangle](#CalloutWedgeRectangle) | 콜아웃 웨지 사각형 모양. |
| [CalloutWedgeRoundRectangle](#CalloutWedgeRoundRectangle) | 콜아웃 웨지 둥근 사각형 모양. |
| [CalloutWedgeEllipse](#CalloutWedgeEllipse) | 콜아웃 웨지 타원 모양. |
| [CalloutCloud](#CalloutCloud) | 콜아웃 구름 모양. |
| [Cloud](#Cloud) | 구름 모양. |
| [Ribbon](#Ribbon) | 리본 모양. |
| [Ribbon2](#Ribbon2) | 리본 2 모양. |
| [EllipseRibbon](#EllipseRibbon) | 타원 리본 모양. |
| [EllipseRibbon2](#EllipseRibbon2) | 타원 리본 2 모양. |
| [LeftRightRibbon](#LeftRightRibbon) | 좌우 리본 모양. |
| [VerticalScroll](#VerticalScroll) | 수직 스크롤 모양. |
| [HorizontalScroll](#HorizontalScroll) | 수평 스크롤 모양. |
| [Wave](#Wave) | 파도 모양. |
| [DoubleWave](#DoubleWave) | 이중 파도 모양. |
| [Plus](#Plus) | 플러스 모양. |
| [ProcessFlow](#ProcessFlow) | 프로세스 흐름 모양. |
| [DecisionFlow](#DecisionFlow) | 결정 흐름 모양. |
| [InputOutputFlow](#InputOutputFlow) | 입력 출력 흐름 모양. |
| [PredefinedProcessFlow](#PredefinedProcessFlow) | 사전 정의된 프로세스 흐름 모양. |
| [InternalStorageFlow](#InternalStorageFlow) | 내부 저장 흐름 모양. |
| [DocumentFlow](#DocumentFlow) | 문서 흐름 모양. |
| [MultiDocumentFlow](#MultiDocumentFlow) | 다중 문서 흐름 모양. |
| [TerminatorFlow](#TerminatorFlow) | 종결자 흐름 모양. |
| [PreparationFlow](#PreparationFlow) | 준비 흐름 모양. |
| [ManualInputFlow](#ManualInputFlow) | 수동 입력 흐름 모양. |
| [ManualOperationFlow](#ManualOperationFlow) | 수동 작업 흐름 모양. |
| [ConnectorFlow](#ConnectorFlow) | 커넥터 흐름 모양. |
| [PunchedCardFlow](#PunchedCardFlow) | 펀치 카드 흐름 모양. |
| [PunchedTapeFlow](#PunchedTapeFlow) | 펀치 테이프 흐름 모양. |
| [SummingJunctionFlow](#SummingJunctionFlow) | 합산 결절 흐름 모양. |
| [OrFlow](#OrFlow) | OR 흐름 모양. |
| [CollateFlow](#CollateFlow) | 정렬 흐름 모양. |
| [SortFlow](#SortFlow) | 정렬 흐름 모양. |
| [ExtractFlow](#ExtractFlow) | 추출 흐름 모양. |
| [MergeFlow](#MergeFlow) | 병합 흐름 모양. |
| [OfflineStorageFlow](#OfflineStorageFlow) | 오프라인 저장 흐름 모양. |
| [OnlineStorageFlow](#OnlineStorageFlow) | 온라인 저장 흐름 모양. |
| [MagneticTapeFlow](#MagneticTapeFlow) | 자기 테이프 흐름 모양. |
| [MagneticDiskFlow](#MagneticDiskFlow) | 자기 디스크 흐름 모양. |
| [MagneticDrumFlow](#MagneticDrumFlow) | 자기 드럼 흐름 모양. |
| [DisplayFlow](#DisplayFlow) | 디스플레이 흐름 모양. |
| [DelayFlow](#DelayFlow) | 지연 흐름 모양. |
| [AlternateProcessFlow](#AlternateProcessFlow) | 대체 프로세스 흐름 모양. |
| [OffPageConnectorFlow](#OffPageConnectorFlow) | 페이지 외 연결 흐름 모양. |
| [BlankButton](#BlankButton) | 빈 버튼 모양. |
| [HomeButton](#HomeButton) | 홈 버튼 모양. |
| [HelpButton](#HelpButton) | 도움 버튼 모양. |
| [InformationButton](#InformationButton) | 정보 버튼 모양. |
| [ForwardOrNextButton](#ForwardOrNextButton) | 앞으로/다음 버튼 모양. |
| [BackOrPreviousButton](#BackOrPreviousButton) | 뒤로/이전 버튼 모양. |
| [EndButton](#EndButton) | 종료 버튼 모양. |
| [BeginningButton](#BeginningButton) | 시작 버튼 모양. |
| [ReturnButton](#ReturnButton) | 반환 버튼 모양. |
| [DocumentButton](#DocumentButton) | 문서 버튼 모양. |
| [SoundButton](#SoundButton) | 사운드 버튼 모양. |
| [MovieButton](#MovieButton) | 영화 버튼 모양. |
| [Gear6](#Gear6) | 기어 6 모양. |
| [Gear9](#Gear9) | 기어 9 모양. |
| [Funnel](#Funnel) | 깔때기 모양. |
| [PlusMath](#PlusMath) | 플러스 수학 모양. |
| [MinusMath](#MinusMath) | 마이너스 수학 모양. |
| [MultiplyMath](#MultiplyMath) | 곱하기 수학 모양. |
| [DivideMath](#DivideMath) | 나누기 수학 모양. |
| [EqualMath](#EqualMath) | 등호 수학 모양. |
| [NotEqualMath](#NotEqualMath) | 부등호 수학 모양. |
| [CornerTabs](#CornerTabs) | 코너 탭 모양. |
| [SquareTabs](#SquareTabs) | 사각형 탭 모양. |
| [PlaqueTabs](#PlaqueTabs) | 플라크 탭 모양. |
| [ChartX](#ChartX) | 차트 X 모양. |
| [ChartStar](#ChartStar) | 차트 스타 모양. |
| [ChartPlus](#ChartPlus) | 차트 플러스 모양. |
