...
| [getImages()](#getImages--) | 프레젠테이션에 포함된 모든 이미지의 컬렉션을 반환합니다. |
| [getAudios()](#getAudios--) | 프레젠테이션에 포함된 모든 임베디드 오디오 파일의 컬렉션을 반환합니다. |
| [getVideos()](#getVideos--) | 프레젠테이션에 포함된 모든 임베디드 비디오 파일의 컬렉션을 반환합니다. |
...
| [getHyperlinkQueries()](#getHyperlinkQueries--) | 모든 프레젠테이션 슬라이드에 포함된 모든 하이퍼링크에 쉽게 접근할 수 있습니다 (마스터, 레이아웃, 노트 슬라이드 제외). |
| [getViewProperties()](#getViewProperties--) | 프레젠테이션 전체에 적용되는 보기 속성을 가져옵니다. |
...
| [save(String fname, int format)](#save-java.lang.String-int-) | 지정된 형식으로 프레젠테이션의 모든 슬라이드를 파일에 저장합니다. |
| [save(OutputStream stream, int format)](#save-java.io.OutputStream-int-) | 지정된 형식으로 프레젠테이션의 모든 슬라이드를 스트림에 저장합니다. |
| [save(String fname, int format, ISaveOptions options)](#save-java.lang.String-int-com.aspose.slides.ISaveOptions-) | 지정된 형식과 추가 옵션으로 프레젠테이션의 모든 슬라이드를 파일에 저장합니다. |
| [save(OutputStream stream, int format, ISaveOptions options)](#save-java.io.OutputStream-int-com.aspose.slides.ISaveOptions-) | 지정된 형식과 추가 옵션으로 프레젠테이션의 모든 슬라이드를 스트림에 저장합니다. |
...
| [getImages(IRenderingOptions options, float scaleX, float scaleY)](#getImages-com.aspose.slides.IRenderingOptions-float-float-) | 맞춤 스케일링으로 프레젠테이션의 모든 슬라이드에 대한 썸네일 이미지 객체를 반환합니다. |
| [getImages(IRenderingOptions options, int[] slides, float scaleX, float scaleY)](#getImages-com.aspose.slides.IRenderingOptions-int---float-float-) | 맞춤 스케일링으로 지정된 슬라이드에 대한 썸네일 이미지 객체를 반환합니다. |
| [getImages(IRenderingOptions options, Dimension imageSize)](#getImages-com.aspose.slides.IRenderingOptions-java.awt.Dimension-) | 지정된 크기로 프레젠테이션의 모든 슬라이드에 대한 썸네일 이미지 객체를 반환합니다. |
| [getImages(IRenderingOptions options, int[] slides, Dimension imageSize)](#getImages-com.aspose.slides.IRenderingOptions-int---java.awt.Dimension-) | 지정된 크기로 지정된 슬라이드에 대한 썸네일 이미지 객체를 반환합니다. |
| [getSlideById(long id)](#getSlideById-long-) | Id에 따라 Slide, MasterSlide 또는 LayoutSlide를 반환합니다. |
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | 모든 슬라이드의 모든 허용된 도형 내 모든 단락에서 동일한 서식의 런을 합칩니다. |
| [highlightText(String text, Color highlightColor)](#highlightText-java.lang.String-java.awt.Color-) | 지정된 색상으로 샘플 텍스트의 모든 일치를 강조합니다. |
| [highlightText(String text, Color highlightColor, ITextSearchOptions options, IFindResultCallback callback)](#highlightText-java.lang.String-java.awt.Color-com.aspose.slides.ITextSearchOptions-com.aspose.slides.IFindResultCallback-) | 지정된 색상으로 샘플 텍스트의 모든 일치를 강조합니다. |
| [highlightRegex(Pattern regex, Color highlightColor, IFindResultCallback callback)](#highlightRegex-java.util.regex.Pattern-java.awt.Color-com.aspose.slides.IFindResultCallback-) | 지정된 색상으로 정규식의 모든 일치를 강조합니다. |
...
| [replaceRegex(Pattern regex, String newText, IFindResultCallback callback)](#replaceRegex-java.util.regex.Pattern-java.lang.String-com.aspose.slides.IFindResultCallback-) | 정규식의 모든 일치를 지정된 문자열로 교체합니다. |
...
datetime 필드의 내용을 대체할 날짜와 시간을 반환하거나 설정합니다. 기본값은 이 Presentation 객체가 생성된 시점의 시간입니다. 읽기/쓰기 java.util.Date.
...
프레젠테이션에 포함된 모든 이미지의 컬렉션을 반환합니다. 읽기 전용 [IImageCollection](../../com.aspose.slides/iimagecollection).
...
프레젠테이션에 포함된 모든 임베디드 오디오 파일의 컬렉션을 반환합니다. 읽기 전용 [IAudioCollection](../../com.aspose.slides/iaudiocollection).
...
프레젠테이션에 포함된 모든 임베디드 비디오 파일의 컬렉션을 반환합니다. 읽기 전용 [IVideoCollection](../../com.aspose.slides/ivideocollection).
...
모든 프레젠테이션 슬라이드에 포함된 모든 하이퍼링크에 쉽게 접근할 수 있습니다 (마스터, 레이아웃, 노트 슬라이드 제외). 읽기 전용 [IHyperlinkQueries](../../com.aspose.slides/ihyperlinkqueries).
...
프레젠테이션 전체에 적용되는 보기 속성을 가져옵니다. 읽기 전용 [IViewProperties](../../com.aspose.slides/iviewproperties).
...
| fname | java.lang.String | 생성된 파일의 경로. |
| format | int | 내보낼 데이터의 형식. |
| options | ISaveOptions | 저장 옵션. |
| format | int | 내보낸 데이터의 형식. |
...
지정된 형식으로 프레젠테이션의 특정 슬라이드를 파일에 저장합니다.
...
지정된 형식으로 프레젠테이션의 특정 슬라이드를 스트림에 저장합니다.
...
모든 슬라이드에 대해 사용자 지정 스케일링을 적용한 썸네일 이미지 객체를 반환합니다.

**매개변수:**
| Parameter | Type | Description |
| --- | --- | --- |
| options | [IRenderingOptions](../../com.aspose.slides/irenderingoptions) | 렌더링 옵션. |
| scaleX | float | X축 방향으로 이 썸네일을 스케일링하는 값. |
| scaleY | float | Y축 방향으로 이 썸네일을 스케일링하는 값. |
...
지정된 슬라이드에 대해 사용자 지정 스케일링을 적용한 썸네일 이미지 객체를 반환합니다.
...
지정된 크기로 모든 슬라이드에 대한 썸네일 이미지 객체를 반환합니다.
...
지정된 크기로 특정 슬라이드에 대한 썸네일 이미지 객체를 반환합니다.
...
Id로 슬라이드, 마스터 슬라이드 또는 레이아웃 슬라이드를 반환합니다.
...
모든 슬라이드의 모든 허용 가능한 도형의 모든 단락에서 동일한 서식을 가진 실행(run)을 결합합니다.
...
| Parameter | Type | Description |
| --- | --- | --- |
| text | java.lang.String | 강조 표시할 텍스트. |
| highlightColor | java.awt.Color | 텍스트를 강조 표시할 색상. |
...
| callback | [IFindResultCallback](../../com.aspose.slides/ifindresultcallback) | 검색 결과를 수신하는 콜백 객체 [IFindResultCallback](../../com.aspose.slides/ifindresultcallback). |
...
| Parameter | Type | Description |
| --- | --- | --- |
| regex | java.util.regex.Pattern | 강조 표시할 문자열을 얻기 위한 정규식 java.util.regex.Pattern. |
| highlightColor | java.awt.Color | 텍스트를 강조 표시할 색상. |
| callback | [IFindResultCallback](../../com.aspose.slides/ifindresultcallback) | 검색 결과를 수신하는 콜백 객체 [IFindResultCallback](../../com.aspose.slides/ifindresultcallback). |
...
| newText | java.lang.String | 교체될 문자열을 모든 발생에 대해 교체할 문자열. |
| callback | [IFindResultCallback](../../com.aspose.slides/ifindresultcallback) | 검색 결과를 수신하는 콜백 객체 [IFindResultCallback](../../com.aspose.slides/ifindresultcallback). |