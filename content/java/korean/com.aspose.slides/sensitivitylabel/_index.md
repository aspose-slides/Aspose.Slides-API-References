...
| [getSiteId()](#getSiteId--) | 민감도 레이블을 설명하는 정책에 해당하는 Azure Active Directory(Azure AD) 사이트 식별자를 반환하거나 설정합니다. |
| [setSiteId(UUID value)](#setSiteId-java.util.UUID-) | 민감도 레이블을 설명하는 정책에 해당하는 Azure Active Directory(Azure AD) 사이트 식별자를 반환하거나 설정합니다. |
...
| [getAssignmentMethodType()](#getAssignmentMethodType--) | 민감도 레이블의 할당 방식을 반환하거나 설정합니다. |
| [setAssignmentMethodType(int value)](#setAssignmentMethodType-int-) | 민감도 레이블의 할당 방식을 반환하거나 설정합니다. |
| [getContentMarkTypes()](#getContentMarkTypes--) | 파일에 적용되어야 하는 콘텐츠 표시 유형 목록을 반환합니다. |
### getId() {#getId--}
```
...
민감도 레이블을 설명하는 정책에 해당하는 Azure Active Directory(Azure AD) 사이트 식별자를 반환하거나 설정합니다. 읽기/쓰기 java.util.UUID.
...
민감도 레이블의 할당 방식을 반환하거나 설정합니다. 읽기/쓰기 [SensitivityLabelAssignmentType](../../com.aspose.slides/sensitivitylabelassignmenttype).
