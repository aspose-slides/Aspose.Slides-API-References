...
| [getCropLeft()](#getCropLeft--) | 그림의 왼쪽에서 잘라낸 실제 이미지 너비의 백분율을 반환하거나 설정합니다. |
| [setCropLeft(float value)](#setCropLeft-float-) | 그림의 왼쪽에서 잘라낸 실제 이미지 너비의 백분율을 반환하거나 설정합니다. |
| [getCropTop()](#getCropTop--) | 그림의 위쪽에서 잘라낸 실제 이미지 높이의 백분율을 반환하거나 설정합니다. |
| [setCropTop(float value)](#setCropTop-float-) | 그림의 위쪽에서 잘라낸 실제 이미지 높이의 백분율을 반환하거나 설정합니다. |
| [getCropRight()](#getCropRight--) | 그림의 오른쪽에서 잘라낸 실제 이미지 너비의 백분율을 반환하거나 설정합니다. |
| [setCropRight(float value)](#setCropRight-float-) | 그림의 오른쪽에서 잘라낸 실제 이미지 너비의 백분율을 반환하거나 설정합니다. |
| [getCropBottom()](#getCropBottom--) | 그림의 아래쪽에서 잘라낸 실제 이미지 높이의 백분율을 반환하거나 설정합니다. |
| [setCropBottom(float value)](#setCropBottom-float-) | 그림의 아래쪽에서 잘라낸 실제 이미지 높이의 백분율을 반환하거나 설정합니다. |
| [deletePictureCroppedAreas()](#deletePictureCroppedAreas--) | 채우기 그림의 잘라낸 영역을 삭제합니다. |
| [compressImage(boolean deleteCroppedAreasOfImage, int resolution)](#compressImage-boolean-int-) | 모양 크기와 지정된 해상도에 따라 이미지 크기를 줄여 압축합니다. |
| [compressImage(boolean deleteCroppedAreasOfImage, float resolution)](#compressImage-boolean-float-) | 모양 크기와 지정된 해상도에 따라 이미지 크기를 줄여 압축합니다. |
| [getStretchOffsetLeft()](#getStretchOffsetLeft--) | 모양 경계 상자의 왼쪽 가장자리에서 백분율 오프셋으로 정의된 채우기 사각형의 왼쪽 가장자리를 반환하거나 설정합니다. |
| [setStretchOffsetLeft(float value)](#setStretchOffsetLeft-float-) | 모양 경계 상자의 왼쪽 가장자리에서 백분율 오프셋으로 정의된 채우기 사각형의 왼쪽 가장자리를 반환하거나 설정합니다. |
| [getStretchOffsetTop()](#getStretchOffsetTop--) | 모양 경계 상자의 위쪽 가장자리에서 백분율 오프셋으로 정의된 채우기 사각형의 위쪽 가장자리를 반환하거나 설정합니다. |
| [setStretchOffsetTop(float value)](#setStretchOffsetTop-float-) | 모양 경계 상자의 위쪽 가장자리에서 백분율 오프셋으로 정의된 채우기 사각형의 위쪽 가장자리를 반환하거나 설정합니다. |
| [getStretchOffsetRight()](#getStretchOffsetRight--) | 모양 경계 상자의 오른쪽 가장자리에서 백분율 오프셋으로 정의된 채우기 사각형의 오른쪽 가장자리를 반환하거나 설정합니다. |
| [setStretchOffsetRight(float value)](#setStretchOffsetRight-float-) | 모양 경계 상자의 오른쪽 가장자리에서 백분율 오프셋으로 정의된 채우기 사각형의 오른쪽 가장자를 반환하거나 설정합니다. |
| [getStretchOffsetBottom()](#getStretchOffsetBottom--) | 모양 경계 상자의 아래쪽 가장자리에서 백분율 오프셋으로 정의된 채우기 사각형의 아래쪽 가장자를 반환하거나 설정합니다. |
| [setStretchOffsetBottom(float value)](#setStretchOffsetBottom-float-) | 모양 경계 상자의 아래쪽 가장자리에서 백분율 오프셋으로 정의된 채우기 사각형의 아래쪽 가장자를 반환하거나 설정합니다. |
| [getTileOffsetX()](#getTileOffsetX--) | 포인트 단위로 모양 원점에서 텍스처의 수평 오프셋을 반환하거나 설정합니다. |
| [setTileOffsetX(float value)](#setTileOffsetX-float-) | 포인트 단위로 모양 원점에서 텍스처의 수평 오프셋을 반환하거나 설정합니다. |
| [getTileOffsetY()](#getTileOffsetY--) | 포인트 단위로 모양 원점에서 텍스처의 수직 오프셋을 반환하거나 설정합니다. |
| [setTileOffsetY(float value)](#setTileOffsetY-float-) | 포인트 단위로 모양 원점에서 텍스처의 수직 오프셋을 반환하거나 설정합니다. |
| [getTileScaleX()](#getTileScaleX--) | 백분율로 텍스처 채우기의 수평 스케일을 반환하거나 설정합니다. |
| [setTileScaleX(float value)](#setTileScaleX-float-) | 백분율로 텍스처 채우기의 수평 스케일을 반환하거나 설정합니다. |
| [getTileScaleY()](#getTileScaleY--) | 백분율로 텍스처 채우기의 수직 스케일을 반환하거나 설정합니다. |
| [setTileScaleY(float value)](#setTileScaleY-float-) | 백분율로 텍스처 채우기의 수직 스케일을 반환하거나 설정합니다. |
| [getTileAlignment()](#getTileAlignment--) | 텍스처가 모양 내에서 정렬되는 방식을 반환하거나 설정합니다. |
| [setTileAlignment(byte value)](#setTileAlignment-byte-) | 텍스처가 모양 내에서 정렬되는 방식을 반환하거나 설정합니다. |
| [getTileFlip()](#getTileFlip--) | 텍스처 타일을 수평, 수직 또는 두 축 모두에 대해 뒤집습니다. |
| [setTileFlip(int value)](#setTileFlip-int-) | 텍스처 타일을 수평, 수직 또는 두 축 모두에 대해 뒤집습니다. |
...
그림의 왼쪽에서 잘라낸 실제 이미지 너비의 백분율을 반환하거나 설정합니다. 읽기/쓰기  float .
...
그림의 위쪽에서 잘라낸 실제 이미지 높이의 백분율을 반환하거나 설정합니다. 읽기/쓰기  float .
...
그림의 오른쪽에서 잘라낸 실제 이미지 너비의 백분율을 반환하거나 설정합니다. 읽기/쓰기  float .
...
그림의 아래쪽에서 잘라낸 실제 이미지 높이의 백분율을 반환하거나 설정합니다. 읽기/쓰기  float .
...
**반환:**  
[IPPImage](../../com.aspose.slides/ippimage) - 잘라낸 이미지 또는 자를 필요가 없는 경우 원본 이미지.

---

이 메서드는 WMF/EMF 메타파일을 자르면서 래스터 PNG 이미지로 변환합니다.
### compressImage(boolean deleteCroppedAreasOfImage, int resolution) {#compressImage-boolean-int-}
```
public final boolean compressImage(boolean deleteCroppedAreasOfImage, int resolution)
```

모양 크기와 지정된 해상도를 기준으로 이미지 크기를 줄여 압축합니다. 선택적으로 잘라낸 영역도 삭제합니다.
...
> CompressImage
> ``` 메서드는 대상 해상도를 설정하고 잘라낸 영역을 제거하여 프레젠테이션의 이미지 크기를 줄입니다:  
>   
>  Presentation presentation = new Presentation("demo.pptx");
>  try {
>      ISlide slide = presentation.getSlides().get_Item(0);
...
> CompressImage
> ```
 메서드를 사용하여 대상 해상도를 설정하고 잘라낸 영역을 제거함으로써 프레젠테이션의 이미지 크기를 줄이는 방법을 보여줍니다:
>   
>  Presentation presentation = new Presentation("demo.pptx");
>  try {
>      ISlide slide = presentation.getSlides().get_Item(0);
...
| resolution | float | DPI 단위의 목표 해상도. 이 값은 양수여야 하며 이미지가 어떻게 크기 조정되는지를 정의합니다.
...
**반환값:**
boolean - 이미지가 성공적으로 압축되었는지 여부를 나타내는 boolean 값입니다. 이미지가 크기 조정 또는 잘라내어진 경우 true를 반환하고, 그렇지 않으면 false를 반환합니다.
