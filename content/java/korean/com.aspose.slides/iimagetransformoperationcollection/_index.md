...
| 메서드 | 설명 |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | 컬렉션에서 인덱스로 [IImageTransformOperation](../../com.aspose.slides/iimagetransformoperation) 를 반환합니다. |
...
컬렉션에서 인덱스로 [IImageTransformOperation](../../com.aspose.slides/iimagetransformoperation) 를 반환합니다.
...
**반환값:**
[IAlphaBiLevel](../../com.aspose.slides/ialphabilevel) - 컬렉션에 새 이미지 효과의 인덱스.
...
**반환값:**
[IAlphaCeiling](../../com.aspose.slides/ialphaceiling) - 컬렉션에 새 이미지 효과의 인덱스.
...
**반환값:**
[IAlphaFloor](../../com.aspose.slides/ialphafloor) - 컬렉션에 새 이미지 효과의 인덱스.
...
**반환값:**
[IAlphaInverse](../../com.aspose.slides/ialphainverse) - 컬렉션에 새 이미지 효과의 인덱스.
...
**반환값:**
[IAlphaModulate](../../com.aspose.slides/ialphamodulate) - 컬렉션에 새 이미지 효과의 인덱스.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| amount | float | 알파를 스케일링할 백분율 양. |

**반환값:**
[IAlphaModulateFixed](../../com.aspose.slides/ialphamodulatefixed) - 컬렉션에 새 이미지 효과의 인덱스.
...
**반환값:**
[IAlphaReplace](../../com.aspose.slides/ialphareplace) - 컬렉션에 새 이미지 효과의 인덱스.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| threshold | float | Bi-Level 효과의 휘도 임계값. 임계값 이상인 값은 흰색으로 설정되고, 임계값 미만인 값은 검은색으로 설정됩니다. |

**반환값:**
[IBiLevel](../../com.aspose.slides/ibilevel) - 컬렉션에 새 이미지 효과의 인덱스.
...
| --- | --- | --- |
| radius | double | 블러 반경. |
| grow | boolean | 블러링 결과 객체의 경계가 확대되는지 여부를 지정합니다. true이면 경계가 확대되고 false이면 확대되지 않습니다. |

**반환값:**
[IBlur](../../com.aspose.slides/iblur) - 컬렉션에 새 이미지 효과의 인덱스.
...
**반환값:**
[IColorChange](../../com.aspose.slides/icolorchange) - 컬렉션에 새 이미지 효과의 인덱스.
...
**반환값:**
[IColorReplace](../../com.aspose.slides/icolorreplace) - 컬렉션에 새 이미지 효과의 인덱스.
...
**반환값:**
[IDuotone](../../com.aspose.slides/iduotone) - 컬렉션에 새 이미지 효과의 인덱스.
...
**반환값:**
[IFillOverlay](../../com.aspose.slides/ifilloverlay) - 컬렉션에 새 이미지 효과의 인덱스.
...
**반환값:**
[IGrayScale](../../com.aspose.slides/igrayscale) - 컬렉션에 새 이미지 효과의 인덱스.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| hue | float | 색조가 조정되는 각도(도). |
| saturation | float | 채도가 조정되는 백분율. |
| luminance | float | 휘도가 조정되는 백분율. |

**반환값:**
[IHSL](../../com.aspose.slides/ihsl) - 컬렉션에 새 이미지 효과의 인덱스.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| brightness | float | 밝기를 변경하는 퍼센트. |
| contrast | float | 대비를 변경하는 퍼센트. |

**반환값:**
[ILuminance](../../com.aspose.slides/iluminance) - 컬렉션에 새 이미지 효과의 인덱스.
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| hue | float | 색조를 적용할 목표 색조. |
| amount | float | 색상 값이 얼마나 이동하는지 지정합니다. |

**반환값:**
[ITint](../../com.aspose.slides/itint) - 컬렉션에 새 이미지 효과의 인덱스.
...
**반환값:**
[IBrightnessContrast](../../com.aspose.slides/ibrightnesscontrast) - 컬렉션에 새 이미지 효과의 인덱스.