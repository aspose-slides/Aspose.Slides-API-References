...
description: ChartType을 사용하여 차트와 시리즈에 대한 추가 정보를 얻기 위한 도우미입니다.
type: docs
url: /ko/com.aspose.slides/charttypecharacterizer/
---
**상속:**
java.lang.Object
```
...
ChartType을 통해 차트와 시리즈에 대한 추가 정보를 가져오는 도우미입니다.
...
| 메서드 | 설명 |
| --- | --- |
| [isBar3DChart(int chartType)](#isBar3DChart-int-) | chartType이 bar3DChart 하위 유형 중 하나(3D 열 또는 막대)인 경우 true를 반환합니다. |
| [is2DChart(int chartType)](#is2DChart-int-) | chartType이 2D 차트 유형 중 하나인 경우 true를 반환합니다. |
| [is3DChart(int chartType)](#is3DChart-int-) | chartType이 3D 차트 유형 중 하나인 경우 true를 반환합니다. |
| [isChartTypeColumn(int chartType)](#isChartTypeColumn-int-) | chartType이 Column 하위 유형 중 하나인 경우 true를 반환합니다. |
| [isChartTypeLine(int chartType)](#isChartTypeLine-int-) | chartType이 Line 하위 유형 중 하나인 경우 true를 반환합니다. |
| [isChartTypePie(int chartType)](#isChartTypePie-int-) | chartType이 Pie 하위 유형 중 하나인 경우 true를 반환합니다. |
| [isChartTypeBar(int chartType)](#isChartTypeBar-int-) | chartType이 Bar 하위 유형 중 하나인 경우 true를 반환합니다. |
| [isChartTypeArea(int chartType)](#isChartTypeArea-int-) | chartType이 Area 하위 유형 중 하나인 경우 true를 반환합니다. |
| [isChartTypeScatter(int chartType)](#isChartTypeScatter-int-) | chartType이 Scatter 하위 유형 중 하나인 경우 true를 반환합니다. |
| [isChartTypeStock(int chartType)](#isChartTypeStock-int-) | chartType이 Stock 하위 유형 중 하나인 경우 true를 반환합니다. |
| [isChartTypeSurface(int chartType)](#isChartTypeSurface-int-) | chartType이 Surface 하위 유형 중 하나인 경우 true를 반환합니다. |
| [isChartTypeDoughnut(int chartType)](#isChartTypeDoughnut-int-) | chartType이 Doughnut 하위 유형 중 하나인 경우 true를 반환합니다. |
| [isChartTypeBubble(int chartType)](#isChartTypeBubble-int-) | chartType이 Bubble 하위 유형 중 하나인 경우 true를 반환합니다. |
| [isChartTypeRadar(int chartType)](#isChartTypeRadar-int-) | chartType이 Radar 하위 유형 중 하나인 경우 true를 반환합니다. |
| [isSeriesUsesXValueCoordinate(int seriesType)](#isSeriesUsesXValueCoordinate-int-) | 지정된 시리즈 유형이 X 값 좌표를 사용하는지 여부를 반환합니다. |
| [isSeriesUsesYValueCoordinate(int seriesType)](#isSeriesUsesYValueCoordinate-int-) | 지정된 시리즈 유형이 Y 값 좌표를 사용하는지 여부를 반환합니다. |
| [isSeriesUsesValueCoordinate(int seriesType)](#isSeriesUsesValueCoordinate-int-) | 지정된 시리즈 유형이 값 좌표를 사용하는지 여부를 반환합니다. |
| [isSeriesUsesBubbleSizeCoordinate(int seriesType)](#isSeriesUsesBubbleSizeCoordinate-int-) | 지정된 시리즈 유형에 대해 버블 크기 좌표를 사용할 수 있는지 여부를 반환합니다. |
| [hasSeriesTrendLines(int seriesType)](#hasSeriesTrendLines-int-) | 지정된 시리즈 유형에 대한 시리즈 추세선이 있는지 여부를 반환합니다. |
| [isErrorBarsXAllowed(int seriesType)](#isErrorBarsXAllowed-int-) | 지정된 시리즈 유형에 대해 X 오류 막대가 허용되는지 여부를 반환합니다. |
| [isErrorBarsYAllowed(int seriesType)](#isErrorBarsYAllowed-int-) | 지정된 시리즈 유형에 대해 Y 오류 막대가 허용되는지 여부를 반환합니다. |
...
chartType이 2D 차트 유형 중 하나인 경우 true를 반환합니다.
...
chartType이 3D 차트 유형 중 하나인 경우 true를 반환합니다.
...
chartType이 Pie 하위 유형 중 하나인 경우 true를 반환합니다. 하위 유형 집합은 PowerPoint의 해당 집합에 해당합니다( PowerPoint의 "Change Chart Type" 대화 상자를 참조): [ChartType.BarOfPie](../../com.aspose.slides/charttype\#BarOfPie), [ChartType.ExplodedPie](../../com.aspose.slides/charttype\#ExplodedPie), [ChartType.ExplodedPie3D](../../com.aspose.slides/charttype\#ExplodedPie3D), [ChartType.Pie](../../com.aspose.slides/charttype\#Pie), [ChartType.Pie3D](../../com.aspose.slides/charttype\#Pie3D), [ChartType.PieOfPie](../../com.aspose.slides/charttype\#PieOfPie).
...
chartType이 Stock 하위 유형 중 하나인 경우 true를 반환합니다. 하위 유형 집합은 PowerPoint의 해당 집합에 해당합니다( PowerPoint의 "Change Chart Type" 대화 상자를 참조): [ChartType.HighLowClose](../../com.aspose.slides/charttype\#HighLowClose), [ChartType.OpenHighLowClose](../../com.aspose.slides/charttype\#OpenHighLowClose), [ChartType.VolumeHighLowClose](../../com.aspose.slides/charttype\#VolumeHighLowClose), [ChartType.VolumeOpenHighLowClose](../../com.aspose.slides/charttype\#VolumeOpenHighLowClose).
...
chartType이 Surface 하위 유형 중 하나인 경우 true를 반환합니다. 하위 유형 집합은 PowerPoint의 해당 집합에 해당합니다( PowerPoint의 "Change Chart Type" 대화 상자를 참조): [ChartType.Surface3D](../../com.aspose.slides/charttype\#Surface3D), [ChartType.WireframeSurface3D](../../com.aspose.slides/charttype\#WireframeSurface3D), [ChartType.Contour](../../com.aspose.slides/charttype\#Contour), [ChartType.WireframeContour](../../com.aspose.slides/charttype\#WireframeContour).
...
chartType이 Doughnut 하위 유형 중 하나인 경우 true를 반환합니다. 하위 유형 집합은 PowerPoint의 해당 집합에 해당합니다( PowerPoint의 "Change Chart Type" 대화 상자를 참조): [ChartType.Doughnut](../../com.aspose.slides/charttype\#Doughnut), [ChartType.ExplodedDoughnut](../../com.aspose.slides/charttype\#ExplodedDoughnut).
...
chartType이 Bubble 하위 유형 중 하나인 경우 true를 반환합니다. 하위 유형 집합은 PowerPoint의 해당 집합에 해당합니다( PowerPoint의 "Change Chart Type" 대화 상자를 참조): [ChartType.Bubble](../../com.aspose.slides/charttype\#Bubble), [ChartType.BubbleWith3D](../../com.aspose.slides/charttype\#BubbleWith3D).
...
chartType이 Radar 하위 유형 중 하나인 경우 true를 반환합니다. 하위 유형 집합은 PowerPoint의 해당 집합에 해당합니다( PowerPoint의 "Change Chart Type" 대화 상자를 참조): [ChartType.FilledRadar](../../com.aspose.slides/charttype\#FilledRadar), [ChartType.Radar](../../com.aspose.slides/charttype\#Radar), [ChartType.RadarWithMarkers](../../com.aspose.slides/charttype\#RadarWithMarkers).
...
지정된 시리즈 유형이 X 값 좌표를 사용하는지 여부를 반환합니다.

**매개변수:**
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| seriesType | int | 시리즈 유형. |

**반환값:**
boolean - 사용하면 true, 그렇지 않으면 false.
...
지정된 시리즈 유형이 Y 값 좌표를 사용하는지 여부를 반환합니다.
...
지정된 시리즈 유형에 대해 버블 크기 좌표를 사용할 수 있는지 여부를 반환합니다.
...
**반환값:**
boolean - 사용 가능하면 true, 그렇지 않으면 false.
...
지정된 시리즈 유형에 대한 시리즈 추세선이 있는지 여부를 반환합니다.
...
지정된 시리즈 유형에 대해 X 오류 막대가 허용되는지 여부를 반환합니다.
...
**반환값:**
boolean - 허용하면 true, 그렇지 않으면 false.
...
지정된 시리즈 유형에 대해 Y 오류 막대가 허용되는지 여부를 반환합니다.
