...
description: 다양한 유형의 재정의된 테마에 대한 액세스를 제공하는 클래스의 기본 클래스.
type: docs
...
다양한 유형의 재정의된 테마에 대한 액세스를 제공하는 클래스의 기본 클래스.
## 메서드
...
OverrideTheme가 상속된 유효 테마를 재정의하는지 여부를 결정합니다. OverrideTheme를 재정의에 사용하려면 OverrideTheme.Init*() 메서드를 사용하십시오. OverrideTheme의 재정을 해제하려면 OverrideTheme.Clear() 메서드를 사용하십시오. 읽기 전용 boolean.
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| scheme | [IExtraColorScheme](../../com.aspose.slides/iextracolorscheme) | [IExtraColorScheme](../../com.aspose.slides/iextracolorscheme) 개체. |