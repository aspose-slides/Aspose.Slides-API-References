...
| [getLinearGradientScaled()](#getLinearGradientScaled--) | 그라디언트가 스케일링되는지 여부를 확인합니다. |
| [setLinearGradientScaled(byte value)](#setLinearGradientScaled-byte-) | 그라디언트가 스케일링되는지 여부를 확인합니다. |
...
| [getGradientStops()](#getGradientStops--) | 그라디언트 정지점 컬렉션을 반환합니다. |
### getVersion() {#getVersion--}
```
...
그라디언트가 스케일링되는지 여부를 확인합니다. 읽기/쓰기 [NullableBool](../../com.aspose.slides/nullablebool).
...
그라디언트 정지점 컬렉션을 반환합니다. 읽기 전용 [IGradientStopCollection](../../com.aspose.slides/igradientstopcollection).
