...
type: docs
url: /ko/com.aspose.slides/idatatable/
---
**구현된 모든 인터페이스:**
...
| [hasBorderHorizontal()](#hasBorderHorizontal--) | 차트 데이터 테이블에 수평 셀 경계가 있으면 true. |
| [setBorderHorizontal(boolean value)](#setBorderHorizontal-boolean-) | 차트 데이터 테이블에 수평 셀 경계가 있으면 true. |
| [hasBorderOutline()](#hasBorderOutline--) | 차트 데이터 테이블에 외곽선 경계가 있으면 true. |
| [setBorderOutline(boolean value)](#setBorderOutline-boolean-) | 차트 데이터 테이블에 외곽선 경계가 있으면 true. |
| [hasBorderVertical()](#hasBorderVertical--) | 차트 데이터 테이블에 수직 셀 경계가 있으면 true. |
| [setBorderVertical(boolean value)](#setBorderVertical-boolean-) | 차트 데이터 테이블에 수직 셀 경계가 있으면 true. |
| [getShowLegendKey()](#getShowLegendKey--) | 데이터 레이블 범례 키가 표시되면 true. |
| [setShowLegendKey(boolean value)](#setShowLegendKey-boolean-) | 데이터 레이블 범례 키가 표시되면 true. |
### getFormat() {#getFormat--}
```
...
차트 데이터 테이블에 수평 셀 경계가 있으면 true. 읽기/쓰기 부울.
...
차트 데이터 테이블에 외곽선 경계가 있으면 true. 읽기/쓰기 부울.
...
차트 데이터 테이블에 수직 셀 경계가 있으면 true. 읽기/쓰기 부울.
...
데이터 레이블 범례 키가 표시되면 true. 읽기/쓰기 부울.
