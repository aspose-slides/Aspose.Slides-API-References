...
type: docs
url: /ko/com.aspose.slides/revealtransition/
---
**상속:**  
...
| [getThroughBlack()](#getThroughBlack--) | 전환이 검은색을 통해 페이드되는지 여부를 지정합니다. |
| [setThroughBlack(boolean value)](#setThroughBlack-boolean-) | 전환이 검은색을 통해 페이드되는지 여부를 지정합니다. |
