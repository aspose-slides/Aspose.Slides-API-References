...
description: OpenXml 프레젠테이션(PPTX, PPSX, POTX, PPTM, PPSM, POTM) 저장 옵션을 나타냅니다.
type: docs
...
OpenXml 프레젠테이션(PPTX, PPSX, POTX, PPTM, PPSM, POTM) 저장 옵션을 나타냅니다.
...
프레젠테이션 썸네일을 새로 고칠지 여부를 지정합니다. 읽기/쓰기 부울. 기본값은 **true**.
...
높은 압축 레벨은 파일을 더 작게 만들지만 처리 시간이 더 많이 필요합니다. 실제 압축 비율은 프레젠테이션 내용에 따라 다릅니다.
