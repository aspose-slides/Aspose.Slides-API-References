...
| [getShowPageBorder()](#getShowPageBorder--) | 페이지 주변에 테두리를 표시할지 여부를 지정합니다. |
| [setShowPageBorder(boolean value)](#setShowPageBorder-boolean-) | 페이지 주변에 테두리를 표시할지 여부를 지정합니다. |
...
| [getShowPageStepper()](#getShowPageStepper--) | 페이지 단계 조절기를 표시/숨깁니다. |
| [setShowPageStepper(boolean value)](#setShowPageStepper-boolean-) | 페이지 단계 조절기를 표시/숨깁니다. |
| [getShowSearch()](#getShowSearch--) | 검색 섹션을 표시/숨깁니다. |
| [setShowSearch(boolean value)](#setShowSearch-boolean-) | 검색 섹션을 표시/숨깁니다. |
| [getShowTopPane()](#getShowTopPane--) | 전체 상단 패널을 표시/숨깁니다. |
| [setShowTopPane(boolean value)](#setShowTopPane-boolean-) | 전체 상단 패널을 표시/숨깁니다. |
| [getShowBottomPane()](#getShowBottomPane--) | 하단 패널을 표시/숨깁니다. |
| [setShowBottomPane(boolean value)](#setShowBottomPane-boolean-) | 하단 패널을 표시/숨깁니다. |
| [getShowLeftPane()](#getShowLeftPane--) | 왼쪽 패널을 표시/숨깁니다. |
| [setShowLeftPane(boolean value)](#setShowLeftPane-boolean-) | 왼쪽 패널을 표시/숨깁니다. |
...
| [getLogoImageBytes()](#getLogoImageBytes--) | 뷰어 오른쪽 상단에 로고로 표시되는 이미지입니다. |
| [setLogoImageBytes(byte[] value)](#setLogoImageBytes-byte---) | 뷰어 오른쪽 상단에 로고로 표시되는 이미지입니다. |
...
페이지 단계 조절기를 표시/숨깁니다. flashvars에서 재정의할 수 있습니다. 기본값은 true입니다.
...
전체 상단 패널을 표시/숨깁니다. flashvars에서 재정의할 수 있습니다. 기본값은 true입니다.
...
하단 패널을 표시/숨깁니다. flashvars에서 재정의할 수 있습니다. 기본값은 true입니다.
...
왼쪽 패널을 표시/숨깁니다. flashvars에서 재정의할 수 있습니다. 기본값은 true입니다.
...
뷰어 오른쪽 상단에 로고로 표시되는 이미지입니다. 이미지 크기는 32x64 픽셀 PNG여야 하며, 그렇지 않으면 로고가 올바르게 표시되지 않을 수 있습니다.
