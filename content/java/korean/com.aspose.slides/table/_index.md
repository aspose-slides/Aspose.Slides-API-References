...
| [getRows()](#getRows--) | 행의 컬렉션을 반환합니다. |
| [getColumns()](#getColumns--) | 열의 컬렉션을 반환합니다. |
...
| [getRightToLeft()](#getRightToLeft--) | 표가 오른쪽에서 왼쪽으로 읽는 순서를 갖는지 여부를 확인합니다. |
| [setRightToLeft(boolean value)](#setRightToLeft-boolean-) | 표가 오른쪽에서 왼쪽으로 읽는 순서를 갖는지 여부를 확인합니다. |
| [getFirstRow()](#getFirstRow--) | 표의 첫 번째 행을 특수 서식으로 그려야 하는지 여부를 확인합니다. |
| [setFirstRow(boolean value)](#setFirstRow-boolean-) | 표의 첫 번째 행을 특수 서식으로 그려야 하는지 여부를 확인합니다. |
| [getFirstCol()](#getFirstCol--) | 표의 첫 번째 열을 특수 서식으로 그려야 하는지 여부를 확인합니다. |
| [setFirstCol(boolean value)](#setFirstCol-boolean-) | 표의 첫 번째 열을 특수 서식으로 그려야 하는지 여부를 확인합니다. |
| [getLastRow()](#getLastRow--) | 표의 마지막 행을 특수 서식으로 그려야 하는지 여부를 확인합니다. |
| [setLastRow(boolean value)](#setLastRow-boolean-) | 표의 마지막 행을 특수 서식으로 그려야 하는지 여부를 확인합니다. |
| [getLastCol()](#getLastCol--) | 표의 마지막 열을 특수 서식으로 그려야 하는지 여부를 확인합니다. |
| [setLastCol(boolean value)](#setLastCol-boolean-) | 표의 마지막 열을 특수 서식으로 그려야 하는지 여부를 확인합니다. |
| [getHorizontalBanding()](#getHorizontalBanding--) | 짝수 행을 다른 서식으로 그려야 하는지 여부를 확인합니다. |
| [setHorizontalBanding(boolean value)](#setHorizontalBanding-boolean-) | 짝수 행을 다른 서식으로 그려야 하는지 여부를 확인합니다. |
| [getVerticalBanding()](#getVerticalBanding--) | 짝수 열을 다른 서식으로 그려야 하는지 여부를 확인합니다. |
| [setVerticalBanding(boolean value)](#setVerticalBanding-boolean-) | 짝수 열을 다른 서식으로 그려야 하는지 여부를 확인합니다. |
...
| [getFillFormat()](#getFillFormat--) | 표에 대한 채우기 서식을 포함하는 TableFormat.FillFormat 객체를 반환합니다. |
...
행의 컬렉션을 반환합니다. 읽기 전용 [IRowCollection](../../com.aspose.slides/irowcollection).
...
열의 컬렉션을 반환합니다. 읽기 전용 [IColumnCollection](../../com.aspose.slides/icolumncollection).
...
표가 오른쪽에서 왼쪽으로 읽는 순서를 갖는지 여부를 확인합니다. 읽기-쓰기 boolean .
...
표의 첫 번째 행을 특수 서식으로 그려야 하는지 여부를 확인합니다. 읽기/쓰기 boolean .
...
표의 첫 번째 열을 특수 서식으로 그려야 하는지 여부를 확인합니다. 읽기/쓰기 boolean .
...
표의 마지막 행을 특수 서식으로 그려야 하는지 여부를 확인합니다. 읽기/쓰기 boolean .
...
표의 마지막 열을 특수 서식으로 그려야 하는지 여부를 확인합니다. 읽기/쓰기 boolean .
...
짝수 행을 다른 서식으로 그려야 하는지 여부를 확인합니다. 읽기/쓰기 boolean .
...
짝수 열을 다른 서식으로 그려야 하는지 여부를 확인합니다. 읽기/쓰기 boolean .
...
표에 대한 채우기 서식을 포함하는 TableFormat.FillFormat 객체를 반환합니다. 읽기 전용 [IFillFormat](../../com.aspose.slides/ifillformat).
