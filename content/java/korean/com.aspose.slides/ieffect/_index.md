...
| [getSound()](#getSound--) | 효과에 대한 포함된 사운드를 정의했습니다. |
| [setSound(IAudio value)](#setSound-com.aspose.slides.IAudio-) | 효과에 대한 포함된 사운드를 정의했습니다. |
...
| [getAfterAnimationType()](#getAfterAnimationType--) | 효과에 대한 후속 애니메이션 유형을 정의했습니다. |
| [setAfterAnimationType(int value)](#setAfterAnimationType-int-) | 효과에 대한 후속 애니메이션 유형을 정의했습니다. |
| [getAfterAnimationColor()](#getAfterAnimationColor--) | 효과에 대한 후속 애니메이션 색상을 정의했습니다. |
| [setAfterAnimationColor(IColorFormat value)](#setAfterAnimationColor-com.aspose.slides.IColorFormat-) | 효과에 대한 후속 애니메이션 색상을 정의했습니다. |
...
| [getDelayBetweenTextParts()](#getDelayBetweenTextParts--) | 애니메이션 텍스트 파트(단어 또는 문자) 사이의 지연을 정의합니다. |
| [setDelayBetweenTextParts(float value)](#setDelayBetweenTextParts-float-) | 애니메이션 텍스트 파트(단어 또는 문자) 사이의 지연을 정의합니다. |
...
효과에 대한 포함된 사운드를 정의했습니다. 읽기/쓰기 [IAudio](../../com.aspose.slides/iaudio).
...
효과에 대한 후속 애니메이션 유형을 정의했습니다. 읽기/쓰기  AfterAnimationType (\#getAfterAnimationType.getAfterAnimationType/\#setAfterAnimationType(int).setAfterAnimationType(int)).
...
효과에 대한 후속 애니메이션 색상을 정의했습니다. 읽기/쓰기 [IColorFormat](../../com.aspose.slides/icolorformat).
...
효과에 대한 텍스트 애니메이션 유형을 정의합니다. 모양 텍스트는 문자별, 단어별 또는 전체 한 번에 애니메이션될 수 있습니다. 읽기/쓰기  AnimateTextType (\#getAnimateTextType.getAnimateTextType/\#setAnimateTextType(int).setAnimateTextType(int)).
...
애니메이션 텍스트 파트(단어 또는 문자) 사이의 지연을 정의합니다. 양수 값은 효과 지속 시간의 백분율을 지정하고, 음수 값은 초 단위 지연을 지정합니다. 읽기/쓰기  float .
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // 효과의 Animate text 유형을 "By word" 로 변경합니다.
