...
--------------------
같은 셀에서 만든 차트 시리즈가 이미 컬렉션에 존재한다면 메서드는 아무 것도 추가하지 않고 해당 인덱스를 반환합니다. |

**반환:**  
[IChartSeries](../../com.aspose.slides/ichartseries) - 컬렉션에 이미 존재하는 시리즈이거나 추가된 차트 시리즈.
...
**반환:**  
int - 값이 전체 CollectionBase 내에서 처음 발견된 위치의 0 기반 인덱스이며, 찾지 못하면 -1을 반환합니다.
