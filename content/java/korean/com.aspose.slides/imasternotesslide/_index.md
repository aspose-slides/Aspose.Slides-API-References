...
| [getDrawingGuides()](#getDrawingGuides--) | 마스터 노트 슬라이드에 대한 드로잉 가이드 컬렉션을 반환합니다. |
...
마스터 노트 슬라이드에 대한 드로잉 가이드 컬렉션을 반환합니다. 읽기 전용 [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
