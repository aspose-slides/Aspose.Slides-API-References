...
| [getTextFrameFormat()](#getTextFrameFormat--) | 이 TextFrame 객체에 대한 서식 객체를 반환합니다. |
| [getHyperlinkQueries()](#getHyperlinkQueries--) | 포함된 하이퍼링크에 쉽게 접근할 수 있도록 제공합니다. |
| [getParentShape()](#getParentShape--) | 부모 객체가 IShape 인터페이스를 구현하지 않는 경우 상위 도형을 반환하거나 null을 반환합니다. 읽기 전용 [IShape](../../com.aspose.slides/ishape). |
| [getParentCell()](#getParentCell--) | 부모 객체가 ICell 인터페이스를 구현하지 않으면 상위 셀을 반환하거나 null을 반환합니다. |
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | 모든 단락에서 동일한 서식을 가진 실행을 결합합니다. |
| [highlightText(String text, Color highlightColor)](#highlightText-java.lang.String-java.awt.Color-) | 지정된 색으로 샘플 텍스트와 일치하는 모든 항목을 강조합니다. |
| [splitTextByColumns()](#splitTextByColumns--) | [ITextFrame](../../com.aspose.slides/itextframe)의 텍스트 내용을 문자열 배열로 분할하며, 각 요소는 프레임 내의 별도 텍스트 열에 해당합니다. |
| [highlightText(String text, Color highlightColor, ITextHighlightingOptions options)](#highlightText-java.lang.String-java.awt.Color-com.aspose.slides.ITextHighlightingOptions-) | 지정된 색으로 샘플 텍스트와 일치하는 모든 항목을 강조합니다. |
| [highlightText(String text, Color highlightColor, ITextSearchOptions options, IFindResultCallback callback)](#highlightText-java.lang.String-java.awt.Color-com.aspose.slides.ITextSearchOptions-com.aspose.slides.IFindResultCallback-) | 지정된 색으로 샘플 텍스트와 일치하는 모든 항목을 강조합니다. |
| [highlightRegex(Pattern regex, Color highlightColor, IFindResultCallback callback)](#highlightRegex-java.util.regex.Pattern-java.awt.Color-com.aspose.slides.IFindResultCallback-) | 지정된 색으로 정규 표현식과 일치하는 모든 항목을 강조합니다. |
| [highlightRegex(String regex, Color highlightColor, ITextHighlightingOptions options)](#highlightRegex-java.lang.String-java.awt.Color-com.aspose.slides.ITextHighlightingOptions-) | 지정된 색으로 정규 표현식과 일치하는 모든 항목을 강조합니다. |
...
이 TextFrame 객체에 대한 서식 객체를 반환합니다. 읽기 전용 [ITextFrameFormat](../../com.aspose.slides/itextframeformat).
...
포함된 하이퍼링크에 쉽게 접근할 수 있도록 제공합니다. 읽기 전용 [IHyperlinkQueries](../../com.aspose.slides/ihyperlinkqueries).
...
부모 객체가 IShape 인터페이스를 구현하지 않으면 상위 도형을 반환하거나 null을 반환합니다. 읽기 전용 [IShape](../../com.aspose.slides/ishape).
...
부모 객체가 ICell 인터페이스를 구현하지 않으면 상위 셀을 반환하거나 null을 반환합니다. 읽기 전용 [ICell](../../com.aspose.slides/icell).
...
지정된 색으로 샘플 텍스트와 일치하는 모든 항목을 강조합니다.
...
[ITextFrame](../../com.aspose.slides/itextframe)의 텍스트 내용을 문자열 배열로 분할하며, 각 요소는 프레임 내의 별도 텍스트 열에 해당합니다.
...
**반환:**
java.lang.String[] - 문자열 배열이며, 각 문자열은 [ITextFrame](../../com.aspose.slides/itextframe)에서 특정 열의 텍스트 내용을 나타냅니다.
...
지정된 색으로 정규 표현식과 일치하는 모든 항목을 강조합니다.
...
> ```
> 다음 샘플 코드는 지정된 문자열 하나를 다른 지정된 문자열로 교체하는 방법을 보여줍니다.
>  
>  Presentation presentation = new Presentation("SomePresentation.pptx");
>  try {
>      TextSearchOptions textSearchOptions = new TextSearchOptions();
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| oldText | java.lang.String | 대체될 문자열. |
| newText | java.lang.String | oldText의 모든 발생을 대체할 문자열. |
| options | [ITextSearchOptions](../../com.aspose.slides/itextsearchoptions) | 텍스트 검색 옵션 [ITextSearchOptions](../../com.aspose.slides/itextsearchoptions). |
| callback | [IFindResultCallback](../../com.aspose.slides/ifindresultcallback) | 검색 결과를 받기 위한 콜백 객체 [IFindResultCallback](../../com.aspose.slides/ifindresultcallback). |
...
| 매개변수 | 유형 | 설명 |
| --- | --- | --- |
| regex | java.util.regex.Pattern | 대체할 문자열을 얻기 위한 정규 표현식 java.util.regex.Pattern. |
| newText | java.lang.String | 대체될 문자열의 모든 발생을 교체할 문자열. |
| callback | [IFindResultCallback](../../com.aspose.slides/ifindresultcallback) | 검색 결과를 받기 위한 콜백 객체 [IFindResultCallback](../../com.aspose.slides/ifindresultcallback). |