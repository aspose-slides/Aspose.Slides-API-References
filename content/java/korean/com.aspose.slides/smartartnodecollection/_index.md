...
| [addNodeByPosition(int position)](#addNodeByPosition-int-) | 노드 컬렉션의 선택된 위치에 새 노드를 추가합니다 |
...
**반환값:**
[ISmartArtNode](../../com.aspose.slides/ismartartnode) - 스마트 아트 노드
...
**반환값:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISmartArtNode> - 컬렉션을 순회하는 데 사용할 수 있는 IGenericEnumerator
