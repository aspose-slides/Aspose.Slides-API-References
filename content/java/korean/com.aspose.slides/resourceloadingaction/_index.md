...
| [UserProvided](#UserProvided) | Aspose.Slides는 이미지 데이터로 사용하기 위해 사용자가 [IResourceLoadingArgs.setData(byte[])](../../com.aspose.slides/iresourceloadingargs\#setData-byte---)에서 제공한 바이트 배열을 사용합니다. |
### Default {#Default}
```
...
Aspose.Slides는 이미지 데이터로 사용하기 위해 사용자가 [IResourceLoadingArgs.setData(byte[])](../../com.aspose.slides/iresourceloadingargs\#setData-byte---)에서 제공한 바이트 배열을 사용합니다.