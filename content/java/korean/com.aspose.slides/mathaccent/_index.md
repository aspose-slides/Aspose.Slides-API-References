...
description: 베이스와 결합 구분 기호로 구성된 악센트 기능을 지정합니다 예: ud835udc4eu0301
type: docs
...
베이스와 결합 구분 기호로 구성된 악센트 기능을 지정합니다 예: \\ud835\\udc4e\\u0301
...
| 생성자 | 설명 |
| --- | --- |
| [MathAccent(IMathElement element)](#MathAccent-com.aspose.slides.IMathElement-) | 지정된 수학 요소에 기본 악센트 문자 값을 적용하는 수학 악센트를 생성합니다 |
| [MathAccent(IMathElement element, char accentCharacter)](#MathAccent-com.aspose.slides.IMathElement-char-) | 지정된 수학 요소에 악센트를 적용하는 수학 악센트를 생성합니다 |
## 메서드

| 메서드 | 설명 |
| --- | --- |
| [getBase()](#getBase--) | 악센트가 적용된 인수 |
| [getCharacter()](#getCharacter--) | 악센트 문자 값은 (U+0300\\u2013U+036F) 또는 (U+20D0\\u2013U+20EF) 범위 내에 있어야 합니다 기본값: 결합된 서머프 악센트 (U+0302) |
| [setCharacter(char value)](#setCharacter-char-) | 악센트 문자 값은 (U+0300\\u2013U+036F) 또는 (U+20D0\\u2013U+20EF) 범위 내에 있어야 합니다 기본값: 결합된 서머프 악센트 (U+0302) |
...
지정된 수학 요소에 악센트를 적용하는 수학 악센트를 생성합니다
...
악센트 문자 값은 (U+0300\\u2013U+036F) 또는 (U+20D0\\u2013U+20EF) 범위 내에 있어야 합니다 기본값: 결합된 서머프 악센트 (U+0302)
