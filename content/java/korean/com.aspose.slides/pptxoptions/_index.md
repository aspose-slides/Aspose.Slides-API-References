...
Presentation 문서가 준수하는 호환성 클래스를 지정합니다. 기본값은 [Conformance.Ecma376\_2006](../../com.aspose.slides/conformance\#Ecma376-2006)입니다.
...
Presentation 문서에 ZIP64 형식을 사용할지 여부를 지정합니다. 기본값은 [Zip64Mode.IfNecessary](../../com.aspose.slides/zip64mode\#IfNecessary)입니다.
...
프레젠테이션 썸네일을 새로 고칠지 여부를 지정합니다. 읽기/쓰기 부울형. 기본값은 **true**입니다.
...
프레젠테이션 문서를 저장할 때 사용되는 압축 수준을 지정합니다. 기본값은 [CompressionLevel.Level6](../../com.aspose.slides/compressionlevel\#Level6)입니다.
...
높은 압축 수준은 파일을 더 작게 만들지만 처리 시간이 더 많이 소요됩니다. 실제 압축 비율은 프레젠테이션 내용에 따라 달라집니다.
