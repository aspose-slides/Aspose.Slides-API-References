...
description: 분자와 분모가 분수막대로 구분되는 분수 객체를 지정합니다.
type: docs
...
분수 객체를 지정합니다. 분자와 분모가 분수막대로 구분됩니다. 분수막대는 분수 속성에 따라 수평 또는 대각선일 수 있습니다. 또한 분수 객체는 하나의 요소를 다른 요소 위에 배치하는 스택 함수도 나타내며, 이 경우 분수막대가 없습니다.
