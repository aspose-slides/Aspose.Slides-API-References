...
Alpha Bi-Level 효과를 나타냅니다. 임계값보다 작은 Alpha(불투명도) 값은 0(완전 투명)으로 변경되고, 임계값 이상인 Alpha 값은 100%(완전 불투명)으로 변경됩니다.
## 메서드
...
| 매개변수 | 형식 | 설명 |
| --- | --- | --- |
| obj | java.lang.Object | 비교할 [AlphaBiLevel](../../com.aspose.slides/alphabilevel). |
