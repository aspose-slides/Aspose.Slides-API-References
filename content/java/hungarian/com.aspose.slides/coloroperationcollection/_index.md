...
description: Színtranszformációs műveleteket tartalmazó gyűjteményt képvisel.
type: docs
...
Színtranszformációs műveleteket tartalmazó gyűjteményt képvisel.
## Módszerek
...
| [insert(int position, int operation, float parameter)](#insert-int-int-float-) | Beszúr egy új műveletet a gyűjteménybe. |
| [insert(int position, int operation)](#insert-int-int-) | Beszúr egy új műveletet a gyűjteménybe. |
...
| [isSynchronized()](#isSynchronized--) | Visszaad egy értéket, amely jelzi, hogy a gyűjtemény hozzáférése szinkronizált-e (szálbiztos). Csak olvasható boolean. |
| [getSyncRoot()](#getSyncRoot--) | Visszaad egy szinkronizációs gyökér elemet. Csak olvasható Object. |
| [deepClone()](#deepClone--) | Létrehoz egy másolatot egy ColorOperationCollection gyűjteményről. |
...
Beszúr egy új műveletet a gyűjteménybe.

**Paraméterek:**
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| position | int | Az index, ahol a művelet be lesz szúrva. |
| operation | int | Művelet típusa. |
| parameter | float | A művelet paramétere. |
...
**Visszatér:**  
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IColorOperation> - A IGenericEnumerator amely a gyűjtemény bejárására használható.
...
Visszaad egy értéket, amely jelzi, hogy a gyűjtemény hozzáférése szinkronizált-e (szálbiztos). Csak olvasható boolean.
...
Létrehoz egy másolatot egy ColorOperationCollection gyűjteményről.
