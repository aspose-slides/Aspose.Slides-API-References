...
description: Egy SmartArt objektum csomópontját reprezentálja
type: docs
...
| Metódus | Leírás |
| --- | --- |
| [getChildNodes()](#getChildNodes--) | Visszaadja a jelenlegi csomópont összes gyermekcsomópontjának gyűjteményét. |
| [getShapes()](#getShapes--) | Visszaadja a csomóponthoz kapcsolódó összes alakzat gyűjteményét. |
...
| [getBulletFillFormat()](#getBulletFillFormat--) | Visszaadja a FillFormat objektumot, amely a csomópont jelölőpontjának kitöltési formázási tulajdonságait tartalmazza. |
...
Visszaadja a jelenlegi csomópont összes gyermekcsomópontjának gyűjteményét. Csak olvasható [ISmartArtNodeCollection](../../com.aspose.slides/ismartartnodecollection).
...
Visszaadja a csomóponthoz kapcsolódó összes alakzat gyűjteményét. Csak olvasható [ISmartArtShapeCollection](../../com.aspose.slides/ismartartshapecollection).
...
Visszaadja a FillFormat objektumot, amely a csomópont jelölőpontjának kitöltési formázási tulajdonságait tartalmazza. Megjegyzés: bizonyos típusú SmartArt elrendezéseknél visszaadhat null értéket, amelyek nem biztosítanak golyókat a csomópontokhoz. Csak olvasható [IFillFormat](../../com.aspose.slides/ifillformat).
...
**Visszatér:**
boolean – true, ha sikeresen eltávolítva, különben false