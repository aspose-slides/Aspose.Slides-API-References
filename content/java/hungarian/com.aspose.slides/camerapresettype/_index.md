...
description: A kamera előre beállított típusát meghatározó állandók.
type: docs
url: /hu/com.aspose.slides/camerapresettype/
---
**Öröklés:**
...
A kamera előre beállított típusát meghatározó állandók.
## Mezők
...
### IsometricOffAxis4Right {#IsometricOffAxis4Right}
```
public static final int IsometricOffMatrix4Right
```
