...
| [getExternalResourceResolver()](#getExternalResourceResolver--) | Visszaadja a visszahívási interfészt, amely az SVG dokumentumok importálása során a külső erőforrások feloldására használható. |
...
Visszaadja a visszahívási interfészt, amely az SVG dokumentumok importálása során a külső erőforrások feloldására használható. Csak olvasható [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver).
...
Visszaadja a megadott SVG alap-URI-ját. Relatív hivatkozások feloldására használható. Csak olvasható String.
