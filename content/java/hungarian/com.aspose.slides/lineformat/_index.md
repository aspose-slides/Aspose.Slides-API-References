...
| [isFormatNotDefined()](#isFormatNotDefined--) | Igaz értéket ad, ha a vonal formátuma nincs definiálva (újonnan létrehozott, alapértelmezett). |
| [getFillFormat()](#getFillFormat--) | Visszaadja a vonal kitöltésformátumát. |
| [getSketchFormat()](#getSketchFormat--) | Visszaadja a vonal vázlatformátumát. |
...
| [getCustomDashPattern()](#getCustomDashPattern--) | Visszaadja vagy beállítja az egyéni szaggatottság mintát. |
| [setCustomDashPattern(float[] value)](#setCustomDashPattern-float---) | Visszaadja vagy beállítja az egyéni szaggatottság mintát. |
| [getCapStyle()](#getCapStyle--) | Visszaadja vagy beállítja a vonal cap (vég) stílusát. |
| [setCapStyle(byte value)](#setCapStyle-byte-) | Visszaadja vagy beállítja a vonal cap (vég) stílusát. |
...
| [getJoinStyle()](#getJoinStyle--) | Visszaadja vagy beállítja a vonalak illesztési stílusát. |
| [setJoinStyle(byte value)](#setJoinStyle-byte-) | Visszaadja vagy beállítja a vonalak illesztési stílusát. |
| [getMiterLimit()](#getMiterLimit--) | Visszaadja vagy beállítja a vonal miter határát. |
| [setMiterLimit(float value)](#setMiterLimit-float-) | Visszaadja vagy beállítja a vonal miter határát. |
...
| [getEffective()](#getEffective--) | Lekéri a vonal hatékony formázási adatait az öröklődés alkalmazásával. |
...
Igaz értéket ad, ha a vonal formátuma nincs definiálva (újonnan létrehozott, alapértelmezett). Csak olvasható  boolean .
...
Visszaadja a vonal kitöltésformátumát. Csak olvasható [ILineFillFormat](../../com.aspose.slides/ilinefillformat).
...
Visszaadja a vonal vázlatformátumát. Csak olvasható [ILineFillFormat](../../com.aspose.slides/ilinefillformat).
...
Visszaadja vagy beállítja a vonal szaggatott stílusát. Olvasás-írás [LineDashStyle](../../com.aspose.slides/linedashstyle).
...
Visszaadja vagy beállítja az egyéni szaggatottság mintát. Olvasás-írás  float[] .
...
Visszaadja vagy beállítja a vonal cap (vég) stílusát. Olvasás-írás [LineCapStyle](../../com.aspose.slides/linecapstyle).
...
Visszaadja vagy beállítja a vonalak illesztési stílusát. Olvasás-írás [LineJoinStyle](../../com.aspose.slides/linejoinstyle).
...
Visszaadja vagy beállítja a vonal miter határát. Olvasás-írás  float .
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| lineFormat | [ILineFormat](../../com.aspose.slides/ilineformat) | Az a LineFormat, amellyel az aktuális LineFormat-et összehasonlítjuk. |

**Visszatér:**  
boolean - **true** ha a megadott LineFormat egyenlő az aktuális LineFormat-tel; egyébként **false**.
...
Lekéri a vonal hatékony formázási adatait az öröklődés alkalmazásával.
