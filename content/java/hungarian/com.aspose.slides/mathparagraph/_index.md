...
| Konstruktor | Leírás |
| --- | --- |
| [MathParagraph()](#MathParagraph--) | Új példányt inicializál a MathParagraph osztályból. |
| [MathParagraph(IMathBlock mathBlock)](#MathParagraph-com.aspose.slides.IMathBlock-) | Új példányt inicializál a MathParagraph osztályból. |
## Metódusok

| Metódus | Leírás |
| --- | --- |
| [getJustification()](#getJustification--) | Bekezdés igazítás alapértelmezett értéke: CenteredAsGroup |
| [setJustification(int value)](#setJustification-int-) | Bekezdés igazítás alapértelmezett értéke: CenteredAsGroup |
...
| [add(IMathBlock mathBlock)](#add-com.aspose.slides.IMathBlock-) | IMathBlock-ot ad a gyűjtemény végéhez. |
| [remove(IMathBlock mathBlock)](#remove-com.aspose.slides.IMathBlock-) | Eltávolítja a megadott objektum első előfordulását a gyűjteményből. |
...
| [insert(int index, IMathBlock mathBlock)](#insert-int-com.aspose.slides.IMathBlock-) | IMathBlock-ot illeszt be a gyűjteménybe a megadott indexnél. |
| [removeAt(int index)](#removeAt-int-) | Eltávolít egy elemet a gyűjtemény megadott indexén. |
| [iterator()](#iterator--) |  |
| [iteratorJava()](#iteratorJava--) |  |
| [writeAsMathMl(OutputStream stream)](#writeAsMathMl-java.io.OutputStream-) | A(z) [MathParagraph](../../com.aspose.slides/mathparagraph) tartalmát MathML-ként menti |
...
Új példányt inicializál a MathParagraph osztályból.
...
Bekezdés igazítás alapértelmezett értéke: CenteredAsGroup
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| index | int | A lekérdezni kívánt elem nulláral kezdődő indexe |

**Visszatérési érték:**
[IMathBlock](../../com.aspose.slides/imathblock) – A matematikai szövegblokk.
...
| --- | --- | --- |
| index | int | A lekérdezni kívánt elem nulláral kezdődő indexe |
| value | [IMathBlock](../../com.aspose.slides/imathblock) | A matematikai szövegblokk. |
...
IMathBlock-ot ad a gyűjtemény végéhez.
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | A matematikai blokk, amelyet a gyűjtemény végéhez adunk hozzá |
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | A gyűjteményből eltávolítandó objektum. |

**Visszatérési érték:**
boolean – true, ha a mathBlock sikeresen eltávolításra került; egyébként false. Ez a metódus false értéket ad vissza, ha a mathBlock nem található a kiinduló gyűjteményben.
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | A gyűjteményben keresendő objektum. |

**Visszatérési érték:**
boolean – true, ha a mathBlock megtalálható a gyűjteményben; egyébként false.
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | A gyűjteményben keresendő elem. |
...
IMathBlock-ot illeszt be a gyűjteménybe a megadott indexnél.
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| index | int | A nulláral kezdődő index, amelynél az elemet be kell szúrni. |
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| index | int | A törlendő elem nulláral kezdődő indexe. |
...
A(z) [MathParagraph](../../com.aspose.slides/mathparagraph) tartalmát MathML-ként menti
