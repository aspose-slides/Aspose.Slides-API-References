...
description: Egy dián lévő hangklipet képvisel.
type: docs
...
| [getPlayMode()](#getPlayMode--) | Visszaadja vagy beállítja a hang lejátszási módját. |
| [setPlayMode(int value)](#setPlayMode-int-) | Visszaadja vagy beállítja a hang lejátszási módját. |
| [getHideAtShowing()](#getHideAtShowing--) | Meghatározza, hogy a AudioFrame rejtett-e. |
| [setHideAtShowing(boolean value)](#setHideAtShowing-boolean-) | Meghatározza, hogy a AudioFrame rejtett-e. |
...
| [getPlayAcrossSlides()](#getPlayAcrossSlides--) | Meghatározza, hogy a hang a diákon keresztül játszódik-e. |
| [setPlayAcrossSlides(boolean value)](#setPlayAcrossSlides-boolean-) | Meghatározza, hogy a hang a diákon keresztül játszódik-e. |
...
| [getLinkPathLong()](#getLinkPathLong--) | Visszaadja vagy beállítja egy hangfájl nevét, amely az AudioFrame-hez van csatolva. |
| [setLinkPathLong(String value)](#setLinkPathLong-java.lang.String-) | Visszaadja vagy beállítja egy hangfájl nevét, amely az AudioFrame-hez van csatolva. |
| [getEmbeddedAudio()](#getEmbeddedAudio--) | Visszaadja vagy beállítja a beágyazott hangobjektumot. |
| [setEmbeddedAudio(IAudio value)](#setEmbeddedAudio-com.aspose.slides.IAudio-) | Visszaadja vagy beállítja a beágyazott hangobjektumot. |
...
| [getVolumeValue()](#getVolumeValue--) | Visszaadja vagy beállítja a hanghangerőt százalékban. |
| [setVolumeValue(float value)](#setVolumeValue-float-) | Visszaadja vagy beállítja a hanghangerőt százalékban. |
...
| [getCaptionTracks()](#getCaptionTracks--) | Lekéri az audio kerethez kapcsolódó lezárt feliratok gyűjteményét. |
...
Visszaadja vagy beállítja a hang lejátszási módját Olvasás/írás [AudioPlayModePreset](../../com.aspose.slides/audioplaymodepreset).
...
Meghatározza, hogy a AudioFrame rejtett-e Olvasás/írás boolean.
...
Meghatározza, hogy a hang a diákon keresztül játszódik-e Olvasás/írás boolean.
...
>       // Beállítja, hogy a hang a diákon keresztül játsszon
>       audioFrame.setPlayAcrossSlides(true);
>       // Beállítja, hogy a hang automatikusan újrainduljon a lejátszás után
>       audioFrame.setRewindAudio(true);
...
Visszaadja vagy beállítja egy hangfájl nevét, amely az AudioFrame-hez van csatolva Olvasás/írás String.
...
Visszaadja vagy beállítja a beágyazott hangobjektumot Olvasás/írás [IAudio](../../com.aspose.slides/iaudio).
...
Lekéri az audio kerethez kapcsolódó lezárt feliratok gyűjteményét. Ez a tulajdonság csak olvasás, és egy [ICaptionsCollection](../../com.aspose.slides/icaptionscollection) ad vissza, amely az összes felirat sávot tartalmaz.
