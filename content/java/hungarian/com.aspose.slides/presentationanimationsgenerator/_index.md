...
A [Presentation](../../com.aspose.slides/presentation) animációinak generátorát reprezentálja.
...
| Konstruktor | Leírás |
| --- | --- |
| [PresentationAnimationsGenerator(Presentation presentation)](#PresentationAnimationsGenerator-com.aspose.slides.Presentation-) | Létrehoz egy új példányt a [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator). |
| [PresentationAnimationsGenerator(Dimension frameSize)](#PresentationAnimationsGenerator-java.awt.Dimension-) | Létrehoz egy új példányt a [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator). |
| [PresentationAnimationsGenerator(Dimension2D frameSize)](#PresentationAnimationsGenerator-java.awt.geom.Dimension2D-) | Létrehoz egy új példányt a [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator). |
## Módszerek
...
| [run(System.Collections.Generic.IGenericEnumerable<ISlide> slides)](#run-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.slides.ISlide--) | Futtatja az animációs események generálását minden diára. |
| [run(System.Collections.Generic.IGenericEnumerable<ISlide> slides, int fps, PresentationPlayer.FrameTick onFrame)](#run-com.aspose.ms.System.Collections.Generic.IGenericEnumerable-com.aspose.slides.ISlide--int-com.aspose.slides.PresentationPlayer.FrameTick-) | Futtatja az animációs események generálását minden diára. |
...
Létrehoz egy új példányt a [PresentationAnimationsGenerator](../../com.aspose.slides/presentationanimationsgenerator).
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| frameSize | java.awt.Dimension | A keret mérete. |
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| frameSize | java.awt.geom.Dimension2D | A keret mérete. |
...
Futtatja az animációs események generálását minden diára.
...
>              player.setFrameTick((sender, args) ->
>              {
>                  // új animációban a képkocka ütemének kezelése
>              });
>              animationsGenerator.run(presentation.getSlides());
>          } finally {
>              if (player != null) player.dispose();
