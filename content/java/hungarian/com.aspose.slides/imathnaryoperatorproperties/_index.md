...
| [getLimitLocation()](#getLimitLocation--) | A határok helye (alsó index és felső index) |
| [setLimitLocation(int value)](#setLimitLocation-int-) | A határok helye (alsó index és felső index) |
...
A határok helye (alsó index és felső index)
