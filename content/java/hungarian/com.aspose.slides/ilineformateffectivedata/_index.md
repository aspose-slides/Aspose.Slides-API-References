...
description: Változtathatatlan objektum, amely a hatékony vonalformázási tulajdonságokat tartalmazza.
type: docs
...
Ez az interfész a [ILineFormat](../../com.aspose.slides/ilineformat) interfésszel együtt használható hatékony formázási értékek visszaadására öröklődés alkalmazásával.
## Methods
