...
type: docs
url: /hu/com.aspose.slides/mathmatrixfactory/
---
**Öröklés:**
java.lang.Object
...
| Módszer | Leírás |
| --- | --- |
| [createMathMatrix(int rowCount, int columnCount)](#createMathMatrix-int-int-) | Létrehoz egy matematikai mátrix |
### MathMatrixFactory() {#MathMatrixFactory--}
```
...
Létrehoz egy matematikai mátrix
...
**Visszatérési érték:**
[IMathMatrix](../../com.aspose.slides/imathmatrix) - új matematikai mátrix