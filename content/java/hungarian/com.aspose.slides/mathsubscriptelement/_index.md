...
description: Megadja az alsó index objektumát, amely egy alapból és egy kisebb méretű alsó indexből áll, amely az alap alá és jobbra van elhelyezve.
type: docs
...
Megadja az alsó index objektumát, amely egy alapból és egy kisebb méretű alsó indexből áll, amely az alap alá és jobbra van elhelyezve.
...
| Konstruktor | Leírás |
| --- | --- |
| [MathSubscriptElement(IMathElement baseArg, IMathElement subScript)](#MathSubscriptElement-com.aspose.slides.IMathElement-com.aspose.slides.IMathElement-) | Új példányt hoz létre a MathSubscriptElement osztályból. |
## Metódusok
