...
description: A diagramok legendájának tulajdonságait reprezentálja.
type: docs
...
Returns or sets the x coordinate of a legend as a fraction of the width of the chart. Olvasás/írás float.
...
Returns or sets the y coordinate of a legend as a fraction of the height of the chart. Olvasás/írás float.
...
Returns or sets the width of a legend as a fraction of the width of the chart. Olvasás/írás float.
...
Returns or sets the height of a legend as a fraction of the height of the chart. Olvasás/írás float.
...
Determines whether other chart elements shall be allowed to overlap legend. Olvasás/írás boolean.
...
Text format. Csak olvasható [IChartTextFormat](../../com.aspose.slides/icharttextformat).
...
Specifies the position of the legend on a chart. Non-NaN values of X, Y, Width, Height properties override effect of this property. Olvasás/írás [LegendPositionType](../../com.aspose.slides/legendpositiontype).
...
Returns the format of a legend. Csak olvasható [IFormat](../../com.aspose.slides/iformat).
...
Returns the chart. Csak olvasható [IChart](../../com.aspose.slides/ichart).
...
Gets legend entries. Csak olvasható [ILegendEntryCollection](../../com.aspose.slides/ilegendentrycollection).
...
Specifies actual x location (left) of the chart element relative to the left top corner of the chart. Call method IChart.validateChartLayout() before to get actual values. Olvasás float.
...
Specifies actual top of the chart element relative to the left top corner of the chart. Call method IChart.validateChartLayout() before to get actual values. Olvasás float.
...
Specifies actual width of the chart element. Call method IChart.validateChartLayout() before to get actual values. Olvasás float.
...
Specifies actual height of the chart element. Call method IChart.validateChartLayout() before to get actual values. Olvasás float.
...
Returns the parent slide of a FillFormat. Csak olvasható [BaseSlide](../../com.aspose.slides/baseslide).
...
Returns the parent presentation of a FillFormat. Csak olvasható [IPresentation](../../com.aspose.slides/ipresentation).
