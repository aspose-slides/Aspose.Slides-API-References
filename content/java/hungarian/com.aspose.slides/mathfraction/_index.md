...
description: Megadja a tört objektumot, amely számláló és nevezőből áll, és egy törtvonal választja el őket.
type: docs
...
Megadja a tört objektumot, amely számláló és nevezőből áll, és egy törtvonal választja el őket. A törtvonal lehet vízszintes vagy átlós, a tört tulajdonságaitól függően. A tört objektumot a stack függvény ábrázolására is használják, amely egy elemet egy másik fölé helyez, törtvonal nélkül.
...
| Módszer | Leírás |
| --- | --- |
| [getFractionType()](#getFractionType--) | Tört típusa Alapértelmezett: Bar |
| [setFractionType(int value)](#setFractionType-int-) | Tört típusa Alapértelmezett: Bar |
...
Tört típusa Alapértelmezett: Bar
