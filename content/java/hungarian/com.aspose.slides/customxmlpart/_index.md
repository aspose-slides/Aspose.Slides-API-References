...
| [getItemId()](#getItemId--) | Megad egy globálisan egyedi azonosítót (GUID), amely egyetlen egyéni XML részt azonosít egy Office Open XML dokumentumban. |
| [setItemId(UUID value)](#setItemId-java.util.UUID-) | Megad egy globálisan egyedi azonosítót (GUID), amely egyetlen egyéni XML részt azonosít egy Office Open XML dokumentumban. |
| [getNamespaceSchemas()](#getNamespaceSchemas--) | Visszaadja az egyéni XML részhez kapcsolódó XML sémákat. |
| [remove()](#remove--) | Eltávolítja az egyéni XML részt a prezentációból. |
...
Megad egy globálisan egyedi azonosítót (GUID), amely egyetlen egyéni XML részt azonosít egy Office Open XML dokumentumban. Csak olvasható java.util.UUID.
...
Visszaadja az egyéni XML részhez kapcsolódó XML sémák gyűjteményét. Csak olvasható String[].
