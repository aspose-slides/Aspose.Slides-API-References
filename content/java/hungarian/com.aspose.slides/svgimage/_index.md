...
description: Egy SVG képet reprezentál.
type: docs
...
| [getExternalResourceResolver()](#getExternalResourceResolver--) | Visszaad egy callback interfészt, amelyet a külső erőforrások feloldására használnak SVG dokumentumok importálása során. |
...
| --- | --- | --- |
| data | byte[] | Svg adat. |
| externalResResolver | [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver) | Egy callback objektum a külső objektumok lekéréséhez. Ha ez a paraméter null, minden külső objektum figyelmen kívül lesz hagyva. |
| baseUri | java.lang.String | A megadott SVG alap URI-ja. Relatív hivatkozások feloldására használatos. |
...
Visszaad egy callback interfészt, amelyet a külső erőforrások feloldására használnak SVG dokumentumok importálása során. Csak olvasható [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver).
...
Visszaadja a megadott SVG alap URI-ját. Relatív hivatkozások feloldására használatos. Csak olvasható String.
