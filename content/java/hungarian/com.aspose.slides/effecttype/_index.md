...
description: Az animációs effektus típusát reprezentálja.
type: docs
url: /hu/com.aspose.slides/effecttype/
---
**Öröklés:**
...
Az animációs effektus típusát jelöli.
## Mezők
...
Appear effektus. Osztály **Entrance** vagy **Exit**.
...
CurveUpDown effektus. Osztály **Entrance** vagy **Exit**.
...
Ascend effektus. Osztály **Entrance** vagy **Exit**.
...
Float effektus felfelé irányuló. Ez az Ascend típus álneve. Osztály **Entrance** vagy **Exit**.
...
Blast effektus. Osztály **Emphasis**.
...
Blinds effektus. Osztály **Entrance** vagy **Exit**.
...
Blink effektus. Osztály **Emphasis**.
...
BoldFlash effektus. Osztály **Emphasis**.
...
BoldReveal effektus. Osztály **Emphasis**.
...
Boomerang effektus. Osztály **Entrance** vagy **Exit**.
...
Bounce effektus. Osztály **Entrance** vagy **Exit**.
...
Box effektus. Osztály **Entrance** vagy **Exit**.
...
BrushOnColor effektus. Osztály **Emphasis**.
...
BrushOnUnderline effektus. Osztály **Emphasis**.
...
CenterRevolve effektus. Osztály **Entrance** vagy **Exit**.
...
ChangeFillColor effektus. Osztály **Emphasis**.
...
ChangeFont effektus. Osztály **Emphasis**.
...
ChangeFontColor effektus. Osztály **Emphasis**.
...
ChangeFontSize effektus. Osztály **Emphasis**.
...
ChangeLineColor effektus. Osztály **Emphasis**.
...
Checkerboard effektus. Osztály **Entrance** vagy **Exit**.
...
ColorBlend effektus. Osztály **Entrance** vagy **Exit**.
...
ColorWave effektus. Osztály **Emphasis**.
...
ComplementaryColor effektus. Osztály **Emphasis**.
...
ComplementaryColor2 effektus. Osztály **Emphasis**.
...
Compress effektus. Osztály **Entrance** vagy **Exit**.
...
ContrastingColor effektus. Osztály **Emphasis**.
...
Crawl effektus. Osztály **Entrance** vagy **Exit**.
...
Credits effektus. Osztály **Entrance** vagy **Exit**.
...
Darken effektus. Osztály **Emphasis**.
...
Desaturate effektus. Osztály **Emphasis**.
...
Descend effektus. Osztály **Entrance** vagy **Exit**.
...
Float effektus lefelé irányuló. Ez az Descend típus álneve. Osztály **Entrance** vagy **Exit**.
...
Diamond effektus. Osztály **Entrance** vagy **Exit**.
...
Dissolve effektus. Osztály **Entrance** vagy **Exit**.
...
Expand effektus. Osztály **Entrance** vagy **Exit**.
...
Fade effektus. Osztály **Entrance** vagy **Exit**.
...
FadedSwivel efektus. Osztály **Entrance** vagy **Exit**.
...
FadedZoom efektus. Osztály **Entrance** vagy **Exit**.
...
FlashBulb effektus. Osztály **Emphasis**.
...
FlashOnce effektus. Osztály **Entrance** vagy **Exit**.
...
Flicker effektus. Osztály **Emphasis**.
...
Flip effektus. Osztály **Entrance** vagy **Exit**.
...
Float effektus. Osztály **Entrance** vagy **Exit**.
...
Fly effektus. Osztály **Entrance** vagy **Exit**.
...
Fold effektus. Osztály **Entrance** vagy **Exit**.
...
Glide effektus. Osztály **Entrance** vagy **Exit**.
...
GrowAndTurn effektus. Osztály **Entrance** vagy **Exit**.
...
GrowShrink effektus. Osztály **Emphasis**.
...
GrowWithColor effektus. Osztály **Emphasis**.
...
Lighten effektus. Osztály **Emphasis**.
...
LightSpeed effektus. Osztály **Entrance** vagy **Exit**.
...
MediaPause effektus. Osztály **Media**.
...
MediaPlay effektus. Osztály **Media**.
...
MediaStop effektus. Osztály **Media**.
...
Path4PointStar effektus. Osztály **Path**.
...
Path5PointStar effektus. Osztály **Path**.
...
Path6PointStar effektus. Osztály **Path**.
...
Path8PointStar effektus. Osztály **Path**.
...
PathArcDown effektus. Osztály **Path**.
...
PathArcLeft hatás. Osztály **Path**.
...
PathArcRight hatás. Osztály **Path**.
...
PathBounceLeft hatás. Osztály **Path**.
...
PathBounceRight hatás. Osztály **Path**.
...
PathBuzzsaw hatás. Osztály **Path**.
...
PathCrescentMoon hatás. Osztály **Path**.
...
PathCurvedSquare hatás. Osztály **Path**.
...
PathCurvedX hatás. Osztály **Path**.
...
PathCurvyLeft hatás. Osztály **Path**.
...
PathCurvyRight hatás. Osztály **Path**.
...
PathCurvyStar hatás. Osztály **Path**.
...
PathDecayingWave hatás. Osztály **Path**.
...
PathDiagonalDownRight hatás. Osztály **Path**.
...
PathDiagonalUpRight hatás. Osztály **Path**.
...
PathDiamond hatás. Osztály **Path**.
...
PathEqualTriangle hatás. Osztály **Path**.
...
PathFigure8Four hatás. Osztály **Path**.
...
PathFootball hatás. Osztály **Path**.
...
PathHeartbeat hatás. Osztály **Path**.
...
PathHexagon hatás. Osztály **Path**.
...
PathHorizontalFigure8 hatás. Osztály **Path**.
...
PathInvertedSquare hatás. Osztály **Path**.
...
PathInvertedTriangle hatás. Osztály **Path**.
...
PathLoopdeLoop hatás. Osztály **Path**.
...
PathNeutron hatás. Osztály **Path**.
...
PathOctagon hatás. Osztály **Path**.
...
PathParallelogram hatás. Osztály **Path**.
...
PathPentagon hatás. Osztály **Path**.
...
PathPointyStar hatás. Osztály **Path**.
...
PathRightTriangle hatás. Osztály **Path**.
...
PathSCurve1 hatás. Osztály **Path**.
...
PathSCurve2 hatás. Osztály **Path**.
...
PathSineWave hatás. Osztály **Path**.
...
PathSpiralLeft hatás. Osztály **Path**.
...
PathSpiralRight hatás. Osztály **Path**.
...
PathStairsDown hatás. Osztály **Path**.
...
PathTeardrop hatás. Osztály **Path**.
...
PathTrapezoid hatás. Osztály **Path**.
...
PathTurnDown hatás. Osztály **Path**.
...
PathTurnRight hatás. Osztály **Path**.
...
PathTurnUpRight hatás. Osztály **Path**.
...
PathVerticalFigure8 hatás. Osztály **Path**.
...
Peek hatás. Osztály **Entrance** vagy **Exit**.
...
Pinwheel hatás. Osztály **Entrance** vagy **Exit**.
...
Plus hatás. Osztály **Entrance** vagy **Exit**.
...
RandomBars hatás. Osztály **Entrance** vagy **Exit**.
...
RandomEffects hatás. Osztály **Entrance** vagy **Exit**.
...
RandomEffects hatás. Osztály **Entrance**.
...
Shimmer hatás. Osztály **Emphasis**.
...
Spinner hatás. Osztály **Emphasis**.
...
Spiral hatás. Osztály **Entrance** vagy **Exit**.
...
Split hatás. Osztály **Entrance** vagy **Exit**.
...
Stretch hatás. Osztály **Entrance** vagy **Exit**.
...
StyleEmphasis hatás. Osztály **Emphasis**.
...
Swish hatás. Osztály **Entrance** vagy **Exit**.
...
Swivel hatás. Osztály **Entrance** vagy **Exit**.
...
Transparency hatás. Osztály **Emphasis**.
...
Unfold hatás. Osztály **Entrance** vagy **Exit**.
...
VerticalGrow hatás. Osztály **Emphasis**.
...
Wedge hatás. Osztály **Entrance** vagy **Exit**.
...
Whip hatás. Osztály **Entrance** vagy **Exit**.
...
Magnify hatás. Osztály **Entrance** vagy **Exit**.
...
Zoom hatás. Osztály **Entrance** vagy **Exit**.
...
OLEObjectShow hatás. Osztály **OLEActionVerbs**.
...
OLEObjectEdit hatás. Osztály **OLEActionVerbs**.
...
OLEObjectOpen hatás. Osztály **OLEActionVerbs**.
