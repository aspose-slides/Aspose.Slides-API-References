...
description: Az adatpont szintjét képviseli.
type: docs
...
Az adatpont szintjét képviseli. A Treemap és a Sunburst diagramokra vonatkozik.
## Metódusok

| Metódus | Leírás |
| --- | --- |
| [getFormat()](#getFormat--) | Formázási tulajdonságokat képviseli az adatpont szintjén. |
| [getLabel()](#getLabel--) | Az adatpont szintjének adatcímkéjét képviseli. |
### getFormat() {#getFormat--}
```
...
Az adatpont szintjének formázási tulajdonságait képviseli. Olvasás/írás [IFormat](../../com.aspose.slides/iformat).
...
Az adatpont szintjének adatcímkéjét képviseli. A Treemap és a Sunburst sorozattípusokra vonatkozik. Csak olvasható [IDataLabel](../../com.aspose.slides/idatalabel).
