...
description: Képkitöltési stílust reprezentál.
type: docs
...
>      // Törli a PictureFrame kép vágott területeit
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| deleteCroppedAreasOfImage | boolean | Ha igaz, a metódus eltávolítja a kép vágott területeit, ami tovább csökkentheti a méretét. |
| resolution | int | A tömörítés célfelbontása, amely a [PicturesCompression](../../com.aspose.slides/picturescompression) felsorolt típus egyik értékeként van megadva. |
...
**Visszatér:**
boolean - Logikai érték, amely jelzi, hogy a kép sikeresen tömörítve lett-e. Igaz értéket ad vissza, ha a képet átméretezték vagy levágták, egyébként hamis.
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| deleteCroppedAreasOfImage | boolean | Ha true, a metódus eltávolítja a kép vágott területeit, ami tovább csökkentheti a méretét. |
...
**Visszatér:**
boolean - logikai érték, amely jelzi, hogy a képet sikeresen tömörítették-e. Igaz értéket ad vissza, ha a képet átméretezték vagy levágták, egyébként hamis.
...
Alapértelmezett érték: [TileFlip.NoFlip](../../com.aspose.slides/tileflip\#NoFlip).
