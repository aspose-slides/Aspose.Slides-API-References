...
>      shape.getTextFrame().getParagraphs().get_Item(0).getParagraphFormat().getDefaultPortionFormat().setFontHeight(64);
>      // Állítsa be a FillFormat.FillType értékét FillType.Gradient-re és határozza meg a gradiensek tulajdonságait
...
>      // Állítsa be a TextFrame egy részét és a PortionFormat tulajdonságait
...
>      // állítsa be az "Arch Up" WordArt átalakító hatást
...
| [getExtrusionHeight()](#getExtrusionHeight--) | Visszaadja vagy beállítja egy extrudálás effektus magasságát. |
| [setExtrusionHeight(double value)](#setExtrusionHeight-double-) | Visszaadja vagy beállítja egy extrudálás effektus magasságát. |
...
| [getBevelTop()](#getBevelTop--) | Visszaadja vagy beállítja egy felső 3D perem típusát. |
| [getBevelBottom()](#getBevelBottom--) | Visszaadja vagy beállítja egy alsó 3D perem típusát. |
...
| [getEffective()](#getEffective--) | Megkapja a hatékony 3D formázási adatokat az alkalmazott öröklődéskel. |
### getVersion() {#getVersion--}
```
...
Visszaadja vagy beállítja egy extrudálás effektus magasságát. Olvasás/írás double.
...
Visszaadja vagy beállítja egy felső 3D perem típusát. Csak olvasható [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Visszaadja vagy beállítja egy alsó 3D perem típusát. Csak olvasható [IShapeBevel](../../com.aspose.slides/ishapebevel).
...
Megkapja a hatékony 3D formázási adatokat az alkalmazott öröklődéskel.
...
**Visszatér:** [IThreeDFormatEffectiveData](../../com.aspose.slides/ithreedformateffectivedata) - A [IThreeDFormatEffectiveData](../../com.aspose.slides/ithreedformateffectivedata).