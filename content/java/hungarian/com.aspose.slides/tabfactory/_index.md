...
type: docs
url: /hu/com.aspose.slides/tabfactory/
---
**Öröklés:**
java.lang.Object
...
| Módszer | Leírás |
| --- | --- |
| [createTab(double position, int align)](#createTab-double-int-) | Létrehoz egy új ITab példányt. |
### TabFactory() {#TabFactory--}
```
public TabFactory()
```
...
**Visszatérési érték:**
[ITab](../../com.aspose.slides/itab) - Létrehozott tab.