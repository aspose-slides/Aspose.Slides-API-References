...
description: A tulajdonság hatásának viselkedését reprezentálja.
type: docs
url: /hu/com.aspose.slides/propertyeffect/
---
**Öröklés:**  
...
| [getTo()](#getTo--) | Megadja az animáció befejező értékét. |
| [setTo(String value)](#setTo-java.lang.String-) | Megadja az animáció befejező értékét. |
| [getBy()](#getBy--) | Megadja az animáció relatív eltolási értékét annak pozíciójához képest az animáció kezdete előtt. |
| [setBy(String value)](#setBy-java.lang.String-) | Megadja az animáció relatív eltolási értékét annak pozíciójához képest az animáció kezdete előtt. |
| [getValueType()](#getValueType--) | Megadja egy tulajdonságérték típusát. |
| [setValueType(int value)](#setValueType-int-) | Megadja egy tulajdonságérték típusát. |
...
Megadja az animáció relatív eltolási értékét annak pozíciójához képest az animáció kezdete előtt. Olvasás/írás String.
...
Megadja egy tulajdonságérték típusát. Olvasás/írás [PropertyValueType](../../com.aspose.slides/propertyvaluetype).
