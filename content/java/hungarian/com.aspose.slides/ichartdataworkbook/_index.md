...
| [getCell(String worksheetName, int row, int column)](#getCell-java.lang.String-int-int-) | Lekéri a cellát, amely használható diagram sorozatokhoz vagy kategóriákhoz |
| [getCell(int worksheetIndex, int row, int column)](#getCell-int-int-int-) | Lekéri a cellát, amely használható diagram sorozatokhoz vagy kategóriákhoz |
| [getCell(int worksheetIndex, String cellName)](#getCell-int-java.lang.String-) | Lekéri a cellát, amely használható diagram sorozatokhoz vagy kategóriákhoz |
| [getCell(int worksheetIndex, String cellName, Object value)](#getCell-int-java.lang.String-java.lang.Object-) | Lekéri a cellát, amely használható diagram sorozatokhoz vagy kategóriákhoz |
| [getCell(int worksheetIndex, int row, int column, Object value)](#getCell-int-int-int-java.lang.Object-) | Lekéri a cellát, amely használható diagram sorozatokhoz vagy kategóriákhoz |
| [clear(int sheetIndex)](#clear-int-) | Törli a munkalapon található összes cella értékét |
...
Lekéri a cellát, amely használható diagram sorozatokhoz vagy kategóriákhoz
...
Törli a munkalapon található összes cella értékét
