...
type: docs
url: /hu/com.aspose.slides/effectformat/
---
**Öröklés:**
...
| [isNoEffects()](#isNoEffects--) | Igaz értéket ad vissza, ha az összes effektus le van tiltva (úgy, ahogy létre lett hozva, alapértelmezett EffectFormat objektum). |
| [getBlurEffect()](#getBlurEffect--) | Elmosódás effektus. |
| [setBlurEffect(IBlur value)](#setBlurEffect-com.aspose.slides.IBlur-) | Elmosódás effektus. |
...
| [getReflectionEffect()](#getReflectionEffect--) | Reflexió. |
| [setReflectionEffect(IReflection value)](#setReflectionEffect-com.aspose.slides.IReflection-) | Reflexió. |
...
| [setBlurEffect(double radius, boolean grow)](#setBlurEffect-double-boolean-) | Beállítja az elmosódási effektust. |
...
| [enableReflectionEffect()](#enableReflectionEffect--) | Engedélyezi a reflexió effektust. |
| [enableSoftEdgeEffect()](#enableSoftEdgeEffect--) | Engedélyezi a lágy él effektust. |
| [disableBlurEffect()](#disableBlurEffect--) | Letiltja az elmosódási effektust. |
...
| [disableReflectionEffect()](#disableReflectionEffect--) | Letiltja a reflexió effektust. |
| [disableSoftEdgeEffect()](#disableSoftEdgeEffect--) | Letiltja a lágy él effektust. |
| [getEffective()](#getEffective--) | Lekéri az effektus formázási adatokat az öröklődés alkalmazásával. |
### getVersion() {#getVersion--}
```
...
Igaz értéket ad vissza, ha az összes effektus le van tiltva (úgy, ahogy létre lett hozva, alapértelmezett EffectFormat objektum). Csak olvasható boolean.
...
Elmosódás effektus. Olvasás/írás [IBlur](../../com.aspose.slides/iblur).
...
Reflexió. Olvasás/írás [IReflection](../../com.aspose.slides/ireflection).
...
Beállítja az elmosódási effektust.
...
Engedélyezi a reflexió effektust.
...
Letiltja az elmosódási effektust.
...
Lekéri az effektus formázási adatokat az öröklődés alkalmazásával.
