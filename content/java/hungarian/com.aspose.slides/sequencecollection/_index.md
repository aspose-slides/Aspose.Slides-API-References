...
| Módszer | Leírás |
| --- | --- |
| [getCount()](#getCount--) | Visszaadja az elemek számát a gyűjteményben. Csak olvasható int. |
...
| [removeAt(int index)](#removeAt-int-) | Eltávolít egy sorozatot a megadott indexen. |
...
Eltávolít egy sorozatot a megadott indexen.

**Paraméterek:**
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| index | int | A törlendő sorozat indexe. |
### clear() {#clear--}
```
...
**Visszatérési érték:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISequence> - Egy IGenericEnumerator, amelyet a gyűjtemény bejárására lehet használni.
...
**Visszatérési érték:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ISequence> - Egy java.util.Iterator a teljes gyűjteményhez.