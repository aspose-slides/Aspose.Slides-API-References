...
| Módszer | Leírás |
| --- | --- |
| [getRow()](#getRow--) | Visszaadja a munkalap sorának indexét, ahol a cella található. |
| [getColumn()](#getColumn--) | Visszaadja a munkalap oszlopának indexét, ahol a cella található. |
| [getValue()](#getValue--) | Lekérdezi vagy beállítja egy cella értékét. |
| [setValue(Object value)](#setValue-java.lang.Object-) | Lekérdezi vagy beállítja egy cella értékét. |
...
| [getChartDataWorksheet()](#getChartDataWorksheet--) | Lekérdezi a munkalapot. |
...
Visszaadja a munkalap sorának indexét, ahol a cella található. Csak olvasható int.
...
Visszaadja a munkalap oszlopának indexét, ahol a cella található. Csak olvasható int.
...
Lekérdezi vagy beállítja egy cella értékét. Olvasás/írás  Object .
...
Lekérdezi a munkalapot. Csak olvasható [IChartDataWorksheet](../../com.aspose.slides/ichartdataworksheet).
...
Lekérdezi vagy beállítja a számok és dátumok beépített megjelenítési formátumát. A beépített számnak a [0..22] vagy [37..49] tartományban kell lennie. Olvasás/írás byte.
...
| Paraméter | Típus | Leírás |
| --- | --- | --- |
| updateValues | boolean | Ha hamis, nincs tényleges számítás. Igaz esetben a lehetséges kivételek ellenőrzése történik. |