...
| Módszer | Leírás |
| --- | --- |
| [getEffective()](#getEffective--) | Lekéri a hatékony táblázatsor formázási tulajdonságait öröklődéssel és a táblázat stílusok alkalmazásával. |
...
Lekéri a hatékony táblázatsor formázási tulajdonságait öröklődéssel és a táblázat stílusok alkalmazásával.
...
Visszatér a szülő IPresentationComponent-re. Csak olvasható [IPresentationComponent](../../com.aspose.slides/ipresentationcomponent).
