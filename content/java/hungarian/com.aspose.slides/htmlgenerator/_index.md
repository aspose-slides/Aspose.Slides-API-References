...
| [addText(String text)](#addText-java.lang.String-) | Egyszerű szöveget ad hozzá a html fájlokhoz, a speciális karaktereket html entitásokkal helyettesítve. |
| [addText(char[] text)](#addText-char---) | Egyszerű szöveget ad hozzá a html fájlokhoz, a speciális karaktereket html entitásokkal helyettesítve. |
| [addText(char[] text, int startIndex, int length)](#addText-char---int-int-) | Egyszerű szöveget ad hozzá a html fájlokhoz, a speciális karaktereket html entitásokkal helyettesítve. |
| [addAttributeValue(String value)](#addAttributeValue-java.lang.String-) | Az attribútum értékét idézőjelek közé teszi és hozzáadja a html fájlhoz. |
| [addAttributeValue(char[] value)](#addAttributeValue-char---) | Az attribútum értékét idézőjelek közé teszi és hozzáadja a html fájlhoz. |
| [addAttributeValue(char[] value, int startIndex, int length)](#addAttributeValue-char---int-int-) | Az attribútum értékét idézőjelek közé teszi és hozzáadja a html fájlhoz. |
...
| [getPreviousSlideIndex()](#getPreviousSlideIndex--) | Visszaadja az előzőleg megjelenített dia indexét, vagy -1-et, ha az első diát jeleníti meg. |
| [getSlideIndex()](#getSlideIndex--) | Visszaadja az aktuálisan megjelenített dia indexét. |
| [getNextSlideIndex()](#getNextSlideIndex--) | Visszaadja a diák indexét, amely a jelenlegi dia után kerül megjelenítésre, vagy -1-et, ha az utolsó diát jeleníti meg. |
...
Egyszerű szöveget ad hozzá a html fájlokhoz, a speciális karaktereket html entitásokkal helyettesítve. A sortörések és a szóközök nem kerülnek helyettesítésre.
...
Az attribútum értékét idézőjelek közé teszi és hozzáadja a html fájlhoz.
...
Visszaadja a dia kép méretét. Csak olvasható java.awt.geom.Dimension2D.
...
Visszaadja az előzőleg megjelenített dia indexét, vagy -1-et, ha az első diát jeleníti meg. Csak olvasható int.
...
Visszaadja az aktuálisan megjelenített dia indexét. Csak olvasható int.
...
Visszaadja a diák indexét, amely a jelenlegi dia után kerül megjelenítésre, vagy -1-et, ha az utolsó diát jeleníti meg. Csak olvasható int.
