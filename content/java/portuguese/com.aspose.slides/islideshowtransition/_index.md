...
Retorna ou define os dados de áudio incorporados. Leitura-escrita [IAudio](../../com.aspose.slides/iaudio).
...
Define ou retorna o modo de som para a transição de slide. Leitura-escrita [TransitionSoundMode](../../com.aspose.slides/transitionsoundmode).
...
Este atributo especifica se o som será repetido até que ocorra o próximo evento de som na apresentação. Leitura-escrita boolean.
...
Especifica se um clique do mouse avançará o slide ou não. Se este atributo não for especificado, assume-se o valor true. Leitura-escrita boolean.
...
Este atributo especifica se a apresentação avançará para o próximo slide após um determinado tempo. Leitura/escrita boolean.
...
> 
>      // Verifica se a bandeira Avançar Slide Após está marcada
>      if (slideTransition.getAdvanceAfter())
>      {
>          // Obtém o valor de Tempo de Avanço de Slide Após
...
Especifica o tempo, em milissegundos, após o qual a transição deve iniciar. Esta configuração pode ser usada em conjunto com o atributo advClick. Se este atributo não for especificado, assume-se que não haverá avanço automático. Leitura-escrita long.
...
Especifica a velocidade de transição que deve ser usada ao transitar do slide atual para o próximo. Leitura-escrita [TransitionSpeed](../../com.aspose.slides/transitionspeed).
...
Tipo de transição. Leitura-escrita [TransitionType](../../com.aspose.slides/transitiontype).
...
Especifica se este som é um som interno ou não. Se este atributo for definido como true, a aplicação geradora será alertada para verificar o atributo name especificado para este som em sua lista de sons internos e poderá então exibir um nome personalizado ou UI conforme necessário. Leitura-escrita boolean.
...
Especifica um nome legível por humanos para o som da transição. A propriedade (\#getSound.getSound/\#setSound(IAudio).setSound(IAudio)) deve ser atribuída para obter ou definir o nome do som. Leitura-escrita String.
...
Obtém ou define a duração do efeito de transição de slide em milissegundos. Leitura/escrita int.
