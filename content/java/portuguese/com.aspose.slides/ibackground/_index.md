...
| Método | Descrição |
| --- | --- |
| [getType()](#getType--) | Retorna um tipo de preenchimento de plano de fundo. |
| [setType(byte value)](#setType-byte-) | Retorna um tipo de preenchimento de plano de fundo. |
...
| [getStyleIndex()](#getStyleIndex--) | Retorna um índice do preenchimento BackgroundType.Themed na coleção de temas de plano de fundo. |
| [setStyleIndex(int value)](#setStyleIndex-int-) | Retorna um índice do preenchimento BackgroundType.Themed na coleção de temas de plano de fundo. |
| [getEffective()](#getEffective--) | Obtém dados de plano de fundo efetivos com a herança aplicada. |
### getType() {#getType--}
```
public abstract byte getType()
```

Retorna um tipo de preenchimento de plano de fundo. Leitura/Gravação [BackgroundType](../../com.aspose.slides/backgroundtype).
...
Retorna um índice do preenchimento BackgroundType.Themed na coleção de temas de plano de fundo. 0 significa sem preenchimento. 1..999 - índice. Leitura/Gravação int.
...
Obtém dados de plano de fundo efetivos com a herança aplicada.

**Retorna:**
[IBackgroundEffectiveData](../../com.aspose.slides/ibackgroundeffectivedata) - Um [IBackgroundEffectiveData](../../com.aspose.slides/ibackgroundeffectivedata).