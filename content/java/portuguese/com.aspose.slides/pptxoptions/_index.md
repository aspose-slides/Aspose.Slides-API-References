...
| [getCompressionLevel()](#getCompressionLevel--) | Especifica o nível de compressão usado ao salvar o documento da apresentação. |
| [setCompressionLevel(int value)](#setCompressionLevel-int-) | Especifica o nível de compressão usado ao salvar o documento da apresentação. |
...
Especifica se a miniatura da apresentação será atualizada. Booleano de leitura/gravação. O valor padrão é **true**.
...
Especifica o nível de compressão usado ao salvar o documento da apresentação. O valor padrão é [CompressionLevel.Level6](../../com.aspose.slides/compressionlevel\#Level6).
