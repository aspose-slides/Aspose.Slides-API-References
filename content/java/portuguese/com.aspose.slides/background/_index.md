...
| [getStyleIndex()](#getStyleIndex--) | Retorna um índice do preenchimento BackgroundType.Themed na coleção de temas de fundo. |
| [setStyleIndex(int value)](#setStyleIndex-int-) | Retorna um índice do preenchimento BackgroundType.Themed na coleção de temas de fundo. |
| [getEffective()](#getEffective--) | Obtém os dados de fundo efetivos com a herança aplicada. |
...
Retorna um índice do preenchimento BackgroundType.Themed na coleção de temas de fundo. 0 significa sem preenchimento. 1..999 - índice. Leitura/Gravação int.
