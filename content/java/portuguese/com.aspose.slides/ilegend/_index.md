...
Especifica a posição da legenda em um gráfico. Valores não NaN das propriedades X, Y, Width, Heigt substituem o efeito desta propriedade. Leitura/Gravação [LegendPositionType](../../com.aspose.slides/legendpositiontype).
