...
| Método | Descrição |
| --- | --- |
| [loadExternalFonts(String[] directories)](#loadExternalFonts-java.lang.String---) | Adiciona pastas adicionais para procurar fontes. |
...
>  // Carrega as fontes do diretório de fontes personalizado
>  FontsLoader.loadExternalFonts(folders);
>  // Executa algum trabalho e realiza a renderização da apresentação/slide
