...
| [findByName(String name)](#findByName-java.lang.String-) | Encontra um autor em uma coleção pelo nome. |
| [findByNameAndInitials(String name, String initials)](#findByNameAndInitials-java.lang.String-java.lang.String-) | Encontra um autor em uma coleção pelo nome e iniciais. |
...
Adiciona um novo autor ao final da coleção.
...
Encontra um autor em uma coleção pelo nome.
...
Encontra um autor em uma coleção pelo nome e iniciais.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice base zero do elemento a ser removido. |
