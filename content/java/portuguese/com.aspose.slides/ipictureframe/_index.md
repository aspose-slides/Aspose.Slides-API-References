...
| Método | Descrição |
| --- | --- |
| [getPictureFrameLock()](#getPictureFrameLock--) | Retorna os locks de PictureFrame. |
...
Retorna os locks de PictureFrame. Somente leitura [IPictureFrameLock](../../com.aspose.slides/ipictureframelock).
...
Retorna ou define a escala de altura(relativa ao tamanho original da imagem) do quadro de imagem. Valor 1.0 corresponde a 100%. Leitura/Escrita float.
...
Retorna ou define a escala de largura(relativa ao tamanho original da imagem) do quadro de imagem. Valor 1.0 corresponde a 100%. Leitura/Escrita float.
