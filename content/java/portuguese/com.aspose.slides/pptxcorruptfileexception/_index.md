...
type: docs
url: /pt/com.aspose.slides/pptxcorruptfileexception/
---
**Herança:**
...
| --- | --- |
| [PptxCorruptFileException()](#PptxCorruptFileException--) | Construtor padrão. |
| [PptxCorruptFileException(String message)](#PptxCorruptFileException-java.lang.String-) | Construtor que permite adicionar uma mensagem a esta exceção. |
| [PptxCorruptFileException(String message, RuntimeException exception)](#PptxCorruptFileException-java.lang.String-java.lang.RuntimeException-) | Construtor para uma exceção que contém uma mensagem e uma exceção incorporada. |
