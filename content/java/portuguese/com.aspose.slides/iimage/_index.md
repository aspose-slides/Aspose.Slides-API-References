...
| --- | --- | --- |
| filename | java.lang.String | O caminho do arquivo onde a imagem será salva. |
...
| filename | java.lang.String | O caminho do arquivo onde a imagem será salva. |
| format | int | O formato da imagem. |
| quality | int | A qualidade da imagem salva (0 a 100). Este parâmetro afeta apenas a gravação em [ImageFormat.Jpeg](../../com.aspose.slides/imageformat\#Jpeg); para todos os outros formatos, é ignorado. |
