...
Esta interface é usada juntamente com a interface [IThreeDFormat](../../com.aspose.slides/ithreedformat) para devolver valores de formatação efetivos com herança aplicada.
## Métodos
...
| [getBevelTop()](#getBevelTop--) | Retorna o tipo de um chanfro superior 3D. |
| [getBevelBottom()](#getBevelBottom--) | Retorna o tipo de um chanfro inferior 3D. |
...
Retorna o tipo de um chanfro superior 3D. Somente leitura [IShapeBevelEffectiveData](../../com.aspose.slides/ishapebeveleffectivedata).
...
Retorna o tipo de um chanfro inferior 3D. Somente leitura [IShapeBevelEffectiveData](../../com.aspose.slides/ishapebeveleffectivedata).
...
Retorna a cor de um contorno. Somente leitura java.awt.Color.
...
Retorna a cor de uma extrusão. Somente leitura java.awt.Color.
