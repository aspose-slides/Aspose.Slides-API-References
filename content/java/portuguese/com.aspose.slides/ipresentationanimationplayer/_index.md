...
| [getFrame()](#getFrame--) | Obter o quadro para a posição de tempo atual previamente definido com o método \#setTimePosition(double).setTimePosition(double) method. |
...
Obter o quadro para a posição de tempo atual previamente definido com o método \#setTimePosition(double).setTimePosition(double) method.
