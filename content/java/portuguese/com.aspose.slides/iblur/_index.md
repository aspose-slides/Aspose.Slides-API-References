...
| [getGrow()](#getGrow--) | Determina se os limites do objeto devem ser aumentados como resultado do desfoque. |
| [setGrow(boolean value)](#setGrow-boolean-) | Determina se os limites do objeto devem ser aumentados como resultado do desfoque. |
### getRadius() {#getRadius--}
```
...
Determina se os limites do objeto devem ser aumentados como resultado do desfoque. True indica que os limites são aumentados enquanto false indica que não são. Leitura/gravação boolean.
