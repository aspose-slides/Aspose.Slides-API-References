...
Permite criar referências de projeto VBA via interface COM
## Construtores
...
| Método | Descrição |
| --- | --- |
| [getInstance()](#getInstance--) | Instância estática da fábrica de referências de projeto VBA. |
...
Instância estática da fábrica de referências de projeto VBA. Somente leitura [VbaReferenceFactory](../../com.aspose.slides/vbareferencefactory).
