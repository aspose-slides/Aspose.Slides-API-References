...
type: docs
url: /pt/com.aspose.slides/effect/
---
**Herança:**
java.lang.Object
...
| [getTextAnimation()](#getTextAnimation--) | TextAnimation Somente leitura [ITextAnimation](../../com.aspose.slides/itextanimation). |
...
| [getDelayBetweenTextParts()](#getDelayBetweenTextParts--) | Define um atraso entre as partes do texto animado (palavras ou letras). |
| [setDelayBetweenTextParts(float value)](#setDelayBetweenTextParts-float-) | Define um atraso entre as partes do texto animado (palavras ou letras). |
...
TextAnimation Somente leitura [ITextAnimation](../../com.aspose.slides/itextanimation).
...
>      {
>          // Altera o Enhancements/Sound do segundo efeito para "Stop Previous Sound"
...
Define um tipo de animação posterior para o efeito. Leitura/Gravação [AfterAnimationType](../../com.aspose.slides/afteranimationtype)(\#getAfterAnimationType.getAfterAnimationType/\#setAfterAnimationType(int).setAfterAnimationType(int)).
...
>      IEffect firstSlideEffect = presentation.getSlides().get_Item(0).getTimeline().getMainSequence().get_Item(0);
> 
>      // Altera a animação após o efeito para "Hide on Next Mouse Click"
...
Define um atraso entre as partes do texto animado (palavras ou letras). Um valor positivo especifica a porcentagem da duração do efeito. Um valor negativo especifica o atraso em segundos. Leitura/Gravação float .
...
> 
>      // Define o atraso entre as partes do texto animado para 20% da duração do efeito.
