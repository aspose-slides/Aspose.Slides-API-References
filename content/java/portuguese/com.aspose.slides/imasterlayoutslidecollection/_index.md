...
1) O novo layout será vinculado ao slide mestre pai desta coleção de slides de layout. Portanto, isso equivale a copiar/colar com a opção "Use Destination Theme" no PowerPoint. 2) Um análogo deste método é o método [IGlobalLayoutSlideCollection.addClone(ILayoutSlide,IMasterSlide)](../../com.aspose.slides/igloballayoutslidecollection\#addClone-ILayoutSlide-IMasterSlide-) acessado via a propriedade [IPresentation.getLayoutSlides](../../com.aspose.slides/ipresentation\#getLayoutSlides).
...
| layoutName | java.lang.String | Nome para um novo layout. Se o nome fornecido já estiver em uso, será lançada uma ArgumentException. Se o parâmetro for nulo, o nome será gerado automaticamente de acordo com o tipo de layout informado (por exemplo "Title Slide" ou "1\_Title Slide", "2\_..", etc.). |

--------------------

1) O layout adicionado para o valor SlideLayoutType.Custom de layoutType não contém marcadores de posição nem formas. 2) Um análogo deste método é o método [IGlobalLayoutSlideCollection.add(IMasterSlide,byte,String)](../../com.aspose.slides/igloballayoutslidecollection\#add-IMasterSlide-byte-String-) acessado via a propriedade [IPresentation.getLayoutSlides](../../com.aspose.slides/ipresentation\#getLayoutSlides).
