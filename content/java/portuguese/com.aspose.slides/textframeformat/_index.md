...
| --- | --- |
| [TextFrameFormat()](#TextFrameFormat--) | Inicializa uma nova instância de [TextFrameFormat](../../com.aspose.slides/textframeformat) classe. |
...
| [getWrapText()](#getWrapText--) | Verdadeiro se o texto for quebrado nas margens do TextFrame. |
| [setWrapText(byte value)](#setWrapText-byte-) | Verdadeiro se o texto for quebrado nas margens do TextFrame. |
| [getAnchoringType()](#getAnchoringType--) | Retorna ou define o ancoramento vertical do texto em um TextFrame. |
| [setAnchoringType(byte value)](#setAnchoringType-byte-) | Retorna ou define o ancoramento vertical do texto em um TextFrame. |
...
| [getRotationAngle()](#getRotationAngle--) | Especifica a rotação personalizada aplicada ao texto dentro da caixa delimitadora. |
| [setRotationAngle(float value)](#setRotationAngle-float-) | Especifica a rotação personalizada aplicada ao texto dentro da caixa delimitadora. |
| [getTransform()](#getTransform--) | Obtém ou define a forma de quebra de texto. |
| [setTransform(byte value)](#setTransform-byte-) | Obtém ou define a forma de quebra de texto. |
...
| [getEffective()](#getEffective--) | Obtém os dados de formatação efetiva do quadro de texto com herança aplicada. |
...
Verdadeiro se o texto for quebrado nas margens do TextFrame. Leitura/gravação [NullableBool](../../com.aspose.slides/nullablebool).
...
Retorna ou define o ancoramento vertical do texto em um TextFrame. Leitura/gravação [TextAnchorType](../../com.aspose.slides/textanchortype).
...
Determina a orientação do texto. O valor resultante da rotação visual do texto resumido desta propriedade e do ângulo personalizado na propriedade RotationAngle. Leitura/gravação [TextVerticalType](../../com.aspose.slides/textverticaltype).
...
Retorna ou define o modo de ajuste automático do texto. Leitura/gravação [TextAutofitType](../../com.aspose.slides/textautofittype).

--------------------

> ```
> O seguinte código de exemplo mostra como redimensionar a forma para Ajustar Texto em uma apresentação PowerPoint.
>  
>  Presentation pres = new Presentation();
>  try {
>      ISlide slide = pres.getSlides().get_Item(0);
...
>  }
>  
>  O seguinte código de exemplo mostra como reduzir o texto em caso de estouro.
>  
>  Presentation pres = new Presentation();
>  try {
>      ISlide slide = pres.getSlides().get_Item(0);
...
> ```
> O seguinte código de exemplo mostra como adicionar colunas em um quadro de texto dentro de uma apresentação PowerPoint.
>  
>  Presentation pres = new Presentation();
>  try {
...
Retorna ou define o espaço entre colunas de texto na área de texto (em pontos). Isso deve ser aplicado apenas quando houver mais de 1 coluna presente. Este valor deve ser um número positivo. Caso contrário, o valor será definido como zero. Leitura/gravação double.
...
Especifica a rotação personalizada que está sendo aplicada ao texto dentro da caixa delimitadora. Se não for especificado, a rotação da forma associada será usada. Se for especificado, então esta será aplicada independentemente da forma. Ou seja, a forma pode ter uma rotação aplicada além da rotação do texto. O valor resultante da rotação visual do texto resumido desta propriedade e do tipo vertical predefinido na propriedade TextVerticalType. Leitura/gravação float.
...
>  estar rotacionada, mas o texto dentro dela pareceria como se não tivesse sido rotacionado de forma alguma.
```
...
Obtém ou define a forma de quebra de texto. Leitura/gravação [TextShapeType](../../com.aspose.slides/textshapetype).
...
Obtém os dados de formatação efetiva do quadro de texto com herança aplicada.

--------------------

> ```
> Este exemplo demonstra a obtenção de algumas das propriedades de formatação efetiva do quadro de texto.
>  
