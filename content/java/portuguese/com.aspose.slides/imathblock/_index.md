...
description: Especifica uma instância de texto matemático que está contido dentro de um MathParagraph e começa em sua própria linha.
type: docs
...
Especifica uma instância de texto matemático que está contido dentro de um MathParagraph e começa em sua própria linha. Todas as áreas matemáticas, incluindo equações, expressões, matrizes de equações ou expressões e fórmulas são representadas por um bloco matemático.
...
| [enclose(char beginningCharacter, char endingCharacter, char separatorCharacter)](#enclose-char-char-char-) | Envolve os elementos filhos deste bloco em caracteres especificados, como parênteses ou outro, como enquadramento e delimita com um caractere separador |
...
Envolve os elementos filhos deste bloco em caracteres especificados, como parênteses ou outro, como enquadramento e delimita com um caractere separador
...
**Retorna:**
[IMathDelimiter](../../com.aspose.slides/imathdelimiter) - O elemento matemático do tipo [IMathDelimiter](../../com.aspose.slides/imathdelimiter) que inclui os caracteres especificados como enquadramento e delimitador
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| other | [IMathBlock](../../com.aspose.slides/imathblock) | O bloco que será juntado |
