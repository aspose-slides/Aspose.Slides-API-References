...
second_title: Aspose.Slides para Java Referência de API
...
Representa uma coleção de pontos para dividir ponto em um gráfico de pizza em barra ou pizza dentro de pizza com uma divisão personalizada.
## Métodos
...
**Retorna:**
boolean - verdadeiro se o item for removido com sucesso; caso contrário, falso. Este método também retorna false se o item não for encontrado na System.Collections.Generic.List\{T\}.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| array | [IChartDataPoint\[\]](../../com.aspose.slides/ichartdatapoint) | O Array unidimensional que é o destino dos elementos copiados de [IGenericCollection](../../com.aspose.slides/igenericcollection). O Array deve ter indexação baseada em zero. |
