...
| [removeUnused(boolean ignorePreserveField)](#removeUnused-boolean-) | Remove slides mestres não utilizados. |
...
Para evitar a exceção PptxEditException, verifique a propriedade HasDependingSlides do mestre antes. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| ignorePreserveField | boolean | Determina se este método deve remover mestres não utilizados mesmo que sua propriedade [MasterSlide.getPreserve](../../com.aspose.slides/masterslide\#getPreserve)/[MasterSlide.setPreserve(boolean)](../../com.aspose.slides/masterslide\#setPreserve-boolean-) esteja definida como true. |
...
>      try {
>          // Instanciar ISlide a partir da coleção de slides na apresentação fonte junto com
>          // Slide mestre
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IMasterSlide> - Um IGenericEnumerator que pode ser usado para iterar através da coleção.
