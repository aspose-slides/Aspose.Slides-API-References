...
Retorna a coleção de esquemas de cores adicionais. Esses esquemas não afetam a aparência da apresentação, eles podem ser selecionados como esquema de cores principal para um slide. Somente leitura [IExtraColorSchemeCollection](../../com.aspose.slides/iextracolorschemecollection).
...
Define o nome de um tema. Leitura/gravação String.
