...
| --- | --- |
| [OleEmbeddedDataInfo()](#OleEmbeddedDataInfo--) | Cria nova informação de dados incorporados para objeto OLE. |
| [OleEmbeddedDataInfo(byte[] embeddedFileData, String embeddedFileExtension)](#OleEmbeddedDataInfo-byte---java.lang.String-) | Cria uma nova instância de uma informação de dados incorporados para objeto OLE. |
## Métodos
...
Cria nova informação de dados incorporados para objeto OLE.
...
Cria uma nova instância de uma informação de dados incorporados para objeto OLE.
