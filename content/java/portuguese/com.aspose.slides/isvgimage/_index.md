...
| [getExternalResourceResolver()](#getExternalResourceResolver--) | Retorna a interface de retorno de chamada usada para resolver recursos externos durante a importação de documentos SVG. |
...
Retorna a interface de retorno de chamada usada para resolver recursos externos durante a importação de documentos SVG. Somente leitura [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver).
