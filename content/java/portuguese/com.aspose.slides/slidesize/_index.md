...
Atribuir um novo valor redefine a propriedade \#getType.getType para [SlideSizeType.Custom](../../com.aspose.slides/slidesizetype\#Custom) e define a \#getOrientation.getOrientation/\#setOrientation(int).setOrientation(int).
...
Atribuir qualquer valor diferente de [SlideSizeType.Custom](../../com.aspose.slides/slidesizetype\#Custom) ajusta a \#getSize.getSize de acordo com as dimensões predefinidas, mantendo a \#getOrientation.getOrientation/\#setOrientation(int).setOrientation(int) atual.
...
| scaleType | int | O modo de dimensionamento do conteúdo a ser usado.

--------------------

Atribuir qualquer valor diferente de [SlideSizeType.Custom](../../com.aspose.slides/slidesizetype\#Custom) ajusta a \#getSize.getSize com base no tipo selecionado, preservando a \#getOrientation.getOrientation/\#setOrientation(int).setOrientation(int). |
...
Isso redefine a propriedade \#getType.getType para [SlideSizeType.Custom](../../com.aspose.slides/slidesizetype\#Custom) e define a \#getOrientation.getOrientation/\#setOrientation(int).setOrientation(int). |