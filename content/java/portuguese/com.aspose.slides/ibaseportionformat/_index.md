...
Esta classe é usada para retornar e manipular as propriedades de formatação de porção de texto definidas para a porção específica. Isto significa que nenhuma herança é aplicada ao obter valores, portanto, na maioria dos casos você receberá valores significando “indefinido”.
...
| [getUnderlineLineFormat()](#getUnderlineLineFormat--) | Retorna as propriedades LineFormat usadas para contorno da linha de sublinhado. |
...
| [setFontItalic(byte value)](#setFontItalic-byte-) | Determina se a fonte está itálica. |
...
| [getStrikethroughType()](#getStrikethroughType--) | Retorna ou define o tipo de tachado do texto. |
| [setStrikethroughType(byte value)](#setStrikethroughType-byte-) | Retorna ou define o tipo de tachado do texto. |
...
| [setHardUnderlineLine(byte value)](#setHardUnderlineLine-byte-) | Determina se o estilo de sublinhado tem propriedades LineFormat próprias ou as herda das propriedades LineFormat do texto. |
...
| [setHardUnderlineFill(byte value)](#setHardUnderlineFill-byte-) | Determina se o estilo de sublinhado tem propriedades FillFormat próprias ou as herda das propriedades FillFormat do texto. |
...
| [getEastAsianFont()](#getEastAsianFont--) | Retorna ou define as informações da fonte oriental. |
| [setEastAsianFont(IFontData value)](#setEastAsianFont-com.aspose.slides.IFontData-) | Retorna ou define as informações da fonte oriental. |
...
| [getLanguageId()](#getLanguageId--) | Retorna ou define o Id de uma língua de revisão. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String-) | Retorna ou define o Id de uma língua de revisão. |
| [getAlternativeLanguageId()](#getAlternativeLanguageId--) | Retorna ou define o Id de uma língua alternativa. |
| [setAlternativeLanguageId(String value)](#setAlternativeLanguageId-java.lang.String-) | Retorna ou define o Id de uma língua alternativa. |
| [getSpacing()](#getSpacing--) | Retorna ou define o incremento de espaçamento intercaracteres. |
| [setSpacing(float value)](#setSpacing-float-) | Retorna ou define o incremento de espaçamento intercaracteres. |
...
Retorna as propriedades LineFormat usadas para contorno da linha de sublinhado. Nenhuma herança aplicada. Somente leitura [ILineFormat](../../com.aspose.slides/ilineformat).
...
Determina se a fonte está itálica. Nenhuma herança aplicada. Leitura/gravação [NullableBool](../../com.aspose.slides/nullablebool).
...
Retorna ou define o tipo de tachado do texto. Nenhuma herança aplicada. Leitura/gravação [TextStrikethroughType](../../com.aspose.slides/textstrikethroughtype).
...
Determina se o estilo de sublinhado tem propriedades LineFormat próprias ou as herda das propriedades LineFormat do texto. Leitura/gravação [NullableBool](../../com.aspose.slides/nullablebool).
...
Determina se o estilo de sublinhado tem propriedades FillFormat próprias ou as herda das propriedades FillFormat do texto. Leitura/gravação [NullableBool](../../com.aspose.slides/nullablebool).
...
Retorna ou define as informações da fonte oriental. Null significa que a fonte está indefinida e deve ser herdada do Mestre. Leitura/gravação [IFontData](../../com.aspose.slides/ifontdata).
...
Retorna ou define o Id de uma língua de revisão. Usado para verificação ortográfica e gramatical. Leitura/gravação String.
...
Retorna ou define o Id de uma língua alternativa. Leitura/gravação String.
...
Retorna ou define o incremento de espaçamento intercaracteres. **Float.NaN** significa que o valor está indefinido e deve ser herdado do Mestre. Leitura/gravação float.
...
Obtém ou define um valor que indica se a verificação ortográfica está habilitada para a porção de texto. Quando essa propriedade é definida como false, as verificações ortográficas para elementos de texto são suprimidas. Quando definida como true, a verificação ortográfica é permitida. O valor padrão é false.
