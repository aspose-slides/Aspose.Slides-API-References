...
description: Representa uma interface de objeto de modelo para um motor de templates.
type: docs
...
Representa uma interface de objeto de modelo para um motor de templates.
## Métodos

| Método | Descrição |
| --- | --- |
| [<TSubModel>subModel(TSubModel subModel)](#-TSubModel-subModel-TSubModel-) | Cria um contexto de modelo filho. |
| [getObject()](#getObject--) | Retorna o objeto do modelo. |
...
| --- | --- | --- |
| subModel | TSubModel | Objeto de modelo filho. |
...
Retorna o objeto do modelo. Somente leitura Object.
