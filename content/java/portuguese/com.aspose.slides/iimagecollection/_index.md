...
**Retorna:**
[IPPImage](../../com.aspose.slides/ippimage) - Imagem.
...
Este método converte arquivos metafile WMF/EMF para imagem PNG raster antes de inseri-los em uma apresentação. |
...
Este método pode adicionar arquivos metafile WMF/EMF a uma apresentação sem convertê-los para uma imagem PNG raster. |
