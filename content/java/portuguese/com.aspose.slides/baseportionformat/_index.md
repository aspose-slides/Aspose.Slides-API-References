...
| [isHardUnderlineLine()](#isHardUnderlineLine--) | Determina se o estilo de sublinhado tem propriedades LineFormat próprias ou se as herda das propriedades LineFormat do texto. |
| [setHardUnderlineLine(byte value)](#setHardUnderlineLine-byte-) | Determina se o estilo de sublinhado tem propriedades LineFormat próprias ou se as herda das propriedades LineFormat do texto. |
| [isHardUnderlineFill()](#isHardUnderlineFill--) | Determina se o estilo de sublinhado tem propriedades FillFormat próprias ou se as herda das propriedades FillFormat do texto. |
| [setHardUnderlineFill(byte value)](#setHardUnderlineFill-byte-) | Determina se o estilo de sublinhado tem propriedades FillFormat próprias ou se as herda das propriedades FillFormat do texto. |
...
| [getEastAsianFont()](#getEastAsianFont--) | Retorna ou define as informações da fonte Leste Asiático. |
| [setEastAsianFont(IFontData value)](#setEastAsianFont-com.aspose.slides.IFontData-) | Retorna ou define as informações da fonte Leste Asiático. |
...
Determina se o estilo de sublinhado tem propriedades LineFormat próprias ou se as herda das propriedades LineFormat do texto. Leitura/Gravação [NullableBool](../../com.aspose.slides/nullablebool).
...
Determina se o estilo de sublinhado tem propriedades FillFormat próprias ou se as herda das propriedades FillFormat do texto. Leitura/Gravação [NullableBool](../../com.aspose.slides/nullablebool).
...
Retorna ou define as informações da fonte Leste Asiático. Null significa que a fonte está indefinida e deve ser herdada do Mestre. Leitura/Gravação [IFontData](../../com.aspose.slides/ifontdata).
