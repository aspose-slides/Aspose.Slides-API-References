...
description: Objeto imutável que contém propriedades de formatação de linha efetiva.
type: docs
...
Objeto imutável que contém propriedades de formatação de linha efetiva.

--------------------

Esta interface é usada junto com a interface [ILineFormat](../../com.aspose.slides/ilineformat) para retornar valores de formatação efetiva com herança aplicada.
## Métodos
...
| [getMiterLimit()](#getMiterLimit--) | Retorna o limite de chanfradura de uma linha. |
| [getBeginArrowheadStyle()](#getBeginArrowheadStyle--) | Retorna o estilo da ponta da seta no início de uma linha. |
| [getEndArrowheadStyle()](#getEndArrowheadStyle--) | Retorna o estilo da ponta da seta no final de uma linha. |
| [getBeginArrowheadWidth()](#getBeginArrowheadWidth--) | Retorna a largura da ponta da seta no início de uma linha. |
| [getEndArrowheadWidth()](#getEndArrowheadWidth--) | Retorna a largura da ponta da seta no final de uma linha. |
| [getBeginArrowheadLength()](#getBeginArrowheadLength--) | Retorna o comprimento da ponta da seta no início de uma linha. |
| [getEndArrowheadLength()](#getEndArrowheadLength--) | Retorna o comprimento da ponta da seta no final de uma linha. |
...
Retorna o limite de chanfradura de uma linha. Somente leitura float.
...
Retorna o estilo da ponta da seta no início de uma linha. Somente leitura [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
Retorna o estilo da ponta da seta no final de uma linha. Somente leitura [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
Retorna a largura da ponta da seta no início de uma linha. Somente leitura [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
Retorna a largura da ponta da seta no final de uma linha. Somente leitura [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
Retorna o comprimento da ponta da seta no início de uma linha. Somente leitura [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
Retorna o comprimento da ponta da seta no final de uma linha. Somente leitura [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
