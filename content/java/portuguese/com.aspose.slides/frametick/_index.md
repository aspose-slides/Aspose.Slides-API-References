...
description: Representa o manipulador de tick de quadro do evento FrameTickDelegate.FrameTickDelegate.
type: docs
url: /pt/com.aspose.slides/presentationplayer.frametick/
---```
public static interface PresentationPlayer.FrameTick
```

Representa o manipulador de tick de quadro do evento \#FrameTickDelegate.FrameTickDelegate.
## Métodos
