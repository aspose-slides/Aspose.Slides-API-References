...
description: Representa o valor da string que pode ser armazenado em um documento de apresentação pptx de duas maneiras: 1) em célula(s) da pasta de trabalho relacionada ao gráfico; 2) como valor literal.
type: docs
...
Representa o valor da string que pode ser armazenado em um documento de apresentação pptx de duas maneiras: 1) em célula/células da pasta de trabalho relacionada ao gráfico; 2) como valor literal.
## Métodos
...
| [getCellsAddressInWorkbook()](#getCellsAddressInWorkbook--) | Se a propriedade DataSourceType for DataSourceType.Worksheet, este método retorna o endereço das células na pasta de trabalho que representam os dados da string. |
...
**Retorna:**
java.lang.String - Representação da string de um valor String
...
Se a propriedade DataSourceType for DataSourceType.Worksheet, este método retorna o endereço das células na pasta de trabalho que representam os dados da string. Caso contrário, retorna uma string vazia.

**Retorna:**
java.lang.String - Valor da string String