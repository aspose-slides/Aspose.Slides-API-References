...
description: Representa a animação de texto.
type: docs
...
Representa a animação de texto.
## Métodos
...
| triggerType | int | Tipo de acionamento do efeito [EffectTriggerType](../../com.aspose.slides/effecttriggertype) |
...
Lista de tipo de construção (por exemplo Parágrafo 1,2,3, Todos de Uma Vez) da animação de texto. Leitura/Gravação \#getBuildType.getBuildType/\#setBuildType(int).setBuildType(int).
