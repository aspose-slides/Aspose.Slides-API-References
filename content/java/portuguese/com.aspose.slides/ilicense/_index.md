...
| [isLicensed()](#isLicensed--) | Verificar se a licença está aplicada ao componente |
...
| --- | --- | --- |
| licenseName | java.lang.String | Pode ser um nome de arquivo completo ou abreviado ou o nome de um recurso incorporado. Use uma string vazia para mudar para o modo de avaliação.
...
Verificar se a licença está aplicada ao componente
