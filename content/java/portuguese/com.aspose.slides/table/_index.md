...
| [getTableFormat()](#getTableFormat--) | Retorna o objeto TableFormat que contém propriedades de formatação para esta tabela. |
...
| [setTextFormat(IPortionFormat source)](#setTextFormat-com.aspose.slides.IPortionFormat-) | Define as propriedades de formato de porção para todas as porções das células da tabela. |
| [setTextFormat(IParagraphFormat source)](#setTextFormat-com.aspose.slides.IParagraphFormat-) | Define as propriedades de formato de parágrafo para todos os parágrafos das células da tabela. |
| [setTextFormat(ITextFrameFormat source)](#setTextFormat-com.aspose.slides.ITextFrameFormat-) | Define as propriedades de formato de quadros de texto para todos os quadros de texto das células da tabela. |
...
Retorna o objeto TableFormat que contém propriedades de formatação para esta tabela. Somente leitura [ITableFormat](../../com.aspose.slides/itableformat).
...
Define as propriedades de formato de porção para todas as porções das células da tabela.
...
Define as propriedades de formato de parágrafo para todos os parágrafos das células da tabela.
...
Define as propriedades de formato de quadros de texto para todos os quadros de texto das células da tabela.
