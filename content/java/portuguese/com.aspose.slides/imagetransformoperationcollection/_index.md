...
| [get_Item(int index)](#get-Item-int-) | Retorna um [ImageTransformOperation](../../com.aspose.slides/imagetransformoperation) da coleção por seu índice. |
...
| [copyToTArray(IImageTransformOperation[] array, int arrayIndex)](#copyToTArray-com.aspose.slides.IImageTransformOperation---int-) | Copia os elementos de [IGenericCollection](../../com.aspose.slides/igenericcollection) para um Array, começando em um índice de Array específico. |
...
Retorna um [ImageTransformOperation](../../com.aspose.slides/imagetransformoperation) da coleção por seu índice.
...
| grow | boolean | Especifica se os limites do objeto devem ser ampliados como resultado do desfoque. Verdadeiro indica que os limites são ampliados, falso indica que não são. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| hue | float | O número de graus que o matiz é ajustado. |
| saturation | float | A porcentagem que a saturação é ajustada. |
| luminance | float | A porcentagem que a luminância é ajustada. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| brightness | float | A percentagem para alterar o brilho. |
| contrast | float | A percentagem para alterar o contraste. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| hue | float | O matiz para o qual a tonalidade será aplicada. |
...
Copia os elementos de [IGenericCollection](../../com.aspose.slides/igenericcollection) para um Array, começando em um índice de Array específico.

**Parâmetros:**
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| array | [IImageTransformOperation\[\]](../../com.aspose.slides/iimagetransformoperation) | O Array unidimensional que recebe os elementos copiados de [IGenericCollection](../../com.aspose.slides/igenericcollection). O Array deve ter indexação baseada em zero. |
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IImageTransformOperation> - Um IGenericEnumerator que pode ser usado para iterar pela coleção.
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IImageTransformOperation> - Um java.util.Iterator para toda a coleção.