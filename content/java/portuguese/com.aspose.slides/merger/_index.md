...
description: Representa um grupo de métodos para mesclar apresentações PowerPoint do mesmo formato em um único arquivo.
type: docs
...
Representa um grupo de métodos para mesclar apresentações PowerPoint do mesmo formato em um único arquivo.
## Métodos

| Método | Descrição |
| --- | --- |
| [process(String[] inputFileNames, String outputFileName)](#process-java.lang.String---java.lang.String-) | Mescla várias apresentações PowerPoint do mesmo formato em um único arquivo de apresentação. |
| [process(String[] inputFileNames, String outputFileName, ISaveOptions options)](#process-java.lang.String---java.lang.String-com.aspose.slides.ISaveOptions-) | Mescla várias apresentações PowerPoint do mesmo formato em um único arquivo de apresentação. |
| [process(String[] inputFileNames, OutputStream outputStream)](#process-java.lang.String---java.io.OutputStream-) | Mescla várias apresentações PowerPoint do mesmo formato em um único arquivo de apresentação. |
| [process(String[] inputFileNames, OutputStream outputStream, ISaveOptions options)](#process-java.lang.String---java.io.OutputStream-com.aspose.slides.ISaveOptions-) | Mescla várias apresentações PowerPoint do mesmo formato em um único arquivo de apresentação. |
