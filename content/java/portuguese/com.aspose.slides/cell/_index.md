...
| [getAnchorCenter()](#getAnchorCenter--) | Determina se a caixa de texto está ou não centrada dentro de uma célula. |
| [setAnchorCenter(boolean value)](#setAnchorCenter-boolean-) | Determina se a caixa de texto está ou não centrada dentro de uma célula. |
...
| [getTextFrame()](#getTextFrame--) | Retorna o frame de texto de uma célula. |
| [getTable()](#getTable--) | Retorna o objeto Table pai de uma célula. |
| [isMergedCell()](#isMergedCell--) | Retorna true se a célula está mesclada com qualquer célula ajustada, caso contrário false. |
...
Determina se a caixa de texto está ou não centrada dentro de uma célula. Leitura/gravação boolean.
...
Retorna o número de colunas da grade na grade da tabela-pai que devem ser abrangidas pela célula atual. Essa propriedade permite que as células apresentem a aparência de mescladas, pois abrangem limites verticais de outras células na tabela. Somente leitura int.
...
Retorna o frame de texto de uma célula. Somente leitura [ITextFrame](../../com.aspose.slides/itextframe).
...
Retorna true se a célula está mesclada com qualquer célula ajustada, caso contrário false. Somente leitura boolean.
