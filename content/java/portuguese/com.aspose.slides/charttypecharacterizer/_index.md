...
| Método | Descrição |
| --- | --- |
| [isBar3DChart(int chartType)](#isBar3DChart-int-) | Retorna true se chartType for um dos subtipos de bar3DChart (colunas ou barras 3D). |
...
| [isChartTypeColumn(int chartType)](#isChartTypeColumn-int-) | Retorna true se chartType for um dos subtipos de Column. |
| [isChartTypeLine(int chartType)](#isChartTypeLine-int-) | Retorna true se chartType for um dos subtipos de Line. |
| [isChartTypePie(int chartType)](#isChartTypePie-int-) | Retorna true se chartType for um dos subtipos de Pie. |
| [isChartTypeBar(int chartType)](#isChartTypeBar-int-) | Retorna true se chartType for um dos subtipos de Bar. |
| [isChartTypeArea(int chartType)](#isChartTypeArea-int-) | Retorna true se chartType for um dos subtipos de Area. |
| [isChartTypeScatter(int chartType)](#isChartTypeScatter-int-) | Retorna true se chartType for um dos subtipos de Scatter. |
| [isChartTypeStock(int chartType)](#isChartTypeStock-int-) | Retorna true se chartType for um dos subtipos de Stock. |
| [isChartTypeSurface(int chartType)](#isChartTypeSurface-int-) | Retorna true se chartType for um dos subtipos de Surface. |
| [isChartTypeDoughnut(int chartType)](#isChartTypeDoughnut-int-) | Retorna true se chartType for um dos subtipos de Doughnut. |
| [isChartTypeBubble(int chartType)](#isChartTypeBubble-int-) | Retorna true se chartType for um dos subtipos de Bubble. |
| [isChartTypeRadar(int chartType)](#isChartTypeRadar-int-) | Retorna true se chartType for um dos subtipos de Radar. |
...
| [isSeriesUsesBubbleSizeCoordinate(int seriesType)](#isSeriesUsesBubbleSizeCoordinate-int-) | Retorna se as coordenadas de tamanho da bolha podem ser usadas para o tipo de série especificado. |
...
Retorna true se chartType for um dos subtipos de bar3DChart (colunas ou barras 3D).
...
Retorna true se chartType for um dos subtipos de Bubble. O conjunto de subtipos corresponde ao conjunto apropriado no PowerPoint (consulte a caixa de diálogo “Change Chart Type” no PowerPoint): [ChartType.Bubble](../../com.aspose.slides/charttype\#Bubble), [ChartType.BubbleWith3D](../../com.aspose.slides/charttype\#BubbleWith3D).
...
```
public static boolean isSeriesUsesBubbleSizeCoordinate(int seriesNumber)
```

Retorna se as coordenadas de tamanho da bolha podem ser usadas para o tipo de série especificado.
...
**Retorna:**
boolean - True se pode ser usado, caso contrário false.
...
**Retorna:**
boolean - True se presente caso contrário false.
...
**Retorna:**
boolean - True se permitido, caso contrário false.
