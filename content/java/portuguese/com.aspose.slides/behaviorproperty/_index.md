...
| [isCustom()](#isCustom--) | Mostra se esta propriedade não pertence à lista de propriedades pré-definidas na especificação: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx |
...
| [getOrCreateByValue(String propertyValue)](#getOrCreateByValue-java.lang.String-) | Procura por uma propriedade de comportamento existente pelo valor ou cria uma nova personalizada com o valor especificado |
...
Mostra se esta propriedade não pertence à lista de propriedades pré-definidas na especificação: https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx
...
**Retorna:**
boolean - Verdadeiro se os objetos forem iguais.
...
Calcula e retorna o código hash com base na propriedade (\#getValue.getValue)
