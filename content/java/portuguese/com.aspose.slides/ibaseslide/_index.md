...
| [getSlideShowTransition()](#getSlideShowTransition--) | Retorna o objeto TransitionEx que contém informações sobre como o slide especificado avança durante uma apresentação. |
...
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | Une trechos com a mesma formatação em todos os parágrafos em todas as formas aceitáveis. |
...
Retorna o objeto TransitionEx que contém informações sobre como o slide especificado avança durante uma apresentação. Somente leitura [ISlideShowTransition](../../com.aspose.slides/islideshowtransition).
...
Especifica se as formas no slide mestre devem ser exibidas nos slides ou não. Para o próprio slide mestre essa propriedade sempre retorna false. Leitura/gravação boolean.
...
**Retorna:**
[IShape](../../com.aspose.slides/ishape) - objeto ShapeEx ou null.
...
Une trechos com a mesma formatação em todos os parágrafos em todas as formas aceitáveis.
