...
| [getOperator()](#getOperator--) | Caractere de Operador N-ário Por exemplo: '\\u2211', '\\u222b' |
| [setOperator(char value)](#setOperator-char-) | Caractere de Operador N-ário Por exemplo: '\\u2211', '\\u222b' |
...
| [getGrowToMatchOperandHeight()](#getGrowToMatchOperandHeight--) | Caractere de Operador cresce verticalmente para corresponder à altura do operando |
| [setGrowToMatchOperandHeight(boolean value)](#setGrowToMatchOperandHeight-boolean-) | Caractere de Operador cresce verticalmente para corresponder à altura do operando |
...
Caractere de Operador cresce verticalmente para corresponder à altura do operando
