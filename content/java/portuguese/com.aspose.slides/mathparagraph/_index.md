...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice baseado em zero do item a obter |
...
**Retorna:**
boolean - true se mathBlock foi removido com sucesso da coleção; caso contrário, false. Este método também retorna false se mathBlock não for encontrado na coleção original.
...
**Retorna:**
boolean - true se mathBlock for encontrado na coleção; caso contrário, false.
...
**Retorna:**
int - O índice de mathBlock se encontrado na coleção; caso contrário, -1.
...
| mathBlock | [IMathBlock](../../com.aspose.slides/imathblock) | O IMathBlock a ser inserido. |
