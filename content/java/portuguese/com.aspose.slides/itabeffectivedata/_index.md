...
second_title: Referência de API Aspose.Slides para Java
...
Retorna a posição de uma tabulação. Atribuir esta propriedade pode alterar o índice da tabulação na coleção e invalidar o Enumerator. Somente leitura double.
