...
| Método | Descrição |
| --- | --- |
| [getShapes()](#getShapes--) | Retorna as shapes de um slide. |
...
| [equals(IBaseSlide slide)](#equals-com.aspose.slides.IBaseSlide-) | Determina se as duas instâncias de IBaseSlide são iguais. |
| [joinPortionsWithSameFormatting()](#joinPortionsWithSameFormatting--) | Mescla trechos com a mesma formatação em todos os parágrafos de todas as shapes aceitáveis. |
| [joinPortionsWithSameFormatting(IShapeCollection collection)](#joinPortionsWithSameFormatting-com.aspose.slides.IShapeCollection-) | Mescla trechos com a mesma formatação em todos os parágrafos em todas as shapes aceitáveis. |
...
| [getTimeline()](#getTimeline--) | Retorna o objeto de linha do tempo de animação. |
...
| [getHyperlinkQueries()](#getHyperlinkQueries--) | Fornece acesso fácil aos hyperlinks contidos. |
| [getShowMasterShapes()](#getShowMasterShapes--) | Especifica se as shapes no slide mestre devem ser exibidas nos slides ou não. |
| [setShowMasterShapes(boolean value)](#setShowMasterShapes-boolean-) | Especifica se as shapes no slide mestre devem ser exibidas nos slides ou não. |
| [findShapeByAltText(String altText)](#findShapeByAltText-java.lang.String-) | Encontra a primeira ocorrência de uma shape com o texto alternativo especificado. |
...
Retorna as shapes de um slide. Somente leitura [IShapeCollection](../../com.aspose.slides/ishapecollection).
...
Determina se as duas instâncias de IBaseSlide são iguais. O valor retornado é calculado com base na estrutura e conteúdo estático do slide. Dois slides são iguais se todos os shapes, estilos, textos, animações e outras configurações, etc., forem iguais. A comparação não leva em conta valores de identificadores únicos, por exemplo SlideId, e conteúdo dinâmico, por exemplo valor da data atual em Placeholder de Data.
...
Mescla trechos com a mesma formatação em todos os parágrafos de todas as shapes aceitáveis.
...
Mescla trechos com a mesma formatação em todos os parágrafos em todas as shapes aceitáveis.
...
Retorna o objeto de linha do tempo de animação. Somente leitura [IAnimationTimeLine](../../com.aspose.slides/ianimationtimeline).
...
Fornece acesso fácil aos hyperlinks contidos. Somente leitura [IHyperlinkQueries](../../com.aspose.slides/ihyperlinkqueries).
...
Especifica se as shapes no slide mestre devem ser exibidas nos slides ou não. Para o próprio slide mestre esta propriedade sempre retorna false. Leitura/gravação boolean.
...
Encontra a primeira ocorrência de uma shape com o texto alternativo especificado.
