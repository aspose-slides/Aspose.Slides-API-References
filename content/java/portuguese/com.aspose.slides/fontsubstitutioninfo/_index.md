...
description: Esta estrutura representa as informações sobre a substituição da fonte quando for renderizada.
type: docs
...
Esta estrutura representa as informações sobre a substituição da fonte quando for renderizada.
