...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | Índice onde a nova propriedade deve ser inserida. |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | Propriedade a ser adicionada. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| item | [IBehaviorProperty](../../com.aspose.slides/ibehaviorproperty) | Propriedade a ser removida. |
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IBehaviorProperty> - Um IGenericEnumerator que pode ser usado para iterar através da coleção.
### indexOfItem(IBehaviorProperty item) {#indexOfItem-com.aspose.slides.IBehaviorProperty-}
```
