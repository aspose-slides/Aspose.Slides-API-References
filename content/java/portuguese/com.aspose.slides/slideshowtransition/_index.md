...
| [getSoundLoop()](#getSoundLoop--) | Este atributo especifica se o som será repetido até que o próximo evento de som ocorra na apresentação. |
| [setSoundLoop(boolean value)](#setSoundLoop-boolean-) | Este atributo especifica se o som será repetido até que o próximo evento de som ocorra na apresentação. |
...
| [getSpeed()](#getSpeed--) | Especifica a velocidade de transição que deve ser usada ao transitar do slide atual para o próximo. |
| [setSpeed(int value)](#setSpeed-int-) | Especifica a velocidade de transição que deve ser usada ao transitar do slide atual para o próximo. |
...
| [getSoundIsBuiltIn()](#getSoundIsBuiltIn--) | Especifica se este som é um som interno ou não. |
| [setSoundIsBuiltIn(boolean value)](#setSoundIsBuiltIn-boolean-) | Especifica se este som é um som interno ou não. |
| [getSoundName()](#getSoundName--) | Especifica um nome legível para o som da transição. |
| [setSoundName(String value)](#setSoundName-java.lang.String-) | Especifica um nome legível para o som da transição. |
...
| [equals(Object obj)](#equals-java.lang.Object-) | Determina se as duas instâncias de SlideShowTransition são iguais. |
| [hashCode()](#hashCode--) | Serve como função hash para um tipo específico, adequada para uso em algoritmos de hash e estruturas de dados como uma tabela de hash. |
...
Este atributo especifica se o som será repetido até que o próximo evento de som ocorra na apresentação. Leitura/Gravação boolean.
...
> 
>      // Verifica se a flag Avançar slide após está marcada
>      if (slideTransition.getAdvanceAfter())
>      {
>          // Obtém o valor do tempo de avanço do slide após
...
Especifica o tempo, em milissegundos, após o qual a transição deve iniciar. Esta configuração pode ser usada em conjunto com o atributo advClick. Se este atributo não for especificado, assume-se que não haverá avanço automático. Leitura/Gravação long.
...
Especifica a velocidade de transição que deve ser usada ao transitar do slide atual para o próximo. Leitura/Gravação [TransitionSpeed](../../com.aspose.slides/transitionspeed).
...
Especifica se este som é um som interno ou não. Se este atributo for true, a aplicação geradora deve verificar o atributo name especificado para este som na sua lista de sons internos e pode então apresentar um nome customizado ou interface de usuário conforme necessário. Leitura/Gravação boolean.
...
Especifica um nome legível para o som da transição. A propriedade Sound (\#getSound.getSound/\#setSound(IAudio).setSound(IAudio)) deve ser atribuída para obter ou definir o nome do som. Leitura/Gravação String.
...
Serve como função hash para um tipo específico, adequada para uso em algoritmos de hash e estruturas de dados como uma tabela de hash.
...
Sobrescrito para satisfazer o compilador. Sempre retorna uma constante porque o objeto é mutável.