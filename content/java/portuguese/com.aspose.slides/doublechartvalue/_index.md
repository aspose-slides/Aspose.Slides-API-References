...
Representa um valor double que pode ser armazenado em um documento de apresentação pptx de duas formas: 1) em célula/células da planilha relacionadas ao gráfico; 2) como valor literal.
## Métodos
...
Retorna ou define a célula de dados do gráfico. Leitura/escrita [IChartDataCell](../../com.aspose.slides/ichartdatacell).
...
Retorna ou define o valor como double literal. Leitura/escrita double.
...
Retorna ou define o objeto Data. Leitura/escrita Object.
