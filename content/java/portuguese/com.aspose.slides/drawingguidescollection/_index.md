...
| [getCount()](#getCount--) | Retorna o número de elementos da coleção. |
| [copyTo(IDrawingGuide[] array, int index)](#copyTo-com.aspose.slides.IDrawingGuide---int-) | Copia todos os elementos da coleção para o array especificado. |
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IDrawingGuide> - Um IGenericEnumerator que pode ser usado para iterar através da coleção.
...
Retorna o número de elementos da coleção. Somente leitura int.
