...
| [getCell(int worksheetIndex, String cellName)](#getCell-int-java.lang.String-) | Recupera uma célula da planilha especificada usando seu índice e nome de célula no estilo Excel (por exemplo, "B2"). |
| [getCell(String worksheetName, String cellName)](#getCell-java.lang.String-java.lang.String-) | Recupera uma célula da planilha especificada usando o nome de célula no estilo Excel (por exemplo, "B2"). |
...
| --- | --- | --- |
| filePath | java.lang.String | O caminho completo para o arquivo da pasta de trabalho Excel. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| stream | java.io.InputStream | Um fluxo contendo os dados da pasta de trabalho Excel. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| formula | java.lang.String | Uma fórmula ou expressão de intervalo (por exemplo, "Sheet1!A1:B3") usada para identificar as células-alvo. |
| skipHiddenCells | boolean | Se true, as células ocultas (por exemplo, em linhas ou colunas ocultas) serão excluídas do resultado. |
...
Recupera uma célula da planilha especificada usando seu índice e nome de célula no estilo Excel (por exemplo, "B2").
...
| --- | --- | --- |
| worksheetIndex | int | Índice baseado em zero da planilha. |
| cellName | java.lang.String | A referência de célula no estilo Excel (por exemplo, "A1", "C5"). |
...
Recupera uma célula da planilha especificada usando o nome de célula no estilo Excel (por exemplo, "B2").
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| worksheetName | java.lang.String | O nome da planilha para procurar gráficos. |
