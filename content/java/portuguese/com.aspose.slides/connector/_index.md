...
| [getStartShapeConnectedTo()](#getStartShapeConnectedTo--) | Retorna ou define a forma à qual anexar o início do conector. |
| [setStartShapeConnectedTo(IShape value)](#setStartShapeConnectedTo-com.aspose.slides.IShape-) | Retorna ou define a forma à qual anexar o início do conector. |
| [getEndShapeConnectedTo()](#getEndShapeConnectedTo--) | Retorna ou define a forma à qual anexar o fim do conector. |
| [setEndShapeConnectedTo(IShape value)](#setEndShapeConnectedTo-com.aspose.slides.IShape-) | Retorna ou define a forma à qual anexar o fim do conector. |
...
| [reroute()](#reroute--) | Redireciona o conector para que ele siga o caminho mais curto possível entre as formas que conecta. |
...
Retorna ou define a forma à qual anexar o início do conector. Leitura/gravação [IShape](../../com.aspose.slides/ishape).
...
Retorna ou define a forma à qual anexar o fim do conector. Leitura/gravação [IShape](../../com.aspose.slides/ishape).
