...
| [getVersion()](#getVersion--) | Retorna a versão do Aspose.Slides para Java. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| namePath | java.lang.String | Pode ser um nome de arquivo completo ou abreviado ou nome de um recurso incorporado. Use uma string vazia para mudar para o modo de avaliação. |
...
Retorna a versão do Aspose.Slides para Java.
