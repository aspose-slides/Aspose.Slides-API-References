...
type: docs
url: /pt/com.aspose.slides/chartdatacell/
---
**Herança:**
java.lang.Object
...
| Método | Descrição |
| --- | --- |
| [getRow()](#getRow--) | Retorna o índice da linha da planilha em que a célula está localizada. |
| [getColumn()](#getColumn--) | Retorna o índice da coluna da planilha em que a célula está localizada. |
...
| [getCustomNumberFormat()](#getCustomNumberFormat--) | Obtém ou define o formato de exibição customizado de números e datas. |
| [setCustomNumberFormat(String value)](#setCustomNumberFormat-java.lang.String-) | Obtém ou define o formato de exibição customizado de números e datas. |
...
Retorna o índice da linha da planilha em que a célula está localizada. Somente leitura int.
...
Retorna o índice da coluna da planilha em que a célula está localizada. Somente leitura int.
...
Obtém ou define o formato de exibição customizado de números e datas. Se o valor estiver vazio, será usado o valor PresetNumberFormat. Leitura/gravação String.
...
Obtém ou define o formato de exibição interno de números e datas. O número pré-definido deve estar em [0..22] ou [37..49]. Leitura/gravação byte.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| updateValues | boolean | Se false, nenhuma cálculo real será realizado. Use true para verificar possíveis exceções. |