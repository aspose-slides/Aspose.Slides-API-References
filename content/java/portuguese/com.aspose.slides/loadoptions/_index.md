...
| [getBlobManagementOptions()](#getBlobManagementOptions--) | Representa as opções que podem ser usadas para gerenciar o comportamento de manipulação de Binary Large Objects (BLOBs), como o uso de arquivos temporários ou o número máximo de bytes de BLOBs em memória. |
| [setBlobManagementOptions(IBlobManagementOptions value)](#setBlobManagementOptions-com.aspose.slides.IBlobManagementOptions-) | Representa as opções que podem ser usadas para gerenciar o comportamento de manipulação de Binary Large Objects (BLOBs), como o uso de arquivos temporários ou o número máximo de bytes de BLOBs em memória. |
| [getDocumentLevelFontSources()](#getDocumentLevelFontSources--) | Especifica as fontes externas a serem usadas pela apresentação. |
| [setDocumentLevelFontSources(IFontSources value)](#setDocumentLevelFontSources-com.aspose.slides.IFontSources-) | Especifica as fontes externas a serem usadas pela apresentação. |
...
Retorna ou define o formato de uma apresentação a ser carregada. Leitura/escrita [LoadFormat](../../com.aspose.slides/loadformat).
...
Retorna ou define a fonte Regular usada caso a fonte de origem não seja encontrada. Leitura/escrita String.
...
>  
>  // Use opções de carregamento para definir as fontes regular e asiática padrão
...
Retorna ou define a fonte Symbol usada caso a fonte de origem não seja encontrada. Leitura/escrita String.
...
Retorna ou define a fonte Asian usada caso a fonte de origem não seja encontrada. Leitura/escrita String.
...
Obtém ou define a senha. Leitura/escrita String.
...
Retorna ou define um objeto que recebe avisos e decide se o processo de carregamento continuará ou será abortado. Leitura/escrita [IWarningCallback](../../com.aspose.slides/iwarningcallback).
...
Representa as opções que podem ser usadas para gerenciar o comportamento de manipulação de Binary Large Objects (BLOBs), como o uso de arquivos temporários ou o número máximo de bytes de BLOBs em memória. Estas opções destinam-se a definir a melhor relação desempenho/consumo de memória para um ambiente ou requisitos específicos.
...
Especifica as fontes externas a serem usadas pela apresentação. Essas fontes estão disponíveis para a apresentação durante todo o seu ciclo de vida e não são compartilhadas com outras apresentações.
...
>  //CustomFont1, CustomFont2, assim como fontes das pastas assets\fonts & global\fonts e suas subpastas estão disponíveis para a apresentação
>  } finally {
...
Retorna ou define a interface de callback que gerencia o carregamento de recursos externos. Leitura/escrita [IResourceLoadingCallback](../../com.aspose.slides/iresourceloadingcallback).
...
Obtém opções para planilhas. Por exemplo, estas opções afetam o cálculo de fórmulas para gráficos.
