...
| Método | Descrição |
| --- | --- |
| [getLastView()](#getLastView--) | Especifica o modo de visualização usado quando o documento de apresentação foi salvo pela última vez. |
| [setLastView(int value)](#setLastView-int-) | Especifica o modo de visualização usado quando o documento de apresentação foi salvo pela última vez. |
...
Especifica o modo de visualização usado quando o documento de apresentação foi salvo pela última vez. Leitura/Gravação [ViewType](../../com.aspose.slides/viewtype).
