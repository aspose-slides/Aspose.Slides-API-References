...
> ```
> Este exemplo demonstra a obtenção de propriedades de tema efetivas.
>  
...
**Retorna:** [IThemeEffectiveData](../../com.aspose.slides/ithemeeffectivedata) - Um [IThemeEffectiveData](../../com.aspose.slides/ithemeeffectivedata).
### getParent_Immediate() {#getParent-Immediate--}
```
