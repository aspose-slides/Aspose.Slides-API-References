...
| Método | Descrição |
| --- | --- |
| [isEmpty()](#isEmpty--) | Um valor true indica que ColorScheme, FontScheme, FormatScheme são nulos e qualquer sobrescrita com este objeto de tema está desativada. |
...
| [clear()](#clear--) | Define ColorScheme, FontScheme, FormatScheme como null para desativar qualquer sobrescrita com este objeto de tema. |
### isEmpty() {#isEmpty--}
```
public abstract boolean isEmpty()
```

Um valor true indica que ColorScheme, FontScheme, FormatScheme são nulos e qualquer sobrescrita com este objeto de tema está desativada. Booleano somente leitura.
...
Define ColorScheme, FontScheme, FormatScheme como null para desativar qualquer sobrescrita com este objeto de tema.