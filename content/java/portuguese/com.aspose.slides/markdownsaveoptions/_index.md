...
| [getShowSlideNumber()](#getShowSlideNumber--) | Especifica se o documento gerado deve mostrar o número de cada slide ou não. |
| [setShowSlideNumber(boolean value)](#setShowSlideNumber-boolean-) | Especifica se o documento gerado deve mostrar o número de cada slide ou não. |
...
| [getHandleRepeatedSpaces()](#getHandleRepeatedSpaces--) | Especifica como caracteres de espaço regulares repetidos devem ser tratados durante a exportação Markdown. |
| [setHandleRepeatedSpaces(int value)](#setHandleRepeatedSpaces-int-) | Especifica como caracteres de espaço regulares repetidos devem ser tratados durante a exportação Markdown. |
| [getRemoveEmptyLines()](#getRemoveEmptyLines--) | Se definido como true, remove linhas vazias ou contendo apenas espaços em branco da saída final Markdown. |
| [setRemoveEmptyLines(boolean value)](#setRemoveEmptyLines-boolean-) | Se definido como true, remove linhas vazias ou contendo apenas espaços em branco da saída final Markdown. |
| [setImageSaving(MarkdownSaveOptions.MarkdownImageSavingHandler event)](#setImageSaving-com.aspose.slides.MarkdownSaveOptions.MarkdownImageSavingHandler-) | Ocorre para cada imagem não SVG (bitmap ou metafile) durante a exportação Markdown. |
| [setSvgImageSaving(MarkdownSaveOptions.MarkdownSvgImageSavingHandler event)](#setSvgImageSaving-com.aspose.slides.MarkdownSaveOptions.MarkdownSvgImageSavingHandler-) | Ocorre para cada imagem SVG durante a exportação Markdown. |
...
Obtém ou define a string de formato usada para cabeçalhos de número de slide na saída Markdown. O formato deve incluir o placeholder "\{0\}", que será substituído pelo índice do slide durante a exportação. Exemplo: "\# Slide \{0\}" produzirá "\# Slide 1", "\# Slide 2", etc.
...
Se definido como true, remove linhas vazias ou contendo apenas espaços em branco da saída final Markdown. O padrão é false.
...
Ocorre para cada imagem não SVG (bitmap ou metafile) durante a exportação Markdown. Permite personalizar como a imagem é salva e referenciada. Se não for tratada, a imagem é salva localmente com um link relativo.
...
Ocorre para cada imagem SVG durante a exportação Markdown. Permite substituir o salvamento padrão e a geração de link. Se não for tratada, o SVG é salvo localmente com um link relativo.

**Parâmetros:**
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| event | [MarkdownSvgImageSavingHandler](../../com.aspose.slides/markdownsvgimagesavinghandler) | Evento de salvamento de imagem SVG Markdown. |