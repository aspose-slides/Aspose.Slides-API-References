...
| [getUseFrameRotation()](#getUseFrameRotation--) | Determina se deve executar a rotação especificada da forma ao renderizar ou não. |
| [setUseFrameRotation(boolean value)](#setUseFrameRotation-boolean-) | Determina se deve executar a rotação especificada da forma ao renderizar ou não. |
...
| [getDisable3DText()](#getDisable3DText--) | Determina se o texto 3D está desativado no SVG. |
| [setDisable3DText(boolean value)](#setDisable3DText-boolean-) | Determina se o texto 3D está desativado no SVG. |
...
| [getDisableLineEndCropping()](#getDisableLineEndCropping--) | SVG 1.1 não possui capacidade de definir recuos para marcadores. |
| [setDisableLineEndCropping(boolean value)](#setDisableLineEndCropping-boolean-) | SVG 1.1 não possui capacidade de definir recuos para marcadores. |
...
| [getWYSIWYG()](#getWYSIWYG--) | Retorna configurações para a geração do arquivo SVG mais preciso. |
| [getJpegQuality()](#getJpegQuality--) | Determina a qualidade da codificação JPEG. |
| [setJpegQuality(int value)](#setJpegQuality-int-) | Determina a qualidade da codificação JPEG. |
| [getShapeFormattingController()](#getShapeFormattingController--) | Retorna e define uma interface de callback que permite ao usuário controlar a conversão de formas. |
| [setShapeFormattingController(ISvgShapeFormattingController value)](#setShapeFormattingController-com.aspose.slides.ISvgShapeFormattingController-) | Retorna e define uma interface de callback que permite ao usuário controlar a conversão de formas. |
...
| [getExternalFontsHandling()](#getExternalFontsHandling--) | Determina uma forma de lidar com fontes carregadas externamente. |
| [setExternalFontsHandling(int value)](#setExternalFontsHandling-int-) | Determina uma forma de lidar com fontes carregadas externamente. |
...
Determina se deve executar a rotação especificada da forma ao renderizar ou não. Leitura/gravação boolean. Valor padrão é true.
...
Determina se o texto 3D está desativado no SVG. Leitura/gravação boolean.
...
SVG 1.1 não possui capacidade de definir recuos para marcadores. O mecanismo de gravação SVG do Aspose.Slides tem uma solução alternativa para esse problema: ele recorta o final da linha com seta, de modo que a linha não sobreponha os marcadores. Esta opção desativa esse comportamento. Leitura/gravação boolean.
...
Retorna configurações para a geração do arquivo SVG mais preciso. Somente leitura [SVGOptions](../../com.aspose.slides/svgoptions).
...
Determina a qualidade da codificação JPEG. Leitura/gravação int.
...
Retorna e define uma interface de callback que permite ao usuário controlar a conversão de formas. Leitura/gravação [ISvgShapeFormattingController](../../com.aspose.slides/isvgshapeformattingcontroller).
...
Determina uma forma de lidar com fontes carregadas externamente. Leitura/gravação [SvgExternalFontsHandling](../../com.aspose.slides/svgexternalfontshandling).
