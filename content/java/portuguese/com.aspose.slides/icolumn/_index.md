...
| [getColumnFormat()](#getColumnFormat--) | Retorna o objeto ColumnFormat que contém as propriedades de formatação para esta coluna. |
### getWidth() {#getWidth--}
```
...
Retorna o objeto ColumnFormat que contém as propriedades de formatação para esta coluna. Somente leitura [IColumnFormat](../../com.aspose.slides/icolumnformat).
