...
| --- | --- | --- |
| index | int | Índice do comportamento a ser retornado. |
...
Retorna o número de comportamentos em uma coleção. int somente leitura.
...
**Retorno:**
boolean - Verdadeiro se o comportamento foi removido com sucesso boolean
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | Índice do comportamento a ser removido. |
