...
Determina o formato no qual a imagem do slide será salva para a exportação de apresentação em HTML.
## Construtores
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| scale | float | O fator pelo qual a imagem de saída será dimensionada. |
