...
Especifica uma instância de texto matemático que está contida dentro de um MathParagraph e começa em sua própria linha. Todas as zonas matemáticas, incluindo equações, expressões, arrays de equações ou expressões e fórmulas são representadas por um bloco matemático.
...
| [join(IMathElement mathElement)](#join-com.aspose.slides.IMathElement-) | Junta um elemento matemático a este bloco matemático |
| [join(String mathText)](#join-java.lang.String-) | Junta um texto matemático a este bloco matemático |
| [joinBlock(IMathBlock other)](#joinBlock-com.aspose.slides.IMathBlock-) | Junta outro bloco matemático a este |
| [delimit(char separatorCharacter)](#delimit-char-) | Delimita os elementos filhos com o caractere separador (sem os colchetes) |
...
Obtém o número de elementos matemáticos filhos realmente contidos na coleção. Somente leitura int.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | O objeto a localizar na coleção. |
...
| arrayIndex | int | Índice onde começar a copiar. |
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IMathElement> - Um IGenericEnumerator que pode ser usado para iterar sobre a coleção.
...
**Retorna:**
com.aspose.ms.System.Collections.IEnumerator - Um java.util.Iterator para a coleção inteira.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| item | [IMathElement](../../com.aspose.slides/imathelement) | O elemento a localizar na coleção. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice baseado em zero no qual o MathElement deve ser inserido. |
...
**Retorna:**
[IMathBlock](../../com.aspose.slides/imathblock) - este bloco matemático após a junção
### delimit(char separatorCharacter) {#delimit-char-}
```
public final IMathDelimiter delimit(char separatorCharacter)
```

Delimita os elementos filhos com o caractere separador (sem os colchetes)
