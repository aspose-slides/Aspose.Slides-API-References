...
| [getEffective()](#getEffective--) | Obtém os dados efetivos do efeito Desfoque com a herança aplicada. |
...
Retorna ou define o raio de desfoque. Leitura/escrita double.
...
Determina se os limites do objeto devem ser ampliados como resultado do desfoque. true indica que os limites são ampliados enquanto false indica que não são. Leitura/escrita boolean.
...
Obtém os dados efetivos do efeito Desfoque com a herança aplicada.
