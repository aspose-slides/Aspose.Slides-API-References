...
| [close()](#close--) | Libera recursos usados por esta instância. |
...
| apiKey | java.lang.String | Chave da API OpenAI. |
...
Cria uma instância do cliente web OpenAI que usa um  HttpClient  gerenciado externamente . O HttpClient fornecido  não é descartado por esta instância e permanece sob responsabilidade do chamador.
...
Envia uma instrução de chat para o modelo de IA usando uma instância de HttpConnection fornecida e retorna a mensagem de resposta para a instrução dada.
...
Libera recursos usados por esta instância.