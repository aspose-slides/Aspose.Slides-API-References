...
second_title: Aspose.Slides para Referência de API Java
...
Se um elemento para esta seção já existe na coleção, o elemento existente é retornado. |
...
**Retorna:**
[ISummaryZoomSection](../../com.aspose.slides/isummaryzoomsection) - [ISummaryZoomSection](../../com.aspose.slides/isummaryzoomsection) ou nulo se a coleção não contém elemento para a seção.
