...
Retorna o número de colunas em uma coleção. Somente leitura int.
...
Retorna a coluna no índice especificado. Somente leitura [Column](../../com.aspose.slides/column).
...
| withAttachedColumns | boolean | Verdadeiro para copiar também todas as colunas anexadas à linha de modelo. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | Índice de uma nova coluna. |
| templ | [IColumn](../../com.aspose.slides/icolumn) | Coluna usada como modelo. |
| withAttachedColumns | boolean | Verdadeiro para copiar também todas as colunas anexadas à coluna de modelo. |
...
| withAttachedRows | boolean | Verdadeiro para excluir também todas as colunas anexadas. |
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IColumn> - Um java.util.Iterator para a coleção inteira.
