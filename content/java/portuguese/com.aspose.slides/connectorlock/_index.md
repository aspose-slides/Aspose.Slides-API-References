...
description: Determina quais operações estão desativadas no Connector pai.
type: docs
url: /pt/com.aspose.slides/connectorlock/
---
**Herança:**
...
Determina quais operações estão desabilitadas no Connector pai.
## Métodos
...
| [getRotateLocked()](#getRotateLocked--) | Determina se a mudança do ângulo de rotação desta forma é proibida. |
| [setRotateLocked(boolean value)](#setRotateLocked-boolean-) | Determina se a mudança do ângulo de rotação desta forma é proibida. |
| [getAspectRatioLocked()](#getAspectRatioLocked--) | Determina se a forma deve preservar a proporção ao redimensionar. |
| [setAspectRatioLocked(boolean value)](#setAspectRatioLocked-boolean-) | Determina se a forma deve preservar a proporção ao redimensionar. |
| [getPositionMove()](#getPositionMove--) | Determina se mover esta forma é proibido. |
| [setPositionMove(boolean value)](#setPositionMove-boolean-) | Determina se mover esta forma é proibido. |
...
| [getArrowheadsLocked()](#getArrowheadsLocked--) | Determina se a mudança das pontas de seta é proibida. |
| [setArrowheadsLocked(boolean value)](#setArrowheadsLocked-boolean-) | Determina se a mudança das pontas de seta é proibida. |
| [getShapeTypeLocked()](#getShapeTypeLocked--) | Determina se a mudança do tipo de forma é proibida. |
| [setShapeTypeLocked(boolean value)](#setShapeTypeLocked-boolean-) | Determina se a mudança do tipo de forma é proibida. |
...
Determina se a mudança dos valores de ajuste é proibida. Leitura/gravação boolean.
...
Determina se a mudança das pontas de seta é proibida. Leitura/gravação boolean.
...
Determina se a mudança do tipo de forma é proibida. Leitura/gravação boolean.
