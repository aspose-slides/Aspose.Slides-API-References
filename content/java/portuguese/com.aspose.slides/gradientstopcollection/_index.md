...
| [get_Item(int index)](#get-Item-int-) | Retorna o ponto de gradiente por índice. |
| [add(float position, Color color)](#add-float-java.awt.Color-) | Cria o novo ponto de gradiente e o adiciona ao final da coleção. |
...
| [insert(int index, float position, Color color)](#insert-int-float-java.awt.Color-) | Cria o novo ponto de gradiente e o insere no índice especificado da coleção. |
...
| color | java.awt.Color | Cor do novo ponto de gradiente. |
