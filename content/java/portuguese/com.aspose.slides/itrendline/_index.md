...
| [getBackward()](#getBackward--) | Especifica o número de categorias (ou unidades em um gráfico de dispersão) que a linha de tendência se estende antes dos dados da série que está sendo analisada. |
| [setBackward(double value)](#setBackward-double-) | Especifica o número de categorias (ou unidades em um gráfico de dispersão) que a linha de tendência se estende antes dos dados da série que está sendo analisada. |
| [getForward()](#getForward--) | Especifica o número de categorias (ou unidades em um gráfico de dispersão) que a linha de tendência se estende após os dados da série que está sendo analisada. |
| [setForward(double value)](#setForward-double-) | Especifica o número de categorias (ou unidades em um gráfico de dispersão) que a linha de tendência se estende após os dados da série que está sendo analisada. |
...
| [getDisplayEquation()](#getDisplayEquation--) | Especifica que a equação da linha de tendência é exibida no gráfico (no mesmo rótulo que o valor de Rsquared). |
| [setDisplayEquation(boolean value)](#setDisplayEquation-boolean-) | Especifica que a equação da linha de tendência é exibida no gráfico (no mesmo rótulo que o valor de Rsquared). |
...
Especifica o número de categorias (ou unidades em um gráfico de dispersão) que a linha de tendência se estende antes dos dados da série que está sendo analisada. Em gráficos de dispersão e não-dispersão, o valor pode ser qualquer valor não negativo. Leitura/gravação double.
...
Especifica o número de categorias (ou unidades em um gráfico de dispersão) que a linha de tendência se estende após os dados da série que está sendo analisada. Em gráficos de dispersão e não-dispersão, o valor pode ser qualquer valor não negativo. Leitura/gravação double.
...
Especifica o valor onde a linha de tendência cruza o eixo y. Esta propriedade é suportada apenas quando o tipo da linha de tendência é exp, linear ou poly. Leitura/gravação double.
...
Especifica que a equação da linha de tendência é exibida no gráfico (no mesmo rótulo que o valor de Rsquared). Leitura/gravação boolean.
