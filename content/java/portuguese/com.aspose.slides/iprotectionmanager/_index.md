...
| [isOnlyDocumentPropertiesLoaded()](#isOnlyDocumentPropertiesLoaded--) | Esta propriedade faz sentido se o arquivo da apresentação estiver protegido por senha e as propriedades do documento desse arquivo forem públicas. |
...
Valor: true se a apresentação foi carregada de um arquivo criptografado ou \#encrypt(String).encrypt(String) method was called; otherwise, false.
...
Esta propriedade faz sentido se o arquivo da apresentação estiver protegido por senha e as propriedades do documento desse arquivo forem públicas. Valor true significa que somente as propriedades do documento são carregadas de um arquivo de apresentação criptografado sem uso de senha. Valor false significa que a apresentação criptografada inteira é carregada com o uso da senha correta, não apenas as propriedades do documento são carregadas. Se a apresentação não estiver criptografada, então o valor da propriedade é sempre false. Se as propriedades do documento de um arquivo criptografado não forem públicas, então o valor da propriedade é sempre false. Se PresentationEx.EncryptDocumentProperties for true, então o valor da propriedade IsOnlyDocumentPropertiesLoaded é sempre false. Boolean de somente leitura.
...
Retorna a senha de criptografia. String de somente leitura.
...
**Retorna:**
boolean - True se a senha for válida; caso contrário, false.