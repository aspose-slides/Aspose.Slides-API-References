...
Representa um efeito Fill Overlay. Uma sobreposição de preenchimento pode ser usada para especificar um preenchimento adicional para um objeto e mesclar os dois preenchimentos juntos.
## Métodos
...
| [getEffective()](#getEffective--) | Obtém os dados efetivos do efeito Fill Overlay com a herança aplicada. |
...
FillBlendMode. Leitura/escrita [FillBlendMode](../../com.aspose.slides/fillblendmode).
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| obj | java.lang.Object | O [FillOverlay](../../com.aspose.slides/filloverlay) a ser comparado. |
