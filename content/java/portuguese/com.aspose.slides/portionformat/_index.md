...
>      // +mn-lt - Fonte Latin do corpo (Fonte Latin Menor)
>      // +mj-lt -Heading Fonte Latin do título (Fonte Latin Maior)
>      // +mn-ea - Fonte East Asian do corpo (Fonte East Asian Menor)
>      // +mj-ea - Fonte East Asian do corpo (Fonte East Asian Menor)
...
Esta classe é usada para obter e manipular as propriedades de formatação da porção de texto definidas para a porção específica. Isso significa que nenhuma herança é aplicada ao obter valores, de modo que, na maioria dos casos, você receberá valores que significam “não definido”.

Para obter os valores efetivos dos parâmetros de formatação, incluindo os herdados, você precisa usar o método [getEffective](../../com.aspose.slides/portionformat\#getEffective), que retorna uma instância [IPortionFormatEffectiveData](../../com.aspose.slides/iportionformateffectivedata).
## Construtores
...
| Método | Descrição |
| --- | --- |
| [getBookmarkId()](#getBookmarkId--) | Retorna ou define o identificador de marcador. |
| [setBookmarkId(String value)](#setBookmarkId-java.lang.String-) | Retorna ou define o identificador de marcador. |
...
| [getEffective()](#getEffective--) | Obtém os dados de formatação efetiva da porção com a herança aplicada. |
...
Retorna ou define o identificador de marcador. Leitura/gravação String.
...
Obtém os dados de formatação efetiva da porção com a herança aplicada.
