...
type: docs
url: /pt/com.aspose.slides/effectstylecollection/
---
**Herança:**
...
| Método | Descrição |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Retorna um elemento na posição especificada. |
...
Retorna um elemento na posição especificada. Somente leitura [EffectStyle](../../com.aspose.slides/effectstyle).

**Parâmetros:**
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | Posição do elemento. |

**Retorna:**
[IEffectStyle](../../com.aspose.slides/ieffectstyle) - Elemento na posição especificada.
### iterator() {#iterator--}
```
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffectStyle> - Um IGenericEnumerator que pode ser usado para iterar através da coleção.
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IEffectStyle> - Um java.util.Iterator para a coleção inteira.
### size() {#size--}
```
public final int size()
```

Retorna o número de elementos na coleção. Somente leitura int, Somente leitura int.
