...
| [getEmbeddedData()](#getEmbeddedData--) | Obtém informações sobre dados incorporados OLE. |
...
Obtém informações sobre dados incorporados OLE. Somente leitura [IOleEmbeddedDataInfo](../../com.aspose.slides/ioleembeddeddatainfo).
...
Nas apresentações Ppt, alguns links de objeto Ole podem ter uma representação relativa.
