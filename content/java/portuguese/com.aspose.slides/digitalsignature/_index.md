...
| Método | Descrição |
| --- | --- |
| [getCertificate()](#getCertificate--) | Objeto de certificado usado para assinar o documento. |
| [isValid()](#isValid--) | Se esta assinatura digital for válida e o documento não tiver sido adulterado, este valor será verdadeiro. |
| [getSignTime()](#getSignTime--) | A hora em que o documento foi assinado. |
...
Objeto de certificado usado para assinar o documento. Somente leitura byte[].
...
A hora em que o documento foi assinado. Somente leitura java.util.Date.
