...
| [getDisableLineEndCropping()](#getDisableLineEndCropping--) | O SVG 1.1 não tem capacidade de definir recuos para marcadores. |
| [setDisableLineEndCropping(boolean value)](#setDisableLineEndCropping-boolean-) | O SVG 1.1 não tem capacidade de definir recuos para marcadores. |
...
| [getPicturesCompression()](#getPicturesCompression--) | Representa o nível de compressão de imagens Leitura/gravação \#getPicturesCompression.getPicturesCompression/\#setPicturesCompression(int).setPicturesCompression(int). |
| [setPicturesCompression(int value)](#setPicturesCompression-int-) | Representa o nível de compressão de imagens Leitura/gravação \#getPicturesCompression.getPicturesCompression/\#setPicturesCompression(int).setPicturesCompression(int). |
...
| [getUseFrameRotation()](#getUseFrameRotation--) | Determina se a rotação especificada da forma deve ser realizada ao renderizar ou não. |
| [setUseFrameRotation(boolean value)](#setUseFrameRotation-boolean-) | Determina se a rotação especificada da forma deve ser realizada ao renderizar ou não. |
...
Representa o nível de compressão de imagens Leitura/gravação \#getPicturesCompression.getPicturesCompression/\#setPicturesCompression(int).setPicturesCompression(int).
...
Determina se a rotação especificada da forma deve ser realizada ao renderizar ou não. Leitura/gravação boolean. Valor padrão é true.
...
Obtém ou define um valor que indica se o texto é renderizado sem usar ligaduras. Quando definido como true, as ligaduras serão desativadas na saída renderizada. Por padrão, esta propriedade é false.
