...
description: Representa o comportamento base da classe do efeito.
type: docs
...
Representa o comportamento base da classe do efeito.
## Métodos
...
| [getTiming()](#getTiming--) | Representa propriedades de tempo para o comportamento do efeito. |
| [setTiming(ITiming value)](#setTiming-com.aspose.slides.ITiming-) | Representa propriedades de tempo para o comportamento do efeito. |
...
Representa propriedades de tempo para o comportamento do efeito. Leitura/gravação [ITiming](../../com.aspose.slides/itiming).
