...
| [getShowComments()](#getShowComments--) | Especifica se os comentários do slide devem ser mostrados. |
| [setShowComments(byte value)](#setShowComments-byte-) | Especifica se os comentários do slide devem ser mostrados. |
...
Especifica se os comentários do slide devem ser mostrados. Leitura/gravação [NullableBool](../../com.aspose.slides/nullablebool).
