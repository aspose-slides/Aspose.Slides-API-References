...
| [indexOf(IChartSeries value)](#indexOf-com.aspose.slides.IChartSeries-) | Procura o [IChartSeries](../../com.aspose.slides/ichartseries) especificado e retorna o índice baseado em zero da primeira ocorrência em toda a Collection |
...
| type | int | Tipo do gráfico [ChartType](../../com.aspose.slides/charttype) |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| cellWithSeriesName | [IChartDataCell](../../com.aspose.slides/ichartdatacell) | Cell que contém o nome da série. |
| type | int | Tipo definido da série |

--------------------

Se uma série de gráfico for criada a partir da mesma célula já presente na coleção, o método não adiciona nada e retorna seu índice. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| cellsWithSeriesName | [IChartCellCollection](../../com.aspose.slides/ichartcellcollection) | Cells que contêm o nome da série. |
| type | int | Tipo definido da série |
...
Procura o [IChartSeries](../../com.aspose.slides/ichartseries) especificado e retorna o índice baseado em zero da primeira ocorrência em toda a Collection
