...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| amount | float | A quantidade percentual para escalar o alfa. |
...
| grow | boolean | Especifica se os limites do objeto devem ser aumentados como resultado do desfoque. Verdadeiro indica que os limites são aumentados enquanto falso indica que não são. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| hue | float | O matiz para o qual tingir. |
| amount | float | Especifica quanto o valor da cor é deslocado. |
