...
description: Representa um grupo de métodos destinados a coletar objetos de modelo de diferentes tipos de .
type: docs
...
Representa um grupo de métodos destinados a coletar objetos de modelo de diferentes tipos de [Presentation](../../com.aspose.slides/presentation).
...
>      {
>          // ... alter a formatação da forma ou outras propriedades
>      }
>  } finally {
