...
| [getTiming()](#getTiming--) | Representa as propriedades de temporização do comportamento do efeito. |
| [setTiming(ITiming value)](#setTiming-com.aspose.slides.ITiming-) | Representa as propriedades de temporização do comportamento do efeito. |
### getParent_Immediate() {#getParent-Immediate--}
```
...
Representa as propriedades de temporização do comportamento do efeito. Leitura/gravação [ITiming](../../com.aspose.slides/itiming).
