...
| [getLightType()](#getLightType--) | Representa uma luz pré-definida que pode ser aplicada a uma forma. |
| [setLightType(int value)](#setLightType-int-) | Representa uma luz pré-definida que pode ser aplicada a uma forma. |
...
Representa uma luz pré-definida que pode ser aplicada a uma forma. O light rig representa um grupo de luzes orientadas de maneira específica em relação a uma cena 3D. Leitura/gravação [LightRigPresetType](../../com.aspose.slides/lightrigpresettype).
