...
| [getPatternFormat()](#getPatternFormat--) | Retorna o formato de preenchimento padrão. |
### getVersion() {#getVersion--}
```
...
Retorna o formato de preenchimento padrão. Somente leitura [IPatternFormat](../../com.aspose.slides/ipatternformat).
