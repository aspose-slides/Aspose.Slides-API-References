...
| [getEmbeddedData()](#getEmbeddedData--) | Obtém ou define informações sobre dados incorporados OLE. |
| [setEmbeddedData(IOleEmbeddedDataInfo embeddedData)](#setEmbeddedData-com.aspose.slides.IOleEmbeddedDataInfo-) | Define informações sobre dados incorporados OLE. |
| [isObjectIcon()](#isObjectIcon--) | Determina se um objeto é exibido como ícone. |
| [setObjectIcon(boolean value)](#setObjectIcon-boolean-) | Determina se um objeto é exibido como ícone. |
...
Obtém ou define informações sobre dados incorporados OLE. Leitura/gravação [IOleEmbeddedDataInfo](../../com.aspose.slides/ioleembeddeddatainfo).
