...
| Método | Descrição |
| --- | --- |
| [getLayout()](#getLayout--) | Obtém o layout das Seções de Summary Zoom no quadro. |
...
Obtém o layout das Seções de Summary Zoom no quadro. O valor padrão é GridLayout.
