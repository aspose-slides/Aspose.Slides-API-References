...
| [getPictureFillMode()](#getPictureFillMode--) | Retorna o modo de preenchimento de imagem. |
...
| [getCropTop()](#getCropTop--) | Retorna o número de porcentagens da altura real da imagem que são recortadas na parte superior da imagem. |
...
Retorna o modo de preenchimento de imagem. Somente leitura [PictureFillMode](../../com.aspose.slides/picturefillmode).
...
Retorna o número de porcentagens da altura real da imagem que são recortadas na parte superior da imagem. Somente leitura float.
