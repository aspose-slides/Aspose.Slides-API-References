...
description: Objeto imutável que contém as propriedades de formatação de parágrafo efetivas.
type: docs
...
Objeto imutável que contém as propriedades de formatação de parágrafo efetivas.

--------------------

Esta interface é usada junto com a interface [IParagraphFormat](../../com.aspose.slides/iparagraphformat) para retornar valores de formatação efetiva com herança aplicada.
## Methods
...
| [getEastAsianLineBreak()](#getEastAsianLineBreak--) | Determina se a quebra de linha Leste-Ásia é usada em um parágrafo. |
...
| [getIndent()](#getIndent--) | Retorna o recuo da primeira linha ou recuo suspenso do parágrafo. |
| [getDefaultTabSize()](#getDefaultTabSize--) | Retorna o tamanho de tabulação padrão. |
...
Determina se a quebra de linha Leste-Ásia é usada em um parágrafo. Somente leitura boolean.
...
Retorna o recuo da primeira linha ou recuo suspenso do parágrafo. O recuo suspenso pode ser definido com valores negativos. Somente leitura float.
...
Retorna o tamanho de tabulação padrão. Somente leitura float.
...
Retorna o formato de porção padrão de um parágrafo. Somente leitura [IPortionFormatEffectiveData](../../com.aspose.slides/iportionformateffectivedata).
