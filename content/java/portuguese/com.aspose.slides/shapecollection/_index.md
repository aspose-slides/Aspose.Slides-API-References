...
| [insertZoomFrame(int index, float x, float y, float width, float height, ISlide slide, IPPImage image)](#insertZoomFrame-int-float-float-float-float-com.aspose.slides.ISlide-com.aspose.slides.IPPImage-) | Cria um novo quadro de Zoom com uma imagem pré-definida e o insere na coleção de formas no índice especificado. |
...
| [addSectionZoomFrame(float x, float y, float width, float height, ISection section, IPPImage image)](#addSectionZoomFrame-float-float-float-float-com.aspose.slides.ISection-com.aspose.slides.IPPImage-) | Cria um novo quadro de Zoom de Seção com uma imagem pré-definida e o adiciona ao final da coleção de formas. |
...
| [insertAudioFrameEmbedded(int index, float x, float y, float width, float height, InputStream audio_stream)](#insertAudioFrameEmbedded-int-float-float-float-float-java.io.InputStream-) | Cria um novo quadro de áudio com um arquivo WAV incorporado e o adiciona ao final da coleção de formas. |
...
| [addMathShape(float x, float y, float width, float height)](#addMathShape-float-float-float-float-) | Cria uma nova forma automática retângulo para hospedar conteúdo matemático e a adiciona ao final da coleção de formas. |
...
>      // Define a série para exibir o valor do terceiro rótulo
...
> ```
> O exemplo a seguir mostra como adicionar smart shape em uma apresentação PowerPoint.
>  
>  Presentation pres = new Presentation();
>  try {
...
| width | float | A largura do novo gráfico, em pontos. |
| height | float | A altura do novo gráfico, em pontos. |
| index | int | O índice baseado em zero onde o novo gráfico será inserido na coleção de shapes. |
| initWithSample | boolean | Verdadeiro para inicializar o novo gráfico com dados e configurações de série de exemplo; falso para criar o gráfico sem séries e apenas com configurações mínimas, o que torna a criação mais rápida. |
...
Cria um novo frame de Zoom e o adiciona ao final da coleção de shapes.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| x | float | A coordenada x do novo frame de Zoom, em pontos. |
| y | float | A coordenada y do novo frame de Zoom, em pontos. |
| width | float | A largura do novo frame de Zoom, em pontos. |
| height | float | A altura do novo frame de Zoom, em pontos. |
| slide | [ISlide](../../com.aspose.slides/islide) | O [ISlide](../../com.aspose.slides/islide) referenciado pelo frame de Zoom; deve pertencer a esta apresentação. |

**Retorno:**
[IZoomFrame](../../com.aspose.slides/izoomframe) - O recém-criado [IZoomFrame](../../com.aspose.slides/izoomframe).
...
Cria um novo frame de Zoom e o insere na coleção de shapes no índice especificado.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice baseado em zero onde o frame de Zoom será inserido. |
| x | float | A coordenada x do novo frame de Zoom, em pontos. |
| y | float | A coordenada y do novo frame de Zoom, em pontos. |
| width | float | A largura do novo frame de Zoom, em pontos. |
| height | float | A altura do novo frame de Zoom, em pontos. |
| slide | [ISlide](../../com.aspose.slides/islide) | O [ISlide](../../com.aspose.slides/islide) referenciado pelo frame de Zoom. |
...
Cria um novo frame de Zoom com uma imagem pré-definida e o insere na coleção de shapes no índice especificado.
...
Cria um novo frame de Zoom de Seção e o adiciona ao final da coleção de shapes.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| x | float | A coordenada x do novo frame de Zoom de Seção, em pontos. |
| y | float | A coordenada y do novo frame de Zoom de Seção, em pontos. |
| width | float | A largura do novo frame de Zoom de Seção, em pontos. |
| height | float | A altura do novo frame de Zoom de Seção, em pontos. |
| section | [ISection](../../com.aspose.slides/isection) | O [ISection](../../com.aspose.slides/isection) referenciado pelo frame de Zoom de Seção; deve pertencer a esta apresentação e conter ao menos um slide. |

**Retorno:**
[ISectionZoomFrame](../../com.aspose.slides/isectionzoomframe) - O recém-criado [ISectionZoomFrame](../../com.aspose.slides/isectionzoomframe).
...
Cria um novo frame de Zoom de Seção com uma imagem pré-definida e o adiciona ao final da coleção de shapes.
...
| height | float | A altura do novo frame de Zoom de Seção, em pontos. |
| section | [ISection](../../com.aspose.slides/isection) | O [ISection](../../com.aspose.slides/isection) referenciado pelo frame de Zoom de Seção; deve pertencer a esta apresentação e conter ao menos um slide. |
| image | [IPPImage](../../com.aspose.slides/ippimage) | O [IPPImage](../../com.aspose.slides/ippimage) a ser exibido dentro do frame de Zoom de Seção. |
...
Cria um novo frame de Zoom de Seção e o insere na coleção de shapes no índice especificado.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice baseado em zero onde o frame de Zoom de Seção será inserido. |
| x | float | A coordenada x do novo frame de Zoom de Seção, em pontos. |
| y | float | A coordenada y do novo frame de Zoom de Seção, em pontos. |
| width | float | A largura do novo frame de Zoom de Seção, em pontos. |
| height | float | A altura do novo frame de Zoom de Seção, em pontos. |
...
Cria um novo frame de Zoom de Seção com uma imagem pré-definida e o insere na coleção de shapes no índice especificado.
...
| height | float | A altura do novo frame de Zoom de Seção, em pontos. |
| section | [ISection](../../com.aspose.slides/isection) | O [ISection](../../com.aspose.slides/isection) referenciado pelo frame de Zoom de Seção; deve pertencer a esta apresentação e conter ao menos um slide. |
| image | [IPPImage](../../com.aspose.slides/ippimage) | A imagem a ser exibida dentro do frame de Zoom de Seção. |
...
Cria um novo frame de Zoom de Resumo e o adiciona ao final da coleção de shapes.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| x | float | A coordenada x do novo frame de Zoom de Resumo, em pontos. |
| y | float | A coordenada y do novo frame de Zoom de Resumo, em pontos. |
| width | float | A largura do novo frame de Zoom de Resumo, em pontos. |
| height | float | A altura do novo frame de Zoom de Resumo, em pontos. |

--------------------

Este método cria um novo Zoom de Resumo e coloca uma coleção de objetos nele para todas as seções desta apresentação.

**Retorno:**
[ISummaryZoomFrame](../../com.aspose.slides/isummaryzoomframe) - O recém-criado [ISummaryZoomFrame](../../com.aspose.slides/isummaryzoomframe).
...
Cria um novo frame de Zoom de Resumo e o insere na coleção de shapes no índice especificado.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice baseado em zero onde o frame de Zoom de Resumo será inserido. |
| x | float | A coordenada x do novo frame de Zoom de Resumo, em pontos. |
| y | float | A coordenada y do novo frame de Zoom de Resumo, em pontos. |
| width | float | A largura do novo frame de Zoom de Resumo, em pontos. |
| height | float | A altura do novo frame de Zoom de Resumo, em pontos. |
...
Este método cria um frame de Zoom de Resumo que agrega links de resumo para todas as seções da apresentação.
...
Cria um novo frame de objeto OLE e o adiciona ao final da coleção de shapes.
...
>      }
>      // Cria objeto de dados para incorporação
>      IOleEmbeddedDataInfo dataInfo = new OleEmbeddedDataInfo(mstream.toByteArray(), "xlsx");
> 
>      // Adiciona um shape de Ole Object Frame
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| x | float | A coordenada x do novo frame OLE, em pontos. |
| y | float | A coordenada y do novo frame OLE, em pontos. |
| width | float | A largura do novo frame OLE, em pontos. |
| height | float | A altura do novo frame OLE, em pontos. |
...
**Retorno:**
[IOleObjectFrame](../../com.aspose.slides/ioleobjectframe) - O recém-criado [IOleObjectFrame](../../com.aspose.slides/ioleobjectframe).
...
Cria um novo frame de objeto OLE e o insere na coleção de shapes no índice especificado.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice baseado em zero onde o frame de objeto OLE será inserido. |
...
| dataInfo | [IOleEmbeddedDataInfo](../../com.aspose.slides/ioleembeddeddatainfo) | A informação de dados OLE incorporada ([IOleEmbeddedDataInfo](../../com.aspose.slides/ioleembeddeddatainfo)). |
...
Este caminho é armazenado literalmente na apresentação. Se um caminho relativo for especificado, o arquivo ficará inacessível ao abrir a apresentação a partir de outro diretório.  

**Retorna:**
[IOleObjectFrame](../../com.aspose.slides/ioleobjectframe) - O recém-criado quadro de objeto OLE.
...
**Retorna:**
[IVideoFrame](../../com.aspose.slides/ivideoframe) - O recém-criado [IVideoFrame](../../com.aspose.slides/ivideoframe).
...
**Retorna:**
[IAudioFrame](../../com.aspose.slides/iaudioframe) - O recém-criado [IAudioFrame](../../com.aspose.slides/iaudioframe).
...
> ```
> O exemplo a seguir mostra como criar Audio Frame.
>  
...
| count | int | O número de formas a serem retornadas. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice baseado em zero de destino onde a forma será colocada. |
| shape | [IShape](../../com.aspose.slides/ishape) | A [IShape](../../com.aspose.slides/ishape) a mover dentro da coleção. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice baseado em zero de destino onde a primeira forma especificada será colocada; as formas subsequentes seguem na ordem fornecida. |
| shapes | IShape[] | As formas a mover.
| shapes | [IShape\[\]](../../com.aspose.slides/ishape) | Uma ou mais [IShape](../../com.aspose.slides/ishape) instâncias para mover dentro da coleção. |
...
Cria uma nova forma automática e a adiciona ao final da coleção de formas, opcionalmente inicializando-a com o estilo de modelo padrão.
...
| width | float | A largura da moldura da forma, em pontos. |
| height | float | A altura da moldura da forma, em pontos. |
| createFromTemplate | boolean | Verdadeiro para aplicar o estilo de modelo padrão (estilo simples, texto centralizado e nome não vazio) à nova forma; falso para criar a forma com todas as propriedades definidas para seus valores padrão. |
...
Cria uma nova forma automática e a insere na coleção de formas no índice especificado, aplicando o estilo de modelo padrão.
...
| width | float | A largura da moldura da forma, em pontos. |
| height | float | A altura da moldura da forma, em pontos. |
| createFromTemplate | boolean | Verdadeiro para aplicar o estilo de modelo padrão (incluindo nome não vazio, estilo simples e texto centralizado); falso para criar a forma com todas as propriedades nos valores padrão. |
...
Cria uma nova forma de grupo vazia e a adiciona ao final da coleção de formas. A moldura do grupo será ajustada automaticamente para acomodar quaisquer formas adicionadas a ele.
...
>      // Adicionando formas dentro do shape de grupo adicionado
...
Cria uma nova forma de grupo vazia e a insere na coleção de formas no índice especificado. A moldura do grupo será ajustada automaticamente para acomodar quaisquer formas adicionadas a ele.

**Parâmetros:**
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice baseado em zero no qual inserir a forma de grupo. |
...
> ```
> O exemplo a seguir mostra como adicionar um conector (um conector curvo) entre duas formas (uma elipse e um retângulo) em uma apresentação PowerPoint.
>  
>  // Instancia a classe Presentation que representa um arquivo PPTX
>  Presentation pres = new Presentation();
>  try {
...
>      // Adiciona um shape de conector à coleção de formas do slide
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| shapeType | int | O [ShapeType](../../com.aspose.slides/shapetype) do conector a ser adicionado. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| shapeType | int | O [ShapeType](../../com.aspose.slides/shapetype) do conector a ser criado. |
| x | float | A coordenada x da moldura do conector, em pontos. |
| y | float | A coordenada y da moldura do conector, em pontos. |
| width | float | A largura da moldura do conector, em pontos. |
| height | float | A altura da moldura do conector, em pontos. |
| createFromTemplate | boolean | Verdadeiro para aplicar o estilo de modelo padrão (nome não vazio, estilo simples); falso para criar o conector com valores de propriedade padrão. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice baseado em zero no qual inserir o conector. |
| shapeType | int | O [ShapeType](../../com.aspose.slides/shapetype) do conector a ser inserido. |
| x | float | A coordenada x da moldura do conector, em pontos. |
| y | float | A coordenada y da moldura do conector, em pontos. |
| width | float | A largura da moldura do conector, em pontos. |
| height | float | A altura da moldura do conector, em pontos. |
...
| image | [IPPImage](../../com.aspose.slides/ippimage) | O [IPPImage](../../com.aspose.slides/ippimage) a ser exibido na moldura da imagem. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice baseado em zero no qual inserir a moldura da imagem. |
| shapeType | int | Especifica o tipo de forma contido em [ShapeType](../../com.aspose.slides/shapetype), exceto para todos os tipos de linhas:  
...
> ```
> O exemplo a seguir mostra como adicionar uma tabela em uma apresentação PowerPoint.
>  
>  // Instancia a classe Presentation que representa um arquivo PPTX
>  Presentation pres = new Presentation();
>  try
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice base zero no qual inserir a tabela. |
| x | float | A coordenada x da tabela, em pontos. |
| y | float | A coordenada y da tabela, em pontos. |
| columnWidths | double[] | Um array de double[] que representa as larguras das colunas da tabela, em pontos. |
| rowHeights | double[] | Um array de double[] que representa as alturas das linhas da tabela, em pontos. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice base zero da forma a ser removida. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | O [IShape](../../com.aspose.slides/ishape) a ser removido. |
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IShape> - Um java.util.Iterator para a coleção inteira.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice base zero no qual inserir a forma clonada. |
| sourceShape | [IShape](../../com.aspose.slides/ishape) | O [IShape](../../com.aspose.slides/ishape) a ser clonada. |
