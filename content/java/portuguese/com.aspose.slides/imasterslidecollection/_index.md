...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| ignorePreserveField | boolean | Determina se este método deve remover mestres não utilizados mesmo que sua propriedade [IMasterSlide.getPreserve](../../com.aspose.slides/imasterslide\#getPreserve)/[IMasterSlide.setPreserve(boolean)](../../com.aspose.slides/imasterslide\#setPreserve-boolean-) esteja definida como true. |
