...
| Método | Descrição |
| --- | --- |
| [getSvgData()](#getSvgData--) | Retorna dados SVG. |
| [getExternalResourceResolver()](#getExternalResourceResolver--) | Retorna interface de callback usada para resolver recursos externos durante a importação de documentos Svg. |
...
| baseUri | java.lang.String | URI base do Svg especificado. Usado para resolver links relativos. |
...
Retorna interface de callback usada para resolver recursos externos durante a importação de documentos Svg. Somente leitura [IExternalResourceResolver](../../com.aspose.slides/iexternalresourceresolver).
