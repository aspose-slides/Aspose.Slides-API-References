...
| Método | Descrição |
| --- | --- |
| [getTraces()](#getTraces--) | Obtém todos os rastros contidos no elemento IInk [IInkTrace](../../com.aspose.slides/iinktrace). |
### getTraces() {#getTraces--}
```
public abstract IInkTrace[] getTraces()
```

Obtém todos os rastros contidos no elemento IInk [IInkTrace](../../com.aspose.slides/iinktrace). Somente leitura.
