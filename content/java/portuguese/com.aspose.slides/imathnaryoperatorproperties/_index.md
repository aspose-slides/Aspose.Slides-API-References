...
| Método | Descrição |
| --- | --- |
| [getOperator()](#getOperator--) | Caractere do Operador Nário Por exemplo: '\\u2211', '\\u222b' |
| [setOperator(char value)](#setOperator-char-) | Caractere do Operador Nário Por exemplo: '\\u2211', '\\u222b' |
...
| [getGrowToMatchOperandHeight()](#getGrowToMatchOperandHeight--) | O caractere do operador cresce verticalmente para corresponder à altura de seu operando |
| [setGrowToMatchOperandHeight(boolean value)](#setGrowToMatchOperandHeight-boolean-) | O caractere do operador cresce verticalmente para corresponder à altura de seu operando |
...
Caractere do Operador Nário Por exemplo: '\\u2211', '\\u222b'
