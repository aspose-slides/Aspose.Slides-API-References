...
| [getValueType()](#getValueType--) | Representa possíveis formas de determinar o comprimento das barras de erro. |
| [setValueType(int value)](#setValueType-int-) | Representa possíveis formas de determinar o comprimento das barras de erro. |
...
Representa possíveis formas de determinar o comprimento das barras de erro. No caso de tipo de valor personalizado, para especificar o valor use a propriedade ([IChartDataPoint.getErrorBarsCustomValues](../../com.aspose.slides/ichartdatapoint\#getErrorBarsCustomValues)) do ponto de dados específico na coleção DataPoints da série. No caso de tipo de valor Fixed, Percentage ou StandardDeviation, use a propriedade Value para especificar o valor. Leitura/gravação [ErrorBarValueType](../../com.aspose.slides/errorbarvaluetype).
...
Obtém ou define o valor que é usado com os tipos de valor Fixed, Percentage e StandardDeviation para determinar o comprimento das barras de erro. Em qualquer outro caso retornará NaN. Leitura/gravação float.
