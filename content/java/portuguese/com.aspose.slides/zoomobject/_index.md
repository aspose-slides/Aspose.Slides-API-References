...
O valor true da propriedade indica comportamento de navegação de retorno ao pai na apresentação de slides.
...
> ```
> o exemplo demonstra a mudança de uma imagem de um objeto Zoom:
>  
>  Presentation pres = new Presentation("pres.pptx");
>  try {
>      IZoomFrame zoomFrame = pres.getSlides().get_Item(0).getShapes().addZoomFrame(150, 20, 50, 50, pres.getSlides().get_Item(1));
