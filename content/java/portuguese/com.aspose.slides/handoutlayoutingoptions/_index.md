...
description: Representa o modo de layout de distribuição da apresentação para exportação.
type: docs
...
Representa o modo de layout de distribuição da apresentação para exportação.
## Construtores
...
| [getPrintFrameSlide()](#getPrintFrameSlide--) | Especifica se deve ou não desenhar quadros ao redor dos slides exibidos. |
| [setPrintFrameSlide(boolean value)](#setPrintFrameSlide-boolean-) | Especifica se deve ou não desenhar quadros ao redor dos slides exibidos. |
...
Especifica se deve ou não desenhar quadros ao redor dos slides exibidos.
