...
Retorna a cópia de uma imagem. Somente leitura [IImage](../../com.aspose.slides/iimage).
...
Substitui os dados da imagem. Atenção: quando a Image é metafile - ela será rasterizada. Use ReplaceImage(byte[]) em vez disso
