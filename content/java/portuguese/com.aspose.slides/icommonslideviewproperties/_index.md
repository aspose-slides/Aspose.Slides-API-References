...
Especifica a proporção de escala da visualização em porcentagens. Read/write int.
...
Especifica que o conteúdo da visualização deve ser dimensionado automaticamente para se ajustar ao tamanho da janela atual. Read/write boolean.
...
Retorna a coleção de guias de desenho. Read-only [IDrawingGuidesCollection](../../com.aspose.slides/idrawingguidescollection)
