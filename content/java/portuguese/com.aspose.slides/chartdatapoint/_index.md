...
| [isBubble3D()](#isBubble3D--) | Especifica que as bolhas têm um efeito 3-D aplicado a elas. |
| [setBubble3D(boolean value)](#setBubble3D-boolean-) | Especifica que as bolhas têm um efeito 3-D aplicado a elas. |
| [getExplosion()](#getExplosion--) | Especifica a quantidade que o ponto de dados deve ser movido a partir do centro da pizza. |
| [setExplosion(int value)](#setExplosion-int-) | Especifica a quantidade que o ponto de dados deve ser movido a partir do centro da pizza. |
...
| [getDataPointLevels()](#getDataPointLevels--) | Retorna o contêiner dos níveis de ponto de dados. |
| [getIndex()](#getIndex--) |  |
...
Especifica que as bolhas têm um efeito 3-D aplicado a elas. Booleano leitura/gravação.
...
Especifica a quantidade que o ponto de dados deve ser movido a partir do centro da pizza. int leitura/gravação.
...
Representa as propriedades de formatação. [IFormat](../../com.aspose.slides/iformat) leitura/gravação.
...
Define o ponto de dados como total. Aplicado somente para o tipo de série Waterfall.
...
Retorna o contêiner dos níveis de ponto de dados. Aplicado para séries Treeamp e Sunburst. A indexação dos níveis de ponto de dados começa em zero.
...
Retorna uma cor automática do ponto de dados baseada no índice da série, índice do ponto de dados, propriedade ParentSeriesGroup.IsColorVaried e estilo do gráfico. Esta cor é usada por padrão se FillType for NotDefined.
...
Especifica que o ponto de dados deve inverter suas cores se o valor for negativo. Booleano leitura/gravação.
...
Especifica a localização x real (esquerda) do elemento do gráfico em relação ao canto superior esquerdo do gráfico. Chame o método IChart.ValidateChartLayout() antes para obter valores reais. float leitura.
...
Especifica a parte superior real do elemento do gráfico em relação ao canto superior esquerdo do gráfico. Chame o método IChart.ValidateChartLayout() antes para obter valores reais. float leitura.
...
Especifica a largura real do elemento do gráfico. Chame o método IChart.ValidateChartLayout() antes para obter valores reais. float leitura.
...
Especifica a altura real do elemento do gráfico. Chame o método IChart.ValidateChartLayout() antes para obter valores reais. float leitura.
