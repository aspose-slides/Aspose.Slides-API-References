...
description: Esta classe representa o token usado para sinalizar tarefas de longa duração se a interrupção foi solicitada.
type: docs
...
Esta classe representa o token usado para sinalizar tarefas de longa duração se a interrupção foi solicitada.
