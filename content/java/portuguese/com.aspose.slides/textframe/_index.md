...
| [getParagraphs()](#getParagraphs--) | Retorna a lista de todos os parágrafos em um frame. |
...
| [getHyperlinkQueries()](#getHyperlinkQueries--) | Fornece acesso fácil a hiperlinks contidos. |
...
| [highlightText(String text, Color highlightColor)](#highlightText-java.lang.String-java.awt.Color-) | Realça todas as correspondências do texto de exemplo com a cor especificada. |
| [highlightText(String text, Color highlightColor, ITextHighlightingOptions options)](#highlightText-java.lang.String-java.awt.Color-com.aspose.slides.ITextHighlightingOptions-) | Realça todas as correspondências do texto de exemplo com a cor especificada. |
| [splitTextByColumns()](#splitTextByColumns--) | Divide o conteúdo de texto do [ITextFrame](../../com.aspose.slides/itextframe) em um array de strings, onde cada elemento corresponde a uma coluna de texto separada dentro do frame. |
| [highlightText(String text, Color highlightColor, ITextSearchOptions options, IFindResultCallback callback)](#highlightText-java.lang.String-java.awt.Color-com.aspose.slides.ITextSearchOptions-com.aspose.slides.IFindResultCallback-) | Realça todas as correspondências do texto de exemplo com a cor especificada. |
| [highlightRegex(String regex, Color highlightColor, ITextHighlightingOptions options)](#highlightRegex-java.lang.String-java.awt.Color-com.aspose.slides.ITextHighlightingOptions-) | Realça todas as correspondências da expressão regular com a cor especificada. |
...
| [replaceRegex(Pattern regex, String newText, IFindResultCallback callback)](#replaceRegex-java.util.regex.Pattern-java.lang.String-com.aspose.slides.IFindResultCallback-) | Substitui todas as correspondências da expressão regular por uma string especificada. |
...
Retorna a lista de todos os parágrafos em um frame. Somente leitura [IParagraphCollection](../../com.aspose.slides/iparagraphcollection).
...
Fornece acesso fácil a hiperlinks contidos. Somente leitura [IHyperlinkQueries](../../com.aspose.slides/ihyperlinkqueries).
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| text | java.lang.String | Amostra de texto a ser realçada. |
...
Divide o conteúdo de texto do [ITextFrame](../../com.aspose.slides/itextframe) em um array de strings, onde cada elemento corresponde a uma coluna de texto separada dentro do frame.
...
>  try {
>      // Obtém a primeira forma no slide e a converte para ITextFrame
>      ITextFrame textFrame = (ITextFrame) pres.getSlides().get_Item(0).getShapes().get_Item(0);
>      // Divide o conteúdo do frame de texto em colunas
...
Se o frame de texto não contiver múltiplas colunas, o array retornado terá um único elemento contendo o texto completo. Colunas vazias serão representadas como strings vazias no array.
...
Substitui todas as correspondências da expressão regular por uma string especificada.
...
>  try {
>      Pattern regex = Pattern.compile("\\b[^\\s]{5,}\\b");
>      // Substitui todas as palavras com 5 símbolos ou mais por '***'
...
> 
>      // Essas asserções são sempre verdadeiras
