...
description: A classe controladora de formatação a ser usada para incorporar todas as fontes da apresentação no formato WOFF.
type: docs
...
| [EmbedAllFontsHtmlController(String[] fontNameExcludeList)](#EmbedAllFontsHtmlController-java.lang.String---) | Cria nova instância |
## Métodos
...
| [writeAllFonts(IHtmlGenerator generator, IPresentation presentation)](#writeAllFonts-com.aspose.slides.IHtmlGenerator-com.aspose.slides.IPresentation-) | Escreve todas as fontes contidas em [Presentation](../../com.aspose.slides/presentation). |
| [writeFont(IHtmlGenerator generator, IFontData originalFont, IFontData substitutedFont, String fontStyle, String fontWeight, byte[] fontData)](#writeFont-com.aspose.slides.IHtmlGenerator-com.aspose.slides.IFontData-com.aspose.slides.IFontData-java.lang.String-java.lang.String-byte---) | Escreve dados como base64 dentro do próprio documento HTML |
...
Escreve todas as fontes contidas em [Presentation](../../com.aspose.slides/presentation).
...
Escreve dados como base64 dentro do próprio documento HTML
...
| fontWeight | java.lang.String | Peso da fonte |
