...
type: docs
url: /pt/com.aspose.slides/fontsubstrulecollection/
---
**Inheritance:**
java.lang.Object
...
| [add(IFontSubstRule value)](#add-com.aspose.slides.IFontSubstRule-) | Adiciona a nova regra de substituição de fontes à coleção |
| [remove(IFontSubstRule value)](#remove-com.aspose.slides.IFontSubstRule-) | Remove a primeira ocorrência de um objeto específico da coleção. |
...
Adiciona a nova regra de substituição de fontes à coleção
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| value | [IFontSubstRule](../../com.aspose.slides/ifontsubstrule) | A regra de substituição de fontes a ser removida da coleção. |
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IFontSubstRule> - Um IGenericEnumerator que pode ser usado para iterar sobre a coleção.
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.IFontSubstRule> - Um java.util.Iterator para a coleção inteira.
