...
| Método | Descrição |
| --- | --- |
| [autoByExtension(String presPath, String outPath)](#autoByExtension-java.lang.String-java.lang.String-) | Converte [Presentation](../../com.aspose.slides/presentation) usando a extensão de caminho de saída fornecida para determinar o formato de exportação necessário. |
...
| [toJpeg(Presentation pres, String outputFileName)](#toJpeg-com.aspose.slides.Presentation-java.lang.String-) | Converte a apresentação de entrada para um conjunto de imagens no formato JPEG. |
| [toJpeg(Presentation pres, String outputFileName, Dimension imageSize)](#toJpeg-com.aspose.slides.Presentation-java.lang.String-java.awt.Dimension-) | Converte a apresentação de entrada para um conjunto de imagens no formato JPEG. |
| [toJpeg(Presentation pres, String outputFileName, float scale, IRenderingOptions options)](#toJpeg-com.aspose.slides.Presentation-java.lang.String-float-com.aspose.slides.IRenderingOptions-) | Converte a apresentação de entrada para um conjunto de imagens no formato JPEG. |
| [toPng(Presentation pres, String outputFileName)](#toPng-com.aspose.slides.Presentation-java.lang.String-) | Converte a apresentação de entrada para um conjunto de imagens no formato PNG. |
| [toPng(Presentation pres, String outputFileName, Dimension imageSize)](#toPng-com.aspose.slides.Presentation-java.lang.String-java.awt.Dimension-) | Converte a apresentação de entrada para um conjunto de imagens no formato PNG. |
| [toPng(Presentation pres, String outputFileName, float scale, IRenderingOptions options)](#toPng-com.aspose.slides.Presentation-java.lang.String-float-com.aspose.slides.IRenderingOptions-) | Converte a apresentação de entrada para um conjunto de imagens no formato PNG. |
| [toTiff(Presentation pres, String outputFileName)](#toTiff-com.aspose.slides.Presentation-java.lang.String-) | Converte a apresentação de entrada para um conjunto de imagens no formato TIFF. |
...
Converte [Presentation](../../com.aspose.slides/presentation) usando a extensão de caminho de saída fornecida para determinar o formato de exportação necessário.
...
| --- | --- | --- |
| presPath | java.lang.String | Caminho da apresentação de entrada |
| getOutPath | [GetOutPathCallback](../../com.aspose.slides/getoutpathcallback) | Callback que devolve o caminho de saída SVG para cada slide da apresentação |
...
Converte a apresentação de entrada para um conjunto de imagens no formato JPEG. Se o nome do ficheiro de saída for fornecido como "myPath/myFilename.jpeg", o resultado será guardado como um conjunto de ficheiros "myPath/myFilename_N.jpeg", onde N é o número do slide.
...
| outputFileName | java.lang.String | O nome do ficheiro de saída. |
...
| pres | [Presentation](../../com.aspose.slides/presentation) | A apresentação de entrada |
| outputFileName | java.lang.String | O nome do ficheiro de saída. |
| imageSize | java.awt.Dimension | O tamanho de cada imagem gerada. |
...
Converte a apresentação de entrada para um conjunto de imagens no formato PNG. Se o nome do ficheiro de saída for fornecido como "myPath/myFilename.png", o resultado será guardado como um conjunto de ficheiros "myPath/myFilename_N.png", onde N é o número do slide.
...
Converte a apresentação de entrada para um conjunto de imagens no formato TIFF. Se o nome do ficheiro de saída for fornecido como "myPath/myFilename.tiff", o resultado será guardado como um conjunto de ficheiros "myPath/myFilename_N.tiff", onde N é o número do slide.
...
Converte a apresentação de entrada para o formato TIFF com opções personalizadas. Se o nome do ficheiro de saída for fornecido como "myPath/myFilename.tiff" e multipage for false, o resultado será guardado como um conjunto de ficheiros "myPath/myFilename_N.tiff", onde N é o número do slide. Caso contrário, se multipage for true, o resultado será um documento TIFF de várias páginas "myPath/myFilename.tiff".
...
| pres | [Presentation](../../com.aspose.slides/presentation) | A apresentação de entrada. |
| outputFileName | java.lang.String | O nome do ficheiro de saída. |
| options | [ITiffOptions](../../com.aspose.slides/itiffoptions) | As opções de gravação TIFF. |
| multipage | boolean | Especifica se o documento TIFF gerado deve ser multi-página. |