...
description: Especifica o objeto Matrix composto por elementos filhos organizados em uma ou mais linhas e colunas.
type: docs
...
| [getHidePlaceholders()](#getHidePlaceholders--) | Ocultar os placeholders para elementos vazios da matriz Padrão: false |
| [setHidePlaceholders(boolean value)](#setHidePlaceholders-boolean-) | Ocultar os placeholders para elementos vazios da matriz Padrão: false |
| [getBaseJustification()](#getBaseJustification--) | Especifica a justificação vertical em relação ao texto circundante. |
| [setBaseJustification(int value)](#setBaseJustification-int-) | Especifica a justificação vertical em relação ao texto circundante. |
| [getMinColumnWidth()](#getMinColumnWidth--) | Largura mínima da coluna em twips (1/20 de ponto). O espaçamento da lacuna (também referido como \u201cColumn Gap\u201d ou \u201cGap Width\u201d) é adicionado ao MinColumnWidth para determinar o espaçamento total entre colunas da matriz (distância entre as mesmas bordas de colunas diferentes). |
| [setMinColumnWidth(long value)](#setMinColumnWidth-long-) | Largura mínima da coluna em twips (1/20 de ponto). O espaçamento da lacuna (também referido como \u201cColumn Gap\u201d ou \u201cGap Width\u201d) é adicionado ao MinColumnWidth para determinar o espaçamento total entre colunas da matriz (distância entre as mesmas bordas de colunas diferentes). |
...
| [insertRowBefore(int rowIndex)](#insertRowBefore-int-) | Insere uma nova linha antes da especificada. Inicialmente todos os elementos na nova linha são nulos. |
| [insertRowAfter(int rowIndex)](#insertRowAfter-int-) | Insere uma nova linha depois da especificada. Inicialmente todos os elementos na nova linha são nulos. |
| [deleteRow(int rowIndex)](#deleteRow-int-) | Exclui a linha especificada |
| [insertColumnBefore(int columnIndex)](#insertColumnBefore-int-) | Insere uma nova coluna antes da especificada. Inicialmente todos os elementos na nova coluna são nulos. |
| [insertColumnAfter(int columnIndex)](#insertColumnAfter-int-) | Insere uma nova coluna depois da especificada. Inicialmente todos os elementos na nova coluna são nulos. |
...
Ocultar os placeholders para elementos vazios da matriz Padrão: false
...
Largura mínima da coluna em twips (1/20 de ponto). O espaçamento da lacuna (também referido como \u201cColumn Gap\u201d ou \u201cGap Width\u201d) é adicionado ao MinColumnWidth para determinar o espaçamento total entre colunas da matriz (distância entre as mesmas bordas de colunas diferentes). Padrão: 0.
...
Insere uma nova linha depois da especificada. Inicialmente todos os elementos na nova linha são nulos.
...
Insere uma nova coluna depois da especificada. Inicialmente todos os elementos na nova coluna são nulos.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| columnIndex | int | O índice baseado em zero da coluna a ser excluída. |