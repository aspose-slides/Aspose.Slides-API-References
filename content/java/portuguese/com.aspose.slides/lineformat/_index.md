...
| [getEffective()](#getEffective--) | Obtém os dados de formatação efetiva da linha com a herança aplicada. |
### getVersion() {#getVersion--}
```
...
Retorna o formato de esboço de uma linha. Somente leitura [ILineFillFormat](../../com.aspose.slides/ilinefillformat).
...
Obtém os dados de formatação efetiva da linha com a herança aplicada.

--------------------

> ```
> Este exemplo demonstra como obter as propriedades efetivas do formato de linha da forma.
>  
