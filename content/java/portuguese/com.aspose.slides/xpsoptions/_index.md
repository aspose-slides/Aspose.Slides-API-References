...
| [getSaveMetafilesAsPng()](#getSaveMetafilesAsPng--) | True para converter todos os metafiles usados em uma apresentação em imagens PNG. |
| [setSaveMetafilesAsPng(boolean value)](#setSaveMetafilesAsPng-boolean-) | True para converter todos os metafiles usados em uma apresentação em imagens PNG. |
