...
| Método | Descrição |
| --- | --- |
| [isFormatNotDefined()](#isFormatNotDefined--) | Retorna true se o formato de linha não estiver definido (como recém-criado, padrão). |
...
| [getJoinStyle()](#getJoinStyle--) | Retorna ou define o estilo de união das linhas. |
| [setJoinStyle(byte value)](#setJoinStyle-byte-) | Retorna ou define o estilo de união das linhas. |
...
| [getBeginArrowheadStyle()](#getBeginArrowheadStyle--) | Retorna ou define o estilo da ponta da seta no início da linha. |
| [setBeginArrowheadStyle(byte value)](#setBeginArrowheadStyle-byte-) | Retorna ou define o estilo da ponta da seta no início da linha. |
| [getEndArrowheadStyle()](#getEndArrowheadStyle--) | Retorna ou define o estilo da ponta da seta no final da linha. |
| [setEndArrowheadStyle(byte value)](#setEndArrowheadStyle-byte-) | Retorna ou define o estilo da ponta da seta no final da linha. |
| [getBeginArrowheadWidth()](#getBeginArrowheadWidth--) | Retorna ou define a largura da ponta da seta no início da linha. |
| [setBeginArrowheadWidth(byte value)](#setBeginArrowheadWidth-byte-) | Retorna ou define a largura da ponta da seta no início da linha. |
| [getEndArrowheadWidth()](#getEndArrowheadWidth--) | Retorna ou define a largura da ponta da seta no final da linha. |
| [setEndArrowheadWidth(byte value)](#setEndArrowheadWidth-byte-) | Retorna ou define a largura da ponta da seta no final da linha. |
| [getBeginArrowheadLength()](#getBeginArrowheadLength--) | Retorna ou define o comprimento da ponta da seta no início da linha. |
| [setBeginArrowheadLength(byte value)](#setBeginArrowheadLength-byte-) | Retorna ou define o comprimento da ponta da seta no início da linha. |
| [getEndArrowheadLength()](#getEndArrowheadLength--) | Retorna ou define o comprimento da ponta da seta no final da linha. |
| [setEndArrowheadLength(byte value)](#setEndArrowheadLength-byte-) | Retorna ou define o comprimento da ponta da seta no final da linha. |
| [equals(ILineFormat lineFormat)](#equals-com.aspose.slides.ILineFormat-) | Determina se as duas instâncias de LineFormat são iguais. |
| [getEffective()](#getEffective--) | Obtém os dados efetivos de formatação de linha com a herança aplicada. |
...
Retorna true se o formato de linha não estiver definido (como recém-criado, padrão). Somente leitura boolean.
...
Retorna ou define o estilo da extremidade da linha. Leitura/gravação [LineCapStyle](../../com.aspose.slides/linecapstyle).
...
Retorna ou define o estilo de união das linhas. Leitura/gravação [LineJoinStyle](../../com.aspose.slides/linejoinstyle).
...
Retorna ou define o limite de mitra de uma linha. Leitura/gravação float.
...
Retorna ou define o estilo da ponta da seta no início da linha. Leitura/gravação [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
Retorna ou define o estilo da ponta da seta no final da linha. Leitura/gravação [LineArrowheadStyle](../../com.aspose.slides/linearrowheadstyle).
...
Retorna ou define a largura da ponta da seta no início da linha. Leitura/gravação [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
Retorna ou define a largura da ponta da seta no final da linha. Leitura/gravação [LineArrowheadWidth](../../com.aspose.slides/linearrowheadwidth).
...
Retorna ou define o comprimento da ponta da seta no início da linha. Leitura/gravação [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
Retorna ou define o comprimento da ponta da seta no final da linha. Leitura/gravação [LineArrowheadLength](../../com.aspose.slides/linearrowheadlength).
...
Obtém os dados efetivos de formatação de linha com a herança aplicada.
