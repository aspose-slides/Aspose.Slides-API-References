...
type: docs
url: /pt/com.aspose.slides/igroupshapelock/
---
...
Determina se a adição desta forma a um grupo é proibida.
## Métodos
...
| [getUngroupingLocked()](#getUngroupingLocked--) | Determina se a divisão desta forma de grupo é proibida. |
| [setUngroupingLocked(boolean value)](#setUngroupingLocked-boolean-) | Determina se a divisão desta forma de grupo é proibida. |
...
| [getRotationLocked()](#getRotationLocked--) | Determina se a alteração do ângulo de rotação desta forma é proibida. |
| [setRotationLocked(boolean value)](#setRotationLocked-boolean-) | Determina se a alteração do ângulo de rotação desta forma é proibida. |
...
Determina se a divisão desta forma de grupo é proibida. Leitura/gravação boolean.
