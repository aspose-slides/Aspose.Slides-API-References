...
| [getLeaderLinesFormat()](#getLeaderLinesFormat--) | Representa o formato das linhas de líderes dos rótulos de dados. |
...
| [hide()](#hide--) | Torne o rótulo de dados oculto por padrão definindo todas as flags Show* (ShowValue, ...) da propriedade DefaultDataLabelFormat para o estado falso. |
...
Outra forma de acessar o rótulo de dados é: - getSeries().getDataPoints().get_Item(i).getLabel() - gerenciar propriedades do rótulo.
...
Representa o formato das linhas de líderes dos rótulos de dados. Somente leitura [IChartLinesFormat](../../com.aspose.slides/ichartlinesformat).
...
Torne o rótulo de dados oculto por padrão definindo todas as flags Show* (ShowValue, ...) da propriedade DefaultDataLabelFormat para o estado falso. IsVisible será false após isso.
...
**Retorno:**
int - Índice de um DataLabel ou -1 se o DataLabel não pertencer a esta coleção.