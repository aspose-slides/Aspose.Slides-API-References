...
second_title: Referência de API do Aspose.Slides para Java
...
| Método | Descrição |
| --- | --- |
| [formatText(ISvgTSpan svgTSpan, IPortion portion, ITextFrame textFrame)](#formatText-com.aspose.slides.ISvgTSpan-com.aspose.slides.IPortion-com.aspose.slides.ITextFrame-) | Esta função é chamada antes da renderização da porção de texto para SVG para permitir que o usuário controle o SVG resultante. |
