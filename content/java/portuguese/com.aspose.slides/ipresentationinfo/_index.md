...
| [isWriteProtected()](#isWriteProtected--) | Obtém um valor que indica se a apresentação vinculada está protegida contra escrita. |
...
| [checkWriteProtection(String password)](#checkWriteProtection-java.lang.String-) | Verifica se a senha de modificação está correta para uma apresentação protegida contra escrita. |
...
| [writeBindedPresentation(OutputStream stream)](#writeBindedPresentation-java.io.OutputStream-) | Escreve a apresentação vinculada para o fluxo. |
| [writeBindedPresentation(String file)](#writeBindedPresentation-java.lang.String-) | Escreve a apresentação vinculada para o arquivo. |
...
Obtém um valor que indica se a apresentação vinculada está protegida contra escrita.
...
> ```
---
Se a apresentação estiver protegida por uma senha para abrir, o valor da propriedade será igual a NotDefined. Veja a enumeração [NullableBool](../../com.aspose.slides/nullablebool).
...
Verifica se a senha de modificação está correta para uma apresentação protegida contra escrita.
...
**Retorna:**
boolean - True se a apresentação estiver protegida contra escrita e a senha estiver correta. False caso contrário.
...
Escreve a apresentação vinculada para o fluxo.
...
Escreve a apresentação vinculada para o arquivo.
