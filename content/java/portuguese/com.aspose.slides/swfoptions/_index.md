...
Fornece opções que controlam como uma apresentação é salva em formato Swf.
...
| [getShowPageStepper()](#getShowPageStepper--) | Mostrar/ocultar paginador de página. |
| [setShowPageStepper(boolean value)](#setShowPageStepper-boolean-) | Mostrar/ocultar paginador de página. |
...
Especifica se o documento gerado deve incluir slides ocultos ou não. Padrão é false.
...
Especifica se o documento SWF gerado deve ser compactado ou não. Padrão é true.
...
Especifica se o documento SWF gerado deve incluir o visualizador de documentos integrado ou não. Padrão é true.
...
Especifica se a borda ao redor das páginas deve ser mostrada. Padrão é true.
...
Mostrar/ocultar botão de tela cheia. Pode ser sobrescrito em flashvars. Padrão é true.
...
Mostrar/ocultar paginador de página. Pode ser sobrescrito em flashvars. Padrão é true.
...
Mostrar/ocultar seção de pesquisa. Pode ser sobrescrito em flashvars. Padrão é true.
...
Mostrar/ocultar todo o painel superior. Pode ser sobrescrito em flashvars. Padrão é true.
...
Mostrar/ocultar painel inferior. Pode ser sobrescrito em flashvars. Padrão é true.
...
Mostrar/ocultar painel esquerdo. Pode ser sobrescrito em flashvars. Padrão é true.
...
Iniciar com painel esquerdo aberto. Pode ser sobrescrito em flashvars. Padrão é false.
...
Habilitar/desabilitar menu de contexto. Padrão é true.
...
Obtém ou define o endereço de hiperlink completo para um logotipo. Tem efeito somente se um (\#getLogoImageBytes.getLogoImageBytes/\#setLogoImageBytes(byte[]).setLogoImageBytes(byte[])) for especificado.
...
Especifica a qualidade das imagens JPEG. Padrão é 95.
...
Obtém ou define o modo em que os slides são posicionados na página ao exportar uma apresentação [ISlidesLayoutOptions](../../com.aspose.slides/islideslayoutoptions). Esta propriedade não suporta a atribuição de objetos do tipo [HandoutLayoutingOptions](../../com.aspose.slides/handoutlayoutingoptions)
