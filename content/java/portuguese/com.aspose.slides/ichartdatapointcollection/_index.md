...
description: Representa a coleção de um ponto de dados de uma série.
type: docs
...
Representa uma coleção de um ponto de dados de série.
## Métodos
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável para séries cujo chartType é um dos subtipos Stock (veja também o método ChartTypeCharacterizer.IsChartTypeStock(ChartType)).
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável para séries cujo chartType é um dos subtipos Scatter (veja também o método ChartTypeCharacterizer.IsChartTypeScatter(ChartType)).
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chartType é um dos subtipos Scatter (consulte também o método ChartTypeCharacterizer.IsChartTypeScatter(ChartType)).
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chartType é um dos subtipos Radar (consulte também o método ChartTypeCharacterizer.IsChartTypeRadar(ChartType)).
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chartType é um dos subtipos Column ou Bar (consulte também os métodos ChartTypeCharacterizer.IsChartTypeColumn(ChartType) e ChartTypeCharacterizer.IsChartTypeBar(ChartType)).
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chartType é um dos subtipos Area (consulte também o método ChartTypeCharacterizer.IsChartTypeArea(ChartType)).
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chartType é um dos subtipos Pie (consulte também o método ChartTypeCharacterizer.IsChartTypePie(ChartType)).
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chartType é um dos subtipos Doughnut (consulte também o método ChartTypeCharacterizer.IsChartTypeDoughnut(ChartType)).
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chartType é um dos subtipos Bubble (consulte também o método ChartTypeCharacterizer.IsChartTypeBubble(ChartType)).
...
```
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chartType seja um dos subtipos Bubble (veja também o método ChartTypeCharacterizer.IsChartTypeBubble(ChartType) method).
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chartType seja um dos subtipos Surface (veja também o método ChartTypeCharacterizer.IsChartTypeSurface(ChartType) method).
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chart type seja Sunburst.
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chart type seja Waterfall.
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chart type seja BoxAndWhisker.
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chart type seja Treemap.
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chart type seja Histogram.
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chart type seja Funnel.
...
Cria o novo ponto de dados e o adiciona ao final da coleção. Aplicável a séries cujo chart type seja Map.
