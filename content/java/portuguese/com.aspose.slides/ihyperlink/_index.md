...
| [getExternalUrl()](#getExternalUrl--) | Especifica a URL externa. Se esta propriedade passar a não ser nula, então a propriedade TargetSlide será nula. |
| [getExternalUrlOriginal()](#getExternalUrlOriginal--) | Representa um hyperlink definido para esta porção independentemente do conteúdo real da porção. |
| [getTargetSlide()](#getTargetSlide--) | Se o HyperlinkEx apontar para um slide específico, retorna esse slide. |
| [getTargetFrame()](#getTargetFrame--) | Retorna o quadro dentro do frameset HTML pai para o destino do hyperlink pai quando existir. |
| [setTargetFrame(String value)](#setTargetFrame-java.lang.String-) | Retorna o quadro dentro do frameset HTML pai para o destino do hyperlink pai quando existir. |
...
| [getSound()](#getSound--) | Representa o som reproduzido do hyperlink. |
| [setSound(IAudio value)](#setSound-com.aspose.slides.IAudio-) | Representa o som reproduzido do hyperlink. |
| [getColorSource()](#getColorSource--) | Representa a origem da cor do hyperlink – seja estilos ou formato da porção. |
| [setColorSource(int value)](#setColorSource-int-) | Representa a origem da cor do hyperlink – seja estilos ou formato da porção. |
...
Especifica a URL externa. Se esta propriedade passar a não ser nula, então a propriedade TargetSlide será nula. **Somente leitura** String.
...
Representa um hyperlink definido para esta porção independentemente do conteúdo real da porção.
...
Se o HyperlinkEx apontar para um slide específico, retorna esse slide. Se a propriedade passar a não ser nula, então a propriedade ExternalUrl será nula. **Somente leitura** [ISlide](../../com.aspose.slides/islide).
...
Retorna o quadro dentro do frameset HTML pai para o destino do hyperlink pai quando existir. **Leitura/gravação** String.
...
Representa o som reproduzido do hyperlink. **Leitura/gravação** [IAudio](../../com.aspose.slides/iaudio).
...
Representa a origem da cor do hyperlink – seja estilos ou formato da porção. **Leitura/gravação** [HyperlinkColorSource](../../com.aspose.slides/hyperlinkcolorsource).
