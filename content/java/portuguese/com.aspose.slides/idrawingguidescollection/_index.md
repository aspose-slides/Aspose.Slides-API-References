...
description: Representa uma coleção de guias de desenho ajustáveis.
type: docs
...
| Método | Descrição |
| --- | --- |
| [get_Item(int index)](#get-Item-int-) | Retorna o guia de desenho pelo índice. |
...
Retorna o guia de desenho pelo índice. Somente leitura [IDrawingGuide](../../com.aspose.slides/idrawingguide).
