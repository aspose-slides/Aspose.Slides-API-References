...
| [getModules()](#getModules--) | Retorna a lista de todos os módulos contidos no projeto VBA. |
| [getReferences()](#getReferences--) | Retorna a lista de todas as referências contidas no projeto VBA. |
...
Retorna a lista de todos os módulos contidos no projeto VBA. Somente leitura [IVbaModuleCollection](../../com.aspose.slides/ivbamodulecollection).
...
Retorna a lista de todas as referências contidas no projeto VBA. Somente leitura [IVbaReferenceCollection](../../com.aspose.slides/ivbareferencecollection).
