...
description: Representa coleção de sequência de efeitos.
type: docs
...
| [removeByShape(IShape shape)](#removeByShape-com.aspose.slides.IShape-) | Remove o efeito para a forma especificada. |
...
| [addEffect(IChart chart, int type, int index, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-) | Adiciona o novo efeito de animação de gráfico para a categoria ou série ao final da sequência. |
| [addEffect(IChart chart, int type, int seriesIndex, int categoriesIndex, int effectType, int subtype, int triggerType)](#addEffect-com.aspose.slides.IChart-int-int-int-int-int-int-) | Adiciona o novo efeito de animação de gráfico para elementos na categoria ou série ao final da sequência. |
### getCount() {#getCount--}
```
...
Remove o efeito para a forma especificada.
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| shape | [IShape](../../com.aspose.slides/ishape) | Objeto de forma [IShape](../../com.aspose.slides/ishape) para adicionar um efeito |
| effectType | int | Tipo de efeito de animação [EffectType](../../com.aspose.slides/effecttype) |
...
Adiciona o novo efeito de animação de gráfico para a categoria ou série ao final da sequência.

**Parâmetros:**
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| chart | [IChart](../../com.aspose.slides/ichart) | Objeto Chart [IChart](../../com.aspose.slides/ichart) |
| type | int | Tipo de efeito de animação [EffectChartMinorGroupingType](../../com.aspose.slides/effectchartminorgroupingtype) |
...
| chart | [IChart](../../com.aspose.slides/ichart) | Objeto Chart [IChart](../../com.aspose.slides/ichart) |
| type | int | Tipo de efeito de animação [EffectChartMinorGroupingType](../../com.aspose.slides/effectchartminorgroupingtype) |
| seriesIndex | int | Índice da série de gráfico int |
