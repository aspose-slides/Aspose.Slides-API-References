...
| Método | Descrição |
| --- | --- |
| [getPictureFrameLock()](#getPictureFrameLock--) | Retorna os locks da shape. |
...
Retorna os locks da shape. Somente leitura [IPictureFrameLock](../../com.aspose.slides/ipictureframelock).
