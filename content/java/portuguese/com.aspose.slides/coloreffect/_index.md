...
type: docs
url: /pt/com.aspose.slides/coloreffect/
---
**Herança:**
...
| [getTo()](#getTo--) | Descreve a cor resultante para a alteração de cor da animação. |
| [setTo(IColorFormat value)](#setTo-com.aspose.slides.IColorFormat-) | Descreve a cor resultante para a alteração de cor da animação. |
...
| [getDirection()](#getDirection--) | Especifica a direção para percorrer a tonalidade ao redor da roda de cores. |
| [setDirection(int value)](#setDirection-int-) | Especifica a direção para percorrer a tonalidade ao redor da roda de cores. |
...
Descreve a cor resultante para a alteração de cor da animação. Leitura/Gravação [IColorFormat](../../com.aspose.slides/icolorformat).
...
Representa o espaço de cor do comportamento. Leitura/Gravação [ColorSpace](../../com.aspose.slides/colorspace).
...
Especifica a direção para percorrer a tonalidade ao redor da roda de cores. Leitura/Gravação [ColorDirection](../../com.aspose.slides/colordirection).
