...
description: Especifica o objeto Matrix constituído por elementos filhos dispostos em uma ou mais linhas e colunas.
type: docs
...
| [insertRowAfter(int rowIndex)](#insertRowAfter-int-) | Insere uma nova linha após a especificada. Inicialmente, todos os elementos na nova linha são nulos. |
...
| [insertColumnAfter(int columnIndex)](#insertColumnAfter-int-) | Insere uma nova coluna após a especificada. Inicialmente, todos os elementos na nova coluna são nulos. |
...
O valor do espaçamento horizontal entre colunas de uma matriz; Se ColumnGapRule for definido como 3 (\"Exactly\"), a unidade é interpretada como twips (1/20 de ponto). Se ColumnGapRule for definido como 4 (\"Multiple\"), a unidade é interpretada como número de incrementos de 0,5 em. Em outros casos, ignorado. Padrão: 0
...
O valor do espaçamento vertical entre linhas de uma matriz; Se RowGapRule for definido como 3 (\"Exactly\"), a unidade é interpretada como twips (1/20 de ponto). Se RowGapRule for definido como 4 (\"Multiple\"), a unidade é interpretada como meia linha. Padrão: 0
