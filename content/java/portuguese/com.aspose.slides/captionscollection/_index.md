...
| --- | --- | --- |
| label | java.lang.String | O rótulo das legendas fechadas. |
| stream | java.io.InputStream | O stream de entrada contendo dados no formato WebVTT. |
...
| Parâmetro | Tipo | Descrição |
| --- | --- | --- |
| index | int | O índice das legendas fechadas a ser removido. |
...
**Retorna:**
com.aspose.ms.System.Collections.Generic.IGenericEnumerator<com.aspose.slides.ICaptions> - Um System.Collections.Generic.IEnumerator1 que pode ser usado para iterar pela coleção.