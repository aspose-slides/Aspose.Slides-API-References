 ...
 **Returns:**
[GrayScale](../grayscale), [FillOverlay](../filloverlay), [AlphaModulateFixed](../alphamodulatefixed), [AlphaCeiling](../alphaceiling), [Tint](../tint), [ColorChange](../colorchange), [ImageTransformOperation](../imagetransformoperation), [Glow](../glow), [OuterShadow](../outershadow), [AlphaFloor](../alphafloor), [InnerShadow](../innershadow), [PresetShadow](../presetshadow), [Blur](../blur), [BiLevel](../bilevel), [SoftEdge](../softedge), [AlphaInverse](../alphainverse), [Duotone](../duotone), [HSL](../hsl), [ColorReplace](../colorreplace), [AlphaModulate](../alphamodulate), [Reflection](../reflection), [BrightnessContrast](../brightnesscontrast), [Luminance](../luminance), [AlphaBiLevel](../alphabilevel), [AlphaReplace](../alphareplace)
