 ...
 **Returns:**
[AlphaModulate](../alphamodulate), [FillOverlay](../filloverlay), [AlphaReplace](../alphareplace), [OuterShadow](../outershadow), [ColorReplace](../colorreplace), [Blur](../blur), [InnerShadow](../innershadow), [GrayScale](../grayscale), [AlphaBiLevel](../alphabilevel), [Duotone](../duotone), [ColorChange](../colorchange), [ImageTransformOperation](../imagetransformoperation), [SoftEdge](../softedge), [AlphaModulateFixed](../alphamodulatefixed), [AlphaInverse](../alphainverse), [Reflection](../reflection), [PresetShadow](../presetshadow), [AlphaFloor](../alphafloor), [AlphaCeiling](../alphaceiling), [BiLevel](../bilevel), [Glow](../glow), [Luminance](../luminance), [HSL](../hsl), [Tint](../tint)
