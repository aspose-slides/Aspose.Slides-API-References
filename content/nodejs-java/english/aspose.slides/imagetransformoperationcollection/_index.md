 ...
 **Returns:**
[HSL](../hsl), [AlphaFloor](../alphafloor), [Reflection](../reflection), [AlphaReplace](../alphareplace), [ColorChange](../colorchange), [Duotone](../duotone), [Luminance](../luminance), [PresetShadow](../presetshadow), [ColorReplace](../colorreplace), [AlphaModulateFixed](../alphamodulatefixed), [AlphaCeiling](../alphaceiling), [AlphaModulate](../alphamodulate), [FillOverlay](../filloverlay), [Glow](../glow), [Tint](../tint), [ImageTransformOperation](../imagetransformoperation), [OuterShadow](../outershadow), [InnerShadow](../innershadow), [Blur](../blur), [BiLevel](../bilevel), [GrayScale](../grayscale), [AlphaInverse](../alphainverse), [AlphaBiLevel](../alphabilevel), [SoftEdge](../softedge)
