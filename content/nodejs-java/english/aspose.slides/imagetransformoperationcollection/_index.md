 ...
 **Returns:**
[GrayScale](../grayscale), [Reflection](../reflection), [SoftEdge](../softedge), [HSL](../hsl), [AlphaBiLevel](../alphabilevel), [ColorChange](../colorchange), [FillOverlay](../filloverlay), [Luminance](../luminance), [InnerShadow](../innershadow), [AlphaFloor](../alphafloor), [Duotone](../duotone), [Tint](../tint), [ImageTransformOperation](../imagetransformoperation), [AlphaModulate](../alphamodulate), [AlphaInverse](../alphainverse), [AlphaModulateFixed](../alphamodulatefixed), [AlphaCeiling](../alphaceiling), [BiLevel](../bilevel), [Glow](../glow), [Blur](../blur), [AlphaReplace](../alphareplace), [OuterShadow](../outershadow), [PresetShadow](../presetshadow), [ColorReplace](../colorreplace)
