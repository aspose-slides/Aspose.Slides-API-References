 ...
 **Returns:**
[Blur](../blur), [PresetShadow](../presetshadow), [AlphaReplace](../alphareplace), [Tint](../tint), [AlphaInverse](../alphainverse), [AlphaBiLevel](../alphabilevel), [HSL](../hsl), [ColorChange](../colorchange), [AlphaModulateFixed](../alphamodulatefixed), [ImageTransformOperation](../imagetransformoperation), [OuterShadow](../outershadow), [Glow](../glow), [InnerShadow](../innershadow), [FillOverlay](../filloverlay), [Duotone](../duotone), [GrayScale](../grayscale), [AlphaFloor](../alphafloor), [Luminance](../luminance), [AlphaModulate](../alphamodulate), [Reflection](../reflection), [BiLevel](../bilevel), [ColorReplace](../colorreplace), [SoftEdge](../softedge), [AlphaCeiling](../alphaceiling)
