 ...
 **Returns:**
[AlphaReplace](../alphareplace), [Luminance](../luminance), [PresetShadow](../presetshadow), [ColorChange](../colorchange), [AlphaModulate](../alphamodulate), [HSL](../hsl), [AlphaFloor](../alphafloor), [InnerShadow](../innershadow), [Reflection](../reflection), [Blur](../blur), [AlphaCeiling](../alphaceiling), [AlphaModulateFixed](../alphamodulatefixed), [BiLevel](../bilevel), [ImageTransformOperation](../imagetransformoperation), [Duotone](../duotone), [Tint](../tint), [AlphaBiLevel](../alphabilevel), [AlphaInverse](../alphainverse), [GrayScale](../grayscale), [ColorReplace](../colorreplace), [FillOverlay](../filloverlay), [OuterShadow](../outershadow), [SoftEdge](../softedge), [Glow](../glow)
