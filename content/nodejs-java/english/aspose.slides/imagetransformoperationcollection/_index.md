 ...
 **Returns:**
[Duotone](../duotone), [Tint](../tint), [FillOverlay](../filloverlay), [Glow](../glow), [Blur](../blur), [PresetShadow](../presetshadow), [ColorReplace](../colorreplace), [ImageTransformOperation](../imagetransformoperation), [AlphaModulateFixed](../alphamodulatefixed), [GrayScale](../grayscale), [AlphaReplace](../alphareplace), [OuterShadow](../outershadow), [AlphaBiLevel](../alphabilevel), [BiLevel](../bilevel), [HSL](../hsl), [InnerShadow](../innershadow), [SoftEdge](../softedge), [AlphaFloor](../alphafloor), [Luminance](../luminance), [AlphaInverse](../alphainverse), [Reflection](../reflection), [AlphaCeiling](../alphaceiling), [AlphaModulate](../alphamodulate), [ColorChange](../colorchange)
