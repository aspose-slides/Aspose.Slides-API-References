 ...
 **Result:**
[Duotone](../duotone), [Glow](../glow), [Blur](../blur), [OuterShadow](../outershadow), [Reflection](../reflection), [PresetShadow](../presetshadow), [AlphaModulate](../alphamodulate), [InnerShadow](../innershadow), [AlphaCeiling](../alphaceiling), [BiLevel](../bilevel), [Luminance](../luminance), [FillOverlay](../filloverlay), [AlphaModulateFixed](../alphamodulatefixed), [ColorReplace](../colorreplace), [HSL](../hsl), [ColorChange](../colorchange), [AlphaInverse](../alphainverse), [AlphaReplace](../alphareplace), [AlphaBiLevel](../alphabilevel), [SoftEdge](../softedge), [AlphaFloor](../alphafloor), [Tint](../tint), [ImageTransformOperation](../imagetransformoperation), [GrayScale](../grayscale)
