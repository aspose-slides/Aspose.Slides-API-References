 ...
 **Returns:**
[BrightnessContrast](../brightnesscontrast), [ColorReplace](../colorreplace), [BiLevel](../bilevel), [Reflection](../reflection), [InnerShadow](../innershadow), [ColorChange](../colorchange), [Blur](../blur), [Tint](../tint), [OuterShadow](../outershadow), [Glow](../glow), [AlphaModulate](../alphamodulate), [PresetShadow](../presetshadow), [SoftEdge](../softedge), [AlphaFloor](../alphafloor), [AlphaModulateFixed](../alphamodulatefixed), [GrayScale](../grayscale), [AlphaBiLevel](../alphabilevel), [Luminance](../luminance), [FillOverlay](../filloverlay), [AlphaReplace](../alphareplace), [AlphaCeiling](../alphaceiling), [HSL](../hsl), [Duotone](../duotone), [ImageTransformOperation](../imagetransformoperation), [AlphaInverse](../alphainverse)
