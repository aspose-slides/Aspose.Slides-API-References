 ...
 **Returns:**
[FillOverlay](../filloverlay), [AlphaFloor](../alphafloor), [Glow](../glow), [Blur](../blur), [BiLevel](../bilevel), [AlphaModulateFixed](../alphamodulatefixed), [Luminance](../luminance), [AlphaBiLevel](../alphabilevel), [ColorReplace](../colorreplace), [InnerShadow](../innershadow), [OuterShadow](../outershadow), [AlphaInverse](../alphainverse), [GrayScale](../grayscale), [AlphaModulate](../alphamodulate), [Reflection](../reflection), [ColorChange](../colorchange), [HSL](../hsl), [ImageTransformOperation](../imagetransformoperation), [Tint](../tint), [AlphaReplace](../alphareplace), [SoftEdge](../softedge), [PresetShadow](../presetshadow), [AlphaCeiling](../alphaceiling), [Duotone](../duotone)
