 ...
 **Returns:**
[PresetShadow](../presetshadow), [SoftEdge](../softedge), [ImageTransformOperation](../imagetransformoperation), [Luminance](../luminance), [ColorChange](../colorchange), [AlphaInverse](../alphainverse), [Reflection](../reflection), [FillOverlay](../filloverlay), [HSL](../hsl), [AlphaBiLevel](../alphabilevel), [OuterShadow](../outershadow), [ColorReplace](../colorreplace), [AlphaCeiling](../alphaceiling), [AlphaFloor](../alphafloor), [AlphaModulate](../alphamodulate), [Tint](../tint), [Blur](../blur), [AlphaReplace](../alphareplace), [InnerShadow](../innershadow), [AlphaModulateFixed](../alphamodulatefixed), [Duotone](../duotone), [GrayScale](../grayscale), [Glow](../glow), [BiLevel](../bilevel)
