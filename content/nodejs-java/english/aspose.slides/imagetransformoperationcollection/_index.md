 ...
 **Returns:**
[ColorChange](../colorchange), [Glow](../glow), [Duotone](../duotone), [SoftEdge](../softedge), [Blur](../blur), [AlphaBiLevel](../alphabilevel), [AlphaModulateFixed](../alphamodulatefixed), [GrayScale](../grayscale), [ImageTransformOperation](../imagetransformoperation), [AlphaCeiling](../alphaceiling), [InnerShadow](../innershadow), [BrightnessContrast](../brightnesscontrast), [OuterShadow](../outershadow), [AlphaFloor](../alphafloor), [AlphaModulate](../alphamodulate), [BiLevel](../bilevel), [FillOverlay](../filloverlay), [AlphaReplace](../alphareplace), [Reflection](../reflection), [HSL](../hsl), [PresetShadow](../presetshadow), [ColorReplace](../colorreplace), [Luminance](../luminance), [Tint](../tint), [AlphaInverse](../alphainverse)
