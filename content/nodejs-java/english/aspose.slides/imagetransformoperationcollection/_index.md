 ...
 **Returns:**
[AlphaBiLevel](../alphabilevel), [Reflection](../reflection), [HSL](../hsl), [SoftEdge](../softedge), [Glow](../glow), [ColorChange](../colorchange), [AlphaCeiling](../alphaceiling), [Luminance](../luminance), [AlphaModulateFixed](../alphamodulatefixed), [ImageTransformOperation](../imagetransformoperation), [Blur](../blur), [AlphaReplace](../alphareplace), [BrightnessContrast](../brightnesscontrast), [FillOverlay](../filloverlay), [BiLevel](../bilevel), [AlphaModulate](../alphamodulate), [InnerShadow](../innershadow), [Tint](../tint), [PresetShadow](../presetshadow), [ColorReplace](../colorreplace), [AlphaFloor](../alphafloor), [OuterShadow](../outershadow), [Duotone](../duotone), [GrayScale](../grayscale), [AlphaInverse](../alphainverse)
