 ...
 **Returns:**
[BiLevel](../bilevel), [OuterShadow](../outershadow), [ColorReplace](../colorreplace), [HSL](../hsl), [InnerShadow](../innershadow), [AlphaReplace](../alphareplace), [Tint](../tint), [Reflection](../reflection), [AlphaModulate](../alphamodulate), [AlphaFloor](../alphafloor), [ColorChange](../colorchange), [Glow](../glow), [GrayScale](../grayscale), [Blur](../blur), [ImageTransformOperation](../imagetransformoperation), [AlphaModulateFixed](../alphamodulatefixed), [FillOverlay](../filloverlay), [PresetShadow](../presetshadow), [Luminance](../luminance), [AlphaCeiling](../alphaceiling), [SoftEdge](../softedge), [Duotone](../duotone), [AlphaBiLevel](../alphabilevel), [AlphaInverse](../alphainverse)
