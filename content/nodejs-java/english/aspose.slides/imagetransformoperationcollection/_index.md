 ...
 **Returns:**
[ColorChange](../colorchange), [Blur](../blur), [HSL](../hsl), [Tint](../tint), [Glow](../glow), [Reflection](../reflection), [GrayScale](../grayscale), [AlphaModulate](../alphamodulate), [OuterShadow](../outershadow), [BiLevel](../bilevel), [BrightnessContrast](../brightnesscontrast), [AlphaInverse](../alphainverse), [PresetShadow](../presetshadow), [InnerShadow](../innershadow), [AlphaBiLevel](../alphabilevel), [AlphaFloor](../alphafloor), [ColorReplace](../colorreplace), [AlphaCeiling](../alphaceiling), [Duotone](../duotone), [AlphaReplace](../alphareplace), [AlphaModulateFixed](../alphamodulatefixed), [SoftEdge](../softedge), [Luminance](../luminance), [ImageTransformOperation](../imagetransformoperation), [FillOverlay](../filloverlay)
