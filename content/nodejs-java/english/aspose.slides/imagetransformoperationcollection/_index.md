 ...
 **Returns:**
[GrayScale](../grayscale), [HSL](../hsl), [AlphaReplace](../alphareplace), [AlphaFloor](../alphafloor), [ColorReplace](../colorreplace), [Luminance](../luminance), [ImageTransformOperation](../imagetransformoperation), [BiLevel](../bilevel), [PresetShadow](../presetshadow), [Tint](../tint), [AlphaModulate](../alphamodulate), [BrightnessContrast](../brightnesscontrast), [AlphaCeiling](../alphaceiling), [ColorChange](../colorchange), [Glow](../glow), [InnerShadow](../innershadow), [SoftEdge](../softedge), [AlphaModulateFixed](../alphamodulatefixed), [FillOverlay](../filloverlay), [AlphaBiLevel](../alphabilevel), [Reflection](../reflection), [Duotone](../duotone), [Blur](../blur), [OuterShadow](../outershadow), [AlphaInverse](../alphainverse)
