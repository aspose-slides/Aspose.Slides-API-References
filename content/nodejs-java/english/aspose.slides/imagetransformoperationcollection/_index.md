 ...
 **Returns:**
[InnerShadow](../innershadow), [ImageTransformOperation](../imagetransformoperation), [AlphaFloor](../alphafloor), [Glow](../glow), [HSL](../hsl), [AlphaModulateFixed](../alphamodulatefixed), [Blur](../blur), [BiLevel](../bilevel), [PresetShadow](../presetshadow), [AlphaModulate](../alphamodulate), [Duotone](../duotone), [ColorReplace](../colorreplace), [SoftEdge](../softedge), [AlphaInverse](../alphainverse), [AlphaReplace](../alphareplace), [FillOverlay](../filloverlay), [Luminance](../luminance), [GrayScale](../grayscale), [Reflection](../reflection), [OuterShadow](../outershadow), [ColorChange](../colorchange), [AlphaCeiling](../alphaceiling), [AlphaBiLevel](../alphabilevel), [Tint](../tint)
