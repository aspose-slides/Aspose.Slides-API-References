 ...
 **Returns:**
[InnerShadow](../innershadow), [GrayScale](../grayscale), [PresetShadow](../presetshadow), [Tint](../tint), [ColorReplace](../colorreplace), [AlphaModulateFixed](../alphamodulatefixed), [SoftEdge](../softedge), [AlphaReplace](../alphareplace), [AlphaFloor](../alphafloor), [Reflection](../reflection), [ColorChange](../colorchange), [AlphaBiLevel](../alphabilevel), [Duotone](../duotone), [Luminance](../luminance), [OuterShadow](../outershadow), [AlphaInverse](../alphainverse), [Blur](../blur), [Glow](../glow), [HSL](../hsl), [BiLevel](../bilevel), [ImageTransformOperation](../imagetransformoperation), [FillOverlay](../filloverlay), [BrightnessContrast](../brightnesscontrast), [AlphaModulate](../alphamodulate), [AlphaCeiling](../alphaceiling)
