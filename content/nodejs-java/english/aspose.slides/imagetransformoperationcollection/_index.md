 ...
 **Returns:**
[GrayScale](../grayscale), [ImageTransformOperation](../imagetransformoperation), [AlphaBiLevel](../alphabilevel), [ColorReplace](../colorreplace), [Blur](../blur), [OuterShadow](../outershadow), [Duotone](../duotone), [AlphaReplace](../alphareplace), [AlphaInverse](../alphainverse), [Luminance](../luminance), [HSL](../hsl), [AlphaFloor](../alphafloor), [PresetShadow](../presetshadow), [FillOverlay](../filloverlay), [AlphaModulate](../alphamodulate), [InnerShadow](../innershadow), [Reflection](../reflection), [Tint](../tint), [ColorChange](../colorchange), [AlphaCeiling](../alphaceiling), [Glow](../glow), [BiLevel](../bilevel), [SoftEdge](../softedge), [AlphaModulateFixed](../alphamodulatefixed)
