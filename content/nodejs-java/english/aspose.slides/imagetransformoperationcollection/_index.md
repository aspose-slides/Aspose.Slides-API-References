 ...
 **Returns:**
[AlphaInverse](../alphainverse), [AlphaModulateFixed](../alphamodulatefixed), [AlphaModulate](../alphamodulate), [FillOverlay](../filloverlay), [GrayScale](../grayscale), [BiLevel](../bilevel), [AlphaFloor](../alphafloor), [AlphaCeiling](../alphaceiling), [ColorChange](../colorchange), [PresetShadow](../presetshadow), [Blur](../blur), [ImageTransformOperation](../imagetransformoperation), [InnerShadow](../innershadow), [AlphaBiLevel](../alphabilevel), [Luminance](../luminance), [ColorReplace](../colorreplace), [OuterShadow](../outershadow), [Tint](../tint), [Glow](../glow), [HSL](../hsl), [Reflection](../reflection), [SoftEdge](../softedge), [Duotone](../duotone), [AlphaReplace](../alphareplace)
