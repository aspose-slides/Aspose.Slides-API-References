 ...
 **Returns:**
[ImageTransformOperation](../imagetransformoperation), [AlphaModulate](../alphamodulate), [SoftEdge](../softedge), [AlphaInverse](../alphainverse), [Glow](../glow), [AlphaModulateFixed](../alphamodulatefixed), [ColorChange](../colorchange), [AlphaReplace](../alphareplace), [FillOverlay](../filloverlay), [Tint](../tint), [InnerShadow](../innershadow), [OuterShadow](../outershadow), [AlphaBiLevel](../alphabilevel), [ColorReplace](../colorreplace), [AlphaFloor](../alphafloor), [Reflection](../reflection), [BiLevel](../bilevel), [GrayScale](../grayscale), [HSL](../hsl), [Blur](../blur), [PresetShadow](../presetshadow), [AlphaCeiling](../alphaceiling), [Luminance](../luminance), [Duotone](../duotone)
