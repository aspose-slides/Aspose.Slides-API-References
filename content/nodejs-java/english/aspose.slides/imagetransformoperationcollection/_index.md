 ...
 **Returns:**
[FillOverlay](../filloverlay), [AlphaInverse](../alphainverse), [Glow](../glow), [AlphaFloor](../alphafloor), [Blur](../blur), [PresetShadow](../presetshadow), [AlphaReplace](../alphareplace), [HSL](../hsl), [Luminance](../luminance), [GrayScale](../grayscale), [OuterShadow](../outershadow), [Duotone](../duotone), [AlphaBiLevel](../alphabilevel), [SoftEdge](../softedge), [AlphaModulateFixed](../alphamodulatefixed), [ColorReplace](../colorreplace), [BiLevel](../bilevel), [Reflection](../reflection), [ColorChange](../colorchange), [Tint](../tint), [ImageTransformOperation](../imagetransformoperation), [AlphaModulate](../alphamodulate), [InnerShadow](../innershadow), [AlphaCeiling](../alphaceiling)
