 ...
 **Returns:**
[FillOverlay](../filloverlay), [Duotone](../duotone), [InnerShadow](../innershadow), [BiLevel](../bilevel), [AlphaModulate](../alphamodulate), [OuterShadow](../outershadow), [AlphaModulateFixed](../alphamodulatefixed), [Luminance](../luminance), [HSL](../hsl), [Tint](../tint), [AlphaFloor](../alphafloor), [ImageTransformOperation](../imagetransformoperation), [AlphaBiLevel](../alphabilevel), [ColorReplace](../colorreplace), [Glow](../glow), [ColorChange](../colorchange), [AlphaReplace](../alphareplace), [GrayScale](../grayscale), [SoftEdge](../softedge), [AlphaCeiling](../alphaceiling), [PresetShadow](../presetshadow), [AlphaInverse](../alphainverse), [Reflection](../reflection), [Blur](../blur)
