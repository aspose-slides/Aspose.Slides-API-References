 ...
 **Returns:**
[Reflection](../reflection), [Glow](../glow), [AlphaModulate](../alphamodulate), [AlphaModulateFixed](../alphamodulatefixed), [InnerShadow](../innershadow), [BrightnessContrast](../brightnesscontrast), [Blur](../blur), [Luminance](../luminance), [BiLevel](../bilevel), [AlphaCeiling](../alphaceiling), [AlphaReplace](../alphareplace), [ImageTransformOperation](../imagetransformoperation), [FillOverlay](../filloverlay), [ColorReplace](../colorreplace), [AlphaFloor](../alphafloor), [PresetShadow](../presetshadow), [Tint](../tint), [GrayScale](../grayscale), [AlphaInverse](../alphainverse), [SoftEdge](../softedge), [HSL](../hsl), [ColorChange](../colorchange), [OuterShadow](../outershadow), [Duotone](../duotone), [AlphaBiLevel](../alphabilevel)
