 ...
 **Returns:**
[ColorChange](../colorchange), [AlphaBiLevel](../alphabilevel), [Luminance](../luminance), [FillOverlay](../filloverlay), [OuterShadow](../outershadow), [BiLevel](../bilevel), [BrightnessContrast](../brightnesscontrast), [AlphaInverse](../alphainverse), [GrayScale](../grayscale), [PresetShadow](../presetshadow), [AlphaReplace](../alphareplace), [Glow](../glow), [Reflection](../reflection), [ImageTransformOperation](../imagetransformoperation), [Tint](../tint), [HSL](../hsl), [SoftEdge](../softedge), [AlphaModulate](../alphamodulate), [InnerShadow](../innershadow), [Blur](../blur), [ColorReplace](../colorreplace), [AlphaModulateFixed](../alphamodulatefixed), [Duotone](../duotone), [AlphaFloor](../alphafloor), [AlphaCeiling](../alphaceiling)
