...
| --- | --- | --- |
| master | [MasterSlide] | Master slide for a new layout. |
...
| Name | Type | Description |
| --- | --- | --- |
| sourceLayout | [LayoutSlide] | Slide to clone. When cloning a layout between different presentations layout's master can be cloned too to keep source formatting. Internal registry is used to track automatically cloned masters to prevent creation of multiple clones of the same master slide. Manual cloning of master slides will be neither prevented nor registered. |
