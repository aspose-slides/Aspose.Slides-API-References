...
url: /aspose.slides/legendentrycollection/
---
...
| Name | Description |
| --- | --- |
| getCount () | Gets the number of legend entries. Read-only int. |
