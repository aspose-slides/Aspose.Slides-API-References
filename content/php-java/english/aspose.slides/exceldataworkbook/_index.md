...
| Name | Description |
| --- | --- |
| ExcelDataWorkbook(InputStream) | Initializes a new instance of the class using the provided stream. |

 **Parameters:**

| Name | Type | Description |
| --- | --- | --- |
| stream | InputStream | A stream containing the Excel workbook data. |
