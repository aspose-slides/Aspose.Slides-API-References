...
url: /zh/aspose.slides/embeddedwofffontshtmlcontroller/
---
...
| 名称 | 描述 |
| --- | --- |
| EmbeddedWoffFontsHtmlController() | 创建新实例。 |
...
| 名称 | 描述 |
| --- | --- |
| EmbeddedWoffFontsHtmlController([EmbeddedWoffFontsHtmlController](../embeddedwofffontshtmlcontroller)) | 创建新实例。 |

**参数:**

| 名称 | 类型 | 描述 |
| --- | --- | --- |
| controller | [EmbeddedWoffFontsHtmlController](../embeddedwofffontshtmlcontroller) | HTML 格式化控制器。 |
...
| 名称 | 描述 |
| --- | --- |
| EmbeddedWoffFontsHtmlController([VideoPlayerHtmlController](../videoplayerhtmlcontroller)) | 创建新实例。 |

**参数:**

| 名称 | 类型 | 描述 |
| --- | --- | --- |
| controller | [VideoPlayerHtmlController](../videoplayerhtmlcontroller) | HTML 格式化控制器。 |
...
| 名称 | 描述 |
| --- | --- |
| EmbeddedWoffFontsHtmlController([EmbeddedEotFontsHtmlController](../embeddedeotfontshtmlcontroller)) | 创建新实例。 |

**参数:**

| 名称 | 类型 | 描述 |
| --- | --- | --- |
| controller | [EmbeddedEotFontsHtmlController](../embeddedeotfontshtmlcontroller) | HTML 格式化控制器。 |
...
| 名称 | 描述 |
| --- | --- |
| EmbeddedWoffFontsHtmlController([ResponsiveHtmlController](../responsivehtmlcontroller)) | 创建新实例。 |

**参数:**

| 名称 | 类型 | 描述 |
| --- | --- | --- |
| controller | [ResponsiveHtmlController](../responsivehtmlcontroller) | HTML 格式化控制器。 |
...
| 名称 | 描述 |
| --- | --- |
| EmbeddedWoffFontsHtmlController([EmbedAllFontsHtmlController](../embedallfontshtmlcontroller)) | 创建新实例。 |

**参数:**

| 名称 | 类型 | 描述 |
| --- | --- | --- |
| controller | [EmbedAllFontsHtmlController](../embedallfontshtmlcontroller) | HTML 格式化控制器。 |
