...
description: نمایش‌دهنده اطلاعات داده توکار برای شیء OLE.
type: docs
weight: 1
...
اطلاعات داده توکار برای شیء OLE را نشان می‌دهد.
...
| متد | توضیح |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | شیء‌ها را با استفاده از semantics [Object.Equals](../../system/object/equals/) C# مقایسه می‌کند. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | داده‌های فایل یک شیء OLE توکار را برمی‌گرداند فقط خواندنی **uint8_t**[]. |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | پسوند فایل شیء OLE توکار فعلی را برمی‌گرداند فقط خواندنی [System::String](../../system/string/). |
...
| void [Lock](../../system/object/lock/)() | قفل‌کننده‌ی بیان C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نظارتی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده کپی. واقعاً چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن زیرکلاس‌ها از طریق کپی را فراهم می‌کند. |
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)() | اطلاعات داده توکار جدیدی برای شیء OLE ایجاد می‌کند. |
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | یک نمونه جدید از اطلاعات داده توکار برای شیء OLE ایجاد می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر اختصاص. واقعاً چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن زیرکلاس‌ها از طریق کپی را فراهم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری بیان C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نظارتی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [IOleEmbeddedDataInfo](../../aspose.slides/ioleembeddeddatainfo/)
* فضای‌نام [Aspose::Slides::DOM::Ole](../)
