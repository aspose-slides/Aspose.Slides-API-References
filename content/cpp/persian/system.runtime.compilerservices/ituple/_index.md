...
description: یک پیاده‌سازی عمومی Tuple تعریف می‌کند که امکان دسترسی به اعضای نمونه Tuple را بدون دانستن نوع پایه Tuple فراهم می‌آورد.
type: docs
weight: 53
url: /fa/system.runtime.compilerservices/ituple/
---
## کلاس ITuple
...
| متد | توضیح |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | شیء را با استفاده از معانی [Object.Equals](../../system/object/equals/) در C# مقایسه می‌کند. |
...
| virtual **int32_t** [get_Length](./get_length/)() const | تعداد موقعیت‌ها در این ساختار داده را برمی‌گرداند. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | عنصر در موقعیت index را برمی‌گرداند. |
...
| void [Lock](../../system/object/lock/)() | عملگر lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | عملگر lock() در C# را برای بازکردن قفل پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* فضای‌نام [System::Runtime::CompilerServices](../)
