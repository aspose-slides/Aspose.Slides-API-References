...
description: ماتریس تبدیل شیء جاری را در ماتریس مشخص شده ضرب می‌کند.
type: docs
weight: 144
url: /fa/system.drawing/texturebrush/multiplytransform/
---
## TextureBrush::MultiplyTransform(const SharedPtr\<Drawing2D::Matrix\>\&, Drawing2D::MatrixOrder) متد
