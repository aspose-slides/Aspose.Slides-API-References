...
description: مجموعه‌ای از اشیاء SolidBrush پیش‌ساخته را فراهم می‌کند. این یک نوع استاتیک بدون سرویس‌های نمونه است. شما هرگز نباید به هیچ وسیله‌ای نمونه‌ای از آن ایجاد کنید.
type: docs
weight: 27
url: /fa/system.drawing/brushes/
---
## کلاس Brushes

یک مجموعه از اشیاء پیش‌ساخته [SolidBrush](../solidbrush/) را فراهم می‌کند. این یک نوع استاتیک بدون سرویس‌های نمونه است. شما هرگز نباید به هیچ وسیله‌ای نمونه‌ای از آن ایجاد کنید.
