...
description: "نشان‌دهندهٔ یک جفت مقدار عدد صحیح است که عرض و ارتفاع یک تصویر را توصیف می‌کند. این نوع باید در پشته تخصیص یابد و به توابع به صورت مقدار یا ارجاع منتقل شود. هرگز از کلاس System::SmartPtr برای مدیریت اشیاء این نوع استفاده نکنید."
type: docs
weight: 274
url: /fa/system.drawing/size/
---
## کلاس Size
...
| **bool** [Equals](./equals/)(const [Size](./)\&) const | Determines if the current object and the specified object are equal, i.e. represent the same pair of width and ارتفاع values. |
| int [get_Height](./get_height/)() const | Returns the value of ارتفاع represented by the current object. |
| **bool** [get_IsEmpty](./get_isempty/)() const | Determines if both width and ارتفاع values are equal to 0. |
...
| [operator SizeF](./operator_sizef/)() const | Constructs an instance of [SizeF](../sizef/) object and initializes it with width and ارتفاع values of the current [Size](./) object. |
...
| static [Size](./) [Subtract](./subtract/)(const [Size](./)\&, const [Size](./)\&) | Returns a new [Size](./) object that is the results of subctraction of **size2** from **size1**, i.e. whose width value is the result of subtraction of **size2's** width value from **size1's** width value and height value is the result of subtraction **size2's** height value from **size1's** height value. |
| [String](../../system/string/) [ToString](./tostring/)() const | Returns the string representation of the pair of width and ارتفاع values represented by the current object. |
