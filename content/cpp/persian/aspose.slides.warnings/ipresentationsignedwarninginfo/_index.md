...
description: این هشدار نشان می‌دهد که ارائه‌ای که در حال خواندن است دارای امضا است و این امضا طی پردازش حذف خواهد شد.
type: docs
weight: 40
url: /fa/aspose.slides.warnings/ipresentationsignedwarninginfo/
---
## IPresentationSignedWarningInfo کلاس

این هشدار نشان می‌دهد که ارائه-ی خوانده-شده دارای امضا است و این امضا در طول پردازش حذف خواهد شد.
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | توضیحی قابل خواندن برای انسان از این هشدار را برمی‌گرداند. فقط خواندنی [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | نوعی از هشدار را برمی‌گرداند. فقط خواندنی [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | نوع حقیقی شیء را دریافت می‌کند. معادل فراخوانی [System.Object.GetType()](../../system/object/gettype/) C#. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری بیان lock() C# را پیاده‌سازی می‌کند. به‌طور مستقیم فراخوانی شود یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | اگر گیرنده null نباشد، هشدار را به گیرنده مشخص پایان می‌دهد و اگر گیرنده تصمیم به لغو عملیات گرفت، استثنای AbortRequestedException را پرتاب می‌کند. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع مشترک را کاهش می‌دهد و برمی‌گرداند. نباید مستقیم فراخوانی شود؛ در عوض، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | عبارت typeof([System.Object](../../system/object/)) C# را پیاده‌سازی می‌کند. |
| void [Unlock](../../system/object/unlock/)() | باز کردن قفل بیان lock() C# را پیاده‌سازی می‌کند. به‌طور مستقیم فراخوانی شود یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
