...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه‌علایند سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه‌علایند سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نیست. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای آزادسازی عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| فیلد | توضیح |
| --- | --- |
| static [Http](./http/) | نمایش رشته‌ای HTTP. |
| static [Https](./https/) | نمایش رشته‌ای HTTPS. |
| static [SchemeDelimiter](./schemedelimiter/) | رشته‌ای که جداکننده طرح را نمایندگی می‌کند. |
| static [Ws](./ws/) | نمایش رشته‌ای WS. |
| static [Wss](./wss/) | نمایش رشته‌ای WSS. |
