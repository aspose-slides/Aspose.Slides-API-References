...
description: متدهای کمکی برای دریافت نمایش رشته‌ای وضعیت HTTP را شامل می‌شود.
type: docs
weight: 248
url: /fa/system.net/httpstatusdescription/
---
## کلاس HttpStatusDescription

متدهای کمکی برای دریافت بازنمایی متنی وضعیت HTTP را دارا است.
...
| static [String](../../system/string/) [Get](./get/)([HttpStatusCode](../httpstatuscode/)) | یک توضیح متنی از کد وضعیت HTTP مشخص‌شده برمی‌گرداند. |
| static [String](../../system/string/) [Get](./get/)(**int32_t**) | یک توضیح متنی از کد وضعیت HTTP مشخص‌شده برمی‌گرداند. |
...
|  [HttpStatusDescription](./httpstatusdescription/)() | سازنده پیش‌فرض حذف‌شده. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده کپی. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن زیرکلاس‌ها با کپی‌سازی را فراهم می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر انتساب. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن زیرکلاس‌ها با کپی‌سازی را فراهم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای بازکردن قفل بیان lock() در C# را پیاده‌سازی می‌کند. به صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
