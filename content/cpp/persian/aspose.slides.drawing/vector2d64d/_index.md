...
description: بردار دو بعدی با مؤلفه‌های double
type: docs
weight: 66
url: /fa/aspose.slides.drawing/vector2d64d/
---
## Vector2d64d کلاس

بردار دو بعدی با مؤلفه‌های **double** 
...
| متد | توضیح |
| --- | --- |
| **double** [Dot](./dot/)([Vector2d64d](./)) | محاسبهٔ محصول اسکالار دو بردار. |
...
| **double** [get_Length](./get_length/)() | طول اسکالار بردار را به دست می‌آورد. فقط-خواندنی **double**. |
| [Vector2d64d](./) [get_Norm](./get_norm/)() | بردار نرمال را به دست می‌آورد. فقط-خواندنی [Vector2d64d](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار داده شمارنده مرجع مرتبط با شیء را به دست می‌آورد. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | همسان روش C# [Object.GetHashCode()](../../system/object/gethashcode/). امکان هش‌سازی اشیاء سفارشی را فراهم می‌کند. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | نوع واقعی شیء را به دست می‌آورد. همسان فراخوانی C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند آیا شیء نمونه‌ای از نوع توصیف‌شده توسط targetType است. همسان عملگر 'is' در C#. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | همسان روش C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). امکان کلون‌کردن انواع سفارشی را فراهم می‌کند. |
| static [Vector2d64d](./) [Min](./min/)([Vector2d64d](./), [Vector2d64d](./)) |  |
| [Vector2d64d](./) [Normalize](./normalize/)() | یک بردار هم‌خطی با طول = 1 ایجاد می‌کند. این بردار نباید طول صفر داشته باشد. |
|  [Object](../../system/object/object/)() | شیء را ایجاد می‌کند. تمام ساختارهای داده داخلی را مقداردهی اولیه می‌کند. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع چیزی کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت نسخهٔ کپی برای زیرکلاس‌ها را فراهم می‌کند. |
...
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | اشیاء را از نظر مرجع مقایسه می‌کند. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | اشیاء را از نظر مرجع مقایسه می‌کند. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع مشترک را کاهش می‌دهد و بر می‌گرداند. نباید به‌صورت مستقیم فراخوانی شود؛ در عوض، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
| void [SwapXY](./swapxy/)() | محور X و Y را جابجا می‌کند. |
| [System::String](../../system/string/) [ToString](./tostring/)() const override | همسان روش C# [Object.ToString()](../../system/object/tostring/). امکان تبدیل اشیاء سفارشی به رشته را فراهم می‌کند. |
| [Vector2d32f](../vector2d32f/) [ToVector2d32f](./tovector2d32f/)() | به [Vector2d32f](../vector2d32f/) |
...
|  [Vector2d64d](./vector2d64d/)(**double**, **double**) | سازنده |
|  [Vector2d64d](./vector2d64d/)([System::Drawing::PointF](../../system.drawing/pointf/)) | سازنده |
