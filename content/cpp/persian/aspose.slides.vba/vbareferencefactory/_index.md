...
| متد | شرح |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)\> [CreateOleTypeLibReference](./createoletypelibreference/)([System::String](../../system/string/), [System::String](../../system/string/)) override | ایجاد ارجاع جدید به کتابخانهٔ نوع OLE Automation. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaReferenceFactory](./)\> [get_Instance](./get_instance/)() | نمونهٔ ایستای کارخانهٔ ارجاعات پروژه VBA. فقط-خواندنی [VbaReferenceFactory](./). |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی شود یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده شود. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌زدایی بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی شود یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده شود. |
...
* کلاس [IVbaReferenceFactory](../ivbareferencefactory/)
