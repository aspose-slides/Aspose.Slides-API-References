...
| متد | توضیح |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [CreateVbaProject](./createvbaproject/)() override | یک پروژه VBA جدید ایجاد می‌کند. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaProjectFactory](./)\> [get_Instance](./get_instance/)() | نمونهٔ ایستاتیک کارخانهٔ پروژه VBA. فقط-خواندنی [VbaProjectFactory](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار دادهٔ شمارندهٔ مرجع مرتبط با شیء را دریافت می‌کند. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | معادل متد [Object.GetHashCode()](../../system/object/gethashcode/) در C#. قابلیت هش کردن اشیاء سفارشی را فراهم می‌کند. |
...
| void [Lock](../../system/object/lock/)() | اجرا کنندهٔ قفل‌گذاری عبارت lock() در C#. می‌توان مستقیماً فراخوانی کرد یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کرد. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [ReadVbaProject](./readvbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | پروژه VBA را از کانتینر OLE می‌خواند. |
...
| void [Unlock](../../system/object/unlock/)() | اجرا کنندهٔ باز کردن قفل عبارت lock() در C#. می‌توان مستقیماً فراخوانی کرد یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کرد. |
...
* کلاس [IVbaProjectFactory](../ivbaprojectfactory/)
