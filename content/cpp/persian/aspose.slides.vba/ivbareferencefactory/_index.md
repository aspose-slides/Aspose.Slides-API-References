...
description: به شما اجازه می‌دهد مرجع‌های پروژه VBA را از طریق رابط COM ایجاد کنید
type: docs
weight: 79
url: /fa/aspose.slides.vba/ivbareferencefactory/
---
## IVbaReferenceFactory کلاس

اجازه می‌دهد مرجع‌های پروژه VBA را از طریق رابط COM ایجاد کند
...
| متد | توضیح |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)\> [CreateOleTypeLibReference](./createoletypelibreference/)([System::String](../../system/string/), [System::String](../../system/string/)) | یک مرجع کتابخانه نوع OLE Automation جدید ایجاد می‌کند. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | داده‌های شمارنده مرجع مرتبط با شیء را دریافت می‌کند. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده نسخه‌برداری. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت نسخه کپی از زیرکلاس‌ها را فراهم می‌کند. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام قالب را به یک اشاره‌گر ضعیف تنظیم می‌کند (به جای اشتراکی). امکان تغییر اشاره‌گرها در کانتینرها به حالت ضعیف را فراهم می‌آورد. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای بازکردن قفل بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
