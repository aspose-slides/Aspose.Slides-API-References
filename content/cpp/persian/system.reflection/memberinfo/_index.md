...
| متد | توضیح |
| --- | --- |
| void [AddAttribute](./addattribute/)(const [ObjectPtr](./objectptr/)\&) | ویژگی را به مجموعه اضافه می‌کند. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطهٔ شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN به عنوان برابر در نظر گرفته می‌شوند حتی اگر طبق IEC 60559:1989 NaN برابر هیچ مقداری نیست، از جمله NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطهٔ شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN به عنوان برابر در نظر گرفته می‌شوند حتی اگر طبق IEC 60559:1989 NaN برابر هیچ مقداری نیست، از جمله NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| [TypeInfo](../../system/typeinfo/) [get_DeclaringType](./get_declaringtype/)() const | نوع اعلان‌کننده را دریافت می‌کند. |
| const [String](../../system/string/)\& [get_FullName](./get_fullname/)() const | نام کامل عضو را دریافت می‌کند. می‌تواند در بخش‌های پیاده‌سازی دستی متفاوت باشد. |
| virtual [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const | یک مقدار [System::Reflection::MemberTypes](../membertypes/) که نوع عضو را نشان می‌دهد - متد، سازنده، رویداد و غیره – را دریافت می‌کند. |
| const [String](../../system/string/)\& [get_Name](./get_name/)() const | نام عضو را دریافت می‌کند. |
| [TypeInfo](../../system/typeinfo/) [get_ReflectedType](./get_reflectedtype/)() const | نوع بازتاب‌شده را دریافت می‌کند. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار داده‌ی شمارنده مرجع مرتبط با شیء را دریافت می‌کند. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | یک آرایه شامل اشیائی که همهٔ ویژگی‌های سفارشی اعمال‌شده به نوع نمایان‌شده توسط شیء جاری را نشان می‌دهند، بر می‌گرداند. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(**bool**) const | یک آرایه شامل اشیائی که همهٔ ویژگی‌های سفارشی اعمال‌شده به نوع نمایان‌شده توسط شیء جاری را نشان می‌دهند، بر می‌گرداند. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند که آیا شیء نمونه‌ای از نوع توصیف‌شده توسط targetType است یا خیر. معادل اپراتور 'is' در C#. |
...
|  [Object](../../system/object/object/)() | شیء را می‌سازد. همهٔ ساختارهای داده داخلی را مقداردهی اولیه می‌کند. |
...
| تعریف نوع | توضیح |
| --- | --- |
| [ObjectPtr](./objectptr/) | نام مستعار یک اشاره‌گر مشترک به [Object](../../system/object/). |
