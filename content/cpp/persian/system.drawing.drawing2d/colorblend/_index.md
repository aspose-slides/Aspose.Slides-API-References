...
description: "حاوی آرایه‌هایی از رنگ‌ها و موقعیت‌ها است که برای درون‌یابی ترکیب رنگ در یک گرادیان چند‌رنگ استفاده می‌شود. اشیاء این کلاس باید فقط با تابع System::MakeObject() تخصیص یابند. هرگز یک نمونه از این نوع را روی پشته یا با عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا نقص‌های assertion می‌شود. همیشه این کلاس را در یک اشاره‌گر System::SmartPtr بپیچید و از این اشاره‌گر برای عبور آن به عنوان آرگومان به توابع استفاده کنید."
type: docs
weight: 27
url: /fa/system.drawing.drawing2d/colorblend/
---
## کلاس ColorBlend
...
| Method | توضیح |
| --- | --- |
|  [ColorBlend](./colorblend/)() | یک نمونه جدید از کلاس [ColorBlend](./) را می‌سازد. |
|  [ColorBlend](./colorblend/)(int) | یک نمونه جدید از کلاس [Blend](../blend/) را می‌سازد. |
...
| [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\> [get_Colors](./get_colors/)() | یک آرایه از رنگ‌ها را برای استفاده در موقعیت‌های متناظر در طول یک گرادیان برمی‌گرداند. |
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Positions](./get_positions/)() | آرایه‌ای از موقعیت‌های ترکیب را در طول یک گرادیان برمی‌گرداند. |
...
| void [set_Colors](./set_colors/)(const [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\>\&) | یک آرایه از رنگ‌ها را برای استفاده در موقعیت‌های متناظر در طول یک گرادیان تنظیم می‌کند. |
| void [set_Positions](./set_positions/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | آرایهٔ موقعیت‌های ترکیب را در طول یک گرادیان تنظیم می‌کند. |
