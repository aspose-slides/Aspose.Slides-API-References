...
description: "شامل فضای‌نام‌ها و پیشوندهای XML است که Serialization::XmlSerializer برای تولید نام‌های معتبر در یک نمونه سند XML استفاده می‌کند."
type: docs
weight: 92
url: /fa/system.xml.serialization/xmlserializernamespaces/
---
## XmlSerializerNamespaces کلاس

حاوی فضای‌نام‌ها و پیشوندهای XML است که [Serialization::XmlSerializer](../xmlserializer/) برای تولید نام‌های معتبر در یک نمونه سند XML استفاده می‌کند.
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | یک جفت پیشوند و فضای‌نام را به شیء [Serialization::XmlSerializerNamespaces](./) اضافه می‌کند. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | اشیاء را با استفاده از معنای [Object.Equals](../../system/object/equals/) در C# مقایسه می‌کند. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | اشیاء نوع ارجاعی را به سبک C# مقایسه می‌کند. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | اشیاء نوع مقدار را به سبک C# مقایسه می‌کند. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسهٔ نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر درنظر گرفته می‌شوند حتی اگر طبق IEC 60559:1989 NaN برابر هیچ مقداری، از جمله NaN نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسهٔ نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر درنظر گرفته می‌شوند حتی اگر طبق IEC 60559:1989 NaN برابر هیچ مقداری، از جمله NaN نیست. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| **int32_t** [get_Count](./get_count/)() | تعداد جفت‌های پیشوند و فضای‌نام را در مجموعه برمی‌گرداند. |
...
| void [Lock](../../system/object/lock/)() | پیاده‌سازی قفل‌گذاری با بیان lock() در C#. مستقیم فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور انتساب. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی از زیرکلاس‌ها را می‌دهد. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\> [ToArray](./toarray/)() | آرایهٔ جفت‌های پیشوند و فضای‌نام را در شیء [Serialization::XmlSerializerNamespaces](./) برمی‌گرداند. |
...
| void [Unlock](../../system/object/unlock/)() | پیاده‌سازی بازکردن قفل توسط بیان lock() در C#. مستقیم فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [XmlSerializerNamespaces](./xmlserializernamespaces/)() | یک نمونه جدید از کلاس [Serialization::XmlSerializerNamespaces](./) را مقداردهی اولیه می‌کند. |
|  [XmlSerializerNamespaces](./xmlserializernamespaces/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSerializerNamespaces](./)\>\&) | یک نمونه جدید از کلاس [Serialization::XmlSerializerNamespaces](./) را مقداردهی اولیه می‌کند، با استفاده از نمونهٔ مشخص‌شدهٔ **[XmlSerializerNamespaces](./)** که شامل مجموعهٔ جفت‌های پیشوند و فضای‌نام است. |
|  [XmlSerializerNamespaces](./xmlserializernamespaces/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\&) | یک نمونه جدید از کلاس [Serialization::XmlSerializerNamespaces](./) را مقداردهی اولیه می‌کند. |
