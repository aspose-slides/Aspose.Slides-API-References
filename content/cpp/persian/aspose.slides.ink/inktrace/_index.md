...
description: یک شیء Trace را نمایان می‌کند. یک عنصر Trace برای ضبط داده‌های ضبط‌شده توسط دیجیتالایزر استفاده می‌شود. این عنصر شامل دنباله‌ای از نقاط است که بر اساس مشخصات ارائه‌شده توسط شیء InkTraceFormat کدگذاری شده‌اند.
type: docs
weight: 92
...
یک شیء Trace را نمایان می‌کند. یک عنصر Trace برای ثبت داده‌های ضبط‌شده توسط دیجیتالایزر استفاده می‌شود. این عنصر حاوی دنباله‌ای از نقاط است که بر اساس مشخصات ارائه‌شده توسط شیء InkTraceFormat رمزگذاری شده‌اند.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه عددی ممیزی به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN همچنان برابر در نظر گرفته می‌شوند، اگرچه طبق IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه عددی ممیزی به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN همچنان برابر در نظر گرفته می‌شوند، اگرچه طبق IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نیست. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| [System::SharedPtr](../../system/sharedptr/)\<[IInkBrush](../iinkbrush/)\> [get_Brush](./get_brush/)() override | قلم‌مو (Brush) را برای IInkLine [IInkBrush](../iinkbrush/) فقط-خواندنی دریافت می‌کند. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() override | نقاط را برای IInkLine [System::Drawing::PointF](../../system.drawing/pointf/) فقط-خواندنی دریافت می‌کند. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی شود یا از شیء sentry [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)() | شیء را ایجاد می‌کند. تمام ساختارهای داده‌ی داخلی را مقداردهی اولیه می‌کند. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور انتساب. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی از کلاس‌های فرزند را فراهم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | بازکردن قفل بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی شود یا از شیء sentry [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual  [~Object](../../system/object/~object/)() | شیء را از بین می‌برد. تمام ساختارهای داده‌ی داخلی را آزاد می‌کند. |
## موارد مرتبط
