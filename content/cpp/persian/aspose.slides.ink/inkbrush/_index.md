...
description: یک شیء inkBrush را نمایش می‌دهد.
type: docs
weight: 79
...
یک شیء inkBrush را نمایش می‌دهد.
...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | رنگ قلم‌مو را برای یک خط دریافت می‌کند. |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | نوع افکت جوهر (e.g., Galaxy, Gold, Silver) را که سبک بصری خط جوهر را تعریف می‌کند، دریافت می‌کند. مقدار از ویژگی قلم‌مو \"inkEffects\" تجزیه می‌شود. اگر هیچ افکت شناخته‌شده‌ای مشخص نشود، [InkEffectType::NotDefined](../inkeffecttype/) برگردانده می‌شود. |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | اندازه قلم‌مو را برای یک خط به نقطه دریافت می‌کند. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند که آیا شیء نمایانگر یک نمونه از نوع توصیف‌شده توسط targetType است. معادل عملگر C# 'is' است. |
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده شود. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده کپی. در واقع چیزی کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و ساخت کپی زیرکلاس‌ها را امکان‌پذیر می‌سازد. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور انتساب. در واقع چیزی کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و ساخت کپی زیرکلاس‌ها را امکان‌پذیر می‌سازد. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | رنگ قلم‌مو را برای یک خط تنظیم می‌کند. |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | اندازه قلم‌مو را برای یک خط به نقطه تنظیم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای آزادسازی قفل عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده شود. |
