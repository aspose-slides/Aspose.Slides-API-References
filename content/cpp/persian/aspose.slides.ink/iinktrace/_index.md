...
description: خط دست‌نویس را در شیء Ink نشان می‌دهد.
type: docs
weight: 40
...
نمایش خط دست‌نویس در یک شیء [Ink](../ink/).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | شبیه‌سازی مقایسهٔ نقطهٔ عطف به سبک C# که در آن دو NaN برابر در نظر گرفته می‌شوند اگرچه بر اساس IEC 60559:1989 NaN برابر هیچ مقداری نیست، از جمله NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | شبیه‌سازی مقایسهٔ نقطهٔ عطف به سبک C# که در آن دو NaN برابر در نظر گرفته می‌شوند اگرچه بر اساس IEC 60559:1989 NaN برابر هیچ مقداری نیست، از جمله NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IInkBrush](../iinkbrush/)\> [get_Brush](./get_brush/)() | Brush را برای IInkLine [IInkBrush](../iinkbrush/) به‌دست می‌آورد فقط‌خواندنی. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | نقاط را برای IInkLine [System::Drawing::PointF](../../system.drawing/pointf/) به‌دست می‌آورد فقط‌خواندنی. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری بیان lock() در C#. به‌طور مستقیم فراخوانی شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده شود. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | عملیات typeof([System.Object](../../system/object/)) در C# را پیاده‌سازی می‌کند. |
| void [Unlock](../../system/object/unlock/)() | اجرای باز کردن قفل بیان lock() در C#. به‌طور مستقیم فراخوانی شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده شود. |
