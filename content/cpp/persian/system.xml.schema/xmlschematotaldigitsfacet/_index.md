...
description: نمایانگر ویژگی totalDigits از XML Schema است که توسط کنسرسیوم جهانی وب (W3C) مشخص شده است. این کلاس می‌تواند برای تعیین محدودیتی بر تعداد ارقامی که برای مقدار یک عنصر simpleType می‌توان وارد کرد، استفاده شود. مقدار totalDigits باید یک عدد صحیح مثبت باشد.
type: docs
weight: 898
url: /fa/system.xml.schema/xmlschematotaldigitsfacet/
---
## XmlSchemaTotalDigitsFacet کلاس

نمایانگر ویژگی **totalDigits** از XML [Schema](../) است که توسط کنسرسیوم جهانی [Web](../../system.web/) (W3C) مشخص شده است. این کلاس می‌تواند برای تعیین محدودیتی بر تعداد ارقامی که می‌توان برای مقدار یک عنصر **simpleType** وارد کرد، استفاده شود. مقدار **totalDigits** باید یک عدد صحیح مثبت باشد.
...
| متد | توضیح |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | شیء‌ها را با استفاده از معناشناسی [Object.Equals](../../system/object/equals/) زبان C# مقایسه می‌کند. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | اشیاء از نوع مرجع را به سبک C# مقایسه می‌کند. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | اشیاء از نوع مقدار را به سبک C# مقایسه می‌کند. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو مقدار NaN برابر در نظر گرفته می‌شوند، حتی اگر بر اساس IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نباشد. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو مقدار NaN برابر در نظر گرفته می‌شوند، حتی اگر بر اساس IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نباشد. |
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | اطلاعاتی را برمی‌گرداند که نشان می‌دهد این ویژگی ثابت است. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | شیء XmlSerializerNamespaces را که با این شیء schema استفاده می‌شود، برمی‌گرداند. |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | محل منبع فایل بارگذاری شده schema را برمی‌گرداند. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | ویژگی **value** این ویژگی را برمی‌گرداند. |
...
| void [Lock](../../system/object/lock/)() | اجرا کننده قفل‌گذاری با عبارت lock() در C#. به‌طور مستقیم صدا بزنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | محل منبع فایل بارگذاری شده schema را تنظیم می‌کند. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | ویژگی **value** این ویژگی را تنظیم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | اجرا کننده بازکردن قفل با عبارت lock() در C#. به‌طور مستقیم صدا بزنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [XmlSchemaTotalDigitsFacet](./xmlschematotaldigitsfacet/)() | یک نمونه جدید از کلاس [XmlSchemaTotalDigitsFacet](./) را مقداردهی اولیه می‌کند. |
