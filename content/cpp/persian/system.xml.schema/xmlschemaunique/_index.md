...
description: عنصر unique را از XML Schema که توسط کنسرسیوم جهانی وب (W3C) تعیین شده است، نمایان می‌کند. این کلاس می‌تواند برای شناسایی یک قید یکتا در میان مجموعه‌ای از عناصر استفاده شود.
type: docs
weight: 924
url: /fa/system.xml.schema/xmlschemaunique/
---
## XmlSchemaUnique کلاس

نمایانگر عنصر **unique** از XML [Schema](../) است همان‌طور که توسط کنسرسیوم جهانی [Web](../../system.web/) (W3C) مشخص شده است. این کلاس می‌تواند برای شناسایی یک محدودیت یکتا در میان مجموعه‌ای از عناصر استفاده شود.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه شناور به-سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر درنظر گرفته می‌شوند، حتی اگر بر وفق استاندارد IEC 60559:1989 NaN برابر هیچ مقداری، از جمله NaN، نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه شناور به-سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر درنظر گرفته می‌شوند، حتی اگر بر وفق استاندارد IEC 60559:1989 NaN برابر هیچ مقداری، از جمله NaN، نیست. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](../xmlschemaidentityconstraint/get_fields/)() | مجموعه فیلدهایی را که به عنوان فرزندان برای انتخابگر عبارت XML Path Language ([XPath](../../system.xml.xpath/)) اعمال می‌شوند، برمی‌گرداند. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | شناسهٔ رشته‌ای را برمی‌گرداند. |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | شماره سطر در فایلی که عنصر **schema** به آن ارجاع دارد را برمی‌گرداند. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | موقعیت سطر در فایلی که عنصر **schema** به آن ارجاع دارد را برمی‌گرداند. |
| [String](../../system/string/) [get_Name](../xmlschemaidentityconstraint/get_name/)() | نام محدودیت هویت را برمی‌گرداند. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | XmlSerializerNamespaces را که برای این شیٔ schema استفاده می‌شود، برمی‌گرداند. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](../xmlschemaidentityconstraint/get_qualifiedname/)() | نام معتبر (qualified) محدودیت هویت را که تفسیر پس از کامپایل مقدار **QualifiedName** را نگه می‌دارد، برمی‌گرداند. |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | مکان منبع برای فایلی که schema را بارگذاری کرده است را برمی‌گرداند. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | ویژگی‌های معتبر که به فضای نام هدف schema فعلی تعلق ندارند را برمی‌گرداند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌بندی دستور C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)() | شیء‌ای ایجاد می‌کند. تمام ساختارهای داخلی را مقداردهی اولیه می‌نماید. |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | شماره سطر در فایلی که عنصر **schema** به آن ارجاع دارد را تنظیم می‌کند. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | موقعیت سطر در فایلی که عنصر **schema** به آن ارجاع دارد را تنظیم می‌کند. |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | مکان منبع برای فایلی که schema را بارگذاری کرده است را تنظیم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای باز کردن قفل دستور C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/xmlschemaidentityconstraint/)() | نمونهٔ جدیدی از کلاس [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/) را مقداردهی اولیه می‌کند. |
