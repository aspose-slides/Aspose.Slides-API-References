...
description: نماد عنصر any کنسرسیوم وب جهانی (W3C).
type: docs
weight: 131
url: /fa/system.xml.schema/xmlschemaany/
---
## XmlSchemaAny کلاس
...
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | عدد را به عنوان یک مقدار رشته‌ای برمی‌گرداند. حداکثر تعداد دفعاتی که ذره می‌تواند رخ دهد. |
...
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | عدد را به عنوان یک مقدار رشته‌ای برمی‌گرداند. حداقل تعداد دفعاتی که ذره می‌تواند رخ دهد. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | فضاهای نام حاوی عناصری که می‌توان استفاده کرد را برمی‌گرداند. |
...
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | اطلاعاتی دربارهٔ نحوهٔ پردازش یا برنامهٔ XML برای اعتبارسنجی اسناد XML برای عناصری که توسط عنصر **any** مشخص شده‌اند، برمی‌گرداند. |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | موقعیت منبع فایل بارگذاری‌شدهٔ schema را برمی‌گرداند. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | صفات دارای صلاحیت که به فضای نام هدف schema فعلی تعلق ندارند را برمی‌گرداند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل (lock()) در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل متد [Object.MemberwiseClone()](../../system/object/memberwiseclone/) در C# است. امکان کپی‌سازی انواع سفارشی را بدهد. |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | فضاهای نام حاوی عناصری که می‌توان استفاده کرد را تنظیم می‌کند. |
...
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | اطلاعاتی دربارهٔ نحوهٔ پردازش یا برنامهٔ XML برای اعتبارسنجی اسناد XML برای عناصری که توسط عنصر **any** مشخص شده‌اند را تنظیم می‌کند. |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | موقعیت منبع فایل بارگذاری‌شدهٔ schema را تنظیم می‌کند. |
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | صفات دارای صلاحیت که به فضای نام هدف schema فعلی تعلق ندارند را تنظیم می‌کند. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | معادل متد [Object.ToString()](../../system/object/tostring/) در C# است. تبدیل اشیاء سفارشی به رشته را امکان‌پذیر می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | قفل (lock()) در C# را باز می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [XmlSchemaAny](./xmlschemaany/)() | نمونهٔ جدیدی از کلاس [XmlSchemaAny](./) را مقداردهی اولیه می‌کند. |
...
اشیای این کلاس باید فقط با استفاده از تابع [System::MakeObject()](../../system/makeobject/) تخصیص داده شوند. هرگز نمونه‌های این نوع را بر روی پشته یا با استفاده از عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا خطاهای اظهاری می‌شود. همیشه این کلاس را در یک اشاره‌گر [System::SmartPtr](../../system/smartptr/) بپیچید و از این اشاره‌گر برای عبور به توابع به‌عنوان آرگومان استفاده کنید. 
