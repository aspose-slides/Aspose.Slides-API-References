...
description: نماد pattern را از XML Schema طبق تعریف کنسرسیوم جهانی وب (W3C) نشان می‌دهد. این کلاس می‌تواند برای تعیین محدودیتی بر مقدار وارد شده برای عنصر simpleType استفاده شود.
type: docs
weight: 742
url: /fa/system.xml.schema/xmlschemapatternfacet/
---
## XmlSchemaPatternFacet کلاس

نمایشگر عنصر **pattern** از XML [Schema](../) است که توسط کنسرسیوم [Web](../../system.web/) جهانی (W3C) تعریف شده است. این کلاس می‌تواند برای تعیین محدودیتی بر مقدار وارد شده برای عنصر **simpleType** استفاده شود.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر هیچ مقداری نیست، حتی NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر هیچ مقداری نیست، حتی NaN. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | مقدار والد این [XmlSchemaObject](../xmlschemaobject/) را برمی‌گرداند. |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | موقعیت منبع برای فایلی که schema را بارگذاری کرده است را برمی‌گرداند. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | ویژگی **value** این facet را برمی‌گرداند. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند که آیا شیء نمایانگر یک نمونه از نوع توصیف‌شده توسط targetType است یا خیر. معادل عملگر 'is' در C#. |
| void [Lock](../../system/object/lock/)() | قفل‌گذاری با عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده کپی. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی برای کلاس‌های مشتق شده را فراهم می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر تخصیص. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی برای کلاس‌های مشتق شده را فراهم می‌کند. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | اطلاعاتی را تنظیم می‌کند که نشان می‌دهد این facet ثابت است. |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | موقعیت منبع برای فایلی که schema را بارگذاری کرده تنظیم می‌کند. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | ویژگی **value** این facet را تنظیم می‌کند. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع مشترک را کاهش می‌دهد و برمی‌گرداند. نباید به‌صورت مستقیم فراخوانی شود؛ در عوض، از پوینترهای هوشمند یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری با عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | شمارنده مرجع ضعیف را کاهش می‌دهد. نباید به‌صورت مستقیم فراخوانی شود؛ در عوض، از پوینترهای هوشمند یا ThisProtector استفاده کنید. |
...
|  [XmlSchemaPatternFacet](./xmlschemapatternfacet/)() | یک نمونه جدید از کلاس [XmlSchemaPatternFacet](./) را مقداردهی اولیه می‌کند. |
...
شیءهای این کلاس باید تنها با استفاده از تابع [System::MakeObject()](../../system/makeobject/) تخصیص داده شوند. هرگز نمونه‌های این نوع را روی پشته یا با استفاده از عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا خطاهای اعتبارسنجی می‌شود. همیشه این کلاس را در یک اشاره‌گر [System::SmartPtr](../../system/smartptr/) بپیچید و از این اشاره‌گر برای عبور به توابع به‌عنوان آرگومان استفاده کنید. 
