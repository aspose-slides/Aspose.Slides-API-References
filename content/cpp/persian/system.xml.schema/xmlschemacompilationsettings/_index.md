...
description: گزینه‌های کامپایل طرح‌واره برای کلاس XmlSchemaSet فراهم می‌کند. این کلاس نمی‌تواند ارث‌برده شود.
type: docs
weight: 248
url: /fa/system.xml.schema/xmlschemacompilationsettings/
---
## XmlSchemaCompilationSettings کلاس
...
| **bool** [get_EnableUpaCheck](./get_enableupacheck/)() | مقداری را برمی‌گرداند که نشان می‌دهد آیا [XmlSchemaSet](../xmlschemaset/) باید خلاف‌های اختصاص ذرات یکتا (UPA) را بررسی کند یا نه. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری در بیان C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء sentry [LockContext](../../system/lockcontext/) استفاده کنید. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل متد C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). امکان کلون‌کردن انواع سفارشی را فراهم می‌کند. |
|  [Object](../../system/object/object/)() | شیء را ایجاد می‌کند. تمام ساختارهای دادهٔ داخلی را مقداردهی اولیه می‌کند. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع هیچ‌چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان سازندهٔ کپی برای کلاس‌های مشتق‌شده را فراهم می‌کند. |
...
| void [set_EnableUpaCheck](./set_enableupacheck/)(**bool**) | مقداری را تنظیم می‌کند که آیا [XmlSchemaSet](../xmlschemaset/) باید خلاف‌های UPA را بررسی کند یا نه. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام قالب را یک اشاره‌گر ضعیف (نه مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در مخازن به حالت ضعیف را فراهم می‌آورد. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای بازکردن قفل در بیان C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء sentry [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [XmlSchemaCompilationSettings](./xmlschemacompilationsettings/)() | نمونهٔ جدیدی از کلاس [XmlSchemaCompilationSettings](./) را مقداردهی اولیه می‌کند. |
