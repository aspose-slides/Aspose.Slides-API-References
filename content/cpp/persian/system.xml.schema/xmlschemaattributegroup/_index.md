...
description: نماد عنصر attributeGroup از XML Schema طبق مشخصات World Wide Web Consortium (W3C) است. AttributesGroups مکانیزمی فراهم می‌کند تا مجموعه‌ای از اعلان‌های ویژگی را گروه‌بندی کند تا بتوان آن‌ها را به‌عنوان یک گروه در تعریف‌های نوع پیچیده وارد کرد.
type: docs
weight: 183
url: /fa/system.xml.schema/xmlschemaattributegroup/
---
## XmlSchemaAttributeGroup کلاس
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | اجزای [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) گروه ویژگی را برمی‌گرداند. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | مجموعهٔ ویژگی‌های گروه ویژگی را برمی‌گرداند. شامل عناصر [XmlSchemaAttribute](../xmlschemaattribute/) و [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) است. |
...
| [String](../../system/string/) [get_Name](./get_name/)() | نام گروه ویژگی را برمی‌گرداند. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | نام مشروط گروه ویژگی را برمی‌گرداند. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttributeGroup](./)\> [get_RedefinedAttributeGroup](./get_redefinedattributegroup/)() | خاصیت گروه ویژگی بازتعریف‌شده از XML [Schema](../) را برمی‌گرداند. |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | محل منبع فایل بارگذاری‌شده schema را برمی‌گرداند. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | ویژگی‌های مشروطی را که به فضای نام هدف schema جاری تعلق ندارند برمی‌گرداند. |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | اجزای [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) گروه ویژگی را تنظیم می‌کند. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | نام گروه ویژگی را تنظیم می‌کند. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | ویژگی‌های مشروطی که به فضای نام هدف schema جاری تعلق ندارند را تنظیم می‌کند. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام الگو را به یک اشاره‌گر ضعیف (به‌جای مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در نگهدارنده‌ها به حالت ضعیف را فراهم می‌کند. |
...
|  [XmlSchemaAttributeGroup](./xmlschemaattributegroup/)() | نمونهٔ جدیدی از کلاس [XmlSchemaAttributeGroup](./) را مقداردهی اولیه می‌کند. |
