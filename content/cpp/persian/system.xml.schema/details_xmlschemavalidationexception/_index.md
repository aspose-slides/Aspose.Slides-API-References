...
description: نمایش می‌دهد استثنایی که هنگام مواجه شدن با خطاها و هشدارهای اعتبارسنجی طرح‌واره XML Schema Definition Language (XSD) در یک سند XML که در حال اعتبارسنجی است، پرتاب می‌شود.
type: docs
weight: 27
url: /fa/system.xml.schema/details_xmlschemavalidationexception/
---
## کلاس Details_XmlSchemaValidationException

نمایش می‌دهد استثنایی که زمانی که خطاها و هشدارهای اعتبارسنجی طرح‌واره XML [Schema](../) Definition Language (XSD) در سند XML در حال اعتبارسنجی مواجه می‌شوند، پرتاب می‌شود.
...
| متد | توصیف |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | اشیاء را با استفاده از سیمانتیک [Object.Equals](../../system/object/equals/) C# مقایسه می‌کند. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | یک مقدار عدد صحیح ۳۲-بیتی که کد HRESULT مربوط به استثنای نمایندهٔ شیٔ فعلی است را برمی‌گرداند. |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | مرجع به شیئی که استثنای داخلی را نمایندگی می‌کند را برمی‌گرداند. |
| **int32_t** [get_LineNumber](../details_xmlschemaexception/get_linenumber/)() | شماره خطی که نشان می‌دهد خطا کجا رخ داده است را برمی‌گرداند. |
| **int32_t** [get_LinePosition](../details_xmlschemaexception/get_lineposition/)() | موقعیت خطی که نشان می‌دهد خطا کجا رخ داده است را برمی‌گرداند. |
| [String](../../system/string/) [get_Message](../details_xmlschemaexception/get_message/)() const override | توضیح وضعیت خطای این استثنا را برمی‌گرداند. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SourceObject](./get_sourceobject/)() | گرهٔ XML که موجب این XmlSchemaValidationException شده است را برمی‌گرداند. |
...
| [String](../../system/string/) [get_SourceUri](../details_xmlschemaexception/get_sourceuri/)() | مکان Uniform Resource Identifier (URI) طرح‌واره‌ای که باعث استثنا شده است را برمی‌گرداند. |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | کپی از شیء Exception که نمایندهٔ داخلی‌ترین استثنا است را برمی‌گرداند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیم فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع هیچ چیز را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن نسخهٔ کپی از زیرکلاس‌ها را فراهم می‌آورد. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور تخصیص. در واقع هیچ چیز را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن نسخهٔ کپی از زیرکلاس‌ها را فراهم می‌آورد. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای آزادسازی قفل عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیم فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | متد [what()](../../system/details_exception/what/) را پیاده‌سازی می‌کند که توسط کلاس [ExceptionWrapper](../../system/exceptionwrapper/) فراخوانی می‌شود. علیرغم این که این کلاس از std::exception ارث‌بری نکرده است، کلاس‌های مشتق می‌توانند از اعضای protected/private برای پیاده‌سازی منطق خود استفاده کنند. انتقال پیاده‌سازی این متد به [ExceptionWrapper](../../system/exceptionwrapper/) ممکن است آن منطق را خراب کند. |
...
* کلاس [Details_XmlSchemaException](../details_xmlschemaexception/)
