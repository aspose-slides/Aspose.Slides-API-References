...
description: بافر برای جایگزینی استراتژی بازگشت رمزگشایی.
type: docs
weight: 92
url: /fa/system.text/decoderreplacementfallbackbuffer/
---
## DecoderReplacementFallbackBuffer کلاس

[Buffer](../../system/buffer/) برای جایگزینی استراتژی بازگشت رمزگشایی.
...
| Method | Description |
| --- | --- |
|  [DecoderReplacementFallbackBuffer](./decoderreplacementfallbackbuffer/)(const [DecoderReplacementFallbackPtr](../../system/decoderreplacementfallbackptr/)\&) | سازنده. |
...
| **bool** [Fallback](./fallback/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | خطای رمزگشایی را مدیریت می‌کند. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای اهداف داخلی. |
| int [get_Remaining](./get_remaining/)() const override | تعداد کاراکترهای باقی‌مانده در بافر را بر می‌گرداند. |
...
| char_t [GetNextChar](./getnextchar/)() override | کاراکتر بعدی در دسترس را بر می‌گرداند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری بیان lock() در C#. مستقیماً فراخوانی شود یا از شیء مأمور [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر واگذاری. واقعاً چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی از زیرکلاس‌ها را فراهم می‌کند. |
...
| void [Reset](./reset/)() override | بافر را به وضعیت اولیه (قبل از فراخوانی [Fallback()](./fallback/)) بازنشانی می‌کند. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان n ام قالب را به یک اشاره‌گر ضعیف تنظیم می‌کند (به جای مشترک). امکان تغییر اشاره‌گرها در کانتینرها به حالت ضعیف را می‌دهد. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای بازکردن قفل بیان lock() در C#. مستقیماً فراخوانی شود یا از شیء مأمور [LockContext](../../system/lockcontext/) استفاده کنید. |
