...
| متد | توضیح |
| --- | --- |
| virtual void [Convert](./convert/)(const char_t *, int, **uint8_t** *, int, **bool**, int\&, int\&, **bool**\&) | کاراکترها را به بایت‌ها تبدیل می‌کند. |
| virtual void [Convert](./convert/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, **bool**, int\&, int\&, **bool**\&) | کاراکترها را به بایت‌ها تبدیل می‌کند. |
...
| [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_Fallback](../encoder/get_fallback/)() const | پشتیبان مدیریت خطا را دریافت می‌کند. |
...
| virtual int [GetByteCount](../encoder/getbytecount/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, **bool**) | تعداد بایت‌های مورد نیاز برای رمزگذاری یک بافر را دریافت می‌کند. |
| virtual int [GetByteCount](../encoder/getbytecount/)(const char_t *, int, **bool**) | تعداد بایت‌های مورد نیاز برای رمزگذاری یک بافر را دریافت می‌کند. |
| virtual int [GetBytes](../encoder/getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, **bool**) | بایت‌های حاصل از رمزگذاری یک بافر را دریافت می‌کند. |
| virtual int [GetBytes](../encoder/getbytes/)(const char_t *, int, **uint8_t** *, int, **bool**) | بایت‌های حاصل از رمزگذاری یک بافر را دریافت می‌کند. |
...
| void [Lock](../../system/object/lock/)() | قفل‌کردن با عبارت lock() C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual void [Reset](../encoder/reset/)() | وضعیت داخلی رمزگذار را پاک می‌کند. |
| void [set_Fallback](../encoder/set_fallback/)(const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&) | پشتیبان مدیریت خطا را تنظیم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گشایی عبارت lock() C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
