...
description: امکان ایجاد یک ماتریس ریاضی را فراهم می‌کند
type: docs
weight: 404
url: /fa/aspose.slides.mathtext/imathmatrixfactory/
---
## IMathMatrixFactory کلاس

امکان ایجاد یک ماتریس ریاضی را فراهم می‌کند
...
| متد | شرح |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathMatrix](../imathmatrix/)\> [CreateMathMatrix](./createmathmatrix/)(**int32_t**, **int32_t**) | یک ماتریس ریاضی ایجاد می‌کند |
