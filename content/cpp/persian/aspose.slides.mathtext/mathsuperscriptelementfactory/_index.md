...
description: اجازه می‌دهد تا IMathSuperscriptElement را ایجاد کنید
type: docs
weight: 1145
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری توسط عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبانی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری با عبارت lock() در C# را باز می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبانی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [IMathSuperscriptElementFactory](../imathsuperscriptelementfactory/)
