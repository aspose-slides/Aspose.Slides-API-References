...
پاراگراف ریاضی که یک مخزن برای بلوک‌های ریاضی است ([IMathBlock](../imathblock/))
...
| متد | توضیح |
| --- | --- |
| virtual void [Add](../imathblockcollection/add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | به انتهای مجموعه [IMathBlock](../imathblock/) را اضافه می‌کند. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | یک تکرارگر را برمی‌گرداند که به اولین عنصر (در صورت وجود) نمونهٔ const-qualified مجموعه اشاره می‌کند. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | یک تکرارگر را برمی‌گرداند که به اولین عنصر (در صورت وجود) نمونهٔ const-qualified مجموعه اشاره می‌کند. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | یک تکرارگر را برمی‌گرداند که به اولین عنصر (در صورت وجود) نمونهٔ const-qualified مجموعه اشاره می‌کند. |
| virtual void [Clear](../imathblockcollection/clear/)() | تمام عناصر را از مجموعه حذف می‌کند. |
| virtual **bool** [Contains](../imathblockcollection/contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | تشخیص می‌دهد که آیا مجموعه حاوی مقدار خاصی است یا خیر. |
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | اشیاء از نوع ارجاعی را به شیوه C# مقایسه می‌کند. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | اشیاء از نوع مقدار را به شیوه C# مقایسه می‌کند. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه‌ی شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند حتی اگر بر اساس IEC 60559:1989 NaN با هیچ‌ مقدار، از جمله NaN، برابر نباشد. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه‌ی شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند حتی اگر بر اساس IEC 60559:1989 NaN با هیچ‌ مقدار، از جمله NaN، برابر نباشد. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای استفاده داخلی. |
| virtual **int32_t** [get_Count](../imathblockcollection/get_count/)() | تعداد عناصری که واقعاً در مجموعه موجود هستند را برمی‌گرداند. فقط-خواندنی **int32_t**. |
| virtual [MathJustification](../mathjustification/) [get_Justification](./get_justification/)() | [Paragraph](../../aspose.slides/paragraph/) توجیه مقدار پیش‌فرض: CenteredAsGroup |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](../imathblockcollection/idx_get/)(**int32_t**) | مورد در اندیس مشخص‌شده را برمی‌گرداند. فقط-خواندنی [IMathBlock](../imathblock/). |
| virtual void [idx_set](../imathblockcollection/idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | مورد در اندیس مشخص‌شده را برمی‌گرداند. فقط-خواندنی [IMathBlock](../imathblock/). |
| virtual **int32_t** [IndexOf](../imathblockcollection/indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | اندیس یک [IMathBlock](../imathblock/) خاص در مجموعه را تعیین می‌کند. |
| virtual void [Insert](../imathblockcollection/insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | [IMathBlock](../imathblock/) را در اندیس مشخص‌شده به مجموعه وارد می‌کند. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | هر عنصر از یک دنباله را به شکل جدیدی تبدیل می‌کند به‌طوری که اندیس عنصر را در بر می‌گیرد. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | تعداد مشخصی از عناصر متوالی را از ابتدای یک دنباله صرف‌نظر می‌کند و بقیه را برمی‌گرداند. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور انتساب. در واقع هیچ‌چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی می‌کند و امکان ساخت نسخهٔ کپی از زیرکلاس‌ها را فراهم می‌کند. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | اشیاء نوع مقدار را با nullptr از نظر ارجاع مقایسه می‌کند. |
...
| virtual **bool** [Remove](../imathblockcollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | اولین وقوع یک شیء خاص را از مجموعه حذف می‌کند. |
| virtual void [RemoveAt](../imathblockcollection/removeat/)(**int32_t**) | موردی را در اندیس مشخص‌شده از مجموعه حذف می‌کند. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | تعداد اشارهٔ مشترک را به مقدار مشخص‌شده کاهش می‌دهد. |
| virtual void [set_Justification](./set_justification/)([MathJustification](../mathjustification/)) | [Paragraph](../../aspose.slides/paragraph/) توجیه مقدار پیش‌فرض: CenteredAsGroup |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام قالب را به اشاره‌گر ضعیف (به‌جای مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در کانتینرها به حالت ضعیف را فراهم می‌کند. |
...
| virtual [System::String](../../system/string/) [ToLatex](./tolatex/)() | معادله ریاضی را در قالب LaTeX برمی‌گرداند. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری بیان lock() در C# را باز می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | پیاده‌سازی begin iterator ثابت برای محفظهٔ فعلی را برمی‌گرداند. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | پیاده‌سازی end iterator ثابت برای محفظهٔ فعلی را برمی‌گرداند. |
...
| virtual void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | [IMathParagraph](./) را به عنوان MathML ذخیره می‌کند. |
...
* کلاس [IMathBlockCollection](../imathblockcollection/)
