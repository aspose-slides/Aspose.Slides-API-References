...
description: اجازه می‌دهد تا IMathSuperscriptElement ساخته شود
type: docs
weight: 599
url: /fa/aspose.slides.mathtext/imathsuperscriptelementfactory/
---
## کلاس IMathSuperscriptElementFactory

اجازه می‌دهد تا [IMathSuperscriptElement](../imathsuperscriptelement/) ساخته شود
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند آیا شیء یک نمونه از نوعی که توسط targetType توصیف شده است. معادل عملگر 'is' در C#. |
| void [Lock](../../system/object/lock/)() | عملکرد قفل کردن در بیانیه C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | مقایسهٔ مرجع شیء از نوع مقداری با nullptr. |
...
| void [Unlock](../../system/object/unlock/)() | پیاده‌سازی باز کردن قفل در بیانیه C# lock(). به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
