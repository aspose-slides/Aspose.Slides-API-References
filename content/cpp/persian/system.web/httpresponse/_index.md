...
| متد | توضیح |
| --- | --- |
| void [AddHeader](./addheader/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | پیاده‌سازی نشده. |
| void [BinaryWrite](./binarywrite/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | پیاده‌سازی نشده. |
| void [Clear](./clear/)() | پیاده‌سازی نشده. |
| void [ClearContent](./clearcontent/)() | پیاده‌سازی نشده. |
| void [ClearHeaders](./clearheaders/)() | پیاده‌سازی نشده. |
| void [End](./end/)() | پیاده‌سازی نشده. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [get_OutputStream](./get_outputstream/)() | پیاده‌سازی نشده. |
...
|  [HttpResponse](./httpresponse/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::IO::TextWriter](../../system.io/textwriter/)\>\&) | پیاده‌سازی نشده. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری با بیان C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [set_ContentType](./set_contenttype/)(const [String](../../system/string/)\&) | پیاده‌سازی نشده. |
...
| void [Unlock](../../system/object/unlock/)() | بازکردن قفل بیان C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
