...
description: عملکرد پایه‌ای برای انتشار یک زمینهٔ همگام‌سازی در عملیات‌های مختلف همگام‌سازی را فراهم می‌کند.
type: docs
weight: 196
url: /fa/system.threading/synchronizationcontext/
---
## کلاس SynchronizationContext

کارکرد پایه‌ای برای انتشار یک زمینهٔ همگام‌سازی در عملیات‌های مختلف همگام‌سازی را فراهم می‌کند.
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | زمینهٔ همگام‌سازی را برای نخ جاری دریافت می‌کند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری توسط عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نظاره‌گر [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | تابع بازگشت (callback) را به‌صورت ناهمزمان اجرا می‌کند. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | تابع بازگشت (callback) را به‌صورت همزمان اجرا می‌کند. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | زمینهٔ همگام‌سازی را برای نخ جاری تنظیم می‌کند. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام قالب را به یک اشاره‌گر ضعیف (به‌جای shared) تنظیم می‌کند. امکان تغییر اشاره‌گرها در containerها به حالت ضعیف را فراهم می‌آورد. |
...
|  [SynchronizationContext](./synchronizationcontext/)() | یک نمونهٔ جدید از [SynchronizationContext](./) را می‌سازد. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | معادل متد C# [Object.ToString()](../../system/object/tostring/). امکان تبدیل اشیاء سفارشی به رشته را فراهم می‌کند. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | ساختار typeof([System.Object](../../system/object/)) در C# را پیاده‌سازی می‌کند. |
| void [Unlock](../../system/object/unlock/)() | اجرای بازکردن قفل توسط عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نظاره‌گر [LockContext](../../system/lockcontext/) استفاده کنید. |
...
این کلاس امکان انتشار زمینهٔ همگام‌سازی بین نخ‌ها را فراهم می‌آورد و برای ارسال callbackها یا فراخوانی‌ها به نخ یا زمینهٔ همگام‌سازی مناسب استفاده می‌شود. پیاده‌سازی ساختگی.
