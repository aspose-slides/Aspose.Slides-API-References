...
description: منبع توکن لغو که می‌تواند برای ایجاد اعلان‌های لغو استفاده شود.
type: docs
weight: 40
url: /fa/system.threading/cancellationtokensource/
---
## CancellationTokenSource کلاس

یک منبع توکن لغو که می‌تواند برای آغاز اعلان‌های لغو استفاده شود.
...
| متد | توضیح |
| --- | --- |
| void [Cancel](./cancel/)() | درخواست لغو را اعلام می‌کند. |
|  [CancellationTokenSource](./cancellationtokensource/)() | یک [CancellationTokenSource](./) جدید می‌سازد. |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | یک منبع توکن پیوسته می‌سازد که هنگامی که هر یک از توکن‌های ارائه شده لغو شوند، لغو می‌شود. |
| void [Dispose](./dispose/)() override | تمام منابع مورد استفاده توسط [CancellationTokenSource](./) را آزاد می‌کند. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند بر مبنای IEC 60559:1989 NaN برابر هیچ مقداری، از جمله NaN، نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند بر مبنای IEC 60559:1989 NaN برابر هیچ مقداری، از جمله NaN، نیست. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | مشخص می‌کند آیا درخواست لغو شده است یا خیر. |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | توکن لغو مرتبط با این منبع را دریافت می‌کند. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری با بیان C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | مقدار کنونی شمارنده‌ی مرجع مشترک را دریافت می‌کند. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده‌ی مرجع مشترک را کاهش داده و مقدار آن را بر می‌گرداند. نباید به‌صورت مستقیم فراخوانی شود؛ به‌جای آن، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | معادل متد C# [Object.ToString()](../../system/object/tostring/). امکان تبدیل اشیاء سفارشی به رشته را فراهم می‌کند. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | ساختار typeof([System.Object](../../system/object/)) در C# را پیاده‌سازی می‌کند. |
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری بیان C# lock() را باز می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
مکانیزمی را فراهم می‌کند تا توکن‌های لغو را برای لغو تعاونی عملیات ایجاد و کنترل کند.
