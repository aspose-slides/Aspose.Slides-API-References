...
type: docs
weight: 768
url: /fa/system.xml/xmlreader/readelementcontentasbase64/
---
## XmlReader::ReadElementContentAsBase64(ArrayPtr\<uint8_t\>, int32_t, int32_t) متد
...
| index | **int32_t** | فاصله‌گذاری در بافر که کپی نتیجه از آنجا آغاز می‌شود. |
