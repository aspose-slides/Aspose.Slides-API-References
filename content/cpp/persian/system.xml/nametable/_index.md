...
description: یک XmlNameTable تک‌نخی را پیاده‌سازی می‌کند.
type: docs
weight: 66
url: /fa/system.xml/nametable/
---
## NameTable کلاس


یک [XmlNameTable](../xmlnametable/) تک‌نخی پیاده‌سازی می‌کند.
...
| Method | Description |
| --- | --- |
| const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) override | رشتهٔ مشخص شده را اتمی‌سازی می‌کند و به [NameTable](./) اضافه می‌گردد. |
| const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | رشتهٔ مشخص شده را اتمی‌سازی می‌کند و به [NameTable](./) اضافه می‌گردد. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسهٔ نقطه‌اعشار به‌سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، اگرچه بر اساس IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسهٔ نقطه‌اعشار به‌سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، اگرچه بر اساس IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نیست. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) override | رشتهٔ اتمی‌شده با مقدار مشخص‌شده را برمی‌گرداند. |
| const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | رشتهٔ اتمی‌شده‌ای را برمی‌گرداند که حاوی همان کاراکترها به‌عنوان بازهٔ مشخص‌شده از کاراکترها در آرایهٔ داده‌شده است. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [NameTable](./nametable/)() | یک نمونهٔ جدید از کلاس [NameTable](./) را مقداردهی اولیه می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌زدایی عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
