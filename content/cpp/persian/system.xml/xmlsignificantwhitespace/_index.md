...
description: "فضای سفید بین تگ‌ها در یک گره محتوا ترکیبی یا فضای سفید درون محدوده‌ای که xml:space='preserve' است را نمایندگی می‌کند. این فضای سفید همچنین به عنوان فضای سفید مهم شناخته می‌شود."
type: docs
weight: 482
url: /fa/system.xml/xmlsignificantwhitespace/
---
## XmlSignificantWhitespace کلاس

فضای سفید بین تگ‌ها در یک گره محتوا ترکیبی یا فضای سفید درون محدوده‌ای که **xml:space='preserve'** است را نمایندگی می‌کند. این فضای سفید همچنین به عنوان فضای سفید مهم شناخته می‌شود.
