...
description: جدولی از اشیاء رشته‌ای اتمی شده.
type: docs
weight: 313
url: /fa/system.xml/xmlnametable/
---
## XmlNameTable کلاس
...
| متد | توضیح |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | زمانی که در یک کلاس مشتق شده بازنویسی می‌شود، رشته مشخص‌شده را اتمی می‌کند و آن را به [XmlNameTable](./) اضافه می‌کند. |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | زمانی که در یک کلاس مشتق شده بازنویسی می‌شود، رشته مشخص‌شده را اتمی می‌کند و آن را به [XmlNameTable](./) اضافه می‌کند. |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | زمانی که در یک کلاس مشتق شده بازنویسی می‌شود، رشته اتمی‌سازی شده‌ای که شامل همان کاراکترهای بازه مشخص‌شده در آرایه داده‌شده است را دریافت می‌کند. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | زمانی که در یک کلاس مشتق شده بازنویسی می‌شود، رشته اتمی‌سازی شده‌ای که همان مقدار رشته مشخص‌شده را دارد را دریافت می‌کند. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار داده شمارندهٔ ارجاع مرتبط با شیء را دریافت می‌کند. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | معادل متد [Object.GetHashCode()](../../system/object/gethashcode/) در C# است. قابلیت هش‌کردن اشیاء سفارشی را فعال می‌کند. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری با دستور lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده شود. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری با دستور lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده شود. |
