...
description: نمایانگر یک دستور پردازش است که XML برای نگهداری اطلاعات خاص پردازنده در متن سند تعریف می‌کند.
type: docs
weight: 404
url: /fa/system.xml/xmlprocessinginstruction/
---
## XmlProcessingInstruction کلاس

نمایش یک دستور پردازش که XML برای نگهداری اطلاعات مخصوص پردازنده در متن سند تعریف می‌کند.
...
| [String](../../system/string/) [get_Data](./get_data/)() | Returns the content of the processing instruction, excluding the target. |
...
| [String](../../system/string/) [get_Target](./get_target/)() | Returns the target of the processing instruction. |
...
| void [set_Data](./set_data/)(const [String](../../system/string/)\&) | Sets the content of the processing instruction, excluding the target. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Saves all the children of the node to the specified [XmlWriter](../xmlwriter/). Because ProcessingInstruction nodes do not have children, this method has no effect. |
