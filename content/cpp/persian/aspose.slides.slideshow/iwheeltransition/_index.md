...
| virtual **uint32_t** [get_Spokes](./get_spokes/)() | تعداد شاخ‌های انتقال چرخ. خواندن **uint32_t**. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری عبارت lock() در C#. مستقیم فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual void [set_Spokes](./set_spokes/)(**uint32_t**) | تعداد شاخ‌های انتقال چرخ. نوشتن **uint32_t**. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای بازقفل‌گذاری عبارت lock() در C#. مستقیم فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
