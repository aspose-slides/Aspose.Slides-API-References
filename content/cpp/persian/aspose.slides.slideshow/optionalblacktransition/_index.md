...
| Method | Description |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | تعیین می‌کند آیا دو نمونه [TransitionValueBase](../transitionvaluebase/) برابر هستند یا نه. |
...
| **bool** [get_FromBlack](./get_fromblack/)() override | این ویژگی مشخص می‌کند آیا انتقال از صفحه‌ای سیاه آغاز می‌شود (و سپس اسلاید جدید بر روی سیاه انتقال می‌یابد). خواندنی **bool**. |
...
| void [Lock](../../system/object/lock/)() | عملکرد قفل شدن عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [set_FromBlack](./set_fromblack/)(**bool**) override | این ویژگی مشخص می‌کند آیا انتقال از صفحه‌ای سیاه آغاز می‌شود (و سپس اسلاید جدید بر روی سیاه انتقال می‌یابد). نوشتنی **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | پیاده‌سازی باز کردن قفل عبارت C# lock(). به‌صورت مستقیم صدا بزنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [IOptionalBlackTransition](../ioptionalblacktransition/)
