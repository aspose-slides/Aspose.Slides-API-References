...
| Method | Description |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | با استفاده از semantics [Object.Equals](../../system/object/equals/) زبان C# اشیا را مقایسه می‌کند. |
...
| virtual [Orientation](../../aspose.slides/orientation/) [get_Direction](./get_direction/)() | جهت انتقال. خواندن [Orientation](../../aspose.slides/orientation/). |
...
| void [Lock](../../system/object/lock/)() | قفل‌کردن با بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual void [set_Direction](./set_direction/)([Orientation](../../aspose.slides/orientation/)) | جهت انتقال. نوشتن [Orientation](../../aspose.slides/orientation/). |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گشایی بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
