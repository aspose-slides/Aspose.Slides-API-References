...
| متد | توضیح |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | تعیین می‌کند که آیا دو نمونه [TransitionValueBase](../transitionvaluebase/) برابر هستند. |
...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | جهت انتقال. خواندن [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | شکل بصری‌های مورد استفاده در طول انتقال را مشخص می‌کند. خواندن [TransitionPattern](../transitionpattern/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار داده شمارنده مرجع مرتبط با شیء را به‌دست می‌آورد. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | به‌عنوان تابع هش برای نوع خاصی عمل می‌کند که برای استفاده در الگوریتم‌های هش و ساختارهای داده‌ای مانند جدول هش مناسب است. |
...
| void [Lock](../../system/object/lock/)() | قفل کردن دستور C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع چیزی کپی نمی‌کند، فقط شیء جدید را مقداردهی می‌کند و امکان ساخت کپی کلاس‌های فرزند را می‌دهد. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور انتساب. در واقع چیزی کپی نمی‌کند، فقط شیء جدید را مقداردهی می‌کند و امکان ساخت کپی کلاس‌های فرزند را می‌دهد. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | شمارندهٔ مرجع مشترک را به‌وساط مقدار مشخص‌شده کاهش می‌دهد. |
| void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) override | جهت انتقال. نوشتن [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | شکل بصری‌های مورد استفاده در طول انتقال را مشخص می‌کند. نوشتن [TransitionPattern](../transitionpattern/). |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداشت دستور C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [IGlitterTransition](../iglittertransition/)
