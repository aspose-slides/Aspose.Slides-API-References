...
description: اثر انتقال اسلایدی ورودی-خروجی.
type: docs
weight: 131
url: /fa/aspose.slides.slideshow/iinouttransition/
---
## IInOutTransition کلاس

اثر انتقال اسلایدی ورودی-خروجی.
...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | جهت اثر انتقال. [TransitionInOutDirectionType](../transitioninoutdirectiontype/) را بخوانید. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | آپراتور تخصیص. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت نسخه کپی از زیرکلاس‌ها را فراهم می‌کند. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | جهت اثر انتقال. [TransitionInOutDirectionType](../transitioninoutdirectiontype/) را بنویسید. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام الگو را یک اشاره‌گر ضعیف (به‌جای مشترک) تنظیم می‌کند. امکان تعویض اشاره‌گرها در محفظه‌ها به حالت ضعیف را فراهم می‌کند. |
