...
description: کلاس پایه برای اثرات انتقال اسلاید.
type: docs
weight: 430
...
کلاس پایه برای اثرات انتقال اسلاید.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | تعیین می‌کند که آیا دو نمونه [TransitionValueBase](./) برابر هستند. |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | به عنوان یک تابع هش برای یک نوع خاص عمل می‌کند و برای استفاده در الگوریتم‌های هش و ساختارهای داده‌ای مانند جدول هش مناسب است. |
...
| void [Lock](../../system/object/lock/)() | عملکرد قفل‌گذاری دستور lock() در C# را پیاده‌سازی می‌کند. به‌طور مستقیم فراخوانی شود یا از شیء مراقبت [LockContext](../../system/lockcontext/) استفاده شود. |
...
| void [Unlock](../../system/object/unlock/)() | عملکرد آزادسازی قفل در دستور lock() در C# را پیاده‌سازی می‌کند. به‌طور مستقیم فراخوانی شود یا از شیء مراقبت [LockContext](../../system/lockcontext/) استفاده شود. |
