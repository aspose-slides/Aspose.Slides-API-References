...
description: افکت انتقال اسلاید را آشکار می‌کند.
type: docs
weight: 209
url: /fa/aspose.slides.slideshow/irevealtransition/
---
## IRevealTransition کلاس
...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | جهت انتقال. [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) را بخوانید. |
| virtual **bool** [get_ThroughBlack](./get_throughblack/)() | مشخص می‌کند که آیا انتقال از طریق سیاه محو می‌شود یا خیر. **bool** را بخوانید. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار داده شمارشگر مرجع مرتبط با شیء را دریافت می‌کند. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | معادل متد [Object.GetHashCode()](../../system/object/gethashcode/) در C#. امکان هش‌گذاری اشیاء سفارشی را فراهم می‌آورد. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری با استفاده از عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهدارنده [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | مقدار شیء از نوع مقدار را با nullptr به صورت مرجع مقایسه می‌کند. |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | جهت انتقال. [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) را بنویسید. |
| virtual void [set_ThroughBlack](./set_throughblack/)(**bool**) | مشخص می‌کند که آیا انتقال از طریق سیاه محو می‌شود یا خیر. **bool** را بنویسید. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام قالب را به اشاره‌گر ضعیف (به جای مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در محفظه‌ها به حالت ضعیف را فراهم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری را با استفاده از عبارت lock() در C# باز می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهدارنده [LockContext](../../system/lockcontext/) استفاده کنید. |
