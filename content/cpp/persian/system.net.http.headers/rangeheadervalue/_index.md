...
description: "نمایانگر مقدار هدر 'Range' است. اشیاء این کلاس باید فقط با استفاده از تابع System::MakeObject() ساخته شوند. هرگز نمونه‌ای از این نوع را روی پشته یا با استفاده از عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا نقص‌های ادعایی می‌شود. همیشه این کلاس را در یک اشاره‌گر System::SmartPtr بپیچید و از این اشاره‌گر برای انتقال به توابع به عنوان آرگومان استفاده کنید."
type: docs
weight: 248
url: /fa/system.net.http.headers/rangeheadervalue/
---
## RangeHeaderValue کلاس

نمایانگر مقدار هدر '[Range](../../system/range/)' است. اشیاء این کلاس باید فقط با استفاده از تابع [System::MakeObject()](../../system/makeobject/) ساخته شوند. هرگز نمونه‌ای از این نوع را روی پشته یا با استفاده از عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا نقص‌های ادعایی می‌شود. همیشه این کلاس را در یک اشاره‌گر [System::SmartPtr](../../system/smartptr/) بپیچید و از این اشاره‌گر برای انتقال به توابع به عنوان آرگومان استفاده کنید.
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::SharedPtr](../../system/sharedptr/)\<[RangeItemHeaderValue](../rangeitemheadervalue/)\>\>\> [get_Ranges](./get_ranges/)() | مجموعه‌ای از بازه‌ها را بر می‌گرداند. |
| [String](../../system/string/) [get_Unit](./get_unit/)() | یک واحد را دریافت می‌کند. |
...
| static **int32_t** [GetRangeLength](./getrangelength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | یک رشتهٔ داده‌شده را از ایندکس مشخص به نمونه‌ای از کلاس [RangeHeaderValue](./) تبدیل می‌کند. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[RangeHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | یک رشتهٔ داده‌شده را به نمونه‌ای از کلاس [RangeHeaderValue](./) تبدیل می‌کند. |
| [RangeHeaderValue](./rangeheadervalue/)() | یک نمونهٔ جدید می‌سازد. |
| [RangeHeaderValue](./rangeheadervalue/)([Nullable](../../system/nullable/)\<**int64_t**\>, [Nullable](../../system/nullable/)\<**int64_t**\>) | یک نمونهٔ جدید می‌سازد. |
...
| void [set_Unit](./set_unit/)([String](../../system/string/)) | یک واحد را تنظیم می‌کند. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان الگو nth را به یک اشاره‌گر ضعیف (به‌جای shared) تنظیم می‌کند. امکان تغییر اشاره‌گران در کانتینرها به حالت ضعیف را فراهم می‌کند. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[RangeHeaderValue](./)\>\&) | سعی می‌کند یک رشتهٔ داده‌شده را به نمونه‌ای از کلاس [RangeHeaderValue](./) تبدیل کند. |
