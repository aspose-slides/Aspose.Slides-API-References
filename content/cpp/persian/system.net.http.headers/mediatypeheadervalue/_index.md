...
description: "نمایشگر یک نوع MIME در مقدار هدر 'Content-Type'. اشیاء این کلاس باید فقط با استفاده از تابع System::MakeObject() تخصیص داده شوند. هرگز نمونه‌ای از این نوع را روی پشته یا با استفاده از عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا اشکالات ادعایی می‌شود. همیشه این کلاس را درون اشاره‌گر System::SmartPtr بپیچید و از این اشاره‌گر برای ارسال به توابع به عنوان آرگومان استفاده کنید."
type: docs
weight: 144
url: /fa/system.net.http.headers/mediatypeheadervalue/
---
## MediaTypeHeaderValue کلاس

نمایشگر یک نوع MIME در مقدار هدر 'Content-Type' است. اشیاء این کلاس باید تنها با استفاده از تابع [System::MakeObject()](../../system/makeobject/) تخصیص داده شوند. هرگز نمونه‌ای از این نوع را روی پشته یا با استفاده از عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا اشکالات ادعا می‌شود. همیشه این کلاس را درون اشاره‌گر [System::SmartPtr](../../system/smartptr/) بپیچید و از این اشاره‌گر برای ارسال به توابع به عنوان آرگومان استفاده کنید.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | اشیاء را با استفاده از semantics C# [Object.Equals](../../system/object/equals/) مقایسه می‌کند. |
...
| [String](../../system/string/) [get_CharSet](./get_charset/)() | یک مجموعه کاراکتر را دریافت می‌کند. |
| [String](../../system/string/) [get_MediaType](./get_mediatype/)() | مقدار هدر media-type را دریافت می‌کند. |
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::SharedPtr](../../system/sharedptr/)\<[NameValueHeaderValue](../namevalueheadervalue/)\>\>\> [get_Parameters](./get_parameters/)() | پارامترهای مقدار هدر media-type را برمی‌گرداند. |
...
| static **int32_t** [GetMediaTypeLength](./getmediatypelength/)([String](../../system/string/), **int32_t**, [HeaderFunc](../headerfunc/)\<[System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\>\>, [System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\>\&) | یک رشتهٔ داده‌شده را از اندیس مشخص به نمونه‌ای از کلاس [MediaTypeHeaderValue](./) تبدیل می‌کند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری بیان lock() C#. به‌صورت مستقیم صدا زده شود یا از شیء [LockContext](../../system/lockcontext/) استفاده شود. |
| [MediaTypeHeaderValue](./mediatypeheadervalue/)() | یک نمونهٔ جدید می‌سازد. |
| [MediaTypeHeaderValue](./mediatypeheadervalue/)([String](../../system/string/)) | یک نمونهٔ جدید می‌سازد. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | یک رشتهٔ داده‌شده را به نمونه‌ای از کلاس [MediaTypeHeaderValue](./) تبدیل می‌کند. |
...
| void [set_CharSet](./set_charset/)([String](../../system/string/)) | مجموعه کاراکتر را تنظیم می‌کند. |
| void [set_MediaType](./set_mediatype/)([String](../../system/string/)) | مقدار هدر media-type را تنظیم می‌کند. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام الگو را به اشاره‌گر ضعیف (به‌جای مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در کانتینرها به حالت ضعیف را فراهم می‌سازد. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\>\&) | سعی می‌کند یک رشتهٔ داده‌شده را به نمونه‌ای از کلاس [MediaTypeHeaderValue](./) تبدیل کند. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | ساختار typeof([System.Object](../../system/object/)) در C# را پیاده‌سازی می‌کند. |
| void [Unlock](../../system/object/unlock/)() | اجرای بازکردن قفل بیان lock() C#. به‌صورت مستقیم صدا زده شود یا از شیء [LockContext](../../system/lockcontext/) استفاده شود. |
