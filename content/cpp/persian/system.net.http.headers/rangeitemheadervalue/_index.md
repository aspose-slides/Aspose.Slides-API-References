...
description: "نمایانگر یک بازه از بایت‌ها در مقدار هدر 'Range' است. اشیاء این کلاس باید فقط با استفاده از تابع System::MakeObject() تخصیص داده شوند. هرگز نمونه‌ای از این نوع را روی پشته یا با استفاده از عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا خطاهای تأیید می‌شود. همیشه این کلاس را در یک اشاره‌گر System::SmartPtr بپیچید و از این اشاره‌گر برای انتقال به توابع به عنوان آرگومان استفاده کنید."
type: docs
weight: 261
url: /fa/system.net.http.headers/rangeitemheadervalue/
---
## RangeItemHeaderValue کلاس

نمایانگر بازه‌ای از بایت‌ها در مقدار هدر '[Range](../../system/range/)' است. اشیاء این کلاس باید فقط با استفاده از تابع [System::MakeObject()](../../system/makeobject/) تخصیص داده شوند. هرگز نمونه‌ای از این نوع را روی پشته یا با استفاده از عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا خطاهای تأیید می‌شود. همیشه این کلاس را در یک اشاره‌گر [System::SmartPtr](../../system/smartptr/) بپیچید و از این اشاره‌گر برای انتقال آن به توابع به عنوان آرگومان استفاده کنید.
...
| متد | توضیح |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | اشیاء را با استفاده از معنابخشی C# [Object.Equals](../../system/object/equals/) مقایسه می‌کند. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | اشیاء را با استفاده از معنابخشی C# [Object.Equals](../../system/object/equals/) مقایسه می‌کند. |
...
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_From](./get_from/)() | موقعیتی را برمی‌گرداند که ارسال داده باید از آن آغاز شود. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_To](./get_to/)() | موقعیتی را برمی‌گرداند که ارسال داده باید در آن متوقف شود. |
...
| static **int32_t** [GetRangeItemLength](./getrangeitemlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[RangeItemHeaderValue](./)\>\&) | یک رشتهٔ پاس‌داده‌شده را از اندیس مشخص به یک نمونه از کلاس [RangeItemHeaderValue](./) تبدیل می‌کند. |
| static **int32_t** [GetRangeItemListLength](./getrangeitemlistlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::SharedPtr](../../system/sharedptr/)\<[RangeItemHeaderValue](./)\>\>\>) | یک رشتهٔ پاس‌داده‌شده را از موقعیت مشخص به مجموعه‌ای از نمونه‌های کلاس RangeItemHeaderValue تبدیل می‌کند. |
...
| void [Lock](../../system/object/lock/)() | قفل‌بندی عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء sentry [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [RangeItemHeaderValue](./rangeitemheadervalue/)([Nullable](../../system/nullable/)\<**int64_t**\>, [Nullable](../../system/nullable/)\<**int64_t**\>) | یک نمونهٔ جدید را می‌سازد. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | اشیاء را بر основе مرجع مقایسه می‌کند. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | اشیاء را بر основе مرجع مقایسه می‌کند. |
