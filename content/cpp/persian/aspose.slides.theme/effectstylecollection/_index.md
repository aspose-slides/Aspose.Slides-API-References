...
description: نمایندهٔ مجموعه‌ای از سبک‌های اثر.
type: docs
weight: 66
...
نمایندهٔ مجموعه‌ای از سبک‌های افکت.
...
| متد | توضیح |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() | یک iterat‌ر که به اولین عنصر (در صورت وجود) مجموعه اشاره می‌کند را برمی‌گرداند. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | یک iterat‌ر که به اولین عنصر (در صورت وجود) نمونهٔ دارای ویژگی const مجموعه اشاره می‌کند را برمی‌گرداند. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | یک iterat‌ر که به اولین عنصر دارای ویژگی const (در صورت وجود) مجموعه اشاره می‌کند را برمی‌گرداند. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | یک iterat‌ر که درست پس از آخرین عنصر دارای ویژگی const (در صورت وجود) مجموعه اشاره می‌کند را برمی‌گرداند. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\>\>, **int32_t**) override | تمام عناصر مجموعه را به آرایهٔ مشخص‌شده کپی می‌کند. |
| [iterator](./iterator/) [end](./end/)() | یک iterat‌ر که درست پس از آخرین عنصر (در صورت وجود) مجموعه اشاره می‌کند را برمی‌گرداند. |
| [const_iterator](./const_iterator/) [end](./end/)() const | یک iterat‌ر که درست پس از آخرین عنصر (در صورت وجود) نمونهٔ دارای ویژگی const مجموعه اشاره می‌کند را برمی‌گرداند. |
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | اشیا را از نوع مرجع به سبک C# مقایسه می‌کند. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | اشیا را از نوع مقدار به سبک C# مقایسه می‌کند. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسهٔ نقاط شناور به سبک C# را شبیه‌سازی می‌کند؛ در این حالت دو NaN برابر درنظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر هیچ مقداری نیست، حتی NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسهٔ نقاط شناور به سبک C# را شبیه‌سازی می‌کند؛ در این حالت دو NaN برابر درنظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر هیچ مقداری نیست، حتی NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| **int32_t** [get_Count](./get_count/)() override | تعداد عناصری در مجموعه را برمی‌گرداند. فقط خواندنی **int32_t**, فقط خواندنی **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | مقداری را برمی‌گرداند که نشان می‌دهد دسترسی به مجموعه همگام (thread-safe) است یا خیر. فقط خواندنی **bool**. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار شمارندهٔ مرجع مرتبط با شیء را برمی‌گیرد. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\>\>\> [GetEnumerator](./getenumerator/)() override | یک enumerator که از طریق مجموعه پیمایش می‌کند را برمی‌گرداند. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\> [idx_get](./idx_get/)(**int32_t**) override | عنصری در موقعیت مشخص‌شده را برمی‌گرداند. فقط خواندنی [EffectStyle](../effectstyle/). |
...
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | یک تابع انباشتگر را بر روی دنباله اعمال می‌کند. |
| **bool** [LINQ_All](../../system.collections.generic/ienumerable/linq_all/)(std::function\<**bool**(T)>) | تعیین می‌کند که آیا همهٔ عناصر یک دنباله شرطی را برآورده می‌کنند یا نه. |
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | تعیین می‌کند که آیا دنباله حاوی هر عنصر است یا خیر. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | میانگین مقادیر یک دنباله را که با اعمال یک تابع تبدیل بر هر عنصر ورودی به‌دست می‌آید، محاسبه می‌کند. |
...
| **bool** [LINQ_Contains](../../system.collections.generic/ienumerable/linq_contains/)(T) | تعیین می‌کند که آیا دنباله شامل مقدار مشخص‌شده‌ای است یا نه. |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | عنصری در شاخص مشخص‌شدهٔ یک دنباله را برمی‌گرداند. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | عنصری در شاخص مشخص‌شدهٔ یک دنباله را برمی‌گرداند. |
...
| void [Lock](../../system/object/lock/)() | قفل‌کردن بیانیهٔ lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)() | شیء را ایجاد می‌کند. همهٔ ساختارهای داخلی را مقداردهی اولیه می‌کند. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع هیچ‌چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی می‌کند و امکان ساختن کپی از کلاس‌های مشتق را فراهم می‌سازد. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور انتساب. در واقع هیچ‌چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی می‌کند و امکان ساختن کپی از کلاس‌های مشتق را فراهم می‌سازد. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | یک شیء نوع مقدار را با nullptr به‌صورت مرجع مقایسه می‌کند. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | آرگومان nام تمپلت را به یک اشاره‌گر ضعیف (به‌جای shared) تنظیم می‌کند. امکان تغییر اشاره‌گرها در کانتینرها به حالت weak را می‌دهد. |
| int [SharedCount](../../system/object/sharedcount/)() const | مقدار فعلی شمارندهٔ مرجع اشتراکی را برمی‌گیرد. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری بیانیهٔ lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | یک iterat‌ر که به اولین عنصر (در صورت وجود) نمونهٔ دارای ویژگی const مجموعه اشاره می‌کند را برمی‌گیرد. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | یک iterat‌ر که به اولین عنصر (در صورت وجود) مجموعه اشاره می‌کند را برمی‌گیرد. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | یک iterat‌ر که درست پس از آخرین عنصر (در صورت وجود) نمونهٔ دارای ویژگی const مجموعه اشاره می‌کند را برمی‌گیرد. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | یک iterat‌ر که درست پس از آخرین عنصر (در صورت وجود) مجموعه اشاره می‌کند را برمی‌گیرد. |
...
| تعریف نوع | توضیح |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | نوع مجموعه‌ای که انواع iterat‌ر آن به‌عنوان انواع iterat‌ر در مجموعهٔ جاری استفاده می‌شود. |
| [iterator](./iterator/) | نوع iterat‌ر. |
| [const_iterator](./const_iterator/) | نوع iterat‌ر ثابت. |
...
* کلاس [IEffectStyleCollection](../ieffectstylecollection/)
