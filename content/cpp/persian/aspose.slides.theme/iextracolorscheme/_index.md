...
description: یک طرح رنگی اضافی را نشان می‌دهد که می‌تواند به یک اسلاید اختصاص داده شود.
type: docs
weight: 222
url: /fa/aspose.slides.theme/iextracolorscheme/
---
## IExtraColorScheme کلاس

نمایش یک طرح رنگی اضافی که می‌تواند به یک اسلاید اختصاص داده شود.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، حتی با این حال طبق IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، حتی با این حال طبق IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نیست. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() | یک طرح رنگی را بازمی‌گرداند. فقط‌خواندنی [IColorScheme](../icolorscheme/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | نام این طرح را بازمی‌گرداند. فقط‌خواندنی [System::String](../../system/string/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع هیچ چیز را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت نسخهٔ کپی از زیرکلاس‌ها را فراهم می‌کند. |
