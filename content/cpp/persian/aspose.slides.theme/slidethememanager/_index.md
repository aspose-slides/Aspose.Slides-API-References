...
description: دسترسی به تم اسلاید بازنویسی‌شده را فراهم می‌کند.
type: docs
weight: 560
...
دسترسی به تم اسلاید که بازنویسی شده است را فراهم می‌کند.
...
| متد | توضیح |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | طرح رنگی اضافی را بر یک اسلاید اعمال می‌کند. |
...
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | اشیاء را با استفاده از منطق [Object.Equals](../../system/object/equals/) C# مقایسه می‌کند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل کردن با عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر اختصاصی. در واقع هیچ‌چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی از زیرکلاس‌ها را فراهم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای رفع قفل با عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
