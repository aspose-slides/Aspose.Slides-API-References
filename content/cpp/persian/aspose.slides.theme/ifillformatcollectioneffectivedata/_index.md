...
description: شیء غیرقابل تغییر که یک مجموعهٔ فقط-خواندنی از فرمت‌های پر کردن مؤثر را نشان می‌دهد.
type: docs
weight: 261
url: /fa/aspose.slides.theme/ifillformatcollectioneffectivedata/
---
## IFillFormatCollectionEffectiveData کلاس

شیء غیرقابل تغییر که یک مجموعهٔ فقط-خواندنی از فرمت‌های پر کردن مؤثر را نشان می‌دهد.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Gets the element at the specified index. Read-only [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/). |
