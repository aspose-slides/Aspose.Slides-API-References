...
description: دسترسی به قالب اصلی ارائه را فراهم می‌کند.
type: docs
weight: 521
...
دسترسی به قالب اصلی ارائه را فراهم می‌کند.
...
| Method | Description |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | طرح رنگی اضافی را بر روی یک اسلاید اعمال می‌کند. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | شیء قالب را برمی‌گرداند. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | شیءها را با استفاده از معناشناسی C# [Object.Equals](../../system/object/equals/) مقایسه می‌کند. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه‌العائمة به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، اگرچه طبق IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه‌العائمة به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، اگرچه طبق IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نیست. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | تعیین می‌کند که آیا [OverrideTheme](../overridetheme/) قالب مؤثر به ارث‌برده را ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) بازنویسی می‌کند یا خیر. مقدار **bool** را بخوانید. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | شیء قالب بازنویسی‌شده را برمی‌گرداند. [IMasterTheme](../imastertheme/) را بخوانید. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌کردن با عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع هیچ چیز را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی از زیرکلاس‌ها را فراهم می‌کند. |
...
| void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) override | تعیین می‌کند که آیا [OverrideTheme](../overridetheme/) قالب مؤثر به ارث‌برده را ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) بازنویسی می‌کند یا خیر. مقدار **bool** را بنویسید. |
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) override | شیء قالب بازنویسی‌شده را برمی‌گرداند. [IMasterTheme](../imastertheme/) را بنویسید. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای بازقفل‌کردن با عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [IMasterThemeManager](../imasterthememanager/)
