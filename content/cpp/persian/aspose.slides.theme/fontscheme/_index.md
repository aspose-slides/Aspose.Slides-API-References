...
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() override | مجموعه فونت‌ها را برای بخش \"heading\" اسلاید برمی‌گرداند. فقط‌خواندنی [IFonts](../../aspose.slides/ifonts/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() override | مجموعه فونت‌ها را برای بخش \"body\" اسلاید برمی‌گرداند. فقط‌خواندنی [IFonts](../../aspose.slides/ifonts/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | نام طرح فونت را برمی‌گرداند. خوان [System::String](../../system/string/). |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | نام طرح فونت را برمی‌گرداند. نوشتن [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام الگو را به یک اشاره‌گر ضعیف (به‌جای مشترک) تنظیم می‌کند. امکان سوئیچ کردن اشاره‌گرها در کانتینرها به حالت ضعیف را فراهم می‌آورد. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گشایی با استفاده از عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [IFontScheme](../ifontscheme/)
* کلاس [IDOMObject](../../aspose.slides/idomobject/)
* فضا‌نام [Aspose::Slides::Theme](../)
