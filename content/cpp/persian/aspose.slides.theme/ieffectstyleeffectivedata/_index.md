...
description: شیء غیرقابل تغییر که خصوصیات مؤثر سبک اثر را شامل می‌شود.
type: docs
weight: 209
url: /fa/aspose.slides.theme/ieffectstyleeffectivedata/
---
## IEffectStyleEffectiveData کلاس

شیء غیرقابل تغییر که خصوصیات مؤثر سبک اثر را شامل می‌شود.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormatEffectiveData](../../aspose.slides/ieffectformateffectivedata/)\> [get_EffectFormat](./get_effectformat/)() | یک فرمت اثر را باز می‌گرداند. فقط خواندنی [IEffectFormatEffectiveData](../../aspose.slides/ieffectformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormatEffectiveData](../../aspose.slides/ithreedformateffectivedata/)\> [get_ThreeDFormat](./get_threedformat/)() | یک فرمت سه‌بعدی را باز می‌گرداند. فقط خواندنی [IThreeDFormatEffectiveData](../../aspose.slides/ithreedformateffectivedata/). |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری دستور lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده شود. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | در مقایسهٔ مرجع، شیء نوع مقدار را با nullptr مقایسه می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری دستور lock() در C# را باز می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده شود. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | شمارنده مرجع ضعیف را کاهش می‌دهد. نباید به‌صورت مستقیم فراخوانی شود؛ در عطف از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
