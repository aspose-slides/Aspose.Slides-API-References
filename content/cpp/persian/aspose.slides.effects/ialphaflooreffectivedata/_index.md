...
description: شیء غیرقابل تغییر که نمایانگر اثر Alpha Floor است. مقادیر Alpha (شفافیت) کمتر از 100٪ به صفر تغییر می‌یابند. به عبارت دیگر، هر چیزی که به‌طور جزئی شفاف باشد، کاملاً شفاف می‌شود.
type: docs
weight: 300
url: /fa/aspose.slides.effects/ialphaflooreffectivedata/
---
## IAlphaFloorEffectiveData کلاس

شیء غیرقابل تغییر که نمایانگر اثر Alpha Floor است. مقادیر Alpha (شفافیت) کمتر از 100٪ به صفر تغییر می‌یابند. به عبارت دیگر، هر چیزی که به‌طور جزئی شفاف باشد، کاملاً شفاف می‌شود.
...
| void [Lock](../../system/object/lock/)() | اجرای قفل کردن statement lock() در C# را پیاده‌سازی می‌کند. مستقیم صدا بزنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل متد C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). امکان کلون کردن انواع سفارشی را فراهم می‌کند. |
|  [Object](../../system/object/object/)() | شیء را ایجاد می‌کند. تمام ساختارهای داده داخلی را مقداردهی اولیه می‌کند. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن زیرکلاس‌ها به‌صورت کپی را فراهم می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر انتساب. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن زیرکلاس‌ها به‌صورت کپی را فراهم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای باز کردن قفل statement lock() در C# را پیاده‌سازی می‌کند. مستقیم صدا بزنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
