...
description: نمایانگر اثر Glow است که در آن یک حاشیه رنگی تار شده در اطراف لبه‌های شیء اضافه می‌شود.
type: docs
weight: 196
...
| متد | توضیح |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | تعیین می‌کند آیا [Glow](./) مشخص شده برابر با [Glow](./) فعلی است. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | قالب رنگ. فقط-خواندنی [IColorFormat](../../aspose.slides/icolorformat/). |
...
| **double** [get_Radius](./get_radius/)() override | شعاع. خواند **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGlowEffectiveData](../igloweffectivedata/)\> [GetEffective](./geteffective/)() override | داده‌های مؤثر اثر [Glow](./) را با به‌کارگیری وراثت دریافت می‌کند. |
...
| void [Lock](../../system/object/lock/)() | پیاده‌سازی قفل‌گذاری عبارت lock() در C#. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده‌ی کپی. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن کپی از زیرکلاس‌ها را فراهم می‌آورد. |
...
| void [set_Radius](./set_radius/)(**double**) override | شعاع. نوشتن **double**. |
...
| void [Unlock](../../system/object/unlock/)() | پیاده‌سازی بازقفل‌گذاری عبارت lock() در C#. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
