...
description: نمایش‌دهنده یک اثر Tint است. مقادیر رنگ اثر را به سمت یا از سمت hue به مقدار مشخص‌شده جابه‌جا می‌کند.
type: docs
weight: 1093
...
نمایش‌دهنده یک اثر [Tint](./) است. مقادیر رنگ اثر را به سمت/از سمت هیو به مقدار مشخص‌شده جابه‌جا می‌کند.
...
| متد | توضیح |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | تعیین می‌کند که آیا [Tint](./) مشخص‌شده برابر با [Tint](./) جاری است. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | داده اثر [Tint](./) مؤثر را با به‌کارگیری ارث‌بری دریافت می‌کند. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل متد [Object.MemberwiseClone()](../../system/object/memberwiseclone/) در C#. امکان تکثیر انواع سفارشی را فعال می‌کند. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده ارجاع مشترک را کاهش داده و برمی‌گرداند. نباید به‌طور مستقیم فراخوانی شود؛ به‌جای آن از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری بیان lock() در C# را باز می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده شود. |
