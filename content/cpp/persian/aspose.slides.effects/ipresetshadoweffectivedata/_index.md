...
description: شیء غیرقابل تغییر که یک اثر سایهٔ پیش‌تنظیم شده را نشان می‌دهد.
type: docs
weight: 924
...
شیء غیرقابل تغییر که یک اثر سایهٔ پیش‌تنظیم شده را نشان می‌دهد.
...
| virtual **float** [get_Direction](./get_direction/)() | جهت سایه. فقط-خواندنی **float**. |
| virtual **double** [get_Distance](./get_distance/)() | فاصلهٔ سایه. فقط-خواندنی **double**. |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | پیش‌تنظیم. فقط-خواندنی [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | رنگ سایه. فقط-خواندنی [System::Drawing::Color](../../system.drawing/color/). |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری دستور C# lock() را پیاده‌سازی می‌کند. مستقیماً صدا بزنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن زیرکلاس‌ها با کپی ساز را فراهم می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور انتساب. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن زیرکلاس‌ها با کپی ساز را فراهم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای باز کردن قفل دستور C# lock() را پیاده‌سازی می‌کند. مستقیماً صدا بزنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
