...
description: یک اثر Alpha Inverse را نشان می‌دهد. مقادیر Alpha (شفافیت) با کم کردن از 100٪ معکوس می‌شوند.
type: docs
weight: 40
...
یک اثر Alpha Inverse را نشان می‌دهد. مقادیر Alpha (شفافیت) با کم کردن از 100٪ معکوس می‌شوند.
...
| متد | توضیح |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | تعیین می‌کند آیا [AlphaInverse](./) مشخص‌شده برابر با [AlphaInverse](./) فعلی است. |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../../aspose.slides/idomobject/)\> [get_Parent_Immediate](../../aspose.slides/idomobject/get_parent_immediate/)() | شی Parent_Immediate را بازمی‌گرداند. فقط-خواندنی [IDOMObject](../../aspose.slides/idomobject/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverseEffectiveData](../ialphainverseeffectivedata/)\> [GetEffective](./geteffective/)() override | داده‌های مؤثر اثر Alpha Inverse را با اعمال وراثت دریافت می‌کند. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | مشابه متد [Object.MemberwiseClone()](../../system/object/memberwiseclone/) در C#. امکان تکثیر انواع سفارشی را فراهم می‌کند. |
...
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | شیءها را با مرجع مقایسه می‌کند. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | شیءها را با مرجع مقایسه می‌کند. |
...
* کلاس [IAlphaInverse](../ialphainverse/)
