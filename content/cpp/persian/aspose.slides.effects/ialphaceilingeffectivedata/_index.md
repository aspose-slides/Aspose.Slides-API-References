...
description: شیء غیرقابل تغییر که نمایانگر اثر سقف آلفا است. مقادیر آلفا (شفافیت) بزرگتر از صفر به ۱۰۰٪ تغییر می‌یابند. به عبارت دیگر، هر چیزی که جزئی شفاف باشد، به طور کامل شفاف می‌شود.
type: docs
weight: 274
url: /fa/aspose.slides.effects/ialphaceilingeffectivedata/
---
## IAlphaCeilingEffectiveData کلاس

شیء غیرقابل تغییر که نمایانگر اثر سقف آلفا است. مقادیر آلفا (شفافیت) بزرگتر از صفر به ۱۰۰٪ تغییر می‌یابند. به عبارت دیگر، هر چیزی که به‌جزئی شفاف باشد، به طور کامل شفاف می‌شود.
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل روش C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). امکان شبیه‌سازی (کپی) انواع سفارشی را فراهم می‌کند. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | مقدار نوع مرجع را با nullptr مقایسه می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای رفع قفل بیان lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء sentry [LockContext](../../system/lockcontext/) استفاده کنید. |
