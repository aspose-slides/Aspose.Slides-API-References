...
description: شیء غیرقابل تغییر که نمایانگر یک اثر Fill Overlay است. یک Fill Overlay می‌تواند برای تعیین یک پرکردن اضافی برای یک شیء استفاده شود و دو پرکردن را با هم ترکیب کند.
type: docs
weight: 625
url: /fa/aspose.slides.effects/ifilloverlayeffectivedata/
---
## IFillOverlayEffectiveData کلاس

شیء غیرقابل تغییر که نمایانگر یک افکت Fill Overlay است. یک Fill Overlay می‌تواند برای تعیین یک پرکردن اضافه برای یک شیء استفاده شود و دو پرکردن را با هم ترکیب کند.
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode. فقط-خواندنی [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | قالب پرکردن. فقط-خواندنی [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/). |
...
| void [Lock](../../system/object/lock/)() | پیاده‌سازی قفل‌گذاری دستور lock() در C#. به‌صورت مستقیم فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع اشتراکی را کاهش می‌دهد و مقدار آن را بر می‌گرداند. نباید به‌صورت مستقیم فراخوانی شود؛ در عوض، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | پیاده‌سازی بازقفل‌گذاری دستور lock() در C#. به‌صورت مستقیم فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
