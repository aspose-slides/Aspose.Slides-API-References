...
description: یک اثر Blur را که بر تمام شکل اعمال می‌شود، از جمله پرشدگی آن، نمایش می‌دهد. تمام کانال‌های رنگ، از جمله آلفا، تحت تأثیر قرار می‌گیرند.
type: docs
weight: 456
...
نمایشگر یک اثر [Blur](../blur/) که بر تمام شکل اعمال می‌شود، از جمله پرشدگی آن. تمام کانال‌های رنگ، از جمله آلفا، تحت تأثیر قرار می‌گیرند.
...
| virtual **bool** [get_Grow](./get_grow/)() | تعیین می‌کند آیا مرزهای شی باید به دلیل تاری بزرگ شوند یا خیر. مقدار true نشان می‌دهد مرزها بزرگ می‌شوند در حالی که false نشان می‌دهد نه. خواندن **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | شعاع تاری را برمی‌گرداند. خواندن **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار داده شمارنده مرجع مرتبط با شی را دریافت می‌کند. |
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | داده مؤثر را که به ارث‌بری اعمال شده است دریافت می‌کند. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده کپی. واقعاً هیچ چیزی را کپی نمی‌کند، فقط شی جدید را مقداردهی اولیه می‌کند و امکان ساخت کلاس‌های فرزند با کپی را فراهم می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور تخصیص. واقعاً هیچ چیزی را کپی نمی‌کند، فقط شی جدید را مقداردهی اولیه می‌کند و امکان ساخت کلاس‌های فرزند با کپی را فراهم می‌کند. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | مقابله مرجع‌ای شی نوع مقدار با nullptr. |
...
| virtual void [set_Grow](./set_grow/)(**bool**) | تعیین می‌کند آیا مرزهای شی باید به دلیل تاری بزرگ شوند یا خیر. مقدار true نشان می‌دهد مرزها بزرگ می‌شوند در حالی که false نشان می‌دهد نه. نوشتن **bool**. |
| virtual void [set_Radius](./set_radius/)(**double**) | شعاع تاری را تنظیم می‌کند. نوشتن **double**. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری معکوس (unlock) بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
