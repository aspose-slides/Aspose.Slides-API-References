...
description: یک افکت دو سطح (سیاه/سفید) را نشان می‌دهد. رنگ‌های ورودی که روشنایی آن‌ها کمتر از مقدار آستانه مشخص شده باشد به رنگ سیاه تغییر می‌کنند. رنگ‌های ورودی که روشنایی آن‌ها برابر یا بیشتر از مقدار مشخص شده باشد به رنگ سفید تنظیم می‌شوند. مقادیر افکت آلفا تحت این افکت تغییر نمی‌کنند.
type: docs
weight: 92
...
نمایش یک افکت دو سطح (سیاه/سفید). رنگ‌های ورودی که روشنایی آن‌ها کمتر از مقدار آستانه مشخص شده است به رنگ سیاه تغییر می‌کنند. رنگ‌های ورودی که روشنایی آن‌ها برابر یا بیشتر از مقدار مشخص شده است به رنگ سفید تنظیم می‌شوند. مقادیر اثر آلفا تحت این افکت تغییر نمی‌کنند.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | تعیین می‌کند آیا [BiLevel](./) مشخص‌شده برابر با [BiLevel](./) جاری است یا خیر. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevelEffectiveData](../ibileveleffectivedata/)\> [GetEffective](./geteffective/)() override | داده‌های مؤثر افکت Bi-Level را با به‌کارگیری وراثت دریافت می‌کند. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری با عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | آبجکت نوع مقدار را با nullptr از طریق ارجاع مقایسه می‌کند. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان تمپلیت nام را به یک اشاره‌گر ضعیف (به‌جای مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در کانتینرها به حالت ضعیف را فراهم می‌آورد. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری معکوس با عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
