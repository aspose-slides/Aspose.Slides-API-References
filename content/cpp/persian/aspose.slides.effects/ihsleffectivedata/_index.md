...
description: یک اثر Hue/Saturation/Luminance را نمایش می‌دهد. هیو، اشباع و روشنایی می‌توانند هر کدام نسبت به مقدار فعلی خود تنظیم شوند.
type: docs
weight: 703
url: /fa/aspose.slides.effects/ihsleffectivedata/
---
## IHSLEffectiveData کلاس

یک اثر Hue/Saturation/Luminance را نمایش می‌دهد. هیو، اشباع و روشنایی می‌توانند به‌صورت جداگانه نسبت به مقدار فعلی‌شان تنظیم شوند.
...
| virtual **float** [get_Hue](./get_hue/)() | درصد هیو را برمی‌گرداند. فقط-خواندنی **float**. |
| virtual **float** [get_Luminance](./get_luminance/)() | درصد روشنایی را برمی‌گرداند. فقط-خواندنی **float**. |
| virtual **float** [get_Saturation](./get_saturation/)() | درصد اشباع را برمی‌گرداند. فقط-خواندنی **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌نماید و امکان ساخت زیرکلاس‌ها از طریق کپی را فراهم می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر انتساب. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌نماید و امکان ساخت زیرکلاس‌ها از طریق کپی را فراهم می‌کند. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | شمارنده مرجع اشتراکی را افزایش می‌دهد. نباید مستقیماً فراخوانی شود؛ به‌جای آن از هوشمند-نشانگرها یا ThisProtector استفاده کنید. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع اشتراکی را کاهش داده و برمی‌گرداند. نباید مستقیماً فراخوانی شود؛ به‌جای آن از هوشمند-نشانگرها یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای بازقفل‌کردن بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | شمارنده مرجع ضعیف را افزایش می‌دهد. نباید مستقیماً فراخوانی شود؛ به‌جای آن از هوشمند-نشانگرها یا ThisProtector استفاده کنید. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | شمارنده مرجع ضعیف را کاهش می‌دهد. نباید مستقیماً فراخوانی شود؛ به‌جای آن از هوشمند-نشانگرها یا ThisProtector استفاده کنید. |
