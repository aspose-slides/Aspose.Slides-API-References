...
description: نمایانگر یک اثر Alpha Modulate Fixed است. مقادیر آلفا (شفافیت) اثر با یک درصد ثابت ضرب می‌شوند.
type: docs
weight: 66
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | تعیین می‌کند که آیا [AlphaModulateFixed](./) مشخص شده برابر با [AlphaModulateFixed](./) جاری است یا خیر. |
...
| **float** [get_Amount](./get_amount/)() override | مقداری از اثر را به درصد باز می‌گرداند. خواندنی **float**. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../../aspose.slides/idomobject/)\> [get_Parent_Immediate](../../aspose.slides/idomobject/get_parent_immediate/)() | شیء Parent_Immediate را باز می‌گرداند. فقط-خواندنی [IDOMObject](../../aspose.slides/idomobject/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | دادهٔ مؤثر اثر Alpha Modulate Fixed را با اعمال وراثت دریافت می‌کند. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری با عبارت C# lock() را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نظارتی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [set_Amount](./set_amount/)(**float**) override | مقداری از اثر را به درصد باز می‌گرداند. نوشتنی **float**. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارندهٔ ارجاع مشترک را کاهش می‌دهد و مقدار آن را بر می‌گرداند. نباید مستقیماً فراخوانی شود؛ به‌جای آن از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری با عبارت C# lock() را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نظارتی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [IAlphaModulateFixed](../ialphamodulatefixed/)
