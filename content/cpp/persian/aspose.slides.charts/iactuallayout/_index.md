...
| virtual **float** [get_ActualHeight](./get_actualheight/)() | ارتفاع واقعی عنصر نمودار را مشخص می‌کند. قبل از آن، متد [IChart::ValidateChartLayout](../ichart/validatechartlayout/) را فراخوانی کنید تا مقادیر واقعی دریافت شوند. نوع **float** خوانده می‌شود. |
| virtual **float** [get_ActualWidth](./get_actualwidth/)() | عرض واقعی عنصر نمودار را مشخص می‌کند. قبل از آن، متد [IChart::ValidateChartLayout](../ichart/validatechartlayout/) را فراخوانی کنید تا مقادیر واقعی دریافت شوند. نوع **float** خوانده می‌شود. |
| virtual **float** [get_ActualX](./get_actualx/)() | موقعیت افقی واقعی (چپ) عنصر نمودار را نسبت به گوشهٔ بالا-چپ نمودار مشخص می‌کند. قبل از آن، متد [IChart::ValidateChartLayout](../ichart/validatechartlayout/) را فراخوانی کنید تا مقادیر واقعی دریافت شوند. نوع **float** خوانده می‌شود. |
| virtual **float** [get_ActualY](./get_actualy/)() | بالای واقعی عنصر نمودار را نسبت به گوشهٔ بالا-چپ نمودار مشخص می‌کند. قبل از آن، متد [IChart::ValidateChartLayout](../ichart/validatechartlayout/) را فراخوانی کنید تا مقادیر واقعی دریافت شوند. نوع **float** خوانده می‌شود. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری دستور lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهدارندهٔ [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)() | شیء را ایجاد می‌کند. همهٔ ساختارهای دادهٔ داخلی را مقداردهی اولیه می‌نماید. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری دستور lock() در C# را باز می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهدارندهٔ [LockContext](../../system/lockcontext/) استفاده کنید. |
