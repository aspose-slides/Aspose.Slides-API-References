...
description: نمایانگر برچسب دادهٔ سطوح نقطهٔ داده است. برای انواع سری‌های Treemap و Sunburst اعمال می‌شود. فقط خواندنی IDataLabel.
type: docs
weight: 14
url: /fa/aspose.slides.charts/ichartdatapointlevel/get_label/
---
## IChartDataPointLevel::get_Label() متد


نمایانگر برچسب دادهٔ سطح نقطهٔ داده است. برای انواع سری‌های Treemap و Sunburst اعمال می‌شود. فقط خواندنی [IDataLabel](../../idatalabel/).
