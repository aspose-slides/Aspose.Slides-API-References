...
description: قالب خطوط راهنما برای برچسب‌های داده را نشان می‌دهد. فقط خواندنی IChartLinesFormat.
type: docs
weight: 14
url: /fa/aspose.slides.charts/idatalabelcollection/get_leaderlinesformat/
---
## IDataLabelCollection::get_LeaderLinesFormat() متد
...
* کلاس [IChartLinesFormat](../../ichartlinesformat/)
* کلاس [IDataLabelCollection](../)
