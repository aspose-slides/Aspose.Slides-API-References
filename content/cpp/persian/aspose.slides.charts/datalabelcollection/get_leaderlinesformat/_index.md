...
description: قالب خطوط راهنمای برچسب‌های داده را نشان می‌دهد. فقط خواندنی IChartLinesFormat.
type: docs
weight: 66
url: /fa/aspose.slides.charts/datalabelcollection/get_leaderlinesformat/
---
## DataLabelCollection::get_LeaderLinesFormat() متد


نمایانگر قالب خطوط راهنمای برچسب‌های داده است. فقط خواندنی [IChartLinesFormat](../../ichartlinesformat/).
