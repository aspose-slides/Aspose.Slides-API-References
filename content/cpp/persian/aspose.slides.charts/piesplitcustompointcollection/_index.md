...
description: نمایانگر مجموعه‌ای از نقاط برای تقسیم نقطه در نمودار bar-of-pie یا pie-of-pie با تقسیم سفارشی.
type: docs
weight: 1314
...
نمایانگر مجموعه‌ای از نقاط برای تقسیم نقطه در نمودار bar-of-pie یا pie-of-pie با تقسیم سفارشی می‌باشد.
...
| متد | توضیحات |
| --- | --- |
| void [Add](./add/)(const **int32_t**\&) override | یک نقطه داده را بر اساس اندیس آن در مجموعه نقاط سری والد اضافه می‌کند. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | یک نقطه داده را به مجموعه اضافه می‌کند. |
| [iterator](./iterator/) [begin](./begin/)() | یک تکرارگر دریافت می‌کند که به اولین عنصر (در صورت وجود) مجموعه اشاره می‌کند. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | یک تکرارگر دریافت می‌کند که به اولین عنصر (در صورت وجود) نمونهٔ ثابت‌کردهٔ مجموعه اشاره می‌کند. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | یک تکرارگر دریافت می‌کند که به اولین عنصر ثابت‌کرده (در صورت وجود) مجموعه اشاره می‌کند. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | یک تکرارگر دریافت می‌کند که دقیقاً پس از آخرین عنصر ثابت‌کرده (در صورت وجود) مجموعه اشاره می‌کند. |
| void [Clear](./clear/)() override | تمام موارد را از [ICollection](../../system.collections.generic/icollection/) حذف می‌کند. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) const override | تعیین می‌کند که آیا [ICollection](../../system.collections.generic/icollection/) شامل مقدار خاصی است. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>, **int32_t**) override | عناصر [ICollection](../../system.collections.generic/icollection/) را به یک [System::Array](../../system/array/) کپی می‌کند، شروع از اندیس [System::Array](../../system/array/) خاص. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | تمام عناصر مجموعه را به عناصری از آرایه موجود کپی می‌کند. |
| [iterator](./iterator/) [end](./end/)() | یک تکرارگر دریافت می‌کند که دقیقاً پس از آخرین عنصر (در صورت وجود) مجموعه اشاره می‌کند. |
| [const_iterator](./const_iterator/) [end](./end/)() const | یک تکرارگر دریافت می‌کند که دقیقاً پس از آخرین عنصر (در صورت وجود) نمونهٔ ثابت‌کردهٔ مجموعه اشاره می‌کند. |
...
| **int32_t** [get_Count](./get_count/)() const override | تعداد نقاط دادهٔ نمودار را برمی‌گرداند. فقط خواندنی **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | مقداری دریافت می‌کند که نشان می‌دهد آیا [ICollection](../../system.collections.generic/icollection/) فقط خواندنی است. فقط خواندنی **bool**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() | مقداری برمی‌گرداند که نشان می‌دهد آیا دسترسی به مجموعه همزمان (امن برای چندنخی) است. فقط خواندنی **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | ریشهٔ همزمانی را برمی‌گرداند. فقط خواندنی [System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار دادهٔ شمارندهٔ مرجع مرتبط با شیء را دریافت می‌کند. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>\> [GetEnumerator](./getenumerator/)() override | یک enumerator که از مجموعه عبور می‌کند را بر می‌گرداند. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) override | نقطهٔ دادهٔ نمودار را برای اندیس مشخص شده برمی‌گرداند. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | تعیین می‌کند آیا یک دنباله شامل هر عنصر است. |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | متوسط یک دنبالهٔ مقادیر عددی را محاسبه می‌کند. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | متوسط یک دنبالهٔ مقادیری را که با فراخوانی یک تابع تبدیل بر هر عنصر دنبالهٔ ورودی به دست می‌آید، محاسبه می‌کند. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | تعداد عناصر دنباله که شرط مشخص‌شده را برآورده می‌شوند را برمی‌گرداند. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | اولین عنصر دنباله را یا یک مقدار پیش‌فرض اگر دنباله خالی باشد برمی‌گرداند. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | هر عنصر دنباله را پروژه می‌کند و دنباله‌های حاصل را در یک دنباله ترکیب می‌کند. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<Source, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\>\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | تعداد مشخصی از عناصر پیدرپی از ابتدا دنباله را نادیده می‌گیرد و باقیمانده را برمی‌گرداند. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | تعداد مشخصی از عناصر پیدرپی از ابتدا دنباله را برمی‌گرداند. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری با عبارت C# lock() را پیاده‌سازی می‌کند. به‌طور مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | نوع مقدار را با nullptr به صورت مرجع مقایسه می‌کند. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | تخصص [Object::ReferenceEquals](../../system/object/referenceequals/) برای مورد رشته و nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | تخصص [Object::ReferenceEquals](../../system/object/referenceequals/) برای مورد رشته‌ها. |
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | مورد را از مجموعه حذف می‌کند. |
| void [Remove](./remove/)(**int32_t**) override | مورد را از مجموعه بر اساس اندیس آن در مجموعه نقاط سری والد حذف می‌کند. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | تعداد شمارندهٔ مرجع مشترک را بر اساس مقدار مشخص کاهش می‌دهد. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری با عبارت C# lock() را باز می‌کند. به‌طور مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | یک تکرارگر دریافت می‌کند که به اولین عنصر (در صورت وجود) نمونهٔ ثابت‌کردهٔ مجموعه اشاره می‌کند. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | یک تکرارگر دریافت می‌کند که دقیقاً پس از آخرین عنصر (در صورت وجود) نمونهٔ ثابت‌کردهٔ مجموعه اشاره می‌کند. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | یک تکرارگر دریافت می‌کند که دقیقاً پس از آخرین عنصر (در صورت وجود) مجموعه اشاره می‌کند. |
...
| نوع تعریف | توضیحات |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | یک نوع مجموعه که نوع‌های تکرارگر آن به عنوان نوع‌های تکرارگر در مجموعهٔ فعلی استفاده می‌شود. |
...
* کلاس [IPieSplitCustomPointCollection](../ipiesplitcustompointcollection/)
