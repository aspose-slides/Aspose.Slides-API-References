...
description: خواص قالب خطوط شبکه را نشان می‌دهد.
type: docs
weight: 768
url: /fa/aspose.slides.charts/ichartlinesformat/
---
## IChartLinesFormat کلاس

خواص قالب خطوط شبکه را نشان می‌دهد.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_Effect](./get_effect/)() | اثرات مورد استفاده برای خط نمودار را برمی‌گرداند. فقط خواندنی [IEffectFormat](../../aspose.slides/ieffectformat/). |
...
| void [Lock](../../system/object/lock/)() | قفل‌کردن با عبارت lock() C# را پیاده‌سازی می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء نگهدار [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده کپی. در واقع چیزی را کپی نمی‌کند، فقط شی جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی از زیرکلاس‌ها را فراهم می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر انتساب. در واقع چیزی را کپی نمی‌کند، فقط شی جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی از زیرکلاس‌ها را فراهم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌کردن با عبارت lock() C# را باز می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء نگهدار [LockContext](../../system/lockcontext/) استفاده کنید. |
