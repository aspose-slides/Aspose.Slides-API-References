...
نمایانگر دیواره‌ها در نمودارهای 3بعدی است.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | مقدار پرکننده دیوار، خط، افکت، سبک‌های 3بعدی را برمی‌گرداند. فقط‌خواندنی [IFormat](../iformat/). |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | مقدار یا تنظیم نوع تصویر. فقط‌خواندنی [Charts::PictureType](../picturetype/). |
| **int32_t** [get_Thickness](./get_thickness/)() override | ضخامت دیوارها را به عنوان درصدی از بزرگ‌ترین بعد حجم نمودار برمی‌گرداند. فقط‌خواندنی **int32_t**. |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | مقدار یا تنظیم نوع تصویر. نوشتنی [Charts::PictureType](../picturetype/). |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | ضخامت دیوارها را به عنوان درصدی از بزرگ‌ترین بعد حجم نمودار تنظیم می‌کند. نوشتنی **int32_t**. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای رفع قفل با عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیم فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
