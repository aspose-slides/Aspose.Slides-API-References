...
description: خصوصیات جدول داده را نشان می‌دهد.
type: docs
weight: 989
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | سبک‌های خط، پرکردن و اثر یک شی را برمی‌گرداند. فقط‌خواندنی [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | درست اگر جدول دادهٔ نمودار دارای حاشیه‌های افقی سلول باشد. قابل‌خواندن **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | درست اگر جدول دادهٔ نمودار دارای حاشیه‌های کلی باشد. قابل‌خواندن **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | درست اگر جدول دادهٔ نمودار دارای حاشیه‌های عمودی سلول باشد. قابل‌خواندن **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | درست اگر کلید افسانهٔ برچسب داده قابل مشاهده باشد. قابل‌خواندن **bool**. |
...
| void [Lock](../../system/object/lock/)() | اجرا کنندهٔ قفل کردن عبارت lock() در C#. مستقیماً فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. واقعاً چیزی را کپی نمی‌کند، تنها شیء جدید را مقداردهی می‌کند و امکان ساختنسخهٔ کپی از زیرکلاس‌ها را فراهم می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر انتساب. واقعاً چیزی را کپی نمی‌کند، تنها شیء جدید را مقداردهی می‌کند و امکان ساختنسخهٔ کپی از زیرکلاس‌ها را فراهم می‌کند. |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | درست اگر جدول دادهٔ نمودار دارای حاشیه‌های افقی سلول باشد. قابل‌نوشتن **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | درست اگر جدول دادهٔ نمودار دارای حاشیه‌های کلی باشد. قابل‌نوشتن **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | درست اگر جدول دادهٔ نمودار دارای حاشیه‌های عمودی سلول باشد. قابل‌نوشتن **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | درست اگر کلید افسانهٔ برچسب داده قابل مشاهده باشد. قابل‌نوشتن **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان n'th قالب را به یک اشاره‌گر ضعیف (به‌جای مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در کانتینرها به حالت ضعیف را می‌دهد. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | اجرای سازندهٔ typeof([System.Object](../../system/object/)) در C#. |
| void [Unlock](../../system/object/unlock/)() | اجرای آزادسازی عبارت lock() در C#. مستقیماً فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
