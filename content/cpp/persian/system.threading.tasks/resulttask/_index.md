...
description: تخصصی از Task که پس از تکمیل مقدار نتیجه را برمی‌گرداند.
type: docs
weight: 40
url: /fa/system.threading.tasks/resulttask/
---
## ResultTask کلاس

یک تخصص [Task](../task/) که پس از تکمیل مقدار نتیجه را برمی‌گرداند.
...
نمایانگر یک عملیات ناهمزمان است که یک نتیجه تولید می‌کند، مشابه System.Threading.Tasks.Task<TResult> در .NET
