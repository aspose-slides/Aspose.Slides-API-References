...
description: وضعیت تکمیل یک حلقهٔ موازی را فراهم می‌کند.
type: docs
weight: 14
url: /fa/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult کلاس

وضعیت تکمیل یک حلقه [Parallel](../parallel/) را فراهم می‌کند.
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | مشخص می‌کند که آیا حلقه تا پایان اجرا شد یا خیر. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | پایین‌ترین ایندکس تکرار که در آن یک break رخ داده است را برمی‌گرداند. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار داده‌کش شمارنده مرجع مرتبط با شیء را برمی‌گرداند. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده کپی. در واقع هیچ چیز را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی از زیرکلاس‌ها را می‌دهد. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | یک [ParallelLoopResult](./) می‌سازد. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | شمارنده مرجع مشترک را افزایش می‌دهد. نباید به‌طور مستقیم فراخوانی شود؛ در عوض از پوینترهای هوشمند یا ThisProtector استفاده کنید. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع مشترک را کاهش داده و مقدار آن را برمی‌گرداند. نباید به‌طور مستقیم فراخوانی شود؛ در عوض از پوینترهای هوشمند یا ThisProtector استفاده کنید. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | شمارنده مرجع ضعیف را افزایش می‌دهد. نباید به‌طور مستقیم فراخوانی شود؛ در عوض از پوینترهای هوشمند یا ThisProtector استفاده کنید. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | شمارنده مرجع ضعیف را کاهش می‌دهد. نباید به‌طور مستقیم فراخوانی شود؛ در عوض از پوینترهای هوشمند یا ThisProtector استفاده کنید. |
| virtual  [~Object](../../system/object/~object/)() | شیء را از بین می‌برد. تمام ساختارهای داده داخلی را آزاد می‌کند. |
## ملاحظات

نتیجه یک عملیات حلقهٔ موازی را نشان می‌دهد، شامل این که آیا تکمیل شده است و اطلاعاتی دربارهٔ قطع‌ها.
