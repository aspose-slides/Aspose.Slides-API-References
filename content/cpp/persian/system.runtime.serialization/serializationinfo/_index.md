...
description: "مجموعه‌ای از فیلدهای نام‌دار را که نمایانگر شیء سریالیزه شده هستند نگه می‌دارد. پیاده‌سازی نشده. اشیاء این کلاس باید فقط با استفاده از تابع System::MakeObject() تخصیص داده شوند. هرگز نمونه‌ای از این نوع را روی پشته یا با استفاده از عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا خطاهای ادعا می‌شود. همیشه این کلاس را در یک اشاره‌گر System::SmartPtr بسته‌بندی کنید و از این اشاره‌گر برای عبور به توابع به عنوان آرگومان استفاده کنید."
type: docs
weight: 53
url: /fa/system.runtime.serialization/serializationinfo/
---
## کلاس SerializationInfo
...
| متد | توضیح |
| --- | --- |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, **float**) | مقدار **float** را می‌گذارد. پیاده‌سازی نشده. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, short) | مقدار short را می‌گذارد. پیاده‌سازی نشده. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, **bool**) | مقدار **bool** را می‌گذارد. پیاده‌سازی نشده. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | مقدار شیء را می‌گذارد. پیاده‌سازی نشده. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&, const [System::TypeInfo](../../system/typeinfo/)\&) | مقدار شیء را با نوع مشخص‌شده می‌گذارد. پیاده‌سازی نشده. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [GetValue](./getvalue/)(const [System::String](../../system/string/)\&, const [System::TypeInfo](../../system/typeinfo/)\&) | مقداری را از حافظه [SerializationInfo](./) دریافت می‌کند. پیاده‌سازی نشده. |
...
| void [Lock](../../system/object/lock/)() | قفل کردن بیان lock() C# را پیاده‌سازی می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء نظارتی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [SerializationInfo](./serializationinfo/)(const [System::TypeInfo](../../system/typeinfo/)\&, const [System::SharedPtr](../../system/sharedptr/)\<[IFormatterConverter](../iformatterconverter/)\>\&) | اطلاعات RTTI. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گشایی بیان lock() C# را پیاده‌سازی می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء نظارتی [LockContext](../../system/lockcontext/) استفاده کنید. |
