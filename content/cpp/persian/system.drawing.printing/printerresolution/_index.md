...
| int [get_X](./get_x/)() const | وضوح افقی را برمی‌گرداند. |
| int [get_Y](./get_y/)() const | وضوح عمودی را برمی‌گرداند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری بیان lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء حفاظتی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [set_X](./set_x/)(int) | وضوح افقی را تنظیم می‌کند. |
| void [set_Y](./set_y/)(int) | وضوح عمودی را تنظیم می‌کند. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام قالب را به یک اشاره‌گر ضعیف تنظیم می‌کند (به‌جای اشتراکی). امکان تغییر اشاره‌گرها در کانتینرها به حالت ضعیف را می‌دهد. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای آزادی بیان lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء حفاظتی [LockContext](../../system/lockcontext/) استفاده کنید. |
