...
description: نمایاندن جابجایی رنگ.
type: docs
weight: 222
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسهٔ نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند بر اساس IEC 60559:1989 NaN برابر با هیچ مقداری نیست، از جمله NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسهٔ نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند بر اساس IEC 60559:1989 NaN برابر با هیچ مقداری نیست، از جمله NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| virtual **float** [get_Value0](./get_value0/)() | اولین مقدار آفست را تعریف می‌کند. خواندن **float**. |
| virtual **float** [get_Value1](./get_value1/)() | دومین مقدار آفست را تعریف می‌کند. خواندن **float**. |
| virtual **float** [get_Value2](./get_value2/)() | سومین مقدار آفست را تعریف می‌کند. خواندن **float**. |
...
| void [Lock](../../system/object/lock/)() | اجرا کنندهٔ قفل‌گذاری دستور lock() در C#. به‌صورت مستقیم فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور تخصیص. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی برای زیرکلاس‌ها را فراهم می‌کند. |
...
| virtual void [set_Value0](./set_value0/)(**float**) | اولین مقدار آفست را تعریف می‌کند. نوشتن **float**. |
| virtual void [set_Value1](./set_value1/)(**float**) | دومین مقدار آفست را تعریف می‌کند. نوشتن **float**. |
| virtual void [set_Value2](./set_value2/)(**float**) | سومین مقدار آفست را تعریف می‌کند. نوشتن **float**. |
...
| void [Unlock](../../system/object/unlock/)() | اجرا کنندهٔ بازکردن قفل دستور lock() در C#. به‌صورت مستقیم فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
