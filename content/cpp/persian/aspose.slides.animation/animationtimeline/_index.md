...
description: نمایشگر زمان‌بندی انیمیشن.
type: docs
weight: 1
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) override | دنباله تعاملی را در اندیس مشخص شده برمی‌گرداند. این دنباله ممکن است فقط شامل اثرهای «کلیک روی شکل» باشد که شکل هدف مشخص شده را داشته باشد. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequenceCollection](../isequencecollection/)\> [get_InteractiveSequences](./get_interactivesequences/)() override | مجموعه‌ای از دنباله‌های تعاملی را برمی‌گرداند. این دنباله‌ها ممکن است فقط شامل اثرهای «کلیک روی شکل» باشند که شکل هدف مشخص شده را داشته باشند. فقط‌خواندنی [ISequenceCollection](../isequencecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_MainSequence](./get_mainsequence/)() override | دنباله اصلی را برمی‌گرداند که ممکن است فقط شامل مجموعه اثرهای اصلی باشد. فقط‌خواندنی [ISequence](../isequence/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) override | اثر را از دنباله اصلی در اندیس مشخص شده برمی‌گرداند. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) override | انیمیشن متن را در اندیس مشخص شده برمی‌گرداند. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimationCollection](../itextanimationcollection/)\> [get_TextAnimationCollection](./get_textanimationcollection/)() override | مجموعه‌ای از انیمیشن‌های متن را برمی‌گرداند. فقط‌خواندنی [ITextAnimationCollection](../itextanimationcollection/). |
...
| void [Lock](../../system/object/lock/)() | قفل کردن با بیان lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | آرگومان قالبی nام را به یک اشاره‌گر ضعیف (به‌جای مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در کانتینرها به حالت ضعیف را فراهم می‌آورد. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع مشترک را کاهش داده و مقدار آن را بر می‌گرداند. نباید به‌صورت مستقیم فراخوانی شود؛ در عوض از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری با بیان lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [IAnimationTimeLine](../../aspose.slides/ianimationtimeline/)
