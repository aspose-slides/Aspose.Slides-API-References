...
description: نمایش یک فرمان از مسیر.
type: docs
weight: 456
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند حتی اگر طبق IEC 60559:1989 NaN برابر هیچ مقداریتی، از جمله NaN، نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه شناور دوگانه به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند حتی اگر طبق IEC 60559:1989 NaN برابر هیچ مقداریتی، از جمله NaN، نیست. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای اهداف داخلی. |
| [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() override | نوع فرمان را مشخص می‌کند. [MotionCommandPathType](../motioncommandpathtype/) را بخوانید. |
| **bool** [get_IsRelative](./get_isrelative/)() override | مختصات فرمان را نسبی یا غیر نسبی تعیین می‌کند. **bool** را بخوانید. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() override | نقاط فرمان را مشخص می‌کند. [System::Drawing::PointF](../../system.drawing/pointf/)[] را بخوانید. |
| [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() override | نوع نقاط فرمان را مشخص می‌کند. [MotionPathPointsType](../motionpathpointstype/) را بخوانید. |
...
| void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) override | نوع فرمان را مشخص می‌کند. [MotionCommandPathType](../motioncommandpathtype/) را بنویسید. |
| void [set_IsRelative](./set_isrelative/)(**bool**) override | مختصات فرمان را نسبی یا غیر نسبی تعیین می‌کند. **bool** را بنویسید. |
| void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) override | نقاط فرمان را مشخص می‌کند. [System::Drawing::PointF](../../system.drawing/pointf/)[] را بنویسید. |
| void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) override | نوع نقاط فرمان را مشخص می‌کند. [MotionPathPointsType](../motionpathpointstype/) را بنویسید. |
