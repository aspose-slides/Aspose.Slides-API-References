...
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../ibehavior/get_accumulate/)() | نمایانگر اینکه آیا رفتارهای انیمیشن جمع‌آوری می‌شوند. خواندن [NullableBool](../../aspose.slides/nullablebool/). |
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../ibehavior/get_additive/)() | نمایانگر اینکه آیا رفتار جاری انیمیشن با انیمیشن‌های در حال اجرای دیگر ترکیب می‌شود. خواندن [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual **float** [get_By](./get_by/)() | مقدار جابجایی نسبی برای انیمیشن را توصیف می‌کند. خواندن **float**. |
| virtual **float** [get_From](./get_from/)() | مقدار شروع برای انیمیشن را توصیف می‌کند. خواندن **float**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../ibehavior/get_timing/)() | خواص زمان‌بندی رفتار اثر را نشان می‌دهد. خواندن [ITiming](../itiming/). |
| virtual **float** [get_To](./get_to/)() | مقدار پایان برای انیمیشن را توصیف می‌کند. خواندن **float**. |
...
| virtual void [set_Accumulate](../ibehavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | نمایانگر اینکه آیا رفتارهای انیمیشن جمع‌آوری می‌شوند. نوشتن [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [set_Additive](../ibehavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | نمایانگر اینکه آیا رفتار جاری انیمیشن با انیمیشن‌های در حال اجرای دیگر ترکیب می‌شود. نوشتن [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual void [set_By](./set_by/)(**float**) | مقدار جابجایی نسبی برای انیمیشن را توصیف می‌کند. نوشتن **float**. |
| virtual void [set_From](./set_from/)(**float**) | مقدار شروع برای انیمیشن را توصیف می‌کند. نوشتن **float**. |
| virtual void [set_Timing](../ibehavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | خواص زمان‌بندی رفتار اثر را نشان می‌دهد. نوشتن [ITiming](../itiming/). |
| virtual void [set_To](./set_to/)(**float**) | مقدار پایان برای انیمیشن را توصیف می‌کند. نوشتن **float**. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای بازقفل‌گذاری عبارت C# lock() را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
