...
| Method | Description |
| --- | --- |
| virtual void [Close](./close/)() | جريان را می‌بندد و منابع به‌دست آمده را آزاد می‌کند. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، حتی اگر بر اساس IEC 60559:1989 NaN با هیچ مقداری، از جمله NaN، برابر نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، حتی اگر بر اساس IEC 60559:1989 NaN با هیچ مقداری، از جمله NaN، برابر نیست. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر انتساب. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت نسخه کپی از زیرکلاس‌ها را فراهم می‌کند. |
| virtual int [Peek](./peek/)() | یک کاراکتر تک از جریان می‌خواند بدون تغییر مکان‌نمای خواندن جریان. |
| virtual int [Read](./read/)() | یک کاراکتر تک از جریان می‌خواند. |
| virtual int [Read](./read/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) | تعداد مشخصی از کاراکترها را از جریان می‌خواند و آنها را در آرایه کاراکتری مشخص، از موقعیت تعیین‌شده، می‌نویسد. |
| virtual int [ReadBlock](./readblock/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) | حداکثر تعداد مشخصی از کاراکترها را از خواننده متن فعلی می‌خواند و داده‌ها را در یک بافر، از اندیس مشخص‌شده، می‌نویسد. |
| virtual [System::String](../../system/string/) [ReadLine](./readline/)() | کاراکترها را از جریان می‌خواند تا پایان خط فعلی. |
| virtual [System::String](../../system/string/) [ReadToEnd](./readtoend/)() | کاراکترها را از جریان می‌خواند تا پایان جریان. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای رفع قفل بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
