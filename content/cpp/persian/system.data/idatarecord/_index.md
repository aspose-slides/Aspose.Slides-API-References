...
| virtual **int32_t** [get_FieldCount](./get_fieldcount/)() | اطلاعات RTTI. |
...
| virtual [System::String](../../system/string/) [GetName](./getname/)(const **int32_t**) | نام فیلد در موقعیت مشخص را دریافت می‌کند. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(const **int32_t**) | مقدار در اندیس مشخص را دریافت می‌کند. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند آیا شی نمونه‌ای از نوعی است که توسط targetType توصیف شده است. معادل عملگر 'is' C#. |
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً صدا بزنید یا از شی سنجاری [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای رفع قفل عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً صدا بزنید یا از شی سنجاری [LockContext](../../system/lockcontext/) استفاده کنید. |
