...
| [System::String](../../system/string/) [get_Id](./get_id/)() override | دریافت شناسه عنصر \"tspan\" |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری توسط دستور lock() در C#. مستقیماً فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | دریافت شناسه عنصر \"tspan\" |
...
| void [Unlock](../../system/object/unlock/)() | پیاده‌سازی باز کردن قفل توسط دستور lock() در C#. مستقیماً فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
