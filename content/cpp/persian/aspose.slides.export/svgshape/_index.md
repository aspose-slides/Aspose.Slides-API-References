...
description: نمایش گزینه‌ها برای شکل SVG.
type: docs
weight: 716
...
| [System::String](../../system/string/) [get_Id](./get_id/)() override | شناسه شکل را دریافت می‌کند |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | تعداد شمارنده ارجاع مشترک را به میزان مقدار مشخص شده کاهش می‌دهد. |
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | شناسه شکل را دریافت می‌کند |
| void [SetEventHandler](./seteventhandler/)([SvgEvent](../svgevent/), [System::String](../../system/string/)) override | دستگاه مدیریت رویداد برای شکل را تنظیم می‌کند |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان n'th الگو را به یک اشاره‌گر ضعیف (به جای مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در کانتینرها به حالت ضعیف را فراهم می‌کند. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده ارجاع مشترک را کاهش داده و باز می‌گرداند. نباید مستقیماً فراخوانی شود؛ به جای آن، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
