...
description: رابط Callback برای تعیین نحوه پردازش شیء هنگام ذخیره‌سازی استفاده می‌شود.
type: docs
weight: 248
...
واسط Callback برای تعیین چگونگی پردازش شیء هنگام ذخیره‌سازی استفاده می‌شود.
...
| virtual [LinkEmbedDecision](../linkembeddecision/) [GetObjectStoringLocation](./getobjectstoringlocation/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) | مشخص می‌کند اشیاء کجا باید ذخیره شوند. این متد یک بار برای هر شناسه شیء فراخوانی می‌شود. تضمینی نیست که دو شیء با داده، semanticName و contentType یکسان اما شناسه متفاوت وجود نداشته باشند. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | نوع واقعی شیء را دریافت می‌کند. معادل فراخوانی C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual [System::String](../../system/string/) [GetUrl](./geturl/)(**int32_t**, **int32_t**) | یک URL به شیء خارجی را برمی‌گرداند. این متد همیشه فراخوانی می‌شود اگر [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/) مقدار [LinkEmbedDecision::Link](../linkembeddecision/) را برگرداند و ممکن است اگر [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/) مقدار [LinkEmbedDecision::Embed](../linkembeddecision/) را برگرداند اما جاسازی امکان‌پذیر نیست. می‌تواند چندین بار برای همان شناسه شیء فراخوانی شود. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند آیا شیء نمونه‌ای از نوع شرح داده شده توسط targetType است. معادل عملگر 'is' در C#. |
| void [Lock](../../system/object/lock/)() | قفل‌گذاری عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً صدا بزنید یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual void [SaveExternal](./saveexternal/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | شیء خارجی را ذخیره می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً صدا بزنید یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
