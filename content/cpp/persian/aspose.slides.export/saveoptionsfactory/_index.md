...
اجازه می‌دهد نمونه‌های گزینه‌های ذخیره‌سازی ایجاد شوند
...
| متد | توضیح |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IPptxOptions](../ipptxoptions/)\> [CreatePptxOptions](./createpptxoptions/)() override | گزینه‌های ذخیره‌سازی PPTX را ایجاد می‌کند. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند آیا شیء نمونه‌ای از نوعی است که توسط targetType توصیف شده است. معادل اپراتور 'is' در C#. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای آزادسازی بیان lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [ISaveOptionsFactory](../isaveoptionsfactory/)
