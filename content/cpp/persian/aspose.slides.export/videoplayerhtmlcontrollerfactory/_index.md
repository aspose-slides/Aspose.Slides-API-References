...
description: به ایجاد VideoPlayerHtmlController اجازه می‌دهد.
type: docs
weight: 794
...
اجازه می‌دهد [VideoPlayerHtmlController](../videoplayerhtmlcontroller/) را ایجاد کنید.
...
| متد | توضیح |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVideoPlayerHtmlController](../ivideoplayerhtmlcontroller/)\> [CreateVideoPlayerHtmlController](./createvideoplayerhtmlcontroller/)([System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) override | یک **[VideoPlayerHtmlController](../videoplayerhtmlcontroller/)** جدید ایجاد می‌کند. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | معادل روش [Object.GetHashCode()](../../system/object/gethashcode/) در C#. امکان هش‌سازی اشیا سفارشی را فراهم می‌کند. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. واقعاً هیچ‌چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت زیرکلاس‌ها را از طریق کپی فراهم می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور انتساب. واقعاً هیچ‌چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت زیرکلاس‌ها را از طریق کپی فراهم می‌کند. |
...
* کلاس [IVideoPlayerHtmlControllerFactory](../ivideoplayerhtmlcontrollerfactory/)
