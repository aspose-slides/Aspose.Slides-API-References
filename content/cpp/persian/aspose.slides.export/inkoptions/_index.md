...
| **bool** [get_HideInk](./get_hideink/)() override | عناصر [Ink](../../aspose.slides.ink/) را در سند صادر شده نشان می‌دهد یا مخفی می‌کند. |
| **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() override | از عملیات ROP یا شفافیت برای رندر کردن برس استفاده می‌کند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری با عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء نظارتی [LockContext](../../system/lockcontext/) استفاده کنید. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل متد C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). امکان کلون‌کردن انواع سفارشی را فراهم می‌کند. |
|  [Object](../../system/object/object/)() | شیء را ایجاد می‌کند. تمام ساختارهای داده داخلی را مقداردهی اولیه می‌کند. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و ساختن نسخهٔ کپی از زیرکلاس‌ها را ممکن می‌سازد. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر اختصاص. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و ساختن نسخهٔ کپی از زیرکلاس‌ها را ممکن می‌سازد. |
...
| void [set_HideInk](./set_hideink/)(**bool**) override | عناصر [Ink](../../aspose.slides.ink/) را در سند صادر شده نشان می‌دهد یا مخفی می‌کند. |
| void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) override | از عملیات ROP یا شفافیت برای رندر کردن برس استفاده می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای رفع قفل با عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء نظارتی [LockContext](../../system/lockcontext/) استفاده کنید. |
