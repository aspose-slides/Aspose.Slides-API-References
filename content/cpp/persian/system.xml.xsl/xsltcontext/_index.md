...
description: محفظهٔ زمینهٔ اجرایی فعلی پردازشگر زبان سبک‌برگ قابل گسترش برای تبدیل‌ها (XSLT) است که به زبان مسیر XML (XPath) امکان حل توابع، پارامترها و فضاهای نام را در عبارات XPath می‌دهد.
type: docs
weight: 79
url: /fa/system.xml.xsl/xsltcontext/
---
## XsltContext کلاس

محفظهٔ زمینهٔ اجرایی فعلی پردازندهٔ زبان سبک‌برگ گسترده برای تبدیل‌ها (XSLT) است که به زبان مسیر XML ([XPath](../../system.xml.xpath/)) امکان حل توابع، پارامترها و فضاهای نام را در عبارات [XPath](../../system.xml.xpath/) می‌دهد.
...
| Method | Description |
| --- | --- |
| virtual void [AddNamespace](../../system.xml/xmlnamespacemanager/addnamespace/)([String](../../system/string/), [String](../../system/string/)) | فضای نام داده‌شده را به مجموعه اضافه می‌کند. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | دستگاهی که به اولین عنصر (در صورت وجود) مجموعه اشاره می‌کند را می‌گیرد. این دست‌گیره نمی‌تواند برای تغییر شیء مرجع استفاده شود زیرا [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) یک شیء کپی از T برمی‌گرداند. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | دستگاهی که به اولین عنصر (در صورت وجود) نمونهٔ با ویژگی const مجموعه اشاره می‌کند را می‌گیرد. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | دستگاهی که به اولین عنصر با ویژگی const (در صورت وجود) مجموعه اشاره می‌کند را می‌گیرد. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | دستگاهی که بلافاصله پس از آخرین عنصر با ویژگی const (در صورت وجود) مجموعه اشاره می‌کند را می‌گیرد. |
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | زمانی که در یک کلاس مشتق‌شده بازنویسی شود، شناسه‌های یکنواخت منبع (URI) پایهٔ دو سند را بر اساس ترتیبی که اسناد توسط پردازندهٔ XSLT بارگذاری شده‌اند (یعنی کلاس [XslTransform](../xsltransform/)) مقایسه می‌کند. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | دستگاهی که بلافاصله پس از آخرین عنصر (در صورت وجود) مجموعه اشاره می‌کند را می‌گیرد. این دست‌گیره نمی‌تواند برای تغییر شیء مرجع استفاده شود زیرا [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) یک شیء کپی از T برمی‌گرداند. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | دستگاهی که بلافاصله پس از آخرین عنصر (در صورت وجود) نمونهٔ با ویژگی const مجموعه اشاره می‌کند را می‌گیرد. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسهٔ نقطه‌اعشار به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر هیچ مقداری نیست، از جمله NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسهٔ نقطه‌اعشار به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر هیچ مقداری نیست، از جمله NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | URI فضای نام برای فضای نام پیش‌فرض را برمی‌گرداند. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | [XmlNameTable](../../system.xml/xmlnametable/) مرتبط با این شیء را برمی‌گرداند. |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | زمانی که در یک کلاس مشتق‌شده بازنویسی شود، مقداری را برمی‌گرداند که نشان می‌دهد آیا گره‌های فضای خالی در خروجی گنجانده شوند یا نه. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار دادهٔ شمارندهٔ مرجع مرتبط با شیء را می‌گیرد. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | یک شمارشگر را برمی‌گرداند تا برای پیمایش فضاهای نام در [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) استفاده شود. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](../../system.xml/xmlnamespacemanager/getnamespacesinscope/)([XmlNamespaceScope](../../system.xml/xmlnamespacescope/)) override | مجموعه‌ای از نام‌های فضای نام که بر اساس پیشوند کلید شده‌اند را برمی‌گرداند که می‌توان برای شمارش فضاهای نامی که در حال حاضر در محدوده هستند استفاده کرد. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | گونهٔ واقعی شیء را می‌گیرد. معادل فراخوانی [System.Object.GetType()](../../system/object/gettype/) در C#. |
| virtual **bool** [HasNamespace](../../system.xml/xmlnamespacemanager/hasnamespace/)([String](../../system/string/)) | مقداری را برمی‌گرداند که نشان می‌دهد آیا پیشوند فراهم‌شده برای حوزهٔ فعلی تعریف فضای نام دارد یا نه. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند آیا شیء نمایانگر نمونه‌ای از نوع توصیف‌شده توسط targetType است یا نه. معادل عملگر 'is' در C#. |
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | تابع انباشت‌کننده را بر روی یک دنباله اعمال می‌کند. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | تعیین می‌کند آیا یک دنباله حاوی هر عنصر می‌باشد. |
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | تعیین می‌کند آیا هر عنصری از دنباله وجود دارد یا شرط را برآورده می‌کند. |
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | میانگین یک دنباله از مقادیر عددی را محاسبه می‌کند. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | میانگین یک دنباله از مقادیری که با فراخوانی یک تابع تبدیل بر هر عنصر از دنباله ورودی به دست می‌آیند را محاسبه می‌کند. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | اولین عنصر دنباله یا یک مقدار پیش‌فرض اگر دنباله خالی باشد را برمی‌گرداند. |
...
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | یک تابع تبدیل را بر هر عنصر یک دنبالهٔ عمومی اجرا می‌کند و کوچک‌ترین مقدار حاصل را برمی‌گرداند. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | هر عنصر یک دنباله را به شکل جدیدی تبدیل می‌کند به‌طوری که اندیس عنصر را در بر می‌گیرد. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | تعداد مشخصی از عناصر پی‌درپی از ابتدای یک دنباله را رد می‌کند و بقیه را برمی‌گرداند. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | تعداد مشخصی از عناصر پی‌درپی از ابتدای یک دنباله را برمی‌گرداند. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | دنباله‌ای را بر اساس پیش‌گوی مشخص‌شده فیلتر می‌کند. |
...
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | URI فضای نام برای پیشوند مشخص‌شده را برمی‌گرداند. |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | پیشوند تعریف‌شده برای URI فضای نام داده‌شده را پیدا می‌کند. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل روش [Object.MemberwiseClone()](../../system/object/memberwiseclone/) در C# است. امکان شبیه‌سازی انواع سفارشی را فراهم می‌کند. |
...
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | یک حوزهٔ فضای نام را از پشته خارج می‌کند. |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | زمانی که در یک کلاس مشتق‌شده بازنویسی شود، ارزیابی می‌کند که آیا گره‌های فضای خالی حفظ شوند یا برای زمینهٔ داده‌شده حذف شوند. |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | یک حوزهٔ فضای نام را به پشته اضافه می‌کند. |
...
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | فضای نام داده‌شده برای پیشوند داده‌شده را حذف می‌کند. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextFunction](../ixsltcontextfunction/)\> [ResolveFunction](./resolvefunction/)([String](../../system/string/), [String](../../system/string/), [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\>) | زمانی که در یک کلاس مشتق‌شده بازنویسی شود، یک ارجاع به تابع را حل می‌کند و یک [IXsltContextFunction](../ixsltcontextfunction/) که نمایانگر تابع است را برمی‌گرداند. [IXsltContextFunction](../ixsltcontextfunction/) در زمان اجرا برای دریافت مقدار بازگشتی تابع استفاده می‌شود. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | زمانی که در یک کلاس مشتق‌شده بازنویسی شود، یک ارجاع به متغیر را حل می‌کند و یک [IXsltContextVariable](../ixsltcontextvariable/) که نمایانگر متغیر است را برمی‌گرداند. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | عملگر typeof([System.Object](../../system/object/)) در C# را پیاده‌سازی می‌کند. |
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری بیان lock() در C# را آزاد می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء نگهبانی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | یک نمونهٔ جدید از کلاس [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) را با [XmlNameTable](../../system.xml/xmlnametable/) مشخص‌شده مقداردهی اولیه می‌کند. |
