...
description: ویژگی‌های XSLT را که باید در حین اجرای برگهٔ سبک XSLT پشتیبانی شوند، مشخص می‌کند.
type: docs
weight: 118
url: /fa/system.xml.xsl/xsltsettings/
---
## XsltSettings کلاس

ویژگی‌های XSLT را که باید در حین اجرای برگهٔ سبک XSLT پشتیبانی شوند، مشخص می‌کند.
...
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_Default](./get_default/)() | یک شیء [XsltSettings](./) را با تنظیمات پیش‌فرض برمی‌گرداند. پشتیبانی از تابع XSLT **document()** و بلوک‌های اسکریپت جاسازی‌شده غیرفعال است. |
| **bool** [get_EnableDocumentFunction](./get_enabledocumentfunction/)() | مقداری را برمی‌گرداند که نشان می‌دهد آیا پشتیبانی از تابع XSLT **document()** فعال شود یا نه. |
| **bool** [get_EnableScript](./get_enablescript/)() | مقداری را برمی‌گرداند که نشان می‌دهد آیا پشتیبانی از بلوک‌های اسکریپت جاسازی‌شده فعال شود یا نه. |
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_TrustedXslt](./get_trustedxslt/)() | یک شیء [XsltSettings](./) را برمی‌گرداند که پشتیبانی از تابع XSLT **document()** و بلوک‌های اسکریپت جاسازی‌شده را فعال می‌کند. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند که آیا شیء نمایانگر نمونه‌ای از نوع توصیف‌شده توسط targetType است. معادل عملی‌گر 'is' C#. |
...
| void [set_EnableDocumentFunction](./set_enabledocumentfunction/)(**bool**) | مقدار را تنظیم می‌کند که نشان می‌دهد آیا پشتیبانی از تابع XSLT **document()** فعال شود یا نه. |
| void [set_EnableScript](./set_enablescript/)(**bool**) | مقدار را تنظیم می‌کند که نشان می‌دهد آیا پشتیبانی از بلوک‌های اسکریپت جاسازی‌شده فعال شود یا نه. |
...
|  [XsltSettings](./xsltsettings/)() | یک نمونه جدید از کلاس [XsltSettings](./) را با تنظیمات پیش‌فرض مقداردهی اولیه می‌کند. |
|  [XsltSettings](./xsltsettings/)(**bool**, **bool**) | یک نمونه جدید از کلاس [XsltSettings](./) را با تنظیمات مشخص‌شده مقداردهی اولیه می‌کند. |
| virtual  [~Object](../../system/object/~object/)() | شیء را از بین می‌برد. تمام ساختارهای داده داخلی را آزاد می‌کند. |
## تعریف نوع

| تعریف نوع | توضیح |
| --- | --- |
| [Ptr](./ptr/) | یک شناسه برای اشاره‌گر مشترک به یک نمونه از این کلاس. |
## توضیحات

اشیا از این کلاس باید فقط با استفاده از تابع [System::MakeObject()](../../system/makeobject/) تخصیص داده شوند. هرگز نمونه‌های این نوع را بر روی پشته یا با استفاده از عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا نقض‌های تأیید می‌شود. همیشه این کلاس را در یک اشاره‌گر [System::SmartPtr](../../system/smartptr/) بپیچید و از این اشاره‌گر برای عبور به توابع به‌عنوان آرگومان استفاده کنید. 
