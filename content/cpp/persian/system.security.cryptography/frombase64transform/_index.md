...
| void [Dispose](./dispose/)() | منابع سیستم‌عامل که توسط شیء جاری به‌دست آمده‌اند را آزاد می‌کند. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه double به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند حتی اگر طبق IEC 60559:1989 NaN برابر با هیچ مقداری، از جمله NaN، نیست. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای استفاده داخلی. |
| [FromBase64Transform](./frombase64transform/)() | سازنده. |
| [FromBase64Transform](./frombase64transform/)([FromBase64TransformMode](../frombase64transformmode/)) | سازنده. |
| virtual **bool** [get_CanReuseTransform](./get_canreusetransform/)() | مقداری را دریافت می‌کند که نشان می‌دهد آیا تبدیل جاری می‌تواند مجدداً استفاده شود. |
| **bool** [get_CanTransformMultipleBlocks](./get_cantransformmultipleblocks/)() | مقداری را دریافت می‌کند که نشان می‌دهد آیا بلوک‌های متعدد می‌توانند تبدیل شوند. |
| virtual **int32_t** [get_InputBlockSize](./get_inputblocksize/)() | اندازهٔ بلوک ورودی. |
| virtual **int32_t** [get_OutputBlockSize](./get_outputblocksize/)() | اندازهٔ بلوک خروجی. |
...
| virtual int [TransformBlock](../icryptotransform/transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | بلوک داده را پردازش می‌کند و داده‌ها را به آرایهٔ خروجی کپی می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | بازکردن قفل توسط عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual [~FromBase64Transform](./~frombase64transform/)() | تخریب‌کننده. |
