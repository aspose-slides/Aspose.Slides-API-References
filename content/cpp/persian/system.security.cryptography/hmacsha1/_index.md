...
description: "کد احراز هویت پیام مبتنی بر هش که از تابع هش SHA1 استفاده می‌کند. پیاده‌سازی نشده. اشیای این کلاس فقط باید با استفاده از تابع System::MakeObject() تخصیص داده شوند. هرگز نمونه‌ای از این نوع را روی پشته یا با استفاده از عملگر new ایجاد نکنید، زیرا منجر به خطاهای زمان اجرا و/یا خطاهای assert می‌شود. همیشه این کلاس را در یک اشاره‌گر System::SmartPtr بپیچید و از این اشاره‌گر برای عبور به توابع به عنوان آرگومان استفاده کنید."
type: docs
weight: 248
url: /fa/system.security.cryptography/hmacsha1/
---
## HMACSHA1 class
...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | بخش بخشی از بافر را هش می‌کند. |
...
|  [HMACSHA1](./hmacsha1/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | سازنده. |
...
| virtual  [~HashAlgorithm](../hashalgorithm/~hashalgorithm/)() | متد تخریب. |
