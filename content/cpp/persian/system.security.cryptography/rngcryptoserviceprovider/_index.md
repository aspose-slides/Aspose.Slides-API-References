...
| متد | توضیح |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[RandomNumberGenerator](../randomnumbergenerator/)\> [Create](../randomnumbergenerator/create/)() | یک نمونه از پیاده‌سازی پیش‌فرض یک تولیدکننده عدد تصادفی رمزنگاری‌شده که می‌تواند برای تولید داده‌های تصادفی استفاده شود را ایجاد می‌کند. پیاده‌سازی نشده. |
...
| void [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | عناصر موجود آرایه را با بایت‌های تصادفی پر می‌کند. |
| void [GetBytes](./getbytes/)(System::Details::ArrayView\<**uint8_t**\>) override | عناصر موجود نمای آرایه را با بایت‌های تصادفی پر می‌کند. |
| virtual void [GetBytes](../randomnumbergenerator/getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | بخش موجود آرایه را با بایت‌های تصادفی پر می‌کند. |
| virtual void [GetBytes](../randomnumbergenerator/getbytes/)(System::Details::ArrayView\<**uint8_t**\>, int, int) | بخش موجود نمای آرایه را با بایت‌های تصادفی پر می‌کند. |
| void [GetBytes](../randomnumbergenerator/getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | عناصر موجود آرایه پشته را با بایت‌های تصادفی پر می‌کند. |
| void [GetBytes](../randomnumbergenerator/getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&, int, int) | بخش موجود آرایه پشته را با بایت‌های تصادفی پر می‌کند. |
...
| void [GetNonZeroBytes](./getnonzerobytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | عناصر موجود آرایه را با بایت‌های تصادفی غیر صفر پر می‌کند. |
| void [GetNonZeroBytes](./getnonzerobytes/)(System::Details::ArrayView\<**uint8_t**\>) override | عناصر موجود نمای آرایه را با بایت‌های تصادفی غیر صفر پر می‌کند. |
| void [GetNonZeroBytes](../randomnumbergenerator/getnonzerobytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | عناصر موجود آرایه پشته را با بایت‌های تصادفی غیر صفر پر می‌کند. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری دستورات lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | اشیاء را با مراجعه (مرجع) مقایسه می‌کند. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | اشیاء را با مراجعه (مرجع) مقایسه می‌کند. |
...
| [RNGCryptoServiceProvider](./rngcryptoserviceprovider/)() | سازنده. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گشایی دستورات lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual [~RNGCryptoServiceProvider](./~rngcryptoserviceprovider/)() | تخریب‌کننده. |

## همچنین ببینید

* کلاس [RandomNumberGenerator](../randomnumbergenerator/)
