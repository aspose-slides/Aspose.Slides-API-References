...
description: نمایندهٔ مدیری است که رفتار جای‌گیرهای اسلاید توزیع اصلی را شامل می‌شود، از جمله جای‌گیر سرصفحه.
type: docs
weight: 2848
url: /fa/aspose.slides/imasterhandoutslideheaderfootermanager/
---
## IMasterHandoutSlideHeaderFooterManager کلاس
...
| virtual **bool** [get_IsDateTimeVisible](../ibaseslideheaderfootermanager/get_isdatetimevisible/)() | مقداری را دریافت می‌کند که نشان می‌دهد یک placeholder تاریخ-زمان وجود دارد. خواندنی**bool**. |
| virtual **bool** [get_IsFooterVisible](../ibaseslideheaderfootermanager/get_isfootervisible/)() | مقداری را دریافت می‌کند که نشان می‌دهد یک placeholder پاورقی وجود دارد. خواندنی **bool**. |
| virtual **bool** [get_IsHeaderVisible](../ibasehandoutnotesslideheaderfootermanag/get_isheadervisible/)() | مقداری را دریافت می‌کند که نشان می‌دهد یک placeholder سرصفحه وجود دارد. خواندنی **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](../ibaseslideheaderfootermanager/get_isslidenumbervisible/)() | مقداری را دریافت می‌کند که نشان می‌دهد یک placeholder شماره صفحه وجود دارد. Read**bool**. |
...
| void [Lock](../../system/object/lock/)() | عملکرد قفل‌گذاری عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | تنظیم خاص [Object::ReferenceEquals](../../system/object/referenceequals/) برای حالت رشته و nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | تنظیم خاص [Object::ReferenceEquals](../../system/object/referenceequals/) برای حالت رشته‌ها. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | شماره شمارنده مرجع اشتراکی را با مقدار مشخصی کاهش می‌دهد. |
| virtual void [SetDateTimeText](../ibaseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) | متن را برای placeholder تاریخ-زمان اسلاید تنظیم می‌کند. |
| virtual void [SetDateTimeVisibility](../ibaseslideheaderfootermanager/setdatetimevisibility/)(**bool**) | قابلیت مشاهده placeholder تاریخ-زمان اسلاید را تغییر می‌دهد. |
| virtual void [SetFooterText](../ibaseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) | متن را برای placeholder پاورقی اسلاید تنظیم می‌کند. |
| virtual void [SetFooterVisibility](../ibaseslideheaderfootermanager/setfootervisibility/)(**bool**) | قابلیت مشاهده placeholder پاورقی اسلاید را تغییر می‌دهد. |
| virtual void [SetHeaderText](../ibasehandoutnotesslideheaderfootermanag/setheadertext/)([System::String](../../system/string/)) | متن را برای placeholder سرصفحه اسلاید تنظیم می‌کند. |
| virtual void [SetHeaderVisibility](../ibasehandoutnotesslideheaderfootermanag/setheadervisibility/)(**bool**) | قابلیت مشاهده placeholder سرصفحه اسلاید را تغییر می‌دهد. |
| virtual void [SetSlideNumberVisibility](../ibaseslideheaderfootermanager/setslidenumbervisibility/)(**bool**) | قابلیت مشاهده placeholder شماره صفحه اسلاید را تغییر می‌دهد. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع اشتراکی را کاهش می‌دهد و بازمی‌گرداند. نباید به‌طور مستقیم فراخوانی شود؛ در عوض، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | عملکرد بازقفل‌گذاری عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
