...
description: مدیر اسلاید برگهٔ اصلی.
type: docs
weight: 2861
url: /fa/aspose.slides/imasterhandoutslidemanager/
---
## IMasterHandoutSlideManager کلاس
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسهٔ نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989، NaN با هیچ‌ مقداری، از جمله NaN، برابر نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسهٔ نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989، NaN با هیچ‌ مقداری، از جمله NaN، برابر نیست. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [get_MasterHandoutSlide](./get_masterhandoutslide/)() | در صورت وجود، مستر برای تمام اسلایدهای یادداشت این ارائه را برمی‌گرداند، در غیر این صورت null برمی‌گرداند. فقط-خواندنی [IMasterHandoutSlide](../imasterhandoutslide/). |
...
| void [Lock](../../system/object/lock/)() | قفل‌کنندهٔ بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual void [RemoveMasterHandoutSlide](./removemasterhandoutslide/)() | اسلاید اصلی برگهٔ دستنویس را حذف می‌کند. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [SetDefaultMasterHandoutSlide](./setdefaultmasterhandoutslide/)() | اسلاید اصلی پیش‌فرض برگهٔ دستنویس را به اسلاید مربوطه تنظیم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌کنندهٔ بیان lock() در C# را باز می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
