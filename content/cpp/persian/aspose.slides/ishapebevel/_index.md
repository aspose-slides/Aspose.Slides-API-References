...
description: خواص برجستگی سطح اصلی شکل را نشان می‌دهد.
type: docs
weight: 3654
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | نوع برجستگی. برای خواندن [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | ارتفاع برجستگی. برای خواندن **double**. |
| virtual **double** [get_Width](./get_width/)() | عرض برجستگی. برای خواندن **double**. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری توسط بیانیه C# lock() را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | مقایسه مرجع‌گرای شیء نوع مقدار با nullptr. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | نوع برجستگی. برای نوشتن [BevelPresetType](../bevelpresettype/). |
| virtual void [set_Height](./set_height/)(**double**) | ارتفاع برجستگی. برای نوشتن **double**. |
| virtual void [set_Width](./set_width/)(**double**) | عرض برجستگی. برای نوشتن **double**. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارندهٔ مرجع مشترک را کاهش داده و بازمی‌گرداند. نباید به‌صورت مستقیم صدا زده شود؛ به‌جای آن از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای باز کردن قفل توسط بیانیه C# lock() را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
