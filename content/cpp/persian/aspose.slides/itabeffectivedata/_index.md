...
description: شیء غیرقابل تغییر که شامل ویژگی‌های توقف تب‌بندی متن مؤثر است.
type: docs
weight: 3992
url: /fa/aspose.slides/itabeffectivedata/
---
## کلاس ITabEffectiveData

شیء غیرقابل تغییر که شامل ویژگی‌های توقف تب‌بندی متن مؤثر است.
...
| متد | توضیح |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | شیء فعلی را با شیء مشخص شده مقایسه می‌کند. |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | سبک تراز یک تب را برمی‌گرداند. فقط-خواندنی [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | موقعیت یک تب را برمی‌گرداند. اختصاص این ویژگی می‌تواند شاخص تب را در مجموعه تغییر داده و Enumerator را نامعتبر کند. فقط-خواندنی **double**. |
...
| void [Lock](../../system/object/lock/)() | پیاده‌سازی قفل‌گذاری دستور C# lock() . به‌صورت مستقیم فراخوانی شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل متد C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). امکان کلون‌بندی انواع سفارشی را فراهم می‌کند. |
|  [Object](../../system/object/object/)() | شیء را ایجاد می‌کند. تمام ساختارهای داده داخلی را مقداردهی اولیه می‌کند. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده کپی. در واقع چیزی کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت زیرکلاس‌های کپی را می‌دهد. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر انتساب. در واقع چیزی کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت زیرکلاس‌های کپی را می‌دهد. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان قالب n-ام را به یک اشاره‌گر ضعیف (نه قوی) تنظیم می‌کند. امکان سوئیچ کردن اشاره‌گرها در کانتینرها به حالت ضعیف را می‌دهد. |
...
| void [Unlock](../../system/object/unlock/)() | پیاده‌سازی آزادسازی قفل دستور C# lock() . به‌صورت مستقیم فراخوانی شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
