...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateFileStreamWrapper](./createfilestreamwrapper/)([System::String](../../system/string/), [System::IO::FileMode](../../system.io/filemode/)) | یک FileStream را با مسیر و حالت ایجاد مشخص شده ایجاد می‌کند. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateFileStreamWrapper](./createfilestreamwrapper/)([System::String](../../system/string/), [System::IO::FileMode](../../system.io/filemode/), [System::IO::FileAccess](../../system.io/fileaccess/)) | یک FileStream را با مسیر، حالت ایجاد و مجوز خواندن/نوشتن مشخص شده ایجاد می‌کند. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateMemoryStreamWrapper](./creatememorystreamwrapper/)() | یک پوشش MemoryStream ایجاد می‌کند. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateMemoryStreamWrapper](./creatememorystreamwrapper/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | یک پوشش MemoryStream را بر پایه آرایه بایت مشخص شده ایجاد می‌کند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری دستور C# lock() را پیاده‌سازی می‌کند. به‌طور مستقیم فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای رفع قفل دستور C# lock() را پیاده‌سازی می‌کند. به‌طور مستقیم فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
