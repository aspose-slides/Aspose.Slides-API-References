...
description: نمایانگر یک فرمت گرادیان.
type: docs
weight: 1106
...
| متد | توضیح |
| --- | --- |
| **bool** [Equals](../pviobject/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | با شیء مشخص مقایسه می‌کند. |
...
| [Aspose::Slides::GradientDirection](../gradientdirection/) [get_GradientDirection](./get_gradientdirection/)() override | سبک یک گرادیان را برمی‌گرداند. ببینید [Slides::GradientDirection](../gradientdirection/). |
| [Aspose::Slides::GradientShape](../gradientshape/) [get_GradientShape](./get_gradientshape/)() override | شکل یک گرادیان را برمی‌گرداند. ببینید [Slides::GradientShape](../gradientshape/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [get_GradientStop](./get_gradientstop/)(**int32_t**) override | وقفه‌ای از گرادیان را در اندیس مشخص برمی‌گرداند. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopCollection](../igradientstopcollection/)\> [get_GradientStops](./get_gradientstops/)() override | مجموعه‌ای از وقفه‌های گرادیان را برمی‌گرداند. فقط-خواندنی [IGradientStopCollection](../igradientstopcollection/). |
| **float** [get_LinearGradientAngle](./get_lineargradientangle/)() override | زاویهٔ یک گرادیان را برمی‌گرداند. ببینید **float**. |
| [NullableBool](../nullablebool/) [get_LinearGradientScaled](./get_lineargradientscaled/)() override | تشخیص می‌دهد آیا یک گرادیان مقیاس‌دار است یا نه. ببینید [NullableBool](../nullablebool/). |
...
| [Aspose::Slides::TileFlip](../tileflip/) [get_TileFlip](./get_tileflip/)() override | حالت چرخش برای یک گرادیان را برمی‌گرداند. ببینید [Slides::TileFlip](../tileflip/). |
...
| void [Lock](../../system/object/lock/)() | پیاده‌سازی قفل‌گذاری عبارت lock() در C#. به‌صورت مستقیم فراخوانی کنید یا از شیء نظارت [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | شمارندهٔ مرجع مشترک را به میزان مقدار مشخص کاهش می‌دهد. |
| void [set_GradientDirection](./set_gradientdirection/)([Aspose::Slides::GradientDirection](../gradientdirection/)) override | سبک یک گرادیان را تنظیم می‌کند. بنویسید [Slides::GradientDirection](../gradientdirection/). |
| void [set_GradientShape](./set_gradientshape/)([Aspose::Slides::GradientShape](../gradientshape/)) override | شکل یک گرادیان را تنظیم می‌کند. بنویسید [Slides::GradientShape](../gradientshape/). |
| void [set_LinearGradientAngle](./set_lineargradientangle/)(**float**) override | زاویهٔ یک گرادیان را تنظیم می‌کند. بنویسید **float**. |
| void [set_LinearGradientScaled](./set_lineargradientscaled/)([NullableBool](../nullablebool/)) override | تشخیص می‌دهد آیا یک گرادیان مقیاس‌دار است یا نه. بنویسید [NullableBool](../nullablebool/). |
| void [set_TileFlip](./set_tileflip/)([Aspose::Slides::TileFlip](../tileflip/)) override | حالت چرخش یک گرادیان را تنظیم می‌کند. بنویسید [Slides::TileFlip](../tileflip/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام قالب را به‌عنوان اشاره‌گر ضعیف (به‌جای مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در سازندها به حالت ضعیف را فراهم می‌آورد. |
...
| void [Unlock](../../system/object/unlock/)() | پیاده‌سازی قفل‌برداری عبارت lock() در C#. به‌صورت مستقیم فراخوانی کنید یا از شیء نظارت [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [IGradientFormat](../igradientformat/)
