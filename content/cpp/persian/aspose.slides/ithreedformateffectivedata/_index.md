...
---
## IThreeDFormatEffectiveData کلاس
...
این رابط همراه با رابط [IThreeDFormat](../ithreedformat/) استفاده می‌شود تا مقادیر قالب‌بندی مؤثر با به‌کارگیری ارث‌بری بازگردانده شوند.
