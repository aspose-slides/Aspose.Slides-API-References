...
---
## ISpreadsheetOptions کلاس

نمایانگر گزینه‌هایی است که می‌توان از آن‌ها برای تعیین رفتارهای اضافی صفحات‌گسترده استفاده کرد.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه شناور به سبک C#-style را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر با هیچ مقدار، از جمله NaN، نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه شناور به سبک C#-style را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر با هیچ مقدار، از جمله NaN، نیست. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() | اطلاعات فرهنگ ترجیحی را برای محاسبه برخی توابعی که برای استفاده با زبان‌هایی که از مجموعه کاراکتر دو بایتی (DBCS) استفاده می‌کنند، دریافت می‌کند. |
| virtual **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() | اگر منبع داده برای نمودار یک کتاب کار خارجی باشد و در دسترس نباشد، از حافظه‌پنهان نمودار بازیابی می‌شود. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری با دستور C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبانی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) | اطلاعات فرهنگ ترجیحی را برای محاسبه برخی توابعی که برای استفاده با زبان‌هایی که از مجموعه کاراکتر دو بایتی (DBCS) استفاده می‌کنند، تنظیم می‌کند. |
| virtual void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) | اگر منبع داده برای نمودار یک کتاب کار خارجی باشد و در دسترس نباشد، از حافظه‌پنهان نمودار بازیابی می‌شود. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری با دستور C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبانی [LockContext](../../system/lockcontext/) استفاده کنید. |
