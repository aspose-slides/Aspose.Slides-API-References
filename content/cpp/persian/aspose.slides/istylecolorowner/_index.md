...
type: docs
weight: 3901
url: /fa/aspose.slides/istylecolorowner/
---
## IStyleColorOwner کلاس
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری با استفاده از عبارت C# lock() را پیاده‌سازی می‌کند. مستقیماً فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارشگر مرجع مشترک را کاهش داده و مقدار آن را برمی‌گرداند. نباید به طور مستقیم فراخوانی شود؛ در عوض، از smart pointers یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | بازکردن قفل با عبارت C# lock() را پیاده‌سازی می‌کند. مستقیماً فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
