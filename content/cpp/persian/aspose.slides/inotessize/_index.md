...
نمایش یک اندازه اسلاید یادداشت‌ها.
...
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | اندازه را به پوینت برمی‌گرداند. به [System::Drawing::SizeF](../../system.drawing/sizef/) مراجعه کنید. |
...
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | اندازه را به پوینت تعیین می‌کند. بنویسید [System::Drawing::SizeF](../../system.drawing/sizef/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام قالب را به یک اشاره‌گر ضعیف (به‌جای مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در‌نوع‌دیتا به حالت ضعیف را فراهم می‌آورد. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی شود یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
