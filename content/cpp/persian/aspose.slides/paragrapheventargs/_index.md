...
description: کلاس آرگومان‌های رویداد برای رویدادهای مرتبط با پاراگراف.
type: docs
weight: 4642
url: /fa/aspose.slides/paragrapheventargs/
---
## ParagraphEventArgs کلاس

کلاس آرگومان‌های رویداد برای رویدادهای مرتبط با پاراگراف.
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند که آیا شیء نشانگر یک نمونه از نوع توصیف‌شده توسط targetType است. معادل عملگر 'is' C#. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان n'th الگو را به یک اشاره‌گر ضعیف تنظیم می‌کند (نه مشترک). امکان تبدیل اشاره‌گرها در ساختارهای داده به حالت ضعیف را می‌دهد. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری از عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| Field | Description |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | یک عضو استاتیک که یک اشاره‌گر مشترک \"empty\" [EventArgs](../../system/eventargs/) (null-pointer) را نشان می‌دهد. |
