...
description: شیء ThreeDFormat را که ویژگی‌های اثر 3d برای متن را نشان می‌دهد بر می‌گرداند. فقط‌خواندنی IThreeDFormat.
type: docs
weight: 300
url: /fa/aspose.slides/itextframeformat/get_threedformat/
---
## ITextFrameFormat::get_ThreeDFormat() متد

شیء [ThreeDFormat](../../threedformat/) را که ویژگی‌های اثر 3d برای متن را نشان می‌دهد بر می‌گرداند. فقط‌خواندنی [IThreeDFormat](../../ithreedformat/).
