...
description: رابط پایه برای اشیاء غیرقابل تغییر که ویژگی‌های قالب‌بندی جدول مؤثر را شامل می‌شوند.
type: docs
weight: 1522
url: /fa/aspose.slides/ibasetableformateffectivedata/
---
## IBaseTableFormatEffectiveData کلاس

رابط پایه برای اشیاء غیرقابل تغییر که شامل ویژگی‌های قالب‌بندی جدول مؤثر هستند.
...
| متد | توضیح |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | اشیاء را با رعایت قواعد C# [Object.Equals](../../system/object/equals/) مقایسه می‌کند. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderBottom](./get_borderbottom/)() | مقدار مؤثر فرمت خط حاشیه پایین را برمی‌گرداند. فقط برای خواندن [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalDown](./get_borderdiagonaldown/)() | مقدار مؤثر فرمت خط قطری پایین را برمی‌گرداند. فقط برای خواندن [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalUp](./get_borderdiagonalup/)() | مقدار مؤثر فرمت خط قطری بالا را برمی‌گرداند. فقط برای خواندن [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderLeft](./get_borderleft/)() | مقدار مؤثر فرمت خط حاشیه چپ را برمی‌گرداند. فقط برای خواندن [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderRight](./get_borderright/)() | مقدار مؤثر فرمت خط حاشیه راست را برمی‌گرداند. فقط برای خواندن [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderTop](./get_bordertop/)() | مقدار مؤثر فرمت خط حاشیه بالا را برمی‌گرداند. فقط برای خواندن [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | مقدار مؤثر فرمت پر کردن را برمی‌گرداند. فقط برای خواندن [IFillFormatEffectiveData](../ifillformateffectivedata/). |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل کردن دستور lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی می‌کند و امکان ساخت نسخهٔ کپی از زیرکلاس‌ها را فراهم می‌آورد. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر انتساب. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی می‌کند و امکان ساخت نسخهٔ کپی از زیرکلاس‌ها را فراهم می‌آورد. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای باز کردن قفل دستور lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
