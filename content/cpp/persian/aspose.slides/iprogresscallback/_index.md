...
description: شیء callback را برای ذخیره‌سازی به‌روزرسانی‌های پیشرفت به درصد نشان می‌دهد.
type: docs
weight: 3446
url: /fa/aspose.slides/iprogresscallback/
---
## IProgressCallback کلاس

شیء callback را برای ذخیره‌سازی به‌روزرسانی‌های پیشرفت به درصد نمایان می‌کند.
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده شود. |
...
| virtual void [Reporting](./reporting/)(**double**) | به‌روزرسانی پیشرفت را گزارش می‌دهد. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام الگوی قالب را به اشاره‌گر ضعیف (به جای مشترک) تنظیم می‌کند. اجازه می‌دهد تا اشاره‌گرها در کانتینرها به حالت ضعیف تغییر یابند. |
| int [SharedCount](../../system/object/sharedcount/)() const | مقدار فعلی شمارنده مرجع مشترک را دریافت می‌کند. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | شمارنده مرجع مشترک را افزایشداده می‌کند. نباید به‌صورت مستقیم فراخوانی شود؛ در عوض، از smart pointers یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای بازقفل‌گذاری عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده شود. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | شمارنده مرجع ضعیف را افزایشداده می‌کند. نباید به‌صورت مستقیم فراخوانی شود؛ در عوض، از smart pointers یا ThisProtector استفاده کنید. |
