...
| virtual [System::String](../../system/string/) [get_CommentsText](./get_commentstext/)() | متن نظرات اسلاید |
| virtual [System::String](../../system/string/) [get_LayoutText](./get_layouttext/)() | متن اشکال صفحهٔ چینش برای این اسلاید |
| virtual [System::String](../../system/string/) [get_MasterText](./get_mastertext/)() | متن اشکال صفحهٔ اصلی برای این اسلاید |
| virtual [System::String](../../system/string/) [get_NotesText](./get_notestext/)() | متن اشکال صفحهٔ یادداشت‌ها برای این اسلاید |
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | متن اشکال اسلاید |
...
| void [Lock](../../system/object/lock/)() | بیانیه lock() در C# را برای قفل‌گذاری پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل روش C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). امکان ایجاد کپی از انواع سفارشی را فراهم می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | بیانیه lock() در C# را برای باز کردن قفل پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
