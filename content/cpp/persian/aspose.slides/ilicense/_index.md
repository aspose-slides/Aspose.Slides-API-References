...
| virtual **bool** [IsLicensed](./islicensed/)() | بررسی می‌کند که آیا مجوز به مؤلفه اعمال شده است |
| void [Lock](../../system/object/lock/)() | قفل‌گذاری عبارت lock() C# را پیاده‌سازی می‌کند. به‌طور مستقیم فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | تعداد شمارنده ارجاع اشتراکی را به مقدار مشخص کاهش می‌دهد. |
| virtual void [ResetLicense](./resetlicense/)() | بازنشانی مجوز |
| virtual void [SetLicense](./setlicense/)([System::String](../../system/string/)) | مجوز مؤلفه را صادر می‌کند. |
| virtual void [SetLicense](./setlicense/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | مجوز مؤلفه را صادر می‌کند. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | شمارنده ارجاع اشتراکی را افزایش می‌دهد. نباید به‌طور مستقیم فراخوانی شود؛ به‌جای آن از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده ارجاع اشتراکی را کاهش می‌دهد و برمی‌گرداند. نباید به‌طور مستقیم فراخوانی شود؛ به‌جای آن از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | سازوکار typeof([System.Object](../../system/object/)) C# را پیاده‌سیازی می‌کند. |
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری عبارت lock() C# را پیاده‌سازی می‌کند. به‌طور مستقیم فراخوانی کنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
در این مثال، سعی می‌شود فایلی به نام MyLicense.lic در پوشه‌ای که مؤلفه در آن قرار دارد، در پوشه‌ای که اسمبلی فراخوانی‌کننده در آن است، در پوشهٔ اسمبلی ورودی و سپس در منابع نهفتهٔ اسمبلی فراخوانی‌کننده پیدا شود. 
```cpp
