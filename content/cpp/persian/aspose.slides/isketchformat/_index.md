...
خواص قالب اسکیچ خطوط را نمایندگی می‌کند.
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | نوع اسکیچ را باز می‌گرداند. [Slides::LineSketchType](../linesketchtype/) را بخوانید. |
...
| virtual void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) | نوع اسکیچ را تنظیم می‌کند. [Slides::LineSketchType](../linesketchtype/) را بنویسید. |
