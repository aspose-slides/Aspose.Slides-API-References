...
description: مجموعه‌ای از امضاهایی را که برای امضای ارائه استفاده می‌شود برمی‌گرداند. فقط-خواندنی IDigitalSignatureCollection.
type: docs
weight: 378
url: /fa/aspose.slides/ipresentation/get_digitalsignatures/
---
## IPresentation::get_DigitalSignatures() method


مجموعهٔ امضاهایی را که برای امضای ارائه استفاده می‌شود برمی‌گرداند. فقط-خواندنی [IDigitalSignatureCollection](../../idigitalsignaturecollection/).
