...
description: نماینده مدیری است که رفتار فوتر اسلاید، مکان‌نمای تاریخ-زمان و شماره صفحه را نگه می‌دارد.
type: docs
weight: 3797
url: /fa/aspose.slides/islideheaderfootermanager/
---
## کلاس ISlideHeaderFooterManager


مدیری را نشان می‌دهد که رفتار فوتر اسلاید، مکان‌نمای تاریخ-زمان و شماره صفحه را نگهداری می‌کند.
...
| virtual **bool** [get_IsDateTimeVisible](../ibaseslideheaderfootermanager/get_isdatetimevisible/)() | مقداری را برمی‌گرداند که نشان می‌دهد یک مکان‌نمای تاریخ-زمان وجود دارد. Read**bool**. |
| virtual **bool** [get_IsFooterVisible](../ibaseslideheaderfootermanager/get_isfootervisible/)() | مقداری را برمی‌گرداند که نشان می‌دهد یک مکان‌نمای فوتر وجود دارد. Read **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](../ibaseslideheaderfootermanager/get_isslidenumbervisible/)() | مقداری را برمی‌گرداند که نشان می‌دهد یک مکان‌نمای شماره صفحه وجود دارد. Read**bool**. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | نوع واقعی شیء را برمی‌گرداند. معادل فراخوانی [System.Object.GetType()](../../system/object/gettype/) C# است. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل کردن در عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل متد [Object.MemberwiseClone()](../../system/object/memberwiseclone/) C# است. امکان شبیه‌سازی انواع سفارشی را می‌دهد. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | مقایسه مرجع‌گونه شیء نوع ارزش با nullptr. |
...
| virtual void [SetDateTimeText](../ibaseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) | متن را برای مکان‌نمای تاریخ-زمان اسلاید تنظیم می‌کند. |
| virtual void [SetDateTimeVisibility](../ibaseslideheaderfootermanager/setdatetimevisibility/)(**bool**) | قابلیت مشاهده مکان‌نمای تاریخ-زمان اسلاید را تغییر می‌دهد. |
| virtual void [SetFooterText](../ibaseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) | متن را برای مکان‌نمای فوتر اسلاید تنظیم می‌کند. |
| virtual void [SetFooterVisibility](../ibaseslideheaderfootermanager/setfootervisibility/)(**bool**) | قابلیت مشاهده مکان‌نمای فوتر اسلاید را تغییر می‌دهد. |
| virtual void [SetSlideNumberVisibility](../ibaseslideheaderfootermanager/setslidenumbervisibility/)(**bool**) | قابلیت مشاهده مکان‌نمای شماره صفحه اسلاید را تغییر می‌دهد. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع مشترک را کاهش می‌دهد و مقدار بازگشتی را برمی‌گرداند. نباید به‌صورت مستقیم فراخوانی شود؛ به‌جای آن از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای باز کردن قفل در عبارت C# lock() را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی شود یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
