...
description: مدیری را نشان می‌دهد که رفتار فوتر، تاریخ-زمان، مکان‌دارهای شماره صفحه را برای تمام انواع اسلاید نگه می‌دارد.
type: docs
weight: 1444
url: /fa/aspose.slides/ibaseheaderfootermanager/
---
## IBaseHeaderFooterManager کلاس

مدیری را نشان می‌دهد که رفتار فوتر، تاریخ-زمان، مکان‌دارهای شماره صفحه را برای تمام انواع اسلاید نگه می‌دارد.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، حتی اگر طبق IEC 60559:1989 NaN برابر هیچ مقدارى، از جمله NaN، نباشد. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه شناور دوگانه به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، حتی اگر طبق IEC 60559:1989 NaN برابر هیچ مقدارى، از جمله NaN، نباشد. |
...
| void [Lock](../../system/object/lock/)() | پیاده‌سازی قفل‌گذاری عبارت lock() در C#. به‌صورت مستقیم فراخوانی می‌شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده‌ی مرجع مشترک را کاهش داده و مقدار آن را برمی‌گرداند. نباید به‌صورت مستقیم فراخوانی شود؛ به‌جای آن از هوشمند-اشاره‌گرها یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | پیاده‌سازی قفل‌گذاری (unlock) عبارت lock() در C#. به‌صورت مستقیم فراخوانی می‌شود یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
