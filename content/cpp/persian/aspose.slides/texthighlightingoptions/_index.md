...
description: گزینه‌هایی که می‌توان برای برجسته‌سازی متن در قاب متن استفاده کرد.
type: docs
weight: 5474
url: /fa/aspose.slides/texthighlightingoptions/
---
## TextHighlightingOptions کلاس
...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | در صورت true تنظیم می‌شود تا جستجوی حساس به حروف بزرگ/کوچک استفاده شود، در غیر این صورت false. خواندن **bool**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | در صورت true تنظیم می‌شود تا تنها کلمات کامل مطابقت داشته باشند، در غیر این صورت false. خواندن **bool**. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً صدا بزنید یا از شیء نگهبانی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده‌ی کپی. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی برای کلاس‌های مشتق را فراهم می‌کند. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | مقایسه مرجع به شیء نوع مقدار با nullptr. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | در صورت true تنظیم می‌شود تا جستجوی حساس به حروف بزرگ/کوچک استفاده شود، در غیر این صورت false. نوشتن **bool**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | در صورت true تنظیم می‌شود تا تنها کلمات کامل مطابقت داشته باشند، در غیر این صورت false. نوشتن **bool**. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع مشترک را کاهش می‌دهد و مقدار آن را بر می‌گرداند. نباید مستقیماً فراخوانی شود؛ در عوض، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
|  [TextHighlightingOptions](./texthighlightingoptions/)() | گزینه‌های پیش‌فرض برجسته‌سازی متن جدید ایجاد می‌کند. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | معادل متد C# [Object.ToString()](../../system/object/tostring/). امکان تبدیل اشیاء سفارشی به رشته را فراهم می‌کند. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | ساختار typeof([System.Object](../../system/object/)) در C# را پیاده‌سازی می‌کند. |
| void [Unlock](../../system/object/unlock/)() | اجرای باز کردن قفل عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً صدا بزنید یا از شیء نگهبانی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
منسوخ شده
:   اینترفیس [ITextHighlightingOptions](../itexthighlightingoptions/) پس از انتشار نسخه 24.10 حذف خواهد شد.
