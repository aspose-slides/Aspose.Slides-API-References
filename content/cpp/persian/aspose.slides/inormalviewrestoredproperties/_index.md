...
description: اندازه‌گذاری ناحیه اسلاید را مشخص می‌کند ((عرض زمانی که فرزند restoredTop باشد، ارتفاع زمانی که فرزند restoredLeft باشد) نمای عادی، زمانی که ناحیه دارای اندازهٔ بازگردانده‌شدهٔ متغیر (نه کمینه‌شده و نه بیشینه‌شده) باشد.
type: docs
weight: 2991
url: /fa/aspose.slides/inormalviewrestoredproperties/
---
## کلاس INormalViewRestoredProperties

اندازه‌گذاری منطقه اسلاید را مشخص می‌کند ((عرض زمانی که فرزند restoredTop باشد، ارتفاع زمانی که فرزند restoredLeft باشد) برای نمای عادی، هنگامی که منطقه دارای اندازهٔ بازگردانده‌شدهٔ متغیر (نه کمینه‌شده و نه بیشینه‌شده) باشد).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه‌ی شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر هیچ مقداریتی نیست، از جمله NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه‌ی شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، هرچند طبق IEC 60559:1989 NaN برابر هیچ مقداریتی نیست، از جمله NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی استفاده می‌شود. |
| virtual **bool** [get_AutoAdjust](./get_autoadjust/)() | مشخص می‌کند که آیا اندازهٔ ناحیهٔ محتویات جانبی باید هنگام تغییر اندازهٔ پنجرهٔ حاوی نمای در برنامه، برای اندازهٔ جدید جبران شود. Read **bool**. |
| virtual **float** [get_DimensionSize](./get_dimensionsize/)() | اندازهٔ منطقه اسلاید را مشخص می‌کند (عرض زمانی که فرزند RestoredTop باشد، ارتفاع زمانی که فرزند RestoredLeft باشد). Read **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌نماید و امکان ساخت کپی در زیرکلاس‌ها را فراهم می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر انتساب. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌نماید و امکان ساخت کپی در زیرکلاس‌ها را فراهم می‌کند. |
...
| virtual void [set_AutoAdjust](./set_autoadjust/)(**bool**) | مشخص می‌کند که آیا اندازهٔ ناحیهٔ محتویات جانبی باید هنگام تغییر اندازهٔ پنجرهٔ حاوی نمای در برنامه، برای اندازهٔ جدید جبران شود. Write **bool**. |
| virtual void [set_DimensionSize](./set_dimensionsize/)(**float**) | اندازهٔ منطقه اسلاید را مشخص می‌کند (عرض زمانی که فرزند RestoredTop باشد، ارتفاع زمانی که فرزند RestoredLeft باشد). Write **float**. |
