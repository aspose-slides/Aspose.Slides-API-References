...
| Method | Description |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | نمونه فعلی را با شیء دیگری از همان نوع مقایسه می‌کند. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | سبک تراز یک تب را برمی‌گرداند. برای مطالعه [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | موقعیت یک تب را برمی‌گرداند. انتساب به این خاصیت می‌تواند شاخص تب را در مجموعه تغییر دهد و Enumerator را نامعتبر کند. فقط خواندنی **double**. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهبانی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| [Object](../../system/object/object/)() | شیء را ساخته و تمام ساختارهای داده داخلی را مقداردهی اولیه می‌کند. |
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازندهٔ کپی. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن کپی از زیرکلاس‌ها را می‌دهد. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | سبک تراز یک تب را تنظیم می‌کند. برای نوشتن [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | موقعیت یک تب را تنظیم می‌کند. انتساب به این خاصیت می‌تواند شاخص تب را در مجموعه تغییر دهد و Enumerator را نامعتبر کند. برای نوشتن **double**. |
...
| [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | یک [Tab](./) جدید ایجاد می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای آزادسازی قفل بیان lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهبانی [LockContext](../../system/lockcontext/) استفاده کنید. |
