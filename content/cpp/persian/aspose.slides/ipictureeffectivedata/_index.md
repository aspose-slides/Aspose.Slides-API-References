...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() | تصویر توکار را برمی‌گرداند. فقط خواندنی [IPPImage](../ippimage/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/)\> [get_ImageTransform](./get_imagetransform/)() | مجموعهٔ اثرات تبدیل تصویر را برمی‌گرداند. فقط خواندنی [Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IEffectEffectiveData](../../aspose.slides.effects/ieffecteffectivedata/)\> [get_ImageTransformEffect](./get_imagetransformeffect/)(**int32_t**) | اثر تبدیل تصویر مشخص‌شده در اندیس را برمی‌گرداند. |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | آدرس URL تصویر پیوندی را برمی‌گرداند. فقط خواندنی [System::String](../../system/string/). |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل کردن عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء sentry [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عملگر تخصیص. در واقع چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی می‌کند و امکان ساخت کپی برای زیرکلاس‌ها را فراهم می‌آورد. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام الگو را به یک اشاره‌گر ضعیف (به‌جای مشترک) تنظیم می‌کند. امکان تعویض اشاره‌گرها در محفظه‌ها به حالت ضعیف را فراهم می‌کند. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارندهٔ مرجع مشترک را کاهش می‌دهد و برمی‌گرداند. نباید به‌صورت مستقیم صدا زده شود؛ در عوض، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای بازکردن قفل عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم صدا بزنید یا از شیء sentry [LockContext](../../system/lockcontext/) استفاده کنید. |
