...
---
## ITextSearchOptions کلاس

گزینه‌هایی را که می‌توان برای جستجوی متن در یک [Presentation](../presentation/)، [Slide](../slide/) یا [TextFrame](../textframe/) استفاده کرد، نشان می‌دهد.
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | برای استفاده از جستجوی حساس به حروف بزرگ مقدار true را تنظیم کنید، در غیر این صورت false. خواندن **bool**. |
| virtual **bool** [get_IncludeNotes](./get_includenotes/)() | برای شامل کردن متن موجود در یادداشت‌های اسلاید هنگام انجام جستجو، جایگزینی یا برجسته‌سازی مقدار **true** را تنظیم کنید. مقدار پیش‌فرض **false** است. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | برای مطابقت فقط با کلمات کامل مقدار true را تنظیم کنید، در غیر این صورت false. خواندن **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ساختار داده شمارنده مرجع مرتبط با شیء را دریافت می‌کند. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | معادل متد [Object.GetHashCode()](../../system/object/gethashcode/) C#. هش‌سازی اشیاء سفارشی را امکان‌پذیر می‌کند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری دستور lock() C#. به‌صورت مستقیم صدا بزنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | برای استفاده از جستجوی حساس به حروف بزرگ مقدار true را تنظیم کنید، در غیر این صورت false. نوشتن **bool**. |
| virtual void [set_IncludeNotes](./set_includenotes/)(**bool**) | برای شامل کردن متن موجود در یادداشت‌های اسلاید هنگام انجام جستجو، جایگزینی یا برجسته‌سازی مقدار **true** را تنظیم کنید. مقدار پیش‌فرض **false** است. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | برای مطابقت فقط با کلمات کامل مقدار true را تنظیم کنید، در غیر این صورت false. نوشتن **bool**. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | اجرای سازه typeof([System.Object](../../system/object/)) C#. |
| void [Unlock](../../system/object/unlock/)() | اجرای بازقفل‌گذاری دستور lock() C#. به‌صورت مستقیم صدا بزنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
