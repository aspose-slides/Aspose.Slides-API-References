...
description: ویژگی‌های نمای اسلاید مشترک را توصیف می‌کند.
type: docs
weight: 1834
url: /fa/aspose.slides/icommonslideviewproperties/
---
## ICommonSlideViewProperties کلاس


نمایش مشترک ویژگی‌های اسلاید را توصیف می‌کند.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه‌ی شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، اگرچه طبق IEC 60559:1989 NaN برابر با هیچ مقداری نیست، از جمله NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه‌ی شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند، اگرچه طبق IEC 60559:1989 NaN برابر با هیچ مقداری نیست، از جمله NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای استفاده داخلی. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | راهنمای رسم را در ایندکس مشخص برمی‌گرداند. فقط-خواندنی [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | مجموعه‌ی راهنمای‌های رسم را برمی‌گرداند. فقط-خواندنی [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | نسبت مقیاس‌گذاری نمایش را به درصد مشخص می‌کند. خواندن **int32_t**. |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | مشخص می‌کند که محتوای نمایش به‌صورت خودکار برای بهترین تناسب با اندازهٔ پنجرهٔ فعلی مقیاس‌بندی شود. خواندن **bool**. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری عبارت C# lock() را پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور انتساب. در واقع هیچ چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساخت کپی برای کلاس‌های فرزند را فراهم می‌کند. |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | نسبت مقیاس‌گذاری نمایش را به درصد مشخص می‌کند. نوشتن **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | مشخص می‌کند که محتوای نمایش به‌صورت خودکار برای بهترین تناسب با اندازهٔ پنجرهٔ فعلی مقیاس‌بندی شود. نوشتن **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای قفل‌گذاری عبارت C# lock() را برای بازکردن پیاده‌سازی می‌کند. مستقیماً فراخوانی کنید یا از شیء نگهبان [LockContext](../../system/lockcontext/) استفاده کنید. |
