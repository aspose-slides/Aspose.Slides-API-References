...
description: داده‌های قالب‌بندی پر مؤثر را با اعمال وراثت دریافت می‌کند.
type: docs
weight: 105
...
داده‌های قالب‌بندی پر مؤثر را با اعمال وراثت دریافت می‌کند.
...
این مثال نحوه دریافت خصوصیات قالب‌پر رنگ مؤثر شکل را نشان می‌دهد. 
```cpp
