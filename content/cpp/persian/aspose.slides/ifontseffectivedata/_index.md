...
---
## IFontsEffectiveData کلاس

شیء غیرقابل تغییر که مجموعهٔ قلم‌های مؤثر را شامل می‌شود.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند حتی اگر طبق IEC 60559:1989 NaN برابر هیچ مقدارى، از جمله NaN، نیست. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | مقایسه نقطه شناور به سبک C# را شبیه‌سازی می‌کند که در آن دو NaN برابر در نظر گرفته می‌شوند حتی اگر طبق IEC 60559:1989 NaN برابر هیچ مقدارى، از جمله NaN، نیست. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() | قلم اسکریپت پیچیده را بازمی‌گرداند. فقط-خواندنی [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() | قلم آسیای شرقی را بازمی‌گرداند. فقط-خواندنی [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() | قلم لاتین را بازمی‌گرداند. فقط-خواندنی [IFontData](../ifontdata/). |
...
| void [Unlock](../../system/object/unlock/)() | اجرای بازقفل‌کردن عبارت lock() در C# را پیاده‌سازی می‌کند. به‌صورت مستقیم فراخوانی کنید یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده کنید. |
...
این رابط به عنوان بخشی از رابط‌های [IBasePortionFormatEffectiveData](../ibaseportionformateffectivedata/) و [Theme::IFontSchemeEffectiveData](../../aspose.slides.theme/ifontschemeeffectivedata/) استفاده می‌شود. 
