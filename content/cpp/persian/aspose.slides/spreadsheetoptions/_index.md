...
description: گزینه‌هایی را نشان می‌دهد که می‌توان برای تعیین رفتارهای اضافی صفحه‌گسترده‌ها استفاده کرد.
type: docs
weight: 5266
...
گزینه‌هایی را نشان می‌دهد که می‌توان برای تعیین رفتارهای اضافی صفحه‌گسترده‌ها استفاده کرد.
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() override | اطلاعات فرهنگ ترجیحی را برای محاسبه برخی توابع که برای استفاده با زبان‌هایی که مجموعه کاراکتر دو بایتی (DBCS) استفاده می‌کنند، دریافت می‌کند. |
| **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() override | اگر منبع داده برای نمودار یک کتاب کار خارجی باشد و در دسترس نباشد، از حافظه پنهان نمودار بازیابی می‌شود. |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری با استفاده از عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی شود یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده شود. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | به‌صورت ارجاعی شیء از نوع مقدار را با nullptr مقایسه می‌کند. |
...
| void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) override | اطلاعات فرهنگ ترجیحی را برای محاسبه برخی توابع که برای استفاده با زبان‌هایی که مجموعه کاراکتر دو بایتی (DBCS) استفاده می‌کنند، تنظیم می‌کند. |
| void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) override | اگر منبع داده برای نمودار یک کتاب کار خارجی باشد و در دسترس نباشد، از حافظه پنهان نمودار بازیابی می‌شود. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | شمارنده مرجع مشترک را افزایش می‌دهد. نباید به‌صورت مستقیم فراخوانی شود؛ در عوض، از هوشمندهای اشاره‌گر یا ThisProtector استفاده کنید. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع مشترک را کاهش داده و مقدار آن را باز می‌گرداند. نباید به‌صورت مستقیم فراخوانی شود؛ در عوض، از هوشمندهای اشاره‌گر یا ThisProtector استفاده کنید. |
|  [SpreadsheetOptions](./spreadsheetoptions/)() | یک نمونه جدید از کلاس [SpreadsheetOptions](./) را مقداردهی اولیه می‌کند. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌گذاری عمودی (unlock) با استفاده از عبارت lock() در C# را پیاده‌سازی می‌کند. مستقیماً فراخوانی شود یا از شیء مراقب [LockContext](../../system/lockcontext/) استفاده شود. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | شمارنده مرجع ضعیف را افزایش می‌دهد. نباید به‌صورت مستقیم فراخوانی شود؛ در عوض، از هوشمندهای اشاره‌گر یا ThisProtector استفاده کنید. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | شمارنده مرجع ضعیف را کاهش می‌دهد. نباید به‌صورت مستقیم فراخوانی شود؛ در عوض، از هوشمندهای اشاره‌گر یا ThisProtector استفاده کنید. |
| virtual  [~Object](../../system/object/~object/)() | شیء را از بین می‌برد. تمام ساختارهای داده داخلی را آزاد می‌کند. |

## ارجاع‌ها

* کلاس [ISpreadsheetOptions](../ispreadsheetoptions/)
