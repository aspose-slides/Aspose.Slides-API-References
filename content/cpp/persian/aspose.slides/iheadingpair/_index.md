...
description: نمایانگر ویژگی «Heading pair» سند است. این ویژگی نام گروه قسمت‌های سند و تعداد قسمت‌ها در گروه را نشان می‌دهد.
type: docs
weight: 2510
...
نمایانگر ویژگی «Heading pair» اسناد است. این ویژگی نام گروه قسمت‌های سند و تعداد قسمت‌ها در گروه را نشان می‌دهد.
...
| virtual **int32_t** [get_Count](./get_count/)() | تعداد بخش‌های موجود در گروه را برمی‌گرداند. فقط-خواندنی **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | نام گروه قسمت‌های سند را برمی‌گرداند. فقط-خواندنی [System::String](../../system/string/). |
...
| void [Lock](../../system/object/lock/)() | قفل‌گذاری عبارت lock() در C# را پیاده‌سازی می‌کند. به طور مستقیم صدا بزنید یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل متد C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). امکان تولید نسخه‌کپی از انواع سفارشی را فراهم می‌کند. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | آرگومان nام قالب را به اشاره‌گر ضعیف (به جای مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در کانتینرها به حالت ضعیف را فراهم می‌آورد. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارندهٔ مرجع اشتراکی را کاهش داده و برمی‌گرداند. نباید مستقیماً فراخوانی شود؛ در عوض، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | قفل‌برداری عبارت lock() در C# را پیاده‌سازی می‌کند. به طور مستقیم صدا بزنید یا از شیء محافظ [LockContext](../../system/lockcontext/) استفاده کنید. |
