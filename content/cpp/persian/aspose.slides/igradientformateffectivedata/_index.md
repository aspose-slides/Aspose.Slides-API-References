...
description: شیء غیرقابل تغییر که شامل ویژگی‌های مؤثر پرکننده گرادیان است.
type: docs
weight: 2393
url: /fa/aspose.slides/igradientformateffectivedata/
---
## IGradientFormatEffectiveData کلاس

شیء غیرقابل تغییر که شامل ویژگی‌های پرکننده گرادیان مؤثر است.
...
| virtual [Aspose::Slides::GradientDirection](../gradientdirection/) [get_GradientDirection](./get_gradientdirection/)() | سبک یک گرادیان را برمی‌گرداند. فقط خواندنی [Slides::GradientDirection](../gradientdirection/). |
| virtual [Aspose::Slides::GradientShape](../gradientshape/) [get_GradientShape](./get_gradientshape/)() | شکل یک گرادیان را برمی‌گرداند. فقط خواندنی [Slides::GradientShape](../gradientshape/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\> [get_GradientStop](./get_gradientstop/)(**int32_t**) | یک نقطه‌توقف گرادیان را در ایندکس مشخص شده برمی‌گرداند. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)\> [get_GradientStops](./get_gradientstops/)() | مجموعهٔ نقاط‌توقف گرادیان را برمی‌گرداند. فقط خواندنی [IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/). |
| virtual **float** [get_LinearGradientAngle](./get_lineargradientangle/)() | زاویهٔ یک گرادیان را برمی‌گرداند. فقط خواندنی **float**. |
| virtual **bool** [get_LinearGradientScaled](./get_lineargradientscaled/)() | تشخیص می‌دهد که آیا یک گرادیان مقیاس‌بندی شده است یا خیر. فقط خواندنی **bool**. |
| virtual [Aspose::Slides::TileFlip](../tileflip/) [get_TileFlip](./get_tileflip/)() | حالت وارون‌سازی گرادیان را برمی‌گرداند. فقط خواندنی [Slides::TileFlip](../tileflip/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | بررسی می‌کند که آیا شیء نشان‌دهندهٔ نمونه‌ای از نوع توصیف‌شده توسط targetType است. معادل عملگر 'is' در C#. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | معادل متد C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). امکان کپی‌برداری از انواع سفارشی را فراهم می‌آورد. |
