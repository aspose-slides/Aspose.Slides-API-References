...
description: "تنظیمات پایهٔ نمایش اسلاید. اجداد نشان‌دهندهٔ انواع نمایش اسلاید هستند: PresentedBySpeaker نمایش توسط سخنران (تمام صفحه) BrowsedByIndividual نمایش توسط فرد (پنجره) BrowsedAtKiosk نمایش در کیوسک (تمام صفحه)"
type: docs
weight: 5227
...
تنظیمات پایهٔ نمایش اسلاید. اجداد نشان‌دهندهٔ انواع نمایش اسلاید هستند: [PresentedBySpeaker](../presentedbyspeaker/) ارائه‌شده توسط سخنران (تمام صفحه) [BrowsedByIndividual](../browsedbyindividual/) مرور شده توسط فرد (پنجره) [BrowsedAtKiosk](../browsedatkiosk/) مرور شده در کیوسک (تمام صفحه)
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | معادل متد [Object.GetHashCode()](../../system/object/gethashcode/) در C# است. قابلیت هش‌کردن اشیاء سفارشی را فراهم می‌کند. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | سازنده کپی. در واقع هیچ‌چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن نسخه‌های کپی از کلاس‌های مشتق‌شده را فراهم می‌کند. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | اپراتور انتساب. در واقع هیچ‌چیزی را کپی نمی‌کند، فقط شیء جدید را مقداردهی اولیه می‌کند و امکان ساختن نسخه‌های کپی از کلاس‌های مشتق‌شده را فراهم می‌کند. |
