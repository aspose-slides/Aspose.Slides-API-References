...
اندازه و جهت یک اسلاید را نشان می‌دهد.
...
| Method | Description |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | آبجکت‌ها را با استفاده از [Object.Equals](../../system/object/equals/) C# مقایسه می‌کند. |
...
| virtual [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() | جهت اسلاید را دریافت می‌کند. |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | بعدهای اسلاید را بر حسب نقطه دریافت می‌کند. اختصاص مقدار جدید، مقدار [ISlideSize::get_Type](./get_type/) را به [SlideSizeType::Custom](../slidesizetype/) بازنشانی و [ISlideSize::get_Orientation](./get_orientation/) را تنظیم می‌کند. |
| virtual [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() | نوع اندازه اسلاید را دریافت می‌کند. اختصاص هر مقدار به جز [SlideSizeType::Custom](../slidesizetype/)، [ISlideSize::get_Size](./get_size/) را بر اساس ابعاد پیش‌تعریف‌شده تنظیم می‌کند، در حالی که [ISlideSize::get_Orientation](./get_orientation/) جاری حفظ می‌شود. |
...
| void [Lock](../../system/object/lock/)() | اجرا کننده قفل‌گذاری بیان lock() در C#. مستقیماً صدا بزنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | مقایسه مرجع برای آبجکت نوع مقدار با nullptr. |
...
| virtual void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) | جهت اسلاید را تنظیم می‌کند. |
| virtual void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) | اندازه اسلاید را بر اساس نوع تنظیم می‌کند و محتوای موجود را مقیاس می‌دهد. اختصاص هر مقداری به جز [SlideSizeType::Custom](../slidesizetype/)، [ISlideSize::get_Size](./get_size/) را بر پایه نوع انتخاب‌شده تنظیم می‌کند، در حالی که [ISlideSize::get_Orientation](./get_orientation/) حفظ می‌شود. |
| virtual void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) | ابعاد اسلاید را به‌صورت صریح تنظیم می‌کند و محتوای موجود را مقیاس می‌دهد. این کار مقدار [ISlideSize::get_Type](./get_type/) را به [SlideSizeType::Custom](../slidesizetype/) بازنشانی و [ISlideSize::get_Orientation](./get_orientation/) را تنظیم می‌کند. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | شمارنده مرجع مشترک را افزایش می‌دهد. نباید مستقیماً فراخوانی شود؛ به جای آن از پوینترهای هوشمند یا ThisProtector استفاده کنید. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارنده مرجع مشترک را کاهش می‌دهد و باز می‌گرداند. نباید مستقیماً فراخوانی شود؛ به جای آن از پوینترهای هوشمند یا ThisProtector استفاده کنید. |
...
| void [Unlock](../../system/object/unlock/)() | اجرا کننده باز کردن قفلِ بیان lock() در C#. مستقیماً صدا بزنید یا از شیء [LockContext](../../system/lockcontext/) استفاده کنید. |
