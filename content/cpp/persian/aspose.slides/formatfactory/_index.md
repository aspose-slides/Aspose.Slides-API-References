...
اجازه می‌دهد فرمت‌ها را از طریق رابط COM ایجاد کنید.
...
| متد | توضیح |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [CreateParagraphFormat](./createparagraphformat/)() override | یک [IParagraphFormat](../iparagraphformat/) جدید ایجاد می‌کند. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [CreatePortionFormat](./createportionformat/)() override | یک [IPortionFormat](../iportionformat/) جدید ایجاد می‌کند. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\> [CreateTextFrameFormat](./createtextframeformat/)() override | یک [ITextFrameFormat](../itextframeformat/) جدید ایجاد می‌کند. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[FormatFactory](./)\> [get_Instance](./get_instance/)() | نمونه استاتیک کارخانه‌فرمت. فقط‌خواندنی [FormatFactory](./). |
...
| void [Lock](../../system/object/lock/)() | اجرا می‌کند قفل‌گذاری عبارت C# lock(). مستقیماً فراخوانی شود یا از شیء نگهبانی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | اجرا می‌کند ساختار typeof([System.Object](../../system/object/)) در C#. |
| void [Unlock](../../system/object/unlock/)() | اجرا می‌کند بازکردن قفل عبارت C# lock(). مستقیماً فراخوانی شود یا از شیء نگهبانی [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [IFormatFactory](../iformatfactory/)
