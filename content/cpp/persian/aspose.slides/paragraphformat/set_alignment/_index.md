...
description: تنظیم تراز متن در یک پاراگراف بدون ارث‌بری. TextAlignment را بنویسید.
type: docs
weight: 14
url: /fa/aspose.slides/paragraphformat/set_alignment/
---
## ParagraphFormat::set_Alignment(TextAlignment) متد

متن را در یک پاراگراف بدون ارث‌بری تنظیم می‌کند. بنویسید [TextAlignment](../../textalignment/).
...
کد نمونه زیر نشان می‌دهد که چگونه پاراگراف‌های متن را در PowerPoint [Presentation](../../presentation/) تنظیم کنید.
```cpp
