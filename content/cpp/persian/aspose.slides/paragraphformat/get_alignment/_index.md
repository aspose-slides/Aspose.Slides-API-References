...
description: ترازبندی متن در یک پاراگراف بدون ارث‌بری را برمی‌گرداند. درباره TextAlignment بخوانید.
type: docs
weight: 1
url: /fa/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() متد

ترازبندی متن در یک پاراگراف بدون ارث‌بری را برمی‌گرداند. خواندن [TextAlignment](../../textalignment/).
...
کد نمونه زیر نشان می‌دهد چگونه پاراگراف‌های متن را در PowerPoint [Presentation](../../presentation/) هم‌ترازبند کنید.
```cpp
