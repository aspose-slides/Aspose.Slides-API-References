...
description: "خواص نمای عادی را نمایش می‌دهد. نمای عادی شامل سه ناحیه محتوا است: خود اسلاید، یک ناحیه محتوا جانبی، و یک ناحیه محتوا پایین."
type: docs
weight: 4525
...
نمایش عادی را نمایان می‌کند. نمایش عادی شامل سه منطقه محتوا است: خود اسلاید، یک منطقه محتوی جانبی، و یک منطقه محتوی پایینی.
...
مثال زیر نشان می‌دهد چطور می‌توانید ویژگی‌های [ViewProperties::get_NormalViewProperties](../viewproperties/get_normalviewproperties/) یک PowerPoint [Presentation](../presentation/) را پیکربندی کنید.

```cpp
// شیء ارائه‌ای را ایجاد می‌کند که نمایانگر یک فایل ارائه است
...
* کلاس [INormalViewProperties](../inormalviewproperties/)
