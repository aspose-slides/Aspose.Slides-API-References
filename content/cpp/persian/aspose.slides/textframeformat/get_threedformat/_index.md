...
description: شیء ThreeDFormat که ویژگی‌های اثر سه‌بعدی برای یک متن را نشان می‌دهد برمی‌گرداند. فقط‌خواندنی IThreeDFormat.
type: docs
weight: 1
url: /fa/aspose.slides/textframeformat/get_threedformat/
---
## TextFrameFormat::get_ThreeDFormat() متد

شیء [ThreeDFormat](../../threedformat/) که ویژگی‌های اثر سه‌بعدی برای یک متن را نشان می‌دهد را برمی‌گرداند. فقط‌خواندنی [IThreeDFormat](../../ithreedformat/).
