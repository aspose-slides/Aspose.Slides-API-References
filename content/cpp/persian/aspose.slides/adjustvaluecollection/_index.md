...
description: نمایش دهنده یک مجموعه از تنظیمات شکل.
type: docs
weight: 14
url: /fa/aspose.slides/adjustvaluecollection/
---
## کلاس AdjustValueCollection
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | شبیه‌سازی مقایسه نقطه‌شناور به سبک C# که در آن دو NaN به‌عنوان برابر در نظر گرفته می‌شوند، اگرچه بر طبق IEC 60559:1989 NaN برابر با هیچ مقداری نیست، از جمله NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | شبیه‌سازی مقایسه نقطه‌شناور به سبک C# که در آن دو NaN به‌عنوان برابر در نظر گرفته می‌شوند، اگرچه بر طبق IEC 60559:1989 NaN برابر با هیچ مقداری نیست، از جمله NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | فقط برای مقاصد داخلی. |
| **int32_t** [get_Count](./get_count/)() override | تعداد تنظیمات را باز می‌گرداند. **int32_t** فقط‌خواندنی. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [idx_get](./idx_get/)(**int32_t**) override | تنظیمات را بر اساس اندیس باز می‌گرداند. |
...
| void [Lock](../../system/object/lock/)() | اجرای قفل‌گذاری دستور lock() در C#. به‌صورت مستقیم فراخوانی کنید یا از شیء مستقر [LockContext](../../system/lockcontext/) استفاده کنید. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | آرگومان nام تمپلیت را به یک اشاره‌گر ضعیف (نه مشترک) تنظیم می‌کند. امکان تغییر اشاره‌گرها در کانتینرها به حالت ضعیف را فراهم می‌سازد. |
...
| void [Unlock](../../system/object/unlock/)() | اجرای باز کردن قفل دستور lock() در C#. به‌صورت مستقیم فراخوانی کنید یا از شیء مستقر [LockContext](../../system/lockcontext/) استفاده کنید. |
...
* کلاس [IAdjustValueCollection](../iadjustvaluecollection/)
