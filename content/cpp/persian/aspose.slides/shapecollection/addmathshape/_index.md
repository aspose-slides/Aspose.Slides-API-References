...
description: یک شکل خودکار مستطیلی جدید برای میزبانی محتوای ریاضی ایجاد می‌کند و آن را به انتهای مجموعه شکل‌ها اضافه می‌نماید.
type: docs
weight: 365
url: /fa/aspose.slides/shapecollection/addmathshape/
---
## ShapeCollection::AddMathShape(float, float, float, float) متد

یک شکل مستطیلی خودکار جدید برای محتوای ریاضی ایجاد می‌کند و آن را به انتهای مجموعه شکل‌ها اضافه می‌نماید.
...
| --- | --- | --- |
| x | **float** | مختصات x چارچوب شکل، به واحد پوینت. |
| y | **float** | مختصات y چارچوب شکل، به واحد پوینت. |
| width | **float** | عرض چارچوب شکل، به واحد پوینت. |
| height | **float** | ارتفاع چارچوب شکل، به واحد پوینت. |
...
مثال زیر نشان می‌دهد چطور یک معادله ریاضی در PowerPoint [Presentation](../../presentation/) اضافه شود.
```cpp
