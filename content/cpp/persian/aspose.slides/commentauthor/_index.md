...
description: نمایان‌گر نویسنده‌ای از نظرات است.
type: docs
weight: 430
...
نمایان‌گر نویسنده‌ای از نظرات است.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | نظر ایجاد شده توسط این نویسنده در ایندکس مشخص شده را باز می‌گرداند. فقط-خواندنی [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | مجموعه نظرات ایجاد شده توسط این نویسنده را باز می‌گرداند. فقط-خواندنی [ICommentCollection](../icommentcollection/). |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | حروف اول نویسنده را باز می‌گرداند. فقط [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | نام نویسنده را باز می‌گرداند. فقط [System::String](../../system/string/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | مقایسهٔ مرجع‌ای شیء از نوع مقدار با nullptr. |
...
| void [Remove](./remove/)() override | نویسنده را از مجموعهٔ والد حذف می‌کند. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | تعداد شمارندهٔ مرجع مشترک را به مقدار مشخص کاهش می‌دهد. |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | حروف اول نویسنده را تنظیم می‌کند. قابل نوشتن [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | نام نویسنده را تنظیم می‌کند. قابل نوشتن [System::String](../../system/string/). |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | شمارندهٔ مرجع مشترک را افزایش می‌دهد. نباید به‌صورت مستقیم فراخوانده شود؛ در عوض، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | شمارندهٔ مرجع مشترک را کاهش می‌دهد و مقدار آن را باز می‌گرداند. نباید به‌صورت مستقیم فراخوانده شود؛ در عوض، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | شمارندهٔ مرجع ضعیف را افزایش می‌دهد. نباید به‌صورت مستقیم فراخوانده شود؛ در عوض، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | شمارندهٔ مرجع ضعیف را کاهش می‌دهد. نباید به‌صورت مستقیم فراخوانده شود؛ در عوض، از اشاره‌گرهای هوشمند یا ThisProtector استفاده کنید. |
