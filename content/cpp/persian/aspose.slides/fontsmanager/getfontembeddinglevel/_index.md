...
---
## FontsManager::GetFontEmbeddingLevel(System::ArrayPtr\<uint8_t\>, System::String) متد
...
| پارامتر | نوع | توضیح |
| --- | --- | --- |
| fontBytes | [System::ArrayPtr](../../../system/arrayptr/)\<**uint8_t**\> | آرایه بایتی حاوی داده‌های قلم. |
