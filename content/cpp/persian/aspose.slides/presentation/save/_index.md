...
description: تمام اسلایدهای یک ارائه را در فایلی با قالب مشخص ذخیره می‌کند.
type: docs
weight: 443
...
تمام اسلایدهای یک ارائه را در فایلی با قالب مشخص ذخیره می‌کند.
...
تمام اسلایدهای یک ارائه را در یک جریان با قالب مشخص ذخیره می‌کند.
...
تمام اسلایدهای یک ارائه را در فایلی با قالب مشخص و گزینه‌های اضافی ذخیره می‌کند.
...
| fname | [System::String](../../../system/string/) | مسیر فایل ایجاد شده. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | قالب داده‌های صادر شده. |
| options | [System::SharedPtr](../../../system/sharedptr/)\<[Export::ISaveOptions](../../../aspose.slides.export/isaveoptions/)\> | گزینه‌های اضافی قالب. |
## توضیحات



مثال زیر نشان می‌دهد که چگونه می‌توان PowerPoint را با استفاده از C++ به HTML تبدیل کرد.
```cpp
// یک شیء ارائه می‌سازد که نمایانگر یک فایل ارائه مانند PPT، PPTX، ODP و غیره است.
...
```
مثال زیر نشان می‌دهد که چگونه می‌توان PowerPoint را با استفاده از C++ به HTML واکنشگرا تبدیل کرد.
```cpp
...
// ارائه را به HTML ذخیره می‌کند
presentation->Save(u"ConvertPresentationToResponsiveHTML_out.html", SaveFormat::Html, htmlOptions);
```
مثال زیر نشان می‌دهد که چگونه می‌توان PowerPoint را با استفاده از C++ به HTML با یادداشت‌ها تبدیل کرد.
```cpp
...
```
مثال زیر نشان می‌دهد که چگونه می‌توان PowerPoint را با استفاده از C++ به HTML با فونت‌های اصلی تبدیل کرد.
```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// فونت‌های پیش‌فرض ارائه را مستثنی می‌کند
...
```
مثال زیر نشان می‌دهد که چگونه می‌توان PowerPoint را با استفاده از C++ به HTML با تصاویر با کیفیت بالا در 150 DPI تبدیل کرد.
```cpp
...
```
مثال زیر نشان می‌دهد که چگونه می‌توان PowerPoint را با استفاده از C++ به HTML با تصاویر با کیفیت کامل تبدیل کرد.
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
مثال زیر نشان می‌دهد که چگونه می‌توان [Slide](../../slide/) را با استفاده از C++ به HTML تبدیل کرد.
```cpp
```
