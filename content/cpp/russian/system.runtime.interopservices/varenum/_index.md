...
description: Определяет, как должны маршалиться элементы массива.
type: docs
weight: 105
url: /ru/system.runtime.interopservices/varenum/
---
...
| VT_CY | 6 | Использует правила валюты. |
...
| VT_USERDEFINED | 29 | Тип, определённый пользователем. |
| VT_LPSTR | 30 | Строка символов, завершаемая нулём. |
| VT_LPWSTR | 31 | Строка wchar_t, завершаемая нулём. |
| VT_RECORD | 36 | Тип, определённый пользователем. |
| VT_FILETIME | 64 | Имя файла. |
| VT_BLOB | 65 | Массив байтов с префиксом длины. |
| VT_STREAM | 66 | Имя потока. |
| VT_STORAGE | 67 | Имя хранилища. |
| VT_STREAMED_OBJECT | 68 | [Object](../../system/object/) сериализован в потоке. |
| VT_STORED_OBJECT | 69 | [Object](../../system/object/) сериализован в хранилище. |
| VT_BLOB_OBJECT | 70 | [Object](../../system/object/) сериализован в blob. |
