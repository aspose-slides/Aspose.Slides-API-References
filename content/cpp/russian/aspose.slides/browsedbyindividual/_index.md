...
description: Просмотр отдельным пользователем (окно)
type: docs
weight: 222
...
| **bool** [get_ShowScrollbar](./get_showscrollbar/)() const | Показать полосу прокрутки в окне |
...
| void [set_ShowScrollbar](./set_showscrollbar/)(**bool**) | Показать полосу прокрутки в окне |
