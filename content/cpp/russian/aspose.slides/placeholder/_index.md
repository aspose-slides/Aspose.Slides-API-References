...
| **uint32_t** [get_Index](./get_index/)() override | Возвращает индекс заполнителя. Только для чтения **uint32_t**. |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Возвращает ориентацию заполнителя. Только для чтения [Slides::Orientation](../orientation/). |
| [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() override | Возвращает размер заполнителя. Только для чтения [PlaceholderSize](../placeholdersize/). |
| [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() override | Возвращает тип заполнителя. Только для чтения [PlaceholderType](../placeholdertype/). |
