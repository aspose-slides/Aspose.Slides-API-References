...
| virtual **uint32_t** [get_Index](./get_index/)() | Возвращает индекс заполнителя. Только для чтения **uint32_t**. |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Возвращает ориентацию заполнителя. Только для чтения [Slides::Orientation](../orientation/). |
| virtual [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() | Возвращает размер заполнителя. Только для чтения [PlaceholderSize](../placeholdersize/). |
| virtual [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() | Возвращает тип заполнителя. Только для чтения [PlaceholderType](../placeholdertype/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й параметр шаблона как слабый указатель (а не общий). Позволяет переключать указатели в контейнерах в режим weak. |
