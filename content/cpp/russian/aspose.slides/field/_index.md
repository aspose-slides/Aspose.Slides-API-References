...
| [System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\> [get_Type](./get_type/)() override | Возвращает тип поля. Читайте [IFieldType](../ifieldtype/). |
...
| void [set_Type](./set_type/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) override | Устанавливает тип поля. Записать [IFieldType](../ifieldtype/). |
