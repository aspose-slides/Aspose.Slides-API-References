...
| Метод | Описание |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [CreateParagraph](./createparagraph/)() | Создает новый пустой параграф. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [CreateParagraph](./createparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Создает новый параграф с указанными данными параграфа, используя. |
