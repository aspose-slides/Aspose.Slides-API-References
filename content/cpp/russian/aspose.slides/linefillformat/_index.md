...
| [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() override | Возвращает формат заливки узором. Только для чтения [IPatternFormat](../ipatternformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() override | Возвращает цвет сплошной заливки. Только для чтения [IColorFormat](../icolorformat/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру данных счётчика ссылок, связанную с объектом. |
| **int32_t** [GetHashCode](../pviobject/gethashcode/)() const override | Возвращает код хэша. |
...
* Класс [ILineFillFormat](../ilinefillformat/)
