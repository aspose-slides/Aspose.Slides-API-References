...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Возвращает объект свойств заполнения таблицы. Только для чтения [IFillFormat](../ifillformat/). |
...
| **float** [get_Transparency](./get_transparency/)() override | Получает прозрачность цвета заполнения. Чтение **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() override | Получает эффективные свойства форматирования таблицы с учётом наследования и применённых стилей таблицы. |
...
| void [set_Transparency](./set_transparency/)(**float**) override | Устанавливает прозрачность цвета заполнения. Запись **float**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Устанавливает n-й параметр шаблона в виде слабой ссылки (вместо общей). Позволяет переключать указатели в контейнерах в режим слабой ссылки. |
...
* Класс [ITableFormat](../itableformat/)
