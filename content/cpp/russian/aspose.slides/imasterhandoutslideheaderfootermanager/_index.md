...
description: Представляет менеджер, который управляет поведением заполнителей мастера раздаточного слайда, включая заполнитель заголовка.
type: docs
weight: 2848
url: /ru/aspose.slides/imasterhandoutslideheaderfootermanager/
---
## IMasterHandoutSlideHeaderFooterManager класс
...
| virtual **bool** [get_IsHeaderVisible](../ibasehandoutnotesslideheaderfootermanag/get_isheadervisible/)() | Получает значение, указывающее, что заполнитель верхнего колонтитула присутствует. Чтение **bool**. |
...
| virtual void [SetHeaderText](../ibasehandoutnotesslideheaderfootermanag/setheadertext/)([System::String](../../system/string/)) | Устанавливает текст в заполнитель верхнего колонтитула слайда. |
| virtual void [SetHeaderVisibility](../ibasehandoutnotesslideheaderfootermanag/setheadervisibility/)(**bool**) | Изменяет видимость заполнителя верхнего колонтитула слайда. |
