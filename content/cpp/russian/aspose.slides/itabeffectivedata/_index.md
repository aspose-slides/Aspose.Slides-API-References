...
description: Неизменяемый объект, содержащий свойства табуляционных стопов эффективного текста.
type: docs
weight: 3992
url: /ru/aspose.slides/itabeffectivedata/
---
## ITabEffectiveData класс

Неизменяемый объект, содержащий свойства табуляционных стопов эффективного текста.
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Возвращает стиль выравнивания табуляции. Только для чтения [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Возвращает позицию табуляции. Присвоение этому свойству может изменить индекс табуляции в коллекции и сделать недействительным Enumerator. Только для чтения **double**. |
