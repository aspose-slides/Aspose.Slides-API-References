...
| virtual void [RemoveHyperlinkClick](./removehyperlinkclick/)() | Удаляет гиперссылку по щелчку. |
| virtual void [RemoveHyperlinkMouseOver](./removehyperlinkmouseover/)() | Удаляет гиперссылку при наведении курсора. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkClick](./setexternalhyperlinkclick/)([System::String](../../system/string/)) | Устанавливает внешнюю гиперссылку по щелчку. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkMouseOver](./setexternalhyperlinkmouseover/)([System::String](../../system/string/)) | Устанавливает внешнюю гиперссылку при наведении курсора. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkClick](./setinternalhyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) | Устанавливает внутреннюю гиперссылку по щелчку. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkMouseOver](./setinternalhyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) | Устанавливает внутреннюю гиперссылку при наведении курсора. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetMacroHyperlinkClick](./setmacrohyperlinkclick/)([System::String](../../system/string/)) | Устанавливает гиперссылку на макрос по щелчку. |
