...
description: Представляет блокировку Shape (операция отключена).
type: docs
weight: 1483
url: /ru/aspose.slides/ibaseshapelock/
---
## IBaseShapeLock класс


Представляет блокировку [Shape](../shape/) (операция отключена).
...
| virtual **bool** [get_NoLocks](./get_nolocks/)() | Возвращает true, если все флаги блокировки отключены. Только для чтения **bool**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-ый аргумент шаблона как слабый указатель (а не совместный). Позволяет переключать указатели в контейнерах в режим слабых. |
