...
type: docs
weight: 898
url: /ru/aspose.slides/floatcolor/
---
## FloatColor класс
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Аналог метода C# Object.GetHashCode(). Позволяет вычислять хеш пользовательских объектов. |
