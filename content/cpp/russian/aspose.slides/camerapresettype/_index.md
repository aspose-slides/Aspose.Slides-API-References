...
description: Константы, определяющие тип предустановки камеры.
type: docs
weight: 5708
url: /ru/aspose.slides/camerapresettype/
---
## CameraPresetType перечисление

Константы, определяющие тип предустановки камеры.
...
* Простой пространство имён [Aspose::Slides](../)
