...
---
## ITextSearchOptions класс

Represents options that can be used to search for text in a [Presentation](../presentation/), [Slide](../slide/) or [TextFrame](../textframe/).
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Установите true для использования чувствительного к регистру поиска, иначе false. Чтение **bool**. |
| virtual **bool** [get_IncludeNotes](./get_includenotes/)() | Установите **true**, чтобы включить текст, содержащийся в заметках слайда, при выполнении поиска текста, замены или подсветки. Значение по умолчанию — **false**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Установите true, чтобы сопоставлять только целые слова, иначе false. Чтение **bool**. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Установите true для использования чувствительного к регистру поиска, иначе false. Запись **bool**. |
| virtual void [set_IncludeNotes](./set_includenotes/)(**bool**) | Установите **true**, чтобы включить текст, содержащийся в заметках слайда, при выполнении поиска текста, замены или подсветки. Значение по умолчанию — **false**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Установите true, чтобы сопоставлять только целые слова, иначе false. Запись **bool**. |
