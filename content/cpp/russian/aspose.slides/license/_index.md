...
| **bool** [IsLicensed](./islicensed/)() override | Проверяет, применена ли лицензия к компоненту. |
...
| void [ResetLicense](./resetlicense/)() override | Сбрасывает лицензию. |
| void [SetLicense](./setlicense/)([System::String](../../system/string/)) override | Лицензирует компонент. |
| void [SetLicense](./setlicense/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Лицензирует компонент. |
...
В этом примере будет выполнена попытка найти файл лицензии с именем MyLicense.lic в папке, содержащей компонент, в папке, содержащей вызывающую сборку, в папке основной сборки, а затем во встроенных ресурсах вызывающей сборки. 
```cpp
