...
description: Представляет неизменяемый объект, содержащий эффективные данные.
type: docs
weight: 2055
url: /ru/aspose.slides/ieffectivedata/
---
## IEffectiveData класс

Представляет неизменяемый объект, содержащий эффективные данные.
