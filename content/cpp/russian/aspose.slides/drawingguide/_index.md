...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Возвращает цвет направляющей рисования. Читайте [System::Drawing::Color](../../system.drawing/color/). |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Возвращает ориентацию направляющей рисования. Читайте [Slides::Orientation](../orientation/). |
| **float** [get_Position](./get_position/)() override | Возвращает позицию направляющей рисования в пунктах от верхнего левого угла слайда. Читайте **float**. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Устанавливает цвет направляющей рисования. Запишите [System::Drawing::Color](../../system.drawing/color/). |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) override | Устанавливает ориентацию направляющей рисования. Запишите [Slides::Orientation](../orientation/). |
| void [set_Position](./set_position/)(**float**) override | Устанавливает позицию направляющей рисования в пунктах от верхнего левого угла слайда. Запишите **float**. |
...
* Класс [IDrawingGuide](../idrawingguide/)
