...
type: docs
weight: 807
url: /ru/aspose.slides/domobject/
---
## Класс DomObject

Базовый объект [DOM](../../aspose.slides.dom/)
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Устанавливает n-й аргумент шаблона как слабый указатель (а не общий). Позволяет переключать указатели в контейнерах в режим слабых. |
