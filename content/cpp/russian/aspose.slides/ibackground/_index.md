...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | Возвращает [EffectFormat](../effectformat/) для заполнения [BackgroundType::OwnBackground](../backgroundtype/). Толькочтения [IEffectFormat](../ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Возвращает [FillFormat](../fillformat/) для заполнения [BackgroundType::OwnBackground](../backgroundtype/). Толькочтения [IFillFormat](../ifillformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](../ipresentationcomponent/get_presentation/)() | Возвращает презентацию. Толькочтения [IPresentation](../ipresentation/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../islidecomponent/get_slide/)() | Возвращает базовый слайд. Толькочтения [IBaseSlide](../ibaseslide/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | Возвращает [ColorFormat](../colorformat/) для заполнения [BackgroundType::Themed](../backgroundtype/). Толькочтения [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | Возвращает индекс заполнения [BackgroundType::Themed](../backgroundtype/) в коллекции фоновых тем. 0 означает отсутствие заполнения. 1..999 — индекс. Чтение **uint16_t**. |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | Возвращает тип фонового заполнения. Чтение [BackgroundType](../backgroundtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру данных счётчика ссылок, связанную с объектом. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | Получает эффективные данные фона с учётом наследования. |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | Записывает индекс заполнения [BackgroundType::Themed](../backgroundtype/) в коллекцию фоновых тем. 0 означает отсутствие заполнения. 1..999 — индекс. Запись **uint16_t**. |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | Записывает тип фонового заполнения. Запись [BackgroundType](../backgroundtype/). |
