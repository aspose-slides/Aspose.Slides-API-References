...
description: Получает данные эффективного форматирования маркеров с учётом наследования.
type: docs
weight: 248
...
Получает данные эффективного форматирования маркеров с учётом наследования.
...
Объект [IBulletFormatEffectiveData](../../ibulletformateffectivedata/).

## Примечания

В этом примере демонстрируется получение некоторых свойств эффективного формата маркера.
```cpp
