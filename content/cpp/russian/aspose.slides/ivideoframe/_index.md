...
| Метод | Описание |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | Добавляет новый плейсхолдер, если его нет, и устанавливает свойства плейсхолдера в указанные. |
...
| virtual **int32_t** [get_ConnectionSiteCount](../ishape/get_connectionsitecount/)() | Возвращает количество соединительных точек на фигуре. Только чтение **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\> [get_EmbeddedVideo](./get_embeddedvideo/)() | Возвращает встроенный объект видео. Чтение [IVideo](../ivideo/). |
...
| virtual **bool** [get_FullScreenMode](./get_fullscreenmode/)() | Определяет, отображается ли видео в полноэкранном режиме. Чтение **bool**. |
...
| virtual **bool** [get_HideAtShowing](./get_hideatshowing/)() | Определяет, скрыт ли [VideoFrame](../videoframe/). Чтение **bool**. |
...
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Возвращает имя видеофайла, связанного с [VideoFrame](../videoframe/). Чтение [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](../ishape/get_name/)() | Возвращает имя фигуры. Чтение [System::String](../../system/string/). |
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Возвращает уникальный идентификатор в пределах слайда, остающийся постоянным в течение жизненного цикла фигуры и позволяющий PowerPoint или межоперативному коду надёжно ссылаться на фигуру из любой части документа. Только чтение **uint32_t**. См. также [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [get_Placeholder](../ishape/get_placeholder/)() | Возвращает плейсхолдер для фигуры. Только чтение [IPlaceholder](../iplaceholder/). |
| virtual **bool** [get_PlayLoopMode](./get_playloopmode/)() | Определяет, зациклен ли видеоролик. Чтение **bool**. |
| virtual [VideoPlayModePreset](../videoplaymodepreset/) [get_PlayMode](./get_playmode/)() | Возвращает режим воспроизведения видео. Чтение [VideoPlayModePreset](../videoplaymodepreset/). |
...
| virtual **float** [get_RelativeScaleHeight](../ipictureframe/get_relativescaleheight/)() | Возвращает масштаб высоты (относительно исходного размера изображения) рамки изображения. Значение 1.0 соответствует 100 %. Чтение **float**. |
| virtual **float** [get_RelativeScaleWidth](../ipictureframe/get_relativescalewidth/)() | Возвращает масштаб ширины (относительно исходного размера изображения) рамки изображения. Значение 1.0 соответствует 100 %. Чтение **float**. |
| virtual **bool** [get_RewindVideo](./get_rewindvideo/)() | Определяет, будет ли видео автоматически перемотываться к началу после завершения воспроизведения. Чтение **bool**. |
...
| virtual **float** [get_TrimFromEnd](./get_trimfromend/)() | Обрезка конца [мс] |
| virtual **float** [get_TrimFromStart](./get_trimfromstart/)() | Обрезка начала [мс] |
...
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | Возвращает позицию фигуры в порядке Z. Shapes[0] возвращает фигуру, находящуюся сзади в порядке Z, а Shapes[Count - 1] — фигуру в передней части. Только чтение **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../ishape/getbaseplaceholder/)() | Возвращает базовую форму плейсхолдера (фигуру из макета и/или мастер-слайда, от которой наследуется текущая фигура). |
...
| virtual void [RemovePlaceholder](../ishape/removeplaceholder/)() | Определяет, что эта фигура не является плейсхолдером. |
...
| virtual void [set_EmbeddedVideo](./set_embeddedvideo/)([System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\>) | Устанавливает встроенный объект видео. Запись [IVideo](../ivideo/). |
...
| virtual void [set_FullScreenMode](./set_fullscreenmode/)(**bool**) | Определяет, отображается ли видео в полноэкранном режиме. Запись **bool**. |
...
| virtual void [set_HideAtShowing](./set_hideatshowing/)(**bool**) | Определяет, скрыт ли [VideoFrame](../videoframe/). Запись **bool**. |
...
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | Устанавливает имя видеофайла, связанного с [VideoFrame](../videoframe/). Запись [System::String](../../system/string/). |
...
| virtual void [set_PlayLoopMode](./set_playloopmode/)(**bool**) | Определяет, зациклен ли видеоролик. Запись **bool**. |
| virtual void [set_PlayMode](./set_playmode/)([VideoPlayModePreset](../videoplaymodepreset/)) | Устанавливает режим воспроизведения видео. Запись [VideoPlayModePreset](../videoplaymodepreset/). |
...
| virtual void [set_RelativeScaleHeight](../ipictureframe/set_relativescaleheight/)(**float**) | Устанавливает масштаб высоты (относительно исходного размера изображения) рамки изображения. Значение 1.0 соответствует 100 %. Запись **float**. |
| virtual void [set_RelativeScaleWidth](../ipictureframe/set_relativescalewidth/)(**float**) | Устанавливает масштаб ширины (относительно исходного размера изображения) рамки изображения. Значение 1.0 соответствует 100 %. Запись **float**. |
| virtual void [set_RewindVideo](./set_rewindvideo/)(**bool**) | Определяет, будет ли видео автоматически перемотываться к началу после завершения воспроизведения. Запись **bool**. |
...
| virtual void [set_TrimFromEnd](./set_trimfromend/)(**float**) | Обрезка конца [мс] |
| virtual void [set_TrimFromStart](./set_trimfromstart/)(**float**) | Обрезка начала [мс] |
