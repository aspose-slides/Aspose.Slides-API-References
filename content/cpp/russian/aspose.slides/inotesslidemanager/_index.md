...
| Метод | Описание |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() | Возвращает слайд заметок для текущего слайда, создавая его, если его нет. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() | Возвращает слайд заметок для текущего слайда. Возвращает null, если у слайда нет слайда заметок. Только для чтения [INotesSlide](../inotesslide/). |
...
| virtual void [RemoveNotesSlide](./removenotesslide/)() | Удаляет слайд заметок текущего слайда. |
