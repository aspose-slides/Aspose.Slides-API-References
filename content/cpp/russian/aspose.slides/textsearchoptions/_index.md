...
description: Представляет параметры, которые можно использовать для поиска текста в презентации, слайде или текстовом фрейме.
type: docs
weight: 5487
...
Представляет параметры, которые можно использовать для поиска текста в [Presentation](../presentation/), [Slide](../slide/) или [TextFrame](../textframe/).
...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Установите true, чтобы использовать поиск с учётом регистра, иначе false. Чтение **bool**. |
| **bool** [get_IncludeNotes](./get_includenotes/)() override | Установите **true**, чтобы включить текст, содержащийся в заметках слайда ([NotesSlide](../notesslide/)) при выполнении поиска текста, замены или выделения. Значение по умолчанию — **false**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Установите true, чтобы соответствовать только полным словам, иначе false. Чтение **bool**. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Установите true, чтобы использовать поиск с учётом регистра, иначе false. Запись **bool**. |
| void [set_IncludeNotes](./set_includenotes/)(**bool**) override | Установите **true**, чтобы включить текст, содержащийся в заметках слайда ([NotesSlide](../notesslide/)) при выполнении поиска текста, замены или выделения. Значение по умолчанию — **false**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Установите true, чтобы соответствовать только полным словам, иначе false. Запись **bool**. |
