...
| Метод | Описание |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [CreateFontData](./createfontdata/)([System::String](../../system/string/)) override | Создает [FontData](../fontdata/) с указанным именем шрифта. |
...
* Класс [IFontDataFactory](../ifontdatafactory/)
