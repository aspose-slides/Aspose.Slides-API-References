...
---
## LayoutPlaceholderManager::AddSmartArtPlaceholder(float, float, float, float) метод

Добавляет новую форму-заполнитель на слайд макета, чтобы разместить диаграмму [SmartArt](../../../aspose.slides.smartart/).
...
Создано [IAutoShape](../../iautoshape/) с [SmartArt](../../../aspose.slides.smartart/) заполнителем.
