...
---
## LayoutPlaceholderManager::AddOnlineImagePlaceholder(float, float, float, float) метод
...
Создан [IAutoShape](../../iautoshape/) с заполнителем онлайн-изображения.

## Примечания

Следующий пример показывает, как добавить форму заполнителя Online Image на слайд макета.
```cpp
