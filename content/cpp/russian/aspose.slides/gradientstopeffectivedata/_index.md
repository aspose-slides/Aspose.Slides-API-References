...
description: Неизменяемый объект, представляющий градиентный стоп.
type: docs
weight: 1158
...
Неизменяемый объект, представляющий градиентный стоп.
...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равен ли указанный [GradientStopEffectiveData](./) текущему [GradientStopEffectiveData](./). |
...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Возвращает цвет градиентного стопа. Только для чтения [System::Drawing::Color](../../system.drawing/color/). |
| **float** [get_Position](./get_position/)() override | Возвращает позицию (0..1) градиентного стопа. Только для чтения **float**. |
...
* Класс [IGradientStopEffectiveData](../igradientstopeffectivedata/)
