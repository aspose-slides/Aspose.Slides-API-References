...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) | Возвращает пользовательскую часть XML по указанному индексу. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() | Возвращает коллекцию пользовательских частей XML. Только для чтения [ICustomXmlPartCollection](../icustomxmlpartcollection/). |
| virtual [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) | Возвращает тег пользовательских данных, указанный по индексу. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() | Возвращает коллекцию тегов пользовательских данных. Только для чтения [ITagCollection](../itagcollection/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Конструктор копий. На самом деле ничего не копирует, а лишь инициализирует новый объект и позволяет копировать конструкторы подклассов. |
...
| virtual void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) | Устанавливает тег пользовательских данных, указанный по индексу. |
