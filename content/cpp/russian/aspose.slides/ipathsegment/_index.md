...
Представляет сегмент графического пути [GeometryShape](../geometryshape/)
...
| virtual [PathCommandType](../pathcommandtype/) [get_PathCommand](./get_pathcommand/)() | Тип пути сегмента |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [get_SegmentData](./get_segmentdata/)() | Данные пути сегмента |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона как weak-указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим weak. |
