...
| [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() override | Возвращает тип эскиза. Чтение [Slides::LineSketchType](../linesketchtype/). |
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку оператора C# lock(). Вызывается непосредственно или с использованием объекта-охранника [LockContext](../../system/lockcontext/). |
...
| void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) override | Устанавливает тип эскиза. Запись [Slides::LineSketchType](../linesketchtype/). |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывается непосредственно или с использованием объекта-охранника [LockContext](../../system/lockcontext/). |
...
* Класс [ISketchFormat](../isketchformat/)
