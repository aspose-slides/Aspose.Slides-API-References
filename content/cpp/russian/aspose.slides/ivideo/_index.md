...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Возвращает копию данных аудио. В случае большого объёма данных рассмотрите использование метода [IVideo::GetStream](./getstream/), чтобы предотвратить ненужную загрузку данных видео в память или даже исключение OutOfMemoryException. Только для чтения **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Возвращает MIME-тип видео, закодированный в [IVideo::get_BinaryData](./get_binarydata/). Только для чтения [System::String](../../system/string/). |
