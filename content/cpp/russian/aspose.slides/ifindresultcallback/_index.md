...
| virtual void [FoundResult](./foundresult/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\>, [System::String](../../system/string/), [System::String](../../system/string/), **int32_t**) | Метод обратного вызова, получающий данные о найденном тексте. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный аргумент слабым указателем (а не shared). Позволяет переключать указатели в контейнерах в режим слабых указателей. |
