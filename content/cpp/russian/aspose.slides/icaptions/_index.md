...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Возвращает двоичные данные закрытых субтитров. Только для чтения **uint8_t**[]. |
| virtual [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() | Возвращает глобальный уникальный идентификатор (GUID) закрытых субтитров. Только для чтения [System::Guid](../../system/guid/). |
| virtual [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() | Возвращает данные закрытых субтитров в виде строки, закодированной в UTF-8. Только для чтения [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Label](./get_label/)() | Возвращает метку закрытых субтитров. Чтение [System::String](../../system/string/). |
...
| virtual void [set_Label](./set_label/)([System::String](../../system/string/)) | Устанавливает метку закрытых субтитров. Запись [System::String](../../system/string/). |
