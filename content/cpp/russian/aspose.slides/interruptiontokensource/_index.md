...
description: Представляет источник InterruptionToken.
type: docs
weight: 3069
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Возвращает true, если прерывание запрошено, иначе false. |
| [System::SharedPtr](../../system/sharedptr/)\<[IInterruptionToken](../iinterruptiontoken/)\> [get_Token](./get_token/)() override | Возвращает новый токен, привязанный к этому [InterruptionTokenSource](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру данных счетчика ссылок, связанную с объектом. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Аналог метода C# [Object.GetHashCode()](../../system/object/gethashcode/). Позволяет хешировать пользовательские объекты. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Получает фактический тип объекта. Аналог вызова C# [System.Object.GetType()](../../system/object/gettype/). |
| void [Interrupt](./interrupt/)() override | Инициализирует запрос на прерывание. |
|  [InterruptionTokenSource](./interruptiontokensource/)() | Создает новый [InterruptionTokenSource](./). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный параметр в weak-указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим weak. |
...
* Класс [IInterruptionTokenSource](../iinterruptiontokensource/)
