...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | Возвращает комментарий, сделанный этим автором по указанному индексу. Только для чтения [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | Возвращает коллекцию комментариев, сделанных этим автором. Только для чтения [ICommentCollection](../icommentcollection/). |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | Возвращает инициалы автора. Чтение [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Возвращает имя автора. Чтение [System::String](../../system/string/). |
...
| void [Remove](./remove/)() override | Удаляет автора из родительской коллекции. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Уменьшает счётчик разделяемых ссылок на указанное значение. |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | Задает инициалы автора. Запись [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Задает имя автора. Запись [System::String](../../system/string/). |
