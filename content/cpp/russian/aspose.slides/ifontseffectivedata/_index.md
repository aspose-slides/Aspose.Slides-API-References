...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() | Возвращает шрифт сложного письма. Только для чтения [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() | Возвращает восточноазиатский шрифт. Только для чтения [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() | Возвращает латинский шрифт. Только для чтения [IFontData](../ifontdata/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n'th аргумент шаблона как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в слабый режим. |
...
Этот интерфейс используется как часть интерфейсов [IBasePortionFormatEffectiveData](../ibaseportionformateffectivedata/) и [Theme::IFontSchemeEffectiveData](../../aspose.slides.theme/ifontschemeeffectivedata/).
