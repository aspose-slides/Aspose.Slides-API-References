...
description: Представляет общие свойства отображения слайда.
type: docs
weight: 469
...
Представляет общие свойства отображения слайда.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) override | Возвращает направляющую рисунка по указанному индексу. Только для чтения [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Возвращает коллекцию направляющих рисунка. Только для чтения [IDrawingGuidesCollection](../idrawingguidescollection/) |
| **int32_t** [get_Scale](./get_scale/)() override | Указывает коэффициент масштабирования представления в процентах. Читать **int32_t**. |
| **bool** [get_VariableScale](./get_variablescale/)() override | Указывает, что содержимое представления должно автоматически масштабироваться для наилучшего соответствия текущему размеру окна. Чтение **bool**. |
...
| void [set_Scale](./set_scale/)(**int32_t**) override | Указывает коэффициент масштабирования представления в процентах. Запись **int32_t**. |
| void [set_VariableScale](./set_variablescale/)(**bool**) override | Указывает, что содержимое представления должно автоматически масштабироваться для наилучшего соответствия текущему размеру окна. Запись **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-ый шаблонный параметр как слабый указатель (а не shared). Позволяет переключать указатели в контейнерах в слабый режим. |
...
Следующий пример показывает, как установить значение масштаба для слайда PowerPoint [Presentation](../presentation/). 
```cpp
...
// Значение масштаба в процентах для просмотра слайда
presentation->get_ViewProperties()->get_NotesViewProperties()->set_Scale(100);
// Значение масштаба в процентах для просмотра заметок
presentation->Save(u"Zoom_out.pptx", SaveFormat::Pptx);
```

## См. также

* Класс [ICommonSlideViewProperties](../icommonslideviewproperties/)
