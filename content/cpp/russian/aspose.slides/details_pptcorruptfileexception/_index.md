...
description: Исключение, которое выбрасывается, когда файл презентации, вероятно, повреждён.
type: docs
weight: 651
url: /ru/aspose.slides/details_pptcorruptfileexception/
---
## Details_PptCorruptFileException класс

Исключение, которое выбрасывается, когда файл презентации, вероятно, повреждён.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й параметр шаблона в виде слабой указателя (вместо shared). Позволяет переключать указатели в контейнерах в слабый режим. |
