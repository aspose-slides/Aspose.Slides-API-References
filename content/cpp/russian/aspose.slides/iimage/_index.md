...
| virtual **int32_t** [get_Height](./get_height/)() | Возвращает высоту изображения в пикселях. |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_Size](./get_size/)() | Возвращает размер изображения. |
| virtual **int32_t** [get_Width](./get_width/)() | Возвращает ширину изображения в пикселях. |
...
| virtual void [Save](./save/)([System::String](../../system/string/)) | Сохраняет изображение в файл. |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/)) | Сохраняет изображение в файл в указанном формате. |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/)) | Сохраняет изображение в поток в указанном формате. |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/), **int32_t**) | Сохраняет изображение в файл в указанном формате и качестве. |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/), **int32_t**) | Сохраняет изображение в поток в указанном формате и качестве. |
...
Этот интерфейс предоставляет общую абстракцию для работы как с растровыми, так и с векторными изображениями. 

 Реализации могут различаться в зависимости от базового типа изображения. 
