...
| Метод | Описание |
| --- | --- |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::String](../../system/string/)) | Добавляет новые шрифты в список шрифтов FallBack. |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Добавляет новые шрифты в список шрифтов FallBack. |
| virtual void [Clear](./clear/)() | Удаляет все шрифты из списка. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Возвращает количество шрифтов, фактически определённых для диапазона. |
| virtual **uint32_t** [get_RangeEndIndex](./get_rangeendindex/)() | Получает последний индекс непрерывного диапазона Unicode. |
| virtual **uint32_t** [get_RangeStartIndex](./get_rangestartindex/)() | Получает первый индекс непрерывного диапазона Unicode. |
...
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)(**int32_t**) | Возвращает имя шрифта по указанному индексу. |
| virtual **int32_t** [IndexOf](./indexof/)([System::String](../../system/string/)) | Возвращает индекс указанного правила в коллекции. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Удаляет первое вхождение указанного шрифта FallBack из списка. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Удаляет шрифт FallBack по указанному индексу в списке. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)() | Создаёт и возвращает массив со всеми шрифтами FallBack для этого правила. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)(**int32_t**, **int32_t**) | Создаёт и возвращает массив со всеми шрифтами FallBack из указанного диапазона в списке. |
