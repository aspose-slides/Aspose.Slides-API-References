...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::String](../../system/string/)) override | Добавляет новую пользовательскую XML-часть. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Добавляет новую пользовательскую XML-часть. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Добавляет новую пользовательскую XML-часть. |
| [iterator](./iterator/) [begin](./begin/)() | Возвращает итератор, указывающий на первый элемент (если он есть) коллекции. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Возвращает итератор, указывающий на первый элемент (если он есть) константной версии коллекции. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Возвращает итератор, указывающий на первый элемент, объявленный как const (если он есть) в коллекции. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Возвращает итератор, указывающий сразу после последнего const-элемента (если он есть) в коллекции. |
| void [Clear](./clear/)() override | Удаляет все элементы из коллекции. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>\>, **int32_t**) override | Копирует в указанный массив. |
...
| [iterator](./iterator/) [end](./end/)() | Возвращает итератор, указывающий сразу после последнего элемента (если он есть) в коллекции. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Возвращает итератор, указывающий сразу после последнего элемента (если он есть) константной версии коллекции. |
...
| **int32_t** [get_Count](./get_count/)() override | Возвращает количество пользовательских XML-частей в коллекции. Только для чтения **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>\>\> [GetEnumerator](./getenumerator/)() override | Возвращает перечислитель, который перебирает элементы коллекции. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Аналог метода C# [Object.GetHashCode()](../../system/object/gethashcode/). Позволяет хешировать пользовательские объекты. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Получает фактический тип объекта. Аналог вызова C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [idx_get](./idx_get/)(**int32_t**) override | Возвращает элемент по указанному индексу. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Возвращает количество элементов в последовательности (вычисляемое прямым подсчетом). |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>) override | Удаляет первое вхождение указанного объекта из коллекции. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Удаляет пользовательскую XML-часть по указанному индексу. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Возвращает итератор, указывающий на первый элемент (если он есть) константной версии коллекции. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Возвращает итератор, указывающий сразу после последнего элемента (если он есть) константной версии коллекции. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Возвращает итератор, указывающий сразу после последнего элемента (если он есть) в коллекции. |
...
* Класс [ICustomXmlPartCollection](../icustomxmlpartcollection/)
