...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Возвращает объект свойств заполнения таблицы. Только чтение [IFillFormat](../ifillformat/). |
| virtual **float** [get_Transparency](./get_transparency/)() | Получает прозрачность цвета заполнения. Чтение **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру данных счетчика ссылок, связанную с объектом. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() | Получает эффективные свойства форматирования таблицы с учётом наследования и применённых стилей таблицы. |
...
| virtual void [set_Transparency](./set_transparency/)(**float**) | Устанавливает прозрачность цвета заполнения. Запись **float**. |
