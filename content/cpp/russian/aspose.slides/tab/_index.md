...
| Метод | Описание |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | Сравнивает текущий экземпляр с другим объектом того же типа. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | Возвращает стиль выравнивания табуляции. Читать [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | Возвращает позицию табуляции. Присвоение этому свойству может изменить индекс табуляции в коллекции и сделать Enumerator недействительным. Читать **double**. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | Задает стиль выравнивания табуляции. Записывать [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | Задает позицию табуляции. Присвоение этому свойству может изменить индекс табуляции в коллекции и сделать Enumerator недействительным. Записать **double**. |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | Создаёт новый [Tab](./) |
