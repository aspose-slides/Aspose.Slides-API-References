...
| Метод | Описание |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Добавляет [Paragraph](../paragraph/) в конец коллекции. |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Добавляет содержимое [ParagraphCollection](./) в конец коллекции. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) override | Добавляет текст из указанной HTML-строки в коллекцию. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) override | Добавляет текст из указанной HTML-строки в коллекцию. |
| [iterator](./iterator/) [begin](./begin/)() | Возвращает итератор, указывающий на первый элемент (если есть) коллекции. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Возвращает итератор, указывающий на первый элемент (если есть) константного экземпляра коллекции. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Возвращает итератор, указывающий на первый const-квалифицированный элемент (если есть) коллекции. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Возвращает итератор, указывающий сразу после последнего const-квалифицированного элемента (если есть) коллекции. |
| void [Clear](./clear/)() override | Удаляет все элементы из коллекции. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Определяет, содержит ли [ICollection](../../system.collections.generic/icollection/) конкретное значение. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>, **int32_t**) | Копирует элементы [ICollection](../../system.collections.generic/icollection/) в [System::Array](../../system/array/), начиная с определённого индекса [System::Array](../../system/array/). |
| [iterator](./iterator/) [end](./end/)() | Возвращает итератор, указывающий сразу после последнего элемента (если есть) коллекции. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Возвращает итератор, указывающий сразу после последнего элемента (если есть) константного экземпляра коллекции. |
...
| [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) override | Преобразует указанные абзацы в HTML и возвращает их как объект String. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>\> [GetEnumerator](./getenumerator/)() override | Возвращает перечислитель, который проходит по элементам коллекции. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) override | Возвращает элемент по указанному индексу. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Определяет индекс конкретного элемента в [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Вставляет [Paragraph](../paragraph/) в коллекцию по указанному индексу. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Вставляет содержимое [ParagraphCollection](./) в коллекцию по указанному индексу. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Удаляет первое вхождение конкретного объекта из [ICollection](../../system.collections.generic/icollection/). |
| void [RemoveAt](./removeat/)(**int32_t**) override | Удаляет элемент по указанному индексу из коллекции. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Уменьшает счётчик общих ссылок на указанное значение. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Устанавливает n-й шаблонный аргумент как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим weak. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Возвращает итератор, указывающий на первый элемент (если есть) константного экземпляра коллекции. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Возвращает итератор, указывающий сразу после последнего элемента (если есть) константного экземпляра коллекции. |
...
* Класс [IParagraphCollection](../iparagraphcollection/)
