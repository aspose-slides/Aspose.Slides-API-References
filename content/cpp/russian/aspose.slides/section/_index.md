...
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Имя раздела. |
| [System::Guid](../../system/guid/) [get_SectionId](./get_sectionid/)() override | [Section](./) Id. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_StartedFromSlide](./get_startedfromslide/)() override | Возвращает первый слайд раздела. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISectionSlideCollection](../isectionslidecollection/)\> [GetSlidesListOfSection](./getslideslistofsection/)() override | Возвращает список слайдов в разделе. |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Имя раздела. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Устанавливает n-й параметр шаблона в виде слабой ссылки (вместо общей). Позволяет переключать указатели в контейнерах в режим слабых ссылок. |
