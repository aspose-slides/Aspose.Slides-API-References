...
| virtual [System::String](../../system/string/) [get_CommentsText](./get_commentstext/)() | Текст комментариев слайда |
| virtual [System::String](../../system/string/) [get_LayoutText](./get_layouttext/)() | Текст фигур на странице макета для этого слайда |
| virtual [System::String](../../system/string/) [get_MasterText](./get_mastertext/)() | Текст фигур на главной странице для этого слайда |
| virtual [System::String](../../system/string/) [get_NotesText](./get_notestext/)() | Текст фигур на странице заметок для этого слайда |
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Текст фигур на слайде |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный аргумент в виде слабого указателя (вместо общего). Позволяет переключать указатели в контейнерах в режим слабых. |
