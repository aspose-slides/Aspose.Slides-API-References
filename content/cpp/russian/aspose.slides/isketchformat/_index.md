...
description: Представляет свойства формата эскиза линий.
type: docs
weight: 3732
...
Представляет свойства формата эскиза линий.
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | Возвращает тип эскиза. См. [Slides::LineSketchType](../linesketchtype/). |
...
| virtual void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) | Устанавливает тип эскиза. Запишите [Slides::LineSketchType](../linesketchtype/). |
