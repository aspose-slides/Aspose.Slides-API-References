...
description: Представляет коллекцию тегов (пары строк, задаваемые пользователем)
type: docs
weight: 4057
url: /ru/aspose.slides/itagcollection/
---
## ITagCollection класс
...
| Метод | Описание |
| --- | --- |
| virtual **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | Добавляет новый тег в коллекцию. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Получает итератор, указывающий на первый элемент (если он есть) константной версии экземпляра коллекции. |
...
| virtual void [Clear](./clear/)() | Удаляет все теги из коллекции. |
| virtual **bool** [Contains](./contains/)([System::String](../../system/string/)) | Определяет, содержит ли коллекция конкретное имя. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Получает итератор, указывающий сразу после последнего элемента (если он есть) константной версии экземпляра коллекции. |
...
| virtual [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) | Возвращает ключ тега по указанному индексу. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() | Возвращает имена тегов. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Получает фактический тип объекта. Аналог вызова C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) | Возвращает значение тега по указанному индексу. |
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) | Возвращает пару ключ-значение тега. |
| virtual void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) | Устанавливает пару ключ-значение тега. |
| virtual **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) | Возвращает нулевой индекс указанного ключа в коллекции. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Удаляет тег с указанным именем из коллекции. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Удаляет тег по указанному индексу. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует снятие блокировки оператором C# lock(). Вызывайте напрямую или используйте объект-сторож [LockContext](../../system/lockcontext/). |
