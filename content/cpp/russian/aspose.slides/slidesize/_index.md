...
| [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() override | Получает ориентацию слайда. |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Получает размеры слайда в пунктах. |
| [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() override | Получает тип размера слайда. |
...
| void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) override | Устанавливает ориентацию слайда. |
| void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) override | Устанавливает размер слайда по типу и масштабирует существующее содержимое. |
| void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) override | Устанавливает размеры слайда явно и масштабирует существующее содержимое. |
