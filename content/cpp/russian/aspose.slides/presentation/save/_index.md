...
| --- | --- | --- |
| fname | [System::String](../../../system/string/) | Путь к создаваемому файлу. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Формат экспортируемых данных. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| stream | [System::SharedPtr](../../../system/sharedptr/)\<[System::IO::Stream](../../../system.io/stream/)\> | Выходной поток. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Формат экспортируемых данных. |
...
| fname | [System::String](../../../system/string/) | Путь к создаваемому файлу. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Формат экспортируемых данных. |
| options | [System::SharedPtr](../../../system/sharedptr/)\<[Export::ISaveOptions](../../../aspose.slides.export/isaveoptions/)\> | Дополнительные параметры формата. |
## Примечания



В следующем примере показано, как преобразовать PowerPoint в HTML с помощью C++.
```cpp
// Создает объект презентации, представляющий файл презентации, например PPT, PPTX, ODP и т.д.
...
```
В следующем примере показано, как преобразовать PowerPoint в адаптивный HTML с помощью C++.
```cpp
...
// Сохраняет презентацию в HTML
presentation->Save(u"ConvertPresentationToResponsiveHTML_out.html", SaveFormat::Html, htmlOptions);
```
В следующем примере показано, как преобразовать PowerPoint в HTML с заметками с помощью C++.
```cpp
...
```
В следующем примере показано, как преобразовать PowerPoint в HTML с оригинальными шрифтами с помощью C++.
```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// Исключает шрифты по умолчанию презентации
...
```
В следующем примере показано, как преобразовать PowerPoint в HTML с изображениями высокого качества при 150 DPI с помощью C++.
```cpp
...
```
В следующем примере показано, как преобразовать PowerPoint в HTML с изображениями полного качества с помощью C++.
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
В следующем примере показано, как преобразовать [Slide](../../slide/) в HTML с помощью C++.
```cpp
```
