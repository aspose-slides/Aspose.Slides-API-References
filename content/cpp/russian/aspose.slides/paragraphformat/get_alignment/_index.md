...
description: Возвращает выравнивание текста в абзаце без наследования. Читайте TextAlignment.
type: docs
weight: 1
url: /ru/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() метод

Возвращает выравнивание текста в абзаце без наследования. Читать [TextAlignment](../../textalignment/).
...
Следующий пример кода показывает, как выравнивать текстовые абзацы в PowerPoint [Presentation](../../presentation/).
```cpp
