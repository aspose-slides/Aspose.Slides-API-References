...
| Метод | Описание |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | Сравнивает текущий объект с указанным объектом. |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Возвращает стиль выравнивания табуляции. Читает [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Возвращает позицию табуляции. Назначение этого свойства может изменить индекс табуляции в коллекции и сделать Enumerator недействительным. Читает **double**. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Устанавливает стиль выравнивания табуляции. Записывает [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Устанавливает позицию табуляции. Назначение этого свойства может изменить индекс табуляции в коллекции и сделать Enumerator недействительным. Записывает **double**. |
