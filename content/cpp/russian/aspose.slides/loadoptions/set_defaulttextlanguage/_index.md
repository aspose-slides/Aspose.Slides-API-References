...
description: "Устанавливает язык по умолчанию для текста презентации. Запишите System::String."
type: docs
weight: 326
url: /ru/aspose.slides/loadoptions/set_defaulttextlanguage/
---
## LoadOptions::set_DefaultTextLanguage(System::String) метод
