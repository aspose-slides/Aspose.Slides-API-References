...
| Метод | Описание |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\> [CreateTab](./createtab/)(**double**, [TabAlignment](../tabalignment/)) override | Создает новый экземпляр [ITab](../itab/). |
