...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, являются ли два экземпляра [FontData](./) равными. |
...
|  [FontData](./fontdata/)([System::String](../../system/string/)) | Создает новый объект [FontData](./) с указанным именем шрифта. |
| [System::String](../../system/string/) [get_FontName](./get_fontname/)() override | Возвращает имя шрифта. Читайте [System::String](../../system/string/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру данных счетчика ссылок, связанную с объектом. |
| [System::String](../../system/string/) [GetFontName](./getfontname/)([System::SharedPtr](../../system/sharedptr/)\<[Theme::IThemeEffectiveData](../../aspose.slides.theme/ithemeeffectivedata/)\>) override | Возвращает имя шрифта, заменяя ссылку на тему фактическим используемым шрифтом. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Возвращает строковое представление. |
