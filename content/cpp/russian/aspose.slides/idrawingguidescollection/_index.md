...
description: Представляет собой коллекцию регулируемых направляющих чертежа.
type: docs
weight: 2016
url: /ru/aspose.slides/idrawingguidescollection/
---
## IDrawingGuidesCollection класс

Представляет собой коллекцию регулируемых направляющих чертежа.
...
| Метод | Описание |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [Add](./add/)([Orientation](../orientation/), **float**) | Добавляет направляющую чертежа в конец коллекции. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [idx_get](./idx_get/)(**int32_t**) | Возвращает направляющую чертежа по индексу. Только для чтения [IDrawingGuide](../idrawingguide/). |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Определяет, существует ли какой-либо элемент последовательности или удовлетворяет условию. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Удаляет направляющую чертежа по указанному индексу. |
