...
description: Представляет текст, извлечённый из презентации
type: docs
weight: 4889
url: /ru/aspose.slides/presentationtext/
---
## PresentationText класс


Представляет текст, извлечённый из презентации
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlideText](../islidetext/)\>\> [get_SlidesText](./get_slidestext/)() override | Массив [ISlideText](../islidetext/) содержит текст презентации. |
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку оператора C# lock(). Вызывает напрямую или использует объект-страж [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывает напрямую или использует объект-страж [LockContext](../../system/lockcontext/). |
