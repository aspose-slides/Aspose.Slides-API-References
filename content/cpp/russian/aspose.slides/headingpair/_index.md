...
Представляет свойство 'Heading pair' документа. Оно указывает имя группы частей документа и количество частей в группе.
...
| **int32_t** [get_Count](./get_count/)() override | Возвращает количество частей в группе. Только для чтения **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Возвращает имя группы частей документа. Только для чтения [System::String](../../system/string/). |
...
* Класс [IHeadingPair](../iheadingpair/)
