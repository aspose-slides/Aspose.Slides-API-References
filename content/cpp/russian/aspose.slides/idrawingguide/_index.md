...
description: Представляет регулируемую направляющую рисунка.
type: docs
weight: 2003
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Возвращает цвет направляющей рисунка. Читать [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Возвращает ориентацию направляющей рисунка. Читать [Slides::Orientation](../orientation/). |
| virtual **float** [get_Position](./get_position/)() | Возвращает позицию направляющей рисунка в пунктах от верхнего левого угла слайда. Читать **float**. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Устанавливает цвет направляющей рисунка. Записать [System::Drawing::Color](../../system.drawing/color/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | Устанавливает ориентацию направляющей рисунка. Записать [Slides::Orientation](../orientation/). |
| virtual void [set_Position](./set_position/)(**float**) | Устанавливает позицию направляющей рисунка в пунктах от верхнего левого угла слайда. Записать **float**. |
