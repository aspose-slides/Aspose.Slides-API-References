...
---
## ICommonSlideViewProperties класс
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | Возвращает направляющую рисунка по указанному индексу. Только для чтения [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | Возвращает коллекцию направляющих рисунка. Только для чтения [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | Задает коэффициент масштабирования представления в процентах. Чтение **int32_t**. |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | Указывает, что содержимое представления должно автоматически масштабироваться для лучшего соответствия текущему размеру окна. Чтение **bool**. |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | Задает коэффициент масштабирования представления в процентах. Запись **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | Указывает, что содержимое представления должно автоматически масштабироваться для лучшего соответствия текущему размеру окна. Запись **bool**. |
