...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Возвращает копию данных изображения. Только для чтения **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Возвращает MIME-тип изображения, закодированный в [IPPImage::get_BinaryData](./get_binarydata/). Только для чтения [System::String](../../system/string/). |
| virtual **int32_t** [get_Height](./get_height/)() | Возвращает высоту изображения. Только для чтения **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [get_Image](./get_image/)() | Возвращает копию изображения. Только для чтения [System::Drawing::Image](../../system.drawing/image/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\> [get_SvgImage](./get_svgimage/)() const | Возвращает объект [ISvgImage](../isvgimage/) [ISvgImage](../isvgimage/) |
| virtual **int32_t** [get_Width](./get_width/)() | Возвращает ширину изображения. Только для чтения **int32_t**. |
| virtual **int32_t** [get_X](./get_x/)() | Возвращает смещение по X изображения. Только для чтения **int32_t**. |
| virtual **int32_t** [get_Y](./get_y/)() | Возвращает смещение по Y изображения. Только для чтения **int32_t**. |
...
| virtual void [ReplaceImage](./replaceimage/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Заменяет данные изображения. |
| virtual void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\>) | Заменяет изображение. |
| virtual void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](./)\>) | Заменяет изображение. |
| virtual void [set_SvgImage](./set_svgimage/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\>) | Устанавливает объект [ISvgImage](../isvgimage/) [ISvgImage](../isvgimage/) |
