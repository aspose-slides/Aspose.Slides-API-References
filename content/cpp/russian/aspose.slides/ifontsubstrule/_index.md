...
description: Представляет информацию о подстановке шрифтов
type: docs
weight: 2276
url: /ru/aspose.slides/ifontsubstrule/
---
## IFontSubstRule класс

Представляет информацию о подстановке шрифтов
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_DestFont](./get_destfont/)() | Шрифт, используемый для подстановки, только для чтения [IFontData](../ifontdata/). |
| virtual [FontSubstCondition](../fontsubstcondition/) [get_ReplaceFontCondition](./get_replacefontcondition/)() | Правило, применяемое для подстановки, только для чтения [FontSubstCondition](../fontsubstcondition/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_SourceFont](./get_sourcefont/)() | Шрифт для подстановки, только для чтения [IFontData](../ifontdata/). |
