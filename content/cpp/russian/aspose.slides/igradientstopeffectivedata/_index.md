...
---
## IGradientStopEffectiveData класс
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Возвращает цвет градиентной остановки. Только для чтения [System::Drawing::Color](../../system.drawing/color/). |
| virtual **float** [get_Position](./get_position/)() | Возвращает позицию (0..1) градиентной остановки. Только для чтения **float**. |
