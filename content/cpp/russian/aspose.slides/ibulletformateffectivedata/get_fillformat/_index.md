...
description: Возвращает формат заливки маркера абзаца. Только для чтения IFillFormatEffectiveData.
type: docs
weight: 131
url: /ru/aspose.slides/ibulletformateffectivedata/get_fillformat/
---
## IBulletFormatEffectiveData::get_FillFormat() метод
...
В этом примере демонстрируется получение эффективных данных заливки маркера. 
```cpp
using namespace System;
using namespace Aspose::Slides;

auto pres = MakeObject<Presentation>(u"SomePresentation.pptx");
// Предположим, что первая фигура на первом слайде является AutoShape с некоторым текстом...
