...
---
## IFontDataFactory класс

[FontData](../fontdata/) фабричный интерфейс
...
| Метод | Описание |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [CreateFontData](./createfontdata/)([System::String](../../system/string/)) | Создает [FontData](../fontdata/) с указанным именем шрифта. |
