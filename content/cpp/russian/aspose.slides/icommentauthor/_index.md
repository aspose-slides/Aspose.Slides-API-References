...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) | Возвращает комментарий, сделанный этим автором по заданному индексу. Только для чтения [Aspose::Slides::IComment](../icomment/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() | Возвращает коллекцию комментариев, сделанных этим автором. Только для чтения [ICommentCollection](../icommentcollection/). |
| virtual [System::String](../../system/string/) [get_Initials](./get_initials/)() | Возвращает инициалы автора. Только для чтения [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Возвращает имя автора. Только для чтения [System::String](../../system/string/). |
...
| virtual void [Remove](./remove/)() | Удаляет автора из родительской коллекции. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Уменьшает счётчик общих ссылок на заданное значение. |
| virtual void [set_Initials](./set_initials/)([System::String](../../system/string/)) | Устанавливает инициалы автора. Запись [System::String](../../system/string/). |
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Устанавливает имя автора. Запись [System::String](../../system/string/). |
