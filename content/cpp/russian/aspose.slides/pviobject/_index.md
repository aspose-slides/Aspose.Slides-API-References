...
description: Инкапсулирует базовую инфраструктуру службы для объектов, которые могут быть объектом наследования значений свойств.
type: docs
weight: 4928
...
Инкапсулирует базовую инфраструктуру службы для объектов, которые могут быть объектом наследования значений свойств.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-ый шаблонный аргумент как слабый указатель (а не разделяемый). Позволяет переключать указатели в контейнерах в режим weak. |
