...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Возвращает копию данных аудио. При большом объёме данных рекомендуется использовать метод [Video::GetStream](./getstream/), чтобы предотвратить ненужную загрузку данных видео в память или даже возникновение OutOfMemoryException. Только для чтения **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Возвращает MIME-тип видео, кодированный в [Video::get_BinaryData](./get_binarydata/). Только для чтения [System::String](../../system/string/). |
