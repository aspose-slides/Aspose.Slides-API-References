...
description: Представляет свойства рельефа основной грани формы.
type: docs
weight: 3654
...
Представляет свойства рельефа основной грани формы.
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Тип фаски. Чтение [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Высота фаски. Чтение **double**. |
| virtual **double** [get_Width](./get_width/)() | Ширина фаски. Чтение **double**. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | Тип фаски. Запись [BevelPresetType](../bevelpresettype/). |
| virtual void [set_Height](./set_height/)(**double**) | Высота фаски. Запись **double**. |
| virtual void [set_Width](./set_width/)(**double**) | Ширина фаски. Запись **double**. |
