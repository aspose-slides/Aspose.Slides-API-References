...
| virtual [System::String](../../system/string/) [get_InternalString](./get_internalstring/)() | Возвращает внутреннее имя этого объекта FieldTypeEx. Чтение [System::String](../../system/string/). |
...
| virtual void [set_InternalString](./set_internalstring/)([System::String](../../system/string/)) | Возвращает внутреннее имя этого объекта FieldTypeEx. Запись [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-ый шаблонный аргумент в виде слабой ссылки (а не общей). Позволяет переключать указатели в контейнерах в режим слабых ссылок. |
