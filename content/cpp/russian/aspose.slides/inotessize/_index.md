...
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Возвращает размер в пунктах. Читайте [System::Drawing::SizeF](../../system.drawing/sizef/). |
...
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Устанавливает размер в пунктах. Запишите [System::Drawing::SizeF](../../system.drawing/sizef/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n'й параметр шаблона как слабый указатель (а не разделяемый). Позволяет переключать указатели в контейнерах в режим слабых указателей. |
