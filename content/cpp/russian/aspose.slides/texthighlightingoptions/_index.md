...
description: Представляет параметры, которые можно использовать для подсветки текста в текстовом фрейме.
type: docs
weight: 5474
url: /ru/aspose.slides/texthighlightingoptions/
---
## TextHighlightingOptions класс
...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Устанавливает true для использования поиска с учётом регистра, false — иначе. Чтение **bool**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Устанавливает true для сопоставления только целых слов, false — иначе. Чтение **bool**. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Устанавливает true для использования поиска с учётом регистра, false — иначе. Запись **bool**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Устанавливает true для сопоставления только целых слов, false — иначе. Запись **bool**. |
...
|  [TextHighlightingOptions](./texthighlightingoptions/)() | Создаёт новые параметры выделения текста по умолчанию. |
...
Устарело
:   Интерфейс [ITextHighlightingOptions](../itexthighlightingoptions/) будет удалён после выпуска версии 24.10.
