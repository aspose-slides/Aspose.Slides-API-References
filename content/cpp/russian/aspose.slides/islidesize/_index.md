...
| virtual [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() | Получает ориентацию слайда. |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Получает размеры слайда в пунктах. Присвоение нового значения сбрасывает значение [ISlideSize::get_Type](./get_type/) к [SlideSizeType::Custom](../slidesizetype/) и устанавливает [ISlideSize::get_Orientation](./get_orientation/). |
| virtual [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() | Получает тип размера слайда. Присвоение любого значения, кроме [SlideSizeType::Custom](../slidesizetype/), корректирует [ISlideSize::get_Size](./get_size/) в соответствии с предопределёнными размерами, при этом сохраняет текущий [ISlideSize::get_Orientation](./get_orientation/). |
...
| virtual void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) | Устанавливает ориентацию слайда. |
| virtual void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) | Устанавливает размер слайда по типу и масштабирует существующее содержимое. Присвоение любого значения, отличного от [SlideSizeType::Custom](../slidesizetype/), корректирует [ISlideSize::get_Size](./get_size/) в соответствии с выбранным типом, сохраняя [ISlideSize::get_Orientation](./get_orientation/). |
| virtual void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) | Явно задаёт размеры слайда и масштабирует существующее содержимое. Это сбрасывает значение [ISlideSize::get_Type](./get_type/) к [SlideSizeType::Custom](../slidesizetype/) и устанавливает [ISlideSize::get_Orientation](./get_orientation/). |
