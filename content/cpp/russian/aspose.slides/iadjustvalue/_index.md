...
description: Представляет значение коррекции геометрической фигуры. Эти значения влияют на форму фигуры.
type: docs
weight: 1288
...
Представляет значение коррекции геометрической фигуры. Эти значения влияют на форму фигуры.
...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | Возвращает значение, рассматривая его как угол в градусах. Читает **float**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Возвращает имя этого значения коррекции. Только для чтения [System::String](../../system/string/). |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | Возвращает значение коррекции «как есть». Читает **int64_t**. |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | Возвращает тип коррекции фигуры. Только для чтения [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | Устанавливает значение, рассматривая его как угол в градусах. Записывает **float**. |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | Устанавливает значение коррекции «как есть». Записывает **int64_t**. |
