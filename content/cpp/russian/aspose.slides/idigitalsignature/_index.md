...
description: Электронная подпись в подписанном файле.
type: docs
weight: 1951
url: /ru/aspose.slides/idigitalsignature/
---
## IDigitalSignature класс
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\> [get_Certificate](./get_certificate/)() | Объект сертификата, использованный для подписи документа. Только для чтения [X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/). |
| virtual [System::String](../../system/string/) [get_Comments](./get_comments/)() | Назначение подписи. Чтение [System::String](../../system/string/). |
| virtual **bool** [get_IsValid](./get_isvalid/)() | Если эта цифровая подпись действительна и документ не был подделан, это значение будет истинным. Только для чтения **bool**. |
| virtual [System::DateTime](../../system/datetime/) [get_SignTime](./get_signtime/)() | Время подписи документа. Только для чтения [System::DateTime](../../system/datetime/). |
...
| virtual void [set_Comments](./set_comments/)([System::String](../../system/string/)) | Назначение подписи. Запись [System::String](../../system/string/). |
