...
description: Представляет исключение, выдаваемое при обнаружении ошибки редактирования презентации.
type: docs
weight: 664
url: /ru/aspose.slides/details_ppteditexception/
---
## Details_PptEditException класс

Представляет исключение, выдаваемое при обнаружении ошибки редактирования презентации.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона в виде слабой ссылки (а не совместной). Позволяет переключать указатели в контейнерах в слабый режим. |
