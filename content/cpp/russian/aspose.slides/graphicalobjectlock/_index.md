...
Определяет, какие операции отключены у родителя [GraphicalObject](../graphicalobject/).
...
| **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() override | Определяет, должна ли фигура сохранять пропорции при изменении размеров. Чтение **bool**. |
| **bool** [get_DrilldownLocked](./get_drilldownlocked/)() override | Определяет, запрещён ли выбор подформ у этого объекта. Чтение **bool**. |
| **bool** [get_GroupingLocked](./get_groupinglocked/)() override | Определяет, запрещено ли добавлять эту фигуру в группу. Чтение **bool**. |
...
| **bool** [get_SizeLocked](./get_sizelocked/)() override | Определяет, запрещено ли изменение размеров этой фигуры. Чтение **bool**. |
...
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | Определяет, должна ли фигура сохранять пропорции при изменении размеров. Запись **bool**. |
| void [set_DrilldownLocked](./set_drilldownlocked/)(**bool**) override | Определяет, запрещён ли выбор подформ у этого объекта. Запись **bool**. |
| void [set_GroupingLocked](./set_groupinglocked/)(**bool**) override | Определяет, запрещено ли добавлять эту фигуру в группу. Запись **bool**. |
...
| void [set_SizeLocked](./set_sizelocked/)(**bool**) override | Определяет, запрещено ли изменение размеров этой фигуры. Запись **bool**. |
...
* Класс [IGraphicalObjectLock](../igraphicalobjectlock/)
