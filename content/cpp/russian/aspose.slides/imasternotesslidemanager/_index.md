...
---
## IMasterNotesSlideManager класс
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [get_MasterNotesSlide](./get_masternotesslide/)() | Возвращает мастер для всех слайдов заметок этой презентации, если он существует, иначе возвращает null. Только для чтения [IMasterNotesSlide](../imasternotesslide/). |
...
| virtual void [RemoveMasterNotesSlide](./removemasternotesslide/)() | Удаляет мастер-слайд заметок. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [SetDefaultMasterNotesSlide](./setdefaultmasternotesslide/)() | Устанавливает мастер-слайд заметок по умолчанию для связанного слайда заметок. |
