...
description: Добавляет новую форму заполнителя на слайд макета для размещения содержимого, такого как изображение, таблица, медиа или текст в вертикальном направлении.
type: docs
weight: 14
url: /ru/aspose.slides/ilayoutplaceholdermanager/addverticalcontentplaceholder/
---
## ILayoutPlaceholderManager::AddVerticalContentPlaceholder(float, float, float, float) метод

Добавляет новую форму заполнителя на слайд макета для размещения содержимого, такого как изображение, таблица, медиа или текст в вертикальном направлении.
...
Следующий пример показывает, как добавить форму заполнителя Content (Vertical) на слайд макета. 
```cpp
