...
description: Добавляет новую форму-заполнитель на макетный слайд для размещения диаграммы.
type: docs
weight: 66
url: /ru/aspose.slides/ilayoutplaceholdermanager/addchartplaceholder/
---
## ILayoutPlaceholderManager::AddChartPlaceholder(float, float, float, float) метод

Добавляет новую форму-заполнитель на макетный слайд для размещения диаграммы.
...
Следующий пример показывает, как добавить форму-заполнитель диаграммы на макетный слайд. 
```cpp
