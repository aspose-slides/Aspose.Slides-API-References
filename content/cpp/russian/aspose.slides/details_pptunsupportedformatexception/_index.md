...
type: docs
weight: 703
url: /ru/aspose.slides/details_pptunsupportedformatexception/
---
## Details_PptUnsupportedFormatException класс
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Устанавливает HRESULT — закодированное числовое значение, назначенное конкретному исключению. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Реализует метод [what()](../../system/details_exception/what/), который вызывается классом [ExceptionWrapper](../../system/exceptionwrapper/). Несмотря на то, что этот класс не наследуется от std::exception, производные классы могут использовать защищенные/приватные члены для реализации своей логики. Перенос реализации этого метода в [ExceptionWrapper](../../system/exceptionwrapper/) может нарушить эту логику. |
| virtual  [~Object](../../system/object/~object/)() | Уничтожает объект. Освобождает все внутренние структуры данных. |

## См. также

* Класс [Details_PptReadException](../details_pptreadexception/)
