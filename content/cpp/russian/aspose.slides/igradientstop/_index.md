...
description: Предоставляет формат градиента.
type: docs
weight: 2406
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | Возвращает цвет градиентной стопки. Только для чтения [IColorFormat](../icolorformat/). |
| virtual **float** [get_Position](./get_position/)() | Возвращает позицию (0..1) градиентной стопки. Читает **float**. |
...
| virtual void [set_Position](./set_position/)(**float**) | Устанавливает позицию (0..1) градиентной стопки. Записывает **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона в виде слабого указателя (а не совместного). Позволяет переключать указатели в контейнерах в слабый режим. |
