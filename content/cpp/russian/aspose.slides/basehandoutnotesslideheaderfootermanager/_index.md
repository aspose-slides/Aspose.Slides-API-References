...
description: Представляет менеджер, который управляет поведением заполнителей, включая заполнитель заголовка для всех типов раздаточных материалов и слайдов заметок.
type: docs
weight: 118
...
| **bool** [get_IsHeaderVisible](./get_isheadervisible/)() override | Получает значение, указывающее, что заполнитель заголовка присутствует. Чтение **bool**. |
...
| void [SetHeaderText](./setheadertext/)([System::String](../../system/string/)) override | Устанавливает текст в заполнитель заголовка слайда. |
| void [SetHeaderVisibility](./setheadervisibility/)(**bool**) override | Изменяет видимость заполнителя заголовка слайда. |
