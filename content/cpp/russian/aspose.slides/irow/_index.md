...
| virtual **double** [get_Height](./get_height/)() | Возвращает высоту строки. Только для чтения **double**. |
...
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Возвращает минимально возможную высоту строки. Чтение **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | Возвращает объект [RowFormat](../rowformat/), содержащий свойства форматирования для этой строки. Только для чтения [IRowFormat](../irowformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Возвращает ячейку по её позиции. Только для чтения [ICell](../icell/). |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Определяет, существует ли элемент последовательности или удовлетворяет условию. |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Устанавливает минимально возможную высоту строки. Записать **double**. |
...
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Устанавливает заданные свойства формата части для всех частей элементов. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Устанавливает заданные свойства формата абзаца для всех абзацев элементов. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Устанавливает заданные свойства формата текстового кадра для всех текстовых кадров элементов. |
