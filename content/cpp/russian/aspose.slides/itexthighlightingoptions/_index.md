...
type: docs
weight: 4109
url: /ru/aspose.slides/itexthighlightingoptions/
---
## ITextHighlightingOptions класс
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Установите true, чтобы использовать поиск с учётом регистра, иначе false. Чтение **bool**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Установите true, чтобы искать только целые слова, иначе false. Чтение **bool**. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Установите true, чтобы использовать поиск с учётом регистра, иначе false. Запись **bool**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Установите true, чтобы искать только целые слова, иначе false. Запись **bool**. |
...
Устаревшее
:   Интерфейс [ITextHighlightingOptions](./) будет удалён после выхода версии 24.10.
