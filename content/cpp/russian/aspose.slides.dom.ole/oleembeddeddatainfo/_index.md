...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | Возвращает данные файла встроенного объекта OLE только для чтения **uint8_t**[]. |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | Возвращает расширение файла текущего встроенного объекта OLE только для чтения [System::String](../../system/string/). |
...
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)() | Создаёт новую информацию о встроенных данных для объекта OLE. |
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | Создаёт новый экземпляр информации о встроенных данных для объекта OLE. |
...
* Класс [IOleEmbeddedDataInfo](../../aspose.slides/ioleembeddeddatainfo/)
* Пространство имён [Aspose::Slides::DOM::Ole](../)
