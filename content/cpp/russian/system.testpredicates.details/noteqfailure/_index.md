...
description: Форматирует сбой утверждения != для вывода.
type: docs
weight: 40
url: /ru/system.testpredicates.details/noteqfailure/
---
## System::TestPredicates::Details::NotEqFailure(const char *, const char *, T1\&, T2\&) функция

Форматирует сбой утверждения != для вывода.
