...
description: Предоставляет исключение, которое выбрасывается при возникновении ошибки при обработке выражения XPath.
type: docs
weight: 1
url: /ru/system.xml.xpath/details_xpathexception/
---
## Details_XPathException класс

Предоставляет исключение, выбрасываемое при ошибке обработки выражения [XPath](../).
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Возвращает 32-разрядное целочисленное значение, являющееся кодом HRESULT, связанным с исключением, представленным текущим объектом. |
...
| [String](../../system/string/) [get_Message](./get_message/)() const override | Возвращает описание условия ошибки для этого исключения. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Устанавливает HRESULT, кодированное числовое значение, назначаемое конкретному исключению. |
