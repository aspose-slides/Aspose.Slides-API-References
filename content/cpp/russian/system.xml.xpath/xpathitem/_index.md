...
description: Представляет элемент в модели данных XQuery 1.0 и XPath 2.0.
type: docs
weight: 53
url: /ru/system.xml.xpath/xpathitem/
---
## XPathItem класс
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Сравнивает объекты типовых (значимых) типов в стиле C#. |
...
| virtual **bool** [get_IsNode](./get_isnode/)() | При переопределении в производном классе возвращает значение, указывающее, представляет ли элемент узел [XPath](../) или атомарное значение. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_TypedValue](./get_typedvalue/)() | При переопределении в производном классе получает текущий элемент как упакованный объект наиболее подходящего типа в соответствии с его типом схемы. |
| virtual [String](../../system/string/) [get_Value](./get_value/)() | При переопределении в производном классе получает значение элемента в виде **string**. |
| virtual **bool** [get_ValueAsBoolean](./get_valueasboolean/)() | При переопределении в производном классе получает значение элемента как [Boolean](../../system/boolean/). |
| virtual [DateTime](../../system/datetime/) [get_ValueAsDateTime](./get_valueasdatetime/)() | При переопределении в производном классе получает значение элемента как [DateTime](../../system/datetime/). |
| virtual **double** [get_ValueAsDouble](./get_valueasdouble/)() | При переопределении в производном классе получает значение элемента как [Double](../../system/double/). |
| virtual **int32_t** [get_ValueAsInt](./get_valueasint/)() | При переопределении в производном классе получает значение элемента как [Int32](../../system/int32/). |
| virtual **int64_t** [get_ValueAsLong](./get_valueaslong/)() | При переопределении в производном классе получает значение элемента как [Int64](../../system/int64/). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchemaType](../../system.xml.schema/xmlschematype/)\> [get_XmlType](./get_xmltype/)() | При переопределении в производном классе получает XmlSchemaType элемента. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Сравнивает объект типового (значимого) типа со значением nullptr по ссылке. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ValueAs](./valueas/)(const [TypeInfo](../../system/typeinfo/)\&) | Возвращает значение элемента как указанный тип. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ValueAs](./valueas/)(const [TypeInfo](../../system/typeinfo/)\&, [SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>) | При переопределении в производном классе возвращает значение элемента как тип, указанный с помощью объекта [IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/), используемого для разрешения префиксов пространств имён. |
