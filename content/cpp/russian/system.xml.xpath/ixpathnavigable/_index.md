...
description: Предоставляет доступ к классу XPathNavigator.
type: docs
weight: 14
url: /ru/system.xml.xpath/ixpathnavigable/
---
## IXPathNavigable класс

Предоставляет доступ к классу [XPathNavigator](../xpathnavigator/).
...
| Метод | Описание |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() | Возвращает новый объект [XPathNavigator](../xpathnavigator/). |
