...
description: Сравнивает массивы или списки на равенство.
type: docs
weight: 40
url: /ru/system.testpredicates.details.sharedptrasserts/notnullareequalimpl/
---
## System::TestPredicates::Details::SharedPtrAsserts::NotNullAreEqualImpl(const char *, const char *, const T1\&, const T2\&, long long) функция

Сравнивает массивы или списки на равенство.
...
| s | long long | Сервисный параметр, служит селектором реализации функции; значение параметра игнорируется. |
...
Сравнивает экземпляры IEnumerable на равенство.
...
## System::TestPredicates::Details::SharedPtrAsserts::NotNullAreEqualImpl(const char *, const char *, const T1\&, const T2\&, int32_t) функция

Сравнивает неизвестные типы с использованием метода Equals.
