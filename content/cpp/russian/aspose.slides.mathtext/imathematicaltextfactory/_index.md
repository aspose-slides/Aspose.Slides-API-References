...
---
## IMathematicalTextFactory класс

Позволяет создать элемент [MathematicalText](../mathematicaltext/)
...
| Метод | Описание |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)() | Создает пустой элемент математического текста |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)(char16_t) | Создает элемент математического текста с указанным значением |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/)) | Создает пустой элемент математического текста с указанным значением |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\>) | Создает пустой элемент математического текста с указанным значением и свойствами форматирования |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Сравнивает объект типажа значения со `nullptr`. |
