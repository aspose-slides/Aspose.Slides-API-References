...
description: Вычисляет интеграл
type: docs
weight: 183
url: /ru/aspose.slides.mathtext/mathelementbase/integral/
---
## MathElementBase::Integral(MathIntegralTypes, System::SharedPtr\<IMathElement\>, System::SharedPtr\<IMathElement\>, MathLimitLocations) метод
...
## MathElementBase::Integral(MathIntegralTypes, System::SharedPtr\<IMathElement\>, System::SharedPtr\<IMathElement\>) метод
...
## MathElementBase::Integral(MathIntegralTypes) метод
...
## MathElementBase::Integral(MathIntegralTypes, System::String, System::String, MathLimitLocations) метод
...
## MathElementBase::Integral(MathIntegralTypes, System::String, System::String) метод
