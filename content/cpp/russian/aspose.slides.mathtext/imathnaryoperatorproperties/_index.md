...
---
## IMathNaryOperatorProperties класс

Определяет свойства [IMathNaryOperator](../imathnaryoperator/)
...
| virtual **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() | Символ оператора растет вертикально, чтобы соответствовать высоте его операнда |
| virtual **bool** [get_HideSubscript](./get_hidesubscript/)() | Скрыть нижний индекс |
| virtual **bool** [get_HideSuperscript](./get_hidesuperscript/)() | Скрыть верхний индекс |
| virtual [MathLimitLocations](../mathlimitlocations/) [get_LimitLocation](./get_limitlocation/)() | Расположение пределов (нижний и верхний индексы) |
| virtual char16_t [get_Operator](./get_operator/)() | Символ n-арного оператора. Например: '\\u2211', '\\u222B' |
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку из заявления C# lock(). Вызывайте напрямую или используйте объект-сторож [LockContext](../../system/lockcontext/). |
...
| virtual void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) | Символ оператора растет вертикально, чтобы соответствовать высоте его операнда |
| virtual void [set_HideSubscript](./set_hidesubscript/)(**bool**) | Скрыть нижний индекс |
| virtual void [set_HideSuperscript](./set_hidesuperscript/)(**bool**) | Скрыть верхний индекс |
| virtual void [set_LimitLocation](./set_limitlocation/)([MathLimitLocations](../mathlimitlocations/)) | Расположение пределов (нижний и верхний индексы) |
| virtual void [set_Operator](./set_operator/)(char16_t) | Символ n-арного оператора. Например: '\\u2211', '\\u222B' |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку из заявления C# lock(). Вызывайте напрямую или используйте объект-сторож [LockContext](../../system/lockcontext/). |
