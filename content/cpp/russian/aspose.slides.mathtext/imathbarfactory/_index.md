...
description: Позволяет создавать математическую черту
type: docs
weight: 92
url: /ru/aspose.slides.mathtext/imathbarfactory/
---
## IMathBarFactory класс
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [CreateMathBar](./createmathbar/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Создаёт математическую черту, применяя к элементу |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [CreateMathBar](./createmathbar/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathTopBotPositions](../mathtopbotpositions/)) | Создаёт математическую черту, применяя к элементу |
