...
description: Задает радикальную функцию, состоящую из основания и необязательной степени. Пример радикального объекта: \\u221A\\uD835\\uDC65.
type: docs
weight: 1054
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Degree](./get_degree/)() override | Аргумент степени |
| **bool** [get_HideDegree](./get_hidedegree/)() override | Скрывать степень. Когда true, степень не отображается, как в \\u221A\\uD835\\uDC65 |
...
|  [MathRadical](./mathradical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Инициализирует новый экземпляр класса [MathRadical](./). |
...
| void [set_HideDegree](./set_hidedegree/)(**bool**) override | Скрывать степень. Когда true, степень не отображается, как в \\u221A\\uD835\\uDC65 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n't-й аргумент шаблона как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в слабый режим. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Размещает этот элемент в невизуальном блоке (логической группировке), используемом для группировки компонентов уравнения или другого фрагмента математического текста. Объект в коробке может (например) выступать в роли эмулятора оператора с точкой выравнивания или без неё, служить точкой разрыва строки или группироваться так, чтобы не разрешать разрывы строк внутри. |
