...
---
## IMathParagraph класс

Математический абзац, который является контейнером для математических блоков ([IMathBlock](../imathblock/))
...
| Метод | Описание |
| --- | --- |
| virtual void [Add](../imathblockcollection/add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Добавляет [IMathBlock](../imathblock/) в конец коллекции. |
...
| virtual void [Clear](../imathblockcollection/clear/)() | Удаляет все элементы из коллекции. |
| virtual **bool** [Contains](../imathblockcollection/contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Определяет, содержит ли коллекция конкретное значение. |
...
| virtual **int32_t** [get_Count](../imathblockcollection/get_count/)() | Получает количество фактически содержащихся в коллекции элементов. Только для чтения **int32_t**. |
| virtual [MathJustification](../mathjustification/) [get_Justification](./get_justification/)() | [Paragraph](../../aspose.slides/paragraph/) Выравнивание Default value: CenteredAsGroup |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](../imathblockcollection/idx_get/)(**int32_t**) | Получает элемент по указанному индексу. Только для чтения [IMathBlock](../imathblock/). |
| virtual void [idx_set](../imathblockcollection/idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Получает элемент по указанному индексу. Только для чтения [IMathBlock](../imathblock/). |
| virtual **int32_t** [IndexOf](../imathblockcollection/indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Определяет индекс конкретного [IMathBlock](../imathblock/) в коллекции. |
| virtual void [Insert](../imathblockcollection/insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Вставляет [IMathBlock](../imathblock/) в коллекцию по указанному индексу. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Сортирует элементы последовательности по возрастанию согласно значениям ключей, выбранных функцией keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Сортирует элементы последовательности по убыванию согласно значениям ключей, выбранных функцией keySelector. |
...
| virtual **bool** [Remove](../imathblockcollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Удаляет первое вхождение конкретного объекта из коллекции/>. |
| virtual void [RemoveAt](../imathblockcollection/removeat/)(**int32_t**) | Удаляет элемент по указанному индексу из коллекции. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Уменьшает счётчик общих ссылок на указанное значение. |
| virtual void [set_Justification](./set_justification/)([MathJustification](../mathjustification/)) | [Paragraph](../../aspose.slides/paragraph/) Выравнивание Default value: CenteredAsGroup |
...
| virtual [System::String](../../system/string/) [ToLatex](./tolatex/)() | Получает математическое уравнение в формате LaTeX |
...
| virtual void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Сохраняет содержимое этого [IMathParagraph](./) в виде MathML |
...
* Класс [IMathBlockCollection](../imathblockcollection/)
