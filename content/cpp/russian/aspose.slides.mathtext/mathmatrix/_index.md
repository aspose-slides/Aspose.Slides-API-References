...
description: Указывает объект Matrix, состоящий из дочерних элементов, расположенных в одной или нескольких строках и столбцах. Важно отметить, что у матриц нет встроенных разделителей. Чтобы разместить матрицу в скобках, следует использовать объект разделителя (IMathDelimiter). Пустые аргументы можно использовать для создания пустот в матрицах.
type: docs
weight: 950
...
| void [DeleteColumn](./deletecolumn/)(**int32_t**) override | Удаляет указанный столбец |
| void [DeleteRow](./deleterow/)(**int32_t**) override | Удаляет указанную строку |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)() override | Ограничивает математический элемент скобками |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Ограничивает математический элемент указанными символами, такими как скобки или другими символами в качестве обрамления |
...
| [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() override | Задает вертикальное выравнивание относительно окружающего текста. Возможные значения: top, bottom, center. По умолчанию: Center |
| **int32_t** [get_ColumnCount](./get_columncount/)() override | Количество столбцов в матрице |
| **uint32_t** [get_ColumnGap](./get_columngap/)() override | Значение горизонтального интервала между столбцами матрицы; если ColumnGapRule имеет значение 3 (\"Exactly\"), единица измерения интерпретируется как twips (1/20 пункта). Если ColumnGapRule имеет значение 4 (\"Multiple\"), единица измерения интерпретируется как количество шагов 0.5 em. В остальных случаях игнорируется. По умолчанию: 0 |
| [MathSpacingRules](../mathspacingrules/) [get_ColumnGapRule](./get_columngaprule/)() override | Тип горизонтального интервала между столбцами матрицы; единицы горизонтального интервала могут быть ems или points (хранятся как twips). По умолчанию: SingleSpacingGap (0) |
| **bool** [get_HidePlaceholders](./get_hideplaceholders/)() override | Скрывать заполнители для пустых элементов матрицы. По умолчанию: false |
| **uint32_t** [get_MinColumnWidth](./get_mincolumnwidth/)() override | Минимальная ширина столбца в twips (1/20 пункта). Промежуток (также обозначаемый как \\u201CColumn Gap\\u201D или \\u201CGap Width\\u201D) добавляется к MinColumnWidth для определения общего интервала матрицы [Column](../../aspose.slides/column/) (расстояние между одинаковыми краями разных столбцов). По умолчанию: 0. |
| **int32_t** [get_RowCount](./get_rowcount/)() override | Количество строк в матрице |
| **uint32_t** [get_RowGap](./get_rowgap/)() override | Значение вертикального интервала между строками матрицы; если RowGapRule имеет значение 3 (\"Exactly\"), единица измерения интерпретируется как twips (1/20 пункта). Если RowGapRule имеет значение 4 (\"Multiple\"), единица измерения интерпретируется как половина строки. По умолчанию: 0 |
| [MathSpacingRules](../mathspacingrules/) [get_RowGapRule](./get_rowgaprule/)() override | Тип вертикального интервала между строками матрицы; единицы вертикального интервала могут быть lines или points (хранятся как twips). По умолчанию: SingleSpacingGap (0) |
...
| [MathHorizontalAlignment](../mathhorizontalalignment/) [GetColumnAlignment](./getcolumnalignment/)(**int32_t**) override | Получить горизонтальное выравивание указанного столбца |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | Размещает этот элемент в группе, используя символ группировки, такой как нижняя фигурная скобка или иной |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [idx_get](./idx_get/)(**int32_t**, **int32_t**) override | Элемент матрицы |
| void [idx_set](./idx_set/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Элемент матрицы |
| void [InsertColumnAfter](./insertcolumnafter/)(**int32_t**) override | Вставить новый столбец после указанного. Изначально все элементы в новом столбце равны null. |
| void [InsertColumnBefore](./insertcolumnbefore/)(**int32_t**) override | Вставить новый столбец перед указанным. Изначально все элементы в новом столбце равны null. |
| void [InsertRowAfter](./insertrowafter/)(**int32_t**) override | Вставить новую строку после указанной. Изначально все элементы в новой строке равны null. |
| void [InsertRowBefore](./insertrowbefore/)(**int32_t**) override | Вставить новую строку перед указанной. Изначально все элементы в новой строке равны null. |
...
|  [MathMatrix](./mathmatrix/)(**int32_t**, **int32_t**) | Инициализирует новый экземпляр класса [MathMatrix](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Задает математический корень указанной степени из заданного аргумента. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | Задает математический корень указанной степени из заданного аргумента. |
...
| void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) override | Задает вертикальное выравнивание относительно окружающего текста. Возможные значения: top, bottom, center. По умолчанию: Center |
| void [set_ColumnGap](./set_columngap/)(**uint32_t**) override | Значение горизонтального интервала между столбцами матрицы; если ColumnGapRule имеет значение 3 (\"Exactly\"), единица измерения интерпретируется как twips (1/20 пункта). Если ColumnGapRule имеет значение 4 (\"Multiple\"), единица измерения интерпретируется как количество шагов 0.5 em. В остальных случаях игнорируется. По умолчанию: 0 |
| void [set_ColumnGapRule](./set_columngaprule/)([MathSpacingRules](../mathspacingrules/)) override | Тип горизонтального интервала между столбцами матрицы; единицы горизонтального интервала могут быть ems или points (хранятся как twips). По умолчанию: SingleSpacingGap (0) |
| void [set_HidePlaceholders](./set_hideplaceholders/)(**bool**) override | Скрывать заполнители для пустых элементов матрицы. По умолчанию: false |
| void [set_MinColumnWidth](./set_mincolumnwidth/)(**uint32_t**) override | Минимальная ширина столбца в twips (1/20 пункта). Промежуток (также обозначаемый как \\u201CColumn Gap\\u201D или \\u201CGap Width\\u201D) добавляется к MinColumnWidth для определения общего интервала матрицы [Column](../../aspose.slides/column/) (расстояние между одинаковыми краями разных столбцов). По умолчанию: 0. |
| void [set_RowGap](./set_rowgap/)(**uint32_t**) override | Значение вертикального интервала между строками матрицы; если RowGapRule имеет значение 3 (\"Exactly\"), единица измерения интерпретируется как twips (1/20 пункта). Если RowGapRule имеет значение 4 (\"Multiple\"), единица измерения интерпретируется как половина строки. По умолчанию: 0 |
| void [set_RowGapRule](./set_rowgaprule/)([MathSpacingRules](../mathspacingrules/)) override | Тип вертикального интервала между строками матрицы; единицы вертикального интервала могут быть lines или points (хранятся как twips). По умолчанию: SingleSpacingGap (0) |
| void [SetColumnAlignment](./setcolumnalignment/)(**int32_t**, [MathHorizontalAlignment](../mathhorizontalalignment/)) override | Установить горизонтальное выравивание указанного столбца |
| void [SetColumnsAlignment](./setcolumnsalignment/)(**int32_t**, **uint32_t**, [MathHorizontalAlignment](../mathhorizontalalignment/)) override | Установить горизонтальное выравивание указанных столбцов |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)() override | Размещает этот элемент в border-box |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) override | Размещает этот элемент в border-box |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Размещает этот элемент в невидимом контейнере (логической группе), который используется для группировки компонентов уравнения или другого фрагмента математического текста. Объект в коробке может (например) служить эмулятором оператора с или без точки выравнивания, служить точкой разрыва строки или быть сгруппированным таким образом, чтобы не допускать разрыва строки внутри. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Underbar](../mathelementbase/underbar/)() override | Устанавливает черту под этим элементом |
