...
Позволяет создавать элемент [MathematicalText](../mathematicaltext/)
...
| Метод | Описание |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)() override | Создает пустой элемент математического текста |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)(char16_t) override | Создает элемент математического текста с указанным значением |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/)) override | Создает пустой элемент математического текста с указанным значением |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\>) override | Создает пустой элемент математического текста с указанным значением и свойствами форматирования |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й параметр шаблона в слабый указатель (а не в разделяемый). Позволяет переключать указатели в контейнерах в режим слабых. |
...
* Класс [IMathematicalTextFactory](../imathematicaltextfactory/)
