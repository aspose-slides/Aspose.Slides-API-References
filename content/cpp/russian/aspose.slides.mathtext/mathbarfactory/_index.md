...
description: Позволяет создавать математический бар
type: docs
weight: 677
...
Позволяет создавать математический бар
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [CreateMathBar](./createmathbar/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Создаёт математический бар, применяя к элементу |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [CreateMathBar](./createmathbar/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathTopBotPositions](../mathtopbotpositions/)) override | Создаёт математический бар, применяя к элементу |
...
* Класс [IMathBarFactory](../imathbarfactory/)
