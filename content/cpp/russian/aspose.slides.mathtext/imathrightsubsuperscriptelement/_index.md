...
description: Определяет объект Sub-Superscript, который состоит из базового элемента и нижнего и верхнего индексов, размещённых справа от базового элемента.
type: docs
weight: 534
...
| Метод | Описание |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../imathelement/accent/)(char16_t) | Устанавливает надстрочный знак (символ в верхней части этого элемента) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)() | Заключает математический элемент в круглые скобки |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Обрамляет этот элемент указанными символами, например скобками или другими символами |
...
| virtual **bool** [get_AlignScripts](./get_alignscripts/)() | Указывает выравнивание нижнего/верхнего индекса. Если true, нижний и верхний индексы выравниваются по горизонтали друг относительно друга. Если false, они подгоняются к форме базового элемента. Значение по умолчанию — false. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | Базовый аргумент |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Subscript](./get_subscript/)() | Аргумент нижнего индекса |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Superscript](./get_superscript/)() | Аргумент верхнего индекса |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../imathelement/join/)([System::String](../../system/string/)) | Объединяет математический элемент и формирует математический блок |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Указывает математический корень указанной степени из заданного аргумента. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Указывает математический корень указанной степени из заданного аргумента. |
...
| virtual void [set_AlignScripts](./set_alignscripts/)(**bool**) | Указывает выравнивание нижнего/верхнего индекса. Если true, нижний и верхний индексы выравниваются по горизонтали друг относительно друга. Если false, они подгоняются к форме базового элемента. Значение по умолчанию — false. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRightSubSuperscriptElement](./)\> [SetSubSuperscriptOnTheRight](../imathelement/setsubsuperscriptontheright/)([System::String](../../system/string/), [System::String](../../system/string/)) | Создаёт нижний и верхний индексы справа |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)() | Размещает этот элемент в границевом блоке |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | Размещает этот элемент в границевом блоке |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Размещает этот элемент в невизуальном блоке (логической группировке), который используется для группировки компонентов уравнения или другого фрагмента математического текста. Объект в коробке может (например) служить эмулятором оператора с точкой выравнивания или без неё, служить точкой разрыва строки или быть сгруппирован так, чтобы не позволять разрывы строк внутри. |
