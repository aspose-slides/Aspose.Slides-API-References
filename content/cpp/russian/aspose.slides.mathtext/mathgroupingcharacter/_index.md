...
| Метод | Описание |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../mathelementbase/accent/)(char16_t) override | Устанавливает акцент (символ в верхней части этого элемента) |
...
| char16_t [get_Character](./get_character/)() override | Значение по умолчанию символа группировки: U+23DF (нижняя фигурная скобка) |
| [MathTopBotPositions](../mathtopbotpositions/) [get_Position](./get_position/)() override | Позиция символа группировки. По умолчанию: Снизу |
| [MathTopBotPositions](../mathtopbotpositions/) [get_VerticalJustification](./get_verticaljustification/)() override | Вертикальное выравнивание символа группировки. Задает выравнивание объекта относительно базовой линии. Например, когда символ группировки находится над объектом, вертикальное выравнивание Top означает, что верхняя часть объекта находится на базовой линии; когда вертикальное выравнивание установлено в Bottom, нижняя часть объекта находится на базовой линии. По умолчанию: Bottom для Position=Top и Top для Position=Bottom |
...
|  [MathGroupingCharacter](./mathgroupingcharacter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Инициализирует новый экземпляр класса [MathGroupingCharacter](./) со значением символа группировки по умолчанию U+23DF (нижняя фигурная скобка) |
|  [MathGroupingCharacter](./mathgroupingcharacter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | Инициализирует новый экземпляр класса [MathGroupingCharacter](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Задаёт математический корень заданной степени из указанного аргумента. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | Задаёт математический корень заданной степени из указанного аргумента. |
...
| void [set_Character](./set_character/)(char16_t) override | Значение по умолчанию символа группировки: U+23DF (нижняя фигурная скобка) |
| void [set_Position](./set_position/)([MathTopBotPositions](../mathtopbotpositions/)) override | Позиция символа группировки. По умолчанию: Снизу |
| void [set_VerticalJustification](./set_verticaljustification/)([MathTopBotPositions](../mathtopbotpositions/)) override | Вертикальное выравнивание символа группировки. Задает выравнивание объекта относительно базовой линии. Например, когда символ группировки находится над объектом, вертикальное выравнивание Top означает, что верхняя часть объекта находится на базовой линии; когда вертикальное выравнивание установлено в Bottom, нижняя часть объекта находится на базовой линии. По умолчанию: Bottom для Position=Top и Top для Position=Bottom |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Размещает этот элемент в невизуальном блоке (логической группировке), который используется для группировки компонентов уравнения или другого фрагмента математического текста. Объект в коробке может (например) выступать в роли эмулятора оператора с точкой выравнивания или без неё, служить точкой разрыва строки или быть сгруппированным так, чтобы не допускать разрывов строк внутри. |
