...
description: Предоставляет информацию о дисплеях. Только Windows. Это тип-синглтон, управление памятью осуществляется через функции доступа. Вы никогда не должны создавать его экземпляры напрямую.
type: docs
weight: 40
url: /ru/system.windows.forms/screen/
---
## Класс Screen
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | Получает границы экрана. |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | Получает информацию о основном дисплее. |
