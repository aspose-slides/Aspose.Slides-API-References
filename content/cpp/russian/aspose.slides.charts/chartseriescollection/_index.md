...
description: Представляет коллекцию ChartSeries
type: docs
weight: 287
...
| Метод | Описание |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) override | Создаёт новую серию диаграммы и добавляет её в коллекцию. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) override | Создаёт новую серию диаграммы из [ChartDataCell](../chartdatacell/) и добавляет её в коллекцию. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) override | Создаёт новую серию диаграммы из [ChartCellCollection](../chartcellcollection/) и добавляет её в коллекцию. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) override | Создаёт новую серию диаграммы из значения и добавляет её в коллекцию. |
| [iterator](./iterator/) [begin](./begin/)() | Получает итератор, указывающий на первый элемент (если он есть) коллекции. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Получает итератор, указывающий на первый элемент (если он есть) константной версии коллекции. |
...
| void [Clear](./clear/)() override | Удаляет все элементы управления из коллекции. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>, **int32_t**) override | Копирует все элементы из коллекции в указанный массив. |
| [iterator](./iterator/) [end](./end/)() | Получает итератор, указывающий сразу после последнего элемента (если он есть) коллекции. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Получает итератор, указывающий сразу после последнего элемента (если он есть) константной версии коллекции. |
...
| **int32_t** [get_Count](./get_count/)() override | Возвращает количество объектов в коллекции. Только для чтения **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Возвращает значение, указывающее, синхронен ли доступ к коллекции (потокобезопасен). Только для чтения **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>\> [GetEnumerator](./getenumerator/)() override | Возвращает перечислитель, который проходит по элементам коллекции. |
...
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Ищет указанный [ChartSeries](../chartseries/) и возвращает нулевой индекс первого вхождения в всю коллекцию. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) override | Создаёт новую серию диаграммы и вставляет её в коллекцию. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Удаляет указанное значение. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Удаляет ActiveX элемент, хранящийся в указанной позиции, из коллекции. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Получает итератор, указывающий на первый элемент (если он есть) константной версии коллекции. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Получает итератор, указывающий сразу после последнего элемента (если он есть) константной версии коллекции. |
...
* Класс [IChartSeriesCollection](../ichartseriescollection/)
