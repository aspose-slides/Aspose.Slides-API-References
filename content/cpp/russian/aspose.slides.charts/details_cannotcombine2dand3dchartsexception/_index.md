...
type: docs
weight: 443
url: /ru/aspose.slides.charts/details_cannotcombine2dand3dchartsexception/
---
## Details_CannotCombine2DAnd3DChartsException класс

Исключение, которое бросается при попытке сочетать 2D и 3D типы диаграмм.
...
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Возвращает строку, содержащую стек вызовов. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_invalidoperationexception/gettype/)() const override | Получает реальный тип объекта. Аналог вызова C# [System.Object.GetType()](../../system/object/gettype/). |
