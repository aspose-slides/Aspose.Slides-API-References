...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)(**int32_t**) | Возвращает ячейку диаграммы по указанному индексу. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [get_AsCells](./get_ascells/)() | Возвращает коллекцию ячеек диаграммы. Читайте [IChartCellCollection](../ichartcellcollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | Указывает, какой из свойств AsCell, AsLiteralString или AsLiteralDouble является фактическим. Другими словами, определяет тип значения свойства Data. Это свойство только для чтения. Для изменения значения этого свойства можно использовать одно из свойств ChartDataPointCollection.DataSourceTypeFor<...>. Читайте [DataSourceType](../datasourcetype/). |
...
| virtual void [set_AsCells](./set_ascells/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>) | Устанавливает коллекцию ячеек диаграммы. Запишите [IChartCellCollection](../ichartcellcollection/). |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Указывает, какой из свойств AsCell, AsLiteralString или AsLiteralDouble является фактическим. Другими словами, определяет тип значения свойства Data. Это свойство только для чтения. Для изменения значения этого свойства можно использовать одно из свойств ChartDataPointCollection.DataSourceTypeFor<...>. Запишите [DataSourceType](../datasourcetype/). |
