...
description: Обеспечивает доступ к полосам вверх/вниз линейных или биржевых диаграмм.
type: docs
weight: 1249
url: /ru/aspose.slides.charts/iupdownbarsmanager/
---
## IUpDownBarsManager класс

Обеспечивает доступ к полосам вверх/вниз линейных или биржевых диаграмм.

```cpp
class IUpDownBarsManager : public virtual System::Object
```
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | Возвращает формат нижних полос. Только для чтения [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | Возвращает ширину промежутка. Читает **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | Определяет, содержит ли диаграмма полосы вверх/вниз. Читает **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | Возвращает формат верхних полос. Только для чтения [IFormat](../iformat/). |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | Устанавливает ширину промежутка. Записывает **int32_t**. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | Определяет, содержит ли диаграмма полосы вверх/вниз. Записывает **bool**. |
