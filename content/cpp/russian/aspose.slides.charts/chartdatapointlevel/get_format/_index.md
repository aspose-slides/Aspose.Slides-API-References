...
description: Представляет свойства форматирования уровня точки данных. Читайте IFormat.
type: docs
weight: 1
url: /ru/aspose.slides.charts/chartdatapointlevel/get_format/
---
## ChartDataPointLevel::get_Format() метод

Представляет свойства форматирования уровня точки данных. Читать [IFormat](../../iformat/).

```cpp
System::SharedPtr<IFormat> Asprose::Slides::Charts::ChartDataPointLevel::get_Format() override
```
