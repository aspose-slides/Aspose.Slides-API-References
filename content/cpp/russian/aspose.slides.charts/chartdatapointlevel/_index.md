...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Представляет свойства форматирования уровня точки данных. Читайте [IFormat](../iformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() override | Представляет подпись данных уровня точки данных. Применяется к типам серий Treemap и Sunburst. Только для чтения [IDataLabel](../idatalabel/). |
...
* Класс [IChartDataPointLevel](../ichartdatapointlevel/)
