...
| Метод | Описание |
| --- | --- |
| void [DeleteGroupingItem](./deletegroupingitem/)(**int32_t**) override | Удалить элемент группировки для заданного уровня. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) override | Возвращает объект [IChartDataCell](../ichartdatacell/) для заданного уровня. |
...
| void [SetGroupingItem](./setgroupingitem/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Устанавливает элемент группировки для заданного уровня. |
...
* Класс [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)
