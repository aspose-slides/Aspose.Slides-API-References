...
description: Обеспечивает доступ к up/down барам линейных или биржевых графиков.
type: docs
weight: 1392
...
Обеспечивает доступ к up/down барам линейных или биржевых графиков.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() override | Возвращает формат DownBars. Только для чтения [IFormat](../iformat/). |
| **int32_t** [get_GapWidth](./get_gapwidth/)() override | GapWidth. Чтение **int32_t**. |
| **bool** [get_HasUpDownBars](./get_hasupdownbars/)() override | HasUpDownBars. Чтение **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() override | Возвращает формат UpBars. Только для чтения [IFormat](../iformat/). |
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку конструкции C# lock(). Вызывайте напрямую или используйте объект-страж [LockContext](../../system/lockcontext/). |
...
| void [set_GapWidth](./set_gapwidth/)(**int32_t**) override | GapWidth. Запись **int32_t**. |
| void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) override | HasUpDownBars. Запись **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку конструкции C# lock(). Вызывайте напрямую или используйте объект-страж [LockContext](../../system/lockcontext/). |
...
* Класс [IUpDownBarsManager](../iupdownbarsmanager/)
