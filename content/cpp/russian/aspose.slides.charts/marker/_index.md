...
description: Представляет маркер чарта.
type: docs
weight: 1301
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Получает заливку маркера. Только для чтения [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | Представляет размер маркера в линейном графике, точечном графике или радиальном графике. Чтение **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | Представляет стиль маркера в линейном графике, точечном графике или радиальном графике. Чтение [MarkerStyleType](../markerstyletype/). |
...
| void [set_Size](./set_size/)(**int32_t**) override | Представляет размер маркера в линейном графике, точечном графике или радиальном графике. Запись **int32_t**. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | Представляет стиль маркера в линейном графике, точечном графике или радиальном графике. Запись [MarkerStyleType](../markerstyletype/). |
