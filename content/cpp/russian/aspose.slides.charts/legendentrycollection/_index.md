...
| **int32_t** [get_Count](./get_count/)() override | Возвращает количество записей легенды. Только для чтения **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILegendEntryProperties](../ilegendentryproperties/)\> [idx_get](./idx_get/)(**int32_t**) override | Возвращает свойства записи легенды, соответствующие [Chart::get_ChartData()](../chart/get_chartdata/)->get_Series()[0].DataPoints[index] в случае типа диаграммы из следующего списка: [ChartType::BarOfPie](../charttype/), [ChartType::ExplodedPie](../charttype/), [ChartType::ExplodedPie3D](../charttype/), [ChartType::Pie](../charttype/), [ChartType::Pie3D](../charttype/), [ChartType::PieOfPie](../charttype/); либо соответствующие [Chart::get_ChartData()](../chart/get_chartdata/)->get_Series()[index] для остальных типов диаграмм. |
...
* Класс [ILegendEntryCollection](../ilegendentrycollection/)
