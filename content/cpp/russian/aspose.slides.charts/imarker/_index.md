...
description: Представляет маркер черта.
type: docs
weight: 1119
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Получает заливку маркера. Только для чтения [IFormat](../iformat/). |
| virtual **int32_t** [get_Size](./get_size/)() | Представляет размер маркера в линейном графике, точечном графике или радиальном графике. Читает **int32_t**. |
| virtual [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() | Представляет стиль маркера в линейном графике, точечном графике или радиальном графике. Читает [MarkerStyleType](../markerstyletype/). |
...
| virtual void [set_Size](./set_size/)(**int32_t**) | Представляет размер маркера в линейном графике, точечном графике или радиальном графике. Запись **int32_t**. |
| virtual void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) | Представляет стиль маркера в линейном графике, точечном графике или радиальном графике. Запись [MarkerStyleType](../markerstyletype/). |
