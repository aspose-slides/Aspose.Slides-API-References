...
description: Представляет коллекцию листов данных диаграммы рабочей книги.
type: docs
weight: 755
url: /ru/aspose.slides.charts/ichartdataworksheetcollection/
---
## IChartDataWorksheetCollection класс


Представляет коллекцию листов данных диаграммы рабочей книги.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\> [idx_get](./idx_get/)(**int32_t**) | Возвращает лист таблицы по индексу. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Возвращает количество элементов в последовательности (рассчитанное путем прямого подсчета). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона в слабый указатель (а не совместный). Позволяет переключать указатели в контейнерах в режим weak. |
