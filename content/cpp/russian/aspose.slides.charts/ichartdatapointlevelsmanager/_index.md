...
description: Контейнер уровней точек данных. Применяется для рядов Treeamp и Sunburst. Индексация уровней точек данных начинается с нуля.
type: docs
weight: 716
url: /ru/aspose.slides.charts/ichartdatapointlevelsmanager/
---
## IChartDataPointLevelsManager класс

Контейнер уровней точек данных. Применяется для рядов Treeamp и Sunburst. Индексация уровней точек данных начинается с нуля.
...
| virtual **int32_t** [get_Count](./get_count/)() | Возвращает количество уровней точек данных. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPointLevel](../ichartdatapointlevel/)\> [idx_get](./idx_get/)(**int32_t**) | Возвращает объект [IChartDataPointLevel](../ichartdatapointlevel/) для заданного уровня. |
