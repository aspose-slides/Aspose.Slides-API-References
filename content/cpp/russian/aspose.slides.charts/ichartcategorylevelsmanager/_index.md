...
---
## IChartCategoryLevelsManager класс
...
| Метод | Описание |
| --- | --- |
| virtual void [DeleteGroupingItem](./deletegroupingitem/)(**int32_t**) | Удалить элемент группировки для заданного уровня. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | Возвращает объект [IChartDataCell](../ichartdatacell/) для заданного уровня. |
...
| virtual void [SetGroupingItem](./setgroupingitem/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Устанавливает элемент группировки для заданного уровня. |
