...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() | Возвращает ячейку данных графика. Читать [IChartDataCell](../ichartdatacell/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | Указывает, какое из свойств AsCell, AsLiteralString или AsLiteralDouble является актуальным. Другими словами, указывает тип значения свойства Data. Это свойство только для чтения. Чтобы изменить значение этого свойства, можно использовать одно из свойств ChartDataPointCollection.DataSourceTypeFor<...>. Читать [DataSourceType](../datasourcetype/). |
...
| virtual void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Устанавливает ячейку данных графика. Записать [IChartDataCell](../ichartdatacell/). |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Указывает, какое из свойств AsCell, AsLiteralString или AsLiteralDouble является актуальным. Другими словами, указывает тип значения свойства Data. Это свойство только для чтения. Чтобы изменить значение этого свойства, можно использовать одно из свойств ChartDataPointCollection.DataSourceTypeFor<...>. Записать [DataSourceType](../datasourcetype/). |
...
* Класс [IBaseChartValue](../ibasechartvalue/)
