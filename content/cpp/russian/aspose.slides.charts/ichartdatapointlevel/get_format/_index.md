...
description: Представляет свойства форматирования уровня точки данных. См. IFormat.
type: docs
weight: 1
url: /ru/aspose.slides.charts/ichartdatapointlevel/get_format/
---
## IChartDataPointLevel::get_Format() метод

Представляет свойства форматирования уровня точки данных. См. [IFormat](../../iformat/).
