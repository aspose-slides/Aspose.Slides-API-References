...
| virtual **float** [get_Bottom](./get_bottom/)() | Получает верхнюю границу элемента диаграммы как долю от высоты диаграммы. Только для чтения **float**. |
...
| virtual **float** [get_Height](./get_height/)() | Указывает высоту элемента диаграммы как долю от высоты диаграммы. Читать **float**. |
...
| virtual **float** [get_Right](./get_right/)() | Получает правую границу элемента диаграммы как долю от ширины диаграммы. Только для чтения **float**. |
...
| virtual **float** [get_Width](./get_width/)() | Указывает ширину элемента диаграммы как долю от ширины диаграммы. Читать **float**. |
| virtual **float** [get_X](./get_x/)() | Указывает положение по оси x (слева) элемента диаграммы как долю от ширины диаграммы. Читать **float**. |
| virtual **float** [get_Y](./get_y/)() | Указывает верхнюю границу элемента диаграммы как долю от высоты диаграммы. Читать **float**. |
...
| virtual void [set_Height](./set_height/)(**float**) | Указывает высоту элемента диаграммы как долю от высоты диаграммы. Записать **float**. |
| virtual void [set_Width](./set_width/)(**float**) | Указывает ширину элемента диаграммы как долю от ширины диаграммы. Записать **float**. |
| virtual void [set_X](./set_x/)(**float**) | Указывает положение по оси x (слева) элемента диаграммы как долю от ширины диаграммы. Записать **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Указывает верхнюю границу элемента диаграммы как долю от высоты диаграммы. Записать **float**. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Реализует конструкт typeof([System.Object](../../system/object/)) в C#. |
