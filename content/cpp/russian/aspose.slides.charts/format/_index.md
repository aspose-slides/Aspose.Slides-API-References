...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_Effect](./get_effect/)() override | Возвращает эффекты, используемые для диаграммы. Только для чтения [IEffectFormat](../../aspose.slides/ieffectformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../../aspose.slides/ithreedformat/)\> [get_Effect3D](./get_effect3d/)() override | Возвращает 3D-формат диаграммы. Только для чтения [IThreeDFormat](../../aspose.slides/ithreedformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_Fill](./get_fill/)() override | Возвращает свойства заливки диаграммы. Только для чтения [IFillFormat](../../aspose.slides/ifillformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_Line](./get_line/)() override | Возвращает свойства линии диаграммы. Только для чтения [ILineFormat](../../aspose.slides/ilineformat/). |
