...
description: Представляет коллекцию групп комбинируемых серий.
type: docs
weight: 859
url: /ru/aspose.slides.charts/ichartseriesgroupcollection/
---
## IChartSeriesGroupCollection класс

Представляет коллекцию групп комбинируемых серий.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeriesGroup](../ichartseriesgroup/)\> [idx_get](./idx_get/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Получает группу серий по серии. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeriesGroup](../ichartseriesgroup/)\> [idx_get](./idx_get/)(**int32_t**) | Получает группу серий по индексу. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Возвращает количество элементов в последовательности (вычисляется путем прямого подсчёта). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й параметр шаблона как слабый указатель (а не общий). Позволяет переключать указатели в контейнерах в режим слабого. |
