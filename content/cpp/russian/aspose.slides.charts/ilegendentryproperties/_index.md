...
| virtual **bool** [get_Hide](./get_hide/)() | Возвращает флаг скрытия элемента легенды. Читать **bool**. |
...
| virtual void [set_Hide](./set_hide/)(**bool**) | Устанавливает флаг скрытия элемента легенды. Записать **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n'th аргумент шаблона как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим слабых. |
