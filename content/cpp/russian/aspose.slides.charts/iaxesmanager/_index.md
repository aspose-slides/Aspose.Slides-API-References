...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_HorizontalAxis](./get_horizontalaxis/)() | Возвращает горизонтальную ось диаграммы. Только для чтения [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryHorizontalAxis](./get_secondaryhorizontalaxis/)() | Возвращает вторичную горизонтальную ось диаграммы. Только для чтения [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryVerticalAxis](./get_secondaryverticalaxis/)() | Возвращает вторичную вертикальную ось диаграммы. Только для чтения [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SeriesAxis](./get_seriesaxis/)() | Возвращает ось серии диаграммы. Только для чтения [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_VerticalAxis](./get_verticalaxis/)() | Возвращает вертикальную ось диаграммы. Только для чтения [IAxis](../iaxis/). |
