...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Возвращает стили линии, заливки и эффектов объекта. Только для чтения [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | Истина, если таблица данных диаграммы имеет горизонтальные границы ячеек. Читает **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | Истина, если таблица данных диаграммы имеет контурные границы. Читает **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | Истина, если таблица данных диаграммы имеет вертикальные границы ячеек. Читает **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | Истина, если ключ легенды подписи данных видим. Читает **bool**. |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | Истина, если таблица данных диаграммы имеет горизонтальные границы ячеек. Записывает **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | Истина, если таблица данных диаграммы имеет контурные границы. Записывает **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | Истина, если таблица данных диаграммы имеет вертикальные границы ячеек. Записывает **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | Истина, если ключ легенды подписи данных видим. Записывает **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-ый аргумент шаблона как слабый указатель (вместо общего). Позволяет переключать указатели в контейнерах в режим слабых. |
