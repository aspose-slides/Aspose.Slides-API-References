...
| virtual **int32_t** [get_Index](./get_index/)() | Возвращает индекс. Только для чтения **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Возвращает имя. Только для чтения [System::String](../../system/string/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n'tй параметр шаблона как слабый указатель (а не совместный). Позволяет переключать указатели в контейнерах в слабый режим. |
