...
| void [Dispose](../../system.componentmodel/component/dispose/)(**bool**) | Поддержка шаблона disposable; ничего не делает. |
| [ByteArrayPtr](../../system/bytearrayptr/) [DownloadData](./downloaddata/)(const [String](../../system/string/)\&) const | Скачивает указанный ресурс в виде массива байтов. |
| [ByteArrayPtr](../../system/bytearrayptr/) [DownloadData](./downloaddata/)(const [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>\&) const | Скачивает указанный ресурс в виде массива байтов. |
| [String](../../system/string/) [DownloadString](./downloadstring/)(const [String](../../system/string/)\&) const | Скачивает указанный ресурс в виде строки. |
| [String](../../system/string/) [DownloadString](./downloadstring/)(const [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>\&) const | Скачивает указанный ресурс в виде строки. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Сравнивает объекты, используя семантику C# [Object.Equals](../../system/object/equals/). |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Сравнивает объекты ссылочного типа в стиле C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Сравнивает объекты типового (value) типа в стиле C#. |
...
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | Проверяет, находится ли компонент в режиме проектирования. |
| [SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\> [get_Encoding](./get_encoding/)() const | Получает кодировку, используемую для загрузки или выгрузки строк. |
...
| void [set_Encoding](./set_encoding/)(const [SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>\&) | Устанавливает кодировку, используемую для загрузки или выгрузки строк. |
| void [set_UseDefaultCredentials](./set_usedefaultcredentials/)(**bool**) | НЕ реализовано. |
...
|  [WebClient](./webclient/)() | Создаёт новый экземпляр. |
