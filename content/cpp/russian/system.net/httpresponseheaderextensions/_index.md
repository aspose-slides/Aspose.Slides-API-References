...
description: Содержит вспомогательные методы для работы со значениями перечисления HttpResponseHeader.
type: docs
weight: 235
url: /ru/system.net/httpresponseheaderextensions/
---
## HttpResponseHeaderExtensions класс

Содержит вспомогательные методы для работы со значениями перечисления HttpResponseHeader.
...
| static [String](../../system/string/) [GetName](./getname/)([HttpResponseHeader](../httpresponseheader/)) | Возвращает имя указанного заголовка. |
...
|  [HttpResponseHeaderExtensions](./httpresponseheaderextensions/)() | Удалённый конструктор по умолчанию. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Получает текущё значение счётчика общих ссылок. |
