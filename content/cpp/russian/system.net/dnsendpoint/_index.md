...
description: "Содержит информацию, используемую приложением для подключения к сервису. Объекты этого класса должны выделяться только с помощью функции System::MakeObject(). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или сбоям assert. Всегда оборачивайте этот класс в указатель System::SmartPtr и используйте этот указатель для передачи его в функции в качестве аргумента."
type: docs
weight: 118
url: /ru/system.net/dnsendpoint/
---
## DnsEndPoint класс

Содержит информацию, используемую приложением для подключения к сервису. Объекты этого класса должны выделяться только с помощью функции [System::MakeObject()](../../system/makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или сбоям assert. Всегда оборачивайте этот класс в указатель [System::SmartPtr](../../system/smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента.
...
| Метод | Описание |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[EndPoint](../endpoint/)\> [Create](../endpoint/create/)([System::SharedPtr](../../system/sharedptr/)\<[SocketAddress](../socketaddress/)\>) | Создаёт новый экземпляр [EndPoint](../endpoint/) класса, используя указанный адрес сокета. |
|  [DnsEndPoint](./dnsendpoint/)([String](../../system/string/), **int32_t**) | Создаёт новый экземпляр. |
|  [DnsEndPoint](./dnsendpoint/)([String](../../system/string/), **int32_t**, [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/)) | Создаёт новый экземпляр. |
...
| [String](../../system/string/) [get_Host](./get_host/)() | Возвращает имя хоста. |
| **int32_t** [get_Port](./get_port/)() | Возвращает номер порта. |
...
| virtual [ImplPtr](../endpoint/implptr/) [GetImpl](../endpoint/getimpl/)() const | Возвращает указатель на реализацию. |
