...
description: Обеспечивает ожидаемый результат асинхронной операции.
type: docs
weight: 92
url: /ru/system.threading.tasks/valuetask/
---
## ValueTask класс
...
| Метод | Описание |
| --- | --- |
| [TaskPtr](../../system/taskptr/) [AsTask](./astask/)() const | Преобразует этот [ValueTask](./) в разделяемый указатель на [Task](../task/). |
| [Runtime::CompilerServices::ConfiguredValueTaskAwaitable](../../system.runtime.compilerservices/configuredvaluetaskawaitable/) [ConfigureAwait](./configureawait/)(**bool**) const | Настраивает awaiter для этой задачи. |
| **bool** [Equals](./equals/)([ValueTask](./)) override | Определяет, равен ли этот экземпляр другому экземпляру [ValueTask](./). |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равен ли этот экземпляр другому объекту. |
...
| **bool** [get_IsCanceled](./get_iscanceled/)() const | Возвращает значение, указывающее, завершилась ли задача из-за отмены. |
| **bool** [get_IsCompleted](./get_iscompleted/)() const | Возвращает значение, указывающее, завершилась ли задача. |
| **bool** [get_IsCompletedSuccessfully](./get_iscompletedsuccessfully/)() const | Возвращает значение, указывающее, успешно ли завершилась задача. |
| **bool** [get_IsFaulted](./get_isfaulted/)() const | Возвращает значение, указывающее, завершилась ли задача из-за необработанного исключения. |
| [Runtime::CompilerServices::ValueTaskAwaiter](../../system.runtime.compilerservices/valuetaskawaiter/) [GetAwaiter](./getawaiter/)() const | Получает awaiter для этой задачи, поддерживая выражения await. |
...
| **bool** [operator!=](./operator_not_equal/)(const [ValueTask](./)\&) const | Оператор неравенства для [ValueTask](./). |
...
| **bool** [operator==](./operator_equal_equal/)(const [ValueTask](./)\&) const | Оператор равенства для [ValueTask](./). |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Сравнивает объекты по ссылке. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Сравнивает объекты по ссылке. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Сравнивает объект-значимый тип со nullptr по ссылке. |
...
|  [ValueTask](./valuetask/)(const [TaskPtr](../../system/taskptr/)\&) | Создаёт [ValueTask](./) из разделяемого указателя на [Task](../task/). |
