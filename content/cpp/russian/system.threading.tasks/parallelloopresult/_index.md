...
description: Предоставляет статус завершения параллельного цикла.
type: docs
weight: 14
url: /ru/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult класс

Предоставляет статус завершения [Parallel](../parallel/) цикла.
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Возвращает, завершился ли цикл. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Возвращает наименьший индекс итерации, на котором произошло прерывание. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Конструирует [ParallelLoopResult](./). |
...
Представляет результат операции параллельного цикла, включая информацию о том, завершилась ли она, и данные о прерываниях. 
