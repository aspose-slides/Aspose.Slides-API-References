...
description: "CultureNotFoundException выбрасывается, когда пытаются создать культуру, которой нет в наличии. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс CultureNotFoundException. Никогда не оборачивайте экземпляры класса CultureNotFoundException в System::SmartPtr."
type: docs
weight: 92
url: /ru/system.globalization/details_culturenotfoundexception/
---
## Details_CultureNotFoundException класс
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку оператора C# lock(). Вызывайте напрямую или используйте объект-защиту [LockContext](../../system/lockcontext/). |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Устанавливает HRESULT, закодированное числовое значение, назначаемое определенному исключению. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывайте напрямую или используйте объект-защиту [LockContext](../../system/lockcontext/). |
