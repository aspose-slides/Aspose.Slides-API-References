...
description: Создаёт объект DateTime из компонентов.
type: docs
weight: 235
url: /ru/system.globalization/koreancalendar/todatetime/
---
## KoreanCalendar::ToDateTime(int, int, int, int, int, int, int, int) const метод
...
| minute | int | Минута. |
| second | int | Секунда. |
| millisecond | int | Миллисекунда. |
| era | int | Эра. |

### Возвращаемое значение

[DateTime](../../../system/datetime/) объект, содержащий указанные компоненты.

## KoreanCalendar::ToDateTime(int, int, int, int, int, int, int) const метод
