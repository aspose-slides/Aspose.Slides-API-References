...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Сравнивает два объекта [IdnMapping](./). |
...
| **bool** [get_AllowUnassigned](./get_allowunassigned/)() const | Получает флаг, указывающий, использованы ли в операциях неприсвоенные кодовые точки. |
| **bool** [get_UseStd3AsciiRules](./get_usestd3asciirules/)() const | Получает флаг, указывающий, использованы ли в операциях стандартные правила именования. |
| [String](../../system/string/) [GetAscii](./getascii/)(const [String](../../system/string/)\&) const | [Convert](../../system/convert/) доменное имя Unicode в эквивалент ASCII. |
| [String](../../system/string/) [GetAscii](./getascii/)(const [String](../../system/string/)\&, int) const | [Convert](../../system/convert/) доменное имя Unicode в эквивалент ASCII. |
| [String](../../system/string/) [GetAscii](./getascii/)(const [String](../../system/string/)\&, int, int) const | [Convert](../../system/convert/) доменное имя Unicode в эквивалент ASCII. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру данных счётчика ссылок, связанную с объектом. |
| int [GetHashCode](./gethashcode/)() const override | Получает хэш-код текущего объекта [IdnMapping](./). |
...
| [String](../../system/string/) [GetUnicode](./getunicode/)(const [String](../../system/string/)\&) const | [Convert](../../system/convert/) доменное имя ASCII в эквивалент Unicode. |
| [String](../../system/string/) [GetUnicode](./getunicode/)(const [String](../../system/string/)\&, int) const | [Convert](../../system/convert/) доменное имя ASCII в эквивалент Unicode. |
| [String](../../system/string/) [GetUnicode](./getunicode/)(const [String](../../system/string/)\&, int, int) const | [Convert](../../system/convert/) доменное имя ASCII в эквивалент Unicode. |
...
| void [set_AllowUnassigned](./set_allowunassigned/)(**bool**) | Устанавливает флаг, указывающий, использованы ли в операциях неприсвоенные кодовые точки. |
| void [set_UseStd3AsciiRules](./set_usestd3asciirules/)(**bool**) | Устанавливает флаг, указывающий, использованы ли в операциях стандартные правила именования. |
