...
description: Проверяет, является ли день високосным.
type: docs
weight: 118
url: /ru/system.globalization/taiwanlunisolarcalendar/isleapday/
---
## TaiwanLunisolarCalendar::IsLeapDay(int, int, int, int) const метод
...
True, если указанная дата является високосной, иначе false.

## TaiwanLunisolarCalendar::IsLeapDay(int, int, int) const метод
