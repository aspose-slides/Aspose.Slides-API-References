...
| int [get_HijriAdjustment](./get_hijriadjustment/)() const | Получает корректировку хиджры. |
...
| static [CalendarPtr](../calendarptr/) [ReadOnly](../calendar/readonly/)(const [CalendarPtr](../calendarptr/)\&) | Получает версию календаря только для чтения. |
...
| void [set_HijriAdjustment](./set_hijriadjustment/)(int) | Устанавливает корректировку хиджры. |
...
| Поле | Описание |
| --- | --- |
| static constexpr [HijriEra](./hijriera/) | Текущая эра хиджры. |
