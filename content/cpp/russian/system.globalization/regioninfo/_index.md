...
description: "Предоставляет информацию о регионе. Объекты этого класса должны создаваться только с помощью функции System::MakeObject() . Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель System::SmartPtr и используйте этот указатель для передачи его в функции в качестве аргумента."
type: docs
weight: 274
url: /ru/system.globalization/regioninfo/
---
## RegionInfo класс
...
| virtual [String](../../system/string/) [get_CurrencyEnglishName](./get_currencyenglishname/)() const | Возвращает английское название валюты. |
| virtual [String](../../system/string/) [get_CurrencyNativeName](./get_currencynativename/)() const | Возвращает нативное название валюты. |
| virtual [String](../../system/string/) [get_CurrencySymbol](./get_currencysymbol/)() const | Возвращает символ валюты. |
| static [RegionInfoPtr](../regioninfoptr/) [get_CurrentRegion](./get_currentregion/)() | Возвращает регион, установленный в системе. |
| virtual [String](../../system/string/) [get_DisplayName](./get_displayname/)() const | Возвращает полное название региона. |
| virtual [String](../../system/string/) [get_EnglishName](./get_englishname/)() const | Возвращает английское название региона. |
| virtual int [get_GeoId](./get_geoid/)() const | Возвращает уникальный идентификатор региона. |
| virtual **bool** [get_IsMetric](./get_ismetric/)() const | Проверяет, использует ли регион метрическую систему. |
| virtual [String](../../system/string/) [get_ISOCurrencySymbol](./get_isocurrencysymbol/)() const | Возвращает ISO-символ валюты. |
| virtual [String](../../system/string/) [get_Name](./get_name/)() const | Возвращает название региона. |
| virtual [String](../../system/string/) [get_NativeName](./get_nativename/)() const | Возвращает нативное название региона. |
| virtual [String](../../system/string/) [get_ThreeLetterISORegionName](./get_threeletterisoregionname/)() const | Возвращает 3-буквенный ISO-код региона. |
| virtual [String](../../system/string/) [get_ThreeLetterWindowsRegionName](./get_threeletterwindowsregionname/)() const | Возвращает 3-буквенный [Windows](../../system.windows/) код региона. |
| virtual [String](../../system/string/) [get_TwoLetterISORegionName](./get_twoletterisoregionname/)() const | Возвращает 2-буквенный ISO-код региона. |
...
|  [RegionInfo](./regioninfo/)(const [String](../../system/string/)\&) | Информация RTTI. |
