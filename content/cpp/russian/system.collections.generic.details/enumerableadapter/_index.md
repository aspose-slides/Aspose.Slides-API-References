...
description: Enumerable, используемый методами-расширениями IEnumerable.Cast() и IEnumerable.OfType().
type: docs
weight: 1
url: /ru/system.collections.generic.details/enumerableadapter/
---
## EnumerableAdapter класс

Enumerable, используемый методами-расширениями IEnumerable.Cast() и IEnumerable.OfType().
...
| Параметр | Описание |
| --- | --- |
| Source | Тип исходных элементов коллекции. |
| Result | Тип результирующих элементов коллекции. |
| EnumeratorAdapter | Тип адаптера перечислителя. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../../system.collections.generic/ienumerator/)\<Result\>\> [GetEnumerator](./getenumerator/)() override | Получает перечислитель. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Reverse](../../system.collections.generic/ienumerable/linq_reverse/)() | Обращает порядок элементов в последовательности. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Уменьшает счётчик слабых ссылок. Не следует вызывать напрямую; вместо этого используете умные указатели или ThisProtector. |
