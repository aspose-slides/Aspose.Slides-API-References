...
type: docs
weight: 105
url: /ru/system.collections.generic.details/enumeratorselectmanyadapter/
---
## EnumeratorSelectManyAdapter класс
...
| **bool** [MoveNext](./movenext/)() override | Перемещает перечислитель к следующему элементу. Если ранее не был выбран элемент, устанавливает ссылку на первый доступный элемент. Если достигнут конец контейнера, ничего не делает. |
