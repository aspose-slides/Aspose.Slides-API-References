...
description: Enumerable, используемый методом расширения IEnumerable.Select().
type: docs
weight: 14
url: /ru/system.collections.generic.details/enumerableselectadapter/
---
## EnumerableSelectAdapter класс
