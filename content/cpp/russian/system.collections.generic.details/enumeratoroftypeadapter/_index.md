...
description: Перечислитель, используемый методом расширения IEnumerable.OfType().
type: docs
weight: 66
url: /ru/system.collections.generic.details/enumeratoroftypeadapter/
---
## EnumeratorOfTypeAdapter класс
...
| Method | Description |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Подготавливает итератор к использованию классом VirtualizedIterator класс. |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Сдвигает итератор на один шаг вперёд. |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Выполняет первый [MoveNext()](../../system.collections.generic/ienumerator/movenext/) вызов и подготавливает объект перечислителя к использованию VirtualizedIterator. |
...
| **bool** [MoveNext](./movenext/)() override | Перемещает перечислитель к следующему элементу. Если ранее ни один элемент не был выбран, устанавливает ссылку на первый доступный элемент. Если достигнут конец контейнера, не делает ничего. |
