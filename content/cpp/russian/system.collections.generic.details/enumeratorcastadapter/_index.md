...
description: Перечислитель, используемый методом расширения IEnumerable.Cast().
type: docs
weight: 53
url: /ru/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter класс

Перечислитель, используемый методом расширения IEnumerable.Cast().
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](../../system.collections.generic/ienumerator/current/)() const | Возвращает текущий элемент. |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | Возвращает текущий элемент. |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Перемещает итератор на один шаг вперёд. |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | Отмечает перечислитель, принадлежащий виртуальному итератору. |
...
| void [Reset](./reset/)() override | Сбрасывает перечислитель в положение до первого элемента. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный параметр в слабый указатель (вместо общего). Позволяет переключать указатели в контейнерах в режим слабого указателя. |
