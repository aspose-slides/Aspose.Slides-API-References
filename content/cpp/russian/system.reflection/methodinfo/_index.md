...
description: Представляет информацию о методе класса.
type: docs
weight: 131
url: /ru/system.reflection/methodinfo/
---
## MethodInfo класс

Представляет информацию о методе класса.
...
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Возвращает значение MemberTypes, указывающее, что этот член является методом. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | Возвращает массив, содержащий объекты, представляющие все пользовательские атрибуты, применённые к типу, представленному текущим объектом. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(**bool**) const | Возвращает массив, содержащий объекты, представляющие все пользовательские атрибуты, применённые к типу, представленному текущим объектом. |
...
| [MethodInfo](./methodinfo/)(const [String](../../system/string/)\&) | Инициализирует новый экземпляр класса [MethodInfo](./). |
