...
| Метод | Описание |
| --- | --- |
| void [AddAttribute](./addattribute/)(const [ObjectPtr](./objectptr/)\&) | Добавляет атрибут в коллекцию. |
...
| [TypeInfo](../../system/typeinfo/) [get_DeclaringType](./get_declaringtype/)() const | Возвращает объявляющий тип. |
| const [String](../../system/string/)\& [get_FullName](./get_fullname/)() const | Возвращает полное имя члена. Может отличаться в вручную реализованных частях. |
| virtual [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const | Возвращает значение [System::Reflection::MemberTypes](../membertypes/), указывающее тип члена — метод, конструктор, событие и т.д. |
| const [String](../../system/string/)\& [get_Name](./get_name/)() const | Возвращает имя члена. |
| [TypeInfo](../../system/typeinfo/) [get_ReflectedType](./get_reflectedtype/)() const | Возвращает отражённый тип. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | Возвращает массив, содержащий объекты, представляющие все пользовательские атрибуты, применённые к типу, представляемому текущим объектом. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(**bool**) const | Возвращает массив, содержащий объекты, представляющие все пользовательские атрибуты, применённые к типу, представляемому текущим объектом. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона слабым указателем (вместо shared). Позволяет переключать указатели в контейнерах в слабый режим. |
...
| Тип | Описание |
| --- | --- |
| [ObjectPtr](./objectptr/) | Псевдоним для shared pointer к [Object](../../system/object/). |
