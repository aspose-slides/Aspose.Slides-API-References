...
description: "TargetInvocationException выбрасывается методами, вызываемыми через рефлексию. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс TargetInvocationException. Никогда не оборачивайте экземпляры класса TargetInvocationException в System::SmartPtr."
type: docs
weight: 79
url: /ru/system.reflection/details_targetinvocationexception/
---
## Details_TargetInvocationException класс

TargetInvocationException бросается методами, вызываемыми через рефлексию. Никогда не создавайте экземпляры этого класса вручную. Используйте вместо этого класс TargetInvocationException. Никогда не оборачивайте экземпляры класса TargetInvocationException в [System::SmartPtr](../../system/smartptr/).
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Сравнивает объекты типовых (значимых) в стиле C#. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_applicationexception/gettype/)() const override | Получает реальный тип объекта. Аналог вызова C# [System.Object.GetType()](../../system/object/gettype/). |
...
* Класс [Details_ApplicationException](../../system/details_applicationexception/)
