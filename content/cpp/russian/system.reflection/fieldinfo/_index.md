...
description: Обнаруживает атрибуты поля и предоставляет доступ к метаданным поля.
type: docs
weight: 92
url: /ru/system.reflection/fieldinfo/
---
## FieldInfo класс
...
| [TypeInfo](../../system/typeinfo/) [get_FieldType](./get_fieldtype/)() | Получает тип свойства. |
...
| **bool** [get_IsStatic](./get_isstatic/)() | Получает значение, указывающее, является ли поле статическим. |
| virtual [MemberTypes](../membertypes/) [get_MemberType](../memberinfo/get_membertype/)() const | Получает значение [System::Reflection::MemberTypes](../membertypes/), указывающее тип члена — метод, конструктор, событие и т.д. |
| const [String](../../system/string/)\& [get_Name](../memberinfo/get_name/)() const | Получает имя члена. |
| [TypeInfo](../../system/typeinfo/) [get_ReflectedType](../memberinfo/get_reflectedtype/)() const | Получает тип отражённого типа. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [GetValue](./getvalue/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Получает значение свойства из конкретного объекта. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный аргумент в виде слабого указателя (а не совместного). Позволяет переключать указатели в контейнерах в режим слабых. |
| void [SetValue](./setvalue/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Устанавливает значение свойства для конкретного объекта. |
