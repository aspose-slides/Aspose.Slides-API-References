...
type: docs
weight: 209
url: /ru/system.io/details_ioexception/
---
## Details_IOException класс
...
| void [Unlock](../../system/object/unlock/)() | Реализует блокировку оператора C# lock() снятие блокировки. Вызывайте напрямую или используйте охранный объект [LockContext](../../system/lockcontext/). |
