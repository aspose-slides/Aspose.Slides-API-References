...
type: docs
weight: 144
url: /ru/system.io/details_drivenotfoundexception/
---
## Details_DriveNotFoundException класс
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й параметр шаблона в виде слабой ссылки (вместо совместной). Позволяет переключать указатели в контейнерах в слабый режим. |
...
* Класс [Details_IOException](../details_ioexception/)
