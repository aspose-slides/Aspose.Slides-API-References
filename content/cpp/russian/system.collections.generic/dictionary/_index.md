...
description: Объявление класса Dictionary без полного определения.
type: docs
weight: 144
url: /ru/system.collections.generic/dictionary/
---
## Класс Dictionary
...
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Получает итератор, указывающий на первый элемент, объявленный как const (если есть) в коллекции. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Получает итератор, указывающий сразу за последним элементом, объявленным как const (если есть) в коллекции. |
...
| [Dictionary](./dictionary/)(const [map_t](./map_t/)\&) | Копирует данные из map. |
| [Dictionary](./dictionary/)(int) | Перегрузка, соответствующая созданию предварительно выделенного словаря; фактически не выполняет выделение. |
| [Dictionary](./dictionary/)(const [SharedPtr](../../system/sharedptr/)\<[IDictionary](../idictionary/)\<TKey, TValue\>\>\&) | Конструктор копирования. |
| [Dictionary](./dictionary/)(const [SharedPtr](../../system/sharedptr/)\<[IDictionary](../idictionary/)\<TKey, TValue\>\>\&, const [SharedPtr](../../system/sharedptr/)\<[IEqualityComparer](../iequalitycomparer/)\<TKey\>\>\&) | Конструктор копирования. |
| [Dictionary](./dictionary/)(const [SharedPtr](../../system/sharedptr/)\<[IEqualityComparer](../iequalitycomparer/)\<TKey\>\>\&) | Создаёт пустой словарь. |
| [Dictionary](./dictionary/)(int, const [SharedPtr](../../system/sharedptr/)\<[IEqualityComparer](../iequalitycomparer/)\<TKey\>\>\&) | Создаёт пустой словарь. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Получает итератор, указывающий сразу за последним элементом (если есть) в коллекции. Этот итератор нельзя использовать для изменения ссылочного объекта, потому что [GetEnumerator()](../ienumerable/getenumerator/) возвращает копию объекта T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Получает итератор, указывающий сразу за последним элементом (если есть) константного экземпляра коллекции. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TKey\>\> [get_Keys](../idictionary/get_keys/)() const | Доступ к коллекции ключей. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TValue\>\> [get_Values](../idictionary/get_values/)() const | Доступ к коллекции значений. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру счётчика ссылок, связанную с объектом. |
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Создаёт объект перечислителя. |
...
| virtual TValue [idx_get](../idictionary/idx_get/)(const TKey\&) const | Функция получения. |
| virtual void [idx_set](../idictionary/idx_set/)(const TKey\&, TValue) | Функция установки. |
...
| [ICollection](../icollection/)\& [operator=](../icollection/operator_equal/)([ICollection](../icollection/)\&&) | Оператор присваивания перемещением. |
| [ICollection](../icollection/)\& [operator=](../icollection/operator_equal/)(const [ICollection](../icollection/)\&) | Оператор присваивания перемещением. |
...
| virtual **bool** [TryGetValue](../idictionary/trygetvalue/)(const TKey\&, TValue\&) const | Ищет значение и извлекает его, если найдено. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Реализует конструкцию C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывайте напрямую или используйте объект-сторож [LockContext](../../system/lockcontext/). |
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../ienumerable/virtualizebeginconstiterator/)() const | Получает реализацию begin-итератора const для текущего контейнера. |
...
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../ienumerable/virtualizeendconstiterator/)() const | Получает реализацию end-итератора const для текущего контейнера. |
...
| Тип | Описание |
| --- | --- |
| [KeyCollection](./keycollection/) | Коллекция ключей для извлечения. |
