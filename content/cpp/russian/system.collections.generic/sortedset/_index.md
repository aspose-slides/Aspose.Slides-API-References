...
description: Предварительное объявление класса SortedSet.
type: docs
weight: 573
url: /ru/system.collections.generic/sortedset/
---
## SortedSet класс
...
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Возвращает итератор, указывающий на первый элемент (если он есть) коллекции. Этот итератор нельзя использовать для изменения объекта, на который он ссылается, потому что [GetEnumerator()](../ienumerable/getenumerator/) возвращает копию-объекта типа T. |
...
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Возвращает итератор, указывающий на первый элемент, объявленный как const (если он есть) коллекции. |
...
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Возвращает итератор, указывающий сразу после последнего элемента (если он есть) коллекции. Этот итератор нельзя использовать для изменения объекта, на который он ссылается, потому что [GetEnumerator()](../ienumerable/getenumerator/) возвращает копию-объекта типа T. |
...
| T [get_Max](./get_max/)() const | Возвращает максимальное значение в [SortedSet](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](../ienumerable/getenumerator/)() | Возвращаетenumerator. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Сравнивает объект-значение со ссылкой на nullptr. |
...
|  [SortedSet](./sortedset/)() | Создаёт пустой набор. |
|  [SortedSet](./sortedset/)(int) | Создаёт пустой набор с указанной ёмкостью. |
|  [SortedSet](./sortedset/)(const [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\>\&) | Создаёт пустой набор, использующий указанный сравниватель равенства. |
|  [SortedSet](./sortedset/)(const [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\>\&) | Создаёт [SortedSet](./) на основе перечислимых значений. |
...
Реализует набор упорядоченных объектов. Объекты этого класса следует создавать только с помощью функции [System::MakeObject()](../../system/makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам времени выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](../../system/smartptr/) и используйте этот указатель для передачи его функциям в качестве аргумента.
