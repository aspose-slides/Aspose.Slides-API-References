...
description: Предоставляет базовый класс для реализаций обобщённого интерфейса System.Collections.Generic.IComparer.
type: docs
weight: 105
url: /ru/system.collections.generic/comparer/
---
## Comparer класс
...
| Метод | Описание |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) функция. |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | Возвращает компаратор порядка сортировки по умолчанию для типа, указанного в обобщённом параметре. |
