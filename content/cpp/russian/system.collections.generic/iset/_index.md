...
description: "Интерфейс коллекции, содержащей набор уникальных элементов. Объекты этого класса должны выделяться только с помощью функции System::MakeObject(). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам времени выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель System::SmartPtr и используйте этот указатель для передачи его в функции в качестве аргумента."
type: docs
weight: 352
url: /ru/system.collections.generic/iset/
---
## ISet класс

Интерфейс коллекции, содержащей набор уникальных элементов. Объекты этого класса должны быть выделены только с помощью функции [System::MakeObject()](../../system/makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам времени выполнения и/или сбоям ассерт. Всегда оборачивайте этот класс в указатель [System::SmartPtr](../../system/smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента.
...
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Получает итератор, указывающий на первый элемент (если существует) коллекции. Этот итератор нельзя использовать для изменения ссылочного объекта, потому что [GetEnumerator()](../ienumerable/getenumerator/) возвращает копию объекта T. |
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Получает итератор, указывающий на первый элемент (если существует) константного экземпляра коллекции. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Получает итератор, указывающий на первый элемент, объявленный как const (если существует), коллекции. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Получает итератор, указывающий сразу после последнего элемента, объявленного как const (если существует), коллекции. |
...
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Получает итератор, указывающий сразу после последнего элемента (если существует) коллекции. Этот итератор нельзя использовать для изменения ссылочного объекта, потому что [GetEnumerator()](../ienumerable/getenumerator/) возвращает копию объекта T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Получает итератор, указывающий сразу после последнего элемента (если существует) константного экземпляра коллекции. |
...
| virtual void [ExceptWith](./exceptwith/)([IEnumerablePtr](./ienumerableptr/)) | Удаляет группу элементов. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](../ienumerable/getenumerator/)() | Получает энумератор. |
...
| virtual void [IntersectWith](./intersectwith/)([IEnumerablePtr](./ienumerableptr/)) | Удаляет элементы, не присутствующие в другом контейнере. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Проверяет, представляет ли объект экземпляр типа, описанного targetType. Аналог оператора C# 'is'. |
| virtual **bool** [IsProperSubsetOf](./ispropersubsetof/)([IEnumerablePtr](./ienumerableptr/)) | Проверяет, является ли текущий набор строгим подмножеством другого контейнера. |
| virtual **bool** [IsProperSupersetOf](./ispropersupersetof/)([IEnumerablePtr](./ienumerableptr/)) | Проверяет, является ли текущий набор строгим надмножеством другого контейнера. |
| virtual **bool** [IsSubsetOf](./issubsetof/)([IEnumerablePtr](./ienumerableptr/)) | Проверяет, является ли текущий набор подмножеством другого контейнера. |
| virtual **bool** [IsSupersetOf](./issupersetof/)([IEnumerablePtr](./ienumerableptr/)) | Проверяет, является ли текущий набор надмножеством другого контейнера. |
...
| virtual **bool** [Overlaps](./overlaps/)([IEnumerablePtr](./ienumerableptr/)) | Проверяет, пересекается ли набор с другим контейнером. |
...
| virtual **bool** [SetEquals](./setequals/)([IEnumerablePtr](./ienumerableptr/)) | Проверяет, содержат ли набор и контейнер одинаковые элементы. |
...
| virtual void [SymmetricExceptWith](./symmetricexceptwith/)([IEnumerablePtr](./ienumerableptr/)) | Вычисляет симметрическое исключение двух контейнеров. Удаляет все элементы, присутствующие в обоих контейнерах, одновременно добавляя все элементы, присутствующие в **other**, но не в текущем наборе. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Аналог метода C# [Object.ToString()](../../system/object/tostring/). Позволяет преобразовывать пользовательские объекты в строку. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Реализует конструкцию C# typeof([System.Object](../../system/object/)). |
| virtual void [UnionWith](./unionwith/)([IEnumerablePtr](./ienumerableptr/)) | Добавляет элементы из указанной коллекции, которые ещё не присутствуют в текущем наборе. |
...
| --- | --- |
| [IEnumerablePtr](./ienumerableptr/) | Тип-энумерация для сравнения содержимого текущего набора. |
