...
description: Простая реализация IComparable<>
type: docs
weight: 1
url: /ru/system.boxedvaluedetail/comparable/
---
## Comparable класс

Простая реализация IComparable<>
...
| Метод | Описание |
| --- | --- |
| int [CompareTo](./compareto/)(T) override | Сравнивает текущий объект с указанным объектом. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-ый аргумент шаблона как слабый указатель (а не общий). Позволяет переключать указатели в контейнерах в режим слабых. |
