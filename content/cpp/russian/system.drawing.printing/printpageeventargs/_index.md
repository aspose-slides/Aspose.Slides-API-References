...
description: "Предоставляет данные для события PrintPage. Объекты этого класса должны создаваться только с помощью функции System::MakeObject(). Никогда не создавайте экземпляр этого типа в стеке или с использованием оператора new, так как это приведёт к ошибкам выполнения и/или сбоям проверок. Всегда оборачивайте этот класс в указатель System::SmartPtr и используйте этот указатель в качестве аргумента функций."
type: docs
weight: 105
url: /ru/system.drawing.printing/printpageeventargs/
---
...
| [SharedPtr](../../system/sharedptr/)\<[Graphics](../../system.drawing/graphics/)\> [get_Graphics](./get_graphics/)() | НЕ РЕАЛИЗОВАНО. |
| **bool** [get_HasMorePages](./get_hasmorepages/)() | НЕ РЕАЛИЗОВАНО. |
| [SharedPtr](../../system/sharedptr/)\<[PageSettings](../pagesettings/)\> [get_PageSettings](./get_pagesettings/)() | НЕ РЕАЛИЗОВАНО. |
...
|  [PrintPageEventArgs](./printpageeventargs/)(const [SharedPtr](../../system/sharedptr/)\<[Graphics](../../system.drawing/graphics/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[Rectangle](../../system.drawing/rectangle/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[Rectangle](../../system.drawing/rectangle/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[PageSettings](../pagesettings/)\>\&) | Создаёт новый экземпляр класса [PrintPageEventArgs](./). |
...
| void [set_HasMorePages](./set_hasmorepages/)(**bool**) | НЕ РЕАЛИЗОВАНО. |
...
| Поле | Описание |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Статический член, представляющий \"empty\" [EventArgs](../../system/eventargs/) shared pointer (null-pointer). |
