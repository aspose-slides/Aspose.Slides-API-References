...
| [Rectangle](../../system.drawing/rectangle/) [get_Bounds](./get_bounds/)() | НЕ РЕАЛИЗОВАНО. |
| **float** [get_HardMarginX](./get_hardmarginx/)() | НЕ РЕАЛИЗОВАНО. |
| **float** [get_HardMarginY](./get_hardmarginy/)() | НЕ РЕАЛИЗОВАНО. |
| [SharedPtr](../../system/sharedptr/)\<[PrinterResolution](../printerresolution/)\> [get_PrinterResolution](./get_printerresolution/)() | НЕ РЕАЛИЗОВАНО. |
...
|  [PageSettings](./pagesettings/)() | Создаёт новый экземпляр класса [PageSettings](./). |
|  [PageSettings](./pagesettings/)(const [SharedPtr](../../system/sharedptr/)\<[PrinterSettings](../printersettings/)\>\&) | Создаёт новый экземпляр класса [PageSettings](./). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона слабым указателем (а не общим). Позволяет переключать указатели в контейнерах в слабый режим. |
