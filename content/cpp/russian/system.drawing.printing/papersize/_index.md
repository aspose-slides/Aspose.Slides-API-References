...
description: Указывает размер листа бумаги.
type: docs
weight: 27
url: /ru/system.drawing.printing/papersize/
---
## PaperSize класс
...
| **int32_t** [get_Height](./get_height/)() const | Возвращает высоту листа бумаги в сотых дюйма. |
| [PaperKind](../paperkind/) [get_Kind](./get_kind/)() const | Возвращает тип бумаги. |
| [System::String](../../system/string/) [get_PaperName](./get_papername/)() const | Возвращает название типа бумаги. |
| **int32_t** [get_RawKind](./get_rawkind/)() const | Возвращает целое, представляющее одно из значений [System::Drawing::Printing::PaperSize](./) или пользовательское значение. |
| **int32_t** [get_Width](./get_width/)() const | Возвращает ширину листа бумаги в сотых дюйма. |
...
|  [PaperSize](./papersize/)([PaperKind](../paperkind/), [System::String](../../system/string/), **int32_t**, **int32_t**) | Инициализирует новый экземпляр класса [System::Drawing::Printing::PaperSize](./). |
|  [PaperSize](./papersize/)([System::String](../../system/string/), **int32_t**, **int32_t**) | Инициализирует новый экземпляр класса [System::Drawing::Printing::PaperSize](./). |
...
| void [set_Height](./set_height/)(**int32_t**) | Устанавливает высоту листа бумаги в сотых дюйма. |
| void [set_PaperName](./set_papername/)([System::String](../../system/string/)) | Устанавливает название типа бумаги. |
| void [set_RawKind](./set_rawkind/)(**int32_t**) | Устанавливает целое, представляющее одно из значений [System::Drawing::Printing::PaperSize](./) или пользовательское значение. |
| void [set_Width](./set_width/)(**int32_t**) | Устанавливает ширину листа бумаги в сотых дюйма. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Предоставляет информацию о [System::Drawing::Printing::PaperSize](./) в виде строки. |
