...
description: Исключение, которое выбрасывается, когда в ячейке электронной таблицы обнаружены неподдерживаемые данные.
type: docs
weight: 40
url: /ru/aspose.slides.spreadsheet/details_cellunsupporteddataexception/
---
## Details_CellUnsupportedDataException класс

Исключение, которое выбрасывается, когда в ячейке электронной таблицы обнаружены неподдерживаемые данные.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный параметр как слабый указатель (а не общий). Позволяет переключать указатели в контейнерах в слабый режим. |
