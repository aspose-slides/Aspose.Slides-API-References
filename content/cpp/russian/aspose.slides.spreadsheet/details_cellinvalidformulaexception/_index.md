...
description: Исключение, которое выбрасывается, когда вычисленная формула неверна или не была разобрана.
type: docs
weight: 14
url: /ru/aspose.slides.spreadsheet/details_cellinvalidformulaexception/
---
## Класс Details_CellInvalidFormulaException

Исключение, которое выбрасывается, когда вычисленная формула неверна или не была разобрана.
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Получает ссылку на ячейку, содержащую неверную формулу. |
