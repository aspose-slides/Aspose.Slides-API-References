...
description: Исключение, которое генерируется, когда обнаружены одна или несколько циклических ссылок, при которых формула ссылается на собственную ячейку напрямую или косвенно.
type: docs
weight: 1
url: /ru/aspose.slides.spreadsheet/details_cellcircularreferenceexception/
---
## Details_CellCircularReferenceException класс

Исключение, которое генерируется, когда обнаружены одна или несколько циклических ссылок, при которых формула ссылается на собственную ячейку напрямую или косвенно.
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Эмулирует сравнение чисел с плавающей запятой в стиле C#, где два NaN считаются равными, несмотря на то, что согласно IEC 60559:1989 NaN не равен ни одному значению,包括 NaN. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Возвращает 32-битное целочисленное значение, которое является кодом HRESULT, связанным с исключением, представляемым текущим объектом. |
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Получает циклическую ссылку на ячейку. |
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку, как в операторе C# lock(). Вызывайте напрямую или используйте объект-охранник [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку, как в операторе C# lock(). Вызывайте напрямую или используйте объект-охранник [LockContext](../../system/lockcontext/). |
...
* Класс [Details_PptxEditException](../../aspose.slides/details_pptxeditexception/)
* Пространство имён [Aspose::Slides::Spreadsheet](../)
