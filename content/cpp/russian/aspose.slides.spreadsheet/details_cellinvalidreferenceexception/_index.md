...
description: Исключение, которое выбрасывается при обнаружении недопустимой ссылки на ячейку.
type: docs
weight: 27
url: /ru/aspose.slides.spreadsheet/details_cellinvalidreferenceexception/
---
## Details_CellInvalidReferenceException класс


Исключение, которое выбрасывается при обнаружении недопустимой ссылки на ячейку.
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Получает недопустимую ссылку на ячейку. |
