...
description: "Базовый класс исключения генерируется классами HttpClient и HttpMessageHandler. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс HttpRequestException. Никогда не оборачивайте экземпляры класса HttpRequestException в System::SmartPtr."
type: docs
weight: 14
url: /ru/system.net.http/details_httprequestexception/
---
## Details_HttpRequestException класс


Базовый класс исключения генерируется классами [HttpClient](../httpclient/) и [HttpMessageHandler](../httpmessagehandler/). Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс HttpRequestException. Никогда не оборачивайте экземпляры класса HttpRequestException в [System::SmartPtr](../../system/smartptr/).
...
| Метод | Описание |
| --- | --- |
|  [Details_HttpRequestException](./details_httprequestexception/)() | Создаёт новый экземпляр. |
|  [Details_HttpRequestException](./details_httprequestexception/)(std::nullptr_t) | Создаёт новый экземпляр. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/)) | Создаёт новый экземпляр. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Создаёт новый экземпляр. |
| virtual void [DoThrow](../../system/details_exception/dothrow/)(const [ExceptionPtr](../../system/exceptionptr/)\&) const | Выбрасывает экземпляр исключения, обёрнутый в обёртку исключения. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Возвращает 32-битное целое значение, которое является кодом HRESULT, связанным с исключением, представленным текущим объектом. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Конструктор копирования. На самом деле ничего не копирует, а просто инициализирует новый объект и позволяет копировать конструктором подклассы. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Оператор присваивания. На самом деле ничего не копирует, а просто инициализирует новый объект и позволяет копировать конструктором подклассы. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона слабым указателем (вместо shared). Позволяет переключать указатели в контейнерах в режим weak. |
...
* Класс [Details_Exception](../../system/details_exception/)
