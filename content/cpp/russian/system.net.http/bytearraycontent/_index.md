...
| Method | Description |
| --- | --- |
|  [ByteArrayContent](./bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Создаёт новый экземпляр. |
|  [ByteArrayContent](./bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | Создаёт новый экземпляр. |
| void [Dispose](../httpcontent/dispose/)() override | Уничтожает текущий экземпляр. Этот метод также уничтожает поток, возвращаемый 'ReadAsStream', и буфер памяти, если он был создан. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpContentHeaders](../../system.net.http.headers/httpcontentheaders/)\> [get_Headers](../httpcontent/get_headers/)() | Возвращает заголовки HTTP-контента. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Конструктор копирования. На самом деле ничего не копирует, просто инициализирует новый объект и позволяет копировать построенные подклассы. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Оператор присваивания. На самом деле ничего не копирует, просто инициализирует новый объект и позволяет копировать построенные подклассы. |
...
| **bool** [TryComputeLength](./trycomputelength/)(**int64_t**\&) override | Пытается вычислить длину массива байтов. |
