...
description: Содержит вспомогательные методы.
type: docs
weight: 131
url: /ru/system.net.http/httputilities/
---
## HttpUtilities класс
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Проверяет, является ли указанный URI HTTP URI. |
| void [Lock](../../system/object/lock/)() | Реализует блокировку оператора C# lock(). Вызывайте напрямую или используйте объект-страж [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Аналог метода C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Позволяет клонировать пользовательские типы. |
|  [Object](../../system/object/object/)() | Создаёт объект. Инициализирует все внутренние структуры данных. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Конструктор копии. На самом деле ничего не копирует, просто инициализирует новый объект и позволяет создавать копии подклассов. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона в слабый указатель (а не совместный). Позволяет переключать указатели в контейнерах в слабый режим. |
...
| Field | Description |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | Версия HTTP по умолчанию для отправки запросов. |
| static [DefaultResponseVersion](./defaultresponseversion/) | Версия HTTP по умолчанию для получения ответов. |
