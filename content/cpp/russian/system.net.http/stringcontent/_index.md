...
| Method | Описание |
| --- | --- |
|  [ByteArrayContent](../bytearraycontent/bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Создаёт новый экземпляр. |
|  [ByteArrayContent](../bytearraycontent/bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | Создаёт новый экземпляр. |
| void [Dispose](../httpcontent/dispose/)() override | Освобождает текущий экземпляр. Этот метод также освобождает поток, возвращаемый 'ReadAsStream', и буфер памяти, если он был создан. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpContentHeaders](../../system.net.http.headers/httpcontentheaders/)\> [get_Headers](../httpcontent/get_headers/)() | Возвращает заголовки HTTP-содержимого. |
...
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)() | Сериализует содержимое в буфер памяти. |
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)(**int64_t**) | Сериализует содержимое в буфер памяти. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ReadAsByteArray](../httpcontent/readasbytearray/)() | Сериализует содержимое и возвращает массив байтов. |
| [System::SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [ReadAsStream](../httpcontent/readasstream/)() | Сериализует содержимое и возвращает поток. |
| [String](../../system/string/) [ReadAsString](../httpcontent/readasstring/)() | Сериализует содержимое и возвращает строку. |
...
|  [StringContent](./stringcontent/)([String](../../system/string/)) | Создаёт новый экземпляр. |
|  [StringContent](./stringcontent/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>) | Создаёт новый экземпляр. |
|  [StringContent](./stringcontent/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>, [String](../../system/string/)) | Создаёт новый экземпляр. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Аналог метода C# [Object.ToString()](../../system/object/tostring/). Позволяет преобразовывать пользовательские объекты в строку. |
| **bool** [TryComputeLength](../bytearraycontent/trycomputelength/)(**int64_t**\&) override | Пытается вычислить длину массива байтов. |
...
| static [MaxBufferSize](../httpcontent/maxbuffersize/) | Максимальное количество байт. |
## См. также

* Класс [ByteArrayContent](../bytearraycontent/)
