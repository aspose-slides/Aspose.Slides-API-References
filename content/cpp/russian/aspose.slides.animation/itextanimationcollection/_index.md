...
description: Представляет коллекцию анимаций текста.
type: docs
weight: 430
url: /ru/aspose.slides.animation/itextanimationcollection/
---
## ITextAnimationCollection класс

Представляет коллекцию анимаций текста.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [idx_get](./idx_get/)(**int32_t**) | Возвращает элемент по индексу. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\>\> [idx_get](./idx_get/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Возвращает все элементы |
...
* Простейств имён [Aspose::Slides::Animation](../)
