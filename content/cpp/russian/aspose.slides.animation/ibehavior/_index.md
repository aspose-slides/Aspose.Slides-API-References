...
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](./get_accumulate/)() | Представляет, аккумулируются ли анимационные поведения. Читайте [NullableBool](../../aspose.slides/nullablebool/). |
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](./get_additive/)() | Представляет, комбинируется ли текущий анимационный поведение с другими запущенными анимациями. Читайте [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](./get_properties/)() | Представляет свойства поведения. Только для чтения [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](./get_timing/)() | Представляет свойства синхронизации для поведения эффекта. Читайте [ITiming](../itiming/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Сравнивает объект типозначения с nullptr по ссылке. |
...
| virtual void [set_Accumulate](./set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | Представляет, аккумулируются ли анимационные поведения. Запись [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [set_Additive](./set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | Представляет, комбинируется ли текущий анимационный поведение с другими запущенными анимациями. Запись [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual void [set_Timing](./set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | Представляет свойства синхронизации для поведения эффекта. Запись [ITiming](../itiming/). |
