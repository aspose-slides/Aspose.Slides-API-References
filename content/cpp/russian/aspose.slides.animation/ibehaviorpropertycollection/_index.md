...
---
## IBehaviorPropertyCollection класс
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | Добавляет новое свойство в коллекцию. |
...
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Определяет, содержит ли [ICollection](../../system.collections.generic/icollection/) конкретное значение. |
...
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Возвращает элемент по указанному индексу. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Устанавливает элемент по указанному индексу. |
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Определяет индекс конкретного элемента по значению свойства в [IList](../../system.collections.generic/ilist/). |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | Возвращает индекс первого появления элемента в контейнере. |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | Вставляет новое свойство (со указанным значением свойства) в коллекцию по заданному индексу. |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | Удаляет указанное свойство из коллекции. |
