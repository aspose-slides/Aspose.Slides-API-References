...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Добавляет новую интерактивную последовательность. |
...
| virtual void [Clear](./clear/)() | Удаляет все последовательности из коллекции. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Возвращает количество элементов в коллекции. Только для чтения **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [idx_get](./idx_get/)(**int32_t**) | Возвращает последовательность по указанному индексу. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Возвращает количество элементов в последовательности (вычислено подсчётом). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>) | Удаляет указанную последовательность из коллекции. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Удаляет последовательность по указанному индексу. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует оператор разблокировки C# lock(). Вызывайте напрямую или используйте объект-охранитель [LockContext](../../system/lockcontext/). |
