...
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../behavior/get_accumulate/)() override | Отражает, собираются ли поведения анимации. Чтение [NullableBool](../../aspose.slides/nullablebool/). |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | Отражает, комбинируется ли текущее поведение анимации с другими запущенными анимациями. Чтение [BehaviorAdditiveType](../behavioradditivetype/). |
| [System::String](../../system/string/) [get_CommandString](./get_commandstring/)() override | Определяет строку команды. Чтение [System::String](../../system/string/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](../behavior/get_properties/)() override | Отображает свойства поведения. Только для чтения [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_ShapeTarget](./get_shapetarget/)() override | Определяет целевую форму эффекта команды. Чтение [IShape](../../aspose.slides/ishape/). |
...
| [CommandEffectType](../commandeffecttype/) [get_Type](./get_type/)() override | Определяет тип эффекта команды поведения. Чтение [CommandEffectType](../commandeffecttype/). |
...
| void [set_Accumulate](../behavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | Отражает, собираются ли поведения анимации. Запись [NullableBool](../../aspose.slides/nullablebool/). |
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Отображает, комбинируется ли текущее поведение анимации с другими запущенными анимациями. Запись [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_CommandString](./set_commandstring/)([System::String](../../system/string/)) override | Определяет строку команды. Запись [System::String](../../system/string/). |
| void [set_ShapeTarget](./set_shapetarget/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | Определяет целевую форму эффекта команды. Запись [IShape](../../aspose.slides/ishape/). |
...
| void [set_Type](./set_type/)([CommandEffectType](../commandeffecttype/)) override | Определяет тип эффекта команды поведения. Запись [CommandEffectType](../commandeffecttype/). |
...
* Класс [ICommandEffect](../icommandeffect/)
