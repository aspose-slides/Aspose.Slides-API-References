...
| **float** [get_Value0](./get_value0/)() override | Определяет первое значение смещения. Чтение **float**. |
| **float** [get_Value1](./get_value1/)() override | Определяет второе значение смещения. Чтение **float**. |
| **float** [get_Value2](./get_value2/)() override | Определяет третье значение смещения. Чтение **float**. |
...
| void [set_Value0](./set_value0/)(**float**) override | Определяет первое значение смещения. Запись **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Определяет второе значение смещения. Запись **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Определяет третье значение смещения. Запись **float**. |
...
* Класс [IColorOffset](../icoloroffset/)
