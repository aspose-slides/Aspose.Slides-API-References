...
description: Представляет типы свойств для поведения анимации. Содержит список свойств из  и
type: docs
weight: 183
url: /ru/aspose.slides.animation/ibehaviorproperty/
---
## IBehaviorProperty класс

Представляет типы свойств для поведения анимации. Содержит список свойств из [https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx) и [https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx)
...
| virtual **bool** [get_IsCustom](./get_iscustom/)() | Показывает, не принадлежит ли это свойство заранее определенному списку свойств в спецификации: [https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx) |
| virtual [System::String](../../system/string/) [get_Value](./get_value/)() | Значение свойства |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n'tй аргумент шаблона как слабый указатель (в отличие от общего). Позволяет переключать указатели в контейнерах в слабый режим. |
