...
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../ibehavior/get_accumulate/)() | Предоставляет, собираются ли анимационные поведения. Чтение [NullableBool](../../aspose.slides/nullablebool/). |
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../ibehavior/get_additive/)() | Предоставляет, комбинируется ли текущее анимационное поведение с другими запущенными анимациями. Чтение [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual **float** [get_By](./get_by/)() | Определяет относительное значение смещения для анимации. Чтение **float**. |
| virtual **float** [get_From](./get_from/)() | Определяет начальное значение для анимации. Чтение **float**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../ibehavior/get_timing/)() | Представляет свойства тайминга для поведения эффекта. Чтение [ITiming](../itiming/). |
| virtual **float** [get_To](./get_to/)() | Определяет конечное значение для анимации. Чтение **float**. |
...
| virtual void [set_Accumulate](../ibehavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | Представляет, собираются ли анимационные поведения. Запись [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [set_Additive](../ibehavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | Представляет, комбинируется ли текущее анимационное поведение с другими запущенными анимациями. Запись [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual void [set_By](./set_by/)(**float**) | Определяет относительное значение смещения для анимации. Запись **float**. |
| virtual void [set_From](./set_from/)(**float**) | Определяет начальное значение для анимации. Запись **float**. |
...
| virtual void [set_To](./set_to/)(**float**) | Определяет конечное значение для анимации. Запись **float**. |
