...
---
## BehaviorPropertyCollection класс
...
| Метод | Описание |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Добавляет новое свойство в коллекцию. |
| void [Add](./add/)(const [System::String](../../system/string/)\&) override | Добавляет новое свойство в коллекцию. |
...
| void [Clear](./clear/)() override | Удаляет все свойства из коллекции. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | Определяет, содержит ли [ICollection](../../system.collections.generic/icollection/) конкретное значение. |
| **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const override | Определяет, содержит ли [ICollection](../../system.collections.generic/icollection/) конкретное значение. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>, **int32_t**) override | Копирует элементы из [ICollection](../../system.collections.generic/icollection/) в [System::Array](../../system/array/), начиная с указанного индекса [System::Array](../../system/array/). |
...
| **int32_t** [get_Count](./get_count/)() const override | Возвращает количество свойств, хранящихся в коллекции. Только для чтения **int32_t**. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Проверяет, имеет ли коллекция фиксированный размер. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Возвращает значение, указывающее, является ли [ICollection](../../system.collections.generic/icollection/) только для чтения. Только для чтения **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>\> [GetEnumerator](./getenumerator/)() override | Возвращает перечислитель, который перебирает элементы коллекции. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\> [idx_get](./idx_get/)(**int32_t**) const override | Возвращает свойство по указанному индексу. |
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Получает элемент по указанному индексу. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>) override | Возвращает свойство по указанному индексу. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Устанавливает элемент по указанному индексу. |
| **int32_t** [IndexOf](./indexof/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | Определяет индекс конкретного элемента в [IList](../../system.collections.generic/ilist/). |
| **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const override | Определяет индекс конкретного элемента по значению свойства в [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Вставляет новое свойство в коллекцию по указанному индексу. |
| void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) override | Вставляет новое свойство (с указанным значением свойства) в коллекцию по указанному индексу. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | Вставляет элемент в указанную позицию, сдвигая остальные элементы. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Удаляет указанное свойство из коллекции. |
| **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) override | Удаляет указанное свойство из коллекции. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Удаляет свойство по указанному индексу. |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | Удаляет элемент по указанному индексу. |
...
* Класс [IBehaviorPropertyCollection](../ibehaviorpropertycollection/)
