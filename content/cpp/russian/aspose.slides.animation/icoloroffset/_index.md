...
| virtual **float** [get_Value0](./get_value0/)() | Определяет первое значение смещения. Читает **float**. |
| virtual **float** [get_Value1](./get_value1/)() | Определяет второе значение смещения. Читает **float**. |
| virtual **float** [get_Value2](./get_value2/)() | Определяет третье значение смещения. Читает **float**. |
...
| virtual void [set_Value0](./set_value0/)(**float**) | Определяет первое значение смещения. Записывает **float**. |
| virtual void [set_Value1](./set_value1/)(**float**) | Определяет второе значение смещения. Записывает **float**. |
| virtual void [set_Value2](./set_value2/)(**float**) | Определяет третье значение смещения. Записывает **float**. |
