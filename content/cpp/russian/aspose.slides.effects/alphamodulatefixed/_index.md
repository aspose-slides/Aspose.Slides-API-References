...
description: Представляет эффект Alpha Modulate Fixed. Значения альфа (непрозрачности) умножаются на фиксированный процент.
type: docs
weight: 66
...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равен ли указанный [AlphaModulateFixed](./) текущему [AlphaModulateFixed](./). |
...
| **float** [get_Amount](./get_amount/)() override | Возвращает величину эффекта в процентах. Чтение **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | Получает данные эффективного эффекта Alpha Modulate Fixed с применённым наследованием. |
...
| void [set_Amount](./set_amount/)(**float**) override | Возвращает величину эффекта в процентах. Запись **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n'tй шаблонный аргумент как слабый указатель (а не shared). Позволяет переключать указатели в контейнерах в слабый режим. |
...
* Класс [IAlphaModulateFixed](../ialphamodulatefixed/)
