...
type: docs
weight: 1015
url: /ru/aspose.slides.effects/ivisualeffect/
---
## IVisualEffect класс
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-th шаблонный аргумент слабым указателем (вместо разделяемого). Позволяет переключать указатели в контейнерах в режим слабых. |
