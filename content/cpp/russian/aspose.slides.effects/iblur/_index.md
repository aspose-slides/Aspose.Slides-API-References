...
description: Представляет эффект размытия, который применяется ко всей фигуре, включая её заливку. Все цветовые каналы, включая альфа-канал, затрагиваются.
type: docs
weight: 456
...
Представляет [Blur](../blur/) эффект, который применяется ко всей фигуре, включая её заливку. Все цветовые каналы, включая альфа-канал, затрагиваются.
...
| virtual **bool** [get_Grow](./get_grow/)() | Определяет, должны ли границы объекта увеличиваться в результате размытия. True указывает, что границы увеличены, а false — что нет. Чтение **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Возвращает радиус размытия. Чтение **double**. |
...
| virtual void [set_Grow](./set_grow/)(**bool**) | Определяет, должны ли границы объекта увеличиваться в результате размытия. True указывает, что границы увеличены, а false — что нет. Запись **bool**. |
| virtual void [set_Radius](./set_radius/)(**double**) | Устанавливает радиус размытия. Запись **double**. |
