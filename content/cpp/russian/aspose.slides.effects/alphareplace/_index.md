...
description: Представляет эффект Alpha Replace. Значения альфа (непрозрачности) эффекта заменяются фиксированным альфа-значением.
type: docs
weight: 79
...
| Method | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равен ли указанный [AlphaReplace](./) текущему [AlphaReplace](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplaceEffectiveData](../ialphareplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | Получает эффективные данные эффекта Alpha Replace с учётом наследования. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный параметр как слабый указатель (вместо общего). Позволяет переключать указатели в контейнерах в режим слабых. |
...
* Класс [IAlphaReplace](../ialphareplace/)
