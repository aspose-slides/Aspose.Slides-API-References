...
---
## IAlphaModulateFixedEffectiveData класс

Неизменяемый объект, представляющий эффект Alpha Modulate Fixed. Значения альфа (непрозрачности) эффекта умножаются на фиксированный процент.
...
| virtual **float** [get_Amount](./get_amount/)() | Возвращает величину эффекта в процентах. Только для чтения **float**. |
