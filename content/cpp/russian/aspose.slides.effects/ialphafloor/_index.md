...
description: Представляет эффект Alpha Floor. Значения альфа (непрозрачности) менее 100% изменяются на ноль. Другими словами, всё частично прозрачное становится полностью прозрачным.
type: docs
weight: 287
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Получает фактические данные с применённым наследованием. |
