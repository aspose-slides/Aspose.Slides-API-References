...
description: Представляет эффект свечения, при котором за краями объекта добавляется цветная размазанная обводка.
type: docs
weight: 638
...
Представляет [Glow](../glow/) эффект, в котором цветная размазанная обводка добавляется за пределами краёв объекта.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | Формат цвета. Только для чтения [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual **double** [get_Radius](./get_radius/)() | Радиус. Чтение **double**. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Радиус. Запись **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-ый параметр шаблона как слабый указатель (вместо совместного). Позволяет переключать указатели в контейнерах в режим слабых. |
