...
description: Представляет эффект наложения заливки. Наложение заливки может использоваться для указания дополнительной заливки объекта и смешивания двух заливок вместе.
type: docs
weight: 612
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode. Чтение [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Формат заливки. Только для чтения [IFillFormat](../../aspose.slides/ifillformat/). |
...
| virtual void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) | FillBlendMode. Запись [FillBlendMode](../../aspose.slides/fillblendmode/). |
