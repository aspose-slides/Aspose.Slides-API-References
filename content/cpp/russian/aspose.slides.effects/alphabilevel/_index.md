...
description: Представляет эффект Alpha Bi-Level. Значения Alpha (непрозрачность) меньше порога изменяются на 0 (полностью прозрачные), а значения alpha, равные или превышающие порог, изменяются на 100% (полностью непрозрачные).
type: docs
weight: 1
...
Представляет эффект Alpha Bi-Level. Значения Alpha (Opacity) меньше порога изменяются на 0 (полностью прозрачные), а значения alpha, равные или превышающие порог, изменяются на 100% (полностью непрозрачные).
...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равен ли указанный [AlphaBiLevel](./) текущему [AlphaBiLevel](./). |
...
| **float** [get_Threshold](./get_threshold/)() override | Возвращает порог эффекта. Чтение **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру данных счетчика ссылок, связанную с объектом. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevelEffectiveData](../ialphabileveleffectivedata/)\> [GetEffective](./geteffective/)() override | Получает данные эффекта Alpha Bi-Level с примененным наследованием. |
...
| void [set_Threshold](./set_threshold/)(**float**) override | Возвращает порог эффекта. Запись **float**. |
...
* Класс [IAlphaBiLevel](../ialphabilevel/)
