...
description: Неизменяемый объект, представляющий эффект обратного альфа. Значения альpha (непрозрачности) инвертируются вычитанием из 100%.
type: docs
weight: 326
url: /ru/aspose.slides.effects/ialphainverseeffectivedata/
---
## IAlphaInverseEffectiveData класс

Неизменяемый объект, представляющий эффект обратного альфа. Значения альфа (непрозрачности) инвертируются вычитанием из 100%.
