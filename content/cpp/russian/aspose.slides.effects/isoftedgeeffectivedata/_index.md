...
description: Неизменяемый объект, представляющий эффект мягкого края. Края фигуры размыты, в то время как заливка не затронута.
type: docs
weight: 976
url: /ru/aspose.slides.effects/isoftedgeeffectivedata/
---
## ISoftEdgeEffectiveData класс
...
| virtual **double** [get_Radius](./get_radius/)() | Указывает радиус размытия, применяемый к краям. Только для чтения **double**. |
