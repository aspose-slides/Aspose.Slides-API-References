...
---
## IColorChangeEffectiveData класс
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_FromColor](./get_fromcolor/)() | Цвет, который будет заменён. Только для чтения [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ToColor](./get_tocolor/)() | Цвет, который будет заменять. Только для чтения [System::Drawing::Color](../../system.drawing/color/). |
| virtual **bool** [get_UseAlpha](./get_usealpha/)() | Возвращает булево значение, определяющее, следует ли использовать альфа-компонент. Только для чтения **bool**. |
