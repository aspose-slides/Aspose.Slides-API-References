...
| virtual **float** [get_Hue](./get_hue/)() | Возвращает процент оттенка. Только для чтения **float**. |
| virtual **float** [get_Luminance](./get_luminance/)() | Возвращает процент яркости. Только для чтения **float**. |
| virtual **float** [get_Saturation](./get_saturation/)() | Возвращает процент насыщенности. Только для чтения **float**. |
