...
description: Представляет эффект инверсии альфа-канала. Значения альфа (непрозрачности) инвертируются вычитанием из 100%.
type: docs
weight: 40
...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равен ли указанный [AlphaInverse](./) текущему [AlphaInverse](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverseEffectiveData](../ialphainverseeffectivedata/)\> [GetEffective](./geteffective/)() override | Получает данные эффективного эффекта Alpha Inverse с учётом наследования. |
...
* Класс [IAlphaInverse](../ialphainverse/)
