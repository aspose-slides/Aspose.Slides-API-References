...
description: Представляет эффект Alpha Floor. Значения альфа (непрозрачности), меньше 100%, заменяются нулём. Другими словами, всё частично прозрачное становится полностью прозрачным.
type: docs
weight: 27
...
Представляет эффект Alpha Floor. Значения Alpha (непрозрачности) меньше 100% заменяются нулём. Другими словами, всё частично прозрачное становится полностью прозрачным.
...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равен ли указанный [AlphaFloor](./) текущему [AlphaFloor](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloorEffectiveData](../ialphaflooreffectivedata/)\> [GetEffective](./geteffective/)() override | Получает эффективные данные эффекта Alpha Floor с примененным наследованием. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Получает текущие значение счетчика общих ссылок. |
