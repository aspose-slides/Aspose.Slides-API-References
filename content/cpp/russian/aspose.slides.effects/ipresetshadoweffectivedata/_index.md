...
description: Неизменяемый объект, представляющий предустановленный эффект тени.
type: docs
weight: 924
...
Неизменяемый объект, представляющий предустановленный эффект тени.
...
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | Предустановка. Только для чтения [PresetShadowType](../../aspose.slides/presetshadowtype/). |
