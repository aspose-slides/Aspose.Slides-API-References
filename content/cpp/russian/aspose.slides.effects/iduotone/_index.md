...
description: Представляет эффект дуотона.
type: docs
weight: 560
...
Представляет эффект [Duotone](../duotone/).
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color1](./get_color1/)() | Возвращает целевой формат цвета для тёмных пикселей. Только для чтения [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color2](./get_color2/)() | Возвращает целевой формат цвета для светлых пикселей. Только для чтения [IColorFormat](../../aspose.slides/icolorformat/). |
