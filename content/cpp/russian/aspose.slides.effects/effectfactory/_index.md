...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IGlow](../iglow/)\> [CreateGlow](./createglow/)() override | Создаёт [Glow](../glow/) эффект. |
| [System::SharedPtr](../../system/sharedptr/)\<[IInnerShadow](../iinnershadow/)\> [CreateInnerShadow](./createinnershadow/)() override | Создаёт Inner shafow эффект. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOuterShadow](../ioutershadow/)\> [CreateOuterShadow](./createoutershadow/)() override | Создаёт Outer shadow эффект. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadow](../ipresetshadow/)\> [CreatePresetShadow](./createpresetshadow/)() override | Создаёт Preset shadow эффект. |
| [System::SharedPtr](../../system/sharedptr/)\<[IReflection](../ireflection/)\> [CreateReflection](./createreflection/)() override | Создаёт [Reflection](../reflection/) эффект. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdge](../isoftedge/)\> [CreateSoftEdge](./createsoftedge/)() override | Создаёт Soft Edge эффект. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperationFactory](../iimagetransformoperationfactory/)\> [get_ImageTransformOperationFactory](./get_imagetransformoperationfactory/)() override | Возвращает [ImageTransformOperationFactory](../imagetransformoperationfactory/). Только для чтения [IImageTransformOperationFactory](../iimagetransformoperationfactory/). |
...
* Класс [IEffectFactory](../ieffectfactory/)
