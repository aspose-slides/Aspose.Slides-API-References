...
---
## IOuterShadowEffectiveData класс
...
| virtual **float** [get_Direction](./get_direction/)() | Направление тени. Только для чтения **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Расстояние тени. Только для чтения **double**. |
...
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | Указывает, должна ли тень вращаться вместе с фигурой, если фигура вращается. Только для чтения **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | Указывает горизонтальный коэффициент масштабирования, отрицательное масштабирование приводит к отражению. Только для чтения **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | Указывает вертикальный коэффициент масштабирования, отрицательное масштабирование приводит к отражению. Только для чтения **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Цвет тени. Только для чтения [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | Указывает горизонтальный угол наклона (в градусах). Только для чтения **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | Указывает вертикальный угол наклона (в градусах). Только для чтения **double**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й параметр шаблона как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим слабых указателей. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывайте непосредственно или используйте объект-сторож [LockContext](../../system/lockcontext/). |
