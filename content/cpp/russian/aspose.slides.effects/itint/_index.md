...
description: Представляет эффект оттенка. Смещает значения цвета эффекта к/от оттенка на указанную величину.
type: docs
weight: 989
...
Представляет [Tint](../tint/) эффект. Смещает значения цвета эффекта к/от оттенка на указанную величину.
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Получает действительные данные с учётом наследования. |
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку операции C# lock(). Вызывайте напрямую или используйте охранный объект [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-ый аргумент шаблона как weak-указатель (а не shared). Позволяет переключать указатели в контейнерах в режим weak. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку операции C# lock(). Вызывайте напрямую или используйте охранный объект [LockContext](../../system/lockcontext/). |
