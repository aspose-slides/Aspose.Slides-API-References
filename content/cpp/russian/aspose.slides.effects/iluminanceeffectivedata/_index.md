...
description: Представляет эффект Luminance. Яркость линейно смещает все цвета ближе к белому или к чёрному. Контраст масштабирует все цвета, делая их либо ближе, либо дальше друг от друга.
type: docs
weight: 807
url: /ru/aspose.slides.effects/iluminanceeffectivedata/
---
## ILuminanceEffectiveData класс


Представляет [Luminance](../luminance/) эффект. Яркость линейно смещает все цвета ближе к белому или к чёрному. Контраст масштабирует все цвета, делая их либо ближе, либо дальше друг от друга.
...
| virtual **float** [get_Brightness](./get_brightness/)() | Яркость. Только для чтения **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Контраст. Только для чтения **float**. |
