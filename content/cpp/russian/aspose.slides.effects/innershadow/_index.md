...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равен ли указанный [InnerShadow](./) текущему [InnerShadow](./). |
...
| **double** [get_BlurRadius](./get_blurradius/)() override | [Blur](../blur/) радиус. Читать **double**. |
| **float** [get_Direction](./get_direction/)() override | Направление тени. Читать **float**. |
| **double** [get_Distance](./get_distance/)() override | Расстояние тени. Читать **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IInnerShadowEffectiveData](../iinnershadoweffectivedata/)\> [GetEffective](./geteffective/)() override | Получает данные эффекта внутренней тени с применённым наследованием. |
...
| void [set_BlurRadius](./set_blurradius/)(**double**) override | [Blur](../blur/) радиус. Записать **double**. |
| void [set_Direction](./set_direction/)(**float**) override | Направление тени. Записать **float**. |
| void [set_Distance](./set_distance/)(**double**) override | Расстояние тени. Записать **double**. |
...
* Класс [IInnerShadow](../iinnershadow/)
