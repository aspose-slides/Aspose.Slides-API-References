...
description: Представляет эффект Luminance. Яркость линейно смещает все цвета ближе к белому или черному. Контраст масштабирует все цвета так, чтобы они были либо ближе друг к другу, либо дальше друг от друга.
type: docs
weight: 794
...
Представляет эффект [Luminance](../luminance/). Яркость линейно смещает все цвета ближе к белому или черному. Контраст масштабирует все цвета так, чтобы они были либо ближе друг к другу, либо дальше друг от друга.
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Реализует оператор C# typeof([System.Object](../../system/object/)). |
