...
description: Представляет эффект серой шкалы. Преобразует все цветовые значения эффекта в оттенок серого, соответствующий их яркости. Значения альфа (непрозрачности) эффекта остаются без изменения.
type: docs
weight: 209
...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, является ли указанный [GrayScale](./) равным текущему [GrayScale](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGrayScaleEffectiveData](../igrayscaleeffectivedata/)\> [GetEffective](./geteffective/)() override | Получает эффективные данные эффекта Gray Scale с учётом наследования. |
