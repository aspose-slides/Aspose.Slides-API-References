...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равен ли указанный [PresetShadow](./) текущему [PresetShadow](./). |
...
| **float** [get_Direction](./get_direction/)() override | Направление тени. Чтение **float**. |
| **double** [get_Distance](./get_distance/)() override | Расстояние тени. Чтение **double**. |
...
| [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() override | Предустановка. Чтение [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() override | Цвет тени. Только для чтения [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadowEffectiveData](../ipresetshadoweffectivedata/)\> [GetEffective](./geteffective/)() override | Получает данные эффективного эффекта Preset Shadow с примененным наследованием. |
...
| void [set_Direction](./set_direction/)(**float**) override | Направление тени. Запись **float**. |
| void [set_Distance](./set_distance/)(**double**) override | Расстояние тени. Запись **double**. |
| void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) override | Предустановка. Запись [PresetShadowType](../../aspose.slides/presetshadowtype/). |
...
* Класс [IPresetShadow](../ipresetshadow/)
