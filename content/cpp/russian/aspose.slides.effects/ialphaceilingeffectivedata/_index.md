...
description: Неизменяемый объект, представляющий эффект предела альфа. Значения альфа (непрозрачности), превышающие ноль, изменяются на 100 %. Другими словами, всё частично непрозрачное становится полностью непрозрачным.
type: docs
weight: 274
url: /ru/aspose.slides.effects/ialphaceilingeffectivedata/
---
## IAlphaCeilingEffectiveData класс


Неизменяемый объект, представляющий эффект предела альфа. Значения альфа (непрозрачности), превышающие ноль, изменяются на 100 %. Другими словами, всё частично непрозрачное становится полностью непрозрачным.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n'tй аргумент шаблона как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим weak. |
