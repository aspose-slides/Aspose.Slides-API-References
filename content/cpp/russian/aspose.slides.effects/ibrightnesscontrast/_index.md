...
description: Представляет эффект BrightnessContrast. Настраивает яркость и контраст
type: docs
weight: 482
url: /ru/aspose.slides.effects/ibrightnesscontrast/
---
## IBrightnessContrast класс

Представляет эффект [BrightnessContrast](../brightnesscontrast/). Настраивает яркость и контраст
