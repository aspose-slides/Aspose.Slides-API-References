...
description: Неизменяемый объект, представляющий эффект Alpha Floor. Значения Alpha (непрозрачности), меньшие 100%, преобразуются в ноль. Другими словами, любые частично прозрачные объекты становятся полностью прозрачными.
type: docs
weight: 300
url: /ru/aspose.slides.effects/ialphaflooreffectivedata/
---
## IAlphaFloorEffectiveData класс


Неизменяемый объект, представляющий эффект Alpha Floor. Значения Alpha (непрозрачности), меньшие 100%, преобразуются в ноль. Другими словами, любые частично прозрачные объекты становятся полностью прозрачными.
