...
description: Представляет эффект мягкой кромки. Края фигуры размыты, в то время как заливка не изменяется.
type: docs
weight: 1080
...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равен ли указанный [SoftEdge](./) текущему [SoftEdge](./). |
...
| **double** [get_Radius](./get_radius/)() override | Указывает радиус размытия, применяемый к краям. Чтение **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | Получает фактические данные эффекта Soft Edge с учётом наследования. |
...
| void [set_Radius](./set_radius/)(**double**) override | Указывает радиус размытия, применяемый к краям. Запись **double**. |
