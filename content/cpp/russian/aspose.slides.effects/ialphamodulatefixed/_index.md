...
description: Представляет эффект фиксированной альфа-модуляции. Значения альфа (непрозрачности) эффекта умножаются на фиксированный процент.
type: docs
weight: 365
url: /ru/aspose.slides.effects/ialphamodulatefixed/
---
## IAlphaModulateFixed класс
...
| virtual **float** [get_Amount](./get_amount/)() | Возвращает величину эффекта в процентах. Чтение **float**. |
...
| virtual void [set_Amount](./set_amount/)(**float**) | Возвращает величину эффекта в процентах. Запись **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й параметр шаблона как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим слабых ссылок. |
