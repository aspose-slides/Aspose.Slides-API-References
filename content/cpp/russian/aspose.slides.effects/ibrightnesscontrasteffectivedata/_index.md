...
---
## IBrightnessContrastEffectiveData класс

Неизменяемый объект, представляющий эффект [BrightnessContrast](../brightnesscontrast/). Регулирует яркость и контраст
...
| virtual **float** [get_Brightness](./get_brightness/)() | Возвращает яркость. Только для чтения **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Возвращает контраст. Только для чтения **float**. |
