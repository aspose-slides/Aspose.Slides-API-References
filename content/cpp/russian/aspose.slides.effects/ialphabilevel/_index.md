...
description: Представляет эффект Alpha Bi-Level. Значения Alpha (непрозрачность), меньше порога, изменяются на 0 (полностью прозрачные), а значения alpha, больше либо равные порогу, изменяются на 100% (полностью непрозрачные).
type: docs
weight: 235
...
Представляет эффект Alpha Bi-Level. Значения Alpha (непрозрачность), которые меньше порога, изменяются на 0 (полностью прозрачные), а значения alpha, большие или равные порогу, изменяются на 100 % (полностью непрозрачные).
...
| virtual **float** [get_Threshold](./get_threshold/)() | Возвращает порог эффекта. Чтение **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру данных счетчика ссылок, связанную с объектом. |
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Получает эффективные данные с применённым наследованием. |
...
| virtual void [set_Threshold](./set_threshold/)(**float**) | Возвращает порог эффекта. Запись **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й параметр шаблона в слабый указатель (вместо общего). Позволяет переключать указатели в контейнерах в режим weak. |
...
Используйте [ImageTransformOperationFactory](../imagetransformoperationfactory/) для создания экземпляров в COM. 
## См. также
