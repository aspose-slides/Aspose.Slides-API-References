...
description: Представляет эффект Luminance. Яркость линейно сдвигает все цвета ближе к белому или чёрному. Контраст масштабирует все цвета, делая их ближе друг к другу или дальше.
type: docs
weight: 1028
...
| Method | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равно ли указанное [Luminance](./) текущему [Luminance](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminanceEffectiveData](../iluminanceeffectivedata/)\> [GetEffective](./geteffective/)() override | Получает эффективные данные эффекта [Luminance](./) с учётом наследования. |
