...
| [System::SharedPtr](../../system/sharedptr/)\<[DataColumnCollection](../datacolumncollection/)\> [get_Columns](./get_columns/)() | Получает столбцы, присутствующие в таблице. |
| [System::SharedPtr](../../system/sharedptr/)\<[DataSet](../dataset/)\> [get_DataSet](./get_dataset/)() | Получает набор данных, к которому принадлежит таблица. |
| [System::SharedPtr](../../system/sharedptr/)\<[DataRowCollection](../datarowcollection/)\> [get_Rows](./get_rows/)() | Информация RTTI. |
| [System::String](../../system/string/) [get_TableName](./get_tablename/)() | Получает имя таблицы. |
