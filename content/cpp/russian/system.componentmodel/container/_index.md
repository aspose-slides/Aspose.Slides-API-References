...
| Метод | Описание |
| --- | --- |
| void [Dispose](./dispose/)() | Информация RTTI. |
| void [Dispose](./dispose/)(**bool**) | Поддержка паттерна Disposable; ничего не делает. |
