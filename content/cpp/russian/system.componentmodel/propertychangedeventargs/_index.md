...
| virtual [String](../../system/string/) [get_PropertyName](./get_propertyname/)() | Получает имя свойства, связанного с событием. |
...
|  [PropertyChangedEventArgs](./propertychangedeventargs/)(const [String](../../system/string/)\&) | Инициализирует аргументы события PropertyChanged. |
...
| Поле | Описание |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Статический член, представляющий "пустой" совместный указатель [EventArgs](../../system/eventargs/) (нулевой указатель). |
