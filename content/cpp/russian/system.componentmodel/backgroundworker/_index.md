...
description: "Экземпляры этого класса должны создаваться только с помощью функции System::MakeObject(). Никогда не создавайте объект этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам времени выполнения и/или сбоям проверок. Всегда оборачивайте этот класс в указатель System::SmartPtr и используйте этот указатель для передачи его в функции в качестве аргумента."
type: docs
weight: 14
url: /ru/system.componentmodel/backgroundworker/
---
...
|  [Component](../component/component/)() | Информация RTTI. |
| void [Dispose](../component/dispose/)(**bool**) | Поддержка шаблона Disposable; ничего не делает. |
...
| **bool** [get_DesignMode](../component/get_designmode/)() | Проверяет, находится ли компонент в режиме проектирования. |
| **bool** [get_WorkerReportsProgress](./get_workerreportsprogress/)() const | Возвращает значение, указывающее, может ли [System::ComponentModel::BackgroundWorker](./) сообщать о прогрессе. |
...
| void [ReportProgress](./reportprogress/)(int) | Вызывает событие **System::ComponentModel::BackgroundWorker::ProgressChanged**. |
| void [ReportProgress](./reportprogress/)(int, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Вызывает событие **System::ComponentModel::BackgroundWorker::ProgressChanged** с объектом userState. |
| void [RunWorkerAsync](./runworkerasync/)() | Запускает выполнение фоновой операции. |
| void [RunWorkerAsync](./runworkerasync/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Запускает выполнение фоновой операции. |
| void [set_WorkerReportsProgress](./set_workerreportsprogress/)(**bool**) | Устанавливает значение, указывающее, может ли [System::ComponentModel::BackgroundWorker](./) сообщать о прогрессе. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Уменьшает счётчик слабых ссылок. Не должно вызываться напрямую;instead, use smart pointers or ThisProtector. |
