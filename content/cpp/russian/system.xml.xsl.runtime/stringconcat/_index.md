...
description: Объединяет строки, когда количество строк заранее неизвестно.
type: docs
weight: 1
url: /ru/system.xml.xsl.runtime/stringconcat/
---
## Класс StringConcat

Объединяет строки, когда количество строк заранее неизвестно.
...
| Метод | Описание |
| --- | --- |
| void [Clear](./clear/)() | Очищает результирующую строку. |
| void [Concat](./concat/)(const [String](../../system/string/)\&) | Объединяет новую строку с результатом. |
...
| [String](../../system/string/) [get_Delimiter](./get_delimiter/)() | Возвращает строку, ограничивающую объединяемые строки. |
...
| [String](../../system/string/) [GetResult](./getresult/)() | Возвращает результирующую строку. |
...
| void [set_Delimiter](./set_delimiter/)(const [String](../../system/string/)\&) | Устанавливает строку, ограничивающую объединяемые строки. |
...
| [StringConcat](./stringconcat/)() | Конструктор по умолчанию. |
...
* Пространство имён [System::Xml::Xsl::Runtime](../)
