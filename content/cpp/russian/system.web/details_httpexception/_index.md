...
type: docs
weight: 1
url: /ru/system.web/details_httpexception/
---
## Details_HttpException класс
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Задаёт n-й аргумент шаблона как слабую ссылку (а не общую). Позволяет переключать указатели в контейнерах в слабый режим. |
