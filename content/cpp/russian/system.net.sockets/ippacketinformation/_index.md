...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Сравнивает два объекта, используя семантику C# [Object.Equals](../../system/object/equals/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../../system.net/ipaddress/)\> [get_Address](./get_address/)() | Возвращает адрес, откуда получен пакет. |
| **int32_t** [get_Interface](./get_interface/)() | Возвращает информацию о сетевом интерфейсе. |
...
| [IPPacketInformation](./ippacketinformation/)([System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../../system.net/ipaddress/)\>, **int32_t**) | Создаёт новый экземпляр. |
