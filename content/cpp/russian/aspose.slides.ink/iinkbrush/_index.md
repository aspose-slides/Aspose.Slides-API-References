...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Получает цвет кисти для линии. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | Получает тип эффекта чернил (например, Galaxy, Gold, Silver), определяющий визуальный стиль штриха. Значение извлекается из свойства кисти "inkEffects". Если не указан распознанный эффект, возвращается [InkEffectType::NotDefined](../inkeffecttype/). |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Получает размер кисти для линии в пунктах. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Устанавливает цвет кисти для линии. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Устанавливает размер кисти для линии в пунктах. |
