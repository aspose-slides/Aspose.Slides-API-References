...
Представляет рукописную линию в объекте [Ink](../ink/).
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IInkBrush](../iinkbrush/)\> [get_Brush](./get_brush/)() | Получает Brush для IInkLine [IInkBrush](../iinkbrush/) только для чтения. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | Получает точки для IInkLine [System::Drawing::PointF](../../system.drawing/pointf/) только для чтения. |
