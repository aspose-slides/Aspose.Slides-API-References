...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Получает цвет кисти для линии. |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | Получает тип эффекта чернил (например, Galaxy, Gold, Silver), определяющий визуальный стиль штриха чернила. Значение извлекается из свойства кисти \"inkEffects\". Если указанный эффект не распознан, возвращается [InkEffectType::NotDefined](../inkeffecttype/). |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Получает размер кисти для линии в пунктах. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Устанавливает цвет кисти для линии. |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | Устанавливает размер кисти для линии в пунктах. |
