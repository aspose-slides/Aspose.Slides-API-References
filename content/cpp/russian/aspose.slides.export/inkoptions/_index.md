...
Предоставляет параметры, которые управляют внешним видом объектов [Ink](../../aspose.slides.ink/) в экспортируемом документе.
...
| **bool** [get_HideInk](./get_hideink/)() override | Показывает или скрывает элементы [Ink](../../aspose.slides.ink/) в экспортируемом документе. |
| **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() override | Использует операцию ROP или непрозрачность для отрисовки кисти. |
...
| void [set_HideInk](./set_hideink/)(**bool**) override | Показывает или скрывает элементы [Ink](../../aspose.slides.ink/) в экспортируемом документе. |
| void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) override | Использует операцию ROP или непрозрачность для отрисовки кисти. |
