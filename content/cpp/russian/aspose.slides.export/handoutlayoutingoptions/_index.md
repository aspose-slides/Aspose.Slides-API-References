...
description: Представляет режим компоновки раздаточного показа для экспорта.
type: docs
weight: 66
...
Представляет режим компоновки раздаточного показа для экспорта.
...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | Указывает, сколько слайдов и в какой последовательности будет размещено на странице [HandoutType](../handouttype/). |
| **bool** [get_PrintComments](./get_printcomments/)() const | Указывает, следует ли отображать комментарии на слайдах. |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | Указывает, рисовать ли рамки вокруг отображаемых слайдов. |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | Указывает, следует ли печатать номера отображаемых слайдов. |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | Указывает, сколько слайдов и в какой последовательности будет размещено на странице [HandoutType](../handouttype/). |
| void [set_PrintComments](./set_printcomments/)(**bool**) | Указывает, следует ли отображать комментарии на слайдах. |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | Указывает, рисовать ли рамки вокруг отображаемых слайдов. |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | Указывает, следует ли печатать номера отображаемых слайдов. |
