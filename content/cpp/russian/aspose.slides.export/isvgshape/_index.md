...
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | Устанавливает или получает id для формы |
...
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | Устанавливает или получает id для формы |
| virtual void [SetEventHandler](./seteventhandler/)([SvgEvent](../svgevent/), [System::String](../../system/string/)) | Устанавливает обработчик событий для формы |
