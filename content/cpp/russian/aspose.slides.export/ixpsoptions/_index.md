...
Предоставляет параметры, контролирующие, как презентация сохраняется в формате XPS.
...
| virtual **bool** [get_DrawSlidesFrame](./get_drawslidesframe/)() | True, чтобы отрисовывать черную рамку вокруг каждого слайда. Читает **bool**. |
...
| virtual **bool** [get_SaveMetafilesAsPng](./get_savemetafilesaspng/)() | True, чтобы конвертировать все метафайлы, используемые в презентации, в изображения PNG. Читает **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/)\> [get_WarningCallback](../isaveoptions/get_warningcallback/)() | Возвращает объект, получающий предупреждения и решающий, продолжать ли процесс загрузки или прервать его. Читает [Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/). |
...
| virtual void [set_DrawSlidesFrame](./set_drawslidesframe/)(**bool**) | True, чтобы отрисовывать черную рамку вокруг каждого слайда. Записывает **bool**. |
...
| virtual void [set_SaveMetafilesAsPng](./set_savemetafilesaspng/)(**bool**) | True, чтобы конвертировать все метафайлы, используемые в презентации, в изображения PNG. Записывает **bool**. |
...
| virtual void [set_WarningCallback](../isaveoptions/set_warningcallback/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/)\>) | Устанавливает объект, получающий предупреждения и решающий, продолжать ли процесс загрузки или прервать его. Записывает [Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n'tй параметр шаблона как слабый указатель (вместо общего). Позволяет переключать указатели в контейнерах в слабый режим. |
