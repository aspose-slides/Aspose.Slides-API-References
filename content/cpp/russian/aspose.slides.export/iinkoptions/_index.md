...
Предоставляет параметры, которые контролируют внешний вид объектов [Ink](../../aspose.slides.ink/) в экспортируемом документе.
...
| virtual **bool** [get_HideInk](./get_hideink/)() | Показывает или скрывает элементы [Ink](../../aspose.slides.ink/) в экспортируемом документе. |
| virtual **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() | Использует операцию ROP или непрозрачность для отрисовки кисти. |
...
| virtual void [set_HideInk](./set_hideink/)(**bool**) | Показывает или скрывает элементы [Ink](../../aspose.slides.ink/) в экспортируемом документе. |
| virtual void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) | Использует операцию ROP или непрозрачность для отрисовки кисти. |
