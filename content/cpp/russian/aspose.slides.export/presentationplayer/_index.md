...
description: Представляет проигрыватель анимаций, связанных с презентацией.
type: docs
weight: 625
...
| Method | Description |
| --- | --- |
| void [Dispose](./dispose/)() override | Уничтожает экземпляр [PresentationPlayer](./). |
...
| **int32_t** [get_FrameIndex](./get_frameindex/)() | Возвращает индекс кадра. |
...
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | Создаёт новый экземпляр [PresentationPlayer](./). |
...
| Typedef | Description |
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | Представляет обработчик тика кадра события **PresentationPlayer::FrameTick**. |
