...
description: Класс контроллера форматирования, используемый для внедрения шрифтов в формат WOFF
type: docs
weight: 27
...
|  [EmbeddedWoffFontsHtmlController](./embeddedwofffontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Создаёт новый экземпляр. |
...
* Класс [IEmbeddedWoffFontsHtmlController](../iembeddedwofffontshtmlcontroller/)
