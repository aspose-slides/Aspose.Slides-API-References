...
description: Представляет параметры SVG фигуры.
type: docs
weight: 716
...
| [System::String](../../system/string/) [get_Id](./get_id/)() override | Получает идентификатор фигуры |
...
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | Получает идентификатор фигуры |
| void [SetEventHandler](./seteventhandler/)([SvgEvent](../svgevent/), [System::String](../../system/string/)) override | Устанавливает обработчик событий для фигуры |
