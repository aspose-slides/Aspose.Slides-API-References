...
| virtual **bool** [get_AnimateShapes](./get_animateshapes/)() | Возвращает параметр анимации фигур. Чтение **bool**. |
| virtual **bool** [get_AnimateTransitions](./get_animatetransitions/)() | Возвращает параметр анимации переходов. Чтение **bool**. |
...
| virtual **bool** [get_DisableFontLigatures](./get_disablefontligatures/)() | Получает значение, указывающее, рендерится ли текст без использования лигатур. При установке в **true** лигатуры будут отключены в выводе. По умолчанию это свойство установлено в **false**. |
| virtual **bool** [get_EmbedImages](./get_embedimages/)() | Возвращает параметр встраивания изображений. Чтение **bool**. |
...
| virtual [System::String](../../system/string/) [get_OutputPath](./get_outputpath/)() | Определяет, где следует хранить внешние ресурсы. Чтение [System::String](../../system/string/). |
...
| virtual **bool** [get_SkipJavaScriptLinks](../isaveoptions/get_skipjavascriptlinks/)() | Определяет, следует ли пропускать гиперссылки с вызовами JavaScript при сохранении презентации. Чтение **bool**. Значение по умолчанию — **false**. |
...
| virtual void [set_AnimateShapes](./set_animateshapes/)(**bool**) | Устанавливает параметр анимации фигур. Запись **bool**. |
| virtual void [set_AnimateTransitions](./set_animatetransitions/)(**bool**) | Устанавливает параметр анимации переходов. Запись **bool**. |
| virtual void [set_DefaultRegularFont](../isaveoptions/set_defaultregularfont/)([System::String](../../system/string/)) | Устанавливает шрифт, используемый в случае, если исходный шрифт не найден. Запись [System::String](../../system/string/). |
| virtual void [set_DisableFontLigatures](./set_disablefontligatures/)(**bool**) | Устанавливает значение, указывающее, рендерится ли текст без использования лигатур. При установке в **true** лигатуры будут отключены в выводе. По умолчанию это свойство установлено в **false**. |
| virtual void [set_EmbedImages](./set_embedimages/)(**bool**) | Устанавливает параметр встраивания изображений. Запись **bool**. |
...
| virtual void [set_OutputPath](./set_outputpath/)([System::String](../../system/string/)) | Определяет, где следует хранить внешние ресурсы. Запись [System::String](../../system/string/). |
...
| virtual void [set_SkipJavaScriptLinks](../isaveoptions/set_skipjavascriptlinks/)(**bool**) | Определяет, следует ли пропускать гиперссылки с вызовами JavaScript при сохранении презентации. Запись **bool**. Значение по умолчанию — **false**. |
