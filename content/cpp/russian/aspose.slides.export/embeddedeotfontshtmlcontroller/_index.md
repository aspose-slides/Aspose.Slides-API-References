...
description: Класс контроллера форматирования, используемый для встраивания шрифтов в формате EOT
type: docs
weight: 14
...
| Method | Description |
| --- | --- |
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)() | Создает новый экземпляр. |
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Создает новый экземпляр. |
...
* Класс [IEmbeddedEotFontsHtmlController](../iembeddedeotfontshtmlcontroller/)
