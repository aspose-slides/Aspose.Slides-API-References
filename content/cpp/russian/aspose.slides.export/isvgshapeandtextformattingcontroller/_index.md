...
---
## ISvgShapeAndTextFormattingController класс
...
| virtual void [FormatShape](../isvgshapeformattingcontroller/formatshape/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgShape](../isvgshape/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Эта функция вызывается перед рендерингом формы в SVG, позволяя пользователю контролировать полученный SVG. |
| virtual void [FormatText](./formattext/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgTSpan](../isvgtspan/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../../aspose.slides/iportion/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) | Эта функция вызывается перед рендерингом текстовой части в SVG, позволяя пользователю контролировать полученный SVG. |
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку по оператору C# lock(). Вызывайте напрямую или используйте охранный объект [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона в виде слабого указателя (вместо общего). Позволяет переключать указатели в контейнерах в режим weak. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку по оператору C# lock(). Вызывайте напрямую или используйте охранный объект [LockContext](../../system/lockcontext/). |
...
* Класс [ISvgShapeFormattingController](../isvgshapeformattingcontroller/)
