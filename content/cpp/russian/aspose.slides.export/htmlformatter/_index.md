...
| Метод | Описание |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateCustomFormatter](./createcustomformatter/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Создаёт и возвращает HTML-форматтер для пользовательской генерации HTML с помощью обратных вызовов. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateDocumentFormatter](./createdocumentformatter/)([System::String](../../system/string/), **bool**) | Создаёт и возвращает HTML-форматтер для простого представления документа, состоящего из последовательностей слайдов один под другим. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateSlideShowFormatter](./createslideshowformatter/)([System::String](../../system/string/), **bool**) | Создаёт и возвращает HTML-форматтер для простого HTML-слайдшоу, показывающего слайды один за другим. |
...
* Класс [IHtmlFormatter](../ihtmlformatter/)
