...
|  [ResponsiveHtmlController](./responsivehtmlcontroller/)() | Создаёт новый экземпляр |
|  [ResponsiveHtmlController](./responsivehtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Создаёт новый экземпляр |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Уменьшает и возвращает значение счётчика общих ссылок. Не должен вызываться напрямую; вместо этого используйте умные указатели или ThisProtector. |
...
* Класс [IResponsiveHtmlController](../iresponsivehtmlcontroller/)
