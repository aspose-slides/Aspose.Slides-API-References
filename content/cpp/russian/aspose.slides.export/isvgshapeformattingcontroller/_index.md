...
---
## ISvgShapeFormattingController класс
...
| virtual void [FormatShape](./formatshape/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgShape](../isvgshape/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Эта функция вызывается перед рендерингом фигуры в SVG, позволяя пользователю управлять полученным SVG. |
