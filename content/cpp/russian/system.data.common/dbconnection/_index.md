...
| virtual [String](../../system/string/) [get_ConnectionString](./get_connectionstring/)() const | Информация RTTI. |
...
| virtual void [Open](./open/)() | Открывает соединение с базой данных. |
...
| virtual void [set_ConnectionString](./set_connectionstring/)([String](../../system/string/)) const | Устанавливает информацию о соединении (например, сервер и порт). |
