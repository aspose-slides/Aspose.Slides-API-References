...
| Метод | Описание |
| --- | --- |
| virtual void [Close](./close/)() | Закрывает канал получения данных. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)([String](../../system/string/)) | Получает именованный элемент. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(int) | Получает элемент по индексу. |
...
| virtual **bool** [Read](./read/)() | Читает следующую запись из базы данных. |
