...
description: Эффект перехода слайда по боковому направлению.
type: docs
weight: 248
url: /ru/aspose.slides.slideshow/isidedirectiontransition/
---
## ISideDirectionTransition класс

Эффект перехода слайда по боковому направлению.
...
| virtual [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() | Направление перехода. Читать [TransitionSideDirectionType](../transitionsidedirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) | Направление перехода. Записать [TransitionSideDirectionType](../transitionsidedirectiontype/). |
