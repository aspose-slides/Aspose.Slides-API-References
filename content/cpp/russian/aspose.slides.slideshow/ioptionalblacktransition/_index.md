...
---
## IOptionalBlackTransition класс
...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Этот атрибут указывает, начнётся ли переход с чёрного экрана (а затем будет переключён новый слайд поверх чёрного). Чтение **bool**. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Этот атрибут указывает, начнётся ли переход с чёрного экрана (а затем будет переключён новый слайд поверх чёрного). Запись **bool**. |
