...
| virtual [TransitionMorphType](../transitionmorphtype/) [get_MorphType](./get_morphtype/)() | Тип морфного перехода. Читайте [TransitionMorphType](../transitionmorphtype/). |
...
| virtual void [set_MorphType](./set_morphtype/)([TransitionMorphType](../transitionmorphtype/)) | Тип морфного перехода. Запишите [TransitionMorphType](../transitionmorphtype/). |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Уменьшает счетчик слабых ссылок. Не следует вывать напрямую; вместо этого используйте умные указатели или ThisProtector. |
