...
| virtual [Orientation](../../aspose.slides/orientation/) [get_Direction](./get_direction/)() | Направление перехода. Читайте [Orientation](../../aspose.slides/orientation/). |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Уменьшает подсчёт общих ссылок на указанное значение. |
| virtual void [set_Direction](./set_direction/)([Orientation](../../aspose.slides/orientation/)) | Направление перехода. Записывайте [Orientation](../../aspose.slides/orientation/). |
