...
| **bool** [get_ThroughBlack](./get_throughblack/)() override | Определяет, затемняется ли переход через чёрный цвет. Читайте **bool**. |
...
| void [set_ThroughBlack](./set_throughblack/)(**bool**) override | Определяет, затемняется ли переход через чёрный цвет. Запишите **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокирование оператора C# lock(). Вызывайте напрямую или используйте охранный объект [LockContext](../../system/lockcontext/). |
...
* Класс [IRevealTransition](../irevealtransition/)
