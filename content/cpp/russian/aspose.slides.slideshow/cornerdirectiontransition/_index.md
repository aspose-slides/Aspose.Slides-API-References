...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Определяет, равны ли два [TransitionValueBase](../transitionvaluebase/) экземпляра. |
...
| [TransitionCornerDirectionType](../transitioncornerdirectiontype/) [get_Direction](./get_direction/)() override | Направление перехода. Читайте [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру счётчика ссылок, связанную с объектом. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Служит функцией хеширования для конкретного типа, пригодной для использования в алгоритмах хеширования и структурах данных, таких как хеш-таблица. |
...
| void [set_Direction](./set_direction/)([TransitionCornerDirectionType](../transitioncornerdirectiontype/)) override | Направление перехода. Записать [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
...
* Класс [ICornerDirectionTransition](../icornerdirectiontransition/)
