...
| [Orientation](../../aspose.slides/orientation/) [get_Direction](./get_direction/)() override | Направление перехода. Чтение [Orientation](../../aspose.slides/orientation/). |
...
| void [set_Direction](./set_direction/)([Orientation](../../aspose.slides/orientation/)) override | Направление перехода. Запись [Orientation](../../aspose.slides/orientation/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона в слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим слабых ссылок. |
...
* Класс [IOrientationTransition](../iorientationtransition/)
