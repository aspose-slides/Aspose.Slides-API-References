...
description: Эффект блестящего перехода слайда.
type: docs
weight: 118
url: /ru/aspose.slides.slideshow/iglittertransition/
---
## IGlitterTransition класс
...
| virtual [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() | Направление перехода. Читайте [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() | Указывает форму визуальных элементов, используемых во время перехода. Читайте [TransitionPattern](../transitionpattern/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) | Направление перехода. Запишите [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) | Указывает форму визуальных элементов, используемых во время перехода. Запишите [TransitionPattern](../transitionpattern/). |
