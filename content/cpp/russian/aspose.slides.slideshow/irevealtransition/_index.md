...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | Направление перехода. Читайте [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| virtual **bool** [get_ThroughBlack](./get_throughblack/)() | Указывает, будет ли переход затухать через чёрный цвет. Читайте **bool**. |
...
| virtual void [set_ThroughBlack](./set_throughblack/)(**bool**) | Указывает, будет ли переход затухать через чёрный цвет. Запишите **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный аргумент в виде слабого указателя (вместо общего). Позволяет переключать указатели в контейнерах в режим слабого. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Реализует конструкт typeof([System.Object](../../system/object/)) C#. |
