...
description: Эффект перехода пролётом слайда.
type: docs
weight: 105
url: /ru/aspose.slides.slideshow/iflythroughtransition/
---
## IFlyThroughTransition класс

Эффект перехода пролётом слайда.
...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Направление перехода. Чтение [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual **bool** [get_HasBounce](./get_hasbounce/)() | Указывает, что перемещение слайдов презентации во время перехода включает отскок. Чтение **bool**. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Направление перехода. Запись [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_HasBounce](./set_hasbounce/)(**bool**) | Указывает, что перемещение слайдов презентации во время перехода включает отскок. Запись **bool**. |
