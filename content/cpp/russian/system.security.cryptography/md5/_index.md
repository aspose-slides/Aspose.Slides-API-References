...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Хеширует срез буфера. |
...
| static [SharedPtr](../../system/sharedptr/)\<[MD5](./)\> [Create](./create/)() | Создаёт алгоритм [MD5](./). |
| static [SharedPtr](../../system/sharedptr/)\<[MD5](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Создаёт алгоритм [MD5](./). |
