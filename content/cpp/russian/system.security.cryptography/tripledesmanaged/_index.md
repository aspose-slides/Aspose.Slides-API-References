...
| void [GenerateIV](./generateiv/)() override | Создаёт случайное начальное значение и сохраняет его во внутренние структуры алгоритма. |
| void [GenerateKey](./generatekey/)() override | Создаёт случайный ключ и сохраняет его во внутренние структуры алгоритма. |
...
| virtual [PaddingMode](../paddingmode/) [get_Padding](../symmetricalgorithm/get_padding/)() | Получает тип заполнения криптографической операции. |
...
| virtual void [set_Padding](../symmetricalgorithm/set_padding/)([PaddingMode](../paddingmode/)) | Устанавливает тип заполнения криптографической операции. |
