...
| int [get_MaxSize](./get_maxsize/)() const | Возвращает максимальный допустимый размер ключа. |
| int [get_MinSize](./get_minsize/)() const | Возвращает минимальный допустимый размер ключа. |
| int [get_SkipSize](./get_skipsize/)() const | Возвращает шаг допустимого размера ключа. |
...
|  [KeySizes](./keysizes/)(int, int, int) | Информация о RTTI. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует размонтирование оператора C# lock(). Вызывайте напрямую или используйте охранный объект [LockContext](../../system/lockcontext/). |
