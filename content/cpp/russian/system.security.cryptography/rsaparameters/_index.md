...
description: "Структура данных параметров алгоритма RSA. Этот тип должен быть выделен в стеке и передан функциям по значению или по ссылке. Никогда не используйте класс System::SmartPtr для управления объектами этого типа."
type: docs
weight: 768
url: /ru/system.security.cryptography/rsaparameters/
---
## RSAParameters структура

[Data](../../system.data/) структура [RSA](../rsa/) параметров алгоритма. Этот тип должен выделяться в стеке и передаваться в функции по значению или по ссылке. Никогда не используйте класс [System::SmartPtr](../../system/smartptr/) для управления объектами этого типа.
...
|  [RSAParameters](./rsaparameters/)() | Конструктор. |
