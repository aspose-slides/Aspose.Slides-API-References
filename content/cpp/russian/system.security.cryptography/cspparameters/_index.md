...
| Метод | Описание |
| --- | --- |
|  [CspParameters](./cspparameters/)() | Конструктор. |
|  [CspParameters](./cspparameters/)(int) | Конструктор. |
|  [CspParameters](./cspparameters/)(int, const [System::String](../../system/string/)\&) | Конструктор. |
|  [CspParameters](./cspparameters/)(int, const [System::String](../../system/string/)\&, const [System::String](../../system/string/)\&) | Конструктор. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Конструктор копии. На самом деле ничего не копирует, просто инициализирует новый объект и позволяет копировать конструкторы подклассов. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-th шаблонный аргумент как слабый указатель (а не shared). Позволяет переключать указатели в контейнерах в режим слабых. |
