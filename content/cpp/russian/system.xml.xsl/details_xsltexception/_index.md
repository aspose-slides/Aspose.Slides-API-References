...
description: Исключение, которое выбрасывается, когда происходит ошибка при обработке трансформации XSLT.
type: docs
weight: 14
url: /ru/system.xml.xsl/details_xsltexception/
---
## Details_XsltException класс

Исключение, которое выбрасывается, когда происходит ошибка при обработке трансформации XSLT.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Возвращает номер строки, указывающей, где произошла ошибка в таблице стилей. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Возвращает позицию в строке, указывающую, где произошла ошибка в таблице стилей. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Возвращает отформатированное сообщение об ошибке, описывающее текущее исключение. |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Возвращает путь расположения таблицы стилей. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Конструктор копирования. На самом деле ничего не копирует, а лишь инициализирует новый объект и позволяет построить копию в подклассах. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Оператор присваивания. На самом деле ничего не копирует, а лишь инициализирует новый объект и позволяет построить копию в подклассах. |
