...
description: Предоставляет интерфейс к заданной переменной, определённой в таблице стилей во время выполнения.
type: docs
weight: 40
url: /ru/system.xml.xsl/ixsltcontextvariable/
---
## IXsltContextVariable класс
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Evaluate](./evaluate/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>) | Выполняет вычисление переменной во время выполнения и возвращает объект, представляющий значение переменной. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Только для внутренних целей. |
| virtual **bool** [get_IsLocal](./get_islocal/)() | Возвращает значение, указывающее, является ли переменная локальной. |
| virtual **bool** [get_IsParam](./get_isparam/)() | Возвращает значение, указывающее, является ли переменная параметром Extensible Stylesheet Language Transformations (XSLT). Это может быть параметр таблицы стилей или шаблона. |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_VariableType](./get_variabletype/)() | Возвращает XPathResultType, представляющий тип XML Path Language ([XPath](../../system.xml.xpath/)) переменной. |
