...
description: Инкапсулирует текущий контекст выполнения процессора Extensible Stylesheet Language for Transformations (XSLT), позволяя XML Path Language (XPath) разрешать функции, параметры и пространства имён в выражениях XPath.
type: docs
weight: 79
url: /ru/system.xml.xsl/xsltcontext/
---
## XsltContext класс

Инкапсулирует текущий контекст выполнения процессора Extensible Stylesheet Language for Transformations (XSLT), позволяя XML Path Language ([XPath](../../system.xml.xpath/)) разрешать функции, параметры и пространства имён в выражениях [XPath](../../system.xml.xpath/).
...
| Метод | Описание |
| --- | --- |
| virtual void [AddNamespace](../../system.xml/xmlnamespacemanager/addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Добавляет указанный namespace в коллекцию. |
...
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | При переопределении в производном классе сравнивает базовые Uniform Resource Identifiers (URI) двух документов на основе порядка загрузки документов процессором XSLT (то есть класса [XslTransform](../xsltransform/)). |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | Возвращает URI пространства имён для пространства имён по умолчанию. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | Возвращает [XmlNameTable](../../system.xml/xmlnametable/), связанный с этим объектом. |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | При переопределении в производном классе возвращает значение, указывающее, включать ли узлы пробельных символов в вывод. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру данных счётчика ссылок, связанную с объектом. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | Возвращает перечислитель для перебора пространств имён в [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/). |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](../../system.xml/xmlnamespacemanager/getnamespacesinscope/)([XmlNamespaceScope](../../system.xml/xmlnamespacescope/)) override | Возвращает коллекцию имён пространств имён, ключом которой является префикс, которую можно использовать для перечисления текущих активных пространств имён. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Получает фактический тип объекта. Аналог вызова C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [HasNamespace](../../system.xml/xmlnamespacemanager/hasnamespace/)([String](../../system/string/)) | Возвращает значение, указывающее, имеет ли указанный префикс определённое пространство имён в текущей добавленной области. |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Возвращает элемент с заданным индексом в последовательности. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Возвращает элемент с заданным индексом в последовательности. |
...
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | Возвращает URI пространства имён для указанного префикса. |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | Находит префикс, объявленный для указанного URI пространства имён. |
...
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | Снимает область пространства имён со стека. |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | При переопределении в производном классе определяет, сохранять ли узлы пробельных символов или удалять их для данного контекста. |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | Помещает область пространства имён в стек. |
...
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Удаляет указанное пространство имён для указанного префикса. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | При переопределении в производном классе разрешает ссылку на переменную и возвращает [IXsltContextVariable](../ixsltcontextvariable/), представляющий переменную. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Задаёт n-й параметр шаблона как слабый указатель (а не shared). Позволяет переключать указатели в контейнерах в режим weak. |
...
| [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Инициализирует новый экземпляр класса [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) с указанным [XmlNameTable](../../system.xml/xmlnametable/). |
