...
description: "Предоставляет данные для события XsltArgumentList::XsltMessageEncountered."
type: docs
weight: 92
url: /ru/system.xml.xsl/xsltmessageencounteredeventargs/
---
## XsltMessageEncounteredEventArgs класс


Предоставляет данные для события **XsltArgumentList::XsltMessageEncountered**.
...
| virtual [String](../../system/string/) [get_Message](./get_message/)() | Возвращает содержимое элемента **xsl:message**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона как слабый указатель (в отличие от общих). Позволяет переключать указатели в контейнерах в слабый режим. |
