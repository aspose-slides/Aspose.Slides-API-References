...
description: Указывает функции XSLT, которые следует поддерживать во время выполнения таблицы стилей XSLT.
type: docs
weight: 118
url: /ru/system.xml.xsl/xsltsettings/
---
## XsltSettings класс
...
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_Default](./get_default/)() | Возвращает объект [XsltSettings](./) с настройками по умолчанию. Поддержка функции XSLT **document()** и встроенных блоков скриптов отключена. |
| **bool** [get_EnableDocumentFunction](./get_enabledocumentfunction/)() | Возвращает значение, указывающее, включена ли поддержка функции XSLT **document()**. |
| **bool** [get_EnableScript](./get_enablescript/)() | Возвращает значение, указывающее, включена ли поддержка встроенных блоков скриптов. |
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_TrustedXslt](./get_trustedxslt/)() | Возвращает объект [XsltSettings](./), который включает поддержку функции XSLT **document()** и встроенных блоков скриптов. |
...
| void [set_EnableDocumentFunction](./set_enabledocumentfunction/)(**bool**) | Устанавливает значение, указывающее, включена ли поддержка функции XSLT **document()**. |
| void [set_EnableScript](./set_enablescript/)(**bool**) | Устанавливает значение, указывающее, включена ли поддержка встроенных блоков скриптов. |
