...
description: "Базовый класс для классов, представляющих системные (а не прикладные) исключения. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс SystemException. Никогда не помещайте экземпляры класса SystemException в System::SmartPtr."
type: docs
weight: 703
url: /ru/system/details_systemexception/
---
## Details_SystemException класс

Базовый класс для классов, представляющих системные (а не прикладные) исключения. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс SystemException. Никогда не помещайте экземпляры класса SystemException в [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Конструктор копирования. На самом деле ничего не копирует, а лишь инициализирует новый объект и позволяет копирующее конструирование подклассов. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Оператор присваивания. На самом деле ничего не копирует, а лишь инициализирует новый объект и позволяет копирующее конструирование подклассов. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона в слабый указатель (а не совместный). Позволяет переключать указатели в контейнерах в слабый режим. |
