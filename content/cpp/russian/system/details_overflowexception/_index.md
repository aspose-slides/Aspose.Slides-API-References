...
description: "OverflowException выбрасывается, когда операция приводит к переполнению. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс OverflowException. Никогда не оборачивайте экземпляры класса OverflowException в System::SmartPtr."
type: docs
weight: 651
url: /ru/system/details_overflowexception/
---
## Details_OverflowException класс


OverflowException вызывается, когда операция приводит к переполнению. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс OverflowException. Никогда не оборачивайте экземпляры класса OverflowException в [System::SmartPtr](../smartptr/).
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона в виде слабой ссылки (вместо совместной). Позволяет переключать указатели в контейнерах в слабый режим. |
| int [SharedCount](../object/sharedcount/)() const | Получает текущее значение совместного счетчика ссылок. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Увеличивает счетчик совместных ссылок. Не следует вызывать напрямую; вместо этого используйте умные указатели или ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Уменьшает и возвращает счетчик совместных ссылок. Не следует вызывать напрямую; вместо этого используйте умные указатели или ThisProtector. |
