...
type: docs
weight: 2107
url: /ru/system/operator_greater_equal/
---
...
Определяет, является ли указанное значение больше или равно значению, представленному указанным объектом [Nullable](../nullable/), применив [operator>=()](./) к этим значениям.
...
| other | const [Nullable](../nullable/)\<T2\>\& | Константная ссылка на объект [Nullable](../nullable/), значение которого будет использоваться в качестве второго сравниваемого |

### Возвращаемое значение

True, если первый сравниваемый элемент больше или равен второму сравниваемому элементу, в противном случае — false
