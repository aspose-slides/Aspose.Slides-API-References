...
description: "UnauthorizedAccessException вызывается, когда доступ отклонён операционной системой из-за ошибки ввода-вывода или ошибки безопасности. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс UnauthorizedAccessException. Никогда не оборачивайте экземпляры класса UnauthorizedAccessException в System::SmartPtr."
type: docs
weight: 755
url: /ru/system/details_unauthorizedaccessexception/
---
## Details_UnauthorizedAccessException класс

UnauthorizedAccessException вызывается, когда доступ отклонён операционной системой из-за ошибки ввода-вывода или ошибки безопасности. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс UnauthorizedAccessException. Никогда не оборачивайте экземпляры класса UnauthorizedAccessException в [System::SmartPtr](../smartptr/).
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Аналог метода C# [Object.GetHashCode()](../object/gethashcode/). Позволяет вычислять хеш пользовательских объектов. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й параметр шаблона в слабый указатель (а не shared). Позволяет переключать указатели в контейнерах в режим weak. |
