...
description: "NullReferenceException выбрасывается, когда происходит попытка разименования нулевой ссылки. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс NullReferenceException. Никогда не оборачивайте экземпляры класса NullReferenceException в System::SmartPtr."
type: docs
weight: 599
url: /ru/system/details_nullreferenceexception/
---
## Details_NullReferenceException класс
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Устанавливает HRESULT, кодовое численное значение, назначаемое конкретному исключению. |
