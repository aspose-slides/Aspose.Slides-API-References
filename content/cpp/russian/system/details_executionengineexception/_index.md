...
description: ExecutionEngineException присутствует только по соображениям совместимости.
type: docs
weight: 456
url: /ru/system/details_executionengineexception/
---
## Details_ExecutionEngineException класс

ExecutionEngineException присутствует только по соображениям совместимости.
