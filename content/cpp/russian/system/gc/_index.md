...
description: Представляет эмулированную сборку мусора, которая фактически является заглушкой и ничего не делает. Это статический тип без сервисов экземпляра. Вы никогда не должны создавать его экземпляры ни при каких обстоятельствах.
type: docs
weight: 872
url: /ru/system/gc/
---
...
| static **int64_t** [GetTotalAllocatedBytes](./gettotalallocatedbytes/)(**bool**) | Возвращает общее количество выделенных байтов. |
| static **int64_t** [GetTotalMemory](./gettotalmemory/)(**bool**) | Возвращает количество байтов частной памяти, в данный момент выделенной текущим процессом. |
...
| int [SharedCount](../object/sharedcount/)() const | Получает текущее значение счетчика совместных ссылок. |
