...
description: "FormatException бросается, когда формат аргумента метода недействителен. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс FormatException. Никогда не оборачивайте экземпляры класса FormatException в System::SmartPtr."
type: docs
weight: 469
url: /ru/system/details_formatexception/
---
## Details_FormatException класс

FormatException бросается, когда формат аргумента метода недействителен. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс FormatException. Никогда не оборачивайте экземпляры класса FormatException в [System::SmartPtr](../smartptr/).
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный аргумент как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в слабый режим. |
