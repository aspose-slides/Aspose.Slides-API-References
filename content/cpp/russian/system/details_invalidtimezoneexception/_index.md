...
description: "InvalidTimeZoneException генерируется, когда информация о часовом поясе недействительна. Никогда не создавайте экземпляры этого класса вручную. Используйте класс InvalidTimeZoneException. Никогда не оборачивайте экземпляры класса InvalidTimeZoneException в System::SmartPtr."
type: docs
weight: 534
url: /ru/system/details_invalidtimezoneexception/
---
## Details_InvalidTimeZoneException класс

InvalidTimeZoneException генерируется, когда информация о часовом поясе недействительна. Никогда не создавайте экземпляры этого класса вручную. Используйте класс InvalidTimeZoneException. Никогда не оборачивайте экземпляры класса InvalidTimeZoneException в [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Эмулирует сравнение чисел с плавающей запятой в стиле C#, при котором два NaN считаются равными, хотя согласно IEC 60559:1989 NaN не равен ни одному значению, включая NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Эмулирует сравнение чисел с плавающей запятой в стиле C#, при котором два NaN считаются равными, хотя согласно IEC 60559:1989 NaN не равен ни одному значению, включая NaN. |
...
| void [Lock](../object/lock/)() | Реализует блокировку, аналогичную оператору C# lock(). Вызывайте непосредственно или используйте объект-страж [LockContext](../lockcontext/). |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | Сравнивает по ссылке объект типa значения с nullptr. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Устанавливает HRESULT, кодовое числовое значение, назначаемое конкретному исключению. |
...
| void [Unlock](../object/unlock/)() | Реализует разблокировку, аналогичную оператору C# lock(). Вызывайте непосредственно или используйте объект-страж [LockContext](../lockcontext/). |
