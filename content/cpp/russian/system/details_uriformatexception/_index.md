...
description: "UriFormatException выбрасывается, когда формат URI недействителен. Никогда не создавайте экземпляры этого класса вручную. Используйте класс UriFormatException. Никогда не помещайте экземпляры класса UriFormatException в System::SmartPtr."
type: docs
weight: 768
url: /ru/system/details_uriformatexception/
---
## Details_UriFormatException класс

UriFormatException выбрасывается, когда формат URI недействителен. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс UriFormatException. Никогда не помещайте экземпляры класса UriFormatException в [System::SmartPtr](../smartptr/).
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й параметр шаблона как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в слабый режим. |
...
* Класс [Details_FormatException](../details_formatexception/)
