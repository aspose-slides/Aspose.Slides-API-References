...
description: "PlatformNotSupportedException генерируется, когда функция не работает на определённой платформе. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс PlatformNotSupportedException. Никогда не оборачивайте экземпляры класса PlatformNotSupportedException в System::SmartPtr."
type: docs
weight: 664
url: /ru/system/details_platformnotsupportedexception/
---
## Details_PlatformNotSupportedException класс


PlatformNotSupportedException генерируется, когда функция не работает на определённой платформе. Никогда не создавайте экземпляры этого класса вручную. Используйте вместо этого класс PlatformNotSupportedException. Никогда не оборачивайте экземпляры класса PlatformNotSupportedException в [System::SmartPtr](../smartptr/).
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона в виде слабой ссылки (а не общей). Позволяет переключать указатели в контейнерах в режим слабых ссылок. |
| int [SharedCount](../object/sharedcount/)() const | Получает текущее значение счётчика общих ссылок. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Увеличивает количество общих ссылок. Не следует вызывать напрямую; вместо этого используйте умные указатели или ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Уменьшает и возвращает количество общих ссылок. Не следует вызывать напрямую; вместо этого используйте умные указатели или ThisProtector. |
...
* Класс [Details_NotSupportedException](../details_notsupportedexception/)
