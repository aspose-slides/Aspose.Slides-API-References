...
description: "TimeZoneNotFoundException выбрасывается, когда информация о часовом поясе не найдена. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс TimeZoneNotFoundException. Никогда не помещайте экземпляры класса TimeZoneNotFoundException в System::SmartPtr."
type: docs
weight: 729
url: /ru/system/details_timezonenotfoundexception/
---
## Details_TimeZoneNotFoundException класс


TimeZoneNotFoundException выбрасывается, когда информация о часовом поясе не найдена. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс TimeZoneNotFoundException. Никогда не помещайте экземпляры класса TimeZoneNotFoundException в [System::SmartPtr](../smartptr/).
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный аргумент как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим weak. |
