...
description: "InvalidCastException генерируется, когда попытка выполнить недопустимую операцию приведения недопустимого явного преобразования. Никогда не создавайте экземпляры этого класса вручную. Используйте класс InvalidCastException. Никогда не оборачивайте экземпляры класса InvalidCastException в System::SmartPtr."
type: docs
weight: 495
url: /ru/system/details_invalidcastexception/
---
## Details_InvalidCastException класс


InvalidCastException генерируется, когда происходит недопустимая операция приведения при попытке выполнить недопустимое явное преобразование. Никогда не создавайте экземпляры этого класса вручную. Используйте класс InvalidCastException. Никогда не оборачивайте экземпляры класса InvalidCastException в [System::SmartPtr](../smartptr/).
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Устанавливает HRESULT, закодированное численное значение, присваиваемое конкретному исключению. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный параметр как слабый указатель (а не общий). Позволяет переключать указатели в контейнерах в режим слабых. |
