...
type: docs
weight: 170
url: /ru/system/nullable/operator_less/
---
...
Определяет, является ли значение, представленное текущим объектом, меньше указанного значения, применяя [operator<()](./) к этим значениям.
...
Определяет, является ли значение, представленное текущим объектом, меньше значения, представленного указанным объектом [Nullable](../), применяя [operator<()](./) к этим значениям.
