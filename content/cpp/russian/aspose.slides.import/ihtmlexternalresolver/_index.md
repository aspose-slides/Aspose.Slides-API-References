...
description: Интерфейс обратного вызова, используемый процедурой импорта HTML для получения ссылочных объектов, таких как изображения.
type: docs
weight: 53
url: /ru/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver класс
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | Отображает URI на объект, содержащий реальный ресурс. |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | Разрешает абсолютный URI из базового и относительных URI. |
...
Устарело
:   Устаревший. Используйте [IExternalResourceResolver](../iexternalresourceresolver/) вместо него. Будет удалён в выпуске 17.12.

## Смотрите также

* Класс [IExternalResourceResolver](../iexternalresourceresolver/)
