...
| **bool** [get_DetectTables](./get_detecttables/)() const | Определяет, следует ли обнаруживать таблицы при импорте PDF-файла. |
...
| void [set_DetectTables](./set_detecttables/)(**bool**) | Определяет, следует ли обнаруживать таблицы при импорте PDF-файла. |
