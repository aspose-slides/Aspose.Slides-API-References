...
description: Класс-обратный вызов, используемый для разрешения внешних ресурсов при импорте документов Html, Svg.
type: docs
weight: 14
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) override | Отображает URI на объект, содержащий фактический ресурс. |
...
| [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Разрешает абсолютный URI из базового и относительных URI. |
...
Использование этого разрешителя может создать уязвимость, когда клиент предоставил HTML или SVG файл, заставляющий серверный софт получать локальные или сетевые файлы. Используйте с осторожностью. Рекомендуется полностью отключить [ExternalResourceResolver](./) (будут читаться только встроенные объекты) или создать подкласс, который проверяет, валиден ли указанный URI.
## See Also

* Class [IExternalResourceResolver](../iexternalresourceresolver/)
