...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)\> [CreateOleTypeLibReference](./createoletypelibreference/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Создает новую ссылку на библиотеку типов OLE Automation. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaReferenceFactory](./)\> [get_Instance](./get_instance/)() | Статический экземпляр фабрики ссылок проекта VBA. Только для чтения [VbaReferenceFactory](./). |
...
* Класс [IVbaReferenceFactory](../ivbareferencefactory/)
