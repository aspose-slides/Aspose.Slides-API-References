...
---
## IVbaReferenceOleTwiddledTypeLib класс

Представляет изменённую ссылку на библиотеку типов OLE Automation, в которой все элементы управления помечены как расширяемые.
...
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | Представляет имя ссылки на проект VBA. Чтение [System::String](../../system/string/). |
...
| virtual void [set_Name](../ivbareference/set_name/)([System::String](../../system/string/)) | Представляет имя ссылки на проект VBA. Запись [System::String](../../system/string/). |
