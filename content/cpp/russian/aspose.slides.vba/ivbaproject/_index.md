...
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | Указывает, защищён ли VBAProject паролем для просмотра свойств проекта. Только для чтения **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) | Возвращает модуль, содержащийся в VBA проекте, по указанному индексу. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() | Возвращает список всех модулей, содержащихся в VBA проекте. Только для чтения [IVbaModuleCollection](../ivbamodulecollection/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Возвращает имя VBA проекта. Только для чтения [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) | Возвращает ссылку, содержащуюся в VBA проекте, по указанному индексу. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() | Возвращает список всех ссылок, содержащихся в VBA проекте. Только для чтения [IVbaReferenceCollection](../ivbareferencecollection/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й параметр шаблона в слабый указатель (а не разделяемый). Позволяет переключать указатели в контейнерах в режим слабых. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() | Возвращает двоичное представление VBA проекта в виде OLE контейнера. Только для чтения **uint8_t**[]. |
