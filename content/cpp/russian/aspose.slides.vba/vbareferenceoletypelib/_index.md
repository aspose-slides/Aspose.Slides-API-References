...
| [System::String](../../system/string/) [get_Libid](./get_libid/)() override | Представляет идентификатор библиотеки типов Automation. Читать [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Представляет имя ссылки на проект VBA. Читать [System::String](../../system/string/). |
...
| void [set_Libid](./set_libid/)([System::String](../../system/string/)) override | Представляет идентификатор библиотеки типов Automation. Запишите [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Представляет имя ссылки на проект VBA. Запишите [System::String](../../system/string/). |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Реализует конструктцию C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывайте напрямую или используйте объект-страж [LockContext](../../system/lockcontext/). |
|  [VbaReferenceOleTypeLib](./vbareferenceoletypelib/)([System::String](../../system/string/), [System::String](../../system/string/)) | Этот конструктор создаёт новую ссылку на библиотеку типов OLE Automation. |
...
* Класс [IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)
