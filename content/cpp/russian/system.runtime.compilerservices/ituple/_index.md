...
description: Определяет реализацию общего назначения Tuple, позволяющую получать доступ к членам экземпляра Tuple без знания базового типа Tuple.
type: docs
weight: 53
url: /ru/system.runtime.compilerservices/ituple/
---
## ITuple класс

Определяет реализацию общего назначения [Tuple](../../system/tuple/), позволяющую получать доступ к членам экземпляра [Tuple](../../system/tuple/) без знания базового типа [Tuple](../../system/tuple/).
...
| virtual **int32_t** [get_Length](./get_length/)() const | Возвращает количество позиций в этой структуре данных. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | Возвращает элемент в позиции index. |
...
* Пространство имён [System::Runtime::CompilerServices](../)
