...
description: Возвращает подробную информацию о последнем исключении.
type: docs
weight: 1
url: /ru/system.xml/details_xmlexception/
---
## Details_XmlException класс
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Возвращает номер строки, указывающий, где произошла ошибка. Номера строк начинаются с 1. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Возвращает позицию в строке, указывающую, где произошла ошибка. Позиция в строке начинается с 1. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Возвращает сообщение, описывающее текущее исключение. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Возвращает расположение XML-файла. |
...
| Typedef | Description |
| --- | --- |
| [Ptr](./ptr/) | Псевдоним для умного указателя (shared pointer) на экземпляр этого класса. |
