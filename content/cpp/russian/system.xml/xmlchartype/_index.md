...
description: Для внутренних целей. Не используйте этот класс напрямую.
type: docs
weight: 131
url: /ru/system.xml/xmlchartype/
---
## XmlCharType класс


Для внутренних целей. Не используйте этот класс напрямую.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n'tй аргумент шаблона как слабый указатель (вместо совместного). Позволяет переключать указатели в контейнерах в режим слабых. |
