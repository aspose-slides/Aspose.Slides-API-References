...
description: Реализует однопоточный XmlNameTable.
type: docs
weight: 66
url: /ru/system.xml/nametable/
---
## NameTable класс
...
| Метод | Описание |
| --- | --- |
| const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) override | Атомизирует указанную строку и добавляет её в [NameTable](./). |
| const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | Атомизирует указанную строку и добавляет её в [NameTable](./). |
...
| const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) override | Возвращает атомизированную строку с указанным значением. |
| const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | Возвращает атомизированную строку, содержащую те же символы, что и указанный диапазон символов в данном массиве. |
