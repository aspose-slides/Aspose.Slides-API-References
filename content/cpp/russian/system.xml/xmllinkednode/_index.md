...
description: Возвращает узел, непосредственно предшествующий или следующий за этим узлом.
type: docs
weight: 274
url: /ru/system.xml/xmllinkednode/
---
## XmlLinkedNode класс
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Получает итератор, указывающий на первый элемент (если он есть) коллекции. Этот итератор нельзя использовать для изменения ссылки на объект, потому что [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) возвращает копию объекта T. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Получает итератор, указывающий на первый константно-квалифицированный элемент (если он есть) коллекции. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Получает итератор, указывающий сразу после последнего константно-квалифицированного элемента (если он есть) коллекции. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Создаёт дубликат этого узла. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Создаёт дубликат узла, когда переопределено в производном классе. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Возвращает узел, сразу следующий за этим узлом. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Возвращает узел, сразу предшествующий этому узлу. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | Возвращает текстовый узел, который сразу предшествует этому узлу. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Возвращает перечислитель, проходящий через дочерние узлы текущего узла. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Ищет ближайшее объявление **xmlns** для указанного префикса, действующее для текущего узла, и возвращает URI пространства имён из объявления. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Ищет ближайшее объявление **xmlns** для указанного URI пространства имён, действующее для текущего узла, и возвращает префикс, определенный в этом объявлении. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](../xmlnode/insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Вставляет указанный узел сразу после указанного эталонного узла. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](../xmlnode/insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Вставляет указанный узел сразу перед указанным эталонным узлом. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Переводит все [XmlText](../xmltext/) узлы на полной глубине поддерева под этим [XmlNode](../xmlnode/) в «нормальную» форму, где только разметка (теги, комментарии, инструкции обработки, секции CDATA и ссылки на сущности) разделяют [XmlText](../xmltext/) узлы, то есть рядом не находятся [XmlText](../xmltext/) узлы. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывать напрямую или использовать объект-страж [LockContext](../../system/lockcontext/). |
