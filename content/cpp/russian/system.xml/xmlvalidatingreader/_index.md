...
description: Представляет читатель, который обеспечивает проверку определения типа документа (DTD), схемы XML-Data Reduced (XDR) и языка определения схем XML (XSD).
type: docs
weight: 547
url: /ru/system.xml/xmlvalidatingreader/
---
## XmlValidatingReader класс
