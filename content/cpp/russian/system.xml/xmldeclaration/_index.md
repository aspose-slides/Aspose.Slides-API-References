...
description: Представляет узел объявления XML <?xml version='1.0'...?>.
type: docs
weight: 170
url: /ru/system.xml/xmldeclaration/
---
## XmlDeclaration класс
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Получает итератор, указывающий на первый элемент, квалифицированный как const (если он существует) в коллекции. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Получает итератор, указывающий сразу после последнего элемента, квалифицированного как const (если он существует) в коллекции. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Получает итератор, указывающий сразу после последнего элемента (если он есть) в экземпляре коллекции, квалифицированном как const. |
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | Возвращает уровень кодировки XML-документа. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Возвращает объединённые значения [XmlDeclaration](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Возвращает набор информации о проверке схемы после её применения, присвоенный этому узлу в результате валидации схемы. |
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | Возвращает значение атрибута standalone. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Возвращает значение [XmlDeclaration](./). |
| [String](../../system/string/) [get_Version](./get_version/)() | Возвращает версию XML документа. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру счётчика ссылок, связанную с объектом. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Возвращает перечислитель, который итерирует через дочерние узлы текущего узла. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Возвращает первый дочерний элемент со значениями [XmlNode::get_LocalName](../xmlnode/get_localname/) и [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](../xmlnode/insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Вставляет указанный узел сразу после указанного узла-референса. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](../xmlnode/insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Вставляет указанный узел сразу перед указанным узлом-референсом. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Возвращает количество элементов в последовательности (рассчитанное путём прямого подсчёта). |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Переводит все [XmlText](../xmltext/)-узлы полной глубины поддерева под данным [XmlNode](../xmlnode/) в «нормальную» форму, где только разметка (теги, комментарии, инструкции обработки, CDATA-секции и ссылки на сущности) отделяет [XmlText](../xmltext/)-узлы, то есть рядом не находятся [XmlText](../xmltext/)-узлы. |
...
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | Устанавливает уровень кодировки XML-документа. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Устанавливает объединённые значения [XmlDeclaration](./). |
...
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | Устанавливает значение атрибута standalone. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Устанавливает значение [XmlDeclaration](./). |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Сохраняет дочерние узлы узла в указанный [XmlWriter](../xmlwriter/). Поскольку у узлов [XmlDeclaration](./) нет дочерних узлов, этот метод не оказывает влияния. |
