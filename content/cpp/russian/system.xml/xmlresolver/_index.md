...
description: Разрешает внешние XML-ресурсы, указанные Униформным Идентификатором Ресурса (URI).
type: docs
weight: 456
url: /ru/system.xml/xmlresolver/
---
## XmlResolver класс

Разрешает внешние XML-ресурсы, указанные Униформным Идентификатором Ресурса (URI).
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetEntity](./getentity/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), const [TypeInfo](../../system/typeinfo/)\&) | При переопределении в производном классе отображает URI на объект, содержащий фактический ресурс. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) | При переопределении в производном классе разрешает абсолютный URI из базового и относительных URI. |
| virtual void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) | При переопределении в производном классе задаёт учётные данные, используемые для аутентификации веб-запросов. |
...
| virtual **bool** [SupportsType](./supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | Позволяет резольверу возвращать типы, отличные от Stream. |
...
| Тип | Описание |
| --- | --- |
| [Ptr](./ptr/) | Псевдоним совместного указателя на экземпляр этого класса. |
