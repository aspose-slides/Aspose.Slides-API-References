...
description: Позволяет классу возвращать XmlNode из текущего контекста или позиции.
type: docs
weight: 27
url: /ru/system.xml/ihasxmlnode/
---
## IHasXmlNode класс
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNode](./getnode/)() | Возвращает [XmlNode](../xmlnode/) для текущей позиции. |
