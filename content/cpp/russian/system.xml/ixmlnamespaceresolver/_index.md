...
description: Обеспечивает доступ только для чтения к набору соответствий префиксов и пространств имён.
type: docs
weight: 53
url: /ru/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver класс

Обеспечивает доступ только для чтения к набору соответствий префиксов и пространств имён.
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | Возвращает URI пространства имён, сопоставленный с указанным префиксом. |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | Возвращает префикс, сопоставленный с указанным URI пространства имён. |
