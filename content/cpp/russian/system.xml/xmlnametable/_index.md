...
type: docs
weight: 313
url: /ru/system.xml/xmlnametable/
---
## XmlNameTable класс
...
| Method | Description |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Когда переопределяется в производном классе, атомизирует указанную строку и добавляет её в [XmlNameTable](./). |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | Когда переопределяется в производном классе, атомизирует указанную строку и добавляет её в [XmlNameTable](./). |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Когда переопределяется в производном классе, получает атомизированную строку, содержащую те же символы, что и указанный диапазон символов в данном массиве. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | Когда переопределяется в производном классе, получает атомизированную строку, содержащую то же значение, что и указанная строка. |
