...
description: Предоставляет методы манипуляции текстом, используемые несколькими классами.
type: docs
weight: 118
url: /ru/system.xml/xmlcharacterdata/
---
## XmlCharacterData класс
...
| virtual void [AppendData](./appenddata/)([String](../../system/string/)) | Добавляет указанную строку в конец символьных данных узла. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Получает итератор, указывающий на первый элемент (если он есть) коллекции. Этот итератор нельзя использовать для изменения объекта, потому что [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) возвращает копию объекта типа T. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Получает итератор, указывающий на первый элемент, квалифицированный как const (если он есть), коллекции. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Получает итератор, указывающий сразу после последнего элемента, квалифицированного как const (если он есть), коллекции. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Создает дубликат этого узла. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Создает дубликат узла, когда переопределено в производном классе. |
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](../xmlnode/createnavigator/)() override | Создает XPathNavigator для навигации этим объектом. |
| virtual void [DeleteData](./deletedata/)(**int32_t**, **int32_t**) | Удаляет диапазон символов из узла. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Получает итератор, указывающий сразу после последнего элемента (если он есть) коллекции. Этот итератор нельзя использовать для изменения объекта, потому что [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) возвращает копию объекта типа T. |
...
| virtual [String](../../system/string/) [get_Data](./get_data/)() | Возвращает данные узла. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Возвращает объединённые значения узла и всех его дочерних узлов. |
...
| virtual **int32_t** [get_Length](./get_length/)() | Возвращает длину данных в символах. |
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | Возвращает локальное имя узла, когда переопределено в производном классе. |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | Возвращает квалифицированное имя узла, когда переопределено в производном классе. |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | Возвращает тип текущего узла, когда переопределено в производном классе. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Возвращает родителя этого узла (для узлов, которые могут иметь родителей). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Возвращает набор сведений после проверки схемы, который был присвоен этому узлу в результате валидации схемы. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Возвращает значение узла. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру счётчика ссылок, связанную с объектом. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Возвращает перечислитель, обходящий дочерние узлы текущего узла. |
...
| virtual void [InsertData](./insertdata/)(**int32_t**, [String](../../system/string/)) | Вставляет указанную строку в указанное смещение символов. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Проектирует каждый элемент последовательности и объединяет полученные последовательности в одну. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Размещает все узлы [XmlText](../xmltext/) на полной глубине поддерева под этим [XmlNode](../xmlnode/) в «нормальную» форму, где только разметка (т.е. теги, комментарии, инструкции обработки, секции CDATA и ссылки на сущности) разделяют узлы [XmlText](../xmltext/), то есть нет соседних узлов [XmlText](../xmltext/). |
|  [Object](../../system/object/object/)() | Создаёт объект. Инициализирует все внутренние структуры данных. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const&) | Конструктор копирования. На самом деле ничего не копирует, просто инициализирует новый объект и позволяет выполнять copy-конструирование подклассов. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const&) | Оператор присваивания. На самом деле ничего не копирует, просто инициализирует новый объект и позволяет выполнять copy-конструирование подклассов. |
...
| virtual void [ReplaceData](./replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Заменяет указанное количество символов, начиная с заданного смещения, указанной строкой. |
...
| virtual void [set_Data](./set_data/)([String](../../system/string/)) | Устанавливает данные узла. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Устанавливает объединённые значения узла и всех его дочерних узлов. |
...
| virtual [String](../../system/string/) [Substring](./substring/)(**int32_t**, **int32_t**) | Получает подстроку полной строки из указанного диапазона. |
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Проверяет, реализует ли реализация DOM определённую возможность. |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Сохраняет все дочерние узлы узла в указанный [XmlWriter](../xmlwriter/), когда переопределено в производном классе. |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Сохраняет текущий узел в указанный [XmlWriter](../xmlwriter/), когда переопределено в производном классе. |
