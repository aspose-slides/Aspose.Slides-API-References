...
description: Содержит коллекцию экземпляров класса SoapHeader.
type: docs
weight: 105
url: /ru/system.web.services.protocols/soapheadercollection/
---
## SoapHeaderCollection класс

Содержит коллекцию экземпляров класса [SoapHeader](../soapheader/).
...
| void [CopyTo](../../system.collections.generic/list/copyto/)(int, const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&, int, int) | Копирует элементы, начиная с заданного индекса, в существующие элементы массива. |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | Получает обратный итератор к последнему константному элементу коллекции (первому в обратном порядке). |
...
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | Проверяет, существует ли элемент, соответствующий определенному предикату, в списке. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Только для внутренних целей. |
| T [Find](../../system.collections.generic/list/find/)([System::Predicate](../../system/predicate/)\<T\>) | Ищет элемент, соответствующий определенному предикату. |
| [ListPtr](../../system.collections.generic/listptr/)\<T\> [FindAll](../../system.collections.generic/list/findall/)([System::Predicate](../../system/predicate/)\<T\>) | Ищет элементы, соответствующие определенному предикату. |
| int [FindIndex](../../system.collections.generic/list/findindex/)([System::Predicate](../../system/predicate/)\<T\>) | Ищет элемент, соответствующий определенному предикату. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, [System::Predicate](../../system/predicate/)\<T\>) | Ищет элемент, соответствующий определенному предикату. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, int, [System::Predicate](../../system/predicate/)\<T\>) | Ищет элемент, соответствующий определенному предикату. |
| T [FindLast](../../system.collections.generic/list/findlast/)([System::Predicate](../../system/predicate/)\<T\>) | Ищет последний элемент, соответствующий определенному предикату. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() const | Получает обратный итератор к последнему элементу константной коллекции (первому в обратном порядке). |
...
| int [RemoveAll](../../system.collections.generic/list/removeall/)([Predicate](../../system/predicate/)\<T\>) | Удаляет все элементы, соответствующие указанному предикату. |
...
| void [Reverse](../../system.collections.generic/list/reverse/)() | Разворачивает порядок элементов всего списка. |
| void [Reverse](../../system.collections.generic/list/reverse/)(int, int) | Разворачивает порядок элементов среза списка. |
...
|  [SoapHeaderCollection](./soapheadercollection/)() | Инициализирует новый экземпляр класса [SoapHeaderCollection](./). |
...
| void [TrimExcess](../../system.collections.generic/list/trimexcess/)() | Устанавливает ёмкость списка в соответствие с её размером. |
| **bool** [TrueForAll](../../system.collections.generic/list/trueforall/)([System::Predicate](../../system/predicate/)\<T\>) | Определяет, соответствуют ли все элементы в коллекции условиям, заданным указанным предикатом. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Реализует конструкцию C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывайте напрямую или используйте объект-страж [LockContext](../../system/lockcontext/). |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../../system.collections.generic/list/virtualizebeginconstiterator/)() const override | Получает реализацию const-итератора begin для текущего контейнера. |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../../system.collections.generic/list/virtualizeendconstiterator/)() const override | Получает реализацию const-итератора end для текущего контейнера. |
