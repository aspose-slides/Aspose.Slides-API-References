...
| [String](../../system/string/) [get_Actor](./get_actor/)() | Получает URI получателя заголовка SOAP, когда используется версия SOAP 1.1. |
| **bool** [get_DidUnderstand](./get_didunderstand/)() | Возвращает значение, указывающее, правильно ли обработан заголовок SOAP. |
| [String](../../system/string/) [get_EncodedMustUnderstand](./get_encodedmustunderstand/)() | Получает значение атрибута 'mustUnderstand', когда используется версия SOAP 1.1. |
| [String](../../system/string/) [get_EncodedMustUnderstand12](./get_encodedmustunderstand12/)() | Получает значение атрибута 'mustUnderstand', когда используется версия SOAP 1.2. |
| [String](../../system/string/) [get_EncodedRelay](./get_encodedrelay/)() | Получает строковое представление значения атрибута 'relay'. |
| **bool** [get_MustUnderstand](./get_mustunderstand/)() | Возвращает значение, указывающее, должен ли заголовок SOAP быть понят. |
| **bool** [get_Relay](./get_relay/)() | Получает значение атрибута 'relay'. |
| [String](../../system/string/) [get_Role](./get_role/)() | Получает URI получателя заголовка SOAP, когда используется версия SOAP 1.2. |
...
| void [set_Actor](./set_actor/)([String](../../system/string/)) | Устанавливает URI получателя заголовка SOAP, когда используется версия SOAP 1.1. |
| void [set_DidUnderstand](./set_didunderstand/)(**bool**) | Устанавливает значение, указывающее, правильно ли обработан заголовок SOAP. |
| void [set_EncodedMustUnderstand](./set_encodedmustunderstand/)([String](../../system/string/)) | Устанавливает значение атрибута 'mustUnderstand', когда используется версия SOAP 1.1. |
| void [set_EncodedMustUnderstand12](./set_encodedmustunderstand12/)([String](../../system/string/)) | Устанавливает значение атрибута 'mustUnderstand', когда используется версия SOAP 1.2. |
| void [set_EncodedRelay](./set_encodedrelay/)([String](../../system/string/)) | Устанавливает строковое представление значения атрибута 'relay'. |
| void [set_MustUnderstand](./set_mustunderstand/)(**bool**) | Устанавливает значение, указывающее, должен ли заголовок SOAP быть понят. |
| void [set_Relay](./set_relay/)(**bool**) | Устанавливает значение атрибута 'relay'. |
| void [set_Role](./set_role/)([String](../../system/string/)) | Устанавливает URI получателя заголовка SOAP, когда используется версия SOAP 1.2. |
...
|  [SoapHeader](./soapheader/)([System::SharedPtr](../../system/sharedptr/)\<[Xml::XmlElement](../../system.xml/xmlelement/)\>) | Создаёт новый экземпляр. |
