...
description: Представляет элемент notation из XML Schema, как указано World Wide Web Consortium (W3C). Объявление XML Schemanotation представляет собой реконструкцию объявлений XML 1.0 NOTATION. Цель нотаций — описать формат данных, не являющихся XML, внутри XML-документа.
type: docs
weight: 651
url: /ru/system.xml.schema/xmlschemanotation/
---
## XmlSchemaNotation класс

Представляет элемент **notation** из XML [Schema](../), указанный Консорциумом World Wide [Web](../../system.web/) (W3C). Объявление XML [Schema](../)**notation** является реконструкцией объявлений **XML** 1.0 NOTATION. Цель нотаций — описать формат данных, не являющихся XML, внутри XML-документа.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Возвращает имя нотации. |
...
| [String](../../system/string/) [get_Public](./get_public/)() | Возвращает идентификатор **public**. |
...
| [String](../../system/string/) [get_System](./get_system/)() | Возвращает идентификатор **system**. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Устанавливает имя нотации. |
...
| void [set_Public](./set_public/)(const [String](../../system/string/)\&) | Устанавливает идентификатор **public**. |
...
| void [set_System](./set_system/)(const [String](../../system/string/)\&) | Устанавливает идентификатор **system**. |
