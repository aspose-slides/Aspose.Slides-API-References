...
description: Предоставляет параметры компиляции схем для класса XmlSchemaSet. Этот класс не может быть унаследован.
type: docs
weight: 248
url: /ru/system.xml.schema/xmlschemacompilationsettings/
---
## XmlSchemaCompilationSettings класс
...
| **bool** [get_EnableUpaCheck](./get_enableupacheck/)() | Возвращает значение, указывающее, должен ли [XmlSchemaSet](../xmlschemaset/) проверять нарушения Unique Particle Attribution (UPA). |
...
| void [set_EnableUpaCheck](./set_enableupacheck/)(**bool**) | Устанавливает значение, указывающее, должен ли [XmlSchemaSet](../xmlschemaset/) проверять нарушения Unique Particle Attribution (UPA). |
...
|  [XmlSchemaCompilationSettings](./xmlschemacompilationsettings/)() | Инициализирует новый экземпляр класса [XmlSchemaCompilationSettings](./). |
