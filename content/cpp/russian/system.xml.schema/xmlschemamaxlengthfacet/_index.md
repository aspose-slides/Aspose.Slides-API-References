...
description: Представляет элемент maxLength из XML Schema, как указано World Wide Web Consortium (W3C). Этот класс может использоваться для указания ограничения на максимальную длину значения данных элемента simpleType. Длина должна быть меньше значения элемента maxLength.
type: docs
weight: 599
url: /ru/system.xml.schema/xmlschemamaxlengthfacet/
---
## XmlSchemaMaxLengthFacet класс


Представляет элемент **maxLength** из XML [Schema](../) как указано консорциумом World Wide [Web](../../system.web/) (W3C). Этот класс может использоваться для указания ограничения на максимальную длину значения данных элемента **simpleType**. Длина должна быть меньше значения элемента **maxLength**.
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Возвращает идентификатор строки. |
