...
description: Представляет элемент anyAttribute консорциума World Wide Web (W3C).
type: docs
weight: 144
url: /ru/system.xml.schema/xmlschemaanyattribute/
---
## XmlSchemaAnyAttribute класс

Представляет элемент **anyAttribute** World Wide [Web](../../system.web/) Consortium (W3C).
...
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Возвращает пространства имён, содержащие атрибуты, которые могут быть использованы. |
...
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | Возвращает информацию о том, как приложение или XML-процессор должны обрабатывать проверку XML-документов для атрибутов, указанных в элементе **anyAttribute**. |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Устанавливает пространства имён, содержащие атрибуты, которые могут быть использованы. |
...
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | Устанавливает информацию о том, как приложение или XML-процессор должны обрабатывать проверку XML-документов для атрибутов, указанных в элементе **anyAttribute**. |
...
| Typedef | Описание |
| --- | --- |
| [Ptr](./ptr/) | Псевдоним для shared pointer на экземпляр этого класса. |
