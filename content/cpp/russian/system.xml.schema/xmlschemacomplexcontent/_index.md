...
description: Представляет элемент complexContent из XML Schema, как определено World Wide Web Consortium (W3C). Этот класс представляет модель сложного содержимого для сложных типов. Он содержит расширения или ограничения для сложного типа, который имеет либо только элементы, либо смешанное содержимое.
type: docs
weight: 261
url: /ru/system.xml.schema/xmlschemacomplexcontent/
---
## XmlSchemaComplexContent класс
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | Возвращает содержимое. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Возвращает строковый идентификатор. |
| **bool** [get_IsMixed](./get_ismixed/)() | Возвращает информацию, определяющую, имеет ли тип модель смешанного содержимого. |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | Возвращает номер строки в файле, на который указывает элемент **schema**. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Возвращает позицию символа в файле, на который указывает элемент **schema**. |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | Устанавливает содержимое. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Устанавливает строковый идентификатор. |
| void [set_IsMixed](./set_ismixed/)(**bool**) | Устанавливает информацию, определяющую, имеет ли тип модель смешанного содержимого. |
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | Устанавливает номер строки в файле, на который указывает элемент **schema**. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Устанавливает позицию символа в файле, на который указывает элемент **schema**. |
...
* Класс [XmlSchemaContentModel](../xmlschemacontentmodel/)
