...
description: Представляет элемент restriction для простых типов из XML Schema, как указано консорциумом World Wide Web Consortium (W3C). Этот класс может использоваться для ограничения элемента simpleType.
type: docs
weight: 872
url: /ru/system.xml.schema/xmlschemasimpletyperestriction/
---
## XmlSchemaSimpleTypeRestriction класс

Представляет элемент **restriction** для простых типов из XML [Schema](../), как указано консорциумом World Wide [Web](../../system.web/) (W3C). Этот класс может использоваться для ограничения элемента **simpleType**.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | Возвращает информацию о базовом типе. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Возвращает имя квалифицированного базового типа. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | Возвращает фасет [Xml](../../system.xml/)[Schema](../). |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Возвращает родительский элемент этого [XmlSchemaObject](../xmlschemaobject/). |
...
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Устанавливает информацию о базовом типе. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Устанавливает имя квалифицированного базового типа. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Устанавливает родительский элемент этого [XmlSchemaObject](../xmlschemaobject/). |
