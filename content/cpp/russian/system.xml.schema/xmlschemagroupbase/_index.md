...
description: Абстрактный класс для XmlSchemaAll, XmlSchemaChoice или XmlSchemaSequence.
type: docs
weight: 443
url: /ru/system.xml.schema/xmlschemagroupbase/
---
## XmlSchemaGroupBase класс

Абстрактный класс для [XmlSchemaAll](../xmlschemaall/), [XmlSchemaChoice](../xmlschemachoice/) или [XmlSchemaSequence](../xmlschemasequence/).
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() | Эта коллекция используется для добавления новых элементов в композитор. |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | Возвращает номер строки в файле, на который ссылается элемент **schema**. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Возвращает позицию столбца в файле, на который ссылается элемент **schema**. |
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | Возвращает максимальное количество вхождений частицы. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Возвращает число в виде строкового значения. Максимальное количество вхождений частицы. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | Возвращает минимальное количество вхождений частицы. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Возвращает число в виде строкового значения. Минимальное количество вхождений частицы. |
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку, аналог оператору C# lock(). Вызывайте напрямую или используйте объект-сторож [LockContext](../../system/lockcontext/). |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | Устанавливает номер строки в файле, на который ссылается элемент **schema**. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Устанавливает позицию столбца в файле, на который ссылается элемент **schema**. |
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Устанавливает максимально количество вхождений частицы. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Устанавливает число как строковое значение. Максимальное количество вхождений частицы. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Устанавливает минимальное количество вхождений частицы. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Устанавливает число как строковое значение. Минимальное количество вхождений частицы. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку, аналог оператору C# lock(). Вызывайте напрямую или используйте объект-сторож [LockContext](../../system/lockcontext/). |
