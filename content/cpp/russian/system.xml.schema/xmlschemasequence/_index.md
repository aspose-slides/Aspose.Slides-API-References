...
description: Представляет элемент последовательности (композитор) из XML-схемы, определённой World Wide Web Consortium (W3C). Последовательность требует, чтобы элементы в группе появлялись в указанном порядке внутри содержащего элемента.
type: docs
weight: 768
url: /ru/system.xml.schema/xmlschemasequence/
---
## XmlSchemaSequence класс
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Элементы, содержащиеся в композиторе. Коллекция [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaSequence](./) или [XmlSchemaAny](../xmlschemaany/). |
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Возвращает позицию в строке в файле, на который ссылается элемент **schema**. |
...
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Устанавливает позицию в строке в файле, на который ссылается элемент **schema**. |
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Устанавливает максимальное количество вхождений частицы. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Устанавливает родителя для этого [XmlSchemaObject](../xmlschemaobject/). |
...
* Класс [XmlSchemaGroupBase](../xmlschemagroupbase/)
