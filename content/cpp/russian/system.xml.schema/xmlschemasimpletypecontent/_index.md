...
description: Базовый класс для классов содержимого простых типов.
type: docs
weight: 846
url: /ru/system.xml.schema/xmlschemasimpletypecontent/
---
## XmlSchemaSimpleTypeContent класс
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Возвращает строковый id. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Устанавливает строковый id. |
