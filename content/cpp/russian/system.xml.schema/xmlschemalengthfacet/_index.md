...
description: Представляет фасет длины из XML Schema, как указано World Wide Web Consortium (W3C). Этот класс может использоваться для указания ограничения длины элемента simpleType в типе данных.
type: docs
weight: 560
url: /ru/system.xml.schema/xmlschemalengthfacet/
---
## XmlSchemaLengthFacet класс
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Возвращает родительский элемент данного [XmlSchemaObject](../xmlschemaobject/). |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Устанавливает родительский элемент данного [XmlSchemaObject](../xmlschemaobject/). |
