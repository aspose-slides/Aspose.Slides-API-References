...
description: Определяет набор информации после проверки схемы для проверенного XML-узла.
type: docs
weight: 40
url: /ru/system.xml.schema/ixmlschemainfo/
---
## IXmlSchemaInfo класс

Определяет набор информации после проверки схемы для проверенного XML-узла.
...
| virtual **bool** [get_IsDefault](./get_isdefault/)() | Возвращает значение, указывающее, был ли этот проверенный XML-узел установлен в результате применения значения по умолчанию во время проверки схемы XML [Schema](../) Definition Language (XSD). |
| virtual **bool** [get_IsNil](./get_isnil/)() | Возвращает значение, указывающее, является ли значение этого проверенного XML-узла **nil**. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | Возвращает динамический тип схемы для этого проверенного XML-узла. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | Возвращает скомпилированный [XmlSchemaAttribute](../xmlschemaattribute/), соответствующий этому проверенному XML-узлу. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | Возвращает скомпилированный [XmlSchemaElement](../xmlschemaelement/), соответствующий этому проверенному XML-узлу. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | Возвращает статический тип схемы XML [Schema](../) Definition Language (XSD) для этого проверенного XML-узла. |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | Возвращает значение XmlSchemaValidity этого проверенного XML-узла. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Задаёт n-й аргумент шаблона как слабый указатель (вместо общего). Позволяет переключать указатели в контейнерах в слабый режим. |
