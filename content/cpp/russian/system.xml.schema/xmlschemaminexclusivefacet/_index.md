...
description: Представляет элемент minExclusive из XML Schema, как указано World Wide Web Consortium (W3C). Этот класс может использоваться для указания ограничения на минимальное значение элемента simpleType. Значение элемента должно быть больше значения элемента minExclusive.
type: docs
weight: 612
url: /ru/system.xml.schema/xmlschemaminexclusivefacet/
---
## XmlSchemaMinExclusiveFacet класс


Представляет элемент **minExclusive** из XML [Schema](../) в соответствии со спецификацией World Wide [Web](../../system.web/) Consortium (W3C). Этот класс может использоваться для указания ограничения минимального значения элемента **simpleType**. Значение элемента должно быть больше значения элемента **minExclusive**.
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Возвращает позицию в строке файла, к которой относится элемент **schema**. |
