...
description: Класс-сосуд для определения числовых фасетов. Этот класс является базовым классом для классов числовых фасетов, таких как XmlSchemaMinLengthFacet.
type: docs
weight: 664
url: /ru/system.xml.schema/xmlschemanumericfacet/
---
## XmlSchemaNumericFacet класс

Класс-сосуд для определения **numeric** фасетов. Этот класс является базовым классом для классов числовых фасетов, таких как [XmlSchemaMinLengthFacet](../xmlschemaminlengthfacet/).
...
Объекты этого класса должны выделяться только с помощью функции [System::MakeObject()](../../system/makeobject/). Никогда не создавайте экземпляры этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или ошибкам утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](../../system/smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. 
