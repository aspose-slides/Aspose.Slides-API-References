...
description: Представляет элемент maxExclusive из XML Schema, указанный Всемирным консорциумом (W3C). Этот класс может использоваться для задания ограничения на максимальное значение элемента simpleType. Значение элемента должно быть меньше значения элемента maxExclusive.
type: docs
weight: 573
url: /ru/system.xml.schema/xmlschemamaxexclusivefacet/
---
## XmlSchemaMaxExclusiveFacet класс

Представляет элемент **maxExclusive** из XML [Schema](../), указанный Всемирным консорциумом [Web](../../system.web/) (W3C). Этот класс можно использовать для задания ограничения на максимальное значение элемента **simpleType**. Значение элемента должно быть меньше значения элемента **maxExclusive**.
...
|  [XmlSchemaMaxExclusiveFacet](./xmlschemamaxexclusivefacet/)() | Инициализирует новый экземпляр класса [XmlSchemaMaxExclusiveFacet](./). |
