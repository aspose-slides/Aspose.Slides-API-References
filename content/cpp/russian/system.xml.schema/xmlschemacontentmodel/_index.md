...
description: Определяет порядок и структуру дочерних элементов типа.
type: docs
weight: 326
url: /ru/system.xml.schema/xmlschemacontentmodel/
---
## XmlSchemaContentModel класс
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() | Возвращает содержимое типа. |
...
| virtual void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) | Устанавливает содержимое типа. |
