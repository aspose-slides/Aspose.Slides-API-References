...
description: Представляет элемент attributeGroup из XML Schema, определённый World Wide Web Consortium (W3C). AttributesGroups предоставляет механизм группировки набора объявлений атрибутов, чтобы их можно было включать как группу в определения сложных типов.
type: docs
weight: 183
url: /ru/system.xml.schema/xmlschemaattributegroup/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Возвращает компонент [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) группы атрибутов. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Возвращает коллекцию атрибутов для группы атрибутов. Содержит элементы [XmlSchemaAttribute](../xmlschemaattribute/) и [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Возвращает имя группы атрибутов. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Возвращает квалифицированное имя группы атрибутов. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttributeGroup](./)\> [get_RedefinedAttributeGroup](./get_redefinedattributegroup/)() | Возвращает переопределённое свойство группы атрибутов из XML [Schema](../). |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Устанавливает компонент [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) группы атрибутов. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Устанавливает имя группы атрибутов. |
