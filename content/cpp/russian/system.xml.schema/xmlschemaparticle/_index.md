...
description: Базовый класс, который является базовым классом для всех типов частиц (например, XmlSchemaAny).
type: docs
weight: 729
url: /ru/system.xml.schema/xmlschemaparticle/
---
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](./get_maxoccurs/)() | Возвращает максимальное количество вхождений частицы. |
| [String](../../system/string/) [get_MaxOccursString](./get_maxoccursstring/)() | Возвращает число в виде строкового значения. Максимальное количество вхождений частицы. |
| [Decimal](../../system/decimal/) [get_MinOccurs](./get_minoccurs/)() | Возвращает минимальное количество вхождений частицы. |
| [String](../../system/string/) [get_MinOccursString](./get_minoccursstring/)() | Возвращает число в виде строкового значения. Минимальное количество вхождений частицы. |
...
| void [set_MaxOccurs](./set_maxoccurs/)([Decimal](../../system/decimal/)) | Устанавливает максимальное количество вхождений частицы. |
| void [set_MaxOccursString](./set_maxoccursstring/)(const [String](../../system/string/)\&) | Устанавливает число в виде строкового значения. Максимальное количество вхождений частицы. |
| void [set_MinOccurs](./set_minoccurs/)([Decimal](../../system/decimal/)) | Устанавливает минимальное количество вхождений частицы. |
| void [set_MinOccursString](./set_minoccursstring/)(const [String](../../system/string/)\&) | Устанавливает число в виде строкового значения. Минимальное количество вхождений частицы. |
