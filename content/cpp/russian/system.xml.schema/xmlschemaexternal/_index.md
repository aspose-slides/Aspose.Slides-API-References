...
description: Предоставляет информацию о включенной схеме.
type: docs
weight: 391
url: /ru/system.xml.schema/xmlschemaexternal/
---
## XmlSchemaExternal класс

Предоставляет информацию о включенной схеме.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [get_Schema](./get_schema/)() | Возвращает [XmlSchema](../xmlschema/) для ссылочной схемы. |
| [String](../../system/string/) [get_SchemaLocation](./get_schemalocation/)() | Возвращает расположение Uniform Resource Identifier (URI) схемы, которое указывает процессору схемы, где физически находится схема. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](./get_unhandledattributes/)() | Возвращает квалифицированные атрибуты, которые не принадлежат целевому пространству имен схемы. |
...
| void [set_Schema](./set_schema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Устанавливает [XmlSchema](../xmlschema/) для ссылочной схемы. |
| void [set_SchemaLocation](./set_schemalocation/)(const [String](../../system/string/)\&) | Устанавливает расположение Uniform Resource Identifier (URI) схемы, которое указывает процессору схемы, где физически находится схема. |
...
| void [set_UnhandledAttributes](./set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Устанавливает квалифицированные атрибуты, которые не принадлежат целевому пространству имен схемы. |
...
Экземпляры этого класса должны выделяться только с помощью функции [System::MakeObject()](../../system/makeobject/). Никогда не создавайте экземпляры этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или нарушениям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](../../system/smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. 
