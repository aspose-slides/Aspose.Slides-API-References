...
description: Представляет элемент choice (композитор) из XML Schema, как указано World Wide Web Consortium (W3C). Элемент choice позволяет появиться только одному из его дочерних элементов в экземпляре.
type: docs
weight: 209
url: /ru/system.xml.schema/xmlschemachoice/
---
## XmlSchemaChoice класс
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Возвращает коллекцию элементов, содержащихся в композиторе (**choice**): [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](./), [XmlSchemaSequence](../xmlschemasequence/) или [XmlSchemaAny](../xmlschemaany/). |
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Возвращает позицию символа в файле, к которому относится элемент **schema**. |
...
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Устанавливает позицию символа в файле, к которому относится элемент **schema**. |
...
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Устанавливает число в виде строкового значения. Максимальное количество вхождений частицы. |
...
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Устанавливает число в виде строкового значения. Минимальное количество вхождений частицы. |
