...
description: Представляет элемент appinfo консорциума World Wide Web (W3C).
type: docs
weight: 157
url: /ru/system.xml.schema/xmlschemaappinfo/
---
## XmlSchemaAppInfo класс
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Возвращает позицию строки в файле, на который ссылается элемент **schema**. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Возвращает массив объектов [XmlNode](../../system.xml/xmlnode/), представляющих дочерние узлы **appinfo**. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Возвращает источник информации приложения. |
...
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Устанавливает позицию строки в файле, на который ссылается элемент **schema**. |
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Устанавливает массив объектов [XmlNode](../../system.xml/xmlnode/), представляющих дочерние узлы **appinfo**. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Устанавливает источник информации приложения. |
...
Объекты этого класса должны выделяться только с помощью функции [System::MakeObject()](../../system/makeobject/). Никогда не создавайте экземпляры этого типа в стеке или с помощью operator new, так как это приведёт к ошибкам выполнения и/или сбоям утверждения. Всегда оборачивайте этот класс в указатель [System::SmartPtr](../../system/smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. 
