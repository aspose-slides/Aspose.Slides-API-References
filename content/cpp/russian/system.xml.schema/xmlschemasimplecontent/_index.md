...
description: Представляет элемент simpleContent из XML Schema, определённый World Wide Web Consortium (W3C). Этот класс предназначен для простых и сложных типов с простой моделью содержимого.
type: docs
weight: 794
url: /ru/system.xml.schema/xmlschemasimplecontent/
---
## XmlSchemaSimpleContent класс
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | Возвращает один из [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) или [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | Возвращает один из [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) или [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-ый параметр шаблона как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим weak. |
...
Экземпляры этого класса должны создаваться только с помощью функции [System::MakeObject()](../../system/makeobject/). Никогда не создавайте объекты этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или assertion faults. Всегда оборачивайте этот класс в указатель [System::SmartPtr](../../system/smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. 
