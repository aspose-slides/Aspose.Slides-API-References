...
description: Представляет элемент documentation из XML Schema, как определено World Wide Web Consortium (W3C). Этот класс задаёт информацию, которую могут читать или использовать люди в аннотации.
type: docs
weight: 352
url: /ru/system.xml.schema/xmlschemadocumentation/
---
## XmlSchemaDocumentation класс
...
| [String](../../system/string/) [get_Language](./get_language/)() | Возвращает атрибут **xml:lang**. Это служит индикатором языка, используемого в содержимом. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Возвращает массив объектов [XmlNode](../../system.xml/xmlnode/), представляющих дочерние узлы документации. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Возвращает источник Uniform Resource Identifier (URI) информации. |
...
| void [set_Language](./set_language/)(const [String](../../system/string/)\&) | Устанавливает атрибут **xml:lang**. Это служит индикатором языка, используемого в содержимом. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Устанавливает массив объектов [XmlNode](../../system.xml/xmlnode/), представляющих дочерние узлы документации. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Устанавливает источник Uniform Resource Identifier (URI) информации. |
