...
description: Возвращает подробную информацию об исключении схемы.
type: docs
weight: 1
url: /ru/system.xml.schema/details_xmlschemaexception/
---
## Details_XmlSchemaException класс
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Возвращает номер строки, указывающей, где произошла ошибка. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Возвращает позицию в строке, указывающую, где произошла ошибка. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Возвращает описание условия ошибки этого исключения. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](./get_sourceschemaobject/)() | Объект **[XmlSchemaObject](../xmlschemaobject/)**, который создал XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Возвращает унифицированный идентификатор ресурса (URI) схемы, вызвавшей исключение. |
