...
description: Базовый класс для всех фасетов, которые используются при выводе простых типов посредством ограничения.
type: docs
weight: 404
url: /ru/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet класс
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Возвращает строковый идентификатор id. |
| virtual **bool** [get_IsFixed](./get_isfixed/)() | Возвращает информацию, указывающую, что этот фасет фиксирован. |
...
| [String](../../system/string/) [get_Value](./get_value/)() | Возвращает атрибут **value** фасета. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Устанавливает строковый идентификатор id. |
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | Устанавливает информацию, указывающую, что этот фасет фиксирован. |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Устанавливает атрибут **value** фасета. |
...
Объекты этого класса должны создаваться только с помощью функции [System::MakeObject()](../../system/makeobject/). Никогда не создавайте экземпляры этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или сбоям проверок. Всегда оборачивайте этот класс в указатель [System::SmartPtr](../../system/smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. 
