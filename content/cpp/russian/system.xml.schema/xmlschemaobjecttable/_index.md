...
description: Предоставляет коллекции содержащихся элементов в классе XmlSchema (например, Attributes, AttributeGroups, Elements и т.д.).
type: docs
weight: 716
url: /ru/system.xml.schema/xmlschemaobjecttable/
---
## XmlSchemaObjectTable класс
...
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Определяет, существует ли указано квалифицированное имя в коллекции. |
...
| **int32_t** [get_Count](./get_count/)() | Возвращает количество элементов, содержащихся в [XmlSchemaObjectTable](./). |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\> [get_Names](./get_names/)() | Возвращает коллекцию всех именованных элементов в [XmlSchemaObjectTable](./). |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [get_Values](./get_values/)() | Возвращает коллекцию всех значений всех элементов в [XmlSchemaObjectTable](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру счетчика ссылок, связанную с объектом. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\>\> [GetEnumerator](./getenumerator/)() override | Возвращает перечислитель, который может проходить по [XmlSchemaObjectTable](./). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Аналог метода C# [Object.GetHashCode()](../../system/object/gethashcode/). Позволяет хешировать пользовательские объекты. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Получает фактический тип объекта. Аналог вызова C# [System.Object.GetType()](../../system/object/gettype/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Возвращает элемент в [XmlSchemaObjectTable](./), указанный квалифицированным именем. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Возвращает количество элементов в последовательности (получается прямым подсчётом). |
