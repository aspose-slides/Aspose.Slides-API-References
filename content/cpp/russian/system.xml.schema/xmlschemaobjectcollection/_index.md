...
description: Коллекция XmlSchemaObjects.
type: docs
weight: 690
url: /ru/system.xml.schema/xmlschemaobjectcollection/
---
## XmlSchemaObjectCollection класс
...
| Метод | Описание |
| --- | --- |
| **int32_t** [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Добавляет [XmlSchemaObject](../xmlschemaobject/) в [XmlSchemaObjectCollection](./). |
...
| void [Clear](../../system.collections/collectionbase/clear/)() | Удаляет все объекты из экземпляра коллекции. Этот метод нельзя переопределить. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Указывает, находится ли указанный [XmlSchemaObject](../xmlschemaobject/) в [XmlSchemaObjectCollection](./). |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\&, **int32_t**) | Копирует все XmlSchemaObject из коллекции в заданный массив, начиная с указанного индекса. |
...
| **int32_t** [get_Capacity](../../system.collections/collectionbase/get_capacity/)() | Возвращает количество элементов, которое может содержать коллекция. |
| **int32_t** [get_Count](../../system.collections/collectionbase/get_count/)() | Возвращает количество элементов, содержащихся в экземпляре коллекции. Этот метод нельзя переопределить. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру данных счётчика ссылок, связанную с объектом. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [GetEnumerator](./getenumerator/)() override | Возвращает перечислитель для итерации по XmlSchemaObject, содержащимся в [XmlSchemaObjectCollection](./). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Аналог метода C# [Object.GetHashCode()](../../system/object/gethashcode/). Позволяет хешировать пользовательские объекты. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Получает фактический тип объекта. Аналог вызова C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(**int32_t**) | Возвращает [XmlSchemaObject](../xmlschemaobject/) по указанному индексу. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>) | Устанавливает [XmlSchemaObject](../xmlschemaobject/) по указанному индексу. |
| **int32_t** [IndexOf](./indexof/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Возвращает индекс коллекции, соответствующий указанному [XmlSchemaObject](../xmlschemaobject/). |
| void [Insert](./insert/)(**int32_t**, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Вставляет [XmlSchemaObject](../xmlschemaobject/) в [XmlSchemaObjectCollection](./). |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Возвращает количество элементов в последовательности (вычисляется подсчётом). |
...
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Удаляет [XmlSchemaObject](../xmlschemaobject/) из [XmlSchemaObjectCollection](./). |
| void [RemoveAt](../../system.collections/collectionbase/removeat/)(**int32_t**) | Удаляет элемент по указанному индексу экземпляра коллекции. Этот метод не может быть переопределён. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Уменьшает счётчик общих ссылок на указанное значение. |
| void [set_Capacity](../../system.collections/collectionbase/set_capacity/)(**int32_t**) | Задаёт количество элементов, которое может содержать коллекция. |
...
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Инициализирует новый экземпляр класса [XmlSchemaObjectCollection](./), который принимает [XmlSchemaObject](../xmlschemaobject/). |
...
| Тип | Описание |
| --- | --- |
| [Ptr](./ptr/) | Псевдоним указателя разделяемого типа на экземпляр этого класса. |
...
* Класс [CollectionBase](../../system.collections/collectionbase/)
