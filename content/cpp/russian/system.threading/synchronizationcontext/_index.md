...
description: Обеспечивает базовую функциональность для распространения контекста синхронизации между различными операциями синхронизации.
type: docs
weight: 196
url: /ru/system.threading/synchronizationcontext/
---
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | Получает контекст синхронизации для текущего потока. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Конструктор копии. На самом деле ничего не копирует, просто инициализирует новый объект и позволяет создавать копии в подклассах. |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Выполняет обратный вызов асинхронно. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Выполняет обратный вызов синхронно. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | Устанавливает контекст синхронизации для текущего потока. |
...
|  [SynchronizationContext](./synchronizationcontext/)() | Создаёт новый экземпляр [SynchronizationContext](./). |
...
Этот класс позволяет распространять контекст синхронизации между потоками и используется для маршаллинга обратных вызовов или вызовов в соответствующий поток или контекст синхронизации. Фиктивная реализация. 
