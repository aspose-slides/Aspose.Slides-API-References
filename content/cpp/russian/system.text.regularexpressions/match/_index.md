...
| Метод | Описание |
| --- | --- |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | Добавляет захват в совпадение. |
| void [AddGroup](./addgroup/)(const [GroupPtr](../groupptr/)\&) | Добавляет группу в совпадение. |
|  [Capture](../capture/capture/)(const [UStringPtr](../ustringptr/)\&, int, int) | Конструктор. |
...
| [CaptureCollectionPtr](../capturecollectionptr/) [get_Captures](../group/get_captures/)() | Получает доступные захваты. |
| static [MatchPtr](../matchptr/) [get_Empty](./get_empty/)() | Доступ к пустому совпадению. |
| [GroupCollectionPtr](../groupcollectionptr/) [get_Groups](./get_groups/)() | Получает список групп. |
| int [get_Index](../capture/get_index/)() const | Получает индекс захваченной подстроки. |
| int [get_Length](../capture/get_length/)() const | Получает длину захваченной подстроки. |
| **bool** [get_Success](../group/get_success/)() | Проверяет, был ли захват успешным для этой группы. |
| [String](../../system/string/) [get_Value](../capture/get_value/)() const | Получает захваченную подстроку. |
...
|  [Group](../group/group/)(const [UStringPtr](../ustringptr/)\&, int, int) | Конструктор. |
|  [Group](../group/group/)() | Конструктор пустой группы. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Проверяет, представляет ли объект экземпляр типа, описанного targetType. Аналог оператора C# 'is'. |
| void [Lock](../../system/object/lock/)() | Реализует блокировку оператора C# lock(). Вызывайте напрямую или используйте объект-сторож [LockContext](../../system/lockcontext/). |
|  [Match](./match/)(const [UStringPtr](../ustringptr/)\&, int, int) | Конструктор. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Аналог метода C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Позволяет клонировать пользовательские типы. |
| [MatchPtr](../matchptr/) [NextMatch](./nextmatch/)() | Итерация по совпадениям. |
...
| virtual [String](../../system/string/) [Result](./result/)(const [String](../../system/string/)\&) | Форматирует строку, заменяя ссылки на подсовпадения их значениями. |
...
| [String](../../system/string/) [ToString](../capture/tostring/)() const override | Получает захваченную подстроку. |
