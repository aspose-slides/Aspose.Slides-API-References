...
| Method | Описание |
| --- | --- |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | Добавляет захват в группу. |
...
| [CaptureCollectionPtr](../capturecollectionptr/) [get_Captures](./get_captures/)() | Получает доступные захваты. |
...
| **bool** [get_Success](./get_success/)() | Проверяет, был ли захват успешным для этой группы. |
...
|  [Group](./group/)(const [UStringPtr](../ustringptr/)\&, int, int) | Конструктор. |
