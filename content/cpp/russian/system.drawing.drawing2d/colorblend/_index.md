...
| [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\> [get_Colors](./get_colors/)() | Возвращает массив цветов, используемых в соответствующих позициях вдоль градиента. |
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Positions](./get_positions/)() | Возвращает массив позиций смешивания вдоль градиента. |
...
| void [set_Colors](./set_colors/)(const [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\>\&) | Устанавливает массив цветов, используемых в соответствующих позициях вдоль градиента. |
| void [set_Positions](./set_positions/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | Устанавливает массив позиций смешивания вдоль градиента. |
