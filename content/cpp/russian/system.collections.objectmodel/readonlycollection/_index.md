...
description: "Оборачивает конкретный контейнер для доступа к нему в режиме только для чтения. Объекты этого класса должны создаваться только с помощью функции System::MakeObject(). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или нарушениям утверждений. Всегда оборачивайте этот класс в указатель System::SmartPtr и используйте этот указатель для передачи его в функции в качестве аргумента."
type: docs
weight: 27
url: /ru/system.collections.objectmodel/readonlycollection/
---
## ReadOnlyCollection класс

Оборачивает конкретный контейнер для доступа к нему в режиме только для чтения. Объекты этого класса должны создаваться только с помощью функции [System::MakeObject()](../../system/makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или нарушениям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](../../system/smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента.
...
| **bool** [Contains](./contains/)(const T\&) const override | Проверяет, содержит ли контейнер указанный элемент. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Копирует элементы контейнера в существующие элементы массива. |
...
| int [get_Count](./get_count/)() const override | Возвращает количество элементов контейнера. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Проверяет, имеет ли коллекция фиксированный размер. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Проверяет, является ли коллекция только для чтения. |
...
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Возвращает перечислитель коллекции. |
...
| T [idx_get](./idx_get/)(int) const override | Возвращает элемент в заданной позиции. |
| int [IndexOf](./indexof/)(const T\&) const override | Ищет указанный элемент в коллекции. |
...
| [ReadOnlyCollection](./readonlycollection/)(const [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\>\&) | Оборачивает только-для-чтения коллекцию вокруг конкретной коллекции. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Ничего не делает, так как только-для-чтения коллекция лишь оборачивает данные и ничего не хранит. |
...
| [IEnumeratorPtr](./ienumeratorptr/) | Контейнер из тех же элементов. |

## См. также

* Класс [Object](../../system/object/)
* Класс [IList](../../system.collections.generic/ilist/)
* Пространство имён [System::Collections::ObjectModel](../)
