...
description: "Базовый тип для обобщенной коллекции. Объекты этого класса должны создаваться только с помощью функции System::MakeObject(). Никогда не создавайте экземпляр этого типа в стеке или с помощью оператора new, так как это приведёт к ошибкам выполнения и/или сбоям утверждений. Всегда оборачивайте этот класс в указатель System::SmartPtr и используйте этот указатель для передачи его в функции в качестве аргумента."
type: docs
weight: 1
url: /ru/system.collections.objectmodel/collection/
---
## Collection класс
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const T\&) override | Добавляет значение в контейнер. |
...
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Копирует элементы коллекции в существующие элементы массива. |
...
| [const_reverse_iterator](./const_reverse_iterator/) [crend](./crend/)() const | Возвращает обратный итератор для несуществующего константного элемента перед началом коллекции. |
...
| int [get_Count](./get_count/)() const override | Возвращает количество элементов. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](./get_items/)() | Доступ к внутренней структуре данных. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](./get_items/)() const | Доступ к внутренней структуре данных. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Возвращает перечислитель для итерации по коллекции. |
...
| T [idx_get](./idx_get/)(int) const override | Возвращает значение по заданному индексу. |
| void [idx_set](./idx_set/)(int, T) override | Устанавливает значение по заданному индексу. |
| int [IndexOf](./indexof/)(const T\&) const override | Ищет элемент в коллекции. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Возвращает заданное число последовательных элементов с начала последовательности. |
...
| T\& [operator[]](./operator[]/)(int) | Возвращает значение по заданному индексу. |
| const T\& [operator[]](./operator[]/)(int) const | Возвращает значение по заданному индексу. |
...
| **bool** [Remove](./remove/)(const T\&) override | Удаляет конкретный элемент. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Делает сохранённые указатели слабыми (если применимо). |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Возвращает реализацию begin-константного итератора для текущего контейнера. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Возвращает реализацию begin-итератора для текущего контейнера. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Возвращает реализацию end-константного итератора для текущего контейнера. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Возвращает реализацию end-итератора для текущего контейнера. |
