...
description: Представляет предупреждение о известной проблеме, исправление которой не планируется в ближайшее время.
type: docs
weight: 1
url: /ru/aspose.slides.warnings/iknownissuewarninginfo/
---
## IKnownIssueWarningInfo класс

Представляет предупреждение о известной проблеме, исправление которой не планируется в ближайшее время.
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Если получатель не null, завершает предупреждение к указанному получателю и бросает AbortRequestedException, если получатель решил прервать операцию. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n'tй аргумент шаблона в слабый указатель (а не разделяемый). Позволяет переключать указатели в контейнерах в слабый режим. |
