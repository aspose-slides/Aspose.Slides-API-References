...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Возвращает человекочитаемое описание этого предупреждения. Только для чтения [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](./get_warningtype/)() | Возвращает тип предупреждения. Только для чтения [IWarningInfo::get_WarningType](./get_warningtype/). |
...
| virtual void [SendWarning](./sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Если получатель не null, завершает предупреждение для указанного получателя и бросает AbortRequestedException, если получатель решил прервать операцию. |
