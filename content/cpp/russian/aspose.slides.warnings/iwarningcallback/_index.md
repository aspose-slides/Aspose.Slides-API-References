...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона в слабый указатель (вместо общего). Позволяет переключать указатели в контейнерах в режим weak. |
...
| virtual [ReturnAction](../returnaction/) [Warning](./warning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningInfo](../iwarninginfo/)\>) | Метод обратного вызова, получающий предупреждение и решающий, следует ли прервать операцию. |
