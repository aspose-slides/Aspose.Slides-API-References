...
---
## INotImplementedWarningInfo класс
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Возвращает человекочитаемое описание этого предупреждения. Только для чтения [System::String](../../system/string/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Если получатель не null, заканчивает предупреждение для указанного получателя и бросает AbortRequestedException, если получатель решил прервать операцию. |
