...
description: IEnumerable — базовый интерфейс для всех non-generic коллекций, которые можно перечислять.
type: docs
weight: 53
url: /ru/system.collections/ienumerable/
---
## IEnumerable класс

[IEnumerable](./) является базовым интерфейсом для всех non-generic коллекций, которые могут быть перечислены.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | Возвращает перечислитель, который итеративно проходит по коллекции. |
