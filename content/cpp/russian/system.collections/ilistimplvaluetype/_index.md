...
description: "Заглушка, реализующая интерфейс System::Collections::IList на объекте System::Collections::Generic::List. Реализация для типовых значений."
type: docs
weight: 144
url: /ru/system.collections/ilistimplvaluetype/
---
## IListImplValueType класс

Заглушка, реализующая [System::Collections::IList](../ilist/) interface на [System::Collections::Generic::List](../../system.collections.generic/list/) object. Implementation for value types.
...
| int [get_Count](./get_count/)() const override | [ICollection.get_Count()](../icollection/get_count/) methods implementation Возвращает количество элементов в коллекции. |
| virtual **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() const | Возвращает значение, указывающее, имеет ли список фиксированный размер. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() override | [IEnumerable.GetEnumerator()](../ienumerable/getenumerator/) implementation Возвращает перечислитель, который перебирает коллекцию. |
...
|  [IListImplValueType](./ilistimplvaluetype/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) | Создаёт новый экземпляр объекта. |
...
| void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Удаляет первый экземпляр конкретного элемента из списка. |
