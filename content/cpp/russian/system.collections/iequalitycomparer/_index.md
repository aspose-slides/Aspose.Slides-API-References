...
type: docs
weight: 105
url: /ru/system.collections/iequalitycomparer/
---
...
| Method | Description |
| --- | --- |
| virtual **bool** [Equals](./equals/)(const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) const | Проверяет, равны ли два объекта. |
...
| virtual int [GetHashCode](./gethashcode/)(const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) const | Получает хеш-код для некоторого объекта. |
...
|  [RTTI_INFO_TEMPLATE_CLASS](./rtti_info_template_class/)([System::Collections::IEqualityComparer](./), System::BaseTypesInfo\<[System::Object](../../system/object/)\>) | Информация RTTI. |
