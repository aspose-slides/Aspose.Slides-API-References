...
description: IList представляет не-обобщённую коллекцию объектов, к которым можно получить доступ по отдельному индексу.
type: docs
weight: 118
url: /ru/system.collections/ilist/
---
## IList класс

[IList](./) Представляет не генерическую коллекцию объектов, к которым можно получить доступ по индексу.
...
| Метод | Описание |
| --- | --- |
| virtual int [Add](./add/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Добавляет элемент в конец списка. |
| virtual void [Clear](./clear/)() | Удаляет все элементы из списка. |
| virtual **bool** [Contains](./contains/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Проверяет, находится ли элемент в списке. |
...
| virtual **bool** [get_IsFixedSize](./get_isfixedsize/)() const | Возвращает значение, указывающее, имеет ли список фиксированный размер. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](../ienumerable/getenumerator/)() | Возвращает перечислитель, который перебирает коллекцию. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(int, int) const | Возвращает элемент по указанному индексу. |
| virtual int [IndexOf](./indexof/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Возвращает первый индекс указанного элемента. |
| virtual void [Insert](./insert/)(int, [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Вставляет элемент в список по указанному индексу. |
...
| virtual void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Удаляет первое вхождение указанного элемента из списка. |
| virtual void [RemoveAt](./removeat/)(int) | Удаляет элемент из списка по указанному индексу. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Уменьшает счётчик совместных ссылок на указанное значение. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-ый аргумент шаблона в weak-указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим weak. |
