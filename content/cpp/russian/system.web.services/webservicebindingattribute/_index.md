...
| [System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\> [get_ConformsTo](./get_conformsto/)() | Получает спецификацию WSI. |
| **bool** [get_EmitConformanceClaims](./get_emitconformanceclaims/)() | Получает значение, указывающее, генерирует ли привязка требования соответствия. |
| [String](../../system/string/) [get_Location](./get_location/)() | Получает местоположение, где определена привязка. |
| [String](../../system/string/) [get_Name](./get_name/)() | Получает имя привязки. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Получает пространство имён, связанное с привязкой. |
...
| void [set_ConformsTo](./set_conformsto/)([System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\>) | Устанавливает спецификацию WSI. |
| void [set_EmitConformanceClaims](./set_emitconformanceclaims/)(**bool**) | Устанавливает значение, указывающее, генерирует ли привязка требования соответствия. |
| void [set_Location](./set_location/)([String](../../system/string/)) | Устанавливает местоположение, где определена привязка. |
| void [set_Name](./set_name/)([String](../../system/string/)) | Устанавливает имя привязки. |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Устанавливает пространство имён, связанное с привязкой. |
...
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/)) | Создаёт новый экземпляр. |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/)) | Создаёт новый экземпляр. |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | Создаёт новый экземпляр. |
| virtual  [~Object](../../system/object/~object/)() | Уничтожает объект. Освобождает все внутренние структуры данных. |

## См. также

* Класс [Attribute](../../system/attribute/)
* Пространство имён [System::Web::Services](../)
