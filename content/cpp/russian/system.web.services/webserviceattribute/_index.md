...
| [String](../../system/string/) [get_Description](./get_description/)() | Получает сообщение, содержащее описание сервиса XML [Web](../../system.web/). |
| [String](../../system/string/) [get_Name](./get_name/)() | Получает имя сервиса XML [Web](../../system.web/). |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Получает пространство имён по умолчанию для использования с сервисом XML [Web](../../system.web/). |
...
| void [set_Description](./set_description/)([String](../../system/string/)) | Устанавливает сообщение, содержащее описание сервиса XML [Web](../../system.web/). |
| void [set_Name](./set_name/)([String](../../system/string/)) | Устанавливает имя сервиса XML [Web](../../system.web/). |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Устанавливает пространство имён по умолчанию для использования с сервисом XML [Web](../../system.web/). |
...
| Field | Description |
| --- | --- |
| static [DefaultNamespace](./defaultnamespace/) | Значение по умолчанию свойства 'Namespace'. |
