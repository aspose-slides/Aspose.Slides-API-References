...
| void [Lock](../../system/object/lock/)() | Реализует захват оператора C# lock(). Вызывайте напрямую или используйте объект-страж [LockContext](../../system/lockcontext/). |
