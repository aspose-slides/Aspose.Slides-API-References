...
description: 2D вектор с компонентами float
type: docs
weight: 53
url: /ru/aspose.slides.drawing/vector2d32f/
---
## Vector2d32f класс

2D вектор с компонентами **float**  
...
| **double** [GetLength](./getlength/)() | Получить длину |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Сравнивает объект-значимый тип со значением nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | Специализация [Object::ReferenceEquals](../../system/object/referenceequals/) для случая строки и nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | Специализация [Object::ReferenceEquals](../../system/object/referenceequals/) для случая строк. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Уменьшает счётчик общих ссылок на указанное значение. |
| [Vector2d32f](./) [Scale](./scale/)(**float**, **float**) | Масштабировать вектор |
| [Vector2d32f](./) [Scale](./scale/)([Vector2d32f](./)) | Масштабировать вектор |
...
| void [SwapXY](./swapxy/)() | Поменять местами X и Y |
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Аналог метода C# Object.ToString(). Позволяет преобразовывать пользовательские объекты в строку. |
| [Vector2d64d](../vector2d64d/) [ToVector2d64d](./tovector2d64d/)() | В [Vector2d64d](../vector2d64d/) |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Реализует конструкцию C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывайте напрямую или используйте объект-страж [LockContext](../../system/lockcontext/). |
|  [Vector2d32f](./vector2d32f/)(**float**, **float**) | Конструктор |
