...
|  [XmlRootAttribute](./xmlrootattribute/)() | Создаёт новый экземпляр класса [XmlRootAttribute](./). |
|  [XmlRootAttribute](./xmlrootattribute/)(const [System::String](../../system/string/)\&) | Создаёт новый экземпляр класса [XmlRootAttribute](./) и инициализирует его указанным именем элемента. |
