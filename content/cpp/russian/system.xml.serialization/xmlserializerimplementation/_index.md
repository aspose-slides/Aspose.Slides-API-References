...
description: Внутренний класс для использования с XmlSerializer.
type: docs
weight: 79
url: /ru/system.xml.serialization/xmlserializerimplementation/
---
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й шаблонный аргумент как слабый указатель (в отличие от shared). Позволяет переключать указатели в контейнерах в режим слабых. |
