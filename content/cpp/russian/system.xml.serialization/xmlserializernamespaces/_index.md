...
description: "Содержит пространства имён XML и префиксы, которые Serialization::XmlSerializer использует для создания квалифицированных имён в экземпляре XML-документа."
type: docs
weight: 92
url: /ru/system.xml.serialization/xmlserializernamespaces/
---
...
| Метод | Описание |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Добавляет пару префикса и пространства имён в объект [Serialization::XmlSerializerNamespaces](./). |
...
| **int32_t** [get_Count](./get_count/)() | Возвращает количество пар префикса и пространства имён в коллекции. |
...
|  [Object](../../system/object/object/)() | Инициализирует новый объект. Инициализирует все внутренние структуры данных. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\> [ToArray](./toarray/)() | Возвращает массив пар префикса и пространства имён в объекте [Serialization::XmlSerializerNamespaces](./). |
...
|  [XmlSerializerNamespaces](./xmlserializernamespaces/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSerializerNamespaces](./)\>\&) | Инициализирует новый экземпляр класса [Serialization::XmlSerializerNamespaces](./), используя указанный экземпляр **[XmlSerializerNamespaces](./)**, содержащий коллекцию пар префикса и пространства имён. |
|  [XmlSerializerNamespaces](./xmlserializernamespaces/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\&) | Инициализирует новый экземпляр класса [Serialization::XmlSerializerNamespaces](./). |
...
Объекты этого класса следует выделять только с помощью функции [System::MakeObject()](../../system/makeobject/). Никогда не создавайте экземпляры этого типа в стеке или через оператор new, так как это приведёт к ошибкам выполнения и/или к сбоям с утверждениями. Всегда оборачивайте этот класс в указатель [System::SmartPtr](../../system/smartptr/) и используйте этот указатель для передачи его в функции в качестве аргумента. 
