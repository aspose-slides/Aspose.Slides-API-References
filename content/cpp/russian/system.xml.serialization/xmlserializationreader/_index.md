...
description: Сервисный класс, улучшающий работу с XmlReader.
type: docs
weight: 40
url: /ru/system.xml.serialization/xmlserializationreader/
---
## XmlSerializationReader класс

Сервисный класс, улучшающий работу с [XmlReader](../../system.xml/xmlreader/).
...
| void [Initialize](./initialize/)([System::SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>, [System::SharedPtr](../../system/sharedptr/)\<[XmlSerializer](../xmlserializer/)\>) | Инициализирует класс [XmlSerializationReader](./). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-th параметр шаблона как слабый указатель (а не разделяемый). Позволяет переключать указатели в контейнерах в режим слабых. |
