...
| Метод | Описание |
| --- | --- |
| [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Создаёт буфер резервного замещения. |
| [EncoderReplacementFallback](./encoderreplacementfallback/)() | Конструктор, который использует строку замещения "?" по умолчанию. |
| [EncoderReplacementFallback](./encoderreplacementfallback/)(const [String](../../system/string/)\&) | Конструктор. |
...
| const [String](../../system/string/)\& [get_DefaultString](./get_defaultstring/)() const | Получает строку замещения. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](../encoderfallback/get_exceptionfallback/)() | Получает реализацию резервного поведения по умолчанию для исключений. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Получает максимальное количество символов, которое может вернуть экземпляр. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](../encoderfallback/get_replacementfallback/)() | Получает реализацию резервного замещения по умолчанию. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_StandardSafeFallback](../encoderfallback/get_standardsafefallback/)() | Получает стандартную безопасную реализацию резервного замещения по умолчанию. |
