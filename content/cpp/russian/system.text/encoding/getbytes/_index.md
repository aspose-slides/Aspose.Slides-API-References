...
description: Получает байты, полученные в результате кодирования буфера символов.
type: docs
weight: 248
url: /ru/system.text/encoding/getbytes/
---
## Encoding::GetBytes(ArrayPtr\<char_t\>, int, int, ArrayPtr\<uint8_t\>, int) method

Получает байты, полученные в результате кодирования буфера символов.
...
[Buffer](../../../system/buffer/), содержащий представление кодируемых символов.
