...
description: Буфер для замены стратегии отката декодирования.
type: docs
weight: 92
url: /ru/system.text/decoderreplacementfallbackbuffer/
---
## DecoderReplacementFallbackBuffer класс

[Buffer](../../system/buffer/) для замены стратегии отката декодирования.
...
| Метод | Описание |
| --- | --- |
|  [DecoderReplacementFallbackBuffer](./decoderreplacementfallbackbuffer/)(const [DecoderReplacementFallbackPtr](../../system/decoderreplacementfallbackptr/)\&) | Конструктор. |
...
| **bool** [Fallback](./fallback/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Обрабатывает сбой декодирования. |
