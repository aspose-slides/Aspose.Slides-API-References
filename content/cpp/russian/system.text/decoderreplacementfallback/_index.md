...
description: "Обеспечивает стратегию резервного замещения ошибочного символа заглушкой. Объекты этого класса должны создаваться только с помощью функции System::MakeObject(). Нельзя создавать экземпляр этого типа в стеке или с помощью оператора new, так как это приводит к ошибкам времени выполнения и/или нарушениям утверждений. Всегда оборачивайте этот класс в указатель System::SmartPtr и используйте этот указатель для передачи его в функции в качестве аргумента."
type: docs
weight: 79
url: /ru/system.text/decoderreplacementfallback/
---
## DecoderReplacementFallback класс
...
| Method | Description |
| --- | --- |
| [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Создаёт буфер резервного переключения. |
| [DecoderReplacementFallback](./decoderreplacementfallback/)() | Конструктор, использующий строку замены "?" по умолчанию. |
| [DecoderReplacementFallback](./decoderreplacementfallback/)(const [String](../../system/string/)\&) | Конструктор. |
...
| const [String](../../system/string/)\& [get_DefaultString](./get_defaultstring/)() const | Возвращает строку замены. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](../decoderfallback/get_exceptionfallback/)() | Возвращает реализацию резервного механизма исключения по умолчанию. |
...
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](../decoderfallback/get_replacementfallback/)() | Возвращает реализацию резервного замещения по умолчанию. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](../decoderfallback/get_standardsafefallback/)() | Возвращает стандартную безопасную реализацию резервного механизма по умолчанию. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Конструктор копирования. На самом деле ничего не копирует, просто инициализирует новый объект и позволяет копировать в подклассах. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Оператор присваивания. На самом деле ничего не копирует, просто инициализирует новый объект и позволяет копировать в подклассах. |
