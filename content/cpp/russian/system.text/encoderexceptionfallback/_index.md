...
| Method | Description |
| --- | --- |
| [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Создаёт буфер отката. |
...
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](../encoderfallback/get_exceptionfallback/)() | Возвращает реализацию отката по умолчанию для исключений. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Возвращает максимальное количество символов, которые может вернуть экземпляр. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](../encoderfallback/get_replacementfallback/)() | Возвращает реализацию замены отката по умолчанию. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_StandardSafeFallback](../encoderfallback/get_standardsafefallback/)() | Возвращает стандартную безопасную реализацию отката по умолчанию. |
...
* Класс [EncoderFallback](../encoderfallback/)
