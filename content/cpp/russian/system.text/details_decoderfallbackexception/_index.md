...
description: "Исключение, выбрасываемое DecoderExceptionFallback при неудачной декодировке. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс DecoderFallbackException. Никогда не оборачивайте экземпляры класса DecoderFallbackException в System::SmartPtr."
type: docs
weight: 105
url: /ru/system.text/details_decoderfallbackexception/
---
## Details_DecoderFallbackException класс

Исключение, выбрасываемое [DecoderExceptionFallback](../decoderexceptionfallback/) при неудачной декодировке. Никогда не создавайте экземпляры этого класса вручную. Используйте DecoderFallbackException класс вместо этого. Никогда не оборачивайте экземпляры класса DecoderFallbackException в [System::SmartPtr](../../system/smartptr/).
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | Получает массив байтов, вызвавший ошибку. |
...
| int [get_Index](./get_index/)() | Получает позицию байта, вызвавшего ошибку, во входном массиве. |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | Возвращает ссылку на объект, представляющий вложенное исключение. |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | Возвращает копию объекта Exception, представляющего самое вложенное исключение. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Получает структуру данных счётчика ссылок, связанную с объектом. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Аналог метода C# [Object.GetHashCode()](../../system/object/gethashcode/). Позволяет хешировать пользовательские объекты. |
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Получает фактический тип объекта. Аналог вызова C# [System.Object.GetType()](../../system/object/gettype/). |
| **bool** [Is](../../system/details_argumentexception/is/)(const [System::TypeInfo](../../system/typeinfo/)\&) const override |  |
| void [Lock](../../system/object/lock/)() | Реализует блокировку оператора C# lock(). Вызывайте напрямую либо используйте объект-сторож [LockContext](../../system/lockcontext/). |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Устанавливает HRESULT, закодированное числовое значение, назначаемое конкретному исключению. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывайте напрямую либо используйте объект-сторож [LockContext](../../system/lockcontext/). |
