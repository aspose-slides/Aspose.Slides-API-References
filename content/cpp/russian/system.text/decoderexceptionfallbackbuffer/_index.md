...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Эмулирует сравнение чисел двойной точности в стиле C#, где два NaN считаются равными, хотя согласно IEC 60559:1989 NaN не равен ни одному значению, включая NaN. |
| **bool** [Fallback](./fallback/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Обрабатывает ошибку декодирования. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Только для внутреннего использования. |
| int [get_Remaining](./get_remaining/)() const override | Возвращает количество оставшихся символов. |
...
| char_t [GetNextChar](./getnextchar/)() override | Возвращает следующий доступный символ. |
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку инструкции C# lock(). Вызывайте напрямую или используйте объект-страж [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Аналог метода C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Позволяет клонировать пользовательские типы. |
| **bool** [MovePrevious](./moveprevious/)() override | Переходит к предыдущему символу. |
...
| virtual void [Reset](../decoderfallbackbuffer/reset/)() | Сбрасывает буфер в исходное состояние. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку инструкции C# lock(). Вызывайте напрямую или используйте объект-страж [LockContext](../../system/lockcontext/). |
...
* Класс [DecoderFallbackBuffer](../decoderfallbackbuffer/)
