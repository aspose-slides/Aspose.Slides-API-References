...
description: "Исключение, генерируемое EncoderExceptionFallback при ошибке кодирования. Никогда не создавайте экземпляры этого класса вручную. Вместо этого используйте класс EncoderFallbackException. Никогда не оборачивайте экземпляры класса EncoderFallbackException в System::SmartPtr."
type: docs
weight: 118
url: /ru/system.text/details_encoderfallbackexception/
---
## Details_EncoderFallbackException класс

Исключение, генерируемое [EncoderExceptionFallback](../encoderexceptionfallback/) при ошибке кодирования. Никогда не создавайте экземпляры этого класса вручную. Используйте вместо него класс EncoderFallbackException. Никогда не оборачивайте экземпляры класса EncoderFallbackException в [System::SmartPtr](../../system/smartptr/).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Эмулирует сравнение чисел с плавающей точкой в стиле C#, при котором два NaN считаются равными, даже несмотря на то, что согласно IEC 60559:1989 NaN не равен ни одному значению, включая NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Эмулирует сравнение чисел с плавающей точкой в стиле C#, при котором два NaN считаются равными, даже несмотря на то, что согласно IEC 60559:1989 NaN не равен ни одному значению, включая NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Только для внутренних целей. |
| char_t [get_CharUnknown](./get_charunknown/)() | Возвращает символ, вызвавший ошибку. |
| char_t [get_CharUnknownHigh](./get_charunknownhigh/)() | Возвращает старший символ пары, вызвавшей ошибку. |
| char_t [get_CharUnknownLow](./get_charunknownlow/)() | Возвращает младший символ пары, вызвавшей ошибку. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Возвращает 32-разрядное целое значение, являющееся кодом HRESULT, связанным с исключением, представленным текущим объектом. |
| int [get_Index](./get_index/)() | Возвращает позицию символа, вызвавшего ошибку, во входном массиве. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Возвращает фактический тип объекта. Аналог вызова C# [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Реализует метод [what()](../../system/details_exception/what/), который вызывается классом [ExceptionWrapper](../../system/exceptionwrapper/). Несмотря на то, что этот класс не наследует std::exception, производные классы могут использовать защищённые/приватные члены для реализации своей логики. Перемещение реализации этого метода в [ExceptionWrapper](../../system/exceptionwrapper/) может нарушить эту логику. |
| virtual  [~Object](../../system/object/~object/)() | Уничтожает объект. Освобождает все внутренние структуры данных. |

## См. также

* Класс [Details_ArgumentException](../../system/details_argumentexception/)
