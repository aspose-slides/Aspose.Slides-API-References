...
| [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_Fallback](./get_fallback/)() const | Получает резервный механизм обработки ошибок. |
| [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [get_FallbackBuffer](./get_fallbackbuffer/)() const | Получает резервный буфер. |
...
| virtual void [Reset](./reset/)() | Очищает внутреннее состояние декодера. |
| void [set_Fallback](./set_fallback/)(const [DecoderFallbackPtr](../../system/decoderfallbackptr/)\&) | Устанавливает резервный механизм обработки ошибок. |
