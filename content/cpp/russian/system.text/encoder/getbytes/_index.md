...
type: docs
weight: 53
url: /ru/system.text/encoder/getbytes/
---
## Encoder::GetBytes(ArrayPtr\<char_t\>, int, int, ArrayPtr\<uint8_t\>, int, bool) метод
...
## Encoder::GetBytes(const char_t *, int, uint8_t *, int, bool) метод
