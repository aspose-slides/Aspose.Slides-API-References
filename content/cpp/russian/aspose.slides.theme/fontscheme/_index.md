...
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() override | Возвращает набор шрифтов для части слайда \"heading\". Только для чтения [IFonts](../../aspose.slides/ifonts/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() override | Возвращает набор шрифтов для части слайда \"body\". Только для чтения [IFonts](../../aspose.slides/ifonts/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Возвращает название схемы шрифтов. Чтение [System::String](../../system/string/). |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Возвращает название схемы шрифтов. Запись [System::String](../../system/string/). |
