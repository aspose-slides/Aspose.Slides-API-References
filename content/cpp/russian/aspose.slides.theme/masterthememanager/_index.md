...
| Метод | Описание |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Применяет дополнительную цветовую схему к слайду. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | Возвращает объект темы. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Определяет, переопределяет ли [OverrideTheme](../overridetheme/) унаследованную эффективную тему ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) или нет. Читает **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Возвращает переопределяющий объект темы. Читает [IMasterTheme](../imastertheme/). |
...
| void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) override | Определяет, переопределяет ли [OverrideTheme](../overridetheme/) унаследованную эффективную тему ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) или нет. Записывает **bool**. |
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) override | Возвращает переопределяющий объект темы. Записывает [IMasterTheme](../imastertheme/). |
...
* Класс [IMasterThemeManager](../imasterthememanager/)
