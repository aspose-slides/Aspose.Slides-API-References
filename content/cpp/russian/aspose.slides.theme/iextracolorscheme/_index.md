...
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Возвращает имя этой схемы. Только для чтения [System::String](../../system/string/). |
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку оператора C# lock(). Вызывайте напрямую или используйте [LockContext](../../system/lockcontext/) охранный объект. |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывайте напрямую или используйте [LockContext](../../system/lockcontext/) охранный объект. |
