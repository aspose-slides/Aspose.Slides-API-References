...
description: Представляет менеджер переопределения темы.
type: docs
weight: 404
url: /ru/aspose.slides.theme/ioverridethemeable/
---
## IOverrideThemeable класс
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideThemeManager](../ioverridethememanager/)\> [get_ThemeManager](./get_thememanager/)() | Возвращает менеджер переопределения темы. Только для чтения [IOverrideThemeManager](../ioverridethememanager/). |
