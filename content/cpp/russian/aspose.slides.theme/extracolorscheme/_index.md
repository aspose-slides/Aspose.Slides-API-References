...
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Возвращает имя этой схемы. Только для чтения [System::String](../../system/string/). |
...
* Класс [IExtraColorScheme](../iextracolorscheme/)
