...
---
## IEffectStyleEffectiveData класс
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormatEffectiveData](../../aspose.slides/ieffectformateffectivedata/)\> [get_EffectFormat](./get_effectformat/)() | Возвращает формат эффекта. Только для чтения [IEffectFormatEffectiveData](../../aspose.slides/ieffectformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormatEffectiveData](../../aspose.slides/ithreedformateffectivedata/)\> [get_ThreeDFormat](./get_threedformat/)() | Возвращает 3D-формат. Только для чтения [IThreeDFormatEffectiveData](../../aspose.slides/ithreedformateffectivedata/). |
...
| void [Lock](../../system/object/lock/)() | Реализует блокировку оператора C# lock(). Вызывайте напрямую или используйте объект-заграждение [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разблокировку оператора C# lock(). Вызывайте напрямую или используйте объект-заграждение [LockContext](../../system/lockcontext/). |
