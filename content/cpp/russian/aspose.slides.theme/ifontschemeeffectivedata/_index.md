...
---
## IFontSchemeEffectiveData класс
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Major](./get_major/)() | Возвращает коллекцию шрифтов для части слайда "heading". Только для чтения [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Minor](./get_minor/)() | Возвращает коллекцию шрифтов для части слайда "body". Только для чтения [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Возвращает название схемы шрифтов. Только для чтения [System::String](../../system/string/). |
