...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontSchemeEffectiveData](../ifontschemeeffectivedata/)\> [get_FontScheme](./get_fontscheme/)() | Возвращает схему шрифтов. Только для чтения [IFontSchemeEffectiveData](../ifontschemeeffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatSchemeEffectiveData](../iformatschemeeffectivedata/)\> [get_FormatScheme](./get_formatscheme/)() | Возвращает схему формата фигур. Только для чтения [IFormatSchemeEffectiveData](../iformatschemeeffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorSchemeEffectiveData](../icolorschemeeffectivedata/)\> [GetColorScheme](./getcolorscheme/)([System::Drawing::Color](../../system.drawing/color/)) | Возвращает схему цветов. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона как слабый указатель (вместо shared). Позволяет переключать указатели в контейнерах в режим слабых ссылок. |
| int [SharedCount](../../system/object/sharedcount/)() const | Получает текущующее значение счетчика совместных ссылок. |
...
Этот интерфейс используется совместно с интерфейсом [ITheme](../itheme/) для возврата эффективных значений форматирования с применением наследования.
