...
| Метод | Описание |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithemeable/createthemeeffective/)() | Возвращает эффективную тему для этого объекта, поддерживающего темы. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterThemeManager](../imasterthememanager/)\> [get_ThemeManager](./get_thememanager/)() | Возвращает менеджер основной темы. Только для чтения [IMasterThemeManager](../imasterthememanager/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Сравнивает объект типового значения со значение nullptr по ссылке. |
...
* Класс [IThemeable](../ithemeable/)
* Пространство имен [Aspose::Slides::Theme](../)
