...
description: Представляет объекты, которые могут быть стилизованы с помощью ITheme.
type: docs
weight: 443
...
Представляет объекты, которые могут быть стилизованы с помощью [ITheme](../itheme/).
...
| Метод | Описание |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() | Возвращает эффективную тему для этого объекта, поддерживающего темизацию. |
