...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Возвращает объект переопределяющей темы. Запишите [IOverrideTheme](../ioverridetheme/). |
...
| void [Unlock](../../system/object/unlock/)() | Реализует снятие блокировки оператора C# lock(). Вызывайте напрямую или используйте объект-охранник [LockContext](../../system/lockcontext/). |
...
* Класс [IOverrideThemeManager](../ioverridethememanager/)
