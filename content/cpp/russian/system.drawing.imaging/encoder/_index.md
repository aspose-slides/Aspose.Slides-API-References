...
| Метод | Описание |
| --- | --- |
|  [Encoder](./encoder/)(const [Guid](../../system/guid/)\&) | Создаёт новый экземпляр класса [Encoder](./). |
...
| [Guid](../../system/guid/) [get_Guid](./get_guid/)() const | Возвращает GUID, который определяет набор параметров кодировщика изображений, представленных текущим объектом. |
