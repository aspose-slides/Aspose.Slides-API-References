...
| **int32_t** [get_Id](./get_id/)() const | Возвращает идентификатор свойства, представленного текущим объектом. |
| **int32_t** [get_Len](./get_len/)() const | Возвращает длину свойства, представленного текущим объектом, в байтах. |
| **int16_t** [get_Type](./get_type/)() const | Возвращает тип свойства, представленного текущим объектом, в байтах. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Value](./get_value/)() const | Возвращает значение свойства, представленного текущим объектом, в байтах. |
...
| void [set_Id](./set_id/)(**int32_t**) | Устанавливает идентификатор свойства, представленного текущим объектом. |
| void [set_Len](./set_len/)(**int32_t**) | Устанавливает длину свойства, представленного текущим объектом, в байтах. |
| void [set_Type](./set_type/)(**int16_t**) | Устанавливает тип свойства, представленного текущим объектом, в байтах. |
| void [set_Value](./set_value/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Устанавливает тип свойства, представленного текущим объектом, в байтах. |
