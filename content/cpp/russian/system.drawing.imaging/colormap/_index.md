...
description: "Представляет карту для преобразования цветов. Объекты этого класса должны выделяться только с помощью функции System::MakeObject(). Никогда не создавайте экземпляр этого типа в стеке или с использованием оператора new, так как это приведёт к ошибкам выполнения и/или нарушениям утверждений. Всегда оборачивайте этот класс в указатель System::SmartPtr и используете этот указатель для передачи его функциям в качестве аргумента."
type: docs
weight: 14
url: /ru/system.drawing.imaging/colormap/
---
## ColorMap класс

Представляет карту для преобразования цветов. Объекты этого класса должны выделяться только с помощью функции [System::MakeObject()](../../system/makeobject/). Никогда не создавайте экземпляр этого типа в стеке или с использованием оператора new, так как это приведёт к ошибкам во время выполнения и/или нарушениям утверждений. Всегда оборачивайте этот класс в указатель [System::SmartPtr](../../system/smartptr/) и используйте этот указатель для передачи его функциям в качестве аргумента.
...
| [Color](../../system.drawing/color/) [get_NewColor](./get_newcolor/)() const | Возвращает новый объект [Color](../../system.drawing/color/), представляющий цвет, к которому следует преобразовать. |
| [Color](../../system.drawing/color/) [get_OldColor](./get_oldcolor/)() const | Возвращает старый объект [Color](../../system.drawing/color/), представляющий цвет, подлежащий преобразованию. |
...
| void [set_NewColor](./set_newcolor/)(const [Color](../../system.drawing/color/)\&) | Устанавливает новый объект [Color](../../system.drawing/color/), представляющий цвет, к которому следует преобразовать. |
| void [set_OldColor](./set_oldcolor/)(const [Color](../../system.drawing/color/)\&) | Устанавливает старый объект [Color](../../system.drawing/color/), представляющий цвет, подлежащий преобразованию. |
