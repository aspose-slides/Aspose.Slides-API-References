...
| Метод | Описание |
| --- | --- |
| **bool** [Equals](./equals/)([FrameDimensionPtr](../framedimensionptr/)) | Определяет, является ли указанный объект [FrameDimension](./) эквивалентным текущему объекту. |
...
|  [FrameDimension](./framedimension/)(const [System::Guid](../../system/guid/)\&) | Создаёт новый объект [FrameDimension](./) и инициализирует его указанным GUID. |
| [System::Guid](../../system/guid/) [get_Guid](./get_guid/)() const | Возвращает GUID, связанный с текущим объектом. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Page](./get_page/)() | Возвращает размер страницы. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Resolution](./get_resolution/)() | Возвращает размер разрешения. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Time](./get_time/)() | Возвращает размер времени. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Устанавливает n-й аргумент шаблона в слабый указатель (вместо совместного). Позволяет переключать указатели в контейнерах в режим слабых ссылок. |
