...
| Method | Description |
| --- | --- |
|  [EncoderParameters](./encoderparameters/)(int) | Создает новый экземпляр класса [EncoderParameters](./). |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\> [get_Param](./get_param/)() const | Возвращает массив объектов [EncoderParameter](../encoderparameter/), представленных текущим объектом [EncoderParameters](./). |
...
| void [set_Param](./set_param/)(const [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\>\&) | Назначает массив объектов [EncoderParameter](../encoderparameter/) текущему объекту [EncoderParameters](./). |
...
| void [Unlock](../../system/object/unlock/)() | Реализует разгрузку оператора C# lock(). Вызывайте напрямую или используйте охранный объект [LockContext](../../system/lockcontext/). |
