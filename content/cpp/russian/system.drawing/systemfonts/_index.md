...
description: Предоставляет набор заранее созданных объектов Font, представляющих шрифты, используемые для отображения текста в элементах отображения Windows. Это статический тип без сервисов экземпляра. Вы не должны создавать его экземпляры ни при каких обстоятельствах.
type: docs
weight: 339
url: /ru/system.drawing/systemfonts/
---
## SystemFonts класс
...
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_CaptionFont](./get_captionfont/)() | НЕ РЕАЛИЗОВАНО. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_DefaultFont](./get_defaultfont/)() | Возвращает объект [Font](../font/), представляющий шрифт по умолчанию, который приложение может использовать для диалоговых окон и форм. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_IconTitleFont](./get_icontitlefont/)() | НЕ РЕАЛИЗОВАНО. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MenuFont](./get_menufont/)() | НЕ РЕАЛИЗОВАНО. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MessageBoxFont](./get_messageboxfont/)() | НЕ РЕАЛИЗОВАНО. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_SmallCaptionFont](./get_smallcaptionfont/)() | НЕ РЕАЛИЗОВАНО. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_StatusFont](./get_statusfont/)() | НЕ РЕАЛИЗОВАНО. |
