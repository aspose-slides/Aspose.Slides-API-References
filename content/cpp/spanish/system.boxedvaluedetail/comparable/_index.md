...
description: Implementación simple de IComparable<>
type: docs
weight: 1
url: /es/system.boxedvaluedetail/comparable/
---
## Clase Comparable

Implementación simple de IComparable<>
...
| Method | Description |
| --- | --- |
| int [CompareTo](./compareto/)(T) override | Compara el objeto actual con el objeto especificado. |
