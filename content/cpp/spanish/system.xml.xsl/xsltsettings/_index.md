...
description: Especifica las características XSLT que se deben admitir durante la ejecución de la hoja de estilo XSLT.
type: docs
weight: 118
url: /es/system.xml.xsl/xsltsettings/
---
## XsltSettings clase
...
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_Default](./get_default/)() | Devuelve un objeto [XsltSettings](./) con la configuración predeterminada. El soporte para la función XSLT **document()** y los bloques de script incrustados está deshabilitado. |
| **bool** [get_EnableDocumentFunction](./get_enabledocumentfunction/)() | Devuelve un valor que indica si se debe habilitar el soporte para la función XSLT **document()**. |
| **bool** [get_EnableScript](./get_enablescript/)() | Devuelve un valor que indica si se debe habilitar el soporte para los bloques de script incrustados. |
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_TrustedXslt](./get_trustedxslt/)() | Devuelve un objeto [XsltSettings](./) que habilita el soporte para la función XSLT **document()** y los bloques de script incrustados. |
...
| void [set_EnableDocumentFunction](./set_enabledocumentfunction/)(**bool**) | Establece un valor que indica si se debe habilitar el soporte para la función XSLT **document()**. |
| void [set_EnableScript](./set_enablescript/)(**bool**) | Establece un valor que indica si se debe habilitar el soporte para los bloques de script incrustados. |
