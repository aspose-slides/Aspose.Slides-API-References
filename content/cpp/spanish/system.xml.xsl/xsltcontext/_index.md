...
description: Encapsula el contexto de ejecución actual del procesador Extensible Stylesheet Language for Transformations (XSLT) que permite que el Lenguaje de Ruta XML (XPath) resuelva funciones, parámetros y espacios de nombres dentro de expresiones XPath.
type: docs
weight: 79
url: /es/system.xml.xsl/xsltcontext/
---
## XsltContext clase
...
| Method | Description |
| --- | --- |
| virtual void [AddNamespace](../../system.xml/xmlnamespacemanager/addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Agrega el espacio de nombres dado a la colección. |
...
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | Cuando se sobrescribe en una clase derivada, compara los Uniform Resource Identifiers (URIs) base de dos documentos según el orden en que los documentos fueron cargados por el procesador XSLT (es decir, la clase [XslTransform](../xsltransform/)). |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | Devuelve el URI del espacio de nombres para el espacio de nombres predeterminado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | Devuelve el [XmlNameTable](../../system.xml/xmlnametable/) asociado con este objeto. |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | Cuando se sobrescribe en una clase derivada, obtiene un valor que indica si incluir nodos de espacio en blanco en la salida. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | Devuelve un enumerador para usar al iterar a través de los espacios de nombres en el [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo al método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite el hash de objetos personalizados. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](../../system.xml/xmlnamespacemanager/getnamespacesinscope/)([XmlNamespaceScope](../../system.xml/xmlnamespacescope/)) override | Devuelve una colección de nombres de espacios de nombres indexados por prefijo que pueden usarse para enumerar los espacios de nombres actualmente en alcance. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtiene el tipo real del objeto. Análogo a la llamada C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [HasNamespace](../../system.xml/xmlnamespacemanager/hasnamespace/)([String](../../system/string/)) | Devuelve un valor que indica si el prefijo suministrado tiene un espacio de nombres definido para el alcance actual empujado. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina si algún elemento de la secuencia existe o cumple una condición. |
...
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | Devuelve el URI del espacio de nombres para el prefijo especificado. |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | Encuentra el prefijo declarado para el URI de espacio de nombres dado. |
...
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | Elimina del stack el alcance de un espacio de nombres. |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | Cuando se sobrescribe en una clase derivada, evalúa si preservar los nodos de espacio en blanco o eliminarlos para el contexto dado. |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | Empuja un alcance de espacio de nombres al stack. |
...
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Elimina el espacio de nombres dado para el prefijo dado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextFunction](../ixsltcontextfunction/)\> [ResolveFunction](./resolvefunction/)([String](../../system/string/), [String](../../system/string/), [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\>) | Cuando se sobrescribe en una clase derivada, resuelve una referencia a función y devuelve un [IXsltContextFunction](../ixsltcontextfunction/) que representa la función. El [IXsltContextFunction](../ixsltcontextfunction/) se usa en tiempo de ejecución para obtener el valor de retorno de la función. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | Cuando se sobrescribe en una clase derivada, resuelve una referencia a variable y devuelve un [IXsltContextVariable](../ixsltcontextvariable/) que representa la variable. |
...
|  [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Inicializa una nueva instancia de la clase [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) con el [XmlNameTable](../../system.xml/xmlnametable/) especificado. |
