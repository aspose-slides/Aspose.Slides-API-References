...
description: La excepción que se lanza cuando ocurre un error al procesar una transformación XSLT.
type: docs
weight: 14
url: /es/system.xml.xsl/details_xsltexception/
---
## Details_XsltException clase


La excepción que se lanza cuando ocurre un error al procesar una transformación XSLT.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Devuelve el número de línea que indica dónde ocurrió el error en la hoja de estilo. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Devuelve la posición de la línea que indica dónde ocurrió el error en la hoja de estilo. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Devuelve el mensaje de error formateado que describe la excepción actual. |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Devuelve la ruta de ubicación de la hoja de estilo. |
