...
description: Representa una colección de IChartCategory
type: docs
weight: 599
...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Si la categoría existe en la colección, la devuelve. De lo contrario crea una nueva categoría de gráfico a partir de [IChartDataCell](../ichartdatacell/) y la agrega a la colección. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Crea un nuevo [IChartCategory](../ichartcategory/) a partir del valor y lo agrega a la colección. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Obtiene un iterador que apunta al primer elemento con calificador const (si lo hay) de la colección. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Obtiene un iterador que apunta justo después del último elemento con calificador const (si lo hay) de la colección. |
| virtual void [Clear](./clear/)() | Elimina todos los elementos de la colección. |
| virtual void [CopyTo](../../aspose.slides/igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Copia todos los elementos de la colección en la matriz especificada. |
...
| virtual **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() | Devuelve el recuento de niveles de agrupación de categorías usados. Es mayor que uno para categorías multinivel. Solo lectura **int32_t**. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Devuelve un valor que indica si el acceso a la colección está sincronizado (seguro para hilos). Solo lectura **bool**. |
...
| virtual **bool** [get_UseCells](./get_usecells/)() | Si es verdadero, la hoja de cálculo se usa para almacenar categorías (este caso admite categorías multinivel). Si es falso, la hoja de cálculo NO se usa para almacenar valores (y este caso no admite categorías multinivel). Lee **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) | Obtiene el elemento en el índice especificado. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Busca el [IChartCategory](../ichartcategory/) especificado y devuelve el índice basado en cero de la primera aparición dentro de toda la colección. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Elimina el valor especificado. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Elimina el elemento en el índice dado. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| virtual void [set_UseCells](./set_usecells/)(**bool**) | Si es verdadero, la hoja de cálculo se usa para almacenar categorías (este caso admite categorías multinivel). Si es falso, la hoja de cálculo NO se usa para almacenar valores (y este caso no admite categorías multinivel). Escribe **bool**. |
