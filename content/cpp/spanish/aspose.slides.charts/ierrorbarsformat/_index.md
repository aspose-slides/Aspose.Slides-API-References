...
Representa las barras de error de una serie de gráficos. Los valores personalizados de ErrorBars están en [IChartDataPointCollection](../ichartdatapointcollection/) (en la propiedad [IChartDataPoint::get_ErrorBarsCustomValues()](../ichartdatapoint/get_errorbarscustomvalues/)).
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Representa el formato de las barras de error. Lee [IFormat](../iformat/). |
| virtual **bool** [get_HasEndCap](./get_hasendcap/)() | Especifica que no se dibuja una tapa final en las barras de error. Lee **bool**. |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | Obtiene la visibilidad de las barras de error. Lee **bool**. |
...
| virtual [ErrorBarType](../errorbartype/) [get_Type](./get_type/)() | Obtiene el tipo de barras de error. Lee [ErrorBarType](../errorbartype/). |
| virtual **float** [get_Value](./get_value/)() | Obtiene el valor que se usa con los tipos de valor Fixed, Percentage y StandardDeviation para determinar la longitud de las barras de error. Lee **float**. |
| virtual [ErrorBarValueType](../errorbarvaluetype/) [get_ValueType](./get_valuetype/)() | Representa posibles formas de determinar la longitud de las barras de error. En caso de tipo de valor personalizado, para especificar el valor use la propiedad [IChartDataPoint::get_ErrorBarsCustomValues()](../ichartdatapoint/get_errorbarscustomvalues/) del punto de datos específico en la colección DataPoints de la serie.\n\nLee [ErrorBarValueType](../errorbarvaluetype/). |
...
| virtual void [set_Format](./set_format/)([System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\>) | Representa el formato de las barras de error. Escribe [IFormat](../iformat/). |
| virtual void [set_HasEndCap](./set_hasendcap/)(**bool**) | Especifica que no se dibuja una tapa final en las barras de error. Escribe **bool**. |
| virtual void [set_IsVisible](./set_isvisible/)(**bool**) | Establece la visibilidad de las barras de error. Escribe **bool**. |
| virtual void [set_Type](./set_type/)([ErrorBarType](../errorbartype/)) | Establece el tipo de las barras de error. Escribe [ErrorBarType](../errorbartype/). |
| virtual void [set_Value](./set_value/)(**float**) | Establece el valor que se usa con los tipos de valor Fixed, Percentage y StandardDeviation para determinar la longitud de las barras de error. Escribe **float**. |
| virtual void [set_ValueType](./set_valuetype/)([ErrorBarValueType](../errorbarvaluetype/)) | Representa posibles formas de determinar la longitud de las barras de error. En caso de tipo de valor personalizado, para especificar el valor use la propiedad [IChartDataPoint::get_ErrorBarsCustomValues()](../ichartdatapoint/get_errorbarscustomvalues/) del punto de datos específico en la colección DataPoints de la serie.\n\nEscribe [ErrorBarValueType](../errorbarvaluetype/). |
