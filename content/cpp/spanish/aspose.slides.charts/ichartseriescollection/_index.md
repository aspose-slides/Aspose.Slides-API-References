...
description: Representa una colección de IChartSeries
type: docs
weight: 833
url: /es/aspose.slides.charts/ichartseriescollection/
---
## IChartSeriesCollection clase

Representa una colección de [IChartSeries](../ichartseries/)
```cpp
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) | Crea una nueva serie de gráfico y la agrega a la colección. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) | Crea una nueva serie de gráfico a partir de [IChartDataCell](../ichartdatacell/) y la agrega a la colección. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) | Crea una nueva serie de gráfico a partir de [IChartCellCollection](../ichartcellcollection/) y la agrega a la colección. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) | Crea una nueva serie de gráfico a partir de un valor y la agrega a la colección. |
...
| virtual void [Clear](./clear/)() | Elimina todos los elementos (incluido el estilo de gráfico) de la colección. |
...
| virtual **int32_t** [get_Count](../../aspose.slides/igenericcollection/get_count/)() | Devuelve el número de comportamientos en una colección. Sólo lectura **int32_t**. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Devuelve un valor que indica si el acceso a la colección está sincronizado (seguro para subprocesos). Sólo lectura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../../aspose.slides/igenericcollection/get_syncroot/)() | Devuelve una raíz de sincronización. Sólo lectura [System::Object](../../system/object/). |
...
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Busca el [IChartSeries](../ichartseries/) especificado y devuelve el índice basado en cero de la primera aparición dentro de toda la colección. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) | Crea una nueva serie de gráfico y la inserta en la colección. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Concat](../../system.collections.generic/ienumerable/linq_concat/)([SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\>) | Concatenar dos secuencias. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Elimina el valor especificado. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Elimina el elemento en el índice especificado |
