...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Obtiene el relleno del marcador. Solo lectura [IFormat](../iformat/). |
| virtual **int32_t** [get_Size](./get_size/)() | Representa el tamaño del marcador en un gráfico de líneas, de dispersión o de radar. Lee **int32_t**. |
| virtual [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() | Representa el estilo del marcador en un gráfico de líneas, de dispersión o de radar. Lee [MarkerStyleType](../markerstyletype/). |
...
| virtual void [set_Size](./set_size/)(**int32_t**) | Representa el tamaño del marcador en un gráfico de líneas, de dispersión o de radar. Escribe **int32_t**. |
| virtual void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) | Representa el estilo del marcador en un gráfico de líneas, de dispersión o de radar. Escribe [MarkerStyleType](../markerstyletype/). |
