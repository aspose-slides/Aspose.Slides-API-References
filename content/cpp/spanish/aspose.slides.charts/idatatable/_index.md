...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Devuelve los estilos de línea, relleno y efecto de un objeto. Sólo lectura [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | Verdadero si la tabla de datos del gráfico tiene bordes de celda horizontales. Leer **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | Verdadero si la tabla de datos del gráfico tiene bordes de contorno. Leer **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | Verdadero si la tabla de datos del gráfico tiene bordes de celda verticales. Leer **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | Verdadero si la clave de leyenda de etiqueta de datos es visible. Leer **bool**. |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | Verdadero si la tabla de datos del gráfico tiene bordes de celda horizontales. Escribir **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | Verdadero si la tabla de datos del gráfico tiene bordes de contorno. Escribir **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | Verdadero si la tabla de datos del gráfico tiene bordes de celda verticales. Escribir **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | Verdadero si la clave de leyenda de etiqueta de datos es visible. Escribir **bool**. |
