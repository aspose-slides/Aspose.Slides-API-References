...
| [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](./get_chart/)() override | Devuelve el gráfico. Sólo lectura [IChart](../ichart/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Devuelve los estilos de línea, relleno y efecto de un objeto. Sólo lectura [IFormat](../iformat/). |
| **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() override | Verdadero si la tabla de datos del gráfico tiene bordes de celda horizontales. Lee **bool**. |
| **bool** [get_HasBorderOutline](./get_hasborderoutline/)() override | Verdadero si la tabla de datos del gráfico tiene bordes de contorno. Lee **bool**. |
| **bool** [get_HasBorderVertical](./get_hasbordervertical/)() override | Verdadero si la tabla de datos del gráfico tiene bordes de celda verticales. Lee **bool**. |
| **bool** [get_ShowLegendKey](./get_showlegendkey/)() override | Verdadero si la clave de leyenda de etiqueta de datos es visible. Lee **bool**. |
...
| void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) override | Verdadero si la tabla de datos del gráfico tiene bordes de celda horizontales. Escribe **bool**. |
| void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) override | Verdadero si la tabla de datos del gráfico tiene bordes de contorno. Escribe **bool**. |
| void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) override | Verdadero si la tabla de datos del gráfico tiene bordes de celda verticales. Escribe **bool**. |
| void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) override | Verdadero si la clave de leyenda de etiqueta de datos es visible. Escribe **bool**. |
