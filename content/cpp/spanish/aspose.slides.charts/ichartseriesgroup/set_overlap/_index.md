...
description: Especifica cuánto se superponen las barras y columnas en gráficos 2-D, como un porcentaje (de -100% a 100%).
type: docs
weight: 196
url: /es/aspose.slides.charts/ichartseriesgroup/set_overlap/
---
## IChartSeriesGroup::set_Overlap(int8_t) método


Specifica cuánto se superponen las barras y columnas en gráficos 2-D, como un porcentaje (de -100 % a 100 %).
...
El siguiente ejemplo demuestra cómo establecer la superposición para un grupo de series de gráfico y renderizar el gráfico resultante en un formulario: 
```cpp
