...
description: Representa una colección de ChartSeries
type: docs
weight: 287
url: /es/aspose.slides.charts/chartseriescollection/
---
## ChartSeriesCollection clase

Representa una colección de [ChartSeries](../chartseries/)
...
| Método | Descripción |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) override | Crea una nueva serie de gráfico y la agrega a la colección. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) override | Crea una nueva serie de gráfico a partir de [ChartDataCell](../chartdatacell/) y la agrega a la colección. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) override | Crea una nueva serie de gráfico a partir de [ChartCellCollection](../chartcellcollection/) y la agrega a la colección. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) override | Crea una nueva serie de gráfico a partir del valor y la agrega a la colección. |
...
| void [Clear](./clear/)() override | Elimina todos los controles de la colección. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>, **int32_t**) override | Copia todos los elementos de la colección en la matriz especificada. |
...
| **int32_t** [get_Count](./get_count/)() override | Devuelve el número de objetos en la colección. Solo lectura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que recorre la colección. |
...
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Busca el [ChartSeries](../chartseries/) especificado y devuelve el índice basado en cero de la primera aparición dentro de toda la colección |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) override | Crea una nueva serie de gráfico e inserta en la colección. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Elimina el valor especificado. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Elimina un control ActiveX almacenado en la posición especificada de la colección. |
...
* Clase [IChartSeriesCollection](../ichartseriescollection/)
