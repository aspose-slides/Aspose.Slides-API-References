...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [Add](./add/)([TrendlineType](../trendlinetype/)) | Agrega el nuevo [Trendline](../trendline/) al final de una colección y lo devuelve. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [idx_get](./idx_get/)(**int32_t**) | Obtiene el elemento en el índice especificado. Solo lectura [ITrendline](../itrendline/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\>) | Elimina el valor especificado. |
