...
description: Especifica los valores de la barra de errores. Sólo debe usarse cuando el tipo de valor de las barras de error es Custom.
type: docs
weight: 469
...
Especifica los valores de la barra de errores. Sólo debe usarse cuando el tipo de valor de las barras de error es Custom.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() override | Especifica el valor de la barra de error en la dirección negativa. Disponible si el tipo de valor de las barras de error es Custom y ErrorBarsXFormat está permitido. En cualquier otro caso esta propiedad devuelve null. Solo lectura [IDoubleChartValue](../idoublechartvalue/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() override | Especifica el valor de la barra de error en la dirección positiva. Disponible si el tipo de valor de las barras de error es Custom y ErrorBarsXFormat está permitido. En cualquier otro caso esta propiedad devuelve null. Solo lectura [IDoubleChartValue](../idoublechartvalue/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() override | Especifica el valor de la barra de error en la dirección negativa. Disponible si el tipo de valor de las barras de error es Custom y ErrorBarsYFormat está permitido. En cualquier otro caso esta propiedad devuelve null. Solo lectura [IDoubleChartValue](../idoublechartvalue/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() override | Especifica el valor de la barra de error en la dirección positiva. Disponible si el tipo de valor de las barras de error es Custom y ErrorBarsYFormat está permitido. En cualquier otro caso esta propiedad devuelve null. Solo lectura [IDoubleChartValue](../idoublechartvalue/). |
...
* Clase [IErrorBarsCustomValues](../ierrorbarscustomvalues/)
