...
description: Proporciona acceso a las barras de subida/bajada de un gráfico de líneas o de valores.
type: docs
weight: 1392
url: /es/aspose.slides.charts/updownbarsmanager/
---
## UpDownBarsManager clase

Proporciona acceso a las barras de subida/bajada de un gráfico de líneas o de valores.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() override | Devuelve el formato DownBars. Solo lectura [IFormat](../iformat/). |
| **int32_t** [get_GapWidth](./get_gapwidth/)() override | GapWidth. Lectura **int32_t**. |
| **bool** [get_HasUpDownBars](./get_hasupdownbars/)() override | HasUpDownBars. Lectura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() override | Devuelve el formato UpBars. Solo lectura [IFormat](../iformat/). |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo del statement C# lock(). Llama directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [set_GapWidth](./set_gapwidth/)(**int32_t**) override | GapWidth. Escritura **int32_t**. |
| void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) override | HasUpDownBars. Escritura **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo del statement C# lock(). Llama directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
...
* Clase [IUpDownBarsManager](../iupdownbarsmanager/)
