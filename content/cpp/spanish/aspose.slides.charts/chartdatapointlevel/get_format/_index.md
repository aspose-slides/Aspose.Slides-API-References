...
description: Representa las propiedades de formato del nivel del punto de datos. Lea IFormat.
type: docs
weight: 1
url: /es/aspose.slides.charts/chartdatapointlevel/get_format/
---
## ChartDataPointLevel::get_Format() método

Representa las propiedades de formato del nivel del punto de datos. Lea [IFormat](../../iformat/).
