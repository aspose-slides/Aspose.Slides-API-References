...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Representa las propiedades de formato del nivel de punto de datos. Leer [IFormat](../iformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() override | Representa la etiqueta de datos del nivel de punto de datos. Se aplica a los tipos de serie Treemap y Sunburst. Solo lectura [IDataLabel](../idatalabel/). |
...
* Clase [IChartDataPointLevel](../ichartdatapointlevel/)
