...
| virtual **int32_t** [get_Count](./get_count/)() | Obtiene el número de todas las etiquetas de datos en la colección. Sólo lectura **int32_t**. |
| virtual **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() | Obtiene el número de etiquetas de datos visibles en la colección. Sólo lectura **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() | Devuelve el formato predeterminado de todas las etiquetas de datos en la colección. Sólo lectura [IDataLabelFormat](../idatalabelformat/). |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | False indica que la etiqueta de datos no es visible por defecto (por lo que todas las banderas Show*- (ShowValue, ...) de la propiedad DefaultDataLabelFormat son false). Sólo lectura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() | Representa el formato de líneas guía de las etiquetas de datos. Sólo lectura [IChartLinesFormat](../ichartlinesformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() | Devuelve la serie del gráfico padre. Sólo lectura [IChartSeries](../ichartseries/). |
...
| virtual void [Hide](./hide/)() | Oculta la etiqueta de datos por defecto estableciendo todas las banderas Show*- (ShowValue, ...) de la propiedad DefaultDataLabelFormat a false. IsVisible será false después de esto. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) | Obtiene la etiqueta de datos para el punto de datos con el índice especificado. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) | Devuelve un índice del [DataLabel](../datalabel/) especificado en la colección. |
