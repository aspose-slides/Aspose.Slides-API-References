...
description: Representa la colección de ChartCategory
type: docs
weight: 79
...
| Método | Descripción |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Si la categoría existe en la colección, la devuelve. De lo contrario crea una nueva categoría de gráfico a partir de [IChartDataCell](../ichartdatacell/) y la agrega a la colección. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Crea un nuevo [ChartCategory](../chartcategory/) a partir del valor y lo agrega a la colección. |
| [iterator](./iterator/) [begin](./begin/)() | Obtiene un iterador que apunta al primer elemento (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtiene un iterador que apunta al primer elemento (si lo hay) de la instancia de la colección calificada como const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtiene un iterador que apunta al primer elemento calificado como const (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtiene un iterador que apunta justo después del último elemento calificado como const (si lo hay) de la colección. |
| void [Clear](./clear/)() override | Elimina todos los elementos de la colección. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>, **int32_t**) override | Copia todos los elementos de la colección al array especificado. |
| [iterator](./iterator/) [end](./end/)() | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la instancia de la colección calificada como const. |
...
| **int32_t** [get_Count](./get_count/)() override | Devuelve el número de elementos en la colección. Solo lectura **int32_t**. |
| **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() override | Devuelve el recuento de niveles de agrupamiento de categorías utilizados. Es mayor que uno para categorías de varios niveles. Solo lectura **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Devuelve un valor que indica si el acceso a la Lista está sincronizado (seguro para hilos). Solo lectura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Devuelve un objeto que puede usarse para sincronizar el acceso a la colección. Solo lectura [System::Object](../../system/object/). |
| **bool** [get_UseCells](./get_usecells/)() override | Si es verdadero, la hoja de cálculo se usa para almacenar categorías (este caso admite categorías multinivel). Si es falso, la hoja de cálculo NO se usa para almacenar valores (y este caso no admite categorías multinivel). Lee **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que itera a través de la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) override | Obtiene el elemento en el índice especificado. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | Busca el [ChartCategory](../chartcategory/) especificado y devuelve el índice base cero de la primera aparición dentro de toda la Colección. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina si existe algún elemento en la secuencia o si satisface una condición. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | Elimina el valor especificado. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Elimina el elemento en el índice dado. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| void [set_UseCells](./set_usecells/)(**bool**) override | Si es verdadero, la hoja de cálculo se usa para almacenar categorías (este caso admite categorías multinivel). Si es falso, la hoja de cálculo NO se usa para almacenar valores (y este caso no admite categorías multinivel). Escribe **bool**. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtiene un iterador que apunta al primer elemento (si lo hay) de la instancia de la colección calificada como const. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la instancia de la colección calificada como const. |
