...
description: Especifica cuánto deben superponerse las barras y columnas en los gráficos 2-D, como un porcentaje (de -100% a 100%).
type: docs
weight: 170
url: /es/aspose.slides.charts/chartseriesgroup/set_overlap/
---
## ChartSeriesGroup::set_Overlap(int8_t) método


Especifica cuánto deben superponerse las barras y columnas en los gráficos 2-D, como un porcentaje (de -100% a 100%).
...
* 100%: Superposición máxima (las barras se superponen completamente entre sí). Esta propiedad es lectura/escritura **int8_t**.
