...
description: Especifica cuánto se superponen las barras y columnas en los gráficos 2-D, como porcentaje (de -100% a 100%).
type: docs
weight: 157
url: /es/aspose.slides.charts/chartseriesgroup/get_overlap/
---
## ChartSeriesGroup::get_Overlap() método

Especifica cuánto se superponen las barras y columnas en los gráficos 2-D, como porcentaje (de -100% a 100%).
...
* 100%: Superposición máxima (las barras se superponen completamente). Esta propiedad es de lectura/escritura **int8_t**.
