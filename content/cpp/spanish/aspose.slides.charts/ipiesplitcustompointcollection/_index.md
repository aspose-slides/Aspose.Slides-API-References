...
description: Representa una colección de puntos que se dibujarán en el segundo pastel o barra en un gráfico de barra-sobre-pastel o pastel-sobre-pastel con una división personalizada.
type: docs
weight: 1158
url: /es/aspose.slides.charts/ipiesplitcustompointcollection/
---
## IPieSplitCustomPointCollection clase

Representa una colección de puntos que se dibujarán en el segundo pastel o barra en un gráfico de barra-sobre-pastel o pastel-sobre-pastel con una división personalizada.
...
| Método | Descripción |
| --- | --- |
| virtual void [Add](./add/)(const **int32_t**\&) | Agrega un punto de datos mediante su índice en la colección de puntos de la serie principal. |
...
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia todos los elementos de la colección a los elementos existentes de la matriz. |
...
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | Comprueba si la colección es solo de lectura. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve el punto de datos del gráfico por índice. |
...
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)() | Devuelve el primer elemento de la secuencia. |
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)(const [Func](../../system/func/)\<T, **bool**\>\&) | Devuelve el primer elemento de la secuencia que cumple la condición especificada. |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Devuelve el primer elemento de la secuencia, o un valor predeterminado si la secuencia está vacía. |
...
| T [LINQ_Last](../../system.collections.generic/ienumerable/linq_last/)() | Devuelve el último elemento de la secuencia. |
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Devuelve el último elemento de la secuencia, o un valor predeterminado si la secuencia está vacía. |
...
| virtual void [Remove](./remove/)(**int32_t**) | Elimina un elemento de la colección por su índice en la colección de puntos de la serie principal. |
