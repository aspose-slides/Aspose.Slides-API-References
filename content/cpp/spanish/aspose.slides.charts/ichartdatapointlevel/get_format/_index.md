...
description: Representa las propiedades de formato del nivel de punto de datos. Lea IFormat.
type: docs
weight: 1
url: /es/aspose.slides.charts/ichartdatapointlevel/get_format/
---
## IChartDataPointLevel::get_Format() método


Representa propiedades de formato del nivel de punto de datos. Lea [IFormat](../../iformat/).
