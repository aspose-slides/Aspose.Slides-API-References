...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Representa las propiedades de formato del nivel del punto de datos. Leer [IFormat](../iformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | Representa la etiqueta de datos del nivel del punto de datos. Se aplica a los tipos de series Treemap y Sunburst. Solo lectura [IDataLabel](../idatalabel/). |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo de la instrucción lock() de C#. Llámalos directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la liberación de la instrucción lock() de C#. Llámalos directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
