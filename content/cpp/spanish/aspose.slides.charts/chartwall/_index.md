...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Devuelve el relleno de la pared, línea, efecto, estilos 3d. Solo lectura [IFormat](../iformat/). |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | Devuelve o establece el tipo de imagen. Solo lectura [Charts::PictureType](../picturetype/). |
| **int32_t** [get_Thickness](./get_thickness/)() override | Devuelve el grosor de las paredes como un porcentaje de la mayor dimensión del volumen del gráfico. Solo lectura **int32_t**. |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | Devuelve o establece el tipo de imagen. Escritura [Charts::PictureType](../picturetype/). |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | Establece el grosor de las paredes como un porcentaje de la mayor dimensión del volumen del gráfico. Escritura **int32_t**. |
