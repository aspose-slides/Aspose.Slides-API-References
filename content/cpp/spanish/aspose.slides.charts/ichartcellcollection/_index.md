...
| Método | Descripción |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Añade una nueva celda a la colección. |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Crea [IChartDataCell](../ichartdatacell/) a partir del valor especificado y lo añade a la colección. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Obtiene el recuento de celdas en la colección. Sólo lectura **int32_t**. |
| virtual [System::String](../../system/string/) [GetCellsAddress](./getcellsaddress/)() | Devuelve la dirección del conjunto de celdas en el libro de trabajo. |
| virtual [System::String](../../system/string/) [GetConcatenatedValuesFromCells](./getconcatenatedvaluesfromcells/)() | Cadena de concatenación de los valores de cadena de todas las celdas. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve una celda ([IChartDataCell](../ichartdatacell/)) por índice. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Elimina una celda de la colección por índice. |
