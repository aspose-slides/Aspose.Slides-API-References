...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_HorizontalAxis](./get_horizontalaxis/)() | Obtiene el eje horizontal del gráfico. Sólo lectura [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryHorizontalAxis](./get_secondaryhorizontalaxis/)() | Obtiene el eje horizontal secundario del gráfico. Sólo lectura [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryVerticalAxis](./get_secondaryverticalaxis/)() | Obtiene el eje vertical secundario del gráfico. Sólo lectura [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SeriesAxis](./get_seriesaxis/)() | Obtiene el eje de series del gráfico. Sólo lectura [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_VerticalAxis](./get_verticalaxis/)() | Obtiene el eje vertical del gráfico. Sólo lectura [IAxis](../iaxis/). |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo de la declaración lock() de C#. Llamar directamente o usar el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo de la declaración lock() de C#. Llamar directamente o usar el objeto centinela [LockContext](../../system/lockcontext/). |
