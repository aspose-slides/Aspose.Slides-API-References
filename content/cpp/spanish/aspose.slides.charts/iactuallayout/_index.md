...
| virtual **float** [get_ActualHeight](./get_actualheight/)() | Especifica la altura real del elemento de gráfico. Llame al método [IChart::ValidateChartLayout](../ichart/validatechartlayout/) antes para obtener los valores reales. Lee **float**. |
| virtual **float** [get_ActualWidth](./get_actualwidth/)() | Especifica el ancho real del elemento de gráfico. Llame al método [IChart::ValidateChartLayout](../ichart/validatechartlayout/) antes para obtener los valores reales. Lee **float**. |
| virtual **float** [get_ActualX](./get_actualx/)() | Especifica la ubicación x real (izquierda) del elemento de gráfico relativo a la esquina superior izquierda del gráfico. Llame al método [IChart::ValidateChartLayout](../ichart/validatechartlayout/) antes para obtener los valores reales. Lee **float**. |
| virtual **float** [get_ActualY](./get_actualy/)() | Especifica la parte superior real del elemento de gráfico relativo a la esquina superior izquierda del gráfico. Llame al método [IChart::ValidateChartLayout](../ichart/validatechartlayout/) antes para obtener los valores reales. Lee **float**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el n'th argumento de plantilla como un puntero débil (en lugar de compartido). Permite cambiar los punteros en contenedores al modo débil. |
