...
| **int32_t** [get_Count](./get_count/)() override | Obtiene el número de entradas de leyenda. Solo lectura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILegendEntryProperties](../ilegendentryproperties/)\> [idx_get](./idx_get/)(**int32_t**) override | Obtiene las propiedades de la entrada de leyenda correspondiente a [Chart::get_ChartData()](../chart/get_chartdata/)->get_Series()[0].DataPoints[index] en caso de tipo de gráfico de esta lista: [ChartType::BarOfPie](../charttype/), [ChartType::ExplodedPie](../charttype/), [ChartType::ExplodedPie3D](../charttype/), [ChartType::Pie](../charttype/), [ChartType::Pie3D](../charttype/), [ChartType::PieOfPie](../charttype/); o correspondiente a [Chart::get_ChartData()](../chart/get_chartdata/)->get_Series()[index] para otros tipos de gráfico. |
...
* Clase [ILegendEntryCollection](../ilegendentrycollection/)
