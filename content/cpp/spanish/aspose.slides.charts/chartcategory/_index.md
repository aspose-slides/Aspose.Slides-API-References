...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() override | Devuelve el objeto [IChartDataCell](../ichartdatacell/). Si la categoría es multinivel entonces se usa el objeto [IChartDataCell](../ichartdatacell/) para el nivel \"0\". Lea [IChartDataCell](../ichartdatacell/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_AsLiteral](./get_asliteral/)() override | Devuelve el objeto AsLiteral. Lea [System::Object](../../system/object/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_GroupingLevel](./get_groupinglevel/)(**int32_t**) override | Devuelve un nivel de agrupación de categoría de gráfico en el índice especificado. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)\> [get_GroupingLevels](./get_groupinglevels/)() override | Contenedor gestionado de los valores de los niveles de agrupación de la categoría del gráfico. Una categoría multinivel contiene más de un nivel de agrupación. La indexación de los niveles de agrupación comienza en cero. Solo lectura [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/). |
| **bool** [get_UseCell](./get_usecell/)() override | Si es true entonces la propiedad AsCell es actual. En otras palabras, la hoja de cálculo se usa para almacenar la categoría (este caso admite una categoría multinivel). Si es false entonces la propiedad AsLiteral es actual. En otras palabras, la hoja de cálculo NO se usa para almacenar la categoría (y este caso no admite categorías multinivel). Solo lectura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | Si UseCell es true entonces esta propiedad representa la propiedad [get_AsCell()](./get_ascell/)->get(set)_Value(). Si UseCell es false entonces esta propiedad representa la propiedad AsLiteral. Lea [System::Object](../../system/object/). |
...
| void [Remove](./remove/)() override | Elimina la categoría del gráfico. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Establece el objeto [IChartDataCell](../ichartdatacell/). Si la categoría es multinivel entonces se usa el objeto [IChartDataCell](../ichartdatacell/) para el nivel \"0\". Escriba [IChartDataCell](../ichartdatacell/). |
| void [set_AsLiteral](./set_asliteral/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Establece el objeto AsLiteral. Escriba [System::Object](../../system/object/). |
| void [set_Value](./set_value/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Si UseCell es true entonces esta propiedad representa la propiedad [get_AsCell()](./get_ascell/)->get(set)_Value(). Si UseCell es false entonces esta propiedad representa la propiedad AsLiteral. Escriba [System::Object](../../system/object/). |
