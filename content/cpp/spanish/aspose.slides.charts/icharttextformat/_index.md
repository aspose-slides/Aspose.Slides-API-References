...
description: Chart opera con un conjunto restringido de propiedades de formato de texto. Las interfaces IChartTextFormat, IChartTextBlockFormat, IChartParagraphFormat, IChartPortionFormat describen este conjunto restringido.
type: docs
weight: 898
url: /es/aspose.slides.charts/icharttextformat/
---
## IChartTextFormat clase

[Chart](../chart/) opera con un conjunto restringido de propiedades de formato de texto. [IChartTextFormat](./), [IChartTextBlockFormat](../icharttextblockformat/), [IChartParagraphFormat](../ichartparagraphformat/), [IChartPortionFormat](../ichartportionformat/) interfaces describen este conjunto restringido.
...
| Método | Descripción |
| --- | --- |
| virtual void [CopyFrom](./copyfrom/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) | Copia el formato de texto del marco de texto especificado. |
| virtual void [CopyTo](./copyto/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) | Copia el formato de texto al marco de texto especificado. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartParagraphFormat](../ichartparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() | Devuelve el formato de párrafo. Solo lectura [IChartParagraphFormat](../ichartparagraphformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartPortionFormat](../ichartportionformat/)\> [get_PortionFormat](./get_portionformat/)() | Devuelve el formato de porción. Solo lectura [IChartPortionFormat](../ichartportionformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartTextBlockFormat](../icharttextblockformat/)\> [get_TextBlockFormat](./get_textblockformat/)() | Devuelve el formato para los elementos de texto del gráfico. Solo lectura [IChartTextBlockFormat](../icharttextblockformat/). |
