...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el n'th argumento de plantilla como un puntero weak (en lugar de shared). Permite cambiar punteros en contenedores a modo weak. |
