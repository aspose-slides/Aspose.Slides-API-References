...
description: "Política de caché de solicitudes común utilizada para el almacenamiento en caché de Http, FTP, etc. Los objetos de esta clase solo deben asignarse mediante la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila o usando operator new, ya que provocará errores en tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a funciones como argumento."
type: docs
weight: 14
url: /es/system.net.cache/requestcachepolicy/
---
## RequestCachePolicy clase


Política de caché de solicitudes común utilizada para el almacenamiento en caché de [Http](../../system.net.http/), FTP, etc. Los objetos de esta clase solo deben asignarse mediante la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando operator new, ya que provocará errores en tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento.
...
| [RequestCacheLevel](../requestcachelevel/) [get_Level](./get_level/)() | Obtiene el valor RequestCacheLevel especificado. |
...
|  [RequestCachePolicy](./requestcachepolicy/)() | Construye una nueva instancia. |
|  [RequestCachePolicy](./requestcachepolicy/)([RequestCacheLevel](../requestcachelevel/)) | Construye una nueva instancia con el valor RequestCacheLevel especificado. |
