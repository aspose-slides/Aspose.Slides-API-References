...
| [DateTime](../../system/datetime/) [get_CacheSyncDate](./get_cachesyncdate/)() const | Obtiene la hora en que los recursos almacenados en la caché deben ser revalidados. |
| [DateTime](../../system/datetime/) [get_InternalCacheSyncDateUtc](./get_internalcachesyncdateutc/)() const | Obtiene la hora en formato UTC en que los recursos almacenados en la caché deben ser revalidados. Solo para uso interno. |
| [HttpRequestCacheLevel](../httprequestcachelevel/) [get_Level](./get_level/)() const | Obtiene el valor especificado de HttpRequestCacheLevel. |
| [RequestCacheLevel](../requestcachelevel/) [get_Level](../requestcachepolicy/get_level/)() | Obtiene el valor especificado de RequestCacheLevel. |
| [TimeSpan](../../system/timespan/) [get_MaxAge](./get_maxage/)() const | Obtiene la edad máxima permitida para un recurso. |
| [TimeSpan](../../system/timespan/) [get_MaxStale](./get_maxstale/)() const | Obtiene el valor máximo de obsolescencia que se permite para un recurso. |
| [TimeSpan](../../system/timespan/) [get_MinFresh](./get_minfresh/)() const | Obtiene la edad mínima permitida para un recurso. |
...
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpRequestCacheLevel](../httprequestcachelevel/)) | Construye una nueva instancia. |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpCacheAgeControl](../httpcacheagecontrol/), [TimeSpan](../../system/timespan/)) | Construye una nueva instancia. |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpCacheAgeControl](../httpcacheagecontrol/), [TimeSpan](../../system/timespan/), [TimeSpan](../../system/timespan/)) | Construye una nueva instancia. |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([DateTime](../../system/datetime/)) | Construye una nueva instancia. |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpCacheAgeControl](../httpcacheagecontrol/), [TimeSpan](../../system/timespan/), [TimeSpan](../../system/timespan/), [DateTime](../../system/datetime/)) | Construye una nueva instancia. |
...
|  [RequestCachePolicy](../requestcachepolicy/requestcachepolicy/)() | Construye una nueva instancia. |
|  [RequestCachePolicy](../requestcachepolicy/requestcachepolicy/)([RequestCacheLevel](../requestcachelevel/)) | Construye una nueva instancia con el valor especificado de RequestCacheLevel. |
...
* Clase [RequestCachePolicy](../requestcachepolicy/)
