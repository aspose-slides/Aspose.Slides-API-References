...
description: Una fuente de token de cancelación que se puede usar para generar notificaciones de cancelación.
type: docs
weight: 40
url: /es/system.threading/cancellationtokensource/
---
## CancellationTokenSource clase


Una fuente de token de cancelación que se puede usar para generar notificaciones de cancelación.
...
| Method | Description |
| --- | --- |
| void [Cancel](./cancel/)() | Comunica una solicitud de cancelación. |
|  [CancellationTokenSource](./cancellationtokensource/)() | Construye un nuevo [CancellationTokenSource](./). |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | Crea una fuente de token enlazado que se cancela cuando cualquiera de los tokens proporcionados se cancela. |
| void [Dispose](./dispose/)() override | Libera todos los recursos utilizados por el [CancellationTokenSource](./). |
...
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | Obtiene si se ha solicitado la cancelación. |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | Obtiene el token de cancelación asociado a esta fuente. |
