...
| Método | Descripción |
| --- | --- |
| virtual void [Close](../waithandle/close/)() | Libera cualquier recurso asociado al manejador. |
...
| void [Lock](../../system/object/lock/)() | Implementa la declaración lock() de C# bloqueando. Llámelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
|  [Mutex](./mutex/)() | Construye un mutex no poseído. |
...
| void [ReleaseMutex](./releasemutex/)() | Libera el mutex. |
| static **bool** [Remove](./remove/)(const [String](../../system/string/)\&) | Borra un mutex nombrado del sistema. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| virtual **bool** [Reset](./reset/)() | Restablece el estado del mutex. No implementado. |
| virtual **bool** [Set](./set/)() | Establece el mutex en estado señalizado. No implementado. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la declaración lock() de C# desbloqueando. Llámelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| **bool** [WaitOne](./waitone/)() override | Bloquea el mutex. Realiza una espera ilimitada si es necesario. |
| **bool** [WaitOne](./waitone/)(int) override | Bloquea el mutex. Realiza una espera si es necesario. |
| **bool** [WaitOne](./waitone/)([TimeSpan](../../system/timespan/)) override | Bloquea el mutex. Realiza una espera si es necesario. |
...
| Campo | Descripción |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Valor especial que debe ser devuelto por la función, de lo contrario devuelve el índice del objeto señalizado en la matriz, si el tiempo de espera se supera y nada se señala. |
