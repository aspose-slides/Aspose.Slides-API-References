...
type: docs
weight: 27
url: /es/system.collections.generic.details/enumerableselectindexadapter/
---
## EnumerableSelectIndexAdapter clase
...
| Método | Descripción |
| --- | --- |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Obtiene el iterador que apunta al primer elemento (si existe) de la colección. Este iterador no puede usarse para modificar un objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) devuelve un objeto copia de T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtiene el iterador que apunta al primer elemento (si existe) de la instancia calificada como const de la colección. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Obtiene el iterador que apunta al primer elemento calificado como const (si existe) de la colección. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Obtiene el iterador que apunta justo después del último elemento calificado como const (si existe) de la colección. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Obtiene el iterador que apunta justo después del último elemento (si existe) de la colección. Este iterador no puede usarse para modificar un objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) devuelve un objeto copia de T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtiene el iterador que apunta justo después del último elemento (si existe) de la instancia calificada como const de la colección. |
