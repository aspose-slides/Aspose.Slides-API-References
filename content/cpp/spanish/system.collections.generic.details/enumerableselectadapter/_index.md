...
description: Enumerable utilizado por el método de extensión IEnumerable.Select().
type: docs
weight: 14
url: /es/system.collections.generic.details/enumerableselectadapter/
---
## EnumerableSelectAdapter clase

Enumerable utilizado por el método de extensión IEnumerable.Select().
...
| --- | --- |
| Source | El tipo origen de los elementos de la colección. |
| Result | El tipo de resultado de los elementos de la colección. |
