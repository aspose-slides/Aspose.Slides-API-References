...
description: Enumerador usado por el método de extensión IEnumerable.Cast().
type: docs
weight: 53
url: /es/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter clase

Enumerador usado por el método de extensión IEnumerable.Cast().
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | Marca el enumerador como propiedad del iterador virtualizado. |
