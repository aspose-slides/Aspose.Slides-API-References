...
description: Enumerable utilizado por los métodos de extensión IEnumerable.Cast() y IEnumerable.OfType().
type: docs
weight: 1
url: /es/system.collections.generic.details/enumerableadapter/
---
## EnumerableAdapter clase

Enumerable utilizado por los métodos de extensión IEnumerable.Cast() y IEnumerable.OfType().
...
| EnumeratorAdapter | El tipo del adaptador de enumerador. |
## Métodos
