...
description: Formatea la falla de afirmación 'same' para la salida.
type: docs
weight: 53
url: /es/system.testpredicates.details/samefailure/
---
## System::TestPredicates::Details::SameFailure(const char *, const char *, T1\&, T2\&) función

Formatea la falla de afirmación 'same' para la salida.
...
[Object](../../system/object/) texto de fallo envuelto.
