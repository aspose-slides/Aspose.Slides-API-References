...
| Método | Descripción |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [CreateParagraphFormat](./createparagraphformat/)() override | Crea un nuevo [IParagraphFormat](../iparagraphformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [CreatePortionFormat](./createportionformat/)() override | Crea un nuevo [IPortionFormat](../iportionformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\> [CreateTextFrameFormat](./createtextframeformat/)() override | Crea un nuevo [ITextFrameFormat](../itextframeformat/). |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[FormatFactory](./)\> [get_Instance](./get_instance/)() | Instancia estática de la fábrica de formatos. Solo lectura [FormatFactory](./). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el n-ésimo argumento plantilla como puntero débil (en lugar de compartido). Permite cambiar los punteros en contenedores a modo débil. |
...
* Clase [IFormatFactory](../iformatfactory/)
