...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Devuelve el estilo de alineación de una tabulación. Solo lectura [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Devuelve la posición de una tabulación. Asignar esta propiedad puede cambiar el índice de la tabulación en la colección e invalidar el enumerador. Solo lectura **double**. |
