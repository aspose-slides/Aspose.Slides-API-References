...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Devuelve el color de una parada de degradado. Solo lectura [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Devuelve la posición (0..1) de una parada de degradado. Lee **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Establece la posición (0..1) de una parada de degradado. Escribe **float**. |
...
* Clase [IGradientStop](../igradientstop/)
