...
description: Representa el bloqueo de Shape (operación deshabilitada).
type: docs
weight: 1483
url: /es/aspose.slides/ibaseshapelock/
---
## IBaseShapeLock clase

Representa [Shape](../shape/) bloqueo (operación deshabilitada).
...
| virtual **bool** [get_NoLocks](./get_nolocks/)() | Devuelve true si todas las banderas de bloqueo están desactivadas. Sólo lectura **bool**. |
