...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | Devuelve el color de una parada de degradado. Solo lectura [IColorFormat](../icolorformat/). |
| virtual **float** [get_Position](./get_position/)() | Devuelve la posición (0..1) de una parada de degradado. Lee **float**. |
...
| virtual void [set_Position](./set_position/)(**float**) | Establece la posición (0..1) de una parada de degradado. Escribe **float**. |
