...
description: Representa un objeto inmutable que contiene datos efectivos.
type: docs
weight: 2055
url: /es/aspose.slides/ieffectivedata/
---
## IEffectiveData clase

Representa un objeto inmutable que contiene datos efectivos.
...
| void [Lock](../../system/object/lock/)() | Implementa la sentencia lock() de C#. Llámelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la sentencia lock() de C# para desbloquear. Llámelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
