...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | Añade un nuevo marcador de posición si no hay ninguno y establece las propiedades del marcador de posición a una especificada. |
...
| virtual **int32_t** [get_AudioCdEndTrack](./get_audiocdendtrack/)() | Devuelve el índice de la última pista Lectura **int32_t**. |
| virtual **int32_t** [get_AudioCdEndTrackTime](./get_audiocdendtracktime/)() | Devuelve el tiempo de la última pista. Lectura **int32_t**. |
| virtual **int32_t** [get_AudioCdStartTrack](./get_audiocdstarttrack/)() | Devuelve el índice de la pista de inicio. Lectura **int32_t**. |
| virtual **int32_t** [get_AudioCdStartTrackTime](./get_audiocdstarttracktime/)() | Devuelve el tiempo de la pista de inicio. Lectura **int32_t**. |
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | La propiedad especifica cómo una forma se renderizará en modo de visualización en blanco y negro.. Lectura [Slides::BlackWhiteMode](../blackwhitemode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptionsCollection](../icaptionscollection/)\> [get_CaptionTracks](./get_captiontracks/)() | Obtiene la colección de subtítulos cerrados asociados con el cuadro de audio. Esta propiedad es solo lectura y devuelve un [ICaptionsCollection](../icaptionscollection/) que contiene todas las pistas de subtítulos. |
...
| virtual **bool** [get_Embedded](./get_embedded/)() | Determina si un sonido está incrustado en una presentación. Solo lectura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [get_EmbeddedAudio](./get_embeddedaudio/)() | Devuelve el objeto de audio incrustado. Lectura [IAudio](../iaudio/). |
| virtual **float** [get_FadeInDuration](./get_fadeinduration/)() | Especifica la duración, en milisegundos, del desvanecimiento de entrada inicial del medio. Lectura **float**. |
| virtual **float** [get_FadeOutDuration](./get_fadeoutduration/)() | Especifica la duración, en milisegundos, del desvanecimiento de salida final del medio. Lectura **float**. |
...
| virtual **bool** [get_HideAtShowing](./get_hideatshowing/)() | Determina si un [AudioFrame](../audioframe/) está oculto. Lectura **bool**. |
...
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Devuelve el nombre de un archivo de audio vinculado a un [AudioFrame](../audioframe/). Lectura [System::String](../../system/string/). |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Devuelve un identificador único de alcance de diapositiva que permanece constante durante la vida de la forma y permite a PowerPoint o al código de interop referenciar la forma de manera fiable desde cualquier parte del documento. Solo lectura **uint32_t**. Véase también [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual **bool** [get_PlayAcrossSlides](./get_playacrossslides/)() | Determina si un audio se reproduce a través de las diapositivas. Lectura **bool**. |
| virtual **bool** [get_PlayLoopMode](./get_playloopmode/)() | Determina si un audio está en bucle. Lectura **bool**. |
| virtual [AudioPlayModePreset](../audioplaymodepreset/) [get_PlayMode](./get_playmode/)() | Devuelve el modo de reproducción de audio. Lectura [AudioPlayModePreset](../audioplaymodepreset/). |
...
| virtual **float** [get_RelativeScaleHeight](../ipictureframe/get_relativescaleheight/)() | Devuelve la escala de altura (relativa al tamaño original de la imagen) del marco de la imagen. El valor 1.0 corresponde al 100%. Lectura **float**. |
| virtual **float** [get_RelativeScaleWidth](../ipictureframe/get_relativescalewidth/)() | Devuelve la escala de ancho (relativa al tamaño original de la imagen) del marco de la imagen. El valor 1.0 corresponde al 100%. Lectura **float**. |
| virtual **bool** [get_RewindAudio](./get_rewindaudio/)() | Determina si un audio se rebobina automáticamente al inicio después de reproducirse. Lectura **bool**. |
...
| virtual [Aspose::Slides::ShapeType](../shapetype/) [get_ShapeType](../igeometryshape/get_shapetype/)() | Devuelve el tipo preestablecido de geometría. Nota: al cambiar el valor, todos los valores de ajuste se restablecerán a sus valores predeterminados. Lectura [Slides::ShapeType](../shapetype/). |
...
| virtual **float** [get_TrimFromEnd](./get_trimfromend/)() | Especifica la duración, en milisegundos, que se debe eliminar del final del medio durante la reproducción. Lectura **float**. |
| virtual **float** [get_TrimFromStart](./get_trimfromstart/)() | Especifica la duración, en milisegundos, que se debe eliminar del comienzo del medio durante la reproducción. Lectura **float**. |
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Devuelve un identificador interno de alcance de presentación destinado a ser usado por complementos u otro código. Dado que este valor puede ser reasignado por el usuario o programáticamente, no debe tratarse como una clave única persistente. Solo lectura **uint32_t**. Véase también [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
| virtual [AudioVolumeMode](../audiovolumemode/) [get_Volume](./get_volume/)() | Devuelve el volumen de audio. Lectura [AudioVolumeMode](../audiovolumemode/). |
| virtual **float** [get_VolumeValue](./get_volumevalue/)() | Devuelve el volumen de audio en porcentajes. Lectura **float**. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGeometryPath](../igeometrypath/)\>\> [GetGeometryPaths](../igeometryshape/getgeometrypaths/)() | Devuelve una copia de la ruta de la forma geométrica. Las coordenadas son relativas a la esquina superior izquierda de la forma. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetImage](../ishape/getimage/)() | Devuelve la miniatura de la forma. El tipo de límites de miniatura [ShapeThumbnailBounds::Shape](../shapethumbnailbounds/) se usa por defecto. |
...
| virtual void [set_AudioCdEndTrack](./set_audiocdendtrack/)(**int32_t**) | Establece un índice de última pista. Escritura **int32_t**. |
| virtual void [set_AudioCdEndTrackTime](./set_audiocdendtracktime/)(**int32_t**) | Establece un tiempo de última pista. Escritura **int32_t**. |
| virtual void [set_AudioCdStartTrack](./set_audiocdstarttrack/)(**int32_t**) | Establece un índice de pista de inicio. Escritura **int32_t**. |
| virtual void [set_AudioCdStartTrackTime](./set_audiocdstarttracktime/)(**int32_t**) | Establece un tiempo de pista de inicio. Escritura **int32_t**. |
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | La propiedad especifica cómo una forma se representará en modo de visualización en blanco y negro.. Escritura [Slides::BlackWhiteMode](../blackwhitemode/). |
| virtual void [set_EmbeddedAudio](./set_embeddedaudio/)([System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\>) | Establece el objeto de audio incrustado. Escritura [IAudio](../iaudio/). |
| virtual void [set_FadeInDuration](./set_fadeinduration/)(**float**) | Especifica la duración, en milisegundos, del desvanecimiento de entrada inicial del medio. Escritura **float**. |
| virtual void [set_FadeOutDuration](./set_fadeoutduration/)(**float**) | Especifica la duración, en milisegundos, del desvanecimiento de salida final del medio. Escritura **float**. |
...
| virtual void [set_HideAtShowing](./set_hideatshowing/)(**bool**) | Determina si un [AudioFrame](../audioframe/) está oculto. Escritura **bool**. |
...
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | Establece el nombre de un archivo de audio vinculado a un [AudioFrame](../audioframe/). Escritura [System::String](../../system/string/). |
...
| virtual void [set_PlayAcrossSlides](./set_playacrossslides/)(**bool**) | Determina si un audio se reproduce a través de las diapositivas. Escritura **bool**. |
| virtual void [set_PlayLoopMode](./set_playloopmode/)(**bool**) | Determina si un audio está en bucle. Escritura **bool**. |
| virtual void [set_PlayMode](./set_playmode/)([AudioPlayModePreset](../audioplaymodepreset/)) | Establece el modo de reproducción de audio. Escritura [AudioPlayModePreset](../audioplaymodepreset/). |
...
| virtual void [set_RelativeScaleHeight](../ipictureframe/set_relativescaleheight/)(**float**) | Establece la escala de altura (relativa al tamaño original de la imagen) del marco de la imagen. El valor 1.0 corresponde al 100%. Escritura **float**. |
| virtual void [set_RelativeScaleWidth](../ipictureframe/set_relativescalewidth/)(**float**) | Establece la escala de ancho (relativa al tamaño original de la imagen) del marco de la imagen. El valor 1.0 corresponde al 100%. Escritura **float**. |
| virtual void [set_RewindAudio](./set_rewindaudio/)(**bool**) | Determina si un audio se rebobina automáticamente al inicio después de reproducirse. Escritura **bool**. |
...
| virtual void [set_ShapeType](../igeometryshape/set_shapetype/)([Aspose::Slides::ShapeType](../shapetype/)) | Establece el tipo preestablecido de geometría. Nota: al cambiar el valor, todos los valores de ajuste se restablecerán a sus valores predeterminados. Escritura [Slides::ShapeType](../shapetype/). |
| virtual void [set_TrimFromEnd](./set_trimfromend/)(**float**) | Especifica la duración, en milisegundos, que se debe eliminar del final del medio durante la reproducción. Escritura **float**. |
| virtual void [set_TrimFromStart](./set_trimfromstart/)(**float**) | Especifica la duración, en milisegundos, que se debe eliminar del comienzo del medio durante la reproducción. Escritura **float**. |
| virtual void [set_Volume](./set_volume/)([AudioVolumeMode](../audiovolumemode/)) | Establece el volumen de audio. Escritura [AudioVolumeMode](../audiovolumemode/). |
| virtual void [set_VolumeValue](./set_volumevalue/)(**float**) | Establece el volumen de audio en porcentajes. Escritura **float**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el enésimo argumento de plantilla como un puntero débil (en lugar de compartido). Permite cambiar punteros en contenedores a modo débil. |
