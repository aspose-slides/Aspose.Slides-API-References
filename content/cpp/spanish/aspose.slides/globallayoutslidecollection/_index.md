...
description: Representa una colección de todas las diapositivas de diseño en la presentación. Extiende la clase LayoutSlideCollection con métodos para agregar/duplicar diapositivas de diseño en el contexto de la unión de las colecciones individuales de diapositivas de diseño maestras.
type: docs
weight: 1093
...
Representa una colección de todas las diapositivas de diseño en la presentación. Extiende la clase [LayoutSlideCollection](../layoutslidecollection/) con métodos para agregar/clonar diapositivas de diseño en el contexto de la unión de las colecciones individuales de diapositivas de diseño maestras.
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) override | Añade una nueva diapositiva de diseño a la presentación. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | Añade una copia de una diapositiva de diseño especificada a la presentación. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Añade una copia de una diapositiva de diseño especificada a la presentación. |
...
| [const_iterator](../layoutslidecollection/const_iterator/) [begin](../layoutslidecollection/begin/)() const | Obtiene un iterador que apunta al primer elemento (si lo hay) de la instancia de la colección calificada como const. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cbegin](../layoutslidecollection/cbegin/)() const | Obtiene un iterador que apunta al primer elemento calificado como const (si lo hay) de la colección. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cend](../layoutslidecollection/cend/)() const | Obtiene un iterador que apunta justo después del último elemento calificado como const (si lo hay) de la colección. |
...
| [const_iterator](../layoutslidecollection/const_iterator/) [end](../layoutslidecollection/end/)() const | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la instancia de la colección calificada como const. |
...
| **int32_t** [get_Count](../layoutslidecollection/get_count/)() override | Devuelve el número de diapositivas de diseño en una colección. **int32_t** de solo lectura. |
| **bool** [get_IsSynchronized](../layoutslidecollection/get_issynchronized/)() override | Devuelve un valor que indica si el acceso a la colección está sincronizado (seguro para hilos). **bool** de solo lectura. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../layoutslidecollection/get_syncroot/)() override | Devuelve una raíz de sincronización. [System::Object](../../system/object/) de solo lectura. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo al método [Object.GetHashCode()](../../system/object/gethashcode/) de C#. Permite el hashing de objetos personalizados. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../layoutslidecollection/idx_get/)(**int32_t**) override | Devuelve la diapositiva de diseño por índice. [LayoutSlide](../layoutslide/) de solo lectura. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica si el objeto representa una instancia del tipo descrito por targetType. Analogo al operador 'is' de C#. |
...
| **bool** [LINQ_Contains](../../system.collections.generic/ienumerable/linq_contains/)(T) | Determina si una secuencia contiene un valor específico. |
...
| void [RemoveUnused](../layoutslidecollection/removeunused/)() override | Elimina diapositivas de diseño no utilizadas (diapositivas cuyo HasDependingSlides es false). |
...
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeBeginConstIterator](../layoutslidecollection/virtualizebeginconstiterator/)() const override | Obtiene un iterador que apunta al primer elemento (si lo hay) de la instancia calificada como const de la colección. |
...
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndConstIterator](../layoutslidecollection/virtualizeendconstiterator/)() const override | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la instancia calificada como const de la colección. |
...
* Clase [IGlobalLayoutSlideCollection](../igloballayoutslidecollection/)
