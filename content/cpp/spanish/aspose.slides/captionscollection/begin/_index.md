...
type: docs
weight: 92
url: /es/aspose.slides/captionscollection/begin/
---
## CaptionsCollection::begin() método


Obtiene un iterador que apunta al primer elemento (si lo hay) de la colección.

```cpp
iterator Aspose::Slides::CaptionsCollection::begin() noexcept
```
