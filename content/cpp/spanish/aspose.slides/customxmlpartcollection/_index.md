...
| Método | Descripción |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::String](../../system/string/)) override | Agrega una nueva parte xml personalizada. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Agrega una nueva parte xml personalizada. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Agrega una nueva parte xml personalizada. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtiene el iterador que apunta al primer elemento constante (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtiene el iterador que apunta justo después del último elemento constante (si lo hay) de la colección. |
| void [Clear](./clear/)() override | Elimina todos los elementos de la colección. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>\>, **int32_t**) override | Copia a la matriz especificada. |
...
| **int32_t** [get_Count](./get_count/)() override | Devuelve el recuento de partes xml personalizadas en la colección. Solo lectura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que itera a través de la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [idx_get](./idx_get/)(**int32_t**) override | Devuelve el elemento en el índice especificado. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>) override | Elimina la primera aparición de un objeto específico de la colección. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Elimina la parte xml personalizada en el índice especificado. |
...
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Tipo de colección cuyo tipo de iterador se usa como tipo de iterador en la colección actual. |
...
* Clase [ICustomXmlPartCollection](../icustomxmlpartcollection/)
