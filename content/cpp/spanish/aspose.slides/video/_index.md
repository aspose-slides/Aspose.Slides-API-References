...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Devuelve una copia de los datos de un audio. En caso de una gran cantidad de datos, considera usar el método [Video::GetStream](./getstream/) para evitar la carga innecesaria de los datos del video en memoria o incluso una OutOfMemoryException. Solo lectura **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Devuelve el tipo MIME de un video, codificado en [Video::get_BinaryData](./get_binarydata/). Solo lectura [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | Devuelve un Stream para lectura. Use 'using' o cierre el stream después de usarlo. |
