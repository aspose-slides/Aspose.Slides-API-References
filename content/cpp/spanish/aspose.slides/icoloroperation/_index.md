...
description: Representa diferentes operaciones de color usadas para transformaciones de color.
type: docs
weight: 1704
url: /es/aspose.slides/icoloroperation/
---
## IColorOperation clase


Representa diferentes operaciones de color usadas para transformaciones de color.
...
| virtual [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const | Devuelve el tipo de una operación. Sólo lectura [ColorTransformOperation](../colortransformoperation/). |
| virtual **float** [get_Parameter](./get_parameter/)() | Devuelve un parámetro de una operación. Sólo lectura **float**. |
