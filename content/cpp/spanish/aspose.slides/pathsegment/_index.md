...
Representa un segmento de la ruta gráfica de [GeometryShape](../geometryshape/)
...
| [PathCommandType](../pathcommandtype/) [get_PathCommand](./get_pathcommand/)() override | Tipo de ruta del segmento |
| [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [get_SegmentData](./get_segmentdata/)() override | Datos de la ruta del segmento |
...
* Clase [IPathSegment](../ipathsegment/)
