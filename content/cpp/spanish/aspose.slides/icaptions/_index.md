...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Devuelve los datos binarios de los subtítulos cerrados. Read-only **uint8_t**[]. |
| virtual [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() | Devuelve el identificador globalmente único (GUID) de los subtítulos cerrados. Read-only [System::Guid](../../system/guid/). |
| virtual [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() | Devuelve los datos de los subtítulos cerrados como cadena codificada en UTF-8. Read-only [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Label](./get_label/)() | Devuelve la etiqueta de los subtítulos cerrados. Read [System::String](../../system/string/). |
...
| virtual void [set_Label](./set_label/)([System::String](../../system/string/)) | Establece la etiqueta de los subtítulos cerrados. Write [System::String](../../system/string/). |
