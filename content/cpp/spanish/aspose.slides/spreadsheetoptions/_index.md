...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() override | Obtiene la información de cultura preferida para calcular algunas funciones destinadas al uso con idiomas que emplean el conjunto de caracteres de doble byte (DBCS). |
| **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() override | Si la fuente de datos del gráfico es un libro de trabajo externo y no está disponible, se recuperará del caché del gráfico. |
...
| void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) override | Establece la información de cultura preferida para calcular algunas funciones destinadas al uso con idiomas que emplean el conjunto de caracteres de doble byte (DBCS). |
| void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) override | Si la fuente de datos del gráfico es un libro de trabajo externo y no está disponible, se recuperará del caché del gráfico. |
...
|  [SpreadsheetOptions](./spreadsheetoptions/)() | Inicializa una nueva instancia de la clase [SpreadsheetOptions](./). |
...
* Clase [ISpreadsheetOptions](../ispreadsheetoptions/)
