...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | Devuelve el gestor HeaderFooter de la diapositiva de notas. Solo lectura [INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/). |
...
| [System::String](../../system/string/) [get_Name](../baseslide/get_name/)() override | Devuelve el nombre de una diapositiva. Solo lectura [System::String](../../system/string/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [get_NotesTextFrame](./get_notestextframe/)() override | Devuelve un [TextFrame](../textframe/) con el texto de notas si existe. Solo lectura [ITextFrame](../itextframe/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_ParentSlide](./get_parentslide/)() override | Devuelve la diapositiva padre. Solo lectura [ISlide](../islide/). |
...
| **bool** [get_ShowMasterShapes](./get_showmastershapes/)() override | Especifica si las formas en la diapositiva maestra deben mostrarse en las diapositivas o no. Solo lectura **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Theme::IOverrideThemeManager](../../aspose.slides.theme/ioverridethememanager/)\> [get_ThemeManager](./get_thememanager/)() override | Devuelve el gestor de tema superpuesto. Solo lectura [Theme::IOverrideThemeManager](../../aspose.slides.theme/ioverridethememanager/). |
...
| void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)() override | Une secuencias con el mismo formato en todos los párrafos y todas las formas aceptables. |
| virtual void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeCollection](../ishapecollection/)\>) | Une secuencias con el mismo formato en todos los párrafos y todas las formas aceptables. |
| void [Lock](../../system/object/lock/)() | Implementa la instrucción lock() de C# para bloqueo. Llame directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la instrucción lock() de C# para desbloqueo. Llame directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
