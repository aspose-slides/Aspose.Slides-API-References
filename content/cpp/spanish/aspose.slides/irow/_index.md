...
| Método | Descripción |
| --- | --- |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Obtiene un iterador que apunta al primer elemento (si existe) de la colección. Este iterador no se puede usar para cambiar un objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) devuelve un objeto copia de T. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Obtiene un iterador que apunta justo después del último elemento (si existe) de la colección. Este iterador no se puede usar para cambiar un objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) devuelve un objeto copia de T. |
...
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | Devuelve el número de comportamientos en una colección. Sólo lectura **int32_t**. |
| virtual **double** [get_Height](./get_height/)() | Devuelve la altura de una fila. Sólo lectura **double**. |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Devuelve un valor que indica si el acceso a la colección está sincronizado (seguro para subprocesos). Sólo lectura **bool**. |
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Devuelve la altura mínima posible de una fila. Sólo lectura **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | Devuelve el objeto [RowFormat](../rowformat/) que contiene las propiedades de formato para esta fila. Sólo lectura [IRowFormat](../irowformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | Devuelve una raíz de sincronización. Sólo lectura [System::Object](../../system/object/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Devuelve una celda por su posición. Sólo lectura [ICell](../icell/). |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Establece la altura mínima posible de una fila. Escribe **double**. |
...
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Establece las propiedades de formato de porción definidas a todas las porciones del elemento. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Establece las propiedades de formato de párrafo definidas a todos los párrafos del elemento. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Establece las propiedades de formato de marco de texto definidas a todos los marcos de texto del elemento. |
...
* Clase [ICellCollection](../icellcollection/)
* Clase [IBulkTextFormattable](../ibulktextformattable/)
