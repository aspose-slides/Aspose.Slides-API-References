...
| [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() override | Devuelve el tipo de relleno. Lea [Slides::FillType](../filltype/). |
...
| [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() override | Determina si el relleno debe rotarse con una forma. Lea [NullableBool](../nullablebool/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() override | Devuelve el color de un relleno sólido. Solo lectura [IColorFormat](../icolorformat/). |
...
| void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) override | Determina si el relleno debe rotarse con una forma. Escritura [NullableBool](../nullablebool/). |
...
* Clase [ILineFillFormat](../ilinefillformat/)
