...
description: Representa al gestor que mantiene el comportamiento de los marcadores de posición del pie de diapositiva, de fecha y hora y del número de página.
type: docs
weight: 5201
...
Representa al gestor que mantiene el comportamiento de los marcadores de posición del pie de diapositiva, de fecha y hora y de número de página.
...
* Clase [ISlideHeaderFooterManager](../islideheaderfootermanager/)
