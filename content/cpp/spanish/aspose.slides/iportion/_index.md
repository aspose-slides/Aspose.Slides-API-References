...
| Método | Descripción |
| --- | --- |
| virtual void [AddField](./addfield/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) | Convierte esta porción en el campo actualizado automáticamente. |
| virtual void [AddField](./addfield/)([System::String](../../system/string/)) | Convierte esta porción en el campo actualizado automáticamente. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IField](../ifield/)\> [get_Field](./get_field/)() | Devuelve un campo de esta porción. Sólo lectura [IField](../ifield/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_PortionFormat](./get_portionformat/)() | Devuelve un objeto de formato que contiene las propiedades de formato establecidas explícitamente de la porción de texto sin aplicar herencia. Sólo lectura [IPortionFormat](../iportionformat/). |
...
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Obtiene el texto plano de una porción. Lectura [System::String](../../system/string/). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [GetCoordinates](./getcoordinates/)() | Obtiene las coordenadas del inicio de la porción. La coordenada X del punto representa el comienzo de la porción desde el primer carácter, incluyendo el margen izquierdo. La coordenada Y incluye el margen superior. |
...
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() | Obtiene las coordenadas del rectángulo que delimita la porción. El rectángulo incluye todas las líneas de texto en la porción, incluidas las vacías. |
...
| virtual void [RemoveField](./removefield/)() | Convierte esta porción de campo en la porción simple. |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | Establece el texto plano de una porción. Escritura [System::String](../../system/string/). |
