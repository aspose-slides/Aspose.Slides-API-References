...
---
## IGradientFormatEffectiveData clase
...
| virtual [Aspose::Slides::GradientDirection](../gradientdirection/) [get_GradientDirection](./get_gradientdirection/)() | Devuelve el estilo de un degradado. Solo lectura [Slides::GradientDirection](../gradientdirection/). |
| virtual [Aspose::Slides::GradientShape](../gradientshape/) [get_GradientShape](./get_gradientshape/)() | Devuelve la forma de un degradado. Solo lectura [Slides::GradientShape](../gradientshape/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\> [get_GradientStop](./get_gradientstop/)(**int32_t**) | Devuelve una parada de degradado en el índice especificado. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)\> [get_GradientStops](./get_gradientstops/)() | Devuelve la colección de paradas de degradado. Solo lectura [IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/). |
| virtual **float** [get_LinearGradientAngle](./get_lineargradientangle/)() | Devuelve el ángulo de un degradado. Solo lectura **float**. |
| virtual **bool** [get_LinearGradientScaled](./get_lineargradientscaled/)() | Determina si un degradado está escalado. Solo lectura **bool**. |
| virtual [Aspose::Slides::TileFlip](../tileflip/) [get_TileFlip](./get_tileflip/)() | Devuelve el modo de volteo para un degradado. Solo lectura [Slides::TileFlip](../tileflip/). |
