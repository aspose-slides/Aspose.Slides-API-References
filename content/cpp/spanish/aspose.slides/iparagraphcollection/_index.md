...
| Método | Descripción |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Agrega un [Paragraph](../paragraph/) al final de la colección. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](./)\>) | Agrega el contenido de [ParagraphCollection](../paragraphcollection/) al final de la colección. |
| virtual void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) | Agrega texto de la cadena html especificada a la colección. |
| virtual void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) | Agrega texto de la cadena html especificada a la colección. |
...
| virtual [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) | Convierte los párrafos especificados a HTML y lo devuelve como objeto String. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo para uso interno. |
| virtual **int32_t** [get_Count](./get_count/)() | Obtiene el número de elementos realmente contenidos en la colección. Solo lectura **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) | Obtiene el elemento en el índice especificado. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Inserta un [Paragraph](../paragraph/) en la colección en el índice especificado. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](./)\>) | Inserta el contenido de [ParagraphCollection](../paragraphcollection/) en la colección en el índice especificado. |
...
| void [Lock](../../system/object/lock/)() | Implementa la instrucción C# lock() de bloqueo. Llama directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Elimina la primera aparición de un párrafo específico. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Análogo al método C# [Object.ToString()](../../system/object/tostring/). Permite convertir objetos personalizados a string. |
