...
| Method | Descripción |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Añade un [Paragraph](../paragraph/) al final de la colección. |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Añade el contenido de [ParagraphCollection](./) al final de la colección. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) override | Añade texto de la cadena html especificada a la colección. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) override | Añade texto de la cadena html especificada a la colección. |
| [iterator](./iterator/) [begin](./begin/)() | Obtiene el iterador que apunta al primer elemento (si existe) de la colección. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtiene el iterador que apunta al primer elemento (si existe) de la instancia de la colección calificada como const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtiene el iterador que apunta al primer elemento calificado como const (si existe) de la colección. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtiene el iterador que apunta justo después del último elemento calificado como const (si existe) de la colección. |
| void [Clear](./clear/)() override | Elimina todos los elementos de la colección. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Determina si [ICollection](../../system.collections.generic/icollection/) contiene un valor específico. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>, **int32_t**) | Copia los elementos de [ICollection](../../system.collections.generic/icollection/) a un [System::Array](../../system/array/), comenzando en un índice [System::Array](../../system/array/) particular. |
| [iterator](./iterator/) [end](./end/)() | Obtiene el iterador que apunta justo después del último elemento (si existe) de la colección. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtiene el iterador que apunta justo después del último elemento (si existe) de la instancia de la colección calificada como const. |
...
| [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) override | Convierte los párrafos especificados a HTML y lo devuelve como objeto String. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Obtiene un valor que indica si [ICollection](../../system.collections.generic/icollection/) es de solo lectura. Solo lectura **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que recorre la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) override | Obtiene el elemento en el índice especificado. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Determina el índice de un elemento específico en [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Inserta un [Paragraph](../paragraph/) en la colección en el índice especificado. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Inserta el contenido de [ParagraphCollection](./) en la colección en el índice especificado. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina si existe algún elemento en la secuencia o satisface una condición. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Elimina la primera ocurrencia de un objeto específico del [ICollection](../../system.collections.generic/icollection/). |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtiene el iterador que apunta al primer elemento (si existe) de la instancia de la colección calificada como const. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Obtiene el iterador que apunta al primer elemento (si existe) de la colección. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtiene el iterador que apunta justo después del último elemento (si existe) de la instancia de la colección calificada como const. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtiene el iterador que apunta justo después del último elemento (si existe) de la colección. |
...
* Clase [IParagraphCollection](../iparagraphcollection/)
