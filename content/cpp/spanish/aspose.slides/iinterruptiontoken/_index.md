...
description: Esta clase representa el token que se usa para señalizar a tareas de larga ejecución si se solicitó la interrupción.
type: docs
weight: 2601
url: /es/aspose.slides/iinterruptiontoken/
---
## IInterruptionToken clase


Esta clase representa el token que se usa para indicar a tareas de larga ejecución si se ha solicitado la interrupción.
...
| virtual **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() | Devuelve **bool**.true si se solicitó la interrupción. |
...
| virtual void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() | Lanza una excepción si se solicitó la interrupción. |
