...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | Devuelve un [EffectFormat](../effectformat/) para relleno [BackgroundType::OwnBackground](../backgroundtype/). Sólo lectura [IEffectFormat](../ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Devuelve un [FillFormat](../fillformat/) para relleno [BackgroundType::OwnBackground](../backgroundtype/). Sólo lectura [IFillFormat](../ifillformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | Devuelve un [ColorFormat](../colorformat/) para un relleno [BackgroundType::Themed](../backgroundtype/). Sólo lectura [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | Devuelve un índice del relleno [BackgroundType::Themed](../backgroundtype/) en la colección de temas de fondo. 0 significa sin relleno. 1..999 - índice. Sólo lectura **uint16_t**. |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | Devuelve un tipo de relleno de fondo. Sólo lectura [BackgroundType](../backgroundtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | Obtiene los datos de fondo efectivos con la herencia aplicada. |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | Devuelve un índice del relleno [BackgroundType::Themed](../backgroundtype/) en la colección de temas de fondo. 0 significa sin relleno. 1..999 - índice. Escritura **uint16_t**. |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | Devuelve un tipo de relleno de fondo. Escritura [BackgroundType](../backgroundtype/). |
