...
Este ejemplo demuestra cómo obtener algunas de las propiedades de efecto efectivas de la forma. 
```cpp
...
* Clase [IEffectFormatEffectiveData](../../ieffectformateffectivedata/)
* Clase [EffectFormat](../)
