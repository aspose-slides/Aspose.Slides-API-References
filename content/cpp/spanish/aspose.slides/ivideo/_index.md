...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Devuelve una copia de los datos de un audio. En caso de gran cantidad de datos, considere usar el método [IVideo::GetStream](./getstream/) para evitar la carga innecesaria de los datos del video en memoria o incluso una OutOfMemoryException. Solo lectura **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Devuelve el tipo MIME de un video, codificado en [IVideo::get_BinaryData](./get_binarydata/). Solo lectura [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | Devuelve un flujo Stream para lectura. Use 'using' o cierre el flujo después de usarlo. |
