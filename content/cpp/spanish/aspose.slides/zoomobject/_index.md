...
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkClick](../shape/get_hyperlinkclick/)() override | Devuelve el hipervínculo definido para el clic del ratón. Lea [IHyperlink](../ihyperlink/). |
...
| [ZoomImageType](../zoomimagetype/) [get_ImageType](./get_imagetype/)() override | Obtiene el tipo de imagen de un objeto zoom. Lea [ZoomImageType](../zoomimagetype/). Valor predeterminado: Preview |
...
| **bool** [get_ReturnToParent](./get_returntoparent/)() override | Obtiene el comportamiento de navegación en la presentación. Lee **bool**. Valor predeterminado: false |
...
| **bool** [get_ShowBackground](./get_showbackground/)() override | Obtiene el valor que especifica si el Zoom usará el fondo de la diapositiva de destino. Lee **bool**. Valor predeterminado: true |
...
| **float** [get_TransitionDuration](./get_transitionduration/)() override | Obtiene la duración de la transición entre Zoom y la diapositiva. Lee **float**. Valor predeterminado: 1.0f |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](./get_zoomimage/)() override | Obtiene la imagen para el objeto zoom. Lea [IPPImage](../ippimage/). |
...
| void [Lock](../../system/object/lock/)() | Implementa la sentencia lock() de C#. Llame directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [set_BlackWhiteMode](../shape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) override | La propiedad especifica cómo se renderiza una forma en modo de visualización en blanco y negro. Escriba [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| void [set_HyperlinkClick](../shape/set_hyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) override | Establece el hipervínculo definido para el clic del ratón. Escriba [IHyperlink](../ihyperlink/). |
...
| void [set_ImageType](./set_imagetype/)([ZoomImageType](../zoomimagetype/)) override | Establece el tipo de imagen de un objeto zoom. Escriba [ZoomImageType](../zoomimagetype/). Valor predeterminado: Preview |
...
| void [set_ReturnToParent](./set_returntoparent/)(**bool**) override | Establece el comportamiento de navegación en la presentación. Escriba **bool**. Valor predeterminado: false |
...
| void [set_ShowBackground](./set_showbackground/)(**bool**) override | Establece el valor que especifica si el Zoom usará el fondo de la diapositiva de destino. Escriba **bool**. Valor predeterminado: true |
| void [set_TransitionDuration](./set_transitionduration/)(**float**) override | Establece la duración de la transición entre Zoom y la diapositiva. Escriba **float**. Valor predeterminado: 1.0f |
...
| void [set_ZoomImage](./set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) override | Establece la imagen para el objeto zoom. Escriba [IPPImage](../ippimage/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la sentencia lock() de C# para desbloquear. Llame directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
