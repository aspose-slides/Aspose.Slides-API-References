...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Devuelve una copia de los datos del audio. En caso de una gran cantidad de datos, considere usar el método [Audio::GetStream](./getstream/) para evitar la carga innecesaria de los datos del audio en memoria o incluso una OutOfMemoryException. Sólo lectura **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Devuelve un tipo MIME de un audio, codificado en [Audio::get_BinaryData](./get_binarydata/). Sólo lectura [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | Devuelve un flujo Stream para lectura. Use 'using' o cierre el flujo después de usar. |
...
| void [set_ContentType](./set_contenttype/)([System::String](../../system/string/)) | Devuelve un tipo MIME de un audio, codificado en [Audio::get_BinaryData](./get_binarydata/). Sólo lectura [System::String](../../system/string/). |
