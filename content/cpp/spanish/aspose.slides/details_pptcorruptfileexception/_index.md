...
type: docs
weight: 651
url: /es/aspose.slides/details_pptcorruptfileexception/
---
## Details_PptCorruptFileException clase
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementa el método [what()](../../system/details_exception/what/) que es llamado por la clase [ExceptionWrapper](../../system/exceptionwrapper/). A pesar de que esta clase no hereda de std::exception, las clases derivadas pueden usar miembros protegido/privados para implementar su lógica. Mover la implementación de este método a [ExceptionWrapper](../../system/exceptionwrapper/) podría romper esa lógica. |
