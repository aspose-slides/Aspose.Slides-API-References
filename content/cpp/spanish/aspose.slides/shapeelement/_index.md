...
| [ShapeElementFillSource](../shapeelementfillsource/) [get_FillSource](./get_fillsource/)() | Devuelve información sobre cómo rellenar un elemento. Sólo lectura [ShapeElementFillSource](../shapeelementfillsource/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Shape](../shape/)\> [get_ParentShape](./get_parentshape/)() | Devuelve un Shape_PPT para el cual se creó el elemento. Sólo lectura [Shape](../shape/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_PathPoints](./get_pathpoints/)() | Obtiene una matriz de puntos que definen la geometría de la ruta del elemento. |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_PathTypes](./get_pathtypes/)() | Obtiene una matriz de valores byte que especifican el tipo de cada punto en la ruta del elemento. |
| [ShapeElementStrokeSource](../shapeelementstrokesource/) [get_StrokeSource](./get_strokesource/)() | Devuelve información sobre cómo trazar un elemento. Sólo lectura [ShapeElementStrokeSource](../shapeelementstrokesource/). |
...
* Clase [IShapeElement](../ishapeelement/)
