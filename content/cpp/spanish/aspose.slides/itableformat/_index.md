...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Devuelve un objeto de propiedades de relleno de tabla. Sólo de lectura [IFillFormat](../ifillformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() | Obtiene las propiedades de formato de tabla efectivas con herencia y estilos de tabla aplicados. |
...
| virtual void [set_Transparency](./set_transparency/)(**float**) | Establece la transparencia del color de relleno. Escribe **float**. |
