...
| Método | Descripción |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [AddComment](./addcomment/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Agrega un nuevo comentario al final de una colección. |
| [System::SharedPtr](../../system/sharedptr/)\<[IModernComment](../imoderncomment/)\> [AddModernComment](./addmoderncomment/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Agrega un nuevo comentario moderno al final de una colección. |
| [iterator](./iterator/) [begin](./begin/)() | Obtiene un iterador que apunta al primer elemento (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtiene un iterador que apunta al primer elemento (si lo hay) de la instancia de la colección con calificador const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtiene un iterador que apunta al primer elemento con calificador const (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtiene un iterador que apunta justo después del último elemento con calificador const (si lo hay) de la colección. |
| void [Clear](./clear/)() override | Elimina todos los comentarios de una colección. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\>, **int32_t**) override | Copia todos los elementos de la colección al array especificado. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la instancia de la colección con calificador const. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [FindCommentByIdx](./findcommentbyidx/)(**int32_t**) | Busca un comentario en la colección por índice. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que itera a través de la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [idx_get](./idx_get/)(**int32_t**) override | Obtiene el elemento en el índice especificado. Solo lectura [Comment](../comment/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [InsertComment](./insertcomment/)(**int32_t**, [System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Inserta un nuevo comentario en una colección en el índice especificado. |
| [System::SharedPtr](../../system/sharedptr/)\<[IModernComment](../imoderncomment/)\> [InsertModernComment](./insertmoderncomment/)(**int32_t**, [System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Inserta un nuevo comentario moderno en una colección en el índice especificado. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>) override | Elimina la primera ocurrencia del comentario especificado en una colección. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Elimina el elemento en el índice especificado en una colección. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\> [ToArray](./toarray/)() override | Crea y devuelve un array con todos los comentarios. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\> [ToArray](./toarray/)(**int32_t**, **int32_t**) override | Crea y devuelve un array con todos los comentarios del rango especificado. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtiene un iterador que apunta al primer elemento (si lo hay) de la instancia de la colección con calificador const. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la instancia de la colección con calificador const. |
...
* Clase [ICommentCollection](../icommentcollection/)
