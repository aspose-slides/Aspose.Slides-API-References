...
---
## IShapeCollection::InsertPictureFrame(int32_t, ShapeType, float, float, float, float, System::SharedPtr\<IPPImage\>) método
...
| --- | --- | --- |
| index | **int32_t** | El índice base cero en el que se insertará el marco de imagen. |
...
| image | [System::SharedPtr](../../../system/sharedptr/)\<[IPPImage](../../ippimage/)\> | El [IPPImage](../../ippimage/) a mostrar en el marco de imagen. |
