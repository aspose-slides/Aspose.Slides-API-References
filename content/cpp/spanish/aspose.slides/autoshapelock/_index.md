...
| **bool** [get_NoLocks](../baseshapelock/get_nolocks/)() override | Devuelve true si todas las banderas de bloqueo están desactivadas. Sólo lectura **bool**. |
...
| **bool** [get_TextLocked](./get_textlocked/)() override | Determina si editar texto está prohibido. Lectura **bool**. |
...
| void [set_AdjustHandlesLocked](./set_adjusthandleslocked/)(**bool**) override | Determina si cambiar valores de ajuste está prohibido. Escritura **bool**. |
...
| void [set_TextLocked](./set_textlocked/)(**bool**) override | Determina si editar texto está prohibido. Escritura **bool**. |
...
* Clase [IAutoShapeLock](../iautoshapelock/)
