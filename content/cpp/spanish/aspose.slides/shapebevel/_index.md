...
| [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() override | Tipo de bisel. Leer [BevelPresetType](../bevelpresettype/). |
| **double** [get_Height](./get_height/)() override | Altura del bisel. Leer **double**. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../idomobject/)\> [get_Parent_Immediate](../idomobject/get_parent_immediate/)() | Devuelve el objeto Parent_Immediate. Sólo de lectura [IDOMObject](../idomobject/). |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../ipviobject/get_parent_ipresentationcomponent/)() | Devuelve el [IPresentationComponent](../ipresentationcomponent/) padre. Sólo de lectura [IPresentationComponent](../ipresentationcomponent/). |
| **double** [get_Width](./get_width/)() override | Ancho del bisel. Leer **double**. |
...
| void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) override | Tipo de bisel. Escribe [BevelPresetType](../bevelpresettype/). |
| void [set_Height](./set_height/)(**double**) override | Altura del bisel. Escribe **double**. |
| void [set_Width](./set_width/)(**double**) override | Ancho del bisel. Escribe **double**. |
