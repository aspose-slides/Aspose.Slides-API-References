...
| virtual **float** [get_CenterX](./get_centerx/)() | Devuelve la coordenada X del centro de un marco. Solo lectura **float**. |
| virtual **float** [get_CenterY](./get_centery/)() | Devuelve la coordenada Y del centro de un marco. Solo lectura **float**. |
| virtual [NullableBool](../nullablebool/) [get_FlipH](./get_fliph/)() | Determina si un marco está volteado horizontalmente. Solo lectura [NullableBool](../nullablebool/). |
| virtual [NullableBool](../nullablebool/) [get_FlipV](./get_flipv/)() | Determina si un marco está volteado verticalmente. Solo lectura [NullableBool](../nullablebool/). |
| virtual **float** [get_Height](./get_height/)() | Devuelve la altura de un marco. Solo lectura **float**. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [get_Rectangle](./get_rectangle/)() | Devuelve las coordenadas de un marco. Solo lectura [System::Drawing::RectangleF](../../system.drawing/rectanglef/). |
| virtual **float** [get_Rotation](./get_rotation/)() | Devuelve el número de grados que un marco está rotado alrededor del eje z. Un valor positivo indica rotación en sentido horario; un valor negativo indica rotación en sentido antihorario. Solo lectura **float**. |
| virtual **float** [get_Width](./get_width/)() | Devuelve el ancho de un marco. Solo lectura **float**. |
| virtual **float** [get_X](./get_x/)() | Devuelve la coordenada X de la esquina superior izquierda de un marco. Solo lectura **float**. |
| virtual **float** [get_Y](./get_y/)() | Devuelve la coordenada Y de la esquina superior izquierda de un marco. Solo lectura **float**. |
