...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Devuelve los datos binarios de los subtítulos cerrados. Sólo lectura **uint8_t**[]. |
| [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() override | Devuelve el identificador global único (GUID) de los subtítulos cerrados. Sólo lectura [System::Guid](../../system/guid/). |
| [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() override | Devuelve los datos de los subtítulos como cadena codificada UTF-8. Sólo lectura [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Label](./get_label/)() override | Devuelve la etiqueta de los subtítulos cerrados. Leer [System::String](../../system/string/). |
...
| void [set_Label](./set_label/)([System::String](../../system/string/)) override | Establece la etiqueta de los subtítulos cerrados. Escribir [System::String](../../system/string/). |
