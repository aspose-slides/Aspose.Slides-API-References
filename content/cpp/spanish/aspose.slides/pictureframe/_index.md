...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IShapeElement](../ishapeelement/)\>\> [CreateShapeElements](../geometryshape/createshapeelements/)() override | Crea y devuelve un arreglo de elementos de la forma. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [get_Adjustment](../geometryshape/get_adjustment/)(**int32_t**) override | Devuelve el valor de ajustes de la forma en el índice especificado. |
...
| [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../shape/get_blackwhitemode/)() override | La propiedad especifica cómo se renderiza una forma en modo de visualización en blanco y negro. Lectura [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| **bool** [get_IsCameo](./get_iscameo/)() | Determina si el [PictureFrame](./) es un objeto Cameo o no. Solo lectura **bool**. |
...
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | Devuelve un identificador único de diapositiva que permanece constante durante la vida útil de la forma y permite que PowerPoint o código de interop lo referencie de forma fiable desde cualquier parte del documento. Solo lectura **uint32_t**. Ver también [Shape::get_UniqueId](../shape/get_uniqueid/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_PictureFormat](./get_pictureformat/)() override | Devuelve el objeto [PictureFillFormat](../picturefillformat/) para un marco de imagen. Solo lectura [IPictureFillFormat](../ipicturefillformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPictureFrameLock](../ipictureframelock/)\> [get_PictureFrameLock](./get_pictureframelock/)() override | Devuelve los bloqueos de la forma. Solo lectura [IPictureFrameLock](../ipictureframelock/). |
...
| **float** [get_RelativeScaleHeight](./get_relativescaleheight/)() override | Devuelve la escala de altura (relativa al tamaño original de la imagen) del marco de imagen. El valor 1.0 corresponde al 100%. Lectura **float**. |
| **float** [get_RelativeScaleWidth](./get_relativescalewidth/)() override | Devuelve la escala de anchura (relativa al tamaño original de la imagen) del marco de imagen. El valor 1.0 corresponde al 100%. Lectura **float**. |
...
| **uint32_t** [get_UniqueId](../shape/get_uniqueid/)() override | Devuelve un identificador interno, limitado a la presentación, destinado al uso por complementos u otro código. Debido a que este valor puede ser reasignado por el usuario o programáticamente, no debe tratarse como una clave única permanente. Solo lectura **uint32_t**. Ver también [Shape::get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetImage](../shape/getimage/)() override | Devuelve la miniatura de la forma. Por defecto se usa el tipo de límites de miniatura [ShapeThumbnailBounds::Shape](../shapethumbnailbounds/). |
...
| void [set_RelativeScaleHeight](./set_relativescaleheight/)(**float**) override | Establece la escala de altura (relativa al tamaño original de la imagen) del marco de imagen. El valor 1.0 corresponde al 100%. Escritura **float**. |
| void [set_RelativeScaleWidth](./set_relativescalewidth/)(**float**) override | Establece la escala de anchura (relativa al tamaño original de la imagen) del marco de imagen. El valor 1.0 corresponde al 100%. Escritura **float**. |
...
El siguiente ejemplo muestra cómo cambiar la miniatura del marco [Audio](../audio/). 
```cpp
