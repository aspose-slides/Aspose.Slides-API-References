...
---
## IDrawingGuidesCollection clase
...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [Add](./add/)([Orientation](../orientation/), **float**) | Agrega la guía de dibujo al final de la colección. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Obtiene el número de todos los elementos de la colección. **int32_t** de solo lectura. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve la guía de dibujo por índice. [IDrawingGuide](../idrawingguide/) de solo lectura. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Elimina la guía de dibujo en el índice especificado. |
