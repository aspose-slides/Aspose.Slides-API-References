...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Devuelve el color de la guía de dibujo. Leer [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Devuelve la orientación de la guía de dibujo. Leer [Slides::Orientation](../orientation/). |
| virtual **float** [get_Position](./get_position/)() | Devuelve la posición de la guía de dibujo en puntos desde la esquina superior izquierda de la diapositiva. Leer **float**. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Establece el color de la guía de dibujo. Escribir [System::Drawing::Color](../../system.drawing/color/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | Establece la orientación de la guía de dibujo. Escribir [Slides::Orientation](../orientation/). |
| virtual void [set_Position](./set_position/)(**float**) | Establece la posición de la guía de dibujo en puntos desde la esquina superior izquierda de la diapositiva. Escribir **float**. |
