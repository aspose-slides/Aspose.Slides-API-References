...
| Método | Descripción |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | Compara la instancia actual con otro objeto del mismo tipo. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | Devuelve el estilo de alineación de una tabulación. Leer [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | Devuelve la posición de una tabulación. Asignar esta propiedad puede cambiar el índice de la tabulación en la colección e invalidar el Enumerator. Leer **double**. |
...
| void [Lock](../../system/object/lock/)() | Implementa la instrucción lock() de C# bloqueando. Llámela directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | Establece el estilo de alineación de una tabulación. Escribir [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | Establece la posición de una tabulación. Asignar esta propiedad puede cambiar el índice de la tabulación en la colección e invalidar el Enumerator. Escribir **double**. |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | Crea un nuevo [Tab](./) |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Análogo al método C# [Object.ToString()](../../system/object/tostring/). Permite convertir objetos personalizados a cadena. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementa la construcción C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementa la instrucción lock() de C# desbloqueando. Llámela directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
