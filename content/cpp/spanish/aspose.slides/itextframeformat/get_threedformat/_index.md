...
description: Devuelve el objeto ThreeDFormat que representa las propiedades de efecto 3D para un texto. Solo lectura IThreeDFormat.
type: docs
weight: 300
url: /es/aspose.slides/itextframeformat/get_threedformat/
---
## ITextFrameFormat::get_ThreeDFormat() método


Devuelve el objeto [ThreeDFormat](../../threedformat/) que representa las propiedades de efecto 3D para un texto. Sólo lectura [IThreeDFormat](../../ithreedformat/).
