...
| virtual **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() | Determina si la forma debe conservar la proporción al redimensionar. Lectura **bool**. |
| virtual **bool** [get_GroupingLocked](./get_groupinglocked/)() | Determina si añadir esta forma a un grupo está prohibido. Lectura **bool**. |
| virtual **bool** [get_NoLocks](../ibaseshapelock/get_nolocks/)() | Devuelve true si todas las banderas de bloqueo están desactivadas. Solo lectura **bool**. |
...
| virtual **bool** [get_UngroupingLocked](./get_ungroupinglocked/)() | Determina si dividir este grupo de formas está prohibido. Lectura **bool**. |
...
| virtual void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) | Determina si la forma debe conservar la proporción al redimensionar. Escritura **bool**. |
...
| virtual void [set_UngroupingLocked](./set_ungroupinglocked/)(**bool**) | Determina si dividir este grupo de formas está prohibido. Escritura **bool**. |
