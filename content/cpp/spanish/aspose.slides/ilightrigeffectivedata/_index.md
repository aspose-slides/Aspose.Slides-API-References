...
description: Objeto inmutable que contiene las propiedades efectivas del rig de luz.
type: docs
weight: 2718
url: /es/aspose.slides/ilightrigeffectivedata/
---
## ILightRigEffectiveData clase

Objeto inmutable que contiene las propiedades efectivas del rig de luz.
...
| virtual [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() | Dirección de la luz. Solo lectura [LightingDirection](../lightingdirection/). |
| virtual [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() | Representa una luz preestablecida que puede aplicarse a una forma. El rig de luz representa un grupo de luces orientadas de una manera específica respecto a una escena 3D. Solo lectura [LightRigPresetType](../lightrigpresettype/). |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo del statement lock() de C#. Llámelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
