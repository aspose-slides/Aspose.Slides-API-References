...
| virtual [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() | Especifica un identificador global único (GUID) que identifica de forma única una única parte XML personalizada dentro de un documento Office Open XML. Solo lectura [System::Guid](../../system/guid/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() | Devuelve la colección de esquemas XML asociados con la parte XML personalizada. Solo lectura [System::String](../../system/string/)[]. |
| virtual [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() | Devuelve los datos xml como cadena UTF-8. Lectura [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() | Devuelve los datos xml. Lectura **uint8_t**[]. |
...
| virtual void [Remove](./remove/)() | Elimina la parte XML personalizada de la presentación. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| virtual void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) | Especifica un identificador global único (GUID) que identifica de forma única una única parte XML personalizada dentro de un documento Office Open XML. Solo lectura [System::Guid](../../system/guid/). |
| virtual void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) | Establece los datos xml como cadena UTF-8. Escritura [System::String](../../system/string/). |
| virtual void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Establece los datos xml. Escritura **uint8_t**[]. |
