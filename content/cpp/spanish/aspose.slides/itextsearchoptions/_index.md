...
description: Representa opciones que pueden usarse para buscar texto en un Presentation, Slide o TextFrame.
type: docs
weight: 4122
url: /es/aspose.slides/itextsearchoptions/
---
## ITextSearchOptions clase
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Establezca true para usar búsqueda sensible a mayúsculas y minúsculas, false en caso contrario. Lee **bool**. |
| virtual **bool** [get_IncludeNotes](./get_includenotes/)() | Establezca **true** para incluir texto contenido en notas de diapositiva al realizar búsquedas de texto, sustitución o resaltado. El valor predeterminado es **false**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Establezca true para coincidir solo palabras completas, false en caso contrario. Lee **bool**. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Establezca true para usar búsqueda sensible a mayúsculas y minúsculas, false en caso contrario. Escribe **bool**. |
| virtual void [set_IncludeNotes](./set_includenotes/)(**bool**) | Establezca **true** para incluir texto contenido en notas de diapositiva al realizar búsquedas de texto, sustitución o resaltado. El valor predeterminado es **false**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Establezca true para coincidir solo palabras completas, false en caso contrario. Escribe **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establezca el n-ésimo argumento de plantilla como puntero débil (en lugar de compartido). Permite cambiar punteros en contenedores al modo débil. |
