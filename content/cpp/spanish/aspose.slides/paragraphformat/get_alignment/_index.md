...
description: Devuelve la alineación del texto en un párrafo sin herencia. Lea TextAlignment.
type: docs
weight: 1
url: /es/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() method


Devuelve la alineación del texto en un párrafo sin herencia. Lea [TextAlignment](../../textalignment/).
...
* Enumeración [TextAlignment](../../textalignment/)
