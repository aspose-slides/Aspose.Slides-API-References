...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | Agrega un nuevo marcador de posición si no existe y establece las propiedades del marcador de posición a uno especificado. |
...
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | Propiedad que especifica cómo una forma se renderiza en modo de visualización en blanco y negro. Leer [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkClick](../ihyperlinkcontainer/get_hyperlinkclick/)() | Devuelve el hipervínculo definido para el clic del mouse. Leer [IHyperlink](../ihyperlink/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkMouseOver](../ihyperlinkcontainer/get_hyperlinkmouseover/)() | Devuelve el hipervínculo definido para pasar el mouse por encima. Leer [IHyperlink](../ihyperlink/). |
| virtual [ZoomImageType](../zoomimagetype/) [get_ImageType](./get_imagetype/)() | Obtiene el tipo de imagen de un objeto zoom. Leer [ZoomImageType](../zoomimagetype/). Valor predeterminado: Preview |
...
| virtual **bool** [get_ReturnToParent](./get_returntoparent/)() | Obtiene el comportamiento de navegación en la presentación. Solo lectura **bool**. Valor predeterminado: false |
...
| virtual **bool** [get_ShowBackground](./get_showbackground/)() | Obtiene el valor que especifica si el Zoom usará el fondo de la diapositiva de destino. Solo lectura **bool**. Valor predeterminado: true |
...
| virtual **float** [get_TransitionDuration](./get_transitionduration/)() | Obtiene la duración de la transición entre Zoom y diapositiva. Solo lectura **float**. Valor predeterminado: 1.0f |
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Devuelve un identificador interno de alcance de presentación destinado a ser usado por complementos u otro código. Debido a que este valor puede ser reasignado por el usuario o programáticamente, no debe tratarse como una clave única persistente. Solo lectura **uint32_t**. Ver también [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](./get_zoomimage/)() | Obtiene la imagen para el objeto zoom. Leer [IPPImage](../ippimage/). |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtiene el tipo actual del objeto. Análogo a la llamada C# [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | La propiedad especifica cómo una forma se renderizará en modo de visualización en blanco y negro. Escribe [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual void [set_HyperlinkClick](../ihyperlinkcontainer/set_hyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) | Establece el hipervínculo definido para el clic del mouse. Escribe [IHyperlink](../ihyperlink/). |
| virtual void [set_HyperlinkMouseOver](../ihyperlinkcontainer/set_hyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) | Establece el hipervínculo definido para pasar el mouse por encima. Escribe [IHyperlink](../ihyperlink/). |
| virtual void [set_ImageType](./set_imagetype/)([ZoomImageType](../zoomimagetype/)) | Establece el tipo de imagen de un objeto zoom. Escribe [ZoomImageType](../zoomimagetype/). Valor predeterminado: Preview |
...
| virtual void [set_ReturnToParent](./set_returntoparent/)(**bool**) | Establece el comportamiento de navegación en la presentación. Escribe **bool**. Valor predeterminado: false |
| virtual void [set_Rotation](../ishape/set_rotation/)(**float**) | Establece el número de grados que la forma especificada está rotada alrededor del eje z. Un valor positivo indica rotación en sentido horario; un valor negativo indica rotación en sentido antihorario. Escribe **float**. |
| virtual void [set_ShowBackground](./set_showbackground/)(**bool**) | Establece el valor que especifica si el Zoom usará el fondo de la diapositiva de destino. Escribe **bool**. Valor predeterminado: true |
| virtual void [set_TransitionDuration](./set_transitionduration/)(**float**) | Establece la duración de la transición entre Zoom y diapositiva. Escribe **float**. Valor predeterminado: 1.0f |
| virtual void [set_Width](../ishape/set_width/)(**float**) | Establece el ancho de la forma, medido en puntos. Escribe **float**. |
...
| virtual void [set_ZoomImage](./set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | Establece la imagen para el objeto zoom. Escribe [IPPImage](../ippimage/). |
