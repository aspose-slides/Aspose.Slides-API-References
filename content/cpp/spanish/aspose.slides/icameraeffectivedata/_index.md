...
---
## Clase ICameraEffectiveData

Objeto inmutable que contiene propiedades efectivas de la cámara.
...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) tipo. Sólo lectura [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 grados, campo de visión). Sólo lectura **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) zoom (valor positivo en porcentaje). Sólo lectura **float**. |
