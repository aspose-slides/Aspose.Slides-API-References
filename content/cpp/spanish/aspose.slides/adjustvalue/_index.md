...
description: Representa el valor de ajuste de una forma geométrica. Estos valores afectan la forma.
type: docs
weight: 1
...
Representa el valor de ajuste de una forma geométrica. Estos valores afectan la forma.
...
| **float** [get_AngleValue](./get_anglevalue/)() override | Devuelve el valor, interpretándolo como ángulo en grados. Lectura **float**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Devuelve el nombre de este valor de ajuste. Solo lectura [System::String](../../system/string/). |
| **int64_t** [get_RawValue](./get_rawvalue/)() override | Devuelve el valor de ajuste "tal cual". Lectura **int64_t**. |
| [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() override | Devuelve el tipo del ajuste de forma. Solo lectura [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| void [set_AngleValue](./set_anglevalue/)(**float**) override | Establece el valor, interpretándolo como ángulo en grados. Escritura **float**. |
| void [set_RawValue](./set_rawvalue/)(**int64_t**) override | Establece el valor de ajuste "tal cual". Escritura **int64_t**. |
...
* Clase [IAdjustValue](../iadjustvalue/)
