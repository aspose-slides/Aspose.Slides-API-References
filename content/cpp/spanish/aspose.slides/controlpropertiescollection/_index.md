...
---
## ControlPropertiesCollection clase


Una colección de AcitveX properties.
...
| Método | Descripción |
| --- | --- |
| void [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Añade una propiedad a la colección. |
| [iterator](./iterator/) [begin](./begin/)() | Obtiene un iterador que apunta al primer elemento (si existe) de la colección. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtiene un iterador que apunta al primer elemento (si existe) de la instancia const de la colección. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtiene un iterador que apunta al primer elemento const (si existe) de la colección. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtiene un iterador que apunta justo después del último elemento const (si existe) de la colección. |
| void [Clear](./clear/)() override | Elimina todas las propiedades. |
| [iterator](./iterator/) [end](./end/)() | Obtiene un iterador que apunta justo después del último elemento (si existe) de la colección. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtiene un iterador que apunta justo después del último elemento (si existe) de la instancia const de la colección. |
...
| **int32_t** [get_Count](./get_count/)() override | Devuelve el número de propiedades en la colección. Solo lectura **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::String](../../system/string/)\>\> [get_NamesOfProperties](./get_namesofproperties/)() override | Devuelve la colección de nombres de propiedades. Solo lectura ICollection<string>. |
...
| [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) override | Devuelve la propiedad. |
| void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Establece la propiedad. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Calcula el promedio de una secuencia de valores obtenidos mediante una función de transformación en cada elemento de la secuencia de entrada. |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | Elimina una propiedad con el nombre especificado. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtiene un iterador que apunta al primer elemento (si existe) de la instancia const de la colección. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtiene un iterador que apunta justo después del último elemento (si existe) de la instancia const de la colección. |
