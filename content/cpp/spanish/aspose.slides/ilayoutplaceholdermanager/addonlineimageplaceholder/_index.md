...
---
## ILayoutPlaceholderManager::AddOnlineImagePlaceholder(float, float, float, float) método
...
Creado [IAutoShape](../../iautoshape/) con un marcador de posición de Imagen en línea.
