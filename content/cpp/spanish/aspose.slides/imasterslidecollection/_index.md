...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Agrega una copia de una diapositiva maestra especificada al final de la colección. Las diapositivas de diseño vinculadas también se copiarán. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [idx_get](./idx_get/)(**int32_t**) | Obtiene el elemento en el índice especificado. [IMasterSlide](../imasterslide/) de solo lectura. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Inserta una copia de una diapositiva maestra especificada en la posición indicada de la colección. Las diapositivas de diseño vinculadas también se copiarán. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Elimina la primera ocurrencia de un objeto específico de la colección. |
...
| virtual void [RemoveUnused](./removeunused/)(**bool**) | Elimina diapositivas maestras no utilizadas. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el n-ésimo argumento de plantilla como puntero weak (en lugar de shared). Permite cambiar punteros en contenedores al modo weak. |
