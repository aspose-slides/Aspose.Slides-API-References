...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() | Obtiene la información cultural preferida para calcular algunas funciones destinadas a usarse con lenguajes que utilizan el conjunto de caracteres de doble byte (DBCS). |
| virtual **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() | Si la fuente de datos para el gráfico es un libro de trabajo externo y no está disponible, se recuperará desde la caché del gráfico. |
...
| virtual void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) | Establece la información cultural preferida para calcular algunas funciones destinadas a usarse con lenguajes que utilizan el conjunto de caracteres de doble byte (DBCS). |
| virtual void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) | Si la fuente de datos para el gráfico es un libro de trabajo externo y no está disponible, se recuperará desde la caché del gráfico. |
