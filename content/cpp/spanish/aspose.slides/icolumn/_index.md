...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormat](../icolumnformat/)\> [get_ColumnFormat](./get_columnformat/)() | Devuelve el objeto [ColumnFormat](../columnformat/) que contiene las propiedades de formato para esta columna. Sólo lectura [IColumnFormat](../icolumnformat/). |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Devuelve un valor que indica si el acceso a la colección está sincronizado (seguro para hilos). Sólo lectura **bool**. |
...
| virtual **double** [get_Width](./get_width/)() | Devuelve el ancho de una columna. Lectura **double**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructor de copia. En realidad no copia nada, solo inicializa un nuevo objeto y permite la copia constructora en subclases. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de asignación. En realidad no copia nada, solo inicializa un nuevo objeto y permite la copia constructora en subclases. |
...
| virtual void [set_Width](./set_width/)(**double**) | Establece el ancho de una columna. Escritura **double**. |
