...
| Method | Description |
| --- | --- |
| **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Agrega una nueva etiqueta a la colección. |
...
| void [Clear](./clear/)() override | Elimina todas las etiquetas de la colección. |
| **bool** [Contains](./contains/)([System::String](../../system/string/)) override | Determina si la colección contiene un nombre específico. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\>, **int32_t**) override | Copia todos los elementos de la colección en la matriz especificada. |
...
| **int32_t** [get_Count](./get_count/)() override | Devuelve el número de etiquetas en la colección. Solo lectura **int32_t**. |
...
| [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) override | Devuelve la clave de una etiqueta en el índice especificado. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() override | Devuelve los nombres de las etiquetas. |
...
| [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) override | Devuelve el valor de una etiqueta en el índice especificado. |
| [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) override | Devuelve un par clave-valor de una etiqueta. |
| void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Establece un par clave-valor de una etiqueta. |
| **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) override | Devuelve el índice basado en cero de la clave especificada en la colección. |
...
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | Aplica una función acumuladora a lo largo de una secuencia. |
...
| void [Lock](../../system/object/lock/)() | Implementa la declaración C# lock() bloqueando. Llámese directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | Elimina la etiqueta con el nombre especificado de la colección. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Elimina la etiqueta en el índice especificado. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la declaración C# lock() desbloqueando. Llámese directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
El siguiente ejemplo muestra cómo agregar una etiqueta a un [Presentation](../presentation/) de PowerPoint. 
```cpp
...
* Clase [ITagCollection](../itagcollection/)
