...
| Método | Descripción |
| --- | --- |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) override | Crea una copia de la fila de plantilla especificada y la inserta al final de una tabla. |
| [iterator](./iterator/) [begin](./begin/)() | Obtiene un iterador que apunta al primer elemento (si existe) de la colección. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtiene un iterador que apunta al primer elemento (si existe) de la instancia calificada como const de la colección. |
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\>, **int32_t**) override | Copia todos los elementos de la colección al array especificado. |
...
| **int32_t** [get_Count](./get_count/)() override | Obtiene el número de filas realmente contenidas en la colección. Solo lectura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que itera a través de la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\> [idx_get](./idx_get/)(**int32_t**) override | Devuelve la fila en el índice especificado. Solo lectura [Row](../row/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) override | Crea una copia de la fila de plantilla especificada y la inserta en la posición especificada dentro de una tabla. |
...
| void [RemoveAt](./removeat/)(**int32_t**, **bool**) override | Elimina una fila en la posición especificada de una tabla. |
...
* Clase [IRowCollection](../irowcollection/)
