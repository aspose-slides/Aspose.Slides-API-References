...
---
## ICommonSlideViewProperties clase
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | Devuelve la guía de dibujo en el índice especificado. Solo lectura [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | Devuelve la colección de guías de dibujo. Solo lectura [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | Especifica la proporción de escala de la vista en porcentajes. Leer **int32_t**. |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | Especifica que el contenido de la vista debe escalarse automáticamente para ajustarse mejor al tamaño actual de la ventana. Leer **bool**. |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | Especifica la proporción de escala de la vista en porcentajes. Escribir **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | Especifica que el contenido de la vista debe escalarse automáticamente para ajustarse mejor al tamaño actual de la ventana. Escribir **bool**. |
