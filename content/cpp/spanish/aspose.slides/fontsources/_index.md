...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_FontFolders](./get_fontfolders/)() override | Carpetas que contienen archivos de fuente. Todos los archivos de fuente ubicados en estas carpetas están incluidos en la colección. Carpetas que se buscan de forma recursiva. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\> [get_MemoryFonts](./get_memoryfonts/)() override | Una colección de fuentes representada como matrices de bytes. |
...
| void [set_FontFolders](./set_fontfolders/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) override | Carpetas que contienen archivos de fuente. Todos los archivos de fuente ubicados en estas carpetas están incluidos en la colección. Carpetas que se buscan de forma recursiva. |
| void [set_MemoryFonts](./set_memoryfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\>) override | Una colección de fuentes representada como matrices de bytes. |
