...
---
## IGradientStopEffectiveData clase
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Devuelve el color de una parada de degradado. Sólo lectura [System::Drawing::Color](../../system.drawing/color/). |
| virtual **float** [get_Position](./get_position/)() | Devuelve la posición (0..1) de una parada de degradado. Sólo lectura **float**. |
