...
type: docs
weight: 4941
url: /es/aspose.slides/pviproperty/
---
## PVIProperty clase
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Establece el enésimo argumento de plantilla como puntero débil (en lugar de compartido). Permite cambiar punteros en contenedores al modo débil. |
...
* Clase [PVIPropertyBase](../pvipropertybase/)
