...
| virtual **uint32_t** [get_Index](./get_index/)() | Obtiene el índice de un marcador de posición. Solo lectura **uint32_t**. |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Obtiene la orientación de un marcador de posición. Solo lectura [Slides::Orientation](../orientation/). |
| virtual [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() | Obtiene el tamaño de un marcador de posición. Solo lectura [PlaceholderSize](../placeholdersize/). |
| virtual [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() | Obtiene el tipo de un marcador de posición. Solo lectura [PlaceholderType](../placeholdertype/). |
