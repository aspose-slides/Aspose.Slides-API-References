...
El siguiente ejemplo muestra cómo convertir PowerPoint a HTML usando C++.
```cpp
// Instancia un objeto de presentación que representa un archivo de presentación, p.ej. PPT, PPTX, ODP, etc.
...
// Guarda la presentación en HTML
presentation->Save(u"ConvertWholePresentationToHTML_out.html", SaveFormat::Html, htmlOpt);
```
El siguiente ejemplo muestra cómo convertir PowerPoint a HTML responsivo usando C++.
```cpp
...
```
El siguiente ejemplo muestra cómo convertir PowerPoint a HTML con notas usando C++.
```cpp
...
```
El siguiente ejemplo muestra cómo convertir PowerPoint a HTML con fuentes originales usando C++.
```cpp
...
```
El siguiente ejemplo muestra cómo convertir PowerPoint a HTML con imágenes de alta calidad a 150 DPI usando C++.
```cpp
...
```
El siguiente ejemplo muestra cómo convertir PowerPoint a HTML con imágenes de calidad completa usando C++.
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
El siguiente ejemplo muestra cómo convertir [Slide](../../slide/) a HTML usando C++.
```cpp
```
...
```
 El siguiente ejemplo muestra cómo convertir PowerPoint a PNG con tamaño personalizado. 
```cpp
auto pres = System::MakeObject<Presentation>(u"pres.pptx");
