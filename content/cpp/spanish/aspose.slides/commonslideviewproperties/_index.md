...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) override | Devuelve la guía de dibujo en el índice especificado. Solo lectura [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Devuelve la colección de guías de dibujo. Solo lectura [IDrawingGuidesCollection](../idrawingguidescollection/) |
| **int32_t** [get_Scale](./get_scale/)() override | Especifica la proporción de escala de la vista en porcentajes. Lectura **int32_t**. |
| **bool** [get_VariableScale](./get_variablescale/)() override | Especifica que el contenido de la vista debe escalarse automáticamente para ajustarse al tamaño actual de la ventana. Lectura **bool**. |
...
| void [set_Scale](./set_scale/)(**int32_t**) override | Especifica la proporción de escala de la vista en porcentajes. Escritura **int32_t**. |
| void [set_VariableScale](./set_variablescale/)(**bool**) override | Especifica que el contenido de la vista debe escalarse automáticamente para ajustarse al tamaño actual de la ventana. Escritura **bool**. |
...
El siguiente ejemplo muestra cómo establecer el valor de zoom para una diapositiva de PowerPoint [Presentation](../presentation/). 
```cpp
// Instanciar un objeto Presentation que representa un archivo de presentación
auto presentation = System::MakeObject<Presentation>(u"demo.pptx");

// Configurando propiedades de vista de la presentación
presentation->get_ViewProperties()->get_SlideViewProperties()->set_Scale(100);
// Valor de zoom en porcentaje para la vista de diapositiva
...
* Clase [ICommonSlideViewProperties](../icommonslideviewproperties/)
