...
description: Representa el administrador que mantiene el comportamiento de los marcadores de posición de pie de página, fecha y hora, número de página para todos los tipos de diapositiva.
type: docs
weight: 1444
url: /es/aspose.slides/ibaseheaderfootermanager/
---
## IBaseHeaderFooterManager clase

Representa el administrador que mantiene el comportamiento de los marcadores de posición de pie de página, fecha y hora, número de página para todos los tipos de diapositiva.
