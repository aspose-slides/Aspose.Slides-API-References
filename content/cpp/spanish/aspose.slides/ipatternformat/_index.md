...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_BackColor](./get_backcolor/)() | Devuelve el color de fondo del patrón. Solo lectura [IColorFormat](../icolorformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ForeColor](./get_forecolor/)() | Devuelve el color de primer plano del patrón. Solo lectura [IColorFormat](../icolorformat/). |
| virtual [Aspose::Slides::PatternStyle](../patternstyle/) [get_PatternStyle](./get_patternstyle/)() | Devuelve el estilo del patrón. Lectura [Slides::PatternStyle](../patternstyle/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/), [System::Drawing::Color](../../system.drawing/color/)) | Crea una imagen de mosaico para el relleno de patrón con colores especificados. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/)) | Crea una imagen de mosaico para el relleno de patrón. |
...
| virtual void [set_PatternStyle](./set_patternstyle/)([Aspose::Slides::PatternStyle](../patternstyle/)) | Establece el estilo del patrón. Escritura [Slides::PatternStyle](../patternstyle/). |
