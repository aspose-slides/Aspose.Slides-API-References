...
| Método | Descripción |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | Compara el objeto actual con el objeto especificado. |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Devuelve el estilo de alineación de una tabulación. Lea [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Devuelve la posición de una tabulación. Asignar esta propiedad puede cambiar el índice de la tabulación en la colección e invalidar el Enumerador. Lea **double**. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Establece el estilo de alineación de una tabulación. Escriba [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Establece la posición de una tabulación. Asignar esta propiedad puede cambiar el índice de la tabulación en la colección e invalidar el Enumerador. Escriba **double**. |
