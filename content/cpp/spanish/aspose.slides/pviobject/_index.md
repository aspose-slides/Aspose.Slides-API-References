...
description: Encapsula la infraestructura básica de servicio para objetos que pueden ser objeto de herencia de valores de propiedades.
type: docs
weight: 4928
...
Encapsula la infraestructura básica de servicio para objetos que pueden ser objeto de herencia de valores de propiedades.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Compara con el objeto especificado. |
