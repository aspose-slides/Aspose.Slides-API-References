...
| Método | Descripción |
| --- | --- |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>, **bool**) | Crea una copia de la fila de plantilla especificada y la inserta al final de una tabla. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Devuelve un valor que indica si el acceso a la colección está sincronizado (thread-safe). Sólo lectura **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve la columna en el índice especificado. Sólo lectura [IColumn](../icolumn/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\>, **bool**) | Crea una copia de la columna de plantilla especificada y la inserta en la posición especificada de una tabla. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**, **bool**) | Elimina una columna en la posición especificada de una tabla. |
