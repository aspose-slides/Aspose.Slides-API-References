...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() override | Devuelve un [EffectFormat](../effectformat/) para relleno [BackgroundType::OwnBackground](../backgroundtype/). Solo lectura [IEffectFormat](../ieffectformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Devuelve un [FillFormat](../fillformat/) para relleno [BackgroundType::OwnBackground](../backgroundtype/). Solo lectura [IFillFormat](../ifillformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() override | Devuelve un [ColorFormat](../colorformat/) para un relleno [BackgroundType::Themed](../backgroundtype/). Solo lectura [IColorFormat](../icolorformat/). |
| **uint16_t** [get_StyleIndex](./get_styleindex/)() override | Devuelve un índice de relleno [BackgroundType::Themed](../backgroundtype/) en la colección de temas de fondo. 0 significa sin relleno. 1..999 - índice. Sólo lectura **uint16_t**. |
| [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() override | Devuelve un tipo de relleno de fondo. Sólo lectura [BackgroundType](../backgroundtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtiene los datos de fondo efectivos con la herencia aplicada. |
...
| void [set_StyleIndex](./set_styleindex/)(**uint16_t**) override | Devuelve un índice de relleno [BackgroundType::Themed](../backgroundtype/) en la colección de temas de fondo. 0 significa sin relleno. 1..999 - índice. Escritura **uint16_t**. |
| void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) override | Devuelve un tipo de relleno de fondo. Escritura [BackgroundType](../backgroundtype/). |
