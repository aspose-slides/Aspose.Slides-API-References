...
| **int32_t** [get_Count](./get_count/)() override | Devuelve el número de partes en el grupo. Solo lectura **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Devuelve el nombre del grupo de partes del documento. Solo lectura [System::String](../../system/string/). |
...
* Clase [IHeadingPair](../iheadingpair/)
