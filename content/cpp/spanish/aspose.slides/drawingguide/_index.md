...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Devuelve el color de la guía de dibujo. Lea [System::Drawing::Color](../../system.drawing/color/). |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Devuelve la orientación de la guía de dibujo. Lea [Slides::Orientation](../orientation/). |
| **float** [get_Position](./get_position/)() override | Devuelve la posición de la guía de dibujo en puntos desde la esquina superior izquierda de la diapositiva. Lea **float**. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Establece el color de la guía de dibujo. Escriba [System::Drawing::Color](../../system.drawing/color/). |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) override | Establece la orientación de la guía de dibujo. Escriba [Slides::Orientation](../orientation/). |
| void [set_Position](./set_position/)(**float**) override | Establece la posición de la guía de dibujo en puntos desde la esquina superior izquierda de la diapositiva. Escriba **float**. |
...
* Clase [IDrawingGuide](../idrawingguide/)
