...
| virtual [System::String](../../system/string/) [get_BaseUri](./get_baseuri/)() | Devuelve la URI base del SVG especificado. Se utiliza para resolver enlaces relativos. Solo lectura [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\> [get_ExternalResourceResolver](./get_externalresourceresolver/)() | Devuelve la interfaz de devolución de llamada usada para resolver recursos externos durante la importación de documentos SVG. Solo lectura [Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/). |
| virtual [System::String](../../system/string/) [get_SvgContent](./get_svgcontent/)() | Devuelve el contenido SVG. Solo lectura [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_SvgData](./get_svgdata/)() | Devuelve los datos SVG. Solo lectura **uint8_t**[]. |
...
| virtual void [WriteAsEmf](./writeasemf/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Guarda la imagen SVG como un archivo EMF. |
