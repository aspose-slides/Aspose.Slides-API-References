...
---
## IPictureFillFormatEffectiveData clase
...
| virtual **float** [get_CropBottom](./get_cropbottom/)() | Devuelve el número de porcentajes de la altura real de la imagen que se recortan en la parte inferior de la imagen. Solo lectura **float**. |
| virtual **float** [get_CropLeft](./get_cropleft/)() | Devuelve el número de porcentajes de la anchura real de la imagen que se recortan en el lado izquierdo de la imagen. Solo lectura **float**. |
| virtual **float** [get_CropRight](./get_cropright/)() | Devuelve el número de porcentajes de la anchura real de la imagen que se recortan en el lado derecho de la imagen. Solo lectura **float**. |
| virtual **float** [get_CropTop](./get_croptop/)() | Devuelve el número de porcentajes de la altura real de la imagen que se recortan en la parte superior de la imagen. Solo lectura **float**. |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | Devuelve el dpi que se usa para rellenar una imagen. Solo lectura **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | Devuelve la imagen. Solo lectura [IPictureEffectiveData](../ipictureeffectivedata/). |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | Devuelve el modo de relleno de imagen. Solo lectura [Slides::PictureFillMode](../picturefillmode/). |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo de la sentencia lock() de C#. Llámalo directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo de la sentencia lock() de C#. Llámalo directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
