...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../ishape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) | Agrega un nuevo marcador de posición si no hay ninguno y establece las propiedades del marcador de posición en uno especificado. |
...
| virtual [System::String](../../system/string/) [get_AlternativeText](../ishape/get_alternativetext/)() | Devuelve el texto alternativo asociado a una forma. Solo lectura [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_AlternativeTextTitle](../ishape/get_alternativetexttitle/)() | Devuelve el título del texto alternativo asociado a una forma. Solo lectura [System::String](../../system/string/). |
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | Propiedad que especifica cómo se mostrará una forma en modo de visualización en blanco y negro. Solo lectura [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Devuelve la descripción de texto del objeto Summary Zoom [Section](../section/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_Frame](../ishape/get_frame/)() | Devuelve las propiedades del marco de la forma. Solo lectura [IShapeFrame](../ishapeframe/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkClick](../ihyperlinkcontainer/get_hyperlinkclick/)() | Devuelve el hipervínculo definido para clic del ratón. Solo lectura [IHyperlink](../ihyperlink/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkMouseOver](../ihyperlinkcontainer/get_hyperlinkmouseover/)() | Devuelve el hipervínculo definido para paso del ratón. Solo lectura [IHyperlink](../ihyperlink/). |
| virtual [ZoomImageType](../zoomimagetype/) [get_ImageType](../izoomobject/get_imagetype/)() | Obtiene el tipo de imagen de un objeto zoom. Solo lectura [ZoomImageType](../zoomimagetype/). Valor predeterminado: Preview |
...
| virtual [System::String](../../system/string/) [get_Name](../ishape/get_name/)() | Devuelve el nombre de una forma. Solo lectura [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGroupShape](../igroupshape/)\> [get_ParentGroup](../ishape/get_parentgroup/)() | Devuelve el objeto padre [GroupShape](../groupshape/) si la forma está agrupada. En caso contrario devuelve null. Solo lectura [IGroupShape](../igroupshape/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_RawFrame](../ishape/get_rawframe/)() | Devuelve las propiedades crudas del marco de la forma. Solo lectura [IShapeFrame](../ishapeframe/). |
| virtual **bool** [get_ReturnToParent](../izoomobject/get_returntoparent/)() | Obtiene el comportamiento de navegación en la presentación de diapositivas. Solo lectura **bool**. Valor predeterminado: false |
...
| virtual **bool** [get_ShowBackground](../izoomobject/get_showbackground/)() | Obtiene el valor que especifica si el Zoom usará el fondo de la diapositiva de destino. Solo lectura **bool**. Valor predeterminado: true |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](../isectionzoomframe/get_targetsection/)() | Obtiene el objeto de sección al que está vinculado el objeto Zoom [Section](../section/). Solo lectura [ISection](../isection/). |
...
| virtual [System::String](../../system/string/) [get_Title](./get_title/)() | Devuelve el título de texto del objeto Summary Zoom [Section](../section/). |
...
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Devuelve un identificador interno, de alcance de la presentación, destinado al uso por complementos u otro código. Dado que este valor puede ser reasignado por el usuario o programáticamente, no debe tratarse como una clave única persistente. Solo lectura **uint32_t**. Ver también [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](../izoomobject/get_zoomimage/)() | Obtiene la imagen para el objeto zoom. Solo lectura [IPPImage](../ippimage/). |
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | Devuelve la posición de una forma en el orden Z. Shapes[0] devuelve la forma que está al fondo del orden Z, y Shapes[Shapes.Count - 1] devuelve la forma que está al frente del orden Z. Solo lectura **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../ishape/getbaseplaceholder/)() | Devuelve una forma de marcador de posición básica (forma del diseño y/o diapositiva maestra de la que se hereda la forma actual). |
...
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | La propiedad especifica cómo se renderiza una forma en modo de visualización en blanco y negro. Escriba [Slides::BlackWhiteMode](../blackwhitemode/). |
| virtual void [set_Description](./set_description/)([System::String](../../system/string/)) | Devuelve la descripción de texto del objeto Summary Zoom [Section](../section/). |
...
| virtual void [set_IsDecorative](../ishape/set_isdecorative/)(**bool**) | Establece la opción 'Mark as decorative' de lectura/escritura **bool**. |
...
| virtual void [set_RawFrame](../ishape/set_rawframe/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\>) | Establece las propiedades del marco bruto de la forma. Escriba [IShapeFrame](../ishapeframe/). |
...
| virtual void [set_Rotation](../ishape/set_rotation/)(**float**) | Establece el número de grados que la forma especificada gira alrededor del eje z. Un valor positivo indica rotación en sentido horario; un valor negativo indica rotación en sentido antihorario. Escriba **float**. |
| virtual void [set_ShowBackground](../izoomobject/set_showbackground/)(**bool**) | Establece el valor que indica si el Zoom usará el fondo de la diapositiva de destino. Escriba **bool**. Valor predeterminado: true |
| virtual void [set_TargetSection](../isectionzoomframe/set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | Establece el objeto de sección al que está enlazado el objeto Zoom [Section](../section/). Escriba [ISection](../isection/). |
| virtual void [set_Title](./set_title/)([System::String](../../system/string/)) | Devuelve el título de texto del objeto Summary Zoom [Section](../section/). |
...
| virtual void [set_ZoomImage](../izoomobject/set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | Establece la imagen para el objeto zoom. Escriba [IPPImage](../ippimage/). |
