...
| [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormatEffectiveData](../icolumnformateffectivedata/)\> [GetEffective](./geteffective/)() override | Obtiene las propiedades de formato efectivas de la columna de tabla con herencia y estilos de tabla aplicados. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Establece el enésimo argumento de plantilla como puntero débil (en lugar de compartido). Permite cambiar los punteros en contenedores al modo débil. |
...
* Clase [IColumnFormat](../icolumnformat/)
