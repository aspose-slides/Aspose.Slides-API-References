...
Este ejemplo muestra cómo obtener el formato de relleno efectivo para diferentes partes lógicas de la tabla. Tenga en cuenta que el formato de celda siempre tiene mayor prioridad que el formato de fila, la fila - mayor que la columna, la columna - mayor que toda la tabla. Por lo tanto, finalmente se utilizan las propiedades de CellFormatEffectiveData para dibujar la tabla. El siguiente código es solo un ejemplo de la API. 
```cpp
...
* Clase [IColumnFormatEffectiveData](../../icolumnformateffectivedata/)
* Clase [ColumnFormat](../)
