...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\> [Add](./add/)(**double**, [TabAlignment](../tabalignment/)) | Agrega un [Tab](../tab/) a la colección. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) | Agrega un [Tab](../tab/) a la colección. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\> [idx_get](./idx_get/)(**int32_t**) | Obtiene el elemento en el índice especificado. Sólo lectura [ITab](../itab/). |
