...
---
## ICellCollection clase

Representa una colección de celdas.

```cpp
class ICellCollection : public Aspose::Slides::ISlideComponent,
                        public Aspose::Slides::IGenericCollection<System::SharedPtr<Aspose::Slides::ICcell>>
```
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Para propósitos internos únicamente. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve una celda por su posición. Solo lectura [ICell](../icell/). |
