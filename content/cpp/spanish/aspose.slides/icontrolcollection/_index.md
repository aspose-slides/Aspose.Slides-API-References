...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [AddControl](./addcontrol/)([ControlType](../controltype/), **float**, **float**, **float**, **float**) | Crea y agrega un nuevo control a la colección. |
...
| virtual void [Clear](./clear/)() | Elimina todos los controles de la colección. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve un control en la posición especificada. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>) | Elimina un control ActiveX de la colección. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Elimina un control ActiveX almacenado en la posición especificada de la colección. |
