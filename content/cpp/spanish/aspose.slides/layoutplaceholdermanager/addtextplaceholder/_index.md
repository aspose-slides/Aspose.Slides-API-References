...
description: Agrega una nueva forma de marcador de posición al diseño de diapositiva para contener contenido de texto.
type: docs
weight: 27
...
Agrega una nueva forma de marcador de posición al diseño de diapositiva para contener contenido de texto.
...
El siguiente ejemplo muestra cómo agregar la forma de marcador de posición de Texto al diseño de diapositiva. 
```cpp
