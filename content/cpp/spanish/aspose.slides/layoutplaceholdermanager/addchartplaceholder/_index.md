...
type: docs
weight: 66
url: /es/aspose.slides/layoutplaceholdermanager/addchartplaceholder/
---
## LayoutPlaceholderManager::AddChartPlaceholder(float, float, float, float) method


Agrega una nueva forma de marcador de posición a la diapositiva de diseño para contener un Chart.
...
Creado [IAutoShape](../../iautoshape/) con un marcador de posición de Chart.
## Observaciones



El siguiente ejemplo muestra cómo agregar la forma de marcador de posición de Chart a la diapositiva de diseño. 
```cpp
