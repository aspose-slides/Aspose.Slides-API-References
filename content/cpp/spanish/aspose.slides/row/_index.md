...
| **int32_t** [get_Count](../cellcollection/get_count/)() override | Devuelve el número de celdas en una colección. Sólo lectura **int32_t**. |
| **double** [get_Height](./get_height/)() override | Devuelve la altura de una fila. Sólo lectura **double**. |
| **bool** [get_IsSynchronized](../cellcollection/get_issynchronized/)() override | Devuelve un valor que indica si el acceso a la colección está sincronizado (seguro para subprocesos). Sólo lectura **bool**. |
| **double** [get_MinimalHeight](./get_minimalheight/)() override | Devuelve la altura mínima posible de una fila. Sólo lectura **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](../cellcollection/get_presentation/)() override | Devuelve la presentación principal de un [CellCollection](../cellcollection/). Sólo lectura [IPresentation](../ipresentation/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() override | Devuelve el objeto [RowFormat](../rowformat/) que contiene las propiedades de formato para esta fila. Sólo lectura [IRowFormat](../irowformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../cellcollection/get_slide/)() override | Devuelve la diapositiva principal de un [CellCollection](../cellcollection/). Sólo lectura [IBaseSlide](../ibaseslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../cellcollection/get_syncroot/)() override | Devuelve una raíz de sincronización. Sólo lectura [System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>\>\> [GetEnumerator](../cellcollection/getenumerator/)() override | Devuelve un enumerador que itera a través de la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../cellcollection/idx_get/)(**int32_t**) override | Devuelve una celda por su posición. Sólo lectura [Cell](../cell/). |
...
| void [set_MinimalHeight](./set_minimalheight/)(**double**) override | Establece la altura mínima posible de una fila. Escribe **double**. |
...
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | Establece las propiedades de formato de porción definidas a todas las porciones de celdas de fila. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | Establece las propiedades de formato de párrafo definidas a todos los párrafos de celdas de fila. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | Establece las propiedades de formato de marco de texto definidas a todos los marcos de texto de celdas de fila. |
