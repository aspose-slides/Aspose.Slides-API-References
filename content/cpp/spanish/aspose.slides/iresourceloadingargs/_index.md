...
| virtual [System::String](../../system/string/) [get_OriginalUri](./get_originaluri/)() | URI original del recurso tal como se especifica en la presentación importada. |
| virtual [System::String](../../system/string/) [get_Uri](./get_uri/)() | URI del recurso que se usa para descargar si [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) devuelve [ResourceLoadingAction::Default](../resourceloadingaction/). Inicialmente se establece en la URI original del recurso, pero puede redefinirse a cualquier valor. |
...
| virtual void [set_Uri](./set_uri/)([System::String](../../system/string/)) | URI del recurso que se usa para descargar si [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) devuelve [ResourceLoadingAction::Default](../resourceloadingaction/). Inicialmente se establece en la URI original del recurso, pero puede redefinirse a cualquier valor. |
| virtual void [SetData](./setdata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Establece los datos proporcionados por el usuario del recurso que se usa si [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) devuelve [ResourceLoadingAction::UserProvided](../resourceloadingaction/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el argumento de plantilla n-ésimo como puntero débil (en lugar de compartido). Permite cambiar los punteros en contenedores al modo débil. |
