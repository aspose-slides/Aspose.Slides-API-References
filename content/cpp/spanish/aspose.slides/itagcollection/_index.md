...
| Método | Descripción |
| --- | --- |
| virtual **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | Agrega una nueva etiqueta a la colección. |
...
| virtual void [Clear](./clear/)() | Elimina todas las etiquetas de la colección. |
| virtual **bool** [Contains](./contains/)([System::String](../../system/string/)) | Determina si la colección contiene un nombre específico. |
...
| virtual [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) | Devuelve la clave de una etiqueta en el índice especificado. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() | Devuelve los nombres de las etiquetas. |
...
| virtual [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) | Devuelve el valor de una etiqueta en el índice especificado. |
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) | Devuelve una pareja clave-valor de una etiqueta. |
| virtual void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) | Establece una pareja clave-valor de una etiqueta. |
| virtual **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) | Devuelve el índice basado en cero de la clave especificada en la colección. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Elimina la etiqueta con un nombre especificado de la colección. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Elimina la etiqueta en el índice especificado. |
