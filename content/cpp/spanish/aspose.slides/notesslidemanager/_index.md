...
description: Administrador de notas de diapositiva.
type: docs
weight: 4590
...
Administrador de notas de diapositiva.
...
| Método | Descripción |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() override | Devuelve la diapositiva de notas para la diapositiva actual, creando una si no existe. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() override | Devuelve la diapositiva de notas para la diapositiva actual. Devuelve null si la diapositiva no tiene notas. Solo lectura [INotesSlide](../inotesslide/). |
...
| void [RemoveNotesSlide](./removenotesslide/)() override | Elimina la diapositiva de notas de la diapositiva actual. |
...
El siguiente ejemplo muestra cómo agregar notas a una diapositiva [Presentation](../presentation/) específica de PowerPoint. 
```cpp
...
```
 Los siguientes ejemplos muestran cómo eliminar notas de la diapositiva específica de PowerPoint [Presentation](../presentation/). 
```cpp
// Instanciar un objeto Presentation que representa un archivo de presentación
auto presentation = System::MakeObject<Presentation>(dataDir + u"AccessSlides.pptx");
