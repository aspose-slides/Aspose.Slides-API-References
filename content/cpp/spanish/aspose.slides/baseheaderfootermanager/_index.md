...
description: Representa el administrador que mantiene el comportamiento de los marcadores de posición del pie de página, fecha y hora, y número de página para todos los tipos de diapositivas.
type: docs
weight: 131
...
Representa el administrador que mantiene el comportamiento de los marcadores de posición del pie de página, fecha y hora, y número de página para todos los tipos de diapositivas.
