...
| [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../shape/get_blackwhitemode/)() override | La propiedad especifica cómo se renderizará una forma en modo de pantalla en blanco y negro. Lea [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| **bool** [get_ReturnToParent](../zoomobject/get_returntoparent/)() override | Obtiene el comportamiento de navegación en presentación. Solo lectura **bool**. Valor predeterminado: false |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](./get_targetsection/)() override | Obtiene el objeto sección al que enlaza el objeto Zoom [Section](../section/). Lea [ISection](../isection/). |
...
| **float** [get_TransitionDuration](../zoomobject/get_transitionduration/)() override | Obtiene la duración de la transición entre Zoom y diapositiva. Solo lectura **float**. Valor predeterminado: 1.0f |
| **uint32_t** [get_UniqueId](../shape/get_uniqueid/)() override | Devuelve un identificador interno, de alcance de presentación, destinado al uso por complementos u otro código. Dado que este valor puede ser reasignado por el usuario o programáticamente, no debe ser tratado como una clave única persistente. Solo lectura **uint32_t**. Véase también [Shape::get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/). |
...
| void [set_BlackWhiteMode](../shape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) override | La propiedad especifica cómo se renderizará una forma en modo de pantalla en blanco y negro. Escriba [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| void [set_Name](../shape/set_name/)([System::String](../../system/string/)) override | Establece el nombre de una forma. No debe ser null. Use una cadena vacía si es necesario. Escriba [System::String](../../system/string/). |
...
| void [set_ReturnToParent](../zoomobject/set_returntoparent/)(**bool**) override | Establece el comportamiento de navegación en presentación. Escriba **bool**. Valor predeterminado: false |
...
| void [set_TargetSection](./set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Establece el objeto sección al que enlaza el objeto Zoom [Section](../section/). Escriba [ISection](../isection/). |
