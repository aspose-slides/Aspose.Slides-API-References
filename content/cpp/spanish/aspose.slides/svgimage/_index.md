...
| [System::String](../../system/string/) [get_BaseUri](./get_baseuri/)() override | Devuelve el URI base del Svg especificado. Se usa para resolver enlaces relativos. Solo lectura [System::String](../../system/string/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\> [get_ExternalResourceResolver](./get_externalresourceresolver/)() override | Devuelve la interfaz de devolución de llamada utilizada para resolver recursos externos durante la importación de documentos Svg. Solo lectura [Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/). |
| [System::String](../../system/string/) [get_SvgContent](./get_svgcontent/)() override | Devuelve el contenido SVG. Solo lectura [System::String](../../system/string/). |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_SvgData](./get_svgdata/)() override | Devuelve los datos SVG. Solo lectura **uint8_t**[]. |
...
|  [SvgImage](./svgimage/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Crea un nuevo objeto [SvgImage](./). |
|  [SvgImage](./svgimage/)([System::String](../../system/string/)) | Crea un nuevo objeto [SvgImage](./). |
|  [SvgImage](./svgimage/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Crea un nuevo objeto [SvgImage](./). |
|  [SvgImage](./svgimage/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) | Crea un nuevo objeto [SvgImage](./). |
|  [SvgImage](./svgimage/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) | Crea un nuevo objeto [SvgImage](./). |
|  [SvgImage](./svgimage/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) | Crea un nuevo objeto [SvgImage](./). |
...
| void [WriteAsEmf](./writeasemf/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Guarda la imagen SVG como un archivo EMF. |
