...
---
## SensitivityLabelCollection clase
...
| Método | Descripción |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [Add](./add/)([System::String](../../system/string/), [System::Guid](../../system/guid/), **bool**, [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) override | Añade la etiqueta de sensibilidad al final de la colección. |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>) override | Añade un [SensitivityLabel](../sensitivitylabel/) a la colección. |
| [iterator](./iterator/) [begin](./begin/)() | Obtiene el iterador que apunta al primer elemento (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtiene el iterador que apunta al primer elemento (si lo hay) de la instancia const-calificada de la colección. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtiene el iterador que apunta al primer elemento const-calificado (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtiene el iterador que apunta justo después del último elemento const-calificado (si lo hay) de la colección. |
| void [Clear](./clear/)() override | Elimina todos los elementos de la colección. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>\>, **int32_t**) | Copia todos los elementos de la colección al array especificado. |
| [iterator](./iterator/) [end](./end/)() | Obtiene el iterador que apunta justo después del último elemento (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtiene el iterador que apunta justo después del último elemento (si lo hay) de la instancia const-calificada de la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que itera a través de la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [idx_get](./idx_get/)(**int32_t**) override | Devuelve la etiqueta de sensibilidad por índice. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Elimina la etiqueta de sensibilidad en el índice especificado. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtiene el iterador que apunta al primer elemento (si lo hay) de la instancia const-calificada de la colección. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtiene el iterador que apunta justo después del último elemento (si lo hay) de la instancia const-calificada de la colección. |
