...
description: Representa al gestor que mantiene el comportamiento de los marcadores de posición de diapositivas de folleto maestro, incluido el marcador de encabezado.
type: docs
weight: 4421
url: /es/aspose.slides/masterhandoutslideheaderfootermanager/
---
## MasterHandoutSlideHeaderFooterManager clase
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Obtiene un valor que indica que existe un marcador de fecha y hora. Leer**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | Obtiene un valor que indica que existe un marcador de pie de página. Leer**bool**. |
| **bool** [get_IsHeaderVisible](../basehandoutnotesslideheaderfootermanager/get_isheadervisible/)() override | Obtiene un valor que indica que existe un marcador de encabezado. Leer**bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Obtiene un valor que indica que existe un marcador de número de página. Leer**bool**. |
...
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | Establece el texto del marcador de fecha y hora de la diapositiva. |
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | Cambia la visibilidad del marcador de fecha y hora de la diapositiva. |
...
| void [SetHeaderText](../basehandoutnotesslideheaderfootermanager/setheadertext/)([System::String](../../system/string/)) override | Establece el texto del marcador de encabezado de la diapositiva. |
| void [SetHeaderVisibility](../basehandoutnotesslideheaderfootermanager/setheadervisibility/)(**bool**) override | Cambia la visibilidad del marcador de encabezado de la diapositiva. |
...
* Clase [IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/)
