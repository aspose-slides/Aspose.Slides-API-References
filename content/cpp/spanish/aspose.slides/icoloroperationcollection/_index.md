...
---
## IColorOperationCollection clase
...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) | Agrega una nueva operación al final de la colección. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) | Agrega una nueva operación al final de la colección. |
...
| virtual void [Clear](./clear/)() | Elimina todas las operaciones de color. |
...
| virtual T [CloneT](../igenericcloneable/clonet/)() | Crea un nuevo objeto que es una copia de la instancia actual. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve la operación en el índice especificado. Lectura [IColorOperation](../icoloroperation/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) | Establece la operación en el índice especificado. Escritura [IColorOperation](../icoloroperation/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) | Inserta la nueva operación en una colección. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) | Inserta la nueva operación en una colección. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Elimina la operación de color de una colección. |
