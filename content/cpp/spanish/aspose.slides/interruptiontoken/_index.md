...
description: Esta clase representa el token que se utiliza para señalizar tareas de larga duración si se solicitó la interrupción.
type: docs
weight: 3056
...
Esta clase representa el token que se utiliza para señalizar tareas de larga duración si se solicitó la interrupción.
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Devuelve **bool**.true si se solicitó la interrupción. |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | Representa un token de interrupción vacío. |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | Lanza una excepción si se solicitó la interrupción. |
