...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | Devuelve el comentario realizado por este autor en el índice especificado. Solo lectura [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | Devuelve la colección de comentarios realizados por este autor. Solo lectura [ICommentCollection](../icommentcollection/). |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | Devuelve las iniciales del autor. Lectura [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Devuelve el nombre del autor. Lectura [System::String](../../system/string/). |
...
| void [Remove](./remove/)() override | Elimina al autor de la colección padre. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | Establece las iniciales del autor. Escritura [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Establece el nombre del autor. Escritura [System::String](../../system/string/). |
