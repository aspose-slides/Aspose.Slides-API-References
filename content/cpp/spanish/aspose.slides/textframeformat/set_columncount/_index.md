...
description: Establece el número de columnas en el área de texto. Este valor debe ser un número positivo. De lo contrario, el valor se establecerá a cero. El valor 0 significa valor indefinido. Escriba int32_t.
type: docs
weight: 261
url: /es/aspose.slides/textframeformat/set_columncount/
---
## TextFrameFormat::set_ColumnCount(int32_t) método


Establece el número de columnas en el área de texto. Este valor debe ser un número positivo. De lo contrario, el valor se establecerá a cero. El valor 0 significa valor indefinido. Escriba **int32_t**.
...
El siguiente código de ejemplo muestra cómo agregar una columna en el marco de texto dentro de un PowerPoint [Presentation](../../presentation/). 
```cpp
