...
description: Devuelve el número de columnas en el área de texto. Este valor debe ser un número positivo. De lo contrario, el valor se establecerá a cero. El valor 0 significa valor indefinido. Leer int32_t.
type: docs
weight: 248
url: /es/aspose.slides/textframeformat/get_columncount/
---
## TextFrameFormat::get_ColumnCount() método

Devuelve el número de columnas en el área de texto. Este valor debe ser un número positivo. De lo contrario, el valor se establecerá a cero. El valor 0 significa valor indefinido. Leer **int32_t**.
...
El siguiente código de ejemplo muestra cómo agregar una columna en un marco de texto dentro de un PowerPoint [Presentation](../../presentation/). 
```cpp
