...
---
## ISensitivityLabelCollection clase
...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [Add](./add/)([System::String](../../system/string/), [System::Guid](../../system/guid/), **bool**, [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | Agrega la etiqueta de sensibilidad al final de la colección. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>) | Agrega un [SensitivityLabel](../sensitivitylabel/) a la colección. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Obtiene un iterador que apunta al primer elemento (si lo hay) de la colección. Este iterador no se puede utilizar para cambiar un objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) devuelve una copia del objeto T. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la colección. Este iterador no se puede utilizar para cambiar un objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) devuelve una copia del objeto T. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Obtiene el número de todos los elementos de la colección. Solo lectura **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve la etiqueta de sensibilidad por índice. Solo lectura [ISensitivityLabel](../isensitivitylabel/). |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Elimina la etiqueta de sensibilidad en el índice especificado. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo de la instrucción C# lock(). Llámalo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
