...
description: Determina qué operaciones están desactivadas en el GroupShape padre.
type: docs
weight: 1210
...
Determina qué operaciones están deshabilitadas en el padre [GroupShape](../groupshape/).
...
| **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() override | Determina si la forma debe preservar la proporción al redimensionar. Lectura **bool**. |
...
| **bool** [get_UngroupingLocked](./get_ungroupinglocked/)() override | Determina si dividir esta forma de grupo está prohibido. Lectura **bool**. |
...
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | Determina si la forma debe preservar la proporción al redimensionar. Escritura **bool**. |
...
| void [set_UngroupingLocked](./set_ungroupinglocked/)(**bool**) override | Determina si dividir esta forma de grupo está prohibido. Escritura **bool**. |
...
* Clase [IGroupShapeLock](../igroupshapelock/)
