...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Tipo de bisel. Leer [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Altura del bisel. Leer **double**. |
| virtual **double** [get_Width](./get_width/)() | Ancho del bisel. Leer **double**. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | Tipo de bisel. Escribir [BevelPresetType](../bevelpresettype/). |
| virtual void [set_Height](./set_height/)(**double**) | Altura del bisel. Escribir **double**. |
| virtual void [set_Width](./set_width/)(**double**) | Ancho del bisel. Escribir **double**. |
