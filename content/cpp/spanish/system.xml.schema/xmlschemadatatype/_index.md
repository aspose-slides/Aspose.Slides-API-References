...
description: La clase XmlSchemaDatatype es una clase abstracta para mapear los tipos del lenguaje de definición de esquemas XML (XSD) a tipos en tiempo de ejecución.
type: docs
weight: 339
url: /es/system.xml.schema/xmlschemadatatype/
---
...
| Método | Descripción |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ChangeType](./changetype/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, const [TypeInfo](../../system/typeinfo/)\&) | Convierte el valor especificado, cuyo tipo es una de las representaciones válidas del tipo de esquema XML representado por [XmlSchemaDatatype](./), al tipo en tiempo de ejecución especificado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ChangeType](./changetype/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, const [TypeInfo](../../system/typeinfo/)\&, [SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>) | Convierte el valor especificado, cuyo tipo es una de las representaciones válidas del tipo de esquema XML representado por [XmlSchemaDatatype](./), al tipo en tiempo de ejecución especificado usando [IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/) si [XmlSchemaDatatype](./) representa el tipo **xs:QName** o un tipo derivado de él. |
...
| virtual [XmlTokenizedType](../../system.xml/xmltokenizedtype/) [get_TokenizedType](./get_tokenizedtype/)() | Cuando se sobrescribe en una clase derivada, obtiene el tipo para la **string** según lo especificado en la especificación XML 1.0 del Consorcio World Wide [Web](../../system.web/) (W3C). |
| virtual [XmlTypeCode](../xmltypecode/) [get_TypeCode](./get_typecode/)() | Devuelve el valor XmlTypeCode para el tipo simple. |
...
| virtual [XmlSchemaDatatypeVariety](../xmlschemadatatypevariety/) [get_Variety](./get_variety/)() | Devuelve el valor XmlSchemaDatatypeVariety para el tipo simple. |
...
| virtual **bool** [IsDerivedFrom](./isderivedfrom/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaDatatype](./)\>) | Este método siempre devuelve **false**. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ParseValue](./parsevalue/)([String](../../system/string/), [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>, [SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>) | Cuando se sobrescribe en una clase derivada, valida la **string** especificada contra un tipo simple integrado o definido por el usuario. |
