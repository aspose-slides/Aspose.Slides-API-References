...
description: Representa el elemento appinfo del World Wide Web Consortium (W3C).
type: docs
weight: 157
url: /es/system.xml.schema/xmlschemaappinfo/
---
## XmlSchemaAppInfo clase


Representa el elemento **appinfo** del Consorcio World Wide [Web](../../system.web/) (W3C).
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Devuelve una matriz de objetos [XmlNode](../../system.xml/xmlnode/) que representa los nodos hijos **appinfo**. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Devuelve la fuente de la información de la aplicación. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Establece una matriz de objetos [XmlNode](../../system.xml/xmlnode/) que representa los nodos hijos **appinfo**. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Establece la fuente de la información de la aplicación. |
