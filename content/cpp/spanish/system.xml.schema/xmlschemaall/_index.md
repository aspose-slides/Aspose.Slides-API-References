...
description: Representa el elemento all (compositor) del World Wide Web Consortium (W3C).
type: docs
weight: 92
url: /es/system.xml.schema/xmlschemaall/
---
## XmlSchemaAll clase


Representa el elemento **all** del consorcio World Wide [Web](../../system.web/) (W3C) (compositor).
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Devuelve la colección de elementos [XmlSchemaElement](../xmlschemaelement/) contenidos dentro del compositor **all**. |
...
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Devuelve el número como valor de cadena. El número mínimo de veces que la partícula puede aparecer. |
...
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Establece el número como valor de cadena. El número mínimo de veces que la partícula puede aparecer. |
...
|  [XmlSchemaAll](./xmlschemaall/)() | Inicializa una nueva instancia de la clase [XmlSchemaAll](./). |
...
Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree instancias de este tipo en la pila ni usando el operador new, ya que resultará en errores en tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento. 
