...
description: Clase base para todas las facetas que se utilizan cuando los tipos simples se derivan mediante restricción.
type: docs
weight: 404
url: /es/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet clase

Una clase base para todas las facetas que se utilizan cuando los tipos simples se derivan mediante restricción.
...
| virtual **bool** [get_IsFixed](./get_isfixed/)() | Devuelve información que indica que esta faceta está fija. |
...
| [String](../../system/string/) [get_Value](./get_value/)() | Devuelve el atributo **value** de la faceta. |
...
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | Establece información que indica que esta faceta está fija. |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Establece el atributo **value** de la faceta. |
