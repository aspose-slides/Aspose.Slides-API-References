...
description: Representa el elemento attributeGroup con el atributo ref del XML Schema según lo especificado por el . AttributesGroupRef es la referencia para un attributeGroup, la propiedad name contiene el grupo de atributos referenciado.
type: docs
weight: 196
url: /es/system.xml.schema/xmlschemaattributegroupref/
---
## XmlSchemaAttributeGroupRef clase

Representa el elemento **attributeGroup** con el atributo **ref** del XML [Schema](../) según lo especificado por el [World Wide Web Consortium (W3C)](https://go.microsoft.com/fwlink/?LinkId=49454). AttributesGroupRef es la referencia de un attributeGroup, la propiedad name contiene el grupo de atributos referenciado.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Devuelve el nombre del elemento **attributeGroup** referenciado. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo al método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite la generación de hash de objetos personalizados. |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Establece el nombre del elemento **attributeGroup** referenciado. |
