...
description: Devuelve información detallada sobre la excepción del esquema.
type: docs
weight: 1
url: /es/system.xml.schema/details_xmlschemaexception/
---
## Details_XmlSchemaException clase
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Devuelve el número de línea que indica dónde ocurrió el error. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Devuelve la posición en la línea que indica dónde ocurrió el error. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Devuelve la descripción de la condición de error de esta excepción. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](./get_sourceschemaobject/)() | El **[XmlSchemaObject](../xmlschemaobject/)** que produjo el XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Devuelve la ubicación del Identificador Uniforme de Recursos (URI) del esquema que provocó la excepción. |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Devuelve la cadena que contiene la traza de pila. |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | Devuelve la copia del objeto Exception que representa la excepción más interna. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Obtiene el tipo real del objeto. Analógico de la llamada C# [System.Object.GetType()](../../system/object/gettype/). |
