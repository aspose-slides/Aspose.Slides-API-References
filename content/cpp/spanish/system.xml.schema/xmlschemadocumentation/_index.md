...
description: Representa el elemento de documentación del esquema XML según lo especificado por el Consorcio World Wide Web (W3C). Esta clase especifica información que debe ser leída o usada por humanos dentro de una anotación.
type: docs
weight: 352
url: /es/system.xml.schema/xmlschemadocumentation/
---
## XmlSchemaDocumentation clase


Representa el elemento **documentación** de XML [Schema](../) tal como lo especifica el Consorcio World Wide [Web](../../system.web/) (W3C). Esta clase especifica información que debe ser leída o usada por humanos dentro de una **anotación**.
...
| [String](../../system/string/) [get_Language](./get_language/)() | Devuelve el atributo **xml:lang**. Esto sirve como indicador del idioma usado en el contenido. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Devuelve una matriz de objetos [XmlNode](../../system.xml/xmlnode/) que representa los nodos secundarios de documentación. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Devuelve la fuente del Identificador Uniforme de Recursos (URI) de la información. |
...
| void [set_Language](./set_language/)(const [String](../../system/string/)\&) | Establece el atributo **xml:lang**. Esto sirve como indicador del idioma usado en el contenido. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Establece una matriz de objetos [XmlNode](../../system.xml/xmlnode/) que representa los nodos secundarios de documentación. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Establece la fuente del Identificador Uniforme de Recursos (URI) de la información. |
