...
description: Representa el elemento maxExclusive del XML Schema según lo especificado por el World Wide Web Consortium (W3C). Esta clase puede usarse para especificar una restricción sobre el valor máximo de un elemento simpleType. El valor del elemento debe ser menor que el valor del elemento maxExclusive.
type: docs
weight: 573
url: /es/system.xml.schema/xmlschemamaxexclusivefacet/
---
## XmlSchemaMaxExclusiveFacet clase

Representa el elemento **maxExclusive** de XML [Schema](../) según lo especificado por el Consorcio World Wide [Web](../../system.web/) (W3C). Esta clase puede usarse para especificar una restricción en el valor máximo de un elemento **simpleType**. El valor del elemento debe ser menor que el valor del elemento **maxExclusive**.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Devuelve información que indica que esta faceta es fija. |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Devuelve la ubicación origen del archivo que cargó el esquema. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Establece información que indica que esta faceta es fija. |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Establece la ubicación origen del archivo que cargó el esquema. |
...
|  [XmlSchemaMaxExclusiveFacet](./xmlschemamaxexclusivefacet/)() | Inicializa una nueva instancia de la clase [XmlSchemaMaxExclusiveFacet](./). |
...
Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree instancias de este tipo en la pila ni usando el operador new, ya que producirá errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento. 
