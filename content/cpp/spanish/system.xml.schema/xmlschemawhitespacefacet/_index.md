...
description: Representa la faceta whiteSpace del World Wide Web Consortium (W3C).
type: docs
weight: 950
url: /es/system.xml.schema/xmlschemawhitespacefacet/
---
## XmlSchemaWhiteSpaceFacet clase

Representa el consorcio World Wide [Web](../../system.web/) (W3C) **whiteSpace** facet.
...
|  [XmlSchemaWhiteSpaceFacet](./xmlschemawhitespacefacet/)() | Inicializa una nueva instancia de la clase [XmlSchemaWhiteSpaceFacet](./). |
...
Los objetos de esta clase solo deben asignarse mediante la función [System::MakeObject()](../../system/makeobject/). Nunca cree instancias de este tipo en la pila ni usando el operador new, ya que provocará errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento. 
