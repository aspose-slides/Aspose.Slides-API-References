...
description: Proporciona opciones de compilación de esquemas para la clase XmlSchemaSet. Esta clase no puede heredarse.
type: docs
weight: 248
url: /es/system.xml.schema/xmlschemacompilationsettings/
---
## XmlSchemaCompilationSettings clase
...
| **bool** [get_EnableUpaCheck](./get_enableupacheck/)() | Devuelve un valor que indica si [XmlSchemaSet](../xmlschemaset/) debe comprobar violaciones de Unique Particle Attribution (UPA). |
...
| void [set_EnableUpaCheck](./set_enableupacheck/)(**bool**) | Establece un valor que indica si [XmlSchemaSet](../xmlschemaset/) debe comprobar violaciones de Unique Particle Attribution (UPA). |
