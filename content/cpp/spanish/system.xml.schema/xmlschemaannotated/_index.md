...
description: La clase base para cualquier elemento que pueda contener elementos de anotación.
type: docs
weight: 105
url: /es/system.xml.schema/xmlschemaannotated/
---
## XmlSchemaAnnotated clase


La clase base para cualquier elemento que pueda contener elementos de annotation.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\> [get_Annotation](./get_annotation/)() | Devuelve la propiedad **annotation**. |
| [String](../../system/string/) [get_Id](./get_id/)() | Devuelve el identificador de cadena. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](./get_unhandledattributes/)() | Devuelve los atributos calificados que no pertenecen al espacio de nombres de destino del esquema actual. |
...
| void [set_Annotation](./set_annotation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\>\&) | Establece la propiedad **annotation**. |
| void [set_Id](./set_id/)(const [String](../../system/string/)\&) | Establece el identificador de cadena. |
...
| void [set_UnhandledAttributes](./set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Establece los atributos calificados que no pertenecen al espacio de nombres de destino del esquema actual. |
