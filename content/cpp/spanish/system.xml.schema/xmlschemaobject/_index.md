...
description: Representa la clase raíz para la jerarquía del modelo de objetos del esquema Xml y sirve como clase base para clases como la clase XmlSchema.
type: docs
weight: 677
url: /es/system.xml.schema/xmlschemaobject/
---
## Clase XmlSchemaObject
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Devuelve el número de línea en el archivo al que se refiere el elemento **schema**. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Devuelve la posición de línea en el archivo al que se refiere el elemento **schema**. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](./get_namespaces/)() | Devuelve el XmlSerializerNamespaces a usar con este objeto de esquema. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\> [get_Parent](./get_parent/)() | Devuelve el padre de este [XmlSchemaObject](./). |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Devuelve la ubicación de origen del archivo que cargó el esquema. |
...
| void [set_LineNumber](./set_linenumber/)(**int32_t**) | Establece el número de línea en el archivo al que se refiere el elemento **schema**. |
| void [set_LinePosition](./set_lineposition/)(**int32_t**) | Establece la posición de línea en el archivo al que se refiere el elemento **schema**. |
| void [set_Namespaces](./set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Establece el XmlSerializerNamespaces a usar con este objeto de esquema. |
| void [set_Parent](./set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\>\&) | Establece el padre de este [XmlSchemaObject](./). |
| void [set_SourceUri](./set_sourceuri/)(const [String](../../system/string/)\&) | Establece la ubicación de origen del archivo que cargó el esquema. |
