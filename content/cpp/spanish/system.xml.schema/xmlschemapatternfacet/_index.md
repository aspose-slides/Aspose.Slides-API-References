...
description: Representa el elemento pattern del XML Schema según lo especificado por el Consorcio World Wide Web (W3C). Esta clase puede usarse para especificar una restricción sobre el valor introducido para un elemento simpleType.
type: docs
weight: 742
url: /es/system.xml.schema/xmlschemapatternfacet/
---
## XmlSchemaPatternFacet clase


Representa el elemento **pattern** de XML [Schema](../) según lo especificado por el Consorcio World Wide [Web](../../system.web/) (W3C). Esta clase puede usarse para especificar una restricción sobre el valor introducido para un elemento **simpleType**.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula una comparación de punto flotante al estilo de C# donde dos NaN se consideran iguales aunque según IEC 60559:1989 NaN no es igual a ningún valor, incluido NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula una comparación de punto flotante al estilo de C# donde dos NaN se consideran iguales aunque según IEC 60559:1989 NaN no es igual a ningún valor, incluido NaN. |
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Devuelve información que indica que esta faceta está fijada. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Establece información que indica que esta faceta está fijada. |
...
|  [XmlSchemaPatternFacet](./xmlschemapatternfacet/)() | Inicializa una nueva instancia de la clase [XmlSchemaPatternFacet](./). |
...
* Clase [XmlSchemaFacet](../xmlschemafacet/)
