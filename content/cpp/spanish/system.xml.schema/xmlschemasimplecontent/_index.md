...
description: Representa el elemento simpleContent de XML Schema según lo especificado por el Consorcio World Wide Web (W3C). Esta clase es para tipos simples y complejos con modelo de contenido simple.
type: docs
weight: 794
url: /es/system.xml.schema/xmlschemasimplecontent/
---
## XmlSchemaSimpleContent clase


Representa el elemento **simpleContent** de XML [Schema](../) tal como lo especifica el Consorcio World Wide [Web](../../system.web/) (W3C). Esta clase es para tipos simples y complejos con modelo de contenido simple.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | Devuelve uno de los [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) o [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | Devuelve uno de los [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) o [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
...
* Clase [XmlSchemaContentModel](../xmlschemacontentmodel/)
