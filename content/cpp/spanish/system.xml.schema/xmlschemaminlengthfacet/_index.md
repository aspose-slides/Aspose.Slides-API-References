...
description: Representa el elemento minLength del XML Schema según lo especificado por el World Wide Web Consortium (W3C). Esta clase puede usarse para especificar una restricción sobre la longitud mínima del valor de datos de un elemento simpleType. La longitud debe ser mayor que el valor del elemento minLength.
type: docs
weight: 638
url: /es/system.xml.schema/xmlschemaminlengthfacet/
---
## XmlSchemaMinLengthFacet clase

Representa el elemento **minLength** de XML [Schema](../) según lo especificado por el Consorcio World Wide [Web](../../system.web/) (W3C). Esta clase puede usarse para especificar una restricción sobre la longitud mínima del valor de datos de un elemento **simpleType**. La longitud debe ser mayor que el valor del elemento **minLength**.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Devuelve información que indica que este facet es fijo. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Devuelve el atributo **value** del facet. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analoga al método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite el hash de objetos personalizados. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtiene el tipo real del objeto. Analoga a la llamada C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Comprueba si el objeto representa una instancia del tipo descrito por targetType. Analoga al operador C# 'is'. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analoga al método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonar tipos personalizados. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Establece información que indica que este facet es fijo. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Establece el atributo **value** del facet. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analoga al método C# [Object.ToString()](../../system/object/tostring/). Permite convertir objetos personalizados a cadena. |
...
|  [XmlSchemaMinLengthFacet](./xmlschemaminlengthfacet/)() | Inicializa una nueva instancia de la clase [XmlSchemaMinLengthFacet](./). |
