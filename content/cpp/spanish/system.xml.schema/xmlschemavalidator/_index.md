...
description: Representa un motor de validación de esquemas de Lenguaje de Definición de Esquema XML (XSD). La clase XmlSchemaValidator no puede heredarse.
type: docs
weight: 937
url: /es/system.xml.schema/xmlschemavalidator/
---
