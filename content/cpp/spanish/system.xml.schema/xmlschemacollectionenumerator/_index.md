...
description: Admite una iteración simple sobre una colección. Esta clase no puede heredarse.
type: docs
weight: 235
url: /es/system.xml.schema/xmlschemacollectionenumerator/
---
## XmlSchemaCollectionEnumerator clase


Apoya una iteración simple sobre una colección. Esta clase no puede heredarse.
...
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchema](../xmlschema/)\>\> * [CloneIterator](./cloneiterator/)() const override | Clona el iterador actual. |
...
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\& [get_Current](./get_current/)() const override | Devuelve el [XmlSchema](../xmlschema/) actual en la colección. |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Hace la primera llamada [MoveNext()](../../system.collections.generic/ienumerator/movenext/) y prepara el objeto enumerador para ser usado por VirtualizedIterator. |
...
| **bool** [MoveNext](./movenext/)() override | Avanza el enumerador al siguiente esquema en la colección. |
