...
description: Representa el elemento anyAttribute del Consorcio World Wide Web (W3C).
type: docs
weight: 144
url: /es/system.xml.schema/xmlschemaanyattribute/
---
## Clase XmlSchemaAnyAttribute

Representa el elemento **anyAttribute** del Consorcio Mundial [Web](../../system.web/) (W3C).
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Devuelve el string id. |
...
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Devuelve los espacios de nombres que contienen los atributos que pueden usarse. |
...
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | Devuelve información sobre cómo una aplicación o procesador XML debe manejar la validación de documentos XML para los atributos especificados por el elemento **anyAttribute**. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Establece el string id. |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Establece los espacios de nombres que contienen los atributos que pueden usarse. |
...
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | Establece información sobre cómo una aplicación o procesador XML debe manejar la validación de documentos XML para los atributos especificados por el elemento **anyAttribute**. |
