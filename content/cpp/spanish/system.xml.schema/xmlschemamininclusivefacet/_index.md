...
description: Representa el elemento minInclusive del XML Schema según lo especificado por el Consorcio World Wide Web (W3C). Esta clase puede usarse para especificar una restricción sobre el valor mínimo de un elemento simpleType. El valor del elemento debe ser mayor o igual que el valor del elemento minInclusive.
type: docs
weight: 625
url: /es/system.xml.schema/xmlschemamininclusivefacet/
---
## Clase XmlSchemaMinInclusiveFacet


Representa el elemento **minInclusive** de XML [Schema](../) según lo especificado por el Consorcio World Wide [Web](../../system.web/) (W3C). Esta clase puede usarse para especificar una restricción sobre el valor mínimo de un elemento simpleType. El valor del elemento debe ser mayor o igual que el valor del elemento **minInclusive**.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Devuelve información que indica que este facet está fijo. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Comprueba si el objeto representa una instancia del tipo descrito por targetType. Analogía del operador 'is' de C#. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Establece información que indica que este facet está fijo. |
...
|  [XmlSchemaMinInclusiveFacet](./xmlschemamininclusivefacet/)() | Inicializa una nueva instancia de la clase [XmlSchemaMinInclusiveFacet](./). |
...
Los objetos de esta clase solo deben asignarse mediante la función [System::MakeObject()](../../system/makeobject/). Nunca cree instancias de este tipo en la pila ni usando el operador new, ya que producirá errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento. 
