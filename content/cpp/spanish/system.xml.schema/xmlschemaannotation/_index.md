...
description: Representa el elemento de anotación del World Wide Web Consortium (W3C).
type: docs
weight: 118
url: /es/system.xml.schema/xmlschemaannotation/
---
## XmlSchemaAnnotation clase

Representa el elemento **annotation** del consorcio World Wide [Web](../../system.web/) (W3C).
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() | Devuelve la colección **Items** que se usa para almacenar los elementos hijo **appinfo** y **documentation**. |
