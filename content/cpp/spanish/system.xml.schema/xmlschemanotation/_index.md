...
description: Representa el elemento notation del XML Schema según lo especificado por el Consorcio World Wide Web (W3C). Una declaración de Schemanotation de XML es una reconstrucción de las declaraciones NOTATION de XML 1.0. El propósito de las notaciones es describir el formato de los datos no XML dentro de un documento XML.
type: docs
weight: 651
url: /es/system.xml.schema/xmlschemanotation/
---
## XmlSchemaNotation clase

Representa el elemento **notation** de XML [Schema](../) según lo especificado por el Consorcio World Wide [Web](../../system.web/) (W3C). Una declaración de **notation** XML [Schema](../) es una reconstrucción de las declaraciones NOTATION de **XML** 1.0. El propósito de las notaciones es describir el formato de datos no XML dentro de un documento XML.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Devuelve el nombre de la notación. |
...
| [String](../../system/string/) [get_Public](./get_public/)() | Devuelve el identificador **public**. |
...
| [String](../../system/string/) [get_System](./get_system/)() | Devuelve el identificador **system**. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Establece el nombre de la notación. |
...
| void [set_Public](./set_public/)(const [String](../../system/string/)\&) | Establece el identificador **public**. |
...
| void [set_System](./set_system/)(const [String](../../system/string/)\&) | Establece el identificador **system**. |
...
Los objetos de esta clase deben asignarse sólo mediante la función [System::MakeObject()](../../system/makeobject/). Nunca cree instancias de este tipo en la pila ni usando el operador new, ya que provocará errores en tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento. 
