...
description: Infiere un esquema XML Schema Definition Language (XSD) a partir de un documento XML. La clase XmlSchemaInference no puede heredarse.
type: docs
weight: 508
url: /es/system.xml.schema/xmlschemainference/
---
## XmlSchemaInference clase


Infiere un esquema XML [Schema](../) Definition Language (XSD) a partir de un documento XML. La clase [XmlSchemaInference](./) no puede heredarse.
...
| [XmlSchemaInference::InferenceOption](./inferenceoption/) [get_Occurrence](./get_occurrence/)() | Devuelve el valor [XmlSchemaInference::InferenceOption](./inferenceoption/) que afecta a las declaraciones de ocurrencia del esquema inferidas del documento XML. |
| [XmlSchemaInference::InferenceOption](./inferenceoption/) [get_TypeInference](./get_typeinference/)() | Devuelve el valor [XmlSchemaInference::InferenceOption](./inferenceoption/) que afecta a los tipos inferidos del documento XML. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\> [InferSchema](./inferschema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Infiere un esquema XML [Schema](../) Definition Language (XSD) a partir del documento XML contenido en el objeto [XmlReader](../../system.xml/xmlreader/) especificado. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\> [InferSchema](./inferschema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\>) | Infiere un esquema XML [Schema](../) Definition Language (XSD) a partir del documento XML contenido en el objeto [XmlReader](../../system.xml/xmlreader/) especificado, y refina el esquema inferido usando un esquema existente en el objeto [XmlSchemaSet](../xmlschemaset/) especificado con el mismo espacio de nombres de destino. |
...
| void [set_Occurrence](./set_occurrence/)([XmlSchemaInference::InferenceOption](./inferenceoption/)) | Establece el valor [XmlSchemaInference::InferenceOption](./inferenceoption/) que afecta a las declaraciones de ocurrencia del esquema inferidas del documento XML. |
| void [set_TypeInference](./set_typeinference/)([XmlSchemaInference::InferenceOption](./inferenceoption/)) | Establece el valor [XmlSchemaInference::InferenceOption](./inferenceoption/) que afecta a los tipos inferidos del documento XML. |
