...
description: Representa el elemento choice (compositor) del XML Schema según lo especificado por el World Wide Web Consortium (W3C). El choice permite que solo uno de sus hijos aparezca en una instancia.
type: docs
weight: 209
url: /es/system.xml.schema/xmlschemachoice/
---
## XmlSchemaChoice clase


Representa el elemento **choice** (compositor) del XML [Schema](../) según lo especificado por el Consorcio World Wide [Web](../../system.web/) (W3C). El **choice** permite que solo uno de sus hijos aparezca en una instancia.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Devuelve la colección de los elementos contenidos en el compositor (**choice**): [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](./), [XmlSchemaSequence](../xmlschemasequence/) o [XmlSchemaAny](../xmlschemaany/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el nth argumento de plantilla como un puntero débil (en lugar de compartido). Permite cambiar los punteros en contenedores al modo débil. |
...
* Clase [XmlSchemaGroupBase](../xmlschemagroupbase/)
