...
description: Representa el elemento selector del Consorcio World Wide Web (W3C).
type: docs
weight: 963
url: /es/system.xml.schema/xmlschemaxpath/
---
## XmlSchemaXPath clase


Representa el elemento **selector** del Consorcio World Wide [Web](../../system.web/) (W3C).
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Devuelve la ubicación fuente del archivo que cargó el esquema. |
...
| [String](../../system/string/) [get_XPath](./get_xpath/)() | Devuelve el atributo para la expresión [XPath](../../system.xml.xpath/). |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Establece la ubicación fuente del archivo que cargó el esquema. |
...
| void [set_XPath](./set_xpath/)(const [String](../../system/string/)\&) | Establece el atributo para la expresión [XPath](../../system.xml.xpath/). |
