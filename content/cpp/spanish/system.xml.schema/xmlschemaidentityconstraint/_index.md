...
description: "Clase para las restricciones de identidad: elementos key, keyref y unique."
type: docs
weight: 469
url: /es/system.xml.schema/xmlschemaidentityconstraint/
---
## XmlSchemaIdentityConstraint clase
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | Devuelve la colección de campos que se aplican como hijos para el selector de expresión del Lenguaje de Ruta XML ([XPath](../../system.xml.xpath/)). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Devuelve el nombre de la restricción de identidad. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Devuelve el nombre calificado de la restricción de identidad, que contiene la interpretación post-compilación del valor **QualifiedName**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | Devuelve el elemento **selector** de expresión [XPath](../../system.xml.xpath/). |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo de la instrucción C# lock(). Llámbese directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Establece el nombre de la restricción de identidad. |
...
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Establece el elemento **selector** de expresión [XPath](../../system.xml.xpath/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo de la instrucción C# lock(). Llámbese directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
