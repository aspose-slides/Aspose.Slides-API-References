...
description: Representa la faceta de longitud del esquema XML según lo especificado por el Consorcio World Wide Web (W3C). Esta clase puede usarse para especificar una restricción en la longitud de un elemento simpleType del tipo de datos.
type: docs
weight: 560
url: /es/system.xml.schema/xmlschemalengthfacet/
---
## XmlSchemaLengthFacet clase


Representa la faceta **length** de XML [Schema](../) según lo especificado por el Consorcio World Wide [Web](../../system.web/) (W3C). Esta clase puede usarse para especificar una restricción en la longitud de un elemento **simpleType** del tipo de datos.
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrementa el contador de referencias compartidas. No debe llamarse directamente; en su lugar, use smart pointers o ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Disminuye y devuelve el contador de referencias compartidas. No debe llamarse directamente; en su lugar, use smart pointers o ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa el contador de referencias débiles. No debe llamarse directamente; en su lugar, use smart pointers o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Disminuye el contador de referencias débiles. No debe llamarse directamente; en su lugar, use smart pointers o ThisProtector. |
|  [XmlSchemaFacet](../xmlschemafacet/xmlschemafacet/)() | Inicializa una nueva instancia de la clase [XmlSchemaFacet](../xmlschemafacet/). |
|  [XmlSchemaLengthFacet](./xmlschemalengthfacet/)() | Inicializa una nueva instancia de la clase [XmlSchemaLengthFacet](./). |
...
Los objetos de esta clase sólo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree instancias de este tipo en la pila ni usando el operador new, ya que produciría errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento. 
