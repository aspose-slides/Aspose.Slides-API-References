...
description: Una clase base para eso es la clase base para todos los tipos de partícula (p. ej. XmlSchemaAny).
type: docs
weight: 729
url: /es/system.xml.schema/xmlschemaparticle/
---
## XmlSchemaParticle clase

Una clase base para eso es la clase base para todos los tipos de partícula (p. ej. [XmlSchemaAny](../xmlschemaany/)).
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](./get_maxoccurs/)() | Devuelve el número máximo de veces que la partícula puede aparecer. |
| [String](../../system/string/) [get_MaxOccursString](./get_maxoccursstring/)() | Devuelve el número como valor de cadena. Número máximo de veces que la partícula puede aparecer. |
| [Decimal](../../system/decimal/) [get_MinOccurs](./get_minoccurs/)() | Devuelve el número mínimo de veces que la partícula puede aparecer. |
| [String](../../system/string/) [get_MinOccursString](./get_minoccursstring/)() | Devuelve el número como valor de cadena. El número mínimo de veces que la partícula puede aparecer. |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo de la sentencia C# lock(). Llámalo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Análogo al método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonar tipos personalizados. |
|  [Object](../../system/object/object/)() | Crea el objeto. Inicializa todas las estructuras de datos internas. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructor de copia. No copia nada, en realidad solo inicializa un nuevo objeto y permite copiar construyendo subclases. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de asignación. No copia nada, en realidad solo inicializa un nuevo objeto y permite copiar construyendo subclases. |
...
| void [set_MaxOccurs](./set_maxoccurs/)([Decimal](../../system/decimal/)) | Establece el número máximo de veces que la partícula puede aparecer. |
| void [set_MaxOccursString](./set_maxoccursstring/)(const [String](../../system/string/)\&) | Establece el número como valor de cadena. Número máximo de veces que la partícula puede aparecer. |
| void [set_MinOccurs](./set_minoccurs/)([Decimal](../../system/decimal/)) | Establece el número mínimo de veces que la partícula puede aparecer. |
| void [set_MinOccursString](./set_minoccursstring/)(const [String](../../system/string/)\&) | Establece el número como valor de cadena. El número mínimo de veces que la partícula puede aparecer. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo de la sentencia C# lock(). Llámalo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
|  [XmlSchemaParticle](./xmlschemaparticle/)() | Inicializa una nueva instancia de la clase [XmlSchemaParticle](./). |
