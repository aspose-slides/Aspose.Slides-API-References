...
description: Esta clase representa el elemento keyref de XMLSchema según lo especificado por el Consorcio World Wide Web (W3C).
type: docs
weight: 547
url: /es/system.xml.schema/xmlschemakeyref/
---
## XmlSchemaKeyref clase
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](../xmlschemaidentityconstraint/get_fields/)() | Devuelve la colección de campos que se aplican como hijos para el selector de expresión del Lenguaje de Ruta XML ([XPath](../../system.xml.xpath/)). |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Devuelve la cadena id. |
...
| [String](../../system/string/) [get_Name](../xmlschemaidentityconstraint/get_name/)() | Devuelve el nombre de la restricción de identidad. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Devuelve el XmlSerializerNamespaces que se usará con este objeto de esquema. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](../xmlschemaidentityconstraint/get_qualifiedname/)() | Devuelve el nombre calificado de la restricción de identidad, que contiene la interpretación post-compilación del valor **QualifiedName**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_Refer](./get_refer/)() | Devuelve el nombre de la clave a la que esta restricción hace referencia en otro tipo simple o complejo. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](../xmlschemaidentityconstraint/get_selector/)() | Devuelve el elemento **selector** de expresión [XPath](../../system.xml.xpath/). |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Establece la cadena id. |
...
| void [set_Name](../xmlschemaidentityconstraint/set_name/)(const [String](../../system/string/)\&) | Establece el nombre de la restricción de identidad. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Establece el XmlSerializerNamespaces que se usará con este objeto de esquema. |
...
| void [set_Refer](./set_refer/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Establece el nombre de la clave a la que esta restricción hace referencia en otro tipo simple o complejo. |
| void [set_Selector](../xmlschemaidentityconstraint/set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Establece el elemento **selector** de expresión [XPath](../../system.xml.xpath/). |
...
|  [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/xmlschemaidentityconstraint/)() | Inicializa una nueva instancia de la clase [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/). |
...
Los objetos de esta clase sólo deben ser asignados usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree instancias de este tipo en la pila o usando el operador new, ya que provocará errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento. 

## Ver también

* Clase [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/)
