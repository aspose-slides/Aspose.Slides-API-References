...
description: Una colección de XmlSchemaObjects.
type: docs
weight: 690
url: /es/system.xml.schema/xmlschemaobjectcollection/
---
## XmlSchemaObjectCollection clase
...
| Método | Descripción |
| --- | --- |
| **int32_t** [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Agrega un [XmlSchemaObject](../xmlschemaobject/) al [XmlSchemaObjectCollection](./). |
...
| void [Clear](../../system.collections/collectionbase/clear/)() | Elimina todos los objetos de la instancia de la colección. Este método no puede sobrescribirse. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Indica si el [XmlSchemaObject](../xmlschemaobject/) especificado está en el [XmlSchemaObjectCollection](./). |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\&, **int32_t**) | Copia todos los XmlSchemaObjects de la colección en la matriz dada, comenzando en el índice especificado. |
...
| **int32_t** [get_Capacity](../../system.collections/collectionbase/get_capacity/)() | Devuelve el número de elementos que la colección puede contener. |
| **int32_t** [get_Count](../../system.collections/collectionbase/get_count/)() | Devuelve el número de elementos contenidos en la instancia de la colección. Este método no puede sobrescribirse. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador para iterar a través de los XmlSchemaObjects contenidos en el [XmlSchemaObjectCollection](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve el [XmlSchemaObject](../xmlschemaobject/) en el índice especificado. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>) | Establece el [XmlSchemaObject](../xmlschemaobject/) en el índice especificado. |
| **int32_t** [IndexOf](./indexof/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Devuelve el índice de la colección correspondiente al [XmlSchemaObject](../xmlschemaobject/) especificado. |
| void [Insert](./insert/)(**int32_t**, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Inserta un [XmlSchemaObject](../xmlschemaobject/) en el [XmlSchemaObjectCollection](./). |
...
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Elimina un [XmlSchemaObject](../xmlschemaobject/) del [XmlSchemaObjectCollection](./). |
| void [RemoveAt](../../system.collections/collectionbase/removeat/)(**int32_t**) | Elimina el elemento en el índice especificado de la instancia de la colección. Este método no se puede sobrescribir. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| void [set_Capacity](../../system.collections/collectionbase/set_capacity/)(**int32_t**) | Establece el número de elementos que la colección puede contener. |
...
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Inicializa una nueva instancia de la clase [XmlSchemaObjectCollection](./) que recibe un [XmlSchemaObject](../xmlschemaobject/). |
...
Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree instancias de este tipo en la pila ni use el operador new, ya que provocará errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento. 

## Ver también

* Clase [CollectionBase](../../system.collections/collectionbase/)
