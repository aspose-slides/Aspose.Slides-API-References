...
description: Representa el elemento complexContent del esquema XML según lo especificado por el Consorcio World Wide Web (W3C). Esta clase representa el modelo de contenido complejo para tipos complejos. Contiene extensiones o restricciones sobre un tipo complejo que tiene solo elementos o contenido mixto.
type: docs
weight: 261
url: /es/system.xml.schema/xmlschemacomplexcontent/
---
## XmlSchemaComplexContent clase


Representa el elemento **complexContent** de XML [Schema](../) según lo especificado por el Consorcio World Wide [Web](../../system.web/) (W3C). Esta clase representa el modelo de contenido complejo para tipos complejos. Contiene extensiones o restricciones sobre un tipo complejo que tiene solo elementos o contenido mixto.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | Devuelve el contenido. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Devuelve el id de cadena. |
| **bool** [get_IsMixed](./get_ismixed/)() | Devuelve información que determina si el tipo tiene un modelo de contenido mixto. |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | Establece el contenido. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Establece el id de cadena. |
| void [set_IsMixed](./set_ismixed/)(**bool**) | Establece la información que determina si el tipo tiene un modelo de contenido mixto. |
