...
description: Contiene una caché de esquemas del lenguaje de definición XML (XSD) y XML-Data Reduced (XDR).
type: docs
weight: 222
url: /es/system.xml.schema/xmlschemacollection/
---
...
Obsoleto
:   La clase [XmlSchemaCollection](./) está obsoleta. Use [XmlSchemaSet](../xmlschemaset/) en su lugar.
