...
description: Representa el elemento list de XML Schema según lo especificado por el Consorcio World Wide Web (W3C). Esta clase puede usarse para definir un elemento simpleType como una lista de valores de un tipo de datos especificado.
type: docs
weight: 859
url: /es/system.xml.schema/xmlschemasimpletypelist/
---
## XmlSchemaSimpleTypeList clase

Representa el elemento **list** de XML [Schema](../) según lo especificado por el Consorcio World Wide [Web](../../system.web/) (W3C). Esta clase puede usarse para definir un elemento **simpleType** como una lista de valores de un tipo de datos especificado.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseItemType](./get_baseitemtype/)() | Devuelve el [XmlSchemaSimpleType](../xmlschemasimpletype/) que representa el tipo del elemento **simpleType** basado en los valores [XmlSchemaSimpleTypeList::get_ItemType](./get_itemtype/) y [XmlSchemaSimpleTypeList::get_ItemTypeName](./get_itemtypename/) del tipo simple. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Devuelve el id de cadena. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_ItemType](./get_itemtype/)() | Devuelve el elemento **simpleType** que se deriva del tipo especificado por el valor base. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_ItemTypeName](./get_itemtypename/)() | Devuelve el nombre de un tipo de datos incorporado o del elemento **simpleType** definido en este esquema (o en otro esquema indicado por el espacio de nombres especificado). |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Devuelve el XmlSerializerNamespaces que se debe usar con este objeto de esquema. |
...
| void [set_BaseItemType](./set_baseitemtype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Establece el [XmlSchemaSimpleType](../xmlschemasimpletype/) que representa el tipo del elemento **simpleType** basado en los valores [XmlSchemaSimpleTypeList::get_ItemType](./get_itemtype/) y [XmlSchemaSimpleTypeList::get_ItemTypeName](./get_itemtypename/) del tipo simple. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Establece el id de cadena. |
| void [set_ItemType](./set_itemtype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Establece el elemento **simpleType** que se deriva del tipo especificado por el valor base. |
| void [set_ItemTypeName](./set_itemtypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Establece el nombre de un tipo de datos incorporado o del elemento **simpleType** definido en este esquema (o en otro esquema indicado por el espacio de nombres especificado). |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Establece el XmlSerializerNamespaces que se debe usar con este objeto de esquema. |
...
* Clase [XmlSchemaSimpleTypeContent](../xmlschemasimpletypecontent/)
