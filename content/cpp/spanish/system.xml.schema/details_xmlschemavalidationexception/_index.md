...
description: Representa la excepción lanzada cuando se encuentran errores y advertencias de validación de esquemas XML Schema Definition Language (XSD) en un documento XML que se está validando.
type: docs
weight: 27
url: /es/system.xml.schema/details_xmlschemavalidationexception/
---
## Details_XmlSchemaValidationException clase


Representa la excepción lanzada cuando se encuentran errores y advertencias de validación de esquemas XML [Schema](../) Definition Language (XSD) en un documento XML que se está validando.
...
| **int32_t** [get_LineNumber](../details_xmlschemaexception/get_linenumber/)() | Devuelve el número de línea que indica dónde ocurrió el error. |
| **int32_t** [get_LinePosition](../details_xmlschemaexception/get_lineposition/)() | Devuelve la posición de la línea que indica dónde ocurrió el error. |
| [String](../../system/string/) [get_Message](../details_xmlschemaexception/get_message/)() const override | Devuelve la descripción de la condición de error de esta excepción. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SourceObject](./get_sourceobject/)() | Devuelve el nodo XML que causó esta XmlSchemaValidationException. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](../details_xmlschemaexception/get_sourceschemaobject/)() | El **[XmlSchemaObject](../xmlschemaobject/)** que produjo la XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](../details_xmlschemaexception/get_sourceuri/)() | Devuelve la ubicación del Identificador Uniforme de Recursos (URI) del esquema que causó la excepción. |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Devuelve la cadena que contiene el trazado de la pila. |
...
* Clase [Details_XmlSchemaException](../details_xmlschemaexception/)
