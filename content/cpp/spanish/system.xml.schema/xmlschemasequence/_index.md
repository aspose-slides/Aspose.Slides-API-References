...
description: Representa el elemento sequence (compositor) del XML Schema según lo especificado por el World Wide Web Consortium (W3C). El sequence requiere que los elementos del grupo aparezcan en la secuencia especificada dentro del elemento contenedor.
type: docs
weight: 768
url: /es/system.xml.schema/xmlschemasequence/
---
## XmlSchemaSequence clase

Representa el elemento **sequence** (compositor) del XML [Schema](../) según lo especificado por el consorcio [Web](../../system.web/) World Wide (W3C). El **sequence** requiere que los elementos del grupo aparezcan en la secuencia especificada dentro del elemento contenedor.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Los elementos contenidos dentro del compositor. Colección de [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaSequence](./) o [XmlSchemaAny](../xmlschemaany/). |
...
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Devuelve el número como un valor de cadena. Número máximo de veces que la partícula puede aparecer. |
...
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Devuelve el número como un valor de cadena. El número mínimo de veces que la partícula puede aparecer. |
...
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Establece el número como un valor de cadena. Número máximo de veces que la partícula puede aparecer. |
...
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Establece el número como un valor de cadena. El número mínimo de veces que la partícula puede aparecer. |
...
Los objetos de esta clase solo deben ser asignados usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree instancias de este tipo en la pila ni usando el operador new, ya que provocará errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento. 
