...
description: Define el conjunto de información posterior a la validación de esquema de un nodo XML validado.
type: docs
weight: 40
url: /es/system.xml.schema/ixmlschemainfo/
---
## IXmlSchemaInfo clase


Define el infoset posterior a la validación de esquema de un nodo XML validado.
...
| virtual **bool** [get_IsDefault](./get_isdefault/)() | Devuelve un valor que indica si este nodo XML validado se estableció como resultado de una aplicación de un valor predeterminado durante la validación del esquema XML [Schema](../) Definition Language (XSD). |
| virtual **bool** [get_IsNil](./get_isnil/)() | Devuelve un valor que indica si el valor de este nodo XML validado es **nil**. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | Devuelve el tipo de esquema dinámico para este nodo XML validado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | Devuelve el [XmlSchemaAttribute](../xmlschemaattribute/) compilado que corresponde a este nodo XML validado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | Devuelve el [XmlSchemaElement](../xmlschemaelement/) compilado que corresponde a este nodo XML validado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | Devuelve el tipo de esquema XML [Schema](../) Definition Language (XSD) estático de este nodo XML validado. |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | Devuelve el valor XmlSchemaValidity de este nodo XML validado. |
