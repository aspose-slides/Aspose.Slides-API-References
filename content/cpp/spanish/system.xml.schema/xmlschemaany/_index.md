...
description: Representa el elemento any del World Wide Web Consortium (W3C).
type: docs
weight: 131
url: /es/system.xml.schema/xmlschemaany/
---
## XmlSchemaAny clase
...
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Devuelve el número como valor de cadena. El número mínimo de veces que la partícula puede ocurrir. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Devuelve los espacios de nombres que contienen los elementos que pueden usarse. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Devuelve el XmlSerializerNamespaces para usar con este objeto de esquema. |
...
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | Devuelve información sobre cómo una aplicación o procesador XML debe manejar la validación de documentos XML para los elementos especificados por el elemento **any**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructor de copia. No copia nada, en realidad, solo inicializa un nuevo objeto y permite la construcción de clones en subclases. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de asignación. No copia nada, en realidad, solo inicializa un nuevo objeto y permite la construcción de clones en subclases. |
...
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Establece el número como valor de cadena. El número mínimo de veces que la partícula puede ocurrir. |
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Establece los espacios de nombres que contienen los elementos que pueden usarse. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Establece el XmlSerializerNamespaces para usar con este objeto de esquema. |
...
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | Establece información sobre cómo una aplicación o procesador XML debe manejar la validación de documentos XML para los elementos especificados por el elemento **any**. |
