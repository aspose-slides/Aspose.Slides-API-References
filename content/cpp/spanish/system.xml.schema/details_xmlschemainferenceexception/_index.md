...
description: Devuelve información sobre los errores encontrados por la clase XmlSchemaInference mientras se infiere un esquema a partir de un documento XML.
type: docs
weight: 14
url: /es/system.xml.schema/details_xmlschemainferenceexception/
---
## Details_XmlSchemaInferenceException clase

Devuelve información sobre los errores encontrados por la clase [XmlSchemaInference](../xmlschemainference/) al inferir un esquema a partir de un documento XML.
...
| **int32_t** [get_LinePosition](../details_xmlschemaexception/get_lineposition/)() | Devuelve la posición de línea que indica dónde ocurrió el error. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](../details_xmlschemaexception/get_sourceschemaobject/)() | El **[XmlSchemaObject](../xmlschemaobject/)** que produjo el XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](../details_xmlschemaexception/get_sourceuri/)() | Devuelve la ubicación Uniform Resource Identifier (URI) del esquema que causó la excepción. |
