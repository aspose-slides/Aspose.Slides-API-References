...
description: Clase base para todos los tipos simples y tipos complejos.
type: docs
weight: 911
url: /es/system.xml.schema/xmlschematype/
---
## XmlSchemaType clase
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_BaseSchemaType](./get_baseschematype/)() | Devuelve el tipo de objeto post-compilación o el tipo de datos incorporado del Lenguaje de Definición XML [Schema](../) (XSD), elemento simpleType o elemento complexType. Este es un valor del conjunto de información post-compilación del esquema. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](./)\> [get_BaseXmlSchemaType](./get_basexmlschematype/)() | Devuelve el valor post-compilación para el tipo base de este tipo de esquema. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaDatatype](../xmlschemadatatype/)\> [get_Datatype](./get_datatype/)() | Devuelve el valor post-compilación para el tipo de datos del tipo complejo. |
| [XmlSchemaDerivationMethod](../xmlschemaderivationmethod/) [get_DerivedBy](./get_derivedby/)() | Devuelve la información post-compilación sobre cómo se derivó este elemento de su tipo base. |
| [XmlSchemaDerivationMethod](../xmlschemaderivationmethod/) [get_Final](./get_final/)() | Devuelve el atributo final de la derivación del tipo que indica si se permiten más derivaciones. |
| [XmlSchemaDerivationMethod](../xmlschemaderivationmethod/) [get_FinalResolved](./get_finalresolved/)() | Devuelve la interpretación post-compilación del valor [XmlSchemaType::get_Final](./get_final/). |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Devuelve el identificador de cadena. |
| virtual **bool** [get_IsMixed](./get_ismixed/)() | Devuelve un valor que indica si este tipo tiene un modelo de contenido mixto. Esta llamada solo es válida en un tipo complejo. |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Devuelve el nombre del tipo. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Devuelve el nombre calificado para el tipo construido a partir del atributo **Name** de este tipo. Este es un valor post-compilación del esquema. |
...
| [XmlTypeCode](../xmltypecode/) [get_TypeCode](./get_typecode/)() | Devuelve el XmlTypeCode del tipo. |
...
| static [SharedPtr](../../system/sharedptr/)\<[XmlSchemaComplexType](../xmlschemacomplextype/)\> [GetBuiltInComplexType](./getbuiltincomplextype/)([XmlTypeCode](../xmltypecode/)) | Devuelve un [XmlSchemaComplexType](../xmlschemacomplextype/) que representa el tipo complejo incorporado del tipo complejo especificado. |
| static [SharedPtr](../../system/sharedptr/)\<[XmlSchemaComplexType](../xmlschemacomplextype/)\> [GetBuiltInComplexType](./getbuiltincomplextype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Devuelve un [XmlSchemaComplexType](../xmlschemacomplextype/) que representa el tipo complejo incorporado del tipo complejo especificado por nombre calificado. |
| static [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [GetBuiltInSimpleType](./getbuiltinsimpletype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Devuelve un [XmlSchemaSimpleType](../xmlschemasimpletype/) que representa el tipo simple incorporado del tipo simple que se especifica mediante el nombre calificado. |
| static [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [GetBuiltInSimpleType](./getbuiltinsimpletype/)([XmlTypeCode](../xmltypecode/)) | Devuelve un [XmlSchemaSimpleType](../xmlschemasimpletype/) que representa el tipo simple incorporado del tipo simple especificado. |
...
| static **bool** [IsDerivedFrom](./isderivedfrom/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](./)\>, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](./)\>\&, [XmlSchemaDerivationMethod](../xmlschemaderivationmethod/)) | Devuelve un valor que indica si el tipo de esquema derivado especificado se deriva del tipo de esquema base especificado. |
...
| void [set_Final](./set_final/)([XmlSchemaDerivationMethod](../xmlschemaderivationmethod/)) | Establece el atributo final de la derivación del tipo que indica si se permiten más derivaciones. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Establece el identificador de cadena. |
| virtual void [set_IsMixed](./set_ismixed/)(**bool**) | Establece un valor que indica si este tipo tiene un modelo de contenido mixto. Esta llamada solo es válida en un tipo complejo. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Establece el nombre del tipo. |
