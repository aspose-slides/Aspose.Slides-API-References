...
description: Representa el elemento include del esquema XML según lo especificado por el World Wide Web Consortium (W3C). Esta clase se utiliza para incluir declaraciones y definiciones de un esquema externo. Las declaraciones y definiciones incluidas están luego disponibles para su procesamiento en el esquema contenedor.
type: docs
weight: 495
url: /es/system.xml.schema/xmlschemainclude/
---
## XmlSchemaInclude clase

Represents the **include** element from XML [Schema](../) as specified by the World Wide [Web](../../system.web/) Consortium (W3C). This clase is used to include declarations and definitions from an external schema. The included declarations and definitions are then available for processing in the containing schema.
...
| [String](../../system/string/) [get_Id](../xmlschemaexternal/get_id/)() | Devuelve el id de cadena. |
...
| [String](../../system/string/) [get_SchemaLocation](../xmlschemaexternal/get_schemalocation/)() | Devuelve la ubicación del Identificador de Recurso Uniforme (URI) para el esquema, lo que indica al procesador de esquemas dónde reside físicamente el esquema. |
...
| void [set_Id](../xmlschemaexternal/set_id/)(const [String](../../system/string/)\&) | Establece el id de cadena. |
...
| void [set_SchemaLocation](../xmlschemaexternal/set_schemalocation/)(const [String](../../system/string/)\&) | Establece la ubicación del Identificador de Recurso Uniforme (URI) para el esquema, lo que indica al procesador de esquemas dónde reside físicamente el esquema. |
