...
description: Representa una implementación de guardador de salida para transferir datos al almacenamiento externo.
type: docs
weight: 14
url: /es/aspose.slides.export.xaml/ixamloutputsaver/
---
## IXamlOutputSaver clase

Representa una implementación de guardador de salida para transferir datos al almacenamiento externo.
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Guarda una matriz de bytes en una ubicación de destino. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el n'th argumento de plantilla a un puntero débil (en lugar de compartido). Permite cambiar los punteros en contenedores al modo débil. |
