...
type: docs
weight: 326
url: /es/aspose.slides.export/ipdfoptions/set_sufficientresolution/
---
...
El efecto de este parámetro depende de varios factores. El algoritmo intenta obtener el mejor tamaño de imagen de salida según el valor de la propiedad, el tamaño de la imagen fuente y el tamaño del marco de la imagen. El uso de valores de propiedad similares puede dar el mismo resultado. Se recomienda usar pasos de 16 o 32 para obtener un efecto visible.
