...
| virtual **bool** [get_DisableFontLigatures](./get_disablefontligatures/)() | Obtiene un valor que indica si el texto se representa sin usar ligaduras. Cuando se establece en **true**, las ligaduras serán desactivadas en la salida renderizada. Por defecto, esta propiedad está establecida en **false**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IInkOptions](../iinkoptions/)\> [get_InkOptions](./get_inkoptions/)() | Proporciona opciones que controlan la apariencia de los objetos [Ink](../../aspose.slides.ink/) en el documento exportado. Sólo lectura [IInkOptions](../iinkoptions/) |
...
| virtual void [set_DisableFontLigatures](./set_disablefontligatures/)(**bool**) | Establece un valor que indica si el texto se representa sin usar ligaduras. Cuando se establece en **true**, las ligaduras serán desactivadas en la salida renderizada. Por defecto, esta propiedad está establecida en **false**. |
