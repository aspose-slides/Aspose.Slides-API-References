...
| [System::String](../../system/string/) [get_DefaultRegularFont](../saveoptions/get_defaultregularfont/)() override | Devuelve la fuente utilizada en caso de que la fuente original no se encuentre. Lee [System::String](../../system/string/). |
| **bool** [get_DisableFontLigatures](./get_disablefontligatures/)() override | Obtiene un valor que indica si el texto se renderiza sin usar ligaduras. Cuando se establece en **true**, las ligaturas estarán desactivadas en la salida renderizada. Por defecto, esta propiedad está establecida en **false**. |
...
| void [set_DefaultRegularFont](../saveoptions/set_defaultregularfont/)([System::String](../../system/string/)) override | Establece la fuente utilizada en caso de que la fuente original no se encuentre. Escribe [System::String](../../system/string/). |
| void [set_DisableFontLigatures](./set_disablefontligatures/)(**bool**) override | Establece un valor que indica si el texto se renderiza sin usar ligaduras. Cuando se establece en **true**, las ligaduras estarán desactivadas en la salida renderizada. Por defecto, esta propiedad está establecida en **false**. |
...
* Clase [IRenderingOptions](../irenderingoptions/)
