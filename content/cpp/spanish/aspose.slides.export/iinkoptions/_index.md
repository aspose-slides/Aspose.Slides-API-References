...
Proporciona opciones que controlan la apariencia de los objetos [Ink](../../aspose.slides.ink/) en el documento exportado.
...
| virtual **bool** [get_HideInk](./get_hideink/)() | Muestra u oculta elementos [Ink](../../aspose.slides.ink/) en el documento exportado. |
| virtual **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() | Usa operación ROP u Opacidad para renderizar el pincel. |
...
| void [Lock](../../system/object/lock/)() | Implementa la instrucción C# lock() de bloqueo. Lámela directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| virtual void [set_HideInk](./set_hideink/)(**bool**) | Muestra u oculta elementos [Ink](../../aspose.slides.ink/) en el documento exportado. |
| virtual void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) | Usa operación ROP u Opacidad para renderizar el pincel. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la instrucción C# lock() de desbloqueo. Lámela directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
