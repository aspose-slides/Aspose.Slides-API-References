...
| [System::Drawing::Color](../../system.drawing/color/) [get_CommentsAreaColor](./get_commentsareacolor/)() | Obtiene el color del área de comentarios (Se aplica solo si los comentarios se muestran a la derecha). |
| **int32_t** [get_CommentsAreaWidth](./get_commentsareawidth/)() | Obtiene el ancho del área de salida de comentarios en píxeles (Se aplica solo si los comentarios se muestran a la derecha). |
| [CommentsPositions](../commentspositions/) [get_CommentsPosition](./get_commentsposition/)() | Obtiene la posición de los comentarios en la página. |
| [NotesPositions](../notespositions/) [get_NotesPosition](./get_notesposition/)() | Obtiene la posición de las notas en la página. |
| **bool** [get_ShowCommentsByNoAuthor](./get_showcommentsbynoauthor/)() | Obtiene la visibilidad de los comentarios que no tienen autor. Si es verdadero, los comentarios se mostrarán. (Se aplica solo si los comentarios se muestran). |
...
| void [set_CommentsAreaColor](./set_commentsareacolor/)([System::Drawing::Color](../../system.drawing/color/)) | Establece el color del área de comentarios (Se aplica solo si los comentarios se muestran a la derecha). |
| void [set_CommentsAreaWidth](./set_commentsareawidth/)(**int32_t**) | Establece el ancho del área de salida de comentarios en píxeles (Se aplica solo si los comentarios se muestran a la derecha). |
| void [set_CommentsPosition](./set_commentsposition/)([CommentsPositions](../commentspositions/)) | Establece la posición de los comentarios en la página. |
| void [set_NotesPosition](./set_notesposition/)([NotesPositions](../notespositions/)) | Establece la posición de las notas en la página. |
| void [set_ShowCommentsByNoAuthor](./set_showcommentsbynoauthor/)(**bool**) | Establece la visibilidad de los comentarios que no tienen autor. Si es verdadero, los comentarios se mostrarán. (Se aplica solo si los comentarios se muestran). |
