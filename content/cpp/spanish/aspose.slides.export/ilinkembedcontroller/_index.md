...
| virtual [LinkEmbedDecision](../linkembeddecision/) [GetObjectStoringLocation](./getobjectstoringlocation/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) | Determina dónde debe almacenarse el objeto. Este método se llama una vez por cada id de objeto. No se garantiza que no haya dos objetos con los mismos datos, semanticName y contentType pero con diferente id. |
...
| virtual [System::String](../../system/string/) [GetUrl](./geturl/)(**int32_t**, **int32_t**) | Devuelve una URL a un objeto externo. Este método siempre se llama si [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/) devolvió [LinkEmbedDecision::Link](../linkembeddecision/) y puede llamarse si [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/) devolvió [LinkEmbedDecision::Embed](../linkembeddecision/) pero la incrustación es imposible. Puede llamarse varias veces para el mismo id de objeto. |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo de la sentencia lock() de C#. Llámalos directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
...
| virtual void [SaveExternal](./saveexternal/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Guarda el objeto externo. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo de la sentencia lock() de C#. Llámalos directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
