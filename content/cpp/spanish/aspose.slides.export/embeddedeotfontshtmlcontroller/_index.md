...
description: La clase del controlador de formato para usar en la incrustación de fuentes en formato EOT
type: docs
weight: 14
...
La clase del controlador de formato para usar en la incrustación de fuentes en formato EOT
...
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Crea una nueva instancia. |
...
* Clase [IEmbeddedEotFontsHtmlController](../iembeddedeotfontshtmlcontroller/)
