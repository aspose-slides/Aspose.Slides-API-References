...
---
## ITextToHtmlConversionOptions clase
...
| virtual **bool** [get_AddClipboardFragmentHeader](./get_addclipboardfragmentheader/)() | Devuelve un valor que indica si se deben añadir encabezados del Portapapeles. Lectura **bool**. |
| virtual [System::String](../../system/string/) [get_EncodingName](./get_encodingname/)() | Devuelve el nombre de la codificación HTML. Este valor se guardará en el archivo HTML generado, pero depende del llamador asegurarse de que el archivo se guarde con esta codificación. Lectura [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Export::ILinkEmbedController](../ilinkembedcontroller/)\> [get_LinkEmbedController](./get_linkembedcontroller/)() | Devuelve un objeto de devolución de llamada que controla cómo se almacenará el objeto externo. Lectura [Export::ILinkEmbedController](../ilinkembedcontroller/). |
| virtual [Aspose::Slides::Export::TextInheritanceLimit](../textinheritancelimit/) [get_TextInheritanceLimit](./get_textinheritancelimit/)() | Devuelve la profundidad heredada para propiedades de texto. Lectura [TextInheritanceLimit](../textinheritancelimit/). |
...
| virtual void [set_AddClipboardFragmentHeader](./set_addclipboardfragmentheader/)(**bool**) | Establece un valor que indica si se deben añadir encabezados del Portapapeles. Escritura **bool**. |
| virtual void [set_EncodingName](./set_encodingname/)([System::String](../../system/string/)) | Establece el nombre de la codificación HTML. Este valor se guardará en el archivo HTML generado, pero depende del llamador asegurarse de que el archivo se guarde con esta codificación. Escritura [System::String](../../system/string/). |
| virtual void [set_LinkEmbedController](./set_linkembedcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[Export::ILinkEmbedController](../ilinkembedcontroller/)\>) | Establece un objeto de devolución de llamada que controla cómo se almacenará el objeto externo. Escritura [Export::ILinkEmbedController](../ilinkembedcontroller/). |
| virtual void [set_TextInheritanceLimit](./set_textinheritancelimit/)([Aspose::Slides::Export::TextInheritanceLimit](../textinheritancelimit/)) | Establece la profundidad heredada para propiedades de texto. Escritura [TextInheritanceLimit](../textinheritancelimit/). |
