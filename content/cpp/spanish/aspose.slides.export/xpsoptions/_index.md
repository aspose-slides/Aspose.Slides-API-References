...
| **bool** [get_DrawSlidesFrame](./get_drawslidesframe/)() override | Verdadero para dibujar un marco negro alrededor de cada diapositiva. Lee **bool**. |
...
| **bool** [get_SaveMetafilesAsPng](./get_savemetafilesaspng/)() override | Verdadero para convertir todos los metarchivos usados en una presentación a imágenes PNG. Lee **bool**. |
...
| void [set_DrawSlidesFrame](./set_drawslidesframe/)(**bool**) override | Verdadero para dibujar un marco negro alrededor de cada diapositiva. Escribe **bool**. |
...
| void [set_SaveMetafilesAsPng](./set_savemetafilesaspng/)(**bool**) override | Verdadero para convertir todos los metarchivos usados en una presentación a imágenes PNG. Escribe **bool**. |
