...
description: Representa un generador de las animaciones en la Presentación.
type: docs
weight: 612
...
Representa un generador de las animaciones en el [Presentation](../../aspose.slides/presentation/).
...
| Método | Descripción |
| --- | --- |
| void [Dispose](./dispose/)() override | Descarta la instancia de [PresentationAnimationsGenerator](./). |
...
| **int32_t** [get_DefaultDelay](./get_defaultdelay/)() const | Obtiene el tiempo de retardo predeterminado [ms]. |
| **int32_t** [get_ExportedSlides](./get_exportedslides/)() const | Obtiene la cantidad de diapositivas exportadas. |
| **bool** [get_IncludeHiddenSlides](./get_includehiddenslides/)() const | Obtiene o establece si se deben incluir diapositivas ocultas. |
...
|  [PresentationAnimationsGenerator](./presentationanimationsgenerator/)([System::SharedPtr](../../system/sharedptr/)\<[Presentation](../../aspose.slides/presentation/)\>) | Crea una nueva instancia de [PresentationAnimationsGenerator](./). |
|  [PresentationAnimationsGenerator](./presentationanimationsgenerator/)([System::Drawing::Size](../../system.drawing/size/)) | Crea una nueva instancia de [PresentationAnimationsGenerator](./). |
...
| void [Run](./run/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>\>\>) | Ejecuta la generación de eventos de animación para cada diapositiva. |
| void [Run](./run/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>\>\>, **int32_t**, [PresentationPlayer::FrameTickHandler](../presentationplayer/frametickhandler/)) | Ejecuta la generación de eventos de animación para cada diapositiva. |
| void [set_DefaultDelay](./set_defaultdelay/)(**int32_t**) | Establece el tiempo de retardo predeterminado [ms]. |
| void [set_IncludeHiddenSlides](./set_includehiddenslides/)(**bool**) | Obtiene o establece si se deben incluir diapositivas ocultas. |
