...
description: Clase controladora de formato que se utiliza para incrustar fuentes en formato WOFF
type: docs
weight: 27
...
La clase controladora de formato que se utiliza para incrustar fuentes en formato WOFF
...
|  [EmbeddedWoffFontsHtmlController](./embeddedwofffontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Crea una nueva instancia. |
...
* Clase [IEmbeddedWoffFontsHtmlController](../iembeddedwofffontshtmlcontroller/)
