...
type: docs
weight: 92
url: /es/aspose.slides.export/igifoptions/set_defaultdelay/
---
## IGifOptions::set_DefaultDelay(int32_t) método


Establece el tiempo de retardo predeterminado [ms]. Este valor se usará si no se llamó al método [ISlideShowTransition::set_AdvanceAfterTime()](../../../aspose.slides/islideshowtransition/set_advanceaftertime/). El valor predeterminado es 1000.
