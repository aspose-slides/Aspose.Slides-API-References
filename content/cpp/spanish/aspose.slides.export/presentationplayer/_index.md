...
description: Representa el reproductor de animaciones asociado con la Presentación.
type: docs
weight: 625
...
Representa el reproductor de animaciones asociado con [Presentation](../../aspose.slides/presentation/).
...
| Método | Descripción |
| --- | --- |
| void [Dispose](./dispose/)() override | Descarta la instancia de [PresentationPlayer](./). |
...
| **int32_t** [get_FrameIndex](./get_frameindex/)() | Obtiene el índice del fotograma. |
...
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | Crea una nueva instancia de [PresentationPlayer](./). |
...
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | Representa el manejador de ticks de fotograma del evento **PresentationPlayer::FrameTick**. |
