...
description: "Representa un objeto matemático fantasma (<m:phant>) que afecta el diseño de su elemento hijo sin necesariamente mostrarse. Un fantasma puede ocultar su expresión base mientras preserva su ancho, altura o profundidad para alinear fórmulas o reservar espacio. La visibilidad y el comportamiento geométrico se controlan mediante propiedades como Show, ZeroWid, ZeroAsc, ZeroDesc y Transp."
type: docs
weight: 1028
...
Representa un objeto matemático fantasma (<m:phant>) que afecta el diseño de su elemento hijo sin necesariamente mostrarse. Un fantasma puede ocultar su expresión base mientras preserva su ancho, altura o profundidad para alinear fórmulas o reservar espacio. La visibilidad y el comportamiento geométrico se controlan mediante propiedades como Show, ZeroWid, ZeroAsc, ZeroDesc y Transp.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Encierra un elemento matemático en los caracteres especificados, como paréntesis u otros caracteres de marco |
...
| **bool** [get_Show](./get_show/)() override | Obtiene un valor que indica si el elemento base se muestra. |
| **bool** [get_Transp](./get_transp/)() override | Obtiene un valor que indica si el fantasma es transparente para reglas de espaciado basadas en clases. |
| **bool** [get_ZeroAsc](./get_zeroasc/)() override | Obtiene un valor que indica si la ascensión (altura sobre la línea base) del elemento base debe considerarse cero. |
| **bool** [get_ZeroDesc](./get_zerodesc/)() override | Obtiene un valor que indica si la descensión (profundidad bajo la línea base) del elemento base debe considerarse cero. |
| **bool** [get_ZeroWidth](./get_zerowidth/)() override | Obtiene un valor que indica si el ancho del elemento base debe considerarse cero. |
...
|  [MathPhantom](./mathphantom/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inicializa una nueva instancia de la clase [MathPhantom](./) usando el elemento matemático base especificado. |
...
| void [set_Show](./set_show/)(**bool**) override | Establece un valor que indica si el elemento base se muestra. |
| void [set_Transp](./set_transp/)(**bool**) override | Establece un valor que indica si el fantasma es transparente para reglas de espaciado basadas en clases. |
| void [set_ZeroAsc](./set_zeroasc/)(**bool**) override | Establece un valor que indica si la ascensión (altura sobre la línea base) del elemento base debe considerarse cero. |
| void [set_ZeroDesc](./set_zerodesc/)(**bool**) override | Establece un valor que indica si la descensión (profundidad bajo la línea base) del elemento base debe considerarse cero. |
| void [set_ZeroWidth](./set_zerowidth/)(**bool**) override | Establece un valor que indica si el ancho del elemento base debe considerarse cero. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)() override | Coloca este elemento en un borde-caja |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) override | Coloca este elemento en un borde-caja |
...
phantom->set_Show(false); // Ocultar el contenido
phantom->set_ZeroWidth(false); // Mantener el ancho
```

## Ver también

* Clase [MathElementBase](../mathelementbase/)
* Clase [IMathPhantom](../imathphantom/)
