...
description: "Representa un objeto matemático fantasma (<m:phant>) que afecta el diseño de su elemento hijo sin necesariamente mostrarlo. Un fantasma puede ocultar su expresión base mientras preserva su ancho, altura o profundidad para alinear fórmulas o reservar espacio. La visibilidad y el comportamiento geométrico se controlan mediante propiedades como Show, ZeroWid, ZeroAsc, ZeroDesc y Transp."
type: docs
weight: 482
...
Representa un objeto matemático fantasma (<m:phant>) que afecta la disposición de su elemento hijo sin necesidad de mostrarse. Un fantasma puede ocultar su expresión base mientras preserva su ancho, altura o profundidad para alinear fórmulas o reservar espacio. La visibilidad y el comportamiento geométrico se controlan mediante propiedades como Show, ZeroWid, ZeroAsc, ZeroDesc y Transp.
...
| virtual **bool** [get_Show](./get_show/)() | Obtiene un valor que indica si el elemento base se muestra. |
| virtual **bool** [get_Transp](./get_transp/)() | Obtiene un valor que indica si el fantasma es transparente para reglas de espaciado basadas en clases. |
| virtual **bool** [get_ZeroAsc](./get_zeroasc/)() | Obtiene un valor que indica si la ascensión (altura por encima de la línea base) del elemento base debe tratarse como cero. |
| virtual **bool** [get_ZeroDesc](./get_zerodesc/)() | Obtiene un valor que indica si el descenso (profundidad bajo la línea base) del elemento base debe tratarse como cero. |
| virtual **bool** [get_ZeroWidth](./get_zerowidth/)() | Obtiene un valor que indica si el ancho del elemento base debe tratarse como cero. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Análogo del método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonación de tipos personalizados. |
...
| virtual void [set_Show](./set_show/)(**bool**) | Establece un valor que indica si el elemento base se muestra. |
| virtual void [set_Transp](./set_transp/)(**bool**) | Establece un valor que indica si el fantasma es transparente para reglas de espaciado basadas en clases. |
| virtual void [set_ZeroAsc](./set_zeroasc/)(**bool**) | Establece un valor que indica si la ascensión (altura por encima de la línea base) del elemento base debe tratarse como cero. |
| virtual void [set_ZeroDesc](./set_zerodesc/)(**bool**) | Establece un valor que indica si el descenso (profundidad bajo la línea base) del elemento base debe tratarse como cero. |
| virtual void [set_ZeroWidth](./set_zerowidth/)(**bool**) | Establece un valor que indica si el ancho del elemento base debe tratarse como cero. |
