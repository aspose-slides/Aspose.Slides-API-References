...
| Método | Descripción |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Añade [IMathBlock](../imathblock/) al final de la colección. |
...
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Determina si la colección contiene un valor específico. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Obtiene el número de elementos realmente contenidos en la colección. **int32_t** de solo lectura. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) | Obtiene el elemento en el índice especificado. [IMathBlock](../imathblock/) de solo lectura. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Obtiene el elemento en el índice especificado. [IMathBlock](../imathblock/) de solo lectura. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Determina el índice de un [IMathBlock](../imathblock/) específico en la colección. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Inserta [IMathBlock](../imathblock/) en la colección en el índice especificado. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Elimina la primera aparición de un objeto específico de la colección/>. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Elimina un elemento en el índice especificado de la colección. |
