...
Especifica la función de acento, que consiste en una base y una marca diacrítica combinada. Ejemplo: \\uD835\\uDC4E\\u0301
...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](./)\> [Accent](../imathelement/accent/)(char16_t) | Establece una marca de acento (un carácter en la parte superior de este elemento) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Encierra este elemento en los caracteres especificados, como paréntesis u otros caracteres de marco |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | El argumento al que se aplicó el acento |
| virtual char16_t [get_Character](./get_character/)() | Carácter de acento. El valor debe estar dentro del rango (U+0300\\u2013U+036F) o (U+20D0\\u2013U+20EF). Valor predeterminado: Acento circunflejo combinante (U+0302) |
...
| virtual void [set_Character](./set_character/)(char16_t) | Carácter de acento. El valor debe estar dentro del rango (U+0300\\u2013U+036F) o (U+20D0\\u2013U+20EF). Valor predeterminado: Acento circunflejo combinante (U+0302) |
