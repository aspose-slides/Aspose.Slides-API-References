...
| Método | Descripción |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [CreateMathAccent](./createmathaccent/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Crea un acento matemático que se aplica a un elemento matemático especificado con el valor de carácter de acento predeterminado |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [CreateMathAccent](./createmathaccent/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, char16_t) override | Crea un acento matemático que se aplica a un elemento matemático especificado |
...
* Clase [IMathAccentFactory](../imathaccentfactory/)
