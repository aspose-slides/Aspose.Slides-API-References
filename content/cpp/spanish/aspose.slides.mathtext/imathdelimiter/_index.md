...
description: "Especifica el objeto delimitador, que consiste en caracteres de apertura y cierre (como paréntesis, llaves, corchetes y barras verticales), y uno o más elementos matemáticos dentro, separados por un carácter especificado. Ejemplos: (\\uD835\\uDC652); [\\uD835\\uDC652|\\uD835\\uDC662]"
type: docs
weight: 196
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](./)\> [Delimit](./delimit/)(char16_t) | Delimita los argumentos usando el carácter delimitador especificado |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](./)\> [Enclose](../imathelement/enclose/)() | Encierra un elemento matemático entre paréntesis |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](./)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Encierra este elemento en los caracteres especificados, como paréntesis u otros caracteres como marco |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) | Devuelve el elemento matemático en el índice especificado del array. Sólo lectura [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() | Uno o más elementos matemáticos separados por caracteres delimitadores |
| virtual char16_t [get_BeginningCharacter](./get_beginningcharacter/)() | El carácter de inicio del delimitador especifica el carácter delimitador de apertura. Los delimitadores matemáticos son caracteres de cierre como paréntesis, corchetes y llaves. Valor predeterminado: '('. |
| virtual [MathDelimiterShape](../mathdelimitershape/) [get_DelimiterShape](./get_delimitershape/)() | Especifica la forma de los delimitadores en el objeto delimitador. Cuando es [MathDelimiterShape::Centered](../mathdelimitershape/), los delimitadores están centrados alrededor del eje matemático del texto y aún pueden ajustarse para cubrir toda la altura de su contenido. Cuando es [MathDelimiterShape::Match](../mathdelimitershape/), su altura y forma se alteran para coincidir exactamente con su contenido. |
| virtual char16_t [get_EndingCharacter](./get_endingcharacter/)() | Delimiter Ending Character especifica el carácter delimitador de cierre, o final. Los delimitadores matemáticos son caracteres de cierre como paréntesis, corchetes y llaves. Valor predeterminado: ')'. |
| virtual **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() | Especifica el crecimiento de BeginningCharacter, SeparatorCharacter, EndingCharacter. Cuando es verdadero, los delimitadores crecen verticalmente para coincidir con la altura del operando. El valor predeterminado es true |
| virtual char16_t [get_SeparatorCharacter](./get_separatorcharacter/)() | Delimiter Separator Character especifica el carácter que separa los argumentos en el objeto delimitador. Valor predeterminado: '|'. |
...
| virtual void [set_BeginningCharacter](./set_beginningcharacter/)(char16_t) | El carácter de inicio del delimitador especifica el carácter delimitador de apertura. Los delimitadores matemáticos son caracteres de cierre como paréntesis, corchetes y llaves. Valor predeterminado: '('. |
| virtual void [set_DelimiterShape](./set_delimitershape/)([MathDelimiterShape](../mathdelimitershape/)) | Especifica la forma de los delimitadores en el objeto delimitador. Cuando es [MathDelimiterShape::Centered](../mathdelimitershape/), los delimitadores están centrados alrededor del eje matemático del texto y aún pueden ajustarse para cubrir toda la altura de su contenido. Cuando es [MathDelimiterShape::Match](../mathdelimitershape/), su altura y forma se alteran para coincidir exactamente con su contenido. |
| virtual void [set_EndingCharacter](./set_endingcharacter/)(char16_t) | Delimiter Ending Character especifica el carácter delimitador de cierre, o final. Los delimitadores matemáticos son caracteres de cierre como paréntesis, corchetes y llaves. Valor predeterminado: ')'. |
| virtual void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) | Especifica el crecimiento de BeginningCharacter, SeparatorCharacter, EndingCharacter. Cuando es verdadero, los delimitadores crecen verticalmente para coincidir con la altura del operando. El valor predeterminado es true |
| virtual void [set_SeparatorCharacter](./set_separatorcharacter/)(char16_t) | Delimiter Separator Character especifica el carácter que separa los argumentos en el objeto delimitador. Valor predeterminado: '|'. |
