...
Dibuja un borde rectangular u otro alrededor del [IMathElement](../imathelement/).
...
| **bool** [get_HideBottom](./get_hidebottom/)() override | Ocultar borde inferior (el valor predeterminado es false) - especifica el estado oculto o visible del borde inferior del cuadro de borde. |
| **bool** [get_HideLeft](./get_hideleft/)() override | Ocultar borde izquierdo (el valor predeterminado es false) - especifica el estado oculto o visible del borde izquierdo del cuadro de borde. |
| **bool** [get_HideRight](./get_hideright/)() override | Ocultar borde derecho (el valor predeterminado es false) - especifica el estado oculto o visible del borde derecho del cuadro de borde. |
| **bool** [get_HideTop](./get_hidetop/)() override | Ocultar borde superior (el valor predeterminado es false) - especifica el estado oculto o visible del borde superior del cuadro de borde. |
| **bool** [get_StrikethroughBottomLeftToTopRight](./get_strikethroughbottomlefttotopright/)() override | Tachado de abajo a la izquierda a arriba a la derecha (el valor predeterminado es false). Especifica el estado oculto o visible de una línea diagonal tachada desde la esquina inferior izquierda hasta la esquina superior derecha del cuadro de borde. |
| **bool** [get_StrikethroughHorizontal](./get_strikethroughhorizontal/)() override | Tachado horizontal (el valor predeterminado es false) - especifica el estado oculto o visible de una línea horizontal tachada. |
| **bool** [get_StrikethroughTopLeftToBottomRight](./get_strikethroughtoplefttobottomright/)() override | Tachado de arriba a la izquierda a abajo a la derecha (el valor predeterminado es false). Especifica el estado oculto o visible de una línea diagonal tachada desde la esquina superior izquierda hasta la esquina inferior derecha del cuadro de borde. |
| **bool** [get_StrikethroughVertical](./get_strikethroughvertical/)() override | Tachado vertical (el valor predeterminado es false) - especifica el estado oculto o visible de una línea vertical tachada. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógico del método C# [Object.GetHashCode()](../../system/object/gethashcode/). Habilita el hash de objetos personalizados. |
...
| [MathBorderBox](./mathborderbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Crea un elemento [MathBorderBox](./) con borde rectangular |
| [MathBorderBox](./mathborderbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | Crea un elemento [MathBorderBox](./) |
...
| void [set_HideBottom](./set_hidebottom/)(**bool**) override | Ocultar borde inferior (el valor predeterminado es false) - especifica el estado oculto o visible del borde inferior del cuadro de borde. |
| void [set_HideLeft](./set_hideleft/)(**bool**) override | Ocultar borde izquierdo (el valor predeterminado es false) - especifica el estado oculto o visible del borde izquierdo del cuadro de borde. |
| void [set_HideRight](./set_hideright/)(**bool**) override | Ocultar borde derecho (el valor predeterminado es false) - especifica el estado oculto o visible del borde derecho del cuadro de borde. |
| void [set_HideTop](./set_hidetop/)(**bool**) override | Ocultar borde superior (el valor predeterminado es false) - especifica el estado oculto o visible del borde superior del cuadro de borde. |
| void [set_StrikethroughBottomLeftToTopRight](./set_strikethroughbottomlefttotopright/)(**bool**) override | Tachado de abajo a la izquierda a arriba a la derecha (el valor predeterminado es false). Especifica el estado oculto o visible de una línea diagonal tachada desde la esquina inferior izquierda hasta la esquina superior derecha del cuadro de borde. |
| void [set_StrikethroughHorizontal](./set_strikethroughhorizontal/)(**bool**) override | Tachado horizontal (el valor predeterminado es false) - especifica el estado oculto o visible de una línea horizontal tachada. |
| void [set_StrikethroughTopLeftToBottomRight](./set_strikethroughtoplefttobottomright/)(**bool**) override | Tachado de arriba a la izquierda a abajo a la derecha (el valor predeterminado es false). Especifica el estado oculto o visible de una línea diagonal tachada desde la esquina superior izquierda hasta la esquina inferior derecha del cuadro de borde. |
| void [set_StrikethroughVertical](./set_strikethroughvertical/)(**bool**) override | Tachado vertical (el valor predeterminado es false) - especifica el estado oculto o visible de una línea vertical tachada. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Coloca este elemento en un cuadro no visual (agrupación lógica) que se utiliza para agrupar componentes de una ecuación u otra instancia de texto matemático. Un objeto encapsulado puede (por ejemplo) servir como emulador de operador con o sin punto de alineación, servir como punto de salto de línea, o agruparse de manera que no se permitan saltos de línea dentro. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analógico del método C# [Object.ToString()](../../system/object/tostring/). Habilita la conversión de objetos personalizados a cadena. |
