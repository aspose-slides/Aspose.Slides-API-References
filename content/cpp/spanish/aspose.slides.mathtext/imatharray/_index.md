...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) | Devuelve el elemento en el índice especificado del arreglo. Solo lectura [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() | El conjunto de elementos del arreglo |
| virtual [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() | Especifica la alineación del arreglo respecto al texto circundante. El texto fuera del arreglo puede alinearse con la parte inferior, superior o el centro del objeto del arreglo. Valor predeterminado: Centro |
| virtual **bool** [get_MaximumDistribution](./get_maximumdistribution/)() | Distribución máxima. Cuando es verdadero, el arreglo se espacia al ancho máximo del elemento contenedor (página, columna, celda, etc.). |
| virtual **bool** [get_ObjectDistribution](./get_objectdistribution/)() | Distribución de objeto. Cuando es verdadero, el contenido del arreglo se espacia al ancho máximo del objeto del arreglo. |
| virtual **uint32_t** [get_RowSpacing](./get_rowspacing/)() | Espaciado entre filas de un arreglo. Se usa solo cuando RowSpacingRule está configurado a 3 Exactamente, en cuyo caso la unidad de medida son puntos, o Multiple, en cuyo caso la unidad de medida son media línea. Valor predeterminado: 0 |
| virtual [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() | El tipo de espaciado vertical entre los elementos del arreglo |
...
| virtual void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) | Especifica la alineación del arreglo respecto al texto circundante. El texto fuera del arreglo puede alinearse con la parte inferior, superior o el centro del objeto del arreglo. Valor predeterminado: Centro |
| virtual void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) | Distribución máxima. Cuando es verdadero, el arreglo se espacia al ancho máximo del elemento contenedor (página, columna, celda, etc.). |
| virtual void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) | Distribución de objeto. Cuando es verdadero, el contenido del arreglo se espacia al ancho máximo del objeto del arreglo. |
| virtual void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) | Espaciado entre filas de un arreglo. Se usa solo cuando RowSpacingRule está configurado a 3 Exactamente, en cuyo caso la unidad de medida son puntos, o Multiple, en cuyo caso la unidad de medida son media línea. Valor predeterminado: 0 |
| virtual void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) | El tipo de espaciado vertical entre los elementos del arreglo |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathArray](./)\> [ToMathArray](../imathelement/tomatharray/)() | Coloca en una matriz vertical |
