...
| **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() override | El carácter del operador crece verticalmente para coincidir con la altura de su operando |
| **bool** [get_HideSubscript](./get_hidesubscript/)() override | Ocultar subíndice |
| **bool** [get_HideSuperscript](./get_hidesuperscript/)() override | Ocultar superíndice |
| [MathLimitLocations](../mathlimitlocations/) [get_LimitLocation](./get_limitlocation/)() override | La ubicación de los límites (subíndice y superíndice) |
| char16_t [get_Operator](./get_operator/)() override | Carácter de operador N-ario Por ejemplo: '\\u2211', '\\u222B' |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Subscript](./get_subscript/)() override | Especifica un argumento subíndice que, por ejemplo, en el caso de una integral, establece el límite inferior |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Superscript](./get_superscript/)() override | Especifica un argumento superíndice que, por ejemplo, en el caso de una integral, establece el límite superior |
...
| void [Lock](../../system/object/lock/)() | Implementa la instrucción lock() de C# bloqueando. Llámelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
|  [MathNaryOperator](./mathnaryoperator/)(char16_t, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inicializa una nueva instancia de la clase [MathNaryOperator](./). |
|  [MathNaryOperator](./mathnaryoperator/)(char16_t, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inicializa una nueva instancia de la clase [MathNaryOperator](./). |
|  [MathNaryOperator](./mathnaryoperator/)(char16_t, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inicializa una nueva instancia de la clase [MathNaryOperator](./). |
...
| void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) override | El carácter del operador crece verticalmente para coincidir con la altura de su operando |
| void [set_HideSubscript](./set_hidesubscript/)(**bool**) override | Ocultar subíndice |
| void [set_HideSuperscript](./set_hidesuperscript/)(**bool**) override | Ocultar superíndice |
| void [set_LimitLocation](./set_limitlocation/)([MathLimitLocations](../mathlimitlocations/)) override | La ubicación de los límites (subíndice y superíndice) |
| void [set_Operator](./set_operator/)(char16_t) override | Carácter de operador N-ario Por ejemplo: '\\u2211', '\\u222B' |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la instrucción lock() de C# desbloqueando. Llámelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
