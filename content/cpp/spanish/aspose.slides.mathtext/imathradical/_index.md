...
description: Especifica la función radical, compuesta por una base y un grado opcional. Un ejemplo de objeto radical es \\u221A\\uD835\\uDC65.
type: docs
weight: 508
...
Specifica la función radical, compuesta por una base y un grado opcional. Ejemplo de objeto radical es \\u221A\\uD835\\uDC65.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Degree](./get_degree/)() | Argumento de grado |
| virtual **bool** [get_HideDegree](./get_hidedegree/)() | Ocultar grado. Cuando es verdadero, el grado no se muestra, como en \\u221A\\uD835\\uDC65 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Especifica la raíz matemática del grado dado a partir del argumento especificado. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Especifica la raíz matemática del grado dado a partir del argumento especificado. |
...
| virtual void [set_HideDegree](./set_hidedegree/)(**bool**) | Ocultar grado. Cuando es verdadero, el grado no se muestra, como en \\u221A\\uD835\\uDC65 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Coloca este elemento en un recuadro no visual (agrupación lógica) que se utiliza para agrupar componentes de una ecuación u otra instancia de texto matemático. Un objeto en recuadro puede (por ejemplo) servir como emulador de operador con o sin punto de alineación, servir como punto de salto de línea, o agruparse de forma que no se permitan saltos de línea dentro. |
