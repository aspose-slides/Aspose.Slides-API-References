...
| char16_t [get_Character](./get_character/)() override | Valor predeterminado del carácter de agrupación: U+23DF (LLAVE CURVA INFERIOR) |
| [MathTopBotPositions](../mathtopbotpositions/) [get_Position](./get_position/)() override | Posición del carácter de agrupación. Predeterminado: Inferior |
| [MathTopBotPositions](../mathtopbotpositions/) [get_VerticalJustification](./get_verticaljustification/)() override | Justificación vertical del carácter de agrupación. Especifica la alineación del objeto con respecto a la línea base. Por ejemplo, cuando el carácter de agrupación está encima del objeto, VerticalJustification de Top indica que la parte superior del objeto cae sobre la línea base; cuando VerticalJustification se establece en Bottom, la parte inferior del objeto está sobre la línea base. Predeterminado: Bottom para Position=Top, y Top para Position=Bottom |
...
| void [Lock](../../system/object/lock/)() | Implementa la instrucción C# lock() bloqueando. Llámelo directamente o use [LockContext](../../system/lockcontext/) objeto centinela. |
|  [MathGroupingCharacter](./mathgroupingcharacter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inicializa una nueva instancia de la clase [MathGroupingCharacter](./) con el carácter de agrupación predeterminado U+23DF (LLAVE CURVA INFERIOR) |
|  [MathGroupingCharacter](./mathgroupingcharacter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | Inicializa una nueva instancia de la clase [MathGroupingCharacter](./). |
...
| void [set_Character](./set_character/)(char16_t) override | Valor predeterminado del carácter de agrupación: U+23DF (LLAVE CURVA INFERIOR) |
| void [set_Position](./set_position/)([MathTopBotPositions](../mathtopbotpositions/)) override | Posición del carácter de agrupación. Predeterminado: Inferior |
| void [set_VerticalJustification](./set_verticaljustification/)([MathTopBotPositions](../mathtopbotpositions/)) override | Justificación vertical del carácter de agrupación. Especifica la alineación del objeto con respecto a la línea base. Por ejemplo, cuando el carácter de agrupación está encima del objeto, VerticalJustification de Top indica que la parte superior del objeto cae sobre la línea base; cuando VerticalJustification se establece en Bottom, la parte inferior del objeto está sobre la línea base. Predeterminado: Bottom para Position=Top, y Top para Position=Bottom |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la instrucción C# lock() desbloqueando. Llámelo directamente o use [LockContext](../../system/lockcontext/) objeto centinela. |
