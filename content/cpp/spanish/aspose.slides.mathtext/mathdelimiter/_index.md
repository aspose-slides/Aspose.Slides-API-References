...
description: "Especifica el objeto delimitador, formado por caracteres de apertura y cierre (como paréntesis, llaves, corchetes y barras verticales), y uno o más elementos matemáticos en su interior, separados por un carácter especificado. Ejemplos: (\\uD835\\uDC652); [\\uD835\\uDC652|\\uD835\\uDC662]"
type: docs
weight: 768
...
Especifica el objeto delimitador, formado por caracteres de apertura y cierre (como paréntesis, llaves, corchetes y barras verticales), y uno o más elementos matemáticos en su interior, separados por un carácter especificado. Ejemplos: (\\uD835\\uDC652); [\\uD835\\uDC652|\\uD835\\uDC662]
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Delimit](./delimit/)(char16_t) override | Delimita los argumentos usando el carácter delimitador especificado |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](./enclose/)(char16_t, char16_t) override | Encierra un elemento matemático en los caracteres especificados, como paréntesis u otros caracteres como marco |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) override | Devuelve el elemento matemático en el índice especificado del arreglo. Solo lectura [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() override | Uno o más elementos matemáticos separados por caracteres delimitadores |
| char16_t [get_BeginningCharacter](./get_beginningcharacter/)() override | El carácter de inicio del delimitador especifica el carácter delimitador de apertura. Los delimitadores matemáticos son caracteres de contorno como paréntesis, corchetes y llaves. El valor predeterminado: '('. |
| [MathDelimiterShape](../mathdelimitershape/) [get_DelimiterShape](./get_delimitershape/)() override | Especifica la forma de los delimitadores en el objeto delimitador. Cuando es [MathDelimiterShape::Centered](../mathdelimitershape/), los delimitadores se centran alrededor del eje matemático del texto y pueden ajustarse a la altura completa de su contenido. Cuando es [MathDelimiterShape::Match](../mathdelimitershape/), su altura y forma se modifican para coincidir exactamente con su contenido. |
| char16_t [get_EndingCharacter](./get_endingcharacter/)() override | El carácter de fin del delimitador especifica el carácter delimitador de cierre. Los delimitadores matemáticos son caracteres de contorno como paréntesis, corchetes y llaves. El valor predeterminado: ')'. |
| **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() override | Especifica el crecimiento de BeginningCharacter, SeparatorCharacter, EndingCharacter. Cuando es true, los delimitadores crecen verticalmente para coincidir con la altura del operando. El valor predeterminado es true |
| char16_t [get_SeparatorCharacter](./get_separatorcharacter/)() override | El carácter separador del delimitador especifica el carácter que separa los argumentos en el objeto delimitador. El valor predeterminado: '|'. |
...
|  [MathDelimiter](./mathdelimiter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inicializa [MathDelimiter](./) con el elemento especificado como argumento base único. |
...
| void [set_BeginningCharacter](./set_beginningcharacter/)(char16_t) override | El carácter de inicio del delimitador especifica el carácter delimitador de apertura. Los delimitadores matemáticos son caracteres de contorno como paréntesis, corchetes y llaves. El valor predeterminado: '('. |
| void [set_DelimiterShape](./set_delimitershape/)([MathDelimiterShape](../mathdelimitershape/)) override | Especifica la forma de los delimitadores en el objeto delimitador. Cuando es [MathDelimiterShape::Centered](../mathdelimitershape/), los delimitadores se centran alrededor del eje matemático del texto y pueden ajustarse a la altura completa de su contenido. Cuando es [MathDelimiterShape::Match](../mathdelimitershape/), su altura y forma se modifican para coincidir exactamente con su contenido. |
| void [set_EndingCharacter](./set_endingcharacter/)(char16_t) override | El carácter de fin del delimitador especifica el carácter delimitador de cierre. Los delimitadores matemáticos son caracteres de contorno como paréntesis, corchetes y llaves. El valor predeterminado: ')'. |
| void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) override | Especifica el crecimiento de BeginningCharacter, SeparatorCharacter, EndingCharacter. Cuando es true, los delimitadores crecen verticalmente para coincidir con la altura del operando. El valor predeterminado es true |
| void [set_SeparatorCharacter](./set_separatorcharacter/)(char16_t) override | El carácter separador del delimitador especifica el carácter que separa los argumentos en el objeto delimitador. El valor predeterminado: '|'. |
