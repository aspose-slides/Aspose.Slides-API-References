...
description: "El tipo de excepción base para todas las excepciones de interoperabilidad COM y las excepciones de manejo estructurado (SEH). Nunca cree instancias de esta clase manualmente. Use la clase ExternalException en su lugar. Nunca envuelva las instancias de la clase ExternalException en System::SmartPtr."
type: docs
weight: 1
url: /es/system.runtime.interopservices/details_externalexception/
---
## Details_ExternalException clase

El tipo de excepción base para todas las excepciones de interoperabilidad COM y excepciones de manejo estructurado (SEH). Nunca cree instancias de esta clase manualmente. Use la clase ExternalException en su lugar. Nunca envuelva las instancias de la clase ExternalException en [System::SmartPtr](../../system/smartptr/).
...
| virtual **int32_t** [get_ErrorCode](../../system/details_exceptionwitherrorcode/get_errorcode/)() const | Obtiene el HRESULT del error. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Obtiene el tipo real del objeto. Análogo a la llamada [System.Object.GetType()](../../system/object/gettype/) de C#. |
...
* Clase [Details_ExceptionWithErrorCode](../../system/details_exceptionwitherrorcode/)
