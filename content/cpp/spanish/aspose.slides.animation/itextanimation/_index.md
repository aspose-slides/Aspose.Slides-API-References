...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | Agrega un nuevo efecto al final de la secuencia actual hasta el final de las animaciones de texto del grupo. ¡Solo es válido si el recuento de párrafos de texto es igual o mayor que el recuento de efectos de este grupo! |
...
| virtual [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() | Lista del tipo de construcción (por ejemplo [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) de la animación de texto. Leer [BuildType](../buildtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() | Efecto de forma vinculada con grupo o no (null). Leer [IEffect](../ieffect/). |
...
| virtual void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) | Lista del tipo de construcción (por ejemplo [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) de la animación de texto. Escribir [BuildType](../buildtype/). |
| virtual void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) | Efecto de forma vinculada con grupo o no (null). Escribir [IEffect](../ieffect/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la liberación de la instrucción C# lock(). Llámalo directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
