...
| **float** [get_By](./get_by/)() override | Describe el valor de desplazamiento relativo para la animación. Lea **float**. |
| **float** [get_From](./get_from/)() override | Describe el valor inicial para la animación. Lea **float**. |
...
| **float** [get_To](./get_to/)() override | Describe el valor final para la animación. Lea **float**. |
...
| void [set_By](./set_by/)(**float**) override | Describe el valor de desplazamiento relativo para la animación. Escriba **float**. |
| void [set_From](./set_from/)(**float**) override | Describe el valor inicial para la animación. Escriba **float**. |
...
| void [set_To](./set_to/)(**float**) override | Describe el valor final para la animación. Escriba **float**. |
...
* Clase [IRotationEffect](../irotationeffect/)
