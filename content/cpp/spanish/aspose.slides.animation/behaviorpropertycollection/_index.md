...
---
## BehaviorPropertyCollection clase
...
| Método | Descripción |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Agrega una nueva propiedad a la colección. |
| void [Add](./add/)(const [System::String](../../system/string/)\&) override | Agrega una nueva propiedad a la colección. |
...
| void [Clear](./clear/)() override | Elimina todas las propiedades de la colección. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | Determina si [ICollection](../../system.collections.generic/icollection/) contiene un valor específico. |
| **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const override | Determina si [ICollection](../../system.collections.generic/icollection/) contiene un valor específico. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>, **int32_t**) override | Copia los elementos de [ICollection](../../system.collections.generic/icollection/) a un [System::Array](../../system/array/), empezando en un índice [System::Array](../../system/array/) particular. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia todos los elementos de la colección a elementos de matriz existentes. |
...
| **int32_t** [get_Count](./get_count/)() const override | Devuelve el número de propiedades almacenadas en la colección. Solo lectura **int32_t**. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Comprueba si la colección tiene un tamaño fijo. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Obtiene un valor que indica si [ICollection](../../system.collections.generic/icollection/) es solo lectura. Solo lectura **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que itera a través de la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\> [idx_get](./idx_get/)(**int32_t**) const override | Devuelve una propiedad en el índice especificado. |
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Obtiene el elemento en el índice especificado. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>) override | Devuelve una propiedad en el índice especificado. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Establece el elemento en el índice especificado. |
| **int32_t** [IndexOf](./indexof/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | Determina el índice de un elemento específico en [IList](../../system.collections.generic/ilist/). |
| **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const override | Determina el índice de un elemento específico por valor de propiedad en [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Inserta una nueva propiedad en la colección en el índice especificado. |
| void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) override | Inserta una nueva propiedad (con el valor de propiedad especificado) en la colección en el índice especificado. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | Inserta el elemento en la posición especificada, desplazando los demás elementos. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina si existe algún elemento de la secuencia o cumple una condición. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Elimina la propiedad especificada de la colección. |
| **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) override | Elimina la propiedad especificada de la colección. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Elimina la propiedad en el índice especificado. |
...
* Clase [IBehaviorPropertyCollection](../ibehaviorpropertycollection/)
