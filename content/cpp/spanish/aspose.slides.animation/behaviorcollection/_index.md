...
| Method | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Agrega un nuevo comportamiento a una colección. |
| [iterator](./iterator/) [begin](./begin/)() | Obtiene un iterador que apunta al primer elemento (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtiene un iterador que apunta al primer elemento (si lo hay) de la instancia const-qualified de la colección. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtiene un iterador que apunta al primer elemento const-qualified (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtiene un iterador que apunta justo después del último elemento const-qualified (si lo hay) de la colección. |
| void [Clear](./clear/)() override | Elimina todos los comportamientos de una colección. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Determina si el [ICollection](../../system.collections.generic/icollection/) contiene un valor específico. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>, **int32_t**) | Copia los elementos del [ICollection](../../system.collections.generic/icollection/) a un [System::Array](../../system/array/), comenzando en un índice [System::Array](../../system/array/) particular. |
| [iterator](./iterator/) [end](./end/)() | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la instancia const-qualified de la colección. |
...
| **int32_t** [get_Count](./get_count/)() override | Devuelve el número de comportamientos en una colección. Solo lectura **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Obtiene un valor que indica si el [ICollection](../../system.collections.generic/icollection/) es solo lectura. Solo lectura **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que itera a través de la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) override | Devuelve un comportamiento en el índice especificado. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Devuelve un comportamiento en el índice especificado. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Determina el índice de un elemento específico en el [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Inserta un nuevo comportamiento en la colección en el índice especificado. |
...
| void [Lock](../../system/object/lock/)() | Implementa la funcionalidad del enunciado C# `lock()` bloqueando. Llámese directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructor de copia. No copia nada, simplemente inicializa el nuevo objeto y permite la copia de subclases. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de asignación. No copia nada, simplemente inicializa el nuevo objeto y permite la copia de subclases. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Elimina el comportamiento especificado de una colección. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Elimina un comportamiento de una colección en el índice especificado. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el n-ésimo argumento plantilla como puntero débil (en lugar de compartido). Permite cambiar punteros en contenedores a modo débil. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la liberación del enunciado C# `lock()` desbloqueando. Llámese directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtiene un iterador que apunta al primer elemento (si lo hay) de la instancia const-qualified de la colección. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la instancia const-qualified de la colección. |
