...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) override | Devuelve la secuencia interactiva en el índice especificado. Esta secuencia puede contener solo efectos mediante "clic en la forma" con la forma objetivo especificada. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequenceCollection](../isequencecollection/)\> [get_InteractiveSequences](./get_interactivesequences/)() override | Devuelve la colección de secuencias interactivas. Estas secuencias pueden contener solo efectos mediante "clic en la forma" con la forma objetivo especificada. Solo lectura [ISequenceCollection](../isequencecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_MainSequence](./get_mainsequence/)() override | Devuelve la secuencia principal que puede contener solo la colección de efectos principales. Solo lectura [ISequence](../isequence/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) override | Devuelve el efecto de la secuencia principal en el índice especificado. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) override | Devuelve la animación de texto en el índice especificado. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimationCollection](../itextanimationcollection/)\> [get_TextAnimationCollection](./get_textanimationcollection/)() override | Devuelve la colección de animaciones de texto. Solo lectura [ITextAnimationCollection](../itextanimationcollection/). |
...
* Clase [IAnimationTimeLine](../../aspose.slides/ianimationtimeline/)
