...
description: Representa un desplazamiento de color.
type: docs
weight: 222
...
Representa un desplazamiento de color.
...
| virtual **float** [get_Value0](./get_value0/)() | Define el primer valor del desplazamiento. Lee **float**. |
| virtual **float** [get_Value1](./get_value1/)() | Define el segundo valor del desplazamiento. Lee **float**. |
| virtual **float** [get_Value2](./get_value2/)() | Define el tercer valor del desplazamiento. Lee **float**. |
...
| virtual void [set_Value0](./set_value0/)(**float**) | Define el primer valor del desplazamiento. Escribe **float**. |
| virtual void [set_Value1](./set_value1/)(**float**) | Define el segundo valor del desplazamiento. Escribe **float**. |
| virtual void [set_Value2](./set_value2/)(**float**) | Define el tercer valor del desplazamiento. Escribe **float**. |
