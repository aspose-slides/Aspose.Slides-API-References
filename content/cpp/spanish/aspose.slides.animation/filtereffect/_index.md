...
| [FilterEffectRevealType](../filtereffectrevealtype/) [get_Reveal](./get_reveal/)() override | Representa que el efecto con comportamiento debe revelarse (entrada/salida) Lea [FilterEffectRevealType](../filtereffectrevealtype/). |
| [FilterEffectSubtype](../filtereffectsubtype/) [get_Subtype](./get_subtype/)() override | Representa subtipo del efecto de filtro. Lea [FilterEffectSubtype](../filtereffectsubtype/). |
...
| [FilterEffectType](../filtereffecttype/) [get_Type](./get_type/)() override | Representa tipo de efecto de filtro. Lea [FilterEffectType](../filtereffecttype/). |
...
| void [set_Reveal](./set_reveal/)([FilterEffectRevealType](../filtereffectrevealtype/)) override | Representa que el efecto con comportamiento debe revelarse (entrada/salida) Escriba [FilterEffectRevealType](../filtereffectrevealtype/). |
| void [set_Subtype](./set_subtype/)([FilterEffectSubtype](../filtereffectsubtype/)) override | Representa subtipo del efecto de filtro. Escriba [FilterEffectSubtype](../filtereffectsubtype/). |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Representa propiedades de temporización para el comportamiento del efecto. Escriba [ITiming](../itiming/). |
| void [set_Type](./set_type/)([FilterEffectType](../filtereffecttype/)) override | Representa tipo de efecto de filtro. Escriba [FilterEffectType](../filtereffecttype/). |
...
* Clase [IFilterEffect](../ifiltereffect/)
