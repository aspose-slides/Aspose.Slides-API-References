...
| [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() override | Especifica el tipo de comando. Lee [MotionCommandPathType](../motioncommandpathtype/). |
| **bool** [get_IsRelative](./get_isrelative/)() override | Determina si las coordenadas del comando son relativas o no. Lee **bool**. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() override | Especifica los puntos del comando. Lee [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() override | Especifica el tipo de puntos del comando. Lee [MotionPathPointsType](../motionpathpointstype/). |
...
| void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) override | Especifica el tipo de comando. Escribe [MotionCommandPathType](../motioncommandpathtype/). |
| void [set_IsRelative](./set_isrelative/)(**bool**) override | Determina si las coordenadas del comando son relativas o no. Escribe **bool**. |
| void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) override | Especifica los puntos del comando. Escribe [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) override | Especifica el tipo de puntos del comando. Escribe [MotionPathPointsType](../motionpathpointstype/). |
