...
| **float** [get_Value0](./get_value0/)() override | Define el primer valor del desplazamiento. Lee **float**. |
| **float** [get_Value1](./get_value1/)() override | Define el segundo valor del desplazamiento. Lee **float**. |
| **float** [get_Value2](./get_value2/)() override | Define el tercer valor del desplazamiento. Lee **float**. |
...
| void [set_Value0](./set_value0/)(**float**) override | Define el primer valor del desplazamiento. Escritura **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Define el segundo valor del desplazamiento. Escritura **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Define el tercer valor del desplazamiento. Escritura **float**. |
...
* Clase [IColorOffset](../icoloroffset/)
