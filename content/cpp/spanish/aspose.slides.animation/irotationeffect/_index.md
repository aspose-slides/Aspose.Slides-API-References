...
| virtual **float** [get_By](./get_by/)() | Describe el valor de desplazamiento relativo para la animación. Leer **float**. |
| virtual **float** [get_From](./get_from/)() | Describe el valor inicial para la animación. Leer **float**. |
...
| virtual **float** [get_To](./get_to/)() | Describe el valor final para la animación. Leer **float**. |
...
| virtual void [set_By](./set_by/)(**float**) | Describe el valor de desplazamiento relativo para la animación. Escribir **float**. |
| virtual void [set_From](./set_from/)(**float**) | Describe el valor inicial para la animación. Escribir **float**. |
...
| virtual void [set_To](./set_to/)(**float**) | Describe el valor final para la animación. Escribir **float**. |
