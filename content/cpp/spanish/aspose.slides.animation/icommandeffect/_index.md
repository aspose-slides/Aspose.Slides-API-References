...
| virtual [System::String](../../system/string/) [get_CommandString](./get_commandstring/)() | Define la cadena de comando. Leer [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_ShapeTarget](./get_shapetarget/)() | Define el objetivo de forma del efecto de comando. Leer [IShape](../../aspose.slides/ishape/). |
...
| virtual [CommandEffectType](../commandeffecttype/) [get_Type](./get_type/)() | Define el tipo de efecto de comando del comportamiento. Leer [CommandEffectType](../commandeffecttype/). |
...
| virtual void [set_CommandString](./set_commandstring/)([System::String](../../system/string/)) | Define la cadena de comando. Escribir [System::String](../../system/string/). |
| virtual void [set_ShapeTarget](./set_shapetarget/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Define el objetivo de forma del efecto de comando. Escribir [IShape](../../aspose.slides/ishape/). |
...
| virtual void [set_Type](./set_type/)([CommandEffectType](../commandeffecttype/)) | Define el tipo de efecto de comando del comportamiento. Escribir [CommandEffectType](../commandeffecttype/). |
