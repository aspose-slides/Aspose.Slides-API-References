...
type: docs
weight: 1
url: /es/aspose.slides.spreadsheet/details_cellcircularreferenceexception/
---
## Details_CellCircularReferenceException clase


La excepción que se lanza cuando se detectan una o más referencias circulares en las que una fórmula hace referencia a su propia celda ya sea directa o indirectamente.
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Obtiene una referencia circular a una celda. |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Devuelve la cadena que contiene el seguimiento de la pila. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementa el método [what()](../../system/details_exception/what/) que es llamado por la clase [ExceptionWrapper](../../system/exceptionwrapper/). A pesar de que esta clase no hereda de std::exception, las clases derivadas pueden usar miembros protegidos/privados para implementar su lógica. Mover la implementación de este método a [ExceptionWrapper](../../system/exceptionwrapper/) puede romper esa lógica. |
| virtual  [~Object](../../system/object/~object/)() | Destruye el objeto. Libera todas las estructuras internas de datos. |

## Ver también

* Clase [Details_PptxEditException](../../aspose.slides/details_pptxeditexception/)
* Espacio de nombres [Aspose::Slides::Spreadsheet](../)
