...
description: La excepción que se lanza cuando una fórmula calculada no es correcta o no se analizó.
type: docs
weight: 14
url: /es/aspose.slides.spreadsheet/details_cellinvalidformulaexception/
---
## Details_CellInvalidFormulaException clase


La excepción que se lanza cuando una fórmula calculada no es correcta o no se analizó.
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Obtiene una referencia de celda que contiene la fórmula no válida. |
