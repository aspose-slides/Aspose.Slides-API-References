...
description: Puntero a colección de cadenas con operador de acceso.
type: docs
weight: 40
url: /es/system.collections.specialized/stringcollectionptr/
---
## StringCollectionPtr clase


Colección de cadenas puntero con operador de acceso.
...
| int [get_shared_count](../../system/smartptr/get_shared_count/)() const | Obtiene el número de punteros compartidos que existen hacia el objeto referenciado, incluido el actual. Afirma que el puntero actual está en modo compartido. |
...
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | Comprueba si el puntero apunta a un objeto distinto al poseído (creado por un constructor de alias). |
...
| [System::String](../../system/string/)\& [operator[]](./operator[]/)(int) const | Función de acceso. |
...
| void [SetContainedTemplateWeakPtr](../../system/smartptr/setcontainedtemplateweakptr/)(**uint32_t**) const | Llama al método SetTemplateWeakPtr() en el objeto apuntado (si existe). |
...
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<[Array](../../system/array/)\<Y\>\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Convierte el tipo del arreglo referenciado creando un nuevo arreglo de tipo diferente. Es útil si en C# hay un casting de tipo de arreglo que no está soportado en C++. |
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const Y\&) | Inicializa un arreglo vacío. Usado para traducir algunos constructos de código C#. |
...
|  [StringCollectionPtr](./stringcollectionptr/)() | Construye un puntero nulo. |
|  [StringCollectionPtr](./stringcollectionptr/)(const [SharedPtr](../../system/sharedptr/)\<[StringCollection](../stringcollection/)\>\&) | Construye un puntero a una colección específica. |
