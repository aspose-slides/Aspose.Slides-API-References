...
| Método | Descripción |
| --- | --- |
| int [Add](./add/)(const [System::String](../../system/string/)\&) | Añade un valor al final de la lista. |
| void [AddRange](./addrange/)(const [ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>\&) | Añade elementos al contenedor. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Devuelve un iterador al primer elemento const-calificado del contenedor. Si el contenedor está vacío, el iterador devuelto será igual a [cend()](./cend/). |
...
| void [Clear](./clear/)() | Elimina todos los elementos. |
| **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Comprueba si una cadena específica está presente en el contenedor. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>\&, const **int32_t**) const | Copia los elementos a los elementos de una matriz existente. |
...
| std::vector\<[System::String](../../system/string/)\>\& [data](./data/)() | Accesor de la estructura de datos interna. |
| const std::vector\<[System::String](../../system/string/)\>\& [data](./data/)() const | Accesor de la estructura de datos interna. |
...
| int [get_Count](./get_count/)() const | Obtiene el número de elementos en la colección. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Obtiene el enumerador que itera a través de la colección actual. |
...
| [System::String](../../system/string/) [idx_get](./idx_get/)(int) const | Obtiene el valor en la posición especificada. |
| void [idx_set](./idx_set/)(int, const [System::String](../../system/string/)\&) | Establece el valor en la posición especificada. |
| int [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Busca una cadena específica en el contenedor. |
| void [Insert](./insert/)(int, const [System::String](../../system/string/)\&) | Inserta un valor específico en el contenedor. |
...
| [System::String](../../system/string/)\& [operator[]](./operator[]/)(int) | Función de acceso. |
...
| void [Remove](./remove/)(const [System::String](../../system/string/)\&) | Elimina la primera aparición de la cadena especificada. |
