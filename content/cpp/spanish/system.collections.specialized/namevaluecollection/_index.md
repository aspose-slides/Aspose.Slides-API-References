...
description: Colección de claves String asociadas y valores String que pueden accederse tanto con la clave como con el índice.
type: docs
weight: 14
url: /es/system.collections.specialized/namevaluecollection/
---
## NameValueCollection clase

Colección de [String](../../system/string/) claves y [String](../../system/string/) valores asociados que pueden accederse tanto con la clave como con el índice.
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&) override | Sobrescribe el método [ICollection](../../system.collections/icollection/) - no implementado. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | Copia las entradas del [NameValueCollection](./) especificado a la actual. |
| virtual void [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Añade una entrada con el nombre y valor especificados. |
...
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) const override | Comprueba si el elemento está presente en la colección. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\>, **int32_t**) override | Copia los elementos de la colección en elementos de una matriz existente. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia todos los elementos de la colección en elementos de una matriz existente. |
...
| virtual [String](../../system/string/) [Get](./get/)(const [String](../../system/string/)\&) | Obtiene los valores asociados a la clave especificada. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [get_AllKeys](./get_allkeys/)() | Obtiene todas las claves. |
| int [get_Count](./get_count/)() const override | Obtiene el número de pares clave/valor. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[String](../../system/string/)\>\> [get_Keys](./get_keys/)() | Obtiene todas las claves. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Obtiene un enumerador para iterar a través de la colección. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [GetValues](./getvalues/)(const [String](../../system/string/)\&) | Obtiene los valores asociados a la clave especificada. |
| **bool** [HasKeys](./haskeys/)() | Obtiene un valor que indica si [NameValueCollection](./) contiene claves que no son nulas. |
...
| [String](../../system/string/) [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Obtiene el valor en el índice especificado. |
| void [idx_set](./idx_set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Establece el valor de una entrada. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Calcula el promedio de una secuencia de valores obtenidos mediante la invocación de una función de transformación en cada elemento de la secuencia de entrada. |
...
| [NameValueCollection](./namevaluecollection/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | Copia las entradas del [NameValueCollection](./) especificado a un nuevo [NameValueCollection](./). |
...
| **bool** [Remove](./remove/)(const [String](../../system/string/)\&) override | Elimina un elemento específico. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencia compartida por el valor especificado. |
| virtual void [Set](./set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Establece el valor de una entrada. |
...
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtiene la implementación del iterador const begin para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Obtiene la implementación del iterador begin para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtiene la implementación del iterador const end para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtiene la implementación del iterador end para el contenedor actual. |
