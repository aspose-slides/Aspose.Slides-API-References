...
| void [CopyTo](../../system.collections.generic/idictionary/copyto/)([ArrayPtr](../../system/arrayptr/)\<[KeyValuePair](../../system.collections.generic/keyvaluepair/)\<TKey, TValue\>\>, int) override | Copia el contenido del diccionario en los elementos de un arreglo existente. |
...
|  [Dictionary](../../system.collections.generic/dictionary/dictionary/)(int) | Sobrecarga que corresponde a crear un diccionario preasignado; en realidad no realiza asignación. |
...
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey\&) const | Devuelve el valor si se encuentra; o **Value()** en caso contrario. |
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey\&, const TValue\&) const | Devuelve el valor si se encuentra; o **defaultValue** en caso contrario. |
| virtual TValue [GetValueOrNull](../../system.collections.generic/idictionary/getvalueornull/)(const TKey\&) const | Devuelve el valor si se encuentra; o **null** en caso contrario, tiene sentido solo para tipos de referencia. |
...
| [String](../../system/string/) [idx_get](./idx_get/)(const [String](../../system/string/)\&) const override | Obtiene el valor con una clave específica. |
