...
description: Representa un objeto que maneja el trabajo de bajo nivel de encolar tareas en hilos.
type: docs
weight: 79
url: /es/system.threading.tasks/taskscheduler/
---
## TaskScheduler clase
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | Crea un [TaskScheduler](./) asociado con el hilo actual. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | Obtiene el [TaskScheduler](./) asociado con la tarea que se está ejecutando actualmente. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | Obtiene la instancia predeterminada de [TaskScheduler](./) que proporciona el framework. |
| **int32_t** [get_Id](./get_id/)() const | Obtiene el ID único para este [TaskScheduler](./). |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | Indica el nivel máximo de concurrencia que este [TaskScheduler](./) puede soportar. |
