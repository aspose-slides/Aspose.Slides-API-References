...
description: Proporciona el estado de finalización de un bucle paralelo.
type: docs
weight: 14
url: /es/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult clase

Proporciona el estado de finalización de un bucle [Parallel](../parallel/).
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Obtiene si el bucle se ejecutó hasta completarse. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Obtiene el índice de iteración más bajo en el que se produjo un break. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Construye un [ParallelLoopResult](./). |
...
Representa el resultado de una operación de bucle paralelo, incluyendo si se completó y la información sobre interrupciones.
