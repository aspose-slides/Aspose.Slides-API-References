...
description: Representa un tipo híbrido similar a una tarea que puede envolver ya sea un valor de resultado directo o un ResultTask<T>.
type: docs
weight: 53
url: /es/system.threading.tasks/resultvaluetask/
---
## ResultValueTask clase


Representa un tipo híbrido similar a una tarea que puede envolver ya sea un valor de resultado directo o un ResultTask<T>.
...
[ResultValueTask](./) combina los beneficios de [ValueTask](../valuetask/) (reducción de asignaciones para resultados sincrónicos) con la capacidad de envolver objetos ResultTask<T> existentes. Proporciona una interfaz awaitable y varios métodos de inspección del estado de la tarea. 
## Ver también
