...
| void [Dispose](./dispose/)(**bool**) override | No hace nada. |
...
| int [Peek](./peek/)() override | Lee un solo carácter del flujo sin cambiar la posición del flujo. |
| int [Read](./read/)() override | Lee un solo carácter del flujo. |
| int [Read](./read/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) override | Lee la cantidad especificada de caracteres del flujo al arreglo de caracteres especificado comenzando en la posición indicada. |
| virtual int [ReadBlock](../textreader/readblock/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) | Lee el número máximo especificado de caracteres del lector de texto actual y escribe los datos en un búfer, comenzando en el índice indicado. |
...
|  [StringReader](./stringreader/)(const [String](../../system/string/)\&) | Construye una nueva instancia de la clase [StringReader](./) que lee caracteres de la cadena especificada. |
