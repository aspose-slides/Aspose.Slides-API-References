...
description: "La clase base de excepción es lanzada por las clases HttpClient y HttpMessageHandler. Nunca cree instancias de esta clase manualmente. Use la clase HttpRequestException en su lugar. Nunca envuelva las instancias de la clase HttpRequestException en System::SmartPtr."
type: docs
weight: 14
url: /es/system.net.http/details_httprequestexception/
---
## Details_HttpRequestException clase

La clase base de excepción es lanzada por las clases [HttpClient](../httpclient/) y [HttpMessageHandler](../httpmessagehandler/). Nunca cree instancias de esta clase manualmente. Use la clase HttpRequestException en su lugar. Nunca envuelva las instancias de la clase HttpRequestException en [System::SmartPtr](../../system/smartptr/).
...
| Método | Descripción |
| --- | --- |
|  [Details_HttpRequestException](./details_httprequestexception/)() | Construye una nueva instancia. |
|  [Details_HttpRequestException](./details_httprequestexception/)(std::nullptr_t) | Construye una nueva instancia. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/)) | Construye una nueva instancia. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Construye una nueva instancia. |
| virtual void [DoThrow](../../system/details_exception/dothrow/)(const [ExceptionPtr](../../system/exceptionptr/)\&) const | Lanza la instancia de excepción envuelta por el envoltorio de excepción. |
...
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Devuelve la cadena que contiene el rastreo de la pila. |
...
* Clase [Details_Exception](../../system/details_exception/)
