...
type: docs
weight: 1
url: /es/system.net.http/bytearraycontent/
---
## ByteArrayContent clase

Representa contenido HTTP como una matriz de bytes. Objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento.
...
| Method | Description |
| --- | --- |
|  [ByteArrayContent](./bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Construye una nueva instancia. |
|  [ByteArrayContent](./bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | Construye una nueva instancia. |
...
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)() | Serializa el contenido en un búfer de memoria. |
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)(**int64_t**) | Serializa el contenido en un búfer de memoria. |
...
| **bool** [TryComputeLength](./trycomputelength/)(**int64_t**\&) override | Intenta calcular la longitud de la matriz de bytes. |
