...
description: Contiene los métodos utilitarios.
type: docs
weight: 131
url: /es/system.net.http/httputilities/
---
## HttpUtilities clase

Contiene los métodos utilitarios.
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Comprueba si el URI especificado es el URI HTTP. |
...
| Campo | Descripción |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | La versión HTTP predeterminada para enviar solicitudes. |
| static [DefaultResponseVersion](./defaultresponseversion/) | La versión HTTP predeterminada para recibir respuestas. |
