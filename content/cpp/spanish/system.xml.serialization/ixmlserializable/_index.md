...
description: "Proporciona formato personalizado para la serialización y deserialización XML. Los objetos de esta clase solo deben asignarse mediante la función System::MakeObject(). Nunca cree instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use este puntero para pasarlo a funciones como argumento."
type: docs
weight: 1
url: /es/system.xml.serialization/ixmlserializable/
---
## Clase IXmlSerializable
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchema](../../system.xml.schema/xmlschema/)\> [GetSchema](./getschema/)() | Un objeto XmlSchema que describe la representación XML del objeto que es devuelto por el método [WriteXml()](./writexml/) y aceptado por el método [ReadXml()](./readxml/). |
...
| virtual void [ReadXml](./readxml/)([System::SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlReader](../../system.xml/xmlreader/)\>) | Deserializa el objeto a partir de su representación XML. |
...
| virtual void [WriteXml](./writexml/)([System::SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlWriter](../../system.xml/xmlwriter/)\>) | Serializa el objeto actual a su representación XML. |
