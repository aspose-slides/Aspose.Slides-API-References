...
description: Representa un efecto de Matiz/Saturación/Luminancia. El matiz, la saturación y la luminancia pueden ajustarse cada uno en relación con su valor actual.
type: docs
weight: 703
url: /es/aspose.slides.effects/ihsleffectivedata/
---
## IHSLEffectiveData clase


Representa un efecto de Matiz/Saturación/Luminancia. El matiz, la saturación y la luminancia pueden ajustarse cada uno en relación con su valor actual.
...
| virtual **float** [get_Hue](./get_hue/)() | Devuelve el porcentaje de matiz. Sólo lectura **float**. |
| virtual **float** [get_Luminance](./get_luminance/)() | Devuelve el porcentaje de luminancia. Sólo lectura **float**. |
| virtual **float** [get_Saturation](./get_saturation/)() | Devuelve el porcentaje de saturación. Sólo lectura **float**. |
