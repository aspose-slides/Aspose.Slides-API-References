...
description: Objeto inmutable que representa un efecto Alpha Modulate. Los valores alfa (opacidad) del efecto se multiplican por un porcentaje fijo. El contenedor de efecto especifica un efecto que contiene valores alfa para modular.
type: docs
weight: 352
url: /es/aspose.slides.effects/ialphamodulateeffectivedata/
---
## IAlphaModulateEffectiveData clase


Objeto inmutable que representa un efecto Alpha Modulate. Los valores alfa (opacidad) del efecto se multiplican por un porcentaje fijo. El contenedor de efecto especifica un efecto que contiene valores alfa para modular.
