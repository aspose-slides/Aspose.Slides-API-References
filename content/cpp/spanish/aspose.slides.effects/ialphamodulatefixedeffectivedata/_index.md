...
description: Objeto inmutable que representa un efecto Alpha Modulate Fixed. Los valores alfa del efecto (opacidad) se multiplican por un porcentaje fijo.
type: docs
weight: 378
url: /es/aspose.slides.effects/ialphamodulatefixedeffectivedata/
---
## IAlphaModulateFixedEffectiveData clase


Objeto inmutable que representa un efecto Alpha Modulate Fixed. Los valores de alfa del efecto (opacidad) se multiplican por un porcentaje fijo.
...
| virtual **float** [get_Amount](./get_amount/)() | Devuelve una cantidad del efecto en porcentajes. **float** de solo lectura. |
