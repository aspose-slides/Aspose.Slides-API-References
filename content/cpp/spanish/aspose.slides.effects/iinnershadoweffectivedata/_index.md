...
```cpp
class IInnerShadowEffectiveData : public virtual Aspose::Slides::Effects::IEffectEffectiveData
```
...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) radio. Solo de lectura **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Dirección de la sombra. Solo de lectura **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Distancia de la sombra. Solo de lectura **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Color de la sombra. Solo de lectura [System::Drawing::Color](../../system.drawing/color/). |
