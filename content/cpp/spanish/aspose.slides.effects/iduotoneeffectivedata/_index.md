...
description: Objeto inmutable que representa un efecto Duotone. Para cada píxel, combina clr1 y clr2 mediante una interpolación lineal para determinar el nuevo color de ese píxel.
type: docs
weight: 573
url: /es/aspose.slides.effects/iduotoneeffectivedata/
---
## IDuotoneEffectiveData clase

Objeto inmutable que representa un efecto [Duotone](../duotone/). Para cada píxel, combina clr1 y clr2 mediante una interpolación lineal para determinar el nuevo color de ese píxel.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color1](./get_color1/)() | Devuelve el formato de color objetivo para píxeles oscuros. Solo lectura [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color2](./get_color2/)() | Devuelve el formato de color objetivo para píxeles claros. Solo lectura [System::Drawing::Color](../../system.drawing/color/). |
