...
description: Objeto inmutable que representa un efecto Alpha Floor. Los valores Alpha (opacidad) menores al 100% se cambian a cero. En otras palabras, cualquier cosa parcialmente transparente se vuelve totalmente transparente.
type: docs
weight: 300
url: /es/aspose.slides.effects/ialphaflooreffectivedata/
---
## IAlphaFloorEffectiveData clase


Objeto inmutable que representa un efecto Alpha Floor. Los valores Alpha (opacidad) menores al 100% se cambian a cero. En otras palabras, cualquier cosa parcialmente transparente se vuelve completamente transparente.
