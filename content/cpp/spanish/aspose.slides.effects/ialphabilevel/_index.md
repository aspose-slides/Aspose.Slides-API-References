...
| virtual **float** [get_Threshold](./get_threshold/)() | Devuelve el umbral del efecto. Lectura **float**. |
...
| virtual void [set_Threshold](./set_threshold/)(**float**) | Devuelve el umbral del efecto. Escritura **float**. |
...
Utilice [ImageTransformOperationFactory](../imagetransformoperationfactory/) para crear instancias en COM. 
