...
description: Representa un efecto Alpha Ceiling. Los valores Alpha (opacidad) mayores que cero se cambian al 100%. En otras palabras, cualquier cosa parcialmente opaca se vuelve completamente opaca.
type: docs
weight: 14
...
| Método | Descripción |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina si el [AlphaCeiling](./) especificado es igual al [AlphaCeiling](./) actual. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeilingEffectiveData](../ialphaceilingeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtiene los datos efectivos del efecto Alpha Ceiling con la herencia aplicada. |
...
* Clase [IAlphaCeiling](../ialphaceiling/)
