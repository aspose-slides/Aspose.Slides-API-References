...
description: Representa un efecto Alpha Replace. Los valores alfa (opacidad) del efecto se reemplazan por un alfa fijo.
type: docs
weight: 79
...
| Método | Descripción |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina si el [AlphaReplace](./) especificado es igual al [AlphaReplace](./) actual. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplaceEffectiveData](../ialphareplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtiene los datos del efecto Alpha Replace efectivo con la herencia aplicada. |
...
* Clase [IAlphaReplace](../ialphareplace/)
