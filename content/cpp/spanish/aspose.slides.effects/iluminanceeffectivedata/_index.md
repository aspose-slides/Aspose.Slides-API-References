...
---
## ILuminanceEffectiveData clase

Representa un [Luminance](../luminance/) efecto. El brillo desplaza linealmente todos los colores más cerca del blanco o del negro. El contraste escala todos los colores para que estén más cercanos o más separados.
...
| virtual **float** [get_Brightness](./get_brightness/)() | Brillo. Solo lectura **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Contraste. Solo lectura **float**. |
