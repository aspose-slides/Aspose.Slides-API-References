...
description: Representa un efecto Alpha Modulate Fixed. Los valores alfa (opacidad) del efecto se multiplican por un porcentaje fijo.
type: docs
weight: 365
url: /es/aspose.slides.effects/ialphamodulatefixed/
---
## IAlphaModulateFixed clase

Representa un efecto Alpha Modulate Fixed. Los valores de alfa (opacidad) del efecto se multiplican por un porcentaje fijo.
...
| virtual **float** [get_Amount](./get_amount/)() | Devuelve una cantidad del efecto en porcentajes. Lectura **float**. |
...
| virtual void [set_Amount](./set_amount/)(**float**) | Devuelve una cantidad del efecto en porcentajes. Escritura **float**. |
