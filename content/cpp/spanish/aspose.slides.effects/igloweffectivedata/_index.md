...
description: Objeto inmutable que representa un efecto Glow, en el que se agrega un contorno borroso de color fuera de los bordes del objeto.
type: docs
weight: 651
url: /es/aspose.slides.effects/igloweffectivedata/
---
## IGlowEffectiveData clase

Objeto inmutable que representa un efecto [Glow](../glow/), en el que se agrega un contorno borroso de color fuera de los bordes del objeto.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Color. Sólo lectura [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_Radius](./get_radius/)() | Radio. Sólo lectura **double**. |
