...
type: docs
weight: 911
url: /es/aspose.slides.effects/ippresetshadow/
---
## IPresetShadow clase
...
| virtual **float** [get_Direction](./get_direction/)() | Dirección de la sombra. Lectura **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Distancia de la sombra. Lectura **double**. |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | Preajuste. Lectura [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Color de la sombra. Solo lectura [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógico del método [Object.GetHashCode()](../../system/object/gethashcode/) de C#. Permite hash de objetos personalizados. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtiene el tipo real del objeto. Analógico de la llamada [System.Object.GetType()](../../system/object/gettype/) de C#. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Comprueba si el objeto representa una instancia del tipo descrito por targetType. Analógico del operador 'is' de C#. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analógico del método [Object.MemberwiseClone()](../../system/object/memberwiseclone/) de C#. Permite clonar tipos personalizados. |
...
| virtual void [set_Direction](./set_direction/)(**float**) | Dirección de la sombra. Escritura **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Distancia de la sombra. Escritura **double**. |
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | Preajuste. Escritura [PresetShadowType](../../aspose.slides/presetshadowtype/). |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analógico del método [Object.ToString()](../../system/object/tostring/) de C#. Permite convertir objetos personalizados a cadena. |
