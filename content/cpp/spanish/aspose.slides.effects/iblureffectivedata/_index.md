...
description: Objeto inmutable que representa un efecto de desenfoque aplicado a toda la forma, incluido su relleno. Todos los canales de color, incluido el alfa, se ven afectados.
type: docs
weight: 469
url: /es/aspose.slides.effects/iblureffectivedata/
---
## IBlurEffectiveData clase


Objeto inmutable que representa un efecto [Blur](../blur/) que se aplica a toda la forma, incluido su relleno. Todos los canales de color, incluido el alfa, se ven afectados.
...
| virtual **bool** [get_Grow](./get_grow/)() | Determina si los límites del objeto deben ampliarse como resultado del difuminado. True indica que los límites se amplían mientras que false indica que no lo hacen. Solo lectura **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Devuelve el radio del difuminado. Solo lectura **double**. |
