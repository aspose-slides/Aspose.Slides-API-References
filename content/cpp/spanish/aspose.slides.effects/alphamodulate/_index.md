...
description: Representa un efecto Alpha Modulate. Los valores alfa (opacidad) del efecto se multiplican por un porcentaje fijo. El contenedor de efectos especifica un efecto que contiene valores alfa para modular.
type: docs
weight: 53
...
Representa un efecto Alpha Modulate. Los valores de alfa (opacidad) del efecto se multiplican por un porcentaje fijo. El contenedor de efecto especifica un efecto que contiene valores alfa para modular.
...
| Método | Descripción |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina si el [AlphaModulate](./) especificado es igual al [AlphaModulate](./) actual. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateEffectiveData](../ialphamodulateeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtiene los datos efectivos del efecto Alpha Modulate con la herencia aplicada. |
