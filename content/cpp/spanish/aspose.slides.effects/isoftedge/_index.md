...
| virtual **double** [get_Radius](./get_radius/)() | Especifica el radio del desenfoque a aplicar a los bordes. Lectura **double**. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Especifica el radio del desenfoque a aplicar a los bordes. Escritura **double**. |
