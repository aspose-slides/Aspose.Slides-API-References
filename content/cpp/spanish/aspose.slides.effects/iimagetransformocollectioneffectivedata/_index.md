...
---
## IImageTransformOCollectionEffectiveData clase
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo al método [Object.GetHashCode()](../../system/object/gethashcode/) de C#. Permite calcular el hash de objetos personalizados. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve el elemento por índice. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Devuelve el primer elemento de la secuencia que satisface una condición o un valor predeterminado si no se encuentra dicho elemento. |
...
El nombre IImageTransformOperationCollectionEffectiveData se truncó a [IImageTransformOCollectionEffectiveData](./) debido a que la longitud de los nombres COM no puede ser mayor que 39. 
