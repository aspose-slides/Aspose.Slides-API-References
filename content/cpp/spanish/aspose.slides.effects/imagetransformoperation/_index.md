...
description: Representa un efecto abstracto de transformación de imagen.
type: docs
weight: 833
...
| void [Lock](../../system/object/lock/)() | Implementa la instrucción lock() de C#. Llámalo directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la instrucción lock() de C# para desbloquear. Llámalo directamente o usa el objeto centinela [LockContext](../../system/lockcontext/). |
