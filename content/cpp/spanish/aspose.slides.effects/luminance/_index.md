...
description: Representa un efecto de Luminance. El brillo desplaza linealmente todos los colores más cerca del blanco o del negro. El contraste escala todos los colores para que estén más cerca o más separados.
type: docs
weight: 1028
...
| Método | Descripción |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina si el [Luminance](./) especificado es igual al [Luminance](./) actual. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminanceEffectiveData](../iluminanceeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtiene los datos de efecto [Luminance](./) efectivos con la herencia aplicada. |
