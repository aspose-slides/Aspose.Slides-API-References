...
description: Objeto inmutable que representa un efecto de sombra externa.
type: docs
weight: 898
...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) radio. Solo lectura **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Dirección de la sombra. Solo lectura **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Distancia de la sombra. Solo lectura **double**. |
| virtual [RectangleAlignment](../../aspose.slides/rectanglealignment/) [get_RectangleAlign](./get_rectanglealign/)() | Alineación del rectángulo. Solo lectura [RectangleAlignment](../../aspose.slides/rectanglealignment/). |
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | Especifica si la sombra debe rotar con la forma cuando la forma se gira. Solo lectura **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | Especifica el factor de escalado horizontal, un escalado negativo provoca una inversión. Solo lectura **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | Especifica el factor de escalado vertical, un escalado negativo provoca una inversión. Solo lectura **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Color de la sombra. Solo lectura [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | Especifica el ángulo de sesgo horizontal (en grados). Solo lectura **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | Especifica el ángulo de sesgo vertical (en grados). Solo lectura **double**. |
