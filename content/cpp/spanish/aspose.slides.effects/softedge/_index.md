...
| Método | Descripción |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina si el [SoftEdge](./) especificado es igual al [SoftEdge](./) actual. |
...
| **double** [get_Radius](./get_radius/)() override | Especifica el radio del desenfoque a aplicar en los bordes. Solo lectura **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtiene los datos efectivos del efecto Soft Edge con la herencia aplicada. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Sirve como función hash para un tipo particular. |
...
| void [set_Radius](./set_radius/)(**double**) override | Especifica el radio del desenfoque a aplicar en los bordes. Escribe **double**. |
