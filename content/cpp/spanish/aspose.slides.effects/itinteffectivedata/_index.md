...
description: Objeto inmutable que representa un efecto Tint. Desplaza los valores de color del efecto hacia o alejándose del matiz en la cantidad especificada.
type: docs
weight: 1002
url: /es/aspose.slides.effects/itinteffectivedata/
---
## ITintEffectiveData clase

Objeto inmutable que representa un efecto [Tint](../tint/). Desplaza los valores de color del efecto hacia o alejándose del matiz en la cantidad especificada.
...
| virtual **float** [get_Amount](./get_amount/)() | Devuelve la cantidad del efecto. Solo lectura **float**. |
| virtual **float** [get_Hue](./get_hue/)() | Devuelve el matiz. Solo lectura **float**. |
