...
description: Representa un efecto de sustitución de color. Todos los colores del efecto se cambian a un color fijo. Los valores alfa no se ven afectados.
type: docs
weight: 144
...
Representa un efecto de sustitución de color. Todos los colores del efecto se cambian a un color fijo. Los valores alfa no se ven afectados.
...
| Método | Descripción |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina si el [ColorReplace](./) especificado es igual al [ColorReplace](./) actual. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | Devuelve el formato de color que reemplazará el color de cada píxel. Solo lectura [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplaceEffectiveData](../icolorreplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtiene los datos efectivos del efecto de sustitución de color con la herencia aplicada. |
...
* Clase [IColorReplace](../icolorreplace/)
