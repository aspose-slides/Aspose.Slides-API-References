...
description: Objeto inmutable que representa un efecto Alpha Replace. Los valores alfa (opacidad) del efecto se sustituyen por un alfa fijo.
type: docs
weight: 404
url: /es/aspose.slides.effects/ialphareplaceeffectivedata/
---
## IAlphaReplaceEffectiveData clase

Objeto inmutable que representa un efecto Alpha Replace. Los valores de alfa (opacidad) del efecto son sustituidos por un alfa fijo.
...
| virtual **float** [get_Alpha](./get_alpha/)() | Devuelve el nuevo valor alfa en el intervalo [0..1] Solo lectura **float**. |
