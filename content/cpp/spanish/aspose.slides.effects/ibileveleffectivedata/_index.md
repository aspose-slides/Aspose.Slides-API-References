...
description: Objeto inmutable que representa un efecto Bi-Level (blanco/negro). Los colores de entrada cuya luminancia es menor que el valor de umbral especificado se cambian a negro. Los colores de entrada cuya luminancia es mayor o igual al valor especificado se establecen a blanco. Los valores de efecto alfa no se ven afectados por este efecto.
type: docs
weight: 443
url: /es/aspose.slides.effects/ibileveleffectivedata/
---
## IBiLevelEffectiveData clase
...
| virtual **float** [get_Threshold](./get_threshold/)() | Devuelve el valor del umbral. **float** de solo lectura. |
