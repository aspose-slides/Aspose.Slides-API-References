...
description: Objeto inmutable que representa un efecto Alpha Inverse. Los valores Alpha (opacidad) se invierten restándolos de 100%.
type: docs
weight: 326
url: /es/aspose.slides.effects/ialphainverseeffectivedata/
---
## IAlphaInverseEffectiveData clase
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el n-ésimo argumento plantilla como puntero débil (en lugar de compartido). Permite cambiar los punteros en contenedores al modo débil. |
...
| virtual  [~Object](../../system/object/~object/)() | Destroya el objeto. Libera todas las estructuras de datos internas. |
