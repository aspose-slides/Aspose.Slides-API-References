...
| virtual **float** [get_Direction](./get_direction/)() | Dirección de la sombra. Lee **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Distancia de la sombra. Lee **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Color de la sombra. Sólo lectura [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual void [set_Direction](./set_direction/)(**float**) | Dirección de la sombra. Escribe **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Distancia de la sombra. Escribe **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Obtiene el n-ésimo argumento de plantilla como un puntero débil (en lugar de compartido). Permite cambiar los punteros en contenedores al modo débil. |
