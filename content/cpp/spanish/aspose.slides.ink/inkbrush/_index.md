...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Obtiene el color del pincel para una línea. |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | Obtiene el tipo de efecto de tinta (p.ej., Galaxy, Gold, Silver) que define el estilo visual del trazo de tinta. El valor se analiza a partir de la propiedad del pincel "inkEffects". Si no se especifica un efecto reconocido, se devuelve [InkEffectType::NotDefined](../inkeffecttype/). |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Obtiene el tamaño del pincel para una línea en puntos. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Establece el color del pincel para una línea. |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | Establece el tamaño del pincel para una línea en puntos. |
