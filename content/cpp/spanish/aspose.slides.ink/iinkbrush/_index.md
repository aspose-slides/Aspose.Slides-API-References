...
description: Representa una brocha de trazo.
type: docs
weight: 27
...
Representa una brocha de trazo.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Obtiene el color de la brocha para una línea. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | Obtiene el tipo de efecto de tinta (p. ej., Galaxy, Gold, Silver) que define el estilo visual del trazo de tinta. El valor se analiza a partir de la propiedad de la brocha "inkEffects". Si no se especifica ningún efecto reconocido, se devuelve [InkEffectType::NotDefined](../inkeffecttype/). |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Obtiene el tamaño de la brocha para una línea en puntos. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Establece el color de la brocha para una línea. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Establece el tamaño de la brocha para una línea en puntos. |
