...
| virtual [Aspose::Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/) [get_BlackWhiteMode](../../aspose.slides/ishape/get_blackwhitemode/)() | La propiedad especifica cómo se representará una forma en modo de visualización en blanco y negro. Lea [Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/). |
| virtual **int32_t** [get_ConnectionSiteCount](../../aspose.slides/ishape/get_connectionsitecount/)() | Devuelve el número de sitios de conexión en la forma. Solo lectura **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../../aspose.slides/ihyperlink/)\> [get_HyperlinkClick](../../aspose.slides/ihyperlinkcontainer/get_hyperlinkclick/)() | Devuelve el hipervínculo definido para el clic del ratón. Lea [IHyperlink](../../aspose.slides/ihyperlink/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../../aspose.slides/ihyperlink/)\> [get_HyperlinkMouseOver](../../aspose.slides/ihyperlinkcontainer/get_hyperlinkmouseover/)() | Devuelve el hipervínculo definido para pasar el ratón sobre él. Lea [IHyperlink](../../aspose.slides/ihyperlink/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../../aspose.slides/ishapeframe/)\> [get_RawFrame](../../aspose.slides/ishape/get_rawframe/)() | Devuelve las propiedades crudas del marco de la forma. Lea [IShapeFrame](../../aspose.slides/ishapeframe/). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IInkTrace](../iinktrace/)\>\> [get_Traces](./get_traces/)() | Obtiene todos los trazos contenidos en el elemento [IInk](./) [IInkTrace](../iinktrace/). Solo lectura. |
| virtual **uint32_t** [get_UniqueId](../../aspose.slides/ishape/get_uniqueid/)() | Devuelve un identificador interno de alcance de presentación destinado al uso de complementos u otro código. Dado que este valor puede ser reasignado por el usuario o programáticamente, no debe tratarse como una clave única persistente. Solo lectura **uint32_t**. Ver también [IShape::get_OfficeInteropShapeId](../../aspose.slides/ishape/get_officeinteropshapeid/). |
...
| virtual **int32_t** [get_ZOrderPosition](../../aspose.slides/ishape/get_zorderposition/)() | Devuelve la posición de una forma en el orden Z. Shapes[0] devuelve la forma más atrás en el orden Z, y Shapes[Shapes.Count - 1] devuelve la forma más al frente. Solo lectura **int32_t**. |
...
| void [Lock](../../system/object/lock/)() | Implementa la sentencia C# lock() bloqueando. Llamar directamente o usar el objeto centinela [LockContext](../../system/lockcontext/). |
...
| virtual void [set_BlackWhiteMode](../../aspose.slides/ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/)) | La propiedad especifica cómo se representará una forma en modo de visualización en blanco y negro. Escritura [Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/). |
...
| virtual void [set_HyperlinkClick](../../aspose.slides/ihyperlinkcontainer/set_hyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../../aspose.slides/ihyperlink/)\>) | Establece el hipervínculo definido para el clic del ratón. Escritura [IHyperlink](../../aspose.slides/ihyperlink/). |
| virtual void [set_HyperlinkMouseOver](../../aspose.slides/ihyperlinkcontainer/set_hyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../../aspose.slides/ihyperlink/)\>) | Establece el hipervínculo definido para pasar el ratón sobre él. Escritura [IHyperlink](../../aspose.slides/ihyperlink/). |
...
| virtual void [set_RawFrame](../../aspose.slides/ishape/set_rawframe/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../../aspose.slides/ishapeframe/)\>) | Establece las propiedades crudas del marco de la forma. Escritura [IShapeFrame](../../aspose.slides/ishapeframe/). |
| virtual void [set_Rotation](../../aspose.slides/ishape/set_rotation/)(**float**) | Establece el número de grados que la forma especificada está rotada alrededor del eje z. Un valor positivo indica rotación horario; un valor negativo indica rotación antihorario. Escritura **float**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la sentencia C# lock() desbloqueando. Llamar directamente o usar el objeto centinela [LockContext](../../system/lockcontext/). |
