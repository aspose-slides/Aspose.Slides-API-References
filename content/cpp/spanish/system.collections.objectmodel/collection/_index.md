...
| Método | Descripción |
| --- | --- |
| void [Add](./add/)(const T\&) override | Agrega un valor al contenedor. |
...
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copia los elementos de la colección en elementos de una matriz existente. |
| [const_reverse_iterator](./const_reverse_iterator/) [crbegin](./crbegin/)() const | Obtiene un iterador inverso al último elemento calificado como const de la colección (el primero en reversa). |
...
| int [get_Count](./get_count/)() const override | Obtiene el número de elementos. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](./get_items/)() | Accesor a la estructura de datos interna. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](./get_items/)() const | Accesor a la estructura de datos interna. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../../system.collections.generic/icollection/get_syncroot/)() const | Obtiene el objeto a través del cual se está sincronizando la colección. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Obtiene un enumerador para iterar a través de la colección. |
...
| T [idx_get](./idx_get/)(int) const override | Obtiene el valor en el índice especificado. |
| void [idx_set](./idx_set/)(int, T) override | Establece el valor en el índice especificado. |
| int [IndexOf](./indexof/)(const T\&) const override | Busca un elemento en la colección. |
...
| T\& [operator[]](./operator[]/)(int) | Obtiene el valor en el índice especificado. |
| const T\& [operator[]](./operator[]/)(int) const | Obtiene el valor en el índice especificado. |
...
| [const_reverse_iterator](./const_reverse_iterator/) [rbegin](./rbegin/)() const | Obtiene un iterador inverso al último elemento de la colección calificada como const (el primero en reversa). |
...
| **bool** [Remove](./remove/)(const T\&) override | Elimina un elemento específico. |
| void [RemoveAt](./removeat/)(int) override | Elimina el elemento en una posición específica. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Hace que los punteros almacenados sean débiles (si corresponde). |
