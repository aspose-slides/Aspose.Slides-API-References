...
| Método | Descripción |
| --- | --- |
| void [Add](./add/)(const TItem\&) override | Añade elemento al final del contenedor. |
...
| void [Clear](../collection/clear/)() override | Elimina todos los elementos. |
| [Collection](../collection/collection/)() | Crea una colección vacía. |
| [Collection](../collection/collection/)([SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) |  |
| **bool** [Contains](./contains/)(TKey) | Comprueba si la clave está presente en el contenedor. |
| **bool** [Contains](../collection/contains/)(const T\&) const override | Comprueba si el elemento está presente en la colección. |
| void [CopyTo](../collection/copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copia los elementos de la colección en elementos de un arreglo existente. |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [crbegin](../collection/crbegin/)() const | Obtiene un iterador inverso al último elemento calificado como const de la colección (el primero en reversa). |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [crend](../collection/crend/)() const | Obtiene un iterador inverso para un elemento calificado como const inexistente antes del inicio de la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEqualityComparer](../../system.collections.generic/iequalitycomparer/)\<TKey\>\> [get_Comparer](./get_comparer/)() | Obtiene el comparador. |
| int [get_Count](../collection/get_count/)() const override | Obtiene el número de elementos. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](../collection/get_items/)() | Accesor de la estructura de datos interna. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](../collection/get_items/)() const | Accesor de la estructura de datos interna. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../collection/getenumerator/)() override | Obtiene un enumerador para iterar a través de la colección. |
...
| TItem [idx_get](./idx_get/)(TKey) | Obtiene el elemento en el índice especificado. |
| T [idx_get](../collection/idx_get/)(int) const override | Obtiene el valor en el índice especificado. |
| void [idx_set](../collection/idx_set/)(int, T) override | Establece el valor en el índice especificado. |
| int [IndexOf](../collection/indexof/)(const T\&) const override | Busca el elemento en la colección. |
| void [Insert](../collection/insert/)(int, const T\&) override | Inserta el elemento en la posición especificada. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina si existe algún elemento en la secuencia o cumple una condición. |
...
| T\& [operator[]](../collection/operator[]/)(int) | Obtiene el valor en el índice especificado. |
| const T\& [operator[]](../collection/operator[]/)(int) const | Obtiene el valor en el índice especificado. |
| [reverse_iterator](../collection/reverse_iterator/) [rbegin](../collection/rbegin/)() | Obtiene un iterador inverso al último elemento de la colección (el primero en reversa). |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [rbegin](../collection/rbegin/)() const | Obtiene un iterador inverso al último elemento de la colección calificada como const (el primero en reversa). |
...
| **bool** [Remove](./remove/)(TKey) | Elimina la clave del contenedor. |
| **bool** [Remove](../collection/remove/)(const T\&) override | Elimina el elemento específico. |
| void [RemoveAt](../collection/removeat/)(int) override | Elimina el elemento en la posición especificada. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| [reverse_iterator](../collection/reverse_iterator/) [rend](../collection/rend/)() | Obtiene un iterador inverso para un elemento inexistente antes del inicio de la colección. |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [rend](../collection/rend/)() const | Obtiene un iterador inverso para un elemento inexistente antes del inicio de la colección calificada como const. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Hace que un argumento de plantilla específico sea tratado como puntero débil en lugar de puntero compartido (si corresponde). |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../collection/virtualizebeginconstiterator/)() const override | Obtiene la implementación del iterador begin const para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginIterator](../collection/virtualizebeginiterator/)() override | Obtiene la implementación del iterador begin para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../collection/virtualizeendconstiterator/)() const override | Obtiene la implementación del iterador end const para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](../collection/virtualizeenditerator/)() override | Obtiene la implementación del iterador end para el contenedor actual. |
...
| Campo | Descripción |
| --- | --- |
| static [defaultThreshold](./defaultthreshold/) | Umbral de creación del diccionario de búsqueda, por defecto. |

## Ver también

* Clase [Collection](../collection/)
