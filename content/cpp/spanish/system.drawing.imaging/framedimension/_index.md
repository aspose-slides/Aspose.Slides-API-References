...
| Método | Descripción |
| --- | --- |
| **bool** [Equals](./equals/)([FrameDimensionPtr](../framedimensionptr/)) | Determina si el objeto [FrameDimension](./) especificado es equivalente al objeto actual. |
...
|  [FrameDimension](./framedimension/)(const [System::Guid](../../system/guid/)\&) | Construye un nuevo objeto [FrameDimension](./) y lo inicializa con el GUID especificado. |
| [System::Guid](../../system/guid/) [get_Guid](./get_guid/)() const | Devuelve el GUID asociado al objeto actual. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Page](./get_page/)() | Devuelve la dimensión de la página. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Resolution](./get_resolution/)() | Devuelve la dimensión de resolución. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Time](./get_time/)() | Devuelve la dimensión de tiempo. |
