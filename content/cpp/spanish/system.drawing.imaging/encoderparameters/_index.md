...
| Método | Descripción |
| --- | --- |
|  [EncoderParameters](./encoderparameters/)(int) | Construye una nueva instancia de la clase [EncoderParameters](./). |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\> [get_Param](./get_param/)() const | Devuelve un arreglo de objetos [EncoderParameter](../encoderparameter/) representados por el objeto [EncoderParameters](./) actual. |
...
| void [set_Param](./set_param/)(const [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\>\&) | Asigna un arreglo de objetos [EncoderParameter](../encoderparameter/) al objeto [EncoderParameters](./) actual. |
