...
description: Especifica el formato de datos de color de un píxel.
type: docs
weight: 326
url: /es/system.drawing.imaging/pixelformat/
---
## PixelFormat enum
...
| --- | --- | --- |
| Indexed | 65536 | Especifica que los datos del píxel contienen valores de color indexados, lo que significa que son un índice a colores en la tabla de colores del sistema. |
...
| Undefined | 0 | Especifica que el formato de píxel no está definido. |
...
| Format4bppIndexed | n/a | Especifica que el formato de píxel es color indexado de 4 bits por píxel. |
| Format8bppIndexed | n/a | Especifica que el formato de píxel es color indexado de 8 bits por píxel. |
| Format16bppGrayScale | n/a | Especifica que el formato de píxel es de 16 bits por píxel. La información de color indica 65536 tonos de gris. |
...
| Format32bppCMYK | n/a | Especifica que el formato de píxel es de 32 bits por píxel con 8 bits para cada uno de los componentes cian, magenta, amarillo y negro (clave). |
| Max | 16 | El valor máximo de este enum. |
