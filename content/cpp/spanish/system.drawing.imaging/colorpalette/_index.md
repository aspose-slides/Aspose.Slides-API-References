...
description: "Representa un conjunto de colores ARGB de 32 bits que forman una paleta de colores. Los objetos de esta clase solo deben asignarse mediante la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila ni utilizando el operador new, ya que provocará errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a funciones como argumento."
type: docs
weight: 40
url: /es/system.drawing.imaging/colorpalette/
---
## ColorPalette clase
...
| [System::ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\> [get_Entries](./get_entries/)() const | Devuelve una matriz de objetos [Color](../../system.drawing/color/) representados por el objeto actual. |
| int [get_Flags](./get_flags/)() const | Devuelve un valor que especifica cómo se deben interpretar los valores de color en la matriz de colores. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo de la declaración lock() de C#. Llámese directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
