...
type: docs
weight: 1
url: /es/system.drawing.imaging/bitmapdata/
---
## BitmapData clase
...
| int [get_Height](./get_height/)() const | Devuelve la altura de la imagen en píxeles. |
| [PixelFormat](../pixelformat/) [get_PixelFormat](./get_pixelformat/)() const | Devuelve el formato de píxel de la imagen bitmap. |
| IntPtr [get_Scan0](./get_scan0/)() const | Devuelve la dirección del primer dato de píxel en el bitmap. |
| int [get_Stride](./get_stride/)() const | Devuelve el ancho de stride de la imagen en bytes. |
| int [get_Width](./get_width/)() const | Devuelve el ancho de la imagen en píxeles. |
...
| void [set_Height](./set_height/)(int) | Establece la altura de la imagen en píxeles. |
| void [set_PixelFormat](./set_pixelformat/)([PixelFormat](../pixelformat/)) | Establece el formato de píxel de la imagen bitmap. |
| void [set_Scan0](./set_scan0/)(IntPtr) | Establece la dirección del primer dato de píxel en el bitmap. |
| void [set_Stride](./set_stride/)(int) | Establece el ancho de stride de la imagen en bytes. |
| void [set_Width](./set_width/)(int) | Establece el ancho de la imagen en píxeles. |
