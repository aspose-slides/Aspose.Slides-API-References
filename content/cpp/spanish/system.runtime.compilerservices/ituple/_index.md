...
description: Define una implementación de Tuple de propósito general que permite acceder a los miembros de instancia de Tuple sin conocer el tipo subyacente de Tuple.
type: docs
weight: 53
url: /es/system.runtime.compilerservices/ituple/
---
## ITuple clase

Define una implementación de [Tuple](../../system/tuple/) de propósito general que permite acceder a los miembros de instancia de [Tuple](../../system/tuple/) sin conocer el tipo subyacente [Tuple](../../system/tuple/).
...
| virtual **int32_t** [get_Length](./get_length/)() const | Devuelve el número de posiciones en esta estructura de datos. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | Devuelve el elemento en la posición índice. |
