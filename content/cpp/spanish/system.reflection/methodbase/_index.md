...
| Método | Descripción |
| --- | --- |
| void [AddAttribute](../memberinfo/addattribute/)(const [ObjectPtr](../memberinfo/objectptr/)\&) | Añade un atributo a la colección. |
...
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Indica el tipo del miembro - método, constructor, evento, etc. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[MemberInfo](../memberinfo/)\> [GetCurrentMethod](./getcurrentmethod/)(const [String](../../system/string/)\&) | Este método permite obtener el nombre del método actual. El traductor sustituye ASPOSE_CURRENT_FUNCTION como parámetro automáticamente. |
