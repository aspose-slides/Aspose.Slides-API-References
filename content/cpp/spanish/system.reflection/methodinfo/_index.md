...
description: Representa información sobre el método de la clase.
type: docs
weight: 131
url: /es/system.reflection/methodinfo/
---
## Clase MethodInfo


Representa información sobre un método de clase.
...
| Method | Description |
| --- | --- |
| void [AddAttribute](../memberinfo/addattribute/)(const [ObjectPtr](../memberinfo/objectptr/)\&) | Agrega un atributo a la colección. |
...
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Obtiene un valor MemberTypes que indica que este miembro es un método. |
...
|  [MethodInfo](./methodinfo/)(const [String](../../system/string/)\&) | Inicializa una nueva instancia de la clase [MethodInfo](./). |
