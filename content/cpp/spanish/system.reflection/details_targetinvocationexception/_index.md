...
description: "TargetInvocationException se lanza por métodos invocados a través de reflexión. Nunca cree instancias de esta clase manualmente. Use la clase TargetInvocationException en su lugar. Nunca envuelva las instancias de la clase TargetInvocationException en System::SmartPtr."
type: docs
weight: 79
url: /es/system.reflection/details_targetinvocationexception/
---
## Details_TargetInvocationException clase

TargetInvocationException se lanza por métodos invocados a través de reflexión. Nunca cree instancias de esta clase manualmente. Use la clase TargetInvocationException en su lugar. Nunca envuelva las instancias de la clase TargetInvocationException en [System::SmartPtr](../../system/smartptr/).
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_applicationexception/gettype/)() const override | Obtiene el tipo real del objeto. Análogo a la llamada C# [System.Object.GetType()](../../system/object/gettype/). |
...
* Clase [Details_ApplicationException](../../system/details_applicationexception/)
