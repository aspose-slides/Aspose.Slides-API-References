...
description: "Proporciona información de reflexión sobre los miembros. Los objetos de esta clase solo deben asignarse usando la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a funciones como argumento."
type: docs
weight: 105
url: /es/system.reflection/memberinfo/
---
## MemberInfo clase
...
| Method | Description |
| --- | --- |
| void [AddAttribute](./addattribute/)(const [ObjectPtr](./objectptr/)\&) | Añade un atributo a la colección. |
...
| [TypeInfo](../../system/typeinfo/) [get_DeclaringType](./get_declaringtype/)() const | Obtiene el tipo declarador. |
| const [String](../../system/string/)\& [get_FullName](./get_fullname/)() const | Obtiene el nombre completo del miembro. Puede ser diferente en partes implementadas manualmente. |
| virtual [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const | Obtiene un valor [System::Reflection::MemberTypes](../membertypes/) que indica el tipo del miembro: método, constructor, evento, etc. |
| const [String](../../system/string/)\& [get_Name](./get_name/)() const | Obtiene el nombre del miembro. |
| [TypeInfo](../../system/typeinfo/) [get_ReflectedType](./get_reflectedtype/)() const | Obtiene el tipo reflejado. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | Devuelve una matriz que contiene objetos que representan todos los atributos personalizados aplicados al tipo representado por el objeto actual. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(**bool**) const | Devuelve una matriz que contiene objetos que representan todos los atributos personalizados aplicados al tipo representado por el objeto actual. |
