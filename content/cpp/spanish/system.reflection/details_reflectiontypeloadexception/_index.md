...
description: "ReflectionTypeLoadException se lanza mediante el método Module.GetTypes si alguna de las clases en un módulo no se puede cargar. Nunca cree instancias de esta clase manualmente. Use la clase ReflectionTypeLoadException en su lugar. Nunca envuelva las instancias de la clase ReflectionTypeLoadException dentro de System::SmartPtr."
type: docs
weight: 66
url: /es/system.reflection/details_reflectiontypeloadexception/
---
## Details_ReflectionTypeLoadException clase


ReflectionTypeLoadException se lanza mediante el método Module.GetTypes si alguna de las clases en un módulo no se puede cargar. Nunca cree instancias de esta clase manualmente. Use la clase ReflectionTypeLoadException en su lugar. Nunca envuelva las instancias de la clase ReflectionTypeLoadException dentro de [System::SmartPtr](../../system/smartptr/).
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Exception](../../system/exception/)\> [get_LoaderExceptions](./get_loaderexceptions/)() const | Devuelve las excepciones que provocan esta excepción. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::TypeInfo](../../system/typeinfo/)\> [get_Types](./get_types/)() const | Devuelve la información de tipo de las causas de la excepción. |
