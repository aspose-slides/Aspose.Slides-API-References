...
Representa una sola celda en un [Excel](../) libro de trabajo.
...
| **int32_t** [get_Column](./get_column/)() override | Obtiene el índice basado en cero de la columna en la hoja de cálculo donde se encuentra la celda. Solo lectura **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Obtiene el nombre de la celda de datos del gráfico. |
| **int32_t** [get_Row](./get_row/)() override | Obtiene el índice basado en cero de la fila en la hoja de cálculo donde se encuentra la celda. Solo lectura **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | Obtiene el valor contenido en la celda [Excel](../). |
