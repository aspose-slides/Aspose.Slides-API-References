...
description: "Representa información sobre la conexión de red del equipo local. Los objetos de esta clase solo deben asignarse mediante la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila ni usando el operador new, ya que resultará en errores de tiempo de ejecución y/or fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a funciones como argumento."
type: docs
weight: 14
url: /es/system.net.networkinformation/ipglobalproperties/
---
...
| virtual [String](../../system/string/) [get_DomainName](./get_domainname/)() | Devuelve el dominio en el que está registrado el equipo local. |
| virtual [String](../../system/string/) [get_HostName](./get_hostname/)() | Devuelve el nombre del host del equipo local. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[IPGlobalProperties](./)\> [GetIPGlobalProperties](./getipglobalproperties/)() | Construye una nueva instancia. |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo del enunciado C# lock(). Llamar directamente o usar el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo del enunciado C# lock(). Llamar directamente o usar el objeto centinela [LockContext](../../system/lockcontext/). |
