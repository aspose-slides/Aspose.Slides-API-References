...
description: "Convierte la instancia de la clase CryptoStream de base 64. Los objetos de esta clase solo deben asignarse utilizando la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que provocará errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use dicho puntero para pasarlo a funciones como argumento."
type: docs
weight: 209
url: /es/system.security.cryptography/frombase64transform/
---
## FromBase64Transform clase

Convierte la instancia de la clase [CryptoStream](../cryptostream/) de base 64. Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que provocará errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use dicho puntero para pasarlo a funciones como argumento.
...
| Método | Descripción |
| --- | --- |
| void [Clear](./clear/)() | Libera todos los recursos. |
| void [Dispose](./dispose/)() | Libera los recursos del sistema operativo adquiridos por el objeto actual. |
...
| virtual **bool** [get_CanReuseTransform](./get_canreusetransform/)() | Obtiene un valor que indica si la transformación actual puede reutilizarse. |
| **bool** [get_CanTransformMultipleBlocks](./get_cantransformmultipleblocks/)() | Obtiene un valor que indica si se pueden transformar varios bloques. |
| virtual **int32_t** [get_InputBlockSize](./get_inputblocksize/)() | Tamaño del bloque de entrada. |
| virtual **int32_t** [get_OutputBlockSize](./get_outputblocksize/)() | Tamaño del bloque de salida. |
...
| virtual int [TransformBlock](../icryptotransform/transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Procesa un bloque de datos y copia los datos al arreglo de salida. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](../icryptotransform/transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Procesa el último bloque de datos y calcula el valor de salida. |
