...
| static [SharedPtr](../../system/sharedptr/)\<[SHA384](./)\> [Create](./create/)() | Crea una instancia del algoritmo de hash. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA384](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Crea una instancia del algoritmo de hash. |
...
| virtual void [Initialize](../hashalgorithm/initialize/)() | Restablece el generador de hash al estado inicial. |
