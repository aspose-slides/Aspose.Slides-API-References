...
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromFriendlyName](./fromfriendlyname/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Crea un objeto OID a partir del nombre amigable OID especificado. |
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromOidValue](./fromoidvalue/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Crea un objeto OID a partir del valor OID especificado. |
| [String](../../system/string/) [get_FriendlyName](./get_friendlyname/)() const | Obtiene el nombre amigable del objeto. |
| [String](../../system/string/) [get_Value](./get_value/)() const | Obtiene la cadena del identificador del objeto. |
...
|  [Oid](./oid/)() | Constructor predeterminado. |
|  [Oid](./oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](./)\>\&) | Constructor de copia. |
...
| void [set_FriendlyName](./set_friendlyname/)(const [String](../../system/string/)\&) | Establece el nombre amigable del objeto. |
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Establece la cadena del identificador del objeto. |
