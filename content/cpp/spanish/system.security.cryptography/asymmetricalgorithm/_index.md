...
| static [SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](./)\> [Create](./create/)() | Crea un algoritmo predeterminado. No implementado. |
| static [SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Crea un algoritmo por nombre. No implementado. |
| void [Dispose](./dispose/)() override | Libera los recursos poseídos por el objeto actual. |
...
| virtual void [FromXmlString](./fromxmlstring/)([String](../../system/string/)) | Lee los parámetros del algoritmo desde una cadena XML. |
| virtual [String](../../system/string/) [get_KeyExchangeAlgorithm](./get_keyexchangealgorithm/)() | Obtiene el algoritmo de intercambio de claves a usar. |
| virtual **int32_t** [get_KeySize](./get_keysize/)() | Obtiene el tamaño de la clave. |
| virtual [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[KeySizes](../keysizes/)\>\> [get_LegalKeySizes](./get_legalkeysizes/)() | Obtiene la matriz de tamaños de clave permitidos. |
| virtual [String](../../system/string/) [get_SignatureAlgorithm](./get_signaturealgorithm/)() | Obtiene el algoritmo de firma a usar. |
...
| virtual void [set_KeySize](./set_keysize/)(**int32_t**) | Establece el tamaño de la clave. |
...
| virtual [String](../../system/string/) [ToXmlString](./toxmlstring/)(**bool**) | Escribe los parámetros del algoritmo a una cadena XML. |
