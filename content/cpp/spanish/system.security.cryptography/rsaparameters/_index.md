...
description: "Estructura de datos de los parámetros del algoritmo RSA. Este tipo debe asignarse en la pila y pasarse a funciones por valor o por referencia. Nunca use la clase System::SmartPtr para gestionar objetos de este tipo."
type: docs
weight: 768
url: /es/system.security.cryptography/rsaparameters/
---
## RSAParameters struct

[Data](../../system.data/) estructura de los parámetros del algoritmo [RSA](../rsa/). Este tipo debe ser asignado en la pila y pasado a funciones por valor o por referencia. Nunca use la clase [System::SmartPtr](../../system/smartptr/) para gestionar objetos de este tipo.
