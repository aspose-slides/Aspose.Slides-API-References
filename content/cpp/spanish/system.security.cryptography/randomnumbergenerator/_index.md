...
| Método | Descripción |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[RandomNumberGenerator](./)\> [Create](./create/)() | Crea una instancia de la implementación predeterminada de un generador de números aleatorios criptográfico que puede usarse para generar datos aleatorios. No implementado. |
...
| virtual void [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Rellena los elementos existentes del array con bytes aleatorios. |
| virtual void [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Rellena una porción existente del array con bytes aleatorios. |
| virtual void [GetBytes](./getbytes/)(System::Details::ArrayView\<**uint8_t**\>) | Rellena los elementos existentes de la vista del array con bytes aleatorios. |
| virtual void [GetBytes](./getbytes/)(System::Details::ArrayView\<**uint8_t**\>, int, int) | Rellena una porción existente de la vista del array con bytes aleatorios. |
| void [GetBytes](./getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | Rellena los elementos existentes del array de pila con bytes aleatorios. |
| void [GetBytes](./getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&, int, int) | Rellena una porción existente del array de pila con bytes aleatorios. |
...
| virtual void [GetNonZeroBytes](./getnonzerobytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Rellena los elementos existentes del array con bytes aleatorios diferentes de cero. |
| virtual void [GetNonZeroBytes](./getnonzerobytes/)(System::Details::ArrayView\<**uint8_t**\>) | Rellena los elementos existentes de la vista del array con bytes aleatorios diferentes de cero. |
| void [GetNonZeroBytes](./getnonzerobytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | Rellena los elementos existentes del array de pila con bytes aleatorios diferentes de cero. |
