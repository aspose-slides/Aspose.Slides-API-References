...
| virtual int [get_InputBlockSize](./get_inputblocksize/)() | Tamaño del bloque de entrada. |
| virtual int [get_OutputBlockSize](./get_outputblocksize/)() | Tamaño del bloque de salida. |
...
| virtual int [TransformBlock](./transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Procesa un bloque de datos y copia los datos al arreglo de salida. |
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](./transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Procesa el último bloque de datos y calcula el valor de salida. |
