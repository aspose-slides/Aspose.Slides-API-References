...
description: "Lanza una excepción por un código de error Win32. Nunca cree instancias de esta clase manualmente. Use la clase Win32Exception en su lugar. Nunca envuelva las instancias de la clase Win32Exception en System::SmartPtr."
type: docs
weight: 79
url: /es/system.componentmodel/details_win32exception/
---
## Details_Win32Exception clase
...
| virtual **int32_t** [get_NativeErrorCode](./get_nativeerrorcode/)() const | Obtiene el código de error Win32 asociado con esta excepción. |
