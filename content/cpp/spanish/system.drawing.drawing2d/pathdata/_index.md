...
description: "Contiene los datos gráficos que representan una ruta. Los objetos de esta clase solo deben asignarse utilizando la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila ni usando el operador new, ya que provocará errores de tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a las funciones como argumento."
type: docs
weight: 131
url: /es/system.drawing.drawing2d/pathdata/
---
## PathData clase
...
| [ArrayPtr](../../system/arrayptr/)\<[PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | Devuelve una matriz que contiene los puntos que forman una ruta. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Types](./get_types/)() | Devuelve una matriz que contiene los valores que especifican los tipos de los puntos correspondientes en la matriz **Points**. |
...
| void [set_Points](./set_points/)(const [ArrayPtr](../../system/arrayptr/)\<[PointF](../../system.drawing/pointf/)\>\&) | Establece una matriz que contiene los puntos que forman una ruta. |
| void [set_Types](./set_types/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Establece una matriz que contiene los valores que especifican los tipos de los puntos correspondientes en la matriz **Points**. |
