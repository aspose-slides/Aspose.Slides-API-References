...
| Método | Descripción |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | Crea una copia exacta del objeto actual. |
...
| [Color](../../system.drawing/color/) [get_BackgroundColor](./get_backgroundcolor/)() const | Devuelve un valor que indica el color de fondo de este pincel. |
| [Color](../../system.drawing/color/) [get_ForegroundColor](./get_foregroundcolor/)() const | Devuelve un valor que indica el color de primer plano de este pincel. |
| [HatchStyle](../hatchstyle/) [get_HatchStyle](./get_hatchstyle/)() const | Devuelve un valor que indica el estilo de trama de este pincel. |
...
|  [HatchBrush](./hatchbrush/)([HatchStyle](../hatchstyle/), [Color](../../system.drawing/color/), [Color](../../system.drawing/color/)) | Construye una nueva instancia de la clase [HatchBrush](./) que representa un pincel con el estilo de trama, el color de primer plano y el color de fondo especificados. |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo del enunciado lock() de C#. Llámelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo del enunciado lock() de C#. Llámelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
