...
description: Proporciona la excepción lanzada cuando ocurre un error al procesar una expresión XPath.
type: docs
weight: 1
url: /es/system.xml.xpath/details_xpathexception/
---
## Details_XPathException clase

Proporciona la excepción lanzada cuando ocurre un error al procesar una expresión [XPath](../).
...
| [String](../../system/string/) [get_Message](./get_message/)() const override | Devuelve la descripción de la condición de error para esta excepción. |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo de la sentencia lock() de C#. Llálelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo de la sentencia lock() de C#. Llálelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
