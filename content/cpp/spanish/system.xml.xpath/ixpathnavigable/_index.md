...
description: Proporciona un accesor a la clase XPathNavigator.
type: docs
weight: 14
url: /es/system.xml.xpath/ixpathnavigable/
---
## IXPathNavigable clase

Proporciona un accesor a la clase [XPathNavigator](../xpathnavigator/).
...
| Método | Descripción |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() | Devuelve un nuevo objeto [XPathNavigator](../xpathnavigator/). |
