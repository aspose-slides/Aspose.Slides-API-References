...
---
## ISmartArtShapeCollection clase

Representa una colección de [SmartArt](../smartart/) formas
...
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Devuelve un valor que indica si el acceso a la colección está sincronizado (thread-safe). Solo lectura **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtShape](../ismartartshape/)\> [idx_get](./idx_get/)(**int32_t**) | Obtiene el elemento en el índice especificado. Solo lectura [ISmartArtShape](../ismartartshape/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Asigna el n-ésimo argumento de plantilla como un puntero débil (en vez de compartido). Permite cambiar los punteros en contenedores a modo débil. |
