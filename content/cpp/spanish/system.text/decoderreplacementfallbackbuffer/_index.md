...
description: Búfer para reemplazar la estrategia de reserva de decodificación.
type: docs
weight: 92
url: /es/system.text/decoderreplacementfallbackbuffer/
---
## DecoderReplacementFallbackBuffer clase

[Buffer](../../system/buffer/) para reemplazar la estrategia de reserva de decodificación.
...
| int [get_Remaining](./get_remaining/)() const override | Obtiene el número de caracteres restantes en el búfer. |
...
| void [Reset](./reset/)() override | Restablece el búfer al estado inicial (antes de la llamada [Fallback()](./fallback/)). |
