...
type: docs
weight: 40
url: /es/system.text/icuencoding/getbytes/
---
...
| bytes | **uint8_t** * | [Buffer](../../../system/buffer/) para poner caracteres. |
...
| char_index | int | Comienzo de la porción de caracteres. |
| char_count | int | Número de caracteres a convertir. |
| bytes | [ArrayPtr](../../../system/arrayptr/)\<**uint8_t**\> | [Buffer](../../../system/buffer/) para poner caracteres. |
...
| char_index | int | Comienzo de la porción de caracteres. |
| char_count | int | Número de caracteres a convertir. |
| bytes | System::Details::ArrayView\<**uint8_t**\> | [Buffer](../../../system/buffer/) para poner caracteres. |
| byte_index | int | Desplazamiento del búfer de salida. |
...
| char_index | int | Comienzo de la porción de caracteres. |
| char_count | int | Número de caracteres a convertir. |
| bytes | System::Details::StackArray\<**uint8_t**, SB\>\& | [Buffer](../../../system/buffer/) para poner caracteres. |
| byte_index | int | Desplazamiento del búfer de salida. |
...
| --- | --- | --- |
| chars | [ArrayPtr](../../../system/arrayptr/)\<char_t\> | Caracteres a codificar. |
| index | int | Comienzo de la porción de caracteres. |
