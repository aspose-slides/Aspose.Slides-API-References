...
| static [EncodingPtr](../../system/encodingptr/) [get_BigEndianUnicode](../encoding/get_bigendianunicode/)() | Obtiene el objeto de codificación Unicode de orden de bytes grande estándar. |
| static [EncodingPtr](../../system/encodingptr/) [get_BigEndianUTF32](../encoding/get_bigendianutf32/)() | Obtiene el objeto de codificación UTF-32 de orden de bytes grande estándar. |
...
| int [GetHashCode](../encoding/gethashcode/)() const override | Calcula hash de la codificación. |
| int [GetMaxByteCount](./getmaxbytecount/)(int) override | Obtiene la cantidad máxima de bytes posible para contener una cadena de una cantidad conocida de caracteres. |
...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetPreamble](../icuencoding/getpreamble/)() override | Devuelve una secuencia de bytes que indica la codificación (p. ej., BOM). |
