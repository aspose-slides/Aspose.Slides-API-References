...
description: "Proporciona una estrategia de respaldo que reemplaza el símbolo erróneo con un stub. Los objetos de esta clase solo deben asignarse usando la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila ni usando operator new, ya que resultará en errores de tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a funciones como argumento."
type: docs
weight: 79
url: /es/system.text/decoderreplacementfallback/
---
## DecoderReplacementFallback clase


Proporciona una estrategia de respaldo que reemplaza el símbolo erróneo con un stub. Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila ni usando operator new, ya que provocará errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento.
...
| Método | Descripción |
| --- | --- |
| [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Crea un búfer de respaldo. |
|  [DecoderReplacementFallback](./decoderreplacementfallback/)() | Constructor que usa la cadena de sustitución predeterminada \"?\". |
...
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](../decoderfallback/get_exceptionfallback/)() | Obtiene la implementación predeterminada de fallback de excepción. |
...
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](../decoderfallback/get_replacementfallback/)() | Obtiene la implementación predeterminada de fallback de sustitución. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](../decoderfallback/get_standardsafefallback/)() | Obtiene la implementación predeterminada de fallback seguro estándar. |
...
* Clase [DecoderFallback](../decoderfallback/)
