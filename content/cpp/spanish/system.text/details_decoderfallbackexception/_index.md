...
description: "Excepción lanzada por DecoderExceptionFallback cuando la decodificación falla. Nunca cree instancias de esta clase manualmente. Use la clase DecoderFallbackException en su lugar. Nunca envuelva instancias de la clase DecoderFallbackException en System::SmartPtr."
type: docs
weight: 105
url: /es/system.text/details_decoderfallbackexception/
---
## Details_DecoderFallbackException clase


Excepción lanzada por [DecoderExceptionFallback](../decoderexceptionfallback/) cuando la decodificación falla. Nunca cree instancias de esta clase manualmente. Use la clase DecoderFallbackException en su lugar. Nunca envuelva instancias de la clase DecoderFallbackException en [System::SmartPtr](../../system/smartptr/).
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | Obtiene la matriz de bytes que desencadenó el error. |
...
| int [get_Index](./get_index/)() | Obtiene la posición del byte que desencadenó el error en la matriz de entrada. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Obtiene el tipo real del objeto. Análogo a la llamada C# [System.Object.GetType()](../../system/object/gettype/). |
