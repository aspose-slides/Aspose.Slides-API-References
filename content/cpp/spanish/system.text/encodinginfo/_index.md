...
| int [get_CodePage](./get_codepage/)() const | Obtiene el ID de la página de códigos. |
| const [String](../../system/string/)\& [get_DisplayName](./get_displayname/)() const | Obtiene el nombre completo localizado de la codificación. |
| const [String](../../system/string/)\& [get_Name](./get_name/)() const | Obtiene el nombre corto de la codificación. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [EncodingPtr](../../system/encodingptr/) [GetEncoding](./getencoding/)() | Obtiene la codificación descrita por la información. |
