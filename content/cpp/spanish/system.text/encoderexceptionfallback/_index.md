...
description: "Proporciona una estrategia de reserva que lanza excepciones. Los objetos de esta clase solo deben asignarse mediante la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila o mediante el operador new, ya que provocará errores de tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use este puntero para pasarlo a funciones como argumento."
type: docs
weight: 144
url: /es/system.text/encoderexceptionfallback/
---
## EncoderExceptionFallback clase
...
| Método | Descripción |
| --- | --- |
| [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Crea el búfer de reserva. |
...
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](../encoderfallback/get_exceptionfallback/)() | Obtiene la implementación predeterminada de reserva de excepciones. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Obtiene la cantidad máxima de caracteres que la instancia puede devolver. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](../encoderfallback/get_replacementfallback/)() | Obtiene la implementación predeterminada de reserva de reemplazo. |
