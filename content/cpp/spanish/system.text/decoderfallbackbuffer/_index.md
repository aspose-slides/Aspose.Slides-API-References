...
| virtual **bool** [Fallback](./fallback/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Implementa el procedimiento de reserva real. |
...
| virtual char_t [GetNextChar](./getnextchar/)() | Extrae el siguiente carácter del búfer de reserva. |
