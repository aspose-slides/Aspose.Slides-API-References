...
| virtual int [GetByteCount](./getbytecount/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, **bool**) | Obtiene el número de bytes necesarios para codificar un búfer. |
| virtual int [GetByteCount](./getbytecount/)(const char_t *, int, **bool**) | Obtiene el número de bytes necesarios para codificar un búfer. |
| virtual int [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, **bool**) | Obtiene los bytes que resultan de codificar un búfer. |
| virtual int [GetBytes](./getbytes/)(const char_t *, int, **uint8_t** *, int, **bool**) | Obtiene los bytes que resultan de codificar un búfer. |
