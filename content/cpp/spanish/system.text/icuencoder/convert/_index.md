...
type: docs
weight: 66
url: /es/system.text/icuencoder/convert/
---
...
| charsUsed | int\& | Referencia a la variable para almacenar la cantidad de caracteres leídos. |
| bytesUsed | int\& | Referencia a la variable para almacenar la cantidad de bytes escritos. |
| completed | **bool**\& | Referencia a la variable que se establecerá en true si se agotó el búfer de entrada y en false en caso contrario. |
