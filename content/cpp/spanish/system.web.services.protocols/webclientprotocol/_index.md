...
| Método | Descripción |
| --- | --- |
| virtual void [Abort](./abort/)() | Cancela la solicitud. |
...
| [String](../../system/string/) [get_ConnectionGroupName](./get_connectiongroupname/)() | Obtiene el nombre del grupo de conexión. |
| [System::SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\> [get_Credentials](./get_credentials/)() | Obtiene la información de autenticación. |
| **bool** [get_PreAuthenticate](./get_preauthenticate/)() | Obtiene un valor que indica si la preautenticación está habilitada. |
| [System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\> [get_RequestEncoding](./get_requestencoding/)() | Obtiene la codificación que se usa para realizar las solicitudes del cliente. |
| **int32_t** [get_Timeout](./get_timeout/)() | Obtiene el intervalo de tiempo a esperar antes de que la solicitud expire. |
| [System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [get_Uri](./get_uri/)() | Obtiene el URI del servicio XML [Web](../../system.web/). |
| [String](../../system/string/) [get_Url](./get_url/)() | Obtiene la URL del servicio XML [Web](../../system.web/). |
| **bool** [get_UseDefaultCredentials](./get_usedefaultcredentials/)() | Obtiene un valor que indica si la propiedad 'Credential' es igual a la propiedad 'DefaultCredentials'. |
...
| void [set_ConnectionGroupName](./set_connectiongroupname/)([String](../../system/string/)) | Establece el nombre del grupo de conexión. |
| void [set_Credentials](./set_credentials/)([System::SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) | Establece la información de autenticación. |
| void [set_PreAuthenticate](./set_preauthenticate/)(**bool**) | Establece un valor que indica si la preautenticación está habilitada. |
| void [set_RequestEncoding](./set_requestencoding/)([System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>) | Establece la codificación que se usa para realizar las solicitudes del cliente. |
| void [set_Timeout](./set_timeout/)(**int32_t**) | Establece el intervalo de tiempo a esperar antes de que la solicitud expire. |
| void [set_Uri](./set_uri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Establece el URI del servicio XML [Web](../../system.web/). |
| void [set_Url](./set_url/)([String](../../system/string/)) | Establece la URL del servicio XML [Web](../../system.web/). |
| void [set_UseDefaultCredentials](./set_usedefaultcredentials/)(**bool**) | Establece un valor que indica si la propiedad 'Credential' es igual a la propiedad 'DefaultCredentials'. |
