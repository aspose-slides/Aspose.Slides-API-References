...
| [SoapServiceRoutingStyle](../soapserviceroutingstyle/) [get_RoutingStyle](./get_routingstyle/)() | Obtiene un valor que muestra cómo los mensajes SOAP se enrutan al servicio. |
| [Description::SoapBindingUse](../../system.web.services.description/soapbindinguse/) [get_Use](./get_use/)() | Obtiene el formato de los parámetros. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructor de copia. No copia nada realmente, solo inicializa un nuevo objeto y permite la copia de construcción de subclases. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de asignación. No copia nada realmente, solo inicializa un nuevo objeto y permite la copia de construcción de subclases. |
...
| void [set_RoutingStyle](./set_routingstyle/)([SoapServiceRoutingStyle](../soapserviceroutingstyle/)) | Establece un valor que muestra cómo se enrutan los mensajes SOAP al servicio. |
| void [set_Use](./set_use/)([Description::SoapBindingUse](../../system.web.services.description/soapbindinguse/)) | Establece el formato de los parámetros. |
...
|  [SoapDocumentServiceAttribute](./soapdocumentserviceattribute/)([Description::SoapBindingUse](../../system.web.services.description/soapbindinguse/)) | Construye una nueva instancia. |
|  [SoapDocumentServiceAttribute](./soapdocumentserviceattribute/)([Description::SoapBindingUse](../../system.web.services.description/soapbindinguse/), [SoapParameterStyle](../soapparameterstyle/)) | Construye una nueva instancia. |
