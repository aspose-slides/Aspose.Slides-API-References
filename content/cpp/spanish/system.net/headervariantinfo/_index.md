...
type: docs
weight: 196
url: /es/system.net/headervariantinfo/
---
## HeaderVariantInfo clase

Usado para coincidir el nombre y la especificación de la cookie. Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Devuelve el nombre de la cookie. |
| [CookieVariant](../cookievariant/) [get_Variant](./get_variant/)() | Devuelve la especificación de la cookie. |
...
|  [HeaderVariantInfo](./headervariantinfo/)([String](../../system/string/), [CookieVariant](../cookievariant/)) | Construye una nueva instancia. |
