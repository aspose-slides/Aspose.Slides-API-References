...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[EndPoint](./)\> [Create](./create/)([System::SharedPtr](../../system/sharedptr/)\<[SocketAddress](../socketaddress/)\>) | Crea una nueva instancia de la clase [EndPoint](./) usando la dirección de socket especificada. |
...
| virtual [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/) [get_AddressFamily](./get_addressfamily/)() | Devuelve la familia de direcciones a la que pertenece la instancia actual. |
...
| virtual [ImplPtr](./implptr/) [GetImpl](./getimpl/)() const | Devuelve un puntero a la implementación. |
