...
description: "Representa una excepción lanzada cuando el tamaño de CookieContainer es mayor que el valor de la propiedad MaxCookieSize. Nunca cree instancias de esta clase manualmente. Use la clase CookieException en su lugar. Nunca envuelva las instancias de la clase CookieException en System::SmartPtr."
type: docs
weight: 79
url: /es/system.net/details_cookieexception/
---
## Details_CookieException clase


Representa una excepción lanzada cuando el tamaño de [CookieContainer](../cookiecontainer/) es mayor que el valor de la propiedad MaxCookieSize. Nunca cree instancias de esta clase manualmente. Use la clase CookieException en su lugar. Nunca envuelva las instancias de la clase CookieException en [System::SmartPtr](../../system/smartptr/).
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_formatexception/gettype/)() const override | Gets actual type of object. Analog of C# [System.Object.GetType()](../../system/object/gettype/) call. |
...
* Clase [Details_FormatException](../../system/details_formatexception/)
