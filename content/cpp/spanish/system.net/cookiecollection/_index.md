...
| Método | Descripción |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) override | Agrega una cookie a la colección. |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](./)\>) | Agrega cookies de la colección especificada a la actual. |
...
| void [Clear](./clear/)() override | Elimina todas las cookies de la colección. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) const override | Comprueba si la colección contiene la cookie especificada. |
| [CookieCollection](./cookiecollection/)() | Construye una nueva instancia. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia todos los elementos de la colección a los elementos de una matriz existente. |
...
| **int32_t** [get_Count](./get_count/)() const override | Obtiene el número de elementos en la colección. |
| **bool** [get_IsOtherVersionSeen](./get_isotherversionseen/)() | Devuelve un valor que indica si la colección contiene una cookie con una versión que no es igual a [Cookie::MaxSupportedVersion](../cookie/maxsupportedversion/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\>\> [GetEnumerator](./getenumerator/)() override | Obtiene un enumerador. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve una cookie de la colección de cookies en el índice especificado. |
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [idx_get](./idx_get/)([String](../../system/string/)) | Devuelve una cookie de la colección de cookies por nombre especificado. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>) | Devuelve el índice de la cookie especificada. |
| **int32_t** [InternalAdd](./internaladd/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>, **bool**) | Agrega la cookie especificada a la colección. |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo de la sentencia C# lock(). Llámelo directamente o utilice el objeto centinela [LockContext](../../system/lockcontext/). |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) override | Elimina la cookie especificada de la colección. |
| void [RemoveAt](./removeat/)(**int32_t**) | Elimina una cookie en el índice especificado. |
...
| [DateTime](../../system/datetime/) [TimeStamp](./timestamp/)([CookieCollection::Stamp](./stamp/)) | Actualiza la marca de tiempo según el escenario especificado y devuelve un nuevo valor. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Análogo al método C# [Object.ToString()](../../system/object/tostring/). Permite convertir objetos personalizados a cadena. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementa la construcción C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo de la sentencia C# lock(). Llámelo directamente o utilice el objeto centinela [LockContext](../../system/lockcontext/). |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtiene la implementación del iterador begin const para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Obtiene la implementación del iterador begin para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtiene la implementación del iterador end const para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtiene la implementación del iterador end para el contenedor actual. |
...
| --- | --- |
| [Stamp](./stamp/) | Enumera las operaciones de establecimiento de marca de tiempo. |
