...
description: "Representa la excepción que se lanza por WebRequest cuando ocurre un error. Nunca cree instancias de esta clase manualmente. Use la clase WebException en su lugar. Nunca envuelva las instancias de la clase WebException dentro de System::SmartPtr."
type: docs
weight: 92
url: /es/system.net/details_webexception/
---
## Details_WebException clase


Representa la excepción que lanza [WebRequest](../webrequest/) cuando ocurre un error. Nunca cree instancias de esta clase manualmente. Use la clase WebException en su lugar. Nunca envuelva las instancias de la clase WebException dentro de [System::SmartPtr](../../system/smartptr/).
...
| Método | Descripción |
| --- | --- |
| static [Exception](../../system/exception/) [CreateCompatibleException](./createcompatibleexception/)([Exception](../../system/exception/)) | No está implementado. |
|  [Details_WebException](./details_webexception/)() | Construye una nueva instancia. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/)) | Construye una nueva instancia. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Construye una nueva instancia. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [WebExceptionStatus](../webexceptionstatus/)) | Construye una nueva instancia. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [Exception](../../system/exception/), [WebExceptionStatus](../webexceptionstatus/), [System::SharedPtr](../../system/sharedptr/)\<[WebResponse](../webresponse/)\>) | Construye una nueva instancia. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Devuelve un valor entero de 32 bits que es un código HRESULT asociado a la excepción representada por el objeto actual. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[WebResponse](../webresponse/)\> [get_Response](./get_response/)() | Devuelve la respuesta web con la que está asociada la excepción actual. |
...
| [WebExceptionStatus](../webexceptionstatus/) [get_Status](./get_status/)() | Devuelve el código de estado. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_invalidoperationexception/gettype/)() const override | Obtiene el tipo real del objeto. Análogo a la llamada C# [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementa el método [what()](../../system/details_exception/what/) que es llamado por la clase [ExceptionWrapper](../../system/exceptionwrapper/). A pesar de que esta clase no hereda de std::exception, las clases derivadas pueden usar miembros protegidos/privados para implementar su lógica. Mover la implementación de este método a [ExceptionWrapper](../../system/exceptionwrapper/) podría romper esa lógica. |
| virtual  [~Details_WebException](./~details_webexception/)() | Destruye la instancia actual. |
| virtual  [~Object](../../system/object/~object/)() | Destruye el objeto. Libera todas las estructuras de datos internas. |

## Ver también

* Clase [Details_InvalidOperationException](../../system/details_invalidoperationexception/)
