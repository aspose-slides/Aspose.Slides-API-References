...
| Método | Descripción |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[EndPoint](../endpoint/)\> [Create](../endpoint/create/)([System::SharedPtr](../../system/sharedptr/)\<[SocketAddress](../socketaddress/)\>) | Crea una nueva instancia de la clase [EndPoint](../endpoint/) utilizando la dirección de socket especificada. |
|  [DnsEndPoint](./dnsendpoint/)([String](../../system/string/), **int32_t**) | Construye una nueva instancia. |
|  [DnsEndPoint](./dnsendpoint/)([String](../../system/string/), **int32_t**, [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/)) | Construye una nueva instancia. |
...
| [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/) [get_AddressFamily](./get_addressfamily/)() override | Devuelve la familia de direcciones a la que pertenece la instancia actual. |
| [String](../../system/string/) [get_Host](./get_host/)() | Devuelve un nombre de host. |
| **int32_t** [get_Port](./get_port/)() | Devuelve el número de puerto. |
...
| virtual [ImplPtr](../endpoint/implptr/) [GetImpl](../endpoint/getimpl/)() const | Devuelve un puntero a la implementación. |
