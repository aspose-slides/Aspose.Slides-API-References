...
| **int32_t** [get_Height](./get_height/)() const | Devuelve la altura del ícono. |
| **int32_t** [get_Width](./get_width/)() const | Devuelve el ancho del ícono. |
...
|  [Icon](./icon/)(const [String](../../system/string/)\&) | Construye una nueva instancia de la clase [Icon](./) que representa un ícono del archivo especificado. |
...
| [SharedPtr](../../system/sharedptr/)\<[Bitmap](../bitmap/)\> [ToBitmap](./tobitmap/)() | Convierte el objeto actual a un objeto [Bitmap](../bitmap/). |
