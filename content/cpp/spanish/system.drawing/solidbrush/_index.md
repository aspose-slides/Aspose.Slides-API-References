...
description: "Representa un pincel de un solo color. Los objetos de esta clase solo deben asignarse mediante la función System::MakeObject() . Nunca cree una instancia de este tipo en la pila ni usando el operador new, ya que provocará errores en tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a las funciones como argumento."
type: docs
weight: 300
url: /es/system.drawing/solidbrush/
---
## SolidBrush clase

Representa un pincel de un solo color. Los objetos de esta clase sólo deben asignarse mediante la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila ni use el operador new, ya que provocará errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a las funciones como argumento.
...
| [Color](../color/) [get_Color](./get_color/)() const | Devuelve el color de este pincel. |
...
| void [set_Color](./set_color/)([Color](../color/)) | Establece el color de este pincel. |
...
|  [SolidBrush](./solidbrush/)(const [Color](../color/)\&) | Construye un nuevo objeto [SolidBrush](./) e lo inicializa con el color especificado. |
