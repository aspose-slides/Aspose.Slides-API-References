...
description: Proporciona una clase base abstracta para una colección fuertemente tipada.
type: docs
weight: 27
url: /es/system.collections/collectionbase/
---
...
| void [Clear](./clear/)() | Elimina todos los objetos de la instancia de la colección. Este método no puede ser sobrescrito. |
...
| **int32_t** [get_Capacity](./get_capacity/)() | Devuelve el número de elementos que la colección puede contener. |
| **int32_t** [get_Count](./get_count/)() | Devuelve el número de elementos contenidos en la instancia de la colección. Este método no puede ser sobrescrito. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que itera a través de la instancia de la colección. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina si existe algún elemento en una secuencia o si algún elemento cumple una condición. |
...
| void [RemoveAt](./removeat/)(**int32_t**) | Elimina el elemento en el índice especificado de la instancia de la colección. Este método no es sobrescribible. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| void [set_Capacity](./set_capacity/)(**int32_t**) | Establece el número de elementos que la colección puede contener. |
