...
type: docs
weight: 14
url: /es/system.collections/ilistimplvaluetype/idx_get/
---
## IListImplValueType::idx_get(int, int) const método
...
| dummy | int | parámetro ficticio para ayudar a resolver la ambigüedad |
