...
description: IEnumerable es la interfaz base para todas las colecciones no genéricas que pueden enumerarse.
type: docs
weight: 53
url: /es/system.collections/ienumerable/
---
## IEnumerable clase

[IEnumerable](./) es la interfaz base para todas las colecciones no genéricas que pueden enumerarse.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | Devuelve un enumerador que recorre una colección. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el n-ésimo argumento template a un puntero débil (en lugar de compartido). Permite cambiar punteros en contenedores a modo débil. |
