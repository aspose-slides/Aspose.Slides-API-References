...
description: Define una interfaz de colección no genérica.
type: docs
weight: 40
url: /es/system.collections/icollection/
---
## ICollection clase

Define una interfaz de colección no genérica.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](../ienumerable/getenumerator/)() | Devuelve un enumerador que recorre una colección. |
