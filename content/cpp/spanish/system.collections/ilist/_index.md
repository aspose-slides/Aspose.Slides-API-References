...
description: IList representa una colección no genérica de objetos que pueden ser accedidos individualmente por índice.
type: docs
weight: 118
url: /es/system.collections/ilist/
---
## IList clase


[IList](./) Representa una colección no genérica de objetos que pueden ser accedidos individualmente por índice.
...
| Método | Descripción |
| --- | --- |
| virtual int [Add](./add/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Agrega un elemento al final de la lista. |
| virtual void [Clear](./clear/)() | Elimina todos los elementos de la lista. |
| virtual **bool** [Contains](./contains/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Comprueba si el elemento está en la lista. |
...
| virtual **bool** [get_IsFixedSize](./get_isfixedsize/)() const | Obtiene un valor que indica si la lista tiene un tamaño fijo. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](../ienumerable/getenumerator/)() | Devuelve un enumerador que itera a través de una colección. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(int, int) const | Obtiene el elemento en el índice especificado. |
| virtual int [IndexOf](./indexof/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Obtiene el primer índice del elemento especificado. |
| virtual void [Insert](./insert/)(int, [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Inserta el elemento en la lista en el índice especificado. |
...
| virtual void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Elimina la primera instancia del elemento especificado de la lista. |
| virtual void [RemoveAt](./removeat/)(int) | Elimina el elemento de la lista en el índice especificado. |
