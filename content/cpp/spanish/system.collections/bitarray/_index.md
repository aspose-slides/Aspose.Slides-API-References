...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const **bool**\&) override | Agrega un valor al final del contenedor. |
| [BitArrayPtr](../bitarrayptr/) [And](./and/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calcula el 'and' a nivel de bits entre dos BitSets. |
...
|  [BitArray](./bitarray/)(const [bitset](./bitset/)\&) | Constructor de copia. |
|  [BitArray](./bitarray/)(const [BitArray](./)\&) | Constructor de copia. |
|  [BitArray](./bitarray/)(const [BitArrayPtr](../bitarrayptr/)\&) | Constructor de copia. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**bool**\>\&) | Constructor de copia. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Constructor de copia. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<int\>\&) | Constructor de copia. |
...
| **bool** [Contains](./contains/)(const **bool**\&) const override | Comprueba si un valor específico está presente en el contenedor. No implementado. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<**bool**\>, int) override | Copia datos a los elementos existentes del array. |
| [bitset](./bitset/)\& [data](./data/)() | Acceso a la estructura de datos subyacente. |
| const [bitset](./bitset/)\& [data](./data/)() const | Acceso a la estructura de datos subyacente. |
...
| **bool** [Get](./get/)(int) const | Obtiene el elemento [BitArray](./). |
| int [get_Count](./get_count/)() const override | Obtiene el tamaño del contenedor. |
...
| int [get_Length](./get_length/)() const | Obtiene el tamaño del contenedor. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<**bool**\>\> [GetEnumerator](./getenumerator/)() override | Crea un objeto enumerador. |
...
| **bool** [idx_get](./idx_get/)(int) const | Función getter. |
| void [idx_set](./idx_set/)(int, **bool**) | Función setter. |
...
| [BitArrayPtr](../bitarrayptr/) [Not](./not/)() | Niega BitSet. |
|  [Object](../../system/object/object/)() | Crea el objeto. Inicializa todas las estructuras de datos internas. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructor de copia. No copia nada, en realidad, solo inicializa un nuevo objeto y permite la copia de construcción en subclases. |
| **bool** [operator!=](./operator_not_equal/)(const [BitArray](./)\&) const | Operador de comparación a nivel de bits. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de asignación. No copia nada, en realidad, solo inicializa un nuevo objeto y permite la copia de construcción en subclases. |
...
| **bool** [operator==](./operator_equal_equal/)(const [BitArray](./)\&) const | Operador de comparación a nivel de bits. |
| **Reference** [operator[]](./operator[]/)(int) | Función de acceso. |
| [BitArrayPtr](../bitarrayptr/) [Or](./or/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calcula el 'or' a nivel de bits entre dos BitSets. |
...
| **bool** [Remove](./remove/)(const **bool**\&) override | Devuelve la primera aparición del valor especificado. No implementado. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| void [Set](./set/)(int, **bool**) | Establece el elemento [BitArray](./). |
| void [SetAll](./setall/)(**bool**) | Establece todos los elementos a un valor específico. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Implementación formal del mecanismo de argumentos de plantilla débiles; no aplicable a esta clase. |
| int [SharedCount](../../system/object/sharedcount/)() const | Obtiene el valor actual del contador de referencias compartidas. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrementa el contador de referencias compartidas. No debería llamarse directamente; en su lugar, use punteros inteligentes o ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementa y devuelve el contador de referencias compartidas. No debería llamarse directamente; en su lugar, use punteros inteligentes o ThisProtector. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogo del método C# [Object.ToString()](../../system/object/tostring/). Permite convertir objetos personalizados a string. |
...
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtiene la implementación del iterador const begin para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Obtiene la implementación del iterador begin para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtiene la implementación del iterador const end para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtiene la implementación del iterador end para el contenedor actual. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa el contador de referencias débiles. No debería llamarse directamente; en su lugar, use punteros inteligentes o ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa el contador de referencias débiles. No debería llamarse directamente; en su lugar, use punteros inteligentes o ThisProtector. |
| [BitArrayPtr](../bitarrayptr/) [Xor](./xor/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calcula el 'xor' a nivel de bits entre dos BitSets. |
...
| Typedef | Description |
| --- | --- |
| [bitset](./bitset/) | Tipo de datos subyacente. |
