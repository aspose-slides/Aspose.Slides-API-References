...
| virtual **uint32_t** [get_Spokes](./get_spokes/)() | Número de radios de la transición de rueda. Leer **uint32_t**. |
...
| virtual void [set_Spokes](./set_spokes/)(**uint32_t**) | Número de radios de la transición de rueda. Escribir **uint32_t**. |
