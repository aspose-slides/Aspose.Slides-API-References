...
description: Efecto de transición opcional de diapositiva negra.
type: docs
weight: 183
url: /es/aspose.slides.slideshow/ioptionalblacktransition/
---
## IOptionalBlackTransition clase


Efecto de transición opcional de diapositiva negra.
...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Este atributo especifica si la transición comenzará desde una pantalla negra (y luego transicionará la nueva diapositiva sobre negro). Leer **bool**. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Este atributo especifica si la transición comenzará desde una pantalla negra (y luego transicionará la nueva diapositiva sobre negro). Escribir **bool**. |
