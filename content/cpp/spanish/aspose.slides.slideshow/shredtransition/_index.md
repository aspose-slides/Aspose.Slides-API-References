...
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | Especifica la forma de los visuales usados durante la transición. Lea [TransitionShredPattern](../transitionshredpattern/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Sirve como función hash para un tipo particular, adecuada para su uso en algoritmos de hashing y estructuras de datos como una tabla hash. |
...
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | Especifica la forma de los visuales usados durante la transición. Escriba [TransitionShredPattern](../transitionshredpattern/). |
...
* Clase [IShredTransition](../ishredtransition/)
