...
description: Efecto de transición de rueda deslizante.
type: docs
weight: 443
url: /es/aspose.slides.slideshow/wheeltransition/
---
## WheelTransition clase

Efecto de transición de rueda deslizante.
...
| **uint32_t** [get_Spokes](./get_spokes/)() override | Número de radios de la transición de rueda. Leer **uint32_t**. |
...
| void [set_Spokes](./set_spokes/)(**uint32_t**) override | Número de radios de la transición de rueda. Escribir **uint32_t**. |
...
* Clase [IWheelTransition](../iwheeltransition/)
