...
description: Efecto de transición de diapositiva en forma de onda.
type: docs
weight: 222
url: /es/aspose.slides.slideshow/irippletransition/
---
## IRippleTransition clase

Efecto de transición de diapositiva en forma de onda.
...
| virtual [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/) [get_Direction](./get_direction/)() | Dirección de la transición. Lea [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/)) | Dirección de la transición. Escriba [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/). |
