...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Dirección de un efecto de transición. Leer [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Dirección de un efecto de transición. Escribir [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el n\'th template argument a un puntero débil (en lugar de compartido). Permite cambiar los punteros en contenedores al modo débil. |
...
* Clase [IInOutTransition](../iinouttransition/)
