...
---
## ILeftRightDirectionTransition clase

Efecto de transición de diapositiva de dirección izquierda-derecha.
...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | Dirección de la transición. Lea [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo de la sentencia C# lock(). Llámanlo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | Dirección de la transición. Escriba [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo de la sentencia C# lock(). Llámanlo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
