...
description: Implementa la interfaz IEnumerable para una colección genérica vacía.
type: docs
weight: 14
url: /es/system.linq.details/emptyenumerable/
---
## EmptyEnumerable clase

Implementa la interfaz IEnumerable para una colección genérica vacía.
...
| --- | --- |
| T | El tipo del elemento en una colección. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Obtiene el enumerador. |
...
* Espacio de nombres [System::Linq::Details](../)
