...
description: Implementa la interfaz IEnumerator para una colección genérica vacía.
type: docs
weight: 27
url: /es/system.linq.details/emptyenumerator/
---
## EmptyEnumerator clase


Implementa la interfaz IEnumerator para una colección genérica vacía.
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const override | Obtiene el elemento actual. |
