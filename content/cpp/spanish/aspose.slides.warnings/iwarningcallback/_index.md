...
| virtual [ReturnAction](../returnaction/) [Warning](./warning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningInfo](../iwarninginfo/)\>) | Método de devolución de llamada que recibe la advertencia y decide si la operación debe abortarse. |
