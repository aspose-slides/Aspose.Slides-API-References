...
---
## IObsoletePresLockingBehaviorWarningInfo clase
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Devuelve una descripción legible por humanos de este aviso. Solo lectura [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Devuelve un tipo de aviso. Solo lectura [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Si el receptor no es nulo finaliza el aviso a un receptor especificado y lanza AbortRequestedException si el receptor decide abortar la operación. |
