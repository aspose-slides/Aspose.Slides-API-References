...
description: Representa una advertencia sobre una característica conocida que no está implementada y que no se implementará en el futuro cercano.
type: docs
weight: 14
url: /es/aspose.slides.warnings/inotimplementedwarninginfo/
---
## INotImplementedWarningInfo clase


Representa una advertencia sobre una característica conocida que no está implementada y que no se implementará en el futuro cercano.
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Si el receptor no es nulo, envía la advertencia a un receptor especificado y lanza AbortRequestedException si el receptor decide abortar la operación. |
