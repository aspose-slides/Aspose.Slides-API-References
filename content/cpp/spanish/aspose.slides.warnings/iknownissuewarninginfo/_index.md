...
description: Representa una advertencia sobre un problema conocido que no se solucionará en un futuro próximo.
type: docs
weight: 1
url: /es/aspose.slides.warnings/iknownissuewarninginfo/
---
## IKnownIssueWarningInfo clase

Representa una advertencia sobre un problema conocido que no se solucionará en un futuro próximo.
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Si el receptor no es nulo finaliza la advertencia a un receptor especificado y lanza la AbortRequestedException si el receptor decide abortar una operación. |
