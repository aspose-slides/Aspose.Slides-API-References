...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Devuelve una descripción legible por humanos de esta advertencia. Solo lectura [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](./get_warningtype/)() | Devuelve un tipo de advertencia. Solo lectura [IWarningInfo::get_WarningType](./get_warningtype/). |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo del enunciado lock() de C#. Llámese directamente o utilice el objeto centinela [LockContext](../../system/lockcontext/). |
...
| virtual void [SendWarning](./sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Si el receptor no es nulo finaliza la advertencia hacia un receptor especificado y lanza AbortRequestedException si el receptor decide abortar la operación. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo del enunciado lock() de C#. Llámese directamente o utilice el objeto centinela [LockContext](../../system/lockcontext/). |
