...
description: Esta advertencia indica que la presentación que se está leyendo tiene la firma y que esta firma se eliminará durante el procesamiento.
type: docs
weight: 40
url: /es/aspose.slides.warnings/ipresentationsignedwarninginfo/
---
## IPresentationSignedWarningInfo clase


Esta advertencia indica que la presentación que se está leyendo tiene la firma y que esta firma se eliminará durante el procesamiento.
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Devuelve una descripción legible por humanos de esta advertencia. Solo lectura [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Devuelve un tipo de advertencia. Solo lectura [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Si el receptor no es nulo, finaliza la advertencia a un receptor especificado y lanza AbortRequestedException si el receptor decidió abortar una operación. |
