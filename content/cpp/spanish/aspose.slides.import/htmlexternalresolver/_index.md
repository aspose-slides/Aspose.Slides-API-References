...
description: Objeto de devolución de llamada usado por la rutina de importación HTML para obtener objetos referenciados, como imágenes.
type: docs
weight: 27
url: /es/aspose.slides.import/htmlexternalresolver/
---
## HtmlExternalResolver clase


Objeto de devolución de llamada usado por la rutina de importación HTML para obtener objetos referenciados, como imágenes.
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) override | Mapea una URI a un objeto que contiene el recurso real. |
...
| [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Resuelve la URI absoluta a partir de la base y las URIs relativas. |
...
Obsoleto
:   Obsoleto. Use [ExternalResourceResolver](../externalresourceresolver/) en su lugar. Será eliminado en la versión 17.12.
...
* Clase [IHtmlExternalResolver](../ihtmlexternalresolver/)
