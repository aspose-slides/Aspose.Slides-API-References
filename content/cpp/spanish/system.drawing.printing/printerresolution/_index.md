...
| int [get_X](./get_x/)() const | Devuelve la resolución horizontal. |
| int [get_Y](./get_y/)() const | Devuelve la resolución vertical. |
...
| void [set_X](./set_x/)(int) | Establece la resolución horizontal. |
| void [set_Y](./set_y/)(int) | Establece la resolución vertical. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el enésimo argumento de plantilla como un puntero débil (en lugar de compartido). Permite cambiar punteros en contenedores al modo débil. |
