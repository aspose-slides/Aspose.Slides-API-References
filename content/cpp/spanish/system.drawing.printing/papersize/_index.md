...
type: docs
weight: 27
url: /es/system.drawing.printing/papersize/
---
## PaperSize clase
...
| **int32_t** [get_Height](./get_height/)() const | Obtiene la altura del papel, en centésimas de pulgada. |
| [PaperKind](../paperkind/) [get_Kind](./get_kind/)() const | Obtiene el tipo de papel. |
| [System::String](../../system/string/) [get_PaperName](./get_papername/)() const | Obtiene el nombre del tipo de papel. |
| **int32_t** [get_RawKind](./get_rawkind/)() const | Obtiene un entero que representa uno de los valores [System::Drawing::Printing::PaperSize](./) o un valor personalizado. |
| **int32_t** [get_Width](./get_width/)() const | Obtiene el ancho del papel, en centésimas de pulgada. |
...
|  [PaperSize](./papersize/)([PaperKind](../paperkind/), [System::String](../../system/string/), **int32_t**, **int32_t**) | Inicializa una nueva instancia de la clase [System::Drawing::Printing::PaperSize](./). |
|  [PaperSize](./papersize/)([System::String](../../system/string/), **int32_t**, **int32_t**) | Inicializa una nueva instancia de la clase [System::Drawing::Printing::PaperSize](./). |
...
| void [set_Height](./set_height/)(**int32_t**) | Establece la altura del papel, en centésimas de pulgada. |
| void [set_PaperName](./set_papername/)([System::String](../../system/string/)) | Establece el nombre del tipo de papel. |
| void [set_RawKind](./set_rawkind/)(**int32_t**) | Establece un entero que representa uno de los valores [System::Drawing::Printing::PaperSize](./) o un valor personalizado. |
| void [set_Width](./set_width/)(**int32_t**) | Establece el ancho del papel, en centésimas de pulgada. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Proporciona información sobre el [System::Drawing::Printing::PaperSize](./) en forma de cadena. |
