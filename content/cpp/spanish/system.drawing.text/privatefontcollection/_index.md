...
| Método | Descripción |
| --- | --- |
| void [AddFont](./addfont/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int) | Añade la fuente especificada a la colección. |
| void [AddFontFile](./addfontfile/)(const [String](../../system/string/)\&) | Añade una fuente del archivo especificado a la colección. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[FontFamily](../../system.drawing/fontfamily/)\>\> [get_Families](./get_families/)() override | Devuelve una matriz de objetos [FontFamily](../../system.drawing/fontfamily/) asociados con la colección de fuentes representada por el objeto actual. |
