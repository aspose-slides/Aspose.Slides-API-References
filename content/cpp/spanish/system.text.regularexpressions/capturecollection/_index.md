...
| void [Add](./add/)(const [CapturePtr](../captureptr/)\&) override | Desactiva la enmienda de la colección. |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | Agrega un elemento al final de la lista. |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | Método de servicio para agregar una captura a la colección. |
...
| void [AddRange](../../system.collections.generic/list/addrange/)([IEnumerablePtr](../../system.collections.generic/list/ienumerableptr/)) | Agrega todos los elementos de la colección (o de sí mismo) al final de la lista actual. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/list/cend/)() const | Obtiene un iterador para un elemento const no existente situado después del final de la colección. |
| void [Clear](./clear/)() override | Desactiva la limpieza de la colección. |
| **bool** [Contains](../../system.collections.generic/list/contains/)(const T\&) const override | Verifica si el elemento está presente en la lista. |
...
| void [CopyTo](../../system.collections.generic/list/copyto/)(int, const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&, int, int) | Copia elementos a partir del índice especificado en elementos de una matriz existente. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crend](../../system.collections.generic/list/crend/)() const | Obtiene un iterador inverso para un elemento const no existente antes del inicio de la colección. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/list/end/)() | Obtiene un iterador para un elemento no existente después del final de la colección. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/list/end/)() const | Obtiene un iterador para un elemento no existente después del final de la colección calificada como const. |
...
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | Verifica si existe un elemento que cumple un predicado específico en la lista. |
...
| int [get_Count](./get_count/)() const override | Obtiene el número de capturas. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Verifica si la colección tiene tamaño fijo. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Marca la colección como de solo lectura. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | Marca la colección como no sincronizada. |
...
| [IEnumeratorPtr](../../system.collections.generic/list/ienumeratorptr/) [GetEnumerator](../../system.collections.generic/list/getenumerator/)() override | Obtiene un enumerador para iterar los elementos de la lista. |
...
| void [Insert](../../system.collections.generic/list/insert/)(int, const T\&) override | Inserta un elemento en la posición especificada. |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | Busca el objeto especificado y devuelve el índice basado en cero de la última ocurrencia dentro de toda la lista. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Busca el objeto especificado y devuelve el índice basado en cero de la última ocurrencia dentro del rango de elementos en [List](../../system.collections.generic/list/) que se extiende desde el primer elemento hasta el índice especificado. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Busca el objeto especificado y devuelve el índice basado en cero de la última ocurrencia dentro del rango de elementos en [List](../../system.collections.generic/list/) que contiene el número especificado de elementos y termina en el índice especificado. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructor de copia. No copia nada, simplemente inicializa un nuevo objeto y permite la construcción de copias de subclases. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de asignación. No copia nada, simplemente inicializa un nuevo objeto y permite la construcción de copias de subclases. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)([ICollection](../../system.collections.generic/icollection/)\&&) | Operador de asignación de movimiento. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)(const [ICollection](../../system.collections.generic/icollection/)\&) | Operador de asignación de movimiento. |
...
| **bool** [Remove](./remove/)(const [CapturePtr](../captureptr/)\&) override | Desactiva la enmienda de la colección. |
...
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() | Obtiene un iterador inverso para un elemento no existente antes del inicio de la colección. |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() const | Obtiene un iterador inverso para un elemento no existente antes de la colección calificada como const. |
...
| void [Sort](../../system.collections.generic/list/sort/)(const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) | Ordena los elementos de la lista. |
| void [Sort](../../system.collections.generic/list/sort/)() | Ordena los elementos de la lista usando el comparador predeterminado. |
| void [Sort](../../system.collections.generic/list/sort/)(int, int, [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>) | Ordena los elementos de la porción de la lista. |
| void [Sort](../../system.collections.generic/list/sort/)([Comparison](../../system/comparison/)\<T\>, **bool**) | Ordena los elementos de la lista. |
...
| **bool** [TrueForAll](../../system.collections.generic/list/trueforall/)([System::Predicate](../../system/predicate/)\<T\>) | Determina si todos los elementos de la colección cumplen las condiciones definidas por el predicado especificado. |
