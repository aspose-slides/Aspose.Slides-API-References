...
| void [Add](./add/)(const [GroupPtr](../groupptr/)\&) override | Desactiva la adición de elementos a la colección. |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | Añade un elemento al final de la lista. |
| void [AddGroup](./addgroup/)(const [GroupPtr](../groupptr/)\&) | Añade un grupo a la colección. |
| void [AddInitializer](../../system.collections.generic/list/addinitializer/)(int, const T *) | Añade elementos a la lista; se usa al traducir inicializadores. |
| void [AddRange](../../system.collections.generic/list/addrange/)([IEnumerablePtr](../../system.collections.generic/list/ienumerableptr/)) | Añade todos los elementos de la colección (o de sí misma) al final de la lista actual. |
...
| void [Clear](./clear/)() override | Desactiva la eliminación de elementos de la colección. |
...
| void [CopyTo](../../system.collections.generic/list/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copia los elementos de la lista en elementos de matriz existentes. |
| void [CopyTo](../../system.collections.generic/list/copyto/)(const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&) | Copia todos los elementos en elementos de matriz existentes. |
| void [CopyTo](../../system.collections.generic/list/copyto/)(int, const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&, int, int) | Copia elementos a partir del índice especificado en elementos de matriz existentes. |
...
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | Comprueba si existe un elemento que cumple un predicado específico en la lista. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo para uso interno. |
| T [Find](../../system.collections.generic/list/find/)([System::Predicate](../../system/predicate/)\<T\>) | Busca un elemento que cumple un predicado específico. |
| [ListPtr](../../system.collections.generic/listptr/)\<T\> [FindAll](../../system.collections.generic/list/findall/)([System::Predicate](../../system/predicate/)\<T\>) | Busca elementos que cumplen un predicado específico. |
| int [FindIndex](../../system.collections.generic/list/findindex/)([System::Predicate](../../system/predicate/)\<T\>) | Busca elementos que cumplen un predicado específico. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, [System::Predicate](../../system/predicate/)\<T\>) | Busca elementos que cumplen un predicado específico. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, int, [System::Predicate](../../system/predicate/)\<T\>) | Busca elementos que cumplen un predicado específico. |
| T [FindLast](../../system.collections.generic/list/findlast/)([System::Predicate](../../system/predicate/)\<T\>) | Busca elementos que cumplen un predicado específico. |
...
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(int) const | accesor [Group](../group/). |
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(const [String](../../system/string/)\&) const | accesor [Group](../group/). |
...
| virtual [GroupPtr](../groupptr/) [idx_get](./idx_get/)([String](../../system/string/)) const | accesor [Group](../group/). |
| [GroupPtr](../groupptr/) [idx_get](./idx_get/)(int) const override | accesor [Group](../group/). |
...
| **bool** [IsReadOnly](./isreadonly/)() const | Marca la colección como de solo lectura. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | Busca el objeto especificado y devuelve el índice basado en cero de la última aparición dentro de la lista completa. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Busca el objeto especificado y devuelve el índice basado en cero de la última aparición dentro del rango de elementos en [List](../../system.collections.generic/list/) que se extiende desde el primer elemento hasta el índice especificado. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Busca el objeto especificado y devuelve el índice basado en cero de la última aparición dentro del rango de elementos en [List](../../system.collections.generic/list/) que contiene el número especificado de elementos y termina en el índice especificado. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Calcula el promedio de una secuencia de valores obtenidos mediante una función de transformación aplicada a cada elemento de la secuencia de entrada. |
...
| [GroupPtr](../groupptr/) [operator[]](./operator[]/)(const [String](../../system/string/)\&) const | accesor [Group](../group/). |
...
| **bool** [Remove](./remove/)(const [GroupPtr](../groupptr/)\&) override | Desactiva la eliminación de elementos de la colección. |
