...
description: Puntero a colección de grupos. Este tipo es un puntero para administrar la eliminación de otro objeto. Debe asignarse en la pila y pasarse a funciones ya sea por valor o por referencia constante.
type: docs
weight: 53
url: /es/system.text.regularexpressions/groupcollectionptr/
---
## GroupCollectionPtr clase

[Group](../group/) puntero de colección. Este tipo es un puntero para administrar la eliminación de otro objeto. Debe asignarse en la pila y pasarse a funciones ya sea por valor o por referencia constante.
...
| [GroupCollectionPtr](./groupcollectionptr/)(const [SharedPtr](../../system/sharedptr/)\<[GroupCollection](../groupcollection/)\>\&) | Constructor de conversión de tipo. |
| **bool** [Is](../../system/smartptr/is/)(const [System::TypeInfo](../../system/typeinfo/)\&) const | Verifica si el objeto apuntado es de un tipo específico o de su tipo derivado. Sigue la semántica 'is' de C#. |
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | Verifica si el puntero apunta a otro objeto que no es el propio (creado por un constructor de alias). |
...
| **bool** [operator<](../../system/smartptr/operator_less/)(Y *) const | Proporciona semántica de comparación 'menos' para la clase [SmartPtr](../../system/smartptr/). |
| **bool** [operator<](../../system/smartptr/operator_less/)([SmartPtr](../../system/smartptr/)\<Y\> const\&) const | Proporciona semántica de comparación 'menos' para la clase [SmartPtr](../../system/smartptr/). |
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&) | Asigna por movimiento el objeto [SmartPtr](../../system/smartptr/). x se vuelve inutilizable. |
...
| [GroupPtr](../groupptr/) [operator[]](./operator[]/)(size_t) const | [Group](../group/) accesor. |
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | Elimina el alias (creado por un constructor de alias) del puntero, asegurándose de que gestione (si es compartido) o rastree (si es débil) el mismo objeto al que apunta. |
...
| explicit [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<[Array](../../system/array/)\<Y\>\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Convierte el tipo de la matriz referenciada creando una nueva matriz de tipo diferente. Útil si en C# existe una conversión de tipo de matriz que no está soportada en C++. |
| explicit [SmartPtr](../../system/smartptr/smartptr/)(const Y\&) | Inicializa una matriz vacía. Se utiliza para traducir algunas construcciones de código C#. |
