...
| [TimeSpan](../../system/timespan/) [get_Elapsed](./get_elapsed/)() const | Obtiene el tiempo total transcurrido medido por la instancia actual. |
| **int64_t** [get_ElapsedMilliseconds](./get_elapsedmilliseconds/)() const | Obtiene el tiempo total transcurrido medido por la instancia actual, en milisegundos. |
| **int64_t** [get_ElapsedTicks](./get_elapsedticks/)() const | Obtiene el tiempo total transcurrido medido por la instancia actual, en ticks del temporizador. |
| **bool** [get_IsRunning](./get_isrunning/)() const | Comprueba si el cronómetro está en ejecución. |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo del enunciado C# lock(). Llame directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| void [Reset](./reset/)() | Detiene la medición del tiempo, establece el intervalo medido a cero. |
| void [Restart](./restart/)() | Establece el intervalo medido a cero, luego inicia la medición del tiempo. |
...
| void [Start](./start/)() | Inicia la medición del tiempo. |
| static [SharedPtr](../../system/sharedptr/)\<[Stopwatch](./)\> [StartNew](./startnew/)() | Crea un nuevo objeto [Stopwatch](./) e inicia la medición. |
| void [Stop](./stop/)() | Detiene la medición del tiempo. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo del enunciado C# lock(). Llame directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
