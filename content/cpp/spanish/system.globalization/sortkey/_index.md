...
| Método | Descripción |
| --- | --- |
| static int [Compare](./compare/)(const [SortKeyPtr](../sortkeyptr/)\&, const [SortKeyPtr](../sortkeyptr/)\&) | Compara dos claves de ordenación. |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Verifica si el objeto especificado es igual al objeto [SortKey](./) actual. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_KeyData](./get_keydata/)() | Obtiene la matriz de bytes que representa el objeto actual. |
| virtual [String](../../system/string/) [get_OriginalString](./get_originalstring/)() | Obtiene la cadena original usada para crear este objeto. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| int [GetHashCode](./gethashcode/)() const override | Obtiene el código hash para el objeto [SortKey](./) actual. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Convierte el objeto actual a su representación en cadena. |
