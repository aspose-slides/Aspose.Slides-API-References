...
description: "Divisor para iterar a través de partes de la cadena. Los objetos de esta clase solo deben asignarse usando la función System::MakeObject() . Nunca cree una instancia de este tipo en la pila ni usando el operador new, ya que producirá errores en tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a las funciones como argumento."
type: docs
weight: 313
url: /es/system.globalization/stringinfo/
---
## StringInfo clase
...
| int [get_LengthInTextElements](./get_lengthintextelements/)() const | Obtiene el número de elementos de texto en el objeto [StringInfo](./). |
| [String](../../system/string/) [get_String](./get_string/)() const | Obtiene el valor del objeto [StringInfo](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| int [GetHashCode](./gethashcode/)() const override | Análogo del método [Object.GetHashCode()](../../system/object/gethashcode/) de C#. Permite el hash de objetos personalizados. |
| static [String](../../system/string/) [GetNextTextElement](./getnexttextelement/)(const [String](../../system/string/)\&) | Obtiene el primer elemento en la cadena especificada. |
| static [String](../../system/string/) [GetNextTextElement](./getnexttextelement/)(const [String](../../system/string/)\&, int) | Obtiene el elemento en el índice especificado de la cadena especificada. |
| static [SharedPtr](../../system/sharedptr/)\<[TextElementEnumerator](../textelementenumerator/)\> [GetTextElementEnumerator](./gettextelementenumerator/)(const [String](../../system/string/)\&) | Crea un enumerador para iterar a través de los caracteres de la cadena. |
| static [SharedPtr](../../system/sharedptr/)\<[TextElementEnumerator](../textelementenumerator/)\> [GetTextElementEnumerator](./gettextelementenumerator/)(const [String](../../system/string/)\&, int) | Crea un enumerador para iterar a través de los caracteres de la cadena comenzando en el índice especificado. |
...
| static [ArrayPtr](../../system/arrayptr/)\<int\> [ParseCombiningCharacters](./parsecombiningcharacters/)(const [String](../../system/string/)\&) | Obtiene los índices de los caracteres base, sustitutos altos y caracteres de control. |
...
| void [set_String](./set_string/)(const [String](../../system/string/)\&) | Establece el valor del objeto [StringInfo](./). |
...
| [String](../../system/string/) [SubstringByTextElements](./substringbytextelements/)(int) const | Obtiene la subcadena de elementos de texto desde el elemento de texto especificado hasta el último elemento de texto. |
| [String](../../system/string/) [SubstringByTextElements](./substringbytextelements/)(int, int) const | Obtiene la subcadena de elementos de texto desde el elemento de texto especificado hasta el número especificado de elementos de texto. |
