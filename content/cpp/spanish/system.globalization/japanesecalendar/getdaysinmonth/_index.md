...
type: docs
weight: 92
url: /es/system.globalization/japanesecalendar/getdaysinmonth/
---
## JapaneseCalendar::GetDaysInMonth(int, int, int) const método
...
| --- | --- | --- |
| year | int | Año. |
| month | int | Mes del que se desea obtener el número de días. |
| era | int | Era. |
...
## JapaneseCalendar::GetDaysInMonth(int, int) const método
