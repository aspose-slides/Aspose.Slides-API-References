...
description: "CultureNotFoundException se lanza cuando se intenta crear una cultura que no está disponible. Nunca cree instancias de esta clase manualmente. Use la clase CultureNotFoundException en su lugar. Nunca envuelva las instancias de la clase CultureNotFoundException dentro de System::SmartPtr."
type: docs
weight: 92
url: /es/system.globalization/details_culturenotfoundexception/
---
## Details_CultureNotFoundException clase

CultureNotFoundException se lanza cuando se intenta crear una cultura que no está disponible. Nunca cree instancias de esta clase manualmente. Use la clase CultureNotFoundException en su lugar. Nunca envuelva las instancias de la clase CultureNotFoundException dentro de [System::SmartPtr](../../system/smartptr/).
