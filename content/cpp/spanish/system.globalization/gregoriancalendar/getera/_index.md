...
type: docs
weight: 157
url: /es/system.globalization/gregoriancalendar/getera/
---
## GregorianCalendar::GetEra(DateTime) const método
...
| --- | --- | --- |
| time | [DateTime](../../../system/datetime/) | Fecha y hora de la que extraer los datos. |

### Valor devuelto

Era del punto de tiempo pasado.
