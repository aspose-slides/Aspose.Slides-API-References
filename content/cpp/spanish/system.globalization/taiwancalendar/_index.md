...
| [DateTime](../../system/datetime/) [get_MaxSupportedDateTime](./get_maxsupporteddatetime/)() const override | Punto de tiempo máximo que soporta el calendario. |
| [DateTime](../../system/datetime/) [get_MinSupportedDateTime](./get_minsupporteddatetime/)() const override | Punto de tiempo mínimo que soporta el calendario. |
...
| int [GetDaysInMonth](./getdaysinmonth/)(int, int, int) const override | Obtiene el número de días en el mes especificado. |
| virtual int [GetDaysInMonth](./getdaysinmonth/)(int, int) const | Obtiene el número de días en el mes especificado. |
| virtual int [GetDaysInMonth](./getdaysinmonth/)(int, int, int) const | Obtiene el número de días en el mes especificado. |
| int [GetDaysInYear](./getdaysinyear/)(int, int) const override | Obtiene el número de días en el año específico. |
| virtual int [GetDaysInYear](./getdaysinyear/)(int) const | Obtiene el número de días en el año específico. |
| virtual int [GetDaysInYear](./getdaysinyear/)(int, int) const | Obtiene el número de días en el año específico. |
...
| int [GetLeapMonth](./getleapmonth/)(int, int) const override | Obtiene el mes intercalado para el año especificado. |
| virtual int [GetLeapMonth](./getleapmonth/)(int) const | Obtiene el mes intercalado para el año especificado. |
| virtual int [GetLeapMonth](./getleapmonth/)(int, int) const | Obtiene el mes intercalado para el año especificado. |
...
| [DateTime](../../system/datetime/) [ToDateTime](./todatetime/)(int, int, int, int, int, int, int, int) const override | Construye el objeto [DateTime](../../system/datetime/) a partir de componentes. |
| virtual [DateTime](../../system/datetime/) [ToDateTime](./todatetime/)(int, int, int, int, int, int, int) const | Construye el objeto [DateTime](../../system/datetime/) a partir de componentes. |
| virtual [DateTime](../../system/datetime/) [ToDateTime](./todatetime/)(int, int, int, int, int, int, int, int) const | Construye el objeto [DateTime](../../system/datetime/) a partir de componentes. |
