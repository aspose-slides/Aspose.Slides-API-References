...
description: Comprueba si el año es bisiesto.
type: docs
weight: 131
url: /es/system.globalization/persiancalendar/isleapyear/
---
## PersianCalendar::IsLeapYear(int, int) const método
...
True si el año especificado es bisiesto, false en caso contrario.

## PersianCalendar::IsLeapYear(int) const método
