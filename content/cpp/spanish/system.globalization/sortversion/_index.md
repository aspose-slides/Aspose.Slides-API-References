...
| Método | Descripción |
| --- | --- |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[SortVersion](./)\>) override | Comprueba si la instancia actual de [SortVersion](./) es igual a un objeto [SortVersion](./) especificado. |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Comprueba si la instancia actual de [SortVersion](./) es igual a un objeto [SortVersion](./) especificado. |
...
| int [get_FullVersion](./get_fullversion/)() | Obtiene el número de versión completo. |
| [Guid](../../system/guid/) [get_SortId](./get_sortid/)() | Obtiene el identificador único de este objeto. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| int [GetHashCode](./gethashcode/)() const override | Obtiene el código hash del objeto actual. |
...
| **bool** [operator!=](./operator_not_equal/)(const [SortVersion](./)\&) | Comprueba si la instancia actual de [SortVersion](./) no es igual a un objeto [SortVersion](./) especificado. |
...
| **bool** [operator==](./operator_equal_equal/)(const [SortVersion](./)\&) | Comprueba si la instancia actual de [SortVersion](./) es igual a un objeto [SortVersion](./) especificado. |
...
|  [SortVersion](./sortversion/)(int, const [Guid](../../system/guid/)\&) | Información RTTI. |
