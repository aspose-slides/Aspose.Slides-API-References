...
| [CalendarAlgorithmType](../calendaralgorithmtype/) [get_AlgorithmType](./get_algorithmtype/)() const override | Información RTTI. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<int\> [get_Eras](../calendar/get_eras/)() const | Obtiene la lista de eras existentes en el calendario. |
| virtual [Details::CalendarId](../../system.globalization.details/calendarid/) [get_ID](../calendar/get_id/)() const | Obtiene el identificador del calendario. |
| **bool** [get_IsReadOnly](../calendar/get_isreadonly/)() const | Comprueba si el calendario es de solo lectura. |
| virtual [DateTime](../../system/datetime/) [get_MaxSupportedDateTime](../calendar/get_maxsupporteddatetime/)() const | Punto máximo en el tiempo que es compatible con el calendario. |
| virtual [DateTime](../../system/datetime/) [get_MinSupportedDateTime](../calendar/get_minsupporteddatetime/)() const | Punto mínimo en el tiempo que es compatible con el calendario. |
...
| int [GetCelestialStem](./getcelestialstem/)(int) const | Obtiene el tallo celestial. |
...
| virtual int [GetLeapMonth](../calendar/getleapmonth/)(int) const | Obtiene el mes bisiesto para el año especificado. |
| virtual int [GetLeapMonth](../calendar/getleapmonth/)(int, int) const | Obtiene el mes bisiesto para el año especificado. |
...
| virtual int [GetSexagenaryYear](./getsexagenaryyear/)([DateTime](../../system/datetime/)) const | Obtiene el año en el ciclo sexagenario. |
| int [GetTerrestrialBranch](./getterrestrialbranch/)(int) const | Obtiene la rama terrestre. |
...
| virtual **bool** [IsLeapDay](../calendar/isleapday/)(int, int, int) const | Comprueba si el día es bisiesto. |
| virtual **bool** [IsLeapDay](../calendar/isleapday/)(int, int, int, int) const | Comprueba si el día es bisiesto. |
...
| virtual **bool** [IsLeapYear](../calendar/isleapyear/)(int) const | Comprueba si el año es bisiesto. |
| virtual **bool** [IsLeapYear](../calendar/isleapyear/)(int, int) const | Comprueba si el año es bisiesto. |
...
| virtual [DateTime](../../system/datetime/) [ToDateTime](../calendar/todatetime/)(int, int, int, int, int, int, int) const | Construye un objeto [DateTime](../../system/datetime/) a partir de componentes. |
| virtual [DateTime](../../system/datetime/) [ToDateTime](../calendar/todatetime/)(int, int, int, int, int, int, int, int) const | Construye un objeto [DateTime](../../system/datetime/) a partir de componentes. |
