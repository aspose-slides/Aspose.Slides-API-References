...
description: Enumera los códigos de control de E/S.
type: docs
weight: 157
url: /es/system.net.sockets/iocontrolcode/
---
## IOControlCode enum

Enumera los códigos de control [IO](../../system.io/).
...
| OobDataRead | 1074033415 | Devuelve información sobre datos fuera de banda que esperan ser recibidos. |
...
| GetQos | -939524089 | Recupera la estructura QOS asociada al socket. |
...
| MulticastScope | -2013265910 | Controla el número de veces que un paquete multicast puede ser reenviado por un enrutador, también conocido como TTL o recuento de saltos. |
| SetQos | -2013265909 | Establece los atributos QOS para el socket. |
| SetGroupQos | -2013265908 | Establece los atributos QOS para el grupo de sockets. |
| TranslateHandle | -939524083 | Devuelve un identificador para el socket que es válido en el contexto de una interfaz compañera. |
| RoutingInterfaceQuery | -939524076 | Devuelve las direcciones de interfaz que pueden usarse para conectarse a la dirección remota especificada. |
| RoutingInterfaceChange | -2013265899 | Habilita la recepción de una notificación cuando la interfaz local utilizada para acceder a un punto final remoto cambia. |
| AddressListQuery | 1207959574 | Devuelve la lista de interfaces locales a las que el socket puede enlazarse. |
| AddressListChange | 671088663 | Habilita la recepción de una notificación cuando la lista de interfaces locales para la familia de protocolos del socket cambie. |
| QueryTargetPnpHandle | 1207959576 | Recupera el identificador SOCKET del proveedor subyacente. |
| NamespaceChange | -2013265895 | Controla si el socket recibe notificación cuando una consulta de espacio de nombres se vuelve inválida. |
...
| ReceiveAllMulticast | -1744830462 | Habilita la recepción de todos los paquetes IPv4 multicast en la red. |
| ReceiveAllIgmpMulticast | -1744830461 | Habilita la recepción de todos los paquetes IGMP en la red. |
| KeepAliveValues | -1744830460 | Controla el envío de paquetes TCP keep-alive y el intervalo entre envíos. |
...
| BindToInterface | -1744830456 | Enlaza el socket a un índice de interfaz especificado. |
| MulticastInterface | -1744830455 | Establece la interfaz utilizada para los paquetes multicast salientes. |
| AddMulticastGroupOnInterface | -1744830454 | Une un grupo multicast usando una interfaz identificada por su índice. |
