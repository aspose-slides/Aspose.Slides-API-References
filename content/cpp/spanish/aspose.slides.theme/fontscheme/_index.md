...
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() override | Devuelve la colección de fuentes para la parte "heading" de la diapositiva. Solo lectura [IFonts](../../aspose.slides/ifonts/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() override | Devuelve la colección de fuentes para la parte "body" de la diapositiva. Solo lectura [IFonts](../../aspose.slides/ifonts/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Devuelve el nombre del esquema de fuentes. Lectura [System::String](../../system/string/). |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Devuelve el nombre del esquema de fuentes. Escritura [System::String](../../system/string/). |
