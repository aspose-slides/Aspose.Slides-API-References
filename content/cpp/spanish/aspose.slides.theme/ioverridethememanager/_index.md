...
| Método | Descripción |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | Aplica un esquema de colores adicional a una diapositiva. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithememanager/createthemeeffective/)() | Devuelve el objeto de tema. |
...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | Determina si [OverrideTheme](../overridetheme/) sobrescribe el tema efectivo heredado o no. Para habilitar [OverrideTheme](../overridetheme/) para sobrescribir use los métodos OverrideTheme.Init*(). Para deshabilitar [OverrideTheme](../overridetheme/) de sobrescribir use el método [get_OverrideTheme()](./get_overridetheme/)->Clear(). Solo lectura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() | Devuelve el objeto de tema sobrescrito. Lectura [IOverrideTheme](../ioverridetheme/). |
...
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) | Devuelve el objeto de tema sobrescrito. Escritura [IOverrideTheme](../ioverridetheme/). |
...
* Clase [IThemeManager](../ithememanager/)
