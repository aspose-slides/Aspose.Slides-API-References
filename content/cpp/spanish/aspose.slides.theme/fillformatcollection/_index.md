...
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtiene el iterador que apunta al primer elemento (si lo hay) de la instancia const-qualified de la colección. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtiene el iterador que apunta al primer elemento const-qualified (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtiene el iterador que apunta justo después del último elemento const-qualified (si lo hay) de la colección. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\>\>, **int32_t**) override | Copia todos los elementos de la colección al arreglo especificado. |
| virtual void [CopyTo](../../aspose.slides/igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Copia todos los elementos de la colección al arreglo especificado. |
| [iterator](./iterator/) [end](./end/)() | Obtiene el iterador que apunta justo después del último elemento (si lo hay) de la colección. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtiene el iterador que apunta justo después del último elemento (si lo hay) de la instancia const-qualified de la colección. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula la comparación de punto flotante al estilo de C# donde dos NaN se consideran iguales aunque según IEC 60559:1989 NaN no sea igual a ningún valor, incluido NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula la comparación de punto flotante al estilo de C# donde dos NaN se consideran iguales aunque según IEC 60559:1989 NaN no sea igual a ningún valor, incluido NaN. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que recorre la colección. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo al método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite el hash de objetos personalizados. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtiene el tipo real del objeto. Análogo a la llamada C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [idx_get](./idx_get/)(**int32_t**) override | Obtiene el elemento en el índice especificado. Solo lectura [IFillFormat](../../aspose.slides/ifillformat/). |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Devuelve el elemento en el índice especificado en una secuencia. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Devuelve el elemento en el índice especificado en una secuencia. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructor de copia. No copia nada, realmente, solo inicializa un nuevo objeto y permite la copia-construcción de subclases. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de asignación. No copia nada, realmente, solo inicializa un nuevo objeto y permite la copia-construcción de subclases. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtiene el iterador que apunta al primer elemento (si lo hay) de la instancia const-qualified de la colección. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtiene el iterador que apunta justo después del último elemento (si lo hay) de la instancia const-qualified de la colección. |
...
* Clase [IFillFormatCollection](../ifillformatcollection/)
