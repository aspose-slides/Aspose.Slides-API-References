...
| Método | Descripción |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Aplica un esquema de color extra a una diapositiva. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | Devuelve el objeto del tema. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Determina si [OverrideTheme](../overridetheme/) sobrescribe el tema efectivo heredado o no. Para habilitar [OverrideTheme](../overridetheme/) para sobrescribir, use los métodos OverrideTheme.Init*(). Para deshabilitar [OverrideTheme](../overridetheme/) de sobrescribir, use el método [OverrideTheme::Clear](../overridetheme/clear/). Sólo lectura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Devuelve el objeto de tema sobrescrito. Lea [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Devuelve el objeto de tema sobrescrito. Escriba [IOverrideTheme](../ioverridetheme/). |
...
* Clase [IOverrideThemeManager](../ioverridethememanager/)
