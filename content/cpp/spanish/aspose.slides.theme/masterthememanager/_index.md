...
| Método | Descripción |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Aplica un esquema de color adicional a una diapositiva. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | Devuelve el objeto de tema. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Determina si [OverrideTheme](../overridetheme/) sobrescribe el tema efectivo heredado ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) o no. Leer **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Devuelve el objeto de tema sobrescrito. Leer [IMasterTheme](../imastertheme/). |
...
| void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) override | Determina si [OverrideTheme](../overridetheme/) sobrescribe el tema efectivo heredado ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) o no. Escribir **bool**. |
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) override | Devuelve el objeto de tema sobrescrito. Escribir [IMasterTheme](../imastertheme/). |
...
* Clase [IMasterThemeManager](../imasterthememanager/)
