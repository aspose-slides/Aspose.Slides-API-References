...
---
## IExtraColorSchemeCollection clase
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve un esquema de color por índice. Solo lectura [IExtraColorScheme](../iextracolorscheme/). |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Computa el promedio de una secuencia de valores que se obtienen invocando una función de transformación en cada elemento de la secuencia de entrada. |
