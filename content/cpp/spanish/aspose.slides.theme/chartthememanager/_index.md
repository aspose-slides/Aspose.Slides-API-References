...
description: Proporciona acceso a la sobrescritura del tema del gráfico.
type: docs
weight: 27
url: /es/aspose.slides.theme/chartthememanager/
---
## ChartThemeManager clase
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Determina si [OverrideTheme](../overridetheme/) reemplaza el tema efectivo heredado o no. Para habilitar [OverrideTheme](../overridetheme/) para sobrescribir, use los métodos OverrideTheme.Init*(). Para deshabilitar [OverrideTheme](../overridetheme/) de sobrescribir, use el método [OverrideTheme::Clear](../overridetheme/clear/). Solo lectura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | Devuelve el objeto de tema de sobrescritura. Lea [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Devuelve el objeto de tema de sobrescritura. Escribe [IOverrideTheme](../ioverridetheme/). |
