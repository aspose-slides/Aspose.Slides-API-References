...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](../itheme/get_colorscheme/)() | Devuelve el esquema de colores. Solo lectura [IColorScheme](../icolorscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) | Devuelve el esquema de colores adicional en el índice especificado. Este esquema no afecta la apariencia de la presentación, puede seleccionarse como esquema de colores principal para una diapositiva. Solo lectura [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() | Devuelve la colección de esquemas de colores adicionales. Estos esquemas no afectan la apariencia de la presentación, pueden seleccionarse como esquema de colores principal para una diapositiva. Solo lectura [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](../itheme/get_fontscheme/)() | Devuelve el esquema de fuentes. Solo lectura [IFontScheme](../ifontscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](../itheme/get_formatscheme/)() | Devuelve el esquema de formato de forma. Solo lectura [IFormatScheme](../iformatscheme/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Devuelve el nombre de un tema. Solo lectura [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](../itheme/geteffective/)() | Obtiene los datos de tema efectivos con la herencia aplicada. |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Devuelve el nombre de un tema. Escritura [System::String](../../system/string/). |
