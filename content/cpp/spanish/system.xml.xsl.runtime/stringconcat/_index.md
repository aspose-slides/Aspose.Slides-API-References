...
description: Concatena cadenas cuando no se conoce de antemano el número de cadenas.
type: docs
weight: 1
url: /es/system.xml.xsl.runtime/stringconcat/
---
## StringConcat clase
...
| Método | Descripción |
| --- | --- |
| void [Clear](./clear/)() | Limpia la cadena de resultado. |
| void [Concat](./concat/)(const [String](../../system/string/)\&) | Concatena una nueva cadena al resultado. |
...
| [String](../../system/string/) [get_Delimiter](./get_delimiter/)() | Devuelve la cadena que delimita las cadenas concatenadas. |
...
| [String](../../system/string/) [GetResult](./getresult/)() | Devuelve la cadena de resultado. |
...
| void [set_Delimiter](./set_delimiter/)(const [String](../../system/string/)\&) | Establece la cadena que delimita las cadenas concatenadas. |
...
|  [StringConcat](./stringconcat/)() | Constructor predeterminado. |
...
* Espacio de nombres [System::Xml::Xsl::Runtime](../)
