...
description: Representa una colección de nodos que pueden ser accedidos por nombre o índice.
type: docs
weight: 287
url: /es/system.xml/xmlnamednodemap/
---
## XmlNamedNodeMap clase

Representa una colección de nodos que pueden ser accedidos por nombre o índice.
...
| Método | Descripción |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() const | Obtiene un iterador al primer elemento de la colección. |
...
| [iterator](./iterator/) [cbegin](./cbegin/)() const | Obtiene un iterador al primer elemento de la colección. |
| [iterator](./iterator/) [cend](./cend/)() const | Obtiene un iterador para un elemento inexistente detrás del último elemento de la colección. |
| [iterator](./iterator/) [end](./end/)() const | Obtiene un iterador para un elemento inexistente detrás del último elemento de la colección. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Devuelve el número de nodos en el [XmlNamedNodeMap](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](./getenumerator/)() override | Proporciona soporte para la iteración sobre la colección de nodos en el [XmlNamedNodeMap](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/)) | Recupera un [XmlNode](../xmlnode/) especificado por nombre. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/), [String](../../system/string/)) | Recupera un nodo con los valores coincidentes [XmlNode::get_LocalName](../xmlnode/get_localname/) y [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Item](./item/)(**int32_t**) | Recupera el nodo en el índice especificado en el [XmlNamedNodeMap](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/)) | Elimina el nodo del [XmlNamedNodeMap](./). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/), [String](../../system/string/)) | Elimina un nodo con los valores coincidentes [XmlNode::get_LocalName](../xmlnode/get_localname/) y [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SetNamedItem](./setnameditem/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Agrega un [XmlNode](../xmlnode/) usando su valor [XmlNode::get_Name](../xmlnode/get_name/). |
