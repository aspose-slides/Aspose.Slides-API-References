...
description: Representa la declaración del tipo de documento.
type: docs
weight: 209
url: /es/system.xml/xmldocumenttype/
---
## XmlDocumentType clase
...
| Método | Descripción |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Añade el nodo especificado al final de la lista de nodos hijo de este nodo. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Entities](./get_entities/)() | Devuelve la colección de nodos [XmlEntity](../xmlentity/) declarados en la declaración del tipo de documento. |
...
| [String](../../system/string/) [get_InternalSubset](./get_internalsubset/)() | Devuelve el valor del subconjunto interno de la definición del tipo de documento (DTD) en la declaración DOCTYPE. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Devuelve el nodo inmediatamente posterior a este nodo. |
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | Devuelve el tipo del nodo actual. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Notations](./get_notations/)() | Devuelve la colección de nodos [XmlNotation](../xmlnotation/) presentes en la declaración del tipo de documento. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Devuelve el nodo inmediatamente anterior a este nodo. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Devuelve el valor del identificador público en la declaración DOCTYPE. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Devuelve el conjunto de información posterior a la validación del esquema que se ha asignado a este nodo como resultado de la validación del esquema. |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Devuelve el valor del identificador del sistema en la declaración DOCTYPE. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Busca la declaración **xmlns** más cercana para el prefijo dado que está en el ámbito del nodo actual y devuelve el URI del espacio de nombres en la declaración. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Busca la declaración **xmlns** más cercana para el URI del espacio de nombres dado que está en el ámbito del nodo actual y devuelve el prefijo definido en esa declaración. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Devuelve el primer elemento hijo con los valores especificados [XmlNode::get_LocalName](../xmlnode/get_localname/) y [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](../xmlnode/insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Inserta el nodo especificado inmediatamente después del nodo referencia especificado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](../xmlnode/insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Inserta el nodo especificado inmediatamente antes del nodo referencia especificado. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Pone todos los nodos [XmlText](../xmltext/) en toda la profundidad del sub-árbol bajo este [XmlNode](../xmlnode/) en una forma "normal" donde solo el marcado (es decir, etiquetas, comentarios, instrucciones de procesamiento, secciones CDATA y referencias a entidades) separa los nodos [XmlText](../xmltext/), es decir, no hay nodos [XmlText](../xmltext/) adyacentes. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Añade el nodo especificado al principio de la lista de nodos hijo de este nodo. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Guarda todos los hijos del nodo en el [XmlWriter](../xmlwriter/) especificado. Para nodos [XmlDocumentType](./), este método no tiene efecto. |
