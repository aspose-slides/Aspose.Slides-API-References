...
description: Proporciona acceso de solo lectura a un conjunto de asignaciones de prefijo y espacio de nombres.
type: docs
weight: 53
url: /es/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver clase
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | Devuelve el URI del espacio de nombres asignado al prefijo especificado. |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | Devuelve el prefijo que está asignado al URI de espacio de nombres especificado. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el argumento de plantilla n-ésimo como un puntero débil (en lugar de compartido). Permite cambiar los punteros en contenedores a modo débil. |
