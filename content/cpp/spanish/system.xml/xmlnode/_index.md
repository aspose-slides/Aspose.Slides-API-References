...
description: Representa un único nodo en el documento XML.
type: docs
weight: 326
url: /es/system.xml/xmlnode/
---
## Clase XmlNode
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [Clone](./clone/)() | Crea un duplicado de este nodo. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [CloneNode](./clonenode/)(**bool**) | Crea un duplicado del nodo, cuando se sobrescribe en una clase derivada. |
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](./createnavigator/)() override | Crea un XPathNavigator para navegar este objeto. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttributeCollection](../xmlattributecollection/)\> [get_Attributes](./get_attributes/)() | Devuelve un [XmlAttributeCollection](../xmlattributecollection/) que contiene los atributos de este nodo. |
| virtual [String](../../system/string/) [get_BaseURI](./get_baseuri/)() | Devuelve el URI base del nodo actual. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [get_ChildNodes](./get_childnodes/)() | Devuelve todos los nodos hijos del nodo. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_FirstChild](./get_firstchild/)() | Devuelve el primer hijo del nodo. |
| virtual **bool** [get_HasChildNodes](./get_haschildnodes/)() | Devuelve un valor que indica si este nodo tiene nodos hijos. |
| virtual [String](../../system/string/) [get_InnerText](./get_innertext/)() | Devuelve los valores concatenados del nodo y todos sus nodos hijos. |
| virtual [String](../../system/string/) [get_InnerXml](./get_innerxml/)() | Devuelve el marcado que representa solo los nodos hijos de este nodo. |
| virtual **bool** [get_IsReadOnly](./get_isreadonly/)() | Devuelve un valor que indica si el nodo es de solo lectura. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_LastChild](./get_lastchild/)() | Devuelve el último hijo del nodo. |
| virtual [String](../../system/string/) [get_LocalName](./get_localname/)() | Devuelve el nombre local del nodo, cuando se sobrescribe en una clase derivada. |
| virtual [String](../../system/string/) [get_Name](./get_name/)() | Devuelve el nombre calificado del nodo, cuando se sobrescribe en una clase derivada. |
| virtual [String](../../system/string/) [get_NamespaceURI](./get_namespaceuri/)() | Devuelve el URI del espacio de nombres de este nodo. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_NextSibling](./get_nextsibling/)() | Devuelve el nodo que sigue inmediatamente a este nodo. |
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() | Devuelve el tipo del nodo actual, cuando se sobrescribe en una clase derivada. |
| virtual [String](../../system/string/) [get_OuterXml](./get_outerxml/)() | Devuelve el marcado que contiene este nodo y todos sus nodos hijos. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](./get_ownerdocument/)() | Devuelve el [XmlDocument](../xmldocument/) al que pertenece este nodo. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_ParentNode](./get_parentnode/)() | Devuelve el padre de este nodo (para nodos que pueden tener padres). |
| virtual [String](../../system/string/) [get_Prefix](./get_prefix/)() | Devuelve el prefijo del espacio de nombres de este nodo. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_PreviousSibling](./get_previoussibling/)() | Devuelve el nodo que precede inmediatamente a este nodo. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_PreviousText](./get_previoustext/)() | Devuelve el nodo de texto que precede inmediatamente a este nodo. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() | Devuelve el conjunto de información de validación de esquema posterior que ha sido asignado a este nodo como resultado de la validación de esquema. |
| virtual [String](../../system/string/) [get_Value](./get_value/)() | Devuelve el valor del nodo. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>\>\> [GetEnumerator](./getenumerator/)() override | Devuelve un enumerador que itera a través de los nodos hijos en el nodo actual. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo al método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite el hash de objetos personalizados. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](./getnamespaceofprefix/)([String](../../system/string/)) | Busca la declaración **xmlns** más cercana para el prefijo dado que está en alcance del nodo actual y devuelve el URI del espacio de nombres en la declaración. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](./getprefixofnamespace/)([String](../../system/string/)) | Busca la declaración **xmlns** más cercana para el URI del espacio de nombres dado que está en alcance del nodo actual y devuelve el prefijo definido en esa declaración. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtiene el tipo real del objeto. Análogo a la llamada C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](./idx_get/)([String](../../system/string/)) | Devuelve el primer elemento hijo con el [XmlNode::get_Name](./get_name/) especificado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](./idx_get/)([String](../../system/string/), [String](../../system/string/)) | Devuelve el primer elemento hijo con los valores [XmlNode::get_LocalName](./get_localname/) y [XmlNode::get_NamespaceURI](./get_namespaceuri/) especificados. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [InsertAfter](./insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Inserta el nodo especificado inmediatamente después del nodo de referencia especificado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [InsertBefore](./insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Inserta el nodo especificado inmediatamente antes del nodo de referencia especificado. |
...
| virtual void [Normalize](./normalize/)() | Coloca todos los nodos [XmlText](../xmltext/) en la profundidad completa del subárbol bajo este [XmlNode](./) en una forma "normal" donde solo el marcado (es decir, etiquetas, comentarios, instrucciones de procesamiento, secciones CDATA y referencias de entidad) separa los nodos [XmlText](../xmltext/), es decir, no hay nodos [XmlText](../xmltext/) adyacentes. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [PrependChild](./prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Agrega el nodo especificado al comienzo de la lista de nodos hijos de este nodo. |
...
| virtual void [RemoveAll](./removeall/)() | Elimina todos los nodos hijos y/o atributos del nodo actual. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [RemoveChild](./removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Elimina el nodo hijo especificado. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [ReplaceChild](./replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Reemplaza el nodo hijo **oldChild** con el nodo **newChild**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](./selectnodes/)(const [String](../../system/string/)\&) | Selecciona una lista de nodos que coinciden con la expresión [XPath](../../system.xml.xpath/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](./selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Selecciona una lista de nodos que coinciden con la expresión [XPath](../../system.xml.xpath/). Cualquier prefijo encontrado en la expresión [XPath](../../system.xml.xpath/) se resuelve usando el [XmlNamespaceManager](../xmlnamespacemanager/) proporcionado. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [SelectSingleNode](./selectsinglenode/)(const [String](../../system/string/)\&) | Selecciona el primer [XmlNode](./) que coincide con la expresión [XPath](../../system.xml.xpath/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [SelectSingleNode](./selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Selecciona el primer [XmlNode](./) que coincide con la expresión [XPath](../../system.xml.xpath/). Cualquier prefijo encontrado en la expresión [XPath](../../system.xml.xpath/) se resuelve usando el [XmlNamespaceManager](../xmlnamespacemanager/) suministrado. |
| virtual void [set_InnerText](./set_innertext/)([String](../../system/string/)) | Establece los valores concatenados del nodo y todos sus nodos hijos. |
| virtual void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) | Establece el marcado que representa solo los nodos hijos de este nodo. |
| virtual void [set_Prefix](./set_prefix/)([String](../../system/string/)) | Establece el prefijo del espacio de nombres de este nodo. |
| virtual void [set_Value](./set_value/)([String](../../system/string/)) | Establece el valor del nodo. |
...
| virtual **bool** [Supports](./supports/)([String](../../system/string/), [String](../../system/string/)) | Prueba si la implementación DOM implementa una característica específica. |
...
| virtual void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Guarda todos los nodos hijos del nodo en el [XmlWriter](../xmlwriter/) especificado, cuando se sobrescribe en una clase derivada. |
| virtual void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Guarda el nodo actual en el [XmlWriter](../xmlwriter/) especificado, cuando se sobrescribe en una clase derivada. |
