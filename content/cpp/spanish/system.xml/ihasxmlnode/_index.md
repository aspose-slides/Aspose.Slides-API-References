...
description: Permite a una clase devolver un XmlNode desde el contexto o posición actual.
type: docs
weight: 27
url: /es/system.xml/ihasxmlnode/
---
## IHasXmlNode clase

Permite a una clase devolver un [XmlNode](../xmlnode/) desde el contexto o posición actual.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNode](./getnode/)() | Devuelve el [XmlNode](../xmlnode/) para la posición actual. |
