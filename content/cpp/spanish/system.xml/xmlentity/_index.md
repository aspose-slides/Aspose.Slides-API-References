...
description: Representa una declaración de entidad, como <!ENTITY... >.
type: docs
weight: 235
url: /es/system.xml/xmlentity/
---
## XmlEntity clase
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Crea un duplicado de este nodo. Los nodos de entidad no pueden clonarse. Llamar a este método en un objeto [XmlEntity](./) lanza una excepción. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Devuelve los valores concatenados del nodo de entidad y todos sus hijos. |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Devuelve el nombre del nodo sin el prefijo del espacio de nombres. |
...
| [String](../../system/string/) [get_NotationName](./get_notationname/)() | Devuelve el nombre del atributo opcional NDATA en la declaración de entidad. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Devuelve el valor del identificador público en la declaración de entidad. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Devuelve el conjunto de información post validación de esquema que se ha asignado a este nodo como resultado de la validación de esquema. |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Devuelve el valor del identificador del sistema en la declaración de entidad. |
...
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Establece los valores concatenados del nodo de entidad y todos sus hijos. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Guarda todos los hijos del nodo en el [XmlWriter](../xmlwriter/) especificado. Para nodos [XmlEntity](./), este método no tiene efecto. |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Guarda el nodo en el [XmlWriter](../xmlwriter/) especificado. Para nodos [XmlEntity](./), este método no tiene efecto. |
