...
description: Representa una instrucción de procesamiento, que XML define para mantener información específica del procesador en el texto del documento.
type: docs
weight: 404
url: /es/system.xml/xmlprocessinginstruction/
---
## XmlProcessingInstruction clase
...
| [String](../../system/string/) [get_Data](./get_data/)() | Devuelve el contenido de la instrucción de procesamiento, excluyendo el objetivo. |
...
| [String](../../system/string/) [get_Target](./get_target/)() | Devuelve el objetivo de la instrucción de procesamiento. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Busca la declaración **xmlns** más cercana para el prefijo dado que está en ámbito del nodo actual y devuelve el URI del espacio de nombres en la declaración. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Busca la declaración **xmlns** más cercana para el URI del espacio de nombres dado que está en ámbito del nodo actual y devuelve el prefijo definido en esa declaración. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Devuelve el primer elemento de la secuencia que satisface una condición o un valor por defecto si no se encuentra tal elemento. |
...
|   [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructor de copia. No copia nada, en realidad, solo inicializa un nuevo objeto y permite la copia-construcción de subclases. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de asignación. No copia nada, en realidad, solo inicializa un nuevo objeto y permite la copia-construcción de subclases. |
...
| void [set_Data](./set_data/)(const [String](../../system/string/)\&) | Establece el contenido de la instrucción de procesamiento, excluyendo el objetivo. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el n'th argumento de plantilla como un puntero débil (en lugar de compartido). Permite cambiar punteros en contenedores a modo débil. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Guarda todos los hijos del nodo en el [XmlWriter](../xmlwriter/) especificado. Debido a que los nodos ProcessingInstruction no tienen hijos, este método no tiene efecto. |
