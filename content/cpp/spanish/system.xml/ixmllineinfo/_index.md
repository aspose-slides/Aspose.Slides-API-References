...
description: Proporciona una interfaz para permitir que una clase devuelva información de línea y posición.
type: docs
weight: 40
url: /es/system.xml/ixmllineinfo/
---
## IXmlLineInfo clase
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Devuelve el número de línea actual. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Devuelve la posición de línea actual. |
...
| virtual **bool** [HasLineInfo](./haslineinfo/)() | Devuelve un valor que indica si la clase puede devolver información de línea. |
