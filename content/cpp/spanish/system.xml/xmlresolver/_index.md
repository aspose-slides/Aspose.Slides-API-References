...
description: Resuelve recursos XML externos nombrados por un Identificador Uniforme de Recursos (URI).
type: docs
weight: 456
url: /es/system.xml/xmlresolver/
---
## XmlResolver clase
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetEntity](./getentity/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), const [TypeInfo](../../system/typeinfo/)\&) | Cuando se sobrescribe en una clase derivada, asigna un URI a un objeto que contiene el recurso real. |
...
| void [Lock](../../system/object/lock/)() | Implementa el bloqueo del enunciado lock() de C#. Llámese directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) | Cuando se sobrescribe en una clase derivada, resuelve el URI absoluto a partir del URI base y los URIs relativos. |
| virtual void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) | Cuando se sobrescribe en una clase derivada, establece las credenciales usadas para autenticar solicitudes web. |
...
| virtual **bool** [SupportsType](./supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | Permite que el resolvedor devuelva tipos distintos de Stream. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa el desbloqueo del enunciado lock() de C#. Llámese directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
