...
description: Representa una colección de atributos que pueden ser accedidos por nombre o índice.
type: docs
weight: 92
url: /es/system.xml/xmlattributecollection/
---
## XmlAttributeCollection clase


Representa una colección de atributos que pueden ser accedidos por nombre o índice.
...
| Método | Descripción |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [Append](./append/)(const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&) | Inserta el atributo especificado como el último nodo en la colección. |
| [iterator](../xmlnamednodemap/iterator/) [begin](../xmlnamednodemap/begin/)() const | Obtiene un iterador al primer elemento de la colección. |
...
| [iterator](../xmlnamednodemap/iterator/) [cbegin](../xmlnamednodemap/cbegin/)() const | Obtiene un iterador al primer elemento de la colección. |
| [iterator](../xmlnamednodemap/iterator/) [cend](../xmlnamednodemap/cend/)() const | Obtiene un iterador para un elemento inexistente detrás del último elemento de la colección. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\>\&, **int32_t**) | Copia todos los objetos [XmlAttribute](../xmlattribute/) de esta colección en la matriz dada. |
| [iterator](../xmlnamednodemap/iterator/) [end](../xmlnamednodemap/end/)() const | Obtiene un iterador para un elemento inexistente detrás del último elemento de la colección. |
...
| virtual **int32_t** [get_Count](../xmlnamednodemap/get_count/)() | Devuelve el número de nodos en el [XmlNamedNodeMap](../xmlnamednodemap/). |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnamednodemap/getenumerator/)() override | Proporciona soporte para iterar sobre la colección de nodos en el [XmlNamedNodeMap](../xmlnamednodemap/). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](../xmlnamednodemap/getnameditem/)([String](../../system/string/)) | Recupera un [XmlNode](../xmlnode/) especificado por nombre. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](../xmlnamednodemap/getnameditem/)([String](../../system/string/), [String](../../system/string/)) | Recupera un nodo con los valores coincidentes [XmlNode::get_LocalName](../xmlnode/get_localname/) y [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [idx_get](./idx_get/)(**int32_t**) | Devuelve el atributo con el índice especificado. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Devuelve el atributo con el nombre especificado. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Devuelve el atributo con el nombre local y el URI del espacio de nombres especificados. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [InsertAfter](./insertafter/)(const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&) | Inserta el atributo especificado inmediatamente después del atributo de referencia especificado. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [InsertBefore](./insertbefore/)(const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&) | Inserta el atributo especificado inmediatamente antes del atributo de referencia especificado. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Item](../xmlnamednodemap/item/)(**int32_t**) | Recupera el nodo en el índice especificado en el [XmlNamedNodeMap](../xmlnamednodemap/). |
...
| void [Lock](../../system/object/lock/)() | Implementa la instrucción C# lock(). Llámelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [Prepend](./prepend/)(const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&) | Inserta el atributo especificado como el primer nodo en la colección. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>\&) | Elimina el atributo especificado de la colección. |
| void [RemoveAll](./removeall/)() | Elimina todos los atributos de la colección. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [RemoveAt](./removeat/)(**int32_t**) | Elimina el atributo correspondiente al índice especificado de la colección. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](../xmlnamednodemap/removenameditem/)([String](../../system/string/)) | Elimina el nodo del [XmlNamedNodeMap](../xmlnamednodemap/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](../xmlnamednodemap/removenameditem/)([String](../../system/string/), [String](../../system/string/)) | Elimina un nodo con los valores coincidentes [XmlNode::get_LocalName](../xmlnode/get_localname/) y [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SetNamedItem](./setnameditem/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Añade un [XmlNode](../xmlnode/) usando su resultado [XmlNode::get_Name](../xmlnode/get_name/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa la instrucción C# lock() de desbloqueo. Llámelo directamente o use el objeto centinela [LockContext](../../system/lockcontext/). |
...
Los objetos de esta clase sólo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree instancias de este tipo en la pila o usando el operador new, ya que producirá errores de tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento. 
