...
description: Representa un nodo de referencia de entidad.
type: docs
weight: 248
url: /es/system.xml/xmlentityreference/
---
## XmlEntityReference clase
...
| Método | Descripción |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Agrega el nodo especificado al final de la lista de nodos hijo de este nodo. |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Devuelve el Identificador Uniforme de Recurso (URI) base del nodo actual. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [get_ChildNodes](../xmlnode/get_childnodes/)() | Devuelve todos los nodos hijo del nodo. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Devuelve un valor que indica si este nodo tiene nodos hijo. |
| virtual [String](../../system/string/) [get_InnerText](../xmlnode/get_innertext/)() | Devuelve los valores concatenados del nodo y todos sus nodos hijo. |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Devuelve el marcado que representa solo los nodos hijo de este nodo. |
...
| [String](../../system/string/) [get_Name](./get_name/)() override | Devuelve el nombre del nodo. |
...
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Devuelve el marcado que contiene este nodo y todos sus nodos hijo. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Devuelve el conjunto de información posterior a la validación de esquema que ha sido asignado a este nodo como resultado de la validación de esquema. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Devuelve el valor del nodo. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Devuelve un enumerador que itera a través de los nodos hijo en el nodo actual. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Agrega el nodo especificado al principio de la lista de nodos hijo para este nodo. |
...
| virtual void [RemoveAll](../xmlnode/removeall/)() | Elimina todos los nodos hijo y/o atributos del nodo actual. |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Establece los valores concatenados del nodo y todos sus nodos hijo. |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Establece el marcado que representa solo los nodos hijo de este nodo. |
...
Los objetos de esta clase deben asignarse solo mediante la función [System::MakeObject()](../../system/makeobject/). Nunca cree instancias de este tipo en la pila ni usando el operador new, ya que provocará errores en tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento.
