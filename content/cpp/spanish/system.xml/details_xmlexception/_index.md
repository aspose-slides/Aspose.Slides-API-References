...
description: Devuelve información detallada sobre la última excepción.
type: docs
weight: 1
url: /es/system.xml/details_xmlexception/
---
## Details_XmlException clase
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Devuelve el número de línea que indica dónde ocurrió el error. Los números de línea comienzan en 1. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Devuelve la posición en la línea que indica dónde ocurrió el error. La posición en la línea comienza en 1. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Devuelve un mensaje que describe la excepción actual. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Devuelve la ubicación del archivo XML. |
