...
description: "InvalidCastException se lanza cuando se intenta una operación de conversión explícita no válida. Nunca cree instancias de esta clase manualmente. Use la clase InvalidCastException en su lugar. Nunca envuelva las instancias de la clase InvalidCastException en System::SmartPtr."
type: docs
weight: 495
url: /es/system/details_invalidcastexception/
---
## Details_InvalidCastException clase

InvalidCastException se lanza cuando se intenta una operación de conversión explícita no válida. Nunca cree instancias de esta clase manualmente. Use la clase InvalidCastException en su lugar. Nunca envuelva las instancias de la clase InvalidCastException en [System::SmartPtr](../smartptr/).
