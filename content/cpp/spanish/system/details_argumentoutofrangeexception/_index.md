...
description: "ArgumentOutOfRangeException se lanza cuando un método invocado recibe un argumento que está fuera del rango de valores esperado para ese argumento. Nunca cree instancias de esta clase manualmente. Use la clase ArgumentOutOfRangeException en su lugar. Nunca envuelva las instancias de la clase ArgumentOutOfRangeException en System::SmartPtr."
type: docs
weight: 352
url: /es/system/details_argumentoutofrangeexception/
---
## Details_ArgumentOutOfRangeException clase

ArgumentOutOfRangeException se lanza cuando un método invocado recibe un argumento que está fuera del rango de valores esperado para ese argumento. Nunca cree instancias de esta clase manualmente. Use la clase ArgumentOutOfRangeException en su lugar. Nunca envuelva las instancias de la clase ArgumentOutOfRangeException en [System::SmartPtr](../smartptr/).
...
* Clase [Details_ArgumentException](../details_argumentexception/)
