...
description: "UnauthorizedAccessException se lanza cuando el acceso es denegado por el sistema operativo debido a un error de E/S o un error de seguridad. Nunca cree instancias de esta clase manualmente. Use la clase UnauthorizedAccessException en su lugar. Nunca envuelva las instancias de la clase UnauthorizedAccessException en System::SmartPtr."
type: docs
weight: 755
url: /es/system/details_unauthorizedaccessexception/
---
## Details_UnauthorizedAccessException clase


UnauthorizedAccessException se lanza cuando el acceso es denegado por el sistema operativo debido a un error de E/S o un error de seguridad. Nunca cree instancias de esta clase manualmente. Use la clase UnauthorizedAccessException en su lugar. Nunca envuelva las instancias de la clase UnauthorizedAccessException en [System::SmartPtr](../smartptr/).
