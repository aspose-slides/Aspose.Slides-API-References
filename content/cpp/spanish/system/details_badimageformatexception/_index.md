...
description: "La excepción que se lanza cuando la imagen de archivo de una biblioteca de enlaces dinámicos (DLL) o de un programa ejecutable es inválida. Nunca cree instancias de esta clase manualmente. Use la clase BadImageFormatException en su lugar. Nunca envuelva las instancias de la clase BadImageFormatException dentro de System::SmartPtr."
type: docs
weight: 378
url: /es/system/details_badimageformatexception/
---
## Details_BadImageFormatException clase


La excepción que se lanza cuando la imagen de archivo de una biblioteca de enlaces dinámicos (DLL) o de un programa ejecutable es inválida. Nunca cree instancias de esta clase manualmente. Use la clase BadImageFormatException en su lugar. Nunca envuelva las instancias de la clase BadImageFormatException dentro de [System::SmartPtr](../smartptr/).
...
| Método | Descripción |
| --- | --- |
| virtual **bool** [Equals](../object/equals/)([ptr](../object/ptr/)) | Compara objetos utilizando la semántica de C# [Object.Equals](../object/equals/). |
...
| virtual [String](../string/) [get_FileName](../details_exceptionwithfilename/get_filename/)() const | Obtiene el nombre del archivo que causa esta excepción. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](../details_systemexception/gettype/)() const override | Obtiene el tipo real del objeto. Análogo a la llamada C# [System.Object.GetType()](../object/gettype/). |
...
* Clase [Details_ExceptionWithFilename](../details_exceptionwithfilename/)
