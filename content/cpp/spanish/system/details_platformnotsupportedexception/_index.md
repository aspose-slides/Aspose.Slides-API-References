...
description: "PlatformNotSupportedException se lanza cuando una característica no se ejecuta en una plataforma particular. Nunca cree instancias de esta clase manualmente. Use la clase PlatformNotSupportedException en su lugar. Nunca envuelva las instancias de la clase PlatformNotSupportedException en System::SmartPtr."
type: docs
weight: 664
url: /es/system/details_platformnotsupportedexception/
---
## Details_PlatformNotSupportedException clase


PlatformNotSupportedException se lanza cuando una característica no se ejecuta en una plataforma particular. Nunca cree instancias de esta clase manualmente. Use la clase PlatformNotSupportedException en su lugar. Nunca envuelva las instancias de la clase PlatformNotSupportedException dentro de [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementa la operación de bloqueo de la sentencia C# lock(). Llame directamente o use el objeto centinela [LockContext](../lockcontext/). |
...
* Clase [Details_NotSupportedException](../details_notsupportedexception/)
