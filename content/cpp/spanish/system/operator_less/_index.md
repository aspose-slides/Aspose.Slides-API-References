...
| --- | --- | --- |
| some | const T1\& | Una referencia constante al valor que se usará como primer operando |
| other | const [Nullable](../nullable/)\<T2\>\& | Una referencia constante al objeto [Nullable](../nullable/) cuyo valor representado se usará como segundo operando |

### Valor de retorno

True si el primer operando es menor que el segundo operando, de lo contrario - false
