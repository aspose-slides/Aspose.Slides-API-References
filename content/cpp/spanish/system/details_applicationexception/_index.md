...
description: "Clase base para clases que representan excepciones de aplicación (en lugar de del sistema). Nunca cree instancias de esta clase manualmente. Use la clase ApplicationException en su lugar. Nunca envuelva las instancias de la clase ApplicationException en System::SmartPtr."
type: docs
weight: 313
url: /es/system/details_applicationexception/
---
## Details_ApplicationException clase


Una clase base para clases que representan excepciones de aplicación (en lugar de del sistema). Nunca cree instancias de esta clase manualmente. Use la clase ApplicationException en su lugar. Nunca envuelva las instancias de la clase ApplicationException en [System::SmartPtr](../smartptr/).
...
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | Sólo para usos internos. |
...
| virtual const char * [what](../details_exception/what/)() const | Implementa el método [what()](../details_exception/what/) que es llamado por la clase [ExceptionWrapper](../exceptionwrapper/). A pesar de que esta clase no hereda de std::exception, las clases derivadas pueden usar miembros protegidos/privados para implementar su lógica. Mover la implementación de este método a [ExceptionWrapper](../exceptionwrapper/) puede romper esa lógica. |
