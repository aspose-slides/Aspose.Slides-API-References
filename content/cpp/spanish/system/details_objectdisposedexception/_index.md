...
description: "ObjectDisposedException se lanza cuando se invoca un método en un objeto eliminado. Nunca cree instancias de esta clase manualmente. Use la clase ObjectDisposedException en su lugar. Nunca envuelva las instancias de la clase ObjectDisposedException en System::SmartPtr."
type: docs
weight: 612
url: /es/system/details_objectdisposedexception/
---
## Details_ObjectDisposedException clase

ObjectDisposedException se lanza cuando se invoca un método en un objeto eliminado. Nunca cree instancias de esta clase manualmente. Utilice la clase ObjectDisposedException en su lugar. Nunca envuelva las instancias de la clase ObjectDisposedException en [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emula la comparación de punto flotante al estilo de C# donde dos NaN se consideran iguales aun cuando según IEC 60559:1989 NaN no es igual a ningún valor, incluido NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emula la comparación de punto flotante al estilo de C# donde dos NaN se consideran iguales aun cuando según IEC 60559:1989 NaN no es igual a ningún valor, incluido NaN. |
...
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Devuelve la cadena que contiene el rastreo de la pila. |
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Análogo al método C# [Object.GetHashCode()](../object/gethashcode/). Permite el hashing de objetos personalizados. |
...
| void [Lock](../object/lock/)() | Implementa el bloqueo de la instrucción lock() de C#. Llámelo directamente o use el objeto centinela [LockContext](../lockcontext/). |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Establece el HRESULT, un valor numérico codificado que se asigna a una excepción específica. |
...
| void [Unlock](../object/unlock/)() | Implementa el desbloqueo de la instrucción lock() de C#. Llámelo directamente o use el objeto centinela [LockContext](../lockcontext/). |
...
* Clase [Details_InvalidOperationException](../details_invalidoperationexception/)
