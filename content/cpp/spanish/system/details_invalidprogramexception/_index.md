...
description: "InvalidProgramException está presente solo por razones de compatibilidad. Nunca cree instancias de esta clase manualmente. Use la clase InvalidProgramException en su lugar. Nunca envuelva las instancias de la clase InvalidProgramException en System::SmartPtr."
type: docs
weight: 521
url: /es/system/details_invalidprogramexception/
---
## Details_InvalidProgramException clase


InvalidProgramException está presente solo por razones de compatibilidad. Nunca cree instancias de esta clase manualmente. Use la clase InvalidProgramException en su lugar. Nunca envuelva las instancias de la clase InvalidProgramException en [System::SmartPtr](../smartptr/).
...
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Devuelve un diccionario con datos personalizados de la excepción. |
