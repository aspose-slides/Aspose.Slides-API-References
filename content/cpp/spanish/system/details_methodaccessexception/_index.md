...
description: "MemberAccessException se lanza cuando se intenta acceder a un método inexistente o cuando no se permite el acceso al método. Nunca cree instancias de esta clase manualmente. Use la clase MethodAccessException en su lugar. Nunca envuelva las instancias de la clase MethodAccessException en System::SmartPtr."
type: docs
weight: 560
url: /es/system/details_methodaccessexception/
---
## Details_MethodAccessException clase
...
| void [Lock](../object/lock/)() | Implementa el bloqueo de la instrucción C# lock(). Llámelo directamente o use el objeto centinela [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Constructor de copia. No copia nada, realmente, solo inicializa un nuevo objeto y permite la copia de subclases. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operador de asignación. No copia nada, realmente, solo inicializa un nuevo objeto y permite la copia de subclases. |
...
| void [Unlock](../object/unlock/)() | Implementa el desbloqueo de la instrucción C# lock(). Llámelo directamente o use el objeto centinela [LockContext](../lockcontext/). |
...
* Clase [Details_MemberAccessException](../details_memberaccessexception/)
