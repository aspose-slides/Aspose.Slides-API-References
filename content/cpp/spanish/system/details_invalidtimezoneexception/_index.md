...
description: "InvalidTimeZoneException se lanza cuando la información de zona horaria es inválida. Nunca cree instancias de esta clase manualmente. Use la clase InvalidTimeZoneException en su lugar. Nunca envuelva las instancias de la clase InvalidTimeZoneException dentro de System::SmartPtr."
type: docs
weight: 534
url: /es/system/details_invalidtimezoneexception/
---
## Details_InvalidTimeZoneException clase

InvalidTimeZoneException se lanza cuando la información de zona horaria es inválida. Nunca cree instancias de esta clase manualmente. Use la clase InvalidTimeZoneException en su lugar. Nunca envuelva las instancias de la clase InvalidTimeZoneException dentro de [System::SmartPtr](../smartptr/).
