...
description: Versión empaquetada de tupla de valores.
type: docs
weight: 118
url: /es/system/boxedvalue_tmpl_valuetuple_tmpl_args_dots__end_tmpl__end_tmpl/
---
## BoxedValue< ValueTuple< Args... > > clase

Versión empaquetada de tupla de valores.
...
| --- | --- |
| name | Tipos de los elementos de la tupla Args. |

## Métodos

| Método | Descripción |
| --- | --- |
|  [BoxedValue](./boxedvalue/)(const [ValueT](../valuetuple/)\&) | Construye un objeto [BoxedValue](../boxedvalue/) que representa el valor especificado empaquetado. |
| **bool** [Equals](./equals/)([ptr](../object/ptr/)) override | Determina la igualdad de los valores empaquetados representados por los objetos actual y especificado. |
...
| virtual [SharedPtr](../sharedptr/)\<[Object](../object/)\> [idx_get](../../system.runtime.compilerservices/ituple/idx_get/)(**int32_t**) const | Devuelve el elemento en la posición índice. |
...
| **bool** [is](./is/)() const | Determina si el tipo del valor empaquetado representado por el objeto actual es **V**. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Establece el n-ésimo argumento de plantilla como puntero débil (en lugar de compartido). Permite cambiar punteros en contenedores al modo débil. |
...
| [String](../string/) [ToString](./tostring/)() const override | Devuelve la representación en cadena del valor empaquetado. |
| static const [TypeInfo](../typeinfo/)\& [Type](../object/type/)() | Implementa la construcción C# typeof([System.Object](../object/)). |
| const [ValueT](../valuetuple/)\& [unbox](./unbox/)() const | Desempaqueta el valor empaquetado. |
...
* Clase [ITuple](../../system.runtime.compilerservices/ituple/)
