...
description: "TimeoutException indica si el tiempo asignado a un proceso u operación ha expirado. Nunca cree instancias de esta clase manualmente. Use la clase TimeoutException en su lugar. Nunca envuelva las instancias de la clase TimeoutException en System::SmartPtr."
type: docs
weight: 716
url: /es/system/details_timeoutexception/
---
## Details_TimeoutException clase

TimeoutException indica si el tiempo asignado a un proceso u operación ha expirado. Nunca cree instancias de esta clase manualmente. Utilice la clase TimeoutException en su lugar. Nunca envuelva las instancias de la clase TimeoutException en [System::SmartPtr](../smartptr/).
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Devuelve la copia del objeto Exception que representa la excepción más interna. |
