...
description: "ArgumentException se lanza cuando un argumento pasado a un método que se está invocando es inválido. Nunca cree instancias de esta clase manualmente. Use la clase ArgumentException en su lugar. Nunca envuelva las instancias de la clase ArgumentException dentro de System::SmartPtr."
type: docs
weight: 326
url: /es/system/details_argumentexception/
---
## Details_ArgumentException clase


ArgumentException se lanza cuando un argumento pasado a un método que se está invocando es inválido. Nunca cree instancias de esta clase manualmente. Use la clase ArgumentException en su lugar. Nunca envuelva las instancias de la clase ArgumentException dentro de [System::SmartPtr](../smartptr/).
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada con el objeto. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Obtiene el tipo real del objeto. Análogo a la llamada [System.Object.GetType()](../object/gettype/) de C#. |
| **bool** [Is](./is/)(const [System::TypeInfo](../typeinfo/)\&) const override |  |
| void [Lock](../object/lock/)() | Implementa el bloqueo de la declaración lock() de C#. Llame directamente o use el objeto centinela [LockContext](../lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Establece el n-ésimo argumento de plantilla como puntero débil (en lugar de compartido). Permite cambiar los punteros en contenedores al modo débil. |
...
| void [Unlock](../object/unlock/)() | Implementa el desbloqueo de la declaración lock() de C#. Llame directamente o use el objeto centinela [LockContext](../lockcontext/). |
...
ArgumentNullException se lanza cuando un método que se está invocando recibe un argumento nulo mientras el método espera un valor no nulo. Nunca cree instancias de esta clase manualmente. Use la clase ArgumentNullException en su lugar. Nunca envuelva las instancias de la clase ArgumentNullException dentro de [System::SmartPtr](../smartptr/). 
