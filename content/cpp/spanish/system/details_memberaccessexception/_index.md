...
description: "MemberAccessException se lanza cuando se intenta acceder a un miembro de una clase que no existe o cuando el acceso al miembro no está permitido. Nunca cree instancias de esta clase manualmente. Use la clase MemberAccessException en su lugar. Nunca envuelva las instancias de la clase MemberAccessException en System::SmartPtr."
type: docs
weight: 547
url: /es/system/details_memberaccessexception/
---
## Details_MemberAccessException clase


MemberAccessException se lanza cuando se intenta acceder a un miembro de una clase que no existe o cuando el acceso al miembro no está permitido. Nunca cree instancias de esta clase manualmente. Use la clase MemberAccessException en su lugar. Nunca envuelva las instancias de la clase MemberAccessException dentro de [System::SmartPtr](../smartptr/).
