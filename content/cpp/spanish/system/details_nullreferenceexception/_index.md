...
description: "NullReferenceException se lanza cuando se intenta desreferenciar una referencia nula. Nunca cree instancias de esta clase manualmente. Use la clase NullReferenceException en su lugar. Nunca envuelva las instancias de la clase NullReferenceException en System::SmartPtr."
type: docs
weight: 599
url: /es/system/details_nullreferenceexception/
---
## Details_NullReferenceException clase

NullReferenceException se lanza cuando se intenta desreferenciar una referencia nula. Nunca cree instancias de esta clase manualmente. Utilice la clase NullReferenceException en su lugar. Nunca envuelva las instancias de la clase NullReferenceException en [System::SmartPtr](../smartptr/).
