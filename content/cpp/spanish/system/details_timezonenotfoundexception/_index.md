...
description: "TimeZoneNotFoundException se lanza cuando no se encuentra la información de zona horaria. Nunca cree instancias de esta clase manualmente. Use la clase TimeZoneNotFoundException en su lugar. Nunca envuelva las instancias de la clase TimeZoneNotFoundException dentro de System::SmartPtr."
type: docs
weight: 729
url: /es/system/details_timezonenotfoundexception/
---
## Details_TimeZoneNotFoundException clase


TimeZoneNotFoundException se lanza cuando no se encuentra la información de zona horaria. Nunca cree instancias de esta clase manualmente. Use la clase TimeZoneNotFoundException en su lugar. Nunca envuelva las instancias de la clase TimeZoneNotFoundException dentro de [System::SmartPtr](../smartptr/).
