...
description: Indica que una enumeración puede ser tratada como un campo de bits; es decir, un conjunto de.
type: docs
weight: 846
url: /es/system/flagsattribute/
---
## FlagsAttribute clase

Indica que una enumeración puede ser tratada como un campo de bits; es decir, un conjunto de.
...
| static [Object::ptr](../object/ptr/) [GetCustomAttribute](../attribute/getcustomattribute/)(const [TypeInfo](../typeinfo/)\&, const [TypeInfo](../typeinfo/)\&) | Devuelve un atributo personalizado de un tipo especificado aplicado al tipo especificado. |
| static [ArrayPtr](../arrayptr/)\<[Object::ptr](../object/ptr/)\> [GetCustomAttributes](../attribute/getcustomattributes/)(const [TypeInfo](../typeinfo/)\&) | Devuelve todos los atributos personalizados aplicados al tipo especificado. |
...
|  [Object](../object/object/)() | Crea un objeto. Inicializa todas las estructuras de datos internas. |
