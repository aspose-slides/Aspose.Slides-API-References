...
description: Construye un objeto que representa un GUID formado por ceros.
type: docs
weight: 1
url: /es/system/guid/guid/
---
## Guid::Guid() constructor

Construye un objeto que representa un GUID formado por ceros.
...
| --- | --- | --- |
| b | const [ArrayPtr](../../arrayptr/)\<**uint8_t**\>\& | Una matriz de bytes que contiene los bytes separados del GUID |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| g | const [String](../../string/)\& | La representación en cadena de un GUID que será representada por el objeto que se está construyendo |

## Guid::Guid(int32_t, int16_t, int16_t, const ArrayPtr\<uint8_t\>\&) constructor

Construye una instancia de la clase [Guid](../) a partir de los componentes del GUID especificados.
...
| d | const [ArrayPtr](../../arrayptr/)\<**uint8_t**\>\& | Una matriz de bytes que contiene los bits 64-127 del GUID |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| guid | const [Guid](../)\& | El objeto [Guid](../) del cual copiar el valor del GUID |
