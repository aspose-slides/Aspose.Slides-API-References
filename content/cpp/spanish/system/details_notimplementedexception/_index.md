...
description: "NotImplementedException se lanza cuando un método no está implementado y sirve como un stub. Nunca cree instancias de esta clase manualmente. Use la clase NotImplementedException en su lugar. Nunca envuelva las instancias de la clase NotImplementedException en System::SmartPtr."
type: docs
weight: 573
url: /es/system/details_notimplementedexception/
---
## Details_NotImplementedException clase


NotImplementedException se lanza cuando un método no está implementado y sirve como un stub. Nunca cree instancias de esta clase manualmente. Use la clase NotImplementedException en su lugar. Nunca envuelva las instancias de la clase NotImplementedException en [System::SmartPtr](../smartptr/).
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Análogo al método C# [Object.GetHashCode()](../object/gethashcode/). Permite hash de objetos personalizados. |
