...
description: Contiene métodos para trabajar con el entero sin signo de 8 bits.
type: docs
weight: 157
url: /es/system/byte/
---
...
| Método | Descripción |
| --- | --- |
| static **uint8_t** [Parse](./parse/)(const [String](../string/)\&) | Convierte la cadena especificada que contiene la representación textual de un número al entero sin signo de 8 bits equivalente. |
| static **uint8_t** [Parse](./parse/)(const [String](../string/)\&, const [SharedPtr](../sharedptr/)\<[IFormatProvider](../iformatprovider/)\>\&) | Convierte la cadena especificada que contiene la representación textual de un número al entero sin signo de 8 bits equivalente usando la información de formato proporcionada. |
...
| static **bool** [TryParse](./tryparse/)(const [String](../string/)\&, **uint8_t**\&) | Convierte la cadena especificada que contiene la representación textual de un número al entero sin signo de 8 bits equivalente. |
| static **bool** [TryParse](./tryparse/)(const [String](../string/)\&, [Globalization::NumberStyles](../../system.globalization/numberstyles/), const [SharedPtr](../sharedptr/)\<[IFormatProvider](../iformatprovider/)\>\&, **uint8_t**\&) | Convierte la cadena especificada que contiene la representación textual de un número al entero sin signo de 8 bits equivalente usando la información de formato proporcionada y el estilo de número. |
...
123
System::OverflowException: El valor era demasiado grande o demasiado pequeño para un UInt8
10
*/
```
