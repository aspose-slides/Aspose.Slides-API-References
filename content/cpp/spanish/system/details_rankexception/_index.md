...
description: "RankException se lanza cuando se pasa a un método un argumento de matriz con un número de dimensiones diferente al esperado. Nunca cree instancias de esta clase manualmente. Use la clase RankException en su lugar. Nunca envuelva las instancias de la clase RankException dentro de System::SmartPtr."
type: docs
weight: 677
url: /es/system/details_rankexception/
---
## Details_RankException clase

RankException se lanza cuando se pasa a un método un argumento de matriz con un número de dimensiones diferente al esperado. Nunca cree instancias de esta clase manualmente. Use la clase RankException en su lugar. Nunca envuelva las instancias de la clase RankException dentro de [System::SmartPtr](../smartptr/).
