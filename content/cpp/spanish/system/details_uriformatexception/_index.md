...
description: "UriFormatException se lanza cuando el formato de URI no es válido. Nunca cree instancias de esta clase manualmente. Use la clase UriFormatException en su lugar. Nunca envuelva las instancias de la clase UriFormatException en System::SmartPtr."
type: docs
weight: 768
url: /es/system/details_uriformatexception/
---
## Details_UriFormatException clase

UriFormatException se lanza cuando el formato de URI no es válido. Nunca cree instancias de esta clase manualmente. Use la clase UriFormatException en su lugar. Nunca envuelva las instancias de la clase UriFormatException en [System::SmartPtr](../smartptr/).
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Devuelve una copia del objeto Exception que representa la excepción más interior. |
...
| void [Lock](../object/lock/)() | Implementa el bloqueo de la declaración C# lock(). Llamar directamente o usar el objeto centinela [LockContext](../lockcontext/). |
...
| void [Unlock](../object/unlock/)() | Implementa el desbloqueo de la declaración C# lock(). Llamar directamente o usar el objeto centinela [LockContext](../lockcontext/). |
...
* Clase [Details_FormatException](../details_formatexception/)
