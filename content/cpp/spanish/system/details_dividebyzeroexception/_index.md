...
description: "DivideByZeroException se lanza cuando se intenta dividir por 0 en una operación aritmética. Nunca cree instancias de esta clase manualmente. Use la clase DivideByZeroException en su lugar. Nunca envuelva las instancias de la clase DivideByZeroException en System::SmartPtr."
type: docs
weight: 404
url: /es/system/details_dividebyzeroexception/
---
## Details_DivideByZeroException clase


DivideByZeroException se lanza cuando se intenta dividir por 0 en una operación aritmética. Nunca cree instancias de esta clase manualmente. Utilice la clase DivideByZeroException en su lugar. Nunca envuelva las instancias de la clase DivideByZeroException en [System::SmartPtr](../smartptr/).
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Obtiene el tipo real del objeto. Analogo de la llamada C# [System.Object.GetType()](../object/gettype/). |
...
OutOfMemoryException se lanza cuando la aplicación se queda sin memoria. Nunca cree instancias de esta clase manualmente. Utilice la clase OutOfMemoryException en su lugar. Nunca envuelva las instancias de la clase OutOfMemoryException en [System::SmartPtr](../smartptr/). 
