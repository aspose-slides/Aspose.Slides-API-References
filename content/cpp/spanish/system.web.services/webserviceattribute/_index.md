...
description: "Agrega información adicional al servicio Web XML. Los objetos de esta clase sólo deben asignarse mediante la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarla a funciones como argumento."
type: docs
weight: 27
url: /es/system.web.services/webserviceattribute/
---
## WebServiceAttribute clase

Agrega información adicional al servicio XML [Web](../../system.web/). Los objetos de esta clase sólo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento.
...
| [String](../../system/string/) [get_Description](./get_description/)() | Obtiene un mensaje que contiene la descripción del servicio XML [Web](../../system.web/). |
| [String](../../system/string/) [get_Name](./get_name/)() | Obtiene el nombre del servicio XML [Web](../../system.web/). |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Obtiene el espacio de nombres predeterminado a usar para el servicio XML [Web](../../system.web/). |
...
| void [set_Description](./set_description/)([String](../../system/string/)) | Establece un mensaje que contiene la descripción del servicio XML [Web](../../system.web/). |
| void [set_Name](./set_name/)([String](../../system/string/)) | Establece el nombre del servicio XML [Web](../../system.web/). |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Establece el espacio de nombres predeterminado a usar para el servicio XML [Web](../../system.web/). |
...
| Field | Description |
| --- | --- |
| static [DefaultNamespace](./defaultnamespace/) | El valor predeterminado de la propiedad 'Namespace'. |
