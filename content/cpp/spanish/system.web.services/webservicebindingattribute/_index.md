...
| [System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\> [get_ConformsTo](./get_conformsto/)() | Obtiene la especificación WSI. |
| **bool** [get_EmitConformanceClaims](./get_emitconformanceclaims/)() | Obtiene un valor que indica si la vinculación emite reclamaciones de conformidad. |
| [String](../../system/string/) [get_Location](./get_location/)() | Obtiene la ubicación donde se define la vinculación. |
| [String](../../system/string/) [get_Name](./get_name/)() | Obtiene el nombre de la vinculación. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Obtiene el espacio de nombres asociado a la vinculación. |
...
| void [set_ConformsTo](./set_conformsto/)([System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\>) | Establece la especificación WSI. |
| void [set_EmitConformanceClaims](./set_emitconformanceclaims/)(**bool**) | Establece un valor que indica si la vinculación emite reclamaciones de conformidad. |
| void [set_Location](./set_location/)([String](../../system/string/)) | Establece la ubicación donde se define la vinculación. |
| void [set_Name](./set_name/)([String](../../system/string/)) | Establece el nombre de la vinculación. |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Establece el espacio de nombres asociado a la vinculación. |
...
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/)) | Construye una nueva instancia. |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/)) | Construye una nueva instancia. |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | Construye una nueva instancia. |
