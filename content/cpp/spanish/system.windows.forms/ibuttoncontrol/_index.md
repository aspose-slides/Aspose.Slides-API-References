...
| virtual [DialogResult](../dialogresult/) [get_DialogResult](./get_dialogresult/)() | Obtiene el resultado del cuadro de diálogo asociado al botón. |
...
| virtual void [NotifyDefault](./notifydefault/)(**bool**) | Establece el control como predeterminado o no predeterminado. |
...
| virtual void [PerformClick](./performclick/)() | Ejecuta un clic en el botón. |
...
| virtual void [set_DialogResult](./set_dialogresult/)([DialogResult](../dialogresult/)) | Establece el resultado del cuadro de diálogo asociado al botón. |
