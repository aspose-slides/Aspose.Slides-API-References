...
description: Clase ficticia para que el código traducido que usa la clase SystemInformation sea compilable. Los métodos no están implementados. Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio.
type: docs
weight: 53
url: /es/system.windows.forms/systeminformation/
---
## SystemInformation estructura

Clase ficticia para que el código traducido que usa la clase [SystemInformation](./) sea compilable. Los métodos no están implementados. Este es un tipo estático sin servicios de instancia. Nunca debe crear instancias de él por ningún medio.
