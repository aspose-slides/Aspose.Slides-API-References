...
description: Proporciona información sobre pantallas. Solo Windows. Este es un tipo singleton con gestión de memoria realizada por función(es) de acceso. No debe crear instancias de él directamente.
type: docs
weight: 40
url: /es/system.windows.forms/screen/
---
## Screen clase

Proporciona información sobre pantallas. [Windows](../../system.windows/) solo. Este es un tipo singleton con gestión de memoria realizada por función(es) de acceso. Nunca debe crear instancias de él directamente.
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | Obtiene los límites de la pantalla. |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | Obtiene información sobre la pantalla principal. |
