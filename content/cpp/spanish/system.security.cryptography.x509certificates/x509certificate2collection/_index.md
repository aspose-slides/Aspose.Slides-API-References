...
| void [CopyTo](../../system.collections.generic/list/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copia elementos de la lista en elementos de un arreglo existente. |
| void [CopyTo](../../system.collections.generic/list/copyto/)(const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&) | Copia todos los elementos en elementos de un arreglo existente. |
| void [CopyTo](../../system.collections.generic/list/copyto/)(int, const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&, int, int) | Copia elementos a partir del índice especificado en elementos de un arreglo existente. |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | Obtiene un iterador inverso al último elemento const de la colección (el primero en reversa). |
...
| **ThisPtr** [GetRange](../../system.collections.generic/list/getrange/)(int, int) | Crea un segmento de la lista. |
...
| int [IndexOf](../../system.collections.generic/list/indexof/)(const T\&) const override | Obtiene el primer índice de un elemento específico. |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Busca el objeto especificado y devuelve el índice basado en cero de la última ocurrencia dentro del rango de elementos en el [List](../../system.collections.generic/list/) que se extiende desde el primer elemento hasta el índice especificado. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Busca el objeto especificado y devuelve el índice basado en cero de la última ocurrencia dentro del rango de elementos en el [List](../../system.collections.generic/list/) que contiene el número especificado de elementos y termina en el índice especificado. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Concat](../../system.collections.generic/ienumerable/linq_concat/)([SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\>) | Concatea dos secuencias. |
...
| **bool** [Remove](../../system.collections.generic/list/remove/)(const T\&) override | Elimina la primera instancia de un elemento específico de la lista. |
...
| void [RemoveRange](../../system.collections.generic/list/removerange/)(int, int) | Elimina un segmento de la lista. |
...
| void [Reverse](../../system.collections.generic/list/reverse/)(int, int) | Invierte el orden de los elementos del segmento de la lista. |
...
| void [Sort](../../system.collections.generic/list/sort/)(int, int, [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>) | Ordena los elementos del segmento de la lista. |
| void [Sort](../../system.collections.generic/list/sort/)([Comparison](../../system/comparison/)\<T\>, **bool**) | Ordena los elementos de la lista. |
| [ArrayPtr](../../system/arrayptr/)\<T\> [ToArray](../../system.collections.generic/list/toarray/)() const | Convierte la lista a un arreglo. |
...
| **bool** [TrueForAll](../../system.collections.generic/list/trueforall/)([System::Predicate](../../system/predicate/)\<T\>) | Determina si todos los elementos en la colección coinciden con las condiciones definidas por el predicado especificado. |
