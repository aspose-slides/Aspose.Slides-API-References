...
description: "La especialización parcial de la plantilla HttpHeaderValueCollection para el tipo String. Los objetos de esta clase deben asignarse solo usando la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila o usando operator new, ya que provocará errores de tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarlo a funciones como argumento."
type: docs
weight: 105
url: /es/system.net.http.headers/httpheadervaluecollection_tmpl_system_string__end_tmpl/
---
## HttpHeaderValueCollection< System::String > clase

La especialización parcial de la plantilla [HttpHeaderValueCollection](../httpheadervaluecollection/) para el tipo [String](../../system/string/). Los objetos de esta clase deben asignarse solo usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando operator new, ya que provocará errores de tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento.
...
| Método | Descripción |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&) override | Añade un elemento a la colección. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Obtiene el enumerador. |
...
| **bool** [Remove](./remove/)(const [String](../../system/string/)\&) override | Elimina un elemento de la colección. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Análogo al método C# [Object.ToString()](../httpheadervaluecollection/tostring/). Habilita la conversión de objetos personalizados a cadena. |
