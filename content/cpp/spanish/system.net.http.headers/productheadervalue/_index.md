...
| [String](../../system/string/) [get_Name](./get_name/)() | Devuelve el nombre del token del producto. |
| [String](../../system/string/) [get_Version](./get_version/)() | Devuelve la versión del token del producto. |
...
| static **int32_t** [GetProductLength](./getproductlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\>\&) | Convierte una cadena proporcionada desde el índice especificado a una instancia de la clase [ProductHeaderValue](./). |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Convierte una cadena proporcionada a una instancia de la clase [ProductHeaderValue](./). |
|  [ProductHeaderValue](./productheadervalue/)([String](../../system/string/)) | Construye una nueva instancia. |
|  [ProductHeaderValue](./productheadervalue/)([String](../../system/string/), [String](../../system/string/)) | Construye una nueva instancia. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\>\&) | Intenta convertir una cadena proporcionada a una instancia de la clase [ProductHeaderValue](./). |
