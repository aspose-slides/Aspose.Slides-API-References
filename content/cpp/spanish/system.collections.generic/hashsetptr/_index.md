...
description: Puntero para mantener referencias HashSet. Este tipo es un puntero para gestionar la eliminación de objetos ajenos. Debe asignarse en la pila y pasarse a funciones ya sea por valor o por referencia constante.
type: docs
weight: 235
url: /es/system.collections.generic/hashsetptr/
---
## HashSetPtr clase

Puntero para mantener [HashSet](../hashset/) referencias. Este tipo es un puntero para gestionar la eliminación de otros objetos. Debe asignarse en la pila y pasarse a funciones ya sea por valor o por referencia constante.
...
|  [HashSetPtr](./hashsetptr/)() | Constructor de puntero nulo. |
|  [HashSetPtr](./hashsetptr/)(const [SharedPtr](../../system/sharedptr/)\<[HashSet](../hashset/)\<T\>\>\&) | Constructor de copia. |
...
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | Comprueba si el puntero apunta a otro objeto distinto al propio (creado por un constructor de alias). |
...
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | Elimina el alias (creado por un constructor de alias) del puntero, asegurándose de que administre (si es compartido) o haga seguimiento (si es débil) del mismo objeto al que apunta. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Construye por copia un objeto [SmartPtr](../../system/smartptr/). Ambos punteros apuntan al mismo objeto después. Realiza conversión de tipo si está permitido. |
...
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<[Array](../../system/array/)\<Y\>\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Convierte el tipo de la matriz referenciada creando una nueva matriz de tipo diferente. Útil si en C# hay una conversión de tipo de matriz que no está soportada en C++. |
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const Y\&) | Inicializa una matriz vacía. Utilizado para traducir algunos constructos de código C#. |
