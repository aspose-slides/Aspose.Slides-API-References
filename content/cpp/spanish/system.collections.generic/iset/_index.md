...
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Obtiene un iterador que apunta al primer elemento (si lo hay) de la colección. Este iterador no puede usarse para cambiar el objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve una copia del objeto T. |
...
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la colección. Este iterador no puede usarse para cambiar el objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve una copia del objeto T. |
...
| virtual void [ExceptWith](./exceptwith/)([IEnumerablePtr](./ienumerableptr/)) | Elimina un grupo de elementos. |
...
| virtual void [IntersectWith](./intersectwith/)([IEnumerablePtr](./ienumerableptr/)) | Elimina los elementos que no están presentes en otro contenedor. |
...
| virtual **bool** [IsProperSubsetOf](./ispropersubsetof/)([IEnumerablePtr](./ienumerableptr/)) | Comprueba si el conjunto actual es un subconjunto estricto de otro contenedor. |
| virtual **bool** [IsProperSupersetOf](./ispropersupersetof/)([IEnumerablePtr](./ienumerableptr/)) | Comprueba si el conjunto actual es un superconjunto estricto de otro contenedor. |
| virtual **bool** [IsSubsetOf](./issubsetof/)([IEnumerablePtr](./ienumerableptr/)) | Comprueba si el conjunto actual es un subconjunto de otro contenedor. |
| virtual **bool** [IsSupersetOf](./issupersetof/)([IEnumerablePtr](./ienumerableptr/)) | Comprueba si el conjunto actual es un superconjunto de otro contenedor. |
...
| virtual **bool** [Overlaps](./overlaps/)([IEnumerablePtr](./ienumerableptr/)) | Comprueba si el conjunto se superpone con otro contenedor. |
...
| virtual **bool** [SetEquals](./setequals/)([IEnumerablePtr](./ienumerableptr/)) | Comprueba si el conjunto y el contenedor contienen los mismos elementos. |
...
| virtual void [SymmetricExceptWith](./symmetricexceptwith/)([IEnumerablePtr](./ienumerableptr/)) | Calcula la excepción simétrica de dos contenedores. Elimina todos los elementos que están presentes en ambos contenedores, pero al mismo tiempo agrega todos los elementos presentes en **other**, pero no en el conjunto actual. |
...
| virtual void [UnionWith](./unionwith/)([IEnumerablePtr](./ienumerableptr/)) | Agrega elementos de la colección especificada que aún no están presentes en el conjunto actual. |
...
| --- | --- |
| [IEnumerablePtr](./ienumerableptr/) | Tipo enumerable para comparar el contenido del conjunto actual con. |
