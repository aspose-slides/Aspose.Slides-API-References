...
description: "Colección de los valores del Dictionary. Referencia la colección, no copia nada. Los objetos de esta clase solo deben asignarse usando la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use ese puntero para pasarla a funciones como argumento."
type: docs
weight: 27
url: /es/system.collections.generic/_valuecollection/
---
## _ValueCollection clase

Colección de valores de [Dictionary](../dictionary/). Referencia la colección, no copia nada. Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores en tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento.
...
| Método | Descripción |
| --- | --- |
|  [_ValueCollection](./_valuecollection/)(const typename Dict::Ptr\&) | Inicializa la colección referenciando el diccionario especificado. |
| void [Add](../ikvcollection/add/)(const T\&) override | Agrega un elemento al contenedor. |
|  [BaseKVCollection](../basekvcollection/basekvcollection/)(const typename Dict::Ptr\&) | Crea la colección. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Obtiene un iterador que apunta al primer elemento (si lo hay) de la colección. Este iterador no puede usarse para modificar un objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve una copia del objeto de tipo T. |
...
| **bool** [Contains](./contains/)(const [TValue](./tvalue/)\&) const override | Comprueba si el elemento está presente en el contenedor. |
| void [CopyTo](../basekvcollection/copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | Copia los datos a los elementos existentes del array. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la colección. Este iterador no puede usarse para modificar un objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve una copia del objeto de tipo T. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TValue](./tvalue/)\>\> [GetEnumerator](./getenumerator/)() override | Obtiene un enumerador que itera a través de los valores. |
...
| [TValue](./tvalue/) [idx_get](./idx_get/)(int) const override | Implementa el método [IList](../ilist/). No soportado. |
...
| void [Insert](../ikvcollection/insert/)(int, const T\&) override | Inserta un elemento en la posición especificada. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<T\> [LINQ_ToArray](../ienumerable/linq_toarray/)() | Crea un array a partir de una secuencia. |
...
| **bool** [Remove](../ikvcollection/remove/)(const T\&) override | Elimina el elemento del contenedor. |
...
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtiene la implementación del iterador begin const para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Obtiene la implementación del iterador begin para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtiene la implementación del iterador end const para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtiene la implementación del iterador end para el contenedor actual. |
...
* Clase [BaseKVCollection](../basekvcollection/)
