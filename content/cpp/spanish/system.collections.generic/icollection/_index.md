...
description: "Interfaz de colección de elementos. Los objetos de esta clase solo deben asignarse mediante la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que provocará errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use este puntero para pasarlo a funciones como argumento."
type: docs
weight: 248
url: /es/system.collections.generic/icollection/
---
## ICollection clase

Interfaz de colección de elementos. Los objetos de esta clase solo deben asignarse utilizando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que provocará errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use este puntero para pasarlo a funciones como argumento.
...
| Método | Descripción |
| --- | --- |
| virtual void [Add](./add/)(const T\&) | Agrega un elemento a la colección. |
...
| virtual **bool** [Contains](./contains/)(const T\&) const | Comprueba si el elemento está presente en la colección. |
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia todos los elementos de la colección a los elementos de una matriz existente. |
...
| virtual int [get_Count](./get_count/)() const | Obtiene el número de elementos en la colección. |
| virtual **bool** [get_IsReadOnly](./get_isreadonly/)() const | Comprueba si la colección es de solo lectura. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Obtiene el objeto a través del cual la colección está sincronizada. |
...
| [ICollection](./icollection/)() | Constructor por defecto. |
...
| [ICollection](./)\& [operator=](./operator_equal/)([ICollection](./)\&&) | Operador de asignación por movimiento. |
| [ICollection](./)\& [operator=](./operator_equal/)(const [ICollection](./)\&) | Operador de asignación por movimiento. |
...
| virtual **bool** [Remove](./remove/)(const T\&) | Elimina un elemento de la colección. |
...
| Typedef | Descripción |
| --- | --- |
| [ValueType](./valuetype/) | Nombre del tipo de valor. |
