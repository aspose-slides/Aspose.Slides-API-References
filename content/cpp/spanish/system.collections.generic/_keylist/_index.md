...
description: "Implementa una lista de claves de diccionario. Los objetos de esta clase solo deben asignarse utilizando la función System::MakeObject(). Nunca cree una instancia de este tipo en la pila o mediante el operador new, ya que provocará errores en tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero System::SmartPtr y use este puntero para pasarlo a funciones como argumento."
type: docs
weight: 14
url: /es/system.collections.generic/_keylist/
---
## _KeyList clase

Implementa una lista de claves de diccionario. Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que resultará en errores de tiempo de ejecución y/o fallas de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use este puntero para pasarlo a funciones como argumento.
...
| Método | Descripción |
| --- | --- |
|  [_KeyCollection](../_keycollection/_keycollection/)(const typename Dict::Ptr\&) | Inicializa la colección referenciando el diccionario especificado. |
|  [_KeyList](./_keylist/)(const typename Dict::Ptr\&) | Inicializa la colección referenciando el diccionario especificado. |
| void [Add](../ikvcollection/add/)(const T\&) override | Añade un elemento al contenedor. |
|  [BaseKVCollection](../basekvcollection/basekvcollection/)(const typename Dict::Ptr\&) | Crea la colección. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Obtiene un iterador que apunta al primer elemento (si lo hay) de la colección. Este iterador no puede usarse para modificar un objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve un objeto copia de T. |
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Obtiene un iterador que apunta al primer elemento (si lo hay) de la instancia const de la colección. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Obtiene un iterador que apunta al primer elemento const (si lo hay) de la colección. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Obtiene un iterador que apunta justo después del último elemento const (si lo hay) de la colección. |
| void [Clear](../ikvcollection/clear/)() override | Elimina todos los elementos del contenedor. |
| **bool** [Contains](./contains/)(const [TKey](../_keycollection/tkey/)\&) const override | Comprueba si la clave especificada está presente en la colección. |
| void [CopyTo](../basekvcollection/copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | Copia datos a los elementos existentes del arreglo. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la colección. Este iterador no puede usarse para modificar un objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve un objeto copia de T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la instancia const de la colección. |
...
| int [get_Count](../basekvcollection/get_count/)() const override | Obtiene el número de elementos. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Comprueba si la colección tiene tamaño fijo. |
| **bool** [get_IsReadOnly](../ikvcollection/get_isreadonly/)() const override | Comprueba si el contenedor es de solo lectura. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TKey](../_keycollection/tkey/)\>\> [GetEnumerator](../_keycollection/getenumerator/)() override | Obtiene el enumerador que itera a través de las claves. |
...
| [TKey](../_keycollection/tkey/) [idx_get](./idx_get/)(int) const override | Obtiene la clave en la posición especificada. |
| void [idx_set](../ikvcollection/idx_set/)(int, T) override | Función setter. |
| int [IndexOf](../ikvcollection/indexof/)(const T\&) const override | Obtiene el índice del elemento en el contenedor. |
| void [Insert](../ikvcollection/insert/)(int, const T\&) override | Inserta el elemento en la posición especificada. |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina si existe algún elemento en la secuencia o si cumple una condición. |
...
| **bool** [Remove](../ikvcollection/remove/)(const T&) override | Elimina un elemento del contenedor. |
| void [RemoveAt](../ikvcollection/removeat/)(int) override | Elimina el elemento en la posición especificada. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
| void [SetTemplateWeakPtr](../basekvcollection/settemplateweakptr/)(**uint32_t**) override | Permite la compilación, pero en realidad no hace nada ya que esta estructura no posee datos. |
...
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeBeginConstIterator](../_keycollection/virtualizebeginconstiterator/)() const override | Obtiene la implementación del iterador begin const para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeBeginIterator](../_keycollection/virtualizebeginiterator/)() override | Obtiene la implementación del iterador begin para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeEndConstIterator](../_keycollection/virtualizeendconstiterator/)() const override | Obtiene la implementación del iterador end const para el contenedor actual. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeEndIterator](../_keycollection/virtualizeenditerator/)() override | Obtiene la implementación del iterador end para el contenedor actual. |
...
* Clase [_KeyCollection](../_keycollection/)
