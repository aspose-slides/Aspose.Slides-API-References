...
| Método | Descripción |
| --- | --- |
| void [Add](./add/)(const T\&) override | Agrega un elemento al contenedor. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Obtiene un iterador que apunta al primer elemento (si lo hay) de la colección. Este iterador no puede usarse para cambiar el objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve un objeto copia de T. |
...
| **bool** [Contains](./contains/)(const T\&) const override | Comprueba si el elemento está presente en el contenedor. |
| virtual void [CopyTo](../icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia todos los elementos de la colección a los elementos existentes del array. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la colección. Este iterador no puede usarse para cambiar el objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve un objeto copia de T. |
...
| virtual int [get_Count](./get_count/)() const | Obtiene el número de elementos en el contenedor. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Comprueba si la colección tiene tamaño fijo. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Comprueba si el contenedor es solo de lectura. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() | Obtiene el enumerador para el contenedor. |
...
| virtual T [idx_get](./idx_get/)(int) const | Función de obtención. |
| void [idx_set](./idx_set/)(int, T) override | Función de asignación. |
| int [IndexOf](./indexof/)(const T\&) const override | Obtiene el índice del elemento en el contenedor. |
...
| **bool** [Remove](./remove/)(const T\&) override | Elimina el elemento del contenedor. |
