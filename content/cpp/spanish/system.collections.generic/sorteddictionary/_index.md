...
description: Declaración adelantada del tipo diccionario ordenado.
type: docs
weight: 521
url: /es/system.collections.generic/sorteddictionary/
---
## SortedDictionary clase

Declaración adelantada del tipo diccionario ordenado.
...
| void [CopyTo](../idictionary/copyto/)([ArrayPtr](../../system/arrayptr/)\<[KeyValuePair](../keyvaluepair/)\<TKey, TValue\>\>, int) override | Copia el contenido del diccionario en los elementos existentes de la matriz. |
...
| [const_reverse_iterator](./const_reverse_iterator/) [crend](./crend/)() const | Obtiene un iterador inverso para un elemento calificado como const inexistente antes del inicio de la colección. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../icomparer/)\<TKey\>\> [get_Comparer](./get_comparer/)() const | Obtiene el IComparer<TKey> utilizado para ordenar los elementos de SortedDictionary<TKey,TValue>. |
...
| **bool** [get_IsSynchronized](../idictionary/get_issynchronized/)() const | Comprueba si el contenedor es seguro para subhilos. |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<typename BasePointerType\<TKey\>::type\>\> [GetDefaultKeyComparer](./getdefaultkeycomparer/)() | Función de acceso al singleton. |
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Obtiene un enumerador para iterar a través del diccionario actual. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo al método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite el hash de objetos personalizados. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtiene el tipo real del objeto. Análogo a la llamada C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual TValue [GetValueOrDefault](../idictionary/getvalueordefault/)(const TKey\&) const | Devuelve el valor si se encuentra; de lo contrario **Value()**. |
| virtual TValue [GetValueOrDefault](../idictionary/getvalueordefault/)(const TKey\&, const TValue\&) const | Devuelve el valor si se encuentra; de lo contrario **defaultValue**. |
| virtual TValue [GetValueOrNull](../idictionary/getvalueornull/)(const TKey\&) const | Devuelve el valor si se encuentra; de lo contrario **null**, solo tiene sentido para tipos de referencia. |
...
| [const_reverse_iterator](./const_reverse_iterator/) [rend](./rend/)() const | Obtiene un iterador inverso para un elemento inexistente antes del inicio de la colección calificada como const. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Establece el n-ésimo argumento de plantilla como puntero débil (en lugar de compartido). Permite cambiar los punteros en los contenedores a modo débil. |
...
|  [SortedDictionary](./sorteddictionary/)(const [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<typename BasePointerType\<TKey\>::type\>\>\&) | Construye un diccionario vacío. |
|  [SortedDictionary](./sorteddictionary/)(const [SharedPtr](../../system/sharedptr/)\<[IDictionary](../idictionary/)\<TKey, TValue\>\>\&) | Constructor de copia. |
|  [SortedDictionary](./sorteddictionary/)(const [SharedPtr](../../system/sharedptr/)\<[IDictionary](../idictionary/)\<TKey, TValue\>\>\&, const [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<typename BasePointerType\<TKey\>::type\>\>\&) | Constructor de copia. |
