...
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Obtiene un iterador que apunta al primer elemento (si existe) de la colección. Este iterador no puede usarse para modificar el objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve una copia del objeto T. |
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Obtiene un iterador que apunta al primer elemento (si existe) de la instancia de la colección calificada como const. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Obtiene un iterador que apunta al primer elemento calificado como const (si existe) de la colección. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Obtiene un iterador que apunta justo después del último elemento calificado como const (si existe) de la colección. |
...
| virtual void [CopyTo](../icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia todos los elementos de la colección a los elementos existentes del arreglo. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtiene un iterador que apunta justo después del último elemento (si existe) de la colección. Este iterador no puede usarse para modificar un objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve una copia del objeto T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Obtiene un iterador que apunta justo después del último elemento (si existe) de la instancia de la colección calificada como const. |
...
| **bool** [get_IsFixedSize](./get_isfixedsize/)() | Comprueba si la colección tiene tamaño fijo. |
...
| virtual T [idx_get](./idx_get/)(int) const | Obtiene el elemento en el índice especificado. |
| virtual void [idx_set](./idx_set/)(int, T) | Establece el elemento en el índice especificado. |
| virtual int [IndexOf](./indexof/)(const T\&) const | Obtiene el índice de la primera aparición del elemento en el contenedor. |
| virtual void [Insert](./insert/)(int, const T\&) | Inserta un elemento en la posición especificada, desplazando los demás elementos. |
...
| [SharedPtr](../../system/sharedptr/)\<[List](../list/)\<T\>\> [LINQ_ToList](../ienumerable/linq_tolist/)() | Crea un List<T> a partir de una secuencia. |
...
| virtual void [RemoveAt](./removeat/)(int) | Elimina el elemento en el índice especificado. |
...
| [ValueType](./valuetype/) | Tipo valor. |
