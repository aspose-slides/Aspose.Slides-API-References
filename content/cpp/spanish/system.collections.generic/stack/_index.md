...
description: Declaración adelantada de la clase Stack.
type: docs
weight: 599
url: /es/system.collections.generic/stack/
---
## Clase Stack

[Stack](./) clase forward declaration.
...
| Método | Descripción |
| --- | --- |
| void [AddRange](./addrange/)([IEnumerablePtr](./ienumerableptr/)) | Inserta elementos en la pila. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Obtiene un iterador que apunta al primer elemento (si lo hay) de la colección. Este iterador no se puede usar para cambiar un objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve una copia del objeto de tipo T. |
...
| virtual void [Clear](./clear/)() | Elimina todos los elementos de la pila. |
| virtual **bool** [Contains](./contains/)(const T\&) const | Comprueba si un ítem específico está presente en el contenedor; usa el operador == para la comparación. |
| [stack_t](./stack_t/)\& [data](./data/)() | Accesor de la estructura de datos interna. |
| const [stack_t](./stack_t/)\& [data](./data/)() const | Accesor de la estructura de datos interna. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtiene un iterador que apunta justo después del último elemento (si lo hay) de la colección. Este iterador no se puede usar para cambiar un objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve una copia del objeto de tipo T. |
...
| virtual int [get_Count](./get_count/)() const | Obtiene el número de elementos en la pila. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtiene la estructura de datos del contador de referencias asociada al objeto. |
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Obtiene un enumerador para iterar a través de la pila actual. |
...
| T [Peek](./peek/)() | Obtiene el elemento de la parte superior de la pila, pero lo mantiene en la pila. |
| T [Pop](./pop/)() | Obtiene el elemento de la parte superior de la pila. |
| void [Push](./push/)(const T\&) | Inserta un elemento en la parte superior de la pila. |
...
|  [Stack](./stack/)([IEnumerablePtr](./ienumerableptr/)) | Constructor de copia. |
| virtual [ArrayPtr](../../system/arrayptr/)\<T\> [ToArray](./toarray/)() | Convierte la pila a una matriz. |
...
| [stack_t](./stack_t/) | Tipo de datos subyacente. |
| [IEnumerablePtr](./ienumerableptr/) | Colección que contiene elementos del mismo tipo. |
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator** tipo. |

## Comentarios

[Stack](./) clase que envuelve std::list. Los objetos de esta clase solo deben asignarse usando la función [System::MakeObject()](../../system/makeobject/). Nunca cree una instancia de este tipo en la pila o usando el operador new, ya que producirá errores de tiempo de ejecución y/o fallos de aserción. Siempre envuelva esta clase en un puntero [System::SmartPtr](../../system/smartptr/) y use ese puntero para pasarlo a funciones como argumento.
...
int main()
{
  ...
  // Imprimir el último elemento de la pila. El método Peek no elimina un elemento de la pila.
  std::cout << stack->Peek() << std::endl;
  PrintItems(stack);

  // Imprimir el último elemento de la pila. El método Pop elimina un elemento de la pila.
