...
| Método | Descripción |
| --- | --- |
| virtual void [Add](./add/)(const TKey\&, const TValue\&) | Agrega un par clave-valor al contenedor. |
...
| virtual **bool** [ContainsKey](./containskey/)(const TKey\&) const | Comprueba si el contenedor contiene la clave. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<[KeyValuePair](../keyvaluepair/)\<TKey, TValue\>\>, int) override | Copia el contenido del diccionario en elementos de un arreglo existente. |
...
| **bool** [get_IsFixedSize](./get_isfixedsize/)() const | Comprueba si el tamaño de la colección es fijo. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Comprueba si la colección es de solo lectura. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | Comprueba si el contenedor es seguro para hilos. |
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TKey\>\> [get_Keys](./get_keys/)() const | Accede a la colección de claves. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TValue\>\> [get_Values](./get_values/)() const | Accede a la colección de valores. |
...
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey\&) const | Devuelve el valor si se encuentra; o **Value()** en caso contrario. |
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey\&, const TValue\&) const | Devuelve el valor si se encuentra; o **defaultValue** en caso contrario. |
| virtual TValue [GetValueOrNull](./getvalueornull/)(const TKey\&) const | Devuelve el valor si se encuentra; o **null** en caso contrario, tiene sentido solo para tipos de referencia. |
...
| virtual TValue [idx_get](./idx_get/)(const TKey\&) const | Función de obtención. |
| virtual void [idx_set](./idx_set/)(const TKey\&, TValue) | Función de establecimiento. |
...
| virtual **bool** [Remove](./remove/)(const TKey\&) | Elimina la clave del contenedor. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Disminuye y devuelve el contador de referencias compartidas. No debería llamarse directamente; use punteros inteligentes o ThisProtector. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Análogo al método C# [Object.ToString()](../../system/object/tostring/). Permite convertir objetos personalizados a cadena. |
| virtual **bool** [TryGetValue](./trygetvalue/)(const TKey\&, TValue\&) const | Busca el valor y lo recupera si se encuentra. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Disminuye el contador de referencias débiles. No debería llamarse directamente; use punteros inteligentes o ThisProtector. |
...
| Typedef | Descripción |
| --- | --- |
| [BaseType](./basetype/) | Tipo de interfaz base. |
