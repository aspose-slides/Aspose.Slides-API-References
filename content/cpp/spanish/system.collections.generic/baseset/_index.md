...
type: docs
weight: 92
url: /es/system.collections.generic/baseset/
---
## BaseSet clase
...
| void [Add](./add/)(const T\&) override | Añade elemento al conjunto. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtiene iterador al primer elemento de la colección con calificador const. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Obtiene iterador que apunta al primer elemento (si lo hay) de la colección. Este iterador no puede usarse para cambiar un objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve un objeto copia de T. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtiene iterador al primer elemento con calificador const de la colección. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtiene iterador para un elemento const-qualificado inexistente detrás del final de la colección. |
| void [Clear](./clear/)() override | Elimina todos los elementos del conjunto. |
| **bool** [Contains](./contains/)(const T\&) const override | Comprueba si el elemento está presente en el conjunto. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copia el contenido del hash en los elementos existentes del arreglo. |
| [set_t](./set_t/)\& [data](./data/)() | Accesor a la estructura de datos subyacente. |
| const [set_t](./set_t/)\& [data](./data/)() const | Accesor a la estructura de datos subyacente. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtiene iterador para un elemento inexistente detrás del final de la colección con calificador const. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtiene iterador que apunta justo después del último elemento (si lo hay) de la colección. Este iterador no puede usarse para cambiar un objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) devuelve un objeto copia de T. |
...
| int [get_Count](./get_count/)() const override | Obtiene el número de elementos en el conjunto. |
| virtual int [get_Count](./get_count/)() const | Mantiene [get_Count()](./get_count/) sin ocultar. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Comprueba si la colección es de sólo lectura. |
...
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Crea enumerador. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructor de copia. No copia nada, realmente, solo inicializa un nuevo objeto y permite la copia de constructores en subclases. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de asignación. No copia nada, realmente, solo inicializa un nuevo objeto y permite la copia de constructores en subclases. |
...
| **bool** [Remove](./remove/)(const T\&) override | Elimina elemento del conjunto. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Disminuye el contador de referencias compartidas en el valor especificado. |
|  [RTTI_INFO_TEMPLATE_CLASS](./rtti_info_template_class/)([ThisType](./thistype/), System::BaseTypesInfo\<[System::Object](../../system/object/)\>) | Información RTTI. |
...
| **bool** [TryAdd](./tryadd/)(const T\&) | Añade elemento al conjunto. |
...
| [IEnumerablePtr](./ienumerableptr/) | Puntero a interfaz enumerable. |
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator** puntero. |
