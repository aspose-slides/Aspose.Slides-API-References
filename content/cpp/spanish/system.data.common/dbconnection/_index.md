...
| virtual [String](../../system/string/) [get_ConnectionString](./get_connectionstring/)() const | Información RTTI. |
...
| virtual void [Open](./open/)() | Abre la conexión a la base de datos. |
...
| virtual void [set_ConnectionString](./set_connectionstring/)([String](../../system/string/)) const | Establece la información de conexión (p. ej., servidor y puerto). |
