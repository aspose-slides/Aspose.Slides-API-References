...
| virtual int [ExecuteNonQuery](./executenonquery/)() | Ejecuta un comando que no es una consulta. |
| virtual [SharedPtr](../../system/sharedptr/)\<[DbDataReader](../dbdatareader/)\> [ExecuteReader](./executereader/)() | Ejecuta un comando de consulta. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Solo para uso interno. |
| virtual [String](../../system/string/) [get_CommandText](./get_commandtext/)() const | Información RTTI. |
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Data::Common::DbConnection](../dbconnection/)\> [get_Connection](./get_connection/)() const | Obtiene la conexión de base de datos asociada al comando. |
...
| virtual void [set_CommandText](./set_commandtext/)([String](../../system/string/)) const | Establece el texto del comando DB. |
| virtual void [set_Connection](./set_connection/)([SharedPtr](../../system/sharedptr/)\<[System::Data::Common::DbConnection](../dbconnection/)\>) | Obtiene la conexión de base de datos asociada al comando. |
