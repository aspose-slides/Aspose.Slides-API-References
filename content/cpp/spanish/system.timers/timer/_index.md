...
description: Temporizador que llama al delegado en un bucle.
type: docs
weight: 14
url: /es/system.timers/timer/
---
## Clase Timer

[Timer](./) que llama al delegado en un bucle.
...
| Método | Descripción |
| --- | --- |
| void [Close](./close/)() | Detiene el temporizador, libera los recursos asignados. |
|  [Component](../../system.componentmodel/component/component/)() | Información RTTI. |
| void [Dispose](./dispose/)() | Detiene el temporizador, libera los recursos asignados. |
| void [Dispose](../../system.componentmodel/component/dispose/)(**bool**) | Soporte del patrón disposable; no hace nada. |
...
| **bool** [get_AutoReset](./get_autoreset/)() const | Comprueba si el temporizador está en modo de reinicio automático. |
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | Comprueba si el componente está en modo de diseño. |
| **bool** [get_Enabled](./get_enabled/)() const | Comprueba si el temporizador está activo. |
| **double** [get_Interval](./get_interval/)() const | Obtiene el intervalo del temporizador. |
| **bool** [get_IsStopped](./get_isstopped/)() const | Comprueba si el temporizador está detenido. |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | Configura el temporizador en modo de reinicio automático o lo desactiva. |
| void [set_Enabled](./set_enabled/)(**bool**) | Inicia o detiene el temporizador. Iniciar el temporizador no reinicia la cuenta de tiempo si el temporizador ya está en ejecución. |
| void [set_Interval](./set_interval/)(**double**) | Configura el intervalo del temporizador. |
...
| void [Start](./start/)() | Inicia el temporizador. No reinicia la cuenta de tiempo si el temporizador ya está en ejecución. |
| void [Stop](./stop/)() | Detiene el temporizador. |
...
* Clase [Component](../../system.componentmodel/component/)
