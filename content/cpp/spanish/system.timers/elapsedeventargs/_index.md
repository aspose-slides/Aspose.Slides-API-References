...
description: Argumentos del evento del temporizador.
type: docs
weight: 1
url: /es/system.timers/elapsedeventargs/
---
## ElapsedEventArgs clase

Argumentos del evento del temporizador.
...
| Método | Descripción |
| --- | --- |
|  [ElapsedEventArgs](./elapsedeventargs/)(**int32_t**, **int32_t**) | Construye el objeto de argumentos con los parámetros dados. |
...
| [DateTime](../../system/datetime/) [get_SignalTime](./get_signaltime/)() | Obtiene el tiempo de señal. |
