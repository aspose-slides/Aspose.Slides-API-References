...
description: "Αντιπροσωπεί την εξαίρεση που προκαλείται όταν συμβαίνει σφάλμα υποδοχής. Ποτέ μην δημιουργείτε στιγμιότυπα αυτής της κλάσης με το χέρι. Χρησιμοποιήστε την κλάση SocketException αντί αυτού. Ποτέ μην τυλίγετε τα στιγμιότυπα της κλάσης SocketException στο System::SmartPtr."
type: docs
weight: 1
url: /el/system.net.sockets/details_socketexception/
---
## Details_SocketException κλάση


Αντιπροσωπεί την εξαίρεση που προκαλείται όταν συμβαίνει σφάλμα υποδοχής. Ποτέ μην δημιουργείτε στιγμιότυπα αυτής της κλάσης χειροκίνητα. Χρησιμοποιήστε την κλάση SocketException αντ' αυτού. Ποτέ μην τυλίγετε τα στιγμιότυπα της κλάση SocketException στο [System::SmartPtr](../../system/smartptr/).
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Συγκρίνει αντικείμενα τύπου αναφοράς σε στυλ C#. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Προσομοιώνει συγκριση κινητής υποδιαστολής σε στυλ C# όπου δύο NaN θεωρούνται ίσα ακόμη και αν σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Προσομοιώνει συγκριση κινητής υποδιαστολής σε στυλ C# όπου δύο NaN θεωρούνται ίσα ακόμη και αν σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
...
| **int32_t** [get_ErrorCode](./get_errorcode/)() | Λαμβάνει τον κωδικό σφάλματος. |
...
| [SocketError](../socketerror/) [get_SocketErrorCode](./get_socketerrorcode/)() | Λαμβάνει τον κωδικό σφάλματος υποδοχής. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το κλείδωμα της έκφρασης C# lock(). Καλέστε απευθείας ή χρησιμοποιήστε το αντικείμενο φύλακα [LockContext](../../system/lockcontext/). |
...
| void [set_ErrorCode](./set_errorcode/)(**int32_t**) | Ορίζει τον κωδικό σφάλματος. |
...
| void [set_SocketErrorCode](./set_socketerrorcode/)([SocketError](../socketerror/)) | Ορίζει τον κωδικό σφάλματος υποδοχής. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την αποκλείδωση της έκφρασης C# lock(). Καλέστε απευθείας ή χρησιμοποιήστε το αντικείμενο φύλακα [LockContext](../../system/lockcontext/). |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Υλοποιεί τη μέθοδο [what()](../../system/details_exception/what/) που καλείται από την κλάση [ExceptionWrapper](../../system/exceptionwrapper/). Παρά το γεγονός ότι αυτή η κλάση δεν κληρονομεί από std::exception, οι παράγωγες κλάσεις μπορούν να χρησιμοποιήσουν προστατευμένα/ιδιωτικά μέλη για την υλοποίηση της λογικής τους. Η μεταφορά αυτής της υλοποίησης μεθόδου στο [ExceptionWrapper](../../system/exceptionwrapper/) μπορεί να διασπάσει αυτή τη λογική. |
