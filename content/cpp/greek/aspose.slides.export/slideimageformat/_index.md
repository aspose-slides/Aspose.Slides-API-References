...
description: Καθορίζει τη μορφή στην οποία θα αποθηκευθεί η εικόνα διαφάνειας για την παρουσίαση κατά την εξαγωγή σε HTML.
type: docs
weight: 690
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[SlideImageFormat](./)\> [Bitmap](./bitmap/)(**float**, [Aspose::Slides::ImageFormat](../../aspose.slides/imageformat/)) | [Slides](../../aspose.slides/) πρέπει να μετατραπεί σε raster εικόνα. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αντιπροσωπεύει μια παρουσία τύπου που περιγράφεται από το targetType. Αναλογικό του τελεστή 'is' της C#. |
| void [Lock](../../system/object/lock/)() | Εφαρμόζει το κλείδωμα της δήλωσης lock() της C#. Καλέστε το απευθείας ή χρησιμοποιήστε το αντικείμενο sentry [LockContext](../../system/lockcontext/). |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[SlideImageFormat](./)\> [Svg](./svg/)([System::SharedPtr](../../system/sharedptr/)\<[SVGOptions](../svgoptions/)\>) | [Slides](../../aspose.slides/) πρέπει να μετατραπεί σε μορφή SVG. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκλείδωμα της δήλωσης lock() της C#. Καλέστε το απευθείας ή χρησιμοποιήστε το αντικείμενο sentry [LockContext](../../system/lockcontext/). |
...
* Κλάση [ISlideImageFormat](../islideimageformat/)
