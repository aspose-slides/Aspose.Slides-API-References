...
description: Αντιπροσωπεί το πρόγραμμα αναπαραγωγής των κινούμενων σχεδίων που σχετίζονται με την Παρουσίαση.
type: docs
weight: 625
...
Αντιπροσωπεί το πρόγραμμα αναπαραγωγής των κινούμενων σχεδίων που συνδέονται με το [Presentation](../../aspose.slides/presentation/).
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| void [Dispose](./dispose/)() override | Αποδεσμεύει την παρουσία του [PresentationPlayer](./). |
...
| **int32_t** [get_FrameIndex](./get_frameindex/)() | Λαμβάνει τον δείκτη πλαισίου. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει τη δημιουργία αντιγράφων υποκατηγορών. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστικό τελεστή ανάθεσης. Δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει τη δημιουργία αντιγράφων υποκατηγορών. |
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | Δημιουργεί νέα παρουσία του [PresentationPlayer](./). |
...
| void [Unlock](../../system/object/unlock/)() | Εφαρμόζει το statement lock() της C# για απελευθέρωση. Κλήση άμεσα ή χρήση του αντικειμένου φρουρού [LockContext](../../system/lockcontext/). |
...
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | Αντιπροσωπεί τον διαχειριστή κτύπου πλαισίου του γεγονότος **PresentationPlayer::FrameTick**. |
