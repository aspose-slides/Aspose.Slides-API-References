...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το κλείδωμα της δήλωσης C# lock(). Κλήση απευθείας ή χρήση του αντικειμένου στήριξης [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκλείδωμα της δήλωσης C# lock(). Κλήση απευθείας ή χρήση του αντικειμένου στήριξης [LockContext](../../system/lockcontext/). |
|  [VideoPlayerHtmlController](./videoplayerhtmlcontroller/)([System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) | Δημιουργεί ένα νέο παράδειγμα ελεγκτή |
...
* Κλάση [IVideoPlayerHtmlController](../ivideoplayerhtmlcontroller/)
