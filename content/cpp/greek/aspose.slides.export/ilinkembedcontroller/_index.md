...
description: Διεπαφή callback που χρησιμοποιείται για να καθορίσει πώς πρέπει το αντικείμενο να επεξεργαστεί κατά την αποθήκευση.
type: docs
weight: 248
...
Διεπαφή callback που χρησιμοποιείται για να καθορίσει πώς θα πρέπει το αντικείμενο να επεξεργαστεί κατά την αποθήκευση.
...
| virtual void [SaveExternal](./saveexternal/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Saves external object. |
