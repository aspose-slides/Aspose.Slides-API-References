...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | Καθορίζει πόσες διαφάνειες και με ποια σειρά θα τοποθετηθούν στη σελίδα [HandoutType](../handouttype/). |
| **bool** [get_PrintComments](./get_printcomments/)() const | Καθορίζει αν θα εμφανιστούν ή όχι τα σχόλια στις διαφάνειες |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | Καθορίζει αν θα σχεδιαστούν ή όχι πλαίσια γύρω από τις εμφανιζόμενες διαφάνειες. |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | Καθορίζει αν θα εκτυπωθούν ή όχι οι αριθμοί των εμφανιζόμενων διαφανειών. |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | Καθορίζει πόσες διαφάνειες και με ποια σειρά θα τοποθετηθούν στη σελίδα [HandoutType](../handouttype/). |
| void [set_PrintComments](./set_printcomments/)(**bool**) | Καθορίζει αν θα εμφανιστούν ή όχι τα σχόλια στις διαφάνειες |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | Καθορίζει αν θα σχεδιαστούν ή όχι πλαίσια γύρω από τις εμφανιζόμενες διαφάνειες. |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | Καθορίζει αν θα εκτυπωθούν ή όχι οι αριθμοί των εμφανιζόμενων διαφανειών. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το ν-ο argument προτύπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
