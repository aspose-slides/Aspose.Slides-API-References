...
description: Η κλάση ελεγκτή μορφοποίησης για ενσωμάτωση γραμματοσειρών σε μορφή EOT
type: docs
weight: 14
...
| Μέθοδος | Περιγραφή |
| --- | --- |
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)() | Δημιουργεί νέο στιγμιότυπο. |
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Δημιουργεί νέο στιγμιότυπο. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αποτελεί παράδειγμα του τύπου που περιγράφεται από το targetType. Αναλογία του χειριστή C# 'is'. |
...
* Κλάση [IEmbeddedEotFontsHtmlController](../iembeddedeotfontshtmlcontroller/)
