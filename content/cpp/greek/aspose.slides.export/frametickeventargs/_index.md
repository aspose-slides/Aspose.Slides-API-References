...
description: "Αντιπροσωπεύει τα επιχειρήματα του συμβάντος PresentationPlayer::FrameTick."
type: docs
weight: 40
...
Αντιπροσωπεύει τα επιχειρήματα του συμβάντος **PresentationPlayer::FrameTick**.
...
| [System::SharedPtr](../../system/sharedptr/)\<[PresentationPlayer](../presentationplayer/)\> [get_Player](./get_player/)() | Λαμβάνει τον παίκτη παρουσίασης |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IImage](../../aspose.slides/iimage/)\> [GetFrame](./getframe/)() | Λαμβάνει το τρέχον [PresentationPlayer](../presentationplayer/) πλαίσιο. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Αναλογία της μεθόδου C# [Object.GetHashCode()](../../system/object/gethashcode/). Ενεργοποιεί την κατασκευή κατακερματικού κώδικα για προσαρμοσμένα αντικείμενα. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n-οστό όρισμα προτύπου ως αδυναμικό δείκτη (αντί για κοινόχρηστο). Επιτρέπει την εναλλαγή των δεικτών σε συλλογές σε αδυναμική λειτουργία. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον αδυναμικό μετρητή αναφοράς. Δεν πρέπει να καλείται άμεσα· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον αδυναμικό μετρητή αναφοράς. Δεν πρέπει να καλείται άμεσα· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
