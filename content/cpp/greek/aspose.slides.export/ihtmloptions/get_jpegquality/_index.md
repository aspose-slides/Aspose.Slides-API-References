...
description: Επιστρέφει μια τιμή που καθορίζει την ποιότητα των εικόνων JPEG μέσα στο έγγραφο PDF. Διαβάζει uint8_t.
type: docs
weight: 79
url: /el/aspose.slides.export/ihtmloptions/get_jpegquality/
---
## IHtmlOptions::get_JpegQuality() μέθοδος

Επιστρέφει μια τιμή που καθορίζει την ποιότητα των εικόνων JPEG στο έγγραφο PDF. Διαβάζει **uint8_t**.
