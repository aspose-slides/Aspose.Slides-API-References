...
description: Παρέχει επιλογές που ελέγχουν την εμφάνιση των αντικειμένων Ink σε εξαχθέν έγγραφο.
type: docs
weight: 261
...
Παρέχει επιλογές που ελέγχουν την εμφάνιση των αντικειμένων [Ink](../../aspose.slides.ink/) σε εξαχθέν έγγραφο.
...
| **bool** [get_HideInk](./get_hideink/)() override | Εμφανίζει ή κρύβει στοιχεία [Ink](../../aspose.slides.ink/) σε εξαχθέν έγγραφο. |
| **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() override | Χρησιμοποιεί λειτουργία ROP ή Αδιαφάνεια για την απόδοση του πινέλου. |
...
| void [set_HideInk](./set_hideink/)(**bool**) override | Εμφανίζει ή κρύβει στοιχεία [Ink](../../aspose.slides.ink/) σε εξαχθέν έγγραφο. |
| void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) override | Χρησιμοποιεί λειτουργία ROP ή Αδιαφάνεια για την απόδοση του πινέλου. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Μειώνει και επιστρέφει τον κοινόχρησητο μετρητή αναφορών. Δεν πρέπει να κληθεί άμεσα· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
