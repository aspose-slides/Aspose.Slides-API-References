...
description: Αμετάβλητο αντικείμενο που αντιπροσωπεύει ένα εφέ εσωτερικής σκιάς.
type: docs
weight: 781
url: /el/aspose.slides.effects/iinnershadoweffectivedata/
---
## IInnerShadowEffectiveData κλάση
...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) ακτίνα. Μόνο ανάγνωση **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Κατεύθυνση της σκιάς. Μόνο ανάγνωση **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Απόσταση της σκιάς. Μόνο ανάγνωση **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Χρώμα της σκιάς. Μόνο ανάγνωση [System::Drawing::Color](../../system.drawing/color/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Συγκρίνει αναφορά έναν τύπο τιμής με nullptr. |
