...
---
## IImageTransformOCollectionEffectiveData κλάση
...
Το όνομα IImageTransformOperationCollectionEffectiveData περικοπήθηκε σε [IImageTransformOCollectionEffectiveData](./) επειδή το μέγεθος ονομάτων COM δεν μπορεί να είναι μεγαλύτερο από 39. 
## Δείτε επίσης
