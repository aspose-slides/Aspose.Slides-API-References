...
type: docs
weight: 417
url: /el/aspose.slides.effects/iapplicableeffect/
---
## IApplicableEffect κλάση
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th template argument ως αδύναμη αναφορά (αντί για κοινόχρηστη). Επιτρέπει την εναλλαγή δεικτών σε συλλογές σε αδύναμη λειτουργία. |
