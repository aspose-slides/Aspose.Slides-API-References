...
description: Αναπαριστά ένα εφέ Tint. Μετατοπίζει τις τιμές χρώματος του εφέ προς ή μακριά από την απόχρωση κατά την καθορισμένη ποσότητα.
type: docs
weight: 1093
...
Αναπαριστά ένα [Tint](./) εφέ. Μετατοπίζει τις τιμές χρώματος του εφέ προς/μακριά από την απόχρωση κατά το καθορισμένο ποσό.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Καθορίζει αν το καθορισμένο [Tint](./) είναι ίσο με το τρέχον [Tint](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | Αποκτά τα αποτελεσματικά δεδομένα εφέ [Tint](./) με την εφαρμογή της κληρονομικότητας. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αντιπροσωπεύει μια παράσταση τύπου που περιγράφεται από το targetType. Αναλογικό του τελεστή C# 'is'. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Αναλογικό της μεθόδου C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Ενισχύει την κλωνοποίηση προσαρμοσμένων τύπων. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Συγκρίνει με αναφορά αντικείμενο τύπου τιμής με το nullptr. |
