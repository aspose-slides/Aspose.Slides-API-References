...
---
## IColorChangeEffectiveData κλάση
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_FromColor](./get_fromcolor/)() | Χρώμα που θα αντικατασταθεί. Μόνο για ανάγνωση [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ToColor](./get_tocolor/)() | Χρώμα που θα αντικαταστήσει. Μόνο για ανάγνωση [System::Drawing::Color](../../system.drawing/color/). |
| virtual **bool** [get_UseAlpha](./get_usealpha/)() | Επιστρέφει μια λογική τιμή η οποία καθορίζει αν πρέπει να χρησιμοποιηθεί το στοιχείο άλφα. Μόνο για ανάγνωση **bool**. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το statement lock() της C#. Καλείται άμεσα ή χρησιμοποιεί το αντικείμενο εποπτείας [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την απελευθέρωση του statement lock() της C#. Καλείται άμεσα ή χρησιμοποιεί το αντικείμενο εποπτείας [LockContext](../../system/lockcontext/). |
