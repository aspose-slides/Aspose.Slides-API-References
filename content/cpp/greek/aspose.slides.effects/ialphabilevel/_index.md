...
description: Αντιπροσωπεύει ένα εφέ Alpha Bi-Level. Οι τιμές Alpha (Διαφάνειας) μικρότερες από το όριο μετατρέπονται σε 0 (πλήρως διαφανές) και οι τιμές alpha μεγαλύτερες ή ίσες με το όριο μετατρέπονται σε 100% (πλήρως αδιαφανές).
type: docs
weight: 235
...
Αντιπροσωπεύει ένα εφέ Alpha Bi-Level. Οι τιμές Alpha (Διαφάνεια) μικρότερες από το όριο μετατρέπονται σε 0 (πλήρως διαφανές) και οι τιμές alpha μεγαλύτερες ή ίσες με το όριο μετατρέπονται σε 100 % (πλήρως αδιαφανές).
...
| virtual **float** [get_Threshold](./get_threshold/)() | Επιστρέφει το όριο του εφέ. Ανάγνωση **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή των υποκατηγορίων. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής ανάθεσης. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή των υποκατηγορίων. |
...
| virtual void [set_Threshold](./set_threshold/)(**float**) | Επιστρέφει το όριο του εφέ. Εγγραφή **float**. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το άνοιγμα του statement lock() της C#. Κλήση απευθείας ή χρήση του αντικειμένου προστασίας [LockContext](../../system/lockcontext/). |
...
Χρησιμοποιήστε το [ImageTransformOperationFactory](../imagetransformoperationfactory/) για τη δημιουργία στιγμάτων στο COM.
