...
description: Αντιπροσωπεύει ένα εφέ Glow, στο οποίο προστίθεται μια χρωματική θολή περιγράμμιση έξω από τις άκρες του αντικειμένου.
type: docs
weight: 638
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | Φόρμα χρώματος. Μόνο για ανάγνωση [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual **double** [get_Radius](./get_radius/)() | Ακτίνα. Ανάγνωση **double**. |
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Αποκτά τα αποτελεσματικά δεδομένα με την κληρονομία εφαρμοσμένη. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Ακτίνα. Εγγραφή **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου σε αδύναμο δείκτη (αντί για κοινό). Επιτρέπει την εναλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
