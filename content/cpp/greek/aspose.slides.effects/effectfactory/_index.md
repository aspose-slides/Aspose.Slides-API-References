...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IGlow](../iglow/)\> [CreateGlow](./createglow/)() override | Δημιουργεί [Glow](../glow/) εφέ. |
| [System::SharedPtr](../../system/sharedptr/)\<[IInnerShadow](../iinnershadow/)\> [CreateInnerShadow](./createinnershadow/)() override | Δημιουργεί εσωτερικό εφέ shafow. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOuterShadow](../ioutershadow/)\> [CreateOuterShadow](./createoutershadow/)() override | Δημιουργεί εξωτερικό εφέ σκιάς. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadow](../ipresetshadow/)\> [CreatePresetShadow](./createpresetshadow/)() override | Δημιουργεί προεπιλεγμένο εφέ σκιάς. |
| [System::SharedPtr](../../system/sharedptr/)\<[IReflection](../ireflection/)\> [CreateReflection](./createreflection/)() override | Δημιουργεί [Reflection](../reflection/) εφέ. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdge](../isoftedge/)\> [CreateSoftEdge](./createsoftedge/)() override | Δημιουργεί εφέ Soft Edge. |
...
* Κλάση [IEffectFactory](../ieffectfactory/)
