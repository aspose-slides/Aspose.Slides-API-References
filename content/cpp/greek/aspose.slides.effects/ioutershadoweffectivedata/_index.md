...
---
## IOuterShadowEffectiveData κλάση
...
| virtual **float** [get_Direction](./get_direction/)() | Κατεύθυνση της σκιάς. Μόνο για ανάγνωση **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Απόσταση της σκιάς. Μόνο για ανάγνωση **double**. |
| virtual [RectangleAlignment](../../aspose.slides/rectanglealignment/) [get_RectangleAlign](./get_rectanglealign/)() | Στοίχιση παραλληλογράμμου. Μόνο για ανάγνωση [RectangleAlignment](../../aspose.slides/rectanglealignment/). |
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | Καθορίζει εάν η σκιά πρέπει να περιστρέφεται με το σχήμα εάν το σχήμα περιστραφεί. Μόνο για ανάγνωση **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | Καθορίζει τον οριζόντιο συντελεστή κλιμάκωσης, η αρνητική κλιμάκωση προξενεί αναστροφή. Μόνο για ανάγνωση **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | Καθορίζει τον κάθετο συντελεστή κλιμάκωσης, η αρνητική κλιμάκωση προξενεί αναστροφή. Μόνο για ανάγνωση **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Χρώμα της σκιάς. Μόνο για ανάγνωση [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | Καθορίζει τη γωνία οριζόντιας παραμόρφωσης (σε μοίρες). Μόνο για ανάγνωση **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | Καθορίζει τη γωνία κάθετης παραμόρφωσης (σε μοίρες). Μόνο για ανάγνωση **double**. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί την κλειδώση της δήλωσης C# lock(). Καλέστε άμεσα ή χρησιμοποιήστε το αντικείμενο [LockContext](../../system/lockcontext/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεσ/operator ανάθεσης. Δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και ενεργοποιεί την αντιγραφή κατασκευής υποκλάσεων. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδύναμο δείκτη (αντί για κοινό). Επιτρέπει την εναλλαγή δεικτών στα containers σε αδύναμη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την απαίδεια της δήλωσης C# lock(). Καλέστε άμεσα ή χρησιμοποιήστε το αντικείμενο [LockContext](../../system/lockcontext/). |
...
* Ονομαχώρο [Aspose::Slides::Effects](../)
