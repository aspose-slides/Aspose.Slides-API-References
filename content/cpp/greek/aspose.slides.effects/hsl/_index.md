...
description: Αντιπροσωπεύει ένα εφέ Hue/Saturation/Luminance. Το hue, το saturation και το luminance μπορούν να ρυθμιστούν ξεχωριστά σε σχέση με την τρέχουσα τιμή τους.
type: docs
weight: 222
...
Αντιπροσωπεύει ένα εφέ Hue/Saturation/Luminance. Το hue, το saturation και το luminance μπορούν να ρυθμιστούν ανάλογα με την τρέχουσα τιμή τους.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Καθορίζει αν το συγκεκριμένο [HSL](./) είναι ίσο με το τρέχον [HSL](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHSLEffectiveData](../ihsleffectivedata/)\> [GetEffective](./geteffective/)() override | Αποκτά τα δεδομένα του αποτελεσματικού εφέ Hue/Saturation/Luminance με την εφαρμοσμένη κληρονομικότητα. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Λειτουργεί ως συνάρτηση κατακερματισμού για έναν συγκεκριμένο τύπο. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Αποκτά τον πραγματικό τύπο του αντικειμένου. Αντίστοιχο της κλήσης [System.Object.GetType()](../../system/object/gettype/) της C#. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει εάν το αντικείμενο αντιπροσωπεύει μια παρουσία του τύπου που περιγράφεται από targetType. Αντίστοιχο του τελεστή 'is' της C#. |
| void [Lock](../../system/object/lock/)() | Υλοποιεί το statement lock() της C#. Καλέστε απευθείας ή χρησιμοποιήστε το αντικείμενο φρούρου [LockContext](../../system/lockcontext/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστή ανάθεσης. Δεν αντιγράφει τίποτα, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή των υποκλάσεων. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το statement lock() της C# ξεκλείδωμα. Καλέστε άμεσα ή χρησιμοποιήστε το αντικείμενο φρούρου [LockContext](../../system/lockcontext/). |
