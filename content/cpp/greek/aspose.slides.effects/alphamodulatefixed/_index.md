...
description: Αναπαριστά ένα εφέ Alpha Modulate Fixed. Οι τιμές του alpha (διαφάνειας) του εφέ πολλαπλασιάζονται με ένα σταθερό ποσοστό.
type: docs
weight: 66
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Καθορίζει εάν το καθορισμένο [AlphaModulateFixed](./) είναι ίσο με το τρέχον [AlphaModulateFixed](./). |
...
| **float** [get_Amount](./get_amount/)() override | Επιστρέφει ένα ποσό του εφέ σε ποσοστά. Ανάγνωση **float**. |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | Επιστρέφει γονέα [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). Μόνο-ανάγνωση [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | Λαμβάνει τα δεδομένα του αποτελεσματικού εφέ Alpha Modulate Fixed με την κληρονομιά εφαρμοσμένη. |
...
| void [set_Amount](./set_amount/)(**float**) override | Επιστρέφει ένα ποσό του εφέ σε ποσοστά. Εγγραφή **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n-οστό όρισμα προτύπου ως αδυναμικό δείκτη (αντί για κοινό). Επιτρέπει την αλλαγή δεικτών σε συλλογές σε αδύνατη λειτουργία. |
...
* Κλάση [IAlphaModulateFixed](../ialphamodulatefixed/)
