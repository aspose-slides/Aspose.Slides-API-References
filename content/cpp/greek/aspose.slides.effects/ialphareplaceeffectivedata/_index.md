...
description: Αμετάβλητο αντικείμενο που αντιπροσωπεύει ένα εφέ Alpha Replace. Οι τιμές alpha (διαφάνειας) του εφέ αντικαθίστανται από μια σταθερή τιμή alpha.
type: docs
weight: 404
url: /el/aspose.slides.effects/ialphareplaceeffectivedata/
---
## IAlphaReplaceEffectiveData κλάση

Αμετάβλητο αντικείμενο που αντιπροσωπεύει ένα εφέ Alpha Replace. Οι τιμές alpha (διαφάνεια) του εφέ αντικαθίστανται από μια σταθερή τιμή alpha.
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Εξομοιώνει σύγκριση κυμαινόμενου σημείου σε στυλ C# όπου δύο NaN θεωρούνται ίσα παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Μόνο για εσωτερική χρήση. |
| virtual **float** [get_Alpha](./get_alpha/)() | Επιστρέφει τη νέα τιμή alpha στο διάστημα [0..1] Μόνο για ανάγνωση **float**. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί την κλειδώσει της δήλωσης C# lock(). Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th επιχείρημα προτύπου ως αδύναμο δείκτη (αντί για κοινό). Επιτρέπει την εναλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την απεμπλοκή της δήλωσης C# lock(). Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο [LockContext](../../system/lockcontext/). |
