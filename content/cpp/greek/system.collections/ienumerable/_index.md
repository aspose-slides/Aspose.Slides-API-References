...
description: IEnumerable είναι η βασική διεπαφή για όλες τις μη γενικές συλλογές που μπορούν να απαριθμηθούν.
type: docs
weight: 53
url: /el/system.collections/ienumerable/
---
## IEnumerable κλάση

[IEnumerable](./) είναι η βασική διεπαφή για όλες τις μη γενικές συλλογές που μπορούν να απαριθμηθούν.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | Επιστρέφει έναν αριθμητή που διατρέχει μια συλλογή. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Ανάλογη της C# [Object.GetHashCode()](../../system/object/gethashcode/) μεθόδου. Επιτρέπει το hashing προσαρμοσμένων αντικειμένων. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Αναλογία της C# [Object.ToString()](../../system/object/tostring/) μεθόδου. Επιτρέπει τη μετατροπή προσαρμοσμένων αντικειμένων σε συμβολοσειρά. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει το μετρητή αδύναμης αναφοράς. Δεν πρέπει να κληθεί απευθείας· χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
