...
description: IList αντιπροσωπεύει μια μη-γενική συλλογή αντικειμένων που μπορούν να προσπελαστούν ατομικά με δείκτη.
type: docs
weight: 118
url: /el/system.collections/ilist/
---
## IList κλάση

[IList](./) Αντιπροσωπεύει μια μη γενική συλλογή αντικειμένων που μπορούν να προσπελαστούν ατομικά με δείκτη.
...
| Method | Description |
| --- | --- |
| virtual int [Add](./add/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Προσθέτει στοιχείο στο τέλος της λίστας. |
| virtual void [Clear](./clear/)() | Αφαιρεί όλα τα στοιχεία από τη λίστα. |
| virtual **bool** [Contains](./contains/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Ελέγχει αν το στοιχείο βρίσκεται στη λίστα. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Συγκρίνει αντικείμενα χρησιμοποιώντας τη σημασιολογία C# [Object.Equals](../../system/object/equals/). |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Συγκρίνει αντικείμενα τύπου αναφοράς σε στυλ C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Συγκρίνει αντικείμενα τύπου τιμής σε στυλ C#. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Εμιμιτοποεί σύγκριση κινητής υποδιαστολής σε στυλ C# όπου δύο NaN θεωρούνται ίσα παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Εμιμιτοποεί σύγκριση κινητής υποδιαστολής σε στυλ C# όπου δύο NaN θεωρούνται ίσα παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Μόνο για εσωτερική χρήση. |
| virtual int [get_Count](../icollection/get_count/)() const | Επιστρέφει τον αριθμό των στοιχείων στη συλλογή. |
| virtual **bool** [get_IsFixedSize](./get_isfixedsize/)() const | Επιστρέφει τιμή που υποδεικνύει αν η λίστα έχει σταθερό μέγεθος. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](../ienumerable/getenumerator/)() | Επιστρέφει έναν επαναλήπτη που διασχίζει μια συλλογή. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(int, int) const | Επιστρέφει το στοιχείο στο καθορισμένο δείκτη. |
| virtual int [IndexOf](./indexof/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Επιστρέφει τον πρώτο δείκτη του καθορισμένου στοιχείου. |
| virtual void [Insert](./insert/)(int, [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Εισάγει το στοιχείο στη λίστα στο καθορισμένο δείκτη. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευή αντιγράφου. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή σε υποκατηγορίες. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής ανάθεσης. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή σε υποκατηγορίες. |
...
| virtual void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Αφαιρεί την πρώτη παρουσία του καθορισμένου στοιχείου από τη λίστα. |
| virtual void [RemoveAt](./removeat/)(int) | Αφαιρεί το στοιχείο από τη λίστα στο καθορισμένο δείκτη. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Επιστρέφει την τρέχουσα τιμή του κοινόμετρου αναφορών. |
