...
description: Παρέχει έναν επαναλήπτη για ένα επιλεγμένο σύνολο κόμβων.
type: docs
weight: 79
url: /el/system.xml.xpath/xpathnodeiterator/
---
## XPathNodeIterator κλάση

Παρέχει έναν επαναλήπτη για ένα επιλεγμένο σύνολο κόμβων.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Λαμβάνει έναν επαναλήπτη που δείχνει στο πρώτο στοιχείο (αν υπάρχει) της συλλογής. Αυτός ο επαναλήπτης δεν μπορεί να χρησιμοποιηθεί για την αλλαγή ενός αντικειμένου παραπομπής επειδή [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) επιστρέφει ένα αντίγραφο-αντικείμενο του T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Λαμβάνει έναν επαναλήπτη που δείχνει στο πρώτο στοιχείο (αν υπάρχει) της const-καθορισμένης εκδοχής της συλλογής. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Λαμβάνει έναν επαναλήπτη που δείχνει ακριβώς μετά το τελευταίο const-καθορισμένο στοιχείο (αν υπάρχει) της συλλογής. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNodeIterator](./)\> [Clone](./clone/)() | Όταν επαναπροσαρμόζεται σε παράγωγη κλάση, επιστρέφει ένα κλώνο αυτού του αντικειμένου [XPathNodeIterator](./). |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Λαμβάνει έναν επαναλήπτη που δείχνει ακριβώς μετά το τελευταίο στοιχείο (αν υπάρχει) της συλλογής. Αυτός ο επαναλήπτης δεν μπορεί να χρησιμοποιηθεί για την αλλαγή ενός αντικειμένου παραπομπής επειδή [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) επιστρέφει ένα αντίγραφο-αντικείμενο του T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Λαμβάνει έναν επαναλήπτη που δείχνει ακριβώς μετά το τελευταίο στοιχείο (αν υπάρχει) της const-καθορισμένης εκδοχής της συλλογής. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Επιστρέφει το δείκτη του τελευταίου κόμβου στο επιλεγμένο σύνολο κόμβων. |
| virtual const [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\& [get_Current](./get_current/)() | Όταν επαναπροσαρμόζεται σε παράγωγη κλάση, λαμβάνει το αντικείμενο [XPathNavigator](../xpathnavigator/) για αυτό το [XPathNodeIterator](./), τοποθετημένο στον τρέχοντα κόμβο περιβάλλοντος. |
| virtual **int32_t** [get_CurrentPosition](./get_currentposition/)() | Όταν επαναπροσαρμόζεται σε παράγωγη κλάση, λαμβάνει το δείκτη της τρέχουσας θέσης στο επιλεγμένο σύνολο κόμβων. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Λαμβάνει τη δομή δεδομένων καταμετρητή αναφοράς που συνδέεται με το αντικείμενο. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\>\> [GetEnumerator](./getenumerator/)() override | Επιστρέφει ένα αντικείμενο IEnumerator για την επανάληψη του επιλεγμένου συνόλου κόμβων. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | Καθορίζει εάν η ακολουθία περιέχει οποιαδήποτε στοιχεία. |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Επιστρέφει το στοιχείο στη συγκεκριμένη θέση μιας ακολουθίας. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Επιστρέφει το στοιχείο στη συγκεκριμένη θέση μιας ακολουθίας. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Καταγράφει κάθε στοιχείο μιας ακολουθίας και συγχωνεύει τις προκύπτουσες ακολουθίες σε μία. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Φιλτράρει μια ακολουθία βάσει του καθορισμένου πρόλογου. |
| void [Lock](../../system/object/lock/)() | Υλοποιεί την εντολή C# `lock()` κλείδωμα. Κλήση άμεσα ή χρήση του αντικειμένου sentry [LockContext](../../system/lockcontext/). |
...
| virtual **bool** [MoveNext](./movenext/)() | Όταν επαναπροσαρμόζεται σε παράγωγη κλάση, μετακινεί το αντικείμενο [XPathNavigator](../xpathnavigator/) που επιστρέφει η μέθοδος [XPathNodeIterator::get_Current](./get_current/) στον επόμενο κόμβο του επιλεγμένου συνόλου κόμβων. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Συγκρίνει αντικείμενα τύπου τιμής με αναφορά προς nullptr. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n-οστό επιχειρήμα προτύπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την εντολή C# `lock()` ξεκλείδωμα. Κλήση άμεσα ή χρήση του αντικειμένου sentry [LockContext](../../system/lockcontext/). |
