...
description: Παρέχει την εξαίρεση που εκτοξεύεται όταν προκύπτει σφάλμα κατά την επεξεργασία μιας έκφρασης XPath.
type: docs
weight: 1
url: /el/system.xml.xpath/details_xpathexception/
---
## Details_XPathException κλάση

Παρέχει την εξαίρεση που εκτοξεύεται όταν συμβαίνει σφάλμα κατά την επεξεργασία μιας έκφρασης [XPath](../).
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | Επιστρέφει μια κατεύθυνση στο αντικείμενο που αντιπροσωπεύει την εσωτερική εξαίρεση. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Επιστρέφει την περιγραφή της κατάστασης σφάλματος για αυτήν την εξαίρεση. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Αποκτά τον πραγματικό τύπο του αντικειμένου. Αναλογικό της κλήσης C# [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Εφαρμόζει τη μέθοδο [what()](../../system/details_exception/what/) η οποία καλείται από την κλάση [ExceptionWrapper](../../system/exceptionwrapper/). Παρά το γεγονός ότι αυτή η κλάση δεν κληρονομεί από std::exception, οι παράγωγες κλάσεις μπορούν να χρησιμοποιήσουν προστατευμένα/ιδιωτικά μέλη για να υλοποιήσουν τη λογική τους. Η μεταφορά της υλοποίησης αυτής της μεθόδου στο [ExceptionWrapper](../../system/exceptionwrapper/) μπορεί να διακόψει αυτή τη λογική. |
