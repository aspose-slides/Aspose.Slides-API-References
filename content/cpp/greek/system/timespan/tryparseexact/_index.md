...
description: Μετατρέπει τη συμβολοσειρά σε ισοδύναμο αντικείμενο TimeSpan χρησιμοποιώντας τις καθορισμένες μορφές και τον πάροχο μορφής, και επιστρέφει το αποτέλεσμα της μετατροπής.
type: docs
weight: 573
url: /el/system/timespan/tryparseexact/
---
## TimeSpan::TryParseExact(const String\&, const ArrayPtr\<String\>\&, const SharedPtr\<IFormatProvider\>\&, TimeSpan\&) method

Μετατρέπει τη συμβολοσειρά σε ισοδύναμο αντικείμενο [TimeSpan](../) χρησιμοποιώντας τις καθορισμένες μορφές και τον πάροχο μορφής, και επιστρέφει το αποτέλεσμα της μετατροπής.
...
Αληθές εάν η συμβολοσειρά μετατράπηκε επιτυχώς· διαφορετικά, ψευδές.
...
Μετατρέπει τη συμβολοσειρά σε ισοδύναμο αντικείμενο [TimeSpan](../) χρησιμοποιώντας την καθορισμένη μορφή, τον πάροχο μορφής και τα στυλ, και επιστρέφει το αποτέλεσμα της μετατροπής.
...
Μετατρέπει τη συμβολοσειρά σε ισοδύναμο αντικείμενο [TimeSpan](../) χρησιμοποιώντας την καθορισμένη μορφή και τον πάροχο μορφής, και επιστρέφει το αποτέλεσμα της μετατροπής.
...
* Απαρίθμηση [TimeSpanStyles](../../../system.globalization/timespanstyles/)
