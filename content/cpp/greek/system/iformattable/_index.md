...
description: Ορίζει μια μέθοδο που μορφοποιεί την τιμή του τρέχοντος αντικειμένου χρησιμοποιώντας τη συγκεκριμένη συμβολοσειρά μορφής και τον πάροχο μορφής.
type: docs
weight: 1002
url: /el/system/iformattable/
---
## IFormattable κλάση

Ορίζει μια μέθοδο που μορφοποιεί την τιμή του τρέχοντος αντικειμένου χρησιμοποιώντας τη συγκεκριμένη συμβολοσειρά μορφής και τον πάροχο μορφής.
