...
Αντιπροσωπεύει μια ταμπέλα για κείμενο.
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Επιστρέφει το στυλ στοίχισης μιας ετικέτας. Διαβάστε [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Επιστρέφει τη θέση μιας ετικέτας. Η ανάθεση αυτής της ιδιότητας μπορεί να αλλάξει το δείκτη της ετικέτας στη συλλογή και να ακυρώσει τον Enumerator. Διαβάστε **double**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Δεν αντιγράφει τίποτα, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή κατασκευών υποκατηγοριών. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής ανάθεσης. Δεν αντιγράφει τίποτα, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή κατασκευών υποκατηγοριών. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Ορίζει το στυλ στοίχισης μιας ετικέτας. Γράψτε [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Ορίζει τη θέση μιας ετικέτας. Η ανάθεση αυτής της ιδιότητας μπορεί να αλλάξει το δείκτη της ετικέτας στη συλλογή και να ακυρώσει τον Enumerator. Γράψτε **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδύναμη διεύθυνση (αντί για κοινόχρηστη). Επιτρέπει την εναλλαγή δεικτών σε δοχεία σε αδύναμη λειτουργία. |
