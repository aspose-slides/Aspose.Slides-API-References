...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [AddComment](./addcomment/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Προσθέτει νέο σχόλιο στο τέλος μιας συλλογής. |
| [System::SharedPtr](../../system/sharedptr/)\<[IModernComment](../imoderncomment/)\> [AddModernComment](./addmoderncomment/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Προσθέτει νέο μοντέρνο σχόλιο στο τέλος μιας συλλογής. |
| [iterator](./iterator/) [begin](./begin/)() | Λαμβάνει επαναλήπτη που δείχνει στο πρώτο στοιχείο (εάν υπάρχει) της συλλογής. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Λαμβάνει επαναλήπτη που δείχνει στο πρώτο στοιχείο (εάν υπάρχει) της const-qualified παρουσίας της συλλογής. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Λαμβάνει επαναλήπτη που δείχνει στο πρώτο const-qualified στοιχείο (εάν υπάρχει) της συλλογής. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Λαμβάνει επαναλήπτη που δείχνει ακριβώς μετά το τελευταίο const-qualified στοιχείο (εάν υπάρχει) της συλλογής. |
| void [Clear](./clear/)() override | Αφαιρεί όλα τα σχόλια από μια συλλογή. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\>, **int32_t**) override | Αντιγράφει όλα τα στοιχεία από τη συλλογή στον καθορισμένο πίνακα. |
...
| [iterator](./iterator/) [end](./end/)() | Λαμβάνει επαναλήπτη που δείχνει ακριβώς μετά το τελευταίο στοιχείο (εάν υπάρχει) της συλλογής. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Λαμβάνει επαναλήπτη που δείχνει ακριβώς μετά το τελευταίο στοιχείο (εάν υπάρχει) της const-qualified παρουσίας της συλλογής. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [FindCommentByIdx](./findcommentbyidx/)(**int32_t**) | Βρίσκει ένα σχόλιο στη συλλογή με βάση το ευρετήριο. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Επιστρέφει έναν ριζικό αντικείμενο συγχρονισμού. Μόνο για ανάγνωση [System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Λαμβάνει τη δομή δεδομένων μετρητή αναφοράς που σχετίζεται με το αντικείμενο. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\>\> [GetEnumerator](./getenumerator/)() override | Επιστρέφει έναν enumerator που διατρέχει τη συλλογή. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [idx_get](./idx_get/)(**int32_t**) override | Λαμβάνει το στοιχείο στο συγκεκριμένο ευρετήριο. Μόνο για ανάγνωση [Comment](../comment/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [InsertComment](./insertcomment/)(**int32_t**, [System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Εισάγει νέο σχόλιο στη συλλογή στο συγκεκριμένο ευρετήριο. |
| [System::SharedPtr](../../system/sharedptr/)\<[IModernComment](../imoderncomment/)\> [InsertModernComment](./insertmoderncomment/)(**int32_t**, [System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>, [System::Drawing::PointF](../../system.drawing/pointf/), [System::DateTime](../../system/datetime/)) override | Εισάγει νέο μοντέρνο σχόλιο στη συλλογή στο συγκεκριμένο ευρετήριο. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Φιλτράρει μια ακολουθία βάσει του καθορισμένου κατηγοριστικού. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>) override | Αφαιρεί την πρώτη εμφάνιση του καθορισμένου σχολίου σε μια συλλογή. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Αφαιρεί το στοιχείο στο καθορισμένο ευρετήριο σε μια συλλογή. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Ορίζει το n'th όρισμα προτύπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\> [ToArray](./toarray/)() override | Δημιουργεί και επιστρέφει έναν πίνακα με όλα τα σχόλια. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>\> [ToArray](./toarray/)(**int32_t**, **int32_t**) override | Δημιουργεί και επιστρέφει έναν πίνακα με όλα τα σχόλια από το καθορισμένο εύρος. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Λαμβάνει επαναλήπτη που δείχνει στο πρώτο στοιχείο (εάν υπάρχει) της const-qualified παρουσίας της συλλογής. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Λαμβάνει επαναλήπτη που δείχνει ακριβώς μετά το τελευταίο στοιχείο (εάν υπάρχει) της const-qualified παρουσίας της συλλογής. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Λαμβάνει επαναλήπτη που δείχνει ακριβώς μετά το τελευταίο στοιχείο (εάν υπάρχει) της συλλογής. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον μετρητή αδύναμων αναφορών. Δεν πρέπει να καλείται άμεσα· αντίθετα, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον μετρητή αδύναμων αναφορών. Δεν πρέπει να καλείται άμεσα· αντίθετα, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
...
* Κλάση [ICommentCollection](../icommentcollection/)
