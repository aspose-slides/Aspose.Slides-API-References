...
| virtual **float** [get_Height](./get_height/)() | Gets the height of the shape, measured in points. Read **float**. |
...
| virtual **uint32_t** [get_UniqueId](./get_uniqueid/)() | Returns an internal, presentation-scoped identifier intended for use by add-ins or other code. Because this value can be reassigned by the user or programmatically, it must not be treated as a persistent unique key. Read-only **uint32_t**. See also [IShape::get_OfficeInteropShapeId](./get_officeinteropshapeid/). |
| virtual **float** [get_Width](./get_width/)() | Gets the width of the shape, measured in points. Read **float**. |
| virtual **float** [get_X](./get_x/)() | Gets the x-coordinate of the shape's upper-left corner, measured in points. Read **float**. |
| virtual **float** [get_Y](./get_y/)() | Gets the y-coordinate of the shape's upper-left corner, measured in points. Read **float**. |
...
| virtual void [set_Height](./set_height/)(**float**) | Sets the height of the shape, measured in points. Write **float**. |
| virtual void [set_Hidden](./set_hidden/)(**bool**) | Sets the hidden state of the shape. Write **bool**. |
...
| virtual void [set_Width](./set_width/)(**float**) | Sets the width of the shape, measured in points. Write **float**. |
| virtual void [set_X](./set_x/)(**float**) | Sets the x-coordinate of the shape's upper-left corner, measured in points. Write **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Sets the y-coordinate of the shape's upper-left corner, measured in points. Write **float**. |
