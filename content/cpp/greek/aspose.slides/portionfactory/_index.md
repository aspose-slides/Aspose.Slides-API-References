...
| Method | Περιγραφή |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)() override | Δημιουργεί ένα κενό τμήμα κειμένου. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)([System::String](../../system/string/)) override | Δημιουργεί ένα τμήμα κειμένου από το καθορισμένο συμβολοσειρά. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Δημιουργεί ένα τμήμα χρησιμοποιώντας καθορισμένα δεδομένα τμήματος. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Επιστρέφει τη δομή δεδομένων του καταμετρητή αναφοράς που σχετίζεται με το αντικείμενο. |
...
* Κλάση [IPortionFactory](../iportionfactory/)
