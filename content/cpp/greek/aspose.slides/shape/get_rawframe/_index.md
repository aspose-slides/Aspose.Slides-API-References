...
type: docs
weight: 40
url: /el/aspose.slides/shape/get_rawframe/
---
## Shape::get_RawFrame() μέθοδος
...
// παράμετροι x, y, width, height δεν μπορούν να είναι std::numeric_limits<float>::quiet_NaN():
{
...
```cpp
SharedPtr<IShape> shape = ...; // το σχήμα είναι συνδεδεμένο με σύμβολο κράτησης
shape->set_RawFrame(System::MakeObject<ShapeFrame>(std::numeric_limits<float>::quiet_NaN(), 
std::numeric_limits<float>::quiet_NaN(), 100.0f, std::numeric_limits<float>::quiet_NaN(), 
NullableBool::NotDefined, NullableBool::NotDefined, 0.0f)); // τώρα το σχήμα κληρονομεί τις τιμές x, y, height, flipH, flipV από το σύμβολο κράτησης και αντικαθιστά width=100 και rotationAngle=0.
```
