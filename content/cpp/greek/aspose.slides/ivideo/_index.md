...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Επιστρέφει το αντίγραφο των δεδομένων ενός ήχου. Σε περίπτωση μεγάλου όγκου δεδομένων συνίσταται η χρήση της μεθόδου [IVideo::GetStream](./getstream/) για να αποφευχθεί η περιττή φόρτωση δεδομένων βίντεο στη μνήμη ή ακόμη και η εξαίρεση OutOfMemoryException. Μόνο-ανάγνωση **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Επιστρέφει τύπο MIME ενός βίντεο, κωδικοποιημένο σε [IVideo::get_BinaryData](./get_binarydata/). Μόνο-ανάγνωση [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | Επιστρέφει ροή Stream για ανάγνωση. Χρησιμοποιήστε ‘using’ ή κλείστε τη ροή μετά τη χρήση. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει εάν το αντικείμενο αποτελεί παρουσία ενός τύπου που περιγράφεται από targetType. Αναλογο του τελεστή C# 'is'. |
| void [Lock](../../system/object/lock/)() | Υλοποιεί τη δήλωση κλειδώματος C# lock(). Κληθεί άμεσα ή χρησιμοποιήστε το αντικείμενο sentry [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Δεν αντιγράφει κάτι, πραγματικά, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή υποκλάσεων μέσω αντιγραφής. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής ανάθεσης. Δεν αντιγράφει κάτι, πραγματικά, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή υποκλάσεων μέσω αντιγραφής. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την αποσφράγιση της δήλωσης C# lock(). Κληθεί άμεσα ή χρησιμοποιήστε το αντικείμενο sentry [LockContext](../../system/lockcontext/). |
