...
description: Κατατυλίγει τη βασική υποδομή υπηρεσιών για αντικείμενα που μπορούν να αποτελέσουν αντικείμενο κληρονομικότητας τιμής ιδιοτήτων.
type: docs
weight: 4928
...
Κατατυλίγει τη βασική υποδομή υπηρεσιών για αντικείμενα που μπορούν να αποτελέσουν αντικείμενο κληρονομικότητας τιμής ιδιοτήτων.
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Επιστρέφει κώδικα κατακερματισμού. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'tο πρότυπο ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
