...
description: Αναπαριστά έναν τύπο που μπορεί να επιστρέψει τα αντίστοιχα αποτελεσματικά δεδομένα με την κληρονομική εφαρμογή.
type: docs
weight: 1275
url: /el/aspose.slides/iaccessiblepviobject/
---
## IAccessiblePVIObject κλάση

Αναπαριστά έναν τύπο που μπορεί να επιστρέψει τα αντίστοιχα αποτελεσματικά δεδομένα με την κληρονομική εφαρμογή.
...
| --- | --- |
| T | Τύπος αποτελεσματικών δεδομένων. |
## Μέθοδοι
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Προσομοιώνει σύγκριση κινητής υποκοπής σε στυλ C# όπου δύο NaN θεωρούνται ίσα, παρότι σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Προσομοιώνει σύγκριση κινητής υποκοπής σε στυλ C# όπου δύο NaN θεωρούνται ίσα, παρότι σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
...
| virtual T [GetEffective](./geteffective/)() | Παίρνει τα αποτελεσματικά δεδομένα με την κληρονομική εφαρμογή. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί τη δήλωση κλειδώματος C# lock(). Κλήστε απευθείας ή χρησιμοποιήστε το αντικείμενο sentry [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευάστης αντιγραφής. Δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή αντιγραφής υποτύπων. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεσάριθμος ανάθεσης. Δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή αντιγραφής υποτύπων. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την απελευθέρωση της δήλωσης κλειδώματος C# lock(). Κλήστε απευθείας ή χρησιμοποιήστε το αντικείμενο sentry [LockContext](../../system/lockcontext/). |
