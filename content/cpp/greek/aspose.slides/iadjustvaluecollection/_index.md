...
description: Παριστά μια συλλογή προσαρμογών σχήματος.
type: docs
weight: 1301
url: /el/aspose.slides/iadjustvaluecollection/
---
## IAdjustValueCollection κλάση

Παριστά μια συλλογή προσαρμογών σχήματος.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [idx_get](./idx_get/)(**int32_t**) | Επιστρέφει τη ρύθμιση με βάση το δείκτη. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το statement C# lock() για κλείδωμα. Κάλεσε άμεσα ή χρησιμοποίησε το αντικείμενο εποπτείας [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το statement C# lock() για ξεκλείδωμα. Κάλεσε άμεσα ή χρησιμοποίησε το αντικείμενο εποπτείας [LockContext](../../system/lockcontext/). |
