...
type: docs
weight: 313
url: /el/aspose.slides/ipicturefillformat/set_tileoffsety/
---
## IPictureFillFormat::set_TileOffsetY(float) μέθοδος


Ορίζει την κατακόρυφη μετατόπιση της υφής από το αρχικό σημείο του σχήματος σε μονάδες σημείου. Μία θετική τιμή μετακινεί την υφή προς τα κάτω, ενώ μία αρνητική τιμή τη μετακινεί προς τα πάνω. Γράψτε **float**.
