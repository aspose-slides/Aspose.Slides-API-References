...
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Όνομα της ενότητας. |
| virtual [System::Guid](../../system/guid/) [get_SectionId](./get_sectionid/)() | [Section](../section/) Αναγνωριστικό. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_StartedFromSlide](./get_startedfromslide/)() | Επιστρέφει την πρώτη διαφάνεια της ενότητας. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISectionSlideCollection](../isectionslidecollection/)\> [GetSlidesListOfSection](./getslideslistofsection/)() | Επιστρέφει τη λίστα των διαφανειών στην ενότητα. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το κλείδωμα της δήλωσης C# lock(). Καλείται άμεσα ή χρησιμοποιεί το αντικείμενο εποπτείας [LockContext](../../system/lockcontext/). |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Όνομα της ενότητας. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδύναμος δείκτης (αντί για κοινόχρηστο). Επιτρέπει την εναλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
