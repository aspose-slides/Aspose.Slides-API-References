...
|  [FontSubstRule](./fontsubstrule/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) | Δημιουργεί νέα παρουσία. |
|  [FontSubstRule](./fontsubstrule/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>, [FontSubstCondition](../fontsubstcondition/)) | Δημιουργεί νέα παρουσία. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_DestFont](./get_destfont/)() override | Γραμματοσειρά που χρησιμοποιείται για αντικατάσταση. Μόνο για ανάγνωση [IFontData](../ifontdata/). |
| [FontSubstCondition](../fontsubstcondition/) [get_ReplaceFontCondition](./get_replacefontcondition/)() override | Κανόνας που εφαρμόζεται για αντικατάσταση. Μόνο για ανάγνωση [FontSubstCondition](../fontsubstcondition/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_SourceFont](./get_sourcefont/)() override | Γραμματοσειρά για αντικατάσταση. Μόνο για ανάγνωση [IFontData](../ifontdata/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αντιπροσωπεύει μία παρουσία τύπου που περιγράφεται από targetType. Αναλογικό του τελεστή C# 'is'. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει την n-οστή παράμετρο προτύπου ως αδυναμικό δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε συλλογές σε αδυναμική λειτουργία. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Εφαρμόζει το κατασκευαστικό τύπου C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Εφαρμόζει την άρση κλειδώματος της δήλωσης C# lock(). Καλέστε απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
...
* Κλάση [IFontSubstRule](../ifontsubstrule/)
