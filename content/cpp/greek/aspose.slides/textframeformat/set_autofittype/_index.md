...
description: Ορίζει τη λειτουργία αυτόματης προσαρμογής του κειμένου. Γράψτε TextAutofitType.
type: docs
weight: 235
url: /el/aspose.slides/textframeformat/set_autofittype/
---
## TextFrameFormat::set_AutofitType(TextAutofitType) μέθοδος
...
```
 Η παρακάτω κώδικας δείχνει πώς να μειώσετε το κείμενο σε περίπτωση υπερχείλισης. 
```cpp
auto pres = System::MakeObject<Presentation>();
auto slide = pres->get_Slides()->idx_get(0);
