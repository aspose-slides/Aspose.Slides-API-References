...
description: Επιστρέφει τον αριθμό των στηλών στην περιοχή κειμένου. Αυτή η τιμή πρέπει να είναι θετικός αριθμός. Διαφορετικά, η τιμή θα οριστεί σε μηδέν. Η τιμή 0 σημαίνει ακαθόριστη τιμή. Διαβάζει int32_t.
type: docs
weight: 248
url: /el/aspose.slides/textframeformat/get_columncount/
---
## TextFrameFormat::get_ColumnCount() μέθοδος

Επιστρέφει τον αριθμό των στηλών στην περιοχή κειμένου. Αυτή η τιμή πρέπει να είναι θετικός αριθμός. Διαφορετικά, η τιμή θα οριστεί σε μηδέν. Η τιμή 0 σημαίνει ακαθορισμένη τιμή. Διαβάζει **int32_t**.
...
Ο παρακάτω κώδικας δείγματος δείχνει πώς να προσθέσετε στήλη σε πλαίσιο κειμένου μέσα σε ένα PowerPoint [Presentation](../../presentation/).
```cpp
