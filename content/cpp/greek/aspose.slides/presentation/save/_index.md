...
---
## Presentation::Save(System::String, Export::SaveFormat) μέθοδος
...
| --- | --- | --- |
| fname | [System::String](../../../system/string/) | Διαδρομή προς το δημιουργημένο αρχείο. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Μορφή των εξαγόμενων δεδομένων. |

## Presentation::Save(System::SharedPtr\<System::IO::Stream\>, Export::SaveFormat) μέθοδος

Αποθηκεύει όλες τις διαφάνειες μιας παρουσίασης σε μια ροή στη συγκεκριμένη μορφή.
...
| Παράμετρος | Τύπος | Περιγραφή |
| --- | --- | --- |
| stream | [System::SharedPtr](../../../system/sharedptr/)\<[System::IO::Stream](../../../system.io/stream/)\> | Ροή εξόδου. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Μορφή των εξαγόμενων δεδομένων. |

## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) μέθοδος
...
| fname | [System::String](../../../system/string/) | Διαδρομή προς το δημιουργημένο αρχείο. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Μορφή των εξαγόμενων δεδομένων. |
| options | [System::SharedPtr](../../../system/sharedptr/)\<[Export::ISaveOptions](../../../aspose.slides.export/isaveoptions/)\> | Πρόσθετες επιλογές μορφής. |

## Παρατηρήσεις

Το παρακάτω παράδειγμα δείχνει πώς να μετατρέψετε το PowerPoint σε HTML χρησιμοποιώντας C++.
```cpp
// Δημιουργεί ένα αντικείμενο παρουσίασης που αντιπροσωπεύει ένα αρχείο παρουσίασης π.χ. PPT, PPTX, ODP κ.λπ.
...
// Αποθηκεύει την παρουσίαση σε HTML
presentation->Save(u"ConvertWholePresentationToHTML_out.html", SaveFormat::Html, htmlOpt);
```
Το παρακάτω παράδειγμα δείχνει πώς να μετατρέψετε το PowerPoint σε responsive HTML χρησιμοποιώντας C++.
```cpp
...
```
Το παρακάτω παράδειγμα δείχνει πώς να μετατρέψετε το PowerPoint σε HTML με σημειώσεις χρησιμοποιώντας C++.
```cpp
...
```
Το παρακάτω παράδειγμα δείχνει πώς να μετατρέψετε το PowerPoint σε HTML με τις αρχικές γραμματοσειρές χρησιμοποιώντας C++.
```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// Εξαιρεί τις προεπιλεγμένες γραμματοσειρές παρουσίασης
...
```
Το παρακάτω παράδειγμα δείχνει πώς να μεταφέρετε το PowerPoint σε HTML με εικόνες υψηλής ποιότητας στα 150 DPI χρησιμοποιώντας C++.
```cpp
...
```
Το παρακάτω παράδειγμα δείχνει πώς να μετατρέψετε το PowerPoint σε HTML με εικόνες πλήρους ποιότητας χρησιμοποιώντας C++.
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
Το παρακάτω παράδειγμα δείχνει πώς να μετατρέψετε [Slide](../../slide/) σε HTML χρησιμοποιώντας C++.
```cpp
```
...
* Κλάση [IXamlOptions](../../../aspose.slides.export.xaml/ixamloptions/)
