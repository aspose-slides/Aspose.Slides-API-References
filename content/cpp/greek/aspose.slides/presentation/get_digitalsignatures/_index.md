...
description: Επιστρέφει τη συλλογή των υπογραφών που χρησιμοποιούνται για την υπογραφή της παρουσίασης. Μόνο-ανάγνωση IDigitalSignatureCollection.
type: docs
weight: 261
url: /el/aspose.slides/presentation/get_digitalsignatures/
---
## Presentation::get_DigitalSignatures() μέθοδος


Επιστρέφει τη συλλογή των υπογραφών που χρησιμοποιούνται για την υπογραφή της παρουσίασης. Μόνο-ανάγνωση [IDigitalSignatureCollection](../../idigitalsignaturecollection/).
