...
description: Αντιπροσωπεύει μια ιδιότητα 'Heading pair' του εγγράφου. Δείχνει το όνομα της ομάδας των τμημάτων του εγγράφου και τον αριθμό των τμημάτων στην ομάδα.
type: docs
weight: 2510
...
Αντιπροσωπεύει μία ιδιότητα ‘Heading pair’ του εγγράφου. Δείχνει το όνομα της ομάδας των τμημάτων του εγγράφου και τον αριθμό των τμημάτων στην ομάδα.
...
| virtual **int32_t** [get_Count](./get_count/)() | Επιστρέφει τον αριθμό των τμημάτων στην ομάδα. Μόνο-ανάγνωση **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Επιστρέφει το όνομα της ομάδας των τμημάτων του εγγράφου. Μόνο-ανάγνωση [System::String](../../system/string/). |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Αναλογικό της μεθόδου C# [Object.GetHashCode()](../../system/object/gethashcode/). Ενεργοποιεί τη δημιουργία κατακερματικού κώδικα για προσαρμοσμένα αντικείμενα. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί την εντολή lock() της C# για κλείδωμα. Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο [LockContext](../../system/lockcontext/). |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Υλοποιεί την δομή C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την εντολή lock() της C# για ξεκλείδωμα. Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο [LockContext](../../system/lockcontext/). |
