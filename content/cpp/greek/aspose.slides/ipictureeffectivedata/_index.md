...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() | Επιστρέφει την ενσωματωμένη εικόνα. Μόνο για ανάγνωση [IPPImage](../ippimage/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/)\> [get_ImageTransform](./get_imagetransform/)() | Επιστρέφει τη συλλογή των επιδράσεων μετασχηματισμού εικόνας. Μόνο για ανάγνωση [Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IEffectEffectiveData](../../aspose.slides.effects/ieffecteffectivedata/)\> [get_ImageTransformEffect](./get_imagetransformeffect/)(**int32_t**) | Επιστρέφει την επιδράση μετασχηματισμού εικόνας που καθορίζεται στο δείκτη. |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Επιστρέφει το URL της συνδεδεμένης εικόνας. Μόνο για ανάγνωση [System::String](../../system/string/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδύναμη δείκτη (αντί για κοινό). Επιτρέπει την εναλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
...
Αυτή η διεπαφή χρησιμοποιείται ως μέρος του [IPictureFillFormatEffectiveData](../ipicturefillformateffectivedata/) και του [IBulletFormatEffectiveData](../ibulletformateffectivedata/). 
