...
Aspose.IO.Stream wrapper για διεπαφή COM.
...
| Method | Description |
| --- | --- |
| void [Close](./close/)() override | Κλείνει το τρέχον stream και απελευθερώνει οποιουσδήποτε πόρους. |
...
| void [Flush](./flush/)() override | Αφαιρεί όλες τις προσωρινές μνήμες (buffers) για αυτό το stream και προκαλεί την εγγραφή των δεδομένων που έχουν αποθηκευθεί στο υποκείμενο μέσο. |
| **bool** [get_CanRead](./get_canread/)() override | Λαμβάνει μια τιμή που δείχνει εάν το τρέχον stream υποστηρίζει ανάγνωση. Μόνο-ανάγνωση **bool**. |
| **bool** [get_CanSeek](./get_canseek/)() override | Λαμβάνει μια τιμή που δείχνει εάν το τρέχον stream υποστηρίζει αναζήτηση. Μόνο-ανάγνωση **bool**. |
| **bool** [get_CanWrite](./get_canwrite/)() override | Λαμβάνει μια τιμή που δείχνει εάν το τρέχον stream υποστηρίζει εγγραφή. Μόνο-ανάγνωση **bool**. |
| **int64_t** [get_Length](./get_length/)() override | Λαμβάνει το μήκος σε bytes του stream. Μόνο-ανάγνωση **int64_t**. |
| **int64_t** [get_Position](./get_position/)() override | Λαμβάνει τη θέση εντός του τρέχοντος stream. Μόνο-ανάγνωση **int64_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [get_Stream](./get_stream/)() override | Λαμβάνει ένα stream. Μόνο-ανάγνωση [System::IO::Stream](../../system.io/stream/). |
...
| void [Read](./read/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) override | Διαβάζει μια ακολουθία bytes από το τρέχον stream και προχωρά τη θέση εντός του stream κατά τον αριθμό των bytes που διαβάστηκαν. |
| **int32_t** [ReadByte](./readbyte/)() override | Διαβάζει ένα byte από το stream και προχωρά τη θέση κατά ένα byte, ή επιστρέφει -1 αν είναι στο τέλος του stream. |
...
| **int64_t** [Seek](./seek/)(**int64_t**, [System::IO::SeekOrigin](../../system.io/seekorigin/)) override | Ορίζει τη θέση εντός του τρέχοντος stream |
...
| void [Write](./write/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) override | Γράφει μια ακολουθία bytes στο τρέχον stream και προχωρά τη θέση εντός του stream κατά τον αριθμό των bytes που γράφτηκαν. |
| void [WriteByte](./writebyte/)(**uint8_t**) override | Γράφει ένα byte στην τρέχουσα θέση του stream και προχωρά τη θέση κατά ένα byte. |
