...
description: Αναπαριστά ενσωματωμένα στυλ πίνακα.
type: docs
weight: 6514
...
Αναπαριστά ενσωματωμένα στυλ πίνακα.
...
| --- | --- | --- |
| Custom | -1 | [Table](../table/) έχει προσαρμοσμένο στυλ. Αυτή είναι τιμή μόνο για ανάγνωση. |
| None | 0 | Κανένα στυλ. |
