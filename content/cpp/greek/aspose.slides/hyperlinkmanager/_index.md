...
description: Παρέχει διαχείριση υπερσυνδέσμων (προσθήκη, κατάργηση).
type: docs
weight: 1249
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Αποκτά τον πραγματικό τύπο του αντικειμένου. Αναλογική κλήσης C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αντιπροσωπεύει μια περίπτωση του τύπου που περιγράφεται από targetType. Αναλογικό του C# 'is' τελεστή. |
...
| void [RemoveHyperlinkClick](./removehyperlinkclick/)() override | Αφαιρεί τον υπερσύνδεσμο κατά το κλικ. |
| void [RemoveHyperlinkMouseOver](./removehyperlinkmouseover/)() override | Αφαιρεί τον υπερσύνδεσμο κατά το πέρασμα του ποντικιού. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkClick](./setexternalhyperlinkclick/)([System::String](../../system/string/)) override | Ορίζει εξωτερικό υπερσύνδεσμο κατά το κλικ. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkMouseOver](./setexternalhyperlinkmouseover/)([System::String](../../system/string/)) override | Ορίζει εξωτερικό υπερσύνδεσμο όταν το ποντίκι περνά πάνω. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkClick](./setinternalhyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | Ορίζει εσωτερικό υπερσύνδεσμο κατά το κλικ. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkMouseOver](./setinternalhyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | Ορίζει εσωτερικό υπερσύνδεσμο όταν το ποντίκι περνά πάνω. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetMacroHyperlinkClick](./setmacrohyperlinkclick/)([System::String](../../system/string/)) override | Ορίζει υπερσύνδεσμο Macro κατά το κλικ. |
...
* Κλάση [IHyperlinkManager](../ihyperlinkmanager/)
