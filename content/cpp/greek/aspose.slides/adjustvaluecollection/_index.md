...
description: Αναπαριστά μια συλλογή ρυθμίσεων του σχήματος.
type: docs
weight: 14
...
| **int32_t** [get_Count](./get_count/)() override | Επιστρέφει έναν αριθμό ρυθμίσεων. Μόνο-ανάγνωση **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [idx_get](./idx_get/)(**int32_t**) override | Επιστρέφει την προσαρμογή βάσει δείκτη. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αντιπροσωπεύει ένα στιγμιότυπο τύπου που περιγράφεται από targetType. Αναλογία του τελεστή C# 'is'. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Συγκρίνει από αναφορά αντικείμενο τύπου τιμής με nullptr. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Ορίζει το ν-οστό όρισμα προτύπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε συλλογές σε αδύναμη λειτουργία. |
...
* Κλάση [IAdjustValueCollection](../iadjustvaluecollection/)
