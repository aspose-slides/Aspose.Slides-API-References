...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Εξομοιώνει τη σύγκριση κινητής υποδιαστολής σε στυλ C# όπου δύο NaN θεωρούνται ισοδύναμα παρόλο που σύμφωνα με το IEC 60559:1989 το NaN δεν είναι ισοδύναμο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Εξομοιώνει τη σύγκριση κινητής υποδιαστολής σε στυλ C# όπου δύο NaN θεωρούνται ισοδύναμα παρόλο που σύμφωνα με το IEC 60559:1989 το NaN δεν είναι ισοδύναμο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Μόνο για εσωτερική χρήση. |
| [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() override | Καθορίζει έναν καθολικά μοναδικό αναγνωριστικό (GUID) που προσδιορίζει μοναδικά ένα μόνο προσαρμοσμένο τμήμα XML μέσα σε ένα έγγραφο Office Open XML. Μόνο για ανάγνωση [System::Guid](../../system/guid/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() override | Επιστρέφει τη συλλογή των σχεδίων XML που σχετίζονται με το προσαρμοσμένο τμήμα XML. Μόνο για ανάγνωση [System::String](../../system/string/)[]. |
| [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() override | Επιστρέφει δεδομένα xml ως συμβολοσειρά UTF-8. Ανάγνωση [System::String](../../system/string/). |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() override | Επιστρέφει δεδομένα xml. Ανάγνωση **uint8_t**[]. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το κλείδωμα της δήλωσης C# lock(). Καλέστε το απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρά [LockContext](../../system/lockcontext/). |
...
| void [Remove](./remove/)() override | Αφαιρεί το προσαρμοσμένο τμήμα xml από την παρουσίαση. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Μειώνει τον μετρητή κοινής αναφοράς κατά την καθορισμένη τιμή. |
| void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) override | Καθορίζει έναν καθολικά μοναδικό αναγνωριστικό (GUID) που προσδιορίζει μοναδικά ένα μόνο προσαρμοσμένο τμήμα XML μέσα σε έγγραφο Office Open XML. Μόνο για ανάγνωση [System::Guid](../../system/guid/). |
| void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) override | Ορίζει δεδομένα xml ως συμβολοσειρά UTF-8. Εγγραφή [System::String](../../system/string/). |
| void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Ορίζει δεδομένα xml. Εγγραφή **uint8_t**[]. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκλείδωμα της δήλωσης C# lock(). Καλεστεί απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρά [LockContext](../../system/lockcontext/). |
...
* Κλάση [ICustomXmlPart](../icustomxmlpart/)
