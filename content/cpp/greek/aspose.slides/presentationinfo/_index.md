...
| Μέθοδος | Περιγραφή |
| --- | --- |
| **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) override | Ελέγχει εάν ένας κωδικός είναι σωστός για μια παρουσίαση προστατευμένη με κωδικό ανοίγματος. |
| **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) override | Ελέγχει εάν ένας κωδικός τροποποίησης είναι σωστός για μια παρουσίαση προστατευμένη από εγγραφή. |
...
| **bool** [get_IsEncrypted](./get_isencrypted/)() override | Επιστρέφει True εάν η συνδεδεμένη παρουσίαση είναι κρυπτογραφημένη, διαφορετικά False. Μόνο για ανάγνωση **bool**. |
| **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() override | Επιστρέφει τιμή που δείχνει εάν η συνδεδεμένη παρουσίαση είναι προστατευμένη από κωδικό ανοίγματος. |
| [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() override | Επιστρέφει τιμή που δείχνει εάν η συνδεδεμένη παρουσίαση είναι προστατευμένη από εγγραφή. |
| [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() override | Επιστρέφει τη μορφή της συνδεδεμένης παρουσίασης. Μόνο για ανάγνωση [Slides::LoadFormat](../loadformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() override | Επιστρέφει τις ιδιότητες εγγράφου της συνδεδεμένης παρουσίασης. |
...
| void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) override | Ενημερώνει τις ιδιότητες της συνδεδεμένης παρουσίασης. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει το μετρητή αδύναμης αναφοράς. Δεν πρέπει να κληθεί απευθείας· χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
...
| void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Γράφει τη συνδεδεμένη παρουσίαση σε ροή. |
| void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) override | Γράφει τη συνδεδεμένη παρουσίαση σε αρχείο. |
