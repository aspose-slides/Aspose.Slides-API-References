...
[Presentation](../presentation/) ευρεία ιδιότητες προβολής.
...
| **float** [get_GridSpacing](./get_gridspacing/)() override | Επιστρέφει το διάστιχο του πλέγματος που πρέπει να χρησιμοποιηθεί για το πλέγμα του εγγράφου παρουσίασης, σε σημεία. Ανάγνωση **float**. |
| [ViewType](../viewtype/) [get_LastView](./get_lastview/)() override | Καθορίζει τη λειτουργία προβολής που χρησιμοποιήθηκε όταν το έγγραφο παρουσίασης αποθηκεύτηκε τελευταία φορά. Ανάγνωση [ViewType](../viewtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[INormalViewProperties](../inormalviewproperties/)\> [get_NormalViewProperties](./get_normalviewproperties/)() override | Αναπαριστά τις ιδιότητες της κανονικής προβολής. Η κανονική προβολή αποτελείται από τρεις περιοχές περιεχομένου: τη διαφάνεια αυτή καθαυτή, μια πλευρική περιοχή περιεχομένου και μια κάτω περιοχή περιεχομένου. Μόνο-ανάγνωση [INormalViewProperties](../inormalviewproperties/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommonSlideViewProperties](../icommonslideviewproperties/)\> [get_NotesViewProperties](./get_notesviewproperties/)() override | Καθορίζει κοινές ιδιότητες προβολής που σχετίζονται με τη λειτουργία προβολής σημειώσεων. Μόνο-ανάγνωση [ICommonSlideViewProperties](../icommonslideviewproperties/). |
| [NullableBool](../nullablebool/) [get_ShowComments](./get_showcomments/)() override | Καθορίζει αν τα σχόλια της διαφάνειας πρέπει να εμφανιστούν. Ανάγνωση [NullableBool](../nullablebool/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommonSlideViewProperties](../icommonslideviewproperties/)\> [get_SlideViewProperties](./get_slideviewproperties/)() override | Καθορίζει κοινές ιδιότητες προβολής που σχετίζονται με τη λειτουργία προβολής διαφάνειας. Μόνο-ανάγνωση [ICommonSlideViewProperties](../icommonslideviewproperties/). |
...
| void [Lock](../../system/object/lock/)() | Εκτελεί την κλείδωμα της δήλωσης C# lock(). Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστή ανάθεσης. Δεν αντιγράφει τίποτα, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και ενεργοποιεί τη δημιουργία αντιγράφων υποκλάσεων. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | Ειδική υλοποίηση του [Object::ReferenceEquals](../../system/object/referenceequals/) για την περίπτωση συμβολοσυρτών. |
...
| void [set_GridSpacing](./set_gridspacing/)(**float**) override | Ορίζει το διάστιχο του πλέγματος που πρέπει να χρησιμοποιηθεί για το πλέγμα του εγγράφου παρουσίασης, σε σημεία. Εγγραφή **float**. |
| void [set_LastView](./set_lastview/)([ViewType](../viewtype/)) override | Καθορίζει τη λειτουργία προβολής που χρησιμοποιήθηκε όταν το έγγραφο παρουσίασης αποθηκεύτηκε τελευταία φορά. Εγγραφή [ViewType](../viewtype/). |
| void [set_ShowComments](./set_showcomments/)([NullableBool](../nullablebool/)) override | Καθορίζει αν τα σχόλια της διαφάνειας πρέπει να εμφανιστούν. Εγγραφή [NullableBool](../nullablebool/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα πρότυπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε κοντέινερς σε αδύναμη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Εκτελεί το ξεκλείδωμα της δήλωσης C# lock(). Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
...
* Κλάση [IViewProperties](../iviewproperties/)
