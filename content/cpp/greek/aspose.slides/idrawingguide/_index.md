...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Επιστρέφει το χρώμα του οδηγού σχεδίασης. Διαβάστε [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Επιστρέφει τον προσανατολισμό του οδηγού σχεδίασης. Διαβάστε [Slides::Orientation](../orientation/). |
| virtual **float** [get_Position](./get_position/)() | Επιστρέφει τη θέση του οδηγού σχεδίασης σε points από την επάνω, αριστερή γωνία της διαφάνειας. Διαβάστε **float**. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Ορίζει το χρώμα του οδηγού σχεδίασης. Γράψτε [System::Drawing::Color](../../system.drawing/color/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | Ορίζει τον προσανατολισμό του οδηγού σχεδίασης. Γράψτε [Slides::Orientation](../orientation/). |
| virtual void [set_Position](./set_position/)(**float**) | Ορίζει τη θέση του οδηγού σχεδίασης σε points από την επάνω, αριστερή γωνία της διαφάνειας. Γράψτε **float**. |
...
| void [Unlock](../../system/object/unlock/)() | Εφαρμόζει το ξεκλείδωμα της δήλωσης C# lock(). Καλέστε άμεσα ή χρησιμοποιήστε το αντικείμενο φρουρός [LockContext](../../system/lockcontext/). |
