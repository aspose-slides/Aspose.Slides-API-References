...
description: Λαμβάνει τα δεδομένα μορφοποίησης αποτελεσματικής κουκίδας με την εφαρμοσμένη κληρονομικότητα.
type: docs
weight: 248
...
Λαμβάνει τα δεδομένα μορφοποίησης της αποτελεσματικής κουκίδας με την εφαρμοσμένη κληρονομικότητα.
...
Αυτό το παράδειγμα δείχνει την απόκτηση ορισμένων ιδιοτήτων της αποτελεσματικής μορφοποίησης κουκίδων. 
```cpp
...
* Κλάση [IBulletFormatEffectiveData](../../ibulletformateffectivedata/)
* Κλάση [IBulletFormat](../)
