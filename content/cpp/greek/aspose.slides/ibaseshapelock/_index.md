...
description: Αντιπροσωπεύει το κλείδωμα Σχήματος (απενεργοποιημένη λειτουργία).
type: docs
weight: 1483
url: /el/aspose.slides/ibaseshapelock/
---
## IBaseShapeLock κλάση


Αντιπροσωπεύει [Shape](../shape/) lock (απενεργοποιημένη λειτουργία).
...
| virtual **bool** [get_NoLocks](./get_nolocks/)() | Επιστρέφει true εάν όλες οι σημαίες κλειδώματος είναι απενεργοποιημένες. Μόνο για ανάγνωση **bool**. |
