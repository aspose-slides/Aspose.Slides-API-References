...
description: Επιστρέφει τη στοίχιση κειμένου σε μια παράγραφο χωρίς κληρονομικότητα. Διαβάστε TextAlignment.
type: docs
weight: 1
url: /el/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() μέθοδος

Επιστρέφει τη στοίχιση κειμένου σε μια παράγραφο χωρίς κληρονομικότητα. Διαβάστε [TextAlignment](../../textalignment/).
...
Ο παρακάτω κώδικας δείγματος δείχνει πώς να ευθυγραμμίσετε παραγράφους κειμένου στο PowerPoint [Presentation](../../presentation/).
```cpp
...
* Απαρίθμηση [TextAlignment](../../textalignment/)
