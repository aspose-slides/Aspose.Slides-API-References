...
description: Αυτή η κλάση αντιπροσωπεύει το token που χρησιμοποιείται για την ένδειξη σε μακράς διάρκειας εργασίες εάν ζητήθηκε διακοπή.
type: docs
weight: 3056
...
Αυτή η κλάση αντιπροσωπεύει το token που χρησιμοποιείται για την ένδειξη σε μακράς διάρκειας εργασίες εάν ζητήθηκε διακοπή.
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Επιστρέφει **bool**.true εάν ζητήθηκε η διακοπή. |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | Αντιπροσωπεύει ένα κενό token διακοπής. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί τη δήλωση C# lock() για κλείδωμα. Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδύνατο δείκτη (αντί για κοινόχρηστο). Επιτρέπει τη μετατροπή δεικτών σε containers σε αδύναμη λειτουργία. |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | Πέταει ένα \nαν ζητήθηκε η διακοπή. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την εντολή απελευθέρωσης C# lock(). Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
