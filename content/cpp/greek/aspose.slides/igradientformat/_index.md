...
| virtual [Aspose::Slides::GradientDirection](../gradientdirection/) [get_GradientDirection](./get_gradientdirection/)() | Επιστρέφει το στυλ μιας διαβάθμισης. Δείτε [Slides::GradientDirection](../gradientdirection/). |
| virtual [Aspose::Slides::GradientShape](../gradientshape/) [get_GradientShape](./get_gradientshape/)() | Επιστρέφει το σχήμα μιας διαβάθμισης. Δείτε [Slides::GradientShape](../gradientshape/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [get_GradientStop](./get_gradientstop/)(**int32_t**) | Επιστρέφει ένα σημείο διαβάθμισης στη συγκεκριμένη θέση. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopCollection](../igradientstopcollection/)\> [get_GradientStops](./get_gradientstops/)() | Επιστρέφει τη συλλογή των σημείων διαβάθμισης. Μόνο για ανάγνωση [IGradientStopCollection](../igradientstopcollection/). |
| virtual **float** [get_LinearGradientAngle](./get_lineargradientangle/)() | Επιστρέφει τη γωνία μιας διαβάθμισης. Δείτε **float**. |
| virtual [NullableBool](../nullablebool/) [get_LinearGradientScaled](./get_lineargradientscaled/)() | Καθορίζει εάν μια διαβάθμιση είναι κλιμακωμένη. Δείτε [NullableBool](../nullablebool/). |
| virtual [Aspose::Slides::TileFlip](../tileflip/) [get_TileFlip](./get_tileflip/)() | Επιστρέφει τη λειτουργία αναστροφής για μια διαβάθμιση. Δείτε [Slides::TileFlip](../tileflip/). |
...
| void [Lock](../../system/object/lock/)() | Εφαρμόζει το κλείδωμα της δήλωσης C# lock(). Καλείτε άμεσα ή χρησιμοποιήστε το αντικείμενο φρουρός [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή αντιγράφων των υποκατηγοριών. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής ανάθεσης. Δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή αντιγράφων των υποκατηγοριών. |
...
| virtual void [set_GradientDirection](./set_gradientdirection/)([Aspose::Slides::GradientDirection](../gradientdirection/)) | Ορίζει το στυλ μιας διαβάθμισης. Εγγραφή [Slides::GradientDirection](../gradientdirection/). |
| virtual void [set_GradientShape](./set_gradientshape/)([Aspose::Slides::GradientShape](../gradientshape/)) | Ορίζει το σχήμα μιας διαβάθμισης. Εγγραφή [Slides::GradientShape](../gradientshape/). |
| virtual void [set_LinearGradientAngle](./set_lineargradientangle/)(**float**) | Ορίζει τη γωνία μιας διαβάθμισης. Εγγραφή **float**. |
| virtual void [set_LinearGradientScaled](./set_lineargradientscaled/)([NullableBool](../nullablebool/)) | Καθορίζει εάν μια διαβάθμιση είναι κλιμακωμένη. Εγγραφή [NullableBool](../nullablebool/). |
| virtual void [set_TileFlip](./set_tileflip/)([Aspose::Slides::TileFlip](../tileflip/)) | Ορίζει τη λειτουργία αναστροφής για μια διαβάθμιση. Εγγραφή [Slides::TileFlip](../tileflip/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει την n'tη παράμετρο προτύπου ως αδύναμη δείκτη (αντί για κοινή). Επιτρέπει την αλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκλείδωμα της δήλωσης C# lock(). Καλείτε άμεσα ή χρησιμοποιήστε το αντικείμενο φρουρός [LockContext](../../system/lockcontext/). |
