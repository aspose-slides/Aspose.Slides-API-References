...
Αναπαριστά μια εσοχή για κείμενο.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | Συγκρίνει την τρέχουσα εμφάνιση με άλλο αντικείμενο του ίδιου τύπου. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | Επιστρέφει το στυλ στοίχισης ενός ταμπ. Διαβάστε [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | Επιστρέφει τη θέση ενός ταμπ. Η ανάθεση αυτής της ιδιότητας μπορεί να αλλάξει το δείκτη του ταμπ στη συλλογή και να ακυρώσει τον Enumerator. Διαβάστε **double**. |
...
| void [Lock](../../system/object/lock/)() | Εφαρμόζει το C# lock() statement για κλείδωμα. Κλήστε απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Καταχωρητής ανάθεσης. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή κατασκευής υποτύπων. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Συγκρίνει αναφορά-τιμη αντικείμενο τύπου τιμής με nullptr. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | Ορίζει το στυλ στοίχισης ενός ταμπ. Γράψτε [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | Ορίζει τη θέση ενός ταμπ. Η ανάθεση αυτής της ιδιότητας μπορεί να αλλάξει το δείκτη του ταμπ στη συλλογή και να ακυρώσει τον Enumerator. Γράψτε **double**. |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | Δημιουργεί νέο [Tab](./) |
...
| void [Unlock](../../system/object/unlock/)() | Εκτελεί το ξεκλείδωμα της δήλωσης C# lock(). Κλήστε απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
