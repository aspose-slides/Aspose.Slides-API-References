...
---
## ILineFillFormatEffectiveData κλάση
...
| virtual [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() | Επιστρέφει τον τύπο γεμίσματος. Μόνο για ανάγνωση [Slides::FillType](../filltype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormatEffectiveData](../igradientformateffectivedata/)\> [get_GradientFormat](./get_gradientformat/)() | Επιστρέφει τη μορφή διαβαθμισμένου γεμίσματος. Μόνο για ανάγνωση [IGradientFormatEffectiveData](../igradientformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormatEffectiveData](../ipatternformateffectivedata/)\> [get_PatternFormat](./get_patternformat/)() | Επιστρέφει τη μορφή μοτίβου γεμίσματος. Μόνο για ανάγνωση [IPatternFormatEffectiveData](../ipatternformateffectivedata/). |
| virtual **bool** [get_RotateWithShape](./get_rotatewithshape/)() | Καθορίζει εάν το γέμισμα πρέπει να περιστραφεί με το σχήμα. Μόνο για ανάγνωση **bool**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_SolidFillColor](./get_solidfillcolor/)() | Επιστρέφει το χρώμα ενός στερεού γεμίσματος. Μόνο για ανάγνωση [System::Drawing::Color](../../system.drawing/color/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει εάν το αντικείμενο αντιπροσωπεύει μια παρουσία τύπου που περιγράφεται από targetType. Αναλογικός τελεστής 'is' της C#. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n-οστό όρισμα προτύπου ως αδύναμη δείκτης (αντί για κοινό). Επιτρέπει την εναλλαγή δεικτών σε συλλογές σε αδύναμη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το statement lock() της C# για απελευθέρωση. Κλήση απευθείας ή χρήση του αντικειμένου φρουρού [LockContext](../../system/lockcontext/). |
