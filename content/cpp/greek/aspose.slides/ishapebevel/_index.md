...
description: Αναπαριστά τις ιδιότητες του ανάγλυφου της κύριας όψης του σχήματος.
type: docs
weight: 3654
...
Αναπαριστά τις ιδιότητες της κύριας όψης του σχήματος.
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Τύπος κάλυψης. Διαβάστε [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Ύψος κάλυψης. Διαβάστε **double**. |
| virtual **double** [get_Width](./get_width/)() | Πλάτος κάλυψης. Διαβάστε **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Παίρνει τη δομή δεδομένων μετρητής αναφοράς που σχετίζεται με το αντικείμενο. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Αναλογικό της μεθόδου C# [Object.GetHashCode()](../../system/object/gethashcode/). Επιτρέπει την δημιουργία hash για προσαρμοσμένα αντικείμενα. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το statement lock() του C# για κλείδωμα. Καλέστε απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγράφου. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή αντιγράφων υποκλάσεων. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Συγκρίνει αναφοράν αντικείμενο τύπου τιμής με nullptr. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | Τύπος κάλυψης. Γράψτε [BevelPresetType](../bevelpresettype/). |
| virtual void [set_Height](./set_height/)(**double**) | Ύψος κάλυψης. Γράψτε **double**. |
| virtual void [set_Width](./set_width/)(**double**) | Πλάτος κάλυψης. Γράψτε **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'ο όρισμα προτύπου ως αδύναμο δείκτη (αντί για κοινό). Επιτρέπει την αλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το statement lock() του C# για ξεκλείδωμα. Κλήση απευθείας ή χρήση του αντικειμένου φρουρού [LockContext](../../system/lockcontext/). |
