...
description: Αναπαριστά τις ρυθμίσεις της προβολής διαφανειών για την παρουσίαση.
type: docs
weight: 5214
...
| **bool** [get_Loop](./get_loop/)() | Βρόχο [Slide](../slide/) Εμφάνιση |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_PenColor](./get_pencolor/)() | Χρώμα Στυλό για [Slide](../slide/) Εμφάνιση |
| **bool** [get_ShowAnimation](./get_showanimation/)() | Εμφάνιση [Animation](../../aspose.slides.animation/) σε [Slide](../slide/) Εμφάνιση |
| **bool** [get_ShowMediaControls](./get_showmediacontrols/)() const | Εμφάνιση Ελέγχων Πολυμέσων |
| **bool** [get_ShowNarration](./get_shownarration/)() | Εμφάνιση Αφήγησης σε [Slide](../slide/) Εμφάνιση |
| [System::SharedPtr](../../system/sharedptr/)\<[SlidesRange](../slidesrange/)\> [get_Slides](./get_slides/)() const | [Slides](../) εύρος |
| [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::SlideShowType](../slideshowtype/)\> [get_SlideShowType](./get_slideshowtype/)() | Αποκτά τον τύπο προβολής διαφανειών. Αναπαρίσταται από τους ακόλουθους [SlideShowType](../slideshowtype/) προγόνους: [BrowsedAtKiosk](../browsedatkiosk/), [PresentedBySpeaker](../presentedbyspeaker/) και [BrowsedByIndividual](../browsedbyindividual/) |
| **bool** [get_UseTimings](./get_usetimings/)() | Χρησιμοποιεί Χρονομετρήσεις σε [Slide](../slide/) Εμφάνιση |
...
| void [set_Loop](./set_loop/)(**bool**) | Βρόχο [Slide](../slide/) Εμφάνιση |
| void [set_ShowAnimation](./set_showanimation/)(**bool**) | Εμφάνιση [Animation](../../aspose.slides.animation/) σε [Slide](../slide/) Εμφάνιση |
| void [set_ShowMediaControls](./set_showmediacontrols/)(**bool**) | Εμφάνιση Ελέγχων Πολυμέσων |
| void [set_ShowNarration](./set_shownarration/)(**bool**) | Εμφάνιση Αφήγησης σε [Slide](../slide/) Εμφάνιση |
| void [set_Slides](./set_slides/)([System::SharedPtr](../../system/sharedptr/)\<[SlidesRange](../slidesrange/)\>) | [Slides](../) εύρος |
| void [set_SlideShowType](./set_slideshowtype/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::SlideShowType](../slideshowtype/)\>) | Ορίζει τον τύπο προβολής διαφανειών. Αναπαρίσταται από τους ακόλουθους [SlideShowType](../slideshowtype/) προγόνους: [BrowsedAtKiosk](../browsedatkiosk/), [PresentedBySpeaker](../presentedbyspeaker/) και [BrowsedByIndividual](../browsedbyindividual/) |
| void [set_UseTimings](./set_usetimings/)(**bool**) | Χρησιμοποιεί Χρονομετρήσεις σε [Slide](../slide/) Εμφάνιση |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την εναλλαγή δεικτών σε containers σε αδυνατική λειτουργία. |
