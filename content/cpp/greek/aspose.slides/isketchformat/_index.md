...
description: Αναπαριστά ιδιότητες για μορφή σκίτσου γραμμών.
type: docs
weight: 3732
...
Αναπαριστά ιδιότητες για μορφή σκίτσου γραμμών.
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | Επιστρέφει τον τύπο σκίτσου. Διαβάστε [Slides::LineSketchType](../linesketchtype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή αντιγραφών των υποκλάσεων. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής εκχώρησης. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή αντιγραφών των υποκλάσεων. |
...
| virtual void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) | Ορίζει τον τύπο σκίτσου. Γράψτε [Slides::LineSketchType](../linesketchtype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει την n-στή παράμετρο προτύπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε συλλογές σε αδύναμη λειτουργία. |
