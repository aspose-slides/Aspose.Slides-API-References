...
type: docs
weight: 5305
url: /el/aspose.slides/stylecoloreffectivedata/
---
## StyleColorEffectiveData κλάση
...
| [System::SharedPtr](../../system/sharedptr/)\<[ColorFormat](../colorformat/)\> [get_StyleColorFormatUnresolved](./get_stylecolorformatunresolved/)() | StyleColorFormatUnresolved. Μόνο για ανάγνωση [ColorFormat](../colorformat/). |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Αναλογικό της μεθόδου C# Object.GetHashCode(). Επιτρέπει τη δημιουργία κατακερματισμού προσαρμοσμένων αντικειμένων. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον μετρητή αδύναμης αναφοράς. Δεν πρέπει να καλείται άμεσα· χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον μετρητή αδύναμης αναφοράς. Δεν πρέπει να καλείται άμεσα· χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
