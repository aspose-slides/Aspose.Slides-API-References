...
description: Αναπαριστά διαχειριστή που διατηρεί τη συμπεριφορά των δεσμευμένων θέσεων υποσέλιδου, ημερομηνίας-ώρας και αριθμού σελίδας για όλους τους τύπους διαφανειών.
type: docs
weight: 1509
url: /el/aspose.slides/ibaseslideheaderfootermanager/
---
## IBaseSlideHeaderFooterManager κλάση
...
| virtual **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() | Επιστρέφει τιμή που υποδεικνύει ότι υπάρχει σύμβολο κράτησης ημερομηνίας-ωρας. Ανάγνωση**bool**. |
| virtual **bool** [get_IsFooterVisible](./get_isfootervisible/)() | Επιστρέφει τιμή που υποδεικνύει ότι υπάρχει σύμβολο κράτησης υποσέλιδου. Ανάγνωση **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() | Επιστρέφει τιμή που υποδεικνύει ότι υπάρχει σύμβολο κράτησης αριθμού σελίδας. Ανάγνωση**bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Επιστρέφει τη δομή δεδομένων μετρητή αναφορών που συσχετίζεται με το αντικείμενο. |
...
| virtual void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) | Ορίζει κείμενο στο σύμβολο κράτησης ημερομηνίας-ώρας διαφάνειας. |
| virtual void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) | Αλλάζει την ορατότητα του συμβόλου κράτησης ημερομηνίας-ώρας διαφάνειας. |
| virtual void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) | Ορίζει κείμενο στο σύμβολο κράτησης υποσέλιδου διαφάνειας. |
| virtual void [SetFooterVisibility](./setfootervisibility/)(**bool**) | Αλλάζει την ορατότητα του συμβόλου κράτησης υποσέλιδου διαφάνειας. |
| virtual void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) | Αλλάζει την ορατότητα του συμβόλου κράτησης αριθμού σελίδας διαφάνειας. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδύναμη δείκτη (αντί για κοινή). Επιτρέπει την αλλαγή δεικτών σε δοχεία σε αδύναμη κατάσταση. |
