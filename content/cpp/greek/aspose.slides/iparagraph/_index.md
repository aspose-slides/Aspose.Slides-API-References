...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_EndParagraphPortionFormat](./get_endparagraphportionformat/)() | Καθορίζει τις ιδιότητες του τμήματος που θα χρησιμοποιηθούν αν ένα άλλο τμήμα εισαχθεί μετά το τελευταίο. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() | Επιστρέφει το αντικείμενο μορφοποίησης για αυτήν την παράγραφο. Μόνο για ανάγνωση [IParagraphFormat](../iparagraphformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [get_Portion](./get_portion/)(**int32_t**) | Επιστρέφει ένα τμήμα κειμένου στον καθορισμένο δείκτη. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionCollection](../iportioncollection/)\> [get_Portions](./get_portions/)() | Επιστρέφει τη συλλογή τμημάτων κειμένου. Μόνο για ανάγνωση [IPortionCollection](../iportioncollection/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../islidecomponent/get_slide/)() | Επιστρέφει την βασική διαφάνεια. Μόνο για ανάγνωση [IBaseSlide](../ibaseslide/). |
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Παίρνει το ακατέργαστο κείμενο μιας παραγράφου. Ανάγνωση [System::String](../../system/string/). |
...
| virtual **int32_t** [GetLinesCount](./getlinescount/)() | Λήψη του αριθμού των γραμμών σε μια παράγραφο. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() | Λήψη συντεταγμένων του ορθογωνίου που περιορίζει την παράγραφο. Το ορθογώνιο περιλαμβάνει όλες τις γραμμές κειμένου στην παράγραφο, συμπεριλαμβανομένων των κενών. |
...
| virtual void [JoinPortionsWithSameFormatting](./joinportionswithsameformatting/)() | Συνενώνει τμήματα με την ίδια μορφοποίηση. |
...
| virtual void [set_EndParagraphPortionFormat](./set_endparagraphportionformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Καθορίζει τις ιδιότητες του τμήματος που θα χρησιμοποιηθούν αν ένα άλλο τμήμα εισαχθεί μετά το τελευταίο. |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | Ορίζει το ακατέργαστο κείμενο μιας παραγράφου. Γραφή [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκόλλημα της δήλωσης C# lock(). Καλείται απευθείας ή χρησιμοποιεί το αντικείμενο [LockContext](../../system/lockcontext/). |
