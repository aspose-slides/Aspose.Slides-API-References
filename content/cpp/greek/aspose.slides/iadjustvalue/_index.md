...
description: Αναπαριστά την τιμή ρύθμισης ενός γεωμετρικού σχήματος. Αυτές οι τιμές επηρεάζουν τη μορφή του σχήματος.
type: docs
weight: 1288
...
Αντιπροσωπεύει την τιμή προσαρμογής ενός γεωμετρικού σχήματος. Αυτές οι τιμές επηρεάζουν το σχήμα.
...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | Επιστρέφει την τιμή, την ερμηνεύοντας ως γωνία σε μοίρες. Διαβάστε **float**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Επιστρέφει ένα όνομα αυτής της τιμής προσαρμογής. Μόνο για ανάγνωση [System::String](../../system/string/). |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | Επιστρέφει την τιμή προσαρμογής «όπως είναι». Διαβάστε **int64_t**. |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | Επιστρέφει τον τύπο της προσαρμογής του σχήματος. Μόνο για ανάγνωση [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστικό ανάθεσης. Δεν αντιγράφει τίποτα, πραγματικά, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή των υποκατηγοριών. |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | Ορίζει την τιμή, την ερμηνεύοντας ως γωνία σε μοίρες. Γράψτε **float**. |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | Ορίζει την τιμή προσαρμογής «όπως είναι». Γράψτε **int64_t**. |
