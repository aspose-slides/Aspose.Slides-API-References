...
description: "Παρέχει στρατηγική εφεδρείας για την αντικατάσταση εσφαλμένου συμβόλου με ένα ψεύτικο αντικείμενο. Τα αντικείμενα αυτής της κλάσης πρέπει να εκχωρούνται μόνο χρησιμοποιώντας τη συνάρτηση System::MakeObject(). Ποτέ μην δημιουργείτε μια περίπτωση αυτού του τύπου στη στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς θα οδηγήσει σε σφάλματα χρόνου εκτέλεσης και/ή σφάλματα ελέγχου. Πάντα τυλίγετε αυτήν την κλάση σε δείκτη System::SmartPtr και χρησιμοποιήστε αυτόν το δείκτη για να το περάσετε σε συναρτήσεις ως όρισμα."
type: docs
weight: 79
url: /el/system.text/decoderreplacementfallback/
---
## DecoderReplacementFallback κλάση


Παρέχει στρατηγική εφεδρείας για την αντικατάσταση εσφαλμένου συμβόλου με μια υποκατάσταση. Τα αντικείμενα αυτής της κλάσης πρέπει να εκχωρούνται μόνο χρησιμοποιώντας τη συνάρτηση [System::MakeObject()](../../system/makeobject/). Ποτέ μην δημιουργείτε ένα δείγμα αυτού του τύπου στη στρώση ή χρησιμοποιώντας τον τελεστή new, καθώς θα καταλήξει σε σφάλματα χρόνου εκτέλεσης και/ή σφάλματα ελέγχου. Πάντα τυλίξτε αυτήν την κλάση σε δείκτη [System::SmartPtr](../../system/smartptr/) και χρησιμοποιήστε αυτόν τον δείκτη για να τη περάσετε ως όρισμα σε συναρτήσεις.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Δημιουργεί εφεδρικό buffer. |
| [DecoderReplacementFallback](./decoderreplacementfallback/)() | Κατασκευαστής που χρησιμοποιεί προεπιλεγμένη συμβολοσειρά αντικατάστασης "?". |
| [DecoderReplacementFallback](./decoderreplacementfallback/)(const [String](../../system/string/)\&) | Κατασκευαστής. |
...
| const [String](../../system/string/)\& [get_DefaultString](./get_defaultstring/)() const | Επιστρέφει τη συμβολοσειρά αντικατάστασης. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](../decoderfallback/get_exceptionfallback/)() | Επιστρέφει την προεπιλεγμένη υλοποίηση fallback εξαιρέσεων. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Επιστρέφει το μέγιστο πλήθος χαρακτήρων που μπορεί να επιστρέψει η περίπτωση. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](../decoderfallback/get_replacementfallback/)() | Επιστρέφει την προεπιλεγμένη υλοποίηση fallback αντικατάστασης. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](../decoderfallback/get_standardsafefallback/)() | Επιστρέφει την προεπιλεγμένη τυπική ασφαλή υλοποίηση fallback. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το κλείδωμα της δήλωσης C# lock(). Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο sentry [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκλείδωμα της δήλωσης C# lock(). Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο sentry [LockContext](../../system/lockcontext/). |
...
* Κλάση [DecoderFallback](../decoderfallback/)
