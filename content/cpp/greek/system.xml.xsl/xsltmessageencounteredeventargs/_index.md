...
description: "Παρέχει δεδομένα για το συμβάν XsltArgumentList::XsltMessageEncountered."
type: docs
weight: 92
url: /el/system.xml.xsl/xsltmessageencounteredeventargs/
---
## XsltMessageEncounteredEventArgs κλάση

Παρέχει δεδομένα για το συμβάν **XsltArgumentList::XsltMessageEncountered**.
...
| virtual [String](../../system/string/) [get_Message](./get_message/)() | Επιστρέφει το περιεχόμενο του στοιχείου **xsl:message**. |
