...
description: Μετασχηματίζει δεδομένα XML χρησιμοποιώντας ένα φύλλο στυλ XSLT.
type: docs
weight: 53
url: /el/system.xml.xsl/xslcompiledtransform/
---
## XslCompiledTransform κλάση

Μετασχηματίζει δεδομένα XML χρησιμοποιώντας ένα φύλλο στυλ XSLT.
