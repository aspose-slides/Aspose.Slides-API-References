...
description: Αντιπροσωπεύει πινέλο ίχνους.
type: docs
weight: 27
...
Αντιπροσωπεύει το πινέλο ίχνος.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Εξομοιώνει σύγκριση κινητής υποδιαστολής σε στυλ C# όπου δύο NaN θεωρούνται ίσα παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσον με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Εξομοιώνει σύγκριση κινητής υποδιαστολής σε στυλ C# όπου δύο NaN θεωρούνται ίσα παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσον με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Μόνο για εσωτερική χρήση. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Ανακτά το χρώμα του πινέλου για μια γραμμή. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | Ανακτά τον τύπο εφέ μελάνης (π.χ., Galaxy, Gold, Silver) που ορίζει το οπτικό στυλ της σχεδίασης μελάνης. Η τιμή αναλύεται από την ιδιότητα του πινέλου "inkEffects". Εάν δεν καθοριστεί αναγνωρίσιμο εφέ, επιστρέφεται το [InkEffectType::NotDefined](../inkeffecttype/). |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Ανακτά το μέγεθος του πινέλου για μια γραμμή σε points. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Ορίζει το χρώμα του πινέλου για μια γραμμή. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Ορίζει το μέγεθος του πινέλου για μια γραμμή σε points. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Αυξάνει τον μετρητή κοινόχρηστων αναφορών. Δεν θα πρέπει να κληθεί άμεσα· αντί γι' αυτό, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
