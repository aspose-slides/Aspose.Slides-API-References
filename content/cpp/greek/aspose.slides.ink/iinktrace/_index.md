...
Αναπαριστά γραμμή χειρόγραφου σε ένα αντικείμενο [Ink](../ink/).
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IInkBrush](../iinkbrush/)\> [get_Brush](./get_brush/)() | Λαμβάνει Brush για το IInkLine [IInkBrush](../iinkbrush/) μόνο για ανάγνωση. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | Λαμβάνει σημεία για το IInkLine [System::Drawing::PointF](../../system.drawing/pointf/) μόνο για ανάγνωση. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί την εντολή lock() της C#. Καλείται απευθείας ή χρησιμοποιεί το αντικείμενο [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την εντολή lock() της C# για ξεκλείδωμα. Καλείται απευθείας ή χρησιμοποιεί το αντικείμενο [LockContext](../../system/lockcontext/). |
