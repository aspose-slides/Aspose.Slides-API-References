...
description: Περιέχει τις βοηθητικές μεθόδους.
type: docs
weight: 131
url: /el/system.net.http/httputilities/
---
## HttpUtilities κλάση

Περιέχει τις βοηθητικές μεθόδους.
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Ελέγχει αν το συγκεκριμένο URI είναι το HTTP URI. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευέας αντιγραφής. Δεν αντιγράφει τίποτα, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή κατασκευής υποκλάσεων. |
...
| Πεδίο | Περιγραφή |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | Η προεπιλεγμένη έκδοση HTTP για αποστολή αιτημάτων. |
| static [DefaultResponseVersion](./defaultresponseversion/) | Η προεπιλεγμένη έκδοση HTTP για λήψη απαντήσεων. |
