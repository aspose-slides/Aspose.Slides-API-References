...
description: "Αντιπροσωπεύει ένα μήνυμα HTTP αιτήματος. Τα αντικείμενα αυτής της κλάσης πρέπει να δημιουργούνται μόνο χρησιμοποιώντας τη συνάρτηση System::MakeObject() function. Ποτέ μην δημιουργείτε στιγμιότυπο αυτού του τύπου στη στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς θα προκαλέσει σφάλματα χρόνου εκτέλεσης και/ή σφάλματα δήλωσης. Πάντα τυλίξτε αυτή τη κλάση σε δείκτη System::SmartPtr pointer και χρησιμοποιήστε αυτόν τον δείκτη για να τη περάσετε σε συναρτήσεις ως όρισμα."
type: docs
weight: 105
url: /el/system.net.http/httprequestmessage/
---
## HttpRequestMessage κλάση

Αντιπροσωπεύει ένα μήνυμα HTTP αιτήματος. Τα αντικείμενα αυτής της κλάσης πρέπει να καταλαμβάνονται μόνο χρησιμοποιώντας τη συνάρτηση [System::MakeObject()](../../system/makeobject/). Ποτέ μην δημιουργείτε ένα στιγμιότυπο αυτού του τύπου στη στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς θα προκαλέσει σφάλματα χρόνου εκτέλεσης και/ή σφάλματα δήλωσης. Πάντα τυλίξτε αυτή τη κλάση σε δείκτη [System::SmartPtr](../../system/smartptr/) και χρησιμοποιήστε αυτόν τον δείκτη για να τη περάσετε σε συναρτήσεις ως όρισμα.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| void [Dispose](./dispose/)() override | Αποδεσμεύει το τρέχον στιγμιότυπο. Αυτή η μέθοδος αποδεσμεύει επίσης το περιεχόμενο του HTTP αιτήματος. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[HttpContent](../httpcontent/)\> [get_Content](./get_content/)() | Αποκτά το περιεχόμενο του HTTP αιτήματος. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Net::Http::Headers::HttpRequestHeaders](../../system.net.http.headers/httprequestheaders/)\> [get_Headers](./get_headers/)() | Επιστρέφει τις κεφαλίδες περιεχομένου HTTP. |
| [System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](../httpmethod/)\> [get_Method](./get_method/)() | Αποκτά τη μέθοδο HTTP αιτήματος. |
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Properties](./get_properties/)() | Επιστρέφει τη συλλογή των ιδιοτήτων του HTTP αιτήματος. |
| [System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [get_RequestUri](./get_requesturi/)() | Αποκτά το URI του ζητούμενου πόρου. |
| [System::Version](../../system/version/) [get_Version](./get_version/)() | Αποκτά την έκδοση HTTP. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Αποκτά τη δομή δεδομένων του μετρητή αναφορών που συσχετίζεται με το αντικείμενο. |
...
|  [HttpRequestMessage](./httprequestmessage/)() | Δημιουργεί ένα νέο στιγμιότυπο. |
|  [HttpRequestMessage](./httprequestmessage/)([System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](../httpmethod/)\>, [System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Δημιουργεί ένα νέο στιγμιότυπο. |
|  [HttpRequestMessage](./httprequestmessage/)([System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](../httpmethod/)\>, [String](../../system/string/)) | Δημιουργεί ένα νέο στιγμιότυπο. |
...
| **bool** [MarkAsSent](./markassent/)() | Σημαδεύει το τρέχον αίτημα ως αποσταλμένο. |
...
| void [set_Content](./set_content/)([System::SharedPtr](../../system/sharedptr/)\<[HttpContent](../httpcontent/)\>) | Ορίζει το περιεχόμενο του HTTP αιτήματος. |
| void [set_Method](./set_method/)([System::SharedPtr](../../system/sharedptr/)\<[HttpMethod](../httpmethod/)\>) | Ορίζει τη μέθοδο HTTP αιτήματος. |
| void [set_RequestUri](./set_requesturi/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Ορίζει το URI του ζητούμενου πόρου. |
