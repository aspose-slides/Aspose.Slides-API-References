...
| [Color](../../system.drawing/color/) [get_NewColor](./get_newcolor/)() const | Επιστρέφει το νέο αντικείμενο [Color](../../system.drawing/color/) που αντιπροσωπεύει το χρώμα στο οποίο θα μετατραπεί. |
| [Color](../../system.drawing/color/) [get_OldColor](./get_oldcolor/)() const | Επιστρέφει το παλιό αντικείμενο [Color](../../system.drawing/color/) που αντιπροσωπεύει το χρώμα που πρόκειται να μετατραπεί. |
...
| void [Lock](../../system/object/lock/)() | Εφαρμόζει το κλείδωμα της δήλωσης C# lock(). Καλείται άμεσα ή χρησιμοποιεί το αντικείμενο φρουρός [LockContext](../../system/lockcontext/). |
...
| void [set_NewColor](./set_newcolor/)(const [Color](../../system.drawing/color/)\&) | Ορίζει το νέο αντικείμενο [Color](../../system.drawing/color/) που αντιπροσωπεύει το χρώμα στο οποίο θα μετατραπεί. |
| void [set_OldColor](./set_oldcolor/)(const [Color](../../system.drawing/color/)\&) | Ορίζει το παλιό αντικείμενο [Color](../../system.drawing/color/) που αντιπροσωπεύει το χρώμα που πρόκειται να μετατραπεί. |
...
| void [Unlock](../../system/object/unlock/)() | Εφαρμόζει το ξεκλείδωμα της δήλωσης C# lock(). Καλείται άμεσα ή χρησιμοποιεί το αντικείμενο φρουρός [LockContext](../../system/lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον αδυνατισμένο μετρητή αναφορών. Δεν πρέπει να καλείται άμεσα· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον αδυνατισμένο μετρητή αναφορών. Δεν πρέπει να καλείται άμεσα· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
