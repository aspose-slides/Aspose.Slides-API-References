...
---
## IXamlOutputSaver κλάση

Αντιπροσωπεύει μια υλοποίηση αποθήκευσης εξόδου για τη μεταφορά δεδομένων στην εξωτερική αποθήκευση.
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Αποθηκεύει έναν πίνακα bytes στην προορισμένη θέση. |
