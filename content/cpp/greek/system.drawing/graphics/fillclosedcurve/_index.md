...
description: Σχεδιάζει μια κλειστή spline χρησιμοποιώντας το καθορισμένο πινέλο.
type: docs
weight: 807
url: /el/system.drawing/graphics/fillclosedcurve/
---
## Graphics::FillClosedCurve(const SharedPtr\<Brush\>\&, const ArrayPtr\<PointF\>\&, Drawing2D::FillMode, float) method

Σχεδιάζει μια κλειστή spline χρησιμοποιώντας το καθορισμένο πινέλο.
