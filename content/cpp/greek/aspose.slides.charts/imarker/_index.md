...
description: Αντιπροσωπεύει το δείκτη ενός chert.
type: docs
weight: 1119
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Λαμβάνει το γέμισμα του δείκτη. Μόνο ανάγωση [IFormat](../iformat/). |
| virtual **int32_t** [get_Size](./get_size/)() | Αντιπροσωπεύει το μέγεθος του δείκτη σε διάγραμμα γραμμής, διάγραμμα διασποράς ή διάγραμμα ραντάρ. Ανάγνωση **int32_t**. |
| virtual [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() | Αντιπροσωπεύει το στυλ του δείκτη σε διάγραμμα γραμμής, διάγραμμα διασποράς ή διάγραμμα ραντάρ. Ανάγνωση [MarkerStyleType](../markerstyletype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευάστης αντιγράφου. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί ένα νέο αντικείμενο και επιτρέπει την κατασκευή υποτύπων μέσω αντιγραφής. |
...
| virtual void [set_Size](./set_size/)(**int32_t**) | Αντιπροσωπεύει το μέγεθος του δείκτη σε διάγραμμα γραμμής, διάγραμμα διασποράς ή διάγραμμα ραντάρ. Εγγραφή **int32_t**. |
| virtual void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) | Αντιπροσωπεύει το στυλ του δείκτη σε διάγραμμα γραμμής, διάγραμμα διασποράς ή διάγραμμα ραντάρ. Εγγραφή [MarkerStyleType](../markerstyletype/). |
