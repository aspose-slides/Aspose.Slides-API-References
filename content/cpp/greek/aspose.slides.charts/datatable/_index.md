...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Προσομοιώνει τη σύγκριση αριθμών κινητής τεφ. σε στυλ C# όπου δύο NaN θεωρούνται ίσα, παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Προσομοιώνει τη σύγκριση αριθμών κινητής τεφ. σε στυλ C# όπου δύο NaN θεωρούνται ίσα, παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Μόνο για εσωτερική χρήση. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](./get_chart/)() override | Επιστρέφει το διάγραμμα. Μόνο για ανάγνωση [IChart](../ichart/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Επιστρέφει τα στυλ γραμμής, γεμίσματος και εφέ ενός αντικειμένου. Μόνο για ανάγνωση [IFormat](../iformat/). |
| **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() override | Αληθές εάν ο πίνακας δεδομένων διαγράμματος έχει οριζόντια σύνορα κελιών. Ανάγνωση **bool**. |
| **bool** [get_HasBorderOutline](./get_hasborderoutline/)() override | Αληθές εάν ο πίνακας δεδομένων διαγράμματος έχει περιγράμματα. Ανάγνωση **bool**. |
| **bool** [get_HasBorderVertical](./get_hasbordervertical/)() override | Αληθές εάν ο πίνακας δεδομένων διαγράμματος έχει κάθετα σύνορα κελιών. Ανάγνωση **bool**. |
| **bool** [get_ShowLegendKey](./get_showlegendkey/)() override | Αληθές εάν το κλειδί υπομνήματος ετικέτας δεδομένων είναι ορατό. Ανάγνωση **bool**. |
...
| void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) override | Αληθές εάν ο πίνακας δεδομένων διαγράμματος έχει οριζόντια σύνορα κελιών. Εγγραφή **bool**. |
| void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) override | Αληθές εάν ο πίνακας δεδομένων διαγράμματος έχει περιγράμματα. Εγγραφή **bool**. |
| void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) override | Αληθές εάν ο πίνακας δεδομένων διαγράμματος έχει κάθετα σύνορα κελιών. Εγγραφή **bool**. |
| void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) override | Αληθές εάν το κλειδί υπομνήματος ετικέτας δεδομένων είναι ορατό. Εγγραφή **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Ορίζει το n'th όρισμα προτύπου ως αδύνατο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
