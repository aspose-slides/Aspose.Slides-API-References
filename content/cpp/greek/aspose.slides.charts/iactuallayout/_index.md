...
description: Καθορίζει τη πραγματική θέση ενός στοιχείου διαγράμματος.
type: docs
weight: 508
...
| virtual **float** [get_ActualHeight](./get_actualheight/)() | Καθορίζει το πραγματικό ύψος του στοιχείου διαγράμματος. Καλέστε τη μέθοδο [IChart::ValidateChartLayout](../ichart/validatechartlayout/) πριν για λήψη των πραγματικών τιμών. Διαβάζει **float**. |
| virtual **float** [get_ActualWidth](./get_actualwidth/)() | Καθορίζει το πραγματικό πλάτος του στοιχείου διαγράμματος. Καλέστε τη μέθοδο [IChart::ValidateChartLayout](../ichart/validatechartlayout/) πριν για λήψη των πραγματικών τιμών. Διαβάζει **float**. |
| virtual **float** [get_ActualX](./get_actualx/)() | Καθορίζει την πραγματική θέση x (αριστερά) του στοιχείου διαγράμματος σε σχέση με την αριστερή πάνω γωνία του διαγράμματος. Καλέστε τη μέθοδο [IChart::ValidateChartLayout](../ichart/validatechartlayout/) πριν για λήψη των πραγματικών τιμών. Διαβάζει **float**. |
| virtual **float** [get_ActualY](./get_actualy/)() | Καθορίζει το πραγματικό πάνω του στοιχείου διαγράμματος σε σχέση με την αριστερή πάνω γωνία του διαγράμματος. Καλέστε τη μέθοδο [IChart::ValidateChartLayout](../ichart/validatechartlayout/) πριν για λήψη των πραγματικών τιμών. Διαβάζει **float**. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το statement κλειδώματος C# lock(). Καλείται άμεσα ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τροποποιητής εκχώρησης. Δεν αντιγράφει κάτι, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και ενεργοποιεί την αντιγραφή κατασκευής υποκλάσεων. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το statement ξεκλειδώματος C# lock(). Καλείται άμεσα ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
