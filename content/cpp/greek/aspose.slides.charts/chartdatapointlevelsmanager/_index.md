...
description: Κοντέινερ επιπέδων σημείων δεδομένων. Εφαρμόζεται για σειρές Treeamp και Sunburst. Η αρίθμηση των επιπέδων σημείων δεδομένων είναι μηδενική.
type: docs
weight: 183
...
Κοντέινερ επιπέδων σημείων δεδομένων. Εφαρμόζεται για σειρές Treeamp και Sunburst. Η αρίθμηση των επιπέδων σημείων δεδομένων είναι μηδενική.
...
| **int32_t** [get_Count](./get_count/)() override | Επιστρέφει τον αριθμό επιπέδων σημείων δεδομένων. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPointLevel](../ichartdatapointlevel/)\> [idx_get](./idx_get/)(**int32_t**) override | Επιστρέφει το αντικείμενο [IChartDataPointLevel](../ichartdatapointlevel/) για το καθορισμένο επίπεδο. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Ορίζει το n'th όρισμα προτύπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την εναλλαγή δεικτών σε containers σε αδύναμη λειτουργία. |
...
* Κλάση [IChartDataPointLevelsManager](../ichartdatapointlevelsmanager/)
