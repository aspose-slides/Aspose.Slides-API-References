...
description: Αντιπροσωπεύει την ετικέτα δεδομένων του επιπέδου σημείου δεδομένων. Εφαρμόζεται για τύπους Treemap και Sunburst. Μόνο ανάγνωση IDataLabel.
type: docs
weight: 14
url: /el/aspose.slides.charts/chartdatapointlevel/get_label/
---
## ChartDataPointLevel::get_Label() μέθοδος


Αντιπροσωπεύει την ετικέτα δεδομένων του επιπέδου σημείου δεδομένων. Εφαρμόζεται για τύπους Treemap και Sunburst. Μόνο ανάγνωση [IDataLabel](../../idatalabel/).
