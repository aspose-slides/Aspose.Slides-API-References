...
description: Αναπαριστά κείμενο με δυνατότητα αντικατάστασης για ένα γράφημα.
type: docs
weight: 1145
url: /el/aspose.slides.charts/ioverridabletext/
---
## IOverridableText κλάση


Αναπαριστά κείμενο με δυνατότητα αντικατάστασης για ένα γράφημα.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\> [AddTextFrameForOverriding](./addtextframeforoverriding/)([System::String](../../system/string/)) | Αρχικοποιεί το TextFrameForOverriding με το κείμενο στην παράμετρο \"text\". Εάν το TextFrameForOverriding έχει ήδη αρχικοποιηθεί, τότε απλώς αλλάζει το κείμενό του. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Αναλογία της μεθόδου C# [Object.GetHashCode()](../../system/object/gethashcode/). Ενεργοποιεί το κατακερματισμό προσαρμοσμένων αντικειμένων. |
