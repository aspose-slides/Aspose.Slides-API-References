...
description: Διαχειριζόμενο δοχείο των τιμών των επιπέδων κατηγοριών διαγράμματος.
type: docs
weight: 92
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| void [DeleteGroupingItem](./deletegroupingitem/)(**int32_t**) override | Διαγράψτε το στοιχείο ομαδοποίησης για το καθορισμένο επίπεδο. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) override | Επιστρέφει το αντικείμενο [IChartDataCell](../ichartdatacell/) για το καθορισμένο επίπεδο. |
...
| void [SetGroupingItem](./setgroupingitem/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Ορίζει το στοιχείο ομαδοποίησης για το καθορισμένο επίπεδο. |
...
* Κλάση [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)
