...
Αντιπροσωπεύει τοίχους σε 3δ διαγράμματα.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Επιστρέφει το γέμισμα τοίχου, τη γραμμή, το εφέ, τα στυλ 3δ. Μόνο για ανάγνωση [IFormat](../iformat/). |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | Επιστρέφει ή ορίζει τον τύπο εικόνας. Ανάγνωση [Charts::PictureType](../picturetype/). |
| **int32_t** [get_Thickness](./get_thickness/)() override | Επιστρέφει το πάχος των τοίχων ως ποσοστό της μεγαλύτερης διάστασης του όγκου γραφήματος. Ανάγνωση **int32_t**. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Λαμβάνει το πραγματικό τύπο του αντικειμένου. Αντίστοιχο κλήσης C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αντιπροσωπεύει ένα παράδειγμα του τύπου που περιγράφεται από targetType. Αντίστοιχο του τελεστή C# 'is'. |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | Επιστρέφει ή ορίζει τον τύπο εικόνας. Εγγραφή [Charts::PictureType](../picturetype/). |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | Ορίζει το πάχος των τοίχων ως ποσοστό της μεγαλύτερης διάστασης του όγκου γραφήματος. Εγγραφή **int32_t**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Ορίζει το n'th όρισμα προτύπου σε αδύναμο δείκτη (αντί για κοινό). Επιτρέπει την αλλαγή δεικτών σε συλλογές σε αδύναμη λειτουργία. |
