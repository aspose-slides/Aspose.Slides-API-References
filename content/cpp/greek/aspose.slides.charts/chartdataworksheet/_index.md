...
description: Αντιπροσωπεύει φύλλο εργασίας που σχετίζεται με IChartDataCell
type: docs
weight: 209
...
| **int32_t** [get_Index](./get_index/)() override | Λαμβάνει τον δείκτη του φύλλου εργασίας. Μόνο ανάγνωση **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Επιστρέφει το όνομα του φύλλου εργασίας. Μόνο ανάγνωση [System::String](../../system/string/). |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί τη δήλωση lock() της C# για κλείδωμα. Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο επιτήρησης [LockContext](../../system/lockcontext/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Ορίζει το ν-οστό όρισμα προτύπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την εναλλαγή δεικτών σε δοχεία σε αδύναμη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί τη δήλωση lock() της C# για ξεκλείδωμα. Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο επιτήρησης [LockContext](../../system/lockcontext/). |
...
* Κλάση [IChartDataWorksheet](../ichartdataworksheet/)
