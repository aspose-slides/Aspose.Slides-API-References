...
description: Αντιπροσωπεύει τοίχους σε 3d διαγράμματα.
type: docs
weight: 924
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Επιστρέφει το γέμισμα τοίχου, τη γραμμή, το εφέ, τα 3d στυλ. Μόνο ανάγνωση [IFormat](../iformat/). |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | Επιστρέφει ή ορίζει τον τύπο εικόνας. Ανάγνωση [PictureType](../picturetype/). |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | Επιστρέφει το πάχος των τοίχων ως ποσοστό της μεγαλύτερης διάστασης του όγκου γραφήματος. Ανάγνωση **int32_t**. |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | Επιστρέφει ή ορίζει τον τύπο εικόνας. Εγγραφή [PictureType](../picturetype/). |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | Ορίζει το πάχος των τοίχων ως ποσοστό της μεγαλύτερης διάστασης του όγκου γραφήματος. Εγγραφή **int32_t**. |
