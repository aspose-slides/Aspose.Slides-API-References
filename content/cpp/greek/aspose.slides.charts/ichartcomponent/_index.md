...
description: Αναπαριστά ένα στοιχείο γραφήματος.
type: docs
weight: 638
url: /el/aspose.slides.charts/ichartcomponent/
---
## IChartComponent κλάση
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](./get_chart/)() | Επιστρέφει το γράφημα. Μόνο για ανάγνωση [IChart](../ichart/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n-οστό όρισμα προτύπου ως αδύναμη δείκτη (αντί για κοινή). Επιτρέπει την εναλλαγή δεικτών σε συλλογή σε αδύναμη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το statement lock() της C# για ξεκλείδωμα. Καλείται απευθεία ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
