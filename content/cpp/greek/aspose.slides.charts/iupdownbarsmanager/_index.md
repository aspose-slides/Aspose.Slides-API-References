...
description: Παρέχει πρόσβαση στις μπάρες πάνω/κάτω των γραφημάτων Γραμμής ή Στοκ.
type: docs
weight: 1249
...
Παρέχει πρόσβαση στις μπάρες πάνω/κάτω των γραφημάτων Γραμμής ή Στοκ.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | Επιστρέφει τη μορφή των κάτω μπαρ. Μόνο για ανάγνωση [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | Επιστρέφει το πλάτος του κενών. Διαβάζει **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | Καθορίζει αν το γράφημα έχει μπάρες πάνω/κάτω. Διαβάζει **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | Επιστρέφει τη μορφή των πάνω μπαρ. Μόνο για ανάγνωση [IFormat](../iformat/). |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | Ορίζει το πλάτος του κενών. Εγγραφή **int32_t**. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | Καθορίζει αν το γράφημα έχει μπάρες πάνω/κάτω. Εγγραφή **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδύναμη αναφορά (αντί για κοινή). Επιτρέπει την εναλλαγή δεικτών στα containers σε αδύναμη λειτουργία. |
