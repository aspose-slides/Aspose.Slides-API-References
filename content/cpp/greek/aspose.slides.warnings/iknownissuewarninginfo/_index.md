...
description: Αντιπροσωπεύει μια προειδοποίηση για γνωστό πρόβλημα που δεν θα διορθωθεί στο κοντινό μέλλον.
type: docs
weight: 1
url: /el/aspose.slides.warnings/iknownissuewarninginfo/
---
## IKnownIssueWarningInfo κλάση


Αντιπροσωπεύει μια προειδοποίηση για γνωστό πρόβλημα που δεν θα διορθωθεί στο κοντινό μέλλον.
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Επιστρέφει μια αναγνώσιμη περιγραφή αυτής της προειδοποίησης. Μόνο για ανάγνωση [System::String](../../system/string/). |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί την δήλωση κλειδώματος lock() της C#. Καλείται άμεσα ή χρησιμοποιεί το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Εάν ο παραλήπτης δεν είναι null, τερματίζει την προειδοποίηση σε έναν καθορισμένο παραλήπτη και ρίχνει το AbortRequestedException εάν ο παραλήπτης αποφασίσει να ακυρώσει τη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκλείδωμα της δήλωσης lock() της C#. Καλείται άμεσα ή χρησιμοποιεί το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
