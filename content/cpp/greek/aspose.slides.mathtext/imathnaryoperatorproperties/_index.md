...
---
## IMathNaryOperatorProperties κλάση


Καθορίζει τις ιδιότητες του [IMathNaryOperator](../imathnaryoperator/)
...
| virtual **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() | Ο χαρακτήρας του τελεστή μεγαλώνει κάθετα ώστε να ταιριάζει με το ύψος του τελεστέου του |
| virtual **bool** [get_HideSubscript](./get_hidesubscript/)() | Απόκρυψη δείκτη |
| virtual **bool** [get_HideSuperscript](./get_hidesuperscript/)() | Απόκρυψη εκθέτη |
| virtual [MathLimitLocations](../mathlimitlocations/) [get_LimitLocation](./get_limitlocation/)() | Η θέση των ορίων (δείκτη και εκθέτη) |
| virtual char16_t [get_Operator](./get_operator/)() | Nary Operator Character Για παράδειγμα: '\\u2211', '\\u222B' |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το statement lock() της C#. Καλείται άμεσα ή χρησιμοποιήστε το αντικείμενο φρουράς [LockContext](../../system/lockcontext/). |
...
| virtual void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) | Ο χαρακτήρας του τελεστή μεγαλώνει κάθετα ώστε να ταιριάζει με το ύψος του τελεστέου του |
| virtual void [set_HideSubscript](./set_hidesubscript/)(**bool**) | Απόκρυψη δείκτη |
| virtual void [set_HideSuperscript](./set_hidesuperscript/)(**bool**) | Απόκρυψη εκθέτη |
| virtual void [set_LimitLocation](./set_limitlocation/)([MathLimitLocations](../mathlimitlocations/)) | Η θέση των ορίων (δείκτη και εκθέτη) |
| virtual void [set_Operator](./set_operator/)(char16_t) | Nary Operator Character Για παράδειγμα: '\\u2211', '\\u222B' |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το statement lock() της C# για ξεκλείδωμα. Καλείται άμεσα ή χρησιμοποιήστε το αντικείμενο φρουράς [LockContext](../../system/lockcontext/). |
