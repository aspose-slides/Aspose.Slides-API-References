...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [CreateMathBlock](./createmathblock/)() override | Δημιουργεί ένα μπλοκ μαθηματικών |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [CreateMathBlock](./createmathblock/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Δημιουργεί ένα μπλοκ μαθηματικών και τοποθετεί το στοιχείο σε αυτό |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [CreateMathBlock](./createmathblock/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\>) override | Δημιουργεί ένα μπλοκ μαθηματικών και τοποθετεί στοιχεία σε αυτό |
...
* Κλάση [IMathBlockFactory](../imathblockfactory/)
