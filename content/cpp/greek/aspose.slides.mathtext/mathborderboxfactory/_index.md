...
description: Επιτρέπει τη δημιουργία ενός πλαίσιου μαθηματικού περιγράμματος
type: docs
weight: 729
...
Επιτρέπει τη δημιουργία ενός πλαισίου μαθηματικού περιγράμματος
...
| Method | Περιγραφή |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [CreateMathBorderBox](./createmathborderbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Δημιουργεί ένα πλαίσιο μαθηματικού περιγράμματος εφαρμόζοντάς το στο στοιχείο |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [CreateMathBorderBox](./createmathborderbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) override | Δημιουργεί ένα πλαίσιο μαθηματικού περιγράμματος εφαρμόζοντάς το στο στοιχείο |
...
| void [Lock](../../system/object/lock/)() | Εφαρμόζει το statement lock() της C# για κλείδωμα. Κλήση απευθείας ή χρήση του αντικειμένου [LockContext](../../system/lockcontext/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής αντιστοίχισης. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και ενεργοποιεί την αντιγραφή κατασκευής υποκλάσεων. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδυναμικό δείκτη (αντί για κοινό). Επιτρέπει την αλλαγή δεικτών σε συλλογές σε αδύναμη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Εφαρμόζει το statement lock() της C# για ξεκλείδωμα. Κλήση απευθείας ή χρήση του αντικειμένου [LockContext](../../system/lockcontext/). |
...
* Κλάση [IMathBorderBoxFactory](../imathborderboxfactory/)
