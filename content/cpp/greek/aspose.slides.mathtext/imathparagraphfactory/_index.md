...
---
## IMathParagraphFactory κλάση

Επιτρέπει τη δημιουργία μιας παράγραφου μαθηματικών
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathParagraph](../imathparagraph/)\> [CreateMathParagraph](./createmathparagraph/)() | Δημιουργεί κενή παράγραφο μαθηματικών |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathParagraph](../imathparagraph/)\> [CreateMathParagraph](./createmathparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Δημιουργεί μια παράγραφο μαθηματικών και τοποθετεί το καθορισμένο μπλοκ μαθηματικών σε αυτήν |
...
| void [Unlock](../../system/object/unlock/)() | Εφαρμόζει την εκδίκηση του κλειδώματος της δήλωσης C# lock(). Καλέστε άμεσα ή χρησιμοποιήστε το αντικείμενο [LockContext](../../system/lockcontext/). |
