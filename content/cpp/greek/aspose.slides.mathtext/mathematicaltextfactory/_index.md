...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)() override | Δημιουργεί κενό στοιχείο μαθηματικού κειμένου |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)(char16_t) override | Δημιουργεί στοιχείο μαθηματικού κειμένου με την καθορισμένη τιμή |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/)) override | Δημιουργεί κενό στοιχείο μαθηματικού κειμένου με την καθορισμένη τιμή |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\>) override | Δημιουργεί κενό στοιχείο μαθηματικού κειμένου με την καθορισμένη τιμή και ιδιότητες μορφοποίησης |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Αντιστοιχο της μεθόδου C# [Object.GetHashCode()](../../system/object/gethashcode/). Ενεργοποιεί τη δημιουργία κατακερματισμού προσαρμοσμένων αντικειμένων. |
...
| void [Lock](../../system/object/lock/)() | Εφαρμόζει την κλείδωση της δήλωσης C# lock(). Καλέστε το άμεσα ή χρησιμοποιήστε το αντικείμενο [LockContext](../../system/lockcontext/) sentry. |
...
| void [Unlock](../../system/object/unlock/)() | Εφαρμόζει την αντικλείδωση της δήλωσης C# lock(). Καλέστε άμεσα ή χρησιμοποιήστε το αντικείμενο [LockContext](../../system/lockcontext/) sentry. |
...
* Κλάση [IMathematicalTextFactory](../imathematicaltextfactory/)
