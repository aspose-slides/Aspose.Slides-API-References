...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [CreateMathBox](./createmathbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Δημιουργεί ένα math box εφαρμόζοντάς το στο στοιχείο |
...
* Κλάση [IMathBoxFactory](../imathboxfactory/)
