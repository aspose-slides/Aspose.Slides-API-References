...
description: Διεπαφή επανάκλησης που χρησιμοποιείται από τη διαδικασία εισαγωγής HTML για να αποκτήσει αναφερόμενα αντικείμενα όπως εικόνες.
type: docs
weight: 53
url: /el/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver κλάση

Διεπαφή επανάκλησης που χρησιμοποιείται από τη διαδικασία εισαγωγής HTML για την απόκτηση αναφερόμενων αντικειμένων όπως εικόνες.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | Αντιστοιχεί ένα URI σε ένα αντικείμενο που περιέχει τον πραγματικό πόρο. |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | Επιλύει το απόλυτο URI από τα βασικά και σχετικά URIs. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n-οστό όρισμα προτύπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή των δεικτών σε δοχεία σε αδύναμη λειτουργία. |
...
Αποσυρμένο
:   Παρωχημένο. Χρησιμοποιήστε [IExternalResourceResolver](../iexternalresourceresolver/) αντί αυτού. Θα αφαιρεθεί στην έκδοση 17.12 release.
