...
| **bool** [get_DetectTables](./get_detecttables/)() const | Καθορίζει εάν ανιχνεύονται πίνακες κατά την εισαγωγή αρχείου pdf. |
...
| void [set_DetectTables](./set_detecttables/)(**bool**) | Καθορίζει εάν ανιχνεύονται πίνακες κατά την εισαγωγή αρχείου pdf. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Αυξάνει τον κοινόχρηστο μετρητή αναφορών. Δεν θα πρέπει να κληθεί άμεσα· αντίγια, χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Μειώνει και επιστρέφει τον κοινόχρηστο μετρητή αναφορών. Δεν θα πρέπει να κληθεί άμεσα· αντίγια, χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον αδυνατό μετρητή αναφορών. Δεν θα πρέπει να κληθεί άμεσα· αντίγια, χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον αδυνατό μετρητή αναφορών. Δεν θα πρέπει να κληθεί άμεσα· αντίγια, χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
