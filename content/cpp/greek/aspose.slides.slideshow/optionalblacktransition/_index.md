...
description: Προαιρετικό εφέ μετάβασης διαφάνειας με μαύρο φόντο.
type: docs
weight: 326
...
| **bool** [get_FromBlack](./get_fromblack/)() override | Αυτό το χαρακτηριστικό καθορίζει εάν η μετάβαση θα ξεκινήσει από μαύρη οθόνη (και στη συνέχεια θα μεταβιβάσει τη νέα διαφάνεια πάνω από το μαύρο). Διαβάστε **bool**. |
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Λειτουργεί ως συνάρτηση κατατεματισμού για έναν συγκεκριμένο τύπο, κατάλληλη για χρήση σε αλγόριθμους κατατεματισμού και δομές δεδομένων όπως ένας πίνακας κατατεματισμού. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Δεν αντιγράφει τίποτα, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή κατασκευών υποκλάσεων. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής ανάθεσης. Δεν αντιγράφει τίποτα, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή κατασκευών υποκλάσεων. |
...
| void [set_FromBlack](./set_fromblack/)(**bool**) override | Αυτό το χαρακτηριστικό καθορίζει εάν η μετάβαση θα ξεκινήσει από μαύρη οθόνη (και στη συνέχεια θα μεταβιβάσει τη νέα διαφάνεια πάνω από το μαύρο). Γράψτε **bool**. |
...
* Κλάση [IOptionalBlackTransition](../ioptionalblacktransition/)
