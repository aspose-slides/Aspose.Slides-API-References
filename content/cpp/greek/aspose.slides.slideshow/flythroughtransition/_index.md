...
| **bool** [get_HasBounce](./get_hasbounce/)() override | Καθορίζει ότι η κίνηση των διαφανειών παρουσίασης κατά τη μετάβαση περιλαμβάνει ένα αναπήδημα. Διαβάστε **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Στην πραγματικότητα δεν κάνει αντιγραφή, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφική κατασκευή υποκλάσεων. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής ανάθεσης. Στην πραγματικότητα δεν κάνει αντιγραφή, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφική κατασκευή υποκλάσεων. |
...
| void [set_HasBounce](./set_hasbounce/)(**bool**) override | Καθορίζει ότι η κίνηση των διαφανειών παρουσίασης κατά τη μετάβαση περιλαμβάνει ένα αναπήδημα. Γράψτε **bool**. |
...
* Κλάση [IFlyThroughTransition](../iflythroughtransition/)
