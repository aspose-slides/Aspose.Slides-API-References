...
description: Κενή επίδραση μετάβασης διαφάνειας.
type: docs
weight: 92
url: /el/aspose.slides.slideshow/iemptytransition/
---
## IEmptyTransition κλάση

Κενή επίδραση μετάβασης διαφάνειας.
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Αναλογία της μεθόδου C# [Object.GetHashCode()](../../system/object/gethashcode/). Ενεργοποιεί την κατακερματιστική λειτουργία προσαρμοσμένων αντικειμένων. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τ operator ανάθεσης. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει τη δημιουργία υποκατηγορίων μέσω αντιγραφής. |
