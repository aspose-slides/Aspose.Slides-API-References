...
description: Εφέ μετάβασης σπασμένης διαφάνειας.
type: docs
weight: 235
url: /el/aspose.slides.slideshow/ishredtransition/
---
## IShredTransition κλάση

Εφέ μετάβασης σπασμένης διαφάνειας.
...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Κατεύθυνση της μετάβασης. Διαβάστε [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() | Καθορίζει το σχήμα των οπτικών στοιχείων που χρησιμοποιούνται κατά τη μετάβαση. Διαβάστε [TransitionShredPattern](../transitionshredpattern/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή αντιγραφών υποκλάσεων. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστέα ανάθεσης. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή αντιγραφών υποκλάσεων. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Κατεύθυνση της μετάβασης. Εγγράψτε [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) | Καθορίζει το σχήμα των οπτικών στοιχείων που χρησιμοποιούνται κατά τη μετάβαση. Εγγράψτε [TransitionShredPattern](../transitionshredpattern/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών στα containers σε αδύναμη κατάσταση. |
