...
description: Αντιπροσωπεί τη βασική κλάση για εφέ μετάβασης διαφάνειας.
type: docs
weight: 274
url: /el/aspose.slides.slideshow/itransitionvaluebase/
---
## ITransitionValueBase κλάση

Αντιπροσωπεί τη βασική κλάση για εφέ μετάβασης διαφάνειας.
