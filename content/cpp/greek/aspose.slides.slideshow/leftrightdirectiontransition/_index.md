...
description: Επίδραση μετάβασης διαφάνειας σε κατεύθυνση αριστερά-δεξιά.
type: docs
weight: 300
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Καθορίζει εάν τα δύο [TransitionValueBase](../transitionvaluebase/) είναι ίσα. |
...
| void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) override | Κατεύθυνση μετάβασης. Γράψτε [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδύναμο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την εναλλαγή δεικτών σε δομές σε αδυναμη λειτουργία. |
...
* Κλάση [ILeftRightDirectionTransition](../ileftrightdirectiontransition/)
* Ονοματοχώρος [Aspose::Slides::SlideShow](../)
