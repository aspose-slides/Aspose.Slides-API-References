...
description: Εφέ μετάβασης διαχωρισμού διαφάνειας.
type: docs
weight: 261
url: /el/aspose.slides.slideshow/isplittransition/
---
## ISplitTransition κλάση

Εφέ μετάβασης διαχωρισμού διαφάνειας.
...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Κατεύθυνση διαχωρισμού μετάβασης. Διαβάστε [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() | Προσανατολισμός διαχωρισμού μετάβασης. Διαβάστε [Slides::Orientation](../../aspose.slides/orientation/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Κατεύθυνση διαχωρισμού μετάβασης. Γράψτε [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) | Προσανατολισμός διαχωρισμού μετάβασης. Γράψτε [Slides::Orientation](../../aspose.slides/orientation/). |
