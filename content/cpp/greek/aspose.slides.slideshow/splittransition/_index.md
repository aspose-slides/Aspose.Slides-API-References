...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Κατεύθυνση διαίρεσης μετάβασης. Ανάγνωση [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() override | Προσανατολισμός διαίρεσης μετάβασης. Ανάγνωση [Slides::Orientation](../../aspose.slides/orientation/). |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Κατεύθυνση διαίρεσης μετάβασης. Εγγραφή [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) override | Προσανατολισμός διαίρεσης μετάβασης. Εγγραφή [Slides::Orientation](../../aspose.slides/orientation/). |
...
* Κλάση [ISplitTransition](../isplittransition/)
