...
description: "Ορισμός enumerator για την περιτύλιξη τύπων τύπου STL για χρήση σε στυλ C#. Δεν κάνει καμία υπόθεση για τη δομή του container εκτός από την ύπαρξη διαδοχικού iterator. Χρησιμοποιεί τις συναρτήσεις begin() και end(). Τα αντικείμενα αυτής της κλάσης πρέπει να δημιουργούνται μόνο με τη συνάρτηση System::MakeObject(). Ποτέ δεν πρέπει να δημιουργείτε στιγμιότυπο αυτού του τύπου στη στοίβα ή με τον τελεστή new, καθώς αυτό θα προκαλέσει σφάλματα χρόνου εκτέλεσης και/ή σφάλματα υπόθεσης. Πάντα περιτυλίγετε αυτήν την κλάση σε δείκτη System::SmartPtr και χρησιμοποιήστε αυτόν τον δείκτη για να τον περάσετε σε συναρτήσεις ως παράμετρο."
type: docs
weight: 66
url: /el/system.collections.generic/baseenumerator/
---
## BaseEnumerator κλάση
...
| Method | Description |
| --- | --- |
| [IEnumerator](../ienumerator/) * [AsVirtualizedIterator](../ienumerator/asvirtualizediterator/)() | Προετοιμάζει τον iterator για χρήση από την κλάση VirtualizedIterator. |
| [BaseEnumerator](./baseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | Αρχικοποιεί τον iterator. |
| System::Details::VirtualizedIteratorBase\<T\> * [CloneIterator](../ienumerator/cloneiterator/)() const override | Κλωνοποιεί τον τρέχοντα iterator. |
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](../ienumerator/current/)() const | Επιστρέφει το τρέχον στοιχείο. |
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](../ienumerator/get_current/)() const | Επιστρέφει το τρέχον στοιχείο. |
...
| void [InitializeIterator](../ienumerator/initializeiterator/)() override | Κάνει την πρώτη κλήση [MoveNext()](../ienumerator/movenext/) και προετοιμάζει το αντικείμενο enumerator για χρήση από VirtualizedIterator. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αποτελεί μία περίπτωση του τύπου που περιγράφεται από targetType. Αναλογία του τελεστή C# 'is'. |
| **bool** [IsValid](./isvalid/)() const | Ελέγχει αν κλήθηκε [MoveNext()](./movenext/) και δεν έχει φτάσει το τέλος. |
| void [Lock](../../system/object/lock/)() | Εφαρμόζει το κλείδωμα της δήλωσης C# lock(). Καλείται άμεσα ή χρησιμοποιήστε το αντικείμενο φύλακα [LockContext](../../system/lockcontext/). |
| void [MarkOwnedByVirtualizedIterator](../ienumerator/markownedbyvirtualizediterator/)() | Σημαδεύει τον enumerator που ανήκει στον virtualized iterator. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Αναλογία της μεθόδου C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Ενεργοποιεί την κλωνοποίηση προσαρμοσμένων τύπων. |
| **bool** [MoveNext](./movenext/)() override | Αύξηση σε στυλ enumerator. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεσ/operator ανάθεσης. Δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή υποτύπων. |
...
| void [Reset](./reset/)() override | Επαναφέρει τον enumerator για να επιτρέπει επανεξέταση στοιχείων. |
...
| void [Unlock](../../system/object/unlock/)() | Εφαρμόζει το ξεκλείδωμα της δήλωσης C# lock(). Καλείται άμεσα ή χρησιμοποιήστε το αντικείμενο φύλακα [LockContext](../../system/lockcontext/). |
