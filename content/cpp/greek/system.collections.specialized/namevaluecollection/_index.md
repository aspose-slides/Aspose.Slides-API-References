...
description: Συλλογή συσχετισμένων κλειδιών String και τιμών String που μπορούν να προσπελαστούν είτε με το κλειδί είτε με το δείκτη.
type: docs
weight: 14
url: /el/system.collections.specialized/namevaluecollection/
---
## NameValueCollection κλάση

Collection of associated [String](../../system/string/) κλειδιών και [String](../../system/string/) τιμών που μπορούν να προσπελαστούν είτε με το κλειδί είτε με το δείκτη.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&) override | Αντικαθιστά τη μέθοδο [ICollection](../../system.collections/icollection/) - δεν έχει υλοποιηθεί. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | Αντιγράφει τις καταχωρήσεις από το καθορισμένο [NameValueCollection](./) στην τρέχουσα. |
| virtual void [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Προσθέτει μια καταχώρηση με το καθορισμένο όνομα και τιμή. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Λαμβάνει έναν επαναλήπτη που δείχνει στο πρώτο στοιχείο (αν υπάρχει) της συλλογής. Αυτός ο επαναλήπτης δεν μπορεί να χρησιμοποιηθεί για να αλλάξει το αντικείμενο που αναφέρεται επειδή το [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) επιστρέφει αντίγραφο του T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Λαμβάνει έναν επαναλήπτη που δείχνει στο πρώτο στοιχείο (αν υπάρχει) της σταθερά-προσδιορισμένης εκδοχής της συλλογής. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Λαμβάνει έναν επαναλήπτη που δείχνει στο πρώτο σταθερό στοιχείο (αν υπάρχει) της συλλογής. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Λαμβάνει έναν επαναλήπτη που δείχνει αμέσως μετά το τελευταίο σταθερό στοιχείο (αν υπάρχει) της συλλογής. |
| void [Clear](./clear/)() override | Διαγράφει όλα τα στοιχεία. |
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) const override | Ελέγχει αν το στοιχείο υπάρχει στη συλλογή. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\>, **int32_t**) override | Αντιγραφεί τα στοιχεία της συλλογής σε υπάρχοντα στοιχεία πίνακα. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Λαμβάνει έναν επαναλήπτη που δείχνει αμέσως μετά το τελευταίο στοιχείο (αν υπάρχει) της συλλογής. Αυτός ο επαναλήπτης δεν μπορεί να χρησιμοποιηθεί για να αλλάξει το αντικείμενο που αναφέρεται επειδή το [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) επιστρέφει αντίγραφο του T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Λαμβάνει έναν επαναλήπτη που δείχνει αμέσως μετά το τελευταίο στοιχείο (αν υπάρχει) της σταθερά-προσδιορισμένης εκδοχής της συλλογής. |
...
| virtual [String](../../system/string/) [Get](./get/)(const [String](../../system/string/)\&) | Λαμβάνει τις τιμές που σχετίζονται με το καθορισμένο κλειδί. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [get_AllKeys](./get_allkeys/)() | Λαμβάνει όλα τα κλειδιά. |
| int [get_Count](./get_count/)() const override | Λαμβάνει τον αριθμό των ζευγών κλειδί/τιμή. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[String](../../system/string/)\>\> [get_Keys](./get_keys/)() | Λαμβάνει όλα τα κλειδιά. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Λαμβάνει έναν απαριθμητή για επανάληψη στη συλλογή. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [GetValues](./getvalues/)(const [String](../../system/string/)\&) | Λαμβάνει τις τιμές που σχετίζονται με το καθορισμένο κλειδί. |
| **bool** [HasKeys](./haskeys/)() | Λαμβάνει μια τιμή που υποδεικνύει αν το [NameValueCollection](./) περιέχει κλειδιά που δεν είναι null. |
...
| [String](../../system/string/) [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Λαμβάνει την τιμή στο καθορισμένο δείκτη. |
| void [idx_set](./idx_set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Ορίζει την τιμή μιας καταχώρησης. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αντιπροσωπεύει μια περίπτωση του τύπου που περιγράφεται από targetType. Αναλογία του τελεστή 'is' της C#. |
...
| [NameValueCollection](./namevaluecollection/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | Αντιγράφει τις καταχωρήσεις από το καθορισμένο [NameValueCollection](./) σε ένα νέο [NameValueCollection](./). |
...
| **bool** [Remove](./remove/)(const [String](../../system/string/)\&) override | Αφαιρεί ένα συγκεκριμένο στοιχείο. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Μειώνει τον μετρητή κοινής αναφοράς κατά την καθορισμένη τιμή. |
| virtual void [Set](./set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Ορίζει την τιμή μιας καταχώρησης. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το ν-οστό όρισμα προτύπου ως αδυναμικό δείκτη (αντί για κοινό). Επιτρέπει την αλλαγή δεικτών σε δοχεία σε αδυναμική λειτουργία. |
...
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Λαμβάνει την υλοποίηση του αρχικού const επαναλήπτη για το τρέχον δοχείο. |
...
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Λαμβάνει την υλοποίηση του τελικού const επαναλήπτη για το τρέχον δοχείο. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον μετρητή αδυναμικής αναφοράς. Δεν πρέπει να κληθεί άμεσα· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον μετρητή αδυναμικής αναφοράς. Δεν πρέπει να κληθεί άμεσα· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
...
* Ονομαχώρος [System::Collections::Specialized](../)
