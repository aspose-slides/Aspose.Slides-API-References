...
description: Αντιπροσωπεύει το στοιχείο restriction για απλό περιεχόμενο από το XML Schema όπως ορίζεται από το Παγκόσμιο Ινστιτούτο Διαδικτύου (W3C). Αυτή η κλάση μπορεί να χρησιμοποιηθεί για την παραγωγή απλών τύπων μέσω περιορισμού. Τέτοιοι περιορισμοί μπορούν να χρησιμοποιηθούν για τον περιορισμό του εύρους τιμών του στοιχείου σε ένα υποσύνολο των τιμών που καθορίζονται στον κληρονομημένο απλό τύπο.
type: docs
weight: 820
url: /el/system.xml.schema/xmlschemasimplecontentrestriction/
---
## XmlSchemaSimpleContentRestriction κλάση

Αναπαριστά το στοιχείο **restriction** για απλό περιεχόμενο από XML [Schema](../) όπως ορίζεται από την Παγκόσμια [Web](../../system.web/) Συνομοσπονδία (W3C). Αυτή η κλάση μπορεί να χρησιμοποιηθεί για την παράγωγο απλών τύπων μέσω περιορισμού. Τέτοιες παράγωγες μπορούν να χρησιμοποιηθούν για να περιορίσουν το εύρος των τιμών του στοιχείου σε ένα υποσύνολο των τιμών που καθορίζονται στον κληρονομημένο απλό τύπο.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Returns an [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) to be used for the attribute value. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Returns the [XmlSchemaAttribute](../xmlschemaattribute/) and [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) collection of attributes for the simple type. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | Returns the simple type base value. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Returns the name of the built-in data type or simple type from which this type is derived. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | Returns an [Xml](../../system.xml/)[Schema](../) facet. |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Sets an [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) to be used for the attribute value. |
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Sets the simple type base value. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Sets the name of the built-in data type or simple type from which this type is derived. |
...
Τα αντικείμενα αυτής της κλάσης θα πρέπει να δημιουργούνται μόνο χρησιμοποιώντας τη συνάρτηση [System::MakeObject()](../../system/makeobject/). Ποτέ μην δημιουργείτε στιγμιότυπα αυτού του τύπου στη στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς θα προκαλέσει σφάλματα χρόνου εκτέλεσης και/ή σφάλματα ελέγχου. Πάντα να περιβάλλετε αυτήν την κλάση με δείκτη [System::SmartPtr](../../system/smartptr/) και να χρησιμοποιείτε αυτόν τον δείκτη για να τον περάσετε στις συναρτήσεις ως όρισμα.
