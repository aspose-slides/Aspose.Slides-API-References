...
description: Υποστηρίζει απλή επανάληψη σε μια συλλογή. Αυτή η κλάση δεν μπορεί να κληθεί.
type: docs
weight: 235
url: /el/system.xml.schema/xmlschemacollectionenumerator/
---
## XmlSchemaCollectionEnumerator κλάση
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Προετοιμάζει τον iterator για χρήση από την VirtualizedIterator κλάση. |
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchema](../xmlschema/)\>\> * [CloneIterator](./cloneiterator/)() const override | Δημιουργεί κλώνο του τρέχοντος iterator. |
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](../../system.collections.generic/ienumerator/current/)() const | Παίρνει το τρέχον στοιχείο. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Εξομοιώνει τη σύγκριση αριθμού κινητής υποδιαστολής τύπου double σε στυλ C#, όπου δύο NaN θεωρούνται ίσα παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Μόνο για εσωτερικές χρήσεις. |
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\& [get_Current](./get_current/)() const override | Επιστρέφει το τρέχον [XmlSchema](../xmlschema/) στη συλλογή. |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Μετακινεί τον iterator ένα βήμα μπροστά. |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Κάνει την πρώτη [MoveNext()](../../system.collections.generic/ienumerator/movenext/) κλήση και προετοιμάζει το αντικείμενο enumerator για χρήση από τον VirtualizedIterator. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το κλείδωμα της δήλωσης C# lock(). Καλείται άμεσα ή χρησιμοποιήστε το αντικείμενο φρουρά [LockContext](../../system/lockcontext/). |
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | Σημειώνει τον enumerator που ανήκει σε virtualized iterator. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Αναλογία της μεθόδου C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Ενεργοποιεί την κλωνοποίηση προσαρμοσμένων τύπων. |
| **bool** [MoveNext](./movenext/)() override | Προχωρά τον enumerator στο επόμενο schema στη συλλογή. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκλείδωμα της δήλωσης C# lock(). Καλείται άμεσα ή χρησιμοποιήστε το αντικείμενο φρουρά [LockContext](../../system/lockcontext/). |
