...
description: Ορίζει το σύνολο πληροφοριών μετά την επικύρωση του σχήματος ενός επικυρωμένου κόμβου XML.
type: docs
weight: 40
url: /el/system.xml.schema/ixmlschemainfo/
---
## IXmlSchemaInfo κλάση

Ορίζει το σύνολο πληροφοριών μετά την επικύρωση του σχήματος ενός επικυρωμένου κόμβου XML.
...
| virtual **bool** [get_IsDefault](./get_isdefault/)() | Επιστρέφει τιμή που υποδεικνύει εάν αυτός ο επικυρωμένος κόμβος XML ορίστηκε ως αποτέλεσμα μιας προεπιλογής που εφαρμόστηκε κατά την επικύρωση σχήματος XML [Schema](../) Definition Language (XSD). |
| virtual **bool** [get_IsNil](./get_isnil/)() | Επιστρέφει τιμή που υποδεικνύει εάν η τιμή για αυτόν τον επικυρωμένο κόμβο XML είναι **nil**. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | Επιστρέφει τον δυναμικό τύπο σχήματος για αυτόν τον επικυρωμένο κόμβο XML. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | Επιστρέφει το μεταγλωττισμένο [XmlSchemaAttribute](../xmlschemaattribute/) που αντιστοιχεί σε αυτόν τον επικυρωμένο κόμβο XML. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | Επιστρέφει το μεταγλωττισμένο [XmlSchemaElement](../xmlschemaelement/) που αντιστοιχεί σε αυτόν τον επικυρωμένο κόμβο XML. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | Επιστρέφει τον στατικό τύπο σχήματος XML [Schema](../) Definition Language (XSD) για αυτόν τον επικυρωμένο κόμβο XML. |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | Επιστρέφει την τιμή XmlSchemaValidity αυτού του επικυρωμένου κόμβου XML. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το κλείδωμα της δήλωσης C# lock(). Κλήση άμεσα ή χρήση του αντικειμένου κερματοδότη [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκλείδωμα της δήλωσης C# lock(). Κλήση άμεσα ή χρήση του αντικειμένου κερματοδότη [LockContext](../../system/lockcontext/). |
