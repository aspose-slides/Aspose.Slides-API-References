...
description: Μια συλλογή από XmlSchemaObjects.
type: docs
weight: 690
url: /el/system.xml.schema/xmlschemaobjectcollection/
---
## XmlSchemaObjectCollection κλάση

Μια συλλογή από XmlSchemaObjects.
...
| Method | Description |
| --- | --- |
| **int32_t** [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Προσθέτει ένα [XmlSchemaObject](../xmlschemaobject/) στο [XmlSchemaObjectCollection](./). |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Λαμβάνει έναν επαναλήπτη που δείχνει στο πρώτο στοιχείο (αν υπάρχει) της έκδοσης της συλλογής που είναι const. |
...
| void [Clear](../../system.collections/collectionbase/clear/)() | Αφαιρεί όλα τα αντικείμενα από το στιγμιότυπο της συλλογής. Αυτή η μέθοδος δεν μπορεί να παρακαμφθεί. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Δηλώνει αν το καθορισμένο [XmlSchemaObject](../xmlschemaobject/) βρίσκεται στο [XmlSchemaObjectCollection](./). |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\&, **int32_t**) | Αντιγράφει όλα τα XmlSchemaObjects από τη συλλογή στον δεδομένο πίνακα, ξεκινώντας από το δεδομένο δείκτη. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Λαμβάνει έναν επαναλήπτη που δείχνει ακριβώς μετά το τελευταίο στοιχείο (αν υπάρχει) της συλλογής. Αυτός ο επαναλήπτης δεν μπορεί να χρησιμοποιηθεί για την αλλαγή ενός αναφερόμενου αντικειμένου επειδή το [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) επιστρέφει ένα αντίγραφο-αντικείμενο του T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Λαμβάνει έναν επαναλήπτη που δείχνει ακριβώς μετά το τελευταίο στοιχείο (αν υπάρχει) της const-εξουσιοδοτημένης έκδοσης της συλλογής. |
...
| **int32_t** [get_Capacity](../../system.collections/collectionbase/get_capacity/)() | Επιστρέφει τον αριθμό των στοιχείων που μπορεί να περιέχει η συλλογή. |
| **int32_t** [get_Count](../../system.collections/collectionbase/get_count/)() | Επιστρέφει τον αριθμό των στοιχείων που περιέχονται στο στιγμιότυπο της συλλογής. Αυτή η μέθοδος δεν μπορεί να παρακαμφθεί. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Λαμβάνει τη δομή δεδομένων μετρητή αναφοράς που σχετίζεται με το αντικείμενο. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [GetEnumerator](./getenumerator/)() override | Επιστρέφει έναν ενομερητή για την επανάληψη των XmlSchemaObjects που περιέχονται στο [XmlSchemaObjectCollection](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(**int32_t**) | Επιστρέφει το [XmlSchemaObject](../xmlschemaobject/) στον καθορισμένο δείκτη. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>) | Ορίζει το [XmlSchemaObject](../xmlschemaobject/) στον καθορισμένο δείκτη. |
| **int32_t** [IndexOf](./indexof/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Επιστρέφει τον δείκτη της συλλογής που αντιστοιχεί στο καθορισμένο [XmlSchemaObject](../xmlschemaobject/). |
| void [Insert](./insert/)(**int32_t**, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Εισάγει ένα [XmlSchemaObject](../xmlschemaobject/) στο [XmlSchemaObjectCollection](./). |
...
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | Εφαρμόζει μια συνάρτηση κατασσωρευτή σε μια ακολουθία. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Επιστρέφει έναν καθορισμένο αριθμό συνεχών στοιχείων από την αρχή μιας ακολουθίας. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το κλείδωμα της εντολής C# lock(). Καλείται άμεσα ή χρησιμοποιεί το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Συγκρίνει αντικείμενο τύπου τιμής με nullptr με χρήση αναφοράς. |
...
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Αφαιρεί ένα [XmlSchemaObject](../xmlschemaobject/) από το [XmlSchemaObjectCollection](./). |
| void [RemoveAt](../../system.collections/collectionbase/removeat/)(**int32_t**) | Αφαιρεί το στοιχείο στον καθορισμένο δείκτη της στιγμιότυπου της συλλογής. Αυτή η μέθοδος δεν είναι παραμεθίσιμη. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Μειώνει τον μετρητή κοινόχρηστων αναφορών κατά την καθορισμένη τιμή. |
| void [set_Capacity](../../system.collections/collectionbase/set_capacity/)(**int32_t**) | Ορίζει τον αριθμό των στοιχείων που μπορεί να περιέχει η συλλογή. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Ορίζει το n'th όρισμα προτύπου ως αδρή δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε δοχεία σε αδρή λειτουργία. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Μειώνει και επιστρέ φει τον μετρητή κοινόχρηστων αναφορών. Δεν πρέπει να καλείται άμεσα· χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκλείδωμα της εντολής C# lock(). Καλείται άμεσα ή χρησιμοποιεί το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Λαμβάνει την υλοποίηση του const αρχικού επαναλήπτη για το τρέχον δοχείο. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Λαμβάνει την υλοποίηση του const τελικού επαναλήπτη για το τρέχον δοχείο. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον μετρητή αδρων αναφορών. Δεν πρέπει να καλείται άμεσα· χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον μετρητή αδρων αναφορών. Δεν πρέπει να καλείται άμεσα· χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)() | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [XmlSchemaObjectCollection](./). |
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [XmlSchemaObjectCollection](./) που λαμβάνει ένα [XmlSchemaObject](../xmlschemaobject/). |
