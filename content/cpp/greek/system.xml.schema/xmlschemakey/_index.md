...
description: Αυτή η κλάση αντιπροσωπεύει το στοιχείο **key** από το XMLSchema όπως καθορίζεται από το World Wide Web Consortium (W3C).
type: docs
weight: 534
url: /el/system.xml.schema/xmlschemakey/
---
## XmlSchemaKey κλάση


Αυτή η κλάση αντιπροσωπεύει το στοιχείο **key** από το XMLSchema όπως καθορίζεται από το Παγκόσμιο [Web](../../system.web/) Consortium (W3C).
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](../xmlschemaidentityconstraint/get_fields/)() | Επιστρέφει τη συλλογή των πεδίων που ισχύουν ως παιδιά για τον επιλογέα έκφρασης XML Path Language ([XPath](../../system.xml.xpath/)). |
...
| [String](../../system/string/) [get_Name](../xmlschemaidentityconstraint/get_name/)() | Επιστρέφει το όνομα του περιορισμού ταυτότητας. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](../xmlschemaidentityconstraint/get_qualifiedname/)() | Επιστρέφει το καθορισμένο όνομα του περιορισμού ταυτότητας, το οποίο περιέχει την μετά-μεταγλώττιση ερμηνεία της τιμής **QualifiedName**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](../xmlschemaidentityconstraint/get_selector/)() | Επιστρέφει το στοιχείο **selector** της έκφρασης [XPath](../../system.xml.xpath/). |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Επιστρέφει τα καθορισμένα χαρακτηριστικά που δεν ανήκουν στο τρέχον namespace προορισμού του σχήματος. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Αναλογική της μεθόδου C# [Object.GetHashCode()](../../system/object/gethashcode/). Επιτρέπει την κατασκευή hash για προσαρμοσμένα αντικείμενα. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αντιπροσωπεύει μια περίπτωση του τύπου που περιγράφεται από το targetType. Αναλογική του τελεστή C# 'is'. |
| void [Lock](../../system/object/lock/)() | Εκτελεί την κλειδωτική εντολή C# lock(). Κλήση απευθείας ή χρήση του αντικειμένου φρουρού [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Δεν αντιγράφει τίποτα, απλώς αρχικοποιεί ένα νέο αντικείμενο και επιτρέπει τη δημιουργία υποκλάσεων μέσω αντιγραφής. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής ανάθεσης. Δεν αντιγράφει τίποτα, απλώς αρχικοποιεί ένα νέο αντικείμενο και επιτρέπει τη δημιουργία υποκλάσεων μέσω αντιγραφής. |
...
| void [set_Name](../xmlschemaidentityconstraint/set_name/)(const [String](../../system/string/)\&) | Ορίζει το όνομα του περιορισμού ταυτότητας. |
...
| void [set_Selector](../xmlschemaidentityconstraint/set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Ορίζει το στοιχείο **selector** της έκφρασης [XPath](../../system.xml.xpath/). |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Ορίζει τα καθορισμένα χαρακτηριστικά που δεν ανήκουν στο τρέχον namespace προορισμού του σχήματος. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το ν-οστό όρισμα του προτύπου ως αδύναμε δείκτη (αντί για κοινό). Επιτρέπει την αλλαγή των δεικτών σε συλλέκτες σε αδύναμη λειτουργία. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Εκτελεί το κατασκευαστικό C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Εκτελεί την απελευθέρωση της εντολής C# lock(). Κλήση απευθείας ή χρήση του αντικειμένου φρουρού [LockContext](../../system/lockcontext/). |
...
|  [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/xmlschemaidentityconstraint/)() | Αρχικοποιεί μια νέα παρουσία της κλάσης [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/). |
...
Τα αντικείμενα αυτής της κλάσης πρέπει να εκχωρούνται μόνο χρησιμοποιώντας τη λειτουργία [System::MakeObject()](../../system/makeobject/). Ποτέ μην δημιουργείτε παραδείγματα αυτού του τύπου στη στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς θα οδηγήσει σε σφάλματα χρόνου εκτέλεσης και/ή σφάλματα ελέγχου. Πάντα τυλίξτε αυτήν την κλάση σε δείκτη [System::SmartPtr](../../system/smartptr/) και χρησιμοποιήστε αυτόν τον δείκτη για να τον περάσετε σε συναρτήσεις ως όρισμα. 

## Δείτε επίσης

* Κλάση [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/)
