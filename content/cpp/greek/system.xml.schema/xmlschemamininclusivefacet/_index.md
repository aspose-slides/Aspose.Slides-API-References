...
description: Αναπαριστά το στοιχείο minInclusive από το XML Schema όπως ορίζεται από το Παγκόσμιο Συνεταιρισμό Παγκόσμιου Ιστού (W3C). Αυτή η κλάση μπορεί να χρησιμοποιηθεί για να καθορίσει έναν περιορισμό στην ελάχιστη τιμή ενός στοιχείου simpleType. Η τιμή του στοιχείου πρέπει να είναι μεγαλύτερη ή ίση με την τιμή του στοιχείου minInclusive.
type: docs
weight: 625
url: /el/system.xml.schema/xmlschemamininclusivefacet/
---
## XmlSchemaMinInclusiveFacet κλάση

Αναπαριστά το στοιχείο **minInclusive** από το XML [Schema](../) όπως ορίζεται από το Παγκόσμιο [Web](../../system.web/) Consortium (W3C). Αυτή η κλάση μπορεί να χρησιμοποιηθεί για να καθορίσει έναν περιορισμό στην ελάχιστη τιμή ενός στοιχείου simpleType. Η τιμή του στοιχείου πρέπει να είναι μεγαλύτερη ή ίση με την τιμή του στοιχείου **minInclusive**.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Επιστρέφει το γονικό αντικείμενο αυτού του [XmlSchemaObject](../xmlschemaobject/). |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Επιστρέφει τα διακριτά χαρακτηριστικά που δεν ανήκουν στον τρέχοντα χώρο ονομάτων στόχου του σχήματος. |
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Επιστρέφει το χαρακτηριστικό **value** του χαρακτηριστικού. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Λαμβάνει τη δομή δεδομένων καταμέτρησης αναφορών που σχετίζεται με το αντικείμενο. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Αναλογία της μεθόδου C# [Object.GetHashCode()](../../system/object/gethashcode/). Ενεργοποιεί την αποτύπωση προσαρμοσμένων αντικειμένων. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Δεν αντιγράφει τίποτα, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή υποκατηγοριών με αντιγραφή. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής ανάθεσης. Δεν αντιγράφει τίποτα, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την κατασκευή υποκατηγοριών με αντιγραφή. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Ορίζει το γονικό αντικείμενο αυτού του [XmlSchemaObject](../xmlschemaobject/). |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Ορίζει τα διακριτά χαρακτηριστικά που δεν ανήκουν στον τρέχοντα χώρο ονομάτων στόχου του σχήματος. |
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Ορίζει το χαρακτηριστικό **value** του χαρακτηριστικού. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n-οστό όρισμα προτύπου ως αδύναμο δείκτη (αντί για κοινό). Επιτρέπει την αλλαγή δεικτών σε συλλογές σε αδυνατό τρόπο. |
...
|  [XmlSchemaMinInclusiveFacet](./xmlschemamininclusivefacet/)() | Αρχικοποιεί ένα νέο στιγμιότυπο της κλάσης [XmlSchemaMinInclusiveFacet](./). |
