...
description: Αντιπροσωπεύει το στοιχείο group από το XML Schema, όπως ορίζεται από το Παγκόσμιο Ιστό Consortium (W3C). Αυτή η κατηγορία ορίζει ομάδες σε επίπεδο schema που αναφέρονται από τους σύνθετους τύπους. Ομαδοποιεί ένα σύνολο δηλώσεων στοιχείων ώστε να μπορούν να ενσωματωθούν ως ομάδα σε ορισμούς σύνθετων τύπων.
type: docs
weight: 430
url: /el/system.xml.schema/xmlschemagroup/
---
## XmlSchemaGroup κατηγορία

Αντιπροσωπεύει το στοιχείο **group** από το XML [Schema](../) όπως ορίζεται από το Παγκόσμιο [Web](../../system.web/) Consortium (W3C). Αυτή η κατηγορία ορίζει ομάδες σε επίπεδο **schema** που αναφέρονται από τους σύνθετους τύπους. Ομαδοποιεί ένα σύνολο δηλώσεων στοιχείων ώστε να μπορούν να ενσωματωθούν ως ομάδα σε ορισμούς σύνθετων τύπων.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Returns the name of the schema group. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | Returns one of the [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/), or [XmlSchemaSequence](../xmlschemasequence/) classes. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Returns the qualified name of the schema group. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Sets the name of the schema group. |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\>\&) | Sets one of the [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/), or [XmlSchemaSequence](../xmlschemasequence/) classes. |
...
Τα αντικείμενα αυτής της κατηγορίας θα πρέπει να δημιουργούνται μόνο χρησιμοποιώντας τη συνάρτηση [System::MakeObject()](../../system/makeobject/). Ποτέ μην δημιουργείτε στιγμιότυπα αυτού του τύπου στην στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς αυτό θα οδηγήσει σε σφάλματα χρόνου εκτέλεσης και/ή σφάλματα ελέγχου. Πάντα τυλίξτε αυτή την κατηγορία σε δείκτη [System::SmartPtr](../../system/smartptr/) και χρησιμοποιήστε αυτόν τον δείκτη για να τον περάσετε σε συναρτήσεις ως όρισμα. 

## Δείτε επίσης

* Κατηγορία [XmlSchemaAnnotated](../xmlschemaannotated/)
