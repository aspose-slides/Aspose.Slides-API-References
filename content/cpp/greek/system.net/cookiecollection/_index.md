...
description: "Αντιπροσωπεύει μια λίστα ταξινομημένων cookies. Τα αντικείμενα αυτής της κλάσης πρέπει να καταλαμβάνονται μόνο χρησιμοποιώντας τη λειτουργία System::MakeObject() function. Ποτέ μην δημιουργείτε στιγμιότυπο αυτού του τύπου στη στοίβα ή χρησιμοποιώντας operator new, επειδή θα οδηγήσει σε σφάλματα χρόνου εκτέλεσης και/ή σφάλματα δήλωσης. Πάντα τυλίξτε αυτήν την κλάση σε δείκτη System::SmartPtr pointer και χρησιμοποιήστε αυτόν τον δείκτη για να το περάσετε σε functions ως argument."
type: docs
weight: 14
url: /el/system.net/cookiecollection/
---
## CookieCollection κλάση
...
| Method | Περιγραφή |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) override | Προσθέτει ένα cookie στη συλλογή. |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](./)\>) | Προσθέτει cookies από τη συγκεκριμένη συλλογή στην τρέχουσα. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Λαμβάνει έναν iterator που δείχνει το πρώτο στοιχείο (αν υπάρχει) της συλλογής. Αυτός ο iterator δεν μπορεί να χρησιμοποιηθεί για αλλαγή του αναφερόμενου αντικειμένου επειδή [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) επιστρέφει ένα αντίγραφο-αντικείμενο του T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Λαμβάνει έναν iterator που δείχνει το πρώτο στοιχείο (αν υπάρχει) της const-προσδιορισμένης εμφάνισης της συλλογής. |
...
| void [Clear](./clear/)() override | Αφαιρεί όλα τα cookies από τη συλλογή. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) const override | Ελέγχει αν η συλλογή περιέχει το συγκεκριμένο cookie. |
|  [CookieCollection](./cookiecollection/)() | Δημιουργεί ένα νέο στιγμιότυπο. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Λαμβάνει iterator που δείχνει ακριβώς μετά το τελευταίο στοιχείο (αν υπάρχει) της συλλογής. Αυτός ο iterator δεν μπορεί να χρησιμοποιηθεί για αλλαγή του αναφερόμενου αντικειμένου επειδή [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) επιστρέφει ένα αντίγραφο-αντικείμενο του T. |
...
| **int32_t** [get_Count](./get_count/)() const override | Λαμβάνει τον αριθμό των στοιχείων στη συλλογή. |
| **bool** [get_IsOtherVersionSeen](./get_isotherversionseen/)() | Επιστρέφει μια τιμή που υποδεικνύει αν η συλλογή περιέχει ένα cookie με έκδοση διαφορετική από [Cookie::MaxSupportedVersion](../cookie/maxsupportedversion/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\>\> [GetEnumerator](./getenumerator/)() override | Λαμβάνει enumerator. |
...
|  [ICollection](../../system.collections.generic/icollection/icollection/)() | Κατασκευάστης χωρίς παραμέτρους. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [idx_get](./idx_get/)(**int32_t**) | Επιστρέφει ένα cookie από τη συλλογή cookies στον καθορισμένο δείκτη. |
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [idx_get](./idx_get/)([String](../../system/string/)) | Επιστρέφει ένα cookie από τη συλλογή cookies με το καθορισμένο όνομα. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>) | Επιστρέφει το δείκτη του καθορισμένου cookie. |
| **int32_t** [InternalAdd](./internaladd/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>, **bool**) | Προσθέτει το καθορισμένο cookie στη συλλογή. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Δεν αντιγράφει τίποτα, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή των υποκατηγοριών. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) override | Αφαιρεί το καθορισμένο cookie από τη συλλογή. |
| void [RemoveAt](./removeat/)(**int32_t**) | Αφαιρεί ένα cookie στον καθορισμένο δείκτη. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Μειώνει τον μετρητή κοινών αναφορών κατά την καθορισμένη τιμή. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδυνατό δείκτη (αντί για κοινό). Επιτρέπει την αλλαγή δεικτών σε containers σε αδυνατό (weak) τρόπο. |
| int [SharedCount](../../system/object/sharedcount/)() const | Λαμβάνει την τρέχουσα τιμή του μετρητή κοινών αναφορών. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Αυξάνει τον μετρητή κοινών αναφορών. Δεν πρέπει να κλήεται απευθείας· αντί αυτού, χρησιμοποιήστε smart pointers ή ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Μειώνει και επιστρέφει τον μετρητή κοινών αναφορών. Δεν πρέπει να κλήεται απευθείας· αντί αυτού, χρησιμοποιήστε smart pointers ή ThisProtector. |
| [DateTime](../../system/datetime/) [TimeStamp](./timestamp/)([CookieCollection::Stamp](./stamp/)) | Ενημερώνει το timestamp σύμφωνα με το καθορισμένο σενάριο και επιστρέφει μια νέα τιμή. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το statement lock() της C# ξεκλείδωμα. Καλείται απευθείας ή χρησιμοποιήστε το αντικείμενο sentry [LockContext](../../system/lockcontext/). |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Λαμβάνει την υλοποίηση του const iterator begin για το τρέχον container. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Λαμβάνει την υλοποίηση του iterator begin για το τρέχον container. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Λαμβάνει την υλοποίηση του const iterator end για το τρέχον container. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Λαμβάνει την υλοποίηση του iterator end για το τρέχον container. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον αδυνατό μετρητή αναφοράς. Δεν πρέπει να κλήεται απευθείας· αντί αυτού, χρησιμοποιήστε smart pointers ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον αδυνατό μετρητή αναφοράς. Δεν πρέπει να κλήεται απευθείας· αντί αυτού, χρησιμοποιήστε smart pointers ή ThisProtector. |
...
| --- | --- |
| [Stamp](./stamp/) | Καταγράφει τις λειτουργίες ορισμού timestamp. |
