...
description: Μια πηγή token ακύρωσης που μπορεί να χρησιμοποιηθεί για την ενεργοποίηση ειδοποιήσεων ακύρωσης.
type: docs
weight: 40
url: /el/system.threading/cancellationtokensource/
---
## CancellationTokenSource κλάση

Μία πηγή token ακύρωσης που μπορεί να χρησιμοποιηθεί για την ενεργοποίηση ειδοποιήσεων ακύρωσης.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| void [Cancel](./cancel/)() | Επικοινωνεί ένα αίτημα ακύρωσης. |
|  [CancellationTokenSource](./cancellationtokensource/)() | Δημιουργεί ένα νέο [CancellationTokenSource](./). |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | Δημιουργεί μια συνδεδεμένη πηγή token που ακυρώνεται όταν ακυρωθεί οποιοδήποτε από τα παρεχόμενα tokens. |
| void [Dispose](./dispose/)() override | Απελευθερώνει όλους τους πόρους που χρησιμοποιεί το [CancellationTokenSource](./). |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Συγκρίνει αντικείμενα χρησιμοποιώντας τη σημασιολογία C# [Object.Equals](../../system/object/equals/). |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Συγκρίνει αντικείμενα τύπου αναφοράς σε στυλ C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Συγκρίνει αντικείμενα τύπου τιμής σε στυλ C#. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Εξομοιώνει σύγκριση αριθμών κινητής τεφράδας σε στυλ C# όπου δύο NaN θεωρούνται ίσα παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Εξομοιώνει σύγκριση αριθμών κινητής τεφράδας σε στυλ C# όπου δύο NaN θεωρούνται ίσα παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Μόνο για εσωτερικές χρήσεις. |
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | Λαμβάνει αν έχει ζητηθεί η ακύρωση. |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | Λαμβάνει το token ακύρωσης που σχετίζεται με αυτήν την πηγή. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την απεκλειδώρηση της δήλωσης C# lock(). Καλέστε άμεσα ή χρησιμοποιήστε το αντικείμενο φύλακα [LockContext](../../system/lockcontext/). |
...
Παρέχει μηχανισμούς για δημιουργία και έλεγχο token ακύρωσης για συνεργατική ακύρωση λειτουργιών. 
