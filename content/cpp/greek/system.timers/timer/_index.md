...
description: Χρονομετρητής που καλεί delegate σε βρόχο.
type: docs
weight: 14
url: /el/system.timers/timer/
---
## Timer κλάση


[Timer](./) που καλεί delegate σε βρόχο.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| void [Close](./close/)() | Σταματά το χρονομετρητή, ελευθερώνει τους δεσμευμένους πόρους. |
|  [Component](../../system.componentmodel/component/component/)() | πληροφορίες RTTI. |
| void [Dispose](./dispose/)() | Σταματά το χρονομετρητή, ελευθερώνει τους δεσμευμένους πόρους. |
| void [Dispose](../../system.componentmodel/component/dispose/)(**bool**) | Υποστήριξη του προτύπου Disposable· δεν κάνει τίποτα. |
...
| **bool** [get_AutoReset](./get_autoreset/)() const | Ελέγχει αν το χρονομετρητής βρίσκεται σε λειτουργία αυτόματης επαναρύθμισης. |
...
| **bool** [get_Enabled](./get_enabled/)() const | Ελέγχει αν το χρονομετρητής είναι ενεργός. |
| **double** [get_Interval](./get_interval/)() const | Λαμβάνει το διάστημα του χρονομέτρου. |
| **bool** [get_IsStopped](./get_isstopped/)() const | Ελέγχει αν το χρονομετρητής είναι σταματημένο. |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | Ορίζει το χρονομετρητή σε λειτουργία αυτόματης επαναρύθμισης ή έξω από αυτήν. |
| void [set_Enabled](./set_enabled/)(**bool**) | Ξεκινά ή σταματά το χρονομετρητή. Η έναρξη του χρονομέτρου δεν επανεκινά τη μέτρηση του χρόνου εάν εκτελείται ήδη. |
| void [set_Interval](./set_interval/)(**double**) | Ορίζει το διάστημα του χρονομέτρου. |
...
| void [Start](./start/)() | Ξεκινά το χρονομετρητή. Δεν επανεκκινεί τη μέτρηση του χρόνου εάν εκτελείται ήδη. |
| void [Stop](./stop/)() | Σταματά το χρονομετρητή. |
|  [Timer](./timer/)() | πληροφορίες RTTI. |
|  [Timer](./timer/)(**double**) | Δημιουργεί σταματημένο χρονομετρητή με το καθορισμένο διάστημα. |
