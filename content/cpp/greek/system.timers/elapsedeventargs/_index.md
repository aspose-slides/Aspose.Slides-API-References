...
description: Παράμετροι του συμβάντος χρονομέτρου.
type: docs
weight: 1
url: /el/system.timers/elapsedeventargs/
---
## ElapsedEventArgs κλάση

Παράμετροι του συμβάντος χρονομέτρου.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
|  [ElapsedEventArgs](./elapsedeventargs/)(**int32_t**, **int32_t**) | Δημιουργεί αντικείμενο παραμέτρων με τα δοσμένα παραμέτρους. |
...
| [DateTime](../../system/datetime/) [get_SignalTime](./get_signaltime/)() | Λαμβάνει τον χρόνο σήματος. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον αριθμό αδυνατών αναφορών. Δεν πρέπει να κληθεί άμεσα· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον αριθμό αδυνατών αναφορών. Δεν πρέπει να κληθεί άμεσα· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
...
| Πεδίο | Περιγραφή |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Ένα static μέλος που αντιπροσωπεύει έναν \"άδειο\" [EventArgs](../../system/eventargs/) κοινό δείκτη (null-pointer). |
