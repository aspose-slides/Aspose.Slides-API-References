...
description: Παρέχει πρόσβαση στο παρακάμπτον θέμα διαφάνειας σημειώσεων.
type: docs
weight: 534
...
Παρέχει πρόσβαση στη θεματική παραλλαγή των σημειώσεων διαφάνειας.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Εφαρμόζει επιπλέον χρωματικό σχήμα σε μία διαφάνεια. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../baseoverridethememanager/createthemeeffective/)() override | Επιστρέφει το αντικείμενο του θέματος. |
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Καθορίζει εάν το [OverrideTheme](../overridetheme/) παρακάμπτει το κληρονομικό ενεργό θέμα ή όχι. Για να ενεργοποιήσετε το [OverrideTheme](../overridetheme/) για παράκαμψη, χρησιμοποιήστε τις μεθόδους OverrideTheme.Init*(). Για να απενεργοποιήσετε το [OverrideTheme](../overridetheme/) από την παράκαμψη, χρησιμοποιήστε τη μέθοδο [OverrideTheme::Clear](../overridetheme/clear/). Μόνο-ανάγνωση **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | Επιστρέφει το αντικείμενο του παρακάμπτοντος θέματος. Διαβάστε [IOverrideTheme](../ioverridetheme/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator ανάθεσης. Δεν αντιγράφει τίποτα, στην πραγματικότητα, απλώς αρχικοποιεί νέο αντικείμενο και ενεργοποιεί τη δημιουργία υποκατηγοριών μέσω αντιγραφής. |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Επιστρέφει το αντικείμενο του παρακάμπτοντος θέματος. Γράψτε [IOverrideTheme](../ioverridetheme/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδυνατιστή δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε δοχεία σε αδυνατισμένη λειτουργία. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον αδυνατισμένο μετρητή αναφοράς. Δεν πρέπει να κληθεί άμεσα· αντίθετα, χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον αδυνατισμένο μετρητή αναφοράς. Δεν πρέπει να κληθεί άμεσα· αντίθετα, χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
