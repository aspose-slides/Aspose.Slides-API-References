...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | Καθορίζει εάν το [OverrideTheme](../overridetheme/) παρακάμπτει το κληρονομημένο ενεργό θέμα (Presentation.MasterTheme) ή όχι. Διάβασε **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() | Επιστρέφει το αντικείμενο του αντικαθιστούμενου θέματος. Διάβασε [IMasterTheme](../imastertheme/). |
...
| virtual void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) | Καθορίζει εάν το [OverrideTheme](../overridetheme/) παρακάμπτει το κληρονομημένο ενεργό θέμα (Presentation.MasterTheme) ή όχι. Γράψτε **bool**. |
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) | Επιστρέφει το αντικείμενο του αντικαθιστούμενου θέματος. Γράψτε [IMasterTheme](../imastertheme/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει τον n'th παράμετρο προτύπου ως αδυνατό δείκτη (αντί για κοινό). Επιτρέπει την εναλλαγή δεικτών σε συλλογές σε αδυνατό τρόπο. |
