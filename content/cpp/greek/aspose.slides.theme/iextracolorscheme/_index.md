...
description: Αντιπροσωπεύει ένα πρόσθετο χρωματικό σχήμα που μπορεί να εκχωρηθεί σε μια διαφάνεια.
type: docs
weight: 222
url: /el/aspose.slides.theme/iextracolorscheme/
---
## IExtraColorScheme κλάση


Αντιπροσωπεύει ένα πρόσθετο χρωματικό σχήμα που μπορεί να εκχωρηθεί σε μια διαφάνεια.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() | Επιστρέφει ένα χρωματικό σχήμα. Μόνο ανάγνωση [IColorScheme](../icolorscheme/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Επιστρέφει ένα όνομα αυτού του σχήματος. Μόνο ανάγνωση [System::String](../../system/string/). |
