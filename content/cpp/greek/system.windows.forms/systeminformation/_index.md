...
description: Ψεύτικη κλάση για να καταστεί ο μεταγλωτισμένος κώδικας που χρησιμοποιεί την κλάση SystemInformation συμβατός. Οι μέθοδοι δεν έχουν υλοποιηθεί. Αυτός είναι ένας στατικός τύπος χωρίς υπηρεσίες στιγμιοτύπου. Δεν πρέπει ποτέ να δημιουργείτε στιγμιότυπα του με οποιονδήποτε τρόπο.
type: docs
weight: 53
url: /el/system.windows.forms/systeminformation/
---
## SystemInformation struct

Ψεύτικη κλάση για να γίνει ο μεταγλωττισμένος κώδικας που χρησιμοποιεί την κλάση [SystemInformation](./) συμβατός. Οι μέθοδοι δεν έχουν υλοποιηθεί. Αυτός είναι ένας στατικός τύπος χωρίς υπηρεσίες στιγμιοτύπου. Δεν πρέπει ποτέ να δημιουργείτε στιγμιότυπα του με οποιονδήποτε τρόπο.
...
| static int [get_HorizontalFocusThickness](./get_horizontalfocusthickness/)() | NOT IMPLEMENTED. |
...
| static [System::Drawing::Size](../../system.drawing/size/) [get_MinimizedWindowSize](./get_minimizedwindowsize/)() | NOT IMPLEMENTED. |
...
| static int [get_VerticalScrollBarWidth](./get_verticalscrollbarwidth/)() | NOT IMPLEMENTED. |
...
* Χώρος ονομάτων [System::Windows::Forms](../)
