...
type: docs
weight: 53
url: /el/system.runtime.interopservices/osplatform/
---
## OSPlatform κλάση
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| static [OSPlatform](./) [Create](./create/)(const [String](../../system/string/)\&) |  |
| **bool** [Equals](./equals/)([OSPlatform](./)) override |  |
| virtual **bool** [Equals](../../system/iequatable/equals/)(T) | Καθορίζει εάν τα τρέχοντα και καθορισμένα αντικείμενα είναι ίσα. |
...
| static const [OSPlatform](./)\& [get_FreeBSD](./get_freebsd/)() |  |
| static const [OSPlatform](./)\& [get_Linux](./get_linux/)() |  |
| static const [OSPlatform](./)\& [get_OSX](./get_osx/)() |  |
| static const [OSPlatform](./)\& [get_Windows](./get_windows/)() |  |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αποτελεί μια παρουσία του τύπου που περιγράφεται από targetType. Αντίστοιχο του τελεστή C# 'is'. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και ενεργοποιεί την κατασκευή αντιγραφής των υποκατηγοριών. |
| **bool** [operator!=](./operator_not_equal/)(const [OSPlatform](./)\&) const |  |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής ανάθεσης. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και ενεργοποιεί την κατασκευή αντιγραφής των υποκατηγοριών. |
| **bool** [operator==](./operator_equal_equal/)(const [OSPlatform](./)\&) const |  |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδύναμη δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε συλλογές σε αδύναμη λειτουργία. |
