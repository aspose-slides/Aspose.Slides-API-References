...
| Μέθοδος | Περιγραφή |
| --- | --- |
|  [AssemblyName](./assemblyname/)() | Κατασκευαστής. |
|  [AssemblyName](./assemblyname/)(const [String](../../system/string/)\&) | Κατασκευαστής. |
|  [AssemblyName](./assemblyname/)(const [String](../../system/string/)\&, const [Version](../../system/version/)\&) | Κατασκευαστής. |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Λαμβάνει το όνομα της συναρμολόγησης. |
| [Version](../../system/version/) [get_Version](./get_version/)() | Λαμβάνει την έκδοση της συναρμολόγησης. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει εάν το αντικείμενο αντιπροσωπεύει ένα στιγμιότυπο τύπου που περιγράφεται από targetType. Αναλογικό του τελεστή C# 'is'. |
| void [Lock](../../system/object/lock/)() | Υλοποιεί το κλείδωμα της δήλωσης C# lock(). Καλείτε απευθείας ή χρησιμοποιήστε το αντικείμενο φύλαξης [LockContext](../../system/lockcontext/). |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Ορίζει το όνομα της συναρμολόγησης. |
| void [set_Version](./set_version/)(const [Version](../../system/version/)\&) | Ορίζει την έκδοση της συναρμολόγησης. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n-οστό όρισμα προτύπου ως αδυναμά δείκτη (αντί για κοινό). Επιτρέπει την εναλλαγή δεικτών σε containers σε αδυναμη λειτουργία. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκλείδωμα της δήλωσης C# lock(). Καλείτε απευθείας ή χρησιμοποιήστε το αντικείμενο φύλαξης [LockContext](../../system/lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον μετρητή αδυναμών αναφορών. Δεν πρέπει να κληθεί άμεσα· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον μετρητή αδυναμών αναφορών. Δεν πρέπει να κληθεί άμεσα· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
