...
description: Παρέχει την κατάσταση ολοκλήρωσης ενός παράλληλου βρόχου.
type: docs
weight: 14
url: /el/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult κλάση

Παρέχει την κατάσταση ολοκλήρωσης ενός [Parallel](../parallel/) βρόχου.
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Λαμβάνει αν ο βρόχος εκτελέστηκε πλήρως. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Λαμβάνει το χαμηλότερο δείκτη επανάληψης κατά τον οποίο προέκυψε διακοπή. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγράφου. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει τη δημιουργία αντιγράφων των υποκατηγοριών. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Δημιουργεί ένα [ParallelLoopResult](./). |
...
Αναπαριστά το αποτέλεσμα μιας παράλληλης λειτουργίας βρόχου, συμπεριλαμβανομένου του αν ολοκληρώθηκε και πληροφορίες για τις διακοπές.
