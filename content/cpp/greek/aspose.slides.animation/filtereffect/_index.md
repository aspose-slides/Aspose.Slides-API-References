...
|  [FilterEffect](./filtereffect/)() | Κατασκευαστής προεπιλογής. |
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../behavior/get_accumulate/)() override | Αναπαριστά αν οι συμπεριφορές animation συγκεντρώνονται. Διαβάστε [NullableBool](../../aspose.slides/nullablebool/). |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | Αναπαριστά αν η τρέχουσα συμπεριφορά animation συνδυάζεται με άλλες ενεργές animations. Διαβάστε [BehaviorAdditiveType](../behavioradditivetype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](../behavior/get_properties/)() override | Αναπαριστά τις ιδιότητες της συμπεριφοράς. Μόνο ανάγνωση [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| [FilterEffectRevealType](../filtereffectrevealtype/) [get_Reveal](./get_reveal/)() override | Αναπαριστά ότι το εφέ με τη συμπεριφορά πρέπει να αποκαλύπτεται (in/out). Διαβάστε [FilterEffectRevealType](../filtereffectrevealtype/). |
| [FilterEffectSubtype](../filtereffectsubtype/) [get_Subtype](./get_subtype/)() override | Αναπαριστά τον υποτύπο του εφέ φίλτρου. Διαβάστε [FilterEffectSubtype](../filtereffectsubtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | Αναπαριστά τις ιδιότητες χρονισμού για τη συμπεριφορά του εφέ. Διαβάστε [ITiming](../itiming/). |
| [FilterEffectType](../filtereffecttype/) [get_Type](./get_type/)() override | Αναπαριστά τον τύπο του εφέ φίλτρου. Διαβάστε [FilterEffectType](../filtereffecttype/). |
...
| void [set_Accumulate](../behavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | Αναπαριστά αν οι συμπεριφορές animation συγκεντρώνονται. Γράψτε [NullableBool](../../aspose.slides/nullablebool/). |
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Αναπαριστά αν η τρέχουσα συμπεριφορά animation συνδυάζεται με άλλες ενεργές animations. Γράψτε [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_Reveal](./set_reveal/)([FilterEffectRevealType](../filtereffectrevealtype/)) override | Αναπαριστά ότι το εφέ με τη συμπεριφορά πρέπει να αποκαλύπτεται (in/out). Γράψτε [FilterEffectRevealType](../filtereffectrevealtype/). |
| void [set_Subtype](./set_subtype/)([FilterEffectSubtype](../filtereffectsubtype/)) override | Αναπαριστά τον υποτύπο του εφέ φίλτρου. Γράψτε [FilterEffectSubtype](../filtereffectsubtype/). |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Αναπαριστά τις ιδιότητες χρονισμού για τη συμπεριφορά του εφέ. Γράψτε [ITiming](../itiming/). |
| void [set_Type](./set_type/)([FilterEffectType](../filtereffecttype/)) override | Αναπαριστά τον τύπο του εφέ φίλτρου. Γράψτε [FilterEffectType](../filtereffecttype/). |
...
* Κλάση [IFilterEffect](../ifiltereffect/)
