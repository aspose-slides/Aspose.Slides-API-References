...
Αναπαριστά ένα εφέ συνόλου για μια συμπεριφορά animation.
...
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../behavior/get_accumulate/)() override | Αναπαριστά αν οι συμπεριφορές animation συσσωρεύονται. Ανάγνωση [NullableBool](../../aspose.slides/nullablebool/). |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | Αναπαριστά αν η τρέχουσα συμπεριφορά animation συνδυάζεται με άλλες εκτελούμενες κινήσεις. Ανάγνωση [BehaviorAdditiveType](../behavioradditivetype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | Αναπαριστά ιδιότητες χρονομέτρησης για τη συμπεριφορά του εφέ. Ανάγνωση [ITiming](../itiming/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_To](./get_to/)() override | Καθορίζει το συγκεκριμένο χαρακτηριστικό ενός εφφέ μετά ένα εφέ κίνησης. Αναπαριστά τιμή σημείου. Μόνο: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Ανάγνωση [System::Object](../../system/object/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Ελέγχει αν το αντικείμενο αναπαριστά μια παρουσία τύπου που περιγράφεται από targetType. Αναλογικό του τελεστή C# 'is'. |
...
| void [set_Accumulate](../behavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | Αναπαριστά αν οι συμπεριφορές animation συσσωρεύονται. Εγγραφή [NullableBool](../../aspose.slides/nullablebool/). |
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Αναπαριστά αν η τρέχουσα συμπεριφορά animation συνδυάζεται με άλλες εκτελούμενες κινήσεις. Εγγραφή [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Αναπαριστά ιδιότητες χρονομέτρησης για τη συμπεριφορά του εφέ. Εγγραφή [ITiming](../itiming/). |
| void [set_To](./set_to/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Καθορίζει το συγκεκριμένο χαρακτηριστικό ενός εφφέ μετά ένα εφέ κίνησης. Αναπαριστά τιμή σημείου. Μόνο: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Εγγραφή [System::Object](../../system/object/). |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον αδύνατο μετρητή αναφοράς. Δεν πρέπει να κληθεί απευθείας· αντί αυτού, χρησιμοποιήστε έξυπνους δείκτους ή ThisProtector. |
