...
| virtual **float** [get_Value0](./get_value0/)() | Ορίζει την πρώτη τιμή της μετατόπισης. Ανάγνωση **float**. |
| virtual **float** [get_Value1](./get_value1/)() | Ορίζει τη δεύτερη τιμή της μετατόπισης. Ανάγνωση **float**. |
| virtual **float** [get_Value2](./get_value2/)() | Ορίζει την τρίτη τιμή της μετατόπισης. Ανάγνωση **float**. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το statement lock() της C# για κλείδωμα. Καλείται άμεσα ή χρησιμοποιεί το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
...
| virtual void [set_Value0](./set_value0/)(**float**) | Ορίζει την πρώτη τιμή της μετατόπισης. Εγγραφή **float**. |
| virtual void [set_Value1](./set_value1/)(**float**) | Ορίζει τη δεύτερη τιμή της μετατόπισης. Εγγραφή **float**. |
| virtual void [set_Value2](./set_value2/)(**float**) | Ορίζει την τρίτη τιμή της μετατόπισης. Εγγραφή **float**. |
