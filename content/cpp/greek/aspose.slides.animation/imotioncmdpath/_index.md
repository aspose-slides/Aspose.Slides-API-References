...
| virtual [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() | Καθορίζει τον τύπο εντολής. Ανάγνωση [MotionCommandPathType](../motioncommandpathtype/). |
| virtual **bool** [get_IsRelative](./get_isrelative/)() | Καθορίζει αν οι συντεταγμένες της εντολής είναι σχετικές ή όχι. Ανάγνωση **bool**. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | Καθορίζει τα σημεία της εντολής. Ανάγνωση [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| virtual [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() | Καθορίζει τύπο σημείων εντολής. Ανάγνωση [MotionPathPointsType](../motionpathpointstype/). |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το statement lock() της C# για κλείδωμα. Κλήση άμεσα ή χρήση του αντικειμένου εποπτείας [LockContext](../../system/lockcontext/). |
...
| virtual void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) | Καθορίζει τον τύπο εντολής. Εγγραφή [MotionCommandPathType](../motioncommandpathtype/). |
| virtual void [set_IsRelative](./set_isrelative/)(**bool**) | Καθορίζει αν οι συντεταγμένες της εντολής είναι σχετικές ή όχι. Εγγραφή **bool**. |
| virtual void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) | Καθορίζει τα σημεία της εντολής. Εγγραφή [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| virtual void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) | Καθορίζει τον τύπο σημείων εντολής. Εγγραφή [MotionPathPointsType](../motionpathpointstype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n-ό όρισμα προτύπου ως αδυνατό δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε συλλογές σε αδυνατό τρόπο. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί την αποδέσμευση του statement lock() της C#. Κλήση άμεσα ή χρήση του αντικειμένου εποπτείας [LockContext](../../system/lockcontext/). |
