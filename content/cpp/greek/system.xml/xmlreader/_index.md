...
description: Αντιπροσωπεύει έναν αναγνώστη που παρέχει γρήγορη, χωρίς προσωρινή αποθήκευση, προσπέλαση μόνο προς τα εμπρός στα δεδομένα XML.
type: docs
weight: 430
url: /el/system.xml/xmlreader/
---
## XmlReader κλάση
