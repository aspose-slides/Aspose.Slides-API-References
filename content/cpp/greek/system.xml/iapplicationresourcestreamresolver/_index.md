...
description: Αναπαριστά έναν επιλυτή ροής πόρων εφαρμογής.
type: docs
weight: 14
url: /el/system.xml/iapplicationresourcestreamresolver/
---
## IApplicationResourceStreamResolver κλάση

Αναπαριστά έναν επιλυτή ροής πόρων εφαρμογής.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetApplicationResourceStream](./getapplicationresourcestream/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Επιστρέφει μια ροή πόρων εφαρμογής από το καθορισμένο URI. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n-οστό όρισμα προτύπου ως αδυνατό δείκτη (αντί για κοινόχρηστο). Επιτρέπει την εναλλαγή δεικτών σε containers σε αδυνατό τρόπο. |
