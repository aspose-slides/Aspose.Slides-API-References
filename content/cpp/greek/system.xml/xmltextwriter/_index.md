...
description: Αντιπροσωπεύει έναν συγγραφέα που παρέχει έναν γρήγορο, μη αποθηκευμένο στην κρυφή μνήμη, μονόδρομο τρόπο δημιουργίας ροών ή αρχείων που περιέχουν δεδομένα XML που συμμορφώνονται με το W3C Extensible Markup Language (XML) 1.0 και τις προτάσεις Namespaces in XML.
type: docs
weight: 521
url: /el/system.xml/xmltextwriter/
---
## XmlTextWriter κλάση

Αντιπροσωπεύει έναν συγγραφέα που παρέχει έναν γρήγορο, μη αποθηκευμένο στην κρυφή μνήμη, μονόδρομο τρόπο δημιουργίας ροών ή αρχείων που περιέχουν δεδομένα XML που συμμορφώνονται με το W3C Extensible Markup Language (XML) 1.0 και τις προτάσεις Namespaces in XML.
...
| Τύπος | Περιγραφή |
| --- | --- |
| [Ptr](./ptr/) | Ένα ψευδώνυμο για κοινόχρηστη δείκτη σε μια περίπτωση αυτής της κλάσης. |
## Παρατηρήσεις

Συνιστάται η χρήση της κλάσης [XmlWriter](../xmlwriter/) αντί αυτού. 

Τα αντικείμενα αυτής της κλάσης πρέπει να εκχωρούνται μόνο με τη συνάρτηση [System::MakeObject()](../../system/makeobject/). Ποτέ μην δημιουργείτε περιπτώσεις αυτού του τύπου στη στοίβα ή με τον τελεστή new, καθώς αυτό θα προκαλέσει σφάλματα χρόνου εκτέλεσης και/ή σφάλματα αστοχίας. Πάντα τυλίξτε αυτή την κλάση σε δείκτη [System::SmartPtr](../../system/smartptr/) και χρησιμοποιήστε αυτόν τον δείκτη για να τον περάσετε στις συναρτήσεις ως όρισμα. 
