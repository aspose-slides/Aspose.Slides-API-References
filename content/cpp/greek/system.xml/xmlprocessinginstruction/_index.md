...
description: Αναπαριστά μια οδηγία επεξεργασίας, η οποία ορίζεται από το XML για να διατηρεί πληροφορίες ειδικές για επεξεργαστή στο κείμενο του εγγράφου.
type: docs
weight: 404
url: /el/system.xml/xmlprocessinginstruction/
---
## XmlProcessingInstruction κλάση

Αναπαριστά μια οδηγία επεξεργασίας, η οποία ορίζεται από το XML για να διατηρεί πληροφορίες ειδικές για τον επεξεργαστή στο κείμενο του εγγράφου.
...
Τα αντικείμενα αυτής της κλάσης πρέπει να εκχωρούνται μόνο χρησιμοποιώντας τη συνάρτηση [System::MakeObject()](../../system/makeobject/). Ποτέ μη δημιουργείτε στιγμιότυπα αυτού του τύπου στη στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς αυτό θα προκαλέσει σφάλματα χρόνου εκτέλεσης και/ή σφαλματα ισχυρισμού. Πάντα να τυλίγετε αυτήν την κλάση σε δείκτη [System::SmartPtr](../../system/smartptr/) και χρησιμοποιείτε αυτόν τον δείκτη για να το περάσετε σε συναρτήσεις ως παράμετρο.
