...
description: "Αντιπροσωπεύει λευκό διάστημα μεταξύ σήμανσης σε έναν κόμβο μεικτού περιεχομένου ή λευκό διάστημα μέσα σε περιοχή xml:space='preserve'. Αυτό επίσης αναφέρεται ως σημαντικό λευκό διάστημα."
type: docs
weight: 482
url: /el/system.xml/xmlsignificantwhitespace/
---
## XmlSignificantWhitespace κλάση

Αναπαριστά λευκό διάστημα μεταξύ σήμανσης σε έναν κόμβο μεικτού περιεχομένου ή λευκό διάστημα μέσα σε περιοχή **xml:space='preserve'**. Αυτό αναφέρεται επίσης ως σημαντικό λευκό διάστημα.
...
Τα αντικείμενα αυτής της κλάσης θα πρέπει να εκχωρούνται μόνο χρησιμοποιώντας τη συνάρτηση [System::MakeObject()](../../system/makeobject/). Ποτέ μην δημιουργείτε στιγμές αυτού του τύπου στη στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς θα προκαλέσει σφάλματα χρόνου εκτέλεσης και/ή αποτυχίες ελέγχου. Πάντα να τυλίγετε αυτήν την κλάση σε δείκτη [System::SmartPtr](../../system/smartptr/) και να χρησιμοποιείτε αυτόν τον δείκτη για να τον περάσετε σε συναρτήσεις ως όρισμα.
