---
title: IXmlNamespaceResolver
second_title: Aspose.Slides για C++ API Αναφορά
description: Παρέχει πρόσβαση μόνο για ανάγνωση σε σύνολο αντιστοιχίσεων προθεμάτων και χώρων ονομάτων.
type: docs
weight: 53
url: /el/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver κλάση

Παρέχει πρόσβαση μόνο για ανάγνωση σε σύνολο αντιστοιχίσεων προθεμάτων και χώρων ονομάτων.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](./getnamespacesinscope/)([XmlNamespaceScope](../xmlnamespacescope/)) | Επιστρέφει μια συλλογή των ορισμένων αντιστοιχίσεων προθεμάτων-χώρων ονομάτων που είναι αυτή τη στιγμή εντός εμβέλειας. |
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | Επιστρέφει το URI του χώρου ονομάτων που αντιστοιχίζεται στο συγκεκριμένο πρόθεμα. |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | Επιστρέφει το πρόθεμα που αντιστοιχίζεται στο συγκεκριμένο URI χώρου ονομάτων. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n-οστό όρισμα προτύπου ως αδύνατο δείκτη (αντί για κοινόχρηστο). Επιτρέπει την αλλαγή δεικτών σε συγκεντρώματα σε αδύναμη λειτουργία. |
