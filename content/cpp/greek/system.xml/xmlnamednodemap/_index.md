...
description: Αντιπροσωπεύει μια συλλογή κόμβων που μπορούν να προσπελαστούν κατά όνομα ή δείκτη.
type: docs
weight: 287
url: /el/system.xml/xmlnamednodemap/
---
## XmlNamedNodeMap κλάση


Αντιπροσωπεύει μια συλλογή κόμβων που μπορούν να προσπελαστούν κατά όνομα ή δείκτη.
