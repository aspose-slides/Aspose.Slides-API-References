...
description: Παρέχει μια διεπαφή που επιτρέπει σε μια κλάση να επιστρέφει πληροφορίες γραμμής και θέσης.
type: docs
weight: 40
url: /el/system.xml/ixmllineinfo/
---
## IXmlLineInfo κλάση


Παρέχει μια διεπαφή που επιτρέπει σε μια κλάση να επιστρέφει πληροφορίες γραμμής και θέσης.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Επιστρέφει τον τρέχοντα αριθμό γραμμής. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Επιστρέφει τη θέση της τρέχουσας γραμμής. |
...
| virtual **bool** [HasLineInfo](./haslineinfo/)() | Επιστρέφει μια τιμή που δείχνει εάν η κλάση μπορεί να επιστρέψει πληροφορίες γραμμής. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Δεν αντιγράφει τίποτα, στην ουσία, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή κατασκευής υποκατηγοριών. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεσ operator ανάθεσης. Δεν αντιγράφει τίποτα, στην ουσία, απλώς αρχικοποιεί νέο αντικείμενο και επιτρέπει την αντιγραφή κατασκευής υποκατηγοριών. |
