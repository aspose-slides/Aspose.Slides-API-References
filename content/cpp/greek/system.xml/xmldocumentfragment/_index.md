...
description: Αντιπροσωπεύει ένα ελαφρύ αντικείμενο που είναι χρήσιμο για λειτουργίες εισαγωγής σε δέντρο.
type: docs
weight: 196
url: /el/system.xml/xmldocumentfragment/
---
## XmlDocumentFragment κλάση

Αυτή η κλάση αντιπροσωπεύει ένα ελαφρύ αντικείμενο που είναι χρήσιμο για λειτουργίες εισαγωγής σε δέντρο.
...
| Typedef | Περιγραφή |
| --- | --- |
| [Ptr](./ptr/) | Ένα ψευδώνυμο για κοινόχρηστο δείκτη σε μια ύπαρξη αυτής της κλάσης. |
