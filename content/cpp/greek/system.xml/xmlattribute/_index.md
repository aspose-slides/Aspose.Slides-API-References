...
description: Αναπαριστά ένα γνώρισμα. Οι έγκυρες και προεπιλεγμένες τιμές για το γνώρισμα ορίζονται σε έναν ορισμό τύπου εγγράφου (DTD) ή σε σχήμα.
type: docs
weight: 79
url: /el/system.xml/xmlattribute/
---
## XmlAttribute κλάση

Αναπαριστά ένα γνώρισμα. Οι έγκυρες και προεπιλεγμένες τιμές για το γνώρισμα ορίζονται σε έναν ορισμό τύπου εγγράφου (DTD) ή σε σχήμα.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Gets iterator pointing to the first element (if any) of the collection. |
