...
description: "Χαρτογράφηση μιας συμβολοσειράς στο κλειδί ταξινόμησης. Τα αντικείμενα αυτής της κλάσης πρέπει να κατανεμηθούν μόνο χρησιμοποιώντας τη συνάρτηση System::MakeObject(). Ποτέ μην δημιουργείτε εμφώλευση αυτού του τύπου στη στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς θα οδηγήσει σε σφάλματα χρόνου εκτέλεσης και/ή σφαλματα assertion. Πάντα τυλίξτε αυτήν την κλάση σε δείκτη System::SmartPtr και χρησιμοποιήστε αυτόν τον δείκτη για να τον περάσετε σε συναρτήσεις ως όρισμα."
type: docs
weight: 287
url: /el/system.globalization/sortkey/
---
## SortKey κλάση

Χαρτογράφηση ενός συμβολοσειράς στο κλειδί ταξινόμησής του. Τα αντικείμενα αυτής της κλάσης πρέπει να κατανεμηθούν μόνο χρησιμοποιώντας τη συνάρτηση [System::MakeObject()](../../system/makeobject/). Ποτέ μην δημιουργείτε εμφώλευση αυτού του τύπου στη στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς θα οδηγήσει σε σφάλματα χρόνου εκτέλεσης και/ή σφαλματα assertion. Πάντα τυλίξτε αυτήν την κλάση σε δείκτη [System::SmartPtr](../../system/smartptr/) και χρησιμοποιήστε αυτόν τον δείκτη για να τη μεταβιβάσετε σε συναρτήσεις ως όρισμα.
...
| Method | Περιγραφή |
| --- | --- |
| static int [Compare](./compare/)(const [SortKeyPtr](../sortkeyptr/)\&, const [SortKeyPtr](../sortkeyptr/)\&) | Συγκρίνει δύο κλειδιά ταξινόμησης. |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Ελέγχει αν το καθορισμένο αντικείμενο είναι ίσο με το τρέχον αντικείμενο [SortKey](./). |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Συγκρίνει αντικείμενα χρησιμοποιώντας τη σημασία C# [Object.Equals](../../system/object/equals/). |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_KeyData](./get_keydata/)() | Λαμβάνει τον πίνακα byte που αντιπροσωπεύει το τρέχον αντικείμενο. |
| virtual [String](../../system/string/) [get_OriginalString](./get_originalstring/)() | Λαμβάνει το αρχικό συμβολοσειρά που χρησιμοποιήθηκε για τη δημιουργία αυτού του αντικειμένου. |
...
| int [GetHashCode](./gethashcode/)() const override | Λαμβάνει τον κωδικό κατακερματισμού για το τρέχον αντικείμενο [SortKey](./). |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Μετατρέπει το τρέχον αντικείμενο στην συμβολοσειρά του. |
