...
description: "Παρέχει πληροφορίες σχετικά με την έκδοση Unicode που χρησιμοποιείται για τη σύγκριση και την ταξινόμηση συμβολοσειρών. Τα αντικείμενα αυτής της κλάσης πρέπει να δημιουργούνται μόνο χρησιμοποιώντας τη συνάρτηση System::MakeObject(). Ποτέ μην δημιουργείτε αντικείμενο αυτού του τύπου στη στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς θα προκαλέσει σφάλματα χρόνου εκτέλεσης και/ή σφάλματα ασυμφωνίας. Πάντα τυλίξτε αυτήν την κλάση σε δείκτη System::SmartPtr και χρησιμοποιήστε αυτόν το δείκτη για να το μεταβιβάσετε στις συναρτήσεις ως όρισμα."
type: docs
weight: 300
url: /el/system.globalization/sortversion/
---
## SortVersion κλάση

Παρέχει πληροφορίες σχετικά με την έκδοση Unicode που χρησιμοποιείται για τη σύγκριση και την ταξινόμηση συμβολοσειρών. Τα αντικείμενα αυτής της κλάσης πρέπει να δημιουργούνται μόνο χρησιμοποιώντας τη λειτουργία [System::MakeObject()](../../system/makeobject/). Ποτέ μην δημιουργείτε εμφάνισμα αυτού του τύπου στη στοίβα ή χρησιμοποιώντας τον τελεστή new, καθώς αυτό θα προκαλέσει σφάλματα χρόνου εκτέλεσης και/ή σφάλματα ασυμφωνίας. Πάντα τυλίξτε αυτήν την κλάση σε δείκτη [System::SmartPtr](../../system/smartptr/) και χρησιμοποιήστε αυτόν τον δείκτη για να τη μεταβιβάζετε σε λειτουργίες ως όρισμα.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[SortVersion](./)\>) override | Ελέγχει εάν η τρέχουσα παρουσία [SortVersion](./) είναι ίση με ένα καθορισμένο αντικείμενο [SortVersion](./). |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Ελέγχει εάν η τρέχουσα παρουσία [SortVersion](./) είναι ίση με ένα καθορισμένο αντικείμενο [SortVersion](./). |
...
| int [get_FullVersion](./get_fullversion/)() | Λαμβάνει τον πλήρη αριθμό έκδοσης. |
| [Guid](../../system/guid/) [get_SortId](./get_sortid/)() | Λαμβάνει μοναδικό αναγνωριστικό για αυτό το αντικείμενο. |
...
| int [GetHashCode](./gethashcode/)() const override | Λαμβάνει τον κώδικα κατακερματισμού για το τρέχον αντικείμενο. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Κατασκευαστής αντιγραφής. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και ενεργοποιεί την κατασκευή αντιγράφων των υποκατηγοριών. |
| **bool** [operator!=](./operator_not_equal/)(const [SortVersion](./)\&) | Ελέγχει εάν η τρέχουσα παρουσία [SortVersion](./) δεν είναι ίση με ένα καθορισμένο αντικείμενο [SortVersion](./). |
| [SortVersion](./)\& [operator=](./operator_equal/)(const [SortVersion](./)\&) |  |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Τελεστής ανάθεσης. Στην πραγματικότητα δεν αντιγράφει τίποτα, απλώς αρχικοποιεί νέο αντικείμενο και ενεργοποιεί την κατασκευή αντιγράφων των υποκατηγοριών. |
| **bool** [operator==](./operator_equal_equal/)(const [SortVersion](./)\&) | Ελέγχει εάν η τρέχουσα παρουσία [SortVersion](./) είναι ίση με ένα καθορισμένο αντικείμενο [SortVersion](./). |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Συγκρίνει αντικείμενα με βάση την αναφορά. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Συγκρίνει αντικείμενα με βάση την αναφορά. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Συγκρίνει με αναφορά αντικείμενα τύπου τιμής με nullptr. |
...
|  [SortVersion](./sortversion/)(int, const [Guid](../../system/guid/)\&) | Πληροφορίες RTTI. |
