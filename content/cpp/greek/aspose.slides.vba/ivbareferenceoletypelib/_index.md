...
description: Αναπαριστά την αναφορά βιβλιοθήκης τύπου OLE Automation.
type: docs
weight: 105
url: /el/aspose.slides.vba/ivbareferenceoletypelib/
---
## IVbaReferenceOleTypeLib κλάση
...
| virtual [System::String](../../system/string/) [get_Libid](./get_libid/)() | Αναπαριστά το αναγνωριστικό μιας βιβλιοθήκης τύπου Automation. Διαβάστε [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | Αναπαριστά το όνομα της αναφοράς έργου VBA. Διαβάστε [System::String](../../system/string/). |
...
| virtual void [set_Libid](./set_libid/)([System::String](../../system/string/)) | Αναπαριστά το αναγνωριστικό μιας βιβλιοθήκης τύπου Automation. Γράψτε [System::String](../../system/string/). |
| virtual void [set_Name](../ivbareference/set_name/)([System::String](../../system/string/)) | Αναπαριστά το όνομα της αναφοράς έργου VBA. Γράψτε [System::String](../../system/string/). |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Αυξάνει τον μετρητή κοινόχρηστων αναφορών. Δεν πρέπει να καλείται άμεσα· χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Μειώνει και επιστρέφει τον μετρητή κοινόχρηστων αναφορών. Δεν πρέπει να καλείται άμεσα· χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον μετρητή αδύναμων αναφορών. Δεν πρέπει να καλείται άμεσα· χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον μετρητή αδύναμων αναφορών. Δεν πρέπει να καλείται άμεσα· χρησιμοποιήστε έξυπνα δείκτες ή ThisProtector. |
