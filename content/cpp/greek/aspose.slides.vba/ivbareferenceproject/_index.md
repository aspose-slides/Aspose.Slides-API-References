...
description: Αναπαριστά αναφορά σε εξωτερικό έργο VBA.
type: docs
weight: 118
url: /el/aspose.slides.vba/ivbareferenceproject/
---
## IVbaReferenceProject κλάση
...
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | Αντιπροσωπεύει το όνομα της αναφοράς του έργου VBA. Ανάγνωση [System::String](../../system/string/). |
...
| virtual void [set_Name](../ivbareference/set_name/)([System::String](../../system/string/)) | Αντιπροσωπεύει το όνομα της αναφοράς του έργου VBA. Εγγραφή [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα προτύπου ως αδυνατιστή δείκτη (αντί για κοινό). Επιτρέπει την εναλλαγή δεικτών σε containers σε αδύνατη λειτουργία. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Αυξάνει τον μετρητή αδυνατιστών αναφορών. Δεν πρέπει να καλείται απευθείας· χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Μειώνει τον μετρητή αδυνατιστών αναφορών. Δεν πρέπει να καλείται απευθεία· χρησιμοποιήστε έξυπνους δείκτες ή ThisProtector. |
