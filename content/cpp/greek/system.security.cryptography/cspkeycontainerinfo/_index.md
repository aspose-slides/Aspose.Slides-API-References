...
description: Πρόσθετες πληροφορίες σχετικά με ένα ζεύγος κρυπτογραφικών κλειδιών.
type: docs
weight: 66
url: /el/system.security.cryptography/cspkeycontainerinfo/
---
## CspKeyContainerInfo κλάση

Πρόσθετες πληροφορίες σχετικά με ένα ζεύγος κρυπτογραφικών κλειδιών.
...
| Μέθοδος | Περιγραφή |
| --- | --- |
|  [CspKeyContainerInfo](./cspkeycontainerinfo/)(const [SharedPtr](../../system/sharedptr/)\<[CspParameters](../cspparameters/)\>\&) | Κατασκευαστής. |
...
| **bool** [get_Accessible](./get_accessible/)() const | Επιστρέφει σημαία που υποδεικνύει αν ένα κλειδί σε ένα κοντέινερ είναι προσβάσιμο. |
| **bool** [get_Exportable](./get_exportable/)() const | Επιστρέφει σημαία που υποδεικνύει αν ένα κλειδί μπορεί να εξαχθεί από ένα κοντέινερ. |
| **bool** [get_HardwareDevice](./get_hardwaredevice/)() const | Επιστρέφει σημαία που υποδεικνύει αν ένα κλειδί είναι υλικό κλειδί. |
| [String](../../system/string/) [get_KeyContainerName](./get_keycontainername/)() const | Επιστρέφει το όνομα του κοντέινερ κλειδιού. |
| [SharedPtr](../../system/sharedptr/)\<[KeyNumber](../keynumber/)\> [get_KeyNumber](./get_keynumber/)() const | Επιστρέφει ένα αντικείμενο KeyNumber. |
| **bool** [get_MachineKeyStore](./get_machinekeystore/)() const | Επιστρέφει σημαία που υποδεικνύει αν ένα κλειδί είναι φορτωμένο από το αποθηκευτικό μηχάνημα κλειδιών. |
| **bool** [get_Protected](./get_protected/)() const | Επιστρέφει σημαία που υποδεικνύει αν ένα κλειδί προστατεύεται από αντιγραφή. |
| [String](../../system/string/) [get_ProviderName](./get_providername/)() const | Επιστρέφει το όνομα του παρόχου. |
| **int32_t** [get_ProviderType](./get_providertype/)() const | Επιστρέφει τον τύπο του παρόχου. |
| **bool** [get_RandomlyGenerated](./get_randomlygenerated/)() const | Επιστρέφει σημαία που υποδεικνύει αν ένα κλειδί δημιουργήθηκε τυχαία. |
| **bool** [get_Removable](./get_removable/)() const | Επιστρέφει σημαία που υποδεικνύει αν ένα κλειδί μπορεί να αφαιρεθεί από ένα κοντέινερ. |
| [String](../../system/string/) [get_UniqueKeyContainerName](./get_uniquekeycontainername/)() const | Επιστρέφει ένα μοναδικό όνομα κοντέινερ. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Συγκρίνει αναφορά ενός αντικειμένου τιμής με nullptr. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ορίζει το n'th όρισμα του προτύπου ως αδύναμο δείκτη (αντί για κοινό). Επιτρέπει την εναλλαγή δεικτών σε κοντέινερ σε αδύναμη λειτουργία. |
