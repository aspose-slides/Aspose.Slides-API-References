...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Προσομοιώνει τη σύγκριση κινητών σημείων σε στυλ C# όπου δύο NaN θεωρούνται ίσα, παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Προσομοιώνει τη σύγκριση κινητών σημείων σε στυλ C# όπου δύο NaN θεωρούνται ίσα, παρόλο που σύμφωνα με IEC 60559:1989 το NaN δεν είναι ίσο με καμία τιμή, συμπεριλαμβανομένου του NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Μόνο για εσωτερική χρήση. |
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromFriendlyName](./fromfriendlyname/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Δημιουργεί αντικείμενο OID από το καθορισμένο φιλικό όνομα OID. |
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromOidValue](./fromoidvalue/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Δημιουργεί αντικείμενο OID από την καθορισμένη τιμή OID. |
| [String](../../system/string/) [get_FriendlyName](./get_friendlyname/)() const | Παίρνει το φιλικό όνομα του αντικειμένου. |
| [String](../../system/string/) [get_Value](./get_value/)() const | Παίρνει τη συμβολοσειρά ταυτοποιητή του αντικειμένου. |
...
| void [Lock](../../system/object/lock/)() | Υλοποιεί το κλείδωμα της δήλωσης C# lock(). Καλέστε το απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
...
|  [Oid](./oid/)() | Κατασκευαστής προεπιλογής. |
|  [Oid](./oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](./)\>\&) | Κατασκευαστής αντιγραφής. |
|  [Oid](./oid/)(const [String](../../system/string/)\&) | Κατασκευαστής. |
|  [Oid](./oid/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Κατασκευαστής. |
...
| void [set_FriendlyName](./set_friendlyname/)(const [String](../../system/string/)\&) | Ορίζει το φιλικό όνομα του αντικειμένου. |
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Ορίζει τη συμβολοσειρά ταυτοποιητή του αντικειμένου. |
...
| void [Unlock](../../system/object/unlock/)() | Υλοποιεί το ξεκλείδωμα της δήλωσης C# lock(). Καλέστε το απευθείας ή χρησιμοποιήστε το αντικείμενο φρουρού [LockContext](../../system/lockcontext/). |
