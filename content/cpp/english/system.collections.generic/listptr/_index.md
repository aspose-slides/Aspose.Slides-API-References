...
|  [ListPtr](./listptr/)(const [SharedPtr](../../system/sharedptr/)\<[List](../list/)\<T\>\>\&) | Initializes pointer to specified list. |
...
| **bool** [operator==](./operator_equal_equal/)(std::nullptr_t) const | Checks if [List](../list/) pointer is null. |
