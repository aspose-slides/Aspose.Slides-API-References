...
description: Dictionary pointer class with operator overloads. This type is a pointer to manage other object's deletion. It should be allocated on stack and passed to functions either by value or by const reference.
type: docs
weight: 170
url: /system.collections.generic/dictionaryptr/
---
## DictionaryPtr class
...
|  [DictionaryPtr](./dictionaryptr/)(const [SharedPtr](../../system/sharedptr/)\<[Dictionary](../dictionary/)\<T, V\>\>\&) | Converts pointer type. |
...
| V\& [operator[]](./operator[]/)(const X\&) const | Access operator to work with key type conversion. |
| V\& [operator[]](./operator[]/)(const T\&) const | Access operator. |
