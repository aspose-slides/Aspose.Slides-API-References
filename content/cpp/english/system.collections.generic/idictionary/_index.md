...
description: "Interface for dictionary-alike containers. Objects of this class should only be allocated using System::MakeObject() function. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into System::SmartPtr pointer and use this pointer to pass it to functions as argument."
type: docs
weight: 274
url: /system.collections.generic/idictionary/
---
## IDictionary class
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)(const TKey\&, const TValue\&) | Adds key-value pair into container. |
...
| virtual **bool** [ContainsKey](./containskey/)(const TKey\&) const | Checks if container contains key. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<[KeyValuePair](../keyvaluepair/)\<TKey, TValue\>\>, int) override | Copies dictionary contents into existing array elements. |
...
| **bool** [get_IsFixedSize](./get_isfixedsize/)() const | Checks if collection size is fixed. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Checks if collection is read only. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | Checks if container is thread-safe. |
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TKey\>\> [get_Keys](./get_keys/)() const | Accesses key collection. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TValue\>\> [get_Values](./get_values/)() const | Accesses value collection. |
...
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey\&) const | Returns value if found; or **Value()** otherwise. |
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey\&, const TValue\&) const | Returns value if found; or **defaultValue** otherwise. |
| virtual TValue [GetValueOrNull](./getvalueornull/)(const TKey\&) const | Returns value if found; or **null** otherwise, make sense only for reference types. |
...
| virtual TValue [idx_get](./idx_get/)(const TKey\&) const | Getter function. |
| virtual void [idx_set](./idx_set/)(const TKey\&, TValue) | Setter function. |
...
| T [LINQ_Average](../ienumerable/linq_average/)() | Computes the average of a sequence of numeric values. |
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Computes the average of a sequence of values that are obtained by invoking a transform function on each element of the input sequence. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | Skip a specified number of contiguous elements from the start of a sequence and returns rest. |
...
| virtual **bool** [Remove](./remove/)(const TKey\&) | Removes key from container. |
...
| virtual **bool** [TryGetValue](./trygetvalue/)(const TKey\&, TValue\&) const | Looks for value and retreives it if found. |
