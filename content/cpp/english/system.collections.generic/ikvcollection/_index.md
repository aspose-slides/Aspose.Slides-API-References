...
description: "Interface of container containing keys or values of the dictionary-like container. Objects of this class should only be allocated using System::MakeObject() function. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into System::SmartPtr pointer and use this pointer to pass it to functions as argument."
type: docs
weight: 326
url: /system.collections.generic/ikvcollection/
---
## IKVCollection class
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const T\&) override | Adds item to container. |
...
| void [Clear](./clear/)() override | Deletes all elements from container. |
| **bool** [Contains](./contains/)(const T\&) const override | Checks if item is present in container. |
...
| virtual int [get_Count](./get_count/)() const | Gets number of elements in container. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Checks whether the collection is of fixed size. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Checks if container is read only. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() | Gets enumerator for container. |
...
| virtual T [idx_get](./idx_get/)(int) const | Getter function. |
| void [idx_set](./idx_set/)(int, T) override | Setter function. |
| int [IndexOf](./indexof/)(const T\&) const override | Gets index of item in container. |
...
| **bool** [Remove](./remove/)(const T\&) override | Removes item from container. |
