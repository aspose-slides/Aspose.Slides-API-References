...
| Method | Description |
| --- | --- |
|  [Encoder](./encoder/)(const [Guid](../../system/guid/)\&) | Constructs a new instance of [Encoder](./) class. |
...
| [Guid](../../system/guid/) [get_Guid](./get_guid/)() const | Returns a GUID that specifies a set of image encoder parameters the current object represents. |
