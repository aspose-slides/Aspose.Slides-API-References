...
| Method | Description |
| --- | --- |
|  [BoxedValue](./boxedvalue/)(const [ValueT](../valuetuple/)\&) | Constructs a [BoxedValue](../boxedvalue/) object that represents the specified value boxed. |
...
| virtual [SharedPtr](../sharedptr/)\<[Object](../object/)\> [idx_get](../../system.runtime.compilerservices/ituple/idx_get/)(**int32_t**) const | Returns the element at position index. |
...
| const [ValueT](../valuetuple/)\& [unbox](./unbox/)() const | Unboxes the boxed value. |
