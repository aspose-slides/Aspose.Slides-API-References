...
description: The dummy for System.Array class (abstract base class for all arrays) May be filled with functionality by request.
type: docs
weight: 27
url: /system/arraybase/
---
## ArrayBase class
...
| virtual **int32_t** [get_Length](./get_length/)() const | Returns 32-bit integer that represents the total number of all elements in all dimensions of the array. |
...
| virtual void * [raw_data_ptr](./raw_data_ptr/)() | Returns pointer to the first element of single-dimension array. For multi-dimensional arrays result undefined. |
