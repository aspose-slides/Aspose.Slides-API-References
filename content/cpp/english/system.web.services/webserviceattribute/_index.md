...
type: docs
weight: 27
url: /system.web.services/webserviceattribute/
---
...
| [String](../../system/string/) [get_Description](./get_description/)() | Gets a message that contains the XML [Web](../../system.web/) service description. |
| [String](../../system/string/) [get_Name](./get_name/)() | Gets the XML [Web](../../system.web/) service's name. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Gets the default namespace to use for the XML [Web](../../system.web/) service. |
...
| void [set_Description](./set_description/)([String](../../system/string/)) | Sets a message that contains the XML [Web](../../system.web/) service description. |
| void [set_Name](./set_name/)([String](../../system/string/)) | Sets the XML [Web](../../system.web/) service's name. |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Sets the default namespace to use for the XML [Web](../../system.web/) service. |
...
| Field | Description |
| --- | --- |
| static [DefaultNamespace](./defaultnamespace/) | The default value of the 'Namespace' property. |
## See Also
