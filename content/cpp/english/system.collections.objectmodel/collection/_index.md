...
description: "Base type for generic collection. Objects of this class should only be allocated using System::MakeObject() function. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into System::SmartPtr pointer and use this pointer to pass it to functions as argument."
type: docs
weight: 1
url: /system.collections.objectmodel/collection/
---
## Collection class
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const T\&) override | Adds value to container. |
...
| **bool** [Contains](./contains/)(const T\&) const override | Checks if item is present in collection. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copies collection elements into existing array elements. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](./get_items/)() | Internal data structure accessor. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](./get_items/)() const | Internal data structure accessor. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Gets enumerator to iterate through collection. |
...
| T [idx_get](./idx_get/)(int) const override | Gets value at specified index. |
| void [idx_set](./idx_set/)(int, T) override | Sets value at specified index. |
| int [IndexOf](./indexof/)(const T\&) const override | Looks for element in collection. |
| void [Insert](./insert/)(int, const T\&) override | Inserts item into specified position. |
...
| T\& [operator[]](./operator[]/)(int) | Gets value at specified index. |
| const T\& [operator[]](./operator[]/)(int) const | Gets value at specified index. |
...
| **bool** [Remove](./remove/)(const T\&) override | Removes specific item. |
| void [RemoveAt](./removeat/)(int) override | Removes item at specific position. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Makes stored pointers weak (if applicable). |
