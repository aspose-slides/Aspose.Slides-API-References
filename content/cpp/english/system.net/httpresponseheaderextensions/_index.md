...
description: Contains utility methods to work with the HttpResponseHeader enumeration values.
type: docs
weight: 235
url: /system.net/httpresponseheaderextensions/
---
...
| static [String](../../system/string/) [GetName](./getname/)([HttpResponseHeader](../httpresponseheader/)) | Returns the name of the specified header. |
