...
description: "Semaphore implementation. Objects of this class should only be allocated using System::MakeObject() function. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into System::SmartPtr pointer and use this pointer to pass it to functions as argument."
type: docs
weight: 183
url: /system.threading/semaphore/
---
## Semaphore class
...
| int [Release](./release/)() | Releases lock on semaphore. |
| int [Release](./release/)(int) | Releases multiple locks on semaphore. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Decreases shared reference count by specified value. |
| virtual **bool** [Reset](./reset/)() | Sets semaphore to non-signalled state. Not supported. |
|  [Semaphore](./semaphore/)(int, int) | Creates unnamed semaphore. |
|  [Semaphore](./semaphore/)(int, int, const [String](../../system/string/)\&) | Creates named semaphore. |
|  [Semaphore](./semaphore/)(int, int, const [String](../../system/string/)\&, **bool**\&) | Creates named semaphore. |
| virtual **bool** [Set](./set/)() | Sets semaphore to signalled state. Not supported. |
...
| **bool** [WaitOne](./waitone/)() override | Locks semaphore. Performs unlimited waiting if neccessary. |
| **bool** [WaitOne](./waitone/)(int) override | Locks semaphore. Performs waiting if neccessary. |
