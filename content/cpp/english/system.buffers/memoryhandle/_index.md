...
description: Represents a handle to a block of memory.
type: docs
weight: 1
url: /system.buffers/memoryhandle/
---
## MemoryHandle class
...
| Method | Description |
| --- | --- |
|  [ASPOSECPP_VALUE_TYPE_IMPLEMENTS_INTERFACES](./asposecpp_value_type_implements_interfaces/)() |  |
| virtual void [Dispose](./dispose/)() | Releases resources held by the memory handle. |
...
| void * [get_Pointer](./get_pointer/)() const | Gets the raw memory pointer associated with this handle. |
