...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | Adds a new property to the collection. |
...
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Determines whether the [ICollection](../../system.collections.generic/icollection/) contains a specific value. |
...
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Determines the index of a specific item by property value in the [IList](../../system.collections.generic/ilist/). |
...
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | Inserts a new property (with the specified property value) to the collection at the specified index. |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | Removes specified property from the collection. |
