...
| virtual **int32_t** [get_Count](./get_count/)() | Returns the number of points in the collection. Read-only **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPoint](../ipoint/)\> [idx_get](./idx_get/)(**int32_t**) | Returns a point at the specified index. |
