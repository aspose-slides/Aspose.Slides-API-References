...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Add new interactive sequence. |
...
| virtual void [Clear](./clear/)() | Removes all sequences from a collection. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Returns the number of elements in a collection Read-only **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [idx_get](./idx_get/)(**int32_t**) | Returns a sequense at the specified index. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>) | Removes specified sequence from a collection. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Removes sequence at the specified index. |
