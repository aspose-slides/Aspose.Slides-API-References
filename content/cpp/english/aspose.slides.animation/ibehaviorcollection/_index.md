...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Add new behavior to a collection. |
...
| virtual void [Clear](./clear/)() | Removes all behaviors from a collection. |
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Determines whether the [ICollection](../../system.collections.generic/icollection/) contains a specific value. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Returns the number of behaviors in a collection. Read-only **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) | Returns a behavior at the specified index. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Returns a behavior at the specified index. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Determines the index of a specific item in the [IList](../../system.collections.generic/ilist/). |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Inserts new behavior to a collection at the specified index. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Removes specified behavior from a collection. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Removes behavior from a collection at the specified index. |
