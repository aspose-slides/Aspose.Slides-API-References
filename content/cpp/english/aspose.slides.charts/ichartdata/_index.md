...
| virtual [WorkbookType](../workbooktype/) [get_EmbeddedWorkbookType](./get_embeddedworkbooktype/)() | Gets the type of the embedded workbook. Returns [WorkbookType::NotDefined](../workbooktype/) if [IChartData::get_DataSourceType](./get_datasourcetype/) is [ChartDataSourceType::ExternalWorkbook](../chartdatasourcetype/). Read-only [WorkbookType](../workbooktype/). |
