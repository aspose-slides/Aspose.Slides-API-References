...
| [WorkbookType](../workbooktype/) [get_EmbeddedWorkbookType](./get_embeddedworkbooktype/)() override | Gets the type of the embedded workbook. Returns [WorkbookType::NotDefined](../workbooktype/) if [ChartData::get_DataSourceType](./get_datasourcetype/) is [ChartDataSourceType::ExternalWorkbook](../chartdatasourcetype/). Read-only [WorkbookType](../workbooktype/). |
