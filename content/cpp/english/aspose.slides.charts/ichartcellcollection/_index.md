...
type: docs
weight: 625
url: /aspose.slides.charts/ichartcellcollection/
---
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Add new cell to the collection. |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Creates [IChartDataCell](../ichartdatacell/) from specified value and adds it to the collection. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Gets the count of cells in collection. Read-only **int32_t**. |
| virtual [System::String](../../system/string/) [GetCellsAddress](./getcellsaddress/)() | Returns address of the set of cells in workbook. |
| virtual [System::String](../../system/string/) [GetConcatenatedValuesFromCells](./getconcatenatedvaluesfromcells/)() | Concatenation string from all cells string values. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | Returns a cell ([IChartDataCell](../ichartdatacell/)) by index. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Removes a cell from the collection by index. |
