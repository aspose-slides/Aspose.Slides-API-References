...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)(const **int32_t**\&) | Adds data point by its index in parent series points collection. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) | Returns chart data point by index. |
...
| virtual void [Remove](./remove/)(**int32_t**) | Removes item from collection by it index in parent series points collection. |
