...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const **int32_t**\&) override | Adds data point by its index in parent series points collection. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Adds data point to collection. |
...
| void [Clear](./clear/)() override | Removes all items from the [ICollection](../../system.collections.generic/icollection/). |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) const override | Determines whether the [ICollection](../../system.collections.generic/icollection/) contains a specific value. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>, **int32_t**) override | Copies the elements of the [ICollection](../../system.collections.generic/icollection/) to an [System::Array](../../system/array/), starting at a particular [System::Array](../../system/array/) index. |
...
| **int32_t** [get_Count](./get_count/)() const override | Returns the count of chart data points. Read-only **int32_t**. |
...
| **bool** [get_IsSynchronized](./get_issynchronized/)() | Returns a value indicating whether access to the collection is synchronized (thread-safe). Read-only **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Returns a synchronization root. Read-only [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) override | Returns chart data point for specified index. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Removes item from collection. |
| void [Remove](./remove/)(**int32_t**) override | Removes item from collection by it index in parent series points collection. |
