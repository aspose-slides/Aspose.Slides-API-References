...
description: Checks if both type arguments are IEnumerable. If so, value member is set to true, otherwise it is set to false.
type: docs
weight: 144
url: /system.testpredicates.typetraits/bothenumerable/
---
