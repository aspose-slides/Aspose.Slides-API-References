...
description: "The collection of the HTTP headers. Objects of this class should only be allocated using System::MakeObject() function. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into System::SmartPtr pointer and use this pointer to pass it to functions as argument."
type: docs
weight: 79
url: /system.net.http.headers/httpheaders/
---
## HttpHeaders class
...
| Method | Description |
| --- | --- |
| void [Add](./add/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\>) | Validates a new name-values pair and adds it to the current collection. |
| void [Add](./add/)([String](../../system/string/), [String](../../system/string/)) | Validates a new name-value pair and adds it to the current collection. |
| virtual void [AddHeaders](./addheaders/)([System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](./)\>) | Concatenates the specified HttpHeaders-class instance with the current one. |
| void [AddParsedValue](./addparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Gets a header by the specified name and adds a parsed value to the header. |
...
| void [Clear](./clear/)() | Removes all items from the collection. |
| **bool** [Contains](./contains/)([String](../../system/string/)) |  |
| **bool** [ContainsParsedValue](./containsparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Checks if the header contains the specified value. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\>\>\>\> [GetEnumerator](./getenumerator/)() override | Gets enumerator. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog of C# [Object.GetHashCode()](../../system/object/gethashcode/) method. Enables hashing of custom objects. |
| [String](../../system/string/) [GetHeaderString](./getheaderstring/)([String](../../system/string/)) | Returns a string representation of values by the specified header name. |
| [String](../../system/string/) [GetHeaderString](./getheaderstring/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Returns a string representation of values by the specified header name. |
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[String](../../system/string/), [String](../../system/string/)\>\>\> [GetHeaderStrings](./getheaderstrings/)() | Returns a collection that contains string representations of headers' values. |
| [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetParsedValues](./getparsedvalues/)([String](../../system/string/)) | Returns parsed values by the specified header name. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Gets actual type of object. Analog of C# [System.Object.GetType()](../../system/object/gettype/) call. |
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\> [GetValues](./getvalues/)([String](../../system/string/)) | Returns corresponding values by the specified name. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::List](../../system.collections.generic/list/)\<[System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\>\> [ParsedValuesAsList](./parsedvaluesaslist/)(const [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Converts parsed values to list. |
...
| **bool** [Remove](./remove/)([String](../../system/string/)) | Tries to remove an item by the specified name. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Decreases shared reference count by specified value. |
| **bool** [RemoveParsedValue](./removeparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Gets a header by the specified name and removes a parsed value from the header. |
...
| void [SetOrRemoveParsedValue](./setorremoveparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Gets a header by the specified name and sets or removes its value. The header value will be removed when the 'value' parameter is nullptr, otherwise a parsed value will be set. |
| void [SetParsedValue](./setparsedvalue/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Gets a header by the specified name and sets a parsed value to the header. |
...
| **bool** [TryAddWithoutValidation](./tryaddwithoutvalidation/)([String](../../system/string/), [String](../../system/string/)) | Tries to add a new name-value pair to the current collection. |
| **bool** [TryAddWithoutValidation](./tryaddwithoutvalidation/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\>) | Adds a collection of name-value pairs to the current collection. |
| **bool** [TryGetValues](./trygetvalues/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[String](../../system/string/)\>\>\&) | Tries to get corresponding values by the specified name. |
| **bool** [TryParseAndAddValue](./tryparseandaddvalue/)([String](../../system/string/), [String](../../system/string/)) | Tries to parse the specified value and add it to the header values. |
