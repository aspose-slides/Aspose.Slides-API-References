...
description: "Represents the collection of the headers values. Objects of this class should only be allocated using System::MakeObject() function. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into System::SmartPtr pointer and use this pointer to pass it to functions as argument."
type: docs
weight: 92
url: /system.net.http.headers/httpheadervaluecollection/
---
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const T\&) override | Adds element into collection. |
...
| **bool** [Contains](./contains/)(const T\&) const override | Checks if element is present in collection. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) override | Copies all collection elements to existing array elements. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Gets a value that indicates if the current collection is read-only. |
...
| **bool** [get_IsSpecialValueSet](./get_isspecialvalueset/)() | Gets a value that indicates if the current collection contains a \"special value\". |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Gets enumerator. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog of C# [Object.GetHashCode()](../../system/object/gethashcode/) method. Enables hashing of custom objects. |
| [String](../../system/string/) [GetHeaderStringWithoutSpecial](./getheaderstringwithoutspecial/)() | Returns a string representation of the current collection without a \"special value\". |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Gets actual type of object. Analog of C# [System.Object.GetType()](../../system/object/gettype/) call. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>) | Constructs a new instance. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Constructs a new instance. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T) | Constructs a new instance. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Constructs a new instance. |
...
| void [ParseAdd](./parseadd/)([String](../../system/string/)) | Parses a header string representation and adds it to the current collection. |
...
| **bool** [Remove](./remove/)(const T\&) override | Deletes element from collection. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Decreases shared reference count by specified value. |
| void [RemoveSpecialValue](./removespecialvalue/)() | Removes a \"special value\". |
| void [SetSpecialValue](./setspecialvalue/)() | Sets a \"special value\". |
...
| **bool** [TryParseAdd](./tryparseadd/)([String](../../system/string/)) | Tries to parse a header string representation and add it to the current collection. |
