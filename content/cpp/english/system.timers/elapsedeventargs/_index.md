...
description: Arguments of timer event.
type: docs
weight: 1
url: /system.timers/elapsedeventargs/
---
...
| Method | Description |
| --- | --- |
|  [ElapsedEventArgs](./elapsedeventargs/)(**int32_t**, **int32_t**) | Constructs arguments object with given parameters. |
...
| [DateTime](../../system/datetime/) [get_SignalTime](./get_signaltime/)() | Gets singal time. |
