...
description: "Represents a phantom math object (<m:phant>) that affects the layout of its child element without necessarily displaying it. A phantom can hide its base expression while preserving its width, height, or depth to align formulas or reserve space. Visibility and geometry behavior are controlled by properties such as Show, ZeroWid, ZeroAsc, ZeroDesc, and Transp."
type: docs
weight: 1028
...
| **bool** [get_Show](./get_show/)() override | Gets a value indicating whether the base element is displayed. |
| **bool** [get_Transp](./get_transp/)() override | Gets a value indicating whether the phantom is transparent for class-based spacing rules. |
| **bool** [get_ZeroAsc](./get_zeroasc/)() override | Gets a value indicating whether the ascent (height above baseline) of the base element should be treated as zero. |
| **bool** [get_ZeroDesc](./get_zerodesc/)() override | Gets a value indicating whether the descent (depth below baseline) of the base element should be treated as zero. |
| **bool** [get_ZeroWidth](./get_zerowidth/)() override | Gets a value indicating whether the width of the base element should be treated as zero. |
...
|  [MathPhantom](./mathphantom/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Initializes a new instance of the [MathPhantom](./) class using the specified base math element. |
...
| void [set_Show](./set_show/)(**bool**) override | Sets a value indicating whether the base element is displayed. |
| void [set_Transp](./set_transp/)(**bool**) override | Sets a value indicating whether the phantom is transparent for class-based spacing rules. |
| void [set_ZeroAsc](./set_zeroasc/)(**bool**) override | Sets a value indicating whether the ascent (height above baseline) of the base element should be treated as zero. |
| void [set_ZeroDesc](./set_zerodesc/)(**bool**) override | Sets a value indicating whether the descent (depth below baseline) of the base element should be treated as zero. |
| void [set_ZeroWidth](./set_zerowidth/)(**bool**) override | Sets a value indicating whether the width of the base element should be treated as zero. |
...
phantom->set_Show(false); // Hide the content
phantom->set_ZeroWidth(false); // Keep the width
```

## See Also

* Class [MathElementBase](../mathelementbase/)
* Class [IMathPhantom](../imathphantom/)
