...
description: Pointer to BitArray. This type is a pointer to manage other object's deletion. It should be allocated on stack and passed to functions either by value or by const reference.
type: docs
weight: 14
url: /system.collections/bitarrayptr/
---
## BitArrayPtr class
...
|  [BitArrayPtr](./bitarrayptr/)(const [SharedPtr](../../system/sharedptr/)\<[BitArray](../bitarray/)\>\&) | Conversion constructor. |
...
| **bool** [IsNull](./isnull/)() const | Checks if specific value is null. |
...
| **BitArray::Reference** [operator[]](./operator[]/)(int) const | Bit accessor. |
