...
description: Padding mode and parameters for RSA signature creation or verification operations.
type: docs
weight: 521
url: /system.security.cryptography/rsasignaturepadding/
---
...
| [RSASignaturePaddingMode](../rsasignaturepaddingmode/) [get_Mode](./get_mode/)() const | Gets the padding mode. |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pkcs1](./get_pkcs1/)() | Gets PKCS #1 v1.5 mode. |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pss](./get_pss/)() | Gets PSS mode. |
