...
description: "Stream implementation that wraps existing stream with a cryptographic function. Objects of this class should only be allocated using System::MakeObject() function. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into System::SmartPtr pointer and use this pointer to pass it to functions as argument."
type: docs
weight: 53
url: /system.security.cryptography/cryptostream/
---
## CryptoStream class
...
| void [Close](./close/)() override | Closes connection. |
...
| void [Flush](./flush/)() override | Empties buffer into wrapped stream. Does nothing as transform algorithm can be still waiting for more data. |
...
| void [FlushFinalBlock](./flushfinalblock/)() | Writes the data which is still in the buffer to stream. |
| **bool** [get_CanRead](./get_canread/)() const override | Checks if stream is readable. |
| **bool** [get_CanSeek](./get_canseek/)() const override | Checks if stream is seekable. |
...
| **bool** [get_CanWrite](./get_canwrite/)() const override | Checks if stream is writable. |
| **int64_t** [get_Length](./get_length/)() const override | Gets length of stream. Not supported. |
| **int64_t** [get_Position](./get_position/)() const override | Gets current position in stream. Not supported. |
...
| **int32_t** [Read](./read/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) override | Reads data from stream. |
| **int32_t** [Read](./read/)(const System::Details::ArrayView\<**uint8_t**\>\&, **int32_t**, **int32_t**) override | Reads data from stream. |
...
| virtual **int32_t** [Read](../../system.io/stream/read/)(const [System::Span](../../system/span/)\<**uint8_t**\>\&) | Reads the specified number of bytes from the stream and writes them to the specified byte span. |
...
| **int64_t** [Seek](./seek/)(**int64_t**, [IO::SeekOrigin](../../system.io/seekorigin/)) override | Seeks position in stream. Not supported. |
| void [set_Position](./set_position/)(**int64_t**) override | Seeks position in stream. Not supported. |
...
| void [SetLength](./setlength/)(**int64_t**) override | Seeks size of stream. Not supported. |
...
| void [Write](./write/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) override | Writes data to stream. |
| void [Write](./write/)(const System::Details::ArrayView\<**uint8_t**\>\&, **int32_t**, **int32_t**) override | Writes data to stream. |
...
| virtual void [Write](../../system.io/stream/write/)(const [System::ReadOnlySpan](../../system/readonlyspan/)\<**uint8_t**\>\&) | Writes the specified subrange of bytes from the specified byte span to the stream. |
