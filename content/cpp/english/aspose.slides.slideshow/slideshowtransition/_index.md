...
| **int32_t** [get_Duration](./get_duration/)() override | Gets the duration of the slide transition effect in milliseconds. Read **int32_t**. |
...
| void [set_Duration](./set_duration/)(**int32_t**) override | Sets the duration of the slide transition effect in milliseconds. Write **int32_t**. |
