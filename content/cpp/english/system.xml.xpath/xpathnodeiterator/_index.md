...
description: Provides an iterator over a selected set of nodes.
type: docs
weight: 79
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNodeIterator](./)\> [Clone](./clone/)() | When overridden in a derived class, returns a clone of this [XPathNodeIterator](./) object. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Returns the index of the last node in the selected set of nodes. |
| virtual const [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\& [get_Current](./get_current/)() | When overridden in a derived class, gets the [XPathNavigator](../xpathnavigator/) object for this [XPathNodeIterator](./), positioned on the current context node. |
| virtual **int32_t** [get_CurrentPosition](./get_currentposition/)() | When overridden in a derived class, gets the index of the current position in the selected set of nodes. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returns an IEnumerator object to iterate through the selected node set. |
...
| virtual **bool** [MoveNext](./movenext/)() | When overridden in a derived class, moves the [XPathNavigator](../xpathnavigator/) object returned by the [XPathNodeIterator::get_Current](./get_current/) method to the next node in the selected node set. |
