...
| [Aspose::Slides::Export::CompressionLevel](../compressionlevel/) [get_CompressionLevel](./get_compressionlevel/)() override | Specifies the compression level used when saving the presentation document. The default value is [CompressionLevel::Level6](../compressionlevel/). |
...
| **bool** [get_RefreshThumbnail](./get_refreshthumbnail/)() override | Specifies whether the presentation thumbnail will be refreshed. Read **bool**. Default value is **true**. |
...
| [Aspose::Slides::Export::Zip64Mode](../zip64mode/) [get_Zip64Mode](./get_zip64mode/)() override | Specifies whether the ZIP64 format is used for the [Presentation](../../aspose.slides/presentation/) document. The default value is [Zip64Mode::IfNecessary](../zip64mode/) |
...
| void [set_CompressionLevel](./set_compressionlevel/)([Aspose::Slides::Export::CompressionLevel](../compressionlevel/)) override | Specifies the compression level used when saving the presentation document. The default value is [CompressionLevel::Level6](../compressionlevel/). |
...
| void [set_RefreshThumbnail](./set_refreshthumbnail/)(**bool**) override | Specifies whether the presentation thumbnail will be refreshed. Write **bool**. Default value is **true**. |
...
| void [set_Zip64Mode](./set_zip64mode/)([Aspose::Slides::Export::Zip64Mode](../zip64mode/)) override | Specifies whether the ZIP64 format is used for the [Presentation](../../aspose.slides/presentation/) document. The default value is [Zip64Mode::IfNecessary](../zip64mode/) |
