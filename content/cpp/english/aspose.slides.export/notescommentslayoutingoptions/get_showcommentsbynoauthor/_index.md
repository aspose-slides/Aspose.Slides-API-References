...
type: docs
weight: 1
url: /aspose.slides.export/notescommentslayoutingoptions/get_showcommentsbynoauthor/
---
...
```cpp
bool Aspose::Slides::Export::NotesCommentsLayoutingOptions::get_ShowCommentsByNoAuthor()
```
