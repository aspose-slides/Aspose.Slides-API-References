...
type: docs
weight: 105
url: /aspose.slides.export/notescommentslayoutingoptions/get_commentsareawidth/
---
...
```cpp
int32_t Aspose::Slides::Export::NotesCommentsLayoutingOptions::get_CommentsAreaWidth()
```
