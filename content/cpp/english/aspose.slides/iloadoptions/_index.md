...
| virtual [System::String](../../system/string/) [get_DefaultTextLanguage](./get_defaulttextlanguage/)() | Returns the default language for presentation text. Read [System::String](../../system/string/). |
| virtual **bool** [get_DeleteEmbeddedBinaryObjects](./get_deleteembeddedbinaryobjects/)() | Determines if [Aspose.Slides](../) will delete all embedded binary objects while presentation loading. |
...
| virtual void [set_DefaultTextLanguage](./set_defaulttextlanguage/)([System::String](../../system/string/)) | Sets the default language for presentation text. Write [System::String](../../system/string/). |
| virtual void [set_DeleteEmbeddedBinaryObjects](./set_deleteembeddedbinaryobjects/)(**bool**) | Determines if [Aspose.Slides](../) will delete all embedded binary objects while presentation loading. |
