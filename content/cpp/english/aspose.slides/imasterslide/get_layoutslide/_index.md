...
type: docs
weight: 144
url: /aspose.slides/imasterslide/get_layoutslide/
---
## IMasterSlide::get_LayoutSlide(int32_t) method
...
```cpp
virtual System::SharedPtr<ILayoutSlide> Aspose::Slides::IMasterSlide::get_LayoutSlide(int32_t index)=0
```
