...
type: docs
weight: 105
url: /aspose.slides/captionscollection/end/
---
## CaptionsCollection::end() method


Gets iterator pointing right after the last element (if any) of the collection.

```cpp
iterator Aspose::Slides::CaptionsCollection::end() noexcept
```
...
## CaptionsCollection::end() const method


Gets iterator pointing right after the last element (if any) of the const-qualified instance of the collection.

```cpp
const_iterator Aspose::Slides::CaptionsCollection::end() const noexcept
```
