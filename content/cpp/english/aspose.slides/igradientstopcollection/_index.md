...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) | Creates the new gradient stop and adds it to the end of collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) | Creates the new gradient stop and adds it to the end of collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) | Creates the new gradient stop and adds it to the end of collection. |
...
| virtual void [Clear](./clear/)() | Removes all gradient stops from a collection. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) | Returns the gradient stop by index. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) | Creates the new gradient stop and inserts it at the specified index to the collection. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) | Creates the new gradient stop and inserts it at the specified index to the collection. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) | Creates the new gradient stop and inserts it at the specified index to the collection. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Removes a gradient stop at the specified index. |
