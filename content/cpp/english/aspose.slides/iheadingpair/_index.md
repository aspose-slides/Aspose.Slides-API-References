...
| virtual **int32_t** [get_Count](./get_count/)() | Returns the number of parts in group. Read-only **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Returns the group name of document parts. Read-only [System::String](../../system/string/). |
