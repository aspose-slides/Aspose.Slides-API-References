...
| [System::SharedPtr](../../system/sharedptr/)\<[ICaptionsCollection](../icaptionscollection/)\> [get_CaptionTracks](./get_captiontracks/)() override | Gets the collection of closed captions associated with the video frame. This property is read-only and returns an [ICaptionsCollection](../icaptionscollection/) containing all caption tracks. |
