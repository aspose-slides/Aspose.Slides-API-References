...
Created [IAutoShape](../../iautoshape/) with a [Table](../../table/) placeholder.
## Remarks



The following example shows how to add the [Table](../../table/) placeholder shape to the layout slide. 
```cpp
