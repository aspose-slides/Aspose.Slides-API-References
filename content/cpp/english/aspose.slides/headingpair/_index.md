...
| **int32_t** [get_Count](./get_count/)() override | Returns the number of parts in group. Read-only **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Returns the group name of document parts. Read-only [System::String](../../system/string/). |
