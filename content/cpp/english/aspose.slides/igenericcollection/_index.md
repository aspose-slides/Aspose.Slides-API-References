...
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Copies all elements from the collection into the specified array. |
...
| virtual **bool** [get_IsSynchronized](./get_issynchronized/)() | Returns a value indicating whether access to the collection is synchronized (thread-safe). Read-only **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() | Returns a synchronization root. Read-only [System::Object](../../system/object/). |
