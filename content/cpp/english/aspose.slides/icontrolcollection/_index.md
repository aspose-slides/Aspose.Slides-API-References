...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [AddControl](./addcontrol/)([ControlType](../controltype/), **float**, **float**, **float**, **float**) | Creates and adds a new control to the collection. |
...
| virtual void [Clear](./clear/)() | Removes all controls from the collection. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [idx_get](./idx_get/)(**int32_t**) | Returns a control at the specified position. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>) | Removes an ActiveX control from the collection. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Removes an ActiveX control stored at specified position from the collection. |
