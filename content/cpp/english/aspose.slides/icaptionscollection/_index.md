...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | Adds WebVTT closed captions to the end of the collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Adds WebVTT closed captions to the end of the collection from a stream. |
...
| virtual void [Clear](./clear/)() | Removes all closed captions from the collection. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Returns the number of elements in the collection. Read-only **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [idx_get](./idx_get/)(**int32_t**) | Returns the closed captions at the specified index. Read-only [ICaptions](../icaptions/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\>) | Removes the specified closed captions from the collection. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Removes the closed captions at the specified index. |
