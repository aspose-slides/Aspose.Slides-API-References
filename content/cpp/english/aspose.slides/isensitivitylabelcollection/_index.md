...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [Add](./add/)([System::String](../../system/string/), [System::Guid](../../system/guid/), **bool**, [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | Adds the sensitivity label at the end of the collection. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>) | Adds a [SensitivityLabel](../sensitivitylabel/) to the collection. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Gets the number of all elements in the collection. Read-only **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [idx_get](./idx_get/)(**int32_t**) | Returns the sensitivity label by index. Read-only [ISensitivityLabel](../isensitivitylabel/). |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Removes the sensitivity label at the specified index. |
