...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [Add](./add/)([Orientation](../orientation/), **float**) | Adds the drawing guide at the end of the collection. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [idx_get](./idx_get/)(**int32_t**) | Returns the drawing guide by index. Read-only [IDrawingGuide](../idrawingguide/). |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Removes the drawing guide at the specified index. |
