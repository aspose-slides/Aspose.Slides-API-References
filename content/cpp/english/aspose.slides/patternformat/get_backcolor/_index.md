...
type: docs
weight: 40
url: /aspose.slides/patternformat/get_backcolor/
---
## PatternFormat::get_BackColor() method


Returns the background pattern color. Read-only [IColorFormat](../../icolorformat/).

```cpp
System::SharedPtr<IColorFormat> Aspose::Slides::PatternFormat::get_BackColor() override
```
