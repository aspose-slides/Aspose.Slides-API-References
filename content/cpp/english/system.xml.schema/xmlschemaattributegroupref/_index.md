...
description: Represents the attributeGroup element with the ref attribute from the XML Schema as specified by the . AttributesGroupRef is the reference for an attributeGroup, name property contains the attribute group being referenced.
type: docs
weight: 196
url: /system.xml.schema/xmlschemaattributegroupref/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Returns the name of the referenced **attributeGroup** element. |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Sets the name of the referenced **attributeGroup** element. |
