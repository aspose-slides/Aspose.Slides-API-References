...
description: Represents the notation element from XML Schema as specified by the World Wide Web Consortium (W3C). An XML Schemanotation declaration is a reconstruction of XML 1.0 NOTATION declarations. The purpose of notations is to describe the format of non-XML data within an XML document.
type: docs
weight: 651
url: /system.xml.schema/xmlschemanotation/
---
...
| [String](../../system/string/) [get_Name](./get_name/)() | Returns the name of the notation. |
...
| [String](../../system/string/) [get_Public](./get_public/)() | Returns the **public** identifier. |
...
| [String](../../system/string/) [get_System](./get_system/)() | Returns the **system** identifier. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Sets the name of the notation. |
...
| void [set_Public](./set_public/)(const [String](../../system/string/)\&) | Sets the **public** identifier. |
...
| void [set_System](./set_system/)(const [String](../../system/string/)\&) | Sets the **system** identifier. |
