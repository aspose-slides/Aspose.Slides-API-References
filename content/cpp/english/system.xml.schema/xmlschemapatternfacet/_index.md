...
description: Represents the pattern element from XML Schema as specified by the World Wide Web Consortium (W3C). This class can be used to specify a restriction on the value entered for a simpleType element.
type: docs
weight: 742
url: /system.xml.schema/xmlschemapatternfacet/
---
