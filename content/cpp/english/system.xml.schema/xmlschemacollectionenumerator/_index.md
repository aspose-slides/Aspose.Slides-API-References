...
description: Supports a simple iteration over a collection. This class cannot be inherited.
type: docs
weight: 235
url: /system.xml.schema/xmlschemacollectionenumerator/
---
...
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchema](../xmlschema/)\>\> * [CloneIterator](./cloneiterator/)() const override | Clones current iterator. |
...
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\& [get_Current](./get_current/)() const override | Returns the current [XmlSchema](../xmlschema/) in the collection. |
...
| **bool** [MoveNext](./movenext/)() override | Advances the enumerator to the next schema in the collection. |
