...
description: Represents the complexContent element from XML Schema as specified by the World Wide Web Consortium (W3C). This class represents the complex content model for complex types. It contains extensions or restrictions on a complex type that has either only elements or mixed content.
type: docs
weight: 261
url: /system.xml.schema/xmlschemacomplexcontent/
---
