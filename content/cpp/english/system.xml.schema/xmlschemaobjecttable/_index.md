...
description: Provides the collections for contained elements in the XmlSchema class (for example, Attributes, AttributeGroups, Elements, and so on).
type: docs
weight: 716
url: /system.xml.schema/xmlschemaobjecttable/
---
...
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Determines if the qualified name specified exists in the collection. |
...
| **int32_t** [get_Count](./get_count/)() | Returns the number of items contained in the [XmlSchemaObjectTable](./). |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\> [get_Names](./get_names/)() | Returns a collection of all the named elements in the [XmlSchemaObjectTable](./). |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [get_Values](./get_values/)() | Returns a collection of all the values for all the elements in the [XmlSchemaObjectTable](./). |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Returns the element in the [XmlSchemaObjectTable](./) specified by qualified name. |
