...
description: Specifies a restriction on the number of digits that can be entered for the fraction value of a simpleType element. The value of fractionDigits must be a positive integer. Represents the World Wide Web Consortium (W3C) fractionDigits facet.
type: docs
weight: 417
url: /system.xml.schema/xmlschemafractiondigitsfacet/
---
