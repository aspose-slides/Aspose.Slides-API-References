...
description: "Class for the identity constraints: key, keyref, and unique elements."
type: docs
weight: 469
url: /system.xml.schema/xmlschemaidentityconstraint/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | Returns the collection of fields that apply as children for the XML Path Language ([XPath](../../system.xml.xpath/)) expression selector. |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Returns the name of the identity constraint. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Returns the qualified name of the identity constraint, which holds the post-compilation interpretation of the **QualifiedName** value. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | Returns the [XPath](../../system.xml.xpath/) expression **selector** element. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Sets the name of the identity constraint. |
...
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Sets the [XPath](../../system.xml.xpath/) expression **selector** element. |
