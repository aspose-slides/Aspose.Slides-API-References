...
description: Represents the enumerator for the XmlSchemaObjectCollection.
type: docs
weight: 703
url: /system.xml.schema/xmlschemaobjectenumerator/
---
...
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchemaObject](../xmlschemaobject/)\>\> * [CloneIterator](./cloneiterator/)() const override | Clones current iterator. |
...
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\& [get_Current](./get_current/)() const override | Returns the current [XmlSchemaObject](../xmlschemaobject/) in the collection. |
...
| **bool** [MoveNext](./movenext/)() override | Moves to the next item in the collection. |
...
| void [Reset](./reset/)() override | Resets the enumerator to the start of the collection. |
