...
description: Represents the choice element (compositor) from the XML Schema as specified by the World Wide Web Consortium (W3C). The choice allows only one of its children to appear in an instance.
type: docs
weight: 209
url: /system.xml.schema/xmlschemachoice/
---
