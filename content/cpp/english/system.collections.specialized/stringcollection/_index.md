...
description: "Indexed list of strings. Objects of this class should only be allocated using System::MakeObject() function. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into System::SmartPtr pointer and use this pointer to pass it to functions as argument."
type: docs
weight: 27
url: /system.collections.specialized/stringcollection/
---
...
| Method | Description |
| --- | --- |
| int [Add](./add/)(const [System::String](../../system/string/)\&) | Adds value to the end of the list. |
| void [AddRange](./addrange/)(const [ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>\&) | Add elements into container. |
...
| void [Clear](./clear/)() | Deletes all elements. |
| **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Checks whether specific string is present in container. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>\&, const **int32_t**) const | Copy elements to existing arra elements. |
...
| std::vector\<[System::String](../../system/string/)\>\& [data](./data/)() | Internal data structure accessor. |
| const std::vector\<[System::String](../../system/string/)\>\& [data](./data/)() const | Internal data structure accessor. |
...
| int [get_Count](./get_count/)() const | Gets number of elements in collection. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Gets enumerator iterating through current collection. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog of C# [Object.GetHashCode()](../../system/object/gethashcode/) method. Enables hashing of custom objects. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Gets actual type of object. Analog of C# [System.Object.GetType()](../../system/object/gettype/) call. |
| [System::String](../../system/string/) [idx_get](./idx_get/)(int) const | Gets value at specified position. |
| void [idx_set](./idx_set/)(int, const [System::String](../../system/string/)\&) | Sets value at specified position. |
| int [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Looks for specific string in container. |
| void [Insert](./insert/)(int, const [System::String](../../system/string/)\&) | Inserts specific value into container. |
...
| [System::String](../../system/string/)\& [operator[]](./operator[]/)(int) | Accessor function. |
...
| void [Remove](./remove/)(const [System::String](../../system/string/)\&) | Removes first occurrence of specified string. |
| void [RemoveAt](./removeat/)(int) | Removes element at specified position. |
