...
description: Pointer to collection of X509 extensions. This type is a pointer to manage other object's deletion. It should be allocated on stack and passed to functions either by value or by const reference.
type: docs
weight: 170
url: /system.security.cryptography.x509certificates/x509extensioncollectionptr/
---
