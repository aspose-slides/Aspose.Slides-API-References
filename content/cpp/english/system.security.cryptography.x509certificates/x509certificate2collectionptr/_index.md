...
description: Pointer to collection of X509 certificates. This type is a pointer to manage other object's deletion. It should be allocated on stack and passed to functions either by value or by const reference.
type: docs
weight: 66
url: /system.security.cryptography.x509certificates/x509certificate2collectionptr/
---
