...
description: Represents an XML document. You can use this class to load, validate, edit, add, and position XML in a document.
type: docs
weight: 183
url: /system.xml/xmldocument/
---
## XmlDocument class
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Creates a duplicate of this node. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [CreateAttribute](./createattribute/)(const [String](../../system/string/)\&) | Creates an [XmlAttribute](../xmlattribute/) with the specified name. |
| [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [CreateAttribute](./createattribute/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Creates an [XmlAttribute](../xmlattribute/) with the specified qualified name and [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [CreateAttribute](./createattribute/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Creates an [XmlAttribute](../xmlattribute/) with the specified [XmlNode::get_Prefix](../xmlnode/get_prefix/), [XmlDocument::get_LocalName](./get_localname/), and [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlCDataSection](../xmlcdatasection/)\> [CreateCDataSection](./createcdatasection/)(const [String](../../system/string/)\&) | Creates an [XmlCDataSection](../xmlcdatasection/) containing the specified data. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlComment](../xmlcomment/)\> [CreateComment](./createcomment/)(const [String](../../system/string/)\&) | Creates an [XmlComment](../xmlcomment/) containing the specified data. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocumentFragment](../xmldocumentfragment/)\> [CreateDocumentFragment](./createdocumentfragment/)() | Creates an [XmlDocumentFragment](../xmldocumentfragment/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocumentType](../xmldocumenttype/)\> [CreateDocumentType](./createdocumenttype/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Returns a new [XmlDocumentType](../xmldocumenttype/) object. |
| [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [CreateElement](./createelement/)(const [String](../../system/string/)\&) | Creates an element with the specified name. |
| [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [CreateElement](./createelement/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Creates an [XmlElement](../xmlelement/) with the qualified name and [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [CreateElement](./createelement/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Creates an element with the specified [XmlNode::get_Prefix](../xmlnode/get_prefix/), [XmlDocument::get_LocalName](./get_localname/), and [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlEntityReference](../xmlentityreference/)\> [CreateEntityReference](./createentityreference/)(const [String](../../system/string/)\&) | Creates an [XmlEntityReference](../xmlentityreference/) with the specified name. |
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](./createnavigator/)() override | Creates a new XPathNavigator object for navigating this document. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CreateNode](./createnode/)([XmlNodeType](../xmlnodetype/), const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Creates a [XmlNode](../xmlnode/) with the specified XmlNodeType, [XmlNode::get_Prefix](../xmlnode/get_prefix/), [XmlDocument::get_Name](./get_name/), and [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CreateNode](./createnode/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Creates an [XmlNode](../xmlnode/) with the specified node type, [XmlDocument::get_Name](./get_name/), and [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CreateNode](./createnode/)([XmlNodeType](../xmlnodetype/), const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Creates an [XmlNode](../xmlnode/) with the specified XmlNodeType, [XmlDocument::get_Name](./get_name/), and [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlProcessingInstruction](../xmlprocessinginstruction/)\> [CreateProcessingInstruction](./createprocessinginstruction/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Creates an [XmlProcessingInstruction](../xmlprocessinginstruction/) with the specified name and data. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSignificantWhitespace](../xmlsignificantwhitespace/)\> [CreateSignificantWhitespace](./createsignificantwhitespace/)(const [String](../../system/string/)\&) | Creates an [XmlSignificantWhitespace](../xmlsignificantwhitespace/) node. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlText](../xmltext/)\> [CreateTextNode](./createtextnode/)(const [String](../../system/string/)\&) | Creates an [XmlText](../xmltext/) with the specified text. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlWhitespace](../xmlwhitespace/)\> [CreateWhitespace](./createwhitespace/)(const [String](../../system/string/)\&) | Creates an [XmlWhitespace](../xmlwhitespace/) node. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDeclaration](../xmldeclaration/)\> [CreateXmlDeclaration](./createxmldeclaration/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Creates an [XmlDeclaration](../xmldeclaration/) node with the specified values. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [get_DocumentElement](./get_documentelement/)() | Returns the root [XmlElement](../xmlelement/) for the document. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocumentType](../xmldocumenttype/)\> [get_DocumentType](./get_documenttype/)() | Returns the node containing the DOCTYPE declaration. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlImplementation](../xmlimplementation/)\> [get_Implementation](./get_implementation/)() | Returns the [XmlImplementation](../xmlimplementation/) object for the current document. |
| virtual [String](../../system/string/) [get_InnerText](../xmlnode/get_innertext/)() | Returns the concatenated values of the node and all its child nodes. |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Returns the markup representing the children of the current node. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | Returns a value indicating whether the current node is read-only. |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Returns the local name of the node. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Returns the qualified name of the node. |
| virtual [String](../../system/string/) [get_NamespaceURI](../xmlnode/get_namespaceuri/)() | Returns the namespace URI of this node. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\> [get_NameTable](./get_nametable/)() | Returns the [XmlNameTable](../xmlnametable/) associated with this implementation. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlDocument](./)\> [get_OwnerDocument](./get_ownerdocument/)() override | Returns the [XmlDocument](./) to which the current node belongs. |
...
| **bool** [get_PreserveWhitespace](./get_preservewhitespace/)() | Returns a value indicating whether to preserve white space in element content. |
...
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | Returns the Post-Schema-Validation-Infoset (PSVI) of the node. |
| [SharedPtr](../../system/sharedptr/)\<[Schema::XmlSchemaSet](../../system.xml.schema/xmlschemaset/)\> [get_Schemas](./get_schemas/)() | Returns the XmlSchemaSet object associated with this [XmlDocument](./). |
| virtual [String](../../system/string/) [get_Value](../xmlnode/get_value/)() | Returns the value of the node. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [GetElementById](./getelementbyid/)([String](../../system/string/)) | Returns the [XmlElement](../xmlelement/) with the specified ID. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [GetElementsByTagName](./getelementsbytagname/)([String](../../system/string/)) | Returns an [XmlNodeList](../xmlnodelist/) containing a list of all descendant elements that match the specified name. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [GetElementsByTagName](./getelementsbytagname/)([String](../../system/string/), [String](../../system/string/)) | Returns an [XmlNodeList](../xmlnodelist/) containing a list of all descendant elements that match the specified [XmlDocument::get_LocalName](./get_localname/) and [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ImportNode](./importnode/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, **bool**) | Imports a node from another document to the current document. |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Computes the average of a sequence of numeric values. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Computes the average of a sequence of values that are obtained by invoking a transform function on each element of the input sequence. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Skip a specified number of contiguous elements from the start of a sequence and returns rest. |
...
| virtual void [Load](./load/)([String](../../system/string/)) | Loads the XML document from the specified URL. |
| virtual void [Load](./load/)([SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\>) | Loads the XML document from the specified stream. |
| virtual void [Load](./load/)([SharedPtr](../../system/sharedptr/)\<[IO::TextReader](../../system.io/textreader/)\>) | Loads the XML document from the specified TextReader. |
| virtual void [Load](./load/)([SharedPtr](../../system/sharedptr/)\<[XmlReader](../xmlreader/)\>) | Loads the XML document from the specified [XmlReader](../xmlreader/). |
| virtual void [LoadXml](./loadxml/)([String](../../system/string/)) | Loads the XML document from the specified string. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReadNode](./readnode/)([SharedPtr](../../system/sharedptr/)\<[XmlReader](../xmlreader/)\>) | Creates an [XmlNode](../xmlnode/) object based on the information in the [XmlReader](../xmlreader/). The reader must be positioned on a node or attribute. |
...
| virtual void [Save](./save/)([String](../../system/string/)) | Saves the XML document to the specified file. If the specified file exists, this method overwrites it. |
| virtual void [Save](./save/)([SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\>) | Saves the XML document to the specified stream. |
| virtual void [Save](./save/)([SharedPtr](../../system/sharedptr/)\<[IO::TextWriter](../../system.io/textwriter/)\>) | Saves the XML document to the specified TextWriter. |
| virtual void [Save](./save/)([SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>) | Saves the XML document to the specified [XmlWriter](../xmlwriter/). |
...
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Throws an InvalidOperationException in all cases. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Sets the markup representing the children of the current node. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Sets the namespace prefix of this node. |
| void [set_PreserveWhitespace](./set_preservewhitespace/)(**bool**) | Sets a value indicating whether to preserve white space in element content. |
| void [set_Schemas](./set_schemas/)(const [SharedPtr](../../system/sharedptr/)\<[Schema::XmlSchemaSet](../../system.xml.schema/xmlschemaset/)\>\&) | Sets the XmlSchemaSet object associated with this [XmlDocument](./). |
| virtual void [set_Value](../xmlnode/set_value/)([String](../../system/string/)) | Sets the value of the node. |
| virtual void [set_XmlResolver](./set_xmlresolver/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../xmlresolver/)\>) | Sets the [XmlResolver](../xmlresolver/) to use for resolving external resources. |
...
| void [Validate](./validate/)([Schema::ValidationEventHandler](../../system.xml.schema/validationeventhandler/)) | Validates the [XmlDocument](./) against the XML [Schema](../../system.xml.schema/) Definition Language (XSD) schemas contained in the [XmlDocument::get_Schemas](./get_schemas/) list. |
| void [Validate](./validate/)([Schema::ValidationEventHandler](../../system.xml.schema/validationeventhandler/), const [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\&) | Validates the [XmlNode](../xmlnode/) object specified against the XML [Schema](../../system.xml.schema/) Definition Language (XSD) schemas in the [XmlDocument::get_Schemas](./get_schemas/) list. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Saves all the children of the [XmlDocument](./) node to the specified [XmlWriter](../xmlwriter/). |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Saves the [XmlDocument](./) node to the specified [XmlWriter](../xmlwriter/). |
|  [XmlDocument](./xmldocument/)() | Initializes a new instance of the [XmlDocument](./) class. |
|  [XmlDocument](./xmldocument/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | Initializes a new instance of the [XmlDocument](./) class with the specified [XmlNameTable](../xmlnametable/). |
