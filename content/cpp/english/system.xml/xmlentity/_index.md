...
description: Represents an entity declaration, such as <!ENTITY... >.
type: docs
weight: 235
url: /system.xml/xmlentity/
---
## XmlEntity class
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Creates a duplicate of this node. Entity nodes cannot be cloned. Calling this method on an [XmlEntity](./) object throws an exception. |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Returns the base Uniform Resource Identifier (URI) of the current node. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Returns the concatenated values of the entity node and all its children. |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Returns the name of the node without the namespace prefix. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Returns the name of the node. |
...
| [String](../../system/string/) [get_NotationName](./get_notationname/)() | Returns the name of the optional NDATA attribute on the entity declaration. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Returns the value of the public identifier on the entity declaration. |
...
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Returns the value of the system identifier on the entity declaration. |
...
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Sets the concatenated values of the entity node and all its children. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Saves all the children of the node to the specified [XmlWriter](../xmlwriter/). For [XmlEntity](./) nodes, this method has no effect. |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Saves the node to the specified [XmlWriter](../xmlwriter/). For [XmlEntity](./) nodes, this method has no effect. |
