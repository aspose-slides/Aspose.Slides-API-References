...
description: Represents the XML declaration node <?xml version='1.0'...?>.
type: docs
weight: 170
url: /system.xml/xmldeclaration/
---
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | Returns the encoding level of the XML document. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Returns the concatenated values of the [XmlDeclaration](./). |
...
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | Returns the value of the standalone attribute. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Returns the value of the [XmlDeclaration](./). |
| [String](../../system/string/) [get_Version](./get_version/)() | Returns the XML version of the document. |
...
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | Sets the encoding level of the XML document. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Sets the concatenated values of the [XmlDeclaration](./). |
...
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | Sets the value of the standalone attribute. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Sets the value of the [XmlDeclaration](./). |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Saves the children of the node to the specified [XmlWriter](../xmlwriter/). Because [XmlDeclaration](./) nodes do not have children, this method has no effect. |
