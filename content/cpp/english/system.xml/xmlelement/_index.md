...
| virtual **bool** [get_HasAttributes](./get_hasattributes/)() | Returns a **bool** value indicating whether the current node has any attributes. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Returns the concatenated values of the node and all its children. |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Returns the markup representing just the children of this node. |
| **bool** [get_IsEmpty](./get_isempty/)() | Returns the tag format of the element. |
...
| [String](../../system/string/) [get_NamespaceURI](./get_namespaceuri/)() override | Returns the namespace URI of this node. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](./get_ownerdocument/)() override | Returns the [XmlDocument](../xmldocument/) to which this node belongs. |
...
| [String](../../system/string/) [get_Prefix](./get_prefix/)() override | Returns the namespace prefix of this node. |
...
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | Returns the post schema validation infoset that has been assigned to this node as a result of schema validation. |
| virtual [String](../../system/string/) [get_Value](../xmlnode/get_value/)() | Returns the value of the node. |
| virtual [String](../../system/string/) [GetAttribute](./getattribute/)([String](../../system/string/)) | Returns the value for the attribute with the specified name. |
| virtual [String](../../system/string/) [GetAttribute](./getattribute/)([String](../../system/string/), [String](../../system/string/)) | Returns the value for the attribute with the specified local name and namespace URI. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [GetAttributeNode](./getattributenode/)([String](../../system/string/)) | Returns the [XmlAttribute](../xmlattribute/) with the specified name. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [GetAttributeNode](./getattributenode/)([String](../../system/string/), [String](../../system/string/)) | Returns the [XmlAttribute](../xmlattribute/) with the specified local name and namespace URI. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [GetElementsByTagName](./getelementsbytagname/)([String](../../system/string/)) | Returns an [XmlNodeList](../xmlnodelist/) containing a list of all descendant elements that match the specified [XmlElement::get_Name](./get_name/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [GetElementsByTagName](./getelementsbytagname/)([String](../../system/string/), [String](../../system/string/)) | Returns an [XmlNodeList](../xmlnodelist/) containing a list of all descendant elements that match the specified [XmlElement::get_LocalName](./get_localname/) and [XmlElement::get_NamespaceURI](./get_namespaceuri/) values. |
...
| virtual **bool** [HasAttribute](./hasattribute/)([String](../../system/string/)) | Determines whether the current node has an attribute with the specified name. |
| virtual **bool** [HasAttribute](./hasattribute/)([String](../../system/string/), [String](../../system/string/)) | Determines whether the current node has an attribute with the specified local name and namespace URI. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](./)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Returns the first child element with the specified [XmlNode::get_Name](../xmlnode/get_name/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](./)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Returns the first child element with the specified [XmlNode::get_LocalName](../xmlnode/get_localname/) and [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/) values. |
...
| void [RemoveAll](./removeall/)() override | Removes all specified attributes and children of the current node. Default attributes are not removed. |
| virtual void [RemoveAllAttributes](./removeallattributes/)() | Removes all specified attributes from the element. Default attributes are not removed. |
| virtual void [RemoveAttribute](./removeattribute/)([String](../../system/string/)) | Removes an attribute by name. |
| virtual void [RemoveAttribute](./removeattribute/)([String](../../system/string/), [String](../../system/string/)) | Removes an attribute with the specified local name and namespace URI. (If the removed attribute has a default value, it is immediately replaced). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveAttributeAt](./removeattributeat/)(**int32_t**) | Removes the attribute node with the specified index from the element. (If the removed attribute has a default value, it is immediately replaced). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [RemoveAttributeNode](./removeattributenode/)([SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>) | Removes the specified [XmlAttribute](../xmlattribute/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [RemoveAttributeNode](./removeattributenode/)([String](../../system/string/), [String](../../system/string/)) | Removes the [XmlAttribute](../xmlattribute/) specified by the local name and namespace URI. (If the removed attribute has a default value, it is immediately replaced). |
...
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Sets the concatenated values of the node and all its children. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Sets the markup representing just the children of this node. |
| void [set_IsEmpty](./set_isempty/)(**bool**) | Sets the tag format of the element. |
| void [set_Prefix](./set_prefix/)([String](../../system/string/)) override | Sets the namespace prefix of this node. |
| virtual void [set_Value](../xmlnode/set_value/)([String](../../system/string/)) | Sets the value of the node. |
| virtual void [SetAttribute](./setattribute/)([String](../../system/string/), [String](../../system/string/)) | Sets the value of the attribute with the specified name. |
| virtual [String](../../system/string/) [SetAttribute](./setattribute/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | Sets the value of the attribute with the specified local name and namespace URI. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [SetAttributeNode](./setattributenode/)([SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>) | Adds the specified [XmlAttribute](../xmlattribute/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [SetAttributeNode](./setattributenode/)([String](../../system/string/), [String](../../system/string/)) | Adds the specified [XmlAttribute](../xmlattribute/). |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Saves all the children of the node to the specified [XmlWriter](../xmlwriter/). |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Saves the current node to the specified [XmlWriter](../xmlwriter/). |
