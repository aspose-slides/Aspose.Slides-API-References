...
type: docs
weight: 118
url: /system.reflection/methodbase/
---
## MethodBase class
...
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Indicating the type of the member - method, constructor, event, and so on. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[MemberInfo](../memberinfo/)\> [GetCurrentMethod](./getcurrentmethod/)(const [String](../../system/string/)\&) | This method allows getting current method name. Translator substitutes ASPOSE_CURRENT_FUNCTION as parameter automatically. |
