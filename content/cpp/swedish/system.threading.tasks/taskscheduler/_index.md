...
description: Representerar ett objekt som hanterar det lågnivåarbete som krävs för att köa uppgifter på trådar.
type: docs
weight: 79
url: /sv/system.threading.tasks/taskscheduler/
---
## TaskScheduler-klass


Representerar ett objekt som hanterar det lågnivåarbete som krävs för att köa uppgifter på trådar.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar C#-liknande flyttalsjämförelse där två NaN-värden betraktas som lika även om enligt IEC 60559:1989 NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-liknande flyttalsjämförelse där två NaN-värden betraktas som lika även om enligt IEC 60559:1989 NaN inte är lika med något värde, inklusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för interna ändamål. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | Skapar ett [TaskScheduler](./) som är associerat med den aktuella tråden. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | Hämtar [TaskScheduler](./) som är associerat med den för närvarande körande uppgiften. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | Hämtar standard[TaskScheduler](./)-instansen som tillhandahålls av ramverket. |
| **int32_t** [get_Id](./get_id/)() const | Hämtar det unika ID:t för detta [TaskScheduler](./). |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | Anger den maximala samtidighetsnivån som denna [TaskScheduler](./) kan stödja. |
