...
description: Omuterligt objekt som representerar en skrivskyddad samling av effektiva bildtransformeringseffekter.
type: docs
weight: 820
...
Omuterligt objekt som representerar en skrivskyddad samling av effektiva bildtransformeringseffekter.
...
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Hämtar iterator som pekar på det första elementet (om något) i den const-kvalificerade instansen av samlingen. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Hämtar iterator som pekar på det första const-kvalificerade elementet (om något) i samlingen. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Hämtar iterator som pekar strax efter det sista const-kvalificerade elementet (om något) i samlingen. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>, **int32_t**) override | Kopierar alla element från samlingen till den angivna arrayen. |
| [iterator](./iterator/) [end](./end/)() | Hämtar iterator som pekar strax efter det sista elementet (om något) i samlingen. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Hämtar iterator som pekar strax efter det sista elementet (om något) i den const-kvalificerade instansen av samlingen. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestämmer om det angivna objektet är lika med det aktuella objektet. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar jämförelse av dubbelprecision i C#-stil där två NaN-värden betraktas som lika även om IEC 60559:1989 säger att NaN inte är lika med något värde, inklusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för interna ändamål. |
| **int32_t** [get_Count](./get_count/)() override | Returnerar antalet bildeffekter i en samling. Skrivskyddad **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returnerar en enumerator som itererar igenom samlingen. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Fungerar som en hash-funktion för en viss typ, lämplig för användning i hash-algoritmer och datastrukturer såsom en hashtabell. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) override | Returnerar element efter index. |
|  [ImageTransformOCollectionEffectiveData](./imagetransformocollectioneffectivedata/)() |  |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollerar om objektet representerar en instans av den typ som beskrivs av targetType. Analog till C#-operatorn 'is'. |
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | Tillämpa en ackumulatorfunktion på en sekvens. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Beräknar medelvärdet för en sekvens av värden som erhålls genom att anropa en transform-funktion på varje element i indatasekvensen. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Typkonverterar elementen till den angivna typen. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar egentligen inget, utan bara initierar ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar egentligen inget, utan bara initierar ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallargument till en svag pekare (i stället för delad). Gör det möjligt att byta pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning enligt C# lock()-satser. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Hämtar iterator som pekar på det första elementet (om något) i den const-kvalificerade instansen av samlingen. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Hämtar iterator som pekar strax efter det sista elementet (om något) i den const-kvalificerade instansen av samlingen. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Hämtar iterator som pekar strax efter det sista elementet (om något) i samlingen. |
...
Namnet IImageTransformOperationCollectionEffectiveData förkortas till [IImageTransformOCollectionEffectiveData](../iimagetransformocollectioneffectivedata/) på grund av att COM-namnens längd inte får överstiga 39. 

## Se även

* Klass [IEffectiveData](../../aspose.slides/ieffectivedata/)
* Klass [IImageTransformOCollectionEffectiveData](../iimagetransformocollectioneffectivedata/)
