...
description: Oföränderligt objekt som representerar en tvånivå (svart/vitt) effekt. Inmatningsfärger vars luminans är mindre än det angivna tröskelvärdet ändras till svart. Inmatningsfärger vars luminans är större än eller lika med det angivna värdet sätts till vitt. Alfaeffektvärdena påverkas inte av denna effekt.
type: docs
weight: 443
url: /sv/aspose.slides.effects/ibileveleffectivedata/
---
## IBiLevelEffectiveData klass


Oföränderligt objekt som representerar en tvånivå (svart/vitt) effekt. Inmatningsfärger vars luminans är mindre än det angivna tröskelvärdet ändras till svart. Inmatningsfärger vars luminans är större än eller lika med det angivna värdet sätts till vitt. Alfaeffektvärdena påverkas inte av denna effekt.
...
| virtual **float** [get_Threshold](./get_threshold/)() | Returnerar tröskelvärdet. Läs-endast **float**. |
