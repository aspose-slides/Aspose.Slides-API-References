...
description: Oföränderligt objekt som representerar en gråskaleffekt. Konverterar alla effektfärgvärden till en nyans av grått som motsvarar deras luminans. Effektens alfa- (opacitet) värden påverkas inte.
type: docs
weight: 677
url: /sv/aspose.slides.effects/igrayscaleeffectivedata/
---
## IGrayScaleEffectiveData klass

Oföränderligt objekt som representerar en gråskaleeffekt. Konverterar alla effektfärgvärden till en nyans av grått som motsvarar deras luminans. Effektens alfa- (opacitet) värden påverkas inte.
