...
description: Oföränderligt objekt som representerar en Alpha Ceiling-effekt. Alpha-värden (opacitet) som är större än noll ändras till 100%. Med andra ord blir allt delvis opakt helt opakt.
type: docs
weight: 274
url: /sv/aspose.slides.effects/ialphaceilingeffectivedata/
---
## IAlphaCeilingEffectiveData klass


Oföränderligt objekt som representerar en Alpha Ceiling-effekt. Alpha (opacitet) värden större än noll ändras till 100 %. Med andra ord blir allt delvis opakt helt opakt.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar C#-liknande flyttalss jämförelse där två NaN anses lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-liknande flyttalss jämförelse där två NaN anses lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satsens låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentinelobjektet. |
