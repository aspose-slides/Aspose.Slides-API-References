...
Oföränderligt objekt som representerar en [Duotone](../duotone/)-effekt. För varje pixel kombineras clr1 och clr2 genom en linjär interpolering för att bestämma den nya färgen för den pixeln.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color1](./get_color1/)() | Returnerar mål-färgformat för mörka pixlar. Skrivskyddad [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color2](./get_color2/)() | Returnerar mål-färgformat för ljusa pixlar. Skrivskyddad [System::Drawing::Color](../../system.drawing/color/). |
