...
description: Representerar en Tint-effekt. Förskjuter effektens färgvärden mot eller bort från nyansen med det angivna värdet.
type: docs
weight: 989
...
Representerar en [Tint](../tint/) effekt. Skiftar effektens färgvärden mot/från nyans med det angivna värdet.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'th mallargument till en svag pekare (istället för delad). Möjliggör att byta pekare i behållare till svagt läge. |
