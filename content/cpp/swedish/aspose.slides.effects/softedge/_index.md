...
Representerar en mjuk kant-effekt. Kanternas form är suddiga, medan fyllningen inte påverkas.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestämmer om den angivna [SoftEdge](./) är lika med den aktuella [SoftEdge](./). |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | Returnerar föräldern [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). Skrivskyddad [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). |
| **double** [get_Radius](./get_radius/)() override | Specificerar radien för suddighet som ska tillämpas på kanterna. Läs **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | Hämtar effektiv Soft Edge-effektsdata med ärvda inställningar tillämpade. |
...
| void [set_Radius](./set_radius/)(**double**) override | Specificerar radien för suddighet som ska tillämpas på kanterna. Skriv **double**. |
