...
description: Oföränderligt objekt som representerar en Alpha Floor-effekt. Alpha (opacitet) värden mindre än 100% ändras till noll. Med andra ord blir allt delvis genomskinligt helt genomskinligt.
type: docs
weight: 300
url: /sv/aspose.slides.effects/ialphaflooreffectivedata/
---
## IAlphaFloorEffectiveData klass


Oföränderligt objekt som representerar en Alpha Floor-effekt. Alpha (opacitet) värden mindre än 100% ändras till noll. Med andra ord blir allt delvis genomskinligt helt genomskinligt.
