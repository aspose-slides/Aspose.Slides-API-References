...
description: Oföränderligt objekt som representerar en Fill Overlay-effekt. En fill overlay kan användas för att specificera en extra fyllning för ett objekt och blanda de två fyllningarna tillsammans.
type: docs
weight: 625
url: /sv/aspose.slides.effects/ifilloverlayeffectivedata/
---
## IFillOverlayEffectiveData klass

Oföränderligt objekt som representerar en Fill Overlay-effekt. En fill overlay kan användas för att specificera en extra fyllning för ett objekt och blanda de två fyllningarna tillsammans.
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode. Skrivskyddad [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | Fill-format. Skrivskyddad [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/). |
