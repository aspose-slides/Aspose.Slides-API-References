...
description: Representerar en Luminance-effekt. Ljusstyrka förskjuter linjärt alla färger närmare vitt eller svart. Kontrast skalar alla färger så att de blir antingen närmare eller längre ifrån varandra.
type: docs
weight: 1028
...
Representerar en [Luminance](./)-effekt. Ljusstyrka förskjuter linjärt alla färger närmare vitt eller svart. Kontrast skalar alla färger så att de blir antingen närmare eller längre ifrån varandra.
...
| Metod | Beskrivning |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestämmer om den angivna [Luminance](./) är lika med den aktuella [Luminance](./). |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Jämför objekt med hjälp av C# [Object.Equals](../../system/object/equals/)-semantiken. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminanceEffectiveData](../iluminanceeffectivedata/)\> [GetEffective](./geteffective/)() override | Hämtar effektiv [Luminance](./)-effektdata med arv tillämpat. |
