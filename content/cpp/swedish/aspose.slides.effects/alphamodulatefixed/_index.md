...
description: Representerar en Alpha Modulate Fixed-effekt. Effektens alfa (opacitet) värden multipliceras med en fast procentsats.
type: docs
weight: 66
...
| Metod | Beskrivning |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestämmer om den angivna [AlphaModulateFixed](./) är lika med den aktuella [AlphaModulateFixed](./). |
...
| **float** [get_Amount](./get_amount/)() override | Returnerar en effektmängd i procent. Läs **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | Hämtar effektiv Alpha Modulate Fixed-effektsdata med arv tillämpat. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Fungerar som en hashfunktion för en specifik typ. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogi till C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-metod. Möjliggör kloning av anpassade typer. |
...
| void [set_Amount](./set_amount/)(**float**) override | Returnerar en effektmängd i procent. Skriv **float**. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogi till C# [Object.ToString()](../../system/object/tostring/)-metod. Möjliggör konvertering av anpassade objekt till sträng. |
...
* Klass [IAlphaModulateFixed](../ialphamodulatefixed/)
