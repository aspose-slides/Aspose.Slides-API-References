...
| virtual **float** [get_Amount](./get_amount/)() | Returnerar mängden effekt i procent. Läs **float**. |
...
| virtual void [set_Amount](./set_amount/)(**float**) | Returnerar mängden effekt i procent. Skriv **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te template-argument till en weak-pekare (istället för shared). Tillåter att byta pekare i behållare till weak-läge. |
