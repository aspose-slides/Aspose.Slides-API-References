...
description: Representerar en Luminance-effekt. Brightness linjärt förflyttar alla färger närmare vitt eller svart. Contrast skalar alla färger så att de antingen ligger närmare eller längre ifrån varandra.
type: docs
weight: 807
url: /sv/aspose.slides.effects/iluminanceeffectivedata/
---
## ILuminanceEffectiveData klass


Representerar en [Luminance](../luminance/) effekt. Brightness linjärt förflyttar alla färger närmare vitt eller svart. Contrast skalar alla färger så att de antingen ligger närmare eller längre ifrån varandra.
...
| virtual **float** [get_Brightness](./get_brightness/)() | Brightness. Skrivskyddad **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Contrast. Skrivskyddad **float**. |
