...
description: Representerar en nyans/mättnad/luminans-effekt. Nyans, mättnad och luminans kan var och en justeras relativt till dess aktuella värde.
type: docs
weight: 703
url: /sv/aspose.slides.effects/ihsleffectivedata/
---
## IHSLEffectiveData klass


Representerar en Hue/Saturation/Luminance-effekt. Nyans, mättnad och luminans kan var och en justeras relativt till dess aktuella värde.
...
| virtual **float** [get_Hue](./get_hue/)() | Returnerar nyansprocent. Skrivskyddad **float**. |
| virtual **float** [get_Luminance](./get_luminance/)() | Returnerar luminansprocent. Skrivskyddad **float**. |
| virtual **float** [get_Saturation](./get_saturation/)() | Returnerar mättnadsprocent. Skrivskyddad **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknars datastruktur som är associerad med objektet. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning för C# lock()-statement. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objekt. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning för C# lock()-statement upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objekt. |
