...
| virtual **float** [get_Direction](./get_direction/)() | Riktning för skugga. Skrivskyddad **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Avstånd för skugga. Skrivskyddad **double**. |
...
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | Anger om skuggan ska rotera med formen om formen roteras. Skrivskyddad **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | Anger den horisontella skalningsfaktorn, negativ skalning orsakar en spegling. Skrivskyddad **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | Anger den vertikala skalningsfaktorn, negativ skalning orsakar en spegling. Skrivskyddad **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Skuggfärg. Skrivskyddad [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | Anger den horisontella skevningsvinkeln (i grader). Skrivskyddad **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | Anger den vertikala skevningsvinkeln (i grader). Skrivskyddad **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog med C# [Object.GetHashCode()](../../system/object/gethashcode/)-metod. Möjliggör hashning av anpassade objekt. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar faktiska typen av objektet. Analog med C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollera om objektet representerar en instans av typen som beskrivs av targetType. Analog med C#-operatorn 'is'. |
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-sats låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentryobjekt. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referenstestar värdetypobjekt med nullptr. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Ökar det delade referensräknaren. Borde inte anropas direkt; använd i stället smarta pekare eller ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Minskar och returnerar det delade referensräknaren. Borde inte anropas direkt; använd i stället smarta pekare eller ThisProtector. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-sats upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentryobjekt. |
