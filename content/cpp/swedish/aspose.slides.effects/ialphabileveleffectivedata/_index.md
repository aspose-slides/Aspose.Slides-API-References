...
description: Oföränderligt objekt som representerar en Alpha Bi-Level-effekt. Alpha-värden (opacitet) som är mindre än tröskeln ändras till 0 (fullt genomskinlig) och alpha-värden som är större än eller lika med tröskeln ändras till 100 % (fullt opak).
type: docs
weight: 248
url: /sv/aspose.slides.effects/ialphabileveleffectivedata/
---
## IAlphaBiLevelEffectiveData klass

Immutabelt objekt som representerar en Alpha Bi-Level-effekt. Alpha-värden (opacitet) som är mindre än tröskeln ändras till 0 (fullt genomskinlig) och alpha-värden som är större än eller lika med tröskeln ändras till 100 % (fullt opak).
...
| virtual **float** [get_Threshold](./get_threshold/)() | Returnerar effekttröskel. Endast läsning **float**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satsens låsuppslag. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
