...
description: Representerar en oskärpeeffekt som appliceras på hela formen, inklusive fyllningen. Alla färgkanaler, inklusive alfa, påverkas.
type: docs
weight: 456
...
Representerar en [Blur](../blur/) effekt som tillämpas på hela formen, inklusive dess fyllning. Alla färgkanaler, inklusive alfa, påverkas.
...
| virtual **bool** [get_Grow](./get_grow/)() | Bestämmer om objektets gränser ska utökas som en följd av oskärpan. True indikerar att gränserna utökas medan false indikerar att de inte gör det. Läs **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Returnerar oskärperadien. Läs **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknare-datastruktur associerad med objektet. |
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Hämtar effektiv data med arv tillämpat. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning med C# lock()-uttryck. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
| virtual void [set_Grow](./set_grow/)(**bool**) | Bestämmer om objektets gränser ska utökas som en följd av oskärpan. True indikerar att gränserna utökas medan false indikerar att de inte gör det. Skriv **bool**. |
| virtual void [set_Radius](./set_radius/)(**double**) | Ställer in oskärperadie. Skriv **double**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning med C# lock()-uttryck. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
