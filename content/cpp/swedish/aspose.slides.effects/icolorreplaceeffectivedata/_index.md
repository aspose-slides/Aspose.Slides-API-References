...
description: Oföränderligt objekt som representerar en färgerstatningseffekt. Alla effektfärger ändras till en fast färg. Alfa-värden påverkas inte.
type: docs
weight: 547
...
Oföränderligt objekt som representerar en färgerstatningseffekt. Alla effektfärger ändras till en fast färg. Alfa-värden påverkas inte.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Returnerar färgformat som kommer att ersätta färgen på varje pixel. Läs-endast [System::Drawing::Color](../../system.drawing/color/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallargument till en svag pekare (istället för delad). Möjliggör byte av pekare i containrar till svagt läge. |
