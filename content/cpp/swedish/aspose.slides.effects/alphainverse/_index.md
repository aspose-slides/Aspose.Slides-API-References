...
description: Representerar en Alpha Inverse-effekt. Alpha (opacitet) värden inverteras genom att subtrahera från 100%.
type: docs
weight: 40
...
| Metod | Beskrivning |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestämmer om den angivna [AlphaInverse](./) är lika med den aktuella [AlphaInverse](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverseEffectiveData](../ialphainverseeffectivedata/)\> [GetEffective](./geteffective/)() override | Hämtar effektiv Alpha Inverse-effektsdata med arv tillämpat. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Ökar delad referenräknare. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Minskar och returnerar delad referenräknare. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
...
* Klass [IAlphaInverse](../ialphainverse/)
