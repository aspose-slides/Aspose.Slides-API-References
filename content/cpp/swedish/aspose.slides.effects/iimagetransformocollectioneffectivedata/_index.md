...
---
## IImageTransformOCollectionEffectiveData klass
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar datatypen för referensräknare som är associerad med objektet. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Returnerar elementet på angivet index. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter det n:te mallargumentet till en weak-pekare (i stället för shared). Tillåter byte av pekare i behållare till weak-läge. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar weak-referensräknare. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar weak-referensräknare. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| virtual  [~Object](../../system/object/~object/)() | Förstör objektet. Frigör alla interna datastrukturer. |

## Anmärkningar

Namnet IImageTransformOperationCollectionEffectiveData förkortas till [IImageTransformOCollectionEffectiveData](./) på grund av att COM-namn inte får vara längre än 39.
