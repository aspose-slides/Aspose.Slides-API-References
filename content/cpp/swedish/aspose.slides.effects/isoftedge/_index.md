...
Representerar en Soft Edge-effekt. Kanterna på formen är suddiga, medan fyllningen inte påverkas.
...
| virtual **double** [get_Radius](./get_radius/)() | Anger radien för oskärpa som ska tillämpas på kanterna. Läs **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Hämtar effektiva data med ärvning tillämpad. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Anger radien för oskärpa som ska tillämpas på kanterna. Skriv **double**. |
