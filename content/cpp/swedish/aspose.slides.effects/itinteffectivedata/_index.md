...
---
## ITintEffectiveData klass

Oföränderligt objekt som representerar en [Tint](../tint/) effekt. Skiftar effektens färgvärden mot/ifrån nyans med det angivna värdet.
...
| virtual **float** [get_Amount](./get_amount/)() | Returnerar effektens mängd. Skrivskyddad **float**. |
| virtual **float** [get_Hue](./get_hue/)() | Returnerar nyans. Skrivskyddad **float**. |
