...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) radius. Läs **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Skuggans riktning. Läs **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Skuggavstånd. Läs **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Skuggans färg. Skrivskyddad [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual void [set_BlurRadius](./set_blurradius/)(**double**) | [Blur](../blur/) radius. Skriv **double**. |
| virtual void [set_Direction](./set_direction/)(**float**) | Skuggans riktning. Skriv **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Skuggavstånd. Skriv **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställ in det n:te mallargumentet till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
