...
description: Representerar en Alpha Replace-effekt. Effektens alfa (opacitet) värden ersätts med ett fast alfa.
type: docs
weight: 79
...
Representerar en Alpha Replace-effekt. Effektens alfavärden (opacitet) ersätts med ett fast alfa.
...
| Metod | Beskrivning |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestämmer om den angivna [AlphaReplace](./) är lika med den aktuella [AlphaReplace](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplaceEffectiveData](../ialphareplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | Hämtar effektiva Alpha Replace-effektsdata med arv tillämpat. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollerar om objektet representerar en instans av typ beskrivs av targetType. Analog till C#-operatorn 'is'. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-sats uppslagning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
...
* Klass [IAlphaReplace](../ialphareplace/)
