...
| virtual **float** [get_Direction](./get_direction/)() | Riktning på skuggan. Läs **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Avstånd för skuggan. Läs **double**. |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | Förinställning. Läs [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Färgen på skuggan. Skrivskyddad [IColorFormat](../../aspose.slides/icolorformat/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Hämtar effektiv data med ärvning tillämpad. |
...
| virtual void [set_Direction](./set_direction/)(**float**) | Riktning på skuggan. Skriv **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Avstånd för skuggan. Skriv **double**. |
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | Förinställning. Skriv [PresetShadowType](../../aspose.slides/presetshadowtype/). |
