...
description: Representerar en Alpha Ceiling-effekt. Alpha (opacitet) värden som är större än noll ändras till 100 %. Med andra ord blir allt som är delvis ogenomskinligt helt ogenomskinligt.
type: docs
weight: 261
...
Representerar en Alpha Ceiling-effekt. Alpha (opacitet) värden som är större än noll ändras till 100 %. Med andra ord blir allt som är delvis ogenomskinligt helt ogenomskinligt.
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning enligt C# lock()-satsen när den släpps. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
