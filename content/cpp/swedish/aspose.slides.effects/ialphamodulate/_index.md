...
description: Representerar en Alpha Modulate-effekt. Effektens alfa (opacitet) värden multipliceras med en fast procentsats. Effektcontainern specificerar en effekt som innehåller alfavärden att modulera.
type: docs
weight: 339
url: /sv/aspose.slides.effects/ialphamodulate/
---
## IAlphaModulate klass


Representerar en Alpha Modulate-effekt. Effektens alfa (opacitet) värden multipliceras med en fast procentsats. Effektecontainern specificerar en effekt som innehåller alfavärden att modulera.
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Hämtar den effektiva datan med arv tillämpat. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Inkremenerar delad referensräknare. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Inkremenerar svag referensräknare. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
