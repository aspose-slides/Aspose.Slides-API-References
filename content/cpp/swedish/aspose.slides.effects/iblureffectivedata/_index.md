...
description: Orörligt objekt som representerar en oskärpeeffekt som appliceras på hela formen, inklusive dess fyllning. Alla färgkanaler, inklusive alfa, påverkas.
type: docs
weight: 469
url: /sv/aspose.slides.effects/iblureffectivedata/
---
## IBlurEffectiveData klass

Orörligt objekt som representerar en [Blur](../blur/) effekt som appliceras på hela formen, inklusive dess fyllning. Alla färgkanaler, inklusive alfa, påverkas.
...
| virtual **bool** [get_Grow](./get_grow/)() | Bestämmer om objektets gränser ska utökas som ett resultat av oskärpan. True indikerar att gränserna utökas medan false indikerar att de inte gör det. Skrivskyddad **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Returnerar oskärpe radius. Skrivskyddad **double**. |
...
|  [Object](../../system/object/object/)() | Skapar objekt. Initierar alla interna datstrukturer. |
