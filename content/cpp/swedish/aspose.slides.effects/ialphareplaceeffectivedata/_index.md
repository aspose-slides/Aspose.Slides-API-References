...
description: Oföränderligt objekt som representerar en Alpha Replace-effekt. Effektens alpha (opacitet) värden ersätts med ett fast alpha.
type: docs
weight: 404
url: /sv/aspose.slides.effects/ialphareplaceeffectivedata/
---
## IAlphaReplaceEffectiveData klass

Oföränderligt objekt som representerar en Alpha Replace-effekt. Effektens alpha (opacitet) värden ersätts med ett fast alpha.
...
| virtual **float** [get_Alpha](./get_alpha/)() | Returnerar nytt alpha-värde i intervallet [0..1] skrivskyddad **float**. |
