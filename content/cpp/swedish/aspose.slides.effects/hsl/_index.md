...
description: Representerar en Hue/Saturation/Luminance-effekt. Hue, saturation och luminance kan var och en justeras relativt sitt nuvarande värde.
type: docs
weight: 222
...
Representerar en färgton/mättnad/luminans-effekt. Färgton, mättnad och luminans kan var och en justeras relativt sitt nuvarande värde.
...
| Metod | Beskrivning |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Avgör om den angivna [HSL](./) är lika med den aktuella [HSL](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHSLEffectiveData](../ihsleffectivedata/)\> [GetEffective](./geteffective/)() override | Hämtar effektiv Hue/Saturation/Luminance-effektsdata med arv tillämpat. |
