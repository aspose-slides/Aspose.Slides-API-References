...
description: Representerar en Alpha Modulate-effekt. Effektens alfavärden (opacitet) multipliceras med en fast procentsats. Effektbehållaren specificerar en effekt som innehåller alfavärden att modulera.
type: docs
weight: 53
...
| Metod | Beskrivning |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestämmer om den angivna [AlphaModulate](./) är lika med den aktuella [AlphaModulate](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateEffectiveData](../ialphamodulateeffectivedata/)\> [GetEffective](./geteffective/)() override | Hämtar effektiv Alpha Modulate-effektsdata med ärvda inställningar tillämpade. |
...
* Klass [IAlphaModulate](../ialphamodulate/)
