...
description: Timer som anropar delegat i en slinga.
type: docs
weight: 14
url: /sv/system.timers/timer/
---
## Timer-klass

[Timer](./) som anropar delegat i en slinga.
...
| Metod | Beskrivning |
| --- | --- |
| void [Close](./close/)() | Stoppar timer, frigör allokerade resurser. |
|  [Component](../../system.componentmodel/component/component/)() | RTTI-information. |
| void [Dispose](./dispose/)() | Stoppar timer, frigör allokerade resurser. |
...
| **bool** [get_AutoReset](./get_autoreset/)() const | Kontrollerar om timer är i automatiskt återställningsläge. |
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | Kontrollerar om komponenten är i designläge. |
| **bool** [get_Enabled](./get_enabled/)() const | Kontrollerar om timer är aktiv. |
| **double** [get_Interval](./get_interval/)() const | Hämtar timerintervall. |
| **bool** [get_IsStopped](./get_isstopped/)() const | Kontrollerar om timer är stoppad. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning för C# lock()-sats. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objekt. |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | Ställer in timer i automatiskt återställningsläge eller ur det. |
| void [set_Enabled](./set_enabled/)(**bool**) | Startar eller stoppar timer. Att starta timer återställer inte tidtagningen om timern redan körs. |
| void [set_Interval](./set_interval/)(**double**) | Ställer in timerintervall. |
...
| void [Start](./start/)() | Startar timer. Återupptar inte tidtagning om timern redan körs. |
| void [Stop](./stop/)() | Stoppar timer. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning för C# lock()-sats. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objekt. |
