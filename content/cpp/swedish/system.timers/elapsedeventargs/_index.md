...
description: Argument för timerhändelse.
type: docs
weight: 1
url: /sv/system.timers/elapsedeventargs/
---
## ElapsedEventArgs klass

Arguments för timerhändelse.
...
| Metod | Beskrivning |
| --- | --- |
|  [ElapsedEventArgs](./elapsedeventargs/)(**int32_t**, **int32_t**) | Skapar argumentobjekt med angivna parametrar. |
...
| [DateTime](../../system/datetime/) [get_SignalTime](./get_signaltime/)() | Hämtar signaltid. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referenstillräknarens datstruktur som är associerad med objektet. |
