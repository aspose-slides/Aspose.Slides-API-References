...
description: Representerar spårpenseln.
type: docs
weight: 27
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Hämtar penselfärgen för en linje. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | Hämtar bläckeffekttypen (t.ex. Galaxy, Gold, Silver) som definierar den visuella stilen för bläckstrecket. Värdet hämtas från penselns egendom "inkEffects". Om ingen erkänd effekt anges, returneras [InkEffectType::NotDefined](../inkeffecttype/). |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Hämtar penselstorleken för en linje i punkter. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Ställer in penselfärgen för en linje. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Ställer in penselstorleken för en linje i punkter. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter det n:te mallargumentet till en weak-pekare (snarare än en shared). Tillåter att byta pekare i container till weak-läge. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar weak-referensräknare. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar weak-referensräknare. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
