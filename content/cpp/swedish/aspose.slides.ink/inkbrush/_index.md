...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Hämtar penselfärgen för en linje. |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | Hämtar bläckeffekttypen (t.ex. Galaxy, Gold, Silver) som definierar den visuella stilen för bläckstrecket. Värdet läses från penselns egenskap "inkEffects". Om ingen igenkänd effekt anges, returneras [InkEffectType::NotDefined](../inkeffecttype/). |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Hämtar penselstorleken för en linje i punkter. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Ställer in penselfärgen för en linje. |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | Ställer in penselstorleken för en linje i punkter. |
