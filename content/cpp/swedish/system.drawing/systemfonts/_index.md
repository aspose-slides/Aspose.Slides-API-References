...
description: Tillhandahåller en uppsättning förhands skapade Font-objekt som representerar typsnitt som används för att visa text i Windows-displayelement. Detta är en statisk typ utan instansfunktioner. Du bör aldrig skapa instanser av den på något sätt.
type: docs
weight: 339
url: /sv/system.drawing/systemfonts/
---
## SystemFonts klass

Tillhandahåller en uppsättning förhands skapade [Font](../font/)-objekt som representerar teckensnitt som används för att visa text i [Windows](../../system.windows/)-displayelement. Detta är en statisk typ utan instansfunktioner. Du bör aldrig skapa instanser av den på något sätt.
...
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_CaptionFont](./get_captionfont/)() | INTE IMPLEMENTERAD. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_DefaultFont](./get_defaultfont/)() | Returnerar ett [Font](../font/)-objekt som representerar standardteckensnittet som programmet kan använda för dialogrutor och formulär. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_IconTitleFont](./get_icontitlefont/)() | INTE IMPLEMENTERAD. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MenuFont](./get_menufont/)() | INTE IMPLEMENTERAD. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MessageBoxFont](./get_messageboxfont/)() | INTE IMPLEMENTERAD. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_SmallCaptionFont](./get_smallcaptionfont/)() | INTE IMPLEMENTERAD. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_StatusFont](./get_statusfont/)() | INTE IMPLEMENTERAD. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktör. Kopierar egentligen ingenting, utan initierar bara ett nytt objekt och möjliggör kopieringskonstruktion av subklasser. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning upp enligt C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objekt. |
