...
| [Color](../color/) [get_Color](./get_color/)() const | Returnerar denna pensels färg. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar faktiskt ingenting, den initierar bara ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
...
| void [set_Color](./set_color/)([Color](../color/)) | Ställer in färgen på denna pensel. |
...
|  [SolidBrush](./solidbrush/)(const [Color](../color/)\&) | Skapar ett nytt [SolidBrush](./)-objekt och initierar det med den angivna färgen. |
