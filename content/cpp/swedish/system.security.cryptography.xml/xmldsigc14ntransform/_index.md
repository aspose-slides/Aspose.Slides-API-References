...
description: "Representerar C14N XML-kanoniseringstransformen för en digital signatur utan kommentarer. Objekt av den här klassen bör endast allokeras med System::MakeObject() funktionen. Skapa aldrig en instans av den här typen på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller påståendefel. Inneslut alltid den här klassen i en System::SmartPtr pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 170
url: /sv/system.security.cryptography.xml/xmldsigc14ntransform/
---
## XmlDsigC14NTransform klass

Representerar C14N XML-kanoniseringstransformen för en digital signatur utan kommentarer. Objekt av den här klassen bör endast allokeras med [System::MakeObject()](../../system/makeobject/) funktion. Skapa aldrig en instans av den här typen på stacken eller med operatorn new, eftersom det kommer att resultera i körfel och/eller påståendefel. Inneslut alltid den här klassen i en [System::SmartPtr](../../system/smartptr/)-pekare och använd pekaren för att skicka den till funktioner som argument.
