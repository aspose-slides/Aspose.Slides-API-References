...
description: "Definierar en formatoberoende mekanism för dataöverföring. Objekt av denna klass bör endast allokeras med funktionen System::MakeObject(). Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller assertfel. Packa alltid in denna klass i en System::SmartPtr-pekare och använd den pekaren för att skicka den till funktioner som argument."
type: docs
weight: 1
url: /sv/system.security.cryptography.xml/dataobject/
---
## DataObject klass

Definierar en formatoberoende mekanism för dataöverföring. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kommer att leda till körfel och/eller assertfel. Packa alltid in denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd den pekaren för att skicka den till funktioner som argument.
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning av C# lock()-uttrycket. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentryobjektet. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning upp (unlock) av C# lock()-uttrycket. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentryobjektet. |
