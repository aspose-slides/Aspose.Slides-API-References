...
---
## INotImplementedWarningInfo klass

Representerar en varning om en känd icke implementerad funktion som inte kommer att implementeras inom den närmaste framtiden.
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Returnerar en mänskligt läsbar beskrivning av denna varning. Skriva-skyddad [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Returnerar en typ av varning. Skriva-skyddad [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Om mottagaren inte är null avslutar varningen till en specificerad mottagare och kastar AbortRequestedException om mottagaren beslutar att avbryta en operation. |
...
| virtual  [~Object](../../system/object/~object/)() | Förstör objekt. Befriar alla interna datastrukturer. |
