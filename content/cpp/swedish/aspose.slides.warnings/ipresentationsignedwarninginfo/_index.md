...
description: Denna varning indikerar att presentationen som läses in har signaturen och att signaturen kommer att tas bort under bearbetning.
type: docs
weight: 40
url: /sv/aspose.slides.warnings/ipresentationsignedwarninginfo/
---
## IPresentationSignedWarningInfo klass


Denna varning indikerar att presentationen som läses in har signaturen och att signaturen kommer att tas bort under bearbetning.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar C#-liknande jämförelse av flyttal där två NaN betraktas som lika även om IEC 60559:1989 anger att NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-liknande jämförelse av flyttal där två NaN betraktas som lika även om IEC 60559:1989 anger att NaN inte är lika med något värde, inklusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för interna ändamål. |
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Returnerar en människoläsbar beskrivning av denna varning. Skrivskyddad [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Returnerar en varningstyp. Skrivskyddad [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Om mottagaren inte är null avslutas varningen till en specificerad mottagare och AbortRequestedException kastas om mottagaren beslutade att avbryta en operation. |
