...
description: Representerar ett grundgränssnitt för alla varningar.
type: docs
weight: 66
...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Returnerar en läsbar beskrivning av denna varning. Skrivskyddad [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](./get_warningtype/)() | Returnerar en varningstyp. Skrivskyddad [IWarningInfo::get_WarningType](./get_warningtype/). |
...
| virtual void [SendWarning](./sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Om mottagaren inte är null avslutar varningen till en angiven mottagare och kastar AbortRequestedException om mottagaren beslutar att avbryta en operation. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n:te templateargumentet till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
