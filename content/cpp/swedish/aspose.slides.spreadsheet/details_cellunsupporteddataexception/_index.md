...
description: Undantaget som kastas när ett ej stödd data påträffas i en kalkylarkscell.
type: docs
weight: 40
url: /sv/aspose.slides.spreadsheet/details_cellunsupporteddataexception/
---
## Details_CellUnsupportedDataException klass

Undantaget som kastas när ett ej stödd data påträffas i en kalkylarkscell.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar jämförelse av flyttal i C#-stil där två NaNs anses vara lika även om enligt IEC 60559:1989 NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar jämförelse av flyttal i C#-stil där två NaNs anses vara lika även om enligt IEC 60559:1989 NaN inte är lika med något värde, inklusive NaN. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning enligt C# lock()-satsen. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vakt-objektet. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsupphävning enligt C# lock()-satsen. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vakt-objektet. |
