...
description: Undantaget som kastas när en beräknad formel inte är korrekt eller inte har kunnat analyseras.
type: docs
weight: 14
url: /sv/aspose.slides.spreadsheet/details_cellinvalidformulaexception/
---
## Details_CellInvalidFormulaException klass


Det undantag som kastas när en beräknad formel inte är korrekt eller inte har kunnat analyseras.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | Returnerar dictionary med anpassad undantagsdata. |
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Returnerar ett 32-bits heltalsvärde som är en HRESULT-kod kopplad till undantaget som representeras av det aktuella objektet. |
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Hämtar en cellreferens som innehåller den ogiltiga formeln. |
