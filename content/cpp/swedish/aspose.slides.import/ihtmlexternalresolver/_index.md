...
description: Callback-gränssnitt som används av HTML-importrutinen för att hämta refererade objekt såsom bilder.
type: docs
weight: 53
url: /sv/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver klass

Callback-gränssnitt som används av HTML-importrutinen för att hämta refererade objekt såsom bilder.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | Mappar en URI till ett objekt som innehåller den faktiska resursen. |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | Löser den absoluta URI:n från bas- och relativa URI:er. |
...
Föråldrad
:   Utdaterad. Use [IExternalResourceResolver](../iexternalresourceresolver/) instead. Will be removed in 17.12 release.

## Se även

* Klass [IExternalResourceResolver](../iexternalresourceresolver/)
