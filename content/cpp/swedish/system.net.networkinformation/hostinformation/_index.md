...
description: "Representerar information om en värd. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av den här typen på stacken eller med operator new, eftersom det kommer att leda till körfel och/eller assertionsfel. Omslut alltid denna klass i System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 1
url: /sv/system.net.networkinformation/hostinformation/
---
## HostInformation klass

Representerar information om en värd. Objekt av denna klass bör bara allokeras med [System::MakeObject()](../../system/makeobject/) funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att resultera i körfel och/eller assertionsfel. Omslut alltid denna klass i [System::SmartPtr](../../system/smartptr/) pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| static [String](../../system/string/) [get_DomainName](./get_domainname/)() | Returnerar domänen där den lokala datorn är registrerad. |
| static [String](../../system/string/) [get_HostName](./get_hostname/)() | Returnerar värddatorns namn för den lokala datorn. |
