...
description: "Basundantagsklassen kastas av HttpClient- och HttpMessageHandler-klasserna. Skapa aldrig instanser av denna klass manuellt. Använd HttpRequestException-klassen istället. Omslut aldrig HttpRequestException-klassens instanser i System::SmartPtr."
type: docs
weight: 14
url: /sv/system.net.http/details_httprequestexception/
---
## Details_HttpRequestException klass

Basundantagsklassen kastas av klasserna [HttpClient](../httpclient/) och [HttpMessageHandler](../httpmessagehandler/). Skapa aldrig instanser av denna klass manuellt. Använd HttpRequestException-klassen istället. Omslut aldrig HttpRequestException-klassens instanser i [System::SmartPtr](../../system/smartptr/).
...
| Method | Description |
| --- | --- |
|  [Details_HttpRequestException](./details_httprequestexception/)() | Skapar en ny instans. |
|  [Details_HttpRequestException](./details_httprequestexception/)(std::nullptr_t) | Skapar en ny instans. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/)) | Skapar en ny instans. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Skapar en ny instans. |
| virtual void [DoThrow](../../system/details_exception/dothrow/)(const [ExceptionPtr](../../system/exceptionptr/)\&) const | Kastar en undantagsinstans som är innesluten av ett undantagsomslag. |
