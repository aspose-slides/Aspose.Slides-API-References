...
description: Innehåller verktygsmetoderna.
type: docs
weight: 131
url: /sv/system.net.http/httputilities/
---
## HttpUtilities klass

Innehåller verktygsmetoderna.
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar objekts faktiska typ. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Kontrollerar om den angivna URI:n är en HTTP-URI. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter det n:te mallargumentet till en svag pekare (istället för en delad). Möjliggör att byta pekare i behållare till svagt läge. |
...
| Field | Description |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | Standard-HTTP-versionen för att skicka förfrågningar. |
| static [DefaultResponseVersion](./defaultresponseversion/) | Standard-HTTP-versionen för att ta emot svar. |
