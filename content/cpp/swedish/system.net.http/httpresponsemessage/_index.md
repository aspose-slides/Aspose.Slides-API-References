...
| Metod | Beskrivning |
| --- | --- |
| void [Dispose](./dispose/)() override | Frigör den aktuella instansen. Denna metod frigör också innehållet i HTTP-svaret. |
| [System::SharedPtr](../../system/sharedptr/)\<[HttpResponseMessage](./)\> [EnsureSuccessStatusCode](./ensuresuccessstatuscode/)() | Kontrollerar statuskoden. HttpRequestException kastas när statuskoden inte tillhör 2xx. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[HttpContent](../httpcontent/)\> [get_Content](./get_content/)() const | Hämtar innehållet i HTTP-svaret. |
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpResponseHeaders](../../system.net.http.headers/httpresponseheaders/)\> [get_Headers](./get_headers/)() const | Returnerar HTTP-innehållshuvudena. |
| **bool** [get_IsSuccessStatusCode](./get_issuccessstatuscode/)() const | Kontrollerar om statuskoden indikerar att åtgärden som begärts av klienten mottogs, förstås och accepterades. |
| [String](../../system/string/) [get_ReasonPhrase](./get_reasonphrase/)() const | Hämtar Reason-Phrase som skickas av servrar tillsammans med statuskoden. |
| [System::SharedPtr](../../system/sharedptr/)\<[HttpRequestMessage](../httprequestmessage/)\> [get_RequestMessage](./get_requestmessage/)() const | Hämtar HTTP-begäranmeddelandet. |
| [HttpStatusCode](../../system.net/httpstatuscode/) [get_StatusCode](./get_statuscode/)() const | Hämtar HTTP-statuskoden. |
| [System::Version](../../system/version/) [get_Version](./get_version/)() const | Hämtar HTTP-versionen. |
...
|  [HttpResponseMessage](./httpresponsemessage/)([HttpStatusCode](../../system.net/httpstatuscode/)) | Skapar en ny instans. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Jämför en värdetypsobjekt med nullptr efter referens. |
...
| void [set_Content](./set_content/)([System::SharedPtr](../../system/sharedptr/)\<[HttpContent](../httpcontent/)\>) | Sätter innehållet i HTTP-svaret. |
| void [set_ReasonPhrase](./set_reasonphrase/)([String](../../system/string/)) | Sätter Reason-Phrase som skickas av servrar tillsammans med statuskoden. |
| void [set_RequestMessage](./set_requestmessage/)([System::SharedPtr](../../system/sharedptr/)\<[HttpRequestMessage](../httprequestmessage/)\>) | Sätter HTTP-begäranmeddelandet. |
| void [set_StatusCode](./set_statuscode/)([HttpStatusCode](../../system.net/httpstatuscode/)) | Sätter HTTP-statuskoden. |
