...
description: Enumerator som används av IEnumerable.Select()-extensionsmetoden.
type: docs
weight: 79
url: /sv/system.collections.generic.details/enumeratorselectadapter/
---
## EnumeratorSelectAdapter klass

Enumerator som används av IEnumerable.Select() extensionsmetod.
...
| --- | --- |
| Source | Källtypen för samlingselementen. |
| Result | Resultattypen för samlingselementen. |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | Hämtar aktuellt element. |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Utför det första [MoveNext()](../../system.collections.generic/ienumerator/movenext/)-anropet och förbereder enumeratorobjektet för användning av VirtualizedIterator. |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | Märker enumeratorn som ägs av virtualiserad iterator. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog till C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-metoden. Möjliggör kloning av anpassade typer. |
| **bool** [MoveNext](./movenext/)() override | Flyttar enumeratorn till nästa element. Om inget element tidigare refererats, sätts referensen till det första tillgängliga elementet. Om behållarens slut nås, görs inget. |
...
| void [Reset](./reset/)() override | Återställer enumeratorn till positionen före första elementet. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning för C# lock()-statement. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
