...
type: docs
weight: 105
url: /sv/system.collections.generic.details/enumeratorselectmanyadapter/
---
## EnumeratorSelectManyAdapter klass
...
| **bool** [MoveNext](./movenext/)() override | Flyttar enumeratorn till nästa element. Om inget element refererades tidigare, sätts referensen till det första tillgängliga elementet. Om slutet av behållaren nås, gör den ingenting. |
...
| void [Reset](./reset/)() override | Återställer enumerator till positionen före första elementet. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Hämtar det aktuella värdet av den delade referensräkningen. |
