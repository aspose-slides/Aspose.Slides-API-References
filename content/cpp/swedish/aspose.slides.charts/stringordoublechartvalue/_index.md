...
description: "Representerar sträng- eller dubbeltalvärde som kan lagras i pptx-presentationsdokument på två sätt: 1) i cell/celler i arbetsbok relaterad till diagram; 2) som ett bokstavligt värde."
type: docs
weight: 1353
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() override | Returnerar diagramdata cell. Läs [IChartDataCell](../ichartdatacell/). |
| **double** [get_AsLiteralDouble](./get_asliteraldouble/)() override | Returnerar värde som bokstavlig double. Läs **double**. |
| [System::String](../../system/string/) [get_AsLiteralString](./get_asliteralstring/)() override | Returnerar värde som bokstavlig sträng. Läs [System::String](../../system/string/). |
...
| void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Sätter diagramdata cell. Skriv [IChartDataCell](../ichartdatacell/). |
| void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) override | Sätter värde som bokstavlig double. Skriv **double**. |
| void [set_AsLiteralString](./set_asliteralstring/)([System::String](../../system/string/)) override | Sätter värde som bokstavlig sträng. Skriv [System::String](../../system/string/). |
...
| void [set_DataSourceType](../basechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) override | Anger om egenskapen AsCell, AsCells, AsLiteralString eller AsLiteralDouble är giltig i avledda klasser. Med andra ord specificerar den vilken typ av värde Data-egenskapen har. Skriv [Charts::DataSourceType](../datasourcetype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'th mallargument till en weak-pekare (istället för shared). Tillåter att byta pekare i behållare till weak-läge. |
...
* Klass [IStringOrDoubleChartValue](../istringordoublechartvalue/)
