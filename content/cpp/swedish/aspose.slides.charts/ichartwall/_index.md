...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Returnerar väggens fyllning, linje, effekt, 3d-stilar. Skrivskyddad [IFormat](../iformat/). |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | Returnerar eller sätter bildtypen. Läs [PictureType](../picturetype/). |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | Returnerar väggtjockleken som en procentsats av den största dimensionen av plotvolymen. Läs **int32_t**. |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | Returnerar eller sätter bildtypen. Skriv [PictureType](../picturetype/). |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | Sätter väggtjockleken som en procentsats av den största dimensionen av plotvolymen. Skriv **int32_t**. |
