...
| virtual **float** [get_Bottom](./get_bottom/)() | Hämtar toppen av diagramobjektet som en bråkdel av diagrammets höjd. Läs-endast **float**. |
...
| virtual **float** [get_Height](./get_height/)() | Anger diagramobjektets höjd som en bråkdel av diagrammets höjd. Läs **float**. |
...
| virtual **float** [get_Right](./get_right/)() | Hämtar högerkanten av diagramobjektet som en bråkdel av diagrammets bredd. Läs-endast **float**. |
...
| virtual **float** [get_Width](./get_width/)() | Anger diagramobjektets bredd som en bråkdel av diagrammets bredd. Läs **float**. |
| virtual **float** [get_X](./get_x/)() | Anger diagramobjektets x-position (vänster) som en bråkdel av diagrammets bredd. Läs **float**. |
| virtual **float** [get_Y](./get_y/)() | Anger diagramobjektets topp som en bråkdel av diagrammets höjd. Läs **float**. |
...
| virtual void [set_Height](./set_height/)(**float**) | Anger diagramobjektets höjd som en bråkdel av diagrammets höjd. Skriv **float**. |
| virtual void [set_Width](./set_width/)(**float**) | Anger diagramobjektets bredd som en bråkdel av diagrammets bredd. Skriv **float**. |
| virtual void [set_X](./set_x/)(**float**) | Anger diagramobjektets x-position (vänster) som en bråkdel av diagrammets bredd. Skriv **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Anger diagramobjektets topp som en bråkdel av diagrammets höjd. Skriv **float**. |
