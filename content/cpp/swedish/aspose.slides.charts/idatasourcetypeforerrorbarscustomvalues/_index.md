...
description: Anger typer av värden i ChartDataPoint.ErrorBarsCustomValues egenskapslista
type: docs
weight: 976
url: /sv/aspose.slides.charts/idatasourcetypeforerrorbarscustomvalues/
---
## IDataSourceTypeForErrorBarsCustomValues klass
...
| virtual [DataSourceType](../datasourcetype/) [get_DataSourceTypeForXMinusValues](./get_datasourcetypeforxminusvalues/)() | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktiv i datapunkternas XMinus-egendomsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde som egenskapen ChartDataPoint.ErrorBarsCustomValues.XMinus.Data har. Läs [DataSourceType](../datasourcetype/). |
| virtual [DataSourceType](../datasourcetype/) [get_DataSourceTypeForXPlusValues](./get_datasourcetypeforxplusvalues/)() | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktiv i datapunkternas XPlus-egendomsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde som egenskapen ChartDataPoint.ErrorBarsCustomValues.XPlus.Data har. Läs [DataSourceType](../datasourcetype/). |
| virtual [DataSourceType](../datasourcetype/) [get_DataSourceTypeForYMinusValues](./get_datasourcetypeforyminusvalues/)() | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktiv i datapunkternas YMinus-egendomsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde som egenskapen ChartDataPointEx.ErrorBarsCustomValues.YMinus.Data har. Läs [DataSourceType](../datasourcetype/). |
| virtual [DataSourceType](../datasourcetype/) [get_DataSourceTypeForYPlusValues](./get_datasourcetypeforyplusvalues/)() | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktiv i datapunkternas YPlus-egendomsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde som egenskapen ChartDataPointEx.ErrorBarsCustomValues.YPlus.Data har. Läs [DataSourceType](../datasourcetype/). |
...
| virtual void [set_DataSourceTypeForXMinusValues](./set_datasourcetypeforxminusvalues/)([DataSourceType](../datasourcetype/)) | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktiv i datapunkternas XMinus-egendomsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde som egenskapen ChartDataPoint.ErrorBarsCustomValues.XMinus.Data har. Skriv [DataSourceType](../datasourcetype/). |
| virtual void [set_DataSourceTypeForXPlusValues](./set_datasourcetypeforxplusvalues/)([DataSourceType](../datasourcetype/)) | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktiv i datapunkternas XPlus-egendomsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde som egenskapen ChartDataPoint.ErrorBarsCustomValues.XPlus.Data har. Skriv [DataSourceType](../datasourcetype/). |
| virtual void [set_DataSourceTypeForYMinusValues](./set_datasourcetypeforyminusvalues/)([DataSourceType](../datasourcetype/)) | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktiv i datapunkternas YMinus-egendomsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde som egenskapen ChartDataPointEx.ErrorBarsCustomValues.YMinus.Data har. Skriv [DataSourceType](../datasourcetype/). |
| virtual void [set_DataSourceTypeForYPlusValues](./set_datasourcetypeforyplusvalues/)([DataSourceType](../datasourcetype/)) | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktiv i datapunkternas YPlus-egendomsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde som egenskapen ChartDataPointEx.ErrorBarsCustomValues.YPlus.Data har. Skriv [DataSourceType](../datasourcetype/). |
