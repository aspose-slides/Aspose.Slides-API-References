...
description: Tillhandahåller åtkomst till upp/ner-staplar i linje- eller aktiediagram.
type: docs
weight: 1249
url: /sv/aspose.slides.charts/iupdownbarsmanager/
---
## IUpDownBarsManager-klass

Tillhandahåller åtkomst till upp/ner-staplar i linje- eller aktiediagram.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | Returnerar formatet för nerstaplarna. Skrivskyddad [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | Returnerar mellanrumbredd. Läs **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | Avgör om diagrammet har upp/ner-staplar. Läs **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | Returnerar formatet för upstaplarna. Skrivskyddad [IFormat](../iformat/). |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | Ställer in mellanrumbredd. Skriv **int32_t**. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | Avgör om diagrammet har upp/ner-staplar. Skriv **bool**. |
