...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [Add](./add/)([TrendlineType](../trendlinetype/)) | Lägger till den nya [Trendline](../trendline/) i slutet av en samling och returnerar den. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Hämtar antalet element som faktiskt finns i samlingen. Läs-end-only **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [idx_get](./idx_get/)(**int32_t**) | Hämtar elementet på det angivna indexet. Läs-end-only [ITrendline](../itrendline/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\>) | Tar bort det angivna värdet. |
