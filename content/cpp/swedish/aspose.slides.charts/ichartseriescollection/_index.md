...
description: Representerar en samling av IChartSeries
type: docs
weight: 833
url: /sv/aspose.slides.charts/ichartseriescollection/
---
## IChartSeriesCollection klass

Representerar en samling av [IChartSeries](../ichartseries/)
...
| Metod | Beskrivning |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) | Skapar en ny diagramserie och lägger till den i samlingen. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) | Skapar en ny diagramserie från [IChartDataCell](../ichartdatacell/) och lägger till den i samlingen. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) | Skapar en ny diagramserie från [IChartCellCollection](../ichartcellcollection/) och lägger till den i samlingen. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) | Skapar en ny diagramserie från värde och lägger till den i samlingen. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Hämtar en iterator som pekar direkt efter det sista konstanterade elementet (om något) i samlingen. |
| virtual void [Clear](./clear/)() | Tar bort alla element (inklusive diagramstilen) från samlingen. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Hämtar en iterator som pekar direkt efter det sista elementet (om något) i den konstanterade instansen av samlingen. |
...
| virtual **int32_t** [get_Count](../../aspose.slides/igenericcollection/get_count/)() | Returnerar antalet beteenden i en samling. Skrivskyddad **int32_t**. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Returnerar ett värde som indikerar om åtkomst till samlingen är synkroniserad (trådsäker). Skrivskyddad **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../../aspose.slides/igenericcollection/get_syncroot/)() | Returnerar ett synkroniseringsrot. Skrivskyddad [System::Object](../../system/object/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [idx_get](./idx_get/)(**int32_t**) | Hämtar elementet vid angivet index. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Söker efter den specificerade [IChartSeries](../ichartseries/) och returnerar det nollbaserade indexet för den första förekomsten i hela samlingen |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) | Skapar en ny diagramserie och infogar den i samlingen. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar egentligen ingenting, bara initierar ett nytt objekt och möjliggör kopiekonstruktion av subklasser. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar egentligen ingenting, bara initierar ett nytt objekt och möjliggör kopiekonstruktion av subklasser. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Tar bort det specificerade värdet. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Tar bort elementet vid angivet index |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning för C# lock()-satser. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
