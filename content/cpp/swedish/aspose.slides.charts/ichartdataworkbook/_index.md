...
---
## IChartDataWorkbook klass

Tillhandahåller åtkomst till inbäddad [Excel](../../aspose.slides.excel/) arbetsbok
...
| Metod | Beskrivning |
| --- | --- |
| virtual void [CalculateFormulas](./calculateformulas/)() | Beräknar alla formler i arbetsboken och uppdaterar motsvarande cellvärden. |
| virtual void [Clear](./clear/)(**int32_t**) | Rensa alla cellvärden på bladet |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\> [get_Worksheet](./get_worksheet/)(**int32_t**) | Returnerar kalkylbladet i den här arbetsboken vid det angivna indexet. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheetCollection](../ichartdataworksheetcollection/)\> [get_Worksheets](./get_worksheets/)() | Hämtar en samling av kalkylblad. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)([System::String](../../system/string/), **int32_t**, **int32_t**) | Hämtar cellen som kan användas för diagramserier eller kategorier |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, **int32_t**, **int32_t**) | Hämtar cellen som kan användas för diagramserier eller kategorier |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, [System::String](../../system/string/)) | Hämtar cellen som kan användas för diagramserier eller kategorier |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, [System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Hämtar cellen som kan användas för diagramserier eller kategorier |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, **int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Hämtar cellen som kan användas för diagramserier eller kategorier |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [GetCellCollection](./getcellcollection/)([System::String](../../system/string/), **bool**) | Hämtar mängden celler. |
