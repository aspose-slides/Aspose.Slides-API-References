...
description: Representerar markör av ett chert.
type: docs
weight: 1301
...
Representerar markör av ett chert.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Hämtar markörfyllning. Skrivskyddad [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | Representerar markörstorleken i ett linjediagram, spridningsdiagram eller radardiagram. Läs **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | Representerar markörstilen i ett linjediagram, spridningsdiagram eller radardiagram. Läs [MarkerStyleType](../markerstyletype/). |
...
| void [set_Size](./set_size/)(**int32_t**) override | Representerar markörstorleken i ett linjediagram, spridningsdiagram eller radardiagram. Skriv **int32_t**. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | Representerar markörstilen i ett linjediagram, spridningsdiagram eller radardiagram. Skriv [MarkerStyleType](../markerstyletype/). |
