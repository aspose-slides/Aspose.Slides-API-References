...
description: "Anger typer av värden i egenskapslistan för ChartDataPoint::get_ErrorBarsCustomValues"
type: docs
weight: 404
...
Anger typer av värden i [ChartDataPoint::get_ErrorBarsCustomValues](../chartdatapoint/get_errorbarscustomvalues/) egenskapslista
...
| [DataSourceType](../datasourcetype/) [get_DataSourceTypeForXMinusValues](./get_datasourcetypeforxminusvalues/)() override | Anger om AsCell- eller AsLiteralString- eller AsLiteralDouble-egenskapen är aktiv i datapunkternas XMinus-egenskapsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde ChartDataPoint.ErrorBarsCustomValues.XMinus.Data-egenskapen har. Läs [DataSourceType](../datasourcetype/). |
| [DataSourceType](../datasourcetype/) [get_DataSourceTypeForXPlusValues](./get_datasourcetypeforxplusvalues/)() override | Anger om AsCell- eller AsLiteralString- eller AsLiteralDouble-egenskapen är aktiv i datapunkternas XPlus-egenskapsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde ChartDataPoint.ErrorBarsCustomValues.XPlus.Data-egenskapen har. Läs [DataSourceType](../datasourcetype/). |
| [DataSourceType](../datasourcetype/) [get_DataSourceTypeForYMinusValues](./get_datasourcetypeforyminusvalues/)() override | Anger om AsCell- eller AsLiteralString- eller AsLiteralDouble-egenskapen är aktiv i datapunkternas YMinus-egenskapsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde ChartDataPointEx.ErrorBarsCustomValues.YMinus.Data-egenskapen har. Läs [DataSourceType](../datasourcetype/). |
| [DataSourceType](../datasourcetype/) [get_DataSourceTypeForYPlusValues](./get_datasourcetypeforyplusvalues/)() override | Anger om AsCell- eller AsLiteralString- eller AsLiteralDouble-egenskapen är aktiv i datapunkternas YPlus-egenskapsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde ChartDataPointEx.ErrorBarsCustomValues.YPlus.Data-egenskapen har. Läs [DataSourceType](../datasourcetype/). |
...
| void [set_DataSourceTypeForXMinusValues](./set_datasourcetypeforxminusvalues/)([DataSourceType](../datasourcetype/)) override | Anger om AsCell- eller AsLiteralString- eller AsLiteralDouble-egenskapen är aktiv i datapunkternas XMinus-egenskapsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde ChartDataPoint.ErrorBarsCustomValues.XMinus.Data-egenskapen har. Skriv [DataSourceType](../datasourcetype/). |
| void [set_DataSourceTypeForXPlusValues](./set_datasourcetypeforxplusvalues/)([DataSourceType](../datasourcetype/)) override | Anger om AsCell- eller AsLiteralString- eller AsLiteralDouble-egenskapen är aktiv i datapunkternas XPlus-egenskapsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde ChartDataPoint.ErrorBarsCustomValues.XPlus.Data-egenskapen har. Skriv [DataSourceType](../datasourcetype/). |
| void [set_DataSourceTypeForYMinusValues](./set_datasourcetypeforyminusvalues/)([DataSourceType](../datasourcetype/)) override | Anger om AsCell- eller AsLiteralString- eller AsLiteralDouble-egenskapen är aktiv i datapunkternas YMinus-egenskapsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde ChartDataPointEx.ErrorBarsCustomValues.YMinus.Data-egenskapen har. Skriv [DataSourceType](../datasourcetype/). |
| void [set_DataSourceTypeForYPlusValues](./set_datasourcetypeforyplusvalues/)([DataSourceType](../datasourcetype/)) override | Anger om AsCell- eller AsLiteralString- eller AsLiteralDouble-egenskapen är aktiv i datapunkternas YPlus-egenskapsobjekt för anpassade felstaplar. Med andra ord specificerar den vilken typ av värde ChartDataPointEx.ErrorBarsCustomValues.YPlus.Data-egenskapen har. Skriv [DataSourceType](../datasourcetype/). |
...
* Klass [IDataSourceTypeForErrorBarsCustomValues](../idatasourcetypeforerrorbarscustomvalues/)
