...
description: Representerar egenskaper för datatabellen.
type: docs
weight: 417
...
Representerar egenskaper för datatabellen.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](./get_chart/)() override | Returnerar diagram. Skrivskyddad [IChart](../ichart/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Returnerar linje-, fyllnings- och effektstilar för ett objekt. Skrivskyddad [IFormat](../iformat/). |
| **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() override | Sant om diagrammets datatabell har horisontella cellgränser. Läs **bool**. |
| **bool** [get_HasBorderOutline](./get_hasborderoutline/)() override | Sant om diagrammets datatabell har konturkanter. Läs **bool**. |
| **bool** [get_HasBorderVertical](./get_hasbordervertical/)() override | Sant om diagrammets datatabell har vertikala cellgränser. Läs **bool**. |
| **bool** [get_ShowLegendKey](./get_showlegendkey/)() override | Sant om förklaringsnyckeln för datamärket är synlig. Läs **bool**. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollera om objektet representerar en instans av den typ som beskrivs av targetType. Analog till C# 'is' operator. |
...
| void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) override | Sant om diagrammets datatabell har horisontella cellgränser. Skriv **bool**. |
| void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) override | Sant om diagrammets datatabell har konturkanter. Skriv **bool**. |
| void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) override | Sant om diagrammets datatabell har vertikala cellgränser. Skriv **bool**. |
| void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) override | Sant om förklaringsnyckeln för datamärket är synlig. Skriv **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Sätt n'te mallargument till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
