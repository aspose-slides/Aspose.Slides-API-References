...
| virtual **bool** [get_Hide](./get_hide/)() | Returnerar dold-flaggan för legendposten. Läs **bool**. |
...
| virtual void [set_Hide](./set_hide/)(**bool**) | Sätter dold-flaggan för legendposten. Skriv **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätt n'th mall-argument till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svagt läge. |
