...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Returnerar linje-, fyllnings- och effektstilar för ett objekt. Läs-endast [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | Sant om diagrammets datatabell har horisontella cellkanter. Läs **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | Sant om diagrammets datatabell har konturkanter. Läs **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | Sant om diagrammets datatabell har vertikala cellkanter. Läs **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | Sant om datamärkeslegendnyckeln är synlig. Läs **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartTextFormat](../icharttextformat/)\> [get_TextFormat](../iformattedtextcontainer/get_textformat/)() | Returnerar diagramtextformatet. Läs-endast [IChartTextFormat](../icharttextformat/). |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | Sant om diagrammets datatabell har horisontella cellkanter. Skriv **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | Sant om diagrammets datatabell har konturkanter. Skriv **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | Sant om diagrammets datatabell har vertikala cellkanter. Skriv **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | Sant om datamärkeslegendnyckeln är synlig. Skriv **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställer in n:te mallargumentet till en svag pekare (i stället för delad). Tillåter att byta pekare i behållare till svagt läge. |
