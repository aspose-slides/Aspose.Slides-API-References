...
description: Representerar formatinställningar för rutnätslinjer.
type: docs
weight: 768
url: /sv/aspose.slides.charts/ichartlinesformat/
---
## IChartLinesFormat klass

Representerar formatinställningar för rutnätslinjer.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_Effect](./get_effect/)() | Returnerar effekter som används för en diagramlinje. Läs-endast [IEffectFormat](../../aspose.slides/ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_Line](./get_line/)() | Returnerar stilinställningar för en diagramlinje. Läs-endast [ILineFormat](../../aspose.slides/ilineformat/). |
