...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)(**int32_t**) | Returnerar en diagramcell på det angivna indexet. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [get_AsCells](./get_ascells/)() | Returnerar samlingen av diagramceller. Läs [IChartCellCollection](../ichartcellcollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktuell. Med andra ord specificerar den typen av värde för Data-egenskapen. Denna egenskap är skrivskyddad. För att ändra värdet på denna egenskap kan du använda en av ChartDataPointCollection.DataSourceTypeFor<...>-egenskaperna. Läs [DataSourceType](../datasourcetype/). |
...
| virtual void [set_AsCells](./set_ascells/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>) | Sätter samlingen av diagramceller. Skriv [IChartCellCollection](../ichartcellcollection/). |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Anger om AsCell eller AsLiteralString eller AsLiteralDouble-egenskapen är aktuell. Med andra ord specificerar den typen av värde för Data-egenskapen. Denna egenskap är skrivskyddad. För att ändra värdet på denna egenskap kan du använda en av ChartDataPointCollection.DataSourceTypeFor<...>-egenskaperna. Skriv [DataSourceType](../datasourcetype/). |
