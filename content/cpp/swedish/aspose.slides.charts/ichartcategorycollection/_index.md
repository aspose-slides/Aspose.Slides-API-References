...
description: Representerar en samling av IChartCategory
type: docs
weight: 599
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Om kategorin finns i samlingen, returneras den. Annars skapas en ny diagramkategori från [IChartDataCell](../ichartdatacell/) och läggs till i samlingen. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Skapar en ny [IChartCategory](../ichartcategory/) från värdet och lägger till den i samlingen. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Hämtar en iterator som pekar på det första elementet (om någon) i den konstantkvalificerade instansen av samlingen. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Hämtar en iterator som pekar på det första konstantkvalificerade elementet (om någon) i samlingen. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Hämtar en iterator som pekar precis efter det sista konstantkvalificerade elementet (om någon) i samlingen. |
| virtual void [Clear](./clear/)() | Tar bort alla element från samlingen. |
| virtual void [CopyTo](../../aspose.slides/igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Kopierar alla element från samlingen till den specificerade arrayen. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Hämtar en iterator som pekar precis efter det sista elementet (om någon) i samlingen. Denna iterator kan inte användas för att ändra ett refererat objekt eftersom [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) returnerar ett kopieringsobjekt av T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Hämtar en iterator som pekar precis efter det sista elementet (om någon) i den konstantkvalificerade instansen av samlingen. |
...
| virtual **int32_t** [get_Count](../../aspose.slides/igenericcollection/get_count/)() | Returnerar antalet beteenden i en samling. Endast läsbar **int32_t**. |
| virtual **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() | Returnerar antalet nivåer för kategorigruppering som används. Är mer än ett för flernivåkategorier. Endast läsbar **int32_t**. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Returnerar ett värde som indikerar om åtkomst till samlingen är synkroniserad (trådsäker). Endast läsbar **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../../aspose.slides/igenericcollection/get_syncroot/)() | Returnerar ett synkroniseringsrot. Endast läsbar [System::Object](../../system/object/). |
| virtual **bool** [get_UseCells](./get_usecells/)() | Om true används kalkylblad för att lagra kategorier (detta fall stödjer flernivåskategorier). Om false används kalkylblad INTE för att lagra värden (och detta fall stödjer inte flernivåskategorier). Läs **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) | Hämtar elementet på det specificerade indexet. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Söker efter den specificerade [IChartCategory](../ichartcategory/) och returnerar det nollbaserade indexet för den första förekomsten i hela samlingen |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Tar bort det specificerade värdet. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Tar bort elementet på det angivna indexet. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar den delade referensräkningen med ett specificerat värde. |
| virtual void [set_UseCells](./set_usecells/)(**bool**) | Om true används kalkylblad för att lagra kategorier (detta fall stödjer flernivåskategorier). Om false används kalkylblad INTE för att lagra värden (och detta fall stödjer inte flernivåskategorier). Skriv **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställer in n:te mallargumentet som en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
| int [SharedCount](../../system/object/sharedcount/)() const | Hämtar nuvarande värde av den delade referensräkningen. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Ökar den delade referensräkningen. Bör inte anropas direkt; använd smartpekare eller ThisProtector istället. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Minskar och returnerar den delade referensräkningen. Bör inte anropas direkt; använd smartpekare eller ThisProtector istället. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar den svaga referensräkningen. Bör inte anropas direkt; använd smartpekare eller ThisProtector istället. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar den svaga referensräkningen. Bör inte anropas direkt; använd smartpekare eller ThisProtector istället. |
