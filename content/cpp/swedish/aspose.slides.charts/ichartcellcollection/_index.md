...
description: Representerar en samling celler med data.
type: docs
weight: 625
url: /sv/aspose.slides.charts/ichartcellcollection/
---
## IChartCellCollection klass
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Lägger till en ny cell i samlingen. |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Skapar [IChartDataCell](../ichartdatacell/) från specificerat värde och lägger till det i samlingen. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Hämtar antalet celler i samlingen. Läs-endast **int32_t**. |
| virtual [System::String](../../system/string/) [GetCellsAddress](./getcellsaddress/)() | Returnerar adressen till uppsättningen av celler i arbetsboken. |
| virtual [System::String](../../system/string/) [GetConcatenatedValuesFromCells](./getconcatenatedvaluesfromcells/)() | Konkatenationssträng från alla cellers strängvärden. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | Returnerar en cell ([IChartDataCell](../ichartdatacell/)) efter index. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning enligt C# lock()-satser. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentryobjektet. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Tar bort en cell från samlingen efter index. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satser för upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentryobjekt. |
