...
---
## IPieSplitCustomPointCollection klass

Representerar en samling av punkter som skall ritas i den andra pajen eller stapeln på ett bar-of-pie- eller pie-of-pie-diagram med en anpassad delning.
...
| Metod | Beskrivning |
| --- | --- |
| virtual void [Add](./add/)(const **int32_t**\&) | Lägger till datapunkt enligt dess index i föräldrakollektionens serie-punktsamling. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Hämtar iterator som pekar precis efter det sista const-kvalificerade elementet (om någon) i samlingen. |
...
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopierar alla samlings-element till befintliga array-element. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Hämtar iterator som pekar precis efter det sista elementet (om någon) i samlingen. Denna iterator kan inte användas för att ändra ett refererat objekt eftersom [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) returnerar ett kopie-objekt av T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Hämtar iterator som pekar precis efter det sista elementet (om någon) i den const-kvalificerade instansen av samlingen. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) | Returnerar diagramdatapunkt efter index. |
...
| virtual void [Remove](./remove/)(**int32_t**) | Tar bort objekt från samlingen efter dess index i föräldrakollektionens serie-punkter. |
