...
description: "Representerar dubbelvärde som kan lagras i pptx-presentationsdokument på två sätt: 1) i cell/celler i arbetsbok relaterad till diagram; 2) som ett bokstavligt värde."
type: docs
weight: 456
...
Representerar dubbelvärde som kan lagras i pptx-presentationsdokument på två sätt: 1) i cell/celler i arbetsbok relaterad till diagram; 2) som ett bokstavligt värde.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() override | Returnerar diagramdatacell. Läs [IChartDataCell](../ichartdatacell/). |
| **double** [get_AsLiteralDouble](./get_asliteraldouble/)() override | Returnerar värde som bokstavlig double. Läs **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](./get_data/)() override | Returnerar Data-objekt. Läs [System::Object](../../system/object/). |
| [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../basechartvalue/get_datasourcetype/)() override | Anger om egenskapen AsCell, AsCells, AsLiteralString eller AsLiteralDouble är aktuell i avledda klasser. Med andra ord specificerar den typen av värde för Data-egenskapen. Läs [Charts::DataSourceType](../datasourcetype/). |
...
| void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Sätter diagramdatacell. Skriv [IChartDataCell](../ichartdatacell/). |
| void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) override | Sätter värde som bokstavlig double. Skriv **double**. |
| void [set_Data](./set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Sätter Data-objekt. Skriv [System::Object](../../system/object/). |
| void [set_DataSourceType](../basechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) override | Anger om egenskapen AsCell, AsCells, AsLiteralString eller AsLiteralDouble är aktuell i avledda klasser. Med andra ord specificerar den typen av värde för Data-egenskapen. Skriv [Charts::DataSourceType](../datasourcetype/). |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Minskar och returnerar delad referensräknare. Börde inte anropas direkt; använd i stället smarta pekare eller ThisProtector. |
| **double** [ToDouble](./todouble/)() override | Konverterar till **double**. |
...
* Klass [IDoubleChartValue](../idoublechartvalue/)
