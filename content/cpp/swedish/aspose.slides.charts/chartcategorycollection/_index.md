...
description: Representerar en samling av ChartCategory
type: docs
weight: 79
...
| Metod | Beskrivning |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Om kategorin finns i samlingen, returneras den. Annars skapas en ny diagramkategori från [IChartDataCell](../ichartdatacell/) och läggs till i samlingen. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Skapar en ny [ChartCategory](../chartcategory/) från värdet och lägger till den i samlingen. |
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>, **int32_t**) override | Kopierar alla element i samlingen till den angivna arrayen. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-liknande jämförelse av dubbelprecisionsflyttal där två NaN-värden betraktas som lika även om IEC 60559:1989 anger att NaN inte är lika med något värde, inklusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för interna ändamål. |
| **int32_t** [get_Count](./get_count/)() override | Returnerar antalet element i samlingen. Läs-endast **int32_t**. |
| **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() override | Returnerar antalet gruppnivåer för kategorier som används. Är fler än ett för flernivåkategorier. Läs-endast **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Returnerar ett värde som indikerar om åtkomst till Listan är synkroniserad (trådsäker). Läs-endast **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Returnerar ett objekt som kan användas för att synkronisera åtkomst till samlingen. Läs-endast [System::Object](../../system/object/). |
| **bool** [get_UseCells](./get_usecells/)() override | Om true används kalkylbladet för att lagra kategorier (detta fall stöder flernivåkategorier). Om false används kalkylbladet INTE för att lagra värden (och detta fall stöder inte flernivåkategorier). Läs **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referenstårningsdatatyp som är associerad med objektet. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returnerar en enumerator som itererar igenom samlingen. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog till C# [Object.GetHashCode()](../../system/object/gethashcode/)-metoden. Gör det möjligt att hashning av anpassade objekt. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar den faktiska typen av objektet. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) override | Hämtar elementet på det angivna indexet. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | Söker efter den angivna [ChartCategory](../chartcategory/) och returnerar det nollbaserade indexet för den första förekomsten i hela samlingen. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformera varje element i en sekvens till en ny form genom att inkludera elementets index. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | Tar bort det angivna värdet. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Tar bort elementet på det angivna indexet. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referenstillräkning med angivet värde. |
| void [set_UseCells](./set_usecells/)(**bool**) override | Om true används kalkylbladet för att lagra kategorier (detta fall stöder flernivåkategorier). Om false används kalkylbladet INTE för att lagra värden (och detta fall stöder inte flernivåkategorier). Skriv **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Sätter n'te template-argument till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
| int [SharedCount](../../system/object/sharedcount/)() const | Hämtar aktuellt värde för delad referenstillräkning. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsningupphävning enligt C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Hämtar en iterator som pekar på det första elementet (om något) i den konstantkvalificerade instansen av samlingen. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Hämtar en iterator som pekar precis efter det sista elementet (om något) i den konstantkvalificerade instansen av samlingen. |
