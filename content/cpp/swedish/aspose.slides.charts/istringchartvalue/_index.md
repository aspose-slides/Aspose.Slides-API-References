...
Representerar strängvärde som kan lagras i pptx-presentationdokument på två sätt: 1) i cell/celler i arbetsboken som är relaterad till diagrammet; 2) som ett bokstavligt värde.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](../imultiplecellchartvalue/get_ascell/)(**int32_t**) | Returnerar en diagramcell på angivet index. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [get_AsCells](../imultiplecellchartvalue/get_ascells/)() | Returnerar samlingen av diagramceller. Läs [IChartCellCollection](../ichartcellcollection/). |
| virtual [System::String](../../system/string/) [get_AsLiteralString](./get_asliteralstring/)() | Returnerar den bokstavliga strängen om egenskapen DataSourceType är [DataSourceType::StringLiterals](../datasourcetype/). Läs [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | Anger om egenskapen AsCell eller AsLiteralString eller AsLiteralDouble är aktuell. Med andra ord anger den vilken typ av värde Data-egenskapen har. Denna egenskap är skrivskyddad. För att ändra värdet på denna egenskap kan du använda någon av egenskaperna ChartDataPointCollection.DataSourceTypeFor<...>. Läs [DataSourceType](../datasourcetype/). |
| virtual [System::String](../../system/string/) [GetCellsAddressInWorkbook](./getcellsaddressinworkbook/)() | Om egenskapen DataSourceType är [DataSourceType::Worksheet](../datasourcetype/) returnerar denna metod adressen till cellerna i arbetsboken som representerar strängdata. Annars returneras en tom sträng. |
...
| virtual void [set_AsCells](../imultiplecellchartvalue/set_ascells/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>) | Ställer in samlingen av diagramceller. Skriv [IChartCellCollection](../ichartcellcollection/). |
| virtual void [set_AsLiteralString](./set_asliteralstring/)([System::String](../../system/string/)) | Ställer in den bokstavliga strängen om egenskapen DataSourceType är [DataSourceType::StringLiterals](../datasourcetype/). Skriv [System::String](../../system/string/). |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Anger om egenskapen AsCell eller AsLiteralString eller AsLiteralDouble är aktuell. Med andra ord anger den vilken typ av värde Data-egenskapen har. Denna egenskap är skrivskyddad. För att ändra värdet på denna egenskap kan du använda någon av egenskaperna ChartDataPointCollection.DataSourceTypeFor<...>. Skriv [DataSourceType](../datasourcetype/). |
| virtual void [SetFromOneCell](./setfromonecell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Ställer in värdet från angiven cell. |
...
* Klass [IMultipleCellChartValue](../imultiplecellchartvalue/)
