...
description: Representerar en samling punkter för att dela en punkt i ett stapeldiagram eller paj-i-paj-diagram med en anpassad delning.
type: docs
weight: 1314
...
Representerar en samling punkter för att dela en punkt i ett stapeldiagram-eller paj-i-paj-diagram med en anpassad delning.
...
| Metod | Beskrivning |
| --- | --- |
| void [Add](./add/)(const **int32_t**\&) override | Lägger till datapunkten enligt dess index i den överordnade seriens punktsamling. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Lägger till datapunkt i samlingen. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Hämtar en iterator som pekar strax efter det sista const-kvalificerade elementet (om något) i samlingen. |
| void [Clear](./clear/)() override | Tar bort alla objekt från [ICollection](../../system.collections.generic/icollection/). |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) const override | Avgör om [ICollection](../../system.collections.generic/icollection/) innehåller ett specifikt värde. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>, **int32_t**) override | Kopierar elementen i [ICollection](../../system.collections.generic/icollection/) till ett [System::Array](../../system/array/), med början på ett specifikt [System::Array](../../system/array/)-index. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopierar alla samlingselement till befintliga array-element. |
| [iterator](./iterator/) [end](./end/)() | Hämtar en iterator som pekar strax efter det sista elementet (om något) i samlingen. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Hämtar en iterator som pekar strax efter det sista elementet (om något) i den const-kvalificerade instansen av samlingen. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar flyttalsjämförelse i C#-stil för dubbelprecision där två NaN-värden anses lika även om IEC 60559:1989 anger att NaN inte är lika med något värde, inklusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för interna ändamål. |
| **int32_t** [get_Count](./get_count/)() const override | Returnerar antalet diagram-datapunkter. Läs-endast **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Hämtar ett värde som indikerar om [ICollection](../../system.collections.generic/icollection/) är skrivskyddad. Läs-endast **bool**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() | Returnerar ett värde som indikerar om åtkomst till samlingen är synkroniserad (trådsäker). Läs-endast **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Returnerar ett synkroniserings-rot. Läs-endast [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) override | Returnerar diagram-datapunkt för angivet index. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Hoppar över ett specificerat antal intilliggande element från sekvensens början och returnerar resten. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Returnerar ett specificerat antal intilliggande element från sekvensens början. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning enligt C# lock()-statement. Anropas direkt eller via [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Tar bort objekt från samlingen. |
| void [Remove](./remove/)(**int32_t**) override | Tar bort objekt från samlingen enligt dess index i föräldraserie-punktsamlingen. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-statement avlåsning. Anropas direkt eller via [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Hämtar en iterator som pekar strax efter det sista elementet (om något) i den const-kvalificerade instansen av samlingen. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Hämtar en iterator som pekar strax efter det sista elementet (om något) i samlingen. |
...
| virtual  [~ICollection](../../system.collections.generic/icollection/~icollection/)() | Destruktör. |
...
* Klass [IPieSplitCustomPointCollection](../ipiesplitcustompointcollection/)
