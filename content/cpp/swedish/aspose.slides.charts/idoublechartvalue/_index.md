...
| virtual void [set_AsCell](../isinglecellchartvalue/set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Sätter diagramdatacell. Skriv [IChartDataCell](../ichartdatacell/). |
| virtual void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) | Sätter bokstavligt dubbelt värde om DataSourceType = [Charts::DataSourceType::DoubleLiterals](../datasourcetype/). Skriv **double**. |
...
| virtual **double** [ToDouble](./todouble/)() | Konverterar till double. |
