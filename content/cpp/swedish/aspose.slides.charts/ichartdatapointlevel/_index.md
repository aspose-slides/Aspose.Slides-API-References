...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Representerar formateringsegenskaper för datapunktnivå. Läs [IFormat](../iformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | Representerar datalabel för datapunktnivå. Tillämpas för Treemap- och Sunburst-serietyper. Skrivskyddad [IDataLabel](../idatalabel/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätt n't:te mallargument till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svagt läge. |
