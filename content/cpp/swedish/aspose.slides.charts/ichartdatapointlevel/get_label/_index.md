...
description: Representerar datalabel för datapunktnivå. Tillämpas för Treemap- och Sunburst-serietyper. Skrivskyddad IDataLabel.
type: docs
weight: 14
url: /sv/aspose.slides.charts/ichartdatapointlevel/get_label/
---
## IChartDataPointLevel::get_Label() metod


Representerar datalabel för datapunktnivå. Tillämpas för Treemap och Sunburst-serietyper. Skrivskyddad [IDataLabel](../../idatalabel/).
