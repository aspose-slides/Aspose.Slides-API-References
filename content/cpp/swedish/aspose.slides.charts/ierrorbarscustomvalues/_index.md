...
description: Anger felstaplarnas värden. Den ska endast användas när värdetypen för felstaplar är Custom.
type: docs
weight: 1015
url: /sv/aspose.slides.charts/ierrorbarscustomvalues/
---
## IErrorBarsCustomValues klass

Anger felstaplarnas värden. Den ska endast användas när felstaplarna värdetyp är Custom.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() | Anger felstapelns värde i negativ riktning. Tillgänglig om felstaplarna värdetyp är Custom och ErrorBarsXFormat är tillåtet. I alla andra fall returnerar denna egenskap null. Skrivskyddad [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() | Anger felstapelns värde i positiv riktning. Tillgänglig om felstaplarna värdetyp är Custom och ErrorBarsXFormat är tillåtet. I alla andra fall returnerar denna egenskap null. Skrivskyddad [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() | Anger felstapelns värde i negativ riktning. Tillgänglig om felstaplarna värdetyp är Custom och ErrorBarsYFormat är tillåtet. I alla andra fall returnerar denna egenskap null. Skrivskyddad [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() | Anger felstapelns värde i positiv riktning. Tillgänglig om felstaplarna värdetyp är Custom och ErrorBarsYFormat är tillåtet. I alla andra fall returnerar denna egenskap null. Skrivskyddad [IDoubleChartValue](../idoublechartvalue/). |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satsen låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/) sentinel-objekt. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter det n'th mallargumentet till en svag pekare (istället för shared). Tillåter att byta pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satsen upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/) sentinel-objekt. |
