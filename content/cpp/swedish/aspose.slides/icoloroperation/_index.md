...
| virtual [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const | Returnerar typen av en operation. Läs-endast [ColorTransformOperation](../colortransformoperation/). |
| virtual **float** [get_Parameter](./get_parameter/)() | Returnerar en parameter för en operation. Läs-endast **float**. |
