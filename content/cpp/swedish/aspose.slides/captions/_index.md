...
Representerar WebVTT stängda undertexter.
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Returnerar de binära data för de stängda undertexterna. Läs-endast **uint8_t**[]. |
| [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() override | Returnerar den globalt unika identifieraren (GUID) för de stängda undertexterna. Läs-endå [System::Guid](../../system/guid/). |
| [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() override | Returnerar undertexternas data som en UTF-8-kodad sträng. Läs-endå [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Label](./get_label/)() override | Returnerar etiketten för de stängda undertexterna. Läs [System::String](../../system/string/). |
...
| void [set_Label](./set_label/)([System::String](../../system/string/)) override | Ställer in etiketten för de stängda undertexterna. Skriv [System::String](../../system/string/). |
