...
| [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() override | Ljusriktning. Läs [LightingDirection](../lightingdirection/). |
| [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() override | Representerar en förinställd ljusrätt som kan tillämpas på en form. Light rig representerar en grupp av ljus orienterade på ett specifikt sätt i förhållande till en 3D-scen. Läs [LightRigPresetType](../lightrigpresettype/). |
...
| void [set_Direction](./set_direction/)([LightingDirection](../lightingdirection/)) override | Ljusriktning. Skriv [LightingDirection](../lightingdirection/). |
| void [set_LightType](./set_lighttype/)([LightRigPresetType](../lightrigpresettype/)) override | Representerar en förinställd ljusrätt som kan tillämpas på en form. Light rig representerar en grupp av ljus orienterade på ett specifikt sätt i förhållande till en 3D-scen. Skriv [LightRigPresetType](../lightrigpresettype/). |
| void [SetRotation](./setrotation/)(**float**, **float**, **float**) override | En rotation definieras genom användning av en latitudkoordinat, en longitudkoordinat och en revolution kring axeln som latitud- och longitudkoordinaterna. Om något av koordinatvärdena är std::numeric_limits<float>::quiet_NaN() är hela rotationen odefinierad. |
