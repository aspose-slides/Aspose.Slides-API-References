...
---
## IPictureFillFormatEffectiveData klass
...
| virtual **float** [get_CropBottom](./get_cropbottom/)() | Returnerar antalet procent av den faktiska bildhöjden som beskärs bort från bildens botten. Skrivskyddad **float**. |
| virtual **float** [get_CropLeft](./get_cropleft/)() | Returnerar antalet procent av den faktiska bildbredden som beskärs bort från bildens vänstra sida. Skrivskyddad **float**. |
| virtual **float** [get_CropRight](./get_cropright/)() | Returnerar antalet procent av den faktiska bildbredden som beskärs bort från bildens högra sida. Skrivskyddad **float**. |
| virtual **float** [get_CropTop](./get_croptop/)() | Returnerar antalet procent av den faktiska bildhöjden som beskärs bort från bildens topp. Skrivskyddad **float**. |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | Returnerar dpi som används för att fylla en bild. Skrivskyddad **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | Returnerar bilden. Skrivskyddad [IPictureEffectiveData](../ipictureeffectivedata/). |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | Returnerar bildfyllnadsläget. Skrivskyddad [Slides::PictureFillMode](../picturefillmode/). |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satsens låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/) sentry object. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satsens upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/) sentry object. |
