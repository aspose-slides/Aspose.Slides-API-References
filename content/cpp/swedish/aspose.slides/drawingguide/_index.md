...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Returnerar färgen på ritguiden. Läs [System::Drawing::Color](../../system.drawing/color/). |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Returnerar orienteringen på ritguiden. Läs [Slides::Orientation](../orientation/). |
| **float** [get_Position](./get_position/)() override | Returnerar positionen för ritguiden i punkter från slide-ens övre vänstra hörn. Läs **float**. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Sätter färgen på ritguiden. Skriv [System::Drawing::Color](../../system.drawing/color/). |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) override | Sätter orienteringen på ritguiden. Skriv [Slides::Orientation](../orientation/). |
| void [set_Position](./set_position/)(**float**) override | Sätter positionen för ritguiden i punkter från slide-ens övre vänstra hörn. Skriv **float**. |
...
* Klass [IDrawingGuide](../idrawingguide/)
