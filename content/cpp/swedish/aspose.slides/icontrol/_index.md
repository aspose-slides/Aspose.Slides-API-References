...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_ActiveXControlBinary](./get_activexcontrolbinary/)() | Specificerar beständigheten för en ActiveX-kontroll när metoden som används för att spara är antingen PersistStream, PersistStreamInit eller PersistStorage. |
| virtual [System::Guid](../../system/guid/) [get_ClassId](./get_classid/)() | Hämtar klass-id för denna kontroll. Skrivskyddad [System::Guid](../../system/guid/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_Frame](./get_frame/)() | Returnerar kontrollens ram. Läs [IShapeFrame](../ishapeframe/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Returnerar namn på denna kontroll. Läs [System::String](../../system/string/). |
| virtual [PersistenceType](../persistencetype/) [get_Persistence](./get_persistence/)() | Hämtar metoden som används för att lagra egenskaper för ActiveX-kontrollen. Skrivskyddad [PersistenceType](../persistencetype/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IControlPropertiesCollection](../icontrolpropertiescollection/)\> [get_Properties](./get_properties/)() | Returnerar en samling av ActiveX-egenskaper. Skrivskyddad [IControlPropertiesCollection](../icontrolpropertiescollection/). |
| virtual [System::String](../../system/string/) [get_Property](./get_property/)([System::String](../../system/string/)) | Returnerar en ActiveX-egenskap på det angivna indexet. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../islidecomponent/get_slide/)() | Returnerar bas-bildspelet. Skrivskyddad [IBaseSlide](../ibaseslide/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_SubstitutePictureFormat](./get_substitutepictureformat/)() | Returnerar ControlEx bild-fyllnings-egenskapsobjekt. Skrivskyddad [IPictureFillFormat](../ipicturefillformat/). |
...
| virtual void [set_Frame](./set_frame/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\>) | Ställer in kontrollens ram. Skriv [IShapeFrame](../ishapeframe/). |
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Returnerar namnet på denna kontroll. Skriv [System::String](../../system/string/). |
| virtual void [set_Property](./set_property/)([System::String](../../system/string/), [System::String](../../system/string/)) | Sätter en ActiveX-egenskap på det angivna indexet. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-sats uppsläpp. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
