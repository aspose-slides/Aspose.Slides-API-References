...
type: docs
weight: 898
url: /sv/aspose.slides/floatcolor/
---
## FloatColor klass
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar C#-stilens flyttalsjämförelse där två NaN betraktas som lika även om IEC 60559:1989 föreskriver att NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-stilens flyttalsjämförelse där två NaN betraktas som lika även om IEC 60559:1989 föreskriver att NaN inte är lika med något värde, inklusive NaN. |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Analog till C# Object.GetHashCode() metod. Möjliggör hashning av anpassade objekt. |
