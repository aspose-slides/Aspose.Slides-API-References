...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Returnerar en kopia av ljudfilens data. Vid stora mängder data bör metoden [IAudio::GetStream](./getstream/) övervägas för att förhindra onödig inläsning av ljuddata i minnet eller till och med OutOfMemoryException. Skrivskyddad **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Returnerar ett MIME-typ för ett ljud, kodad i [IAudio::get_BinaryData](./get_binarydata/). Skrivskyddad [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning via C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
