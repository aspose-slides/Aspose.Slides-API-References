...
description: Representerar en hanterare som håller beteendet för fotnot, datum-tid och sidnummer-platshållare för alla bildtyper.
type: docs
weight: 183
...
Representerar en hanterare som håller beteendet för fotnot, datum-tid och sidnummer-platshållare för alla bildtyper.
...
| **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() override | Hämtar värde som indikerar att en datum-tid-platshållare är närvarande. Read**bool**. |
| **bool** [get_IsFooterVisible](./get_isfootervisible/)() override | Hämtar värde som indikerar att en fotnot-platshållare är närvarande. Read **bool**. |
| **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() override | Hämtar värde som indikerar att en sidnummer-platshållare är närvarande. Read**bool**. |
...
| void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) override | Ställer in text för bildens datum-tid-platshållare. |
| void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) override | Ändrar synlighet för bildens datum-tid-platshållare. |
| void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) override | Ställer in text för bildens fotnot-platshållare. |
| void [SetFooterVisibility](./setfootervisibility/)(**bool**) override | Ändrar synlighet för bildens fotnot-platshållare. |
| void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) override | Ändrar synlighet för bildens sidnummer-platshållare. |
