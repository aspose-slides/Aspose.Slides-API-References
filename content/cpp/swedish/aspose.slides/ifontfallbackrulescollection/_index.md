...
---
## IFontFallBackRulesCollection klass
...
| Metod | Beskrivning |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | Lägg till en ny FallBack-regel i slutet av samlingen. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\> [idx_get](./idx_get/)(**int32_t**) | Hämtar regeln på det angivna indexet. Skrivskyddad [IFontFallBackRule](../ifontfallbackrule/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | Tar bort den första förekomsten av en specifik FallBack-regel från samlingen. |
