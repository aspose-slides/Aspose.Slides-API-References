...
| --- | --- | --- |
| Custom | -1 | [Table](../table/) har en anpassad stil. Detta är ett endast återvändande värde. |
| None | 0 | Ingen stil. |
| MediumStyle2Accent1 | 1 | Medium Style 2 - Accent 1. |
| MediumStyle2 | 2 | Medium Style 2. |
| NoStyleNoGrid | 3 | Ingen stil, inget rutnät. |
...
| NoStyleTableGrid | 10 | Ingen stil, [Table](../table/) rutnät. |
