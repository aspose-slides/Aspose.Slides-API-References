...
| Metod | Beskrivning |
| --- | --- |
| virtual **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) | Kontrollerar om ett lösenord är korrekt för en presentation som skyddas med ett öppet lösenord. |
| virtual **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) | Kontrollerar om ett lösenord för att ändra är korrekt för en skrivskyddad presentation. |
...
| virtual **bool** [get_IsEncrypted](./get_isencrypted/)() | Hämtar True om den bundna presentationen är krypterad, annars False. Skrivskyddad **bool**. |
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | Hämtar ett värde som indikerar om den bundna presentationen är skyddad med ett lösenord för att öppna. |
| virtual [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() | Hämtar ett värde som indikerar om den bundna presentationen är skrivskyddad. |
| virtual [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() | Hämtar formatet för den bundna presentationen. Skrivskyddad [Slides::LoadFormat](../loadformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() | Hämtar dokumentegenskaper för den bundna presentationen. |
...
| virtual void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) | Uppdaterar egenskaper för den bundna presentationen. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar svag referensräknare. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar svag referensräknare. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Skriver den bundna presentationen till en ström. |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) | Skriver den bundna presentationen till en fil. |
