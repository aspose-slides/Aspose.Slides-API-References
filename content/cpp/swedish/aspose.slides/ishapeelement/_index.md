...
description: Representerar en del av en form med samma kontur- och fyllnadsegenskaper.
type: docs
weight: 3693
...
Representerar en del av en form med samma kontur- och fyllnadsegenskaper.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallargument till en svag pekare (istället för delad). Tillåter att ändra pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning för C#-statement lock() upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
