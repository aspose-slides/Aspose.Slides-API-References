...
description: Kapslar grundläggande tjänsteinfrastruktur för objekt som kan vara föremål för arv av egendomsvärden.
type: docs
weight: 4928
...
Kapslar grundläggande tjänsteinfrastruktur för objekt som kan vara föremål för arv av egendomsvärden.
...
| Metod | Beskrivning |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Jämför med angivet objekt. |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../idomobject/)\> [get_Parent_Immediate](../idomobject/get_parent_immediate/)() | Returnerar Parent_Immediate-objekt. Läs-endast [IDOMObject](../idomobject/). |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../ipviobject/get_parent_ipresentationcomponent/)() | Returnerar förälder [IPresentationComponent](../ipresentationcomponent/). Läs-endast [IPresentationComponent](../ipresentationcomponent/). |
| virtual ASPOSE_SLIDES_LOCAL_API **uint32_t** [get_Version](../ipviobject/get_version/)() | Version. Läs-endast **uint32_t**. |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Returnerar hash-kod. |
