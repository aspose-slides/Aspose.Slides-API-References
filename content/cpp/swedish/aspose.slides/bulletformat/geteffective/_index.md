...
description: Hämtar effektiv punktformateringsdata med ärftlighet tillämpad.
type: docs
weight: 248
...
Hämtar effektiv punktformateringsdata med ärftlighet tillämpad.
...
En [IBulletFormatEffectiveData](../../ibulletformateffectivedata/).

## Anmärkningar

Detta exempel demonstrerar hur man hämtar vissa effektiva punktformategenskaper.
```cpp
