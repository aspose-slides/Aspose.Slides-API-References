...
| virtual **int32_t** [get_Height](./get_height/)() | Hämtar bildens höjd i pixlar. |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_Size](./get_size/)() | Hämtar bildens storlek. |
| virtual **int32_t** [get_Width](./get_width/)() | Hämtar bildens bredd i pixlar. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollerar om objektet är en instans av typ som beskrivs av targetType. Analog till C# 'is'-operatorn. |
...
| virtual void [Save](./save/)([System::String](../../system/string/)) | Sparar bilden till en fil. |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/)) | Sparar bilden till en fil i det angivna formatet. |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/)) | Sparar bilden till en ström i det angivna formatet. |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/), **int32_t**) | Sparar bilden till en fil i det angivna formatet och kvaliteten. |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/), **int32_t**) | Sparar bilden till en ström i det angivna formatet och kvaliteten. |
...
Detta gränssnitt tillhandahåller en gemensam abstraktion för hantering av både raster- och vektorbilder. 

Implementeringar kan variera beroende på den underliggande bildtypen. 
