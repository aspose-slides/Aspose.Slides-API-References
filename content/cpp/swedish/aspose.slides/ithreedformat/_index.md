...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevel](../ishapebevel/)\> [get_BevelBottom](./get_bevelbottom/)() | Returnerar typen av en nedre 3D-avfasning. Skrivskyddad [IShapeBevel](../ishapebevel/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevel](../ishapebevel/)\> [get_BevelTop](./get_beveltop/)() | Returnerar typen av en övre 3D-avfasning. Skrivskyddad [IShapeBevel](../ishapebevel/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICamera](../icamera/)\> [get_Camera](./get_camera/)() | Returnerar inställningarna för en kamera. Skrivskyddad [ICamera](../icamera/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ContourColor](./get_contourcolor/)() | Returnerar färgen på en kontur. Skrivskyddad [IColorFormat](../icolorformat/). |
| virtual **double** [get_ContourWidth](./get_contourwidth/)() | Returnerar bredden på en 3D-kontur. Läser **double**. |
| virtual **double** [get_Depth](./get_depth/)() | Returnerar djupet på en 3D-form. Läser **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ExtrusionColor](./get_extrusioncolor/)() | Returnerar färgen på en extrudering. Skrivskyddad [IColorFormat](../icolorformat/). |
| virtual **double** [get_ExtrusionHeight](./get_extrusionheight/)() | Returnerar höjden på en extruderingseffekt. Läser **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILightRig](../ilightrig/)\> [get_LightRig](./get_lightrig/)() | Returnerar typen av ett ljus. Skrivskyddad [ILightRig](../ilightrig/). |
| virtual [MaterialPresetType](../materialpresettype/) [get_Material](./get_material/)() | Returnerar typen av ett material. Läser [MaterialPresetType](../materialpresettype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormatEffectiveData](../ithreedformateffectivedata/)\> [GetEffective](./geteffective/)() | Hämtar effektiv 3-D-formateringsdata med ärftlighet tillämpad. |
...
| virtual void [set_ContourWidth](./set_contourwidth/)(**double**) | Ställer in bredden på en 3D-kontur. Skriver **double**. |
| virtual void [set_Depth](./set_depth/)(**double**) | Ställer in djupet på en 3D-form. Skriver **double**. |
| virtual void [set_ExtrusionHeight](./set_extrusionheight/)(**double**) | Ställer in höjden på en extruderingseffekt. Skriver **double**. |
| virtual void [set_Material](./set_material/)([MaterialPresetType](../materialpresettype/)) | Ställer in typen av ett material. Skriver [MaterialPresetType](../materialpresettype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar avlåsning av C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
* Klass [IThreeDParamSource](../ithreedparamsource/)
