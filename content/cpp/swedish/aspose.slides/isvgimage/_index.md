...
| virtual [System::String](../../system/string/) [get_BaseUri](./get_baseuri/)() | Returnerar bas-URI för den angivna SVG:n. Används för att lösa relativa länkar. Endast läsning [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\> [get_ExternalResourceResolver](./get_externalresourceresolver/)() | Returnerar callback-gränssnitt som används för att lösa externa resurser under SVG-dokumentimport. Endast läsning [Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/). |
| virtual [System::String](../../system/string/) [get_SvgContent](./get_svgcontent/)() | Returnerar SVG-innehåll. Endast läsning [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_SvgData](./get_svgdata/)() | Returnerar SVG-data. Endast läsning **uint8_t**[]. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mall-argument till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svagt läge. |
...
| virtual void [WriteAsEmf](./writeasemf/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Sparar SVG-bilden som en EMF-fil. |
