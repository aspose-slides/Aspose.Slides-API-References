...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Returnerar färgen på ritguiden. Läs [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Returnerar orienteringen på ritguiden. Läs [Slides::Orientation](../orientation/). |
| virtual **float** [get_Position](./get_position/)() | Returnerar positionen för ritguiden i punkter från bildens övre vänstra hörn. Läs **float**. |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satsen för låsning. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Sätter färgen på ritguiden. Skriv [System::Drawing::Color](../../system.drawing/color/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | Sätter orienteringen på ritguiden. Skriv [Slides::Orientation](../orientation/). |
| virtual void [set_Position](./set_position/)(**float**) | Sätter positionen för ritguiden i punkter från bildens övre vänstra hörn. Skriv **float**. |
