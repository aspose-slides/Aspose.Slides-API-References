...
description: Klass för händelseargument för stycke-relaterade händelser.
type: docs
weight: 4642
url: /sv/aspose.slides/paragrapheventargs/
---
## ParagraphEventArgs klass

Eventargumentklass för styckerelaterade händelser.
