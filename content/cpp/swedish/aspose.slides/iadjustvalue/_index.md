...
description: Representerar ett geometriskt formsjusteringsvärde. Dessa värden påverkar formens form.
type: docs
weight: 1288
...
Representerar ett geometriskt formas justeringsvärde. Dessa värden påverkar formens utformning.
...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | Returnerar värdet, tolkat som en vinkel i grader. Läs **float**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Returnerar ett namn för detta justeringsvärde. Läs-endast [System::String](../../system/string/). |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | Returnerar justeringsvärdet "som det är". Läs **int64_t**. |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | Returnerar typen av formjusteringen. Läs-endast [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | Sätter värdet, tolkat som en vinkel i grader. Skriv **float**. |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | Sätter justeringsvärdet "som det är". Skriv **int64_t**. |
