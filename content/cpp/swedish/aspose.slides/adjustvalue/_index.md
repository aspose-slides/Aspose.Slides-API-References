...
description: Representerar ett geometriskt formjusteringsvärde. Dessa värden påverkar formens form.
type: docs
weight: 1
...
| **float** [get_AngleValue](./get_anglevalue/)() override | Returnerar värdet, tolkar det som en vinkel i grader. Läs **float**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Returnerar ett namn för detta justeringsvärde. Skrivskyddad [System::String](../../system/string/). |
| **int64_t** [get_RawValue](./get_rawvalue/)() override | Returnerar justeringsvärdet "som det är". Läs **int64_t**. |
| [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() override | Returnerar typen av formjusteringen. Skrivskyddad [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar det delade referensräknandet med det angivna värdet. |
| void [set_AngleValue](./set_anglevalue/)(**float**) override | Sätter värdet, tolkar det som en vinkel i grader. Skriv **float**. |
| void [set_RawValue](./set_rawvalue/)(**int64_t**) override | Sätter justeringsvärdet "som det är". Skriv **int64_t**. |
...
* Klass [IAdjustValue](../iadjustvalue/)
