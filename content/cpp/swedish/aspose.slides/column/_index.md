...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Hämtar en iterator som pekar på det första elementet (om något) av den konstanthållna instansen av samlingen. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Hämtar en iterator som pekar på det första konstanthållna elementet (om något) i samlingen. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Hämtar en iterator som pekar precis efter det sista konstanthållna elementet (om något) i samlingen. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Hämtar en iterator som pekar precis efter det sista elementet (om något) av den konstanthållna instansen av samlingen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormat](../icolumnformat/)\> [get_ColumnFormat](./get_columnformat/)() override | Returnerar [ColumnFormat](../columnformat/)-objektet som innehåller formateringsegenskaper för denna kolumn. Skrivskyddad [IColumnFormat](../icolumnformat/). |
| **int32_t** [get_Count](../cellcollection/get_count/)() override | Returnerar antalet celler i en samling. Skrivskyddad **int32_t**. |
| **bool** [get_IsSynchronized](../cellcollection/get_issynchronized/)() override | Returnerar ett värde som indikeras om åtkomsten till samlingen är synkroniserad (trådsäker). Skrivskyddad **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](../cellcollection/get_presentation/)() override | Returnerar den överordnade presentationen för en [CellCollection](../cellcollection/). Skrivskyddad [IPresentation](../ipresentation/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../cellcollection/get_slide/)() override | Returnerar den överordnade bilden för en [CellCollection](../cellcollection/). Skrivskyddad [IBaseSlide](../ibaseslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../cellcollection/get_syncroot/)() override | Returnerar ett synkroniseringsrot. Skrivskyddad [System::Object](../../system/object/). |
| **double** [get_Width](./get_width/)() override | Returnerar bredden på en kolumn. Läs **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../cellcollection/idx_get/)(**int32_t**) override | Returnerar en cell efter dess position. Skrivskyddad [Cell](../cell/). |
...
| void [set_Width](./set_width/)(**double**) override | Sätter bredden på en kolumn. Skriv **double**. |
...
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | Ställer in definierade formategenskaper för portioner på alla kolumnceller. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | Ställer in definierade styckeformat-egenskaper för alla kolumncellers stycken. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | Ställer in definierade textrameformat-egenskaper för alla kolumncellers textramar. |
