...
description: Representerar en samling av bildspel i sektionen.
type: docs
weight: 3589
url: /sv/aspose.slides/isectionslidecollection/
---
## ISectionSlideCollection klass


Representerar en samling av bildspel i sektionen.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [idx_get](./idx_get/)(**int32_t**) | Hämtar elementet på det angivna indexet. Läs-endast [ISlide](../islide/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallargument till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svag läge. |
