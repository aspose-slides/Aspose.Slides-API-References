...
description: Representerar en typ av fält. Detta värde avgör vilken text som kommer att sättas på fältdelen när den uppdateras.
type: docs
weight: 2094
...
Representerar en fälttyp. Detta värde avgör vilken text som kommer att sättas på fältdelen när den uppdateras.
...
| virtual [System::String](../../system/string/) [get_InternalString](./get_internalstring/)() | Returnerar det interna namnet för detta FieldTypeEx-objekt. Läs [System::String](../../system/string/). |
...
| virtual void [set_InternalString](./set_internalstring/)([System::String](../../system/string/)) | Returnerar det interna namnet för detta FieldTypeEx-objekt. Skriv [System::String](../../system/string/). |
