...
description: Oföränderligt objekt som innehåller effektiva formens ytreliefegenskaper.
type: docs
weight: 3667
url: /sv/aspose.slides/ishapebeveleffectivedata/
---
## IShapeBevelEffectiveData klass

Oföränderligt objekt som innehåller effektiva formens ytreliefegenskaper.
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Bevel-typ. Skriftskyddad [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Bevel-höjd. Skriftskyddad **double**. |
| virtual **double** [get_Width](./get_width/)() | Bevel-bredd. Skriftskyddad **double**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter det n-te mall-argumentet till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
