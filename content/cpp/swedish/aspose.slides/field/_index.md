...
| [System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\> [get_Type](./get_type/)() override | Returnerar fältets typ. Läs [IFieldType](../ifieldtype/). |
...
| void [set_Type](./set_type/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) override | Sätter fältets typ. Skriv [IFieldType](../ifieldtype/). |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Sätter n-te mallparameter till en svag pekare (istället för delad). Tillåter att växla pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning för C# lock()-sats avlåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
