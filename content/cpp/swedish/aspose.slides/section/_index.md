...
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Namnet på sektionen. |
| [System::Guid](../../system/guid/) [get_SectionId](./get_sectionid/)() override | [Section](./) Id. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_StartedFromSlide](./get_startedfromslide/)() override | Returnerar den första bilden i sektionen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISectionSlideCollection](../isectionslidecollection/)\> [GetSlidesListOfSection](./getslideslistofsection/)() override | Returnerar en lista med bilder i sektionen. |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Namnet på sektionen. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Sätter n'te template-argument till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning-upplåsning enligt C# lock()-satser. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
