...
description: Hämtar effektiv fyllningsformateringsdata med arv tillämpat.
type: docs
weight: 105
...
Hämtar effektiv fyllningsformateringsdata med arv applicerat.
...
Detta exempel demonstrerar hur man får formens effektiva fyllningsformategenskaper. 
```cpp
