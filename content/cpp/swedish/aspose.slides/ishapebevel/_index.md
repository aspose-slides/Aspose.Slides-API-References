...
description: Representerar egenskaper för formens huvudytas relief.
type: docs
weight: 3654
...
Representerar egenskaper för formens huvudytas relief.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar C#-stil floating-point-jämförelse där två NaN-värden betraktas som lika även om IEC 60559:1989 säger att NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-stil floating-point-jämförelse där två NaN-värden betraktas som lika även om IEC 60559:1989 säger att NaN inte är lika med något värde, inklusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för interna ändamål. |
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Bevel-typ. Läs [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Bevel-höjd. Läs **double**. |
| virtual **double** [get_Width](./get_width/)() | Bevel-bredd. Läs **double**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-konstruktor. Kopierar egentligen ingenting, utan initierar bara ett nytt objekt och möjliggör kopiekonstruktion av underklasser. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | Bevel-typ. Skriv [BevelPresetType](../bevelpresettype/). |
| virtual void [set_Height](./set_height/)(**double**) | Bevel-höjd. Skriv **double**. |
| virtual void [set_Width](./set_width/)(**double**) | Bevel-bredd. Skriv **double**. |
