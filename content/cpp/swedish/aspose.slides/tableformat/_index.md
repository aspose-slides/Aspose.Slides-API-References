...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Returnerar ett tabellfyllningsegenskapsobjekt. Skrivskyddad [IFillFormat](../ifillformat/). |
...
| **float** [get_Transparency](./get_transparency/)() override | Hämtar genomskinligheten för fyllnadsfärgen. Läs **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() override | Hämtar effektiva tabellformateringsegenskaper med arv och tillämpade tabellstilar. |
...
| void [set_Transparency](./set_transparency/)(**float**) override | Ställer in genomskinligheten för fyllnadsfärgen. Skriv **float**. |
...
* Klass [ITableFormat](../itableformat/)
