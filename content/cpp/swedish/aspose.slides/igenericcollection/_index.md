...
description: Hjälpgränssnitt för generisk samling.
type: docs
weight: 2328
url: /sv/aspose.slides/igenericcollection/
---
## IGenericCollection klass

Hjälpgränssnitt för generisk samling.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Hämtar iterator som pekar strax efter det sista const-kvalificerade elementet (om något) i samlingen. |
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Kopierar alla element från samlingen till den angivna arrayen. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Hämtar iterator som pekar strax efter det sista elementet (om något) i samlingen. Denna iterator kan inte användas för att ändra ett refererat objekt eftersom [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) returnerar ett kopieobjekt av T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Hämtar iterator som pekar strax efter det sista elementet (om något) i den const-kvalificerade instansen av samlingen. |
...
| virtual **bool** [get_IsSynchronized](./get_issynchronized/)() | Returnerar ett värde som anger om åtkomst till samlingen är synkroniserad (trådsäker). Läs-endast **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() | Returnerar ett synkroniseringsrot. Läs-endast [System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referenskounter-datastruktur som är associerad med objektet. |
