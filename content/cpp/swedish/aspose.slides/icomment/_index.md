...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [get_Author](./get_author/)() | Returnerar författaren till en kommentar. Skrivskyddad [ICommentAuthor](../icommentauthor/). |
| virtual [System::DateTime](../../system/datetime/) [get_CreatedTime](./get_createdtime/)() | Returnerar tiden för när en kommentar skapades. Att sätta denna egenskap till [DateTime::MinValue](../../system/datetime/minvalue/) betyder att ingen kommentarstid är angiven. Läs [System::DateTime](../../system/datetime/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](./)\> [get_ParentComment](./get_parentcomment/)() | Hämtar föräldrakommentaren. Läs [IComment](./). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_Position](./get_position/)() | Returnerar positionen för en kommentar på en bild. Läs [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_Slide](./get_slide/)() | Returnerar föräldrabilden till en kommentar. Skrivskyddad [ISlide](../islide/). |
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Returnerar vanlig text för en bildkommentar. Läs [System::String](../../system/string/). |
...
| virtual void [Remove](./remove/)() | Tar bort kommentaren och alla dess svar från föräldrakollektionen. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referensräknare med angivet värde. |
| virtual void [set_CreatedTime](./set_createdtime/)([System::DateTime](../../system/datetime/)) | Sätter tiden för när en kommentar skapades. Att sätta denna egenskap till [DateTime::MinValue](../../system/datetime/minvalue/) betyder att ingen kommentarstid är angiven. Skriv [System::DateTime](../../system/datetime/). |
| virtual void [set_ParentComment](./set_parentcomment/)([System::SharedPtr](../../system/sharedptr/)\<[IComment](./)\>) | Sätter föräldrakommentaren. Skriv [IComment](./). |
| virtual void [set_Position](./set_position/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Sätter positionen för en kommentar på en bild. Skriv [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | Sätter vanlig text för en bildkommentar. Skriv [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsningupphävning enligt C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
