...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Returnerar färgen på ett gradientstopp. Skrivskyddad [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Returnerar positionen (0..1) för ett gradientstopp. Läs **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Ställer in positionen (0..1) för ett gradientstopp. Skriv **float**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning enligt C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objekt. |
...
* Klass [IGradientStop](../igradientstop/)
