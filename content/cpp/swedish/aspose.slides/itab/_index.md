...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar flyttalsjämförelse i C#-stil där två NaN-värden anses vara lika även om enligt IEC 60559:1989 NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar flyttalsjämförelse i C#-stil där två NaN-värden anses vara lika även om enligt IEC 60559:1989 NaN inte är lika med något värde, inklusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för interna ändamål. |
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Returnerar justeringsstil för en tab. Läs [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Returnerar positionen för en tab. Att tilldela denna egenskap kan förändra tabbens index i samlingen och göra Enumerator ogiltig. Läs **double**. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Sätter justeringsstil för en tab. Skriv [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Sätter positionen för en tab. Att tilldela denna egenskap kan förändra tabbens index i samlingen och göra Enumerator ogiltig. Skriv **double**. |
