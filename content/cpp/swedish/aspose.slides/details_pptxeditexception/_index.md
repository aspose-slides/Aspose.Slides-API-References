...
description: Representerar ett undantag som kastas när ett redigeringsfel i presentationen upptäcks.
type: docs
weight: 716
url: /sv/aspose.slides/details_pptxeditexception/
---
## Details_PptxEditException klass

Representerar ett undantag som kastas när ett redigeringsfel i presentationen upptäcks.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar C#-stil flyttalssammanslagning där två NaN-värden betraktas som lika även om IEC 60559:1989 säger att NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-stil flyttalssammanslagning där två NaN-värden betraktas som lika även om IEC 60559:1989 säger att NaN inte är lika med något värde, inklusive NaN. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknardatatypen som är associerad med objektet. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallargument som en svag pekare (i stället för delad). Möjliggör att byta pekare i behållare till svagt läge. |
