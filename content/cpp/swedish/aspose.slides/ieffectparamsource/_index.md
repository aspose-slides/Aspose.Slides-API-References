...
description: Hjälpgränssnitt för effektparametrar.
type: docs
weight: 2068
url: /sv/aspose.slides/ieffectparamsource/
---
## IEffectParamSource klass

Hjälpgränssnitt för effektparametrar.
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning för C#-statementet lock(). Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning för C#-statementet lock(). Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
