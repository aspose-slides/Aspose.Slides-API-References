...
|  [FontSources](./fontsources/)() | Skapar nya standardtypsnittsalternativ. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_FontFolders](./get_fontfolders/)() override | Mappar som innehåller typsnittsfiler. Alla typsnittsfiler som finns i dessa mappar inkluderas i samlingen. Mappar som söks rekursivt. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\> [get_MemoryFonts](./get_memoryfonts/)() override | En samling av typsnitt representerade som byte-arrayer. |
...
| void [set_FontFolders](./set_fontfolders/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) override | Mappar som innehåller typsnittsfiler. Alla typsnittsfiler som finns i dessa mappar inkluderas i samlingen. Mappar som söks rekursivt. |
| void [set_MemoryFonts](./set_memoryfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\>) override | En samling av typsnitt representerade som byte-arrayer. |
