...
description: 3D-egenskapskälla hjälpgränssnitt
type: docs
weight: 4187
url: /sv/aspose.slides/ithreedparamsource/
---
## IThreeDParamSource klass

3D-egenskapskälla hjälpgränssnitt
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Ökar delad referenräkning. Bör inte anropas direkt; använd i stället smarta pekare eller ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Minskar och returnerar delad referenräkning. Bör inte anropas direkt; använd i stället smarta pekare eller ThisProtector. |
