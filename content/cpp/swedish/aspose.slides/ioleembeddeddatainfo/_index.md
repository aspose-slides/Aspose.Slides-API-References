...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() | Returnerar fildata för inbäddat OLE-objekt. Endast läsning **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() | Returnerar filtillägget för det aktuella inbäddade OLE-objektet. Endast läsning [System::String](../../system/string/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätt n'te mallparameter till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
