...
description: Klass för att ladda anpassade teckensnitt som definierats av användaren. Bör användas innan några presentationsobjekt skapas.
type: docs
weight: 976
...
| Metod | Beskrivning |
| --- | --- |
| static void [ClearCache](./clearcache/)() | Frigir alla anpassade teckensnitt som definierats av användaren |
...
| static [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetFontFolders](./getfontfolders/)() | Hämtar teckensnittsmappningar. Returnerar mappar som har lagts till med LoadExternalFonts-metoden samt systemteckensnittsmappor |
...
| static void [LoadExternalFont](./loadexternalfont/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Lägger till teckensnitt från binärdata |
| static void [LoadExternalFonts](./loadexternalfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Lägger till ytterligare mappar för att söka efter teckensnitt. |
| void [Lock](../../system/object/lock/)() | Implementerar låsning för C# lock()-statement. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjektet. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning av C# lock()-statement. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjektet. |
...
* Klass [IFontsLoader](../ifontsloader/)
