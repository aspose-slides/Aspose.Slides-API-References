...
description: Klass för att läsa in anpassade teckensnitt som definieras av användaren. Bör användas innan några presentationsobjekt skapas.
type: docs
weight: 2237
...
Klass för att läsa in anpassade teckensnitt som definieras av användaren. Ska användas innan några presentationsobjekt skapas.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter den n'te mallargumentet till en weak-pekare (istället för shared). Tillåter att växla pekare i behållare till weak-läge. |
