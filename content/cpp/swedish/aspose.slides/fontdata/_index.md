...
description: Representerar en typsnittsdefinition. Oföränderlig.
type: docs
weight: 911
...
| Metod | Beskrivning |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestämmer om två [FontData](./) instanser är lika. |
...
|  [FontData](./fontdata/)([System::String](../../system/string/)) | Skapar ett nytt [FontData](./)-objekt med det angivna typsnittsnamnet. |
| [System::String](../../system/string/) [get_FontName](./get_fontname/)() override | Returnerar typsnittsnamnet. Läs [System::String](../../system/string/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| [System::String](../../system/string/) [GetFontName](./getfontname/)([System::SharedPtr](../../system/sharedptr/)\<[Theme::IThemeEffectiveData](../../aspose.slides.theme/ithemeeffectivedata/)\>) override | Returnerar typsnittsnamnet och ersätter temareferensen med ett faktiskt använt typsnitt. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Fungerar som en hash-funktion för en viss typ, lämplig för användning i hashalgoritmer och datastrukturer som en hashtabell. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Returnerar strängrepresentation. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar svagt referensräknare. Borde inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar svagt referensräknare. Borde inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
