...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [FindShapeByAltText](../baseslide/findshapebyalttext/)([System::String](../../system/string/)) override | Söker efter den första förekomsten av en form med den angivna alternativa texten. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Returnerar en samling ritningsguider för layout-bilden. Skrivskyddad [IDrawingGuidesCollection](../idrawingguidescollection/) |
| **bool** [get_HasDependingSlides](./get_hasdependingslides/)() override | Returnerar true om det finns minst en bild som beror på denna layout-bild. Skrivskyddad **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlideHeaderFooterManager](../ilayoutslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | Returnerar HeaderFooter-hanteraren för layout-bilden. Skrivskyddad [ILayoutSlideHeaderFooterManager](../ilayoutslideheaderfootermanager/). |
...
| [SlideLayoutType](../slidelayouttype/) [get_LayoutType](./get_layouttype/)() override | Returnerar layouttypen för denna layout-bild. Skrivskyddad [SlideLayoutType](../slidelayouttype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [get_MasterSlide](./get_masterslide/)() override | Returnerar mastersbilden för en layout. Läs [IMasterSlide](../imasterslide/). |
| [System::String](../../system/string/) [get_Name](../baseslide/get_name/)() override | Returnerar namn på en bild. Läs [System::String](../../system/string/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutPlaceholderManager](../ilayoutplaceholdermanager/)\> [get_PlaceholderManager](./get_placeholdermanager/)() override | Returnerar platshållarhanteraren för layout-bilden. Skrivskyddad [ILayoutPlaceholderManager](../ilayoutplaceholdermanager/). |
...
| **bool** [get_ShowMasterShapes](./get_showmastershapes/)() override | Anger om former på mastersbilden ska visas på bilder eller inte. Läs **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Theme::IOverrideThemeManager](../../aspose.slides.theme/ioverridethememanager/)\> [get_ThemeManager](./get_thememanager/)() override | Returnerar den överskuggande temahanteraren. Skrivskyddad [Theme::IOverrideThemeManager](../../aspose.slides.theme/ioverridethememanager/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IAnimationTimeLine](../ianimationtimeline/)\> [get_Timeline](../baseslide/get_timeline/)() override | Returnerar animations tidslinje-objekt. Skrivskyddad [IAnimationTimeLine](../ianimationtimeline/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>\> [GetDependingSlides](./getdependingslides/)() override | Returnerar en array med alla bilder som beror på denna layout-bild. |
...
| void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)() override | Sammanfogar körningar med samma formatering i alla stycken i alla godkända former. |
...
| void [Remove](./remove/)() override | Tar bort layouten från presentationen. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar det delade referensräknaren med angivet värde. |
| void [set_MasterSlide](./set_masterslide/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Ställer in mastersbilden för en layout. Skriv [IMasterSlide](../imasterslide/). |
| void [set_Name](../baseslide/set_name/)([System::String](../../system/string/)) override | Ställer in namn på en bild. Skriv [System::String](../../system/string/). |
| void [set_ShowMasterShapes](./set_showmastershapes/)(**bool**) override | Anger om former på mastersbilden ska visas på bilder eller inte. Skriv **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställ in n:te mallargumentet till en svag pekare (istället för delad). Tillåter att byta pekare i containrar till svagt läge. |
