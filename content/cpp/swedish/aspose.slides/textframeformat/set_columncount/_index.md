...
description: Sätter antalet kolumner i textområdet. Detta värde måste vara ett positivt tal. Annars kommer värdet att sättas till noll. Värde 0 betyder odefinierat värde. Skriv int32_t.
type: docs
weight: 261
url: /sv/aspose.slides/textframeformat/set_columncount/
---
## TextFrameFormat::set_ColumnCount(int32_t) metod

Sätter antalet kolumner i textområdet. Detta värde måste vara ett positivt tal. Annars kommer värdet att sättas till noll. Värde 0 betyder odefinierat värde. Skriv **int32_t**.
...
Följande exempel visar hur man lägger till en kolumn i textramen i en PowerPoint [Presentation](../../presentation/).
