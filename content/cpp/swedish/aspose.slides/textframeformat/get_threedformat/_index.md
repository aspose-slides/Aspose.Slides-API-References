...
description: Returnerar ThreeDFormat-objektet som representerar 3d-effektegenskaper för en text. Skrivskyddad IThreeDFormat.
type: docs
weight: 1
url: /sv/aspose.slides/textframeformat/get_threedformat/
---
## TextFrameFormat::get_ThreeDFormat() metod


Returnerar [ThreeDFormat](../../threedformat/)-objektet som representerar 3d-effektegenskaper för en text. Skrivskyddad [IThreeDFormat](../../ithreedformat/).
