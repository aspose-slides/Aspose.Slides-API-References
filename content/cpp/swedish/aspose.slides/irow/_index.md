...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar jämförelse av flyttal i C#-stil där två NaN-värden anses vara lika även om IEC 60559:1989 säger att NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar jämförelse av flyttal i C#-stil där två NaN-värden anses vara lika även om IEC 60559:1989 säger att NaN inte är lika med något värde, inklusive NaN. |
...
| virtual **double** [get_Height](./get_height/)() | Returnerar höjden på en rad. Skrivskyddad **double**. |
...
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Returnerar den minsta möjliga höjden på en rad. Läs **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | Returnerar [RowFormat](../rowformat/)-objektet som innehåller formateringsegenskaper för denna rad. Skrivskyddad [IRowFormat](../irowformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../islidecomponent/get_slide/)() | Returnerar grund-sliden. Skrivskyddad [IBaseSlide](../ibaseslide/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Returnerar en cell efter dess position. Skrivskyddad [ICell](../icell/). |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Hoppar över ett angivet antal på varandra följande element från sekvensens början och returnerar resten. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Returnerar ett angivet antal på varandra följande element från sekvensens början. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar egentligen ingenting, utan initierar ett nytt objekt och möjliggör kopieringskonstruktor för underklasser. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar egentligen ingenting, utan initierar ett nytt objekt och möjliggör kopieringskonstruktor för underklasser. |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Sätter den minsta möjliga höjden på en rad. Skriv **double**. |
...
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Sätter definierade portionsformat-egenskaper på alla elementens portioner. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Sätter definierade styckeformat-egenskaper på alla elementens stycken. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Sätter definierade textram-format-egenskaper på alla elementens textramar. |
| int [SharedCount](../../system/object/sharedcount/)() const | Hämtar aktuellt värde av delad referensräkning. |
...
* Klass [ICellCollection](../icellcollection/)
