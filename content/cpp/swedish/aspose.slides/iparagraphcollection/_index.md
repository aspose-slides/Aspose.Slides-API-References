...
| Metod | Beskrivning |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Lägger till en [Paragraph](../paragraph/) i slutet av samlingen. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](./)\>) | Lägger till innehållet av [ParagraphCollection](../paragraphcollection/) i slutet av samlingen. |
| virtual void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) | Lägger till text från specificerad HTML-sträng till samlingen. |
| virtual void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) | Lägger till text från specificerad HTML-sträng till samlingen. |
...
| virtual [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) | Konverterar angivna stycken till HTML och returnerar det som ett String-objekt. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för internt bruk. |
| virtual **int32_t** [get_Count](./get_count/)() | Hämtar antalet element som faktiskt finns i samlingen. Endast läsning **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../islidecomponent/get_slide/)() | Returnerar grundsliden. Endast läsning [IBaseSlide](../ibaseslide/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) | Hämtar elementet på det angivna indexet. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Infogar en [Paragraph](../paragraph/) i samlingen på det angivna indexet. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](./)\>) | Infogar innehållet av [ParagraphCollection](../paragraphcollection/) i samlingen på det angivna indexet. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Tar bort den första förekomsten av ett specifikt stycke. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Tar bort elementet på det specificerade indexet i samlingen. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar det delade referensräkningen med ett specificerat värde. |
