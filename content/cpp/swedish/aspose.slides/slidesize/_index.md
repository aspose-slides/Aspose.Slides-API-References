...
description: Representerar storleken och orienteringen av en slide.
type: docs
weight: 5240
...
Representerar storleken och orienteringen av en slide.
...
| [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() override | Hämtar slide-orienteringen. |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Hämtar slide-dimensionerna i punkter. |
| [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() override | Hämtar slide-storlekstypen. |
...
| void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) override | Ställer in slide-orienteringen. |
| void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) override | Ställer in slide-storleken efter typ och skalar befintligt innehåll. |
| void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) override | Ställer in slide-dimensionerna explicit och skalar befintligt innehåll. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Sätter det n:te mallargumentet till en weak pointer (istället för shared). Tillåter att byta pekare i behållare till weak-läge. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog till C# [Object.ToString()](../../system/object/tostring/)-metoden. Möjliggör omvandling av anpassade objekt till string. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementerar C# typeof([System.Object](../../system/object/))-konstruktion. |
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satsens upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar weak-referensräkningen. Bör inte anropas direkt; använd i stället smarta pekare eller ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar weak-referensräkningen. Bör inte anropas direkt; använd i stället smarta pekare eller ThisProtector. |
