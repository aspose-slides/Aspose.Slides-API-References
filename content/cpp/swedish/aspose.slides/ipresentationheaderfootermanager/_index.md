...
---
## IPresentationHeaderFooterManager klass

Representerar en manager som håller beteendet för alla sidfot-, datum-tid- och sidnumrerings-platshållare i presentationen.
...
| virtual void [SetAllDateTimesText](./setalldatetimestext/)([System::String](../../system/string/)) | Sätter text till alla datum-tid-platshållare, inklusive master-bilder, layoutbilder och bilder. |
| virtual void [SetAllDateTimesVisibility](./setalldatetimesvisibility/)(**bool**) | Ändrar synlighet för alla datum-tid-platshållare, inklusive master-bilder, layoutbilder och bilder. |
| virtual void [SetAllFootersText](./setallfooterstext/)([System::String](../../system/string/)) | Sätter text till alla sidfot-platshållare, inklusive master-bilder, layoutbilder och bilder. |
| virtual void [SetAllFootersVisibility](./setallfootersvisibility/)(**bool**) | Ändrar synlighet för alla sidfot-platshållare, inklusive master-bilder, layoutbilder och bilder. |
| virtual void [SetAllHeadersText](./setallheaderstext/)([System::String](../../system/string/)) | Sätter text till alla rubrik-platshållare, inklusive notes-master, notes-bilder och handout-master. |
| virtual void [SetAllHeadersVisibility](./setallheadersvisibility/)(**bool**) | Ändrar synlighet för alla rubrik-platshållare, inklusive notes-master, notes-bilder och handout-master. |
| virtual void [SetAllSlideNumbersVisibility](./setallslidenumbersvisibility/)(**bool**) | Ändrar synlighet för alla sidnummer-platshållare, inklusive master-bilder, layoutbilder och bilder. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te templatem argument till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svagt läge. |
| virtual void [SetVisibilityOnAllTitleSlides](./setvisibilityonalltitleslides/)(**bool**) | Ändrar synlighet för sidfot-, datum-tid- och sidnummer-platshållare för alla titelslides och för första layout-sliden. Titelslides \\u2013 slides baserade på första layout-sliden (oavsett typ av denna första layout). |
...
* Klass [IBaseHeaderFooterManager](../ibaseheaderfootermanager/)
