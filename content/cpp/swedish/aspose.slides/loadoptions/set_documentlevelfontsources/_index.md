...
type: docs
weight: 222
url: /sv/aspose.slides/loadoptions/set_documentlevelfontsources/
---
## LoadOptions::set_DocumentLevelFontSources(System::SharedPtr\<IFontSources\>) metod
...
Följande exempel visar hur man anger anpassade teckensnitt som används med PowerPoint [Presentation](../../presentation/). 
```cpp
...
// CustomFont1, CustomFont2 samt teckensnitt från mapparna assets\fonts & global\fonts samt deras undermappar är tillgängliga för presentationen
```
