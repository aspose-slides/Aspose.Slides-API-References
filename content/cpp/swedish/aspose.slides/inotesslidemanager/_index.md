...
| Metod | Beskrivning |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() | Returnerar anteckningsbilden för den aktuella bilden, skapar en om den inte finns. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() | Returnerar anteckningsbilden för den aktuella bilden. Returnerar null om bilden inte har någon anteckningsbild. Läs-endast [INotesSlide](../inotesslide/). |
...
| virtual void [RemoveNotesSlide](./removenotesslide/)() | Tar bort anteckningsbilden för den aktuella bilden. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter den n-te mallargumentet till en svag pekare (istället för delad). Tillåter att byta pekare i containrar till svag läge. |
