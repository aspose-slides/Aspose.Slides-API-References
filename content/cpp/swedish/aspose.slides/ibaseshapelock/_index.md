...
---
## IBaseShapeLock klass


Representerar [Shape](../shape/) lås (inaktiverad operation).
...
| virtual **bool** [get_NoLocks](./get_nolocks/)() | Returnerar true om alla låsflaggor är inaktiverade. Skrivskyddad **bool**. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Ökar delad referenräknare. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Minskar och returnerar den delade referenräknaren. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar svag referenräknare. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar svag referenräknare. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
