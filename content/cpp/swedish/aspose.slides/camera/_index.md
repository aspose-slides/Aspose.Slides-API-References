...
| [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() override | [Camera](./) typ. Läs [CameraPresetType](../camerapresettype/). |
| **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() override | [Camera](./) FOV (0-180 deg, field of View). Läs **float**. |
...
| **float** [get_Zoom](./get_zoom/)() override | [Camera](./) zoom (positivt värde i procent). Läs **float**. |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-uttrycket låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
...
| void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) override | [Camera](./) typ. Skriv [CameraPresetType](../camerapresettype/). |
| void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) override | [Camera](./) FOV (0-180 deg, field of View). Skriv **float**. |
| void [set_Zoom](./set_zoom/)(**float**) override | [Camera](./) zoom (positivt värde i procent). Skriv **float**. |
| void [SetRotation](./setrotation/)(**float**, **float**, **float**) override | En rotation definieras genom användning av en latitudkoordinat, en longitudkoordinat och en revolution kring axeln som latitud- och longitudkoordinater. Om något av koordinatvärdena är std::numeric_limits<float>::quiet_NaN(), är all rotation odefinierad. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-uttrycket upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
