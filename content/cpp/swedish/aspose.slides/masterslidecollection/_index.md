...
| Method | Beskrivning |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Lägger till en kopia av en specificerad master-slide i slutet av samlingen. Länkade layout-slides kopieras också. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Hämtar iterator som pekar direkt efter det sista const-kvalificerade elementet (om något) i samlingen. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>, **int32_t**) override | Kopierar alla element från samlingen till den specificerade arrayen. |
...
| [iterator](./iterator/) [end](./end/)() | Hämtar iterator som pekar direkt efter det sista elementet (om något) i samlingen. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Hämtar iterator som pekar direkt efter det sista elementet (om något) i den const-kvalificerade instansen av samlingen. |
...
| **int32_t** [get_Count](./get_count/)() override | Hämtar antalet element som faktiskt finns i samlingen. Endast läs-**int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Returnerar ett värde som indikerar om åtkomst till samlingen är synkroniserad (trådsäker). Endast läs-**bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Returnerar ett synkroniserings-rot. Endast läs-[System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returnerar en enumerator som itererar igenom samlingen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [idx_get](./idx_get/)(**int32_t**) override | Hämtar elementet på det angivna indexet. Endast läs-[MasterSlide](../masterslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Infogar en kopia av en specificerad master-slide på en angiven position i samlingen. Länkade layout-slides kopieras också. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Kastar elementens typ till den specificerade typen. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_OfType](../../system.collections.generic/ienumerable/linq_oftype/)() | Filtrerar element i sekvensen baserat på den specificerade typen. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referensjämför ett värdetyps-objekt med nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | Specialisering av [Object::ReferenceEquals](../../system/object/referenceequals/) för fallet med sträng och nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | Specialisering av [Object::ReferenceEquals](../../system/object/referenceequals/) för fallet med strängar. |
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Tar bort den första förekomsten av ett specifikt objekt från samlingen. |
...
| void [RemoveUnused](./removeunused/)(**bool**) override | Tar bort oanvända master-slides. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Sätter n'te mallargument till en svag pekare (istället för delad). Tillåter att byta pekare i containrar till svagt läge. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Hämtar iterator som pekar rätt efter det sista elementet (om något) i den const-kvalificerade instansen av samlingen. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Hämtar iterator som pekar rätt efter det sista elementet (om något) i samlingen. |
