...
description: Representerar alternativ som kan användas för att markera text i en textram.
type: docs
weight: 4109
url: /sv/aspose.slides/itexthighlightingoptions/
---
## ITextHighlightingOptions klass


Representerar alternativ som kan användas för att markera text i en textram.
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Ställ in true för att använda skiftlägeskänslig sökning, false annars. Läs **bool**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Ställ in true för att matcha endast hela ord, false annars. Läs **bool**. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Ställ in true för att använda skiftlägeskänslig sökning, false annars. Skriv **bool**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Ställ in true för att matcha endast hela ord, false annars. Skriv **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställ in n'th mallargument till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
...
Föråldrad
:   Gränssnittet [ITextHighlightingOptions](./) kommer att tas bort efter utgåvan av version 24.10.
