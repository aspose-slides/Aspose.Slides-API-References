...
| **uint32_t** [get_Index](./get_index/)() override | Hämtar indexet för en platshållare. Skrivskyddad **uint32_t**. |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Hämtar orienteringen för en platshållare. Skrivskyddad [Slides::Orientation](../orientation/). |
| [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() override | Hämtar storleken för en platshållare. Skrivskyddad [PlaceholderSize](../placeholdersize/). |
| [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() override | Hämtar typen för en platshållare. Skrivskyddad [PlaceholderType](../placeholdertype/). |
