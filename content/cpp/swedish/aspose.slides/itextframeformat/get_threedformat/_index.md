...
type: docs
weight: 300
url: /sv/aspose.slides/itextframeformat/get_threedformat/
---
## ITextFrameFormat::get_ThreeDFormat() metod

Returnerar [ThreeDFormat](../../threedformat/) objekt som representerar 3D-effektegenskaper för en text. Skrivskyddad [IThreeDFormat](../../ithreedformat/).
