...
| virtual [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() | Hämtar bildens orientering. |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Hämtar bildens dimensioner i punkter. Tilldelning av ett nytt värde återställer [ISlideSize::get_Type](./get_type/)-värdet till [SlideSizeType::Custom](../slidesizetype/) och sätter [ISlideSize::get_Orientation](./get_orientation/). |
| virtual [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() | Hämtar bildens storlekstyp. Tilldelning av vilket värde som helst förutom [SlideSizeType::Custom](../slidesizetype/) justerar [ISlideSize::get_Size](./get_size/) enligt de fördefinierade dimensionerna, samtidigt som den nuvarande [ISlideSize::get_Orientation](./get_orientation/) behålls. |
...
| virtual void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) | Ställer in bildens orientering. |
| virtual void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) | Ställer in bildens storlek efter typ och skalar befintligt innehåll. Tilldelning av vilket värde som helst förutom [SlideSizeType::Custom](../slidesizetype/) justerar [ISlideSize::get_Size](./get_size/) baserat på den valda typen, samtidigt som [ISlideSize::get_Orientation](./get_orientation/) bevaras. |
| virtual void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) | Ställer in bildens dimensioner explicit och skalar befintligt innehåll. Detta återställer [ISlideSize::get_Type](./get_type/)-värdet till [SlideSizeType::Custom](../slidesizetype/) och sätter [ISlideSize::get_Orientation](./get_orientation/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te template-argument till en weak-pekare (i stället för shared). Tillåter att byta pekare i containrar till weak-läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning upp enligt C# lock()-statement. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
