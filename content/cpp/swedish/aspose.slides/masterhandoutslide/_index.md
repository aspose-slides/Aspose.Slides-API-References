...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Returnerar en samling ritguider för masterhandout-bilden. Skrivskyddad [IDrawingGuidesCollection](../idrawingguidescollection/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | Returnerar HeaderFooter-hanteraren för masterhandout-bilden. Skrivskyddad [IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/). |
...
| **bool** [get_ShowMasterShapes](./get_showmastershapes/)() override | Anger om former på masterbilden ska visas på bilder eller inte. För själva masterbilden returnerar denna egenskap alltid **false**. Läs **bool**. |
...
| void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)() override | Slår ihop körningar med samma formatering i alla stycken i alla acceptabla former. |
...
| void [set_ShowMasterShapes](./set_showmastershapes/)(**bool**) override | Anger om former på masterbilden ska visas på bilder eller inte. För själva masterbilden returnerar denna egenskap alltid **false**. Skriv **bool**. |
...
* Klass [IMasterHandoutSlide](../imasterhandoutslide/)
