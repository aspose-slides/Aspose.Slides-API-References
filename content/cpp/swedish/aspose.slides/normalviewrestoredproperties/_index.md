...
description: Anger storleken på bildspelsområdet ((bredd när ett barn till restoredTop, höjd när ett barn till restoredLeft) av normalvyn, när området är av en variabel återställd storlek(varken minimerad eller maximiserad).
type: docs
weight: 4538
...
Anger storleken på bildspelsområdet ((bredd när ett barn till restoredTop, höjd när ett barn till restoredLeft) av normalvyn, när området har en variabel återställd storlek (varken minimerad eller maximiserad).
...
| **bool** [get_AutoAdjust](./get_autoadjust/)() override | Anger om storleken på sidoinnehållsområdet ska kompensera för den nya storleken när fönstret som innehåller vyn i applikationen ändras i storlek. Läs **bool**. |
| **float** [get_DimensionSize](./get_dimensionsize/)() override | Anger storleken på bildspelsområdet (bredd när ett barn till RestoredTop, höjd när ett barn till RestoredLeft). Läs **float**. |
...
| void [set_AutoAdjust](./set_autoadjust/)(**bool**) override | Anger om storleken på sidoinnehållsområdet ska kompensera för den nya storleken när fönstret som innehåller vyn i applikationen ändras i storlek. Skriv **bool**. |
| void [set_DimensionSize](./set_dimensionsize/)(**float**) override | Anger storleken på bildspelsområdet (bredd när ett barn till RestoredTop, höjd när ett barn till RestoredLeft). Skriv **float**. |
...
* Klass [INormalViewRestoredProperties](../inormalviewrestoredproperties/)
