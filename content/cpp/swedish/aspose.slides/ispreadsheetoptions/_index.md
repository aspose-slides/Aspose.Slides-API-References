...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() | Hämtar föredragen kulturinformation för beräkning av vissa funktioner avsedda för språk som använder dubbelbyte-teckenuppsättning (DBCS). |
| virtual **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() | Om datakällan för diagrammet är en extern arbetsbok och den inte är tillgänglig, återställs den från diagramcachen. |
...
| virtual void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) | Ställer in föredragen kulturinformation för beräkning av vissa funktioner avsedda för språk som använder dubbelbyte-teckenuppsättning (DBCS). |
| virtual void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) | Om datakällan för diagrammet är en extern arbetsbok och den inte är tillgänglig, återställs den från diagramcachen. |
