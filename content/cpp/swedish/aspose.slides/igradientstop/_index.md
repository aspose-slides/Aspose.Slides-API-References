...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | Returnerar färgen på ett gradientstopp. Skrivskyddad [IColorFormat](../icolorformat/). |
| virtual **float** [get_Position](./get_position/)() | Returnerar positionen (0..1) för ett gradientstopp. Läs **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar faktiskt ingenting, utan initierar bara ett nytt objekt och gör det möjligt att kopieringskonstruktera underklasser. |
...
| virtual void [set_Position](./set_position/)(**float**) | Sätter positionen (0..1) för ett gradientstopp. Skriv **float**. |
