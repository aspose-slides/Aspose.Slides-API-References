...
---
## IMasterNotesSlideManager klass
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [get_MasterNotesSlide](./get_masternotesslide/)() | Returnerar en master för alla anteckningsbilder i den här presentationen om en finns, annars returneras null. Läs-endast [IMasterNotesSlide](../imasternotesslide/). |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satset för låsning. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
...
| virtual void [RemoveMasterNotesSlide](./removemasternotesslide/)() | Tar bort huvudanteckningsbild. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [SetDefaultMasterNotesSlide](./setdefaultmasternotesslide/)() | Ställer in standard-masteranteckningsbild för relaterad anteckningsbild. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satsets upplåsning. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
