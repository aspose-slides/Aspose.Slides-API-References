...
| Method | Description |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | Jämför den aktuella instansen med ett annat objekt av samma typ. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | Returnerar justeringsstil för en tabulering. Läs [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | Returnerar positionen för en tabulering. Tilldelning av denna egenskap kan ändra tabuleringens index i samlingen och ogiltigförklara Enumerator. Läs **double**. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollerar om objektet representerar en instans av typen som beskrivas av targetType. Analog till C# 'is'-operatorn. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | Ställer in justeringsstil för en tabulering. Skriv [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | Ställer in positionen för en tabulering. Tilldelning av denna egenskap kan ändra tabuleringens index i samlingen och ogiltigförklara Enumerator. Skriv **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställer in det n'te templateargumentet till en svag pekare (istället för delad). Tillåter att byta pekare i containrar till svagt läge. |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | Skapar ny [Tab](./) |
