...
description: Representerar ett objekt med möjlighet att i bulk ställa in format för barntext-element.
type: docs
weight: 1548
url: /sv/aspose.slides/ibulktextformattable/
---
## IBulkTextFormattable klass

Representerar ett objekt med möjlighet att ställa in format för barntextelement i bulk.
...
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Ställer in definierade portionsformatsegenskaper för alla elementens portioner. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Ställer in definierade styckeformatsegenskaper för alla elementens stycken. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Ställer in definierade textramformatsegenskaper för alla elementens textramar. |
