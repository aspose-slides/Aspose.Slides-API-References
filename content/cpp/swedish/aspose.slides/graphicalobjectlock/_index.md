...
Bestämmer vilka operationer som är inaktiverade på den överordnade [GraphicalObject](../graphicalobject/).
...
| **bool** [get_DrilldownLocked](./get_drilldownlocked/)() override | Bestämmer om urval av delformer av detta objekt är förbjudet. Läs **bool**. |
| **bool** [get_GroupingLocked](./get_groupinglocked/)() override | Bestämmer om tillägg av denna form till en grupp är förbjudet. Läs **bool**. |
| **bool** [get_NoLocks](../baseshapelock/get_nolocks/)() override | Returnerar true om alla lås-flaggor är inaktiverade. Skrivskyddad **bool**. |
| **bool** [get_PositionLocked](./get_positionlocked/)() override | Bestämmer om förflyttning av denna form är förbjudet. Läs **bool**. |
| **bool** [get_SelectLocked](./get_selectlocked/)() override | Bestämmer om urval av denna form är förbjudet. Läs **bool**. |
| **bool** [get_SizeLocked](./get_sizelocked/)() override | Bestämmer om storleksändring av denna form är förbjudet. Läs **bool**. |
...
| void [set_DrilldownLocked](./set_drilldownlocked/)(**bool**) override | Bestämmer om urval av delformer av detta objekt är förbjudet. Skriv **bool**. |
| void [set_GroupingLocked](./set_groupinglocked/)(**bool**) override | Bestämmer om tillägg av denna form till en grupp är förbjudet. Skriv **bool**. |
| void [set_PositionLocked](./set_positionlocked/)(**bool**) override | Bestämmer om förflyttning av denna form är förbjudet. Skriv **bool**. |
| void [set_SelectLocked](./set_selectlocked/)(**bool**) override | Bestämmer om urval av denna form är förbjudet. Skriv **bool**. |
| void [set_SizeLocked](./set_sizelocked/)(**bool**) override | Bestämmer om storleksändring av denna form är förbjudet. Skriv **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätt n'te mall-argument till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svagt läge. |
...
* Klass [IGraphicalObjectLock](../igraphicalobjectlock/)
