...
---
## ILayoutPlaceholderManager::AddSmartArtPlaceholder(float, float, float, float) metod
...
Följande exempel visar hur man lägger till [SmartArt](../../../aspose.slides.smartart/) platshållarformen på layoutbilden.
```cpp
