...
| virtual **bool** [get_IncludeNotes](./get_includenotes/)() | Ställ in **true** för att inkludera text som finns i bildanteckningar vid textssökning, ersättning eller markeringsoperationer. Standardvärdet är **false**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Ställ in true för att endast matcha hela ord, false annars. Läs **bool**. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning enligt C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentryobjektet. |
...
| virtual void [set_IncludeNotes](./set_includenotes/)(**bool**) | Ställ in **true** för att inkludera text som finns i bildanteckningar vid textssökning, ersättning eller markeringsoperationer. Standardvärdet är **false**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Ställ in true för att endast matcha hela ord, false annars. Skriv **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning enligt C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentryobjektet. |
