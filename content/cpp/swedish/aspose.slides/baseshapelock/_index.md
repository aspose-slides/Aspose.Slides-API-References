...
| **bool** [get_NoLocks](./get_nolocks/)() override | Returnerar true om alla låsflaggor är inaktiverade. Skrivskyddad **bool**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te templatargument till en svag pekare (istället för delad). Möjliggör att byta pekare i behållare till svagt läge. |
