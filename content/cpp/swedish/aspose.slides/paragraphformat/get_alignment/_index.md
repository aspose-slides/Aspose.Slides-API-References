...
description: Returnerar textjusteringen i ett stycke utan arv. Läs TextAlignment.
type: docs
weight: 1
url: /sv/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() metod


Returnerar textjusteringen i ett stycke utan arv. Läs [TextAlignment](../../textalignment/).
...
Följande exempelprogram visar hur man justerar textstycken i PowerPoint [Presentation](../../presentation/). 
```cpp
