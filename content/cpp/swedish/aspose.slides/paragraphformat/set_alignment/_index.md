...
description: Ställer in textjusteringen i ett stycke utan ärvning. Skriv TextAlignment.
type: docs
weight: 14
url: /sv/aspose.slides/paragraphformat/set_alignment/
---
## ParagraphFormat::set_Alignment(TextAlignment) metod

Ställer in textjusteringen i ett stycke utan ärvning. Skriv [TextAlignment](../../textalignment/).
...
Följande exempel visar hur man justerar textstycken i PowerPoint [Presentation](../../presentation/).
```cpp
