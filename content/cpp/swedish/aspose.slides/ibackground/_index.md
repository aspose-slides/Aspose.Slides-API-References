...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | Returnerar en [EffectFormat](../effectformat/) för [BackgroundType::OwnBackground](../backgroundtype/) fyllning. Skrivskyddad [IEffectFormat](../ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Returnerar en [FillFormat](../fillformat/) för [BackgroundType::OwnBackground](../backgroundtype/) fyllning. Skrivskyddad [IFillFormat](../ifillformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | Returnerar en [ColorFormat](../colorformat/) för en [BackgroundType::Themed](../backgroundtype/) fyllning. Skrivskyddad [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | Returnerar ett index för [BackgroundType::Themed](../backgroundtype/) fyllning i bakgrundstemat. 0 betyder ingen fyllning. 1..999 – index. Läs **uint16_t**. |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | Returnerar en typ av bakgrundsfyllning. Läs [BackgroundType](../backgroundtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | Hämtar effektiv bakgrundsdata med arv tillämpat. |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | Returnerar ett index för [BackgroundType::Themed](../backgroundtype/) fyllning i bakgrundstemat. 0 betyder ingen fyllning. 1..999 – index. Skriv **uint16_t**. |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | Returnerar en typ av bakgrundsfyllning. Skriv [BackgroundType](../backgroundtype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställer in n'ta mallargumentet till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
