...
description: Oföränderligt objekt som innehåller en uppsättning effektiva teckensnitt.
type: docs
weight: 2224
url: /sv/aspose.slides/ifontseffectivedata/
---
## IFontsEffectiveData klass

Oföränderligt objekt som innehåller effektiva teckensnitt.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() | Returnerar det komplexa skriptteckensnittet. Läs-endast [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() | Returnerar östasiatiskt teckensnitt. Läs-endast [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() | Returnerar latinskt teckensnitt. Läs-endast [IFontData](../ifontdata/). |
...
Detta gränssnitt används som en del av [IBasePortionFormatEffectiveData](../ibaseportionformateffectivedata/) och [Theme::IFontSchemeEffectiveData](../../aspose.slides.theme/ifontschemeeffectivedata/)-gränssnitten.
