...
Representerar alternativ som kan användas för att söka efter text i en [Presentation](../presentation/), [Slide](../slide/) eller [TextFrame](../textframe/).
...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Ställ in true för att använda skiftlägeskänslig sökning, false - annars. Läs **bool**. |
| **bool** [get_IncludeNotes](./get_includenotes/)() override | Ställ in **true** för att inkludera text som finns i bildanteckningar ([NotesSlide](../notesslide/)) vid text-sökning, ersättning eller markeringsoperationer. Standardvärdet är **false**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Ställ in true för att bara matcha hela ord, false - annars. Läs **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar egentligen ingenting, initierar bara ett nytt objekt och möjliggör kopierande av underklasser. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar egentligen ingenting, initierar bara ett nytt objekt och möjliggör kopierande av underklasser. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Ställ in true för att använda skiftlägeskänslig sökning, false - annars. Skriv **bool**. |
| void [set_IncludeNotes](./set_includenotes/)(**bool**) override | Ställ in **true** för att inkludera text som finns i bildanteckningar ([NotesSlide](../notesslide/)) vid text-sökning, ersättning eller markeringsoperationer. Standardvärdet är **false**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Ställ in true för att bara matcha hela ord, false - annars. Skriv **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställ in n'th mallargument som en svag pekare (istället för delad). Gör det möjligt att byta pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning för C# lock()-satsens upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
