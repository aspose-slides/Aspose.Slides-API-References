...
description: Gränssnitt för externa resursladdningsargument.
type: docs
weight: 3485
url: /sv/aspose.slides/iresourceloadingargs/
---
## IResourceLoadingArgs klass

Gränssnitt för externa resursladdningsargument.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar flyttalsjämförelse i C#-stil där två NaN-värden betraktas som lika trots att enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar flyttalsjämförelse i C#-stil där två NaN-värden betraktas som lika trots att enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för interna ändamål. |
| virtual [System::String](../../system/string/) [get_OriginalUri](./get_originaluri/)() | Original-URI för resursen som specificerats i importerad presentation. |
| virtual [System::String](../../system/string/) [get_Uri](./get_uri/)() | URI för resursen som används för nedladdning om [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) returnerar [ResourceLoadingAction::Default](../resourceloadingaction/). Initialt är den satt till original-URI för resursen, men kan omdefinieras till vilket värde som helst. |
...
| virtual void [set_Uri](./set_uri/)([System::String](../../system/string/)) | URI för resursen som används för nedladdning om [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) returnerar [ResourceLoadingAction::Default](../resourceloadingaction/). Initialt är den satt till original-URI för resursen, men kan omdefinieras till vilket värde som helst. |
| virtual void [SetData](./setdata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Ställer in användarlevererade data för resursen som används om [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) returnerar [ResourceLoadingAction::UserProvided](../resourceloadingaction/). |
