...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | Returnerar kommentar skriven av denna författare på det angivna indexet. Skrivskyddad [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | Returnerar samlingen av kommentarer som denna författare har gjort. Skrivskyddad [ICommentCollection](../icommentcollection/). |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | Returnerar författarens initialer. Läs [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Returnerar författarens namn. Läs [System::String](../../system/string/). |
...
| void [Remove](./remove/)() override | Tar bort författaren från föräldrakollektionen. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referensräknare med angivet värde. |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | Sätter författarens initialer. Skriv [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Sätter författarens namn. Skriv [System::String](../../system/string/). |
