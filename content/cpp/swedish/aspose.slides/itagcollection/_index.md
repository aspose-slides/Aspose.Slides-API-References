...
| Method | Description |
| --- | --- |
| virtual **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | Lägger till en ny tagg i samlingen. |
...
| virtual void [Clear](./clear/)() | Tar bort alla taggar från samlingen. |
| virtual **bool** [Contains](./contains/)([System::String](../../system/string/)) | Bestämmer om samlingen innehåller ett specifikt namn. |
...
| virtual [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) | Returnerar nyckeln för en tagg på angivet index. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() | Returnerar namn på taggar. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar den faktiska typen av objektet. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
| virtual [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) | Returnerar värdet för en tagg på angivet index. |
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) | Returnerar ett nyckel- och värdepar för en tagg. |
| virtual void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) | Sätter ett nyckel- och värdepar för en tagg. |
| virtual **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) | Returnerar det nollbaserade indexet för den angivna nyckeln i samlingen. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Tar bort taggen med ett angivet namn från samlingen. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Tar bort taggen på angivet index. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Inkremeterar delad referensräkning. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementerar och returnerar delad referensräkning. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Inkremeterar svag referensräkning. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementerar svag referensräkning. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
