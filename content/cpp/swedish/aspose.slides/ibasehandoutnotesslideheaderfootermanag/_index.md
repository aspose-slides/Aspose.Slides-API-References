...
description: Representerar en hanterare som innehåller beteendet för platshållarna, inklusive huvud-platshållare för alla typer av handout- och notes-bilder.
type: docs
weight: 1431
url: /sv/aspose.slides/ibasehandoutnotesslideheaderfootermanag/
---
## IBaseHandoutNotesSlideHeaderFooterManag klass

Representerar en hanterare som innehåller beteendet för platshållarna, inklusive huvud-platshållare för alla typer av handout- och notes-bilder.
...
| virtual **bool** [get_IsDateTimeVisible](../ibaseslideheaderfootermanager/get_isdatetimevisible/)() | Hämtar värde som indikerar att en datum-tid-platshållare är närvarande. Läs**bool**. |
| virtual **bool** [get_IsFooterVisible](../ibaseslideheaderfootermanager/get_isfootervisible/)() | Hämtar värde som indikerar att en sidfot-platshållare är närvarande. Läs **bool**. |
| virtual **bool** [get_IsHeaderVisible](./get_isheadervisible/)() | Hämtar värde som indikerar att en huvud-platshållare är närvarande. Läs **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](../ibaseslideheaderfootermanager/get_isslidenumbervisible/)() | Hämtar värde som indikerar att en sidnumrerings-platshållare är närvarande. Läs**bool**. |
...
| virtual void [SetDateTimeText](../ibaseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) | Sätter text till bildens datum-tid-platshållare. |
...
| virtual void [SetFooterText](../ibaseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) | Sätter text till bildens sidfot-platshållare. |
...
| virtual void [SetHeaderText](./setheadertext/)([System::String](../../system/string/)) | Sätter text till bildens huvud-platshållare. |
| virtual void [SetHeaderVisibility](./setheadervisibility/)(**bool**) | Ändrar synlighet för bildens huvud-platshållare. |
| virtual void [SetSlideNumberVisibility](../ibaseslideheaderfootermanager/setslidenumbervisibility/)(**bool**) | Ändrar synlighet för bildens sidnumrerings-platshållare. |
...
Det ursprungliga gränssnittsnamnet "IBaseHandoutNotesSlideHeaderFooterManager" har förkortats till "IBaseHandoutNotesSlideHeaderFooterManag" för COM-kompatibilitet (typenamnet får inte vara längre än 39 tecken).
