...
| Metod | Beskrivning |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateFileStreamWrapper](./createfilestreamwrapper/)([System::String](../../system/string/), [System::IO::FileMode](../../system.io/filemode/)) override | Skapar FileStream med den angivna sökvägen och skapningsläge. |
| [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateFileStreamWrapper](./createfilestreamwrapper/)([System::String](../../system/string/), [System::IO::FileMode](../../system.io/filemode/), [System::IO::FileAccess](../../system.io/fileaccess/)) override | Skapar FileStream med den angivna sökvägen, skapningsläge och läs/skriv-behörighet. |
| [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateMemoryStreamWrapper](./creatememorystreamwrapper/)() override | Skapar MemoryStream-omslag. |
| [System::SharedPtr](../../system/sharedptr/)\<[IStreamWrapper](../istreamwrapper/)\> [CreateMemoryStreamWrapper](./creatememorystreamwrapper/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Skapar MemoryStream-omslag baserat på den angivna byte-arrayen. |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satssatsen för låsning. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjektet. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satssatsen för upplåsning. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjektet. |
...
* Klass [IStreamWrapperFactory](../istreamwrapperfactory/)
