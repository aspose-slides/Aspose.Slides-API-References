...
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Format för den exporterade datan. |
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| stream | [System::SharedPtr](../../../system/sharedptr/)\<[System::IO::Stream](../../../system.io/stream/)\> | Utdatastream. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Format för den exporterade datan. |

## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) method

Sparar alla bildspel i en presentation till en fil med det angivna formatet och med ytterligare alternativ.
...
Följande exempel visar hur man konverterar PowerPoint till HTML med C++.
```cpp
// Skapar ett presentationsobjekt som representerar en presentationsfil t.ex. PPT, PPTX, ODP etc.
...
```
Följande exempel visar hur man konverterar PowerPoint till responsiv HTML med C++.
```cpp
...
```
Följande exempel visar hur man konverterar PowerPoint till HTML med anteckningar med C++.
```cpp
...
```
Följande exempel visar hur man konverterar PowerPoint till HTML med originaltypsnitt med C++.
```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// Exkluderar standardtypsnitt för presentationen
...
```
Följande exempel visar hur man konverterar PowerPoint till HTML med högkvalitativa bilder vid 150 DPI med C++.
```cpp
...
```
Följande exempel visar hur man konverterar PowerPoint till HTML med bilder av full kvalitet med C++.
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
Följande exempel visar hur man konverterar [Slide](../../slide/) till HTML med C++.
```cpp
```
