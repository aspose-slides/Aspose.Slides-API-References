...
description: Denna klass representerar den token som används för att signalera huruvida ett avbrott begärdes för långvariga uppgifter.
type: docs
weight: 2601
url: /sv/aspose.slides/iinterruptiontoken/
---
## IInterruptionToken klass


Denna klass representerar token som används för att signalera om ett avbrott begärdes för långvariga uppgifter.
...
| virtual **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() | Returnerar **bool**.true om avbrott begärdes. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referenräknar-datastruktur som är associerad med objektet. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Jämför värdestyp-objekt med nullptr efter referens. |
...
| virtual void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() | Kastar ett undantag om avbrott begärdes. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning upphävdning enligt C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
