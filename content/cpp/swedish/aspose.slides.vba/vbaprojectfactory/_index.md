...
| Metod | Beskrivning |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [CreateVbaProject](./createvbaproject/)() override | Skapar ett nytt VBA-projekt. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaProjectFactory](./)\> [get_Instance](./get_instance/)() | Statisk instans av VBA-projektfabrik. Endast läsbar [VbaProjectFactory](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referenräknardatastruktur som är associerad med objektet. |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satser låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vakterobjekt. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [ReadVbaProject](./readvbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Läser VBA-projekt från OLE-behållare. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallparameter till en svag pekare (istället för delad). Tillåter att byta pekare i containrar till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satser låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vakterobjekt. |
...
* Klass [IVbaProjectFactory](../ivbaprojectfactory/)
