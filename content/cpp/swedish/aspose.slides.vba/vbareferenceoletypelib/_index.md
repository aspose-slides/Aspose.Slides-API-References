...
description: Representerar OLE Automation-typbibliotsreferens.
type: docs
weight: 209
...
Representerar OLE Automation-typbibliotsreferens.
...
| [System::String](../../system/string/) [get_Libid](./get_libid/)() override | Representerar identifieraren för ett Automation-typbibliotek. Läs [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Representerar namnet på VBA-projektreferensen. Läs [System::String](../../system/string/). |
...
| void [set_Libid](./set_libid/)([System::String](../../system/string/)) override | Representerar identifieraren för ett Automation-typbibliotek. Skriv [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Representerar namnet på VBA-projektreferensen. Skriv [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te templatargumentet till en svag pekare (istället för en delad). Tillåter att byta pekare i behållare till svagt läge. |
...
|  [VbaReferenceOleTypeLib](./vbareferenceoletypelib/)([System::String](../../system/string/), [System::String](../../system/string/)) | Denna konstruktor skapar en ny OLE Automation-typbibliotsreferens. |
...
* Klass [IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)
