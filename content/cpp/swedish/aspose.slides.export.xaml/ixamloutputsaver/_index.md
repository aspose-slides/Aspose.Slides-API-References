...
---
## IXamlOutputSaver klass


Representerar en implementation av en output-sparare för överföring av data till extern lagring.
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Sparar en byte-array till en destinationsplats. |
