...
description: "Iteratorklass för enkla behållare som håller element direkt med rbegin() och rend() funktioner. Objekt av denna klass bör endast allokeras med System::MakeObject() funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, då det kan leda till körfel och/eller påståendefel. Inslå alltid denna klass i en System::SmartPtr pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 508
url: /sv/system.collections.generic/simpleenumerator/
---
## SimpleEnumerator klass

Iteratorklass för enkla behållare som håller element direkt med rbegin() och rend()-funktioner. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kommer att leda till körfel och/eller påståendefel. Inslå alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd pekaren för att skicka den till funktioner som argument.
...
| --- | --- |
| Container | Containertyp att iterera igenom. |
| Element | Elementtyp. |
## Metoder

| Metod | Beskrivning |
| --- | --- |
| [IEnumerator](../ienumerator/) * [AsVirtualizedIterator](../ienumerator/asvirtualizediterator/)() | Förbereder iteratorn för att användas av VirtualizedIterator-klassen. |
| [BaseEnumerator](../baseenumerator/baseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | Initierar iteratorn. |
| System::Details::VirtualizedIteratorBase\<Element\> * [CloneIterator](./cloneiterator/)() const override | Klonar den aktuella iteratorn. |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Element\> [get_Current](./get_current/)() const override | Hämtar det 'aktuella' elementet. |
...
| void [IncrementIterator](../ienumerator/incrementiterator/)() override | Flyttar iteratorn ett steg framåt. |
| void [InitializeIterator](../ienumerator/initializeiterator/)() override | Utför det första [MoveNext()](../ienumerator/movenext/)-anropet och förbereder enumeratorobjektet för att användas av VirtualizedIterator. |
...
| **bool** [IsValid](../baseenumerator/isvalid/)() const | Kontrollerar om [MoveNext()](../baseenumerator/movenext/) anropades och slutet inte nåddes. |
...
| void [MarkOwnedByVirtualizedIterator](../ienumerator/markownedbyvirtualizediterator/)() | Markerar enumeratorn som ägs av virtualiserad iterator. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog till C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-metoden. Möjliggör kloning av anpassade typer. |
| **bool** [MoveNext](../baseenumerator/movenext/)() override | Ökning i enumeratorstil. |
...
| void [Reset](../baseenumerator/reset/)() override | Återställer enumeratorn för att möjliggöra omenumerering av element. |
...
| [SimpleEnumerator](./simpleenumerator/)([Object::ptr](../../system/object/ptr/), Container\&) | Skapar enkel iterator. |
...
* Klass [BaseEnumerator](../baseenumerator/)
