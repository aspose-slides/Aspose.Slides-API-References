...
description: Framåtdeklaration av Queue-klass.
type: docs
weight: 469
url: /sv/system.collections.generic/queue/
---
## Queue-klass

[Queue](./) klass framåtdeklaration.
...
| virtual void [Clear](./clear/)() | Raderar alla element i kön. |
| virtual **bool** [Contains](./contains/)(const T\&) const | Kontrollerar om kön innehåller ett specifikt element med operator == för att jämföra element. |
| [queue_t](./queue_t/)\& [data](./data/)() | Åtkomst till underliggande datastruktur. |
| const [queue_t](./queue_t/)\& [data](./data/)() const | Åtkomst till underliggande datastruktur. |
| T [Dequeue](./dequeue/)() | Hämtar ett objekt från början av kön. |
...
| void [Enqueue](./enqueue/)(const T\&) | Lägger till ett objekt i slutet av kön. |
...
| virtual int [get_Count](./get_count/)() const | Hämtar antalet element i kön. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Hämtar en enumerator för att iterera genom kön. |
...
| T [Peek](./peek/)() | Hämtar ett objekt från början av kön, men tar inte bort det från kön. |
|  [Queue](./queue/)() | Skapar en tom kö. |
|  [Queue](./queue/)(int) | Skapar en tom kö. |
|  [Queue](./queue/)(const [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\>\&) | Kopieringskonstruktor. |
...
| virtual  [~Object](../../system/object/~object/)() | Förstör objektet. Friger alla interna datastrukturer. |
...
| [queue_t](./queue_t/) | Underliggande datatyp. |
| [IEnumerablePtr](./ienumerableptr/) | Behållare av element av samma typ. |
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator** typ. |

## Anmärkningar

[Queue](./) behållare som omsluter STL-lista. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operator new, då det kan leda till körfel och/eller påståenderelaterade fel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd pekaren för att skicka den till funktioner som argument.
...
int main()
{
  ...
  // Skriv ut det första köobjektet. Metoden Peek tar inte bort ett objekt från kön.
  std::cout << queue->Peek() << std::endl;
  // Skriv ut köobjekten.
  PrintItems(queue);

  // Skriv ut det första köobjektet. Metoden Dequeue tar bort ett objekt från kön.
