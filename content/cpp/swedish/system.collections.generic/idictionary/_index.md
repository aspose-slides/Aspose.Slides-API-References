...
description: "Interface för dictionary-liknande behållare. Objekt av denna klass bör endast allokeras med funktionen System::MakeObject(). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att resultera i körfel och/eller assert-fel. Alltid paketera in denna klass i en System::SmartPtr pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 274
url: /sv/system.collections.generic/idictionary/
---
## IDictionary klass

Interface för dictionary-liknande behållare. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att leda till körfel och/eller assert-fel. Alltid packa in denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd pekaren för att skicka den till funktioner som argument.
...
| Metod | Beskrivning |
| --- | --- |
| virtual void [Add](./add/)(const TKey\&, const TValue\&) | Lägger till ett nyckel-värde-par i behållaren. |
| virtual void [Add](../icollection/add/)(const T\&) | Lägger till ett element i samlingen. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Hämtar en iterator som pekar på det första elementet (om något) i samlingen. Denna iterator kan inte användas för att ändra det refererade objektet eftersom [GetEnumerator()](../ienumerable/getenumerator/) returnerar ett kopieobjekt av T. |
...
| virtual **bool** [ContainsKey](./containskey/)(const TKey\&) const | Kontrollerar om behållaren innehåller nyckeln. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<[KeyValuePair](../keyvaluepair/)\<TKey, TValue\>\>, int) override | Kopierar dictionary-innehållet till befintliga array-element. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Hämtar en iterator som pekar precis efter det sista elementet (om något) i samlingen. Denna iterator kan inte användas för att ändra det refererade objektet eftersom [GetEnumerator()](../ienumerable/getenumerator/) returnerar ett kopieobjekt av T. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-liknande jämförelse av dubbelprecision flyttal där två NaN-värden betraktas som lika även om NaN enligt IEC 60559:1989 inte är lika med något värde, inklusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för interna ändamål. |
| virtual int [get_Count](../icollection/get_count/)() const | Hämtar antalet element i samlingen. |
| **bool** [get_IsFixedSize](./get_isfixedsize/)() const | Kontrollerar om samlingens storlek är fast. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Kontrollerar om samlingen är skrivskyddad. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | Kontrollerar om behållaren är trådsäker. |
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TKey\>\> [get_Keys](./get_keys/)() const | Hämtar nyckelsamlingen. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TValue\>\> [get_Values](./get_values/)() const | Hämtar värdesamlingen. |
...
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey\&) const | Returnerar värdet om det hittas; annars **Value()**. |
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey\&, const TValue\&) const | Returnerar värdet om det hittas; annars **defaultValue**. |
| virtual TValue [GetValueOrNull](./getvalueornull/)(const TKey\&) const | Returnerar värdet om det hittas; annars **null**, vilket bara är meningsfullt för referenstyper. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Cast](../ienumerable/linq_cast/)() | Omvandlar elementen till den angivna typen. |
...
| virtual **bool** [Remove](./remove/)(const TKey\&) | Tar bort nyckeln från behållaren. |
...
| virtual **bool** [TryGetValue](./trygetvalue/)(const TKey\&, TValue\&) const | Söker efter värdet och hämtar det om det hittas. |
...
| --- | --- |
| [BaseType](./basetype/) | Basgränssnittstyp. |
| [KeyValuePairType](./keyvaluepairtype/) | Nyckel-värde-parstyp. |
