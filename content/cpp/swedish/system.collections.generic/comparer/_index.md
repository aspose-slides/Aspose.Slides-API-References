...
description: Tillhandahåller en basklass för implementationer av det generiska gränssnittet System.Collections.Generic.IComparer.
type: docs
weight: 105
url: /sv/system.collections.generic/comparer/
---
## Comparer klass
...
| --- | --- |
| T | Typen av objekt som ska jämföras. |

## Metoder

| Metod | Beskrivning |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) funktion. |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | Returnerar en standard sorteringsordningsjämförare för den typ som anges av det generiska argumentet. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referenstellräknare med det angivna värdet. |
