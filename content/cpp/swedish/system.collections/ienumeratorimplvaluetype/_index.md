...
description: Wrapper som skapar en icke-generisk IEnumerator-implementation över den generiska Iterator IEnumeratorImplRefType - wrapper för värdetyperna.
type: docs
weight: 92
url: /sv/system.collections/ienumeratorimplvaluetype/
---
## IEnumeratorImplValueType klass


Wrapper som skapar icke-generisk [IEnumerator](../ienumerator/)-implementation över den generiska Iterator [IEnumeratorImplRefType](../ienumeratorimplreftype/) – wrapper för värdetyperna.
...
| Metod | Beskrivning |
| --- | --- |
| virtual const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\& [Current](../ienumerator/current/)() const | Hämtar aktuellt element. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Efterliknar C#-stil flyttalss jämförelse där två NaN-värden betraktas som lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Efterliknar C#-stil flyttalss jämförelse där två NaN-värden betraktas som lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Efterliknar C#-stil flyttalss jämförelse där två NaN-värden betraktas som lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Efterliknar C#-stil flyttalss jämförelse där två NaN-värden betraktas som lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för intern användning. |
| const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\& [get_Current](./get_current/)() const override | Hämtar aktuellt element. |
...
| **bool** [MoveNext](./movenext/)() override | Flyttar uppräkningaren till nästa element. Om inget element refererades tidigare sätts referensen till det första tillgängliga elementet. Om behållarens slut nås görs inget. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referenräknare med angivet värde. |
| virtual void [Reset](../ienumerator/reset/)() | Återställer uppräkningaren till positionen före det första elementet. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar svag referenräknare. Bör inte anropas direkt; använd smarta pekare eller ThisProtector alternativt. |
