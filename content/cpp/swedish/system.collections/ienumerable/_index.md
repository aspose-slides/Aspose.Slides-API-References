...
description: IEnumerable är det grundläggande gränssnittet för alla icke-generiska samlingar som kan enumereras.
type: docs
weight: 53
url: /sv/system.collections/ienumerable/
---
## IEnumerable klass


[IEnumerable](./) är det grundläggande gränssnittet för alla icke-generiska samlingar som kan enumereras.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | Returnerar en enumerator som itererar genom en samling. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning för C# lock()-satsen (upplåsning). Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
