...
description: Tillhandahåller en abstrakt basklass för en starkt typad samling.
type: docs
weight: 27
url: /sv/system.collections/collectionbase/
---
...
| void [Clear](./clear/)() | Tar bort alla objekt från samlingsinstansen. Denna metod kan inte åsidosättas. |
...
| **int32_t** [get_Capacity](./get_capacity/)() | Returnerar antalet element som samlingen kan innehålla. |
| **int32_t** [get_Count](./get_count/)() | Returnerar antalet element som finns i samlingsinstansen. Denna metod kan inte åsidosättas. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referen räknare-datastrukturen som är associerad med objektet. |
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Returnerar en enumerator som itererar genom samlingsinstansen. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Concat](../../system.collections.generic/ienumerable/linq_concat/)([SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\>) | Sammanfogar två sekvenser. |
...
| void [RemoveAt](./removeat/)(**int32_t**) | Tar bort elementet vid det angivna indexet i samlingsinstansen. Denna metod kan inte åsidosättas. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referensräknare med angivet värde. |
| void [set_Capacity](./set_capacity/)(**int32_t**) | Sätter antalet element som samlingen kan innehålla. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Sätter det n-te mallargumentet till en weak-pekare (istället för shared). Tillåter att byta pekare i behållare till svagt läge. |
...
| Typedef | Beskrivning |
| --- | --- |
| [Ptr](./ptr/) | Ett alias för en smart pekare till en instans av denna klass. |
