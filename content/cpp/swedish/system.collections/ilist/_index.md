...
description: IList representerar en icke-generisk samling av objekt som kan nås individuellt via index.
type: docs
weight: 118
url: /sv/system.collections/ilist/
---
## IList klass

[IList](./) Representerar en icke-generisk samling av objekt som kan nås individuellt via index.
...
| Metod | Beskrivning |
| --- | --- |
| virtual int [Add](./add/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Lägger till ett objekt i slutet av listan. |
| virtual void [Clear](./clear/)() | Tar bort alla objekt från listan. |
| virtual **bool** [Contains](./contains/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Kontrollerar om objektet finns i listan. |
...
| virtual **bool** [get_IsFixedSize](./get_isfixedsize/)() const | Hämtar ett värde som indikerar om listan har en fast storlek. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(int, int) const | Hämtar objektet på angivet index. |
| virtual int [IndexOf](./indexof/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Hämtar det första indexet för det angivna objektet. |
| virtual void [Insert](./insert/)(int, [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Infogar objektet i listan på det angivna indexet. |
...
| virtual void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Tar bort den första förekomsten av det angivna objektet från listan. |
| virtual void [RemoveAt](./removeat/)(int) | Tar bort objektet från listan på det angivna indexet. |
