...
description: Bas-klass för klasser som ger åtkomst till olika typer av överskrivna teman.
type: docs
weight: 1
...
Bas-klass för klasser som ger åtkomst till olika typer av överskrivna teman.
...
| Metod | Beskrivning |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Tillämpar extra färgschema på en bild. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | Returnerar temats objekt. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Fastställer om [OverrideTheme](../overridetheme/) överskrider ärvt effektivt tema eller inte. För att aktivera [OverrideTheme](../overridetheme/) för överskrivning, använd OverrideTheme.Init*()-metoderna. För att inaktivera [OverrideTheme](../overridetheme/) från överskrivning, använd [OverrideTheme::Clear](../overridetheme/clear/)-metoden. Skrivskyddad **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Returnerar det överskrivande temats objekt. Läs [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Returnerar det överskrivande temats objekt. Skriv [IOverrideTheme](../ioverridetheme/). |
...
* Klass [IOverrideThemeManager](../ioverridethememanager/)
