...
---
## IEffectStyleCollectionEffectiveData klass
...
| static **bool** [Equals](../../system/object/equals/)(**float** const&, **float** const&) | Emulerar C#-stil flyttalssammansättning där två NaN-värden anses lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const&, **double** const&) | Emulerar C#-stil flyttalssammansättning där två NaN-värden anses lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
...
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Returnerar ett värde som visar om åtkomst till samlingen är synkroniserad (trådsäker). Läs-endast **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../../aspose.slides/igenericcollection/get_syncroot/)() | Returnerar ett synkroniserings-rot. Läs-endast [System::Object](../../system/object/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyleEffectiveData](../ieffectstyleeffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Hämtar elementet på det angivna indexet. Läs-endast [IEffectStyleEffectiveData](../ieffectstyleeffectivedata/). |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const&) | Kopieringskonstruktor. Kopierar egentligen inget, utan initierar ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const&) | Tilldelningsoperator. Kopierar egentligen inget, utan initierar ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
...
Det här gränssnittet används som en del av [IFormatSchemeEffectiveData](../iformatschemeeffectivedata/).

## Se även

* Klass [IGenericCollection](../../aspose.slides/igenericcollection/)
* Namnutrymme [Aspose::Slides::Theme](../)
