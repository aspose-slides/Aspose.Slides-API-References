...
description: Representerar en samling av extra färgscheman.
type: docs
weight: 92
...
Representerar en samling av extra färgscheman.
...
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Hämtar en iterator som pekar på det första elementet (om något) i den konstanthörda instansen av samlingen. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Hämtar en iterator som pekar på det första konstanthörda elementet (om något) i samlingen. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Hämtar en iterator som pekar precis efter det sista konstanthörda elementet (om något) i samlingen. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>\>, **int32_t**) override | Kopierar alla element i samlingen till den angivna arrayen. |
| [iterator](./iterator/) [end](./end/)() | Hämtar en iterator som pekar precis efter det sista elementet (om något) i samlingen. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Hämtar en iterator som pekar precis efter det sista elementet (om något) i den konstanthörda instansen av samlingen. |
...
| **int32_t** [get_Count](./get_count/)() override | Returnerar ett antal element i samlingen. Skrivskyddad **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Returnerar ett värde som visar om åtkomst till ArrayList är synkroniserad (trådsäker). Skrivskyddad **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Returnerar ett objekt som kan användas för att synkronisera åtkomst till samlingen. Skrivskyddad [System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returnerar en enumerator som itererar genom samlingen. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog till C# [Object.GetHashCode()](../../system/object/gethashcode/)-metoden. Möjliggör hashning av anpassade objekt. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar den faktiska typen av objektet. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [idx_get](./idx_get/)(**int32_t**) override | Returnerar ett färgschema efter index. Skrivskyddad [ExtraColorScheme](../extracolorscheme/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-konstruktor. Kopierar egentligen ingenting, initierar bara ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallargument till en svag pekare (istället för delad). Tillåter att byta pekare i container till svagt läge. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Hämtar en iterator som pekar på det första elementet (om något)of den konstanthörda instansen av samlingen. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Hämtar en iterator som pekar precis efter det sista elementet (om något)of den konstanthörda instansen av samlingen. |
...
* Klass [IExtraColorSchemeCollection](../iextracolorschemecollection/)
