...
description: Tillhandahåller åtkomst till olika typer av överriddna teman.
type: docs
weight: 417
url: /sv/aspose.slides.theme/ioverridethememanager/
---
## IOverrideThemeManager klass

Tillhandahåller åtkomst till olika typer av överriddna teman.
...
| Metod | Beskrivning |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | Tillägger ett extra färgschema på en bild. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithememanager/createthemeeffective/)() | Returnerar temaobjektet. |
...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | Fastställer om [OverrideTheme](../overridetheme/) åsidosätter ärvt effektivt tema eller inte. För att aktivera [OverrideTheme](../overridetheme/) för överskrivning använd OverrideTheme.Init*()-metoderna. För att inaktivera [OverrideTheme](../overridetheme/) från överskrivning använd [get_OverrideTheme()](./get_overridetheme/)->Clear()-metoden. Läs-endast **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() | Returnerar det åsidosatta temaobjektet. Läs [IOverrideTheme](../ioverridetheme/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referenräknardatastrukturen som är associerad med objektet. |
...
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) | Returnerar det åsidosatta temaobjektet. Skriv [IOverrideTheme](../ioverridetheme/). |
...
* Klass [IThemeManager](../ithememanager/)
