...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](../itheme/get_colorscheme/)() | Returnerar färgschemat. Läs-endast [IColorScheme](../icolorscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) | Returnerar det ytterligare färgschemat på det angivna indexet. Detta schema påverkar inte presentationens utseende, det kan väljas som huvudfärgschema för en bild. Läs-endast [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() | Returnerar samlingen av ytterligare färgscheman. Dessa scheman påverkar inte presentationens utseende, de kan väljas som huvudfärgschema för en bild. Läs-endast [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](../itheme/get_fontscheme/)() | Returnerar typsnittsschemat. Läs-endast [IFontScheme](../ifontscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](../itheme/get_formatscheme/)() | Returnerar formateringsschemat för former. Läs-endast [IFormatScheme](../iformatscheme/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Returnerar namnet på ett tema. Läs [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](../itheme/geteffective/)() | Hämtar effektiv tema-data med arv tillämpat. |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Returnerar namnet på ett tema. Skriv [System::String](../../system/string/). |
