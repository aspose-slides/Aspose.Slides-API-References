...
description: Oföränderligt objekt som representerar en skrivskyddad samling av effektiva radformat.
type: docs
weight: 339
url: /sv/aspose.slides.theme/ilineformatcollectioneffectivedata/
---
## ILineFormatCollectionEffectiveData klass
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Efterliknar C#-stil för flyttalssammanlikning där två NaN betraktas som lika även om IEC 60559:1989 säger att NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Efterliknar C#-stil för flyttalssammanlikning där två NaN betraktas som lika även om IEC 60559:1989 säger att NaN inte är lika med något värde, inklusive NaN. |
...
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Returnerar ett värde som indikerar huruvida åtkomst till samlingen är synkroniserad (trådsäker). Läs-endast **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../../aspose.slides/ilineformateffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Hämtar elementet på angivet index. Läs-endast [ILineFormatEffectiveData](../../aspose.slides/ilineformateffectivedata/). |
