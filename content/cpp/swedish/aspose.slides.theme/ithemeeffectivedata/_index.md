...
description: Oföränderligt objekt som innehåller effektiva temaeigenskaper.
type: docs
weight: 456
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontSchemeEffectiveData](../ifontschemeeffectivedata/)\> [get_FontScheme](./get_fontscheme/)() | Returnerar typsnittsschemat. Endast läsning [IFontSchemeEffectiveData](../ifontschemeeffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatSchemeEffectiveData](../iformatschemeeffectivedata/)\> [get_FormatScheme](./get_formatscheme/)() | Returnerar format-schemat för form. Endast läsning [IFormatSchemeEffectiveData](../iformatschemeeffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorSchemeEffectiveData](../icolorschemeeffectivedata/)\> [GetColorScheme](./getcolorscheme/)([System::Drawing::Color](../../system.drawing/color/)) | Returnerar färgschemat. |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satset låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Inkremenerar delad referensräkning. Bör inte anropas direkt; använd i stället smarta pekare eller ThisProtector. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satset upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Inkremenerar svag referensräkning. Bör inte anropas direkt; använd i stället smarta pekare eller ThisProtector. |
...
Detta gränssnitt används tillsammans med [ITheme](../itheme/)-gränssnittet för att returnera effektiva formateringsvärden med ärftlighet tillämpad. 
