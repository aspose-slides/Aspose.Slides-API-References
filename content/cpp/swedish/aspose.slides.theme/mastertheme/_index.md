...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() override | Returnerar färgschemat. Läs-endast [IColorScheme](../icolorscheme/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) override | Returnerar det extra färgschemat på angivet index. Detta schema påverkar inte presentationens utseende, det kan väljas som huvudfärgschema för en bild. Läs-endast [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() override | Returnerar samlingen av extra färgscheman. Dessa scheman påverkar inte presentationens utseende, de kan väljas som huvudfärgschema för en bild. Läs-endast [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](./get_fontscheme/)() override | Returnerar typsnittsschemat. Läs-endast [IFontScheme](../ifontscheme/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](./get_formatscheme/)() override | Returnerar formatmall för former. Läs-endast [IFormatScheme](../iformatscheme/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Returnerar temats namn. Läs [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\> [get_Presentation](../theme/get_presentation/)() override | Returnerar den överordnade presentationen. Läs-endast [IPresentation](../../aspose.slides/ipresentation/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](../theme/geteffective/)() override | Hämtar effektiva temadata med ärftlighet tillämpad. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar den faktiska objektets typ. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Returnerar temats namn. Skriv [System::String](../../system/string/). |
...
* Klass [Theme](../theme/)
* Klass [IMasterTheme](../imastertheme/)
