...
| Metod | Beskrivning |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Lägger till [IMathBlock](../imathblock/) i slutet av samlingen. |
...
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Bestämmer om samlingen innehåller ett specifikt värde. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar C#-stil flyttalss jämförelse där två NaN-värden anses lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-stil flyttalss jämförelse där två NaN-värden anses lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Endast för interna ändamål. |
| **int32_t** [get_Count](./get_count/)() override | Hämtar antalet element som faktiskt finns i samlingen. Read-only **int32_t**. |
| [MathJustification](../mathjustification/) [get_Justification](./get_justification/)() override | [Paragraph](../../aspose.slides/paragraph/) Justering Standardvärde: CenteredAsGroup |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) override | Hämtar elementet på angivet index. Read-only [IMathBlock](../imathblock/). |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Hämtar elementet på angivet index. Read-only [IMathBlock](../imathblock/). |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Bestämmer indexet för en specifik [IMathBlock](../imathblock/) i samlingen. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Infogar [IMathBlock](../imathblock/) i samlingen på det angivna indexet. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformerar varje element i en sekvens till en ny form genom att integrera elementets index. |
...
|  [MathParagraph](./mathparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Initierar en ny instans av klassen [MathParagraph](./). |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Tar bort den första förekomsten av ett specifikt objekt från samlingen/>. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Tar bort ett objekt på det angivna indexet i samlingen. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referen räknare med angivet värde. |
| void [set_Justification](./set_justification/)([MathJustification](../mathjustification/)) override | [Paragraph](../../aspose.slides/paragraph/) Justering Standardvärde: CenteredAsGroup |
...
| [System::String](../../system/string/) [ToLatex](./tolatex/)() override | Hämtar matematisk ekvation i LaTeX-format |
...
| void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Sparar innehåll av detta [MathParagraph](./) som MathML |
