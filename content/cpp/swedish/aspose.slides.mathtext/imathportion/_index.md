...
description: Representerar en del med matematisk kontext internt.
type: docs
weight: 495
...
Representerar en del med matematisk kontext internt.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathParagraph](../imathparagraph/)\> [get_MathParagraph](./get_mathparagraph/)() | Matematisk stycke |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter det n'te mallargumentet till en svag pekare (i stället för delad). Tillåter att pekare i behållare byts till svagt läge. |
