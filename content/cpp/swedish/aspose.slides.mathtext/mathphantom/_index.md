...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Tar specificerad funktion med detta objekt som argument |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([System::String](../../system/string/)) override | Tar specificerad funktion med detta objekt som argument |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfOneArgument](../mathfunctionsofoneargument/)) override | Tar specificerad funktion med detta objekt som argument |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Tar specificerad funktion med detta objekt som argument och specificerat ytterligare argument |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) override | Tar specificerad funktion med detta objekt som argument och specificerat ytterligare argument |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Omsluter ett matematiskt element i specificerade tecken, såsom parentes eller andra tecken som ram |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Tar en funktion på ett argument med detta objekt som funktionsnamn |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::String](../../system/string/)) override | Tar en funktion på ett argument med detta objekt som funktionsnamn |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() override | Basargument |
| **bool** [get_Show](./get_show/)() override | Hämtar ett värde som indikerar om baselementet visas. |
| **bool** [get_Transp](./get_transp/)() override | Hämtar ett värde som indikerar om fantomet är genomskinligt för klassbaserade avståndsregler. |
| **bool** [get_ZeroAsc](./get_zeroasc/)() override | Hämtar ett värde som indikerar om höjden (ascent, höjd över baslinjen) för baselementet ska behandlas som noll. |
| **bool** [get_ZeroDesc](./get_zerodesc/)() override | Hämtar ett värde som indikerar om nedstigningen (djup under baslinjen) för baselementet ska behandlas som noll. |
| **bool** [get_ZeroWidth](./get_zerowidth/)() override | Hämtar ett värde som indikerar om bredden på baselementet ska behandlas som noll. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../mathelementbase/join/)([System::String](../../system/string/)) override | Sammanfogar ett matematiskt element och bildar ett matematiskt block |
...
|  [MathPhantom](./mathphantom/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Initierar en ny instans av [MathPhantom](./)-klassen med det specificerade basmatematiska elementet. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../mathelementbase/overbar/)() override | Sätter en linje på toppen av detta element |
...
| void [set_Show](./set_show/)(**bool**) override | Sätter ett värde som indikerar om baselementet visas. |
| void [set_Transp](./set_transp/)(**bool**) override | Sätter ett värde som indikerar om fantomet är genomskinligt för klassbaserade avståndsregler. |
| void [set_ZeroAsc](./set_zeroasc/)(**bool**) override | Sätter ett värde som indikerar om höjden (ascent, höjd över baslinjen) för baselementet ska behandlas som noll. |
| void [set_ZeroDesc](./set_zerodesc/)(**bool**) override | Sätter ett värde som indikerar om nedstigningen (djup under baslinjen) för baselementet ska behandlas som noll. |
| void [set_ZeroWidth](./set_zerowidth/)(**bool**) override | Sätter ett värde som indikerar om bredden på baselementet ska behandlas som noll. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Placera detta element i en osynlig ruta (logisk gruppering) som används för att gruppera komponenter i en ekvation eller annan instans av matematisk text. Ett låst objekt kan (till exempel) fungera som en operatoremulator med eller utan en justeringspunkt, fungera som en radbrytning, eller grupperas så att radbrytning inom inte tillåts. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Underbar](../mathelementbase/underbar/)() override | Sätter en linje på botten av detta element |
...
* Klass [IMathPhantom](../imathphantom/)
