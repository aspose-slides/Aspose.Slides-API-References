...
description: Tillåter att skapa en matris
type: docs
weight: 404
url: /sv/aspose.slides.mathtext/imathmatrixfactory/
---
## IMathMatrixFactory klass

Tillåter att skapa en matris
...
| Metod | Beskrivning |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathMatrix](../imathmatrix/)\> [CreateMathMatrix](./createmathmatrix/)(**int32_t**, **int32_t**) | Skapar en matris |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallargument till en svag pekare (istället för en delad). Tillåter att byta pekare i behållare till svag läge. |
