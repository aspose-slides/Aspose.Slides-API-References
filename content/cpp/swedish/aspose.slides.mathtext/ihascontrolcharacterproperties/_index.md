...
description: IMathElement med kontrollteckenegenskaper
type: docs
weight: 14
url: /sv/aspose.slides.mathtext/ihascontrolcharacterproperties/
---
## IHasControlCharacterProperties klass

[IMathElement](../imathelement/) med [Control](../../aspose.slides/control/) teckenegenskaper
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Jämför en värdetypobjekt med nullptr efter referens. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Minskar och returnerar delad referensräknare. Bör inte anropas direkt; använd smarta pekare eller ThisProtector alternativt. |
