...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathParagraph](../imathparagraph/)\> [CreateMathParagraph](./createmathparagraph/)() override | Skapa ett tomt matematiskt stycke |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathParagraph](../imathparagraph/)\> [CreateMathParagraph](./createmathparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Skapar ett matematiskt stycke och placerar det angivna mathblocket i det |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning för C# lock()-uttrycket. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'ta mallargument till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning-upplåsning för C# lock()-uttrycket. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
* Klass [IMathParagraphFactory](../imathparagraphfactory/)
