...
---
## IMathBlockCollection klass

Samling av matematiska block ([IMathBlock](../imathblock/))
...
| Metod | Beskrivning |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Lägger till [IMathBlock](../imathblock/) i slutet av samlingen. |
...
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Avgör om samlingen innehåller ett specifikt värde. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Hämtar antalet element som faktiskt finns i samlingen. Skrivskyddad **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) | Hämtar objektet på det specificerade indexet. Skrivskyddad [IMathBlock](../imathblock/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Hämtar objektet på det specificerade indexet. Skrivskyddad [IMathBlock](../imathblock/). |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Bestämmer indexet för en specifik [IMathBlock](../imathblock/) i samlingen. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Infogar [IMathBlock](../imathblock/) i samlingen på det specificerade indexet. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Tar bort den första förekomsten av ett specifikt objekt från samlingen/>. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Tar bort ett element på det specificerade indexet i samlingen. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Hämtar det aktuella värdet på den delade referensräknaren. |
