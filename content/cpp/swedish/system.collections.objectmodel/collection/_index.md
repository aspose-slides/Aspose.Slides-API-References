...
description: "Bas-typ för generisk samling. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller assertfel. Omslut alltid denna klass i en System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 1
url: /sv/system.collections.objectmodel/collection/
---
## Samlingsklass

Bastyp för generisk samling. Objekt av denna klass bör endast allokeras med hjälp av [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kommer att resultera i körningsfel och/eller assertfel. Omge alltid denna klass med en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| Metod | Beskrivning |
| --- | --- |
| void [Add](./add/)(const T\&) override | Lägger till värde i behållaren. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Hämtar en iterator som pekar direkt efter det sista konstanträttade elementet (om något) i samlingen. |
...
| **bool** [Contains](./contains/)(const T\&) const override | Kontrollerar om objektet finns i samlingen. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Kopierar samlingsobjekt till befintliga arrayelement. |
| [const_reverse_iterator](./const_reverse_iterator/) [crbegin](./crbegin/)() const | Hämtar en omvänd iterator till det sista konstanträttade elementet i samlingen (första i omvänd ordning). |
| [const_reverse_iterator](./const_reverse_iterator/) [crend](./crend/)() const | Hämtar en omvänd iterator för ett icke-existerande konstanträttat element före samlingens början. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Hämtar en iterator som pekar direkt efter det sista elementet (om något) i samlingen. Denna iterator kan inte användas för att ändra ett refererat objekt eftersom [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) returnerar ett kopieringsobjekt av T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Hämtar en iterator som pekar direkt efter det sista elementet (om något) i den konstanträttade instansen av samlingen. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](./get_items/)() | Intern åtkomst till datastruktur. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](./get_items/)() const | Intern åtkomst till datastruktur. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Hämtar enumerator för att iterera genom samlingen. |
...
| T [idx_get](./idx_get/)(int) const override | Hämtar värde på angivet index. |
| void [idx_set](./idx_set/)(int, T) override | Sätter värde på angivet index. |
| int [IndexOf](./indexof/)(const T\&) const override | Söker efter element i samlingen. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Beräknar medelvärdet för en sekvens av värden som erhålls genom att anropa en transform-funktion på varje element i indatan. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar egentligen ingenting, bara initierar ett nytt objekt och möjliggör kopieringskonstruktor för underklasser. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar egentligen ingenting, bara initierar ett nytt objekt och möjliggör kopieringskonstruktor för underklasser. |
| T\& [operator[]](./operator[]/)(int) | Hämtar värde på angivet index. |
| const T\& [operator[]](./operator[]/)(int) const | Hämtar värde på angivet index. |
...
| [const_reverse_iterator](./const_reverse_iterator/) [rbegin](./rbegin/)() const | Hämtar en omvänd iterator till det sista elementet i den konstanträttade samlingen (första i omvänd ordning). |
...
| **bool** [Remove](./remove/)(const T\&) override | Tar bort ett specifikt objekt. |
| void [RemoveAt](./removeat/)(int) override | Tar bort objekt på en specifik position. |
...
| [const_reverse_iterator](./const_reverse_iterator/) [rend](./rend/)() const | Hämtar en omvänd iterator för ett icke-existerande element före den konstanträttade samlingens början. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Gör lagrade pekare svaga (om tillämpligt). |
