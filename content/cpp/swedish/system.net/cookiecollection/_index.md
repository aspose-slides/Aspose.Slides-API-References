...
description: "Representerar en lista med sorterade cookies. Objekt av den här klassen bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av den här typen på stacken eller med operatorn new, eftersom det kan leda till körningsfel och/eller assertionsfel. Omslut alltid den här klassen i en System::SmartPtr-pekare och använd den pekaren för att skicka den till funktioner som argument."
type: docs
weight: 14
url: /sv/system.net/cookiecollection/
---
## CookieCollection klass

Representerar en lista med sorterade cookies. Objekt av den här klassen bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av den här typen på stacken eller med operatorn new, eftersom det kan leda till körningsfel och/eller assertionsfel. Omslut alltid klassen i en [System::SmartPtr](../../system/smartptr/)-pekare och använd den pekaren för att skicka den till funktioner som argument.
...
| Metod | Beskrivning |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) override | Lägger till en cookie i samlingen. |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](./)\>) | Lägger till cookies från den angivna samlingen till den aktuella. |
...
| void [Clear](./clear/)() override | Tar bort alla cookies från samlingen. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) const override | Kontrollerar om samlingen innehåller den angivna cookien. |
...
| **bool** [get_IsOtherVersionSeen](./get_isotherversionseen/)() | Returnerar ett värde som indikerar om samlingen innehåller en cookie med en version som inte är lika med [Cookie::MaxSupportedVersion](../cookie/maxsupportedversion/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\>\> [GetEnumerator](./getenumerator/)() override | Hämtar en enumerator. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [idx_get](./idx_get/)(**int32_t**) | Returnerar en cookie från cookie-samlingen på angivet index. |
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [idx_get](./idx_get/)([String](../../system/string/)) | Returnerar en cookie från cookie-samlingen efter angivet namn. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>) | Returnerar indexet för den angivna cookien. |
| **int32_t** [InternalAdd](./internaladd/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>, **bool**) | Lägger till den angivna cookien i samlingen. |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satser för låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjektet. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) override | Tar bort den angivna cookien från samlingen. |
| void [RemoveAt](./removeat/)(**int32_t**) | Tar bort en cookie på angivet index. |
...
| [DateTime](../../system/datetime/) [TimeStamp](./timestamp/)([CookieCollection::Stamp](./stamp/)) | Uppdaterar tidsstämpeln med angivet scenario och returnerar ett nytt värde. |
...
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Hämtar implementeringen av begin-const-iterator för den aktuella containern. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Hämtar implementeringen av begin-iterator för den aktuella containern. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Hämtar implementeringen av end-const-iterator för den aktuella containern. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Hämtar implementeringen av end-iterator för den aktuella containern. |
...
| Enum | Beskrivning |
| --- | --- |
| [Stamp](./stamp/) | Enumererar operationerna för att ställa in tidsstämpeln. |
