...
| Metod | Beskrivning |
| --- | --- |
| int [Compare](./compare/)([args_type](../../system.collections.generic/icomparer/args_type/), [args_type](../../system.collections.generic/icomparer/args_type/)) const override | Jämför de angivna objekten. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[CookieComparer](./)\> [get_Instance](./get_instance/)() | En 'singleton'-implementering. Returnerar alltid samma instans av den här klassen. |
