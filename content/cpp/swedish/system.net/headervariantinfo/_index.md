...
description: "Används för att matcha cookie-namnet och specifikationen. Objekt av denna klass bör endast allokeras med funktionen System::MakeObject(). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assertionsfel. Omslut alltid denna klass i en System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 196
url: /sv/system.net/headervariantinfo/
---
## HeaderVariantInfo klass


Används för att matcha cookie-namnet och specifikationen. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att leda till körfel och/eller assertionsfel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Returnerar cookie-namnet. |
| [CookieVariant](../cookievariant/) [get_Variant](./get_variant/)() | Returnerar cookie-specifikationen. |
...
|  [HeaderVariantInfo](./headervariantinfo/)([String](../../system/string/), [CookieVariant](../cookievariant/)) | Skapar en ny instans. |
