...
description: Innehåller verktygsmetoder för att arbeta med HttpResponseHeader uppräkningsvärden.
type: docs
weight: 235
url: /sv/system.net/httpresponseheaderextensions/
---
## HttpResponseHeaderExtensions klass


Innehåller verktygsmetoder för att arbeta med HttpResponseHeader-uppräkningsvärden.
...
| static [String](../../system/string/) [GetName](./getname/)([HttpResponseHeader](../httpresponseheader/)) | Returnerar namnet på den angivna rubriken. |
...
|  [HttpResponseHeaderExtensions](./httpresponseheaderextensions/)() | Den borttagna standardkonstruktorn. |
