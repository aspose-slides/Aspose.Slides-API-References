...
description: "Tillhandahåller autentiseringsgränssnittet för att hämta autentiseringsuppgifter för en värd, port och autentiseringstyp. Objekt av denna klass bör endast allokeras med funktionen System::MakeObject(). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assertionsfel. Wrappa alltid denna klass i en System::SmartPtr-pekare och använd denna pekare för att skicka den till funktioner som argument."
type: docs
weight: 313
url: /sv/system.net/icredentialsbyhost/
---
## ICredentialsByHost klass

Tillhandahåller autentiseringsgränssnittet för att hämta autentiseringsuppgifter för en värd, port och autentiseringstyp. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att leda till körfel och/eller påståendefel. Wrappa alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](../networkcredential/)\> [GetCredential](./getcredential/)([String](../../system/string/), **int32_t**, [String](../../system/string/)) | Returnerar autentiseringsuppgifter för den specificerade värden och autentiseringstypen. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning av C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjektet. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upphävd av C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjektet. |
