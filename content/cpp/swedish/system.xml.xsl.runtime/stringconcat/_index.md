...
description: Konkatenar strängar när antalet strängar inte är känt på förhand.
type: docs
weight: 1
url: /sv/system.xml.xsl.runtime/stringconcat/
---
## StringConcat klass


Konkatenar strängar när antalet strängar inte är känt på förhand.
...
| Metod | Beskrivning |
| --- | --- |
| void [Clear](./clear/)() | Rensar resultatsträngen. |
| void [Concat](./concat/)(const [String](../../system/string/)\&) | Konkatenar en ny sträng till resultatet. |
...
| [String](../../system/string/) [get_Delimiter](./get_delimiter/)() | Returnerar strängen som avgränsar de konkatenerade strängarna. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog till C# [Object.GetHashCode()](../../system/object/gethashcode/)-metoden. Möjliggör hashning av anpassade objekt. |
| [String](../../system/string/) [GetResult](./getresult/)() | Returnerar resultatsträngen. |
...
| void [set_Delimiter](./set_delimiter/)(const [String](../../system/string/)\&) | Ställer in strängen som avgränsar de konkatenerade strängarna. |
...
|  [StringConcat](./stringconcat/)() | Standardkonstruktör. |
...
* Namnrymd [System::Xml::Xsl::Runtime](../)
