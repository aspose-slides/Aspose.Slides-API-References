...
description: "ArgumentException kastas när ett argument som skickas till en metod som anropas är ogiltigt. Skapa aldrig instanser av den här klassen manuellt. Använd ArgumentException-klassen istället. Packa aldrig in ArgumentException-klassinstanser i System::SmartPtr."
type: docs
weight: 326
url: /sv/system/details_argumentexception/
---
## Details_ArgumentException klass


ArgumentException kastas när ett argument som skickas till en metod som anropas är ogiltigt. Skapa aldrig instanser av den här klassen manuellt. Använd ArgumentException klass istället. Packa aldrig in ArgumentException klass-instanser i [System::SmartPtr](../smartptr/).
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Returnerar ett 32-bitars heltalsvärde som är en HRESULT-kod som är associerad med undantaget som representeras av det aktuella objektet. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Sätter det n:te mallargumentet till en weak-pekare (istället för shared). Tillåter att byta pekare i behållare till weak-läge. |
| int [SharedCount](../object/sharedcount/)() const | Hämtar nuvarande värde för delad referensräknare. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Ökar delad referensräkning. Bör inte anropas direkt; använd smarta pekare eller ThisProtector i stället. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Minskar och returnerar delad referensräkning. Bör inte anropas direkt; använd smarta pekare eller ThisProtector i stället. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Ökar weak-referensräkning. Bör inte anropas direkt; använd smarta pekare eller ThisProtector i stället. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Minskar weak-referensräkning. Bör inte anropas direkt; använd smarta pekare eller ThisProtector i stället. |
...
ArgumentNullException kastas när en metod som anropas får ett null-argument medan metoden förväntar ett icke-null-värde. Skapa aldrig instanser av den här klassen manuellt. Använd istället ArgumentNullException-klassen. Packa aldrig in ArgumentNullException-klasser i [System::SmartPtr](../smartptr/). 
