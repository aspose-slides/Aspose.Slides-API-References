...
description: "NullReferenceException kastas när en avreferens av en null-referens försöks. Skapa aldrig instanser av denna klass manuellt. Använd NullReferenceException-klassen istället. Inslå aldrig NullReferenceException-klassens instanser i System::SmartPtr."
type: docs
weight: 599
url: /sv/system/details_nullreferenceexception/
---
## Details_NullReferenceException klass

NullReferenceException kastas när en avreferens av en null-referens försöks. Skapa aldrig instanser av denna klass manuellt. Använd NullReferenceException-klassen istället. Inslå aldrig NullReferenceException-klassens instanser i [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emulerar C#-stil floating-point-jämförelse där två NaN-värden betraktas som lika även om IEC 60559:1989 anger att NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-stil floating-point-jämförelse där två NaN-värden betraktas som lika även om IEC 60559:1989 anger att NaN inte är lika med något värde, inklusive NaN. |
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Hämtar referensräknar-datastrukturen som är associerad med objektet. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallargument till en svag pekare (snarare än delad). Tillåter byte av pekare i behållare till svagt läge. |
