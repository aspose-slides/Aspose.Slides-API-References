...
description: Översättaren översätter C#s postinkrementuttryck som riktar sig mot klassens egenskap som har setter och getter definierade, till ett anrop av denna funktion.
type: docs
weight: 2848
url: /sv/system/setter_post_increment_wrap/
---
## System::setter_post_increment_wrap(T(*)(), void(*)(T)) funktion

Översättaren översätter C#s postinkrementuttryck som riktar sig mot klassens egenskap som har setter och getter definierade, till ett anrop av denna funktion.
...
Översättaren översätter C#s postinkrementuttryck som riktar sig mot instansens egenskap som har setter och getter definierade, till ett anrop av denna funktion (överladdning för icke-const getter).
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| host | Host *const | Instans för att anropa getter- och setter-funktioner för. |
...
Översättaren översätter C#s postinkrementuttryck som riktar sig mot instansens egenskap som har setter och getter definierade, till ett anrop av denna funktion (överladdning för const getter).
