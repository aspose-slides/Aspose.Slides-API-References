...
description: "NotSupportedException kastas när en metod som anropas inte stöds eller när en operation som utförs på en ström inte stöds. Skapa aldrig instanser av den här klassen manuellt. Använd NotSupportedException-klassen istället. Packa aldrig NotSupportedException-klassens instanser i System::SmartPtr."
type: docs
weight: 586
url: /sv/system/details_notsupportedexception/
---
## Details_NotSupportedException klass

NotSupportedException kastas när en metod som anropas inte stöds eller när en operation som försöks på en ström inte stöds. Skapa aldrig instanser av denna klass manuellt. Använd NotSupportedException-klassen istället. Packa aldrig NotSupportedException-klassens instanser i [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emulerar jämförelse av flyttal i C#-stil där två NaN betraktas som lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emulerar jämförelse av flyttal i C#-stil där två NaN betraktas som lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopieringskonstruktor. Kopierar egentligen inget, initierar bara nytt objekt och möjliggör kopiekonstruktion av underklasser. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Tilldelningsoperator. Kopierar egentligen inget, initierar bara nytt objekt och möjliggör kopiekonstruktion av underklasser. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Sätter det n:te mallargumentet till en svag pekare (istället för delad). Tillåter att växla pekare i behållare till svagt läge. |
...
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Minskar och returnerar delad referensräknare. Borde inte anropas direkt; använd smarta pekare eller ThisProtector ändå. |
