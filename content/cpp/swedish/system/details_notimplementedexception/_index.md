...
description: "NotImplementedException kastas när en metod inte är implementerad och fungerar som en stub. Skapa aldrig instanser av denna klass manuellt. Använd NotImplementedException-klassen istället. Packa aldrig NotImplementedException-klassens instanser i System::SmartPtr."
type: docs
weight: 573
url: /sv/system/details_notimplementedexception/
---
## Details_NotImplementedException klass


NotImplementedException kastas när en metod inte är implementerad och fungerar som en stub. Skapa aldrig instanser av denna klass manuellt. Använd NotImplementedException-klassen istället. Packa aldrig NotImplementedException-klassinstanser i [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emulerar C#-stilens flyttalsjämförelse där två NaN-värden betraktas som lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-stilens flyttalsjämförelse där två NaN-värden betraktas som lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Returnerar ett 32-bits heltal som är en HRESULT-kod associerad med undantaget som representeras av det aktuella objektet. |
...
| void [Lock](../object/lock/)() | Implementerar C# lock()-statement låsning. Anropa direkt eller använd [LockContext](../lockcontext/)-sentry-objekt. |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Minskar det delade referensräknandet med angivet värde. |
...
| int [SharedCount](../object/sharedcount/)() const | Hämtar det nuvarande värdet av det delade referensräknaren. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Ökar det delade referensräknandet. Borde inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Minskar och returnerar det delade referensräknandet. Borde inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Returnerar objektets strängrepresentation. |
| static const [System::TypeInfo](../typeinfo/)\& [Type](./type/)() |  |
| void [Unlock](../object/unlock/)() | Implementerar C# lock()-statement upplåsning. Anropa direkt eller använd [LockContext](../lockcontext/)-sentry-objekt. |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Ökar svagt referensräknande. Borde inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Minskar svagt referensräknande. Borde inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
