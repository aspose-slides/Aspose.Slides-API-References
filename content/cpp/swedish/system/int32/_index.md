...
description: Innehåller metoder för att arbeta med 32-bitars heltal.
type: docs
weight: 1041
url: /sv/system/int32/
---
...
| Metod | Beskrivning |
| --- | --- |
| static **int32_t** [Parse](./parse/)(const [String](../string/)\&) | Konverterar den angivna strängen som innehåller talets teckenrepresentation till motsvarande 32-bitars signerat heltal. |
| static **int32_t** [Parse](./parse/)(const [String](../string/)\&, const [SharedPtr](../sharedptr/)\<[IFormatProvider](../iformatprovider/)\>\&) | Konverterar den angivna strängen som innehåller talets teckenrepresentation till motsvarande 32-bitars signerat heltal med den angivna formateringsinformationen. |
...
| static **bool** [TryParse](./tryparse/)(const [String](../string/)\&, **int32_t**\&) | Konverterar den angivna strängen som innehåller talets teckenrepresentation till motsvarande 32-bitars signerat heltal. |
| static **bool** [TryParse](./tryparse/)(const [String](../string/)\&, [Globalization::NumberStyles](../../system.globalization/numberstyles/), const [SharedPtr](../sharedptr/)\<[IFormatProvider](../iformatprovider/)\>\&, **int32_t**\&) | Konverterar den angivna strängen som innehåller talets teckenrepresentation till motsvarande 32-bitars signerat heltal med den angivna formateringsinformationen och talstil. |
...
| Fält | Beskrivning |
| --- | --- |
| static constexpr [MaxValue](./maxvalue/) | Största möjliga värdet. |
| static constexpr [MinValue](./minvalue/) | Minsta möjliga värdet. |
