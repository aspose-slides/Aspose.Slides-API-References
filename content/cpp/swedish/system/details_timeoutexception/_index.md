...
description: "TimeoutException indikerar om den tid som avsatts för en process eller operation har löpt ut. Skapa aldrig instanser av den här klassen manuellt. Använd istället TimeoutException-klassen. Wrappa aldrig TimeoutException-klassens instanser i System::SmartPtr."
type: docs
weight: 716
url: /sv/system/details_timeoutexception/
---
## Details_TimeoutException klass

TimeoutException indikerar om den tid som avsatts för en process eller operation har löpt ut. Skapa aldrig instanser av denna klass manuellt. Använd istället TimeoutException klass. Wrappa aldrig TimeoutException klass-instanser i [System::SmartPtr](../smartptr/).
...
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Returnerar strängen som innehåller stack-spårningen. |
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Hämtar datastrukturen för referensräknaren som är kopplad till objektet. |
...
| void [Lock](../object/lock/)() | Implementerar låsning med C# lock()-sats. Anropa direkt eller använd [LockContext](../lockcontext/)-vaktsobjekt. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallargument till en weak-pekare (istället för shared). Möjliggör att byta pekare i behållare till weak-läge. |
...
| void [Unlock](../object/unlock/)() | Implementerar upplåsning av C# lock()-sats. Anropa direkt eller använd [LockContext](../lockcontext/)-vaktsobjekt. |
