...
description: "TimeZoneNotFoundException kastas när tidszonsinformation inte hittas. Skapa aldrig instanser av den här klassen manuellt. Använd istället TimeZoneNotFoundException-klassen. Omslut aldrig instanser av TimeZoneNotFoundException-klassen i System::SmartPtr."
type: docs
weight: 729
url: /sv/system/details_timezonenotfoundexception/
---
## Details_TimeZoneNotFoundException klass


TimeZoneNotFoundException kastas när tidszonsinformation inte hittas. Skapa aldrig instanser av den här klassen manuellt. Använd istället TimeZoneNotFoundException-klassen. Omslut aldrig instanser av TimeZoneNotFoundException-klassen i [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Härmar C#-stil flyttalsjämförelse där två NaN-värden anses lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Härmar C#-stil flyttalsjämförelse där två NaN-värden anses lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
...
| void [Lock](../object/lock/)() | Implementerar C# lock()-satsens låsning. Anropa direkt eller använd [LockContext](../lockcontext/)-sentry-objekt. |
...
| void [Unlock](../object/unlock/)() | Implementerar C# lock()-satsens upplåsning. Anropa direkt eller använd [LockContext](../lockcontext/)-sentry-objekt. |
