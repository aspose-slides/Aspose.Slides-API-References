...
type: docs
weight: 27
url: /sv/system/details_objectdisposedexception/is/
---
## Details_ObjectDisposedException::Is(const System::TypeInfo\&) const metod
...
Sant om objektet är av den markerade typen eller dess underklass, annars falskt.
## Anmärkningar
...
* Klass [Details_ObjectDisposedException](../)
* Namnrymd [System](../../)
