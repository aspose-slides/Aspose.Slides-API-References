...
description: "OperationCanceledException kastas i en tråd när en operation som tråden kör avbryts. Skapa aldrig manuellt instanser av den här klassen. Använd OperationCanceledException-klassen istället. Packa aldrig in OperationCanceledException-klassens instanser i System::SmartPtr."
type: docs
weight: 625
url: /sv/system/details_operationcanceledexception/
---
## Details_OperationCanceledException klass

OperationCanceledException kastas i en tråd när en operation som tråden kör avbryts. Skapa aldrig manuellt instanser av den här klassen. Använd istället OperationCanceledException-klassen. Packa aldrig in OperationCanceledException-klassens instanser i [System::SmartPtr](../smartptr/).
...
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Returnerar strängen som innehåller stack-spåret. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Hämtar det faktiska objektetypen. Analog till C# [System.Object.GetType()](../object/gettype/)-anrop. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Sätter n'te template-argumentet till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svagt läge. |
