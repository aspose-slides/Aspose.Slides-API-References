...
description: ExecutionEngineException finns endast av kompatibilitetsskäl.
type: docs
weight: 456
url: /sv/system/details_executionengineexception/
---
## Details_ExecutionEngineException klass
...
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Returnerar en ordlista med anpassad undantagsdata. |
...
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Returnerar strängen som innehåller stackspårningen. |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | Jämför referens för värdetypobjekt med nullptr. |
...
| virtual  [~Object](../object/~object/)() | Förstör objekt. Frigir alla interna datastrukturer. |
## Se även
