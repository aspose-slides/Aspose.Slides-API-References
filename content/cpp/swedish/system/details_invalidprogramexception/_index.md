...
description: "InvalidProgramException finns endast av kompatibilitetsskäl. Skapa aldrig instanser av den här klassen manuellt. Använd InvalidProgramException-klassen istället. Wrapa aldrig InvalidProgramException-klassens instanser i System::SmartPtr."
type: docs
weight: 521
url: /sv/system/details_invalidprogramexception/
---
## Details_InvalidProgramException klass


InvalidProgramException finns bara av kompatibilitetsskäl. Skapa aldrig instanser av den här klassen manuellt. Använd InvalidProgramException klass istället. Wrappa aldrig InvalidProgramException-klassens instanser i [System::SmartPtr](../smartptr/).
...
| static std::enable_if\<[IsSmartPtr](../issmartptr/)\<T1\>::value\&&[IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | Jämför referenstypsobjekt i C#-stil. |
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emulerar flyttalsjämförelse i C#-stil där två NaN-värden betraktas som lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emulerar flyttalsjämförelse i C#-stil där två NaN-värden betraktas som lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Hämtar det faktiska objektets typ. Analog till C# [System.Object.GetType()](../object/gettype/)-anrop. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopieringskonstruktor. Kopierar faktiskt ingenting, utan initierar bara ett nytt objekt och möjliggör kopiekonstruktion av underklasser. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Tilldelningsoperator. Kopierar faktiskt ingenting, utan initierar bara ett nytt objekt och möjliggör kopiekonstruktion av underklasser. |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | Jämför värdetypobjekt med nullptr med referens. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Sätter HRESULT, ett kodad numeriskt värde som tilldelas ett specifikt undantag. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Sätter det n'te mallargumentet till en svag pekare (istället för delad). Möjliggör byte av pekare i behållare till svagt läge. |
