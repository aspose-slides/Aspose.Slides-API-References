...
description: "Undantaget som kastas när en metod anropas på ett objekt som befinner sig i ett tillstånd som är oförenligt med detta anrop. Skapa aldrig instanser av denna klass manuellt. Använd klassen InvalidOperationException istället. Packa aldrig in instanser av InvalidOperationException-klassen i System::SmartPtr."
type: docs
weight: 508
url: /sv/system/details_invalidoperationexception/
---
## Details_InvalidOperationException klass


Undantaget som kastas när en metod anropas på ett objekt som befinner sig i ett tillstånd som är oförenligt med detta anrop. Skapa aldrig instanser av denna klass manuellt. Använd klassen InvalidOperationException istället. Packa aldrig in instanser av klassen InvalidOperationException i [System::SmartPtr](../smartptr/).
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Returnerar kopian av Exception-objektet som representerar det innersta undantaget. |
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Hämtar referensräknarens datastruktur som är kopplad till objektet. |
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analog till C#-metoden [Object.GetHashCode()](../object/gethashcode/). Möjliggör hashning av anpassade objekt. |
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Hämtar objektets faktiska typ. Analog till C#-anropet [System.Object.GetType()](../object/gettype/). |
...
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Tilldelningsoperator. Kopierar egentligen ingnothing, utan initierar bara ett nytt objekt och möjliggör kopiekonstruktion av underklasser. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Sätter n'te templatargumentet till en svag pekare (istället för delad). Möjliggör att byta pekare i behållare till svagt läge. |
| int [SharedCount](../object/sharedcount/)() const | Hämtar aktuellt värde för det delade referensräknaren. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Ökar det delade referensräknet. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Minskar och returnerar det delade referensräknet. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
...
| void [Unlock](../object/unlock/)() | Implementerar upplåsning enligt C# lock()-satsen. Anropa direkt eller använd [LockContext](../lockcontext/)-vaktsobjektet. |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Ökar det svaga referensräknet. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Minskar det svaga referensräknet. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
| virtual const char * [what](../details_exception/what/)() const | Implementerar [what()](../details_exception/what/)-metoden som anropas av klassen [ExceptionWrapper](../exceptionwrapper/). Trots att den här klassen inte ärvd från std::exception kan avledda klasser använda skyddade/privata medlemmar för att implementera sin logik. Att flytta denna metodimplementering till [ExceptionWrapper](../exceptionwrapper/) kan bryta den logiken. |
