...
description: "StackOverflowException kastas när trådens exekveringsstack överskrider sin gräns. Skapa aldrig instanser av den här klassen manuellt. Använd StackOverflowException-klassen istället. Packa aldrig StackOverflowException-klassens instanser i System::SmartPtr."
type: docs
weight: 690
url: /sv/system/details_stackoverflowexception/
---
## Details_StackOverflowException klass

StackOverflowException kastas när trådens exekveringsstack blir för stor. Skapa aldrig instanser av den här klassen manuellt. Använd i stället StackOverflowException-klassen. Packa aldrig StackOverflowException-klassens instanser i [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Efterliknar C#-stilens flyttalsjämförelse där två NaN-värden anses vara lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Efterliknar C#-stilens flyttalsjämförelse där två NaN-värden anses vara lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Minskar delad referensräknare med det angivna värdet. |
