...
description: Indikerar att en uppräkning kan behandlas som ett bitfält; det vill säga, en uppsättning av.
type: docs
weight: 846
url: /sv/system/flagsattribute/
---
## FlagsAttribute klass

Indikerar att en uppräkning kan behandlas som ett bitfält; det vill säga, en uppsättning av.
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emulerar flyttalssjämförelse i C#-stil där två NaN-värden anses lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emulerar flyttalssjämförelse i C#-stil där två NaN-värden anses lika även om enligt IEC 60559:1989 är NaN inte lika med något värde, inklusive NaN. |
...
| static [Object::ptr](../object/ptr/) [GetCustomAttribute](../attribute/getcustomattribute/)(const [TypeInfo](../typeinfo/)\&, const [TypeInfo](../typeinfo/)\&) | Returnerar ett anpassat attribut av en angiven typ som tillämpas på den angivna typen. |
| static [ArrayPtr](../arrayptr/)\<[Object::ptr](../object/ptr/)\> [GetCustomAttributes](../attribute/getcustomattributes/)(const [TypeInfo](../typeinfo/)\&) | Returnerar alla anpassade attribut som tillämpas på den angivna typen. |
...
| virtual const [TypeInfo](../typeinfo/)\& [GetType](../object/gettype/)() const | Hämtar det faktiska typnamnet för objektet. Analog till C# [System.Object.GetType()](../object/gettype/)-anrop. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallargument till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svagt läge. |
