...
description: "RankException kastas när ett array-argument med ett antal dimensioner som skiljer sig från det förväntade skickas till en metod. Skapa aldrig instanser av den här klassen manuellt. Använd RankException-klassen istället. Omslut aldrig RankException-klassens instanser med System::SmartPtr."
type: docs
weight: 677
url: /sv/system/details_rankexception/
---
## Details_RankException klass


RankException kastas när ett array-argument med ett antal dimensioner som skiljer sig från det förväntade skickas till en metod. Skapa aldrig instanser av denna klass manuellt. Använd RankException-klassen istället. Omge aldrig RankException-klassens instanser med [System::SmartPtr](../smartptr/).
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Returnerar ett 32-bit heltalsvärde som är en HRESULT-kod kopplad till undantaget som representeras av det aktuella objektet. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopieringskonstruktor. Kopierar egentligen inget, utan initierar bara ett nytt objekt och möjliggör kopieringskonstruktion av subklasser. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Tilldelningsoperator. Kopierar egentligen inget, utan initierar bara ett nytt objekt och möjliggör kopieringskonstruktion av subklasser. |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Minskar delad referenstæcount med angivet värde. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Sätter det n'te mallargumentet till en svag pekare (i stället för delad). Tillåter att byta pekare i behållare till svagt läge. |
| int [SharedCount](../object/sharedcount/)() const | Hämtar aktuellt värde på delad referenstæcount. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Ökar delad referenstæcount. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Minskar och returnerar delad referenstæcount. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Ökar svag referenstæcount. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Minskar svag referenstæcount. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
