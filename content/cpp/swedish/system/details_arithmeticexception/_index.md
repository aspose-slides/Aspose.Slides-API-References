...
description: "ArithmeticException kastas när ett fel uppstår under utförandet av aritmetiska operationer, konvertering eller typomvandlingar. Skapa aldrig instanser av den här klassen manuellt. Använd istället ArithmeticException-klassen. Packa aldrig in instanser av ArithmeticException-klassen i System::SmartPtr."
type: docs
weight: 365
url: /sv/system/details_arithmeticexception/
---
## Details_ArithmeticException klass


ArithmeticException kastas när ett fel uppstår under utförandet av aritmetiska operationer, konvertering eller typomvandlingar. Skapa aldrig instanser av denna klass manuellt. Använd istället ArithmeticException-klassen. Packa aldrig in instanser av ArithmeticException-klassen i [System::SmartPtr](../smartptr/).
...
| static std::enable_if\<[IsSmartPtr](../issmartptr/)\<T1\>::value\&&[IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | Jämför objekt av referenstyp i C#-stil. |
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | Jämför objekt av värdetyp i C#-stil. |
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emulerar C#-liknande jämförelse av flyttal där två NaN betraktas som lika även om IEC 60559:1989 anger att NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-liknande jämförelse av flyttal där två NaN betraktas som lika även om IEC 60559:1989 anger att NaN inte är lika med något värde, inklusive NaN. |
...
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Ökar delad referensräknare. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Minskar och returnerar delad referensräknare. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
