...
type: docs
weight: 742
url: /sv/system/details_typeinitializationexception/
---
## Details_TypeInitializationException klass
...
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Returnerar en dictionary med anpassade undantagsdata. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Sätter det n'te mallargumentet till en weak-pekare (snarare än en shared). Tillåter att byta pekare i behållare till weak-läge. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Returnerar den strängrepresentation av det aktuella objektet. |
