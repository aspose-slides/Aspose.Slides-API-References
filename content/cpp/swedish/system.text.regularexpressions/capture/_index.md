...
description: "Resultat av matchning av ett enstaka deluttryck. Objekt av denna klass bör endast allokeras med funktionen System::MakeObject(). Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kommer att leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 1
url: /sv/system.text.regularexpressions/capture/
---
## Capture-klass

Resultat av matchning av ett enstaka deluttryck. Objekt av den här klassen bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kommer att resultera i körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd pekaren för att skicka den till funktioner som argument.
...
| int [get_Index](./get_index/)() const | Hämtar index för fångad delsträng. |
| int [get_Length](./get_length/)() const | Hämtar längden på den fångade delsträngen. |
| [String](../../system/string/) [get_Value](./get_value/)() const | Hämtar den fångade delsträngen. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Hämtar den fångade delsträngen. |
