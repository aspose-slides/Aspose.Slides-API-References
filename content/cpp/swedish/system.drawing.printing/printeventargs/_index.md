...
description: "Tillhandahåller data för BeginPrint- och EndPrint-händelserna. Objekt av denna klass bör endast allokeras med funktionen System::MakeObject(). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assert-fel. Bunta alltid in klassen i en System::SmartPtr-pekare och använd den pekaren för att skicka den som argument till funktioner."
type: docs
weight: 92
url: /sv/system.drawing.printing/printeventargs/
---
## PrintEventArgs klass


Tillhandahåller data för BeginPrint- och EndPrint-händelserna. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det resulterar i körfel och/eller assert-fel. Bunta alltid in denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd den pekaren för att skicka den som argument till funktioner.
...
|  [CancelEventArgs](../../system.componentmodel/canceleventargs/canceleventargs/)() | Konstruktor; sätter Cancel-egenskapen till false. |
...
| **bool** [get_Cancel](../../system.componentmodel/canceleventargs/get_cancel/)() | Hämtar värde som indikerar om händelsen ska avbrytas. |
| [PrintAction](../printaction/) [get_PrintAction](./get_printaction/)() | Returnerar ett värde som specificerar en utskriftsåtgärd representerad av det aktuella objektet. |
...
|  [PrintEventArgs](./printeventargs/)() | Konstruerar en ny instans av [PrintEventArgs](./)-objektet. |
...
| void [set_Cancel](../../system.componentmodel/canceleventargs/set_cancel/)(**bool**) | Ställer in värde som indikerar om händelsen ska avbrytas. |
...
* Klass [CancelEventArgs](../../system.componentmodel/canceleventargs/)
