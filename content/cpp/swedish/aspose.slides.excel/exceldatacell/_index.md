...
| **int32_t** [get_Column](./get_column/)() override | Hämtar kolumnens nollbaserade index i kalkylbladet där cellen är placerad. Skrivskyddad **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Hämtar namnet på diagrammets datacell. |
| **int32_t** [get_Row](./get_row/)() override | Hämtar radens nollbaserade index i kalkylbladet där cellen är placerad. Skrivskyddad **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | Hämtar värdet som finns i [Excel](../) cellen. |
