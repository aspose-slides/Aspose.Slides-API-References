...
description: Glidövergångseffekt för sidriktning.
type: docs
weight: 248
url: /sv/aspose.slides.slideshow/isidedirectiontransition/
---
## ISideDirectionTransition klass


Glidövergångseffekt för sidriktning.
...
| virtual [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() | Riktning för övergången. Läs [TransitionSideDirectionType](../transitionsidedirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) | Riktning för övergången. Skriv [TransitionSideDirectionType](../transitionsidedirectiontype/). |
