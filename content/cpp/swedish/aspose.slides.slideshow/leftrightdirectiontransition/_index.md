...
description: Bildspelsövergångseffekt i vänster-höger riktning.
type: docs
weight: 300
...
| [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() override | Riktning för övergången. Läs [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Fungerar som en hash-funktion för en specifik typ, lämplig för användning i hash-algoritmer och datastrukturer såsom en hashtabell. |
...
| void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) override | Riktning för övergången. Skriv [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
...
* Klass [ILeftRightDirectionTransition](../ileftrightdirectiontransition/)
