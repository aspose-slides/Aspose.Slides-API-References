...
description: Slide-övergångseffekt i sidriktning.
type: docs
weight: 391
...
Slide-övergångseffekt i sidriktning.
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Fungerar som en hashfunktion för en specifik typ, lämplig för användning i hash-algoritmer och datastrukturer som ett hashbord. |
...
| void [Lock](../../system/object/lock/)() | Implementerar C#-satsen lock() för låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjektet. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställer in n't:te mallargumentet till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C#-satsen lock() för upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjektet. |
...
* Klass [ISideDirectionTransition](../isidedirectiontransition/)
