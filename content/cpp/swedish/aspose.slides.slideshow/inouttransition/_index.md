...
| Metod | Beskrivning |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestämmer om de två [TransitionValueBase](../transitionvaluebase/) instanser är lika. |
...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Riktning för en övergångseffekt. Läs [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Fungerar som en hashfunktion för en viss typ, lämplig för användning i hash-algoritmer och datastrukturer som en hashtabell. |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Riktning för en övergångseffekt. Skriv [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsningens upplåsning enligt C# lock()-statement. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
* Klass [IInOutTransition](../iinouttransition/)
