...
description: Slide-övergångseffekt med hörndriktning.
type: docs
weight: 66
url: /sv/aspose.slides.slideshow/icornerdirectiontransition/
---
## ICornerDirectionTransition klass

Slide-övergångseffekt med hörndriktning.
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Jämför referenstypers objekt i C#-stil. |
...
| virtual [TransitionCornerDirectionType](../transitioncornerdirectiontype/) [get_Direction](./get_direction/)() | Riktning för övergången. Läs [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionCornerDirectionType](../transitioncornerdirectiontype/)) | Riktning för övergången. Skriv [TransitionCornerDirectionType](../transitioncornerdirectiontype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätt n'te templatet argument till en weak-pekare (istället för shared). Tillåter att byta pekare i containrar till weak-läge. |
