...
Bildövergångseffekt i åtta riktningar.
...
| [TransitionEightDirectionType](../transitioneightdirectiontype/) [get_Direction](./get_direction/)() override | Riktning för övergången. Läs [TransitionEightDirectionType](../transitioneightdirectiontype/). |
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Fungerar som en hashfunktion för en viss typ, lämplig för användning i hash-algoritmer och datastrukturer som en hash-tabell. |
...
| void [set_Direction](./set_direction/)([TransitionEightDirectionType](../transitioneightdirectiontype/)) override | Riktning för övergången. Skriv [TransitionEightDirectionType](../transitioneightdirectiontype/). |
...
* Klass [IEightDirectionTransition](../ieightdirectiontransition/)
