...
---
## IOptionalBlackTransition klass
...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Detta attribut anger om övergången ska starta från en svart skärm (och sedan övergå till den nya bilden över svart). Läs **bool**. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Detta attribut anger om övergången ska starta från en svart skärm (och sedan övergå till den nya bilden över svart). Skriv **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Anger n'th mallargument som en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning enligt C# lock()-uttrycket som upphäver låset. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
