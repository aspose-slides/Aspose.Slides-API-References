...
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | Anger formen på de visuella element som används under övergången. Läs [TransitionShredPattern](../transitionshredpattern/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Fungerar som en hash-funktion för en viss typ, lämplig för användning i hash-algoritmer och datastrukturer som en hashtabell. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar det faktiska typen av objektet. Analogi till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
...
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | Anger formen på de visuella element som används under övergången. Skriv [TransitionShredPattern](../transitionshredpattern/). |
...
* Klass [IShredTransition](../ishredtransition/)
