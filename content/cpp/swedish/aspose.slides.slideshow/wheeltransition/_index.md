...
| **uint32_t** [get_Spokes](./get_spokes/)() override | Antal ekrar i hjulövergången. Läs **uint32_t**. |
...
| void [set_Spokes](./set_spokes/)(**uint32_t**) override | Antal ekrar i hjulövergången. Skriv **uint32_t**. |
...
* Klass [IWheelTransition](../iwheeltransition/)
