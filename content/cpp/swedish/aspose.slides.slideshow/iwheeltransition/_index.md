...
---
## IWheelTransition klass

Övergångseffekt för hjulglidning.
...
| virtual **uint32_t** [get_Spokes](./get_spokes/)() | Antal ekrar i hjulövergång. Läs **uint32_t**. |
...
| virtual void [set_Spokes](./set_spokes/)(**uint32_t**) | Antal ekrar i hjulövergång. Skriv **uint32_t**. |
