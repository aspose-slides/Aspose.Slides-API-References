...
description: Glittrande bildövergångseffekt.
type: docs
weight: 118
url: /sv/aspose.slides.slideshow/iglittertransition/
---
## IGlitterTransition klass


Glittrande bildövergångseffekt.
...
| virtual [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() | Övergångens riktning. Läs [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() | Anger formen på de visuella element som används under övergången. Läs [TransitionPattern](../transitionpattern/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) | Övergångens riktning. Skriv [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) | Anger formen på de visuella element som används under övergången. Skriv [TransitionPattern](../transitionpattern/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställer in n'te template-argument till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svagt läge. |
