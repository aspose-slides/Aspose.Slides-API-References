...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Riktning för övergången. Läs [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual **bool** [get_HasBounce](./get_hasbounce/)() | Anger att rörelsen av presentationens bilder under övergången inkluderar en studs. Läs **bool**. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Riktning för övergången. Skriv [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_HasBounce](./set_hasbounce/)(**bool**) | Anger att rörelsen av presentationens bilder under övergången inkluderar en studs. Skriv **bool**. |
