...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Övergångens riktning. Läs [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() | Anger formen på de visuella element som används under övergången. Läs [TransitionShredPattern](../transitionshredpattern/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Övergångens riktning. Skriv [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) | Anger formen på de visuella element som används under övergången. Skriv [TransitionShredPattern](../transitionshredpattern/). |
