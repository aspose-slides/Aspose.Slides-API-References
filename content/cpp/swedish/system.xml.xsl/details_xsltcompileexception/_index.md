...
description: Undantaget som kastas av Load-metoden när ett fel påträffas i XSLT-stilmallen.
type: docs
weight: 1
url: /sv/system.xml.xsl/details_xsltcompileexception/
---
## Details_XsltCompileException klass


Undantaget som kastas av **Load**-metoden när ett fel påträffas i XSLT-stilmallen.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | Returnerar en ordbok med anpassade undantagsdata. |
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Returnerar ett 32-bitars heltal som är en HRESULT-kod kopplad till undantaget som representeras av det aktuella objektet. |
...
| virtual **int32_t** [get_LineNumber](../details_xsltexception/get_linenumber/)() | Returnerar radnumret som anger var felet inträffade i stilmallen. |
| virtual **int32_t** [get_LinePosition](../details_xsltexception/get_lineposition/)() | Returnerar radpositionen som anger var felet inträffade i stilmallen. |
| [String](../../system/string/) [get_Message](../details_xsltexception/get_message/)() const override | Returnerar det formaterade felmeddelandet som beskriver det aktuella undantaget. |
| virtual [String](../../system/string/) [get_SourceUri](../details_xsltexception/get_sourceuri/)() | Returnerar plats-sökvägen för stilmallen. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Hämtar den faktiska typen av objektet. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar egentligen inget, utan initierar endast nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar egentligen inget, utan initierar endast nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
...
* Klass [Details_XsltException](../details_xsltexception/)
