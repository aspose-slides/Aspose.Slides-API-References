...
description: "Tillhandahåller data för händelsen XsltArgumentList::XsltMessageEncountered."
type: docs
weight: 92
url: /sv/system.xml.xsl/xsltmessageencounteredeventargs/
---
## XsltMessageEncounteredEventArgs klass


Tillhandahåller data för händelsen **XsltArgumentList::XsltMessageEncountered**.
...
| virtual [String](../../system/string/) [get_Message](./get_message/)() | Returnerar innehållet i **xsl:message**-elementet. |
