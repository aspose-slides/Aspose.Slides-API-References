...
description: Representerar ett objekt i XQuery 1.0 och XPath 2.0-datamodellen.
type: docs
weight: 53
url: /sv/system.xml.xpath/xpathitem/
---
## XPathItem klass
...
| virtual **bool** [get_IsNode](./get_isnode/)() | När den åsidosätts i en härledd klass, får ett värde som indikerar om objektet representerar en [XPath](../)-nod eller ett atomärt värde. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_TypedValue](./get_typedvalue/)() | När den åsidosätts i en härledd klass, får det aktuella objektet som ett inkapslat objekt av den mest lämpliga typen enligt dess schematyp. |
| virtual [String](../../system/string/) [get_Value](./get_value/)() | När den åsidosätts i en härledd klass, får **string**-värdet för objektet. |
| virtual **bool** [get_ValueAsBoolean](./get_valueasboolean/)() | När den åsidosätts i en härledd klass, får objektets värde som en [Boolean](../../system/boolean/). |
| virtual [DateTime](../../system/datetime/) [get_ValueAsDateTime](./get_valueasdatetime/)() | När den åsidosätts i en härledd klass, får objektets värde som en [DateTime](../../system/datetime/). |
| virtual **double** [get_ValueAsDouble](./get_valueasdouble/)() | När den åsidosätts i en härledd klass, får objektets värde som en [Double](../../system/double/). |
| virtual **int32_t** [get_ValueAsInt](./get_valueasint/)() | När den åsidosätts i en härledd klass, får objektets värde som en [Int32](../../system/int32/). |
| virtual **int64_t** [get_ValueAsLong](./get_valueaslong/)() | När den åsidosätts i en härledd klass, får objektets värde som en [Int64](../../system/int64/). |
| virtual [TypeInfo](../../system/typeinfo/) [get_ValueType](./get_valuetype/)() | När den åsidosätts i en härledd klass, får typen av objektet. |
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchemaType](../../system.xml.schema/xmlschematype/)\> [get_XmlType](./get_xmltype/)() | När den åsidosätts i en härledd klass, får XmlSchemaType för objektet. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ValueAs](./valueas/)(const [TypeInfo](../../system/typeinfo/)\&) | Returnerar objektets värde som den angivna typen. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ValueAs](./valueas/)(const [TypeInfo](../../system/typeinfo/)\&, [SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>) | När den åsidosätts i en härledd klass, returnerar objektets värde som den typ som anges med [IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)-objektet för att lösa namnrymdsprefix. |
