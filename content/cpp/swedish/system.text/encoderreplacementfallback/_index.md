...
description: "Tillhandahåller en fallback-strategi för att ersätta felaktig symbol med en stub. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av den här typen på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assert-fel. Wrapa alltid den här klassen i en System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 196
url: /sv/system.text/encoderreplacementfallback/
---
## EncoderReplacementFallback klass

Tillhandahåller fallback-strategi för att ersätta felaktig symbol med en stub. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assert-fel. Wrapa alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd pekaren för att skicka den till funktioner som argument.
...
| Metod | Beskrivning |
| --- | --- |
| [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Skapar en fallback-buffert. |
| [EncoderReplacementFallback](./encoderreplacementfallback/)() | Konstruktor som använder standard-strängen "?" som ersättning. |
...
| const [String](../../system/string/)\& [get_DefaultString](./get_defaultstring/)() const | Hämtar ersättningssträng. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](../encoderfallback/get_exceptionfallback/)() | Hämtar standardimplementering för undantags-fallback. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Hämtar maximalt antal tecken som instansen kan returnera. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](../encoderfallback/get_replacementfallback/)() | Hämtar standardimplementering för ersättnings-fallback. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_StandardSafeFallback](../encoderfallback/get_standardsafefallback/)() | Hämtar standardimplementering för säker fallback. |
