...
description: Enkel implementation av IComparable<>
type: docs
weight: 1
url: /sv/system.boxedvaluedetail/comparable/
---
## Jämförbar klass


Enkel implementation av IComparable<>
...
| Metod | Beskrivning |
| --- | --- |
| int [CompareTo](./compareto/)(T) override | Jämför det aktuella objektet med det angivna objektet. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-sats avlåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
