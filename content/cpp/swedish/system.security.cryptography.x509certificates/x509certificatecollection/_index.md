...
description: "Samling av X509-certifikatobjekt. Objekt av denna klass ska endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av den här typen på stacken eller med operator new, eftersom det kan leda till körningstidfel och/eller assertion-fel. Wrappa alltid den här klassen i en System::SmartPtr-pekare och använd den pekaren för att skicka den som argument till funktioner."
type: docs
weight: 79
url: /sv/system.security.cryptography.x509certificates/x509certificatecollection/
---
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/list/cend/)() const | Hämtar en iterator för ett icke-existerande const-kvalificerat element bakom slutet av samlingen. |
...
| void [CopyTo](../../system.collections.generic/list/copyto/)(int, const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&, int, int) | Kopierar element från angivet index till befintliga array-element. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/list/end/)() const | Hämtar en iterator för ett icke-existerande element bakom slutet av den const-kvalificerade samlingen. |
...
| void [ForEach](../../system.collections.generic/list/foreach/)([System::Action](../../system/action/)\<T\>) | Applicerar en åtgärd på alla element i listan. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referenskänten-datastruktur som är associerad med objektet. |
...
| **ThisPtr** [GetRange](../../system.collections.generic/list/getrange/)(int, int) | Skapar ett utsnitt av listan. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollerar om objektet representerar en instans av den typ som beskrivas av targetType. Analog till C#-operatorn 'is'. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | Söker efter det angivna objektet och returnerar det nollbaserade indexet för sista förekomsten i hela listan. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Söker efter det angivna objektet och returnerar det nollbaserade indexet för sista förekomsten inom intervallet av element i [List](../../system.collections.generic/list/) som sträcker sig från första elementet till det angivna indexet. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Söker efter det angivna objektet och returnerar det nollbaserade indexet för sista förekomsten inom intervallet av element i [List](../../system.collections.generic/list/) som innehåller det angivna antalet element och slutar vid det angivna indexet. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Jämför referens med ett värdetyp-objekt och nullptr. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar det delade referenskäntet med angivet värde. |
| void [RemoveRange](../../system.collections.generic/list/removerange/)(int, int) | Tar bort ett utsnitt av listan. |
...
| void [Reverse](../../system.collections.generic/list/reverse/)() | Vänder på ordningen av alla element i listan. |
| void [Reverse](../../system.collections.generic/list/reverse/)(int, int) | Vänder på ordningen av listens utsnitt. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Hämtar aktuellt värde på det delade referenskäntet. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Ökar det delade referenskäntet. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Minskar och returnerar det delade referenskäntet. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
...
| void [Sort](../../system.collections.generic/list/sort/)(int, int, [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>) | Sorterar element i listans utsnitt. |
...
| void [TrimExcess](../../system.collections.generic/list/trimexcess/)() | Justera listkapaciteten till dess storlek. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar weak-referenskäntet. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar weak-referenskäntet. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
