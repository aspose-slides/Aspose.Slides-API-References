...
description: "Extensionsobjekt för att lagra extra information som är associerad med X.509-certifikat. Objekt av denna klass bör endast allokeras med hjälp av System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körningstidfel och/eller påståendesfel. Omslut alltid denna klass i en System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 144
url: /sv/system.security.cryptography.x509certificates/x509extension/
---
## X509Extension klass

Extensionsobjekt för att lagra extra information som är associerad med X.509-certifikat. Objekt av denna klass bör endast allokeras med hjälp av [System::MakeObject()](../../system/makeobject/) funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att resultera i körningstidfel och/eller påståendesfel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| void [CopyFrom](./copyfrom/)(const [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](../../system.security.cryptography/asnencodeddata/)\>\&) override | Kopierar extensionsdata från ett annat objekt. |
...
| virtual [String](../../system/string/) [Format](../../system.security.cryptography/asnencodeddata/format/)(**bool**) const | Formaterar data i ett människoläsbart format. |
| **bool** [get_Critical](./get_critical/)() const | Kontrollerar om tillägget är kritiskt. |
| [SharedPtr](../../system/sharedptr/)\<[Oid](../../system.security.cryptography/oid/)\> [get_Oid](../../system.security.cryptography/asnencodeddata/get_oid/)() const | Hämtar objektidentifieraren för kodade data. |
...
| void [set_Critical](./set_critical/)(**bool**) | Definierar om tillägget är kritiskt. |
| void [set_Oid](../../system.security.cryptography/asnencodeddata/set_oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](../../system.security.cryptography/oid/)\>\&) | Sätter objektidentifieraren för kodade data. |
