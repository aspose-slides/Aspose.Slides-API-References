...
description: "ReflectionTypeLoadException kastas av metoden Module.GetTypes om någon av klasserna i en modul misslyckas med att laddas. Skapa aldrig instanser av denna klass manuellt. Använd ReflectionTypeLoadException-klassen istället. Packa aldrig in instanser av ReflectionTypeLoadException-klassen i System::SmartPtr."
type: docs
weight: 66
url: /sv/system.reflection/details_reflectiontypeloadexception/
---
## Details_ReflectionTypeLoadException klass


ReflectionTypeLoadException kastas av metoden Module.GetTypes om någon av klasserna i en modul misslyckas med att laddas. Skapa aldrig instanser av denna klass manuellt. Använd ReflectionTypeLoadException-klassen istället. Packa aldrig in instanser av ReflectionTypeLoadException-klassen i [System::SmartPtr](../../system/smartptr/).
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Exception](../../system/exception/)\> [get_LoaderExceptions](./get_loaderexceptions/)() const | Returnerar de undantag som orsakar detta undantag. |
...
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Returnerar strängen som innehåller stackspårningen. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::TypeInfo](../../system/typeinfo/)\> [get_Types](./get_types/)() const | Returnerar typinformationen för orsakerna till undantaget. |
