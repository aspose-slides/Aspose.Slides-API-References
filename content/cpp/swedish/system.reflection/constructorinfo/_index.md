...
description: Tillhandahåller åtkomst till konstruktormetadata.
type: docs
weight: 53
url: /sv/system.reflection/constructorinfo/
---
## ConstructorInfo-klass

Tillhandahåller åtkomst till konstruktormetadata.
...
| Metod | Beskrivning |
| --- | --- |
| void [AddAttribute](../memberinfo/addattribute/)(const [ObjectPtr](../memberinfo/objectptr/)\&) | Lägger till attribut till samlingen. |
| [ConstructorInfo](./constructorinfo/)(const [String](../../system/string/)\&, std::function\<[System::Object::ptr](../../system/object/ptr/)()>) | Initierar en ny instans av klassen [ConstructorInfo](./) för konstruktor utan parametrar. |
...
| [TypeInfo](../../system/typeinfo/) [get_DeclaringType](./get_declaringtype/)() | Hämtar klassen som deklarerar detta medlem. INTE IMPLEMENTERAD. |
| [TypeInfo](../../system/typeinfo/) [get_DeclaringType](../memberinfo/get_declaringtype/)() const | Hämtar deklarerande typ. |
| const [String](../../system/string/)\& [get_FullName](../memberinfo/get_fullname/)() const | Hämtar medlemmens fullständiga namn. Kan vara annorlunda i manuellt implementerade delar. |
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Hämtar ett MemberTypes-värde som indikerar att detta medlem är en konstruktor. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[MemberInfo](../memberinfo/)\> [GetCurrentMethod](../methodbase/getcurrentmethod/)(const [String](../../system/string/)\&) | Denna metod möjliggör att hämta det aktuella metodnamnet. Översättaren ersätter ASPOSE_CURRENT_FUNCTION som parameter automatiskt. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | Returnerar en array som innehåller objekt som representerar alla anpassade attribut som tillämpats på typen som representeras av det aktuella objektet. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(**bool**) const | Returnerar en array som innehåller objekt som representerar alla anpassade attribut som tillämpats på typen som representeras av det aktuella objektet. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Invoke](./invoke/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\>\&) | Invokerar metoden eller konstruktorn som representeras av den aktuella instansen, med de angivna parametrarna. |
...
| [MethodBase](../methodbase/methodbase/)() | Initierar en ny instans av [MethodBase](../methodbase/)-klassen. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar den svaga referensräknaren. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar den svaga referensräknaren. Bör inte anropas direkt; använd istället smarta pekare eller ThisProtector. |
| virtual  [~Object](../../system/object/~object/)() | Förstör objektet. Frigör alla interna datastrukturer. |

## Se även

* Klass [MethodBase](../methodbase/)
