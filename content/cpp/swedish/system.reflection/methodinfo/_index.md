...
description: Representerar information om klassmetod.
type: docs
weight: 131
url: /sv/system.reflection/methodinfo/
---
## MethodInfo klass

Representerar information om klassmetod.
...
| const [String](../../system/string/)\& [get_FullName](../memberinfo/get_fullname/)() const | Hämtar medlemmets fullständiga namn. Kan vara annorlunda i manuellt implementerade delar. |
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Hämtar ett MemberTypes-värde som indikerar att detta medlem är en metod. |
| const [String](../../system/string/)\& [get_Name](../memberinfo/get_name/)() const | Hämtar medlemsnamn. |
| [TypeInfo](../../system/typeinfo/) [get_ReflectedType](../memberinfo/get_reflectedtype/)() const | Hämtar reflekterad typtyp. |
...
|  [MethodInfo](./methodinfo/)(const [String](../../system/string/)\&) | Initierar en ny instans av [MethodInfo](./)-klassen. |
