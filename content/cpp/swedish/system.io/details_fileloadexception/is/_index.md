...
type: docs
weight: 27
url: /sv/system.io/details_fileloadexception/is/
---
## Details_FileLoadException::Is(const System::TypeInfo\&) const metod
...
Sant om objektet är av den märkta typen eller en underklass, falskt annars.
...
* Klass [Details_FileLoadException](../)
* Namnrymd [System::IO](../../)
