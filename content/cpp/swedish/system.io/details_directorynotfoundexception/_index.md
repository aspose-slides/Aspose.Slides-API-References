...
type: docs
weight: 131
url: /sv/system.io/details_directorynotfoundexception/
---
## Details_DirectoryNotFoundException klass
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter det n'te mallargumentet till en weak-pekare (i stället för shared). Tillåter att byta pekare i behållare till weak-läge. |
