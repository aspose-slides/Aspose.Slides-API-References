...
| Metod | Beskrivning |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Lägg till ny interaktiv sekvens. |
...
| virtual void [Clear](./clear/)() | Tar bort alla sekvenser från en samling. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Returnerar antalet element i en samling Read-only **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [idx_get](./idx_get/)(**int32_t**) | Returnerar en sekvens på det angivna indexet. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Fastställer om något element i en sekvens finns eller uppfyller ett villkor. |
...
| **bool** [LINQ_Contains](../../system.collections.generic/ienumerable/linq_contains/)(T) | Fastställer om en sekvens innehåller ett specifikt värde. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_OfType](../../system.collections.generic/ienumerable/linq_oftype/)() | Filtrerar element i sekvensen baserat på den angivna typen. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>) | Tar bort angiven sekvens från en samling. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Tar bort sekvens på det angivna indexet. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar det delade referensräkningen med angivet värde. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsningens upplåsning enligt C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
