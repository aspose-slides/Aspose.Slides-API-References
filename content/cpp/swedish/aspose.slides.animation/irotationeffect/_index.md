...
description: Representerar roteringsbeteende för effekt.
type: docs
weight: 352
url: /sv/aspose.slides.animation/irotationeffect/
---
## IRotationEffect klass
...
| virtual **float** [get_By](./get_by/)() | Beskriver det relativa offset-värdet för animationen. Läs **float**. |
| virtual **float** [get_From](./get_from/)() | Beskriver startvärdet för animationen. Läs **float**. |
...
| virtual **float** [get_To](./get_to/)() | Beskriver slutvärdet för animationen. Läs **float**. |
...
| virtual void [set_By](./set_by/)(**float**) | Beskriver det relativa offset-värdet för animationen. Skriv **float**. |
| virtual void [set_From](./set_from/)(**float**) | Beskriver startvärdet för animationen. Skriv **float**. |
...
| virtual void [set_To](./set_to/)(**float**) | Beskriver slutvärdet för animationen. Skriv **float**. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Hämtar nuvarande värde för delad referensräkning. |
