...
| Metod | Beskrivning |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) override | Lägg till en ny effekt i slutet av den aktuella sekvensen till slutet av gruppens textanimationer. Giltig endast om antalet textstycken är lika med eller större än antalet effekter i denna grupp! |
...
| [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() override | Lista över byggtyp (för exp. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, Allt på en gång) för textanimation. Läs [Animation::BuildType](../buildtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() override | Länkad formseffekt med grupp eller ingen (null). Läs [IEffect](../ieffect/). |
...
| void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) override | Lista över byggtyp (för exp. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, Allt på en gång) för textanimation. Skriv [Animation::BuildType](../buildtype/). |
| void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) override | Länkad formseffekt med grupp eller ingen (null). Skriv [IEffect](../ieffect/). |
...
* Klass [ITextAnimation](../itextanimation/)
