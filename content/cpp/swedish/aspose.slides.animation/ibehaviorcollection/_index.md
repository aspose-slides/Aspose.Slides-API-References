...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Lägger till ett nytt beteende i en samling. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Hämtar iterator som pekar direkt efter det sista konstantkvalificerade elementet (om något) i samlingen. |
| virtual void [Clear](./clear/)() | Tar bort alla beteenden från en samling. |
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Avgör om [ICollection](../../system.collections.generic/icollection/) innehåller ett specifikt värde. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Hämtar iterator som pekar direkt efter det sista elementet (om något) i samlingen. Denna iterator kan inte användas för att ändra ett refererat objekt eftersom [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) returnerar ett kopierat objekt av T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Hämtar iterator som pekar direkt efter det sista elementet (om något) i den konstantkvalificerade instansen av samlingen. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Returnerar antalet beteenden i en samling. Läs-endast **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) | Returnerar ett beteende på det angivna indexet. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Returnerar ett beteende på det angivna indexet. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Avgör index för ett specifikt objekt i [IList](../../system.collections.generic/ilist/). |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Infogar ett nytt beteende i en samling på det angivna indexet. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Tar bort specificerat beteende från en samling. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Tar bort beteende från en samling på det specificerade indexet. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satss upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjektet. |
