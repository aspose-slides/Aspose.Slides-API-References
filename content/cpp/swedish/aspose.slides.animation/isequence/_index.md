...
description: Representerar sekvens (samling av effekter).
type: docs
weight: 378
...
Representerar en sekvens (samling av effekter).
...
| Metod | Beskrivning |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>, [EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | Lägg till en ny effekt i slutet av sekvensen. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../../aspose.slides/iparagraph/)\>, [EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | Lägg till en ny animationseffekt för ett stycke i slutet av sekvensen. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::Charts::IChart](../../aspose.slides.charts/ichart/)\>, [EffectChartMajorGroupingType](../effectchartmajorgroupingtype/), **int32_t**, [EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | Lägger till den nya diagramanimationseffekten för kategori eller serie i slutet av sekvensen. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::Charts::IChart](../../aspose.slides.charts/ichart/)\>, [EffectChartMinorGroupingType](../effectchartminorgroupingtype/), **int32_t**, **int32_t**, [EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | Lägger till den nya diagramanimationseffekten för element i kategori eller serie i slutet av sekvensen. |
...
| virtual void [Clear](./clear/)() | Tar bort alla effekter från en samling. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Returnerar antalet effekter i en sekvens. Läs-endast **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_TriggerShape](./get_triggershape/)() | Returnerar formmål för INTERACTIVE-sekvens. Om sekvensen inte är interaktiv returneras null. Läs [IShape](../../aspose.slides/ishape/). |
| virtual **int32_t** [GetCount](./getcount/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Returnerar antalet effekter för den angivna formen. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>\> [GetEffectsByParagraph](./geteffectsbyparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../../aspose.slides/iparagraph/)\>) | Returnerar en array av effekter för det angivna stycket. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>\> [GetEffectsByShape](./geteffectsbyshape/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Returnerar en array av effekter för den angivna formen. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../../system.collections.generic/ienumerable/getenumerator/)() | Hämtar en enumerator. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [idx_get](./idx_get/)(**int32_t**) | Returnerar en effekt vid det angivna indexet. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[System::Linq::IGrouping](../../system.linq/igrouping/)\<Key, T\>\>\>\> [LINQ_GroupBy](../../system.collections.generic/ienumerable/linq_groupby/)([System::Func](../../system/func/)\<T, Key\>) | Grupperar element i en sekvens. |
| [System::SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[System::Linq::IGrouping](../../system.linq/igrouping/)\<Key, Element\>\>\>\> [LINQ_GroupBy](../../system.collections.generic/ienumerable/linq_groupby/)([System::Func](../../system/func/)\<T, Key\>, [System::Func](../../system/func/)\<T, Element\>) | Grupperar element i en sekvens. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) | Tar bort specificerad effekt från en samling. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Tar bort en effekt från en samling. |
| virtual void [RemoveByShape](./removebyshape/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Tar bort effekt för den specificerade formen. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referensräknare med specificerat värde. |
| virtual void [set_TriggerShape](./set_triggershape/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Sätter formmål för INTERACTIVE-sekvens. Om sekvensen inte är interaktiv returneras null. Skriv [IShape](../../aspose.slides/ishape/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätt n'te mallargument till en weak-pekare (i stället för shared). Tillåter att byta pekare i behållare till weak-läge. |
