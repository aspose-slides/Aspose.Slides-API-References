...
| Metod | Beskrivning |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | Lägg till ny effekt i slutet av den aktuella sekvensen till slutet av gruppens textanimationer. Giltig endast om antalet textparagrafer är lika med eller större än antalet effekter i denna grupp! |
...
| virtual [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() | Lista över byggtyp (för exp. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) av textanimation. Läs [BuildType](../buildtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() | Länkad formseffekt med grupp eller ej (null) Läs [IEffect](../ieffect/). |
...
| virtual void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) | Lista över byggtyp (för exp. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) av textanimation. Skriv [BuildType](../buildtype/). |
| virtual void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) | Länkad formseffekt med grupp eller ej (null) Skriv [IEffect](../ieffect/). |
