...
| **float** [get_Value0](./get_value0/)() override | Definierar första värdet av förskjutningen. Läs **float**. |
| **float** [get_Value1](./get_value1/)() override | Definierar andra värdet av förskjutningen. Läs **float**. |
| **float** [get_Value2](./get_value2/)() override | Definierar tredje värdet av förskjutningen. Läs **float**. |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satsets låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objekt. |
...
| void [set_Value0](./set_value0/)(**float**) override | Definierar första värdet av förskjutningen. Skriv **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Definierar andra värdet av förskjutningen. Skriv **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Definierar tredje värdet av förskjutningen. Skriv **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställer in n'te mallargument till en svag pekare (i stället för delad). Möjliggör att växla pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satsets upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objekt. |
...
* Klass [IColorOffset](../icoloroffset/)
