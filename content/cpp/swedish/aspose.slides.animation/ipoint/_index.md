...
| virtual [System::String](../../system/string/) [get_Formula](./get_formula/)() | Formler inom värden, from, to, by-attribut kan bestå av följande: Standardaritmetiska operatorer: \\uFFFD+\\uFFFD, \\uFFFD-\\uFFFD, \\uFFFD*\\uFFFD, \\uFFFD/\\uFFFD, \\uFFFD^\\uFFFD, \\uFFFD\\uFFFD (mod) Konstanter: \\uFFFDpi\\uFFFD \\uFFFDe\\uFFFD Villkorsoperatorer: \\uFFFDabs\\uFFFD, \\uFFFDmin\\uFFFD, \\uFFFDmax\\uFFFD, \\uFFFD?\\uFFFD (if) Jämförelseoperatorer: '==', '>=', '', '!=', '!' Trigonometriska operatorer: \\uFFFDsin()\\uFFFD, \\uFFFDcos()\\uFFFD, \\uFFFDtan()\\uFFFD, \\uFFFDasin()\\uFFFD, \\uFFFDacos()\\uFFFD, \\uFFFDatan()\\uFFFD Naturlig logaritm \\uFFFDln()\\uFFFD Egendomsreferenser (host-stödda egenskaper) |
| virtual **float** [get_Time](./get_time/)() | Representerar tidsvärde. Läs **float**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() | Representerar punktvärde. Endast: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Läs [System::Object](../../system/object/). |
...
| virtual void [set_Formula](./set_formula/)([System::String](../../system/string/)) | Formler inom värden, from, to, by-attribut kan bestå av följande: Standardaritmetiska operatorer: \\uFFFD+\\uFFFD, \\uFFFD-\\uFFFD, \\uFFFD*\\uFFFD, \\uFFFD/\\uFFFD, \\uFFFD^\\uFFFD, \\uFFFD\\uFFFD (mod) Konstanter: \\uFFFDpi\\uFFFD \\uFFFDe\\uFFFD Villkorsoperatorer: \\uFFFDabs\\uFFFD, \\uFFFDmin\\uFFFD, \\uFFFDmax\\uFFFD, \\uFFFD?\\uFFFD (if) Jämförelseoperatorer: '==', '>=', '', '!=', '!' Trigonometriska operatorer: \\uFFFDsin()\\uFFFD, \\uFFFDcos()\\uFFFD, \\uFFFDtan()\\uFFFD, \\uFFFDasin()\\uFFFD, \\uFFFDacos()\\uFFFD, \\uFFFDatan()\\uFFFD Naturlig logaritm \\uFFFDln()\\uFFFD Egendomsreferenser (host-stödda egenskaper) |
| virtual void [set_Time](./set_time/)(**float**) | Representerar tidsvärde. Skriv **float**. |
| virtual void [set_Value](./set_value/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Representerar punktvärde. Endast: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Skriv [System::Object](../../system/object/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallargument som en svag pekare (istället för delad). Tillåter att byta pekare i containrar till svagt läge. |
