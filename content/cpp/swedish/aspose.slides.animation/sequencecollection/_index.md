...
| Metod | Beskrivning |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | Lägg till en ny interaktiv sekvens. Läs/skriv [Sequence](../sequence/). |
| [iterator](./iterator/) [begin](./begin/)() | Hämtar iterator som pekar på det första elementet (om något) i samlingen. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Hämtar iterator som pekar på det första elementet (om något) av den const-kvalificerade instansen av samlingen. |
...
| void [Clear](./clear/)() override | Tar bort alla sekvenser från en samling. |
| [iterator](./iterator/) [end](./end/)() | Hämtar iterator som pekar precis efter det sista elementet (om något) i samlingen. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Hämtar iterator som pekar precis efter det sista elementet (om något) av den const-kvalificerade instansen av samlingen. |
...
| **int32_t** [get_Count](./get_count/)() override | Returnerar antalet element i en samling. Skrivskyddad **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returnerar en enumerator som itererar genom samlingen. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog till C# [Object.GetHashCode()](../../system/object/gethashcode/)-metoden. Aktiverar hashning av egna objekt. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [idx_get](./idx_get/)(**int32_t**) override | Returnerar en sekvens på det angivna indexet. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning för C# lock()-påståendet. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog till C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-metoden. Aktiverar kloning av egna typer. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>) override | Tar bort specificerad sekvens från en samling. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Tar bort sekvensen på det angivna indexet. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar den delade referensräknaren med ett specificerat värde. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog till C# [Object.ToString()](../../system/object/tostring/)-metoden. Aktiverar konvertering av egna objekt till sträng. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementerar C# typeof([System.Object](../../system/object/))-konstruktion. |
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning för C# lock()-påståendet. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
...
* Klass [ISequenceCollection](../isequencecollection/)
