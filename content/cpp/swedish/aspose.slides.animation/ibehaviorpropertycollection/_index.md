...
description: Representerar timingegenskaper för effektbeteendet.
type: docs
weight: 196
url: /sv/aspose.slides.animation/ibehaviorpropertycollection/
---
## IBehaviorPropertyCollection klass

Representerar timingegenskaper för effektbeteendet.
...
| Metod | Beskrivning |
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | Lägger till en ny egenskap i samlingen. |
...
| virtual void [Clear](../../system.collections.generic/icollection/clear/)() | Raderar alla element från samlingen. |
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Bestämmer om [ICollection](../../system.collections.generic/icollection/) innehåller ett specifikt värde. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar jämförelse av flyttal i C#-stil där två NaN betraktas som lika även om IEC 60559:1989 fastställer att NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar jämförelse av dubbelprecision i C#-stil där två NaN betraktas som lika även om IEC 60559:1989 fastställer att NaN inte är lika med något värde, inklusive NaN. |
...
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Hämtar element på angivet index. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Sätter element på angivet index. |
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Bestämmer index för ett specifikt objekt efter egenskapsvärde i [IList](../../system.collections.generic/ilist/). |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | Hämtar index för den första förekomsten av objektet i behållaren. |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | Infogar en ny egenskap (med det angivna egenskapsvärdet) i samlingen på det angivna indexet. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | Infogar element på angiven position och skjuter andra element. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollerar om objektet är en instans av typen som beskrivs av targetType. Analog till C# 'is'-operatorn. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Beräknar medelvärdet för en sekvens av värden som erhålls genom att anropa en transformfunktion på varje element i ingångssekvensen. |
...
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)() | Returnerar första elementet i en sekvens. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Hoppar över ett angivet antal på varandra följande element i början av en sekvens och returnerar resten. |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | Tar bort den angivna egenskapen från samlingen. |
| virtual **bool** [Remove](../../system.collections.generic/icollection/remove/)(const T\&) | Raderar element från samlingen. |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | Tar bort element på angivet index. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referensräknare med angivet värde. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n't:de templateargument till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
