...
| Metod | Beskrivning |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Lägger till en ny egenskap i samlingen. |
| void [Add](./add/)(const [System::String](../../system/string/)\&) override | Lägger till en ny egenskap i samlingen. |
...
| void [Clear](./clear/)() override | Tar bort alla egenskaper från samlingen. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | Avgör om [ICollection](../../system.collections.generic/icollection/) innehåller ett specifikt värde. |
| **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const override | Avgör om [ICollection](../../system.collections.generic/icollection/) innehåller ett specifikt värde. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>, **int32_t**) override | Kopierar elementen i [ICollection](../../system.collections.generic/icollection/) till ett [System::Array](../../system/array/), med start vid ett specifikt [System::Array](../../system/array/)-index. |
...
| **int32_t** [get_Count](./get_count/)() const override | Returnerar antalet egenskaper som lagras i samlingen. Läs-endast **int32_t**. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknings-datastruktur som är associerad med objektet. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returnerar en enumerator som itererar genom samlingen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\> [idx_get](./idx_get/)(**int32_t**) const override | Returnerar en egenskap vid angivet index. |
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Hämtar elementet vid angivet index. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>) override | Returnerar en egenskap vid angivet index. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Sätter elementet vid angivet index. |
| **int32_t** [IndexOf](./indexof/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | Avgör indexen för ett specifikt objekt i [IList](../../system.collections.generic/ilist/). |
| **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const override | Avgör indexen för ett specifikt objekt efter egenskapsvärde i [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Infogar en ny egenskap i samlingen på angivet index. |
| void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) override | Infogar en ny egenskap (med angivet egenskapsvärde) i samlingen på angivet index. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | Infogar element på angiven position och förskjuter övriga element. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar egentligen inget, utan initierar ett nytt objekt och möjliggör kopieringskonstruktion av subklasser. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar egentligen inget, utan initierar ett nytt objekt och möjliggör kopieringskonstruktion av subklasser. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Tar bort en specificerad egenskap från samlingen. |
| **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) override | Tar bort en specificerad egenskap från samlingen. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Tar bort egenskap vid angivet index. |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | Tar bort element vid angivet index. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Minskar och returnerar delad referensräkning. Ska inte anropas direkt; använd smarta pekare eller ThisProtector. |
...
* Klass [IBehaviorPropertyCollection](../ibehaviorpropertycollection/)
