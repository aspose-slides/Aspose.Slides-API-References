...
description: Representerar rörelseeffektsbeteende för en effekt.
type: docs
weight: 287
...
Representerar rörelseeffektsbeteende av effekt.
...
| virtual **float** [get_Angle](./get_angle/)() | Beskriver den relativa vinkeln på rörelsebanan. Läs **float**. |
...
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_From](./get_from/)() | Anger en x/y-koordinat varifrån animationen startas (i procent). Läs [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [MotionOriginType](../motionorigintype/) [get_Origin](./get_origin/)() | Anger vad rörelsebanans ursprung är relativt till exempel slide-layouten eller föräldern. Läs [MotionOriginType](../motionorigintype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMotionPath](../imotionpath/)\> [get_Path](./get_path/)() | Anger färdvägselementet följt av koordinater för animationsrörelsen. Läs [IMotionPath](../imotionpath/). |
| virtual [MotionPathEditMode](../motionpatheditmode/) [get_PathEditMode](./get_patheditmode/)() | Anger hur rörelsebanan rör sig när formen flyttas. Läs [MotionPathEditMode](../motionpatheditmode/). |
...
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_RotationCenter](./get_rotationcenter/)() | Beskriver rotationscentrumet som används för att rotera en rörelsebana med X vinkel. Läs [System::Drawing::PointF](../../system.drawing/pointf/). |
...
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_To](./get_to/)() | Anger målplatsen för en animationsrörelseeffekt (i procent). Läs [System::Drawing::PointF](../../system.drawing/pointf/). |
...
| virtual void [set_Angle](./set_angle/)(**float**) | Beskriver den relativa vinkeln på rörelsebanan. Skriv **float**. |
...
| virtual void [set_From](./set_from/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Anger en x/y-koordinat varifrån animationen startas (i procent). Skriv [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_Origin](./set_origin/)([MotionOriginType](../motionorigintype/)) | Anger vad rörelsebanans ursprung är relativt till exempel slide-layouten eller föräldern. Skriv [MotionOriginType](../motionorigintype/). |
| virtual void [set_Path](./set_path/)([System::SharedPtr](../../system/sharedptr/)\<[IMotionPath](../imotionpath/)\>) | Anger färdvägselementet följt av koordinater för animationsrörelsen. Skriv [IMotionPath](../imotionpath/). |
| virtual void [set_PathEditMode](./set_patheditmode/)([MotionPathEditMode](../motionpatheditmode/)) | Anger hur rörelsebanan rör sig när formen flyttas. Skriv [MotionPathEditMode](../motionpatheditmode/). |
| virtual void [set_RotationCenter](./set_rotationcenter/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Beskriver rotationscentrumet som används för att rotera en rörelsebana med X vinkel. Skriv [System::Drawing::PointF](../../system.drawing/pointf/). |
...
| virtual void [set_To](./set_to/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Anger målplatsen för en animationsrörelseeffekt (i procent). Skriv [System::Drawing::PointF](../../system.drawing/pointf/). |
