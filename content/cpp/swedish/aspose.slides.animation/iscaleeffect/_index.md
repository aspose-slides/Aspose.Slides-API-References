...
description: Representerar animationens skalningseffekt.
type: docs
weight: 365
...
Representerar animationseffekt för skalning.
...
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_By](./get_by/)() | Beskriver det relativa offsetvärdet för animationen (i procent). Läs [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_From](./get_from/)() | Anger en x/y-koordinat att starta animationen från (i procent). Läs [System::Drawing::PointF](../../system.drawing/pointf/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../ibehavior/get_timing/)() | Representerar timingegenskaper för effektbeteendet. Läs [ITiming](../itiming/). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_To](./get_to/)() | Anger målpositionen för en animationsskaleffekt (i procent). Läs [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_ZoomContent](./get_zoomcontent/)() | Avgör om innehåll ska zoomas. Läs [NullableBool](../../aspose.slides/nullablebool/). |
...
| virtual void [set_By](./set_by/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Beskriver det relativa offsetvärdet för animationen (i procent). Skriv [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_From](./set_from/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Anger en x/y-koordinat att starta animationen från (i procent). Skriv [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_Timing](../ibehavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | Representerar timingegenskaper för effektbeteendet. Skriv [ITiming](../itiming/). |
| virtual void [set_To](./set_to/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Anger målpositionen för en animationsskaleffekt (i procent). Skriv [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_ZoomContent](./set_zoomcontent/)([NullableBool](../../aspose.slides/nullablebool/)) | Avgör om innehåll ska zoomas. Skriv [NullableBool](../../aspose.slides/nullablebool/). |
