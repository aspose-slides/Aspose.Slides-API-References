...
| virtual **float** [get_Value0](./get_value0/)() | Definierar första värdet av förskjutning. Läs **float**. |
| virtual **float** [get_Value1](./get_value1/)() | Definierar andra värdet av förskjutning. Läs **float**. |
| virtual **float** [get_Value2](./get_value2/)() | Definierar tredje värdet av förskjutning. Läs **float**. |
...
| virtual void [set_Value0](./set_value0/)(**float**) | Definierar första värdet av förskjutning. Skriv **float**. |
| virtual void [set_Value1](./set_value1/)(**float**) | Definierar andra värdet av förskjutning. Skriv **float**. |
| virtual void [set_Value2](./set_value2/)(**float**) | Definierar tredje värdet av förskjutning. Skriv **float**. |
