...
description: Representera egenskapstyper för animationsbeteende. Följer listan med egenskaper från  och
type: docs
weight: 183
url: /sv/aspose.slides.animation/ibehaviorproperty/
---
## IBehaviorProperty klass
...
| virtual **bool** [get_IsCustom](./get_iscustom/)() | Visar om denna egenskap inte tillhör den fördefinierade egenskapslistan i specifikationen: [https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx) |
| virtual [System::String](../../system/string/) [get_Value](./get_value/)() | Egenskapens värde |
