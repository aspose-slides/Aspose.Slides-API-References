...
description: "Dummy-klass för att göra översatt kod som använder Component class kompilerbar. Objekt av denna klass bör endast allokeras med System::MakeObject() funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assertionsfel. Omslut alltid denna klass i en System::SmartPtr pekare och använd denna pekare för att skicka den till funktioner som argument."
type: docs
weight: 40
url: /sv/system.componentmodel/component/
---
## Komponentklass

Dummy-klass för att göra översatt kod som använder [Component](./)-klassen kompilerbar. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att resultera i körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| void [Dispose](./dispose/)(**bool**) | Stöd för disposable-mönster; gör ingenting. |
...
| **bool** [get_DesignMode](./get_designmode/)() | Kontrollerar om komponenten är i designläge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning av C# lock()-sats för upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
