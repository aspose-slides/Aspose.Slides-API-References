...
description: "Innehåller den interna datan för en grafikbehållare. Objekt av denna klass bör endast allokeras med System::MakeObject() funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr pekare och använd denna pekare för att skicka den till funktioner som argument."
type: docs
weight: 53
url: /sv/system.drawing.drawing2d/graphicscontainer/
---
## GraphicsContainer klass
