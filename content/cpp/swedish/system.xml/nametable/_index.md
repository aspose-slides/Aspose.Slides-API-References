...
description: Implementerar en enkeltrådad XmlNameTable.
type: docs
weight: 66
url: /sv/system.xml/nametable/
---
## NameTable klass
...
| Metod | Beskrivning |
| --- | --- |
| const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) override | Atomiserar den specificerade strängen och lägger till den i [NameTable](./). |
| const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | Atomiserar den specificerade strängen och lägger till den i [NameTable](./). |
...
| const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) override | Returnerar den atomiserade strängen med det angivna värdet. |
| const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | Returnerar den atomiserade strängen som innehåller samma tecken som den specificerade teckensekvensen i den givna arrayen. |
...
|  [NameTable](./nametable/)() | Initierar en ny instans av [NameTable](./)-klassen. |
