...
description: Representerar en entity-deklaration, såsom <!ENTITY... >.
type: docs
weight: 235
url: /sv/system.xml/xmlentity/
---
## XmlEntity klass

Representerar en entity-deklaration, såsom **<!ENTITY... >**.
...
| Metod | Beskrivning |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Lägger till den angivna noden i slutet av listan med underordnade noder för den här noden. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Skapar en dublett av denna nod. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Skapar en dublett av denna nod. Entity-noder kan inte klonas. Anropar man den här metoden på ett [XmlEntity](./)-objekt kastas ett undantag. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar flyttalsjämförelse i C#-stil där två NaN-värden betraktas som lika även om IEC 60559:1989 fastställer att NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar flyttalsjämförelse i C#-stil där två NaN-värden betraktas som lika även om IEC 60559:1989 fastställer att NaN inte är lika med något värde, inklusive NaN. |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Returnerar den grundläggande Uniform Resource Identifier (URI) för den aktuella noden. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [get_ChildNodes](../xmlnode/get_childnodes/)() | Returnerar alla underordnade noder för noden. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Returnerar de sammanslagna värdena för entity-noden och alla dess underordnade. |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Returnerar markup som representerar nodens underordnade. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | Returnerar ett värde som indikerar om noden är skrivskyddad. |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Returnerar nodens namn utan namnrymdspräffixet. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Returnerar nodens namn. |
...
| [String](../../system/string/) [get_NotationName](./get_notationname/)() | Returnerar namnet på det valfria NDATA-attributet i entity-deklarationen. |
| [String](../../system/string/) [get_OuterXml](./get_outerxml/)() override | Returnerar markup som representerar denna nod och alla dess underordnade. |
...
| virtual [String](../../system/string/) [get_Prefix](../xmlnode/get_prefix/)() | Returnerar namnrymdspräffixet för denna nod. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Returnerar värdet för den publika identifieraren i entity-deklarationen. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Returnerar post-schema-validerings-infosettet som har tilldelats denna nod som ett resultat av schema-validering. |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Returnerar värdet för systemidentifieraren i entity-deklarationen. |
| virtual [String](../../system/string/) [get_Value](../xmlnode/get_value/)() | Returnerar nodens värde. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Returnerar en enumerator som itererar genom de underordnade noderna i den aktuella noden. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog till C# [Object.GetHashCode()](../../system/object/gethashcode/)-metoden. Möjliggör hashning av anpassade objekt. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Söker upp den närmaste **xmlns**-deklarationen för det givna prefixet som är i räckvidd för den aktuella noden och returnerar namnrymdens URI i deklarationen. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Söker upp den närmaste **xmlns**-deklarationen för den givna namnrymdens URI som är i räckvidd för den aktuella noden och returnerar prefixet som definieras i den deklarationen. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar den faktiska typen av objektet. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Returnerar det första underordnade elementet med den angivna [XmlNode::get_Name](../xmlnode/get_name/). |
...
| **bool** [LINQ_All](../../system.collections.generic/ienumerable/linq_all/)(std::function\<**bool**(T)>) | Fastställer om alla element i en sekvens uppfyller ett villkor. |
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | Fastställer om en sekvens innehåller några element. |
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Fastställer om något element i en sekvens existerar eller uppfyller ett villkor. |
...
| **bool** [LINQ_Contains](../../system.collections.generic/ienumerable/linq_contains/)(T) | Fastställer om en sekvens innehåller ett angivet värde. |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-uttalandet för låsning. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objektet. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog till C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-metoden. Möjliggör kloning av anpassade typer. |
| virtual void [Normalize](../xmlnode/normalize/)() | Omvandlar alla [XmlText](../xmltext/)-noder i hela djupet av delträdet under denna [XmlNode](../xmlnode/) till ett "normalt" format där endast markup (det vill säga taggar, kommentarer, behandlingsinstruktioner, CDATA-sektioner och entity-referenser) separerar [XmlText](../xmltext/)-noder, dvs. det finns inga intilliggande [XmlText](../xmltext/)-noder. |
|  [Object](../../system/object/object/)() | Skapar objekt. Initierar alla interna datastrukturer. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar egentligen ingenting, bara initierar ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar egentligen ingenting, bara initierar ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Lägger till den angivna noden i början av listan med underordnade noder för denna nod. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Jämför objekt efter referens. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Jämför objekt efter referens. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Jämför ett värdetypobjekt med nullptr genom referens. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](../xmlnode/replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Ersätter underordnad nod **oldChild** med **newChild**-noden. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&) | Väljer det första [XmlNode](../xmlnode/) som matchar [XPath](../../system.xml.xpath/)-uttrycket. |
...
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Sätter de sammanslagna värdena för entity-noden och alla dess underordnade. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Sätter markup som representerar nodens underordnade. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Sätter namnrymdspräffixet för denna nod. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-uttalandet för upplåsning. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objekt. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Hämtar implementationen av begin-konstant-iterator för den aktuella containern. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Hämtar implementationen av end-konstant-iterator för den aktuella containern. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sparar alla underordnade noder till den angivna [XmlWriter](../xmlwriter/). För [XmlEntity](./)-noder har denna metod ingen effekt. |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sparar noden till den angivna [XmlWriter](../xmlwriter/). För [XmlEntity](./)-noder har denna metod ingen effekt. |
