...
description: Definierar kontexten för en uppsättning XmlDocument-objekt.
type: docs
weight: 261
url: /sv/system.xml/xmlimplementation/
---
## XmlImplementation klass
...
| Metod | Beskrivning |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [CreateDocument](./createdocument/)() | Skapar en ny [XmlDocument](../xmldocument/). |
...
| **bool** [HasFeature](./hasfeature/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Testar om Document [Object](../../system/object/) Model (DOM)-implementeringen implementerar en specifik funktion. |
...
|  [XmlImplementation](./xmlimplementation/)() | Initierar en ny instans av [XmlImplementation](./) klass. |
|  [XmlImplementation](./xmlimplementation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | Initierar en ny instans av [XmlImplementation](./) klass med den specificerade [XmlNameTable](../xmlnametable/). |
...
Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig instanser av denna typ på stacken eller med operatorn new, eftersom det kommer att resultera i körningstidfel och/eller påstående-fel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument. 
