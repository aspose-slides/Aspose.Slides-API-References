...
description: Representerar XML-deklarationsnoden <?xml version='1.0'...?>.
type: docs
weight: 170
url: /sv/system.xml/xmldeclaration/
---
## XmlDeclaration klass
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emulerar flyttalsjämförelse i C#-stil där två NaN-värden anses lika även om IEC 60559:1989 anger att NaN inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar flyttalsjämförelse i C#-stil där två NaN-värden anses lika även om IEC 60559:1989 anger att NaN inte är lika med något värde, inklusive NaN. |
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | Returnerar kodningsnivån för XML-dokumentet. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | Returnerar den första barnnoden. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Returnerar de sammanslagna värdena för [XmlDeclaration](./). |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Returnerar markup som endast representerar nodens barnnoder. |
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | Returnerar ett värde som indikerar om noden är skrivskyddad. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | Returnerar den sista barnnoden. |
...
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | Returnerar värdet för standalone-attributet. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Returnerar värdet för [XmlDeclaration](./). |
| [String](../../system/string/) [get_Version](./get_version/)() | Returnerar XML-versionen för dokumentet. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Sätter alla [XmlText](../xmltext/)-noder i hela djupet av delträdet under denna [XmlNode](../xmlnode/) i ett "normalt" format där endast markup (det vill säga taggar, kommentarer, processinstruktioner, CDATA-sektioner och enhetshänvisningar) separerar [XmlText](../xmltext/)-noder, det vill säga att det inte finns några intilliggande [XmlText](../xmltext/)-noder. |
...
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | Ställer in kodningsnivån för XML-dokumentet. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Ställer in de sammanslagna värdena för [XmlDeclaration](./). |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Ställer in markup som endast representerar nodens barnnoder. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Ställer in namnrymdspräfixet för denna nod. |
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | Ställer in värdet för standalone-attributet. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Ställer in värdet för [XmlDeclaration](./). |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sparar barnen av noden till den angivna [XmlWriter](../xmlwriter/). Eftersom [XmlDeclaration](./)-noder inte har barn har denna metod ingen effekt. |
...
Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig instanser av den här typen på stacken eller med operatorn new, eftersom det kan leda till körningsfel och/eller assert-fel. Wrappa alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd den pekaren för att skicka den till funktioner som argument. 
