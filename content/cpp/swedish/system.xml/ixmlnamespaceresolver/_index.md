...
description: Tillhandahåller skrivskyddad åtkomst till en uppsättning prefix- och namnrymdsmappningar.
type: docs
weight: 53
url: /sv/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver klass
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning av C# lock()-statement. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objektet. |
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | Returnerar namnrymdens URI som är mappad till det angivna prefixet. |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | Returnerar prefixet som är mappat till den angivna namnrymdens URI. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning av C# lock()-statement. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objektet. |
