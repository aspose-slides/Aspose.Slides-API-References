...
description: "Representerar blanksteg mellan markup i en blandad innehållsnod eller blanksteg inom ett xml:space='preserve'-omfång. Detta kallas också för betydelsefullt blanksteg."
type: docs
weight: 482
url: /sv/system.xml/xmlsignificantwhitespace/
---
## XmlSignificantWhitespace klass


Representerar blanksteg mellan markup i en blandad innehållsnod eller blanksteg inom ett **xml:space='preserve'**-omfång. Detta kallas också för betydelsefullt blanksteg.
...
| Metod | Beskrivning |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Lägger till den angivna noden i slutet av listan med barnnoder för denna nod. |
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Lägger till den angivna strängen i slutet av teckendatan för noden. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Skapar en duplicering av denna nod. |
...
| virtual [String](../../system/string/) [get_Data](../xmlcharacterdata/get_data/)() | Returnerar datan för noden. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | Returnerar den första barnnoden för noden. |
...
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | Returnerar de konkatenerade värdena för noden och alla dess barn. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | Returnerar den sista barnnoden för noden. |
| virtual **int32_t** [get_Length](../xmlcharacterdata/get_length/)() | Returnerar längden på datan, i tecken. |
...
| virtual [String](../../system/string/) [get_Prefix](../xmlnode/get_prefix/)() | Returnerar namnrymdspräfixet för denna nod. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Returnerar informationsuppsättningen efter schemavalidering som har tilldelats denna nod som ett resultat av schemavalidering. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Slår upp den närmaste **xmlns**-deklarationen för den angivna prefixen som är i räckhåll för den aktuella noden och returnerar namnrymdens URI i deklarationen. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Slår upp den närmaste **xmlns**-deklarationen för den angivna namnrymds-URI:n som är i räckhåll för den aktuella noden och returnerar prefixet som definieras i den deklarationen. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Infogar den angivna strängen vid den angivna teckenoffseten. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Filtrerar en sekvens baserat på den angivna predikatet. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Placera alla [XmlText](../xmltext/)-noder i hela djupet av underträdet under denna [XmlNode](../xmlnode/) i ett "normalt" format där endast markup (det vill säga taggar, kommentarer, processinstruktioner, CDATA-sektioner och entitetsreferenser) separerar [XmlText](../xmltext/)-noder, det vill säga att det inte finns några intilliggande [XmlText](../xmltext/)-noder. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Ersätter det angivna antalet tecken som börjar vid den angivna offseten med den angivna strängen. |
...
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Sätter de konkatenerade värdena för noden och alla dess barn. |
...
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Sätter namnrymdspräfixet för denna nod. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Sätter värdet för noden. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter den n'te mallargumentet till en weak-pekare (istället för shared). Tillåter att byta pekare i behållare till weak-läge. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Hämtar en delsträng av den fullständiga strängen från det angivna intervallet. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar weak-referensräkning. Borde inte anropas direkt; använd i stället smarta pekare eller ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar weak-referensräkning. Borde inte anropas direkt; använd i stället smarta pekare eller ThisProtector. |
...
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sparar noden i den angivna [XmlWriter](../xmlwriter/). |
...
Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig instanser av denna typ på stacken eller med operatorn new, då det kommer att resultera i körningsfel och/eller assert-fel. Omge alltid denna klass med en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument. 
