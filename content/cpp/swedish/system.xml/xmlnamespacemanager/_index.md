...
description: Löser, lägger till och tar bort namnrymder i en samling och tillhandahåller räckviddstyrning för dessa namnrymder.
type: docs
weight: 300
url: /sv/system.xml/xmlnamespacemanager/
---
## XmlNamespaceManager klass


Löser, lägger till och tar bort namnrymder i en samling och tillhandahåller räckviddstyrning för dessa namnrymder.
...
| Metod | Beskrivning |
| --- | --- |
| virtual void [AddNamespace](./addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Lägger till den angivna namnrymden i samlingen. |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](./get_defaultnamespace/)() | Returnerar namnrymdens URI för standardnamnrymden. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\> [get_NameTable](./get_nametable/)() | Returnerar [XmlNameTable](../xmlnametable/) som är associerad med detta objekt. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Returnerar en enumerator att använda för att iterera genom namnrymderna i [XmlNamespaceManager](./). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog till C# [Object.GetHashCode()](../../system/object/gethashcode/)-metoden. Möjliggör hashning av anpassade objekt. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](./getnamespacesinscope/)([XmlNamespaceScope](../xmlnamespacescope/)) override | Returnerar en samling av namnrymdsnamn med nyckel prefix som kan användas för att enumerera de namnrymder som för närvarande är i räckvidd. |
...
| virtual **bool** [HasNamespace](./hasnamespace/)([String](../../system/string/)) | Returnerar ett värde som indikerar om det angivna prefixet har en namnrymd definierad för den aktuella stackade räckvidden. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Beräknar medelvärdet av en sekvens av värden som erhålls genom att anropa en transformfunktion på varje element i indata-sekvensen. |
...
| [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) override | Returnerar namnrymdens URI för det angivna prefixet. |
| [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) override | Hittar prefixet som deklarerats för den angivna namnrymdens URI. |
...
| virtual **bool** [PopScope](./popscope/)() | Tar bort en namnrymdsräckvidd från stacken. |
| virtual void [PushScope](./pushscope/)() | Lägger till en namnrymdsräckvidd på stacken. |
...
| virtual void [RemoveNamespace](./removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Tar bort den angivna namnrymden för det angivna prefixet. |
...
|  [XmlNamespaceManager](./xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | Initierar en ny instans av [XmlNamespaceManager](./) klass med den angivna [XmlNameTable](../xmlnametable/). |
