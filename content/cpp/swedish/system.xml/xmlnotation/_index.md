...
description: Representerar en notationsdeklaration, såsom <!NOTATION... >.
type: docs
weight: 378
url: /sv/system.xml/xmlnotation/
---
## XmlNotation klass
...
| Method | Description |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Lägger till den specificerade noden i slutet av listan med underordnade noder för denna nod. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Skapar en duplikat av denna nod. Notationsnoder kan inte klonas. Anrop av den här metoden på ett [XmlNotation](./)-objekt kastar ett undantag. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Efterliknar C#-liknande flyttalsjämförelse där två NaN-värden betraktas som lika även om NaN enligt IEC 60559:1989 inte är lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Efterliknar C#-liknande flyttalsjämförelse där två NaN-värden betraktas som lika även om NaN enligt IEC 60559:1989 inte är lika med något värde, inklusive NaN. |
...
| virtual [String](../../system/string/) [get_InnerText](../xmlnode/get_innertext/)() | Returnerar de konkatenerade värdena för noden och alla dess underordnade noder. |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Returnerar markup-representationen av denna nods underordnade. |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Returnerar namnet på den aktuella noden utan namnrymdsprefix. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Returnerar namnet på den aktuella noden. |
...
| [String](../../system/string/) [get_OuterXml](./get_outerxml/)() override | Returnerar markup-representationen av denna nod och alla dess underordnade. |
...
| virtual [String](../../system/string/) [get_Prefix](../xmlnode/get_prefix/)() | Returnerar namnrymdsprefixet för denna nod. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Returnerar värdet av den offentliga identifieraren i notationsdeklarationen. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Returnerar det post-schema-validerings-infoset som har tilldelats denna nod som ett resultat av schema-validering. |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Returnerar värdet av systemidentifieraren i notationsdeklarationen. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Söker upp den närmaste **xmlns**-deklarationen för det angivna prefixet som är i räckhåll för den aktuella noden och returnerar namnrymdens URI i deklarationen. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Söker upp den närmaste **xmlns**-deklarationen för den angivna namnrymdens URI som är i räckhåll för den aktuella noden och returnerar prefixet som definieras i den deklarationen. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Avgör om någon element i en sekvens existerar eller uppfyller ett villkor. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning för C# lock()-satset. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog till C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-metoden. Möjliggör kloning av anpassade typer. |
| virtual void [Normalize](../xmlnode/normalize/)() | Sätter alla [XmlText](../xmltext/)-noder i hela djupet av delträdet under denna [XmlNode](../xmlnode/) i ett "normalt" format där endast markup (dvs. taggar, kommentarer, processinstruktioner, CDATA-sektioner och entitetsreferenser) separerar [XmlText](../xmltext/)-noder, det vill säga att det inte finns några intilliggande [XmlText](../xmltext/)-noder. |
|  [Object](../../system/object/object/)() | Skapar objekt. Initierar alla interna datastrukturer. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar egentligen ingenting, bara initierar ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar egentligen ingenting, bara initierar ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Lägger till den specificerade noden i början av listan med underordnade noder för denna nod. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](../xmlnode/removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Tar bort specificerad underordnad nod. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Väljer den första [XmlNode](../xmlnode/) som matchar [XPath](../../system.xml.xpath/)-uttrycket. Eventuella prefix som finns i [XPath](../../system.xml.xpath/)-uttrycket löses med den medföljande [XmlNamespaceManager](../xmlnamespacemanager/). |
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Sätter de konkatenerade värdena för noden och alla dess underordnade noder. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Sätter markup-representationen av denna nods underordnade. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Sätter namnrymdsprefixet för denna nod. |
| virtual void [set_Value](../xmlnode/set_value/)([String](../../system/string/)) | Sätter värdet för noden. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter det n'te mallargumentet till en svag pekare (i stället för delad). Tillåter byte av pekare i behållare till svagt läge. |
| int [SharedCount](../../system/object/sharedcount/)() const | Hämtar det aktuella värdet av det delade referensräknet. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sparar nodens underordnade till den specificerade [XmlWriter](../xmlwriter/). Denna metod har ingen effekt på [XmlNotation](./)-noder. |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sparar noden till den specificerade [XmlWriter](../xmlwriter/). Denna metod har ingen effekt på [XmlNotation](./)-noder. |
...
Objekt av denna klass bör bara allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig instanser av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assertion-fel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd den pekaren för att skicka den till funktioner som argument. 
