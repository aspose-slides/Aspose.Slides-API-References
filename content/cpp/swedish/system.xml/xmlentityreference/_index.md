...
description: Representerar en entity reference-nod.
type: docs
weight: 248
url: /sv/system.xml/xmlentityreference/
---
## XmlEntityReference klass

Representerar en entity reference-nod.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Skapar en dubblett av denna nod. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Skapar en dubblett av denna nod. |
...
| virtual [String](../../system/string/) [get_InnerText](../xmlnode/get_innertext/)() | Returnerar de sammanfogade värdena för noden och alla dess underordnade noder. |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Returnerar markup som representerar endast underordnade noder för denna nod. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Hämtar implementeringen av end const-iterator för den aktuella containern. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Returnerar det post-schema valideringsinfosätt som har tilldelats denna nod som ett resultat av schema-validering. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Returnerar nodens värde. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referenstækningsdatastrukturen som är associerad med objektet. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Filtrerar en sekvens baserat på det angivna predicate. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Placerar alla [XmlText](../xmltext/)-noder i hela djupet av delträdet under denna [XmlNode](../xmlnode/) i ett "normalt" format där endast markup (det vill säga taggar, kommentarer, processinstruktioner, CDATA-sektioner och entity-referenser) separerar [XmlText](../xmltext/)-noder, det vill säga, det finns inga intilliggande [XmlText](../xmltext/)-noder. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referenställyft med angivet värde. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&) | Väljer en lista av noder som matchar [XPath](../../system.xml.xpath/)-uttrycket. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Väljer en lista av noder som matchar [XPath](../../system.xml.xpath/)-uttrycket. Alla prefix som finns i [XPath](../../system.xml.xpath/)-uttrycket löses upp med den tillhandahållna [XmlNamespaceManager](../xmlnamespacemanager/). |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Ställer in de sammanfogade värdena för noden och alla dess underordnade noder. |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Ställer in markup som representerar endast underordnade noder för denna nod. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Ställer in namnrymdens prefix för denna nod. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Ställer in nodens värde. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Hämtar aktuellt värde av delad referenställyft. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Ökar delad referenställyft. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Minskar och returnerar delad referenställyft. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar svag referenställyft. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar svag referenställyft. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sparar alla underordnade till den angivna [XmlWriter](../xmlwriter/). |
...
Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig instanser av den här typen på stacken eller med operatorn new, eftersom det kommer leda till körningstidfel och/eller assert-fel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument. 
