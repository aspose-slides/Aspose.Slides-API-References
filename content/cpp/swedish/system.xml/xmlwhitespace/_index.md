...
description: Representerar blanksteg i elementinnehåll.
type: docs
weight: 560
url: /sv/system.xml/xmlwhitespace/
---
## XmlWhitespace klass
...
| Metod | Beskrivning |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Lägger till den angivna noden i slutet av listan med barnnoder för den här noden. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Skapar en duplicering av den här noden. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Skapar en duplicering av den här noden. |
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](../xmlnode/createnavigator/)() override | Skapar en XPathNavigator för att navigera detta objekt. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttributeCollection](../xmlattributecollection/)\> [get_Attributes](../xmlnode/get_attributes/)() | Returnerar ett [XmlAttributeCollection](../xmlattributecollection/) som innehåller attributen för den här noden. |
| virtual [String](../../system/string/) [get_BaseURI](../xmlnode/get_baseuri/)() | Returnerar bas-URI:n för den aktuella noden. |
...
| virtual [String](../../system/string/) [get_Data](../xmlcharacterdata/get_data/)() | Returnerar data för noden. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | Returnerar den första barnet till noden. |
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Returnerar ett värde som indikerar om den här noden har några barnnoder. |
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | Returnerar de sammanfogade värdena för noden och alla nodens barn. |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Returnerar markup som endast representerar barnnoderna för denna nod. |
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | Returnerar ett värde som indikerar om noden är skrivskyddad. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | Returnerar det sista barnet av noden. |
| virtual **int32_t** [get_Length](../xmlcharacterdata/get_length/)() | Returnerar längden på data, i tecken. |
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Returnerar det lokala namnet för noden. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Returnerar det kvalificerade namnet för noden. |
| virtual [String](../../system/string/) [get_NamespaceURI](../xmlnode/get_namespaceuri/)() | Returnerar namnrymdens URI för den här noden. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Returnerar noden som omedelbart följer den här noden. |
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | Returnerar nodens typ. |
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Returnerar markup som innehåller den här noden och alla dess barnnoder. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](../xmlnode/get_ownerdocument/)() | Returnerar [XmlDocument](../xmldocument/) som den här noden tillhör. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Returnerar föräldern till den här noden (för noder som kan ha föräldrar). |
| virtual [String](../../system/string/) [get_Prefix](../xmlnode/get_prefix/)() | Returnerar namnrymdspräfixet för den här noden. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Returnerar noden som omedelbart föregår den här noden. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](./get_previoustext/)() override | Returnerar textnoden som omedelbart föregår den här noden. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Returnerar post-schema-validerings-infosettet som har tilldelats den här noden som ett resultat av schema-validering. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Returnerar värdet för noden. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Söker upp den närmaste **xmlns**-deklarationen för det givna prefixet som är i räckhåll för den aktuella noden och returnerar namnrymdens URI i deklarationen. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Söker upp den närmaste **xmlns**-deklarationen för den givna namnrymdens URI som är i räckhåll för den aktuella noden och returnerar prefixet som definieras i den deklarationen. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Returnerar det första barn-elementet med den specificerade [XmlNode::get_Name](../xmlnode/get_name/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Returnerar det första barn-elementet med de specificerade [XmlNode::get_LocalName](../xmlnode/get_localname/)- och [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/)-värdena. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Infogar den specificerade strängen vid den specificerade teckenoffseten. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Concat](../../system.collections.generic/ienumerable/linq_concat/)([SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\>) | Kedjar två sekvenser. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projekterar varje element av en sekvens och kombinerar de resulterande sekvenserna till en sekvens. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Sätter alla [XmlText](../xmltext/)-noder i hela djupet av delträdet under denna [XmlNode](../xmlnode/) i ett "normalt" format där endast markup (det vill säga taggar, kommentarer, processinstruktioner, CDATA-sektioner och entitetsreferenser) separerar [XmlText](../xmltext/)-noder, det vill säga att det inte finns några intilliggande [XmlText](../xmltext/)-noder. |
|  [Object](../../system/object/object/)() | Skapar objekt. Initierar alla interna datastrukturer. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar egentligen ingenting, utan initierar bara ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar egentligen ingenting, utan initierar bara ett nytt objekt och möjliggör kopieringskonstruktion av underklasser. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Lägger till den specificerade noden i början av listan med barnnoder för den här noden. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Ersätter det specificerade antalet tecken med start vid den specificerade offseten med den specificerade strängen. |
...
| virtual void [set_Data](../xmlcharacterdata/set_data/)([String](../../system/string/)) | Sätter data för noden. |
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Sätter de sammanfogade värdena för noden och alla dess barn. |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Sätter markup som endast representerar barnnoderna för denna nod. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Sätter namnrymdspräfixet för den här noden. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Sätter värdet för noden. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Hämtar nuvarande värde av delad referenstellräknare. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Hämtar en delsträng av hela strängen från det specificerade intervallet. |
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Testar om DOM-implementationen implementerar en viss funktion. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sparar alla barn av noden till den specificerade [XmlWriter](../xmlwriter/). |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sparar noden till den specificerade [XmlWriter](../xmlwriter/). |
