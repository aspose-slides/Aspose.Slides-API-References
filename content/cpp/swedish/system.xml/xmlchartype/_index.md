...
description: För interna ändamål. Använd inte denna klass direkt.
type: docs
weight: 131
url: /sv/system.xml/xmlchartype/
---
## XmlCharType klass


För interna ändamål. Använd inte denna klass direkt.
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning för C# lock()-satset. Anropa direkt eller använd [LockContext](../../system/lockcontext/) sentinel-objekt. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning för C# lock()-satset upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/) sentinel-objekt. |
