...
description: Representerar en applikationsresursströmslösare.
type: docs
weight: 14
url: /sv/system.xml/iapplicationresourcestreamresolver/
---
## IApplicationResourceStreamResolver klass

Representerar en applikationsresursströmslösare.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetApplicationResourceStream](./getapplicationresourcestream/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Returnerar en applikationsresursström från den angivna URI:n. |
