...
description: Representerar textinnehållet i ett element eller attribut.
type: docs
weight: 495
url: /sv/system.xml/xmltext/
---
## XmlText klass
...
| Metod | Beskrivning |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Lägger till den angivna noden i slutet av listan med underordnade noder för denna nod. |
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Lägger till den angivna strängen i slutet av teckndata för noden. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Hämtar en iterator som pekar strax efter det sista konstanterade elementet (om något) i samlingen. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Hämtar en iterator som pekar strax efter det sista elementet (om något) i den konstanterade instansen av samlingen. |
...
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | Returnerar de concatenerade värdena för noden och alla dess underordnade noder. |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Returnerar markup som endast representerar underordnade noder för denna nod. |
...
| virtual **int32_t** [get_Length](../xmlcharacterdata/get_length/)() | Returnerar längden av data, i tecken. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Returnerar post-schema-validerings-infosettet som har tilldelats denna nod som ett resultat av schemavalidering. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Returnerar det första elementet i sekvensen som uppfyller ett villkor eller ett standardvärde om ett sådant element ej hittas. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Sätter alla [XmlText](./)-noder i hela djupet av underträdet under denna [XmlNode](../xmlnode/) i ett "normalt" format där endast markup (det vill säga taggar, kommentarer, behandlingsinstruktioner, CDATA-sektioner och entitetsreferenser) separerar [XmlText](./)-noder, det vill säga att det inte finns några intilliggande [XmlText](./)-noder. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](../xmlnode/replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Ersätter underordnad nod **oldChild** med noden **newChild**. |
...
| virtual void [set_Data](../xmlcharacterdata/set_data/)([String](../../system/string/)) | Anger data för noden. |
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Anger de concatenerade värdena för noden och alla dess underordnade noder. |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Anger markup som endast representerar underordnade noder för denna nod. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Anger namnrymdens prefix för denna nod. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Anger värdet för noden. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlText](./)\> [SplitText](./splittext/)(**int32_t**) | Delar noden i två noder vid den angivna offseten, behåller båda i trädet som syskon. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Hämtar implementationen av begin-konstiterator för den aktuella containern. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Hämtar implementationen av end-konstiterator för den aktuella containern. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sparar alla nodens underordnade till den angivna [XmlWriter](../xmlwriter/). [XmlText](./)-noder har inga underordnade, så denna metod har ingen effekt. |
