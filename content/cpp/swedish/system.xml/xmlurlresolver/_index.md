...
type: docs
weight: 534
url: /sv/system.xml/xmlurlresolver/
---
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollerar om objektet representerar en instans av den typ som beskrivet av targetType. Analog till C#-operatorn 'is'. |
...
| void [set_CachePolicy](./set_cachepolicy/)(const [SharedPtr](../../system/sharedptr/)\<[Net::Cache::RequestCachePolicy](../../system.net.cache/requestcachepolicy/)\>\&) | Ställer in cachepolicy för underliggande WebRequest-objekt. |
...
| void [set_Proxy](./set_proxy/)(const [SharedPtr](../../system/sharedptr/)\<[Net::IWebProxy](../../system.net/iwebproxy/)\>\&) | Ställer in nätverksproxy för underliggande WebRequest-objekt. |
...
| virtual **bool** [SupportsType](../xmlresolver/supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | Möjliggör för upplösaren att returnera typer annat än Stream. |
...
|  [XmlUrlResolver](./xmlurlresolver/)() | Initierar en ny instans av [XmlUrlResolver](./)-klassen. |
...
Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig instanser av denna typ på stacken eller med operator new, eftersom det kommer leda till körningsfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument. 
