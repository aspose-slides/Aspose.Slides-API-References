...
description: Representerar en samling noder som kan nås via namn eller index.
type: docs
weight: 287
url: /sv/system.xml/xmlnamednodemap/
---
## XmlNamedNodeMap klass
...
| Metod | Beskrivning |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() const | Hämtar en iterator till det första elementet i samlingen. |
...
| [iterator](./iterator/) [cbegin](./cbegin/)() const | Hämtar iterator till det första elementet i samlingen. |
| [iterator](./iterator/) [cend](./cend/)() const | Hämtar en iterator för ett icke-existerande element bakom det sista elementet i samlingen. |
| [iterator](./iterator/) [end](./end/)() const | Hämtar en iterator för ett icke-existerande element bakom det sista elementet i samlingen. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Returnerar antalet noder i [XmlNamedNodeMap](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](./getenumerator/)() override | Tillhandahåller stöd för iteration över samlingen av noder i [XmlNamedNodeMap](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/)) | Hämtar en [XmlNode](../xmlnode/) specificerad med namn. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/), [String](../../system/string/)) | Hämtar en nod med matchande [XmlNode::get_LocalName](../xmlnode/get_localname/)- och [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/)-värden. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar objektets faktiska typ. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollerar om objektet representerar en instans av den typ som beskrivs av targetType. Analog till C#-operatorn 'is'. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Item](./item/)(**int32_t**) | Hämtar noden på det angivna indexet i [XmlNamedNodeMap](./). |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satsens låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-övervakningsobjekt. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/)) | Tar bort noden från [XmlNamedNodeMap](./). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/), [String](../../system/string/)) | Tar bort en nod med matchande [XmlNode::get_LocalName](../xmlnode/get_localname/)- och [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/)-värden. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SetNamedItem](./setnameditem/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Lägger till en [XmlNode](../xmlnode/) med dess [XmlNode::get_Name](../xmlnode/get_name/)-värde. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satsens låsuppslag. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-övervakningsobjekt. |
...
| virtual  [~Object](../../system/object/~object/)() | Förstör objekt. Frigör all intern datastruktur. |
...
Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig instanser av denna typ på stacken eller med operatorn new, eftersom det kommer att resultera i körfel och/eller påståendefel. Wrappa alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument. 
