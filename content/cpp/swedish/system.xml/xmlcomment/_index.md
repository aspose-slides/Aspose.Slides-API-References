...
description: Representerar innehållet i en XML-kommentar.
type: docs
weight: 144
url: /sv/system.xml/xmlcomment/
---
## XmlComment klass
...
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Lägger till den angivna strängen i slutet av tecknadsdata för noden. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Hämtar en iterator som pekar på det första elementet (om något) i den konstantrqualifierade instansen av samlingen. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Hämtar en iterator som pekar på det första konstantrqualifierade elementet (om något) i samlingen. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Hämtar en iterator som pekar precis efter det sista konstantrqualifierade elementet (om något) i samlingen. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Hämtar en iterator som pekar precis efter det sista elementet (om något) i den konstantrqualifierade instansen av samlingen. |
...
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | Returnerar de sammanfogade värdena för noden och alla dess underordnade noder. |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Returnerar markup som bara representerar underordnade noder för denna nod. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Returnerar det post-schemasvaliderings-infosettet som har tilldelats denna nod som resultat av schemasvalidering. |
| [String](../../system/string/) [get_Value](../xmlcharacterdata/get_value/)() override | Returnerar värdet för noden. |
...
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Söker upp den närmaste **xmlns**-deklarationen för den givna namnrymds-URI:n som är i räckhåll för den aktuella noden och returnerar prefixet definierat i den deklarationen. |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Beräknar medelvärdet av en sekvens med numeriska värden. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Casterar elementen till den angivna typen. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Placera alla [XmlText](../xmltext/)-noder i hela djupet av delträdet under denna [XmlNode](../xmlnode/) i ett "normalt" format där endast markup (det vill säga taggar, kommentarer, processinstruktioner, CDATA-sektioner och enhetsreferenser) separerar [XmlText](../xmltext/)-noder, det vill säga att det inte finns några intilliggande [XmlText](../xmltext/)-noder. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Ersätter det angivna antalet tecken som börjar på den angivna offseten med den angivna strängen. |
...
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Sätter de sammanfogade värdena för noden och alla dess underordnade noder. |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Sätter markup som bara representerar underordnade noder för denna nod. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Sätter namnrymdspräfixet för denna nod. |
| void [set_Value](../xmlcharacterdata/set_value/)([String](../../system/string/)) override | Sätter värdet för noden. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning för C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)>\&) override | Sparar alla underordnade noder till den angivna [XmlWriter](../xmlwriter/). Eftersom kommentarsnoder inte har underordnade har denna metod ingen effekt. |
...
Objekt av denna klass bör endast allokeras med hjälp av funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig instanser av denna typ på stacken eller med operator new, eftersom det kommer att resultera i körningsfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd den pekaren för att skicka den till funktioner som argument. 
