...
description: "Representerar samlingen av rubrikvärden. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av den här typen på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assertionsfel. Packa alltid in denna klass i en System::SmartPtr-pekar och använd den pekaren för att skicka den till funktioner som argument."
type: docs
weight: 92
url: /sv/system.net.http.headers/httpheadervaluecollection/
---
## HttpHeaderValueCollection klass

Representerar samlingen av rubrikvärden. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig en instans av den här typen på stacken eller med operatorn new, eftersom det kommer att resultera i körfel och/eller assertion-fel. Packa alltid in denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd den pekaren för att skicka den till funktioner som argument.
...
| --- | --- |
| The | typ av rubrikvärden som representeras i samlingen. |

## Metoder

| Metod | Beskrivning |
| --- | --- |
| void [Add](./add/)(const T\&) override | Lägger till ett element i samlingen. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Hämtar iterator som pekar på det första elementet (om något) av den const-kvalificerade instansen av samlingen. |
...
| **bool** [Contains](./contains/)(const T\&) const override | Kontrollerar om elementet finns i samlingen. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) override | Kopierar alla samlingselement till befintliga arrayelement. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopierar alla samlingselement till befintliga arrayelement. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Hämtar iterator som pekar precis efter det sista elementet (om något) i samlingen. Denna iterator kan inte användas för att ändra ett refererat objekt eftersom [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) returnerar ett kopieringsobjekt av T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Hämtar iterator som pekar precis efter det sista elementet (om något) av den const-kvalificerade instansen av samlingen. |
...
| **int32_t** [get_Count](./get_count/)() const override | Hämtar antalet element i samlingen. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Hämtar ett värde som indikerar om den aktuella samlingen är skrivskyddad. |
...
| **bool** [get_IsSpecialValueSet](./get_isspecialvalueset/)() | Hämtar ett värde som indikerar om den aktuella samlingen innehåller ett "specialvärde". |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Hämtar uppräkning. |
...
| [String](../../system/string/) [GetHeaderStringWithoutSpecial](./getheaderstringwithoutspecial/)() | Returnerar en strängrepresentation av den aktuella samlingen utan ett "specialvärde". |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar den faktiska typen av objektet. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>) | Konstruktor för en ny instans. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Konstruktor för en ny instans. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T) | Konstruktor för en ny instans. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Konstruktor för en ny instans. |
...
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Anropar en transform-funktion på varje element i en generisk sekvens och returnerar det minima resulterande värdet. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar faktiskt ingenting, bara initierar nytt objekt och möjliggör kopiekonstruktion av underklasser. |
| void [ParseAdd](./parseadd/)([String](../../system/string/)) | Analyserar en header-strängrepresentation och lägger till den i den aktuella samlingen. |
...
| **bool** [Remove](./remove/)(const T\&) override | Tar bort element från samlingen. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar den delade referensräknaren med angivet värde. |
| void [RemoveSpecialValue](./removespecialvalue/)() | Tar bort ett "specialvärde". |
| void [SetSpecialValue](./setspecialvalue/)() | Sätter ett "specialvärde". |
...
| **bool** [TryParseAdd](./tryparseadd/)([String](../../system/string/)) | Försöker analysera en header-strängrepresentation och lägga till den i den aktuella samlingen. |
