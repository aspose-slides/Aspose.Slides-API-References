...
description: Representerar samlingen av objekten.
type: docs
weight: 196
url: /sv/system.net.http.headers/objectcollection/
---
## ObjectCollection klass
...
| --- | --- |
| T | Objekttypen. Objects of this class should only be allocated using [System::MakeObject()](../../system/makeobject/) function. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into [System::SmartPtr](../../system/smartptr/) pointer and use this pointer to pass it to functions as argument. |
## Metoder

| Metod | Beskrivning |
| --- | --- |
| void [Add](../../system.collections.objectmodel/collection/add/)(const T\&) override | Lägger till ett värde i behållaren. |
...
| void [Clear](../../system.collections.objectmodel/collection/clear/)() override | Raderar alla element. |
|  [Collection](../../system.collections.objectmodel/collection/collection/)() | Skapar en tom samling. |
...
| **bool** [Contains](../../system.collections.objectmodel/collection/contains/)(const T\&) const override | Kontrollerar om objektet finns i samlingen. |
| void [CopyTo](../../system.collections.objectmodel/collection/copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Kopierar samlingens element till befintliga arrayelement. |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [crbegin](../../system.collections.objectmodel/collection/crbegin/)() const | Hämtar en omvänd iterator till det sista konstantkvalificerade elementet i samlingen (första i omvänd ordning). |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [crend](../../system.collections.objectmodel/collection/crend/)() const | Hämtar en omvänd iterator för ett icke-existerande konstantkvalificerat element före samlingens början. |
...
| int [get_Count](../../system.collections.objectmodel/collection/get_count/)() const override | Hämtar antalet element. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](../../system.collections.objectmodel/collection/get_items/)() | Intern åtkomst till datastruktur. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](../../system.collections.objectmodel/collection/get_items/)() const | Intern åtkomst till datastruktur. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknare-datastrukturen som är kopplad till objektet. |
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../../system.collections.objectmodel/collection/getenumerator/)() override | Hämtar en enumerator för att iterera över samlingen. |
...
| T [idx_get](../../system.collections.objectmodel/collection/idx_get/)(int) const override | Hämtar värdet på angivet index. |
| void [idx_set](../../system.collections.objectmodel/collection/idx_set/)(int, T) override | Sätter värdet på angivet index. |
| int [IndexOf](../../system.collections.objectmodel/collection/indexof/)(const T\&) const override | Söker efter element i samlingen. |
| void [Insert](../../system.collections.objectmodel/collection/insert/)(int, const T\&) override | Infogar objektet på angiven position. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Beräknar medelvärdet för en sekvens av värden som erhålls genom att anropa en transformationsfunktion på varje element i inmatningssekvensen. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Anropar en transformationsfunktion på varje element i en generisk sekvens och returnerar det högsta resulterande värdet. |
...
|  [ObjectCollection](./objectcollection/)() | Konstruerar en ny instans. |
|  [ObjectCollection](./objectcollection/)([Action](../../system/action/)\<T\>) | Konstruerar en ny instans. |
...
| T\& [operator[]](../../system.collections.objectmodel/collection/operator[]/)(int) | Hämtar värdet på angivet index. |
| const T\& [operator[]](../../system.collections.objectmodel/collection/operator[]/)(int) const | Hämtar värdet på angivet index. |
| [reverse_iterator](../../system.collections.objectmodel/collection/reverse_iterator/) [rbegin](../../system.collections.objectmodel/collection/rbegin/)() | Hämtar en omvänd iterator till det sista elementet i samlingen (första i omvänd ordning). |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [rbegin](../../system.collections.objectmodel/collection/rbegin/)() const | Hämtar en omvänd iterator till det sista elementet i den konstantkvalificerade samlingen (första i omvänd ordning). |
...
| **bool** [Remove](../../system.collections.objectmodel/collection/remove/)(const T\&) override | Tar bort ett specifikt objekt. |
| void [RemoveAt](../../system.collections.objectmodel/collection/removeat/)(int) override | Tar bort objekt på en specifik position. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar den delade referensräknaren med ett angivet värde. |
| [reverse_iterator](../../system.collections.objectmodel/collection/reverse_iterator/) [rend](../../system.collections.objectmodel/collection/rend/)() | Hämtar en omvänd iterator för ett icke-existerande element före samlingens början. |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [rend](../../system.collections.objectmodel/collection/rend/)() const | Hämtar en omvänd iterator för ett icke-existerande element före den konstantkvalificerade samlingens början. |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../../system.collections.objectmodel/collection/virtualizebeginconstiterator/)() const override | Hämtar implementeringen av begin-const-iterator för den aktuella behållaren. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginIterator](../../system.collections.objectmodel/collection/virtualizebeginiterator/)() override | Hämtar implementeringen av begin-iterator för den aktuella behållaren. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../../system.collections.objectmodel/collection/virtualizeendconstiterator/)() const override | Hämtar implementeringen av end-const-iterator för den aktuella behållaren. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](../../system.collections.objectmodel/collection/virtualizeenditerator/)() override | Hämtar implementeringen av end-iterator för den aktuella behållaren. |
...
* Klass [Collection](../../system.collections.objectmodel/collection/)
