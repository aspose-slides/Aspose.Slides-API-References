...
description: "Representerar en MIME-typ i ett värde för 'Content-Type'-header. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Alltid paketera in denna klass i en System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 144
url: /sv/system.net.http.headers/mediatypeheadervalue/
---
## MediaTypeHeaderValue klass

Representerar en MIME-typ i ett värde för headern 'Content-Type'. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att leda till körningsfel och/eller påståendefel. Alltid paketera in denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd pekaren för att skicka den till funktioner som argument.
...
| [String](../../system/string/) [get_CharSet](./get_charset/)() | Hämtar en teckenuppsättning. |
| [String](../../system/string/) [get_MediaType](./get_mediatype/)() | Hämtar ett värde för media-typ-huvudet. |
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::SharedPtr](../../system/sharedptr/)\<[NameValueHeaderValue](../namevalueheadervalue/)\>\>\> [get_Parameters](./get_parameters/)() | Returnerar värdeparametrarna för media-typ-huvudet. |
...
| static **int32_t** [GetMediaTypeLength](./getmediatypelength/)([String](../../system/string/), **int32_t**, [HeaderFunc](../headerfunc/)\<[System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\>\>, [System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\>\&) | Konverterar en given sträng från det angivna indexet till en instans av klassen [MediaTypeHeaderValue](./). |
...
|  [MediaTypeHeaderValue](./mediatypeheadervalue/)([String](../../system/string/)) | Skapar en ny instans. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Konverterar en given sträng till en instans av klassen [MediaTypeHeaderValue](./). |
...
| void [set_CharSet](./set_charset/)([String](../../system/string/)) | Ställer in en teckenuppsättning. |
| void [set_MediaType](./set_mediatype/)([String](../../system/string/)) | Ställer in ett värde för media-typ-huvudet. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te templatemargument till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\>\&) | Försöker konvertera en given sträng till en instans av klassen [MediaTypeHeaderValue](./). |
