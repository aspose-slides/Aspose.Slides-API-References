...
| virtual **int32_t** [get_DefaultDelay](./get_defaultdelay/)() | Hämtar standardfördröjningstid [ms]. Detta värde används om [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/)-metoden inte anropades. Standardvärdet är 1000. |
...
| virtual **bool** [get_ExportHiddenSlides](./get_exporthiddenslides/)() | Avgör om dolda bilder ska exporteras. Standardvärdet är false. |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_FrameSize](./get_framesize/)() | Hämtar ramstorlek. |
...
| virtual **int32_t** [get_TransitionFps](./get_transitionfps/)() | Hämtar övergångens FPS [frames/sec] Standardvärdet är 25. |
...
| virtual void [set_DefaultDelay](./set_defaultdelay/)(**int32_t**) | Ställer in standardfördröjningstid [ms]. Detta värde används om [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/)-metoden inte anropades. Standardvärdet är 1000. |
...
| virtual void [set_ExportHiddenSlides](./set_exporthiddenslides/)(**bool**) | Avgör om dolda bilder ska exporteras. Standardvärdet är false. |
| virtual void [set_FrameSize](./set_framesize/)([System::Drawing::Size](../../system.drawing/size/)) | Ställer in ramstorlek. |
| virtual void [set_GradientStyle](../isaveoptions/set_gradientstyle/)([Aspose::Slides::GradientStyle](../../aspose.slides/gradientstyle/)) | Ställer in gradientens visuella stil. Skriver [GradientStyle](../../aspose.slides/gradientstyle/). |
...
| virtual void [set_TransitionFps](./set_transitionfps/)(**int32_t**) | Ställer in övergångens FPS [frames/sec] Standardvärdet är 25. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätt n'te mallparameter till en svag pekare (istället för delad). Tillåter att pekare i behållare byts till svagt läge. |
