...
description: Kör genereringen av animeringsevenemang för varje bild.
type: docs
weight: 92
url: /sv/aspose.slides.export/presentationanimationsgenerator/run/
---
## PresentationAnimationsGenerator::Run(System::SharedPtr\<System::Collections::Generic::IEnumerable\<System::SharedPtr\<ISlide\>\>\>) metod


Kör genereringen av animeringsevenemang för varje bild.
...
{
    // hantera ramtick i den nya animationen
}));
...
## PresentationAnimationsGenerator::Run(System::SharedPtr\<System::Collections::Generic::IEnumerable\<System::SharedPtr\<ISlide\>\>\>, int32_t, PresentationPlayer::FrameTickHandler) metod
...
* Klass [ISlide](../../../aspose.slides/islide/)
