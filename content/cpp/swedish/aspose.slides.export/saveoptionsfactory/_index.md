...
| Metod | Beskrivning |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IPptxOptions](../ipptxoptions/)\> [CreatePptxOptions](./createpptxoptions/)() override | Skapar PPTX-sparalternativ. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallparameter till en svag pekare (istället för delad). Tillåter byte av pekare i behållare till svagt läge. |
...
* Klass [ISaveOptionsFactory](../isaveoptionsfactory/)
