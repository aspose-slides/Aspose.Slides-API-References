...
description: Representerar en spelare av animationen.
type: docs
weight: 313
url: /sv/aspose.slides.export/ipresentationanimationplayer/
---
## IPresentationAnimationPlayer klass
...
| virtual ASPOSE_SLIDES_LOCAL_API **double** [get_Duration](./get_duration/)() | Hämtar animeringsduration [ms] |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IImage](../../aspose.slides/iimage/)\> [GetFrame](./getframe/)() | Hämtar ramen för den aktuella tidspositionen som tidigare satts med metoden [IPresentationAnimationPlayer::SetTimePosition](./settimeposition/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referenserjämför värdetypobjekt med nullptr. |
...
| virtual ASPOSE_SLIDES_LOCAL_API void [SetTimePosition](./settimeposition/)(**double**) | Sätter animeringens tidsposition inom [IPresentationAnimationPlayer::get_Duration](./get_duration/). |
...
Animationer genererade av [PresentationAnimationsGenerator](../presentationanimationsgenerator/) via dess **PresentationAnimationsGenerator::NewAnimation**-händelse. 
