...
description: Tillhandahåller alternativ som styr hur en presentation/bild renderas.
type: docs
weight: 638
...
| **bool** [get_DisableFontLigatures](./get_disablefontligatures/)() override | Hämtar ett värde som indikerar om text renderas utan att använda ligaturer. När den är **true** inaktiveras ligaturer i den renderade utdata. Som standard är egenskapen **false**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IInkOptions](../iinkoptions/)\> [get_InkOptions](./get_inkoptions/)() override | Tillhandahåller alternativ som styr utseendet på [Ink](../../aspose.slides.ink/)-objekt i exporterat dokument. Läs-endast [IInkOptions](../iinkoptions/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IProgressCallback](../../aspose.slides/iprogresscallback/)\> [get_ProgressCallback](../saveoptions/get_progresscallback/)() override | Representerar ett återanrop-objekt för att spara förloppsuppdateringar i procent. Se [IProgressCallback](../../aspose.slides/iprogresscallback/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISlidesLayoutOptions](../islideslayoutoptions/)\> [get_SlidesLayoutOptions](./get_slideslayoutoptions/)() override | Hämtar det läge i vilket bilder placeras på sidan vid export av en presentation [ISlidesLayoutOptions](../islideslayoutoptions/). |
...
| void [set_DisableFontLigatures](./set_disablefontligatures/)(**bool**) override | Ställer in ett värde som indikerar om text renderas utan ligaturer. När den är **true** inaktiveras ligaturer i den renderade utdata. Som standard är egenskapen **false**. |
...
| void [set_ProgressCallback](../saveoptions/set_progresscallback/)([System::SharedPtr](../../system/sharedptr/)\<[IProgressCallback](../../aspose.slides/iprogresscallback/)\>) override | Representerar ett återanrop-objekt för att spara förloppsuppdateringar i procent. Se [IProgressCallback](../../aspose.slides/iprogresscallback/). |
...
| void [set_SlidesLayoutOptions](./set_slideslayoutoptions/)([System::SharedPtr](../../system/sharedptr/)\<[ISlidesLayoutOptions](../islideslayoutoptions/)\>) override | Ställer in det läge i vilket bilder placeras på sidan vid export av en presentation [ISlidesLayoutOptions](../islideslayoutoptions/). |
| void [set_WarningCallback](../saveoptions/set_warningcallback/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/)\>) override | Returnerar eller sätter ett objekt som tar emot varningar och beslutar om laddningsprocessen ska fortsätta eller avbrytas. Skriver [Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ställer in det n'te mallargumentet som en svag pekare (istället för delad). Gör det möjligt att växla pekare i containrar till svagt läge. |
