...
description: Representerar handout-presentationslayoutläget för export.
type: docs
weight: 66
...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | Anger hur många bilder och i vilken sekvens som kommer att placeras på sidan [HandoutType](../handouttype/). |
| **bool** [get_PrintComments](./get_printcomments/)() const | Anger om kommentarer på bilder ska visas eller inte. |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | Anger om ramar ska ritas runt de visade bilderna eller ej. |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | Anger om de visade bildnumren ska skrivas ut eller inte. |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | Anger hur många bilder och i vilken sekvens som kommer att placeras på sidan [HandoutType](../handouttype/). |
| void [set_PrintComments](./set_printcomments/)(**bool**) | Anger om kommentarer på bilder ska visas eller ej. |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | Anger om ramar ska ritas runt de visade bilderna eller ej. |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | Anger om de visade bildnumren ska skrivas ut eller ej. |
