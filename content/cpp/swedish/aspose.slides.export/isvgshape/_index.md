...
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | Ställer in eller hämtar id för formen |
...
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | Ställer in eller hämtar id för formen |
| virtual void [SetEventHandler](./seteventhandler/)([SvgEvent](../svgevent/), [System::String](../../system/string/)) | Ställer in händelsehanterare för formen |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te templatargumentet till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
