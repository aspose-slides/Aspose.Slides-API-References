...
description: Representerar HTML-mallfil.
type: docs
weight: 92
...
| Method | Description |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateCustomFormatter](./createcustomformatter/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Skapar och returnerar en HTML-formatterare för anpassad återanropsstyrd HTML-generering. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateDocumentFormatter](./createdocumentformatter/)([System::String](../../system/string/), **bool**) | Skapar och returnerar en HTML-formatterare för en enkel dokumentvy som består av sekvenser av bilder staplade under varandra. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateSlideShowFormatter](./createslideshowformatter/)([System::String](../../system/string/), **bool**) | Skapar och returnerar en HTML-formatterare för ett enkelt bildspels-HTML som visar bilder en efter en. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Motsvarighet till C# [Object.GetHashCode()](../../system/object/gethashcode/)-metoden. Möjliggör hashning av anpassade objekt. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar det faktiska typen av objektet. Motsvarighet till C# [System.Object.GetType()](../../system/object/gettype/)-anropet. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollerar om objektet representerar en instans av den typ som beskrivs av targetType. Motsvarighet till C#-operatorn 'is'. |
| void [Lock](../../system/object/lock/)() | Implementerar låsning med C#-statement lock(). Anropas direkt eller via [LockContext](../../system/lockcontext/)-vaktobjekt. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Motsvarighet till C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-metoden. Möjliggör kloning av anpassade typer. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Motsvarighet till C# [Object.ToString()](../../system/object/tostring/)-metoden. Möjliggör konvertering av anpassade objekt till sträng. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning med C#-statement lock(). Anropas direkt eller via [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
* Klass [IHtmlFormatter](../ihtmlformatter/)
