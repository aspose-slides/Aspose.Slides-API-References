...
description: Representerar spelaren av animationer som är associerade med Presentation.
type: docs
weight: 625
...
Representerar spelaren av animationer som är associerade med [Presentation](../../aspose.slides/presentation/).
...
| Metod | Beskrivning |
| --- | --- |
| void [Dispose](./dispose/)() override | Disposerar instansen av [PresentationPlayer](./). |
...
| **int32_t** [get_FrameIndex](./get_frameindex/)() | Hämtar bildrutesindex. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning enligt C# lock()-satset. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | Skapar en ny instans av [PresentationPlayer](./). |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning enligt C# lock()-satset. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | Representerar bildrute-tick-hanteraren för **PresentationPlayer::FrameTick**-händelsen. |
