...
description: Callback-gränssnitt som används för att bestämma hur objektet ska behandlas vid sparande.
type: docs
weight: 248
...
Callback-gränssnitt som används för att bestämma hur objektet ska behandlas vid sparande.
...
| virtual void [SaveExternal](./saveexternal/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Sparar externt objekt. |
