...
description: Bestämmer formatet i vilket bild för bilden kommer att sparas för presentation till HTML-export.
type: docs
weight: 378
url: /sv/aspose.slides.export/islideimageformat/
---
## ISlideImageFormat klass

Determinerar formatet som bild för bilden kommer att sparas i för presentation till HTML-export.
