...
description: Dummy-klass för att göra översatt kod som använder SystemInformation-klassen kompilerbar. Metoder är inte implementerade. Detta är en statisk typ utan instanstjänster. Du bör aldrig skapa instanser av den på något sätt.
type: docs
weight: 53
url: /sv/system.windows.forms/systeminformation/
---
## SystemInformation struktur

Dummy-klass för att göra översatt kod som använder [SystemInformation](./)-klassen kompilerbar. Metoder är inte implementerade. Detta är en statisk typ utan instanstjänster. Du bör aldrig skapa instanser av den på något sätt.
