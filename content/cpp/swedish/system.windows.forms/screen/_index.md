...
description: Tillhandahåller information om skärmar. Endast Windows. Detta är en singleton-typ med minneshantering som utförs av åtkomstfunktion(er). Du bör aldrig skapa instanser av den direkt.
type: docs
weight: 40
url: /sv/system.windows.forms/screen/
---
## Screen klass

Tillhandahåller information om skärmar. [Windows](../../system.windows/) endast. Detta är en singleton-typ med minneshantering som utförs av åtkomstfunktion(er). Du bör aldrig skapa instanser av den direkt.
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | Hämtar skärmgränser. |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | Hämtar information om primär skärm. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning via C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning via C# lock()-sats upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
