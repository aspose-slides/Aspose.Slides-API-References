...
type: docs
weight: 53
url: /sv/system.runtime.interopservices/osplatform/
---
## OSPlatform klass
...
| virtual **bool** [Equals](../../system/iequatable/equals/)(T) | Bestämmer om det aktuella och specificerade objektet är lika. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emulerar C#-liknande jämförelse av dubbelprecisionstal där två NaN-värden anses vara lika även om IEC 60559:1989 anger att NaN inte är lika med något värde, inklusive NaN. |
