...
description: "Basundantagstypen för alla COM interop-undantag och strukturerade undantagshanterings (SEH) undantag. Skapa aldrig instanser av denna klass manuellt. Använd istället klassen ExternalException. Wrappa aldrig instanser av klassen ExternalException i System::SmartPtr."
type: docs
weight: 1
url: /sv/system.runtime.interopservices/details_externalexception/
---
## Details_ExternalException klass

Basundantags-typen för alla COM-interopsundantag och strukturerade undantagshanterings (SEH) undantag. Skapa aldrig instanser av denna klass manuellt. Använd ExternalException klass istället. Wrappa aldrig ExternalException klassens instanser i [System::SmartPtr](../../system/smartptr/).
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te template-argument till en svag pekare (istället för delad). Möjliggör att byta pekare i behållare till svagt läge. |
