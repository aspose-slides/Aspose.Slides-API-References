...
description: Intern klass att använda med XmlSerializer.
type: docs
weight: 79
url: /sv/system.xml.serialization/xmlserializerimplementation/
---
## XmlSerializerImplementation klass

Intern klass att använda med [XmlSerializer](../xmlserializer/).
