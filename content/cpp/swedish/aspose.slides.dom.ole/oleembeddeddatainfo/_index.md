...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | Returnerar fildata för ett inbäddat OLE-objekt Endast läs **uint8_t**[]. |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | Returnerar filändelsen för det aktuella inbäddade OLE-objektet Endast läs [System::String](../../system/string/). |
...
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | Skapar en ny instans av en inbäddad datainformation för OLE-objekt. |
...
* Klass [IOleEmbeddedDataInfo](../../aspose.slides/ioleembeddeddatainfo/)
* Namnrymd [Aspose::Slides::DOM::Ole](../)
