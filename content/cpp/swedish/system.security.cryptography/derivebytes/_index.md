...
description: "Abstrakt klass från vilken alla klasser som härleder byte-sekvenser av en specificerad längd ärver. Objekt av denna klass bör endast allokeras med funktionen System::MakeObject(). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att leda till körningsfel och/eller påståendefel. Packa alltid in denna klass i en System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 92
url: /sv/system.security.cryptography/derivebytes/
---
## DeriveBytes klass

Abstrakt klass från vilken alla klasser som härleder byte sekvenser av en specificerad längd ärver. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att resultera i körningsfel och/eller påståendefel. Packa alltid in denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetBytes](./getbytes/)(**int32_t**) | RTTI-information. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning för C#-statement lock(). Anropas direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objektet. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning för C#-statement lock(). Anropas direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objektet. |
