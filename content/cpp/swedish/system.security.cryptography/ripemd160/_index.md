...
| static [SharedPtr](../../system/sharedptr/)\<[RIPEMD160](./)\> [Create](./create/)() | Skapar en instans av hash-algoritmen. |
| static [SharedPtr](../../system/sharedptr/)\<[RIPEMD160](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Skapar en instans av hash-algoritmen. |
...
| virtual int [get_HashSize](../hashalgorithm/get_hashsize/)() | Hämtar storleken på beräknat hashvärde i byte. |
| int [get_InputBlockSize](../hashalgorithm/get_inputblocksize/)() override | Inmatningsblockens storlek. |
| int [get_OutputBlockSize](../hashalgorithm/get_outputblocksize/)() override | Utdatablockens storlek. |
...
| int [TransformBlock](../hashalgorithm/transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Behandlar ett datablock och kopierar data till utdatamatris. |
