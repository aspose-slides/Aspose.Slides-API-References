...
description: Ytterligare information om ett kryptografiskt nyckelpar.
type: docs
weight: 66
url: /sv/system.security.cryptography/cspkeycontainerinfo/
---
## CspKeyContainerInfo klass
...
| **bool** [get_Accessible](./get_accessible/)() const | Hämtar en flagga som anger om en nyckel i en behållare är åtkomlig. |
| **bool** [get_Exportable](./get_exportable/)() const | Hämtar en flagga som anger om en nyckel kan exporteras från en behållare. |
| **bool** [get_HardwareDevice](./get_hardwaredevice/)() const | Hämtar en flagga som anger om en nyckel är en hårdvarunyckel. |
| [String](../../system/string/) [get_KeyContainerName](./get_keycontainername/)() const | Hämtar namn på nyckelbehållare. |
| [SharedPtr](../../system/sharedptr/)\<[KeyNumber](../keynumber/)\> [get_KeyNumber](./get_keynumber/)() const | Hämtar ett KeyNumber-objekt. |
| **bool** [get_MachineKeyStore](./get_machinekeystore/)() const | Hämtar en flagga som anger om en nyckel laddas från maskinens nyckellager. |
| **bool** [get_Protected](./get_protected/)() const | Hämtar en flagga som anger om en nyckel är skyddad mot kopiering. |
| [String](../../system/string/) [get_ProviderName](./get_providername/)() const | Hämtar leverantörsnamn. |
| **int32_t** [get_ProviderType](./get_providertype/)() const | Hämtar leverantörstyp. |
| **bool** [get_RandomlyGenerated](./get_randomlygenerated/)() const | Hämtar en flagga som anger om en nyckel genererades slumpmässigt. |
| **bool** [get_Removable](./get_removable/)() const | Hämtar en flagga som anger om en nyckel kan tas bort från en behållare. |
| [String](../../system/string/) [get_UniqueKeyContainerName](./get_uniquekeycontainername/)() const | Hämtar ett unikt behållarnamn. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te mallparameter till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
