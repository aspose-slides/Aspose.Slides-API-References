...
description: Paddingläge och parametrar för RSA-signaturskapande eller verifieringsoperationer.
type: docs
weight: 521
url: /sv/system.security.cryptography/rsasignaturepadding/
---
## RSASignaturePadding klass


Paddingläge och parametrar för [RSA](../rsa/) signaturskapande eller verifieringsoperationer.
...
| virtual **bool** [Equals](../../system/iequatable/equals/)(T) | Avgör om det aktuella och angivna objekten är lika. |
...
| [RSASignaturePaddingMode](../rsasignaturepaddingmode/) [get_Mode](./get_mode/)() const | Hämtar padding-läget. |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pkcs1](./get_pkcs1/)() | Hämtar PKCS #1 v1.5-läge. |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pss](./get_pss/)() | Hämtar PSS-läge. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n't:te mallargument till en svag pekare (i stället för delad). Tillåter att byta pekare i behållare till svagt läge. |
