...
type: docs
weight: 118
url: /sv/system.security.cryptography/details_cryptographicunexpectedoperationexception/
---
## Details_CryptographicUnexpectedOperationException klass
...
| int [SharedCount](../../system/object/sharedcount/)() const | Hämtar det nuvarande värdet på den delade referensräknaren. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar den svaga referensräknaren. Borde inte anropas direkt; använd smarta pekare eller ThisProtector annars. |
...
* Klass [Details_CryptographicException](../details_cryptographicexception/)
