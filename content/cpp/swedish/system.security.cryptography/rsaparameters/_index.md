...
description: "Datastruktur för RSA-algoritmens parametrar. Denna typ bör allokeras på stacken och skickas till funktioner av värde eller av referens. Använd aldrig System::SmartPtr-klass för att hantera objekt av denna typ."
type: docs
weight: 768
url: /sv/system.security.cryptography/rsaparameters/
---
## RSAParameters struktur


[Data](../../system.data/) struktur av [RSA](../rsa/) algoritmparametrar. Denna typ bör allokeras på stacken och skickas till funktioner av värde eller av referens. Använd aldrig [System::SmartPtr](../../system/smartptr/) klass för att hantera objekt av denna typ.
