...
description: "Hash-baserad meddelandeautentiseringskod som använder SHA512-hashfunktionen. Delvis implementerad. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller assertionsfel. Omslut alltid denna klass i en System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 261
url: /sv/system.security.cryptography/hmacsha512/
---
## HMACSHA512 klass


Hash-baserad meddelande [Authentication](../../system.security.authentication/) kod som använder [SHA512](../sha512/) hash-funktionen. Delvis implementerad. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller assertionsfel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| Method | Description |
| --- | --- |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Beräknar [HMAC](../hmac/). |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Hashar buffertdel. |
...
| static [SharedPtr](../../system/sharedptr/)\<[HashAlgorithm](../hashalgorithm/)\> [Create](../hashalgorithm/create/)(const [String](../../system/string/)\&) | Skapar hash-algoritm baserad på namn. |
...
| virtual int [get_HashSize](../hashalgorithm/get_hashsize/)() | Hämtar storleken på det beräknade hashvärdet i byte. |
| int [get_InputBlockSize](../hashalgorithm/get_inputblocksize/)() override | Indatablockstorlek. |
| int [get_OutputBlockSize](../hashalgorithm/get_outputblocksize/)() override | Utdatablockstorlek. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referenskontorens datastruktur som är associerad med objektet. |
...
| int [TransformBlock](../hashalgorithm/transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Bearbetar ett datablok och kopierar data till utmatningsarray. |
