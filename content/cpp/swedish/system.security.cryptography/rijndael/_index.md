...
description: "Bas-klass för Rijndael-algoritmen. Objekt av denna klass bör endast allokeras med funktionen System::MakeObject(). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assertionsfel. Paketera alltid denna klass i en System::SmartPtr-pekare och använd den pekaren för att skicka den till funktioner som argument."
type: docs
weight: 404
url: /sv/system.security.cryptography/rijndael/
---
## Rijndael klass

Bas-klass för [Rijndael](./)-algoritmen. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av den här typen på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assertionsfel. Paketera alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd den pekaren för att skicka den till funktioner som argument.
...
| virtual void [GenerateIV](../symmetricalgorithm/generateiv/)() | Genererar slumpmässigt startvärde för algoritmen. Åsidosätter befintligt (om något). |
...
| virtual void [set_BlockSize](../symmetricalgorithm/set_blocksize/)(int) | Sätter blockstorlek för kryptografisk operation. |
| virtual void [set_FeedbackSize](../symmetricalgorithm/set_feedbacksize/)(int) | Sätter återkopplingsstorlek för kryptografisk operation. |
| virtual void [set_IV](../symmetricalgorithm/set_iv/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Sätter startvärde för kryptografisk operation. |
| virtual void [set_Key](../symmetricalgorithm/set_key/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Sätter nyckel för kryptografisk operation. |
| virtual void [set_KeySize](../symmetricalgorithm/set_keysize/)(int) | Sätter nyckelstorlek för kryptografisk operation. |
| virtual void [set_Mode](../symmetricalgorithm/set_mode/)([CipherMode](../ciphermode/)) | Sätter läge för kryptografisk operation. |
| virtual void [set_Padding](../symmetricalgorithm/set_padding/)([PaddingMode](../paddingmode/)) | Sätter utfyllnad för kryptografisk operation. |
...
| **bool** [ValidKeySize](../symmetricalgorithm/validkeysize/)(int) | Kontrollerar om nyckelstorlek är giltig. |
