...
description: Implementerar IEnumerator-gränssnittet för en tom generisk samling.
type: docs
weight: 27
url: /sv/system.linq.details/emptyenumerator/
---
## EmptyEnumerator klass

Implementerar IEnumerator-gränssnittet för en tom generisk samling.
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const override | Hämtar aktuellt element. |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Gör det första [MoveNext()](../../system.collections.generic/ienumerator/movenext/)-anropet och förbereder enumeratorobjektet för att användas av VirtualizedIterator. |
...
| **bool** [MoveNext](./movenext/)() override | Flyttar enumeratorn till nästa element. Om inget element refererades tidigare sätts referensen till det första tillgängliga elementet. Om containerns slut nås görs inget. |
...
| void [Reset](./reset/)() override | Återställer enumeratorn till positionen före det första elementet. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter den n-te mallparametern till en svag pekare (istället för delad). Tillåter att byta pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning med C# lock()-satser. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
