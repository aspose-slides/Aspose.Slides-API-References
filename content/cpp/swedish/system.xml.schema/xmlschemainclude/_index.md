...
description: Representerar include-elementet från XML Schema enligt World Wide Web Consortium (W3C). Denna klass används för att inkludera deklarationer och definitioner från ett externt schema. De inkluderade deklarationerna och definitionerna är sedan tillgängliga för bearbetning i det innehållande schemat.
type: docs
weight: 495
url: /sv/system.xml.schema/xmlschemainclude/
---
## XmlSchemaInclude class


Representerar **include**-elementet från XML [Schema](../) som specificeras av World Wide [Web](../../system.web/)-konsortiet (W3C). Denna klass används för att inkludera deklarationer och definitioner från ett externt schema. De inkluderade deklarationerna och definitionerna blir sedan tillgängliga för behandling i det innehållande schemat.
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaexternal/get_unhandledattributes/)() | Returnerar de kvalificerade attributen, som inte tillhör schemets målnamnrymd. |
...
| void [set_Annotation](./set_annotation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\>\&) | Ställer in **annotation**-värdet. |
...
| void [set_UnhandledAttributes](../xmlschemaexternal/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Ställer in de kvalificerade attributen, som inte tillhör schemets målnamnrymd. |
