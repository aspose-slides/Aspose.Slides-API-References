...
description: Innehåller en cache av XML Schema definition language (XSD) och XML-Data Reduced (XDR) scheman.
type: docs
weight: 222
url: /sv/system.xml.schema/xmlschemacollection/
---
...
| Metod | Beskrivning |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Adds the schema located by the given URL into the schema collection. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Adds the schema contained in the [XmlReader](../../system.xml/xmlreader/) to the schema collection. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Adds the schema contained in the [XmlReader](../../system.xml/xmlreader/) to the schema collection. The specified [XmlResolver](../../system.xml/xmlresolver/) is used to resolve any external resources. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Adds the [XmlSchema](../xmlschema/) to the collection. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Adds the [XmlSchema](../xmlschema/) to the collection. The specified [XmlResolver](../../system.xml/xmlresolver/) is used to resolve any external references. |
| void [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaCollection](./)\>\&) | Adds all the namespaces defined in the given collection (including their associated schemas) to this collection. |
...
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Returns a value indicating whether the **targetNamespace** of the specified [XmlSchema](../xmlschema/) is in the collection. |
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) | Returns a value indicating whether a schema with the specified namespace is in the collection. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\&, **int32_t**) | Copies all the [XmlSchema](../xmlschema/) objects from this collection into the given array starting at the given index. |
...
| **int32_t** [get_Count](./get_count/)() | Returns the number of namespaces defined in this collection. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](./get_nametable/)() | Returns the default [XmlNameTable](../../system.xml/xmlnametable/) used by the [XmlSchemaCollection](./) when loading new schemas. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\> [GetEnumerator](./getenumerator/)() override | Provides support for iteration over the collection of schemas. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog of C# [Object.GetHashCode()](../../system/object/gethashcode/) method. Enables hashing of custom objects. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Gets actual type of object. Analog of C# [System.Object.GetType()](../../system/object/gettype/) call. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Returns the [XmlSchema](../xmlschema/) associated with the given namespace URI. |
...
|  [XmlSchemaCollection](./xmlschemacollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Initializes a new instance of the [XmlSchemaCollection](./) class with the specified [XmlNameTable](../../system.xml/xmlnametable/). The [XmlNameTable](../../system.xml/xmlnametable/) is used when loading schemas. |
...
Avskriven
:   [XmlSchemaCollection](./)-klassen är föråldrad. Använd [XmlSchemaSet](../xmlschemaset/) istället.
