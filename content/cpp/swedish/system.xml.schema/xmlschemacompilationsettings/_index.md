...
description: Tillhandahåller alternativ för schema-kompilering för XmlSchemaSet-klassen. Denna klass kan inte ärvas.
type: docs
weight: 248
url: /sv/system.xml.schema/xmlschemacompilationsettings/
---
## XmlSchemaCompilationSettings klass

Tillhandahåller alternativ för schema-kompilering för [XmlSchemaSet](../xmlschemaset/) klass. Denna klass kan inte ärvas.
...
| **bool** [get_EnableUpaCheck](./get_enableupacheck/)() | Returnerar ett värde som indikerar om [XmlSchemaSet](../xmlschemaset/) ska kontrollera Unique Particle Attribution (UPA)-överträdelser. |
...
| void [set_EnableUpaCheck](./set_enableupacheck/)(**bool**) | Ställer in ett värde som indikerar om [XmlSchemaSet](../xmlschemaset/) ska kontrollera Unique Particle Attribution (UPA)-överträdelser. |
...
|  [XmlSchemaCompilationSettings](./xmlschemacompilationsettings/)() | Initierar en ny instans av [XmlSchemaCompilationSettings](./) klass. |
