...
description: Representerar dokumentationselementet från XML-schema enligt World Wide Web Consortium (W3C). Denna klass specificerar information som ska läsas eller användas av människor inom en annotering.
type: docs
weight: 352
url: /sv/system.xml.schema/xmlschemadocumentation/
---
## XmlSchemaDocumentation klass
...
| [String](../../system/string/) [get_Language](./get_language/)() | Returnerar attributet **xml:lang**. Detta fungerar som en indikator på språket som används i innehållet. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Returnerar en array av [XmlNode](../../system.xml/xmlnode/)-objekt som representerar dokumentations-barnnoderna. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Returnerar XmlSerializerNamespaces som ska användas med detta schema-objekt. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Returnerar Uniform Resource Identifier (URI)-källan för informationen. |
...
| void [set_Language](./set_language/)(const [String](../../system/string/)\&) | Sätter attributet **xml:lang**. Detta fungerar som en indikator på språket som används i innehållet. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Sätter en array av [XmlNode](../../system.xml/xmlnode/)-objekt som representerar dokumentations-barnnoderna. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Sätter XmlSerializerNamespaces som ska användas med detta schema-objekt. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Sätter Uniform Resource Identifier (URI)-källan för informationen. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsningupplåsning för C# lock()-satser. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig instanser av denna typ på stacken eller med operatorn new, eftersom det kan leda till körtidsfel och/eller assert-fel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd den pekaren för att skicka den till funktioner som argument. 
