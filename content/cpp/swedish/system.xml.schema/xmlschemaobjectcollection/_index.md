...
description: En samling av XmlSchemaObjects.
type: docs
weight: 690
url: /sv/system.xml.schema/xmlschemaobjectcollection/
---
## XmlSchemaObjectCollection klass
...
| Metod | Beskrivning |
| --- | --- |
| **int32_t** [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Lägger till ett [XmlSchemaObject](../xmlschemaobject/) i [XmlSchemaObjectCollection](./). |
...
| void [Clear](../../system.collections/collectionbase/clear/)() | Tar bort alla objekt från samlingsinstansen. Denna metod kan inte åsidosättas. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Indikerar om den specificerade [XmlSchemaObject](../xmlschemaobject/) finns i [XmlSchemaObjectCollection](./). |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\&, **int32_t**) | Kopierar alla XmlSchemaObjects från samlingen till den angivna arrayen, med början vid det angivna indexet. |
...
| **int32_t** [get_Capacity](../../system.collections/collectionbase/get_capacity/)() | Returnerar antalet element som samlingen kan innehålla. |
| **int32_t** [get_Count](../../system.collections/collectionbase/get_count/)() | Returnerar antalet element som finns i samlingsinstansen. Denna metod kan inte åsidosättas. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [GetEnumerator](./getenumerator/)() override | Returnerar en enumerator för att iterera genom XmlSchemaObjects som finns i [XmlSchemaObjectCollection](./). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog till C# [Object.GetHashCode()](../../system/object/gethashcode/)-metoden. Möjliggör hashning av anpassade objekt. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Hämtar objektets faktiska typ. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(**int32_t**) | Returnerar [XmlSchemaObject](../xmlschemaobject/) vid angivet index. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>) | Sätter [XmlSchemaObject](../xmlschemaobject/) vid angivet index. |
| **int32_t** [IndexOf](./indexof/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Returnerar samlingens index som motsvarar den angivna [XmlSchemaObject](../xmlschemaobject/). |
| void [Insert](./insert/)(**int32_t**, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Infogar ett [XmlSchemaObject](../xmlschemaobject/) i [XmlSchemaObjectCollection](./). |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Hoppar över ett angivet antal intilliggande element från sekvensens början och returnerar resten. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Returnerar ett angivet antal intilliggande element från sekvensens början. |
...
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Tar bort ett [XmlSchemaObject](../xmlschemaobject/) från [XmlSchemaObjectCollection](./). |
| void [RemoveAt](../../system.collections/collectionbase/removeat/)(**int32_t**) | Tar bort elementet vid det angivna indexet i samlingsinstansen. Denna metod kan inte åsidosättas. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar det delade referensräknandet med angivet värde. |
| void [set_Capacity](../../system.collections/collectionbase/set_capacity/)(**int32_t**) | Ställer in antalet element som samlingen kan innehålla. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Sätter n'te mallargument till en weak-pekare (istället för shared). Tillåter att byta pekare i behållare till weak-läge. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar det svaga referensräknandet. Bör inte anropas direkt; använd smarta pekare eller ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar det svaga referensräknandet. Bör inte anropas direkt; använd smarta pekare eller ThisProtector. |
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)() | Initierar en ny instans av [XmlSchemaObjectCollection](./)-klassen. |
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Initierar en ny instans av [XmlSchemaObjectCollection](./)-klassen som tar emot ett [XmlSchemaObject](../xmlschemaobject/). |
...
Objekt av denna klass bör endast allokeras med hjälp av funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig instanser av denna typ på stacken eller med operatorn new, eftersom det kan leda till körningstidfel och/eller assert-fel. Omslut alltid klassen i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument. 

## Se även

* Klass [CollectionBase](../../system.collections/collectionbase/)
