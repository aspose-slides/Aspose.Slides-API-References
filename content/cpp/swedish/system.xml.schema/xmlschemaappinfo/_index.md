...
description: Representerar World Wide Web Consortium (W3C) appinfo-elementet.
type: docs
weight: 157
url: /sv/system.xml.schema/xmlschemaappinfo/
---
## XmlSchemaAppInfo klass
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Returnerar en array av [XmlNode](../../system.xml/xmlnode/)-objekt som representerar **appinfo**-barnnoder. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Returnerar XmlSerializerNamespaces att använda med detta schemainstans. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Returnerar källan för programinformation. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referenstillgång med angivet värde. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Sätter en array av [XmlNode](../../system.xml/xmlnode/)-objekt som representerar **appinfo**-barnnoder. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Sätter XmlSerializerNamespaces att använda med detta schemainstans. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Sätter källan för programinformationen. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Ökar delad referenstillgång. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Minskar och returnerar delad referenstillgång. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar weak-referenstillgång. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar weak-referenstillgång. Bör inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
...
| Typdef | Beskrivning |
| --- | --- |
| [Ptr](./ptr/) | En alias för shared pointer till en instans av denna klass. |
## Anmärkningar
