...
description: Representerar group-elementet med ref-attribut från XML-schema enligt World Wide Web Consortium (W3C). Denna klass används inom komplexa typer som refererar till ett group definierat på schemanivå.
type: docs
weight: 456
url: /sv/system.xml.schema/xmlschemagroupref/
---
## XmlSchemaGroupRef klass


Representerar **group**-elementet med **ref**-attribut från XML [Schema](../) enligt World Wide [Web](../../system.web/) Consortium (W3C). Denna klass används inom komplexa typer som refererar till ett **group** definierat på **schema**-nivå.
...
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Returnerar siffran som ett strängvärde. Maximalt antal gånger partikeln kan förekomma. |
...
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Returnerar siffran som ett strängvärde. Det minsta antalet gånger partikeln kan förekomma. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | Returnerar en av klasserna [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) eller [XmlSchemaSequence](../xmlschemasequence/), som håller den efterkompilations-tolkning av **Particle**-värdet. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Returnerar namnet på en grupp som definierats i detta schema (eller ett annat schema angivet av den specificerade namnrymden). |
...
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Sätter siffran som ett strängvärde. Maximalt antal gånger partikeln kan förekomma. |
...
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Sätter siffran som ett strängvärde. Det minsta antalet gånger partikeln kan förekomma. |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Sätter namnet på en grupp som definierats i detta schema (eller ett annat schema angivet av den specificerade namnrymden). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n'te template-argument till en svag pekare (istället för en delad). Tillåter att byta pekare i behållare till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satsens låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentry-objektet. |
...
Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig instanser av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller assert-fel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den som argument till funktioner. 
