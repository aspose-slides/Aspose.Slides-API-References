...
description: En vas-klass för att definiera numeriska fasetter. Denna klass är basklass för numeriska fasetklasser såsom XmlSchemaMinLengthFacet.
type: docs
weight: 664
url: /sv/system.xml.schema/xmlschemanumericfacet/
---
## XmlSchemaNumericFacet klass

En vas-klass för att definiera **numeriska** fasetter. Denna klass är basklass för numeriska fasetklasser såsom [XmlSchemaMinLengthFacet](../xmlschemaminlengthfacet/).
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Returnerar information som indikerar att denna fasett är fixerad. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Returnerar **value**-attributet för fasetten. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Sätter sträng-id-tänjaren. |
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Sätter information som indikerar att denna fasett är fixerad. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Sätter **value**-attributet för fasetten. |
