...
description: Representerar undantaget som kastas när XML Schema Definition Language (XSD) schema valideringsfel och varningar påträffas i ett XML-dokument som valideras.
type: docs
weight: 27
url: /sv/system.xml.schema/details_xmlschemavalidationexception/
---
## Details_XmlSchemaValidationException klass

Representerar undantaget som kastas när XML [Schema](../) Definition Language (XSD) schema valideringsfel och varningar påträffas i ett XML-dokument som valideras.
...
| **int32_t** [get_LineNumber](../details_xmlschemaexception/get_linenumber/)() | Returnerar radnumret som indikerar var felet inträffade. |
| **int32_t** [get_LinePosition](../details_xmlschemaexception/get_lineposition/)() | Returnerar radpositionen som indikerar var felet inträffade. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SourceObject](./get_sourceobject/)() | Returnerar XML-noden som orsakade detta XmlSchemaValidationException. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](../details_xmlschemaexception/get_sourceschemaobject/)() | Den **[XmlSchemaObject](../xmlschemaobject/)** som producerade XmlSchemaException. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Hämtar det faktiska objektets typ. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
| **bool** [Is](../../system/details_systemexception/is/)(const [System::TypeInfo](../../system/typeinfo/)\&) const override |  |
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-påstående låsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätt n'te template-argument till en svag pekare (snarare än delad). Tillåter att byta pekare i behållare till svagt läge. |
