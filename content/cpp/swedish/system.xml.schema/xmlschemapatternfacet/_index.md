...
description: Representerar pattern-elementet från XML Schema enligt World Wide Web Consortium (W3C). Denna klass kan användas för att specificera en begränsning på värdet som anges för ett simpleType-element.
type: docs
weight: 742
url: /sv/system.xml.schema/xmlschemapatternfacet/
---
## XmlSchemaPatternFacet klass


Representerar **pattern**-elementet från XML [Schema](../) enligt World Wide [Web](../../system.web/) Consortium (W3C). Denna klass kan användas för att specificera en begränsning på värdet som anges för ett **simpleType**-element.
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referenstæknar-datastruktur associerad med objektet. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Ställer in de kvalificerade attributen som inte tillhör det aktuella schemets mål-namnrymd. |
