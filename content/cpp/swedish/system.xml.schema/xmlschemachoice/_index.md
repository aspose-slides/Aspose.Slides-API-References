...
description: Representerar **choice**-elementet (kompositör) från XML-schemat enligt specifikationen av World Wide Web Consortium (W3C). **choice** tillåter endast ett av sina barn att förekomma i en instans.
type: docs
weight: 209
url: /sv/system.xml.schema/xmlschemachoice/
---
## XmlSchemaChoice klass

Representerar **choice**-elementet (kompositör) från XML [Schema](../) enligt specifikationen av World Wide [Web](../../system.web/) Consortium (W3C). **choice** tillåter endast ett av dess barn att förekomma i en instans.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Returnerar samlingen av element som ingår i kompositören (**choice**): [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](./), [XmlSchemaSequence](../xmlschemasequence/) eller [XmlSchemaAny](../xmlschemaany/). |
...
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Returnerar talet som en sträng. Maximalt antal gånger partikeln kan förekomma. |
...
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Returnerar talet som en sträng. Det minsta antalet gånger partikeln kan förekomma. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Returnerar de kvalificerade attributen som inte tillhör det aktuella schemets mål-namnrymd. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieringskonstruktor. Kopierar egentligen inget, initierar bara ett nytt objekt och möjliggör kopiekonstruktion av underklasser. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Tilldelningsoperator. Kopierar egentligen inget, initierar bara ett nytt objekt och möjliggör kopiekonstruktion av underklasser. |
...
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Sätter talet som en sträng. Maximalt antal gånger partikeln kan förekomma. |
...
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Sätter talet som en sträng. Det minsta antalet gånger partikeln kan förekomma. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Sätter de kvalificerade attributen som inte tillhör det aktuella schemets mål-namnrymd. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter n-te mallargumentet till en svag pekare (istället för delad). Möjliggör byte av pekare i containrar till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning av C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
Objekt av denna klass bör endast allokeras med hjälp av funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig instanser av denna typ på stacken eller med operatorn new, eftersom det kan leda till körningstidfel och/eller assertionsfel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den som argument till funktioner som argument. 
