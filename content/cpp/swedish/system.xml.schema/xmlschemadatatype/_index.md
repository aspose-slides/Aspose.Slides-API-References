...
description: Klassen XmlSchemaDatatype är en abstrakt klass för att kartlägga XML Schema definition language (XSD)-typer till körningstyper.
type: docs
weight: 339
url: /sv/system.xml.schema/xmlschemadatatype/
---
## XmlSchemaDatatype klass

Klassen [XmlSchemaDatatype](./) är en abstrakt klass för att mappa XML [Schema](../) definitionsspråk (XSD) typer till körtidstyper.
...
| Metod | Beskrivning |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ChangeType](./changetype/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, const [TypeInfo](../../system/typeinfo/)\&) | Konverterar det angivna värdet, vars typ är en av de giltiga representationerna av XML-schemas typen som representeras av [XmlSchemaDatatype](./), till den angivna körtidstypen. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ChangeType](./changetype/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, const [TypeInfo](../../system/typeinfo/)\&, [SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>) | Konverterar det angivna värdet, vars typ är en av de giltiga representationerna av XML-schemas typen som representeras av [XmlSchemaDatatype](./), till den angivna körtidstypen med hjälp av [IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/) om [XmlSchemaDatatype](./) representerar **xs:QName**-typen eller en av den härledd typ. |
...
| virtual [XmlTokenizedType](../../system.xml/xmltokenizedtype/) [get_TokenizedType](./get_tokenizedtype/)() | När den åsidosätts i en avledd klass hämtas typen för **string** enligt World Wide [Web](../../system.web/) Consortium (W3C) XML 1.0-specifikationen. |
| virtual [XmlTypeCode](../xmltypecode/) [get_TypeCode](./get_typecode/)() | Returnerar XmlTypeCode-värdet för den enkla typen. |
| virtual [TypeInfo](../../system/typeinfo/) [get_ValueType](./get_valuetype/)() | När den åsidosätts i en avledd klass hämtas typen för objektet. |
| virtual [XmlSchemaDatatypeVariety](../xmlschemadatatypevariety/) [get_Variety](./get_variety/)() | Returnerar XmlSchemaDatatypeVariety-värdet för den enkla typen. |
...
| virtual **bool** [IsDerivedFrom](./isderivedfrom/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaDatatype](./)\>) | Denna metod returnerar alltid **false**. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ParseValue](./parsevalue/)([String](../../system/string/), [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>, [SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>) | När den åsidosätts i en avledd klass valideras den angivna **string** mot en inbyggd eller användardefinierad enkel typ. |
