...
description: Representerar restriktionselementet för enkelt innehåll från XML Schema enligt vad World Wide Web Consortium (W3C) specificerar. Denna klass kan användas för att härleda enkla typer genom restriktion. Sådana härledningar kan användas för att begränsa värdeintervallet för elementet till en delmängd av de värden som specificeras i den ärvda enkla typen.
type: docs
weight: 820
url: /sv/system.xml.schema/xmlschemasimplecontentrestriction/
---
## XmlSchemaSimpleContentRestriction klass


Representerar **restriktion**-elementet för enkelt innehåll från XML [Schema](../) enligt vad World Wide [Web](../../system.web/) Consortium (W3C) specificerar. Denna klass kan användas för att härleda enkla typer med restriktion. Sådana härledningar kan användas för att begränsa värdeintervallet för elementet till en delmängd av de värden som specificeras i den ärvda enkla typen.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Returnerar en [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) som ska användas för attributvärdet. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Returnerar samlingarna [XmlSchemaAttribute](../xmlschemaattribute/) och [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) av attribut för den enkla typen. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | Returnerar det enkla typens grundvärde. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Returnerar namnet på den inbyggda datatypen eller enkla typen som denna typ härstammar från. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | Returnerar ett [Xml](../../system.xml/)[Schema](../) facet. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Returnerar XmlSerializerNamespaces som ska användas med detta schemasobjekt. |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Ställer in ett [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) som ska användas för attributvärdet. |
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Ställer in det enkla typens grundvärde. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Ställer in namnet på den inbyggda datatypen eller enkla typen som denna typ härstammar från. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Ställer in XmlSerializerNamespaces som ska användas med detta schemasobjekt. |
...
|  [XmlSchemaSimpleContentRestriction](./xmlschemasimplecontentrestriction/)() | Initierar en ny instans av [XmlSchemaSimpleContentRestriction](./)-klassen. |
...
* Klass [XmlSchemaContent](../xmlschemacontent/)
