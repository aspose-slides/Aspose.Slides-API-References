...
description: Representerar maxLength-elementet från XML Schema enligt World Wide Web Consortium (W3C). Denna klass kan användas för att ange en begränsning på den maximala längden av datavärdet för ett simpleType-element. Längden måste vara mindre än värdet av maxLength-elementet.
type: docs
weight: 599
url: /sv/system.xml.schema/xmlschemamaxlengthfacet/
---
## XmlSchemaMaxLengthFacet klass


Representerar **maxLength**-elementet från XML [Schema](../) enligt World Wide [Web](../../system.web/) Consortium (W3C). Denna klass kan användas för att ange en begränsning på den maximala längden av datavärdet för ett **simpleType**-element. Längden måste vara mindre än värdet av **maxLength**-elementet.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Returnerar information som visar att detta facet är fixerad. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Returnerar de kvalificerade attributen som inte hör till det aktuella schemats mål-namnrymd. |
...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satsen för låsning. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Ställer in information som visar att detta facet är fixerad. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Ställer in XmlSerializerNamespaces att använda med detta schema-objekt. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Ställer in **value**-attributet för facetet. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter det n'te template-argumentet till en svag pekare (i stället för delad). Tillåter att byta pekare i containrar till svagt läge. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satsen för upplåsning. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
Objekt av denna klass bör bara allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig instanser av denna typ på stacken eller med operatorn new, eftersom det kan leda till körningsfel och/eller assert-fel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd den pekaren för att skicka den till funktioner som argument. 
