...
description: Stöder enkel iteration över en samling. Denna klass kan inte ärvas.
type: docs
weight: 235
url: /sv/system.xml.schema/xmlschemacollectionenumerator/
---
## XmlSchemaCollectionEnumerator klass


Stöder enkel iteration över en samling. Denna klass kan inte ärvas.
...
| Metod | Beskrivning |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Förbereder iteratorn för att användas av VirtualizedIterator-klassen. |
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchema](../xmlschema/)\>\> * [CloneIterator](./cloneiterator/)() const override | Klonar den aktuella iteratorn. |
...
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\& [get_Current](./get_current/)() const override | Returnerar den aktuella [XmlSchema](../xmlschema/) i samlingen. |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Utför det första [MoveNext()](../../system.collections.generic/ienumerator/movenext/)-anropet och förbereder enumeratorobjektet för att användas av VirtualizedIterator. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Kontrollerar om objektet representerar en instans av den typ som beskrivs av targetType. Analog till C#-operatorn 'is'. |
| void [Lock](../../system/object/lock/)() | Implementerar låsning i C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | Markerar enumeratorn som ägs av virtualiserad iterator. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog till C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-metoden. Möjliggör kloning av anpassade typer. |
| **bool** [MoveNext](./movenext/)() override | Flyttar enumeratorn till nästa schema i samlingen. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning i C# lock()-sats. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
