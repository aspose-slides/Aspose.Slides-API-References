...
description: Härleder ett XML Schema Definition Language (XSD) schema från ett XML-dokument. Klassen XmlSchemaInference kan inte ärvas.
type: docs
weight: 508
url: /sv/system.xml.schema/xmlschemainference/
---
...
| [XmlSchemaInference::InferenceOption](./inferenceoption/) [get_Occurrence](./get_occurrence/)() | Returnerar [XmlSchemaInference::InferenceOption](./inferenceoption/)-värdet som påverkar schemats förekomstdeklarationer som härleds från XML-dokumentet. |
| [XmlSchemaInference::InferenceOption](./inferenceoption/) [get_TypeInference](./get_typeinference/)() | Returnerar [XmlSchemaInference::InferenceOption](./inferenceoption/)-värdet som påverkar typerna som härleds från XML-dokumentet. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\> [InferSchema](./inferschema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Härleder ett XML [Schema](../) Definition Language (XSD) schema från XML-dokumentet som finns i det angivna [XmlReader](../../system.xml/xmlreader/)-objektet. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\> [InferSchema](./inferschema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\>) | Härleder ett XML [Schema](../) Definition Language (XSD) schema från XML-dokumentet som finns i det angivna [XmlReader](../../system.xml/xmlreader/)-objektet, och förfinar det härledda schemat med ett befintligt schema i det angivna [XmlSchemaSet](../xmlschemaset/)-objektet med samma mål-namnområde. |
...
| void [Lock](../../system/object/lock/)() | Implementerar låsning enligt C# lock()-statement. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
| void [set_Occurrence](./set_occurrence/)([XmlSchemaInference::InferenceOption](./inferenceoption/)) | Sätter [XmlSchemaInference::InferenceOption](./inferenceoption/)-värdet som påverkar schemats förekomstdeklarationer som härleds från XML-dokumentet. |
| void [set_TypeInference](./set_typeinference/)([XmlSchemaInference::InferenceOption](./inferenceoption/)) | Sätter [XmlSchemaInference::InferenceOption](./inferenceoption/)-värdet som påverkar typerna som härleds från XML-dokumentet. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning enligt C# lock()-statement. Anropas direkt eller använd [LockContext](../../system/lockcontext/)-vaktobjekt. |
...
|  [XmlSchemaInference](./xmlschemainference/)() | Initierar en ny instans av [XmlSchemaInference](./)-klassen. |
...
| Enum | Description |
| --- | --- |
| [InferenceOption](./inferenceoption/) | Påverkar förekomst- och typinformation som härleds av [XmlSchemaInference](./)-klassen för element och attribut i ett XML-dokument. |
