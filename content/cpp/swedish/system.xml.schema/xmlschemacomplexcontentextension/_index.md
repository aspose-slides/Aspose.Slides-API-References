...
description: Representerar extensionselementet från XML Schema enligt World Wide Web Consortium (W3C). Denna klass är för komplexa typer med en komplex innehållsmodell som härstammar genom extension. Den utökar den komplexa typen genom att lägga till attribut eller element.
type: docs
weight: 274
url: /sv/system.xml.schema/xmlschemacomplexcontentextension/
---
## XmlSchemaComplexContentExtension klass


Representerar **extension**-elementet från XML [Schema](../) enligt World Wide [Web](../../system.web/) Consortium (W3C). Denna klass är för komplexa typer med en komplex innehållsmodell som härstammar genom extension. Den utökar den komplexa typen genom att lägga till attribut eller element.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Returnerar [XmlSchemaAnyAttribute](../xmlschemaanyattribute/)-komponenten av den komplexa innehållsmodellen. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Returnerar samlingen av attribut för det komplexa innehållet. Innehåller [XmlSchemaAttribute](../xmlschemaattribute/) och [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) element. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Returnerar namnet på den komplexa typen som detta typ härstammar från genom extension. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\> [get_Particle](./get_particle/)() | Returnerar en av klasserna [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) eller [XmlSchemaSequence](../xmlschemasequence/). |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Sätter [XmlSchemaAnyAttribute](../xmlschemaanyattribute/)-komponenten av den komplexa innehållsmodellen. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Sätter namnet på den komplexa typen som detta typ härstammar från genom extension. |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\>\&) | Sätter en av klasserna [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) eller [XmlSchemaSequence](../xmlschemasequence/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låssläpp enligt C# lock()-satser. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
