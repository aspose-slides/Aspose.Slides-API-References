...
description: Representerar enumerationsfacet från XML Schema enligt World Wide Web Consortium (W3C). Denna klass specificerar en lista med giltiga värden för ett simpleType-element. Deklarationen finns i en restriktionsdeklaration.
type: docs
weight: 378
url: /sv/system.xml.schema/xmlschemaenumerationfacet/
---
## XmlSchemaEnumerationFacet klass


Representerar **enumeration**-facet från XML [Schema](../) enligt World Wide [Web](../../system.web/) Consortium (W3C). Denna klass specificerar en lista med giltiga värden för ett simpleType-element. Deklarationen finns i en **restriction**-deklaration.
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Returnerar sträng-id-värdet. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Returnerar de kvalificerade attributen som inte tillhör det aktuella schemets mål-namnområde. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Jämför värdetyp-objekt via referens med nullptr. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Ställer in sträng-id-värdet. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Ställer in de kvalificerade attributen som inte tillhör det aktuella schemets mål-namnområde. |
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Ställer in **value**-attributet för facet. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter det n-:te mallargumentet till en weak-pekare (istället för shared). Gör det möjligt att byta pekare i behållare till weak-läge. |
...
|  [XmlSchemaEnumerationFacet](./xmlschemaenumerationfacet/)() | Initierar en ny instans av [XmlSchemaEnumerationFacet](./)-klassen. |
