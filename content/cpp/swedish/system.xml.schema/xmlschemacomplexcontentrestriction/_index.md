...
description: Representerar restriction-elementet från XML-schema enligt World Wide Web Consortium (W3C). Denna klass är för komplexa typer med en komplex innehållsmodell som härleds genom restriction. Den begränsar innehållet i den komplexa typen till en delmängd av den ärvda komplexa typen.
type: docs
weight: 287
url: /sv/system.xml.schema/xmlschemacomplexcontentrestriction/
---
## XmlSchemaComplexContentRestriction klass
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Returnerar [XmlSchemaAnyAttribute](../xmlschemaanyattribute/)-komponenten i den komplexa innehållsmodellen. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Returnerar samlingen av attribut för den komplexa typen. Innehåller elementen [XmlSchemaAttribute](../xmlschemaattribute/) och [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Returnerar namnet på en komplex typ som denna typ härstammar från genom restriction. |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Sätter [XmlSchemaAnyAttribute](../xmlschemaanyattribute/)-komponenten i den komplexa innehållsmodellen. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Sätter namnet på en komplex typ som denna typ härstammar från genom restriction. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar upplåsning enligt C# lock()-sats. Anropas direkt eller via [LockContext](../../system/lockcontext/)-vaktobjekt. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Ökar den svaga referensräknaren. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Minskar den svaga referensräknaren. Ska inte anropas direkt; använd smarta pekare eller ThisProtector istället. |
| [XmlSchemaComplexContentRestriction](./xmlschemacomplexcontentrestriction/)() | Initierar en ny instans av [XmlSchemaComplexContentRestriction](./) klass. |
