...
description: En basklass för alla facetter som används när enkla typer härleds genom restriktion.
type: docs
weight: 404
url: /sv/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet klass


En basklass för alla facetter som används när enkla typer härleds genom restriktion.
...
| virtual **bool** [get_IsFixed](./get_isfixed/)() | Returnerar information som indikerar att denna facet är fast. |
...
| [String](../../system/string/) [get_Value](./get_value/)() | Returnerar attributet **value** för facet. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referenräknar-datastruktur associerad med objektet. |
...
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | Ställer in information som indikerar att denna facet är fast. |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Ställer in attributet **value** för facet. |
