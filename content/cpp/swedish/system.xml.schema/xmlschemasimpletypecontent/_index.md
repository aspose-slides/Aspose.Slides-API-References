...
description: En basklass för enkla typinnehållsklasser.
type: docs
weight: 846
url: /sv/system.xml.schema/xmlschemasimpletypecontent/
---
## XmlSchemaSimpleTypeContent klass
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Efterliknar C#-stil för flyttalssammanlikning där två NaN-värden anses vara lika även om IEC 60559:1989 anger att NaN inte ar̈r lika med något värde, inklusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Efterliknar C#-stil för flyttalssammanlikning där två NaN-värden anses vara lika även om IEC 60559:1989 anger att NaN inte ar̈r lika med något värde, inklusive NaN. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Sätter det n-:te mall-argumentet till en svag pekare (istället för delad). Möjliggör byte av pekare i behållare till svagt läge. |
