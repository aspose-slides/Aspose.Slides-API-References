...
description: "Representerar en karta för att konvertera färger. Objekt av den här klassen bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller påståendesfel. Wrappa alltid denna klass i en System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 14
url: /sv/system.drawing.imaging/colormap/
---
## ColorMap klass

Representerar en karta för att konvertera färger. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att leda till körfel och/eller påstående-fel. Wrappa alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| [Color](../../system.drawing/color/) [get_NewColor](./get_newcolor/)() const | Returnerar det nya [Color](../../system.drawing/color/)-objektet som representerar färgen att konvertera till. |
| [Color](../../system.drawing/color/) [get_OldColor](./get_oldcolor/)() const | Returnerar det gamla [Color](../../system.drawing/color/)-objektet som representerar färgen som ska konverteras. |
...
| void [set_NewColor](./set_newcolor/)(const [Color](../../system.drawing/color/)\&) | Ställer in det nya [Color](../../system.drawing/color/)-objektet som representerar färgen att konvertera till. |
| void [set_OldColor](./set_oldcolor/)(const [Color](../../system.drawing/color/)\&) | Ställer in det gamla [Color](../../system.drawing/color/)-objektet som representerar färgen som ska konverteras. |
