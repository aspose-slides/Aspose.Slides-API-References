...
| void [Lock](../../system/object/lock/)() | Implementerar C# lock()-satset låsning. Anropas direkt eller med [LockContext](../../system/lockcontext/)-vaktobjektet. |
...
| int [Release](./release/)() | Frigör lås på semafor. |
| int [Release](./release/)(int) | Frigör flera lås på semafor. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referensräknare med angivet värde. |
| virtual **bool** [Reset](./reset/)() | Ställer in semafor till icke-signalerat tillstånd. Stöds inte. |
|  [Semaphore](./semaphore/)(int, int) | Skapar namnlös semafor. |
|  [Semaphore](./semaphore/)(int, int, const [String](../../system/string/)\&) | Skapar namngiven semafor. |
|  [Semaphore](./semaphore/)(int, int, const [String](../../system/string/)\&, **bool**\&) | Skapar namngiven semafor. |
| virtual **bool** [Set](./set/)() | Ställer in semafor till signalerat tillstånd. Stöds inte. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satset upplåsning. Anropas direkt eller med [LockContext](../../system/lockcontext/)-vaktobjektet. |
...
| **bool** [WaitOne](./waitone/)() override | Låser semafor. Utför obegränsad väntan om nödvändigt. |
| **bool** [WaitOne](./waitone/)(int) override | Låser semafor. Utför väntan om nödvändigt. |
...
| Fält | Beskrivning |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Speciellt värde som returneras av funktionen annars returnerar index för det signalerade objektet i arrayen, om timeout överskrids och inget signalerar. |
