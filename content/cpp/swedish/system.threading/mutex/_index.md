...
description: "Mutex-implementation. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller assertionsfel. Omslut alltid denna klass med en System::SmartPtr-pekare och använd denna pekare för att skicka den till funktioner som argument."
type: docs
weight: 170
url: /sv/system.threading/mutex/
---
## Mutex-klass
...
|  [Mutex](./mutex/)() | Skapar mutex utan ägande. |
...
| void [ReleaseMutex](./releasemutex/)() | Frigör mutexen. |
| static **bool** [Remove](./remove/)(const [String](../../system/string/)\&) | Tar bort en namngiven mutex från systemet. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Minskar delad referensräknare med angivet värde. |
| virtual **bool** [Reset](./reset/)() | Återställer mutexens tillstånd. Implementeras inte. |
| virtual **bool** [Set](./set/)() | Sätter mutex till signalerat tillstånd. Implementeras inte. |
...
| void [Unlock](../../system/object/unlock/)() | Implementerar låsning med C# lock()-sats för upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-vaktsobjekt. |
...
| **bool** [WaitOne](./waitone/)() override | Låser mutex. Utför oändlig väntan om nödvändigt. |
| **bool** [WaitOne](./waitone/)(int) override | Låser mutex. Utför väntan om nödvändigt. |
| **bool** [WaitOne](./waitone/)([TimeSpan](../../system/timespan/)) override | Låser mutex. Utför väntan om nödvändigt. |
...
| Fält | Beskrivning |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Speciellt värde som returneras av funktionen annars returneras index för ett signalerat objekt i arrayen, om timeout överskrids och inget signaleras. |
