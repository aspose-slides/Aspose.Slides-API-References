...
description: "Timer-klass som utför jobbobjekt i en separat tråd efter fördröjning. Objekt av denna klass bör endast allokeras med funktionen System::MakeObject(). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assertionsfel. Wrapa alltid denna klass i en System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 248
url: /sv/system.threading/timer/
---
## Timer klass


[Timer](./) klass som utför jobbobjekt i separat tråd efter fördröjning. Objekt av denna klass bör endast allokeras med funktionen [System::MakeObject()](../../system/makeobject/). Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller assertion-fel. Wrapa alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd pekaren för att skicka den till funktioner som argument.
...
| Method | Description |
| --- | --- |
| **bool** [Change](./change/)(**int64_t**, **int64_t**) | Återplanerar eller avbryter timern. |
| **bool** [Change](./change/)([System::TimeSpan](../../system/timespan/), [System::TimeSpan](../../system/timespan/)) | Återplanerar eller avbryter timern. |
| void [Dispose](./dispose/)() | Avplanerar timern. |
