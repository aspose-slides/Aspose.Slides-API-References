...
description: "CultureNotFoundException kastas när ett försök görs att konstruera en kultur som inte är tillgänglig. Skapa aldrig instanser av den här klassen manuellt. Använd CultureNotFoundException-klassen istället. Packa aldrig in instanser av CultureNotFoundException-klassen i System::SmartPtr."
type: docs
weight: 92
url: /sv/system.globalization/details_culturenotfoundexception/
---
## Details_CultureNotFoundException klass


CultureNotFoundException kastas när ett försök görs att konstruera en kultur som inte är tillgänglig. Skapa aldrig instanser av den här klassen manuellt. Använd CultureNotFoundException klass istället. Packa aldrig in instanser av CultureNotFoundException klass i [System::SmartPtr](../../system/smartptr/).
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Hämtar det faktiska typen av objektet. Analog till C# [System.Object.GetType()](../../system/object/gettype/)-anrop. |
