...
description: "Mappning av en sträng till dess sortnyckel. Objekt av den här klassen bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av den här typen på stacken eller med operatorn new, eftersom det kan leda till körfel och/eller påståendefel. Wrapa alltid den här klassen i en System::SmartPtr-pekare och använd pekaren för att skicka den till funktioner som argument."
type: docs
weight: 287
url: /sv/system.globalization/sortkey/
---
## SortKey klass


Mappning av en sträng till dess sortnyckel. Objekt av denna klass bör endast allokeras med hjälp av [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operatorn new, eftersom det kommer att leda till körfel och/eller påståendefel. Wrap alltid den här klassen i en [System::SmartPtr](../../system/smartptr/)-pekare och använd pekaren för att skicka den till funktioner som argument.
...
| Metod | Beskrivning |
| --- | --- |
| static int [Compare](./compare/)(const [SortKeyPtr](../sortkeyptr/)\&, const [SortKeyPtr](../sortkeyptr/)\&) | Jämför två sortnycklar. |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Kontrollerar om det angivna objektet är lika med det aktuella [SortKey](./)-objektet. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_KeyData](./get_keydata/)() | Hämtar en byte-array som representerar det aktuella objektet. |
| virtual [String](../../system/string/) [get_OriginalString](./get_originalstring/)() | Hämtar den ursprungliga strängen som användes för att skapa detta objekt. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Hämtar referensräknarens datastruktur som är associerad med objektet. |
| int [GetHashCode](./gethashcode/)() const override | Hämtar hash-koden för det aktuella [SortKey](./)-objektet. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Konverterar det aktuella objektet till dess strängrepresentation. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementerar C# typeof([System.Object](../../system/object/))-konstruktion. |
| void [Unlock](../../system/object/unlock/)() | Implementerar C# lock()-satsens upplåsning. Anropa direkt eller använd [LockContext](../../system/lockcontext/)-sentinelobjektet. |
