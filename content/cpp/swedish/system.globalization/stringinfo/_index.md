...
description: "Splitter för att iterera genom strängdelar. Objekt av denna klass bör endast allokeras med System::MakeObject()-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kan leda till körfel och/eller påståendefel. Omslut alltid denna klass i en System::SmartPtr-pekare och använd denna pekare för att skicka den till funktioner som argument."
type: docs
weight: 313
url: /sv/system.globalization/stringinfo/
---
## StringInfo klass

Splitter för att iterera genom strängdelar. Objekt av denna klass bör endast allokeras med [System::MakeObject()](../../system/makeobject/)-funktionen. Skapa aldrig en instans av denna typ på stacken eller med operator new, eftersom det kommer att resultera i körfel och/eller påståendefel. Omslut alltid denna klass i en [System::SmartPtr](../../system/smartptr/)-pekare och använd denna pekare för att skicka den till funktioner som argument.
...
| int [get_LengthInTextElements](./get_lengthintextelements/)() const | Hämtar antalet textelement i [StringInfo](./)-objektet. |
| [String](../../system/string/) [get_String](./get_string/)() const | Hämtar värdet på [StringInfo](./)-objektet. |
...
| static [String](../../system/string/) [GetNextTextElement](./getnexttextelement/)(const [String](../../system/string/)\&) | Hämtar första elementet i den angivna strängen. |
| static [String](../../system/string/) [GetNextTextElement](./getnexttextelement/)(const [String](../../system/string/)\&, int) | Hämtar elementet på det angivna indexet i den angivna strängen. |
| static [SharedPtr](../../system/sharedptr/)\<[TextElementEnumerator](../textelementenumerator/)\> [GetTextElementEnumerator](./gettextelementenumerator/)(const [String](../../system/string/)\&) | Skapar enumerator för att iterera genom strängens tecken. |
| static [SharedPtr](../../system/sharedptr/)\<[TextElementEnumerator](../textelementenumerator/)\> [GetTextElementEnumerator](./gettextelementenumerator/)(const [String](../../system/string/)\&, int) | Skapar enumerator för att iterera genom strängens tecken med start vid det angivna indexet. |
...
| static [ArrayPtr](../../system/arrayptr/)\<int\> [ParseCombiningCharacters](./parsecombiningcharacters/)(const [String](../../system/string/)\&) | Hämtar index för bastecken, höga surrogat och kontrolltecken. |
...
| void [set_String](./set_string/)(const [String](../../system/string/)\&) | Sätter värdet på [StringInfo](./)-objektet. |
...
| [String](../../system/string/) [SubstringByTextElements](./substringbytextelements/)(int) const | Hämtar delsträng av textelement från det angivna textelementet till det sista textelementet. |
| [String](../../system/string/) [SubstringByTextElements](./substringbytextelements/)(int, int) const | Hämtar delsträng av textelement från det angivna textelementet genom det angivna antalet textelement. |
