...
description: Hämtar veckodag för den angivna tidpunkten.
type: docs
weight: 118
url: /sv/system.globalitation/koreancalendar/getdayofweek/
---
## KoreanCalendar::GetDayOfWeek(DateTime) const metod
