...
description: Skapar DateTime-objekt från komponenter.
type: docs
weight: 183
url: /sv/system.globalization/hebrewcalendar/todatetime/
---
## HebrewCalendar::ToDateTime(int, int, int, int, int, int, int, int) const metod
...
| minute | int | Minut. |
| second | int | Sekund. |
| millisecond | int | Millisekund. |
| era | int | Era. |

### Returvärde

[DateTime](../../../system/datetime/)-objekt som har angivna komponenter.

## HebrewCalendar::ToDateTime(int, int, int, int, int, int, int) const metod
