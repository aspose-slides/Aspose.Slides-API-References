...
description: Kontrollerar om dagen är en skottdag.
type: docs
weight: 170
url: /sv/system.globalization/hebrewcalendar/isleapday/
---
## HebrewCalendar::IsLeapDay(int, int, int, int) const metod


Kontrollerar om dagen är en skottdag.
...
Sant om angivet datum är ett skottår, annars falskt.

## HebrewCalendar::IsLeapDay(int, int, int) const metod
