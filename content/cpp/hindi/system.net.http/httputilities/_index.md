...
description: उपयोगी विधियों को शामिल करता है।
type: docs
weight: 131
url: /hi/system.net.http/httputilities/
---
## HttpUtilities क्लास

उपयोगी विधियों को शामिल करता है।
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचें कि ऑब्जेक्ट लक्ष्य प्रकार द्वारा वर्णित प्रकार का उदाहरण है या नहीं। C# 'is' ऑपरेटर का अनुरूप। |
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | जाँचता है कि निर्दिष्ट URI HTTP URI है या नहीं। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n-वें टेम्पलेट आर्ग्युमेंट को वीक पॉइंटर सेट करता है (साझा के बजाय)। कंटेनरों में पॉइंटर्स को वीक मोड में बदलने की अनुमति देता है। |
...
| फ़ील्ड | विवरण |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | रिक्वेस्ट भेजने के लिए डिफ़ॉल्ट HTTP संस्करण। |
| static [DefaultResponseVersion](./defaultresponseversion/) | रेस्पॉन्स प्राप्त करने के लिए डिफ़ॉल्ट HTTP संस्करण। |
