...
description: XML Schema से simpleContent तत्व को दर्शाता है जैसा कि World Wide Web Consortium (W3C) द्वारा निर्दिष्ट किया गया है। यह क्लास सरल और जटिल प्रकारों के लिए सरल कंटेंट मॉडल के साथ है।
type: docs
weight: 794
url: /hi/system.xml.schema/xmlschemasimplecontent/
---
## XmlSchemaSimpleContent क्लास

Represents the **simpleContent** element from XML [Schema](../) as specified by the World Wide [Web](../../system.web/) Consortium (W3C). This क्लास is for simple and complex types with simple content model.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) या [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/) में से एक लौटाता है। |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | स्ट्रिंग आईडी लौटाता है। |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | **schema** तत्व की ओर संकेत करने वाली फ़ाइल में लाइन संख्या लौटाता है। |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | **schema** तत्व की ओर संकेत करने वाली फ़ाइल में लाइन स्थिति लौटाता है। |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | वर्तमान schema के टार्गेट नेमस्पेस से संबंधित नहीं होने वाले योग्य एट्रीब्यूट्स लौटाता है। |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) या [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/) में से एक लौटाता है। |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | स्ट्रिंग आईडी सेट करता है। |
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | **schema** तत्व की ओर संकेत करने वाली फ़ाइल में लाइन संख्या सेट करता है। |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | **schema** तत्व की ओर संकेत करने वाली फ़ाइल में लाइन स्थिति सेट करता है। |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | वर्तमान schema के टार्गेट नेमस्पेस से संबंधित नहीं होने वाले योग्य एट्रीब्यूट्स सेट करता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्यूमेंट को वीक पॉइंटर (शेयर नहीं) सेट करता है। कंटेनर में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
