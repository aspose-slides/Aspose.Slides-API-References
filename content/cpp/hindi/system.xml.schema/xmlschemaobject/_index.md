...
description: Xml स्कीमा ऑब्जेक्ट मॉडल पदानुक्रम के लिए मूल क्लास का प्रतिनिधित्व करता है और XmlSchema क्लास जैसी क्लासों के लिए बेस क्लास के रूप में कार्य करता है।
type: docs
weight: 677
url: /hi/system.xml.schema/xmlschemaobject/
---
## XmlSchemaObject क्लास


Represents the root class for the [Xml](../../system.xml/) schema object model hierarchy and serves as a base class for classes such as the [XmlSchema](../xmlschema/) क्लास.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी वैल्यू के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी वैल्यू के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| **int32_t** [get_LineNumber](./get_linenumber/)() | फ़ाइल में उस पंक्ति संख्या को लौटाता है जिसका **schema** तत्व संदर्भित करता है। |
| **int32_t** [get_LinePosition](./get_lineposition/)() | फ़ाइल में उस पंक्ति स्थिति को लौटाता है जिसका **schema** तत्व संदर्भित करता है। |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](./get_namespaces/)() | इस schema ऑब्जेक्ट के साथ उपयोग करने के लिए XmlSerializerNamespaces लौटाता है। |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\> [get_Parent](./get_parent/)() | इस [XmlSchemaObject](./) का पैरेंट लौटाता है। |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | स्कीमा को लोड करने वाली फ़ाइल का स्रोत स्थान लौटाता है। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँच करता है कि ऑब्जेक्ट targetType द्वारा वर्णित टाइप का इंस्टेंस है या नहीं। C# 'is' ऑपरेटर का समकक्ष। |
...
| void [set_LineNumber](./set_linenumber/)(**int32_t**) | फ़ाइल में उस पंक्ति संख्या को सेट करता है जिसका **schema** तत्व संदर्भित करता है। |
| void [set_LinePosition](./set_lineposition/)(**int32_t**) | फ़ाइल में उस पंक्ति स्थिति को सेट करता है जिसका **schema** तत्व संदर्भित करता है। |
| void [set_Namespaces](./set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | इस schema ऑब्जेक्ट के साथ उपयोग करने के लिए XmlSerializerNamespaces सेट करता है। |
| void [set_Parent](./set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\>\&) | इस [XmlSchemaObject](./) का पैरेंट सेट करता है। |
| void [set_SourceUri](./set_sourceuri/)(const [String](../../system/string/)\&) | स्कीमा को लोड करने वाली फ़ाइल का स्रोत स्थान सेट करता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्युमेंट को एक वीक पॉइंटर (शेयर्ड के बजाय) सेट करता है। कंटेनर्स में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
...
|  [XmlSchemaObject](./xmlschemaobject/)() | [XmlSchemaObject](./) क्लास का नया इंस्टेंस इनिशियलाइज़ करता है। |
