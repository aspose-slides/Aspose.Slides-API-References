...
description: XmlSchemaDatatype क्लास XML स्कीमा परिभाषा भाषा (XSD) प्रकारों को रनटाइम प्रकारों में मैप करने के लिए एक सारभूत क्लास है।
type: docs
weight: 339
url: /hi/system.xml.schema/xmlschemadatatype/
---
## XmlSchemaDatatype क्लास

यह [XmlSchemaDatatype](./) क्लास XML [Schema](../) परिभाषा भाषा (XSD) प्रकारों को रनटाइम प्रकार में मैप करने के लिए एक सारभूत क्लास है।
...
| विधि | विवरण |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ChangeType](./changetype/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, const [TypeInfo](../../system/typeinfo/)\&) | निर्दिष्ट मान को परिवर्तित करता है, जिसका प्रकार [XmlSchemaDatatype](./) द्वारा प्रदर्शित XML स्कीमा प्रकार के मान्य प्रतिनिधित्वों में से एक है, निर्दिष्ट रन-टाइम प्रकार में। |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ChangeType](./changetype/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, const [TypeInfo](../../system/typeinfo/)\&, [SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>) | निर्दिष्ट मान को परिवर्तित करता है, जिसका प्रकार [XmlSchemaDatatype](./) द्वारा प्रदर्शित XML स्कीमा प्रकार के मान्य प्रतिनिधित्वों में से एक है, निर्दिष्ट रन-टाइम प्रकार में, यदि [XmlSchemaDatatype](./) **xs:QName** प्रकार या उससे व्युत्पन्न प्रकार का प्रतिनिधित्व करता है तो [IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/) का उपयोग किया जाता है। |
...
| virtual [XmlTokenizedType](../../system.xml/xmltokenizedtype/) [get_TokenizedType](./get_tokenizedtype/)() | जब एक व्युत्पन्न क्लास में ओवरराइड किया जाता है, तो World Wide [Web](../../system.web/) Consortium (W3C) XML 1.0 विनिर्देशन में निर्दिष्ट **string** के प्रकार को प्राप्त करता है। |
| virtual [XmlTypeCode](../xmltypecode/) [get_TypeCode](./get_typecode/)() | सरल प्रकार के लिए XmlTypeCode मान को वापस देता है। |
| virtual [TypeInfo](../../system/typeinfo/) [get_ValueType](./get_valuetype/)() | जब एक व्युत्पन्न क्लास में ओवरराइड किया जाता है, तो आइटम के प्रकार को प्राप्त करता है। |
| virtual [XmlSchemaDatatypeVariety](../xmlschemadatatypevariety/) [get_Variety](./get_variety/)() | सरल प्रकार के लिए XmlSchemaDatatypeVariety मान को वापस देता है। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँच करता है कि ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का एक इंस्टेंस दर्शाता है या नहीं। C# 'is' ऑपरेटर का समकक्ष। |
| virtual **bool** [IsDerivedFrom](./isderivedfrom/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaDatatype](./)\>) | यह मेथड हमेशा **false** लौटाता है। |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ParseValue](./parsevalue/)([String](../../system/string/), [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>, [SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>) | जब एक व्युत्पन्न क्लास में ओवरराइड किया जाता है, तो निर्दिष्ट **string** को बिल्ट-इन या उपयोगकर्ता-निर्धारित सरल प्रकार के विरुद्ध मान्य करता है। |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | रेफ़रेंस की तुलना मान प्रकार के ऑब्जेक्ट की nullptr से करती है। |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) का विशेषीकरण, जहाँ स्ट्रिंग और nullptr की स्थिति है। |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) का विशेषीकरण, जहाँ स्ट्रिंग्स की स्थिति है। |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्दिष्ट मान से साझा रेफ़रेंस काउंटर को घटाता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nth टेम्पलेट आर्ग्युमेंट को एक वीक पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | साझा रेफ़रेंस काउंटर को घटाता है और मान को लौटाता है। सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
