...
description: एक मान्य किए गए XML नोड के पोस्ट-स्कीमा-वैलिडेशन इनफ़ोसेट को परिभाषित करता है।
type: docs
weight: 40
url: /hi/system.xml.schema/ixmlschemainfo/
---
## IXmlSchemaInfo क्लास

एक मान्य किए गए XML नोड का पोस्ट-स्कीमा-वैलिडेशन इनफ़ोसेट परिभाषित करता है।
...
| virtual **bool** [get_IsDefault](./get_isdefault/)() | एक मान लौटाता है जो दर्शाता है कि यह मान्य किया गया XML नोड XML [Schema](../) डिफिनिशन लैंग्वेज (XSD) स्कीमा वैलिडेशन के दौरान डिफ़ॉल्ट लागू होने के परिणामस्वरूप सेट किया गया था या नहीं। |
| virtual **bool** [get_IsNil](./get_isnil/)() | एक मान लौटाता है जो दर्शाता है कि इस मान्य किए गए XML नोड का मान **nil** है या नहीं। |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | इस मान्य किए गए XML नोड के लिए डायनेमिक स्कीमा टाइप लौटाता है। |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | इस मान्य किए गए XML नोड से संबंधित कंपाइल्ड [XmlSchemaAttribute](../xmlschemaattribute/) लौटाता है। |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | इस मान्य किए गए XML नोड से संबंधित कंपाइल्ड [XmlSchemaElement](../xmlschemaelement/) लौटाता है। |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | इस मान्य किए गए XML नोड का स्थैतिक XML [Schema](../) डिफिनिशन लैंग्वेज (XSD) स्कीमा टाइप लौटाता है। |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | इस मान्य किए गए XML नोड का XmlSchemaValidity मान लौटाता है। |
...
| void [Lock](../../system/object/lock/)() | C# lock() स्टेटमेंट की लॉकिंग को लागू करता है। सीधा कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट का उपयोग करें। |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) मेथड का समान रूप। कस्टम टाइप्स को क्लोन करने में सक्षम बनाता है। |
|  [Object](../../system/object/object/)() | ऑब्जेक्ट बनाता है। सभी आंतरिक डेटा स्ट्रक्चर को इनिशियलाइज़ करता है। |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कंस्ट्रक्टर्स। वास्तव में कुछ भी कॉपी नहीं करता, बस नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ की कॉपी कंस्ट्रक्शन को सक्षम बनाता है। |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) का स्पेशलाइजेशन स्ट्रिंग और nullptr के केस के लिए। |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) का स्पेशलाइजेशन स्ट्रिंग्स के केस के लिए। |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्दिष्ट मान द्वारा साझा रेफ़रेंस काउंट को घटाता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्यूमेंट को वीक पॉइंटर (शेयर किए गए के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
