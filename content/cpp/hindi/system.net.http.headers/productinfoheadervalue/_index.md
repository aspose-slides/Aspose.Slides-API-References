...
description: "'User-Agent' हेडर के मान में एक उत्पाद या टिप्पणी का प्रतिनिधित्व करता है। इस क्लास के ऑब्जेक्ट्स को केवल System::MakeObject() फ़ंक्शन का उपयोग करके ही आवंटित किया जाना चाहिए। इस प्रकार का उदाहरण स्टैक पर या operator new का उपयोग करके कभी नहीं बनाएँ, क्योंकि इससे रनटाइम त्रुटियाँ और/या अभिकथन त्रुटियाँ उत्पन्न हो सकती हैं। हमेशा इस क्लास को System::SmartPtr पॉइंटर में लपेटें और इस पॉइंटर को फ़ंक्शन में तर्क के रूप में पास करें।"
type: docs
weight: 222
url: /hi/system.net.http.headers/productinfoheadervalue/
---
## ProductInfoHeaderValue क्लास
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली का फ़्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को समान माना जाता है, भले ही IEC 60559:1989 के अनुसार NaN किसी भी मान, जिसमें NaN स्वयं भी शामिल है, के बराबर नहीं है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली का फ़्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को समान माना जाता है, भले ही IEC 60559:1989 के अनुसार NaN किसी भी मान, जिसमें NaN स्वयं भी शामिल है, के बराबर नहीं है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| [String](../../system/string/) [get_Comment](./get_comment/)() | एक टिप्पणी लौटाता है। |
| [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](../productheadervalue/)\> [get_Product](./get_product/)() | एक उत्पाद लौटाता है। |
...
| static **int32_t** [GetProductInfoLength](./getproductinfolength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ProductInfoHeaderValue](./)\>\&) | दिए गए स्ट्रिंग को निर्दिष्ट इंडेक्स से [ProductInfoHeaderValue](./) क्लास की एक इंस्टेंस में बदलता है। |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[ProductInfoHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | दिए गए स्ट्रिंग को [ProductInfoHeaderValue](./) क्लास की एक इंस्टेंस में बदलता है। |
|  [ProductInfoHeaderValue](./productinfoheadervalue/)([String](../../system/string/), [String](../../system/string/)) | नई इंस्टेंस बनाता है। |
|  [ProductInfoHeaderValue](./productinfoheadervalue/)([System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](../productheadervalue/)\>) | नई इंस्टेंस बनाता है। |
|  [ProductInfoHeaderValue](./productinfoheadervalue/)([String](../../system/string/)) | नई इंस्टेंस बनाता है। |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | स्ट्रिंग और नल पॉइंटर के केस के लिए [Object::ReferenceEquals](../../system/object/referenceequals/) का विशेषीकरण। |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ProductInfoHeaderValue](./)\>\&) | दिए गए स्ट्रिंग को [ProductInfoHeaderValue](./) क्लास की एक इंस्टेंस में बदलने का प्रयास करता है। |
