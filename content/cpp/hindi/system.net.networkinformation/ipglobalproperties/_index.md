...
description: "स्थानीय कंप्यूटर के नेटवर्क कनेक्शन के बारे में जानकारी दर्शाता है। इस क्लास की वस्तुओं को केवल System::MakeObject() फ़ंक्शन का उपयोग करके ही आवंटित किया जाना चाहिए। इस प्रकार का इंस्टेंस स्टैक पर या operator new का उपयोग करके कभी न बनाएँ, क्योंकि इससे रनटाइम त्रुटियाँ और/या असर्शन दोष उत्पन्न हो सकते हैं। हमेशा इस क्लास को System::SmartPtr पॉइंटर में लपेटें और इस पॉइंटर का उपयोग फ़ंक्शन को तर्क के रूप में पास करने के लिए करें।"
type: docs
weight: 14
url: /hi/system.net.networkinformation/ipglobalproperties/
---
## IPGlobalProperties क्लास

स्थानीय कंप्यूटर के नेटवर्क कनेक्शन के बारे में जानकारी दर्शाता है। इस क्लास की वस्तुओं को केवल [System::MakeObject()](../../system/makeobject/) फ़ंक्शन का उपयोग करके ही आवंटित किया जाना चाहिए। कभी भी इस प्रकार का इंस्टेंस स्टैक पर या operator new का उपयोग करके न बनाएं, क्योंकि इससे रनटाइम त्रुटियाँ और/या असर्शन त्रुटियां उत्पन्न होंगी। हमें इस क्लास को हमेशा [System::SmartPtr](../../system/smartptr/) पॉइंटर में लपेटना चाहिए और इस पॉइंटर का उपयोग फ़ंक्शन के तर्क के रूप में पास करना चाहिए।
...
| virtual [String](../../system/string/) [get_DomainName](./get_domainname/)() | स्थानीय कंप्यूटर के पंजीकृत डोमेन को लौटाता है। |
| virtual [String](../../system/string/) [get_HostName](./get_hostname/)() | स्थानीय कंप्यूटर का होस्ट नाम लौटाता है। |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[IPGlobalProperties](./)\> [GetIPGlobalProperties](./getipglobalproperties/)() | एक नया इंस्टेंस बनाता है। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि क्या वस्तु targetType द्वारा वर्णित प्रकार का एक इंस्टेंस है। C# 'is' ऑपरेटर का समानांतर। |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कॉन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लास की कॉपी कॉन्स्ट्रक्शन को सक्षम करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट तर्क को एक कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनर में पॉइंटर्स को कमजोर मोड में स्विच करने की अनुमति देता है। |
...
* नेमस्पेस [System::Net::NetworkInformation](../)
