...
description: एक अपवाद जो तब फेंका जाता है जब एक या अधिक सर्कुलर रेफ़रेंसेज़ का पता चलता है जहाँ कोई फ़ॉर्मूला अपनी स्वयं की सेल को सीधे या परोक्ष रूप से संदर्भित करता है।
type: docs
weight: 1
url: /hi/aspose.slides.spreadsheet/details_cellcircularreferenceexception/
---
## Details_CellCircularReferenceException क्लास
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | एक सर्कुलर सेल रेफ़रेंस प्राप्त करता है। |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | सबसे अंदरूनी एक्सेप्शन का प्रतिनिधित्व करने वाले Exception ऑब्जेक्ट की कॉपी लौटाता है। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचिए कि ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का उदाहरण दर्शाता है या नहीं। C# 'is' ऑपरेटर का समान रूप। |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | HRESULT सेट करता है, जो एक कोडेड संख्यात्मक मान है जिसे विशिष्ट एक्सेप्शन को सौंपा जाता है। |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() स्टेटमेंट अनलॉकर को लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट का उपयोग करें। |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) मेथड को लागू करता है जिसे [ExceptionWrapper](../../system/exceptionwrapper/) क्लास द्वारा कॉल किया जाता है। इस तथ्य के बावजूद कि यह क्लास std::exception से विरासत में नहीं ली गई है, व्युत्पन्न क्लासेस अपने लॉजिक को लागू करने के लिए प्रोटेक्टेड/प्राइवेट मेम्बर का उपयोग कर सकते हैं। इस मेथड की इम्प्लीमेंटेशन को [ExceptionWrapper](../../system/exceptionwrapper/) में ले जाना उस लॉजिक को तोड़ सकता है। |
