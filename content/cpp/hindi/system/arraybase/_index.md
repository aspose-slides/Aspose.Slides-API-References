...
description: System.Array क्लास (सभी ऐरे के लिए एब्स्ट्रैक्ट बेस क्लास) का डमी है और अनुरोध पर कार्यक्षमता जोड़ी जा सकती है।
type: docs
weight: 27
url: /hi/system/arraybase/
---
## ArrayBase क्लास


The dummy for [System.Array](../array/) class (abstract base class for all arrays) May be filled with functionality by request.
...
| मेथड | विवरण |
| --- | --- |
| virtual **bool** [Equals](../object/equals/)([ptr](../object/ptr/)) | C# [Object.Equals](../object/equals/) सेमान्टिक का उपयोग करके ऑब्जेक्ट्स की तुलना करता है। |
...
| virtual **int32_t** [get_Length](./get_length/)() const | ऐरे के सभी आयामों में सभी तत्वों की कुल संख्या दर्शाने वाला 32-बिट पूर्णांक लौटाता है। |
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | ऑब्जेक्ट के साथ जुड़े रेफ़रेंस काउंटर डेटा स्ट्रक्चर को प्राप्त करता है। |
...
| virtual **bool** [Is](../object/is/)(const [TypeInfo](../typeinfo/)\&) const | जाँचता है कि ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का एक इंस्टेंस है या नहीं। C# 'is' ऑपरेटर का समानांतर। |
...
| virtual void * [raw_data_ptr](./raw_data_ptr/)() | सिंगल-डिमेंशन ऐरे के पहले तत्व का पॉइंटर लौटाता है। मल्टी-डिमेंशन ऐरे के लिए परिणाम अपरिभाषित है। |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्यूमेंट को एक वीक पॉइंटर सेट करता है (शेयरड के बजाय)। कंटेनरों में पॉइंटर को वीक मोड में स्विच करने की अनुमति देता है। |
...
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | साझा रेफ़रेंस काउंट को घटाता और लौटाता है। सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
