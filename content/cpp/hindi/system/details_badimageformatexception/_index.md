...
description: "जब डायनामिक लिंक लाइब्रेरी (DLL) या निष्पादन योग्य प्रोग्राम की फ़ाइल इमेज अवैध होती है तो यह अपवादन उत्पन्न किया जाता है। इस वर्ग के उदाहरण को मैन्युअली कभी न बनाएँ। इसके बजाय BadImageFormatException वर्ग का उपयोग करें। BadImageFormatException वर्ग के उदाहरणों को कभी भी System::SmartPtr में न लपेटें।"
type: docs
weight: 378
url: /hi/system/details_badimageformatexception/
---
## Details_BadImageFormatException वर्ग

फ़ाइल इमेज जो डाइनामिक लिंक लाइब्रेरी (DLL) या निष्पादन योग्य प्रोग्राम की हो, अवैध होने पर यह एक्सेप्शन उत्पन्न होता है। इस वर्ग के उदाहरण को मैन्युअली कभी न बनाएं। इसके बजाय BadImageFormatException वर्ग का उपयोग करें। BadImageFormatException वर्ग के उदाहरणों को कभी भी [System::SmartPtr](../smartptr/) में न लपेटें।
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | C# शैली में रेफ़रेंस प्रकार के ऑब्जेक्ट्स की तुलना करता है। |
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | C#-शैली का फ़्लोटिंग पॉइंट तुलना अनुकरण करता है जहाँ दो NaN को समान माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं है, जिसमें NaN भी शामिल है। |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | C#-शैली का फ़्लोटिंग पॉइंट तुलना अनुकरण करता है जहाँ दो NaN को समान माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं है, जिसमें NaN भी शामिल है। |
...
| virtual [String](../string/) [get_FileName](../details_exceptionwithfilename/get_filename/)() const | उस फ़ाइल का नाम प्राप्त करता है जो इस एक्सेप्शन का कारण बनती है। |
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | एक 32-बिट पूर्णांक मान लौटाता है जो वर्तमान ऑब्जेक्ट द्वारा प्रतिनिधित्व किए गए एक्सेप्शन से संबंधित HRESULT कोड है। |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | आंतरिक एक्सेप्शन को दर्शाने वाले ऑब्जेक्ट का संदर्भ लौटाता है। |
| [String](../string/) [get_Message](../details_exceptionwithfilename/get_message/)() const override |  |
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | स्टैक ट्रेस वाले स्ट्रिंग को लौटाता है। |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | आंतरिक-most एक्सेप्शन को दर्शाने वाले Exception ऑब्जेक्ट की कॉपी लौटाता है। |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](../details_systemexception/gettype/)() const override | ऑब्जेक्ट का वास्तविक प्रकार प्राप्त करता है। C# [System.Object.GetType()](../object/gettype/) कॉल का समानांतर। |
| **bool** [Is](../details_systemexception/is/)(const [System::TypeInfo](../typeinfo/)\&) const override |  |
| void [Lock](../object/lock/)() | C# lock() कथन के लॉकिंग को लागू करता है। सीधे कॉल करें या [LockContext](../lockcontext/) सेंट्री ऑब्जेक्ट का उपयोग करें। |
...
|  [Object](../object/object/)([Object](../object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी कन्स्ट्रक्शन को सक्षम करता है। |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी कन्स्ट्रक्शन को सक्षम करता है। |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | HRESULT सेट करता है, एक कोडेड संख्यात्मक मान जो विशिष्ट एक्सेप्शन को सौंपा गया है। |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्युमेंट को वीक पॉइंटर (शेयर किए गए के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
...
| virtual const char * [what](../details_exception/what/)() const | [what()](../details_exception/what/) मेथड को लागू करता है जिसे [ExceptionWrapper](../exceptionwrapper/) वर्ग द्वारा बुलाया जाता है। तथ्य के बावजूद कि यह वर्ग std::exception से विरासत में नहीं मिला है, डेरिव्ड क्लासेस अपने लॉजिक को लागू करने के लिए संरक्षित/निजी सदस्यों का उपयोग कर सकती हैं। इस मेथड कार्यान्वयन को [ExceptionWrapper](../exceptionwrapper/) में ले जाने से वह लॉजिक टूट सकता है। |
| virtual  [~Object](../object/~object/)() | ऑब्जेक्ट को नष्ट करता है। सभी आंतरिक डेटा स्ट्रक्चर को मुक्त करता है। |

## संबंधित देखें

* वर्ग [Details_ExceptionWithFilename](../details_exceptionwithfilename/)
* नेमस्पेस [System](../)
