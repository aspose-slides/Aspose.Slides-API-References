...
description: "जब कोई विधि लागू नहीं की गई हो और एक स्टब के रूप में कार्य करे, तो NotImplementedException फेंका जाता है। इस क्लास की इंस्टेंस को मैन्युअली कभी न बनाएं। इसके बजाय NotImplementedException क्लास का उपयोग करें। NotImplementedException क्लास की इंस्टेंस को System::SmartPtr में कभी न लपेटें।"
type: docs
weight: 573
url: /hi/system/details_notimplementedexception/
---
## Details_NotImplementedException क्लास

NotImplementedException तब फेंका जाता है जब कोई विधि लागू नहीं की गई हो और एक स्टब के रूप में कार्य करती हो। इस क्लास की इंस्टेंस को मैन्युअली कभी न बनाएं। इसके बजाय NotImplementedException क्लास का उपयोग करें। NotImplementedException क्लास की इंस्टेंस को कभी भी [System::SmartPtr](../smartptr/) में न लपेटें।
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN बराबर माने जाते हैं, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के भी नहीं। |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN बराबर माने जाते हैं, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के भी नहीं। |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | वर्तमान ऑब्जेक्ट द्वारा प्रतिनिधित्व किए गए एक्सेप्शन से संबंधित HRESULT कोड वाला 32-बिट पूर्णांक मान लौटाता है। |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | HRESULT सेट करता है, जो एक कोडेड संख्यात्मक मान है और एक विशिष्ट एक्सेप्शन को असाइन किया जाता है। |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | टेम्प्लेट के n'th आर्ग्यूमेंट को एक weak पॉइंटर (shared के बजाय) सेट करता है। कंटेनर में पॉइंटर्स को weak मोड में स्विच करने की अनुमति देता है। |
