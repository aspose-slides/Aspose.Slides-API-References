...
description: "IndexOutOfRangeException तब फेंका जाता है जब संग्रह के एक तत्व तक पहुंच को उसकी सीमा से बाहर के सूचकांक का उपयोग करके किया जाता है। इस क्लास की इंस्टेंसेस को मैन्युअली नहीं बनाना चाहिए। इसके बजाय IndexOutOfRangeException क्लास का उपयोग करें। IndexOutOfRangeException क्लास की इंस्टेंसेस को System::SmartPtr में कभी नहीं लपेटना चाहिए।"
type: docs
weight: 482
url: /hi/system/details_indexoutofrangeexception/
---
## Details_IndexOutOfRangeException क्लास

IndexOutOfRangeException तब फेंका जाता है जब एक संग्रह के तत्व तक पहुंच को उसकी सीमा से बाहर के सूचकांक का उपयोग करके करने का प्रयास किया जाता है। इस क्लास की इंस्टेंसेस को मैन्युअली नहीं बनाएँ। इसके बजाय IndexOutOfRangeException क्लास का उपयोग करें। IndexOutOfRangeException क्लास की इंस्टेंसेस को कभी भी [System::SmartPtr](../smartptr/) में न लपेटें।
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | C#-स्टाइल फ़्लोटिंग-पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को समान माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के बराबर भी नहीं। |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | C#-स्टाइल फ़्लोटिंग-पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को समान माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के बराबर भी नहीं। |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | एक 32-बिट पूर्णांक मान लौटाता है जो वर्तमान ऑब्जेक्ट द्वारा दर्शाए गए एक्सेप्शन से संबंधित HRESULT कोड है। |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | सबसे अंदरूनी एक्सेप्शन को दर्शाने वाले Exception ऑब्जेक्ट की कॉपी लौटाता है। |
...
| void [Lock](../object/lock/)() | C# lock() स्टेटमेंट के लॉकिंग को लागू करता है। सीधे कॉल करें या [LockContext](../lockcontext/) सेंटीनी ऑब्जेक्ट का उपयोग करें। |
...
|  [Object](../object/object/)() | ऑब्जेक्ट बनाता है। सभी आंतरिक डेटा स्ट्रक्चर्स को इनिशियालाइज़ करता है। |
|  [Object](../object/object/)([Object](../object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तविक में कुछ भी कॉपी नहीं करता, बस नया ऑब्जेक्ट इनिशियालाइज़ करता है और सबक्लासेज़ की कॉपी कन्स्ट्रक्शन को सक्षम करता है। |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | असाइनमेंट ऑपरेटर। वास्तविक में कुछ भी कॉपी नहीं करता, बस नया ऑब्जेक्ट इनिशियालाइज़ करता है और सबक्लासेज़ की कॉपी कन्स्ट्रक्शन को सक्षम करता है। |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | HRESULT सेट करता है, जो एक कोडेड संख्यात्मक मान है और किसी विशिष्ट एक्सेप्शन को सौंपा जाता है। |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्यूमेंट को वीक पॉइंटर सेट करता है (शेयरड के बजाय)। कंटेनर में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
...
| void [Unlock](../object/unlock/)() | C# lock() स्टेटमेंट के अनलॉकिंग को लागू करता है। सीधे कॉल करें या [LockContext](../lockcontext/) सेंटीनी ऑब्जेक्ट का उपयोग करें। |
