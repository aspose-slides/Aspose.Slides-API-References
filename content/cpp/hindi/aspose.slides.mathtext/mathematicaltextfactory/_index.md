...
| विधि | विवरण |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)() override | एक खाली गणितीय पाठ तत्व बनाता है |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)(char16_t) override | निर्दिष्ट मान के साथ गणितीय पाठ तत्व बनाता है |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/)) override | निर्दिष्ट मान के साथ एक खाली गणितीय पाठ तत्व बनाता है |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathematicalText](../imathematicaltext/)\> [CreateMathematicalText](./createmathematicaltext/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\>) override | निर्दिष्ट मान और स्वरूपण गुणों के साथ एक खाली गणितीय पाठ तत्व बनाता है |
...
| void [Lock](../../system/object/lock/)() | C# lock() कथन को लागू करता है। प्रत्यक्ष रूप से कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट का उपयोग करें। |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | नल पॉइंटर के साथ मान प्रकार ऑब्जेक्ट की रेफ़रेंस तुलना करता है। |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | साझा रेफ़रेंस काउंटर को घटाता है और उसे लौटाता है। सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() कथन अनलॉकिंग को लागू करता है। प्रत्यक्ष रूप से कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट का उपयोग करें। |
...
* क्लास [IMathematicalTextFactory](../imathematicaltextfactory/)
