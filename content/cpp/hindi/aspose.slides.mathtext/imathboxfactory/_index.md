...
---
## IMathBoxFactory क्लास

एक मैथ बॉक्स बनाने की अनुमति देता है
...
| मेथड | विवरण |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [CreateMathBox](./createmathbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | एक तत्व पर लागू करके गणित बॉक्स बनाता है |
...
| void [Lock](../../system/object/lock/)() | C# lock() स्टेटमेंट लॉक करने को लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट का उपयोग करें। |
