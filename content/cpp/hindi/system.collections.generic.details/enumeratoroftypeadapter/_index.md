...
description: IEnumerable.OfType() एक्सटेंशन मेथड द्वारा उपयोग किया जाने वाला Enumerator।
type: docs
weight: 66
url: /hi/system.collections.generic.details/enumeratoroftypeadapter/
---
## EnumeratorOfTypeAdapter क्लास


IEnumerable.OfType() विस्तार विधि द्वारा उपयोग किया जाने वाला Enumerator।
...
| Result | संग्रह तत्वों का परिणाम प्रकार। |
## Methods

| Method | Description |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | VirtualizedIterator क्लास द्वारा उपयोग किए जाने वाले इटरेटर को तैयार करता है। |
| System::Details::VirtualizedIteratorBase\<Result\> * [CloneIterator](./cloneiterator/)() const override |  |
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](../../system.collections.generic/ienumerator/current/)() const | वर्तमान तत्व को प्राप्त करता है। |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | वर्तमान तत्व को प्राप्त करता है। |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ऑब्जेक्ट के साथ जुड़ी रेफ़रेंस काउंटर डेटा संरचना को प्राप्त करता है। |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | इटरेटर को एक कदम आगे ले जाता है। |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | पहली [MoveNext()](../../system.collections.generic/ienumerator/movenext/) कॉल करता है और VirtualizedIterator द्वारा उपयोग किए जाने वाले एन्‍युमरेटर ऑब्जेक्ट को तैयार करता है। |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | वर्चुअलाइज़्ड इटरेटर द्वारा स्वामित्व वाले एन्‍युमरेटर को चिन्हित करता है। |
...
| **bool** [MoveNext](./movenext/)() override | एन्‍युमरेटर को अगले तत्व पर ले जाता है। यदि पहले कोई तत्व संदर्भित नहीं किया गया था, तो संदर्भ को उपलब्ध पहले तत्व पर सेट करता है। यदि कंटेनर के अंत तक पहुँच गया, तो कुछ नहीं करता। |
...
| void [Reset](./reset/)() override | एन्‍युमरेटर को पहले तत्व से पहले की स्थिति में रीसेट करता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्युमेंट को एक weak पॉइंटर (shared के बजाय) सेट करता है। कंटेनरों में पोइंटर्स को weak मोड में स्विच करने की अनुमति देता है। |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | shared रेफ़रेंस काउंट को घटाता है और 반환 करता है। सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
