...
description: IEnumerable.Cast() एक्सटेंशन मेथड द्वारा उपयोग किया जाने वाला एन्यूमरेटर।
type: docs
weight: 53
url: /hi/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter क्लास

IEnumerable.Cast() विस्तार विधि द्वारा उपयोग किया जाने वाला एन्यूमरेटर।
...
| पैरामीटर | विवरण |
| --- | --- |
| Source | संग्रह तत्वों का स्रोत प्रकार। |
| Result | संग्रह तत्वों का परिणाम स्वरूप प्रकार। |

## मेथड्स

| मेथड | विवरण |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | VirtualizedIterator क्लास द्वारा उपयोग किए जाने वाले इटेरेटर को तैयार करता है। |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | वर्तमान तत्व प्राप्त करता है। |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) मेथड के समकक्ष। कस्टम ऑब्जेक्ट्स का हैशिंग सक्षम करता है। |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | ऑब्जेक्ट का वास्तविक प्रकार प्राप्त करता है। C# [System.Object.GetType()](../../system/object/gettype/) कॉल के समकक्ष। |
|  [IEnumerator](../../system.collections.generic/ienumerator/ienumerator/)() |  |
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | इटेरेटर को एक कदम आगे ले जाता है। |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | पहला [MoveNext()](../../system.collections.generic/ienumerator/movenext/) कॉल करता है और VirtualizedIterator द्वारा उपयोग किए जाने वाले एन्यूमरेटर ऑब्जेक्ट को तैयार करता है। |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | वर्चुअलाइज़्ड इटेरेटर द्वारा स्वामित्व वाले एन्यूमरेटर को चिह्नित करता है। |
...
| **bool** [MoveNext](./movenext/)() override | एन्यूमरेटर को अगले तत्व पर ले जाता है। यदि पहले कोई तत्व संदर्भित नहीं था, तो उपलब्ध पहले तत्व का रेफ़रेंस सेट करता है। यदि कंटेनर की समाप्ति तक पहुँचा गया, तो कुछ नहीं करता। |
|  [Object](../../system/object/object/)() | ऑब्जेक्ट बनाता है। सभी आंतरिक डेटा संरचनाओं को आरम्भ करता है। |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ नहीं कॉपी करता, बस नया ऑब्जेक्ट आरम्भ करता है और सबक्लास की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तविकता में कुछ नहीं कॉपी करता, बस नया ऑब्जेक्ट आरम्भ करता है और सबक्लास की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
...
| void [Reset](./reset/)() override | एन्यूमरेटर को पहले तत्व से पहले की स्थिति पर रीसेट करता है। |
