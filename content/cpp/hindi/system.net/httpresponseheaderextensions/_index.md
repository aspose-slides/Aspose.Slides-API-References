...
description: HttpResponseHeader enumeration मानों के साथ काम करने के लिए उपयोगी मेथड्स शामिल करता है।
type: docs
weight: 235
url: /hi/system.net/httpresponseheaderextensions/
---
## HttpResponseHeaderExtensions वर्ग

HttpResponseHeader enumeration मानों के साथ काम करने के लिए उपयोगी मेथड्स शामिल करता है।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलन को अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलन को अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
...
| static [String](../../system/string/) [GetName](./getname/)([HttpResponseHeader](../httpresponseheader/)) | निर्दिष्ट हेडर का नाम लौटाता है। |
...
|  [HttpResponseHeaderExtensions](./httpresponseheaderextensions/)() | हटाया गया डिफ़ॉल्ट कन्स्ट्रक्टर। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्गुमेंट को एक weak पॉइंटर सेट करता है (shared के बजाय)। कंटेनरों में पॉइंटर्स को weak मोड में स्विच करने की अनुमति देता है। |
