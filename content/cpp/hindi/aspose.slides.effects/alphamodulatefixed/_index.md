...
description: एक Alpha Modulate Fixed प्रभाव का प्रतिनिधित्व करता है। प्रभाव अल्फा (अपारदर्शिता) मान को एक निश्चित प्रतिशत से गुणा किया जाता है।
type: docs
weight: 66
url: /hi/aspose.slides.effects/alphamodulatefixed/
---
## AlphaModulateFixed वर्ग

Alpha Modulate Fixed प्रभाव का प्रतिनिधित्व करता है। प्रभाव अल्फा (अपारदर्शिता) मान को एक निश्चित प्रतिशत से गुणा किया जाता है।
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | निर्धारित करता है कि निर्दिष्ट [AlphaModulateFixed](./) वर्तमान [AlphaModulateFixed](./) के बराबर है या नहीं। |
...
| **float** [get_Amount](./get_amount/)() override | प्रभाव की मात्रा प्रतिशत में लौटाता है। पढ़ें **float**। |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | पैरेंट [IPresentationComponent](../../aspose.slides/ipresentationcomponent/) लौटाता है। केवल-रीड [IPresentationComponent](../../aspose.slides/ipresentationcomponent/)। |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | विरासिता लागू करके प्रभावी Alpha Modulate Fixed प्रभाव डेटा प्राप्त करता है। |
...
| void [set_Amount](./set_amount/)(**float**) override | प्रभाव की मात्रा प्रतिशत में लौटाता है। लिखें **float**। |
...
* क्लास [IAlphaModulateFixed](../ialphamodulatefixed/)
