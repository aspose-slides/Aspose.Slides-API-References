...
| मेथड | विवरण |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | निर्धारित करता है कि निर्दिष्ट [PresetShadow](./) वर्तमान [PresetShadow](./) के बराबर है या नहीं। |
...
| **float** [get_Direction](./get_direction/)() override | छाया की दिशा। **float** पढ़ें। |
| **double** [get_Distance](./get_distance/)() override | छाया की दूरी। **double** पढ़ें। |
...
| [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() override | प्रीसेट। [PresetShadowType](../../aspose.slides/presetshadowtype/) पढ़ें। |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadowEffectiveData](../ipresetshadoweffectivedata/)\> [GetEffective](./geteffective/)() override | विरासत लागू किए साथ प्रभावी Preset Shadow प्रभाव डेटा प्राप्त करता है। |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ नहीं कॉपी करता, बस नया ऑब्जेक्ट आरंभ करता है और सबक्लास की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
...
| void [set_Direction](./set_direction/)(**float**) override | छाया की दिशा। **float** लिखें। |
| void [set_Distance](./set_distance/)(**double**) override | छाया की दूरी। **double** लिखें। |
| void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) override | प्रीसेट। [PresetShadowType](../../aspose.slides/presetshadowtype/) लिखें। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट तर्क को एक कमजोर पॉइंटर (शेयर्ड के बजाय) सेट करता है। कंटेनरों में पॉइंटर को कमजोर मोड में बदलने की अनुमति देता है। |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) मेथड का समान। कस्टम ऑब्जेक्ट को स्ट्रिंग में परिवर्तन सक्षम करता है। |
...
* क्लास [IPresetShadow](../ipresetshadow/)
