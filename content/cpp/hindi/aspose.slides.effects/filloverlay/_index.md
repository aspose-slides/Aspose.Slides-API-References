...
description: एक Fill Overlay प्रभाव का प्रतिनिधित्व करता है। एक Fill Overlay का उपयोग किसी ऑब्जेक्ट के लिए अतिरिक्त फ़िल निर्दिष्ट करने और दो फ़िल को साथ मिलाकर उपयोग किया जा सकता है।
type: docs
weight: 183
...
एक Fill Overlay प्रभाव का प्रतिनिधित्व करता है। एक Fill Overlay का उपयोग किसी ऑब्जेक्ट के लिए अतिरिक्त Fill निर्दिष्ट करने और दो Fill को साथ मिश्रित करने के लिए किया जा सकता है।
...
| विधि | विवरण |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | निर्धारित करता है कि निर्दिष्ट [FillOverlay](./) वर्तमान [FillOverlay](./) के बराबर है या नहीं। |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली के फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN स्वयं भी शामिल है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली के फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN स्वयं भी शामिल है। |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Fill format. केवल पढ़ने योग्य [IFillFormat](../../aspose.slides/ifillformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlayEffectiveData](../ifilloverlayeffectivedata/)\> [GetEffective](./geteffective/)() override | विरासत लागू होने के साथ प्रभावी Fill Overlay प्रभाव डेटा प्राप्त करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्यूमेंट को एक कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर को कमजोर मोड में बदलने की अनुमति देता है। |
...
* क्लास [IFillOverlay](../ifilloverlay/)
