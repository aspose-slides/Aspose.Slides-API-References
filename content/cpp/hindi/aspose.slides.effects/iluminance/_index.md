...
description: एक Luminance प्रभाव का प्रतिनिधित्व करता है। ब्राइटनेस रैखिक रूप से सभी रंगों को सफेद या काली की ओर शिफ्ट करती है। कंट्रास्ट सभी रंगों को या तो नज़दीक या दूर ले जाकर स्केल करता है।
type: docs
weight: 794
...
एक [Luminance](../luminance/) इफ़ेक्ट का प्रतिनिधित्व करता है। ब्राइटनेस रैखिक रूप से सभी रंगों को सफ़ेद या काली की ओर शिफ्ट करती है। कंट्रास्ट सभी रंगों को या तो नज़दीक या दूर ले जाकर स्केल करता है।
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | विरासत लागू होने के बाद प्रभावी डेटा प्राप्त करता है। |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) का विशेष संस्करण स्ट्रिंग और nullptr के मामले के लिए। |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) का विशेष संस्करण स्ट्रिंग्स के मामले के लिए। |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्दिष्ट मान द्वारा साझा रेफ़रेंस काउंट को घटाता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्युमेंट को वीक पॉइंटर (शेयर किए गए के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
...
| virtual  [~Object](../../system/object/~object/)() | ऑब्जेक्ट नष्ट करता है। सभी आंतरिक डेटा संरचनाओं को फ्री करता है। |
