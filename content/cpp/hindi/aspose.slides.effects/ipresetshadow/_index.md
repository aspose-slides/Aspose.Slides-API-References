...
| virtual **float** [get_Direction](./get_direction/)() | छाया की दिशा। पढ़ें **float**। |
| virtual **double** [get_Distance](./get_distance/)() | छाया की दूरी। पढ़ें **double**। |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | प्रीसेट। पढ़ें [PresetShadowType](../../aspose.slides/presetshadowtype/)। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | छाया का रंग। केवल-पढ़ने योग्य [IColorFormat](../../aspose.slides/icolorformat/)। |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) मेथड का समान। कस्टम ऑब्जेक्ट्स का हैश बनाना सक्षम करता है। |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्दिष्ट मान द्वारा शेयरड रेफ़रेंस काउंटर को घटाता है। |
| virtual void [set_Direction](./set_direction/)(**float**) | छाया की दिशा। लिखें **float**। |
| virtual void [set_Distance](./set_distance/)(**double**) | छाया की दूरी। लिखें **double**। |
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | प्रीसेट। लिखें [PresetShadowType](../../aspose.slides/presetshadowtype/)। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्गुमेंट को एक वीक पॉइंटर (शेयरड के बजाय) सेट करें। कंटेनरों में पॉइंटर्स को वीक मोड में बदलने की अनुमति देता है। |
| int [SharedCount](../../system/object/sharedcount/)() const | शेयरड रेफ़रेंस काउंटर का वर्तमान मान प्राप्त करता है। |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | शेयरड रेफ़रेंस काउंट को बढ़ाता है। सीधे कॉल नहीं करना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | शेयरड रेफ़रेंस काउंट को घटाता है और लौटाता है। सीधे कॉल नहीं करना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
