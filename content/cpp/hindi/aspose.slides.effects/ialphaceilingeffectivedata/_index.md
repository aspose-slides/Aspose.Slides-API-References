...
description: एक अपरिवर्तनीय ऑब्जेक्ट जो Alpha Ceiling प्रभाव का प्रतिनिधित्व करता है। Alpha (opacity) शून्य से बड़े मानों को 100% में बदल दिया जाता है। दूसरे शब्दों में, आंशिक रूप से अपारदर्शी कोई भी वस्तु पूरी तरह अपारदर्शी बन जाती है।
type: docs
weight: 274
url: /hi/aspose.slides.effects/ialphaceilingeffectivedata/
---
## IAlphaCeilingEffectiveData क्लास

एक अपरिवर्तनीय ऑब्जेक्ट जो Alpha Ceiling प्रभाव का प्रतिनिधित्व करता है। Alpha (opacity) शून्य से बड़े मानों को 100% में बदल दिया जाता है। दूसरे शब्दों में, आंशिक रूप से अपारदर्शी कोई भी वस्तु पूरी तरह अपारदर्शी बन जाती है।

```cpp
class IAlphaCeilingEffectiveData : public virtual Aspose::Slides::Effects::IEffectEffectiveData
```
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्युमेंट को एक विकरु पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर को विकरु मोड में स्विच करने की अनुमति देता है। |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | विकरु रेफ़रेंस काउंट को बढ़ाता है। सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | विकरु रेफ़रेंस काउंट को घटाता है। सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
