...
description: एक अपरिवर्तनीय ऑब्जेक्ट जो कलर रिप्लेसमेंट इफ़ेक्ट का प्रतिनिधित्व करता है। सभी इफ़ेक्ट रंगों को एक निश्चित रंग में बदल दिया जाता है। अल्फा मान अपरिवर्तित रहते हैं।
type: docs
weight: 547
url: /hi/aspose.slides.effects/icolorreplaceeffectivedata/
---
## IColorReplaceEffectiveData क्लास

एक अपरिवर्तनीय ऑब्जेक्ट जो कलर रिप्लेसमेंट इफ़ेक्ट का प्रतिनिधित्व करता है। सभी इफ़ेक्ट रंगों को एक निश्चित रंग में बदल दिया जाता है। अल्फा मान अपरिवर्तित रहते हैं।
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | हर पिक्सेल के रंग को बदलने वाला कलर फ़ॉर्मेट लौटाता है। केवल-पढ़ने योग्य [System::Drawing::Color](../../system.drawing/color/)। |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ऑब्जेक्ट से जुड़े रेफ़रेंस काउंटर डेटा स्ट्रक्चर को प्राप्त करता है। |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) मेथड का समकक्ष। कस्टम ऑब्जेक्ट्स का हैश बनाना संभव करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्गुमेंट को एक weak पॉइंटर (shared के बजाय) सेट करता है। कंटेनरों में पॉइंटर को weak मोड में स्विच करने की सुविधा देता है। |
