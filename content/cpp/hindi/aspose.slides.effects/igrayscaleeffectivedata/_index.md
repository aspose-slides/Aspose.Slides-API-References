...
description: अपरिवर्तनीय ऑब्जेक्ट जो ग्रे स्केल प्रभाव का प्रतिनिधित्व करता है। सभी प्रभाव रंग मानों को उनकी चमक के अनुसार ग्रे की एक छटा में परिवर्तित करता है। प्रभाव का अल्फा (अपारदर्शिता) मान अछूता रहता है।
type: docs
weight: 677
url: /hi/aspose.slides.effects/igrayscaleeffectivedata/
---
## IGrayScaleEffectiveData कक्षा

एक अपरिवर्तनीय ऑब्जेक्ट जो ग्रे स्केल प्रभाव का प्रतिनिधित्व करता है। सभी प्रभाव रंग मानों को उनकी चमक के अनुसार ग्रे की एक छटा में परिवर्तित करता है। प्रभाव का अल्फा (अपारदर्शिता) मान अछूता रहता है।
...
| void [Lock](../../system/object/lock/)() | C# lock() स्टेटमेंट की लॉकिंग को लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेण्ट्री ऑब्जेक्ट का उपयोग करें। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्यूमेंट को एक वीक पॉइंटर (शेयर किए गए के बजाय) सेट करता है। कंटेनर में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() स्टेटमेंट की अनलॉकिंग को लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेण्ट्री ऑब्जेक्ट का उपयोग करें। |
