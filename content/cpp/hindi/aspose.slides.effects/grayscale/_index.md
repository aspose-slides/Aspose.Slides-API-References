...
description: एक ग्रे स्केल प्रभाव का प्रतिनिधित्व करता है। सभी प्रभाव रंग मानों को उनके चमक के अनुरूप ग्रे के एक शेड में बदलता है। प्रभाव अल्फा (अपारदर्शिता) मान अपरिवर्तित रहते हैं।
type: docs
weight: 209
...
Gray Scale प्रभाव का प्रतिनिधित्व करता है। सभी प्रभाव रंग मानों को उनके चमक के अनुरूप ग्रे के शेड में बदलता है। प्रभाव अल्फा (अपारदर्शिता) मान अपरिवर्तित रहते हैं।
...
| मेथड | विवरण |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | निर्धारित करता है कि निर्दिष्ट [GrayScale](./) वर्तमान [GrayScale](./) के बराबर है या नहीं। |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGrayScaleEffectiveData](../igrayscaleeffectivedata/)\> [GetEffective](./geteffective/)() override | इनहेरिटेंस लागू करके प्रभावी Gray Scale प्रभाव डेटा प्राप्त करता है। |
| **int32_t** [GetHashCode](./gethashcode/)() const override | एक विशिष्ट प्रकार के लिए हैश फ़ंक्शन के रूप में काम करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्युमेंट को एक वीक पॉइंटर सेट करता है (शेयर की जगह)। कंटेनर्स में पॉइंटर को वीक मोड में स्विच करने की अनुमति देता है। |
