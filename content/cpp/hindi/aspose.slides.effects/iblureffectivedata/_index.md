...
description: एक अपरिवर्तनीय ऑब्जेक्ट जो ब्लर प्रभाव का प्रतिनिधित्व करता है जो पूरी आकृति पर लागू होता है, जिसमें उसका भराव भी शामिल है। सभी रंग चैनल, अल्फा सहित, प्रभावित होते हैं।
type: docs
weight: 469
url: /hi/aspose.slides.effects/iblureffectivedata/
---
## IBlurEffectiveData क्लास

एक अपरिवर्तनीय ऑब्जेक्ट जो एक [Blur](../blur/) प्रभाव का प्रतिनिधित्व करता है जो पूरी आकृति पर लागू होता है, जिसमें उसका भराव भी शामिल है। सभी रंग चैनल, अल्फा सहित, प्रभावित होते हैं।
...
| virtual **bool** [get_Grow](./get_grow/)() | निर्धारित करता है कि ब्लरिंग के परिणामस्वरूप ऑब्जेक्ट की सीमाएँ बढ़नी चाहिए या नहीं। यदि सत्य है तो सीमाएँ बढ़ती हैं, अन्यथा नहीं। केवल-पढ़ने योग्य **bool**। |
| virtual **double** [get_Radius](./get_radius/)() | ब्लर रेडियस लौटाता है। केवल-पढ़ने योग्य **double**। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्यूमेंट को एक कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनर में पॉइंटर को कमजोर मोड में बदलने की अनुमति देता है। |
