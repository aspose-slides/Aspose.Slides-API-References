...
description: एक अपरिवर्तनीय वस्तु जो Duotone प्रभाव को दर्शाती है। प्रत्येक पिक्सेल के लिए, clr1 और clr2 को रैखिक इंटरपोलेशन के माध्यम से मिलाकर उस पिक्सेल के लिए नया रंग निर्धारित करती है।
type: docs
weight: 573
...
एक अपरिवर्तनीय वस्तु जो [Duotone](../duotone/) प्रभाव को दर्शाती है। प्रत्येक पिक्सेल के लिए, clr1 और clr2 को रैखिक इंटरपोलेशन द्वारा मिलाकर उस पिक्सेल के लिए नया रंग निर्धारित करती है।
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color1](./get_color1/)() | डार्क पिक्सेल के लिए लक्षित रंग फ़ॉर्मेट लौटाता है। केवल-पठन [System::Drawing::Color](../../system.drawing/color/)। |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color2](./get_color2/)() | लाइट पिक्सेल के लिए लक्षित रंग फ़ॉर्मेट लौटाता है। केवल-पठन [System::Drawing::Color](../../system.drawing/color/)। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ भी नहीं कॉपी करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी निर्माण को सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी नहीं कॉपी करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी निर्माण को सक्षम करता है। |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) का स्ट्रिंग्स मामलों के लिए विशेषीकरण। |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्दिष्ट मान द्वारा साझा रेफ़रेंस काउंट को घटाता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्युमेंट को एक कमजोर पॉइंटर सेट करता है (साझा के बजाय)। कंटेनरों में पॉइंटर को कमजोर मोड में स्विच करने की अनुमति देता है। |
