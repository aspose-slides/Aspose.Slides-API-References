...
description: एक सॉफ़्ट एज प्रभाव का प्रतिनिधित्व करता है। आकार के किनारे धुंधले होते हैं, जबकि भराव प्रभावित नहीं होता।
type: docs
weight: 963
...
एक सॉफ़्ट एज इफ़ेक्ट का प्रतिनिधित्व करता है। आकार के किनारे धुंधले होते हैं, जबकि भराव प्रभावित नहीं होता।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-स्टाइल फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के समान नहीं है, जिसमें NaN भी शामिल है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-स्टाइल फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के समान नहीं है, जिसमें NaN भी शामिल है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक उद्देश्यों के लिए। |
| virtual **double** [get_Radius](./get_radius/)() | किनारों पर ब्लर लागू करने की त्रिज्या निर्दिष्ट करता है। पढ़ें **double**। |
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | इनहेरिटेंस लागू होने के बाद प्रभावी डेटा प्राप्त करता है। |
...
| virtual void [set_Radius](./set_radius/)(**double**) | किनारों पर ब्लर लागू करने की त्रिज्या निर्दिष्ट करता है। लिखें **double**। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्युमेंट को एक वीक पॉइंटर (शेयरड के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
