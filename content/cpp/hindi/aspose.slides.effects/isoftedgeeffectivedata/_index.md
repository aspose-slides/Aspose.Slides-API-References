...
description: अपरिवर्तनीय ऑब्जेक्ट जो सॉफ़्ट एज प्रभाव का प्रतिनिधित्व करता है। आकृति के किनारे धुंधले होते हैं, जबकि भराव पर कोई असर नहीं पड़ता।
type: docs
weight: 976
url: /hi/aspose.slides.effects/isoftedgeeffectivedata/
---
## ISoftEdgeEffectiveData क्लास

एक अपरिवर्तनीय ऑब्जेक्ट जो सॉफ़्ट एज प्रभाव का प्रतिनिधित्व करता है। आकृति के किनारे धुंधले होते हैं, जबकि भराव पर कोई प्रभाव नहीं पड़ता।
...
| virtual **double** [get_Radius](./get_radius/)() | किनारों पर लागू करने के लिए ब्लर त्रिज्या निर्दिष्ट करता है। पढ़ने-के-लिए-केवल **double**। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि ऑब्जेक्ट targetType द्वारा वर्णित टाइप का इंस्टैंस है या नहीं। C# 'is' ऑपरेटर का समरूप। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n-वें टेम्प्लेट आर्ग्यूमेंट को एक वीक पॉइंटर सेट करता है (शेयर्ड के बजाय)। कंटेनर्स में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
