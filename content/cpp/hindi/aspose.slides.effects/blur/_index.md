...
description: पूर्ण आकार, जिसमें उसका भराव भी शामिल है, पर लागू किए गए Blur प्रभाव को दर्शाता है। सभी रंग चैनल, जिसमें अल्फा भी शामिल है, प्रभावित होते हैं।
type: docs
weight: 105
...
पूरे आकार पर लागू किए जाने वाले [Blur](./) प्रभाव का प्रतिनिधित्व करता है, जिसमें उसका भराव भी शामिल है। सभी रंग चैनलों, जिसमें अल्फा भी शामिल है, पर प्रभाव पड़ता है।
...
| विधि | विवरण |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | निर्धारित करता है कि निर्दिष्ट [Blur](./) वर्तमान [Blur](./) के बराबर है या नहीं। |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलना को अनुक्रमित करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान, जिसमें NaN भी शामिल है, के बराबर नहीं होता। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलना को अनुक्रमित करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान, जिसमें NaN भी शामिल है, के बराबर नहीं होता। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| **bool** [get_Grow](./get_grow/)() override | निर्धारित करता है कि ब्लर करने के परिणामस्वरूप ऑब्जेक्ट की सीमाएं बढ़नी चाहिए या नहीं। True दर्शाता है कि सीमाएं बढ़ती हैं जबकि false दर्शाता है कि वे नहीं बढ़तीं। पढ़ें **bool**। |
...
| **double** [get_Radius](./get_radius/)() override | ब्लर त्रिज्या लौटाता है। पढ़ें **double**। |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBlurEffectiveData](../iblureffectivedata/)\> [GetEffective](./geteffective/)() override | विरासत लागू होने के साथ प्रभावी [Blur](./) प्रभाव डेटा प्राप्त करता है। |
| **int32_t** [GetHashCode](./gethashcode/)() const override | किसी विशेष प्रकार के लिए हैश फ़ंक्शन के रूप में कार्य करता है। |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | ऑब्जेक्ट का वास्तविक प्रकार प्राप्त करता है। C# [System.Object.GetType()](../../system/object/gettype/) कॉल का समानांतर। |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जांच करता है कि क्या ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का एक उदाहरण है। C# 'is' ऑपरेटर का समानांतर। |
...
| void [set_Grow](./set_grow/)(**bool**) override | निर्धारित करता है कि ब्लर करने के परिणामस्वरूप ऑब्जेक्ट की सीमाएं बढ़नी चाहिए या नहीं। True दर्शाता है कि सीमाएं बढ़ती हैं जबकि false दर्शाता है कि वे नहीं बढ़तीं। लिखें **bool**। |
| void [set_Radius](./set_radius/)(**double**) override | ब्लर त्रिज्या सेट करता है। लिखें **double**। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्गुमेंट को एक weak पॉइंटर (shared के बजाय) सेट करता है। कंटेनरों में पॉइंटर को weak मोड में बदलने की अनुमति देता है। |
