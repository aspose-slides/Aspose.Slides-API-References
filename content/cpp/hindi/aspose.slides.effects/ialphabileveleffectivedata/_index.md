...
description: अपरिवर्तनीय ऑब्जेक्ट जो एक Alpha Bi-Level प्रभाव का प्रतिनिधित्व करता है। Alpha (Opacity) मान जो थ्रेशहोल्ड से कम हैं, उन्हें 0 (पूर्णतः पारदर्शी) में बदल दिया जाता है और alpha मान जो थ्रेशहोल्ड के बराबर या अधिक हैं, उन्हें 100% (पूर्णतः अपारदर्शी) में बदल दिया जाता है।
type: docs
weight: 248
url: /hi/aspose.slides.effects/ialphabileveleffectivedata/
---
## IAlphaBiLevelEffectiveData क्लास

एक अपरिवर्तनीय ऑब्जेक्ट जो एक Alpha Bi-Level प्रभाव का प्रतिनिधित्व करता है। Alpha (Opacity) मान जो थ्रेशहोल्ड से कम हैं, उन्हें 0 (पूर्णतः पारदर्शी) में बदल दिया जाता है और alpha मान जो थ्रेशहोल्ड के बराबर या अधिक हैं, उन्हें 100% (पूर्णतः अपारदर्शी) में बदल दिया जाता है।
...
| virtual **float** [get_Threshold](./get_threshold/)() | इफ़ेक्ट थ्रेशहोल्ड लौटाता है। केवल-पढ़ने वाला **float**। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कंस्ट्रक्टर्स। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ को कॉपी कंस्ट्रक्ट करने में सक्षम बनाता है। |
