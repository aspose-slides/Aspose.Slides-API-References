...
description: एक अपरिवर्तनीय ऑब्जेक्ट जो बाहरी छाया प्रभाव का प्रतिनिधित्व करता है।
type: docs
weight: 898
url: /hi/aspose.slides.effects/ioutershadoweffectivedata/
---
## IOuterShadowEffectiveData क्लास
...
| virtual **float** [get_Direction](./get_direction/)() | छाया की दिशा। केवल पढ़ने योग्य **float**। |
| virtual **double** [get_Distance](./get_distance/)() | छाया की दूरी। केवल पढ़ने योग्य **double**। |
...
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | निर्दिष्ट करता है कि क्या छाया को आकार के साथ घुमाया जाना चाहिए यदि आकार घुमाया गया हो। केवल पढ़ने योग्य **bool**। |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | क्षैतिज स्केलिंग फैक्टर निर्दिष्ट करता है, नकारात्मक स्केलिंग फ़्लिप का कारण बनती है। केवल पढ़ने योग्य **double**। |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | ऊर्ध्वाधर स्केलिंग फैक्टर निर्दिष्ट करता है, नकारात्मक स्केलिंग फ़्लिप का कारण बनती है। केवल पढ़ने योग्य **double**। |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | छाया का रंग। केवल पढ़ने योग्य [System::Drawing::Color](../../system.drawing/color/)। |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | क्षैतिज विकृति कोण (डिग्री में) निर्दिष्ट करता है। केवल पढ़ने योग्य **double**। |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | ऊर्ध्वाधर विकृति कोण (डिग्री में) निर्दिष्ट करता है। केवल पढ़ने योग्य **double**। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि ऑब्जेक्ट targetType द्वारा वर्णित प्रकार की एक इंस्टेंस है या नहीं। C# 'is' ऑपरेटर का समान रूप। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कंस्ट्रक्टर। वास्तव में कुछ नहीं कॉपी करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ नहीं कॉपी करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्यूमेंट को एक कमजोर पॉइंटर (शेयर किए गए के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को कमजोर मोड में स्विच करने की अनुमति देता है। |
| int [SharedCount](../../system/object/sharedcount/)() const | शेयर किए गए रेफ़रेंस काउंटर का वर्तमान मान प्राप्त करता है। |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | शेयर किए गए रेफ़रेंस काउंट को बढ़ाता है। इसे सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | शेयर किए गए रेफ़रेंस काउंट को घटाता है और लौटाता है। इसे सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
...
* क्लास [IEffectEffectiveData](../ieffecteffectivedata/)
