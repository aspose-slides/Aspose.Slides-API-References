...
description: एक मजबूत प्रकार के संग्रह के लिए एक एब्स्ट्रैक्ट बेस क्लास प्रदान करता है।
type: docs
weight: 27
url: /hi/system.collections/collectionbase/
---
## CollectionBase क्लास
...
| void [Clear](./clear/)() | Removes all objects from the collection instance. This method cannot be overridden. |
...
| **int32_t** [get_Capacity](./get_capacity/)() | Returns the number of elements that the collection can contain. |
| **int32_t** [get_Count](./get_count/)() | Returns the number of elements contained in the collection instance. This method cannot be overridden. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Returns an enumerator that iterates through the collection instance. |
...
| void [RemoveAt](./removeat/)(**int32_t**) | Removes the element at the specified index of the collection instance. This method is not overridable. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Decreases shared reference count by specified value. |
| void [set_Capacity](./set_capacity/)(**int32_t**) | Sets the number of elements that the collection can contain. |
