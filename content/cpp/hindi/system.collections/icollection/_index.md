...
description: गैर-जेनेरिक कलेक्शन इंटरफ़ेस को परिभाषित करता है।
type: docs
weight: 40
url: /hi/system.collections/icollection/
---
## ICollection क्लास
...
| virtual int [get_Count](./get_count/)() const | कलेक्शन में तत्वों की संख्या प्राप्त करता है। |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](../ienumerable/getenumerator/)() | कलेक्शन के माध्यम से इटरटे करने वाला एनेमरेटर लौटाता है। |
