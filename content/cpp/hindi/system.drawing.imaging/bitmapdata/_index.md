...
description: "एक बिटमैप इमेज की एट्रिब्यूट्स का सेट प्रस्तुत करता है। इस क्लास के ऑब्जेक्ट को केवल System::MakeObject() फ़ंक्शन का उपयोग करके ही एलोकेट किया जाना चाहिए। इस प्रकार का इंस्टैंस स्टैक पर या operator new का उपयोग करके कभी न बनाएँ, क्योंकि इससे रनटाइम एरर और/या असर्शन फ़ॉल्ट्स हो सकते हैं। हमेशा इस क्लास को System::SmartPtr पॉइंटर में रैप करें और इस पॉइंटर को फ़ंक्शन के आर्ग्युमेंट के रूप में पास करें।"
type: docs
weight: 1
url: /hi/system.drawing.imaging/bitmapdata/
---
## BitmapData वर्ग

Bitmap इमेज के सेट एट्रिब्यूट्स को प्रस्तुत करता है। इस वर्ग के ऑब्जेक्ट को केवल [System::MakeObject()](../../system/makeobject/) फ़ंक्शन का उपयोग करके ही एलोकेट किया जाना चाहिए। इस प्रकार का इंस्टैंस स्टैक पर या operator new का उपयोग करके कभी न बनाएँ, क्योंकि इससे रन-टाइम एरर्स और/या असर्शन फॉल्ट्स हो सकते हैं। हमेशा इस वर्ग को [System::SmartPtr](../../system/smartptr/) पॉइंटर में रैप करें और इस पॉइंटर को फ़ंक्शन के आर्ग्युमेंट के रूप में पास करें।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-स्टाइल फ़्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, सहित NaN, के बराबर नहीं होता। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-स्टाइल फ़्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, सहित NaN, के बराबर नहीं होता। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| int [get_Height](./get_height/)() const | चित्र की ऊँचाई पिक्सेल में लौटाता है। |
| [PixelFormat](../pixelformat/) [get_PixelFormat](./get_pixelformat/)() const | बिटमैप इमेज का पिक्सेल फ़ॉर्मेट लौटाता है। |
| IntPtr [get_Scan0](./get_scan0/)() const | बिटमैप में पहले पिक्सेल डेटा का पता लौटाता है। |
| int [get_Stride](./get_stride/)() const | चित्र की स्ट्राइड चौड़ाई बाइट्स में लौटाता है। |
| int [get_Width](./get_width/)() const | चित्र की चौड़ाई पिक्सेल में लौटाता है। |
...
| void [set_Height](./set_height/)(int) | चित्र की ऊँचाई पिक्सेल में सेट करता है। |
| void [set_PixelFormat](./set_pixelformat/)([PixelFormat](../pixelformat/)) | बिटमैप छवि का पिक्सेल फ़ॉर्मेट सेट करता है। |
| void [set_Scan0](./set_scan0/)(IntPtr) | बिटमैप में पहले पिक्सेल डेटा का पता सेट करता है। |
| void [set_Stride](./set_stride/)(int) | चित्र की स्ट्राइड चौड़ाई बाइट्स में सेट करता है। |
| void [set_Width](./set_width/)(int) | चित्र की चौड़ाई पिक्सेल में सेट करता है। |
