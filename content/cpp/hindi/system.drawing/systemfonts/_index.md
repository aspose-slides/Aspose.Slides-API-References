...
description: प्री-क्रिएटेड फ़ॉन्ट ऑब्जेक्ट्स का सेट प्रदान करता है जो विंडोज़ डिस्प्ले तत्वों में टेक्स्ट प्रदर्शित करने के लिए उपयोग किए जाने वाले फ़ॉन्ट्स का प्रतिनिधित्व करते हैं। यह एक स्थैतिक प्रकार है जिसके पास कोई इंस्टेंस सेवाएँ नहीं हैं। आपको किसी भी तरह से इसके इंस्टेंस नहीं बनाना चाहिए।
type: docs
weight: 339
url: /hi/system.drawing/systemfonts/
---
## SystemFonts क्लास
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली का फ़्लोटिंग पॉइंट तुलना अनुकरण करता है जहाँ दो NaN को समान माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं है, यहाँ तक कि NaN के भी नहीं। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली का फ़्लोटिंग पॉइंट तुलना अनुकरण करता है जहाँ दो NaN को समान माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं है, यहाँ तक कि NaN के भी नहीं। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_CaptionFont](./get_captionfont/)() | अभी लागू नहीं है। |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_DefaultFont](./get_defaultfont/)() | [Font](../font/) ऑब्जेक्ट लौटाता है जो डिफ़ॉल्ट फ़ॉन्ट का प्रतिनिधित्व करता है जिसे एप्लिकेशन डायलॉग बॉक्स और फ़ॉर्म के लिए उपयोग कर सकता है। |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_IconTitleFont](./get_icontitlefont/)() | अभी लागू नहीं है। |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MenuFont](./get_menufont/)() | अभी लागू नहीं है। |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MessageBoxFont](./get_messageboxfont/)() | अभी लागू नहीं है। |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_SmallCaptionFont](./get_smallcaptionfont/)() | अभी लागू नहीं है। |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_StatusFont](./get_statusfont/)() | अभी लागू नहीं है। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कॉन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, सिर्फ नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी कॉन्स्ट्रक्शन को सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, सिर्फ नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी कॉन्स्ट्रक्शन को सक्षम करता है। |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) का स्ट्रिंग और nullptr के केस हेतु विशेषीकरण। |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) का स्ट्रिंग्स के केस हेतु विशेषीकरण। |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्दिष्ट मान द्वारा शेयर्ड रेफ़रेंस काउंट को घटाता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nth टेम्प्लेट आर्ग्यूमेंट को एक कमजोर पॉइंटर सेट करता है (शेयर्ड के बजाय)। कंटेनर में पॉइंटर्स को कमजोर मोड में स्विच करने की अनुमति देता है। |
