...
description: float घटकों वाला 2D वेक्टर
type: docs
weight: 53
url: /hi/aspose.slides.drawing/vector2d32f/
---
## Vector2d32f क्लास

2D वेक्टर जिसमें **float** घटक हैं
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN स्वयं भी शामिल है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN स्वयं भी शामिल है। |
...
| **double** [GetLength](./getlength/)() | लंबाई प्राप्त करें |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि ऑब्जेक्ट लक्ष्य प्रकार द्वारा वर्णित प्रकार का इंस्टेंस है या नहीं। C# 'is' ऑपरेटर का समानांतर। |
...
| [Vector2d32f](./) [Scale](./scale/)(**float**, **float**) | वेक्टर को स्केल करें |
| [Vector2d32f](./) [Scale](./scale/)([Vector2d32f](./)) | वेक्टर को स्केल करें |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n-वें टेम्पलेट आर्ग्युमेंट को वैक पॉइंटर (साझा के बजाय) सेट करता है। कंटेनर में पॉइंटर्स को वैक मोड में स्विच करने की अनुमति देता है। |
...
| void [SwapXY](./swapxy/)() | X और Y को अदला-बदली करें |
| [System::String](../../system/string/) [ToString](./tostring/)() const override | C# Object.ToString() मेथड का समानांतर। कस्टम ऑब्जेक्ट्स को स्ट्रिंग में परिवर्तित करने को सक्षम करता है। |
| [Vector2d64d](../vector2d64d/) [ToVector2d64d](./tovector2d64d/)() | [Vector2d64d](../vector2d64d/) पर |
...
|  [Vector2d32f](./vector2d32f/)(**float**, **float**) | कंस्ट्रक्टर |
