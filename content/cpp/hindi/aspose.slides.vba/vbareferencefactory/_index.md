...
description: COM इंटरफ़ेस के माध्यम से VBA प्रोजेक्ट रेफ़रेंसेस बनाने की अनुमति देता है
type: docs
weight: 196
...
VBA प्रोजेक्ट रेफ़रेंसेस को COM इंटरफ़ेस के माध्यम से बनाने की अनुमति देता है
...
| मेथड | विवरण |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)\> [CreateOleTypeLibReference](./createoletypelibreference/)([System::String](../../system/string/), [System::String](../../system/string/)) override | नया OLE Automation टाइप लाइब्रेरी रेफ़रेंस बनाता है। |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaReferenceFactory](./)\> [get_Instance](./get_instance/)() | VBA प्रोजेक्ट रेफ़रेंसेस फ़ैक्ट्री का स्थैतिक इंस्टेंस। केवल-पढ़ने योग्य [VbaReferenceFactory](./)। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्युमेंट को weak पॉइंटर सेट करता है (shared के बजाय)। कंटेनर में पॉइंटर्स को weak मोड में स्विच करने की अनुमति देता है। |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | साझा रेफ़रेंस काउंट को घटाता और लौटाता है। सीधे कॉल नहीं किया जाना चाहिए; इसके अलावा स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
...
* क्लास [IVbaReferenceFactory](../ivbareferencefactory/)
