...
description: प्रेज़ेंटेशन मैक्रोज़ वाले VBA प्रोजेक्ट को दर्शाता है।
type: docs
weight: 27
...
प्रेज़ेंटेशन मैक्रोज़ वाले VBA प्रोजेक्ट का प्रतिनिधित्व करता है।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली की फ़्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं है, जिसमें NaN भी शामिल है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली की फ़्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं है, जिसमें NaN भी शामिल है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक उपयोग के लिए। |
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | बताता है कि VBAProject पासवर्ड द्वारा संरक्षित है या नहीं, जिससे प्रोजेक्ट प्रॉपर्टी देखी जा सकती है। केवल-पठनीय **bool**। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) | निर्दिष्ट इंडेक्स पर VBA प्रोजेक्ट में शामिल मॉड्यूल को लौटाता है। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() | VBA प्रोजेक्ट में शामिल सभी मॉड्यूल की सूची लौटाता है। केवल-पठनीय [IVbaModuleCollection](../ivbamodulecollection/)। |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | VBA प्रोजेक्ट का नाम लौटाता है। केवल-पठनीय [System::String](../../system/string/)। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) | निर्दिष्ट इंडेक्स पर VBA प्रोजेक्ट में शामिल रेफ़रेंस को लौटाता है। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() | VBA प्रोजेक्ट में शामिल सभी रेफ़रेंसेज़ की सूची लौटाता है। केवल-पठनीय [IVbaReferenceCollection](../ivbareferencecollection/)। |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) का स्ट्रिंग और नलपॉइंट केस के लिए विशिष्ट संस्करण। |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) का स्ट्रिंग्स के केस के लिए विशिष्ट संस्करण। |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्दिष्ट मान द्वारा शेयर्ड रेफ़रेंस काउंट को घटाता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्यूमेंट को वीक पॉइंटर (शेयर्ड के बजाय) सेट करता है। कंटेनर में पॉइंटर्स को वीक मोड में बदलने की अनुमति देता है। |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() | VBA प्रोजेक्ट का बाइनरी प्रतिनिधित्व OLE कंटेनर के रूप में लौटाता है। केवल-पठनीय **uint8_t**[]। |
