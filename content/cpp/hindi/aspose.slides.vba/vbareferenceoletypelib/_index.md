...
description: OLE Automation टाइप लाइब्रेरी रेफ़रेंस को दर्शाता है।
type: docs
weight: 209
...
OLE Automation टाइप लाइब्रेरी रेफ़रेंस को दर्शाता है।
...
| [System::String](../../system/string/) [get_Libid](./get_libid/)() override | Automation टाइप लाइब्रेरी के पहचानकर्ता को दर्शाता है। पढ़ें [System::String](../../system/string/)। |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | VBA प्रोजेक्ट रेफ़रेंस के नाम को दर्शाता है। पढ़ें [System::String](../../system/string/)। |
...
| void [set_Libid](./set_libid/)([System::String](../../system/string/)) override | Automation टाइप लाइब्रेरी के पहचानकर्ता को दर्शाता है। लिखें [System::String](../../system/string/)। |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | VBA प्रोजेक्ट रेफ़रेंस के नाम को दर्शाता है। लिखें [System::String](../../system/string/)। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्पलेट आर्ग्यूमेंट को व्हीक पॉइंटर सेट करता है (शेयरड के बजाय)। कंटेनरों में पॉइंटर्स को व्हीक मोड में स्विच करने की अनुमति देता है। |
...
|  [VbaReferenceOleTypeLib](./vbareferenceoletypelib/)([System::String](../../system/string/), [System::String](../../system/string/)) | यह कन्स्ट्रक्टर नया OLE Automation टाइप लाइब्रेरी रेफ़रेंस बनाता है। |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | व्हीक रेफ़रेंस काउंट को बढ़ाता है। सीधे कॉल नहीं करना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | व्हीक रेफ़रेंस काउंट को घटाता है। सीधे कॉल नहीं करना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
| virtual  [~Object](../../system/object/~object/)() | ऑब्जेक्ट नष्ट करता है। सभी आंतरिक डेटा संरचनाओं को मुक्त करता है। |

## संबंधित देखें

* क्लास [IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)
