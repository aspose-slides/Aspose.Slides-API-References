...
description: काग़ज़ के एक टुकड़े का आकार निर्दिष्ट करता है।
type: docs
weight: 27
url: /hi/system.drawing.printing/papersize/
---
## PaperSize क्लास

काग़ज के एक टुकड़े का आकार निर्दिष्ट करता है।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली फ़्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN समान माने जाते हैं जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के लिए भी नहीं। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली फ़्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN समान माने जाते हैं जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के लिए भी नहीं। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| **int32_t** [get_Height](./get_height/)() const | काग़ज की ऊँचाई प्राप्त करता है, इंच के सैंकड़ों हिस्से में। |
| [PaperKind](../paperkind/) [get_Kind](./get_kind/)() const | काग़ज के प्रकार को प्राप्त करता है। |
| [System::String](../../system/string/) [get_PaperName](./get_papername/)() const | काग़ज के प्रकार का नाम प्राप्त करता है। |
| **int32_t** [get_RawKind](./get_rawkind/)() const | एक पूर्णांक प्राप्त करता है जो [System::Drawing::Printing::PaperSize](./) मानों में से एक या कस्टम मान को दर्शाता है। |
| **int32_t** [get_Width](./get_width/)() const | काग़ज की चौड़ाई प्राप्त करता है, इंच के सैंकड़ों हिस्से में। |
...
|  [PaperSize](./papersize/)() | [System::Drawing::Printing::PaperSize](./) क्लास का नया इंस्टेंस इनिशियलाइज़ करता है। |
|  [PaperSize](./papersize/)([PaperKind](../paperkind/), [System::String](../../system/string/), **int32_t**, **int32_t**) | [System::Drawing::Printing::PaperSize](./) क्लास का नया इंस्टेंस इनिशियलाइज़ करता है। |
|  [PaperSize](./papersize/)([System::String](../../system/string/), **int32_t**, **int32_t**) | [System::Drawing::Printing::PaperSize](./) क्लास का नया इंस्टांस इनिशियलाइज़ करता है। |
...
| void [set_Height](./set_height/)(**int32_t**) | काग़ज की ऊँचाई सेट करता है, इंच के सैंकड़ों हिस्से में। |
| void [set_PaperName](./set_papername/)([System::String](../../system/string/)) | काग़ज के प्रकार का नाम सेट करता है। |
| void [set_RawKind](./set_rawkind/)(**int32_t**) | [System::Drawing::Printing::PaperSize](./) मानों में से एक या कस्टम मान का प्रतिनिधित्व करने वाला पूर्णांक सेट करता है। |
| void [set_Width](./set_width/)(**int32_t**) | काग़ज की चौड़ाई सेट करता है, इंच के सैंकड़ों हिस्से में। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्यूमेंट को वीक पॉइंटर सेट करता है (शेयर्ड के बजाय)। कंटेनर्स में पॉइंटर को वीक मोड में स्विच करने की अनुमति देता है। |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | [System::Drawing::Printing::PaperSize](./) के बारे में जानकारी स्ट्रिंग रूप में प्रदान करता है। |
