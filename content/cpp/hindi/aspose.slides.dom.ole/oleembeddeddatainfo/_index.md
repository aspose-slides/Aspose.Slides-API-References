...
description: OLE ऑब्जेक्ट के लिए एम्बेडेड डेटा जानकारी दर्शाता है।
type: docs
weight: 1
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | एम्बेडेड OLE ऑब्जेक्ट के फ़ाइल डेटा को वापस करता है, केवल पढ़ने योग्य **uint8_t**[]. |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | वर्तमान एम्बेडेड OLE ऑब्जेक्ट के फ़ाइल एक्सटेंशन को वापस करता है, केवल पढ़ने योग्य [System::String](../../system/string/)। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जांचता है कि ऑब्जेक्ट targetType द्वारा वर्णित टाइप की इंस्टेंस है या नहीं। C# 'is' ऑपरेटर का समान। |
...
| [OleEmbeddedDataInfo](./oleembeddeddatainfo/)() | OLE ऑब्जेक्ट के लिए नया एम्बेडेड डेटा जानकारी बनाता है। |
| [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | OLE ऑब्जेक्ट के लिए एम्बेडेड डेटा जानकारी का नया इंस्टेंस बनाता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्यूमेंट को कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर को कमजोर मोड में स्विच करने की अनुमति देता है। |
...
* क्लास [IOleEmbeddedDataInfo](../../aspose.slides/ioleembeddeddatainfo/)
* नेमस्पेस [Aspose::Slides::DOM::Ole](../)
