...
description: XmlSerializer के साथ उपयोग करने के लिए आंतरिक क्लास।
type: docs
weight: 79
url: /hi/system.xml.serialization/xmlserializerimplementation/
---
## XmlSerializerImplementation क्लास

आंतरिक क्लास जिसे [XmlSerializer](../xmlserializer/) के साथ उपयोग किया जाता है।
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nth टेम्प्लेट तर्क को वीक पॉइंटर सेट करता है (शेयरड के बजाय)। कंटेनरों में पॉइंटर्स को वीक मोड में बदलने की अनुमति देता है। |
