...
प्रेज़ेंटेशन मास्टर थीम तक पहुँच प्रदान करता है।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-स्टाइल फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के भी नहीं। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-स्टाइल फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के भी नहीं। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक उपयोग के लिए। |
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | निर्धारित करता है कि [OverrideTheme](../overridetheme/) विरासत में मिली प्रभावी थीम ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) को ओवरराइड करता है या नहीं। पढ़ें **bool**। |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | ओवरराइड करने वाले थीम ऑब्जेक्ट को लौटाता है। पढ़ें [IMasterTheme](../imastertheme/)। |
...
| void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) override | निर्धारित करता है कि [OverrideTheme](../overridetheme/) विरासत में मिली प्रभावी थीम ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) को ओवरराइड करता है या नहीं। लिखें **bool**। |
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) override | ओवरराइड करने वाले थीम ऑब्जेक्ट को लौटाता है। लिखें [IMasterTheme](../imastertheme/)। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्युमेंट को एक कमजोर पॉइंटर (शेयर किए गए के बजाय) सेट करता है। कंटेनर्स में पॉइंटर्स को कमजोर मोड में स्विच करने की अनुमति देता है। |
...
* क्लास [IMasterThemeManager](../imasterthememanager/)
