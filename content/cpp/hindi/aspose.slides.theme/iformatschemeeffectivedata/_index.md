...
description: एक अपरिवर्तनीय ऑब्जेक्ट जो प्रभावी फ़ॉर्मेट स्कीम गुणों को शामिल करता है।
type: docs
weight: 313
url: /hi/aspose.slides.theme/iformatschemeeffectivedata/
---
## IFormatSchemeEffectiveData क्लास

एक अपरिवर्तनीय ऑब्जेक्ट जो प्रभावी फ़ॉर्मेट स्कीम गुणों को शामिल करता है।
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollectionEffectiveData](../ifillformatcollectioneffectivedata/)\> [GetBackgroundFillStyles](./getbackgroundfillstyles/)([System::Drawing::Color](../../system.drawing/color/)) | थीम द्वारा परिभाषित पृष्ठभूमि फ़िल स्टाइल्स का संग्रह लौटाता है। |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ऑब्जेक्ट से जुड़ी रेफ़रेंस काउंटर डेटा संरचना प्राप्त करता है। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyleCollectionEffectiveData](../ieffectstylecollectioneffectivedata/)\> [GetEffectStyles](./geteffectstyles/)([System::Drawing::Color](../../system.drawing/color/)) | थीम द्वारा परिभाषित इफ़ेक्ट स्टाइल्स का संग्रह लौटाता है। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollectionEffectiveData](../ifillformatcollectioneffectivedata/)\> [GetFillStyles](./getfillstyles/)([System::Drawing::Color](../../system.drawing/color/)) | थीम द्वारा परिभाषित फ़िल स्टाइल्स का संग्रह लौटाता है। |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatCollectionEffectiveData](../ilineformatcollectioneffectivedata/)\> [GetLineStyles](./getlinestyles/)([System::Drawing::Color](../../system.drawing/color/)) | थीम द्वारा परिभाषित लाइन स्टाइल्स का संग्रह लौटाता है। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कंस्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, सिर्फ नया ऑब्जेक्ट आरंभ करता है और सबक्लासेज़ की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, सिर्फ नया ऑब्जेक्ट आरंभ करता है और सबक्लासेज़ की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्यूमेंट को एक कमजोर पॉइंटर सेट करता है (साझा के बजाय)। कंटेनरों में पॉइंटर्स को कमजोर मोड में बदलने की अनुमति देता है। |
