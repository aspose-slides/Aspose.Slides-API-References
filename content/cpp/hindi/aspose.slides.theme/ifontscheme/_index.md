...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() | स्लाइड के "heading" भाग के लिए फ़ॉन्ट्स संग्रह लौटाता है। केवल-पाठनीय [IFonts](../../aspose.slides/ifonts/)। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() | स्लाइड के "body" भाग के लिए फ़ॉन्ट्स संग्रह लौटाता है। केवल-पाठनीय [IFonts](../../aspose.slides/ifonts/)। |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | फ़ॉन्ट स्कीम का नाम लौटाता है। पढ़ें [System::String](../../system/string/)। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी निर्माण को सक्षम बनाता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी निर्माण को सक्षम बनाता है। |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | फ़ॉन्ट स्कीम का नाम लौटाता है। लिखें [System::String](../../system/string/)। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्युमेंट को एक वैक्ड पॉइंटर (शेयर किए गए के बजाय) सेट करता है। कंटेनरों में पॉइंटर को वैक्ड मोड में स्विच करने की अनुमति देता है। |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | वैक्ड रेफ़रेंस काउंट को बढ़ाता है। इसे सीधे नहीं बुलाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | वैक्ड रेफ़रेंस काउंट को घटाता है। इसे सीधे नहीं बुलाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
