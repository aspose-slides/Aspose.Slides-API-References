...
| विधि | विवरण |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | एक स्लाइड पर अतिरिक्त रंग योजना लागू करता है। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithememanager/createthemeeffective/)() | थीम ऑब्जेक्ट लौटाता है। |
...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | निर्धारित करता है कि [OverrideTheme](../overridetheme/) विरासत में प्राप्त प्रभावी थीम (Presentation.MasterTheme) को ओवरराइड करता है या नहीं। पढ़ें **bool**। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() | ओवरराइडिंग थीम ऑब्जेक्ट लौटाता है। पढ़ें [IMasterTheme](../imastertheme/)। |
...
| virtual void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) | निर्धारित करता है कि [OverrideTheme](../overridetheme/) विरासत में प्राप्त प्रभावी थीम (Presentation.MasterTheme) को ओवरराइड करता है या नहीं। लिखें **bool**। |
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) | ओवरराइडिंग थीम ऑब्जेक्ट लौटाता है। लिखें [IMasterTheme](../imastertheme/)। |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | साझा रेफ़रेंस काउंट को कम करता है और लौटाता है। सीधे नहीं बुलाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | कमजोर रेफ़रेंस काउंट को कम करता है। सीधे नहीं बुलाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
| virtual  [~Object](../../system/object/~object/)() | ऑब्जेक्ट को नष्ट करता है। सभी आंतरिक डेटा संरचनाओं को मुक्त करता है। |
## देखें भी

* वर्ग [IThemeManager](../ithememanager/)
