...
description: चार्ट थीम को ओवरराइड करने के लिए पहुंच प्रदान करता है।
type: docs
weight: 27
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | निर्धारित करता है कि [OverrideTheme](../overridetheme/) इनहेरिटेड प्रभावी थीम को ओवरराइड करता है या नहीं। ओवरराइडिंग के लिए [OverrideTheme](../overridetheme/) सक्षम करने हेतु OverrideTheme.Init*() मेथड का उपयोग करें। [OverrideTheme](../overridetheme/) को ओवरराइडिंग से निष्क्रिय करने हेतु [OverrideTheme::Clear](../overridetheme/clear/) मेथड का प्रयोग करें। केवल-पढ़ने योग्य **bool**। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट आर्ग्युमेंट को वीक पॉइंटर सेट करता है (शेयर किए गए के बजाय)। कंटेनरों में पॉइंटर्स को वीक मोड में बदलने की अनुमति देता है। |
| int [SharedCount](../../system/object/sharedcount/)() const | शेयर किए गए रेफ़रेंस काउंटर का वर्तमान मान प्राप्त करता है। |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | शेयर किए गए रेफ़रेंस काउंट को बढ़ाता है। इसे सीधे कॉल नहीं करना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | शेयर किए गए रेफ़रेंस काउंट को घटाता है और लौटाता है। इसे सीधे कॉल नहीं करना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
