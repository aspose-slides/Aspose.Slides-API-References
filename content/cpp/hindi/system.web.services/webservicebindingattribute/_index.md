...
description: "XML वेब सेवा के एक या अधिक मेथड को परिभाषित करने वाले बाइंडिंग को घोषित करने के लिए उपयोग किया जाता है। इस क्लास के ऑब्जेक्ट्स को केवल System::MakeObject() फ़ंक्शन का उपयोग करके ही एलोकेट किया जाना चाहिए। कभी भी इस प्रकार का इंस्टेंस स्टैक पर या operator new का उपयोग करके न बनाएँ, क्योंकि इससे रनटाइम त्रुटियाँ और/या असर्शन फॉल्ट्स उत्पन्न हो सकते हैं। हमेशा इस क्लास को System::SmartPtr पॉइंटर में रैप करें और इस पॉइंटर को फ़ंक्शन में आर्ग्यूमेंट के रूप में पास करें।"
type: docs
weight: 40
url: /hi/system.web.services/webservicebindingattribute/
---
## WebServiceBindingAttribute क्लास

Used to declare a बाइंडिंग that defines one or more विधियों of the XML [Web](../../system.web/) service. Objects of this क्लास should only be allocated using [System::MakeObject()](../../system/makeobject/) फ़ंक्शन. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this क्लास into [System::SmartPtr](../../system/smartptr/) पॉइंटर and use this पॉइंटर to pass it to फ़ंक्शनों as argument.
...
| [System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\> [get_ConformsTo](./get_conformsto/)() | WSI विनिर्देश प्राप्त करता है। |
| **bool** [get_EmitConformanceClaims](./get_emitconformanceclaims/)() | एक मान प्राप्त करता है जो संकेत करता है कि बाइंडिंग कनफ़ॉर्मेंस क्लेम्स जारी करती है या नहीं। |
| [String](../../system/string/) [get_Location](./get_location/)() | बाइंडिंग के परिभाषित होने का स्थान प्राप्त करता है। |
| [String](../../system/string/) [get_Name](./get_name/)() | बाइंडिंग का नाम प्राप्त करता है। |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | बाइंडिंग से सम्बंधित नेमस्पेस प्राप्त करता है। |
...
| static [Object::ptr](../../system/object/ptr/) [GetCustomAttribute](../../system/attribute/getcustomattribute/)(const [TypeInfo](../../system/typeinfo/)\&, const [TypeInfo](../../system/typeinfo/)\&) | निर्दिष्ट प्रकार पर लागू एक कस्टम एट्रिब्यूट जो निर्दिष्ट प्रकार है, लौटाता है। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कंस्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेस की कॉपी कंस्ट्रक्शन सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेस की कॉपी कंस्ट्रक्शन सक्षम करता है। |
...
| void [set_ConformsTo](./set_conformsto/)([System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\>) | WSI विनिर्देश सेट करता है। |
| void [set_EmitConformanceClaims](./set_emitconformanceclaims/)(**bool**) | एक मान सेट करता है जो दर्शाता है कि बाइंडिंग कनफ़ॉर्मेंस क्लेम्स जारी करती है या नहीं। |
| void [set_Location](./set_location/)([String](../../system/string/)) | बाइंडिंग के परिभाषित होने का स्थान सेट करता है। |
| void [set_Name](./set_name/)([String](../../system/string/)) | बाइंडिंग का नाम सेट करता है। |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | बाइंडिंग से सम्बंधित नेमस्पेस सेट करता है। |
...
|  [WebServiceBindingAttribute](./webservicebindingattribute/)() | एक नया इंस्टेंस बनाता है। |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/)) | एक नया इंस्टेंस बनाता है। |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/)) | एक नया इंस्टेंस बनाता है। |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | एक नया इंस्टेंस बनाता है। |
