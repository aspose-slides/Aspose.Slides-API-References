---
title: ParallelLoopResult
second_title: C++ के लिए Aspose.Slides API संदर्भ
description: समांतर लूप की पूर्णता स्थिति प्रदान करता है।
type: docs
weight: 14
url: /hi/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult क्लास

एक [Parallel](../parallel/) लूप की पूर्णता स्थिति प्रदान करता है।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली की फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN बराबर मानते हैं, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, जिसमें NaN भी शामिल है, के बराबर नहीं होता। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली की फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN बराबर मानते हैं, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, जिसमें NaN भी शामिल है, के बराबर नहीं होता। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक उपयोग के लिए। |
| **bool** [get_IsCompleted](./get_iscompleted/)() | लूप के पूर्णता तक चलने का निर्धारण करता है। |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | ब्रेक होने पर सबसे कम इटरेशन इंडेक्स प्राप्त करता है। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी कन्स्ट्रक्शन सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी कन्स्ट्रक्शन सक्षम करता है। |
|  [ParallelLoopResult](./parallelloopresult/)() | एक [ParallelLoopResult](./) बनाता है। |
...
समांतर लूप ऑपरेशन का परिणाम दर्शाता है, जिसमें यह शामिल है कि यह पूरा हुआ या नहीं तथा ब्रेक्स की जानकारी।
