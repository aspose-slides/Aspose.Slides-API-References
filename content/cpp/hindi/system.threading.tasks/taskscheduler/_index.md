...
description: थ्रेड्स पर टास्क को क्यू करने के निम्न-स्तरीय कार्य को संभालने वाला ऑब्जेक्ट दर्शाता है।
type: docs
weight: 79
url: /hi/system.threading.tasks/taskscheduler/
---
## TaskScheduler क्लास

एक ऑब्जेक्ट को दर्शाता है जो थ्रेड्स पर टास्क को क्यू करने के निम्न-स्तरीय कार्य को संभालता है।
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | वर्तमान थ्रेड से जुड़े [TaskScheduler](./) को बनाता है। |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | वर्तमान में चल रहे टास्क से जुड़े [TaskScheduler](./) को प्राप्त करता है। |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | फ्रेमवर्क द्वारा प्रदान किए गए डिफ़ॉल्ट [TaskScheduler](./) इंस्टेंस को प्राप्त करता है। |
| **int32_t** [get_Id](./get_id/)() const | इस [TaskScheduler](./) के लिए यूनिक आईडी प्राप्त करता है। |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | इस [TaskScheduler](./) द्वारा समर्थित अधिकतम समवर्ती स्तर दर्शाता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्युमेंट को एक वीक पॉइंटर (शेयर किए बजाय) सेट करता है। कंटेनर्स में पॉइंटर को वीक मोड में स्विच करने की अनुमति देता है। |
