...
description: डिस्प्ले के बारे में जानकारी प्रदान करता है। केवल Windows। यह एक सिंगलटन प्रकार है जिससे मेमोरी प्रबंधन एक्सेस फ़ंक्शन(ओं) द्वारा किया जाता है। आपको इसे सीधे इंस्टेंस नहीं बनाना चाहिए।
type: docs
weight: 40
url: /hi/system.windows.forms/screen/
---
## Screen क्लास

डिस्प्ले के बारे में जानकारी प्रदान करता है। [Windows](../../system.windows/) केवल। यह एक सिंगलटन प्रकार है जिसमें मेमोरी प्रबंधन एक्सेस फ़ंक्शन(s) द्वारा किया जाता है। आपको इसे सीधे इंस्टेंस बनाना नहीं चाहिए।
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | स्क्रीन की सीमा प्राप्त करता है। |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | प्राथमिक डिस्प्ले की जानकारी प्राप्त करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट तर्क को एक कमजोर पॉइंटर (शेयर किए हुए के बजाय) सेट करता है। कंटेनरों में पॉइंटर को कमजोर मोड में स्विच करने की अनुमति देता है। |
