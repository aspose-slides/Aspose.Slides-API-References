...
description: "RFC2616 HTTP कैशिंग सेमांटिक को व्यक्त करने वाली HTTP कैश नीति। इस क्लास की वस्तुओं को केवल System::MakeObject() फ़ंक्शन का उपयोग करके ही आवंटित किया जाना चाहिए। इस प्रकार का इंस्टेंस स्टैक पर या operator new का उपयोग करके कभी नहीं बनाना चाहिए, क्योंकि इससे रनटाइम त्रुटियां और/या असर्शन फॉल्ट्स हो सकते हैं। हमेशा इस क्लास को System::SmartPtr पॉइंटर में घेरें और इस पॉइंटर का उपयोग फ़ंक्शन्स में तर्क के रूप में पास करें।"
type: docs
weight: 1
url: /hi/system.net.cache/httprequestcachepolicy/
---
## HttpRequestCachePolicy क्लास
...
| [DateTime](../../system/datetime/) [get_CacheSyncDate](./get_cachesyncdate/)() const | कैश में संग्रहीत संसाधनों को पुनःमान्य करने के समय को प्राप्त करता है। |
| [DateTime](../../system/datetime/) [get_InternalCacheSyncDateUtc](./get_internalcachesyncdateutc/)() const | UTC प्रारूप में समय प्राप्त करता है जब कैश में संग्रहीत संसाधनों को पुनःमान्य करना आवश्यक होता है। केवल आंतरिक उपयोग के लिए। |
| [HttpRequestCacheLevel](../httprequestcachelevel/) [get_Level](./get_level/)() const | निर्दिष्ट HttpRequestCacheLevel मान प्राप्त करता है। |
| [RequestCacheLevel](../requestcachelevel/) [get_Level](../requestcachepolicy/get_level/)() | निर्दिष्ट RequestCacheLevel मान प्राप्त करता है। |
| [TimeSpan](../../system/timespan/) [get_MaxAge](./get_maxage/)() const | संसाधन के लिए अनुमत अधिकतम आयु प्राप्त करता है। |
| [TimeSpan](../../system/timespan/) [get_MaxStale](./get_maxstale/)() const | संसाधन के लिए अनुमत अधिकतम स्टेलनेस मान प्राप्त करता है। |
| [TimeSpan](../../system/timespan/) [get_MinFresh](./get_minfresh/)() const | संसाधन के लिए अनुमत न्यूनतम आयु प्राप्त करता है। |
...
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)() | एक नया इंस्टेंस बनाता है। |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpRequestCacheLevel](../httprequestcachelevel/)) | एक नया इंस्टेंस बनाता है। |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpCacheAgeControl](../httpcacheagecontrol/), [TimeSpan](../../system/timespan/)) | एक नया इंस्टेंस बनाता है। |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpCacheAgeControl](../httpcacheagecontrol/), [TimeSpan](../../system/timespan/), [TimeSpan](../../system/timespan/)) | एक नया इंस्टेंस बनाता है। |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([DateTime](../../system/datetime/)) | एक नया इंस्टेंस बनाता है। |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpCacheAgeControl](../httpcacheagecontrol/), [TimeSpan](../../system/timespan/), [TimeSpan](../../system/timespan/), [DateTime](../../system/datetime/)) | एक नया इंस्टेंस बनाता है। |
...
|  [RequestCachePolicy](../requestcachepolicy/requestcachepolicy/)() | एक नया इंस्टेंस बनाता है। |
|  [RequestCachePolicy](../requestcachepolicy/requestcachepolicy/)([RequestCacheLevel](../requestcachelevel/)) | निर्दिष्ट RequestCacheLevel मान के साथ नया इंस्टेंस बनाता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट आर्ग्यूमेंट को कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनर्स में पॉइंटर्स को कमजोर मोड में स्विच करने की अनुमति देता है। |
...
* क्लास [RequestCachePolicy](../requestcachepolicy/)
