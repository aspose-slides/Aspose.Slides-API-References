...
description: सेव के दौरान यह निर्धारित करने के लिए उपयोग किया जाने वाला कॉलबैक इंटरफ़ेस कि वस्तु को कैसे प्रोसेस किया जाना चाहिए।
type: docs
weight: 248
...
सहेजने के दौरान वस्तु को कैसे प्रोसेस किया जाना चाहिए, यह निर्धारित करने के लिए उपयोग किया जाने वाला कॉलबैक इंटरफ़ेस।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 के अनुसार NaN किसी भी मान, यहाँ तक कि NaN के बराबर नहीं होता, फिर भी दो NaN को बराबर मानते हुए C#-शैली का फ़्लोटिंग पॉइंट तुलना अनुकरण करता है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 के अनुसार NaN किसी भी मान, यहाँ तक कि NaN के बराबर नहीं होता, फिर भी दो NaN को बराबर मानते हुए C#-शैली का फ़्लोटिंग पॉइंट तुलना अनुकरण करता है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | वस्तु से सम्बंधित रेफरेंस काउंटर डेटा संरचना प्राप्त करता है। |
...
| virtual [LinkEmbedDecision](../linkembeddecision/) [GetObjectStoringLocation](./getobjectstoringlocation/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) | निर्धारित करता है कि वस्तु को कहां संग्रहित किया जाना चाहिए। यह मेथड प्रत्येक वस्तु आईडी के लिए एक बार बुलाया जाता है। यह गारंटी नहीं है कि समान डेटा, semanticName और contentType वाली दो वस्तुएँ विभिन्न आईडी के साथ नहीं होंगी। |
...
| virtual [System::String](../../system/string/) [GetUrl](./geturl/)(**int32_t**, **int32_t**) | बाहरी वस्तु का URL लौटाता है। यह मेथड हमेशा तब कॉल किया जाता है जब [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/) ने [LinkEmbedDecision::Link](../linkembeddecision/) लौटाया हो और संभव है कि [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/) ने [LinkEmbedDecision::Embed](../linkembeddecision/) लौटाया हो लेकिन एम्बेडिंग असंभव है। समान वस्तु आईडी के लिए इसे कई बार कॉल किया जा सकता है। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कंस्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, बस नई वस्तु को आरम्भ करता है और सबक्लास की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, बस नई वस्तु को आरम्भ करता है और सबक्लास की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | रेफ़रेंस के माध्यम से वैल्यू टाइप वस्तु की nullptr के साथ तुलना करता है। |
...
| virtual void [SaveExternal](./saveexternal/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | बाहरी वस्तु को सहेजता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्पलेट आर्ग्यूमेंट को weak पॉइंटर सेट करता है (shared के बजाय)। कंटेनरों में पॉइंटर्स को weak मोड में बदलने की अनुमति देता है। |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | weak रेफ़रेंस काउंटर को घटाता है। इसे सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय स्मार्ट पॉइंटर्स और ThisProtector का उपयोग करें। |
