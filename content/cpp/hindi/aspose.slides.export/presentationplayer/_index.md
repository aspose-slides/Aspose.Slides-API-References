...
description: प्रेजेंटेशन से जुड़े एनीमेशन का प्लेयर दर्शाता है।
type: docs
weight: 625
...
[Presentation](../../aspose.slides/presentation/) से जुड़े एनिमेशन का प्लेयर दर्शाता है।
...
| मेथड | विवरण |
| --- | --- |
| void [Dispose](./dispose/)() override | [PresentationPlayer](./) की इंस्टेंस को नष्ट करता है। |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, यहाँ तक कि NaN को भी, बराबर नहीं होता। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, यहाँ तक कि NaN को भी, बराबर नहीं होता। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक उपयोग के लिए। |
| **int32_t** [get_FrameIndex](./get_frameindex/)() | फ़्रेम इंडेक्स प्राप्त करता है। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, बस नया ऑब्जेक्ट आरंभ करता है और सबक्लासों के कॉपी निर्माण को सक्षम करता है। |
...
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | [PresentationPlayer](./) का नया इंस्टेंस बनाता है। |
...
| टाइपडिफ़ | विवरण |
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | **PresentationPlayer::FrameTick** इवेंट के फ्रेम टिक हैंडलर का प्रतिनिधित्व करता है। |
