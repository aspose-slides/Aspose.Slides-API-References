...
[VideoPlayerHtmlController](../videoplayerhtmlcontroller/) बनाने की अनुमति देता है।

```cpp
class VideoPlayerHtmlControllerFactory : public Aspose::Slides::Export::IVideoPlayerHtmlControllerFactory
```
...
| मेथड | विवरण |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVideoPlayerHtmlController](../ivideoplayerhtmlcontroller/)\> [CreateVideoPlayerHtmlController](./createvideoplayerhtmlcontroller/)([System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) override | नया **[VideoPlayerHtmlController](../videoplayerhtmlcontroller/)** बनाता है। |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 के अनुसार NaN किसी भी मान, यहाँ तक कि NaN के बराबर नहीं होता, फिर भी दो NaN को समान मान कर C#-शैली का फ्लोटिंग पॉइंट तुलना एмуляट करता है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 के अनुसार NaN किसी भी मान, यहाँ तक कि NaN के बराबर नहीं होता, फिर भी दो NaN को समान मान कर C#-शैली का फ्लोटिंग पॉइंट तुलना एмуляट करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nth टेम्पलेट आर्ग्यूमेंट को कमजोर पॉइंटर (शेयर के बजाय) सेट करता है। कंटेनर्स में पॉइंटर्स को कमजोर मोड में स्विच करने की अनुमति देता है। |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | साझा रेफ़रेंस काउंट को घटाकर वापस करता है। इसे सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
...
* क्लास [IVideoPlayerHtmlControllerFactory](../ivideoplayerhtmlcontrollerfactory/)
