...
description: HTML फ़ाइल टेम्पलेट को दर्शाता है।
type: docs
weight: 92
...
| विधि | विवरण |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateCustomFormatter](./createcustomformatter/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | कस्टम कॉलबैक-ड्रिवेन HTML जनरेशन के लिए HTML फ़ॉर्मेटर बनाता और लौटाता है। |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateDocumentFormatter](./createdocumentformatter/)([System::String](../../system/string/), **bool**) | एक सरल दस्तावेज़ दृश्य के लिए HTML फ़ॉर्मेटर बनाता और लौटाता है जिसमें स्लाइड्स की क्रमिक श्रृंखला एक के नीचे एक होती है। |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateSlideShowFormatter](./createslideshowformatter/)([System::String](../../system/string/), **bool**) | एक सरल स्लाइड शो HTML के लिए HTML फ़ॉर्मेटर बनाता और लौटाता है जो स्लाइड्स को क्रमशः दिखाता है। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ के कॉपी कन्स्ट्रक्टिंग को सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ के कॉपी कन्स्ट्रक्टिंग को सक्षम करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्यूमेंट को एक कमजोर पॉइंटर (शेयर्ड के बजाय) सेट करता है। कंटेनरों में पॉइंटर को कमजोर मोड में बदलने की अनुमति देता है। |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | वीकम रेफ़रेंस काउंट को बढ़ाता है। सीधे कॉल नहीं करना चाहिए; इसके बजाय स्मार्ट पॉइंटर्स और ThisProtector का उपयोग करें। |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | वीकम रेफ़रेंस काउंट को घटाता है। सीधे कॉल नहीं करना चाहिए; इसके बजाय स्मार्ट पॉइंटर्स और ThisProtector का उपयोग करें। |
| virtual  [~Object](../../system/object/~object/)() | ऑब्जेक्ट को नष्ट करता है। सभी आंतरिक डेटा संरचनाओं को मुक्त करता है। |

## देखें भी

* वर्ग [IHtmlFormatter](../ihtmlformatter/)
