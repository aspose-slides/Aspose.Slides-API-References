...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | निर्दिष्ट करता है कि पृष्ठ [HandoutType](../handouttype/) पर कितनी स्लाइड्स और किस क्रम में रखी जाएँगी। |
| **bool** [get_PrintComments](./get_printcomments/)() const | निर्दिष्ट करता है कि स्लाइड्स पर टिप्पणी प्रदर्शित करनी है या नहीं |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | निर्दिष्ट करता है कि प्रदर्शित स्लाइड्स के आसपास फ्रेम खींचना है या नहीं। |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | निर्दिष्ट करता है कि प्रदर्शित स्लाइड नंबर प्रिंट करने हैं या नहीं। |
...
| void [Lock](../../system/object/lock/)() | C# lock() स्टेटमेंट के लॉकिंग को लागू करता है। इसे सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेंटीनी ऑब्जेक्ट का उपयोग करें। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रकटर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी निर्माण को सक्षम करता है। |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | निर्दिष्ट करता है कि पृष्ठ [HandoutType](../handouttype/) पर कितनी स्लाइड्स और किस क्रम में रखी जाएँगी। |
| void [set_PrintComments](./set_printcomments/)(**bool**) | निर्दिष्ट करता है कि स्लाइड्स पर टिप्पणी प्रदर्शित करनी है या नहीं |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | निर्दिष्ट करता है कि प्रदर्शित स्लाइड्स के आसपास फ्रेम खींचना है या नहीं। |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | निर्दिष्ट करता है कि प्रदर्शित स्लाइड नंबर प्रिंट करने हैं या नहीं। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट तर्क को weak पॉइंटर सेट करता है (shared के बजाय)। कंटेनरों में पॉइंटर्स को weak मोड में बदलने की अनुमति देता है। |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() स्टेटमेंट के अनलॉकिंग को लागू करता है। इसे सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेंटीनी ऑब्जेक्ट का उपयोग करें। |
