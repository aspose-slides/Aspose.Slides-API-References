...
| virtual [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() | स्लाइड अभिविन्यास प्राप्त करता है। |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | स्लाइड आयाम पॉइंट्स में प्राप्त करता है। नया मान असाइन करने पर [ISlideSize::get_Type](./get_type/) मान को [SlideSizeType::Custom](../slidesizetype/) पर रीसेट करता है और [ISlideSize::get_Orientation](./get_orientation/) सेट करता है। |
| virtual [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() | स्लाइड आकार प्रकार प्राप्त करता है। [SlideSizeType::Custom](../slidesizetype/) को छोड़कर कोई भी मान असाइन करने पर पूर्वनिर्धारित आयामों के अनुसार [ISlideSize::get_Size](./get_size/) को समायोजित करता है, जबकि वर्तमान [ISlideSize::get_Orientation](./get_orientation/) को बरकरार रखता है। |
...
| virtual void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) | स्लाइड अभिविन्यास सेट करता है। |
| virtual void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) | टाइप द्वारा स्लाइड आकार सेट करता है और मौजूदा कंटेंट को स्केल करता है। [SlideSizeType::Custom](../slidesizetype/) के अलावा कोई भी मान असाइन करने पर चयनित टाइप के आधार पर [ISlideSize::get_Size](./get_size/) को समायोजित करता है, जबकि [ISlideSize::get_Orientation](./get_orientation/) को संरक्षित रखता है। |
| virtual void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) | स्लाइड आयाम को स्पष्ट रूप से सेट करता है और मौजूदा कंटेंट को स्केल करता है। यह [ISlideSize::get_Type](./get_type/) मान को [SlideSizeType::Custom](../slidesizetype/) पर रीसेट करता है और [ISlideSize::get_Orientation](./get_orientation/) को सेट करता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट आर्ग्युमेंट को एक कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनर में पॉइंटर्स को कमजोर मोड में बदलने की अनुमति देता है। |
