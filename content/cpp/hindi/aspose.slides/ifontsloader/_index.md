...
description: उपयोगकर्ता द्वारा परिभाषित कस्टम फ़ॉन्ट लोड करने के लिए क्लास। किसी भी प्रस्तुति वस्तु को बनाने से पहले इसे उपयोग किया जाना चाहिए।
type: docs
weight: 2237
...
उपयोगकर्ता द्वारा परिभाषित कस्टम फ़ॉन्ट लोड करने के लिए क्लास। किसी भी प्रस्तुति वस्तु को बनाने से पहले इसे उपयोग करना चाहिए।
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | वस्तु के साथ संबंधित रेफ़रेंस काउंटर डेटा संरचना प्राप्त करता है। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचें कि वस्तु targetType द्वारा वर्णित प्रकार का एक उदाहरण है या नहीं। C# 'is' ऑपरेटर का तुल्य। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | नवें टेम्पलेट तर्क को वीक पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को वीक मोड में बदलने की अनुमति देता है। |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) मेथड का तुल्य। कस्टम वस्तुओं को स्ट्रिंग में बदलने को सक्षम करता है। |
