...
description: प्रस्तुति में सभी लेआउट स्लाइड्स का संग्रह दर्शाता है। ILayoutSlideCollection इंटरफ़ेस को विस्तारित करता है जिसमें लेआउट स्लाइड्स को जोड़ने/क्लोन करने के लिए मेथड्स शामिल हैं, जो मास्टर के लेआउट स्लाइड्स के व्यक्तिगत संग्रहों को मिलाने के संदर्भ में उपयोग होते हैं।
type: docs
weight: 2367
url: /hi/aspose.slides/igloballayoutslidecollection/
---
## IGlobalLayoutSlideCollection क्लास

प्रस्तुति में सभी लेआउट स्लाइड्स का संग्रह दर्शाता है। [ILayoutSlideCollection](../ilayoutslidecollection/) इंटरफ़ेस को विस्तारित करता है जिसमें लेआउट स्लाइड्स को जोड़ने/क्लोन करने के लिये मेथड्स शामिल हैं, जो मास्टर के लेआउट स्लाइड्स के व्यक्तिगत संग्रहों को मिलाने के संदर्भ में उपयोग होते हैं।
...
| मेथड | विवरण |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Adds a new layout slide to the presentation. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Adds a copy of a specified layout slide to the presentation. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Adds a copy of a specified layout slide to the presentation. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../ilayoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) | Returns the first layout slide of specified type. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../ilayoutslidecollection/idx_get/)(**int32_t**) | Returns the layout slide by index. Read-only [ILayoutSlide](../ilayoutslide/). |
...
| virtual void [Remove](../ilayoutslidecollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Removes a layout from the collection. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Decreases shared reference count by specified value. |
| virtual void [RemoveUnused](../ilayoutslidecollection/removeunused/)() | Removes unused layout slides (layout slides whose HasDependingSlides is false). |
