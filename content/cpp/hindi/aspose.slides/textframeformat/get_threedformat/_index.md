...
description: टेक्स्ट के लिये 3d इफ़ेक्ट गुणों को दर्शाने वाला ThreeDFormat ऑब्जेक्ट लौटाता है। केवल पढ़ने योग्य IThreeDFormat.
type: docs
weight: 1
url: /hi/aspose.slides/textframeformat/get_threedformat/
---
## TextFrameFormat::get_ThreeDFormat() मेथड

टेक्स्ट के लिए 3d इफ़ेक्ट गुणों को दर्शाने वाला [ThreeDFormat](../../threedformat/) ऑब्जेक्ट लौटाता है। केवल पढ़ने योग्य [IThreeDFormat](../../ithreedformat/)।
