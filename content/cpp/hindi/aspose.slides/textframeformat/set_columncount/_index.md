...
description: टेक्स्ट क्षेत्र में कॉलमों की संख्या सेट करता है। यह मान एक सकारात्मक संख्या होना चाहिए। अन्यथा, मान को शून्य पर सेट किया जाएगा। मान 0 का अर्थ अपरिभाषित मान है। लिखें int32_t.
type: docs
weight: 261
url: /hi/aspose.slides/textframeformat/set_columncount/
---
## TextFrameFormat::set_ColumnCount(int32_t) विधि


टेक्स्ट क्षेत्र में कॉलमों की संख्या सेट करता है। यह मान एक सकारात्मक संख्या होना चाहिए। अन्यथा, मान को शून्य पर सेट किया जाएगा। मान 0 का अर्थ अपरिभाषित मान है। लिखें **int32_t**।
...
निम्नलिखित नमूना कोड दिखाता है कि PowerPoint [Presentation](../../presentation/) के भीतर टेक्स्ट फ़्रेम में कॉलम कैसे जोड़ें। 
```cpp
