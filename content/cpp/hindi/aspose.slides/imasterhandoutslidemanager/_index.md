...
description: मुख्य हैंडआउट स्लाइड प्रबंधक।
type: docs
weight: 2861
url: /hi/aspose.slides/imasterhandoutslidemanager/
---
## IMasterHandoutSlideManager क्लास

मुख्य हैंडआउट स्लाइड प्रबंधक।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली का फ्लोटिंग पॉइंट तुलना अनुकरण करती है जहाँ दो NaN को बराबर माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, सहित NaN, के बराबर नहीं होता। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली का फ्लोटिंग पॉइंट तुलना अनुकरण करती है जहाँ दो NaN को बराबर माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, सहित NaN, के बराबर नहीं होता। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक उपयोग के लिए। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [get_MasterHandoutSlide](./get_masterhandoutslide/)() | यदि मौजूद हो तो इस प्रेजेंटेशन की सभी नोट्स स्लाइड्स के लिए एक मास्टर लौटाता है, अन्यथा null लौटाता है। पढ़ने-के-लिए-केवल [IMasterHandoutSlide](../imasterhandoutslide/)। |
...
| virtual void [RemoveMasterHandoutSlide](./removemasterhandoutslide/)() | मास्टर हैंडआउट स्लाइड को हटाता है। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [SetDefaultMasterHandoutSlide](./setdefaultmasterhandoutslide/)() | डिफ़ॉल्ट मास्टर हैंडआउट स्लाइड को संबंधित हैंडआउट स्लाइड पर सेट करता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट तर्क को एक वीक पॉइंटर (शेयर किए गए के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को वीक मोड में बदलने की अनुमति देता है। |
