...
description: अपरिवर्तनीय ऑब्जेक्ट जिसमें प्रभावी लाइन स्केच गुण होते हैं।
type: docs
weight: 3745
url: /hi/aspose.slides/isketchformateffectivedata/
---
## ISketchFormatEffectiveData क्लास


इम्म्युटेबल ऑब्जेक्ट जो प्रभावी लाइन स्केच गुणों को सम्मिलित करता है।
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | स्केच प्रकार लौटाता है। केवल पढ़ने योग्य [Slides::LineSketchType](../linesketchtype/)। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि क्या ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का एक इंस्टेंस है। C# 'is' ऑपरेटर का समतुल्य। |
| void [Lock](../../system/object/lock/)() | C# lock() बयान के लॉक को लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट का उपयोग करें। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्यूमेंट को एक वीक पॉइंटर सेट करता है (शेयर किए हुए के बजाय)। कंटेनरों में पॉइंटर्स को वीक मोड में बदलना सक्षम करता है। |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() बयान के अनलॉक को लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट का उपयोग करें। |
...
| virtual  [~Object](../../system/object/~object/)() | ऑब्जेक्ट को नष्ट करता है। सभी आंतरिक डेटा संरचनाओं की मुक्त करता है। |
