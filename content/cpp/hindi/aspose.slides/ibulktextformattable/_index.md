...
description: एक ऑब्जेक्ट का प्रतिनिधित्व करता है जिसमें चाइल्ड टेक्स्ट एलिमेंट्स के फॉर्मैट को बल्क सेट करने की संभावना होती है।
type: docs
weight: 1548
url: /hi/aspose.slides/ibulktextformattable/
---
## IBulkTextFormattable क्लास
...
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | परिभाषित पोर्शन फॉर्मेट प्रॉपर्टी को सभी एलिमेंट के पोर्शन पर सेट करता है। |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | परिभाषित पैराग्राफ फॉर्मेट प्रॉपर्टी को सभी एलिमेंट के पैराग्राफ पर सेट करता है। |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | परिभाषित टेक्स्ट फ्रेम फॉर्मेट प्रॉपर्टी को सभी एलिमेंट के टेक्स्ट फ्रेम पर सेट करता है। |
| int [SharedCount](../../system/object/sharedcount/)() const | शेयरड रेफ़रेंस काउंटर का वर्तमान मान प्राप्त करता है। |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | शेयरड रेफ़रेंस काउंट बढ़ाता है। इसे सीधे नहीं बुलाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर या ThisProtector का उपयोग करें। |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | शेयरड रेफ़रेंस काउंट घटाता है और उसे लौटाता है। इसे सीधे नहीं बुलाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर या ThisProtector का उपयोग करें। |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | वीक रेफ़रेंस काउंट बढ़ाता है। इसे सीधे नहीं बुलाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर या ThisProtector का उपयोग करें। |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | वीक रेफ़रेंस काउंट घटाता है। इसे सीधे नहीं बुलाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर या ThisProtector का उपयोग करें। |
