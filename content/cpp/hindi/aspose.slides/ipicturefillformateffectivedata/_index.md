...
description: अपरिवर्तनीय वस्तु जो चित्र भराव की गुणधर्मों को समाहित करती है।
type: docs
weight: 3238
url: /hi/aspose.slides/ipicturefillformateffectivedata/
---
## IPictureFillFormatEffectiveData वर्ग

एक अपरिवर्तनीय वस्तु जो चित्र भराव की गुणधर्मों को समाहित करती है।
...
| virtual **float** [get_CropBottom](./get_cropbottom/)() | चित्र के नीचे से काटे गए वास्तविक चित्र ऊँचाई के प्रतिशत की संख्या लौटाता है। केवल-पढ़ने योग्य **float**। |
| virtual **float** [get_CropLeft](./get_cropleft/)() | चित्र के बाएँ से काटे गए वास्तविक चित्र चौड़ाई के प्रतिशत की संख्या लौटाता है। केवल-पढ़ने योग्य **float**। |
| virtual **float** [get_CropRight](./get_cropright/)() | चित्र के दाएँ से काटे गए वास्तविक चित्र चौड़ाई के प्रतिशत की संख्या लौटाता है। केवल-पढ़ने योग्य **float**। |
| virtual **float** [get_CropTop](./get_croptop/)() | चित्र के ऊपर से काटे गए वास्तविक चित्र ऊँचाई के प्रतिशत की संख्या लौटाता है। केवल-पढ़ने योग्य **float**। |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | वह dpi लौटाता है जो चित्र को भरने के लिए उपयोग किया जाता है। केवल-पढ़ने योग्य **int32_t**। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | चित्र लौटाता है। केवल-पढ़ने योग्य [IPictureEffectiveData](../ipictureeffectivedata/)। |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | चित्र भराव मोड लौटाता है। केवल-पढ़ने योग्य [Slides::PictureFillMode](../picturefillmode/)। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जांचता है कि वस्तु targetType द्वारा वर्णित प्रकार का उदाहरण है या नहीं। C# 'is' ऑपरेटर का समान। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्युमेंट को कमजोर पॉइंटर (शेयर्ड के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को कमजोर मोड में स्विच करने की अनुमति देता है। |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() स्टेटमेंट अनलॉक करना लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट का उपयोग करें। |
...
यह इंटरफ़ेस [IFillFormatEffectiveData](../ifillformateffectivedata/) का एक भाग के रूप में उपयोग किया जाता है। 
## देखें
