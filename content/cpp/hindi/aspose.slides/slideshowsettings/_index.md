...
description: प्रेजेंटेशन के स्लाइड शो सेटिंग्स का प्रतिनिधित्व करता है।
type: docs
weight: 5214
...
प्रेजेंटेशन के स्लाइड शो सेटिंग्स का प्रतिनिधित्व करता है।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 के अनुसार NaN किसी भी मूल्य के बराबर नहीं होता, जिसमें NaN भी शामिल है, लेकिन दो NaN को बराबर माना जाता है, इस प्रकार C#-शैली का फ़्लोटिंग पॉइंट तुलना अनुकरण करता है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 के अनुसार NaN किसी भी मूल्य के बराबर नहीं होता, जिसमें NaN भी शामिल है, लेकिन दो NaN को बराबर माना जाता है, इस प्रकार C#-शैली का फ़्लोटिंग पॉइंट तुलना अनुकरण करता है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| **bool** [get_Loop](./get_loop/)() | लूप [Slide](../slide/) शो |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_PenColor](./get_pencolor/)() | पेन रंग के लिए [Slide](../slide/) शो |
| **bool** [get_ShowAnimation](./get_showanimation/)() | शो [Animation](../../aspose.slides.animation/) में [Slide](../slide/) शो |
| **bool** [get_ShowMediaControls](./get_showmediacontrols/)() const | मीडिया नियंत्रण दिखाएँ |
| **bool** [get_ShowNarration](./get_shownarration/)() | नैरेशन को [Slide](../slide/) शो में दिखाएँ |
| [System::SharedPtr](../../system/sharedptr/)\<[SlidesRange](../slidesrange/)\> [get_Slides](./get_slides/)() const | [Slides](../) रेंज |
| [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::SlideShowType](../slideshowtype/)\> [get_SlideShowType](./get_slideshowtype/)() | स्लाइड शो प्रकार प्राप्त करता है। निम्नलिखित [SlideShowType](../slideshowtype/) पूर्वज द्वारा प्रदर्शित: [BrowsedAtKiosk](../browsedatkiosk/), [PresentedBySpeaker](../presentedbyspeaker/) और [BrowsedByIndividual](../browsedbyindividual/) |
| **bool** [get_UseTimings](./get_usetimings/)() | [Slide](../slide/) शो में टाइमिंग का उपयोग करें |
...
| void [set_Loop](./set_loop/)(**bool**) | लूप [Slide](../slide/) शो |
| void [set_ShowAnimation](./set_showanimation/)(**bool**) | शो [Animation](../../aspose.slides.animation/) को [Slide](../slide/) शो में दिखाएँ |
| void [set_ShowMediaControls](./set_showmediacontrols/)(**bool**) | मीडिया नियंत्रण दिखाएँ |
| void [set_ShowNarration](./set_shownarration/)(**bool**) | नैरेशन को [Slide](../slide/) शो में दिखाएँ |
| void [set_Slides](./set_slides/)([System::SharedPtr](../../system/sharedptr/)\<[SlidesRange](../slidesrange/)\>) | [Slides](../) रेंज |
| void [set_SlideShowType](./set_slideshowtype/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::SlideShowType](../slideshowtype/)\>) | स्लाइड शो प्रकार सेट करता है। निम्नलिखित [SlideShowType](../slideshowtype/) पूर्वज द्वारा प्रदर्शित: [BrowsedAtKiosk](../browsedatkiosk/), [PresentedBySpeaker](../presentedbyspeaker/) और [BrowsedByIndividual](../browsedbyindividual/) |
| void [set_UseTimings](./set_usetimings/)(**bool**) | [Slide](../slide/) शो में टाइमिंग का उपयोग करें |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्गुमेंट को weak पॉइंटर (shared के बजाय) सेट करता है। कंटेनरों में पॉइंटर को weak मोड में बदलना सक्षम करता है। |
