...
| मेथड | विवरण |
| --- | --- |
|  [DigitalSignature](./digitalsignature/)([System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\>) | निर्दिष्ट प्रमाणपत्र के साथ नया [DigitalSignature](./) ऑब्जेक्ट बनाता है। |
|  [DigitalSignature](./digitalsignature/)([System::String](../../system/string/), [System::String](../../system/string/)) | निर्दिष्ट प्रमाणपत्र फ़ाइल पथ और पासवर्ड के साथ नया [DigitalSignature](./) ऑब्जेक्ट बनाता है। |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\> [get_Certificate](./get_certificate/)() override | दस्तावेज़ पर हस्ताक्षर करने के लिए उपयोग किया गया प्रमाणपत्र ऑब्जेक्ट। केवल-पढ़ने योग्य [X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)। |
| [System::String](../../system/string/) [get_Comments](./get_comments/)() override | हस्ताक्षर का उद्देश्य। पढ़ें [System::String](../../system/string/)। |
| **bool** [get_IsValid](./get_isvalid/)() override | यदि यह डिजिटल हस्ताक्षर वैध है और दस्तावेज़ में छेड़छाड़ नहीं हुई है, तो यह मान true होगा। केवल-पढ़ने योग्य **bool**। |
| [System::DateTime](../../system/datetime/) [get_SignTime](./get_signtime/)() override | दस्तावेज़ पर हस्ताक्षर किए जाने का समय। केवल-पढ़ने योग्य [System::DateTime](../../system/datetime/)। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कंस्ट्रक्टर। वास्तव में कुछ नहीं कॉपी करता, बस नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ को कॉपी कंस्ट्रक्ट करने में सक्षम बनाता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ नहीं कॉपी करता, बस नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ को कॉपी कंस्ट्रक्ट करने में सक्षम बनाता है। |
...
| void [set_Comments](./set_comments/)([System::String](../../system/string/)) override | हस्ताक्षर का उद्देश्य। लिखें [System::String](../../system/string/)। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्गुमेंट को कमजोर पॉइंटर सेट करता है (साझा के बजाय)। कंटेनरों में पॉइंटर्स को कमजोर मोड में बदलने की अनुमति देता है। |
...
निम्न उदाहरण दिखाता है कि PowerPoint [Presentation](../presentation/) में PFX प्रमाणपत्र से डिजिटल हस्ताक्षर कैसे जोड़ें। 
```cpp
// Presentation इंस्टेंस को इनिशियलाइज़ करें
...
```
निम्न नमूना कोड दिखाता है कि PowerPoint [Presentation](../presentation/) का डिजिटल हस्ताक्षर कैसे मान्य करें। 
```cpp
// Presentation इंस्टेंस को इनिशियलाइज़ करें
