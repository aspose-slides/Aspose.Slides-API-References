...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | बंद कैप्शन का बाइनरी डेटा लौटाता है। केवल पढ़ने के लिए **uint8_t**[]। |
| [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() override | बंद कैप्शन का ग्लोबली यूनिक आइडेंटिफायर (GUID) लौटाता है। केवल पढ़ने के लिए [System::Guid](../../system/guid/)। |
| [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() override | बंद कैप्शन डेटा को UTF-8 एन्कोडेड स्ट्रिंग के रूप में लौटाता है। केवल पढ़ने के लिए [System::String](../../system/string/)। |
| [System::String](../../system/string/) [get_Label](./get_label/)() override | बंद कैप्शन का लेबल लौटाता है। पढ़ें [System::String](../../system/string/)। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जांचता है कि ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का इंस्टेंस है या नहीं। C# 'is' ऑपरेटर का तुल्य। |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) मेथड का तुल्य। कस्टम टाइप्स के क्लोनिंग को सक्षम करता है। |
...
| void [set_Label](./set_label/)([System::String](../../system/string/)) override | बंद कैप्शन का लेबल सेट करता है। लिखें [System::String](../../system/string/)। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्युमेंट को वीक पॉइंटर (शेयर्ड के बजाय) सेट करता है। कंटेनर्स में पॉइंटर को वीक मोड में स्विच करने की अनुमति देता है। |
