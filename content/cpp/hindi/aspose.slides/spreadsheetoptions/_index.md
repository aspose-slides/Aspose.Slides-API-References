...
description: वह विकल्प दर्शाता है जिनका उपयोग अतिरिक्त स्प्रेडशीट व्यवहार को निर्दिष्ट करने के लिए किया जा सकता है।
type: docs
weight: 5266
url: /hi/aspose.slides/spreadsheetoptions/
---
## SpreadsheetOptions वर्ग
...
| Method | वर्णन |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | C# [Object.Equals](../../system/object/equals/) मानकों का उपयोग करके वस्तुओं की तुलना करता है। |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली की फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली की फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक उपयोग के लिए। |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() override | डबल-बाइट कैरेक्टर सेट (DBCS) का उपयोग करने वाली भाषाओं के लिए उद्देशनिर्दिष्ट कुछ फ़ंक्शन की गणना हेतु पसंदीदा संस्कृति जानकारी प्राप्त करता है। |
| **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() override | यदि चार्ट के लिए डेटा स्रोत बाहरी वर्कबुक है और उपलब्ध नहीं है, तो इसे चार्ट कैश से पुनः प्राप्त किया जाएगा। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कंस्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लास के कॉपी निर्माण को सक्षम करता है। |
...
| void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) override | डबल-बाइट कैरेक्टर सेट (DBCS) का उपयोग करने वाली भाषाओं के लिए उद्देशनिर्दिष्ट कुछ फ़ंक्शन की गणना हेतु पसंदीदा संस्कृति जानकारी प्राप्त करता है। |
| void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) override | यदि चार्ट के लिए डेटा स्रोत बाहरी वर्कबुक है और उपलब्ध नहीं है, तो इसे चार्ट कैश से पुनः प्राप्त किया जाएगा। |
...
|  [SpreadsheetOptions](./spreadsheetoptions/)() | [SpreadsheetOptions](./) वर्ग की नई इंस्टेंस को प्रारम्भ करता है। |
...
* वर्ग [ISpreadsheetOptions](../ispreadsheetoptions/)
