...
description: एक ज्यामिति आकृति के समायोजन मान को दर्शाता है। ये मान आकृति के रूप को प्रभावित करते हैं।
type: docs
weight: 1288
...
एक ज्यामिति आकृति के समायोजन मान को दर्शाता है। ये मान आकृति के रूप को प्रभावित करते हैं।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली का फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली का फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| virtual **float** [get_AngleValue](./get_anglevalue/)() | मान लौटाता है, इसे डिग्री में कोण के रूप में व्याख्या करता है। पढ़ें **float**। |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | इस समायोजन मान का नाम लौटाता है। केवल-पढ़ने योग्य [System::String](../../system/string/)। |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | समायोजन मान को "जैसा है" लौटाता है। पढ़ें **int64_t**। |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | आकृति समायोजन का प्रकार लौटाता है। केवल-पढ़ने योग्य [ShapeAdjustmentType](../shapeadjustmenttype/)। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का एक उदाहरण दर्शाता है या नहीं। C# 'is' ऑपरेटर का समानांतर। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ नहीं कॉपी करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ को कॉपी कंस्ट्रक्ट करने में सक्षम बनाता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ नहीं कॉपी करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ को कॉपी कंस्ट्रक्ट करने में सक्षम बनाता है। |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | मान सेट करता है, इसे डिग्री में कोण के रूप में व्याख्या करता है। लिखें **float**। |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | समायोजन मान को "जैसा है" सेट करता है। लिखें **int64_t**। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट आर्ग्युमेंट को एक वीक पॉइंटर सेट करता है (शेयर किए हुए के बजाय)। कंटेनर्स में पॉइंटर्स को वीक मोड में बदलने की अनुमति देता है। |
