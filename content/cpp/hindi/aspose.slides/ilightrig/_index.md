...
प्रस्तुत करता है [LightRig](../lightrig/)।
...
| virtual [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() | Light direction. पढ़ें [LightingDirection](../lightingdirection/)। |
| virtual [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() | एक प्रीसेट लाइट राइट को दर्शाता है जिसे आकृति पर लागू किया जा सकता है। लाइटRig एक समूह लाइट्स को दर्शाता है जो 3D सीन के सापेक्ष एक विशिष्ट तरीके से अभिमुखित होते हैं। पढ़ें [LightRigPresetType](../lightrigpresettype/)। |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | एक घूर्णन को अक्षांश निर्देशांक, देशांतर निर्देशांक, तथा अक्ष के चारों ओर एक क्रांति का उपयोग करके निर्धारित किया जाता है, जहाँ अक्षांश और देशांतर निर्देशांक होते हैं। लौटाए गए सरणी में पहला तत्व - अक्षांश, दूसरा - देशांतर, तिसरा - क्रांति। |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | स्ट्रिंग और nullptr के लिए [Object::ReferenceEquals](../../system/object/referenceequals/) का विशेषीकरण। |
...
| virtual void [set_Direction](./set_direction/)([LightingDirection](../lightingdirection/)) | Light direction. लिखें [LightingDirection](../lightingdirection/)। |
| virtual void [set_LightType](./set_lighttype/)([LightRigPresetType](../lightrigpresettype/)) | एक प्रीसेट लाइट राइट को दर्शाता है जिसे आकृति पर लागू किया जा सकता है। लाइटRig एक समूह लाइट्स को दर्शाता है जो 3D सीन के सापेक्ष एक विशिष्ट तरीके से अभिमुखित होते हैं। लिखें [LightRigPresetType](../lightrigpresettype/)। |
| virtual void [SetRotation](./setrotation/)(**float**, **float**, **float**) | एक घूर्णन को अक्षांश निर्देशांक, देशांतर निर्देशांक, तथा अक्ष के चारों ओर एक क्रांति का उपयोग करके निर्धारित किया जाता है, जहाँ अक्षांश और देशांतर निर्देशांक होते हैं। |
