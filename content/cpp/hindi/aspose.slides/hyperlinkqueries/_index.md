...
description: समाहित हाइपरलिंक्स तक आसान पहुंच प्रदान करता है।
type: docs
weight: 1262
...
| विधि | विवरण |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | C# [Object.Equals](../../system/object/equals/) semantics का उपयोग करके ऑब्जेक्ट की तुलना करता है। |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetAnyHyperlinks](./getanyhyperlinks/)() override | सभी [IHyperlinkContainer](../ihyperlinkcontainer/) सबऑब्जेक्ट प्राप्त करें जो नल नहीं होने वाले HyperlinkMouseOver को समाहित करते हैं। दिए गए [IHyperlinkContainer](../ihyperlinkcontainer/) ऑब्जेक्ट के साथ आप उसके हाइपरलिंक को (पढ़ें, अपडेट करें या हटाएँ) प्रबंधित कर सकते हैं। [IHyperlinkContainer](../ihyperlinkcontainer/) इंटरफ़ेस देखें। |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ऑब्जेक्ट से संबद्ध रिफ़रेंस काउंटर डेटा स्ट्रक्चर प्राप्त करता है। |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetHyperlinkClicks](./gethyperlinkclicks/)() override | सभी [IHyperlinkContainer](../ihyperlinkcontainer/) सबऑब्जेक्ट प्राप्त करें जो नल नहीं होने वाले HyperlinkClick को समाहित करते हैं। दिए गए [IHyperlinkContainer](../ihyperlinkcontainer/) ऑब्जेक्ट के साथ आप उसके हाइपरलिंक को (पढ़ें, अपडेट करें या हटाएँ) प्रबंधित कर सकते हैं। [IHyperlinkContainer](../ihyperlinkcontainer/) इंटरफ़ेस देखें। |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetHyperlinkMouseOvers](./gethyperlinkmouseovers/)() override | सभी [IHyperlinkContainer](../ihyperlinkcontainer/) सबऑब्जेक्ट प्राप्त करें जो नल नहीं होने वाले HyperlinkMouseOver को समाहित करते हैं। दिए गए [IHyperlinkContainer](../ihyperlinkcontainer/) ऑब्जेक्ट के साथ आप उसके हाइपरलिंक को (पढ़ें, अपडेट करें या हटाएँ) प्रबंधित कर सकते हैं। [IHyperlinkContainer](../ihyperlinkcontainer/) इंटरफ़ेस देखें। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जांचता है कि ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का उदाहरण है या नहीं। C# 'is' ऑपरेटर का समान। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कंस्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी कंस्ट्रक्शन सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट प्रारंभ करता है और सबक्लासेज़ की कॉपी कंस्ट्रक्शन सक्षम करता है। |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | ऑब्जेक्ट्स की रिफ़रेंस द्वारा तुलना करता है। |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | ऑब्जेक्ट्स की रिफ़रेंस द्वारा तुलना करता है। |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | वैल्यू टाइप ऑब्जेक्ट की nullptr के साथ रिफ़रेंस-तुलना करता है। |
...
| void [RemoveAllHyperlinks](./removeallhyperlinks/)() override | सभी समाहित HyperlinkClick और HyperlinkMouseOver हाइपरलिंक्स को हटाता है (सभी [IHyperlinkContainer](../ihyperlinkcontainer/) सबऑब्जेक्ट्स में). |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्दिष्ट मान द्वारा साझा रेफ़रेंस काउंटर को घटाता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्युमेंट को एक weak पॉइंटर सेट करता है (shared के बजाय)। कंटेनरों में पॉइंटर्स को weak मोड में स्विच करने की अनुमति देता है। |
...
* क्लास [IHyperlinkQueries](../ihyperlinkqueries/)
