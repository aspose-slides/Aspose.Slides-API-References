...
description: एक पाठ के लिए टैबुलेशन को दर्शाता है।
type: docs
weight: 3966
...
| विधि | विवरण |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | वर्तमान ऑब्जेक्ट की निर्दिष्ट ऑब्जेक्ट से तुलना करता है। |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | C# [Object.Equals](../../system/object/equals/) सिद्धांतों का प्रयोग करके ऑब्जेक्ट्स की तुलना करता है। |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली का फ्लोटिंग पॉइंट तुलना अनुकरण करता है जहाँ दो NaN को समान माना जाता है, हालाँकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली का फ्लोटिंग पॉइंट तुलना अनुकरण करता है जहाँ दो NaN को समान माना जाता है, हालाँकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | एक टैब का संरेखण शैली लौटाता है। पढ़ें [TabAlignment](../tabalignment/)। |
| virtual **double** [get_Position](./get_position/)() | एक टैब की स्थिति लौटाता है। इस गुण को असाइन करने से संग्रह में टैब का सूचकांक बदल सकता है और Enumerator अमान्य हो सकता है। पढ़ें **double**। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचें कि क्या ऑब्जेक्ट targetType द्वारा वर्णित प्रकार की एक इंस्टेंस दर्शाता है। C# 'is' ऑपरेटर का समानांतर। |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | एक टैब की संरेखण शैली सेट करता है। लिखें [TabAlignment](../tabalignment/)। |
| virtual void [set_Position](./set_position/)(**double**) | एक टैब की स्थिति सेट करता है। इस गुण को असाइन करने से संग्रह में टैब का सूचकांक बदल सकता है और Enumerator अमान्य हो सकता है। लिखें **double**। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट तर्क को एक कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर को कमजोर मोड में बदलने की अनुमति देता है। |
...
* वर्ग [IComparable](../../system/icomparable/)
