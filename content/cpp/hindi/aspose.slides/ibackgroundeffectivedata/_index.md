...
description: अपरिवर्तनीय ऑब्जेक्ट जिसमें प्रभावी पृष्ठभूमि गुण होते हैं।
type: docs
weight: 1418
url: /hi/aspose.slides/ibackgroundeffectivedata/
---
## IBackgroundEffectiveData क्लास

अपरिवर्तनीय ऑब्जेक्ट जिसमें प्रभावी पृष्ठभूमि गुण होते हैं।

```cpp
class IBackgroundEffectiveData : public Aspose::Slides::IFillParamSource
```
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormatEffectiveData](../ieffectformateffectivedata/)\> [get_EffectFormat](./get_effectformat/)() | प्रभावी इफ़ेक्ट फ़ॉर्मेट लौटाता है। केवल-पढ़ने योग्य [IEffectFormatEffectiveData](../ieffectformateffectivedata/)। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | प्रभावी फ़िल फ़ॉर्मेट लौटाता है। केवल-पढ़ने योग्य [IFillFormatEffectiveData](../ifillformateffectivedata/)। |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | स्ट्रिंग और नलपॉइंट के केस के लिए [Object::ReferenceEquals](../../system/object/referenceequals/) का विशिष्टकरण। |
...
यह इंटरफ़ेस [IBackground](../ibackground/) इंटरफ़ेस के साथ मिलकर प्रभावी फ़ॉर्मेटिंग मानों को लौटाने के लिए उपयोग किया जाता है, जिसमें विरासत लागू होती है।
