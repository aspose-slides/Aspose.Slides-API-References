...
description: किसी पाठ के लिए 3d इफ़ेक्ट गुणों को दर्शाने वाला ThreeDFormat ऑब्जेक्ट लौटाता है। केवल-पढ़ने योग्य IThreeDFormat।
type: docs
weight: 300
url: /hi/aspose.slides/itextframeformat/get_threedformat/
---
## ITextFrameFormat::get_ThreeDFormat() विधि

वापस [ThreeDFormat](../../threedformat/) ऑब्जेक्ट जो किसी पाठ के लिए 3d इफ़ेक्ट गुणों का प्रतिनिधित्व करता है। केवल-पढ़ने योग्य [IThreeDFormat](../../ithreedformat/)।
