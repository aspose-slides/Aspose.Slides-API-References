...
| virtual [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() | एक ग्लोबली यूनिक आइडेंटिफायर (GUID) निर्दिष्ट करता है जो Office Open XML दस्तावेज़ के भीतर एकल कस्टम XML भाग को विशिष्ट रूप से पहचानता है। केवल पढ़ने योग्य [System::Guid](../../system/guid/)। |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() | कस्टम XML भाग से जुड़े संग्रह XML स्कीमा को लौटाता है। केवल पढ़ने योग्य [System::String](../../system/string/)[]। |
| virtual [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() | XML डेटा को UTF-8 स्ट्रिंग के रूप में लौटाता है। पढ़ें [System::String](../../system/string/)। |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() | XML डेटा लौटाता है। पढ़ें **uint8_t**[]। |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) मेथड का समान रूप। कस्टम वस्तुओं की हैशिंग को सक्षम करता है। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का एक उदाहरण है या नहीं। C# 'is' ऑपरेटर का समान रूप। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, सिर्फ नया ऑब्जेक्ट आरंभ करता है और सबक्लास की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) का स्ट्रिंग और नलपॉइंट के मामले के लिए विशिष्टकरण। |
...
| virtual void [Remove](./remove/)() | प्रेज़ेंटेशन से कस्टम xml भाग को हटाता है। |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्दिष्ट मान द्वारा साझा रेफ़रेंस काउंट को घटाता है। |
| virtual void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) | एक ग्लोबली यूनिक आइडेंटिफायर (GUID) निर्दिष्ट करता है जो Office Open XML दस्तावेज़ के भीतर एकल कस्टम XML भाग को विशिष्ट रूप से पहचानता है। केवल पढ़ने योग्य [System::Guid](../../system/guid/)। |
| virtual void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) | XML डेटा को UTF-8 स्ट्रिंग के रूप में सेट करता है। लिखें [System::String](../../system/string/)। |
| virtual void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | XML डेटा सेट करता है। लिखें **uint8_t**[]। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n-थे टेम्पलेट आर्ग्यूमेंट को वीक पॉइंटर (शेयर्ड के बजाय) सेट करता है। कंटेनरों में पॉइंटर को वीक मोड में स्विच करने की अनुमति देता है। |
