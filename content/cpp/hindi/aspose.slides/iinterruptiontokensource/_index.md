...
description: IInterruptionToken का स्रोत दर्शाता है।
type: docs
weight: 2614
url: /hi/aspose.slides/iinterruptiontokensource/
---
## IInterruptionTokenSource क्लास
...
| virtual **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() | यदि बाधा का अनुरोध किया गया हो तो true लौटाता है, अन्यथा false। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IInterruptionToken](../iinterruptiontoken/)\> [get_Token](./get_token/)() | इस [IInterruptionTokenSource](./) से बंधा नया टोकन लौटाता है। |
...
| virtual void [Interrupt](./interrupt/)() | बाधा के अनुरोध को प्रारम्भ करता है। |
...
| void [Lock](../../system/object/lock/)() | C# lock() स्टेटमेंट के लॉक को लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट उपयोग करें। |
...
| int [SharedCount](../../system/object/sharedcount/)() const | साझा रेफ़रेंस काउण्टर के वर्तमान मान को प्राप्त करता है। |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() स्टेटमेंट को अनलॉक करना लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट उपयोग करें। |
