...
description: एक अपरिवर्तनीय वस्तु जो प्रभावी ग्रेडिएंट भराव गुणों को समाहित करती है।
type: docs
weight: 2393
url: /hi/aspose.slides/igradientformateffectivedata/
---
## IGradientFormatEffectiveData क्लास

एक अपरिवर्तनीय वस्तु जो प्रभावी ग्रेडिएंट भराव गुणों को समाहित करती है।
...
| virtual [Aspose::Slides::GradientDirection](../gradientdirection/) [get_GradientDirection](./get_gradientdirection/)() | एक ग्रेडिएंट की शैली लौटाता है। केवल-पढ़ने योग्य [Slides::GradientDirection](../gradientdirection/)। |
| virtual [Aspose::Slides::GradientShape](../gradientshape/) [get_GradientShape](./get_gradientshape/)() | एक ग्रेडिएंट का आकार लौटाता है। केवल-पढ़ने योग्य [Slides::GradientShape](../gradientshape/)। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\> [get_GradientStop](./get_gradientstop/)(**int32_t**) | निर्दिष्ट सूचकांक पर एक ग्रेडिएंट स्टॉप लौटाता है। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)\> [get_GradientStops](./get_gradientstops/)() | ग्रेडिएंट स्टॉप्स का संग्रह लौटाता है। केवल-पढ़ने योग्य [IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)। |
| virtual **float** [get_LinearGradientAngle](./get_lineargradientangle/)() | एक ग्रेडिएंट का कोण लौटाता है। केवल-पढ़ने योग्य **float**। |
| virtual **bool** [get_LinearGradientScaled](./get_lineargradientscaled/)() | निर्धारित करता है कि ग्रेडिएंट स्केल किया गया है या नहीं। केवल-पढ़ने योग्य **bool**। |
| virtual [Aspose::Slides::TileFlip](../tileflip/) [get_TileFlip](./get_tileflip/)() | ग्रेडिएंट के फ़्लिपिंग मोड को लौटाता है। केवल-पढ़ने योग्य [Slides::TileFlip](../tileflip/)। |
...
| void [Lock](../../system/object/lock/)() | C# lock() कथन को लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सैंट्री ऑब्जेक्ट का उपयोग करें। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्यूमेंट को एक वीक्स पॉइंटर सेट करता है (साझा के बजाय)। कंटेनरों में पॉइंटर्स को वीक्स मोड में बदलने की अनुमति देता है। |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() कथन का अनलॉकिंग लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सैंट्री ऑब्जेक्ट का उपयोग करें। |
...
यह इंटरफ़ेस [IFillFormatEffectiveData](../ifillformateffectivedata/) और [ILineFillFormatEffectiveData](../ilinefillformateffectivedata/) का भाग के रूप में उपयोग किया जाता है।
