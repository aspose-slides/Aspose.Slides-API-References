...
description: किसी पैराग्राफ में बिना विरासत के पाठ संरेखण देता है। पढ़ें TextAlignment.
type: docs
weight: 1
url: /hi/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() विधि

किसी पैराग्राफ में बिना विरासत के पाठ संरेखण लौटाता है। पढ़ें [TextAlignment](../../textalignment/)।
...
निम्नलिखित नमूना कोड दिखाता है कि PowerPoint [Presentation](../../presentation/) में पाठ पैराग्राफ को कैसे संरेखित करें। 
```cpp
