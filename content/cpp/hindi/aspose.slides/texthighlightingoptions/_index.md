...
description: टेक्स्ट फ़्रेम में टेक्स्ट को हाईलाइट करने के लिए उपयोग किए जा सकने वाले विकल्पों का प्रतिनिधित्व करता है।
type: docs
weight: 5474
url: /hi/aspose.slides/texthighlightingoptions/
---
## TextHighlightingOptions क्लास
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलना को अनुकृत करता है जहाँ दो NaN को बराबर माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली के फ्लोटिंग पॉइंट तुलना को अनुकृत करता है जहाँ दो NaN को बराबर माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | केस-सेंसिटिव खोज के लिए true सेट करें, अन्यथा false। **bool** पढ़ें। |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | केवल पूर्ण शब्दों से मेल खाने के लिए true सेट करें, अन्यथा false। **bool** पढ़ें। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचें कि क्या ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का एक इंस्टेंस है। C# 'is' ऑपरेटर का समकक्ष। |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | केस-सेंसिटिव खोज के लिए true सेट करें, अन्यथा false। **bool** लिखें। |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | केवल पूर्ण शब्दों से मिलाने के लिए true सेट करें, अन्यथा false। **bool** लिखें। |
...
|  [TextHighlightingOptions](./texthighlightingoptions/)() | नया डिफ़ॉल्ट टेक्स्ट हाइलाइटिंग विकल्प बनाता है। |
...
अप्रचलित
:   इंटरफ़ेस [ITextHighlightingOptions](../itexthighlightingoptions/) को संस्करण 24.10 के रिलीज़ के बाद हटा दिया जाएगा।
