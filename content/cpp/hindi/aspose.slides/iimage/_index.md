...
एक रास्टर या वेक्टर छवि का प्रतिनिधित्व करता है।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली का फ्लोटिंग पॉइंट तुलना अनुकरित करता है जहाँ दो NaN को समान माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली का फ्लोटिंग पॉइंट तुलना अनुकरित करता है जहाँ दो NaN को समान माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, जिसमें NaN भी शामिल है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| virtual **int32_t** [get_Height](./get_height/)() | छवि की ऊँचाई पिक्सेल में प्राप्त करता है। |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_Size](./get_size/)() | छवि का आकार प्राप्त करता है। |
| virtual **int32_t** [get_Width](./get_width/)() | छवि की चौड़ाई पिक्सेल में प्राप्त करता है। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, सिर्फ नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ की कॉपी कन्स्ट्रक्शन सक्षम करता है। |
...
| virtual void [Save](./save/)([System::String](../../system/string/)) | छवि को फ़ाइल में सहेजता है। |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/)) | छवि को निर्दिष्ट फॉर्मेट में फ़ाइल में सहेजता है। |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/)) | छवि को निर्दिष्ट फॉर्मेट में स्ट्रीम में सहेजता है। |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/), **int32_t**) | छवि को निर्दिष्ट फॉर्मेट और क्वालिटी में फ़ाइल में सहेजता है। |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/), **int32_t**) | छवि को निर्दिष्ट फॉर्मेट और क्वालिटी में स्ट्रीम में सहेजता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्युमेंट को एक कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को कमजोर मोड में बदलने की अनुमति देता है। |
...
यह इंटरफ़ेस रास्टर और वेक्टर दोनों छवियों को संभालने के लिए एक सामान्य अमूर्तन प्रदान करता है।

कार्यान्वयन आधारभूत छवि प्रकार के आधार पर भिन्न हो सकते हैं।
