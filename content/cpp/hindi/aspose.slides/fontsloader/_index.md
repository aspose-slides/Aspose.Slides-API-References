...
description: उपयोगकर्ता द्वारा परिभाषित कस्टम फ़ॉन्ट लोड करने के लिए वर्ग। इसे किसी भी प्रेज़ेंटेशन ऑब्जेक्ट बनाने से पहले उपयोग किया जाना चाहिए।
type: docs
weight: 976
...
उपयोगकर्ता द्वारा परिभाषित कस्टम फ़ॉन्ट लोड करने के लिए वर्ग। इसे किसी भी प्रेज़ेंटेशन ऑब्जेक्ट बनाने से पहले उपयोग किया जाना चाहिए।
...
| विधि | विवरण |
| --- | --- |
| static void [ClearCache](./clearcache/)() | उपयोगकर्ता द्वारा परिभाषित सभी कस्टम फ़ॉन्ट रिलीज़ करता है |
...
| static [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetFontFolders](./getfontfolders/)() | फ़ॉन्ट फ़ोल्डर प्राप्त करता है। उन फ़ोल्डरों को लौटाता है जो LoadExternalFonts विधि से जोड़े गए हैं और सिस्टम फ़ॉन्ट फ़ोल्डर। |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) विधि का समानार्थी। कस्टम ऑब्जेक्ट्स की हैशिंग को सक्षम करता है। |
...
| static void [LoadExternalFont](./loadexternalfont/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | बाइनरी डेटा से फ़ॉन्ट जोड़ता है |
| static void [LoadExternalFonts](./loadexternalfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | फ़ॉन्ट खोजने के लिए अतिरिक्त फ़ोल्डर जोड़ता है। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कंस्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, बल्कि नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, बल्कि नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ की कॉपी कंस्ट्रक्शन को सक्षम करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्गुमेंट को एक कमजोर पॉइंटर सेट करता है (शेयर से नहीं)। कंटेनरों में पॉइंटर्स को कमजोर मोड में स्विच करने की अनुमति देता है। |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) विधि का समानार्थी। कस्टम ऑब्जेक्ट्स को स्ट्रिंग में रूपांतरण को सक्षम करता है। |
...
* वर्ग [IFontsLoader](../ifontsloader/)
