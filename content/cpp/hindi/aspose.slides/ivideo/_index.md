...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | सिर्फ आंतरिक उपयोग के लिये। |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | ऑडियो के डेटा की प्रति लौटाता है। बड़ी मात्रा में डेटा होने पर [IVideo::GetStream](./getstream/) मेथड के उपयोग पर विचार करें ताकि वीडियो के डेटा को मेमोरी में अनावश्यक लोड करने या OutOfMemoryException से बचा जा सके। केवल-पढ़ने योग्य **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | वीडियो का MIME टाइप लौटाता है, जो [IVideo::get_BinaryData](./get_binarydata/) में एन्कोड किया गया है। केवल-पढ़ने योग्य [System::String](../../system/string/)। |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | पढ़ने के लिये Stream स्ट्रीम लौटाता है। उपयोग के बाद 'using' या स्ट्रीम को बंद करें। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि ऑब्जेक्ट targetType द्वारा वर्णित प्रकार की इंस्टेंस है या नहीं। C# 'is' ऑपरेटर का समान। |
