...
description: COM इंटरफ़ेस के माध्यम से प्रेज़ेंटेशन बनाने की अनुमति देता है
type: docs
weight: 4850
...
COM इंटरफ़ेस के माध्यम से प्रेज़ेंटेशन बनाने की अनुमति देता है
...
निम्नलिखित उदाहरण दिखाता है कि कैसे एक [Presentation](../presentation/) फ़ॉर्मेट की जाँच की जाए। 
```cpp
...
```
निम्नलिखित उदाहरण दिखाता है कि कैसे एक [Presentation](../presentation/) की प्रॉपर्टीज़ प्राप्त की जाएँ। 
```cpp
System::SharedPtr<IPresentationInfo> info = PresentationFactory::get_Instance()->GetPresentationInfo(u"pres.pptx");
...
```
निम्नलिखित उदाहरण दिखाता है कि कैसे एक [Presentation](../presentation/) की प्रॉपर्टीज़ को अपडेट किया जाए। 
```cpp
System::SharedPtr<IPresentationInfo> info = PresentationFactory::get_Instance()->GetPresentationInfo(u"pres.pptx");
System::SharedPtr<IDocumentProperties> props = info->ReadDocumentProperties();
...
* क्लास [IPresentationFactory](../ipresentationfactory/)
