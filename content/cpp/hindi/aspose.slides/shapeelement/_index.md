...
description: एक ही रूपरेखा और भरने की विशेषताओं वाले आकार के भाग का प्रतिनिधित्व करता है।
type: docs
weight: 5123
...
एक ही रूपरेखा और भरने की विशेषताओं वाले आकार के भाग का प्रतिनिधित्व करता है।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली वाले फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, जिसमें NaN भी शामिल है, के बराबर नहीं होता। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली वाले फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, जिसमें NaN भी शामिल है, के बराबर नहीं होता। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| [ShapeElementFillSource](../shapeelementfillsource/) [get_FillSource](./get_fillsource/)() | एक तत्व को भरने के बारे में जानकारी लौटाता है। केवल-पढ़ने योग्य [ShapeElementFillSource](../shapeelementfillsource/)। |
| [System::SharedPtr](../../system/sharedptr/)\<[Shape](../shape/)\> [get_ParentShape](./get_parentshape/)() | उस Shape_PPT को लौटाता है जिसके लिए तत्व बनाया गया था। केवल-पढ़ने योग्य [Shape](../shape/)। |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_PathPoints](./get_pathpoints/)() | तत्व के पथ की ज्यामिति को परिभाषित करने वाले बिंदुओं का एक एरे प्राप्त करता है। |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_PathTypes](./get_pathtypes/)() | तत्व के पथ के प्रत्येक बिंदु के प्रकार को निर्दिष्ट करने वाले बाइट मानों का एक एरे प्राप्त करता है। |
| [ShapeElementStrokeSource](../shapeelementstrokesource/) [get_StrokeSource](./get_strokesource/)() | एक तत्व को स्ट्रोक करने के बारे में जानकारी लौटाता है। केवल-पढ़ने योग्य [ShapeElementStrokeSource](../shapeelementstrokesource/)। |
...
* वर्ग [IShapeElement](../ishapeelement/)
