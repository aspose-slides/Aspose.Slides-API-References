...
description: InterruptionToken का स्रोत दर्शाता है।
type: docs
weight: 3069
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | यदि बाधा अनुरोधित है तो true लौटाता है, अन्यथा false। |
| [System::SharedPtr](../../system/sharedptr/)\<[IInterruptionToken](../iinterruptiontoken/)\> [get_Token](./get_token/)() override | [InterruptionTokenSource](./) से बंधित नया टोकन लौटाता है। |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ऑब्जेक्ट से जुड़ी रेफ़रेंस काउंटर डेटा स्ट्रक्चर प्राप्त करता है। |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) मेथड का समतुल्य। कस्टम ऑब्जेक्ट्स का हैश बनाना सक्षम करता है। |
...
| void [Interrupt](./interrupt/)() override | बाधा के अनुरोध को आरंभ करता है। |
|  [InterruptionTokenSource](./interruptiontokensource/)() | एक नया [InterruptionTokenSource](./) बनाता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट तर्क को एक कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को वैकमोड में स्विच करने की अनुमति देता है। |
...
* क्लास [IInterruptionTokenSource](../iinterruptiontokensource/)
