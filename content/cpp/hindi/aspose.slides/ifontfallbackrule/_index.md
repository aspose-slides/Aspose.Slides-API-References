...
description: फ़ॉन्ट फ़ॉलबैक नियम को दर्शाता है
type: docs
weight: 2185
url: /hi/aspose.slides/ifontfallbackrule/
---
## IFontFallBackRule क्लास
...
| विधि | विवरण |
| --- | --- |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::String](../../system/string/)) | नई फ़ॉन्ट(s) को FallBack फ़ॉन्ट्स की सूची में जोड़ता है। |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | नए फ़ॉन्ट्स को FallBack फ़ॉन्ट्स की सूची में जोड़ता है। |
| virtual void [Clear](./clear/)() | सभी फ़ॉन्ट्स को सूची से हटाता है। |
...
| virtual **int32_t** [get_Count](./get_count/)() | रेंज के लिए वास्तव में परिभाषित फ़ॉन्ट्स की संख्या प्राप्त करता है। |
| virtual **uint32_t** [get_RangeEndIndex](./get_rangeendindex/)() | सतत Unicode रेंज का अंतिम इंडेक्स प्राप्त करें। |
| virtual **uint32_t** [get_RangeStartIndex](./get_rangestartindex/)() | सतत Unicode रेंज का पहला इंडेक्स प्राप्त करें। |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | ऑब्जेक्ट की वास्तविक टाइप प्राप्त करता है। C# [System.Object.GetType()](../../system/object/gettype/) कॉल का समान रूप। |
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)(**int32_t**) | निर्दिष्ट इंडेक्स पर फ़ॉन्ट नाम प्राप्त करता है। |
| virtual **int32_t** [IndexOf](./indexof/)([System::String](../../system/string/)) | कलेक्शन में निर्दिष्ट नियम का इंडेक्स लौटाता है। |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचें कि ऑब्जेक्ट targetType द्वारा वर्णित टाइप का इंस्टेंस है या नहीं। C# 'is' ऑपरेटर का समान रूप। |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | सूची से एक विशिष्ट FallBack फ़ॉन्ट की पहली उपस्थिति को हटाता है। |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | सूची के निर्दिष्ट इंडेक्स पर FallBack फ़ॉन्ट को हटाता है। |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्दिष्ट मूल्य द्वारा साझा रेफ़रेंस काउंट को घटाता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nth टेम्प्लेट आर्ग्युमेंट को वीक पॉइंटर (शेयर्ड के बजाय) सेट करता है। कंटेनर में पॉइंटर को वीक मोड में स्विच करने की अनुमति देता है। |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)() | इस नियम के लिए सभी FallBack फ़ॉन्ट्स के साथ एक एरे बनाता और लौटाता है। |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)(**int32_t**, **int32_t**) | सूची में निर्दिष्ट रेंज से सभी FallBack फ़ॉन्ट्स के साथ एक एरे बनाता और लौटाता है। |
