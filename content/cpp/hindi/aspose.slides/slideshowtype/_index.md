...
description: "Base slide show settings. Ancestors represent types of the slide show: PresentedBySpeaker वक्ता द्वारा प्रस्तुत (पूर्ण स्क्रीन) BrowsedByIndividual व्यक्तिगत द्वारा ब्राउज़ किया गया (विंडो) BrowsedAtKiosk कियोस्क पर ब्राउज़ किया गया (पूर्ण स्क्रीन)"
type: docs
weight: 5227
...
Base slide show settings. Ancestors represent types of the slide show: [PresentedBySpeaker](../presentedbyspeaker/) वक्ता द्वारा प्रस्तुत (पूर्ण स्क्रीन) [BrowsedByIndividual](../browsedbyindividual/) व्यक्तिगत द्वारा ब्राउज़ किया गया (विंडो) [BrowsedAtKiosk](../browsedatkiosk/) कियोस्क पर ब्राउज़ किया गया (पूर्ण स्क्रीन)
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि ऑब्जेक्ट targetType द्वारा वर्णित टाइप का उदाहरण है या नहीं। C# 'is' ऑपरेटर का समकक्ष। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n-थ टेम्पलेट आर्ग्युमेंट को कमजोर पॉइंटर (शेयरड नहीं) सेट करता है। कंटेनरों में पॉइंटर को कमजोर मोड में स्विच करने की अनुमति देता है। |
