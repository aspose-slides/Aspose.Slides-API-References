...
description: एक प्रेजेंटेशन की सभी स्लाइड्स को निर्दिष्ट फ़ॉर्मेट वाली फ़ाइल में सहेजता है।
type: docs
weight: 443
url: /hi/aspose.slides/presentation/save/
---
## Presentation::Save(System::String, Export::SaveFormat) मेथड


प्रस्तुति की सभी स्लाइड्स को निर्दिष्ट फॉर्मेट के साथ एक फ़ाइल में सहेजता है।
...
| पैरामीटर | टाइप | विवरण |
| --- | --- | --- |
| fname | [System::String](../../../system/string/) | बनाई गई फ़ाइल का पथ। |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | निर्यात किए गए डेटा का फॉर्मेट। |

## Presentation::Save(System::SharedPtr\<System::IO::Stream\>, Export::SaveFormat) मेथड
...
## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) मेथड


प्रस्तुति की सभी स्लाइड्स को निर्दिष्ट फॉर्मेट और अतिरिक्त विकल्पों के साथ फ़ाइल में सहेजता है।
...
| fname | [System::String](../../../system/string/) | बनाई गई फ़ाइल का पथ। |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | निर्यात किए गए डेटा का फॉर्मेट। |
| options | [System::SharedPtr](../../../system/sharedptr/)\<[Export::ISaveOptions](../../../aspose.slides.export/isaveoptions/)\> | फ़ॉर्मेट के अतिरिक्त विकल्प। |
## टिप्पणियाँ



निम्न उदाहरण दिखाता है कि कैसे C++ का उपयोग करके PowerPoint को HTML में परिवर्तित किया जा सकता है। 
```cpp
// एक प्रस्तुति ऑब्जेक्ट बनाता है जो PPT, PPTX, ODP आदि जैसी प्रस्तुति फ़ाइल को दर्शाता है।
...
// प्रस्तुति को HTML में सहेजता है
presentation->Save(u"ConvertWholePresentationToHTML_out.html", SaveFormat::Html, htmlOpt);
```
निम्न उदाहरण दिखाता है कि कैसे C++ का उपयोग करके PowerPoint को रिस्पॉन्सिव HTML में परिवर्तित किया जा सकता है। 
```cpp
...
```
निम्न उदाहरण दिखाता है कि कैसे C++ का उपयोग करके PowerPoint को नोट्स के साथ HTML में परिवर्तित किया जा सकता है। 
```cpp
...
// नोट्स पृष्ठ सहेजता है
pres->Save(u"Output.html", SaveFormat::Html, opt);
```
निम्न उदाहरण दिखाता है कि कैसे C++ का उपयोग करके PowerPoint को मूल फ़ॉन्ट्स के साथ HTML में परिवर्तित किया जा सकता है। 
```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// डिफ़ॉल्ट प्रस्तुति फ़ॉन्ट्स को बाहर करता है
...
```
निम्न उदाहरण दिखाता है कि कैसे C++ का उपयोग करके PowerPoint को 150 DPI पर हाई-क्वालिटी इमेजेज़ के साथ HTML में परिवर्तित किया जा सकता है। 
```cpp
...
```
निम्न उदाहरण दिखाता है कि कैसे C++ का उपयोग करके PowerPoint को फुल क्वालिटी इमेजेज़ के साथ HTML में परिवर्तित किया जा सकता है। 
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
निम्न उदाहरण दिखाता है कि कैसे C++ का उपयोग करके [Slide](../../slide/) को HTML में परिवर्तित किया जा सकता है। 
```cpp
```
