...
description: टेक्स्ट पैराग्राफ के भीतर टेक्स्ट के एक भाग का प्रतिनिधित्व करता है।
type: docs
weight: 4772
...
टेक्स्ट पैराग्राफ के भीतर टेक्स्ट के एक भाग का प्रतिनिधित्व करता है।
...
| मेथड | विवरण |
| --- | --- |
| void [AddField](./addfield/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) override | इस भाग को स्वचालित रूप से अपडेट किए गए फ़ील्ड में परिवर्तित करता है। |
| void [AddField](./addfield/)([System::String](../../system/string/)) override | इस भाग को स्वचालित रूप से अपडेट किए गए फ़ील्ड में परिवर्तित करता है। |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IField](../ifield/)\> [get_Field](./get_field/)() override | इस भाग का फ़ील्ड लौटाता है। केवल-पढ़ने योग्य [IField](../ifield/)। |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_PortionFormat](./get_portionformat/)() override | टेक्स्ट भाग की स्पष्ट रूप से सेट फॉर्मेटिंग गुणों को शामिल करने वाला स्वरूपण वस्तु लौटाता है, जहाँ विरासत लागू नहीं होती। केवल-पढ़ने योग्य [IPortionFormat](../iportionformat/)। |
| [System::String](../../system/string/) [get_Text](./get_text/)() override | एक भाग का साधारण टेक्स्ट प्राप्त करता है। पढ़ें [System::String](../../system/string/)। |
| [System::Drawing::PointF](../../system.drawing/pointf/) [GetCoordinates](./getcoordinates/)() override | भाग की शुरुआत के निर्देशांक प्राप्त करता है। बिंदु का X निर्देशांक भाग की शुरुआत को दर्शाता है, जिसमें पहला अक्षर और बाएँ पक्ष का बियरिंग शामिल है। Y निर्देशांक में ऊपर की ओर बियरिंग शामिल है। |
...
| [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() override | भाग को सीमित करने वाले आयत के निर्देशांक प्राप्त करता है। आयत में भाग के सभी टेक्स्ट लाइनों को शामिल किया जाता है, जिसमें खाली लाइनों भी शामिल हैं। |
...
|  [Object](../../system/object/object/)() | ऑब्जेक्ट बनाता है। सभी आंतरिक डेटा संरचनाओं को प्रारम्भिक करता है। |
...
|  [Portion](./portion/)() | [Portion](./) क्लास का एक नया इंस्टेंस प्रारम्भ करता है। |
|  [Portion](./portion/)([System::String](../../system/string/)) | [Portion](./) क्लास का एक नया इंस्टेंस प्रारम्भ करता है। |
|  [Portion](./portion/)([System::SharedPtr](../../system/sharedptr/)\<[Portion](./)\>) | [Portion](./) क्लास का एक नया इंस्टेंस प्रारम्भ करता है। |
...
| void [RemoveField](./removefield/)() override | इस फ़ील्ड भाग को साधारण भाग में परिवर्तित करता है। |
| void [set_Text](./set_text/)([System::String](../../system/string/)) override | एक भाग का साधारण टेक्स्ट सेट करता है। लिखें [System::String](../../system/string/)। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्पलेट आर्ग्युमेंट को कमजोर पॉइंटर सेट करता है (साझा के बजाय)। कंटेनरों में पॉइंटर्स को कमजोर मोड में बदलने की अनुमति देता है। |
