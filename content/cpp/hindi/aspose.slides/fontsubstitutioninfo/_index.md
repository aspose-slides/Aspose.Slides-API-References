...
description: यह संरचना उस फ़ॉन्ट प्रतिस्थापन की जानकारी का प्रतिनिधित्व करती है जब इसे रेंडर किया जाएगा।
type: docs
weight: 1015
...
यह संरचना उन फ़ॉन्ट प्रतिस्थापन की जानकारी का प्रतिनिधित्व करती है जब इसे रेंडर किया जाएगा।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली वाले फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के साथ भी। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली वाले फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के साथ भी। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
|  [FontSubstitutionInfo](./fontsubstitutioninfo/)([System::String](../../system/string/), [System::String](../../system/string/)) | एक [FontSubstitutionInfo](./) क्लास का उदाहरण बनाता है। |
| [System::String](../../system/string/) [get_OriginalFontName](./get_originalfontname/)() | प्रेजेंटेशन में स्रोत फ़ॉन्ट नाम दर्शाता है। केवल-पठन [System::String](../../system/string/) |
| [System::String](../../system/string/) [get_SubstitutedFontName](./get_substitutedfontname/)() | मूल फ़ॉन्ट के लिये प्रतिस्थापन फ़ॉन्ट नाम दर्शाता है। केवल-पठन [System::String](../../system/string/) |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्युमेंट को एक कमजोर पॉइंटर (शेयर्ड के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को कमजोर मोड में स्विच करने की अनुमति देता है। |
