...
| मेथड | विवरण |
| --- | --- |
| virtual **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) | जाँचता है कि खुले पासवर्ड से संरक्षित प्रस्तुति के लिए पासवर्ड सही है या नहीं। |
| virtual **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) | जाँचता है कि लिखने से सुरक्षित प्रस्तुति के संशोधन पासवर्ड सही है या नहीं। |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली की फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, यहाँ तक कि NaN के बराबर नहीं है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली की फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, यहाँ तक कि NaN के बराबर नहीं है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक उपयोग के लिए। |
| virtual **bool** [get_IsEncrypted](./get_isencrypted/)() | यदि बाइंडेड प्रस्तुति एन्क्रिप्टेड है तो True प्राप्त करता है, अन्यथा False। केवल-रीड **bool**। |
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | एक मान प्राप्त करता है जो दर्शाता है कि बाइंडेड प्रस्तुति को खोलने के लिए पासवर्ड द्वारा संरक्षित किया गया है या नहीं। |
| virtual [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() | एक मान प्राप्त करता है जो दर्शाता है कि बाइंडेड प्रस्तुति लिखने से सुरक्षित है या नहीं। |
| virtual [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() | बाइंडेड प्रस्तुति का फ़ॉर्मेट प्राप्त करता है। केवल-रीड [Slides::LoadFormat](../loadformat/)। |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() | बाइंडेड प्रस्तुति की दस्तावेज़ प्रॉपर्टीज़ प्राप्त करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट आर्ग्युमेंट को एक वीक पॉइंटर सेट करता है (साझा के बजाय)। कंटेनरों में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
...
| virtual void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) | बाइंडेड प्रस्तुति की प्रॉपर्टीज़ को अपडेट करता है। |
...
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | बाइंडेड प्रस्तुति को स्ट्रीम में लिखता है। |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) | बाइंडेड प्रस्तुति को फ़ाइल में लिखता है। |
