...
description: एक सेट प्रीफ़िक्स और नेमस्पेस मैपिंग्स तक केवल पढ़ने के लिए पहुँच प्रदान करता है।
type: docs
weight: 53
url: /hi/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver क्लास

एक सेट प्रीफ़िक्स और नेमस्पेस मैपिंग्स तक पढ़ने-के-लिए-केवल पहुँच प्रदान करता है।
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | निर्दिष्ट प्रीफ़िक्स के लिए मैप किया गया नेमस्पेस URI लौटाता है। |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | निर्दिष्ट नेमस्पेस URI के लिए मैप किया गया प्रीफ़िक्स लौटाता है। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कॉन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, बस नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ की कॉपी निर्माण को सक्षम करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 'n'th टेम्पलेट आर्ग्युमेंट को एक weak पॉइंटर सेट करता है (shared के बजाय)। कंटेनरों में पॉइंटर को weak मोड में स्विच करने की अनुमति देता है। |
