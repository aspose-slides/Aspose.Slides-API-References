...
description: एटॉमाइज़्ड स्ट्रिंग ऑब्जेक्ट्स की तालिका।
type: docs
weight: 313
url: /hi/system.xml/xmlnametable/
---
## XmlNameTable क्लास

एटॉमाइज़्ड स्ट्रिंग ऑब्जेक्ट्स की तालिका।
...
| Method | Description |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | जब किसी व्युत्पन्न क्लास में इसे ओवरराइड किया जाता है, तो निर्दिष्ट स्ट्रिंग को एटॉमाइज़ करता है और इसे [XmlNameTable](./) में जोड़ता है। |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | जब किसी व्युत्पन्न क्लास में इसे ओवरराइड किया जाता है, तो निर्दिष्ट स्ट्रिंग को एटॉमाइज़ करता है और इसे [XmlNameTable](./) में जोड़ता है। |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | जब किसी व्युत्पन्न क्लास में इसे ओवरराइड किया जाता है, तो दिए गए एरे में निर्दिष्ट अक्षर सीमा के समान अक्षरों वाले एटॉमाइज़्ड स्ट्रिंग को प्राप्त करता है। |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | जब किसी व्युत्पन्न क्लास में इसे ओवरराइड किया जाता है, तो निर्दिष्ट स्ट्रिंग के समान मान वाले एटॉमाइज़्ड स्ट्रिंग को प्राप्त करता है। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचें कि ऑब्जेक्ट targetType द्वारा वर्णित टाइप का उदाहरण है या नहीं। C# 'is' ऑपरेटर का समानार्थी। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कॉन्स्ट्रक्टर। वास्तव में कुछ भी नहीं कॉपी करता, केवल नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ की कॉपी कंस्ट्रक्शन को सक्षम बनाता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी नहीं कॉपी करता, केवल नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ की कॉपी कंस्ट्रक्शन को सक्षम बनाता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्यूमेंट को एक विंड पॉइंटर सेट करता है (शेयर्ड के बजाय)। कंटेनरों में पॉइंटर्स को विंड मोड में स्विच करने की अनुमति देता है। |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | विंड रेफ़रेंस काउंट को बढ़ाता है। इसे सीधे नहीं बुलाया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | विंड रेफ़रेंस काउंट को घटाता है। इसे सीधे नहीं बुलाया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
| virtual  [~Object](../../system/object/~object/)() | ऑब्जेक्ट को नष्ट करता है। सभी आंतरिक डेटा स्ट्रक्चर को मुक्त करता है। |
## टाइपडिफ़

| Typedef | Description |
| --- | --- |
| [Ptr](./ptr/) | इस क्लास की एक इन्स्टेंस के लिए साझा पॉइंटर का उपनाम। |
## देखें
