...
description: एक एप्लिकेशन रिसोर्स स्ट्रीम रिज़ॉल्वर का प्रतिनिधित्व करता है।
type: docs
weight: 14
url: /hi/system.xml/iapplicationresourcestreamresolver/
---
## IApplicationResourceStreamResolver कक्षा
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetApplicationResourceStream](./getapplicationresourcestream/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | निर्दिष्ट URI से एक एप्लिकेशन रिसोर्स स्ट्रीम वापस करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट आर्ग्युमेंट को वीक पॉइंटर (शेयर किए गए के बजाय) सेट करता है। कंटेनरों में पॉइंटर को वीक मोड में स्विच करने की अनुमति देता है। |
