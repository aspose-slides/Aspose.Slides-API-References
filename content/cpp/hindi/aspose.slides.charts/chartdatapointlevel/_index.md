...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | डेटा पॉइंट लेवल की फ़ॉर्मेटिंग प्रॉपर्टीज़ का प्रतिनिधित्व करता है। पढ़ें [IFormat](../iformat/)। |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() override | डेटा पॉइंट लेवल के डेटा लेबल का प्रतिनिधित्व करता है। Treemap और Sunburst श्रृंखला प्रकारों पर लागू होता है। केवल-पढ़ने योग्य [IDataLabel](../idatalabel/)। |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) मेथड का समान रूप। कस्टम टाइप्स का क्लोनिंग सक्षम करता है। |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n-थ टेम्प्लेट आर्ग्यूमेंट को एक कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को वीक मोड में बदलने की अनुमति देता है। |
...
* क्लास [IChartDataPointLevel](../ichartdatapointlevel/)
