...
description: "pptx प्रस्तुति दस्तावेज़ में दो तरीकों से संग्रहीत किए जा सकने वाले स्ट्रिंग या डबल मान को प्रतिनिधित्व करता है: 1) चार्ट से संबंधित वर्कबुक की सेल/सेलों में; 2) लिटरल मान के रूप में।"
type: docs
weight: 1353
...
| **double** [get_AsLiteralDouble](./get_asliteraldouble/)() override | मान को लिटरल डबल के रूप में लौटाता है। पढ़ें **double**। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचें कि ऑब्जेक्ट targetType द्वारा वर्णित टाइप का इंस्टेंस है या नहीं। C# 'is' ऑपरेटर का समानार्थी। |
...
| void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) override | मान को लिटरल डबल के रूप में सेट करता है। लिखें **double**। |
...
| void [set_DataSourceType](../basechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) override | निर्दिष्ट करता है कि AsCell, AsCells, AsLiteralString या AsLiteralDouble प्रॉपर्टी वंशजों में वास्तविक है या नहीं। अन्य शब्दों में यह Data प्रॉपर्टी के मान के प्रकार को निर्दिष्ट करता है। लिखें [Charts::DataSourceType](../datasourcetype/)। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट आर्ग्यूमेंट को एक वीक पॉइंटर सेट करता है (शेयर्ड के बजाय)। कंटेनर में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
...
| **double** [ToDouble](./todouble/)() override | डबल में परिवर्तित करता है। |
...
* क्लास [IStringOrDoubleChartValue](../istringordoublechartvalue/)
