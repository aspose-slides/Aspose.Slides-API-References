...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | दीवार की फ़िल, लाइन, इफ़ेक्ट, 3D शैलियों को वापस करता है। केवल पढ़ने योग्य [IFormat](../iformat/)। |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | चित्र प्रकार को वापस करता है या सेट करता है। पढ़ें [PictureType](../picturetype/)। |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | दीवारों की मोटाई को प्लॉट वॉल्यूम के सबसे बड़े आयाम के प्रतिशत के रूप में वापस करता है। पढ़ें **int32_t**। |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | चित्र प्रकार को वापस करता है या सेट करता है। लिखें [PictureType](../picturetype/)। |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | दीवारों की मोटाई को प्लॉट वॉल्यूम के सबसे बड़े आयाम के प्रतिशत के रूप में सेट करता है। लिखें **int32_t**। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट आर्ग्यूमेंट को वीक प्वाइंटर सेट करता है (शेयर्ड के बजाय)। कंटेनरों में प्वाइंटर को वीक मोड में स्विच करने की अनुमति देता है। |
| int [SharedCount](../../system/object/sharedcount/)() const | साझा रेफ़रेंस काउंटर का वर्तमान मान प्राप्त करता है। |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | साझा रेफ़रेंस काउंट को बढ़ाता है। इसे सीधे कॉल नहीं करना चाहिए; बल्कि, स्मार्ट प्वाइंटर्स या ThisProtector का उपयोग करें। |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | साझा रेफ़रेंस काउंट को घटाता है और वापस करता है। इसे सीधे कॉल नहीं करना चाहिए; बल्कि, स्मार्ट प्वाइंटर्स या ThisProtector का उपयोग करें। |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | वीक रेफ़रेंस काउंट को बढ़ाता है। इसे सीधे कॉल नहीं करना चाहिए; बल्कि, स्मार्ट प्वाइंटर्स या ThisProtector का उपयोग करें। |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | वीक रेफ़रेंस काउंट को घटाता है। इसे सीधे कॉल नहीं करना चाहिए; बल्कि, स्मार्ट प्वाइंटर्स या ThisProtector का उपयोग करें। |
