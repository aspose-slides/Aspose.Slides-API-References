...
description: डेटा पॉइंट स्तर का प्रतिनिधित्व करता है। Treemap और Sunburst चार्ट के लिए लागू होता है।
type: docs
weight: 703
url: /hi/aspose.slides.charts/ichartdatapointlevel/
---
## IChartDataPointLevel क्लास
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | डेटा पॉइंट स्तर की फ़ॉर्मेटिंग प्रॉपर्टीज़ का प्रतिनिधित्व करता है। [IFormat](../iformat/) पढ़ें। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | डेटा पॉइंट स्तर के डेटा लेबल का प्रतिनिधित्व करता है। Treemap और Sunburst श्रृंखला प्रकारों के लिए लागू। केवल-पढ़ने योग्य [IDataLabel](../idatalabel/)। |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ऑब्जेक्ट से जुड़ी रेफ़रेंस काउंट डेटा स्ट्रक्चर प्राप्त करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्युमेंट को वैक पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को वैक मोड में स्विच करने की अनुमति देता है। |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | वैक रेफ़रेंस काउंट को इंक्रीमेंट करता है। सीधे कॉल नहीं करना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | वैक रेफ़रेंस काउंट को डिक्रीमेंट करता है। सीधे कॉल नहीं करना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
