---
title: ChartWall
second_title: Aspose.Slides के लिये C++ API रेफ़रेंस
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-स्टाइल फ़्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान, सहित NaN, के बराबर नहीं होता। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-स्टाइल फ़्लोटिंग पॉइंट तुलना को अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, हालांकि IEC 60559:1989 के अनुसार NaN किसी भी मान, सहित NaN, के बराबर नहीं होता। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजनों के लिए। |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | दीवार भराव, रेखा, प्रभाव, 3d शैलियों को लौटाता है। केवल-पढ़ने योग्य [IFormat](../iformat/)। |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | चित्र प्रकार को लौटाता या सेट करता है। Read [Charts::PictureType](../picturetype/)। |
| **int32_t** [get_Thickness](./get_thickness/)() override | प्लॉट वॉल्यूम के सबसे बड़े आयाम के प्रतिशत के रूप में दीवारों की मोटाई लौटाता है। Read **int32_t**। |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | चित्र प्रकार को लौटाता या सेट करता है। Write [Charts::PictureType](../picturetype/)। |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | प्लॉट वॉल्यूम के सबसे बड़े आयाम के प्रतिशत के रूप में दीवारों की मोटाई सेट करता है। Write **int32_t**। |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'th टेम्प्लेट आर्ग्युमेंट को एक कमजोर पॉइंटर (साझा के बजाय) सेट करें। कंटेनरों में पॉइंटर्स को कमजोर मोड में स्विच करने की अनुमति देता है। |
