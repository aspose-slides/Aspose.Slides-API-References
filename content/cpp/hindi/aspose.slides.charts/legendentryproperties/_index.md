...
| **bool** [get_Hide](./get_hide/)() override | निर्धारित करता है कि लेजेंड एंट्री छिपी हुई है या नहीं। पढ़ें **bool**। |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartTextFormat](../icharttextformat/)\> [get_TextFormat](./get_textformat/)() override | टेक्स्ट फॉर्मेट लौटाता है। केवल-पढ़ने योग्य [IChartTextFormat](../icharttextformat/)। |
...
| void [set_Hide](./set_hide/)(**bool**) override | निर्धारित करता है कि लेजेंड एंट्री छिपी हुई है या नहीं। लिखें **bool**। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट आर्ग्युमेंट को एक वीक पॉइंटर सेट करता है (शेयर किए हुए के बजाय)। कंटेनरों में पॉइंटर्स को वीक मोड में बदलने की अनुमति देता है। |
...
* क्लास [ILegendEntryProperties](../ilegendentryproperties/)
