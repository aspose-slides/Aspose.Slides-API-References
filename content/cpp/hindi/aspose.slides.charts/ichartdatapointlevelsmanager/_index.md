...
description: डेटा पॉइंट लेवल्स का कंटेनर। Treeamp और Sunburst श्रृंखला के लिए लागू। डेटा पॉइंट लेवल्स का इंडेक्सिंग शून्य-आधारित है।
type: docs
weight: 716
url: /hi/aspose.slides.charts/ichartdatapointlevelsmanager/
---
## IChartDataPointLevelsManager क्लास

डेटा पॉइंट लेवल्स का कंटेनर। Treeamp और Sunburst सीरीज़ के लिए लागू। डेटा पॉइंट लेवल्स का इंडेक्सिंग शून्य-आधारित है।
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली का फ्लोटिंग पॉइंट तुलना अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, भले ही IEC 60559:1989 के अनुसार NaN किसी भी मान, जिसमें NaN भी शामिल है, के बराबर नहीं है। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली का फ्लोटिंग पॉइंट तुलना अनुकरण करता है जहाँ दो NaN को बराबर माना जाता है, भले ही IEC 60559:1989 के अनुसार NaN किसी भी मान, जिसमें NaN भी शामिल है, के बराबर नहीं है। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | केवल आंतरिक प्रयोजन के लिए। |
| virtual **int32_t** [get_Count](./get_count/)() | डेटा पॉइंट लेवल्स की गिनती लौटाता है। |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPointLevel](../ichartdatapointlevel/)\> [idx_get](./idx_get/)(**int32_t**) | परिभाषित स्तर के लिए [IChartDataPointLevel](../ichartdatapointlevel/) ऑब्जेक्ट लौटाता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्युमेंट को एक वीक्स पॉइंटर सेट करता है (साझा के बजाय)। कंटेनरों में पॉइंटर्स को वीक्स मोड में स्विच करने को सक्षम करता है। |
...
| virtual  [~Object](../../system/object/~object/)() | ऑब्जेक्ट को नष्ट करता है। सभी इंटरनल डेटा स्ट्रक्चर को मुक्त करता है। |
## देखें
