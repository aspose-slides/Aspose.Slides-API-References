...
description: त्रुटि बार मान निर्धारित करता है। इसे केवल तब उपयोग किया जाना चाहिए जब Error bars value type Custom हो।
type: docs
weight: 469
url: /hi/aspose.slides.charts/errorbarscustomvalues/
---
## ErrorBarsCustomValues क्लास

त्रुटि बार मान निर्धारित करता है। इसे केवल तब उपयोग किया जाना चाहिए जब Error bars value type Custom हो।
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() override | नकारात्मक दिशा में त्रुटि बार मान निर्दिष्ट करता है। यह उपलब्ध है यदि error bars value type Custom है और ErrorBarsXFormat अनुमति है। किसी भी अन्य मामले में यह प्रॉपर्टी null लौटाती है। केवल-पढ़ने योग्य [IDoubleChartValue](../idoublechartvalue/)। |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() override | सकारात्मक दिशा में त्रुटि बार मान निर्दिष्ट करता है। यह उपलब्ध है यदि error bars value type Custom है और ErrorBarsXFormat अनुमति है। किसी भी अन्य मामले में यह प्रॉपर्टी null लौटाती है। केवल-पढ़ने योग्य [IDoubleChartValue](../idoublechartvalue/)। |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() override | नकारात्मक दिशा में त्रुटि बार मान निर्दिष्ट करता है। यह उपलब्ध है यदि error bars value type Custom है और ErrorBarsYFormat अनुमति है। किसी भी अन्य मामले में यह प्रॉपर्टी null लौटाती है। केवल-पढ़ने योग्य [IDoubleChartValue](../idoublechartvalue/)। |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() override | सकारात्मक दिशा में त्रुटि बार मान निर्दिष्ट करता है। यह उपलब्ध है यदि error bars value type Custom है और ErrorBarsYFormat अनुमति है। किसी भी अन्य मामले में यह प्रॉपर्टी null लौटाती है। केवल-पढ़ने योग्य [IDoubleChartValue](../idoublechartvalue/)। |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Set n'th टेम्पलेट आर्गुमेंट को एक कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को कमजोर मोड में स्विच करने की अनुमति देता है। |
...
* क्लास [IErrorBarsCustomValues](../ierrorbarscustomvalues/)
