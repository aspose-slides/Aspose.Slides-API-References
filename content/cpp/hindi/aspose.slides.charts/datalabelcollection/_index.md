...
| विधि | विवरण |
| --- | --- |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | इटरेटर को प्राप्त करता है जो संग्रह का पहला तत्व (यदि कोई हो) दर्शाता है। यह इटरेटर संदर्भित वस्तु को बदलने के लिए उपयोग नहीं किया जा सकता क्योंकि [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) T की एक कॉपी-ऑब्जेक्ट लौटाता है। |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | इटरेटर को प्राप्त करता है जो संग्रह की const-योग्य इकाई का पहला तत्व (यदि कोई हो) दर्शाता है। |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | इटरेटर को प्राप्त करता है जो संग्रह के पहले const-योग्य तत्व (यदि कोई हो) की ओर संकेत करता है। |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | इटरेटर को प्राप्त करता है जो संग्रह के अंतिम const-योग्य तत्व (यदि कोई हो) के तुरंत बाद स्थित है। |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | इटरेटर को प्राप्त करता है जो संग्रह के अंतिम तत्व (यदि कोई हो) के तुरंत बाद स्थित है। यह इटरेटर संदर्भित वस्तु को बदलने के लिए उपयोग नहीं किया जा सकता क्योंकि [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) T की एक कॉपी-ऑब्जेक्ट लौटाता है। |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | इटरेटर को प्राप्त करता है जो संग्रह की const-योग्य इकाई के अंतिम तत्व (यदि कोई हो) के तुरंत बाद स्थित है। |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](./get_chart/)() override | पैरेंट चार्ट को लौटाता है। केवल-पठन [IChart](../ichart/)। |
| **int32_t** [get_Count](./get_count/)() override | संग्रह में सभी डेटा लेबल्स की संख्या प्राप्त करता है। केवल-पठन **int32_t**। |
| **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() override | संग्रह में दृश्यमान डेटा लेबल्स की संख्या प्राप्त करता है। केवल-पठन **int32_t**। |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() override | डिफ़ॉल्ट डेटा लेबल फ़ॉर्मेट प्राप्त करता है। केवल-पठन [IDataLabelFormat](../idatalabelformat/)। |
| **bool** [get_IsVisible](./get_isvisible/)() override | False का अर्थ है कि डेटा लेबल डिफ़ॉल्ट रूप से दृश्यमान नहीं है (और इस कारण DefaultDataLabelFormat प्रॉपर्टी के सभी Show*-फ़्लैग्स (ShowValue, ...) false होते हैं)। केवल-पठन **bool**। |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() override | डेटा लेबल्स की लीडर लाइन्स फ़ॉर्मेट को दर्शाता है। केवल-पठन [IChartLinesFormat](../ichartlinesformat/)। |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() override | पैरेंट सीरीज़ प्राप्त करता है। केवल-पठन [IChartSeries](../ichartseries/)। |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | ऑब्जेक्ट से जुड़ी रेफ़रेंस काउंटर डेटा संरचना प्राप्त करता है। |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>\>\> [GetEnumerator](./getenumerator/)() override | एक एनेमरेटर लौटाता है जो संग्रह के माध्यम से इटरैट करता है। |
...
| void [Hide](./hide/)() override | डिफ़ॉल्ट रूप से डेटा लेबल को छिपा देता है सभी Show*-फ़्लैग्स (ShowValue, ...) को DefaultDataLabelFormat प्रॉपर्टी में false स्थिति पर सेट करके। इस के बाद IsVisible false होगा। |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) override | निर्दिष्ट इंडेक्स वाले डेटा पॉइंट के लिए डेटा लेबल प्राप्त करता है। |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) override | संग्रह में निर्दिष्ट [DataLabel](../datalabel/) का इंडेक्स लौटाता है। |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | शर्त को संतुष्ट करने वाले अनुक्रम के पहले तत्व को लौटाता है या यदि ऐसा तत्व न मिले तो डिफ़ॉल्ट मान देता है। |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | सामान्य अनुक्रम के प्रत्येक तत्व पर ट्रांसफ़ॉर्म फ़ंक्शन लागू करता है और अधिकतम परिणामी मान लौटाता है। |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | सामान्य अनुक्रम के प्रत्येक तत्व पर ट्रांसफ़ॉर्म फ़ंक्शन लागू करता है और न्यूनतम परिणामी मान लौटाता है। |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | प्रत्येक तत्व को उसके इंडेक्स को सम्मिलित करके नई रूप में परिवर्तित करता है। |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | अनुक्रम की शुरुआत से निर्दिष्ट संख्या में लगातार तत्वों को छोड़ता है और शेष भाग लौटाता है। |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | nवें टेम्प्लेट आर्ग्युमेंट को weak पॉइंटर (shared नहीं) सेट करता है। कंटेनरों में पॉइंटर्स को weak मोड में बदलने की अनुमति देता है। |
...
* क्लास [IDataLabelCollection](../idatalabelcollection/)
