...
description: ऐसा Timer जो लूप में डेलीगेट को कॉल करता है।
type: docs
weight: 14
url: /hi/system.timers/timer/
---
## Timer वर्ग

[Timer](./) जो लूप में डेलीगेट को कॉल करता है।
...
| विधि | विवरण |
| --- | --- |
| void [Close](./close/)() | टाइमर को रोकता है, आवंटित संसाधनों को मुक्त करता है। |
|  [Component](../../system.componentmodel/component/component/)() | RTTI जानकारी। |
| void [Dispose](./dispose/)() | टाइमर को रोकता है, आवंटित संसाधनों को मुक्त करता है। |
| void [Dispose](../../system.componentmodel/component/dispose/)(**bool**) | Disposable पैटर्न समर्थन; कुछ नहीं करता। |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-शैली के फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के साथ भी नहीं। |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली के फ़्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान के बराबर नहीं होता, यहाँ तक कि NaN के साथ भी नहीं। |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | सिर्फ़ आंतरिक उपयोग के लिए। |
| **bool** [get_AutoReset](./get_autoreset/)() const | जाँचता है कि टाइमर ऑटो-रीसेट मोड में है या नहीं। |
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | जाँचता है कि कंपोनेंट डिज़ाइन मोड में है या नहीं। |
| **bool** [get_Enabled](./get_enabled/)() const | जाँचता है कि टाइमर सक्रिय है या नहीं। |
| **double** [get_Interval](./get_interval/)() const | टाइमर अंतराल प्राप्त करता है। |
| **bool** [get_IsStopped](./get_isstopped/)() const | जाँचता है कि टाइमर रोका गया है या नहीं। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि ऑब्जेक्ट targetType द्वारा वर्णित टाइप का उदाहरण है या नहीं। C# 'is' ऑपरेटर का समानांतर। |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | टाइमर को ऑटो-रीसेट मोड में या उससे बाहर सेट करता है। |
| void [set_Enabled](./set_enabled/)(**bool**) | टाइमर को शुरू या रोकता है। यदि टाइमर पहले से चल रहा है तो शुरू करना समय गिनती को पुनः प्रारंभ नहीं करता। |
| void [set_Interval](./set_interval/)(**double**) | टाइमर अंतराल सेट करता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट तर्क को कमजोर पॉइंटर (शेयर्ड के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को कमजोर मोड में बदलने की अनुमति देता है। |
...
| void [Start](./start/)() | टाइमर को शुरू करता है। यदि टाइमर पहले से चल रहा है तो समय गिनती को पुनः प्रारंभ नहीं करता। |
| void [Stop](./stop/)() | टाइमर को रोकता है। |
|  [Timer](./timer/)() | RTTI जानकारी। |
|  [Timer](./timer/)(**double**) | निर्दिष्ट अंतराल के साथ रोका गया टाइमर बनाता है। |
...
* क्लास [Component](../../system.componentmodel/component/)
* नेमस्पेस [System::Timers](../)
