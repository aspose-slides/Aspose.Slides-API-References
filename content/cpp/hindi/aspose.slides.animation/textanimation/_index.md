...
| विधि | विवरण |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) override | वर्तमान अनुक्रम के अंत में नया प्रभाव जोड़ता है ताकि समूह पाठ एनीमेशन के अंत तक पहुँचा जा सके। केवल तभी मान्य है जब पाठ पैराग्राफ की गिनती इस समूह के प्रभावों की गिनती के बराबर या अधिक हो! |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | वस्तुओं की तुलना C# [Object.Equals](../../system/object/equals/) सेमिक्स का उपयोग करके करता है। |
...
| [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() override | पाठ एनीमेशन के निर्माण प्रकार की सूची (उदाहरण के लिए [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once)। [Animation::BuildType](../buildtype/) पढ़ें। |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() override | समूह के साथ या बिना (null) जुड़ा हुआ आकार प्रभाव। [IEffect](../ieffect/) पढ़ें। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँच करता है कि वस्तु targetType द्वारा वर्णित प्रकार का एक उदाहरण है या नहीं। C# 'is' ऑपरेटर का समानार्थी। |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कंस्ट्रक्टर। वास्तव में कुछ नहीं कॉपी करता, केवल नई वस्तु को आरम्भ करता है और सबक्लासों के कॉपी निर्माण को सक्षम करता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ नहीं कॉपी करता, केवल नई वस्तु को आरम्भ करता है और सबक्लासों के कॉपी निर्माण को सक्षम करता है। |
...
| void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) override | पाठ एनीमेशन के निर्माण प्रकार की सूची (उदाहरण के लिए [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once)। [Animation::BuildType](../buildtype/) लिखें। |
| void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) override | समूह के साथ या बिना (null) जुड़ा हुआ आकार प्रभाव। [IEffect](../ieffect/) लिखें। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 'n'-वें टेम्पलेट आर्ग्युमेंट को एक कमजोर पॉइंटर सेट करता है (साझा के बजाय)। कंटेनरों में पॉइंटर को कमजोर मोड में बदलने की अनुमति देता है। |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | साझा रेफ़रेंस काउंट को घटाता है और 반환 करता है। इसे सीधे नहीं बुलाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर या ThisProtector का उपयोग करें। |
...
* वर्ग [ITextAnimation](../itextanimation/)
