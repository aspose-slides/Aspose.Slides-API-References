...
| **int32_t** [get_Column](./get_column/)() override | सेल जहाँ स्थित है, उस कार्यपत्रक में कॉलम का शून्य-आधारित अनुक्रमांक प्राप्त करता है। केवल-पढ़ने योग्य **int32_t**। |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | चार्ट डेटा सेल का नाम प्राप्त करता है। |
| **int32_t** [get_Row](./get_row/)() override | सेल जहाँ स्थित है, उस कार्यपत्रक में पंक्ति का शून्य-आधारित अनुक्रमांक प्राप्त करता है। केवल-पढ़ने योग्य **int32_t**। |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | [Excel](../) सेल में मौजूद मान प्राप्त करता है। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nथ टेम्प्लेट तर्क को एक कमजोर पॉइंटर (साझा के बजाय) सेट करता है। कंटेनरों में पॉइंटर को कमजोर मोड में बदलने की अनुमति देता है। |
