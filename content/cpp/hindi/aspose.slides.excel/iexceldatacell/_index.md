...
description: एक Excel कार्यपुस्तिका में एकल सेल का प्रतिनिधित्व करता है।
type: docs
weight: 27
url: /hi/aspose.slides.excel/iexceldatacell/
---
## IExcelDataCell क्लास


[Excel](../) कार्यपुस्तिका में एक एकल सेल को दर्शाता है।
...
| virtual **int32_t** [get_Column](./get_column/)() | कार्यपत्रक में वह कॉलम जहाँ सेल स्थित है, उसका शून्य-आधारित सूचकांक प्राप्त करता है। केवल-पढ़ने योग्य **int32_t**। |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | चार्ट डेटा सेल का नाम प्राप्त करता है। केवल-पढ़ने योग्य [System::String](../../system/string/)। |
| virtual **int32_t** [get_Row](./get_row/)() | कार्यपत्रक में वह पंक्ति जहाँ सेल स्थित है, उसका शून्य-आधारित सूचकांक प्राप्त करता है। केवल-पढ़ने योग्य **int32_t**। |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() | [Excel](../) सेल में मौजूद मान प्राप्त करता है। केवल-पढ़ने योग्य [System::Object](../../system/object/)। |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्प्लेट आर्ग्युमेंट को कमजोर पॉइंटर सेट करता है (साझा के बजाय)। कंटेनरों में पॉइंटर को कमजोर मोड में स्विच करने की अनुमति देता है। |
