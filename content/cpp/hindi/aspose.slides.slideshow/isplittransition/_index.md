...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | ट्रांज़िशन विभाजन की दिशा। [TransitionInOutDirectionType](../transitioninoutdirectiontype/) पढ़ें। |
| virtual [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() | ट्रांज़िशन विभाजन की अभिविन्यास। [Slides::Orientation](../../aspose.slides/orientation/) पढ़ें। |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | ट्रांज़िशन विभाजन की दिशा। [TransitionInOutDirectionType](../transitioninoutdirectiontype/) लिखें। |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) | ट्रांज़िशन विभाजन का अभिविन्यास। [Slides::Orientation](../../aspose.slides/orientation/) लिखें। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट तर्क को एक Weak पॉइंटर (शेयर्ड के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को Weak मोड में बदलने की अनुमति देता है। |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | शेयर्ड रेफ़रेंस काउंट घटाता है और वापस करता है। सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Weak रेफ़रेंस काउंट बढ़ाता है। सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय, स्मार्ट पॉइंटर्स और ThisProtector का उपयोग करें। |
