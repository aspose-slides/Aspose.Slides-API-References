...
| मेथड | विवरण |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | निर्धारित करता है कि दो [TransitionValueBase](../transitionvaluebase/) इंस्टेंस समान हैं या नहीं। |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-शैली के डबल फ्लोटिंग पॉइंट तुलना का अनुकरण करता है जहाँ दो NaN को समान माना जाता है, जबकि IEC 60559:1989 के अनुसार NaN किसी भी मान, जिसमें NaN भी शामिल है, के बराबर नहीं है। |
...
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | ट्रांज़िशन के दौरान उपयोग किए गए विज़ुअल्स के आकार को निर्दिष्ट करता है। पढ़ें [TransitionPattern](../transitionpattern/)। |
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | विशिष्ट प्रकार के लिए हैश फ़ंक्शन के रूप में कार्य करता है, जो हैशिंग एल्गोरिदम और हैश टेबल जैसी डेटा स्ट्रक्चर्स में उपयोग के लिए उपयुक्त है। |
...
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | ट्रांज़िशन के दौरान उपयोग किए गए विज़ुअल्स के आकार को निर्दिष्ट करता है। लिखें [TransitionPattern](../transitionpattern/)। |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | साझा रेफ़रेंस काउंट को घटाता है और उसका मान लौटाता है। सीधे कॉल नहीं किया जाना चाहिए; इसके बजाय स्मार्ट पॉइंटर्स या ThisProtector का उपयोग करें। |
...
* क्लास [IGlitterTransition](../iglittertransition/)
