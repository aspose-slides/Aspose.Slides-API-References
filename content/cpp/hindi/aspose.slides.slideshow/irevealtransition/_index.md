...
description: स्लाइड संक्रमण प्रभाव को प्रकट करता है।
type: docs
weight: 209
url: /hi/aspose.slides.slideshow/irevealtransition/
---
## IRevealTransition क्लास

स्लाइड संक्रमण प्रभाव को प्रदर्शित करता है।
...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | ट्रांज़िशन की दिशा। पढ़ें [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)। |
| virtual **bool** [get_ThroughBlack](./get_throughblack/)() | निर्दिष्ट करता है कि ट्रांज़िशन काले माध्यम से फेड होता है या नहीं। पढ़ें **bool**। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ को कॉपी कन्स्ट्रक्ट करने की अनुमति देता है। |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, केवल नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज़ को कॉपी कन्स्ट्रक्ट करने की अनुमति देता है। |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | ट्रांज़िशन की दिशा। लिखें [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)। |
| virtual void [set_ThroughBlack](./set_throughblack/)(**bool**) | निर्दिष्ट करता है कि ट्रांज़िशन काले माध्यम से फेड होता है या नहीं। लिखें **bool**। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | nवें टेम्प्लेट आर्ग्युमेंट को एक वीक पॉइंटर (शेयरड के बजाय) सेट करता है। कंटेनर में पॉइंटर्स को वीक मोड में स्विच करने की अनुमति देता है। |
