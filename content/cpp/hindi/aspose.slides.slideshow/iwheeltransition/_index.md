...
---
## IWheelTransition क्लास

व्हील स्लाइड ट्रांज़िशन इफ़ेक्ट।
...
| virtual **uint32_t** [get_Spokes](./get_spokes/)() | व्हील ट्रांज़िशन के स्पोक की संख्या। पढ़ें **uint32_t**। |
...
| virtual void [set_Spokes](./set_spokes/)(**uint32_t**) | व्हील ट्रांज़िशन के स्पोक की संख्या। लिखें **uint32_t**। |
