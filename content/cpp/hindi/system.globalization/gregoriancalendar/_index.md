...
description: "ग्रेगोरियन कैलेंडर। इस क्लास की ऑब्जेक्ट्स को केवल System::MakeObject() फ़ंक्शन का उपयोग करके ही आवंटित किया जाना चाहिए। इस प्रकार का इंस्टेंस स्टैक पर या operator new का उपयोग करके कभी न बनाएँ, क्योंकि इससे रनटाइम त्रुटियाँ और/या असर्शन त्रुटियां उत्पन्न होंगी। हमेशा इस क्लास को System::SmartPtr पॉइंटर में रैप करें और इस पॉइंटर का उपयोग फ़ंक्शन को आर्ग्युमेंट के रूप में पास करने के लिए करें।"
type: docs
weight: 131
url: /hi/system.globalization/gregoriancalendar/
---
## GregorianCalendar क्लास
...
|  [Calendar](../calendar/calendar/)(const [Calendar](../calendar/)\&) | RTTI सूचना। |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | वर्तमान ऑब्जेक्ट की एक कॉपी बनाता है और उसे एक shared pointer के रूप में लौटाता है। |
...
| virtual [GregorianCalendarTypes](../gregoriancalendartypes/) [get_CalendarType](./get_calendartype/)() const | ग्रेगोरियन कैलेंडर प्रकार प्राप्त करता है। |
...
| [ArrayPtr](../../system/arrayptr/)\<int\> [get_Eras](./get_eras/)() const override | कैलेंडर में मौज़ूद युगों की सूची प्राप्त करता है। |
...
| virtual int [get_TwoDigitYearMax](../calendar/get_twodigityearmax/)() const | 2-अंकीय द्वारा दर्शाया जा सकने वाले अंतिम वर्ष को प्राप्त करता है। |
...
| int [GetDaysInYear](./getdaysinyear/)(int, int) const override | विशिष्ट वर्ष में दिनों की संख्या प्राप्त करता है। |
| virtual int [GetDaysInYear](./getdaysinyear/)(int) const | विशिष्ट वर्ष में दिनों की संख्या प्राप्त करता है। |
| virtual int [GetDaysInYear](./getdaysinyear/)(int, int) const | विशिष्ट वर्ष में दिनों की संख्या प्राप्त करता है। |
| static [CalendarPtr](../calendarptr/) [GetDefaultInstance](./getdefaultinstance/)() | डिफ़ॉल्ट ग्रेगोरियन कैलेंडर इंस्टेंस प्राप्त करता है। |
...
| virtual int [GetLeapMonth](./getleapmonth/)(int) const | निर्दिष्ट वर्ष के लिए लीप महीने को प्राप्त करता है। |
| virtual int [GetLeapMonth](./getleapmonth/)(int, int) const | निर्दिष्ट वर्ष के लिए लीप महीने को प्राप्त करता है। |
...
| virtual int [GetMonthsInYear](./getmonthsinyear/)(int) const | RTTI सूचना। |
| virtual int [GetMonthsInYear](./getmonthsinyear/)(int, int) const | RTTI सूचना। |
...
| int [GetYear](./getyear/)([DateTime](../../system/datetime/)) const override | निर्दिष्ट समय बिंदु के लिए वर्ष प्राप्त करता है। |
|  [GregorianCalendar](./gregoriancalendar/)([GregorianCalendarTypes](../gregoriancalendartypes/)) | विशिष्ट ग्रेगोरियन कैलेंडर का निर्माण करता है। |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का इन्स्टेंस है या नहीं। C# 'is' ऑपरेटर का समान। |
...
| **bool** [IsLeapMonth](./isleapmonth/)(int, int, int) const override | महीना लीप है या नहीं जाँचता है। |
| virtual **bool** [IsLeapMonth](./isleapmonth/)(int, int) const | महीना लीप है या नहीं जाँचता है। |
| virtual **bool** [IsLeapMonth](./isleapmonth/)(int, int, int) const | महीना लीप है या नहीं जाँचता है। |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | कॉपी कन्स्ट्रक्टर। वास्तव में कुछ भी कॉपी नहीं करता, बस नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज के कॉपी कन्स्ट्रक्शन को सक्षम करता है। |
| [Calendar](../calendar/)\& [operator=](../calendar/operator_equal/)(const [Calendar](../calendar/)\&) |  |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | असाइनमेंट ऑपरेटर। वास्तव में कुछ भी कॉपी नहीं करता, बस नया ऑब्जेक्ट इनिशियलाइज़ करता है और सबक्लासेज के कॉपी कन्स्ट्रक्शन को सक्षम करता है। |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | रैफ़रेंस-तुलना वैल्यू टाइप ऑब्जेक्ट को nullptr से करता है। |
...
| virtual void [set_CalendarType](./set_calendartype/)([GregorianCalendarTypes](../gregoriancalendartypes/)) | ग्रेगोरियन कैलेंडर प्रकार निर्धारित करता है। |
| virtual void [set_TwoDigitYearMax](../calendar/set_twodigityearmax/)(int) | 2-अंकीय द्वारा दर्शाए जा सकने वाले अंतिम वर्ष को निर्धारित करता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n-वें टेम्प्लेट आर्ग्युमेंट को वीक पॉइंटर (शेयर किए बजाय) सेट करता है। कंटेनरों में पॉइंटर को वीक मोड में बदलने की अनुमति देता है। |
