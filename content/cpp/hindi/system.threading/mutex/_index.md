...
description: "Mutex कार्यान्वयन। इस वर्ग की वस्तुओं को केवल System::MakeObject() फ़ंक्शन का उपयोग करके ही आवंटित किया जाना चाहिए। इस प्रकार का उदाहरण स्टैक में या operator new का उपयोग करके कभी न बनाएं, क्योंकि इससे रनटाइम त्रुटियाँ और/या असर्शन दोष उत्पन्न हो सकते हैं। हमेशा इस वर्ग को System::SmartPtr पॉइंटर में लपेटें और इस पॉइंटर का उपयोग फ़ंक्शन में तर्क के रूप में पास करने के लिए करें।"
type: docs
weight: 170
url: /hi/system.threading/mutex/
---
## Mutex वर्ग

[Mutex](./) कार्यान्वयन। इस वर्ग की वस्तुओं को केवल [System::MakeObject()](../../system/makeobject/) फ़ंक्शन का उपयोग करके ही आवंटित किया जाना चाहिए। इस प्रकार का उदाहरण स्टैक पर या operator new का उपयोग करके कभी न बनायें, क्योंकि इससे रनटाइम त्रुटियाँ और/या असर्शन त्रुटियाँ उत्पन्न हो सकती हैं। इस वर्ग को हमेशा [System::SmartPtr](../../system/smartptr/) पॉइंटर में लपेटें और इस पॉइंटर का उपयोग फ़ंक्शन में तर्क के रूप में पास करने के लिए करें।
...
| विधि | विवरण |
| --- | --- |
| virtual void [Close](../waithandle/close/)() | हैंडल से जुड़ा कोई भी संसाधन रिलीज़ करता है। |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | जाँचता है कि ऑब्जेक्ट targetType द्वारा वर्णित प्रकार का एक उदाहरण दर्शाता है या नहीं। C# 'is' ऑपरेटर का समतुल्य। |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) मेथड का समतुल्य। कस्टम टाइप्स की क्लोर्निंग सक्षम करता है। |
|  [Mutex](./mutex/)() | अनओन्ड mutex बनाता है। |
|  [Mutex](./mutex/)(**bool**) | कंस्ट्रक्टर। |
|  [Mutex](./mutex/)(**bool**, const [String](../../system/string/)\&) | कंस्ट्रक्टर। |
...
| void [ReleaseMutex](./releasemutex/)() | mutex को रिलीज़ करता है। |
| static **bool** [Remove](./remove/)(const [String](../../system/string/)\&) | सिस्टम से नामित mutex को मिटाता है। |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्दिष्ट मान द्वारा साझा रेफ़रेंस काउंट को घटाता है। |
| virtual **bool** [Reset](./reset/)() | mutex स्थिति को रीसेट करता है। लागू नहीं किया गया। |
| virtual **bool** [Set](./set/)() | mutex को सिग्नल्ड स्थिति में सेट करता है। लागू नहीं किया गया। |
...
| **bool** [WaitOne](./waitone/)() override | mutex को लॉक करता है। आवश्यक होने पर अनिश्चितकालीन प्रतीक्षा करता है। |
| **bool** [WaitOne](./waitone/)(int) override | mutex को लॉक करता है। आवश्यक होने पर प्रतीक्षा करता है। |
| **bool** [WaitOne](./waitone/)([TimeSpan](../../system/timespan/)) override | mutex को लॉक करता है। आवश्यक होने पर प्रतीक्षा करता है। |
...
| फ़ील्ड | विवरण |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | फ़ंक्शन द्वारा लौटाए जाने वाला विशेष मान, अन्यथा एरे में सिग्नल्ड ऑब्जेक्ट का इंडेक्स लौटाता है, यदि टाइमआउट समाप्त हो जाता है और कुछ भी सिग्नल नहीं करता। |
