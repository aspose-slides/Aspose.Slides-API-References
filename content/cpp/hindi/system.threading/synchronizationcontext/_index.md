...
description: विभिन्न समक्रमण संचालन के बीच समक्रमण संदर्भ को प्रसारित करने के लिए मूलभूत कार्यक्षमता प्रदान करता है।
type: docs
weight: 196
url: /hi/system.threading/synchronizationcontext/
---
## SynchronizationContext क्लास


विभिन्न समक्रमण संचालन के बीच समक्रमण संदर्भ को प्रसारित करने के लिए मूलभूत कार्यक्षमता प्रदान करता है।
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | वर्तमान थ्रेड के लिए समक्रमण संदर्भ प्राप्त करता है। |
...
| void [Lock](../../system/object/lock/)() | C# lock() वक्तव्य को लागू करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट का उपयोग करें। |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | कॉलबैक को असिंक्रोनस रूप से चलाता है। |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | निर्धारित मान द्वारा साझा रेफ़रेंस काउण्ट को घटाता है। |
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | कॉलबैक को सिंक्रोनस रूप से चलाता है। |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | वर्तमान थ्रेड के लिए समक्रमण संदर्भ सेट करता है। |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'th टेम्पलेट आर्ग्युमेंट को वीक पॉइंटर (शेयर किए गए के बजाय) सेट करता है। कंटेनरों में पॉइंटर्स को वीक मोड में बदलने की अनुमति देता है। |
...
|  [SynchronizationContext](./synchronizationcontext/)() | [SynchronizationContext](./) का नया instance बनाता है। |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() वक्तव्य को अनलॉक करता है। सीधे कॉल करें या [LockContext](../../system/lockcontext/) सेंट्री ऑब्जेक्ट का उपयोग करें। |
...
यह क्लास थ्रेड्स के बीच समक्रमण संदर्भ के प्रसार को सक्षम करती है और उचित थ्रेड या समक्रमण संदर्भ में कॉलबैक या इनवोकेशन को मार्शल करने के लिए उपयोग की जाती है। 
डमी कार्यान्वयन। 
