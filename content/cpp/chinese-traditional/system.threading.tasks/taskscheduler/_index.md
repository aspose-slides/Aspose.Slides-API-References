...
description: 表示一個負責將任務排入執行緒佇列之低階工作的物件。
type: docs
weight: 79
url: /zh-hant/system.threading.tasks/taskscheduler/
---
## TaskScheduler 類別

表示一個處理將任務排入執行緒佇列之低階工作的物件。
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | 建立一個與目前執行緒相關聯的 [TaskScheduler](./)。 |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | 取得與目前執行中的任務相關聯的 [TaskScheduler](./)。 |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | 取得框架提供的預設 [TaskScheduler](./) 實例。 |
| **int32_t** [get_Id](./get_id/)() const | 取得此 [TaskScheduler](./) 的唯一 ID。 |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | 指出此 [TaskScheduler](./) 能支援的最大併發等級。 |
