...
description: 提供平行迴圈的完成狀態。
type: docs
weight: 14
url: /zh-hant/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult 類別

Provides completion status of a [Parallel](../parallel/) loop.
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | 取得迴圈是否已完成執行。 |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | 取得發生中斷的最低迭代索引。 |
...
|  [ParallelLoopResult](./parallelloopresult/)() | 建構一個 [ParallelLoopResult](./)。 |
