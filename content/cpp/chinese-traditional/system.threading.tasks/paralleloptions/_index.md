...
description: 儲存配置 Parallel 類別 方法之運作的選項。
type: docs
weight: 27
url: /zh-hant/system.threading.tasks/paralleloptions/
---
## ParallelOptions 類別


儲存配置 [Parallel](../parallel/) 類別 方法之運作的選項。
...
| const [CancellationToken](../../system.threading/cancellationtoken/)\& [get_CancellationToken](./get_cancellationtoken/)() | 取得與此 [ParallelOptions](./) 實例相關聯的 [CancellationToken](../../system.threading/cancellationtoken/)。 |
| **int32_t** [get_MaxDegreeOfParallelism](./get_maxdegreeofparallelism/)() | 取得此 [ParallelOptions](./) 實例所啟用的最大平行度。 |
| const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](../taskscheduler/)\>\& [get_TaskScheduler](./get_taskscheduler/)() | 取得與此 [ParallelOptions](./) 實例相關聯的 [TaskScheduler](../taskscheduler/)。 |
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 敘述之鎖定。直接呼叫或使用 [LockContext](../../system/lockcontext/) 哨兵物件。 |
...
|  [ParallelOptions](./paralleloptions/)() | 以預設值建構 [ParallelOptions](./) 實例。 |
...
| void [set_CancellationToken](./set_cancellationtoken/)(const [CancellationToken](../../system.threading/cancellationtoken/)\&) | 設定與此 [ParallelOptions](./) 實例相關聯的 [CancellationToken](../../system.threading/cancellationtoken/)。 |
| void [set_MaxDegreeOfParallelism](./set_maxdegreeofparallelism/)(**int32_t**) | 設定此 [ParallelOptions](./) 實例所啟用的最大平行度。 |
| void [set_TaskScheduler](./set_taskscheduler/)(const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](../taskscheduler/)\>\&) | 設定與此 [ParallelOptions](./) 實例相關聯的 [TaskScheduler](../taskscheduler/)。 |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 敘述之解鎖。直接呼叫或使用 [LockContext](../../system/lockcontext/) 哨兵物件。 |
