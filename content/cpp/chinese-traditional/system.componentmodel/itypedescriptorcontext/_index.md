...
description: "用於編譯依賴 ITypeDescriptorContext 的程式碼的虛擬介面。此類別的物件只能使用 System::MakeObject() 函式配置。切勿在堆疊上或使用 new 運算子建立此類型的實例，否則會導致執行時錯誤或斷言失敗。應始終將此類別包裝為 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 144
url: /zh-hant/system.componentmodel/itypedescriptorcontext/
---
## ITypeDescriptorContext 類別
