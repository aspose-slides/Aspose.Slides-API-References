...
description: "此虛擬類別用於在翻譯後使使用 TypeDescriptor 的程式碼能編譯。此類別的物件只能透過 System::MakeObject() 函式進行配置。切勿在堆疊上或使用 new 運算子建立此類型的實例，否則會導致執行時錯誤和/或斷言失敗。務必將此類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 209
url: /zh-hant/system.componentmodel/typedescriptor/
---
## TypeDescriptor 類別
...
| static [System::SharedPtr](../../system/sharedptr/)\<[TypeConverter](../typeconverter/)\> [GetConverter](./getconverter/)(const [TypeInfo](../../system/typeinfo/)\&) | RTTI 資訊。 |
