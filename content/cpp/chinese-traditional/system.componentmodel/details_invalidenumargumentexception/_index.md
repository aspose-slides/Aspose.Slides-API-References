...
type: docs
weight: 66
url: /zh-hant/system.componentmodel/details_invalidenumargumentexception/
---
## Details_InvalidEnumArgumentException 類別
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，儘管依據 IEC 60559:1989，NaN 不等於任何值，包含 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，儘管依據 IEC 60559:1989，NaN 不等於任何值，包含 NaN 本身。 |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 傳回 32 位元整數，為與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | 傳回代表最內層例外的 Exception 物件副本。 |
...
| int [SharedCount](../../system/object/sharedcount/)() const | 取得共用參考計數器的當前值。 |
