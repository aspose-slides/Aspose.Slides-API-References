...
description: "拋出與 Win32 錯誤代碼相關的例外。切勿手動建立此類別的實例。請改用 Win32Exception 類別。切勿將 Win32Exception 類別的實例封裝至 System::SmartPtr。"
type: docs
weight: 79
url: /zh-hant/system.componentmodel/details_win32exception/
---
## Details_Win32Exception 類別

拋出一個與 Win32 錯誤代碼相關的例外。 切勿手動建立此類別的實例。 請改用 Win32Exception 類別。 切勿將 Win32Exception 類別的實例封裝進 [System::SmartPtr](../../system/smartptr/)。
...
| virtual **int32_t** [get_NativeErrorCode](./get_nativeerrorcode/)() const | 取得與此例外相關聯的 Win32 錯誤代碼。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷貝建構函式。實際上不會複製任何東西，只是初始化新物件並允許子類別進行拷貝建構。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 實作 [what()](../../system/details_exception/what/) 方法，由 [ExceptionWrapper](../../system/exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，衍生類別仍可使用受保護/私有成員實作其邏輯。將此方法實作移至 [ExceptionWrapper](../../system/exceptionwrapper/) 可能會破壞該邏輯。 |
