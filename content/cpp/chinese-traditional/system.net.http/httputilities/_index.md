...
type: docs
weight: 131
url: /zh-hant/system.net.http/httputilities/
---
## HttpUtilities 類別
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | 檢查指定的 URI 是否為 HTTP URI。 |
...
| 欄位 | 描述 |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | 發送請求的預設 HTTP 版號。 |
| static [DefaultResponseVersion](./defaultresponseversion/) | 接收回應的預設 HTTP 版號。 |
