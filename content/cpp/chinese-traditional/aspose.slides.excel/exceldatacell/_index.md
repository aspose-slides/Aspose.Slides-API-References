...
| **int32_t** [get_Column](./get_column/)() override | 取得儲存格所在工作表中欄位的零基索引。唯讀 **int32_t**。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 取得圖表資料儲存格的名稱。 |
| **int32_t** [get_Row](./get_row/)() override | 取得儲存格所在工作表中列的零基索引。唯讀 **int32_t**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | 取得 [Excel](../) 儲存格中包含的值。 |
