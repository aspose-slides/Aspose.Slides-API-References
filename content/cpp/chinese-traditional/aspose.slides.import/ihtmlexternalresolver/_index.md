...
description: 用於 HTML 匯入程序以取得諸如影像等被參照的物件的回呼介面。
type: docs
weight: 53
url: /zh-hant/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver 類別

HTML 匯入程序使用的回呼介面，用於取得如影像等被參照的物件。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | 將 URI 映射至包含實際資源的物件。 |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | 從基礎與相對 URI 解析絕對 URI。 |
...
已棄用
:   已過時。改用 [IExternalResourceResolver](../iexternalresourceresolver/)。將在 17.12 版中移除。

## 另請參閱

* 類別 [IExternalResourceResolver](../iexternalresourceresolver/)
