...
description: 在 Html、Svg 文件匯入過程中使用的回呼介面，用於解析外部資源。
type: docs
weight: 40
url: /zh-hant/aspose.slides.import/iexternalresourceresolver/
---
## IExternalResourceResolver 類別

在 Html、Svg 文件匯入過程中用於解析外部資源的回呼介面。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) | 將 URI 對映至包含實際資源的物件。 |
...
| virtual [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | 從基礎 URI 與相對 URI 解析絕對 URI。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n'th 模板參數設定為弱指標（而非共享）。允許在容器中切換指標至弱模式。 |
