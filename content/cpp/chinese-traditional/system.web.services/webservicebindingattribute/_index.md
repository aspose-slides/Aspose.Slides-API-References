...
description: "用於聲明一個綁定，該綁定定義 XML Web 服務的一個或多個方法。此類的物件應僅使用 System::MakeObject() 函式分配。絕不要在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 40
url: /zh-hant/system.web.services/webservicebindingattribute/
---
## WebServiceBindingAttribute 類別

用於聲明一個綁定，該綁定定義 XML [Web](../../system.web/) 服務的一個或多個方法。此類的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函式分配。絕不要在堆疊上或使用 operator new 建立此類型的實例，因為這會導致執行時錯誤和/或斷言失敗。請始終將此類包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
...
| [System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\> [get_ConformsTo](./get_conformsto/)() | 取得 WSI 規格。 |
| **bool** [get_EmitConformanceClaims](./get_emitconformanceclaims/)() | 取得指示此綁定是否發出相容性聲明的值。 |
| [String](../../system/string/) [get_Location](./get_location/)() | 取得定義此綁定的位置。 |
| [String](../../system/string/) [get_Name](./get_name/)() | 取得綁定的名稱。 |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | 取得與此綁定相關聯的命名空間。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| static [Object::ptr](../../system/object/ptr/) [GetCustomAttribute](../../system/attribute/getcustomattribute/)(const [TypeInfo](../../system/typeinfo/)\&, const [TypeInfo](../../system/typeinfo/)\&) | 回傳套用於指定類型的自訂屬性。 |
| static [ArrayPtr](../../system/arrayptr/)\<[Object::ptr](../../system/object/ptr/)\> [GetCustomAttributes](../../system/attribute/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&) | 回傳套用於指定類型的所有自訂屬性。 |
...
| void [set_ConformsTo](./set_conformsto/)([System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\>) | 設定 WSI 規格。 |
| void [set_EmitConformanceClaims](./set_emitconformanceclaims/)(**bool**) | 設定指示此綁定是否發出相容性聲明的值。 |
| void [set_Location](./set_location/)([String](../../system/string/)) | 設定定義此綁定的位置。 |
| void [set_Name](./set_name/)([String](../../system/string/)) | 設定綁定的名稱。 |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | 設定與此綁定相關聯的命名空間。 |
...
|  [WebServiceBindingAttribute](./webservicebindingattribute/)() | 建構一個新實例。 |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/)) | 建構一個新實例。 |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/)) | 建構一個新實例。 |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | 建構一個新實例。 |
| virtual  [~Object](../../system/object/~object/)() | 銷毀物件。釋放所有內部資料結構。 |

## 另請參閱

* 類別 [Attribute](../../system/attribute/)
* 命名空間 [System::Web::Services](../)
* 函式庫 [Aspose.Slides](../../)