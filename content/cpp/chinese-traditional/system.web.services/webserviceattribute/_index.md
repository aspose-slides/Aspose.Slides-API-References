...
description: "為 XML Web 服務添加額外資訊。此類別的物件應僅使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 27
url: /zh-hant/system.web.services/webserviceattribute/
---
## WebServiceAttribute 類別

向 XML [Web](../../system.web/) 服務添加其他資訊。此類別的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。應始終將此類別封裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
...
| [String](../../system/string/) [get_Description](./get_description/)() | 取得包含 XML [Web](../../system.web/) 服務描述的訊息。 |
| [String](../../system/string/) [get_Name](./get_name/)() | 取得 XML [Web](../../system.web/) 服務的名稱。 |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | 取得用於 XML [Web](../../system.web/) 服務的預設命名空間。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| static [Object::ptr](../../system/object/ptr/) [GetCustomAttribute](../../system/attribute/getcustomattribute/)(const [TypeInfo](../../system/typeinfo/)\&, const [TypeInfo](../../system/typeinfo/)\&) | 傳回套用於指定類型之指定類型的自訂屬性。 |
| static [ArrayPtr](../../system/arrayptr/)\<[Object::ptr](../../system/object/ptr/)\> [GetCustomAttributes](../../system/attribute/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&) | 傳回套用於指定類型的所有自訂屬性。 |
...
| void [set_Description](./set_description/)([String](../../system/string/)) | 設定包含 XML [Web](../../system.web/) 服務描述的訊息。 |
| void [set_Name](./set_name/)([String](../../system/string/)) | 設定 XML [Web](../../system.web/) 服務的名稱。 |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | 設定用於 XML [Web](../../system.web/) 服務的預設命名空間。 |
...
|  [WebServiceAttribute](./webserviceattribute/)() | 建構新實例。 |
...
| 欄位 | 說明 |
| --- | --- |
| static [DefaultNamespace](./defaultnamespace/) | ‘Namespace’ 屬性的預設值。 |
