...
description: 用於 XmlSerializer 的內部類別。
type: docs
weight: 79
url: /zh-hant/system.xml.serialization/xmlserializerimplementation/
---
## XmlSerializerImplementation 類別

內部類別，用於 [XmlSerializer](../xmlserializer/)。
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 敘述的上鎖。直接呼叫或使用 [LockContext](../../system/lockcontext/) 哨兵物件。 |
