...
description: "提供用於 XML 序列化與反序列化的自訂格式化。此類別的物件應僅透過 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用此指標作為參數傳遞給函式。"
type: docs
weight: 1
url: /zh-hant/system.xml.serialization/ixmlserializable/
---
## IXmlSerializable 類別

提供用於 XML 序列化與反序列化的自訂格式化。此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標作為參數傳遞給函式。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchema](../../system.xml.schema/xmlschema/)\> [GetSchema](./getschema/)() | 由 [WriteXml()](./writexml/) 方法回傳且由 [ReadXml()](./readxml/) 方法接受之物件的 XML 表示的 XmlSchema 物件。 |
...
| virtual void [ReadXml](./readxml/)([System::SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlReader](../../system.xml/xmlreader/)\>) | 從其 XML 表示反序列化物件。 |
...
| virtual void [WriteXml](./writexml/)([System::SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlWriter](../../system.xml/xmlwriter/)\>) | 將目前物件序列化為 XML 表示。 |
| virtual  [~IXmlSerializable](./~ixmlserializable/)() | 解構子。 |
