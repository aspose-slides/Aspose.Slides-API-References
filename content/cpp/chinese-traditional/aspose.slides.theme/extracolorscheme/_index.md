...
description: 表示一個可指派給投影片的額外顏色配置。
type: docs
weight: 79
...
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 傳回此配置的名稱。唯讀 [System::String](../../system/string/)。 |
...
* 類別 [IExtraColorScheme](../iextracolorscheme/)
