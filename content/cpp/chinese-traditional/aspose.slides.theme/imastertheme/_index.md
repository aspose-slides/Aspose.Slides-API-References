...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](../itheme/get_colorscheme/)() | 返回顏色配置。唯讀 [IColorScheme](../icolorscheme/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) | 返回指定索引處的額外顏色配置。此配置不會影響簡報的外觀，可被選擇為投影片的主要顏色配置。唯讀 [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() | 返回額外顏色配置的集合。這些配置不會影響簡報的外觀，可被選擇為投影片的主要顏色配置。唯讀 [IExtraColorSchemeCollection](../iextracolorschemecollection/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](../itheme/get_fontscheme/)() | 返回字型配置。唯讀 [IFontScheme](../ifontscheme/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](../itheme/get_formatscheme/)() | 返回形狀格式配置。唯讀 [IFormatScheme](../iformatscheme/)。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 返回主題的名稱。讀取 [System::String](../../system/string/)。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](../itheme/geteffective/)() | 取得套用繼承後的有效主題資料。 |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | 返回主題的名稱。寫入 [System::String](../../system/string/)。 |
