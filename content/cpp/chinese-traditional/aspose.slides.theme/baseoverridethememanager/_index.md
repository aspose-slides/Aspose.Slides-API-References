...
description: 提供存取不同類型已覆寫主題的類別之基底類別。
type: docs
weight: 1
...
| Method | Description |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | 將額外的色彩配置套用至投影片。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | 傳回主題物件。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，其中兩個 NaN 被視為相等，儘管依據 IEC 60559:1989，NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，其中兩個 NaN 被視為相等，儘管依據 IEC 60559:1989，NaN 不等於任何值，包括 NaN 本身。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | 判斷 [OverrideTheme](../overridetheme/) 是否覆寫繼承的有效主題。若要啟用 [OverrideTheme](../overridetheme/) 以進行覆寫，請使用 OverrideTheme.Init*() 方法。若要停用 [OverrideTheme](../overridetheme/) 的覆寫，請使用 [OverrideTheme::Clear](../overridetheme/clear/) 方法。唯讀 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | 傳回覆寫的主題物件。讀取 [IOverrideTheme](../ioverridetheme/)。 |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | 傳回覆寫的主題物件。寫入 [IOverrideTheme](../ioverridetheme/)。 |
...
* 類別 [IOverrideThemeManager](../ioverridethememanager/)
