...
description: 表示可以使用 ITheme 進行佈景的物件。
type: docs
weight: 443
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() | 傳回此可佈景物件的有效佈景。 |
