...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() | 傳回投影片「heading」部分的字型集合。唯讀 [IFonts](../../aspose.slides/ifonts/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() | 傳回投影片「body」部分的字型集合。唯讀 [IFonts](../../aspose.slides/ifonts/)。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 傳回字型方案名稱。只讀 [System::String](../../system/string/)。 |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | 傳回字型方案名稱。寫入 [System::String](../../system/string/)。 |
