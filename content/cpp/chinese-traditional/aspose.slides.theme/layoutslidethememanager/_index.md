...
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../baseoverridethememanager/createthemeeffective/)() override | 返回主題物件。 |
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | 判斷 [OverrideTheme](../overridetheme/) 是否覆寫繼承的有效主題。若要啟用 [OverrideTheme](../overridetheme/) 進行覆寫，請使用 OverrideTheme.Init*() 方法。若要停用 [OverrideTheme](../overridetheme/) 的覆寫，請使用 [OverrideTheme::Clear](../overridetheme/clear/) 方法。唯讀 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | 返回覆寫的主題物件。讀取 [IOverrideTheme](../ioverridetheme/)。 |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | 返回覆寫的主題物件。寫入 [IOverrideTheme](../ioverridetheme/)。 |
