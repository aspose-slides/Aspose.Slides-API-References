...
| Method | Description |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | 將額外的配色方案套用到投影片上。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithememanager/createthemeeffective/)() | 返回主題物件。 |
...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | 判斷 [OverrideTheme](../overridetheme/) 是否覆寫繼承的有效主題。要啟用 [OverrideTheme](../overridetheme/) 以進行覆寫，請使用 OverrideTheme.Init*() 方法。要停用 [OverrideTheme](../overridetheme/) 的覆寫，請使用 [get_OverrideTheme()](./get_overridetheme/)->Clear() 方法。唯讀 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() | 返回覆寫的主題物件。讀取 [IOverrideTheme](../ioverridetheme/)。 |
...
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) | 返回覆寫的主題物件。寫入 [IOverrideTheme](../ioverridetheme/)。 |
