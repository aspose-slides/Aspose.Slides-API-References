...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontSchemeEffectiveData](../ifontschemeeffectivedata/)\> [get_FontScheme](./get_fontscheme/)() | 傳回字型方案。唯讀 [IFontSchemeEffectiveData](../ifontschemeeffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatSchemeEffectiveData](../iformatschemeeffectivedata/)\> [get_FormatScheme](./get_formatscheme/)() | 傳回形狀格式方案。唯讀 [IFormatSchemeEffectiveData](../iformatschemeeffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorSchemeEffectiveData](../icolorschemeeffectivedata/)\> [GetColorScheme](./getcolorscheme/)([System::Drawing::Color](../../system.drawing/color/)) | 傳回顏色方案。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否為 targetType 描述之型別的實例。類似 C# 'is' 運算子。 |
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述式的鎖定機制。直接呼叫或使用 [LockContext](../../system/lockcontext/) 守衛物件。 |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 陳述式的解鎖機制。直接呼叫或使用 [LockContext](../../system/lockcontext/) 守衛物件。 |
...
此介面與 [ITheme](../itheme/) 介面一起使用，以回傳套用繼承的有效格式化值。
