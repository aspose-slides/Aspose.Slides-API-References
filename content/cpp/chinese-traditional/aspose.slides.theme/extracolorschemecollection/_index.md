...
| [const_iterator](./const_iterator/) [begin](./begin/)() const | 取得指向集合的 const 限定實例之第一個元素（若存在）的迭代器。 |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | 取得指向集合第一個 const 限定元素（若存在）的迭代器。 |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 取得指向集合最後一個 const 限定元素之後（若存在）的迭代器。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>\>, **int32_t**) override | 將集合的所有元素複製到指定的陣列。 |
| [iterator](./iterator/) [end](./end/)() | 取得指向集合最後一個元素之後（若存在）的迭代器。 |
| [const_iterator](./const_iterator/) [end](./end/)() const | 取得指向集合的 const 限定實例之最後一個元素（若存在）之後的迭代器。 |
...
| **int32_t** [get_Count](./get_count/)() override | 傳回集合中元素的數量。唯讀 **int32_t**。 |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | 傳回一個值，表示對 ArrayList 的存取是否已同步（執行緒安全）。唯讀 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | 傳回可用於同步存取集合的物件。唯讀 [System::Object](../../system/object/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>\>\> [GetEnumerator](./getenumerator/)() override | 傳回可遍歷集合的列舉器。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [idx_get](./idx_get/)(**int32_t**) override | 依索引傳回顏色配置方案。唯讀 [ExtraColorScheme](../extracolorscheme/)。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | 判斷序列中是否有任何元素或是否有元素滿足條件。 |
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | 計算數值序列的平均值。 |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 計算透過對輸入序列的每個元素呼叫轉換函式所獲得之值的序列的平均值。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | 從序列開頭跳過指定數量的連續元素並傳回剩餘部分。 |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 取得指向集合的 const 限定實例之第一個元素（若存在）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 取得指向集合第一個元素（若存在）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 取得指向集合的 const 限定實例之最後一個元素（若存在）之後的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | 取得指向集合最後一個元素之後（若存在）的迭代器。 |
...
| Typedef | Description |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 一種集合型別，其迭代器型別用作目前集合的迭代器型別。 |
...
* 類別 [IExtraColorSchemeCollection](../iextracolorschemecollection/)
