...
description: "根據 CMS/PKCS #7 標準簽署內容。未實作。此類別的物件應僅使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。應始終將此類別包裝成 System::SmartPtr 指標，並使用該指標將其傳遞給函式作為參數。"
type: docs
weight: 27
url: /zh-hant/system.security.cryptography.pkcs/signedcms/
---
## SignedCms 類別

根據 CMS/PKCS #7 標準簽署內容。未實作。此類別的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函數分配。絕不要在堆疊上或使用 operator new 建立此類型的實例，因為這會導致執行時錯誤和/或斷言失敗。應始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標將其傳遞給函式作為參數。
...
| 方法 | 說明 |
| --- | --- |
| void [ComputeSignature](./computesignature/)(const [SharedPtr](../../system/sharedptr/)\<[CmsSigner](../cmssigner/)\>\&, **bool**) | 建立簽章。 |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [Encode](./encode/)() | 編碼 CMS/PKCS #7 訊息。 |
...
| [SignedCms](./signedcms/)(const [SharedPtr](../../system/sharedptr/)\<[ContentInfo](../contentinfo/)\>\&, **bool**) | 建構子。 |
