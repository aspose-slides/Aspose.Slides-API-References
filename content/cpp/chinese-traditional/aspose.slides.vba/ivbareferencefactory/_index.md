...
| 方法 | 說明 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)\> [CreateOleTypeLibReference](./createoletypelibreference/)([System::String](../../system/string/), [System::String](../../system/string/)) | 建立新的 OLE Automation 類型庫參考。 |
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 敘述的鎖定行為。直接呼叫或使用 [LockContext](../../system/lockcontext/) 監視物件。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化，針對字串和 nullptr 的情形。 |
