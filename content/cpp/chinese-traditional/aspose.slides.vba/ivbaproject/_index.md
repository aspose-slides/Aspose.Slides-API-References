...
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | 指示 VBAProject 是否受密碼保護以檢視專案屬性。唯讀 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) | 傳回位於指定索引的 VBA 專案中所包含的模組。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() | 傳回 VBA 專案中所有模組的清單。唯讀 [IVbaModuleCollection](../ivbamodulecollection/)。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 傳回 VBA 專案的名稱。唯讀 [System::String](../../system/string/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) | 傳回位於指定索引的 VBA 專案中所包含的參考。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() | 傳回 VBA 專案中所有參考的清單。唯讀 [IVbaReferenceCollection](../ivbareferencecollection/)。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() | 傳回 VBA 專案作為 OLE 容器的二進位表示。唯讀 **uint8_t**[]。 |
