...
description: 表示已修改的 OLE Automation 類型庫參考，其中所有控制項均標記為可擴充。
type: docs
weight: 92
url: /zh-hant/aspose.slides.vba/ivbareferenceoletwiddledtypelib/
---
## IVbaReferenceOleTwiddledTypeLib 類別

表示已修改的 OLE Automation 類型庫參考，其中所有控制項皆標記為可擴充。
...
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | 表示 VBA 專案參考的名稱。閱讀 [System::String](../../system/string/)。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將已共享參考計數減少指定的值。 |
| virtual void [set_Name](../ivbareference/set_name/)([System::String](../../system/string/)) | 表示 VBA 專案參考的名稱。寫入 [System::String](../../system/string/)。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 設定第 n 個模板參數為弱指標（而非共享）。允許在容器中將指標切換為弱模式。 |
| int [SharedCount](../../system/object/sharedcount/)() const | 取得已共享參考計數器的當前值。 |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 遞增已共享參考計數。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 遞減並回傳已共享參考計數。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
...
* 類別 [IVbaReference](../ivbareference/)
