...
| **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() override | 指出 VBAProject 是否受密碼保護以檢視專案屬性。唯讀 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) override | 傳回位於指定索引的 VBA 專案中包含的模組。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() override | 傳回 VBA 專案中包含的所有模組的清單。唯讀 [IVbaModuleCollection](../ivbamodulecollection/)。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 傳回 VBA 專案的名稱。唯讀 [System::String](../../system/string/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) override | 傳回位於指定索引的 VBA 專案中包含的參考。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() override | 傳回 VBA 專案中包含的所有參考的清單。唯讀 [IVbaReferenceCollection](../ivbareferencecollection/)。 |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() override | 傳回 VBA 專案的二進位表示形式，作為 OLE 容器 |
...
|  [VbaProject](./vbaproject/)() | 此建構函式從頭開始建立新的 VBA 專案。專案將以 1252 Windows Latin 1 (ANSI) 代碼頁建立 |
|  [VbaProject](./vbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 此建構函式從 OLE 容器的二進位表示載入 VBA 專案。 |
