...
description: 表示 OLE Automation 型別庫參考。
type: docs
weight: 105
url: /zh-hant/aspose.slides.vba/ivbareferenceoletypelib/
---
## IVbaReferenceOleTypeLib 類別

表示 OLE Automation 型別庫參考。
...
| virtual [System::String](../../system/string/) [get_Libid](./get_libid/)() | 表示 Automation 類型庫的識別碼。讀取 [System::String](../../system/string/)。 |
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | 表示 VBA 專案參考的名稱。讀取 [System::String](../../system/string/)。 |
...
| virtual void [set_Libid](./set_libid/)([System::String](../../system/string/)) | 表示 Automation 類型庫的識別碼。寫入 [System::String](../../system/string/)。 |
