...
description: 表示 Shape 鎖定（已停用的操作）。
type: docs
weight: 1483
...
| virtual **bool** [get_NoLocks](./get_nolocks/)() | 如果所有鎖定旗標皆已停用，則回傳 true。唯讀 **bool**。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 個模板參數設定為弱指標（而非共享指標）。允許在容器中將指標切換為弱模式。 |
