...
description: 代表管理佈局投影片頁腳、日期時間、頁碼佔位符以及所有子佔位符的行為的管理器。子佔位符指的是包含於相依投影片上的佔位符。相依投影片使用且依賴於佈局投影片。
type: docs
weight: 4317
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | 取得指示日期時間佔位符是否存在的值。讀取**bool**。 |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | 取得指示頁腳佔位符是否存在的值。讀取 **bool**。 |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | 取得指示頁碼佔位符是否存在的值。讀取**bool**。 |
...
| void [SetDateTimeAndChildDateTimesText](./setdatetimeandchilddatetimestext/)([System::String](../../system/string/)) override | 將文字設定到版面投影片的日期時間佔位符以及所有子佔位符。子佔位符表示這些佔位符位於相依投影片上。相依投影片使用且依賴於版面投影片。 |
| void [SetDateTimeAndChildDateTimesVisibility](./setdatetimeandchilddatetimesvisibility/)(**bool**) override | 變更版面投影片日期時間佔位符以及所有子佔位符的可見性。子佔位符表示這些佔位符位於相依投影片上。相依投影片使用且依賴於版面投影片。 |
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | 將文字設定到投影片的日期時間佔位符。 |
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | 變更投影片日期時間佔位符的可見性。 |
| void [SetFooterAndChildFootersText](./setfooterandchildfooterstext/)([System::String](../../system/string/)) override | 將文字設定到版面投影片的頁腳佔位符以及所有子頁腳佔位符。子佔位符表示這些佔位符位於相依投影片上。相依投影片使用且依賴於版面投影片。 |
| void [SetFooterAndChildFootersVisibility](./setfooterandchildfootersvisibility/)(**bool**) override | 變更版面投影片頁腳佔位符以及所有子頁腳佔位符的可見性。子佔位符表示這些佔位符位於相依投影片上。相依投影片使用且依賴於母版投影片。 |
| void [SetFooterText](../baseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) override | 將文字設定到投影片的頁腳佔位符。 |
| void [SetFooterVisibility](../baseslideheaderfootermanager/setfootervisibility/)(**bool**) override | 變更投影片頁腳佔位符的可見性。 |
| void [SetSlideNumberAndChildSlideNumbersVisibility](./setslidenumberandchildslidenumbersvisibility/)(**bool**) override | 變更版面投影片頁碼佔位符以及所有子頁碼佔位符的可見性。子佔位符表示這些佔位符位於相依投影片上。相依投影片使用且依賴於版面投影片。 |
...
* 類別 [ILayoutSlideHeaderFooterManager](../ilayoutslideheaderfootermanager/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)