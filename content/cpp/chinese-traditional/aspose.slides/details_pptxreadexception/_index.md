...
type: docs
weight: 742
url: /zh-hant/aspose.slides/details_pptxreadexception/
---
## Details_PptxReadException 類別
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 傳回 32 位元整數值，作為與目前物件所表示的例外相關的 HRESULT 代碼。 |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | 設定 HRESULT，這是一個分配給特定例外的編碼數值。 |
...
* 類別 [Details_PptxException](../details_pptxexception/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)