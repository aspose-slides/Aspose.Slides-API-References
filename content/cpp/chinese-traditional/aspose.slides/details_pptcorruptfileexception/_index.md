...
type: docs
weight: 651
url: /zh-hant/aspose.slides/details_pptcorruptfileexception/
---
## Details_PptCorruptFileException 類別
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 回傳一個 32 位元整數值，此值為與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | 回傳代表內部例外之物件的參考。 |
...
* 類別 [Details_PptReadException](../details_pptreadexception/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)