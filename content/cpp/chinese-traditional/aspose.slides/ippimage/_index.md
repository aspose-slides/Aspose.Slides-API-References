...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | 傳回影像資料的副本。唯讀 **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | 傳回影像的 MIME 類型，使用 [IPPImage::get_BinaryData](./get_binarydata/) 編碼。唯讀 [System::String](../../system/string/)。 |
| virtual **int32_t** [get_Height](./get_height/)() | 傳回影像的高度。唯讀 **int32_t**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [get_Image](./get_image/)() | 傳回影像的副本。唯讀 [System::Drawing::Image](../../system.drawing/image/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\> [get_SvgImage](./get_svgimage/)() const | 傳回 [ISvgImage](../isvgimage/) 物件 [ISvgImage](../isvgimage/) |
| virtual **int32_t** [get_Width](./get_width/)() | 傳回影像的寬度。唯讀 **int32_t**。 |
| virtual **int32_t** [get_X](./get_x/)() | 傳回影像的 X 偏移。唯讀 **int32_t**。 |
| virtual **int32_t** [get_Y](./get_y/)() | 傳回影像的 Y 偏移。唯讀 **int32_t**。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否為 targetType 所描述的型別實例。C# 'is' 運算子的類比。 |
...
| virtual void [ReplaceImage](./replaceimage/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 取代影像資料。 |
| virtual void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\>) | 取代影像。 |
| virtual void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](./)\>) | 取代影像。 |
| virtual void [set_SvgImage](./set_svgimage/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\>) | 設定 [ISvgImage](../isvgimage/) 物件 [ISvgImage](../isvgimage/) |
