...
| 方法 | 說明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [CreateFontData](./createfontdata/)([System::String](../../system/string/)) override | 使用指定的字體名稱建立 [FontData](../fontdata/)。 |
...
* 類別 [IFontDataFactory](../ifontdatafactory/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)