...
description: 指定投影片區域的尺寸（在 normal view 中，當為 restoredTop 的子項時為寬度，當為 restoredLeft 的子項時為高度），且該區域具有可變的還原大小（既非最小化也非最大化）。
type: docs
weight: 4538
...
指定投影片區域的尺寸（在 normal view 中，當為 restoredTop 的子項時為寬度，當為 restoredLeft 的子項時為高度），且該區域具有可變的還原大小（既非最小化也非最大化）。
...
| **bool** [get_AutoAdjust](./get_autoadjust/)() override | 指定在調整包含該視圖之視窗大小時，側邊內容區域的尺寸是否應補償新尺寸。讀取 **bool**。 |
| **float** [get_DimensionSize](./get_dimensionsize/)() override | 指定投影片區域的大小（當為 RestoredTop 的子項時為寬度，當為 RestoredLeft 的子項時為高度）。讀取 **float**。 |
...
| void [set_AutoAdjust](./set_autoadjust/)(**bool**) override | 指定在調整包含該視圖之視窗大小時，側邊內容區域的尺寸是否應補償新尺寸。寫入 **bool**。 |
| void [set_DimensionSize](./set_dimensionsize/)(**float**) override | 指定投影片區域的大小（當為 RestoredTop 的子項時為寬度，當為 RestoredLeft 的子項時為高度）。寫入 **float**。 |
...
* 類別 [INormalViewRestoredProperties](../inormalviewrestoredproperties/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)