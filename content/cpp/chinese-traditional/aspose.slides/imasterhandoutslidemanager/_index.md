...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [get_MasterHandoutSlide](./get_masterhandoutslide/)() | Returns a master for all notes slides of this presentation if there is one, otherwise returns null. 唯讀 [IMasterHandoutSlide](../imasterhandoutslide/). |
...
| virtual void [RemoveMasterHandoutSlide](./removemasterhandoutslide/)() | 移除母版講義投影片。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [SetDefaultMasterHandoutSlide](./setdefaultmasterhandoutslide/)() | 將預設母版講義投影片設為相關的講義投影片。 |
