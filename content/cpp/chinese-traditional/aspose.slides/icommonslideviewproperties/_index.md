...
description: 代表共用投影片檢視屬性。
type: docs
weight: 1834
url: /zh-hant/aspose.slides/icommonslideviewproperties/
---
## ICommonSlideViewProperties 類別
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | 傳回指定索引處的繪圖指引。唯讀 [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | 傳回繪圖指引的集合。唯讀 [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | 指定檢視縮放比例（百分比）。讀取 **int32_t**。 |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | 指定檢視內容應自動縮放以最佳適應目前視窗大小。讀取 **bool**。 |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | 指定檢視縮放比例（百分比）。寫入 **int32_t**。 |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | 指定檢視內容應自動縮放以最佳適應目前視窗大小。寫入 **bool**。 |
