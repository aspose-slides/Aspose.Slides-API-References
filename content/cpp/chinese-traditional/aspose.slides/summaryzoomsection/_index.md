...
代表 Summary Zoom [Section](../section/) 物件於 Summary Zoom 框架中。
...
| 方法 | 說明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [AddPlaceholder](../shape/addplaceholder/)([System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\>) override | 如果沒有則新增一個佔位符，並將佔位符屬性設定為指定的佔位符。 |
...
| [System::String](../../system/string/) [get_AlternativeText](../shape/get_alternativetext/)() override | 傳回與圖形關聯的替代文字。閱讀 [System::String](../../system/string/)。 |
| [System::String](../../system/string/) [get_AlternativeTextTitle](../shape/get_alternativetexttitle/)() override | 傳回與圖形關聯的替代文字標題。閱讀 [System::String](../../system/string/)。 |
...
| [System::String](../../system/string/) [get_Description](./get_description/)() override | 傳回 Summary Zoom [Section](../section/) 物件的文字描述。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](../shape/get_effectformat/)() override | 傳回包含套用於圖形之像素效果的 [EffectFormat](../effectformat/) 物件。注意：對於沒有效果屬性的某些圖形類型，可能會傳回 null。唯讀 [IEffectFormat](../ieffectformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](../shape/get_fillformat/)() override | 傳回包含圖形填充格式屬性的 [FillFormat](../fillformat/) 物件。注意：對於沒有填充屬性的某些圖形類型，可能會傳回 null。唯讀 [IFillFormat](../ifillformat/)。 |
...
| **bool** [get_IsGrouped](../shape/get_isgrouped/)() override | 判斷圖形是否已群組。唯讀 **bool**。 |
| **bool** [get_IsTextHolder](../shape/get_istextholder/)() override | 判斷圖形是否為 TextHolder_PPT。唯讀 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_LineFormat](../shape/get_lineformat/)() override | 傳回包含圖形線條格式屬性的 [LineFormat](../lineformat/) 物件。注意：對於沒有線條屬性的某些圖形類型，可能會傳回 null。唯讀 [ILineFormat](../ilineformat/)。 |
| [System::String](../../system/string/) [get_Name](../shape/get_name/)() override | 傳回圖形的名稱。不得為 null。必要時使用空字串。閱讀 [System::String](../../system/string/)。 |
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | 傳回在投影片範圍內唯一的識別碼，於圖形生命週期內保持不變，讓 PowerPoint 或互通程式碼能從文件任意位置可靠地參照圖形。唯讀 **uint32_t**。另請參閱 [Shape::get_UniqueId](../shape/get_uniqueid/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IGroupShape](../igroupshape/)\> [get_ParentGroup](../shape/get_parentgroup/)() override | 若圖形已群組，傳回父層 [GroupShape](../groupshape/) 物件；否則傳回 null。唯讀 [IGroupShape](../igroupshape/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [get_Placeholder](../shape/get_placeholder/)() override | 傳回圖形的佔位符。若圖形沒有佔位符，則傳回 null。唯讀 [IPlaceholder](../iplaceholder/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_RawFrame](../shape/get_rawframe/)() override | 傳回原始圖形框架的屬性。閱讀 [IShapeFrame](../ishapeframe/)。 |
| **bool** [get_ReturnToParent](../zoomobject/get_returntoparent/)() override | 取得投影片放映時的導覽行為。讀取 **bool**。預設值: false |
| **float** [get_Rotation](../shape/get_rotation/)() override | 傳回指定圖形繞 z 軸旋轉的角度（度數）。正值表示順時針旋轉，負值表示逆時針旋轉。讀取 **float**。 |
...
| **bool** [get_ShowBackground](../zoomobject/get_showbackground/)() override | 取得 Zoom 是否使用目標投影片背景的值。讀取 **bool**。預設值: true |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](../sectionzoomframe/get_targetsection/)() override | 取得 [Section](../section/) Zoom 物件所連結的節(section)物件。閱讀 [ISection](../isection/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../ithreedformat/)\> [get_ThreeDFormat](../shape/get_threedformat/)() override | 傳回包含圖形 3D 效果屬性的 [ThreeDFormat](../threedformat/) 物件。注意：對於沒有 3D 屬性的某些圖形類型，可能會傳回 null。唯讀 [IThreeDFormat](../ithreedformat/)。 |
| [System::String](../../system/string/) [get_Title](./get_title/)() override | 傳回 Summary Zoom [Section](../section/) 物件的文字標題。 |
| **float** [get_TransitionDuration](../zoomobject/get_transitionduration/)() override | 取得 Zoom 與投影片之間轉場的持續時間。讀取 **float**。預設值: 1.0f |
| **uint32_t** [get_UniqueId](../shape/get_uniqueid/)() override | 傳回內部、簡報範圍的識別碼，供外掛或其他程式碼使用。因為此值可能被使用者或程式重新指派，故不應視為永久唯一鍵。唯讀 **uint32_t**。另請參閱 [Shape::get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)。 |
...
| **int32_t** [get_ZOrderPosition](../shape/get_zorderposition/)() override | 傳回圖形在 Z 順序中的位置。Shapes[0] 代表 Z 順序最背面的圖形，Shapes[Shapes.Count - 1] 代表最前面的圖形。唯讀 **int32_t**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../shape/getbaseplaceholder/)() override | 傳回基本的佔位符圖形（來自版面配置或母片，且目前圖形繼承自該圖形）。 |
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述式的鎖定。直接呼叫或使用 [LockContext](../../system/lockcontext/) 監控物件。 |
...
| void [set_Description](./set_description/)([System::String](../../system/string/)) override | 傳回 Summary Zoom [Section](../section/) 物件的文字描述。 |
...
| void [set_Rotation](../shape/set_rotation/)(**float**) override | 設定指定圖形繞 z 軸旋轉的角度（度數）。正值表示順時針旋轉，負值表示逆時針旋轉。寫入 **float**。 |
| void [set_ShowBackground](../zoomobject/set_showbackground/)(**bool**) override | 設定 Zoom 是否使用目標投影片背景的值。寫入 **bool**。預設值: true |
| void [set_TargetSection](../sectionzoomframe/set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | 設定 [Section](../section/) Zoom 物件所連結的節(section)物件。寫入 [ISection](../isection/)。 |
| void [set_Title](./set_title/)([System::String](../../system/string/)) override | 傳回 Summary Zoom [Section](../section/) 物件的文字標題。 |
| void [set_TransitionDuration](../zoomobject/set_transitionduration/)(**float**) override | 設定 Zoom 與投影片之間轉場的持續時間。寫入 **float**。預設值: 1.0f |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 陳述式的解鎖。直接呼叫或使用 [LockContext](../../system/lockcontext/) 監控物件。 |
