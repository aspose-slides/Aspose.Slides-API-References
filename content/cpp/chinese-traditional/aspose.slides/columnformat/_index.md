...
| [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormatEffectiveData](../icolumnformateffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承與表格樣式後的有效表格欄位格式屬性。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否為 targetType 描述的類型實例。等同於 C# 'is' 運算子。 |
...
* 類別 [IColumnFormat](../icolumnformat/)
