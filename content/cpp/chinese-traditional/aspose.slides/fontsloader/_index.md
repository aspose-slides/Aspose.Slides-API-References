...
| Method | Description |
| --- | --- |
| static void [ClearCache](./clearcache/)() | 釋放使用者定義的所有自訂字型 |
...
| static [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetFontFolders](./getfontfolders/)() | 取得字型資料夾。返回已使用 LoadExternalFonts 方法加入的資料夾以及系統字型資料夾 |
...
| static void [LoadExternalFont](./loadexternalfont/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 從二進位資料新增字型 |
| static void [LoadExternalFonts](./loadexternalfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | 新增其他資料夾以搜尋字型。 |
