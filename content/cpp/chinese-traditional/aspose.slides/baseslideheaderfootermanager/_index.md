...
---
## BaseSlideHeaderFooterManager 類
...
| **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() override | 取得指示是否存在日期時間佔位符的值。Read**bool**。 |
| **bool** [get_IsFooterVisible](./get_isfootervisible/)() override | 取得指示是否存在頁腳佔位符的值。Read **bool**。 |
| **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() override | 取得指示是否存在頁碼佔位符的值。Read**bool**。 |
...
| void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) override | 設定文字至投影片日期時間佔位符。 |
| void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) override | 變更投影片日期時間佔位符的可見性。 |
| void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) override | 設定文字至投影片頁腳佔位符。 |
| void [SetFooterVisibility](./setfootervisibility/)(**bool**) override | 變更投影片頁腳佔位符的可見性。 |
| void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) override | 變更投影片頁碼佔位符的可見性。 |
