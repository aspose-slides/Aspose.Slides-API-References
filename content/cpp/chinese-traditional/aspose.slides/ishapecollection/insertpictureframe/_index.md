...
description: 建立一個包含指定影像的新圖片框，並將其插入至形狀集合中指定的索引位置。
type: docs
weight: 417
...
建立一個包含指定影像的新圖片框，並將其插入至形狀集合中指定的索引位置。
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| index | **int32_t** | 要插入圖片框的零基索引。 |
| shapeType | [ShapeType](../../shapetype/) | 指定 [ShapeType](../../shapetype/) 中包含的形狀類型，除了所有類型的線條：
