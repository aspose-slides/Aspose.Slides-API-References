...
| **int32_t** [get_Count](./get_count/)() override | 回傳調整的數量。唯讀 **int32_t**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [idx_get](./idx_get/)(**int32_t**) override | 依索引回傳調整。 |
...
* 類別 [IAdjustValueCollection](../iadjustvaluecollection/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)