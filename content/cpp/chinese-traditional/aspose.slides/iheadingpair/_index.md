...
description: 表示文件的 'Heading pair' 屬性。它指出文件部件的群組名稱以及群組中的部件數量。
type: docs
weight: 2510
...
表示文件的 'Heading pair' 屬性。它指出文件部件的群組名稱以及群組中的部件數量。
...
| virtual **int32_t** [get_Count](./get_count/)() | 返回群組中部件的數量。唯讀 **int32_t**。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 返回文件部件的群組名稱。唯讀 [System::String](../../system/string/)。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | 類似 C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法。啟用自訂型別的複製功能。 |
