...
| **bool** [Equals](../baseslide/equals/)([System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\>) override | 判斷兩個 [IBaseSlide](../ibaseslide/) 實例是否相等。返回值根據投影片的結構和靜態內容計算。若所有形狀、樣式、文字、動畫及其他設定等皆相等，則兩投影片相等。比較不考慮唯一識別碼值，例如 SlideId，以及動態內容，例如 Date [Placeholder](../placeholder/) 中的目前日期值。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IControlCollection](../icontrolcollection/)\> [get_Controls](../baseslide/get_controls/)() override | 返回投影片上 ActiveX 控制項的集合。唯讀 [IControlCollection](../icontrolcollection/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | 返回版面投影片的繪圖參考線集合。唯讀 [IDrawingGuidesCollection](../idrawingguidescollection/)。 |
| **bool** [get_HasDependingSlides](./get_hasdependingslides/)() override | 如果至少有一個投影片依賴此版面投影片，則返回 true。唯讀 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlideHeaderFooterManager](../ilayoutslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | 返回版面投影片的 HeaderFooter 管理器。唯讀 [ILayoutSlideHeaderFooterManager](../ilayoutslideheaderfootermanager/)。 |
...
| [SlideLayoutType](../slidelayouttype/) [get_LayoutType](./get_layouttype/)() override | 返回此版面投影片的版面類型。唯讀 [SlideLayoutType](../slidelayouttype/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [get_MasterSlide](./get_masterslide/)() override | 返回版面的母片投影片。唯讀 [IMasterSlide](../imasterslide/)。 |
| [System::String](../../system/string/) [get_Name](../baseslide/get_name/)() override | 返回投影片的名稱。唯讀 [System::String](../../system/string/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutPlaceholderManager](../ilayoutplaceholdermanager/)\> [get_PlaceholderManager](./get_placeholdermanager/)() override | 返回版面投影片的 placeholder 管理器。唯讀 [ILayoutPlaceholderManager](../ilayoutplaceholdermanager/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [get_Shape](../baseslide/get_shape/)(**int32_t**) override | 返回指定索引處的圖形。唯讀 [Aspose::Slides::IShape](../ishape/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeCollection](../ishapecollection/)\> [get_Shapes](../baseslide/get_shapes/)() override | 返回投影片的圖形集合。唯讀 [IShapeCollection](../ishapecollection/)。 |
| **bool** [get_ShowMasterShapes](./get_showmastershapes/)() override | 指定是否在投影片上顯示母片投影片的圖形。唯讀 **bool**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Theme::IOverrideThemeManager](../../aspose.slides.theme/ioverridethememanager/)\> [get_ThemeManager](./get_thememanager/)() override | 返回覆寫佈景主題管理器。唯讀 [Theme::IOverrideThemeManager](../../aspose.slides.theme/ioverridethememanager/)。 |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>\> [GetDependingSlides](./getdependingslides/)() override | 返回一個陣列，包含所有依賴此版面投影片的投影片。 |
...
| void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)() override | 將所有段落中具有相同格式的執行序合併於所有可接受的圖形。 |
| virtual void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeCollection](../ishapecollection/)\>) | 將所有段落中具有相同格式的執行序合併於所有可接受的圖形。 |
...
| void [Remove](./remove/)() override | 從簡報中移除版面。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將共享參考計數減少指定的值。 |
| void [set_MasterSlide](./set_masterslide/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | 設定版面的母片投影片。寫入 [IMasterSlide](../imasterslide/)。 |
| void [set_Name](../baseslide/set_name/)([System::String](../../system/string/)) override | 設定投影片的名稱。寫入 [System::String](../../system/string/)。 |
| void [set_ShowMasterShapes](./set_showmastershapes/)(**bool**) override | 指定是否在投影片上顯示母片投影片的圖形。寫入 **bool**。 |
