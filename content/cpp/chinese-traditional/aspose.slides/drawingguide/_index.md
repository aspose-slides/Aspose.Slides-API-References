...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | 返回繪圖參考線的顏色。閱讀 [System::Drawing::Color](../../system.drawing/color/)。 |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | 返回繪圖參考線的方向。閱讀 [Slides::Orientation](../orientation/)。 |
| **float** [get_Position](./get_position/)() override | 返回繪圖參考線相對於投影片左上角的點位置（以 points 為單位）。閱讀 **float**。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 副本建構子。實際上不會複製任何內容，只是初始化新物件並允許子類別的複製建構。 |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | 設定繪圖參考線的顏色。寫入 [System::Drawing::Color](../../system.drawing/color/)。 |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) override | 設定繪圖參考線的方向。寫入 [Slides::Orientation](../orientation/)。 |
| void [set_Position](./set_position/)(**float**) override | 設定繪圖參考線相對於投影片左上角的點位置（以 points 為單位）。寫入 **float**。 |
...
* 類別 [IDrawingGuide](../idrawingguide/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)