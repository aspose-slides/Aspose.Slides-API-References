...
| Method | Description |
| --- | --- |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::String](../../system/string/)) | 將新的字型(s)加入 FallBack 字型列表。 |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | 將新的字型加入 FallBack 字型列表。 |
| virtual void [Clear](./clear/)() | 從列表中移除所有字型。 |
...
| virtual **int32_t** [get_Count](./get_count/)() | 取得實際在範圍內定義的字型數量。 |
| virtual **uint32_t** [get_RangeEndIndex](./get_rangeendindex/)() | 取得連續 Unicode 範圍的最後索引。 |
| virtual **uint32_t** [get_RangeStartIndex](./get_rangestartindex/)() | 取得連續 Unicode 範圍的第一索引。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。啟用自訂物件的雜湊。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際型別。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)(**int32_t**) | 取得指定索引處的字型名稱。 |
| virtual **int32_t** [IndexOf](./indexof/)([System::String](../../system/string/)) | 返回集合中指定規則的索引。 |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | 從列表中移除特定 FallBack 字型的第一個出現。 |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 移除列表中指定索引處的 FallBack 字型。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)() | 建立並返回包含此規則所有 FallBack 字型的陣列。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)(**int32_t**, **int32_t**) | 建立並返回列表中指定範圍內所有 FallBack 字型的陣列。 |
