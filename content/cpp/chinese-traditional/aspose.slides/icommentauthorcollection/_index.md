...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [AddAuthor](./addauthor/)([System::String](../../system/string/), [System::String](../../system/string/)) | 在集合的末端新增作者。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 取得指向集合第一個元素（如果有）的迭代器。此迭代器無法用於更改所參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會返回 T 的副本物件。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | 取得指向 const 限定的集合實例的第一個元素（如果有）的迭代器。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | 取得指向集合最後一個 const 限定元素之後（如果有）的迭代器。 |
| virtual void [Clear](./clear/)() | 從集合中移除所有作者。 |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | 將集合中的所有元素複製到指定的陣列中。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 取得指向集合最後一個元素之後（如果有）的迭代器。此迭代器無法用於更改所參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會返回 T 的副本物件。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 取得指向 const 限定的集合實例最後一個元素之後（如果有）的迭代器。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByName](./findbyname/)([System::String](../../system/string/)) | 依名稱在集合中尋找作者。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByNameAndInitials](./findbynameandinitials/)([System::String](../../system/string/), [System::String](../../system/string/)) | 依名稱與首字母在集合中尋找作者。 |
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | 返回集合中行為的數量。只讀 **int32_t**。 |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | 返回指示集合存取是否同步（執行緒安全）的值。只讀 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | 返回同步根。只讀 [System::Object](../../system/object/)。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [idx_get](./idx_get/)(**int32_t**) | 取得指定索引處的元素。只讀 [ICommentAuthor](../icommentauthor/)。 |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 計算透過對輸入序列每個元素呼叫轉換函式所取得之值的平均。 |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | 返回序列中特定索引處的元素。 |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | 返回序列中特定索引處的元素。 |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | 返回符合條件的序列的第一個元素，若未找到則返回預設值。 |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>) | 移除集合中指定作者的第一次出現。 |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 移除集合中指定索引處的作者。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [ToArray](./toarray/)() | 建立並返回包含所有作者的陣列。 |
