...
| Method | 說明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [Add](./add/)([Orientation](../orientation/), **float**) override | 在集合的末端新增繪圖參考線。 |
| [iterator](./iterator/) [begin](./begin/)() | 取得指向集合第一個元素（若有）的疊代器。 |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | 取得指向 const 限定集合實例第一個元素（若有）的疊代器。 |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | 取得指向集合第一個 const 限定元素（若有）的疊代器。 |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 取得指向集合最後一個 const 限定元素之後的位置（若有）的疊代器。 |
| void [Clear](./clear/)() override | 從集合中移除所有元素。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\>\>, **int32_t**) | 將集合中所有元素複製到指定的陣列。 |
| [iterator](./iterator/) [end](./end/)() | 取得指向集合最後一個元素之後的位置（若有）的疊代器。 |
| [const_iterator](./const_iterator/) [end](./end/)() const | 取得指向 const 限定集合實例最後一個元素之後的位置（若有）的疊代器。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\>\>\> [GetEnumerator](./getenumerator/)() override | 返回一個可遍歷集合的列舉器。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [idx_get](./idx_get/)(**int32_t**) override | 依索引返回繪圖參考線。唯讀 [IDrawingGuide](../idrawingguide/)。 |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 計算透過對輸入序列的每個元素呼叫轉換函式所獲得之值的平均。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | 將序列的每個元素結合其索引轉換成新形式。 |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<Source, **int32_t**, Result\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | 對序列的每個元素投射，並將產生的序列合併為單一序列。 |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | 移除指定索引處的繪圖參考線。 |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 取得指向 const 限定集合實例第一個元素（若有）的疊代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 取得指向集合第一個元素（若有）的疊代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 取得指向 const 限定集合實例最後一個元素之後的位置（若有）的疊代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | 取得指向集合最後一個元素之後的位置（若有）的疊代器。 |
...
| 型別別名 | 說明 |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 用於當前集合之疊代器類型的集合型別。 |
