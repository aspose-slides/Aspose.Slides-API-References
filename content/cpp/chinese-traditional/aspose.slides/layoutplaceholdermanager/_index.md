...
description: 表示管理員，可讓您向版面投影片新增佔位符。
type: docs
weight: 4278
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddChartPlaceholder](./addchartplaceholder/)(**float**, **float**, **float**, **float**) override | 在版面投影片中新增一個佔位符形狀以容納圖表。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddContentPlaceholder](./addcontentplaceholder/)(**float**, **float**, **float**, **float**) override | 在版面投影片中新增一個佔位符形狀以容納內容，例如圖片、表格、媒體或文字。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddMediaPlaceholder](./addmediaplaceholder/)(**float**, **float**, **float**, **float**) override | 在版面投影片中新增一個佔位符形狀以容納媒體物件。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddOnlineImagePlaceholder](./addonlineimageplaceholder/)(**float**, **float**, **float**, **float**) override | 在版面投影片中新增一個佔位符形狀以容納線上圖片。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddPicturePlaceholder](./addpictureplaceholder/)(**float**, **float**, **float**, **float**) override | 在版面投影片中新增一個佔位符形狀以容納圖片。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddSmartArtPlaceholder](./addsmartartplaceholder/)(**float**, **float**, **float**, **float**) override | 在版面投影片中新增一個佔位符形狀以容納 [SmartArt](../../aspose.slides.smartart/) 圖表。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddTablePlaceholder](./addtableplaceholder/)(**float**, **float**, **float**, **float**) override | 在版面投影片中新增一個佔位符形狀以容納表格。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddTextPlaceholder](./addtextplaceholder/)(**float**, **float**, **float**, **float**) override | 在版面投影片中新增一個佔位符形狀以容納文字內容。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddVerticalContentPlaceholder](./addverticalcontentplaceholder/)(**float**, **float**, **float**, **float**) override | 在版面投影片中新增一個佔位符形狀，以垂直方向容納內容，例如圖片、表格、媒體或文字。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddVerticalTextPlaceholder](./addverticaltextplaceholder/)(**float**, **float**, **float**, **float**) override | 在版面投影片中新增一個佔位符形狀，以垂直方向容納文字內容。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n'th 模板參數設為弱指標（而非共享）。允許在容器中將指標切換為弱模式。 |
...
* 類別 [ILayoutPlaceholderManager](../ilayoutplaceholdermanager/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)