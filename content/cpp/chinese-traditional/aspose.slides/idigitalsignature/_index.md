...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\> [get_Certificate](./get_certificate/)() | 用於簽署文件的憑證物件。唯讀 [X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)。 |
| virtual [System::String](../../system/string/) [get_Comments](./get_comments/)() | 簽章的目的。可讀 [System::String](../../system/string/)。 |
| virtual **bool** [get_IsValid](./get_isvalid/)() | 如果此數位簽章有效且文件未被竄改，則此值為 true。唯讀 **bool**。 |
| virtual [System::DateTime](../../system/datetime/) [get_SignTime](./get_signtime/)() | 文件簽署的時間。唯讀 [System::DateTime](../../system/datetime/)。 |
...
| virtual void [set_Comments](./set_comments/)([System::String](../../system/string/)) | 簽章的目的。寫入 [System::String](../../system/string/)。 |
