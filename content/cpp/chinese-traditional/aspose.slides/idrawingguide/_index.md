...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，當兩個 NaN 被視為相等，即使依 IEC 60559:1989 標準，NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，當兩個 NaN 被視為相等，即使依 IEC 60559:1989 標準，NaN 不等於任何值，包括 NaN 本身。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | 傳回繪圖參考線的顏色。讀取 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | 傳回繪圖參考線的方向。讀取 [Slides::Orientation](../orientation/)。 |
| virtual **float** [get_Position](./get_position/)() | 傳回繪圖參考線相對於投影片左上角的點位置（以 points 為單位）。讀取 **float**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與此物件相關聯的參照計數資料結構。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特殊化，適用於字串與 nullptr 情況。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特殊化，適用於字串情況。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 依指定值遞減共享參照計數。 |
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | 設定繪圖參考線的顏色。寫入 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | 設定繪圖參考線的方向。寫入 [Slides::Orientation](../orientation/)。 |
| virtual void [set_Position](./set_position/)(**float**) | 設定繪圖參考線相對於投影片左上角的點位置（以 points 為單位）。寫入 **float**。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 遞減並傳回共享參照計數。不應直接呼叫；請使用智慧指標或 ThisProtector。 |
