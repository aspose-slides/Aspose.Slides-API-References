...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | 返回此作者在指定索引處所發表的評論。唯讀 [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | 返回此作者所發表的評論集合。唯讀 [ICommentCollection](../icommentcollection/)。 |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | 返回作者的縮寫。讀取 [System::String](../../system/string/)。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 返回作者的名字。讀取 [System::String](../../system/string/)。 |
...
| void [Remove](./remove/)() override | 從父集合中移除作者。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將共享參考計數減少指定的值。 |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | 設定作者的縮寫。寫入 [System::String](../../system/string/)。 |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | 設定作者的名字。寫入 [System::String](../../system/string/)。 |
