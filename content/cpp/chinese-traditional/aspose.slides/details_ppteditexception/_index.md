...
type: docs
weight: 664
url: /zh-hant/aspose.slides/details_ppteditexception/
---
## Details_PptEditException 類別
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述句的鎖定。可直接呼叫或使用 [LockContext](../../system/lockcontext/) 監視物件。 |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | 設定 HRESULT，此為指派給特定例外的編碼數值。 |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 陳述句的解鎖。可直接呼叫或使用 [LockContext](../../system/lockcontext/) 監視物件。 |
...
* 類別 [Details_PptException](../details_pptexception/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)