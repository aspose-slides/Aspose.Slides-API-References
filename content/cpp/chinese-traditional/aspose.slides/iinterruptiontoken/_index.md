...
description: 此類別代表用於向長時間執行的任務發送中斷請求之訊號的代幣。
type: docs
weight: 2601
url: /zh-hant/aspose.slides/iinterruptiontoken/
---
## IInterruptionToken 類別
...
| virtual **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() | 如果已請求中斷，回傳 **bool**.true。 |
...
| virtual void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() | 如果已請求中斷，拋出例外。 |
