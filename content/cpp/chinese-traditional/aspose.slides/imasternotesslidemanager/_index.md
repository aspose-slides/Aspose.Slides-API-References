...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [get_MasterNotesSlide](./get_masternotesslide/)() | 如果此簡報有 master，則回傳所有註腳投影片的 master，否則回傳 null。唯讀 [IMasterNotesSlide](../imasternotesslide/)。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 複製建構子。實際上不會複製任何東西，只是初始化新物件，並允許子類別的複製建構子。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 賦值運算子。實際上不會複製任何東西，只是初始化新物件，並允許子類別的複製建構子。 |
...
| virtual void [RemoveMasterNotesSlide](./removemasternotesslide/)() | 移除 master 註腳投影片。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [SetDefaultMasterNotesSlide](./setdefaultmasternotesslide/)() | 設定相關註腳投影片的預設 master 註腳投影片。 |
