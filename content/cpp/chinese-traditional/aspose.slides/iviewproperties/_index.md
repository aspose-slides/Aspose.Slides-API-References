...
[Presentation](../presentation/) 寬視圖屬性。
...
| virtual **float** [get_GridSpacing](./get_gridspacing/)() | 傳回在簡報文件底層格線應使用的格點間距（單位為點）。讀取 **float**。 |
| virtual [ViewType](../viewtype/) [get_LastView](./get_lastview/)() | 指定在上次儲存簡報文件時使用的檢視模式。讀取 [ViewType](../viewtype/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INormalViewProperties](../inormalviewproperties/)\> [get_NormalViewProperties](./get_normalviewproperties/)() | 表示一般檢視屬性。一般檢視由三個內容區域組成：投影片本身、側邊內容區以及底部內容區。唯讀 [INormalViewProperties](../inormalviewproperties/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommonSlideViewProperties](../icommonslideviewproperties/)\> [get_NotesViewProperties](./get_notesviewproperties/)() | 指定與註解檢視模式相關的共通檢視屬性。唯讀 [ICommonSlideViewProperties](../icommonslideviewproperties/)。 |
| virtual [NullableBool](../nullablebool/) [get_ShowComments](./get_showcomments/)() | 指定是否顯示投影片註解。讀取 [NullableBool](../nullablebool/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommonSlideViewProperties](../icommonslideviewproperties/)\> [get_SlideViewProperties](./get_slideviewproperties/)() | 指定與投影片檢視模式相關的共通檢視屬性。唯讀 [ICommonSlideViewProperties](../icommonslideviewproperties/)。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | 針對字串與 nullptr 案例的 [Object::ReferenceEquals](../../system/object/referenceequals/) 特化。 |
...
| virtual void [set_GridSpacing](./set_gridspacing/)(**float**) | 設定在簡報文件底層格線應使用的格點間距（單位為點）。寫入 **float**。 |
| virtual void [set_LastView](./set_lastview/)([ViewType](../viewtype/)) | 指定在上次儲存簡報文件時使用的檢視模式。寫入 [ViewType](../viewtype/)。 |
| virtual void [set_ShowComments](./set_showcomments/)([NullableBool](../nullablebool/)) | 指定是否顯示投影片註解。寫入 [NullableBool](../nullablebool/)。 |
