...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) | 返回指定索引處的自訂 XML 部分。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() | 返回自訂 XML 部分集合。唯讀 [ICustomXmlPartCollection](../icustomxmlpartcollection/)。 |
| virtual [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) | 返回索引處指定的 Customer Data Tag。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() | 返回 Customer Data Tags 集合。唯讀 [ITagCollection](../itagcollection/)。 |
...
| virtual void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) | 設定索引處指定的 Customer Data Tag。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 設定第 n'th 模板參數為弱指標（而非共享）。允許在容器中將指標切換為弱模式。 |
