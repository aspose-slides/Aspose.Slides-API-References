...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | 傳回漸層止點的顏色。唯讀 [IColorFormat](../icolorformat/)。 |
...
| **float** [get_Position](./get_position/)() override | 傳回漸層止點的位置 (0..1)。讀取 **float**。 |
...
| void [set_Position](./set_position/)(**float**) override | 設定漸層止點的位置 (0..1)。寫入 **float**。 |
