...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\> [get_Type](./get_type/)() | 傳回欄位的類型。讀取 [IFieldType](../ifieldtype/)。 |
...
| virtual void [set_Type](./set_type/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) | 設定欄位的類型。寫入 [IFieldType](../ifieldtype/)。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設定為弱指標（而非共用指標）。允許在容器中將指標切換為弱模式。 |
| int [SharedCount](../../system/object/sharedcount/)() const | 取得共用參考計數目前的值。 |
