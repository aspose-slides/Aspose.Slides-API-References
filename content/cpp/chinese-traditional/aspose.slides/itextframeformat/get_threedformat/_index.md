...
description: 傳回代表文字之 3D 效果屬性的 ThreeDFormat 物件。唯讀 IThreeDFormat。
type: docs
weight: 300
url: /zh-hant/aspose.slides/itextframeformat/get_threedformat/
---
## ITextFrameFormat::get_ThreeDFormat() 方法

返回代表文字之 3D 效果屬性的 [ThreeDFormat](../../threedformat/) 物件。唯讀 [IThreeDFormat](../../ithreedformat/)。
