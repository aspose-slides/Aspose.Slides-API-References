...
| [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() override | [Camera](./) 型別。讀取 [CameraPresetType](../camerapresettype/)。 |
| **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() override | [Camera](./) 視野角 (0-180 度，視場角)。讀取 **float**。 |
...
| **float** [get_Zoom](./get_zoom/)() override | [Camera](./) 縮放（以百分比表示的正值）。讀取 **float**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| **int32_t** [GetHashCode](../pviobject/gethashcode/)() const override | 傳回雜湊碼。 |
| [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() override | 旋轉是透過使用緯度座標、經度座標，以及繞該軸的旋轉（以緯度與經度座標為基礎）來定義的。返回陣列的第一個元素為緯度，第二個為經度，第三個為旋轉。若未定義旋轉，則傳回 null。 |
...
| void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) override | [Camera](./) 型別。寫入 [CameraPresetType](../camerapresettype/)。 |
| void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) override | [Camera](./) 視野角 (0-180 度，視場角)。寫入 **float**。 |
| void [set_Zoom](./set_zoom/)(**float**) override | [Camera](./) 縮放（以百分比表示的正值）。寫入 **float**。 |
| void [SetRotation](./setrotation/)(**float**, **float**, **float**) override | 旋轉是透過使用緯度座標、經度座標，以及繞該軸的旋轉（以緯度與經度座標為基礎）來定義的。若任一座標值為 std::numeric_limits<float>::quiet_NaN()，則所有旋轉皆未定義。 |
