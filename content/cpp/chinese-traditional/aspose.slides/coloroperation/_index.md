...
description: 代表用於顏色轉換的不同色彩操作。不可變物件。
type: docs
weight: 352
...
| 方法 | 描述 |
| --- | --- |
|  [ColorOperation](./coloroperation/)([ColorTransformOperation](../colortransformoperation/)) | 建立新的顏色變換操作。 |
|  [ColorOperation](./coloroperation/)([ColorTransformOperation](../colortransformoperation/), **float**) | 建立新的顏色變換操作。 |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷兩個 [ColorOperation](./) 實例是否相等。 |
...
| [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const override | 回傳操作的類型。唯讀 [ColorTransformOperation](../colortransformoperation/)。 |
| **float** [get_Parameter](./get_parameter/)() override | 回傳操作的一個參數。唯讀 **float**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| **int32_t** [GetHashCode](./gethashcode/)() const override | 作為特定類型的雜湊函式，可用於雜湊演算法及如雜湊表等資料結構。 |
