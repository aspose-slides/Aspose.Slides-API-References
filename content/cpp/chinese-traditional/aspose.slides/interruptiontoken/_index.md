...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | 如果已請求中斷，傳回 **bool**.true。 |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | 代表一個空的中斷代幣。 |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | 如果已請求中斷，拋出例外。 |
