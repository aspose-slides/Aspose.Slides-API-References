...
description: 不可變物件的基礎介面，包含有效的表格格式屬性。
type: docs
weight: 1522
url: /zh-hant/aspose.slides/ibasetableformateffectivedata/
---
## IBaseTableFormatEffectiveData 類別
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderBottom](./get_borderbottom/)() | 傳回底部邊框線格式的有效值。唯讀 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalDown](./get_borderdiagonaldown/)() | 傳回向下對角線格式的有效值。唯讀 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalUp](./get_borderdiagonalup/)() | 傳回向上對角線格式的有效值。唯讀 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderLeft](./get_borderleft/)() | 傳回左側邊框線格式的有效值。唯讀 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderRight](./get_borderright/)() | 傳回右側邊框線格式的有效值。唯讀 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderTop](./get_bordertop/)() | 傳回上方邊框線格式的有效值。唯讀 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | 傳回填充格式的有效值。唯讀 [IFillFormatEffectiveData](../ifillformateffectivedata/)。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 減少共享參照計數並回傳結果。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
