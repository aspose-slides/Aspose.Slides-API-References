...
description: 確定在父 GraphicalObject 上哪些操作被停用。
type: docs
weight: 1184
...
確定在父 [GraphicalObject](../graphicalobject/) 上哪些操作被停用。
...
| **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() override | 判斷形狀在調整大小時是否必須保持長寬比。讀取 **bool**。 |
| **bool** [get_DrilldownLocked](./get_drilldownlocked/)() override | 判斷是否禁止選取此物件的子形狀。讀取 **bool**。 |
...
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | 判斷形狀在調整大小時是否必須保持長寬比。寫入 **bool**。 |
| void [set_DrilldownLocked](./set_drilldownlocked/)(**bool**) override | 判斷是否禁止選取此物件的子形狀。寫入 **bool**。 |
...
* 類別 [IGraphicalObjectLock](../igraphicalobjectlock/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)