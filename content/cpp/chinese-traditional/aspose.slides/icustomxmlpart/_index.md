...
| virtual [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() | 指定全域唯一識別碼 (GUID)，在 Office Open XML 文件中唯一識別單一自訂 XML 部分。唯讀 [System::Guid](../../system/guid/)。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() | 回傳與自訂 XML 部分關聯的 XML 架構集合。唯讀 [System::String](../../system/string/)[]。 |
| virtual [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() | 以 UTF-8 字串回傳 xml 資料。讀取 [System::String](../../system/string/)。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() | 回傳 xml 資料。讀取 **uint8_t**[]。 |
...
| virtual void [Remove](./remove/)() | 從簡報中移除自訂 XML 部分。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將共享參考計數減少指定的值。 |
| virtual void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) | 指定全域唯一識別碼 (GUID)，在 Office Open XML 文件中唯一識別單一自訂 XML 部分。唯讀 [System::Guid](../../system/guid/)。 |
| virtual void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) | 以 UTF-8 字串設定 xml 資料。寫入 [System::String](../../system/string/)。 |
| virtual void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 設定 xml 資料。寫入 **uint8_t**[]。 |
