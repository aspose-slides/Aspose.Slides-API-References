...
| virtual [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() | 返回填充類型。請閱讀 [Slides::FillType](../filltype/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() | 返回梯度填充格式。唯讀 [IGradientFormat](../igradientformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() | 返回圖案填充格式。唯讀 [IPatternFormat](../ipatternformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_PictureFillFormat](./get_picturefillformat/)() | 返回圖片填充格式。唯讀 [IPictureFillFormat](../ipicturefillformat/)。 |
| virtual [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() | 確定填充是否應隨形狀旋轉。請閱讀 [NullableBool](../nullablebool/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() | 返回填充顏色。唯讀 [IColorFormat](../icolorformat/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../ifillformateffectivedata/)\> [GetEffective](./geteffective/)() | 取得套用繼承後的有效填充格式資料。 |
...
| virtual void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) | 設定填充類型。寫入 [Slides::FillType](../filltype/)。 |
| virtual void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) | 確定填充是否應隨形狀旋轉。寫入 [NullableBool](../nullablebool/)。 |
