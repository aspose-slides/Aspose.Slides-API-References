...
description: 表示可用於在簡報、投影片或文字框中搜尋文字的選項。
type: docs
weight: 4122
url: /zh-hant/aspose.slides/itextsearchoptions/
---
## ITextSearchOptions 類別
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | 設定為 true 以使用區分大小寫的搜尋，否則為 false。讀取 **bool**。 |
| virtual **bool** [get_IncludeNotes](./get_includenotes/)() | 設定 **true** 以在執行文字搜尋、取代或強調操作時包含投影片備註中的文字。預設值為 **false**。 |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | 設定為 true 以僅匹配完整單詞，否則為 false。讀取 **bool**。 |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | 設定為 true 以使用區分大小寫的搜尋，否則為 false。寫入 **bool**。 |
| virtual void [set_IncludeNotes](./set_includenotes/)(**bool**) | 設定 **true** 以在執行文字搜尋、取代或強調操作時包含投影片備註中的文字。預設值為 **false**。 |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | 設定為 true 以僅匹配完整單詞，否則為 false。寫入 **bool**。 |
