...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點數比較，將兩個 NaN 視為相等，即使依 IEC 60559:1989 規定，NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點數比較，將兩個 NaN 視為相等，即使依 IEC 60559:1989 規定，NaN 不等於任何值，包括 NaN 本身。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) override | 傳回指定索引處的繪圖參考線。唯讀 [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | 傳回繪圖參考線的集合。唯讀 [IDrawingGuidesCollection](../idrawingguidescollection/) |
| **int32_t** [get_Scale](./get_scale/)() override | 指定檢視縮放比例（百分比）。讀取 **int32_t**。 |
| **bool** [get_VariableScale](./get_variablescale/)() override | 指定檢視內容應自動縮放以最佳符合目前視窗大小。讀取 **bool**。 |
...
| void [set_Scale](./set_scale/)(**int32_t**) override | 指定檢視縮放比例（百分比）。寫入 **int32_t**。 |
| void [set_VariableScale](./set_variablescale/)(**bool**) override | 指定檢視內容應自動縮放以最佳符合目前視窗大小。寫入 **bool**。 |
...
以下範例示範如何為 PowerPoint [Presentation](../presentation/) 的投影片設定縮放值。 
```cpp
...
* 類別 [ICommonSlideViewProperties](../icommonslideviewproperties/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)