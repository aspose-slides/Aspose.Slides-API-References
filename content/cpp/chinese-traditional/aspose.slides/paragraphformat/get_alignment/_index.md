...
description: 返回段落中未繼承的文字對齊方式。閱讀 TextAlignment.
type: docs
weight: 1
url: /zh-hant/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() 方法


返回段落中未繼承的文字對齊方式。閱讀 [TextAlignment](../../textalignment/).
...
以下範例程式碼示範如何在 PowerPoint 中對齊文字段落 [Presentation](../../presentation/)。 
```cpp
