...
description: 建立一個包含指定影像的新圖片框，並將其新增至形狀集合的末端。
type: docs
weight: 443
url: /zh-hant/aspose.slides/shapecollection/addpictureframe/
---
...
| 參數 | 類型 | 說明 |
| --- | --- | --- |
| shapeType | [ShapeType](../../shapetype/) | 指定 [ShapeType](../../shapetype/) 中包含的形狀類型，除所有種類的線條外：
