...
description: 代表管理器，負責保存簡報中所有頁腳、日期時間與頁碼佔位符的行為。
type: docs
weight: 4863
...
代表管理器，負責保存簡報中所有頁腳、日期時間與頁碼佔位符的行為。
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否為由 targetType 描述的類型之實例。C# 'is' 運算子的類比。 |
...
| void [SetAllDateTimesText](./setalldatetimestext/)([System::String](../../system/string/)) override | 設定所有日期時間佔位符的文字，包含母片、版面配置投影片、投影片、備註母片、備註投影片與講義母片。 |
| void [SetAllDateTimesVisibility](./setalldatetimesvisibility/)(**bool**) override | 變更所有日期時間佔位符的可見性，包含母片、版面配置投影片、投影片、備註母片、備註投影片與講義母片。 |
| void [SetAllFootersText](./setallfooterstext/)([System::String](../../system/string/)) override | 設定所有頁腳佔位符的文字，包含母片、版面配置投影片、投影片、備註母片、備註投影片與講義母片。 |
| void [SetAllFootersVisibility](./setallfootersvisibility/)(**bool**) override | 變更所有頁腳佔位符的可見性，包含母片、版面配置投影片、投影片、備註母片、備註投影片與講義母片。 |
| void [SetAllHeadersText](./setallheaderstext/)([System::String](../../system/string/)) override | 設定所有標頭佔位符的文字，包含備註母片、備註投影片與講義母片。 |
| void [SetAllHeadersVisibility](./setallheadersvisibility/)(**bool**) override | 變更所有標頭佔位符的可見性，包含備註母片、備註投影片與講義母片。 |
| void [SetAllSlideNumbersVisibility](./setallslidenumbersvisibility/)(**bool**) override | 變更所有頁碼佔位符的可見性，包含母片、版面配置投影片、投影片、備註母片、備註投影片與講義母片。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設定為弱指標（而非共享指標）。允許在容器中將指標切換為弱模式。 |
| void [SetVisibilityOnAllTitleSlides](./setvisibilityonalltitleslides/)(**bool**) override | 變更所有標題投影片以及第一個版面配置投影片的頁腳、日期時間與頁碼佔位符的可見性。標題投影片 \\u2013 基於第一個版面配置投影片的投影片（不論此第一個版面配置的類型）。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) 方法的類比。啟用將自訂物件轉換為 string。 |
