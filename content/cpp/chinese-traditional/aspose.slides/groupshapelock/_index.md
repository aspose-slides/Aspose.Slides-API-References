...
確定在父 [GroupShape](../groupshape/) 上哪些操作被禁用。
...
| **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() override | 判斷在調整大小時形狀是否必須保留長寬比。讀取 **bool**。 |
| **bool** [get_GroupingLocked](./get_groupinglocked/)() override | 判斷將此形狀加入群組是否被禁止。讀取 **bool**。 |
| **bool** [get_NoLocks](../baseshapelock/get_nolocks/)() override | 如果所有鎖定旗標皆已停用則回傳 true。唯讀 **bool**。 |
| **bool** [get_PositionLocked](./get_positionlocked/)() override | 判斷是否禁止移動此形狀。讀取 **bool**。 |
| **bool** [get_RotationLocked](./get_rotationlocked/)() override | 判斷是否禁止變更此形狀的旋轉角度。讀取 **bool**。 |
| **bool** [get_SelectLocked](./get_selectlocked/)() override | 判斷是否禁止選取此形狀。讀取 **bool**。 |
| **bool** [get_SizeLocked](./get_sizelocked/)() override | 判斷是否禁止調整此形狀的大小。讀取 **bool**。 |
| **bool** [get_UngroupingLocked](./get_ungroupinglocked/)() override | 判斷是否禁止分割此群組形狀。讀取 **bool**。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 複製建構函式。實際上不會複製任何東西，只是初始化新物件並啟用子類別的複製建構。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 指定運算子。實際上不會複製任何東西，只是初始化新物件並啟用子類別的複製建構。 |
...
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | 判斷在調整大小時形狀是否必須保留長寬比。寫入 **bool**。 |
| void [set_GroupingLocked](./set_groupinglocked/)(**bool**) override | 判斷將此形狀加入群組是否被禁止。寫入 **bool**。 |
| void [set_PositionLocked](./set_positionlocked/)(**bool**) override | 判斷是否禁止移動此形狀。寫入 **bool**。 |
| void [set_RotationLocked](./set_rotationlocked/)(**bool**) override | 判斷是否禁止變更此形狀的旋轉角度。寫入 **bool**。 |
| void [set_SelectLocked](./set_selectlocked/)(**bool**) override | 判斷是否禁止選取此形狀。寫入 **bool**。 |
| void [set_SizeLocked](./set_sizelocked/)(**bool**) override | 判斷是否禁止調整此形狀的大小。寫入 **bool**。 |
| void [set_UngroupingLocked](./set_ungroupinglocked/)(**bool**) override | 判斷是否禁止分割此群組形狀。寫入 **bool**。 |
...
* 類別 [IGroupShapeLock](../igroupshapelock/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)