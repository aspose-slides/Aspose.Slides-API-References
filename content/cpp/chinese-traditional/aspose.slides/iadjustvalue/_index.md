...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | 回傳值，將其解讀為以度數表示的角度。讀取 **float**。 |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | 回傳此調整值的名稱。唯讀 [System::String](../../system/string/)。 |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | 以原樣回傳調整值。讀取 **int64_t**。 |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | 回傳形狀調整的類型。唯讀 [ShapeAdjustmentType](../shapeadjustmenttype/)。 |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | 設定值，將其解讀為以度數表示的角度。寫入 **float**。 |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | 以原樣設定調整值。寫入 **int64_t**。 |
