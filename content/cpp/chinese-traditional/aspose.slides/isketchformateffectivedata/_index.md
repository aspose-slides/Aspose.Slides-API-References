...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | 傳回草圖類型。唯讀 [Slides::LineSketchType](../linesketchtype/)。 |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 陳述式之解除鎖定。直接呼叫或使用 [LockContext](../../system/lockcontext/) 監視物件。 |
