...
| 方法 | 描述 |
| --- | --- |
|  [BrowsedByIndividual](./browsedbyindividual/)() | 初始化 [BrowsedByIndividual](./) 類別的新實例。 |
...
| **bool** [get_ShowScrollbar](./get_showscrollbar/)() const | 在視窗中顯示捲動條。 |
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述式的上鎖。直接呼叫或使用 [LockContext](../../system/lockcontext/) 守護物件。 |
...
| void [set_ShowScrollbar](./set_showscrollbar/)(**bool**) | 在視窗中顯示捲動條。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設為弱指標（而非共享）。允許在容器中將指標切換為弱模式。 |
| int [SharedCount](../../system/object/sharedcount/)() const | 取得共享參考計數的目前值。 |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 遞增共享參考計數。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 遞減共享參考計數並回傳其值。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
