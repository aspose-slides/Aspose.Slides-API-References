...
| 方法 | 說明 |
| --- | --- |
| void [AddFallBackFonts](./addfallbackfonts/)([System::String](../../system/string/)) override | 將新字型加入回退字型清單。 |
| void [AddFallBackFonts](./addfallbackfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) override | 將新字型加入回退字型清單。 |
| void [Clear](./clear/)() override | 從清單中移除所有字型。 |
...
|  [FontFallBackRule](./fontfallbackrule/)(**uint32_t**, **uint32_t**, [System::String](../../system/string/)) | 建立新實例。 |
|  [FontFallBackRule](./fontfallbackrule/)(**uint32_t**, **uint32_t**, [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | 建立新實例。 |
| **int32_t** [get_Count](./get_count/)() override | 取得在範圍內實際定義的字型數量。只讀 **int32_t**。 |
| **uint32_t** [get_RangeEndIndex](./get_rangeendindex/)() override | 取得連續 Unicode 範圍的最後索引。 |
| **uint32_t** [get_RangeStartIndex](./get_rangestartindex/)() override | 取得連續 Unicode 範圍的第一索引。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。啟用自訂物件的雜湊。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際類型。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
| [System::String](../../system/string/) [idx_get](./idx_get/)(**int32_t**) override | 取得指定索引處的字型名稱。只讀 [IFontFallBackRule](../ifontfallbackrule/)。 |
| **int32_t** [IndexOf](./indexof/)([System::String](../../system/string/)) override | 回傳集合中指定規則的索引。 |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | 從清單中移除特定回退字型的首次出現。 |
| void [RemoveAt](./removeat/)(**int32_t**) override | 從清單中移除指定索引處的回退字型。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將共用參考計數減少指定的數值。 |
| void [set_RangeEndIndex](./set_rangeendindex/)(**uint32_t**) | 取得連續 Unicode 範圍的最後索引。 |
| void [set_RangeStartIndex](./set_rangestartindex/)(**uint32_t**) | 取得連續 Unicode 範圍的第一索引。 |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)() override | 建立並回傳包含此規則所有回退字型的陣列。 |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)(**int32_t**, **int32_t**) override | 建立並回傳清單中指定範圍內所有回退字型的陣列。 |
