...
---
## IGradientFormatEffectiveData 類別
...
| virtual [Aspose::Slides::GradientDirection](../gradientdirection/) [get_GradientDirection](./get_gradientdirection/)() | 傳回漸層的樣式。唯讀 [Slides::GradientDirection](../gradientdirection/)。 |
| virtual [Aspose::Slides::GradientShape](../gradientshape/) [get_GradientShape](./get_gradientshape/)() | 傳回漸層的形狀。唯讀 [Slides::GradientShape](../gradientshape/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\> [get_GradientStop](./get_gradientstop/)(**int32_t**) | 傳回指定索引處的漸層停靠點。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)\> [get_GradientStops](./get_gradientstops/)() | 傳回漸層停靠點的集合。唯讀 [IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)。 |
| virtual **float** [get_LinearGradientAngle](./get_lineargradientangle/)() | 傳回漸層的角度。唯讀 **float**。 |
| virtual **bool** [get_LinearGradientScaled](./get_lineargradientscaled/)() | 判斷漸層是否已縮放。唯讀 **bool**。 |
| virtual [Aspose::Slides::TileFlip](../tileflip/) [get_TileFlip](./get_tileflip/)() | 傳回漸層的翻轉模式。唯讀 [Slides::TileFlip](../tileflip/)。 |
