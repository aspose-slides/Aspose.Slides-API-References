...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | 傳回漸層停止點的顏色。唯讀 [IColorFormat](../icolorformat/)。 |
| virtual **float** [get_Position](./get_position/)() | 傳回漸層停止點的位置 (0..1)。可讀 **float**。 |
...
| virtual void [set_Position](./set_position/)(**float**) | 設定漸層停止點的位置 (0..1)。寫入 **float**。 |
