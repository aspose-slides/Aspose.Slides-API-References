...
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 傳回一個值，用以指示此實例是否等於指定的物件。 |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[ShapeFrame](./)\>) | 傳回一個值，用以指示此實例是否等於指定的物件。 |
...
| **float** [get_CenterX](./get_centerx/)() override | 傳回框架中心的 X 座標。唯讀 **float**。 |
| **float** [get_CenterY](./get_centery/)() override | 傳回框架中心的 Y 座標。唯讀 **float**。 |
| [NullableBool](../nullablebool/) [get_FlipH](./get_fliph/)() override | 判斷框架是否水平翻轉。唯讀 [NullableBool](../nullablebool/)。 |
| [NullableBool](../nullablebool/) [get_FlipV](./get_flipv/)() override | 判斷框架是否垂直翻轉。唯讀 [NullableBool](../nullablebool/)。 |
| **float** [get_Height](./get_height/)() override | 傳回框架的高度。唯讀 **float**。 |
| [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [get_Rectangle](./get_rectangle/)() override | 傳回框架的座標。唯讀 [System::Drawing::RectangleF](../../system.drawing/rectanglef/)。 |
| **float** [get_Rotation](./get_rotation/)() override | 傳回框架繞 Z 軸旋轉的角度（以度為單位）。正值表示順時針旋轉；負值表示逆時針旋轉。唯讀 **float**。 |
| **float** [get_Width](./get_width/)() override | 傳回框架的寬度。唯讀 **float**。 |
| **float** [get_X](./get_x/)() override | 傳回框架左上角的 X 座標。唯讀 **float**。 |
| **float** [get_Y](./get_y/)() override | 傳回框架左上角的 Y 座標。唯讀 **float**。 |
...
|  [ShapeFrame](./shapeframe/)(**float**, **float**, **float**, **float**, [NullableBool](../nullablebool/), [NullableBool](../nullablebool/), **float**) | 建立新的 shape frame 屬性。 |
