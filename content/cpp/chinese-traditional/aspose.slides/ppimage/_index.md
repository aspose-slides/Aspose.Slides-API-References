...
| 方法 | 說明 |
| --- | --- |
| void [Dispose](./dispose/)() override | 釋放物件。 |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | 回傳圖像資料的副本。唯讀 **uint8_t**[]。 |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | 回傳圖像的 MIME 類型，以 [PPImage::get_BinaryData](./get_binarydata/) 編碼。唯讀 [System::String](../../system/string/)。 |
| **int32_t** [get_Height](./get_height/)() override | 回傳圖像的高度。唯讀 **int32_t**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::IImage](../iimage/)\> [get_Image](./get_image/)() override | 回傳圖像的副本。唯讀 [IImage](../iimage/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::ISvgImage](../isvgimage/)\> [get_SvgImage](./get_svgimage/)() const override | 回傳 [ISvgImage](../isvgimage/) 物件 [ISvgImage](../isvgimage/) |
| **int32_t** [get_Width](./get_width/)() override | 回傳圖像的寬度。唯讀 **int32_t**。 |
| **int32_t** [get_X](./get_x/)() override | 回傳圖像的 X 偏移量。唯讀 **int32_t**。 |
| **int32_t** [get_Y](./get_y/)() override | 回傳圖像的 Y 偏移量。唯讀 **int32_t**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| **int32_t** [GetHashCode](./gethashcode/)() const override | 回傳圖像的雜湊碼。 |
...
| void [ReplaceImage](./replaceimage/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | 取代圖像資料。 |
| void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::IImage](../iimage/)\>) override | 取代圖像資料。注意：當圖像是中繪檔時，將會光柵化。請改用 ReplaceImage(byte[])。 |
| void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::IPPImage](../ippimage/)\>) override | 取代圖像資料。 |
| virtual void [ReplaceImage](../ippimage/replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\>) | 取代圖像。 |
| virtual void [ReplaceImage](../ippimage/replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | 取代圖像。 |
| void [set_SvgImage](./set_svgimage/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::ISvgImage](../isvgimage/)\>) override | 設定 [ISvgImage](../isvgimage/) 物件 [ISvgImage](../isvgimage/) |
| virtual void [set_SvgImage](../ippimage/set_svgimage/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\>) | 設定 [ISvgImage](../isvgimage/) 物件 [ISvgImage](../isvgimage/) |
