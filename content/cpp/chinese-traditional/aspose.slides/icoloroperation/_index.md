...
| virtual [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const | 傳回操作的類型。唯讀 [ColorTransformOperation](../colortransformoperation/)。 |
| virtual **float** [get_Parameter](./get_parameter/)() | 傳回操作的參數。唯讀 **float**。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 複製建構式。實際上不會複製任何內容，只會初始化新物件並允許子類別的複製建構。 |
