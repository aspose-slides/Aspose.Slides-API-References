...
description: 不可變物件，包含有效文字的定位停頓屬性。
type: docs
weight: 3992
url: /zh-hant/aspose.slides/itabeffectivedata/
---
## ITabEffectiveData 類別
...
| 方法 | 說明 |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | 比較目前物件與指定的物件。 |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | 回傳定位的對齊樣式。唯讀 [TabAlignment](../tabalignment/)。 |
| virtual **double** [get_Position](./get_position/)() | 回傳定位的位置。設定此屬性可能會變更集合中定位的索引並使列舉器失效。唯讀 **double**。 |
