...
description: 不可變物件，包含有效形狀的表面浮雕屬性。
type: docs
weight: 3667
url: /zh-hant/aspose.slides/ishapebeveleffectivedata/
---
## IShapeBevelEffectiveData 類別
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | 斜角類型。唯讀 [BevelPresetType](../bevelpresettype/)。 |
| virtual **double** [get_Height](./get_height/)() | 斜角高度。唯讀 **double**。 |
| virtual **double** [get_Width](./get_width/)() | 斜角寬度。唯讀 **double**。 |
