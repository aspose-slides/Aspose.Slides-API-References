...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | 斜角類型。讀取 [BevelPresetType](../bevelpresettype/)。 |
| virtual **double** [get_Height](./get_height/)() | 斜角高度。讀取 **double**。 |
| virtual **double** [get_Width](./get_width/)() | 斜角寬度。讀取 **double**。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷貝建構子。實際上不會複製任何內容，只會初始化新物件並允許子類別的拷貝建構。 |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | 斜角類型。寫入 [BevelPresetType](../bevelpresettype/)。 |
| virtual void [set_Height](./set_height/)(**double**) | 斜角高度。寫入 **double**。 |
| virtual void [set_Width](./set_width/)(**double**) | 斜角寬度。寫入 **double**。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 遞減並回傳共享參考計數。不應直接呼叫；請改為使用智慧指標或 ThisProtector。 |
