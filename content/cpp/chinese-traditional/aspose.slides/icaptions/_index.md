...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | 傳回閉合字幕的二進位資料。唯讀 **uint8_t**[]. |
| virtual [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() | 傳回閉合字幕的全域唯一辨識碼 (GUID)。唯讀 [System::Guid](../../system/guid/)。 |
| virtual [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() | 傳回以 UTF-8 編碼的閉合字幕資料字串。唯讀 [System::String](../../system/string/)。 |
| virtual [System::String](../../system/string/) [get_Label](./get_label/)() | 傳回閉合字幕的標籤。唯讀 [System::String](../../system/string/)。 |
...
| virtual void [set_Label](./set_label/)([System::String](../../system/string/)) | 設定閉合字幕的標籤。寫入 [System::String](../../system/string/)。 |
