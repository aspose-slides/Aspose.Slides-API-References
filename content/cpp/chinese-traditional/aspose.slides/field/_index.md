...
| [System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\> [get_Type](./get_type/)() override | 回傳欄位的類型。閱讀 [IFieldType](../ifieldtype/)。 |
...
| void [set_Type](./set_type/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) override | 設定欄位的類型。寫入 [IFieldType](../ifieldtype/)。 |
