...
| [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() override | 傳回填充類型。讀取 [Slides::FillType](../filltype/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() override | 傳回漸層填充格式。唯讀 [IGradientFormat](../igradientformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() override | 傳回圖案填充格式。唯讀 [IPatternFormat](../ipatternformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_PictureFillFormat](./get_picturefillformat/)() override | 傳回圖片填充格式。唯讀 [IPictureFillFormat](../ipicturefillformat/)。 |
| [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() override | 判斷填充是否應隨形狀旋轉。讀取 [NullableBool](../nullablebool/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() override | 傳回填充顏色。唯讀 [IColorFormat](../icolorformat/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數器資料結構。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../ifillformateffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效填充格式資料。 |
...
| void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) override | 設定填充類型。寫入 [Slides::FillType](../filltype/)。 |
| void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) override | 判斷填充是否應隨形狀旋轉。寫入 [NullableBool](../nullablebool/)。 |
