...
| virtual [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() | 返回填充類型。讀取 [Slides::FillType](../filltype/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() | 返回漸層填充格式。唯讀 [IGradientFormat](../igradientformat/)。 |
...
| virtual [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() | 判斷填充是否隨形狀旋轉。讀取 [NullableBool](../nullablebool/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() | 返回純色填充的顏色。唯讀 [IColorFormat](../icolorformat/)。 |
...
| virtual void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) | 判斷填充是否隨形狀旋轉。寫入 [NullableBool](../nullablebool/)。 |
