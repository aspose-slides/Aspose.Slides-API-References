...
description: "基本投影片播放設定。祖先表示投影片播放的類型：PresentedBySpeaker 由講者呈現（全螢幕） BrowsedByIndividual 由個人瀏覽（視窗） BrowsedAtKiosk 於資訊站點瀏覽（全螢幕）"
type: docs
weight: 5227
...
Base slide show settings. Ancestors represent types of the slide show: [PresentedBySpeaker](../presentedbyspeaker/) 由講者呈現（全螢幕） [BrowsedByIndividual](../browsedbyindividual/) 由個人瀏覽（視窗） [BrowsedAtKiosk](../browsedatkiosk/) 在資訊站點瀏覽（全螢幕）
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述式的鎖定功能。可直接呼叫或使用 [LockContext](../../system/lockcontext/) 哨兵物件。 |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 陳述式的解鎖功能。可直接呼叫或使用 [LockContext](../../system/lockcontext/) 哨兵物件。 |
