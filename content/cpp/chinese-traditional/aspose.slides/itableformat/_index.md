...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | 傳回表格填充屬性物件。唯讀 [IFillFormat](../ifillformat/)。 |
| virtual **float** [get_Transparency](./get_transparency/)() | 取得填充顏色的透明度。讀取 **float**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() | 取得套用繼承與表格樣式後的有效表格格式屬性。 |
...
| virtual void [set_Transparency](./set_transparency/)(**float**) | 設定填充顏色的透明度。寫入 **float**。 |
