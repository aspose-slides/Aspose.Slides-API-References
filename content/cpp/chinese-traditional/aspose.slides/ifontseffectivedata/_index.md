...
description: 不可變的物件，包含有效字型設定。
type: docs
weight: 2224
url: /zh-hant/aspose.slides/ifontseffectivedata/
---
## IFontsEffectiveData 類別
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() | 返回複合腳本字型。唯讀 [IFontData](../ifontdata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() | 返回東亞字型。唯讀 [IFontData](../ifontdata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() | 返回拉丁字型。唯讀 [IFontData](../ifontdata/)。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷貝建構子。不會實際拷貝任何內容，只是初始化新物件，並允許子類別使用拷貝建構。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 指派運算子。實際上不會拷貝任何東西，只是初始化新物件，並允許子類別使用拷貝建構。 |
...
此介面作為 [IBasePortionFormatEffectiveData](../ibaseportionformateffectivedata/) 與 [Theme::IFontSchemeEffectiveData](../../aspose.slides.theme/ifontschemeeffectivedata/) 介面的一部分使用。
