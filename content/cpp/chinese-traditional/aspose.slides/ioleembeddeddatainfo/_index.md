...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() | 回傳嵌入式 OLE 物件的檔案資料，唯讀 **uint8_t**[]。 |
| virtual [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() | 回傳目前嵌入式 OLE 物件的檔案副檔名，唯讀 [System::String](../../system/string/)。 |
