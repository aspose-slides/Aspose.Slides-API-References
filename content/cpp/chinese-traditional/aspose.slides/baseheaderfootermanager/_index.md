...
description: 代表管理者，負責所有投影片類型的頁腳、日期時間、頁碼佔位符的行為。
type: docs
weight: 131
...
代表一個管理者，負責所有投影片類型的頁腳、日期時間、頁碼佔位符的行為。
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 指派運算子。實際上不會真的複製任何東西，只是初始化新物件並允許子類別的複製建構。 |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | 使用參考比較物件。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | 使用參考比較物件。 |
