...
description: 表示包含有效資料的不可變物件。
type: docs
weight: 2055
url: /zh-hant/aspose.slides/ieffectivedata/
---
## IEffectiveData 類別
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 設定 第 n 個模板參數為弱指標（而非共享）。允許在容器中將指標切換為弱模式。 |
