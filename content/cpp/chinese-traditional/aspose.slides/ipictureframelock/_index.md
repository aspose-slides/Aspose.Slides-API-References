...
description: 確定在父 PictureFrameEx 上哪些操作被禁用。
type: docs
weight: 3264
url: /zh-hant/aspose.slides/ipictureframelock/
---
## IPictureFrameLock 類別
...
| virtual **bool** [get_ArrowheadsLocked](./get_arrowheadslocked/)() | 判斷是否禁止變更箭頭。讀取 **bool**。 |
| virtual **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() | 判斷形狀在調整大小時是否必須保持長寬比。讀取 **bool**。 |
| virtual **bool** [get_CropLocked](./get_croplocked/)() | 判斷是否禁止圖像裁剪。讀取 **bool**。 |
...
| virtual **bool** [get_NoLocks](../ibaseshapelock/get_nolocks/)() | 如果所有鎖定旗標皆已停用則回傳 true。唯讀 **bool**。 |
| virtual **bool** [get_PositionLocked](./get_positionlocked/)() | 判斷是否禁止移動此形狀。讀取 **bool**。 |
| virtual **bool** [get_RotationLocked](./get_rotationlocked/)() | 判斷是否禁止變更此形狀的旋轉角度。讀取 **bool**。 |
...
| virtual **bool** [get_SizeLocked](./get_sizelocked/)() | 判斷是否禁止調整此形狀的大小。讀取 **bool**。 |
...
| virtual void [set_ArrowheadsLocked](./set_arrowheadslocked/)(**bool**) | 判斷是否禁止變更箭頭。寫入 **bool**。 |
| virtual void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) | 判斷形狀在調整大小時是否必須保持長寬比。寫入 **bool**。 |
| virtual void [set_CropLocked](./set_croplocked/)(**bool**) | 判斷是否禁止圖像裁剪。寫入 **bool**。 |
...
| virtual void [set_RotationLocked](./set_rotationlocked/)(**bool**) | 判斷是否禁止變更此形狀的旋轉角度。寫入 **bool**。 |
...
| virtual void [set_SizeLocked](./set_sizelocked/)(**bool**) | 判斷是否禁止調整此形狀的大小。寫入 **bool**。 |
