...
決定在父 [PictureFrame](../pictureframe/) 上哪個操作被禁用。
...
| **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() override | 判斷形狀在調整尺寸時是否必須保持長寬比。讀取 **bool**。 |
| **bool** [get_CropLocked](./get_croplocked/)() override | 判斷是否禁止裁剪影像。讀取 **bool**。 |
...
| **bool** [get_NoLocks](../baseshapelock/get_nolocks/)() override | 若所有鎖定旗標皆被停用則回傳 true。唯讀 **bool**。 |
...
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | 判斷形狀在調整尺寸時是否必須保持長寬比。寫入 **bool**。 |
| void [set_CropLocked](./set_croplocked/)(**bool**) override | 判斷是否禁止裁剪影像。寫入 **bool**。 |
...
* 類別 [IPictureFrameLock](../ipictureframelock/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)