...
description: 表示一個可以批量設定子文字元素格式的物件。
type: docs
weight: 1548
url: /zh-hant/aspose.slides/ibulktextformattable/
---
## IBulkTextFormattable 類別

表示一個可以批量設定子文字元素格式的物件。
...
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | 將已定義的部份格式屬性設定給所有元素的部份。 |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | 將已定義的段落格式屬性設定給所有元素的段落。 |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | 將已定義的文字框格式屬性設定給所有元素的文字框。 |
