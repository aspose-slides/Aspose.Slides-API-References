...
| 方法 | 說明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [CreateParagraph](./createparagraph/)() override | 建立一個新的空段落。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [CreateParagraph](./createparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | 使用指定的段落資料建立新段落。 |
...
* 類別 [IParagraphFactory](../iparagraphfactory/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)