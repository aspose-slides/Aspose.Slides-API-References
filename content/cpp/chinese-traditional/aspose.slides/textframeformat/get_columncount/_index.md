...
description: 返回文字區域中的列數。此值必須為正數。否則，該值將被設為零。值 0 表示未定義的值。讀取 int32_t.
type: docs
weight: 248
url: /zh-hant/aspose.slides/textframeformat/get_columncount/
---
## TextFrameFormat::get_ColumnCount() 方法


返回文字區域中的列數。此值必須為正數。否則，該值將被設定為零。值 0 表示未定義的值。讀取 **int32_t**.
...
以下範例程式碼展示了如何在 PowerPoint [Presentation](../../presentation/) 中的文字框新增列。 
```cpp
