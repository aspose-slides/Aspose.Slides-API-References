...
description: 返回代表文字 3D 效果屬性的 ThreeDFormat 物件。唯讀 IThreeDFormat。
type: docs
weight: 1
url: /zh-hant/aspose.slides/textframeformat/get_threedformat/
---
## TextFrameFormat::get_ThreeDFormat() 方法


返回代表文字 3D 效果屬性的 [ThreeDFormat](../../threedformat/) 物件。唯讀 [IThreeDFormat](../../ithreedformat/)。
