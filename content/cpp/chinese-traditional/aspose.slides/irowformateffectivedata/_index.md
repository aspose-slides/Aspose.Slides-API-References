...
description: 不可變對象，包含有效的表格列格式屬性。
type: docs
weight: 3550
url: /zh-hant/aspose.slides/irowformateffectivedata/
---
## IRowFormatEffectiveData 類別
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalDown](../ibasetableformateffectivedata/get_borderdiagonaldown/)() | 傳回向下斜線格式的有效值。唯讀 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalUp](../ibasetableformateffectivedata/get_borderdiagonalup/)() | 傳回向上斜線格式的有效值。唯讀 [ILineFormatEffectiveData](../ilineformateffectivedata/)。 |
...
此介面與 [IRowFormat](../irowformat/) 介面一起使用，以回傳在繼承與表格樣式套用後的有效格式值。 
