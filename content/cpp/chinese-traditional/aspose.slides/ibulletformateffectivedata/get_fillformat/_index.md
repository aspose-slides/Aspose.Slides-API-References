...
description: 返回段落的項目符號填充格式。唯讀 IFillFormatEffectiveData.
type: docs
weight: 131
url: /zh-hant/aspose.slides/ibulletformateffectivedata/get_fillformat/
---
## IBulletFormatEffectiveData::get_FillFormat() 方法

返回段落的項目符號填充格式。唯讀 [IFillFormatEffectiveData](../../ifillformateffectivedata/).
