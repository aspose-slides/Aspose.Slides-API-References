...
| virtual **bool** [Equals](../ibaseslide/equals/)([System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\>) | 確定兩個 [IBaseSlide](../ibaseslide/) 實例是否相等。返回值根據投影片的結構和靜態內容計算。若所有形狀、樣式、文字、動畫及其他設定等皆相等，則兩張投影片相等。比較不考慮唯一識別碼值，例如 SlideId，以及動態內容，例如 Date [Placeholder](../placeholder/) 中的當前日期值。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [FindShapeByAltText](../ibaseslide/findshapebyalttext/)([System::String](../../system/string/)) | 尋找具有指定替代文字的形狀的首次出現。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() | 傳回註解投影片的 HeaderFooter 管理器。唯讀 [INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkQueries](../ihyperlinkqueries/)\> [get_HyperlinkQueries](../ibaseslide/get_hyperlinkqueries/)() | 提供對包含之超連結的簡易存取。唯讀 [IHyperlinkQueries](../ihyperlinkqueries/)。 |
| virtual [System::String](../../system/string/) [get_Name](../ibaseslide/get_name/)() | 傳回投影片的名稱。讀取 [System::String](../../system/string/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [get_NotesTextFrame](./get_notestextframe/)() | 若有註解文字，傳回 [TextFrame](../textframe/)。唯讀 [ITextFrame](../itextframe/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_ParentSlide](./get_parentslide/)() | 傳回 ParentSlide。唯讀 [ISlide](../islide/)。 |
...
| virtual **bool** [get_ShowMasterShapes](../ibaseslide/get_showmastershapes/)() | 指定是否在投影片上顯示母片投影片上的形狀。對於母片投影片本身，該屬性始終傳回 **false**。讀取 **bool**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlideShowTransition](../islideshowtransition/)\> [get_SlideShowTransition](../ibaseslide/get_slideshowtransition/)() | 傳回 TransitionEx 物件，其中包含有關指定投影片在投影片放映期間如何前進的資訊。唯讀 [ISlideShowTransition](../islideshowtransition/)。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否代表由 targetType 所描述的型別實例。相當於 C# 'is' 運算子。 |
| virtual void [JoinPortionsWithSameFormatting](../ibaseslide/joinportionswithsameformatting/)() | 在所有可接受的形狀中的所有段落內，將相同格式的文字執行合併。 |
...
| virtual void [set_ShowMasterShapes](../ibaseslide/set_showmastershapes/)(**bool**) | 指定是否在投影片上顯示母片投影片上的形狀。對於母片投影片本身，該屬性始終傳回 **false**。寫入 **bool**。 |
