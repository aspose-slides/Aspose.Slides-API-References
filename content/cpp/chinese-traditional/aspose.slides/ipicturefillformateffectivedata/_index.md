...
---
## IPictureFillFormatEffectiveData 類別
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，儘管根據 IEC 60559:1989，NaN 並不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，儘管根據 IEC 60559:1989，NaN 並不等於任何值，包括 NaN 本身。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| virtual **float** [get_CropBottom](./get_cropbottom/)() | 返回圖片底部被裁切的實際影像高度的百分比。唯讀 **float**。 |
| virtual **float** [get_CropLeft](./get_cropleft/)() | 返回圖片左側被裁切的實際影像寬度的百分比。唯讀 **float**。 |
| virtual **float** [get_CropRight](./get_cropright/)() | 返回圖片右側被裁切的實際影像寬度的百分比。唯讀 **float**。 |
| virtual **float** [get_CropTop](./get_croptop/)() | 返回圖片頂部被裁切的實際影像高度的百分比。唯讀 **float**。 |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | 返回用於填充圖片的 dpi。唯讀 **int32_t**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | 返回圖片。唯讀 [IPictureEffectiveData](../ipictureeffectivedata/)。 |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | 返回圖片填充模式。唯讀 [Slides::PictureFillMode](../picturefillmode/)。 |
...
此介面作為 [IFillFormatEffectiveData](../ifillformateffectivedata/) 的一部分使用。
