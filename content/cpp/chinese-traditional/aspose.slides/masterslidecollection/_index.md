...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | 將指定母片的副本新增至集合的末端。已連結的版面投影片也會被複製。 |
| [iterator](./iterator/) [begin](./begin/)() | 取得指向集合第一個元素（如果有）的迭代器。 |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | 取得指向集合之 const 限定實例的第一個元素（如果有）的迭代器。 |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | 取得指向集合第一個 const 限定元素（如果有）的迭代器。 |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 取得指向集合最後一個 const 限定元素之後位置的迭代器（如果有）。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>, **int32_t**) override | 將集合中的所有元素複製到指定的陣列中。 |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | 將集合中的所有元素複製到指定的陣列中。 |
| [iterator](./iterator/) [end](./end/)() | 取得指向集合最後一個元素之後位置的迭代器（如果有）。 |
| [const_iterator](./const_iterator/) [end](./end/)() const | 取得指向集合之 const 限定實例的最後一個元素之後位置的迭代器（如果有）。 |
...
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | 傳回一個值，指示集合的存取是否已同步（執行緒安全）。唯讀 **bool**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>\> [GetEnumerator](./getenumerator/)() override | 傳回可遍歷集合的列舉子。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。啟用自訂物件的雜湊。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際型別。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [idx_get](./idx_get/)(**int32_t**) override | 取得指定索引處的元素。唯讀 [MasterSlide](../masterslide/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | 在集合的指定位置插入指定母片的副本。已連結的版面投影片也會被複製。 |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 計算透過在輸入序列的每個元素上呼叫轉換函式取得的值序列的平均值。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | 從序列開始處跳過指定數量的連續元素，並傳回剩餘部分。 |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 指定運算子。實際上不會拷貝任何東西，只是初始化新物件並允許子類別的拷貝建構。 |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | 從集合中移除特定物件的第一個出現項。 |
...
| void [RemoveUnused](./removeunused/)(**bool**) override | 移除未使用的母片。 |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 將第 n 個模板參數設為弱指標（而非共用指標）。允許在容器中將指標切換為弱模式。 |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 取得指向集合之 const 限定實例的第一個元素（如果有）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 取得指向集合第一個元素（如果有）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 取得指向集合之 const 限定實例的最後一個元素之後位置的迭代器（如果有）。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | 取得指向集合最後一個元素之後位置的迭代器（如果有）。 |
...
| 型別別名 | 描述 |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 集合型別，其迭代器型別用於目前集合的迭代器型別。 |
...
* 類別 [IMasterSlideCollection](../imasterslidecollection/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)