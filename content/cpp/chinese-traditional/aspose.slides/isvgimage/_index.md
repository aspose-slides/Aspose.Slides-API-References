...
| virtual [System::String](../../system/string/) [get_BaseUri](./get_baseuri/)() | 傳回指定 SVG 的基礎 URI。用於解析相對連結。唯讀 [System::String](../../system/string/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\> [get_ExternalResourceResolver](./get_externalresourceresolver/)() | 傳回在 SVG 文件匯入期間用於解析外部資源的回呼介面。唯讀 [Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)。 |
| virtual [System::String](../../system/string/) [get_SvgContent](./get_svgcontent/)() | 傳回 SVG 內容。唯讀 [System::String](../../system/string/)。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_SvgData](./get_svgdata/)() | 傳回 SVG 資料。唯讀 **uint8_t**[]。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化，用於 string 和 nullptr 的情況。 |
...
| virtual void [WriteAsEmf](./writeasemf/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | 將 SVG 圖像儲存為 EMF 檔案。 |
