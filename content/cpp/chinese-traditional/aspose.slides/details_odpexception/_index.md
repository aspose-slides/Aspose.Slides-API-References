...
type: docs
weight: 599
url: /zh-hant/aspose.slides/details_odpexception/
---
## Details_OdpException 類別
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 返回一個 32 位元整數值，該值為與目前物件所表示的例外相關聯的 HRESULT 代碼。 |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | 返回表示最內層例外的 Exception 物件的副本。 |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | 返回目前物件的字串表示形式。 |
