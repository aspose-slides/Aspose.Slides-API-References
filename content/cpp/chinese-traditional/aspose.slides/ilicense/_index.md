...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點數比較，將兩個 NaN 視為相等，即使依 IEC 60559:1989，NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點數比較，將兩個 NaN 視為相等，即使依 IEC 60559:1989，NaN 不等於任何值，包括 NaN 本身。 |
...
| virtual **bool** [IsLicensed](./islicensed/)() | 檢查授權是否已套用至元件 |
...
| virtual void [ResetLicense](./resetlicense/)() | 重設授權 |
| virtual void [SetLicense](./setlicense/)([System::String](../../system/string/)) | 為元件授權。 |
| virtual void [SetLicense](./setlicense/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | 為元件授權。 |
...
在此範例中，系統會嘗試在以下位置尋找名為 MyLicense.lic 的授權檔案：包含元件的資料夾、包含呼叫組件的資料夾、入口組件的資料夾，最後是呼叫組件的內嵌資源。 
```cpp
