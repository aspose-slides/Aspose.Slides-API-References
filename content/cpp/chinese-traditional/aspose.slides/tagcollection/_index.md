...
| Method | Description |
| --- | --- |
| **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 將新標籤加入集合。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 取得指向集合中第一個元素（如果有）的迭代器。由於 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 回傳 T 的副本物件，該迭代器不能用來變更參考的物件。 |
...
| void [Clear](./clear/)() override | 從集合中移除所有標籤。 |
| **bool** [Contains](./contains/)([System::String](../../system/string/)) override | 判斷集合是否包含指定的名稱。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\>, **int32_t**) override | 將集合中的所有元素複製到指定的陣列。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 取得指向集合中最後一個元素之後的迭代器（如果有）。由於 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 回傳 T 的副本物件，該迭代器不能用來變更參考的物件。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 取得指向集合的 const 限定實例中最後一個元素之後的迭代器（如果有）。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使依 IEC 60559:1989 規定 NaN 並不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使依 IEC 60559:1989 規定 NaN 並不等於任何值，包括 NaN 本身。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| **int32_t** [get_Count](./get_count/)() override | 返回集合中標籤的數量。唯讀 **int32_t**。 |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | 返回一個指示集合存取是否同步（執行緒安全）的值。唯讀 **bool**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\>\> [GetEnumerator](./getenumerator/)() override | 返回用於遍歷集合的列舉器。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。支援自訂物件的雜湊運算。 |
| [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) override | 返回指定索引處標籤的鍵。 |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() override | 返回標籤的名稱。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際類型。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
| [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) override | 返回指定索引處標籤的值。 |
| [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) override | 返回標籤的鍵和值對。 |
| void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) override | 設定標籤的鍵和值對。 |
| **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) override | 返回指定鍵在集合中的零基索引。 |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 計算透過對輸入序列的每個元素呼叫轉換函式取得之值的序列的平均值。 |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | 返回序列的第一個元素；如果序列為空則返回預設值。 |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | 返回序列的最後一個元素；如果序列為空則返回預設值。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | 對序列的每個元素進行投射，並將產生的序列合併為一個序列。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | 返回序列開頭的指定數量的連續元素。 |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | 從集合中移除具有指定名稱的標籤。 |
| void [RemoveAt](./removeat/)(**int32_t**) override | 移除指定索引處的標籤。 |
...
以下範例示範如何將標籤新增至 PowerPoint [Presentation](../presentation/)。
...
* 類別 [ITagCollection](../itagcollection/)
* 命名空間 [Aspose::Slides](../)
* 函式庫 [Aspose.Slides](../../)