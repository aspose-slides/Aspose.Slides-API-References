...
[Presentation](../presentation/) 寬闊視圖屬性。
...
| **float** [get_GridSpacing](./get_gridspacing/)() override | 傳回應用於簡報文件底層格線的格距（單位為點）。讀取 **float**。 |
| [ViewType](../viewtype/) [get_LastView](./get_lastview/)() override | 指定最後一次保存簡報文件時使用的檢視模式。讀取 [ViewType](../viewtype/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[INormalViewProperties](../inormalviewproperties/)\> [get_NormalViewProperties](./get_normalviewproperties/)() override | 代表一般檢視屬性。一般檢視由三個內容區域組成：投影片本身、側邊內容區域以及底部內容區域。唯讀 [INormalViewProperties](../inormalviewproperties/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommonSlideViewProperties](../icommonslideviewproperties/)\> [get_NotesViewProperties](./get_notesviewproperties/)() override | 指定與註解檢視模式相關的共用檢視屬性。唯讀 [ICommonSlideViewProperties](../icommonslideviewproperties/)。 |
| [NullableBool](../nullablebool/) [get_ShowComments](./get_showcomments/)() override | 指定是否顯示投影片註解。讀取 [NullableBool](../nullablebool/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommonSlideViewProperties](../icommonslideviewproperties/)\> [get_SlideViewProperties](./get_slideviewproperties/)() override | 指定與投影片檢視模式相關的共用檢視屬性。唯讀 [ICommonSlideViewProperties](../icommonslideviewproperties/)。 |
...
| void [set_GridSpacing](./set_gridspacing/)(**float**) override | 設定應用於簡報文件底層格線的格距（單位為點）。寫入 **float**。 |
| void [set_LastView](./set_lastview/)([ViewType](../viewtype/)) override | 指定最後一次保存簡報文件時使用的檢視模式。寫入 [ViewType](../viewtype/)。 |
| void [set_ShowComments](./set_showcomments/)([NullableBool](../nullablebool/)) override | 指定是否顯示投影片註解。寫入 [NullableBool](../nullablebool/)。 |
...
* 類別 [IViewProperties](../iviewproperties/)
