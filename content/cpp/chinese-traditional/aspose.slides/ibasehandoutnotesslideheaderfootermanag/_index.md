...
description: 代表管理員，負責保持佔位符的行為，包括所有類型的講義與備註投影片的標頭佔位符。
type: docs
weight: 1431
url: /zh-hant/aspose.slides/ibasehandoutnotesslideheaderfootermanag/
---
## IBaseHandoutNotesSlideHeaderFooterManag 類別

表示管理員，負責佔位符的行為，包括所有類型的講義與備註投影片的標頭佔位符。
...
| virtual **bool** [get_IsDateTimeVisible](../ibaseslideheaderfootermanager/get_isdatetimevisible/)() | 取得指示日期時間佔位符是否存在的值。讀取**bool**。 |
| virtual **bool** [get_IsFooterVisible](../ibaseslideheaderfootermanager/get_isfootervisible/)() | 取得指示頁腳佔位符是否存在的值。讀取 **bool**。 |
| virtual **bool** [get_IsHeaderVisible](./get_isheadervisible/)() | 取得指示標頭佔位符是否存在的值。讀取 **bool**。 |
| virtual **bool** [get_IsSlideNumberVisible](../ibaseslideheaderfootermanager/get_isslidenumbervisible/)() | 取得指示頁碼佔位符是否存在的值。讀取**bool**。 |
...
| virtual void [SetHeaderText](./setheadertext/)([System::String](../../system/string/)) | 設定投影片標頭佔位符的文字。 |
| virtual void [SetHeaderVisibility](./setheadervisibility/)(**bool**) | 變更投影片標頭佔位符的可見性。 |
...
原始介面名稱 "IBaseHandoutNotesSlideHeaderFooterManager" 為了 COM 相容性被截斷為 "IBaseHandoutNotesSlideHeaderFooterManag"（型別名稱長度不得超過 39）。
