...
description: 表示文件的 'Heading pair' 屬性。它指示文件部件的群組名稱以及群組中部件的數量。
type: docs
weight: 1223
...
代表文件的「Heading pair」屬性。它指示文件部件的群組名稱以及群組中部件的數量。
...
| **int32_t** [get_Count](./get_count/)() override | 傳回群組中零件的數量。唯讀 **int32_t**。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 傳回文件零件的群組名稱。唯讀 [System::String](../../system/string/)。 |
