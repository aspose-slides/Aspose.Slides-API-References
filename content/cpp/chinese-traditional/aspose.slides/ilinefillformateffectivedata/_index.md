...
---
## ILineFillFormatEffectiveData 類別
...
| virtual [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() | 取得填充類型。唯讀 [Slides::FillType](../filltype/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormatEffectiveData](../igradientformateffectivedata/)\> [get_GradientFormat](./get_gradientformat/)() | 取得漸層填充格式。唯讀 [IGradientFormatEffectiveData](../igradientformateffectivedata/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormatEffectiveData](../ipatternformateffectivedata/)\> [get_PatternFormat](./get_patternformat/)() | 取得圖案填充格式。唯讀 [IPatternFormatEffectiveData](../ipatternformateffectivedata/)。 |
| virtual **bool** [get_RotateWithShape](./get_rotatewithshape/)() | 判斷填充是否應隨形狀旋轉。唯讀 **bool**。 |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_SolidFillColor](./get_solidfillcolor/)() | 取得實心填充的顏色。唯讀 [System::Drawing::Color](../../system.drawing/color/)。 |
...
此介面作為 [ILineFormatEffectiveData](../ilineformateffectivedata/) 的一部分使用。
