...
description: 表示已定義母版投影片的所有版面投影片的集合。繼承 ILayoutSlideCollection 介面，提供在母版投影片的各個版面投影片集合中加入、插入、移除或複製版面投影片的方法。
type: docs
weight: 2874
url: /zh-hant/aspose.slides/imasterlayoutslidecollection/
---
## IMasterLayoutSlideCollection 類別

表示已定義母版投影片的所有版面投影片的集合。繼承 [ILayoutSlideCollection](../ilayoutslidecollection/) 介面，提供在母版投影片的各個版面投影片集合中加入、插入、移除或複製版面投影片的方法。
...
| 方法 | 描述 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | 將新的版面投影片新增至集合的末端。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | 將指定版面投影片的副本新增至集合的末端。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 取得指向集合第一個元素（若有）的迭代器。此迭代器無法用於修改所參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的複本物件。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | 取得指向 const 限定之集合實例的第一個元素（若有）的迭代器。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | 取得指向集合中最後一個 const 限定元素之後位置（若有）的迭代器。 |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | 將集合中的所有元素複製到指定的陣列中。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 取得指向集合最後一個元素之後位置（若有）的迭代器。此迭代器無法用於修改所參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的複本物件。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 取得指向 const 限定之集合實例的最後一個元素之後位置（若有）的迭代器。 |
...
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | 返回集合中行為的數量。唯讀 **int32_t**。 |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | 返回指示集合存取是否同步（執行緒安全）的值。唯讀 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | 返回同步根。唯讀 [System::Object](../../system/object/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../ilayoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) | 返回指定類型的第一個版面投影片。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../ilayoutslidecollection/idx_get/)(**int32_t**) | 依索引返回版面投影片。唯讀 [ILayoutSlide](../ilayoutslide/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Insert](./insert/)(**int32_t**, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | 在集合中指定位置插入新的版面投影片。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | 在集合中指定位置插入指定版面投影片的副本。 |
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 敘述的加鎖。直接呼叫或使用 [LockContext](../../system/lockcontext/) 哨兵物件。 |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | 移除集合中指定索引的元素。 |
...
| virtual void [Reorder](./reorder/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | 將版面投影片從集合中移動到指定位置。 |
