...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | 傳回音訊資料的副本。若資料量龐大，請考慮使用 [Audio::GetStream](./getstream/) 方法，以避免不必要地將音訊資料載入記憶體，甚至發生 OutOfMemoryException。唯讀 **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | 傳回音訊的 MIME 類型，使用 [Audio::get_BinaryData](./get_binarydata/) 編碼。唯讀 [System::String](../../system/string/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數器資料結構。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。啟用自訂物件的雜湊。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | 傳回用於讀取的 Stream。使用 'using' 或在使用後關閉串流。 |
...
| void [set_ContentType](./set_contenttype/)([System::String](../../system/string/)) | 傳回音訊的 MIME 類型，使用 [Audio::get_BinaryData](./get_binarydata/) 編碼。唯讀 [System::String](../../system/string/)。 |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 設定第 n'th 模板參數為弱指標（而非共享）。允許在容器中將指標切換為弱模式。 |
