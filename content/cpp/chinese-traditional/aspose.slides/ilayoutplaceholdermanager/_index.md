...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddChartPlaceholder](./addchartplaceholder/)(**float**, **float**, **float**, **float**) | 新增一個佔位形狀至版面投影片，用於保存圖表。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddContentPlaceholder](./addcontentplaceholder/)(**float**, **float**, **float**, **float**) | 新增一個佔位形狀至版面投影片，用於保存內容，例如圖片、表格、媒體或文字。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddMediaPlaceholder](./addmediaplaceholder/)(**float**, **float**, **float**, **float**) | 新增一個佔位形狀至版面投影片，用於保存媒體物件。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddOnlineImagePlaceholder](./addonlineimageplaceholder/)(**float**, **float**, **float**, **float**) | 新增一個佔位形狀至版面投影片，用於保存線上影像。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddPicturePlaceholder](./addpictureplaceholder/)(**float**, **float**, **float**, **float**) | 新增一個佔位形狀至版面投影片，用於保存圖片。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddSmartArtPlaceholder](./addsmartartplaceholder/)(**float**, **float**, **float**, **float**) | 新增一個佔位形狀至版面投影片，用於保存 [SmartArt](../../aspose.slides.smartart/) 圖表。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddTablePlaceholder](./addtableplaceholder/)(**float**, **float**, **float**, **float**) | 新增一個佔位形狀至版面投影片，用於保存表格。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddTextPlaceholder](./addtextplaceholder/)(**float**, **float**, **float**, **float**) | 新增一個佔位形狀至版面投影片，用於保存文字內容。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddVerticalContentPlaceholder](./addverticalcontentplaceholder/)(**float**, **float**, **float**, **float**) | 新增一個佔位形狀至版面投影片，用於以垂直方向保存內容，例如圖片、表格、媒體或文字。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShape](../iautoshape/)\> [AddVerticalTextPlaceholder](./addverticaltextplaceholder/)(**float**, **float**, **float**, **float**) | 新增一個佔位形狀至版面投影片，用於以垂直方向保存文字內容。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 設定第 n 個模板參數為弱參考（而非共用）。允許在容器中切換指標至弱模式。 |
