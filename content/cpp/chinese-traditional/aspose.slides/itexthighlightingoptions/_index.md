...
description: 表示可用於在文字框中突出顯示文字的選項。
type: docs
weight: 4109
url: /zh-hant/aspose.slides/itexthighlightingoptions/
---
## ITextHighlightingOptions 類別
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | 設定為 true 以使用區分大小寫的搜尋，false 則相反。讀取 **bool**。 |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | 設定為 true 只匹配完整字詞，false 則相反。讀取 **bool**。 |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | 設定為 true 以使用區分大小寫的搜尋，false 則相反。寫入 **bool**。 |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | 設定為 true 只匹配完整字詞，false 則相反。寫入 **bool**。 |
...
## 已棄用
:   介面 [ITextHighlightingOptions](./) 將在 24.10 版發佈後移除。
