...
description: Queue 類別前向宣告。
type: docs
weight: 469
url: /zh-hant/system.collections.generic/queue/
---
## Queue 類別
...
| 方法 | 說明 |
| --- | --- |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | 取得指向集合第一個元素（若有）的迭代器。此迭代器無法用於更改所參考的物件，因為 [GetEnumerator()](../ienumerable/getenumerator/) 會回傳 T 的副本物件。 |
...
| virtual void [Clear](./clear/)() | 刪除佇列中的所有元素。 |
| virtual **bool** [Contains](./contains/)(const T\&) const | 檢查佇列是否包含特定元素，使用 operator == 來比較元素。 |
| [queue_t](./queue_t/)\& [data](./data/)() | 底層資料結構存取子。 |
| const [queue_t](./queue_t/)\& [data](./data/)() const | 底層資料結構存取子。 |
| T [Dequeue](./dequeue/)() | 取得佇列開頭的項目。 |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | 取得指向集合最後一個元素之後的迭代器（若有）。此迭代器無法用於更改所參考的物件，因為 [GetEnumerator()](../ienumerable/getenumerator/) 會回傳 T 的副本物件。 |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | 取得指向 const 限定集合實例之最後一個元素之後的迭代器（若有）。 |
| void [Enqueue](./enqueue/)(const T\&) | 將項目加入佇列的末端。 |
...
| virtual int [get_Count](./get_count/)() const | 取得佇列中的元素數量。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | 取得用於遍歷佇列的列舉器。 |
...
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 計算透過對輸入序列每個元素呼叫轉換函式所得到的值序列的平均值。 |
...
| T [LINQ_ElementAt](../ienumerable/linq_elementat/)(int) | 回傳序列中指定索引之元素。 |
| T [LINQ_ElementAtOrDefault](../ienumerable/linq_elementatordefault/)(int) | 回傳序列中指定索引之元素。 |
| T [LINQ_First](../ienumerable/linq_first/)() | 回傳序列的第一個元素。 |
| T [LINQ_First](../ienumerable/linq_first/)(const [Func](../../system/func/)\<T, **bool**\>\&) | 回傳符合指定條件的序列中的第一個元素。 |
| T [LINQ_FirstOrDefault](../ienumerable/linq_firstordefault/)() | 回傳序列的第一個元素；如果序列為空，則回傳預設值。 |
| T [LINQ_FirstOrDefault](../ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | 回傳符合條件的序列第一個元素；若未找到，則回傳預設值。 |
...
| T [LINQ_LastOrDefault](../ienumerable/linq_lastordefault/)() | 回傳序列的最後一個元素；如果序列為空，則回傳預設值。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | 根據 keySelector 所選取的鍵值，以升冪排序序列的元素。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | 根據 keySelector 所選取的鍵值，以降冪排序序列的元素。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | 跳過序列開頭指定數量的連續元素，並回傳剩餘部分。 |
...
| T [Peek](./peek/)() | 取得佇列開頭的項目，但不會從佇列中移除。 |
|  [Queue](./queue/)() | 建構空的佇列。 |
|  [Queue](./queue/)(int) | 建構空的佇列。 |
|  [Queue](./queue/)(const [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\>\&) | 拷貝建構函式。 |
...
| 型別別名 | 說明 |
| --- | --- |
| [ValueType](./valuetype/) | 此類型。 |
| [queue_t](./queue_t/) | 底層資料類型。 |
| [IEnumerablePtr](./ienumerableptr/) | 相同類型元素的容器。 |
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator** 類型。 |

## 備註

[Queue](./) 容器封裝 STL list。此類別的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行階段錯誤和/或斷言失敗。應始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
...
int main()
{
  ...
  // 印出第一個佇列項目。Peek 方法不會從佇列中移除項目。
  std::cout << queue->Peek() << std::endl;
  // 印出佇列項目。
  PrintItems(queue);

  // 印出第一個佇列項目。Dequeue 方法會從佇列中移除項目。
