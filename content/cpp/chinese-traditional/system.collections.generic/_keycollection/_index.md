...
description: "Dictionary 的鍵集合。引用集合，不會複製任何內容。此類別的物件只能使用 System::MakeObject() 函式來分配。絕不要在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝為 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 1
url: /zh-hant/system.collections.generic/_keycollection/
---
## _KeyCollection 類別

[Dictionary](../dictionary/) 的鍵集合。引用集合，不會複製任何內容。此類別的物件只能使用 [System::MakeObject()](../../system/makeobject/) 函式來分配。絕不要在堆疊上或使用 new 運算子建立此型別的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別封裝為 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標作為參數傳遞給函式。
...
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | 取得指向集合中第一個元素（若有）的迭代器。此迭代器無法用於變更被參照的物件，因為 [GetEnumerator()](../ienumerable/getenumerator/) 會回傳 T 的拷貝物件。 |
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | 取得指向 const 限定之集合實例中第一個元素（若有）的迭代器。 |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | 取得指向集合中第一個 const 限定元素（若有）的迭代器。 |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | 取得指向集合中最後一個 const 限定元素之後位置的迭代器（若有）。 |
| void [Clear](../ikvcollection/clear/)() override | 刪除容器中的所有元素。 |
| **bool** [Contains](./contains/)(const [TKey](./tkey/)\&) const override | 檢查項目是否存在於容器中。 |
| void [CopyTo](../basekvcollection/copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | 將資料複製到現有的陣列元素。 |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | 取得指向集合中最後一個元素之後位置的迭代器（若有）。此迭代器無法用於變更被參照的物件，因為 [GetEnumerator()](../ienumerable/getenumerator/) 會回傳 T 的拷貝物件。 |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | 取得指向 const 限定之集合實例中最後一個元素之後位置的迭代器（若有）。 |
...
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | 檢查集合是否具有固定大小。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TKey](./tkey/)\>\> [GetEnumerator](./getenumerator/)() override | 取得遍歷鍵的列舉器。 |
...
| [TKey](./tkey/) [idx_get](./idx_get/)(int) const override | 實作 [IList](../ilist/) 方法。未支援。 |
...
| T [LINQ_Aggregate](../ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | 對序列套用 accumulator 函式。 |
| **bool** [LINQ_All](../ienumerable/linq_all/)(std::function\<**bool**(T)>) | 判斷序列的所有元素是否符合條件。 |
| **bool** [LINQ_Any](../ienumerable/linq_any/)() | 判斷序列是否包含任何元素。 |
| **bool** [LINQ_Any](../ienumerable/linq_any/)(std::function\<**bool**(T)>) | 判斷序列中是否有任一元素存在或符合條件。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Cast](../ienumerable/linq_cast/)() | 將元素轉換為指定的型別。 |
...
| T [LINQ_FirstOrDefault](../ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | 回傳符合條件的序列第一個元素，若找不到則回傳預設值。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | 依照 keySelector 選取的鍵值，以升冪方式排序序列的元素。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | 依照 keySelector 選取的鍵值，以降冪方式排序序列的元素。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Select](../ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | 透過加入元素的索引，將序列的每個元素轉換為新形式。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Where](../ienumerable/linq_where/)(std::function\<**bool**(T)>) | 依據指定的斷言過濾序列。 |
...
| void [SetTemplateWeakPtr](../basekvcollection/settemplateweakptr/)(**uint32_t**) override | 啟用編譯，但實際上不執行任何操作，因為此結構不擁有資料。 |
...
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 取得目前容器的 begin const 迭代器實作。 |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 取得目前容器的 begin 迭代器實作。 |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 取得目前容器的 end const 迭代器實作。 |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | 取得目前容器的 end 迭代器實作。 |
