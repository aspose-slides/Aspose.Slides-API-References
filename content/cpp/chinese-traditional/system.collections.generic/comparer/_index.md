...
description: 提供一個基礎類別，以實作 System.Collections.Generic.IComparer 泛型介面。
type: docs
weight: 105
url: /zh-hant/system.collections.generic/comparer/
---
## Comparer 類別
...
| Method | Description |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) 函式。 |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | 傳回由泛型參數指定之型別的預設排序比較器。 |
