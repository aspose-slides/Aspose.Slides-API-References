...
description: 指定一個位於運算式上方或下方的群組符號，通常用於凸顯元素之間的關係
type: docs
weight: 326
url: /zh-hant/aspose.slides.mathtext/imathgroupingcharacter/
---
## IMathGroupingCharacter 類別


指定一個位於運算式上方或下方的分組符號，通常用於凸顯元素之間的關係
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 使用此實例作為參數，取得指定的函式，並附加指定的額外參數 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) | 使用此實例作為參數，取得指定的函式，並附加指定的額外參數 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) | 使用此分子與指定的分母，建立指定類型的分數 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) | 使用此分子與指定的分母，建立指定類型的分數 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)() | 將數學元素包於括號中 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | 使用指定的字元（如括號或其他字元）將此元素框起來 |
...
| virtual char16_t [get_Character](./get_character/)() | 群組字元 預設值：U+23DF（下弧形括號） |
| virtual [MathTopBotPositions](../mathtopbotpositions/) [get_Position](./get_position/)() | 群組字元的位置。預設：下方 |
| virtual [MathTopBotPositions](../mathtopbotpositions/) [get_VerticalJustification](./get_verticaljustification/)() | 群組字元的垂直對齊。指定物件相對於基線的對齊方式。例如，當群組字元位於物件上方時，垂直對齊設定為 Top 表示物件的頂部位於基線上；當垂直對齊設定為 Bottom 時，物件的底部位於基線上。預設：Position=Top 時為 Bottom，Position=Bottom 時為 Top。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](./)\> [Group](../imathelement/group/)() | 使用下弧形括號將此元素放入群組 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](./)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | 使用群組字元（如下弧形括號或其他）將此元素放入群組 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../imathelement/join/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 將數學元素加入並形成數學區塊 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../imathelement/join/)([System::String](../../system/string/)) | 將數學文字加入並形成數學區塊 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 指定給定次方的數學根號，根據指定的參數。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | 指定給定次方的數學根號，根據指定的參數。 |
...
| virtual void [set_Character](./set_character/)(char16_t) | 群組字元 預設值：U+23DF（下弧形括號） |
| virtual void [set_Position](./set_position/)([MathTopBotPositions](../mathtopbotpositions/)) | 群組字元的位置。預設：下方 |
| virtual void [set_VerticalJustification](./set_verticaljustification/)([MathTopBotPositions](../mathtopbotpositions/)) | 群組字元的垂直對齊。指定物件相對於基線的對齊方式。例如，當群組字元位於物件上方時，垂直對齊設定為 Top 表示物件的頂部位於基線上；當垂直對齊設定為 Bottom 時，物件的底部位於基線上。預設：Position=Top 時為 Bottom，Position=Bottom 時為 Top。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | 將此元素放入非可視盒（邏輯群組），用於將方程式或其他數學文字的組件群組。盒狀物件可（例如）作為帶或不帶對齊點的運算子模擬器，作為換行點，或被群組以防止內部換行。 |
