...
description: 指定一個位於 MathParagraph 內且自行起始於新行的數學文字實例。所有數學區域，包括等式、表達式、等式或表達式的陣列以及公式，都由 math block 表示。
type: docs
weight: 105
...
指定一個位於 [MathParagraph](../mathparagraph/) 內且自行起始於新行的數學文字實例。所有數學區域，包括等式、表達式、等式或表達式的陣列以及公式，都由 math block 表示。
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../imathelement/accent/)(char16_t) | 設定此元素上方的重音符號（此元素頂部的字元） |
| virtual void [Add](../imathelementcollection/add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 將數學元素新增至集合的末端。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 以此實例作為參數，呼叫指定的函式。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::String](../../system/string/)) | 以此實例作為參數，呼叫指定的函式。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfOneArgument](../mathfunctionsofoneargument/)) | 以此實例作為參數，呼叫指定的函式。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 以此實例作為參數，並使用指定的其他參數，呼叫指定的函式。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) | 以此實例作為參數，並使用指定的其他參數，呼叫指定的函式。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 取得指向集合第一個元素（若有）的迭代器。此迭代器無法用於更改所參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的副本物件。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | 取得指向集合的 const 限定實例第一個元素（若有）的迭代器。 |
...
| virtual void [Clear](../imathelementcollection/clear/)() | 從集合中移除所有元素。 |
| virtual **bool** [Contains](../imathelementcollection/contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 判斷集合是否包含特定值。 |
| virtual void [CopyTo](../imathelementcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>\>, **int32_t**) | 複製至指定的陣列。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Delimit](./delimit/)(char16_t) | 使用分隔字元（不含方括號）分隔所有子元素。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](./enclose/)(char16_t, char16_t, char16_t) | 以指定的字元（例如括號或其他）框住此區塊的子元素，並以分隔字元分隔。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)() | 將數學元素置於括號中。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | 以指定的字元（例如括號或其他）框住此元素。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 取得指向集合最後一個元素之後的迭代器（若有）。此迭代器無法用於更改所參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的副本物件。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 取得指向集合的 const 限定實例最後一個元素之後的迭代器（若有）。 |
...
| virtual **int32_t** [get_Count](../imathelementcollection/get_count/)() | 取得集合實際包含的元素數量。唯讀 **int32_t**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [idx_get](../imathelementcollection/idx_get/)(**int32_t**) | 取得指定索引處的元素。唯讀 [IMathElement](../imathelement/)。 |
| virtual **int32_t** [IndexOf](../imathelementcollection/indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 確定集合中特定數學元素的索引。 |
| virtual void [Insert](../imathelementcollection/insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 在指定索引處將數學元素插入集合。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../imathelement/integral/)([MathIntegralTypes](../mathintegraltypes/)) | 取得無限制的積分 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](./)\> [Join](../imathelement/join/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 將數學元素合併並形成數學區塊。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](./)\> [Join](../imathelement/join/)([System::String](../../system/string/)) | 將數學文字合併並形成數學區塊。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](./)\> [JoinBlock](./joinblock/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](./)\>) | 將另一個數學區塊與此區塊合併。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | 對序列的每個元素投影，並將產生的多個序列合併為一個序列。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../imathelement/overbar/)() | 在此元素上方設定橫條 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 以指定的參數計算給定次方的數學根號。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | 以指定的參數計算給定次方的數學根號。 |
...
| virtual **bool** [Remove](../imathelementcollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 從集合中移除特定物件的第一次出現。 |
| virtual void [RemoveAt](../imathelementcollection/removeat/)(**int32_t**) | 移除集合中指定索引處的元素。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | 將此元素放入非可視盒（邏輯分組），用於將方程式或其他數學文字的組件分組。此盒狀物件可（例如）作為具有或不具有對齊點的運算子模擬器、作為換行點，或被分組以防止其內部換行。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Underbar](../imathelement/underbar/)() | 在此元素底部設定橫條 |
...
| virtual void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | 將此 [IMathBlock](./) 的內容儲存為 MathML |
