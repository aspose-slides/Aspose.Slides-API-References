...
description: 具有控制字元屬性的 IMathElement
type: docs
weight: 14
url: /zh-hant/aspose.slides.mathtext/ihascontrolcharacterproperties/
---
## IHasControlCharacterProperties 類別

[IMathElement](../imathelement/) 具有 [Control](../../aspose.slides/control/) Character Properties
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，其中兩個 NaN 被視為相等，儘管根據 IEC 60559:1989，NaN 並不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，其中兩個 NaN 被視為相等，儘管根據 IEC 60559:1989，NaN 並不等於任何值，包括 NaN 本身。 |
