...
description: 指定一個位於表達式上方或下方的群組符號，通常用於突顯元素之間的關係
type: docs
weight: 885
...
指定一個位於表達式上方或下方的群組符號，通常用於突顯元素之間的關係
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) override | 使用此分子和指定的分母，以指定類型建立分數 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) override | 使用此分子和指定的分母，以指定類型建立分數 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)() override | 將數學元素包於括號中 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 使用此實例作為函式名稱，對參數呼叫函式 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::String](../../system/string/)) override | 使用此實例作為函式名稱，對參數呼叫函式 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() override | 基底參數 |
| char16_t [get_Character](./get_character/)() override | 群組字元預設值：U+23DF（底部大括號） |
| [MathTopBotPositions](../mathtopbotpositions/) [get_Position](./get_position/)() override | 群組字元的位置。預設：底部 |
| [MathTopBotPositions](../mathtopbotpositions/) [get_VerticalJustification](./get_verticaljustification/)() override | 群組字元的垂直對齊方式。指定物件相對於基線的對齊位置。例如，當群組字元位於物件上方時，VerticalJustification 為 Top 表示物件的頂部位於基線上；當設定為 Bottom 時，物件的底部位於基線上。預設：Position 為 Top 時垂直對齊為 Bottom，Position 為 Bottom 時垂直對齊為 Top。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | 使用群組字元（例如底部大括號或其他字元）將此元素放入群組中 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../mathelementbase/integral/)([MathIntegralTypes](../mathintegraltypes/)) override | 取得無限制的積分 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../mathelementbase/join/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 將數學元素結合並形成數學區塊 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../mathelementbase/join/)([System::String](../../system/string/)) override | 將數學文字結合並形成數學區塊 |
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述式的鎖定。直接呼叫或使用 [LockContext](../../system/lockcontext/) 哨兵物件。 |
|  [MathGroupingCharacter](./mathgroupingcharacter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 以預設的群組字元 U+23DF（底部大括號）初始化 [MathGroupingCharacter](./) 類別的新執行個體 |
|  [MathGroupingCharacter](./mathgroupingcharacter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | 初始化 [MathGroupingCharacter](./) 類別的新執行個體。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../mathelementbase/overbar/)() override | 在此元素的頂部設定一條線 |
...
| void [set_Character](./set_character/)(char16_t) override | 群組字元預設值：U+23DF（底部大括號） |
| void [set_Position](./set_position/)([MathTopBotPositions](../mathtopbotpositions/)) override | 群組字元的位置。預設：底部 |
| void [set_VerticalJustification](./set_verticaljustification/)([MathTopBotPositions](../mathtopbotpositions/)) override | 群組字元的垂直對齊方式。指定物件相對於基線的對齊位置。例如，當群組字元位於物件上方時，VerticalJustification 為 Top 表示物件的頂部位於基線上；當設定為 Bottom 時，物件的底部位於基線上。預設：Position 為 Top 時垂直對齊為 Bottom，Position 為 Bottom 時垂直對齊為 Top。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | 將此元素放入非可視盒（邏輯群組），用於將方程式或其他數學文字的組件進行分組。盒狀物件可以（例如）作為帶或不帶對齊點的運算子模擬器、作為換行點，或被分組以防止內部換行。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Underbar](../mathelementbase/underbar/)() override | 在此元素的底部設定一條線 |
