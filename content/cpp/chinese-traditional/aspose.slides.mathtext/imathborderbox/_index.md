...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 使用此實例作為參數，取得指定的函式，並傳入指定的額外參數 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) | 使用此實例作為參數，取得指定的函式，並傳入指定的額外參數 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)() | 將數學元素括於括號內 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 以此實例作為函式名稱，取得帶參數的函式 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | 以此實例作為函式名稱，取得帶參數的函式 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | 基礎參數 |
| virtual **bool** [get_HideBottom](./get_hidebottom/)() | 隱藏底部邊緣（預設為 false）- 指定邊框盒底部邊緣的隱藏或顯示狀態。 |
| virtual **bool** [get_HideLeft](./get_hideleft/)() | 隱藏左側邊緣（預設為 false）- 指定邊框盒左側邊緣的隱藏或顯示狀態。 |
| virtual **bool** [get_HideRight](./get_hideright/)() | 隱藏右側邊緣（預設為 false）- 指定邊框盒右側邊緣的隱藏或顯示狀態。 |
| virtual **bool** [get_HideTop](./get_hidetop/)() | 隱藏頂部邊緣（預設為 false）- 指定邊框盒頂部邊緣的隱藏或顯示狀態。 |
| virtual **bool** [get_StrikethroughBottomLeftToTopRight](./get_strikethroughbottomlefttotopright/)() | 斜線從左下到右上（預設為 false）。指定邊框盒左下角至右上角的刪除線的隱藏或顯示狀態。 |
| virtual **bool** [get_StrikethroughHorizontal](./get_strikethroughhorizontal/)() | 水平刪除線（預設為 false）- 指定水平刪除線的隱藏或顯示狀態。 |
| virtual **bool** [get_StrikethroughTopLeftToBottomRight](./get_strikethroughtoplefttobottomright/)() | 斜線從左上到右下（預設為 false）。指定邊框盒左上角至右下角的刪除線的隱藏或顯示狀態。 |
| virtual **bool** [get_StrikethroughVertical](./get_strikethroughvertical/)() | 垂直刪除線（預設為 false）- 指定垂直刪除線的隱藏或顯示狀態。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../imathelement/integral/)([MathIntegralTypes](../mathintegraltypes/)) | 取得積分（無上下限） |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../imathelement/overbar/)() | 在此元素上方設定條線 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 指定給定次方根的數學根號，根據提供的參數。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | 指定給定次方根的數學根號，根據提供的參數。 |
...
| virtual void [set_HideBottom](./set_hidebottom/)(**bool**) | 隱藏底部邊緣（預設為 false）- 指定邊框盒底部邊緣的隱藏或顯示狀態。 |
| virtual void [set_HideLeft](./set_hideleft/)(**bool**) | 隱藏左側邊緣（預設為 false）- 指定邊框盒左側邊緣的隱藏或顯示狀態。 |
| virtual void [set_HideRight](./set_hideright/)(**bool**) | 隱藏右側邊緣（預設為 false）- 指定邊框盒右側邊緣的隱藏或顯示狀態。 |
| virtual void [set_HideTop](./set_hidetop/)(**bool**) | 隱藏頂部邊緣（預設為 false）- 指定邊框盒頂部邊緣的隱藏或顯示狀態。 |
| virtual void [set_StrikethroughBottomLeftToTopRight](./set_strikethroughbottomlefttotopright/)(**bool**) | 斜線從左下到右上（預設為 false）。指定邊框盒左下角至右上角的刪除線的隱藏或顯示狀態。 |
| virtual void [set_StrikethroughHorizontal](./set_strikethroughhorizontal/)(**bool**) | 水平刪除線（預設為 false）- 指定水平刪除線的隱藏或顯示狀態。 |
| virtual void [set_StrikethroughTopLeftToBottomRight](./set_strikethroughtoplefttobottomright/)(**bool**) | 斜線從左上到右下（預設為 false）。指定邊框盒左上角至右下角的刪除線的隱藏或顯示狀態。 |
| virtual void [set_StrikethroughVertical](./set_strikethroughvertical/)(**bool**) | 垂直刪除線（預設為 false）- 指定垂直刪除線的隱藏或顯示狀態。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](./)\> [ToBorderBox](../imathelement/toborderbox/)() | 將此元素放入邊框盒中 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](./)\> [ToBorderBox](../imathelement/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | 將此元素放入邊框盒中 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | 將此元素放入非可視盒（邏輯分組），用於將方程式或其他數學文字的組件分組。此盒狀物件可（例如）作為具或不具對齊點的運算子模擬器，作為換行點，或分組以防止內部換行。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Underbar](../imathelement/underbar/)() | 在此元素底部設定條線 |
