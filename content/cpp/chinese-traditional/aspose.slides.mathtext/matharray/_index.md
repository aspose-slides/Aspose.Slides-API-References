...
description: 指定一個垂直的方程式或任何數學物件的陣列
type: docs
weight: 638
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../mathelementbase/accent/)(char16_t) override | 設定重音標記（此元素頂部的字元） |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 以此實例作為參數，使用指定的函式 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([System::String](../../system/string/)) override | 以此實例作為參數，使用指定的函式 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfOneArgument](../mathfunctionsofoneargument/)) override | 以此實例作為參數，使用指定的函式 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 以此實例作為參數，使用指定的函式，並使用指定的額外參數 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) override | 以此實例作為參數，使用指定的函式，並使用指定的額外參數 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) override | 以此分子與指定的分母，按照指定類型建立分數 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) override | 以此分子與指定的分母，按照指定類型建立分數 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使依 IEC 60559:1989，NaN 不等於任何值，甚至 NaN 本身也不等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使依 IEC 60559:1989，NaN 不等於任何值，甚至 NaN 本身也不等。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) override | 傳回陣列中指定索引的項目。唯讀 [Aspose::Slides::MathText::IMathElement](../imathelement/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() override | 陣列的項目集合 |
| [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() override | 指定陣列相對於周圍文字的對齊方式。陣列外的文字可與陣列物件的底部、頂部或中心對齊。預設值：Center |
| **bool** [get_MaximumDistribution](./get_maximumdistribution/)() override | 最大分佈：當為 true 時，陣列的間距會擴展至包含元素（頁面、欄位、儲存格等）的最大寬度。 |
| **bool** [get_ObjectDistribution](./get_objectdistribution/)() override | 物件分佈：當為 true 時，陣列的內容會間隔至陣列物件的最大寬度。 |
| **uint32_t** [get_RowSpacing](./get_rowspacing/)() override | 陣列列之間的間距。僅在 RowSpacingRule 設為 3 時使用，此時計量單位為點；若為 Multiple，則計量單位為半行。預設值：0 |
| [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() override | 陣列元素之間的垂直間距類型。預設值：SingleLineGap |
...
|   [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | 建立數學陣列並將指定元素放入其中 |
|   [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>\>\>) | 建立數學陣列並將指定元素放入其中 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../mathelementbase/overbar/)() override | 在此元素之上設定橫條 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | 從指定參數取得給定次方的數學根。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | 從指定參數取得給定次方的數學根。 |
...
| void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) override | 指定陣列相對於周圍文字的對齊方式。陣列外的文字可與陣列物件的底部、頂部或中心對齊。預設值：Center |
| void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) override | 最大分佈：當為 true 時，陣列的間距會擴展至包含元素（頁面、欄位、儲存格等）的最大寬度。 |
| void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) override | 物件分佈：當為 true 時，陣列的內容會間隔至陣列物件的最大寬度。 |
| void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) override | 陣列列之間的間距。僅在 RowSpacingRule 設為 3 時使用，此時計量單位為點；若為 Multiple，則計量單位為半行。預設值：0 |
| void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) override | 陣列元素之間的垂直間距類型。預設值：SingleLineGap |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | 將此元素放入非可視盒（邏輯分組），用於將方程式或其他數學文字的組件分組。此盒狀物件可（例如）作為具有或不具有對齊點的運算子模擬器，作為換行點，或被分組以防止內部換行。 |
