...
description: 在事先不知道字串數量時，將字串串接在一起。
type: docs
weight: 1
url: /zh-hant/system.xml.xsl.runtime/stringconcat/
---
## StringConcat 類別
...
| 方法 | 描述 |
| --- | --- |
| void [Clear](./clear/)() | 清除結果字串。 |
| void [Concat](./concat/)(const [String](../../system/string/)\&) | 將新字串串接至結果。 |
...
| [String](../../system/string/) [get_Delimiter](./get_delimiter/)() | 傳回用於分隔串接字串的字串。 |
...
| [String](../../system/string/) [GetResult](./getresult/)() | 傳回結果字串。 |
...
| void [set_Delimiter](./set_delimiter/)(const [String](../../system/string/)\&) | 設定用於分隔串接字串的字串。 |
...
|  [StringConcat](./stringconcat/)() | 預設建構子。 |
