...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | 回傳嵌入式 OLE 物件的檔案資料，只讀 **uint8_t**[]。 |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | 回傳目前嵌入式 OLE 物件的檔案副檔名，只讀 [System::String](../../system/string/)。 |
...
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)() | 為 OLE 物件建立新的嵌入式資料資訊。 |
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | 建立 OLE 物件之嵌入式資料資訊的新實例。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | 相當於 C# [Object.ToString()](../../system/object/tostring/) 方法。啟用自訂物件轉換為字串的功能。 |
...
* 類別 [IOleEmbeddedDataInfo](../../aspose.slides/ioleembeddeddatainfo/)
* 命名空間 [Aspose::Slides::DOM::Ole](../)
* 程式庫 [Aspose.Slides](../../)