...
description: "所有 COM 互操作例外和結構化例外處理 (SEH) 例外的基礎例外類型。切勿手動建立此類別的實例。請改用 ExternalException 類別。切勿將 ExternalException 類別的實例包裹於 System::SmartPtr。"
type: docs
weight: 1
url: /zh-hant/system.runtime.interopservices/details_externalexception/
---
## Details_ExternalException 類別


所有 COM 互操作例外和結構化例外處理 (SEH) 例外的基礎例外類型。切勿手動建立此類別的實例。請改用 ExternalException 類別。切勿將 ExternalException 類別的實例包裹至 [System::SmartPtr](../../system/smartptr/)。
...
| virtual **int32_t** [get_ErrorCode](../../system/details_exceptionwitherrorcode/get_errorcode/)() const | 取得錯誤的 HRESULT。 |
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 傳回 32 位元整數值，該值為與目前物件所表示之例外相關聯的 HRESULT 代碼。 |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | 取得物件的實際類型。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 實作 [what()](../../system/details_exception/what/) 方法，由 [ExceptionWrapper](../../system/exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，衍生類別仍可使用受保護/私有成員來實作其邏輯。將此方法實作移至 [ExceptionWrapper](../../system/exceptionwrapper/) 可能會破壞該邏輯。 |
| virtual  [~Object](../../system/object/~object/)() | 銷毀物件。釋放所有內部資料結構。 |

## 參見

* 類別 [Details_ExceptionWithErrorCode](../../system/details_exceptionwitherrorcode/)
