...
description: IEnumerable 是所有可列舉的非泛型集合的基礎介面。
type: docs
weight: 53
url: /zh-hant/system.collections/ienumerable/
---
## IEnumerable 類別

[IEnumerable](./) 是所有可列舉的非泛型集合的基礎介面。
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | 傳回可遍歷集合的列舉器。 |
