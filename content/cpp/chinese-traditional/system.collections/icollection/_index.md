...
description: 定義非泛型集合介面。
type: docs
weight: 40
url: /zh-hant/system.collections/icollection/
---
## ICollection 類別
...
| virtual int [get_Count](./get_count/)() const | 取得集合中的元素數量。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](../ienumerable/getenumerator/)() | 傳回用於遍歷集合的列舉器。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 個範本參數設定為弱指標（而非共享）。允許在容器中將指標切換為弱模式。 |
