...
description: IList 代表一個非泛型的物件集合，可透過索引個別存取。
type: docs
weight: 118
url: /zh-hant/system.collections/ilist/
---
## IList 類別
...
| Method | Description |
| --- | --- |
| virtual int [Add](./add/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | 將項目新增至列表的末端。 |
| virtual void [Clear](./clear/)() | 從列表中移除所有項目。 |
| virtual **bool** [Contains](./contains/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | 檢查項目是否在列表中。 |
...
| virtual **bool** [get_IsFixedSize](./get_isfixedsize/)() const | 取得指示列表是否具有固定大小的值。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(int, int) const | 取得指定索引處的項目。 |
| virtual int [IndexOf](./indexof/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | 取得指定項目的第一個索引。 |
| virtual void [Insert](./insert/)(int, [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | 在指定索引處將項目插入列表。 |
...
| virtual void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | 從列表中移除指定項目的第一個實例。 |
| virtual void [RemoveAt](./removeat/)(int) | 從列表中移除指定索引處的項目。 |
