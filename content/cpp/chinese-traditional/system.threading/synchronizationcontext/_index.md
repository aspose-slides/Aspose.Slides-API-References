...
description: 提供在各種同步操作之間傳播同步上下文的基本功能。
type: docs
weight: 196
url: /zh-hant/system.threading/synchronizationcontext/
---
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | 取得目前執行緒的同步上下文。 |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | 非同步執行回呼函式。 |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | 同步執行回呼函式。 |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | 設定目前執行緒的同步上下文。 |
...
|  [SynchronizationContext](./synchronizationcontext/)() | 建立 [SynchronizationContext](./) 的新實例。 |
...
此類別可在執行緒之間傳播同步上下文，並用於將回呼或呼叫轉發至適當的執行緒或同步上下文。虛擬實作。 
