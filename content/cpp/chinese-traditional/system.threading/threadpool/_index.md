...
description: 執行緒池 API，允許將工作推入佇列，由工作執行緒池讀取。這是一種靜態型別，沒有實例服務。絕不要以任何方式建立它的實例。
type: docs
weight: 222
url: /zh-hant/system.threading/threadpool/
---
## ThreadPool 類別


[Thread](../thread/) 池 API 允許將工作推入佇列，由工作執行緒池讀取。這是一種靜態型別，沒有實例服務。絕不要以任何方式建立它的實例。
...
| static void [GetAvailableThreads](./getavailablethreads/)(int\&, int\&) | 取得可用執行緒的數量。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。啟用自訂物件的雜湊。 |
| static [ThreadPoolImpl](../threadpoolimpl/)\& [GetInstance](./getinstance/)() | 實作實例，保存工作清單與其他參數。 |
| static void [GetMaxThreads](./getmaxthreads/)(int\&, int\&) | 取得最大同時執行緒數量。 |
| static void [GetMinThreads](./getminthreads/)(int\&, int\&) | 取得池所建立的最小執行緒數量。 |
...
| static void [JoinAllThreads](./joinallthreads/)() | 加入所有擁有的執行緒。無限等待。 |
...
| void [operator=](./operator_equal/)(const [ThreadPool](./)\&) | 不進行複製。 |
...
| static **bool** [QueueUserWorkItem](./queueuserworkitem/)([WaitCallback](../waitcallback/)) | 將工作項目放入佇列，該項目以無參數回呼方式呈現。 |
| static **bool** [QueueUserWorkItem](./queueuserworkitem/)([WaitCallback](../waitcallback/), const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | 將工作項目放入佇列，該項目以無參數回呼方式呈現。 |
...
| static **bool** [SetMaxThreads](./setmaxthreads/)(int, int) | 設定池擁有的執行緒數量。 |
| static **bool** [SetMinThreads](./setminthreads/)(int, int) | 設定池擁有的最小執行緒數量。 |
...
|  [ThreadPool](./threadpool/)(const [ThreadPool](./)\&) | 不進行複製。 |
