...
type: docs
weight: 79
url: /zh-hant/system.threading/details_threadabortexception/
---
## Details_ThreadAbortException 類別
...
| virtual const char * [what](../../system/details_exception/what/)() const | 實作由 [ExceptionWrapper](../../system/exceptionwrapper/) 類別呼叫的 [what()](../../system/details_exception/what/) 方法。儘管此類別未繼承自 std::exception，但衍生類別仍可使用受保護/私有成員來實作其邏輯。將此方法的實作移至 [ExceptionWrapper](../../system/exceptionwrapper/) 可能會破壞該邏輯。 |
