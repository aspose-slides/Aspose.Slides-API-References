...
description: 一個可用於觸發取消通知的取消代幣來源。
type: docs
weight: 40
url: /zh-hant/system.threading/cancellationtokensource/
---
...
| 方法 | 說明 |
| --- | --- |
| void [Cancel](./cancel/)() | 傳達取消請求。 |
| [CancellationTokenSource](./cancellationtokensource/)() | 建構新的 [CancellationTokenSource](./)。 |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | 建立一個連結的代幣來源，當任一提供的代幣被取消時即取消。 |
| void [Dispose](./dispose/)() override | 釋放 [CancellationTokenSource](./) 使用的所有資源。 |
...
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | 取得是否已請求取消。 |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | 取得與此來源關聯的取消代幣。 |
