...
type: docs
weight: 66
url: /zh-hant/system.threading/details_synchronizationlockexception/
---
## Details_SynchronizationLockException 類別
...
| virtual const char * [what](../../system/details_exception/what/)() const | 實作 [what()](../../system/details_exception/what/) 方法，該方法被 [ExceptionWrapper](../../system/exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，衍生類別仍可使用受保護/私有成員來實作其邏輯。將此方法實作移至 [ExceptionWrapper](../../system/exceptionwrapper/) 可能會破壞該邏輯。 |
