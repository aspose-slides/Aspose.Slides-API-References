...
description: "一組儲存在具備相互關聯之資料表中的資料。此類別的物件只能透過 System::MakeObject() 函式來配置。切勿在堆疊上或使用 new 運算子建立此類型的實例，否則會導致執行時錯誤或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 92
url: /zh-hant/system.data/dataset/
---
## DataSet 類別
...
| [System::SharedPtr](../../system/sharedptr/)\<[DataRelationCollection](../datarelationcollection/)\> [get_Relations](./get_relations/)() | 取得資料集內資料表之關聯。 |
| [System::SharedPtr](../../system/sharedptr/)\<[DataTableCollection](../datatablecollection/)\> [get_Tables](./get_tables/)() | RTTI 資訊。 |
...
| void [Unlock](../../system/object/unlock/)() | 实作 C# lock() 陳述式的解鎖。直接呼叫或使用 [LockContext](../../system/lockcontext/) 守衛物件。 |
