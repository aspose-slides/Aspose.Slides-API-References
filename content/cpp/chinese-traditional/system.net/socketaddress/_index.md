...
description: "用於儲存 EndPoint 類別實例的序列化資訊。此類別的物件只能使用 System::MakeObject() 函式進行分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 443
url: /zh-hant/system.net/socketaddress/
---
## SocketAddress 類別

用於儲存 [EndPoint](../endpoint/) 類別實例的序列化資訊。此類別的物件只能使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為這會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
...
| [Sockets::AddressFamily](../../system.net.sockets/addressfamily/) [get_Family](./get_family/)() | 傳回位址族群。 |
| **int32_t** [get_Size](./get_size/)() | 傳回底層緩衝區大小。 |
...
| **uint8_t** [idx_get](./idx_get/)(**int32_t**) | 取得指定索引處底層緩衝區的值。 |
| void [idx_set](./idx_set/)(**int32_t**, **uint8_t**) | 設定指定索引處底層緩衝區的值。 |
...
|  [SocketAddress](./socketaddress/)([Sockets::AddressFamily](../../system.net.sockets/addressfamily/)) | 建立新實例。 |
|  [SocketAddress](./socketaddress/)([Sockets::AddressFamily](../../system.net.sockets/addressfamily/), **int32_t**) | 建立新實例。 |
