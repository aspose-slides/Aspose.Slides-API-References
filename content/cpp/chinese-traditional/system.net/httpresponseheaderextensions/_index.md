...
description: 包含用於處理 HttpResponseHeader 列舉值的實用方法。
type: docs
weight: 235
url: /zh-hant/system.net/httpresponseheaderextensions/
---
## HttpResponseHeaderExtensions 類別

包含用於處理 HttpResponseHeader 列舉值的實用方法。
...
| static [String](../../system/string/) [GetName](./getname/)([HttpResponseHeader](../httpresponseheader/)) | 傳回指定標頭的名稱。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際類型。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
|  [HttpResponseHeaderExtensions](./httpresponseheaderextensions/)() | 已刪除的預設建構子。 |
