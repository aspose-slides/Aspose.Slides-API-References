...
description: "包含應用程式用於連接服務的資訊。本類別的物件應僅使用 System::MakeObject() 函式進行配置。切勿在堆疊上或使用 operator new 建立此類型的實例，因為這會導致執行時錯誤和/或斷言失敗。應始終將本類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 118
url: /zh-hant/system.net/dnsendpoint/
---
## DnsEndPoint 類別

包含應用程式用於連接服務的資訊。此類別的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
...
| 方法 | 說明 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[EndPoint](../endpoint/)\> [Create](../endpoint/create/)([System::SharedPtr](../../system/sharedptr/)\<[SocketAddress](../socketaddress/)\>) | 使用指定的 socket 位址建立 [EndPoint](../endpoint/) 類別的新執行個體。 |
|  [DnsEndPoint](./dnsendpoint/)([String](../../system/string/), **int32_t**) | 建立新執行個體。 |
|  [DnsEndPoint](./dnsendpoint/)([String](../../system/string/), **int32_t**, [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/)) | 建立新執行個體。 |
...
| [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/) [get_AddressFamily](./get_addressfamily/)() override | 傳回目前執行個體所屬的位址族群。 |
| [String](../../system/string/) [get_Host](./get_host/)() | 傳回主機名稱。 |
| **int32_t** [get_Port](./get_port/)() | 傳回埠號。 |
...
| virtual [ImplPtr](../endpoint/implptr/) [GetImpl](../endpoint/getimpl/)() const | 傳回指向實作的指標。 |
