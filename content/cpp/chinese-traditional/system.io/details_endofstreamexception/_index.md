...
type: docs
weight: 157
url: /zh-hant/system.io/details_endofstreamexception/
---
## Details_EndOfStreamException 類別
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 傳回 32 位元整數值，為與目前物件所代表之例外相關聯的 HRESULT 代碼。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 依指定值降低共享參照計數。 |
