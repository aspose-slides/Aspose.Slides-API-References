...
type: docs
weight: 144
url: /zh-hant/system.io/details_drivenotfoundexception/
---
## Details_DriveNotFoundException 類別
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 回傳 32 位元整數值，作為與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
