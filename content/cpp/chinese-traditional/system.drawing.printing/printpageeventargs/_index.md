...
description: "提供 PrintPage 事件的資料。此類別的物件只能使用 System::MakeObject() 函式分配。絕不可在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 105
url: /zh-hant/system.drawing.printing/printpageeventargs/
---
## PrintPageEventArgs 類別

提供 PrintPage 事件的資料。此類別的物件只能使用 [System::MakeObject()](../../system/makeobject/) 函式分配。千萬不要在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標作為參數傳遞給函式。
...
|  [EventArgs](../../system/eventargs/eventargs/)() | 建構子。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| [SharedPtr](../../system/sharedptr/)\<[Graphics](../../system.drawing/graphics/)\> [get_Graphics](./get_graphics/)() | 未實作。 |
| **bool** [get_HasMorePages](./get_hasmorepages/)() | 未實作。 |
| [SharedPtr](../../system/sharedptr/)\<[PageSettings](../pagesettings/)\> [get_PageSettings](./get_pagesettings/)() | 未實作。 |
...
|  [PrintPageEventArgs](./printpageeventargs/)(const [SharedPtr](../../system/sharedptr/)\<[Graphics](../../system.drawing/graphics/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[Rectangle](../../system.drawing/rectangle/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[Rectangle](../../system.drawing/rectangle/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[PageSettings](../pagesettings/)\>\&) | 建立 [PrintPageEventArgs](./) 類別的新實例。 |
...
| void [set_HasMorePages](./set_hasmorepages/)(**bool**) | 未實作。 |
...
| 欄位 | 說明 |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | 表示「空」[EventArgs](../../system/eventargs/) 共享指標（空指標）的靜態成員。 |
