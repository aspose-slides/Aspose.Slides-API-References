...
description: "表示列印頁面的設定。此類別的物件只能使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝為 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 14
url: /zh-hant/system.drawing.printing/pagesettings/
---
## PageSettings 類別

表示列印頁面的設定。此類別的物件只能使用 [System::MakeObject()](../../system/makeobject/) 函式配置。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝為 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
...
| [Rectangle](../../system.drawing/rectangle/) [get_Bounds](./get_bounds/)() | 未實作。 |
| **float** [get_HardMarginX](./get_hardmarginx/)() | 未實作。 |
| **float** [get_HardMarginY](./get_hardmarginy/)() | 未實作。 |
| [SharedPtr](../../system/sharedptr/)\<[PrinterResolution](../printerresolution/)\> [get_PrinterResolution](./get_printerresolution/)() | 未實作。 |
...
|  [PageSettings](./pagesettings/)() | 建立 [PageSettings](./) 類別的新實例。 |
|  [PageSettings](./pagesettings/)(const [SharedPtr](../../system/sharedptr/)\<[PrinterSettings](../printersettings/)\>\&) | 建立 [PageSettings](./) 類別的新實例。 |
