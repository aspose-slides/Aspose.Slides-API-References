...
description: "用於回應除錯與追蹤資訊的介面。此類別的物件只能使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 92
url: /zh-hant/system.diagnostics/tracelistener/
---
## TraceListener 類別

介面，用於回應除錯與追蹤資訊。此類別的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
...
| virtual void [Fail](./fail/)([System::String](../../system/string/)) | 將失敗訊息寫入偵錯器。 |
| virtual void [Fail](./fail/)([System::String](../../system/string/), [System::String](../../system/string/)) | 將失敗訊息寫入偵錯器。 |
...
| virtual void [Write](./write/)([System::String](../../system/string/)) | RTTI 資訊。 |
| virtual void [WriteLine](./writeline/)([System::String](../../system/string/)) | 將行寫入偵錯器。 |
