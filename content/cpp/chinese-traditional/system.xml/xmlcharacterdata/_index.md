...
description: 提供供多個類別使用的文字操作方法。
type: docs
weight: 118
url: /zh-hant/system.xml/xmlcharacterdata/
---
## XmlCharacterData 類別
...
| 方法 | 描述 |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | 將指定的節點加入此節點的子節點清單末端。 |
| virtual void [AppendData](./appenddata/)([String](../../system/string/)) | 將指定的字串附加至此節點的字元資料末端。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 取得指向集合中第一個元素（若有）的迭代器。此迭代器無法用於變更所參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的副本物件。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | 在衍生類別中被覆寫時，建立此節點的副本。 |
...
| virtual void [DeleteData](./deletedata/)(**int32_t**, **int32_t**) | 從節點中移除一段字元。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 取得指向集合中最後一個元素之後的位置（若有）的迭代器。此迭代器無法用於變更所參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的副本物件。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點數比較，將兩個 NaN 視為相等，儘管根據 IEC 60559:1989，NaN 不等於任何值，甚至包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點數比較，將兩個 NaN 視為相等，儘管根據 IEC 60559:1989，NaN 不等於任何值，甚至包括 NaN 本身。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttributeCollection](../xmlattributecollection/)\> [get_Attributes](../xmlnode/get_attributes/)() | 傳回一個包含此節點屬性的 [XmlAttributeCollection](../xmlattributecollection/)。 |
...
| virtual [String](../../system/string/) [get_Data](./get_data/)() | 傳回節點的資料。 |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | 傳回節點及其所有子節點的串接值。 |
...
| virtual **int32_t** [get_Length](./get_length/)() | 傳回資料的長度（以字元為單位）。 |
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | 在衍生類別中被覆寫時，傳回節點的本地名稱。 |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | 在衍生類別中被覆寫時，傳回節點的限定名稱。 |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | 在衍生類別中被覆寫時，傳回目前節點的類型。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | 傳回因模式驗證而指派給此節點的後驗證資訊集。 |
| [String](../../system/string/) [get_Value](./get_value/)() override | 傳回節點的值。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | 傳回遍歷目前節點子節點的列舉器。 |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | 查找目前節點作用域內給定前置詞最近的 **xmlns** 宣告，並傳回該宣告中的命名空間 URI。 |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | 查找目前節點作用域內給定命名空間 URI 最近的 **xmlns** 宣告，並傳回該宣告中定義的前置詞。 |
...
| virtual void [InsertData](./insertdata/)(**int32_t**, [String](../../system/string/)) | 在指定的字元偏移處插入指定的字串。 |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | 傳回序列中元素的數目（透過直接計數計算）。 |
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | 傳回符合指定條件的序列元素數目。 |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | 傳回序列的第一個元素；如果序列為空，則回傳預設值。 |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | 傳回序列的最後一個元素；如果序列為空，則回傳預設值。 |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 對泛型序列的每個元素呼叫轉換函式，並傳回產生的最大值。 |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 對泛型序列的每個元素呼叫轉換函式，並傳回產生的最小值。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | 依 keySelector 所選擇的鍵值，以升序排序序列的元素。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | 依 keySelector 所選擇的鍵值，以降序排序序列的元素。 |
...
| virtual void [Normalize](../xmlnode/normalize/)() | 將此 [XmlNode](../xmlnode/) 下子樹的所有 [XmlText](../xmltext/) 節點整理為「正常」形式，使僅有標記（即標籤、註解、處理指令、CDATA 區段與實體參照）分隔 [XmlText](../xmltext/) 節點，也就是不存在相鄰的 [XmlText](../xmltext/) 節點。 |
|  [Object](../../system/object/object/)() | 建立物件。初始化所有內部資料結構。 |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 複製建構子。實際上不複製任何內容，只是初始化新物件並允許子類別進行複製建構。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 指派運算子。實際上不複製任何內容，只是初始化新物件並允許子類別進行複製建構。 |
...
| virtual void [ReplaceData](./replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | 以指定的字串取代從指定偏移開始的指定數量字元。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | 選取符合 [XPath](../../system.xml.xpath/) 表達式的節點清單。[XPath](../../system.xml.xpath/) 表達式中出現的任何前置詞皆使用提供的 [XmlNamespaceManager](../xmlnamespacemanager/) 解析。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | 選取第一個符合 [XPath](../../system.xml.xpath/) 表達式的 [XmlNode](../xmlnode/)。[XPath](../../system.xml.xpath/) 表達式中出現的任何前置詞皆使用提供的 [XmlNamespaceManager](../xmlnamespacemanager/) 解析。 |
| virtual void [set_Data](./set_data/)([String](../../system/string/)) | 設定節點的資料。 |
...
| virtual [String](../../system/string/) [Substring](./substring/)(**int32_t**, **int32_t**) | 從指定範圍取得完整字串的子字串。 |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | 在衍生類別中被覆寫時，將節點的所有子節點儲存至指定的 [XmlWriter](../xmlwriter/)。 |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | 在衍生類別中被覆寫時，將目前節點儲存至指定的 [XmlWriter](../xmlwriter/)。 |
