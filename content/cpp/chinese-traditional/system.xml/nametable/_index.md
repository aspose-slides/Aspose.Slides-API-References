...
description: 實作單執行緒的 XmlNameTable。
type: docs
weight: 66
url: /zh-hant/system.xml/nametable/
---
## NameTable 類別
...
| 方法 | 說明 |
| --- | --- |
| const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) override | 將指定的字串原子化並加入到 [NameTable](./)。 |
| const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | 將指定的字串原子化並加入到 [NameTable](./)。 |
...
| const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) override | 返回具有指定值的原子化字串。 |
| const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | 返回包含於給定陣列中指定字符範圍相同字符的原子化字串。 |
...
|  [NameTable](./nametable/)() | 初始化 [NameTable](./) 類別的新執行個體。 |
