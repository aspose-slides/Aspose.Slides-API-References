...
description: 提供一個介面，使類別能夠返回行號與位置資訊。
type: docs
weight: 40
url: /zh-hant/system.xml/ixmllineinfo/
---
## IXmlLineInfo 類別


提供一個介面，使類別能夠回傳行號與位置資訊。
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | 傳回目前的行號。 |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | 傳回目前的行位置。 |
...
| virtual **bool** [HasLineInfo](./haslineinfo/)() | 傳回指示類別是否能提供行資訊的值。 |
