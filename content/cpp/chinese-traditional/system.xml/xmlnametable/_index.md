...
description: 原子化字串物件的表格。
type: docs
weight: 313
url: /zh-hant/system.xml/xmlnametable/
---
## XmlNameTable 類別
...
| 方法 | 說明 |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | 在衍生類別中覆寫時，將指定的字串原子化並加入 [XmlNameTable](./)。 |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | 在衍生類別中覆寫時，將指定的字串原子化並加入 [XmlNameTable](./)。 |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | 在衍生類別中覆寫時，取得包含給定陣列中指定字元範圍相同字元的原子化字串。 |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | 在衍生類別中覆寫時，取得與指定字串具有相同值的原子化字串。 |
