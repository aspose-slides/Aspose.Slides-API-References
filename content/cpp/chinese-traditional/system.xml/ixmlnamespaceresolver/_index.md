...
description: 提供對一組前置詞與命名空間對映的唯讀存取。
type: docs
weight: 53
url: /zh-hant/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver 類別

提供對一組前置詞與命名空間對映的唯讀存取。
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](./getnamespacesinscope/)([XmlNamespaceScope](../xmlnamespacescope/)) | 傳回目前範圍內已定義的前置詞-命名空間對映集合。 |
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | 傳回對應於指定前置詞的命名空間 URI。 |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | 傳回對應於指定命名空間 URI 的前置詞。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將共享參考計數器減少指定的數值。 |
