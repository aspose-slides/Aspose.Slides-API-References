...
description: 定義一組 XmlDocument 物件的上下文。
type: docs
weight: 261
url: /zh-hant/system.xml/xmlimplementation/
---
## XmlImplementation 類別
...
| 方法 | 說明 |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [CreateDocument](./createdocument/)() | 建立一個新的 [XmlDocument](../xmldocument/)。 |
...
| **bool** [HasFeature](./hasfeature/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | 測試 Document [Object](../../system/object/) Model (DOM) 實作是否支援特定功能。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷貝建構子。實際上並不複製任何東西，只是初始化新物件並允許子類別的拷貝建構。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 賦值運算子。實際上並不複製任何東西，只是初始化新物件並允許子類別的拷貝建構。 |
...
|  [XmlImplementation](./xmlimplementation/)() | 初始化 [XmlImplementation](./) 類別的新執行個體。 |
|  [XmlImplementation](./xmlimplementation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | 使用指定的 [XmlNameTable](../xmlnametable/) 初始化 [XmlImplementation](./) 類別的新執行個體。 |
...
此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式分配。絕不要在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標將其作為參數傳遞給函式。
