...
description: 傳回有關最後一個例外的詳細資訊。
type: docs
weight: 1
url: /zh-hant/system.xml/details_xmlexception/
---
## Details_XmlException 類別
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 傳回 32 位元整數值，該值是與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | 傳回指出錯誤發生位置的行號。行號從 1 開始。 |
| **int32_t** [get_LinePosition](./get_lineposition/)() | 傳回指出錯誤發生位置的行位置。行位置從 1 開始。 |
| [String](../../system/string/) [get_Message](./get_message/)() const override | 傳回描述目前例外的訊息。 |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | 傳回 XML 檔案的位置。 |
