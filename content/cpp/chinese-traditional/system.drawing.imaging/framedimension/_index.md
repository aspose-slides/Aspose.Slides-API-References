...
description: "提供取得影像框架尺寸的屬性。此類別的物件應僅透過 System::MakeObject() 函式來配置。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並以該指標作為參數傳遞給函式。"
type: docs
weight: 92
url: /zh-hant/system.drawing.imaging/framedimension/
---
## FrameDimension 類別
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([FrameDimensionPtr](../framedimensionptr/)) | 確定指定的 [FrameDimension](./) 物件是否等同於目前的物件。 |
...
|  [FrameDimension](./framedimension/)(const [System::Guid](../../system/guid/)\&) | 建構一個新的 [FrameDimension](./) 物件，並以指定的 GUID 進行初始化。 |
| [System::Guid](../../system/guid/) [get_Guid](./get_guid/)() const | 傳回與目前物件關聯的 GUID。 |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Page](./get_page/)() | 傳回頁面的尺寸。 |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Resolution](./get_resolution/)() | 傳回解析度的尺寸。 |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Time](./get_time/)() | 傳回時間的尺寸。 |
