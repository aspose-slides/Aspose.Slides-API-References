...
description: "提供有關影像編解碼器的資訊。此類別的物件應僅使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為這會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 118
url: /zh-hant/system.drawing.imaging/imagecodecinfo/
---
## ImageCodecInfo 類別
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 比較參考類型物件，以 C# 風格。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 比較值類型物件，以 C# 風格。 |
...
| [Guid](../../system/guid/) [get_FormatID](./get_formatid/)() const | 傳回與目前物件所代表之編解碼器格式相關聯的 GUID。 |
| [System::String](../../system/string/) [get_MimeType](./get_mimetype/)() | 傳回由目前物件所代表之編解碼器的多用途網際網路郵件擴充 (MIME) 類型。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法的類似物。啟用自訂物件的雜湊。 |
| static [System::ArrayPtr](../../system/arrayptr/)\<[ImageCodecInfoPtr](../imagecodecinfoptr/)\> [GetImageDecoders](./getimagedecoders/)() | 傳回表示支援之影像解碼器的 [ImageCodecInfo](./) 物件陣列。 |
| static [System::ArrayPtr](../../system/arrayptr/)\<[ImageCodecInfoPtr](../imagecodecinfoptr/)\> [GetImageEncoders](./getimageencoders/)() | 傳回表示支援之影像編碼器的 [ImageCodecInfo](./) 物件陣列。 |
...
| void [set_FormatID](./set_formatid/)(const [Guid](../../system/guid/)\&) | 設定與目前物件所代表之編解碼器格式相關聯的 GUID。 |
