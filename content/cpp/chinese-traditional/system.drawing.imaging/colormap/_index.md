...
description: "表示一個用於轉換顏色的映射。此類的物件應僅使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 System::SmartPtr 指標，並使用此指標將其作為參數傳遞給函式。"
type: docs
weight: 14
url: /zh-hant/system.drawing.imaging/colormap/
---
## ColorMap 類別


表示一個用於轉換顏色的映射。此類的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標將其作為參數傳遞給函式。
...
| [Color](../../system.drawing/color/) [get_NewColor](./get_newcolor/)() const | 傳回代表要轉換至之色彩的新 [Color](../../system.drawing/color/) 物件。 |
| [Color](../../system.drawing/color/) [get_OldColor](./get_oldcolor/)() const | 傳回代表待轉換之色彩的舊 [Color](../../system.drawing/color/) 物件。 |
...
| void [set_NewColor](./set_newcolor/)(const [Color](../../system.drawing/color/)\&) | 設定代表要轉換至之色彩的新 [Color](../../system.drawing/color/) 物件。 |
| void [set_OldColor](./set_oldcolor/)(const [Color](../../system.drawing/color/)\&) | 設定代表待轉換之色彩的舊 [Color](../../system.drawing/color/) 物件。 |
