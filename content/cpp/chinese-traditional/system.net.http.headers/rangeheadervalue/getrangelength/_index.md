...
description: 將傳入的字串從指定索引轉換為 RangeHeaderValue 類別的實例。
type: docs
weight: 118
url: /zh-hant/system.net.http.headers/rangeheadervalue/getrangelength/
---
## RangeHeaderValue::GetRangeLength(String, int32_t, System::SharedPtr\<Object\>\&) 方法

將傳入的字串從指定索引轉換為 [RangeHeaderValue](../) 類別的實例。
