...
description: "表示在 'Range' 標頭的值中，一段位元組的範圍。此類別的物件只能使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用此指標作為參數傳遞給函式。"
type: docs
weight: 261
url: /zh-hant/system.net.http.headers/rangeitemheadervalue/
---
## RangeItemHeaderValue 類別

表示在「[Range](../../system/range/)」標頭的值中，一段位元組的範圍。此類別的物件只能使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標作為參數傳遞給函式。
...
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_From](./get_from/)() | 回傳資料傳送必須開始的位置。 |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_To](./get_to/)() | 回傳資料傳送必須停止的位置。 |
...
| static **int32_t** [GetRangeItemLength](./getrangeitemlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[RangeItemHeaderValue](./)\>\&) | 將傳入的字串從指定索引轉換為 [RangeItemHeaderValue](./) 類別的實例。 |
| static **int32_t** [GetRangeItemListLength](./getrangeitemlistlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::SharedPtr](../../system/sharedptr/)\<[RangeItemHeaderValue](./)\>\>\>) | 將傳入的字串從指定位置轉換為 RangeItemHeaderValue-class 實例的集合。 |
...
|  [RangeItemHeaderValue](./rangeitemheadervalue/)([Nullable](../../system/nullable/)\<**int64_t**\>, [Nullable](../../system/nullable/)\<**int64_t**\>) | 建構新的實例。 |
