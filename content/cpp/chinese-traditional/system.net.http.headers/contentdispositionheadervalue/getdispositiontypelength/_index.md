...
description: 將傳入的字串從指定索引位置轉換為 ContentDispositionHeaderValue 類別的實例。
type: docs
weight: 300
url: /zh-hant/system.net.http.headers/contentdispositionheadervalue/getdispositiontypelength/
---
## ContentDispositionHeaderValue::GetDispositionTypeLength(String, int32_t, System::SharedPtr\<Object\>\&) 方法


將傳入的字串從指定索引位置轉換為 [ContentDispositionHeaderValue](../) 類別的實例。
...
* 類別 [ContentDispositionHeaderValue](../)
