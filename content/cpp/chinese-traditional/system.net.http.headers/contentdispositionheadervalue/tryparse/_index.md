...
description: 嘗試將傳入的字串轉換為 ContentDispositionHeaderValue 類別的實例。
type: docs
weight: 287
url: /zh-hant/system.net.http.headers/contentdispositionheadervalue/tryparse/
---
## ContentDispositionHeaderValue::TryParse(String, System::SharedPtr\<ContentDispositionHeaderValue\>\&) 方法

嘗試將傳入的字串轉換為 [ContentDispositionHeaderValue](../) 類別的實例。
...
| parsedValue | [System::SharedPtr](../../../system/sharedptr/)\<[ContentDispositionHeaderValue](../)\>\& | 已解析物件將被指派的實例。 |
