...
description: 將傳入的字串從指定的索引轉換為 ProductHeaderValue 類別的實例。
type: docs
weight: 105
url: /zh-hant/system.net.http.headers/productheadervalue/getproductlength/
---
## ProductHeaderValue::GetProductLength(String, int32_t, System::SharedPtr\<ProductHeaderValue\>\&) 方法

將傳入的字串從指定的索引轉換為 [ProductHeaderValue](../) 類別的實例。
...
| parsedValue | [System::SharedPtr](../../../system/sharedptr/)\<[ProductHeaderValue](../)\>\& | 指派已解析物件的實例。 |
