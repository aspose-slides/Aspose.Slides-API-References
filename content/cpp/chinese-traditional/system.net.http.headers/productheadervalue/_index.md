...
description: "表示在 'User-Agent' 標頭值中的產品代幣。此類別的物件只能使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此型別的實例，否則會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用此指標將其作為參數傳遞給函式。"
type: docs
weight: 209
url: /zh-hant/system.net.http.headers/productheadervalue/
---
## ProductHeaderValue 類別


表示「User-Agent」標頭值中的產品代幣。此類別的物件只能使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此型別的實例，否則會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標將其作為參數傳遞給函式。
...
| [String](../../system/string/) [get_Name](./get_name/)() | 傳回產品代幣名稱。 |
| [String](../../system/string/) [get_Version](./get_version/)() | 傳回產品代幣版本。 |
...
| static **int32_t** [GetProductLength](./getproductlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\>\&) | 將傳入的字串從指定索引轉換為 [ProductHeaderValue](./) 類別的實例。 |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | 將傳入的字串轉換為 [ProductHeaderValue](./) 類別的實例。 |
|  [ProductHeaderValue](./productheadervalue/)([String](../../system/string/)) | 建構新的實例。 |
|  [ProductHeaderValue](./productheadervalue/)([String](../../system/string/), [String](../../system/string/)) | 建構新的實例。 |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\>\&) | 嘗試將傳入的字串轉換為 [ProductHeaderValue](./) 類別的實例。 |
