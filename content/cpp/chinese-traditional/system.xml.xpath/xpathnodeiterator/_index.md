...
description: 提供對所選節點集合的迭代器。
type: docs
weight: 79
url: /zh-hant/system.xml.xpath/xpathnodeiterator/
---
...
| 方法 | 說明 |
| --- | --- |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 取得指向集合第一個元素（如果有）的迭代器。此迭代器無法用來更改參照的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會傳回 T 的副本物件。 |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNodeIterator](./)\> [Clone](./clone/)() | 當在衍生類別中覆寫時，回傳此 [XPathNodeIterator](./) 物件的克隆。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 取得指向集合中最後一個元素（如果有）之後的迭代器。此迭代器無法用來更改參照的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會傳回 T 的副本物件。 |
...
| virtual **int32_t** [get_Count](./get_count/)() | 回傳所選節點集合中最後一個節點的索引。 |
| virtual const [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\& [get_Current](./get_current/)() | 當在衍生類別中覆寫時，取得此 [XPathNodeIterator](./) 在目前上下文節點上的 [XPathNavigator](../xpathnavigator/) 物件。 |
| virtual **int32_t** [get_CurrentPosition](./get_currentposition/)() | 當在衍生類別中覆寫時，取得所選節點集合中目前位置的索引。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參照計數器資料結構。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\>\> [GetEnumerator](./getenumerator/)() override | 回傳 IEnumerator 物件以遍歷所選節點集合。 |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際型別。C# [System.Object.GetType()](../../system/object/gettype/) 呼叫的類似項。 |
...
| virtual **bool** [MoveNext](./movenext/)() | 當在衍生類別中覆寫時，將 [XPathNodeIterator::get_Current](./get_current/) 方法回傳的 [XPathNavigator](../xpathnavigator/) 物件移動至所選節點集合的下一個節點。 |
...
|  [XPathNodeIterator](./xpathnodeiterator/)() | 初始化 [XPathNodeIterator](./) 類別的新實例。 |
