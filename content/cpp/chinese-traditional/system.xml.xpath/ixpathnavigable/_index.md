...
description: 提供對 XPathNavigator 類別的存取器。
type: docs
weight: 14
url: /zh-hant/system.xml.xpath/ixpathnavigable/
---
## IXPathNavigable 類別


提供對 [XPathNavigator](../xpathnavigator/) 類別的存取器。
...
| 方法 | 描述 |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() | 傳回新的 [XPathNavigator](../xpathnavigator/) 物件。 |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得物件關聯的參考計數器資料結構。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷貝建構式。實際上並未拷貝任何內容，只是初始化新物件並允許子類別的拷貝建構。 |
