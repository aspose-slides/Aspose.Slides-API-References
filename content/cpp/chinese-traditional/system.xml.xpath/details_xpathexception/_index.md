...
description: 提供在處理 XPath 表達式時發生錯誤時拋出的例外。
type: docs
weight: 1
url: /zh-hant/system.xml.xpath/details_xpathexception/
---
## Details_XPathException 類別


提供在處理 [XPath](../) 表達式時發生錯誤時拋出的例外。
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 傳回 32 位元整數值，該值為與目前物件表示的例外相關聯的 HRESULT 代碼。 |
...
| [String](../../system/string/) [get_Message](./get_message/)() const override | 傳回此例外的錯誤狀況描述。 |
