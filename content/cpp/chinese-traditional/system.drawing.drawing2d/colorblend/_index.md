...
description: "包含用於在多色漸層中插值顏色混合的顏色和位置陣列。此類別的物件應僅透過 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 System::SmartPtr 指標，並使用此指標將其作為參數傳遞給函式。"
type: docs
weight: 27
url: /zh-hant/system.drawing.drawing2d/colorblend/
---
## ColorBlend class

包含用於在多色漸層中進行顏色混合插值的顏色和位置陣列。此類的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標將其作為參數傳遞給函式。
...
| 方法 | 描述 |
| --- | --- |
|  [ColorBlend](./colorblend/)() | 建構 [ColorBlend](./) 類別的新實例。 |
|  [ColorBlend](./colorblend/)(int) | 建構 [Blend](../blend/) 類別的新實例。 |
...
| [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\> [get_Colors](./get_colors/)() | 傳回沿漸層相對位置使用的顏色陣列。 |
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Positions](./get_positions/)() | 傳回沿漸層的混合位置陣列。 |
...
| void [set_Colors](./set_colors/)(const [ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\>\&) | 設定在漸層中相對位置所使用的顏色陣列。 |
| void [set_Positions](./set_positions/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | 設定沿漸層的混合位置陣列。 |
