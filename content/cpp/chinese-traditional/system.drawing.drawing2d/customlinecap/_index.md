...
description: "代表使用者自訂的線端帽。此類別的物件只能使用 System::MakeObject() 函式來配置。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。應始終將此類別包裝成 System::SmartPtr 指標，並使用該指標將其作為參數傳遞給函式。"
type: docs
weight: 40
url: /zh-hant/system.drawing.drawing2d/customlinecap/
---
## CustomLineCap 類別


表示使用者自訂的線端帽。此類別的物件只能透過 [System::MakeObject()](../../system/makeobject/) 函式進行配置。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。應始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標將其作為參數傳遞給函式。
...
| 方法 | 描述 |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[CustomLineCap](./)\> [Clone](./clone/)() | 傳回目前物件的副本。 |
|  [CustomLineCap](./customlinecap/)(const [SharedPtr](../../system/sharedptr/)\<[GraphicsPath](../graphicspath/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[GraphicsPath](../graphicspath/)\>\&, [LineCap](../linecap/), **float**) | 建立一個新的 [CustomLineCap](./) 類別實例，該實例代表具有指定屬性的使用者自訂線端帽。 |
...
| [LineCap](../linecap/) [get_BaseCap](./get_basecap/)() const | 傳回此自訂端帽所基於的基本線端帽。 |
| **float** [get_BaseInset](./get_baseinset/)() const | 傳回線條與端帽之間的距離。 |
| [LineJoin](../linejoin/) [get_StrokeJoin](./get_strokejoin/)() const | 傳回 LineJoin 值，決定此自訂端帽的線條如何連接。 |
| **float** [get_WidthScale](./get_widthscale/)() const | 傳回此自訂端帽的縮放比例。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。啟用自訂物件的雜湊。 |
| void [GetStrokeCaps](./getstrokecaps/)([LineCap](../linecap/)\&, [LineCap](../linecap/)\&) | 取得目前物件所代表的自訂端帽的起始與結束線端帽。 |
...
| void [set_BaseCap](./set_basecap/)([LineCap](../linecap/)) | 設定此自訂端帽的基本線端帽值。 |
| void [set_BaseInset](./set_baseinset/)(**float**) | 設定線條與端帽之間的距離。 |
| void [set_StrokeJoin](./set_strokejoin/)([LineJoin](../linejoin/)) | 設定 LineJoin 值，決定此自訂端帽的線條如何連接。 |
| void [set_WidthScale](./set_widthscale/)(**float**) | 設定此自訂端帽的縮放值。 |
| void [SetStrokeCaps](./setstrokecaps/)([LineCap](../linecap/), [LineCap](../linecap/)) | 設定目前物件所代表的自訂端帽的起始與結束線端帽。 |
