...
description: "將 CryptoStream 類別實例轉換為 base 64。此類別的物件只能透過 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 664
url: /zh-hant/system.security.cryptography/tobase64transform/
---
## ToBase64Transform 類別


將 [CryptoStream](../cryptostream/) 類別的實例轉換為 base 64。此類別的物件僅應使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標作為參數傳遞給函式。
...
| void [Dispose](./dispose/)() | 釋放目前物件取得的作業系統資源。 |
...
| virtual **bool** [get_CanReuseTransform](./get_canreusetransform/)() | 取得一個值，指示目前的轉換是否可以重複使用。 |
...
| **int32_t** [TransformBlock](./transformblock/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**) | 處理資料區塊並將資料複製到輸出陣列。 |
| virtual int [TransformBlock](../icryptotransform/transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | 處理資料區塊並將資料複製到輸出陣列。 |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](./transformfinalblock/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | 處理最後一個資料區塊並計算輸出值。 |
...
| virtual  [~ToBase64Transform](./~tobase64transform/)() | 解構函式。 |
