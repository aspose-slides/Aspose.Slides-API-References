...
description: 有關加密金鑰對的其他資訊。
type: docs
weight: 66
url: /zh-hant/system.security.cryptography/cspkeycontainerinfo/
---
## CspKeyContainerInfo 類別
...
| 方法 | 說明 |
| --- | --- |
|  [CspKeyContainerInfo](./cspkeycontainerinfo/)(const [SharedPtr](../../system/sharedptr/)\<[CspParameters](../cspparameters/)\>\&) | 建構子。 |
...
| **bool** [get_Accessible](./get_accessible/)() const | 取得表示容器中金鑰是否可存取的旗標。 |
| **bool** [get_Exportable](./get_exportable/)() const | 取得表示金鑰是否可以從容器匯出的旗標。 |
| **bool** [get_HardwareDevice](./get_hardwaredevice/)() const | 取得表示金鑰是否為硬體金鑰的旗標。 |
| [String](../../system/string/) [get_KeyContainerName](./get_keycontainername/)() const | 取得金鑰容器名稱。 |
| [SharedPtr](../../system/sharedptr/)\<[KeyNumber](../keynumber/)\> [get_KeyNumber](./get_keynumber/)() const | 取得 KeyNumber 物件。 |
| **bool** [get_MachineKeyStore](./get_machinekeystore/)() const | 取得表示金鑰是否已從機器金鑰儲存區載入的旗標。 |
| **bool** [get_Protected](./get_protected/)() const | 取得表示金鑰是否受到防止複製保護的旗標。 |
| [String](../../system/string/) [get_ProviderName](./get_providername/)() const | 取得提供者名稱。 |
| **int32_t** [get_ProviderType](./get_providertype/)() const | 取得提供者類型。 |
| **bool** [get_RandomlyGenerated](./get_randomlygenerated/)() const | 取得表示金鑰是否為隨機產生的旗標。 |
| **bool** [get_Removable](./get_removable/)() const | 取得表示金鑰是否可以從容器中移除的旗標。 |
| [String](../../system/string/) [get_UniqueKeyContainerName](./get_uniquekeycontainername/)() const | 取得唯一的容器名稱。 |
