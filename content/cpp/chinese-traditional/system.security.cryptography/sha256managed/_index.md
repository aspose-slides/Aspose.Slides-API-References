...
description: "受管理的 SHA256 雜湊器。尚未實作。此類別的物件只能使用 System::MakeObject() 函式分配。絕不要在堆疊上或使用 operator new 建立此型別的實例，因為會導致執行時錯誤和/或斷言失敗。永遠將此類別包裝成 System::SmartPtr 指標，並使用此指標作為參數傳遞給函式。"
type: docs
weight: 586
url: /zh-hant/system.security.cryptography/sha256managed/
---
## SHA256Managed 類別
...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)([SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> const\&) | 讀取串流直至結束，並為讀取的資料計算雜湊。 |
| static [SharedPtr](../../system/sharedptr/)\<[SHA256](../sha256/)\> [Create](../sha256/create/)() | 建立雜湊演算法實例。 |
| static [SharedPtr](../../system/sharedptr/)\<[SHA256](../sha256/)\> [Create](../sha256/create/)(const [String](../../system/string/)\&) | 建立雜湊演算法實例。 |
...
|  [SHA256Managed](./sha256managed/)() | 建構函式。 |
