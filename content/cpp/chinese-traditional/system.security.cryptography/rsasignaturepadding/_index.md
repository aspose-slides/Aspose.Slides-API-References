...
description: 用於 RSA 簽章建立或驗證作業的填充模式和參數。
type: docs
weight: 521
url: /zh-hant/system.security.cryptography/rsasignaturepadding/
---
## RSASignaturePadding 類別

用於 [RSA](../rsa/) 簽章建立或驗證作業的填充模式和參數。
...
| virtual **bool** [Equals](../../system/iequatable/equals/)(T) | 確定目前與指定的物件是否相等。 |
...
| [RSASignaturePaddingMode](../rsasignaturepaddingmode/) [get_Mode](./get_mode/)() const | 取得填充模式。 |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pkcs1](./get_pkcs1/)() | 取得 PKCS #1 v1.5 模式。 |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pss](./get_pss/)() | 取得 PSS 模式。 |
