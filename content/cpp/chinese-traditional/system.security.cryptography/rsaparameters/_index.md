...
description: "RSA 演算法參數的資料結構。此類型應分配於堆疊，並以值或參考方式傳遞給函式。切勿使用 System::SmartPtr 類別來管理此類型的物件。"
type: docs
weight: 768
url: /zh-hant/system.security.cryptography/rsaparameters/
---
## RSAParameters 結構


[Data](../../system.data/) 結構，用於 [RSA](../rsa/) 演算法參數。此類型應在堆疊上分配，並以值或參考方式傳遞給函式。切勿使用 [System::SmartPtr](../../system/smartptr/) 類別來管理此類型的物件。
...
|  [RSAParameters](./rsaparameters/)() | 建構子。 |
