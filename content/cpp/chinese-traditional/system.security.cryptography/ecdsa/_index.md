...
description: "ECDsa 演算法實作的基礎類別。此類別的物件應僅使用 System::MakeObject() 函式分配。絕不要在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用此指標將其作為參數傳遞給函式。"
type: docs
weight: 183
url: /zh-hant/system.security.cryptography/ecdsa/
---
## ECDsa 類別


此類別是 [ECDsa](./) 演算法的基礎類別。此類別的物件只能使用 [System::MakeObject()](../../system/makeobject/) 函式分配。絕不要在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標將其作為參數傳遞給函式。
...
| static [SharedPtr](../../system/sharedptr/)\<[ECDsa](./)\> [Create](./create/)() | 建立預設的 ECDSA aglorithm 實作。 |
| static [SharedPtr](../../system/sharedptr/)\<[ECDsa](./)\> [Create](./create/)(const [ECCurve](../eccurve/)\&) | 建立預設的 ECDSA aglorithm 實作，使用在指定曲線上新建立的金鑰。 |
| static [SharedPtr](../../system/sharedptr/)\<[ECDsa](./)\> [Create](./create/)(const [ECParameters](../ecparameters/)\&) | 使用指定的參數建立預設的 ECDSA aglorithm 實作。 |
| static [SharedPtr](../../system/sharedptr/)\<[ECDsa](./)\> [Create](./create/)(const [String](../../system/string/)\&) | 建立指定的 ECDSA aglorithm 實作。 |
...
| virtual [ECParameters](../ecparameters/) [ExportExplicitParameters](./exportexplicitparameters/)(**bool**) | 匯出顯式參數。 |
| virtual [ECParameters](../ecparameters/) [ExportParameters](./exportparameters/)(**bool**) | 匯出具名或顯式參數。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| virtual void [FromXmlString](../asymmetricalgorithm/fromxmlstring/)([String](../../system/string/)) | 從 XML 字串讀取演算法參數。 |
| virtual void [GenerateKey](./generatekey/)(const [ECCurve](../eccurve/)\&) | 為指定的曲線產生新的公私鑰對。 |
| [String](../../system/string/) [get_KeyExchangeAlgorithm](./get_keyexchangealgorithm/)() override | 取得要使用的金鑰交換演算法。 |
...
| virtual void [ImportParameters](./importparameters/)(const [ECParameters](../ecparameters/)\&) | 從資料結構匯入所有參數。 |
...
| virtual [ByteArrayPtr](../../system/bytearrayptr/) [SignData](./signdata/)(const [ByteArrayPtr](../../system/bytearrayptr/)\&, const [HashAlgorithmName](../hashalgorithmname/)\&) | 使用指定的雜湊演算法計算指定資料陣列的雜湊值，並對結果簽章。 |
| virtual [ByteArrayPtr](../../system/bytearrayptr/) [SignData](./signdata/)(const [ByteArrayPtr](../../system/bytearrayptr/)\&, **int32_t**, **int32_t**, const [HashAlgorithmName](../hashalgorithmname/)\&) | 使用指定的雜湊演算法計算指定資料陣列的雜湊值，並對結果簽章。 |
| virtual [ByteArrayPtr](../../system/bytearrayptr/) [SignData](./signdata/)(const [StreamPtr](../../system/streamptr/)\&, const [HashAlgorithmName](../hashalgorithmname/)\&) | 使用指定的雜湊演算法計算指定二進位串流的雜湊值，並對結果簽章。 |
| virtual [ByteArrayPtr](../../system/bytearrayptr/) [SignHash](./signhash/)(const [ByteArrayPtr](../../system/bytearrayptr/)\&) | 計算指定輸入值的簽章。 |
...
| virtual [String](../../system/string/) [ToXmlString](../asymmetricalgorithm/toxmlstring/)(**bool**) | 將演算法參數寫入 XML 字串。 |
...
| virtual **bool** [VerifyHash](./verifyhash/)([ByteArrayPtr](../../system/bytearrayptr/), [ByteArrayPtr](../../system/bytearrayptr/)) | 檢查資料簽章。 |
