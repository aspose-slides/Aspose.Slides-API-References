...
description: "雜湊演算法的基類。此類別的物件應僅使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝為 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 222
url: /zh-hant/system.security.cryptography/hashalgorithm/
---
## HashAlgorithm 類別


雜湊演算法的基類。此類別的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝為 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
...
| 方法 | 描述 |
| --- | --- |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | 對緩衝區進行雜湊。 |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | 對緩衝區切片進行雜湊。 |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)([SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> const\&) | 讀取串流直至結束，並計算已讀取資料的雜湊。 |
| static [SharedPtr](../../system/sharedptr/)\<[HashAlgorithm](./)\> [Create](./create/)(const [String](../../system/string/)\&) | 根據名稱建立雜湊演算法。 |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Hash](./get_hash/)() | 取得已計算的雜湊碼值。 |
| virtual int [get_HashSize](./get_hashsize/)() | 取得已計算雜湊值的位元組大小。 |
| int [get_InputBlockSize](./get_inputblocksize/)() override | 輸入區塊大小。 |
| int [get_OutputBlockSize](./get_outputblocksize/)() override | 輸出區塊大小。 |
...
| virtual void [Initialize](./initialize/)() | 將雜湊器重設為初始狀態。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個範本參數設定為弱指標（而非共享）。允許在容器中切換指標為弱模式。 |
...
| int [TransformBlock](./transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | 處理資料區塊並將資料複製到輸出陣列。 |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](./transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) override | 處理最後一個資料區塊並計算雜湊。 |
...
| virtual  [~HashAlgorithm](./~hashalgorithm/)() | 解構函式。 |
