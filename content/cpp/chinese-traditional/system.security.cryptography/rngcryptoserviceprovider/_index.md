...
description: "遵循 CSP 概念的隨機數生成器。此類別的實例只能使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 443
url: /zh-hant/system.security.cryptography/rngcryptoserviceprovider/
---
## RNGCryptoServiceProvider 類別

遵循 CSP 概念的隨機數生成器。此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為這會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
...
| 方法 | 說明 |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[RandomNumberGenerator](../randomnumbergenerator/)\> [Create](../randomnumbergenerator/create/)() | 建立加密隨機數生成器的預設實作之實例，可用於產生隨機資料。未實作。 |
...
| void [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | 使用隨機位元組填滿現有陣列元素。 |
| void [GetBytes](./getbytes/)(System::Details::ArrayView\<**uint8_t**\>) override | 使用隨機位元組填滿現有陣列視圖元素。 |
| virtual void [GetBytes](../randomnumbergenerator/getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | 使用隨機位元組填滿現有陣列切片。 |
| virtual void [GetBytes](../randomnumbergenerator/getbytes/)(System::Details::ArrayView\<**uint8_t**\>, int, int) | 使用隨機位元組填滿現有陣列視圖切片。 |
| void [GetBytes](../randomnumbergenerator/getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | 使用隨機位元組填滿現有堆疊陣列元素。 |
| void [GetBytes](../randomnumbergenerator/getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&, int, int) | 使用隨機位元組填滿現有堆疊陣列切片。 |
...
| void [GetNonZeroBytes](./getnonzerobytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | 使用隨機非零位元組填滿現有陣列元素。 |
| void [GetNonZeroBytes](./getnonzerobytes/)(System::Details::ArrayView\<**uint8_t**\>) override | 使用隨機非零位元組填滿現有陣列視圖元素。 |
| void [GetNonZeroBytes](../randomnumbergenerator/getnonzerobytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | 使用隨機非零位元組填滿現有堆疊陣列元素。 |
...
|  [RNGCryptoServiceProvider](./rngcryptoserviceprovider/)() | 建構函式。 |
...
| virtual  [~RNGCryptoServiceProvider](./~rngcryptoserviceprovider/)() | 析構函式。 |

## 另請參閱

* 類別 [RandomNumberGenerator](../randomnumbergenerator/)
