...
description: 表示一個 Trace 物件。Trace 元素用於記錄由數位化儀捕獲的資料。它包含依據 InkTraceFormat 物件所提供的規範編碼的點序列。
type: docs
weight: 92
...
表示一個 Trace 物件。Trace 元素用於記錄由數位化儀捕獲的資料。它包含依據 InkTraceFormat 物件所提供的規範編碼的點序列。
...
| [System::SharedPtr](../../system/sharedptr/)\<[IInkBrush](../iinkbrush/)\> [get_Brush](./get_brush/)() override | 取得 IInkLine [IInkBrush](../iinkbrush/) 的 Brush（唯讀）。 |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() override | 取得 IInkLine [System::Drawing::PointF](../../system.drawing/pointf/) 的點（唯讀）。 |
