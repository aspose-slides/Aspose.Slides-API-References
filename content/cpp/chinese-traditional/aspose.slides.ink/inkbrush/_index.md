...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | 取得線條的筆刷顏色。 |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | 取得墨水效果類型（例如 Galaxy、Gold、Silver），此類型定義墨跡的視覺風格。該值會從筆刷屬性 "inkEffects" 解析。如果未指定可辨識的效果，將回傳 [InkEffectType::NotDefined](../inkeffecttype/)。 |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | 取得線條的筆刷大小（以點為單位）。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 複製建構子。實際上什麼也不複製，只是初始化新物件並允許子類別的複製建構。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 指派運算子。實際上什麼也不複製，只是初始化新物件並允許子類別的複製建構。 |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | 設定線條的筆刷顏色。 |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | 設定線條的筆刷大小（以點為單位）。 |
