...
description: 群組集合指標。此類型是用於管理其他物件刪除的指標。它應該在堆疊上分配，並以值或 const 參考方式傳遞給函式。
type: docs
weight: 53
url: /zh-hant/system.text.regularexpressions/groupcollectionptr/
---
## GroupCollectionPtr 類別

[Group](../group/) collection pointer. 此類型用於管理其他物件的刪除。它應該在堆疊上分配，並以值或 const 參考方式傳遞給函式。
...
| Method | Description |
| --- | --- |
| auto [begin](../../system/smartptr/begin/)() | 存取底層集合的 [begin()](../../system/smartptr/begin/) 方法。僅在 SmartPtr_ 為具備 [begin()](../../system/smartptr/begin/) 方法的特化類型時編譯。 |
| auto [begin](../../system/smartptr/begin/)() const | 存取底層集合的 [begin()](../../system/smartptr/begin/) 方法。僅在 SmartPtr_ 為具備 [begin()](../../system/smartptr/begin/) 方法的特化類型時編譯。 |
...
| std::enable_if_t\<Check::value\&&\!std::is_same\<Y, T\>::value\&&\!std::is_base_of\<Y, T\>::value, [SmartPtr](../../system/smartptr/)\<Y\>\> [Cast](../../system/smartptr/cast/)() const | 使用 dynamic_cast 將指標轉型為派生類型。 |
| std::enable_if_t<\!Check::value\&&\!std::is_same\<Y, T\>::value\&&\!std::is_base_of\<Y, T\>::value, [SmartPtr](../../system/smartptr/)\<Y\>\> [Cast](../../system/smartptr/cast/)() const | 使用 dynamic_cast 將指標轉型為派生類型。 |
| auto [cbegin](../../system/smartptr/cbegin/)() const | 存取底層集合的 [cbegin()](../../system/smartptr/cbegin/) 方法。僅在 SmartPtr_ 為具備 [cbegin()](../../system/smartptr/cbegin/) 方法的特化類型時編譯。 |
| auto [cend](../../system/smartptr/cend/)() const | 存取底層集合的 [cend()](../../system/smartptr/cend/) 方法。僅在 SmartPtr_ 為具備 [cend()](../../system/smartptr/cend/) 方法的特化類型時編譯。 |
...
| auto [end](../../system/smartptr/end/)() | 存取底層集合的 [end()](../../system/smartptr/end/) 方法。僅在 SmartPtr_ 為具備 [end()](../../system/smartptr/end/) 方法的特化類型時編譯。 |
| auto [end](../../system/smartptr/end/)() const | 存取底層集合的 [end()](../../system/smartptr/end/) 方法。僅在 SmartPtr_ 為具備 [end()](../../system/smartptr/end/) 方法的特化類型時編譯。 |
...
| int [get_shared_count](../../system/smartptr/get_shared_count/)() const | 取得參考物件上現有的共享指標數量，包含目前這個。會斷言目前指標處於共享模式。 |
...
|  [GroupCollectionPtr](./groupcollectionptr/)() | 空指標建構子。 |
|  [GroupCollectionPtr](./groupcollectionptr/)(const [SharedPtr](../../system/sharedptr/)\<[GroupCollection](../groupcollection/)\>\&) | 型別轉換建構子。 |
| **bool** [Is](../../system/smartptr/is/)(const [System::TypeInfo](../../system/typeinfo/)\&) const | 檢查指向的物件是否為特定類型或其子類型。遵循 C# 的 'is' 語意。 |
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | 檢查指標是否指向與擁有者不同的物件（由別名建構子建立）。 |
...
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&) | 將 [SmartPtr](../../system/smartptr/) 物件以移動賦值。x 變得不可用。 |
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr_](../../system/smartptr/smartptr_/)\&) | 以拷貝賦值 [SmartPtr](../../system/smartptr/) 物件。 |
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&) | 以拷貝賦值 [SmartPtr](../../system/smartptr/) 物件。執行必要的型別轉換。 |
...
| [GroupPtr](../groupptr/) [operator[]](./operator[]/)(size_t) const | [Group](../group/) 存取器。 |
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | 移除指標的別名（由別名建構子建立），確保它在共享模式下管理或在弱引用模式下追蹤相同的指向物件。 |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr_](../../system/smartptr/smartptr_/)\&, [SmartPtrMode](../../system/smartptrmode/)) | 以拷貝建構 [SmartPtr](../../system/smartptr/) 物件。之後兩個指標指向相同的物件。 |
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&, [SmartPtrMode](../../system/smartptrmode/)) | 以拷貝建構 [SmartPtr](../../system/smartptr/) 物件。之後兩個指標指向相同的物件。若允許則執行型別轉換。 |
|  [SmartPtr](../../system/smartptr/smartptr/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&, [SmartPtrMode](../../system/smartptrmode/)) | 以移動建構 [SmartPtr](../../system/smartptr/) 物件。實質上交換兩個指標（若模式相同），呼叫後 x 可能不可用。 |
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<[Array](../../system/array/)\<Y\>\>\&, [SmartPtrMode](../../system/smartptrmode/)) | 透過建立不同類型的新陣列，轉換參考陣列的類型。如果在 C# 中有不支援於 C++ 的陣列型別轉換，此功能很有用。 |
...
| [SmartPtr](../../system/smartptr/)\<Y\> [static_pointer_cast](../../system/smartptr/static_pointer_cast/)() const | 使用 static_cast 將指標轉型為指向物件的不同類型。 |
| [SmartPtr](../../system/smartptr/)\<[Object](../../system/object/)\> [ToObjectPtr](../../system/smartptr/toobjectptr/)() const | 将任意指標類型轉換為指向 [Object](../../system/object/) 的指標。無需 Pointee_ 類型完整。 |
...
|  [~SmartPtr](../../system/smartptr/~smartptr/)() | 銷毀 [SmartPtr](../../system/smartptr/) 物件。如有需要，減少指向物件的引用計數並刪除該物件。 |
