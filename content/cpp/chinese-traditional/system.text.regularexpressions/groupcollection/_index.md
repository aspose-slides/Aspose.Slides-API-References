...
description: "單次匹配中捕獲群組的清單。此類別的物件只能透過 System::MakeObject() 函式配置。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用此指標作為參數傳遞給函式。"
type: docs
weight: 40
url: /zh-hant/system.text.regularexpressions/groupcollection/
---
## GroupCollection 類別

單次匹配中捕獲群組的清單。此類別的物件只能透過 [System::MakeObject()](../../system/makeobject/) 函式配置。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標作為參數傳遞給函式。
...
| 方法 | 說明 |
| --- | --- |
| void [_add_range](../../system.collections.generic/list/_add_range/)(std::initializer_list\<T\>) | C++ 專屬。 |
| void [Add](./add/)(const [GroupPtr](../groupptr/)\&) override | 禁用向集合中新增元素。 |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | 將元素加入清單的末端。 |
| void [AddGroup](./addgroup/)(const [GroupPtr](../groupptr/)\&) | 將群組加入集合。 |
| void [AddInitializer](../../system.collections.generic/list/addinitializer/)(int, const T *) | 將元素加入清單；用於翻譯初始化子。 |
| void [AddRange](../../system.collections.generic/list/addrange/)([IEnumerablePtr](../../system.collections.generic/list/ienumerableptr/)) | 將集合（或自身）的所有元素加入至目前清單的末端。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/list/begin/)() const | 取得 const 限定集合的第一個元素的迭代器。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/list/cbegin/)() const | 取得集合中第一個 const 限定元素的迭代器。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/list/cend/)() const | 取得位於集合末端之後、不存在的 const 限定元素的迭代器。 |
| void [Clear](./clear/)() override | 禁用從集合中移除元素。 |
| **bool** [Contains](../../system.collections.generic/list/contains/)(const T\&) const override | 檢查項目是否存在於清單中。 |
| [SharedPtr](../../system/sharedptr/)\<[List](../../system.collections.generic/list/)\<OutputType\>\> [ConvertAll](../../system.collections.generic/list/convertall/)([Converter](../../system/converter/)\<T, OutputType\>) | 建立已轉換為不同類型的元素清單。 |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | 取得集合中最後一個 const 限定元素的反向迭代器（倒序的第一個）。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crend](../../system.collections.generic/list/crend/)() const | 取得位於集合開始之前、不存在的 const 限定元素的反向迭代器。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/list/end/)() | 取得位於集合末端之後、不存在的元素的迭代器。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/list/end/)() const | 取得位於 const 限定集合末端之後、不存在的元素的迭代器。 |
...
| int [get_Count](../../system.collections.generic/list/get_count/)() const override | 取得目前清單中元素的數量。 |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | 檢查集合是否為固定大小。 |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | 檢查集合是否為唯讀。 |
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(int) const | [Group](../group/) 存取子。 |
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(const [String](../../system/string/)\&) const | [Group](../group/) 存取子。 |
...
| **ThisPtr** [GetRange](../../system.collections.generic/list/getrange/)(int, int) | 建立清單切片。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際型別。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
|  [GroupCollection](./groupcollection/)(const [WeakPtr](../../system/weakptr/)\<[Match](../match/)\>\&) | 建構子。 |
...
| virtual [GroupPtr](../groupptr/) [idx_get](./idx_get/)([String](../../system/string/)) const | [Group](../group/) 存取子。 |
| [GroupPtr](../groupptr/) [idx_get](./idx_get/)(int) const override | [Group](../group/) 存取子。 |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | 搜尋指定物件，並回傳在整個清單中最後一次出現的零基索引。 |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | 搜尋指定物件，並回傳在 [List](../../system.collections.generic/list/) 範圍（從第一個元素至指定索引）內最後一次出現的零基索引。 |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | 搜尋指定物件，並回傳在 [List](../../system.collections.generic/list/) 範圍（包含指定數量的元素且結束於指定索引）內最後一次出現的零基索引。 |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | 判斷序列中是否存在任一元素或其符合條件。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | 對序列的每個元素投影，並將產生的序列合併為一個序列。 |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<Source, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\>\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | 跳過序列起始處指定數量的連續元素，並回傳剩餘部分。 |
...
|  [List](../../system.collections.generic/list/list/)() | 建立空清單。 |
|  [List](../../system.collections.generic/list/list/)(int) | 建立具預先定義容量的清單。 |
|  [List](../../system.collections.generic/list/list/)([IEnumerablePtr](../../system.collections.generic/list/ienumerableptr/)) | 複製建構子。 |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 指定運算子。實際上不會複製任何內容，只是初始化新物件，並允許子類別的複製建構。 |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)([ICollection](../../system.collections.generic/icollection/)\&&) | 移動指定運算子。 |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)(const [ICollection](../../system.collections.generic/icollection/)\&) | 移動指定運算子。 |
| [GroupPtr](../groupptr/) [operator[]](./operator[]/)(const [String](../../system/string/)\&) const | [Group](../group/) 存取子。 |
...
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() | 取得集合最後一個元素的反向迭代器（倒序的第一個）。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() const | 取得 const 限定集合最後一個元素的反向迭代器（倒序的第一個）。 |
...
| **bool** [Remove](./remove/)(const [GroupPtr](../groupptr/)\&) override | 禁用從集合中移除元素。 |
| **bool** [Remove](../../system.collections.generic/list/remove/)(const T\&) override | 從清單中移除第一個特定項目。 |
...
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() | 取得位於集合開始之前、不存在的元素的反向迭代器。 |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() const | 取得位於 const 限定集合開始之前、不存在的元素的反向迭代器。 |
| void [Reverse](../../system.collections.generic/list/reverse/)() | 反轉整個清單的元素順序。 |
| void [Reverse](../../system.collections.generic/list/reverse/)(int, int) | 反轉清單切片的元素順序。 |
...
| void [Sort](../../system.collections.generic/list/sort/)(const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) | 對清單中的元素進行排序。 |
| void [Sort](../../system.collections.generic/list/sort/)() | 使用預設比較器對清單元素排序。 |
| void [Sort](../../system.collections.generic/list/sort/)(int, int, [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>) | 對清單切片中的元素排序。 |
| void [Sort](../../system.collections.generic/list/sort/)([Comparison](../../system/comparison/)\<T\>, **bool**) | 對清單中的元素排序。 |
