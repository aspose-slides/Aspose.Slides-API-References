...
description: "通用集合的基礎類型。此類別的物件應僅使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝在 System::SmartPtr 指標中，並使用此指標將其作為參數傳遞給函式。"
type: docs
weight: 1
url: /zh-hant/system.collections.objectmodel/collection/
---
## 集合類別

通用集合的基礎類型。此類別的物件只能透過 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為這會導致執行時錯誤和/或斷言失敗。始終將此類別包裝在 [System::SmartPtr](../../system/smartptr/) 指標中，並使用此指標將它作為參數傳遞給函式。
...
| 方法 | 說明 |
| --- | --- |
| void [Add](./add/)(const T\&) override | 將值新增至容器。 |
...
| [Collection](./collection/)() | 建立空的集合。 |
| [Collection](./collection/)([SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) |  |
| **bool** [Contains](./contains/)(const T\&) const override | 檢查項目是否存在於集合中。 |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | 將集合元素複製到現有的陣列元素中。 |
| [const_reverse_iterator](./const_reverse_iterator/) [crbegin](./crbegin/)() const | 取得指向集合最後一個 const 限定元素的反向迭代器（反向的第一個）。 |
| [const_reverse_iterator](./const_reverse_iterator/) [crend](./crend/)() const | 取得指向集合開始前的不存在的 const 限定元素的反向迭代器。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 取得指向集合最後一個元素之後的迭代器（若有）。此迭代器無法用於變更所參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的副本物件。 |
...
| int [get_Count](./get_count/)() const override | 取得元素數量。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](./get_items/)() | 內部資料結構存取器。 |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](./get_items/)() const | 內部資料結構存取器。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | 取得列舉器以遍歷集合。 |
...
| T [idx_get](./idx_get/)(int) const override | 取得指定索引處的值。 |
| void [idx_set](./idx_set/)(int, T) override | 設定指定索引處的值。 |
| int [IndexOf](./indexof/)(const T\&) const override | 在集合中搜尋元素。 |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | 計算透過對輸入序列每個元素呼叫轉換函式取得之值的平均。 |
...
| T\& [operator[]](./operator[]/)(int) | 取得指定索引處的值。 |
| const T\& [operator[]](./operator[]/)(int) const | 取得指定索引處的值。 |
...
| **bool** [Remove](./remove/)(const T\&) override | 移除特定項目。 |
| void [RemoveAt](./removeat/)(int) override | 移除指定位置的項目。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將共享參考計數減少指定的值。 |
| [reverse_iterator](./reverse_iterator/) [rend](./rend/)() | 取得集合開始前不存在的元素的反向迭代器。 |
| [const_reverse_iterator](./const_reverse_iterator/) [rend](./rend/)() const | 取得 const 限定集合開始前不存在的元素的反向迭代器。 |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 將已儲存的指標設為弱引用（若適用）。 |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 取得目前容器之 begin const 迭代器的實作。 |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 取得目前容器之 begin 迭代器的實作。 |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 取得目前容器之 end const 迭代器的實作。 |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | 取得目前容器之 end 迭代器的實作。 |
