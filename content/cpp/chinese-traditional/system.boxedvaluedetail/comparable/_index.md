...
description: IComparable<> 的簡單實作
type: docs
weight: 1
url: /zh-hant/system.boxedvaluedetail/comparable/
---
## Comparable 類別
...
| 方法 | 描述 |
| --- | --- |
| int [CompareTo](./compareto/)(T) override | 比較目前物件與指定的物件。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C#-style 的浮點比較，兩個 NaN 被視為相等，儘管根據 IEC 60559:1989 NaN 不等於任何值，包含 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C#-style 的浮點比較，兩個 NaN 被視為相等，儘管根據 IEC 60559:1989 NaN 不等於任何值，包含 NaN 本身。 |
