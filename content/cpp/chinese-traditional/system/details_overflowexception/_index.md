...
description: "OverflowException 會在操作導致溢位時拋出。永遠不要手動建立此類別的實例。改用 OverflowException 類別。永遠不要將 OverflowException 類別的實例包裝成 System::SmartPtr。"
type: docs
weight: 651
url: /zh-hant/system/details_overflowexception/
---
## Details_OverflowException 類別


OverflowException 會在操作導致溢位時拋出。永遠不要手動建立此類別的實例。改用 OverflowException 類別。永遠不要將 OverflowException 類別的實例包裝成 [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點數比較，兩個 NaN 被視為相等，儘管依 IEC 60559:1989 的規定 NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點數比較，兩個 NaN 被視為相等，儘管依 IEC 60559:1989 的規定 NaN 不等於任何值，包括 NaN 本身。 |
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | 回傳含有自訂例外資料的字典。 |
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 回傳與目前物件所代表的例外相關聯的 32 位整數值 (HRESULT 代碼)。 |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | 回傳指向代表內部例外之物件的參考。 |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | 回傳表示最內層例外之 Exception 物件的複本。 |
...
|  [Object](../object/object/)([Object](../object/) const\&) | 拷貝建構函式。實際上不會拷貝任何東西，只是初始化新物件並允許子類別的拷貝建構。 |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | 指派運算子。實際上不會拷貝任何東西，只是初始化新物件並允許子類別的拷貝建構。 |
...
| virtual const char * [what](../details_exception/what/)() const | 實作 [what()](../details_exception/what/) 方法，該方法由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，衍生類別仍可使用受保護/私有成員來實作其邏輯。將此方法實作搬移到 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
