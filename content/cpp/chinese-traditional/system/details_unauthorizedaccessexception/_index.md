...
description: "當作業系統因 I/O 錯誤或安全錯誤而拒絕存取時，會拋出 UnauthorizedAccessException。不要手動建立此類別的實例。請改用 UnauthorizedAccessException 類別。且永遠不要將 UnauthorizedAccessException 類別的實例包裝成 System::SmartPtr。"
type: docs
weight: 755
url: /zh-hant/system/details_unauthorizedaccessexception/
---
## Details_UnauthorizedAccessException 類別
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點數比較，將兩個 NaN 視為相等，即使根據 IEC 60559:1989，NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點數比較，將兩個 NaN 視為相等，即使根據 IEC 60559:1989，NaN 不等於任何值，包括 NaN 本身。 |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 返回一個 32 位元整數值，該值是與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | 返回代表內部例外的物件參考。 |
| virtual [String](../string/) [get_Message](../details_exception/get_message/)() const | 返回包含錯誤描述的字串。 |
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | 返回包含堆疊追蹤的字串。 |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | 返回表示最內層例外的 Exception 物件的副本。 |
...
|  [Object](../object/object/)() | 建立物件。初始化全部內部資料結構。 |
|  [Object](../object/object/)([Object](../object/) const\&) | 拷貝建構子。實際上不會複製任何內容，只是初始化新物件並允許子類別的拷貝建構。 |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | 指定運算子。實際上不會複製任何內容，只是初始化新物件並允許子類別的拷貝建構。 |
...
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../object/referenceequals/) 的特化，針對字串與 nullptr 的情況。 |
