...
description: 表示元組資料結構的類別。最大項目數為 8。
type: docs
weight: 1353
url: /zh-hant/system/tuple/
---
## Tuple 類別

表示元組資料結構的類別。最大項目數為 8。
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([SharedPtr](../sharedptr/)\<[Object](../object/)\>) override | 判斷目前的物件與指定的物件是否相同。 |
...
| std::tuple_element\<[Index](../index/), tuple_t\>::type [get_Item](./get_item/)() const | 取得 [Tuple](./) 物件的組件值。 |
...
| virtual [SharedPtr](../sharedptr/)\<[Object](../object/)\> [idx_get](../../system.runtime.compilerservices/ituple/idx_get/)(**int32_t**) const | 回傳位於 index 位置的元素。 |
...
| virtual [String](../string/) [ToString](../object/tostring/)() const | 相當於 C# [Object.ToString()](../object/tostring/) 方法。提供將自訂物件轉換為字串的功能。 |
|  [Tuple](./tuple/)(Args...) | 建構一個 Tuple 物件。 |
