...
type: docs
weight: 391
url: /zh-hant/system/details_datamisalignedexception/
---
## Details_DataMisalignedException 類別
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 回傳一個 32 位元整數值，該值為與目前物件所代表例外關聯的 HRESULT 代碼。 |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | 回傳代表最內層例外的 Exception 物件的副本。 |
...
| void [Lock](../object/lock/)() | 實作 C# lock() 陳述式的鎖定。直接呼叫或使用 [LockContext](../lockcontext/) 監看物件。 |
...
| int [SharedCount](../object/sharedcount/)() const | 取得共享參考計數目前的值。 |
...
| void [Unlock](../object/unlock/)() | 實作 C# lock() 陳述式的解鎖。直接呼叫或使用 [LockContext](../lockcontext/) 監看物件。 |
...
| virtual const char * [what](../details_exception/what/)() const | 實作 [what()](../details_exception/what/) 方法，此方法由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，衍生類別仍可使用受保護/私人成員來實作其邏輯。將此方法的實作移至 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
