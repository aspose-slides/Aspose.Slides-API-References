...
description: 將指定的布林值轉換為等效的 64 位元無號整數。
type: docs
weight: 196
url: /zh-hant/system/convert/touint64/
---
## Convert::ToUInt64(bool) 方法

將指定的布林值轉換為等效的 64 位元無號整數。
...
將指定的 16 位元無號整數轉換為等效的 64 位元無號整數。
...
將指定的 16 位元有號整數轉換為等效的 64 位元無號整數。
...
將指定的 32 位元無號整數轉換為等效的 64 位元無號整數。
...
將指定的 32 位元有號整數轉換為等效的 64 位元無號整數。
...
將指定的 64 位元有號整數轉換為等效的 64 位元無號整數。
...
將指定的 Unicode 字元轉換為等效的 64 位元無號整數。
...
將指定的 null-string 轉換為等效的 64 位元無號整數值。
...
將包含數字字串表示的指定 c-string 轉換為等效的 64 位元無號整數值。
...
指定 c-string 所表示之數字相等的 64 位元無號整數值

## Convert::ToUInt64(const String\&) 方法


將包含數字字串表示的指定字串轉換為等效的 64 位元無號整數值。
...
指定字串所表示之數字相等的 64 位元無號整數值

## Convert::ToUInt64(const String\&, int) 方法


將包含指定基數之數字字串表示的指定字串轉換為等效的 64 位元無號整數值。
...
將指定字串轉換為等效的 64 位元無號整數值，並使用提供的格式資訊。
...
將指定字串轉換為等效的 64 位元無號整數值，並使用提供的格式資訊與數字樣式。
...
| --- | --- | --- |
| value | const [String](../../string/)\& | 要轉換的字串 |
| styles | [Globalization::NumberStyles](../../../system.globalization/numberstyles/) | 指定字串之數字表示所允許之樣式的 NumberStyles 列舉值的位元組合 |
| provider | const [SharedPtr](../../sharedptr/)\<[IFormatProvider](../../iformatprovider/)\>\& | 指向包含字串格式資訊之物件的指標 |
