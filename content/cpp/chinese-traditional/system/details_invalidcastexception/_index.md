...
description: "當嘗試無效的明確轉換時會拋出 InvalidCastException。切勿手動建立此類別的實例。請改用 InvalidCastException 類別。切勿將 InvalidCastException 類別的實例包裝到 System::SmartPtr 中。"
type: docs
weight: 495
url: /zh-hant/system/details_invalidcastexception/
---
## Details_InvalidCastException 類別

InvalidCastException 在嘗試無效的明確轉換時會拋出。切勿手動建立此類別的實例。請改用 InvalidCastException 類別。切勿將 InvalidCastException 類別的實例包裝到 [System::SmartPtr](../smartptr/) 中。
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 回傳與目前物件所代表的例外相關聯的 32 位元整數值 (HRESULT 代碼)。 |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | 回傳表示內部例外之物件的參照。 |
...
|  [Object](../object/object/)([Object](../object/) const\&) | 複製建構子。實際上不會複製任何東西，只會初始化新物件並允許子類別的複製建構。 |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | 指派運算子。實際上不會複製任何東西，只會初始化新物件並允許子類別的複製建構。 |
