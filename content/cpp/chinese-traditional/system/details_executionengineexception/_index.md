...
description: ExecutionEngineException 僅為相容性原因而存在。
type: docs
weight: 456
url: /zh-hant/system/details_executionengineexception/
---
## Details_ExecutionEngineException 類別

ExecutionEngineException 僅為相容性原因而存在。
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，即使依 IEC 60559:1989 之規定 NaN 不等於任何值（包括 NaN），仍將兩個 NaN 視為相等。 |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，即使依 IEC 60559:1989 之規定 NaN 不等於任何值（包括 NaN），仍將兩個 NaN 視為相等。 |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 傳回一個 32 位元整數值，該值為與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
...
| void [Lock](../object/lock/)() | 實作 C# lock() 陳述式之鎖定。直接呼叫或使用 [LockContext](../lockcontext/) 監視物件。 |
...
|  [Object](../object/object/)([Object](../object/) const\&) | 複製建構子。實際上不複製任何東西，只是初始化新物件並允許子類別的複製建構。 |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | 賦值運算子。實際上不複製任何東西，只是初始化新物件並允許子類別的複製建構。 |
...
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, std::nullptr_t) | 針對字串與 nullptr 的 [Object::ReferenceEquals](../object/referenceequals/) 特化。 |
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, [String](../string/) const\&) | 針對字串的 [Object::ReferenceEquals](../object/referenceequals/) 特化。 |
...
| void [Unlock](../object/unlock/)() | 實作 C# lock() 陳述式之解鎖。直接呼叫或使用 [LockContext](../lockcontext/) 監視物件。 |
...
| virtual const char * [what](../details_exception/what/)() const | 實作 [what()](../details_exception/what/) 方法，該方法由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，但衍生類別可使用受保護/私有成員來實作其邏輯。將此方法實作搬移至 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
