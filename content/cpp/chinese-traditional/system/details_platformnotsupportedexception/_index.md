...
description: "PlatformNotSupportedException 於功能在特定平台上無法執行時拋出。切勿手動建立此類別的實例。請改用 PlatformNotSupportedException 類別。切勿將 PlatformNotSupportedException 類別的實例包裹至 System::SmartPtr。"
type: docs
weight: 664
url: /zh-hant/system/details_platformnotsupportedexception/
---
## Details_PlatformNotSupportedException 類別

PlatformNotSupportedException 會在某項功能於特定平台上無法執行時拋出。切勿手動建立此類別的實例。請改用 PlatformNotSupportedException 類別。切勿將 PlatformNotSupportedException 類別的實例包裹至 [System::SmartPtr](../smartptr/) 中。
...
| static std::enable_if\<[IsSmartPtr](../issmartptr/)\<T1\>::value\&&[IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | 以 C# 方式比較參考型別物件。 |
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | 以 C# 方式比較值型別物件。 |
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，兩個 NaN 即使根據 IEC 60559:1989 規定 NaN 與任何值（包括 NaN 本身）皆不相等，仍被視為相等。 |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，兩個 NaN 即使根據 IEC 60559:1989 規定 NaN 與任何值（包括 NaN 本身）皆不相等，仍被視為相等。 |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 傳回 32 位元整數值，該值為與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | 取得與物件關聯的參考計數器資料結構。 |
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../object/gethashcode/) 方法。允許自訂物件的雜湊。 |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | 相當於 C# [Object.MemberwiseClone()](../object/memberwiseclone/) 方法。允許自訂型別的複製。 |
...
| int [SharedCount](../object/sharedcount/)() const | 取得目前的共享參考計數值。 |
...
* 類別 [Details_NotSupportedException](../details_notsupportedexception/)
* 命名空間 [System](../)
* 函式庫 [Aspose.Slides](../../)