...
description: "OperationCanceledException 會在執行緒執行的操作被取消時拋出。切勿手動建立此類別的實例。請改用 OperationCanceledException 類別。絕不要將 OperationCanceledException 類別的實例包裝至 System::SmartPtr."
type: docs
weight: 625
url: /zh-hant/system/details_operationcanceledexception/
---
## Details_OperationCanceledException 類別

當執行緒的操作被取消時，會拋出 OperationCanceledException。切勿手動建立此類別的實例。請改用 OperationCanceledException 類別。絕不要將 OperationCanceledException 類別的實例包裝至 [System::SmartPtr](../smartptr/)。
...
| Method | Description |
| --- | --- |
| virtual **bool** [Equals](../object/equals/)([ptr](../object/ptr/)) | 比較物件，使用 C# [Object.Equals](../object/equals/) 語意。 |
| static std::enable_if\<[IsSmartPtr](../issmartptr/)\<T1\>::value\&&[IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | 比較 C# 風格的參考型別物件。 |
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | 比較 C# 風格的值型別物件。 |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 傳回一個 32 位元整數值，該值是與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | 傳回代表最內層例外的 Exception 物件的副本。 |
...
| void [Lock](../object/lock/)() | 實作 C# lock() 陳述式之鎖定。直接呼叫或使用 [LockContext](../lockcontext/) 哨兵物件。 |
...
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../object/referenceequals/) 的特化版本，用於字串與 nullptr 情況。 |
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, [String](../string/) const\&) | [Object::ReferenceEquals](../object/referenceequals/) 的特化版本，用於字串情況。 |
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | 將共用參考計數減少指定的值。 |
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | 設定 HRESULT，一個分配給特定例外的編碼數值。 |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設為弱指標（而非共用指標）。允許在容器中將指標切換為弱模式。 |
| int [SharedCount](../object/sharedcount/)() const | 取得共用參考計數器的當前值。 |
...
| void [Unlock](../object/unlock/)() | 實作 C# lock() 陳述式之解除鎖定。直接呼叫或使用 [LockContext](../lockcontext/) 哨兵物件。 |
