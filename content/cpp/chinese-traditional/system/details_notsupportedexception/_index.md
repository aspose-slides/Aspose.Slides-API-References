...
description: "當呼叫的方法不受支援，或在串流上嘗試的操作不受支援時，會拋出 NotSupportedException。永遠不要手動建立此類別的實例。請改用 NotSupportedException 類別。永遠不要將 NotSupportedException 類別的實例包裝成 System::SmartPtr。"
type: docs
weight: 586
url: /zh-hant/system/details_notsupportedexception/
---
## Details_NotSupportedException 類別

NotSupportedException 會在被呼叫的方法不受支援，或在串流上嘗試的操作不受支援時拋出。永遠不要手動建立此類別的實例。請改用 NotSupportedException 類別。永遠不要將 NotSupportedException 類別實例包裝至 [System::SmartPtr](../smartptr/)。
...
| Method | Description |
| --- | --- |
| virtual **bool** [Equals](../object/equals/)([ptr](../object/ptr/)) | 比較物件時使用 C# [Object.Equals](../object/equals/) 語意。 |
| static std::enable_if\<[IsSmartPtr](../issmartptr/)\<T1\>::value\&&[IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | 在 C# 風格中比較參考型別物件。 |
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | 在 C# 風格中比較值型別物件。 |
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點數比較，兩個 NaN 被視為相等，即使依據 IEC 60559:1989，NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點數比較，兩個 NaN 被視為相等，即使依據 IEC 60559:1989，NaN 不等於任何值，包括 NaN 本身。 |
...
| virtual const char * [what](../details_exception/what/)() const | 實作 [what()](../details_exception/what/) 方法，此方法由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，但衍生類別仍可使用受保護/私有成員來實作其邏輯。將此方法的實作移至 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
