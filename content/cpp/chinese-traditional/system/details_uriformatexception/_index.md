...
description: "UriFormatException 會在 URI 格式無效時拋出。切勿手動建立此類別的實例。請改用 UriFormatException 類別。切勿將 UriFormatException 類別的實例封裝到 System::SmartPtr 中。"
type: docs
weight: 768
url: /zh-hant/system/details_uriformatexception/
---
## Details_UriFormatException 類別


UriFormatException 會在 URI 格式無效時拋出。切勿手動建立此類別的實例。請改用 UriFormatException 類別。切勿將 UriFormatException 類別的實例封裝到 [System::SmartPtr](../smartptr/) 中。
...
| 方法 | 描述 |
| --- | --- |
| virtual **bool** [Equals](../object/equals/)([ptr](../object/ptr/)) | 使用 C# [Object.Equals](../object/equals/) 語義比較物件。 |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 回傳 32 位元整數值，該值為與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
...
| void [Lock](../object/lock/)() | 實作 C# lock() 陳述式的上鎖。可直接呼叫或使用 [LockContext](../lockcontext/) 監視物件。 |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | 以參考方式將值型別物件與 nullptr 進行比較。 |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | 設定 HRESULT，此編碼數值指派給特定例外。 |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | 回傳目前物件的字串表示形式。 |
| static const [System::TypeInfo](../typeinfo/)\& [Type](./type/)() |  |
| void [Unlock](../object/unlock/)() | 實作 C# lock() 陳述式的解鎖。可直接呼叫或使用 [LockContext](../lockcontext/) 監視物件。 |
...
| virtual const char * [what](../details_exception/what/)() const | 實作 [what()](../details_exception/what/) 方法，該方法由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，衍生類別仍可使用受保護/私有成員實作其邏輯。將此方法實作移至 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
| virtual  [~Object](../object/~object/)() | 銷毀物件。釋放所有內部資料結構。 |

## 另請參閱

* 類別 [Details_FormatException](../details_formatexception/)
* 命名空間 [System](../)
* 函式庫 [Aspose.Slides](../../)