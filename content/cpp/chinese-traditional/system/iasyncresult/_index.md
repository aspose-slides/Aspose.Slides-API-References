...
description: "表示非同步操作的狀態。此類別的物件應僅透過 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。永遠將此類別包裝成 System::SmartPtr 指標，並使用此指標作為參數傳遞給函式。"
type: docs
weight: 898
url: /zh-hant/system/iasyncresult/
---
## IAsyncResult 類別

表示非同步操作的狀態。此類別的物件應僅透過 [System::MakeObject()](../makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。永遠將此類別包裝成 [System::SmartPtr](../smartptr/) 指標，並使用此指標作為參數傳遞給函式。
...
| virtual [SharedPtr](../sharedptr/)\<[System::Object](../object/)\> [get_AsyncState](./get_asyncstate/)() | 返回一個包含非同步操作資訊的物件。 |
| virtual [SharedPtr](../sharedptr/)\<[System::Threading::WaitHandle](../../system.threading/waithandle/)\> [get_AsyncWaitHandle](./get_asyncwaithandle/)() | 返回一個 WaitHandle 實例，可用於等待非同步操作的完成。 |
| virtual **bool** [get_CompletedSynchronously](./get_completedsynchronously/)() | 返回一個值，指示非同步操作是否同步完成。 |
| virtual **bool** [get_IsCompleted](./get_iscompleted/)() | 返回一個值，指示非同步操作是否已完成。 |
...
|  [Object](../object/object/)([Object](../object/) const\&) | 拷貝建構式。實際上不會複製任何內容，只是初始化新物件並允許子類別的拷貝建構。 |
...
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../object/referenceequals/) 的特化，用於 string 和 nullptr 的情況。 |
...
| virtual  [~IAsyncResult](./~iasyncresult/)() | 析構函式。 |
...
| 型別別名 | 描述 |
| --- | --- |
| [smart_ptr](./smart_ptr/) | 指向 [IAsyncResult](./) 的共享指標。 |
