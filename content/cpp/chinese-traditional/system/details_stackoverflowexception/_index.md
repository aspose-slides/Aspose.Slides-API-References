...
description: "StackOverflowException 會在執行緒的堆疊溢位時拋出。切勿手動建立此類別的實例。請改用 StackOverflowException 類別。切勿將 StackOverflowException 類別的實例包裝到 System::SmartPtr 中。"
type: docs
weight: 690
url: /zh-hant/system/details_stackoverflowexception/
---
## Details_StackOverflowException 類別
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 傳回 32 位元整數值，即與目前物件所表示的例外相關的 HRESULT 代碼。 |
...
| virtual [String](../string/) [get_Message](../details_exception/get_message/)() const | 傳回包含錯誤說明的 string。 |
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | 傳回包含堆疊追蹤的 string。 |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | 傳回表示最內層例外的 Exception 物件的副本。 |
...
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | 指定運算子。實際上不複製任何內容，只是初始化新物件並允許子類別的複製建構。 |
...
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../object/referenceequals/) 的特化，用於 string 與 nullptr 的情況。 |
