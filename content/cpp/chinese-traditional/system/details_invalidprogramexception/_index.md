...
description: "InvalidProgramException 只因相容性需求而保留。切勿手動建立此類別的實例。請改用 InvalidProgramException 類別。切勿將 InvalidProgramException 類別的實例包裹到 System::SmartPtr 中。"
type: docs
weight: 521
url: /zh-hant/system/details_invalidprogramexception/
---
## Details_InvalidProgramException 類別


InvalidProgramException is present for compatibility reasons only. Never create instances of this 類別 manually. Use the InvalidProgramException 類別 instead. Never wrap the InvalidProgramException 類別 instances into [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點數比較，將兩個 NaN 視為相等，儘管根據 IEC 60559:1989，NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點數比較，將兩個 NaN 視為相等，儘管根據 IEC 60559:1989，NaN 不等於任何值，包括 NaN 本身。 |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 傳回 32 位元整數值，作為與目前物件所表示例外相關聯的 HRESULT 代碼。 |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | 将值型別物件與 nullptr 以參考方式比較。 |
