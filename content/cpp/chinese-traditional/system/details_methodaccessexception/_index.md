...
description: "當嘗試存取不存在的方法或存取該方法未被允許時，會拋出 MemberAccessException。切勿手動建立此類別的實例。請改用 MethodAccessException 類別。切勿將 MethodAccessException 類別的實例封裝到 System::SmartPtr 中。"
type: docs
weight: 560
url: /zh-hant/system/details_methodaccessexception/
---
## Details_MethodAccessException 類別


MemberAccessException 會在嘗試存取不存在的方法或存取該方法未被允許時拋出。永遠不要手動建立此類別的實例。請改用 MethodAccessException 類別。永遠不要將 MethodAccessException 類別的實例封裝到 [System::SmartPtr](../smartptr/) 中。
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使根據 IEC 60559:1989，NaN 不等於任何值，包含 NaN 本身。 |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使根據 IEC 60559:1989，NaN 不等於任何值，包含 NaN 本身。 |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../object/memberwiseclone/) 方法的類似功能。啟用自訂型別的克隆。 |
...
| virtual const char * [what](../details_exception/what/)() const | 實作 [what()](../details_exception/what/) 方法，此方法由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫。儘管此類別未從 std::exception 繼承，衍生類別仍可使用受保護/私有成員實作其邏輯。將此方法實作移至 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
| virtual  [~Object](../object/~object/)() | 銷毀物件。釋放所有內部資料結構。 |

## 另請參閱

* 類別 [Details_MemberAccessException](../details_memberaccessexception/)
* 命名空間 [System](../)
* 函式庫 [Aspose.Slides](../../)