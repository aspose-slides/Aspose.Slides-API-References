...
description: "DivideByZeroException 在算術運算中嘗試除以 0 時會拋出。永遠不要手動建立此類別的實例。請改用 DivideByZeroException 類別。永遠不要將 DivideByZeroException 類別的實例包裝到 System::SmartPtr 中。"
type: docs
weight: 404
url: /zh-hant/system/details_dividebyzeroexception/
---
## Details_DivideByZeroException 類別


DivideByZeroException 會在算術運算嘗試除以 0 時拋出。永遠不要手動建立此類別的實例。請改用 DivideByZeroException 類別。永遠不要將 DivideByZeroException 類別的實例包裝到 [System::SmartPtr](../smartptr/) 中。
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 回傳 32 位元整數值，該值是與目前物件所表示的例外相關聯的 HRESULT 代碼。 |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | 回傳代表內部例外的物件參考。 |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | 回傳代表最內層例外的 Exception 物件的複本。 |
...
|  [Object](../object/object/)([Object](../object/) const\&) | 複製建構子。實際上不會複製任何內容，只會初始化新物件並允許子類別的複製建構。 |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | 指派運算子。實際上不會複製任何內容，只會初始化新物件並允許子類別的複製建構。 |
...
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../object/referenceequals/) 的特化，用於字串與 nullptr 情況。 |
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, [String](../string/) const\&) | [Object::ReferenceEquals](../object/referenceequals/) 的特化，用於字串情況。 |
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | 將共享參考計數減少指定值。 |
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | 設定 HRESULT，這是指派給特定例外的編碼數值。 |
...
| virtual const char * [what](../details_exception/what/)() const | 實作 [what()](../details_exception/what/) 方法，此方法由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，衍生類別仍可使用受保護/私有成員實作其邏輯。將此方法實作移至 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
...
* 類別 [Details_ArithmeticException](../details_arithmeticexception/)
* 命名空間 [System](../)
* 函式庫 [Aspose.Slides](../../)