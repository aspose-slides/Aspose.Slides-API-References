...
description: "TimeoutException 表示分配給程序或操作的時間已過期。切勿手動建立此類別的實例。使用 TimeoutException class。切勿將 TimeoutException class 實例包裝為 System::SmartPtr。"
type: docs
weight: 716
url: /zh-hant/system/details_timeoutexception/
---
## Details_TimeoutException 類別


TimeoutException 表示分配給流程或操作的時間已過期。切勿手動建立此類別的實例。請改用 TimeoutException 類別。切勿將 TimeoutException 類別的實例包裝至 [System::SmartPtr](../smartptr/)。
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點數比較，兩個 NaN 被視為相等，即使根據 IEC 60559:1989，NaN 並不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點數比較，兩個 NaN 被視為相等，即使根據 IEC 60559:1989，NaN 並不等於任何值，包括 NaN 本身。 |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 傳回 32 位元整數值，該值是與目前物件所表示的例外相關的 HRESULT 代碼。 |
...
|  [Object](../object/object/)([Object](../object/) const\&) | 複製建構函式。實際上不會複製任何內容，只會初始化新物件並允許子類別的複製建構。 |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | 賦值運算子。實際上不會複製任何內容，只會初始化新物件並允許子類別的複製建構。 |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | 以參考比較值類型物件與 nullptr。 |
...
| virtual const char * [what](../details_exception/what/)() const | [what()](../details_exception/what/) 方法由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，衍生類別仍可使用受保護/私有成員實作其邏輯。將此方法實作移至 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
