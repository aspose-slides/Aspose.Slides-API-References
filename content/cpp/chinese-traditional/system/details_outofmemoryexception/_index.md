...
type: docs
weight: 638
url: /zh-hant/system/details_outofmemoryexception/
---
## Details_OutOfMemoryException 類別
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 傳回與目前物件所表示的例外相關聯的 32 位元整數值（HRESULT 代碼）。 |
...
|  [Object](../object/object/)([Object](../object/) const\&) | 複製建構子。實際上不會複製任何內容，只是初始化新物件並允許子類別進行複製建構。 |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | 賦值運算子。實際上不會複製任何內容，只是初始化新物件並允許子類別進行複製建構。 |
...
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | 遞增共享參考計數。不要直接呼叫；請改用智慧指標或 ThisProtector。 |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | 遞增弱參考計數。不要直接呼叫；請改用智慧指標或 ThisProtector。 |
| void [WeakRefRemoved](../object/weakrefremoved/)() | 遞減弱參考計數。不要直接呼叫；請改用智慧指標或 ThisProtector。 |
| virtual const char * [what](../details_exception/what/)() const | 實作由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫的 [what()](../details_exception/what/) 方法。儘管此類別未從 std::exception 繼承，衍生類別仍可使用 protected/private 成員來實作其邏輯。將此方法實作移至 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
