...
type: docs
weight: 2107
url: /zh-hant/system/operator_less_equal/
---
...
判斷指定的值是否小於或等於由指定的 [Nullable](../nullable/) 物件所表示的值，方法是對這些值套用 [operator<=()](./)。
...
| --- | --- |
| T1 | 第一個比較項值的型別 |
| T2 | 代表第二個比較項值之 [Nullable](../nullable/) 物件的基礎型別 |

### 引數

| 參數 | 型別 | 描述 |
| --- | --- | --- |
| some | const T1\& | 作為第一個比較項之值的常量參考 |
| other | const [Nullable](../nullable/)\<T2\>\& | 作為第二個比較項之值的 [Nullable](../nullable/) 物件的常量參考 |

### 傳回值

如果第一個比較項小於或等於第二個比較項則傳回 True，否則傳回 false
