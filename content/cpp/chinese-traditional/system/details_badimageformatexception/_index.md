...
description: "當動態連結庫 (DLL) 或可執行程式的檔案映像無效時會拋出的例外。永遠不要手動建立此類別的實例。請改用 BadImageFormatException 類別。永遠不要將 BadImageFormatException 類別的實例包裝到 System::SmartPtr 中。"
type: docs
weight: 378
url: /zh-hant/system/details_badimageformatexception/
---
## Details_BadImageFormatException 類別


當動態連結庫 (DLL) 或可執行程式的檔案映像無效時會拋出的例外。永遠不要手動建立此類別的實例。請改用 BadImageFormatException 類別。永遠不要將 BadImageFormatException 類別的實例包裝到 [System::SmartPtr](../smartptr/) 中。
...
| virtual [String](../string/) [get_FileName](../details_exceptionwithfilename/get_filename/)() const | 取得導致此例外的檔案名稱。 |
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | 傳回 32 位元整數值，該值是與目前物件所表示的例外相關聯的 HRESULT 代碼。 |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | 傳回代表內部例外的物件參考。 |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | 傳回代表最內層例外的 Exception 物件副本。 |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](../details_systemexception/gettype/)() const override | 取得物件的實際類型。相當於 C# [System.Object.GetType()](../object/gettype/) 呼叫。 |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | 設定第 n 個模板參數為弱指標（而非共用）。允許在容器中將指標切換到弱模式。 |
| int [SharedCount](../object/sharedcount/)() const | 取得共用參考計數器的目前值。 |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | 遞增共用參考計數。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | 遞減並傳回共用參考計數。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
...
| virtual const char * [what](../details_exception/what/)() const | 實作 [what()](../details_exception/what/) 方法，此方法由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，衍生類別仍可使用受保護/私有成員來實作其邏輯。將此方法實作移至 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
| virtual  [~Object](../object/~object/)() | 銷毀物件。釋放所有內部資料結構。 |
## 另請參閱

* 類別 [Details_ExceptionWithFilename](../details_exceptionwithfilename/)
* 命名空間 [System](../)
* 函式庫 [Aspose.Slides](../../)