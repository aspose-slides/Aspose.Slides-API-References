...
description: "FormatException 是在方法參數的格式無效時拋出。切勿手動建立此類別的實例。請改用 FormatException 類別。切勿將 FormatException 類別的實例包裝到 System::SmartPtr 中。"
type: docs
weight: 469
url: /zh-hant/system/details_formatexception/
---
## Details_FormatException 類別


當方法參數的格式無效時，會拋出 FormatException。切勿手動建立此類別的實例。請改用 FormatException 類別。切勿將 FormatException 類別的實例包裝到 [System::SmartPtr](../smartptr/) 中。
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | C# [Object.GetHashCode()](../object/gethashcode/) 方法的類似實作。啟用自訂物件的雜湊。 |
...
| void [Lock](../object/lock/)() | 實作 C# lock() 陳述式的鎖定功能。直接呼叫或使用 [LockContext](../lockcontext/) 守護物件。 |
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../object/memberwiseclone/) 方法的類似實作。啟用自訂型別的複製。 |
...
| void [Unlock](../object/unlock/)() | 實作 C# lock() 陳述式的解鎖功能。直接呼叫或使用 [LockContext](../lockcontext/) 守護物件。 |
...
| virtual const char * [what](../details_exception/what/)() const | 實作 [what()](../details_exception/what/) 方法，該方法由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，衍生類別仍可使用 protected/private 成員來實作其邏輯。將此方法實作移至 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
