...
description: 表示一個包含多個內部例外的例外。
type: docs
weight: 300
url: /zh-hant/system/details_aggregateexception/
---
## Details_AggregateException 類別
...
| static std::enable_if\<[IsSmartPtr](../issmartptr/)\<T1\>::value\&&[IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | 以 C# 風格比較參考型別的物件。 |
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | 以 C# 風格比較值型別的物件。 |
...
| [AggregateException](../aggregateexception/) [Flatten](./flatten/)() | 將聚合例外展平，將所有巢狀的 AggregateExceptions 展開為單層列表。 |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | 傳回指向代表內部例外之物件的參考。 |
| **int32_t** [get_InnerExceptionCount](./get_innerexceptioncount/)() | 取得此聚合例外所包含的內部例外數量。 |
| [SharedPtr](../sharedptr/)\<[Collections::ObjectModel::ReadOnlyCollection](../../system.collections.objectmodel/readonlycollection/)\<[Exception](../exception/)\>\> [get_InnerExceptions](./get_innerexceptions/)() | 取得內部例外的唯讀集合。 |
| const [ArrayPtr](../arrayptr/)\<[Exception](../exception/)\>\& [get_InternalInnerExceptions](./get_internalinnerexceptions/)() | 傳回內部例外的陣列。 |
| [String](../string/) [get_Message](./get_message/)() const override | 覆寫基底訊息以包含所有內部例外的聚合資訊。 |
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | 傳回包含堆疊追蹤的字串。 |
| [Exception](../exception/) [GetBaseException](./getbaseexception/)() const override | 透過遞迴展開內部例外，傳回根本原因例外。 |
...
| void [Handle](./handle/)(const [Func](../func/)\<[Exception](../exception/), **bool**\>\&) | 對每個內部例外呼叫處理函式，並重新拋出任何未處理的例外。 |
...
| [String](../string/) [ToString](./tostring/)() const override | 傳回例外的字串表示，包括所有內部例外。 |
...
| virtual const char * [what](../details_exception/what/)() const | 實作 [what()](../details_exception/what/) 方法，該方法由 [ExceptionWrapper](../exceptionwrapper/) 類別呼叫。儘管此類別未從 std::exception 繼承，衍生類別仍可使用受保護/私有成員來實作其邏輯。將此方法實作移至 [ExceptionWrapper](../exceptionwrapper/) 可能會破壞該邏輯。 |
| virtual  [~Object](../object/~object/)() | 銷毀物件。釋放所有內部資料結構。 |

## 備註

此類別通常用於將同時發生的多個例外分組，例如在平行處理或非同步任務執行情境中。它允許使用者檢查、展平或選擇性處理所包含的例外。
