...
description: 指出可將列舉視為位元欄位；亦即，一組。
type: docs
weight: 846
url: /zh-hant/system/flagsattribute/
---
## FlagsAttribute 類別
...
| static [Object::ptr](../object/ptr/) [GetCustomAttribute](../attribute/getcustomattribute/)(const [TypeInfo](../typeinfo/)\&, const [TypeInfo](../typeinfo/)\&) | 傳回套用於指定型別的指定類型自訂屬性。 |
| static [ArrayPtr](../arrayptr/)\<[Object::ptr](../object/ptr/)\> [GetCustomAttributes](../attribute/getcustomattributes/)(const [TypeInfo](../typeinfo/)\&) | 傳回套用於指定型別的所有自訂屬性。 |
