...
description: 當在 XSLT 樣式表中發現錯誤時，由 Load 方法拋出的例外。
type: docs
weight: 1
url: /zh-hant/system.xml.xsl/details_xsltcompileexception/
---
## Details_XsltCompileException 類別


當在 XSLT 樣式表中發現錯誤時，由 **Load** 方法拋出的例外。
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | 傳回含有自訂例外資料的字典。 |
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 傳回 32 位元整數值，該值為與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | 傳回表示內部例外之物件的參考。 |
| virtual **int32_t** [get_LineNumber](../details_xsltexception/get_linenumber/)() | 傳回顯示錯誤發生於樣式表之行號。 |
| virtual **int32_t** [get_LinePosition](../details_xsltexception/get_lineposition/)() | 傳回顯示錯誤發生於樣式表之行位置。 |
| [String](../../system/string/) [get_Message](../details_xsltexception/get_message/)() const override | 傳回描述目前例外的格式化錯誤訊息。 |
| virtual [String](../../system/string/) [get_SourceUri](../details_xsltexception/get_sourceuri/)() | 傳回樣式表的位置路徑。 |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | 取得物件的實際類型。C# [System.Object.GetType()](../../system/object/gettype/) 呼叫的類比。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷貝建構子。實際上什麼也不拷貝，只是初始化新物件並允許子類別的拷貝建構。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 指派運算子。實際上什麼也不拷貝，只是初始化新物件並允許子類別的拷貝建構。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 實作 [what()](../../system/details_exception/what/) 方法，此方法由 [ExceptionWrapper](../../system/exceptionwrapper/) 類別呼叫。即使此類別未繼承自 std::exception，衍生類別仍可使用受保護/私有成員實作其邏輯。將此方法實作移至 [ExceptionWrapper](../../system/exceptionwrapper/) 可能會破壞該邏輯。 |
...
* 類別 [Details_XsltException](../details_xsltexception/)
* 命名空間 [System::Xml::Xsl](../)
* 函式庫 [Aspose.Slides](../../)