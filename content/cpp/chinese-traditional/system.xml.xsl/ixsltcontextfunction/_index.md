...
description: 在執行時期，提供對在可擴充樣式表語言轉換 (XSLT) 樣式表中定義的特定函式的介面。
type: docs
weight: 27
url: /zh-hant/system.xml.xsl/ixsltcontextfunction/
---
## IXsltContextFunction 類別

在執行時期，提供對在可擴充樣式表語言轉換 (XSLT) 樣式表中定義的特定函式的介面。
...
| virtual [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\> [get_ArgTypes](./get_argtypes/)() | 傳回提供的 XML 路徑語言 ([XPath](../../system.xml.xpath/)) 類型，用於函式的參數清單。此資訊可用於偵測函式的簽章，讓您區分重載的函式。 |
| virtual **int32_t** [get_Maxargs](./get_maxargs/)() | 傳回函式的最大參數數量。此功能讓使用者能區分重載的函式。 |
| virtual **int32_t** [get_Minargs](./get_minargs/)() | 傳回函式的最小參數數量。此功能讓使用者能區分重載的函式。 |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_ReturnType](./get_returntype/)() | 傳回 XPathResultType，表示函式回傳的 [XPath](../../system.xml.xpath/) 類型。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。啟用自訂物件的雜湊。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際類型。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Invoke](./invoke/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>, [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>, [SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | 提供在指定情境下使用給定參數呼叫函式的方法。 |
