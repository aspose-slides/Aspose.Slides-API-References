...
description: 封裝 XSLT（可擴充樣式表語言轉換）處理器的當前執行環境，允許 XML 路徑語言（XPath）在 XPath 表達式中解析函式、參數和名稱空間。
type: docs
weight: 79
url: /zh-hant/system.xml.xsl/xsltcontext/
---
## XsltContext 類別

封裝 XSLT 處理器的當前執行環境，允許 XML 路徑語言 ([XPath](../../system.xml.xpath/)) 在 [XPath](../../system.xml.xpath/) 表達式中解析函式、參數和名稱空間。
...
| 方法 | 說明 |
| --- | --- |
| virtual void [AddNamespace](../../system.xml/xmlnamespacemanager/addnamespace/)([String](../../system/string/), [String](../../system/string/)) | 將給定的名稱空間新增到集合中。 |
...
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | 在衍生類別中覆寫時，根據兩個文件被 XSLT 處理器（即 [XslTransform](../xsltransform/) 類別）載入的順序，比較其基礎統一資源識別符（URI）。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 取得指向 const 限定實例的集合中最後一個元素（若有）之後的迭代器。 |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | 傳回預設名稱空間的 URI。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | 傳回與此物件關聯的 [XmlNameTable](../../system.xml/xmlnametable/)。 |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | 在衍生類別中覆寫時，取得指示是否在輸出中包含空白節點的值。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數器資料結構。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | 傳回用於遍歷 [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) 中名稱空間的列舉器。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。啟用自訂物件的雜湊。 |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](../../system.xml/xmlnamespacemanager/getnamespacesinscope/)([XmlNamespaceScope](../../system.xml/xmlnamespacescope/)) override | 傳回以前置詞為鍵的名稱空間名稱集合，可用於列舉目前在作用域中的名稱空間。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際類型。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
| virtual **bool** [HasNamespace](../../system.xml/xmlnamespacemanager/hasnamespace/)([String](../../system/string/)) | 傳回指示提供的前置詞在目前推入的作用域中是否已定義名稱空間的值。 |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | 傳回序列的第一個元素，如果序列為空則回傳預設值。 |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | 傳回序列的最後一個元素，如果序列為空則回傳預設值。 |
...
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | 傳回指定前置詞的名稱空間 URI。 |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | 找出給定名稱空間 URI 所宣告的前置詞。 |
...
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | 從堆疊彈出一個名稱空間作用域。 |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | 在衍生類別中覆寫時，評估在給定的上下文中是否保留或剝除空白節點。 |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | 將名稱空間作用域推入堆疊。 |
...
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | 移除給定前置詞的指定名稱空間。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextFunction](../ixsltcontextfunction/)\> [ResolveFunction](./resolvefunction/)([String](../../system/string/), [String](../../system/string/), [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\>) | 在衍生類別中覆寫時，解析函式參考並回傳代表該函式的 [IXsltContextFunction](../ixsltcontextfunction/)。執行時使用 [IXsltContextFunction](../ixsltcontextfunction/) 取得函式的回傳值。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | 在衍生類別中覆寫時，解析變數參考並回傳代表該變數的 [IXsltContextVariable](../ixsltcontextvariable/)。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設定為弱指標（而非共享）。允許在容器中將指標切換為弱模式。 |
| int [SharedCount](../../system/object/sharedcount/)() const | 取得共享參考計數器的目前值。 |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 遞增共享參考計數。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 遞減並回傳共享參考計數。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | 相當於 C# [Object.ToString()](../../system/object/tostring/) 方法。啟用將自訂物件轉換為字串。 |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | 实作 C# typeof([System.Object](../../system/object/)) 建構。 |
...
| [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | 使用指定的 [XmlNameTable](../../system.xml/xmlnametable/) 初始化 [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) 類別的新實例。 |
