...
description: 提供在執行期間於樣式表中定義之變數的介面。
type: docs
weight: 40
url: /zh-hant/system.xml.xsl/ixsltcontextvariable/
---
## IXsltContextVariable 類別


提供在執行期間於樣式表中定義之變數的介面。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，儘管根據 IEC 60559:1989 規範，NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，儘管根據 IEC 60559:1989 規範，NaN 不等於任何值，包括 NaN 本身。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Evaluate](./evaluate/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>) | 在執行期間評估變數，並回傳代表變數值的物件。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| virtual **bool** [get_IsLocal](./get_islocal/)() | 回傳指示變數是否為本地的值。 |
| virtual **bool** [get_IsParam](./get_isparam/)() | 回傳指示變數是否為可擴充樣式語言轉換（XSLT）參數的值。這可以是樣式表或範本的參數。 |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_VariableType](./get_variabletype/)() | 回傳代表變數之 XML 路徑語言（[XPath](../../system.xml.xpath/)）型別的 XPathResultType。 |
