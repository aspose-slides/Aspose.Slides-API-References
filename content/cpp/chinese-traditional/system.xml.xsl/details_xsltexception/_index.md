...
description: 在處理 XSLT 轉換時發生錯誤時拋出的例外。
type: docs
weight: 14
url: /zh-hant/system.xml.xsl/details_xsltexception/
---
## Details_XsltException 類別


此例外在處理 XSLT 轉換時發生錯誤時拋出。
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | 傳回表示錯誤發生於樣式表哪一行的行號。 |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | 傳回表示錯誤發生於樣式表的行位置。 |
| [String](../../system/string/) [get_Message](./get_message/)() const override | 傳回描述目前例外的格式化錯誤訊息。 |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | 傳回樣式表的路徑位置。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 實作 [what()](../../system/details_exception/what/) 方法，此方法由 [ExceptionWrapper](../../system/exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，但衍生類別可以使用受保護/私有成員來實作其邏輯。將此方法的實作移至 [ExceptionWrapper](../../system/exceptionwrapper/) 可能會破壞該邏輯。 |
