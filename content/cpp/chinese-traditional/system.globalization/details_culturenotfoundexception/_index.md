...
description: "當嘗試建立不可用的文化時，會拋出 CultureNotFoundException。切勿手動建立此類別的實例。請改用 CultureNotFoundException 類別。切勿將 CultureNotFoundException 類別的實例包裝成 System::SmartPtr。"
type: docs
weight: 92
url: /zh-hant/system.globalization/details_culturenotfoundexception/
---
## Details_CultureNotFoundException 類別

CultureNotFoundException 會在嘗試建構不可用的文化時拋出。切勿手動建立此類別的實例。請改用 CultureNotFoundException 類別。切勿將 CultureNotFoundException 類別的實例包裝到 [System::SmartPtr](../../system/smartptr/) 中。
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | 回傳含有自訂例外資料的字典。 |
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 回傳 32 位元整數值，該值為與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | 取得物件的實際型別。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
