...
description: 取得特定月份的天數。
type: docs
weight: 92
url: /zh-hant/system.globalization/japanesecalendar/getdaysinmonth/
---
## JapaneseCalendar::GetDaysInMonth(int, int, int) const 方法
...
## JapaneseCalendar::GetDaysInMonth(int, int) const 方法
