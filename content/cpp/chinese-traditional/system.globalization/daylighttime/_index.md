...
description: "夏令時間的期間。此類別的物件應僅使用 System::MakeObject() 函式進行配置。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤或斷言失敗。始終將此類別包裝成 System::SmartPtr 指標，並使用此指標作為參數傳遞給函式。"
type: docs
weight: 79
url: /zh-hant/system.globalization/daylighttime/
---
## DaylightTime 類別

夏令時間期間。此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤或斷言失敗。永遠將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標作為參數傳遞給函式。
...
| 方法 | 說明 |
| --- | --- |
|  [DaylightTime](./daylighttime/)([DateTime](../../system/datetime/), [DateTime](../../system/datetime/), [TimeSpan](../../system/timespan/)) | RTTI 資訊。 |
...
| [TimeSpan](../../system/timespan/) [get_Delta](./get_delta/)() const | 取得標準時間與夏令時間之間的差異。 |
| [DateTime](../../system/datetime/) [get_End](./get_end/)() const | 取得夏令時間結束的日期與時間。 |
| [DateTime](../../system/datetime/) [get_Start](./get_start/)() const | 取得夏令時間開始的日期與時間。 |
