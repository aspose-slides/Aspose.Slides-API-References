...
description: "提供有關用於比較和排序字串的 Unicode 版號資訊。此類別的物件應僅透過 System::MakeObject() 函式配置。切勿在堆疊上或使用 operator new 建立此類型的實例，否則會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用此指標將其作為參數傳遞給函式。"
type: docs
weight: 300
url: /zh-hant/system.globalization/sortversion/
---
## SortVersion 類別

提供有關用於比較和排序字串的 Unicode 版號資訊。此類別的物件僅應使用 [System::MakeObject()](../../system/makeobject/) 函式進行配置。切勿在堆疊上或使用 operator new 建立此類型的實例，否則會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標將其作為參數傳遞給函式。
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[SortVersion](./)\>) override | 檢查目前的 [SortVersion](./) 實例是否等於指定的 [SortVersion](./) 物件。 |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | 檢查目前的 [SortVersion](./) 實例是否等於指定的 [SortVersion](./) 物件。 |
...
| int [get_FullVersion](./get_fullversion/)() | 取得完整版本號。 |
| [Guid](../../system/guid/) [get_SortId](./get_sortid/)() | 取得此物件的唯一識別碼。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| int [GetHashCode](./gethashcode/)() const override | 取得目前物件的雜湊碼。 |
...
| **bool** [operator!=](./operator_not_equal/)(const [SortVersion](./)\&) | 檢查目前的 [SortVersion](./) 實例是否不等於指定的 [SortVersion](./) 物件。 |
...
| **bool** [operator==](./operator_equal_equal/)(const [SortVersion](./)\&) | 檢查目前的 [SortVersion](./) 實例是否等於指定的 [SortVersion](./) 物件。 |
...
|  [SortVersion](./sortversion/)(int, const [Guid](../../system/guid/)\&) | RTTI 資訊。 |
