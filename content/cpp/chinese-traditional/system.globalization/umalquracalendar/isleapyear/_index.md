...
description: 檢查該年份是否為閏年。
type: docs
weight: 92
url: /zh-hant/system.globalization/umalquracalendar/isleapyear/
---
## UmAlQuraCalendar::IsLeapYear(int, int) const 方法
...
如果指定的年份是閏年則返回 True，否則返回 false。

## UmAlQuraCalendar::IsLeapYear(int) const 方法
