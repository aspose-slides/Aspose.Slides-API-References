...
description: 實作 IEnumerator 介面以處理空的泛型集合。
type: docs
weight: 27
url: /zh-hant/system.linq.details/emptyenumerator/
---
## EmptyEnumerator 類別
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const override | 取得目前元素。 |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 執行第一次 [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 呼叫，並為 VirtualizedIterator 使用的列舉器物件做準備。 |
...
| **bool** [MoveNext](./movenext/)() override | 將列舉器移至下一個元素。若先前未參照任何元素，則設定參照至第一個可用元素。若已到達容器末端，則什麼也不做。 |
...
| void [Reset](./reset/)() override | 將列舉器重設至第一個元素之前的位置。 |
