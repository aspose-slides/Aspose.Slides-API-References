...
description: "虛擬類別，用於使使用 IButtonControl 介面的已翻譯程式碼能夠編譯。此類別的物件應僅透過 System::MakeObject() 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 27
url: /zh-hant/system.windows.forms/ibuttoncontrol/
---
## IButtonControl 類別


虛擬類別，用於使使用 [IButtonControl](./) 介面的已翻譯程式碼能夠編譯。此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
...
| virtual [DialogResult](../dialogresult/) [get_DialogResult](./get_dialogresult/)() | 取得與按鈕相關的對話方塊結果。 |
...
| virtual void [NotifyDefault](./notifydefault/)(**bool**) | 將控制項設定為預設或非預設。 |
|  [Object](../../system/object/object/)() | 建立物件。初始化所有內部資料結構。 |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 複製建構函式。實際上並未複製任何東西，只是初始化新物件並允許子類別的複製建構。 |
...
| virtual void [PerformClick](./performclick/)() | 對按鈕執行點擊。 |
...
| virtual void [set_DialogResult](./set_dialogresult/)([DialogResult](../dialogresult/)) | 設定與按鈕相關的對話方塊結果。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 將共享參考計數減少並返回。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | 將弱參考計數減少。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
