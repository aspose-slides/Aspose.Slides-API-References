...
description: 提供顯示器資訊。僅限 Windows。這是一種單例類型，記憶體管理由存取函式完成。您不應直接建立其實例。
type: docs
weight: 40
url: /zh-hant/system.windows.forms/screen/
---
## Screen 類別

提供顯示器資訊。僅 [Windows](../../system.windows/)。這是一種單例類型，記憶體管理由存取函式完成。您不應直接建立其實例。
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅限內部使用。 |
| **Rectangle_** [get_Bounds](./get_bounds/)() const | 取得螢幕邊界。 |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | 取得主要顯示器的資訊。 |
