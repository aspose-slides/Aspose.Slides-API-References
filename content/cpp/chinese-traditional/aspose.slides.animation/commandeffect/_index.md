...
| [System::String](../../system/string/) [get_CommandString](./get_commandstring/)() override | 定義指令字串。讀取 [System::String](../../system/string/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_ShapeTarget](./get_shapetarget/)() override | 定義指令效果的形狀目標。讀取 [IShape](../../aspose.slides/ishape/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | 表示效果行為的時間屬性。讀取 [ITiming](../itiming/)。 |
| [CommandEffectType](../commandeffecttype/) [get_Type](./get_type/)() override | 定義行為的指令效果類型。讀取 [CommandEffectType](../commandeffecttype/)。 |
...
| void [set_CommandString](./set_commandstring/)([System::String](../../system/string/)) override | 定義指令字串。寫入 [System::String](../../system/string/)。 |
| void [set_ShapeTarget](./set_shapetarget/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | 定義指令效果的形狀目標。寫入 [IShape](../../aspose.slides/ishape/)。 |
...
| void [set_Type](./set_type/)([CommandEffectType](../commandeffecttype/)) override | 定義行為的指令效果類型。寫入 [CommandEffectType](../commandeffecttype/)。 |
...
* 類別 [ICommandEffect](../icommandeffect/)
