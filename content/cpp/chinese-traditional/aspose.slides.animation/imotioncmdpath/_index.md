...
| virtual [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() | 指定指令類型。讀取 [MotionCommandPathType](../motioncommandpathtype/)。 |
| virtual **bool** [get_IsRelative](./get_isrelative/)() | 確定指令座標是否為相對座標。讀取 **bool**。 |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | 指定指令的點。讀取 [System::Drawing::PointF](../../system.drawing/pointf/)[]。 |
| virtual [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() | 指定指令點的類型。讀取 [MotionPathPointsType](../motionpathpointstype/)。 |
...
| virtual void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) | 指定指令類型。寫入 [MotionCommandPathType](../motioncommandpathtype/)。 |
| virtual void [set_IsRelative](./set_isrelative/)(**bool**) | 確定指令座標是否為相對座標。寫入 **bool**。 |
| virtual void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) | 指定指令的點。寫入 [System::Drawing::PointF](../../system.drawing/pointf/)[]。 |
| virtual void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) | 指定指令點的類型。寫入 [MotionPathPointsType](../motionpathpointstype/)。 |
