...
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../behavior/get_accumulate/)() override | 表示是否累積動畫行為。閱讀 [NullableBool](../../aspose.slides/nullablebool/)。 |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | 表示目前的動畫行為是否與其他執行中的動畫結合。閱讀 [BehaviorAdditiveType](../behavioradditivetype/)。 |
| **float** [get_By](./get_by/)() override | 描述動畫的相對位移值。閱讀 **float**。 |
| **float** [get_From](./get_from/)() override | 描述動畫的起始值。閱讀 **float**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | 表示效果行為的時間屬性。閱讀 [ITiming](../itiming/)。 |
| **float** [get_To](./get_to/)() override | 描述動畫的結束值。閱讀 **float**。 |
...
| void [set_Accumulate](../behavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | 表示是否累積動畫行為。寫入 [NullableBool](../../aspose.slides/nullablebool/)。 |
...
| void [set_By](./set_by/)(**float**) override | 描述動畫的相對位移值。寫入 **float**。 |
| void [set_From](./set_from/)(**float**) override | 描述動畫的起始值。寫入 **float**。 |
...
| void [set_To](./set_to/)(**float**) override | 描述動畫的結束值。寫入 **float**。 |
...
* 類別 [IRotationEffect](../irotationeffect/)
