...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 比較引用型別物件，採用 C# 風格。 |
...
| **float** [get_Value0](./get_value0/)() override | 定義偏移的第一個值。讀取 **float**。 |
| **float** [get_Value1](./get_value1/)() override | 定義偏移的第二個值。讀取 **float**。 |
| **float** [get_Value2](./get_value2/)() override | 定義偏移的第三個值。讀取 **float**。 |
...
| void [set_Value0](./set_value0/)(**float**) override | 定義偏移的第一個值。寫入 **float**。 |
| void [set_Value1](./set_value1/)(**float**) override | 定義偏移的第二個值。寫入 **float**。 |
| void [set_Value2](./set_value2/)(**float**) override | 定義偏移的第三個值。寫入 **float**。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設為 weak 指標（而非 shared）。允許在容器中將指標切換為 weak 模式。 |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | 遞增 weak 參考計數。不應直接呼叫；請使用智慧指標或 ThisProtector。 |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | 遞減 weak 參考計數。不應直接呼叫；請使用智慧指標或 ThisProtector。 |
| virtual  [~Object](../../system/object/~object/)() | 銷毀物件。釋放所有內部資料結構。 |

## 另見

* 類別 [IColorOffset](../icoloroffset/)
