...
| virtual **float** [get_Value0](./get_value0/)() | 定義偏移的第一個值。讀取 **float**。 |
| virtual **float** [get_Value1](./get_value1/)() | 定義偏移的第二個值。讀取 **float**。 |
| virtual **float** [get_Value2](./get_value2/)() | 定義偏移的第三個值。讀取 **float**。 |
...
| virtual void [set_Value0](./set_value0/)(**float**) | 定義偏移的第一個值。寫入 **float**。 |
| virtual void [set_Value1](./set_value1/)(**float**) | 定義偏移的第二個值。寫入 **float**。 |
| virtual void [set_Value2](./set_value2/)(**float**) | 定義偏移的第三個值。寫入 **float**。 |
