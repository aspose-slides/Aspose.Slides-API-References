...
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../ibehavior/get_additive/)() | 表示目前的動畫行為是否與其他正在執行的動畫結合。讀取 [BehaviorAdditiveType](../behavioradditivetype/)。 |
| virtual [System::String](../../system/string/) [get_CommandString](./get_commandstring/)() | 定義指令字串。讀取 [System::String](../../system/string/)。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_ShapeTarget](./get_shapetarget/)() | 定義指令效果的形狀目標。讀取 [IShape](../../aspose.slides/ishape/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../ibehavior/get_timing/)() | 表示效果行為的時間屬性。讀取 [ITiming](../itiming/)。 |
| virtual [CommandEffectType](../commandeffecttype/) [get_Type](./get_type/)() | 定義行為的指令效果類型。讀取 [CommandEffectType](../commandeffecttype/)。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的專門化版本，用於字串與 nullptr 的情況。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的專門化版本，用於字串的情況。 |
...
| virtual void [set_Additive](../ibehavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | 表示目前的動畫行為是否與其他正在執行的動畫結合。寫入 [BehaviorAdditiveType](../behavioradditivetype/)。 |
| virtual void [set_CommandString](./set_commandstring/)([System::String](../../system/string/)) | 定義指令字串。寫入 [System::String](../../system/string/)。 |
| virtual void [set_ShapeTarget](./set_shapetarget/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | 定義指令效果的形狀目標。寫入 [IShape](../../aspose.slides/ishape/)。 |
...
| virtual void [set_Type](./set_type/)([CommandEffectType](../commandeffecttype/)) | 定義行為的指令效果類型。寫入 [CommandEffectType](../commandeffecttype/)。 |
