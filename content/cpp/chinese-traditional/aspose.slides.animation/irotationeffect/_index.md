...
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../ibehavior/get_accumulate/)() | 表示動畫行為是否被累積。讀取 [NullableBool](../../aspose.slides/nullablebool/)。 |
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../ibehavior/get_additive/)() | 表示當前動畫行為是否與其他正在執行的動畫結合。讀取 [BehaviorAdditiveType](../behavioradditivetype/)。 |
| virtual **float** [get_By](./get_by/)() | 描述動畫的相對位移值。讀取 **float**。 |
| virtual **float** [get_From](./get_from/)() | 描述動畫的起始值。讀取 **float**。 |
...
| virtual **float** [get_To](./get_to/)() | 描述動畫的結束值。讀取 **float**。 |
...
| virtual void [set_Accumulate](../ibehavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | 表示動畫行為是否被累積。寫入 [NullableBool](../../aspose.slides/nullablebool/)。 |
| virtual void [set_Additive](../ibehavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | 表示當前動畫行為是否與其他正在執行的動畫結合。寫入 [BehaviorAdditiveType](../behavioradditivetype/)。 |
| virtual void [set_By](./set_by/)(**float**) | 描述動畫的相對位移值。寫入 **float**。 |
| virtual void [set_From](./set_from/)(**float**) | 描述動畫的起始值。寫入 **float**。 |
...
| virtual void [set_To](./set_to/)(**float**) | 描述動畫的結束值。寫入 **float**。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設定為弱指標（而非共享）。允許在容器中將指標切換為弱引用模式。 |
