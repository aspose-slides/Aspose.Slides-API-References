...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | 新增交互式序列。可讀寫 [Sequence](../sequence/)。 |
| [iterator](./iterator/) [begin](./begin/)() | 取得指向集合中第一個元素（如果有）的迭代器。 |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | 取得指向 const 限定的集合實例中第一個元素（如果有）的迭代器。 |
...
| void [Clear](./clear/)() override | 從集合中移除所有序列。 |
| [iterator](./iterator/) [end](./end/)() | 取得指向集合中最後一個元素（如果有）之後的迭代器。 |
| [const_iterator](./const_iterator/) [end](./end/)() const | 取得指向 const 限定的集合實例中最後一個元素（如果有）之後的迭代器。 |
...
| **int32_t** [get_Count](./get_count/)() override | 回傳集合中元素的數量，唯讀 **int32_t**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>\>\> [GetEnumerator](./getenumerator/)() override | 回傳可遍歷集合的列舉器。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [idx_get](./idx_get/)(**int32_t**) override | 回傳指定索引處的序列。 |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>) override | 從集合中移除指定的序列。 |
| void [RemoveAt](./removeat/)(**int32_t**) override | 移除指定索引處的序列。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將共享參考計數減少指定的值。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設為弱指標（而非共享）。允許在容器中將指標切換為弱模式。 |
| int [SharedCount](../../system/object/sharedcount/)() const | 取得共享參考計數器的目前值。 |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 遞增共享參考計數。不應直接呼叫；請改用智能指標或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 遞減並回傳共享參考計數。不應直接呼叫；請改用智能指標或 ThisProtector。 |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 取得指向 const 限定的集合實例中第一個元素（如果有）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 取得指向集合中第一個元素（如果有）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 取得指向 const 限定的集合實例中最後一個元素（如果有）之後的迭代器。 |
...
| Typedef | Description |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 在目前集合中使用其迭代器類型作為迭代器類型的集合型別。 |
...
* 類別 [ISequenceCollection](../isequencecollection/)
