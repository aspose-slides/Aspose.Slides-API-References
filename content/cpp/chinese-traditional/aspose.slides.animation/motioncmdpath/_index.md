...
| [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() override | 指定指令類型。閱讀 [MotionCommandPathType](../motioncommandpathtype/)。 |
| **bool** [get_IsRelative](./get_isrelative/)() override | 判斷指令座標是否為相對座標。讀取 **bool**。 |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() override | 指定指令的點。讀取 [System::Drawing::PointF](../../system.drawing/pointf/)[]。 |
| [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() override | 指定指令點的型別。讀取 [MotionPathPointsType](../motionpathpointstype/)。 |
...
| void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) override | 指定指令類型。寫入 [MotionCommandPathType](../motioncommandpathtype/)。 |
| void [set_IsRelative](./set_isrelative/)(**bool**) override | 判斷指令座標是否為相對座標。寫入 **bool**。 |
| void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) override | 指定指令的點。寫入 [System::Drawing::PointF](../../system.drawing/pointf/)[]。 |
| void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) override | 指定指令點的型別。寫入 [MotionPathPointsType](../motionpathpointstype/)。 |
