...
| 方法 | 說明 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | 將新效果新增至目前序列的結尾以至於群組文字動畫的結尾。僅在文字段落的計數大於或等於此群組效果的計數時有效！ |
...
| virtual [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() | 文字動畫的建置類型清單（例如 [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once）。讀取 [BuildType](../buildtype/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() | 與群組連結的形狀效果（或為 null）。讀取 [IEffect](../ieffect/)。 |
...
| virtual void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) | 文字動畫的建置類型清單（例如 [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once）。寫入 [BuildType](../buildtype/)。 |
| virtual void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) | 與群組連結的形狀效果（或為 null）。寫入 [IEffect](../ieffect/)。 |
