...
---
## IBehaviorPropertyCollection 類別
...
| 方法 | 描述 |
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | 將新屬性新增至集合中。 |
| virtual void [Add](../../system.collections.generic/icollection/add/)(const T\&) | 將元素新增至集合中。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 取得指向集合中第一個元素（若有）的迭代器。此迭代器無法用來變更所參照的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的副本物件。 |
...
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | 判斷 [ICollection](../../system.collections.generic/icollection/) 是否包含特定值。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 取得指向集合中最後一個元素之後的迭代器（若有）。此迭代器無法用來變更所參照的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的副本物件。 |
...
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | 依據屬性值在 [IList](../../system.collections.generic/ilist/) 中判定特定項目的索引。 |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | 取得項目在容器中首次出現的索引。 |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | 在指定索引處於集合中插入新屬性（使用指定的屬性值）。 |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | 在指定位置插入元素，並將其他元素往後移動。 |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | 從集合中移除指定屬性。 |
