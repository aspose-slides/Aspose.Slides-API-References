...
| 方法 | 說明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) override | 將新效果加入目前序列的末端，以結束群組文字動畫。僅在文字段落的計數大於或等於此群組效果的計數時有效！ |
...
| [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() override | 文字動畫的建置類型清單（例如 [Paragraph](../../aspose.slides/paragraph/) 1,2,3,一次全部）。讀取 [Animation::BuildType](../buildtype/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() override | 與群組連結的形狀效果，若無則為 null。讀取 [IEffect](../ieffect/)。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 之針對字串與 nullptr 的特化。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) 之針對字串的特化。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 依指定值減少共享參考計數。 |
| void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) override | 文字動畫的建置類型清單（例如 [Paragraph](../../aspose.slides/paragraph/) 1,2,3,一次全部）。寫入 [Animation::BuildType](../buildtype/)。 |
| void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) override | 與群組連結的形狀效果，若無則為 null。寫入 [IEffect](../ieffect/)。 |
...
* 類別 [ITextAnimation](../itextanimation/)
