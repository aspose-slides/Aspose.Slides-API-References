...
description: 計時器事件的參數。
type: docs
weight: 1
url: /zh-hant/system.timers/elapsedeventargs/
---
## ElapsedEventArgs 類別
...
| 方法 | 說明 |
| --- | --- |
|  [ElapsedEventArgs](./elapsedeventargs/)(**int32_t**, **int32_t**) | 使用給定的參數建立引數物件。 |
...
| [DateTime](../../system/datetime/) [get_SignalTime](./get_signaltime/)() | 取得訊號時間。 |
...
| 欄位 | 說明 |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | 表示「空」[EventArgs](../../system/eventargs/) 共享指標（null-pointer）的靜態成員。 |
