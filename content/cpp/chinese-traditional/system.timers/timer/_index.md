...
description: 在迴圈中呼叫委派的計時器。
type: docs
weight: 14
url: /zh-hant/system.timers/timer/
---
## Timer 類別
...
| 方法 | 說明 |
| --- | --- |
| void [Close](./close/)() | 停止計時器，釋放已分配的資源。 |
|  [Component](../../system.componentmodel/component/component/)() | RTTI 資訊。 |
| void [Dispose](./dispose/)() | 停止計時器，釋放已分配的資源。 |
...
| **bool** [get_AutoReset](./get_autoreset/)() const | 檢查計時器是否處於自動重設模式。 |
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | 檢查元件是否處於設計模式。 |
| **bool** [get_Enabled](./get_enabled/)() const | 檢查計時器是否為活躍狀態。 |
| **double** [get_Interval](./get_interval/)() const | 取得計時器間隔。 |
| **bool** [get_IsStopped](./get_isstopped/)() const | 檢查計時器是否已停止。 |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | 將計時器設定為自動重設模式或取消該模式。 |
| void [set_Enabled](./set_enabled/)(**bool**) | 啟動或停止計時器。若計時器已在執行，啟動計時器不會重新計算時間。 |
| void [set_Interval](./set_interval/)(**double**) | 設定計時器間隔。 |
...
| void [Start](./start/)() | 啟動計時器。若計時器已在執行，則不重新計算時間。 |
| void [Stop](./stop/)() | 停止計時器。 |
|  [Timer](./timer/)() | RTTI 資訊。 |
|  [Timer](./timer/)(**double**) | 以指定間隔建構已停止的計時器。 |
