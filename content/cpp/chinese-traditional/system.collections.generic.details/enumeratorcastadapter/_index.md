...
description: 由 IEnumerable.Cast() 延伸方法使用的列舉器。
type: docs
weight: 53
url: /zh-hant/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter 類別

由 IEnumerable.Cast() 延伸方法使用的列舉器。
...
| 方法 | 描述 |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | 準備迭代器供 VirtualizedIterator 類別使用。 |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | 取得目前元素。 |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | 將迭代器前進一步。 |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 執行第一次 [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 呼叫，並準備列舉器物件供 VirtualizedIterator 使用。 |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | 標記由虛擬化迭代器擁有的列舉器。 |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | 相當於 C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法。啟用自訂型別的複製。 |
| **bool** [MoveNext](./movenext/)() override | 將列舉器移動至下一個元素。若之前未參照任何元素，則設定參照為第一個可用元素。若已到容器結尾，則不執行任何操作。 |
...
| void [Reset](./reset/)() override | 將列舉器重設到第一個元素之前的位置。 |
