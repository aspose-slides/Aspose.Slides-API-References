...
description: 列舉器用於 IEnumerable.OfType() 擴充方法。
type: docs
weight: 66
url: /zh-hant/system.collections.generic.details/enumeratoroftypeadapter/
---
## EnumeratorOfTypeAdapter 類別
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](../../system.collections.generic/ienumerator/current/)() const | 取得當前元素。 |
| virtual void [Dispose](../../system/idisposable/dispose/)() | 什麼都不做。 |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | 取得當前元素。 |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | 標記虛擬化迭代器擁有的列舉器。 |
...
| **bool** [MoveNext](./movenext/)() override | 將列舉器移動到下一個元素。如果之前未參照任何元素，則設定參照為第一個可用元素。若已達容器結尾，則什麼都不做。 |
