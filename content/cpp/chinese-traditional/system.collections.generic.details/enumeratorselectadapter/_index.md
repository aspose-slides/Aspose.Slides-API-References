...
description: 由 IEnumerable.Select() 擴充方法使用的列舉器。
type: docs
weight: 79
url: /zh-hant/system.collections.generic.details/enumeratorselectadapter/
---
## EnumeratorSelectAdapter 類別


由 IEnumerable.Select() 擴充方法使用的列舉器。
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | 取得目前的元素。 |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 執行第一次 [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 呼叫，並準備列舉器物件以供 VirtualizedIterator 使用。 |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | 標記屬於虛擬化迭代器的列舉器。 |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | 相當於 C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法。啟用自訂型別的克隆。 |
| **bool** [MoveNext](./movenext/)() override | 將列舉器移動到下一個元素。如果之前未參考任何元素，則設定參考為第一個可用元素。若已達容器末端，則什麼也不做。 |
...
| void [Reset](./reset/)() override | 將列舉器重設為第一個元素之前的位置。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 減少並回傳共享參考計數。不應直接呼叫；請改用智能指標或 ThisProtector。 |
