...
type: docs
weight: 105
url: /zh-hant/system.collections.generic.details/enumeratorselectmanyadapter/
---
## EnumeratorSelectManyAdapter 類別
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 執行第一次 [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 呼叫並準備列舉器物件供 VirtualizedIterator 使用。 |
...
| **bool** [MoveNext](./movenext/)() override | 將列舉器移動到下一個元素。如果之前未參照任何元素，則設定參照至第一個可用元素。若已達容器結尾，則不執行任何操作。 |
