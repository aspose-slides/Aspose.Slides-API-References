...
description: Enumerable 用於 IEnumerable.Select() 延伸方法。
type: docs
weight: 14
url: /zh-hant/system.collections.generic.details/enumerableselectadapter/
---
## EnumerableSelectAdapter 類別

Enumerable 用於 IEnumerable.Select() 延伸方法。
...
| 方法 | 說明 |
| --- | --- |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 獲取指向集合第一個元素（如果有）的迭代器。此迭代器無法用於更改被引用的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的複本。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | 獲取指向集合 const 限定實例之第一個元素（如果有）的迭代器。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 獲取指向集合最後一個元素（如果有）之後的迭代器。此迭代器無法用於更改被引用的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的複本。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 獲取指向集合 const 限定實例之最後一個元素（如果有）之後的迭代器。 |
