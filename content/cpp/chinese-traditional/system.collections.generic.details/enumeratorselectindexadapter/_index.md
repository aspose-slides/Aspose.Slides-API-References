...
type: docs
weight: 92
url: /zh-hant/system.collections.generic.details/enumeratorselectindexadapter/
---
## EnumeratorSelectIndexAdapter 類別
...
| Method | Description |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | 預備此疊代器供 VirtualizedIterator 類別使用。 |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 執行第一次 [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 呼叫，並預備列舉器物件供 VirtualizedIterator 使用。 |
...
| **bool** [MoveNext](./movenext/)() override | 將列舉器移至下一個元素。若先前未參照過任何元素，則設定參照至第一個可用元素。若已到容器結尾，則什麼也不做。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將共享參照計數降低指定的值。 |
