...
description: "當模組中的任何類別載入失敗時，Module.GetTypes 方法會拋出 ReflectionTypeLoadException。切勿手動建立此類別的實例。請改用 ReflectionTypeLoadException 類別。切勿將 ReflectionTypeLoadException 類別的實例包裝成 System::SmartPtr。"
type: docs
weight: 66
url: /zh-hant/system.reflection/details_reflectiontypeloadexception/
---
## Details_ReflectionTypeLoadException 類別


ReflectionTypeLoadException 於 Module.GetTypes 方法中拋出，如果模組中的任何類別無法載入。切勿手動建立此類別的實例。請改用 ReflectionTypeLoadException 類別。切勿將 ReflectionTypeLoadException 類別的實例包裝至 [System::SmartPtr](../../system/smartptr/)。
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Exception](../../system/exception/)\> [get_LoaderExceptions](./get_loaderexceptions/)() const | 傳回導致此例外的例外集合。 |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::TypeInfo](../../system/typeinfo/)\> [get_Types](./get_types/)() const | 傳回例外原因的型別資訊。 |
