...
description: 表示類別方法的資訊。
type: docs
weight: 131
url: /zh-hant/system.reflection/methodinfo/
---
## MethodInfo 類別
...
| const [String](../../system/string/)\& [get_FullName](../memberinfo/get_fullname/)() const | 取得成員完整名稱。於手動實作部分可能會不同。 |
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | 取得表示此成員為方法的 MemberTypes 值。 |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | 回傳一個陣列，包含表示套用於目前物件所代表類型的所有自訂屬性的物件。 |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(**bool**) const | 回傳一個陣列，包含表示套用於目前物件所代表類型的所有自訂屬性的物件。 |
...
|  [MethodInfo](./methodinfo/)(const [String](../../system/string/)\&) | 初始化 [MethodInfo](./) 類別的新執行個體。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的專門化，處理 string 與 nullptr 的情況。 |
