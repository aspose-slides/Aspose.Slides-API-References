...
description: "定義組件名稱。此類別的物件應僅透過 System::MakeObject() 函式分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。始終將此類別包裝為 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 14
url: /zh-hant/system.reflection/assemblyname/
---
## AssemblyName 類別
...
| Method | Description |
| --- | --- |
|  [AssemblyName](./assemblyname/)() | 建構函式。 |
|  [AssemblyName](./assemblyname/)(const [String](../../system/string/)\&) | 建構函式。 |
|  [AssemblyName](./assemblyname/)(const [String](../../system/string/)\&, const [Version](../../system/version/)\&) | 建構函式。 |
...
| [String](../../system/string/) [get_Name](./get_name/)() | 取得組件名稱。 |
| [Version](../../system/version/) [get_Version](./get_version/)() | 取得組件版本。 |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | 設定組件名稱。 |
| void [set_Version](./set_version/)(const [Version](../../system/version/)\&) | 設定組件版本。 |
