...
description: "虛擬類別，使得能將已翻譯的程式碼與 HttpContext 參照連結起來，但不會執行。未實作任何正確的成員。此類別的物件只能使用 System::MakeObject() 函式配置。切勿在堆疊上或使用 new 運算子建立此類型的實例，否則會導致執行階段錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並以此指標作為參數傳遞給函式。"
type: docs
weight: 14
url: /zh-hant/system.web/httpcontext/
---
## HttpContext 類別


虛擬類別，使得可將已翻譯的程式碼與 [HttpContext](./) 參照連結起來，但不會執行。未實作任何正確的成員。此類別的物件只能使用 [System::MakeObject()](../../system/makeobject/) 函式配置。切勿在堆疊上或使用 new 運算子建立此類型的實例，否則會導致執行階段錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並以此指標作為參數傳遞給函式。
...
| static [System::SharedPtr](../../system/sharedptr/)\<[HttpContext](./)\> [get_Current](./get_current/)() | 未實作。 |
| [System::SharedPtr](../../system/sharedptr/)\<HttpRequest\> [get_Request](./get_request/)() | 未實作。 |
...
| static void [set_Current](./set_current/)(const [System::SharedPtr](../../system/sharedptr/)\<[HttpContext](./)\>\&) | 未實作。 |
