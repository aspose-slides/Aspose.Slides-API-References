...
description: 具有 float 元件的 2D 向量
type: docs
weight: 53
url: /zh-hant/aspose.slides.drawing/vector2d32f/
---
## Vector2d32f 類別
...
| **double** [GetLength](./getlength/)() | 取得長度 |
...
| [Vector2d32f](./) [Scale](./scale/)(**float**, **float**) | 縮放向量 |
| [Vector2d32f](./) [Scale](./scale/)([Vector2d32f](./)) | 縮放向量 |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | 相當於 C# Object.ToString() 方法。啟用將自訂物件轉換為字串。 |
| [Vector2d64d](../vector2d64d/) [ToVector2d64d](./tovector2d64d/)() | 轉換為 [Vector2d64d](../vector2d64d/) |
...
|  [Vector2d32f](./vector2d32f/)(**float**, **float**) | 建構子 |
