...
type: docs
weight: 27
url: /zh-hant/aspose.slides.drawing/rect32f/
---
## Rect32f 類別
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述式的鎖定功能。可直接呼叫，或使用 [LockContext](../../system/lockcontext/) 監視物件。 |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設定為弱指標（而非共享指標）。允許在容器中將指標切換至弱模式。 |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 陳述式的解鎖功能。可直接呼叫，或使用 [LockContext](../../system/lockcontext/) 監視物件。 |
