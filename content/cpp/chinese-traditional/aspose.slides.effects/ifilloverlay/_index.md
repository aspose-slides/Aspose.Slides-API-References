...
description: 表示 Fill Overlay 效果。Fill Overlay 可用於為物件指定額外的填色，並將兩種填色混合在一起。
type: docs
weight: 612
...
表示 Fill Overlay 效果。Fill Overlay 可用於為物件指定額外的填色，並將兩種填色混合。
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode。讀取 [FillBlendMode](../../aspose.slides/fillblendmode/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() | 填充格式。唯讀 [IFillFormat](../../aspose.slides/ifillformat/)。 |
...
| virtual void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) | FillBlendMode。寫入 [FillBlendMode](../../aspose.slides/fillblendmode/)。 |
