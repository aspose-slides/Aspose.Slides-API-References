...
description: 不可變物件，代表有效影像轉換效果的唯讀集合。
type: docs
weight: 820
...
| [const_iterator](./const_iterator/) [begin](./begin/)() const | 取得指向集合之 const 資格實例中第一個元素（若存在）的迭代器。 |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | 取得指向集合中第一個 const 資格元素（若存在）的迭代器。 |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 取得指向集合中最後一個 const 資格元素之後（若存在）的迭代器。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>, **int32_t**) override | 將集合中的所有元素複製到指定的陣列中。 |
| [iterator](./iterator/) [end](./end/)() | 取得指向集合中最後一個元素之後（若存在）的迭代器。 |
| [const_iterator](./const_iterator/) [end](./end/)() const | 取得指向集合之 const 資格實例中最後一個元素之後（若存在）的迭代器。 |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的物件是否等於目前的物件。 |
...
| **int32_t** [get_Count](./get_count/)() override | 傳回集合中影像效果的數量。唯讀 **int32_t**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>\> [GetEnumerator](./getenumerator/)() override | 傳回可遍歷集合的列舉器。 |
| **int32_t** [GetHashCode](./gethashcode/)() const override | 作為特定類型的雜湊函式，適用於雜湊演算法與資料結構（如雜湊表）。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際類型。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) override | 依索引傳回元素。 |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 取得指向集合之 const 資格實例中第一個元素（若存在）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 取得指向集合中第一個元素（若存在）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 取得指向集合之 const 資格實例中最後一個元素之後（若存在）的迭代器。 |
...
名稱 IImageTransformOperationCollectionEffectiveData 被截斷為 [IImageTransformOCollectionEffectiveData](../iimagetransformocollectioneffectivedata/)，因為 COM 名稱長度不能超過 39。

## 另見

* 類別 [IEffectiveData](../../aspose.slides/ieffectivedata/)
* 類別 [IImageTransformOCollectionEffectiveData](../iimagetransformocollectioneffectivedata/)
