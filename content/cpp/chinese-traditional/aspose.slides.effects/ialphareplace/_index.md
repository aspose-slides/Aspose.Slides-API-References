...
description: 代表基礎 IImageTransformOperation 介面。
type: docs
weight: 391
...
代表基礎 [IImageTransformOperation](../iimagetransformoperation/) 介面。
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 設定第 n 個模板參數為 weak 指標（而非 shared）。允許在容器中將指標切換為 weak 模式。 |
