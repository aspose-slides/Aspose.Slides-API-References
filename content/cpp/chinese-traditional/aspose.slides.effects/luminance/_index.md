...
description: 表示一個 Luminance 效果。亮度會線性地將所有顏色向白色或黑色偏移。對比度會縮放所有顏色，使它們更接近或更遠離彼此。
type: docs
weight: 1028
...
表示一個 [Luminance](./) 效果。亮度會線性地將所有顏色向白色或黑色偏移。對比度會縮放所有顏色，使它們更接近或更遠離彼此。
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [Luminance](./) 是否等於目前的 [Luminance](./)。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使依據 IEC 60559:1989 規範，NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使依據 IEC 60559:1989 規範，NaN 不等於任何值，包括 NaN 本身。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminanceEffectiveData](../iluminanceeffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 [Luminance](./) 效果資料。 |
