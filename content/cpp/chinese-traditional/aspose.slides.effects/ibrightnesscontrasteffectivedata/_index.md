...
description: 不可變物件，表示一個 BrightnessContrast 效果。調整亮度和對比度
type: docs
weight: 495
url: /zh-hant/aspose.slides.effects/ibrightnesscontrasteffectivedata/
---
## IBrightnessContrastEffectiveData 類別

不可變物件，表示 [BrightnessContrast](../brightnesscontrast/) 效果。調整亮度和對比度
...
| virtual **float** [get_Brightness](./get_brightness/)() | 傳回亮度。唯讀 **float**。 |
| virtual **float** [get_Contrast](./get_contrast/)() | 傳回對比度。唯讀 **float**。 |
