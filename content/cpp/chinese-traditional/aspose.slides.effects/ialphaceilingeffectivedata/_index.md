...
description: 不可變物件，表示 Alpha Ceiling 效果。Alpha（不透明度）大於零的值會被更改為 100%。換句話說，任何部分不透明的物件都會變為完全不透明。
type: docs
weight: 274
url: /zh-hant/aspose.slides.effects/ialphaceilingeffectivedata/
---
## IAlphaCeilingEffectiveData 類別

不可變物件，表示 Alpha Ceiling 效果。Alpha（不透明度）大於零的值會被更改為 100%。換句話說，任何部分不透明的物件都會變為完全不透明。
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | 針對字串與 nullptr 的情況，對 [Object::ReferenceEquals](../../system/object/referenceequals/) 進行特殊化。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | 針對字串的情況，對 [Object::ReferenceEquals](../../system/object/referenceequals/) 進行特殊化。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | 相當於 C# [Object.ToString()](../../system/object/tostring/) 方法。支援將自訂物件轉換為 string。 |
