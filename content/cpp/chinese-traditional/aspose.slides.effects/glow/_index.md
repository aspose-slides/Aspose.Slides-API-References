...
description: 表示一種 Glow 效果，其中在物件的邊緣外添加了顏色模糊的輪廓。
type: docs
weight: 196
...
表示一種 [Glow](./) 效果，其中在物件的邊緣外添加了顏色模糊的輪廓。
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [Glow](./) 是否等於目前的 [Glow](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | 顏色格式。唯讀 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| **double** [get_Radius](./get_radius/)() override | 半徑。讀取 **double**。 |
| virtual ASPOSE_SLIDES_LOCAL_API **uint32_t** [get_Version](../../aspose.slides/ipviobject/get_version/)() | 版本。唯讀 **uint32_t**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數器資料結構。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IGlowEffectiveData](../igloweffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 [Glow](./) 效果資料。 |
...
| void [set_Radius](./set_radius/)(**double**) override | 半徑。寫入 **double**。 |
