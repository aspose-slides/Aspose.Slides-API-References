...
description: 不可變物件，表示 Alpha Floor 效果。Alpha（不透明度）低於 100% 的值會被改為零。換句話說，任何部分透明的物件都會變為完全透明。
type: docs
weight: 300
url: /zh-hant/aspose.slides.effects/ialphaflooreffectivedata/
---
## IAlphaFloorEffectiveData 類別


不可變物件，表示 Alpha Floor 效果。Alpha（不透明度）低於 100% 的值會被改為零。換句話說，任何部分透明的物件都會變為完全透明。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，當兩個 NaN 被視為相等，儘管依據 IEC 60559:1989 NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，當兩個 NaN 被視為相等，儘管依據 IEC 60559:1989 NaN 不等於任何值，包括 NaN 本身。 |
