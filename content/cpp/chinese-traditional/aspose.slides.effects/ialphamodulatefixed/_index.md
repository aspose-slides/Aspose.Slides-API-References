...
description: 表示 Alpha Modulate Fixed 效果。效果的 alpha（不透明度）值會乘以固定的百分比。
type: docs
weight: 365
url: /zh-hant/aspose.slides.effects/ialphamodulatefixed/
---
## IAlphaModulateFixed 類別
...
| virtual **float** [get_Amount](./get_amount/)() | 以百分比返回效果數值。讀取 **float**。 |
...
| virtual void [set_Amount](./set_amount/)(**float**) | 以百分比返回效果數值。寫入 **float**。 |
