...
| virtual **float** [get_Direction](./get_direction/)() | 陰影方向。唯讀 **float**。 |
| virtual **double** [get_Distance](./get_distance/)() | 陰影距離。唯讀 **double**。 |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | 陰影顏色。唯讀 [System::Drawing::Color](../../system.drawing/color/)。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 複製建構子。實際上不會複製任何東西，只是初始化新物件並允許子類別的副本建構。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 指派運算子。實際上不會複製任何東西，只是初始化新物件並允許子類別的副本建構。 |
