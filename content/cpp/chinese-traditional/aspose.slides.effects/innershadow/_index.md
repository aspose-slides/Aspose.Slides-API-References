...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [InnerShadow](./) 是否等於目前的 [InnerShadow](./)。 |
...
| **float** [get_Direction](./get_direction/)() override | 陰影方向。讀取 **float**。 |
| **double** [get_Distance](./get_distance/)() override | 陰影距離。讀取 **double**。 |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | 返回父級 [IPresentationComponent](../../aspose.slides/ipresentationcomponent/)。唯讀 [IPresentationComponent](../../aspose.slides/ipresentationcomponent/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() override | 陰影顏色。唯讀 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IInnerShadowEffectiveData](../iinnershadoweffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 Inner Shadow 效果資料。 |
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述式的上鎖。直接呼叫或使用 [LockContext](../../system/lockcontext/) 監視器物件。 |
...
| void [set_Direction](./set_direction/)(**float**) override | 陰影方向。寫入 **float**。 |
| void [set_Distance](./set_distance/)(**double**) override | 陰影距離。寫入 **double**。 |
