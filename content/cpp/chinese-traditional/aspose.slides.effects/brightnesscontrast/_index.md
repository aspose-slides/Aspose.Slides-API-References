...
description: 表示一個 BrightnessContrast 效果。調整亮度與對比度
type: docs
weight: 118
...
表示一個 [BrightnessContrast](./) 效果。調整亮度與對比度。
...
| 方法 | 描述 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [BrightnessContrast](./) 是否等於目前的 [BrightnessContrast](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBrightnessContrastEffectiveData](../ibrightnesscontrasteffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 [BrightnessContrast](./) 效果資料。 |
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述式的鎖定。直接呼叫或使用 [LockContext](../../system/lockcontext/) 警衛物件。 |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 陳述式的解鎖。直接呼叫或使用 [LockContext](../../system/lockcontext/) 警衛物件。 |
...
* 類別 [IBrightnessContrast](../ibrightnesscontrast/)
