...
| 方法 | 描述 |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) override | 將新的圖像效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevel](../ialphabilevel/)\> [AddAlphaBiLevelEffect](./addalphabileveleffect/)(**float**) override | 將新的 Alpha Bi-Level 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeiling](../ialphaceiling/)\> [AddAlphaCeilingEffect](./addalphaceilingeffect/)() override | 將新的 Alpha Ceiling 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloor](../ialphafloor/)\> [AddAlphaFloorEffect](./addalphaflooreffect/)() override | 將新的 Alpha Floor 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverse](../ialphainverse/)\> [AddAlphaInverseEffect](./addalphainverseeffect/)() override | 將新的 Alpha Inverse 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulate](../ialphamodulate/)\> [AddAlphaModulateEffect](./addalphamodulateeffect/)() override | 將新的 Alpha Modulate 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixed](../ialphamodulatefixed/)\> [AddAlphaModulateFixedEffect](./addalphamodulatefixedeffect/)(**float**) override | 將新的 Alpha Modulate Fixed 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplace](../ialphareplace/)\> [AddAlphaReplaceEffect](./addalphareplaceeffect/)(**float**) override | 將新的 Alpha Replace 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevel](../ibilevel/)\> [AddBiLevelEffect](./addbileveleffect/)(**float**) override | 將新的 Bi-Level（黑/白）效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlur](../iblur/)\> [AddBlurEffect](./addblureffect/)(**double**, **bool**) override | 將新的 [Blur](../blur/) 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IBrightnessContrast](../ibrightnesscontrast/)\> [AddBrightnessContrastEffect](./addbrightnesscontrasteffect/)(**float**, **float**) override | 將新的 [BrightnessContrast](../brightnesscontrast/) 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorChange](../icolorchange/)\> [AddColorChangeEffect](./addcolorchangeeffect/)() override | 將新的 Color Change 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplace](../icolorreplace/)\> [AddColorReplaceEffect](./addcolorreplaceeffect/)() override | 將新的 Color Replacement 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotone](../iduotone/)\> [AddDuotoneEffect](./addduotoneeffect/)() override | 將新的 [Duotone](../duotone/) 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlay](../ifilloverlay/)\> [AddFillOverlayEffect](./addfilloverlayeffect/)() override | 將新的 Fill Overlay 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IGrayScale](../igrayscale/)\> [AddGrayScaleEffect](./addgrayscaleeffect/)() override | 將新的 Gray Scale 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IHSL](../ihsl/)\> [AddHSLEffect](./addhsleffect/)(**float**, **float**, **float**) override | 將新的 Hue/Saturation/Luminance 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminance](../iluminance/)\> [AddLuminanceEffect](./addluminanceeffect/)(**float**, **float**) override | 將新的 [Luminance](../luminance/) 效果新增至集合的末端。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ITint](../itint/)\> [AddTintEffect](./addtinteffect/)(**float**, **float**) override | 將新的 [Tint](../tint/) 效果新增至集合的末端。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 取得指向集合第一個元素（若有）的迭代器。此迭代器無法用於變更被參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會傳回 T 的副本物件。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | 取得指向 const 限定之集合實例第一個元素（若有）的迭代器。 |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | 取得指向集合最後一個 const 限定元素之後（若有）的迭代器。 |
| void [Clear](./clear/)() override | 從集合中移除所有圖像效果。 |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) const override | 判斷 [ICollection](../../system.collections.generic/icollection/) 是否包含特定值。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\>, **int32_t**) override | 將 [ICollection](../../system.collections.generic/icollection/) 的元素複製到 [System::Array](../../system/array/)，從特定的 [System::Array](../../system/array/) 索引開始。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 取得指向集合最後一個元素之後（若有）的迭代器。此迭代器無法用於變更被參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會傳回 T 的副本物件。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 取得指向 const 限定之集合實例最後一個元素之後（若有）的迭代器。 |
| **bool** [Equals](../../aspose.slides/pviobject/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 與指定物件進行比較。 |
...
| **int32_t** [get_Count](./get_count/)() const override | 傳回集合中圖像效果的數量。唯讀 **int32_t**。 |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | 取得指示 [ICollection](../../system.collections.generic/icollection/) 是否唯讀的值。唯讀 **bool**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\>\> [GetEnumerator](./getenumerator/)() override | 傳回可遍歷集合的列舉器。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\> [idx_get](./idx_get/)(**int32_t**) override | 依索引從集合傳回一個 [ImageTransformOperation](../imagetransformoperation/)。 |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | 傳回符合條件的第一個元素，若未找到則傳回預設值。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | 從序列的開頭跳過指定數量的連續元素，並傳回剩餘部分。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | 相當於 C# 的 [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法。允許複製自訂類型。 |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) override | 從 [ICollection](../../system.collections.generic/icollection/) 中移除特定物件的第一次出現。 |
| void [RemoveAt](./removeat/)(**int32_t**) override | 在指定索引處從集合中移除圖像效果。 |
...
* 類別 [IImageTransformOperationCollection](../iimagetransformoperationcollection/)
