...
description: 表示 Alpha 雙階層效果。Alpha（不透明度）值低於閾值時會變為 0（完全透明），而 Alpha 值大於或等於閾值時會變為 100%（完全不透明）。
type: docs
weight: 235
...
表示 Alpha 雙階層效果。低於閾值的 Alpha（不透明度）值會被更改為 0（完全透明），而大於或等於閾值的 Alpha 值會被更改為 100%（完全不透明）。
...
| virtual **float** [get_Threshold](./get_threshold/)() | 傳回效果閾值。讀取 **float**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | 取得套用繼承後的有效資料。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 等同於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。提供自訂物件的雜湊功能。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | 等同於 C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法。提供自訂型別的克隆功能。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特殊化，用於 string 與 nullptr 情況。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特殊化，用於 strings 情況。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將共享參考計數減少指定的值。 |
| virtual void [set_Threshold](./set_threshold/)(**float**) | 傳回效果閾值。寫入 **float**。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | 等同於 C# [Object.ToString()](../../system/object/tostring/) 方法。提供將自訂物件轉換為字串的功能。 |
...
在 COM 中使用 [ImageTransformOperationFactory](../imagetransformoperationfactory/) 建立實例。
