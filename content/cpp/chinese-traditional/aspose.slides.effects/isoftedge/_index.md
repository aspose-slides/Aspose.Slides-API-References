...
| virtual **double** [get_Radius](./get_radius/)() | 指定應用於邊緣的模糊半徑。讀取 **double**。 |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際類型。類比 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否為 targetType 描述之類型的實例。類比 C# 'is' 運算子。 |
...
| virtual void [set_Radius](./set_radius/)(**double**) | 指定應用於邊緣的模糊半徑。寫入 **double**。 |
