...
description: 表示 Alpha Replace 效果。效果的 alpha（不透明度）值將被固定的 alpha 取代。
type: docs
weight: 79
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [AlphaReplace](./) 是否等於目前的 [AlphaReplace](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplaceEffectiveData](../ialphareplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 Alpha Replace 效果資料。 |
...
* 類別 [IAlphaReplace](../ialphareplace/)
