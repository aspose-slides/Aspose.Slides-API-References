...
description: 不可變的物件，代表 Alpha 雙階層效果。小於閾值的 Alpha（不透明度）值將被改為 0（完全透明），大於或等於閾值的 Alpha 值將被改為 100%（完全不透明）。
type: docs
weight: 248
url: /zh-hant/aspose.slides.effects/ialphabileveleffectivedata/
---
## IAlphaBiLevelEffectiveData 類別
...
| virtual **float** [get_Threshold](./get_threshold/)() | 傳回效果閾值。唯讀 **float**。 |
