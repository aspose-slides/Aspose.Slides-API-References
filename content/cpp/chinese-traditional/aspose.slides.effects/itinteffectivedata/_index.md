...
description: 不可變的物件，表示 Tint 效果。將效果的顏色值依指定的量向色相移動或遠離色相。
type: docs
weight: 1002
url: /zh-hant/aspose.slides.effects/itinteffectivedata/
---
## ITintEffectiveData 類別


不可變物件，表示 [Tint](../tint/) 效果。將效果的顏色值按指定的量向色相移動或遠離色相。
...
| virtual **float** [get_Amount](./get_amount/)() | 回傳效果量。唯讀 **float**。 |
| virtual **float** [get_Hue](./get_hue/)() | 回傳色相。唯讀 **float**。 |
