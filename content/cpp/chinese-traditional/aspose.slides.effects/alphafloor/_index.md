...
description: 表示 Alpha Floor 效果。Alpha（不透明度）值小於 100% 時會被改為零。換句話說，任何部分透明的項目都會變成完全透明。
type: docs
weight: 27
...
代表 Alpha Floor 效果。Alpha（不透明度）小於 100% 的值會被改為零。換句話說，任何部分透明的項目都會變為完全透明。
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [AlphaFloor](./) 是否等於目前的 [AlphaFloor](./)。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使依據 IEC 60559:1989，NaN 並不等於任何值（包括 NaN）。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使依據 IEC 60559:1989，NaN 並不等於任何值（包括 NaN）。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloorEffectiveData](../ialphaflooreffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 Alpha Floor 效果資料。 |
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 敘述的鎖定行為。直接呼叫或使用 [LockContext](../../system/lockcontext/) 監護物件。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特殊化版本，處理字串與 nullptr 的情況。 |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特殊化版本，處理字串的情況。 |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 敘述的解除鎖定。直接呼叫或使用 [LockContext](../../system/lockcontext/) 監護物件。 |
