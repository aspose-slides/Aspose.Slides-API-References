...
description: 代表一種 Bi-Level（黑/白）效果。亮度低於指定閾值的輸入顏色會被改為黑色。亮度大於或等於指定值的輸入顏色會被設定為白色。Alpha 效果值不受此效果影響。
type: docs
weight: 92
...
代表一種 Bi-Level（黑白）效果。亮度低於指定閾值的輸入顏色會被改為黑色。亮度大於或等於指定值的輸入顏色會被設定為白色。Alpha 效果值不受此效果影響。
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [BiLevel](./) 是否等於目前的 [BiLevel](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevelEffectiveData](../ibileveleffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 Bi-Level 效果資料。 |
