...
description: 表示 Alpha Modulate 效果。效果的 alpha（不透明度）值會乘以固定的百分比。效果容器指定包含 alpha 值以進行調變的效果。
type: docs
weight: 53
...
表示一種 Alpha Modulate 效果。效果的 alpha（不透明度）值會乘以固定的百分比。效果容器指定要調變的含有 alpha 值的效果。
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [AlphaModulate](./) 是否等於目前的 [AlphaModulate](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateEffectiveData](../ialphamodulateeffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 Alpha Modulate 效果資料。 |
...
|  [Object](../../system/object/object/)() | 建立物件。初始化全部內部資料結構。 |
...
* 類別 [IAlphaModulate](../ialphamodulate/)
