...
description: 不可變物件，表示灰階效果。將所有效果顏色值轉換為與其亮度相對應的灰階色調。效果的 alpha（不透明度）值不受影響。
type: docs
weight: 677
url: /zh-hant/aspose.slides.effects/igrayscaleeffectivedata/
---
## IGrayScaleEffectiveData 類別

Immutable 物件，表示灰階效果。將所有效果顏色值轉換為與其亮度相對應的灰階色調。效果的 alpha（不透明度）值不受影響。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，兩個 NaN 被視為相等，即使根據 IEC 60559:1989，NaN 與任何值（包括 NaN 本身）都不相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，兩個 NaN 被視為相等，即使根據 IEC 60559:1989，NaN 與任何值（包括 NaN 本身）都不相等。 |
