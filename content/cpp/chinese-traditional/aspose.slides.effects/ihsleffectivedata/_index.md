...
description: 表示一個色相/飽和度/亮度效果。色相、飽和度與亮度皆可相對於其當前值進行調整。
type: docs
weight: 703
url: /zh-hant/aspose.slides.effects/ihsleffectivedata/
---
## IHSLEffectiveData 類別

表示一個色相/飽和度/亮度效果。色相、飽和度和亮度皆可相對於其當前值進行調整。
...
| virtual **float** [get_Hue](./get_hue/)() | 傳回色相百分比。唯讀 **float**。 |
| virtual **float** [get_Luminance](./get_luminance/)() | 傳回亮度百分比。唯讀 **float**。 |
| virtual **float** [get_Saturation](./get_saturation/)() | 傳回飽和度百分比。唯讀 **float**。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否為目標類型所描述之實例。相當於 C# 'is' 運算子。 |
