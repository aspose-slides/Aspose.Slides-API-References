...
description: 不可變的物件，代表一個 Duotone 效果。對於每個像素，透過線性插值結合 clr1 與 clr2，以決定該像素的新顏色。
type: docs
weight: 573
url: /zh-hant/aspose.slides.effects/iduotoneeffectivedata/
---
## IDuotoneEffectiveData 類別

不可變的物件，代表一個 [Duotone](../duotone/) 效果。對於每個像素，透過線性插值結合 clr1 與 clr2，以決定該像素的新顏色。
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color1](./get_color1/)() | 傳回暗像素的目標顏色格式。唯讀 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color2](./get_color2/)() | 傳回亮像素的目標顏色格式。唯讀 [System::Drawing::Color](../../system.drawing/color/)。 |
