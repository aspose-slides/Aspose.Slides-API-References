...
description: 代表 Alpha 反轉效果。Alpha（不透明度）值透過從 100% 減去來進行反轉。
type: docs
weight: 40
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [AlphaInverse](./) 是否等於目前的 [AlphaInverse](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverseEffectiveData](../ialphainverseeffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 Alpha Inverse 效果資料。 |
...
* 類別 [IAlphaInverse](../ialphainverse/)
