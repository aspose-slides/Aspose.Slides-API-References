...
description: 表示 Alpha Ceiling 效果。Alpha（不透明度）值大於零時會被更改為 100%。換句話說，任何部分透明的物件都會變成完全不透明。
type: docs
weight: 14
...
表示 Alpha Ceiling 效果。Alpha（不透明度）值大於零時會被更改為 100%。換句話說，任何部分透明的物件都會變成完全不透明。
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [AlphaCeiling](./) 是否等於目前的 [AlphaCeiling](./)。 |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../../aspose.slides/idomobject/)\> [get_Parent_Immediate](../../aspose.slides/idomobject/get_parent_immediate/)() | 回傳 Parent_Immediate 物件。唯讀 [IDOMObject](../../aspose.slides/idomobject/)。 |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | 回傳父項 [IPresentationComponent](../../aspose.slides/ipresentationcomponent/)。唯讀 [IPresentationComponent](../../aspose.slides/ipresentationcomponent/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeilingEffectiveData](../ialphaceilingeffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 Alpha Ceiling 效果資料。 |
...
* 類別 [IAlphaCeiling](../ialphaceiling/)
