...
type: docs
weight: 911
url: /zh-hant/aspose.slides.effects/ipresetshadow/
---
## IPresetShadow 類別
...
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | 預設。讀取 [PresetShadowType](../../aspose.slides/presetshadowtype/)。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否為 targetType 所描述的型別之實例。相當於 C# 'is' 運算子。 |
...
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | 預設。寫入 [PresetShadowType](../../aspose.slides/presetshadowtype/)。 |
