...
description: 表示 Tint 效果。根據指定的數值，將效果的顏色值向色相方向或相反方向平移。
type: docs
weight: 1093
...
表示一種 [Tint](./) 效果。根據指定的數值，將效果的顏色值向色相方向或相反方向平移。
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [Tint](./) 是否等於目前的 [Tint](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 [Tint](./) 效果資料。 |
