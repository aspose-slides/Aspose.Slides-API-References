...
description: 代表灰階效果。將所有效果顏色值轉換為與其亮度相對應的灰階色調。效果的 alpha（不透明度）值不受影響。
type: docs
weight: 209
...
代表灰階效果。將所有效果顏色值轉換為與其亮度相對應的灰階色調。效果的 alpha（不透明度）值不受影響。
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [GrayScale](./) 是否等於目前的 [GrayScale](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGrayScaleEffectiveData](../igrayscaleeffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 Gray Scale 效果資料。 |
