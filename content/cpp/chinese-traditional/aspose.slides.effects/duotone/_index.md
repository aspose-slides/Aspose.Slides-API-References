...
description: 代表一個 Duotone 效果。對於每個像素，透過線性插值將 Color1 與 Color2 結合，以確定該像素的新顏色。
type: docs
weight: 157
...
表示一個 [Duotone](./) 效果。對於每個像素，通過線性插值將 Color1 和 Color2 結合，以確定該像素的新顏色。
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 確定指定的 [Duotone](./) 是否等於當前的 [Duotone](./)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color1](./get_color1/)() override | 返回深色像素的目標色彩格式。唯讀 [IColorFormat](../../aspose.slides/icolorformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color2](./get_color2/)() override | 返回亮色像素的目標色彩格式。唯讀 [IColorFormat](../../aspose.slides/icolorformat/)。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotoneEffectiveData](../iduotoneeffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 [Duotone](./) 效果資料。 |
