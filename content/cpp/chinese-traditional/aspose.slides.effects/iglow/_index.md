...
description: 表示一種 Glow 效果，會在物件的邊緣之外添加彩色模糊輪廓。
type: docs
weight: 638
...
表示一種 [Glow](../glow/) 效果，會在物件的邊緣之外添加彩色模糊輪廓。
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | 顏色格式。唯讀 [IColorFormat](../../aspose.slides/icolorformat/)。 |
| virtual **double** [get_Radius](./get_radius/)() | 半徑。讀取 **double**。 |
...
| virtual void [set_Radius](./set_radius/)(**double**) | 半徑。寫入 **double**。 |
