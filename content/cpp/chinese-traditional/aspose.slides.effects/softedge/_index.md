...
description: 表示柔和邊緣效果。形狀的邊緣會被模糊化，而填充則不受影響。
type: docs
weight: 1080
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [SoftEdge](./) 是否等於目前的 [SoftEdge](./)。 |
...
| **double** [get_Radius](./get_radius/)() override | 指定應用於邊緣的模糊半徑。讀取 **double**。 |
| virtual ASPOSE_SLIDES_LOCAL_API **uint32_t** [get_Version](../../aspose.slides/ipviobject/get_version/)() | 版本。唯讀 **uint32_t**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 Soft Edge 效果資料。 |
...
| void [set_Radius](./set_radius/)(**double**) override | 指定應用於邊緣的模糊半徑。寫入 **double**。 |
