...
description: 不可變的物件，代表顏色變更效果。FromColor 的實例會被 ToColor 的實例取代。
type: docs
weight: 521
url: /zh-hant/aspose.slides.effects/icolorchangeeffectivedata/
---
## IColorChangeEffectiveData 類別


不可變的物件，代表顏色變更效果。Instances of FromColor are replaced with instances of ToColor.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_FromColor](./get_fromcolor/)() | 將被取代的顏色。唯讀 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ToColor](./get_tocolor/)() | 將作為替代的顏色。唯讀 [System::Drawing::Color](../../system.drawing/color/)。 |
| virtual **bool** [get_UseAlpha](./get_usealpha/)() | 傳回一個布林值，用於決定是否應使用 alpha 元件。唯讀 **bool**。 |
