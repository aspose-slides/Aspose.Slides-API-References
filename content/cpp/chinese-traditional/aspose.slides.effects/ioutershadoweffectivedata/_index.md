...
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | 指定陰影在形狀旋轉時是否跟隨形狀旋轉。唯讀 **bool**。 |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | 指定水平縮放係數，負縮放會導致翻轉。唯讀 **double**。 |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | 指定垂直縮放係數，負縮放會導致翻轉。唯讀 **double**。 |
...
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | 指定水平斜切角度（以度為單位）。唯讀 **double**。 |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | 指定垂直斜切角度（以度為單位）。唯讀 **double**。 |
