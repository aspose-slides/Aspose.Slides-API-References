...
description: 不可變物件，代表顏色替換效果。所有效果顏色皆會被更改為固定顏色。Alpha 值不受影響。
type: docs
weight: 547
url: /zh-hant/aspose.slides.effects/icolorreplaceeffectivedata/
---
## IColorReplaceEffectiveData 類別

不可變物件，代表顏色替換效果。所有效果顏色皆會被更改為固定顏色。Alpha 值不受影響。
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | 返回將替換每個像素顏色的顏色格式。唯讀 [System::Drawing::Color](../../system.drawing/color/)。 |
