...
description: 表示一個 Alpha Modulate Fixed 效果。效果的 alpha（不透明度）值會乘以固定的百分比。
type: docs
weight: 66
...
表示一個 Alpha Modulate Fixed 效果。效果的 alpha（不透明度）值會乘以固定的百分比。
...
| 方法 | 說明 |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 判斷指定的 [AlphaModulateFixed](./) 是否等於目前的 [AlphaModulateFixed](./)。 |
...
| **float** [get_Amount](./get_amount/)() override | 傳回效果的百分比值。讀取 **float**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | 取得套用繼承後的有效 Alpha Modulate Fixed 效果資料。 |
...
| void [set_Amount](./set_amount/)(**float**) override | 傳回效果的百分比值。寫入 **float**。 |
...
* 類別 [IAlphaModulateFixed](../ialphamodulatefixed/)
