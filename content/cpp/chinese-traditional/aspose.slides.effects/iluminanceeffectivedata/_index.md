...
description: 表示一個亮度效果。亮度會線性地將所有顏色向白色或黑色移動。對比度會將所有顏色的差異縮放，使其更接近或更遠離。
type: docs
weight: 807
...
表示一個 [Luminance](../luminance/) 效果。亮度會線性地將所有顏色向白色或黑色移動。對比度會將所有顏色的差異縮放，使其更接近或更遠離。
...
| virtual **float** [get_Brightness](./get_brightness/)() | 亮度。唯讀 **float**。 |
| virtual **float** [get_Contrast](./get_contrast/)() | 對比度。唯讀 **float**。 |
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述式的鎖定。直接呼叫或使用 [LockContext](../../system/lockcontext/) 把持物件。 |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 陳述式的解鎖。直接呼叫或使用 [LockContext](../../system/lockcontext/) 把持物件。 |
