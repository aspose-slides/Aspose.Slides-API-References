...
| [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() override | 轉場方向。讀取 [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)。 |
| **bool** [get_ThroughBlack](./get_throughblack/)() override | 指定轉場是否淡入淡出黑色。讀取 **bool**。 |
...
| void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) override | 轉場方向。寫入 [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)。 |
| void [set_ThroughBlack](./set_throughblack/)(**bool**) override | 指定轉場是否淡入淡出黑色。寫入 **bool**。 |
...
* 類別 [IRevealTransition](../irevealtransition/)
