...
| **bool** [get_FromBlack](./get_fromblack/)() override | 此屬性指定過渡是否從黑色螢幕開始（然後在黑色上過渡到新投影片）。讀取 **bool**。 |
...
| void [set_FromBlack](./set_fromblack/)(**bool**) override | 此屬性指定過渡是否從黑色螢幕開始（然後在黑色上過渡到新投影片）。寫入 **bool**。 |
...
* 類別 [IOptionalBlackTransition](../ioptionalblacktransition/)
