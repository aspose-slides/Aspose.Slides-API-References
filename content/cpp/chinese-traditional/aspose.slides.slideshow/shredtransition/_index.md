...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | 過渡方向。請閱讀 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | 指定過渡期間使用之視覺圖形的形狀。請閱讀 [TransitionShredPattern](../transitionshredpattern/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數器資料結構。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 作為特定類型的雜湊函式，適用於雜湊演算法及如雜湊表之資料結構。 |
...
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | 指定過渡期間使用之視覺圖形的形狀。寫入 [TransitionShredPattern](../transitionshredpattern/)。 |
...
* 類 [TransitionValueBase](../transitionvaluebase/)
* 類 [IShredTransition](../ishredtransition/)
