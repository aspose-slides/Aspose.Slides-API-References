...
| virtual **uint32_t** [get_Spokes](./get_spokes/)() | 輪轉過渡的輻條數量。讀取 **uint32_t**。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否為 targetType 所描述的類型之實例。C# 'is' 運算子的類比。 |
...
| virtual void [set_Spokes](./set_spokes/)(**uint32_t**) | 輪轉過渡的輻條數量。寫入 **uint32_t**。 |
