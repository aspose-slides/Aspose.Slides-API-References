...
| [TransitionEightDirectionType](../transitioneightdirectiontype/) [get_Direction](./get_direction/)() override | 過渡方向。讀取 [TransitionEightDirectionType](../transitioneightdirectiontype/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關的參考計數資料結構。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 作為特定類型的雜湊函式，適用於雜湊演算法與類似雜湊表的資料結構。 |
...
| void [set_Direction](./set_direction/)([TransitionEightDirectionType](../transitioneightdirectiontype/)) override | 過渡方向。寫入 [TransitionEightDirectionType](../transitioneightdirectiontype/)。 |
...
* 類別 [IEightDirectionTransition](../ieightdirectiontransition/)
