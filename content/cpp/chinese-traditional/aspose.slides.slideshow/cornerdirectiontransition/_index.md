...
| [TransitionCornerDirectionType](../transitioncornerdirectiontype/) [get_Direction](./get_direction/)() override | 過渡方向。讀取 [TransitionCornerDirectionType](../transitioncornerdirectiontype/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 作為特定類型的雜湊函式，可用於雜湊演算法與資料結構（如雜湊表）中。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | 相當於 C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法。允許對自訂型別進行克隆。 |
...
| void [set_Direction](./set_direction/)([TransitionCornerDirectionType](../transitioncornerdirectiontype/)) override | 過渡方向。寫入 [TransitionCornerDirectionType](../transitioncornerdirectiontype/)。 |
...
* 類別 [ICornerDirectionTransition](../icornerdirectiontransition/)
