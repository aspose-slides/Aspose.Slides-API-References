...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，兩個 NaN 仍視為相等，即使 IEC 60559:1989 規定 NaN 不等於任何值（包含 NaN）。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，兩個 NaN 仍視為相等，即使 IEC 60559:1989 規定 NaN 不等於任何值（包含 NaN）。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | 轉場效果的方向。讀取 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 為特定類型提供雜湊函式，可用於雜湊演算法與資料結構（如雜湊表）。 |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | 轉場效果的方向。寫入 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
...
* 類別 [IInOutTransition](../iinouttransition/)
