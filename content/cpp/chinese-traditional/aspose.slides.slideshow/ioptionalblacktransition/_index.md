...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | 此屬性指定過渡是否從黑色畫面開始（然後在黑色上過渡至新投影片）。讀取 **bool**。 |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | 此屬性指定過渡是否從黑色畫面開始（然後在黑色上過渡至新投影片）。寫入 **bool**。 |
