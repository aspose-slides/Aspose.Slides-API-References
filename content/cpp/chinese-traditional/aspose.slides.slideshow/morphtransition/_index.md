...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，即使根據 IEC 60559:1989，NaN 與任何值（包括 NaN）皆不相等，仍將兩個 NaN 視為相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 同上，模擬 C# 風格的雙精度浮點比較。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| [TransitionMorphType](../transitionmorphtype/) [get_MorphType](./get_morphtype/)() override | 形態過渡的類型。讀取 [TransitionMorphType](../transitionmorphtype/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 作為特定類型的雜湊函式，可用於雜湊演算法與資料結構（如雜湊表）。 |
...
| void [set_MorphType](./set_morphtype/)([TransitionMorphType](../transitionmorphtype/)) override | 形態過渡的類型。寫入 [TransitionMorphType](../transitionmorphtype/)。 |
...
* 類別 [IMorphTransition](../imorphtransition/)
