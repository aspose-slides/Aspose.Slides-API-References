...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | 轉場方向。讀取 [TransitionSideDirectionType](../transitionsidedirectiontype/)。 |
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | 指定轉場期間使用的視覺形狀。讀取 [TransitionPattern](../transitionpattern/)。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 作為特定型別的雜湊函式，適用於雜湊演算法與像雜湊表之類的資料結構。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | 相當於 C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法。可用於複製自訂型別。 |
...
| void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) override | 轉場方向。寫入 [TransitionSideDirectionType](../transitionsidedirectiontype/)。 |
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | 指定轉場期間使用的視覺形狀。寫入 [TransitionPattern](../transitionpattern/)。 |
...
* 類別 [IGlitterTransition](../iglittertransition/)
