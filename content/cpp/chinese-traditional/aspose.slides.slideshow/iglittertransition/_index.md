...
| virtual [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() | 過渡方向。讀取 [TransitionSideDirectionType](../transitionsidedirectiontype/)。 |
| virtual [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() | 指定過渡期間使用的視覺形狀。讀取 [TransitionPattern](../transitionpattern/)。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) | 過渡方向。寫入 [TransitionSideDirectionType](../transitionsidedirectiontype/)。 |
| virtual void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) | 指定過渡期間使用的視覺形狀。寫入 [TransitionPattern](../transitionpattern/)。 |
