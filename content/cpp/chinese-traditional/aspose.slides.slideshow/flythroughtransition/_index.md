...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | 過渡方向。讀取 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| **bool** [get_HasBounce](./get_hasbounce/)() override | 指定在過渡期間投影片的移動包含彈跳。讀取 **bool**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關的參考計數資料結構。 |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | 作為特定類型的雜湊函式，適用於雜湊演算法和像雜湊表之類的資料結構。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特殊化，適用於字串和 nullptr 的情況。 |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | 過渡方向。寫入 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| void [set_HasBounce](./set_hasbounce/)(**bool**) override | 指定在過渡期間投影片的移動包含彈跳。寫入 **bool**。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設置為弱指標（而非共享）。允許在容器中將指標切換為弱模式。 |
...
* 類別 [IFlyThroughTransition](../iflythroughtransition/)
