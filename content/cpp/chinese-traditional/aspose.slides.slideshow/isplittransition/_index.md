...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | 轉場分割的方向。讀取 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| virtual [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() | 轉場分割的取向。讀取 [Slides::Orientation](../../aspose.slides/orientation/)。 |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | 以參考方式比較具值類型的物件與 nullptr。 |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | 轉場分割的方向。寫入 [TransitionInOutDirectionType](../transitioninoutdirectiontype/)。 |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) | 轉場分割的取向。寫入 [Slides::Orientation](../../aspose.slides/orientation/)。 |
