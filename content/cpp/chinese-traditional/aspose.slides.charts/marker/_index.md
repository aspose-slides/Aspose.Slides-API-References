...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，兩個 NaN 被視為相等，儘管根據 IEC 60559:1989 的規定，NaN 不等於任何值，包含 NaN 本身。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | 取得標記填色。唯讀 [IFormat](../iformat/)。 |
| **int32_t** [get_Size](./get_size/)() override | 表示折線圖、散佈圖或雷達圖中的標記大小。讀取 **int32_t**。 |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | 表示折線圖、散佈圖或雷達圖中的標記樣式。讀取 [MarkerStyleType](../markerstyletype/)。 |
...
| void [set_Size](./set_size/)(**int32_t**) override | 表示折線圖、散佈圖或雷達圖中的標記大小。寫入 **int32_t**。 |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | 表示折線圖、散佈圖或雷達圖中的標記樣式。寫入 [MarkerStyleType](../markerstyletype/)。 |
