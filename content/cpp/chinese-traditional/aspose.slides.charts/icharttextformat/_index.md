...
description: 圖表僅使用受限的文字格式屬性集。IChartTextFormat、IChartTextBlockFormat、IChartParagraphFormat、IChartPortionFormat 介面描述此受限集合。
type: docs
weight: 898
...
[Chart](../chart/) 運作於受限的一組文字格式屬性。[IChartTextFormat](./)、[IChartTextBlockFormat](../icharttextblockformat/)、[IChartParagraphFormat](../ichartparagraphformat/)、[IChartPortionFormat](../ichartportionformat/) 介面描述此受限集合。
...
| 方法 | 說明 |
| --- | --- |
| virtual void [CopyFrom](./copyfrom/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) | 從指定的文字框複製文字格式。 |
| virtual void [CopyTo](./copyto/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) | 將文字格式複製至指定的文字框。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartParagraphFormat](../ichartparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() | 返回段落格式。唯讀 [IChartParagraphFormat](../ichartparagraphformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartPortionFormat](../ichartportionformat/)\> [get_PortionFormat](./get_portionformat/)() | 返回部分格式。唯讀 [IChartPortionFormat](../ichartportionformat/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartTextBlockFormat](../icharttextblockformat/)\> [get_TextBlockFormat](./get_textblockformat/)() | 返回圖表文字元素的格式。唯讀 [IChartTextBlockFormat](../icharttextblockformat/)。 |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 增加共享參考計數。不得直接呼叫；請改用智慧指標或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 遞減並回傳共享參考計數。不得直接呼叫；請改用智慧指標或 ThisProtector。 |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | 增加弱參考計數。不得直接呼叫；請改用智慧指標或 ThisProtector。 |
