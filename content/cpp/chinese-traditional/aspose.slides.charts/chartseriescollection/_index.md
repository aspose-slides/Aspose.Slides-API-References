...
| 方法 | 描述 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) override | 建立新的圖表系列並將其加入集合。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) override | 從 [ChartDataCell](../chartdatacell/) 建立新的圖表系列並將其加入集合。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) override | 從 [ChartCellCollection](../chartcellcollection/) 建立新的圖表系列並將其加入集合。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) override | 從值建立新的圖表系列並將其加入集合。 |
| [iterator](./iterator/) [begin](./begin/)() | 取得指向集合中第一個元素（若有）的迭代器。 |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | 取得指向集合的 const 限定實例中第一個元素（若有）的迭代器。 |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | 取得指向集合中第一個 const 限定元素（若有）的迭代器。 |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 取得指向集合中最後一個 const 限定元素（若有）之後的迭代器。 |
| void [Clear](./clear/)() override | 從集合中移除所有控制項。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>, **int32_t**) override | 將集合中的所有元素複製到指定的陣列中。 |
| [iterator](./iterator/) [end](./end/)() | 取得指向集合中最後一個元素（若有）之後的迭代器。 |
| [const_iterator](./const_iterator/) [end](./end/)() const | 取得指向集合的 const 限定實例中最後一個元素（若有）之後的迭代器。 |
...
| **int32_t** [get_Count](./get_count/)() override | 回傳集合中物件的數量。唯讀 **int32_t**。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>\> [GetEnumerator](./getenumerator/)() override | 回傳可遍歷集合的列舉器。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# 的 [Object.GetHashCode()](../../system/object/gethashcode/) 方法。允許自訂物件的雜湊。 |
...
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | 搜尋指定的 [ChartSeries](../chartseries/)，並回傳在整個集合中第一次出現的零基索引。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) override | 建立新的圖表系列並插入集合中。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | 回傳序列起始處的指定數量連續元素。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | 相當於 C# 的 [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法。允許自訂類型的克隆。 |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | 從集合中移除位於指定位置的 ActiveX 控制項。 |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | 取得指向集合的 const 限定實例中第一個元素（若有）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | 取得指向集合中第一個元素（若有）的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 取得指向集合的 const 限定實例中最後一個元素（若有）之後的迭代器。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | 取得指向集合中最後一個元素（若有）之後的迭代器。 |
...
* 類別 [IChartSeriesCollection](../ichartseriescollection/)
