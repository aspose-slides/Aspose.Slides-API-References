...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | 表示資料點層級的格式屬性。閱讀 [IFormat](../iformat/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() override | 表示資料點層級的資料標籤。適用於 Treemap 和 Sunburst 系列類型。唯讀 [IDataLabel](../idatalabel/)。 |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 將第 n'th 個模板參數設為弱指標（而非共享）。允許在容器中將指標切換為弱模式。 |
...
* 類別 [IChartDataPointLevel](../ichartdatapointlevel/)
