...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | 傳回下條的格式。唯讀 [IFormat](../iformat/)。 |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | 傳回間隙寬度。讀取 **int32_t**。 |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | 判斷圖表是否具有上/下條。讀取 **bool**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | 傳回上條的格式。唯讀 [IFormat](../iformat/)。 |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | 設定間隙寬度。寫入 **int32_t**。 |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | 判斷圖表是否具有上/下條。寫入 **bool**。 |
