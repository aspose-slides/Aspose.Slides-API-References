...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() override | 傳回 DownBars 格式。唯讀 [IFormat](../iformat/)。 |
| **int32_t** [get_GapWidth](./get_gapwidth/)() override | GapWidth。讀取 **int32_t**。 |
| **bool** [get_HasUpDownBars](./get_hasupdownbars/)() override | HasUpDownBars。讀取 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() override | 傳回 UpBars 格式。唯讀 [IFormat](../iformat/)。 |
...
| void [set_GapWidth](./set_gapwidth/)(**int32_t**) override | GapWidth。寫入 **int32_t**。 |
| void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) override | HasUpDownBars。寫入 **bool**。 |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 將第 n't 個模板參數設定為弱指標（而非共享）。允許在容器中切換指標至弱模式。 |
...
* 類別 [IUpDownBarsManager](../iupdownbarsmanager/)
