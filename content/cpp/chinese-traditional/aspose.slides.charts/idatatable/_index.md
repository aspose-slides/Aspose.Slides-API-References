...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | 傳回物件的線條、填充與效果樣式。唯讀 [IFormat](../iformat/)。 |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | 如果圖表資料表具有水平儲存格邊框則為 true。讀取 **bool**。 |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | 如果圖表資料表具有外框邊框則為 true。讀取 **bool**。 |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | 如果圖表資料表具有垂直儲存格邊框則為 true。讀取 **bool**。 |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | 如果資料標籤圖例鍵可見則為 true。讀取 **bool**。 |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | 如果圖表資料表具有水平儲存格邊框則為 true。寫入 **bool**。 |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | 如果圖表資料表具有外框邊框則為 true。寫入 **bool**。 |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | 如果圖表資料表具有垂直儲存格邊框則為 true。寫入 **bool**。 |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | 如果資料標籤圖例鍵可見則為 true。寫入 **bool**。 |
