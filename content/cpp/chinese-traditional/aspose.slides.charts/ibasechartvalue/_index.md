...
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](./get_datasourcetype/)() | 指定 AsCell、AsLiteralString 或 AsLiteralDouble 屬性哪一個為實際值。換句話說，它指定 Data 屬性的值類型。此屬性為唯讀。若要變更此屬性的值，可使用 ChartDataPointCollection.DataSourceTypeFor<...> 其中一個屬性。請閱讀 [DataSourceType](../datasourcetype/)。 |
...
| virtual void [set_DataSourceType](./set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | 指定 AsCell、AsLiteralString 或 AsLiteralDouble 屬性哪一個為實際值。換句話說，它指定 Data 屬性的值類型。此屬性為唯讀。若要變更此屬性的值，可使用 ChartDataPointCollection.DataSourceTypeFor<...> 其中一個屬性。寫入 [DataSourceType](../datasourcetype/)。 |
