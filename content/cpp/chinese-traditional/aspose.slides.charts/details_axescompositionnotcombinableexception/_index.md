...
description: 當系列的軸組合與圖表中現有的軸組合無法兼容時拋出的例外。
type: docs
weight: 430
url: /zh-hant/aspose.slides.charts/details_axescompositionnotcombinableexception/
---
## Details_AxesCompositionNotCombinableException 類別

當序列的軸組合與圖表中現有的軸組合無法兼容時拋出的例外。
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 傳回 32 位整數值，該值是與目前物件代表的例外相關聯的 HRESULT 代碼。 |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_invalidoperationexception/gettype/)() const override | 取得物件的實際類型。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 減少共享參考計數並回傳。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
