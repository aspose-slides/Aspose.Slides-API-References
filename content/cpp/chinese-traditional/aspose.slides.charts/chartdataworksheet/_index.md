...
description: 表示與 IChartDataCell 相關聯的工作表
type: docs
weight: 209
...
| **int32_t** [get_Index](./get_index/)() override | 取得工作表的索引。唯讀 **int32_t**。 |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | 傳回工作表的名稱。唯讀 [System::String](../../system/string/)。 |
...
* 類別 [IChartDataWorksheet](../ichartdataworksheet/)
