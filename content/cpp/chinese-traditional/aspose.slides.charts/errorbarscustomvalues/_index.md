...
description: 指定誤差棒的值。僅在誤差棒值類型為 Custom 時使用。
type: docs
weight: 469
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 比較參考型別的物件，依照 C# 風格。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 比較值型別的物件，依照 C# 風格。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() override | 指定負方向的誤差棒值。若誤差棒值類型為 Custom 且允許 ErrorBarsXFormat，則可用。否則此屬性回傳 null。唯讀 [IDoubleChartValue](../idoublechartvalue/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() override | 指定正方向的誤差棒值。若誤差棒值類型為 Custom 且允許 ErrorBarsXFormat，則可用。否則此屬性回傳 null。唯讀 [IDoubleChartValue](../idoublechartvalue/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() override | 指定負方向的誤差棒值。若誤差棒值類型為 Custom 且允許 ErrorBarsYFormat，則可用。否則此屬性回傳 null。唯讀 [IDoubleChartValue](../idoublechartvalue/)。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() override | 指定正方向的誤差棒值。若誤差棒值類型為 Custom 且允許 ErrorBarsYFormat，則可用。否則此屬性回傳 null。唯讀 [IDoubleChartValue](../idoublechartvalue/)。 |
...
* 類別 [IErrorBarsCustomValues](../ierrorbarscustomvalues/)
