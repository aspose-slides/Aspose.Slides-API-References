...
| [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](./get_chart/)() override | 回傳父圖表。唯讀 [IChart](../ichart/)。 |
| **bool** [get_Hide](./get_hide/)() override | 判斷圖例項目是否隱藏。讀取 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartTextFormat](../icharttextformat/)\> [get_TextFormat](./get_textformat/)() override | 回傳文字格式。唯讀 [IChartTextFormat](../icharttextformat/)。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 複製建構式。實際上不會複製任何東西，只是初始化新物件並允許子類別進行複製建構。 |
...
| void [set_Hide](./set_hide/)(**bool**) override | 判斷圖例項目是否隱藏。寫入 **bool**。 |
...
* 類別 [ILegendEntryProperties](../ilegendentryproperties/)
