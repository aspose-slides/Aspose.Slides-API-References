...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILegendEntryProperties](../ilegendentryproperties/)\> [idx_get](./idx_get/)(**int32_t**) | 取得圖例項目的屬性，對應於 Chart.ChartData.Series[0].DataPoints[index]，當圖表類型屬於以下清單時：[ChartType::BarOfPie](../charttype/)、[ChartType::ExplodedPie](../charttype/)、[ChartType::ExplodedPie3D](../charttype/)、[ChartType::Pie](../charttype/)、[ChartType::Pie3D](../charttype/)、[ChartType::PieOfPie](../charttype/)；或對於其他圖表類型，對應於 Chart.ChartData.Series[index]。 |
