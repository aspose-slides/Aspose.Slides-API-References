...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](./get_data/)() | 資料。讀取 [System::Object](../../system/object/)。 |
| [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](./get_datasourcetype/)() override | 指定在衍生類別中 AsCell、AsCells、AsLiteralString 或 AsLiteralDouble 屬性是否實際存在。換句話說，它指定 Data 屬性的值類型。讀取 [Charts::DataSourceType](../datasourcetype/)。 |
...
| virtual void [set_Data](./set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | 資料。寫入 [System::Object](../../system/object/)。 |
| void [set_DataSourceType](./set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) override | 指定在衍生類別中 AsCell、AsCells、AsLiteralString 或 AsLiteralDouble 屬性是否實際存在。換句話說，它指定 Data 屬性的值類型。寫入 [Charts::DataSourceType](../datasourcetype/)。 |
