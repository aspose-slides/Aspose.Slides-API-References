...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | 返回牆壁的填充、線條、效果、3D 樣式。唯讀 [IFormat](../iformat/)。 |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | 返回或設定圖片類型。讀取 [Charts::PictureType](../picturetype/)。 |
| **int32_t** [get_Thickness](./get_thickness/)() override | 返回牆壁厚度，作為圖表體積最大維度的百分比。讀取 **int32_t**。 |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | 返回或設定圖片類型。寫入 [Charts::PictureType](../picturetype/)。 |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | 設定牆壁厚度，作為圖表體積最大維度的百分比。寫入 **int32_t**。 |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 將第 n 個模板參數設為弱指標（而非共享指標）。允許在容器中將指標切換為弱模式。 |
