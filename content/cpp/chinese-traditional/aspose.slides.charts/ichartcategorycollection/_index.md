...
| 方法 | 說明 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | 如果集合中存在該類別，則返回它。否則從 [IChartDataCell](../ichartdatacell/) 建立新的圖表類別並將其加入集合。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | 根據值建立新的 [IChartCategory](../ichartcategory/)，並將其加入集合。 |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | 取得指向集合中第一個元素（若存在）的迭代器。此迭代器無法用於變更所參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的複本物件。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | 取得指向集合之 const 限定實例中第一個元素（若存在）的迭代器。 |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | 取得指向集合中最後一個元素之後的迭代器（若存在）。此迭代器無法用於變更所參考的物件，因為 [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) 會回傳 T 的複本物件。 |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | 取得指向 const 限定的集合實例中最後一個元素之後的迭代器（若存在）。 |
...
| virtual **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() | 傳回使用的類別分組層級計數。多層類別時會大於一。唯讀 **int32_t**。 |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | 傳回一個值，指示對集合的存取是否已同步（執行緒安全）。唯讀 **bool**。 |
...
| virtual **bool** [get_UseCells](./get_usecells/)() | 如果為 true，則工作表用於儲存類別（此情況支援多層類別）。如果為 false，則工作表*不*用於儲存值（且此情況不支援多層類別）。讀取 **bool**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) | 取得指定索引處的元素。 |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | 搜尋指定的 [IChartCategory](../ichartcategory/)，並回傳其在整個集合中首次出現的零基索引。 |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_OfType](../../system.collections.generic/ienumerable/linq_oftype/)() | 依據指定的類型過濾序列的元素。 |
...
| virtual void [set_UseCells](./set_usecells/)(**bool**) | 如果為 true，則工作表用於儲存類別（此情況支援多層類別）。如果為 false，則工作表*不*用於儲存值（且此情況不支援多層類別）。寫入 **bool**。 |
