...
description: 資料點層級的容器。適用於 Treeamp 與 Sunburst 系列。資料點層級的索引是零基的。
type: docs
weight: 716
url: /zh-hant/aspose.slides.charts/ichartdatapointlevelsmanager/
---
## IChartDataPointLevelsManager 類別

資料點層級的容器。適用於 Treeamp 與 Sunburst 系列。資料點層級的索引是零基的。
...
| virtual **int32_t** [get_Count](./get_count/)() | 傳回資料點層級的數量。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPointLevel](../ichartdatapointlevel/)\> [idx_get](./idx_get/)(**int32_t**) | 傳回已定義層級的 [IChartDataPointLevel](../ichartdatapointlevel/) 物件。 |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) 方法的類似功能。支援自訂型別的克隆。 |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) 方法的類似功能。支援將自訂物件轉換為字串。 |
