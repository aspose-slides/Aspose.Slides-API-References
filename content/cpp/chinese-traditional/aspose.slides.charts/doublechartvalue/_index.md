...
description: "表示可在 pptx 簡報文件中以兩種方式儲存的 double 值：1) 在與圖表相關的工作簿的儲存格/儲存格中；2) 作為字面值。"
type: docs
weight: 456
...
表示可在 pptx 簡報文件中以兩種方式儲存的 double 值：1) in cell/cells of workbook related to chart; 2) as literal value.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() override | 傳回圖表資料儲存格。請閱讀 [IChartDataCell](../ichartdatacell/)。 |
| **double** [get_AsLiteralDouble](./get_asliteraldouble/)() override | 傳回值為字面 double。請閱讀 **double**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](./get_data/)() override | 傳回 Data 物件。請閱讀 [System::Object](../../system/object/)。 |
| [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../basechartvalue/get_datasourcetype/)() override | 指定在衍生類別中哪個 AsCell、AsCells、AsLiteralString 或 AsLiteralDouble 屬性實際可用。換句話說，它指定 Data 屬性的值類型。請閱讀 [Charts::DataSourceType](../datasourcetype/)。 |
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述句的鎖定功能。直接呼叫或使用 [LockContext](../../system/lockcontext/) 監視物件。 |
...
| void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | 設定圖表資料儲存格。寫入 [IChartDataCell](../ichartdatacell/)。 |
| void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) override | 設定值為字面 double。寫入 **double**。 |
...
| void [set_DataSourceType](../basechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) override | 指定在衍生類別中哪個 AsCell、AsCells、AsLiteralString 或 AsLiteralDouble 屬性實際可用。換句話說，它指定 Data 屬性的值類型。寫入 [Charts::DataSourceType](../datasourcetype/)。 |
...
| **double** [ToDouble](./todouble/)() override | 轉換為 **double**。 |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 陳述句的解鎖功能。直接呼叫或使用 [LockContext](../../system/lockcontext/) 監視物件。 |
...
* 類別 [IDoubleChartValue](../idoublechartvalue/)
