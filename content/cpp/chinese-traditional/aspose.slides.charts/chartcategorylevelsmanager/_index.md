...
| Method | Description |
| --- | --- |
| void [DeleteGroupingItem](./deletegroupingitem/)(**int32_t**) override | 刪除已定義層級的分組項目。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) override | 返回已定義層級的 [IChartDataCell](../ichartdatacell/) 物件。 |
...
| void [SetGroupingItem](./setgroupingitem/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 設定已定義層級的分組項目。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設為弱指標（而不是共享指標）。允許在容器中將指標切換為弱模式。 |
...
* 類別 [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)
