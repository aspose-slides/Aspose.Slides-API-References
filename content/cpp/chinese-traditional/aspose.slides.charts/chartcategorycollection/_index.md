...
description: 代表 ChartCategory 的集合
type: docs
weight: 79
...
代表 [ChartCategory](../chartcategory/) 的集合
...
| 方法 | 說明 |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | 如果集合中已存在該類別，則返回它。否則從 [IChartDataCell](../ichartdatacell/) 建立新的圖表類別並將其添加到集合中。 |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | 從值建立新的 [ChartCategory](../chartcategory/) 並將其添加到集合中。 |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | 取得指向集合中最後一個 const 限定元素之後的位置的迭代器（若有）。 |
| void [Clear](./clear/)() override | 移除集合中的所有元素。 |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>, **int32_t**) override | 將集合中的所有元素複製到指定的陣列。 |
| [iterator](./iterator/) [end](./end/)() | 取得指向集合中最後一個元素之後的位置的迭代器（若有）。 |
| [const_iterator](./const_iterator/) [end](./end/)() const | 取得指向集合之 const 限定實例中最後一個元素之後的位置的迭代器（若有）。 |
...
| **int32_t** [get_Count](./get_count/)() override | 返回集合中的元素數量。唯讀 **int32_t**。 |
| **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() override | 返回使用的類別分組層級計數。對於多層類別，此值大於一。唯讀 **int32_t**。 |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | 返回一個值，指示對 List 的存取是否已同步（執行緒安全）。唯讀 **bool**。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | 返回可用於同步存取集合的物件。唯讀 [System::Object](../../system/object/)。 |
| **bool** [get_UseCells](./get_usecells/)() override | 如果為 true，則使用工作表來儲存類別（此情況支援多層類別）。如果為 false，則工作表不會用於儲存值（此情況不支援多層類別）。讀取 **bool**。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>\> [GetEnumerator](./getenumerator/)() override | 返回用於遍歷集合的列舉器。 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) override | 取得指定索引處的元素。 |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | 搜尋指定的 [ChartCategory](../chartcategory/)，並返回整個集合中首次出現的零基索引。 |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | 依據 keySelector 所選取的鍵值，以升冪順序對序列的元素進行排序。 |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | 依據 keySelector 所選取的鍵值，以降冪順序對序列的元素進行排序。 |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | 移除指定的值。 |
| void [RemoveAt](./removeat/)(**int32_t**) override | 移除指定索引處的元素。 |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將共享參考計數減少指定的值。 |
| void [set_UseCells](./set_usecells/)(**bool**) override | 如果為 true，則工作表用於儲存類別（此情況支援多層類別）。如果為 false，則工作表不會用於儲存值（此情況不支援多層類別）。寫入 **bool**。 |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | 將第 n 個模板參數設定為弱指標（而非共享指標）。允許在容器中將指標切換為弱模式。 |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | 取得指向集合之 const 限定實例中最後一個元素之後的位置的迭代器（若有）。 |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | 取得指向集合中最後一個元素之後的位置的迭代器（若有）。 |
...
| 型別別名 | 說明 |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | 用於目前集合之迭代器類型的集合型別，其迭代器類型亦被使用。 |
