...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，即使依 IEC 60559:1989，NaN 與任何值（包括 NaN）皆不相等，兩個 NaN 仍視為相等。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，即使依 IEC 60559:1989，NaN 與任何值（包括 NaN）皆不相等，兩個 NaN 仍視為相等。 |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | 僅供內部使用。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | 取得標記填充。唯讀 [IFormat](../iformat/)。 |
| virtual **int32_t** [get_Size](./get_size/)() | 代表線圖、散佈圖或雷達圖中的標記大小。讀取 **int32_t**。 |
| virtual [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() | 代表線圖、散佈圖或雷達圖中的標記樣式。讀取 [MarkerStyleType](../markerstyletype/)。 |
...
| virtual void [set_Size](./set_size/)(**int32_t**) | 代表線圖、散佈圖或雷達圖中的標記大小。寫入 **int32_t**。 |
| virtual void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) | 代表線圖、散佈圖或雷達圖中的標記樣式。寫入 [MarkerStyleType](../markerstyletype/)。 |
