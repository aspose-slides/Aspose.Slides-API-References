...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)(**int32_t**) | 返回指定索引的圖表儲存格。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [get_AsCells](./get_ascells/)() | 返回圖表儲存格的集合。閱讀 [IChartCellCollection](../ichartcellcollection/)。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | 指定 AsCell、AsLiteralString 或 AsLiteralDouble 屬性是否為實際值。換句話說，它指定 Data 屬性的值類型。此屬性為唯讀。若要更改此屬性的值，可使用 ChartDataPointCollection.DataSourceTypeFor<...> 其中一個屬性。閱讀 [DataSourceType](../datasourcetype/)。 |
...
| virtual void [set_AsCells](./set_ascells/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>) | 設定圖表儲存格的集合。寫入 [IChartCellCollection](../ichartcellcollection/)。 |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | 指定 AsCell、AsLiteralString 或 AsLiteralDouble 屬性是否為實際值。換句話說，它指定 Data 屬性的值類型。此屬性為唯讀。若要更改此屬性的值，可使用 ChartDataPointCollection.DataSourceTypeFor<...> 其中一個屬性。寫入 [DataSourceType](../datasourcetype/)。 |
...
* 類別 [IBaseChartValue](../ibasechartvalue/)
