...
| virtual **float** [get_Bottom](./get_bottom/)() | 取得圖表元素的上邊緣，為圖表高度的比例。唯讀 **float**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](../ichartcomponent/get_chart/)() | 回傳圖表。唯讀 [IChart](../ichart/)。 |
| virtual **float** [get_Height](./get_height/)() | 指定圖表元素的高度，為圖表高度的比例。讀取 **float**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\> [get_Presentation](../../aspose.slides/ipresentationcomponent/get_presentation/)() | 回傳簡報。唯讀 [IPresentation](../../aspose.slides/ipresentation/)。 |
| virtual **float** [get_Right](./get_right/)() | 取得圖表元素的右邊緣，為圖表寬度的比例。唯讀 **float**。 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../../aspose.slides/ibaseslide/)\> [get_Slide](../../aspose.slides/islidecomponent/get_slide/)() | 回傳基底投影片。唯讀 [IBaseSlide](../../aspose.slides/ibaseslide/)。 |
| virtual **float** [get_Width](./get_width/)() | 指定圖表元素的寬度，為圖表寬度的比例。讀取 **float**。 |
| virtual **float** [get_X](./get_x/)() | 指定圖表元素的 x 位置（左側），為圖表寬度的比例。讀取 **float**。 |
| virtual **float** [get_Y](./get_y/)() | 指定圖表元素的上方，為圖表高度的比例。讀取 **float**。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 複製建構函式。實際上不 copy 任何東西，只是初始化新物件，並允許子類別的複製建構。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 賦值運算子。實際上不 copy 任何東西，只是初始化新物件，並允許子類別的複製建構。 |
...
| virtual void [set_Height](./set_height/)(**float**) | 指定圖表元素的高度，為圖表高度的比例。寫入 **float**。 |
| virtual void [set_Width](./set_width/)(**float**) | 指定圖表元素的寬度，為圖表寬度的比例。寫入 **float**。 |
| virtual void [set_X](./set_x/)(**float**) | 指定圖表元素的 x 位置（左側），為圖表寬度的比例。寫入 **float**。 |
| virtual void [set_Y](./set_y/)(**float**) | 指定圖表元素的上方，為圖表高度的比例。寫入 **float**。 |
