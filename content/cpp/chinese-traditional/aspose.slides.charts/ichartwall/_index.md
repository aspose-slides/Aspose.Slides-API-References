...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | 傳回牆壁的填充、線條、效果、3d 樣式。唯讀 [IFormat](../iformat/)。 |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | 傳回或設定圖片類型。讀取 [PictureType](../picturetype/)。 |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | 傳回牆壁厚度，以圖形體積最大尺寸的百分比表示。讀取 **int32_t**。 |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | 傳回或設定圖片類型。寫入 [PictureType](../picturetype/)。 |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | 設定牆壁厚度，以圖形體積最大尺寸的百分比表示。寫入 **int32_t**。 |
