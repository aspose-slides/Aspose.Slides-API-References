...
description: 表示根據萬維網聯盟（W3C）規範的 XML Schema 中的 length 限定。此類別可用於對資料類型的 simpleType 元素的長度設定限制。
type: docs
weight: 560
url: /zh-hant/system.xml.schema/xmlschemalengthfacet/
---
## XmlSchemaLengthFacet 類別


表示來自 XML [Schema](../) 的 **length** 限定，依據萬維網 [Web](../../system.web/) 聯盟（W3C）的規範。此 類別 可用來指定對 **simpleType** 元素長度的限制。
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使根據 IEC 60559:1989 規範，NaN 不等於任何值，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，將兩個 NaN 視為相等，即使根據 IEC 60559:1989 規範，NaN 不等於任何值，包括 NaN 本身。 |
...
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | 傳回 **schema** 元素指向的檔案中的行號。 |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | 傳回 **schema** 元素指向的檔案中的行位置。 |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | 傳回載入 **schema** 的檔案的來源位置。 |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | 設定 **schema** 元素指向的檔案中的行號。 |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | 設定 **schema** 元素指向的檔案中的行位置。 |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | 設定載入 **schema** 的檔案的來源位置。 |
...
|  [XmlSchemaLengthFacet](./xmlschemalengthfacet/)() | 初始化 [XmlSchemaLengthFacet](./) 類別的新實例。 |
...
| 型別別名 | 描述 |
| --- | --- |
| [Ptr](./ptr/) | 此 類別 實例的共享指標別名。 |

## 註解



此 類別 的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。應始終將此 類別 包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標作為參數傳遞給函式。 

## 另見

* 類別 [XmlSchemaNumericFacet](../xmlschemanumericfacet/)
