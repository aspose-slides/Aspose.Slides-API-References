...
description: 定義已驗證 XML 節點的後綱驗證資訊集。
type: docs
weight: 40
url: /zh-hant/system.xml.schema/ixmlschemainfo/
---
## IXmlSchemaInfo 類別


定義已驗證 XML 節點的後綱驗證資訊集。
...
| virtual **bool** [get_IsDefault](./get_isdefault/)() | 傳回一個值，指示此已驗證的 XML 節點是否在 XML [Schema](../) 定義語言 (XSD) 綱驗證期間套用預設值後被設定。 |
| virtual **bool** [get_IsNil](./get_isnil/)() | 傳回一個值，指示此已驗證的 XML 節點的值是否為 **nil**。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | 傳回此已驗證的 XML 節點的動態 schema 類型。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | 傳回對應此已驗證的 XML 節點的已編譯 [XmlSchemaAttribute](../xmlschemaattribute/)。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | 傳回對應此已驗證的 XML 節點的已編譯 [XmlSchemaElement](../xmlschemaelement/)。 |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | 傳回此已驗證的 XML [Schema](../) 定義語言 (XSD) schema 類型的靜態 XML。 |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | 傳回此已驗證的 XML 節點的 XmlSchemaValidity 值。 |
