...
description: 傳回與 ValidationEventHandler 相關的詳細資訊。
type: docs
weight: 53
url: /zh-hant/system.xml.schema/validationeventargs/
---
...
| [XmlSchemaException](../xmlschemaexception/) [get_Exception](./get_exception/)() | 傳回與驗證事件相關聯的 XmlSchemaException。 |
| [String](../../system/string/) [get_Message](./get_message/)() | 傳回對應於驗證事件的文字描述。 |
| [XmlSeverityType](../xmlseveritytype/) [get_Severity](./get_severity/)() | 傳回驗證事件的嚴重性。 |
...
此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式配置。切勿在堆疊上或使用 operator new 建立此類型的實例，否則會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝在 [System::SmartPtr](../../system/smartptr/) 指標中，並使用該指標作為參數傳遞給函式。
