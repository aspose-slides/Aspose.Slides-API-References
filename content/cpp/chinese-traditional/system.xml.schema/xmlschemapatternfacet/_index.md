...
description: 表示由萬維網聯盟 (W3C) 規範的 XML Schema 中的 pattern 元素。此類別可用於對 simpleType 元素輸入的值設定限制。
type: docs
weight: 742
url: /zh-hant/system.xml.schema/xmlschemapatternfacet/
---
## XmlSchemaPatternFacet 類別


表示 XML [Schema](../) 中的 **pattern** 元素，該元素由全球 [Web](../../system.web/) 聯盟 (W3C) 定義。此類別可用於指定 **simpleType** 元素的輸入值之限制。
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | 回傳指示此 facet 為固定的資訊。 |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | 回傳 **schema** 元素所引用檔案的行號。 |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | 回傳 **schema** 元素所引用檔案的行位置。 |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | 回傳 facet 的 **value** 屬性。 |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | 設定 **schema** 元素所引用檔案的行號。 |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | 設定 **schema** 元素所引用檔案的行位置。 |
...
|  [XmlSchemaPatternFacet](./xmlschemapatternfacet/)() | 初始化 [XmlSchemaPatternFacet](./) 類別的新實例。 |
...
應僅使用 [System::MakeObject()](../../system/makeobject/) 函式配置此類別的物件。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝在 [System::SmartPtr](../../system/smartptr/) 指標中，並使用該指標作為參數傳遞給函式。 
