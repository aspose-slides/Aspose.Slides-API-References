...
description: 表示 XML 綱要物件模型階層的根類別，並作為例如 XmlSchema 類別等類別的基底類別。
type: docs
weight: 677
url: /zh-hant/system.xml.schema/xmlschemaobject/
---
## XmlSchemaObject 類別

表示 [Xml](../../system.xml/) 綱要物件模型階層的根類別，並作為 [XmlSchema](../xmlschema/) 類別等類別的基底類別。
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | 傳回 **schema** 元素所參照之檔案中的行號。 |
| **int32_t** [get_LinePosition](./get_lineposition/)() | 傳回 **schema** 元素所參照之檔案中的行位置。 |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](./get_namespaces/)() | 傳回用於此 schema 物件的 XmlSerializerNamespaces。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\> [get_Parent](./get_parent/)() | 傳回此 [XmlSchemaObject](./) 的父項。 |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | 傳回載入 schema 的檔案之來源位置。 |
...
| void [set_LineNumber](./set_linenumber/)(**int32_t**) | 設定 **schema** 元素所參照之檔案的行號。 |
| void [set_LinePosition](./set_lineposition/)(**int32_t**) | 設定 **schema** 元素所參照之檔案的行位置。 |
| void [set_Namespaces](./set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | 設定此 schema 物件所使用的 XmlSerializerNamespaces。 |
| void [set_Parent](./set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\>\&) | 設定此 [XmlSchemaObject](./) 的父項。 |
| void [set_SourceUri](./set_sourceuri/)(const [String](../../system/string/)\&) | 設定載入 schema 的檔案之來源位置。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 将第 n 個模板參數設為弱指標（而非共享指標）。允許在容器中將指標切換為弱模式。 |
...
|  [XmlSchemaObject](./xmlschemaobject/)() | 初始化 [XmlSchemaObject](./) 類別的新實例。 |
...
此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式配置。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為這會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
