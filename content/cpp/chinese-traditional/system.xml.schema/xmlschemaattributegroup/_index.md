...
description: 代表由萬維網聯盟（W3C）指定的 XML Schema 中的 attributeGroup 元素。AttributesGroups 提供了一種機制，可將一組屬性聲明分組，以便將其作為整體納入複雜類型定義中。
type: docs
weight: 183
url: /zh-hant/system.xml.schema/xmlschemaattributegroup/
---
## XmlSchemaAttributeGroup 類別
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 風格比較參考型別之物件。 |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | 以 C# 風格比較值型別之物件。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | 傳回屬於屬性群組的 [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) 元件。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | 傳回屬性群組的屬性集合。包含 [XmlSchemaAttribute](../xmlschemaattribute/) 和 [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) 元素。 |
...
| [String](../../system/string/) [get_Name](./get_name/)() | 傳回屬性群組的名稱。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | 傳回屬性群組的限定名稱。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttributeGroup](./)\> [get_RedefinedAttributeGroup](./get_redefinedattributegroup/)() | 傳回自 XML [Schema](../) 重新定義之屬性群組屬性。 |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | 設定屬性群組的 [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) 元件。 |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | 設定屬性群組的名稱。 |
...
|  [XmlSchemaAttributeGroup](./xmlschemaattributegroup/)() | 初始化 [XmlSchemaAttributeGroup](./) 類別的新執行個體。 |
...
此類別的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函式進行配置。切勿在堆疊上或使用 operator new 建立此類型的實例，否則會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
