...
description: "用於身分約束（key、keyref 和 unique 元素）的類別。"
type: docs
weight: 469
url: /zh-hant/system.xml.schema/xmlschemaidentityconstraint/
---
## XmlSchemaIdentityConstraint 類別

此類別用於身分約束：**key**、**keyref** 和 **unique** 元素。
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | 傳回適用於 XML Path Language ([XPath](../../system.xml.xpath/)) 表達式選取器之子項的欄位集合。 |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | 傳回字串 id。 |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | 傳回 **schema** 元素所參照的檔案中的行號。 |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | 傳回 **schema** 元素所參照的檔案中的行位置。 |
| [String](../../system/string/) [get_Name](./get_name/)() | 傳回身分約束的名稱。 |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | 傳回此 schema 物件使用的 XmlSerializerNamespaces。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | 傳回身分約束的合格名稱，該名稱保存 **QualifiedName** 值的編譯後詮釋。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | 傳回 [XPath](../../system.xml.xpath/) 表達式 **selector** 元素。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 複製建構子。實際上不會複製任何內容，只是初始化新物件並允許在子類別中進行複製建構。 |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | 設定 **schema** 元素所參照的檔案中的行號。 |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | 設定 **schema** 元素所參照的檔案中的行位置。 |
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | 設定身分約束的名稱。 |
...
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | 設定 [XPath](../../system.xml.xpath/) 表達式 **selector** 元素。 |
...
|  [XmlSchemaIdentityConstraint](./xmlschemaidentityconstraint/)() | 初始化 [XmlSchemaIdentityConstraint](./) 類別的新實例。 |
...
此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式配置。切勿在堆疊上或使用 operator new 建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
