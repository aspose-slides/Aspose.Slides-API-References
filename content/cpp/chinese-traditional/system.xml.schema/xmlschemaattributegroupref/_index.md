...
description: 表示具有 ref 屬性的 attributeGroup 元素，來自 XML Schema，依據 . 所指定。AttributesGroupRef 是 attributeGroup 的參考，name 屬性包含被參考的 attribute group。
type: docs
weight: 196
url: /zh-hant/system.xml.schema/xmlschemaattributegroupref/
---
## XmlSchemaAttributeGroupRef 類別

表示來自 XML [Schema](../) 且符合 [World Wide Web Consortium (W3C)](https://go.microsoft.com/fwlink/?LinkId=49454) 指定的 **ref** 屬性的 **attributeGroup** 元素。AttributesGroupRef 是 attributeGroup 的參考，name 屬性包含被參考的 attribute group。
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | 傳回此 [XmlSchemaObject](../xmlschemaobject/) 的父物件。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | 傳回被參考的 **attributeGroup** 元素名稱。 |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 設定被參考的 **attributeGroup** 元素名稱。 |
...
|  [XmlSchemaAttributeGroupRef](./xmlschemaattributegroupref/)() | 初始化 [XmlSchemaAttributeGroupRef](./) 類別的新執行個體。 |
...
此類別的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函式進行配置。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。務必將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
