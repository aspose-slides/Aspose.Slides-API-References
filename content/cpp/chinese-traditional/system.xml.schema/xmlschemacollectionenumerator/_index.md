...
description: 支援對集合的簡易疊代。本類別不可被繼承。
type: docs
weight: 235
url: /zh-hant/system.xml.schema/xmlschemacollectionenumerator/
---
## XmlSchemaCollectionEnumerator 類別
...
| 方法 | 說明 |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | 將迭代器準備好以供 VirtualizedIterator 類別使用。 |
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchema](../xmlschema/)\>\> * [CloneIterator](./cloneiterator/)() const override | 複製目前的迭代器。 |
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](../../system.collections.generic/ienumerator/current/)() const | 取得目前的元素。 |
...
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\& [get_Current](./get_current/)() const override | 傳回集合中的目前 [XmlSchema](../xmlschema/)。 |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | 將迭代器向前移動一步。 |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 執行第一個 [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 呼叫，並將列舉器物件準備好以供 VirtualizedIterator 使用。 |
...
| **bool** [MoveNext](./movenext/)() override | 將列舉器前進至集合中的下一個 schema。 |
|  [Object](../../system/object/object/)() | 建立物件。初始化所有內部資料結構。 |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 複製建構函式。實際上什麼也不複製，只是初始化新物件並允許子類別的複製建構。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 賦值運算子。實際上什麼也不複製，只是初始化新物件並允許子類別的複製建構。 |
...
| 型別別名 | 說明 |
| --- | --- |
| [Ptr](./ptr/) | 此類別之實例的 shared pointer 別名。 |

## 備註

此類別的物件應僅使用 [System::MakeObject()](../../system/makeobject/) 函式配置。切勿在堆疊上或使用 operator new 建立此類型的實例，否則會導致執行時錯誤或斷言失敗。始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標將其作為參數傳遞給函式。
