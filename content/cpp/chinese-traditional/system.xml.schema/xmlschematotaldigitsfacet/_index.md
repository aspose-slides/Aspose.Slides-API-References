...
description: 表示 World Wide Web Consortium (W3C) 所指定的 XML Schema 中的 totalDigits facet。此類別可用於對 simpleType 元素的值可輸入的位數數量施加限制。totalDigits 的值必須為正整數。
type: docs
weight: 898
url: /zh-hant/system.xml.schema/xmlschematotaldigitsfacet/
---
## XmlSchemaTotalDigitsFacet 類別
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | 返回 string id。 |
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | 返回指示此 facet 為固定的資訊。 |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | 返回 **schema** 元素所指檔案中的行號。 |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | 返回 **schema** 元素所指檔案中的列位置。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | 返回此 [XmlSchemaObject](../xmlschemaobject/) 的父項目。 |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | 返回 facet 的 **value** 屬性。 |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 指派運算子。實際上不複製任何內容，只是初始化新物件，並允許子類別的拝貝建構。 |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | 設定 string id。 |
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | 設定指示此 facet 為固定的資訊。 |
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | 設定 **schema** 元素所指檔案中的行號。 |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | 設定 **schema** 元素所指檔案中的列位置。 |
...
|  [XmlSchemaTotalDigitsFacet](./xmlschematotaldigitsfacet/)() | 初始化 [XmlSchemaTotalDigitsFacet](./) 類別的新實例。 |
