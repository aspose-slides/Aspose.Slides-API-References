...
description: 從 XML 文件推斷 XML 架構定義語言 (XSD) 架構。XmlSchemaInference 類別無法被繼承。
type: docs
weight: 508
url: /zh-hant/system.xml.schema/xmlschemainference/
---
## XmlSchemaInference 類別

從 XML 文檔推斷 XML [Schema](../) 定義語言 (XSD) 架構。[XmlSchemaInference](./) 類別無法被繼承。
...
| [XmlSchemaInference::InferenceOption](./inferenceoption/) [get_Occurrence](./get_occurrence/)() | 傳回影響從 XML 文檔推斷之架構出現聲明的 [XmlSchemaInference::InferenceOption](./inferenceoption/) 值。 |
| [XmlSchemaInference::InferenceOption](./inferenceoption/) [get_TypeInference](./get_typeinference/)() | 傳回影響從 XML 文檔推斷之類型的 [XmlSchemaInference::InferenceOption](./inferenceoption/) 值。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件相關聯的參考計數資料結構。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。啟用自訂物件的雜湊。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際類型。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\> [InferSchema](./inferschema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | 從指定的 [XmlReader](../../system.xml/xmlreader/) 物件所包含的 XML 文檔推斷 XML [Schema](../) 定義語言 (XSD) 架構。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\> [InferSchema](./inferschema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSet](../xmlschemaset/)\>) | 從指定的 [XmlReader](../../system.xml/xmlreader/) 物件所包含的 XML 文檔推斷 XML [Schema](../) 定義語言 (XSD) 架構，並使用同一目標名稱空間的 [XmlSchemaSet](../xmlschemaset/) 物件中現有的架構來精緻推斷出的架構。 |
...
| void [set_Occurrence](./set_occurrence/)([XmlSchemaInference::InferenceOption](./inferenceoption/)) | 設定影響從 XML 文檔推斷之架構出現聲明的 [XmlSchemaInference::InferenceOption](./inferenceoption/) 值。 |
| void [set_TypeInference](./set_typeinference/)([XmlSchemaInference::InferenceOption](./inferenceoption/)) | 設定影響從 XML 文檔推斷之類型的 [XmlSchemaInference::InferenceOption](./inferenceoption/) 值。 |
...
|  [XmlSchemaInference](./xmlschemainference/)() | 初始化 [XmlSchemaInference](./) 類別的新實例。 |
...
| 列舉 | 說明 |
| --- | --- |
| [InferenceOption](./inferenceoption/) | 影響 [XmlSchemaInference](./) 類別從 XML 文檔推斷的元素與屬性的出現與類型資訊。 |
...
此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式配置。切勿在堆疊上或使用 new 運算子建立此類型的實例，否則會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
