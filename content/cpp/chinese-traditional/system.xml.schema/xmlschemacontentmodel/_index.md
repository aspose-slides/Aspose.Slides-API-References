...
description: 指定類型之子元素的順序與結構。
type: docs
weight: 326
url: /zh-hant/system.xml.schema/xmlschemacontentmodel/
---
## XmlSchemaContentModel 類別
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() | 傳回類型的內容。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否為 targetType 描述之型別的實例。C# 'is' 運算子 的類比。 |
...
| virtual void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) | 設定類型的內容。 |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | 設定可與此 schema 物件一起使用的 XmlSerializerNamespaces。 |
