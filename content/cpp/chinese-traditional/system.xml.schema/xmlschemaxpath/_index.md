...
description: 代表 World Wide Web Consortium (W3C) selector 元素。
type: docs
weight: 963
url: /zh-hant/system.xml.schema/xmlschemaxpath/
---
## XmlSchemaXPath class


代表 World Wide [Web](../../system.web/) Consortium (W3C) **selector** 元素。
...
| [String](../../system/string/) [get_XPath](./get_xpath/)() | 傳回 [XPath](../../system.xml.xpath/) 表達式的屬性。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否代表 targetType 所描述的型別實例。C# 'is' 運算子的類比。 |
...
| void [set_XPath](./set_xpath/)(const [String](../../system/string/)\&) | 設定 [XPath](../../system.xml.xpath/) 表達式的屬性。 |
...
此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式配置。切勿在堆疊上或使用 new 運算子建立此型別的實例，因為這會導致執行時錯誤和/或斷言失敗。始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標將其作為參數傳遞給函式。
