...
description: 此類別代表 XMLSchema 中的 key 元素，該元素由萬維網協會 (W3C) 所定義。
type: docs
weight: 534
url: /zh-hant/system.xml.schema/xmlschemakey/
---
## XmlSchemaKey 類別


此類別代表 XMLSchema 中的 **key** 元素，該元素由全球 [Web](../../system.web/) 聯盟（W3C）所定義。
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](../xmlschemaidentityconstraint/get_fields/)() | 傳回適用於 XML Path Language ([XPath](../../system.xml.xpath/)) 表達式選取器的欄位集合。 |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | 傳回字串 id。 |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | 傳回 **schema** 元素所指向之檔案內的行號。 |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | 傳回 **schema** 元素所指向之檔案內的列位置。 |
| [String](../../system/string/) [get_Name](../xmlschemaidentityconstraint/get_name/)() | 傳回身分限制式的名稱。 |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | 傳回要與此 schema 物件一起使用的 XmlSerializerNamespaces。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](../xmlschemaidentityconstraint/get_qualifiedname/)() | 傳回身分限制式的限定名稱，該名稱保留 **QualifiedName** 值的編譯後詮釋。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](../xmlschemaidentityconstraint/get_selector/)() | 傳回 [XPath](../../system.xml.xpath/) 表達式 **selector** 元素。 |
...
| void [Lock](../../system/object/lock/)() | 實作 C# lock() 陳述式之鎖定。可直接呼叫或使用 [LockContext](../../system/lockcontext/) 監視物件。 |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | 設定 **schema** 元素所指向之檔案內的行號。 |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | 設定 **schema** 元素所指向之檔案內的列位置。 |
| void [set_Name](../xmlschemaidentityconstraint/set_name/)(const [String](../../system/string/)\&) | 設定身分限制式的名稱。 |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | 設定要與此 schema 物件一起使用的 XmlSerializerNamespaces。 |
...
| void [set_Selector](../xmlschemaidentityconstraint/set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | 設定 [XPath](../../system.xml.xpath/) 表達式 **selector** 元素。 |
...
| void [Unlock](../../system/object/unlock/)() | 實作 C# lock() 陳述式之解鎖。可直接呼叫或使用 [LockContext](../../system/lockcontext/) 監視物件。 |
...
|  [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/xmlschemaidentityconstraint/)() | 初始化 [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/) 類別的新執行個體。 |
...
此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式配置。絕不要在堆疊上或使用 new 運算子建立此類型的實例，因為這會導致執行時錯誤和/或斷言失敗。請始終將此類別封裝於 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。

## 另請參閱

* 類別 [XmlSchemaIdentityConstraint](../xmlschemaidentityconstraint/)
