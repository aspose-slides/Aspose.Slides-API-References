...
description: 代表符合 World Wide Web Consortium (W3C) 規範的 XML Schema 中的 extension 元素。此類別用於透過擴充衍生的具有複雜內容模型的複雜型別。它透過加入屬性或元素來擴充此複雜型別。
type: docs
weight: 274
url: /zh-hant/system.xml.schema/xmlschemacomplexcontentextension/
---
## XmlSchemaComplexContentExtension 類別
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | 回傳複雜內容模型的 [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) 元件。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | 回傳複雜內容的屬性集合。包含 [XmlSchemaAttribute](../xmlschemaattribute/) 與 [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) 元素。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | 回傳此類型透過擴充衍生的複雜型別名稱。 |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | 回傳字串 id。 |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | 回傳 **schema** 元素所指向之檔案中的行號。 |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | 回傳 **schema** 元素所指向之檔案中的行位置。 |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | 回傳此 schema 物件使用的 XmlSerializerNamespaces。 |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\> [get_Particle](./get_particle/)() | 回傳 [XmlSchemaGroupRef](../xmlschemagroupref/)、[XmlSchemaChoice](../xmlschemachoice/)、[XmlSchemaAll](../xmlschemaall/) 或 [XmlSchemaSequence](../xmlschemasequence/) 類別之一。 |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | 回傳載入 schema 的檔案來源位置。 |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | 設定複雜內容模型的 [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) 元件。 |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | 設定此類型透過擴充衍生的複雜型別名稱。 |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\>\&) | 設定 [XmlSchemaGroupRef](../xmlschemagroupref/)、[XmlSchemaChoice](../xmlschemachoice/)、[XmlSchemaAll](../xmlschemaall/) 或 [XmlSchemaSequence](../xmlschemasequence/) 類別之一。 |
...
|  [XmlSchemaComplexContentExtension](./xmlschemacomplexcontentextension/)() | 初始化 [XmlSchemaComplexContentExtension](./) 類別的新執行個體。 |
...
此類別的物件僅應使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 new 運算子建立此型別的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。 
