...
description: 代表萬維網聯盟 (W3C) 的 appinfo 元素。
type: docs
weight: 157
url: /zh-hant/system.xml.schema/xmlschemaappinfo/
---
## XmlSchemaAppInfo 類別


代表全球 [Web](../../system.web/) 聯盟 (W3C) **appinfo** 元素。
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | 傳回一個 [XmlNode](../../system.xml/xmlnode/) 物件陣列，表示 **appinfo** 子節點。 |
...
| [String](../../system/string/) [get_Source](./get_source/)() | 傳回應用程式資訊的來源。 |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | 設定一個 [XmlNode](../../system.xml/xmlnode/) 物件陣列，表示 **appinfo** 子節點。 |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | 設定應用程式資訊的來源。 |
...
此類別的物件只能使用 [System::MakeObject()](../../system/makeobject/) 函式配置。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。 
