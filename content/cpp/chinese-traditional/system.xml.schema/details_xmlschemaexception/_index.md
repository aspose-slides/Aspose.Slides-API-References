...
description: 返回有關結構例外的詳細資訊。
type: docs
weight: 1
url: /zh-hant/system.xml.schema/details_xmlschemaexception/
---
## Details_XmlSchemaException 類別
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | 返回包含自訂例外資料的字典。 |
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 返回 32 位元整數值，該值是與目前物件所代表的例外相關聯的 HRESULT 代碼。 |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | 返回代表內部例外之物件的參照。 |
| **int32_t** [get_LineNumber](./get_linenumber/)() | 返回指示錯誤發生位置的行號。 |
| **int32_t** [get_LinePosition](./get_lineposition/)() | 返回指示錯誤發生位置的行位置。 |
| [String](../../system/string/) [get_Message](./get_message/)() const override | 返回此例外的錯誤條件描述。 |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](./get_sourceschemaobject/)() | 產生 XmlSchemaException 的 **[XmlSchemaObject](../xmlschemaobject/)**。 |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | 返回導致例外的結構之統一資源識別碼 (URI) 位置。 |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | 返回包含堆疊追蹤的字串。 |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | 返回代表最內層例外之 Exception 物件的副本。 |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | 取得物件的實際型別。為 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫的類比。 |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷貝建構式。實際上不會拷貝任何內容，只是初始化新物件並允許子類別的拷貝建構。 |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | 返回目前物件的字串表示。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 實作 [what()](../../system/details_exception/what/) 方法，此方法由 [ExceptionWrapper](../../system/exceptionwrapper/) 類別呼叫。儘管此類別未繼承自 std::exception，但衍生類別仍可使用受保護/私有成員來實作其邏輯。將此方法的實作移至 [ExceptionWrapper](../../system/exceptionwrapper/) 可能會破壞該邏輯。 |
