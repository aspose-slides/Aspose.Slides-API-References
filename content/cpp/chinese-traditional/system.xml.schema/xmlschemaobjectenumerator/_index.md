...
description: 代表 XmlSchemaObjectCollection 的列舉器。
type: docs
weight: 703
url: /zh-hant/system.xml.schema/xmlschemaobjectenumerator/
---
## XmlSchemaObjectEnumerator 類別


代表 [XmlSchemaObjectCollection](../xmlschemaobjectcollection/) 的列舉器。
...
| Method | Description |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | 準備迭代器以供 VirtualizedIterator 類別使用。 |
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchemaObject](../xmlschemaobject/)\>\> * [CloneIterator](./cloneiterator/)() const override | 克隆目前的迭代器。 |
...
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\& [get_Current](./get_current/)() const override | 傳回集合中目前的 [XmlSchemaObject](../xmlschemaobject/)。 |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | 執行第一次的 [MoveNext()](../../system.collections.generic/ienumerator/movenext/) 呼叫，並準備列舉器物件以供 VirtualizedIterator 使用。 |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | 標記由 virtualized iterator 所擁有的列舉器。 |
...
| **bool** [MoveNext](./movenext/)() override | 移動至集合中的下一個項目。 |
...
| void [Reset](./reset/)() override | 將列舉器重設至集合的起始位置。 |
...
此類別的物件應僅透過 [System::MakeObject()](../../system/makeobject/) 函式配置。切勿在堆疊上或使用 operator new 建立此類型的實例，否則會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標作為參數傳遞給函式。
