...
description: 用於在 EOT 格式中嵌入字型的格式化控制器類別
type: docs
weight: 14
...
| 方法 | 描述 |
| --- | --- |
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)() | 建立新實例。 |
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | 建立新實例。 |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | 模擬 C# 風格的浮點比較，兩個 NaN 被視為相等，即使根據 IEC 60559:1989 標準，NaN 與任何值都不相等，包括 NaN 本身。 |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | 模擬 C# 風格的浮點比較，兩個 NaN 被視為相等，即使根據 IEC 60559:1989 標準，NaN 與任何值都不相等，包括 NaN 本身。 |
...
* 類別 [IEmbeddedEotFontsHtmlController](../iembeddedeotfontshtmlcontroller/)
