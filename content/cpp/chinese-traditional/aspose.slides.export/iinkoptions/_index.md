...
description: 提供控制匯出文件中墨跡物件外觀的選項。
type: docs
weight: 235
...
提供控制匯出文件中 [Ink](../../aspose.slides.ink/) 物件外觀的選項。
...
| virtual **bool** [get_HideInk](./get_hideink/)() | 在匯出文件中顯示或隱藏 [Ink](../../aspose.slides.ink/) 元素。 |
| virtual **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() | 使用 ROP 運算或不透明度來呈現畫筆。 |
...
| virtual void [set_HideInk](./set_hideink/)(**bool**) | 在匯出文件中顯示或隱藏 [Ink](../../aspose.slides.ink/) 元素。 |
| virtual void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) | 使用 ROP 運算或不透明度來呈現畫筆。 |
