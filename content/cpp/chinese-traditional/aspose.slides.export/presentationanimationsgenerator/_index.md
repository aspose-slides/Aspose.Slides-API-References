...
| 方法 | 說明 |
| --- | --- |
| void [Dispose](./dispose/)() override | 釋放 [PresentationAnimationsGenerator](./) 的實例。 |
...
| **int32_t** [get_DefaultDelay](./get_defaultdelay/)() const | 取得預設延遲時間 [毫秒]。 |
| **int32_t** [get_ExportedSlides](./get_exportedslides/)() const | 取得匯出投影片的計數。 |
| **bool** [get_IncludeHiddenSlides](./get_includehiddenslides/)() const | 取得或設定是否包含隱藏投影片。 |
...
|  [PresentationAnimationsGenerator](./presentationanimationsgenerator/)([System::SharedPtr](../../system/sharedptr/)\<[Presentation](../../aspose.slides/presentation/)\>) | 建立 [PresentationAnimationsGenerator](./) 的新實例。 |
|  [PresentationAnimationsGenerator](./presentationanimationsgenerator/)([System::Drawing::Size](../../system.drawing/size/)) | 建立 [PresentationAnimationsGenerator](./) 的新實例。 |
...
| void [Run](./run/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>\>\>) | 對每張投影片執行動畫事件產生。 |
| void [Run](./run/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>\>\>, **int32_t**, [PresentationPlayer::FrameTickHandler](../presentationplayer/frametickhandler/)) | 對每張投影片執行動畫事件產生。 |
| void [set_DefaultDelay](./set_defaultdelay/)(**int32_t**) | 設定預設延遲時間 [毫秒]。 |
| void [set_IncludeHiddenSlides](./set_includehiddenslides/)(**bool**) | 取得或設定是否包含隱藏投影片。 |
