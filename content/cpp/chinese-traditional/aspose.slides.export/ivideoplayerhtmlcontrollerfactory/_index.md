...
---
## IVideoPlayerHtmlControllerFactory 類別


允許建立 [VideoPlayerHtmlController](../videoplayerhtmlcontroller/)。
...
| 方法 | 說明 |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVideoPlayerHtmlController](../ivideoplayerhtmlcontroller/)\> [CreateVideoPlayerHtmlController](./createvideoplayerhtmlcontroller/)([System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) | 建立影片播放器 HTML 控制器。 |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | 檢查物件是否為目標型別描述的實例。相當於 C# 'is' 運算子。 |
