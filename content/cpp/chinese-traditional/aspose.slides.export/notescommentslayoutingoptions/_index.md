...
description: 提供控制匯出文件中註記與註解版面配置外觀的選項。
type: docs
weight: 560
...
| [System::Drawing::Color](../../system.drawing/color/) [get_CommentsAreaColor](./get_commentsareacolor/)() | 取得評論區域的顏色（僅在評論顯示於右側時適用）。 |
| **int32_t** [get_CommentsAreaWidth](./get_commentsareawidth/)() | 取得評論輸出區域的寬度（單位為像素，僅在評論顯示於右側時適用）。 |
| [CommentsPositions](../commentspositions/) [get_CommentsPosition](./get_commentsposition/)() | 取得評論在頁面上的位置。 |
| [NotesPositions](../notespositions/) [get_NotesPosition](./get_notesposition/)() | 取得備註在頁面上的位置。 |
| **bool** [get_ShowCommentsByNoAuthor](./get_showcommentsbynoauthor/)() | 取得沒有作者的評論之可見性。若為 true，則會顯示評論。（僅在顯示評論時適用） |
...
|  [NotesCommentsLayoutingOptions](./notescommentslayoutingoptions/)() | 預設建構子。 |
...
| void [set_CommentsAreaColor](./set_commentsareacolor/)([System::Drawing::Color](../../system.drawing/color/)) | 設定評論區域的顏色（僅在評論顯示於右側時適用）。 |
| void [set_CommentsAreaWidth](./set_commentsareawidth/)(**int32_t**) | 設定評論輸出區域的寬度（單位為像素，僅在評論顯示於右側時適用）。 |
| void [set_CommentsPosition](./set_commentsposition/)([CommentsPositions](../commentspositions/)) | 設定評論在頁面上的位置。 |
| void [set_NotesPosition](./set_notesposition/)([NotesPositions](../notespositions/)) | 設定備註在頁面上的位置。 |
| void [set_ShowCommentsByNoAuthor](./set_showcommentsbynoauthor/)(**bool**) | 設定沒有作者的評論之可見性。若為 true，則會顯示評論。（僅在顯示評論時適用） |
