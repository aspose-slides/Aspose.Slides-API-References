...
description: 用於決定在保存過程中如何處理物件的回呼介面。
type: docs
weight: 248
...
| virtual [LinkEmbedDecision](../linkembeddecision/) [GetObjectStoringLocation](./getobjectstoringlocation/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) | 決定物件應存放的位置。此方法對每個物件 id 會被呼叫一次。無法保證不會出現具有相同 data、semanticName 與 contentType 但 id 不同的兩個物件。 |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | 取得物件的實際型別。相當於 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
| virtual [System::String](../../system/string/) [GetUrl](./geturl/)(**int32_t**, **int32_t**) | 傳回指向外部物件的 URL。若 [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/) 回傳 [LinkEmbedDecision::Link](../linkembeddecision/)，此方法一定會被呼叫；若 [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/) 回傳 [LinkEmbedDecision::Embed](../linkembeddecision/) 但無法嵌入，亦可能被呼叫。對相同物件 id 可多次呼叫。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化版，用於 string 與 nullptr 的情況。 |
...
| virtual void [SaveExternal](./saveexternal/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | 儲存外部物件。 |
