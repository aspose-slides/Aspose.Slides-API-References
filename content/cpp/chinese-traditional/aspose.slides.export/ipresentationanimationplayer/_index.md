...
| virtual ASPOSE_SLIDES_LOCAL_API **double** [get_Duration](./get_duration/)() | 取得動畫持續時間 [ms] |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IImage](../../aspose.slides/iimage/)\> [GetFrame](./getframe/)() | 取得先前使用 [IPresentationAnimationPlayer::SetTimePosition](./settimeposition/) 方法設定的目前時間位置的框架。 |
...
| virtual ASPOSE_SLIDES_LOCAL_API void [SetTimePosition](./settimeposition/)(**double**) | 設定 [IPresentationAnimationPlayer::get_Duration](./get_duration/) 內的動畫時間位置。 |
...
動畫由 [PresentationAnimationsGenerator](../presentationanimationsgenerator/) 透過其 **PresentationAnimationsGenerator::NewAnimation** 事件產生。
