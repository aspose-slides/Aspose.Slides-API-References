...
| virtual **bool** [get_DisableFontLigatures](./get_disablefontligatures/)() | 取得一個值，指示文字是否在未使用連字的情況下呈現。設定為 **true** 時，連字將在輸出中被停用。預設情況下，此屬性為 **false**。 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/)\> [get_WarningCallback](../isaveoptions/get_warningcallback/)() | 返回一個接收警告並決定載入程序是否繼續或中止的物件。讀取 [Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/)。 |
...
| virtual void [set_DisableFontLigatures](./set_disablefontligatures/)(**bool**) | 設定一個值，指示文字是否在未使用連字的情況下呈現。設定為 **true** 時，連字將在輸出中被停用。預設情況下，此屬性為 **false**。 |
...
| virtual void [set_WarningCallback](../isaveoptions/set_warningcallback/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/)\>) | 設定一個接收警告並決定載入程序是否繼續或中止的物件。寫入 [Aspose::Slides::Warnings::IWarningCallback](../../aspose.slides.warnings/iwarningcallback/)。 |
