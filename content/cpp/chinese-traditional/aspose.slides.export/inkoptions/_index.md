...
提供用於控制匯出文件中 [Ink](../../aspose.slides.ink/) 物件外觀的選項。
...
| **bool** [get_HideInk](./get_hideink/)() override | 在匯出文件中顯示或隱藏 [Ink](../../aspose.slides.ink/) 元素。 |
| **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() override | 使用 ROP 運算或不透明度來繪製筆刷。 |
...
| void [set_HideInk](./set_hideink/)(**bool**) override | 在匯出文件中顯示或隱藏 [Ink](../../aspose.slides.ink/) 元素。 |
| void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) override | 使用 ROP 運算或不透明度來繪製筆刷。 |
