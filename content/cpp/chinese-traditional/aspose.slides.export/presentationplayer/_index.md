...
description: 代表與 Presentation 相關聯的動畫播放器。
type: docs
weight: 625
...
代表與 [Presentation](../../aspose.slides/presentation/) 相關聯的動畫播放器。
...
| 方法 | 描述 |
| --- | --- |
| void [Dispose](./dispose/)() override | 釋放 [PresentationPlayer](./) 的實例。 |
...
| **int32_t** [get_FrameIndex](./get_frameindex/)() | 取得框架索引。 |
...
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | 建立 [PresentationPlayer](./) 的新實例。 |
...
| 型別別名 | 描述 |
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | 代表 **PresentationPlayer::FrameTick** 事件的框架滴答處理程式。 |
