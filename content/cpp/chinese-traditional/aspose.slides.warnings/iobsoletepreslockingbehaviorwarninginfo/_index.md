...
---
## IObsoletePresLockingBehaviorWarningInfo 類別
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | 返回此警告的可讀描述。唯讀 [System::String](../../system/string/)。 |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | 返回警告的類型。唯讀 [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/)。 |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | 將共用引用計數減少指定值。 |
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | 如果接收器不為 null，將警告傳送給指定的接收器，且若接收器決定中止操作，會拋出 AbortRequestedException。 |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 將第 n 個模板參數設為弱指標（而非共用指標）。允許在容器中將指標切換為弱模式。 |
| int [SharedCount](../../system/object/sharedcount/)() const | 取得共用引用計數的目前值。 |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | 遞增共用引用計數。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | 遞減並返回共用引用計數。不應直接呼叫；請改用智慧指標或 ThisProtector。 |
