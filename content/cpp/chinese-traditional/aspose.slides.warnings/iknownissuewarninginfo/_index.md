...
description: 表示一個關於已知問題的警告，該問題在近期內不會被修復。
type: docs
weight: 1
url: /zh-hant/aspose.slides.warnings/iknownissuewarninginfo/
---
## IKnownIssueWarningInfo 類別


表示一個關於已知問題的警告，該問題在近期內不會被修復。
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | 傳回此警告的可讀說明。唯讀 [System::String](../../system/string/)。 |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | 傳回警告類型。唯讀 [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/)。 |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) 的特化版本，用於字串和 nullptr 情況。 |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | 如果接收者不為 null，將警告傳送給指定的接收者，且若接收者決定中止操作，拋出 AbortRequestedException。 |
