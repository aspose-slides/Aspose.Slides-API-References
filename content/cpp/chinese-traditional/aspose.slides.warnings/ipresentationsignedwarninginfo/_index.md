...
description: 此警告表示正在讀取的簡報具有簽章，且此簽章將在處理過程中被移除。
type: docs
weight: 40
url: /zh-hant/aspose.slides.warnings/ipresentationsignedwarninginfo/
---
## IPresentationSignedWarningInfo 類別


此警告表示正在讀取的簡報具有簽章，且此簽章將在處理過程中被移除。
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | 傳回此警告的人類可讀描述。唯讀 [System::String](../../system/string/)。 |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | 如果 receiver 不為 null，將警告傳送給指定的 receiver，且當 receiver 決定中止操作時拋出 AbortRequestedException。 |
