...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | 拷貝建構函式。實際上不會拷貝任何東西，只是初始化新物件，並允許在子類別中使用拷貝建構。 |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | 賦值運算子。實際上不會拷貝任何東西，只是初始化新物件，並允許在子類別中使用拷貝建構。 |
...
| virtual [ReturnAction](../returnaction/) [Warning](./warning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningInfo](../iwarninginfo/)\>) | 回呼方法，接收警告並決定是否應中止操作。 |
