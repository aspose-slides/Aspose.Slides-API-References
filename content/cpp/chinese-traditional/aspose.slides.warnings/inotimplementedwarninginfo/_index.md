...
description: 代表關於已知未實作功能的警告，該功能不會在近期內實作。
type: docs
weight: 14
url: /zh-hant/aspose.slides.warnings/inotimplementedwarninginfo/
---
## INotImplementedWarningInfo 類別


代表關於已知未實作功能的警告，該功能不會在近期內實作。
...
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | 傳回警告的類型。唯讀 [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/)。 |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | 如果接收者不為 null，將警告傳送至指定的接收者，且若接收者決定中止操作，則拋出 AbortRequestedException。 |
