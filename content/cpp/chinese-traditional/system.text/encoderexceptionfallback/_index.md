...
description: "提供會拋出例外的備援策略。此類別的物件只能使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝在 System::SmartPtr 指標中，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 144
url: /zh-hant/system.text/encoderexceptionfallback/
---
## EncoderExceptionFallback 類別
...
| 方法 | 說明 |
| --- | --- |
| [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | 建立後備緩衝區。 |
| [EncoderExceptionFallback](./encoderexceptionfallback/)() | 建構函式。 |
...
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](../encoderfallback/get_exceptionfallback/)() | 取得預設的例外後備實作。 |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | 取得此實例可返回的字元最大數量。 |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](../encoderfallback/get_replacementfallback/)() | 取得預設的替代後備實作。 |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_StandardSafeFallback](../encoderfallback/get_standardsafefallback/)() | 取得預設的標準安全後備實作。 |
