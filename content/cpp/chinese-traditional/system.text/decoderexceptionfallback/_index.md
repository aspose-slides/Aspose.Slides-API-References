...
description: "提供拋出例外的回退策略。此類別的物件只能使用 System::MakeObject() 函式分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用此指標將其作為參數傳遞給函式。"
type: docs
weight: 27
url: /zh-hant/system.text/decoderexceptionfallback/
---
## DecoderExceptionFallback 類別


提供拋出例外的回退策略。此類別的物件只能使用 [System::MakeObject()](../../system/makeobject/) 函式分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，因為會導致執行時錯誤和/或斷言失敗。應始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用此指標將其作為參數傳遞給函式。
...
| 方法 | 描述 |
| --- | --- |
| [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | 建立回退緩衝區。 |
...
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](../decoderfallback/get_exceptionfallback/)() | 取得預設的例外回退實作。 |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | 取得此實例可返回的最大字元數。 |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](../decoderfallback/get_replacementfallback/)() | 取得預設的替換回退實作。 |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](../decoderfallback/get_standardsafefallback/)() | 取得預設的標準安全回退實作。 |
...
* 類別 [DecoderFallback](../decoderfallback/)
* 命名空間 [System::Text](../)
* 函式庫 [Aspose.Slides](../../)