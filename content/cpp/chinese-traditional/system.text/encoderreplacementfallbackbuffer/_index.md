...
description: "用於取代編碼回退策略的緩衝區。此類別的物件只能使用 System::MakeObject() 函式進行配置。切勿在堆疊上或使用 operator new 建立此類型的實例，否則會導致執行時錯誤和/或斷言失敗。請始終將此類別包裝成 System::SmartPtr 指標，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 209
url: /zh-hant/system.text/encoderreplacementfallbackbuffer/
---
## EncoderReplacementFallbackBuffer 類別

[Buffer](../../system/buffer/) 用於取代編碼回退策略。 此類別的物件只能使用 [System::MakeObject()](../../system/makeobject/) 函式分配。 絕不要在堆疊上或使用 operator new 建立此類型的實例，否則會導致執行時錯誤和/或斷言失敗。 請始終將此類別包裝成 [System::SmartPtr](../../system/smartptr/) 指標，並使用該指標將其作為參數傳遞給函式。
...
| 方法 | 說明 |
| --- | --- |
|  [EncoderReplacementFallbackBuffer](./encoderreplacementfallbackbuffer/)(const [EncoderReplacementFallbackPtr](../../system/encoderreplacementfallbackptr/)\&) | 建構函式。 |
...
| int [get_Remaining](./get_remaining/)() const override | 取得緩衝區中剩餘字元的數量。 |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | 取得與物件關聯的參考計數資料結構。 |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | 相當於 C# [Object.GetHashCode()](../../system/object/gethashcode/) 方法。啟用自訂物件的雜湊。 |
| char_t [GetNextChar](./getnextchar/)() override | 取得下一個可用的字元。 |
...
| **bool** [MovePrevious](./moveprevious/)() override | 移動至前一個字元。 |
...
| void [Reset](./reset/)() override | 將緩衝區重設為初始狀態（在呼叫 [Fallback()](./fallback/) 之前）。 |
...
| virtual  [~Object](../../system/object/~object/)() | 摧毀物件。釋放所有內部資料結構。 |
