...
description: "提供備援 API 以處理解碼錯誤。此類別的物件只能透過 System::MakeObject() 函式分配。切勿在堆疊上或使用 new 運算子建立此類型的實例，否則會導致執行時錯誤和/或斷言失敗。必須將此類別包裝在 System::SmartPtr 指標中，並使用該指標作為參數傳遞給函式。"
type: docs
weight: 53
url: /zh-hant/system.text/decoderfallback/
---
## DecoderFallback 類別
...
| 方法 | 說明 |
| --- | --- |
| virtual [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() | 取得與備援演算法關聯的緩衝區。 |
...
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](./get_exceptionfallback/)() | 取得預設例外備援實作。 |
| virtual int [get_MaxCharCount](./get_maxcharcount/)() const | 取得備援可回傳的最大字元數。 |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](./get_replacementfallback/)() | 取得預設的取代備援實作。 |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](./get_standardsafefallback/)() | 取得預設的標準安全備援實作。 |
