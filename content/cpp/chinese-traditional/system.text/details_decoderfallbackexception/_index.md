...
description: "當解碼失敗時，由 DecoderExceptionFallback 拋出的例外。切勿手動建立此類別的實例。請改用 DecoderFallbackException 類別。切勿將 DecoderFallbackException 類別的實例包裝到 System::SmartPtr 中。"
type: docs
weight: 105
url: /zh-hant/system.text/details_decoderfallbackexception/
---
## Details_DecoderFallbackException 類別
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | 取得觸發錯誤的位元組陣列。 |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | 傳回 32 位元整數值，該值是與目前物件所代表之例外相關聯的 HRESULT 代碼。 |
| int [get_Index](./get_index/)() | 取得觸發錯誤的位元組在輸入陣列中的位置。 |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | 取得物件的實際類型。類似 C# [System.Object.GetType()](../../system/object/gettype/) 呼叫。 |
...
| virtual const char * [what](../../system/details_exception/what/)() const | 實作 [what()](../../system/details_exception/what/) 方法，該方法由 [ExceptionWrapper](../../system/exceptionwrapper/) 類別呼叫。儘管此類別未從 std::exception 繼承，衍生類別仍可使用受保護/私有成員來實作其邏輯。將此方法實作移至 [ExceptionWrapper](../../system/exceptionwrapper/) 可能會破壞該邏輯。 |
