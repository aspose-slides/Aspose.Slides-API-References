...
description: Definiuje ogólnego przeznaczenia implementację Tuple, umożliwiającą dostęp do członków instancji Tuple bez znajomości podstawowego typu Tuple.
type: docs
weight: 53
url: /pl/system.runtime.compilerservices/ituple/
---
## Klasa ITuple


Definiuje implementację [Tuple](../../system/tuple/) przeznaczoną do użytku ogólnego, umożliwiającą dostęp do członków instancji [Tuple](../../system/tuple/) bez znajomości podstawowego typu [Tuple](../../system/tuple/).
...
| virtual **int32_t** [get_Length](./get_length/)() const | Zwraca liczbę pozycji w tej strukturze danych. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | Zwraca element o podanym indeksie. |
