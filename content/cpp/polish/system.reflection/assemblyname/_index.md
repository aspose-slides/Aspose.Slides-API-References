...
description: "Definiuje nazwę zestawu. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject() . Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami w czasie wykonywania i/lub naruszeniami asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go funkcjom jako argument."
type: docs
weight: 14
url: /pl/system.reflection/assemblyname/
---
## AssemblyName klasa

Definiuje nazwę zestawu. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami w czasie wykonania i/lub naruszeniami asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej do funkcji jako argument.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Pobiera nazwę zestawu. |
| [Version](../../system/version/) [get_Version](./get_version/)() | Pobiera wersję zestawu. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Odpowiednik metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia wyliczanie skrótu (hash) własnych obiektów. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Ustawia nazwę zestawu. |
| void [set_Version](./set_version/)(const [Version](../../system/version/)\&) | Ustawia wersję zestawu. |
