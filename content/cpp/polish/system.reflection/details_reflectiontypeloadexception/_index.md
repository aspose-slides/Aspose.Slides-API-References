...
description: "ReflectionTypeLoadException jest rzucany przez metodę Module.GetTypes, jeśli którakolwiek z klas w module nie zostanie załadowana. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy ReflectionTypeLoadException zamiast tego. Nigdy nie owijaj instancji klasy ReflectionTypeLoadException w System::SmartPtr."
type: docs
weight: 66
url: /pl/system.reflection/details_reflectiontypeloadexception/
---
## Details_ReflectionTypeLoadException klasa


ReflectionTypeLoadException jest rzucany przez metodę Module.GetTypes, jeśli którakolwiek z klas w module nie zostanie załadowana. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy ReflectionTypeLoadException zamiast tego. Nigdy nie owijaj instancji klasy ReflectionTypeLoadException w [System::SmartPtr](../../system/smartptr/).
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | Zwraca słownik z danymi własnego wyjątku. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Exception](../../system/exception/)\> [get_LoaderExceptions](./get_loaderexceptions/)() const | Zwraca wyjątki powodujące ten wyjątek. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::TypeInfo](../../system/typeinfo/)\> [get_Types](./get_types/)() const | Zwraca informacje o typie przyczyn wyjątku. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Ustawia HRESULT, kodowaną wartość liczbową przypisaną do konkretnego wyjątku. |
