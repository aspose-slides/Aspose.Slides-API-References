...
description: "TargetInvocationException jest wyrzucany przez metody wywoływane przy użyciu refleksji. Nigdy nie twórz ręcznie instancji tej klasy. Zamiast tego użyj klasy TargetInvocationException. Nigdy nie owijaj instancji klasy TargetInvocationException w System::SmartPtr."
type: docs
weight: 79
url: /pl/system.reflection/details_targetinvocationexception/
---
## Details_TargetInvocationException klasa

TargetInvocationException jest wyrzucany przez metody wywoływane przy użyciu refleksji. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy TargetInvocationException zamiast tego. Nigdy nie owijaj instancji klasy TargetInvocationException w [System::SmartPtr](../../system/smartptr/).
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_applicationexception/gettype/)() const override | Pobiera rzeczywisty typ obiektu. Analog wywołania C# [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementuje metodę [what()](../../system/details_exception/what/) wywoływaną przez klasę [ExceptionWrapper](../../system/exceptionwrapper/). Pomimo faktu, że klasa ta nie dziedziczy po std::exception, klasy pochodne mogą używać chronionych/prywatnych członków do implementacji swojej logiki. Przeniesienie implementacji tej metody do [ExceptionWrapper](../../system/exceptionwrapper/) może tę logikę zepsuć. |
| virtual  [~Object](../../system/object/~object/)() | Niszczy obiekt. Zwalnia wszystkie wewnętrzne struktury danych. |

## Zobacz także

* Klasa [Details_ApplicationException](../../system/details_applicationexception/)
