...
description: Reprezentuje informacje o metodzie klasy.
type: docs
weight: 131
url: /pl/system.reflection/methodinfo/
---
## Klasa MethodInfo

Reprezentuje informacje o metodzie klasy.
...
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Zwraca wartość MemberTypes wskazującą, że ten członek jest metodą. |
| const [String](../../system/string/)\& [get_Name](../memberinfo/get_name/)() const | Zwraca nazwę członka. |
| [TypeInfo](../../system/typeinfo/) [get_ReflectedType](../memberinfo/get_reflectedtype/)() const | Zwraca odzwierciedlony typ. |
...
|  [MethodInfo](./methodinfo/)(const [String](../../system/string/)\&) | Inicjalizuje nową instancję klasy [MethodInfo](./). |
