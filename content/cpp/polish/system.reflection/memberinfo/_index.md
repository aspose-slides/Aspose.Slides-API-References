...
description: "Zapewnia informacje refleksyjne o elementach. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub awarie asercji. Zawsze owiń tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika jako argumentu w wywołaniach funkcji."
type: docs
weight: 105
url: /pl/system.reflection/memberinfo/
---
## MemberInfo klasa
...
| Metoda | Opis |
| --- | --- |
| void [AddAttribute](./addattribute/)(const [ObjectPtr](./objectptr/)\&) | Dodaje atrybut do kolekcji. |
...
| [TypeInfo](../../system/typeinfo/) [get_DeclaringType](./get_declaringtype/)() const | Zwraca typ deklarujący. |
| const [String](../../system/string/)\& [get_FullName](./get_fullname/)() const | Zwraca pełną nazwę członka. Może się różnić w ręcznie implementowanych częściach. |
| virtual [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const | Zwraca wartość [System::Reflection::MemberTypes](../membertypes/) wskazującą typ członka – metoda, konstruktor, zdarzenie itd. |
| const [String](../../system/string/)\& [get_Name](./get_name/)() const | Zwraca nazwę członka. |
| [TypeInfo](../../system/typeinfo/) [get_ReflectedType](./get_reflectedtype/)() const | Zwraca typ odzwierciedlonego typu. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | Zwraca tablicę zawierającą obiekty reprezentujące wszystkie niestandardowe atrybuty zastosowane do typu reprezentowanego przez bieżący obiekt. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](./getcustomattributes/)(**bool**) const | Zwraca tablicę zawierającą obiekty reprezentujące wszystkie niestandardowe atrybuty zastosowane do typu reprezentowanego przez bieżący obiekt. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog metody C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwertowanie niestandardowych obiektów na łańcuch. |
...
| Typedef | Opis |
| --- | --- |
| [ObjectPtr](./objectptr/) | Alias wskaźnika współdzielonego do [Object](../../system/object/). |
