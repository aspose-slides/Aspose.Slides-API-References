...
description: Wewnętrzna klasa narzędziowa implementująca IEnumerable na kolejce elementów.
type: docs
weight: 1
url: /pl/system.linq.details/cachedenumerable/
---
## CachedEnumerable klasa


Wewnętrzna klasa narzędziowa implementuje IEnumerable nad kolejką elementów.
...
| Parametr | Opis |
| --- | --- |
| TItem | Typ elementu w kolejce. |

## Metody
| Metoda | Opis |
| --- | --- |
| void [Add](./add/)(TItem) |  |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Pobiera iterator wskazujący na pierwszy element (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany wskazywanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Pobiera iterator wskazujący bezpośrednio po ostatnim const-kwalifikowanym elemencie (jeśli istnieje) kolekcji. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Pobiera iterator wskazujący bezpośrednio po ostatnim elemencie (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany wskazywanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Pobiera iterator wskazujący bezpośrednio po ostatnim elemencie (jeśli istnieje) const-kwalifikowanej instancji kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<TItem\>\> [GetEnumerator](./getenumerator/)() override | Pobiera enumerator. |
...
* Przestrzeń nazw [System::Linq::Details](../)
