...
description: Implementuje interfejs IEnumerator dla pustej kolekcji generycznej.
type: docs
weight: 27
url: /pl/system.linq.details/emptyenumerator/
---
## EmptyEnumerator klasa
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const override | Zwraca bieżący element. |
...
| **bool** [MoveNext](./movenext/)() override | Przesuwa enumerator do następnego elementu. Jeśli wcześniej nie odwoływano się do żadnego elementu, ustawia referencję na pierwszy dostępny element. Jeśli osiągnięto koniec kontenera, nie robi nic. |
