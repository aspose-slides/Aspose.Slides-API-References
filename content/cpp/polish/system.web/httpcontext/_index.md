...
description: "Klasa atrapy umożliwiająca łączenie przetłumaczonego kodu z odwołaniami HttpContext, ale nie wykonująca go. Nie zawiera poprawnie zaimplementowanych członków. Obiekty tej klasy powinny być przydzielane wyłącznie za pomocą funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani nie używaj operatora new, ponieważ może to powodować błędy w czasie wykonania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej do funkcji jako argument."
type: docs
weight: 14
url: /pl/system.web/httpcontext/
---
## HttpContext klasa
...
| static [System::SharedPtr](../../system/sharedptr/)\<[HttpContext](./)\> [get_Current](./get_current/)() | Niezaimplementowane. |
| [System::SharedPtr](../../system/sharedptr/)\<HttpRequest\> [get_Request](./get_request/)() | Niezaimplementowane. |
...
| static void [set_Current](./set_current/)(const [System::SharedPtr](../../system/sharedptr/)\<[HttpContext](./)\>\&) | Niezaimplementowane. |
