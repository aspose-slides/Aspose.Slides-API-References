...
description: "Reprezentuje wyłączną transformację kanonizacji XML C14N dla podpisu cyfrowego bez komentarzy. Obiekty tej klasy powinny być tworzony wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to powodować błędy w czasie wykonywania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej jako argumentu funkcjom."
type: docs
weight: 209
url: /pl/system.security.cryptography.xml/xmldsigexcc14ntransform/
---
## XmlDsigExcC14NTransform klasa
