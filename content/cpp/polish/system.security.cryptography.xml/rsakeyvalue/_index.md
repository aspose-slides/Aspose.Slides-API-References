...
description: "Reprezentuje element 'RSAKeyValue' podpisu XML. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj go jako argumentu w funkcjach."
type: docs
weight: 92
url: /pl/system.security.cryptography.xml/rsakeyvalue/
---
## RSAKeyValue klasa
