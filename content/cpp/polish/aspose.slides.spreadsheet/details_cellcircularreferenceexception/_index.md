...
description: Wyjątek, który jest zgłaszany, gdy wykryto jeden lub więcej odwołań cyklicznych, w których formuła odwołuje się do własnej komórki bezpośrednio lub pośrednio.
type: docs
weight: 1
url: /pl/aspose.slides.spreadsheet/details_cellcircularreferenceexception/
---
## Details_CellCircularReferenceException klasa


Wyjątek, który jest zgłaszany, gdy wykryto jeden lub więcej odwołań cyklicznych, w których formuła odwołuje się do własnej komórki bezpośrednio lub pośrednio.
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Pobiera odwołanie do cyklicznej komórki. |
...
* Klasa [Details_PptxEditException](../../aspose.slides/details_pptxeditexception/)
* Przestrzeń nazw [Aspose::Slides::Spreadsheet](../)
