...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Kierunek podziału przejścia. Czytaj [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() override | Orientacja podziału przejścia. Czytaj [Slides::Orientation](../../aspose.slides/orientation/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Służy jako funkcja skrótu dla określonego typu, nadająca się do użycia w algorytmach haszowania i strukturach danych, takich jak tablica haszująca. |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Kierunek podziału przejścia. Zapisz [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) override | Orientacja podziału przejścia. Zapisz [Slides::Orientation](../../aspose.slides/orientation/). |
...
* Klasa [ISplitTransition](../isplittransition/)
