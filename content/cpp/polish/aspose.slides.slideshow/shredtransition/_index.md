...
| Metoda | Opis |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Określa, czy dwa [TransitionValueBase](../transitionvaluebase/) są równe. |
...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Kierunek przejścia. Odczytaj [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | Określa kształt elementów wizualnych używanych podczas przejścia. Odczytaj [TransitionShredPattern](../transitionshredpattern/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Służy jako funkcja skrótu dla konkretnego typu, odpowiednia do użycia w algorytmach haszujących i strukturach danych, takich jak tablica hash. |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Kierunek przejścia. Zapisz [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | Określa kształt elementów wizualnych używanych podczas przejścia. Zapisz [TransitionShredPattern](../transitionshredpattern/). |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogicznie do metody C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwersję obiektów niestandardowych do stringa. |
...
* Klasa [IShredTransition](../ishredtransition/)
