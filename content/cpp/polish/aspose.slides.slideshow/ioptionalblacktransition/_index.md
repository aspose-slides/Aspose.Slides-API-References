...
description: Opcjonalny efekt przejścia slajdu w czerni.
type: docs
weight: 183
url: /pl/aspose.slides.slideshow/ioptionalblacktransition/
---
## IOptionalBlackTransition klasa

Opcjonalny efekt przejścia slajdu w czerni.
...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Ten atrybut określa, czy przejście rozpocznie się od czarnego ekranu (a następnie przejdzie nowy slajd przez czarny). Odczyt **bool**. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Ten atrybut określa, czy przejście rozpocznie się od czarnego ekranu (a następnie przejdzie nowy slajd przez czarny). Zapis **bool**. |
