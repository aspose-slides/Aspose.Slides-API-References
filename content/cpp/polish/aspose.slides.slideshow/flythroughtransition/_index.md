...
description: Efekt przejścia slajdu w trybie przelotu.
type: docs
weight: 40
...
Efekt przejścia slajdu w trybie przelotu.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, gdzie dwa NaN są uważane za równe, mimo że według IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, gdzie dwa NaN są uważane za równe, mimo że według IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Tylko do celów wewnętrznych. |
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Kierunek przejścia. Zobacz [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| **bool** [get_HasBounce](./get_hasbounce/)() override | Określa, że ruch slajdów prezentacji podczas przejścia obejmuje odbicie. Zobacz **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Służy jako funkcja mieszająca dla danego typu, odpowiednia do użycia w algorytmach mieszania i strukturach danych, takich jak tablica mieszająca. |
...
| void [set_HasBounce](./set_hasbounce/)(**bool**) override | Określa, że ruch slajdów prezentacji podczas przejścia obejmuje odbicie. Zapisz **bool**. |
...
* Klasa [IFlyThroughTransition](../iflythroughtransition/)
