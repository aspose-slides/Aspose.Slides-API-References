...
description: Efekt przejścia slajdu z efektem fali.
type: docs
weight: 365
...
Efekt przejścia slajdu z efektem fali.
...
| [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/) [get_Direction](./get_direction/)() override | Kierunek przejścia. Przeczytaj [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Służy jako funkcja skrótu dla konkretnego typu, odpowiednia do użycia w algorytmach haszujących i strukturach danych, takich jak tablica mieszająca. |
...
| void [set_Direction](./set_direction/)([TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/)) override | Kierunek przejścia. Zapisz [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/). |
...
* Klasa [IRippleTransition](../irippletransition/)
