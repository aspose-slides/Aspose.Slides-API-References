...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Służy jako funkcja mieszająca dla określonego typu, odpowiednia do użycia w algorytmach haszujących i strukturach danych takich jak tabela mieszająca. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogiczny do metody C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwersję obiektów niestandardowych do ciągu znaków. |
...
* Klasa [IEmptyTransition](../iemptytransition/)
