...
| **uint32_t** [get_Spokes](./get_spokes/)() override | Liczba szprych przejścia koła. Odczyt **uint32_t**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Służy jako funkcja skrótu dla określonego typu, odpowiednia do użycia w algorytmach haszujących i strukturach danych takich jak tablica mieszająca. |
...
| void [set_Spokes](./set_spokes/)(**uint32_t**) override | Liczba szprych przejścia koła. Zapis **uint32_t**. |
...
* Klasa [IWheelTransition](../iwheeltransition/)
