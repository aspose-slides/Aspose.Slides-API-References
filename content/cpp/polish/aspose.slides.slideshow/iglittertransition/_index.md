...
| virtual [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() | Kierunek przejścia. Odczytaj [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() | Określa kształt elementów wizualnych używanych podczas przejścia. Odczytaj [TransitionPattern](../transitionpattern/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) | Kierunek przejścia. Zapisz [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) | Określa kształt elementów wizualnych używanych podczas przejścia. Zapisz [TransitionPattern](../transitionpattern/). |
