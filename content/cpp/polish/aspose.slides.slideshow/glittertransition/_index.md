...
| Metoda | Opis |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Określa, czy dwie instancje [TransitionValueBase](../transitionvaluebase/) są równe. |
...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | Kierunek przejścia. Zobacz [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | Określa kształt elementów wizualnych używanych podczas przejścia. Zobacz [TransitionPattern](../transitionpattern/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Służy jako funkcja hash dla konkretnego typu, 적합na do użycia w algorytmach haszujących i strukturach danych takich jak tablica hash. |
...
| void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) override | Kierunek przejścia. Zapisz [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | Określa kształt elementów wizualnych używanych podczas przejścia. Zapisz [TransitionPattern](../transitionpattern/). |
...
* Klasa [IGlitterTransition](../iglittertransition/)
