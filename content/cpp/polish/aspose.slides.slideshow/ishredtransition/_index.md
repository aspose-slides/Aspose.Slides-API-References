...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Kierunek przejścia. Czytaj [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() | Określa kształt elementów wizualnych używanych podczas przejścia. Czytaj [TransitionShredPattern](../transitionshredpattern/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Kierunek przejścia. Zapisz [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) | Określa kształt elementów wizualnych używanych podczas przejścia. Zapisz [TransitionShredPattern](../transitionshredpattern/). |
