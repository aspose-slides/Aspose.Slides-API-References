...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | Dodaje napisy WebVTT na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Dodaje napisy WebVTT na koniec kolekcji ze strumienia. |
...
| virtual void [Clear](./clear/)() | Usuwa wszystkie napisy z kolekcji. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący tuż za ostatnim elementem (jeśli istnieje) stałej wersji kolekcji. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Zwraca liczbę elementów w kolekcji. Tylko do odczytu **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca napisy na podanym indeksie. Tylko do odczytu [ICaptions](../icaptions/). |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Zwraca element pod podanym indeksem w sekwencji. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Zwraca element pod podanym indeksem w sekwencji. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę statement lock() z C#. Wywołaj bezpośrednio lub użyj obiektu ochronnego [LockContext](../../system/lockcontext/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\>) | Usuwa określone napisy z kolekcji. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Usuwa napisy pod określonym indeksem. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie statement lock() z C#. Wywołaj bezpośrednio lub użyj obiektu ochronnego [LockContext](../../system/lockcontext/). |
