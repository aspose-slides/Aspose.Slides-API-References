...
| Method | Description |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | Porównuje bieżący obiekt ze wskazanym obiektem. |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Zwraca styl wyrównania tabulacji. Zobacz [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Zwraca pozycję tabulacji. Przypisanie tej właściwości może zmienić indeks tabulacji w kolekcji i unieważnić Enumerator. Odczyt **double**. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Ustawia styl wyrównania tabulacji. Zapisz [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Ustawia pozycję tabulacji. Przypisanie tej właściwości może zmienić indeks tabulacji w kolekcji i unieważnić Enumerator. Zapisz **double**. |
