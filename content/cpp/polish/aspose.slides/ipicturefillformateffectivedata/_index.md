...
description: Niezmienny obiekt, który zawiera właściwości wypełnienia obrazem.
type: docs
weight: 3238
url: /pl/aspose.slides/ipicturefillformateffectivedata/
---
## IPictureFillFormatEffectiveData klasa
...
| virtual **float** [get_CropBottom](./get_cropbottom/)() | Zwraca liczbę procent rzeczywistej wysokości obrazu, które są obcięte od dołu obrazu. Tylko do odczytu **float**. |
| virtual **float** [get_CropLeft](./get_cropleft/)() | Zwraca liczbę procent rzeczywistej szerokości obrazu, które są obcięte od lewej strony obrazu. Tylko do odczytu **float**. |
| virtual **float** [get_CropRight](./get_cropright/)() | Zwraca liczbę procent rzeczywistej szerokości obrazu, które są obcięte od prawej strony obrazu. Tylko do odczytu **float**. |
| virtual **float** [get_CropTop](./get_croptop/)() | Zwraca liczbę procent rzeczywistej wysokości obrazu, które są obcięte od góry obrazu. Tylko do odczytu **float**. |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | Zwraca dpi używane do wypełnienia obrazu. Tylko do odczytu **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | Zwraca obraz. Tylko do odczytu [IPictureEffectiveData](../ipictureeffectivedata/). |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | Zwraca tryb wypełnienia obrazu. Tylko do odczytu [Slides::PictureFillMode](../picturefillmode/). |
