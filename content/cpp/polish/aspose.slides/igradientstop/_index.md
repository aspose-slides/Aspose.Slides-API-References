...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | Zwraca kolor punktu przerywania gradientu. Tylko do odczytu [IColorFormat](../icolorformat/). |
| virtual **float** [get_Position](./get_position/)() | Zwraca pozycję (0..1) punktu przerywania gradientu. Odczyt **float**. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje niczego, w rzeczywistości jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
...
| virtual void [set_Position](./set_position/)(**float**) | Ustawia pozycję (0..1) punktu przerywania gradientu. Zapis **float**. |
