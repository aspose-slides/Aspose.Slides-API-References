...
---
## ICommonSlideViewProperties klasa
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | Zwraca prowadnicę rysowania pod wskazanym indeksem. Tylko do odczytu [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | Zwraca kolekcję prowadnic rysowania. Tylko do odczytu [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | Określa współczynnik skalowania widoku w procentach. Odczyt **int32_t**. |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | Określa, że zawartość widoku powinna automatycznie skalować się, aby najlepiej dopasować do bieżącego rozmiaru okna. Odczyt **bool**. |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | Określa współczynnik skalowania widoku w procentach. Zapis **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | Określa, że zawartość widoku powinna automatycznie skalować się, aby najlepiej dopasować do bieżącego rozmiaru okna. Zapis **bool**. |
