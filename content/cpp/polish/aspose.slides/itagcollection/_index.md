...
description: Reprezentuje kolekcję znaczników (pary ciągów definiowane przez użytkownika)
type: docs
weight: 4057
url: /pl/aspose.slides/itagcollection/
---
## ITagCollection klasa

Reprezentuje kolekcję znaczników (pary ciągów definiowane przez użytkownika)
...
| Metoda | Opis |
| --- | --- |
| virtual **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | Dodaje nowy znacznik do kolekcji. |
...
| virtual void [Clear](./clear/)() | Usuwa wszystkie znaczniki z kolekcji. |
| virtual **bool** [Contains](./contains/)([System::String](../../system/string/)) | Określa, czy kolekcja zawiera określoną nazwę. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie const-kwalifikowanej instancji kolekcji (jeśli istnieje). |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogiczna metoda do C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia wyliczanie skrótu (hash) własnych obiektów. |
| virtual [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) | Zwraca klucz znacznika o podanym indeksie. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() | Zwraca nazwy znaczników. |
...
| virtual [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) | Zwraca wartość znacznika o podanym indeksie. |
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) | Zwraca parę klucz-wartość znacznika. |
| virtual void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) | Ustawia parę klucz-wartość znacznika. |
| virtual **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) | Zwraca indeks (zerowy) określonego klucza w kolekcji. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią z sekwencji wartości uzyskanych poprzez wywołanie funkcji przekształcającej na każdym elemencie sekwencji wejściowej. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Wywołuje funkcję przekształcającą na każdym elemencie generycznej sekwencji i zwraca maksymalną uzyskaną wartość. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Wywołuje funkcję przekształcającą na każdym elemencie generycznej sekwencji i zwraca minimalną uzyskaną wartość. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Usuwa znacznik o określonej nazwie z kolekcji. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Usuwa znacznik o podanym indeksie. |
