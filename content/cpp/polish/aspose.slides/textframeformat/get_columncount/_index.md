...
description: Zwraca liczbę kolumn w obszarze tekstowym. Ta wartość musi być liczbą dodatnią. W przeciwnym razie wartość zostanie ustawiona na zero. Wartość 0 oznacza nieokreśloną wartość. Odczyt int32_t.
type: docs
weight: 248
url: /pl/aspose.slides/textframeformat/get_columncount/
---
## TextFrameFormat::get_ColumnCount() metoda


Zwraca liczbę kolumn w obszarze tekstowym. Ta wartość musi być liczbą dodatnią. W przeciwnym razie wartość zostanie ustawiona na zero. Wartość 0 oznacza nieokreśloną wartość. Odczyt **int32_t**.
