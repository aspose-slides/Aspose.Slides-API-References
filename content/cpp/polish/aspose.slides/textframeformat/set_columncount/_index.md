...
description: Ustawia liczbę kolumn w obszarze tekstowym. Ta wartość musi być liczbą dodatnią. W przeciwnym razie wartość zostanie ustawiona na zero. Wartość 0 oznacza nieokreśloną wartość. Zapisz int32_t.
type: docs
weight: 261
url: /pl/aspose.slides/textframeformat/set_columncount/
---
## TextFrameFormat::set_ColumnCount(int32_t) metoda

Ustawia liczbę kolumn w obszarze tekstowym. Ta wartość musi być liczbą dodatnią. W przeciwnym razie wartość zostanie ustawiona na zero. Wartość 0 oznacza niezdefiniowaną wartość. Zapisz **int32_t**.
...
Poniższy przykładowy kod pokazuje, jak dodać kolumnę w ramce tekstowej w programie PowerPoint [Presentation](../../presentation/).
```cpp
