...
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevel](../ishapebevel/)\> [get_BevelBottom](./get_bevelbottom/)() override | Zwraca typ dolnego fazowania 3D. Tylko do odczytu [IShapeBevel](../ishapebevel/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevel](../ishapebevel/)\> [get_BevelTop](./get_beveltop/)() override | Zwraca typ górnego fazowania 3D. Tylko do odczytu [IShapeBevel](../ishapebevel/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ICamera](../icamera/)\> [get_Camera](./get_camera/)() override | Zwraca ustawienia kamery. Tylko do odczytu [ICamera](../icamera/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ContourColor](./get_contourcolor/)() override | Zwraca kolor konturu. Tylko do odczytu [IColorFormat](../icolorformat/). |
| **double** [get_ContourWidth](./get_contourwidth/)() override | Zwraca szerokość konturu 3D. Zwraca **double**. |
| **double** [get_Depth](./get_depth/)() override | Zwraca głębokość kształtu 3D. Zwraca **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ExtrusionColor](./get_extrusioncolor/)() override | Zwraca kolor ekstruzji. Tylko do odczytu [IColorFormat](../icolorformat/). |
| **double** [get_ExtrusionHeight](./get_extrusionheight/)() override | Zwraca wysokość efektu ekstruzji. Zwraca **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILightRig](../ilightrig/)\> [get_LightRig](./get_lightrig/)() override | Zwraca typ światła. Tylko do odczytu [ILightRig](../ilightrig/). |
| [MaterialPresetType](../materialpresettype/) [get_Material](./get_material/)() override | Zwraca typ materiału. Odczyt [MaterialPresetType](../materialpresettype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormatEffectiveData](../ithreedformateffectivedata/)\> [GetEffective](./geteffective/)() override | Pobiera efektywne dane formatowania 3-D z zastosowanym dziedziczeniem. |
...
| void [set_ContourWidth](./set_contourwidth/)(**double**) override | Ustawia szerokość konturu 3D. Zapisuje **double**. |
| void [set_Depth](./set_depth/)(**double**) override | Ustawia głębokość kształtu 3D. Zapisuje **double**. |
| void [set_ExtrusionHeight](./set_extrusionheight/)(**double**) override | Ustawia wysokość efektu ekstruzji. Zapisuje **double**. |
| void [set_Material](./set_material/)([MaterialPresetType](../materialpresettype/)) override | Ustawia typ materiału. Zapisuje [MaterialPresetType](../materialpresettype/). |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementuje i zwraca licznik współdzielonych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
...
Poniższy przykład pokazuje, jak dodać kształt 3D w PowerPoint [Presentation](../presentation/). 
```cpp
...
```
Poniższy przykład pokazuje, jak zastosować efekt gradientu do kształtu 3D w PowerPoint [Presentation](../presentation/). 
```cpp
// Utwórz instancję klasy Presentation.
auto pres = System::MakeObject<Presentation>();
auto slide = pres->get_Slides()->idx_get(0);
...
pres->Save(u"sandbox_3d.pptx", SaveFormat::Pptx);
```
Poniższy przykład pokazuje, jak zastosować efekt 3D na tekście. Do tworzenia tekstu 3D można użyć efektu transformacji WordArt. 
```cpp
// Utwórz instancję klasy Presentation.
auto pres = System::MakeObject<Presentation>();
auto slide = pres->get_Slides()->idx_get(0);
