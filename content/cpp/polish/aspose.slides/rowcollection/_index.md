...
| Metoda | Opis |
| --- | --- |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) override | Tworzy kopię określonego wiersza szablonu i wstawia ją na koniec tabeli. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie stałym (jeśli istnieje) kolekcji. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\>, **int32_t**) override | Kopiuje wszystkie elementy z kolekcji do określonej tablicy. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) stałej wersji kolekcji. |
...
| **int32_t** [get_Count](./get_count/)() override | Zwraca liczbę wierszy faktycznie znajdujących się w kolekcji. Tylko do odczytu **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator iterujący po kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca wiersz o podanym indeksie. Tylko do odczytu [Row](../row/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) override | Tworzy kopię określonego wiersza szablonu i wstawia ją w wskazanej pozycji w tabeli. |
...
| void [RemoveAt](./removeat/)(**int32_t**, **bool**) override | Usuwa wiersz w określonej pozycji z tabeli. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) stałej wersji kolekcji. |
...
* Klasa [IRowCollection](../irowcollection/)
