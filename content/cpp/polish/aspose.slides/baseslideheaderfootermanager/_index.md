...
description: Reprezentuje menedżera, który kontroluje zachowanie placeholderów stopki, daty i godziny oraz numeru strony we wszystkich typach slajdów.
type: docs
weight: 183
...
| **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() override | Pobiera wartość wskazującą, że placeholder daty i czasu jest obecny. Odczyt **bool**. |
| **bool** [get_IsFooterVisible](./get_isfootervisible/)() override | Pobiera wartość wskazującą, że placeholder stopki jest obecny. Odczyt **bool**. |
| **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() override | Pobiera wartość wskazującą, że placeholder numeru strony jest obecny. Odczyt **bool**. |
...
| void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) override | Ustawia tekst w placeholderze daty i czasu slajdu. |
| void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) override | Zmienia widoczność placeholdera daty i czasu slajdu. |
| void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) override | Ustawia tekst w placeholderze stopki slajdu. |
| void [SetFooterVisibility](./setfootervisibility/)(**bool**) override | Zmienia widoczność placeholdera stopki slajdu. |
| void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) override | Zmienia widoczność placeholdera numeru strony slajdu. |
