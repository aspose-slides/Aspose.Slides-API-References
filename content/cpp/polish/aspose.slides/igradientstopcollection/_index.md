...
description: Reprezentuje kolekcję przerywek gradientu.
type: docs
weight: 2419
url: /pl/aspose.slides/igradientstopcollection/
---
## IGradientStopCollection klasa
...
| Metoda | Opis |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) | Tworzy nową przerywkę gradientu i dodaje ją na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) | Tworzy nową przerywkę gradientu i dodaje ją na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) | Tworzy nową przerywkę gradientu i dodaje ją na koniec kolekcji. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Zwraca iterator wskazujący na pierwszy element const-kwalifikowany (jeśli istnieje) w kolekcji. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie const-kwalifikowanym (jeśli istnieje) w kolekcji. |
| virtual void [Clear](./clear/)() | Usuwa wszystkie przerywki gradientu z kolekcji. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb podwójnej precyzji w stylu C#, gdzie dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Zwraca wartość wskazującą, czy dostęp do kolekcji jest zsynchronizowany (wielowątkowy). Tylko do odczytu **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca przerywkę gradientu według indeksu. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) | Tworzy nową przerywkę gradientu i wstawia ją pod podanym indeksem w kolekcji. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) | Tworzy nową przerywkę gradientu i wstawia ją pod podanym indeksem w kolekcji. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) | Tworzy nową przerywkę gradientu i wstawia ją pod podanym indeksem w kolekcji. |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Oblicza średnią wartość sekwencji liczb. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projekuje każdy element sekwencji i łączy uzyskane sekwencje w jedną sekwencję. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Usuwa przerywkę gradientu pod podanym indeksem. |
