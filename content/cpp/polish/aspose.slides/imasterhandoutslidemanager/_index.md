...
description: Menedżer slajdu master handout.
type: docs
weight: 2861
url: /pl/aspose.slides/imasterhandoutslidemanager/
---
## IMasterHandoutSlideManager klasa

Menedżer slajdu master handout.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [get_MasterHandoutSlide](./get_masterhandoutslide/)() | Zwraca master dla wszystkich slajdów notatek tej prezentacji, jeśli istnieje, w przeciwnym razie zwraca null. Tylko do odczytu [IMasterHandoutSlide](../imasterhandoutslide/). |
...
| virtual void [RemoveMasterHandoutSlide](./removemasterhandoutslide/)() | Usuwa slajd master handout. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [SetDefaultMasterHandoutSlide](./setdefaultmasterhandoutslide/)() | Ustawia domyślny slajd master handout na powiązany slajd handout. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n-ty argument szablonu jako słaby wskaźnik (zamiast współdzielonego). Pozwala przestawić wskaźniki w kontenerach na tryb słaby. |
