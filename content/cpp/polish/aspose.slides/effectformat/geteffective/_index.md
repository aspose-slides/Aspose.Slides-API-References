...
Pobiera efektywne formatowanie efektu z zastosowanym dziedziczeniem.
...
Ten przykład pokazuje pobieranie niektórych efektywnych właściwości efektu kształtu. 
```cpp
...
* Klasa [IEffectFormatEffectiveData](../../ieffectformateffectivedata/)
* Klasa [EffectFormat](../)
