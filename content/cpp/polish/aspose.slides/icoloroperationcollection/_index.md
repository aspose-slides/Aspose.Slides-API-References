...
---
## IColorOperationCollection klasa
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) | Dodaje nową operację na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) | Dodaje nową operację na koniec kolekcji. |
...
| virtual void [Clear](./clear/)() | Usuwa wszystkie operacje koloru. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Clone](../../system/icloneable/clone/)() | Tworzy kopię bieżącego obiektu i zwraca wskaźnik współdzielony do niej. |
| virtual T [CloneT](../igenericcloneable/clonet/)() | Tworzy nowy obiekt będący kopią bieżącej instancji. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca operację pod wskazanym indeksem. Odczyt [IColorOperation](../icoloroperation/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) | Ustawia operację pod wskazanym indeksem. Zapis [IColorOperation](../icoloroperation/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) | Wstawia nową operację do kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) | Wstawia nową operację do kolekcji. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Usuwa operację koloru z kolekcji. |
