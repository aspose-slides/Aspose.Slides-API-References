...
| virtual [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() | Pobiera orientację slajdu. |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Pobiera wymiary slajdu w punktach. Przypisanie nowej wartości resetuje wartość [ISlideSize::get_Type](./get_type/) do [SlideSizeType::Custom](../slidesizetype/) i ustawia [ISlideSize::get_Orientation](./get_orientation/). |
| virtual [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() | Pobiera typ rozmiaru slajdu. Przypisanie dowolnej wartości oprócz [SlideSizeType::Custom](../slidesizetype/) dostosowuje [ISlideSize::get_Size](./get_size/) zgodnie z wstępnie zdefiniowanymi wymiarami, zachowując bieżący [ISlideSize::get_Orientation](./get_orientation/). |
...
| virtual void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) | Ustawia orientację slajdu. |
| virtual void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) | Ustawia rozmiar slajdu według typu i skaluje istniejącą zawartość. Przypisanie dowolnej wartości oprócz [SlideSizeType::Custom](../slidesizetype/) dostosowuje [ISlideSize::get_Size](./get_size/) w zależności od wybranego typu, zachowując [ISlideSize::get_Orientation](./get_orientation/). |
| virtual void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) | Ustawia wymiary slajdu explicite i skaluje istniejącą zawartość. To resetuje wartość [ISlideSize::get_Type](./get_type/) do [SlideSizeType::Custom](../slidesizetype/) i ustawia [ISlideSize::get_Orientation](./get_orientation/). |
