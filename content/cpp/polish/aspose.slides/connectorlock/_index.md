...
| **bool** [get_AdjustHandlesLocked](./get_adjusthandleslocked/)() override | Określa, czy zmiana wartości regulacji jest zabroniona. Odczyt **bool**. |
| **bool** [get_ArrowheadsLocked](./get_arrowheadslocked/)() override | Określa, czy zmiana grotów strzałek jest zabroniona. Odczyt **bool**. |
| **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() override | Określa, czy kształt musi zachować proporcje przy skalowaniu. Odczyt **bool**. |
...
| **bool** [get_NoLocks](../baseshapelock/get_nolocks/)() override | Zwraca true, jeśli wszystkie flagi blokad są wyłączone. Tylko do odczytu **bool**. |
| **bool** [get_PositionMove](./get_positionmove/)() override | Określa, czy przemieszczanie tego kształtu jest zabronione. Odczyt **bool**. |
| **bool** [get_RotateLocked](./get_rotatelocked/)() override | Określa, czy zmiana kąta obrotu tego kształtu jest zabroniona. Odczyt **bool**. |
| **bool** [get_SelectLocked](./get_selectlocked/)() override | Określa, czy zaznaczanie tego kształtu jest zabronione. Odczyt **bool**. |
...
| void [set_AdjustHandlesLocked](./set_adjusthandleslocked/)(**bool**) override | Określa, czy zmiana wartości regulacji jest zabroniona. Zapis **bool**. |
| void [set_ArrowheadsLocked](./set_arrowheadslocked/)(**bool**) override | Określa, czy zmiana grotów strzałek jest zabroniona. Zapis **bool**. |
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | Określa, czy kształt musi zachować proporcje przy skalowaniu. Zapis **bool**. |
...
| void [set_PositionMove](./set_positionmove/)(**bool**) override | Określa, czy przemieszczanie tego kształtu jest zabronione. Zapis **bool**. |
...
| void [set_SelectLocked](./set_selectlocked/)(**bool**) override | Określa, czy zaznaczanie tego kształtu jest zabronione. Zapis **bool**. |
...
* Klasa [IConnectorLock](../iconnectorlock/)
