...
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() override | Zwraca osadzony obraz. Odczytaj [IPPImage](../ippimage/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/)\> [get_ImageTransform](./get_imagetransform/)() override | Zwraca kolekcję efektów przekształcenia obrazu. Tylko do odczytu [IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperation](../../aspose.slides.effects/iimagetransformoperation/)\> [get_ImageTransformOperation](./get_imagetransformoperation/)(**int32_t**) override | Zwraca operację przekształcenia obrazu dla określonego indeksu. |
| [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() override | Zwraca lub ustawia adres URL powiązanego obrazu. Odczytaj [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](./get_presentation/)() override | Zwraca prezentację. Tylko do odczytu [IPresentation](../ipresentation/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](./get_slide/)() override | Zwraca slajd macierzysty obrazu. Tylko do odczytu [IBaseSlide](../ibaseslide/). |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Zwraca wartość skrótu. |
...
| void [set_Image](./set_image/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) override | Ustawia osadzony obraz. Zapisz [IPPImage](../ippimage/). |
| void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) override | Zwraca lub ustawia adres URL powiązanego obrazu. Zapisz [System::String](../../system/string/). |
...
* Klasa [ISlidesPicture](../islidespicture/)
