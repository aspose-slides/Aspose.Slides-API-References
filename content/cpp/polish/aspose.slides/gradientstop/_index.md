...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Zwraca kolor punktu gradientu. Tylko do odczytu [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Zwraca pozycję (0..1) punktu gradientu. Odczytuje **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Ustawia pozycję (0..1) punktu gradientu. Zapisuje **float**. |
...
* Klasa [IGradientStop](../igradientstop/)
