...
---
## ICameraEffectiveData klasa

Nieodmienny obiekt zawierający efektywne właściwości kamery.
...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) typ. Tylko do odczytu [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 deg, pole widzenia). Tylko do odczytu **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) zoom (wartość dodatnia w procentach). Tylko do odczytu **float**. |
