...
description: Reprezentuje wartość dopasowania geometrycznego kształtu. Wartości te wpływają na formę kształtu.
type: docs
weight: 1288
...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | Zwraca wartość, interpretując ją jako kąt w stopniach. Odczyt **float**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Zwraca nazwę tej wartości dopasowania. Tylko do odczytu [System::String](../../system/string/). |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | Zwraca wartość dopasowania w stanie „as is”. Odczyt **int64_t**. |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | Zwraca typ dopasowania kształtu. Tylko do odczytu [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | Ustawia wartość, interpretując ją jako kąt w stopniach. Zapis **float**. |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | Ustawia wartość dopasowania w stanie „as is”. Zapis **int64_t**. |
