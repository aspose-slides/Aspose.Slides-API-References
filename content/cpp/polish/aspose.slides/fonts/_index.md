...
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() override | Zwraca czcionkę skryptu złożonego. Przeczytaj [IFontData](../ifontdata/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() override | Zwraca czcionkę wschodnioazjatycką. Przeczytaj [IFontData](../ifontdata/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() override | Zwraca czcionkę łacińską. Przeczytaj [IFontData](../ifontdata/). |
...
| [System::String](../../system/string/) [GetScriptFont](./getscriptfont/)([System::String](../../system/string/)) override | Pobiera nazwę czcionki powiązaną z określonym tagiem skryptu z tematu prezentacji. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\> [GetScriptFontMap](./getscriptfontmap/)() override | Zwraca słownik wszystkich definicji czcionek skryptu w prezentacji. |
...
| void [RemoveScriptFont](./removescriptfont/)([System::String](../../system/string/)) override | Usuwa ustawienie czcionki powiązane z określonym tagiem skryptu z kolekcji czcionek tematu. |
| void [set_ComplexScriptFont](./set_complexscriptfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | Ustawia czcionkę skryptu złożonego. Zapisz [IFontData](../ifontdata/). |
| void [set_EastAsianFont](./set_eastasianfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | Ustawia czcionkę wschodnioazjatycką. Zapisz [IFontData](../ifontdata/). |
| void [set_LatinFont](./set_latinfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | Ustawia czcionkę łacińską. Zapisz [IFontData](../ifontdata/). |
| void [SetScriptFont](./setscriptfont/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Przypisuje nazwę czcionki do określonego tagu skryptu, co definiuje sposób renderowania tekstu tego skryptu w prezentacji. |
