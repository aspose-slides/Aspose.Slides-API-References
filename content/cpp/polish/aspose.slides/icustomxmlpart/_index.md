...
| virtual [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() | Określa globalnie unikatowy identyfikator (GUID), który jednoznacznie identyfikuje jedną niestandardową część XML w dokumencie Office Open XML. Tylko do odczytu [System::Guid](../../system/guid/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() | Zwraca kolekcję schematów XML skojarzonych z niestandardową częścią XML. Tylko do odczytu [System::String](../../system/string/)[]. |
| virtual [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() | Zwraca dane xml jako ciąg UTF-8. Odczyt [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() | Zwraca dane xml. Odczyt **uint8_t**[]. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje niczego, po prostu inicjalizuje nowy obiekt i umożliwia tworzenie kopii podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje niczego, po prostu inicjalizuje nowy obiekt i umożliwia tworzenie kopii podklas. |
...
| virtual void [Remove](./remove/)() | Usuwa niestandardową część xml z prezentacji. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza współdzielony licznik referencji o podaną wartość. |
| virtual void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) | Określa globalnie unikatowy identyfikator (GUID), który jednoznacznie identyfikuje jedną niestandardową część XML w dokumencie Office Open XML. Tylko do odczytu [System::Guid](../../system/guid/). |
| virtual void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) | Ustawia dane xml jako ciąg UTF-8. Zapis [System::String](../../system/string/). |
| virtual void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Ustawia dane xml. Zapis **uint8_t**[]. |
