...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() | Zwraca dane pliku osadzonego obiektu OLE. Tylko do odczytu **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() | Zwraca rozszerzenie pliku dla bieżącego osadzonego obiektu OLE. Tylko do odczytu [System::String](../../system/string/). |
