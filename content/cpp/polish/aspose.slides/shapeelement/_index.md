...
description: Reprezentuje część kształtu posiadającą te same właściwości obrysu i wypełnienia.
type: docs
weight: 5123
...
Reprezentuje część kształtu posiadającą te same właściwości obrysu i wypełnienia.
...
| [ShapeElementFillSource](../shapeelementfillsource/) [get_FillSource](./get_fillsource/)() | Zwraca informacje o tym, jak wypełnić element. Tylko do odczytu [ShapeElementFillSource](../shapeelementfillsource/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Shape](../shape/)\> [get_ParentShape](./get_parentshape/)() | Zwraca Shape_PPT, dla którego element został utworzony. Tylko do odczytu [Shape](../shape/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_PathPoints](./get_pathpoints/)() | Zwraca tablicę punktów definiujących geometrię ścieżki elementu. |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_PathTypes](./get_pathtypes/)() | Zwraca tablicę wartości bajtowych określających typ każdego punktu w ścieżce elementu. |
| [ShapeElementStrokeSource](../shapeelementstrokesource/) [get_StrokeSource](./get_strokesource/)() | Zwraca informacje o tym, jak narysować obrys elementu. Tylko do odczytu [ShapeElementStrokeSource](../shapeelementstrokesource/). |
...
* Klasa [IShapeElement](../ishapeelement/)
