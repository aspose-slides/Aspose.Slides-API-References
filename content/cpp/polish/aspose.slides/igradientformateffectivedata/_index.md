...
---
## IGradientFormatEffectiveData klasa
...
| virtual [Aspose::Slides::GradientDirection](../gradientdirection/) [get_GradientDirection](./get_gradientdirection/)() | Zwraca styl gradientu. Tylko do odczytu [Slides::GradientDirection](../gradientdirection/). |
| virtual [Aspose::Slides::GradientShape](../gradientshape/) [get_GradientShape](./get_gradientshape/)() | Zwraca kształt gradientu. Tylko do odczytu [Slides::GradientShape](../gradientshape/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\> [get_GradientStop](./get_gradientstop/)(**int32_t**) | Zwraca punkt zatrzymania gradientu pod wskazanym indeksem. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)\> [get_GradientStops](./get_gradientstops/)() | Zwraca kolekcję punktów zatrzymania gradientu. Tylko do odczytu [IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/). |
| virtual **float** [get_LinearGradientAngle](./get_lineargradientangle/)() | Zwraca kąt gradientu. Tylko do odczytu **float**. |
| virtual **bool** [get_LinearGradientScaled](./get_lineargradientscaled/)() | Określa, czy gradient jest skalowany. Tylko do odczytu **bool**. |
| virtual [Aspose::Slides::TileFlip](../tileflip/) [get_TileFlip](./get_tileflip/)() | Zwraca tryb odbicia dla gradientu. Tylko do odczytu [Slides::TileFlip](../tileflip/). |
