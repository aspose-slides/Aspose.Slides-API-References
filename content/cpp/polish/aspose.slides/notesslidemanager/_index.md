...
| Metoda | Opis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() override | Zwraca slajd notatek dla bieżącego slajdu, tworząc go, jeśli go nie ma. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() override | Zwraca slajd notatek dla bieżącego slajdu. Zwraca null, jeśli slajd nie ma slajdu notatek. Tylko do odczytu [INotesSlide](../inotesslide/). |
...
| void [RemoveNotesSlide](./removenotesslide/)() override | Usuwa slajd notatek bieżącego slajdu. |
...
Poniższy przykład pokazuje, jak dodać notatki do konkretnego slajdu PowerPoint [Presentation](../presentation/). 
```cpp
...
```
 Poniższy przykład pokazuje, jak usunąć notatki z konkretnego slajdu PowerPoint [Presentation](../presentation/). 
```cpp
// Utwórz obiekt Presentation, który reprezentuje plik prezentacji
auto presentation = System::MakeObject<Presentation>(dataDir + u"AccessSlides.pptx");
...
* Klasa [INotesSlideManager](../inotesslidemanager/)
