...
Poniższy przykład pokazuje, jak przekonwertować PowerPoint do HTML za pomocą C++. 
```cpp
// Tworzy obiekt prezentacji, który reprezentuje plik prezentacji, np. PPT, PPTX, ODP itp.
...
// Zapisuje prezentację do HTML
presentation->Save(u"ConvertWholePresentationToHTML_out.html", SaveFormat::Html, htmlOpt);
```
 Poniższy przykład pokazuje, jak przekonwertować PowerPoint do responsywnego HTML za pomocą C++. 
```cpp
...
```
 Poniższy przykład pokazuje, jak przekonwertować PowerPoint do HTML z notatkami za pomocą C++. 
```cpp
...
```
 Poniższy przykład pokazuje, jak przekonwertować PowerPoint do HTML z oryginalnymi czcionkami za pomocą C++. 
```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// Wyklucza domyślne czcionki prezentacji
...
```
 Poniższy przykład pokazuje, jak przekonwertować PowerPoint do HTML z wysokiej jakości obrazami przy 150 DPI za pomocą C++. 
```cpp
...
```
 Poniższy przykład pokazuje, jak przekonwertować PowerPoint do HTML z obrazami pełnej jakości za pomocą C++. 
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
 Poniższy przykład pokazuje, jak przekonwertować [Slide](../../slide/) do HTML za pomocą C++. 
```cpp
```
