...
| Metoda | Opis |
| --- | --- |
| virtual void [AddField](./addfield/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) | Konwertuje ten fragment na automatycznie aktualizowane pole. |
| virtual void [AddField](./addfield/)([System::String](../../system/string/)) | Konwertuje ten fragment na automatycznie aktualizowane pole. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IField](../ifield/)\> [get_Field](./get_field/)() | Zwraca pole tego fragmentu. Tylko do odczytu [IField](../ifield/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_PortionFormat](./get_portionformat/)() | Zwraca obiekt formatowania, który zawiera wyraźnie ustawione właściwości formatowania fragmentu tekstu bez zastosowanej dziedziczenia. Tylko do odczytu [IPortionFormat](../iportionformat/). |
...
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Pobiera zwykły tekst fragmentu. Odczyt [System::String](../../system/string/). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [GetCoordinates](./getcoordinates/)() | Pobiera współrzędne początku fragmentu. Współrzędna X punktu reprezentuje początek fragmentu od pierwszego znaku, włączając lewy odstęp. Współrzędna Y obejmuje górny odstęp. |
...
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() | Pobiera współrzędne prostokąta ograniczającego fragment. Prostokąt obejmuje wszystkie wiersze tekstu w fragmencie, włączając puste. |
...
| virtual void [RemoveField](./removefield/)() | Konwertuje ten fragment pola na prosty fragment. |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | Ustawia zwykły tekst fragmentu. Zapis [System::String](../../system/string/). |
