...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Zwraca dane binarne napisów zamkniętych. Tylko do odczytu **uint8_t**[]. |
| virtual [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() | Zwraca globalnie unikalny identyfikator (GUID) napisów zamkniętych. Tylko do odczytu [System::Guid](../../system/guid/). |
| virtual [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() | Zwraca dane napisów zamkniętych jako ciąg zakodowany w UTF-8. Tylko do odczytu [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Label](./get_label/)() | Zwraca etykietę napisów zamkniętych. Odczyt [System::String](../../system/string/). |
...
| virtual void [set_Label](./set_label/)([System::String](../../system/string/)) | Ustawia etykietę napisów zamkniętych. Zapis [System::String](../../system/string/). |
