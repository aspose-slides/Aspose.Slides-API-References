...
description: Reprezentuje opcje, które można używać do wyszukiwania tekstu w prezentacji, slajdzie lub ramce tekstowej.
type: docs
weight: 5487
...
Reprezentuje opcje, które można używać do wyszukiwania tekstu w [Presentation](../presentation/), [Slide](../slide/) lub [TextFrame](../textframe/).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN-y są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włączając NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN-y są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włączając NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Tylko do użytku wewnętrznego. |
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Ustaw true, aby używać wyszukiwania z rozróżnianiem wielkości liter, false – w przeciwnym razie. Odczyt **bool**. |
| **bool** [get_IncludeNotes](./get_includenotes/)() override | Ustaw **true**, aby uwzględniać tekst zawarty w notatkach slajdu ([NotesSlide](../notesslide/)) podczas wyszukiwania tekstu, zamiany lub podświetlania. Domyślna wartość to **false**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Ustaw true, aby dopasowywać tylko całe słowa, false – w przeciwnym razie. Odczyt **bool**. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Ustaw true, aby używać wyszukiwania z rozróżnianiem wielkości liter, false – w przeciwnym razie. Zapis **bool**. |
| void [set_IncludeNotes](./set_includenotes/)(**bool**) override | Ustaw **true**, aby uwzględniać tekst zawarty w notatkach slajdu ([NotesSlide](../notesslide/)) podczas wyszukiwania, zamiany lub podświetlania. Domyślna wartość to **false**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Ustaw true, aby dopasowywać tylko całe słowa, false – w przeciwnym razie. Zapis **bool**. |
