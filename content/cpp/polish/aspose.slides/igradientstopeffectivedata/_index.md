...
description: niezmienny obiekt, który reprezentuje zatrzymanie gradientu.
type: docs
weight: 2445
...
niezmienny obiekt, który reprezentuje zatrzymanie gradientu.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, w którym dwa NaN są uznawane za równe, mimo że według IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Wyłącznie do celów wewnętrznych. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Zwraca kolor zatrzymania gradientu. Tylko do odczytu [System::Drawing::Color](../../system.drawing/color/). |
| virtual **float** [get_Position](./get_position/)() | Zwraca pozycję (0..1) zatrzymania gradientu. Tylko do odczytu **float**. |
