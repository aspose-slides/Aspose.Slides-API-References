...
description: Reprezentuje kolekcję porcji.
type: docs
weight: 3303
url: /pl/aspose.slides/iportioncollection/
---
## IPortionCollection klasa
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | Dodaje [Portion](../portion/) na koniec kolekcji. |
...
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | Określa, czy [ICollection](../../system.collections.generic/icollection/) zawiera określoną wartość. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Zwraca liczbę elementów faktycznie znajdujących się w kolekcji. Tylko do odczytu **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca element o podanym indeksie. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | Określa indeks określonej części w kolekcji. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | Wstawia [Portion](../portion/) do kolekcji pod określonym indeksem. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią wartości w sekwencji, które uzyskuje się wywołując funkcję przekształcającą na każdym elemencie sekwencji wejściowej. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę (lock()) z C#. Wywołaj bezpośrednio lub użyj obiektu wartownika [LockContext](../../system/lockcontext/). |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | Usuwa pierwsze wystąpienie określonego obiektu z [ICollection](../../system.collections.generic/icollection/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie statement lock() z C#. Wywołaj bezpośrednio lub użyj obiektu wartownika [LockContext](../../system/lockcontext/). |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../../system.collections.generic/ienumerable/virtualizebeginiterator/)() | Zwraca implementację iteratora start dla bieżącego kontenera. |
