...
| [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() override | Zwraca typ wypełnienia. Odczytaj [Slides::FillType](../filltype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() override | Zwraca format wypełnienia wzorem. Tylko do odczytu [IPatternFormat](../ipatternformat/). |
| [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() override | Określa, czy wypełnienie powinno być obracane razem z kształtem. Odczytaj [NullableBool](../nullablebool/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() override | Zwraca kolor wypełnienia stałego. Tylko do odczytu [IColorFormat](../icolorformat/). |
...
| void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) override | Ustawia typ wypełnienia. Zapisz [Slides::FillType](../filltype/). |
| void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) override | Określa, czy wypełnienie powinno być obracane razem z kształtem. Zapisz [NullableBool](../nullablebool/). |
...
* Klasa [ILineFillFormat](../ilinefillformat/)
