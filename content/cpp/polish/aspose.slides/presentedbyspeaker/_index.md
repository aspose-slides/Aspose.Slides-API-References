...
description: Prezentowane przez mówcę (pełny ekran)
type: docs
weight: 4902
url: /pl/aspose.slides/presentedbyspeaker/
---
## Klasa PresentedBySpeaker
...
| void [Lock](../../system/object/lock/)() | Implementuje blokowanie instrukcji C# lock(). Wywołaj bezpośrednio albo użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowywanie instrukcji C# lock(). Wywołaj bezpośrednio albo użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
