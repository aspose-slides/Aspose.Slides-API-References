...
description: Zapewnia zarządzanie odnośnikami (dodawanie, usuwanie).
type: docs
weight: 2549
url: /pl/aspose.slides/ihyperlinkmanager/
---
## IHyperlinkManager klasa

Zapewnia zarządzanie odnośnikami (dodawanie, usuwanie).
...
| virtual void [RemoveHyperlinkClick](./removehyperlinkclick/)() | Usuwa odnośnik po kliknięciu. |
| virtual void [RemoveHyperlinkMouseOver](./removehyperlinkmouseover/)() | Usuwa odnośnik przy najechaniu myszy. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkClick](./setexternalhyperlinkclick/)([System::String](../../system/string/)) | Ustawia zewnętrzny odnośnik po kliknięciu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkMouseOver](./setexternalhyperlinkmouseover/)([System::String](../../system/string/)) | Ustawia zewnętrzny odnośnik przy najechaniu myszy. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkClick](./setinternalhyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) | Ustawia wewnętrzny odnośnik po kliknięciu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkMouseOver](./setinternalhyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) | Ustawia wewnętrzny odnośnik przy najechaniu myszy. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetMacroHyperlinkClick](./setmacrohyperlinkclick/)([System::String](../../system/string/)) | Ustawia odnośnik makra po kliknięciu. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n't-argument szablonu jako słaby wskaźnik (zamiast współdzielonego). Pozwala przełączać wskaźniki w kontenerach do trybu słabego. |
