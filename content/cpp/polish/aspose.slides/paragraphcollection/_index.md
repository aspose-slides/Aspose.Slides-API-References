...
| Metoda | Opis |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Dodaje [Paragraph](../paragraph/) na koniec kolekcji. |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Dodaje zawartość [ParagraphCollection](./) na koniec kolekcji. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) override | Dodaje tekst z określonego łańcucha HTML do kolekcji. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) override | Dodaje tekst z określonego łańcucha HTML do kolekcji. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Zwraca iterator wskazujący na pierwszy element o stałym typie (jeśli istnieje) kolekcji. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Zwraca iterator wskazujący zaraz po ostatnim elemencie o stałym typie (jeśli istnieje) kolekcji. |
| void [Clear](./clear/)() override | Usuwa wszystkie elementy z kolekcji. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Określa, czy [ICollection](../../system.collections.generic/icollection/) zawiera określoną wartość. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>, **int32_t**) | Kopiuje elementy [ICollection](../../system.collections.generic/icollection/) do [System::Array](../../system/array/), rozpoczynając od określonego indeksu [System::Array](../../system/array/). |
...
| [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) override | Konwertuje określone akapity do HTML i zwraca je jako obiekt String. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator, który iteruje po kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca element pod określonym indeksem. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Określa indeks konkretnego elementu w [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Wstawia [Paragraph](../paragraph/) do kolekcji pod określonym indeksem. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Wstawia zawartość [ParagraphCollection](./) do kolekcji pod określonym indeksem. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Usuwa pierwsze wystąpienie konkretnego obiektu z [ICollection](../../system.collections.generic/icollection/). |
...
* Klasa [IParagraphCollection](../iparagraphcollection/)
