...
Reprezentuje [AutoShape](../autoshape/).
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [AddTextFrame](./addtextframe/)([System::String](../../system/string/)) | Dodaje nowy [TextFrame](../textframe/) do kształtu. Jeśli kształt już posiada [TextFrame](../textframe/), po prostu zmienia jego tekst. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [get_Adjustment](../igeometryshape/get_adjustment/)(**int32_t**) | Zwraca wartość dopasowań kształtu pod wskazanym indeksem. |
...
| virtual [System::String](../../system/string/) [get_AlternativeText](../ishape/get_alternativetext/)() | Zwraca tekst alternatywny powiązany z kształtem. Odczyt [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_AlternativeTextTitle](../ishape/get_alternativetexttitle/)() | Zwraca tytuł tekstu alternatywnego powiązanego z kształtem. Odczyt [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAutoShapeLock](../iautoshapelock/)\> [get_AutoShapeLock](./get_autoshapelock/)() | Zwraca blokady [AutoShape](../autoshape/). Tylko do odczytu [IAutoShapeLock](../iautoshapelock/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkClick](../ihyperlinkcontainer/get_hyperlinkclick/)() | Zwraca hiperłącze zdefiniowane dla kliknięcia myszą. Odczyt [IHyperlink](../ihyperlink/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkMouseOver](../ihyperlinkcontainer/get_hyperlinkmouseover/)() | Zwraca hiperłącze zdefiniowane przy najechaniu myszą. Odczyt [IHyperlink](../ihyperlink/). |
...
| virtual **bool** [get_IsTextBox](./get_istextbox/)() | Określa, czy kształt jest polem tekstowym. |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Zwraca unikalny identyfikator w zakresie slajdu, który pozostaje stały przez cały okres życia kształtu i pozwala PowerPointowi lub kodowi interop na niezawodne odwoływanie się do kształtu z dowolnego miejsca w dokumencie. Tylko do odczytu **uint32_t**. Zobacz także [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual **float** [get_Rotation](../ishape/get_rotation/)() | Zwraca liczbę stopni, o jaką określony kształt jest obrócony wokół osi z. Wartość dodatnia oznacza obrót zgodny z ruchem wskazówek zegara; wartość ujemna oznacza obrót przeciwny. Odczyt **float**. |
...
| virtual [Aspose::Slides::ShapeType](../shapetype/) [get_ShapeType](../igeometryshape/get_shapetype/)() | Zwraca typ presetu geometrii. Uwaga: przy zmianie wartości wszystkie wartości dopasowań zostaną przywrócone do wartości domyślnych. Odczyt [Slides::ShapeType](../shapetype/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [get_TextFrame](./get_textframe/)() | Zwraca obiekt [TextFrame](../textframe/) dla [AutoShape](../autoshape/). Tylko do odczytu [ITextFrame](../itextframe/). |
...
| virtual **bool** [get_UseBackgroundFill](./get_usebackgroundfill/)() | Określa, czy ten autoshape powinien być wypełniony tłem slajdu zamiast określonego przez styl lub format wypełnienia. Odczyt **bool**. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGeometryPath](../igeometrypath/)\>\> [GetGeometryPaths](../igeometryshape/getgeometrypaths/)() | Zwraca kopię ścieżki kształtu geometrycznego. Współrzędne są względne względem lewego górnego rogu kształtu. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetImage](../ishape/getimage/)() | Zwraca miniaturkę kształtu. Typ granic miniaturki [ShapeThumbnailBounds::Shape](../shapethumbnailbounds/) jest używany domyślnie. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokowanie w instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
...
| virtual void [set_HyperlinkClick](../ihyperlinkcontainer/set_hyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) | Ustawia hiperłącze zdefiniowane dla kliknięcia myszą. Zapis [IHyperlink](../ihyperlink/). |
| virtual void [set_HyperlinkMouseOver](../ihyperlinkcontainer/set_hyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) | Ustawia hiperłącze zdefiniowane przy najechaniu myszą. Zapis [IHyperlink](../ihyperlink/). |
...
| virtual void [set_Rotation](../ishape/set_rotation/)(**float**) | Ustawia liczbę stopni, o jaką określony kształt jest obrócony wokół osi z. Wartość dodatnia oznacza obrót zgodny z ruchem wskazówek zegara; wartość ujemna oznacza obrót przeciwny. Zapis **float**. |
| virtual void [set_ShapeType](../igeometryshape/set_shapetype/)([Aspose::Slides::ShapeType](../shapetype/)) | Ustawia typ presetu geometrii. Uwaga: przy zmianie wartości wszystkie wartości dopasowań zostaną przywrócone do wartości domyślnych. Zapis [Slides::ShapeType](../shapetype/). |
| virtual void [set_UseBackgroundFill](./set_usebackgroundfill/)(**bool**) | Określa, czy ten autoshape powinien być wypełniony tłem slajdu zamiast określonego przez styl lub format wypełnienia. Zapis **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie w instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
