...
| virtual [System::String](../../system/string/) [get_BaseUri](./get_baseuri/)() | Zwraca bazowy URI określonego SVG. Używany do rozwiązywania względnych odnośników. Tylko do odczytu [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\> [get_ExternalResourceResolver](./get_externalresourceresolver/)() | Zwraca interfejs wywołania zwrotnego używany do rozwiązywania zewnętrznych zasobów podczas importu dokumentów SVG. Tylko do odczytu [Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/). |
| virtual [System::String](../../system/string/) [get_SvgContent](./get_svgcontent/)() | Zwraca zawartość SVG. Tylko do odczytu [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_SvgData](./get_svgdata/)() | Zwraca dane SVG. Tylko do odczytu **uint8_t**[]. |
...
| virtual void [WriteAsEmf](./writeasemf/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Zapisuje obraz SVG jako plik EMF. |
