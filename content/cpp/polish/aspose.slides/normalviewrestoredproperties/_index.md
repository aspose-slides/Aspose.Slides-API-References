...
description: Określa rozmiar obszaru slajdu ((szerokość, gdy jest dzieckiem restoredTop, wysokość, gdy jest dzieckiem restoredLeft) w normalnym widoku, gdy obszar ma zmienny rozmiar przywrócony (nie jest zminimalizowany ani zmaksymalizowany)).
type: docs
weight: 4538
...
Określa rozmiar obszaru slajdu ((szerokość, gdy jest dzieckiem restoredTop, wysokość, gdy jest dzieckiem restoredLeft) normalnego widoku, gdy obszar ma zmienny rozmiar przywrócony (nie zminimalizowany ani zmaksymalizowany).
...
| **bool** [get_AutoAdjust](./get_autoadjust/)() override | Określa, czy rozmiar regionu dodatkowej zawartości powinien kompensować nowy rozmiar przy zmianie rozmiaru okna zawierającego widok w aplikacji Odczyt **bool**. |
| **float** [get_DimensionSize](./get_dimensionsize/)() override | Określa rozmiar obszaru slajdu (szerokość, gdy jest dzieckiem RestoredTop, wysokość, gdy jest dzieckiem RestoredLeft). Odczyt **float**. |
...
| void [set_AutoAdjust](./set_autoadjust/)(**bool**) override | Określa, czy rozmiar regionu dodatkowej zawartości powinien kompensować nowy rozmiar przy zmianie rozmiaru okna zawierającego widok w aplikacji Zapis **bool**. |
| void [set_DimensionSize](./set_dimensionsize/)(**float**) override | Określa rozmiar obszaru slajdu (szerokość, gdy jest dzieckiem RestoredTop, wysokość, gdy jest dzieckiem RestoredLeft). Zapis **float**. |
...
* Klasa [INormalViewRestoredProperties](../inormalviewrestoredproperties/)
