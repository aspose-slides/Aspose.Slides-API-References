...
description: Wyjątek, który jest rzucany, gdy format pliku prezentacji nie jest obsługiwany.
type: docs
weight: 586
url: /pl/aspose.slides/details_invalidpasswordexception/
---
## Details_InvalidPasswordException klasa


Exception, który jest rzucany, gdy format pliku prezentacji nie jest obsługiwany.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwie NaN są traktowane jako równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równe żadnej wartości, w tym NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwie NaN są traktowane jako równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równe żadnej wartości, w tym NaN. |
