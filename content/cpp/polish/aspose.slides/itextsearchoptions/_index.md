...
---
## ITextSearchOptions klasa

Reprezentuje opcje, które mogą być użyte do wyszukiwania tekstu w [Presentation](../presentation/), [Slide](../slide/) lub [TextFrame](../textframe/).
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Ustaw true, aby używać wyszukiwania z rozróżnianiem wielkości liter, false – w przeciwnym razie. Odczyt **bool**. |
| virtual **bool** [get_IncludeNotes](./get_includenotes/)() | Ustaw **true**, aby uwzględniać tekst zawarty w notatkach slajdu podczas wykonywania wyszukiwania tekstu, zamiany lub podświetlania. Wartość domyślna to **false**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Ustaw true, aby dopasowywać tylko całe wyrazy, false – w przeciwnym razie. Odczyt **bool**. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Ustaw true, aby używać wyszukiwania z rozróżnianiem wielkości liter, false – w przeciwnym razie. Zapis **bool**. |
| virtual void [set_IncludeNotes](./set_includenotes/)(**bool**) | Ustaw **true**, aby uwzględniać tekst zawarty w notatkach slajdu podczas wykonywania wyszukiwania tekstu, zamiany lub podświetlania. Wartość domyślna to **false**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Ustaw true, aby dopasowywać tylko całe wyrazy, false – w przeciwnym razie. Zapis **bool**. |
