...
| Method | Description |
| --- | --- |
| void [Dispose](./dispose/)() override | Zwalnia obiekt. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Zwraca kopię danych obrazu. Tylko do odczytu **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Zwraca typ MIME obrazu, zakodowany w [PPImage::get_BinaryData](./get_binarydata/). Tylko do odczytu [System::String](../../system/string/). |
| **int32_t** [get_Height](./get_height/)() override | Zwraca wysokość obrazu. Tylko do odczytu **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::IImage](../iimage/)\> [get_Image](./get_image/)() override | Zwraca kopię obrazu. Tylko do odczytu [IImage](../iimage/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::ISvgImage](../isvgimage/)\> [get_SvgImage](./get_svgimage/)() const override | Zwraca [ISvgImage](../isvgimage/) obiekt [ISvgImage](../isvgimage/) |
| **int32_t** [get_Width](./get_width/)() override | Zwraca szerokość obrazu. Tylko do odczytu **int32_t**. |
| **int32_t** [get_X](./get_x/)() override | Zwraca przesunięcie X obrazu. Tylko do odczytu **int32_t**. |
| **int32_t** [get_Y](./get_y/)() override | Zwraca przesunięcie Y obrazu. Tylko do odczytu **int32_t**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Zwraca kod skrótu obrazu. |
...
| void [ReplaceImage](./replaceimage/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Zastępuje dane obrazu. |
| void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::IImage](../iimage/)\>) override | Zastępuje dane obrazu. Uwaga: gdy obraz jest metafilem – zostanie zrastrowany. Użyj zamiast tego ReplaceImage(byte[]). |
| void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::IPPImage](../ippimage/)\>) override | Zastępuje dane obrazu. |
| virtual void [ReplaceImage](../ippimage/replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\>) | Zastępuje obraz. |
| virtual void [ReplaceImage](../ippimage/replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | Zastępuje obraz. |
| void [set_SvgImage](./set_svgimage/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::ISvgImage](../isvgimage/)\>) override | Ustawia [ISvgImage](../isvgimage/) obiekt [ISvgImage](../isvgimage/) |
| virtual void [set_SvgImage](../ippimage/set_svgimage/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\>) | Ustawia [ISvgImage](../isvgimage/) obiekt [ISvgImage](../isvgimage/) |
