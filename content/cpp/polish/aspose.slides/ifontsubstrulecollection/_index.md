...
description: Reprezentuje kolekcję zamian czcionek.
type: docs
weight: 2289
url: /pl/aspose.slides/ifontsubstrulecollection/
---
## IFontSubstRuleCollection klasa

Reprezentuje kolekcję zamian czcionek.
...
| Metoda | Opis |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontSubstRule](../ifontsubstrule/)\>) | Dodaje nową regułę zamiany czcionek do kolekcji |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontSubstRule](../ifontsubstrule/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca element pod określonym indeksem. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią ciągu wartości uzyskanych poprzez wywołanie funkcji transformacji na każdym elemencie sekwencji wejściowej. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontSubstRule](../ifontsubstrule/)\>) | Usuwa pierwsze wystąpienie określonego obiektu z kolekcji. |
