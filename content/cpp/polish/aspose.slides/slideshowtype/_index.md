...
description: "Podstawowe ustawienia pokazu slajdów. Przodkowie reprezentują typy pokazu slajdów: PresentedBySpeaker Prezentowane przez prelegenta (pełny ekran) BrowsedByIndividual Przeglądane przez indywidualnego (okno) BrowsedAtKiosk Przeglądane w kiosku (pełny ekran)"
type: docs
weight: 5227
...
Podstawowe ustawienia pokazu slajdów. Przodkowie reprezentują typy pokazu slajdów: [PresentedBySpeaker](../presentedbyspeaker/) Prezentowane przez prelegenta (pełny ekran) [BrowsedByIndividual](../browsedbyindividual/) Przeglądane przez użytkownika (okno) [BrowsedAtKiosk](../browsedatkiosk/) Przeglądane w kiosku (pełny ekran)
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje niczego, w rzeczywistości tylko inicjalizuje nowy obiekt i umożliwia kopiowanie w podklasach. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje niczego, w rzeczywistości tylko inicjalizuje nowy obiekt i umożliwia kopiowanie w podklasach. |
