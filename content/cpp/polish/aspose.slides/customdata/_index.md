...
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) override | Zwraca niestandardową część XML pod wskazanym indeksem. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() override | Zwraca kolekcję niestandardowych części xml. Tylko do odczytu [ICustomXmlPartCollection](../icustomxmlpartcollection/). |
| [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) override | Zwraca znacznik danych klienta określony indeksem. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() override | Zwraca kolekcję znaczników danych klienta. Tylko do odczytu [ITagCollection](../itagcollection/). |
...
| void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Ustawia znacznik danych klienta określony indeksem. |
