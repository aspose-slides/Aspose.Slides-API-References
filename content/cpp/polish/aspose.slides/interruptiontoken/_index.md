...
description: Ta klasa reprezentuje token używany do sygnalizowania długotrwałych zadań, czy przerwanie zostało żądane.
type: docs
weight: 3056
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Zwraca **bool**.true jeśli przerwanie zostało żądane. |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | Reprezentuje pusty token przerwania. |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | Rzuca \n jeśli przerwanie zostało żądane. |
