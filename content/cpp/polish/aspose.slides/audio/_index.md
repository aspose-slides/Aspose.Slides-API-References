...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Zwraca kopię danych audio. W przypadku dużej ilości danych rozważ użycie metody [Audio::GetStream](./getstream/), aby zapobiec niepotrzebnemu ładowaniu danych audio do pamięci lub nawet wyjątku OutOfMemoryException. Tylko do odczytu **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Zwraca typ MIME audio, zakodowany w [Audio::get_BinaryData](./get_binarydata/). Tylko do odczytu [System::String](../../system/string/). |
...
| void [set_ContentType](./set_contenttype/)([System::String](../../system/string/)) | Zwraca typ MIME audio, zakodowany w [Audio::get_BinaryData](./get_binarydata/). Tylko do odczytu [System::String](../../system/string/). |
