...
description: Reprezentuje menedżera, który kontroluje zachowanie elementów stopki, daty-czasu oraz symboli numeru strony dla wszystkich typów slajdów.
type: docs
weight: 131
...
| void [Lock](../../system/object/lock/)() | Implementuje instrukcję C# lock() blokującą. Wywołuj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowywanie instrukcji C# lock(). Wywołuj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/). |
