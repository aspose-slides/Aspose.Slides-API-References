...
description: Zwraca obiekt ThreeDFormat, który reprezentuje właściwości efektu 3D dla tekstu. Tylko do odczytu IThreeDFormat.
type: docs
weight: 300
url: /pl/aspose.slides/itextframeformat/get_threedformat/
---
## ITextFrameFormat::get_ThreeDFormat() metoda

Zwraca [ThreeDFormat](../../threedformat/) obiekt, który reprezentuje właściwości efektu 3D dla tekstu. Tylko do odczytu [IThreeDFormat](../../ithreedformat/).
...
* Klasa [IThreeDFormat](../../ithreedformat/)
