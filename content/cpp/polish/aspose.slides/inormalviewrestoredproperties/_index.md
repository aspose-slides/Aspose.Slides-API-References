...
description: Określa rozmiar obszaru slajdu ((szerokość, gdy jest dzieckiem restoredTop, wysokość, gdy jest dzieckiem restoredLeft) widoku normalnego, gdy obszar ma zmienny rozmiar przywrócony (nie jest zminimalizowany ani zmaksymalizowany).
type: docs
weight: 2991
url: /pl/aspose.slides/inormalviewrestoredproperties/
---
## INormalViewRestoredProperties klasa


Określa rozmiar obszaru slajdu ((szerokość, gdy jest dzieckiem restoredTop, wysokość, gdy jest dzieckiem restoredLeft) widoku normalnego, gdy obszar ma zmienny rozmiar przywrócony (nie jest zminimalizowany ani zmaksymalizowany).
...
| virtual **bool** [get_AutoAdjust](./get_autoadjust/)() | Określa, czy rozmiar bocznego regionu zawartości powinien kompensować nowy rozmiar przy zmianie rozmiaru okna zawierającego widok w aplikacji Odczyt **bool**. |
| virtual **float** [get_DimensionSize](./get_dimensionsize/)() | Określa rozmiar obszaru slajdu (szerokość, gdy jest dzieckiem RestoredTop, wysokość, gdy jest dzieckiem RestoredLeft). Odczyt **float**. |
...
| virtual void [set_AutoAdjust](./set_autoadjust/)(**bool**) | Określa, czy rozmiar bocznego regionu zawartości powinien kompensować nowy rozmiar przy zmianie rozmiaru okna zawierającego widok w aplikacji Zapis **bool**. |
| virtual void [set_DimensionSize](./set_dimensionsize/)(**float**) | Określa rozmiar obszaru slajdu (szerokość, gdy jest dzieckiem RestoredTop, wysokość, gdy jest dzieckiem RestoredLeft). Zapis **float**. |
