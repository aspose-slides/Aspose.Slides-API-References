...
---
## IDigitalSignatureCollection klasa
...
| Metoda | Opis |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\>) | Dodaje podpis na końcu kolekcji. |
...
| virtual void [Clear](./clear/)() | Usuwa wszystkie podpisy z kolekcji. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca podpis według indeksu. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Usuwa podpis pod określonym indeksem. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementuje i zwraca współdzielony licznik referencji. Nie należy wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementuje słaby licznik referencji. Nie należy wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
