...
| [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() override | Określa globalnie unikalny identyfikator (GUID), który jednoznacznie identyfikuje jedną niestandardową część XML w dokumencie Office Open XML. Tylko do odczytu [System::Guid](../../system/guid/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() override | Zwraca kolekcję schematów XML powiązanych z niestandardową częścią XML. Tylko do odczytu [System::String](../../system/string/)[]. |
| [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() override | Zwraca dane XML jako ciąg UTF-8. Odczyt [System::String](../../system/string/). |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() override | Zwraca dane XML. Odczyt **uint8_t**[]. |
...
| void [Remove](./remove/)() override | Usuwa niestandardową część XML z prezentacji. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza liczbę współdzielonych referencji o podaną wartość. |
| void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) override | Określa globalnie unikalny identyfikator (GUID), który jednoznacznie identyfikuje jedną niestandardową część XML w dokumencie Office Open XML. Tylko do odczytu [System::Guid](../../system/guid/). |
| void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) override | Ustawia dane XML jako ciąg UTF-8. Zapis [System::String](../../system/string/). |
| void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Ustawia dane XML. Zapis **uint8_t**[]. |
