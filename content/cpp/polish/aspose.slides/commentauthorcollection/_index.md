...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [AddAuthor](./addauthor/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Dodaje nowego autora na końcu kolekcji. |
| [iterator](./iterator/) [begin](./begin/)() | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) kolekcji. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) niezmienniczej instancji kolekcji. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Zwraca iterator wskazujący na pierwszy element niezmienniczy (jeśli istnieje) kolekcji. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Zwraca iterator wskazujący tuż po ostatnim niezmienniczym elemencie (jeśli istnieje) kolekcji. |
| void [Clear](./clear/)() override | Usuwa wszystkich autorów z kolekcji. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\>, **int32_t**) override | Kopiuje wszystkie elementy z kolekcji do określonej tablicy. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) niezmienniczej instancji kolekcji. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByName](./findbyname/)([System::String](../../system/string/)) override | Znajduje autora w kolekcji po nazwie. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByNameAndInitials](./findbynameandinitials/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Znajduje autora w kolekcji po nazwie i inicjałach. |
| **int32_t** [get_Count](./get_count/)() override | Zwraca liczbę rzeczywistych elementów znajdujących się w kolekcji. Tylko do odczytu **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator iterujący po kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca element o podanym indeksie. Tylko do odczytu [ICommentAuthor](../icommentauthor/). |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>) override | Usuwa pierwsze wystąpienie określonego autora w kolekcji. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Usuwa autora o określonym indeksie w kolekcji. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [ToArray](./toarray/)() override | Tworzy i zwraca tablicę ze wszystkimi autorami. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) niezmienniczej instancji kolekcji. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) niezmienniczej instancji kolekcji. |
...
* Klasa [ICommentAuthorCollection](../icommentauthorcollection/)
