...
---
## IFontFallBackRulesCollection klasa
...
| Metoda | Opis |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | Dodaje nową regułę FallBack na koniec kolekcji. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący zaraz po ostatnim elemencie const-kwalifikowanym (jeśli istnieje) kolekcji. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Zwraca wartość określającą, czy dostęp do kolekcji jest synchronizowany (wątkowo-bezpieczny). Tylko do odczytu **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca regułę pod wskazanym indeksem. Tylko do odczytu [IFontFallBackRule](../ifontfallbackrule/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) | Usuwa pierwsze wystąpienie konkretnej reguły FallBack z kolekcji. |
