...
description: Niezmienny obiekt, który reprezentuje efektywne właściwości formatowania 3-D.
type: docs
weight: 4174
url: /pl/aspose.slides/ithreedformateffectivedata/
---
## IThreeDFormatEffectiveData klasa

Niezmienny obiekt, który reprezentuje efektywne właściwości formatowania 3-D.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevelEffectiveData](../ishapebeveleffectivedata/)\> [get_BevelBottom](./get_bevelbottom/)() | Zwraca typ dolnego fazowania 3D. Tylko do odczytu [IShapeBevelEffectiveData](../ishapebeveleffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevelEffectiveData](../ishapebeveleffectivedata/)\> [get_BevelTop](./get_beveltop/)() | Zwraca typ górnego fazowania 3D. Tylko do odczytu [IShapeBevelEffectiveData](../ishapebeveleffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICameraEffectiveData](../icameraeffectivedata/)\> [get_Camera](./get_camera/)() | Zwraca ustawienia kamery. Tylko do odczytu [ICameraEffectiveData](../icameraeffectivedata/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ContourColor](./get_contourcolor/)() | Zwraca kolor konturu. Tylko do odczytu [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_ContourWidth](./get_contourwidth/)() | Zwraca szerokość konturu 3D. Tylko do odczytu **double**. |
| virtual **double** [get_Depth](./get_depth/)() | Zwraca głębokość kształtu 3D. Tylko do odczytu **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ExtrusionColor](./get_extrusioncolor/)() | Zwraca kolor ekstruzji. Tylko do odczytu [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_ExtrusionHeight](./get_extrusionheight/)() | Zwraca wysokość efektu ekstruzji. Tylko do odczytu **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILightRigEffectiveData](../ilightrigeffectivedata/)\> [get_LightRig](./get_lightrig/)() | Zwraca typ światła. Tylko do odczytu [ILightRigEffectiveData](../ilightrigeffectivedata/). |
| virtual [MaterialPresetType](../materialpresettype/) [get_Material](./get_material/)() | Zwraca typ materiału. Tylko do odczytu [MaterialPresetType](../materialpresettype/). |
