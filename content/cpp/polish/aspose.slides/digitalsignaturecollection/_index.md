...
| Method | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\>) override | Dodaje podpis na końcu kolekcji. |
...
| void [Clear](./clear/)() override | Usuwa wszystkie podpisy z kolekcji. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\>\>, **int32_t**) override | Kopiuje wszystkie elementy z kolekcji do podanej tablicy. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie (jeśli istnieje) stałej instancji kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator, który iteruje po kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca podpis według indeksu. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Usuwa podpis pod określonym indeksem. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie (jeśli istnieje) stałej instancji kolekcji. |
...
| [virtualized_iterator_element](./virtualized_iterator_element/) | Typ wirtualizowanego elementu. |
