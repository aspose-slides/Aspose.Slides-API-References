...
| [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() override | Pobiera orientację slajdu. |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Pobiera wymiary slajdu w punktach. |
| [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() override | Pobiera typ rozmiaru slajdu. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznik referencji powiązaną z obiektem. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. W rzeczywistości nie kopiuje nic, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie przy tworzeniu podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. W rzeczywistości nie kopiuje nic, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie przy tworzeniu podklas. |
...
| void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) override | Ustawia orientację slajdu. |
| void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) override | Ustawia rozmiar slajdu według typu i skaluje istniejącą zawartość. |
| void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) override | Ustawia wymiary slajdu jawnie i skaluje istniejącą zawartość. |
