...
description: Reprezentuje niezmienny obiekt, który zawiera skuteczne dane.
type: docs
weight: 2055
url: /pl/aspose.slides/ieffectivedata/
---
## IEffectiveData klasa


Reprezentuje niezmienny obiekt, który zawiera skuteczne dane.
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę (locking) instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu ochronnego [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowywanie (unlocking) instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu ochronnego [LockContext](../../system/lockcontext/). |
