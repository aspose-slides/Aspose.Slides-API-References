...
| Metoda | Opis |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | Porównuje bieżącą instancję z innym obiektem tego samego typu. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | Zwraca styl wyrównania tabulacji. Odczytaj [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | Zwraca pozycję tabulacji. Przypisanie tej właściwości może zmienić indeks tabulacji w kolekcji i unieważnić Enumerator. Odczytaj **double**. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | Ustawia styl wyrównania tabulacji. Zapisz [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | Ustawia pozycję tabulacji. Przypisanie tej właściwości może zmienić indeks tabulacji w kolekcji i unieważnić Enumerator. Zapisz **double**. |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | Tworzy nowy [Tab](./) |
