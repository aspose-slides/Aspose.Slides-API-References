...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Zwraca iterator wskazujący zaraz po ostatnim elemencie (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany referencjonowanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący zaraz po ostatnim elemencie (jeśli istnieje) stałej wersji kolekcji. |
...
| **double** [get_Height](./get_height/)() override | Zwraca wysokość wiersza. Tylko do odczytu **double**. |
...
| **double** [get_MinimalHeight](./get_minimalheight/)() override | Zwraca minimalną możliwą wysokość wiersza. Odczyt **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](../cellcollection/get_presentation/)() override | Zwraca prezentację nadrzędną [CellCollection](../cellcollection/). Tylko do odczytu [IPresentation](../ipresentation/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() override | Zwraca obiekt [RowFormat](../rowformat/), który zawiera właściwości formatowania tego wiersza. Tylko do odczytu [IRowFormat](../irowformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../cellcollection/get_slide/)() override | Zwraca slajd nadrzędny [CellCollection](../cellcollection/). Tylko do odczytu [IBaseSlide](../ibaseslide/). |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią sekwencji wartości uzyskanych przez wywołanie funkcji transformacji na każdym elemencie sekwencji wejściowej. |
...
| void [set_MinimalHeight](./set_minimalheight/)(**double**) override | Ustawia minimalną możliwą wysokość wiersza. Zapis **double**. |
...
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | Ustawia zdefiniowane właściwości formatu części dla wszystkich części komórek wiersza. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | Ustawia zdefiniowane właściwości formatu akapitu dla wszystkich akapitów w komórkach wiersza. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | Ustawia zdefiniowane właściwości formatu ramki tekstowej dla wszystkich ramek tekstowych w komórkach wiersza. |
