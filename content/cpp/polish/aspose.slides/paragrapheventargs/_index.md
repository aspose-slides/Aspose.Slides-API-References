...
description: Klasa argumentów zdarzenia dla zdarzeń związanych z akapitem.
type: docs
weight: 4642
url: /pl/aspose.slides/paragrapheventargs/
---
## ParagraphEventArgs klasa
...
| Pole | Opis |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Statyczny członek, który reprezentuje "pusty" [EventArgs](../../system/eventargs/) współdzielony wskaźnik (null-pointer). |
