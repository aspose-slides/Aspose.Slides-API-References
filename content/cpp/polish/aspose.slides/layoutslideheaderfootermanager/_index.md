...
description: Reprezentuje menedżer, który utrzymuje zachowanie stopki slajdu układu, znaczników daty i czasu oraz numeru strony oraz wszystkich znaczników potomnych. Znaczniki potomne oznaczają, że znaczniki znajdują się na slajdach zależnych. Slajdy zależne używają i zależą od slajdu układu.
type: docs
weight: 4317
...
Reprezentuje menedżer, który utrzymuje zachowanie stopki slajdu układu, znaczników daty i czasu, numeru strony oraz wszystkich znaczników potomnych. Znaczniki potomne oznaczają, że znaczniki znajdują się na slajdach zależnych. Slajdy zależne używają i zależą od slajdu układu.
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Zwraca wartość wskazującą, że znacznik daty i czasu jest obecny. Read**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | Zwraca wartość wskazującą, że znacznik stopki jest obecny. Read **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Zwraca wartość wskazującą, że znacznik numeru strony jest obecny. Read**bool**. |
...
| void [SetDateTimeAndChildDateTimesText](./setdatetimeandchilddatetimestext/)([System::String](../../system/string/)) override | Ustawia tekst w znaczniku daty i czasu slajdu układu oraz we wszystkich potomnych znacznikach daty i czasu. Znaczniki potomne oznaczają, że znaczniki znajdują się na slajdach zależnych. Slajdy zależne używają i zależą od slajdu układu. |
| void [SetDateTimeAndChildDateTimesVisibility](./setdatetimeandchilddatetimesvisibility/)(**bool**) override | Zmienia widoczność znacznika daty i czasu slajdu układu oraz wszystkich potomnych znaczników daty i czasu. Znaczniki potomne oznaczają, że znaczniki znajdują się na slajdach zależnych. Slajdy zależne używają i zależą od slajdu układu. |
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | Ustawia tekst w znaczniku daty i czasu slajdu. |
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | Zmienia widoczność znacznika daty i czasu slajdu. |
| void [SetFooterAndChildFootersText](./setfooterandchildfooterstext/)([System::String](../../system/string/)) override | Ustawia tekst w znaczniku stopki slajdu układu oraz we wszystkich potomnych znacznikach stopki. Znaczniki potomne oznaczają, że znaczniki znajdują się na slajdach zależnych. Slajdy zależne używają i zależą od slajdu układu. |
| void [SetFooterAndChildFootersVisibility](./setfooterandchildfootersvisibility/)(**bool**) override | Zmienia widoczność znacznika stopki slajdu układu oraz wszystkich potomnych znaczników stopki. Znaczniki potomne oznaczają, że znaczniki znajdują się na slajdach zależnych. Slajdy zależne używają i zależą od slajdu głównego. |
...
| void [SetSlideNumberAndChildSlideNumbersVisibility](./setslidenumberandchildslidenumbersvisibility/)(**bool**) override | Zmienia widoczność znacznika numeru strony slajdu układu oraz wszystkich potomnych znaczników numeru strony. Znaczniki potomne oznaczają, że znaczniki znajdują się na slajdach zależnych. Slajdy zależne używają i zależą od slajdu układu. |
...
* Klasa [ILayoutSlideHeaderFooterManager](../ilayoutslideheaderfootermanager/)
