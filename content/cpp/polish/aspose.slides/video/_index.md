...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Zwraca kopię danych audio. W przypadku dużej ilości danych rozważ użycie metody [Video::GetStream](./getstream/), aby zapobiec niepotrzebnemu ładowaniu danych wideo do pamięci lub nawet wyjątku OutOfMemoryException. Tylko do odczytu **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Zwraca typ MIME wideo, zakodowany w [Video::get_BinaryData](./get_binarydata/). Tylko do odczytu [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | Zwraca strumień Stream do odczytu. Użyj 'using' lub zamknij strumień po użyciu. |
