...
description: Reprezentuje ramkę z umieszczonym w niej obrazem.
type: docs
weight: 4733
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [get_Adjustment](../geometryshape/get_adjustment/)(**int32_t**) override | Zwraca wartość dopasowania kształtu podanym indeksie. |
...
| **float** [get_Height](../shape/get_height/)() override | Pobiera wysokość kształtu, w punktach. Odczyt **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkMouseOver](../shape/get_hyperlinkmouseover/)() override | Zwraca hiperłącze zdefiniowane dla najechania myszą. Odczyt [IHyperlink](../ihyperlink/). |
| **bool** [get_IsCameo](./get_iscameo/)() | Określa, czy [PictureFrame](./) jest obiektem Cameo. Tylko do odczytu **bool**. |
...
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | Zwraca unikalny identyfikator zakresu slajdu, stały przez cały czas życia kształtu, umożliwiający PowerPointowi lub kodowi interop odwoływanie się do kształtu z dowolnego miejsca w dokumencie. Tylko do odczytu **uint32_t**. Zobacz także [Shape::get_UniqueId](../shape/get_uniqueid/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_PictureFormat](./get_pictureformat/)() override | Zwraca obiekt [PictureFillFormat](../picturefillformat/) dla ramki obrazu. Tylko do odczytu [IPictureFillFormat](../ipicturefillformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPictureFrameLock](../ipictureframelock/)\> [get_PictureFrameLock](./get_pictureframelock/)() override | Zwraca blokady kształtu. Tylko do odczytu [IPictureFrameLock](../ipictureframelock/). |
...
| **float** [get_RelativeScaleHeight](./get_relativescaleheight/)() override | Zwraca skalę wysokości (względem oryginalnego rozmiaru obrazu) ramki obrazu. Wartość 1.0 odpowiada 100%. Odczyt **float**. |
| **float** [get_RelativeScaleWidth](./get_relativescalewidth/)() override | Zwraca skalę szerokości (względem oryginalnego rozmiaru obrazu) ramki obrazu. Wartość 1.0 odpowiada 100%. Odczyt **float**. |
| **float** [get_Rotation](../shape/get_rotation/)() override | Zwraca liczbę stopni, o które określony kształt jest obrócony wokół osi z. Wartość dodatnia oznacza obrót zgodny z ruchem wskazówek zegara; wartość ujemna – przeciwnie. Odczyt **float**. |
...
| **float** [get_Width](../shape/get_width/)() override | Pobiera szerokość kształtu, w punktach. Odczyt **float**. |
| **float** [get_X](../shape/get_x/)() override | Pobiera współrzędną x lewego górnego rogu kształtu, w punktach. Odczyt **float**. |
| **float** [get_Y](../shape/get_y/)() override | Pobiera współrzędną y lewego górnego rogu kształtu, w punktach. Odczyt **float**. |
| **int32_t** [get_ZOrderPosition](../shape/get_zorderposition/)() override | Zwraca pozycję kształtu w kolejności z. Shapes[0] zwraca kształt z tyłu kolejności, a Shapes[Shapes.Count - 1] zwraca kształt z przodu kolejności. Tylko do odczytu **int32_t**. |
...
| void [set_Height](../shape/set_height/)(**float**) override | Ustawia wysokość kształtu, w punktach. Zapis **float**. |
...
| void [set_IsDecorative](../shape/set_isdecorative/)(**bool**) override | Ustawia 'Mark as decorative' opcję Odczyt/zapis **bool**. |
...
| void [set_RelativeScaleHeight](./set_relativescaleheight/)(**float**) override | Ustawia skalę wysokości (względem oryginalnego rozmiaru obrazu) ramki obrazu. Wartość 1.0 odpowiada 100%. Zapis **float**. |
| void [set_RelativeScaleWidth](./set_relativescalewidth/)(**float**) override | Ustawia skalę szerokości (względem oryginalnego rozmiaru obrazu) ramki obrazu. Wartość 1.0 odpowiada 100%. Zapis **float**. |
| void [set_Rotation](../shape/set_rotation/)(**float**) override | Ustawia liczbę stopni, o które określony kształt jest obrócony wokół osi z. Wartość dodatnia oznacza obrót zgodny z ruchem wskazówek zegara; wartość ujemna – przeciwnie. Zapis **float**. |
| void [set_ShapeType](./set_shapetype/)([Aspose::Slides::ShapeType](../shapetype/)) override |  |
| void [set_Width](../shape/set_width/)(**float**) override | Ustawia szerokość kształtu, w punktach. Zapis **float**. |
| void [set_X](../shape/set_x/)(**float**) override | Ustawia współrzędną x lewego górnego rogu kształtu, w punktach. Zapis **float**. |
| void [set_Y](../shape/set_y/)(**float**) override | Ustawia współrzędną y lewego górnego rogu kształtu, w punktach. Zapis **float**. |
...
Poniższe przykłady pokazują, jak zmienić miniaturę ramki [Audio](../audio/).
```cpp
auto presentation = System::MakeObject<Presentation>();
auto slide = presentation->get_Slides()->idx_get(0);

// Dodaje ramkę dźwiękową do slajdu z określonym położeniem i rozmiarem.
...
// Ustawia obraz dla ramki dźwiękowej.
