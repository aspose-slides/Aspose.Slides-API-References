...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) typ Odczyt [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 deg, field of View) Odczyt **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) zoom (positive value in percentage) Odczyt **float**. |
...
| virtual void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) | [Camera](../camera/) typ Zapis [CameraPresetType](../camerapresettype/). |
| virtual void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) | [Camera](../camera/) FOV (0-180 deg, field of View) Zapis **float**. |
| virtual void [set_Zoom](./set_zoom/)(**float**) | [Camera](../camera/) zoom (positive value in percentage) Zapis **float**. |
