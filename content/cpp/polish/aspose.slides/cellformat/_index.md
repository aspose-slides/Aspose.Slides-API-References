...
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderBottom](./get_borderbottom/)() override | Zwraca obiekt właściwości linii dolnego obramowania. Tylko do odczytu [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderDiagonalDown](./get_borderdiagonaldown/)() override | Zwraca obiekt właściwości linii przekątnej od lewego górnego do prawego dolnego. Tylko do odczytu [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderDiagonalUp](./get_borderdiagonalup/)() override | Zwraca obiekt właściwości linii przekątnej od lewego dolnego do prawego górnego. Tylko do odczytu [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderLeft](./get_borderleft/)() override | Zwraca obiekt właściwości linii lewego obramowania. Tylko do odczytu [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderRight](./get_borderright/)() override | Zwraca obiekt właściwości linii prawego obramowania. Tylko do odczytu [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderTop](./get_bordertop/)() override | Zwraca obiekt właściwości linii górnego obramowania. Tylko do odczytu [ILineFormat](../ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Zwraca obiekt właściwości wypełnienia komórki. Tylko do odczytu [IFillFormat](../ifillformat/). |
...
| **float** [get_Transparency](./get_transparency/)() override | Pobiera przezroczystość koloru wypełnienia. Odczyt **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICellFormatEffectiveData](../icellformateffectivedata/)\> [GetEffective](./geteffective/)() override | Pobiera efektywne właściwości formatowania komórki tabeli z zastosowaną dziedziczeniem i stylami tabeli. |
...
| void [set_Transparency](./set_transparency/)(**float**) override | Ustawia przezroczystość koloru wypełnienia. Zapis **float**. |
