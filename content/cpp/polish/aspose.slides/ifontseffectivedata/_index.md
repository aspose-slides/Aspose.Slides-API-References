...
description: Niezmienny obiekt zawierający zestaw efektywnych czcionek.
type: docs
weight: 2224
url: /pl/aspose.slides/ifontseffectivedata/
---
## IFontsEffectiveData klasa

Niezmienny obiekt zawierający zestaw efektywnych czcionek.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() | Zwraca czcionkę skryptu złożonego. Tylko do odczytu [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() | Zwraca czcionkę wschodnioazjatycką. Tylko do odczytu [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() | Zwraca czcionkę łacińską. Tylko do odczytu [IFontData](../ifontdata/). |
...
Ten interfejs jest używany jako część interfejsów [IBasePortionFormatEffectiveData](../ibaseportionformateffectivedata/) i [Theme::IFontSchemeEffectiveData](../../aspose.slides.theme/ifontschemeeffectivedata/).
