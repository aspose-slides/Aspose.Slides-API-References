...
description: Reprezentuje blokadę kształtu (operacja wyłączona).
type: docs
weight: 1483
url: /pl/aspose.slides/ibaseshapelock/
---
## IBaseShapeLock klasa

Reprezentuje [Shape](../shape/) lock (operacja wyłączona).
...
| virtual **bool** [get_NoLocks](./get_nolocks/)() | Zwraca true, jeśli wszystkie flagi blokady są wyłączone. Tylko do odczytu **bool**. |
