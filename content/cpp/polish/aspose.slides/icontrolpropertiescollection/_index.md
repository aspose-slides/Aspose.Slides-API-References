...
---
## IControlPropertiesCollection klasa
...
| Method | Opis |
| --- | --- |
| virtual void [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | Dodaje własność do kolekcji. |
...
| virtual void [Clear](./clear/)() | Usuwa wszystkie własności. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Zwraca liczbę własności w kolekcji. Tylko do odczytu **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::String](../../system/string/)\>\> [get_NamesOfProperties](./get_namesofproperties/)() | Zwraca liczbę własności w kolekcji. Tylko do odczytu ICollection<string>. |
...
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) | Zwraca własność. |
| virtual void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) | Ustawia własność. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę w stylu C# lock(). Wywołać bezpośrednio lub użyć obiektu strażniczego [LockContext](../../system/lockcontext/). |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Usuwa własność o podanej nazwie. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie w stylu C# lock(). Wywołać bezpośrednio lub użyć obiektu strażniczego [LockContext](../../system/lockcontext/). |
