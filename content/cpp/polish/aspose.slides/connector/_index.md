...
description: Reprezentuje łącze.
type: docs
weight: 482
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [get_Adjustment](../geometryshape/get_adjustment/)(**int32_t**) override | Zwraca wartość dopasowań kształtu pod wskazanym indeksem. |
...
| [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../shape/get_blackwhitemode/)() override | Właściwość określa, jak kształt będzie renderowany w trybie czarno-biały. Odczyt [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IConnectorLock](../iconnectorlock/)\> [get_ConnectorLock](./get_connectorlock/)() override | Zwraca blokady łącza. Tylko do odczytu [IConnectorLock](../iconnectorlock/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomData](../icustomdata/)\> [get_CustomData](../shape/get_customdata/)() override | Zwraca dane własne kształtu. Tylko do odczytu [ICustomData](../icustomdata/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [get_EndShapeConnectedTo](./get_endshapeconnectedto/)() override | Zwraca kształt, do którego podłącza się koniec łącza. Odczyt [IShape](../ishape/). |
| **uint32_t** [get_EndShapeConnectionSiteIndex](./get_endshapeconnectionsiteindex/)() override | Zwraca indeks punktu połączenia dla końcowego kształtu. Odczyt **uint32_t**. |
...
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | Zwraca unikalny identyfikator w zakresie slajdu, który pozostaje stały przez cały czas życia kształtu i pozwala PowerPointowi lub kodowi interop w niezawodny sposób odwoływać się do kształtu z dowolnego miejsca w dokumencie. Tylko do odczytu **uint32_t**. Zobacz także [Shape::get_UniqueId](../shape/get_uniqueid/). |
...
| **float** [get_Rotation](../shape/get_rotation/)() override | Zwraca liczbę stopni, o które podany kształt jest obrócony wokół osi z. Wartość dodatnia oznacza obrót zgodnie z ruchem wskazówek zegara; wartość ujemna oznacza obrót przeciwnie do ruchu wskazówek zegara. Odczyt **float**. |
...
| [Aspose::Slides::ShapeType](../shapetype/) [get_ShapeType](./get_shapetype/)() override | Zwraca typ [AutoShape](../autoshape/). Odczyt [Slides::ShapeType](../shapetype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [get_StartShapeConnectedTo](./get_startshapeconnectedto/)() override | Zwraca kształt, do którego podłącza się początek łącza. Odczyt [IShape](../ishape/). |
| **uint32_t** [get_StartShapeConnectionSiteIndex](./get_startshapeconnectionsiteindex/)() override | Zwraca indeks punktu połączenia dla kształtu początkowego. Odczyt **uint32_t**. |
...
| **uint32_t** [get_UniqueId](../shape/get_uniqueid/)() override | Zwraca wewnętrzny identyfikator w zakresie prezentacji przeznaczony do użytku przez dodatki lub inny kod. Ponieważ wartość ta może zostać ponownie przypisana przez użytkownika lub programowo, nie należy jej traktować jako trwały unikalny klucz. Tylko do odczytu **uint32_t**. Zobacz także [Shape::get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/). |
...
| **int32_t** [get_ZOrderPosition](../shape/get_zorderposition/)() override | Zwraca pozycję kształtu w kolejności Z. Shapes[0] zwraca kształt na końcu kolejności Z, a Shapes[Shapes.Count - 1] zwraca kształt na przedzie kolejności Z. Tylko do odczytu **int32_t**. |
...
| void [Reroute](./reroute/)() override | Przekierowuje łącze, aby wybrało najkrótszą możliwą ścieżkę między połączonymi kształtami. |
...
| void [set_BlackWhiteMode](../shape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) override | Właściwość określa, jak kształt będzie renderowany w trybie czarno-biały. Zapis [Slides::BlackWhiteMode](../blackwhitemode/). |
| void [set_EndShapeConnectedTo](./set_endshapeconnectedto/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>) override | Ustawia kształt, do którego podłącza się koniec łącza. Zapis [IShape](../ishape/). |
| void [set_EndShapeConnectionSiteIndex](./set_endshapeconnectionsiteindex/)(**uint32_t**) override | Ustawia indeks punktu połączenia dla końcowego kształtu. Zapis **uint32_t**. |
...
| void [set_IsDecorative](../shape/set_isdecorative/)(**bool**) override | Ustawia opcję 'Mark as decorative'. Zapis **bool**. |
...
| void [set_Rotation](../shape/set_rotation/)(**float**) override | Ustawia liczbę stopni, o które podany kształt jest obrócony wokół osi z. Wartość dodatnia oznacza obrót zgodnie z ruchem wskazówek zegara; wartość ujemna oznacza obrót przeciwnie do ruchu wskazówek zegara. Zapis **float**. |
| void [set_ShapeType](./set_shapetype/)([Aspose::Slides::ShapeType](../shapetype/)) override | Ustawia typ [AutoShape](../autoshape/). Zapis [Slides::ShapeType](../shapetype/). |
| void [set_StartShapeConnectedTo](./set_startshapeconnectedto/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\>) override | Ustawia kształt, do którego podłącza się początek łącza. Zapis [IShape](../ishape/). |
| void [set_StartShapeConnectionSiteIndex](./set_startshapeconnectionsiteindex/)(**uint32_t**) override | Ustawia indeks punktu połączenia dla początkowego kształtu. Zapis **uint32_t**. |
