...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Zwraca obiekt właściwości wypełnienia tabeli. Tylko do odczytu [IFillFormat](../ifillformat/). |
| virtual **float** [get_Transparency](./get_transparency/)() | Pobiera przezroczystość koloru wypełnienia. Odczyt **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() | Pobiera efektywne właściwości formatowania tabeli z zastosowanym dziedziczeniem i stylami tabel. |
...
| virtual void [set_Transparency](./set_transparency/)(**float**) | Ustawia przezroczystość koloru wypełnienia. Zapis **float**. |
