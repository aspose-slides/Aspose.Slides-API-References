...
| Method | Description |
| --- | --- |
| virtual **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) | Sprawdza, czy hasło jest prawidłowe dla prezentacji chronionej otwartym hasłem. |
| virtual **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) | Sprawdza, czy hasło do modyfikacji jest prawidłowe dla prezentacji chronionej przed zapisem. |
...
| virtual **bool** [get_IsEncrypted](./get_isencrypted/)() | Zwraca True, jeśli powiązana prezentacja jest zaszyfrowana, w przeciwnym razie False. Tylko do odczytu **bool**. |
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | Zwraca wartość wskazującą, czy powiązana prezentacja jest chroniona hasłem otwierającym. |
| virtual [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() | Zwraca wartość wskazującą, czy powiązana prezentacja jest chroniona przed zapisem. |
| virtual [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() | Zwraca format powiązanej prezentacji. Tylko do odczytu [Slides::LoadFormat](../loadformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() | Zwraca właściwości dokumentu powiązanej prezentacji. |
...
| virtual void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) | Aktualizuje właściwości powiązanej prezentacji. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Zapisuje powiązaną prezentację do strumienia. |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) | Zapisuje powiązaną prezentację do pliku. |
