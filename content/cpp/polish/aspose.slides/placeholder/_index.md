...
description: Reprezentuje znacznik zastępczy na slajdzie.
type: docs
weight: 4759
...
Reprezentuje znacznik zastępczy na slajdzie.
...
| **uint32_t** [get_Index](./get_index/)() override | Pobiera indeks znacznika zastępczego. Tylko do odczytu **uint32_t**. |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Pobiera orientację znacznika zastępczego. Tylko do odczytu [Slides::Orientation](../orientation/). |
| [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() override | Pobiera rozmiar znacznika zastępczego. Tylko do odczytu [PlaceholderSize](../placeholdersize/). |
| [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() override | Pobiera typ znacznika zastępczego. Tylko do odczytu [PlaceholderType](../placeholdertype/). |
