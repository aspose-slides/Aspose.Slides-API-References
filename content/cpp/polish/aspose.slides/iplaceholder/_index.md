...
| virtual **uint32_t** [get_Index](./get_index/)() | Pobiera indeks placeholdera. Tylko do odczytu **uint32_t**. |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Pobiera orientację placeholdera. Tylko do odczytu [Slides::Orientation](../orientation/). |
| virtual [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() | Pobiera rozmiar placeholdera. Tylko do odczytu [PlaceholderSize](../placeholdersize/). |
| virtual [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() | Pobiera typ placeholdera. Tylko do odczytu [PlaceholderType](../placeholdertype/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę w instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. W rzeczywistości nie kopiuje nic, tylko inicjalizuje nowy obiekt i umożliwia tworzenie podklas przez kopiowanie. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. W rzeczywistości nie kopiuje nic, tylko inicjalizuje nowy obiekt i umożliwia tworzenie podklas przez kopiowanie. |
