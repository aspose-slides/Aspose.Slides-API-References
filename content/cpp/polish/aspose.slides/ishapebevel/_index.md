...
description: Reprezentuje właściwości wypukłości głównej powierzchni kształtu.
type: docs
weight: 3654
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Typ fazowania. Odczyt [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Wysokość fazowania. Odczyt **double**. |
| virtual **double** [get_Width](./get_width/)() | Szerokość fazowania. Odczyt **double**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę statementu C# lock(). Wywołaj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/) sentry. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiowania. W rzeczywistości nie kopiuje nic, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | Typ fazowania. Zapis [BevelPresetType](../bevelpresettype/). |
| virtual void [set_Height](./set_height/)(**double**) | Wysokość fazowania. Zapis **double**. |
| virtual void [set_Width](./set_width/)(**double**) | Szerokość fazowania. Zapis **double**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie statementu C# lock(). Wywołaj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/) sentry. |
