...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_EndParagraphPortionFormat](./get_endparagraphportionformat/)() | Określa właściwości fragmentu, które mają być użyte, jeśli po ostatnim zostanie wstawiony kolejny fragment. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() | Zwraca obiekt formatowania dla tego akapitu. Tylko do odczytu [IParagraphFormat](../iparagraphformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [get_Portion](./get_portion/)(**int32_t**) | Zwraca fragment tekstu pod określonym indeksem. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionCollection](../iportioncollection/)\> [get_Portions](./get_portions/)() | Zwraca kolekcję fragmentów tekstu. Tylko do odczytu [IPortionCollection](../iportioncollection/). |
...
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Pobiera zwykły tekst akapitu. Odczyt [System::String](../../system/string/). |
...
| virtual **int32_t** [GetLinesCount](./getlinescount/)() | Pobiera liczbę linii w akapicie. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() | Pobiera współrzędne prostokąta otaczającego akapit. Prostokąt obejmuje wszystkie linie tekstu w akapicie, w tym puste. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Pobiera rzeczywisty typ obiektu. Odpowiednik wywołania C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Sprawdza, czy obiekt jest instancją typu opisanego przez targetType. Odpowiednik operatora C# 'is'. |
| virtual void [JoinPortionsWithSameFormatting](./joinportionswithsameformatting/)() | Łączy fragmenty o tym samym formatowaniu. |
...
| virtual void [set_EndParagraphPortionFormat](./set_endparagraphportionformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Określa właściwości fragmentu, które mają być użyte, jeśli po ostatnim zostanie wstawiony kolejny fragment. |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | Ustawia zwykły tekst akapitu. Zapis [System::String](../../system/string/). |
