...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | Zwraca komentarz napisany przez tego autora pod wskazanym indeksem. Tylko do odczytu [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | Zwraca kolekcję komentarzy napisanych przez tego autora. Tylko do odczytu [ICommentCollection](../icommentcollection/). |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | Zwraca inicjały autora. Tylko do odczytu [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Zwraca nazwę autora. Tylko do odczytu [System::String](../../system/string/). |
...
| void [Remove](./remove/)() override | Usuwa autora z kolekcji nadrzędnej. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza współdzielony licznik referencji o podaną wartość. |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | Ustawia inicjały autora. Zapis [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Ustawia nazwę autora. Zapis [System::String](../../system/string/). |
