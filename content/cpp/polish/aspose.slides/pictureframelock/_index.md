...
Określa, które operacje są wyłączone w nadrzędnym [PictureFrame](../pictureframe/).
...
| **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() override | Określa, czy kształt musi zachować proporcje podczas zmiany rozmiaru. Odczyt **bool**. |
| **bool** [get_CropLocked](./get_croplocked/)() override | Określa, czy przycinanie obrazu jest zabronione. Odczyt **bool**. |
...
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | Określa, czy kształt musi zachować proporcje podczas zmiany rozmiaru. Zapis **bool**. |
| void [set_CropLocked](./set_croplocked/)(**bool**) override | Określa, czy przycinanie obrazu jest zabronione. Zapis **bool**. |
...
* Klasa [IPictureFrameLock](../ipictureframelock/)
