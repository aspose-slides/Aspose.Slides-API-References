...
| [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() override | Kierunek światła. Odczyt [LightingDirection](../lightingdirection/). |
| [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() override | Reprezentuje wstępnie ustawione światło, które może być zastosowane do kształtu. Light rig reprezentuje grupę świateł skierowaną w określony sposób względem sceny 3D. Odczyt [LightRigPresetType](../lightrigpresettype/). |
...
| void [set_Direction](./set_direction/)([LightingDirection](../lightingdirection/)) override | Kierunek światła. Zapis [LightingDirection](../lightingdirection/). |
| void [set_LightType](./set_lighttype/)([LightRigPresetType](../lightrigpresettype/)) override | Reprezentuje wstępnie ustawione światło, które może być zastosowane do kształtu. Light rig reprezentuje grupę świateł skierowaną w określony sposób względem sceny 3D. Zapis [LightRigPresetType](../lightrigpresettype/). |
| void [SetRotation](./setrotation/)(**float**, **float**, **float**) override | Rotacja jest definiowana przy użyciu współrzędnej szerokości, współrzędnej długości oraz obrotu wokół osi jako współrzędne szerokości i długości. Jeśli którakolwiek wartość współrzędnej jest std::numeric_limits<float>::quiet_NaN(), cała rotacja jest niezdefiniowana. |
