...
description: Reprezentuje menedżera, który zarządza zachowaniem placeholderów slajdu głównego materiału pomocniczego, w tym placeholdera nagłówka.
type: docs
weight: 4421
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Pobiera wartość wskazującą, że placeholder daty i czasu jest obecny. Read**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | Pobiera wartość wskazującą, że placeholder stopki jest obecny. Read **bool**. |
| **bool** [get_IsHeaderVisible](../basehandoutnotesslideheaderfootermanager/get_isheadervisible/)() override | Pobiera wartość wskazującą, że placeholder nagłówka jest obecny. Read **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Pobiera wartość wskazującą, że placeholder numeru strony jest obecny. Read**bool**. |
...
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | Ustawia tekst w placeholderze daty i czasu slajdu. |
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | Zmienia widoczność placeholdera daty i czasu slajdu. |
| void [SetFooterText](../baseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) override | Ustawia tekst w placeholderze stopki slajdu. |
| void [SetFooterVisibility](../baseslideheaderfootermanager/setfootervisibility/)(**bool**) override | Zmienia widoczność placeholdera stopki slajdu. |
| void [SetHeaderText](../basehandoutnotesslideheaderfootermanager/setheadertext/)([System::String](../../system/string/)) override | Ustawia tekst w placeholderze nagłówka slajdu. |
| void [SetHeaderVisibility](../basehandoutnotesslideheaderfootermanager/setheadervisibility/)(**bool**) override | Zmienia widoczność placeholdera nagłówka slajdu. |
| void [SetSlideNumberVisibility](../baseslideheaderfootermanager/setslidenumbervisibility/)(**bool**) override | Zmienia widoczność placeholdera numeru strony slajdu. |
...
* Klasa [IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/)
