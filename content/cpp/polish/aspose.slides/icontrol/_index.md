...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_ActiveXControlBinary](./get_activexcontrolbinary/)() | Określa trwałość kontrolki ActiveX, gdy metodą utrwalania jest PersistStream, PersistStreamInit lub PersistStorage. |
| virtual [System::Guid](../../system/guid/) [get_ClassId](./get_classid/)() | Pobiera identyfikator klasy tej kontrolki. Tylko do odczytu [System::Guid](../../system/guid/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_Frame](./get_frame/)() | Zwraca ramkę kontrolki. Odczyt [IShapeFrame](../ishapeframe/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Zwraca nazwę tej kontrolki. Odczyt [System::String](../../system/string/). |
| virtual [PersistenceType](../persistencetype/) [get_Persistence](./get_persistence/)() | Pobiera metodę używaną do przechowywania właściwości kontrolki ActiveX. Tylko do odczytu [PersistenceType](../persistencetype/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IControlPropertiesCollection](../icontrolpropertiescollection/)\> [get_Properties](./get_properties/)() | Zwraca kolekcję właściwości ActiveX. Tylko do odczytu [IControlPropertiesCollection](../icontrolpropertiescollection/). |
| virtual [System::String](../../system/string/) [get_Property](./get_property/)([System::String](../../system/string/)) | Zwraca właściwość ActiveX pod podanym indeksem. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_SubstitutePictureFormat](./get_substitutepictureformat/)() | Zwraca obiekt właściwości wypełnienia obrazu ControlEx. Tylko do odczytu [IPictureFillFormat](../ipicturefillformat/). |
...
| virtual void [set_Frame](./set_frame/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\>) | Ustawia ramkę kontrolki. Zapis [IShapeFrame](../ishapeframe/). |
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Zwraca nazwę tej kontrolki. Zapis [System::String](../../system/string/). |
| virtual void [set_Property](./set_property/)([System::String](../../system/string/), [System::String](../../system/string/)) | Ustawia właściwość ActiveX pod podanym indeksem. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowywanie w instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
