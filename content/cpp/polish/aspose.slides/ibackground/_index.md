...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | Zwraca [EffectFormat](../effectformat/) dla wypełnienia [BackgroundType::OwnBackground](../backgroundtype/). Tylko do odczytu [IEffectFormat](../ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Zwraca [FillFormat](../fillformat/) dla wypełnienia [BackgroundType::OwnBackground](../backgroundtype/). Tylko do odczytu [IFillFormat](../ifillformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | Zwraca [ColorFormat](../colorformat/) dla wypełnienia [BackgroundType::Themed](../backgroundtype/). Tylko do odczytu [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | Zwraca indeks wypełnienia [BackgroundType::Themed](../backgroundtype/) w kolekcji motywów tła. 0 oznacza brak wypełnienia. 1..999 – indeks. Odczyt **uint16_t**. |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | Zwraca typ wypełnienia tła. Odczyt [BackgroundType](../backgroundtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | Pobiera efektywne dane tła z zastosowanym dziedziczeniem. |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | Zwraca indeks wypełnienia [BackgroundType::Themed](../backgroundtype/) w kolekcji motywów tła. 0 oznacza brak wypełnienia. 1..999 – indeks. Zapis **uint16_t**. |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | Zwraca typ wypełnienia tła. Zapis [BackgroundType](../backgroundtype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje instrukcję C# lock() odblokowującą. Wywołaj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/). |
