...
description: Reprezentuje kolekcję wszystkich slajdów układu zdefiniowanego slajdu nadrzędnego. Rozszerza interfejs ILayoutSlideCollection metodami do dodawania, wstawiania, usuwania i klonowania slajdów układu w kontekście poszczególnych kolekcji slajdów układu nadrzędnego.
type: docs
weight: 2874
url: /pl/aspose.slides/imasterlayoutslidecollection/
---
## IMasterLayoutSlideCollection klasa


Reprezentuje kolekcję wszystkich slajdów układu zdefiniowanego slajdu nadrzędnego. Rozszerza interfejs [ILayoutSlideCollection](../ilayoutslidecollection/) metodami do dodawania/wstawiania/usuwania/klonowania slajdów układu w kontekście poszczególnych kolekcji slajdów układu nadrzędnego.
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Dodaje nowy slajd układu na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Dodaje kopię określonego slajdu układu na koniec kolekcji. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) kolekcji. Ten iterator nie może być używany do zmiany referencowanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca obiekt-kopię typu T. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są traktowane jako równe, pomimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są traktowane jako równe, pomimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../ilayoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) | Zwraca pierwszy slajd układu określonego typu. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../ilayoutslidecollection/idx_get/)(**int32_t**) | Zwraca slajd układu według indeksu. Tylko do odczytu [ILayoutSlide](../ilayoutslide/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Insert](./insert/)(**int32_t**, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Wstawia nowy slajd układu we wskazane miejsce w kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Wstawia kopię określonego slajdu układu we wskazane miejsce w kolekcji. |
...
| virtual void [Remove](../ilayoutslidecollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Usuwa układ z kolekcji. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Usuwa element o określonym indeksie w kolekcji. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza współdzielony licznik referencji o określoną wartość. |
| virtual void [RemoveUnused](../ilayoutslidecollection/removeunused/)() | Usuwa nieużywane slajdy układu (slajdy układu, dla których HasDependingSlides jest false). |
| virtual void [Reorder](./reorder/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Przenosi slajd układu z kolekcji do określonej pozycji. |
...
* Klasa [ILayoutSlideCollection](../ilayoutslidecollection/)
