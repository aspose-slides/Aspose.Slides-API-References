...
| virtual [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() | Zwraca metodę przypisania etykiety wrażliwości. Czytaj [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() | Zwraca listę typów oznaczenia treści, które powinny być zastosowane do pliku. |
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | Zwraca identyfikator etykiety wrażliwości. Czytaj [System::String](../../system/string/). |
| virtual **bool** [get_IsEnabled](./get_isenabled/)() | Wskazuje, czy etykieta wrażliwości jest włączona. |
| virtual **bool** [get_IsRemoved](./get_isremoved/)() | Wskazuje, czy etykieta wrażliwości została usunięta. |
| virtual [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() | Zwraca identyfikator witryny Azure Active Directory (Azure AD) odpowiadający polityce etykiety wrażliwości opisującej etykietę wrażliwości. Czytaj [System::Guid](../../system/guid/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje zablokowanie przez instrukcję C# lock(). Wywołaj bezpośrednio lub użyj obiektu ochronnego [LockContext](../../system/lockcontext/). |
...
| virtual void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | Ustawia metodę przypisania etykiety wrażliwości. Zapisz [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | Ustawia identyfikator etykiety wrażliwości. Zapisz [System::String](../../system/string/). |
| virtual void [set_IsEnabled](./set_isenabled/)(**bool**) | Wskazuje, czy etykieta wrażliwości jest włączona. |
| virtual void [set_IsRemoved](./set_isremoved/)(**bool**) | Wskazuje, czy etykieta wrażliwości została usunięta. |
| virtual void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) | Ustawia identyfikator witryny Azure Active Directory (Azure AD) odpowiadający polityce etykiety wrażliwości opisującej etykietę wrażliwości. Zapisz [System::Guid](../../system/guid/). |
