...
| Metoda | Opis |
| --- | --- |
| **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) override | Sprawdza, czy hasło jest poprawne dla prezentacji chronionej hasłem otwarcia. |
| **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) override | Sprawdza, czy hasło do modyfikacji jest poprawne dla prezentacji chronionej przed zapisem. |
...
| **bool** [get_IsEncrypted](./get_isencrypted/)() override | Zwraca True, jeśli powiązana prezentacja jest zaszyfrowana, w przeciwnym razie False. Read-only **bool**. |
| **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() override | Zwraca wartość wskazującą, czy powiązana prezentacja jest chroniona hasłem otwarcia. |
| [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() override | Zwraca wartość wskazującą, czy powiązana prezentacja jest chroniona przed zapisem. |
| [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() override | Zwraca format powiązanej prezentacji. Read-only [Slides::LoadFormat](../loadformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() override | Zwraca właściwości dokumentu powiązanej prezentacji. |
...
| void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) override | Aktualizuje właściwości powiązanej prezentacji. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Zapisuje powiązaną prezentację do strumienia. |
| void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) override | Zapisuje powiązaną prezentację do pliku. |
| virtual  [~Object](../../system/object/~object/)() | Niszczy obiekt. Zwalnia wszystkie wewnętrzne struktury danych. |

## Zobacz także

* Klasa [IPresentationInfo](../ipresentationinfo/)
