...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) override | Zwraca prowadnicę rysowania pod wskazanym indeksem. Tylko do odczytu [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Zwraca kolekcję prowadnic rysowania. Tylko do odczytu [IDrawingGuidesCollection](../idrawingguidescollection/) |
| **int32_t** [get_Scale](./get_scale/)() override | Określa współczynnik skalowania widoku w procentach. Odczyt **int32_t**. |
| **bool** [get_VariableScale](./get_variablescale/)() override | Określa, że zawartość widoku powinna automatycznie skalować się, aby najlepiej pasowała do bieżącego rozmiaru okna. Odczyt **bool**. |
...
| void [set_Scale](./set_scale/)(**int32_t**) override | Określa współczynnik skalowania widoku w procentach. Zapis **int32_t**. |
| void [set_VariableScale](./set_variablescale/)(**bool**) override | Określa, że zawartość widoku powinna automatycznie skalować się, aby najlepiej pasowała do bieżącego rozmiaru okna. Zapis **bool**. |
...
Poniższy przykład pokazuje, jak ustawić wartość powiększenia dla slajdu PowerPoint [Presentation](../presentation/).
```cpp
// Instancjonuj obiekt Presentation, który reprezentuje plik prezentacji
auto presentation = System::MakeObject<Presentation>(u"demo.pptx");

// Ustawianie własności widoku prezentacji
presentation->get_ViewProperties()->get_SlideViewProperties()->set_Scale(100);
// Wartość przybliżenia w procentach dla widoku slajdu
presentation->get_ViewProperties()->get_NotesViewProperties()->set_Scale(100);
// Wartość przybliżenia w procentach dla widoku notatek
presentation->Save(u"Zoom_out.pptx", SaveFormat::Pptx);
```

## Zobacz także

* Klasa [ICommonSlideViewProperties](../icommonslideviewproperties/)
