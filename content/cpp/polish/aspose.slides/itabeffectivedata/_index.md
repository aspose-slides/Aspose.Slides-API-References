...
description: Niezmienny obiekt zawierający właściwości skutecznych zatrzymań tabulacji tekstu.
type: docs
weight: 3992
url: /pl/aspose.slides/itabeffectivedata/
---
## Klasa ITabEffectiveData

Niezmienny obiekt zawierający właściwości skutecznych zatrzymań tabulacji tekstu.
...
| Metoda | Opis |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | Porównuje bieżący obiekt z określonym obiektem. |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Zwraca styl wyrównania tabulacji. Tylko do odczytu [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Zwraca pozycję tabulacji. Przypisanie tej właściwości może zmienić indeks tabulacji w kolekcji i unieważnić Enumerator. Tylko do odczytu **double**. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zwiększa współdzielony licznik odniesień. Nie powinno się wywoływać bezpośrednio; zamiast tego używaj inteligentnych wskaźników lub ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Zmniejsza i zwraca współdzielony licznik odniesień. Nie powinno się wywoływać bezpośrednio; zamiast tego używaj inteligentnych wskaźników lub ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabych odniesień. Nie powinno się wywoływać bezpośrednio; zamiast tego używaj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabych odniesień. Nie powinno się wywoływać bezpośrednio; zamiast tego używaj inteligentnych wskaźników lub ThisProtector. |
