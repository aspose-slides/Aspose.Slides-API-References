...
---
## ISmartArtShapeCollection klasa

Reprezentuje kolekcję [SmartArt](../smartart/) kształtów
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtShape](../ismartartshape/)\> [idx_get](./idx_get/)(**int32_t**) | Pobiera element o podanym indeksie. Tylko do odczytu [ISmartArtShape](../ismartartshape/). |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Sortuje elementy sekwencji w rosnącym porządku według wartości klucza wybranego przez keySelector. |
