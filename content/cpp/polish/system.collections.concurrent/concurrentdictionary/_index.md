...
description: "Implementacja słownika zabezpieczonego przed dostępem wielowątkowym. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub awarie asercji. Zawsze otaczaj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania jej do funkcji jako argument."
type: docs
weight: 1
url: /pl/system.collections.concurrent/concurrentdictionary/
---
## Klasa ConcurrentDictionary
...
| Metoda | Opis |
| --- | --- |
| void [Add](./add/)(const TKey&, const TValue&) override | Dodaje wartość do słownika. |
| virtual void [Add](../../system.collections.generic/idictionary/add/)(const TKey&, const TValue&) | Dodaje parę klucz-wartość do kontenera. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Zwraca iterator wskazujący na pierwszy element kolekcji oznaczony jako const (jeśli istnieje). |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący tuż za ostatnim elementem const (jeśli istnieje) kolekcji. |
| void [Clear](./clear/)() override | Usuwa wszystkie elementy w kontenerze. |
...
| virtual **bool** [ContainsKey](../../system.collections.generic/idictionary/containskey/)(const TKey&) const | Sprawdza, czy kontener zawiera klucz. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)<TKey, TValue>>, int) override | Kopiuje elementy kontenera do istniejących elementów tablicy. |
| void [CopyTo](../../system.collections.generic/idictionary/copyto/)([ArrayPtr](../../system/arrayptr/)<[KeyValuePair](../../system.collections.generic/keyvaluepair/)<TKey, TValue>>, int) override | Kopiuje zawartość słownika do istniejących elementów tablicy. |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)() | Tworzy pusty słownik. |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(const [map_t](../../system.collections.generic/dictionary/map_t/)&) | Kopiuje dane z mapy. |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(int) | Przeciążenie, które odpowiada tworzeniu prealokowanego słownika; faktycznie nie dokonuje alokacji. |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(const [SharedPtr](../../system/sharedptr/)<[IDictionary](../../system.collections.generic/idictionary/)<TKey, TValue>>&) | Konstruktor kopiujący. |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(const [SharedPtr](../../system/sharedptr/)<[IDictionary](../../system.collections.generic/idictionary/)<TKey, TValue>>&, const [SharedPtr](../../system/sharedptr/)<[IEqualityComparer](../../system.collections.generic/iequalitycomparer/)<TKey>>&) | Konstruktor kopiujący. |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(const [SharedPtr](../../system/sharedptr/)<[IEqualityComparer](../../system.collections.generic/iequalitycomparer/)<TKey>>&) | Tworzy pusty słownik. |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(int, const [SharedPtr](../../system/sharedptr/)<[IEqualityComparer](../../system.collections.generic/iequalitycomparer/)<TKey>>&) | Tworzy pusty słownik. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący tuż za ostatnim elementem (jeśli istnieje) stałej (const) instancji kolekcji. |
...
| **bool** [get_IsFixedSize](../../system.collections.generic/idictionary/get_isfixedsize/)() const | Sprawdza, czy rozmiar kolekcji jest stały. |
...
| **bool** [get_IsSynchronized](../../system.collections.generic/idictionary/get_issynchronized/)() const | Sprawdza, czy kontener jest bezpieczny dla wątków. |
| virtual [SharedPtr](../../system/sharedptr/)<[ICollection](../../system.collections.generic/icollection/)<TKey>> [get_Keys](../../system.collections.generic/idictionary/get_keys/)() const | Uzyskuje dostęp do kolekcji kluczy. |
| [SharedPtr](../../system/sharedptr/)<typename [ThisType::KeyCollection](../../system.collections.generic/dictionary/keycollection/)> [get_KeysInternal](./get_keysinternal/)() const override | Zwraca kolekcję wrappera umożliwiającą dostęp do kluczy słownika. |
...
| virtual [SharedPtr](../../system/sharedptr/)<[ICollection](../../system.collections.generic/icollection/)<TValue>> [get_Values](../../system.collections.generic/idictionary/get_values/)() const | Uzyskuje dostęp do kolekcji wartości. |
...
| [IEnumeratorPtr](../../system.collections.generic/dictionary/ienumeratorptr/) [GetEnumerator](../../system.collections.generic/dictionary/getenumerator/)() override | Tworzy obiekt enumeratora. |
...
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey&) const | Zwraca wartość, jeśli znaleziona; w przeciwnym razie **Value()**. |
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey&, const TValue&) const | Zwraca wartość, jeśli znaleziona; w przeciwnym razie **defaultValue**. |
| virtual TValue [GetValueOrNull](../../system.collections.generic/idictionary/getvalueornull/)(const TKey&) const | Zwraca wartość, jeśli znaleziona; w przeciwnym razie **null**, ma sens tylko dla typów referencyjnych. |
...
| virtual TValue [idx_get](../../system.collections.generic/idictionary/idx_get/)(const TKey&) const | Funkcja pobierająca (getter). |
| void [idx_set](./idx_set/)(const TKey&, TValue) override | Ustawia element w określonej pozycji. |
| virtual void [idx_set](../../system.collections.generic/idictionary/idx_set/)(const TKey&, TValue) | Funkcja ustawiająca (setter). |
...
| **bool** [Remove](./remove/)(const TKey&) override | Usuwa element z kontenera. |
| virtual **bool** [Remove](../../system.collections.generic/idictionary/remove/)(const TKey&) | Usuwa klucz z kontenera. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwersję własnych obiektów na ciąg znaków. |
| **bool** [TryAdd](./tryadd/)(const TKey&, const TValue&) | Próbuje dodać parę klucz/wartość do słownika. |
| virtual **bool** [TryGetValue](../../system.collections.generic/idictionary/trygetvalue/)(const TKey&, TValue&) const | Wyszukuje wartość i pobiera ją, jeśli znaleziona. |
...
| [BaseType](./basetype/) | Typ implementacji. |
...
int main()
{
  ...
  // Utwórz instancję klasy ConcurrentDictionary.
  auto concurrentDictionary = MakeObject<ConcurrentDictionary<int, int>>();

  // Wypełnij słownik współbieżny.
