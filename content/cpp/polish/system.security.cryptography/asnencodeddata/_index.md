...
description: "Zakodowane dane ASN.1. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani za pomocą operatora new, ponieważ może to powodować błędy w czasie wykonywania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej do funkcji jako argument."
type: docs
weight: 1
url: /pl/system.security.cryptography/asnencodeddata/
---
...
| Metoda | Opis |
| --- | --- |
|  [AsnEncodedData](./asnencodeddata/)(const [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](./)\>\&) | Konstruktor kopiujący. |
...
| virtual void [CopyFrom](./copyfrom/)(const [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](./)\>\&) | Kopiuje dane z innego obiektu. |
...
| virtual [String](../../system/string/) [Format](./format/)(**bool**) const | Formatuje dane w formie czytelnej dla człowieka. |
| [SharedPtr](../../system/sharedptr/)\<[Oid](../oid/)\> [get_Oid](./get_oid/)() const | Pobiera identyfikator obiektu zakodowanych danych. |
| [ByteArrayPtr](../../system/bytearrayptr/) [get_RawData](./get_rawdata/)() const | Pobiera surowe zakodowane dane. |
...
| void [set_Oid](./set_oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](../oid/)\>\&) | Ustawia identyfikator obiektu zakodowanych danych. |
| void [set_RawData](./set_rawdata/)(const [ByteArrayPtr](../../system/bytearrayptr/)\&) | Ustawia surowe zakodowane dane. |
