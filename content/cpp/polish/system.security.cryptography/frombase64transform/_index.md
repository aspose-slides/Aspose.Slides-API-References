...
description: "Konwertuje instancję klasy CryptoStream z base 64. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operator new, ponieważ spowoduje to błędy czasu wykonania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go do funkcji jako argument."
type: docs
weight: 209
url: /pl/system.security.cryptography/frombase64transform/
---
## FromBase64Transform klasa


Konwertuje instancję klasy [CryptoStream](../cryptostream/) z base 64. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej do funkcji jako argument.
...
| virtual **bool** [get_CanReuseTransform](./get_canreusetransform/)() | Pobiera wartość wskazującą, czy bieżąca transformacja może być ponownie użyta. |
| **bool** [get_CanTransformMultipleBlocks](./get_cantransformmultipleblocks/)() | Pobiera wartość wskazującą, czy można przekształcać wiele bloków. |
...
| virtual int [TransformBlock](../icryptotransform/transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Przetwarza blok danych i kopiuje dane do tablicy wyjściowej. |
