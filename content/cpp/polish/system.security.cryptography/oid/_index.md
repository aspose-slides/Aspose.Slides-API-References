...
description: "Identyfikator obiektu kryptograficznego. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub błędy asercji. Zawsze owiń tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 339
url: /pl/system.security.cryptography/oid/
---
## Oid klasa

Identyfikator obiektu kryptograficznego. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub błędy asercji. Zawsze owijaj tę klasę we wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika, aby przekazać go do funkcji jako argument.
...
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromFriendlyName](./fromfriendlyname/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Tworzy obiekt OID z podanej przyjaznej nazwy OID. |
| static [SharedPtr](../../system/sharedptr/)\<[Oid](./)\> [FromOidValue](./fromoidvalue/)(const [String](../../system/string/)\&, [OidGroup](../oidgroup/)) | Tworzy obiekt OID z podanej wartości OID. |
| [String](../../system/string/) [get_FriendlyName](./get_friendlyname/)() const | Pobiera przyjazną nazwę obiektu. |
| [String](../../system/string/) [get_Value](./get_value/)() const | Pobiera ciąg identyfikatora obiektu. |
...
| [Oid](./oid/)() | Konstruktor domyślny. |
| [Oid](./oid/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](./)\>\&) | Konstruktor kopiujący. |
...
| void [set_FriendlyName](./set_friendlyname/)(const [String](../../system/string/)\&) | Ustawia przyjazną nazwę obiektu. |
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Ustawia ciąg identyfikatora obiektu. |
