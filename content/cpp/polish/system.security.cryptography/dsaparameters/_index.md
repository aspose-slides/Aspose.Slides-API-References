...
description: "Struktura danych parametrów algorytmu DSA. Ten typ powinien być alokowany na stosie i przekazywany do funkcji przez wartość lub przez referencję. Nigdy nie używaj klasy System::SmartPtr do zarządzania obiektami tego typu."
type: docs
weight: 703
url: /pl/system.security.cryptography/dsaparameters/
---
## DSAParameters struktura

[Data](../../system.data/) struktura parametrów algorytmu [DSA](../dsa/). Ten typ powinien być alokowany na stosie i przekazywany do funkcji przez wartość lub przez referencję. Nigdy nie używaj klasy [System::SmartPtr](../../system/smartptr/) do zarządzania obiektami tego typu.
