...
description: "Zestaw dopuszczalnych rozmiarów kluczy dla algorytmów symetrycznych. Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub błędy asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji."
type: docs
weight: 300
url: /pl/system.security.cryptography/keysizes/
---
## KeySizes klasa
...
| int [get_MaxSize](./get_maxsize/)() const | Zwraca maksymalny dopuszczalny rozmiar klucza. |
| int [get_MinSize](./get_minsize/)() const | Zwraca minimalny dopuszczalny rozmiar klucza. |
| int [get_SkipSize](./get_skipsize/)() const | Zwraca krok dopuszczalnych rozmiarów klucza. |
...
|  [KeySizes](./keysizes/)(int, int, int) | Informacje RTTI. |
