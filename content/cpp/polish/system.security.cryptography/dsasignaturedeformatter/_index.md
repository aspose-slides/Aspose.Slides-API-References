...
description: "Używany do weryfikacji podpisów DSA. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub błędy asercji. Zawsze owiń tę klasę wskaźnikiem System::SmartPtr i użyj tego wskaźnika do przekazywania go do funkcji jako argument."
type: docs
weight: 157
url: /pl/system.security.cryptography/dsasignaturedeformatter/
---
## DSASignatureDeformatter klasa


Używany do weryfikacji podpisów [DSA](../dsa/). Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub błędy asercji. Zawsze owiń tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i użyj tego wskaźnika do przekazywania jej do funkcji jako argument.
...
| void [SetHashAlgorithm](./sethashalgorithm/)([String](../../system/string/)) override | NIE ZAIMPLEMENTOWANE. |
| void [SetKey](./setkey/)([SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](../asymmetricalgorithm/)\>) override | NIE ZAIMPLEMENTOWANE. |
...
| **bool** [VerifySignature](./verifysignature/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | NIE ZAIMPLEMENTOWANE. |
| virtual **bool** [VerifySignature](../asymmetricsignaturedeformatter/verifysignature/)([System::SharedPtr](../../system/sharedptr/)\<[HashAlgorithm](../hashalgorithm/)\>, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Weryfikuje podpis danych. Nie zaimplementowano. |
