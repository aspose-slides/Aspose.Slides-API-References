...
| virtual int [get_InputBlockSize](./get_inputblocksize/)() | Rozmiar bloku wejściowego. |
| virtual int [get_OutputBlockSize](./get_outputblocksize/)() | Rozmiar bloku wyjściowego. |
...
| virtual int [TransformBlock](./transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Przetwarza blok danych i kopiuje dane do tablicy wyjściowej. |
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](./transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Przetwarza ostatni blok danych i oblicza wartość wyjściową. |
