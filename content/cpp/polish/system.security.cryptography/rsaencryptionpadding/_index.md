...
description: Tryb wypełnienia i parametry dla operacji szyfrowania lub odszyfrowywania RSA.
type: docs
weight: 482
url: /pl/system.security.cryptography/rsaencryptionpadding/
---
## RSAEncryptionPadding klasa

Tryb wypełnienia i parametry dla [RSA](../rsa/) operacji szyfrowania lub odszyfrowywania.
...
| Metoda | Opis |
| --- | --- |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [CreateOaep](./createoaep/)(const [HashAlgorithmName](../hashalgorithmname/)\&) | Tworzy [RSAEncryptionPadding](./) w trybie OAEP i określonym algorytmie skrótu. |
...
| [RSAEncryptionPaddingMode](../rsaencryptionpaddingmode/) [get_Mode](./get_mode/)() const | Pobiera tryb wypełnienia. |
| const [HashAlgorithmName](../hashalgorithmname/)\& [get_OaepHashAlgorithm](./get_oaephashalgorithm/)() const | Pobiera algorytm skrótu używany z OAEP. |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [get_OaepSHA1](./get_oaepsha1/)() | Pobiera tryb OAEP z algorytmem skrótu [SHA1](../sha1/). |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [get_OaepSHA256](./get_oaepsha256/)() | Pobiera tryb OAEP z algorytmem skrótu [SHA256](../sha256/). |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [get_OaepSHA384](./get_oaepsha384/)() | Pobiera tryb OAEP z algorytmem skrótu [SHA384](../sha384/). |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [get_OaepSHA512](./get_oaepsha512/)() | Pobiera tryb OAEP z algorytmem skrótu [SHA512](../sha512/). |
| static [SharedPtr](../../system/sharedptr/)\<[RSAEncryptionPadding](./)\> [get_Pkcs1](./get_pkcs1/)() | Pobiera tryb PKCS #1 v1.5. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Analog metody C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwersję własnych obiektów do ciągu znaków. |
