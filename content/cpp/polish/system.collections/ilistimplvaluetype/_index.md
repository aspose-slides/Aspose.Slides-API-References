...
description: "Szablon, który implementuje interfejs System::Collections::IList na obiekcie System::Collections::Generic::List. Implementacja dla typów wartościowych."
type: docs
weight: 144
url: /pl/system.collections/ilistimplvaluetype/
---
## IListImplValueType klasa
...
| int [get_Count](./get_count/)() const override | [ICollection.get_Count()](../icollection/get_count/) methods implementation Zwraca liczbę elementów w kolekcji. |
| virtual **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() const | Zwraca wartość wskazującą, czy lista ma stały rozmiar. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia wyliczanie skrótu (hash) własnych obiektów. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(int, int) const override | Zwraca element o podanym indeksie. |
|  [IListImplValueType](./ilistimplvaluetype/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) | Tworzy nową instancję obiektu. |
| int [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const override | Zwraca indeks pierwszego wystąpienia elementu w kontenerze. |
| void [Insert](./insert/)(int, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Wstawia element na określoną pozycję, przesuwając pozostałe elementy. |
