...
description: "Tablica bitów, które mogą być adresowane indeksem. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciem operatora new, ponieważ spowoduje to błędy w czasie wykonania i/lub awarie asercji. Zawsze owijaj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu funkcjom."
type: docs
weight: 1
url: /pl/system.collections/bitarray/
---
## BitArray klasa


[Array](../../system/array/) bitów, które mogą być adresowane indeksem. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonania i/lub awarie asercji. Zawsze owijaj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji.
...
| Metoda | Opis |
| --- | --- |
| void [Add](./add/)(const **bool**\&) override | Dodaje wartość na koniec kontenera. |
| [BitArrayPtr](../bitarrayptr/) [And](./and/)(const [BitArrayPtr](../bitarrayptr/)\&) | Oblicza bitowe 'and' pomiędzy dwoma BitSetami. |
...
| [BitArray](./bitarray/)(const [bitset](./bitset/)\&) | Konstruktor kopiujący. |
| [BitArray](./bitarray/)(const [BitArray](./)\&) | Konstruktor kopiujący. |
| [BitArray](./bitarray/)(const [BitArrayPtr](../bitarrayptr/)\&) | Konstruktor kopiujący. |
| [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**bool**\>\&) | Konstruktor kopiujący. |
| [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Konstruktor kopiujący. |
| [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<int\>\&) | Konstruktor kopiujący. |
| [BitArray](./bitarray/)(int, **bool**) | Konstruktor wypełniający. |
...
| **bool** [Contains](./contains/)(const **bool**\&) const override | Sprawdza, czy określona wartość jest obecna w kontenerze. Niezaimplementowane. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<**bool**\>, int) override | Kopiuje dane do istniejących elementów tablicy. |
| [bitset](./bitset/)\& [data](./data/)() | Dostęp do wewnętrznej struktury danych. |
| const [bitset](./bitset/)\& [data](./data/)() const | Dostęp do wewnętrznej struktury danych. |
...
| **bool** [Get](./get/)(int) const | Zwraca element [BitArray](./). |
| int [get_Count](./get_count/)() const override | Zwraca rozmiar kontenera. |
...
| int [get_Length](./get_length/)() const | Zwraca rozmiar kontenera. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<**bool**\>\> [GetEnumerator](./getenumerator/)() override | Tworzy obiekt enumeratora. |
...
| **bool** [idx_get](./idx_get/)(int) const | Funkcja pobierająca. |
| void [idx_set](./idx_set/)(int, **bool**) | Funkcja ustawiająca. |
...
| [BitArrayPtr](../bitarrayptr/) [Not](./not/)() | Neguje BitSet. |
| [Object](../../system/object/object/)() | Tworzy obiekt. Inicjalizuje wszystkie wewnętrzne struktury danych. |
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje nic, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
| **bool** [operator!=](./operator_not_equal/)(const [BitArray](./)\&) const | Operator porównania bitowego. |
...
| **bool** [operator==](./operator_equal_equal/)(const [BitArray](./)\&) const | Operator porównania bitowego. |
| **Reference** [operator[]](./operator[]/)(int) | Funkcja dostępowa. |
| [BitArrayPtr](../bitarrayptr/) [Or](./or/)(const [BitArrayPtr](../bitarrayptr/)\&) | Oblicza bitowe 'or' pomiędzy dwoma BitSetami. |
...
| **bool** [Remove](./remove/)(const **bool**\&) override | Zwraca pierwsze wystąpienie określonej wartości. Niezaimplementowane. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza współdzielony licznik referencji o określoną wartość. |
| void [Set](./set/)(int, **bool**) | Ustawia element [BitArray](./). |
| void [SetAll](./setall/)(**bool**) | Ustawia wszystkie elementy na określoną wartość. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Formalna implementacja mechanizmu słabych argumentów szablonu; nie ma zastosowania do tej klasy. |
...
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Zwraca implementację iteratora begin const dla bieżącego kontenera. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Zwraca implementację iteratora begin dla bieżącego kontenera. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Zwraca implementację iteratora end const dla bieżącego kontenera. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Zwraca implementację iteratora end dla bieżącego kontenera. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| [BitArrayPtr](../bitarrayptr/) [Xor](./xor/)(const [BitArrayPtr](../bitarrayptr/)\&) | Oblicza bitowe 'xor' pomiędzy dwoma BitSetami. |
...
| Definicja typu | Opis |
| --- | --- |
| [bitset](./bitset/) | Typ danych bazowych. |
...
int main()
{
  // Tworzy nową instancję klasy BitArray.
