...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)() override | Otacza element matematyczny nawiasami |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Otacza element matematyczny określonymi znakami, takimi jak nawiasy lub innymi znakami jako obramowanie |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() override | Argument bazowy |
| **bool** [get_HideBottom](./get_hidebottom/)() override | Ukrywa dolną krawędź (default is false) - określa ukryty lub widoczny stan dolnej krawędzi ramki. |
| **bool** [get_HideLeft](./get_hideleft/)() override | Ukrywa lewą krawędź (default is false) - określa ukryty lub widoczny stan lewej krawędzi ramki. |
| **bool** [get_HideRight](./get_hideright/)() override | Ukrywa prawą krawędź (default is false) - określa ukryty lub widoczny stan prawej krawędzi ramki. |
| **bool** [get_HideTop](./get_hidetop/)() override | Ukrywa górną krawędź (default is false) - określa ukryty lub widoczny stan górnej krawędzi ramki. |
| **bool** [get_StrikethroughBottomLeftToTopRight](./get_strikethroughbottomlefttotopright/)() override | Przekreślenie od dolnego-lewego do górnego-prawego (default is false). Określa ukryty lub widoczny stan przekreślonej linii ukośnej od lewego dolnego rogu do prawego górnego rogu ramki. |
| **bool** [get_StrikethroughHorizontal](./get_strikethroughhorizontal/)() override | Przekreślenie poziome (default is false) - określa ukryty lub widoczny stan przekreślonej linii poziomej. |
| **bool** [get_StrikethroughTopLeftToBottomRight](./get_strikethroughtoplefttobottomright/)() override | Przekreślenie od górnego-lewego do dolnego-prawego (default is false). Określa ukryty lub widoczny stan przekreślonej linii ukośnej od lewego górnego rogu do prawego dolnego rogu ramki. |
| **bool** [get_StrikethroughVertical](./get_strikethroughvertical/)() override | Przekreślenie pionowe (default is false) - określa ukryty lub widoczny stan przekreślonej linii pionowej. |
...
|  [MathBorderBox](./mathborderbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Tworzy element [MathBorderBox](./) z prostokątną ramką |
|  [MathBorderBox](./mathborderbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | Tworzy element [MathBorderBox](./) |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Określa pierwiastek matematyczny danego stopnia z podanego argumentu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | Określa pierwiastek matematyczny danego stopnia z podanego argumentu. |
...
| void [set_HideBottom](./set_hidebottom/)(**bool**) override | Ukrywa dolną krawędź (default is false) - określa ukryty lub widoczny stan dolnej krawędzi ramki. |
| void [set_HideLeft](./set_hideleft/)(**bool**) override | Ukrywa lewą krawędź (default is false) - określa ukryty lub widoczny stan lewej krawędzi ramki. |
| void [set_HideRight](./set_hideright/)(**bool**) override | Ukrywa prawą krawędź (default is false) - określa ukryty lub widoczny stan prawej krawędzi ramki. |
| void [set_HideTop](./set_hidetop/)(**bool**) override | Ukrywa górną krawędź (default is false) - określa ukryty lub widoczny stan górnej krawędzi ramki. |
| void [set_StrikethroughBottomLeftToTopRight](./set_strikethroughbottomlefttotopright/)(**bool**) override | Przekreślenie od dolnego-lewego do górnego-prawego (default is false). Określa ukryty lub widoczny stan przekreślonej linii ukośnej od lewego dolnego rogu do prawego górnego rogu ramki. |
| void [set_StrikethroughHorizontal](./set_strikethroughhorizontal/)(**bool**) override | Przekreślenie poziome (default is false) - określa ukryty lub widoczny stan przekreślonej linii poziomej. |
| void [set_StrikethroughTopLeftToBottomRight](./set_strikethroughtoplefttobottomright/)(**bool**) override | Przekreślenie od górnego-lewego do dolnego-prawego (default is false). Określa ukryty lub widoczny stan przekreślonej linii ukośnej od lewego górnego rogu do prawego dolnego rogu ramki. |
| void [set_StrikethroughVertical](./set_strikethroughvertical/)(**bool**) override | Przekreślenie pionowe (default is false) - określa ukryty lub widoczny stan przekreślonej linii pionowej. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLeftSubSuperscriptElement](../imathleftsubsuperscriptelement/)\> [SetSubSuperscriptOnTheLeft](../mathelementbase/setsubsuperscriptontheleft/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Tworzy indeks dolny i górny po lewej |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLeftSubSuperscriptElement](../imathleftsubsuperscriptelement/)\> [SetSubSuperscriptOnTheLeft](../mathelementbase/setsubsuperscriptontheleft/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Tworzy indeks dolny i górny po lewej |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRightSubSuperscriptElement](../imathrightsubsuperscriptelement/)\> [SetSubSuperscriptOnTheRight](../mathelementbase/setsubsuperscriptontheright/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Tworzy indeks dolny i górny po prawej |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRightSubSuperscriptElement](../imathrightsubsuperscriptelement/)\> [SetSubSuperscriptOnTheRight](../mathelementbase/setsubsuperscriptontheright/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Tworzy indeks dolny i górny po prawej |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zwiększa licznik współdzielonych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego należy używać inteligentnych wskaźników lub ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Zmniejsza i zwraca licznik współdzielonych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego należy używać inteligentnych wskaźników lub ThisProtector. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Umieszcza ten element w niewidzialnym pudełku (grupowaniu logicznym) używanym do grupowania składników równania lub innego fragmentu tekstu matematycznego. Obiekt w ramce może (na przykład) służyć jako emulator operatora z lub bez punktu wyrównania, służyć jako punkt łamania linii lub być grupowany tak, aby nie dopuszczać do łamania linii wewnątrz. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowywanie statementu C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego należy używać inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego należy używać inteligentnych wskaźników lub ThisProtector. |
