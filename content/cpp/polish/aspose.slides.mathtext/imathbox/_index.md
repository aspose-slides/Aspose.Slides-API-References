...
description: Określa logiczne opakowywanie (pakowanie) elementu matematycznego. Na przykład, obiekt w ramce może służyć jako emulator operatora z lub bez punktu wyrównania, jako punkt podziału wiersza lub być grupowany w taki sposób, aby nie dopuszczać do podziałów wierszy wewnątrz. Na przykład operator \"==\" powinien być opakowany, aby zapobiec podziałom wierszy.
type: docs
weight: 170
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Wywołuje określoną funkcję, używając tej instancji jako argumentu |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::String](../../system/string/)) | Wywołuje określoną funkcję, używając tej instancji jako argumentu |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfOneArgument](../mathfunctionsofoneargument/)) | Wywołuje określoną funkcję, używając tej instancji jako argumentu |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Wywołuje określoną funkcję, używając tej instancji jako argumentu i podanego dodatkowego argumentu |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) | Wywołuje określoną funkcję, używając tej instancji jako argumentu i podanego dodatkowego argumentu |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Otacza ten element podanymi znakami, takimi jak nawiasy lub inne znaki ramkowe |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Wywołuje funkcję argumentu, używając tej instancji jako nazwy funkcji |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | Wywołuje funkcję argumentu, używając tej instancji jako nazwy funkcji |
| virtual **bool** [get_AlignmentPoint](./get_alignmentpoint/)() | Gdy true, ten emulator operatora służy jako punkt wyrównania; oznacza to, że wyznaczone punkty wyrównania w innych równaniach mogą być z nim wyrównane. Domyślnie: false |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | Argument bazowy |
| virtual **bool** [get_Differential](./get_differential/)() | Różniczka. Gdy true, pole działa jako różniczka (np. \\uD835\\uDC51\\uDC65 w całce) i otrzymuje odpowiednie odstępy poziome dla różniczki matematycznej. Domyślnie: false |
| virtual **uint8_t** [get_ExplicitBreak](./get_explicitbreak/)() | Jawny podział określa, czy na początku obiektu Box występuje podział wiersza, tak aby linia łamała się przy początku obiektu. Określa numer operatora w poprzedniej linii tekstu matematycznego, który ma być użyty jako punkt wyrównania dla bieżącej linii tekstu matematycznego. możliwe wartości: 1..255 Domyślnie: 0 (brak jawnego podziału) |
| virtual **bool** [get_NoBreak](./get_nobreak/)() | Brak podziału. To właściwość określająca „niełamiącość” obiektu. Gdy true, w obrębie pola nie mogą wystąpić podziały wiersza. Może być istotne dla emulatorów operatorów składających się z więcej niż jednego operatora binarnego. Gdy element nie jest określony, podziały mogą wystąpić wewnątrz pola. Domyślnie: true |
| virtual **bool** [get_OperatorEmulator](./get_operatoremulator/)() | Emulator operatora. Gdy true, pole i jego zawartość zachowują się jak pojedynczy operator i dziedziczą właściwości operatora. Oznacza to, że znak może służyć jako punkt podziału wiersza i może być wyrównany do innych operatorów. Emulatory operatorów są często używane, gdy jeden lub więcej glifów łączy się w operator, np. '=='. Domyślna wartość: false |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogiczna metoda do C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia haszowanie obiektów własnych. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Określa pierwiastek matematyczny danego stopnia z podanego argumentu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Określa pierwiastek matematyczny danego stopnia z podanego argumentu. |
...
| virtual void [set_AlignmentPoint](./set_alignmentpoint/)(**bool**) | Gdy true, ten emulator operatora służy jako punkt wyrównania; ... Domyślnie: false |
| virtual void [set_Differential](./set_differential/)(**bool**) | Różniczka. Gdy true, pole działa jako różniczka (np. \\uD835\\uDC51\\uDC65 w całce) i otrzymuje odpowiednie odstępy poziome dla różniczki matematycznej. Domyślnie: false |
| virtual void [set_ExplicitBreak](./set_explicitbreak/)(**uint8_t**) | Jawny podział określa, czy na początku obiektu Box występuje podział wiersza, tak aby linia łamała się przy początku obiektu. Określa numer operatora w poprzedniej linii tekstu matematycznego... Domyślnie: 0 (brak jawnego podziału) |
| virtual void [set_NoBreak](./set_nobreak/)(**bool**) | Brak podziału. To właściwość określająca „niełamiącość” obiektu... Domyślnie: true |
| virtual void [set_OperatorEmulator](./set_operatoremulator/)(**bool**) | Emulator operatora. Gdy true, pole i jego zawartość zachowują się jak pojedynczy operator... Domyślna wartość: false |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Ustawia dolną granicę |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::String](../../system/string/)) | Ustawia dolną granicę |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Ustawia górną granicę |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::String](../../system/string/)) | Ustawia górną granicę |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](./)\> [ToBox](../imathelement/tobox/)() | Umieszcza ten element w niewidzialnym polu (grupowanie logiczne), które służy do grupowania komponentów równania lub innego fragmentu tekstu matematycznego. Obiekt w ramce może (np.) służyć jako emulator operatora z lub bez punktu wyrównania, jako punkt podziału wiersza, lub być grupowany tak, aby nie zezwalać na podziały wiersza wewnątrz. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabego odwołania. Nie powinno być wywoływane bezpośrednio; zamiast tego używaj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabego odwołania. Nie powinno być wywoływane bezpośrednio; zamiast tego używaj inteligentnych wskaźników lub ThisProtector. |
