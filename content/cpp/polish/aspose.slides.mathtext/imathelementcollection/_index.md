...
| Metoda | Opis |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Dodaje element matematyczny na koniec kolekcji. |
...
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Określa, czy kolekcja zawiera określoną wartość. |
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>\>, **int32_t**) | Kopiuje do określonej tablicy. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Zwraca liczbę elementów faktycznie zawartych w kolekcji. Tylko do odczytu **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca element pod podanym indeksem. Tylko do odczytu [IMathElement](../imathelement/). |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Określa indeks określonego elementu matematycznego w kolekcji. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Wstawia element matematyczny do kolekcji pod podanym indeksem. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Zwraca pierwszy element sekwencji spełniający warunek albo wartość domyślną, jeśli taki element nie zostanie znaleziony. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_OfType](../../system.collections.generic/ienumerable/linq_oftype/)() | Filtrować elementy sekwencji w oparciu o określony typ. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Pomiń określoną liczbę kolejnych elementów od początku sekwencji i zwróć resztę. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu czujnego [LockContext](../../system/lockcontext/). |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Usuwa pierwsze wystąpienie określonego obiektu z kolekcji. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu czujnego [LockContext](../../system/lockcontext/). |
