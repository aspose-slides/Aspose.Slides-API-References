...
description: "Określa N-ary obiekt matematyczny, taki jak Summation i Integral. Składa się z operatora, bazy (lub operandu) oraz opcjonalnych górnych i dolnych granic. Przykłady N-ary operatorów są: Summation, Union, Intersection, Integral"
type: docs
weight: 976
...
Określa N-arny obiekt matematyczny, taki jak Sumowanie i Całka. Składa się z operatora, bazy (lub operandu) oraz opcjonalnych górnych i dolnych granic. Przykłady operatorów N-arnych: Sumowanie, Suma, Przecięcie, Całka
...
| **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() override | Znak operatora rośnie pionowo, aby dopasować się do wysokości swojego operandu |
| **bool** [get_HideSubscript](./get_hidesubscript/)() override | Ukryj indeks dolny |
| **bool** [get_HideSuperscript](./get_hidesuperscript/)() override | Ukryj indeks górny |
| [MathLimitLocations](../mathlimitlocations/) [get_LimitLocation](./get_limitlocation/)() override | Lokalizacja ograniczeń (indeks dolny i górny) |
| char16_t [get_Operator](./get_operator/)() override | Znak operatora N-ary, np.: '\\u2211', '\\u222B' |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Subscript](./get_subscript/)() override | Określa argument indeksu dolnego, który np. w przypadku całki ustawia dolną granicę |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Superscript](./get_superscript/)() override | Określa argument indeksu górnego, który np. w przypadku całki ustawia górną granicę |
...
|  [MathNaryOperator](./mathnaryoperator/)(char16_t, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inicjalizuje nową instancję klasy [MathNaryOperator](./). |
|  [MathNaryOperator](./mathnaryoperator/)(char16_t, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inicjalizuje nową instancję klasy [MathNaryOperator](./). |
|  [MathNaryOperator](./mathnaryoperator/)(char16_t, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inicjalizuje nową instancję klasy [MathNaryOperator](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Nary](../mathelementbase/nary/)([MathNaryOperatorTypes](../mathnaryoperatortypes/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Tworzy operator N-ary |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Nary](../mathelementbase/nary/)([MathNaryOperatorTypes](../mathnaryoperatortypes/), [System::String](../../system/string/), [System::String](../../system/string/)) override | Tworzy operator N-ary |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Określa pierwiastek matematyczny zadanej stopni z określonego argumentu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | Określa pierwiastek matematyczny zadanej stopni z określonego argumentu. |
...
| void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) override | Znak operatora rośnie pionowo, aby dopasować się do wysokości swojego operandu |
| void [set_HideSubscript](./set_hidesubscript/)(**bool**) override | Ukryj indeks dolny |
| void [set_HideSuperscript](./set_hidesuperscript/)(**bool**) override | Ukryj indeks górny |
| void [set_LimitLocation](./set_limitlocation/)([MathLimitLocations](../mathlimitlocations/)) override | Lokalizacja ograniczeń (indeks dolny i górny) |
| void [set_Operator](./set_operator/)(char16_t) override | Znak operatora N-ary, np.: '\\u2211', '\\u222B' |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Umieszcza ten element w niewizualnym pudełku (grupowanie logiczne), które służy do grupowania komponentów równania lub innego fragmentu tekstu matematycznego. Obiekt w pudełku może (na przykład) działać jako emulator operatora z punktem wyrównania lub bez niego, pełnić rolę punktu łamania linii lub być grupowany w sposób uniemożliwiający wstawianie łamań linii wewnątrz. |
