...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Otacza ten element określonymi znakami, takimi jak nawiasy lub innymi znakami jako obramowanie |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\> [get_Format](./get_format/)() | Właściwości formatowania tekstu |
| virtual [System::String](../../system/string/) [get_Value](./get_value/)() | Wartość tekstowa |
...
| virtual void [set_Value](./set_value/)([System::String](../../system/string/)) | Wartość tekstowa |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n-ą argument szablonu jako słaby wskaźnik (zamiast współdzielonego). Pozwala przełączać wskaźniki w kontenerach na tryb słaby. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)() | Umieszcza ten element w ramce obramowania |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | Umieszcza ten element w ramce obramowania |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Umieszcza ten element w niewidzialnym pudełku (logiczne grupowanie), które służy do grupowania składników równania lub innego wystąpienia tekstu matematycznego. Obiekt w pudełku może (na przykład) służyć jako emulator operatora z lub bez punktu wyrównania, służyć jako punkt łamania linii lub być grupowany tak, aby nie zezwalał na łamanie linii wewnątrz. |
