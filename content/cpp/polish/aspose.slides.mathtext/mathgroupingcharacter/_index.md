...
description: Określa symbol grupujący powyżej lub poniżej wyrażenia, zazwyczaj podkreślający zależności między elementami
type: docs
weight: 885
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Przyjmuje określoną funkcję, używając tego egzemplarza jako argumentu |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([System::String](../../system/string/)) override | Przyjmuje określoną funkcję, używając tego egzemplarza jako argumentu |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfOneArgument](../mathfunctionsofoneargument/)) override | Przyjmuje określoną funkcję, używając tego egzemplarza jako argumentu |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Przyjmuje określoną funkcję, używając tego egzemplarza jako argumentu oraz określony dodatkowy argument |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) override | Przyjmuje określoną funkcję, używając tego egzemplarza jako argumentu i określony dodatkowy argument |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Otacza element matematyczny podanymi znakami, takimi jak nawiasy lub inne znaki ramkowe |
...
| char16_t [get_Character](./get_character/)() override | Domyślna wartość znaku grupującego: U+23DF (nawias klamrowy dolny) |
| [MathTopBotPositions](../mathtopbotpositions/) [get_Position](./get_position/)() override | Pozycja znaku grupującego. Domyślna: Bottom |
| [MathTopBotPositions](../mathtopbotpositions/) [get_VerticalJustification](./get_verticaljustification/)() override | Wyrównanie pionowe znaku grupującego. Określa wyrównanie obiektu względem linii podstawowej. Na przykład, gdy znak grupujący znajduje się nad obiektem, VerticalJustification ustawione na Top oznacza, że górna krawędź obiektu leży na linii podstawowej; gdy VerticalJustification jest ustawione na Bottom, dolna krawędź obiektu leży na linii podstawowej Domyślne: Bottom dla Position=Top oraz Top dla Position=Bottom |
...
|  [MathGroupingCharacter](./mathgroupingcharacter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Inicjalizuje nową instancję klasy [MathGroupingCharacter](./) z domyślnym znakiem grupującym U+23DF (BOTTOM CURLY BRACKET) |
|  [MathGroupingCharacter](./mathgroupingcharacter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | Inicjalizuje nową instancję klasy [MathGroupingCharacter](./). |
...
| void [set_Character](./set_character/)(char16_t) override | Domyślna wartość znaku grupującego: U+23DF (nawias klamrowy dolny) |
| void [set_Position](./set_position/)([MathTopBotPositions](../mathtopbotpositions/)) override | Pozycja znaku grupującego. Domyślna: Bottom |
| void [set_VerticalJustification](./set_verticaljustification/)([MathTopBotPositions](../mathtopbotpositions/)) override | Wyrównanie pionowe znaku grupującego. Określa wyrównanie obiektu względem linii podstawowej. Na przykład, gdy znak grupujący znajduje się nad obiektem, VerticalJustification ustawione na Top oznacza, że górna krawędź obiektu leży na linii podstawowej; gdy VerticalJustification jest ustawione na Bottom, dolna krawędź obiektu leży na linii podstawowej Domyślne: Bottom dla Position=Top oraz Top dla Position=Bottom |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Umieszcza ten element w niewizualnym pudełku (logiczna grupowanie), które służy do grupowania komponentów równania lub innego fragmentu tekstu matematycznego. Obiekt w pudełku może (na przykład) służyć jako emulator operatora z lub bez punktu wyrównania, służyć jako punkt zerwania linii, lub być grupowany tak, aby nie pozwalał na złamanie linii wewnątrz. |
