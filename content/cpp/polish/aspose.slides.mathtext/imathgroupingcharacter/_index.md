...
description: Określa symbol grupujący powyżej lub poniżej wyrażenia, zazwyczaj w celu podkreślenia zależności między elementami
type: docs
weight: 326
url: /pl/aspose.slides.mathtext/imathgroupingcharacter/
---
## IMathGroupingCharacter klasa

Określa symbol grupujący nad lub pod wyrażeniem, zazwyczaj w celu podkreślenia zależności między elementami
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Otacza ten element określonymi znakami, takimi jak nawiasy lub inne znaki ramki |
...
| virtual char16_t [get_Character](./get_character/)() | Domyślna wartość znaku grupowania: U+23DF (BOTTOM CURLY BRACKET) |
| virtual [MathTopBotPositions](../mathtopbotpositions/) [get_Position](./get_position/)() | Pozycja znaku grupowania. Domyślnie: Bottom |
| virtual [MathTopBotPositions](../mathtopbotpositions/) [get_VerticalJustification](./get_verticaljustification/)() | Wyrównanie pionowe znaku grupującego. Określa wyrównanie obiektu względem linii bazowej. Na przykład, gdy znak grupujący znajduje się powyżej obiektu, wyrównanie pionowe Top oznacza, że górna krawędź obiektu znajduje się na linii bazowej; gdy wyrównanie pionowe ustawione jest na Bottom, dolna krawędź obiektu znajduje się na linii bazowej. Domyślnie: Bottom dla Position=Top oraz Top dla Position=Bottom |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](./)\> [Group](../imathelement/group/)() | Umieszcza ten element w grupie przy użyciu dolnego nawiasu klamrowego |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](./)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | Umieszcza ten element w grupie przy użyciu znaku grupującego, takiego jak dolny nawias klamrowy lub inny |
...
| virtual void [set_Character](./set_character/)(char16_t) | Domyślna wartość znaku grupowania: U+23DF (BOTTOM CURLY BRACKET) |
| virtual void [set_Position](./set_position/)([MathTopBotPositions](../mathtopbotpositions/)) | Pozycja znaku grupowania. Domyślnie: Bottom |
| virtual void [set_VerticalJustification](./set_verticaljustification/)([MathTopBotPositions](../mathtopbotpositions/)) | Wyrównanie pionowe znaku grupującego. Określa wyrównanie obiektu względem linii bazowej. Na przykład, gdy znak grupujący znajduje się powyżej obiektu, wyrównanie pionowe Top oznacza, że górna krawędź obiektu znajduje się na linii bazowej; gdy wyrównanie pionowe ustawione jest na Bottom, dolna krawędź obiektu znajduje się na linii bazowej. Domyślnie: Bottom dla Position=Top oraz Top dla Position=Bottom |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Umieszcza ten element w nie-wizualnym pudełku (grupowanie logiczne), które służy do grupowania komponentów równania lub innego fragmentu tekstu matematycznego. Obiekt w pudełku może (na przykład) pełnić rolę emulatora operatora z lub bez punktu wyrównania, służyć jako punkt łamania linii lub być grupowany w taki sposób, aby nie dopuszczać do łamania linii wewnątrz. |
