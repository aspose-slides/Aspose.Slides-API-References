...
description: Określa obiekt Limit, składający się z tekstu na linii podstawowej oraz zmniejszonego tekstu bezpośrednio powyżej lub poniżej niego.
type: docs
weight: 365
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje określoną funkcję używającą tego wystąpienia jako argument |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::String](../../system/string/)) | Przyjmuje określoną funkcję używającą tego wystąpienia jako argument |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfOneArgument](../mathfunctionsofoneargument/)) | Przyjmuje określoną funkcję używającą tego wystąpienia jako argument |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje określoną funkcję używającą tego wystąpienia jako argument oraz określony dodatkowy argument |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) | Przyjmuje określoną funkcję używającą tego wystąpienia jako argument oraz określony dodatkowy argument |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)() | Otacza element matematyczny nawiasem |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Otacza ten element określonymi znakami, takimi jak nawiasy lub innymi znakami jako ramkę |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje funkcję argumentu używającą tego wystąpienia jako nazwę funkcji |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | Przyjmuje funkcję argumentu używającą tego wystąpienia jako nazwę funkcji |
...
| virtual **bool** [get_UpperLimit](./get_upperlimit/)() | Określa górny lub dolny limit |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../imathelement/join/)([System::String](../../system/string/)) | Łączy element matematyczny i tworzy blok matematyczny |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. W rzeczywistości nic nie kopiuje, tylko inicjalizuje nowy obiekt i umożliwia konstrukcję kopiowania podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. W rzeczywistości nic nie kopiuje, tylko inicjalizuje nowy obiekt i umożliwia konstrukcję kopiowania podklas. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../imathelement/overbar/)() | Ustawia belkę na górze tego elementu |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Określa pierwiastek matematyczny danej stopnia z określonego argumentu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Określa pierwiastek matematyczny danej stopnia z określonego argumentu. |
...
| virtual void [set_UpperLimit](./set_upperlimit/)(**bool**) | Określa górny lub dolny limit |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje dolny limit |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::String](../../system/string/)) | Przyjmuje dolny limit |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje górny limit |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](./)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::String](../../system/string/)) | Przyjmuje górny limit |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)() | Umieszcza ten element w ramce granicznej |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../imathelement/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | Umieszcza ten element w ramce granicznej |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Umieszcza ten element w nie-wizualnym pudełku (logiczne grupowanie), które służy do grupowania komponentów równania lub innego fragmentu tekstu matematycznego. Obiekt w pudełku może (na przykład) pełnić rolę emulatora operatora z lub bez punktu wyrównania, służyć jako punkt przerwania linii lub być grupowany w taki sposób, aby nie zezwalał na przerwania linii wewnątrz. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Underbar](../imathelement/underbar/)() | Ustawia belkę na dole tego elementu |
