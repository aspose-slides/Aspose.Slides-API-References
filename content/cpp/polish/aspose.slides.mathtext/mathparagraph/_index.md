...
Akapit matematyczny, który jest kontenerem dla bloków matematycznych ([IMathBlock](../imathblock/))
...
| Method | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Dodaje [IMathBlock](../imathblock/) do końca kolekcji. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Zwraca iterator wskazujący na pierwszy element oznaczony jako stały (jeśli istnieje) w kolekcji. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Zwraca iterator wskazujący tuż za ostatnim stałym elementem (jeśli istnieje) w kolekcji. |
| void [Clear](./clear/)() override | Usuwa wszystkie elementy z kolekcji. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Określa, czy kolekcja zawiera określoną wartość. |
| [iterator](./iterator/) [end](./end/)() | Zwraca iterator wskazujący tuż za ostatnim elementem (jeśli istnieje) w kolekcji. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Zwraca iterator wskazujący tuż za ostatnim elementem (jeśli istnieje) w stałej wersji kolekcji. |
...
| [MathJustification](../mathjustification/) [get_Justification](./get_justification/)() override | [Paragraph](../../aspose.slides/paragraph/) Justowanie Domyślna wartość: CenteredAsGroup |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca element o podanym indeksie. Tylko do odczytu [IMathBlock](../imathblock/). |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Zwraca element o podanym indeksie. Tylko do odczytu [IMathBlock](../imathblock/). |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Określa indeks określonego [IMathBlock](../imathblock/) w kolekcji. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Wstawia [IMathBlock](../imathblock/) do kolekcji pod podanym indeksem. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę C# lock(). Wywołuj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
|  [MathParagraph](./mathparagraph/)() | Inicjalizuje nową instancję klasy [MathParagraph](./). |
|  [MathParagraph](./mathparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Inicjalizuje nową instancję klasy [MathParagraph](./). |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Usuwa pierwsze wystąpienie określonego obiektu z kolekcji/>. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Usuwa element pod podanym indeksem w kolekcji. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza licznik współdzielonych referencji o podaną wartość. |
| void [set_Justification](./set_justification/)([MathJustification](../mathjustification/)) override | [Paragraph](../../aspose.slides/paragraph/) Justowanie Domyślna wartość: CenteredAsGroup |
...
| [System::String](../../system/string/) [ToLatex](./tolatex/)() override | Zwraca równanie matematyczne w formacie LaTeX. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie C# lock(). Wywołuj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) w kolekcji. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Zwraca iterator wskazujący tuż za ostatnim elementem (jeśli istnieje) stałej wersji kolekcji. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Zwraca iterator wskazujący tuż za ostatnim elementem (jeśli istnieje) w kolekcji. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabych referencji. Nie powinno być wywoływane bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabych referencji. Nie powinno być wywoływane bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Zapisuje zawartość tego [MathParagraph](./) jako MathML. |
...
* Klasa [IMathParagraph](../imathparagraph/)
