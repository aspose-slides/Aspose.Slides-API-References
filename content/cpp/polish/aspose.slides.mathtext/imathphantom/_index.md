...
description: "Reprezentuje fantomowy obiekt matematyczny (<m:phant>), który wpływa na układ jego elementu potomnego, niekoniecznie wyświetlając go. Fantom może ukrywać swoją podstawową wyrażenie, zachowując jednocześnie szerokość, wysokość lub głębokość w celu wyrównania wzorów lub zarezerwowania miejsca. Widoczność i zachowanie geometrii są kontrolowane przez właściwości takie jak Show, ZeroWid, ZeroAsc, ZeroDesc i Transp."
type: docs
weight: 482
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje określoną funkcję używającą tej instancji jako argument |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::String](../../system/string/)) | Przyjmuje określoną funkcję używającą tej instancji jako argument |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfOneArgument](../mathfunctionsofoneargument/)) | Przyjmuje określoną funkcję używającą tej instancji jako argument |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje określoną funkcję używającą tej instancji jako argument oraz określony dodatkowy argument |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) | Przyjmuje określoną funkcję używającą tej instancji jako argument oraz określony dodatkowy argument |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Umieszcza ten element w określonych znakach, takich jak nawiasy lub inne znaki jako ramka |
...
| virtual **bool** [get_Show](./get_show/)() | Pobiera wartość wskazującą, czy element bazowy jest wyświetlany. |
| virtual **bool** [get_Transp](./get_transp/)() | Pobiera wartość wskazującą, czy fantom jest przezroczysty dla reguł odstępów opartych na klasie. |
| virtual **bool** [get_ZeroAsc](./get_zeroasc/)() | Pobiera wartość wskazującą, czy wzniesienie (wysokość powyżej linii bazowej) elementu bazowego powinno być traktowane jako zero. |
| virtual **bool** [get_ZeroDesc](./get_zerodesc/)() | Pobiera wartość wskazującą, czy spadek (głębokość poniżej linii bazowej) elementu bazowego powinno być traktowane jako zero. |
| virtual **bool** [get_ZeroWidth](./get_zerowidth/)() | Pobiera wartość wskazującą, czy szerokość elementu bazowego powinna być traktowana jako zero. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../imathelement/integral/)([MathIntegralTypes](../mathintegraltypes/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Pobiera całkę |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Określa pierwiastek matematyczny danego stopnia z określonego argumentu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Określa pierwiastek matematyczny danego stopnia z określonego argumentu. |
...
| virtual void [set_Show](./set_show/)(**bool**) | Ustawia wartość wskazującą, czy element bazowy jest wyświetlany. |
| virtual void [set_Transp](./set_transp/)(**bool**) | Ustawia wartość wskazującą, czy fantom jest przezroczysty dla reguł odstępów opartych na klasie. |
| virtual void [set_ZeroAsc](./set_zeroasc/)(**bool**) | Ustawia wartość wskazującą, czy wzniesienie (wysokość powyżej linii bazowej) elementu bazowego powinno być traktowane jako zero. |
| virtual void [set_ZeroDesc](./set_zerodesc/)(**bool**) | Ustawia wartość wskazującą, czy spadek (głębokość poniżej linii bazowej) elementu bazowego powinno być traktowane jako zero. |
| virtual void [set_ZeroWidth](./set_zerowidth/)(**bool**) | Ustawia wartość wskazującą, czy szerokość elementu bazowego powinna być traktowana jako zero. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Umieszcza ten element w nie-wizualnym pudełku (logiczne grupowanie), które służy do grupowania komponentów równania lub innego wystąpienia tekstu matematycznego. Obiekt w ramce może (na przykład) służyć jako emulator operatora z lub bez punktu wyrównania, jako punkt przerwania linii, lub być grupowany tak, aby nie zezwalać na przerwy wierszy wewnątrz. |
