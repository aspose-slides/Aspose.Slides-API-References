...
description: Określa funkcję pierwiastkową, składającą się z podstawy i opcjonalnego stopnia. Przykładem obiektu pierwiastka jest \\u221A\\uD835\\uDC65.
type: docs
weight: 508
...
Określa funkcję pierwiastkową, składającą się z podstawy i opcjonalnego stopnia. Przykład obiektu pierwiastka to \\u221A\\uD835\\uDC65.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje określoną funkcję, używając tego wystąpienia jako argumentu |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::String](../../system/string/)) | Przyjmuje określoną funkcję, używając tego wystąpienia jako argumentu |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfOneArgument](../mathfunctionsofoneargument/)) | Przyjmuje określoną funkcję, używając tego wystąpienia jako argumentu |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje określoną funkcję, używając tego wystąpienia jako argumentu oraz określony dodatkowy argument |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) | Przyjmuje określoną funkcję, używając tego wystąpienia jako argumentu oraz określony dodatkowy argument |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Otacza ten element w określonych znakach, takich jak nawiasy lub inne znaki, jako ramkę |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje funkcję argumentu, używając tego wystąpienia jako nazwy funkcji |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | Przyjmuje funkcję argumentu, używając tego wystąpienia jako nazwy funkcji |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | Argument podstawowy |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Degree](./get_degree/)() | Argument stopnia |
| virtual **bool** [get_HideDegree](./get_hidedegree/)() | Ukrywa stopień. Gdy jest prawda, stopień nie jest wyświetlany, tak jak w \\u221A\\uD835\\uDC65 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Określa pierwiastek matematyczny o podanym stopniu z określonego argumentu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Określa pierwiastek matematyczny o podanym stopniu z określonego argumentu. |
...
| virtual void [set_HideDegree](./set_hidedegree/)(**bool**) | Ukrywa stopień. Gdy jest prawda, stopień nie jest wyświetlany, tak jak w \\u221A\\uD835\\uDC65 |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje dolną granicę |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../imathelement/setlowerlimit/)([System::String](../../system/string/)) | Przyjmuje dolną granicę |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Przyjmuje górną granicę |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetUpperLimit](../imathelement/setupperlimit/)([System::String](../../system/string/)) | Przyjmuje górną granicę |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Umieszcza ten element w niewidzialnym pudełku (grupowanie logiczne), które służy do grupowania składników równania lub innego fragmentu tekstu matematycznego. Obiekt w pudełku może (na przykład) służyć jako emulator operatora z lub bez punktu wyrównania, jako punkt podziału linii lub być grupowany tak, aby nie zezwalał na podziały linii w jego wnętrzu. |
