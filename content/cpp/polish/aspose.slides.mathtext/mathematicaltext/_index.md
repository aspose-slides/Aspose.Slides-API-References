...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Otacza element matematyczny określonymi znakami, takimi jak nawiasy lub inne znaki, jako ramkę |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\> [get_Format](./get_format/)() override | Właściwości formatowania tekstu |
| [System::String](../../system/string/) [get_Value](./get_value/)() override | Wartość tekstowa |
...
|  [MathematicalText](./mathematicaltext/)(char16_t) | Tworzy [MathText](../) z pojedynczym symbolem |
|  [MathematicalText](./mathematicaltext/)([System::String](../../system/string/)) | Tworzy [MathematicalText](./) z tekstu |
|  [MathematicalText](./mathematicaltext/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\>) | Tworzy [MathematicalText](./) z tekstu i ustawień formatowania |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Określa pierwiastek matematyczny stopnia określonego z podanego argumentu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | Określa pierwiastek matematyczny stopnia określonego z podanego argumentu. |
...
| void [set_Value](./set_value/)([System::String](../../system/string/)) override | Wartość tekstowa |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zwiększa licznik współdzielonej referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Zmniejsza i zwraca licznik współdzielonej referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)() override | Umieszcza ten element w border-box |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) override | Umieszcza ten element w border-box |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Umieszcza ten element w niewidzialnym polu (grupowanie logiczne), które służy do grupowania komponentów równania lub innego fragmentu tekstu matematycznego. Obiekt w polu może (na przykład) pełnić rolę emulacji operatora z lub bez punktu wyrównania, służyć jako punkt podziału linii lub być grupowany tak, aby nie zezwalać na podziały linii wewnątrz. |
