...
description: "Opakowuje określony kontener, umożliwiając dostęp w trybie tylko do odczytu. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami czasu wykonywania i/lub naruszeniami asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji."
type: docs
weight: 27
url: /pl/system.collections.objectmodel/readonlycollection/
---
## ReadOnlyCollection klasa
...
| **bool** [Contains](./contains/)(const T\&) const override | Sprawdza, czy kontener zawiera określony element. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Kopiuje elementy kontenera do istniejących elementów tablicy. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, gdzie dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równe żadnej wartości, włączając NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, gdzie dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równe żadnej wartości, włączając NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Tylko do użytku wewnętrznego. |
| int [get_Count](./get_count/)() const override | Zwraca liczbę elementów kontenera. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Sprawdza, czy kolekcja ma stały rozmiar. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Sprawdza, czy kolekcja jest tylko do odczytu. |
...
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Zwraca enumerator kolekcji. |
...
| int [IndexOf](./indexof/)(const T\&) const override | Wyszukuje określony element w kolekcji. |
...
| [ReadOnlyCollection](./readonlycollection/)(const [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\>\&) | Opakowuje kolekcję tylko do odczytu wokół konkretnej kolekcji. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Nic nie robi, ponieważ kolekcja tylko do odczytu jedynie opakowuje dane i nie przechowuje nic. |
...
| [IEnumeratorPtr](./ienumeratorptr/) | Kontener tych samych elementów. |
