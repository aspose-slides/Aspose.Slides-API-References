...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Pobiera wypełnienie znacznika. Tylko do odczytu [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | Reprezentuje rozmiar znacznika w wykresie liniowym, wykresie punktowym lub radarowym. Odczyt **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | Reprezentuje styl znacznika w wykresie liniowym, wykresie punktowym lub radarowym. Odczyt [MarkerStyleType](../markerstyletype/). |
...
| void [set_Size](./set_size/)(**int32_t**) override | Reprezentuje rozmiar znacznika w wykresie liniowym, wykresie punktowym lub radarowym. Zapisz **int32_t**. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | Reprezentuje styl znacznika w wykresie liniowym, wykresie punktowym lub radarowym. Zapisz [MarkerStyleType](../markerstyletype/). |
