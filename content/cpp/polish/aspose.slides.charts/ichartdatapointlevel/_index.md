...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Reprezentuje właściwości formatowania poziomu punktu danych. Przeczytaj [IFormat](../iformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | Reprezentuje etykietę danych poziomu punktu danych. Stosowane dla typów serii Treemap i Sunburst. Tylko do odczytu [IDataLabel](../idatalabel/). |
