...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | Zwraca format dolnych pasków. Tylko do odczytu [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | Zwraca szerokość przerwy. Odczyt **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | Określa, czy wykres ma paski góra/dół. Odczyt **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | Zwraca format górnych pasków. Tylko do odczytu [IFormat](../iformat/). |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | Ustawia szerokość przerwy. Zapis **int32_t**. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | Określa, czy wykres ma paski góra/dół. Zapis **bool**. |
