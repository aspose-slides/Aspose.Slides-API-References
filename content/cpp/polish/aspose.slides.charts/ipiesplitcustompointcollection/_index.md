...
description: Reprezentuje kolekcję punktów, które mają być rysowane w drugim okręgu lub słupku na wykresie słupkowo-kołowym lub kołowo-słupkowym z niestandardowym podziałem.
type: docs
weight: 1158
url: /pl/aspose.slides.charts/ipiesplitcustompointcollection/
---
## IPieSplitCustomPointCollection klasa

Reprezentuje kolekcję punktów, które mają być rysowane w drugim okręgu lub słupku na wykresie słupkowo-kołowym lub kołowo-słupkowym z niestandardowym podziałem.
...
| Metoda | Opis |
| --- | --- |
| virtual void [Add](./add/)(const **int32_t**\&) | Dodaje punkt danych według jego indeksu w kolekcji punktów serii nadrzędnej. |
...
| virtual **bool** [Contains](../../system.collections.generic/icollection/contains/)(const T\&) const | Sprawdza, czy element jest obecny w kolekcji. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca punkt danych wykresu według indeksu. |
...
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)([ICollection](../../system.collections.generic/icollection/)\&&) | Operator przypisania ruchomego. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)(const [ICollection](../../system.collections.generic/icollection/)\&) | Operator przypisania ruchomego. |
...
| virtual void [Remove](./remove/)(**int32_t**) | Usuwa element z kolekcji za pomocą jego indeksu w kolekcji punktów serii nadrzędnej. |
