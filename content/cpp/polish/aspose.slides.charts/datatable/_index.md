...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Zwraca style linii, wypełnienia i efektów obiektu. Tylko do odczytu [IFormat](../iformat/). |
| **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() override | Prawda, jeśli tabela danych wykresu ma poziome obramowania komórek. Odczyt **bool**. |
| **bool** [get_HasBorderOutline](./get_hasborderoutline/)() override | Prawda, jeśli tabela danych wykresu ma obramowanie konturu. Odczyt **bool**. |
| **bool** [get_HasBorderVertical](./get_hasbordervertical/)() override | Prawda, jeśli tabela danych wykresu ma pionowe obramowania komórek. Odczyt **bool**. |
| **bool** [get_ShowLegendKey](./get_showlegendkey/)() override | Prawda, jeśli klucz legendy etykiety danych jest widoczny. Odczyt **bool**. |
...
| void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) override | Prawda, jeśli tabela danych wykresu ma poziome obramowania komórek. Zapis **bool**. |
| void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) override | Prawda, jeśli tabela danych wykresu ma obramowanie konturu. Zapis **bool**. |
| void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) override | Prawda, jeśli tabela danych wykresu ma pionowe obramowania komórek. Zapis **bool**. |
| void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) override | Prawda, jeśli klucz legendy etykiety danych jest widoczny. Zapis **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Ustawia n't argument szablonu jako słaby wskaźnik (zamiast współdzielonego). Umożliwia przełączanie wskaźników w kontenerach na tryb słaby. |
