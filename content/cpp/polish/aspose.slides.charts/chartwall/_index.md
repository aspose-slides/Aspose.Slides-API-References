...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Zwraca wypełnienie ściany, linię, efekt, style 3D. Tylko do odczytu [IFormat](../iformat/). |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | Zwraca lub ustawia typ obrazu. Odczyt [Charts::PictureType](../picturetype/). |
| **int32_t** [get_Thickness](./get_thickness/)() override | Zwraca grubość ścian jako procent największego wymiaru objętości wykresu. Tylko do odczytu **int32_t**. |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | Zwraca lub ustawia typ obrazu. Zapis [Charts::PictureType](../picturetype/). |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | Ustawia grubość ścian jako procent największego wymiaru objętości wykresu. Zapis **int32_t**. |
