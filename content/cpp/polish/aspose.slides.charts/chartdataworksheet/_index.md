...
description: Reprezentuje arkusz powiązany z IChartDataCell
type: docs
weight: 209
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Tylko dla celów wewnętrznych. |
| **int32_t** [get_Index](./get_index/)() override | Pobiera indeks arkusza. Tylko do odczytu **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Zwraca nazwę arkusza. Tylko do odczytu [System::String](../../system/string/). |
...
* Klasa [IChartDataWorksheet](../ichartdataworksheet/)
