...
description: Reprezentuje znacznik chert.
type: docs
weight: 1119
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Pobiera wypełnienie znacznika. Tylko do odczytu [IFormat](../iformat/). |
| virtual **int32_t** [get_Size](./get_size/)() | Reprezentuje rozmiar znacznika w wykresie liniowym, wykresie punktowym lub radarowym. Odczyt **int32_t**. |
| virtual [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() | Reprezentuje styl znacznika w wykresie liniowym, wykresie punktowym lub radarowym. Odczyt [MarkerStyleType](../markerstyletype/). |
...
| virtual void [set_Size](./set_size/)(**int32_t**) | Reprezentuje rozmiar znacznika w wykresie liniowym, wykresie punktowym lub radarowym. Zapis **int32_t**. |
| virtual void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) | Reprezentuje styl znacznika w wykresie liniowym, wykresie punktowym lub radarowym. Zapis [MarkerStyleType](../markerstyletype/). |
