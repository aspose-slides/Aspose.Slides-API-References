...
Reprezentuje kolekcję [Trendline](../trendline/)
...
| Metoda | Opis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [Add](./add/)([TrendlineType](../trendlinetype/)) override | Dodaje nowy [Trendline](../trendline/) na koniec kolekcji i zwraca go. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Zwraca iterator wskazujący na pierwszy element oznaczony jako stały (jeśli istnieje) kolekcji. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie oznaczonym jako stały (jeśli istnieje) kolekcji. |
| [iterator](./iterator/) [end](./end/)() | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) kolekcji. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie stałej instancji (jeśli istnieje) kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator iterujący po kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca element o podanym indeksie. Tylko do odczytu [Trendline](../trendline/). |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Mapuje każdy element sekwencji i łączy uzyskane sekwencje w jedną. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\>) override | Usuwa podaną wartość. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza licznik współdzielonych referencji o podaną wartość. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Ustawia n-ty argument szablonu jako słaby wskaźnik (zamiast współdzielonego). Pozwala na zmianę wskaźników w kontenerach na tryb słaby. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementuje i zwraca licznik współdzielonych referencji. Nie powinno być wywoływane bezpośrednio; używaj inteligentnych wskaźników lub ThisProtector. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementuje licznik słabych referencji. Nie powinno być wywoływane bezpośrednio; używaj inteligentnych wskaźników lub ThisProtector. |
...
* Klasa [ITrendlineCollection](../itrendlinecollection/)
