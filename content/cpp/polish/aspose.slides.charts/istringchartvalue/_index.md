...
description: "Reprezentuje wartość tekstową, którą można przechowywać w dokumencie prezentacji pptx na dwa sposoby: 1) w komórce/komórkach skoroszytu powiązanego z wykresem; 2) jako wartość dosłowną."
type: docs
weight: 1197
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](../imultiplecellchartvalue/get_ascell/)(**int32_t**) | Zwraca komórkę wykresu pod wskazanym indeksem. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [get_AsCells](../imultiplecellchartvalue/get_ascells/)() | Zwraca kolekcję komórek wykresu. Czytaj [IChartCellCollection](../ichartcellcollection/). |
| virtual [System::String](../../system/string/) [get_AsLiteralString](./get_asliteralstring/)() | Zwraca łańcuch dosłowny, jeśli właściwość DataSourceType ma wartość [DataSourceType::StringLiterals](../datasourcetype/). Czytaj [System::String](../../system/string/). |
...
| virtual [System::String](../../system/string/) [GetCellsAddressInWorkbook](./getcellsaddressinworkbook/)() | Jeśli właściwość DataSourceType ma wartość [DataSourceType::Worksheet](../datasourcetype/), metoda zwraca adres komórek w skoroszycie, które reprezentują dane tekstowe. W przeciwnym razie zwraca pusty łańcuch. |
...
| virtual void [set_AsCells](../imultiplecellchartvalue/set_ascells/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>) | Ustawia kolekcję komórek wykresu. Zapisz [IChartCellCollection](../ichartcellcollection/). |
| virtual void [set_AsLiteralString](./set_asliteralstring/)([System::String](../../system/string/)) | Ustawia łańcuch dosłowny, jeśli właściwość DataSourceType ma wartość [DataSourceType::StringLiterals](../datasourcetype/). Zapisz [System::String](../../system/string/). |
...
| virtual void [SetFromOneCell](./setfromonecell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Ustawia wartość z określonej komórki. |
...
* Klasa [IMultipleCellChartValue](../imultiplecellchartvalue/)
