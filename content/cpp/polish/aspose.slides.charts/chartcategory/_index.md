...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() override | Zwraca obiekt [IChartDataCell](../ichartdatacell/). Jeśli kategoria jest wielopoziomowa, używany jest obiekt [IChartDataCell](../ichartdatacell/) dla poziomu "0". Odczyt [IChartDataCell](../ichartdatacell/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_AsLiteral](./get_asliteral/)() override | Zwraca obiekt AsLiteral. Odczyt [System::Object](../../system/object/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_GroupingLevel](./get_groupinglevel/)(**int32_t**) override | Zwraca poziom grupowania kategorii wykresu o podanym indeksie. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)\> [get_GroupingLevels](./get_groupinglevels/)() override | Zarządzany kontener wartości poziomów grupowania kategorii wykresu. Kategoria wielopoziomowa zawiera więcej niż jeden poziom grupowania. Indeksowanie poziomów grupowania jest zerowe. [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/) tylko do odczytu. |
| **bool** [get_UseCell](./get_usecell/)() override | Jeśli true, właściwość AsCell jest aktualna. Innymi słowy, arkusz jest używany do przechowywania kategorii (przypadek ten obsługuje kategorię wielopoziomową). Jeśli false, właściwość AsLiteral jest aktualna. Innymi słowy, arkusz NIE jest używany do przechowywania kategorii (i ten przypadek nie obsługuje kategorii wielopoziomowych). **bool** tylko do odczytu. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | Jeśli UseCell jest true, właściwość reprezentuje właściwość [get_AsCell()](./get_ascell/)->get(set)_Value(). Jeśli UseCell jest false, właściwość reprezentuje właściwość AsLiteral. Odczyt [System::Object](../../system/object/). |
...
| void [Remove](./remove/)() override | Usuwa kategorię z wykresu. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza współdzielony licznik referencji o określoną wartość. |
| void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Ustawia obiekt [IChartDataCell](../ichartdatacell/). Jeśli kategoria jest wielopoziomowa, używany jest obiekt [IChartDataCell](../ichartdatacell/) dla poziomu "0". Zapis [IChartDataCell](../ichartdatacell/). |
| void [set_AsLiteral](./set_asliteral/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Ustawia obiekt AsLiteral. Zapis [System::Object](../../system/object/). |
| void [set_Value](./set_value/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Jeśli UseCell jest true, właściwość reprezentuje właściwość [get_AsCell()](./get_ascell/)->get(set)_Value(). Jeśli UseCell jest false, właściwość reprezentuje właściwość AsLiteral. Zapis [System::Object](../../system/object/). |
