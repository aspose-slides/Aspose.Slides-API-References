...
description: Reprezentuje poziom punktu danych. Stosowany w wykresach Treemap i Sunburst.
type: docs
weight: 170
...
Reprezentuje poziom punktu danych. Stosowany w wykresach Treemap i Sunburst chart.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Reprezentuje właściwości formatowania poziomu punktu danych. Odczyt [IFormat](../iformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() override | Reprezentuje etykietę danych poziomu punktu danych. Stosowany dla typów serii Treemap i Sunburst. Tylko do odczytu [IDataLabel](../idatalabel/). |
...
* Klasa [IChartDataPointLevel](../ichartdatapointlevel/)
