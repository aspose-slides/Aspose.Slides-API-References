...
description: Reprezentuje kolekcję ChartCategory
type: docs
weight: 79
...
| Metoda | Opis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Jeśli kategoria istnieje w kolekcji, zwraca ją. W przeciwnym razie tworzy nową kategorię wykresu z [IChartDataCell](../ichartdatacell/) i dodaje ją do kolekcji. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Tworzy nowy [ChartCategory](../chartcategory/) z wartości i dodaje go do kolekcji. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Zwraca iterator wskazujący na pierwszy element oznaczony const (jeśli istnieje) kolekcji. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Zwraca iterator wskazujący zaraz po ostatnim elemencie oznaczonym const (jeśli istnieje) kolekcji. |
| void [Clear](./clear/)() override | Usuwa wszystkie elementy z kolekcji. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>, **int32_t**) override | Kopiuje wszystkie elementy kolekcji do określonej tablicy. |
...
| **int32_t** [get_Count](./get_count/)() override | Zwraca liczbę elementów w kolekcji. Tylko do odczytu **int32_t**. |
| **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() override | Zwraca liczbę poziomów grupowania kategorii. Jest większa niż jeden dla wielopoziomowych kategorii. Tylko do odczytu **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Zwraca wartość wskazującą, czy dostęp do Listy jest zsynchronizowany (wątkowo bezpieczny). Tylko do odczytu **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Zwraca obiekt, który może być użyty do synchronizacji dostępu do kolekcji. Tylko do odczytu [System::Object](../../system/object/). |
| **bool** [get_UseCells](./get_usecells/)() override | Jeśli true, to arkusz jest używany do przechowywania kategorii (przypadek wspiera wielopoziomowe kategorie). Jeśli false, to arkusz NIE jest używany do przechowywania wartości (i ten przypadek nie wspiera wielopoziomowych kategorii). Odczyt **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator iterujący po kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca element pod wskazanym indeksem. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | Wyszukuje określony [ChartCategory](../chartcategory/) i zwraca indeks zerowy pierwszego wystąpienia w całej kolekcji. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | Usuwa określoną wartość. |
...
| void [set_UseCells](./set_usecells/)(**bool**) override | Jeśli true, to arkusz jest używany do przechowywania kategorii (przypadek wspiera wielopoziomowe kategorie). Jeśli false, to arkusz NIE jest używany do przechowywania wartości (i ten przypadek nie wspiera wielopoziomowych kategorii). Zapis **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Ustawia n-ty argument szablonu jako wskaźnik słaby (zamiast współdzielonego). Umożliwia przełączanie wskaźników w kontenerach na tryb słaby. |
