...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Zwraca iterator wskazujący zaraz po ostatnim elemencie (jeśli istnieje) w kolekcji. Ten iterator nie może być używany do zmiany wskazywanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący zaraz po ostatnim elemencie (jeśli istnieje) stałej (const) wersji kolekcji. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Zwraca liczbę wszystkich etykiet danych w kolekcji. Tylko do odczytu **int32_t**. |
| virtual **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() | Zwraca liczbę widocznych etykiet danych w kolekcji. Tylko do odczytu **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() | Zwraca domyślny format wszystkich etykiet danych w kolekcji. Tylko do odczytu [IDataLabelFormat](../idatalabelformat/). |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | Fałsz oznacza, że etykieta danych nie jest widoczna domyślnie (a więc wszystkie flagi Show* (ShowValue, ...) właściwości DefaultDataLabelFormat są ustawione na fałsz). Tylko do odczytu **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() | Reprezentuje format linii prowadzących etykiet danych. Tylko do odczytu [IChartLinesFormat](../ichartlinesformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() | Zwraca serię rodzica wykresu. Tylko do odczytu [IChartSeries](../ichartseries/). |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Zwraca strukturę danych licznika referencji związanego z obiektem. |
...
| virtual void [Hide](./hide/)() | Ukrywa etykietę danych domyślnie, ustawiając wszystkie flagi Show* (ShowValue, ...) właściwości DefaultDataLabelFormat na stan fałsz. IsVisible będzie fałszem po wykonaniu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca etykietę danych dla punktu danych o podanym indeksie. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) | Zwraca indeks określonego [DataLabel](../datalabel/) w kolekcji. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformuje każdy element sekwencji w nową postać, uwzględniając indeks elementu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie statement lock() z C#. Wywołaj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/). |
