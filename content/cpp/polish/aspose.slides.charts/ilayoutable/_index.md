...
| virtual **float** [get_Bottom](./get_bottom/)() | Pobiera górną krawędź elementu wykresu jako ułamek wysokości wykresu. Tylko do odczytu **float**. |
...
| virtual **float** [get_Height](./get_height/)() | Określa wysokość elementu wykresu jako ułamek wysokości wykresu. Odczyt **float**. |
...
| virtual **float** [get_Right](./get_right/)() | Pobiera prawą krawędź elementu wykresu jako ułamek szerokości wykresu. Tylko do odczytu **float**. |
...
| virtual **float** [get_Width](./get_width/)() | Określa szerokość elementu wykresu jako ułamek szerokości wykresu. Odczyt **float**. |
| virtual **float** [get_X](./get_x/)() | Określa położenie x (lewo) elementu wykresu jako ułamek szerokości wykresu. Odczyt **float**. |
| virtual **float** [get_Y](./get_y/)() | Określa górną krawędź elementu wykresu jako ułamek wysokości wykresu. Odczyt **float**. |
...
| virtual void [set_Height](./set_height/)(**float**) | Określa wysokość elementu wykresu jako ułamek wysokości wykresu. Zapis **float**. |
| virtual void [set_Width](./set_width/)(**float**) | Określa szerokość elementu wykresu jako ułamek szerokości wykresu. Zapis **float**. |
| virtual void [set_X](./set_x/)(**float**) | Określa położenie x (lewo) elementu wykresu jako ułamek szerokości wykresu. Zapis **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Określa górną krawędź elementu wykresu jako ułamek wysokości wykresu. Zapis **float**. |
