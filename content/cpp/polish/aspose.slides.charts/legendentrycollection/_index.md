...
| **int32_t** [get_Count](./get_count/)() override | Pobiera liczbę pozycji legendy. Tylko do odczytu **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILegendEntryProperties](../ilegendentryproperties/)\> [idx_get](./idx_get/)(**int32_t**) override | Pobiera właściwości pozycji legendy odpowiadającej [Chart::get_ChartData()](../chart/get_chartdata/)->get_Series()[0].DataPoints[index] w przypadku typów wykresów z tej listy: [ChartType::BarOfPie](../charttype/), [ChartType::ExplodedPie](../charttype/), [ChartType::ExplodedPie3D](../charttype/), [ChartType::Pie](../charttype/), [ChartType::Pie3D](../charttype/), [ChartType::PieOfPie](../charttype/); lub odpowiadającej [Chart::get_ChartData()](../chart/get_chartdata/)->get_Series()[index] dla innych typów wykresów. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabych referencji. Nie powinno być wywoływane bezpośrednie; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| virtual [~Object](../../system/object/~object/)() | Niszczy obiekt. Zwalnia wszystkie wewnętrzne struktury danych. |

## Zobacz także

* Klasa [ILegendEntryCollection](../ilegendentrycollection/)
