...
description: Określa wartości słupków błędów. Powinno być używane tylko wtedy, gdy typ wartości słupków błędów jest Custom.
type: docs
weight: 1015
url: /pl/aspose.slides.charts/ierrorbarscustomvalues/
---
## IErrorBarsCustomValues klasa
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() | Określa wartość słupka błędu w kierunku ujemnym. Dostępne, jeśli typ wartości słupków błędów jest Custom i ErrorBarsXFormat jest dozwolone. W każdym innym przypadku ta właściwość zwraca null. Tylko do odczytu [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() | Określa wartość słupka błędu w kierunku dodatnim. Dostępne, jeśli typ wartości słupków błędów jest Custom i ErrorBarsXFormat jest dozwolone. W każdym innym przypadku ta właściwość zwraca null. Tylko do odczytu [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() | Określa wartość słupka błędu w kierunku ujemnym. Dostępne, jeśli typ wartości słupków błędów jest Custom i ErrorBarsYFormat jest dozwolone. W każdym innym przypadku ta właściwość zwraca null. Tylko do odczytu [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() | Określa wartość słupka błędu w kierunku dodatnim. Dostępne, jeśli typ wartości słupków błędów jest Custom i ErrorBarsYFormat jest dozwolone. W każdym innym przypadku ta właściwość zwraca null. Tylko do odczytu [IDoubleChartValue](../idoublechartvalue/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie (unlock()) języka C#. Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
