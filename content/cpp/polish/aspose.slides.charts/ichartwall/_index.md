...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Zwraca wypełnienie ściany, linię, efekt, style 3D. Tylko do odczytu [IFormat](../iformat/). |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | Zwraca lub ustawia typ obrazu. Odczyt [PictureType](../picturetype/). |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | Zwraca grubość ścian jako procent największego wymiaru objętości wykresu. Odczyt **int32_t**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę statementu C# lock(). Wywołaj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/) typu sentry. |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | Zwraca lub ustawia typ obrazu. Zapis [PictureType](../picturetype/). |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | Ustawia grubość ścian jako procent największego wymiaru objętości wykresu. Zapis **int32_t**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie statementu C# lock(). Wywołaj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/) typu sentry. |
