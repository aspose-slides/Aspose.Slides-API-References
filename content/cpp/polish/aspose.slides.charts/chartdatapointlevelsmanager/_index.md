...
description: Kontener poziomów punktów danych. Stosowany w seriach Treeamp i Sunburst. Indeksowanie poziomów punktów danych jest zerowe.
type: docs
weight: 183
...
Kontener poziomów punktów danych. Stosowane dla serii Treeamp i Sunburst. Indeksowanie poziomów punktów danych jest zerowe.
...
| **int32_t** [get_Count](./get_count/)() override | Zwraca liczbę poziomów punktów danych. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPointLevel](../ichartdatapointlevel/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca obiekt [IChartDataPointLevel](../ichartdatapointlevel/) dla określonego poziomu. |
...
* Klasa [IChartDataPointLevelsManager](../ichartdatapointlevelsmanager/)
