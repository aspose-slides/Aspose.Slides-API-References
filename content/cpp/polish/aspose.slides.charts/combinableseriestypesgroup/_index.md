...
description: "Wyliczenie grup łączonych typów serii. Każdy element odnosi się do grupy typów serii wykresu, które mogą współistnieć jednocześnie w jednej ChartSeriesGroup. Na przykład: serie ChartType::PercentsStackedArea nie mogą być jednocześnie z seriami ChartType::StackedArea w jednej ChartSeriesGroup. Jednak dwie lub więcej serii ChartType::PercentsStackedArea mogą znajdować się w jednej ChartSeriesGroup jednocześnie (CombinableSeriesTypesGroup::AreaChart_PercentsStackedArea). A serie ChartType::Line mogą być razem z seriami ChartType::LineWithMarkers w jednej ChartSeriesGroup (CombinableSeriesTypesGroup::LineChart_LineChartSeriesGroup)."
type: docs
weight: 1496
...
Wyliczenie grup łączonych typów serii. Każdy element odnosi się do grupy typów serii wykresu, które mogą współistnieć jednocześnie w jednym [ChartSeriesGroup](../chartseriesgroup/). Na przykład: serie [ChartType::PercentsStackedArea](../charttype/) nie mogą współistnieć jednocześnie z seriami [ChartType::StackedArea](../charttype/) w jednym [ChartSeriesGroup](../chartseriesgroup/). Jednak dwie lub więcej [ChartType::PercentsStackedArea](../charttype/) mogą znajdować się w jednym [ChartSeriesGroup](../chartseriesgroup/) jednocześnie ([CombinableSeriesTypesGroup::AreaChart_PercentsStackedArea](./)). A serie [ChartType::Line](../charttype/) mogą być jednocześnie z seriami [ChartType::LineWithMarkers](../charttype/) w jednym [CombinableSeriesTypesGroup::LineChart_Line](./)[ChartSeriesGroup](../chartseriesgroup/).
