...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Zwraca style linii, wypełnienia i efektów obiektu. Tylko do odczytu [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | Prawda, jeśli tabela danych wykresu ma poziome obramowania komórek. Odczyt **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | Prawda, jeśli tabela danych wykresu ma obramowanie konturu. Odczyt **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | Prawda, jeśli tabela danych wykresu ma pionowe obramowania komórek. Odczyt **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | Prawda, jeśli klucz legendy etykiet danych jest widoczny. Odczyt **bool**. |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | Prawda, jeśli tabela danych wykresu ma poziome obramowania komórek. Zapis **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | Prawda, jeśli tabela danych wykresu ma obramowanie konturu. Zapis **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | Prawda, jeśli tabela danych wykresu ma pionowe obramowania komórek. Zapis **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | Prawda, jeśli klucz legendy etykiet danych jest widoczny. Zapis **bool**. |
