...
description: Reprezentuje kolekcję ChartSeries
type: docs
weight: 287
...
| Metoda | Opis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) override | Tworzy nową serię wykresu i dodaje ją do kolekcji. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) override | Tworzy nową serię wykresu z [ChartDataCell](../chartdatacell/) i dodaje ją do kolekcji. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) override | Tworzy nową serię wykresu z [ChartCellCollection](../chartcellcollection/) i dodaje ją do kolekcji. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) override | Tworzy nową serię wykresu z wartości i dodaje ją do kolekcji. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) stałej wersji kolekcji. |
...
| void [Clear](./clear/)() override | Usuwa wszystkie kontrolki z kolekcji. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>, **int32_t**) override | Kopiuje wszystkie elementy z kolekcji do określonej tablicy. |
...
| **int32_t** [get_Count](./get_count/)() override | Zwraca liczbę obiektów w kolekcji. Tylko do odczytu **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator iterujący po kolekcji. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia haszowanie własnych obiektów. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Pobiera rzeczywisty typ obiektu. Analog wywołania C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [idx_get](./idx_get/)(**int32_t**) override | Pobiera element pod określonym indeksem. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Wyszukuje określony [ChartSeries](../chartseries/) i zwraca indeks zerowy pierwszego wystąpienia w całej kolekcji |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) override | Tworzy nową serię wykresu i wstawia ją do kolekcji. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Określa, czy istnieje element sekwencji lub spełnia warunek. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Usuwa określoną wartość. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Usuwa kontrolkę ActiveX przechowywaną w określonej pozycji z kolekcji. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) stałej kwalifikowanej instancji kolekcji. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Zwraca iterator wskazujący zaraz po ostatnim elemencie (jeśli istnieje) stałej kwalifikowanej instancji kolekcji. |
...
* Klasa [IChartSeriesCollection](../ichartseriescollection/)
