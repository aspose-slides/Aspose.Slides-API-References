...
description: Umożliwia dostęp do pasków górnych/dolnych wykresu liniowego lub giełdowego.
type: docs
weight: 1392
...
Udostępnia dostęp do pasków górnych/dolnych wykresu liniowego lub giełdowego.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() override | Zwraca format DownBars. Tylko do odczytu [IFormat](../iformat/). |
| **int32_t** [get_GapWidth](./get_gapwidth/)() override | GapWidth. Odczyt **int32_t**. |
| **bool** [get_HasUpDownBars](./get_hasupdownbars/)() override | HasUpDownBars. Odczyt **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() override | Zwraca format UpBars. Tylko do odczytu [IFormat](../iformat/). |
...
| void [set_GapWidth](./set_gapwidth/)(**int32_t**) override | GapWidth. Zapis **int32_t**. |
| void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) override | HasUpDownBars. Zapis **bool**. |
...
* Klasa [IUpDownBarsManager](../iupdownbarsmanager/)
