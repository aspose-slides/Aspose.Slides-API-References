...
description: "Implementacja semafora. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject() . Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub błędy asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go do funkcji jako argument."
type: docs
weight: 183
url: /pl/system.threading/semaphore/
---
## Klasa Semaphore

[Semaphore](./) implementacja. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub błędy asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej do funkcji jako argument.
```cpp
...
| int [Release](./release/)() | Zwalnia blokadę semaforu. |
| int [Release](./release/)(int) | Zwalnia wiele blokad na semaforze. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza współdzielony licznik referencji o podaną wartość. |
| virtual **bool** [Reset](./reset/)() | Ustawia semafor w stan niezgłoszony. Nieobsługiwane. |
|  [Semaphore](./semaphore/)(int, int) | Tworzy nienazwany semafor. |
|  [Semaphore](./semaphore/)(int, int, const [String](../../system/string/)\&) | Tworzy nazwany semafor. |
|  [Semaphore](./semaphore/)(int, int, const [String](../../system/string/)\&, **bool**\&) | Tworzy nazwany semafor. |
| virtual **bool** [Set](./set/)() | Ustawia semafor w stan zgłoszony. Nieobsługiwane. |
...
| **bool** [WaitOne](./waitone/)() override | Blokuje semafor. Wykonuje nieograniczone oczekiwanie, jeśli konieczne. |
| **bool** [WaitOne](./waitone/)(int) override | Blokuje semafor. Wykonuje oczekiwanie, jeśli konieczne. |
| virtual **bool** [WaitOne](../waithandle/waitone/)([TimeSpan](../../system/timespan/)) | Czeka, aż uchwyt zostanie wyzwolony. |
...
| Pole | Opis |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Specjalna wartość zwracana przez funkcję, w przeciwnym razie zwracająca indeks zgłoszonego obiektu w tablicy, jeśli limit czasu zostanie przekroczony i nic nie sygnalizuje. |
