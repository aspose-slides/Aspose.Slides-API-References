...
description: API puli wątków umożliwiające wstawianie zadań do kolejki odczytywanej przez pulę wątków pracowniczych. Jest to typ statyczny bez usług instancji. Nie powinno się tworzyć jego instancji w żaden sposób.
type: docs
weight: 222
url: /pl/system.threading/threadpool/
---
## ThreadPool klasa


[Thread](../thread/) pool API umożliwiające wrzucanie zadań do kolejki odczytywanej przez pulę wątków roboczych. To jest typ statyczny bez usług instancji. Nigdy nie powinieneś tworzyć jego instancji żadnym sposobem.
...
| static void [GetAvailableThreads](./getavailablethreads/)(int\&, int\&) | Pobiera liczbę dostępnych wątków. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia haszowanie własnych obiektów. |
| static [ThreadPoolImpl](../threadpoolimpl/)\& [GetInstance](./getinstance/)() | Instancja implementacji, która przechowuje listę zadań oraz inne parametry. |
| static void [GetMaxThreads](./getmaxthreads/)(int\&, int\&) | Pobiera maksymalną liczbę jednoczesnych wątków. |
| static void [GetMinThreads](./getminthreads/)(int\&, int\&) | Pobiera minimalną liczbę wątków tworzonych przez pulę. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Pobiera rzeczywisty typ obiektu. Analog wywołania C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Sprawdza, czy obiekt jest instancją typu opisanego przez targetType. Analog operatora C# 'is'. |
| static void [JoinAllThreads](./joinallthreads/)() | Łączy wszystkie własne wątki. Czeka w nieskończoność. |
...
| void [operator=](./operator_equal/)(const [ThreadPool](./)\&) | Brak kopiowania. |
...
| static **bool** [QueueUserWorkItem](./queueuserworkitem/)([WaitCallback](../waitcallback/)) | Umieszcza element pracy w kolejce, która jest dostępna z wywołaniem zwrotnym bez parametrów. |
| static **bool** [QueueUserWorkItem](./queueuserworkitem/)([WaitCallback](../waitcallback/), const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Umieszcza element pracy w kolejce, która jest dostępna z wywołaniem zwrotnym bez parametrów. |
...
| static **bool** [SetMaxThreads](./setmaxthreads/)(int, int) | Ustawia liczbę wątków posiadanych przez pulę. |
| static **bool** [SetMinThreads](./setminthreads/)(int, int) | Ustawia minimalną liczbę wątków posiadanych przez pulę. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decreases i zwraca licznik współdzielonych referencji. Nie powinno być wywoływane bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
|  [ThreadPool](./threadpool/)(const [ThreadPool](./)\&) | Brak kopiowania. |
