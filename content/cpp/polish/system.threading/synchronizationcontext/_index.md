...
description: Zapewnia podstawową funkcjonalność propagowania kontekstu synchronizacji pomiędzy różnymi operacjami synchronizacyjnymi.
type: docs
weight: 196
url: /pl/system.threading/synchronizationcontext/
---
## SynchronizationContext klasa

Zapewnia podstawową funkcjonalność propagowania kontekstu synchronizacji pomiędzy różnymi operacjami synchronizacyjnymi.
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | Pobiera kontekst synchronizacji dla bieżącego wątku. |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Uruchamia wywołanie zwrotne asynchronicznie. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Uruchamia wywołanie zwrotne synchronicznie. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | Ustawia kontekst synchronizacji dla bieżącego wątku. |
...
|  [SynchronizationContext](./synchronizationcontext/)() | Tworzy nową instancję [SynchronizationContext](./). |
...
Ta klasa umożliwia propagację kontekstu synchronizacji pomiędzy wątkami i jest używana do przekazywania wywołań zwrotnych lub wywołań do odpowiedniego wątku lub kontekstu synchronizacji.  
