...
description: Źródło tokenu anulowania, które może być użyte do wyzwalania powiadomień o anulowaniu.
type: docs
weight: 40
url: /pl/system.threading/cancellationtokensource/
---
## CancellationTokenSource klasa


Źródło tokenu anulowania, które może być użyte do wyzwalania powiadomień o anulowaniu.
...
| Metoda | Opis |
| --- | --- |
| void [Cancel](./cancel/)() | Komunikuje żądanie anulowania. |
| [CancellationTokenSource](./cancellationtokensource/)() | Tworzy nowy [CancellationTokenSource](./). |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | Tworzy połączone źródło tokenu, które jest anulowane, gdy którekolwiek z podanych tokenów zostanie anulowane. |
| void [Dispose](./dispose/)() override | Zwalnia wszystkie zasoby używane przez [CancellationTokenSource](./). |
...
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | Pobiera informację, czy żądanie anulowania zostało zgłoszone. |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | Pobiera token anulowania powiązany z tym źródłem. |
...
Zapewnia mechanizmy tworzenia i kontrolowania tokenów anulowania dla współpracującego anulowania operacji. 
