...
description: Obiekt zwrotny używany przez procedurę importu HTML do uzyskiwania odwoływanych obiektów, takich jak obrazy.
type: docs
weight: 27
url: /pl/aspose.slides.import/htmlexternalresolver/
---
## HtmlExternalResolver klasa


Obiekt wywoływany zwrotny używany przez procedurę importu HTML do uzyskiwania odwoływanych obiektów, takich jak obrazy.
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) override | Mapuje URI na obiekt zawierający rzeczywisty zasób. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę instrukcji C# lock(). Wywołaj bezpośrednio lub użyj [LockContext](../../system/lockcontext/) sentry object. |
...
| [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Rozwiązuje pełny URI z bazowego i względnych URI. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n't-argument szablonu jako słaby wskaźnik (zamiast współdzielonego). Pozwala przełączyć wskaźniki w kontenerach na tryb słaby. |
...
Przestarzałe
:   Przestarzałe. Użyj [ExternalResourceResolver](../externalresourceresolver/) zamiast tego. Zostanie usunięte w wersji 17.12.


Użycie tego resolvera może stworzyć podatność, gdy klient dostarczy plik HTML, który spowoduje, że oprogramowanie serwera uzyska dostęp do lokalnego lub sieciowego pliku. Używaj ostrożnie. Zaleca się nie podawać [HtmlExternalResolver](./) wcale (odczytane zostaną tylko osadzone obiekty) lub utworzyć podklasę, która sprawdza, czy podany URI jest prawidłowy.
## Zobacz także

* Klasa [IHtmlExternalResolver](../ihtmlexternalresolver/)
