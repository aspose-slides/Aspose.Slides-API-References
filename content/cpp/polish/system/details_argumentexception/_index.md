...
description: "ArgumentException jest zgłaszany, gdy argument przekazany do wywoływanej metody jest nieprawidłowy. Nigdy nie twórz ręcznie instancji tej klasy. Użyj zamiast tego klasy ArgumentException. Nigdy nie otaczaj (wrap) instancji klasy ArgumentException w System::SmartPtr."
type: docs
weight: 326
url: /pl/system/details_argumentexception/
---
## Details_ArgumentException klasa

ArgumentException jest zgłaszany, gdy argument przekazany do wywoływanej metody jest nieprawidłowy. Nigdy nie twórz ręcznie instancji tej klasy. Użyj zamiast tego klasy ArgumentException. Nigdy nie otaczaj (wrap) instancji klasy ArgumentException w [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są uważane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są uważane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | Zwraca odwołanie do obiektu reprezentującego wewnętrzny wyjątek. |
...
| void [Lock](../object/lock/)() | Implementuje blokowanie instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu stróża [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor kopiujący. Nie kopiuje nic, naprawdę, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstruktorów podklas. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator przypisania. Nie kopiuje nic, naprawdę, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstruktorów podklas. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Ustawia HRESULT, zakodowaną wartość liczbową, która jest przypisywana do określonego wyjątku. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Zwraca reprezentację ciągu znaków bieżącego obiektu. |
...
| virtual const char * [what](../details_exception/what/)() const | Implementuje metodę [what()](../details_exception/what/), która jest wywoływana przez klasę [ExceptionWrapper](../exceptionwrapper/). Pomimo faktu, że ta klasa nie dziedziczy po std::exception, klasy pochodne mogą używać chronionych/prywatnych członków do implementacji swojej logiki. Przeniesienie implementacji tej metody do [ExceptionWrapper](../exceptionwrapper/) może zburzyć tę logikę. |
| virtual  [~Object](../object/~object/)() | Niszczy obiekt. Zwalnia wszystkie wewnętrzne struktury danych. |

## Uwagi

ArgumentNullException jest zgłaszany, gdy metoda wywoływana otrzymuje argument null, podczas gdy metoda oczekuje wartości nie-null. Nigdy nie twórz ręcznie instancji tej klasy. Użyj zamiast tego klasy ArgumentNullException. Nigdy nie otaczaj (wrap) instancji klasy ArgumentNullException w [System::SmartPtr](../smartptr/). 
