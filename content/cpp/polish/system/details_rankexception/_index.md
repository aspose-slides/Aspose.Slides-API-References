...
description: "RankException jest rzucany, gdy do metody przekazany zostaje argument tablicy o liczbie wymiarów różnej od oczekiwanej. Nigdy nie twórz ręcznie instancji tej klasy. Zamiast tego użyj klasy RankException. Nigdy nie umieszczaj instancji klasy RankException w System::SmartPtr."
type: docs
weight: 677
url: /pl/system/details_rankexception/
---
## Details_RankException klasa


RankException jest rzucany, gdy do metody przekazany zostaje argument tablicy o liczbie wymiarów różnej od oczekiwanej. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy RankException. Nigdy nie umieszczaj instancji klasy RankException w [System::SmartPtr](../smartptr/).
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | Porównuje obiekty typów wartości w stylu C#. |
