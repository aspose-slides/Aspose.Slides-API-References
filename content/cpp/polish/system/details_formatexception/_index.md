...
description: "FormatException jest rzucany, gdy format argumentu metody jest nieprawidłowy. Nigdy nie twórz ręcznie instancji tej klasy. Używaj klasy FormatException. Nigdy nie otaczaj instancji klasy FormatException w System::SmartPtr."
type: docs
weight: 469
url: /pl/system/details_formatexception/
---
## Details_FormatException klasa


FormatException jest rzucany, gdy format argumentu metody jest nieprawidłowy. Nigdy nie twórz ręcznie instancji tej klasy. Używaj zamiast tego klasy FormatException. Nigdy nie otaczaj instancji klasy FormatException w [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor kopiujący. Nie kopiuje niczego, naprawdę, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator przypisania. Nie kopiuje niczego, naprawdę, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
