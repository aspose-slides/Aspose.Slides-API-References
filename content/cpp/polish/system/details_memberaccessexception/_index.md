...
description: "MemberAccessException jest wyrzucany, gdy próbuje się uzyskać dostęp do nieistniejącego członka klasy lub gdy dostęp do członka nie jest dozwolony. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy MemberAccessException. Nigdy nie otaczaj instancji klasy MemberAccessException w System::SmartPtr."
type: docs
weight: 547
url: /pl/system/details_memberaccessexception/
---
## Details_MemberAccessException klasa

MemberAccessException jest rzucany, gdy próbuje się uzyskać dostęp do nieistniejącego członka klasy lub gdy dostęp do członka nie jest dozwolony. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy MemberAccessException. Nigdy nie otaczaj instancji klasy MemberAccessException w [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, gdzie dwa NaN są uważane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, gdzie dwa NaN są uważane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analogiczna metoda C# [Object.GetHashCode()](../object/gethashcode/). Umożliwia haszowanie niestandardowych obiektów. |
...
| void [Lock](../object/lock/)() | Implementuje blokowanie instrukcją C# lock(). Wywołaj bezpośrednio lub użyj obiektu [LockContext](../lockcontext/). |
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analogiczna metoda C# [Object.MemberwiseClone()](../object/memberwiseclone/). Umożliwia klonowanie niestandardowych typów. |
...
| void [Unlock](../object/unlock/)() | Implementuje odblokowanie instrukcją C# lock(). Wywołaj bezpośrednio lub użyj obiektu [LockContext](../lockcontext/). |
