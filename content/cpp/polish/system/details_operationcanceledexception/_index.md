...
description: "OperationCanceledException jest zgłaszany w wątku po anulowaniu operacji, którą wątek wykonywał. Nigdy nie twórz ręcznie instancji tej klasy. Używaj klasy OperationCanceledException. Nigdy nie otaczaj instancji klasy OperationCanceledException obiektem System::SmartPtr."
type: docs
weight: 625
url: /pl/system/details_operationcanceledexception/
---
## Details_OperationCanceledException klasa

OperationCanceledException jest zgłaszany w wątku po anulowaniu operacji, którą wątek wykonywał. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy OperationCanceledException zamiast tego. Nigdy nie otaczaj instancji klasy OperationCanceledException w [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementuje blokadę instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu wartownika [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor kopiujący. Nie kopiuje nic, naprawdę, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator przypisania. Nie kopiuje nic, naprawdę, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
...
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, std::nullptr_t) | Specjalizacja [Object::ReferenceEquals](../object/referenceequals/) dla przypadku łańcucha i nullptr. |
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, [String](../string/) const\&) | Specjalizacja [Object::ReferenceEquals](../object/referenceequals/) dla przypadku łańcuchów. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Ustawia n-ty argument szablonu na słaby wskaźnik (zamiast współdzielonego). Umożliwia przełączanie wskaźników w kontenerach na tryb słaby. |
