...
description: "ArithmeticException jest rzucany, gdy podczas wykonywania operacji arytmetycznych, konwersji lub rzutowania wystąpi błąd. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy ArithmeticException. Nigdy nie otaczaj instancji klasy ArithmeticException w System::SmartPtr."
type: docs
weight: 365
url: /pl/system/details_arithmeticexception/
---
## Details_ArithmeticException klasa


ArithmeticException jest rzucany, gdy podczas wykonywania operacji arytmetycznych, konwersji lub rzutowania wystąpi błąd. Nigdy nie twórz instancji tej klasy ręcznie. Użyj klasy ArithmeticException. Nigdy nie otaczaj instancji klasy ArithmeticException w [System::SmartPtr](../smartptr/).
...
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Zwraca słownik z niestandardowymi danymi wyjątku. |
...
| void [Lock](../object/lock/)() | Implementuje blokowanie instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu nadzorczego [LockContext](../lockcontext/). |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Ustawia HRESULT, zakodowaną wartość numeryczną przypisaną do określonego wyjątku. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Zwraca łańcuchowa reprezentację bieżącego obiektu. |
| static const [System::TypeInfo](../typeinfo/)\& [Type](./type/)() |  |
| void [Unlock](../object/unlock/)() | Implementuje odblokowanie instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu nadzorczego [LockContext](../lockcontext/). |
