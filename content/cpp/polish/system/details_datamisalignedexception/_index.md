...
type: docs
weight: 391
url: /pl/system/details_datamisalignedexception/
---
## Details_DataMisalignedException klasa
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Uzyskuje strukturę danych licznika referencji powiązaną z obiektem. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Uzyskuje rzeczywisty typ obiektu. Analog wywołania C# [System.Object.GetType()](../object/gettype/). |
| **bool** [Is](./is/)(const [System::TypeInfo](../typeinfo/)\&) const override |  |
| void [Lock](../object/lock/)() | Implementuje blokowanie instrukcją C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażniczego [LockContext](../lockcontext/). |
...
| int [SharedCount](../object/sharedcount/)() const | Uzyskuje bieżącą wartość licznika współdzielonych referencji. |
...
| void [Unlock](../object/unlock/)() | Implementuje odblokowanie instrukcją C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażniczego [LockContext](../lockcontext/). |
