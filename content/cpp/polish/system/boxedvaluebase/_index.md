...
description: "Klasa bazowa, która definiuje interfejs i implementuje niektóre podstawowe metody klasy potomnej reprezentującej wartość opakowaną. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub naruszenia asercji. Zawsze owiń tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania jej do funkcji jako argument."
type: docs
weight: 131
url: /pl/system/boxedvaluebase/
---
## BoxedValueBase klasa

Klasa bazowa, która definiuje interfejs i implementuje niektóre podstawowe metody klasy potomnej reprezentującej wartość opakowaną. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub naruszenia asercji. Zawsze otaczaj tę klasę wskaźnikiem [System::SmartPtr](../smartptr/) i używaj tego wskaźnika, aby przekazywać ją do funkcji jako argument.
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równe żadnej wartości, w tym NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równe żadnej wartości, w tym NaN. |
...
| virtual [TypeCode](../typecode/) [GetTypeCode](./gettypecode/)() const | Zwraca wartość reprezentującą typ wartośći opakowanej reprezentowanej przez bieżący obiekt. |
| virtual **uint64_t** [GetUnsignedLongLongValue](./getunsignedlonglongvalue/)() const | Konwertuje opakowaną wartość reprezentowaną przez bieżący obiekt na 64-bitową wartość całkowitą. |
...
| virtual **bool** [IsBoxedEnum](./isboxedenum/)() | Określa, czy bieżący obiekt reprezentuje opakowaną wartość typu wyliczeniowego. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor kopiujący. W rzeczywistości nic nie kopiuje, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstruktorów podklas. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator przypisania. W rzeczywistości nic nie kopiuje, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstruktorów podklas. |
| static [SharedPtr](../sharedptr/)\<[Object](../object/)\> [Parse](./parse/)(const [TypeInfo](../typeinfo/)\&, const [String](../string/)\&, **bool**) | Opakowuje wartość stałej wyliczeniowej określonego wyliczenia o podanej nazwie. Parametr określa, czy przy interpretacji ciągu określającego nazwę stałej wyliczeniowej ma być ignorowana wielkość liter. |
| static [SharedPtr](../sharedptr/)\<[Object](../object/)\> [Parse](./parse/)(const [TypeInfo](../typeinfo/)\&, const [String](../string/)\&) | Opakowuje wartość stałej wyliczeniowej określonego wyliczenia o podanej nazwie. |
...
| [System::String](../string/) [ToString](./tostring/)(const [System::String](../string/)\&) const | Konwertuje opakowany obiekt na ciąg znaków używając podanego łańcucha formatu. |
| virtual [String](../string/) [ToString](./tostring/)() const | Analog metody C# [Object.ToString()](../object/tostring/). Umożliwia konwersję własnych obiektów na ciąg znaków. |
