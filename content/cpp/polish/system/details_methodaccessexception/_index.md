...
description: "MemberAccessException jest rzucany, gdy próbuje się uzyskać dostęp do nieistniejącej metody lub gdy dostęp do metody nie jest dozwolony. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy MethodAccessException zamiast tego. Nigdy nie otaczaj instancji klasy MethodAccessException w System::SmartPtr."
type: docs
weight: 560
url: /pl/system/details_methodaccessexception/
---
## Details_MethodAccessException klasa

MemberAccessException jest rzucany, gdy próbuje się uzyskać dostęp do nieistniejącej metody lub gdy dostęp do metody nie jest dozwolony. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy MethodAccessException zamiast tego. Nigdy nie otaczaj instancji klasy MethodAccessException w [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementuje blokowanie instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażniczego [LockContext](../lockcontext/). |
...
* Klasa [Details_MemberAccessException](../details_memberaccessexception/)
