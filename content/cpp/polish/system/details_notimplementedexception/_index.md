...
description: "NotImplementedException jest rzucany, gdy metoda nie jest zaimplementowana i służy jako szkielet. Nigdy nie twórz ręcznie egzemplarzy tej klasy. Użyj zamiast tego klasy NotImplementedException. Nigdy nie otaczaj egzemplarzy klasy NotImplementedException w System::SmartPtr."
type: docs
weight: 573
url: /pl/system/details_notimplementedexception/
---
## Details_NotImplementedException klasa


NotImplementedException jest rzucany, gdy metoda nie jest zaimplementowana i służy jako szkielet. Nigdy nie twórz ręcznie egzemplarzy tej klasy. Użyj klasy NotImplementedException zamiast tego. Nigdy nie otaczaj egzemplarzy klasy NotImplementedException w [System::SmartPtr](../smartptr/).
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | Zwraca odniesienie do obiektu reprezentującego wewnętrzny wyjątek. |
