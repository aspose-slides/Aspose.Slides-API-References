...
description: "UnauthorizedAccessException jest zgłaszany, gdy dostęp jest odmawiany przez system operacyjny z powodu błędu I/O lub błędu zabezpieczeń. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy UnauthorizedAccessException. Nigdy nie otaczaj instancji klasy UnauthorizedAccessException w System::SmartPtr."
type: docs
weight: 755
url: /pl/system/details_unauthorizedaccessexception/
---
## Details_UnauthorizedAccessException klasa

UnauthorizedAccessException jest zgłaszany, gdy dostęp jest odmawiany przez system operacyjny z powodu błędu I/O lub błędu zabezpieczeń. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy UnauthorizedAccessException. Nigdy nie otaczaj instancji klasy UnauthorizedAccessException w [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementuje blokowanie instrukcją C# lock(). Wywołaj bezpośrednio lub użyj obiektu straży [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor kopiujący. Faktycznie nic nie kopiuje, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstruktorów klas pochodnych. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator przypisania. Faktycznie nic nie kopiuje, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstruktorów klas pochodnych. |
...
| void [Unlock](../object/unlock/)() | Implementuje odblokowanie instrukcją C# lock(). Wywołaj bezpośrednio lub użyj obiektu straży [LockContext](../lockcontext/). |
