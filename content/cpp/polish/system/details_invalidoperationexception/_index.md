...
description: "Wyjątek rzucany, gdy metoda jest wywoływana na obiekcie, który znajduje się w stanie niezgodnym z tym wywołaniem. Nigdy nie twórz ręcznie instancji tej klasy. Użyj zamiast tego klasy InvalidOperationException. Nigdy nie otaczaj instancji klasy InvalidOperationException w System::SmartPtr."
type: docs
weight: 508
url: /pl/system/details_invalidoperationexception/
---
## Details_InvalidOperationException klasa


Wyjątek, który jest rzucany, gdy metoda jest wywoływana na obiekcie, który znajduje się w stanie niezgodnym z tym wywołaniem. Nigdy nie twórz ręcznie instancji tej klasy. Użyj zamiast tego klasy InvalidOperationException. Nigdy nie otaczaj instancji klasy InvalidOperationException w [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementuje blokadę statements lock() z C#. Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../lockcontext/). |
...
| void [Unlock](../object/unlock/)() | Implementuje odblokowanie statementu lock() z C#. Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../lockcontext/). |
