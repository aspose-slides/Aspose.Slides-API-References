...
description: "Definiuje metodę porównującą dwa obiekty. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani nie używaj operatora new, ponieważ może to spowodować błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji."
type: docs
weight: 924
url: /pl/system/icomparable/
---
## IComparable klasa
...
| Parametr | Opis |
| --- | --- |
| T | Typ obiektów, z którymi porównywany jest bieżący obiekt |

## Metody

| Metoda | Opis |
| --- | --- |
| virtual int [CompareTo](./compareto/)(T) | Porównuje bieżący obiekt z określonym obiektem. |
