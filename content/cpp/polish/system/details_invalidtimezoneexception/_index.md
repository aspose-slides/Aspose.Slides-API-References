...
description: "InvalidTimeZoneException jest rzucany, gdy informacje o strefie czasowej są nieprawidłowe. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy InvalidTimeZoneException zamiast tego. Nigdy nie otaczaj instancji klasy InvalidTimeZoneException w System::SmartPtr."
type: docs
weight: 534
url: /pl/system/details_invalidtimezoneexception/
---
## Details_InvalidTimeZoneException klasa

InvalidTimeZoneException jest rzucany, gdy informacje o strefie czasowej są nieprawidłowe. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy InvalidTimeZoneException zamiast tego. Nigdy nie otaczaj instancji klasy InvalidTimeZoneException w [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementuje blokowanie instrukcją C# lock(). Wywołaj bezpośrednio lub użyj obiektu wartownika [LockContext](../lockcontext/). |
...
| void [Unlock](../object/unlock/)() | Implementuje odblokowanie instrukcją C# lock(). Wywołaj bezpośrednio lub użyj obiektu wartownika [LockContext](../lockcontext/). |
