...
description: "InvalidProgramException jest dostępny wyłącznie ze względu na kompatybilność. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy InvalidProgramException zamiast tego. Nigdy nie otaczaj instancji klasy InvalidProgramException w System::SmartPtr."
type: docs
weight: 521
url: /pl/system/details_invalidprogramexception/
---
## Details_InvalidProgramException klasa


InvalidProgramException jest dostępny wyłącznie ze względów zgodności. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy InvalidProgramException zamiast tego. Nigdy nie otaczaj instancji klasy InvalidProgramException w [System::SmartPtr](../smartptr/).
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Ustawia HRESULT, kodowaną wartość numeryczną przypisaną do określonego wyjątku. |
