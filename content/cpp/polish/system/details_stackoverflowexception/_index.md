...
description: "StackOverflowException jest zgłaszany, gdy stos wykonywania wątku przepełnia się. Nigdy nie twórz ręcznie instancji tej klasy. Zamiast tego użyj klasy StackOverflowException. Nigdy nie otaczaj instancji klasy StackOverflowException w System::SmartPtr."
type: docs
weight: 690
url: /pl/system/details_stackoverflowexception/
---
## Details_StackOverflowException klasa


StackOverflowException jest zgłaszany, gdy stos wykonania wątku przepełnia się. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy StackOverflowException zamiast tego. Nigdy nie otaczaj instancji klasy StackOverflowException w [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są uznawane za równe, choć zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są uznawane za równe, choć zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
...
| static **bool** [ReferenceEquals](../object/referenceequals/)([ptr](../object/ptr/) const\&, [ptr](../object/ptr/) const\&) | Porównuje obiekty referencyjnie. |
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, T const\&) | Porównuje obiekty referencyjnie. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Ustawia HRESULT, zakodowaną wartość numeryczną przypisywaną konkretnemu wyjątkowi. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Ustawia n-ty argument szablonu jako słaby wskaźnik (zamiast współdzielonego). Pozwala na przełączenie wskaźników w kontenerach w tryb słaby. |
