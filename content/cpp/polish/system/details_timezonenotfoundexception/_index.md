...
description: "TimeZoneNotFoundException jest wyrzucany, gdy nie można znaleźć informacji o strefie czasowej. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy TimeZoneNotFoundException zamiast tego. Nigdy nie opakowuj instancji klasy TimeZoneNotFoundException w System::SmartPtr."
type: docs
weight: 729
url: /pl/system/details_timezonenotfoundexception/
---
## Details_TimeZoneNotFoundException klasa


TimeZoneNotFoundException jest rzucany, gdy nie można znaleźć informacji o strefie czasowej. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy TimeZoneNotFoundException zamiast tego. Nigdy nie opakowuj instancji klasy TimeZoneNotFoundException w [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor kopiujący. W rzeczywistości nic nie kopiuje, po prostu inicjalizuje nowy obiekt i umożliwia konstrukcję kopiującą podklas. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator przypisania. W rzeczywistości nic nie kopiuje, po prostu inicjalizuje nowy obiekt i umożliwia konstrukcję kopiującą podklas. |
...
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, [String](../string/) const\&) | Specjalizacja [Object::ReferenceEquals](../object/referenceequals/) dla przypadku wielu łańcuchów znaków. |
