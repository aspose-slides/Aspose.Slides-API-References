...
description: "ArgumentOutOfRangeException jest rzucany, gdy wywoływana metoda otrzymuje argument, który wychodzi poza oczekiwany zakres wartości dla tego argumentu. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy ArgumentOutOfRangeException zamiast tego. Nigdy nie opakowuj instancji klasy ArgumentOutOfRangeException w System::SmartPtr."
type: docs
weight: 352
url: /pl/system/details_argumentoutofrangeexception/
---
## Details_ArgumentOutOfRangeException klasa

ArgumentOutOfRangeException jest rzucany, gdy wywoływana metoda otrzymuje argument, który wychodzi poza oczekiwany zakres wartości dla tego argumentu. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy ArgumentOutOfRangeException zamiast tego. Nigdy nie opakowuj instancji klasy ArgumentOutOfRangeException w [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są traktowane jako równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są traktowane jako równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
...
* Klasa [Details_ArgumentException](../details_argumentexception/)
