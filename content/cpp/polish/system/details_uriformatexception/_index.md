...
description: "UriFormatException jest zgłaszany, gdy format URI jest nieprawidłowy. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy UriFormatException zamiast tego. Nigdy nie owijaj instancji klasy UriFormatException w System::SmartPtr."
type: docs
weight: 768
url: /pl/system/details_uriformatexception/
---
## Details_UriFormatException klasa


UriFormatException jest zgłaszany, gdy format URI jest nieprawidłowy. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy UriFormatException zamiast tego. Nigdy nie owijaj instancji klasy UriFormatException w [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Implementuje blokadę (lock()) w stylu C#. Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor kopiujący. Nie kopiuje niczego, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstrukcji podklas. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator przypisania. Nie kopiuje niczego, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstrukcji podklas. |
...
| void [Unlock](../object/unlock/)() | Implementuje odblokowanie (lock()) w stylu C#. Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../lockcontext/). |
...
* Klasa [Details_FormatException](../details_formatexception/)
