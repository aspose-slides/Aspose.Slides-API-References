...
description: "NotSupportedException jest rzucany, gdy wywoływana metoda nie jest obsługiwana lub gdy operacja wykonywana na strumieniu nie jest obsługiwana. Nigdy nie twórz ręcznie instancji tej klasy. Zamiast tego użyj klasy NotSupportedException. Nigdy nie osadzaj instancji klasy NotSupportedException w System::SmartPtr."
type: docs
weight: 586
url: /pl/system/details_notsupportedexception/
---
## Details_NotSupportedException klasa

NotSupportedException jest rzucany, gdy wywoływana metoda nie jest obsługiwana lub gdy operacja wykonana na strumieniu nie jest obsługiwana. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy NotSupportedException. Nigdy nie osadzaj instancji klasy NotSupportedException w [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, w którym dwa NaN są uważane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, w którym dwa NaN są uważane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
