...
description: "IndexOutOfRangeException jest rzucany, gdy dostęp do elementu kolekcji jest podejmowany przy użyciu indeksu spoza jego zakresu. Nigdy nie twórz ręcznie instancji tej klasy. Zamiast tego użyj klasy IndexOutOfRangeException. Nigdy nie otaczaj instancji klasy IndexOutOfRangeException w System::SmartPtr."
type: docs
weight: 482
url: /pl/system/details_indexoutofrangeexception/
---
## Details_IndexOutOfRangeException klasa

IndexOutOfRangeException jest rzucany, gdy dostęp do elementu kolekcji jest podejmowany przy użyciu indeksu spoza jego zakresu. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy IndexOutOfRangeException. Nigdy nie owijaj instancji klasy IndexOutOfRangeException w [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, w którym dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, łącznie z NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, w którym dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, łącznie z NaN. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor kopiujący. W rzeczywistości nie kopiuje nic, tylko inicjalizuje nowy obiekt i umożliwia kopiowanie w podklasach. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator przypisania. W rzeczywistości nie kopiuje nic, tylko inicjalizuje nowy obiekt i umożliwia kopiowanie w podklasach. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Zwraca łańcuchową reprezentację bieżącego obiektu. |
