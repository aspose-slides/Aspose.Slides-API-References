...
description: "InvalidCastException jest rzucany, gdy podejmowana jest nieprawidłowa operacja rzutowania niepoprawnej konwersji jawnej. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy InvalidCastException zamiast tego. Nigdy nie umieszczaj instancji klasy InvalidCastException w System::SmartPtr."
type: docs
weight: 495
url: /pl/system/details_invalidcastexception/
---
## Details_InvalidCastException klasa


InvalidCastException jest rzucany, gdy próbowana jest nieprawidłowa operacja rzutowania niepoprawnej konwersji jawnej. Nigdy nie twórz ręcznie instancji tej klasy. Użyj klasy InvalidCastException zamiast tego. Nigdy nie otaczaj instancji InvalidCastException klasy w [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są traktowane jako równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są traktowane jako równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | Tylko do użytku wewnętrznego. |
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Zwraca słownik z danymi własnego wyjątku. |
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Zwraca 32-bitową wartość całkowitą będącą kodem HRESULT skojarzonym z wyjątkiem reprezentowanym przez bieżący obiekt. |
...
| virtual [String](../string/) [get_Message](../details_exception/get_message/)() const | Zwraca łańcuch znaków zawierający opis błędu. |
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Zwraca łańcuch znaków zawierający ślad stosu. |
...
| void [Lock](../object/lock/)() | Implementuje blokowanie instrukcji C# lock(). Wywołuj bezpośrednio lub użyj obiektu strażnika [LockContext](../lockcontext/). |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Ustawia HRESULT, zakodowaną wartość liczbową przypisaną do określonego wyjątku. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Zwraca tekstową reprezentację bieżącego obiektu. |
| static const [System::TypeInfo](../typeinfo/)\& [Type](./type/)() |  |
| void [Unlock](../object/unlock/)() | Implementuje odblokowywanie instrukcji C# lock(). Wywołuj bezpośrednio lub użyj obiektu strażnika [LockContext](../lockcontext/). |
...
| virtual const char * [what](../details_exception/what/)() const | Implementuje metodę [what()](../details_exception/what/), która jest wywoływana przez klasę [ExceptionWrapper](../exceptionwrapper/). Pomimo faktu, że ta klasa nie dziedziczy po std::exception, pochodne klasy mogą używać chronionych/prywatnych członków do implementacji ich logiki. Przeniesienie implementacji tej metody do [ExceptionWrapper](../exceptionwrapper/) może zepsuć tę logikę. |
