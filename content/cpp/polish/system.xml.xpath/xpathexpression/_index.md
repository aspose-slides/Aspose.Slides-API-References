...
description: Udostępnia typowaną klasę reprezentującą skompilowane wyrażenie XPath.
type: docs
weight: 40
url: /pl/system.xml.xpath/xpathexpression/
---
## XPathExpression klasa
...
| Metoda | Opis |
| --- | --- |
| virtual void [AddSort](./addsort/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\>) | Gdy zostanie przesłonięta w klasie pochodnej, sortuje węzły wybrane przez wyrażenie [XPath](../) zgodnie z określonym obiektem IComparer. |
| virtual void [AddSort](./addsort/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [XmlSortOrder](../xmlsortorder/), [XmlCaseOrder](../xmlcaseorder/), [String](../../system/string/), [XmlDataType](../xmldatatype/)) | Gdy zostanie przesłonięta w klasie pochodnej, sortuje węzły wybrane przez wyrażenie [XPath](../) zgodnie z podanymi parametrami. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathExpression](./)\> [Clone](./clone/)() | Gdy zostanie przesłonięta w klasie pochodnej, zwraca klon tego [XPathExpression](./). |
| static [SharedPtr](../../system/sharedptr/)\<[XPathExpression](./)\> [Compile](./compile/)(const [String](../../system/string/)\&) | Kompiluje podane wyrażenie [XPath](../) i zwraca obiekt [XPathExpression](./) reprezentujący wyrażenie [XPath](../). |
| static [SharedPtr](../../system/sharedptr/)\<[XPathExpression](./)\> [Compile](./compile/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>\&) | Kompiluje określone wyrażenie [XPath](../), przy użyciu obiektu [IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/) określonego do rozwiązywania przestrzeni nazw, i zwraca obiekt [XPathExpression](./) reprezentujący wyrażenie [XPath](../). |
...
| virtual [String](../../system/string/) [get_Expression](./get_expression/)() | Gdy zostanie przesłonięta w klasie pochodnej, pobiera **string** reprezentację [XPathExpression](./). |
| virtual [XPathResultType](../xpathresulttype/) [get_ReturnType](./get_returntype/)() | Gdy zostanie przesłonięta w klasie pochodnej, pobiera typ wyniku wyrażenia [XPath](../). |
...
| virtual void [SetContext](./setcontext/)([SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../../system.xml/xmlnamespacemanager/)\>) | Gdy zostanie przesłonięta w klasie pochodnej, określa obiekt [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) używany do rozwiązywania przestrzeni nazw. |
| virtual void [SetContext](./setcontext/)([SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>) | Gdy zostanie przesłonięta w klasie pochodnej, określa obiekt [IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/) używany do rozwiązywania przestrzeni nazw. |
...
| virtual  [~Object](../../system/object/~object/)() | Zwalnia wszystkie wewnętrzne struktury danych. |
## Definicje typów
