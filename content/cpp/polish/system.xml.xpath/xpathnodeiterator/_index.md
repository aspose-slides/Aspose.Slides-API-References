...
description: Udostępnia iterator po wybranym zestawie węzłów.
type: docs
weight: 79
url: /pl/system.xml.xpath/xpathnodeiterator/
---
## XPathNodeIterator klasa

Udostępnia iterator po wybranym zestawie węzłów.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Zwraca iterator wskazujący na pierwszy element zakwalifikowany jako const (jeśli istnieje) w kolekcji. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie zakwalifikowanym jako const (jeśli istnieje) w kolekcji. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNodeIterator](./)\> [Clone](./clone/)() | Po nadpisaniu w klasie pochodnej zwraca klon tego obiektu [XPathNodeIterator](./). |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C# dla typu double, gdzie dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Tylko do użytku wewnętrznego. |
| virtual **int32_t** [get_Count](./get_count/)() | Zwraca indeks ostatniego węzła w wybranym zestawie węzłów. |
| virtual const [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\& [get_Current](./get_current/)() | Po nadpisaniu w klasie pochodnej pobiera obiekt [XPathNavigator](../xpathnavigator/) dla tego [XPathNodeIterator](./), ustawiony na bieżącym węźle kontekstu. |
| virtual **int32_t** [get_CurrentPosition](./get_currentposition/)() | Po nadpisaniu w klasie pochodnej pobiera indeks bieżącej pozycji w wybranym zestawie węzłów. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca obiekt IEnumerator do iteracji po wybranym zestawie węzłów. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Pomiada określoną liczbę kolejnych elementów od początku sekwencji i zwraca pozostałe. |
...
| virtual **bool** [MoveNext](./movenext/)() | Po nadpisaniu w klasie pochodnej przemieszcza obiekt [XPathNavigator](../xpathnavigator/) zwrócony przez metodę [XPathNodeIterator::get_Current](./get_current/) do następnego węzła w wybranym zestawie węzłów. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie wywołania C# lock(). Wywołaj bezpośrednio lub użyj obiektu ochronnego [LockContext](../../system/lockcontext/). |
...
|  [XPathNodeIterator](./xpathnodeiterator/)() | Inicjalizuje nową instancję klasy [XPathNodeIterator](./). |
