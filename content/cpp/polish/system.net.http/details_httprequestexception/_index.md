...
description: "Podstawowa klasa wyjątków jest rzucana przez klasy HttpClient i HttpMessageHandler. Nigdy nie twórz ręcznie instancji tej klasy. Użyj zamiast tego klasy HttpRequestException. Nigdy nie otaczaj instancji klasy HttpRequestException w System::SmartPtr."
type: docs
weight: 14
url: /pl/system.net.http/details_httprequestexception/
---
## Details_HttpRequestException klasa


Podstawowa klasa wyjątków jest rzucana przez [HttpClient](../httpclient/) i [HttpMessageHandler](../httpmessagehandler/) klasy. Nigdy nie twórz ręcznie instancji tej klasy. Użyj zamiast tego klasy HttpRequestException. Nigdy nie otaczaj instancji klasy HttpRequestException w [System::SmartPtr](../../system/smartptr/).
...
| Metoda | Opis |
| --- | --- |
|  [Details_HttpRequestException](./details_httprequestexception/)() | Tworzy nową instancję. |
|  [Details_HttpRequestException](./details_httprequestexception/)(std::nullptr_t) | Tworzy nową instancję. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/)) | Tworzy nową instancję. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Tworzy nową instancję. |
| virtual void [DoThrow](../../system/details_exception/dothrow/)(const [ExceptionPtr](../../system/exceptionptr/)\&) const | Rzuca instancję wyjątku opakowaną przez opakowywacz wyjątków. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Porównuje obiekty używając semantyki C# [Object.Equals](../../system/object/equals/). |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Porównuje obiekty typu referencyjnego w stylu C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Porównuje obiekty typu wartościowego w stylu C#. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, w którym dwa NaN są uważane za równe, pomimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, w którym dwa NaN są uważane za równe, pomimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokowanie deklaracji C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażniczego [LockContext](../../system/lockcontext/). |
