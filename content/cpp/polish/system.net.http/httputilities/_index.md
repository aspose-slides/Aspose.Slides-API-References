...
description: Zawiera metody pomocnicze.
type: docs
weight: 131
url: /pl/system.net.http/httputilities/
---
## Klasa HttpUtilities
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Sprawdza, czy podany URI jest URI HTTP. |
...
| Pole | Opis |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | Domyślna wersja HTTP używana przy wysyłaniu żądań. |
| static [DefaultResponseVersion](./defaultresponseversion/) | Domyślna wersja HTTP używana przy odbieraniu odpowiedzi. |
## Zobacz także
