...
description: "Reprezentuje zawartość HTTP jako ciąg znaków. Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to prowadzić do błędów czasu wykonywania i/lub awarii asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji."
type: docs
weight: 144
url: /pl/system.net.http/stringcontent/
---
## StringContent klasa
...
| Metoda | Opis |
| --- | --- |
|  [ByteArrayContent](../bytearraycontent/bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Tworzy nową instancję. |
|  [ByteArrayContent](../bytearraycontent/bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | Tworzy nową instancję. |
| void [Dispose](../httpcontent/dispose/)() override | Zwalnia bieżącą instancję. Ta metoda również zwalnia strumień zwrócony przez 'ReadAsStream' oraz bufor pamięci, jeśli został utworzony. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpContentHeaders](../../system.net.http.headers/httpcontentheaders/)\> [get_Headers](../httpcontent/get_headers/)() | Zwraca nagłówki zawartości HTTP. |
...
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)() | Serializuje zawartość do bufora pamięci. |
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)(**int64_t**) | Serializuje zawartość do bufora pamięci. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ReadAsByteArray](../httpcontent/readasbytearray/)() | Serializuje zawartość i zwraca tablicę bajtów. |
| [System::SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [ReadAsStream](../httpcontent/readasstream/)() | Serializuje zawartość i zwraca strumień. |
| [String](../../system/string/) [ReadAsString](../httpcontent/readasstring/)() | Serializuje zawartość i zwraca ciąg znaków. |
...
|  [StringContent](./stringcontent/)([String](../../system/string/)) | Tworzy nową instancję. |
|  [StringContent](./stringcontent/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>) | Tworzy nową instancję. |
|  [StringContent](./stringcontent/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>, [String](../../system/string/)) | Tworzy nową instancję. |
...
| **bool** [TryComputeLength](../bytearraycontent/trycomputelength/)(**int64_t**\&) override | Próbuje obliczyć długość tablicy bajtów. |
...
| Pole | Opis |
| --- | --- |
| static [DefaultStringEncoding](../httpcontent/defaultstringencoding/) | Domyślne kodowanie. |
| static [MaxBufferSize](../httpcontent/maxbuffersize/) | Maksymalna liczba bajtów. |

## Zobacz także

* Klasa [ByteArrayContent](../bytearraycontent/)
