...
description: Reprezentuje odniesienie do zewnętrznego projektu VBA.
type: docs
weight: 118
url: /pl/aspose.slides.vba/ivbareferenceproject/
---
## IVbaReferenceProject klasa


Reprezentuje odniesienie do zewnętrznego projektu VBA.
...
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | Reprezentuje nazwę odniesienia do projektu VBA. Odczytaj [System::String](../../system/string/). |
...
| virtual void [set_Name](../ivbareference/set_name/)([System::String](../../system/string/)) | Reprezentuje nazwę odniesienia do projektu VBA. Zapisz [System::String](../../system/string/). |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() const | Zmniejsza i zwraca współdzielony licznik referencji. Nie powinno być wywoływane bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
