...
description: Umożliwia tworzenie projektów VBA za pośrednictwem interfejsu COM
type: docs
weight: 40
url: /pl/aspose.slides.vba/ivbaprojectfactory/
---
## IVbaProjectFactory klasa


Umożliwia tworzenie projektów VBA za pośrednictwem interfejsu COM
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [CreateVbaProject](./createvbaproject/)() | Tworzy nowy projekt VBA. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [ReadVbaProject](./readvbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Odczytuje projekt VBA z kontenera OLE. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogiczna metoda C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwertowanie niestandardowych obiektów na ciąg znaków. |
