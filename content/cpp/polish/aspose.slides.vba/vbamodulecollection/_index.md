...
| Metoda | Opis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [AddEmptyModule](./addemptymodule/)([System::String](../../system/string/)) override | Dodaje nowy pusty moduł do projektu VBA. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Zwraca iterator wskazujący na pierwszy element oznaczony const (jeśli istnieje) w kolekcji. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Zwraca iterator wskazujący zaraz po ostatnim elemencie oznaczonym const (jeśli istnieje) w kolekcji. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\>\>, **int32_t**) override | Kopiuje wszystkie elementy z kolekcji do określonej tablicy. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca wylicznik, który iteruje po kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca element o podanym indeksie. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę wyrażenia C# lock(). Wywołaj bezpośrednio lub użyj obiektu stróża [LockContext](../../system/lockcontext/). |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\>) override | Usuwa pierwsze wystąpienie konkretnego obiektu z kolekcji. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie wyrażenia C# lock(). Wywołaj bezpośrednio lub użyj obiektu stróża [LockContext](../../system/lockcontext/). |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Zwraca iterator wskazujący zaraz po ostatnim elemencie (jeśli istnieje) w kolekcji. |
...
* Klasa [IVbaModuleCollection](../ivbamodulecollection/)
