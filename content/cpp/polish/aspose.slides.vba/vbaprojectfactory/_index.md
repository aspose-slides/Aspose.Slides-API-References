...
Umożliwia tworzenie projektu VBA poprzez interfejs COM
...
| Metoda | Opis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [CreateVbaProject](./createvbaproject/)() override | Tworzy nowy projekt VBA. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaProjectFactory](./)\> [get_Instance](./get_instance/)() | Statyczna instancja fabryki projektów VBA. Tylko do odczytu [VbaProjectFactory](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [ReadVbaProject](./readvbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Odczytuje projekt VBA z kontenera OLE. |
...
* Klasa [IVbaProjectFactory](../ivbaprojectfactory/)
