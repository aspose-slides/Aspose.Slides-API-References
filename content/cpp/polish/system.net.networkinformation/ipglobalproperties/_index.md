...
description: "Reprezentuje informacje o połączeniu sieciowym lokalnego komputera. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonywania i/lub błędy asercji. Zawsze owijaj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania go funkcjom jako argument."
type: docs
weight: 14
url: /pl/system.net.networkinformation/ipglobalproperties/
---
## IPGlobalProperties klasa

Reprezentuje informacje o połączeniu sieciowym lokalnego komputera. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub błędy asercji. Zawsze otaczaj tę klasę wskaźnikiem [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej funkcjom jako argument.
...
| virtual [String](../../system/string/) [get_DomainName](./get_domainname/)() | Zwraca domenę, w której zarejestrowany jest lokalny komputer. |
| virtual [String](../../system/string/) [get_HostName](./get_hostname/)() | Zwraca nazwę hosta lokalnego komputera. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[IPGlobalProperties](./)\> [GetIPGlobalProperties](./getipglobalproperties/)() | Tworzy nową instancję. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Właściwie nic nie kopiuje, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie w podklasach. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Właściwie nic nie kopiuje, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie w podklasach. |
