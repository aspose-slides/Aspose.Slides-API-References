...
description: "Częściowa specjalizacja szablonu HttpHeaderValueCollection dla typu String. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani nie używaj operatora new, ponieważ może to skutkować błędami w czasie wykonywania i/lub awariami asercji. Zawsze opakowuj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika przy przekazywaniu jej jako argumentu do funkcji."
type: docs
weight: 105
url: /pl/system.net.http.headers/httpheadervaluecollection_tmpl_system_string__end_tmpl/
---
## HttpHeaderValueCollection< System::String > klasa
...
| Metoda | Opis |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&) override | Dodaje element do kolekcji. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, w którym dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym innemu NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, w którym dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym innemu NaN. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator. |
...
| **bool** [Remove](./remove/)(const [String](../../system/string/)\&) override | Usuwa element z kolekcji. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Analogiczna metoda C# [Object.ToString()](../httpheadervaluecollection/tostring/). Umożliwia konwersję własnych obiektów na string. |
