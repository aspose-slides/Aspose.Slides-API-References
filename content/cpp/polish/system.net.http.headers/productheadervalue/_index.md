...
description: "Reprezentuje token produktu w wartości nagłówka 'User-Agent'. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy w czasie działania i/lub naruszenia asercji. Zawsze otaczaj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 209
url: /pl/system.net.http.headers/productheadervalue/
---
...
| [String](../../system/string/) [get_Name](./get_name/)() | Zwraca nazwę tokenu produktu. |
| [String](../../system/string/) [get_Version](./get_version/)() | Zwraca wersję tokenu produktu. |
...
| static **int32_t** [GetProductLength](./getproductlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\>\&) | Konwertuje przekazany ciąg znaków od określonego indeksu na instancję klasy [ProductHeaderValue](./). |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Konwertuje przekazany ciąg znaków na instancję klasy [ProductHeaderValue](./). |
| [ProductHeaderValue](./productheadervalue/)([String](../../system/string/)) | Tworzy nową instancję. |
| [ProductHeaderValue](./productheadervalue/)([String](../../system/string/), [String](../../system/string/)) | Tworzy nową instancję. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ProductHeaderValue](./)\>\&) | Próbuje skonwertować przekazany ciąg znaków na instancję klasy [ProductHeaderValue](./). |
