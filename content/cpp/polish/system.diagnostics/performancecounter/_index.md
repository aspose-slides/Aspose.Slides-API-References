...
description: "Klasa dummy służąca do kompilacji przetłumaczonego kodu używającego PerformanceCounter. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji."
type: docs
weight: 14
url: /pl/system.diagnostics/performancecounter/
---
...
| Metoda | Opis |
| --- | --- |
| void [Close](./close/)() | Zatrzymuje wszystkie operacje liczenia wydajności. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Pobiera rzeczywisty typ obiektu. Analogiczna funkcja C# [System.Object.GetType()](../../system/object/gettype/). |
...
| **float** [NextValue](./nextvalue/)() | Pobiera następną zmierzoną wartość. |
...
|  [PerformanceCounter](./performancecounter/)() | Tworzy licznik wydajności. |
|  [PerformanceCounter](./performancecounter/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Tworzy licznik wydajności o konkretnej kategorii. |
|  [PerformanceCounter](./performancecounter/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Tworzy licznik wydajności o konkretnej kategorii i nazwie instancji. |
