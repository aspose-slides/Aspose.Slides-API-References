---
title: StackFrame
second_title: Dokumentacja referencyjna API Aspose.Slides dla C++
description: "Uzyskuje informacje o pojedynczej ramce stosu. Tylko MSVS. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami czasu wykonania i/lub błędami asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika jako argumentu w funkcjach."
type: docs
weight: 53
url: /pl/system.diagnostics/stackframe/
---
## StackFrame klasa


Uzyskuje informacje o pojedynczej ramce stosu. MSVS only. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub błędy asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika, aby przekazywać go do funkcji jako argument.
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Uzyskuje strukturę danych licznika referencji skojarzoną z obiektem. |
| virtual int [GetFileColumnNumber](./getfilecolumnnumber/)() | Uzyskuje numer kolumny. |
| virtual int [GetFileLineNumber](./getfilelinenumber/)() | Uzyskuje numer wiersza. |
| virtual [System::String](../../system/string/) [GetFileName](./getfilename/)() | Uzyskuje nazwę pliku. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Odpowiednik metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia haszowanie własnych obiektów. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Reflection::MethodBase](../../system.reflection/methodbase/)\> [GetMethod](./getmethod/)() | Uzyskuje informacje o metodzie. |
...
| const [StackFrame](./)\& [operator=](./operator_equal/)(const [StackFrame](./)\&) const | Bez zmian. |
...
|  [StackFrame](./stackframe/)(int) | Tworzy ramkę stosu na bieżącym offsetcie stosu. |
|  [StackFrame](./stackframe/)(const [StackFrame](./)\&) | Bez kopiowania. |
