...
description: "Argumenty anulowalnego zdarzenia. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go funkcjom jako argument."
type: docs
weight: 27
url: /pl/system.componentmodel/canceleventargs/
---
## CancelEventArgs klasa

Argumenty anulowalnego zdarzenia. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej funkcjom jako argument.
...
|  [CancelEventArgs](./canceleventargs/)() | Konstruktor; ustawia właściwość Cancel na false. |
...
| **bool** [get_Cancel](./get_cancel/)() | Zwraca wartość wskazującą, czy zdarzenie powinno zostać anulowane. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje właściwie nic, tylko inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstrukcji podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje właściwie nic, tylko inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstrukcji podklas. |
...
| void [set_Cancel](./set_cancel/)(**bool**) | Ustawia wartość wskazującą, czy zdarzenie powinno zostać anulowane. |
...
| Pole | Opis |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Statyczny członek reprezentujący \"pusty\" współdzielony wskaźnik [EventArgs](../../system/eventargs/) (wskaźnik null). |
