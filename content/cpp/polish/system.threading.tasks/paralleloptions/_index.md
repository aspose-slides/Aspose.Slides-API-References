...
description: Przechowuje opcje, które konfigurują działanie metod klasy Parallel.
type: docs
weight: 27
url: /pl/system.threading.tasks/paralleloptions/
---
## ParallelOptions klasa


Przechowuje opcje, które konfigurują działanie metod na klasie [Parallel](../parallel/).
...
| const [CancellationToken](../../system.threading/cancellationtoken/)\& [get_CancellationToken](./get_cancellationtoken/)() | Pobiera [CancellationToken](../../system.threading/cancellationtoken/) powiązany z tą instancją [ParallelOptions](./). |
| **int32_t** [get_MaxDegreeOfParallelism](./get_maxdegreeofparallelism/)() | Pobiera maksymalny stopień równoległości włączony w tej instancji [ParallelOptions](./). |
| const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](../taskscheduler/)\>\& [get_TaskScheduler](./get_taskscheduler/)() | Pobiera [TaskScheduler](../taskscheduler/) powiązany z tą instancją [ParallelOptions](./). |
...
|  [ParallelOptions](./paralleloptions/)() | Tworzy instancję [ParallelOptions](./) z wartościami domyślnymi. |
...
| void [set_CancellationToken](./set_cancellationtoken/)(const [CancellationToken](../../system.threading/cancellationtoken/)\&) | Ustawia [CancellationToken](../../system.threading/cancellationtoken/) powiązany z tą instancją [ParallelOptions](./). |
| void [set_MaxDegreeOfParallelism](./set_maxdegreeofparallelism/)(**int32_t**) | Ustawia maksymalny stopień równoległości włączony w tej instancji [ParallelOptions](./). |
| void [set_TaskScheduler](./set_taskscheduler/)(const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](../taskscheduler/)\>\&) | Ustawia [TaskScheduler](../taskscheduler/) powiązany z tą instancją [ParallelOptions](./). |
