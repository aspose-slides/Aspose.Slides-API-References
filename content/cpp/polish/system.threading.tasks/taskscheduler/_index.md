...
description: Reprezentuje obiekt, który zajmuje się niskopoziomową pracą polegającą na kolejkowaniu zadań na wątkach.
type: docs
weight: 79
url: /pl/system.threading.tasks/taskscheduler/
---
## TaskScheduler klasa
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | Tworzy [TaskScheduler](./) powiązany z bieżącym wątkiem. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | Pobiera [TaskScheduler](./) powiązany z aktualnie wykonywanym zadaniem. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | Pobiera domyślną instancję [TaskScheduler](./) dostarczaną przez framework. |
| **int32_t** [get_Id](./get_id/)() const | Pobiera unikalny identyfikator tego [TaskScheduler](./). |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | Wskazuje maksymalny poziom współbieżności, jaki może obsłużyć ten [TaskScheduler](./). |
