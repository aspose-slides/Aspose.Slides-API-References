...
description: Dostarcza informacje o statusie zakończenia pętli równoległej.
type: docs
weight: 14
url: /pl/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult klasa

Zapewnia status zakończenia pętli [Parallel](../parallel/).
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Zwraca informację, czy pętla zakończyła się pomyślnie. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Zwraca najniższy indeks iteracji, przy którym wystąpiło przerwanie. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Tworzy [ParallelLoopResult](./). |
...
Reprezentuje wynik operacji równoległej pętli, w tym informacje o tym, czy zakończyła się pomyślnie oraz o przerwaniach. 
## Zobacz także
