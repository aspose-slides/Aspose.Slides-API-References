...
description: Zapewnia wynik oczekujący w operacji asynchronicznej.
type: docs
weight: 92
url: /pl/system.threading.tasks/valuetask/
---
## ValueTask klasa

Zapewnia wynik oczekujący operacji asynchronicznej.
...
| Metoda | Opis |
| --- | --- |
| [TaskPtr](../../system/taskptr/) [AsTask](./astask/)() const | Konwertuje ten [ValueTask](./) na współdzielony wskaźnik do [Task](../task/). |
| [Runtime::CompilerServices::ConfiguredValueTaskAwaitable](../../system.runtime.compilerservices/configuredvaluetaskawaitable/) [ConfigureAwait](./configureawait/)(**bool**) const | Konfiguruje awaiter dla tego zadania. |
| **bool** [Equals](./equals/)([ValueTask](./)) override | Określa, czy ta instancja jest równa innej instancji [ValueTask](./). |
...
| virtual **bool** [Equals](../../system/iequatable/equals/)(T) | Określa, czy bieżący i podany obiekt są równe. |
...
| **bool** [get_IsCompleted](./get_iscompleted/)() const | Zwraca wartość wskazującą, czy zadanie zostało zakończone. |
...
| [Runtime::CompilerServices::ValueTaskAwaiter](../../system.runtime.compilerservices/valuetaskawaiter/) [GetAwaiter](./getawaiter/)() const | Zwraca awaiter dla tego zadania, aby obsługiwać wyrażenia await. |
...
| **bool** [operator!=](./operator_not_equal/)(const [ValueTask](./)\&) const | Operator nierówności dla [ValueTask](./). |
...
| **bool** [operator==](./operator_equal_equal/)(const [ValueTask](./)\&) const | Operator równości dla [ValueTask](./). |
...
|  [ValueTask](./valuetask/)() | Tworzy pusty, niezinicjowany [ValueTask](./). |
|  [ValueTask](./valuetask/)(const [TaskPtr](../../system/taskptr/)\&) | Tworzy [ValueTask](./) ze współdzielonego wskaźnika do [Task](../task/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| virtual  [~Object](../../system/object/~object/)() | Niszczą obiekt. Zwalnia wszystkie wewnętrzne struktury danych. |
