...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) override | Zwraca interaktywną sekwencję pod określonym indeksem. Ta sekwencja może zawierać jedynie efekty wywoływane \"kliknięciem na kształt\" z określonym docelowym kształtem. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequenceCollection](../isequencecollection/)\> [get_InteractiveSequences](./get_interactivesequences/)() override | Zwraca kolekcję interaktywnych sekwencji. Te sekwencje mogą zawierać jedynie efekty wywoływane \"kliknięciem na kształt\" z określonym docelowym kształtem. Tylko do odczytu [ISequenceCollection](../isequencecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_MainSequence](./get_mainsequence/)() override | Zwraca główną sekwencję, która może zawierać jedynie kolekcję głównych efektów. Tylko do odczytu [ISequence](../isequence/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) override | Zwraca efekt z głównej sekwencji pod określonym indeksem. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) override | Zwraca animację tekstu pod określonym indeksem. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimationCollection](../itextanimationcollection/)\> [get_TextAnimationCollection](./get_textanimationcollection/)() override | Zwraca kolekcję animacji tekstu. Tylko do odczytu [ITextAnimationCollection](../itextanimationcollection/). |
...
* Klasa [IAnimationTimeLine](../../aspose.slides/ianimationtimeline/)
