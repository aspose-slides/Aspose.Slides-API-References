...
| Metoda | Opis |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | Dodaje nową interaktywną sekwencję. Odczyt/zapis [Sequence](../sequence/). |
| [iterator](./iterator/) [begin](./begin/)() | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) kolekcji. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) stałej instancji kolekcji. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Zwraca iterator wskazujący tuż po ostatnim stałym elemencie (jeśli istnieje) kolekcji. |
| void [Clear](./clear/)() override | Usuwa wszystkie sekwencje z kolekcji. |
| [iterator](./iterator/) [end](./end/)() | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) kolekcji. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) stałej instancji kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator iterujący po kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca sekwencję pod określonym indeksem. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę statement lock() C#. Wywołaj bezpośrednio lub użyj obiektu wartownika [LockContext](../../system/lockcontext/). |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>) override | Usuwa określoną sekwencję z kolekcji. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Usuwa sekwencję pod określonym indeksem. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie statement lock() C#. Wywołaj bezpośrednio lub użyj obiektu wartownika [LockContext](../../system/lockcontext/). |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) stałej instancji kolekcji. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) stałej instancji kolekcji. |
...
* Klasa [ISequenceCollection](../isequencecollection/)
