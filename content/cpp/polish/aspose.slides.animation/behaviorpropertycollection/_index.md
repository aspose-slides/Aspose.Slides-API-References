...
description: Reprezentuje właściwości czasowe dla zachowania efektu.
type: docs
weight: 66
...
| Metoda | Opis |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Dodaje nową właściwość do kolekcji. |
| void [Add](./add/)(const [System::String](../../system/string/)\&) override | Dodaje nową właściwość do kolekcji. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Zwraca iterator wskazujący na pierwszy element stały (jeśli istnieje) kolekcji. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Zwraca iterator wskazujący zaraz po ostatnim elemencie stałym (jeśli istnieje) kolekcji. |
| void [Clear](./clear/)() override | Usuwa wszystkie właściwości z kolekcji. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | Określa, czy [ICollection](../../system.collections.generic/icollection/) zawiera określoną wartość. |
| **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const override | Określa, czy [ICollection](../../system.collections.generic/icollection/) zawiera określoną wartość. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>, **int32_t**) override | Kopiuje elementy [ICollection](../../system.collections.generic/icollection/) do [System::Array](../../system/array/), zaczynając od określonego indeksu [System::Array](../../system/array/). |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Zwraca iterator wskazujący zaraz po ostatnim elemencie (jeśli istnieje) stałej wersji kolekcji. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych typu double w stylu C#, gdzie dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Tylko do użytku wewnętrznego. |
| **int32_t** [get_Count](./get_count/)() const override | Zwraca liczbę właściwości przechowywanych w kolekcji. Tylko do odczytu **int32_t**. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Sprawdza, czy kolekcja ma stały rozmiar. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Zwraca wartość wskazującą, czy [ICollection](../../system.collections.generic/icollection/) jest tylko do odczytu. Tylko do odczytu **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator iterujący po kolekcji. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Odpowiednik metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Udostępnia hashowanie własnych obiektów. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\> [idx_get](./idx_get/)(**int32_t**) const override | Zwraca właściwość pod określonym indeksem. |
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Zwraca element pod określonym indeksem. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>) override | Zwraca właściwość pod określonym indeksem. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Ustawia element pod określonym indeksem. |
| **int32_t** [IndexOf](./indexof/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | Określa indeks określonego elementu w [IList](../../system.collections.generic/ilist/). |
| **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const override | Określa indeks określonego elementu według wartości właściwości w [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Wstawia nową właściwość do kolekcji pod określonym indeksem. |
| void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) override | Wstawia nową właściwość (z określoną wartością) do kolekcji pod określonym indeksem. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | Wstawia element w określone położenie, przesuwając pozostałe elementy. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Zwraca pierwszy element sekwencji, który spełnia warunek, lub wartość domyślną, jeśli nie znaleziono takiego elementu. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Usuwa określoną właściwość z kolekcji. |
| **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) override | Usuwa określoną właściwość z kolekcji. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Usuwa właściwość pod określonym indeksem. |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | Usuwa element pod określonym indeksem. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) stałej wersji kolekcji. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Zwraca iterator wskazujący zaraz po ostatnim elemencie (jeśli istnieje) stałej wersji kolekcji. |
...
| [virtualized_iterator_element](./virtualized_iterator_element/) | Typ elementu wirtualizowanego. |
| [virtualized_iterator](./virtualized_iterator/) | Typ wirtualizowany. |

## Zobacz także

* Klasa [IBehaviorPropertyCollection](../ibehaviorpropertycollection/)
