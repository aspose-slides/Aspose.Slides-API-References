...
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../ibehavior/get_accumulate/)() | Określa, czy zachowania animacji są kumulowane. Odczyt [NullableBool](../../aspose.slides/nullablebool/). |
...
| virtual **float** [get_By](./get_by/)() | Opisuje względną wartość offsetu dla animacji. Odczyt **float**. |
| virtual **float** [get_From](./get_from/)() | Opisuje początkową wartość dla animacji. Odczyt **float**. |
...
| virtual **float** [get_To](./get_to/)() | Opisuje wartość końcową animacji. Odczyt **float**. |
...
| virtual void [set_Accumulate](../ibehavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | Określa, czy zachowania animacji są kumulowane. Zapis [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [set_Additive](../ibehavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | Określa, czy bieżące zachowanie animacji jest łączone z innymi uruchomionymi animacjami. Zapis [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual void [set_By](./set_by/)(**float**) | Opisuje względną wartość offsetu dla animacji. Zapis **float**. |
| virtual void [set_From](./set_from/)(**float**) | Opisuje początkową wartość animacji. Zapis **float**. |
...
| virtual void [set_To](./set_to/)(**float**) | Opisuje wartość końcową animacji. Zapis **float**. |
