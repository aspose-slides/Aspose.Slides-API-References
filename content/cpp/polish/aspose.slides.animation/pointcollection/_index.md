...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Zwraca iterator wskazujący tuż za ostatnim const-kwalifikowanym elementem (jeśli istnieje) kolekcji. |
...
| **int32_t** [get_Count](./get_count/)() override | Zwraca liczbę punktów w kolekcji. Tylko do odczytu **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPoint](../ipoint/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator iterujący po kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPoint](../ipoint/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca punkt o podanym indeksie. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Zwraca aktualną wartość współdzielonego licznika referencji. |
...
* Klasa [IPointCollection](../ipointcollection/)
