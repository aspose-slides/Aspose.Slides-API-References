...
Represents rotation behavior of effect.
...
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | Określa, czy bieżące zachowanie animacji jest łączone z innymi uruchomionymi animacjami. Odczyt [BehaviorAdditiveType](../behavioradditivetype/). |
| **float** [get_By](./get_by/)() override | Opisuje względną wartość offsetu dla animacji. Odczyt **float**. |
| **float** [get_From](./get_from/)() override | Opisuje początkową wartość dla animacji. Odczyt **float**. |
...
| **float** [get_To](./get_to/)() override | Opisuje końcową wartość dla animacji. Odczyt **float**. |
...
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Określa, czy bieżące zachowanie animacji jest łączone z innymi uruchomionymi animacjami. Zapis [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_By](./set_by/)(**float**) override | Opisuje względną wartość offsetu dla animacji. Zapis **float**. |
| void [set_From](./set_from/)(**float**) override | Opisuje początkową wartość dla animacji. Zapis **float**. |
...
| void [set_To](./set_to/)(**float**) override | Opisuje końcową wartość dla animacji. Zapis **float**. |
...
* Klasa [IRotationEffect](../irotationeffect/)
