...
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](./get_accumulate/)() override | Reprezentuje, czy zachowania animacji są kumulowane. Odczyt [NullableBool](../../aspose.slides/nullablebool/). |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](./get_additive/)() override | Reprezentuje, czy bieżące zachowanie animacji jest łączone z innymi trwającymi animacjami. Odczyt [BehaviorAdditiveType](../behavioradditivetype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](./get_properties/)() override | Reprezentuje właściwości zachowania. Tylko do odczytu [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](./get_timing/)() override | Reprezentuje właściwości czasowe dla zachowania efektu. Odczyt [ITiming](../itiming/). |
...
| void [set_Accumulate](./set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | Reprezentuje, czy zachowania animacji są kumulowane. Zapis [NullableBool](../../aspose.slides/nullablebool/). |
| void [set_Additive](./set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Reprezentuje, czy bieżące zachowanie animacji jest łączone z innymi trwającymi animacjami. Zapis [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_Timing](./set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Reprezentuje właściwości czasowe dla zachowania efektu. Zapis [ITiming](../itiming/). |
