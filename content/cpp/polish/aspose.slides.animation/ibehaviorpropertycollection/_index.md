...
---
## IBehaviorPropertyCollection klasa


Reprezentuje właściwości czasowe dla zachowania efektu.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie oznaczonym jako const (jeśli istnieje) w kolekcji. |
| virtual void [Clear](../../system.collections.generic/icollection/clear/)() | Usuwa wszystkie elementy z kolekcji. |
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Określa, czy [ICollection](../../system.collections.generic/icollection/) zawiera określoną wartość. |
| virtual **bool** [Contains](../../system.collections.generic/icollection/contains/)(const T\&) const | Sprawdza, czy element znajduje się w kolekcji. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopiuje wszystkie elementy kolekcji do istniejących elementów tablicy. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany referencjonowanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca kopię-obiekt T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) stałej wersji kolekcji. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Porównuje obiekty korzystając z semantyki C# [Object.Equals](../../system/object/equals/). |
...
| virtual int [get_Count](../../system.collections.generic/icollection/get_count/)() const | Zwraca liczbę elementów w kolekcji. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../../system.collections.generic/ienumerable/getenumerator/)() | Zwraca wylicznik. |
...
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Zwraca element o podanym indeksie. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Ustawia element o podanym indeksie. |
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Określa indeks konkretnego elementu po wartości właściwości w [IList](../../system.collections.generic/ilist/). |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | Zwraca indeks pierwszego wystąpienia elementu w kontenerze. |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | Wstawia nową właściwość (z podaną wartością) do kolekcji pod określonym indeksem. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | Wstawia element na określoną pozycję, przesuwając pozostałe elementy. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Określa, czy istnieje przynajmniej jeden element sekwencji spełniający warunek. |
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Oblicza średnią sekwencji wartości numerycznych. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią sekwencji wartości uzyskanych przez wywołanie funkcji transformującej na każdym elemencie wejściowej sekwencji. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_OfType](../../system.collections.generic/ienumerable/linq_oftype/)() | Filtruje elementy sekwencji według podanego typu. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Filtruje sekwencję według podanego predykatu. |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | Usuwa określoną właściwość z kolekcji. |
| virtual **bool** [Remove](../../system.collections.generic/icollection/remove/)(const T\&) | Usuwa element z kolekcji. |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | Usuwa element pod podanym indeksem. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zwiększa licznik współdzielonych referencji. Nie wolno wywoływać bezpośrednio; używaj inteligentnych wskaźników lub ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Zmniejsza i zwraca licznik współdzielonych referencji. Nie wolno wywoływać bezpośrednio; używaj inteligentnych wskaźników lub ThisProtector. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Zwraca implementację stałego iteratora początku dla bieżącego kontenera. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../../system.collections.generic/ienumerable/virtualizebeginiterator/)() | Zwraca implementację iteratora początku dla bieżącego kontenera. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Zwraca implementację stałego iteratora końca dla bieżącego kontenera. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../../system.collections.generic/ienumerable/virtualizeenditerator/)() | Zwraca implementację iteratora końca dla bieżącego kontenera. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabych referencji. Nie wolno wywoływać bezpośrednio; używaj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabych referencji. Nie wolno wywoływać bezpośrednio; używaj inteligentnych wskaźników lub ThisProtector. |
