...
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_By](./get_by/)() | Opisuje względną wartość przesunięcia animacji (w procentach). Odczyt [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_From](./get_from/)() | Określa współrzędną x/y, z której zaczyna się animacja (w procentach). Odczyt [System::Drawing::PointF](../../system.drawing/pointf/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../ibehavior/get_timing/)() | Reprezentuje właściwości czasowe dla zachowania efektu. Odczyt [ITiming](../itiming/). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_To](./get_to/)() | Określa docelową lokalizację efektu skalowania animacji (w procentach). Odczyt [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_ZoomContent](./get_zoomcontent/)() | Określa, czy zawartość powinna być powiększona. Odczyt [NullableBool](../../aspose.slides/nullablebool/). |
...
| virtual void [set_By](./set_by/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Opisuje względną wartość przesunięcia animacji (w procentach). Zapis [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_From](./set_from/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Określa współrzędną x/y, z której zaczyna się animacja (w procentach). Zapis [System::Drawing::PointF](../../system.drawing/pointf/). |
...
| virtual void [set_To](./set_to/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Określa docelową lokalizację efektu skalowania animacji (w procentach). Zapis [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_ZoomContent](./set_zoomcontent/)([NullableBool](../../aspose.slides/nullablebool/)) | Określa, czy zawartość powinna być powiększona. Zapis [NullableBool](../../aspose.slides/nullablebool/). |
