...
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](./get_accumulate/)() | Reprezentuje, czy zachowania animacji są kumulowane. Odczytaj [NullableBool](../../aspose.slides/nullablebool/). |
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](./get_additive/)() | Reprezentuje, czy bieżące zachowanie animacji jest łączone z innymi uruchomionymi animacjami. Odczytaj [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](./get_properties/)() | Reprezentuje właściwości zachowania. Tylko do odczytu [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](./get_timing/)() | Reprezentuje właściwości czasowe dla zachowania efektu. Odczytaj [ITiming](../itiming/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia haszowanie własnych obiektów. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Pobiera rzeczywisty typ obiektu. Analog wywołania C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Sprawdza, czy obiekt jest instancją typu opisanego przez targetType. Analog operatora C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementuje blokowanie wyrażeniem C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażniczego [LockContext](../../system/lockcontext/). |
...
| virtual void [set_Accumulate](./set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | Reprezentuje, czy zachowania animacji są kumulowane. Zapisz [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [set_Additive](./set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | Reprezentuje, czy bieżące zachowanie animacji jest łączone z innymi uruchomionymi animacjami. Zapisz [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual void [set_Timing](./set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | Reprezentuje właściwości czasowe dla zachowania efektu. Zapisz [ITiming](../itiming/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie wyrażeniem C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażniczego [LockContext](../../system/lockcontext/). |
