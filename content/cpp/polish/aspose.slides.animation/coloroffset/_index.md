...
| **float** [get_Value0](./get_value0/)() override | Definiuje pierwszą wartość offsetu. Odczyt **float**. |
| **float** [get_Value1](./get_value1/)() override | Definiuje drugą wartość offsetu. Odczyt **float**. |
| **float** [get_Value2](./get_value2/)() override | Definiuje trzecią wartość offsetu. Odczyt **float**. |
...
| void [set_Value0](./set_value0/)(**float**) override | Definiuje pierwszą wartość offsetu. Zapis **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Definiuje drugą wartość offsetu. Zapis **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Definiuje trzecią wartość offsetu. Zapis **float**. |
...
* Klasa [IColorOffset](../icoloroffset/)
