...
description: "Oznacza wybrany atrybut jako element główny XML i kontroluje jego serializację XML. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub naruszenia asercji. Zawsze owiń tę klasę w wskaźnik System::SmartPtr i użyj tego wskaźnika, aby przekazać go do funkcji jako argument."
type: docs
weight: 27
url: /pl/system.xml.serialization/xmlrootattribute/
---
## XmlRootAttribute klasa


Oznacza element docelowy atrybutu jako element główny XML i kontroluje jego serializację XML. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub naruszenia asercji. Zawsze owiń tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i użyj tego wskaźnika, aby przekazać ją do funkcji jako argument.
...
|  [XmlRootAttribute](./xmlrootattribute/)() | Tworzy nową instancję klasy [XmlRootAttribute](./). |
|  [XmlRootAttribute](./xmlrootattribute/)(const [System::String](../../system/string/)\&) | Tworzy nową instancję klasy [XmlRootAttribute](./) i inicjalizuje ją podaną nazwą elementu. |
