...
description: Udostępnia interfejs do określonej zmiennej, która jest definiowana w arkuszu stylów w trakcie wykonywania.
type: docs
weight: 40
url: /pl/system.xml.xsl/ixsltcontextvariable/
---
## IXsltContextVariable klasa
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Evaluate](./evaluate/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>) | Oblicza zmienną w czasie wykonywania i zwraca obiekt reprezentujący wartość zmiennej. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Tylko do celów wewnętrznych. |
| virtual **bool** [get_IsLocal](./get_islocal/)() | Zwraca wartość wskazującą, czy zmienna jest lokalna. |
| virtual **bool** [get_IsParam](./get_isparam/)() | Zwraca wartość wskazującą, czy zmienna jest parametrem Extensible Stylesheet Language Transformations (XSLT). Może to być parametr arkusza stylów lub szablonu. |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_VariableType](./get_variabletype/)() | Zwraca XPathResultType reprezentujący typ języka XML Path Language ([XPath](../../system.xml.xpath/)) zmiennej. |
