...
description: Wyjątek zgłaszany, gdy podczas przetwarzania transformacji XSLT wystąpi błąd.
type: docs
weight: 14
url: /pl/system.xml.xsl/details_xsltexception/
---
## Details_XsltException klasa


Wyjątek, który jest zgłaszany, gdy podczas przetwarzania transformacji XSLT wystąpi błąd.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Zwraca numer wiersza wskazujący, gdzie błąd wystąpił w arkuszu stylów. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Zwraca pozycję wiersza wskazującą, gdzie błąd wystąpił w arkuszu stylów. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Zwraca sformatowaną wiadomość o błędzie opisującą bieżący wyjątek. |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Zwraca ścieżkę lokalizacji arkusza stylów. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Ustawia HRESULT, zakodowaną wartość numeryczną przypisywaną określonemu wyjątkowi. |
