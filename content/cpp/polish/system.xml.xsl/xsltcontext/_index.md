...
description: Umożliwia enkapsulację bieżącego kontekstu wykonania procesora Extensible Stylesheet Language for Transformations (XSLT), pozwalając językowi XML Path Language (XPath) na rozwiązywanie funkcji, parametrów i przestrzeni nazw w wyrażeniach XPath.
type: docs
weight: 79
url: /pl/system.xml.xsl/xsltcontext/
---
## XsltContext klasa
...
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | Po nadpisaniu w klasie pochodnej, porównuje podstawowe Uniform Resource Identifiers (URI) dwóch dokumentów na podstawie kolejności ich wczytania przez procesor XSLT (czyli klasę [XslTransform](../xsltransform/)). |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | Zwraca URI przestrzeni nazw dla domyślnej przestrzeni nazw. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | Zwraca [XmlNameTable](../../system.xml/xmlnametable/) powiązany z tym obiektem. |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | Po nadpisaniu w klasie pochodnej zwraca wartość wskazującą, czy włączać węzły białych znaków w wynik. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | Zwraca enumerator używany do iteracji po przestrzeniach nazw w [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/). |
...
| virtual **bool** [HasNamespace](../../system.xml/xmlnamespacemanager/hasnamespace/)([String](../../system/string/)) | Zwraca wartość wskazującą, czy podany prefiks ma zdefiniowaną przestrzeń nazw w bieżącym zakreszie. |
...
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | Zwraca URI przestrzeni nazw dla określonego prefiksu. |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | Znajduje prefiks zadeklarowany dla podanego URI przestrzeni nazw. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umożliwia klonowanie niestandardowych typów. |
| [Object](../../system/object/object/)() | Tworzy obiekt. Inicjalizuje wszystkie wewnętrzne struktury danych. |
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje niczego, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje niczego, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | Zdejmuje zakres przestrzeni nazw ze stosu. |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | Po nadpisaniu w klasie pochodnej ocenia, czy zachować węzły białych znaków, czy je usunąć w danym kontekście. |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | Umieszcza zakres przestrzeni nazw na stosie. |
...
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Usuwa podaną przestrzeń nazw dla podanego prefiksu. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextFunction](../ixsltcontextfunction/)\> [ResolveFunction](./resolvefunction/)([String](../../system/string/), [String](../../system/string/), [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\>) | Po nadpisaniu w klasie pochodnej rozwiązuje odwołanie do funkcji i zwraca [IXsltContextFunction](../ixsltcontextfunction/) reprezentujący funkcję. [IXsltContextFunction](../ixsltcontextfunction/) jest używany w czasie wykonywania do pobrania wartości zwracanej funkcji. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | Po nadpisaniu w klasie pochodnej rozwiązuje odwołanie do zmiennej i zwraca [IXsltContextVariable](../ixsltcontextvariable/) reprezentujący zmienną. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwertowanie niestandardowych obiektów na string. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementuje konstrukcję C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowywanie instrukcją C# lock(). Wywołaj bezpośrednio lub użyj obiektu sentry [LockContext](../../system/lockcontext/). |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Zwraca implementację początkowego const iteratora dla bieżącego kontenera. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../../system.collections.generic/ienumerable/virtualizebeginiterator/)() | Zwraca implementację początkowego iteratora dla bieżącego kontenera. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Zwraca implementację końcowego const iteratora dla bieżącego kontenera. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../../system.collections.generic/ienumerable/virtualizeenditerator/)() | Zwraca implementację końcowego iteratora dla bieżącego kontenera. |
...
| [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Inicjalizuje nową instancję klasy [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) z określonym [XmlNameTable](../../system.xml/xmlnametable/). |
