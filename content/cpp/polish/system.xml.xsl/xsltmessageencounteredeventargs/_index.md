...
description: "Udostępnia dane dla zdarzenia XsltArgumentList::XsltMessageEncountered."
type: docs
weight: 92
url: /pl/system.xml.xsl/xsltmessageencounteredeventargs/
---
## XsltMessageEncounteredEventArgs klasa
...
| virtual [String](../../system/string/) [get_Message](./get_message/)() | Zwraca zawartość elementu **xsl:message**. |
...
| Pole | Opis |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Statyczny członek reprezentujący \"pusty\" [EventArgs](../../system/eventargs/) wskaźnik współdzielony (wskaźnik zerowy). |
## Definicje typów
