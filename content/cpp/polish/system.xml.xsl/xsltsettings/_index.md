...
description: Określa funkcje XSLT, które mają być obsługiwane podczas wykonywania arkusza stylów XSLT.
type: docs
weight: 118
url: /pl/system.xml.xsl/xsltsettings/
---
## Klasa XsltSettings


Określa funkcje XSLT, które mają być obsługiwane podczas wykonywania arkusza stylów XSLT.
...
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_Default](./get_default/)() | Zwraca obiekt [XsltSettings](./) z ustawieniami domyślnymi. Obsługa funkcji XSLT **document()** oraz osadzonych bloków skryptów jest wyłączona. |
| **bool** [get_EnableDocumentFunction](./get_enabledocumentfunction/)() | Zwraca wartość wskazującą, czy włączyć obsługę funkcji XSLT **document()**. |
| **bool** [get_EnableScript](./get_enablescript/)() | Zwraca wartość wskazującą, czy włączyć obsługę osadzonych bloków skryptów. |
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_TrustedXslt](./get_trustedxslt/)() | Zwraca obiekt [XsltSettings](./), który umożliwia obsługę funkcji XSLT **document()** oraz osadzonych bloków skryptów. |
...
| void [set_EnableDocumentFunction](./set_enabledocumentfunction/)(**bool**) | Ustawia wartość wskazującą, czy włączyć obsługę funkcji XSLT **document()**. |
| void [set_EnableScript](./set_enablescript/)(**bool**) | Ustawia wartość wskazującą, czy włączyć obsługę osadzonych bloków skryptów. |
...
|  [XsltSettings](./xsltsettings/)() | Inicjalizuje nową instancję klasy [XsltSettings](./) z ustawieniami domyślnymi. |
|  [XsltSettings](./xsltsettings/)(**bool**, **bool**) | Inicjalizuje nową instancję klasy [XsltSettings](./) z określonymi ustawieniami. |
...
Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze owijaj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej do funkcji jako argument. 
