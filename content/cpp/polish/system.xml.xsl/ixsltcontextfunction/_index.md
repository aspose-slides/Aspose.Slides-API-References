...
description: Udostępnia interfejs do określonej funkcji zdefiniowanej w arkuszu stylów Extensible Stylesheet Language for Transformations (XSLT) podczas wykonywania w czasie rzeczywistym.
type: docs
weight: 27
url: /pl/system.xml.xsl/ixsltcontextfunction/
---
## IXsltContextFunction klasa

Zapewnia interfejs do określonej funkcji zdefiniowanej w Extensible Stylesheet Language for Transformations (XSLT) podczas wykonywania w czasie rzeczywistym.
...
| virtual [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\> [get_ArgTypes](./get_argtypes/)() | Zwraca dostarczone typy XML Path Language ([XPath](../../system.xml.xpath/)) dla listy argumentów funkcji. Ta informacja może być użyta do odkrycia sygnatury funkcji, co pozwala odróżnić przeciążone funkcje. |
| virtual **int32_t** [get_Maxargs](./get_maxargs/)() | Zwraca maksymalną liczbę argumentów funkcji. Umożliwia to użytkownikowi odróżnienie przeciążonych funkcji. |
| virtual **int32_t** [get_Minargs](./get_minargs/)() | Zwraca minimalną liczbę argumentów funkcji. Umożliwia to użytkownikowi odróżnienie przeciążonych funkcji. |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_ReturnType](./get_returntype/)() | Zwraca XPathResultType reprezentujący typ [XPath](../../system.xml.xpath/) zwracany przez funkcję. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Invoke](./invoke/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>, [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>, [SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | Udostępnia metodę wywołania funkcji z podanymi argumentami w określonym kontekście. |
