...
description: Reprezentuje zawartość tekstową elementu lub atrybutu.
type: docs
weight: 495
url: /pl/system.xml/xmltext/
---
## XmlText klasa
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) stałej wersji instancji kolekcji. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Zwraca iterator wskazujący tuż za ostatnim elementem (jeśli istnieje) w kolekcji. Ten iterator nie może być używany do zmiany referowanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca obiekt-kopię typu T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący tuż za ostatnim elementem (jeśli istnieje) stałej wersji instancji kolekcji. |
...
| virtual [String](../../system/string/) [get_BaseURI](../xmlnode/get_baseuri/)() | Zwraca podstawowy URI bieżącego węzła. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | Zwraca pierwszy węzeł podrzędny węzła. |
...
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | Zwraca połączone wartości węzła oraz wszystkich jego dzieci. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | Zwraca ostatni węzeł podrzędny węzła. |
...
| [String](../../system/string/) [get_Name](./get_name/)() override | Zwraca pełną nazwę węzła. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Zwraca zestaw informacji po walidacji schematu przypisany temu węzłowi w wyniku walidacji schematu. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Wyszukuje najbliższą deklarację **xmlns** dla podanego prefiksu, która jest w zasięgu bieżącego węzła i zwraca URI przestrzeni nazw w tej deklaracji. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](../xmlnode/insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Wstawia określony węzeł bezpośrednio po określonym węźle referencyjnym. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](../xmlnode/insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Wstawia określony węzeł bezpośrednio przed określonym węzłem referencyjnym. |
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Wstawia określony ciąg znaków pod określonym offsetem znakowym. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Zwraca pierwszy element sekwencji lub domyślną wartość, jeśli sekwencja jest pusta. |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Zwraca pierwszy element sekwencji spełniający warunek lub domyślną wartość, jeśli taki element nie zostanie znaleziony. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Zwraca ostatni element sekwencji lub domyślną wartość, jeśli sekwencja jest pusta. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Zastępuje określoną liczbę znaków począwszy od podanego offsetu podanym ciągiem. |
...
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Ustawia połączone wartości węzła oraz wszystkich jego dzieci. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlText](./)\> [SplitText](./splittext/)(**int32_t**) | Dzieli węzeł na dwa węzły w podanym offsetcie, zachowując oba w drzewie jako rodzeństwo. |
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Pobiera podciąg pełnego ciągu znaków z określonego zakresu. |
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Testuje, czy implementacja DOM obsługuje określoną funkcję. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Zapisuje wszystkie dzieci węzła do określonego [XmlWriter](../xmlwriter/). Węzły [XmlText](./) nie mają dzieci, więc metoda nie ma wpływu. |
...
| Definicja typu | Opis |
| --- | --- |
| [Ptr](./ptr/) | Alias do wskaźnika współdzielonego na instancję tej klasy. |
