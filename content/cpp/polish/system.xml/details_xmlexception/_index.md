...
description: Zwraca szczegółowe informacje o ostatnim wyjątku.
type: docs
weight: 1
url: /pl/system.xml/details_xmlexception/
---
## Details_XmlException klasa
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Zwraca numer wiersza wskazujący, gdzie wystąpił błąd. Numery wierszy zaczynają się od 1. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Zwraca pozycję wiersza wskazującą, gdzie wystąpił błąd. Pozycja wiersza zaczyna się od 1. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Zwraca komunikat opisujący bieżący wyjątek. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Zwraca lokalizację pliku XML. |
