...
description: Udostępnia metody manipulacji tekstem używane przez kilka klas.
type: docs
weight: 118
url: /pl/system.xml/xmlcharacterdata/
---
## XmlCharacterData klasa
...
| virtual void [AppendData](./appenddata/)([String](../../system/string/)) | Dołącza określony ciąg znaków na koniec danych znakowych węzła. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany odwoływanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący na pozycję bezpośrednio po ostatnim elemencie oznaczonym jako const (jeśli istnieje) w kolekcji. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Tworzy duplikat tego węzła. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Tworzy duplikat węzła, gdy metoda jest przesłonięta w klasie pochodnej. |
...
| virtual void [DeleteData](./deletedata/)(**int32_t**, **int32_t**) | Usuwa zakres znaków z węzła. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Zwraca iterator wskazujący na pozycję bezpośrednio po ostatnim elemencie (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany odwoływanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący na pozycję bezpośrednio po ostatnim elemencie (jeśli istnieje) stałej instancji kolekcji. |
...
| virtual [String](../../system/string/) [get_Data](./get_data/)() | Zwraca dane węzła. |
...
| virtual **int32_t** [get_Length](./get_length/)() | Zwraca długość danych w znakach. |
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | Zwraca lokalną nazwę węzła, gdy metoda jest przesłonięta w klasie pochodnej. |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | Zwraca w pełni kwalifikowaną nazwę węzła, gdy metoda jest przesłonięta w klasie pochodnej. |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | Zwraca typ bieżącego węzła, gdy metoda jest przesłonięta w klasie pochodnej. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | Zwraca węzeł tekstowy, który natychmiast poprzedza ten węzeł. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Zwraca enumerator iterujący po węzłach potomnych w bieżącym węźle. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Odpowiednik metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia haszowanie własnych obiektów. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Wyszukuje najbliższą deklarację **xmlns** dla podanego prefiksu, który jest w zasięgu bieżącego węzła i zwraca URI przestrzeni nazw w tej deklaracji. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Wyszukuje najbliższą deklarację **xmlns** dla podanego URI przestrzeni nazw, który jest w zasięgu bieżącego węzła i zwraca prefiks zdefiniowany w tej deklaracji. |
...
| virtual void [InsertData](./insertdata/)(**int32_t**, [String](../../system/string/)) | Wstawia określony ciąg znaków pod podanym offsetem znakowym. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Określa, czy istnieje dowolny element sekwencji lub spełnia warunek. |
...
| void [Lock](../../system/object/lock/)() | Implementuje odblokowanie instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Odpowiednik metody C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umożliwia klonowanie własnych typów. |
| virtual void [Normalize](../xmlnode/normalize/)() | Umieszcza wszystkie węzły [XmlText](../xmltext/) na pełnej głębokości poddrzewa pod tym [XmlNode](../xmlnode/) w „normalną” formę, w której tylko znaczniki (tj. tagi, komentarze, instrukcje przetwarzania, sekcje CDATA i odwołania do encji) oddzielają węzły [XmlText](../xmltext/), czyli nie ma sąsiadujących węzłów [XmlText](../xmltext/). |
...
| virtual void [ReplaceData](./replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Zastępuje określoną liczbę znaków zaczynając od podanego offsetu podanym ciągiem. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Wybiera listę węzłów pasujących do wyrażenia [XPath](../../system.xml.xpath/). Wszelkie prefiksy znalezione w wyrażeniu [XPath](../../system.xml.xpath/) są rozwiązywane przy użyciu dostarczonego [XmlNamespaceManager](../xmlnamespacemanager/). |
...
| virtual void [set_Data](./set_data/)([String](../../system/string/)) | Ustawia dane węzła. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Ustawia połączone wartości węzła oraz wszystkich jego dzieci. |
...
| virtual [String](../../system/string/) [Substring](./substring/)(**int32_t**, **int32_t**) | Pobiera podciąg pełnego ciągu znaków z podanego zakresu. |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Zapisuje wszystkie węzły potomne węzła do określonego [XmlWriter](../xmlwriter/), gdy metoda jest przesłonięta w klasie pochodnej. |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Zapisuje bieżący węzeł do określonego [XmlWriter](../xmlwriter/), gdy metoda jest przesłonięta w klasie pochodnej. |
