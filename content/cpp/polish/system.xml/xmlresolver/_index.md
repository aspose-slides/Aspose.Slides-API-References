...
description: Rozwiązuje zewnętrzne zasoby XML określone przez jednolity identyfikator zasobów (URI).
type: docs
weight: 456
url: /pl/system.xml/xmlresolver/
---
## XmlResolver klasa

Rozwiązuje zewnętrzne zasoby XML określone przez jednolity identyfikator zasobów (URI).
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetEntity](./getentity/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), const [TypeInfo](../../system/typeinfo/)\&) | Gdy zostanie przesłonięta w klasie pochodnej, mapuje URI na obiekt zawierający faktyczny zasób. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. W rzeczywistości nic nie kopiuje, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie konstruktorów klas pochodnych. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. W rzeczywistości nic nie kopiuje, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie konstruktorów klas pochodnych. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) | Gdy zostanie przesłonięta w klasie pochodnej, rozwiązuje absolutny URI z bazowego i względnych URI. |
| virtual void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) | Gdy zostanie przesłonięta w klasie pochodnej, ustawia poświadczenia używane do uwierzytelniania żądań sieciowych. |
...
| virtual **bool** [SupportsType](./supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | Umożliwia resolverowi zwracanie typów innych niż Stream. |
