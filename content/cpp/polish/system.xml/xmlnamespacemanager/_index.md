...
description: Rozwiązuje, dodaje i usuwa przestrzenie nazw w kolekcji oraz zapewnia zarządzanie zakresem dla tych przestrzeni nazw.
type: docs
weight: 300
url: /pl/system.xml/xmlnamespacemanager/
---
## XmlNamespaceManager klasa

Rozwiązuje, dodaje i usuwa przestrzenie nazw w kolekcji oraz zapewnia zarządzanie zakresem dla tych przestrzeni nazw.
...
| Metoda | Opis |
| --- | --- |
| virtual void [AddNamespace](./addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Dodaje podaną przestrzeń nazw do kolekcji. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) stałej kwalifikowanej instancji kolekcji. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) o stałej kwalifikacji w kolekcji. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie o stałej kwalifikacji (jeśli istnieje) w kolekcji. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) stałej kwalifikowanej instancji kolekcji. |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](./get_defaultnamespace/)() | Zwraca URI przestrzeni nazw dla domyślnej przestrzeni nazw. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\> [get_NameTable](./get_nametable/)() | Zwraca [XmlNameTable](../xmlnametable/) powiązany z tym obiektem. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator używany do iteracji po przestrzeniach nazw w [XmlNamespaceManager](./). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Odpowiednik metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia haszowanie własnych obiektów. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](./getnamespacesinscope/)([XmlNamespaceScope](../xmlnamespacescope/)) override | Zwraca kolekcję nazw przestrzeni nazw kluczowaną prefiksem, którą można użyć do wyliczenia aktualnie obowiązujących przestrzeni nazw. |
...
| virtual **bool** [HasNamespace](./hasnamespace/)([String](../../system/string/)) | Zwraca wartość wskazującą, czy podany prefiks ma zdefiniowaną przestrzeń nazw w bieżącym zakresowym stosie. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią z sekwencji wartości uzyskanych poprzez wywołanie funkcji transformującej na każdym elemencie wejsciowej sekwencji. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Sortuje elementy sekwencji w kolejności rosnącej wg wartości klucza wybranych przez keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Sortuje elementy sekwencji w kolejności malejącej wg wartości klucza wybranych przez keySelector. |
...
| [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) override | Zwraca URI przestrzeni nazw dla określonego prefiksu. |
| [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) override | Znajduje prefiks zadeklarowany dla podanego URI przestrzeni nazw. |
...
| virtual **bool** [PopScope](./popscope/)() | Usuwa zakres przestrzeni nazw ze stosu. |
| virtual void [PushScope](./pushscope/)() | Umieszcza zakres przestrzeni nazw na stosie. |
...
| virtual void [RemoveNamespace](./removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Usuwa podaną przestrzeń nazw dla podanego prefiksu. |
...
|  [XmlNamespaceManager](./xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | Inicjalizuje nową instancję klasy [XmlNamespaceManager](./) z określonym [XmlNameTable](../xmlnametable/). |
