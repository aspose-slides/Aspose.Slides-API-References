...
description: Reprezentuje sekcję CDATA.
type: docs
weight: 105
url: /pl/system.xml/xmlcdatasection/
---
## XmlCDataSection klasa
...
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Dodaje określony łańcuch znaków na koniec danych znakowych węzła. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) stałej (const-kwalifikowanej) instancji kolekcji. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Zwraca iterator wskazujący na pierwszy element kwalifikowany jako const (jeśli istnieje) kolekcji. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie kwalifikowanym jako const (jeśli istnieje) kolekcji. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie (jeśli istnieje) stałej (const-kwalifikowanej) instancji kolekcji. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | Zwraca pierwszy węzeł potomny węzła. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | Zwraca ostatni węzeł potomny węzła. |
| virtual **int32_t** [get_Length](../xmlcharacterdata/get_length/)() | Zwraca długość danych w znakach. |
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Zwraca nazwę lokalną węzła. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Wstawia określony łańcuch znaków pod określonym odsunięciem znakowym. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Zwraca liczbę elementów w sekwencji (obliczoną poprzez liczenie bezpośrednie). |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza współny licznik referencji o określoną wartość. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Zastępuje określoną liczbę znaków zaczynając od określonego offsetu podanym łańcuchem znaków. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Pobiera podciąg pełnego łańcucha znaków z określonego zakresu. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Zapisuje dzieci węzła do określonego [XmlWriter](../xmlwriter/). |
...
Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy w czasie wykonywania i/lub błędy asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej do funkcji jako argument.
