...
description: Implementuje jednowątkowy XmlNameTable.
type: docs
weight: 66
url: /pl/system.xml/nametable/
---
## NameTable klasa

Implementuje jednowątkowy [XmlNameTable](../xmlnametable/).
...
| Metoda | Opis |
| --- | --- |
| const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) override | Atomizuje podany ciąg znaków i dodaje go do [NameTable](./). |
| const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | Atomizuje podany ciąg znaków i dodaje go do [NameTable](./). |
...
| const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) override | Zwraca atomizowany ciąg znaków o podanej wartości. |
| const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | Zwraca atomizowany ciąg znaków zawierający te same znaki co określony zakres znaków w podanej tablicy. |
...
|  [NameTable](./nametable/)() | Inicjalizuje nową instancję klasy [NameTable](./). |
...
Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy pomocy operatora new, ponieważ spowoduje to błędy w czasie działania i/lub naruszenia asercji. Zawsze otaczaj tę klasę wskaźnikiem [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go do funkcji jako argument.
