...
description: Reprezentuje węzeł deklaracji XML <?xml version='1.0'...?>.
type: docs
weight: 170
url: /pl/system.xml/xmldeclaration/
---
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) w stałej wersji kolekcji. |
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | Zwraca poziom kodowania dokumentu XML. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Zwraca połączone wartości [XmlDeclaration](./). |
...
| virtual [String](../../system/string/) [get_Prefix](../xmlnode/get_prefix/)() | Zwraca przedrostek przestrzeni nazw tego węzła. |
...
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | Zwraca wartość atrybutu standalone. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Zwraca wartość [XmlDeclaration](./). |
| [String](../../system/string/) [get_Version](./get_version/)() | Zwraca wersję XML dokumentu. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Zwraca enumerator, który iteruje po węzłach potomnych w bieżącym węźle. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projekcje każdego elementu sekwencji i łączenie uzyskanych sekwencji w jedną. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza licznik referencji współdzielonych o określoną wartość. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&) | Wybiera listę węzłów pasujących do wyrażenia [XPath](../../system.xml.xpath/). Wszystkie prefiksy znalezione w wyrażeniu [XPath](../../system.xml.xpath/) są rozwiązywane przy użyciu dostarczonego [XmlNamespaceManager](../xmlnamespacemanager/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Wybiera listę węzłów pasujących do wyrażenia [XPath](../../system.xml.xpath/). |
...
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | Ustawia poziom kodowania dokumentu XML. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Ustawia połączone wartości [XmlDeclaration](./). |
...
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Ustawia przedrostek przestrzeni nazw tego węzła. |
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | Ustawia wartość atrybutu standalone. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Ustawia wartość [XmlDeclaration](./). |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Zwraca bieżącą wartość licznika referencji współdzielonych. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Zapisuje potomków węzła do określonego [XmlWriter](../xmlwriter/). Ponieważ węzły [XmlDeclaration](./) nie mają potomków, ta metoda nie ma żadnego efektu. |
