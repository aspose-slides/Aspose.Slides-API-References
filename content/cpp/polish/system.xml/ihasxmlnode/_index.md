...
description: Umożliwia klasie zwrócenie XmlNode z bieżącego kontekstu lub pozycji.
type: docs
weight: 27
url: /pl/system.xml/ihasxmlnode/
---
## IHasXmlNode klasa

Umożliwia klasie zwrócenie [XmlNode](../xmlnode/) z bieżącego kontekstu lub pozycji.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNode](./getnode/)() | Zwraca [XmlNode](../xmlnode/) dla bieżącej pozycji. |
