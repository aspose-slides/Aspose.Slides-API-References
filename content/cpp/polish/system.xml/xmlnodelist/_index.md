...
description: Reprezentuje uporządkowaną kolekcję węzłów.
type: docs
weight: 352
url: /pl/system.xml/xmlnodelist/
---
## XmlNodeList klasa
...
| virtual **int32_t** [get_Count](./get_count/)() | Zwraca liczbę węzłów w [XmlNodeList](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](./getenumerator/)() | Zapewnia wsparcie iteracji po kolekcji węzłów w [XmlNodeList](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca węzeł o podanym indeksie. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Item](./item/)(**int32_t**) | Pobiera węzeł o podanym indeksie. |
...
| Definicja typu | Opis |
| --- | --- |
| [Ptr](./ptr/) | Aliasing dla współdzielonego wskaźnika do instancji tej klasy. |
