...
description: Klasa atrapa, aby umożliwić kompilację przetłumaczonego kodu używającego klasy SystemInformation. Metody nie są zaimplementowane. Jest to typ statyczny bez usług instancji. Nie należy nigdy tworzyć jego instancji w żaden sposób.
type: docs
weight: 53
url: /pl/system.windows.forms/systeminformation/
---
## SystemInformation struktura

Klasa atrapa, aby umożliwić kompilację przetłumaczonego kodu używającego klasy [SystemInformation](./). Metody nie są zaimplementowane. Jest to typ statyczny bez usług instancji. Nie należy nigdy tworzyć jego instancji w żaden sposób.
