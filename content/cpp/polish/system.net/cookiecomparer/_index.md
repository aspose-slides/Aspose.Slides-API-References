...
| Metoda | Opis |
| --- | --- |
| int [Compare](./compare/)([args_type](../../system.collections.generic/icomparer/args_type/), [args_type](../../system.collections.generic/icomparer/args_type/)) const override | Porównuje określone obiekty. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[CookieComparer](./)\> [get_Instance](./get_instance/)() | Implementacja 'singleton'. Zawsze zwraca tę samą instancję tej klasy. |
