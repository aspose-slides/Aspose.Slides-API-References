...
description: "Abstrakcyjna klasa zawiera adres sieciowy. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami czasu wykonania i/lub awariami asercji. Zawsze opakowuj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji."
type: docs
weight: 131
url: /pl/system.net/endpoint/
---
## Klasa EndPoint

Abstrakcyjna klasa zawiera adres sieciowy. Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika, aby przekazać ją do funkcji jako argument.
...
| Metoda | Opis |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[EndPoint](./)\> [Create](./create/)([System::SharedPtr](../../system/sharedptr/)\<[SocketAddress](../socketaddress/)\>) | Utwórz nową instancję klasy [EndPoint](./) przy użyciu określonego adresu gniazda. |
...
| virtual [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/) [get_AddressFamily](./get_addressfamily/)() | Zwraca rodzinę adresów, do której należy bieżąca instancja. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Odpowiednik metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia haszowanie własnych obiektów. |
| virtual [ImplPtr](./implptr/) [GetImpl](./getimpl/)() const | Zwraca wskaźnik do implementacji. |
...
| Definicja typu | Opis |
| --- | --- |
| [ImplPtr](./implptr/) | Wskaźnik do implementacji. |
