...
description: "Zapewnia poświadczenia dla schematów uwierzytelniania opartego na haśle. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani nie używaj operatora new, ponieważ może to powodować błędy czasu wykonania i/lub awarie asercji. Zawsze otaczaj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji."
type: docs
weight: 391
url: /pl/system.net/networkcredential/
---
...
| [String](../../system/string/) [get_Domain](./get_domain/)() | Pobiera domenę weryfikującą poświadczenia. |
| [String](../../system/string/) [get_Password](./get_password/)() | Pobiera hasło. |
| [String](../../system/string/) [get_UserName](./get_username/)() | Pobiera nazwę użytkownika. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę licznika odwołań powiązaną z obiektem. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę licznika odwołań powiązaną z obiektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](./)\> [GetCredential](./getcredential/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) override | Zwraca poświadczenia dla określonego URI i typu uwierzytelnienia. |
| [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](./)\> [GetCredential](./getcredential/)([String](../../system/string/), **int32_t**, [String](../../system/string/)) override | Zwraca poświadczenia dla określonej nazwy hosta, portu i typu uwierzytelnienia. |
...
|  [NetworkCredential](./networkcredential/)() | Tworzy nową instancję. |
|  [NetworkCredential](./networkcredential/)([String](../../system/string/), [String](../../system/string/)) | Tworzy nową instancję. |
|  [NetworkCredential](./networkcredential/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | Tworzy nową instancję. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza licznik współdzielonych odwołań o podaną wartość. |
| void [set_Domain](./set_domain/)([String](../../system/string/)) | Ustawia domenę weryfikującą poświadczenia. |
| void [set_Password](./set_password/)([String](../../system/string/)) | Ustawia hasło. |
| void [set_UserName](./set_username/)([String](../../system/string/)) | Ustawia nazwę użytkownika. |
