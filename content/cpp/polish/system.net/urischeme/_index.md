...
description: "Reprezentuje schemat URI. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub awarie asercji. Zawsze otaczaj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania jej do funkcji jako argument."
type: docs
weight: 456
url: /pl/system.net/urischeme/
---
## UriScheme klasa


Reprezentuje schemat URI. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonywania i/lub awarie asercji. Zawsze otaczaj tę klasę wskaźnikiem [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej do funkcji jako argumentu.
...
| Pole | Opis |
| --- | --- |
| static [Http](./http/) | Reprezentacja łańcucha HTTP. |
| static [Https](./https/) | Reprezentacja łańcucha HTTPS. |
| static [SchemeDelimiter](./schemedelimiter/) | Łańcuch reprezentujący separator schematu. |
| static [Ws](./ws/) | Reprezentacja łańcucha WS. |
| static [Wss](./wss/) | Reprezentacja łańcucha WSS. |
