...
description: "Używany do przechowywania zserializowanych informacji o instancjach klasy EndPoint. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub błędy asercji. Zawsze otaczaj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika jako argumentu w funkcjach."
type: docs
weight: 443
url: /pl/system.net/socketaddress/
---
## SocketAddress klasa
...
| [Sockets::AddressFamily](../../system.net.sockets/addressfamily/) [get_Family](./get_family/)() | Zwraca rodzinę adresów. |
| **int32_t** [get_Size](./get_size/)() | Zwraca rozmiar bazowego bufora. |
...
| **uint8_t** [idx_get](./idx_get/)(**int32_t**) | Pobiera wartość bazowego bufora pod określonym indeksem. |
| void [idx_set](./idx_set/)(**int32_t**, **uint8_t**) | Ustawia wartość bazowego bufora pod określonym indeksem. |
...
|  [SocketAddress](./socketaddress/)([Sockets::AddressFamily](../../system.net.sockets/addressfamily/)) | Tworzy nową instancję. |
|  [SocketAddress](./socketaddress/)([Sockets::AddressFamily](../../system.net.sockets/addressfamily/), **int32_t**) | Tworzy nową instancję. |
