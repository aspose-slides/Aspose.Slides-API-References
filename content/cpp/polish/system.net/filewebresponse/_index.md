...
description: "Zapewnia implementację abstrakcyjnej klasy WebResponse do pracy z systemem plików. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami czasu wykonywania i/lub błędami asercji. Zawsze otaczaj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 157
url: /pl/system.net/filewebresponse/
---
...
| Metoda | Opis |
| --- | --- |
| void [Close](./close/)() override | Zamyka strumień odpowiedzi. |
| void [Dispose](../webresponse/dispose/)() override | Nie robi nic. |
...
|  [FileWebResponse](./filewebresponse/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Tworzy nową instancję. |
| **int64_t** [get_ContentLength](./get_contentlength/)() override | Zwraca liczbę bajtów zasobu. |
| [String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Zwraca typ MIME zasobu. |
| [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](./get_headers/)() override | Zwraca kolekcję nagłówków powiązanych z bieżącą odpowiedzią. |
| [System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [get_ResponseUri](./get_responseuri/)() override | Zwraca URI zasobu. |
| **bool** [get_SupportsHeaders](./get_supportsheaders/)() override | Zwraca wartość wskazującą, czy bieżąca odpowiedź obsługuje nagłówki. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia haszowanie własnych obiektów. |
| [System::SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetResponseStream](./getresponsestream/)() override | Zwraca strumień odpowiedzi. |
