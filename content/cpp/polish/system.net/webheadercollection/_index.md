...
description: "Reprezentuje kolekcję nagłówków protokołu. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub błędy asercji. Zawsze owiń tę klasę wskaźnikiem System::SmartPtr i użyj tego wskaźnika jako argumentu w wywołaniach funkcji."
type: docs
weight: 482
url: /pl/system.net/webheadercollection/
---
## WebHeaderCollection klasa

Reprezentuje kolekcję nagłówków protokołu. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub błędy asercji. Zawsze owiń tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i użyj tego wskaźnika, aby przekazać go do funkcji jako argument.
