...
| **int32_t** [get_Id](./get_id/)() const | Zwraca identyfikator właściwości reprezentowanej przez bieżący obiekt. |
| **int32_t** [get_Len](./get_len/)() const | Zwraca długość właściwości reprezentowanej przez bieżący obiekt w bajtach. |
| **int16_t** [get_Type](./get_type/)() const | Zwraca typ właściwości reprezentowanej przez bieżący obiekt w bajtach. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Value](./get_value/)() const | Zwraca wartość właściwości reprezentowanej przez bieżący obiekt w bajtach. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje niczego, właściwie, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje niczego, właściwie, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
|  [PropertyItem](./propertyitem/)() | Tworzy nową instancję klasy [PropertyItem](./). |
...
| void [set_Id](./set_id/)(**int32_t**) | Ustawia identyfikator właściwości reprezentowanej przez bieżący obiekt. |
| void [set_Len](./set_len/)(**int32_t**) | Ustawia długość właściwości reprezentowanej przez bieżący obiekt w bajtach. |
| void [set_Type](./set_type/)(**int16_t**) | Ustawia typ właściwości reprezentowanej przez bieżący obiekt w bajtach. |
| void [set_Value](./set_value/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Ustawia typ właściwości reprezentowanej przez bieżący obiekt w bajtach. |
