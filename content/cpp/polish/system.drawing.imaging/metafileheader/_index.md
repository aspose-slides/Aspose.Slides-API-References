...
description: "Zawiera atrybuty powiązane z graficznym metafilem. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go do funkcji jako argument."
type: docs
weight: 157
url: /pl/system.drawing.imaging/metafileheader/
---
## MetafileHeader klasa

Zawiera atrybuty powiązane z graficznym metafilem. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy wykonania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go do funkcji jako argument.
...
| [Rectangle](../../system.drawing/rectangle/) [get_Bounds](./get_bounds/)() const | Zwraca prostokąt ograniczający metafil związany z bieżącym obiektem. |
| **float** [get_DpiX](./get_dpix/)() const | NIE ZAIMPLEMENTOWANO. |
| **float** [get_DpiY](./get_dpiy/)() const | NIE ZAIMPLEMENTOWANO. |
...
| void [set_Bounds](./set_bounds/)(const [Rectangle](../../system.drawing/rectangle/)\&) | Ustawia prostokąt ograniczający metafil związany z bieżącym obiektem. |
