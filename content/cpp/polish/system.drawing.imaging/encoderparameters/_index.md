...
description: "Reprezentuje tablicę obiektów EncoderParameter. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 79
url: /pl/system.drawing.imaging/encoderparameters/
---
## Klasa EncoderParameters


Reprezentuje tablicę obiektów [EncoderParameter](../encoderparameter/). Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu działania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji.
...
| Metoda | Opis |
| --- | --- |
|  [EncoderParameters](./encoderparameters/)(int) | Tworzy nową instancję klasy [EncoderParameters](./). |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\> [get_Param](./get_param/)() const | Zwraca tablicę obiektów [EncoderParameter](../encoderparameter/) reprezentowanych przez bieżący obiekt [EncoderParameters](./). |
...
| void [set_Param](./set_param/)(const [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\>\&) | Przypisuje tablicę obiektów [EncoderParameter](../encoderparameter/) do bieżącego obiektu [EncoderParameters](./). |
