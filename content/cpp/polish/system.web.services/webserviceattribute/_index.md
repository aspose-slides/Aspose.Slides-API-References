...
description: "Dodaje dodatkowe informacje do usługi sieciowej XML. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go do funkcji jako argument."
type: docs
weight: 27
url: /pl/system.web.services/webserviceattribute/
---
## WebServiceAttribute klasa

Dodaje dodatkowe informacje do usługi XML [Web](../../system.web/). Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze umieszczaj tę klasę w wskaźniku [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej do funkcji jako argumentu.
...
| [String](../../system/string/) [get_Description](./get_description/)() | Pobiera komunikat zawierający opis usługi XML [Web](../../system.web/). |
| [String](../../system/string/) [get_Name](./get_name/)() | Pobiera nazwę usługi XML [Web](../../system.web/). |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Pobiera domyślną przestrzeń nazw używaną dla usługi XML [Web](../../system.web/). |
...
| void [set_Description](./set_description/)([String](../../system/string/)) | Ustawia komunikat zawierający opis usługi XML [Web](../../system.web/). |
| void [set_Name](./set_name/)([String](../../system/string/)) | Ustawia nazwę usługi XML [Web](../../system.web/). |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Ustawia domyślną przestrzeń nazw używaną dla usługi XML [Web](../../system.web/). |
...
|  [WebServiceAttribute](./webserviceattribute/)() | Tworzy nową instancję. |
...
| Pole | Opis |
| --- | --- |
| static [DefaultNamespace](./defaultnamespace/) | Domyślna wartość właściwości 'Namespace'. |
