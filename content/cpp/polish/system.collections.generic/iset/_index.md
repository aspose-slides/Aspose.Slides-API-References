...
description: "Interfejs kolekcji zawierającej zbiór unikalnych elementów. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu funkcjom."
type: docs
weight: 352
url: /pl/system.collections.generic/iset/
---
## ISet klasa

Interfejs zbioru zawierającego zestaw unikalnych elementów. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub błędy asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej funkcjom jako argument.
...
| Metoda | Opis |
| --- | --- |
| virtual void [Add](../icollection/add/)(const T\&) | Dodaje element do zbioru. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) zbioru. Ten iterator nie może być używany do zmiany referencjonowanego obiektu, ponieważ [GetEnumerator()](../ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) const-kwalifikowanej instancji zbioru. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Zwraca iterator wskazujący na pierwszy const-kwalifikowany element (jeśli istnieje) zbioru. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Zwraca iterator wskazujący tuż po ostatnim const-kwalifikowanym elemencie (jeśli istnieje) zbioru. |
| virtual void [Clear](../icollection/clear/)() | Usuwa wszystkie elementy ze zbioru. |
| virtual **bool** [Contains](../icollection/contains/)(const T\&) const | Sprawdza, czy element jest obecny w zbiorze. |
| virtual void [CopyTo](../icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopiuje wszystkie elementy zbioru do istniejących elementów tablicy. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) zbioru. Ten iterator nie może być używany do zmiany referencjonowanego obiektu, ponieważ [GetEnumerator()](../ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie (jeśli istnieje) const-kwalifikowanej instancji zbioru. |
...
| virtual void [ExceptWith](./exceptwith/)([IEnumerablePtr](./ienumerableptr/)) | Usuwa grupę elementów. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Tylko do użytku wewnętrznego. |
| virtual int [get_Count](../icollection/get_count/)() const | Zwraca liczbę elementów w zbiorze. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Sprawdza, czy zbiór jest tylko do odczytu. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../icollection/get_syncroot/)() const | Zwraca obiekt, za pośrednictwem którego synchronizowany jest zbiór. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Zwraca rzeczywisty typ obiektu. Analogiczna metoda C# [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual void [IntersectWith](./intersectwith/)([IEnumerablePtr](./ienumerableptr/)) | Usuwa elementy nieobecne w innym kontenerze. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Sprawdza, czy obiekt jest instancją typu opisanego przez targetType. Analog operatora C# 'is'. |
| virtual **bool** [IsProperSubsetOf](./ispropersubsetof/)([IEnumerablePtr](./ienumerableptr/)) | Sprawdza, czy bieżący zbiór jest ścisłym podzbiorem innego kontenera. |
| virtual **bool** [IsProperSupersetOf](./ispropersupersetof/)([IEnumerablePtr](./ienumerableptr/)) | Sprawdza, czy bieżący zbiór jest ścisłym nadzbiorem innego kontenera. |
| virtual **bool** [IsSubsetOf](./issubsetof/)([IEnumerablePtr](./ienumerableptr/)) | Sprawdza, czy bieżący zbiór jest podzbiorem innego kontenera. |
| virtual **bool** [IsSupersetOf](./issupersetof/)([IEnumerablePtr](./ienumerableptr/)) | Sprawdza, czy bieżący zbiór jest nadzbiorem innego kontenera. |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)(std::function\<**bool**(T)>) | Określa, czy jakikolwiek element sekwencji istnieje lub spełnia warunek. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokowanie w stylu instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu stróża [LockContext](../../system/lockcontext/). |
...
| virtual **bool** [Overlaps](./overlaps/)([IEnumerablePtr](./ienumerableptr/)) | Sprawdza, czy zbiór zachodzi na inny kontener. |
...
| virtual **bool** [Remove](../icollection/remove/)(const T\&) | Usuwa element ze zbioru. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza współdzielony licznik referencji o określoną wartość. |
| virtual **bool** [SetEquals](./setequals/)([IEnumerablePtr](./ienumerableptr/)) | Sprawdza, czy zbiór i kontener zawierają te same elementy. |
...
| virtual void [SymmetricExceptWith](./symmetricexceptwith/)([IEnumerablePtr](./ienumerableptr/)) | Oblicza symetryczną różnicę dwóch kontenerów. Usuwa wszystkie elementy, które są obecne w obu kontenerach, a jednocześnie dodaje wszystkie elementy obecne w **other**, ale nie w bieżącym zbiorze. |
...
| virtual void [UnionWith](./unionwith/)([IEnumerablePtr](./ienumerableptr/)) | Dodaje elementy z określonej kolekcji, które jeszcze nie występują w bieżącym zbiorze. |
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie w stylu instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu stróża [LockContext](../../system/lockcontext/). |
...
| Definicja | Opis |
| --- | --- |
| [IEnumerablePtr](./ienumerableptr/) | Typ wyliczeniowy do porównania zawartości bieżącego zestawu. |

## Zobacz także

* Klasa [ICollection](../icollection/)
