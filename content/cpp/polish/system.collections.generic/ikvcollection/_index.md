...
description: "Interfejs kontenera zawierającego klucze lub wartości kontenera podobnego do słownika. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze otaczaj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 326
url: /pl/system.collections.generic/ikvcollection/
---
## IKVCollection klasa


Interfejs kontenera zawierającego klucze lub wartości kontenera podobnego do słownika. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze otaczaj tę klasę wskaźnikiem [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji.
...
| Metoda | Opis |
| --- | --- |
| void [Add](./add/)(const T\&) override | Dodaje element do kontenera. |
...
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) wersji kolekcji oznaczonej jako const. |
...
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie oznaczonym jako const (jeśli istnieje) w kolekcji. |
| void [Clear](./clear/)() override | Usuwa wszystkie elementy z kontenera. |
| **bool** [Contains](./contains/)(const T\&) const override | Sprawdza, czy element znajduje się w kontenerze. |
...
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany referencjonowanego obiektu, ponieważ [GetEnumerator()](../ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie (jeśli istnieje) wersji kolekcji oznaczonej jako const. |
...
| virtual int [get_Count](./get_count/)() const | Zwraca liczbę elementów w kontenerze. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Sprawdza, czy kolekcja ma stały rozmiar. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Sprawdza, czy kontener jest tylko do odczytu. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() | Zwraca enumerator dla kontenera. |
...
| virtual T [idx_get](./idx_get/)(int) const | Funkcja pobierająca. |
| void [idx_set](./idx_set/)(int, T) override | Funkcja ustawiająca. |
| int [IndexOf](./indexof/)(const T\&) const override | Zwraca indeks elementu w kontenerze. |
...
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią sekwencji wartości uzyskanych poprzez wywołanie funkcji transformacji na każdym elemencie sekwencji wejściowej. |
...
| int [LINQ_Count](../ienumerable/linq_count/)() | Zwraca liczbę elementów w sekwencji (liczoną bezpośrednio). |
...
| void [Lock](../../system/object/lock/)() | Implementuje instrukcję C# lock() blokującą. Wywołaj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/). |
...
| **bool** [Remove](./remove/)(const T\&) override | Usuwa element z kontenera. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Inkrementuje współdzielony licznik referencji. Nie należy wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Dekrementuje i zwraca współdzielony licznik referencji. Nie należy wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Inkrementuje słaby licznik referencji. Nie należy wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Dekrementuje słaby licznik referencji. Nie należy wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
