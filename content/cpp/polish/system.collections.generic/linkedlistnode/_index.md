...
description: "Węzeł listy połączonej. Implementuje obudowę nad iteratorem std::list, który jest opakowany w listę połączoną. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz egzemplarza tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub błędy asercji. Zawsze otaczaj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika jako argumentu w funkcjach."
type: docs
weight: 417
url: /pl/system.collections.generic/linkedlistnode/
---
## LinkedListNode klasa

Węzeł listy połączonej. Implementuje obudowę nad iteratorem std::list, który jest zawinięty w listę połączoną. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz egzemplarza tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub awarie asercji. Zawsze opakuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i użyj tego wskaźnika jako argumentu w funkcjach.
...
| [SharedPtr](../../system/sharedptr/)\<[LinkedList](../linkedlist/)\<T\>\> [get_List](./get_list/)() const | Zwraca listę zawierającą. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Next](./get_next/)() const | Zwraca kolejny węzeł. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Previous](./get_previous/)() const | Zwraca poprzedni węzeł. |
| T [get_Value](./get_value/)() const | Zwraca przechowywaną wartość. |
...
| void [set_Value](./set_value/)(const T\&) | Ustawia przechowywaną wartość. |
