...
description: Udostępnia klasę bazową dla implementacji generycznego interfejsu System.Collections.Generic.IComparer.
type: docs
weight: 105
url: /pl/system.collections.generic/comparer/
---
## Comparer klasa

Provides a base class for implementations of the [System.Collections.Generic.IComparer](../icomparer/) interfejsu generycznego.
...
| Metoda | Opis |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) funkcja. |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | Zwraca domyślny komparator kolejności sortowania dla typu określonego przez argument generyczny. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n-ty template argument a weak pointer (rather than shared). Allows switching pointers in containers to weak mode. |
