...
description: "Definicja enumeratora służąca do opakowywania typów w stylu STL dla użytku w stylu C#. Nie zakłada żadnych struktur kontenera poza istnieciem sekwencyjnego iteratora. Używa funkcji begin() i end(). Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to prowadzić do błędów w czasie wykonywania i/lub awarii asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika jako argumentu przekazywanego do funkcji."
type: docs
weight: 66
url: /pl/system.collections.generic/baseenumerator/
---
## BaseEnumerator klasa
...
| Parametr | Opis |
| --- | --- |
| Container | Typ kontenera w stylu STL. |
...
|  [BaseEnumerator](./baseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | Inicjalizuje iterator. |
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](../ienumerator/get_current/)() const | Pobiera bieżący element. |
...
| void [IncrementIterator](../ienumerator/incrementiterator/)() override | Przesuwa iterator o krok do przodu. |
...
| **bool** [IsValid](./isvalid/)() const | Sprawdza, czy [MoveNext()](./movenext/) został wywołany i czy nie osiągnięto końca. |
