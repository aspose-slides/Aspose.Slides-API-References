...
description: "Zawiera wspólny kod dla kolekcji kluczy lub wartości. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 79
url: /pl/system.collections.generic/basekvcollection/
---
## BaseKVCollection klasa

Zawiera wspólny kod dla kolekcji kluczy lub wartości. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu [System::MakeObject()](../../system/makeobject/) funkcji. Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji.
...
| KV | Klucz lub typ wartości, w zależności od tego, dla czego używany jest interfejs. |
...
| [BaseKVCollection](./basekvcollection/)(const typename Dict::Ptr\&) | Tworzy kolekcję. |
...
| **bool** [Contains](../ikvcollection/contains/)(const T\&) const override | Sprawdza, czy element znajduje się w kontenerze. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | Kopiuje dane do istniejących elementów tablicy. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, gdzie dwa NaN są uważane za równe, mimo że według IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, gdzie dwa NaN są uważane za równe, mimo że według IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](../ikvcollection/getenumerator/)() | Zwraca enumerator dla kontenera. |
...
| virtual T [idx_get](../ikvcollection/idx_get/)(int) const | Funkcja pobierająca. |
...
| void [Insert](../ikvcollection/insert/)(int, const T\&) override | Wstawia element w określonej pozycji. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | Pomiotu określoną liczbę kolejnych elementów od początku sekwencji i zwraca resztę. |
...
| void [RemoveAt](../ikvcollection/removeat/)(int) override | Usuwa element w określonej pozycji. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza współdzielony licznik referencji o określoną wartość. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Umożliwia kompilację, ale w rzeczywistości nic nie robi, ponieważ ta struktura nie posiada danych. |
...
* Klasa [IKVCollection](../ikvcollection/)
