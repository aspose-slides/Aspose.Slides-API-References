...
description: "Interfejs dla kontenerów podobnych do słownika. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy w czasie wykonywania i/lub błędy asercji. Zawsze opakowuj tę klasę we wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go funkcjom jako argument."
type: docs
weight: 274
url: /pl/system.collections.generic/idictionary/
---
## IDictionary klasa

Interfejs dla kontenerów podobnych do słownika. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub błędy asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej funkcjom jako argument.
...
| Metoda | Opis |
| --- | --- |
| virtual void [Add](./add/)(const TKey&, const TValue&) | Dodaje parę klucz-wartość do kontenera. |
...
| virtual **bool** [Contains](../icollection/contains/)(const T&) const | Sprawdza, czy element jest obecny w kolekcji. |
| virtual **bool** [ContainsKey](./containskey/)(const TKey&) const | Sprawdza, czy kontener zawiera klucz. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)<[KeyValuePair](../keyvaluepair/)<TKey, TValue>>, int) override | Kopiuje zawartość słownika do istniejących elementów tablicy. |
...
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie (jeśli istnieje) stałej wersji kolekcji. |
...
| **bool** [get_IsFixedSize](./get_isfixedsize/)() const | Sprawdza, czy rozmiar kolekcji jest stały. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Sprawdza, czy kolekcja jest tylko do odczytu. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | Sprawdza, czy kontener jest bezpieczny wątkowo. |
| virtual [SharedPtr](../../system/sharedptr/)<[ICollection](../icollection/)<TKey>> [get_Keys](./get_keys/)() const | Uzyskuje dostęp do kolekcji kluczy. |
...
| virtual [SharedPtr](../../system/sharedptr/)<[ICollection](../icollection/)<TValue>> [get_Values](./get_values/)() const | Uzyskuje dostęp do kolekcji wartości. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Odpowiednik metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia tworzenie hashy niestandardowych obiektów. |
...
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey&) const | Zwraca wartość, jeśli znaleziona; w przeciwnym razie **Value()**. |
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey&, const TValue&) const | Zwraca wartość, jeśli znaleziona; w przeciwnym razie **defaultValue**. |
| virtual TValue [GetValueOrNull](./getvalueornull/)(const TKey&) const | Zwraca wartość, jeśli znaleziona; w przeciwnym razie **null**, ma sens tylko dla typów referencyjnych. |
...
| virtual TValue [idx_get](./idx_get/)(const TKey&) const | Funkcja getter. |
| virtual void [idx_set](./idx_set/)(const TKey&, TValue) | Funkcja setter. |
...
| [SharedPtr](../../system/sharedptr/)<[IEnumerable](../ienumerable/)<ResultType>> [LINQ_OfType](../ienumerable/linq_oftype/)() | Filtrowuje elementy sekwencji w oparciu o określony typ. |
...
| [SharedPtr](../../system/sharedptr/)<[IEnumerable](../ienumerable/)<T>> [LINQ_Where](../ienumerable/linq_where/)(std::function<**bool**(T)>) | Filtruje sekwencję w oparciu o określony predykat. |
...
| virtual **bool** [Remove](./remove/)(const TKey&) | Usuwa klucz z kontenera. |
...
| virtual **bool** [TryGetValue](./trygetvalue/)(const TKey&, TValue&) const | Wyszukuje wartość i pobiera ją, jeśli znaleziona. |
...
| Alias typu | Opis |
| --- | --- |
| [BaseType](./basetype/) | Typ bazowego interfejsu. |
| [KeyValuePairType](./keyvaluepairtype/) | Typ pary klucz-wartość. |
