...
description: "Zaimplementowano listę kluczy słownika. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani za pomocą operatora new, ponieważ może to skutkować błędami w czasie wykonania i/lub błędami asercji. Zawsze owiń tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 14
url: /pl/system.collections.generic/_keylist/
---
## _KeyList klasa

Implementuje listę kluczy słownika. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy w czasie wykonywania i/lub błędy asercji. Zawsze owiń tę klasę wskaźnikiem [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji.
...
| Metoda | Opis |
| --- | --- |
| [_KeyCollection](../_keycollection/_keycollection/)(const typename Dict::Ptr\&) | Inicjalizuje kolekcję odwołującą się do określonego słownika. |
| [_KeyList](./_keylist/)(const typename Dict::Ptr\&) | Inicjalizuje kolekcję odwołującą się do określonego słownika. |
...
| **bool** [Contains](./contains/)(const [TKey](../_keycollection/tkey/)\&) const override | Sprawdza, czy określony klucz znajduje się w kolekcji. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TKey](../_keycollection/tkey/)\>\> [GetEnumerator](../_keycollection/getenumerator/)() override | Zwraca enumerator iterujący po kluczach. |
...
| [TKey](../_keycollection/tkey/) [idx_get](./idx_get/)(int) const override | Zwraca klucz na określonej pozycji. |
...
| T [LINQ_Average](../ienumerable/linq_average/)() | Oblicza średnią ciągu wartości liczbowych. |
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią ciągu wartości uzyskanych przez wywołanie funkcji transformującej na każdym elemencie ciągu wejściowego. |
...
| int [LINQ_Count](../ienumerable/linq_count/)() | Zwraca liczbę elementów w sekwencji (obliczoną przez bezpośrednie liczenie). |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\>\>\&) | Projektuje każdy element sekwencji i łączy wynikowe sekwencje w jedną sekwencję. |
...
| void [SetTemplateWeakPtr](../basekvcollection/settemplateweakptr/)(**uint32_t**) override | Umożliwia kompilację, ale w rzeczywistości nic nie robi, ponieważ ta struktura nie posiada własnych danych. |
...
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeBeginConstIterator](../_keycollection/virtualizebeginconstiterator/)() const override | Zwraca implementację stałego iteratora begin dla bieżącego kontenera. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeBeginIterator](../_keycollection/virtualizebeginiterator/)() override | Zwraca implementację iteratora begin dla bieżącego kontenera. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeEndConstIterator](../_keycollection/virtualizeendconstiterator/)() const override | Zwraca implementację stałego iteratora end dla bieżącego kontenera. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeEndIterator](../_keycollection/virtualizeenditerator/)() override | Zwraca implementację iteratora end dla bieżącego kontenera. |
...
* Klasa [_KeyCollection](../_keycollection/)
