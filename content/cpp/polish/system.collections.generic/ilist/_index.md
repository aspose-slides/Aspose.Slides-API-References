...
description: "Interfejs indeksowanego kontenera elementów. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej do funkcji jako argument."
type: docs
weight: 339
url: /pl/system.collections.generic/ilist/
---
## IList klasa

Interfejs indeksowanego kontenera elementów. Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej do funkcji jako argument.
...
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany odwoływanego obiektu, ponieważ [GetEnumerator()](../ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
...
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Zwraca iterator wskazujący tuż za ostatnim const-kwalifikowanym elementem (jeśli istnieje) kolekcji. |
...
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Zwraca iterator wskazujący tuż za ostatnim elementem (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany odwoływanego obiektu, ponieważ [GetEnumerator()](../ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Zwraca iterator wskazujący tuż za ostatnim elementem (jeśli istnieje) const-kwalifikowanej instancji kolekcji. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, gdzie dwa NaN są traktowane jako równe, pomimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, gdzie dwa NaN są traktowane jako równe, pomimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, włącznie z NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Tylko do użytku wewnętrznego. |
| virtual int [get_Count](../icollection/get_count/)() const | Zwraca liczbę elementów w kolekcji. |
| **bool** [get_IsFixedSize](./get_isfixedsize/)() | Sprawdza, czy kolekcja ma stały rozmiar. |
...
| virtual T [idx_get](./idx_get/)(int) const | Zwraca element podanym indeksem. |
| virtual void [idx_set](./idx_set/)(int, T) | Ustawia element podanym indeksem. |
| virtual int [IndexOf](./indexof/)(const T\&) const | Zwraca indeks pierwszego wystąpienia elementu w kontenerze. |
| virtual void [Insert](./insert/)(int, const T\&) | Wstawia element na określone pozycje, przesuwając pozostałe elementy. |
...
| T [LINQ_Average](../ienumerable/linq_average/)() | Oblicza średnią sekwencji wartości liczbowych. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Cast](../ienumerable/linq_cast/)() | Rzutuje elementy do określonego typu. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę instrukcji C# lock(). Wywołuj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Tak naprawdę nie kopiuje nic, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Tak naprawdę nie kopiuje nic, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
...
| virtual void [RemoveAt](./removeat/)(int) | Usuwa element pod określonym indeksem. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie instrukcji C# lock(). Wywołuj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../ienumerable/virtualizebeginconstiterator/)() const | Zwraca implementację stałego iteratora begin dla bieżącego kontenera. |
...
| virtual [virtualized_iterator](../ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../ienumerable/virtualizeendconstiterator/)() const | Zwraca implementację stałego iteratora end dla bieżącego kontenera. |
