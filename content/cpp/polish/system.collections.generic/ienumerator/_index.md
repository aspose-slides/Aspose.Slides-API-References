...
description: "Interfejs enumeratora, który może być używany do iteracji po niektórych elementach. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub awarie asercji. Zawsze owiń tę klasę wskaźnikiem System::SmartPtr i użyj tego wskaźnika do przekazywania go jako argument do funkcji."
type: docs
weight: 300
url: /pl/system.collections.generic/ienumerator/
---
## IEnumerator klasa

Interfejs iteratora, który może być używany do przechodzenia przez pewne elementy. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami w czasie wykonywania i/lub naruszeniami asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej funkcjom jako argumentu.
...
| Metoda | Opis |
| --- | --- |
| [IEnumerator](./) * [AsVirtualizedIterator](./asvirtualizediterator/)() | Przygotowuje iterator do użycia przez klasę VirtualizedIterator. |
| System::Details::VirtualizedIteratorBase\<T\> * [CloneIterator](./cloneiterator/)() const override | Klonuje bieżący iterator. |
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](./current/)() const | Pobiera bieżący element. |
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const | Pobiera bieżący element. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia haszowanie własnych obiektów. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Pobiera rzeczywisty typ obiektu. Analog wywołania C# [System.Object.GetType()](../../system/object/gettype/). |
|  [IEnumerator](./ienumerator/)() |  |
| void [IncrementIterator](./incrementiterator/)() override | Przesuwa iterator o jeden krok do przodu. |
| void [InitializeIterator](./initializeiterator/)() override | Wykonuje pierwsze wywołanie [MoveNext()](./movenext/) i przygotowuje obiekt enumeratora do użycia przez VirtualizedIterator. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Sprawdza, czy obiekt jest instancją typu opisanego przez targetType. Analog operatora C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementuje blokowanie instrukcją C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
| void [MarkOwnedByVirtualizedIterator](./markownedbyvirtualizediterator/)() | Oznacza enumerator będący własnością iteratora wirtualizowanego. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog metody C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umożliwia klonowanie własnych typów. |
| virtual **bool** [MoveNext](./movenext/)() | Przesuwa enumerator do następnego elementu. Jeśli wcześniej nie odwoływano się do żadnego elementu, ustawia odwołanie na pierwszy dostępny element. Jeśli osiągnięto koniec kontenera, nie robi nic. |
...
| virtual void [Reset](./reset/)() | Resetuje enumerator do pozycji przed pierwszym elementem. |
...
| Definicja typu | Opis |
| --- | --- |
| [ValueType](./valuetype/) | Typ wartościowy. |
## Uwagi
...
int main()
{
  ...
  // Pobierz enumerator listy.
  auto enumerator = collection->GetEnumerator();

  while (enumerator->MoveNext())
  {
    // Pobierz bieżący element i wypisz go.
