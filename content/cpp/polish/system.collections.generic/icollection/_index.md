...
description: "Interfejs kolekcji elementów. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy w czasie działania i/lub awarie asercji. Zawsze opakuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go funkcjom jako argument."
type: docs
weight: 248
url: /pl/system.collections.generic/icollection/
---
## ICollection klasa


Interfejs kolekcji elementów. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami w czasie wykonywania i/lub awariami asercji. Zawsze opakuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej funkcjom jako argumentu.
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)(const T\&) | Dodaje element do kolekcji. |
...
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Zwraca iterator wskazujący na pierwszy element const-kwalifikowany (jeśli istnieje) w kolekcji. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Zwraca iterator wskazujący bezpośrednio za ostatnim elementem const-kwalifikowanym (jeśli istnieje) kolekcji. |
| virtual void [Clear](./clear/)() | Usuwa wszystkie elementy z kolekcji. |
| virtual **bool** [Contains](./contains/)(const T\&) const | Sprawdza, czy element znajduje się w kolekcji. |
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopiuje wszystkie elementy kolekcji do istniejących elementów tablicy. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Zwraca iterator wskazujący bezpośrednio za ostatnim elementem (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany referowanego obiektu, ponieważ [GetEnumerator()](../ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Zwraca iterator wskazujący bezpośrednio za ostatnim elementem (jeśli istnieje) const-kwalifikowanej instancji kolekcji. |
...
| virtual int [get_Count](./get_count/)() const | Zwraca liczbę elementów w kolekcji. |
| virtual **bool** [get_IsReadOnly](./get_isreadonly/)() const | Sprawdza, czy kolekcja jest tylko do odczytu. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Zwraca obiekt, przez który synchronizowana jest kolekcja. |
...
|  [ICollection](./icollection/)() | Konstruktor domyślny. |
|  [ICollection](./icollection/)(const [ICollection](./)\&) | Konstruktor kopiujący. |
|  [ICollection](./icollection/)([ICollection](./)\&&) | Konstruktor przenoszący. |
...
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią ciągu wartości uzyskanych poprzez wywołanie funkcji transformującej dla każdego elementu sekwencji wejściowej. |
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Cast](../ienumerable/linq_cast/)() | Rzuca elementy na określony typ. |
...
| int [LINQ_Count](../ienumerable/linq_count/)() | Zwraca liczbę elementów w sekwencji (obliczaną poprzez bezpośrednie zliczanie). |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Sortuje elementy sekwencji w porządku rosnącym według wartości klucza wybranych przez keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Sortuje elementy sekwencji w porządku malejącym według wartości klucza wybranych przez keySelector. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Select](../ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformuje każdy element sekwencji do nowej postaci, uwzględniając indeks elementu. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. W rzeczywistości nie kopiuje nic, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie w podklasach. |
| [ICollection](./)\& [operator=](./operator_equal/)([ICollection](./)\&&) | Operator przypisania przenoszącego. |
| [ICollection](./)\& [operator=](./operator_equal/)(const [ICollection](./)\&) | Operator przypisania przenoszącego. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. W rzeczywistości nie kopiuje nic, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie w podklasach. |
...
| virtual **bool** [Remove](./remove/)(const T\&) | Usuwa element z kolekcji. |
...
| Typedef | Opis |
| --- | --- |
| [ValueType](./valuetype/) | Nazwa typu wartości. |
| [ThisType](./thistype/) | Nazwa typu kolekcji. |
