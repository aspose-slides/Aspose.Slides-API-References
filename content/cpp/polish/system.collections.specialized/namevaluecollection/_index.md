...
description: Zbiór powiązanych kluczy typu String i wartości typu String, które można uzyskać zarówno przy użyciu klucza, jak i indeksu.
type: docs
weight: 14
url: /pl/system.collections.specialized/namevaluecollection/
---
## NameValueCollection klasa


Zbiór powiązanych [String](../../system/string/) kluczy i [String](../../system/string/) wartości, które można uzyskać zarówno przy użyciu klucza, jak i indeksu.
...
| Metoda | Opis |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&) override | Nadpisuje metodę [ICollection](../../system.collections/icollection/) – niezaimplementowana. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | Kopiuje wpisy z określonego [NameValueCollection](./) do bieżącego. |
| virtual void [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Dodaje wpis o określonej nazwie i wartości. |
...
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) const override | Sprawdza, czy element znajduje się w kolekcji. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\>, **int32_t**) override | Kopiuje elementy kolekcji do istniejących elementów tablicy. |
...
| virtual [String](../../system/string/) [Get](./get/)(const [String](../../system/string/)\&) | Zwraca wartości skojarzone z określonym kluczem. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [get_AllKeys](./get_allkeys/)() | Zwraca wszystkie klucze. |
| int [get_Count](./get_count/)() const override | Zwraca liczbę par klucz/wartość. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[String](../../system/string/)\>\> [get_Keys](./get_keys/)() | Zwraca wszystkie klucze. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Zwraca strukturę danych licznika referencji skojarzoną z obiektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator umożliwiający iterację po kolekcji. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [GetValues](./getvalues/)(const [String](../../system/string/)\&) | Zwraca wartości skojarzone z określonym kluczem. |
| **bool** [HasKeys](./haskeys/)() | Zwraca wartość wskazującą, czy [NameValueCollection](./) zawiera klucze, które nie są nullem. |
...
| [String](../../system/string/) [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Zwraca wartość pod określonym indeksem. |
| void [idx_set](./idx_set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Ustawia wartość wpisu. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę w instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu wartownika [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Odpowiednik metody C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umożliwia klonowanie własnych typów. |
|  [NameValueCollection](./namevaluecollection/)() | Inicjalizuje nową, pustą instancję klasy [NameValueCollection](./). |
|  [NameValueCollection](./namevaluecollection/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | Kopiuje wpisy z określonego [NameValueCollection](./) do nowego [NameValueCollection](./). |
...
| **bool** [Remove](./remove/)(const [String](../../system/string/)\&) override | Usuwa określony element. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza licznik współdzielonych referencji o podaną wartość. |
| virtual void [Set](./set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Ustawia wartość wpisu. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie w instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu wartownika [LockContext](../../system/lockcontext/). |
