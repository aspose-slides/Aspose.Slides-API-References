...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Pobiera kolor pędzla dla linii. |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | Pobiera typ efektu tuszu (np. Galaxy, Gold, Silver), który definiuje styl wizualny pociągnięcia tuszu. Wartość jest odczytywana z właściwości pędzla \"inkEffects\". Jeśli nie określono rozpoznawanego efektu, zwracane jest [InkEffectType::NotDefined](../inkeffecttype/). |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Pobiera rozmiar pędzla dla linii w punktach. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Ustawia kolor pędzla dla linii. |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | Ustawia rozmiar pędzla dla linii w punktach. |
