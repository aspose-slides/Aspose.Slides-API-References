...
description: Reprezentuje pędzel śladowy.
type: docs
weight: 27
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Pobiera kolor pędzla dla linii. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | Pobiera typ efektu atramentu (np. Galaxy, Gold, Silver), który definiuje styl wizualny pociągnięcia atramentu. Wartość jest odczytywana z właściwości pędzla "inkEffects". Jeśli nie określono rozpoznanego efektu, zwracane jest [InkEffectType::NotDefined](../inkeffecttype/). |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Pobiera rozmiar pędzla dla linii w punktach. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Ustawia kolor pędzla dla linii. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Ustawia rozmiar pędzla dla linii w punktach. |
