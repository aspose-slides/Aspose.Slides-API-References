...
description: Reprezentuje obiekt Trace. Element Trace jest używany do rejestrowania danych przechwyconych przez digitalizator. Zawiera sekwencję punktów zakodowaną zgodnie ze specyfikacją podaną przez obiekt InkTraceFormat.
type: docs
weight: 92
...
| [System::SharedPtr](../../system/sharedptr/)\<[IInkBrush](../iinkbrush/)\> [get_Brush](./get_brush/)() override | Pobiera Brush dla IInkLine [IInkBrush](../iinkbrush/) tylko do odczytu. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() override | Pobiera punkty dla IInkLine [System::Drawing::PointF](../../system.drawing/pointf/) tylko do odczytu. |
