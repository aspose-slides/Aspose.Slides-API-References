...
type: docs
weight: 222
url: /pl/system.io/details_pathtoolongexception/
---
## Details_PathTooLongException klasa
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Zwraca 32-bitową wartość całkowitą, która jest kodem HRESULT powiązanym z wyjątkiem reprezentowanym przez bieżący obiekt. |
...
| virtual [String](../../system/string/) [get_Message](../../system/details_exception/get_message/)() const | Zwraca string zawierający opis błędu. |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Zwraca string zawierający ślad stosu. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](./gettype/)() const override | Pobiera rzeczywisty typ obiektu. Analog wywołania C# [System.Object.GetType()](../../system/object/gettype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje niczego, naprawdę, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstrukcji klas pochodnych. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje niczego, naprawdę, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstrukcji klas pochodnych. |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | Zwraca reprezentację string bieżącego obiektu. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementuje metodę [what()](../../system/details_exception/what/), która jest wywoływana przez klasę [ExceptionWrapper](../../system/exceptionwrapper/). Pomimo faktu, że ta klasa nie dziedziczy po std::exception, klasy pochodne mogą korzystać z chronionych/prywatnych członków, aby zaimplementować swoją logikę. Przeniesienie implementacji tej metody do [ExceptionWrapper](../../system/exceptionwrapper/) może naruszyć tę logikę. |
| virtual  [~Object](../../system/object/~object/)() | Usuwa obiekt. Zwalnia wszystkie wewnętrzne struktury danych. |

## Zobacz także

* Klasa [Details_IOException](../details_ioexception/)
