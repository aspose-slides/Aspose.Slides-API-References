...
description: "Reprezentuje wyjątek rzucany, gdy wystąpi błąd gniazda. Nigdy nie twórz ręcznie instancji tej klasy. Użyj zamiast tego klasy SocketException. Nigdy nie otaczaj instancji klasy SocketException w System::SmartPtr."
type: docs
weight: 1
url: /pl/system.net.sockets/details_socketexception/
---
## Details_SocketException klasa


Reprezentuje wyjątek wyrzucany, gdy wystąpi błąd gniazda. Nigdy nie twórz ręcznie instancji tej klasy. Użyj zamiast tego klasy SocketException. Nigdy nie otaczaj instancji klasy SocketException w [System::SmartPtr](../../system/smartptr/).
...
| **int32_t** [get_ErrorCode](./get_errorcode/)() | Pobiera kod błędu. |
...
| [SocketError](../socketerror/) [get_SocketErrorCode](./get_socketerrorcode/)() | Pobiera kod błędu gniazda. |
...
| void [set_ErrorCode](./set_errorcode/)(**int32_t**) | Ustawia kod błędu. |
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Ustawia HRESULT, zakodowaną wartość liczbową przypisaną konkretnemu wyjątkowi. |
| void [set_SocketErrorCode](./set_socketerrorcode/)([SocketError](../socketerror/)) | Ustawia kod błędu gniazda. |
