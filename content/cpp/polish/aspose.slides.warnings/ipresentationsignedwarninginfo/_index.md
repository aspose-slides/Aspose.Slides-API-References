...
description: To ostrzeżenie wskazuje, że odczytywana prezentacja posiada podpis, który zostanie usunięty podczas przetwarzania.
type: docs
weight: 40
url: /pl/aspose.slides.warnings/ipresentationsignedwarninginfo/
---
## IPresentationSignedWarningInfo klasa
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Zwraca czytelny opis tego ostrzeżenia. Tylko do odczytu [System::String](../../system/string/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Jeśli odbiorca nie jest nullem, kończy ostrzeżenie do określonego odbiorcy i rzuca AbortRequestedException, jeśli odbiorca zdecydował o przerwaniu operacji. |
