...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Zwraca opis ostrzeżenia w czytelnej formie. Tylko do odczytu [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Zwraca typ ostrzeżenia. Tylko do odczytu [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Jeśli odbiorca nie jest null, kończy ostrzeżenie do określonego odbiorcy i rzuca wyjątek AbortRequestedException, jeśli odbiorca zdecydował przerwać operację. |
...
* Klasa [IWarningInfo](../iwarninginfo/)
