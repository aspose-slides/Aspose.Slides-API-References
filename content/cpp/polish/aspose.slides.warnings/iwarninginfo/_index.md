...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Zwraca czytelny opis tego ostrzeżenia. Tylko do odczytu [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](./get_warningtype/)() | Zwraca typ ostrzeżenia. Tylko do odczytu [IWarningInfo::get_WarningType](./get_warningtype/). |
...
| virtual void [SendWarning](./sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Jeżeli odbiorca nie jest null, kończy ostrzeżenie do określonego odbiorcy i wyrzuca wyjątek AbortRequestedException, jeśli odbiorca zdecydował przerwać operację. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Odpowiednik metody C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwertowanie własnych obiektów do ciągu znaków. |
