...
description: Interfejs dla klas, które odbierają ostrzeżenia
type: docs
weight: 53
url: /pl/aspose.slides.warnings/iwarningcallback/
---
## Klasa IWarningCallback

Interfejs dla klas, które odbierają ostrzeżenia
...
| virtual [ReturnAction](../returnaction/) [Warning](./warning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningInfo](../iwarninginfo/)\>) | Metoda wywołania zwrotnego, która odbiera ostrzeżenie i decyduje, czy operacja powinna zostać przerwana. |
