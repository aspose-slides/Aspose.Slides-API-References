...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() | Zwraca schemat kolorów. Tylko do odczytu [IColorScheme](../icolorscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](./get_fontscheme/)() | Zwraca schemat czcionek. Tylko do odczytu [IFontScheme](../ifontscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](./get_formatscheme/)() | Zwraca schemat formatowania kształtów. Tylko do odczytu [IFormatScheme](../iformatscheme/). |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | Zwraca element nadrzędny [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). Tylko do odczytu [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](./geteffective/)() override | Pobiera efektywne dane motywu z zastosowanym dziedziczeniem. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę zgodną z C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie zgodne z C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
...
* Klasa [ITheme](../itheme/)
* Klasa [IStyleColorOwner](../../aspose.slides/istylecolorowner/)
