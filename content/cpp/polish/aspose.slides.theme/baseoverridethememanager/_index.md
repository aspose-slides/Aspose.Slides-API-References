...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Określa, czy [OverrideTheme](../overridetheme/) przesłania odziedziczony efektywny motyw, czy nie. Aby włączyć [OverrideTheme](../overridetheme/) do przesłaniania, użyj metod OverrideTheme.Init*(). Aby wyłączyć [OverrideTheme](../overridetheme/) z przesłaniania, użyj metody [OverrideTheme::Clear](../overridetheme/clear/). Tylko do odczytu **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Zwraca obiekt przesłaniającego motywu. Odczyt [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Zwraca obiekt przesłaniającego motywu. Zapis [IOverrideTheme](../ioverridetheme/). |
...
* Klasa [IOverrideThemeManager](../ioverridethememanager/)
