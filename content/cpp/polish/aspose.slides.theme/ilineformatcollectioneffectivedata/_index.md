...
---
## ILineFormatCollectionEffectiveData klasa
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie (jeśli istnieje) stałej wersji instancji kolekcji. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const&, **double** const&) | Emuluje porównanie liczb zmiennoprzecinkowych podwójnej precyzji w stylu C#, w którym dwa NaN są uznawane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../../aspose.slides/ilineformateffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca element pod wskazanym indeksem. Tylko do odczytu [ILineFormatEffectiveData](../../aspose.slides/ilineformateffectivedata/). |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Określa, czy istnieje dowolny element sekwencji lub spełnia on warunek. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const&, std::nullptr_t) | Porównuje odniesieniowo obiekt typu wartościowego z nullptr. |
