...
description: Niezmienny obiekt reprezentujący kolekcję tylko do odczytu skutecznych stylów efektów.
type: docs
weight: 196
url: /pl/aspose.slides.theme/ieffectstylecollectioneffectivedata/
---
## IEffectStyleCollectionEffectiveData klasa


Niezmienny obiekt, który reprezentuje kolekcję tylko do odczytu skutecznych stylów efektów.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Zwraca iterator wskazujący zaraz po ostatnim elemencie (jeśli istnieje) stałej wersji instancji kolekcji. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyleEffectiveData](../ieffectstyleeffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca element pod określonym indeksem. Tylko do odczytu [IEffectStyleEffectiveData](../ieffectstyleeffectivedata/). |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Zwraca pierwszy element sekwencji spełniający warunek lub wartość domyślną, jeśli nie znajdzie takiego elementu. |
