...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>\>, **int32_t**) override | Kopiuje wszystkie elementy kolekcji do określonej tablicy. |
...
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Zwraca wartość wskazującą, czy dostęp do ArrayList jest zsynchronizowany (wątkowo bezpieczny). Tylko do odczytu **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator, który iteruje po kolekcji. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [idx_get](./idx_get/)(**int32_t**) override | Zwraca schemat kolorów według indeksu. Tylko do odczytu [ExtraColorScheme](../extracolorscheme/). |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią ciągu wartości uzyskanych poprzez wywołanie funkcji transformującej na każdym elemencie wejściowej sekwencji. |
...
* Klasa [IExtraColorSchemeCollection](../iextracolorschemecollection/)
