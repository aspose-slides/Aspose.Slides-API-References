...
---
## IExtraColorSchemeCollection klasa
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie kwalifikowanym jako const (jeśli istnieje) w kolekcji. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca schemat kolorów według indeksu. Tylko do odczytu [IExtraColorScheme](../iextracolorscheme/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokowanie zgodne z instrukcją C# lock(). Wywołaj bezpośrednio lub użyj obiektu strażnika [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Właściwie nic nie kopiuje, tylko inicjalizuje nowy obiekt i umożliwia kopiowanie przy tworzeniu podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Właściwie nic nie kopiuje, tylko inicjalizuje nowy obiekt i umożliwia kopiowanie przy tworzeniu podklas. |
