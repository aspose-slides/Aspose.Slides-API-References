...
| Metoda | Opis |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | Stosuje dodatkowy schemat kolorów na slajdzie. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithememanager/createthemeeffective/)() | Zwraca obiekt motywu. |
...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | Określa, czy [OverrideTheme](../overridetheme/) przesłania odziedziczony skuteczny motyw, czy nie. Aby włączyć [OverrideTheme](../overridetheme/) do przesłaniania, użyj metod OverrideTheme.Init*(). Aby wyłączyć [OverrideTheme](../overridetheme/) z przesłaniania, użyj metody [get_OverrideTheme()](./get_overridetheme/)->Clear(). Tylko do odczytu **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() | Zwraca obiekt nadrzędnego motywu. Odczyt [IOverrideTheme](../ioverridetheme/). |
...
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) | Zwraca obiekt nadrzędnego motywu. Zapis [IOverrideTheme](../ioverridetheme/). |
...
* Klasa [IThemeManager](../ithememanager/)
