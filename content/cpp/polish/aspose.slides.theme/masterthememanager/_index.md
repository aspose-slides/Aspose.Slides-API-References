...
Zapewnia dostęp do głównego motywu prezentacji.
...
| Metoda | Opis |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Zastosowuje dodatkowy schemat kolorów do slajdu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | Zwraca obiekt motywu. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Określa, czy [OverrideTheme](../overridetheme/) nadpisuje odziedziczony efektywny motyw ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) czy nie. Odczyt **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Zwraca nadpisujący obiekt motywu. Odczyt [IMasterTheme](../imastertheme/). |
...
| void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) override | Określa, czy [OverrideTheme](../overridetheme/) nadpisuje odziedziczony efektywny motyw ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) czy nie. Zapis **bool**. |
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) override | Zwraca nadpisujący obiekt motywu. Zapis [IMasterTheme](../imastertheme/). |
...
* Klasa [IMasterThemeManager](../imasterthememanager/)
