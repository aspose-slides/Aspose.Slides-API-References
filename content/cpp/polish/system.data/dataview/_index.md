...
description: "Widok działający na tabeli. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani za pomocą operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub awarie asercji. Zawsze opakowuj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 131
url: /pl/system.data/dataview/
---
## DataView klasa
...
| **int32_t** [get_Count](./get_count/)() | Informacje RTTI. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Data::DataTable](../datatable/)\> [get_Table](./get_table/)() | Pobiera tabelę, do której należy widok. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Data::DataRowView](../datarowview/)\> [idx_get](./idx_get/)(const **int32_t**) | Pobiera widoki wierszy. |
