...
description: "Zbiór danych przechowywanych w tabelach posiadających pewne powiązania między nimi. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze owijaj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go do funkcji jako argument."
type: docs
weight: 92
url: /pl/system.data/dataset/
---
## DataSet klasa

Zbiór danych przechowywanych w tabelach posiadających pewne powiązania między sobą. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze owijaj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go do funkcji jako argument.
...
| [System::SharedPtr](../../system/sharedptr/)\<[DataRelationCollection](../datarelationcollection/)\> [get_Relations](./get_relations/)() | Pobiera powiązania między tabelami w zestawie danych. |
| [System::SharedPtr](../../system/sharedptr/)\<[DataTableCollection](../datatablecollection/)\> [get_Tables](./get_tables/)() | Informacje RTTI. |
