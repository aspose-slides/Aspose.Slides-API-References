...
Poniższy przykład pokazuje, jak przekonwertować PowerPoint na PDF z własnymi opcjami.
```cpp
...
```
Poniższy przykład pokazuje, jak przekonwertować PowerPoint na PDF z ukrytymi slajdami.
```cpp
...
presentation->Save(u"PowerPoint-to-PDF.pdf", SaveFormat::Pdf, pdfOptions);
```
Poniższy przykład pokazuje, jak przekonwertować PowerPoint na PDF zabezpieczony hasłem.
```cpp
...
```
Poniższy przykład pokazuje, jak przekonwertować PowerPoint na PDF z notatkami.
```cpp
