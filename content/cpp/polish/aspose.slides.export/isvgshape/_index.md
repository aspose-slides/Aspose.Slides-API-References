...
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | Ustawia lub pobiera id dla kształtu |
...
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | Ustawia lub pobiera id dla kształtu |
| virtual void [SetEventHandler](./seteventhandler/)([SvgEvent](../svgevent/), [System::String](../../system/string/)) | Ustawia obsługę zdarzeń dla kształtu |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n-ty argument szablonu jako słaby wskaźnik (zamiast współdzielonego). Allows switching pointers in containers to weak mode. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementuje konstrukcję C# typeof([System.Object](../../system/object/)) construct. |
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie instrukcją C# lock(). Call directly or use [LockContext](../../system/lockcontext/) sentry object. |
