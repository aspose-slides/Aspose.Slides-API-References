...
description: Zapewnia opcje kontrolujące wygląd obiektów Ink w wyeksportowanym dokumencie.
type: docs
weight: 261
...
Zapewnia opcje kontrolujące wygląd obiektów [Ink](../../aspose.slides.ink/) w wyeksportowanym dokumencie.
...
| **bool** [get_HideInk](./get_hideink/)() override | Pokazuje lub ukrywa elementy [Ink](../../aspose.slides.ink/) w wyeksportowanym dokumencie. |
| **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() override | Używa operacji ROP lub przezroczystości przy renderowaniu pędzla. |
...
| void [set_HideInk](./set_hideink/)(**bool**) override | Pokazuje lub ukrywa elementy [Ink](../../aspose.slides.ink/) w wyeksportowanym dokumencie. |
| void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) override | Używa operacji ROP lub przezroczystości przy renderowaniu pędzla. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n-ty argument szablonu jako wskaźnik słaby (zamiast współdzielonego). Pozwala na zmianę wskaźników w kontenerach na tryb słaby. |
