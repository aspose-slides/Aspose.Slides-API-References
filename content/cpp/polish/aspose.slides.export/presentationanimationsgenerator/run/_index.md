...
description: Uruchom generowanie zdarzeń animacji dla każdego slajdu.
type: docs
weight: 92
...
Uruchom generowanie zdarzeń animacji dla każdego slajdu.
...
{
    // obsłuż takt ramki w nowej animacji
}));
...
* Definicja typu [FrameTickHandler](../../presentationplayer/frametickhandler/)
* Klasa [IEnumerable](../../../system.collections.generic/ienumerable/)
* Klasa [ISlide](../../../aspose.slides/islide/)
