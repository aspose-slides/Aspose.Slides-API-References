...
---
## ITextToHtmlConversionOptions klasa
...
| virtual **bool** [get_AddClipboardFragmentHeader](./get_addclipboardfragmentheader/)() | Zwraca wartość wskazującą, czy nagłówki schowka powinny być dodane. Odczyt **bool**. |
| virtual [System::String](../../system/string/) [get_EncodingName](./get_encodingname/)() | Zwraca nazwę kodowania html. Ta wartość zostanie zapisana do wygenerowanego pliku HTML, ale to od wywołującego zależy, czy plik zostanie zapisany w tym kodowaniu. Odczyt [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Export::ILinkEmbedController](../ilinkembedcontroller/)\> [get_LinkEmbedController](./get_linkembedcontroller/)() | Zwraca obiekt zwrotny, który kontroluje, jak obiekt zewnętrzny będzie przechowywany. Odczyt [Export::ILinkEmbedController](../ilinkembedcontroller/). |
| virtual [Aspose::Slides::Export::TextInheritanceLimit](../textinheritancelimit/) [get_TextInheritanceLimit](./get_textinheritancelimit/)() | Zwraca dziedziczoną głębokość właściwości tekstu. Odczyt [TextInheritanceLimit](../textinheritancelimit/). |
...
| virtual void [set_AddClipboardFragmentHeader](./set_addclipboardfragmentheader/)(**bool**) | Ustawia wartość wskazującą, czy nagłówki schowka powinny być dodane. Zapis **bool**. |
| virtual void [set_EncodingName](./set_encodingname/)([System::String](../../system/string/)) | Ustawia nazwę kodowania html. Ta wartość zostanie zapisana do wygenerowanego pliku HTML, ale to od wywołującego zależy, czy plik zostanie zapisany w tym kodowaniu. Zapis [System::String](../../system/string/). |
| virtual void [set_LinkEmbedController](./set_linkembedcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[Export::ILinkEmbedController](../ilinkembedcontroller/)\>) | Ustawia obiekt zwrotny, który kontroluje, jak obiekt zewnętrzny będzie przechowywany. Zapis [Export::ILinkEmbedController](../ilinkembedcontroller/). |
| virtual void [set_TextInheritanceLimit](./set_textinheritancelimit/)([Aspose::Slides::Export::TextInheritanceLimit](../textinheritancelimit/)) | Ustawia dziedziczoną głębokość właściwości tekstu. Zapis [TextInheritanceLimit](../textinheritancelimit/). |
