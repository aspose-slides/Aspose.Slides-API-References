...
description: Reprezentuje implementację zapisywania wyjścia służącą do transferu danych do zewnętrznego magazynu.
type: docs
weight: 14
url: /pl/aspose.slides.export.xaml/ixamloutputsaver/
---
## IXamlOutputSaver klasa

Reprezentuje implementację zapisywania wyjścia służącą do przesyłania danych do zewnętrznego magazynu.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Faktycznie nic nie kopiuje, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstrukcji podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Faktycznie nic nie kopiuje, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstrukcji podklas. |
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Zapisuje tablicę bajtów w docelowej lokalizacji. |
