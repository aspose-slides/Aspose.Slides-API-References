...
description: Wskaźnik do kolekcji rozszerzeń X509. Ten typ jest wskaźnikiem zarządzającym usuwaniem innych obiektów. Powinien być alokowany na stosie i przekazywany do funkcji przez wartość lub przez referencję const.
type: docs
weight: 170
url: /pl/system.security.cryptography.x509certificates/x509extensioncollectionptr/
---
## X509ExtensionCollectionPtr klasa
...
| Metoda | Opis |
| --- | --- |
| auto [begin](../../system/smartptr/begin/)() | Akcesor do metody [begin()](../../system/smartptr/begin/) w podkolekcji. Kompiluje się wyłącznie, jeśli SmartPtr_ jest typem specjalizacji posiadającym metodę [begin()](../../system/smartptr/begin/). |
| auto [begin](../../system/smartptr/begin/)() const | Akcesor do metody [begin()](../../system/smartptr/begin/) w podkolekcji. Kompiluje się wyłącznie, jeśli SmartPtr_ jest typem specjalizacji posiadającym metodę [begin()](../../system/smartptr/begin/). |
...
| std::enable_if_t<\!Check::value\&&\!std::is_same\<Y, T\>::value\&&\!std::is_base_of\<Y, T\>::value, [SmartPtr](../../system/smartptr/)\<Y\>\> [Cast](../../system/smartptr/cast/)() const | Rzutuje wskaźnik na typ pochodny przy użyciu dynamic_cast. |
| auto [cbegin](../../system/smartptr/cbegin/)() const | Akcesor do metody [cbegin()](../../system/smartptr/cbegin/) w podkolekcji. Kompiluje się wyłącznie, jeśli SmartPtr_ jest typem specjalizacji posiadającym metodę [cbegin()](../../system/smartptr/cbegin/). |
| auto [cend](../../system/smartptr/cend/)() const | Akcesor do metody [cend()](../../system/smartptr/cend/) w podkolekcji. Kompiluje się wyłącznie, jeśli SmartPtr_ jest typem specjalizacji posiadającym metodę [cend()](../../system/smartptr/cend/). |
...
| auto [end](../../system/smartptr/end/)() | Akcesor do metody [end()](../../system/smartptr/end/) w podkolekcji. Kompiluje się wyłącznie, jeśli SmartPtr_ jest typem specjalizacji posiadającym metodę [end()](../../system/smartptr/end/). |
| auto [end](../../system/smartptr/end/)() const | Akcesor do metody [end()](../../system/smartptr/end/) w podkolekcji. Kompiluje się wyłącznie, jeśli SmartPtr_ jest typem specjalizacji posiadającym metodę [end()](../../system/smartptr/end/). |
...
| [Pointee_](../../system/smartptr/pointee_/) * [get_shared](../../system/smartptr/get_shared/)() const | Zwraca wskazywany obiekt, ale wymusza, że wskaźnik jest w trybie współdzielonym. |
| int [get_shared_count](../../system/smartptr/get_shared_count/)() const | Zwraca liczbę współdzielonych wskaźników istniejących do referencjonowanego obiektu, łącznie z bieżącym. Wymusza, że bieżący wskaźnik jest w trybie współdzielonym. |
...
| **bool** [Is](../../system/smartptr/is/)(const [System::TypeInfo](../../system/typeinfo/)\&) const | Sprawdza, czy wskazywany obiekt jest określonego typu lub jego typem pochodnym. Odnosi się do semantyki C# 'is'. |
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | Sprawdza, czy wskaźnik wskazuje na inny obiekt niż posiadany (utworzony przez konstruktor aliasujący). |
...
| [Pointee_](../../system/smartptr/pointee_/)\& [operator*](../../system/smartptr/operator_star/)() const | Zwraca referencję do wskazywanego obiektu. Wymusza, że wskaźnik nie jest nullem. |
...
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&) | Przypisuje przesunięciem obiekt [SmartPtr](../../system/smartptr/). x staje się nieużywalny. |
...
| [SharedPtr](../../system/sharedptr/)\<[X509Extension](../x509extension/)\>\& [operator[]](./operator[]/)(**int32_t**) const | Akcesor. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(std::nullptr_t, [SmartPtrMode](../../system/smartptrmode/)) | Tworzy obiekt [SmartPtr](../../system/smartptr/) będący wskaźnikiem null wymaganego trybu. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr_](../../system/smartptr/smartptr_/)\&, [SmartPtrMode](../../system/smartptrmode/)) | Konstruktor kopiujący tworzy obiekt [SmartPtr](../../system/smartptr/). Oba wskaźniki wskazują później na ten sam obiekt. |
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Konstruktor kopiujący tworzy obiekt [SmartPtr](../../system/smartptr/). Oba wskaźniki wskazują później na ten sam obiekt. Wykonuje konwersję typów, jeśli jest dozwolona. |
|  [SmartPtr](../../system/smartptr/smartptr/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&, [SmartPtrMode](../../system/smartptrmode/)) | Konstruktor przenoszący tworzy obiekt [SmartPtr](../../system/smartptr/). Efektywnie zamienia dwa wskaźniki, jeśli oba są w tym samym trybie. x może stać się nieużywalny po wywołaniu. |
...
|  [X509ExtensionCollectionPtr](./x509extensioncollectionptr/)() | Konstruktor wskaźnika null. |
