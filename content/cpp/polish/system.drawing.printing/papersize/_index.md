...
description: Określa rozmiar kartki papieru.
type: docs
weight: 27
url: /pl/system.drawing.printing/papersize/
---
## PaperSize klasa
...
| **int32_t** [get_Height](./get_height/)() const | Zwraca wysokość papieru w setnych cala. |
| [PaperKind](../paperkind/) [get_Kind](./get_kind/)() const | Zwraca typ papieru. |
| [System::String](../../system/string/) [get_PaperName](./get_papername/)() const | Zwraca nazwę typu papieru. |
| **int32_t** [get_RawKind](./get_rawkind/)() const | Zwraca liczbę całkowitą reprezentującą jedną z wartości [System::Drawing::Printing::PaperSize](./) lub wartość niestandardową. |
| **int32_t** [get_Width](./get_width/)() const | Zwraca szerokość papieru w setnych cala. |
...
|  [PaperSize](./papersize/)() | Inicjalizuje nową instancję klasy [System::Drawing::Printing::PaperSize](./). |
|  [PaperSize](./papersize/)([PaperKind](../paperkind/), [System::String](../../system/string/), **int32_t**, **int32_t**) | Inicjalizuje nową instancję klasy [System::Drawing::Printing::PaperSize](./). |
|  [PaperSize](./papersize/)([System::String](../../system/string/), **int32_t**, **int32_t**) | Inicjalizuje nową instancję klasy [System::Drawing::Printing::PaperSize](./). |
...
| void [set_Height](./set_height/)(**int32_t**) | Ustawia wysokość papieru w setnych cala. |
| void [set_PaperName](./set_papername/)([System::String](../../system/string/)) | Ustawia nazwę typu papieru. |
| void [set_RawKind](./set_rawkind/)(**int32_t**) | Ustawia liczbę całkowitą reprezentującą jedną z wartości [System::Drawing::Printing::PaperSize](./) lub wartość niestandardową. |
| void [set_Width](./set_width/)(**int32_t**) | Ustawia szerokość papieru w setnych cala. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Dostarcza informacje o [System::Drawing::Printing::PaperSize](./) w formie łańcucha znaków. |
