...
description: Timer, który wywołuje delegata w pętli.
type: docs
weight: 14
url: /pl/system.timers/timer/
---
## Klasa Timer


[Timer](./) która wywołuje delegata w pętli.
...
| Metoda | Opis |
| --- | --- |
| void [Close](./close/)() | Zatrzymuje timer, zwalnia przydzielone zasoby. |
|  [Component](../../system.componentmodel/component/component/)() | Informacje RTTI. |
| void [Dispose](./dispose/)() | Zatrzymuje timer, zwalnia przydzielone zasoby. |
...
| **bool** [get_AutoReset](./get_autoreset/)() const | Sprawdza, czy timer jest w trybie automatycznego resetu. |
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | Sprawdza, czy komponent jest w trybie projektowania. |
| **bool** [get_Enabled](./get_enabled/)() const | Sprawdza, czy timer jest aktywny. |
| **double** [get_Interval](./get_interval/)() const | Pobiera interwał timera. |
| **bool** [get_IsStopped](./get_isstopped/)() const | Sprawdza, czy timer jest zatrzymany. |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | Ustawia timer w tryb automatycznego resetu lub wyłącza go. |
| void [set_Enabled](./set_enabled/)(**bool**) | Uruchamia lub zatrzymuje timer. Uruchomienie timera nie resetuje liczenia czasu, jeśli timer już działa. |
| void [set_Interval](./set_interval/)(**double**) | Ustawia interwał timera. |
...
| void [Start](./start/)() | Uruchamia timer. Nie restartuje liczenia czasu, jeśli timer już działa. |
| void [Stop](./stop/)() | Zatrzymuje timer. |
|  [Timer](./timer/)() | Informacje RTTI. |
|  [Timer](./timer/)(**double**) | Tworzy zatrzymany timer z określonym interwałem. |
