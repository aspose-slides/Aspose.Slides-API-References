...
description: "Przechowuje zestaw nazwanych pól reprezentujących zserializowany obiekt. Niezaimplementowane. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to powodować błędy czasu wykonania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argument do funkcji."
type: docs
weight: 53
url: /pl/system.runtime.serialization/serializationinfo/
---
## SerializationInfo klasa


Przechowuje zestaw nazwanych pól reprezentujących zserializowany obiekt. Niezaimplementowane. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami czasu wykonania i/lub naruszeniami asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej do funkcji jako argument.
...
| Metoda | Opis |
| --- | --- |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, **float**) | Umieszcza wartość float. Niezaimplementowane. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, short) | Umieszcza wartość short. Niezaimplementowane. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, **bool**) | Umieszcza wartość boolean. Niezaimplementowane. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Umieszcza wartość obiektu. Niezaimplementowane. |
| void [AddValue](./addvalue/)(const [System::String](../../system/string/)\&, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&, const [System::TypeInfo](../../system/typeinfo/)\&) | Umieszcza wartość obiektu z określonym typem. Niezaimplementowane. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [GetValue](./getvalue/)(const [System::String](../../system/string/)\&, const [System::TypeInfo](../../system/typeinfo/)\&) | Pobiera wartość ze sklepu [SerializationInfo](./). Niezaimplementowane. |
...
|  [SerializationInfo](./serializationinfo/)(const [System::TypeInfo](../../system/typeinfo/)\&, const [System::SharedPtr](../../system/sharedptr/)\<[IFormatterConverter](../iformatterconverter/)\>\&) | Informacje RTTI. |
