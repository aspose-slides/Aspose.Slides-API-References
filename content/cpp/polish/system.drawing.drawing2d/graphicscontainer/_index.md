...
description: "Zawiera wewnętrzne dane kontenera graficznego. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie działania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go funkcjom jako argument."
type: docs
weight: 53
url: /pl/system.drawing.drawing2d/graphicscontainer/
---
## GraphicsContainer klasa

Zawiera wewnętrzne dane kontenera graficznego. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu [System::MakeObject()](../../system/makeobject/) function. Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operator new, ponieważ spowoduje to błędy w czasie działania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w [System::SmartPtr](../../system/smartptr/) pointer i używaj tego wskaźnika do przekazywania go funkcjom jako argumentu.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są uznawane za równe, mimo że według IEC 60559:1989 NaN nie jest równy żadnej wartości, łącznie z NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są uznawane za równe, mimo że według IEC 60559:1989 NaN nie jest równy żadnej wartości, łącznie z NaN. |
