...
description: "Zawiera dane graficzne reprezentujące ścieżkę. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub naruszenia asercji. Zawsze owiń tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argument do funkcji."
type: docs
weight: 131
url: /pl/system.drawing.drawing2d/pathdata/
---
## PathData klasa

Zawiera dane graficzne reprezentujące ścieżkę. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Należy nigdy tworzyć instancję tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu działania i/lub naruszenia asercji. Zawsze owiń tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji.
...
| [ArrayPtr](../../system/arrayptr/)\<[PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | Zwraca tablicę zawierającą punkty tworzące ścieżkę. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Types](./get_types/)() | Zwraca tablicę zawierającą wartości określające typy odpowiadających punktów w tablicy **Points**. |
...
|  [PathData](./pathdata/)() | Tworzy pusty obiekt [PathData](./). |
...
| void [set_Points](./set_points/)(const [ArrayPtr](../../system/arrayptr/)\<[PointF](../../system.drawing/pointf/)\>\&) | Ustawia tablicę zawierającą punkty tworzące ścieżkę. |
| void [set_Types](./set_types/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Ustawia tablicę zawierającą wartości określające typy odpowiadających punktów w tablicy **Points**. |
