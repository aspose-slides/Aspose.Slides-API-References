...
description: Reprezentuje element notacji z XML Schema określony przez World Wide Web Consortium (W3C). Deklaracja notacji XML Schema jest rekonstrukcją deklaracji NOTATION w XML 1.0. Celem notacji jest opisanie formatu danych nie-XML wewnątrz dokumentu XML.
type: docs
weight: 651
url: /pl/system.xml.schema/xmlschemanotation/
---
## XmlSchemaNotation klasa


Reprezentuje element **notacja** z XML [Schema](../) określony przez World Wide [Web](../../system.web/) Consortium (W3C). Deklaracja **notacja** XML [Schema](../) jest rekonstrukcją deklaracji **XML** 1.0 NOTATION. Celem notacji jest opisanie formatu danych nie-XML wewnątrz dokumentu XML.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Zwraca nazwę notacji. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Zwraca XmlSerializerNamespaces używany z tym obiektem schematu. |
...
| [String](../../system/string/) [get_Public](./get_public/)() | Zwraca identyfikator **public**. |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Zwraca lokalizację źródłową pliku, który wczytał schemat. |
| [String](../../system/string/) [get_System](./get_system/)() | Zwraca identyfikator **system**. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Ustawia nazwę notacji. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Ustawia XmlSerializerNamespaces używany z tym obiektem schematu. |
...
| void [set_Public](./set_public/)(const [String](../../system/string/)\&) | Ustawia identyfikator **public**. |
...
| void [set_System](./set_system/)(const [String](../../system/string/)\&) | Ustawia identyfikator **system**. |
...
|  [XmlSchemaNotation](./xmlschemanotation/)() | Inicjalizuje nową instancję klasy [XmlSchemaNotation](./). |
