...
description: Reprezentuje element maxExclusive ze schematu XML określony przez World Wide Web Consortium (W3C). Ta klasa może być użyta do określenia ograniczenia maksymalnej wartości elementu simpleType. Wartość elementu musi być mniejsza niż wartość elementu maxExclusive.
type: docs
weight: 573
url: /pl/system.xml.schema/xmlschemamaxexclusivefacet/
---
## XmlSchemaMaxExclusiveFacet klasa


Reprezentuje element **maxExclusive** z XML [Schema](../) określony przez World Wide [Web](../../system.web/) Consortium (W3C). Ta klasa może być użyta do określenia ograniczenia maksymalnej wartości elementu **simpleType**. Wartość elementu musi być mniejsza niż wartość elementu **maxExclusive**.
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę wyrażenia lock() w C#. Wywołaj bezpośrednio lub użyj obiektu strażniczego [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Odpowiednik metody C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umożliwia klonowanie własnych typów. |
|  [Object](../../system/object/object/)() | Tworzy obiekt. Inicjalizuje wszystkie wewnętrzne struktury danych. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje niczego, tak naprawdę, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstrukcji podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje niczego, tak naprawdę, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstrukcji podklas. |
...
|  [XmlSchemaMaxExclusiveFacet](./xmlschemamaxexclusivefacet/)() | Inicjalizuje nową instancję klasy [XmlSchemaMaxExclusiveFacet](./). |
