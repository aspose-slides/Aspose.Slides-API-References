...
description: Abstrakcyjna klasa dla zawartości schematu.
type: docs
weight: 313
url: /pl/system.xml.schema/xmlschemacontent/
---
## XmlSchemaContent klasa

Abstrakcyjna klasa dla zawartości schematu.
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Zwraca **string** id. |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Zwraca położenie źródła dla pliku, który załadował schemat. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje nic, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstrukcji podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje nic, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstrukcji podklas. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Ustawia **string** id. |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Ustawia położenie źródła dla pliku, który załadował schemat. |
