...
description: Reprezentuje element simpleContent ze schematu XML zgodnie ze specyfikacją World Wide Web Consortium (W3C). Ta klasa jest przeznaczona dla typów prostych i złożonych z modelem prostego zawartości.
type: docs
weight: 794
url: /pl/system.xml.schema/xmlschemasimplecontent/
---
## XmlSchemaSimpleContent klasa


Represents the **simpleContent** element from XML [Schema](../) as specified by the Światowy [Web](../../system.web/) Konsorcjum (W3C). This class is for simple and complex types with simple content model.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | Zwraca jedną z [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) lub [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Zwraca identyfikator string. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Zwraca atrybuty kwalifikowane, które nie należą do docelowej przestrzeni nazw bieżącego schematu. |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | Zwraca jedną z [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) lub [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/). |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Ustawia atrybuty kwalifikowane, które nie należą do docelowej przestrzeni nazw bieżącego schematu. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n-ty argument szablonu jako weak pointer (zamiast shared). Umożliwia zmianę wskaźników w kontenerach na tryb słaby. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowywanie statementu C# lock(). Wywołaj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabego odwołania. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabego odwołania. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
...
| Typedef | Opis |
| --- | --- |
| [Ptr](./ptr/) | Aliasa dla wskaźnika współdzielonego do instancji tej klasy. |

## Uwagi

Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ doprowadzi to do błędów czasu wykonywania i/lub awarii asercji. Zawsze opakuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej funkcjom jako argument.

## Zobacz także

* Klasa [XmlSchemaContentModel](../xmlschemacontentmodel/)
