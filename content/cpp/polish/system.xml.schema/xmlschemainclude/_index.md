...
description: Reprezentuje element include z XML Schema określony przez World Wide Web Consortium (W3C). Ta klasa jest używana do dołączania deklaracji i definicji z zewnętrznego schematu. Dołączone deklaracje i definicje są następnie dostępne do przetwarzania w schemacie zawierającym.
type: docs
weight: 495
url: /pl/system.xml.schema/xmlschemainclude/
---
## XmlSchemaInclude klasa


Reprezentuje element **include** z XML [Schema](../) określony przez World Wide [Web](../../system.web/) Consortium (W3C). Ta klasa służy do dołączania deklaracji i definicji z zewnętrznego schematu. Dołączone deklaracje i definicje są następnie dostępne do przetwarzania w schemacie zawierającym.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\> [get_Annotation](./get_annotation/)() | Zwraca wartość **annotation**. |
| [String](../../system/string/) [get_Id](../xmlschemaexternal/get_id/)() | Zwraca identyfikator ciągu. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Zwraca XmlSerializerNamespaces używane z tym obiektem schematu. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [get_Schema](../xmlschemaexternal/get_schema/)() | Zwraca [XmlSchema](../xmlschema/) dla odwoływanego schematu. |
| [String](../../system/string/) [get_SchemaLocation](../xmlschemaexternal/get_schemalocation/)() | Zwraca lokalizację Uniform Resource Identifier (URI) schematu, która informuje procesor schematu, gdzie schemat fizycznie się znajduje. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaexternal/get_unhandledattributes/)() | Zwraca atrybuty kwalifikowane, które nie należą do docelowej przestrzeni nazw schematu. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę za pomocą instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/). |
...
| void [set_Annotation](./set_annotation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\>\&) | Ustawia wartość **annotation**. |
| void [set_Id](../xmlschemaexternal/set_id/)(const [String](../../system/string/)\&) | Ustawia identyfikator ciągu. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Ustawia XmlSerializerNamespaces używane z tym obiektem schematu. |
...
| void [set_Schema](../xmlschemaexternal/set_schema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Ustawia [XmlSchema](../xmlschema/) dla odwoływanego schematu. |
| void [set_SchemaLocation](../xmlschemaexternal/set_schemalocation/)(const [String](../../system/string/)\&) | Ustawia lokalizację Uniform Resource Identifier (URI) schematu, która informuje procesor schematu, gdzie schemat fizycznie się znajduje. |
...
| void [set_UnhandledAttributes](../xmlschemaexternal/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Ustawia atrybuty kwalifikowane, które nie należą do docelowej przestrzeni nazw schematu. |
...
|  [XmlSchemaExternal](../xmlschemaexternal/xmlschemaexternal/)() | Inicjalizuje nową instancję klasy [XmlSchemaExternal](../xmlschemaexternal/). |
|  [XmlSchemaInclude](./xmlschemainclude/)() | Inicjalizuje nową instancję klasy [XmlSchemaInclude](./). |
...
* Klasa [XmlSchemaExternal](../xmlschemaexternal/)
