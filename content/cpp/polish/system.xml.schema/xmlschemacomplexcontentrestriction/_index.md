...
description: Reprezentuje element restriction z XML Schema określony przez World Wide Web Consortium (W3C). Ta klasa jest przeznaczona dla typów złożonych z modelem złożonej zawartości pochodzącym z ograniczenia. Ogranicza zawartość typu złożonego do podzbioru odziedziczonego typu złożonego.
type: docs
weight: 287
url: /pl/system.xml.schema/xmlschemacomplexcontentrestriction/
---
## XmlSchemaComplexContentRestriction klasa


Reprezentuje element **restriction** z XML [Schema](../) określony przez konsorcjum World Wide [Web](../../system.web/) (W3C). Ta klasa jest przeznaczona dla typów złożonych z modelem złożonej zawartości pochodzącym z ograniczenia. Ogranicza zawartość typu złożonego do podzestawu odziedziczonego typu złożonego.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Zwraca komponent [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) modelu złożonej zawartości. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Zwraca kolekcję atrybutów dla typu złożonego. Zawiera elementy [XmlSchemaAttribute](../xmlschemaattribute/) i [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Zwraca nazwę typu złożonego, z którego ten typ jest pochodny przez ograniczenie. |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Ustawia komponent [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) modelu złożonej zawartości. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Ustawia nazwę typu złożonego, z którego ten typ jest pochodny przez ograniczenie. |
...
|  [XmlSchemaComplexContentRestriction](./xmlschemacomplexcontentrestriction/)() | Inicjalizuje nową instancję klasy [XmlSchemaComplexContentRestriction](./). |
