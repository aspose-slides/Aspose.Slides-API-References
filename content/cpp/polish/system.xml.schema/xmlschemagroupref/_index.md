...
description: Reprezentuje element group z atrybutem ref z XML Schema określonym przez konsorcjum World Wide Web (W3C). Ta klasa jest używana w typach złożonych, które odwołują się do grupy zdefiniowanej na poziomie schematu.
type: docs
weight: 456
url: /pl/system.xml.schema/xmlschemagroupref/
---
## XmlSchemaGroupRef klasa
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | Zwraca jedną z klas [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) lub [XmlSchemaSequence](../xmlschemasequence/), które przechowują post-kompilacyjną interpretację wartości **Particle**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Zwraca nazwę grupy zdefiniowanej w tym schemacie (lub w innym schemacie wskazanym przez określoną przestrzeń nazw). |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Ustawia nazwę grupy zdefiniowanej w tym schemacie (lub w innym schemacie wskazanym przez określoną przestrzeń nazw). |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa liczbę słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza liczbę słabych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
|  [XmlSchemaGroupRef](./xmlschemagroupref/)() | Inicjalizuje nową instancję klasy [XmlSchemaGroupRef](./). |
