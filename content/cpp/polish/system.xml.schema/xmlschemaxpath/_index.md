...
description: Reprezentuje element selector organizacji World Wide Web Consortium (W3C).
type: docs
weight: 963
url: /pl/system.xml.schema/xmlschemaxpath/
---
## XmlSchemaXPath klasa


Reprezentuje element **selector** World Wide [Web](../../system.web/) Consortium (W3C).
...
| [String](../../system/string/) [get_XPath](./get_xpath/)() | Zwraca atrybut dla wyrażenia [XPath](../../system.xml.xpath/). |
...
| void [set_XPath](./set_xpath/)(const [String](../../system/string/)\&) | Ustawia atrybut dla wyrażenia [XPath](../../system.xml.xpath/). |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementuje i zwraca współdzielony licznik referencji. Nie powinno być wywoływane bezpośrednio; zamiast tego używaj inteligentnych wskaźników lub ThisProtector. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementuje słaby licznik referencji. Nie powinno być wywoływane bezpośrednio; zamiast tego używaj inteligentnych wskaźników lub ThisProtector. |
