...
description: Zapewnia opcje kompilacji schematu dla klasy XmlSchemaSet. Ta klasa nie może być dziedziczona.
type: docs
weight: 248
url: /pl/system.xml.schema/xmlschemacompilationsettings/
---
## XmlSchemaCompilationSettings klasa

Zapewnia opcje kompilacji schematu dla klasy [XmlSchemaSet](../xmlschemaset/). Ta klasa nie może być dziedziczona.
...
| Metoda | Opis |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Porównuje obiekty używając C# [Object.Equals](../../system/object/equals/) semantyki. |
...
| **bool** [get_EnableUpaCheck](./get_enableupacheck/)() | Zwraca wartość wskazującą, czy [XmlSchemaSet](../xmlschemaset/) powinien sprawdzać naruszenia Unique Particle Attribution (UPA). |
...
| void [set_EnableUpaCheck](./set_enableupacheck/)(**bool**) | Ustawia wartość wskazującą, czy [XmlSchemaSet](../xmlschemaset/) powinien sprawdzać naruszenia Unique Particle Attribution (UPA). |
...
|  [XmlSchemaCompilationSettings](./xmlschemacompilationsettings/)() | Inicjalizuje nową instancję klasy [XmlSchemaCompilationSettings](./). |
