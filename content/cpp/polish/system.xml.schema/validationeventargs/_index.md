...
description: Zwraca szczegółowe informacje powiązane z ValidationEventHandler.
type: docs
weight: 53
url: /pl/system.xml.schema/validationeventargs/
---
## ValidationEventArgs klasa
...
| [XmlSchemaException](../xmlschemaexception/) [get_Exception](./get_exception/)() | Zwraca XmlSchemaException powiązany z zdarzeniem walidacji. |
| [String](../../system/string/) [get_Message](./get_message/)() | Zwraca opis tekstowy odpowiadający zdarzeniu walidacji. |
| [XmlSeverityType](../xmlseveritytype/) [get_Severity](./get_severity/)() | Zwraca poziom krytyczności zdarzenia walidacji. |
...
| Pole | Opis |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Statyczny element reprezentujący „pusty” współdzielony wskaźnik [EventArgs](../../system/eventargs/) (wskaźnik null). |
## Definicje typów
