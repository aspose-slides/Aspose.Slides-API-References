...
description: Reprezentuje facet length z XML Schema określony przez World Wide Web Consortium (W3C). Ta klasa może być użyta do określenia ograniczenia długości elementu simpleType w typie danych.
type: docs
weight: 560
url: /pl/system.xml.schema/xmlschemalengthfacet/
---
## XmlSchemaLengthFacet klasa

Reprezentuje facet **length** z XML [Schema](../) określony przez Konsorcjum World Wide [Web](../../system.web/) (W3C). Ta klasa może być użyta do określenia ograniczenia długości elementu **simpleType** w typie danych.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, w którym dwa NaN są uważane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, łącznie z NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, w którym dwa NaN są uważane za równe, mimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, łącznie z NaN. |
...
|  [XmlSchemaLengthFacet](./xmlschemalengthfacet/)() | Inicjalizuje nową instancję klasy [XmlSchemaLengthFacet](./). |
...
Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to prowadzić do błędów w czasie wykonania i/lub naruszeń asercji. Zawsze owijaj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go jako argument do funkcji.
