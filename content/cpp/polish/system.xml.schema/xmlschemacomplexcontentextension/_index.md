...
description: Reprezentuje element extension ze schematu XML Schema określony przez World Wide Web Consortium (W3C). Ta klasa jest przeznaczona dla typów złożonych o modelu zawartości złożonej pochodzącym przez rozszerzenie. Rozszerza typ złożony, dodając atrybuty lub elementy.
type: docs
weight: 274
url: /pl/system.xml.schema/xmlschemacomplexcontentextension/
---
## XmlSchemaComplexContentExtension klasa

Reprezentuje element **extension** z XML [Schema](../) zgodnie ze specyfikacją World Wide [Web](../../system.web/) Consortium (W3C). Ta klasa jest przeznaczona dla typów złożonych o modelu zawartości złożonej pochodzących przez rozszerzenie. Rozszerza typ złożony, dodając atrybuty lub elementy.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Zwraca komponent [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) modelu zawartości złożonej. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Zwraca kolekcję atrybutów dla zawartości złożonej. Zawiera elementy [XmlSchemaAttribute](../xmlschemaattribute/) i [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Zwraca nazwę typu złożonego, z którego ten typ jest dziedziczony przez rozszerzenie. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\> [get_Particle](./get_particle/)() | Zwraca jedną z klas [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) lub [XmlSchemaSequence](../xmlschemasequence/). |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę wyrażenia C# lock(). Wywołaj bezpośrednio lub użyj obiektu straży [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Odpowiednik metody C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Umożliwia klonowanie własnych typów. |
|  [Object](../../system/object/object/)() | Tworzy obiekt. Inicjalizuje wszystkie wewnętrzne struktury danych. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje niczego, tylko inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje niczego, tylko inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Ustawia komponent [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) modelu zawartości złożonej. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Ustawia nazwę typu złożonego, z którego ten typ jest dziedziczony przez rozszerzenie. |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\>\&) | Ustawia jedną z klas [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) lub [XmlSchemaSequence](../xmlschemasequence/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie wyrażenia C# lock(). Wywołaj bezpośrednio lub użyj obiektu straży [LockContext](../../system/lockcontext/). |
...
|  [XmlSchemaComplexContentExtension](./xmlschemacomplexcontentextension/)() | Inicjalizuje nową instancję klasy [XmlSchemaComplexContentExtension](./). |
...
Obiekty tej klasy powinny być przydzielane tylko przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze otaczaj tę klasę wskaźnikiem [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej do funkcji jako argument.

## Zobacz także

* Klasa [XmlSchemaContent](../xmlschemacontent/)
