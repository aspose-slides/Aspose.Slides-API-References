...
description: Reprezentuje element attribute ze schematu XML określony przez World Wide Web Consortium (W3C). Atrybuty dostarczają dodatkowych informacji dla innych elementów dokumentu. Znacznik atrybutu jest zagnieżdżony pomiędzy znacznikami elementu dokumentu w schemacie. Dokument XML wyświetla atrybuty jako nazwane elementy w otwierającym znaczniku elementu.
type: docs
weight: 170
url: /pl/system.xml.schema/xmlschemaattribute/
---
## XmlSchemaAttribute klasa

Reprezentuje element **attribute** w XML [Schema](../) określony przez konsorcjum World Wide [Web](../../system.web/) (W3C). Atrybuty dostarczają dodatkowych informacji dla innych elementów dokumentu. Znacznik atrybutu jest zagnieżdżony pomiędzy znacznikami elementu dokumentu w schemacie. Dokument XML wyświetla atrybuty jako nazwane elementy w otwierającym znaczniku elementu.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_AttributeSchemaType](./get_attributeschematype/)() | Zwraca obiekt [XmlSchemaSimpleType](../xmlschemasimpletype/) reprezentujący typ atrybutu w oparciu o wartość [XmlSchemaAttribute::get_SchemaType](./get_schematype/) lub [XmlSchemaAttribute::get_SchemaTypeName](./get_schematypename/) atrybutu. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_AttributeType](./get_attributetype/)() | Zwraca obiekt w oparciu o wartość [XmlSchemaAttribute::get_SchemaType](./get_schematype/) lub [XmlSchemaAttribute::get_SchemaTypeName](./get_schematypename/) atrybutu, który przechowuje interpretację po kompilacji wartości **AttributeType**. |
| [String](../../system/string/) [get_DefaultValue](./get_defaultvalue/)() | Zwraca domyślną wartość atrybutu. |
| [String](../../system/string/) [get_FixedValue](./get_fixedvalue/)() | Zwraca stałą wartość atrybutu. |
| [XmlSchemaForm](../xmlschemaform/) [get_Form](./get_form/)() | Zwraca formę atrybutu. |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Zwraca nazwę atrybutu. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Zwraca kwalifikowaną nazwę atrybutu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Zwraca nazwę atrybutu zadeklarowanego w tym schemacie (lub w innym schemacie wskazanym przez określony przestrzeń nazw). |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_SchemaType](./get_schematype/)() | Zwraca typ atrybutu jako typ prosty. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_SchemaTypeName](./get_schematypename/)() | Zwraca nazwę prostego typu zdefiniowanego w tym schemacie (lub w innym schemacie wskazanym przez określony przestrzeń nazw). |
...
| [XmlSchemaUse](../xmlschemause/) [get_Use](./get_use/)() | Zwraca informacje o tym, jak używany jest atrybut. |
...
| void [set_DefaultValue](./set_defaultvalue/)(const [String](../../system/string/)\&) | Ustawia domyślną wartość atrybutu. |
| void [set_FixedValue](./set_fixedvalue/)(const [String](../../system/string/)\&) | Ustawia stałą wartość atrybutu. |
| void [set_Form](./set_form/)([XmlSchemaForm](../xmlschemaform/)) | Ustawia formę atrybutu. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Ustawia nazwę atrybutu. |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Ustawia nazwę atrybutu zadeklarowanego w tym schemacie (lub w innym schemacie wskazanym przez określony przestrzeń nazw). |
| void [set_SchemaType](./set_schematype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Ustawia typ atrybutu jako typ prosty. |
| void [set_SchemaTypeName](./set_schematypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Ustawia nazwę prostego typu zdefiniowanego w tym schemacie (lub w innym schemacie wskazanym przez określony przestrzeń nazw). |
...
| void [set_Use](./set_use/)([XmlSchemaUse](../xmlschemause/)) | Ustawia informacje o tym, jak używany jest atrybut. |
...
|  [XmlSchemaAttribute](./xmlschemaattribute/)() | Inicjalizuje nową instancję klasy [XmlSchemaAttribute](./). |
...
Obiekty tej klasy powinny być alokowane wyłącznie za pomocą funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji jako argumentu. 
