...
description: Reprezentuje element restriction dla typów prostych z XML Schema, określony przez World Wide Web Consortium (W3C). Ta klasa może być używana do ograniczania elementu simpleType.
type: docs
weight: 872
url: /pl/system.xml.schema/xmlschemasimpletyperestriction/
---
## XmlSchemaSimpleTypeRestriction klasa
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | Zwraca informacje o typie bazowym. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Zwraca nazwę kwalifikowanego typu bazowego. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | Zwraca facet [Xml](../../system.xml/)[Schema](../). |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Zwraca identyfikator łańcucha. |
...
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Ustawia informacje o typie bazowym. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Ustawia nazwę kwalifikowanego typu bazowego. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Ustawia identyfikator łańcucha. |
...
|  [XmlSchemaSimpleTypeRestriction](./xmlschemasimpletyperestriction/)() | Inicjalizuje nową instancję klasy [XmlSchemaSimpleTypeRestriction](./). |
