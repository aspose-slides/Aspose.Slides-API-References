...
description: Reprezentuje element minLength z XML Schema określony przez World Wide Web Consortium (W3C). Ta klasa może być użyta do określenia ograniczenia minimalnej długości wartości danych elementu simpleType. Długość musi być większa niż wartość elementu minLength.
type: docs
weight: 638
url: /pl/system.xml.schema/xmlschemaminlengthfacet/
---
## XmlSchemaMinLengthFacet klasa
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są uważane za równe, mimo że według IEC 60559:1989 NaN nie jest równy żadnej wartości, łącznie z NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie liczb zmiennoprzecinkowych w stylu C#, gdzie dwa NaN są uważane za równe, mimo że według IEC 60559:1989 NaN nie jest równy żadnej wartości, łącznie z NaN. |
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Zwraca identyfikator łańcuchowy. |
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Zwraca informację wskazującą, że ten faset jest stały. |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Zwraca lokalizację źródła pliku, który wczytał schemat. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Zwraca atrybut **value** fasetu. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Ustawia identyfikator łańcuchowy. |
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Ustawia informację wskazującą, że ten faset jest stały. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Ustawia atrybut **value** fasetu. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog metody C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwersję własnych obiektów na łańcuch. |
...
|  [XmlSchemaMinLengthFacet](./xmlschemaminlengthfacet/)() | Inicjalizuje nową instancję klasy [XmlSchemaMinLengthFacet](./). |
