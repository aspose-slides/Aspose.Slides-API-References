...
description: Udostępnia kolekcje dla zawartych elementów w klasie XmlSchema (na przykład Attributes, AttributeGroups, Elements i tak dalej).
type: docs
weight: 716
url: /pl/system.xml.schema/xmlschemaobjecttable/
---
## XmlSchemaObjectTable klasa

Udostępnia kolekcje dla zawartych elementów w klasie [XmlSchema](../xmlschema/) (na przykład Attributes, AttributeGroups, Elements i inne).
...
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Określa, czy podana kwalifikowana nazwa istnieje w kolekcji. |
...
| **int32_t** [get_Count](./get_count/)() | Zwraca liczbę elementów zawartych w [XmlSchemaObjectTable](./). |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\> [get_Names](./get_names/)() | Zwraca kolekcję wszystkich nazwanych elementów w [XmlSchemaObjectTable](./). |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [get_Values](./get_values/)() | Zwraca kolekcję wszystkich wartości dla wszystkich elementów w [XmlSchemaObjectTable](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Zwraca strukturę licznika referencji powiązaną z obiektem. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\>\> [GetEnumerator](./getenumerator/)() override | Zwraca enumerator, który może iterować po [XmlSchemaObjectTable](./). |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Zwraca element w [XmlSchemaObjectTable](./) określony przez kwalifikowaną nazwę. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią ciągu wartości uzyskanych przez wywołanie funkcji transformującej dla każdego elementu sekwencji wejściowej. |
