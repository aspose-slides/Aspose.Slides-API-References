...
description: Reprezentuje element redefine z XML Schema, określony przez World Wide Web Consortium (W3C). Ta klasa może być używana do dopuszczania prostych i złożonych typów, grup oraz grup atrybutów z zewnętrznych plików schematów do redefinicji w bieżącym schemacie. Klasa może również służyć do wersjonowania elementów schematu.
type: docs
weight: 755
url: /pl/system.xml.schema/xmlschemaredefine/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectTable](../xmlschemaobjecttable/)\> [get_AttributeGroups](./get_attributegroups/)() | Zwraca [XmlSchemaObjectTable](../xmlschemaobjecttable/), dla wszystkich atrybutów w schemacie, który zawiera interpretację po kompilacji wartości **AttributeGroups**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectTable](../xmlschemaobjecttable/)\> [get_Groups](./get_groups/)() | Zwraca [XmlSchemaObjectTable](../xmlschemaobjecttable/), dla wszystkich grup w schemacie, który zawiera interpretację po kompilacji wartości **Groups**. |
| [String](../../system/string/) [get_Id](../xmlschemaexternal/get_id/)() | Zwraca identyfikator ciągu znaków. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() | Zwraca kolekcję następujących klas: [XmlSchemaAnnotation](../xmlschemaannotation/), [XmlSchemaAttributeGroup](../xmlschemaattributegroup/), [XmlSchemaComplexType](../xmlschemacomplextype/), [XmlSchemaSimpleType](../xmlschemasimpletype/) i [XmlSchemaGroup](../xmlschemagroup/). |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectTable](../xmlschemaobjecttable/)\> [get_SchemaTypes](./get_schematypes/)() | Zwraca [XmlSchemaObjectTable](../xmlschemaobjecttable/), dla wszystkich prostych i złożonych typów w schemacie, który zawiera interpretację po kompilacji wartości **SchemaTypes**. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę (lock()) języka C#. Wywołaj bezpośrednio lub użyj obiektu [LockContext](../../system/lockcontext/). |
...
| void [set_Id](../xmlschemaexternal/set_id/)(const [String](../../system/string/)\&) | Ustawia identyfikator ciągu znaków. |
...
|  [XmlSchemaRedefine](./xmlschemaredefine/)() | Inicjalizuje nową instancję klasy [XmlSchemaRedefine](./). |
