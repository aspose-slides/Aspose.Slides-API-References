...
description: Reprezentuje element documentation z XML Schema zgodnie ze specyfikacją World Wide Web Consortium (W3C). Ta klasa określa informacje przeznaczone do odczytu lub użycia przez ludzi w ramach adnotacji.
type: docs
weight: 352
url: /pl/system.xml.schema/xmlschemadocumentation/
---
## XmlSchemaDocumentation klasa

Reprezentuje element **documentation** z XML [Schema](../) określony przez konsorcjum World Wide [Web](../../system.web/) (W3C). Ta klasa określa informacje przeznaczone do odczytu lub użycia przez ludzi w **annotation**.
...
| [String](../../system/string/) [get_Language](./get_language/)() | Zwraca atrybut **xml:lang**. Służy jako wskaźnik języka używanego w treści. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Zwraca tablicę obiektów [XmlNode](../../system.xml/xmlnode/) reprezentujących węzły potomne dokumentacji. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Zwraca źródło Uniform Resource Identifier (URI) informacji. |
...
| void [set_Language](./set_language/)(const [String](../../system/string/)\&) | Ustawia atrybut **xml:lang**. Służy jako wskaźnik języka używanego w treści. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Ustawia tablicę obiektów [XmlNode](../../system.xml/xmlnode/) reprezentujących węzły potomne dokumentacji. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Ustawia źródło Uniform Resource Identifier (URI) informacji. |
