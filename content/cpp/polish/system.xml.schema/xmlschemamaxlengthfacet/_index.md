...
description: Reprezentuje element maxLength z XML Schema określony przez World Wide Web Consortium (W3C). Ta klasa może być użyta do określenia ograniczenia maksymalnej długości wartości danych elementu simpleType. Długość musi być mniejsza niż wartość elementu maxLength.
type: docs
weight: 599
url: /pl/system.xml.schema/xmlschemamaxlengthfacet/
---
## XmlSchemaMaxLengthFacet klasa


Reprezentuje element **maxLength** z XML [Schema](../) określony przez World Wide [Web](../../system.web/) Consortium (W3C). Ta klasa może być użyta do określenia ograniczenia maksymalnej długości wartości danych elementu **simpleType**. Długość musi być mniejsza niż wartość elementu **maxLength**.
...
|  [XmlSchemaMaxLengthFacet](./xmlschemamaxlengthfacet/)() | Inicjalizuje nową instancję klasy [XmlSchemaMaxLengthFacet](./). |
