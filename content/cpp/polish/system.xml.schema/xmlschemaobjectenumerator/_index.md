...
description: Reprezentuje enumerator dla XmlSchemaObjectCollection.
type: docs
weight: 703
url: /pl/system.xml.schema/xmlschemaobjectenumerator/
---
## XmlSchemaObjectEnumerator klasa

Reprezentuje enumerator dla [XmlSchemaObjectCollection](../xmlschemaobjectcollection/).
...
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchemaObject](../xmlschemaobject/)\>\> * [CloneIterator](./cloneiterator/)() const override | Klonuje bieżący iterator. |
...
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\& [get_Current](./get_current/)() const override | Zwraca bieżący [XmlSchemaObject](../xmlschemaobject/) w kolekcji. |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Przesuwa iterator o jeden krok do przodu. |
...
| **bool** [MoveNext](./movenext/)() override | Przechodzi do następnego elementu w kolekcji. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza licznik udostępnionych referencji o podaną wartość. |
| void [Reset](./reset/)() override | Resetuje enumerator do początku kolekcji. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n-argument szablonu jako słaby wskaźnik (zamiast udostępnionego). Pozwala przełączać wskaźniki w kontenerach na tryb słaby. |
| int [SharedCount](../../system/object/sharedcount/)() const | Pobiera bieżącą wartość licznika udostępnionych referencji. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Inkrementuje licznik udostępnionych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Dekrementuje i zwraca licznik udostępnionych referencji. Nie powinno się wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
...
| Definicja typu | Opis |
| --- | --- |
| [Ptr](./ptr/) | Alias dla udostępnionego wskaźnika do instancji tej klasy. |
