...
description: Reprezentuje fasetę wyliczenia z XML Schema zgodnie z definicją World Wide Web Consortium (W3C). Ta klasa określa listę dopuszczalnych wartości dla elementu simpleType. Deklaracja znajduje się wewnątrz deklaracji ograniczenia.
type: docs
weight: 378
url: /pl/system.xml.schema/xmlschemaenumerationfacet/
---
## XmlSchemaEnumerationFacet klasa
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Zwraca nadrzędny element tego [XmlSchemaObject](../xmlschemaobject/). |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Ustawia nadrzędny element tego [XmlSchemaObject](../xmlschemaobject/). |
...
|  [XmlSchemaEnumerationFacet](./xmlschemaenumerationfacet/)() | Inicjalizuje nową instancję klasy [XmlSchemaEnumerationFacet](./). |
