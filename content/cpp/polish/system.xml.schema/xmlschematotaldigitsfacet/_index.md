...
description: Reprezentuje fasetę totalDigits ze schematu XML określoną przez World Wide Web Consortium (W3C). Ta klasa może być użyta do określenia ograniczenia liczby cyfr, które mogą być wprowadzone dla wartości elementu simpleType. Wartość totalDigits musi być liczbą całkowitą dodatnią.
type: docs
weight: 898
url: /pl/system.xml.schema/xmlschematotaldigitsfacet/
---
## XmlSchemaTotalDigitsFacet klasa

Reprezentuje fasetę **totalDigits** z XML [Schema](../) określoną przez Konsorcjum World Wide [Web](../../system.web/) (W3C). Ta klasa może być użyta do określenia ograniczenia liczby cyfr, które mogą być wprowadzone dla wartości elementu **simpleType**. Ta wartość **totalDigits** musi być liczbą całkowitą dodatnią.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Zwraca informację wskazującą, że ta faseta jest stała. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Zwraca atrybut **value** fasety. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Tak naprawdę nic nie kopiuje, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Tak naprawdę nic nie kopiuje, jedynie inicjalizuje nowy obiekt i umożliwia kopiowanie podklas. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Ustawia informację wskazującą, że ta faseta jest stała. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Ustawia atrybut **value** fasety. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n-ty argument szablonu jako wskaźnik słaby (zamiast współdzielonego). Pozwala zmienić wskaźniki w kontenerach na tryb słaby. |
...
|  [XmlSchemaTotalDigitsFacet](./xmlschematotaldigitsfacet/)() | Inicjalizuje nową instancję klasy [XmlSchemaTotalDigitsFacet](./). |
