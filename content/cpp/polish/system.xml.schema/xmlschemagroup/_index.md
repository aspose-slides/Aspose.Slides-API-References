...
description: Reprezentuje element group z XML Schema zgodnie z określeniem World Wide Web Consortium (W3C). Ta klasa definiuje grupy na poziomie schematu, które są odwoływane z typów złożonych. Grupuje zestaw deklaracji elementów, aby mogły być włączone jako grupa do definicji typów złożonych.
type: docs
weight: 430
url: /pl/system.xml.schema/xmlschemagroup/
---
## XmlSchemaGroup klasa
...
| [String](../../system/string/) [get_Name](./get_name/)() | Zwraca nazwę grupy schematu. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | Zwraca jedną z klas [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) lub [XmlSchemaSequence](../xmlschemasequence/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Zwraca w pełni kwalifikowaną nazwę grupy schematu. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Ustawia nazwę grupy schematu. |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\>\&) | Ustawia jedną z klas [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) lub [XmlSchemaSequence](../xmlschemasequence/). |
...
|  [XmlSchemaGroup](./xmlschemagroup/)() | Inicjalizuje nową instancję klasy [XmlSchemaGroup](./). |
