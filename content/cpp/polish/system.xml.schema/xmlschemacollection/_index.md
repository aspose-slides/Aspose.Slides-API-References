...
description: Zawiera pamięć podręczną definicji schematów XML Schema (XSD) oraz XML-Data Reduced (XDR).
type: docs
weight: 222
url: /pl/system.xml.schema/xmlschemacollection/
---
## XmlSchemaCollection klasa

Zawiera pamięć podręczną schematów języka definicji XML [Schema](../) (XSD) oraz XML-Data Reduced (XDR).
...
| Metoda | Opis |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Dodaje schemat wskazany określonym adresem URL do kolekcji schematów. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Dodaje schemat zawarty w [XmlReader](../../system.xml/xmlreader/) do kolekcji schematów. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Dodaje schemat zawarty w [XmlReader](../../system.xml/xmlreader/) do kolekcji schematów. Określony [XmlResolver](../../system.xml/xmlresolver/) jest używany do rozwiązywania wszelkich zasobów zewnętrznych. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Dodaje [XmlSchema](../xmlschema/) do kolekcji. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Dodaje [XmlSchema](../xmlschema/) do kolekcji. Określony [XmlResolver](../../system.xml/xmlresolver/) jest używany do rozwiązywania wszelkich odwołań zewnętrznych. |
| void [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaCollection](./)\>\&) | Dodaje wszystkie przestrzenie nazw zdefiniowane w podanej kolekcji (wraz z ich powiązanymi schematami) do tej kolekcji. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Zwraca iterator wskazujący na pierwszy element (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany odwołanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie const (jeśli istnieje) w kolekcji. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Zwraca wartość wskazującą, czy **targetNamespace** określonego [XmlSchema](../xmlschema/) znajduje się w kolekcji. |
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) | Zwraca wartość wskazującą, czy schemat z określoną przestrzenią nazw znajduje się w kolekcji. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\&, **int32_t**) | Kopiuje wszystkie obiekty [XmlSchema](../xmlschema/) z tej kolekcji do podanej tablicy, zaczynając od podanego indeksu. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Zwraca iterator wskazujący bezpośrednio po ostatnim elemencie (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany odwołanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
...
| **int32_t** [get_Count](./get_count/)() | Zwraca liczbę przestrzeni nazw zdefiniowanych w tej kolekcji. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](./get_nametable/)() | Zwraca domyślne [XmlNameTable](../../system.xml/xmlnametable/) używane przez [XmlSchemaCollection](./) przy ładowaniu nowych schematów. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\> [GetEnumerator](./getenumerator/)() override | Zapewnia wsparcie iteracji po kolekcji schematów. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Odpowiednik metody C# [Object.GetHashCode()](../../system/object/gethashcode/). Umożliwia haszowanie obiektów własnych. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Zwraca [XmlSchema](../xmlschema/) powiązany z podanym URI przestrzeni nazw. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Zwraca implementację begin iteratora const dla bieżącego kontenera. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Zwraca implementację end iteratora const dla bieżącego kontenera. |
...
|  [XmlSchemaCollection](./xmlschemacollection/)() | Inicjalizuje nową instancję klasy [XmlSchemaCollection](./). |
|  [XmlSchemaCollection](./xmlschemacollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Inicjalizuje nową instancję klasy [XmlSchemaCollection](./) z określonym [XmlNameTable](../../system.xml/xmlnametable/). [XmlNameTable](../../system.xml/xmlnametable/) jest używany przy ładowaniu schematów. |
...
Przestarzałe
:   The [XmlSchemaCollection](./) class is obsolete. Use [XmlSchemaSet](../xmlschemaset/) instead.
