...
description: Reprezentuje element sequence (kompozytor) ze schematu XML określony przez World Wide Web Consortium (W3C). Sequence wymaga, aby elementy w grupie pojawiały się w określonej kolejności wewnątrz elementu zawierającego.
type: docs
weight: 768
url: /pl/system.xml.schema/xmlschemasequence/
---
## XmlSchemaSequence klasa


Reprezentuje element **sequence** (kompozytor) z XML [Schema](../) określony przez konsorcjum World Wide [Web](../../system.web/) (W3C). **sequence** wymaga, aby elementy w grupie pojawiały się w określonej kolejności w obrębie elementu zawierającego.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Elementy zawarte w kompozytorze. Kolekcja [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaSequence](./) lub [XmlSchemaAny](../xmlschemaany/). |
...
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Zwraca liczbę jako wartość tekstową. Maksymalna liczba wystąpień cząstki. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | Zwraca minimalną liczbę wystąpień cząstki. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Zwraca liczbę jako wartość tekstową. Minimalna liczba wystąpień cząstki. |
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Zwraca położenie źródłowe pliku, który załadował schemat. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Zwraca pełne atrybuty, które nie należą do docelowej przestrzeni nazw bieżącego schematu. |
...
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Ustawia liczbę jako wartość tekstową. Maksymalna liczba wystąpień cząstki. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Ustawia minimalną liczbę wystąpień cząstki. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Ustawia liczbę jako wartość tekstową. Minimalna liczba wystąpień cząstki. |
...
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Ustawia położenie źródłowe pliku, który załadował schemat. |
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Ustawia pełne atrybuty, które nie należą do docelowej przestrzeni nazw bieżącego schematu. |
...
|  [XmlSchemaSequence](./xmlschemasequence/)() | Inicjalizuje nową instancję klasy [XmlSchemaSequence](./). |
