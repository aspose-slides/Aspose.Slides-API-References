...
description: Reprezentuje wyjątek rzucany, gdy w walidowanym dokumencie XML napotykane są błędy i ostrzeżenia walidacji schematu XML Schema Definition Language (XSD).
type: docs
weight: 27
url: /pl/system.xml.schema/details_xmlschemavalidationexception/
---
## Details_XmlSchemaValidationException klasa

Reprezentuje wyjątek rzucany, gdy w walidowanym dokumencie XML napotykane są błędy i ostrzeżenia walidacji schematu XML [Schema](../) Definition Language (XSD).
...
| [String](../../system/string/) [get_Message](../details_xmlschemaexception/get_message/)() const override | Zwraca opis warunku błędu tego wyjątku. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SourceObject](./get_sourceobject/)() | Zwraca węzeł XML, który spowodował tę XmlSchemaValidationException. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](../details_xmlschemaexception/get_sourceschemaobject/)() | Element **[XmlSchemaObject](../xmlschemaobject/)**, który spowodował XmlSchemaException. |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | Zwraca łańcuch reprezentujący bieżący obiekt. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementuje metodę [what()](../../system/details_exception/what/), która jest wywoływana przez klasę [ExceptionWrapper](../../system/exceptionwrapper/). Pomimo faktu, że ta klasa nie jest dziedziczona z std::exception, klasy pochodne mogą używać chronionych/prywatnych członków do implementacji swojej logiki. Przeniesienie implementacji tej metody do [ExceptionWrapper](../../system/exceptionwrapper/) może zepsuć tę logikę. |
