...
description: Definiuje zestaw informacji po walidacji schematu zwalidowanego węzła XML.
type: docs
weight: 40
url: /pl/system.xml.schema/ixmlschemainfo/
---
## IXmlSchemaInfo klasa


Definiuje zestaw informacji po walidacji schematu zwalidowanego węzła XML.
...
| virtual **bool** [get_IsDefault](./get_isdefault/)() | Zwraca wartość wskazującą, czy ten zwalidowany węzeł XML został ustawiony jako wynik zastosowania domyślnej wartości podczas walidacji schematu XML [Schema](../) Definition Language (XSD). |
| virtual **bool** [get_IsNil](./get_isnil/)() | Zwraca wartość wskazującą, czy wartość tego zwalidowanego węzła XML jest **nil**. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | Zwraca dynamiczny typ schematu dla tego zwalidowanego węzła XML. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | Zwraca skompilowany [XmlSchemaAttribute](../xmlschemaattribute/) odpowiadający temu zwalidowanemu węzłowi XML. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | Zwraca skompilowany [XmlSchemaElement](../xmlschemaelement/) odpowiadający temu zwalidowanemu węzłowi XML. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | Zwraca statyczny typ schematu XML [Schema](../) Definition Language (XSD) tego zwalidowanego węzła XML. |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | Zwraca wartość XmlSchemaValidity tego zwalidowanego węzła XML. |
