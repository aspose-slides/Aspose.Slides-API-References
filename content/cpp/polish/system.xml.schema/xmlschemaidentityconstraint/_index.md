...
description: "Klasa dla ograniczeń tożsamości: elementy key, keyref i unique."
type: docs
weight: 469
url: /pl/system.xml.schema/xmlschemaidentityconstraint/
---
## XmlSchemaIdentityConstraint klasa

Klasa dla ograniczeń tożsamości: elementy **key**, **keyref** i **unique**.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, w którym dwa NaN są uznawane za równe, pomimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuluje porównanie zmiennoprzecinkowe w stylu C#, w którym dwa NaN są uznawane za równe, pomimo że zgodnie z IEC 60559:1989 NaN nie jest równy żadnej wartości, w tym NaN. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | Zwraca kolekcję pól, które są stosowane jako dzieci dla selektora wyrażenia XML Path Language ([XPath](../../system.xml.xpath/)). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Zwraca nazwę ograniczenia tożsamości. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Zwraca kwalifikowaną nazwę ograniczenia tożsamości, która zawiera post-kompilacyjne tłumaczenie wartości **QualifiedName**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | Zwraca element **selector** wyrażenia [XPath](../../system.xml.xpath/). |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Ustawia nazwę ograniczenia tożsamości. |
...
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Ustawia element **selector** wyrażenia [XPath](../../system.xml.xpath/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n-argument szablonu jako słaby wskaźnik (zamiast współdzielonego). Pozwala na przełączanie wskaźników w kontenerach na tryb słaby. |
...
|  [XmlSchemaIdentityConstraint](./xmlschemaidentityconstraint/)() | Inicjalizuje nową instancję klasy [XmlSchemaIdentityConstraint](./). |
