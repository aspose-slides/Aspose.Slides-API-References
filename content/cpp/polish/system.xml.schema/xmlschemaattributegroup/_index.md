...
description: Reprezentuje element attributeGroup ze schematu XML określony przez World Wide Web Consortium (W3C). AttributesGroups zapewnia mechanizm grupowania zestawu deklaracji atrybutów, tak aby mogły być włączane jako grupa do definicji typów złożonych.
type: docs
weight: 183
url: /pl/system.xml.schema/xmlschemaattributegroup/
---
## XmlSchemaAttributeGroup klasa
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Zwraca komponent [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) grupy atrybutów. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Zwraca kolekcję atrybutów dla grupy atrybutów. Zawiera elementy [XmlSchemaAttribute](../xmlschemaattribute/) i [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Zwraca nazwę grupy atrybutów. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Zwraca w pełni kwalifikowaną nazwę grupy atrybutów. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttributeGroup](./)\> [get_RedefinedAttributeGroup](./get_redefinedattributegroup/)() | Zwraca przedefiniowaną właściwość grupy atrybutów z XML [Schema](../). |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Ustawia komponent [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) grupy atrybutów. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Ustawia nazwę grupy atrybutów. |
...
|  [XmlSchemaAttributeGroup](./xmlschemaattributegroup/)() | Inicjalizuje nową instancję klasy [XmlSchemaAttributeGroup](./). |
