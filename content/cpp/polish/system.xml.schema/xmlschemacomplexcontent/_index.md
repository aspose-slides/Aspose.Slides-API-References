...
description: "Reprezentuje element complexContent z XML Schema zgodnie ze specyfikacją World Wide Web Consortium (W3C). Ta klasa reprezentuje model złożonej zawartości dla typów złożonych. Zawiera rozszerzenia lub ograniczenia na typie złożonym, który ma wyłącznie elementy lub mieszane treści."
type: docs
weight: 261
url: /pl/system.xml.schema/xmlschemacomplexcontent/
---
## XmlSchemaComplexContent klasa

Reprezentuje element **complexContent** z XML [Schema](../) określony przez World Wide [Web](../../system.web/) Consortium (W3C). Ta klasa reprezentuje model złożonej zawartości dla typów złożonych. Zawiera rozszerzenia lub ograniczenia dla typu złożonego, który ma wyłącznie elementy lub mieszane treści.
