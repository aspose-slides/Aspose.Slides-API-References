...
second_title: Aspose.Slides dla C++ API
description: Klasa bazowa służąca do definiowania numerycznych faset. Ta klasa jest klasą bazową dla klas faset numerycznych, takich jak XmlSchemaMinLengthFacet.
type: docs
weight: 664
url: /pl/system.xml.schema/xmlschemanumericfacet/
---
## XmlSchemaNumericFacet klasa

Klasa bazowa służąca do definiowania **numeryczne** faset. Ta klasa jest klasą bazową dla klas faset numerycznych, takich jak [XmlSchemaMinLengthFacet](../xmlschemaminlengthfacet/).
