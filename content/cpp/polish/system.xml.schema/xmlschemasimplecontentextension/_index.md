...
description: Reprezentuje element rozszerzenia dla prostych treści z XML Schema, zgodnie ze specyfikacją World Wide Web Consortium (W3C). Ta klasa może być używana do dziedziczenia prostych typów poprzez rozszerzenie. Takie dziedziczenie służy do rozszerzania zawartości prostego typu elementu poprzez dodanie atrybutów.
type: docs
weight: 807
url: /pl/system.xml.schema/xmlschemasimplecontentextension/
---
## XmlSchemaSimpleContentExtension klasa
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Zwraca kolekcję [XmlSchemaAttribute](../xmlschemaattribute/) i [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Zwraca nazwę wbudowanego typu danych lub prostego typu, z którego ten typ jest rozszerzony. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Uzyskuje rzeczywisty typ obiektu. Analogia do wywołania C# [System.Object.GetType()](../../system/object/gettype/). |
...
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Ustawia nazwę wbudowanego typu danych lub prostego typu, z którego ten typ jest rozszerzany. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogia do metody C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwertowanie własnych obiektów na łańcuch. |
...
|  [XmlSchemaSimpleContentExtension](./xmlschemasimplecontentextension/)() | Inicjalizuje nową instancję klasy [XmlSchemaSimpleContentExtension](./). |
