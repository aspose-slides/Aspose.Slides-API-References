...
description: Reprezentuje element minExclusive z XML Schema określony przez World Wide Web Consortium (W3C). Ta klasa może być użyta do określenia ograniczenia minimalnej wartości elementu simpleType. Wartość elementu musi być większa niż wartość elementu minExclusive.
type: docs
weight: 612
url: /pl/system.xml.schema/xmlschemaminexclusivefacet/
---
## XmlSchemaMinExclusiveFacet klasa


Reprezentuje element **minExclusive** z XML [Schema](../) zgodnie ze specyfikacją World Wide [Web](../../system.web/) Consortium (W3C). Ta klasa może być użyta do określenia ograniczenia minimalnej wartości elementu **simpleType**. Wartość elementu musi być większa niż wartość elementu **minExclusive**.
...
|  [XmlSchemaMinExclusiveFacet](./xmlschemaminexclusivefacet/)() | Inicjalizuje nową instancję klasy [XmlSchemaMinExclusiveFacet](./). |
