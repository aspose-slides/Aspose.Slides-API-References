...
description: Reprezentuje aspekt whiteSpace konsorcjum World Wide Web (W3C).
type: docs
weight: 950
url: /pl/system.xml.schema/xmlschemawhitespacefacet/
---
## XmlSchemaWhiteSpaceFacet klasa


Reprezentuje konsorcjum World Wide [Web](../../system.web/) (W3C) **whiteSpace** aspekt.
...
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Zwraca identyfikator łańcucha znaków. |
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Zwraca informację wskazującą, że ten aspekt jest stały. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Zwraca atrybut **value** aspektu. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Ustawia identyfikator łańcucha znaków. |
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Ustawia informację wskazującą, że ten aspekt jest stały. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Ustawia atrybut **value** aspektu. |
...
|  [XmlSchemaWhiteSpaceFacet](./xmlschemawhitespacefacet/)() | Inicjalizuje nową instancję klasy [XmlSchemaWhiteSpaceFacet](./). |
...
Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie lub przy użyciu operatora new, ponieważ spowoduje to błędy wykonania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go jako argument do funkcji.
