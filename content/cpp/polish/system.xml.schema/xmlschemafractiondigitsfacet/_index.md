...
description: Określa ograniczenie liczby cyfr, które mogą być wprowadzane dla wartości ułamkowej elementu simpleType. Wartość fractionDigits musi być liczbą całkowitą dodatnią. Reprezentuje facet fractionDigits organizacji World Wide Web Consortium (W3C).
type: docs
weight: 417
url: /pl/system.xml.schema/xmlschemafractiondigitsfacet/
---
## XmlSchemaFractionDigitsFacet klasa


Określa ograniczenie liczby cyfr, które mogą być wprowadzane dla wartości ułamkowej elementu simpleType. Wartość fractionDigits musi być liczbą całkowitą dodatnią. Reprezentuje World Wide [Web](../../system.web/) Consortium (W3C) **fractionDigits** facet.
...
|  [XmlSchemaFractionDigitsFacet](./xmlschemafractiondigitsfacet/)() | Inicjalizuje nową instancję klasy [XmlSchemaFractionDigitsFacet](./). |
...
| Typedef | Opis |
| --- | --- |
| [Ptr](./ptr/) | Alias dla wspólnego wskaźnika do instancji tej klasy. |
## Uwagi
