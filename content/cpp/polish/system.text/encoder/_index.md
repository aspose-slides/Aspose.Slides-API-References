...
description: "Enkapsuluje kodowanie sekwencji znaków w sekwencję bajtów. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami czasu wykonywania i/lub awariami asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go funkcjom jako argument."
type: docs
weight: 131
url: /pl/system.text/encoder/
---
## Klasa Encoder


Enkapsuluje kodowanie ciągu znaków w ciąg bajtów. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go do funkcji jako argumentu.
...
| [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_Fallback](./get_fallback/)() const | Zwraca mechanizm obsługi błędów. |
| const [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [get_FallbackBuffer](./get_fallbackbuffer/)() const | Zwraca bufor awaryjny. |
| virtual int [GetByteCount](./getbytecount/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, **bool**) | Zwraca liczbę bajtów potrzebnych do zakodowania bufora. |
| virtual int [GetByteCount](./getbytecount/)(const char_t *, int, **bool**) | Zwraca liczbę bajtów potrzebnych do zakodowania bufora. |
| virtual int [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, **bool**) | Zwraca bajty wynikające z kodowania bufora. |
| virtual int [GetBytes](./getbytes/)(const char_t *, int, **uint8_t** *, int, **bool**) | Zwraca bajty wynikające z kodowania bufora. |
...
| virtual void [Reset](./reset/)() | Czyści wewnętrzny stan enkodera. |
| void [set_Fallback](./set_fallback/)(const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&) | Ustawia mechanizm obsługi błędów. |
