...
description: "Bufor służący do zastępowania strategii awaryjnej kodowania. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy wykonania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji."
type: docs
weight: 209
url: /pl/system.text/encoderreplacementfallbackbuffer/
---
## EncoderReplacementFallbackBuffer klasa


[Buffer](../../system/buffer/) do zastępowania strategii awaryjnej kodowania. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy wykonania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji.
...
| Metoda | Opis |
| --- | --- |
|  [EncoderReplacementFallbackBuffer](./encoderreplacementfallbackbuffer/)(const [EncoderReplacementFallbackPtr](../../system/encoderreplacementfallbackptr/)\&) | Konstruktor. |
...
| **bool** [Fallback](./fallback/)(char_t, int) override | Obsługuje błąd kodowania. |
| **bool** [Fallback](./fallback/)(char_t, char_t, int) override | Obsługuje błąd kodowania. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Tylko do użytku wewnętrznego. |
| int [get_Remaining](./get_remaining/)() const override | Zwraca liczbę pozostałych znaków w buforze. |
...
| char_t [GetNextChar](./getnextchar/)() override | Zwraca następny dostępny znak. |
...
| **bool** [MovePrevious](./moveprevious/)() override | Przesuwa do poprzedniego znaku. |
...
| void [Reset](./reset/)() override | Resetuje bufor do stanu początkowego (przed wywołaniem [Fallback()](./fallback/)). |
...
* Klasa [EncoderFallbackBuffer](../encoderfallbackbuffer/)
