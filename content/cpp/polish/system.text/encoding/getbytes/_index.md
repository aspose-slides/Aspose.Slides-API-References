...
description: Uzyskuje bajty będące wynikiem kodowania bufora znaków.
type: docs
weight: 248
url: /pl/system.text/encoding/getbytes/
---
## Encoding::GetBytes(ArrayPtr\<char_t\>, int, int, ArrayPtr\<uint8_t\>, int) metoda

Uzyskuje bajty będące wynikiem kodowania bufora znaków.
