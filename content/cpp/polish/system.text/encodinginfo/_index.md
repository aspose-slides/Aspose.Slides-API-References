...
description: "Krótka informacja o kodowaniu. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie działania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej funkcjom jako argument."
type: docs
weight: 261
url: /pl/system.text/encodinginfo/
---
## EncodingInfo klasa

Krótka informacja o kodowaniu. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie działania i/lub awarie asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej funkcjom jako argument.
...
| int [get_CodePage](./get_codepage/)() const | Pobiera ID strony kodowej. |
| const [String](../../system/string/)\& [get_DisplayName](./get_displayname/)() const | Zwraca pełną, zlokalizowaną nazwę kodowania. |
| const [String](../../system/string/)\& [get_Name](./get_name/)() const | Zwraca krótką nazwę kodowania. |
...
| [EncodingPtr](../../system/encodingptr/) [GetEncoding](./getencoding/)() | Zwraca kodowanie opisane w informacji. |
