...
description: "Wyjątek zgłaszany przez DecoderExceptionFallback, gdy dekodowanie się nie powiedzie. Nigdy nie twórz ręcznie instancji tej klasy. Zamiast tego użyj klasy DecoderFallbackException. Nigdy nie otaczaj instancji klasy DecoderFallbackException w System::SmartPtr."
type: docs
weight: 105
url: /pl/system.text/details_decoderfallbackexception/
---
## Details_DecoderFallbackException klasa
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | Pobiera tablicę bajtów, która spowodowała błąd. |
...
| int [get_Index](./get_index/)() | Pobiera pozycję bajtu, który spowodował błąd w tablicy wejściowej. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Pobiera rzeczywisty typ obiektu. Odpowiednik wywołania C# [System.Object.GetType()](../../system/object/gettype/). |
