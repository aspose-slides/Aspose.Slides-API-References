...
description: "Zapewnia strategię awaryjną polegającą na zastępowaniu błędnego symbolu atrapą. Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to powodować błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika jako argumentu w wywołaniach funkcji."
type: docs
weight: 196
url: /pl/system.text/encoderreplacementfallback/
---
...
| Metoda | Opis |
| --- | --- |
| [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Tworzy bufor awaryjny. |
|  [EncoderReplacementFallback](./encoderreplacementfallback/)() | Konstruktor, który używa domyślnego ciągu zastępczego "?". |
...
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](../encoderfallback/get_exceptionfallback/)() | Pobiera domyślną implementację awaryjną wyjątku. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Pobiera maksymalną liczbę znaków, które instancja może zwrócić. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](../encoderfallback/get_replacementfallback/)() | Pobiera domyślną implementację zastępczego awaryjnego. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_StandardSafeFallback](../encoderfallback/get_standardsafefallback/)() | Pobiera domyślną standardową bezpieczną implementację awaryjną. |
...
* Klasa [EncoderFallback](../encoderfallback/)
