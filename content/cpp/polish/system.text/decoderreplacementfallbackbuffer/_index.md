...
description: Bufor służący do zastępowania strategii awaryjnej dekodowania.
type: docs
weight: 92
url: /pl/system.text/decoderreplacementfallbackbuffer/
---
## DecoderReplacementFallbackBuffer klasa

[Buffer](../../system/buffer/) do zastępowania strategii awaryjnej dekodowania.
...
| char_t [GetNextChar](./getnextchar/)() override | Zwraca kolejny dostępny znak. |
