...
description: "Udostępnia fallback API do obsługi błędów kodowania. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argument do funkcji."
type: docs
weight: 170
url: /pl/system.text/encoderfallback/
---
## EncoderFallback klasa

Udostępnia fallback API do obsługi błędów kodowania. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go do funkcji jako argument.
...
| Method | Description |
| --- | --- |
| virtual [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() | Pobiera bufor powiązany z algorytmem fallback. |
...
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](./get_exceptionfallback/)() | Pobiera domyślną implementację fallback dla wyjątków. |
| virtual int [get_MaxCharCount](./get_maxcharcount/)() const | Pobiera maksymalną liczbę znaków, które może zwrócić fallback. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](./get_replacementfallback/)() | Pobiera domyślną implementację fallback zastępczą. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_StandardSafeFallback](./get_standardsafefallback/)() | Pobiera domyślną standardową bezpieczną implementację fallback. |
