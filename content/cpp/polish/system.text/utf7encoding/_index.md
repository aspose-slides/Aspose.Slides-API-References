...
description: "Kodowanie UTF-7. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami czasu wykonywania i/lub awariami asercji. Zawsze otaczaj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji."
type: docs
weight: 365
url: /pl/system.text/utf7encoding/
---
## UTF7Encoding klasa
...
| Metoda | Opis |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | Clones encoding object. |
...
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Compares with object. |
...
| int [GetByteCount](./getbytecount/)(const char_t *, int) override | Get the number of characters needed to encode a character buffer. |
...
| int [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Get the bytes that result from encoding a character buffer. |
| int [GetBytes](./getbytes/)(const char_t *, int, **uint8_t** *, int) override | Get the bytes that result from encoding a character buffer. |
| int [GetBytes](./getbytes/)(const [String](../../system/string/)\&, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Get the bytes that result from encoding a character buffer. |
...
| int [GetCharCount](./getcharcount/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) override | Get the number of characters needed to decode a byte buffer. |
| int [GetCharCount](./getcharcount/)(const **uint8_t** *, int) override | Get the number of characters needed to decode a byte buffer. |
...
| int [GetChars](./getchars/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<char_t\>, int) override | Get the characters that result from decoding a byte buffer. |
| int [GetChars](./getchars/)(const **uint8_t** *, int, char_t *, int) override | Get the characters that result from decoding a byte buffer. |
...
| [DecoderPtr](../../system/decoderptr/) [GetDecoder](./getdecoder/)() override | Get a decoder that forwards requests to this object. |
| [EncoderPtr](../../system/encoderptr/) [GetEncoder](./getencoder/)() override | Get an encoder that forwards requests to this object. |
...
| int [GetHashCode](./gethashcode/)() const override | Gets encoding hash code. |
| int [GetMaxByteCount](./getmaxbytecount/)(int) override | Get the maximum number of bytes needed to encode a specified number of characters. |
...
| **bool** [operator==](./operator_equal_equal/)(const [UTF7Encoding](./)\&) const | Compares encodings parameters. |
