...
description: "Zapewnia strategię awaryjną polegającą na zastępowaniu nieprawidłowego symbolu sztuczką. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to prowadzić do błędów czasu wykonania i/lub naruszeń asercji. Zawsze otaczaj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania jej do funkcji jako argument."
type: docs
weight: 79
url: /pl/system.text/decoderreplacementfallback/
---
## DecoderReplacementFallback klasa

Zapewnia strategię awaryjną zastępowania błędnego symbolu sztuczkiem. Obiekty tej klasy powinny być alokowane wyłącznie za pomocą funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub błędy asercji. Zawsze otaczaj tę klasę wskaźnikiem [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika, aby przekazywać ją do funkcji jako argument.
...
| Metoda | Opis |
| --- | --- |
| [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Tworzy bufor awaryjny. |
| [DecoderReplacementFallback](./decoderreplacementfallback/)() | Konstruktor używający domyślnego ciągu zastępczego "?" . |
...
| const [String](../../system/string/)\& [get_DefaultString](./get_defaultstring/)() const | Pobiera ciąg zastępczy. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](../decoderfallback/get_exceptionfallback/)() | Pobiera domyślną implementację awaryjną dla wyjątków. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Pobiera maksymalną liczbę znaków, które instancja może zwrócić. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](../decoderfallback/get_replacementfallback/)() | Pobiera domyślną implementację zastępczego fallbacku. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](../decoderfallback/get_standardsafefallback/)() | Pobiera domyślną standardową bezpieczną implementację fallbacku. |
...
* Klasa [DecoderFallback](../decoderfallback/)
