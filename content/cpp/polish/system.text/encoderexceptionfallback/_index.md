...
description: "Zapewnia strategię awaryjną polegającą na rzucaniu wyjątków. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy w czasie wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 144
url: /pl/system.text/encoderexceptionfallback/
---
## EncoderExceptionFallback klasa
...
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](../encoderfallback/get_exceptionfallback/)() | Zwraca domyślną implementację wyjątku awaryjnego. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Zwraca maksymalną liczbę znaków, które instancja może zwrócić. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](../encoderfallback/get_replacementfallback/)() | Zwraca domyślną implementację zastępczego awaryjnego. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_StandardSafeFallback](../encoderfallback/get_standardsafefallback/)() | Zwraca domyślną standardową bezpieczną implementację awaryjną. |
