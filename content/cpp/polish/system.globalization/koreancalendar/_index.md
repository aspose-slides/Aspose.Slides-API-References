...
description: "Kalendarz koreański. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to powodować błędy w czasie wykonania i/lub awarie asercji. Zawsze opakowuj tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika jako argumentu w funkcjach."
type: docs
weight: 222
url: /pl/system.globalization/koreancalendar/
---
## KoreanCalendar klasa
...
| Pole | Opis |
| --- | --- |
| static constexpr [KoreanEra](./koreanera/) | Obecna koreańska era. |
