...
description: Sprawdza, czy miesiąc jest przestępny.
type: docs
weight: 118
url: /pl/system.globalization/chineselunisolarcalendar/isleapmonth/
---
## ChineseLunisolarCalendar::IsLeapMonth(int, int, int) const metoda

Sprawdza, czy miesiąc jest przestępny.
...
True jeśli podany miesiąc jest przestępny, false w przeciwnym razie.

## ChineseLunisolarCalendar::IsLeapMonth(int, int) const metoda
