...
description: "Chiński kalendarz lunisolarny. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to prowadzić do błędów w czasie wykonywania i/lub naruszeń asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 27
url: /pl/system.globalization/chineselunisolarcalendar/
---
## ChineseLunisolarCalendar class

Chiński kalendarz lunisolarny. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami w czasie wykonywania i/lub naruszeniami asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji.
...
|  [ChineseLunisolarCalendar](./chineselunisolarcalendar/)() | Konstruktor domyślny. |
...
| [CalendarAlgorithmType](../calendaralgorithmtype/) [get_AlgorithmType](../eastasianlunisolarcalendar/get_algorithmtype/)() const override | Informacja RTTI. |
...
| int [GetEra](./getera/)([DateTime](../../system/datetime/)) const override | Pobiera erę dla określonego punktu czasowego. |
...
| virtual int [GetMonthsInYear](./getmonthsinyear/)(int) const | Informacja RTTI. |
| virtual int [GetMonthsInYear](./getmonthsinyear/)(int, int) const | Informacja RTTI. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje niczego, tak naprawdę, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstruowaniu podklas. |
| [Calendar](../calendar/)\& [operator=](../calendar/operator_equal/)(const [Calendar](../calendar/)\&) |  |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje niczego, tak naprawdę, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstruowaniu podklas. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | Specjalizacja [Object::ReferenceEquals](../../system/object/referenceequals/) w przypadku ciągu znaków i nullptr. |
...
| virtual  [~Object](../../system/object/~object/)() | Zniszczenie obiektu. Zwalnia wszystkie wewnętrzne struktury danych. |

## Pola

| Pole | Opis |
| --- | --- |
| static constexpr [ChineseEra](./chineseera/) | Obecna chińska era. |
