...
description: "Okres czasu letniego. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub naruszenia asercji. Zawsze opakowuj tę klasę we wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej funkcjom jako argument."
type: docs
weight: 79
url: /pl/system.globalization/daylighttime/
---
## Klasa DaylightTime

Okres czasu letniego. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub naruszenia asercji. Zawsze umieszczaj tę klasę w wskaźniku [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go funkcjom jako argument.
...
| Metoda | Opis |
| --- | --- |
|  [DaylightTime](./daylighttime/)([DateTime](../../system/datetime/), [DateTime](../../system/datetime/), [TimeSpan](../../system/timespan/)) | Informacje RTTI. |
...
| [TimeSpan](../../system/timespan/) [get_Delta](./get_delta/)() const | Zwraca różnicę między czasem standardowym a czasem letnim. |
| [DateTime](../../system/datetime/) [get_End](./get_end/)() const | Zwraca datę i czas, kiedy kończy się czas letni. |
| [DateTime](../../system/datetime/) [get_Start](./get_start/)() const | Zwraca datę i czas, kiedy zaczyna się czas letni. |
