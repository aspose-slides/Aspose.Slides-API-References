...
description: "Japoński kalendarz lunarny słoneczny. Niezaimplementowany. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub awarie asercji. Zawsze opakuj tę klasę we wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 196
url: /pl/system.globalization/japaneselunisolarcalendar/
---
## JapaneseLunisolarCalendar klasa

Japoński kalendarz lunarny słoneczny. Niezaimplementowany. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonywania i/lub awarie asercji. Zawsze opakuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go funkcjom jako argumentu.
...
| [CalendarAlgorithmType](../calendaralgorithmtype/) [get_AlgorithmType](../eastasianlunisolarcalendar/get_algorithmtype/)() const override | Informacje RTTI. |
...
| virtual int [get_TwoDigitYearMax](../calendar/get_twodigityearmax/)() const | Pobiera ostatni rok, który może być przedstawiony dwu-cyfrowo. |
| int [GetCelestialStem](../eastasianlunisolarcalendar/getcelestialstem/)(int) const | Pobiera niebiański pęd. |
...
| virtual [DayOfWeek](../../system/dayofweek/) [GetDayOfWeek](../calendar/getdayofweek/)([DateTime](../../system/datetime/)) const | Pobiera dzień tygodnia dla określonego punktu czasu. |
...
| int [GetEra](./getera/)([DateTime](../../system/datetime/)) const override | Pobiera erę dla określonego punktu czasu. |
...
| virtual int [GetSexagenaryYear](../eastasianlunisolarcalendar/getsexagenaryyear/)([DateTime](../../system/datetime/)) const | Pobiera rok w cyklu sześćdziesięcioletnim. |
| int [GetTerrestrialBranch](../eastasianlunisolarcalendar/getterrestrialbranch/)(int) const | Pobiera gałąź ziemską. |
...
| int [GetYear](./getyear/)([DateTime](../../system/datetime/)) const override | Pobiera rok dla określonego punktu czasu. |
...
| static [CalendarPtr](../calendarptr/) [ReadOnly](../calendar/readonly/)(const [CalendarPtr](../calendarptr/)\&) | Pobiera wersję kalendarza tylko do odczytu. |
...
| virtual void [set_TwoDigitYearMax](../calendar/set_twodigityearmax/)(int) | Ustawia ostatni rok, który może być przedstawiony dwu-cyfrowo. |
...
| Pole | Opis |
| --- | --- |
| static constexpr [JapaneseEra](./japaneseera/) | Obecna japońska era. |

## Zobacz także

* Klasa [EastAsianLunisolarCalendar](../eastasianlunisolarcalendar/)
