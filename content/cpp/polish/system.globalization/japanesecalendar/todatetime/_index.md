...
description: Tworzy obiekt DateTime z komponentów.
type: docs
weight: 222
url: /pl/system.globalization/japanesecalendar/todatetime/
---
## JapaneseCalendar::ToDateTime(int, int, int, int, int, int, int, int) const metoda

Tworzy obiekt [DateTime](../../../system/datetime/) z komponentów.
...
[DateTime](../../../system/datetime/) obiekt posiadający określone komponenty.

## JapaneseCalendar::ToDateTime(int, int, int, int, int, int, int) const metoda
