...
description: Tworzy obiekt DateTime z podanych składników.
type: docs
weight: 235
url: /pl/system.globalization/thaibuddhistcalendar/todatetime/
---
## ThaiBuddhistCalendar::ToDateTime(int, int, int, int, int, int, int, int) const metoda

Tworzy obiekt [DateTime](../../../system/datetime/) z podanych składników.
...
| minute | int | Minuta. |
| second | int | Sekunda. |
| millisecond | int | Milisekunda. |
| era | int | Era. |

### Wartość zwracana

[DateTime](../../../system/datetime/) obiekt, który ma określone składniki.

## ThaiBuddhistCalendar::ToDateTime(int, int, int, int, int, int, int) const metoda
