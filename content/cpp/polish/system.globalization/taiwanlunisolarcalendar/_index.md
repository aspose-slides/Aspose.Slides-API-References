...
description: "Kalendarz lunarny Tajwanu. Niezaimplementowany. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub błędy asercji. Zawsze owiń tę klasę wskaźnikiem System::SmartPtr i używaj tego wskaźnika do przekazywania go funkcjom jako argument."
type: docs
weight: 339
url: /pl/system.globalization/taiwanlunisolarcalendar/
---
...
| virtual int [get_TwoDigitYearMax](../calendar/get_twodigityearmax/)() const | Pobiera ostatni rok, który może być przedstawiony dwucyfrowo. |
...
| virtual void [set_TwoDigitYearMax](../calendar/set_twodigityearmax/)(int) | Ustawia ostatni rok, który może być przedstawiony dwucyfrowo. |
