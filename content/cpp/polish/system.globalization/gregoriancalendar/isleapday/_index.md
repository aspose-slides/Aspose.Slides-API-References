...
description: Sprawdza, czy dzień jest przestępny.
type: docs
weight: 248
url: /pl/system.globalization/gregoriancalendar/isleapday/
---
## GregorianCalendar::IsLeapDay(int, int, int, int) const metoda

Sprawdza, czy dzień jest przestępny.
...
True jeśli podana data jest przestępna, false w przeciwnym razie.

## GregorianCalendar::IsLeapDay(int, int, int) const metoda
