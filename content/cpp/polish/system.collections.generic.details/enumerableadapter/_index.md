...
description: Enumerable używany przez metody rozszerzające IEnumerable.Cast() i IEnumerable.OfType().
type: docs
weight: 1
url: /pl/system.collections.generic.details/enumerableadapter/
---
## EnumerableAdapter klasa

Enumerable używany przez metody rozszerzające IEnumerable.Cast() i IEnumerable.OfType().
...
| EnumeratorAdapter | Typ adaptera enumeratora. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący tuż po ostatnim elemencie kwalifikowanym jako const (jeśli istnieje) kolekcji. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę wyrażenia C# lock(). Wywołaj bezpośrednio lub użyj obiektu stróżującego [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie wyrażenia C# lock(). Wywołaj bezpośrednio lub użyj obiektu stróżującego [LockContext](../../system/lockcontext/). |
