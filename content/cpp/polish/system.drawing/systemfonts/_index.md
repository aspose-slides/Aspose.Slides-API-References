...
description: Zapewnia zestaw wstępnie utworzonych obiektów Font, które reprezentują czcionki używane do wyświetlania tekstu w elementach wyświetlających systemu Windows. Jest to typ statyczny bez usług instancji. Nigdy nie należy tworzyć jego instancji w żaden sposób.
type: docs
weight: 339
url: /pl/system.drawing/systemfonts/
---
## SystemFonts klasa

Zapewnia zestaw wstępnie utworzonych [Font](../font/) obiektów, które reprezentują czcionki używane do wyświetlania tekstu w elementach wyświetlających [Windows](../../system.windows/). Jest to typ statyczny bez usług instancji. Nigdy nie należy tworzyć jego instancji w żaden sposób.
...
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_CaptionFont](./get_captionfont/)() | NIE ZIMPLEMENTOWANO. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_DefaultFont](./get_defaultfont/)() | Zwraca obiekt [Font](../font/) reprezentujący domyślną czcionkę, której aplikacja może używać w oknach dialogowych i formularzach. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_IconTitleFont](./get_icontitlefont/)() | NIE ZIMPLEMENTOWANO. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MenuFont](./get_menufont/)() | NIE ZIMPLEMENTOWANO. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MessageBoxFont](./get_messageboxfont/)() | NIE ZIMPLEMENTOWANO. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_SmallCaptionFont](./get_smallcaptionfont/)() | NIE ZIMPLEMENTOWANO. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_StatusFont](./get_statusfont/)() | NIE ZIMPLEMENTOWANO. |
