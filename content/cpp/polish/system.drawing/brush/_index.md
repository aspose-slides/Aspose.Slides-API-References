...
description: "Klasa bazowa dla klas, które reprezentują wypełniacze używane do wypełniania wnętrz graficznych kształtów. Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami wykonania i/lub błędami asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go funkcjom jako argument."
type: docs
weight: 14
url: /pl/system.drawing/brush/
---
## Brush klasa


Klasa bazowa dla klas reprezentujących wypełniacze używane do wypełniania wnętrz graficznych kształtów. Obiekty tej klasy powinny być tworzone wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to skutkować błędami wykonania i/lub błędami asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania go do funkcji jako argument.
...
| Metoda | Opis |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Clone](../../system/icloneable/clone/)() | Tworzy kopię bieżącego obiektu i zwraca współdzielony wskaźnik do niego. |
