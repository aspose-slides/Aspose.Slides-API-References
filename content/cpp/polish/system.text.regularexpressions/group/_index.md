...
description: "Wynik dopasowania wykonanego przez pojedynczą grupę przechwytującą. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonywania i/lub naruszenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji."
type: docs
weight: 27
url: /pl/system.text.regularexpressions/group/
---
## Group klasa
...
| Metoda | Opis |
| --- | --- |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | Dodaje przechwycenie do grupy. |
...
| [CaptureCollectionPtr](../capturecollectionptr/) [get_Captures](./get_captures/)() | Pobiera dostępne przechwycenia. |
...
| **bool** [get_Success](./get_success/)() | Sprawdza, czy przechwycenie powiodło się dla tej grupy. |
...
|  [Group](./group/)(const [UStringPtr](../ustringptr/)\&, int, int) | Konstruktor. |
|  [Group](./group/)() | Konstruktor pustej grupy. |
