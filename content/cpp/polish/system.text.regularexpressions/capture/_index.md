...
| int [get_Index](./get_index/)() const | Pobiera indeks przechwyconego podciągu. |
| int [get_Length](./get_length/)() const | Pobiera długość przechwyconego podciągu. |
| [String](../../system/string/) [get_Value](./get_value/)() const | Pobiera przechwycony podciąg. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Pobiera przechwycony podciąg. |
