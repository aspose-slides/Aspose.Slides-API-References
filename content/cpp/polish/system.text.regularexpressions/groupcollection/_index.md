...
description: "Lista grup przechwytywania w pojedynczym dopasowaniu. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy wykonania i/lub niepowodzenia asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania go jako argumentu do funkcji."
type: docs
weight: 40
url: /pl/system.text.regularexpressions/groupcollection/
---
## Klasa GroupCollection


Lista grup przechwytywania w pojedynczym dopasowaniu. Obiekty tej klasy powinny być przydzielane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy wykonania i/lub niepowodzenia asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej jako argumentu do funkcji.
...
| void [Add](./add/)(const [GroupPtr](../groupptr/)\&) override | Wyłącza dodawanie elementu do kolekcji. |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | Dodaje element na koniec listy. |
| void [AddGroup](./addgroup/)(const [GroupPtr](../groupptr/)\&) | Dodaje grupę do kolekcji. |
...
| void [Clear](./clear/)() override | Wyłącza usuwanie elementów z kolekcji. |
...
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(int) const | [Group](../group/) akcesor. |
| [GroupPtr](../groupptr/) [get_Item](./get_item/)(const [String](../../system/string/)\&) const | [Group](../group/) akcesor. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Uzyskuje strukturę licznika referencji powiązaną z obiektem. |
...
| virtual [GroupPtr](../groupptr/) [idx_get](./idx_get/)([String](../../system/string/)) const | [Group](../group/) akcesor. |
| [GroupPtr](../groupptr/) [idx_get](./idx_get/)(int) const override | [Group](../group/) akcesor. |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | Wyszukuje określony obiekt i zwraca indeks bazowy zero ostatniego wystąpienia w całej liście. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Wyszukuje określony obiekt i zwraca indeks bazowy zero ostatniego wystąpienia w przedziale elementów [List](../../system.collections.generic/list/) rozciągającym się od pierwszego elementu do podanego indeksu. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Wyszukuje określony obiekt i zwraca indeks bazowy zero ostatniego wystąpienia w przedziale elementów [List](../../system.collections.generic/list/) zawierającym określoną liczbę elementów i kończącym się w podanym indeksie. |
...
| [GroupPtr](../groupptr/) [operator[]](./operator[]/)(const [String](../../system/string/)\&) const | [Group](../group/) akcesor. |
| vector_t::reference [operator[]](../../system.collections.generic/list/operator[]/)(int) | Funkcja akcesorowa. |
| vector_t::const_reference [operator[]](../../system.collections.generic/list/operator[]/)(int) const | Funkcja akcesorowa. |
...
| **bool** [Remove](./remove/)(const [GroupPtr](../groupptr/)\&) override | Wyłącza usuwanie elementu z kolekcji. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Uzyskuje bieżącą wartość licznika współdzielonych odwołań. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Zwiększa licznik współdzielonych odwołań. Nie powinno się wywoływać bezpośrednio; użyj inteligentnych wskaźników lub ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Zmniejsza i zwraca licznik współdzielonych odwołań. Nie powinno się wywoływać bezpośrednio; użyj inteligentnych wskaźników lub ThisProtector. |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../../system.collections.generic/list/virtualizebeginconstiterator/)() const override | Uzyskuje implementację stałego iteratora początkowego dla bieżącego kontenera. |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../../system.collections.generic/list/virtualizeendconstiterator/)() const override | Uzyskuje implementację stałego iteratora końcowego dla bieżącego kontenera. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabych odwołań. Nie powinno się wywoływać bezpośrednio; użyj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabych odwołań. Nie powinno się wywoływać bezpośrednio; użyj inteligentnych wskaźników lub ThisProtector. |
