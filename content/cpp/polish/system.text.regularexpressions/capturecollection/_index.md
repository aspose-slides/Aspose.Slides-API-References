...
description: "Lista przechwyceń wykonywanych przez jedną grupę przechwytującą. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji System::MakeObject(). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ może to spowodować błędy czasu wykonania i/lub błędy asercji. Zawsze opakowuj tę klasę w wskaźnik System::SmartPtr i używaj tego wskaźnika do przekazywania jej do funkcji jako argument."
type: docs
weight: 14
url: /pl/system.text.regularexpressions/capturecollection/
---
## CaptureCollection klasa

Lista przechwyceń wykonanych przez pojedynczą grupę przechwytującą. Obiekty tej klasy powinny być alokowane wyłącznie przy użyciu funkcji [System::MakeObject()](../../system/makeobject/). Nigdy nie twórz instancji tego typu na stosie ani przy użyciu operatora new, ponieważ spowoduje to błędy czasu wykonania i/lub błędy asercji. Zawsze opakowuj tę klasę w wskaźnik [System::SmartPtr](../../system/smartptr/) i używaj tego wskaźnika do przekazywania jej do funkcji jako argument.
...
| void [Add](./add/)(const [CapturePtr](../captureptr/)\&) override | Wyłącza modyfikację kolekcji. |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | Dodaje element na koniec listy. |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | Metoda pomocnicza do dodawania przechwycenia do kolekcji. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/list/cend/)() const | Uzyskuje iterator do nieistniejącego elementu oznaczonego jako const poza końcem kolekcji. |
| void [Clear](./clear/)() override | Wyłącza czyszczenie kolekcji. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | Uzyskuje odwrócony iterator do ostatniego elementu kolekcji oznaczonego jako const (pierwszy w odwróconym porządku). |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/list/end/)() | Uzyskuje iterator do nieistniejącego elementu poza końcem kolekcji. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/list/end/)() const | Uzyskuje iterator do nieistniejącego elementu poza końcem kolekcji oznaczonej jako const. |
...
| int [get_Count](./get_count/)() const override | Uzyskuje liczbę przechwyceń. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Sprawdza, czy kolekcja ma stały rozmiar. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Oznacza kolekcję jako tylko do odczytu. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | Oznacza kolekcję jako niesynchronizowaną. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../../system.collections.generic/icollection/get_syncroot/)() const | Uzyskuje obiekt, przez który kolekcja jest synchronizowana. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Uzyskuje rzeczywisty typ obiektu. Analogiczna do wywołania C# [System.Object.GetType()](../../system/object/gettype/). |
...
| T [idx_get](../../system.collections.generic/list/idx_get/)(int) const override | Uzyskuje element w określonej pozycji. |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | Wyszukuje określony obiekt i zwraca indeks zerowy ostatniego wystąpienia w całej liście. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Wyszukuje określony obiekt i zwraca indeks zerowy ostatniego wystąpienia w zakresie elementów [List](../../system.collections.generic/list/) rozciągającego się od pierwszego elementu do określonego indeksu. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Wyszukuje określony obiekt i zwraca indeks zerowy ostatniego wystąpienia w zakresie elementów [List](../../system.collections.generic/list/) zawierającego określoną liczbę elementów i kończącego się w określonym indeksie. |
...
| [List](../../system.collections.generic/list/list/)(int) | Tworzy listę o określonej pojemności. |
...
| void [Lock](../../system/object/lock/)() | Implementuje blokadę języka C# lock(). Wywołuj bezpośrednio lub użyj obiektu stróżującego [LockContext](../../system/lockcontext/). |
...
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() | Uzyskuje odwrócony iterator do ostatniego elementu kolekcji (pierwszy w odwróconym porządku). |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() const | Uzyskuje odwrócony iterator do ostatniego elementu kolekcji oznaczonej jako const (pierwszy w odwróconym porządku). |
...
| **bool** [Remove](./remove/)(const [CapturePtr](../captureptr/)\&) override | Wyłącza modyfikację kolekcji. |
| **bool** [Remove](../../system.collections.generic/list/remove/)(const T\&) override | Usuwa pierwszą instancję określonego elementu z listy. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza wspólny licznik referencji o określoną wartość. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Uzyskuje aktualną wartość współdzielonego licznika referencji. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogiczna do metody C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwersję własnych obiektów do łańcucha znaków. |
...
| void [Unlock](../../system/object/unlock/)() | Implementuje odblokowanie instrukcji C# lock(). Wywołuj bezpośrednio lub użyj obiektu stróżującego [LockContext](../../system/lockcontext/). |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../../system.collections.generic/list/virtualizebeginconstiterator/)() const override | Uzyskuje implementację const iteratora begin dla bieżącego kontenera. |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../../system.collections.generic/list/virtualizeendconstiterator/)() const override | Uzyskuje implementację const iteratora end dla bieżącego kontenera. |
