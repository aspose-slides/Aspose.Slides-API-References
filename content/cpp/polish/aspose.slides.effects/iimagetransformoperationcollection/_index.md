...
---
## IImageTransformOperationCollection klasa
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevel](../ialphabilevel/)\> [AddAlphaBiLevelEffect](./addalphabileveleffect/)(**float**) | Dodaje nowy efekt Alpha Bi-Level na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeiling](../ialphaceiling/)\> [AddAlphaCeilingEffect](./addalphaceilingeffect/)() | Dodaje nowy efekt Alpha Ceiling na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloor](../ialphafloor/)\> [AddAlphaFloorEffect](./addalphaflooreffect/)() | Dodaje nowy efekt Alpha Floor na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverse](../ialphainverse/)\> [AddAlphaInverseEffect](./addalphainverseeffect/)() | Dodaje nowy efekt Alpha Inverse na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulate](../ialphamodulate/)\> [AddAlphaModulateEffect](./addalphamodulateeffect/)() | Dodaje nowy efekt Alpha Modulate na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixed](../ialphamodulatefixed/)\> [AddAlphaModulateFixedEffect](./addalphamodulatefixedeffect/)(**float**) | Dodaje nowy efekt Alpha Modulate Fixed na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplace](../ialphareplace/)\> [AddAlphaReplaceEffect](./addalphareplaceeffect/)(**float**) | Dodaje nowy efekt Alpha Replace na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBiLevel](../ibilevel/)\> [AddBiLevelEffect](./addbileveleffect/)(**float**) | Dodaje nowy efekt Bi-Level (black/white) na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBlur](../iblur/)\> [AddBlurEffect](./addblureffect/)(**double**, **bool**) | Dodaje nowy efekt [Blur](../blur/) na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBrightnessContrast](../ibrightnesscontrast/)\> [AddBrightnessContrastEffect](./addbrightnesscontrasteffect/)(**float**, **float**) | Dodaje nowy efekt [BrightnessContrast](../brightnesscontrast/) na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorChange](../icolorchange/)\> [AddColorChangeEffect](./addcolorchangeeffect/)() | Dodaje nowy efekt Color Change na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorReplace](../icolorreplace/)\> [AddColorReplaceEffect](./addcolorreplaceeffect/)() | Dodaje nowy efekt Color Replacement na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDuotone](../iduotone/)\> [AddDuotoneEffect](./addduotoneeffect/)() | Dodaje nowy efekt [Duotone](../duotone/) na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlay](../ifilloverlay/)\> [AddFillOverlayEffect](./addfilloverlayeffect/)() | Dodaje nowy efekt Fill Overlay na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGrayScale](../igrayscale/)\> [AddGrayScaleEffect](./addgrayscaleeffect/)() | Dodaje nowy efekt Gray Scale na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHSL](../ihsl/)\> [AddHSLEffect](./addhsleffect/)(**float**, **float**, **float**) | Dodaje nowy efekt Hue/Saturation/Luminance na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILuminance](../iluminance/)\> [AddLuminanceEffect](./addluminanceeffect/)(**float**, **float**) | Dodaje nowy efekt [Luminance](../luminance/) na koniec kolekcji. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITint](../itint/)\> [AddTintEffect](./addtinteffect/)(**float**, **float**) | Dodaje nowy efekt [Tint](../tint/) na koniec kolekcji. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Zwraca iterator wskazujący na pozycję bezpośrednio po ostatnim stałym elemencie (jeśli istnieje) kolekcji. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Zwraca iterator wskazujący na pozycję bezpośrednio po ostatnim elemencie (jeśli istnieje) kolekcji. Ten iterator nie może być używany do zmiany odwoływanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca kopię obiektu typu T. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca [IImageTransformOperation](../iimagetransformoperation/) z kolekcji według jego indeksu. |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Oblicza średnią w sekwencji wartości liczbowych. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Oblicza średnią w sekwencji wartości uzyskanych poprzez wywołanie funkcji transformującej na każdym elemencie sekwencji wejściowej. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Filtruje sekwencję wg określonego predykatu. |
| void [Lock](../../system/object/lock/)() | Implementuje blokadę instrukcji C# lock(). Wywołaj bezpośrednio lub użyj obiektu zabezpieczającego [LockContext](../../system/lockcontext/). |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Usuwa efekt obrazu z kolekcji pod podanym indeksem. |
