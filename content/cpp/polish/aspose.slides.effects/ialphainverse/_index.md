...
description: Reprezentuje efekt Alpha Inverse. Wartości Alpha (przezroczystości) są odwracane przez odjęcie od 100%.
type: docs
weight: 313
...
Reprezentuje efekt Alpha Inverse. Wartości Alpha (przezroczystości) są odwracane przez odjęcie od 100%.
