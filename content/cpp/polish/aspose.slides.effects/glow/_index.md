...
description: Reprezentuje efekt Glow, w którym rozmyta obwodowa linia w kolorze jest dodawana poza krawędziami obiektu.
type: docs
weight: 196
...
| Metoda | Opis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Określa, czy podany [Glow](./) jest równy bieżącemu [Glow](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | Format koloru. Tylko do odczytu [IColorFormat](../../aspose.slides/icolorformat/). |
...
| **double** [get_Radius](./get_radius/)() override | Promień. Odczyt **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGlowEffectiveData](../igloweffectivedata/)\> [GetEffective](./geteffective/)() override | Pobiera efektywne dane efektu [Glow](./) z zastosowanym dziedziczeniem. |
...
| void [set_Radius](./set_radius/)(**double**) override | Promień. Zapis **double**. |
