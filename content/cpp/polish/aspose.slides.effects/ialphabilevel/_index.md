...
description: Reprezentuje efekt Alpha Bi-Level. Wartości alfa (przezroczystość) mniejsze niż próg są zmieniane na 0 (całkowicie przezroczyste), a wartości alfa większe lub równe progowi są zmieniane na 100% (całkowicie nieprzezroczyste).
type: docs
weight: 235
...
Reprezentuje efekt Alpha Bi-Level. Wartości alfa (przezroczystość) mniejsze niż próg są zmieniane na 0 (całkowicie przezroczyste), a wartości alfa większe lub równe progowi są zmieniane na 100 % (całkowicie nieprzezroczyste).
...
| virtual **float** [get_Threshold](./get_threshold/)() | Zwraca próg efektu. Odczyt **float**. |
...
| virtual void [set_Threshold](./set_threshold/)(**float**) | Zwraca próg efektu. Zapis **float**. |
...
Użyj [ImageTransformOperationFactory](../imagetransformoperationfactory/) do tworzenia instancji w COM. 
## Zobacz także
