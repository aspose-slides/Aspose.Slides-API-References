...
description: Reprezentuje efekt Alpha Floor. Wartości alfa (przezroczystość) mniejsze niż 100% są zmieniane na zero. Innymi słowy, wszystko częściowo przezroczyste staje się w pełni przezroczyste.
type: docs
weight: 287
