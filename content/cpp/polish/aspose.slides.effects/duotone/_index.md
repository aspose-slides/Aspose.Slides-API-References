...
description: Reprezentuje efekt Duotone. Dla każdego piksela łączy Color1 i Color2 za pomocą interpolacji liniowej, aby określić nowy kolor tego piksela.
type: docs
weight: 157
...
| Metoda | Opis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Określa, czy podany [Duotone](./) jest równy bieżącemu [Duotone](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color1](./get_color1/)() override | Zwraca docelowy format koloru dla ciemnych pikseli. Tylko do odczytu [IColorFormat](../../aspose.slides/icolorformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color2](./get_color2/)() override | Zwraca docelowy format koloru dla jasnych pikseli. Tylko do odczytu [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotoneEffectiveData](../iduotoneeffectivedata/)\> [GetEffective](./geteffective/)() override | Pobiera efektywne dane efektu [Duotone](./) z zastosowanym dziedziczeniem. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. W rzeczywistości nie kopiuje nic, tylko inicjalizuje nowy obiekt i umożliwia konstrukcję kopiowania podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. W rzeczywistości nie kopiuje nic, tylko inicjalizuje nowy obiekt i umożliwia konstrukcję kopiowania podklas. |
