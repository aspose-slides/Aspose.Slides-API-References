...
description: Niezmienny obiekt reprezentujący efekt Alpha Floor. Wartości Alpha (przezroczystość) mniejsze niż 100% są zmieniane na zero. Innymi słowy, wszystko częściowo przezroczyste staje się w pełni przezroczyste.
type: docs
weight: 300
url: /pl/aspose.slides.effects/ialphaflooreffectivedata/
---
## IAlphaFloorEffectiveData klasa


Niezmienny obiekt reprezentujący efekt Alpha Floor. Wartości Alpha (przezroczystość) mniejsze niż 100 % są zmieniane na zero. Innymi słowy, wszystko częściowo przezroczyste staje się w pełni przezroczyste.
