...
description: Reprezentuje efekt miękkich krawędzi. Krawędzie kształtu są rozmyte, podczas gdy wypełnienie nie jest zmieniane.
type: docs
weight: 1080
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Określa, czy określony [SoftEdge](./) jest równy bieżącemu [SoftEdge](./). |
...
| **double** [get_Radius](./get_radius/)() override | Określa promień rozmycia stosowanego do krawędzi. Read **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | Pobiera efektywne dane efektu Soft Edge z zastosowanym dziedziczeniem. |
...
| void [set_Radius](./set_radius/)(**double**) override | Określa promień rozmycia stosowanego do krawędzi. Write **double**. |
