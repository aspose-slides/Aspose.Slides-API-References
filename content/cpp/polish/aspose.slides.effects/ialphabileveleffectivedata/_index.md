...
description: Niezmienny obiekt reprezentujący efekt Alpha dwupoziomowego. Wartości Alfa (przezroczystość) mniejsze niż próg są zmieniane na 0 (całkowicie przezroczyste), a wartości alfa większe lub równe progowi są zmieniane na 100% (całkowicie nieprzezroczyste).
type: docs
weight: 248
url: /pl/aspose.slides.effects/ialphabileveleffectivedata/
---
## IAlphaBiLevelEffectiveData klasa
