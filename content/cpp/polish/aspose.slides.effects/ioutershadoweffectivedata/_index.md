...
---
## IOuterShadowEffectiveData klasa
...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | Promień [Blur](../blur/). Tylko do odczytu **double**. |
...
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | Określa, czy cień powinien obracać się wraz z kształtem, jeśli kształt jest obrócony. Tylko do odczytu **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | Określa poziomy współczynnik skalowania, ujemne skalowanie powoduje odbicie. Tylko do odczytu **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | Określa pionowy współczynnik skalowania, ujemne skalowanie powoduje odbicie. Tylko do odczytu **double**. |
...
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | Określa poziomy kąt pochylenia (w stopniach). Tylko do odczytu **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | Określa pionowy kąt pochylenia (w stopniach). Tylko do odczytu **double**. |
