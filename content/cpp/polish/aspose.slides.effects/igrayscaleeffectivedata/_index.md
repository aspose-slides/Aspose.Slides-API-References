...
description: Niezmienny obiekt, który reprezentuje efekt skali szarości. Konwertuje wszystkie wartości kolorów efektu na odcień szarości, odpowiadający ich luminancji. Wartości alfa (przezroczystość) efektu pozostają niezmienione.
type: docs
weight: 677
url: /pl/aspose.slides.effects/igrayscaleeffectivedata/
---
## IGrayScaleEffectiveData klasa

Obiekt niemutowalny, który reprezentuje efekt skali szarości. Konwertuje wszystkie wartości kolorów efektu na odcień szarości, odpowiadający ich luminancji. Wartości alfa (przezroczystości) efektu pozostają niezmienione.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje właściwie niczego, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstrukcji podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje właściwie niczego, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie konstrukcji podklas. |
