...
description: Niezmienny obiekt, który reprezentuje efekt Alpha Replace. Wartości alfy (przezroczystości) efektu są zastępowane stałą wartością alfy.
type: docs
weight: 404
url: /pl/aspose.slides.effects/ialphareplaceeffectivedata/
---
## IAlphaReplaceEffectiveData klasa

Nie zmienny obiekt, który reprezentuje efekt Alpha Replace. Wartości alfa (przezroczystość) efektu są zastępowane stałą wartością alfa.
...
| virtual **float** [get_Alpha](./get_alpha/)() | Zwraca nową wartość alfa w przedziale [0..1]. Read-only **float**. |
