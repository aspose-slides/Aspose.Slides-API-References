...
description: Niezmienny obiekt reprezentujący kolekcję tylko do odczytu efektywnych efektów przekształceń obrazu.
type: docs
weight: 716
url: /pl/aspose.slides.effects/iimagetransformocollectioneffectivedata/
---
## IImageTransformOCollectionEffectiveData klasa

Niezmienny obiekt reprezentujący kolekcję tylko do odczytu efektywów przekształceń obrazu.
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Zwraca iterator wskazujący tuż za ostatnim elementem (jeśli istnieje) kolekcji. Ten iterator nie może być użyty do zmiany referencjonowanego obiektu, ponieważ [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) zwraca obiekt-kopię typu T. |
...
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Porównuje obiekty zgodnie z semantyką [Object.Equals](../../system/object/equals/) języka C#. |
...
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Zwraca wartość wskazującą, czy dostęp do kolekcji jest zsynchronizowany (bezpieczny dla wątków). Tylko do odczytu **bool**. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog metody [Object.GetHashCode()](../../system/object/gethashcode/) w C#. Umożliwia haszowanie własnych obiektów. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Zwraca rzeczywisty typ obiektu. Analog wywołania [System.Object.GetType()](../../system/object/gettype/) w C#. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Zwraca element według indeksu. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog metody [Object.MemberwiseClone()](../../system/object/memberwiseclone/) w C#. Umożliwia klonowanie własnych typów. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog metody [Object.ToString()](../../system/object/tostring/) w C#. Umożliwia konwertowanie własnych obiektów na łańcuch znaków. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zwiększa licznik słabego wskaźnika. Nie należy wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zmniejsza licznik słabego wskaźnika. Nie należy wywoływać bezpośrednio; zamiast tego użyj inteligentnych wskaźników lub ThisProtector. |
| virtual  [~Object](../../system/object/~object/)() | Niszczy obiekt. Zwolnia wszystkie wewnętrzne struktury danych. |

## Uwagi

Nazwa IImageTransformOperationCollectionEffectiveData została obcięta do [IImageTransformOCollectionEffectiveData](./), ponieważ długość nazw COM nie może przekraczać 39 znaków. 
