...
description: Reprezentuje efekt Bi-Level (czarno-biały). Kolory wejściowe, których luminancja jest mniejsza niż określona wartość progu, są zmieniane na czarny. Kolory wejściowe, których luminancja jest większa lub równa określonej wartości, są ustawiane na biały. Wartości alfa nie są przez ten efekt modyfikowane.
type: docs
weight: 92
...
| Metoda | Opis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Określa, czy podany [BiLevel](./) jest równy bieżącemu [BiLevel](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevelEffectiveData](../ibileveleffectivedata/)\> [GetEffective](./geteffective/)() override | Pobiera skuteczne dane efektu Bi-Level z zastosowanym dziedziczeniem. |
