...
description: Niezmienny obiekt, który reprezentuje efekt rozmycia stosowany do całego kształtu, włącznie z jego wypełnieniem. Wszystkie kanały kolorów, w tym alfa, są dotknięte.
type: docs
weight: 469
url: /pl/aspose.slides.effects/iblureffectivedata/
---
## IBlurEffectiveData klasa


Niezmienny obiekt, który reprezentuje [Blur](../blur/) efekt stosowany do całego kształtu, włącznie z jego wypełnieniem. Wszystkie kanały kolorów, w tym alfa, są dotknięte.
...
| virtual **bool** [get_Grow](./get_grow/)() | Określa, czy granice obiektu powinny być powiększane w wyniku rozmycia. True wskazuje, że granice są powiększane, natomiast false wskazuje, że nie są. Tylko do odczytu **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Zwraca promień rozmycia. Tylko do odczytu **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznik odniesień powiązaną z obiektem. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor kopiujący. Nie kopiuje niczego, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstrukcji podklas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator przypisania. Nie kopiuje niczego, po prostu inicjalizuje nowy obiekt i umożliwia kopiowanie przy konstrukcji podklas. |
