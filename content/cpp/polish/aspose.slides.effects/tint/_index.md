...
description: Reprezentuje efekt Tint. Przesuwa wartości koloru efektu w stronę lub od odcienia o określoną wartość.
type: docs
weight: 1093
...
Reprezentuje efekt [Tint](./). Przesuwa wartości koloru efektu w kierunku/od odcienia o określoną wartość.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Określa, czy określony [Tint](./) jest równy aktualnemu [Tint](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | Pobiera efektywne dane efektu [Tint](./) z zastosowanym dziedziczeniem. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog metody C# [Object.ToString()](../../system/object/tostring/). Umożliwia konwersję obiektów niestandardowych na łańcuch. |
