...
---
## IInnerShadowEffectiveData klasa

Obiekt niezmienny, który reprezentuje efekt wewnętrznego cienia.
...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) promień. Tylko do odczytu **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Kierunek cienia. Tylko do odczytu **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Odległość cienia. Tylko do odczytu **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Kolor cienia. Tylko do odczytu [System::Drawing::Color](../../system.drawing/color/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Ustawia n-ty argument szablonu na słaby wskaźnik (zamiast współdzielonego). Pozwala przełączyć wskaźniki w kontenerach na tryb słaby. |
