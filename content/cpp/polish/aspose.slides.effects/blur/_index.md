...
description: Reprezentuje efekt rozmycia, który jest stosowany do całego kształtu, włącznie z jego wypełnieniem. Wszystkie kanały kolorów, w tym alfa, są objęte.
type: docs
weight: 105
...
| Metoda | Opis |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Określa, czy podany [Blur](./) jest równy bieżącemu [Blur](./). |
...
| **bool** [get_Grow](./get_grow/)() override | Określa, czy granice obiektu powinny być powiększone w wyniku rozmycia. Prawda wskazuje, że granice są zwiększane, natomiast fałsz, że nie są. Odczytaj **bool**. |
...
| **double** [get_Radius](./get_radius/)() override | Zwraca promień rozmycia. Odczytaj **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlurEffectiveData](../iblureffectivedata/)\> [GetEffective](./geteffective/)() override | Pobiera efektywne dane efektu [Blur](./) z zastosowanym dziedziczeniem. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Służy jako funkcja mieszająca dla określonego typu. |
...
| void [set_Grow](./set_grow/)(**bool**) override | Określa, czy granice obiektu powinny być powiększone w wyniku rozmycia. Prawda wskazuje, że granice są zwiększane, natomiast fałsz, że nie są. Zapisz **bool**. |
| void [set_Radius](./set_radius/)(**double**) override | Ustawia promień rozmycia. Zapisz **double**. |
