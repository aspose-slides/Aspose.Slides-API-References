...
description: Reprezentuje efekt Hue/Saturation/Luminance. Hue, Saturation i Luminance mogą być każdorazowo dostosowywane względem ich bieżącej wartości.
type: docs
weight: 222
...
Reprezentuje efekt Hue/Saturation/Luminance. Hue, Saturation i Luminance mogą być każdorazowo dostosowywane względem ich bieżącej wartości.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Określa, czy podany [HSL](./) jest równy bieżącemu [HSL](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHSLEffectiveData](../ihsleffectivedata/)\> [GetEffective](./geteffective/)() override | Pobiera efektywne dane efektu Hue/Saturation/Luminance z zastosowanym dziedziczeniem. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Służy jako funkcja skrótu dla danego typu. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Zmniejsza licznik współdzielonych odniesień o określoną wartość. |
