...
description: Reprezentuje efekt Alpha Bi-Level. Wartości Alpha (przezroczystość) mniejsze niż próg są zmieniane na 0 (całkowicie przezroczyste), a wartości alpha większe lub równe progowi są zmieniane na 100% (całkowicie nieprzezroczyste).
type: docs
weight: 1
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Określa, czy podany [AlphaBiLevel](./) jest równy bieżącemu [AlphaBiLevel](./). |
...
| **float** [get_Threshold](./get_threshold/)() override | Zwraca próg efektu. Odczyt **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Pobiera strukturę danych licznika referencji powiązaną z obiektem. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevelEffectiveData](../ialphabileveleffectivedata/)\> [GetEffective](./geteffective/)() override | Pobiera efektywne dane efektu Alpha Bi-Level z zastosowanym dziedziczeniem. |
...
| void [set_Threshold](./set_threshold/)(**float**) override | Zwraca próg efektu. Zapis **float**. |
...
* Klasa [IAlphaBiLevel](../ialphabilevel/)
