...
description: Niezmienny obiekt reprezentujący efekt zamiany koloru. Wszystkie kolory efektu są zmieniane na stały kolor. Wartości alfa pozostają niezmienione.
type: docs
weight: 547
url: /pl/aspose.slides.effects/icolorreplaceeffectivedata/
---
## IColorReplaceEffectiveData klasa

Niezmienny obiekt reprezentujący efekt zamiany koloru. Wszystkie kolory efektu są zmieniane na stały kolor. Wartości alfa pozostają niezmienione.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Zwraca format koloru, który zastąpi kolor każdego piksela. Tylko do odczytu [System::Drawing::Color](../../system.drawing/color/). |
