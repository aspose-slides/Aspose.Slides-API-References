...
description: Obiekt niezmienny, który reprezentuje efekt Fill Overlay. Fill Overlay może być użyty do określenia dodatkowego wypełnienia dla obiektu i połączenia obu wypełnień razem.
type: docs
weight: 625
url: /pl/aspose.slides.effects/ifilloverlayeffectivedata/
---
## IFillOverlayEffectiveData klasa


Obiekt niezmienny, który reprezentuje efekt Fill Overlay. Fill Overlay może być użyty do określenia dodatkowego wypełnienia dla obiektu i połączenia obu wypełnień razem.
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode. Tylko do odczytu [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | Format wypełnienia. Tylko do odczytu [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/). |
