...
---
## ILuminanceEffectiveData klasa


Reprezentuje efekt [Luminance](../luminance/). Jasność liniowo przesuwa wszystkie kolory bliżej bieli lub czerni. Kontrast skaluje wszystkie kolory, aby były bliżej siebie lub dalej od siebie.
...
| virtual **float** [get_Brightness](./get_brightness/)() | Jasność. Tylko do odczytu **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Kontrast. Tylko do odczytu **float**. |
