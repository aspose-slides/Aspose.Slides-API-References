...
description: Niezmienny obiekt, który reprezentuje efekt poświaty, w którym rozmyta obwódka koloru jest dodawana poza krawędziami obiektu.
type: docs
weight: 651
url: /pl/aspose.slides.effects/igloweffectivedata/
---
## IGlowEffectiveData klasa


Niezmienny obiekt, który reprezentuje [Glow](../glow/) efekt, w którym rozmyta obwódka koloru jest dodawana poza krawędziami obiektu.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Kolor. Tylko do odczytu [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_Radius](./get_radius/)() | Promień. Tylko do odczytu **double**. |
