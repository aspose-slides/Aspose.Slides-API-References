...
description: "นโยบายแคช HTTP ที่แสดงความหมายการแคชตาม RFC2616 วัตถุของคลาสนี้ควรถูกจัดสรรโดยใช้ฟังก์ชัน System::MakeObject() เท่านั้น ไม่ควรสร้างอินสแตนซ์ของประเภทนี้บนสแตกหรือโดยใช้ตัวดำเนินการ new เนื่องจากจะทำให้เกิดข้อผิดพลาดเวลาใช้งานและ/หรือการตรวจสอบความถูกต้องเสมอ ควรห่อคลาสนี้ด้วยพอยน์เตอร์ System::SmartPtr และใช้พอยน์เตอร์นี้เพื่อส่งเป็นอาร์กิวเมนต์ให้กับฟังก์ชัน"
type: docs
weight: 1
url: /th/system.net.cache/httprequestcachepolicy/
---
## HttpRequestCachePolicy คลาส
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบจำนวนจริงสไตล์ C# ซึ่ง NaN สองค่าได้รับการพิจารณาเท่ากัน แม้ว่าตาม IEC 60559:1989 NaN จะไม่เท่ากับค่าใด ๆ รวมถึง NaN เอง. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบจำนวนจริงสไตล์ C# ซึ่ง NaN สองค่าได้รับการพิจารณาเท่ากัน แม้ว่าตาม IEC 60559:1989 NaN จะไม่เท่ากับค่าใด ๆ รวมถึง NaN เอง. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | เพื่อการใช้งานภายในเท่านั้น. |
| [DateTime](../../system/datetime/) [get_CacheSyncDate](./get_cachesyncdate/)() const | รับเวลาที่ทรัพยากรที่เก็บในแคชต้องถูกตรวจสอบใหม่. |
| [DateTime](../../system/datetime/) [get_InternalCacheSyncDateUtc](./get_internalcachesyncdateutc/)() const | รับเวลาในรูปแบบ UTC ที่ทรัพยากรที่เก็บในแคชต้องถูกตรวจสอบใหม่. เพื่อการใช้งานภายในเท่านั้น. |
| [HttpRequestCacheLevel](../httprequestcachelevel/) [get_Level](./get_level/)() const | รับค่าที่ระบุของ HttpRequestCacheLevel. |
| [RequestCacheLevel](../requestcachelevel/) [get_Level](../requestcachepolicy/get_level/)() | รับค่าที่ระบุของ RequestCacheLevel. |
| [TimeSpan](../../system/timespan/) [get_MaxAge](./get_maxage/)() const | รับอายุสูงสุดที่อนุญาตสำหรับทรัพยากร. |
| [TimeSpan](../../system/timespan/) [get_MaxStale](./get_maxstale/)() const | รับค่าสูงสุดของความเก่า (staleness) ที่อนุญาตสำหรับทรัพยากร. |
| [TimeSpan](../../system/timespan/) [get_MinFresh](./get_minfresh/)() const | รับอายุต่ำสุดที่อนุญาตสำหรับทรัพยากร. |
...
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)() | สร้างอินสแตนซ์ใหม่. |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpRequestCacheLevel](../httprequestcachelevel/)) | สร้างอินสแตนซ์ใหม่. |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpCacheAgeControl](../httpcacheagecontrol/), [TimeSpan](../../system/timespan/)) | สร้างอินสแตนซ์ใหม่. |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpCacheAgeControl](../httpcacheagecontrol/), [TimeSpan](../../system/timespan/), [TimeSpan](../../system/timespan/)) | สร้างอินสแตนซ์ใหม่. |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([DateTime](../../system/datetime/)) | สร้างอินสแตนซ์ใหม่. |
|  [HttpRequestCachePolicy](./httprequestcachepolicy/)([HttpCacheAgeControl](../httpcacheagecontrol/), [TimeSpan](../../system/timespan/), [TimeSpan](../../system/timespan/), [DateTime](../../system/datetime/)) | สร้างอินสแตนซ์ใหม่. |
...
|  [RequestCachePolicy](../requestcachepolicy/requestcachepolicy/)() | สร้างอินสแตนซ์ใหม่. |
|  [RequestCachePolicy](../requestcachepolicy/requestcachepolicy/)([RequestCacheLevel](../requestcachelevel/)) | สร้างอินสแตนซ์ใหม่ด้วยค่าที่ระบุของ RequestCacheLevel. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | คล้ายกับเมธอด C# [Object.ToString()](../../system/object/tostring/). เปิดใช้งานการแปลงอ็อบเจกต์ที่กำหนดเองเป็นสตริง. |
...
| void [Unlock](../../system/object/unlock/)() | ทำหน้าที่เป็นการปลดล็อกของคำสั่ง C# lock(). เรียกโดยตรงหรือใช้วัตถุ sentinel [LockContext](../../system/lockcontext/). |
...
* คลาส [RequestCachePolicy](../requestcachepolicy/)
