...
ย่อหน้าคณิตศาสตร์ที่เป็นคอนเทนเนอร์สำหรับบล็อกคณิตศาสตร์ ([IMathBlock](../imathblock/))
...
| เมธอด | คำอธิบาย |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | เพิ่ม [IMathBlock](../imathblock/) ไปที่ส่วนท้ายของคอลเลกชัน. |
| [iterator](./iterator/) [begin](./begin/)() | รับ iterator ที่ชี้ไปยังองค์ประกอบแรก (ถ้ามี) ของคอลเลกชัน. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | รับ iterator ที่ชี้ไปยังองค์ประกอบแรก (ถ้ามี) ของอ็อบเจกต์ที่กำหนด const ของคอลเลกชัน. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | รับ iterator ที่ชี้ไปยังองค์ประกอบแรกที่มี const (ถ้ามี) ของคอลเลกชัน. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | รับ iterator ที่ชี้ไปหลังจากองค์ประกอบสุดท้ายที่มี const (ถ้ามี) ของคอลเลกชัน. |
| void [Clear](./clear/)() override | ลบทุกองค์ประกอบจากคอลเลกชัน. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | กำหนดว่าคอลเลกชันมีค่าที่ระบุหรือไม่. |
| [iterator](./iterator/) [end](./end/)() | รับ iterator ที่ชี้ไปหลังจากองค์ประกอบสุดท้าย (ถ้ามี) ของคอลเลกชัน. |
| [const_iterator](./const_iterator/) [end](./end/)() const | รับ iterator ที่ชี้ไปหลังจากองค์ประกอบสุดท้าย (ถ้ามี) ของอ็อบเจกต์ที่กำหนด const ของคอลเลกชัน. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบจุดลอยแบบ C# ซึ่ง NaN สองค่าเท่ากัน แม้ว่าตาม IEC 60559:1989 NaN จะไม่เท่ากับค่าใด ๆ รวมถึง NaN เอง. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบจุดลอยแบบ C# ซึ่ง NaN สองค่าถูกถือว่าเท่ากัน แม้ตาม IEC 60559:1989 NaN ไม่เท่ากับค่าตัวใดรวมถึง NaN เอง. |
...
| [MathJustification](../mathjustification/) [get_Justification](./get_justification/)() override | [Paragraph](../../aspose.slides/paragraph/) การจัดแนว ค่าเริ่มต้น: CenteredAsGroup |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) override | รับรายการที่ตำแหน่งที่ระบุ. อ่านอย่างเดียว [IMathBlock](../imathblock/). |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | รับรายการที่ตำแหน่งที่ระบุ. อ่านอย่างเดียว [IMathBlock](../imathblock/). |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | กำหนดตำแหน่งของ [IMathBlock](../imathblock/) เฉพาะในคอลเลกชัน. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | แทรก [IMathBlock](../imathblock/) ลงในคอลเลกชันที่ตำแหน่งที่ระบุ. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | ตรวจสอบว่าอ็อบเจกต์เป็นอินสแตนซ์ของประเภทที่อธิบายโดย targetType. เทียบเคียงกับอุปกรณ์ 'is' ของ C#. |
...
|  [MathParagraph](./mathparagraph/)() | สร้างอินสแตนซ์ใหม่ของคลาส [MathParagraph](./). |
|  [MathParagraph](./mathparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | สร้างอินสแตนซ์ใหม่ของคลาส [MathParagraph](./). |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | ลบการปรากฏครั้งแรกของอ็อบเจกต์เฉพาะจากคอลเลกชัน/>. |
| void [RemoveAt](./removeat/)(**int32_t**) override | ลบรายการที่ตำแหน่งที่ระบุของคอลเลกชัน. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | ลดจำนวนการอ้างอิงที่แชร์โดยค่าที่ระบุ. |
| void [set_Justification](./set_justification/)([MathJustification](../mathjustification/)) override | [Paragraph](../../aspose.slides/paragraph/) การจัดแนว ค่าเริ่มต้น: CenteredAsGroup |
...
| [System::String](../../system/string/) [ToLatex](./tolatex/)() override | รับสมการคณิตศาสตร์ในรูปแบบ LaTeX |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | รับ iterator ที่ชี้ไปยังองค์ประกอบแรก (ถ้ามี) ของอินสแตนซ์ที่กำหนด const ของคอลเลกชัน. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | รับ iterator ที่ชี้ไปหลังจากองค์ประกอบสุดท้าย (ถ้ามี) ของอินสแตนซ์ที่กำหนด const ของคอลเลกชัน. |
...
| void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | บันทึกเนื้อหาของ [MathParagraph](./) นี้เป็น MathML |
...
| Typedef | คำอธิบาย |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | ประเภทคอลเลกชันที่ใช้ประเภท iterator ของมันเป็นประเภท iterator ในคอลเลกชันปัจจุบัน. |
| [iterator](./iterator/) | ประเภท iterator. |
| [const_iterator](./const_iterator/) | ประเภท const iterator. |
| [virtualized_iterator_element](./virtualized_iterator_element/) | ประเภทองค์ประกอบแบบเวอร์ชวลไลซ์. |
| [virtualized_iterator](./virtualized_iterator/) | ประเภทแบบเวอร์ชวลไลซ์. |
