...
description: "ให้ API fallback เพื่อจัดการข้อผิดพลาดการถอดรหัส. วัตถุของคลาสนี้ควรสร้างด้วยฟังก์ชัน System::MakeObject() เท่านั้น. ไม่ควรสร้างอินสแตนซ์ของประเภทนี้บนสแตกหรือโดยใช้ operator new เนื่องจากจะทำให้เกิดข้อผิดพลาดรันไทม์และ/หรือ assertion fault. ควรห่อคลาสนี้ด้วยพอยน์เตอร์ System::SmartPtr แล้วใช้พอยน์เตอร์นี้ส่งต่อเป็นอาร์กิวเมนต์ให้ฟังก์ชัน."
type: docs
weight: 53
url: /th/system.text/decoderfallback/
---
## DecoderFallback คลาส
...
| เมธอด | คำอธิบาย |
| --- | --- |
| virtual [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() | รับบัฟเฟอร์ที่เกี่ยวข้องกับอัลกอริทึม fallback. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบเลขทศนิยมแบบ C#-style ที่ NaN สองค่าเท่ากันแม้ตาม IEC 60559:1989 แล้ว NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN ด้วย. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบเลขทศนิยมแบบ C#-style ที่ NaN สองค่าเท่ากันแม้ตาม IEC 60559:1989 แล้ว NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN ด้วย. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | สำหรับการใช้งานภายในเท่านั้น. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](./get_exceptionfallback/)() | รับการทำงาน fallback ของข้อยกเว้นค่าเริ่มต้น. |
| virtual int [get_MaxCharCount](./get_maxcharcount/)() const | รับจำนวนอักขระสูงสุดที่ fallback สามารถคืนค่าได้. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](./get_replacementfallback/)() | รับการทำงาน fallback การทดแทนค่าเริ่มต้น. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](./get_standardsafefallback/)() | รับการทำงาน fallback มาตรฐานปลอดภัยค่าเริ่มต้น. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | รับประเภทที่แท้จริงของวัตถุ. เทียบเท่าการเรียก C# [System.Object.GetType()](../../system/object/gettype/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | เปรียบเทียบโดยอ้างอิงประเภทค่ากับ nullptr. |
