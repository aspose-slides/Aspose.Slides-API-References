...
description: บันทึกสไลด์ทั้งหมดของการนำเสนอลงในไฟล์โดยใช้รูปแบบที่ระบุ.
type: docs
weight: 443
url: /th/aspose.slides/presentation/save/
---
## Presentation::Save(System::String, Export::SaveFormat) เมธอด
...
## Presentation::Save(System::SharedPtr\<System::IO::Stream\>, Export::SaveFormat) เมธอด
...
## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) เมธอด
...
```cpp
// สร้างอ็อบเจ็กต์การนำเสนอที่เป็นตัวแทนของไฟล์การนำเสนอ เช่น PPT, PPTX, ODP เป็นต้น
...
// ไม่รวมฟอนต์เริ่มต้นของการนำเสนอ
...
* แบบนับ [SaveFormat](../../../aspose.slides.export/saveformat/)
