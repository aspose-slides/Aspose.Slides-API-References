...
description: กำหนดการจัดแนวข้อความในย่อหน้าที่ไม่มีการสืบทอด เขียน TextAlignment.
type: docs
weight: 14
url: /th/aspose.slides/paragraphformat/set_alignment/
---
## ParagraphFormat::set_Alignment(TextAlignment) เมธอด


กำหนดการจัดแนวข้อความในย่อหน้าที่ไม่มีการสืบทอด เขียน [TextAlignment](../../textalignment/).
...
โค้ดตัวอย่างต่อไปนี้แสดงวิธีการจัดแนวข้อความในย่อหน้าใน PowerPoint [Presentation](../../presentation/). 
```cpp
