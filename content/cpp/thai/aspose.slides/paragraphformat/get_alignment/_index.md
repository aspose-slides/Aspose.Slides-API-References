...
description: ส่งคืนการจัดแนวข้อความในย่อหน้าที่ไม่มีการสืบทอด. อ่าน TextAlignment.
type: docs
weight: 1
url: /th/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() เมธอด


ส่งคืนการจัดแนวข้อความในย่อหน้าที่ไม่มีการสืบทอด. อ่าน [TextAlignment](../../textalignment/).
...
ตัวอย่างโค้ดต่อไปนี้แสดงวิธีการ Align Text Paragraphs ใน PowerPoint [Presentation](../../presentation/). 
```cpp
