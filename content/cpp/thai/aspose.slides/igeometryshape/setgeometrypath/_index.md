...
description: "อัปเดตรูปทรงเรขาคณิตจากวัตถุ IGeometryPath. พิกัดต้องสัมพันธ์กับมุมซ้ายบนของรูป. เปลี่ยนประเภทของรูป (ShapeType) เป็น ShapeType::Custom."
type: docs
weight: 66
url: /th/aspose.slides/igeometryshape/setgeometrypath/
---
## IGeometryShape::SetGeometryPath(System::SharedPtr\<IGeometryPath\>) เมธอด

อัปเดตรูปทรงเรขาคณิตของรูปจากวัตถุ [IGeometryPath](../../igeometrypath/). พิกัดต้องสัมพันธ์กับมุมซ้ายบนของรูป. เปลี่ยนประเภทของรูป ([ShapeType](../../shapetype/)) เป็น [ShapeType::Custom](../../shapetype/).
