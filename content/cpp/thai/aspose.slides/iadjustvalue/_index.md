...
description: แสดงถึงค่าการปรับของรูปทรงเรขาคณิต ค่าดังกล่าวส่งผลต่อรูปทรงของวัตถุ
type: docs
weight: 1288
...
แสดงถึงค่าการปรับของรูปทรงเรขาคณิต ค่าดังกล่าวส่งผลต่อรูปทรงของวัตถุ
...
| เมธอด | คำอธิบาย |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | เปรียบเทียบอ็อบเจกต์โดยใช้กฎของ C# [Object.Equals](../../system/object/equals/) |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบ floating point แบบ C#-style ที่ NaN สองค่าได้รับการพิจารณาให้เท่ากัน แม้ว่าตาม IEC 60559:1989 NaN จะไม่เท่ากับค่าใด ๆ รวมถึง NaN เอง |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบ floating point แบบ C#-style ที่ NaN สองค่าได้รับการพิจารณาให้เท่ากัน แม้ว่าตาม IEC 60559:1989 NaN จะไม่เท่ากับค่าใด ๆ รวมถึง NaN เอง |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | เพื่อการใช้ภายในเท่านั้น |
| virtual **float** [get_AngleValue](./get_anglevalue/)() | คืนค่าที่ตีความเป็นมุมหน่วยองศา. อ่าน **float** |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | คืนชื่อของค่าการปรับนี้. อ่านอย่างเดียว [System::String](../../system/string/) |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | คืนค่าการปรับ "ตามที่เป็น". อ่าน **int64_t** |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | คืนประเภทของการปรับรูปทรง. อ่านอย่างเดียว [ShapeAdjustmentType](../shapeadjustmenttype/) |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | รับโครงสร้างข้อมูลตัวนับอ้างอิงที่เชื่อมโยงกับอ็อบเจกต์ |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | คล้ายกับเมธอด C# [Object.GetHashCode()](../../system/object/gethashcode/). เปิดให้ทำแฮชกับอ็อบเจกต์ที่กำหนดเอง |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | คล้ายกับเมธอด C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). เปิดให้ทำการโคลนประเภทที่กำหนดเอง |
|  [Object](../../system/object/object/)() | สร้างอ็อบเจกต์. เริ่มต้นโครงสร้างข้อมูลภายในทั้งหมด |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | คอนสตรัคเตอร์คัดลอก. จริง ๆ แล้วไม่ได้คัดลอกรายการใด ๆ เพียงเริ่มต้นอ็อบเจกต์ใหม่และเปิดให้สร้างสำเนาสำหรับซับคลาส |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | โอเปอเรเตอร์การกำหนดค่า. จริง ๆ แล้วไม่ได้คัดลอกรายการใด ๆ เพียงเริ่มต้นอ็อบเจกต์ใหม่และเปิดให้สร้างสำเนาสำหรับซับคลาส |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | ตั้งค่าโดยตีความเป็นมุมในหน่วยองศา. เขียน **float** |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | ตั้งค่าการปรับ "ตามที่เป็น". เขียน **int64_t** |
