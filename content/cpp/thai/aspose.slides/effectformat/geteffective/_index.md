...
description: ดึงข้อมูลการจัดรูปแบบเอฟเฟกต์ที่มีผลโดยใช้การสืบทอดที่นำมาประยุกต์ใช้
type: docs
weight: 430
url: /th/aspose.slides/effectformat/geteffective/
---
## เมธอด EffectFormat::GetEffective() method

รับข้อมูลการจัดรูปแบบเอฟเฟกต์ที่มีผลโดยใช้การสืบทอดที่นำมาประยุกต์ใช้
...
ตัวอย่างนี้แสดงวิธีการดึงคุณสมบัติเอฟเฟกต์ที่มีผลของรูปทรงบางส่วน
```cpp
...
* คลาส [IEffectFormatEffectiveData](../../ieffectformateffectivedata/)
* คลาส [EffectFormat](../)
