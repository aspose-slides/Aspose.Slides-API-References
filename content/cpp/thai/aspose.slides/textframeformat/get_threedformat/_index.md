...
description: ส่งคืนวัตถุ ThreeDFormat ที่แสดงคุณสมบัติของเอฟเฟกต์ 3d สำหรับข้อความ. อ่านอย่างเดียว IThreeDFormat.
type: docs
weight: 1
url: /th/aspose.slides/textframeformat/get_threedformat/
---
## TextFrameFormat::get_ThreeDFormat() เมธอด

ส่งคืนวัตถุ [ThreeDFormat](../../threedformat/) ที่แสดงคุณสมบัติของเอฟเฟกต์ 3 มิติสำหรับข้อความ. อ่านอย่างเดียว [IThreeDFormat](../../ithreedformat/).
