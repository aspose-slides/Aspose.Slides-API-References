...
description: สร้างรูปทรงสี่เหลี่ยมอัตโนมัติใหม่เพื่อเป็นที่เก็บเนื้อหาทางคณิตศาสตร์และเพิ่มลงในตอนท้ายของคอลเลกชันรูปทรง.
type: docs
weight: 365
url: /th/aspose.slides/shapecollection/addmathshape/
---
## ShapeCollection::AddMathShape(float, float, float, float) เมธอด

สร้างรูปทรงสี่เหลี่ยมอัตโนมัติใหม่เพื่อเป็นที่เก็บเนื้อหาทางคณิตศาสตร์และเพิ่มลงในตอนท้ายของคอลเลกชันรูปทรง.
...
| --- | --- | --- |
| x | **float** | พิกัด x ของกรอบรูปทรง, หน่วยเป็นจุด. |
| y | **float** | พิกัด y ของกรอบรูปทรง, หน่วยเป็นจุด. |
| width | **float** | ความกว้างของกรอบรูปทรง, หน่วยเป็นจุด. |
| height | **float** | ความสูงของกรอบรูปทรง, หน่วยเป็นจุด. |
...
ตัวอย่างต่อไปนี้แสดงวิธีเพิ่มสมการคณิตศาสตร์ใน PowerPoint [Presentation](../../presentation/).
