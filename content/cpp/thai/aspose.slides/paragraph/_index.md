...
description: แสดงถึงพารากราฟของข้อความ.
type: docs
weight: 4616
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบเลขทศนิยมแบบ C#-style ที่ NaN สองค่าถือว่าเท่ากัน แม้ว่าตามมาตรฐาน IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN เอง. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบเลขทศนิยมแบบ C#-style ที่ NaN สองค่าถือว่าเท่ากัน แม้ว่าตามมาตรฐาน IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN เอง. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | ใช้เพื่อวัตถุประสงค์ภายในเท่านั้น. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_EndParagraphPortionFormat](./get_endparagraphportionformat/)() override | ระบุคุณสมบัติส่วนที่ต้องใช้หากมีส่วนอื่นแทรกหลังจากส่วนสุดท้าย. |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() override | ส่งคืนวัตถุการจัดรูปแบบสำหรับพารากราฟนี้ อ่านอย่างเดียว [IParagraphFormat](../iparagraphformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [get_Portion](./get_portion/)(**int32_t**) override | ส่งคืนส่วนข้อความที่ตำแหน่งที่ระบุ. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionCollection](../iportioncollection/)\> [get_Portions](./get_portions/)() override | ส่งคืนคอลเลกชันของส่วนข้อความ อ่านอย่างเดียว [IPortionCollection](../iportioncollection/). |
| [System::String](../../system/string/) [get_Text](./get_text/)() override | รับข้อความธรรมดาของพารากราฟ อ่าน [System::String](../../system/string/). |
...
| **int32_t** [GetLinesCount](./getlinescount/)() override | รับจำนวนบรรทัดในพารากราฟ. |
| [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() override | รับพิกัดของสี่เหลี่ยมที่ล้อมรอบพารากราฟ. สี่เหลี่ยมนี้รวมบรรทัดทั้งหมดของข้อความในพารากราฟรวมถึงบรรทัดว่าง. |
...
| void [JoinPortionsWithSameFormatting](./joinportionswithsameformatting/)() override | รวมรันที่มีการจัดรูปแบบเดียวกัน. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | คอนสตรัคเตอร์คัดลอก. ไม่ได้คัดลอกอะไรเลย จริง ๆ แล้วเพียงแค่เริ่มต้นอ็อบเจ็กต์ใหม่และเปิดใช้งานการสร้างคัดลอกของคลาสย่อย. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | ตัวดำเนินการกำหนดค่า. ไม่ได้คัดลอกอะไรเลย จริง ๆ แล้วเพียงแค่เริ่มต้นอ็อบเจ็กต์ใหม่และเปิดใช้งานการสร้างคัดลอกของคลาสย่อย. |
|  [Paragraph](./paragraph/)() | เริ่มต้นอินสแตนซ์ใหม่ของคลาส [Paragraph](./) ด้วยคุณสมบัติปริยาย. |
|  [Paragraph](./paragraph/)([System::SharedPtr](../../system/sharedptr/)\<[Paragraph](./)\>) | คอนสตรัคเตอร์คัดลอกที่เริ่มต้นอินสแตนซ์ใหม่ของคลาส [Paragraph](./). |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | การทำเฉพาะของ [Object::ReferenceEquals](../../system/object/referenceequals/) สำหรับกรณีของสตริงหลายค่า. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | ลดค่าตัวนับอ้างอิงที่แชร์โดยค่าที่ระบุ. |
| void [set_EndParagraphPortionFormat](./set_endparagraphportionformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | ระบุคุณสมบัติส่วนที่ต้องใช้หากมีส่วนอื่นแทรกหลังจากส่วนสุดท้าย. |
| void [set_Text](./set_text/)([System::String](../../system/string/)) override | ตั้งค่าข้อความธรรมดาของพารากราฟ. เขียน [System::String](../../system/string/). |
