...
description: เป็นตัวเลือกที่สามารถใช้ในการเน้นข้อความในกรอบข้อความ.
type: docs
weight: 5474
url: /th/aspose.slides/texthighlightingoptions/
---
## TextHighlightingOptions คลาส

เป็นตัวเลือกที่สามารถใช้ในการเน้นข้อความในกรอบข้อความ.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบจุดลอยแบบ C# ที่ NaN สองค่าถูกพิจารณาเท่ากันแม้ว่า ตามมาตรฐาน IEC 60559:1989 NaN จะไม่เท่ากับค่าตัวใด ๆ รวมถึง NaN ด้วย. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบจุดลอยแบบ C# ที่ NaN สสองค่าถูกพิจารณาเท่ากันแม้ว่า ตามมาตรฐาน IEC 60559:1989 NaN จะไม่เท่ากับค่าตัวใด ๆ รวมถึง NaN ด้วย. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | ใช้สำหรับการทำงานภายในเท่านั้น. |
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | กำหนดค่า true เพื่อใช้การค้นหาแยกแยะตัวพิมพ์ใหญ่-เล็ก, false - มิฉะนั้น. อ่าน **bool**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | กำหนดค่า true เพื่อจับคู่อย่างเต็มรูปแบบของคำเท่านั้น, false - มิฉะนั้น. อ่าน **bool**. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | ตรวจสอบว่าอ็อบเจกต์เป็นอินสแตนซ์ของชนิดที่อธิบายโดย targetType หรือไม่. เป็นอนาล็อกของโอเปอเรเตอร์ 'is' ของ C#. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | คอนสตรัคเตอร์คัดลอก. จริง ๆ แล้วไม่ได้คัดลอกอะไรเลย เพียงเริ่มต้นอ็อบเจกต์ใหม่และเปิดใช้งานการคัดลอกคอนสตรัคเตอร์ของซับคลาส. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | ตัวดำเนินการกำหนดค่า. จริง ๆ แล้วไม่ได้คัดลอกอะไรเลย เพียงเริ่มต้นอ็อบเจกต์ใหม่และเปิดใช้งานการคัดลอกคอนสตรัคเตอร์ของซับคลาส. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | กำหนดค่า true เพื่อใช้การค้นหาแยกแยะตัวพิมพ์ใหญ่-เล็ก, false - มิฉะนั้น. เขียน **bool**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | กำหนดค่า true เพื่อจับคู่อย่างเต็มรูปแบบของคำเท่านั้น, false - มิฉะนั้น. เขียน **bool**. |
...
|  [TextHighlightingOptions](./texthighlightingoptions/)() | สร้างตัวเลือกการเน้นข้อความเริ่มต้นใหม่. |
...
## เลิกใช้
อินเทอร์เฟซ [ITextHighlightingOptions](../itexthighlightingoptions/) จะถูกลบหลังจากการปล่อยเวอร์ชัน 24.10.
