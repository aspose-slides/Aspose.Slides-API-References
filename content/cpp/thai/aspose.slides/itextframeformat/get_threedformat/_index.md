...
description: ส่งคืนอ็อบเจ็กต์ ThreeDFormat ที่เป็นตัวแทนของคุณสมบัติผลกระทบ 3 มิติสำหรับข้อความ. อ่านอย่างเดียว IThreeDFormat.
type: docs
weight: 300
url: /th/aspose.slides/itextframeformat/get_threedformat/
---
## ITextFrameFormat::get_ThreeDFormat() เมธอด

ส่งคืนอ็อบเจ็กต์ [ThreeDFormat](../../threedformat/) ที่เป็นตัวแทนของคุณสมบัติผลกระทบ 3 มิติสำหรับข้อความ อ่านอย่างเดียว [IThreeDFormat](../../ithreedformat/).
