...
description: IEnumerable เป็นอินเทอร์เฟซพื้นฐานสำหรับคอลเลกชันที่ไม่เป็น generic ทั้งหมดที่สามารถวนลูปได้.
type: docs
weight: 53
url: /th/system.collections/ienumerable/
---
## IEnumerable คลาส

[IEnumerable](./) เป็นอินเทอร์เฟซพื้นฐานสำหรับคอลเลกชันที่ไม่เป็น generic ทั้งหมดที่สามารถวนลูปได้.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | คืนค่า enumerator ที่วนซ้ำผ่านคอลเลกชัน. |
