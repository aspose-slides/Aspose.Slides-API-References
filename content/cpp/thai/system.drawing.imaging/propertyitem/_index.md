...
description: "แสดงถึงคุณสมบัติเมทาดาต้าที่จะรวมอยู่ในไฟล์ภาพ วัตถุของคลาสนี้ควรสร้างขึ้นโดยใช้ฟังก์ชัน System::MakeObject() เท่านั้น ไม่ควรสร้างอินสแตนซ์ของประเภทนี้บนสแตกหรือใช้ operator new เพราะจะทำให้เกิดข้อผิดพลาดเวลาเรียกใช้และ/หรือการตรวจสอบข้อผิดพลาด เสมอห่อคลาสนี้ด้วยตัวชี้ System::SmartPtr และใช้ตัวชี้นี้เพื่อส่งเป็นอาร์กิวเมนต์ให้กับฟังก์ชัน"
type: docs
weight: 170
url: /th/system.drawing.imaging/propertyitem/
---
## PropertyItem คลาส
...
| **int32_t** [get_Id](./get_id/)() const | คืนค่า ID ของคุณสมบัติที่แสดงโดยอ็อบเจ็กต์ปัจจุบัน. |
| **int32_t** [get_Len](./get_len/)() const | คืนความยาวของคุณสมบัติที่แสดงโดยอ็อบเจ็กต์ปัจจุบันเป็นไบต์. |
| **int16_t** [get_Type](./get_type/)() const | คืนประเภทของคุณสมบัติที่แสดงโดยอ็อบเจ็กต์ปัจจุบันเป็นไบต์. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Value](./get_value/)() const | คืนค่าของคุณสมบัติที่แสดงโดยอ็อบเจ็กต์ปัจจุบันเป็นไบต์. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | ดึงประเภทจริงของอ็อบเจ็กต์ คล้ายการเรียก C# [System.Object.GetType()](../../system/object/gettype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy constructor. จริง ๆ แล้วไม่ได้คัดลอกอะไรเลย เพียงแค่เริ่มต้นอ็อบเจ็กต์ใหม่และเปิดให้สร้างสำเนาย่อยได้. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Assignment operator. จริง ๆ แล้วไม่ได้คัดลอกอะไรเลย เพียงแค่เริ่มต้นอ็อบเจ็กต์ใหม่และเปิดให้สร้างสำเนาย่อยได้. |
|  [PropertyItem](./propertyitem/)() | สร้างอินสแตนซ์ใหม่ของคลาส [PropertyItem](./). |
...
| void [set_Id](./set_id/)(**int32_t**) | ตั้งค่า ID ของคุณสมบัติที่แสดงโดยอ็อบเจ็กต์ปัจจุบัน. |
| void [set_Len](./set_len/)(**int32_t**) | ตั้งค่าความยาวของคุณสมบัติที่แสดงโดยอ็อบเจ็กต์ปัจจุบันเป็นไบต์. |
| void [set_Type](./set_type/)(**int16_t**) | ตั้งค่าประเภทของคุณสมบัติที่แสดงโดยอ็อบเจ็กต์ปัจจุบันเป็นไบต์. |
| void [set_Value](./set_value/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | ตั้งค่าประเภทของคุณสมบัติที่แสดงโดยอ็อบเจ็กต์ปัจจุบันเป็นไบต์. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | ทำหน้าที่เป็นคำสั่ง typeof([System.Object](../../system/object/)) ของ C#. |
