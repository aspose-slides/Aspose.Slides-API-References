...
description: "ให้ข้อมูลสำหรับเหตุการณ์ BeginPrint และ EndPrint. วัตถุของคลาสนี้ควรจะจัดสรรเท่านั้นด้วยฟังก์ชัน System::MakeObject(). ไม่ควรสร้างอินสแตนซ์ของประเภทนี้บนสแตกหรือโดยใช้ operator new เพราะจะทำให้เกิดข้อผิดพลาดรันไทม์และ/หรือการตรวจสอบข้อสันนิษฐาน. ควรห่อหุ้มคลาสนี้ด้วยพอยน์เตอร์ System::SmartPtr และใช้พอยน์เตอร์นี้เพื่อส่งผ่านเป็นอาร์กิวเมนต์ให้กับฟังก์ชัน."
type: docs
weight: 92
url: /th/system.drawing.printing/printeventargs/
---
## PrintEventArgs คลาส
...
| Method | Description |
| --- | --- |
|  [CancelEventArgs](../../system.componentmodel/canceleventargs/canceleventargs/)(**bool**) | ตัวสร้าง |
|  [CancelEventArgs](../../system.componentmodel/canceleventargs/canceleventargs/)() | ตัวสร้าง; ตั้งค่า Cancel property เป็น false. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบจำนวนทศนิยมแบบ C# ที่ NaN สองค่าเท่ากัน แม้ว่าตาม IEC 60559:1989 NaN จะไม่เท่ากับค่าใด ๆ รวมทั้ง NaN |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบจำนวนทศนิยมแบบ C# ที่ NaN สองค่าเท่ากัน แม้ว่าตาม IEC 60559:1989 NaN จะไม่เท่ากับค่าใด ๆ รวมทั้ง NaN |
|  [EventArgs](../../system/eventargs/eventargs/)() | ตัวสร้าง |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | เพื่อการใช้งานภายในเท่านั้น |
| **bool** [get_Cancel](../../system.componentmodel/canceleventargs/get_cancel/)() | รับค่าที่บ่งชี้ว่ากิจกรรมควรถูกยกเลิกหรือไม่ |
| [PrintAction](../printaction/) [get_PrintAction](./get_printaction/)() | คืนค่าที่ระบุการดำเนินการพิมพ์ที่แทนโดยอ็อบเจ็กต์ปัจจุบัน |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | ตรวจสอบว่าอ็อบเจ็กต์เป็นอินสแตนซ์ของชนิดที่อธิบายโดย targetType. เทียบเคียงกับโอเปอร์เรเตอร์ 'is' ของ C# |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | คอนสตรัคเตอร์คัดลอก. จริง ๆ แล้วไม่ได้คัดลอกอะไรเลย เพียงเริ่มต้นอ็อบเจ็กต์ใหม่และเปิดใช้งานการคัดลอกย่อยคลาส |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | โอเปอเรเตอร์กำหนดค่า. จริง ๆ แล้วไม่ได้คัดลอกอะไรเลย เพียงเริ่มต้นอ็อบเจ็กต์ใหม่และเปิดใช้งานการคัดลอกย่อยคลาส |
|  [PrintEventArgs](./printeventargs/)() | สร้างอินสแตนซ์ใหม่ของอ็อบเจ็กต์ [PrintEventArgs](./) |
...
| void [set_Cancel](../../system.componentmodel/canceleventargs/set_cancel/)(**bool**) | ตั้งค่าที่บ่งชี้ว่ากิจกรรมควรถูกยกเลิกหรือไม่ |
...
| Field | Description |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | สมาชิก static ที่เป็นตัวแทนของ [EventArgs](../../system/eventargs/) shared pointer "ว่างเปล่า" (null-pointer) |

## ดูเพิ่มเติม

* คลาส [CancelEventArgs](../../system.componentmodel/canceleventargs/)
