...
description: ห่อหุ้มบริบทการทำงานปัจจุบันของ Extensible Stylesheet Language for Transformations (XSLT) processor ที่อนุญาตให้ XML Path Language (XPath) แก้ไขฟังก์ชัน, พารามิเตอร์, และเนมสเปซภายในนิพจน์ XPath.
type: docs
weight: 79
url: /th/system.xml.xsl/xsltcontext/
---
## XsltContext คลาส

ห่อหุ้มบริบทการทำงานปัจจุบันของ Extensible Stylesheet Language for Transformations (XSLT) processor ที่อนุญาตให้ XML Path Language ([XPath](../../system.xml.xpath/)) แก้ไขฟังก์ชัน, พารามิเตอร์, และเนมสเปซภายในนิพจน์ [XPath](../../system.xml.xpath/) ได้
...
| เมธอด | คำอธิบาย |
| --- | --- |
| virtual void [AddNamespace](../../system.xml/xmlnamespacemanager/addnamespace/)([String](../../system/string/), [String](../../system/string/)) | เพิ่มเนมสเปซที่ระบุลงในคอลเลกชัน |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | รับ iterator ที่ชี้ไปยังองค์ประกอบแรก (หากมี) ของอินสแทนซ์ที่กำหนดเป็น const ของคอลเลกชัน |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | รับ iterator ที่ชี้ไปตรงหลังองค์ประกอบสุดท้ายที่กำหนดเป็น const (หากมี) ของคอลเลกชัน |
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | เมื่อถูก override ในคลาสที่สืบทอด จะเปรียบเทียบ Uniform Resource Identifiers (URIs) พื้นฐานของสองเอกสารตามลำดับที่เอกสารถูกโหลดโดยตัวประมวลผล XSLT (คือคลาส [XslTransform](../xsltransform/)) |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | รับ iterator ที่ชี้ไปตรงหลังองค์ประกอบสุดท้าย (หากมี) ของคอลเลกชัน ตัว iterator นี้ไม่สามารถใช้เพื่อเปลี่ยนวัตถุที่อ้างอิงได้ เนื่องจาก [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) ส่งคืนอ็อบเจ็กต์สำเนาของ T |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | รับ iterator ที่ชี้ไปตรงหลังองค์ประกอบสุดท้าย (หากมี) ของอินสแทนซ์ที่กำหนดเป็น const ของคอลเลกชัน |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบจุดทศนิยมแบบ C# ที่ NaN สองค่าเป็นเท่ากัน แม้ตาม IEC 60559:1989 NaN ไม่เท่ากับค่าหรือ NaN ใดๆ |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบจุดทศนิยมแบบ C# ที่ NaN สองค่าเป็นเท่ากัน แม้ตาม IEC 60559:1989 NaN ไม่เท่ากับค่าหรือ NaN ใดๆ |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | ใช้สำหรับการทำงานภายในเท่านั้น |
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | ส่งคืน URI ของเนมสเปซค่าเริ่มต้น |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | ส่งคืน [XmlNameTable](../../system.xml/xmlnametable/) ที่เกี่ยวข้องกับอ็อบเจ็กต์นี้ |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | เมื่อถูก override ในคลาสที่สืบทอด จะรับค่าที่บ่งบอกว่าควรรวมโหนสี่่ขาวในผลลัพธ์หรือไม่ |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | รับโครงสร้างข้อมูลตัวนับอ้างอิงที่เชื่อมโยงกับอ็อบเจ็กต์ |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | ส่งคืน enumerator เพื่อใช้ในการวนผ่านเนมสเปซใน [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | เป็นอเน็ลอกของเมธอด C# [Object.GetHashCode()](../../system/object/gethashcode/). เปิดใช้งานการทำแฮชของอ็อบเจ็กต์ที่กำหนดเอง |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](../../system.xml/xmlnamespacemanager/getnamespacesinscope/)([XmlNamespaceScope](../../system.xml/xmlnamespacescope/)) override | ส่งคืนคอลเลกชันของชื่อเนมสเปซที่ใช้คีย์ตามพรีแฟกซ์ ซึ่งสามารถใช้เพื่อวนตรวจสอบเนมสเปซที่มีอยู่ในขอบเขตปัจจุบัน |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | รับประเภทจริงของอ็อบเจ็กต์. เป็นอเน็ลอกของการเรียก C# [System.Object.GetType()](../../system/object/gettype/) |
| virtual **bool** [HasNamespace](../../system.xml/xmlnamespacemanager/hasnamespace/)([String](../../system/string/)) | ส่งคืนค่าที่บ่งบอกว่าพรีแฟกซ์ที่ระบุมีเนมสเปซกำหนดไว้สำหรับสโกปที่ถูกผลักปัจจุบันหรือไม่ |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | ตรวจสอบว่าอ็อบเจ็กต์เป็นอินสแทนซ์ของประเภทที่อธิบายโดย targetType หรือไม่. เป็นอเน็ลอกของตัวดำเนินการ 'is' ของ C# |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | กำหนดว่ามีองค์ประกอบใดในลำดับที่มีอยู่หรือสอดคล้องกับเงื่อนไขหรือไม่ |
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | คำนวนค่าเฉลี่ยของลำดับของค่าตัวเลข |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | คำนวนค่าเฉลี่ยของลำดับของค่าที่ได้จากการเรียกฟังก์ชันแปลงบนแต่ละองค์ประกอบของลำดับอินพุต |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | ส่งคืนจำนวนขององค์ประกอบในลำดับที่ตรงตามเงื่อนไขที่ระบุ |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | ส่งคืนองค์ประกอบแรกของลำดับ หรือค่าเริ่มต้นหากลำดับว่าง |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | ส่งคืนองค์ประกอบแรกของลำดับที่ตรงกับเงื่อนไข หรือค่าเริ่มต้นหากไม่พบ |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | ส่งคืนองค์ประกอบสุดท้ายของลำดับ หรือค่าเริ่มต้นหากลำดับว่าง |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | เรียกฟังก์ชันแปลงบนแต่ละองค์ประกอบของลำดับทั่วไปและส่งคืนค่าสูงสุดที่ได้ |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | เรียกฟังก์ชันแปลงบนแต่ละองค์ประกอบของลำดับทั่วไปและส่งคืนค่าต่ำสุดที่ได้ |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | แปลงแต่ละองค์ประกอบของลำดับเป็นรูปแบบใหม่โดยผนวกดัชนีขององค์ประกอบ |
...
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | ส่งคืน URI ของเนมสเปซสำหรับพรีแฟกซ์ที่ระบุ |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | ค้นหาพรีแฟกซ์ที่ประกาศสำหรับ URI ของเนมสเปซที่ให้มา |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | เป็นอเน็ลอกของเมธอด C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). เปิดใช้งานการโคลนประเภทที่กำหนดเอง |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | โอเปอร์เรเตอร์การกำหนดค่า. ไม่ได้คัดลอกอะไรจริงๆ เพียงเริ่มต้นอ็อบเจ็กต์ใหม่และเปิดใช้งานการคัดลอกสร้างซับคลาส |
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | ดึงสโกปของเนมสเปซออกจากสแตก |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | เมื่อถูก override ในคลาสที่สืบทอด จะประเมินว่าจะคงโหนสี่่ขาวไว้หรือเอาออกสำหรับบริบทที่ให้ |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | ผลักสโกปของเนมสเปซเข้าสู่สแตก |
...
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | ลบเนมสเปซที่ระบุสำหรับพรีแฟกซ์ที่กำหนด |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextFunction](../ixsltcontextfunction/)\> [ResolveFunction](./resolvefunction/)([String](../../system/string/), [String](../../system/string/), [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\>) | เมื่อถูก override ในคลาสที่สืบทอด จะ resolve การอ้างอิงฟังก์ชันและส่งคืน [IXsltContextFunction](../ixsltcontextfunction/) ที่แสดงถึงฟังก์ชัน. [IXsltContextFunction](../ixsltcontextfunction/) ถูกใช้ในช่วงเวลาการทำงานเพื่อรับค่าที่คืนของฟังก์ชัน |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | เมื่อถูก override ในคลาสที่สืบทอด จะ resolve การอ้างอิงตัวแปรและส่งคืน [IXsltContextVariable](../ixsltcontextvariable/) ที่แสดงถึงตัวแปร |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | ลดจำนวนการอ้างอิงแบบแชร์และส่งคืนค่า. ไม่ควรเรียกโดยตรง; ใช้ smart pointers หรือ ThisProtector แทน |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | เป็นอเน็ลอกของเมธอด C# [Object.ToString()](../../system/object/tostring/). เปิดใช้งานการแปลงอ็อบเจ็กต์ที่กำหนดเป็นสตริง |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | ทำหน้าที่เป็นการสร้าง C# typeof([System.Object](../../system/object/)) |
| void [Unlock](../../system/object/unlock/)() | ทำหน้าที่เป็นการปลดล็อกตามคำสั่ง lock() ของ C#. เรียกโดยตรงหรือใช้วัตถุ sentry [LockContext](../../system/lockcontext/) |
...
|  [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | เริ่มต้นอินสแทนซ์ใหม่ของคลาส [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) ด้วย [XmlNameTable](../../system.xml/xmlnametable/) ที่ระบุ |
...
| --- | --- |
| [Ptr](./ptr/) | นิยามอื่นสำหรับ shared pointer ไปยังอินสแทนซ์ของคลาสนี้ |

## ดูเพิ่มเติม

* คลาส [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/)
