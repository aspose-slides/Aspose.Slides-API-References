...
description: คลาสฐานสำหรับนั้นคือคลาสฐานสำหรับประเภทพาร์ทิเคิลทั้งหมด (เช่น XmlSchemaAny).
type: docs
weight: 729
url: /th/system.xml.schema/xmlschemaparticle/
---
## XmlSchemaParticle คลาส

คลาสฐานสำหรับนั้นคือคลาสฐานสำหรับประเภทพาร์ทิเคิลทั้งหมด (เช่น [XmlSchemaAny](../xmlschemaany/)).
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](./get_maxoccurs/)() | Returns the maximum number of times the particle can occur. |
| [String](../../system/string/) [get_MaxOccursString](./get_maxoccursstring/)() | Returns the number as a string value. Maximum number of times the particle can occur. |
| [Decimal](../../system/decimal/) [get_MinOccurs](./get_minoccurs/)() | Returns the minimum number of times the particle can occur. |
| [String](../../system/string/) [get_MinOccursString](./get_minoccursstring/)() | Returns the number as a string value. The minimum number of times the particle can occur. |
...
| void [set_MaxOccurs](./set_maxoccurs/)([Decimal](../../system/decimal/)) | Sets the maximum number of times the particle can occur. |
| void [set_MaxOccursString](./set_maxoccursstring/)(const [String](../../system/string/)\&) | Sets the number as a string value. Maximum number of times the particle can occur. |
| void [set_MinOccurs](./set_minoccurs/)([Decimal](../../system/decimal/)) | Sets the minimum number of times the particle can occur. |
| void [set_MinOccursString](./set_minoccursstring/)(const [String](../../system/string/)\&) | Sets the number as a string value. The minimum number of times the particle can occur. |
...
อ็อบเจกต์ของคลาสนี้ควรจัดสรรโดยใช้ฟังก์ชัน [System::MakeObject()](../../system/makeobject/) เท่านั้น ไม่ควรสร้างอินสแตนซ์ของประเภทนี้บนสแตกหรือใช้ตัวดำเนินการ new เนื่องจากจะทำให้เกิดข้อผิดพลาดขณะทำงานและ/หรือข้อผิดพลาดการอ้างอิง ควรห่อคลาสนี้ด้วยพอยเตอร์ [System::SmartPtr](../../system/smartptr/) และใช้พอยเตอร์นี้ในการส่งเป็นอาร์กิวเมนต์ให้กับฟังก์ชันเสมอ. 
