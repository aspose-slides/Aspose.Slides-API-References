...
description: ตัวชี้ไปยังคอลเลกชันของใบรับรอง X509. ชนิดนี้เป็นตัวชี้เพื่อจัดการการลบของออบเจกต์อื่น. ควรจัดสรรบนสแตกและส่งต่อให้ฟังก์ชันโดยค่าหรือด้วยการอ้างอิงแบบคอนสท์.
type: docs
weight: 92
url: /th/system.security.cryptography.x509certificates/x509certificatecollectionptr/
---
## X509CertificateCollectionPtr คลาส

ตัวชี้ไปยังคอลเลกชันของใบรับรอง X509. ชนิดนี้เป็นตัวชี้เพื่อจัดการการลบของออบเจกต์อื่น. ควรจัดสรรบนสแตกและส่งต่อให้ฟังก์ชันโดยค่าหรือด้วยการอ้างอิงแบบคอนสท์.
