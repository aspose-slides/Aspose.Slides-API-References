...
description: อินเทอร์เฟซ callback ที่ใช้โดยกระบวนการนำเข้า HTML เพื่อรับอ็อบเจกต์ที่อ้างอิง เช่น รูปภาพ.
type: docs
weight: 53
url: /th/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver คลาส

Callback อินเทอร์เฟซที่ใช้โดยกระบวนการนำเข้า HTML เพื่อรับอ็อบเจกต์ที่อ้างอิง เช่น รูปภาพ.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบค่า floating point แบบ C# โดยถือว่า NaN สองค่าเท่ากันแม้ตาม IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN เอง. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบค่า floating point แบบ C# โดยถือว่า NaN สองค่าเท่ากันแม้ตาม IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN เอง. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | สำหรับการใช้งานภายในเท่านั้น. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | รับโครงสร้างข้อมูลตัวนับอ้างอิงที่เชื่อมโยงกับอ็อบเจกต์. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | แม็ป URI ไปยังอ็อบเจกต์ที่มีทรัพยากรจริง. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | ตรวจสอบว่าอ็อบเจกต์เป็นอินสแตนซ์ของประเภทที่อธิบายโดย targetType. คล้ายตัวดำเนินการ C# `is`. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | ตัวสร้างคัดลอก. ไม่คัดลอกอะไรจริง ๆ เพียงแค่เริ่มต้นอ็อบเจกต์ใหม่และเปิดใช้งานการคัดลอกย่อยคลาส. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | ตัวดำเนินการกำหนดค่า. ไม่คัดลอกอะไรจริง ๆ เพียงแค่เริ่มต้นอ็อบเจกต์ใหม่และเปิดใช้งานการคัดลอกย่อยคลาส. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | เฉพาะกรณีสำหรับสตริงและ nullptr ของ [Object::ReferenceEquals](../../system/object/referenceequals/). |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | เฉพาะกรณีสำหรับสตริงของ [Object::ReferenceEquals](../../system/object/referenceequals/). |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | ลดค่าตัวนับอ้างอิงที่แชร์ลงตามค่าที่ระบุ. |
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | แก้ไข URI แบบสมบูรณ์จากฐานและ URI ที่สัมพันธ์กัน. |
...
Deprecated
:   ล้าสมัย. ใช้ [IExternalResourceResolver](../iexternalresourceresolver/) แทน. จะถูกลบในรุ่น 17.12

## ดูเพิ่มเติม

* คลาส [IExternalResourceResolver](../iexternalresourceresolver/)
