...
description: การสเปเชียลไลซ์ของ Task ที่คืนค่าผลลัพธ์เมื่องานเสร็จสมบูรณ์.
type: docs
weight: 40
url: /th/system.threading.tasks/resulttask/
---
## ResultTask คลาส
...
เป็นการดำเนินการแบบอะซิงโครนัสที่ผลิตผลลัพธ์, คล้ายกับ System.Threading.Tasks.Task<TResult> ใน .NET 
## ดูเพิ่มเติม
