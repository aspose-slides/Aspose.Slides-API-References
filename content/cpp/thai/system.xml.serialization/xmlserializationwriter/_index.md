...
description: คลาสบริการที่ปรับปรุงประสบการณ์การใช้งาน XmlWriter.
type: docs
weight: 53
url: /th/system.xml.serialization/xmlserializationwriter/
---
## XmlSerializationWriter คลาส

คลาสบริการที่ปรับปรุงประสบการณ์ [XmlWriter](../../system.xml/xmlwriter/).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบจุดทศนิยมแบบ C# ซึ่ง NaN สองค่าถือว่าเท่ากัน แม้ว่าตาม IEC 60559:1989 NaN จะไม่เท่ากับค่าใด ๆ รวมถึง NaN เอง. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบจุดทศนิยมแบบ C# ซึ่ง NaN สองค่าถือว่าเท่ากัน แม้ว่าตาม IEC 60559:1989 NaN จะไม่เท่ากับค่าใด ๆ รวมถึง NaN เอง. |
...
| void [Initialize](./initialize/)([System::SharedPtr](../../system/sharedptr/)\<[XmlWriter](../../system.xml/xmlwriter/)\>, [System::SharedPtr](../../system/sharedptr/)\<[XmlSerializerNamespaces](../xmlserializernamespaces/)\>) | กำหนดค่าเริ่มต้นให้คลาส [XmlSerializationReader](../xmlserializationreader/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | คอนสตรัคเตอร์คัดลอก. จริง ๆ แล้วไม่คัดลอกอะไร เพียงกำหนดค่าเริ่มต้นให้วัตถุใหม่และอนุญาตให้คอนสตรัคเตอร์คัดลอกของคลาสย่อยทำงาน. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | โอเปอเรเตอร์กำหนดค่า. จริง ๆ แล้วไม่คัดลอกอะไร เพียงกำหนดค่าเริ่มต้นให้วัตถุใหม่และอนุญาตให้คอนสตรัคเตอร์คัดลอกของคลาสย่อยทำงาน. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | ลดจำนวนการอ้างอิงแบบแชร์และส่งค่ากลับ. ไม่ควรเรียกโดยตรง; แทนที่ใช้ smart pointer หรือ ThisProtector. |
