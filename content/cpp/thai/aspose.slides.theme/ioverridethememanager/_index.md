...
description: ให้การเข้าถึงประเภทต่าง ๆ ของธีมที่ถูกเขียนทับ.
type: docs
weight: 417
url: /th/aspose.slides.theme/ioverridethememanager/
---
## IOverrideThemeManager คลาส

ให้การเข้าถึงประเภทต่าง ๆ ของธีมที่ถูกเขียนทับ
...
| เมธอด | คำอธิบาย |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | ใช้รูปแบบสีเพิ่มเติมกับสไลด์หนึ่ง. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithememanager/createthemeeffective/)() | คืนค่าอ็อบเจ็กต์ธีม. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบจำนวนจริงแบบ C# ที่ NaN สองค่าได้รับการพิจารณาเท่ากันแม้ว่าตาม IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN ด้วย. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบจำนวนจริงแบบ C# ที่ NaN สองค่าได้รับการพิจารณาเท่ากันแม้ว่าตาม IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN ด้วย. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | เพื่อการใช้งานภายในเท่านั้น. |
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | กำหนดว่า [OverrideTheme](../overridetheme/) จะเขียนทับธีมที่สืบทอดได้หรือไม่ เพื่อเปิดใช้งาน [OverrideTheme](../overridetheme/) สำหรับการเขียนทับให้ใช้เมธอด OverrideTheme.Init*() เพื่อปิดการเขียนทับ [OverrideTheme](../overridetheme/) ให้ใช้เมธอด [get_OverrideTheme()](./get_overridetheme/)->Clear() อ่านอย่างเดียว **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() | คืนค่าอ็อบเจ็กต์ธีมที่เขียนทับ. อ่าน [IOverrideTheme](../ioverridetheme/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | เปรียบเทียบการอ้างอิงอ็อบเจ็กต์แบบค่า กับ nullptr. |
...
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) | คืนค่าอ็อบเจ็กต์ธีมที่เขียนทับ. เขียน [IOverrideTheme](../ioverridetheme/). |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | เพิ่มค่าตัวนับอ้างอิงที่ใช้ร่วมกัน. ไม่ควรเรียกโดยตรง; ควรใช้ smart pointers หรือ ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | ลดค่าตัวนับอ้างอิงที่ใช้ร่วมกันและคืนค่า. ไม่ควรเรียกโดยตรง; ควรใช้ smart pointers หรือ ThisProtector. |
