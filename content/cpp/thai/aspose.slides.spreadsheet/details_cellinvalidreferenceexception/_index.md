...
description: ข้อยกเว้นที่ถูกโยนเมื่อพบการอ้างอิงเซลที่ไม่ถูกต้อง.
type: docs
weight: 27
url: /th/aspose.slides.spreadsheet/details_cellinvalidreferenceexception/
---
## Details_CellInvalidReferenceException คลาส


ข้อยกเว้นที่ถูกโยนเมื่อพบการอ้างอิงเซลที่ไม่ถูกต้อง.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบจุดลอยแบบ C#-style ซึ่ง NaN สองค่าถือว่าเท่ากัน แม้ว่าตาม IEC 60559:1989 NaN ไม่เท่ากับค่าใดๆ รวมถึง NaN ด้วย |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบจุดลอยแบบ C#-style ซึ่ง NaN สองค่าถือว่าเท่ากัน แม้ว่าตาม IEC 60559:1989 NaN ไม่เท่ากับค่าใดๆ รวมถึง NaN ทั้งหาก |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | คืนค่าเต็ม 32 บิตที่เป็นโค้ด HRESULT ที่สัมพันธ์กับข้อยกเว้นที่แทนโดยอ็อบเจ็กต์ปัจจุบัน |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | คืนอ้างอิงถึงอ็อบเจ็กต์ที่แทนข้อยกเว้นภายใน |
| virtual [String](../../system/string/) [get_Message](../../system/details_exception/get_message/)() const | คืนสตริงที่มีรายละเอียดข้อผิดพลาด |
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | รับการอ้างอิงเซลที่ไม่ถูกต้อง |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | คล้ายเมธอด C# [Object.GetHashCode()](../../system/object/gethashcode/). เปิดใช้งานการสร้างแฮชของอ็อบเจ็กต์ที่กำหนดเอง |
