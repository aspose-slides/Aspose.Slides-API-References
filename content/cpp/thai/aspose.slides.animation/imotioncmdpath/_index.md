...
description: เป็นตัวแทนของคำสั่งหนึ่งในเส้นทาง
type: docs
weight: 274
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบค่าจุดลอยแบบ C# ที่สองค่า NaN ถือว่าเท่ากันแม้ตามมาตรฐาน IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN ด้วย |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบค่าจุดลอยแบบ C# ที่สองค่า NaN ถือว่าเท่ากันแม้ตามมาตรฐาน IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN ด้วย |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | ใช้เพื่อวัตถุประสงค์ภายในเท่านั้น |
| virtual [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() | ระบุประเภทคำสั่ง อ่าน [MotionCommandPathType](../motioncommandpathtype/) |
| virtual **bool** [get_IsRelative](./get_isrelative/)() | กำหนดว่าพิกัดคำสั่งเป็นสัมพัทธ์หรือไม่ อ่าน **bool** |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | ระบุจุดของคำสั่ง อ่าน [System::Drawing::PointF](../../system.drawing/pointf/)[] |
| virtual [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() | ระบุประเภทจุดของคำสั่ง อ่าน [MotionPathPointsType](../motionpathpointstype/) |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | คอนสตรัคเตอร์สำเนา. จริง ๆ แล้วไม่ได้คัดลอกอะไรเลย เพียงเริ่มต้นอ็อบเจกต์ใหม่และเปิดใช้งานการสร้างสำเนาของซับคลาส |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | ตัวดำเนินการมอบหมายค่า. จริง ๆ แล้วไม่ได้คัดลอกอะไรเลย เพียงเริ่มต้นอ็อบเจกต์ใหม่และเปิดใช้งานการสร้างสำเนาของซับคลาส |
...
| virtual void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) | ระบุประเภทคำสั่ง เขียน [MotionCommandPathType](../motioncommandpathtype/) |
| virtual void [set_IsRelative](./set_isrelative/)(**bool**) | กำหนดว่าพิกัดคำสั่งเป็นสัมพัทธ์หรือไม่ เขียน **bool** |
| virtual void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) | ระบุจุดของคำสั่ง เขียน [System::Drawing::PointF](../../system.drawing/pointf/)[] |
| virtual void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) | ระบุประเภทจุดของคำสั่ง เขียน [MotionPathPointsType](../motionpathpointstype/) |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | ตั้งค่าอาร์กิวเมนต์เท็มเพลตที่ n ให้เป็น weak pointer (แทนที่ shared). อนุญาตให้สลับพอยเตอร์ในคอนเทนเนอร์เป็นโหมด weak |
