...
| เมธอด | คำอธิบาย |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorEffect](../icoloreffect/)\> [CreateColorEffect](./createcoloreffect/)() override | สร้างเอฟเฟกต์สี. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommandEffect](../icommandeffect/)\> [CreateCommandEffect](./createcommandeffect/)() override | สร้างเอฟเฟกต์คำสั่ง. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFilterEffect](../ifiltereffect/)\> [CreateFilterEffect](./createfiltereffect/)() override | สร้างเอฟเฟกต์ตัวกรอง. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMotionEffect](../imotioneffect/)\> [CreateMotionEffect](./createmotioneffect/)() override | สร้างเอฟเฟกต์การเคลื่อนไหว. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPropertyEffect](../ipropertyeffect/)\> [CreatePropertyEffect](./createpropertyeffect/)() override | สร้างเอฟเฟกต์คุณสมบัติ. |
| [System::SharedPtr](../../system/sharedptr/)\<[IRotationEffect](../irotationeffect/)\> [CreateRotationEffect](./createrotationeffect/)() override | สร้างเอฟเฟกต์การหมุน. |
| [System::SharedPtr](../../system/sharedptr/)\<[IScaleEffect](../iscaleeffect/)\> [CreateScaleEffect](./createscaleeffect/)() override | สร้างเอฟเฟกต์การสเกล. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISetEffect](../iseteffect/)\> [CreateSetEffect](./createseteffect/)() override | สร้างเอฟเฟกต์การตั้งค่า. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบจุดลอยตามสไตล์ของ C# ซึ่งสองค่า NaN จะถือว่เท่ากัน แม้ว่าตามมาตรฐาน IEC 60559:1989 ค่า NaN จะไม่เท่ากับค่าหรือค่าใด ๆ รวมถึง NaN ด้วย. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบจุดลอยตามสไตล์ของ C# ซึ่งสองค่า NaN จะถือว่เท่ากัน แม้ว่าตามมาตรฐาน IEC 60559:1989 ค่า NaN จะไม่เท่ากับค่าหรือค่าใด ๆ รวมถึง NaN ด้วย. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | คอนสตรัคเตอร์คัดลอก. จริง ๆ แล้วไม่ได้คัดลอกอะไรเลย เพียงแต่เริ่มต้นอ็อบเจ็กต์ใหม่และเปิดใช้งานการคัดลอกคอนสตรัคเตอร์ของซับคลาส. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | ตัวดำเนินการกำหนดค่า. จริง ๆ แล้วไม่ได้คัดลอกอะไรเลย เพียงแต่เริ่มต้นอ็อบเจ็กต์ใหม่และเปิดใช้งานการคัดลอกคอนสตรัคเตอร์ของซับคลาส. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | ตั้งค่าเทมเพลตอาร์กิวเมนต์ที่ n ให้เป็น weak pointer (แทนที่จะแบ่งปัน). อนุญาตให้สลับพอยน์เตอร์ในคอนเทนเนอร์เป็นโหมด weak. |
| int [SharedCount](../../system/object/sharedcount/)() const | รับค่าปัจจุบันของตัวนับการอ้างอิงแบบแชร์. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | เพิ่มจำนวนการอ้างอิงแบบแชร์. ไม่ควรเรียกโดยตรง; ให้ใช้ smart pointer หรือ ThisProtector แทน. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | ลดจำนวนการอ้างอิงแบบแชร์และคืนค่า. ไม่ควรเรียกโดยตรง; ให้ใช้ smart pointer หรือ ThisProtector แทน. |
...
* คลาส [IBehaviorFactory](../ibehaviorfactory/)
