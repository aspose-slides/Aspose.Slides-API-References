...
description: "แสดงถึงคอลเลกชันของฟอนต์ที่ติดตั้งในระบบ. ยังไม่ได้ดำเนินการ. วัตถุของคลาสนี้ควรถูกจัดสรรโดยใช้ฟังก์ชัน System::MakeObject() เท่านั้น. อย่าสร้างอินสแตนซ์ของชนิดนี้บนสแตกหรือใช้ operator new เพราะจะทำให้เกิดข้อผิดพลาดรันไทม์และ/หรือข้อผิดพลาดการตรวจสอบ. ควรห่อหุ้มคลาสนี้ด้วยพอยน์เตอร์ System::SmartPtr และใช้พอยน์เตอร์นี้เพื่อส่งเป็นอาร์กิวเมนต์ให้กับฟังก์ชัน."
type: docs
weight: 14
url: /th/system.drawing.text/installedfontcollection/
---
## คลาส InstalledFontCollection
...
* คลาส [FontCollection](../fontcollection/)
* เนมสเปซ [System::Drawing::Text](../)
