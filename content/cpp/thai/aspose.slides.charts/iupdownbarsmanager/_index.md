...
description: ให้การเข้าถึงแถบขึ้น/ลงของกราฟเส้นหรือกราฟหุ้น
type: docs
weight: 1249
url: /th/aspose.slides.charts/iupdownbarsmanager/
---
## IUpDownBarsManager คลาส
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบจุดลอยสไตล์ C# ซึ่ง NaN สองค่าถูกพิจารณาเท่ากัน แม้ว่าตาม IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN ด้วย |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบจุดลอยสไตล์ C# ซึ่ง NaN สองค่าถูกพิจารณาเท่ากัน แม้ว่าตาม IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN ด้วย |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | สำหรับการใช้งานภายในเท่านั้น |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | ส่งกลับรูปแบบของแถบลง. อ่านอย่างเดียว [IFormat](../iformat/) |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | ส่งกลับความกว้างของช่องว่าง. อ่าน **int32_t** |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | กำหนดว่าตารางมีแถบขึ้น/ลงหรือไม่. อ่าน **bool** |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | ส่งกลับรูปแบบของแถบขึ้น. อ่านอย่างเดียว [IFormat](../iformat/) |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | การจำลองของ [Object::ReferenceEquals](../../system/object/referenceequals/) สำหรับกรณีของสตริงและ nullptr |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | การจำลองของ [Object::ReferenceEquals](../../system/object/referenceequals/) สำหรับกรณีของสตริง |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | ลดจำนวนการอ้างอิงที่แชร์ลงตามค่าที่ระบุ |
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | ตั้งค่าความกว้างช่องว่าง. เขียน **int32_t** |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | กำหนดว่าตารางมีแถบขึ้น/ลงหรือไม่. เขียน **bool** |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | ลดยอดการอ้างอิงที่แชร์และส่งค่ากลับ. ไม่ควรเรียกโดยตรง; ให้ใช้ smart pointers หรือ ThisProtector |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | ลดยอด weak reference. ไม่ควรเรียกโดยตรง; ให้ใช้ smart pointers หรือ ThisProtector |
