...
type: docs
weight: 2107
url: /th/system/operator_less_equal/
---
...
กำหนดว่าค่าที่ระบุเป็นค่าน้อยกว่าหรือเท่ากับค่าที่แสดงโดยอ็อบเจกต์ [Nullable](../nullable/) ที่ระบุโดยการใช้ [operator<=()](./) กับค่าทั้งสอง.
...
| T2 | ชนิดพื้นฐานของอ็อบเจกต์ [Nullable](../nullable/) ที่เป็นค่าที่เปรียบเทียบตัวที่สอง |
...
| other | const [Nullable](../nullable/)\<T2\>\& | การอ้างอิงคงที่ไปยังอ็อบเจกต์ [Nullable](../nullable/) ที่ค่าที่แสดงจะถูกใช้เป็นค่าที่เปรียบเทียบตัวที่สอง |

### ค่าที่คืน

true หากค่าที่เปรียบเทียบตัวแรกน้อยกว่าหรือเท่ากับค่าที่เปรียบเทียบตัวที่สอง, มิฉะนั้น - false
