...
description: ตัวจับเวลาที่เรียก delegate ในลูป.
type: docs
weight: 14
url: /th/system.timers/timer/
---
## คลาส Timer


[Timer](./) ที่เรียก delegate ในลูป.
...
| เมธอด | คำอธิบาย |
| --- | --- |
| void [Close](./close/)() | หยุดตัวจับเวลา, ปล่อยทรัพยากรที่จัดสรร. |
|  [Component](../../system.componentmodel/component/component/)() | ข้อมูล RTTI. |
| void [Dispose](./dispose/)() | หยุดตัวจับเวลา, ปล่อยทรัพยากรที่จัดสรร. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | จำลองการเปรียบเทียบตัวเลขลอย-point สไตล์ C# ที่ถือว่า NaN สองค่าเท่ากันแม้ว่าตาม IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN ด้วย. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | จำลองการเปรียบเทียบตัวเลขลอย-point สไตล์ C# ที่ถือว่า NaN สองค่าเท่ากันแม้ว่าตาม IEC 60559:1989 NaN ไม่เท่ากับค่าใด ๆ รวมถึง NaN ด้วย. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | เพื่อการใช้งานภายในเท่านั้น. |
| **bool** [get_AutoReset](./get_autoreset/)() const | ตรวจสอบว่าตัวจับเวลาอยู่ในโหมดรีเซ็ตอัตโนมัติหรือไม่. |
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | ตรวจสอบว่าองค์ประกอบอยู่ในโหมดออกแบบหรือไม่. |
| **bool** [get_Enabled](./get_enabled/)() const | ตรวจสอบว่าตัวจับกกำลังทำงานหรือไม่. |
| **double** [get_Interval](./get_interval/)() const | รับช่วงเวลาของตัวจับเวลา. |
| **bool** [get_IsStopped](./get_isstopped/)() const | ตรวจสอบว่าตัวจับเวลาถูกหยุดหรือไม่. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | คอนสตรัคเตอร์คัดลอก. จริง ๆ แล้วไม่คัดลอกอะไรเลย, เพียงแค่เริ่มต้นอ็อบเจ็กต์ใหม่และเปิดใช้งานการคัดลอกคอนสตรัคเตอร์ของซับคลาส. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | โอเปอเรเตอร์การกำหนดค่า. จริง ๆ แล้วไม่คัดลอกอะไรเลย, เพียงแค่เริ่มต้นอ็อบเจ็กต์ใหม่และเปิดใช้งานการคัดลอกคอนสตรัคเตอร์ของซับคลาส. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | รุ่นพิเศษของ [Object::ReferenceEquals](../../system/object/referenceequals/) สำหรับกรณีของสตริงและ nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | รุ่นพิเศษของ [Object::ReferenceEquals](../../system/object/referenceequals/) สำหรับกรณีของสตริงหลายตัว. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | ลดค่าตัวนับการอ้างอิงที่แชร์โดยค่าที่ระบุ. |
| void [set_AutoReset](./set_autoreset/)(**bool**) | ตั้งค่าตัวจับเวลาให้เป็นโหมดรีเซ็ตอัตโนมัติหรือออกจากโหมดนั้น. |
| void [set_Enabled](./set_enabled/)(**bool**) | เริ่มหรือหยุดตัวจับเวลา. การเริ่มตัวจับเวลาไม่รีเซ็ตการนับเวลาหากตัวจับเวลากำลังทำงานอยู่. |
| void [set_Interval](./set_interval/)(**double**) | ตั้งค่าช่วงเวลาของตัวจับเวลา. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | ลดค่าตัวนับการอ้างอิงที่แชร์และคืนค่า. ไม่ควรเรียกโดยตรง; แทนที่ใช้ smart pointers หรือ ThisProtector. |
| void [Start](./start/)() | เริ่มตัวจับเวลา. ไม่รีสตาร์ทการนับเวลาหากตัวจับเวลากำลังทำงานอยู่. |
| void [Stop](./stop/)() | หยุดตัวจับเวลา. |
|  [Timer](./timer/)() | ข้อมูล RTTI. |
|  [Timer](./timer/)(**double**) | สร้างตัวจับเวลาที่หยุดอยู่พร้อมช่วงเวลาที่ระบุ. |
