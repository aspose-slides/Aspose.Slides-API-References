...
description: พอยเตอร์พจนานุกรมที่เรียงลำดับพร้อมตัวดำเนินการเข้าถึง. ประเภทนี้เป็นพอยเตอร์เพื่อจัดการการลบของอ็อบเจ็กต์อื่น. ควรจัดสรรบนสแตกและส่งให้ฟังก์ชันโดยค่าหรือโดยการอ้างอิงแบบคอนสท์.
type: docs
weight: 534
url: /th/system.collections.generic/sorteddictionaryptr/
---
## SortedDictionaryPtr คลาส
...
|  [SortedDictionaryPtr](./sorteddictionaryptr/)(const [SharedPtr](../../system/sharedptr/)\<[SortedDictionary](../sorteddictionary/)\<T, V\>\>\&) | Constructs pointer to specified sorted dictionary. |
