...
description: Stellt ein Objekt dar, das die Low-Level-Arbeit des Einreihens von Aufgaben auf Threads übernimmt.
type: docs
weight: 79
url: /de/system.threading.tasks/taskscheduler/
---
## TaskScheduler Klasse

Stellt ein Objekt dar, das die Low-Level-Arbeit des Queuens von Aufgaben auf Threads übernimmt.
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | Erstellt ein [TaskScheduler](./) das dem aktuellen Thread zugeordnet ist. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | Gibt das [TaskScheduler](./) zurück, das dem aktuell ausgeführten Task zugeordnet ist. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | Gibt die standardmäßige [TaskScheduler](./)-Instanz zurück, die vom Framework bereitgestellt wird. |
| **int32_t** [get_Id](./get_id/)() const | Gibt die eindeutige ID für dieses [TaskScheduler](./) zurück. |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | Gibt das maximale Konkurrenzniveau an, das dieses [TaskScheduler](./) unterstützen kann. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog zur C#-[Object.ToString()](../../system/object/tostring/)-Methode. Aktiviert die Umwandlung benutzerdefinierter Objekte in Zeichenketten. |
