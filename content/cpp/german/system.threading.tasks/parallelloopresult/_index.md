...
description: Stellt den Abschlussstatus einer Parallelschleife bereit.
type: docs
weight: 14
url: /de/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult Klasse


Stellt den Abschlussstatus einer [Parallel](../parallel/) Schleife bereit.
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Ermittelt, ob die Schleife bis zum Abschluss ausgeführt wurde. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Ermittelt den niedrigsten Iterationsindex, an dem ein Abbruch auftrat. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Konstruiert ein [ParallelLoopResult](./). |
...
Stellt das Ergebnis einer Parallelloop-Operation dar, einschließlich ob sie abgeschlossen wurde und Informationen über Abbrüche. 
