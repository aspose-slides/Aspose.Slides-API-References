...
description: "Secure string, repräsentiert Text, der vertraulich zu behandeln ist. Diese Klasse VERSCHLÜSSELT die internen Daten NICHT. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 14
url: /de/system.security/securestring/
---
## SecureString Klasse


SecureString stellt einen Text dar, der vertraulich zu behandeln ist. Diese Klasse VERSCHLÜSSELN die internen Daten NICHT. Objekte dieser Klasse sollten nur mittels [System::MakeObject()](../../system/makeobject/)-Funktion zugewiesen werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Zeiger und verwenden Sie diesen Zeiger, um sie als Argument an Funktionen zu übergeben.
...
| --- | --- |
| void [AppendChar](./appendchar/)(char16_t) | Fügt ein Zeichen am Ende der Zeichenkette an. |
| void [Clear](./clear/)() | Löscht alle Zeichen aus dem aktuellen SecureString. |
| [SecureStringPtr](../securestringptr/) [Copy](./copy/)() const | Erstellt ein Duplikat dieses SecureString. |
| void [Dispose](./dispose/)() override | Gibt alle vom aktuellen Objekt genutzten Ressourcen frei. |
...
| **int32_t** [get_Length](./get_length/)() const | Ermittelt die Anzahl der Zeichen in diesem SecureString. |
...
| void [InsertAt](./insertat/)(**int32_t**, char16_t) | Fügt an dem angegebenen Index ein Zeichen ein. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Prüft, ob das Objekt eine Instanz des durch targetType beschriebenen Typs darstellt. Analog zum C#-Operator 'is'. |
| **bool** [IsReadOnly](./isreadonly/)() const | Ermittelt das Flag, das anzeigt, ob dieses Objekt schreibgeschützt ist. |
...
| void [MakeReadOnly](./makereadonly/)() | Macht diesen SecureString schreibgeschützt. |
...
| void [RemoveAt](./removeat/)(**int32_t**) | Entfernt das Zeichen an der angegebenen Position. |
...
| void [SetAt](./setat/)(**int32_t**, char16_t) | Ersetzt das bestehende Zeichen an der angegebenen Position. |
...
| [String](../../system/string/) [ToUnsecureString](./tounsecurestring/)() const | Kopiert den Inhalt dieses SecureString in ein unsicheres [String](../../system/string/)-Objekt. Mit Vorsicht verwenden. |
