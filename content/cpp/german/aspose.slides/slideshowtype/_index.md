...
description: "Grundlegende Diashow-Einstellungen. Vorgänger repräsentieren Typen der Diashow: PresentedBySpeaker Präsentiert von einem Redner (Vollbild) BrowsedByIndividual Durchsucht von einer Einzelperson (Fenster) BrowsedAtKiosk Durchsucht an einem Kiosk (Vollbild)"
type: docs
weight: 5227
...
Grundlegende Diashow-Einstellungen. Die Vorgänger repräsentieren Typen der Diashow: [PresentedBySpeaker](../presentedbyspeaker/) Vom Redner präsentiert (Vollbild) [BrowsedByIndividual](../browsedbyindividual/) Von einer Einzelperson angesehen (Fenster) [BrowsedAtKiosk](../browsedatkiosk/) An einem Kiosk angesehen (Vollbild)
