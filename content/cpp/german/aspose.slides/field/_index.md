...
| [System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\> [get_Type](./get_type/)() override | Gibt den Typ des Feldes zurück. Lesen Sie [IFieldType](../ifieldtype/). |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren der C#-Anweisung lock(). Aufrufen direkt oder mithilfe des [LockContext](../../system/lockcontext/)-Wächterobjekts. |
...
| void [set_Type](./set_type/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) override | Setzt den Typ des Feldes. Schreiben Sie [IFieldType](../ifieldtype/). |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Setzt das n-te Template-Argument zu einem schwachen Zeiger (statt eines geteilten). Ermöglicht das Umstellen von Zeigern in Containern in den Weak-Modus. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren der C#-Anweisung lock(). Aufrufen direkt oder mithilfe des [LockContext](../../system/lockcontext/)-Wächterobjekts. |
