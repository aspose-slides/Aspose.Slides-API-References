...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Gibt den Ausrichtungsstil eines Tabulators zurück. Nur-Lesen [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Gibt die Position eines Tabulators zurück. Das Zuweisen dieser Eigenschaft kann den Index des Tabulators in der Sammlung ändern und den Enumerator ungültig machen. Nur-Lesen **double**. |
