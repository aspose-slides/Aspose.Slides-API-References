...
description: Repräsentiert Kamera.
type: docs
weight: 1587
...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) Typ Lesen [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 Grad, Sichtfeld) Lese **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) Zoom (positiver Wert in Prozent) Lese **float**. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Eine Rotation wird über die Verwendung einer Breitengradkoordinate, einer Längengradkoordinate und einer Drehung um die Achse definiert, wobei die Breitengrad- und Längengradkoordinaten verwendet werden. Erstes Element im Rückgabearray – Breitengrad, zweites – Längengrad, drittes – Drehung. Gibt null zurück, wenn keine Rotation definiert ist. |
...
| virtual void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) | [Camera](../camera/) Typ Schreiben [CameraPresetType](../camerapresettype/). |
| virtual void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) | [Camera](../camera/) FOV (0-180 Grad, Sichtfeld) Schreiben **float**. |
| virtual void [set_Zoom](./set_zoom/)(**float**) | [Camera](../camera/) Zoom (positiver Wert in Prozent) Schreiben **float**. |
| virtual void [SetRotation](./setrotation/)(**float**, **float**, **float**) | Eine Rotation wird über die Verwendung einer Breitengradkoordinate, einer Längengradkoordinate und einer Drehung um die Achse definiert, wobei die Breitengrad- und Längengradkoordinaten verwendet werden. Wenn irgendein Koordinatenwert std::numeric_limits<float>::quiet_NaN() ist, ist die gesamte Rotation undefiniert. |
