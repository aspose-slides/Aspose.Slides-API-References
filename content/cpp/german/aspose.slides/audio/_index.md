...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Liefert eine Kopie der Audiodaten. Bei großen Datenmengen sollte die Methode [Audio::GetStream](./getstream/) verwendet werden, um das unnötige Laden der Audiodaten in den Speicher oder sogar eine OutOfMemoryException zu verhindern. Nur-Lese **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Liefert den MIME-Typ eines Audios, kodiert in [Audio::get_BinaryData](./get_binarydata/). Nur-Lese [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | Liefert einen Stream zum Lesen. Verwenden Sie 'using' oder schließen Sie den Stream nach der Verwendung. |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren der C#-lock()-Anweisung. Direkt aufrufen oder das Sentinelen-Objekt [LockContext](../../system/lockcontext/) verwenden. |
...
| void [set_ContentType](./set_contenttype/)([System::String](../../system/string/)) | Liefert den MIME-Typ eines Audios, kodiert in [Audio::get_BinaryData](./get_binarydata/). Nur-Lese [System::String](../../system/string/). |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Setzt das n-te Template-Argument zu einem Weak-Pointer (statt Shared). Ermöglicht das Umstellen von Zeigern in Containern auf den Weak-Modus. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren der C#-lock()-Anweisung. Direkt aufrufen oder das Sentinelen-Objekt [LockContext](../../system/lockcontext/) verwenden. |
