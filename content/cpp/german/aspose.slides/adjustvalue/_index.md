...
| **float** [get_AngleValue](./get_anglevalue/)() override | Gibt den Wert zurück, interpretiert als Winkel in Grad. Lese **float**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Gibt den Namen dieses Anpassungswertes zurück. Nur-Lesen [System::String](../../system/string/). |
| **int64_t** [get_RawValue](./get_rawvalue/)() override | Gibt den Anpassungswert "wie er ist" zurück. Lese **int64_t**. |
| [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() override | Gibt den Typ der Formanpassung zurück. Nur-Lesen [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| void [set_AngleValue](./set_anglevalue/)(**float**) override | Setzt den Wert, interpretiert als Winkel in Grad. Schreibe **float**. |
| void [set_RawValue](./set_rawvalue/)(**int64_t**) override | Setzt den Anpassungswert "wie er ist". Schreibe **int64_t**. |
