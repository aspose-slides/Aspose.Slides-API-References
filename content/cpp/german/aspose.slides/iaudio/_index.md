...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Gibt eine Kopie der Audiodaten zurück. Bei großen Datenmengen sollte die Methode [IAudio::GetStream](./getstream/) verwendet werden, um das unnötige Laden der Audiodaten in den Speicher oder sogar eine OutOfMemoryException zu vermeiden. Nur lesbares **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Gibt den MIME-Typ eines Audios zurück, kodiert in [IAudio::get_BinaryData](./get_binarydata/). Nur lesbar [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | Gibt einen Stream zum Lesen zurück. Verwenden Sie 'using' oder schließen Sie den Stream nach der Verwendung. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verringert den shared reference count um den angegebenen Wert. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Ermittelt den aktuellen Wert des shared reference counters. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Erhöht den shared reference count. Sollte nicht direkt aufgerufen werden; stattdessen smart pointers oder ThisProtector verwenden. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Verringert und gibt den shared reference count zurück. Sollte nicht direkt aufgerufen werden; stattdessen smart pointers oder ThisProtector verwenden. |
