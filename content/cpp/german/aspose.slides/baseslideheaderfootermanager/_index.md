...
description: Stellt einen Manager dar, der das Verhalten von Fußzeilen-, Datum-Zeit- und Seitenzahl-Platzhaltern für alle Folientypen verwaltet.
type: docs
weight: 183
...
Stellt einen Manager dar, der das Verhalten von Fußzeilen-, Datums-Zeit- und Seitenzahlen-Platzhaltern für alle Folientypen verwaltet.
...
| **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() override | Gibt den Wert zurück, der anzeigt, dass ein Datums-Zeit-Platzhalter vorhanden ist. Read**bool**. |
| **bool** [get_IsFooterVisible](./get_isfootervisible/)() override | Gibt den Wert zurück, der anzeigt, dass ein Fußzeilen-Platzhalter vorhanden ist. Read **bool**. |
| **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() override | Gibt den Wert zurück, der anzeigt, dass ein Seitenzahlen-Platzhalter vorhanden ist. Read**bool**. |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren des C# lock()-Statements. Direkter Aufruf oder Verwendung des [LockContext](../../system/lockcontext/)-Wächter-Objekts. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog zur C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-Methode. Ermöglicht das Klonen benutzerdefinierter Typen. |
|  [Object](../../system/object/object/)() | Erstelle Objekt. Initialisiert alle internen Datenstrukturen. |
...
| void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) override | Setzt den Text des Datums-Zeit-Platzhalters der Folie. |
| void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) override | Ändert die Sichtbarkeit des Datums-Zeit-Platzhalters der Folie. |
| void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) override | Setzt den Text des Fußzeilen-Platzhalters der Folie. |
| void [SetFooterVisibility](./setfootervisibility/)(**bool**) override | Ändert die Sichtbarkeit des Fußzeilen-Platzhalters der Folie. |
| void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) override | Ändert die Sichtbarkeit des Seitenzahlen-Platzhalters der Folie. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren des C# lock()-Statements. Direkter Aufruf oder Verwendung des [LockContext](../../system/lockcontext/)-Wächter-Objekts. |
