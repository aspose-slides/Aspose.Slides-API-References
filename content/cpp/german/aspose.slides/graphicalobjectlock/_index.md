...
Bestimmt, welche Vorgänge beim übergeordneten [GraphicalObject](../graphicalobject/) deaktiviert sind.
...
| **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() override | Bestimmt, ob die Form beim Größenwechsel das Seitenverhältnis beibehalten muss. Lese **bool**. |
| **bool** [get_DrilldownLocked](./get_drilldownlocked/)() override | Bestimmt, ob die Auswahl von Unterformen dieses Objekts verboten ist. Lese **bool**. |
...
| **bool** [get_SelectLocked](./get_selectlocked/)() override | Bestimmt, ob die Auswahl dieser Form verboten ist. Lese **bool**. |
...
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | Bestimmt, ob die Form beim Größenwechsel das Seitenverhältnis beibehalten muss. Schreibe **bool**. |
| void [set_DrilldownLocked](./set_drilldownlocked/)(**bool**) override | Bestimmt, ob die Auswahl von Unterformen dieses Objekts verboten ist. Schreibe **bool**. |
...
| void [set_SelectLocked](./set_selectlocked/)(**bool**) override | Bestimmt, ob die Auswahl dieser Form verboten ist. Schreibe **bool**. |
