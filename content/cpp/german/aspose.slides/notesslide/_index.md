...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[Theme::IThemeEffectiveData](../../aspose.slides.theme/ithemeeffectivedata/)\> [CreateThemeEffective](../baseslide/createthemeeffective/)() override | Gibt ein effektives Design für diese Folie zurück. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IControlCollection](../icontrolcollection/)\> [get_Controls](../baseslide/get_controls/)() override | Gibt die Sammlung der ActiveX-Steuerungen auf einer Folie zurück. Nur-Lese [IControlCollection](../icontrolcollection/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | Gibt den HeaderFooter-Manager der Notizfolie zurück. Nur-Lese [INotesSlideHeaderFooterManager](../inotesslideheaderfootermanager/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../itextframe/)\> [get_NotesTextFrame](./get_notestextframe/)() override | Gibt ein [TextFrame](../textframe/) mit dem Text der Notizen zurück, falls vorhanden. Nur-Lese [ITextFrame](../itextframe/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_ParentSlide](./get_parentslide/)() override | Gibt die übergeordnete Folie zurück. Nur-Lese [ISlide](../islide/). |
...
| **bool** [get_ShowMasterShapes](./get_showmastershapes/)() override | Gibt an, ob Formen auf der Masterfolie auf den Folien angezeigt werden sollen oder nicht. Nur-Lese **bool**. |
...
| void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)() override | Führt Läufe mit derselben Formatierung in allen Absätzen aller akzeptablen Formen zusammen. |
| virtual void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeCollection](../ishapecollection/)\>) | Führt Läufe mit derselben Formatierung in allen Absätzen aller akzeptablen Formen zusammen. |
...
| void [set_Name](../baseslide/set_name/)([System::String](../../system/string/)) override | Setzt den Namen einer Folie. Schreib [System::String](../../system/string/). |
| void [set_ShowMasterShapes](./set_showmastershapes/)(**bool**) override | Gibt an, ob Formen auf der Masterfolie auf den Folien angezeigt werden sollen oder nicht. Schreib **bool**. |
