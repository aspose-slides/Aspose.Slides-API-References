...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Gibt ein Tabellenfüll-Eigenschaftsobjekt zurück. Schreibgeschützt [IFillFormat](../ifillformat/). |
| virtual **float** [get_Transparency](./get_transparency/)() | Liefert die Transparenz der Füllfarbe. Lese **float**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() | Liefert die effektiven Tabellenformatierungseigenschaften mit vererbten und angewandten Tabellenstilen. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierkonstruktor. Kopiert tatsächlich nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopieren von Konstruktoren in Unterklassen. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Zuweisungsoperator. Kopiert tatsächlich nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopieren von Konstruktoren in Unterklassen. |
...
| virtual void [set_Transparency](./set_transparency/)(**float**) | Setzt die Transparenz der Füllfarbe. Schreibe **float**. |
