...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [Add](./add/)([System::String](../../system/string/), [System::Guid](../../system/guid/), **bool**, [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) override | Fügt die Sensitivitätsbezeichnung am Ende der Sammlung hinzu. |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>) override | Fügt ein [SensitivityLabel](../sensitivitylabel/) zur Sammlung hinzu. |
| [iterator](./iterator/) [begin](./begin/)() | Ruft einen Iterator ab, der auf das erste Element (falls vorhanden) der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Ruft einen Iterator ab, der auf das erste Element (falls vorhanden) der konstanten Instanz der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Ruft einen Iterator ab, der auf das erste konstante Element (falls vorhanden) der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Ruft einen Iterator ab, der direkt nach dem letzten konstanten Element (falls vorhanden) der Sammlung liegt. |
| void [Clear](./clear/)() override | Entfernt alle Elemente aus der Sammlung. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>\>, **int32_t**) | Kopiert alle Elemente der Sammlung in das angegebene Array. |
| [iterator](./iterator/) [end](./end/)() | Ruft einen Iterator ab, der direkt nach dem letzten Element (falls vorhanden) der Sammlung liegt. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Ruft einen Iterator ab, der direkt nach dem letzten Element (falls vorhanden) der konstanten Instanz der Sammlung liegt. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der durch die Sammlung iteriert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [idx_get](./idx_get/)(**int32_t**) override | Gibt die Sensitivitätsbezeichnung nach Index zurück. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Entfernt die Sensitivitätsbezeichnung am angegebenen Index. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verringert den gemeinsamen Referenzzähler um den angegebenen Wert. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Setzt das n-te Template-Argument auf einen schwachen Zeiger (statt gemeinsam). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Ruft einen Iterator ab, der auf das erste Element (falls vorhanden) der konstanten Instanz der Sammlung zeigt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Ruft einen Iterator ab, der auf das erste Element (falls vorhanden) der Sammlung zeigt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Ruft einen Iterator ab, der direkt nach dem letzten Element (falls vorhanden) der konstanten Instanz der Sammlung liegt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Ruft einen Iterator ab, der direkt nach dem letzten Element (falls vorhanden) der Sammlung liegt. |
