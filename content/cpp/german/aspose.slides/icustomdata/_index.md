...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) | Gibt das benutzerdefinierte XML-Teil am angegebenen Index zurück. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() | Gibt die Sammlung benutzerdefinierter XML-Teile zurück. Nur lesbar [ICustomXmlPartCollection](../icustomxmlpartcollection/). |
| virtual [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) | Gibt das Customer Data Tag am angegebenen Index zurück. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() | Gibt die Sammlung der Customer Data Tags zurück. Nur lesbar [ITagCollection](../itagcollection/). |
...
| virtual void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) | Setzt das Customer Data Tag am angegebenen Index. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument zu einem Weak-Pointer (statt eines Shared-Pointer). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Verringert und gibt die gemeinsame Referenzzahl zurück. Sollte nicht direkt aufgerufen werden; stattdessen Smart-Pointer oder ThisProtector verwenden. |
