...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Fügt eine Kopie einer angegebenen Masterfolie am Ende der Sammlung hinzu. Verknüpfte Layoutfolien werden ebenfalls kopiert. |
| [iterator](./iterator/) [begin](./begin/)() | Gibt einen Iterator zurück, der auf das erste Element (sofern vorhanden) der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Gibt einen Iterator zurück, der auf das erste Element (sofern vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Gibt einen Iterator zurück, der auf das erste const-qualifizierte Element (sofern vorhanden) der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Gibt einen Iterator zurück, der unmittelbar nach dem letzten const-qualifizierten Element (sofern vorhanden) der Sammlung zeigt. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>, **int32_t**) override | Kopiert alle Elemente der Sammlung in das angegebene Array. |
...
| [iterator](./iterator/) [end](./end/)() | Gibt einen Iterator zurück, der unmittelbar nach dem letzten Element (sofern vorhanden) der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Gibt einen Iterator zurück, der unmittelbar nach dem letzten Element (sofern vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der die Sammlung durchläuft. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [idx_get](./idx_get/)(**int32_t**) override | Gibt das Element am angegebenen Index zurück. Nur lesbar [MasterSlide](../masterslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Fügt eine Kopie einer angegebenen Masterfolie an der angegebenen Position in die Sammlung ein. Verknüpfte Layoutfolien werden ebenfalls kopiert. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Entfernt das erste Vorkommen eines bestimmten Objekts aus der Sammlung. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Entfernt das Element am angegebenen Index der Sammlung. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verringert den gemeinsamen Referenzzähler um den angegebenen Wert. |
| void [RemoveUnused](./removeunused/)(**bool**) override | Entfernt ungenutzte Masterfolien. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Gibt einen Iterator zurück, der auf das erste Element (sofern vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Gibt einen Iterator zurück, der auf das erste Element (sofern vorhanden) der Sammlung zeigt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Gibt einen Iterator zurück, der unmittelbar nach dem letzten Element (sofern vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Gibt einen Iterator zurück, der unmittelbar nach dem letzten Element (sofern vorhanden) der Sammlung zeigt. |
