...
description: Bestimmt, welche Vorgänge im übergeordneten GraphicalObjectEx deaktiviert sind.
type: docs
weight: 2471
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-ähnlichen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert gleich ist, einschließlich NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-ähnlichen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert gleich ist, einschließlich NaN. |
...
| virtual **bool** [get_DrilldownLocked](./get_drilldownlocked/)() | Bestimmt, ob das Auswählen von Unterschichten dieses Objekts verboten ist. Lesen **bool**. |
...
| virtual **bool** [get_NoLocks](../ibaseshapelock/get_nolocks/)() | Gibt true zurück, wenn alle Sperrflaggen deaktiviert sind. Nur-Lese **bool**. |
...
| virtual void [set_DrilldownLocked](./set_drilldownlocked/)(**bool**) | Bestimmt, ob das Auswählen von Unterschichten dieses Objekts verboten ist. Schreiben **bool**. |
