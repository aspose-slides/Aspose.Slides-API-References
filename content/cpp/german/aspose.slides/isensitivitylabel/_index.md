...
| virtual [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() | Gibt die Zuweisungsmethode für das Sensitivitätslabel zurück. Lesen Sie [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() | Gibt die Liste der Typen von Inhaltskennzeichnungen zurück, die auf eine Datei angewendet werden sollten. |
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | Gibt die ID des Sensitivitätslabels zurück. Lesen Sie [System::String](../../system/string/). |
| virtual **bool** [get_IsEnabled](./get_isenabled/)() | Gibt an, ob das Sensitivitätslabel aktiviert ist. |
| virtual **bool** [get_IsRemoved](./get_isremoved/)() | Gibt an, ob das Sensitivitätslabel entfernt wurde. |
| virtual [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() | Gibt die Azure Active Directory (Azure AD)-Site-ID zurück, die der Richtlinie des Sensitivitätslabels entspricht, welche das Sensitivitätslabel beschreibt. Lesen Sie [System::Guid](../../system/guid/). |
...
| virtual void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | Setzt die Zuweisungsmethode für das Sensitivitätslabel. Schreiben Sie [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | Setzt die ID des Sensitivitätslabels. Schreiben Sie [System::String](../../system/string/). |
| virtual void [set_IsEnabled](./set_isenabled/)(**bool**) | Gibt an, ob das Sensitivitätslabel aktiviert ist. |
| virtual void [set_IsRemoved](./set_isremoved/)(**bool**) | Gibt an, ob das Sensitivitätslabel entfernt wurde. |
| virtual void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) | Setzt die Azure Active Directory (Azure AD)-Site-ID, die der Richtlinie des Sensitivitätslabels entspricht, welche das Sensitivitätslabel beschreibt. Schreiben Sie [System::Guid](../../system/guid/). |
