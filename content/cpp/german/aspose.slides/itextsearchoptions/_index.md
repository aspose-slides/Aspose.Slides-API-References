...
description: Stellt Optionen bereit, die zum Durchsuchen von Text in einer Presentation, Slide oder TextFrame verwendet werden können.
type: docs
weight: 4122
...
Stellt Optionen bereit, die zum Durchsuchen von Text in einem [Presentation](../presentation/), [Slide](../slide/) oder [TextFrame](../textframe/) verwendet werden können.
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Setze true, um eine groß-/kleinschreibungssensible Suche zu verwenden, sonst false. Lesen **bool**. |
| virtual **bool** [get_IncludeNotes](./get_includenotes/)() | Setze **true**, um Text, der in Foliennotizen enthalten ist, bei Textsuche, Ersetzung oder Hervorhebungs-Operationen einzubeziehen. Der Standardwert ist **false**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Setze true, um nur ganze Wörter zu matchen, sonst false. Lesen **bool**. |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren des C# lock()-Statements. Direkt aufrufen oder das [LockContext](../../system/lockcontext/)-Wächterobjekt nutzen. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Setze true, um eine groß-/kleinschreibungssensible Suche zu verwenden, sonst false. Schreiben **bool**. |
| virtual void [set_IncludeNotes](./set_includenotes/)(**bool**) | Setze **true**, um Text, der in Foliennotizen enthalten ist, bei Textsuche, Ersetzung oder Hervorhebungs-Operationen einzubeziehen. Der Standardwert ist **false**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Setze true, um nur ganze Wörter zu matchen, sonst false. Schreiben **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setze das n'te Template-Argument auf einen schwachen Zeiger (statt Shared). Ermöglicht das Umschalten von Zeigern in Containern auf den schwachen Modus. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren des C# lock()-Statements. Direkt aufrufen oder das [LockContext](../../system/lockcontext/)-Wächterobjekt nutzen. |
