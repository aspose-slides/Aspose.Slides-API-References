...
description: Enthält die Eigenschaften des Hauptflächenreliefs einer Form.
type: docs
weight: 5097
...
Enthält die Eigenschaften des Hauptflächenreliefs einer Form.
...
| [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() override | Fasenart. Lesen [BevelPresetType](../bevelpresettype/). |
| **double** [get_Height](./get_height/)() override | Fasenhöhe. Lesen **double**. |
...
| **double** [get_Width](./get_width/)() override | Fasenbreite. Lesen **double**. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Erhält den tatsächlichen Typ des Objekts. Analogie zum C#-Aufruf [System.Object.GetType()](../../system/object/gettype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierkonstruktor. Kopiert eigentlich nichts, sondern initialisiert lediglich ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
...
| void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) override | Fasenart. Schreiben [BevelPresetType](../bevelpresettype/). |
| void [set_Height](./set_height/)(**double**) override | Fasenhöhe. Schreiben **double**. |
| void [set_Width](./set_width/)(**double**) override | Fasenbreite. Schreiben **double**. |
...
* Klasse [IShapeBevel](../ishapebevel/)
