...
description: Stellt den Manager dar, der das Verhalten der Platzhalter für Notizfolien verwaltet, einschließlich des Kopfzeilen-Platzhalters.
type: docs
weight: 4577
...
Stellt den Manager dar, der das Verhalten der Platzhalter für Notizfolien verwaltet, einschließlich des Kopfzeilen-Platzhalters.
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Liest den Wert, der anzeigt, dass ein Datums-Uhrzeit-Platzhalter vorhanden ist. Read**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | Liest den Wert, der anzeigt, dass ein Fußzeilen-Platzhalter vorhanden ist. Read **bool**. |
| **bool** [get_IsHeaderVisible](../basehandoutnotesslideheaderfootermanager/get_isheadervisible/)() override | Liest den Wert, der anzeigt, dass ein Kopfzeilen-Platzhalter vorhanden ist. Read **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Liest den Wert, der anzeigt, dass ein Seitenzahl-Platzhalter vorhanden ist. Read**bool**. |
...
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | Setzt den Text des Datums-Uhrzeit-Platzhalters der Folie. |
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | Ändert die Sichtbarkeit des Datums-Uhrzeit-Platzhalters der Folie. |
| void [SetFooterText](../baseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) override | Setzt den Text des Fußzeilen-Platzhalters der Folie. |
...
| void [SetHeaderText](../basehandoutnotesslideheaderfootermanager/setheadertext/)([System::String](../../system/string/)) override | Setzt den Text des Kopfzeilen-Platzhalters der Folie. |
