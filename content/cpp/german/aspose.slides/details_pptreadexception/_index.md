...
type: docs
weight: 690
url: /de/aspose.slides/details_pptreadexception/
---
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Setzt den HRESULT, einen kodierten numerischen Wert, der einer bestimmten Ausnahme zugewiesen wird. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die Methode [what()](../../system/details_exception/what/), die von der Klasse [ExceptionWrapper](../../system/exceptionwrapper/) aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/ private Mitglieder nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenumsetzung in den [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik zerstören. |
