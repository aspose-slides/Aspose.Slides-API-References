...
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() override | Gibt das eingebettete Bild zurück. Lesen [IPPImage](../ippimage/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/)\> [get_ImageTransform](./get_imagetransform/)() override | Gibt die Sammlung von Bildtransformations-Effekten zurück. Nur-Lesen [IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperation](../../aspose.slides.effects/iimagetransformoperation/)\> [get_ImageTransformOperation](./get_imagetransformoperation/)(**int32_t**) override | Gibt die Bildtransformationsoperation am angegebenen Index zurück. |
| [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() override | Gibt die verknüpfte Bild-URL zurück oder setzt sie. Lesen [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](./get_presentation/)() override | Gibt die Präsentation zurück. Nur-Lesen [IPresentation](../ipresentation/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](./get_slide/)() override | Gibt die übergeordnete Folie eines Bildes zurück. Nur-Lesen [IBaseSlide](../ibaseslide/). |
| virtual ASPOSE_SLIDES_LOCAL_API **uint32_t** [get_Version](../ipviobject/get_version/)() | Version. Nur-Lesen **uint32_t**. |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Gibt den Hash zurück. |
...
| void [set_Image](./set_image/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) override | Setzt das eingebettete Bild. Schreiben [IPPImage](../ippimage/). |
| void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) override | Gibt die verknüpfte Bild-URL zurück oder setzt sie. Schreiben [System::String](../../system/string/). |
...
* Klasse [ISlidesPicture](../islidespicture/)
