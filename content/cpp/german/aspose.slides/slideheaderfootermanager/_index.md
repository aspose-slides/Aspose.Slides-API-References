...
description: Repräsentiert den Manager, der das Verhalten der Folienfußzeile, des Datums-Zeit-Platzhalters und des Seitenzahl-Platzhalters verwaltet.
type: docs
weight: 5201
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Liefert den Wert, der angibt, dass ein Datums-Zeit-Platzhalter vorhanden ist. Read**bool**. |
...
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Liefert den Wert, der angibt, dass ein Seitenzahl-Platzhalter vorhanden ist. Read**bool**. |
...
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | Setzt den Text im Datums-Zeit-Platzhalter der Folie. |
...
| void [SetFooterText](../baseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) override | Setzt den Text im Fußzeilen-Platzhalter der Folie. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen schwachen Zeiger (statt auf einen geteilten). Ermöglicht das Umschalten von Zeigern in Containern in den schwachen Modus. |
