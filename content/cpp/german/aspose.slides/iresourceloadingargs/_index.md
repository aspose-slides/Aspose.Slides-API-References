...
description: Schnittstelle für externe Ressourcieladeargumente.
type: docs
weight: 3485
...
Schnittstelle für externe Ressourcieladeargumente.
...
| virtual [System::String](../../system/string/) [get_OriginalUri](./get_originaluri/)() | Ursprüngliche URI der Ressource, wie in der importierten Präsentation angegeben. |
| virtual [System::String](../../system/string/) [get_Uri](./get_uri/)() | URI der Ressource, die für das Herunterladen verwendet wird, falls [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) [ResourceLoadingAction::Default](../resourceloadingaction/) zurückgibt. Anfangs ist sie auf die ursprüngliche URI der Ressource gesetzt, kann aber auf jeden Wert neu definiert werden. |
...
| virtual void [set_Uri](./set_uri/)([System::String](../../system/string/)) | URI der Ressource, die für das Herunterladen verwendet wird, falls [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) [ResourceLoadingAction::Default](../resourceloadingaction/) zurückgibt. Anfangs ist sie auf die ursprüngliche URI der Ressource gesetzt, kann aber auf jeden Wert neu definiert werden. |
| virtual void [SetData](./setdata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Setzt vom Benutzer bereitgestellte Daten der Ressource, die verwendet werden, falls [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) [ResourceLoadingAction::UserProvided](../resourceloadingaction/) zurückgibt. |
