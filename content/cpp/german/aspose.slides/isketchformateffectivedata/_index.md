...
description: Unveränderliches Objekt, das wirksame Linien-Skizzen-Eigenschaften enthält.
type: docs
weight: 3745
...
Unveränderliches Objekt, das wirksame Linien-Skizzen-Eigenschaften enthält.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-artigen Gleitkomma-Vergleich, bei dem zwei NaNs als gleich angesehen werden, obwohl NaN laut IEC 60559:1989 keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Gleitkomma-Vergleich, bei dem zwei NaNs als gleich angesehen werden, obwohl NaN laut IEC 60559:1989 keinem Wert, einschließlich NaN, gleich ist. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | Gibt den Skizzentyp zurück. Nur lesbar [Slides::LineSketchType](../linesketchtype/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Vergleicht Referenz-weise einen Werttyp-Objekt mit nullptr. |
...
Dieses Interface wird als Teil von [ILineFormatEffectiveData](../ilineformateffectivedata/) verwendet.
