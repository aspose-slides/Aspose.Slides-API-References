...
description: Stellt einen standardmäßigen internen Ausnahmetyp dar, der mit dem Office Open XML-Dateiformat zusammenhängt.
type: docs
weight: 638
url: /de/aspose.slides/details_ooxmlexception/
---
## Details_OOXMLException Klasse


Stellt einen standardmäßigen internen Ausnahmetyp dar, der mit dem Office Open XML-Dateiformat zusammenhängt.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierkonstruktor. Kopiert eigentlich nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopieren von Subklassen. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die Methode [what()](../../system/details_exception/what/), die von der Klasse [ExceptionWrapper](../../system/exceptionwrapper/) aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception abgeleitet ist, können abgeleitete Klassen geschützte/ private Mitglieder nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenumsetzung in das [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik brechen. |
