...
description: Gibt die Textausrichtung in einem Absatz ohne Vererbung zurück. Lesen Sie TextAlignment.
type: docs
weight: 1
url: /de/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() Methode

Gibt die Textausrichtung in einem Absatz ohne Vererbung zurück. Siehe [TextAlignment](../../textalignment/).
...
Der folgende Beispielcode zeigt, wie man Textabsätze in PowerPoint [Presentation](../../presentation/) ausrichtet.
```cpp
...
* Aufzählung [TextAlignment](../../textalignment/)
