...
description: Stellt ein Farbverlauf-Format dar.
type: docs
weight: 2406
url: /de/aspose.slides/igradientstop/
---
## IGradientStop Klasse

Stellt ein Farbverlauf-Format dar.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | Gibt die Farbe eines Farbverlaufsstopps zurück. Nur-Lese [IColorFormat](../icolorformat/). |
| virtual **float** [get_Position](./get_position/)() | Gibt die Position (0..1) eines Farbverlaufsstopps zurück. Liest **float**. |
...
| virtual void [set_Position](./set_position/)(**float**) | Setzt die Position (0..1) eines Farbverlaufsstopps. Schreibt **float**. |
