...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Gibt die Farbe eines Gradient-Stops zurück. Nur-Lesen [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Gibt die Position (0..1) eines Gradient-Stops zurück. Liest **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Setzt die Position (0..1) eines Gradient-Stops. Schreibt **float**. |
...
* Klasse [IGradientStop](../igradientstop/)
