...
description: Stellt eine Sammlung von Farbumwandlungsoperationen dar.
type: docs
weight: 1717
...
Stellt eine Sammlung von Farbumwandlungsoperationen dar.
...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) | Fügt der Sammlung am Ende eine neue Operation hinzu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) | Fügt der Sammlung am Ende eine neue Operation hinzu. |
...
| virtual void [Clear](./clear/)() | Entfernt alle Farboperationen. |
...
| virtual T [CloneT](../igenericcloneable/clonet/)() | Erstellt ein neues Objekt, das eine Kopie der aktuellen Instanz ist. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Liefert einen Iterator, der direkt nach dem letzten Element (falls vorhanden) der Sammlung zeigt. Dieser Iterator kann nicht verwendet werden, um das referenzierte Objekt zu ändern, weil [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) ein Kopie-Objekt von T zurückgibt. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | Gibt ein Synchronisations-Root zurück. Nur lesend [System::Object](../../system/object/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) | Gibt die Operation am angegebenen Index zurück. Nur lesend [IColorOperation](../icoloroperation/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) | Setzt die Operation am angegebenen Index. Schreibend [IColorOperation](../icoloroperation/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) | Fügt eine neue Operation zu einer Sammlung hinzu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) | Fügt eine neue Operation zu einer Sammlung hinzu. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Entfernt die Farboperation aus einer Sammlung. |
