...
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [get_DefaultParagraphFormat](./get_defaultparagraphformat/)() override | Standard-Absatz-Eigenschaften. Nur lesbar [IParagraphFormat](../iparagraphformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextStyleEffectiveData](../itextstyleeffectivedata/)\> [GetEffective](./geteffective/)() override | Liefert die wirksamen Textstil-Formatierungsdaten mit angewandter Vererbung. |
| **int32_t** [GetHashCode](../pviobject/gethashcode/)() const override | Gibt den Hashcode zurück. |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [GetLevel](./getlevel/)(**int32_t**) override | Falls die Ebene des Stils existiert, wird sie zurückgegeben, sonst null. |
