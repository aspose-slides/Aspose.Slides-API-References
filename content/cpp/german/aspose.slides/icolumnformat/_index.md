...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-artigen Vergleich von Gleitkommazahlen, bei dem zwei NaN als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Vergleich von Gleitkommazahlen, bei dem zwei NaN als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormatEffectiveData](../icolumnformateffectivedata/)\> [GetEffective](./geteffective/)() | Ruft die wirksamen Formatierungseigenschaften der Tabellenspalte mit Vererbung und angewendeten Tabellenvorlagen ab. |
