...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [AddAuthor](./addauthor/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Fügt einen neuen Autor am Ende einer Sammlung hinzu. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Gibt einen Iterator zurück, der auf das erste Element (falls vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
...
| void [Clear](./clear/)() override | Entfernt alle Autoren aus einer Sammlung. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\>, **int32_t**) override | Kopiert alle Elemente aus der Sammlung in das angegebene Array. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByName](./findbyname/)([System::String](../../system/string/)) override | Findet einen Autor in einer Sammlung anhand des Namens. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [FindByNameAndInitials](./findbynameandinitials/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Findet einen Autor in einer Sammlung anhand von Name und Initialen. |
| **int32_t** [get_Count](./get_count/)() override | Gibt die tatsächlich in der Sammlung enthaltene Anzahl von Elementen zurück. Nur lesbar **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Gibt einen Wert zurück, der anzeigt, ob der Zugriff auf die Sammlung synchronisiert (thread-sicher) ist. Nur lesbar **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der die Sammlung durchläuft. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [idx_get](./idx_get/)(**int32_t**) override | Gibt das Element am angegebenen Index zurück. Nur lesbar [ICommentAuthor](../icommentauthor/). |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren der C# lock()-Anweisung. Direkt aufrufen oder das [LockContext](../../system/lockcontext/)-Wächterobjekt benutzen. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>) override | Entfernt das erste Vorkommen des angegebenen Autors in einer Sammlung. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Entfernt den Autor am angegebenen Index der Sammlung. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\>\> [ToArray](./toarray/)() override | Erstellt und gibt ein Array mit allen Autoren zurück. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren der C# lock()-Anweisung. Direkt aufrufen oder das [LockContext](../../system/lockcontext/)-Wächterobjekt benutzen. |
