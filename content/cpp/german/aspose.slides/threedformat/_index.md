...
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevel](../ishapebevel/)\> [get_BevelBottom](./get_bevelbottom/)() override | Gibt den Typ einer unteren 3D-Fase zurück. Nur lesend [IShapeBevel](../ishapebevel/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevel](../ishapebevel/)\> [get_BevelTop](./get_beveltop/)() override | Gibt den Typ einer oberen 3D-Fase zurück. Nur lesend [IShapeBevel](../ishapebevel/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ICamera](../icamera/)\> [get_Camera](./get_camera/)() override | Gibt die Einstellungen einer Kamera zurück. Nur lesend [ICamera](../icamera/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ContourColor](./get_contourcolor/)() override | Gibt die Farbe einer Kontur zurück. Nur lesend [IColorFormat](../icolorformat/). |
| **double** [get_ContourWidth](./get_contourwidth/)() override | Gibt die Breite einer 3D-Kontur zurück. Rückgabetyp **double**. |
| **double** [get_Depth](./get_depth/)() override | Gibt die Tiefe einer 3D-Form zurück. Rückgabetyp **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ExtrusionColor](./get_extrusioncolor/)() override | Gibt die Farbe einer Extrusion zurück. Nur lesend [IColorFormat](../icolorformat/). |
| **double** [get_ExtrusionHeight](./get_extrusionheight/)() override | Gibt die Höhe eines Extrusionseffekts zurück. Rückgabetyp **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILightRig](../ilightrig/)\> [get_LightRig](./get_lightrig/)() override | Gibt den Typ eines Lichts zurück. Nur lesend [ILightRig](../ilightrig/). |
| [MaterialPresetType](../materialpresettype/) [get_Material](./get_material/)() override | Gibt den Typ eines Materials zurück. Nur lesend [MaterialPresetType](../materialpresettype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormatEffectiveData](../ithreedformateffectivedata/)\> [GetEffective](./geteffective/)() override | Ermittelt die effektiven 3-D-Formatierungsdaten mit angewandter Vererbung. |
...
| void [set_ContourWidth](./set_contourwidth/)(**double**) override | Setzt die Breite einer 3D-Kontur. Schreiben Sie **double**. |
| void [set_Depth](./set_depth/)(**double**) override | Setzt die Tiefe einer 3D-Form. Schreiben Sie **double**. |
| void [set_ExtrusionHeight](./set_extrusionheight/)(**double**) override | Setzt die Höhe eines Extrusionseffekts. Schreiben Sie **double**. |
| void [set_Material](./set_material/)([MaterialPresetType](../materialpresettype/)) override | Setzt den Typ eines Materials. Schreiben Sie [MaterialPresetType](../materialpresettype/). |
...
Das folgende Beispiel zeigt, wie man eine 3D-Form in PowerPoint [Presentation](../presentation/) hinzufügt.
```cpp
...
```
 Das folgende Beispiel zeigt, wie man einen Gradient-Effekt auf eine 3D-Form in PowerPoint [Presentation](../presentation/) anwendet.
```cpp
// Erstelle eine Instanz der Presentation-Klasse.
auto pres = System::MakeObject<Presentation>();
auto slide = pres->get_Slides()->idx_get(0);
...
pres->Save(u"sandbox_3d.pptx", SaveFormat::Pptx);
```
 Das folgende Beispiel zeigt, wie man einen 3D-Effekt auf Text anwendet. Für die Erstellung von 3D-Text kann der WordArt-Transformations-Effekt verwendet werden.
```cpp
// Erstelle eine Instanz der Presentation-Klasse.
auto pres = System::MakeObject<Presentation>();
auto slide = pres->get_Slides()->idx_get(0);
...
// Konfiguriere Portion des TextFrames und konfiguriere Eigenschaften von PortionFormat
