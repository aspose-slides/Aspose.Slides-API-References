...
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() override | Gibt die komplexe Skript-Schrift zurück. Siehe [IFontData](../ifontdata/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() override | Gibt die ostasiatische Schrift zurück. Siehe [IFontData](../ifontdata/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() override | Gibt die lateinische Schrift zurück. Siehe [IFontData](../ifontdata/). |
...
| [System::String](../../system/string/) [GetScriptFont](./getscriptfont/)([System::String](../../system/string/)) override | Erhält den Schriftartnamen, der einem bestimmten Skript-Tag im Präsentationsthema zugeordnet ist. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\> [GetScriptFontMap](./getscriptfontmap/)() override | Gibt ein Wörterbuch aller Skript-Schriftdefinitionen in der Präsentation zurück. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Vergleicht das Werttypobjekt per Referenz mit nullptr. |
...
| void [RemoveScriptFont](./removescriptfont/)([System::String](../../system/string/)) override | Entfernt die mit einem bestimmten Skript-Tag verknüpfte Schriftarteinstellung aus der Schriftart-Sammlung des Themas. |
| void [set_ComplexScriptFont](./set_complexscriptfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | Setzt die komplexe Skript-Schrift. Schreiben Sie [IFontData](../ifontdata/). |
| void [set_EastAsianFont](./set_eastasianfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | Setzt die ostasiatische Schrift. Schreiben Sie [IFontData](../ifontdata/). |
| void [set_LatinFont](./set_latinfont/)([System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\>) override | Setzt die lateinische Schrift. Schreiben Sie [IFontData](../ifontdata/). |
| void [SetScriptFont](./setscriptfont/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Weist einem bestimmten Skript-Tag einen Schriftartnamen zu, der definiert, wie Text dieses Skripts in der Präsentation dargestellt wird. |
