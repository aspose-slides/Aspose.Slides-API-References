...
| --- | --- |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::String](../../system/string/)) | Fügt eine neue(n) Schriftart(en) zur Liste der FallBack-Schriftarten hinzu. |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Fügt neue Schriftarten zur Liste der FallBack-Schriftarten hinzu. |
| virtual void [Clear](./clear/)() | Entfernt alle Schriftarten aus der Liste. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Ermittelt die tatsächlich für den Bereich definierten Schriftarten. |
| virtual **uint32_t** [get_RangeEndIndex](./get_rangeendindex/)() | Liefert den letzten Index des zusammenhängenden Unicode-Bereichs. |
| virtual **uint32_t** [get_RangeStartIndex](./get_rangestartindex/)() | Liefert den ersten Index des zusammenhängenden Unicode-Bereichs. |
...
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)(**int32_t**) | Ermittelt den Schriftartnamen am angegebenen Index. |
| virtual **int32_t** [IndexOf](./indexof/)([System::String](../../system/string/)) | Gibt den Index der angegebenen Regel in der Sammlung zurück. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Entfernt das erste Vorkommen einer bestimmten FallBack-Schriftart aus der Liste. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Entfernt die FallBack-Schriftart am angegebenen Index der Liste. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)() | Erstellt und gibt ein Array mit allen FallBack-Schriftarten für diese Regel zurück. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)(**int32_t**, **int32_t**) | Erstellt und gibt ein Array mit allen FallBack-Schriftarten aus dem angegebenen Bereich in der Liste zurück. |
