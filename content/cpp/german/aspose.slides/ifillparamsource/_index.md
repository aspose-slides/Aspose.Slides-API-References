...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument zu einer schwachen Referenz (statt shared). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
