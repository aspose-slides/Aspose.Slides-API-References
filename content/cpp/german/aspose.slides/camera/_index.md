...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-artigen Gleitkommavergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl sie nach IEC 60559:1989 nicht gleich einem beliebigen Wert, einschließlich NaN, sind. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Gleitkommavergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl sie nach IEC 60559:1989 nicht gleich einem beliebigen Wert, einschließlich NaN, sind. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() override | [Camera](./) Typ. Lesen [CameraPresetType](../camerapresettype/). |
| **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() override | [Camera](./) FOV (0-180 Grad, Sichtfeld). Lesen **float**. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../idomobject/)\> [get_Parent_Immediate](../idomobject/get_parent_immediate/)() | Gibt das Parent_Immediate-Objekt zurück. Nur-Lese [IDOMObject](../idomobject/). |
...
| **float** [get_Zoom](./get_zoom/)() override | [Camera](./) Zoom (positiver Wert in Prozent). Lesen **float**. |
...
| void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) override | [Camera](./) Typ. Schreiben [CameraPresetType](../camerapresettype/). |
| void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) override | [Camera](./) FOV (0-180 Grad, Sichtfeld). Schreiben **float**. |
| void [set_Zoom](./set_zoom/)(**float**) override | [Camera](./) Zoom (positiver Wert in Prozent). Schreiben **float**. |
| void [SetRotation](./setrotation/)(**float**, **float**, **float**) override | Eine Drehung wird durch die Verwendung einer Breitengrad-Koordinate, einer Längengrad-Koordinate und einer Umdrehung um die Achse definiert, wobei die Breitengrad- und Längengrad-Koordinaten verwendet werden. Wenn irgendein Koordinatenwert std::numeric_limits<float>::quiet_NaN() ist, ist die gesamte Drehung undefiniert. |
