...
| Method | Description |
| --- | --- |
| **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) override | Überprüft, ob ein Kennwort für eine Präsentation, die mit einem Öffnungskennwort geschützt ist, korrekt ist. |
| **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) override | Überprüft, ob ein Kennwort zum Ändern für eine schreibgeschützte Präsentation korrekt ist. |
...
| **bool** [get_IsEncrypted](./get_isencrypted/)() override | Gibt True zurück, wenn die gebundene Präsentation verschlüsselt ist, andernfalls False. Nur lesbar **bool**. |
| **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() override | Gibt einen Wert zurück, der angibt, ob die gebundene Präsentation durch ein Öffnungskennwort geschützt ist. |
| [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() override | Gibt einen Wert zurück, der angibt, ob die gebundene Präsentation schreibgeschützt ist. |
| [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() override | Gibt das Format der gebundenen Präsentation zurück. Nur lesbar [Slides::LoadFormat](../loadformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() override | Gibt die Dokumenteigenschaften der gebundenen Präsentation zurück. |
...
| void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) override | Aktualisiert die Eigenschaften der gebundenen Präsentation. |
...
| void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Schreibt die gebundene Präsentation in einen Stream. |
| void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) override | Schreibt die gebundene Präsentation in eine Datei. |
