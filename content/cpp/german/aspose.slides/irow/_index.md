...
| virtual **double** [get_Height](./get_height/)() | Gibt die Höhe einer Zeile zurück. Nur lesbar **double**. |
...
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Gibt die minimal mögliche Höhe einer Zeile zurück. Lese **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | Gibt das [RowFormat](../rowformat/)-Objekt zurück, das Formatierungseigenschaften für diese Zeile enthält. Nur lesbar [IRowFormat](../irowformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Gibt eine Zelle anhand ihrer Position zurück. Nur lesbar [ICell](../icell/). |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Setzt die minimal mögliche Höhe einer Zeile. Schreib **double**. |
...
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Setzt definierte Teilformat-Eigenschaften für alle Teile des Elements. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Setzt definierte Absatzformat-Eigenschaften für alle Absätze des Elements. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Setzt definierte Textfeldformat-Eigenschaften für alle Textfelder des Elements. |
| int [SharedCount](../../system/object/sharedcount/)() const | Gibt den aktuellen Wert der gemeinsamen Referenzzählung zurück. |
