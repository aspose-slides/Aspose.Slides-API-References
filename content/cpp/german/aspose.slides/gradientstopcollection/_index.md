...
description: Stellt eine Sammlung von Gradient-Stops dar.
type: docs
weight: 1132
...
Stellt eine Sammlung von Gradient-Stops dar.
...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) override | Erzeugt den neuen Gradient-Stop und fügt ihn am Ende der Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) override | Erzeugt den neuen Gradient-Stop und fügt ihn am Ende der Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) override | Erzeugt den neuen Gradient-Stop und fügt ihn am Ende der Sammlung hinzu. |
...
| void [Clear](./clear/)() override | Entfernt alle Gradient-Stops aus einer Sammlung. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>, **int32_t**) override | Kopiert alle Elemente der Sammlung in das angegebene Array. |
...
| **int32_t** [get_Count](./get_count/)() override | Gibt die Anzahl der Gradient-Stops in einer Sammlung zurück. Nur lesbar **int32_t**. |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../idomobject/)\> [get_Parent_Immediate](../idomobject/get_parent_immediate/)() | Gibt ein Parent_Immediate-Objekt zurück. Nur lesbar [IDOMObject](../idomobject/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der die Sammlung durchläuft. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) override | Gibt den Gradient-Stop anhand des Index zurück. |
| void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) override | Erstellt einen neuen Gradient-Stop und fügt ihn an dem angegebenen Index in die Sammlung ein. |
| void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) override | Erstellt einen neuen Gradient-Stop und fügt ihn an dem angegebenen Index in die Sammlung ein. |
| void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) override | Erstellt einen neuen Gradient-Stop und fügt ihn an dem angegebenen Index in die Sammlung ein. |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Gibt das Element an einem angegebenen Index einer Sequenz zurück. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Gibt das Element an einem angegebenen Index einer Sequenz zurück. |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren einer C# lock()-Anweisung. Direkter Aufruf oder Verwendung des [LockContext](../../system/lockcontext/)-Wächterobjekts. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Entfernt einen Gradient-Stop am angegebenen Index. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren einer C# lock()-Anweisung. Direkter Aufruf oder Verwendung des [LockContext](../../system/lockcontext/)-Wächterobjekts. |
