...
description: Stellt die Sammlung von Tags (benutzerdefinierte Paare von Zeichenketten) dar.
type: docs
weight: 5435
...
| --- | --- |
| **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Fügt der Sammlung einen neuen Tag hinzu. |
...
| void [Clear](./clear/)() override | Entfernt alle Tags aus der Sammlung. |
| **bool** [Contains](./contains/)([System::String](../../system/string/)) override | Bestimmt, ob die Sammlung einen bestimmten Namen enthält. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\>, **int32_t**) override | Kopiert alle Elemente der Sammlung in das angegebene Array. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const&, **double** const&) | Emuliert den C#-artigen Gleitkommavergleich für double, bei dem zwei NaNs als gleich betrachtet werden, obwohl NaN laut IEC 60559:1989 zu keinem Wert, einschließlich NaN, gleich ist. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase&, void **) const | Nur für interne Zwecke. |
| **int32_t** [get_Count](./get_count/)() override | Gibt die Anzahl der Tags in der Sammlung zurück. Nur-lesbar **int32_t**. |
...
| [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) override | Gibt den Schlüssel eines Tags am angegebenen Index zurück. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() override | Gibt die Namen der Tags zurück. |
...
| [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) override | Gibt den Wert eines Tags am angegebenen Index zurück. |
| [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) override | Gibt ein Schlüssel-Wert-Paar eines Tags zurück. |
| void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Setzt ein Schlüssel-Wert-Paar eines Tags. |
| **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) override | Gibt den nullbasierten Index des angegebenen Schlüssels in der Sammlung zurück. |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | Entfernt den Tag mit einem angegebenen Namen aus der Sammlung. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Entfernt den Tag am angegebenen Index. |
...
Das folgende Beispiel zeigt, wie man einen Tag zu einer PowerPoint [Presentation](../presentation/) hinzufügt. 
```cpp
