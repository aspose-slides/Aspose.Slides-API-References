...
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | Vergleicht das aktuelle Objekt mit dem angegebenen Objekt. |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Gibt den Ausrichtungsstil eines Tabs zurück. Lesen [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Gibt die Position eines Tabs zurück. Das Zuweisen dieser Eigenschaft kann den Index des Tabs in der Sammlung ändern und den Enumerator ungültig machen. Lesen **double**. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Setzt den Ausrichtungsstil eines Tabs. Schreiben [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Setzt die Position eines Tabs. Das Zuweisen dieser Eigenschaft kann den Index des Tabs in der Sammlung ändern und den Enumerator ungültig machen. Schreiben **double**. |
