...
description: Stellt eine Basisklasse für Sperren dar (deaktivierte Operation).
type: docs
weight: 157
...
| **bool** [get_NoLocks](./get_nolocks/)() override | Gibt true zurück, wenn alle Sperr-Flags deaktiviert sind. Nur lesbar **bool**. |
