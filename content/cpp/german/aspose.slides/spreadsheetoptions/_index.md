...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() override | Ruft bevorzugte Kulturinformationen ab, die für die Berechnung einiger Funktionen bestimmt sind, die für Sprachen mit doppelbyte-zeichensatz (DBCS) verwendet werden. |
| **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() override | Wenn die Datenquelle für das Diagramm eine externe Arbeitsmappe ist und sie nicht verfügbar ist, wird sie aus dem Diagramm-Cache wiederhergestellt. |
...
| void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) override | Setzt bevorzugte Kulturinformationen für die Berechnung einiger Funktionen, die für Sprachen mit doppelbyte-zeichensatz (DBCS) verwendet werden. |
| void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) override | Wenn die Datenquelle für das Diagramm eine externe Arbeitsmappe ist und sie nicht verfügbar ist, wird sie aus dem Diagramm-Cache wiederhergestellt. |
...
|  [SpreadsheetOptions](./spreadsheetoptions/)() | Initialisiert eine neue Instanz der [SpreadsheetOptions](./)-Klasse. |
