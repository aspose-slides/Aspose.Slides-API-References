...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) | Erzeugt den neuen Farbverlaufspunkt und fügt ihn am Ende der Sammlung hinzu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) | Erzeugt den neuen Farbverlaufspunkt und fügt ihn am Ende der Sammlung hinzu. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) | Erzeugt den neuen Farbverlaufspunkt und fügt ihn am Ende der Sammlung hinzu. |
...
| virtual void [Clear](./clear/)() | Entfernt alle Farbverlaufspunkte aus einer Sammlung. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) | Gibt den Farbverlaufspunkt anhand des Index zurück. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) | Erzeugt den neuen Farbverlaufspunkt und fügt ihn an der angegebenen Position in die Sammlung ein. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) | Erzeugt den neuen Farbverlaufspunkt und fügt ihn an der angegebenen Position in die Sammlung ein. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) | Erzeugt den neuen Farbverlaufspunkt und fügt ihn an der angegebenen Position in die Sammlung ein. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-Konstruktor. Kopiert nichts, wirklich, sondern initiiert ein neues Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Zuweisungsoperator. Kopiert nichts, wirklich, sondern initiiert ein neues Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Entfernt einen Farbverlaufspunkt an dem angegebenen Index. |
