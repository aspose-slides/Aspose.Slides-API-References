...
Stellt ein Summary Zoom [Section](../section/)-Objekt in einem Summary Zoom-Rahmen dar.
...
| [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../shape/get_blackwhitemode/)() override | Eigenschaft gibt an, wie eine Form im Schwarz-weiß-Anzeige-Modus gerendert wird. Lesen [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| [System::String](../../system/string/) [get_Description](./get_description/)() override | Gibt die Textbeschreibung des Summary Zoom [Section](../section/)-Objekts zurück. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_Frame](../shape/get_frame/)() override | Gibt die Rahmen-Eigenschaften der Form zurück. Lesen [IShapeFrame](../ishapeframe/). |
...
| [ZoomImageType](../zoomimagetype/) [get_ImageType](../zoomobject/get_imagetype/)() override | Ermittelt den Bildtyp eines Zoom-Objekts. Lesen [ZoomImageType](../zoomimagetype/). Standardwert: Preview |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_RawFrame](../shape/get_rawframe/)() override | Gibt die rohen Rahmen-Eigenschaften der Form zurück. Lesen [IShapeFrame](../ishapeframe/). |
| **bool** [get_ReturnToParent](../zoomobject/get_returntoparent/)() override | Ermittelt das Navigationsverhalten in der Diashow. Lesen **bool**. Standardwert: false |
| **float** [get_Rotation](../shape/get_rotation/)() override | Gibt die Anzahl der Grad zurück, um die die angegebene Form um die Z-Achse rotiert ist. Ein positiver Wert bedeutet Drehung im Uhrzeigersinn; ein negativer Wert bedeutet Drehung gegen den Uhrzeigersinn. Lesen **float**. |
...
| **bool** [get_ShowBackground](../zoomobject/get_showbackground/)() override | Ermittelt den Wert, der angibt, ob der Zoom den Hintergrund der Ziel-Folie verwendet. Lesen **bool**. Standardwert: true |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](../sectionzoomframe/get_targetsection/)() override | Ermittelt das Abschnitts-Objekt, auf das das [Section](../section/)-Zoom-Objekt verweist. Lesen [ISection](../isection/). |
...
| [System::String](../../system/string/) [get_Title](./get_title/)() override | Gibt den Texttitel des Summary Zoom [Section](../section/)-Objekts zurück. |
| **float** [get_TransitionDuration](../zoomobject/get_transitionduration/)() override | Ermittelt die Dauer des Übergangs zwischen Zoom und Folie. Lesen **float**. Standardwert: 1.0f |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](../zoomobject/get_zoomimage/)() override | Ermittelt das Bild für das Zoom-Objekt. Lesen [IPPImage](../ippimage/). |
| **int32_t** [get_ZOrderPosition](../shape/get_zorderposition/)() override | Gibt die Position einer Form in der Z-Reihenfolge zurück. Shapes[0] gibt die Form zurück, die hinten in der Z-Reihenfolge liegt, und Shapes[Shapes.Count - 1] gibt die Form zurück, die vorne liegt. Nur lesbar **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../shape/getbaseplaceholder/)() override | Gibt eine grundlegende Platzhalter-Form zurück (Form aus dem Layout und/oder der Master-Folien, von der die aktuelle Form ererbt wurde). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetImage](../shape/getimage/)() override | Gibt die Miniaturansicht der Form zurück. [ShapeThumbnailBounds::Shape](../shapethumbnailbounds/) Form-Miniaturansicht-Grenztyp wird standardmäßig verwendet. |
...
| void [Lock](../../system/object/lock/)() | Implementiert die Sperrung der C# lock()-Anweisung. Direkt aufrufen oder das [LockContext](../../system/lockcontext/)-Wächterobjekt verwenden. |
...
| void [set_Description](./set_description/)([System::String](../../system/string/)) override | Gibt die Textbeschreibung des Summary Zoom [Section](../section/)-Objekts zurück. |
| void [set_Frame](../shape/set_frame/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\>) override | Setzt die Rahmen-Eigenschaften der Form. Schreiben [IShapeFrame](../ishapeframe/). |
...
| void [set_ImageType](../zoomobject/set_imagetype/)([ZoomImageType](../zoomimagetype/)) override | Setzt den Bildtyp eines Zoom-Objekts. Schreiben [ZoomImageType](../zoomimagetype/). Standardwert: Preview |
...
| void [set_RawFrame](../shape/set_rawframe/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\>) override | Setzt die rohen Rahmen-Eigenschaften der Form. Schreiben [IShapeFrame](../ishapeframe/). |
| void [set_ReturnToParent](../zoomobject/set_returntoparent/)(**bool**) override | Setzt das Navigationsverhalten in der Diashow. Schreiben **bool**. Standardwert: false |
| void [set_Rotation](../shape/set_rotation/)(**float**) override | Setzt die Anzahl der Grad, um die die angegebene Form um die Z-Achse gedreht wird. Ein positiver Wert bedeutet Drehung im Uhrzeigersinn; ein negativer Wert bedeutet Drehung gegen den Uhrzeigersinn. Schreiben **float**. |
| void [set_ShowBackground](../zoomobject/set_showbackground/)(**bool**) override | Setzt den Wert, der angibt, ob der Zoom den Hintergrund der Ziel-Folie verwendet. Schreiben **bool**. Standardwert: true |
| void [set_TargetSection](../sectionzoomframe/set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Setzt das Abschnitts-Objekt, auf das das [Section](../section/)-Zoom-Objekt verweist. Schreiben [ISection](../isection/). |
| void [set_Title](./set_title/)([System::String](../../system/string/)) override | Gibt den Texttitel des Summary Zoom [Section](../section/)-Objekts zurück. |
| void [set_TransitionDuration](../zoomobject/set_transitionduration/)(**float**) override | Setzt die Dauer des Übergangs zwischen Zoom und Folie. Schreiben **float**. Standardwert: 1.0f |
...
| void [set_ZoomImage](../zoomobject/set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) override | Setzt das Bild für das Zoom-Objekt. Schreiben [IPPImage](../ippimage/). |
