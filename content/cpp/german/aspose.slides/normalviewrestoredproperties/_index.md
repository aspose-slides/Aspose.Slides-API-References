...
description: Gibt die Größe des Folienbereichs an ((Breite, wenn ein Kind von restoredTop, Höhe, wenn ein Kind von restoredLeft) der Normalansicht, wenn der Bereich eine variable wiederhergestellte Größe hat (weder minimiert noch maximiert).
type: docs
weight: 4538
...
Gibt die Größe des Folienbereichs an ((Breite, wenn ein Kind von restoredTop, Höhe, wenn ein Kind von restoredLeft) der Normalansicht, wenn der Bereich eine variable wiederhergestellte Größe hat (weder minimiert noch maximiert).
...
| **bool** [get_AutoAdjust](./get_autoadjust/)() override | Gibt an, ob die Größe des seitlichen Inhaltsbereichs die neue Größe beim Ändern der Fenstergröße, die die Ansicht in der Anwendung enthält, kompensieren soll. Lese **bool**. |
| **float** [get_DimensionSize](./get_dimensionsize/)() override | Gibt die Größe des Folienbereichs an (Breite, wenn ein Kind von RestoredTop, Höhe, wenn ein Kind von RestoredLeft). Lese **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Liest die dem Objekt zugeordnete Referenzzähler-Datenstruktur. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Verweist (vergleicht) ein Werttyp-Objekt mit nullptr. |
...
| void [set_AutoAdjust](./set_autoadjust/)(**bool**) override | Gibt an, ob die Größe des seitlichen Inhaltsbereichs die neue Größe beim Ändern der Fenstergröße, die die Ansicht in der Anwendung enthält, kompensieren soll. Schreibe **bool**. |
| void [set_DimensionSize](./set_dimensionsize/)(**float**) override | Gibt die Größe des Folienbereichs an (Breite, wenn ein Kind von RestoredTop, Höhe, wenn ein Kind von RestoredLeft). Schreibe **float**. |
