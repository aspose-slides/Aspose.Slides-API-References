...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [CreatePresentation](./createpresentation/)() override | Erstelle eine neue Präsentation. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [CreatePresentation](./createpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[ILoadOptions](../iloadoptions/)\>) override | Erstellt eine neue Präsentation mit zusätzlichen Ladeoptionen |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[PresentationFactory](./)\> [get_Instance](./get_instance/)() | [Presentation](../presentation/) Factory statische Instanz. Nur-Lese [PresentationFactory](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentationInfo](../ipresentationinfo/)\> [GetPresentationInfo](./getpresentationinfo/)([System::String](../../system/string/)) override | Erstellt ein neues [PresentationInfo](../presentationinfo/)-Objekt aus einer Datei und bindet die Präsentation daran. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentationInfo](../ipresentationinfo/)\> [GetPresentationInfo](./getpresentationinfo/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Erstellt ein neues [PresentationInfo](../presentationinfo/)-Objekt aus einem Stream und bindet die Präsentation daran. Ruft Informationen über die Präsentation im angegebenen Stream ab. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentationText](../ipresentationtext/)\> [GetPresentationText](./getpresentationtext/)([System::String](../../system/string/), [TextExtractionArrangingMode](../textextractionarrangingmode/)) override | Liefert den Rohtext aus den Folien. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentationText](../ipresentationtext/)\> [GetPresentationText](./getpresentationtext/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [TextExtractionArrangingMode](../textextractionarrangingmode/)) override | Liefert den Rohtext aus den Folien. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentationText](../ipresentationtext/)\> [GetPresentationText](./getpresentationtext/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [TextExtractionArrangingMode](../textextractionarrangingmode/), [System::SharedPtr](../../system/sharedptr/)\<[ILoadOptions](../iloadoptions/)\>) override | Liefert den Rohtext aus den Folien. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [ReadPresentation](./readpresentation/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Liest eine bestehende Präsentation aus einem Array. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [ReadPresentation](./readpresentation/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::SharedPtr](../../system/sharedptr/)\<[ILoadOptions](../iloadoptions/)\>) override | Liest eine bestehende Präsentation aus einem Array mit zusätzlichen Ladeoptionen. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [ReadPresentation](./readpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Liest eine bestehende Präsentation aus einem Stream. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [ReadPresentation](./readpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ILoadOptions](../iloadoptions/)\>) override | Liest eine bestehende Präsentation aus einem Stream mit zusätzlichen Ladeoptionen. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [ReadPresentation](./readpresentation/)([System::String](../../system/string/)) override | Liest eine bestehende Präsentation aus einer Datei. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [ReadPresentation](./readpresentation/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ILoadOptions](../iloadoptions/)\>) override | Liest eine bestehende Präsentation aus einem Stream mit zusätzlichen Ladeoptionen. |
...
Das folgende Beispiel zeigt, wie man ein [Presentation](../presentation/)-Format überprüft. 
```cpp
...
```
 Das folgende Beispiel zeigt, wie man die Eigenschaften eines [Presentation](../presentation/) abruft. 
```cpp
System::SharedPtr<IPresentationInfo> info = PresentationFactory::get_Instance()->GetPresentationInfo(u"pres.pptx");
...
```
 Das folgende Beispiel zeigt, wie man die Eigenschaften eines [Presentation](../presentation/) aktualisiert. 
```cpp
System::SharedPtr<IPresentationInfo> info = PresentationFactory::get_Instance()->GetPresentationInfo(u"pres.pptx");
System::SharedPtr<IDocumentProperties> props = info->ReadDocumentProperties();
