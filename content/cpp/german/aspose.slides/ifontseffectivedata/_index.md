...
description: Unveränderliches Objekt, das den Satz effektiver Schriftarten enthält.
type: docs
weight: 2224
...
Unveränderliches Objekt, das den Satz effektiver Schriftarten enthält.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() | Gibt die komplexe Skript-Schriftart zurück. Nur lesbar [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() | Gibt die ostasiatische Schriftart zurück. Nur lesbar [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() | Gibt die lateinische Schriftart zurück. Nur lesbar [IFontData](../ifontdata/). |
...
Dieses Interface wird als Teil der [IBasePortionFormatEffectiveData](../ibaseportionformateffectivedata/)- und [Theme::IFontSchemeEffectiveData](../../aspose.slides.theme/ifontschemeeffectivedata/)-Interfaces verwendet.
