...
description: Stellt den Manager dar, der das Verhalten aller Fußzeilen-, Datums- und Seitenzahlen-Platzhalter der Präsentation verwaltet.
type: docs
weight: 3407
...
Stellt den Manager dar, der das Verhalten aller Fußzeilen-, Datums- und Seitenzahl-Platzhalter der Präsentation verwaltet.
...
| virtual void [SetAllDateTimesText](./setalldatetimestext/)([System::String](../../system/string/)) | Setzt den Text für alle Datums- und Zeit-Platzhalter, einschließlich Master-Folien, Layout-Folien und Folien. |
| virtual void [SetAllDateTimesVisibility](./setalldatetimesvisibility/)(**bool**) | Ändert die Sichtbarkeit aller Datums- und Zeit-Platzhalter, einschließlich Master-Folien, Layout-Folien und Folien. |
| virtual void [SetAllFootersText](./setallfooterstext/)([System::String](../../system/string/)) | Setzt den Text für alle Fußzeilen-Platzhalter, einschließlich Master-Folien, Layout-Folien und Folien. |
| virtual void [SetAllFootersVisibility](./setallfootersvisibility/)(**bool**) | Ändert die Sichtbarkeit aller Fußzeilen-Platzhalter, einschließlich Master-Folien, Layout-Folien und Folien. |
| virtual void [SetAllHeadersText](./setallheaderstext/)([System::String](../../system/string/)) | Setzt den Text für alle Kopf-Platzhalter, einschließlich Notiz-Master, Notiz-Folien und Handout-Master. |
| virtual void [SetAllHeadersVisibility](./setallheadersvisibility/)(**bool**) | Ändert die Sichtbarkeit aller Kopf-Platzhalter, einschließlich Notiz-Master, Notiz-Folien und Handout-Master. |
| virtual void [SetAllSlideNumbersVisibility](./setallslidenumbersvisibility/)(**bool**) | Ändert die Sichtbarkeit aller Seitenzahlen-Platzhalter, einschließlich Master-Folien, Layout-Folien und Folien. |
...
| virtual void [SetVisibilityOnAllTitleSlides](./setvisibilityonalltitleslides/)(**bool**) | Ändert die Sichtbarkeit der Fußzeilen-, Datums- und Seitenzahlen-Platzhalter für alle Titelfolien und die erste Layout-Folie. Titelfolien \\u2013 Folien, die auf der ersten Layout-Folie basieren (unabhängig vom Typ dieses ersten Layouts). |
