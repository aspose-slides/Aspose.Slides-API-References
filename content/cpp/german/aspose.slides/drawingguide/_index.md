...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Gibt die Farbe des Zeichenleitfadens zurück. Lesen Sie [System::Drawing::Color](../../system.drawing/color/). |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Gibt die Ausrichtung des Zeichenleitfadens zurück. Lesen Sie [Slides::Orientation](../orientation/). |
| **float** [get_Position](./get_position/)() override | Gibt die Position des Zeichenleitfadens in Punkten relativ zur oberen linken Ecke der Folie zurück. Lesen Sie **float**. |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren des C# lock()-Statements. Rufen Sie es direkt auf oder verwenden Sie das [LockContext](../../system/lockcontext/)-Wachobjekt. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Setzt die Farbe des Zeichenleitfadens. Schreiben Sie [System::Drawing::Color](../../system.drawing/color/). |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) override | Setzt die Ausrichtung des Zeichenleitfadens. Schreiben Sie [Slides::Orientation](../orientation/). |
| void [set_Position](./set_position/)(**float**) override | Setzt die Position des Zeichenleitfadens in Punkten relativ zur oberen linken Ecke der Folie. Schreiben Sie **float**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren des C# lock()-Statements. Rufen Sie es direkt auf oder verwenden Sie das [LockContext](../../system/lockcontext/)-Wachobjekt. |
