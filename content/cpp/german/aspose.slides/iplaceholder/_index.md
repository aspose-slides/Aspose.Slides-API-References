...
| virtual **uint32_t** [get_Index](./get_index/)() | Gibt den Index eines Platzhalters zurück. Nur lesend **uint32_t**. |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Gibt die Orientierung eines Platzhalters zurück. Nur lesend [Slides::Orientation](../orientation/). |
| virtual [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() | Gibt die Größe eines Platzhalters zurück. Nur lesend [PlaceholderSize](../placeholdersize/). |
| virtual [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() | Gibt den Typ eines Platzhalters zurück. Nur lesend [PlaceholderType](../placeholdertype/). |
