...
| **uint32_t** [get_Index](./get_index/)() override | Liefert den Index eines Platzhalters. Read-only **uint32_t**. |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Liefert die Ausrichtung eines Platzhalters. Read-only [Slides::Orientation](../orientation/). |
| [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() override | Liefert die Größe eines Platzhalters. Read-only [PlaceholderSize](../placeholdersize/). |
| [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() override | Liefert den Typ eines Platzhalters. Read-only [PlaceholderType](../placeholdertype/). |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Verringert und liefert den gemeinsamen Referenzzähler. Sollte nicht direkt aufgerufen werden; stattdessen smarte Zeiger oder ThisProtector verwenden. |
