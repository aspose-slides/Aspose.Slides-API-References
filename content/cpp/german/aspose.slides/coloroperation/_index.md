...
| --- | --- |
|  [ColorOperation](./coloroperation/)([ColorTransformOperation](../colortransformoperation/)) | Erstellt eine neue Farbtransformationsoperation. |
|  [ColorOperation](./coloroperation/)([ColorTransformOperation](../colortransformoperation/), **float**) | Erstellt eine neue Farbtransformationsoperation. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestimmt, ob die beiden [ColorOperation](./) Instanzen gleich sind. |
...
| [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const override | Gibt den Typ einer Operation zurück. Nur-Lese [ColorTransformOperation](../colortransformoperation/). |
| **float** [get_Parameter](./get_parameter/)() override | Gibt einen Parameter einer Operation zurück. Nur-Lese **float**. |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Dient als Hash-Funktion für einen bestimmten Typ und ist für den Einsatz in Hash-Algorithmen und Datenstrukturen wie einer Hashtabelle geeignet. |
