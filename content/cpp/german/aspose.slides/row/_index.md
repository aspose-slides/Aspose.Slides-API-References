...
| void [CopyTo](../cellcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>\>, **int32_t**) override | Kopiert alle Elemente der Sammlung in das angegebene Array. |
...
| **int32_t** [get_Count](../cellcollection/get_count/)() override | Gibt die Anzahl der Zellen in einer Sammlung zurück. Nur lesbar **int32_t**. |
| **double** [get_Height](./get_height/)() override | Gibt die Höhe einer Zeile zurück. Nur lesbar **double**. |
| **bool** [get_IsSynchronized](../cellcollection/get_issynchronized/)() override | Gibt einen Wert zurück, der angibt, ob der Zugriff auf die Sammlung synchronisiert (thread-sicher) ist. Nur lesbar **bool**. |
| **double** [get_MinimalHeight](./get_minimalheight/)() override | Gibt die minimal mögliche Höhe einer Zeile zurück. Nur lesbar **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](../cellcollection/get_presentation/)() override | Gibt die übergeordnete Präsentation eines [CellCollection](../cellcollection/) zurück. Nur lesbar [IPresentation](../ipresentation/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() override | Gibt das [RowFormat](../rowformat/)-Objekt zurück, das die Formatierungseigenschaften für diese Zeile enthält. Nur lesbar [IRowFormat](../irowformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../cellcollection/get_slide/)() override | Gibt die übergeordnete Folie eines [CellCollection](../cellcollection/) zurück. Nur lesbar [IBaseSlide](../ibaseslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../cellcollection/get_syncroot/)() override | Gibt eine Synchronisationswurzel zurück. Nur lesbar [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>\>\> [GetEnumerator](../cellcollection/getenumerator/)() override | Gibt einen Enumerator zurück, der die Sammlung durchläuft. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../cellcollection/idx_get/)(**int32_t**) override | Gibt eine Zelle nach ihrer Position zurück. Nur lesbar [Cell](../cell/). |
...
| void [set_MinimalHeight](./set_minimalheight/)(**double**) override | Setzt die minimal mögliche Höhe einer Zeile. Schreiben **double**. |
...
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | Setzt definierte Portion-Format-Eigenschaften für alle Abschnitte der Zeilenzellen. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | Setzt definierte Absatz-Format-Eigenschaften für alle Absätze der Zeilenzellen. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | Setzt definierte Textframe-Format-Eigenschaften für alle Textframes der Zeilenzellen. |
