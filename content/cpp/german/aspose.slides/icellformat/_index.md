...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderBottom](./get_borderbottom/)() | Gibt ein Objekt für die Eigenschaften der unteren Randlinie zurück. Nur lesbar [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderDiagonalDown](./get_borderdiagonaldown/)() | Gibt ein Objekt für die Eigenschaften der diagonalen Linie von oben links nach unten rechts zurück. Nur lesbar [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderDiagonalUp](./get_borderdiagonalup/)() | Gibt ein Objekt für die Eigenschaften der diagonalen Linie von unten links nach oben rechts zurück. Nur lesbar [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderLeft](./get_borderleft/)() | Gibt ein Objekt für die Eigenschaften der linken Randlinie zurück. Nur lesbar [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderRight](./get_borderright/)() | Gibt ein Objekt für die Eigenschaften der rechten Randlinie zurück. Nur lesbar [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_BorderTop](./get_bordertop/)() | Gibt ein Objekt für die Eigenschaften der oberen Randlinie zurück. Nur lesbar [ILineFormat](../ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Gibt ein Objekt für die Zellfüllungs-Eigenschaften zurück. Nur lesbar [IFillFormat](../ifillformat/). |
| virtual **float** [get_Transparency](./get_transparency/)() | Ermittelt die Transparenz der Füllfarbe. Lese **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ermittelt die dem Objekt zugeordnete Referenzzähler-Datenstruktur. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICellFormatEffectiveData](../icellformateffectivedata/)\> [GetEffective](./geteffective/)() | Ermittelt die effektiven Formatierungseigenschaften der Tabellenzelle mit Vererbung und angewandten Tabellenstilen. |
...
| virtual void [set_Transparency](./set_transparency/)(**float**) | Setzt die Transparenz der Füllfarbe. Schreiben **float**. |
