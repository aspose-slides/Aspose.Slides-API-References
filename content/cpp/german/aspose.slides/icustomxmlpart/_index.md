...
| virtual [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() | Gibt einen global eindeutig identifizierenden Bezeichner (GUID) an, der ein einzelnes benutzerdefiniertes XML-Teil innerhalb eines Office Open XML-Dokuments eindeutig identifiziert. Nur lesbar [System::Guid](../../system/guid/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() | Gibt die Sammlung von XML-Schemas zurück, die mit dem benutzerdefinierten XML-Teil verknüpft sind. Nur lesbar [System::String](../../system/string/)[]. |
| virtual [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() | Gibt XML-Daten als UTF-8-Zeichenkette zurück. Lesend [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() | Gibt XML-Daten zurück. Lesend **uint8_t**[]. |
...
| virtual void [Remove](./remove/)() | Entfernt das benutzerdefinierte XML-Teil aus der Präsentation. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verringert den gemeinsamen Referenzzähler um den angegebenen Wert. |
| virtual void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) | Gibt einen global eindeutig identifizierenden Bezeichner (GUID) an, der ein einzelnes benutzerdefiniertes XML-Teil innerhalb eines Office Open XML-Dokuments eindeutig identifiziert. Nur lesbar [System::Guid](../../system/guid/). |
| virtual void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) | Setzt XML-Daten als UTF-8-Zeichenkette. Schreibend [System::String](../../system/string/). |
| virtual void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Setzt XML-Daten. Schreibend **uint8_t**[]. |
