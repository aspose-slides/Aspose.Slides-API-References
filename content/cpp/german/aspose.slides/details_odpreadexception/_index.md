...
description: Stellt eine Ausnahme dar, die bei Fehlern beim Lesen der Präsentation ausgelöst wird.
type: docs
weight: 612
url: /de/aspose.slides/details_odpreadexception/
---
## Details_OdpReadException Klasse

Stellt eine Ausnahme dar, die bei Fehlern beim Lesen der Präsentation ausgelöst wird.
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Gibt einen 32-Bit-Ganzzahlwert zurück, der ein HRESULT-Code ist, der mit der vom aktuellen Objekt dargestellten Ausnahme verbunden ist. |
...
* Klasse [Details_OdpException](../details_odpexception/)
