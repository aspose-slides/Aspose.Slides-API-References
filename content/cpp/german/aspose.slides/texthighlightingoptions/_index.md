...
description: Stellt Optionen dar, die zum Hervorheben von Text in einem Textfeld verwendet werden können.
type: docs
weight: 5474
...
Stellt Optionen dar, die zum Hervorheben von Text in einem Textfeld verwendet werden können.
...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Setzen Sie true, um eine Groß-/Kleinschreibung-sensitive Suche zu verwenden, false – sonst. Lesen **bool**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Setzen Sie true, um nur ganze Wörter zu finden, false – sonst. Lesen **bool**. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Setzen Sie true, um eine Groß-/Kleinschreibung-sensitive Suche zu verwenden, false – sonst. Schreiben **bool**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Setzen Sie true, um nur ganze Wörter zu finden, false – sonst. Schreiben **bool**. |
...
|  [TextHighlightingOptions](./texthighlightingoptions/)() | Erstellt neue Standard-Text-Highlighting-Optionen. |
...
Veraltet
:   Die Schnittstelle [ITextHighlightingOptions](../itexthighlightingoptions/) wird nach der Veröffentlichung von Version 24.10 entfernt.
