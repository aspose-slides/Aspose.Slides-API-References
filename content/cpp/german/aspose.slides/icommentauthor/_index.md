...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) | Gibt den vom Autor am angegebenen Index erstellten Kommentar zurück. Schreibgeschützt [Aspose::Slides::IComment](../icomment/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() | Gibt die Sammlung der vom Autor erstellten Kommentare zurück. Schreibgeschützt [ICommentCollection](../icommentcollection/). |
| virtual [System::String](../../system/string/) [get_Initials](./get_initials/)() | Gibt die Initialen des Autors zurück. Lesen [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Gibt den Namen des Autors zurück. Lesen [System::String](../../system/string/). |
...
| virtual void [Remove](./remove/)() | Entfernt den Autor aus der übergeordneten Sammlung. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verringert den gemeinsamen Referenzzähler um den angegebenen Wert. |
| virtual void [set_Initials](./set_initials/)([System::String](../../system/string/)) | Setzt die Initialen des Autors. Schreiben [System::String](../../system/string/). |
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Setzt den Namen des Autors. Schreiben [System::String](../../system/string/). |
