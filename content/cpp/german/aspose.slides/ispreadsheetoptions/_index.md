...
Stellt Optionen dar, die verwendet werden können, um zusätzliches Tabellen-Verhalten anzugeben.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() | Ruft bevorzugte Kulturinformationen ab, die für die Berechnung einiger Funktionen verwendet werden, die für Sprachen mit Double-Byte-Zeichensatz (DBCS) vorgesehen sind. |
| virtual **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() | Falls die Datenquelle für das Diagramm eine externe Arbeitsmappe ist und nicht verfügbar ist, wird sie aus dem Diagramm-Cache wiederhergestellt. |
...
| virtual void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) | Setzt bevorzugte Kulturinformationen für die Berechnung einiger Funktionen, die für Sprachen mit Double-Byte-Zeichensatz (DBCS) vorgesehen sind. |
| virtual void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) | Falls die Datenquelle für das Diagramm eine externe Arbeitsmappe ist und nicht verfügbar ist, wird sie aus dem Diagramm-Cache wiederhergestellt. |
