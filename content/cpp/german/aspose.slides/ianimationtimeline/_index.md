...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ISequence](../../aspose.slides.animation/isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) | Gibt die interaktive Sequenz am angegebenen Index zurück. Diese Sequenz kann nur Effekte durch \"click on shape\" mit spezifiziertem Ziel-Form enthalten. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ISequenceCollection](../../aspose.slides.animation/isequencecollection/)\> [get_InteractiveSequences](./get_interactivesequences/)() | Gibt eine Sammlung interaktiver Sequenzen zurück. Diese Sequenzen können nur Effekte durch \"click on shape\" mit spezifiziertem Ziel-Form enthalten. Nur-Lese [Animation::ISequenceCollection](../../aspose.slides.animation/isequencecollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ISequence](../../aspose.slides.animation/isequence/)\> [get_MainSequence](./get_mainsequence/)() | Gibt die Hauptsequenz zurück, die nur die Haupt-Effektsammlungen enthalten kann. Nur-Lese [Animation::ISequence](../../aspose.slides.animation/isequence/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::IEffect](../../aspose.slides.animation/ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) | Gibt den Effekt aus der Hauptsequenz am angegebenen Index zurück. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ITextAnimation](../../aspose.slides.animation/itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) | Gibt die Textanimation am angegebenen Index zurück. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ITextAnimationCollection](../../aspose.slides.animation/itextanimationcollection/)\> [get_TextAnimationCollection](./get_textanimationcollection/)() | Gibt eine Sammlung von Textanimationen zurück. Nur-Lese [Animation::ITextAnimationCollection](../../aspose.slides.animation/itextanimationcollection/). |
