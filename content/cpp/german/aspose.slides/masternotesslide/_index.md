...
| [System::SharedPtr](../../system/sharedptr/)\<[IBackground](../ibackground/)\> [get_Background](../baseslide/get_background/)() override | Gibt den Hintergrund der Folie zurück. Schreibgeschützt [IBackground](../ibackground/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IControlCollection](../icontrolcollection/)\> [get_Controls](../baseslide/get_controls/)() override | Gibt die Sammlung von ActiveX-Steuerelementen auf einer Folie zurück. Schreibgeschützt [IControlCollection](../icontrolcollection/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Gibt eine Sammlung von Zeichenhilfen für die Master-Notizfolie zurück. Schreibgeschützt [IDrawingGuidesCollection](../idrawingguidescollection/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlideHeaderFooterManager](../imasternotesslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | Gibt den HeaderFooter-Manager der Master-Notizfolie zurück. Schreibgeschützt [IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/). |
...
| [System::String](../../system/string/) [get_Name](../baseslide/get_name/)() override | Gibt den Namen einer Folie zurück. Lese [System::String](../../system/string/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextStyle](../itextstyle/)\> [get_NotesStyle](./get_notesstyle/)() override | Gibt den Stil eines Notiztextes zurück. Schreibgeschützt [ITextStyle](../itextstyle/). |
...
| **bool** [get_ShowMasterShapes](./get_showmastershapes/)() override | Gibt an, ob Formen auf der Masterfolie auf Folien angezeigt werden sollen oder nicht. Für die Masterfolie selbst gibt diese Eigenschaft immer **false** zurück. Lese **bool**. |
...
| virtual void [JoinPortionsWithSameFormatting](../baseslide/joinportionswithsameformatting/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeCollection](../ishapecollection/)\>) | Verbindet Läufe mit gleicher Formatierung in allen Absätzen in allen zulässigen Formen. |
...
| void [set_ShowMasterShapes](./set_showmastershapes/)(**bool**) override | Gibt an, ob Formen auf der Masterfolie auf Folien angezeigt werden sollen oder nicht. Für die Masterfolie selbst gibt diese Eigenschaft immer **false** zurück. Schreiben **bool**. |
