...
description: Stellt eine Sammlung digitaler Signaturen dar, die an einem Dokument angehängt sind.
type: docs
weight: 781
...
Stellt eine Sammlung digitaler Signaturen dar, die an einem Dokument angehängt sind.
...
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\>) override | Fügt die Signatur am Ende der Sammlung hinzu. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Liefert einen Iterator, der unmittelbar nach dem letzten const-qualifizierten Element (falls vorhanden) der Sammlung zeigt. |
| void [Clear](./clear/)() override | Entfernt alle Signaturen aus der Sammlung. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\>\>, **int32_t**) override | Kopiert alle Elemente aus der Sammlung in das angegebene Array. |
...
| [iterator](./iterator/) [end](./end/)() | Liefert einen Iterator, der unmittelbar nach dem letzten Element (falls vorhanden) der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Liefert einen Iterator, der unmittelbar nach dem letzten Element (falls vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert einen C#-ähnlichen Vergleich von Gleitkommazahlen, bei dem zwei NaN als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert einen C#-ähnlichen Vergleich von Gleitkommazahlen, bei dem zwei NaN als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der durch die Sammlung iteriert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\> [idx_get](./idx_get/)(**int32_t**) override | Gibt die Signatur anhand des Index zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Überspringt eine festgelegte Anzahl zusammenhängender Elemente am Anfang einer Sequenz und gibt den Rest zurück. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Gibt eine festgelegte Anzahl zusammenhängender Elemente vom Anfang einer Sequenz zurück. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Entfernt die Signatur am angegebenen Index. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Liefert einen Iterator, der unmittelbar nach dem letzten Element (falls vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Liefert einen Iterator, der unmittelbar nach dem letzten Element (falls vorhanden) der Sammlung zeigt. |
