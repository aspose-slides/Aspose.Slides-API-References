...
description: Stellt die Größe und Orientierung einer Folie dar.
type: docs
weight: 3823
...
Stellt die Größe und Orientierung einer Folie dar.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imitiert C#-artige Gleitkommavergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imitiert C#-artige Gleitkommavergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| virtual [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() | Gibt die Folienorientierung zurück. |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Gibt die Folienabmessungen in Punkten zurück. Das Zuweisen eines neuen Wertes setzt den [ISlideSize::get_Type](./get_type/) Wert auf [SlideSizeType::Custom](../slidesizetype/) zurück und setzt [ISlideSize::get_Orientation](./get_orientation/). |
| virtual [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() | Gibt den Foliengrößentyp zurück. Das Zuweisen eines beliebigen Wertes außer [SlideSizeType::Custom](../slidesizetype/) passt das [ISlideSize::get_Size](./get_size/) gemäß den vordefinierten Abmessungen an, wobei das aktuelle [ISlideSize::get_Orientation](./get_orientation/) beibehalten wird. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gibt die Referenzzähler-Datenstruktur, die mit dem Objekt verbunden ist, zurück. |
...
| virtual void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) | Setzt die Folienorientierung. |
| virtual void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) | Setzt die Foliengröße nach Typ und skaliert vorhandenen Inhalt. Das Zuweisen eines beliebigen Wertes außer [SlideSizeType::Custom](../slidesizetype/) passt das [ISlideSize::get_Size](./get_size/) anhand des ausgewählten Typs an, während [ISlideSize::get_Orientation](./get_orientation/) beibehalten wird. |
| virtual void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) | Setzt die Folienabmessungen explizit und skaliert vorhandenen Inhalt. Dies setzt den [ISlideSize::get_Type](./get_type/)-Wert auf [SlideSizeType::Custom](../slidesizetype/) zurück und setzt das [ISlideSize::get_Orientation](./get_orientation/). |
