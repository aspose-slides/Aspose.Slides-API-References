...
| virtual **bool** [get_AutoAdjust](./get_autoadjust/)() | Gibt an, ob die Größe des Seiteninhaltsbereichs die neue Größe beim Ändern der Fenstergröße, das die Ansicht enthält, innerhalb der Anwendung kompensieren soll. Lese **bool**. |
| virtual **float** [get_DimensionSize](./get_dimensionsize/)() | Gibt die Größe des Folienbereichs an (Breite, wenn ein Kind von RestoredTop, Höhe, wenn ein Kind von RestoredLeft). Lese **float**. |
...
| virtual void [set_AutoAdjust](./set_autoadjust/)(**bool**) | Gibt an, ob die Größe des Seiteninhaltsbereichs die neue Größe beim Ändern der Fenstergröße, das die Ansicht enthält, innerhalb der Anwendung kompensieren soll. Schreibe **bool**. |
| virtual void [set_DimensionSize](./set_dimensionsize/)(**float**) | Gibt die Größe des Folienbereichs an (Breite, wenn ein Kind von RestoredTop, Höhe, wenn ein Kind von RestoredLeft). Schreibe **float**. |
