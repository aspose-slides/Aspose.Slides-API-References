...
description: Diese Klasse repräsentiert das Token, das zur Signalisierung von langfristig laufenden Aufgaben verwendet wird, wenn eine Unterbrechung angefordert wurde.
type: docs
weight: 3056
...
Diese Klasse repräsentiert das Token, das zur Signalisierung von langfristig laufenden Aufgaben verwendet wird, wenn eine Unterbrechung angefordert wurde.
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Gibt **bool**.true zurück, wenn eine Unterbrechung angefordert wurde. |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | Stellt ein leeres Unterbrechungs-Token dar. |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | Wirft eine Ausnahme, wenn eine Unterbrechung angefordert wurde. |
