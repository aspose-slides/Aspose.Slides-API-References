...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Gibt den Iterator zurück, der unmittelbar nach dem letzten const-qualifizierten Element (falls vorhanden) der Sammlung liegt. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>\>, **int32_t**) override | Kopiert die gesamte Sammlung in das angegebene Array. |
...
| [iterator](./iterator/) [end](./end/)() | Gibt den Iterator zurück, der unmittelbar nach dem letzten Element (falls vorhanden) der Sammlung liegt. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Gibt den Iterator zurück, der unmittelbar nach dem letzten Element (falls vorhanden) der const-qualifizierten Instanz der Sammlung liegt. |
...
| **int32_t** [get_Count](./get_count/)() override | Gibt die tatsächlich in der Sammlung enthaltene Anzahl von Elementen zurück. Nur lesend **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Gibt ein Synchronisations-Root zurück. Nur lesend [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der durch die Sammlung iteriert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [idx_get](./idx_get/)(**int32_t**) override | Gibt das Element am angegebenen Index zurück. Nur lesend [ISlide](../islide/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Setzt das n-te Template-Argument zu einem schwachen Zeiger (statt shared). Ermöglicht das Umstellen von Zeigern in Containern auf den schwachen Modus. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Gibt den Iterator zurück, der unmittelbar nach dem letzten Element (falls vorhanden) der const-qualifizierten Instanz der Sammlung liegt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Gibt den Iterator zurück, der unmittelbar nach dem letzten Element (falls vorhanden) der Sammlung liegt. |
...
* Klasse [ISectionSlideCollection](../isectionslidecollection/)
