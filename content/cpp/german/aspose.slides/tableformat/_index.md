...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Gibt ein Objekt mit den Füll-Eigenschaften der Tabelle zurück. Nur lesend [IFillFormat](../ifillformat/). |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../idomobject/)\> [get_Parent_Immediate](../idomobject/get_parent_immediate/)() | Gibt ein Parent_Immediate-Objekt zurück. Nur lesend [IDOMObject](../idomobject/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() override | Ermittelt die effektiven Tabellenformatierungs-Eigenschaften mit Vererbung und angewandten Tabellenstilen. |
...
| void [set_Transparency](./set_transparency/)(**float**) override | Setzt die Transparenz der Füllfarbe. Schreibe **float**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Setzt das n-te Template-Argument auf einen schwachen Zeiger (anstatt eines geteilten). Ermöglicht das Wechseln von Zeigern in Containern in den schwachen Modus. |
...
* Klasse [ITableFormat](../itableformat/)
