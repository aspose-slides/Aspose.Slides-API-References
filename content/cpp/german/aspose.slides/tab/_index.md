...
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | Vergleicht die aktuelle Instanz mit einem anderen Objekt desselben Typs. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | Gibt den Ausrichtungsstil eines Tabs zurück. Siehe [TabAlignment](../tabalignment/). |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../ipviobject/get_parent_ipresentationcomponent/)() | Gibt den Eltern-[IPresentationComponent](../ipresentationcomponent/) zurück. Nur lesend [IPresentationComponent](../ipresentationcomponent/). |
| **double** [get_Position](./get_position/)() override | Gibt die Position eines Tabs zurück. Das Zuweisen dieser Eigenschaft kann den Index des Tabs in der Sammlung ändern und den Enumerator ungültig machen. Lesen **double**. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | Setzt den Ausrichtungsstil eines Tabs. Schreiben [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | Setzt die Position eines Tabs. Das Zuweisen dieser Eigenschaft kann den Index des Tabs in der Sammlung ändern und den Enumerator ungültig machen. Schreiben **double**. |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | Erstellt ein neues [Tab](./) |
