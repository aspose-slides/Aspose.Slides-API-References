...
description: Stellt einen Manager dar, der das Verhalten des Folienfußes, des Datum-Uhrzeit-Platzhalters und des Seitenzahlen-Platzhalters verwaltet.
type: docs
weight: 3797
...
| virtual **bool** [get_IsDateTimeVisible](../ibaseslideheaderfootermanager/get_isdatetimevisible/)() | Liefert einen Wert, der angibt, dass ein Datums-Uhrzeit-Platzhalter vorhanden ist. Read**bool**. |
| virtual **bool** [get_IsFooterVisible](../ibaseslideheaderfootermanager/get_isfootervisible/)() | Liefert einen Wert, der angibt, dass ein Fußzeilen-Platzhalter vorhanden ist. Read **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](../ibaseslideheaderfootermanager/get_isslidenumbervisible/)() | Liefert einen Wert, der angibt, dass ein Seitenzahl-Platzhalter vorhanden ist. Read**bool**. |
...
| virtual void [SetDateTimeText](../ibaseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) | Setzt Text für den Datums-Uhrzeit-Platzhalter der Folie. |
| virtual void [SetDateTimeVisibility](../ibaseslideheaderfootermanager/setdatetimevisibility/)(**bool**) | Ändert die Sichtbarkeit des Datums-Uhrzeit-Platzhalters der Folie. |
