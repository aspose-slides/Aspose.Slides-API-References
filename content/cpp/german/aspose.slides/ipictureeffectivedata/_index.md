...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() | Gibt das eingebettete Bild zurück. Nur lesend [IPPImage](../ippimage/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/)\> [get_ImageTransform](./get_imagetransform/)() | Gibt die Sammlung von Bild-Transformations-Effekten zurück. Nur lesend [Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IEffectEffectiveData](../../aspose.slides.effects/ieffecteffectivedata/)\> [get_ImageTransformEffect](./get_imagetransformeffect/)(**int32_t**) | Gibt den Bild-Transformations-Effekt zurück, der am angegebenen Index liegt. |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Gibt die URL des verknüpften Bildes zurück. Nur lesend [System::String](../../system/string/). |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Zuweisungsoperator. Kopiert nichts, sondern nur ein neues Objekt initialisiert und das Kopieren von Unterklassen ermöglicht. |
...
Dieses Interface wird als Teil von [IPictureFillFormatEffectiveData](../ipicturefillformateffectivedata/) und [IBulletFormatEffectiveData](../ibulletformateffectivedata/) verwendet.
