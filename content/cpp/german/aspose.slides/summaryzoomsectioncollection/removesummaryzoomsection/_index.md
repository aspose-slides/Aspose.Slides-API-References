...
---
## SummaryZoomSectionCollection::RemoveSummaryZoomSection(System::SharedPtr\<ISection\>) Methode
...
| --- | --- | --- |
| section | [System::SharedPtr](../../../system/sharedptr/)\<[ISection](../../isection/)\> | [Section](../../section/) für die das Summary Zoom [Section](../../section/) Element entfernt werden soll [ISection](../../isection/). |
## Hinweise

Das Beispiel demonstriert das Abrufen des Summary Zoom [Section](../../section/) Elements anhand des Indexes:
```cpp
