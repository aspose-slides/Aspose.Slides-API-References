...
Bestimmt, welche Vorgänge am übergeordneten [Connector](../connector/) deaktiviert sind.
...
| **bool** [get_PositionMove](./get_positionmove/)() override | Bestimmt, ob das Bewegen dieser Form verboten ist. Lese-**bool**. |
...
| **bool** [get_SizeLocked](./get_sizelocked/)() override | Bestimmt, ob das Skalieren dieser Form verboten ist. Lese-**bool**. |
...
| void [set_AdjustHandlesLocked](./set_adjusthandleslocked/)(**bool**) override | Bestimmt, ob das Ändern von Anpassungswerten verboten ist. Schreib-**bool**. |
| void [set_ArrowheadsLocked](./set_arrowheadslocked/)(**bool**) override | Bestimmt, ob das Ändern von Pfeilspitzen verboten ist. Schreib-**bool**. |
| void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) override | Bestimmt, ob eine Form beim Skalieren das Seitenverhältnis beibehalten muss. Schreib-**bool**. |
| void [set_EditPointsLocked](./set_editpointslocked/)(**bool**) override | Bestimmt, ob eine direkte Änderung der Kontur dieser Form verboten ist. Schreib-**bool**. |
| void [set_GroupingLocked](./set_groupinglocked/)(**bool**) override | Bestimmt, ob das Hinzufügen dieser Form zu einer Gruppe verboten ist. Schreib-**bool**. |
| void [set_PositionMove](./set_positionmove/)(**bool**) override | Bestimmt, ob das Bewegen dieser Form verboten ist. Schreib-**bool**. |
| void [set_RotateLocked](./set_rotatelocked/)(**bool**) override | Bestimmt, ob das Ändern des Rotationswinkels dieser Form verboten ist. Schreib-**bool**. |
| void [set_SelectLocked](./set_selectlocked/)(**bool**) override | Bestimmt, ob das Auswählen dieser Form verboten ist. Schreib-**bool**. |
| void [set_ShapeTypeLocked](./set_shapetypelocked/)(**bool**) override | Bestimmt, ob das Ändern des Formtyps verboten ist. Schreib-**bool**. |
| void [set_SizeLocked](./set_sizelocked/)(**bool**) override | Bestimmt, ob das Skalieren dieser Form verboten ist. Schreib-**bool**. |
