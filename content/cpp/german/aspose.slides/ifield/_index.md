...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\> [get_Type](./get_type/)() | Gibt den Typ des Feldes zurück. Lesen [IFieldType](../ifieldtype/). |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren der C#-lock()-Anweisung. Direkt aufrufen oder das Wächterobjekt [LockContext](../../system/lockcontext/) verwenden. |
...
| virtual void [set_Type](./set_type/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) | Setzt den Feldtyp. Schreiben [IFieldType](../ifieldtype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren der C#-lock()-Anweisung. Direkt aufrufen oder das Wächterobjekt [LockContext](../../system/lockcontext/) verwenden. |
