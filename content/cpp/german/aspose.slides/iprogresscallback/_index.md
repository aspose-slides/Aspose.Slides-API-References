...
description: Stellt ein Callback-Objekt für das Speichern von Fortschrittsaktualisierungen in Prozent dar.
type: docs
weight: 3446
url: /de/aspose.slides/iprogresscallback/
---
## IProgressCallback Klasse

Stellt ein Callback-Objekt für das Speichern von Fortschrittsaktualisierungen in Prozent dar.
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gibt die dem Objekt zugeordnete Referenzzähler-Datenstruktur zurück. |
...
| virtual void [Reporting](./reporting/)(**double**) | Meldet eine Fortschrittsaktualisierung. |
