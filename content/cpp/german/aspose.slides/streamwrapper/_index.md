...
| --- | --- |
| void [Close](./close/)() override | Schließt den aktuellen Stream und gibt alle Ressourcen frei. |
...
| void [Flush](./flush/)() override | Löscht alle Puffer dieses Streams und sorgt dafür, dass gepufferte Daten an das zugrunde liegende Gerät geschrieben werden. |
| **bool** [get_CanRead](./get_canread/)() override | Gibt einen Wert zurück, der angibt, ob der aktuelle Stream Leseoperationen unterstützt. Nur-Lese **bool**. |
| **bool** [get_CanSeek](./get_canseek/)() override | Gibt einen Wert zurück, der angibt, ob der aktuelle Stream Positionierung unterstützt. Nur-Lese **bool**. |
| **bool** [get_CanWrite](./get_canwrite/)() override | Gibt einen Wert zurück, der angibt, ob der aktuelle Stream Schreiboperationen unterstützt. Nur-Lese **bool**. |
| **int64_t** [get_Length](./get_length/)() override | Gibt die Länge des Streams in Bytes zurück. Nur-Lese **int64_t**. |
| **int64_t** [get_Position](./get_position/)() override | Gibt die Position im aktuellen Stream zurück. Nur-Lese **int64_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [get_Stream](./get_stream/)() override | Gibt einen Stream zurück. Nur-Lese [System::IO::Stream](../../system.io/stream/). |
...
| void [Read](./read/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) override | Liest eine Sequenz von Bytes aus dem aktuellen Stream und erhöht die Position im Stream um die gelesene Byte-Anzahl. |
| **int32_t** [ReadByte](./readbyte/)() override | Liest ein Byte aus dem Stream und erhöht die Position im Stream um ein Byte, oder gibt -1 zurück, wenn das Ende des Streams erreicht ist. |
...
| **int64_t** [Seek](./seek/)(**int64_t**, [System::IO::SeekOrigin](../../system.io/seekorigin/)) override | Setzt die Position im aktuellen Stream |
...
| void [Write](./write/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) override | Schreibt eine Sequenz von Bytes in den aktuellen Stream und erhöht die aktuelle Position in diesem Stream um die Anzahl der geschriebenen Bytes. |
| void [WriteByte](./writebyte/)(**uint8_t**) override | Schreibt ein Byte an die aktuelle Position im Stream und erhöht die Position im Stream um ein Byte. |
