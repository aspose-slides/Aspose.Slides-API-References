...
description: Gibt das ThreeDFormat-Objekt zurück, das die 3D-Effekteigenschaften für einen Text darstellt. Schreibgeschützt IThreeDFormat.
type: docs
weight: 1
url: /de/aspose.slides/textframeformat/get_threedformat/
---
## TextFrameFormat::get_ThreeDFormat() Methode


Gibt das [ThreeDFormat](../../threedformat/)-Objekt zurück, das die 3d-Effekteigenschaften für einen Text darstellt. Schreibgeschützt [IThreeDFormat](../../ithreedformat/).
