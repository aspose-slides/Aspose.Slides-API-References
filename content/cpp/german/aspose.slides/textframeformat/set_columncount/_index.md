...
description: Legt die Anzahl der Spalten im Textbereich fest. Dieser Wert muss eine positive Zahl sein. Andernfalls wird der Wert auf Null gesetzt. Der Wert 0 bedeutet einen undefinierten Wert. Schreiben int32_t.
type: docs
weight: 261
url: /de/aspose.slides/textframeformat/set_columncount/
---
## TextFrameFormat::set_ColumnCount(int32_t) Methode


Legt die Anzahl der Spalten im Textbereich fest. Dieser Wert muss eine positive Zahl sein. Andernfalls wird der Wert auf Null gesetzt. Der Wert 0 bedeutet einen undefinierten Wert. Schreiben **int32_t**.
...
Der folgende Beispielcode zeigt, wie man eine Spalte im Textfeld innerhalb einer PowerPoint [Presentation](../../presentation/) hinzufügt. 
```cpp
