...
Stellt gemeinsame Folienansichts-Eigenschaften dar.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | Gibt die Zeichenführung am angegebenen Index zurück. Schreibgeschützt [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | Gibt die Sammlung der Zeichenführungen zurück. Schreibgeschützt [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | Legt das Ansichts-Skalierungsverhältnis in Prozent fest. Lesen **int32_t**. |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | Legt fest, dass der Ansichtinhalt automatisch skaliert, um optimal in die aktuelle Fenstergröße zu passen. Lesen **bool**. |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | Legt das Ansichts-Skalierungsverhältnis in Prozent fest. Schreiben **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | Legt fest, dass der Ansichtinhalt automatisch skaliert, um optimal in die aktuelle Fenstergröße zu passen. Schreiben **bool**. |
