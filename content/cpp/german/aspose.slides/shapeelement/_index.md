...
description: Stellt einen Teil einer Form mit denselben Kontur- und Füllungseigenschaften dar.
type: docs
weight: 5123
...
Stellt einen Teil einer Form mit denselben Kontur- und Füllungs-Eigenschaften dar.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-artigen Gleitkommavergleich, bei dem zwei NaNs als gleich angesehen werden, obwohl sie gemäß IEC 60559:1989 nicht gleich einem Wert, einschließlich NaN, sind. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Gleitkommavergleich, bei dem zwei NaNs als gleich angesehen werden, obwohl sie gemäß IEC 60559:1989 nicht gleich einem Wert, einschließlich NaN, sind. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| [ShapeElementFillSource](../shapeelementfillsource/) [get_FillSource](./get_fillsource/)() | Gibt Informationen darüber zurück, wie ein Element gefüllt wird. Nur-Lese [ShapeElementFillSource](../shapeelementfillsource/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Shape](../shape/)\> [get_ParentShape](./get_parentshape/)() | Gibt ein Shape_PPT zurück, für das das Element erstellt wurde. Nur-Lese [Shape](../shape/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_PathPoints](./get_pathpoints/)() | Gibt ein Array von Punkten zurück, das die Geometrie des Pfads des Elements definiert. |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_PathTypes](./get_pathtypes/)() | Gibt ein Array von Byte-Werten zurück, das den Typ jedes Punktes im Pfad des Elements angibt. |
| [ShapeElementStrokeSource](../shapeelementstrokesource/) [get_StrokeSource](./get_strokesource/)() | Gibt Informationen darüber zurück, wie ein Element konturiert wird. Nur-Lese [ShapeElementStrokeSource](../shapeelementstrokesource/). |
