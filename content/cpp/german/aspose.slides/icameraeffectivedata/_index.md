...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) Typ. Nur lesbar [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 Grad, Sichtfeld). Nur lesbar **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) Zoom (positiver Wert in Prozent). Nur lesbar **float**. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Eine Rotation wird durch die Verwendung einer Breitengradkoordinate, einer Längengradkoordinate und einer Drehung um die Achse definiert, die den Breitengrad- und Längengradkoordinaten entspricht. Erstes Element im Rückgabe-Array – Breitengrad, zweites – Längengrad, drittes – Drehung. Gibt null zurück, wenn keine Rotation definiert ist. |
...
Dieses Interface wird als Teil von [IThreeDFormatEffectiveData](../ithreedformateffectivedata/) verwendet.
