...
description: Stellt eine Sammlung aller Layout-Folien in einer Präsentation dar. Erweitert die LayoutSlideCollection Klasse mit Methoden zum Hinzufügen/Klonen von Layout-Folien im Kontext der Zusammenführung der einzelnen Sammlungen von Master-Layout-Folien.
type: docs
weight: 1093
...
Stellt eine Sammlung aller Layout-Folien in einer Präsentation dar. Erweitert die [LayoutSlideCollection](../layoutslidecollection/) Klasse mit Methoden zum Hinzufügen/Klonen von Layout-Folien im Kontext der Zusammenführung der einzelnen Sammlungen von Master-Layout-Folien.
...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) override | Fügt der Präsentation eine neue Layout-Folie hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | Fügt der Präsentation eine Kopie einer angegebenen Layout-Folie hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Fügt der Präsentation eine Kopie einer angegebenen Layout-Folie hinzu. |
...
| [const_iterator](../layoutslidecollection/const_iterator/) [begin](../layoutslidecollection/begin/)() const | Gibt einen Iterator zurück, der auf das erste Element (falls vorhanden) der konstanten Instanz der Sammlung zeigt. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cbegin](../layoutslidecollection/cbegin/)() const | Gibt einen Iterator zurück, der auf das erste konstante Element (falls vorhanden) der Sammlung zeigt. |
| [const_iterator](../layoutslidecollection/const_iterator/) [cend](../layoutslidecollection/cend/)() const | Gibt einen Iterator zurück, der direkt nach dem letzten konstanten Element (falls vorhanden) der Sammlung zeigt. |
...
| [iterator](../layoutslidecollection/iterator/) [end](../layoutslidecollection/end/)() | Gibt einen Iterator zurück, der direkt nach dem letzten Element (falls vorhanden) der Sammlung zeigt. |
| [const_iterator](../layoutslidecollection/const_iterator/) [end](../layoutslidecollection/end/)() const | Gibt einen Iterator zurück, der direkt nach dem letzten Element (falls vorhanden) der konstanten Instanz der Sammlung zeigt. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert einen C#-ähnlichen Vergleich von Fließkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert einen C#-ähnlichen Vergleich von Fließkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| **int32_t** [get_Count](../layoutslidecollection/get_count/)() override | Gibt die Anzahl der Layout-Folien in einer Sammlung zurück. Schreibgeschützt **int32_t**. |
| **bool** [get_IsSynchronized](../layoutslidecollection/get_issynchronized/)() override | Gibt einen Wert zurück, der angibt, ob der Zugriff auf die Sammlung synchronisiert (thread-sicher) ist. Schreibgeschützt **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../layoutslidecollection/get_syncroot/)() override | Gibt eine Synchronisationswurzel zurück. Schreibgeschützt [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>\> [GetEnumerator](../layoutslidecollection/getenumerator/)() override | Gibt einen Enumerator zurück, der die Sammlung durchläuft. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../layoutslidecollection/idx_get/)(**int32_t**) override | Gibt die Layout-Folie nach Index zurück. Schreibgeschützt [LayoutSlide](../layoutslide/). |
...
| void [RemoveUnused](../layoutslidecollection/removeunused/)() override | Entfernt ungenutzte Layout-Folien (Layout-Folien, deren HasDependingSlides false ist). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument zu einem schwachen Zeiger (statt einem gemeinsam genutzten). Ermöglicht das Umschalten von Zeigern in Containern in den schwachen Modus. |
...
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeBeginConstIterator](../layoutslidecollection/virtualizebeginconstiterator/)() const override | Gibt einen Iterator zurück, der auf das erste Element (falls vorhanden) der konstanten Instanz der Sammlung zeigt. |
...
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndConstIterator](../layoutslidecollection/virtualizeendconstiterator/)() const override | Gibt einen Iterator zurück, der direkt nach dem letzten Element (falls vorhanden) der konstanten Instanz der Sammlung zeigt. |
| [virtualized_iterator](../layoutslidecollection/virtualized_iterator/) * [virtualizeEndIterator](../layoutslidecollection/virtualizeenditerator/)() override | Gibt einen Iterator zurück, der direkt nach dem letzten Element (falls vorhanden) der Sammlung zeigt. |
