...
| **int32_t** [get_Count](./get_count/)() override | Gibt die Anzahl der Teile in der Gruppe zurück. Nur-Lese **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Gibt den Gruppennamen der Dokumentteile zurück. Nur-Lese [System::String](../../system/string/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-Konstruktor. Kopiert eigentlich nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopierkonstruieren von Unterklassen. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument zu einem schwachen Zeiger (statt einem shared). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
