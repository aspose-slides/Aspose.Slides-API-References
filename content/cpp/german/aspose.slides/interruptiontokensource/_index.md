...
description: Stellt die Quelle von InterruptionToken dar.
type: docs
weight: 3069
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Gibt true zurück, wenn eine Unterbrechung angefordert wurde, sonst false. |
| [System::SharedPtr](../../system/sharedptr/)\<[IInterruptionToken](../iinterruptiontoken/)\> [get_Token](./get_token/)() override | Gibt ein neues Token zurück, das an dieses [InterruptionTokenSource](./) gebunden ist. |
...
| void [Interrupt](./interrupt/)() override | Initialisiert die Anforderung einer Unterbrechung. |
| [InterruptionTokenSource](./interruptiontokensource/)() | Erstellt ein neues [InterruptionTokenSource](./). |
