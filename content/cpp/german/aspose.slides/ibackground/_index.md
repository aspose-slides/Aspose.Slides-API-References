...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | Gibt ein [EffectFormat](../effectformat/) für [BackgroundType::OwnBackground](../backgroundtype/)-Füllung zurück. Nur lesbar [IEffectFormat](../ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Gibt ein [FillFormat](../fillformat/) für [BackgroundType::OwnBackground](../backgroundtype/)-Füllung zurück. Nur lesbar [IFillFormat](../ifillformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../islidecomponent/get_slide/)() | Gibt die Basissfolie zurück. Nur lesbar [IBaseSlide](../ibaseslide/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | Gibt ein [ColorFormat](../colorformat/) für eine [BackgroundType::Themed](../backgroundtype/)-Füllung zurück. Nur lesbar [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | Gibt einen Index der [BackgroundType::Themed](../backgroundtype/)-Füllung in der Hintergrund-Themensammlung zurück. 0 bedeutet keine Füllung. 1..999 – Index. Nur lesend **uint16_t**. |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | Gibt einen Typ der Hintergrund-Füllung zurück. Nur lesend [BackgroundType](../backgroundtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ermittelt die Referenzzähler-Datenstruktur, die dem Objekt zugeordnet ist. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | Ermittelt die wirksamen Hintergrunddaten mit angewandter Vererbung. |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | Setzt einen Index der [BackgroundType::Themed](../backgroundtype/)-Füllung in der Hintergrund-Themensammlung. 0 bedeutet keine Füllung. 1..999 – Index. Schreiben **uint16_t**. |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | Setzt einen Typ der Hintergrund-Füllung. Schreiben [BackgroundType](../backgroundtype/). |
