...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [get_Author](./get_author/)() | Gibt den Autor eines Kommentars zurück. Schreibgeschützt [ICommentAuthor](../icommentauthor/). |
| virtual [System::DateTime](../../system/datetime/) [get_CreatedTime](./get_createdtime/)() | Gibt den Erstellungszeitpunkt eines Kommentars zurück. Das Setzen dieser Eigenschaft auf [DateTime::MinValue](../../system/datetime/minvalue/) bedeutet, dass keine Kommentarzeit festgelegt ist. Lesen [System::DateTime](../../system/datetime/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](./)\> [get_ParentComment](./get_parentcomment/)() | Ermittelt übergeordneten Kommentar. Lesen [IComment](./). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_Position](./get_position/)() | Gibt die Position eines Kommentars auf einer Folie zurück. Lesen [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_Slide](./get_slide/)() | Gibt die übergeordnete Folie eines Kommentars zurück. Schreibgeschützt [ISlide](../islide/). |
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Gibt den reinen Text eines Folienkommentars zurück. Lesen [System::String](../../system/string/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Vergleicht Referenzen von Werttypobjekten mit nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | Spezialisierung von [Object::ReferenceEquals](../../system/object/referenceequals/) für den Fall von string und nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | Spezialisierung von [Object::ReferenceEquals](../../system/object/referenceequals/) für den Fall von Zeichenketten. |
| virtual void [Remove](./remove/)() | Entfernt den Kommentar und alle seine Antworten aus der übergeordneten Sammlung. |
...
| virtual void [set_CreatedTime](./set_createdtime/)([System::DateTime](../../system/datetime/)) | Setzt den Erstellungszeitpunkt eines Kommentars. Das Setzen dieser Eigenschaft auf [DateTime::MinValue](../../system/datetime/minvalue/) bedeutet, dass keine Kommentarzeit festgelegt ist. Schreiben [System::DateTime](../../system/datetime/). |
| virtual void [set_ParentComment](./set_parentcomment/)([System::SharedPtr](../../system/sharedptr/)\<[IComment](./)\>) | Setzt den übergeordneten Kommentar. Schreiben [IComment](./). |
| virtual void [set_Position](./set_position/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Setzt die Position eines Kommentars auf einer Folie. Schreiben [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | Setzt den reinen Text eines Folienkommentars. Schreiben [System::String](../../system/string/). |
