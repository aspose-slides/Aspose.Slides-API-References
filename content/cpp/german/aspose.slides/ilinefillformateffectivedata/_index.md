...
description: Unveränderliches Objekt, das effektive Linienfüllungs-Eigenschaften enthält.
type: docs
weight: 2744
...
Unveränderliches Objekt, das effektive Linienfüllungs-Eigenschaften enthält.
...
| virtual [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() | Gibt den Fülltyp zurück. Nur lesend [Slides::FillType](../filltype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormatEffectiveData](../igradientformateffectivedata/)\> [get_GradientFormat](./get_gradientformat/)() | Gibt das Farbverlauf-Füllformat zurück. Nur lesend [IGradientFormatEffectiveData](../igradientformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormatEffectiveData](../ipatternformateffectivedata/)\> [get_PatternFormat](./get_patternformat/)() | Gibt das Muster-Füllformat zurück. Nur lesend [IPatternFormatEffectiveData](../ipatternformateffectivedata/). |
| virtual **bool** [get_RotateWithShape](./get_rotatewithshape/)() | Bestimmt, ob die Füllung mit einer Form rotiert werden soll. Nur lesend **bool**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_SolidFillColor](./get_solidfillcolor/)() | Gibt die Farbe einer Vollfüllung zurück. Nur lesend [System::Drawing::Color](../../system.drawing/color/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopie-Konstruktor. Kopiert nichts wirklich, sondern initialisiert ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
