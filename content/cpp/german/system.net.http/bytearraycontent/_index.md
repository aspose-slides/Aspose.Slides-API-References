...
description: "Stellt HTTP-Inhalt als Byte-Array dar. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 1
url: /de/system.net.http/bytearraycontent/
---
## ByteArrayContent Klasse

Stellt HTTP-Inhalt als Byte-Array dar. Objekte dieser Klasse sollten nur mit der [System::MakeObject()](../../system/makeobject/)-Funktion alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
|  [ByteArrayContent](./bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Erstellt eine neue Instanz. |
|  [ByteArrayContent](./bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | Erstellt eine neue Instanz. |
| void [Dispose](../httpcontent/dispose/)() override | Gibt die aktuelle Instanz frei. Diese Methode gibt außerdem den Stream frei, der von 'ReadAsStream' zurückgegeben wird, sowie den Speicherpuffer, falls er erstellt wurde. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpContentHeaders](../../system.net.http.headers/httpcontentheaders/)\> [get_Headers](../httpcontent/get_headers/)() | Gibt die HTTP-Content-Header zurück. |
...
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)() | Serialisiert den Inhalt in einen Speicherpuffer. |
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)(**int64_t**) | Serialisiert den Inhalt in einen Speicherpuffer. |
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren durch die C#-Anweisung lock(). Direkt aufrufen oder das [LockContext](../../system/lockcontext/)-Wächterobjekt verwenden. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ReadAsByteArray](../httpcontent/readasbytearray/)() | Serialisiert den Inhalt und gibt ein Byte-Array zurück. |
| [System::SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [ReadAsStream](../httpcontent/readasstream/)() | Serialisiert den Inhalt und gibt einen Stream zurück. |
| [String](../../system/string/) [ReadAsString](../httpcontent/readasstring/)() | Serialisiert den Inhalt und gibt einen String zurück. |
...
| **bool** [TryComputeLength](./trycomputelength/)(**int64_t**\&) override | Versucht, die Länge des Byte-Arrays zu berechnen. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementiert das C#-Konstrukt typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren durch die C#-Anweisung lock(). Direkt aufrufen oder das [LockContext](../../system/lockcontext/)-Wächterobjekt verwenden. |
...
* Klasse [HttpContent](../httpcontent/)
