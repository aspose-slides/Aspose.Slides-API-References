...
description: "Die Basisausnahmeklasse wird von den Klassen HttpClient und HttpMessageHandler geworfen. Erstellen Sie niemals Instanzen dieser Klasse manuell. Verwenden Sie stattdessen die Klasse HttpRequestException. Wickeln Sie die Instanzen der Klasse HttpRequestException niemals in System::SmartPtr ein."
type: docs
weight: 14
url: /de/system.net.http/details_httprequestexception/
---
## Details_HttpRequestException Klasse


Die Basisausnahmeklasse wird von den Klassen [HttpClient](../httpclient/) und [HttpMessageHandler](../httpmessagehandler/) geworfen. Erstellen Sie niemals Instanzen dieser Klasse manuell. Verwenden Sie stattdessen die Klasse HttpRequestException. Wickeln Sie die Instanzen der Klasse HttpRequestException niemals in [System::SmartPtr](../../system/smartptr/) ein.
...
| --- | --- |
|  [Details_HttpRequestException](./details_httprequestexception/)() | Konstruiert eine neue Instanz. |
|  [Details_HttpRequestException](./details_httprequestexception/)(std::nullptr_t) | Konstruiert eine neue Instanz. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/)) | Konstruiert eine neue Instanz. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Konstruiert eine neue Instanz. |
| virtual void [DoThrow](../../system/details_exception/dothrow/)(const [ExceptionPtr](../../system/exceptionptr/)\&) const | Wirft eine Ausnahmeinstanz, die von einem Ausnahme-Wrapper umschlossen ist. |
