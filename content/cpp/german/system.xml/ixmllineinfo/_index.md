...
description: Stellt eine Schnittstelle bereit, mit der eine Klasse Zeilen- und Positionsinformationen zurückgeben kann.
type: docs
weight: 40
url: /de/system.xml/ixmllineinfo/
---
## IXmlLineInfo Klasse
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Gibt die aktuelle Zeilennummer zurück. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Gibt die aktuelle Zeilenposition zurück. |
...
| virtual **bool** [HasLineInfo](./haslineinfo/)() | Gibt einen Wert zurück, der angibt, ob die Klasse Zeileninformationen zurückgeben kann. |
