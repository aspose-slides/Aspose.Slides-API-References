...
description: Stellt ein leichtgewichtiges Objekt dar, das für Baum-Einfügungsoperationen nützlich ist.
type: docs
weight: 196
url: /de/system.xml/xmldocumentfragment/
---
## XmlDocumentFragment Klasse

Stellt ein leichtgewichtiges Objekt dar, das für Baum-Einfügungsoperationen nützlich ist.
...
| Method | Description |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Fügt den angegebenen Knoten ans Ende der Liste von Kindknoten dieses Knotens hinzu. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Gibt einen Wert zurück, der angibt, ob dieser Knoten Kindknoten besitzt. |
...
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Gibt das Markup zurück, das die Kinder dieses Knotens darstellt. |
...
| virtual [String](../../system/string/) [get_NamespaceURI](../xmlnode/get_namespaceuri/)() | Gibt die Namensraum-URI dieses Knotens zurück. |
...
| virtual [String](../../system/string/) [get_Prefix](../xmlnode/get_prefix/)() | Gibt das Namensraum-Präfix dieses Knotens zurück. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Gibt das nach der Schema-Validierung zugewiesene Infoset zurück, das diesem Knoten zugewiesen wurde. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten nächstliegende **xmlns**-Deklaration für das angegebene Präfix, das im Geltungsbereich ist, und gibt die Namensraum-URI aus der Deklaration zurück. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten nächstliegende **xmlns**-Deklaration für die angegebene Namensraum-URI, die im Geltungsbereich ist, und gibt das in der Deklaration definierte Präfix zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projiziert jedes Element einer Sequenz und kombiniert die entstandenen Sequenzen zu einer einzigen Sequenz. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Bringt alle [XmlText](../xmltext/)-Knoten in der vollen Tiefe des Unterbaums unterhalb dieses [XmlNode](../xmlnode/) in eine „normale“ Form, in der nur Markup (also Tags, Kommentare, Verarbeitungsanweisungen, CDATA-Abschnitte und Entity-Referenzen) [XmlText](../xmltext/)-Knoten trennt, d.h. es gibt keine benachbarten [XmlText](../xmltext/)-Knoten. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Fügt den angegebenen Knoten am Anfang der Liste von Kindknoten für diesen Knoten hinzu. |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Setzt die zusammengefügten Werte des Knotens und aller seiner Kindknoten. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Setzt das Markup, das die Kinder dieses Knotens darstellt. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument als Weak-Pointer (statt Shared). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert alle Kinder des Knotens in dem angegebenen [XmlWriter](../xmlwriter/). |
