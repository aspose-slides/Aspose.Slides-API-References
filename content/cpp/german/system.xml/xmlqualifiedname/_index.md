...
description: Stellt einen qualifizierten XML-Namen dar.
type: docs
weight: 417
url: /de/system.xml/xmlqualifiedname/
---
## XmlQualifiedName Klasse
...
| --- | --- |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Bestimmt, ob das angegebene [XmlQualifiedName](./) Objekt dem aktuellen [XmlQualifiedName](./) Objekt entspricht. |
...
| **bool** [get_IsEmpty](./get_isempty/)() const | Gibt einen Wert zurück, der angibt, ob [XmlQualifiedName](./) leer ist. |
| [String](../../system/string/) [get_Name](./get_name/)() const | Gibt die Zeichenkettenrepräsentation des qualifizierten Namens von [XmlQualifiedName](./) zurück. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() const | Gibt die Zeichenkettenrepräsentation des Namensraums von [XmlQualifiedName](./) zurück. |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Gibt den Hash-Code für [XmlQualifiedName](./) zurück. |
...
| static [String](../../system/string/) [ToString](./tostring/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Gibt den Zeichenkettenwert von [XmlQualifiedName](./) zurück. |
| [String](../../system/string/) [ToString](./tostring/)() const override | Gibt den Zeichenkettenwert von [XmlQualifiedName](./) zurück. |
...
|  [XmlQualifiedName](./xmlqualifiedname/)(const [String](../../system/string/)\&) | Initialisiert eine neue Instanz der [XmlQualifiedName](./) Klasse mit dem angegebenen Namen. |
|  [XmlQualifiedName](./xmlqualifiedname/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Initialisiert eine neue Instanz der [XmlQualifiedName](./) Klasse mit dem angegebenen Namen und Namespace. |
...
Objekte dieser Klasse sollten ausschließlich mit der Funktion [System::MakeObject()](../../system/makeobject/) zugewiesen werden. Erstellen Sie niemals Instanzen dieses Typs auf dem Stack oder mit operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Pointer und verwenden Sie diesen Pointer, um ihn als Argument an Funktionen zu übergeben. 
