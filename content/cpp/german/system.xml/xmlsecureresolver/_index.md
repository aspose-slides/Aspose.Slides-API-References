...
description: Hilft, eine andere Implementierung von XmlResolver zu sichern, indem das XmlResolver-Objekt umschlossen wird und die Ressourcen eingeschränkt werden, auf die das zugrunde liegende XmlResolver Zugriff hat.
type: docs
weight: 469
url: /de/system.xml/xmlsecureresolver/
---
## XmlSecureResolver Klasse

Hilft, eine andere Implementierung von [XmlResolver](../xmlresolver/) zu sichern, indem das [XmlResolver](../xmlresolver/)-Objekt umschlossen wird und die Ressourcen eingeschränkt werden, auf die [XmlResolver](../xmlresolver/) zugreifen kann.
...
| [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) override | Löst die absolute URI aus Basis- und relativen URIs, indem **ResolveUri** auf dem zugrunde liegenden [XmlResolver](../xmlresolver/) aufgerufen wird. |
| void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) override | Setzt die Anmeldeinformationen, die zur Authentifizierung von Web-Anfragen verwendet werden. |
...
|  [XmlSecureResolver](./xmlsecureresolver/)(const [SharedPtr](../../system/sharedptr/)\<[XmlResolver](../xmlresolver/)\>\&, const [String](../../system/string/)\&) | Initialisiert eine neue Instanz der [XmlSecureResolver](./)-Klasse mit dem bereitgestellten [XmlResolver](../xmlresolver/) und der URL. |
...
Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstelle niemals Instanzen dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickele diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Pointer und verwende diesen Pointer, um ihn als Argument an Funktionen zu übergeben. 
