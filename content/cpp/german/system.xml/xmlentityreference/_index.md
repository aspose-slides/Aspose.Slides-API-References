...
description: Stellt einen Entity-Referenzknoten dar.
type: docs
weight: 248
url: /de/system.xml/xmlentityreference/
---
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Gibt den Basis-Uniform-Resource-Identifier (URI) des aktuellen Knotens zurück. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Gibt einen Wert zurück, der anzeigt, ob dieser Knoten Kindknoten hat. |
...
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Gibt das Markup zurück, das ausschließlich die Kindknoten dieses Knotens darstellt. |
...
| [String](../../system/string/) [get_Name](./get_name/)() override | Gibt den Namen des Knotens zurück. |
| virtual [String](../../system/string/) [get_NamespaceURI](../xmlnode/get_namespaceuri/)() | Gibt den Namespace-URI dieses Knotens zurück. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Gibt den übergeordneten Knoten dieses Knotens zurück (für Knoten, die übergeordnete haben können). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Gibt das nach der Schema-Validierung zugewiesene Infoset des Knotens zurück. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten nächstliegende **xmlns**-Deklaration für das angegebene Präfix, das im Gültigkeitsbereich ist, und gibt den Namespace-URI der Deklaration zurück. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten nächstliegende **xmlns**-Deklaration für den angegebenen Namespace-URI, der im Gültigkeitsbereich ist, und gibt das in dieser Deklaration definierte Präfix zurück. |
...
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Setzt das Markup, das ausschließlich die Kindknoten dieses Knotens darstellt. |
...
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Prüft, ob die DOM-Implementierung ein bestimmtes Merkmal implementiert. |
