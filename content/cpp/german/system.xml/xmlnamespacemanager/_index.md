...
description: Löst Namensräume in einer Sammlung auf, fügt sie hinzu und entfernt sie und stellt eine Bereichsverwaltung für diese Namensräume bereit.
type: docs
weight: 300
url: /de/system.xml/xmlnamespacemanager/
---
## XmlNamespaceManager Klasse

Löst Namensräume auf, fügt sie hinzu und entfernt sie aus einer Sammlung und bietet eine Bereichsverwaltung für diese Namensräume.
...
| --- | --- |
| virtual void [AddNamespace](./addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Fügt den angegebenen Namensraum zur Sammlung hinzu. |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](./get_defaultnamespace/)() | Gibt die Namespace-URI für den Standards-Namespace zurück. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\> [get_NameTable](./get_nametable/)() | Gibt das [XmlNameTable](../xmlnametable/) zurück, das mit diesem Objekt verknüpft ist. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der zum Durchlaufen der Namensräume im [XmlNamespaceManager](./) verwendet werden kann. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](./getnamespacesinscope/)([XmlNamespaceScope](../xmlnamespacescope/)) override | Gibt eine Sammlung von Namespace-Namen zurück, die nach Präfix indexiert sind und zum Aufzählen der derzeit im Geltungsbereich befindlichen Namensräume verwendet werden kann. |
...
| virtual **bool** [HasNamespace](./hasnamespace/)([String](../../system/string/)) | Gibt einen Wert zurück, der angibt, ob das angegebene Präfix für den aktuell gepushten Geltungsbereich einen definierten Namespace hat. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | Bestimmt, ob eine Sequenz irgendeine Elemente enthält. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Castet die Elemente zum angegebenen Typ. |
...
| [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) override | Gibt die Namespace-URI für das angegebene Präfix zurück. |
| [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) override | Findet das für die gegebene Namespace-URI deklarierte Präfix. |
...
| virtual **bool** [PopScope](./popscope/)() | Entfernt einen Namespace-Geltungsbereich vom Stack. |
| virtual void [PushScope](./pushscope/)() | Legt einen Namespace-Geltungsbereich auf den Stack. |
...
| virtual void [RemoveNamespace](./removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Entfernt den angegebenen Namensraum für das angegebene Präfix. |
...
|  [XmlNamespaceManager](./xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | Initialisiert eine neue Instanz der [XmlNamespaceManager](./)-Klasse mit dem angegebenen [XmlNameTable](../xmlnametable/). |
...
Objekte dieser Klasse sollten nur über die Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erzeugen Sie niemals Instanzen dieses Typs auf dem Stack oder mit dem new-Operator, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Verwenden Sie stets einen [System::SmartPtr](../../system/smartptr/)-Pointer, um diese Klasse zu umschließen, und benutzen Sie diesen Pointer, um sie als Argument an Funktionen zu übergeben. 
