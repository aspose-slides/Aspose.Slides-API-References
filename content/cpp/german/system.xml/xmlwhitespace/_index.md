...
description: Stellt Leerzeichen im Elementinhalt dar.
type: docs
weight: 560
url: /de/system.xml/xmlwhitespace/
---
...
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Hängt die angegebene Zeichenkette an das Ende der Zeichendaten des Knotens an. |
...
| virtual void [DeleteData](../xmlcharacterdata/deletedata/)(**int32_t**, **int32_t**) | Entfernt einen Bereich von Zeichen aus dem Knoten. |
...
| virtual [String](../../system/string/) [get_Data](../xmlcharacterdata/get_data/)() | Gibt die Daten des Knotens zurück. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Gibt einen Wert zurück, der angibt, ob dieser Knoten untergeordnete Knoten hat. |
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | Gibt die verketteten Werte des Knotens und aller seiner Kinder zurück. |
...
| virtual **int32_t** [get_Length](../xmlcharacterdata/get_length/)() | Gibt die Länge der Daten in Zeichen zurück. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Gibt den Knoten zurück, der diesem Knoten unmittelbar folgt. |
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | Gibt den Typ des Knotens zurück. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Gibt den Knoten zurück, der diesem Knoten unmittelbar vorausgeht. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](./get_previoustext/)() override | Gibt den Textknoten zurück, der diesem Knoten unmittelbar vorausgeht. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Gibt das nach der Schemavalidierung zugewiesene Infoset zurück, das diesem Knoten zugewiesen wurde. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Gibt einen Enumerator zurück, der durch die Kindknoten im aktuellen Knoten iteriert. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog zur C# [Object.GetHashCode()](../../system/object/gethashcode/)-Methode. Ermöglicht das Hashen benutzerdefinierter Objekte. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Sucht die nächste **xmlns**-Deklaration für das gegebene Präfix, die im Geltungsbereich des aktuellen Knotens liegt, und gibt die Namespace-URI in der Deklaration zurück. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Sucht die nächste **xmlns**-Deklaration für die gegebene Namespace-URI, die im Geltungsbereich des aktuellen Knotens liegt, und gibt das in dieser Deklaration definierte Präfix zurück. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Fügt die angegebene Zeichenkette an der angegebenen Zeichenposition ein. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Ersetzt die angegebene Anzahl von Zeichen, beginnend am angegebenen Versatz, durch die angegebene Zeichenkette. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Wählt eine Liste von Knoten aus, die dem [XPath](../../system.xml.xpath/)-Ausdruck entsprechen. Alle im [XPath](../../system.xml.xpath/)-Ausdruck gefundenen Präfixe werden mit dem bereitgestellten [XmlNamespaceManager](../xmlnamespacemanager/) aufgelöst. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Wählt das erste [XmlNode](../xmlnode/) aus, das dem [XPath](../../system.xml.xpath/)-Ausdruck entspricht. Alle im [XPath](../../system.xml.xpath/)-Ausdruck gefundenen Präfixe werden mit dem bereitgestellten [XmlNamespaceManager](../xmlnamespacemanager/) aufgelöst. |
| virtual void [set_Data](../xmlcharacterdata/set_data/)([String](../../system/string/)) | Setzt die Daten des Knotens. |
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Setzt die verketteten Werte des Knotens und aller seiner Kinder. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Vorlagenargument zu einem schwachen Zeiger (statt einem gemeinsamen). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Ruft eine Teilzeichenkette der Gesamtkette aus dem angegebenen Bereich ab. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert alle Kindknoten des Knotens im angegebenen [XmlWriter](../xmlwriter/). |
...
| --- | --- |
| [Ptr](./ptr/) | Ein Alias für einen Smart-Pointer auf eine Instanz dieser Klasse. |
