...
description: Tabelle der atomisierten Zeichenkettenobjekte.
type: docs
weight: 313
url: /de/system.xml/xmlnametable/
---
## XmlNameTable Klasse

Tabelle der atomisierten Zeichenkettenobjekte.
...
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Wenn in einer abgeleiteten Klasse überschrieben, atomisiert die angegebene Zeichenkette und fügt sie dem [XmlNameTable](./) hinzu. |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | Wenn in einer abgeleiteten Klasse überschrieben, atomisiert die angegebene Zeichenkette und fügt sie dem [XmlNameTable](./) hinzu. |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Wenn in einer abgeleiteten Klasse überschrieben, erhält die atomisierte Zeichenkette, die dieselben Zeichen wie der angegebene Zeichenbereich im angegebenen Array enthält. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | Wenn in einer abgeleiteten Klasse überschrieben, erhält die atomisierte Zeichenkette, die denselben Wert wie die angegebene Zeichenkette enthält. |
