...
description: Stellt den XML-Deklarationsknoten <?xml version='1.0'...?> dar.
type: docs
weight: 170
url: /de/system.xml/xmldeclaration/
---
...
| Method | Description |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Fügt den angegebenen Knoten am Ende der Liste der untergeordneten Knoten dieses Knotens hinzu. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Gibt einen Iterator zurück, der auf das erste Element (falls vorhanden) der Sammlung zeigt. Dieser Iterator kann nicht verwendet werden, um ein referenziertes Objekt zu ändern, da [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) ein Kopie-Objekt von T zurückgibt. |
...
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](../xmlnode/createnavigator/)() override | Erstellt einen XPathNavigator zum Durchlaufen dieses Objekts. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Gibt einen Iterator zurück, der unmittelbar nach dem letzten Element (falls vorhanden) der Sammlung liegt. Dieser Iterator kann nicht verwendet werden, um ein referenziertes Objekt zu ändern, da [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) ein Kopie-Objekt von T zurückgibt. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [get_ChildNodes](../xmlnode/get_childnodes/)() | Gibt alle untergeordneten Knoten des Knotens zurück. |
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | Gibt die Kodierungsebene des XML-Dokuments zurück. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | Gibt das erste untergeordnete Element des Knotens zurück. |
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Gibt einen Wert zurück, der angibt, ob dieser Knoten über untergeordnete Knoten verfügt. |
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Gibt die verketteten Werte von [XmlDeclaration](./) zurück. |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Gibt das Markup zurück, das nur die untergeordneten Knoten dieses Knotens darstellt. |
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | Gibt einen Wert zurück, der angibt, ob der Knoten schreibgeschützt ist. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | Gibt das letzte untergeordnete Element des Knotens zurück. |
...
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Gibt das Markup zurück, das diesen Knoten und alle seine untergeordneten Knoten enthält. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | Gibt den Textknoten zurück, der unmittelbar vor diesem Knoten steht. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Gibt das nach der Schema-Validierung zugewiesene Infoset zurück, das diesem Knoten als Ergebnis der Schema-Validierung zugewiesen wurde. |
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | Gibt den Wert des standalone-Attributs zurück. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Gibt den Wert von [XmlDeclaration](./) zurück. |
| [String](../../system/string/) [get_Version](./get_version/)() | Gibt die XML-Version des Dokuments zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Gibt einen Enumerator zurück, der durch die untergeordneten Knoten des aktuellen Knotens iteriert. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog zur C# [Object.GetHashCode()](../../system/object/gethashcode/)-Methode. Ermöglicht das Hashen benutzerdefinierter Objekte. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Sucht die dem gegebenen Präfix nächstgelegene **xmlns**-Deklaration, die im Gültigkeitsbereich des aktuellen Knotens liegt, und gibt die Namespace-URI der Deklaration zurück. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Sucht die dem gegebenen Namespace-URI nächstgelegene **xmlns**-Deklaration, die im Gültigkeitsbereich des aktuellen Knotens liegt, und gibt das in dieser Deklaration definierte Präfix zurück. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Gibt das erste untergeordnete Element mit dem angegebenen [XmlNode::get_Name](../xmlnode/get_name/) zurück. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Gibt das erste untergeordnete Element mit den angegebenen [XmlNode::get_LocalName](../xmlnode/get_localname/)- und [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/)-Werten zurück. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Wendet eine Transformationsfunktion auf jedes Element einer generischen Sequenz an und gibt den maximalen resultierenden Wert zurück. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Wendet eine Transformationsfunktion auf jedes Element einer generischen Sequenz an und gibt den minimalen resultierenden Wert zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Überspringt eine angegebene Anzahl zusammenhängender Elemente zu Beginn einer Sequenz und gibt den Rest zurück. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Gibt eine angegebene Anzahl zusammenhängender Elemente zu Beginn einer Sequenz zurück. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Fügt den angegebenen Knoten am Anfang der Liste der untergeordneten Knoten dieses Knotens hinzu. |
...
| virtual void [RemoveAll](../xmlnode/removeall/)() | Entfernt alle untergeordneten Knoten und/oder Attribute des aktuellen Knotens. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](../xmlnode/removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Entfernt den angegebenen untergeordneten Knoten. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verringert den gemeinsamen Referenzzähler um den angegebenen Wert. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](../xmlnode/replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Ersetzt den untergeordneten Knoten **oldChild** durch den **newChild**-Knoten. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Wählt eine Liste von Knoten aus, die dem [XPath](../../system.xml.xpath/)-Ausdruck entsprechen. Alle in dem [XPath](../../system.xml.xpath/)-Ausdruck gefundenen Präfixe werden mittels des bereitgestellten [XmlNamespaceManager](../xmlnamespacemanager/) aufgelöst. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Wählt das erste [XmlNode](../xmlnode/) aus, das dem [XPath](../../system.xml.xpath/)-Ausdruck entspricht. Alle in dem [XPath](../../system.xml.xpath/)-Ausdruck gefundenen Präfixe werden mittels des bereitgestellten [XmlNamespaceManager](../xmlnamespacemanager/) aufgelöst. |
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | Setzt die Kodierungsebene des XML-Dokuments. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Setzt die verketteten Werte von [XmlDeclaration](./). |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Setzt das Markup, das nur die untergeordneten Knoten dieses Knotens darstellt. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Setzt das Namespace-Präfix dieses Knotens. |
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | Setzt den Wert des standalone-Attributs. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Setzt den Wert von [XmlDeclaration](./). |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Verringert und gibt den gemeinsamen Referenzzähler zurück. Sollte nicht direkt aufgerufen werden; stattdessen sollten Smart-Pointers oder ThisProtector verwendet werden. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert die untergeordneten Knoten des Knotens im angegebenen [XmlWriter](../xmlwriter/). Da [XmlDeclaration](./)-Knoten keine Kinder haben, hat diese Methode keine Wirkung. |
...
Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstellen Sie niemals Instanzen dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Verpacken Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Pointer und verwenden Sie diesen Pointer, um ihn als Argument an Funktionen zu übergeben. 
