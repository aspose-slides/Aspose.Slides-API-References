...
description: Stellt ein Element dar.
type: docs
weight: 222
url: /de/system.xml/xmlelement/
---
## XmlElement Klasse
...
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Fügt den angegebenen Knoten am Ende der Kindknotenliste dieses Knotens ein. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Erstellt eine Kopie dieses Knotens. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Erstellt eine Kopie dieses Knotens. |
...
| virtual **bool** [get_HasAttributes](./get_hasattributes/)() | Gibt einen **bool**-Wert zurück, der angibt, ob der aktuelle Knoten Attribute besitzt. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Gibt die zusammengefügten Werte des Knotens und aller seiner Kinder zurück. |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Gibt das Markup zurück, das nur die Kinder dieses Knotens repräsentiert. |
| **bool** [get_IsEmpty](./get_isempty/)() | Gibt das Tag-Format des Elements zurück. |
...
| [String](../../system/string/) [get_NamespaceURI](./get_namespaceuri/)() override | Gibt die Namespace-URI dieses Knotens zurück. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Gibt den Knoten zurück, der unmittelbar auf diesen Knoten folgt. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](./get_ownerdocument/)() override | Gibt das [XmlDocument](../xmldocument/) zurück, zu dem dieser Knoten gehört. |
...
| [String](../../system/string/) [get_Prefix](./get_prefix/)() override | Gibt das Namespace-Präfix dieses Knotens zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | Gibt das nach der Schemagültigkeitsprüfung zugewiesene Infoset dieses Knotens zurück. |
| virtual [String](../../system/string/) [get_Value](../xmlnode/get_value/)() | Gibt den Wert des Knotens zurück. |
| virtual [String](../../system/string/) [GetAttribute](./getattribute/)([String](../../system/string/)) | Gibt den Wert des Attributs mit dem angegebenen Namen zurück. |
| virtual [String](../../system/string/) [GetAttribute](./getattribute/)([String](../../system/string/), [String](../../system/string/)) | Gibt den Wert des Attributs mit dem angegebenen lokalen Namen und der Namespace-URI zurück. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [GetAttributeNode](./getattributenode/)([String](../../system/string/)) | Gibt das [XmlAttribute](../xmlattribute/) mit dem angegebenen Namen zurück. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [GetAttributeNode](./getattributenode/)([String](../../system/string/), [String](../../system/string/)) | Gibt das [XmlAttribute](../xmlattribute/) mit dem angegebenen lokalen Namen und der Namespace-URI zurück. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [GetElementsByTagName](./getelementsbytagname/)([String](../../system/string/)) | Gibt ein [XmlNodeList](../xmlnodelist/) zurück, das eine Liste aller Nachfahren-Elemente enthält, die dem angegebenen [XmlElement::get_Name](./get_name/) entsprechen. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [GetElementsByTagName](./getelementsbytagname/)([String](../../system/string/), [String](../../system/string/)) | Gibt ein [XmlNodeList](../xmlnodelist/) zurück, das eine Liste aller Nachfahren-Elemente enthält, die den angegebenen [XmlElement::get_LocalName](./get_localname/)- und [XmlElement::get_NamespaceURI](./get_namespaceuri/)-Werten entsprechen. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Gibt einen Enumerator zurück, der durch die Kindknoten des aktuellen Knotens iteriert. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog zur C#-Methode [Object.GetHashCode()](../../system/object/gethashcode/). Ermöglicht das Hashen benutzerdefinierter Objekte. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten im Gültigkeitsbereich nächstgelegene **xmlns**-Deklaration für das angegebene Präfix und gibt die Namespace-URI aus der Deklaration zurück. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten im Gültigkeitsbereich nächstgelegene **xmlns**-Deklaration für die angegebene Namespace-URI und gibt das in der Deklaration definierte Präfix zurück. |
...
| virtual **bool** [HasAttribute](./hasattribute/)([String](../../system/string/)) | Bestimmt, ob der aktuelle Knoten ein Attribut mit dem angegebenen Namen besitzt. |
| virtual **bool** [HasAttribute](./hasattribute/)([String](../../system/string/), [String](../../system/string/)) | Bestimmt, ob der aktuelle Knoten ein Attribut mit dem angegebenen lokalen Namen und der Namespace-URI besitzt. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](./)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Gibt das erste Kind-Element mit dem angegebenen [XmlNode::get_Name](../xmlnode/get_name/) zurück. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](./)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Gibt das erste Kind-Element mit den angegebenen [XmlNode::get_LocalName](../xmlnode/get_localname/)- und [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/)-Werten zurück. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Setzt alle [XmlText](../xmltext/)-Knoten in der vollen Tiefe des Unterbaums unterhalb dieses [XmlNode](../xmlnode/) in eine "normale" Form, bei der nur Markup (also Tags, Kommentare, Verarbeitungsanweisungen, CDATA-Abschnitte und Entity-Referenzen) [XmlText](../xmltext/)-Knoten trennt, das heißt, es gibt keine benachbarten [XmlText](../xmltext/)-Knoten. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Fügt den angegebenen Knoten am Anfang der Liste von Kindknoten dieses Knotens hinzu. |
...
| void [RemoveAll](./removeall/)() override | Entfernt alle angegebenen Attribute und Kindknoten des aktuellen Knotens. Standardattribute werden nicht entfernt. |
| virtual void [RemoveAllAttributes](./removeallattributes/)() | Entfernt alle angegebenen Attribute aus dem Element. Standardattribute werden nicht entfernt. |
| virtual void [RemoveAttribute](./removeattribute/)([String](../../system/string/)) | Entfernt ein Attribut anhand seines Namens. |
| virtual void [RemoveAttribute](./removeattribute/)([String](../../system/string/), [String](../../system/string/)) | Entfernt ein Attribut mit dem angegebenen lokalen Namen und Namespace-URI. (Falls das entfernte Attribut einen Standardwert hat, wird dieser sofort ersetzt). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveAttributeAt](./removeattributeat/)(**int32_t**) | Entfernt den Attributknoten mit dem angegebenen Index aus dem Element. (Falls das entfernte Attribut einen Standardwert hat, wird dieser sofort ersetzt). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [RemoveAttributeNode](./removeattributenode/)([SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>) | Entfernt das angegebene [XmlAttribute](../xmlattribute/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [RemoveAttributeNode](./removeattributenode/)([String](../../system/string/), [String](../../system/string/)) | Entfernt das [XmlAttribute](../xmlattribute/) mit dem angegebenen lokalen Namen und Namespace-URI. (Falls das entfernte Attribut einen Standardwert hat, wird dieser sofort ersetzt). |
...
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Setzt das Markup, das nur die Kinder dieses Knotens darstellt. |
| void [set_IsEmpty](./set_isempty/)(**bool**) | Setzt das Tag-Format des Elements. |
| void [set_Prefix](./set_prefix/)([String](../../system/string/)) override | Setzt das Namespace-Präfix dieses Knotens. |
| virtual void [set_Value](../xmlnode/set_value/)([String](../../system/string/)) | Setzt den Wert des Knotens. |
| virtual void [SetAttribute](./setattribute/)([String](../../system/string/), [String](../../system/string/)) | Setzt den Wert des Attributs mit dem angegebenen Namen. |
| virtual [String](../../system/string/) [SetAttribute](./setattribute/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | Setzt den Wert des Attributs mit dem angegebenen lokalen Namen und Namespace-URI. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [SetAttributeNode](./setattributenode/)([SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>) | Fügt das angegebene [XmlAttribute](../xmlattribute/) hinzu. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [SetAttributeNode](./setattributenode/)([String](../../system/string/), [String](../../system/string/)) | Fügt das angegebene [XmlAttribute](../xmlattribute/) hinzu. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Ermittelt die Implementierung des const-Begin-Iterators für den aktuellen Container. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Ermittelt die Implementierung des const-End-Iterators für den aktuellen Container. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert alle Kinder des Knotens im angegebenen [XmlWriter](../xmlwriter/). |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert den aktuellen Knoten im angegebenen [XmlWriter](../xmlwriter/). |
...
Objekte dieser Klasse sollten nur über die [System::MakeObject()](../../system/makeobject/)-Funktion alloziert werden. Erstellen Sie niemals Instanzen dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben. 
