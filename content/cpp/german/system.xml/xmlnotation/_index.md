...
description: Stellt eine Notationsdeklaration dar, wie <!NOTATION... >.
type: docs
weight: 378
url: /de/system.xml/xmlnotation/
---
## XmlNotation Klasse
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Erzeugt ein Duplikat dieses Knotens. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Erzeugt ein Duplikat dieses Knotens. Notationsknoten können nicht geklont werden. Der Aufruf dieser Methode auf einem [XmlNotation](./)-Objekt löst eine Ausnahme aus. |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Gibt den Namen des aktuellen Knotens ohne das Namensraum-Präfix zurück. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Gibt den Namen des aktuellen Knotens zurück. |
...
| [String](../../system/string/) [get_OuterXml](./get_outerxml/)() override | Gibt das Markup zurück, das diesen Knoten und alle seine Kinder darstellt. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Gibt den Wert des öffentlichen Identifikators in der Notationsdeklaration zurück. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Gibt das nach der Schemavalidierung zugewiesene Infoset zurück, das diesem Knoten zugeordnet wurde. |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Gibt den Wert des Systemidentifikators in der Notationsdeklaration zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Gibt einen Enumerator zurück, der die Kindknoten des aktuellen Knotens durchläuft. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog zur C#-[Object.GetHashCode()](../../system/object/gethashcode/)-Methode. Ermöglicht das Hashen benutzerdefinierter Objekte. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten nächstgelegene **xmlns**-Deklaration für das angegebene Präfix, das im Gültigkeitsbereich ist, und gibt die Namespace-URI aus der Deklaration zurück. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten nächstgelegene **xmlns**-Deklaration für die angegebene Namespace-URI, die im Gültigkeitsbereich ist, und gibt das in dieser Deklaration definierte Präfix zurück. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Bringt alle [XmlText](../xmltext/)-Knoten in der vollen Tiefe des Unterbaums unterhalb dieses [XmlNode](../xmlnode/) in eine „normale“ Form, bei der nur Markup (also Tags, Kommentare, Verarbeitungsanweisungen, CDATA-Abschnitte und Entity-Referenzen) [XmlText](../xmltext/)-Knoten trennt, d. h. es gibt keine benachbarten [XmlText](../xmltext/)-Knoten. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert die Kindknoten des Knotens im angegebenen [XmlWriter](../xmlwriter/). Diese Methode hat keinen Effekt auf [XmlNotation](./)-Knoten. |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert den Knoten im angegebenen [XmlWriter](../xmlwriter/). Diese Methode hat keinen Effekt auf [XmlNotation](./)-Knoten. |
...
Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstellen Sie niemals Instanzen dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Umschließen Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Pointer und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben. 
