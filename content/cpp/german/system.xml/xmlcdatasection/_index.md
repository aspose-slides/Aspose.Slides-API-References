...
description: Stellt einen CDATA-Abschnitt dar.
type: docs
weight: 105
url: /de/system.xml/xmlcdatasection/
---
...
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Fügt die angegebene Zeichenkette an das Ende der Zeichendaten des Knotens an. |
...
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | Gibt die verketteten Werte des Knotens und aller seiner Kindknoten zurück. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Gibt den Knoten zurück, der sofort auf diesen Knoten folgt. |
...
| [String](../../system/string/) [get_Value](../xmlcharacterdata/get_value/)() override | Gibt den Wert des Knotens zurück. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Sucht die nächste **xmlns**-Deklaration für das angegebene Präfix, das für den aktuellen Knoten im Gültigkeitsbereich ist, und gibt die Namespace-URI in der Deklaration zurück. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Sucht die nächste **xmlns**-Deklaration für die angegebene Namespace-URI, die für den aktuellen Knoten im Gültigkeitsbereich ist, und gibt das in dieser Deklaration definierte Präfix zurück. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Setzt alle [XmlText](../xmltext/)-Knoten in der vollen Tiefe des Unterbaums unterhalb dieses [XmlNode](../xmlnode/) in eine „normale“ Form, in der nur Markup (also Tags, Kommentare, Verarbeitungsanweisungen, CDATA-Abschnitte und Entity-Referenzen) [XmlText](../xmltext/)-Knoten trennt, das heißt, es gibt keine benachbarten [XmlText](../xmltext/)-Knoten. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Ersetzt die angegebene Anzahl von Zeichen ab dem angegebenen Offset durch die angegebene Zeichenkette. |
...
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Setzt die verketteten Werte des Knotens und aller seiner Kindknoten. |
...
| void [set_Value](../xmlcharacterdata/set_value/)([String](../../system/string/)) override | Setzt den Wert des Knotens. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Ruft eine Teilzeichenkette der Gesamtlänge aus dem angegebenen Bereich ab. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert die Kindknoten des Knotens im angegebenen [XmlWriter](../xmlwriter/). |
...
Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstellen Sie niemals Instanzen dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Umschließen Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
