...
description: Stellt den Inhalt eines XML-Kommentars dar.
type: docs
weight: 144
url: /de/system.xml/xmlcomment/
---
## XmlComment Klasse
...
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Fügt den angegebenen Knoten am Ende der Liste von Kindknoten dieses Knotens hinzu. |
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Hängt die angegebene Zeichenfolge an das Ende der Zeichendaten des Knotens an. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Gibt den übergeordneten Knoten zurück (für Knoten, die übergeordnete haben können). |
| virtual [String](../../system/string/) [get_Prefix](../xmlnode/get_prefix/)() | Gibt das Namespace-Präfix dieses Knotens zurück. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Gibt den Knoten zurück, der unmittelbar diesem Knoten vorausgeht. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | Gibt den Textknoten zurück, der unmittelbar diesem Knoten vorausgeht. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Fügt die angegebene Zeichenfolge an der angegebenen Zeichenposition ein. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Bringt alle [XmlText](../xmltext/)-Knoten in voller Tiefe des Unterbaums unterhalb dieses [XmlNode](../xmlnode/) in eine „normale“ Form, in der nur Markup (also Tags, Kommentare, Verarbeitungsanweisungen, CDATA-Abschnitte und Entity-Referenzen) [XmlText](../xmltext/)-Knoten trennt, d.h. es gibt keine benachbarten [XmlText](../xmltext/)-Knoten. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Ersetzt die angegebene Anzahl von Zeichen ab dem angegebenen Offset durch die angegebene Zeichenfolge. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Wählt eine Liste von Knoten aus, die dem [XPath](../../system.xml.xpath/)-Ausdruck entsprechen. Alle Präfixe, die im [XPath](../../system.xml.xpath/)-Ausdruck gefunden werden, werden mit dem bereitgestellten [XmlNamespaceManager](../xmlnamespacemanager/) aufgelöst. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Ruft eine Teilzeichenfolge der Gesamtheit aus dem angegebenen Bereich ab. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert alle Kindknoten des Knotens im angegebenen [XmlWriter](../xmlwriter/). Da Kommentar-Knoten keine Kinder haben, hat diese Methode keine Wirkung. |
