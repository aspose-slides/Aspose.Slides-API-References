...
description: Stellt ein Attribut dar. Gültige und Standardwerte für das Attribut sind in einer Dokumenttypdefinition (DTD) oder einem Schema definiert.
type: docs
weight: 79
url: /de/system.xml/xmlattribute/
---
## XmlAttribute Klasse

Stellt ein Attribut dar. Gültige und Standardwerte für das Attribut sind in einer Dokumenttypdefinition (DTD) oder einem Schema definiert.
...
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](./appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Fügt den angegebenen Knoten am Ende der Liste der Kindknoten dieses Knotens hinzu. |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Gibt den Basis-Uniform-Resource-Identifier (URI) des Knotens zurück. |
...
| virtual [String](../../system/string/) [get_InnerText](../xmlnode/get_innertext/)() | Gibt die verketteten Werte des Knotens und aller seiner Kindknoten zurück. |
...
| [String](../../system/string/) [get_NamespaceURI](./get_namespaceuri/)() override | Gibt den Namespace-URI dieses Knotens zurück. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Gibt den Knoten zurück, der unmittelbar nach diesem Knoten kommt. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [get_OwnerElement](./get_ownerelement/)() | Gibt das [XmlElement](../xmlelement/) zurück, zu dem das Attribut gehört. |
...
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | Gibt das Post-Schema-Validierungs-Infoset zurück, das diesem Knoten infolge der Schema-Validierung zugewiesen wurde. |
| virtual **bool** [get_Specified](./get_specified/)() | Gibt einen Wert zurück, der angibt, ob der Attributwert explizit gesetzt wurde. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten im Geltungsbereich nächstgelegene **xmlns**-Deklaration für das angegebene Präfix und gibt den Namespace-URI in der Deklaration zurück. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten im Geltungsbereich nächstgelegene **xmlns**-Deklaration für den angegebenen Namespace-URI und gibt das Präfix zurück, das in dieser Deklaration definiert ist. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](./insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Fügt den angegebenen Knoten unmittelbar nach dem angegebenen Referenzknoten ein. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](./insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Fügt den angegebenen Knoten unmittelbar vor dem angegebenen Referenzknoten ein. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft eine Transformationsfunktion für jedes Element einer generischen Sequenz auf und gibt den maximal resultierenden Wert zurück. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft eine Transformationsfunktion für jedes Element einer generischen Sequenz auf und gibt den minimal resultierenden Wert zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projektisiert jedes Element einer Sequenz und kombiniert die resultierenden Sequenzen zu einer einzigen Sequenz. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Verschiebt alle [XmlText](../xmltext/)-Knoten in der gesamten Tiefe des Unterbaums unterhalb dieses [XmlNode](../xmlnode/) in eine "normale" Form, bei der nur Markup (also Tags, Kommentare, Verarbeitungsanweisungen, CDATA-Abschnitte und Entity-Referenzen) [XmlText](../xmltext/)-Knoten trennt, das heißt, es gibt keine benachbarten [XmlText](../xmltext/)-Knoten. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](./prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Fügt den angegebenen Knoten am Anfang der Liste der Kindknoten dieses Knotens hinzu. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](./removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Entfernt den angegebenen Kindknoten. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](./replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Ersetzt den angegebenen Kindknoten durch den angegebenen neuen Kindknoten. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Wählt eine Liste von Knoten aus, die dem [XPath](../../system.xml.xpath/)-Ausdruck entsprechen. Alle im [XPath](../../system.xml.xpath/)-Ausdruck gefundenen Präfixe werden mithilfe des bereitgestellten [XmlNamespaceManager](../xmlnamespacemanager/) aufgelöst. |
...
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Setzt den Wert des Attributs. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Verringert und gibt den geteilten Referenzzähler zurück. Sollte nicht direkt aufgerufen werden; stattdessen sollten Smart-Pointer oder ThisProtector verwendet werden. |
...
Objekte dieser Klasse sollten nur mit der [System::MakeObject()](../../system/makeobject/)-Funktion zugewiesen werden. Erstellen Sie niemals Instanzen dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Pointer ein und verwenden Sie diesen Pointer, um ihn als Argument an Funktionen zu übergeben. 
