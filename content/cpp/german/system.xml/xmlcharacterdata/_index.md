...
description: Stellt Textmanipulationsmethoden bereit, die von mehreren Klassen verwendet werden.
type: docs
weight: 118
url: /de/system.xml/xmlcharacterdata/
---
...
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Fügt den angegebenen Knoten am Ende der Liste der Kindknoten dieses Knotens ein. |
| virtual void [AppendData](./appenddata/)([String](../../system/string/)) | Hängt die angegebene Zeichenfolge an das Ende der Zeichendaten des Knotens an. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Erstellt eine Kopie des Knotens, wenn in einer abgeleiteten Klasse überschrieben. |
...
| virtual void [DeleteData](./deletedata/)(**int32_t**, **int32_t**) | Entfernt einen Zeichenbereich aus dem Knoten. |
...
| virtual [String](../../system/string/) [get_Data](./get_data/)() | Gibt die Daten des Knotens zurück. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Gibt die zusammengefügten Werte des Knotens und aller seiner Kindknoten zurück. |
...
| virtual **int32_t** [get_Length](./get_length/)() | Gibt die Länge der Daten in Zeichen zurück. |
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | Gibt den lokalen Namen des Knotens zurück, wenn in einer abgeleiteten Klasse überschrieben. |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | Gibt den qualifizierten Namen des Knotens zurück, wenn in einer abgeleiteten Klasse überschrieben. |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | Gibt den Typ des aktuellen Knotens zurück, wenn in einer abgeleiteten Klasse überschrieben. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Gibt den übergeordneten Knoten zurück (für Knoten, die Eltern haben können). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Gibt das nach der Schema-Validierung zugewiesene Infoset zurück, das diesem Knoten zugeordnet ist. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Sucht die nächste **xmlns**-Deklaration für das angegebene Präfix, das im Geltungsbereich des aktuellen Knotens liegt, und gibt die Namespace-URI der Deklaration zurück. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Sucht die nächste **xmlns**-Deklaration für die angegebene Namespace-URI, die im Geltungsbereich des aktuellen Knotens liegt, und gibt das in dieser Deklaration definierte Präfix zurück. |
...
| virtual void [InsertData](./insertdata/)(**int32_t**, [String](../../system/string/)) | Fügt die angegebene Zeichenfolge an der angegebenen Zeichenposition ein. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Bringt alle [XmlText](../xmltext/)-Knoten in voller Tiefe des Unterbaums unter diesem [XmlNode](../xmlnode/) in eine „normale“ Form, bei der nur Markup (also Tags, Kommentare, Verarbeitungsanweisungen, CDATA-Abschnitte und Entity-Referenzen) [XmlText](../xmltext/)-Knoten trennt, d.h. es gibt keine benachbarten [XmlText](../xmltext/)-Knoten. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Fügt den angegebenen Knoten am Anfang der Kindknotenliste dieses Knotens ein. |
...
| virtual void [ReplaceData](./replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Ersetzt die angegebene Anzahl von Zeichen, beginnend an der angegebenen Position, durch die angegebene Zeichenfolge. |
...
| virtual void [set_Data](./set_data/)([String](../../system/string/)) | Setzt die Daten des Knotens. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Setzt die zusammengefügten Werte des Knotens und aller seiner Kindknoten. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument zu einem Weak-Pointer (statt Shared). Ermöglicht das Wechseln von Pointern in Containern in den Weak-Modus. |
...
| virtual [String](../../system/string/) [Substring](./substring/)(**int32_t**, **int32_t**) | Ruft eine Teilzeichenkette des Gesamtsrings aus dem angegebenen Bereich ab. |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Speichert alle Kindknoten des Knotens im angegebenen [XmlWriter](../xmlwriter/), wenn in einer abgeleiteten Klasse überschrieben. |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Speichert den aktuellen Knoten im angegebenen [XmlWriter](../xmlwriter/), wenn in einer abgeleiteten Klasse überschrieben. |
