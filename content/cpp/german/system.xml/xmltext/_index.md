...
description: Stellt den Textinhalt eines Elements oder Attributs dar.
type: docs
weight: 495
url: /de/system.xml/xmltext/
---
## XmlText Klasse
...
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Fügt den angegebenen Knoten am Ende der Liste von Kindknoten dieses Knotens ein. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Gibt einen Wert zurück, der angibt, ob dieser Knoten irgendeine Kindknoten hat. |
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | Gibt die zusammengefügten Werte des Knotens und aller seiner Kinder zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](./get_previoustext/)() override | Gibt den Textknoten zurück, der unmittelbar vor diesem Knoten liegt. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Gibt das Infoseset nach Schema-Validierung zurück, das diesem Knoten infolge der Schema-Validierung zugewiesen wurde. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Sucht die nächstgelegene **xmlns**-Deklaration für das gegebene Präfix, die im Geltungsbereich des aktuellen Knotens liegt, und gibt die Namespace-URI aus der Deklaration zurück. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Sucht die nächstgelegene **xmlns**-Deklaration für die gegebene Namespace-URI, die im Geltungsbereich des aktuellen Knotens liegt, und gibt das Präfix zurück, das in dieser Deklaration definiert ist. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Setzt alle [XmlText](./)-Knoten in der vollen Tiefe des Unterbaums unterhalb dieses [XmlNode](../xmlnode/) in eine "normale" Form, bei der nur Markup (also Tags, Kommentare, Verarbeitungsanweisungen, CDATA-Abschnitte und Entity-Referenzen) [XmlText](./)-Knoten trennt, das heißt, es gibt keine benachbarten [XmlText](./)-Knoten. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Ersetzt die angegebene Anzahl von Zeichen ab der angegebenen Position durch die angegebene Zeichenkette. |
...
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Setzt die zusammengefügten Werte des Knotens und aller seiner Kinder. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlText](./)\> [SplitText](./splittext/)(**int32_t**) | Teilt den Knoten bei der angegebenen Position in zwei Knoten, wobei beide als Geschwister im Baum erhalten bleiben. |
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Ruft eine Teilzeichenfolge der gesamten Zeichenkette aus dem angegebenen Bereich ab. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert alle Kinder des Knotens in das angegebene [XmlWriter](../xmlwriter/). [XmlText](./)-Knoten haben keine Kinder, daher hat diese Methode keine Wirkung. |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert den Knoten in das angegebene [XmlWriter](../xmlwriter/). |
