...
description: Gibt detaillierte Informationen über die letzte Ausnahme zurück.
type: docs
weight: 1
url: /de/system.xml/details_xmlexception/
---
## Details_XmlException Klasse


Gibt detaillierte Informationen über die letzte Ausnahme zurück.
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Gibt die Zeilennummer zurück, die angibt, wo der Fehler aufgetreten ist. Zeilennummern beginnen bei 1. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Gibt die Zeilenposition zurück, die angibt, wo der Fehler aufgetreten ist. Zeilenpositionen beginnen bei 1. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Gibt eine Meldung zurück, die die aktuelle Ausnahme beschreibt. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Gibt den Speicherort der XML-Datei zurück. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die [what()](../../system/details_exception/what/)-Methode, die von der [ExceptionWrapper](../../system/exceptionwrapper/)-Klasse aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/private Mitglieder nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenumsetzung in die [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik beschädigen. |
