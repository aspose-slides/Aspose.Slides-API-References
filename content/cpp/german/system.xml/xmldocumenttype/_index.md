...
description: Stellt die Dokumenttypdeklaration dar.
type: docs
weight: 209
url: /de/system.xml/xmldocumenttype/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Entities](./get_entities/)() | Gibt die Sammlung der im Dokumenttyp-Deklaration deklarierten [XmlEntity](../xmlentity/)-Knoten zurück. |
...
| [String](../../system/string/) [get_InternalSubset](./get_internalsubset/)() | Gibt den Wert des internen Teilbereichs der Dokumenttypdefinition (DTD) in der DOCTYPE-Deklaration zurück. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | Gibt einen Wert zurück, der angibt, ob der Knoten schreibgeschützt ist. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Gibt den unmittelbar nach diesem Knoten folgenden Knoten zurück. |
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | Gibt den Typ des aktuellen Knotens zurück. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Notations](./get_notations/)() | Gibt die Sammlung der im Dokumenttyp-Deklaration vorhandenen [XmlNotation](../xmlnotation/)-Knoten zurück. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | Gibt den Textknoten zurück, der diesem Knoten unmittelbar vorausgeht. |
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Gibt den Wert des öffentlichen Identifikators in der DOCTYPE-Deklaration zurück. |
...
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Gibt den Wert des System-Identifikators in der DOCTYPE-Deklaration zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Gibt einen Enumerator zurück, der die Kindknoten im aktuellen Knoten durchläuft. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog zur C# [Object.GetHashCode()](../../system/object/gethashcode/)-Methode. Ermöglicht das Hashen benutzerdefinierter Objekte. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten nächstgelegene **xmlns**-Deklaration für das angegebene Präfix im Geltungsbereich und gibt die Namespace-URI aus der Deklaration zurück. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Sucht die dem aktuellen Knoten nächstgelegene **xmlns**-Deklaration für die angegebene Namespace-URI im Geltungsbereich und gibt das darin definierte Präfix zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Überspringt eine angegebene Anzahl aufeinanderfolgender Elemente zu Beginn einer Sequenz und gibt den Rest zurück. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Gibt eine angegebene Anzahl aufeinanderfolgender Elemente zu Beginn einer Sequenz zurück. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Setzt alle [XmlText](../xmltext/)-Knoten in der vollen Tiefe des Unterbaums unter diesem [XmlNode](../xmlnode/) in eine „normale“ Form, bei der nur Markup (also Tags, Kommentare, Verarbeitungsanweisungen, CDATA-Abschnitte und Entity-Referenzen) [XmlText](../xmltext/)-Knoten trennt, das heißt, es gibt keine benachbarten [XmlText](../xmltext/)-Knoten. |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Setzt die verketteten Werte des Knotens und aller seiner Kindknoten. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Speichert alle Kindknoten des Knotens im angegebenen [XmlWriter](../xmlwriter/). Für [XmlDocumentType](./)-Knoten hat diese Methode keine Wirkung. |
