...
description: "Stellt eine Basisklasse für System.IO.Stream-ähnliche Wrapper bereit. Objekte dieser Klasse sollten nur mit der System::MakeObject()-Funktion zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs im Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Verpacken Sie diese Klasse immer in einen System::SmartPtr-Zeiger und verwenden Sie diesen Zeiger, um ihn Funktionen als Argument zu übergeben."
type: docs
weight: 352
url: /de/system.io/stdiostreamwrapperbase/
---
## STDIOStreamWrapperBase Klasse

Stellt eine Basisklasse für [System.IO.Stream](../stream/)-ähnliche Wrapper bereit. Objekte dieser Klasse sollten nur mit der [System::MakeObject()](../../system/makeobject/)-Funktion zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Verpacken Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Pointer und verwenden Sie diesen Pointer, um ihn Funktionen als Argument zu übergeben.
...
| virtual void [Flush](../stream/flush/)() | Leert die Puffer dieses Streams und schreibt alle gepufferten Daten in den zugrunde liegenden Speicher. |
| virtual [TaskPtr](../../system/taskptr/) [FlushAsync](../stream/flushasync/)(const [Threading::CancellationToken](../../system.threading/cancellationtoken/)\&) | Löscht asynchron alle Puffer dieses Streams, bewirkt, dass gepufferte Daten in das zugrunde liegende Gerät geschrieben werden, und überwacht Abbruchanforderungen. |
| [TaskPtr](../../system/taskptr/) [FlushAsync](../stream/flushasync/)() | Löscht asynchron alle Puffer dieses Streams, bewirkt, dass gepufferte Daten in das zugrunde liegende Gerät geschrieben werden, und überwacht Abbruchanforderungen. |
| **bool** [get_CanRead](./get_canread/)() const override | Bestimmt, ob der Stream das Lesen unterstützt. |
| **bool** [get_CanSeek](./get_canseek/)() const override | Bestimmt, ob der Stream das Seeken unterstützt. |
| virtual **bool** [get_CanTimeout](../stream/get_cantimeout/)() const | Ermittelt einen Wert, der festlegt, ob der aktuelle Stream eine Zeitüberschreitung haben kann. |
| **bool** [get_CanWrite](./get_canwrite/)() const override | Bestimmt, ob der Stream das Schreiben unterstützt. |
...
| virtual int [get_ReadTimeout](../stream/get_readtimeout/)() const | Ermittelt einen Wert in Millisekunden, der festlegt, wie lange der Stream versucht zu lesen, bevor er die Zeit überschreitet. |
| virtual int [get_WriteTimeout](../stream/get_writetimeout/)() const | Ermittelt einen Wert in Millisekunden, der festlegt, wie lange der Stream versucht zu schreiben, bevor er die Zeit überschreitet. |
...
| [STDIOStreamWrapperBase](./)\& [operator=](./operator_equal/)(const [STDIOStreamWrapperBase](./)\&) | Kopierzuweisungsoperator. Gelöscht. |
...
| virtual **int32_t** [Read](../stream/read/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) | Liest die angegebene Anzahl von Bytes aus dem Stream und schreibt sie in das angegebene Byte-Array. |
| virtual **int32_t** [Read](../stream/read/)(const System::Details::ArrayView\<**uint8_t**\>\&, **int32_t**, **int32_t**) | Liest die angegebene Anzahl von Bytes aus dem Stream und schreibt sie in das angegebene Byte-Array. |
...
| virtual [RTaskPtr](../../system/rtaskptr/)\<**int32_t**\> [ReadAsync](../stream/readasync/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**, const [Threading::CancellationToken](../../system.threading/cancellationtoken/)\&) | Liest asynchron eine Bytefolge aus dem aktuellen Stream, verschiebt die Position im Stream um die gelesene Anzahl von Bytes und überwacht Abbruchanforderungen. |
| [RTaskPtr](../../system/rtaskptr/)\<**int32_t**\> [ReadAsync](../stream/readasync/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) | Liest asynchron eine Bytefolge aus dem aktuellen Stream, verschiebt die Position im Stream um die gelesene Anzahl von Bytes und überwacht Abbruchanforderungen. |
| virtual int [ReadByte](../stream/readbyte/)() | Liest ein einzelnes Byte aus dem Stream und gibt einen 32-Bit-Integer-Wert zurück, der dem Wert des gelesenen Bytes entspricht. |
...
| virtual void [set_ReadTimeout](../stream/set_readtimeout/)(int) | Setzt einen Wert, der festlegt, ob der aktuelle Stream eine Zeitüberschreitung haben kann. |
| virtual void [set_WriteTimeout](../stream/set_writetimeout/)(int) | Setzt einen Wert in Millisekunden, der festlegt, wie lange der Stream versucht zu lesen, bevor er die Zeit überschreitet. |
| virtual void [SetLength](../stream/setlength/)(**int64_t**) | Setzt die Länge des Streams, der vom aktuellen Objekt repräsentiert wird. |
...
| virtual void [Write](../stream/write/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) | Schreibt den angegebenen Teilbereich von Bytes aus dem angegebenen Byte-Array in den Stream. |
| virtual void [Write](../stream/write/)(const System::Details::ArrayView\<**uint8_t**\>\&, **int32_t**, **int32_t**) | Schreibt den angegebenen Teilbereich von Bytes aus dem angegebenen Byte-Array in den Stream. |
...
| virtual [TaskPtr](../../system/taskptr/) [WriteAsync](../stream/writeasync/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**, const [Threading::CancellationToken](../../system.threading/cancellationtoken/)\&) | Schreibt asynchron eine Bytefolge in den aktuellen Stream, verschiebt die aktuelle Position in diesem Stream um die geschriebene Anzahl von Bytes und überwacht Abbruchanforderungen. |
| [TaskPtr](../../system/taskptr/) [WriteAsync](../stream/writeasync/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, **int32_t**, **int32_t**) | Schreibt asynchron eine Bytefolge in den aktuellen Stream, verschiebt die aktuelle Position in diesem Stream um die geschriebene Anzahl von Bytes und überwacht Abbruchanforderungen. |
| virtual void [WriteByte](../stream/writebyte/)(**uint8_t**) | Schreibt den angegebenen unsigned 8-Bit-Integer-Wert in den Stream. |
