...
description: Enumerator, der von der IEnumerable.Cast() Erweiterungsmethode verwendet wird.
type: docs
weight: 53
url: /de/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter Klasse


Enumerator, der von der IEnumerable.Cast() Erweiterungsmethode verwendet wird.
...
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Bereitet den Iterator vor, der von der VirtualizedIterator Klasse verwendet werden soll. |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Lock-Statement von C# lock(). Aufruf direkt oder über das [LockContext](../../system/lockcontext/)-Wächterobjekt. |
...
| **bool** [MoveNext](./movenext/)() override | Bewegt den Enumerator zum nächsten Element. Wenn vorher kein Element referenziert wurde, wird die Referenz auf das erste verfügbare Element gesetzt. Wenn das Container-Ende erreicht ist, wird nichts getan. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren des C#-Lock-Statements lock(). Aufruf direkt oder über das [LockContext](../../system/lockcontext/)-Wächterobjekt. |
