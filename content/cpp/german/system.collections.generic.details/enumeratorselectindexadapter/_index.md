...
type: docs
weight: 92
url: /de/system.collections.generic.details/enumeratorselectindexadapter/
---
...
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Bereitet den Iterator vor, damit er von der Klasse VirtualizedIterator verwendet werden kann. |
| System::Details::VirtualizedIteratorBase\<Result\> * [CloneIterator](./cloneiterator/)() const override |  |
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](../../system.collections.generic/ienumerator/current/)() const | Erhält das aktuelle Element. |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | Erhält das aktuelle Element. |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren via C#-lock()-Anweisung. Direkt aufrufen oder das [LockContext](../../system/lockcontext/)-Wächterobjekt nutzen. |
...
| **bool** [MoveNext](./movenext/)() override | Bewegt den Enumerator zum nächsten Element. Wenn zuvor kein Element referenziert war, wird die Referenz auf das zuerst verfügbare Element gesetzt. Wenn das Ende des Containers erreicht ist, passiert nichts. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren via C#-lock()-Anweisung. Direkt aufrufen oder das [LockContext](../../system/lockcontext/)-Wächterobjekt nutzen. |
