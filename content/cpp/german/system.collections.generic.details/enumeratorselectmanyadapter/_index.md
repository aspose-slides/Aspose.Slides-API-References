...
type: docs
weight: 105
url: /de/system.collections.generic.details/enumeratorselectmanyadapter/
---
## EnumeratorSelectManyAdapter Klasse
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Bewegt den Iterator einen Schritt vorwärts. |
...
| **bool** [MoveNext](./movenext/)() override | Bewegt den Enumerator zum nächsten Element. Wenn vorher kein Element referenziert wurde, wird die Referenz auf das erste verfügbare Element gesetzt. Wird das Ende des Containers erreicht, passiert nichts. |
