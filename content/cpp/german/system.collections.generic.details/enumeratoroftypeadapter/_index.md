...
description: Enumerator, der von der Erweiterungsmethode IEnumerable.OfType() verwendet wird.
type: docs
weight: 66
url: /de/system.collections.generic.details/enumeratoroftypeadapter/
---
## EnumeratorOfTypeAdapter Klasse

Enumerator, der von der Erweiterungsmethode IEnumerable.OfType() verwendet wird.
...
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Bereitet den Iterator vor, der von der Klasse VirtualizedIterator verwendet wird. |
...
| virtual void [Dispose](../../system/idisposable/dispose/)() | Macht nichts. |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | Gibt das aktuelle Element zurück. |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Verschiebt den Iterator einen Schritt vorwärts. |
...
| **bool** [MoveNext](./movenext/)() override | Verschiebt den Enumerator zum nächsten Element. Wenn vorher kein Element referenziert war, wird die Referenz auf das erste verfügbare Element gesetzt. Wird das Ende des Containers erreicht, passiert nichts. |
