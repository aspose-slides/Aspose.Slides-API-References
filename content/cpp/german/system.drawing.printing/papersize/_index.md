...
description: Legt die Größe eines Blatt Papiers fest.
type: docs
weight: 27
url: /de/system.drawing.printing/papersize/
---
## PaperSize Klasse
...
| **int32_t** [get_Height](./get_height/)() const | Ermittelt die Höhe des Papiers in Hundertsteln eines Zolls. |
| [PaperKind](../paperkind/) [get_Kind](./get_kind/)() const | Ermittelt den Papiertyp. |
| [System::String](../../system/string/) [get_PaperName](./get_papername/)() const | Ermittelt den Namen des Papiertyps. |
| **int32_t** [get_RawKind](./get_rawkind/)() const | Ermittelt einen ganzzahligen Wert, der einen der [System::Drawing::Printing::PaperSize](./)-Werte oder einen benutzerdefinierten Wert darstellt. |
| **int32_t** [get_Width](./get_width/)() const | Ermittelt die Breite des Papiers in Hundertsteln eines Zolls. |
...
|  [PaperSize](./papersize/)() | Initialisiert eine neue Instanz der Klasse [System::Drawing::Printing::PaperSize](./). |
|  [PaperSize](./papersize/)([PaperKind](../paperkind/), [System::String](../../system/string/), **int32_t**, **int32_t**) | Initialisiert eine neue Instanz der Klasse [System::Drawing::Printing::PaperSize](./). |
|  [PaperSize](./papersize/)([System::String](../../system/string/), **int32_t**, **int32_t**) | Initialisiert eine neue Instanz der Klasse [System::Drawing::Printing::PaperSize](./). |
...
| void [set_Height](./set_height/)(**int32_t**) | Setzt die Höhe des Papiers in Hundertsteln eines Zolls. |
| void [set_PaperName](./set_papername/)([System::String](../../system/string/)) | Setzt den Namen des Papiertyps. |
| void [set_RawKind](./set_rawkind/)(**int32_t**) | Setzt einen ganzzahligen Wert, der einen der [System::Drawing::Printing::PaperSize](./)-Werte oder einen benutzerdefinierten Wert darstellt. |
| void [set_Width](./set_width/)(**int32_t**) | Setzt die Breite des Papiers in Hundertsteln eines Zolls. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Gibt Informationen über [System::Drawing::Printing::PaperSize](./) als Zeichenkette zurück. |
