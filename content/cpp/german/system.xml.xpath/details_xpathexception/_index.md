...
description: Stellt die Ausnahme bereit, die ausgelöst wird, wenn beim Verarbeiten eines XPath-Ausdrucks ein Fehler auftritt.
type: docs
weight: 1
url: /de/system.xml.xpath/details_xpathexception/
---
## Details_XPathException Klasse

Stellt die Ausnahme bereit, die ausgelöst wird, wenn beim Verarbeiten eines [XPath](../)-Ausdrucks ein Fehler auftritt.
...
| [String](../../system/string/) [get_Message](./get_message/)() const override | Gibt die Beschreibung des Fehlers für diese Ausnahme zurück. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Setzt HRESULT, einen kodierten numerischen Wert, der einer bestimmten Ausnahme zugewiesen wird. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die [what()](../../system/details_exception/what/)-Methode, die von der [ExceptionWrapper](../../system/exceptionwrapper/)-Klasse aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/private Member nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenimplementierung in das [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik brechen. |
