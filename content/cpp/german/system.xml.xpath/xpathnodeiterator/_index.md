...
description: Stellt einen Iterator über einen ausgewählten Knotensatz bereit.
type: docs
weight: 79
url: /de/system.xml.xpath/xpathnodeiterator/
---
## XPathNodeIterator Klasse

Stellt einen Iterator über einen ausgewählten Knotensatz bereit.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Gibt einen Iterator zurück, der direkt nach dem letzten konstant-qualifizierten Element (falls vorhanden) der Sammlung liegt. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNodeIterator](./)\> [Clone](./clone/)() | Wenn in einer abgeleiteten Klasse überschrieben, gibt einen Klon dieses [XPathNodeIterator](./)-Objekts zurück. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Gibt einen Iterator zurück, der direkt nach dem letzten Element (falls vorhanden) der konstant-qualifizierten Instanz der Sammlung liegt. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Gibt den Index des letzten Knotens im ausgewählten Knotensatz zurück. |
| virtual const [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\& [get_Current](./get_current/)() | Wenn in einer abgeleiteten Klasse überschrieben, liefert das [XPathNavigator](../xpathnavigator/)-Objekt für dieses [XPathNodeIterator](./), das auf den aktuellen Kontextknoten positioniert ist. |
| virtual **int32_t** [get_CurrentPosition](./get_currentposition/)() | Wenn in einer abgeleiteten Klasse überschrieben, liefert den Index der aktuellen Position im ausgewählten Knotensatz. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt ein IEnumerator-Objekt zurück, um durch den ausgewählten Knotensatz zu iterieren. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft für jedes Element einer generischen Sequenz eine Transformationsfunktion auf und gibt den maximal resultierenden Wert zurück. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft für jedes Element einer generischen Sequenz eine Transformationsfunktion auf und gibt den minimal resultierenden Wert zurück. |
...
| virtual **bool** [MoveNext](./movenext/)() | Wenn in einer abgeleiteten Klasse überschrieben, bewegt das vom [XPathNodeIterator::get_Current](./get_current/)-Methode zurückgegebene [XPathNavigator](../xpathnavigator/)-Objekt zum nächsten Knoten im ausgewählten Knotensatz. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Erhöht den weak reference count. Sollte nicht direkt aufgerufen werden; stattdessen Smart Pointers oder ThisProtector verwenden. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Verringert den weak reference count. Sollte nicht direkt aufgerufen werden; stattdessen Smart Pointers oder ThisProtector verwenden. |
