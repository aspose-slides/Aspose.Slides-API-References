...
description: Stellt Informationen zu Bildschirmen bereit. Nur Windows. Dies ist ein Singleton-Typ, bei dem die Speicherverwaltung über Zugriffsfunktion(en) erfolgt. Sie sollten niemals Instanzen davon direkt erstellen.
type: docs
weight: 40
url: /de/system.windows.forms/screen/
---
## Screen-Klasse

Stellt Informationen zu Bildschirmen bereit. [Windows](../../system.windows/) nur. Dies ist ein Singleton-Typ, bei dem die Speicherverwaltung über Zugriffsfunktion(en) erfolgt. Sie sollten niemals Instanzen davon direkt erstellen.
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | Ermittelt die Bildschirmgrenzen. |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | Ermittelt Informationen zum primären Display. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopie-Konstruktor. Kopiert tatsächlich nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
