...
description: "Stellt eine Menge von 32-bit ARGB-Farben dar, die eine Farbpalette bilden. Objekte dieser Klasse sollten ausschließlich über die Funktion System::MakeObject() alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 40
url: /de/system.drawing.imaging/colorpalette/
---
## ColorPalette Klasse


Stellt eine Menge von 32-Bit-ARGB-Farben dar, die eine Farbpalette bilden. Objekte dieser Klasse sollten nur über die Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| [System::ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\> [get_Entries](./get_entries/)() const | Gibt ein Array von [Color](../../system.drawing/color/)-Objekten zurück, die durch das aktuelle Objekt repräsentiert werden. |
| int [get_Flags](./get_flags/)() const | Gibt einen Wert zurück, der angibt, wie die Farbwerte im Farbfeld-Array interpretiert werden sollen. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-Konstruktor. Kopiert eigentlich nichts, sondern initialisiert lediglich ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Zuweisungsoperator. Kopiert eigentlich nichts, sondern initialisiert lediglich ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
