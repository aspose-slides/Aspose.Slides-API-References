...
| --- | --- |
|  [Encoder](./encoder/)(const [Guid](../../system/guid/)\&) | Konstruiert eine neue Instanz der Klasse [Encoder](./). |
...
| [Guid](../../system/guid/) [get_Guid](./get_guid/)() const | Gibt eine GUID zurück, die das Set von Bild-Encoder-Parametern angibt, das das aktuelle Objekt repräsentiert. |
...
| Feld | Beschreibung |
| --- | --- |
| static [ChrominanceTable](./chrominancetable/) | Eine Instanz der Klasse [Encoder](./), die die Chrominanz-Tabellenparameterkategorie repräsentiert. |
| static [ColorDepth](./colordepth/) | Eine Instanz der Klasse [Encoder](./), die die Farbtiefe-Parameterkategorie repräsentiert. |
| static [Compression](./compression/) | Eine Instanz der Klasse [Encoder](./), die die Kompressions-Parameterkategorie repräsentiert. |
| static [LuminanceTable](./luminancetable/) | Eine Instanz der Klasse [Encoder](./), die die Luminanz-Tabellenparameterkategorie repräsentiert. |
| static [Quality](./quality/) | Eine Instanz der Klasse [Encoder](./), die die Qualitäts-Parameterkategorie repräsentiert. |
| static [RenderMethod](./rendermethod/) | Eine Instanz der Klasse [Encoder](./), die die Render-Methoden-Parameterkategorie repräsentiert. |
| static [SaveFlag](./saveflag/) | Eine Instanz der Klasse [Encoder](./), die die Speicher-Flag-Parameterkategorie repräsentiert. |
| static [ScanMethod](./scanmethod/) | Eine Instanz der Klasse [Encoder](./), die die Scan-Methoden-Parameterkategorie repräsentiert. |
| static [Transformation](./transformation/) | Eine Instanz der Klasse [Encoder](./), die die Transformations-Parameterkategorie repräsentiert. |
| static [Version](./version/) | Eine Instanz der Klasse [Encoder](./), die die Versions-Parameterkategorie repräsentiert. |
