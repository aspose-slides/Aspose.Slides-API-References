...
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Fügt der Sammlung eine neue Zelle hinzu. |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Erstellt [IChartDataCell](../ichartdatacell/) aus dem angegebenen Wert und fügt es der Sammlung hinzu. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Gibt die Anzahl der Zellen in der Sammlung zurück. Nur lesbar **int32_t**. |
| virtual [System::String](../../system/string/) [GetCellsAddress](./getcellsaddress/)() | Gibt die Adresse des Zellensatzes in der Arbeitsmappe zurück. |
| virtual [System::String](../../system/string/) [GetConcatenatedValuesFromCells](./getconcatenatedvaluesfromcells/)() | Verkettungszeichenfolge aus allen Zell-String-Werten. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | Gibt eine Zelle ([IChartDataCell](../ichartdatacell/)) anhand des Index zurück. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierkonstruktor. Kopiert nichts, tatsächlich, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Zuweisungsoperator. Kopiert nichts, tatsächlich, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Entfernt eine Zelle aus der Sammlung anhand des Index. |
