...
| virtual **float** [get_Bottom](./get_bottom/)() | Gibt die Oberkante des Diagrammelements als Bruchteil der Diagrammhöhe zurück. Nur-Lese **float**. |
...
| virtual **float** [get_Height](./get_height/)() | Gibt die Höhe des Diagrammelements als Bruchteil der Diagrammhöhe an. Lese **float**. |
...
| virtual **float** [get_Right](./get_right/)() | Liefert die rechte Seite des Diagrammelements als Bruchteil der Diagrammbreite. Nur-Lese **float**. |
...
| virtual **float** [get_Width](./get_width/)() | Gibt die Breite des Diagrammelements als Bruchteil der Diagrammbreite an. Lese **float**. |
| virtual **float** [get_X](./get_x/)() | Gibt die x-Position (links) des Diagrammelements als Bruchteil der Diagrammbreite an. Lese **float**. |
| virtual **float** [get_Y](./get_y/)() | Gibt die Oberkante des Diagrammelements als Bruchteil der Diagrammhöhe an. Lese **float**. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Vergleicht einen Werttyp mittels Referenz mit nullptr. |
...
| virtual void [set_Height](./set_height/)(**float**) | Legt die Höhe des Diagrammelements als Bruchteil der Diagrammhöhe fest. Schreib **float**. |
| virtual void [set_Width](./set_width/)(**float**) | Legt die Breite des Diagrammelements als Bruchteil der Diagrammbreite fest. Schreib **float**. |
| virtual void [set_X](./set_x/)(**float**) | Legt die x-Position (links) des Diagrammelements als Bruchteil der Diagrammbreite fest. Schreib **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Legt die Oberkante des Diagrammelements als Bruchteil der Diagrammhöhe fest. Schreib **float**. |
