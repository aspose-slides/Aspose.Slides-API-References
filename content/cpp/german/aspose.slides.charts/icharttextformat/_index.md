...
description: Diagramme arbeiten mit einem eingeschränkten Satz von Textformat-Eigenschaften. Die Schnittstellen IChartTextFormat, IChartTextBlockFormat, IChartParagraphFormat, IChartPortionFormat beschreiben diesen eingeschränkten Satz.
type: docs
weight: 898
...
[Chart](../chart/) arbeiten mit einem eingeschränkten Satz von Textformat-Eigenschaften. [IChartTextFormat](./), [IChartTextBlockFormat](../icharttextblockformat/), [IChartParagraphFormat](../ichartparagraphformat/), [IChartPortionFormat](../ichartportionformat/) Schnittstellen beschreiben diesen eingeschränkten Satz.
...
| --- | --- |
| virtual void [CopyFrom](./copyfrom/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) | Kopiert das Textformat aus dem angegebenen Textframe. |
| virtual void [CopyTo](./copyto/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) | Kopiert das Textformat in den angegebenen Textframe. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartParagraphFormat](../ichartparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() | Gibt das Absatzformat zurück. Nur lesbar [IChartParagraphFormat](../ichartparagraphformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartPortionFormat](../ichartportionformat/)\> [get_PortionFormat](./get_portionformat/)() | Gibt das Abschnittsformat zurück. Nur lesbar [IChartPortionFormat](../ichartportionformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartTextBlockFormat](../icharttextblockformat/)\> [get_TextBlockFormat](./get_textblockformat/)() | Gibt das Format für die Diagramm-Textelemente zurück. Nur lesbar [IChartTextBlockFormat](../icharttextblockformat/). |
