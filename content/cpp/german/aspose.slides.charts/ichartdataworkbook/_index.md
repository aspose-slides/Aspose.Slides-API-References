...
description: Stellt Zugriff auf das eingebettete Excel-Arbeitsbuch bereit
type: docs
weight: 729
...
Stellt Zugriff auf das eingebettete [Excel](../../aspose.slides.excel/) Arbeitsbuch bereit
...
| --- | --- |
| virtual void [CalculateFormulas](./calculateformulas/)() | Berechnet alle Formeln im Arbeitsbuch und aktualisiert die entsprechenden Zellenwerte. |
| virtual void [Clear](./clear/)(**int32_t**) | Löscht alle Zellenwerte im Blatt. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\> [get_Worksheet](./get_worksheet/)(**int32_t**) | Gibt das Arbeitsblatt dieses Arbeitsbuchs am angegebenen Index zurück. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheetCollection](../ichartdataworksheetcollection/)\> [get_Worksheets](./get_worksheets/)() | Liefert eine Sammlung von Arbeitsblättern. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)([System::String](../../system/string/), **int32_t**, **int32_t**) | Liefert die Zelle, die für Diagrammreihen oder Kategorien verwendet werden kann. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, **int32_t**, **int32_t**) | Liefert die Zelle, die für Diagrammreihen oder Kategorien verwendet werden kann. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, [System::String](../../system/string/)) | Liefert die Zelle, die für Diagrammreihen oder Kategorien verwendet werden kann. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, [System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Liefert die Zelle, die für Diagrammreihen oder Kategorien verwendet werden kann. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, **int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Liefert die Zelle, die für Diagrammreihen oder Kategorien verwendet werden kann. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [GetCellCollection](./getcellcollection/)([System::String](../../system/string/), **bool**) | Liefert die Menge der Zellen. |
