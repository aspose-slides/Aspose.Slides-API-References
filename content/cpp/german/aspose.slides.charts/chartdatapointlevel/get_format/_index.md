...
description: Stellt Formatierungseigenschaften der Datenpunktebene dar. Lesen IFormat.
type: docs
weight: 1
url: /de/aspose.slides.charts/chartdatapointlevel/get_format/
---
## ChartDataPointLevel::get_Format() Methode

Stellt Formatierungseigenschaften der Datenpunktebene dar. Lesen [IFormat](../../iformat/).
