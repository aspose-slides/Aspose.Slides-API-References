...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() override | Gibt das [IChartDataCell](../ichartdatacell/)-Objekt zurück. Wenn die Kategorie mehrstufig ist, wird das [IChartDataCell](../ichartdatacell/)-Objekt für Ebene "0" verwendet. Lesen [IChartDataCell](../ichartdatacell/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_AsLiteral](./get_asliteral/)() override | Gibt das AsLiteral-Objekt zurück. Lesen [System::Object](../../system/object/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_GroupingLevel](./get_groupinglevel/)(**int32_t**) override | Gibt die Gruppierungsebene einer Diagrammkategorie am angegebenen Index zurück. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)\> [get_GroupingLevels](./get_groupinglevels/)() override | Verwalteter Container der Werte der Gruppierungsebenen einer Diagrammkategorie. Mehrstufige Kategorien enthalten mehr als eine Gruppierungsebene. Die Indizierung der Gruppierungsebenen beginnt bei Null. Read-only [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/). |
| **bool** [get_UseCell](./get_usecell/)() override | Wenn true, ist die AsCell-Eigenschaft aktiv. Mit anderen Worten, das Arbeitsblatt wird zum Speichern der Kategorie verwendet (dieser Fall unterstützt eine mehrstufige Kategorie). Wenn false, ist die AsLiteral-Eigenschaft aktiv. Mit anderen Worten, das Arbeitsblatt wird NICHT zum Speichern der Kategorie verwendet (und dieser Fall unterstützt keine mehrstufigen Kategorien). Read-only **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | Wenn UseCell true ist, stellt diese Eigenschaft die [get_AsCell()](./get_ascell/)->get(set)_Value()-Eigenschaft dar. Wenn UseCell false ist, stellt diese Eigenschaft die AsLiteral-Eigenschaft dar. Lesen [System::Object](../../system/object/). |
...
| void [Remove](./remove/)() override | Entfernt die Kategorie aus dem Diagramm. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verringert den gemeinsamen Referenzzähler um den angegebenen Wert. |
| void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Setzt das [IChartDataCell](../ichartdatacell/)-Objekt. Wenn die Kategorie mehrstufig ist, wird das [IChartDataCell](../ichartdatacell/)-Objekt für Ebene "0" verwendet. Schreiben [IChartDataCell](../ichartdatacell/). |
| void [set_AsLiteral](./set_asliteral/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Setzt das AsLiteral-Objekt. Schreiben [System::Object](../../system/object/). |
| void [set_Value](./set_value/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Wenn UseCell true ist, stellt diese Eigenschaft die [get_AsCell()](./get_ascell/)->get(set)_Value()-Eigenschaft dar. Wenn UseCell false ist, stellt diese Eigenschaft die AsLiteral-Eigenschaft dar. Schreiben [System::Object](../../system/object/). |
