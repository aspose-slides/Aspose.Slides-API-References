...
description: Verwalteter Container für die Werte der Diagrammkategorienebenen.
type: docs
weight: 612
...
Verwalteter Container für die Werte der Diagramm-Kategorienebenen.
...
| --- | --- |
| virtual void [DeleteGroupingItem](./deletegroupingitem/)(**int32_t**) | Löscht das Gruppierungselement für die definierte Ebene. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | Gibt das [IChartDataCell](../ichartdatacell/)-Objekt für die definierte Ebene zurück. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Prüft, ob das Objekt eine Instanz des durch targetType beschriebenen Typs darstellt. Analog zu C# 'is' Operator. |
| void [Lock](../../system/object/lock/)() | Implementiert die C# lock()-Anweisung (Sperren). Aufruf direkt oder Verwendung des [LockContext](../../system/lockcontext/)-Wächterobjekts. |
...
| virtual void [SetGroupingItem](./setgroupingitem/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Setzt das Gruppierungselement für die definierte Ebene. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert die C# lock()-Anweisung (Entsperren). Aufruf direkt oder Verwendung des [LockContext](../../system/lockcontext/)-Wächterobjekts. |
