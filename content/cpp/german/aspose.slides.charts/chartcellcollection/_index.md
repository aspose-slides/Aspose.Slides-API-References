...
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Fügt der Sammlung eine neue Zelle hinzu. |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Erstellt [ChartDataCell](../chartdatacell/) aus dem angegebenen Wert und fügt ihn der Sammlung hinzu. |
...
| **int32_t** [get_Count](./get_count/)() override | Gibt die Anzahl der Zellen in der Sammlung zurück. Nur lesbarer **int32_t**. |
| [System::String](../../system/string/) [GetCellsAddress](./getcellsaddress/)() override | Gibt die Adresse des Zellen-Sets in der Arbeitsmappe zurück. |
| [System::String](../../system/string/) [GetConcatenatedValuesFromCells](./getconcatenatedvaluesfromcells/)() override | Verkettungszeichenkette aus den Zeichenkettenwerten aller Zellen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der die Sammlung durchläuft. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) override | Gibt eine Zelle ([IChartDataCell](../ichartdatacell/)) nach Index zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformiert jedes Element einer Sequenz in eine neue Form, indem der Index des Elements berücksichtigt wird. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Entfernt eine Zelle aus der Sammlung per Index. |
