...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Stellt Formatierungseigenschaften der Datenpunktstufe dar. Siehe [IFormat](../iformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | Stellt Datenbeschriftung der Datenpunktstufe dar. Wird angewendet für Treemap- und Sunburst-Serientypen. Nur lesbar [IDataLabel](../idatalabel/). |
