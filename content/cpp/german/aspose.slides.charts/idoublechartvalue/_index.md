...
description: "Repräsentiert einen double-Wert, der in einer pptx-Präsentationsdatei auf zwei Arten gespeichert werden kann: 1) in Zelle/Zellen einer Arbeitsmappe, die mit einem Diagramm verbunden ist; 2) als Literalwert."
type: docs
weight: 1002
url: /de/aspose.slides.charts/idoublechartvalue/
---
## Klasse IDoubleChartValue

Stellt einen double-Wert dar, der in einer pptx-Präsentationsdatei auf zwei Arten gespeichert werden kann: 1) in Zelle/Zellen einer Arbeitsmappe, die mit einem Diagramm verbunden ist; 2) als Literalwert.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](../isinglecellchartvalue/get_ascell/)() | Gibt die Diagrammdatenzelle zurück. Lesen [IChartDataCell](../ichartdatacell/). |
| virtual **double** [get_AsLiteralDouble](./get_asliteraldouble/)() | Gibt den Literalwert vom Typ double zurück, wenn DataSourceType = [Charts::DataSourceType::DoubleLiterals](../datasourcetype/). Lesen **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | Legt fest, ob die Eigenschaft AsCell, AsLiteralString oder AsLiteralDouble aktuell ist. Mit anderen Worten gibt sie den Typ des Wertes der Data-Eigenschaft an. Diese Eigenschaft ist schreibgeschützt. Zum Ändern des Wertes dieser Eigenschaft können Sie eine der ChartDataPointCollection.DataSourceTypeFor<...>-Eigenschaften verwenden. Lesen [DataSourceType](../datasourcetype/). |
...
| virtual void [set_AsCell](../isinglecellchartvalue/set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Setzt die Diagrammdatenzelle. Schreiben [IChartDataCell](../ichartdatacell/). |
| virtual void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) | Setzt den Literalwert vom Typ double, wenn DataSourceType = [Charts::DataSourceType::DoubleLiterals](../datasourcetype/). Schreiben **double**. |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Legt fest, ob die Eigenschaft AsCell, AsLiteralString oder AsLiteralDouble aktuell ist. Mit anderen Worten gibt sie den Typ des Wertes der Data-Eigenschaft an. Diese Eigenschaft ist schreibgeschützt. Zum Ändern des Wertes dieser Eigenschaft können Sie eine der ChartDataPointCollection.DataSourceTypeFor<...>-Eigenschaften verwenden. Schreiben [DataSourceType](../datasourcetype/). |
...
| virtual **double** [ToDouble](./todouble/)() | Konvertiert zu double. |
...
* Klasse [ISingleCellChartValue](../isinglecellchartvalue/)
