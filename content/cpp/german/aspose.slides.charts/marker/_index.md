...
description: Stellt einen Marker eines Schiefers dar.
type: docs
weight: 1301
...
Stellt einen Marker eines Schiefers dar.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Liefert die Markerfüllung. Nur lesbar [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | Stellt die Markergröße in einem Liniendiagramm, Streudiagramm oder Radar-Diagramm dar. Lese **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | Stellt den Markerstil in einem Liniendiagramm, Streudiagramm oder Radar-Diagramm dar. Lese [MarkerStyleType](../markerstyletype/). |
...
| void [set_Size](./set_size/)(**int32_t**) override | Stellt die Markergröße in einem Liniendiagramm, Streudiagramm oder Radar-Diagramm dar. Schreib **int32_t**. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | Stellt den Markerstil in einem Liniendiagramm, Streudiagramm oder Radar-Diagramm dar. Schreib [MarkerStyleType](../markerstyletype/). |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Verringert den schwachen Referenzzähler. Sollte nicht direkt aufgerufen werden; stattddessen Smart-Pointer oder ThisProtector verwenden. |
