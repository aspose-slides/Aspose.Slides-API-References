...
Stellt eine Sammlung von Punkten dar, die im zweiten Kuchen- oder Balkendiagramm eines Bar-of-Pie- bzw. Pie-of-Pie-Diagramms mit einer benutzerdefinierten Aufteilung gezeichnet werden sollen.
...
| --- | --- |
| virtual void [Add](./add/)(const **int32_t**\&) | Fügt einen Datenpunkt anhand seines Indexes in der Punkte-Sammlung der übergeordneten Serie hinzu. |
...
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopiert alle Elemente der Sammlung in vorhandene Array-Elemente. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) | Gibt den Diagrammdatenpunkt anhand des Index zurück. |
...
| virtual void [Remove](./remove/)(**int32_t**) | Entfernt ein Element aus der Sammlung anhand seines Indexes in der Punkte-Sammlung der übergeordneten Serie. |
