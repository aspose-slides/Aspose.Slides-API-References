...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | Gibt das Format der Ab-Balken zurück. Nur lesbar [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | Gibt die Lückenbreite zurück. Lese **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | Bestimmt, ob das Diagramm Auf-/Ab-Balken hat. Lese **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | Gibt das Format der Auf-Balken zurück. Nur lesbar [IFormat](../iformat/). |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | Setzt die Lückenbreite. Schreibe **int32_t**. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | Bestimmt, ob das Diagramm Auf-/Ab-Balken hat. Schreibe **bool**. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Verringert und liefert die freigegebene Referenzzählung zurück. Sollte nicht direkt aufgerufen werden; stattdessen Smart-Pointer oder ThisProtector verwenden. |
