...
description: Stellt das Format der Leader-Lines von Datenbeschriftungen dar. Nur lesbar IChartLinesFormat.
type: docs
weight: 14
url: /de/aspose.slides.charts/idatalabelcollection/get_leaderlinesformat/
---
## IDataLabelCollection::get_LeaderLinesFormat() Methode

Stellt das Format der Leader-Lines von Datenbeschriftungen dar. Nur lesbar [IChartLinesFormat](../../ichartlinesformat/).
