...
| virtual **float** [get_ActualHeight](./get_actualheight/)() | Gibt die tatsächliche Höhe des Diagrammelements an. Rufen Sie die Methode [IChart::ValidateChartLayout](../ichart/validatechartlayout/) vorher auf, um die tatsächlichen Werte zu erhalten. Lesen **float**. |
| virtual **float** [get_ActualWidth](./get_actualwidth/)() | Gibt die tatsächliche Breite des Diagrammelements an. Rufen Sie die Methode [IChart::ValidateChartLayout](../ichart/validatechartlayout/) vorher auf, um die tatsächlichen Werte zu erhalten. Lesen **float**. |
| virtual **float** [get_ActualX](./get_actualx/)() | Gibt die tatsächliche x-Position (links) des Diagrammelements relativ zur linken oberen Ecke des Diagramms an. Rufen Sie die Methode [IChart::ValidateChartLayout](../ichart/validatechartlayout/) vorher auf, um die tatsächlichen Werte zu erhalten. Lesen **float**. |
| virtual **float** [get_ActualY](./get_actualy/)() | Gibt die tatsächliche obere Position des Diagrammelements relativ zur linken oberen Ecke des Diagramms an. Rufen Sie die Methode [IChart::ValidateChartLayout](../ichart/validatechartlayout/) vorher auf, um die tatsächlichen Werte zu erhalten. Lesen **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierkonstruktor. Kopiert im Wesentlichen nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Zuweisungsoperator. Kopiert im Wesentlichen nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
