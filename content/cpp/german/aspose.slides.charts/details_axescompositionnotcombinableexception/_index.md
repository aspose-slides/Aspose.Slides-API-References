...
description: Ausnahme, die ausgelöst wird, wenn die Achsenkomposition der Serie nicht mit der aktuellen Achsenkomposition im Diagramm kombinierbar ist.
type: docs
weight: 430
url: /de/aspose.slides.charts/details_axescompositionnotcombinableexception/
---
## Details_AxesCompositionNotCombinableException Klasse

Exception, die ausgelöst wird, wenn die Achsenkomposition der Serie nicht mit der aktuellen Achsenkomposition im Diagramm kombinierbar ist.
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_invalidoperationexception/gettype/)() const override | Ermittelt den tatsächlichen Typ des Objekts. Entspricht dem C#-Aufruf [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument zu einem Weak-Pointer (statt zu einem Shared-Pointer). Ermöglicht das Umschalten von Zeigern in Containern auf den Weak-Modus. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die Methode [what()](../../system/details_exception/what/), die von der Klasse [ExceptionWrapper](../../system/exceptionwrapper/) aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception abgeleitet ist, können abgeleitete Klassen geschützte/privat-e Mitglieder verwenden, um ihre Logik zu implementieren. Das Verschieben dieser Methodenimplementierung in das [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik brechen. |
