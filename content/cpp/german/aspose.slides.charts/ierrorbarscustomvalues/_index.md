...
description: Gibt die Fehlbalkenwerte an. Sie darf nur verwendet werden, wenn der Fehlerbalkenwerttyp Custom ist.
type: docs
weight: 1015
...
Gibt die Fehlbalkenwerte an. Sie darf nur verwendet werden, wenn der Fehlerbalkenwerttyp Custom ist.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-artigen Vergleich von Gleitkommazahlen, wobei zwei NaNs als gleich betrachtet werden, obwohl laut IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Vergleich von Gleitkommazahlen, wobei zwei NaNs als gleich betrachtet werden, obwohl laut IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() | Gibt den Fehlerbalkenwert in negativer Richtung an. Verfügbar, wenn der Fehlerbalkenwerttyp Custom ist und ErrorBarsXFormat erlaubt ist. In allen anderen Fällen gibt diese Eigenschaft null zurück. Nur lesend [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() | Gibt den Fehlerbalkenwert in positiver Richtung an. Verfügbar, wenn der Fehlerbalkenwerttyp Custom ist und ErrorBarsXFormat erlaubt ist. In allen anderen Fällen gibt diese Eigenschaft null zurück. Nur lesend [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() | Gibt den Fehlerbalkenwert in negativer Richtung an. Verfügbar, wenn der Fehlerbalkenwerttyp Custom ist und ErrorBarsYFormat erlaubt ist. In allen anderen Fällen gibt diese Eigenschaft null zurück. Nur lesend [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() | Gibt den Fehlerbalkenwert in positiver Richtung an. Verfügbar, wenn der Fehlerbalkenwerttyp Custom ist und ErrorBarsYFormat erlaubt ist. In allen anderen Fällen gibt diese Eigenschaft null zurück. Nur lesend [IDoubleChartValue](../idoublechartvalue/). |
