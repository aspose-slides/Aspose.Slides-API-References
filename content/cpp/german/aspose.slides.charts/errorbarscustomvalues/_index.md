...
description: Gibt die Werte der Fehlerbalken an. Sie darf nur verwendet werden, wenn der Fehlerbalkenwerttyp Custom ist.
type: docs
weight: 469
...
Gibt die Werte der Fehlerbalken an. Sie darf nur verwendet werden, wenn der Fehlerbalkenwerttyp Custom ist.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() override | Gibt den Fehlerbalkenwert in negativer Richtung an. Verfügbar, wenn der Fehlerbalkenwerttyp Custom ist und ErrorBarsXFormat erlaubt ist. In allen anderen Fällen gibt diese Eigenschaft null zurück. Nur lesbar [IDoubleChartValue](../idoublechartvalue/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() override | Gibt den Fehlerbalkenwert in positiver Richtung an. Verfügbar, wenn der Fehlerbalkenwerttyp Custom ist und ErrorBarsXFormat erlaubt ist. In allen anderen Fällen gibt diese Eigenschaft null zurück. Nur lesbar [IDoubleChartValue](../idoublechartvalue/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() override | Gibt den Fehlerbalkenwert in negativer Richtung an. Verfügbar, wenn der Fehlerbalkenwerttyp Custom ist und ErrorBarsYFormat erlaubt ist. In allen anderen Fällen gibt diese Eigenschaft null zurück. Nur lesbar [IDoubleChartValue](../idoublechartvalue/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() override | Gibt den Fehlerbalkenwert in positiver Richtung an. Verfügbar, wenn der Fehlerbalkenwerttyp Custom ist und ErrorBarsYFormat erlaubt ist. In allen anderen Fällen gibt diese Eigenschaft null zurück. Nur lesbar [IDoubleChartValue](../idoublechartvalue/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Setzt das n-te Template-Argument auf einen schwachen Zeiger (statt eines geteilten). Ermöglicht das Umstellen von Zeigern in Containern auf den schwachen Modus. |
