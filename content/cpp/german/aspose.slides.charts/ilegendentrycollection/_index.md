...
| virtual **int32_t** [get_Count](./get_count/)() | Ermittelt die tatsächlich in der Sammlung enthaltene Anzahl von Elementen. Schreibgeschützt **int32_t**. |
