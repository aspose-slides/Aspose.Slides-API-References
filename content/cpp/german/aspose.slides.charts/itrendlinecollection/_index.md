...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [Add](./add/)([TrendlineType](../trendlinetype/)) | Fügt das neue [Trendline](../trendline/) am Ende einer Sammlung hinzu und gibt es zurück. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Liefert die tatsächliche Anzahl der in der Sammlung enthaltenen Elemente. Nur-Lese **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [idx_get](./idx_get/)(**int32_t**) | Liefert das Element am angegebenen Index. Nur-Lese [ITrendline](../itrendline/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\>) | Entfernt den angegebenen Wert. |
