...
description: Stellt eine Sammlung von ChartCategory dar
type: docs
weight: 79
...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Wenn die Kategorie in der Sammlung existiert, wird sie zurückgegeben. Andernfalls wird eine neue Diagrammkategorie aus [IChartDataCell](../ichartdatacell/) erstellt und zur Sammlung hinzugefügt. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Erstellt eine neue [ChartCategory](../chartcategory/) aus dem Wert und fügt sie der Sammlung hinzu. |
| [iterator](./iterator/) [begin](./begin/)() | Ermittelt einen Iterator, der auf das erste Element (sofern vorhanden) der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Ermittelt einen Iterator, der auf das erste Element (sofern vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Ermittelt einen Iterator, der auf das erste const-qualifizierte Element (sofern vorhanden) der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Ermittelt einen Iterator, der unmittelbar nach dem letzten const-qualifizierten Element (sofern vorhanden) der Sammlung zeigt. |
| void [Clear](./clear/)() override | Entfernt alle Elemente aus der Sammlung. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>, **int32_t**) override | Kopiert alle Elemente der Sammlung in das angegebene Array. |
| [iterator](./iterator/) [end](./end/)() | Ermittelt einen Iterator, der unmittelbar nach dem letzten Element (sofern vorhanden) der Sammlung zeigt. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Ermittelt einen Iterator, der unmittelbar nach dem letzten Element (sofern vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
...
| **int32_t** [get_Count](./get_count/)() override | Gibt die Anzahl der Elemente in der Sammlung zurück. Nur lesbar **int32_t**. |
| **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() override | Gibt die Anzahl der verwendeten Kategorisierungs-Ebenen zurück. Ist bei mehrstufigen Kategorien größer als eins. Nur lesbar **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Gibt einen Wert zurück, der angibt, ob der Zugriff auf die Liste synchronisiert (Thread-sicher) ist. Nur lesbar **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Gibt ein Objekt zurück, das zur Synchronisation des Zugriffs auf die Sammlung verwendet werden kann. Nur lesbar [System::Object](../../system/object/). |
| **bool** [get_UseCells](./get_usecells/)() override | Wenn true, wird das Arbeitsblatt zur Speicherung von Kategorien verwendet (dieser Fall unterstützt mehrstufige Kategorien). Wenn false, wird das Arbeitsblatt NICHT zur Speicherung von Werten verwendet (und dieser Fall unterstützt keine mehrstufigen Kategorien). Nur lesbar **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der die Sammlung durchläuft. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog zur C# [Object.GetHashCode()](../../system/object/gethashcode/)-Methode. Ermöglicht das Hashen benutzerdefinierter Objekte. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Ermittelt den tatsächlichen Typ des Objekts. Analog zum C# [System.Object.GetType()](../../system/object/gettype/)-Aufruf. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) override | Ermittelt das Element am angegebenen Index. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | Durchsucht die gesamte Sammlung nach dem angegebenen [ChartCategory](../chartcategory/) und gibt den nullbasierten Index des ersten Vorkommens zurück. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft für jedes Element einer generischen Sequenz eine Transformationsfunktion auf und gibt den maximalen Ergebniswert zurück. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft für jedes Element einer generischen Sequenz eine Transformationsfunktion auf und gibt den minimalen Ergebniswert zurück. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | Entfernt den angegebenen Wert. |
...
| void [set_UseCells](./set_usecells/)(**bool**) override | Wenn true, wird das Arbeitsblatt zur Speicherung von Kategorien verwendet (dieser Fall unterstützt mehrstufige Kategorien). Wenn false, wird das Arbeitsblatt NICHT zur Speicherung von Werten verwendet (und dieser Fall unterstützt keine mehrstufigen Kategorien). Schreib **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Setzt das n-te Template-Argument zu einem schwachen Zeiger (statt shared). Ermöglicht das Umschalten von Zeigern in Containern auf schwachen Modus. |
| int [SharedCount](../../system/object/sharedcount/)() const | Ermittelt den aktuellen Wert der gemeinsam genutzten Referenzzählung. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Erhöht die gemeinsam genutzte Referenzzählung. Sollte nicht direkt aufgerufen werden; stattdessen smarte Zeiger oder ThisProtector verwenden. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Verringert die gemeinsam genutzte Referenzzählung und gibt sie zurück. Sollte nicht direkt aufgerufen werden; stattdessen smarte Zeiger oder ThisProtector verwenden. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Ermittelt einen Iterator, der auf das erste Element (sofern vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Ermittelt einen Iterator, der auf das erste Element (sofern vorhanden) der Sammlung zeigt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Ermittelt einen Iterator, der unmittelbar nach dem letzten Element (sofern vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Ermittelt einen Iterator, der unmittelbar nach dem letzten Element (sofern vorhanden) der Sammlung zeigt. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Erhöht die schwache Referenzzählung. Sollte nicht direkt aufgerufen werden; stattdessen smarte Zeiger oder ThisProtector verwenden. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Verringert die schwache Referenzzählung. Sollte nicht direkt aufgerufen werden; stattdessen smarte Zeiger oder ThisProtector verwenden. |
