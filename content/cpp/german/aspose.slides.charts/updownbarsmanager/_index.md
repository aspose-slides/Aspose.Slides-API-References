...
description: Bietet Zugriff auf Auf-/Ab-Balken von Linien- oder Aktien-Diagrammen.
type: docs
weight: 1392
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() override | Gibt das DownBars-Format zurück. Nur lesend [IFormat](../iformat/). |
| **int32_t** [get_GapWidth](./get_gapwidth/)() override | GapWidth. Lesen **int32_t**. |
| **bool** [get_HasUpDownBars](./get_hasupdownbars/)() override | HasUpDownBars. Lesen **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() override | Gibt das UpBars-Format zurück. Nur lesend [IFormat](../iformat/). |
...
| void [set_GapWidth](./set_gapwidth/)(**int32_t**) override | GapWidth. Schreiben **int32_t**. |
| void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) override | HasUpDownBars. Schreiben **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Setzt das n-te Template-Argument auf einen Weak-Pointer (statt eines Shared-Pointers). Ermöglicht das Umstellen von Zeigern in Containern auf den Weak-Modus. |
...
* Klasse [IUpDownBarsManager](../iupdownbarsmanager/)
