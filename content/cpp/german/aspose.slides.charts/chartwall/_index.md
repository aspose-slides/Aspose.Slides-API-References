...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Gibt die Wandfüllung, Linie, Effekt, 3D-Stile zurück. Nur lesbar [IFormat](../iformat/). |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | Gibt den Bildtyp zurück oder setzt ihn. Lesen [Charts::PictureType](../picturetype/). |
| **int32_t** [get_Thickness](./get_thickness/)() override | Gibt die Wanddicke als Prozentsatz der größten Dimension des Plotvolumens zurück. Lesen **int32_t**. |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | Gibt den Bildtyp zurück oder setzt ihn. Schreiben [Charts::PictureType](../picturetype/). |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | Setzt die Wanddicke als Prozentsatz der größten Dimension des Plotvolumens. Schreiben **int32_t**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Setzt das n-te Template-Argument zu einem schwachen Zeiger (statt eines freigegebenen). Ermöglicht das Umschalten von Zeigern in Containern auf schwachen Modus. |
