...
description: "Stellt einen einfarbigen Pinsel dar. Objekte dieser Klasse sollten nur über die Funktion System::MakeObject() alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse immer in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 300
url: /de/system.drawing/solidbrush/
---
## SolidBrush Klasse
...
| Method | Description |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | Erzeugt eine Kopie des aktuellen Objekts. |
...
| [Color](../color/) [get_Color](./get_color/)() const | Gibt die Farbe dieses Pinsels zurück. |
...
| void [set_Color](./set_color/)([Color](../color/)) | Setzt die Farbe dieses Pinsels. |
...
|  [SolidBrush](./solidbrush/)(const [Color](../color/)\&) | Konstruiert ein neues [SolidBrush](./)-Objekt und initialisiert es mit der angegebenen Farbe. |
