...
description: "FormatException wird ausgelöst, wenn das Format des Arguments der Methode ungültig ist. Erstellen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die Klasse FormatException. Wickeln Sie die Instanzen der Klasse FormatException niemals in System::SmartPtr ein."
type: docs
weight: 469
url: /de/system/details_formatexception/
---
## Details_FormatException Klasse


FormatException wird ausgelöst, wenn das Format des Arguments der Methode ungültig ist. Erstellen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die Klasse FormatException. Wickeln Sie die Instanzen der Klasse FormatException niemals in [System::SmartPtr](../smartptr/) ein.
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Gibt die String-Repräsentation des aktuellen Objekts zurück. |
...
| virtual const char * [what](../details_exception/what/)() const | Implementiert die Methode [what()](../details_exception/what/), die von der Klasse [ExceptionWrapper](../exceptionwrapper/) aufgerufen wird. Obwohl diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/ private Mitglieder nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenimplementierung in [ExceptionWrapper](../exceptionwrapper/) könnte diese Logik brechen. |
