...
description: "ArgumentOutOfRangeException wird ausgelöst, wenn einer aufgerufenen Methode ein Argument übergeben wird, das außerhalb des erwarteten Wertebereichs für dieses Argument liegt. Erstellen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die ArgumentOutOfRangeException-Klasse. Wickeln Sie die Instanzen der ArgumentOutOfRangeException-Klasse niemals in System::SmartPtr ein."
type: docs
weight: 352
url: /de/system/details_argumentoutofrangeexception/
---
## Details_ArgumentOutOfRangeException Klasse

ArgumentOutOfRangeException wird ausgelöst, wenn einer aufgerufenen Methode ein Argument übergeben wird, das außerhalb des erwarteten Wertebereichs für dieses Argument liegt. Erstellen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die ArgumentOutOfRangeException-Klasse. Wickeln Sie die Instanzen der ArgumentOutOfRangeException-Klasse niemals in [System::SmartPtr](../smartptr/) ein.
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Gibt die Referenzzähler-Datenstruktur zurück, die mit dem Objekt verknüpft ist. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Gibt den tatsächlichen Typ des Objekts zurück. Analog zum C#-Aufruf [System.Object.GetType()](../object/gettype/). |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Gibt die Zeichenkettendarstellung des aktuellen Objekts zurück. |
