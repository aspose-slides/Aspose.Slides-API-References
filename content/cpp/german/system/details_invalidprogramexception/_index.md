...
description: "InvalidProgramException ist nur aus Kompatibilitätsgründen vorhanden. Erzeugen Sie niemals Instanzen dieser Klasse manuell. Verwenden Sie stattdessen die InvalidProgramException-Klasse. Wickeln Sie die InvalidProgramException-Klasseninstanzen niemals in System::SmartPtr ein."
type: docs
weight: 521
url: /de/system/details_invalidprogramexception/
---
## Details_InvalidProgramException Klasse


InvalidProgramException ist nur aus Kompatibilitätsgründen vorhanden. Erzeugen Sie niemals Instanzen dieser Klasse manuell. Verwenden Sie stattdessen die InvalidProgramException-Klasse. Wickeln Sie die InvalidProgramException-Klasseninstanzen niemals in [System::SmartPtr](../smartptr/) ein.
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-artigen Vergleich von Gleitkommazahlen, wobei zwei NaNs als gleich betrachtet werden, obwohl gemäß IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Vergleich von Gleitkommazahlen, wobei zwei NaNs als gleich betrachtet werden, obwohl gemäß IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
...
| virtual [String](../string/) [get_Message](../details_exception/get_message/)() const | Gibt die Zeichenkette mit der Fehlerbeschreibung zurück. |
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Gibt die Zeichenkette mit dem Stack-Trace zurück. |
...
| void [Lock](../object/lock/)() | Implementiert die Sperrung des C#-lock()-Statements. Direkt aufrufen oder das [LockContext](../lockcontext/)-Wächterobjekt verwenden. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopierkonstruktor. Kopiert nichts wirklich, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopier-Konstruktion von Unterklassen. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Zuweisungsoperator. Kopiert nichts wirklich, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopier-Konstruktion von Unterklassen. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Setzt den HRESULT, einen codierten numerischen Wert, der einer spezifischen Ausnahme zugeordnet ist. |
...
| virtual const char * [what](../details_exception/what/)() const | Implementiert die [what()](../details_exception/what/)-Methode, die von der Klasse [ExceptionWrapper](../exceptionwrapper/) aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception abgeleitet ist, können abgeleitete Klassen geschützte/ private Mitglieder nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenimplementierung in das [ExceptionWrapper](../exceptionwrapper/) könnte diese Logik brechen. |
