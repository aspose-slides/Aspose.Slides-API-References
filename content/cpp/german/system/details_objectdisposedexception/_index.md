...
description: "ObjectDisposedException wird ausgelöst, wenn eine Methode an einem freigegebenen Objekt aufgerufen wird. Erstellen Sie niemals Instanzen dieser Klasse manuell. Verwenden Sie stattdessen die ObjectDisposedException-Klasse. Wickeln Sie die ObjectDisposedException-Klasseninstanzen niemals in System::SmartPtr ein."
type: docs
weight: 612
url: /de/system/details_objectdisposedexception/
---
## Details_ObjectDisposedException Klasse


ObjectDisposedException wird ausgelöst, wenn eine Methode an einem freigegebenen Objekt aufgerufen wird. Erstellen Sie niemals Instanzen dieser Klasse manuell. Verwenden Sie stattdessen die ObjectDisposedException-Klasse. Wickeln Sie niemals die ObjectDisposedException-Klasseninstanzen in [System::SmartPtr](../smartptr/) ein.
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Gibt einen 32-Bit-Integer-Wert zurück, der ein HRESULT-Code ist, der mit der durch das aktuelle Objekt dargestellten Ausnahme verbunden ist. |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | Vergleicht das Referenz des Werttyps mit nullptr. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Setzt den HRESULT, einen codierten numerischen Wert, der einer bestimmten Ausnahme zugeordnet wird. |
