...
description: "MemberAccessException wird ausgelöst, wenn versucht wird, auf ein nicht existentes Klassenmitglied zuzugreifen, oder wenn der Zugriff auf das Mitglied nicht erlaubt ist. Erstellen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die MemberAccessException-Klasse. Wickeln Sie die MemberAccessException-Klasseninstanzen niemals in System::SmartPtr ein."
type: docs
weight: 547
url: /de/system/details_memberaccessexception/
---
## Details_MemberAccessException Klasse


MemberAccessException wird ausgelöst, wenn versucht wird, auf ein nicht existentes Klassenmitglied zuzugreifen, oder wenn der Zugriff auf das Mitglied nicht erlaubt ist. Erstellen Sie niemals Instanzen dieser Klasse manuell. Verwenden Sie stattdessen die MemberAccessException Klasse. Wickeln Sie die MemberAccessException Klasseninstanzen niemals in [System::SmartPtr](../smartptr/) ein.
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuliert einen C#-artigen Gleitkommavergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuliert einen C#-artigen Gleitkommavergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Gibt ein Wörterbuch mit benutzerdefinierten Ausnahmeinformationen zurück. |
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Gibt einen 32-Bit-Ganzzahlwert zurück, der ein HRESULT-Code ist, der mit der vom aktuellen Objekt repräsentierten Ausnahme verknüpft ist. |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | Gibt eine Referenz auf das Objekt zurück, das die innere Ausnahme repräsentiert. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopierkonstruktor. Kopiert tatsächlich nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | Vergleicht per Referenz einen Werttyp mit nullptr. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Setzt HRESULT, einen codierten numerischen Wert, der einer bestimmten Ausnahme zugeordnet wird. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen schwachen Zeiger (statt eines geteilten). Ermöglicht das Umschalten von Zeigern in Containern auf den schwachen Modus. |
