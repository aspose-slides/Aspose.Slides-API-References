...
description: "Die Ausnahme, die ausgelöst wird, wenn das Dateibild einer dynamischen Linkbibliothek (DLL) oder eines ausführbaren Programms ungültig ist. Erzeugen Sie niemals Instanzen dieser Klasse manuell. Verwenden Sie stattdessen die BadImageFormatException-Klasse. Wickeln Sie die BadImageFormatException-Klasseninstanzen niemals in System::SmartPtr ein."
type: docs
weight: 378
url: /de/system/details_badimageformatexception/
---
## Details_BadImageFormatException Klasse


Die Ausnahme, die ausgelöst wird, wenn das Dateibild einer dynamischen Linkbibliothek (DLL) oder eines ausführbaren Programms ungültig ist. Erstellen Sie niemals Instanzen dieser Klasse manuell. Verwenden Sie stattdessen die BadImageFormatException-Klasse. Wickeln Sie die BadImageFormatException-Klasseninstanzen niemals in [System::SmartPtr](../smartptr/) ein.
...
| virtual [String](../string/) [get_FileName](../details_exceptionwithfilename/get_filename/)() const | Ermittelt den Namen der Datei, die diese Ausnahme verursacht. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](../details_systemexception/gettype/)() const override | Ermittelt den tatsächlichen Typ des Objekts. Analog zum C# [System.Object.GetType()](../object/gettype/)-Aufruf. |
...
|  [Object](../object/object/)() | Erstellt Objekt. Initialisiert alle internen Datenstrukturen. |
|  [Object](../object/object/)([Object](../object/) const\&) | Kopierkonstruktor. Kopiert tatsächlich nichts, initialisiert nur ein neues Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Zuweisungsoperator. Kopiert tatsächlich nichts, initialisiert nur ein neues Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
...
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Erhöht die gemeinsame Referenzzählung. Sollte nicht direkt aufgerufen werden; stattdessen sollte man Smart-Pointer oder ThisProtector verwenden. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Verringert und gibt die gemeinsame Referenzzählung zurück. Sollte nicht direkt aufgerufen werden; stattdessen sollte man Smart-Pointer oder ThisProtector verwenden. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Erhöht die schwache Referenzzählung. Sollte nicht direkt aufgerufen werden; stattdessen sollte man Smart-Pointer oder ThisProtector verwenden. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Verringert die schwache Referenzzählung. Sollte nicht direkt aufgerufen werden; stattdessen sollte man Smart-Pointer oder ThisProtector verwenden. |
| virtual const char * [what](../details_exception/what/)() const | Implementiert die [what()](../details_exception/what/)-Methode, die von der [ExceptionWrapper](../exceptionwrapper/)-Klasse aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/ private Mitglieder nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenumsetzung in [ExceptionWrapper](../exceptionwrapper/) könnte diese Logik brechen. |
