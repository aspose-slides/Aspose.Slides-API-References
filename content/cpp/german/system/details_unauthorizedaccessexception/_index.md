...
description: "UnauthorizedAccessException wird ausgelöst, wenn der Zugriff vom Betriebssystem aufgrund eines Ein-/Ausgabe-Fehlers oder eines Sicherheitsfehlers verweigert wird. Erstellen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die UnauthorizedAccessException Klasse. Wickeln Sie die UnauthorizedAccessException Klasseninstanzen niemals in System::SmartPtr."
type: docs
weight: 755
url: /de/system/details_unauthorizedaccessexception/
---
## Details_UnauthorizedAccessException Klasse

UnauthorizedAccessException wird ausgelöst, wenn der Zugriff vom Betriebssystem aufgrund eines Ein-/Ausgabe-Fehlers oder eines Sicherheitsfehlers verweigert wird. Erstellen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die UnauthorizedAccessException Klasse. Wickeln Sie die UnauthorizedAccessException Klasseninstanzen niemals in [System::SmartPtr](../smartptr/).
...
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur zu internen Zwecken. |
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Rückgabe eines Wörterbuchs mit benutzerdefinierten Ausnahmedaten. |
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Entspricht der C# [Object.GetHashCode()](../object/gethashcode/)-Methode. Ermöglicht das Hashen benutzerdefinierter Objekte. |
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Erhält den tatsächlichen Typ des Objekts. Entspricht einem Aufruf von C# [System.Object.GetType()](../object/gettype/). |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Entspricht der C# [Object.MemberwiseClone()](../object/memberwiseclone/)-Methode. Ermöglicht das Klonen benutzerdefinierter Typen. |
|  [Object](../object/object/)() | Erzeugt ein Objekt. Initialisiert alle internen Datenstrukturen. |
|  [Object](../object/object/)([Object](../object/) const\&) | Kopierkonstruktor. Kopiert tatsächlich nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Setzt das HRESULT, einen codierten numerischen Wert, der einer bestimmten Ausnahme zugewiesen wird. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument zu einem schwachen Zeiger (statt geteilt). Ermöglicht das Umschalten von Zeigern in Containern in den schwachen Modus. |
...
| virtual const char * [what](../details_exception/what/)() const | Implementiert die [what()](../details_exception/what/)-Methode, die von der [ExceptionWrapper](../exceptionwrapper/)-Klasse aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/private Member nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenumsetzung in [ExceptionWrapper](../exceptionwrapper/) könnte diese Logik brechen. |
