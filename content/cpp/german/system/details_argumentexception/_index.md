...
description: "ArgumentException wird ausgelöst, wenn ein an eine aufgerufene Methode übergebenes Argument ungültig ist. Erzeugen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die ArgumentException-Klasse. Verpacken Sie niemals die ArgumentException-Klasseninstanzen in System::SmartPtr."
type: docs
weight: 326
url: /de/system/details_argumentexception/
---
## Details_ArgumentException Klasse


ArgumentException wird ausgelöst, wenn ein an eine aufgerufene Methode übergebenes Argument ungültig ist. Erzeugen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die ArgumentException Klasse. Verpacken Sie niemals die ArgumentException Klasse Instanzen in [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuliert einen C#-artigen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuliert einen C#-artigen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopie-Konstruktor. Kopiert nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Gibt die Zeichenketten-Darstellung des aktuellen Objekts zurück. |
...
| virtual const char * [what](../details_exception/what/)() const | Implementiert die [what()](../details_exception/what/)-Methode, die von der [ExceptionWrapper](../exceptionwrapper/)-Klasse aufgerufen wird. Obwohl diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/ private Mitglieder nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenumsetzung in [ExceptionWrapper](../exceptionwrapper/) könnte diese Logik zerstören. |
| virtual  [~Object](../object/~object/)() | Zerstört das Objekt. Gibt alle internen Datenstrukturen frei. |

## Anmerkungen


ArgumentNullException wird ausgelöst, wenn einer aufgerufenen Methode ein Null-Argument übergeben wird, obwohl die Methode einen nicht-null Wert erwartet. Erzeugen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die ArgumentNullException Klasse. Verpacken Sie niemals die ArgumentNullException Klasse Instanzen in [System::SmartPtr](../smartptr/). 
