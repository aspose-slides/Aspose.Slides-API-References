...
description: "OverflowException wird ausgelöst, wenn eine Operation zu einem Überlauf führt. Erstellen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die Klasse OverflowException. Verpacken Sie die Instanzen der Klasse OverflowException niemals in System::SmartPtr."
type: docs
weight: 651
url: /de/system/details_overflowexception/
---
## Details_OverflowException Klasse


OverflowException wird ausgelöst, wenn eine Operation zu einem Überlauf führt. Erstellen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die Klasse OverflowException. Verpacken Sie die Instanzen der Klasse OverflowException niemals in [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-artigen Gleitkomma-Vergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl NaN laut IEC 60559:1989 zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Gleitkomma-Vergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl NaN laut IEC 60559:1989 zu keinem Wert, einschließlich NaN, gleich ist. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Copy-Konstruktor. Kopiert nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Gibt die String-Darstellung des aktuellen Objekts zurück. |
...
| virtual const char * [what](../details_exception/what/)() const | Implementiert die Methode [what()](../details_exception/what/), die von der Klasse [ExceptionWrapper](../exceptionwrapper/) aufgerufen wird. Ungeachtet der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/ private Mitglieder nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenumsetzung in das [ExceptionWrapper](../exceptionwrapper/) könnte diese Logik brechen. |
