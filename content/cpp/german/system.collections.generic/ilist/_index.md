...
description: "Schnittstelle eines indizierten Containers von Elementen. Objekte dieser Klasse sollten ausschließlich über die Funktion System::MakeObject() allokiert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 339
url: /de/system.collections.generic/ilist/
---
## IList class

Schnittstelle eines indizierten Containers von Elementen. Objekte dieser Klasse sollten ausschließlich mit der Funktion [System::MakeObject()](../../system/makeobject/) allokiert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| virtual **bool** [Contains](../icollection/contains/)(const T\&) const | Überprüft, ob das Element in der Sammlung vorhanden ist. |
| virtual void [CopyTo](../icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopiert alle Elemente der Sammlung in bestehende Array-Elemente. |
...
| **bool** [get_IsFixedSize](./get_isfixedsize/)() | Prüft, ob die Sammlung eine feste Größe hat. |
...
| virtual T [idx_get](./idx_get/)(int) const | Gibt das Element am angegebenen Index zurück. |
| virtual void [idx_set](./idx_set/)(int, T) | Setzt das Element am angegebenen Index. |
| virtual int [IndexOf](./indexof/)(const T\&) const | Gibt den Index des ersten Auftretens des Elements im Container zurück. |
| virtual void [Insert](./insert/)(int, const T\&) | Fügt das Element an der angegebenen Position ein und verschiebt die anderen Elemente. |
...
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Berechnet den Durchschnitt einer Sequenz von Werten, die durch Aufrufen einer Transformationsfunktion auf jedem Element der Eingabesequenz erhalten werden. |
...
| ResultType [LINQ_Max](../ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft eine Transformationsfunktion für jedes Element einer generischen Sequenz auf und gibt den maximalen Ergebniswert zurück. |
| ResultType [LINQ_Max](../ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft eine Transformationsfunktion für jedes Element einer generischen Sequenz auf und gibt den minimalen Ergebniswert zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | Überspringt eine angegebene Anzahl zusammenhängender Elemente am Beginn einer Sequenz und gibt den Rest zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[List](../list/)\<T\>\> [LINQ_ToList](../ienumerable/linq_tolist/)() | Erstellt ein List<T> aus einer Sequenz. |
...
| virtual void [RemoveAt](./removeat/)(int) | Entfernt das Element am angegebenen Index. |
