...
description: "Implementiert eine Liste von Schlüsseln eines Wörterbuchs. Objekte dieser Klasse sollten nur mithilfe der Funktion System::MakeObject() zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs im Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Umwickeln Sie diese Klasse stets in einen System::SmartPtr Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 14
url: /de/system.collections.generic/_keylist/
---
## _KeyList Klasse

Implementiert eine Liste von Schlüsseln eines Wörterbuchs. Objekte dieser Klasse sollten nur mithilfe der Funktion [System::MakeObject()](../../system/makeobject/) zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs im Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Umwickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/) Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| Method | Description |
| --- | --- |
| [_KeyCollection](../_keycollection/_keycollection/)(const typename Dict::Ptr\&) | Initialisiert die Sammlung, die das angegebene Wörterbuch referenziert. |
| [_KeyList](./_keylist/)(const typename Dict::Ptr\&) | Initialisiert die Sammlung, die das angegebene Wörterbuch referenziert. |
| void [Add](../ikvcollection/add/)(const T\&) override | Fügt ein Element zum Container hinzu. |
| [BaseKVCollection](../basekvcollection/basekvcollection/)(const typename Dict::Ptr\&) | Erstellt eine Sammlung. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Gibt einen Iterator zurück, der auf das erste Element (falls vorhanden) der Sammlung zeigt. Dieser Iterator kann nicht verwendet werden, um ein referenziertes Objekt zu ändern, da [GetEnumerator()](../ienumerable/getenumerator/) ein Kopie-Objekt von T zurückgibt. |
...
| **bool** [Contains](./contains/)(const [TKey](../_keycollection/tkey/)\&) const override | Überprüft, ob der angegebene Schlüssel in der Sammlung vorhanden ist. |
| void [CopyTo](../basekvcollection/copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | Kopiert Daten in vorhandene Array-Elemente. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Gibt einen Iterator zurück, der unmittelbar nach dem letzten Element (falls vorhanden) der Sammlung liegt. Dieser Iterator kann nicht verwendet werden, um ein referenziertes Objekt zu ändern, da [GetEnumerator()](../ienumerable/getenumerator/) ein Kopie-Objekt von T zurückgibt. |
...
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Überprüft, ob die Sammlung eine feste Größe hat. |
| **bool** [get_IsReadOnly](../ikvcollection/get_isreadonly/)() const override | Überprüft, ob der Container nur lesbar ist. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TKey](../_keycollection/tkey/)\>\> [GetEnumerator](../_keycollection/getenumerator/)() override | Gibt einen Enumerator zurück, der über die Schlüssel iteriert. |
...
| [TKey](../_keycollection/tkey/) [idx_get](./idx_get/)(int) const override | Gibt den Schlüssel an der angegebenen Position zurück. |
| void [idx_set](../ikvcollection/idx_set/)(int, T) override | Setzerfunktion. |
| int [IndexOf](../ikvcollection/indexof/)(const T\&) const override | Gibt den Index eines Elements im Container zurück. |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)() | Bestimmt, ob eine Sequenz irgendein Element enthält. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Vergleich ein Werttyp-Objekt per Referenz mit nullptr. |
...
| void [SetTemplateWeakPtr](../basekvcollection/settemplateweakptr/)(**uint32_t**) override | Ermöglicht die Kompilierung, bewirkt jedoch nichts, da diese Struktur keine Daten besitzt. |
...
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeBeginConstIterator](../_keycollection/virtualizebeginconstiterator/)() const override | Gibt die Implementierung des begin-const-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeBeginIterator](../_keycollection/virtualizebeginiterator/)() override | Gibt die Implementierung des begin-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeEndConstIterator](../_keycollection/virtualizeendconstiterator/)() const override | Gibt die Implementierung des end-const-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeEndIterator](../_keycollection/virtualizeenditerator/)() override | Gibt die Implementierung des end-Iterators für den aktuellen Container zurück. |
...
* Klasse [_KeyCollection](../_keycollection/)
