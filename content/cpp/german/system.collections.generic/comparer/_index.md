...
description: Stellt eine Basisklasse für Implementierungen des generischen Interfaces System.Collections.Generic.IComparer bereit.
type: docs
weight: 105
url: /de/system.collections.generic/comparer/
---
## Comparer-Klasse

Stellt eine Basisklasse für Implementierungen des [System.Collections.Generic.IComparer](../icomparer/) generischen Interfaces bereit.
...
| --- | --- |
| T | Der Typ der zu vergleichenden Objekte. |
## Methoden
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | Gibt einen Standard-Sortierreihenfolgen-Comparer für den durch das generische Argument angegebenen Typ zurück. |
