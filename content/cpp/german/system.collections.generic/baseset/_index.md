...
type: docs
weight: 92
url: /de/system.collections.generic/baseset/
---
## BaseSet Klasse
...
| void [Add](./add/)(const T\&) override | Fügt ein Element zum Set hinzu. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Liefert einen Iterator zum ersten Element der const-qualifizierten Sammlung. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Liefert einen Iterator, der auf das erste Element (falls vorhanden) der Sammlung zeigt. Dieser Iterator kann nicht zum Ändern eines referenzierten Objekts verwendet werden, weil [GetEnumerator()](../ienumerable/getenumerator/) ein Kopie-Objekt von T zurückgibt. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Liefert einen Iterator zum ersten const-qualifizierten Element der Sammlung. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Liefert einen Iterator für ein nicht existierendes const-qualifiziertes Element hinter dem Ende der Sammlung. |
| void [Clear](./clear/)() override | Löscht alle Elemente im Set. |
| **bool** [Contains](./contains/)(const T\&) const override | Überprüft, ob ein Element im Set vorhanden ist. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Kopiert den Hash-Inhalt in vorhandene Array-Elemente. |
| [set_t](./set_t/)\& [data](./data/)() | Zugriff auf die zugrunde liegende Datenstruktur. |
| const [set_t](./set_t/)\& [data](./data/)() const | Zugriff auf die zugrunde liegende Datenstruktur. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Liefert einen Iterator für ein nicht existierendes Element hinter dem Ende der const-qualifizierten Sammlung. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Liefert einen Iterator, der direkt nach dem letzten Element (falls vorhanden) der Sammlung zeigt. Dieser Iterator kann nicht zum Ändern eines referenzierten Objekts verwendet werden, weil [GetEnumerator()](../ienumerable/getenumerator/) ein Kopie-Objekt von T zurückgibt. |
...
| int [get_Count](./get_count/)() const override | Liefert die Anzahl der Elemente im Set. |
| virtual int [get_Count](./get_count/)() const | Verhindert, dass [get_Count()](./get_count/) verborgen wird. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Überprüft, ob die Sammlung schreibgeschützt ist. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../icollection/get_syncroot/)() const | Liefert das Objekt, über das die Sammlung synchronisiert wird. |
...
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Erstellt einen Enumerator. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog zur C#-Methode [Object.GetHashCode()](../../system/object/gethashcode/). Aktiviert das Hashing benutzerdefinierter Objekte. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\>\>\&) | Projektiert jedes Element einer Sequenz und kombiniert die resultierenden Sequenzen zu einer Sequenz. |
...
| **bool** [Remove](./remove/)(const T\&) override | Entfernt ein Element aus dem Set. |
...
| **bool** [TryAdd](./tryadd/)(const T\&) | Fügt ein Element zum Set hinzu. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementiert das C#-typeof([System.Object](../../system/object/))-Konstrukt. |
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren der C#-lock()-Anweisung. Direkt aufrufen oder das [LockContext](../../system/lockcontext/)-Wächterobjekt verwenden. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Liefert die Implementierung des begin-const-Iterators für den aktuellen Container. |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Liefert die Implementierung des end-const-Iterators für den aktuellen Container. |
...
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator**-Zeiger. |
