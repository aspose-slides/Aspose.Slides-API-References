...
description: Vorwärtsdeklaration der Stack-Klasse.
type: docs
weight: 599
url: /de/system.collections.generic/stack/
---
## Stack-Klasse


[Stack](./) Klasse Vorwärtsdeklaration.
...
| --- | --- |
| void [AddRange](./addrange/)([IEnumerablePtr](./ienumerableptr/)) | Fügt Elemente in den Stack ein. |
...
| virtual void [Clear](./clear/)() | Löscht alle Elemente aus dem Stack. |
| virtual **bool** [Contains](./contains/)(const T\&) const | Prüft, ob ein bestimmtes Element im Container vorhanden ist; verwendet den Operator == für den Vergleich. |
| [stack_t](./stack_t/)\& [data](./data/)() | Zugriff auf interne Datenstruktur. |
| const [stack_t](./stack_t/)\& [data](./data/)() const | Zugriff auf interne Datenstruktur. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Gibt einen Iterator zurück, der direkt nach dem letzten Element (falls vorhanden) der Sammlung zeigt. Dieser Iterator kann nicht verwendet werden, um ein referenziertes Objekt zu ändern, da [GetEnumerator()](../ienumerable/getenumerator/) ein Kopie-Objekt von T zurückgibt. |
...
| virtual int [get_Count](./get_count/)() const | Gibt die Anzahl der Elemente im Stack zurück. |
...
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, um durch den aktuellen Stack zu iterieren. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Cast](../ienumerable/linq_cast/)() | Castet die Elemente in den angegebenen Typ. |
...
| T [Peek](./peek/)() | Liest das Element vom Stapeloberteil, lässt es aber im Stapel. |
| T [Pop](./pop/)() | Liest das Element vom obersten Stück des Stapels. |
| void [Push](./push/)(const T\&) | Legt ein Element oben auf den Stapel. |
...
|  [Stack](./stack/)([IEnumerablePtr](./ienumerableptr/)) | Copy-Konstruktor. |
| virtual [ArrayPtr](../../system/arrayptr/)\<T\> [ToArray](./toarray/)() | Konvertiert den Stapel in ein Array. |
...
| [stack_t](./stack_t/) | Zugrundeliegender Datentyp. |
| [IEnumerablePtr](./ienumerableptr/) | Sammlung, die Elemente desselben Typs enthält. |
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator**-Typ. |
## Anmerkungen

[Stack](./) Klasse, die std::list kapselt. Objekte dieser Klasse sollten nur mit der [System::MakeObject()](../../system/makeobject/)-Funktion alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Umwickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Pointer und verwenden Sie diesen Pointer, um ihn als Argument an Funktionen zu übergeben.
...
int main()
{
  // Erstelle die Stack-Klasseninstanz.
