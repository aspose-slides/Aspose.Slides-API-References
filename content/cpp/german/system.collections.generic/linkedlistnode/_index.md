...
description: "Knoten einer verketteten Liste. Implementiert eine Hülle über einem Iterator von std::list, der in einer verketteten Liste eingebettet ist. Objekte dieser Klasse sollten nur mit der System::MakeObject()-Funktion zugewiesen werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 417
url: /de/system.collections.generic/linkedlistnode/
---
## LinkedListNode Klasse

Knoten einer verketteten Liste. Implementiert eine Hülle über einem Iterator von std::list, der in einer verketteten Liste eingebettet ist. Objekte dieser Klasse sollten nur mit der [System::MakeObject()](../../system/makeobject/)-Funktion zugewiesen werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| [SharedPtr](../../system/sharedptr/)\<[LinkedList](../linkedlist/)\<T\>\> [get_List](./get_list/)() const | Ruft die enthaltende Liste ab. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Next](./get_next/)() const | Ruft den nächsten Knoten ab. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Previous](./get_previous/)() const | Ruft den vorherigen Knoten ab. |
| T [get_Value](./get_value/)() const | Ruft den gespeicherten Wert ab. |
...
| void [set_Value](./set_value/)(const T\&) | Setzt den gespeicherten Wert. |
