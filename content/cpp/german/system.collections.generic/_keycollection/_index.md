...
description: "Sammlung der Schlüssel des Dictionary. Referenziert die Sammlung, kopiert nichts. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse immer in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 1
url: /de/system.collections.generic/_keycollection/
---
## _KeyCollection Klasse

Sammlung der Schlüssel von [Dictionary](../dictionary/). Referenziert die Sammlung, kopiert nichts. Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Pointer ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
|  [_KeyCollection](./_keycollection/)(const typename Dict::Ptr\&) | Initialisiert die Sammlung, die das angegebene Wörterbuch referenziert. |
| void [Add](../ikvcollection/add/)(const T\&) override | Fügt ein Element zum Container hinzu. |
|  [BaseKVCollection](../basekvcollection/basekvcollection/)(const typename Dict::Ptr\&) | Erstellt die Sammlung. |
...
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Gibt einen Iterator zurück, der unmittelbar nach dem letzten const-qualifizierten Element (falls vorhanden) der Sammlung liegt. |
| void [Clear](../ikvcollection/clear/)() override | Löscht alle Elemente aus dem Container. |
| **bool** [Contains](./contains/)(const [TKey](./tkey/)\&) const override | Prüft, ob das Element im Container vorhanden ist. |
| void [CopyTo](../basekvcollection/copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | Kopiert Daten in vorhandene Array-Elemente. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Gibt einen Iterator zurück, der unmittelbar nach dem letzten Element (falls vorhanden) der Sammlung liegt. Dieser Iterator kann nicht verwendet werden, um ein referenziertes Objekt zu ändern, weil [GetEnumerator()](../ienumerable/getenumerator/) ein Kopie-Objekt von T zurückgibt. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Gibt einen Iterator zurück, der unmittelbar nach dem letzten Element (falls vorhanden) der const-qualifizierten Instanz der Sammlung liegt. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Gleitkommavergleich für double, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| int [get_Count](../basekvcollection/get_count/)() const override | Gibt die Anzahl der Elemente zurück. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Prüft, ob die Sammlung eine feste Größe hat. |
| **bool** [get_IsReadOnly](../ikvcollection/get_isreadonly/)() const override | Prüft, ob der Container schreibgeschützt ist. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TKey](./tkey/)\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der über die Schlüssel iteriert. |
...
|  [ICollection](../icollection/icollection/)(const [ICollection](../icollection/)\&) | Kopierekonstruktor. |
|  [ICollection](../icollection/icollection/)([ICollection](../icollection/)\&&) | Move-Konstruktor. |
| [TKey](./tkey/) [idx_get](./idx_get/)(int) const override | Implementiert die [IList](../ilist/)-Methode. Nicht unterstützt. |
| void [idx_set](../ikvcollection/idx_set/)(int, T) override | Setzer-Funktion. |
| int [IndexOf](../ikvcollection/indexof/)(const T\&) const override | Gibt den Index des Elements im Container zurück. |
| void [Insert](../ikvcollection/insert/)(int, const T\&) override | Fügt ein Element an der angegebenen Position ein. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Sortiert die Elemente einer Sequenz aufsteigend nach den durch keySelector ausgewählten Schlüsselwerten. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Sortiert die Elemente einer Sequenz absteigend nach den durch keySelector ausgewählten Schlüsselwerten. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Take](../ienumerable/linq_take/)(**int32_t**) | Gibt eine angegebene Anzahl zusammenhängender Elemente am Beginn einer Sequenz zurück. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierekonstruktor. Kopiert nichts, sondern initialisiert lediglich ein neues Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
...
| **bool** [Remove](../ikvcollection/remove/)(const T\&) override | Entfernt ein Element aus dem Container. |
| void [RemoveAt](../ikvcollection/removeat/)(int) override | Entfernt ein Element an der angegebenen Position. |
...
| void [SetTemplateWeakPtr](../basekvcollection/settemplateweakptr/)(**uint32_t**) override | Ermöglicht die Kompilierung, führt jedoch nichts aus, da diese Struktur keine Daten besitzt. |
...
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Gibt die Implementierung des const-Begin-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Gibt die Implementierung des Begin-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Gibt die Implementierung des const-End-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<[TKey](./tkey/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Gibt die Implementierung des End-Iterators für den aktuellen Container zurück. |
