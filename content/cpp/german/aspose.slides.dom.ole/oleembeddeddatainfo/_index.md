...
description: Stellt eingebettete Dateninformationen für OLE-Objekt dar.
type: docs
weight: 1
...
Stellt eingebettete Dateninformationen für OLE-Objekt dar.
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | Gibt die Dateidaten eines eingebetteten OLE-Objekts zurück. Nur lesbar **uint8_t**[]. |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | Gibt die Dateierweiterung für das aktuelle eingebettete OLE-Objekt zurück. Nur lesbar [System::String](../../system/string/). |
...
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)() | Erstellt neue eingebettete Dateninformationen für OLE-Objekt. |
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | Erstellt eine neue Instanz von eingebetteten Dateninformationen für OLE-Objekt. |
...
* Klasse [IOleEmbeddedDataInfo](../../aspose.slides/ioleembeddeddatainfo/)
* Namensraum [Aspose::Slides::DOM::Ole](../)
