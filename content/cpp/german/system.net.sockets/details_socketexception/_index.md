...
description: "Stellt die Ausnahme dar, die ausgelöst wird, wenn ein Socket-Fehler auftritt. Erstellen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die SocketException-Klasse. Wickeln Sie die SocketException-Klasseninstanzen niemals in System::SmartPtr ein."
type: docs
weight: 1
url: /de/system.net.sockets/details_socketexception/
---
## Details_SocketException Klasse

Stellt die Ausnahme dar, die ausgelöst wird, wenn ein Socket-Fehler auftritt. Erstellen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die SocketException Klasse. Wickeln Sie die SocketException-Klasseninstanzen niemals in [System::SmartPtr](../../system/smartptr/) ein.
...
| **int32_t** [get_ErrorCode](./get_errorcode/)() | Liefert den Fehlercode. |
...
| [SocketError](../socketerror/) [get_SocketErrorCode](./get_socketerrorcode/)() | Liefert den Socket-Fehlercode. |
...
| void [set_ErrorCode](./set_errorcode/)(**int32_t**) | Setzt den Fehlercode. |
...
| void [set_SocketErrorCode](./set_socketerrorcode/)([SocketError](../socketerror/)) | Setzt den Socket-Fehlercode. |
