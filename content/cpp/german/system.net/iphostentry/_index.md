...
description: "Stellt Informationen über eine Internet-Hostadresse dar. Objekte dieser Klasse sollten nur mit der System::MakeObject()-Funktion alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 352
url: /de/system.net/iphostentry/
---
## IPHostEntry Klasse


Stellt Informationen über eine Internet-Hostadresse dar. Objekte dieser Klasse sollten nur mit der [System::MakeObject()](../../system/makeobject/)-Funktion alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../ipaddress/)\>\> [get_AddressList](./get_addresslist/)() | Ruft die Sammlung der IP-Adressen des Hosts ab. |
| [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [get_Aliases](./get_aliases/)() | Ruft die Sammlung der Aliasnamen des Hosts ab. |
| [String](../../system/string/) [get_HostName](./get_hostname/)() const | Ruft den Hostnamen ab. |
...
| void [set_AddressList](./set_addresslist/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../ipaddress/)\>\>) | Setzt eine Sammlung von IP-Adressen des Hosts. |
| void [set_Aliases](./set_aliases/)([System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\>) | Setzt eine Sammlung von Aliasnamen des Hosts. |
| void [set_HostName](./set_hostname/)([String](../../system/string/)) | Setzt den Hostnamen. |
