...
description: "Stellt eine Liste sortierter Cookies dar. Objekte dieser Klasse sollten nur mittels der System::MakeObject()-Funktion alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger und verwenden Sie diesen Zeiger, um sie als Argument an Funktionen zu übergeben."
type: docs
weight: 14
url: /de/system.net/cookiecollection/
---
## CookieCollection Klasse

Stellt eine Liste sortierter Cookies dar. Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/) Zeiger und verwenden Sie diesen Zeiger, um sie als Argument an Funktionen zu übergeben.
...
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) override | Fügt ein Cookie zur Sammlung hinzu. |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](./)\>) | Fügt Cookies aus der angegebenen Sammlung zur aktuellen hinzu. |
...
| void [Clear](./clear/)() override | Entfernt alle Cookies aus der Sammlung. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) const override | Prüft, ob die Sammlung das angegebene Cookie enthält. |
...
| **int32_t** [get_Count](./get_count/)() const override | Gibt die Anzahl der Elemente in der Sammlung zurück. |
| **bool** [get_IsOtherVersionSeen](./get_isotherversionseen/)() | Gibt einen Wert zurück, der angibt, ob die Sammlung ein Cookie mit einer Version enthält, die nicht gleich [Cookie::MaxSupportedVersion](../cookie/maxsupportedversion/) ist. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Gibt den tatsächlichen Typ des Objekts zurück. Analog dem C# [System.Object.GetType()](../../system/object/gettype/)-Aufruf. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [idx_get](./idx_get/)(**int32_t**) | Gibt ein Cookie aus der Cookie-Sammlung am angegebenen Index zurück. |
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [idx_get](./idx_get/)([String](../../system/string/)) | Gibt ein Cookie aus der Cookie-Sammlung mit dem angegebenen Namen zurück. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>) | Gibt den Index des angegebenen Cookies zurück. |
| **int32_t** [InternalAdd](./internaladd/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>, **bool**) | Fügt das angegebene Cookie zur Sammlung hinzu. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft eine Transformationsfunktion auf jedes Element einer generischen Sequenz auf und gibt den maximalen resultierenden Wert zurück. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft eine Transformationsfunktion auf jedes Element einer generischen Sequenz auf und gibt den minimalen resultierenden Wert zurück. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) override | Entfernt das angegebene Cookie aus der Sammlung. |
| void [RemoveAt](./removeat/)(**int32_t**) | Entfernt ein Cookie am angegebenen Index. |
...
| [DateTime](../../system/datetime/) [TimeStamp](./timestamp/)([CookieCollection::Stamp](./stamp/)) | Aktualisiert den Zeitstempel um das angegebene Szenario und gibt einen neuen Wert zurück. |
...
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Gibt die Implementierung des begin-const-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Gibt die Implementierung des begin-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Gibt die Implementierung des end-const-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Gibt die Implementierung des end-Iterators für den aktuellen Container zurück. |
...
| --- | --- |
| [Stamp](./stamp/) | Enumeriert die Zeitstempel-Setz-Operationen. |
