...
description: Enthält die Hilfsmethoden, um die String-Darstellung des HTTP-Status zu erhalten.
type: docs
weight: 248
url: /de/system.net/httpstatusdescription/
---
## HttpStatusDescription Klasse

Enthält die Hilfsmethoden, um die String-Darstellung des HTTP-Status zu erhalten.
...
| static [String](../../system/string/) [Get](./get/)([HttpStatusCode](../httpstatuscode/)) | Gibt eine Zeichenkettenbeschreibung des angegebenen HTTP-Statuscodes zurück. |
| static [String](../../system/string/) [Get](./get/)(**int32_t**) | Gibt eine Zeichenkettenbeschreibung des angegebenen HTTP-Statuscodes zurück. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen schwachen Zeiger (statt einem geteilten). Ermöglicht das Umschalten von Zeigern in Containern auf den Weak-Modus. |
