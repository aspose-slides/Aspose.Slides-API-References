...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-Stil des Vergleichs von Gleitkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-Stil des Vergleichs von Gleitkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
...
| Feld | Beschreibung |
| --- | --- |
| static [Http](./http/) | Die HTTP-String-Repräsentation. |
| static [Https](./https/) | Die HTTPS-String-Repräsentation. |
| static [SchemeDelimiter](./schemedelimiter/) | Der String, der das Schematrennzeichen darstellt. |
| static [Ws](./ws/) | Die WS-String-Repräsentation. |
| static [Wss](./wss/) | Die WSS-String-Repräsentation. |
