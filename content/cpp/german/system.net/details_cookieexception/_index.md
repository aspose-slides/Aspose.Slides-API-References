...
description: "Stellt eine Ausnahme dar, die ausgelöst wird, wenn die Größe von CookieContainer größer ist als der Wert der MaxCookieSize-Eigenschaft. Erzeugen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die CookieException-Klasse. Wickeln Sie die CookieException-Klasseninstanzen niemals in System::SmartPtr ein."
type: docs
weight: 79
url: /de/system.net/details_cookieexception/
---
## Details_CookieException Klasse


Stellt eine Ausnahme dar, die ausgelöst wird, wenn die Größe von [CookieContainer](../cookiecontainer/) größer ist als der Wert der MaxCookieSize-Eigenschaft. Erzeugen Sie niemals manuell Instanzen dieser Klasse. Verwenden Sie stattdessen die CookieException-Klasse. Wickeln Sie die CookieException-Klasseninstanzen niemals in [System::SmartPtr](../../system/smartptr/) ein.
...
| Method | Description |
| --- | --- |
|  [Details_CookieException](./details_cookieexception/)() | Konstruiert eine neue Instanz. |
|  [Details_CookieException](./details_cookieexception/)(std::nullptr_t) | Konstruiert eine neue Instanz. |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/)) | Konstruiert eine neue Instanz. |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Konstruiert eine neue Instanz. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_formatexception/gettype/)() const override | Ermittelt den tatsächlichen Typ des Objekts. Entspricht dem C# [System.Object.GetType()](../../system/object/gettype/)-Aufruf. |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | Gibt die Zeichenkettendarstellung des aktuellen Objekts zurück. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die [what()](../../system/details_exception/what/)-Methode, die von der [ExceptionWrapper](../../system/exceptionwrapper/)-Klasse aufgerufen wird. Ungeachtet der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/ private Mitglieder nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenimplementation in das [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik brechen. |
| virtual  [~Details_CookieException](./~details_cookieexception/)() | Zerstört die aktuelle Instanz. |
| virtual  [~Object](../../system/object/~object/)() | Zerstört das Objekt. Gibt alle internen Datenstrukturen frei. |

## Siehe auch

* Klasse [Details_FormatException](../../system/details_formatexception/)
