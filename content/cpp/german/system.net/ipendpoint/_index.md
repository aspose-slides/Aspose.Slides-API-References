...
description: "Stellt einen Netzwerkendpunkt dar, der eine IP-Adresse und einen Port enthält. Objekte dieser Klasse sollten nur mittels der Funktion System::MakeObject() alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Umschließen Sie diese Klasse stets in einen System::SmartPtr-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 339
url: /de/system.net/ipendpoint/
---
## IPEndPoint Klasse

Stellt einen Netzwerkendpunkt dar, der eine IP-Adresse und einen Port enthält. Objekte dieser Klasse sollten nur mittels [System::MakeObject()](../../system/makeobject/) Funktion alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Umschließen Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/) Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[EndPoint](../endpoint/)\> [Create](./create/)([System::SharedPtr](../../system/sharedptr/)\<[SocketAddress](../socketaddress/)\>) override | Erstellt eine neue Instanz der [EndPoint](../endpoint/) Klasse mit der angegebenen Socket-Adresse. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Vergleicht Objekte mithilfe der C# [Object.Equals](../../system/object/equals/) Semantik. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../ipaddress/)\> [get_Address](./get_address/)() | Ermittelt die Endpunktadresse. |
...
| **int32_t** [get_Port](./get_port/)() | Ermittelt die Portnummer. |
...
| [ImplPtr](../endpoint/implptr/) [GetImpl](./getimpl/)() const override | Gibt einen Zeiger auf die Implementierung zurück. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Ermittelt den tatsächlichen Typ des Objekts. Analog zum C# [System.Object.GetType()](../../system/object/gettype/) Aufruf. |
| [IPEndPoint](./ipendpoint/)(**int64_t**, **int32_t**) | Konstruiert eine neue Instanz. |
| [IPEndPoint](./ipendpoint/)([System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../ipaddress/)\>, **int32_t**) | Konstruiert eine neue Instanz. |
...
| void [set_Address](./set_address/)([System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../ipaddress/)\>) | Setzt die Endpunktadresse. |
| void [set_Port](./set_port/)(**int32_t**) | Setzt die Portnummer. |
...
| static [MinPort](./minport/) | Die minimale Portnummer. |
