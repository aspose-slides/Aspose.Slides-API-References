...
description: 2D-Vektor mit double-Komponenten
type: docs
weight: 66
url: /de/aspose.slides.drawing/vector2d64d/
---
## Vector2d64d Klasse

2D-Vektor mit **double**-Komponenten
...
| --- | --- |
| **double** [Dot](./dot/)([Vector2d64d](./)) | Berechnet das Skalarprodukt zweier Vektoren. |
...
| **double** [get_Length](./get_length/)() | Ermittelt die skalare Länge des Vektors. Nur lesbar **double**. |
| [Vector2d64d](./) [get_Norm](./get_norm/)() | Ermittelt den Normalenvektor. Nur lesbar [Vector2d64d](./). |
...
| [Vector2d64d](./) [Normalize](./normalize/)() | Erstellt einen kollinearen Vektor mit Länge = 1. Dieser Vektor darf keine Länge von Null haben. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen schwachen Zeiger (statt gemeinsam genutzt). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
...
| void [SwapXY](./swapxy/)() | Vertauscht X und Y |
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Analog zur C# [Object.ToString()](../../system/object/tostring/)-Methode. Ermöglicht die Umwandlung benutzerdefinierter Objekte in einen String. |
| [Vector2d32f](../vector2d32f/) [ToVector2d32f](./tovector2d32f/)() | Zu [Vector2d32f](../vector2d32f/) |
