...
description: "Argumente des PropertyChanged-Ereignisses. Objekte dieser Klasse sollten nur über die Funktion System::MakeObject() zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mithilfe des Operators new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 170
url: /de/system.componentmodel/propertychangedeventargs/
---
## PropertyChangedEventArgs Klasse


Argumente des PropertyChanged-Ereignisses. Objekte dieser Klasse sollten nur über die Funktion [System::MakeObject()](../../system/makeobject/) zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mithilfe des Operators new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/) Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| virtual [String](../../system/string/) [get_PropertyName](./get_propertyname/)() | Liefert den Namen der Eigenschaft, die dem Ereignis zugeordnet ist. |
...
|  [PropertyChangedEventArgs](./propertychangedeventargs/)(const [String](../../system/string/)\&) | Initialisiert die PropertyChanged-Ereignisargumente. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Verringert den Weak-Referenzzähler. Sollte nicht direkt aufgerufen werden; stattddessen sollten Smart Pointers oder ThisProtector verwendet werden. |
