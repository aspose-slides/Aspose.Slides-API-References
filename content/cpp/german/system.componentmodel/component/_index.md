...
description: "Dummyklasse, um übersetzten Code, der die Component-Klasse verwendet, kompiliert zu machen. Objekte dieser Klasse sollten nur mit der System::MakeObject() Funktion alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führen kann. Wickeln Sie diese Klasse immer in einen System::SmartPtr Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 40
url: /de/system.componentmodel/component/
---
## Komponentenklasse
...
| **bool** [get_DesignMode](./get_designmode/)() | Überprüft, ob die Komponente im Entwurfsmodus ist. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gibt die zum Objekt zugehörige Referenzzähler-Datenstruktur zurück. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierkonstruktor. Kopiert tatsächlich nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopier-Konstrukt von Unterklassen. |
