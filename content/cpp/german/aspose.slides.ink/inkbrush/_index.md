...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Liefert die Pinsel-Farbe für eine Linie. |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | Liefert den Tinteneffekt-Typ (z. B. Galaxy, Gold, Silver), der den visuellen Stil des Tintestrichs definiert. Der Wert wird aus der Pinsel-Eigenschaft "inkEffects" geparst. Wenn kein erkannter Effekt angegeben ist, wird [InkEffectType::NotDefined](../inkeffecttype/) zurückgegeben. |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Liefert die Pinselgröße für eine Linie in Punkten. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Setzt die Pinsel-Farbe für eine Linie. |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | Setzt die Pinselgröße für eine Linie in Punkten. |
