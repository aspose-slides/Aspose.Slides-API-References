...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Gibt die Pinsel-Farbe für eine Linie zurück. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | Gibt den Tinteneffekttyp zurück (z. B. Galaxy, Gold, Silver), der den visuellen Stil des Tintenstrichs definiert. Der Wert wird aus der Pinsel-Eigenschaft \"inkEffects\" geparst. Wenn kein erkannter Effekt angegeben ist, wird [InkEffectType::NotDefined](../inkeffecttype/) zurückgegeben. |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Gibt die Pinselgröße für eine Linie in Punkten zurück. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Setzt die Pinsel-Farbe für eine Linie. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Setzt die Pinselgröße für eine Linie in Punkten. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument zu einem schwachen Zeiger (statt geteilten). Erlaubt das Umschalten von Zeigern in Containern in den schwachen Modus. |
