...
description: Gibt detaillierte Informationen zurück, die mit dem ValidationEventHandler zusammenhängen.
type: docs
weight: 53
url: /de/system.xml.schema/validationeventargs/
---
## ValidationEventArgs Klasse

Gibt detaillierte Informationen zurück, die mit dem ValidationEventHandler zusammenhängen.
...
| [XmlSchemaException](../xmlschemaexception/) [get_Exception](./get_exception/)() | Gibt die mit dem Validierungsereignis verbundene XmlSchemaException zurück. |
| [String](../../system/string/) [get_Message](./get_message/)() | Gibt die Textbeschreibung zurück, die dem Validierungsereignis entspricht. |
| [XmlSeverityType](../xmlseveritytype/) [get_Severity](./get_severity/)() | Gibt die Schwere des Validierungsereignisses zurück. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiervorgangskonstruktor. Kopiert tatsächlich nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
...
Objekte dieser Klasse sollten nur über die Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstellen Sie niemals Instanzen dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Pointer und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben. 
