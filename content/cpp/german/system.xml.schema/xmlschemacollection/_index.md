...
description: Enthält einen Cache von XML Schema Definition Language (XSD) und XML-Data Reduced (XDR) Schemata.
type: docs
weight: 222
url: /de/system.xml.schema/xmlschemacollection/
---
## XmlSchemaCollection class

Enthält einen Cache von XML [Schema](../) Definition Language (XSD) und XML-Data Reduced (XDR) Schemata.
...
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Fügt das durch die angegebene URL gefundene Schema zur Schemasammlung hinzu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Fügt das im [XmlReader](../../system.xml/xmlreader/) enthaltene Schema zur Schemasammlung hinzu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Fügt das im [XmlReader](../../system.xml/xmlreader/) enthaltene Schema zur Schemasammlung hinzu. Das angegebene [XmlResolver](../../system.xml/xmlresolver/) wird verwendet, um externe Ressourcen aufzulösen. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Fügt das [XmlSchema](../xmlschema/) zur Sammlung hinzu. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Fügt das [XmlSchema](../xmlschema/) zur Sammlung hinzu. Das angegebene [XmlResolver](../../system.xml/xmlresolver/) wird verwendet, um externe Referenzen aufzulösen. |
| void [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaCollection](./)\>\&) | Fügt alle im angegebenen Kollektiv definierten Namensräume (einschließlich ihrer zugehörigen Schemata) zu dieser Sammlung hinzu. |
...
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Gibt einen Wert zurück, der angibt, ob das **targetNamespace** des angegebenen [XmlSchema](../xmlschema/) in der Sammlung enthalten ist. |
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) | Gibt einen Wert zurück, der angibt, ob ein Schema mit dem angegebenen Namensraum in der Sammlung enthalten ist. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\&, **int32_t**) | Kopiert alle [XmlSchema](../xmlschema/)-Objekte aus dieser Sammlung in das angegebene Array, beginnend bei dem angegebenen Index. |
...
| **int32_t** [get_Count](./get_count/)() | Gibt die Anzahl der in dieser Sammlung definierten Namensräume zurück. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](./get_nametable/)() | Gibt das Standard-[XmlNameTable](../../system.xml/xmlnametable/) zurück, das von der [XmlSchemaCollection](./) beim Laden neuer Schemata verwendet wird. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\> [GetEnumerator](./getenumerator/)() override | Stellt Unterstützung für die Iteration über die Schema-Sammlung bereit. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Gibt das [XmlSchema](../xmlschema/) zurück, das mit der angegebenen Namespace-URI verknüpft ist. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen schwachen Zeiger (statt geteilten). Ermöglicht das Umschalten von Zeigern in Containern in den schwachen Modus. |
...
|  [XmlSchemaCollection](./xmlschemacollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Initialisiert eine neue Instanz der [XmlSchemaCollection](./)-Klasse mit dem angegebenen [XmlNameTable](../../system.xml/xmlnametable/). Das [XmlNameTable](../../system.xml/xmlnametable/) wird beim Laden von Schemata verwendet. |
...
Veraltet
:   Die [XmlSchemaCollection](./) Klasse ist veraltet. Verwenden Sie [XmlSchemaSet](../xmlschemaset/) stattdessen.
