...
description: Stellt Optionen für die Schema-Kompilierung der Klasse XmlSchemaSet bereit. Diese Klasse kann nicht abgeleitet werden.
type: docs
weight: 248
url: /de/system.xml.schema/xmlschemacompilationsettings/
---
## XmlSchemaCompilationSettings Klasse
...
| **bool** [get_EnableUpaCheck](./get_enableupacheck/)() | Gibt einen Wert zurück, der angibt, ob [XmlSchemaSet](../xmlschemaset/) auf Verstöße gegen Unique Particle Attribution (UPA) prüfen soll. |
...
| void [set_EnableUpaCheck](./set_enableupacheck/)(**bool**) | Setzt einen Wert, der angibt, ob [XmlSchemaSet](../xmlschemaset/) auf Verstöße gegen Unique Particle Attribution (UPA) prüfen soll. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Dekrementiert und gibt den geteilten Referenzzähler zurück. Sollte nicht direkt aufgerufen werden; stattdessen Smart-Pointer oder ThisProtector verwenden. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Dekrementiert den Weak-Referenzzähler. Sollte nicht direkt aufgerufen werden; stattdessen Smart-Pointer oder ThisProtector verwenden. |
| [XmlSchemaCompilationSettings](./xmlschemacompilationsettings/)() | Initialisiert eine neue Instanz der [XmlSchemaCompilationSettings](./) Klasse. |
...
Objekte dieser Klasse sollten nur über die Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstellen Sie niemals Instanzen dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Pointer und verwenden Sie diesen Pointer, um ihn als Argument an Funktionen zu übergeben. 
