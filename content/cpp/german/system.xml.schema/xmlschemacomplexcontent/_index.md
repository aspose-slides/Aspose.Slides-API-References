...
description: Stellt das complexContent-Element aus dem XML-Schema dar, wie vom World Wide Web Consortium (W3C) spezifiziert. Diese Klasse repräsentiert das komplexe Inhaltsmodell für komplexe Typen. Sie enthält Erweiterungen oder Einschränkungen eines komplexen Typs, der entweder nur Elemente oder gemischten Inhalt hat.
type: docs
weight: 261
url: /de/system.xml.schema/xmlschemacomplexcontent/
---
## XmlSchemaComplexContent Klasse

Stellt das **complexContent**-Element aus XML [Schema](../) dar, wie vom World Wide [Web](../../system.web/) Consortium (W3C) spezifiziert. Diese Klasse repräsentiert das komplexe Inhaltsmodell für komplexe Typen. Sie enthält Erweiterungen oder Einschränkungen eines komplexen Typs, der entweder nur Elemente oder gemischten Inhalt hat.
...
Objekte dieser Klasse sollten nur mittels der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erzeugen Sie niemals Instanzen dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/) Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben. 
