...
description: Eine Sammlung von XmlSchemaObjects.
type: docs
weight: 690
url: /de/system.xml.schema/xmlschemaobjectcollection/
---
## XmlSchemaObjectCollection Klasse
...
| --- | --- |
| **int32_t** [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Fügt ein [XmlSchemaObject](../xmlschemaobject/) zum [XmlSchemaObjectCollection](./) hinzu. |
...
| void [Clear](../../system.collections/collectionbase/clear/)() | Entfernt alle Objekte aus der Sammlungsinstanz. Diese Methode kann nicht überschrieben werden. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Gibt an, ob das angegebene [XmlSchemaObject](../xmlschemaobject/) im [XmlSchemaObjectCollection](./) ist. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\&, **int32_t**) | Kopiert alle XmlSchemaObjects aus der Sammlung in das angegebene Array, beginnend am angegebenen Index. |
...
| **int32_t** [get_Capacity](../../system.collections/collectionbase/get_capacity/)() | Gibt die Anzahl der Elemente zurück, die die Sammlung enthalten kann. |
| **int32_t** [get_Count](../../system.collections/collectionbase/get_count/)() | Gibt die Anzahl der in der Sammlungsinstanz enthaltenen Elemente zurück. Diese Methode kann nicht überschrieben werden. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(**int32_t**) | Gibt das [XmlSchemaObject](../xmlschemaobject/) am angegebenen Index zurück. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>) | Setzt das [XmlSchemaObject](../xmlschemaobject/) am angegebenen Index. |
| **int32_t** [IndexOf](./indexof/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Gibt den Sammlungsindex zurück, der dem angegebenen [XmlSchemaObject](../xmlschemaobject/) entspricht. |
| void [Insert](./insert/)(**int32_t**, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Fügt ein [XmlSchemaObject](../xmlschemaobject/) zum [XmlSchemaObjectCollection](./) hinzu. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const&) | Kopierkonstruktor. Kopiert nichts, sondern initialisiert nur das neue Objekt und ermöglicht das Kopieren von Unterklassen. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const&) | Zuweisungsoperator. Kopiert nichts, sondern initialisiert nur das neue Objekt und ermöglicht das Kopieren von Unterklassen. |
...
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Entfernt ein [XmlSchemaObject](../xmlschemaobject/) aus dem [XmlSchemaObjectCollection](./). |
| void [RemoveAt](../../system.collections/collectionbase/removeat/)(**int32_t**) | Entfernt das Element am angegebenen Index der Sammlungsinstanz. Diese Methode ist nicht überschreibbar. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verringert den gemeinsamen Referenzzähler um den angegebenen Wert. |
| void [set_Capacity](../../system.collections/collectionbase/set_capacity/)(**int32_t**) | Setzt die Anzahl der Elemente, die die Sammlung enthalten kann. |
...
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Initialisiert eine neue Instanz der [XmlSchemaObjectCollection](./) Klasse, die ein [XmlSchemaObject](../xmlschemaobject/) entgegennimmt. |
...
Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) zugewiesen werden. Erstellen Sie niemals Instanzen dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/) Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben. 

## Siehe auch

* Klasse [CollectionBase](../../system.collections/collectionbase/)
