...
description: Stellt das pattern-Element aus dem XML-Schema dar, wie vom World Wide Web Consortium (W3C) spezifiziert. Diese Klasse kann verwendet werden, um eine Einschränkung für den für ein simpleType-Element eingegebenen Wert anzugeben.
type: docs
weight: 742
url: /de/system.xml.schema/xmlschemapatternfacet/
---
## XmlSchemaPatternFacet Klasse

Stellt das **pattern**-Element aus XML [Schema](../) dar, wie vom World Wide [Web](../../system.web/) Consortium (W3C) spezifiziert. Diese Klasse kann verwendet werden, um eine Einschränkung für den für ein **simpleType**-Element eingegebenen Wert anzugeben.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Gibt Informationen zurück, die anzeigen, dass dieses Facet festgelegt ist. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogie zu der C#-Methode [Object.GetHashCode()](../../system/object/gethashcode/). Ermöglicht das Hashen benutzerdefinierter Objekte. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Gibt den tatsächlichen Typ des Objekts zurück. Analogie zum C#-Aufruf [System.Object.GetType()](../../system/object/gettype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierkonstruktor. Kopiert nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopieren beim Erzeugen von Unterklassen. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Setzt Informationen, die anzeigen, dass dieses Facet festgelegt ist. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogie zur C#-Methode [Object.ToString()](../../system/object/tostring/). Ermöglicht die Umwandlung benutzerdefinierter Objekte in Zeichenketten. |
