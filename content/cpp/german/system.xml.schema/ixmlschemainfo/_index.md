...
description: Definiert das Post-Schema-Validierungs-Informationsset eines validierten XML-Knotens.
type: docs
weight: 40
url: /de/system.xml.schema/ixmlschemainfo/
---
## IXmlSchemaInfo Klasse

Definiert das Post-Schema-Validierungs-Informationsset eines validierten XML-Knotens.
...
| virtual **bool** [get_IsDefault](./get_isdefault/)() | Gibt einen Wert zurück, der angibt, ob dieser validierte XML-Knoten als Ergebnis einer während der XML [Schema](../) Definition Language (XSD) Schema-Validierung angewandten Vorgabe gesetzt wurde. |
| virtual **bool** [get_IsNil](./get_isnil/)() | Gibt einen Wert zurück, der angibt, ob der Wert dieses validierten XML-Knotens **nil** ist. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | Gibt den dynamischen Schematyp für diesen validierten XML-Knoten zurück. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | Gibt das kompilierte [XmlSchemaAttribute](../xmlschemaattribute/) zurück, das diesem validierten XML-Knoten entspricht. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | Gibt das kompilierte [XmlSchemaElement](../xmlschemaelement/) zurück, das diesem validierten XML-Knoten entspricht. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | Gibt den statischen XML [Schema](../) Definition Language (XSD) Schematyp dieses validierten XML-Knotens zurück. |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | Gibt den XmlSchemaValidity-Wert dieses validierten XML-Knotens zurück. |
