...
description: Stellt das import-Element aus XML Schema dar, wie vom World Wide Web Consortium (W3C) spezifiziert. Diese Klasse wird verwendet, um Schemakomponenten aus anderen Schemata zu importieren.
type: docs
weight: 482
url: /de/system.xml.schema/xmlschemaimport/
---
## XmlSchemaImport Klasse


Stellt das **import**-Element aus XML [Schema](../) dar, wie vom World Wide [Web](../../system.web/) Consortium (W3C) spezifiziert. Diese Klasse wird verwendet, um Schemakomponenten aus anderen Schemata zu importieren.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\> [get_Annotation](./get_annotation/)() | Gibt den **annotation**-Wert zurück. |
...
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Gibt den Ziel-Namespace für das importierte Schema als Uniform Resource Identifier (URI)-Referenz zurück. |
...
| [String](../../system/string/) [get_SchemaLocation](../xmlschemaexternal/get_schemalocation/)() | Gibt den Uniform Resource Identifier (URI)-Standort für das Schema zurück, der dem Schema-Prozessor mitteilt, wo das Schema physisch liegt. |
...
| void [set_Annotation](./set_annotation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\>\&) | Setzt den **annotation**-Wert. |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Setzt den Ziel-Namespace für das importierte Schema als Uniform Resource Identifier (URI)-Referenz. |
...
| void [set_SchemaLocation](../xmlschemaexternal/set_schemalocation/)(const [String](../../system/string/)\&) | Setzt den Uniform Resource Identifier (URI)-Standort für das Schema, der dem Schema-Prozessor mitteilt, wo das Schema physisch liegt. |
...
Objekte dieser Klasse sollten ausschließlich mit der [System::MakeObject()](../../system/makeobject/)-Funktion alloziert werden. Erzeugen Sie niemals Instanzen dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Pointer ein und verwenden Sie diesen Pointer, um ihn als Argument an Funktionen zu übergeben. 
