...
description: Stellt das all-Element (Kompositor) des World Wide Web Consortium (W3C) dar.
type: docs
weight: 92
url: /de/system.xml.schema/xmlschemaall/
---
## XmlSchemaAll Klasse
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Gibt die Sammlung der [XmlSchemaElement](../xmlschemaelement/)-Elemente zurück, die im **all**-Kompositor enthalten sind. |
...
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Gibt die Zahl als Zeichenkettenwert zurück. Minimale Anzahl der möglichen Vorkommen des Partikels. |
...
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Setzt die Zahl als Zeichenkettenwert. Minimale Anzahl der möglichen Vorkommen des Partikels. |
