...
description: Stellt das Erweiterungs-Element des XML-Schemas dar, wie vom World Wide Web Consortium (W3C) spezifiziert. Diese Klasse dient komplexen Typen mit einem durch Erweiterung abgeleiteten komplexen Inhaltsmodell. Sie erweitert den komplexen Typ, indem sie Attribute oder Elemente hinzufügt.
type: docs
weight: 274
url: /de/system.xml.schema/xmlschemacomplexcontentextension/
---
## XmlSchemaComplexContentExtension Klasse


Stellt das **extension**-Element aus XML [Schema](../) dar, wie vom World Wide [Web](../../system.web/) Consortium (W3C) spezifiziert. Diese Klasse ist für komplexe Typen mit einem durch Erweiterung abgeleiteten komplexen Inhaltsmodell. Sie erweitert den komplexen Typ, indem sie Attribute oder Elemente hinzufügt.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Gibt die [XmlSchemaAnyAttribute](../xmlschemaanyattribute/)-Komponente des komplexen Inhaltsmodells zurück. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Gibt die Sammlung von Attributen für den komplexen Inhalt zurück. Enthält [XmlSchemaAttribute](../xmlschemaattribute/)- und [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/)-Elemente. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Gibt den Namen des komplexen Typs zurück, von dem dieser Typ durch Erweiterung abgeleitet ist. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaParticle](../xmlschemaparticle/)\> [get_Particle](./get_particle/)() | Gibt eine der Klassen [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) oder [XmlSchemaSequence](../xmlschemasequence/) zurück. |
...
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Setzt den Namen des komplexen Typs, von dem dieser Typ durch Erweiterung abgeleitet ist. |
