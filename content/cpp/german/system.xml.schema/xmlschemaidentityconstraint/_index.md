...
description: "Klasse für die Identitätsbeschränkungen: key-, keyref- und unique-Elemente."
type: docs
weight: 469
url: /de/system.xml.schema/xmlschemaidentityconstraint/
---
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | Gibt die Sammlung von Feldern zurück, die als Kinder für den Ausdrucksselektor der XML Path Language ([XPath](../../system.xml.xpath/)) gelten. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Gibt die Zeichenketten-ID zurück. |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | Gibt die Zeilennummer in der Datei zurück, auf die das Element **schema** verweist. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Gibt die Zeilenposition in der Datei zurück, auf die das Element **schema** verweist. |
| [String](../../system/string/) [get_Name](./get_name/)() | Gibt den Namen der Identitätsbeschränkung zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Gibt den Eltern-Knoten dieses [XmlSchemaObject](../xmlschemaobject/) zurück. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Gibt den qualifizierten Namen der Identitätsbeschränkung zurück, der die nach der Kompilierung interpretierte **QualifiedName**-Wert darstellt. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | Gibt das [XPath](../../system.xml.xpath/)-Ausdruck **selector**-Element zurück. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Setzt den Namen der Identitätsbeschränkung. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Setzt den Eltern-Knoten dieses [XmlSchemaObject](../xmlschemaobject/). |
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Setzt das [XPath](../../system.xml.xpath/)-Ausdruck **selector**-Element. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Verringert und gibt den gemeinsam genutzten Referenzzähler zurück. Sollte nicht direkt aufgerufen werden; verwenden Sie stattdessen Smart-Pointer oder ThisProtector. |
