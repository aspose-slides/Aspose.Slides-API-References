...
description: Stellt das World Wide Web Consortium (W3C) whiteSpace-Facet dar.
type: docs
weight: 950
url: /de/system.xml.schema/xmlschemawhitespacefacet/
---
## XmlSchemaWhiteSpaceFacet Klasse


Stellt das World Wide [Web](../../system.web/) Consortium (W3C) **whiteSpace** Facet dar.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Gibt Informationen zurück, die anzeigen, dass dieses Facet fest ist. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Gibt das **value** Attribut des Facets zurück. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog zur C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) Methode. Ermöglicht das Klonen benutzerdefneider Typen. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Setzt die Information, die anzeigt, dass dieses Facet fest ist. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Setzt das **value** Attribut des Facets. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen Weak-Pointer (statt eines Shared-Pointers). Ermöglicht das Umschalten von Pointern in Containern in den Weak-Modus. |
...
|  [XmlSchemaWhiteSpaceFacet](./xmlschemawhitespacefacet/)() | Initialisiert eine neue Instanz der [XmlSchemaWhiteSpaceFacet](./) Klasse. |
...
Objekte dieser Klasse sollten nur über die Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erzeugen Sie niemals Instanzen dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/) Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben. 
