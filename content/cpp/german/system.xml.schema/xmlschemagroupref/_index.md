...
description: Stellt das group-Element mit dem ref-Attribut aus dem XML Schema dar, wie vom World Wide Web Consortium (W3C) festgelegt. Diese Klasse wird innerhalb komplexer Typen verwendet, die ein group referenzieren, das auf Schema-Ebene definiert ist.
type: docs
weight: 456
url: /de/system.xml.schema/xmlschemagroupref/
---
## XmlSchemaGroupRef Klasse


Stellt das **group**-Element mit dem **ref**-Attribut aus dem XML [Schema](../) dar, wie vom World Wide [Web](../../system.web/) Consortium (W3C) spezifiziert. Diese Klasse wird innerhalb komplexer Typen verwendet, die ein **group** referenzieren, das auf **schema**-Ebene definiert ist.
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | Gibt die maximale Anzahl von Vorkommen des Partikels zurück. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Gibt die Zahl als Zeichenkettenwert zurück. Maximale Anzahl von Vorkommen des Partikels. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | Gibt die minimale Anzahl von Vorkommen des Partikels zurück. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Gibt die Zahl als Zeichenkettenwert zurück. Die minimale Anzahl von Vorkommen des Partikels. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | Gibt eine der Klassen [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) oder [XmlSchemaSequence](../xmlschemasequence/) zurück, die die Nachkompilierungsinterpretation des **Particle**-Werts enthält. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Gibt den Namen einer in diesem Schema definierten Gruppe zurück (oder eines anderen Schemas, das durch den angegebenen Namensraum angegeben ist). |
...
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Setzt die maximale Anzahl von Vorkommen des Partikels. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Setzt die Zahl als Zeichenkettenwert. Maximale Anzahl von Vorkommen des Partikels. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Setzt die minimale Anzahl von Vorkommen des Partikels. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Setzt die Zahl als Zeichenkettenwert. Die minimale Anzahl von Vorkommen des Partikels. |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Setzt den Namen einer in diesem Schema definierten Gruppe (oder eines anderen Schemas, das durch den angegebenen Namensraum angegeben ist). |
