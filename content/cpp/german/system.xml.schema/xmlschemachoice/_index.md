...
description: Stellt das choice-Element (Kompositor) aus dem XML Schema dar, wie vom World Wide Web Consortium (W3C) spezifiziert. Das choice erlaubt, dass nur eines seiner Unterelemente in einer Instanz erscheint.
type: docs
weight: 209
url: /de/system.xml.schema/xmlschemachoice/
---
## XmlSchemaChoice Klasse


Stellt das **choice**-Element (Kompositor) aus dem XML [Schema](../) dar, wie vom World Wide [Web](../../system.web/) Consortium (W3C) spezifiziert. Das **choice** erlaubt, dass nur eines seiner Kinder in einer Instanz erscheint.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Gibt die Sammlung der mit dem Kompositor (**choice**) enthaltenen Elemente zurück: [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](./), [XmlSchemaSequence](../xmlschemasequence/) oder [XmlSchemaAny](../xmlschemaany/). |
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | Gibt die maximale Anzahl der möglichen Vorkommen des Partikels zurück. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Gibt die Zahl als Zeichenkettenwert zurück. Maximale Anzahl der möglichen Vorkommen des Partikels. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | Gibt die minimale Anzahl der möglichen Vorkommen des Partikels zurück. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Gibt die Zahl als Zeichenkettenwert zurück. Die minimale Anzahl der möglichen Vorkommen des Partikels. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Gibt das XmlSerializerNamespaces-Objekt zurück, das mit diesem Schemaknoten verwendet werden soll. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Gibt den Elternelement dieses [XmlSchemaObject](../xmlschemaobject/) zurück. |
...
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Setzt die maximale Anzahl der möglichen Vorkommen des Partikels. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Setzt die Zahl als Zeichenkettenwert. Maximale Anzahl der möglichen Vorkommen des Partikels. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Setzt die minimale Anzahl der möglichen Vorkommen des Partikels. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Setzt die Zahl als Zeichenkettenwert. Die minimale Anzahl der möglichen Vorkommen des Partikels. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Setzt das XmlSerializerNamespaces-Objekt, das mit diesem Schemaknoten verwendet werden soll. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen schwachen Zeiger (statt eines gemeinsamen Zeigers). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
...
| [XmlSchemaChoice](./xmlschemachoice/)() | Initialisiert eine neue Instanz der [XmlSchemaChoice](./)-Klasse. |
...
Objekte dieser Klasse sollten nur über die Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erzeugen Sie niemals Instanzen dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Pointer und verwenden Sie diesen Pointer, um ihn als Argument an Funktionen zu übergeben. 
