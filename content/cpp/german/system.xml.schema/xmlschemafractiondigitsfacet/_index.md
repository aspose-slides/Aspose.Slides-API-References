...
description: Gibt eine Beschränkung für die Anzahl der Ziffern an, die für den Bruchwert eines simpleType-Elements eingegeben werden können. Der Wert von fractionDigits muss eine positive ganze Zahl sein. Stellt das World Wide Web Consortium (W3C) fractionDigits facet dar.
type: docs
weight: 417
url: /de/system.xml.schema/xmlschemafractiondigitsfacet/
---
## XmlSchemaFractionDigitsFacet Klasse


Gibt eine Beschränkung für die Anzahl der Ziffern an, die für den Bruchwert eines simpleType-Elements eingegeben werden können. Der Wert von fractionDigits muss eine positive ganze Zahl sein. Stellt das World Wide [Web](../../system.web/) Consortium (W3C) **fractionDigits** Facet dar.
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Setzt Informationen, die anzeigen, dass dieses Facet fest ist. |
...
|  [XmlSchemaFractionDigitsFacet](./xmlschemafractiondigitsfacet/)() | Initialisiert eine neue Instanz der [XmlSchemaFractionDigitsFacet](./)-Klasse. |
...
Objekte dieser Klasse sollten nur mit der [System::MakeObject()](../../system/makeobject/)-Funktion zugewiesen werden. Erzeugen Sie niemals Instanzen dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Pointer und verwenden Sie diesen Pointer, um ihn als Argument an Funktionen zu übergeben. 
