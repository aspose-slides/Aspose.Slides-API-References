...
description: Die XmlSchemaDatatype-Klasse ist eine abstrakte Klasse zum Abbilden von XML Schema Definitionssprache (XSD) Typen auf Laufzeittypen.
type: docs
weight: 339
url: /de/system.xml.schema/xmlschemadatatype/
---
...
| virtual [XmlTokenizedType](../../system.xml/xmltokenizedtype/) [get_TokenizedType](./get_tokenizedtype/)() | Wenn in einer abgeleiteten Klasse überschrieben, gibt den Typ für die **string** zurück, wie in der World Wide [Web](../../system.web/) Consortium (W3C) XML 1.0-Spezifikation angegeben. |
| virtual [XmlTypeCode](../xmltypecode/) [get_TypeCode](./get_typecode/)() | Gibt den XmlTypeCode-Wert für den einfachen Typ zurück. |
| virtual [TypeInfo](../../system/typeinfo/) [get_ValueType](./get_valuetype/)() | Wenn in einer abgeleiteten Klasse überschrieben, gibt den Typ des Elements zurück. |
| virtual [XmlSchemaDatatypeVariety](../xmlschemadatatypevariety/) [get_Variety](./get_variety/)() | Gibt den XmlSchemaDatatypeVariety-Wert für den einfachen Typ zurück. |
...
| virtual **bool** [IsDerivedFrom](./isderivedfrom/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaDatatype](./)\>) | Diese Methode gibt stets **false** zurück. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [ParseValue](./parsevalue/)([String](../../system/string/), [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>, [SharedPtr](../../system/sharedptr/)\<[IXmlNamespaceResolver](../../system.xml/ixmlnamespaceresolver/)\>) | Wenn in einer abgeleiteten Klasse überschrieben, prüft die angegebene **string** gegen einen integrierten oder benutzerdefinierten einfachen Typ. |
