...
description: "Klasse, die eine Sicherheitsberechtigung beschreibt. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit operator new, da dies Laufzeitfehler und/oder Assertionsfehler zur Folge hat. Wickeln Sie diese Klasse stets in einen System::SmartPtr Zeiger ein und verwenden Sie diesen Zeiger, um ihn an Funktionen als Argument zu übergeben."
type: docs
weight: 1
url: /de/system.security.permissions/securitypermission/
---
## SecurityPermission Klasse

Klasse, die eine Sicherheitsberechtigung beschreibt. Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit operator new, da dies Laufzeitfehler und/oder Assertionsfehler zur Folge hat. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/) Zeiger ein und verwenden Sie diesen Zeiger, um ihn an Funktionen als Argument zu übergeben.
...
| [SecurityPermissionFlag](../securitypermissionflag/) [get_Flags](./get_flags/)() | Ermittelt Flags, die mit der Berechtigung verknüpft sind. |
...
| **bool** [IsUnrestricted](./isunrestricted/)() | Prüft, ob die Berechtigung uneingeschränkt ist. |
...
| void [set_Flags](./set_flags/)([SecurityPermissionFlag](../securitypermissionflag/)) | Setzt Flags, die mit der Berechtigung verknüpft sind. |
