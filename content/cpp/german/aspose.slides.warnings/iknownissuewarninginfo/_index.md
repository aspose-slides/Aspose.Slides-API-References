...
description: Stellt eine Warnung zu einem bekannten Problem dar, das in naher Zukunft nicht behoben wird.
type: docs
weight: 1
url: /de/aspose.slides.warnings/iknownissuewarninginfo/
---
## IKnownIssueWarningInfo Klasse

Stellt eine Warnung zu einem bekannten Problem dar, das in naher Zukunft nicht behoben wird.
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Gibt eine menschenlesbare Beschreibung dieser Warnung zurück. Nur lesbar [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Gibt einen Warnungstyp zurück. Nur lesbar [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-Konstruktor. Kopiert nichts, sondern initialisiert ein neues Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Wenn der Empfänger nicht null ist, beendet die Warnung an einen angegebenen Empfänger und wirft die AbortRequestedException, falls der Empfänger beschlossen hat, den Vorgang abzubrechen. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog zur C# [Object.ToString()](../../system/object/tostring/)-Methode. Ermöglicht die Konvertierung benutzerdefinierter Objekte in string. |
