...
---
## IObsoletePresLockingBehaviorWarningInfo Klasse
...
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Gibt den Typ der Warnung zurück. Nur lesbar [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Falls der Empfänger nicht null ist, endet die Warnung bei einem angegebenen Empfänger und wirft die AbortRequestedException, wenn der Empfänger beschlossen hat, einen Vorgang abzubrechen. |
