...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Gibt eine menschenlesbare Beschreibung dieser Warnung zurück. Nur-Lesen [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](./get_warningtype/)() | Gibt den Typ einer Warnung zurück. Nur-Lesen [IWarningInfo::get_WarningType](./get_warningtype/). |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren der C#-Anweisung lock(). Aufrufen direkt oder das Sentry-Objekt [LockContext](../../system/lockcontext/) verwenden. |
...
| virtual void [SendWarning](./sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Falls Empfänger nicht null ist, beendet die Warnung für einen angegebenen Empfänger und wirft die AbortRequestedException, wenn der Empfänger beschlossen hat, den Vorgang abzubrechen. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren der C#-Anweisung lock(). Aufrufen direkt oder das Sentry-Objekt [LockContext](../../system/lockcontext/) verwenden. |
