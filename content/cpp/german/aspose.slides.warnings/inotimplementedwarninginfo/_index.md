...
---
## INotImplementedWarningInfo Klasse
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Gibt eine menschenlesbare Beschreibung dieser Warnung zurück. Schreibgeschützt [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Gibt einen Warnungstyp zurück. Schreibgeschützt [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Wenn der Empfänger nicht null ist, beendet die Warnung an einen angegebenen Empfänger und wirft die AbortRequestedException, falls der Empfänger beschlossen hat, einen Vorgang abzubrechen. |
