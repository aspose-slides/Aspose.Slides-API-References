...
description: Diese Warnung weist darauf hin, dass die gelesene Präsentation eine Signatur enthält und diese Signatur während der Verarbeitung entfernt wird.
type: docs
weight: 40
...
Diese Warnung weist darauf hin, dass die gelesene Präsentation eine Signatur enthält und diese Signatur während der Verarbeitung entfernt wird.
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Zuweisungsoperator. Kopiert nichts, sondern initialisiert einfach ein neues Objekt und ermöglicht das Kopierkonstruktion von Unterklassen. |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Falls der Empfänger nicht null ist, wird die Warnung an einen angegebenen Empfänger gesendet und die AbortRequestedException ausgelöst, wenn der Empfänger beschlossen hat, einen Vorgang abzubrechen. |
