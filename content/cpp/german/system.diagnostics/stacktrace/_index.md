...
description: "Sammlung von Stack-Frames. Objekte dieser Klasse sollten nur über die Funktion System::MakeObject() alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 66
url: /de/system.diagnostics/stacktrace/
---
## StackTrace Klasse

Sammlung von Stack-Frames. Objekte dieser Klasse sollten nur über die Funktion [System::MakeObject()](../../system/makeobject/) angelegt werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| int [get_FrameCount](./get_framecount/)() const | Ermittelt die Anzahl der Rahmen im Stack-Trace. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[StackFrame](../stackframe/)\> [GetFrame](./getframe/)(**uint32_t**) | Ruft das Stack-Frame ab. |
...
| const [StackTrace](./)\& [operator=](./operator_equal/)(const [StackTrace](./)\&) const | Keine Zuweisung. |
...
|  [StackTrace](./stacktrace/)() | Erzeugt einen Stack-Trace, der den aktuellen Stack-Zustand beschreibt. |
|  [StackTrace](./stacktrace/)(**bool**) | Erzeugt einen Stack-Trace, der den aktuellen Stack-Zustand beschreibt. |
