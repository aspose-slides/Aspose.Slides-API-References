...
| virtual [String](../../system/string/) [get_ConnectionString](./get_connectionstring/)() const | RTTI-Informationen. |
...
| virtual void [Open](./open/)() | Öffnet die Verbindung zur Datenbank. |
...
| virtual void [set_ConnectionString](./set_connectionstring/)([String](../../system/string/)) const | Setzt Verbindungsinformationen (z. B. Server und Port). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n'th Template-Argument auf einen schwachen Zeiger (statt eines geteilten). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
