...
description: Konstruiert ein DateTime-Objekt aus Komponenten.
type: docs
weight: 222
url: /de/system.globalization/japanesecalendar/todatetime/
---
## JapaneseCalendar::ToDateTime(int, int, int, int, int, int, int, int) const Methode

Konstruiert [DateTime](../../../system/datetime/) Objekt aus Komponenten.
...
| minute | int | Minute. |
| second | int | Sekunde. |
| millisecond | int | Millisekunde. |
| era | int | Epoche. |

### Rückgabewert

[DateTime](../../../system/datetime/) Objekt, das die angegebenen Komponenten enthält.

## JapaneseCalendar::ToDateTime(int, int, int, int, int, int, int) const Methode
