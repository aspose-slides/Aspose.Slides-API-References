...
description: "Stellt Informationen über die Unicode-Version bereit, die zum Vergleichen und Ordnen von Zeichenketten verwendet wird. Objekte dieser Klasse sollten nur über die Funktion System::MakeObject() alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 300
url: /de/system.globalization/sortversion/
---
## SortVersion Klasse

Stellt Informationen über die Unicode-Version bereit, die zum Vergleichen und Ordnen von Zeichenketten verwendet wird. Objekte dieser Klasse sollten nur über die Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[SortVersion](./)\>) override | Prüft, ob die aktuelle [SortVersion](./)-Instanz einem angegebenen [SortVersion](./)-Objekt entspricht. |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Prüft, ob die aktuelle [SortVersion](./)-Instanz einem angegebenen [SortVersion](./)-Objekt entspricht. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert einen C#-artigen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert einen C#-artigen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN keinem Wert, einschließlich NaN, gleich ist. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| int [get_FullVersion](./get_fullversion/)() | Liefert die vollständige Versionsnummer. |
| [Guid](../../system/guid/) [get_SortId](./get_sortid/)() | Liefert den eindeutigen Bezeichner für dieses Objekt. |
...
| int [GetHashCode](./gethashcode/)() const override | Liefert den Hash-Code für das aktuelle Objekt. |
...
| **bool** [operator!=](./operator_not_equal/)(const [SortVersion](./)\&) | Prüft, ob die aktuelle [SortVersion](./)-Instanz nicht gleich einem angegebenen [SortVersion](./)-Objekt ist. |
...
| **bool** [operator==](./operator_equal_equal/)(const [SortVersion](./)\&) | Prüft, ob die aktuelle [SortVersion](./)-Instanz einem angegebenen [SortVersion](./)-Objekt entspricht. |
