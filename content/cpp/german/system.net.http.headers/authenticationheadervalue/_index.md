...
description: "Stellt die Werte der Header 'Authorization', 'ProxyAuthorization', 'WWW-Authenticate' und 'Proxy-Authenticate' dar. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse immer in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 1
url: /de/system.net.http.headers/authenticationheadervalue/
---
## AuthenticationHeaderValue Klasse
...
| [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | Erstellt eine Kopie des aktuellen Objekts und gibt einen Shared-Pointer darauf zurück. |
...
| [String](../../system/string/) [get_Parameter](./get_parameter/)() | Ruft die Anmeldedaten ab, die die Authentifizierungsinformationen enthalten. |
| [String](../../system/string/) [get_Scheme](./get_scheme/)() | Ruft das Schema ab, das für die Autorisierung verwendet werden kann. |
| static **int32_t** [GetAuthenticationLength](./getauthenticationlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Parst den angegebenen String und gibt den letzten Index der String-Repräsentation zurück. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[AuthenticationHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Wandelt einen übergebenen String in eine Instanz der [AuthenticationHeaderValue](./)-Klasse um. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Ruft den aktuellen Wert des Shared-Referenzzählers ab. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[AuthenticationHeaderValue](./)\>\&) | Versucht, einen übergebenen String in eine Instanz der [AuthenticationHeaderValue](./)-Klasse zu konvertieren. |
