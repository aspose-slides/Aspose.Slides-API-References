...
description: "Stellt die Sammlung der Header-Werte dar. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um sie als Argument an Funktionen zu übergeben."
type: docs
weight: 92
url: /de/system.net.http.headers/httpheadervaluecollection/
---
...
| --- | --- |
| void [Add](./add/)(const T\&) override | Fügt ein Element in die Sammlung ein. |
...
| void [Clear](./clear/)() override | Löscht alle Elemente aus der Sammlung. |
| **bool** [Contains](./contains/)(const T\&) const override | Prüft, ob das Element in der Sammlung vorhanden ist. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) override | Kopiert alle Sammlungselemente in vorhandene Array-Elemente. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopiert alle Sammlungselemente in vorhandene Array-Elemente. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Gibt einen Wert zurück, der angibt, ob die aktuelle Sammlung schreibgeschützt ist. |
...
| **bool** [get_IsSpecialValueSet](./get_isspecialvalueset/)() | Gibt einen Wert zurück, der angibt, ob die aktuelle Sammlung einen \"special value\" enthält. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Gibt den Enumerator zurück. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog zur C# [Object.GetHashCode()](../../system/object/gethashcode/)-Methode. Ermöglicht das Hashen benutzerdefinierter Objekte. |
| [String](../../system/string/) [GetHeaderStringWithoutSpecial](./getheaderstringwithoutspecial/)() | Gibt eine Zeichenkettendarstellung der aktuellen Sammlung ohne einen \"special value\" zurück. |
...
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>) | Konstruiert eine neue Instanz. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Konstruiert eine neue Instanz. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T) | Konstruiert eine neue Instanz. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Konstruiert eine neue Instanz. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Überspringt eine festgelegte Anzahl zusammenhängender Elemente zu Beginn einer Sequenz und gibt den Rest zurück. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Gibt eine festgelegte Anzahl zusammenhängender Elemente vom Beginn einer Sequenz zurück. |
...
| void [ParseAdd](./parseadd/)([String](../../system/string/)) | Parst eine Header-Zeichenketten-Darstellung und fügt sie zur aktuellen Sammlung hinzu. |
...
| **bool** [Remove](./remove/)(const T\&) override | Löscht ein Element aus der Sammlung. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verringert den gemeinsamen Referenzzähler um den angegebenen Wert. |
| void [RemoveSpecialValue](./removespecialvalue/)() | Entfernt einen \"special value\". |
| void [SetSpecialValue](./setspecialvalue/)() | Setzt einen \"special value\". |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Analog zur C# [Object.ToString()](../../system/object/tostring/)-Methode. Ermöglicht die Umwandlung benutzerdefinierter Objekte in eine Zeichenkette. |
| **bool** [TryParseAdd](./tryparseadd/)([String](../../system/string/)) | Versucht, eine Header-Zeichenketten-Darstellung zu parsen und sie zur aktuellen Sammlung hinzuzufügen. |
