...
| --- | --- |
|  [ContentRangeHeaderValue](./contentrangeheadervalue/)(**int64_t**, **int64_t**, **int64_t**) | Erzeugt eine neue Instanz. |
|  [ContentRangeHeaderValue](./contentrangeheadervalue/)(**int64_t**) | Erzeugt eine neue Instanz. |
|  [ContentRangeHeaderValue](./contentrangeheadervalue/)(**int64_t**, **int64_t**) | Erzeugt eine neue Instanz. |
...
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_From](./get_from/)() | Ermittelt eine Position, an der das Senden von Daten beginnen muss. |
| **bool** [get_HasLength](./get_haslength/)() const | Ermittelt einen Wert, der angibt, ob die Länge für den aktuellen Header angegeben ist. |
| **bool** [get_HasRange](./get_hasrange/)() const | Ermittelt einen Wert, der angibt, ob der Bereich für den aktuellen Header angegeben ist. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_Length](./get_length/)() | Ermittelt die Länge eines Entity-Body. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_To](./get_to/)() | Ermittelt eine Position, an der das Senden von Daten beendet werden muss. |
| [String](../../system/string/) [get_Unit](./get_unit/)() | Ermittelt die im Bereich verwendeten Einheiten. |
| static **int32_t** [GetContentRangeLength](./getcontentrangelength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Konvertiert einen übergebenen String ab der angegebenen Position in eine Instanz der [ContentRangeHeaderValue](./) Klasse. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[ContentRangeHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Konvertiert einen übergebenen String in eine Instanz der [ContentRangeHeaderValue](./) Klasse. |
...
| void [set_Unit](./set_unit/)([String](../../system/string/)) | Setzt die im Bereich verwendeten Einheiten. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[ContentRangeHeaderValue](./)\>\&) | Versucht, einen übergebenen String in eine Instanz der [ContentRangeHeaderValue](./) Klasse zu konvertieren. |
