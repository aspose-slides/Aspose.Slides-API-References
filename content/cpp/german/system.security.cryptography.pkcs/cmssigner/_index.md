...
| --- | --- |
|  [CmsSigner](./cmssigner/)(const [SharedPtr](../../system/sharedptr/)\<[X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\>\&) | Initialisiert den Signierer mit einem X509-Zertifikat. |
...
| [SharedPtr](../../system/sharedptr/)\<[Oid](../../system.security.cryptography/oid/)\> [get_DigestAlgorithm](./get_digestalgorithm/)() const | Ermittelt den für die Signatur verwendeten Hash-Algorithmus. |
| [X509Certificates::X509IncludeOption](../../system.security.cryptography.x509certificates/x509includeoption/) [get_IncludeOption](./get_includeoption/)() const | Prüft, welche Zertifikate aus der Kette in die Signatur aufgenommen werden. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Ermittelt den tatsächlichen Typ des Objekts. Analog zu [System.Object.GetType()](../../system/object/gettype/) in C#. |
...
| void [set_DigestAlgorithm](./set_digestalgorithm/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](../../system.security.cryptography/oid/)\>\&) | Setzt den für die Signatur zu verwendenden Hash-Algorithmus. |
| void [set_IncludeOption](./set_includeoption/)([X509Certificates::X509IncludeOption](../../system.security.cryptography.x509certificates/x509includeoption/)) | Gibt an, welche Zertifikate aus der Kette in die Signatur aufgenommen werden. |
...
* Namensraum [System::Security::Cryptography::Pkcs](../)
