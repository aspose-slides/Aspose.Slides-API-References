...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() override | Gibt das Farbschema zurück. Nur-Lesen [IColorScheme](../icolorscheme/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) override | Gibt das zusätzliche Farbschema am angegebenen Index zurück. Dieses Schema beeinflusst das Erscheinungsbild der Präsentation nicht, es kann als Hauptfarbschema für eine Folie ausgewählt werden. Nur-Lesen [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() override | Gibt die Sammlung zusätzlicher Farbschemas zurück. Diese Schemata beeinflussen das Erscheinungsbild der Präsentation nicht, sie können als Hauptfarbschema für eine Folie ausgewählt werden. Nur-Lesen [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](./get_fontscheme/)() override | Gibt das Schriftartenschema zurück. Nur-Lesen [IFontScheme](../ifontscheme/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](./get_formatscheme/)() override | Gibt das Formatierungsschema für Formen zurück. Nur-Lesen [IFormatScheme](../iformatscheme/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Gibt den Namen eines Themes zurück. Lesen [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\> [get_Presentation](../theme/get_presentation/)() override | Gibt die übergeordnete Präsentation zurück. Nur-Lesen [IPresentation](../../aspose.slides/ipresentation/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](../theme/geteffective/)() override | Ermittelt die effektiven Theme-Daten mit angewandter Vererbung. |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Gibt den Namen eines Themes zurück. Schreiben [System::String](../../system/string/). |
...
* Klasse [Theme](../theme/)
* Klasse [IMasterTheme](../imastertheme/)
