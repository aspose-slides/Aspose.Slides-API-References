...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithemeable/createthemeeffective/)() | Gibt ein effektives Theme für dieses themefähige Objekt zurück. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterThemeManager](../imasterthememanager/)\> [get_ThemeManager](./get_thememanager/)() | Gibt den Master-Theme-Manager zurück. Nur-Lesen [IMasterThemeManager](../imasterthememanager/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument als schwachen Zeiger (statt shared). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
