...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithemeable/createthemeeffective/)() | Gibt ein effektives Theme für dieses themenfähige Objekt zurück. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideThemeManager](../ioverridethememanager/)\> [get_ThemeManager](./get_thememanager/)() | Gibt den Override-Theme-Manager zurück. Nur lesend [IOverrideThemeManager](../ioverridethememanager/). |
