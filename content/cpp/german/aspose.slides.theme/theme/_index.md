...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() | Gibt das Farbschema zurück. Nur lesbar [IColorScheme](../icolorscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](./get_fontscheme/)() | Gibt das Font-Schema zurück. Nur lesbar [IFontScheme](../ifontscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](./get_formatscheme/)() | Gibt das Shape-Format-Schema zurück. Nur lesbar [IFormatScheme](../iformatscheme/). |
...
| virtual ASPOSE_SLIDES_LOCAL_API **uint32_t** [get_Version](../../aspose.slides/ipviobject/get_version/)() | Version. Nur lesbar **uint32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](./geteffective/)() override | Liefert die wirksamen Theme-Daten mit angewandter Vererbung. |
...
* Klasse [IStyleColorOwner](../../aspose.slides/istylecolorowner/)
