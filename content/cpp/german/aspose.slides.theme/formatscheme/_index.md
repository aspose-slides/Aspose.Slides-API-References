...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_BackgroundFillStyle](./get_backgroundfillstyle/)(**int32_t**) override | Gibt den themen-definierten Hintergrundfüllstil am angegebenen Index zurück. Nur lesbar [Aspose::Slides::IFillFormat](../../aspose.slides/ifillformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollection](../ifillformatcollection/)\> [get_BackgroundFillStyles](./get_backgroundfillstyles/)() override | Gibt eine Sammlung themen-definierter Hintergrundfüllstile zurück. Nur lesbar [IFillFormatCollection](../ifillformatcollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\> [get_EffectStyle](./get_effectstyle/)(**int32_t**) override | Gibt den themen-definierten Effektstil am angegebenen Index zurück. Nur lesbar [Aspose::Slides::Theme::IEffectStyle](../ieffectstyle/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyleCollection](../ieffectstylecollection/)\> [get_EffectStyles](./get_effectstyles/)() override | Gibt eine Sammlung themen-definierter Effektstile zurück. Nur lesbar [IEffectStyleCollection](../ieffectstylecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillStyle](./get_fillstyle/)(**int32_t**) override | Gibt den themen-definierten Füllstil am angegebenen Index zurück. Nur lesbar [Aspose::Slides::IFillFormat](../../aspose.slides/ifillformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollection](../ifillformatcollection/)\> [get_FillStyles](./get_fillstyles/)() override | Gibt eine Sammlung themen-definierter Füllstile zurück. Nur lesbar [IFillFormatCollection](../ifillformatcollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_LineStyle](./get_linestyle/)(**int32_t**) override | Gibt den themen-definierten Linienstil am angegebenen Index zurück. Nur lesbar [Aspose::Slides::ILineFormat](../../aspose.slides/ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatCollection](../ilineformatcollection/)\> [get_LineStyles](./get_linestyles/)() override | Gibt eine Sammlung themen-definierter Linienstile zurück. Nur lesbar [ILineFormatCollection](../ilineformatcollection/). |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren der C#-Anweisung lock(). Aufrufen direkt oder den Sentry-Objekt [LockContext](../../system/lockcontext/) verwenden. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren der C#-Anweisung lock(). Aufrufen direkt oder den Sentry-Objekt [LockContext](../../system/lockcontext/) verwenden. |
