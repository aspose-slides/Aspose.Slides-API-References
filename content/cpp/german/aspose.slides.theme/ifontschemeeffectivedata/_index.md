...
description: Unveränderliches Objekt, das die effektiven Schriftartenschema-Eigenschaften enthält.
type: docs
weight: 287
...
Unveränderliches Objekt, das die effektiven Schriftartenschema-Eigenschaften enthält.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Major](./get_major/)() | Gibt die Schriftartensammlung für den "Überschrift"-Teil der Folie zurück. Schreibgeschützt [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Minor](./get_minor/)() | Gibt die Schriftartensammlung für den "Inhalt"-Teil der Folie zurück. Schreibgeschützt [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Gibt den Namen des Schriftartenschemas zurück. Schreibgeschützt [System::String](../../system/string/). |
