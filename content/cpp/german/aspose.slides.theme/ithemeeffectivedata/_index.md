...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontSchemeEffectiveData](../ifontschemeeffectivedata/)\> [get_FontScheme](./get_fontscheme/)() | Gibt das Schriftschema zurück. Nur-Lesen [IFontSchemeEffectiveData](../ifontschemeeffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatSchemeEffectiveData](../iformatschemeeffectivedata/)\> [get_FormatScheme](./get_formatscheme/)() | Gibt das Formformat-Schema zurück. Nur-Lesen [IFormatSchemeEffectiveData](../iformatschemeeffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorSchemeEffectiveData](../icolorschemeeffectivedata/)\> [GetColorScheme](./getcolorscheme/)([System::Drawing::Color](../../system.drawing/color/)) | Gibt das Farbschema zurück. |
...
Dieses Interface wird zusammen mit dem Interface [ITheme](../itheme/) verwendet, um wirksame Formatierungswerte mit angewandter Vererbung zurückzugeben.
