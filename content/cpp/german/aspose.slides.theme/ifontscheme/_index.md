...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() | Gibt die Schriften-Sammlung für einen \"Überschrift\"-Teil der Folie zurück. Schreibgeschützt [IFonts](../../aspose.slides/ifonts/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() | Gibt die Schriften-Sammlung für einen \"Inhalt\"-Teil der Folie zurück. Schreibgeschützt [IFonts](../../aspose.slides/ifonts/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Gibt den Namen des Schriftartschemas zurück. Lese [System::String](../../system/string/). |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Gibt den Namen des Schriftartschemas zurück. Schreiben [System::String](../../system/string/). |
