...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Bestimmt, ob [OverrideTheme](../overridetheme/) das geerbte effektive Theme überschreibt oder nicht. Um [OverrideTheme](../overridetheme/) für das Überschreiben zu aktivieren, verwenden Sie die OverrideTheme.Init*()-Methoden. Um [OverrideTheme](../overridetheme/) vom Überschreiben zu deaktivieren, verwenden Sie die [OverrideTheme::Clear](../overridetheme/clear/)-Methode. Nur-Lese **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Gibt das überschreibende Theme-Objekt zurück. Lesen [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Gibt das überschreibende Theme-Objekt zurück. Schreiben [IOverrideTheme](../ioverridetheme/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen Weak-Pointer (statt eines Shared). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
