...
type: docs
weight: 14
url: /de/aspose.slides.spreadsheet/details_cellinvalidformulaexception/
---
## Details_CellInvalidFormulaException Klasse
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Ermittelt eine Zellenreferenz, die die ungültige Formel enthält. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Setzt HRESULT, einen codierten numerischen Wert, der einer bestimmten Ausnahme zugeordnet wird. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die Methode [what()](../../system/details_exception/what/), die von der Klasse [ExceptionWrapper](../../system/exceptionwrapper/) aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/private Mitglieder nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodendefinition in das [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik beschädigen. |
