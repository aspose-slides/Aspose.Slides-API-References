...
description: Eine CancellationTokenSource, die verwendet werden kann, um Abbruchbenachrichtigungen auszulösen.
type: docs
weight: 40
url: /de/system.threading/cancellationtokensource/
---
## CancellationTokenSource Klasse


Eine CancellationTokenSource, die verwendet werden kann, um Abbruchbenachrichtigungen auszulösen.
...
| --- | --- |
| void [Cancel](./cancel/)() | Sendet eine Anforderung zum Abbruch. |
|  [CancellationTokenSource](./cancellationtokensource/)() | Konstruiert ein neues [CancellationTokenSource](./). |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | Erstellt eine verknüpfte Token-Quelle, die abbricht, wenn einer der bereitgestellten Tokens abbricht. |
| void [Dispose](./dispose/)() override | Gibt alle vom [CancellationTokenSource](./) genutzten Ressourcen frei. |
...
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | Gibt zurück, ob ein Abbruch angefordert wurde. |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | Gibt das dem Quellobjekt zugehörige Abbruch-Token zurück. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Liefert den tatsächlichen Typ des Objekts. Analoge C# [System.Object.GetType()](../../system/object/gettype/)-Aufruf. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analoge C# [Object.ToString()](../../system/object/tostring/)-Methode. Ermöglicht die Umwandlung benutzerdefinierter Objekte in Zeichenketten. |
...
Bietet Mechanismen zum Erstellen und Steuern von Abbruch-Tokens für die kooperative Abbruch von Vorgängen. 
