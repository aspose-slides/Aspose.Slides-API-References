...
description: Stellt die Grundfunktionalität zum Weiterleiten eines Synchronisationskontexts über verschiedene Synchronisationsvorgänge bereit.
type: docs
weight: 196
url: /de/system.threading/synchronizationcontext/
---
## SynchronizationContext Klasse

Stellt die Grundfunktionalität bereit, um einen Synchronisationskontext über verschiedene Synchronisationsvorgänge hinweg zu propagieren.
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | Ermittelt den Synchronisationskontext für den aktuellen Thread. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierkonstruktor. Kopiert nichts, sondern initialisiert lediglich ein neues Objekt und ermöglicht das Kopierkonstrukt für abgeleitete Klassen. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Zuweisungsoperator. Kopiert nichts, sondern initialisiert lediglich ein neues Objekt und ermöglicht das Kopieren in abgeleiteten Klassen. |
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Führt Callback asynchron aus. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Führt Callback synchron aus. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | Setzt den Synchronisationskontext für den aktuellen Thread. |
...
|  [SynchronizationContext](./synchronizationcontext/)() | Konstruiert eine neue Instanz von [SynchronizationContext](./). |
...
Diese Klasse ermöglicht die Weitergabe des Synchronisationskontexts zwischen Threads und wird verwendet, um Callbacks oder Aufrufe an den entsprechenden Thread bzw. Synchronisationskontext zu marshallen. Dummy-Implementierung.
