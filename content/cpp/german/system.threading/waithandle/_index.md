...
description: "Warteprimitive Basisklasse. Objekte dieser Klasse sollten nur über die Funktion System::MakeObject() alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 274
url: /de/system.threading/waithandle/
---
## WaitHandle Klasse

Warteprimitive-Basisklasse. Objekte dieser Klasse sollten nur über die [System::MakeObject()](../../system/makeobject/)-Funktion alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
| virtual void [Close](./close/)() | Gibt jede mit dem Handle verbundene Ressource frei. |
...
| [wait_handle_t](../wait_handle_t/) [get_Handle](./get_handle/)() | Gibt das Handle zurück. |
...
| static **bool** [WaitAll](./waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&, int) | Wartet darauf, dass alle Handles ausgelöst werden. |
| static **bool** [WaitAll](./waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&, [TimeSpan](../../system/timespan/)) | Wartet darauf, dass alle Handles ausgelöst werden. |
| static **bool** [WaitAll](./waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&) | Wartet darauf, dass alle Handles ausgelöst werden. |
| static int [WaitAny](./waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&, int) | Wartet darauf, dass irgendeines der Handles ausgelöst wird. |
| static int [WaitAny](./waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&, [TimeSpan](../../system/timespan/)) | Wartet darauf, dass irgendeines der Handles ausgelöst wird. |
| static int [WaitAny](./waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](./)\>\>\&) | Wartet darauf, dass irgendeines der Handles ausgelöst wird. |
| virtual **bool** [WaitOne](./waitone/)() | Wartet unbegrenzt, bis das Handle ausgelöst wird. |
| virtual **bool** [WaitOne](./waitone/)(int) | Wartet, bis das Handle ausgelöst wird. |
| virtual **bool** [WaitOne](./waitone/)([TimeSpan](../../system/timespan/)) | Wartet, bis das Handle ausgelöst wird. |
| virtual **bool** [WaitOne](./waitone/)(int, **bool**) | Wartet, bis das Handle ausgelöst wird. |
...
| Feld | Beschreibung |
| --- | --- |
| static [WaitTimeout](./waittimeout/) | Sonderwert, der von der Funktion zurückgegeben wird, wenn sonst der Index des signalierten Objekts im Array zurückgegeben würde, falls das Timeout überschritten wird und nichts signalisiert. |
