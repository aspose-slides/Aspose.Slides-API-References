...
description: "Ereignis, das an einen wartenden Thread gesendet werden kann. Objekte dieser Klasse sollten nur mithilfe der System::MakeObject()-Funktion zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem new-Operator, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 118
url: /de/system.threading/eventwaithandle/
---
## EventWaitHandle Klasse


Event, das an einen wartenden Thread gesendet werden kann. Objekte dieser Klasse sollten nur mithilfe der [System::MakeObject()](../../system/makeobject/)-Funktion zugewiesen werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mithilfe des new-Operators, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| virtual **bool** [Reset](./reset/)() | Setzt das Ereignis in den nicht-signalisierenden Zustand. |
| virtual **bool** [Set](./set/)() | Setzt das Ereignis in den signalisierten Zustand. |
...
| Feld | Beschreibung |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Sonderwert, der von der Funktion zurückgegeben wird, sonst wird der Index des signalisierten Objekts im Array zurückgegeben, falls das Timeout überschritten wird und nichts signalisiert. |
