...
type: docs
weight: 79
url: /de/system.threading/details_threadabortexception/
---
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-Konstruktor. Kopiert nichts, sondern initialisiert lediglich ein neues Objekt und ermöglicht das Kopieren bei der Konstruktion von Unterklassen. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die [what()](../../system/details_exception/what/)-Methode, die von der [ExceptionWrapper](../../system/exceptionwrapper/)-Klasse aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/privatre Mitglieder verwenden, um ihre Logik zu implementieren. Das Verschieben dieser Methodenimplementierung in die [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik brechen. |
