...
description: Gibt die XSLT-Funktionen an, die während der Ausführung des XSLT-Stylesheets unterstützt werden sollen.
type: docs
weight: 118
url: /de/system.xml.xsl/xsltsettings/
---
## XsltSettings Klasse

Specifiziert die XSLT-Funktionen, die während der Ausführung des XSLT-Stylesheets unterstützt werden sollen.
...
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_Default](./get_default/)() | Gibt ein [XsltSettings](./)-Objekt mit Standardeinstellungen zurück. Unterstützung für die XSLT **document()** Funktion und eingebettete Skriptblöcke ist deaktiviert. |
| **bool** [get_EnableDocumentFunction](./get_enabledocumentfunction/)() | Gibt einen Wert zurück, der angibt, ob die Unterstützung für die XSLT **document()**-Funktion aktiviert werden soll. |
| **bool** [get_EnableScript](./get_enablescript/)() | Gibt einen Wert zurück, der angibt, ob die Unterstützung für eingebettete Skriptblöcke aktiviert werden soll. |
| static [SharedPtr](../../system/sharedptr/)\<[XsltSettings](./)\> [get_TrustedXslt](./get_trustedxslt/)() | Gibt ein [XsltSettings](./)-Objekt zurück, das die Unterstützung für die XSLT **document()**-Funktion und eingebettete Skriptblöcke ermöglicht. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierekonstruktor. Kopiert nichts, sondern initialisiert lediglich ein neues Objekt und ermöglicht das Kopieren von Unterklassen. |
...
| void [set_EnableDocumentFunction](./set_enabledocumentfunction/)(**bool**) | Setzt einen Wert, der angibt, ob die Unterstützung für die XSLT **document()**-Funktion aktiviert werden soll. |
| void [set_EnableScript](./set_enablescript/)(**bool**) | Setzt einen Wert, der angibt, ob die Unterstützung für eingebettete Skriptblöcke aktiviert werden soll. |
