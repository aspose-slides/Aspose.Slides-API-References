...
description: Die Ausnahme, die von der Load-Methode ausgelöst wird, wenn im XSLT-Stylesheet ein Fehler gefunden wird.
type: docs
weight: 1
url: /de/system.xml.xsl/details_xsltcompileexception/
---
## Details_XsltCompileException Klasse

Die Ausnahme, die von der **Load**-Methode ausgelöst wird, wenn in dem XSLT-Stylesheet ein Fehler gefunden wird.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert einen C#-artigen Gleitkommavergleich, bei dem zwei NaN-Werte als gleich betrachtet werden, obwohl NaN laut IEC 60559:1989 zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert einen C#-artigen Gleitkommavergleich, bei dem zwei NaN-Werte als gleich betrachtet werden, obwohl NaN laut IEC 60559:1989 zu keinem Wert, einschließlich NaN, gleich ist. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Gibt einen 32-Bit-Integer-Wert zurück, der ein HRESULT-Code ist, der mit der vom aktuellen Objekt dargestellten Ausnahme verbunden ist. |
...
| virtual **int32_t** [get_LineNumber](../details_xsltexception/get_linenumber/)() | Gibt die Zeilennummer zurück, die angibt, wo der Fehler im Stylesheet aufgetreten ist. |
| virtual **int32_t** [get_LinePosition](../details_xsltexception/get_lineposition/)() | Gibt die Zeilenposition zurück, die angibt, wo der Fehler im Stylesheet aufgetreten ist. |
| [String](../../system/string/) [get_Message](../details_xsltexception/get_message/)() const override | Gibt die formatierte Fehlermeldung zurück, die die aktuelle Ausnahme beschreibt. |
| virtual [String](../../system/string/) [get_SourceUri](../details_xsltexception/get_sourceuri/)() | Gibt den Pfad der Stylesheet-Location zurück. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Vergleicht den Werttyp-Objekt referenziell mit nullptr. |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | Gibt die String-Repräsentation des aktuellen Objekts zurück. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die [what()](../../system/details_exception/what/)-Methode, die von der [ExceptionWrapper](../../system/exceptionwrapper/)-Klasse aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/private Mitglieder nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenimplementierung in [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik brechen. |
