...
description: Bietet eine Schnittstelle zu einer angegebenen Variable, die im Stylesheet während der Laufzeit definiert wird.
type: docs
weight: 40
url: /de/system.xml.xsl/ixsltcontextvariable/
---
## IXsltContextVariable Klasse

Bietet eine Schnittstelle zu einer gegebenen Variable, die im Stylesheet zur Laufzeit definiert ist.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Evaluate](./evaluate/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>) | Evaluiert die Variable zur Laufzeit und gibt ein Objekt zurück, das den Wert der Variable darstellt. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| virtual **bool** [get_IsLocal](./get_islocal/)() | Gibt einen Wert zurück, der angibt, ob die Variable lokal ist. |
| virtual **bool** [get_IsParam](./get_isparam/)() | Gibt einen Wert zurück, der angibt, ob die Variable ein Extensible Stylesheet Language Transformations (XSLT)-Parameter ist. Dies kann ein Parameter für ein Stylesheet oder eine Vorlage sein. |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_VariableType](./get_variabletype/)() | Gibt den XPathResultType zurück, der den XML Path Language ([XPath](../../system.xml.xpath/))-Typ der Variable darstellt. |
