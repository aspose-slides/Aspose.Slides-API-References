...
description: Callback-Schnittstelle, die von der HTML-Importroutine verwendet wird, um referenzierte Objekte wie Bilder zu erhalten.
type: docs
weight: 53
url: /de/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver Klasse

Callback-Schnittstelle, die von der HTML-Importroutine verwendet wird, um referenzierte Objekte wie Bilder zu erhalten.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | Ordnet eine URI einem Objekt zu, das die eigentliche Ressource enthält. |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | Ermittelt die absolute URI aus der Basis- und den relativen URIs. |
...
Veraltet
:   Veraltet. Verwenden Sie [IExternalResourceResolver](../iexternalresourceresolver/) stattdessen. Wird in der Version 17.12 entfernt.

## Siehe auch

* Klasse [IExternalResourceResolver](../iexternalresourceresolver/)
