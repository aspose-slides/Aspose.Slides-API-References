...
type: docs
weight: 27
url: /de/aspose.slides.import/htmlexternalresolver/
---
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) override | Ordnet einer URI ein Objekt zu, das die eigentliche Ressource enthält. |
...
| [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Ermittelt die absolute URI aus Basis- und relativen URIs. |
...
Veraltet
:   Veraltet. Verwenden Sie [ExternalResourceResolver](../externalresourceresolver/) stattdessen. Wird in der Version 17.12 entfernt.


Die Verwendung dieses Resolvers könnte eine Sicherheitslücke erzeugen, wenn eine vom Client bereitgestellte HTML-Datei die Serversoftware veranlasst, lokale oder Netzwerkdateien zu erhalten. Mit Vorsicht verwenden. Es wird empfohlen, [HtmlExternalResolver](./) überhaupt nicht anzugeben (es werden nur eingebettete Objekte gelesen) oder eine Unterklasse zu erstellen, die prüft, ob die angegebene URI gültig ist.

## Siehe auch

* Klasse [IHtmlExternalResolver](../ihtmlexternalresolver/)
