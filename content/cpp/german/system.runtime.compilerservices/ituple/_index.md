...
description: Definiert eine allgemein einsetzbare Tuple-Implementierung, die den Zugriff auf Tuple-Instanzmitglieder ermöglicht, ohne den zugrunde liegenden Tuple-Typ zu kennen.
type: docs
weight: 53
url: /de/system.runtime.compilerservices/ituple/
---
## ITuple Klasse

Definiert eine allgemein einsetzbare [Tuple](../../system/tuple/)-Implementierung, die den Zugriff auf Instanzmitglieder von [Tuple](../../system/tuple/) ermöglicht, ohne den zugrunde liegenden [Tuple](../../system/tuple/)-Typ zu kennen.
...
| virtual **int32_t** [get_Length](./get_length/)() const | Gibt die Anzahl der Positionen in dieser Datenstruktur zurück. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | Gibt das Element am Positionsindex zurück. |
...
* Namensraum [System::Runtime::CompilerServices](../)
