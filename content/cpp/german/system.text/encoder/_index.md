...
description: "Kapselt die Kodierung einer Zeichenfolge in eine Bytesequenz. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 131
url: /de/system.text/encoder/
---
## Encoder Klasse
...
| [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_Fallback](./get_fallback/)() const | Ruft das Fehlerbehandlungs-Fallback ab. |
| const [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [get_FallbackBuffer](./get_fallbackbuffer/)() const | Liefert das Fallback-Puffer. |
| virtual int [GetByteCount](./getbytecount/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, **bool**) | Ermittelt die Anzahl der Bytes, die zum Codieren eines Puffers erforderlich sind. |
| virtual int [GetByteCount](./getbytecount/)(const char_t *, int, **bool**) | Ermittelt die Anzahl der Bytes, die zum Codieren eines Puffers erforderlich sind. |
| virtual int [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, **bool**) | Ermittelt die Bytes, die aus der Codierung eines Puffers resultieren. |
| virtual int [GetBytes](./getbytes/)(const char_t *, int, **uint8_t** *, int, **bool**) | Ermittelt die Bytes, die aus der Codierung eines Puffers resultieren. |
...
| virtual void [Reset](./reset/)() | Bereinigt den internen Zustand des Encoders. |
| void [set_Fallback](./set_fallback/)(const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&) | Setzt das Fehlerbehandlungs-Fallback. |
