...
description: Ermittelt die Bytes, die durch das Codieren eines Puffers entstehen.
type: docs
weight: 53
url: /de/system.text/encoder/getbytes/
---
## Encoder::GetBytes(ArrayPtr\<char_t\>, int, int, ArrayPtr\<uint8_t\>, int, bool) Methode

Ermittelt die Bytes, die durch das Codieren eines Puffers entstehen.
...
| bytes | [ArrayPtr](../../../system/arrayptr/)\<**uint8_t**\> | Zielbytepuffer. |
