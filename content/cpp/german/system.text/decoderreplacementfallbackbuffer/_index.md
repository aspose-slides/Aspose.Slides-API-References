...
description: Puffer zum Ersetzen der Decodierungs-Fallback-Strategie.
type: docs
weight: 92
url: /de/system.text/decoderreplacementfallbackbuffer/
---
## DecoderReplacementFallbackBuffer Klasse


[Buffer](../../system/buffer/) zum Ersetzen der Decodierungs-Fallback-Strategie.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-Stil des Vergleichs von Gleitkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert gleich ist, einschließlich NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-Stil des Vergleichs von Gleitkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert gleich ist, einschließlich NaN. |
| **bool** [Fallback](./fallback/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Behandelt Decodierungsfehler. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| int [get_Remaining](./get_remaining/)() const override | Ermittelt die Anzahl verbleibender Zeichen im Puffer. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ermittelt die Referenzzähler-Datenstruktur, die dem Objekt zugeordnet ist. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog zur C# [Object.GetHashCode()](../../system/object/gethashcode/)-Methode. Ermöglicht das Hashen benutzerdefinierter Objekte. |
| char_t [GetNextChar](./getnextchar/)() override | Ermittelt das nächste verfügbare Zeichen. |
...
| **bool** [MovePrevious](./moveprevious/)() override | Bewegt zum vorherigen Zeichen. |
...
| void [Reset](./reset/)() override | Setzt den Puffer auf den Anfangszustand zurück (vor dem Aufruf von [Fallback()](./fallback/)). |
...
* Klasse [DecoderFallbackBuffer](../decoderfallbackbuffer/)
