...
| Method | Description |
| --- | --- |
| virtual void [Convert](./convert/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, **bool**, int\&, int\&, **bool**\&) | Konvertiert Zeichen in Bytes. |
| virtual void [Convert](./convert/)(const char_t *, int, **uint8_t** *, int, **bool**, int\&, int\&, **bool**\&) | Konvertiert Zeichen in Bytes. |
...
| [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_Fallback](../encoder/get_fallback/)() const | Liefert Fehlerbehandlungs-Fallback. |
| const [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [get_FallbackBuffer](../encoder/get_fallbackbuffer/)() const | Liefert Fallback-Puffer. |
| virtual int [GetByteCount](./getbytecount/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, **bool**) | Gibt die Anzahl der Bytes zurück, die zum Codieren eines Puffers benötigt werden. |
| virtual int [GetByteCount](./getbytecount/)(const char_t *, int, **bool**) | Gibt die Anzahl der Bytes zurück, die zum Codieren eines Puffers benötigt werden. |
| virtual int [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, **bool**) | Liefert die Bytes, die durch das Codieren eines Puffers entstehen. |
| virtual int [GetBytes](./getbytes/)(const char_t *, int, **uint8_t** *, int, **bool**) | Liefert die Bytes, die durch das Codieren eines Puffers entstehen. |
...
| virtual void [Reset](./reset/)() | Setzt interne Variablen auf den Ausgangszustand. |
| void [set_Fallback](../encoder/set_fallback/)(const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&) | Setzt den Fehlerbehandlungs-Fallback. |
