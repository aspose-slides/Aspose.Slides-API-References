...
description: "Puffer für eine Ausnahme-werfende Codierungs-Fallback-Strategie. Speichert eigentlich nichts, wirft stattdessen. Objekte dieser Klasse sollten nur mit der System::MakeObject()-Funktion alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs im Stack oder mit operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 157
url: /de/system.text/encoderexceptionfallbackbuffer/
---
## EncoderExceptionFallbackBuffer Klasse


[Buffer](../../system/buffer/) für eine Ausnahme-wirfende Codierungs-Fallback-Strategie. Speichert eigentlich nichts, wirft stattdessen. Objekte dieser Klasse sollten nur mit der [System::MakeObject()](../../system/makeobject/)-Funktion alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs im Stack oder mit operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| **bool** [Fallback](./fallback/)(char_t, int) override | Behandelt einen Codierungsfehler. |
| **bool** [Fallback](./fallback/)(char_t, char_t, int) override | Behandelt einen Codierungsfehler. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| int [get_Remaining](./get_remaining/)() const override | Gibt die Anzahl verbleibender Zeichen zurück. |
...
| char_t [GetNextChar](./getnextchar/)() override | Gibt das nächste verfügbare Zeichen zurück. |
...
| **bool** [MovePrevious](./moveprevious/)() override | Wechselt zum vorherigen Zeichen. |
...
| virtual void [Reset](../encoderfallbackbuffer/reset/)() | Setzt den Puffer auf den Ausgangszustand zurück. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen schwachen Zeiger (statt einen geteilten). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
