...
description: "Encoder, der ein Encoding-Objekt zur Kodierung verwendet. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 248
url: /de/system.text/encodingencoder/
---
## EncodingEncoder Klasse

[Encoder](../encoder/) die ein Kodierungsobjekt für die Kodierung verwendet. Objekte dieser Klasse sollten nur über die Funktion [System::MakeObject()](../../system/makeobject/) zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs im Stack oder mit operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/) Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_Fallback](../encoder/get_fallback/)() const | Liefert die Fehlerbehandlungs-Ausweichoption. |
| const [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [get_FallbackBuffer](../encoder/get_fallbackbuffer/)() const | Liefert den Ausweichpuffer. |
| virtual int [GetByteCount](../encoder/getbytecount/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, **bool**) | Ermittelt die Anzahl der Bytes, die zum Kodieren eines Puffers benötigt werden. |
| virtual int [GetByteCount](../encoder/getbytecount/)(const char_t *, int, **bool**) | Ermittelt die Anzahl der Bytes, die zum Kodieren eines Puffers benötigt werden. |
| virtual int [GetBytes](../encoder/getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, **bool**) | Ermittelt die Bytes, die durch die Kodierung eines Puffers entstehen. |
| virtual int [GetBytes](../encoder/getbytes/)(const char_t *, int, **uint8_t** *, int, **bool**) | Ermittelt die Bytes, die durch die Kodierung eines Puffers entstehen. |
...
| virtual void [Reset](../encoder/reset/)() | Bereinigt den internen Zustand des Encoders. |
| void [set_Fallback](../encoder/set_fallback/)(const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&) | Setzt die Fehlerbehandlungs-Ausweichoption. |
