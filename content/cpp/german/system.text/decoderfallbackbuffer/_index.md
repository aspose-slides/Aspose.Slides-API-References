...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-artigen Gleitkommavergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN keinem Wert, auch nicht NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Gleitkommavergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN keinem Wert, auch nicht NaN, gleich ist. |
| virtual **bool** [Fallback](./fallback/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Implementiert das eigentliche Fallback-Verfahren. |
...
| virtual **bool** [MovePrevious](./moveprevious/)() | Verschiebt die Pufferposition, wenn möglich, einen Schritt zurück. |
...
| virtual void [Reset](./reset/)() | Setzt den Puffer auf den Ausgangszustand zurück. |
