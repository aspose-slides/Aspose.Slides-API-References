...
description: "Kurzinfo zur Kodierung. Objekte dieser Klasse sollten nur mit der System::MakeObject()-Funktion zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse immer in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 261
url: /de/system.text/encodinginfo/
---
## EncodingInfo Klasse

Kurze Informationen zur Kodierung. Objekte dieser Klasse sollten nur mit der [System::MakeObject()](../../system/makeobject/)-Funktion zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| int [get_CodePage](./get_codepage/)() const | Liefert die Codepage-ID. |
| const [String](../../system/string/)\& [get_DisplayName](./get_displayname/)() const | Liefert den vollständig lokalisierten Kodierungsnamen. |
| const [String](../../system/string/)\& [get_Name](./get_name/)() const | Liefert den kurzen Kodierungsnamen. |
...
| [EncodingPtr](../../system/encodingptr/) [GetEncoding](./getencoding/)() | Liefert die von den Informationen beschriebene Kodierung. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n'te Template-Argument auf einen schwachen Zeiger (statt shared). Erlaubt das Umschalten von Zeigern in Containern in den Weak-Modus. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementiert und gibt die gemeinsame Referenzzählung zurück. Sollte nicht direkt aufgerufen werden; stattdessen Smart-Pointer oder ThisProtector verwenden. |
