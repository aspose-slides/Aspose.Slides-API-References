...
| [String](../../system/string/) [get_Description](./get_description/)() | Holt eine Nachricht, die die XML [Web](../../system.web/) Servicebeschreibung enthält. |
| [String](../../system/string/) [get_Name](./get_name/)() | Holt den Namen des XML [Web](../../system.web/) Dienstes. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Holt den Standard-Namespace, der für den XML [Web](../../system.web/) Dienst verwendet werden soll. |
...
| static [Object::ptr](../../system/object/ptr/) [GetCustomAttribute](../../system/attribute/getcustomattribute/)(const [TypeInfo](../../system/typeinfo/)\&, const [TypeInfo](../../system/typeinfo/)\&) | Gibt ein benutzerdefiniertes Attribut eines angegebenen Typs zurück, das dem angegebenen Typ zugeordnet ist. |
| static [ArrayPtr](../../system/arrayptr/)\<[Object::ptr](../../system/object/ptr/)\> [GetCustomAttributes](../../system/attribute/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&) | Gibt alle benutzerdefinierten Attribute zurück, die dem angegebenen Typ zugeordnet sind. |
...
| void [set_Description](./set_description/)([String](../../system/string/)) | Setzt eine Nachricht, die die XML [Web](../../system.web/) Servicebeschreibung enthält. |
| void [set_Name](./set_name/)([String](../../system/string/)) | Setzt den Namen des XML [Web](../../system.web/) Dienstes. |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Setzt den Standard-Namespace, der für den XML [Web](../../system.web/) Dienst verwendet werden soll. |
...
| Feld | Beschreibung |
| --- | --- |
| static [DefaultNamespace](./defaultnamespace/) | Der Standardwert der Eigenschaft 'Namespace'. |
