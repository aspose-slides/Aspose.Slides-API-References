...
description: Stellt einen Player der Animation dar.
type: docs
weight: 313
...
| virtual ASPOSE_SLIDES_LOCAL_API **double** [get_Duration](./get_duration/)() | Liefert Animationsdauer [ms] |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IImage](../../aspose.slides/iimage/)\> [GetFrame](./getframe/)() | Liefert das Bild für die aktuelle Zeitposition, die zuvor mit der [IPresentationAnimationPlayer::SetTimePosition](./settimeposition/)-Methode gesetzt wurde. |
...
| virtual ASPOSE_SLIDES_LOCAL_API void [SetTimePosition](./settimeposition/)(**double**) | Setzt die Animationszeitposition innerhalb des [IPresentationAnimationPlayer::get_Duration](./get_duration/). |
| int [SharedCount](../../system/object/sharedcount/)() const | Liefert aktuellen Wert des gemeinsamen Referenzzählers. |
...
Animationen, die von [PresentationAnimationsGenerator](../presentationanimationsgenerator/) über ihr **PresentationAnimationsGenerator::NewAnimation**-Ereignis erzeugt werden. 
