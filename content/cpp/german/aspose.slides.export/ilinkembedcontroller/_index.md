...
description: Callback-Schnittstelle, die verwendet wird, um zu bestimmen, wie das Objekt beim Speichern verarbeitet werden soll.
type: docs
weight: 248
...
Callback-Schnittstelle, die verwendet wird, um zu bestimmen, wie das Objekt beim Speichern verarbeitet werden soll.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-Stil von Gleitkomma-Vergleichen, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-Stil von Gleitkomma-Vergleichen, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
...
| virtual [LinkEmbedDecision](../linkembeddecision/) [GetObjectStoringLocation](./getobjectstoringlocation/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) | Bestimmt, wo das Objekt gespeichert werden soll. Diese Methode wird einmal pro Objekt-ID aufgerufen. Es ist nicht garantiert, dass nicht zwei Objekte mit denselben Daten, semanticName und contentType, aber unterschiedlicher ID existieren. |
...
| virtual void [SaveExternal](./saveexternal/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Speichert ein externes Objekt. |
