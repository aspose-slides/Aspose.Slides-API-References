...
description: "Stellt ein Blend-Muster für ein LinearGradientBrush-Objekt dar. Objekte dieser Klasse sollten nur mit der System::MakeObject()-Funktion alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 14
url: /de/system.drawing.drawing2d/blend/
---
## Blend Klasse

Stellt ein Blend-Muster für ein [LinearGradientBrush](../lineargradientbrush/)-Objekt dar. Objekte dieser Klasse sollten nur mit der [System::MakeObject()](../../system/makeobject/)-Funktion alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
|  [Blend](./blend/)() | Konstruiert eine neue Instanz der [Blend](./)-Klasse. |
|  [Blend](./blend/)(int) | Konstruiert eine neue Instanz der [Blend](./)-Klasse. |
...
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Factors](./get_factors/)() const | Gibt das Array der Blendfaktoren des Farbverlaufs zurück. |
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Positions](./get_positions/)() const | Gibt das Array der Blendpositionen des Farbverlaufs zurück. |
...
| void [set_Factors](./set_factors/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | Setzt das Array der Blendfaktoren des Farbverlaufs. |
| void [set_Positions](./set_positions/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | Setzt das Array der Blendpositionen des Farbverlaufs. |
