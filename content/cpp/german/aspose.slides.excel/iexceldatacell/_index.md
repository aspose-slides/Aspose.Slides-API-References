...
| virtual **int32_t** [get_Column](./get_column/)() | Liefert den nullbasierten Index der Spalte im Arbeitsblatt, in dem sich die Zelle befindet. Nur-Lesen **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Liefert den Namen der Diagrammdatenzelle. Nur-Lesen [System::String](../../system/string/). |
| virtual **int32_t** [get_Row](./get_row/)() | Liefert den nullbasierten Index der Zeile im Arbeitsblatt, in dem sich die Zelle befindet. Nur-Lesen **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() | Liefert den Wert, der in der [Excel](../)-Zelle enthalten ist. Nur-Lesen [System::Object](../../system/object/). |
