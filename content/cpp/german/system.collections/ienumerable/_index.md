...
description: IEnumerable ist die Basisschnittstelle für alle nicht-generischen Sammlungen, die enumerierbar sind.
type: docs
weight: 53
url: /de/system.collections/ienumerable/
---
## IEnumerable Klasse

[IEnumerable](./) ist die Basisschnittstelle für alle nicht-generischen Sammlungen, die enumerierbar sind.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | Gibt einen Enumerator zurück, der eine Sammlung durchläuft. |
