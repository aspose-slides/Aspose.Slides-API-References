...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const **bool**\&) override | Fügt den Wert am Ende des Containers hinzu. |
| [BitArrayPtr](../bitarrayptr/) [And](./and/)(const [BitArrayPtr](../bitarrayptr/)\&) | Berechnet das bitweise 'and' zwischen zwei BitSets. |
...
| [BitArray](./bitarray/)(const [bitset](./bitset/)\&) | Copy-Konstruktor. |
| [BitArray](./bitarray/)(const [BitArray](./)\&) | Copy-Konstruktor. |
| [BitArray](./bitarray/)(const [BitArrayPtr](../bitarrayptr/)\&) | Copy-Konstruktor. |
| [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**bool**\>\&) | Copy-Konstruktor. |
| [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Copy-Konstruktor. |
| [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<int\>\&) | Copy-Konstruktor. |
| [BitArray](./bitarray/)(int, **bool**) | Füllkonstruktor. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Gibt einen Iterator zurück, der das erste const-qualifizierte Element (falls vorhanden) der Sammlung zeigt. |
...
| **bool** [Contains](./contains/)(const **bool**\&) const override | Prüft, ob ein bestimmter Wert im Container vorhanden ist. Nicht implementiert. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<**bool**\>, int) override | Kopiert Daten in vorhandene Array-Elemente. |
| [bitset](./bitset/)\& [data](./data/)() | Zugriff auf die zugrunde liegende Datenstruktur. |
| const [bitset](./bitset/)\& [data](./data/)() const | Zugriff auf die zugrunde liegende Datenstruktur. |
...
| **bool** [Get](./get/)(int) const | Gibt das [BitArray](./)-Element zurück. |
| int [get_Count](./get_count/)() const override | Gibt die Größe des Containers zurück. |
...
| int [get_Length](./get_length/)() const | Gibt die Größe des Containers zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<**bool**\>\> [GetEnumerator](./getenumerator/)() override | Erstellt ein Enumerator-Objekt. |
...
| [BitArrayPtr](../bitarrayptr/) [Not](./not/)() | Negiert BitSet. |
...
| **bool** [operator!=](./operator_not_equal/)(const [BitArray](./)\&) const | Bitweiser Vergleichsoperator. |
...
| **bool** [operator==](./operator_equal_equal/)(const [BitArray](./)\&) const | Bitweiser Vergleichsoperator. |
| **Reference** [operator[]](./operator[]/)(int) | Accessor-Funktion. |
| [BitArrayPtr](../bitarrayptr/) [Or](./or/)(const [BitArrayPtr](../bitarrayptr/)\&) | Berechnet das bitweise 'or' zwischen zwei BitSets. |
...
| **bool** [Remove](./remove/)(const **bool**\&) override | Gibt das erste Vorkommen des angegebenen Werts zurück. Nicht implementiert. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verringert den gemeinsamen Referenzzähler um den angegebenen Wert. |
| void [Set](./set/)(int, **bool**) | Setzt das [BitArray](./)-Element. |
| void [SetAll](./setall/)(**bool**) | Setzt alle Elemente auf einen bestimmten Wert. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Formale Implementierung des schwachen Template-Argument-Mechanismus; nicht anwendbar auf diese Klasse. |
...
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Gibt die Implementierung des begin-const-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Gibt die Implementierung des begin-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Gibt die Implementierung des end-const-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Gibt die Implementierung des end-Iterators für den aktuellen Container zurück. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Erhöht den schwachen Referenzzähler. Sollte nicht direkt aufgerufen werden; stattdessen Smart-Pointer oder ThisProtector verwenden. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Verringert den schwachen Referenzzähler. Sollte nicht direkt aufgerufen werden; stattdessen Smart-Pointer oder ThisProtector verwenden. |
| [BitArrayPtr](../bitarrayptr/) [Xor](./xor/)(const [BitArrayPtr](../bitarrayptr/)\&) | Berechnet das bitweise 'xor' zwischen zwei BitSets. |
...
| Typedef | Description |
| --- | --- |
| [bitset](./bitset/) | Zugrunde liegender Datentyp. |
