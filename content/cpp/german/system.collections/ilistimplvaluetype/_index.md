...
description: "Stub, das die System::Collections::IList Schnittstelle auf einem System::Collections::Generic::List Objekt implementiert. Implementierung für Werttypen."
type: docs
weight: 144
url: /de/system.collections/ilistimplvaluetype/
---
## IListImplValueType Klasse

Stub, das die [System::Collections::IList](../ilist/) Schnittstelle auf einem [System::Collections::Generic::List](../../system.collections.generic/list/) Objekt implementiert. Implementierung für Werttypen.
...
| **bool** [Contains](./contains/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const override | Prüft, ob das Element in der Liste vorhanden ist. |
...
| int [get_Count](./get_count/)() const override | [ICollection.get_Count()](../icollection/get_count/) methods implementation Ermittelt die Anzahl der Elemente in der Sammlung. |
| virtual **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() const | Ermittelt einen Wert, der angibt, ob die Liste eine feste Größe hat. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(int, int) const override | Ermittelt das Element am angegebenen Index. |
|  [IListImplValueType](./ilistimplvaluetype/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) | Erstellt eine neue Objektinstanz. |
| int [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const override | Ermittelt den Index des ersten Auftretens des Elements im Container. |
...
| void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Entfernt die erste Instanz des angegebenen Elements aus der Liste. |
