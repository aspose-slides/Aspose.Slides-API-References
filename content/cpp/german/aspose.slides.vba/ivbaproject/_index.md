...
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | Zeigt an, ob das VBAProject durch ein Passwort geschützt ist, um Projekteigenschaften anzuzeigen. Nur lesbar **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) | Gibt das im VBA-Projekt enthaltene Modul am angegebenen Index zurück. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() | Gibt die Liste aller im VBA-Projekt enthaltenen Module zurück. Nur lesbar [IVbaModuleCollection](../ivbamodulecollection/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Gibt den Namen des VBA-Projekts zurück. Nur lesbar [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) | Gibt die im VBA-Projekt enthaltene Referenz am angegebenen Index zurück. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() | Gibt die Liste aller im VBA-Projekt enthaltenen Referenzen zurück. Nur lesbar [IVbaReferenceCollection](../ivbareferencecollection/). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() | Gibt die Binärdarstellung des VBA-Projekts als OLE-Container zurück. Nur lesbar **uint8_t**[]. |
