...
---
## IVbaReferenceCollection Klasse
...
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>) | Fügt die neue Referenz zur Referenzsammlung hinzu |
...
| virtual **int32_t** [get_Count](../../aspose.slides/igenericcollection/get_count/)() | Gibt die Anzahl der Verhaltensweisen in einer Sammlung zurück. Nur-Lese-**int32_t**. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Gibt einen Wert zurück, der angibt, ob der Zugriff auf die Sammlung synchronisiert (Thread-sicher) ist. Nur-Lese-**bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../../aspose.slides/igenericcollection/get_syncroot/)() | Gibt ein Synchronisations-Root zurück. Nur-Lese-[System::Object](../../system/object/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [idx_get](./idx_get/)(**int32_t**) | Liefert das Element am angegebenen Index. |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Liefert das Element an einem angegebenen Index in einer Sequenz. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Liefert das Element an einem angegebenen Index in einer Sequenz. |
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)() | Liefert das erste Element einer Sequenz. |
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)(const [Func](../../system/func/)\<T, **bool**\>\&) | Liefert das erste Element einer Sequenz, das die angegebene Bedingung erfüllt. |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Liefert das erste Element einer Sequenz oder einen Standardwert, wenn die Sequenz leer ist. |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Liefert das erste Element der Sequenz, das eine Bedingung erfüllt, oder einen Standardwert, wenn kein solches Element gefunden wird. |
...
| T [LINQ_Last](../../system.collections.generic/ienumerable/linq_last/)() | Liefert das letzte Element einer Sequenz. |
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Liefert das letzte Element einer Sequenz oder einen Standardwert, wenn die Sequenz leer ist. |
