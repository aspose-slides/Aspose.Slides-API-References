...
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Stellt den Namen der VBA-Projektreferenz dar. Lesen Sie [System::String](../../system/string/). |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Stellt den Namen der VBA-Projektreferenz dar. Schreiben Sie [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument zu einem schwachen Zeiger (statt einem geteilten). Ermöglicht das Umschalten von Zeigern in Containern in den Schwachmodus. |
