...
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestimmt, ob das angegebene [Blur](./) gleich dem aktuellen [Blur](./) ist. |
...
| **bool** [get_Grow](./get_grow/)() override | Bestimmt, ob die Begrenzungen des Objekts durch das Weichzeichnen vergrößert werden sollen. True bedeutet, dass die Begrenzungen vergrößert werden, während false bedeutet, dass dies nicht der Fall ist. Lesen **bool**. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../../aspose.slides/idomobject/)\> [get_Parent_Immediate](../../aspose.slides/idomobject/get_parent_immediate/)() | Gibt das Parent_Immediate-Objekt zurück. Nur lesend [IDOMObject](../../aspose.slides/idomobject/). |
...
| **double** [get_Radius](./get_radius/)() override | Gibt den Weichzeichnungsradius zurück. Lesen **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBlurEffectiveData](../iblureffectivedata/)\> [GetEffective](./geteffective/)() override | Erhält die wirksamen [Blur](./)-Effektdaten mit angewandter Vererbung. |
...
| void [set_Grow](./set_grow/)(**bool**) override | Bestimmt, ob die Begrenzungen des Objekts durch das Weichzeichnen vergrößert werden sollen. True bedeutet, dass die Begrenzungen vergrößert werden, während false bedeutet, dass dies nicht der Fall ist. Schreiben **bool**. |
| void [set_Radius](./set_radius/)(**double**) override | Setzt den Weichzeichnungsradius. Schreiben **double**. |
