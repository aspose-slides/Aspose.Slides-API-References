...
description: Unveränderliches Objekt, das einen Graustufen-Effekt darstellt. Konvertiert alle Farbewerte des Effekts in einen Grauton, der ihrer Luminanz entspricht. Alpha-Werte (Opazität) des Effekts bleiben unverändert.
type: docs
weight: 677
url: /de/aspose.slides.effects/igrayscaleeffectivedata/
---
## IGrayScaleEffectiveData Klasse

Unveränderliches Objekt, das einen Graustufen-Effekt darstellt. Konvertiert alle Farbwerte des Effekts in einen Grauton, der ihrer Luminanz entspricht. Alpha-Werte (Opazität) des Effekts bleiben unverändert.
