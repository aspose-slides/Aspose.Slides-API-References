...
description: Stellt einen Luminance-Effekt dar. Helligkeit verschiebt alle Farben linear näher an Weiß oder Schwarz. Kontrast skaliert alle Farben, sodass sie entweder näher beieinander oder weiter auseinander liegen.
type: docs
weight: 1028
...
Stellt einen [Luminance](./) Effekt dar. Helligkeit verschiebt alle Farben linear näher an Weiß oder Schwarz. Kontrast skaliert alle Farben, sodass sie entweder näher beieinander oder weiter auseinander liegen.
...
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestimmt, ob das angegebene [Luminance](./) gleich dem aktuellen [Luminance](./) ist. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminanceEffectiveData](../iluminanceeffectivedata/)\> [GetEffective](./geteffective/)() override | Ruft die effektiven [Luminance](./)-Effect-Daten mit angewandter Vererbung ab. |
