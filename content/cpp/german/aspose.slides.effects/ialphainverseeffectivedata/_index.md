...
description: Unveränderliches Objekt, das einen Alpha-Inverse-Effekt darstellt. Alpha (Opazitäts-)Werte werden durch Subtraktion von 100% invertiert.
type: docs
weight: 326
...
Unveränderliches Objekt, das einen Alpha-Inverse-Effekt darstellt. Alpha-(Opazitäts)-Werte werden durch Subtraktion von 100 % invertiert.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert einen C#-stilisierten Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert einen C#-stilisierten Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
