...
description: Unveränderliches Objekt, das einen Alpha-Bi-Level-Effekt darstellt. Alpha-(Opazitäts-)Werte, die kleiner als der Schwellenwert sind, werden zu 0 (vollständig transparent) geändert, und Alpha-Werte, die größer oder gleich dem Schwellenwert sind, werden zu 100 % (vollständig opak) geändert.
type: docs
weight: 248
...
Unveränderliches Objekt, das einen Alpha-Bi-Level-Effekt darstellt. Alpha-(Opazitäts-)Werte, die kleiner als der Schwellenwert sind, werden zu 0 (vollständig transparent) geändert, und Alpha-Werte, die größer oder gleich dem Schwellenwert sind, werden zu 100 % (vollständig opak) geändert.
...
| virtual **float** [get_Threshold](./get_threshold/)() | Gibt den Effekt-Schwellenwert zurück. Nur lesbarer **float**. |
