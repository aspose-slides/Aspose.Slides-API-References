...
description: Stellt einen Alpha-Modulate-Fixed-Effekt dar. Effekt-Alpha-(Opazitäts-)Werte werden mit einem festen Prozentsatz multipliziert.
type: docs
weight: 365
url: /de/aspose.slides.effects/ialphamodulatefixed/
---
## IAlphaModulateFixed Klasse


Stellt einen Alpha-Modulate-Fixed-Effekt dar. Effekt-Alpha-(Opazitäts-)Werte werden mit einem festen Prozentsatz multipliziert.
...
| virtual **float** [get_Amount](./get_amount/)() | Gibt einen Betrag des Effekts in Prozent zurück. Lesen **float**. |
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Ermittelt die effektiven Daten mit angewandter Vererbung. |
...
| virtual void [set_Amount](./set_amount/)(**float**) | Gibt einen Betrag des Effekts in Prozent zurück. Schreiben **float**. |
