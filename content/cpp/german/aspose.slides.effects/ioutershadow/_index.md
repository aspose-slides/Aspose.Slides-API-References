...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) Radius, in Punkten. Standardwert – 0 pt. Lesen **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Richtung des Schattens, in Grad. Standardwert – 0 ° (links-nach-rechts). Lesen **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Abstand des Schattens vom Objekt, in Punkten. Standardwert – 0 pt. Lesen **double**. |
| virtual [RectangleAlignment](../../aspose.slides/rectanglealignment/) [get_RectangleAlign](./get_rectanglealign/)() | Rechteckausrichtung. Standardwert – [RectangleAlignment::Bottom](../../aspose.slides/rectanglealignment/). Lesen [RectangleAlignment](../../aspose.slides/rectanglealignment/). |
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | Gibt an, ob der Schatten zusammen mit der Form rotiert. Standardwert – true. Lesen **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | Horizontaler Skalierungsfaktor, in Prozent der Originalgröße. Negative Skalierung verursacht ein Spiegeln. Standardwert – 100 %. Lesen **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | Vertikaler Skalierungsfaktor, in Prozent der Originalgröße. Negative Skalierung verursacht ein Spiegeln. Standardwert – 100 %. Lesen **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Farbe des Schattens. Standardwert – automatisches Schwarz (themenabhängig). Nur-Lese [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | Horizontaler Scherwinkel, in Grad. Standardwert – 0 °. Lesen **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | Vertikaler Scherwinkel, in Grad. Standardwert – 0 °. Lesen **double**. |
...
| virtual void [set_BlurRadius](./set_blurradius/)(**double**) | [Blur](../blur/) Radius, in Punkten. Standardwert – 0 pt. Schreiben **double**. |
| virtual void [set_Direction](./set_direction/)(**float**) | Richtung des Schattens, in Grad. Standardwert – 0 ° (links-nach-rechts). Schreiben **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Abstand des Schattens vom Objekt, in Punkten. Standardwert – 0 pt. Schreiben **double**. |
| virtual void [set_RectangleAlign](./set_rectanglealign/)([RectangleAlignment](../../aspose.slides/rectanglealignment/)) | Rechteckausrichtung. Standardwert – [RectangleAlignment::Bottom](../../aspose.slides/rectanglealignment/). Schreiben [RectangleAlignment](../../aspose.slides/rectanglealignment/). |
| virtual void [set_RotateShadowWithShape](./set_rotateshadowwithshape/)(**bool**) | Gibt an, ob der Schatten zusammen mit der Form rotiert. Standardwert – true. Schreiben **bool**. |
| virtual void [set_ScaleHorizontal](./set_scalehorizontal/)(**double**) | Horizontaler Skalierungsfaktor, in Prozent der Originalgröße. Negative Skalierung verursacht ein Spiegeln. Standardwert – 100 %. Schreiben **double**. |
| virtual void [set_ScaleVertical](./set_scalevertical/)(**double**) | Vertikaler Skalierungsfaktor, in Prozent der Originalgröße. Negative Skalierung verursacht ein Spiegeln. Standardwert – 100 %. Schreiben **double**. |
| virtual void [set_SkewHorizontal](./set_skewhorizontal/)(**double**) | Horizontaler Scherwinkel, in Grad. Standardwert – 0 °. Schreiben **double**. |
| virtual void [set_SkewVertical](./set_skewvertical/)(**double**) | Vertikaler Scherwinkel, in Grad. Standardwert – 0 °. Schreiben **double**. |
