...
description: Stellt einen Soft-Edge-Effekt dar. Die Kanten der Form sind verschwommen, während die Füllung nicht betroffen ist.
type: docs
weight: 963
...
Stellt einen Soft-Edge-Effekt dar. Die Kanten der Form sind verschwommen, während die Füllung nicht betroffen ist.
...
| virtual **double** [get_Radius](./get_radius/)() | Gibt den auf die Kanten anzuwendenden Unschärferadius an. Lesen **double**. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Gibt den auf die Kanten anzuwendenen Unschärferadius an. Schreiben **double**. |
