...
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) override | Fügt den neuen Bildeffekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevel](../ialphabilevel/)\> [AddAlphaBiLevelEffect](./addalphabileveleffect/)(**float**) override | Fügt den neuen Alpha-Bi-Level-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeiling](../ialphaceiling/)\> [AddAlphaCeilingEffect](./addalphaceilingeffect/)() override | Fügt den neuen Alpha-Ceiling-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloor](../ialphafloor/)\> [AddAlphaFloorEffect](./addalphaflooreffect/)() override | Fügt den neuen Alpha-Floor-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverse](../ialphainverse/)\> [AddAlphaInverseEffect](./addalphainverseeffect/)() override | Fügt den neuen Alpha-Inverse-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulate](../ialphamodulate/)\> [AddAlphaModulateEffect](./addalphamodulateeffect/)() override | Fügt den neuen Alpha-Modulate-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixed](../ialphamodulatefixed/)\> [AddAlphaModulateFixedEffect](./addalphamodulatefixedeffect/)(**float**) override | Fügt den neuen Alpha-Modulate-Fixed-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplace](../ialphareplace/)\> [AddAlphaReplaceEffect](./addalphareplaceeffect/)(**float**) override | Fügt den neuen Alpha-Replace-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevel](../ibilevel/)\> [AddBiLevelEffect](./addbileveleffect/)(**float**) override | Fügt den neuen Bi-Level-(schwarz/weiß)-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlur](../iblur/)\> [AddBlurEffect](./addblureffect/)(**double**, **bool**) override | Fügt den neuen [Blur](../blur/)-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBrightnessContrast](../ibrightnesscontrast/)\> [AddBrightnessContrastEffect](./addbrightnesscontrasteffect/)(**float**, **float**) override | Fügt den neuen [BrightnessContrast](../brightnesscontrast/)-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorChange](../icolorchange/)\> [AddColorChangeEffect](./addcolorchangeeffect/)() override | Fügt den neuen Color Change-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplace](../icolorreplace/)\> [AddColorReplaceEffect](./addcolorreplaceeffect/)() override | Fügt den neuen Color Replacement-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotone](../iduotone/)\> [AddDuotoneEffect](./addduotoneeffect/)() override | Fügt den neuen [Duotone](../duotone/)-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlay](../ifilloverlay/)\> [AddFillOverlayEffect](./addfilloverlayeffect/)() override | Fügt den neuen Fill Overlay-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGrayScale](../igrayscale/)\> [AddGrayScaleEffect](./addgrayscaleeffect/)() override | Fügt den neuen Gray Scale-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHSL](../ihsl/)\> [AddHSLEffect](./addhsleffect/)(**float**, **float**, **float**) override | Fügt den neuen Hue/Saturation/Luminance-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminance](../iluminance/)\> [AddLuminanceEffect](./addluminanceeffect/)(**float**, **float**) override | Fügt den neuen [Luminance](../luminance/)-Effekt am Ende einer Sammlung hinzu. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITint](../itint/)\> [AddTintEffect](./addtinteffect/)(**float**, **float**) override | Fügt den neuen [Tint](../tint/)-Effekt am Ende einer Sammlung hinzu. |
...
| void [Clear](./clear/)() override | Entfernt alle Bildeffekte aus einer Sammlung. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) const override | Bestimmt, ob [ICollection](../../system.collections.generic/icollection/) einen bestimmten Wert enthält. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\>, **int32_t**) override | Kopiert die Elemente von [ICollection](../../system.collections.generic/icollection/) in ein [System::Array](../../system/array/), beginnend bei einem bestimmten [System::Array](../../system/array/)-Index. |
...
| **int32_t** [get_Count](./get_count/)() const override | Gibt die Anzahl der Bildeffekte in einer Sammlung zurück. Nur-Lese **int32_t**. |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../../aspose.slides/idomobject/)\> [get_Parent_Immediate](../../aspose.slides/idomobject/get_parent_immediate/)() | Gibt das Parent_Immediate-Objekt zurück. Nur-Lese [IDOMObject](../../aspose.slides/idomobject/). |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gibt die Referenz-Zähler-Datenstruktur zurück, die mit dem Objekt verknüpft ist. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der durch die Sammlung iteriert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\> [idx_get](./idx_get/)(**int32_t**) override | Gibt ein [ImageTransformOperation](../imagetransformoperation/) aus der Sammlung anhand seines Index zurück. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) override | Entfernt das erste Vorkommen eines bestimmten Objekts aus dem [ICollection](../../system.collections.generic/icollection/). |
| void [RemoveAt](./removeat/)(**int32_t**) override | Entfernt einen Bildeffekt aus einer Sammlung am angegebenen Index. |
