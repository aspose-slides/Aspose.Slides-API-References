...
description: Stellt einen Alpha Modulate Fixed-Effekt dar. Die Alpha-Werte (Opazität) des Effekts werden mit einem festen Prozentsatz multipliziert.
type: docs
weight: 66
...
Stellt einen Alpha Modulate Fixed-Effekt dar. Alpha-Werte (Opazität) des Effekts werden mit einem festen Prozentsatz multipliziert.
...
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bestimmt, ob das angegebene [AlphaModulateFixed](./) dem aktuellen [AlphaModulateFixed](./) entspricht. |
...
| **float** [get_Amount](./get_amount/)() override | Gibt einen Betrag des Effekts in Prozent zurück. Lese **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | Ermittelt effektive Alpha Modulate Fixed-Effektdaten mit angewandter Vererbung. |
...
| void [set_Amount](./set_amount/)(**float**) override | Gibt einen Betrag des Effekts in Prozent zurück. Schreibe **float**. |
...
* Klasse [IAlphaModulateFixed](../ialphamodulatefixed/)
