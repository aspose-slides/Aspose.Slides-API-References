...
description: Stellt einen Alpha Ceiling-Effekt dar. Alpha (Opazität)-Werte, die größer als Null sind, werden auf 100 % geändert. Mit anderen Worten wird alles, das teilweise undurchsichtig ist, vollständig undurchsichtig.
type: docs
weight: 261
...
Stellt einen Alpha Ceiling-Effekt dar. Alpha- (Opazitäts-) Werte, die größer als Null sind, werden auf 100 % geändert. Mit anderen Worten wird alles, das teilweise undurchsichtig ist, vollständig undurchsichtig.
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Erhält die wirksamen Daten mit angewandter Vererbung. |
