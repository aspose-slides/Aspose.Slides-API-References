...
description: Unveränderliches Objekt, das einen Glow-Effekt darstellt, bei dem ein farblich verschwommener Umriss außerhalb der Kanten des Objekts hinzugefügt wird.
type: docs
weight: 651
...
Unveränderliches Objekt, das einen [Glow](../glow/)-Effekt darstellt, bei dem ein farblich verschwommener Umriss außerhalb der Kanten des Objekts hinzugefügt wird.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Farbe. Nur lesbar [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_Radius](./get_radius/)() | Radius. Nur lesbar **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Ruft die dem Objekt zugehörige Referenzzähler-Datenstruktur ab. |
