...
description: Unveränderliches Objekt, das einen Alpha Floor-Effekt darstellt. Alpha (Deckkraft) Werte unter 100% werden auf null gesetzt. Mit anderen Worten wird alles, das teilweise transparent ist, vollständig transparent.
type: docs
weight: 300
...
Unveränderliches Objekt, das einen Alpha-Floor-Effekt darstellt. Alpha (Deckkraft) Werte unter 100 % werden auf null gesetzt. Mit anderen Worten wird alles, was teilweise transparent ist, vollständig transparent.
