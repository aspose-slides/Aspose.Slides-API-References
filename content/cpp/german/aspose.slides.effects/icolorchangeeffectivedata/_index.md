...
description: Unveränderliches Objekt, das einen Farbwechsel-Effekt darstellt. Instanzen von FromColor werden durch Instanzen von ToColor ersetzt.
type: docs
weight: 521
...
Unveränderliches Objekt, das einen Farbwechsel-Effekt darstellt. Instanzen von FromColor werden durch Instanzen von ToColor ersetzt.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_FromColor](./get_fromcolor/)() | Farbe, die ersetzt wird. Schreibgeschützt [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ToColor](./get_tocolor/)() | Farbe, die ersetzen wird. Schreibgeschützt [System::Drawing::Color](../../system.drawing/color/). |
| virtual **bool** [get_UseAlpha](./get_usealpha/)() | Gibt einen booleschen Wert zurück, der bestimmt, ob die Alpha-Komponente verwendet werden soll. Schreibgeschützt **bool**. |
...
| void [Lock](../../system/object/lock/)() | Implementiert das C#-lock()-Statement für das Sperren. Direkt aufrufen oder das Sentry-Objekt [LockContext](../../system/lockcontext/) verwenden. |
