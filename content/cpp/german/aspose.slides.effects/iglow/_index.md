...
description: Stellt einen Glow-Effekt dar, bei dem ein farblich unscharfer Umriss außerhalb der Kanten des Objekts hinzugefügt wird.
type: docs
weight: 638
...
Stellt einen [Glow](../glow/)-Effekt dar, bei dem ein farblich unscharfer Umriss außerhalb der Kanten des Objekts hinzugefügt wird.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | Farbformat. Nur lesbar [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual **double** [get_Radius](./get_radius/)() | Radius. Lesen **double**. |
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Liefert die effektiven Daten mit angewandter Vererbung. |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren der C#-Anweisung lock(). Direkter Aufruf oder Nutzung des [LockContext](../../system/lockcontext/)-Wächterobjekts. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Radius. Schreiben **double**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren der C#-Anweisung lock(). Direkter Aufruf oder Nutzung des [LockContext](../../system/lockcontext/)-Wächterobjekts. |
