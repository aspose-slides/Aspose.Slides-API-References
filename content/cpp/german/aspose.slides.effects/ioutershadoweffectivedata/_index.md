...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-artigen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich betrachtet werden, obwohl NaN gemäß IEC 60559:1989 zu keinem Wert, auch nicht zu NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich betrachtet werden, obwohl NaN gemäß IEC 60559:1989 zu keinem Wert, auch nicht zu NaN, gleich ist. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) Radius. Nur lesbar **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Richtung des Schattens. Nur lesbar **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Abstand des Schattens. Nur lesbar **double**. |
...
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | Gibt an, ob der Schatten mit der Form rotiert werden soll, wenn die Form rotiert ist. Nur lesbar **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | Gibt den horizontalen Skalierungsfaktor an; negative Skalierung führt zu einer Spiegelung. Nur lesbar **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | Gibt den vertikalen Skalierungsfaktor an; negative Skalierung führt zu einer Spiegelung. Nur lesbar **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Farbe des Schattens. Nur lesbar [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | Gibt den horizontalen Schrägwinkel (in Grad) an. Nur lesbar **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | Gibt den vertikalen Schrägwinkel (in Grad) an. Nur lesbar **double**. |
