...
description: Unveränderliches Objekt, das einen weichen Kanteneffekt darstellt. Die Kanten der Form sind unscharf, während die Füllung nicht beeinflusst wird.
type: docs
weight: 976
...
Unveränderbares Objekt, das einen weichen Kanteneffekt darstellt. Die Kanten der Form sind unscharf, während die Füllung nicht beeinflusst wird.
...
| virtual **double** [get_Radius](./get_radius/)() | Gibt den Radius der Unschärfe an, der auf die Kanten angewendet wird. Nur-Lese **double**. |
