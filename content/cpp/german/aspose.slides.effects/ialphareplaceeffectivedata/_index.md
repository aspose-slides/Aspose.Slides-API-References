...
description: Unveränderliches Objekt, das einen Alpha-Replace-Effekt darstellt. Effekt-Alpha-(Opazitäts-)Werte werden durch ein festes Alpha ersetzt.
type: docs
weight: 404
url: /de/aspose.slides.effects/ialphareplaceeffectivedata/
---
## IAlphaReplaceEffectiveData Klasse

Unveränderliches Objekt, das einen Alpha-Replace-Effekt darstellt. Effekt-Alpha-(Opazitäts-)Werte werden durch ein festes Alpha ersetzt.
...
| virtual **float** [get_Alpha](./get_alpha/)() | Gibt den neuen Alpha-Wert im Intervall [0..1] zurück. Nur lesbarer **float**. |
