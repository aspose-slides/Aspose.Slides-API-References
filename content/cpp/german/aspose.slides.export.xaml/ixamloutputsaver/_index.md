...
description: Stellt eine Implementierung eines Ausgabespeichers zum Übertragen von Daten in den externen Speicher dar.
type: docs
weight: 14
url: /de/aspose.slides.export.xaml/ixamloutputsaver/
---
## IXamlOutputSaver Klasse

Stellt eine Implementierung eines Ausgabespeichers zum Übertragen von Daten in den externen Speicher dar.
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Speichert ein Byte-Array an einem Zielort. |
