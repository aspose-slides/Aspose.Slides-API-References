...
description: "Abstrakte Sammlung von Elementen mit eingebetteten Schlüsseln. Objekte dieser Klasse sollten nur mithilfe der System::MakeObject()-Funktion alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs im Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 14
url: /de/system.collections.objectmodel/keyedcollection/
---
## KeyedCollection Klasse

Abstrakte Sammlung von Elementen mit eingebetteten Schlüsseln. Objekte dieser Klasse sollten ausschließlich mit der [System::MakeObject()](../../system/makeobject/)-Funktion alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs im Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse stets in einen [System::SmartPtr](../../system/smartptr/)-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
| void [Add](./add/)(const TItem\&) override | Fügt ein Element am Ende des Containers hinzu. |
...
| void [Clear](../collection/clear/)() override | Löscht alle Elemente. |
|  [Collection](../collection/collection/)() | Erstellt eine leere Sammlung. |
|  [Collection](../collection/collection/)([SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) |  |
| **bool** [Contains](./contains/)(TKey) | Prüft, ob der Schlüssel im Container vorhanden ist. |
| **bool** [Contains](../collection/contains/)(const T\&) const override | Prüft, ob das Element in der Sammlung vorhanden ist. |
| void [CopyTo](../collection/copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Kopiert Sammlungs-Elemente in vorhandene Array-Elemente. |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [crbegin](../collection/crbegin/)() const | Gibt einen Reverse-Iterator zum letzten const-qualifizierten Element der Sammlung zurück (erstes im Reverse). |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [crend](../collection/crend/)() const | Gibt einen Reverse-Iterator für ein nicht vorhandenes const-qualifiziertes Element vor dem Beginn der Sammlung zurück. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEqualityComparer](../../system.collections.generic/iequalitycomparer/)\<TKey\>\> [get_Comparer](./get_comparer/)() | Gibt den Vergleicher zurück. |
| int [get_Count](../collection/get_count/)() const override | Gibt die Anzahl der Elemente zurück. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](../collection/get_items/)() | Zugriff auf die interne Datenstruktur. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](../collection/get_items/)() const | Zugriff auf die interne Datenstruktur. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../collection/getenumerator/)() override | Gibt einen Enumerator zurück, um die Sammlung zu iterieren. |
...
| TItem [idx_get](./idx_get/)(TKey) | Gibt das Element an einem bestimmten Index zurück. |
| T [idx_get](../collection/idx_get/)(int) const override | Gibt den Wert am angegebenen Index zurück. |
| void [idx_set](../collection/idx_set/)(int, T) override | Setzt den Wert am angegebenen Index. |
| int [IndexOf](../collection/indexof/)(const T\&) const override | Sucht ein Element in der Sammlung. |
| void [Insert](../collection/insert/)(int, const T\&) override | Fügt das Element an der angegebenen Position ein. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft eine Transformationsfunktion für jedes Element einer generischen Sequenz auf und gibt den maximal entstehenden Wert zurück. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Ruft eine Transformationsfunktion für jedes Element einer generischen Sequenz auf und gibt den minimal entstehenden Wert zurück. |
...
| T\& [operator[]](../collection/operator[]/)(int) | Gibt den Wert am angegebenen Index zurück. |
| const T\& [operator[]](../collection/operator[]/)(int) const | Gibt den Wert am angegebenen Index zurück. |
| [reverse_iterator](../collection/reverse_iterator/) [rbegin](../collection/rbegin/)() | Gibt einen Reverse-Iterator zum letzten Element der Sammlung zurück (erstes im Reverse). |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [rbegin](../collection/rbegin/)() const | Gibt einen Reverse-Iterator zum letzten Element der const-qualifizierten Sammlung zurück (erstes im Reverse). |
...
| **bool** [Remove](./remove/)(TKey) | Entfernt den Schlüssel aus dem Container. |
| **bool** [Remove](../collection/remove/)(const T\&) override | Entfernt ein bestimmtes Element. |
| void [RemoveAt](../collection/removeat/)(int) override | Entfernt das Element an einer bestimmten Position. |
...
| [reverse_iterator](../collection/reverse_iterator/) [rend](../collection/rend/)() | Gibt einen Reverse-Iterator für ein nicht vorhandenes Element vor dem Beginn der Sammlung zurück. |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [rend](../collection/rend/)() const | Gibt einen Reverse-Iterator für ein nicht vorhandenes Element vor dem Beginn der const-qualifizierten Sammlung zurück. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Bewirkt, dass ein spezifisches Template-Argument als Weak-Pointer anstelle eines Shared-Pointers behandelt wird (falls zutreffend). |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../collection/virtualizebeginconstiterator/)() const override | Gibt die Implementierung des begin const-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginIterator](../collection/virtualizebeginiterator/)() override | Gibt die Implementierung des begin-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../collection/virtualizeendconstiterator/)() const override | Gibt die Implementierung des end const-Iterators für den aktuellen Container zurück. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](../collection/virtualizeenditerator/)() override | Gibt die Implementierung des end-Iterators für den aktuellen Container zurück. |
...
| Feld | Beschreibung |
| --- | --- |
| static [defaultThreshold](./defaultthreshold/) | Schwellwert für die Erstellung des Lookup-Wörterbuchs, Standard. |

## Siehe auch

* Klasse [Collection](../collection/)
* Namensraum [System::Collections::ObjectModel](../)
