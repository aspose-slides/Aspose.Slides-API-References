...
description: "Basistyp für generische Sammlungen. Objekte dieser Klasse sollten nur über die System::MakeObject()-Funktion zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit operator new, da dies zu Laufzeitfehlern und/oder Assertionsfehlern führt. Wickeln Sie diese Klasse immer in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 1
url: /de/system.collections.objectmodel/collection/
---
## Sammlungsklasse
...
| --- | --- |
| void [Add](./add/)(const T&) override | Fügt einen Wert zum Container hinzu. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Gibt einen Iterator zurück, der unmittelbar nach dem letzten const-qualifizierten Element (falls vorhanden) der Sammlung zeigt. |
...
| **bool** [Contains](./contains/)(const T&) const override | Überprüft, ob ein Element in der Sammlung vorhanden ist. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Kopiert die Sammlungs-Elemente in vorhandene Array-Elemente. |
| [const_reverse_iterator](./const_reverse_iterator/) [crbegin](./crbegin/)() const | Gibt einen Reverse-Iterator zum letzten const-qualifizierten Element der Sammlung zurück (erstes im Reverse). |
| [const_reverse_iterator](./const_reverse_iterator/) [crend](./crend/)() const | Gibt einen Reverse-Iterator für ein nicht-existierendes const-qualifiziertes Element vor dem Start der Sammlung zurück. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Gibt einen Iterator zurück, der unmittelbar nach dem letzten Element (falls vorhanden) der Sammlung zeigt. Dieser Iterator kann nicht verwendet werden, um ein referenziertes Objekt zu ändern, weil [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) ein Kopie-Objekt von T zurückgibt. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Gibt einen Iterator zurück, der unmittelbar nach dem letzten Element (falls vorhanden) der const-qualifizierten Instanz der Sammlung zeigt. |
...
| int [get_Count](./get_count/)() const override | Gibt die Anzahl der Elemente zurück. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Überprüft, ob die Sammlung eine feste Größe hat. |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | Überprüft, ob die Sammlung schreibgeschützt ist. |
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](./get_items/)() | Zugriff auf interne Datenstruktur. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](./get_items/)() const | Zugriff auf interne Datenstruktur. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, um durch die Sammlung zu iterieren. |
...
| T [idx_get](./idx_get/)(int) const override | Liefert den Wert am angegebenen Index. |
| void [idx_set](./idx_set/)(int, T) override | Setzt den Wert am angegebenen Index. |
| int [IndexOf](./indexof/)(const T&) const override | Sucht ein Element in der Sammlung. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Berechnet den Durchschnitt einer Sequenz von Werten, die durch Aufrufen einer Transform-Funktion für jedes Element der Eingabesequenz erhalten werden. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Wendet eine Transform-Funktion auf jedes Element einer generischen Sequenz an und gibt den maximalen resultierenden Wert zurück. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Wendet eine Transform-Funktion auf jedes Element einer generischen Sequenz an und gibt den minimalen resultierenden Wert zurück. |
...
| T\& [operator[]](./operator[]/)(int) | Liefert den Wert am angegebenen Index. |
| const T\& [operator[]](./operator[]/)(int) const | Liefert den Wert am angegebenen Index. |
| [reverse_iterator](./reverse_iterator/) [rbegin](./rbegin/)() | Gibt einen Reverse-Iterator zum letzten Element der Sammlung zurück (erstes im Reverse). |
| [const_reverse_iterator](./const_reverse_iterator/) [rbegin](./rbegin/)() const | Gibt einen Reverse-Iterator zum letzten Element der const-qualifizierten Sammlung zurück (erstes im Reverse). |
...
| **bool** [Remove](./remove/)(const T&) override | Entfernt ein bestimmtes Element. |
| void [RemoveAt](./removeat/)(int) override | Entfernt ein Element an einer bestimmten Position. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verringert den gemeinsamen Referenzzähler um den angegebenen Wert. |
| [reverse_iterator](./reverse_iterator/) [rend](./rend/)() | Gibt einen Reverse-Iterator für ein nicht-existierendes Element vor dem Start der Sammlung zurück. |
| [const_reverse_iterator](./const_reverse_iterator/) [rend](./rend/)() const | Gibt einen Reverse-Iterator für ein nicht-existierendes Element vor dem Start der const-qualifizierten Sammlung zurück. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Macht gespeicherte Zeiger schwach (falls zutreffend). |
