...
description: "Konvertiert die CryptoStream-Klasseninstanz aus Base64. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies Laufzeitfehler und/oder Assertion-Fehler zur Folge hat. Wickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 209
url: /de/system.security.cryptography/frombase64transform/
---
## FromBase64Transform Klasse

Wandelt die Instanz der [CryptoStream](../cryptostream/) Klasse aus Base64 um. Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies Laufzeitfehler und/oder Assertion-Fehler zur Folge hat. Wickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/) Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
| void [Clear](./clear/)() | Gibt alle Ressourcen frei. |
| void [Dispose](./dispose/)() | Gibt vom aktuellen Objekt erworbene Betriebssystemressourcen frei. |
...
| virtual **bool** [get_CanReuseTransform](./get_canreusetransform/)() | Ermittelt einen Wert, der angibt, ob die aktuelle Transformation wiederverwendet werden kann. |
| **bool** [get_CanTransformMultipleBlocks](./get_cantransformmultipleblocks/)() | Ermittelt einen Wert, der angibt, ob mehrere Blöcke transformiert werden können. |
| virtual **int32_t** [get_InputBlockSize](./get_inputblocksize/)() | Größe des Eingabeblocks. |
| virtual **int32_t** [get_OutputBlockSize](./get_outputblocksize/)() | Größe des Ausgabeblocks. |
...
| virtual int [TransformBlock](../icryptotransform/transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Verarbeitet einen Datenblock und kopiert die Daten in das Ausgabearray. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](../icryptotransform/transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Verarbeitet den letzten Datenblock und berechnet den Ausgabewert. |
