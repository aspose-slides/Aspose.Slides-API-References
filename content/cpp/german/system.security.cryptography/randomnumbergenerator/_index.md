...
description: "Abstrakte Klasse, von der Zufallszahlengeneratoren erben. Objekte dieser Klasse sollten ausschließlich über die Funktion System::MakeObject() zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Verpacken Sie diese Klasse stets in einen System::SmartPtr-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 352
url: /de/system.security.cryptography/randomnumbergenerator/
---
## RandomNumberGenerator Klasse

Abstrakte Klasse für Zufallszahlengeneratoren, von der erbt wird. Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) zugewiesen werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Umwickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/) Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[RandomNumberGenerator](./)\> [Create](./create/)() | Erstellt eine Instanz der Standardimplementierung eines kryptografischen Zufallszahlengenerators, der zum Erzeugen zufälliger Daten verwendet werden kann. Nicht implementiert. |
...
| virtual void [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Füllt vorhandene Array-Elemente mit zufälligen Bytes. |
| virtual void [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Füllt ein vorhandenes Array-Segment mit zufälligen Bytes. |
| virtual void [GetBytes](./getbytes/)(System::Details::ArrayView\<**uint8_t**\>) | Füllt vorhandene Array-View-Elemente mit zufälligen Bytes. |
| virtual void [GetBytes](./getbytes/)(System::Details::ArrayView\<**uint8_t**\>, int, int) | Füllt ein vorhandenes Array-View-Segment mit zufälligen Bytes. |
| void [GetBytes](./getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | Füllt vorhandene Stack-Array-Elemente mit zufälligen Bytes. |
| void [GetBytes](./getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&, int, int) | Füllt ein vorhandenes Stack-Array-Segment mit zufälligen Bytes. |
...
| virtual void [GetNonZeroBytes](./getnonzerobytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Füllt vorhandene Array-Elemente mit zufälligen, von Null verschiedenen Bytes. |
| virtual void [GetNonZeroBytes](./getnonzerobytes/)(System::Details::ArrayView\<**uint8_t**\>) | Füllt vorhandene Array-View-Elemente mit zufälligen, von Null verschiedenen Bytes. |
| void [GetNonZeroBytes](./getnonzerobytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | Füllt vorhandene Stack-Array-Elemente mit zufälligen, von Null verschiedenen Bytes. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument zu einem schwachen Zeiger (anstatt zu einem geteilten). Ermöglicht das Umschalten von Zeigern in Containern in den schwachen Modus. |
