...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Erzeugt den Hash für einen Pufferabschnitt. |
...
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](./)\> [Create](./create/)() | Erstellt eine Instanz des Hash-Algorithmus. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Erstellt eine Instanz des Hash-Algorithmus. |
...
| virtual int [get_HashSize](../hashalgorithm/get_hashsize/)() | Gibt die Größe des berechneten Hash-Werts in Byte zurück. |
