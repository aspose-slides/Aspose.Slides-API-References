...
description: "Datenstruktur der DSA-Algorithmus-Parameter. Dieser Typ sollte auf dem Stack zugewiesen und zu Funktionen per Wert oder per Referenz übergeben werden. Verwenden Sie niemals die System::SmartPtr-Klasse, um Objekte dieses Typs zu verwalten."
type: docs
weight: 703
url: /de/system.security.cryptography/dsaparameters/
---
## DSAParameters Struktur


[Data](../../system.data/) Struktur der [DSA](../dsa/) Algorithmusparameter. Dieser Typ sollte auf dem Stack zugewiesen und zu Funktionen per Wert oder per Referenz übergeben werden. Verwenden Sie niemals die [System::SmartPtr](../../system/smartptr/) Klasse, um Objekte dieses Typs zu verwalten.
