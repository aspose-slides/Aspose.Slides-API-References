...
| virtual **bool** [get_CanReuseTransform](./get_canreusetransform/)() | Ermittelt einen Wert, der anzeigt, ob die aktuelle Transformation wiederverwendet werden kann. |
| **bool** [get_CanTransformMultipleBlocks](./get_cantransformmultipleblocks/)() | Ermittelt einen Wert, der anzeigt, ob mehrere Blöcke transformiert werden können. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierkonstruktor. Kopiert tatsächlich nichts, sondern initialisiert nur das neue Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Zuweisungsoperator. Kopiert tatsächlich nichts, sondern initialisiert nur das neue Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
...
| **int32_t** [TransformBlock](./transformblock/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**) | Verarbeitet einen Datenblock und kopiert die Daten in ein Ausgabearray. |
| virtual int [TransformBlock](../icryptotransform/transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Verarbeitet einen Datenblock und kopiert die Daten in ein Ausgabearray. |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](./transformfinalblock/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | Verarbeitet den letzten Datenblock und berechnet den Ausgabewert. |
