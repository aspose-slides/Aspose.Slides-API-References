...
description: "Datenstruktur der RSA-Algorithmus-Parameter. Dieser Typ sollte auf dem Stack zugewiesen und Funktionen per Wert oder Referenz übergeben werden. Verwenden Sie niemals die System::SmartPtr-Klasse, um Objekte dieses Typs zu verwalten."
type: docs
weight: 768
url: /de/system.security.cryptography/rsaparameters/
---
## RSAParameters Struktur


[Data](../../system.data/) Struktur von [RSA](../rsa/) Algorithmusparametern. Dieser Typ sollte auf dem Stack zugewiesen und Funktionen per Wert oder Referenz übergeben werden. Verwenden Sie niemals die [System::SmartPtr](../../system/smartptr/) Klasse, um Objekte dieses Typs zu verwalten.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopierekonstruktor. Kopiert tatsächlich nichts, sondern initialisiert nur ein neues Objekt und ermöglicht das Kopierkonstrukt von Unterklassen. |
