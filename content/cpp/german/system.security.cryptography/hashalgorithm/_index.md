...
| --- | --- |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Hasht den Puffer. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Hasht einen Pufferabschnitt. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)([SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> const\&) | Liest den Stream bis zum Ende und berechnet den Hash für die gelesenen Daten. |
| static [SharedPtr](../../system/sharedptr/)\<[HashAlgorithm](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Erstellt einen Hash-Algorithmus basierend auf dem Namen. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Hash](./get_hash/)() | Gibt den Wert des berechneten Hash-Codes zurück. |
| virtual int [get_HashSize](./get_hashsize/)() | Gibt die Größe des berechneten Hash-Werts in Bytes zurück. |
| int [get_InputBlockSize](./get_inputblocksize/)() override | Eingabe-Blockgröße. |
| int [get_OutputBlockSize](./get_outputblocksize/)() override | Ausgabe-Blockgröße. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gibt die Datenstruktur des Referenzzählers zurück, die mit dem Objekt verknüpft ist. |
...
| virtual void [Initialize](./initialize/)() | Setzt den Hasher in den Ausgangszustand zurück. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog zur C# [Object.ToString()](../../system/object/tostring/)-Methode. Ermöglicht das Konvertieren benutzerdefinierter Objekte zu Zeichenketten. |
| int [TransformBlock](./transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Verarbeitet einen Datenblock und kopiert die Daten in das Ausgabearray. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](./transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) override | Verarbeitet den letzten Datenblock und berechnet den Hash. |
