...
type: docs
weight: 118
url: /de/system.security.cryptography/details_cryptographicunexpectedoperationexception/
---
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Setzt das HRESULT, einen codierten numerischen Wert, der einer bestimmten Ausnahme zugeordnet wird. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die [what()](../../system/details_exception/what/)-Methode, die von der [ExceptionWrapper](../../system/exceptionwrapper/)-Klasse aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/privat-Member nutzen, um ihre Logik zu implementieren. Das Verschieben dieser Methodenumsetzung in das [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik beschädigen. |
