...
type: docs
weight: 105
url: /de/system.security.cryptography/details_cryptographicexception/
---
## Details_CryptographicException Klasse
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die [what()](../../system/details_exception/what/)-Methode, die von der [ExceptionWrapper](../../system/exceptionwrapper/)-Klasse aufgerufen wird. Trotz der Tatsache, dass diese Klasse nicht von std::exception erbt, können abgeleitete Klassen geschützte/privatre Member verwenden, um ihre Logik zu implementieren. Das Verschieben dieser Methodenimplementierung in das [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik brechen. |
