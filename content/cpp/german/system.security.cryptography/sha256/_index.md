...
description: "Berechnet den SHA256-Hash für Eingabedaten. In C++ ist SHA256 keine abstrakte Klasse. Objekte dieser Klasse sollten nur über die Funktion System::MakeObject() alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs im Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse immer in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 573
url: /de/system.security.cryptography/sha256/
---
## SHA256 Klasse

Berechnet den [SHA256](./)-Hash für Eingabedaten. In C++ ist [SHA256](./) keine abstrakte Klasse. Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs im Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Umwickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Hashiert den Puffer. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Hashiert einen Pufferabschnitt. |
...
| static [SharedPtr](../../system/sharedptr/)\<[SHA256](./)\> [Create](./create/)() | Erstellt eine Instanz des Hash-Algorithmus. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA256](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Erstellt eine Instanz des Hash-Algorithmus. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Hash](../hashalgorithm/get_hash/)() | Gibt den Wert des berechneten Hash-Codes zurück. |
| virtual int [get_HashSize](../hashalgorithm/get_hashsize/)() | Gibt die Größe des berechneten Hash-Werts in Bytes zurück. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen schwachen Zeiger (statt auf einen geteilten). Ermöglicht das Umschalten von Zeigern in Containern auf den schwachen Modus. |
