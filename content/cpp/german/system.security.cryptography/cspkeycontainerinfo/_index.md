...
description: Zusätzliche Informationen zu einem kryptografischen Schlüsselpaar.
type: docs
weight: 66
url: /de/system.security.cryptography/cspkeycontainerinfo/
---
## CspKeyContainerInfo Klasse

Zusätzliche Informationen zu einem kryptografischen Schlüsselpaar.
...
| **bool** [get_Accessible](./get_accessible/)() const | Liefert ein Flag, das angibt, ob ein Schlüssel im Container zugänglich ist. |
| **bool** [get_Exportable](./get_exportable/)() const | Liefert ein Flag, das angibt, ob ein Schlüssel aus einem Container exportiert werden kann. |
| **bool** [get_HardwareDevice](./get_hardwaredevice/)() const | Liefert ein Flag, das angibt, ob ein Schlüssel ein Hardware-Schlüssel ist. |
| [String](../../system/string/) [get_KeyContainerName](./get_keycontainername/)() const | Liefert den Namen des Schlüsselcontainers. |
| [SharedPtr](../../system/sharedptr/)\<[KeyNumber](../keynumber/)\> [get_KeyNumber](./get_keynumber/)() const | Liefert ein KeyNumber-Objekt. |
| **bool** [get_MachineKeyStore](./get_machinekeystore/)() const | Liefert ein Flag, das angibt, ob ein Schlüssel aus dem Maschinen-Schlüsselspeicher geladen wurde. |
| **bool** [get_Protected](./get_protected/)() const | Liefert ein Flag, das angibt, ob ein Schlüssel vor Kopieren geschützt ist. |
| [String](../../system/string/) [get_ProviderName](./get_providername/)() const | Liefert den Anbieternamen. |
| **int32_t** [get_ProviderType](./get_providertype/)() const | Liefert den Anbietertyp. |
| **bool** [get_RandomlyGenerated](./get_randomlygenerated/)() const | Liefert ein Flag, das angibt, ob ein Schlüssel zufällig erzeugt wurde. |
| **bool** [get_Removable](./get_removable/)() const | Liefert ein Flag, das angibt, ob ein Schlüssel aus einem Container entfernt werden kann. |
| [String](../../system/string/) [get_UniqueKeyContainerName](./get_uniquekeycontainername/)() const | Liefert einen eindeutigen Containernamen. |
