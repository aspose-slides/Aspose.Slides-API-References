...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Hasht einen Teil des Puffers. |
...
| static [SharedPtr](../../system/sharedptr/)\<[SHA1](../sha1/)\> [Create](../sha1/create/)() | Erzeugt eine Instanz des Hash-Algorithmus. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA1](../sha1/)\> [Create](../sha1/create/)(const [String](../../system/string/)\&) | Erzeugt eine Instanz des Hash-Algorithmus. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog zur C#-Methode [Object.GetHashCode()](../../system/object/gethashcode/). Ermöglicht das Hash-en benutzerdefinierter Objekte. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen schwachen Zeiger (statt einem geteilten). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
|  [SHA1CryptoServiceProvider](./sha1cryptoserviceprovider/)() | Konstruktor. |
