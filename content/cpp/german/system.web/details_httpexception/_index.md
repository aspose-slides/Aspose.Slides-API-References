...
type: docs
weight: 1
url: /de/system.web/details_httpexception/
---
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementiert die Methode [what()](../../system/details_exception/what/), die von der Klasse [ExceptionWrapper](../../system/exceptionwrapper/) aufgerufen wird. Obwohl diese Klasse nicht von std::exception erbt, können von ihr abgeleitete Klassen geschützte/ private Member verwenden, um ihre Logik zu implementieren. Das Verschieben dieser Methodenimplementierung in [ExceptionWrapper](../../system/exceptionwrapper/) könnte diese Logik brechen. |
