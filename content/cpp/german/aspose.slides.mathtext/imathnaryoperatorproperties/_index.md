...
Gibt die Eigenschaften von [IMathNaryOperator](../imathnaryoperator/) an
...
| virtual **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() | Der Operator-Charakter wächst vertikal, um die Höhe seines Operanden anzupassen |
| virtual **bool** [get_HideSubscript](./get_hidesubscript/)() | Tiefstellung ausblenden |
| virtual **bool** [get_HideSuperscript](./get_hidesuperscript/)() | Hochstellung ausblenden |
| virtual [MathLimitLocations](../mathlimitlocations/) [get_LimitLocation](./get_limitlocation/)() | Position der Grenzen (Tiefstellung und Hochstellung) |
| virtual char16_t [get_Operator](./get_operator/)() | Mehrfachoperator-Zeichen, zum Beispiel: '\\u2211', '\\u222B' |
...
| virtual void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) | Der Operator-Charakter wächst vertikal, um die Höhe seines Operanden anzupassen |
| virtual void [set_HideSubscript](./set_hidesubscript/)(**bool**) | Tiefstellung ausblenden |
| virtual void [set_HideSuperscript](./set_hidesuperscript/)(**bool**) | Hochstellung ausblenden |
| virtual void [set_LimitLocation](./set_limitlocation/)([MathLimitLocations](../mathlimitlocations/)) | Position der Grenzen (Tiefstellung und Hochstellung) |
| virtual void [set_Operator](./set_operator/)(char16_t) | Mehrfachoperator-Zeichen, zum Beispiel: '\\u2211', '\\u222B' |
