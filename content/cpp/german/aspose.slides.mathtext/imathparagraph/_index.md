...
description: Mathematischer Paragraph, der ein Container für mathematische Blöcke ist (IMathBlock)
type: docs
weight: 456
...
Mathematischer Paragraph, der ein Container für mathematische Blöcke ist ([IMathBlock](../imathblock/))
...
| --- | --- |
| virtual void [Add](../imathblockcollection/add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Fügt [IMathBlock](../imathblock/) am Ende der Sammlung hinzu. |
...
| virtual void [Clear](../imathblockcollection/clear/)() | Entfernt alle Elemente aus der Sammlung. |
| virtual **bool** [Contains](../imathblockcollection/contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Bestimmt, ob die Sammlung einen bestimmten Wert enthält. |
...
| virtual **int32_t** [get_Count](../imathblockcollection/get_count/)() | Gibt die tatsächlich in der Sammlung enthaltene Anzahl von Elementen zurück. Nur lesbarer **int32_t**. |
| virtual [MathJustification](../mathjustification/) [get_Justification](./get_justification/)() | [Paragraph](../../aspose.slides/paragraph/) Ausrichtung Standardwert: CenteredAsGroup |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](../imathblockcollection/idx_get/)(**int32_t**) | Gibt das Element am angegebenen Index zurück. Nur lesbar [IMathBlock](../imathblock/). |
| virtual void [idx_set](../imathblockcollection/idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Gibt das Element am angegebenen Index zurück. Nur lesbar [IMathBlock](../imathblock/). |
| virtual **int32_t** [IndexOf](../imathblockcollection/indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Bestimmt den Index eines bestimmten [IMathBlock](../imathblock/) in der Sammlung. |
| virtual void [Insert](../imathblockcollection/insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Fügt [IMathBlock](../imathblock/) in die Sammlung an dem angegebenen Index ein. |
...
| virtual **bool** [Remove](../imathblockcollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Entfernt das erste Vorkommen eines bestimmten Objekts aus der Sammlung/>. |
| virtual void [RemoveAt](../imathblockcollection/removeat/)(**int32_t**) | Entfernt ein Element am angegebenen Index der Sammlung. |
...
| virtual void [set_Justification](./set_justification/)([MathJustification](../mathjustification/)) | [Paragraph](../../aspose.slides/paragraph/) Ausrichtung Standardwert: CenteredAsGroup |
...
| virtual [System::String](../../system/string/) [ToLatex](./tolatex/)() | Gibt die mathematische Gleichung im LaTeX-Format zurück. |
...
| virtual void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Speichert den Inhalt dieses [IMathParagraph](./) als MathML. |
