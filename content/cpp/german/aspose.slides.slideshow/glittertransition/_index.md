...
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | Legt die Form der während des Übergangs verwendeten Visualisierungen fest. Lesen [TransitionPattern](../transitionpattern/). |
...
| void [Lock](../../system/object/lock/)() | Implementiert das Sperren der C# lock()-Anweisung. Direkt aufrufen oder das [LockContext](../../system/lockcontext/) Wachdienst-Objekt verwenden. |
...
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | Legt die Form der während des Übergangs verwendeten Visualisierungen fest. Schreiben [TransitionPattern](../transitionpattern/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Entsperren der C# lock()-Anweisung. Direkt aufrufen oder das [LockContext](../../system/lockcontext/) Wachdienst-Objekt verwenden. |
