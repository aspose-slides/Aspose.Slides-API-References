...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Dieses Attribut gibt an, ob der Übergang von einem schwarzen Bildschirm aus startet (und dann die neue Folie über Schwarz übergeht). Lesen **bool**. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Dieses Attribut gibt an, ob der Übergang von einem schwarzen Bildschirm aus startet (und dann die neue Folie über Schwarz übergeht). Schreiben **bool**. |
