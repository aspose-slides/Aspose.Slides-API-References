...
| **bool** [get_FromBlack](./get_fromblack/)() override | Dieses Attribut gibt an, ob die Übergangsanimation von einem schwarzen Bildschirm startet (und dann die neue Folie über Schwarz überblendet). Lesen **bool**. |
...
| void [set_FromBlack](./set_fromblack/)(**bool**) override | Dieses Attribut gibt an, ob die Übergangsanimation von einem schwarzen Bildschirm startet (und dann die neue Folie über Schwarz überblendet). Schreiben **bool**. |
