...
| [TransitionEightDirectionType](../transitioneightdirectiontype/) [get_Direction](./get_direction/)() override | Richtung des Übergangs. Lesen Sie [TransitionEightDirectionType](../transitioneightdirectiontype/). |
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Dient als Hash-Funktion für einen bestimmten Typ und ist geeignet für Hash-Algorithmen und Datenstrukturen wie eine Hashtabelle. |
...
| void [set_Direction](./set_direction/)([TransitionEightDirectionType](../transitioneightdirectiontype/)) override | Richtung des Übergangs. Schreiben Sie [TransitionEightDirectionType](../transitioneightdirectiontype/). |
