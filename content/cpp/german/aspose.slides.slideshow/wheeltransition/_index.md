...
description: Wheel-Schiebetransitionseffekt.
type: docs
weight: 443
...
Wheel-Schiebetransitionseffekt.
...
| **uint32_t** [get_Spokes](./get_spokes/)() override | Anzahl der Speichen der WheelTransition. Lesen **uint32_t**. |
...
| void [set_Spokes](./set_spokes/)(**uint32_t**) override | Anzahl der Speichen der WheelTransition. Schreiben **uint32_t**. |
