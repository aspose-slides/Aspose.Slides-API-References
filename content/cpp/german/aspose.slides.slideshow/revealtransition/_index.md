...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-artigen Gleitkomma-Vergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl sie gemäß IEC 60559:1989 nicht gleich einem beliebigen Wert sind, einschließlich NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Gleitkomma-Vergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl sie gemäß IEC 60559:1989 nicht gleich einem beliebigen Wert sind, einschließlich NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() override | Richtung der Überblendung. Lese [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| **bool** [get_ThroughBlack](./get_throughblack/)() override | Gibt an, ob die Überblendung über Schwarz ausblendet. Lesen **bool**. |
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Dient als Hash-Funktion für einen bestimmten Typ und ist geeignet für den Einsatz in Hash-Algorithmen und Datenstrukturen wie einer Hashtabelle. |
...
| void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) override | Richtung der Überblendung. Schreiben [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| void [set_ThroughBlack](./set_throughblack/)(**bool**) override | Gibt an, ob die Überblendung über Schwarz ausblendet. Schreiben **bool**. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogie zur C# [Object.ToString()](../../system/object/tostring/)-Methode. Ermöglicht das Konvertieren benutzerdefinierter Objekte zu string. |
