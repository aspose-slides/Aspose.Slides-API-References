...
| [TransitionMorphType](../transitionmorphtype/) [get_MorphType](./get_morphtype/)() override | Typ des Morph-Übergangs. Lesen [TransitionMorphType](../transitionmorphtype/). |
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Dient als Hashfunktion für einen bestimmten Typ und ist geeignet für den Einsatz in Hash-Algorithmen und Datenstrukturen wie einer Hashtabelle. |
...
| void [set_MorphType](./set_morphtype/)([TransitionMorphType](../transitionmorphtype/)) override | Typ des Morph-Übergangs. Schreiben [TransitionMorphType](../transitionmorphtype/). |
