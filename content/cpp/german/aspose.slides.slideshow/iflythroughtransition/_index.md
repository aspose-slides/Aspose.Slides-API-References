...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-Stil beim Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-Stil beim Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich betrachtet werden, obwohl nach IEC 60559:1989 NaN zu keinem Wert, einschließlich NaN, gleich ist. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Richtung des Übergangs. Lesen Sie [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual **bool** [get_HasBounce](./get_hasbounce/)() | Gibt an, dass die Bewegung der Präsentationsfolien während des Übergangs ein Aufspringen beinhaltet. Lesen Sie **bool**. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Richtung des Übergangs. Schreiben Sie [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_HasBounce](./set_hasbounce/)(**bool**) | Gibt an, dass die Bewegung der Präsentationsfolien während des Übergangs ein Aufspringen beinhaltet. Schreiben Sie **bool**. |
