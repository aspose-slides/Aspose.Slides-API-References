...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | Fügt einen neuen Effekt am Ende der aktuellen Sequenz bis zum Ende der Gruppen-Textanimationen hinzu. Nur gültig, wenn die Anzahl der Textabsätze gleich oder größer ist als die Anzahl der Effekte dieser Gruppe! |
...
| virtual [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() | Liste des Build-Typs (z. B. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) der Textanimation. Lesen [BuildType](../buildtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() | Verknüpfter Form-Effekt mit Gruppe oder nicht (null). Lesen [IEffect](../ieffect/). |
...
| virtual void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) | Liste des Build-Typs (z. B. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) der Textanimation. Schreiben [BuildType](../buildtype/). |
| virtual void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) | Verknüpfter Form-Effekt mit Gruppe oder nicht (null). Schreiben [IEffect](../ieffect/). |
