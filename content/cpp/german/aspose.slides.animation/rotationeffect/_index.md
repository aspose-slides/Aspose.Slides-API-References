...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert C#-ähnlichen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl gemäß IEC 60559:1989 NaN keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert C#-ähnlichen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich angesehen werden, obwohl gemäß IEC 60559:1989 NaN keinem Wert, einschließlich NaN, gleich ist. |
...
| **float** [get_By](./get_by/)() override | Beschreibt den relativen Offsetwert für die Animation. Lesen **float**. |
| **float** [get_From](./get_from/)() override | Beschreibt den Startwert für die Animation. Lesen **float**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](../behavior/get_properties/)() override | Stellt Eigenschaften des Verhaltens dar. Nur lesend [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
...
| **float** [get_To](./get_to/)() override | Beschreibt den Endwert für die Animation. Lesen **float**. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Vergleicht Werttyp-Objekt mit nullptr per Referenz. |
...
| void [set_By](./set_by/)(**float**) override | Beschreibt den relativen Offsetwert für die Animation. Schreiben **float**. |
| void [set_From](./set_from/)(**float**) override | Beschreibt den Startwert für die Animation. Schreiben **float**. |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Gibt Zeiteigenschaften für das Effektverhalten an. Schreiben [ITiming](../itiming/). |
| void [set_To](./set_to/)(**float**) override | Beschreibt den Endwert für die Animation. Schreiben **float**. |
...
* Klasse [IRotationEffect](../irotationeffect/)
