...
| [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() override | Gibt den Befehlstyp an. Lesen [MotionCommandPathType](../motioncommandpathtype/). |
| **bool** [get_IsRelative](./get_isrelative/)() override | Bestimmt, ob Befehlskoordinaten relativ sind oder nicht. Lesen **bool**. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() override | Gibt die Punkte des Befehls an. Lesen [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() override | Gibt den Typ der Befehlspunkte an. Lesen [MotionPathPointsType](../motionpathpointstype/). |
...
| void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) override | Gibt den Befehlstyp an. Schreiben [MotionCommandPathType](../motioncommandpathtype/). |
| void [set_IsRelative](./set_isrelative/)(**bool**) override | Bestimmt, ob Befehlskoordinaten relativ sind oder nicht. Schreiben **bool**. |
| void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) override | Gibt die Punkte des Befehls an. Schreiben [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) override | Gibt den Typ der Befehlspunkte an. Schreiben [MotionPathPointsType](../motionpathpointstype/). |
