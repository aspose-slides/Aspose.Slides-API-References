...
description: Stellt Farb-Offset dar.
type: docs
weight: 92
...
| **float** [get_Value0](./get_value0/)() override | Definiert den ersten Wert des Offsets. Lese **float**. |
| **float** [get_Value1](./get_value1/)() override | Definiert den zweiten Wert des Offsets. Lese **float**. |
| **float** [get_Value2](./get_value2/)() override | Definiert den dritten Wert des Offsets. Lese **float**. |
...
| void [set_Value0](./set_value0/)(**float**) override | Definiert den ersten Wert des Offsets. Schreibe **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Definiert den zweiten Wert des Offsets. Schreibe **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Definiert den dritten Wert des Offsets. Schreibe **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n-te Template-Argument auf einen Weak-Pointer (statt eines Shared-Pointers). Ermöglicht, Zeiger in Containern in den Weak-Modus zu schalten. |
...
* Klasse [IColorOffset](../icoloroffset/)
