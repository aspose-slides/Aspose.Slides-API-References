...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergleicht Objekttypen vom Referenztyp im C#-Stil. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergleicht Objekttypen vom Werttyp im C#-Stil. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert C#-style Gleitkomma-Vergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl NaN gemäß IEC 60559:1989 zu keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert C#-style Gleitkomma-Vergleich, bei dem zwei NaNs als gleich betrachtet werden, obwohl NaN gemäß IEC 60559:1989 zu keinem Wert, einschließlich NaN, gleich ist. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Nur für interne Zwecke. |
| virtual **float** [get_Value0](./get_value0/)() | Definiert den ersten Wert des Offsets. Lesen **float**. |
| virtual **float** [get_Value1](./get_value1/)() | Definiert den zweiten Wert des Offsets. Lesen **float**. |
| virtual **float** [get_Value2](./get_value2/)() | Definiert den dritten Wert des Offsets. Lesen **float**. |
...
| virtual void [set_Value0](./set_value0/)(**float**) | Definiert den ersten Wert des Offsets. Schreiben **float**. |
| virtual void [set_Value1](./set_value1/)(**float**) | Definiert den zweiten Wert des Offsets. Schreiben **float**. |
| virtual void [set_Value2](./set_value2/)(**float**) | Definiert den dritten Wert des Offsets. Schreiben **float**. |
