...
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Fügt ein neues Verhalten zu einer Sammlung hinzu. |
...
| virtual void [Clear](./clear/)() | Entfernt alle Verhaltensweisen aus einer Sammlung. |
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Bestimmt, ob [ICollection](../../system.collections.generic/icollection/) einen bestimmten Wert enthält. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Gibt die Anzahl der Verhaltensweisen in einer Sammlung zurück. Nur lesbarer **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) | Gibt ein Verhalten am angegebenen Index zurück. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Gibt ein Verhalten am angegebenen Index zurück. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Bestimmt den Index eines bestimmten Elements in [IList](../../system.collections.generic/ilist/). |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Fügt ein neues Verhalten an einem angegebenen Index in eine Sammlung ein. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Entfernt das angegebene Verhalten aus einer Sammlung. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Entfernt ein Verhalten aus einer Sammlung am angegebenen Index. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Gibt die Implementierung des begin const Iterator für den aktuellen Container zurück. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../../system.collections.generic/ienumerable/virtualizebeginiterator/)() | Gibt die Implementierung des begin Iterator für den aktuellen Container zurück. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Gibt die Implementierung des end const Iterator für den aktuellen Container zurück. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../../system.collections.generic/ienumerable/virtualizeenditerator/)() | Gibt die Implementierung des end Iterator für den aktuellen Container zurück. |
