...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | Fügt der Sammlung eine neue Eigenschaft hinzu. |
| virtual void [Add](../../system.collections.generic/icollection/add/)(const T\&) | Fügt ein Element in die Sammlung ein. |
...
| virtual void [Clear](../../system.collections.generic/icollection/clear/)() | Löscht alle Elemente aus der Sammlung. |
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Bestimmt, ob [ICollection](../../system.collections.generic/icollection/) einen bestimmten Wert enthält. |
| virtual **bool** [Contains](../../system.collections.generic/icollection/contains/)(const T\&) const | Überprüft, ob das Element in der Sammlung vorhanden ist. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuliert den C#-artigen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich betrachtet werden, obwohl laut IEC 60559:1989 NaN mit keinem Wert, einschließlich NaN, gleich ist. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuliert den C#-artigen Vergleich von Gleitkommazahlen, bei dem zwei NaNs als gleich betrachtet werden, obwohl laut IEC 60559:1989 NaN mit keinem Wert, einschließlich NaN, gleich ist. |
...
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Bestimmt den Index eines bestimmten Elements anhand des Eigenschaftswerts im [IList](../../system.collections.generic/ilist/). |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | Gibt den Index des ersten Auftretens des Elements im Container zurück. |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | Fügt der Sammlung an der angegebenen Position eine neue Eigenschaft (mit dem angegebenen Eigenschaftswert) ein. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<T\> [LINQ_ToArray](../../system.collections.generic/ienumerable/linq_toarray/)() | Erzeugt ein Array aus einer Sequenz. |
| [SharedPtr](../../system/sharedptr/)\<[List](../../system.collections.generic/list/)\<T\>\> [LINQ_ToList](../../system.collections.generic/ienumerable/linq_tolist/)() | Erzeugt eine List<T> aus einer Sequenz. |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | Entfernt die angegebene Eigenschaft aus der Sammlung. |
| virtual **bool** [Remove](../../system.collections.generic/icollection/remove/)(const T\&) | Löscht das Element aus der Sammlung. |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | Entfernt das Element an dem angegebenen Index. |
