...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) override | Fügt einen neuen Effekt am Ende der aktuellen Sequenz zum Ende der Gruppen-Textanimationen hinzu. Nur gültig, wenn die Anzahl der Textabsätze gleich oder größer als die Anzahl der Effekte dieser Gruppe ist! |
...
| [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() override | Liste des Build-Typs (z. B. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) der Textanimation. Lesen [Animation::BuildType](../buildtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() override | Verknüpfter Form-Effekt mit Gruppe oder ohne (null). Lesen [IEffect](../ieffect/). |
...
| void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) override | Liste des Build-Typs (z. B. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) der Textanimation. Schreiben [Animation::BuildType](../buildtype/). |
| void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) override | Verknüpfter Form-Effekt mit Gruppe oder ohne (null). Schreiben [IEffect](../ieffect/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setzt das n'th-Template-Argument auf einen Weak-Pointer (statt eines Shared-Pointers). Ermöglicht das Umschalten von Zeigern in Containern in den Weak-Modus. |
