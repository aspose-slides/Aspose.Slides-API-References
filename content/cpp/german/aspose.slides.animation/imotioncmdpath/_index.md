...
| virtual [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() | Gibt den Befehlstyp an. Lesen [MotionCommandPathType](../motioncommandpathtype/). |
| virtual **bool** [get_IsRelative](./get_isrelative/)() | Bestimmt, ob Befehlskoordinaten relativ sind oder nicht. Lesen **bool**. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | Gibt die Punkte des Befehls an. Lesen [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| virtual [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() | Gibt den Typ der Befehlspunkte an. Lesen [MotionPathPointsType](../motionpathpointstype/). |
...
| virtual void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) | Gibt den Befehlstyp an. Schreiben [MotionCommandPathType](../motioncommandpathtype/). |
| virtual void [set_IsRelative](./set_isrelative/)(**bool**) | Bestimmt, ob Befehlskoordinaten relativ sind oder nicht. Schreiben **bool**. |
| virtual void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) | Gibt die Punkte des Befehls an. Schreiben [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| virtual void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) | Gibt den Typ der Befehlspunkte an. Schreiben [MotionPathPointsType](../motionpathpointstype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementiert das Unlock-Statement von C# lock(). Direkt aufrufen oder das [LockContext](../../system/lockcontext/)-Wächterobjekt verwenden. |
