...
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Fügt ein neues Verhalten zu einer Sammlung hinzu. |
...
| void [Clear](./clear/)() override | Entfernt alle Verhaltensweisen aus einer Sammlung. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Bestimmt, ob [ICollection](../../system.collections.generic/icollection/) einen bestimmten Wert enthält. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>, **int32_t**) | Kopiert die Elemente von [ICollection](../../system.collections.generic/icollection/) in ein [System::Array](../../system/array/), beginnend bei einem bestimmten [System::Array](../../system/array/)-Index. |
...
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Vergleicht Objekte gemäß den C# [Object.Equals](../../system/object/equals/)-Semantiken. |
...
| **int32_t** [get_Count](./get_count/)() override | Gibt die Anzahl der Verhaltensweisen in einer Sammlung zurück. Nur-Lesen **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Ermittelt, ob [ICollection](../../system.collections.generic/icollection/) schreibgeschützt ist. Nur-Lesen **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>\> [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der durch die Sammlung iteriert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) override | Gibt ein Verhalten am angegebenen Index zurück. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Gibt ein Verhalten am angegebenen Index zurück. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Bestimmt den Index eines bestimmten Elements in [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Fügt ein neues Verhalten in einer Sammlung an dem angegebenen Index ein. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformiert jedes Element einer Sequenz in eine neue Form unter Einbeziehung des Index des Elements. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Entfernt das angegebene Verhalten aus einer Sammlung. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Entfernt ein Verhalten aus einer Sammlung am angegebenen Index. |
