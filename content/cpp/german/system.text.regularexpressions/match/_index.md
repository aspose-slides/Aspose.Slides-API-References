...
description: "Einzelnes Match eines regulären Ausdrucks für einen String. Objekte dieser Klasse sollten ausschließlich über die Funktion System::MakeObject() alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse immer in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 66
url: /de/system.text.regularexpressions/match/
---
## Match-Klasse

[Single](../../system/single/) Übereinstimmung eines regulären Ausdrucks mit einem String. Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führt. Wickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | Fügt ein Capture in das Match ein. |
| void [AddGroup](./addgroup/)(const [GroupPtr](../groupptr/)\&) | Fügt eine Gruppe in das Match ein. |
...
| [CaptureCollectionPtr](../capturecollectionptr/) [get_Captures](../group/get_captures/)() | Gibt verfügbare Captures zurück. |
| static [MatchPtr](../matchptr/) [get_Empty](./get_empty/)() | Zugriff auf leeres Match. |
| [GroupCollectionPtr](../groupcollectionptr/) [get_Groups](./get_groups/)() | Gibt die Gruppelliste zurück. |
| int [get_Index](../capture/get_index/)() const | Gibt den Index des erfassten Teilstrings zurück. |
| int [get_Length](../capture/get_length/)() const | Gibt die Länge des erfassten Teilstrings zurück. |
| **bool** [get_Success](../group/get_success/)() | Prüft, ob das Erfassen für diese Gruppe erfolgreich war. |
| [String](../../system/string/) [get_Value](../capture/get_value/)() const | Gibt den erfassten Teilstring zurück. |
...
| [Group](../group/group/)() | Konstruktor einer leeren Gruppe. |
...
| [MatchPtr](../matchptr/) [NextMatch](./nextmatch/)() | Iteration über Matches. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Zuweisungsoperator. Kopiert nichts, sondern initialisiert ein neues Objekt und ermöglicht das Kopieren beim Konstruieren von Unterklassen. |
...
| virtual [String](../../system/string/) [Result](./result/)(const [String](../../system/string/)\&) | Formatiert einen String, indem Submatch-Referenzen durch ihre Werte ersetzt werden. |
...
| [String](../../system/string/) [ToString](../capture/tostring/)() const override | Gibt den erfassten Teilstring zurück. |
