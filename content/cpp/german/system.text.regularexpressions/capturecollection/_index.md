...
description: "Liste der von einer einzelnen Erfassungsgruppe durchgeführten Capture-Elemente. Objekte dieser Klasse sollten nur mit der Funktion System::MakeObject() alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Umwickeln Sie diese Klasse stets in einen System::SmartPtr-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 14
url: /de/system.text.regularexpressions/capturecollection/
---
## CaptureCollection Klasse

Liste der von einer einzelnen Erfassungsgruppe durchgeführten Capture-Elemente. Objekte dieser Klasse sollten nur mit der Funktion [System::MakeObject()](../../system/makeobject/) alloziert werden. Erstellen Sie niemals eine Instanz dieses Typs auf dem Stack oder mit dem Operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen wird. Umwickeln Sie diese Klasse immer in einen [System::SmartPtr](../../system/smartptr/)-Zeiger und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben.
...
| --- | --- |
| void [_add_range](../../system.collections.generic/list/_add_range/)(std::initializer_list\<T\>) | Spezifisch für C++. |
| void [Add](./add/)(const [CapturePtr](../captureptr/)\&) override | Deaktiviert die Änderung der Sammlung. |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | Fügt ein Element am Ende der Liste hinzu. |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | Dienstmethode zum Hinzufügen eines Capture in die Sammlung. |
...
| void [AddRange](../../system.collections.generic/list/addrange/)([IEnumerablePtr](../../system.collections.generic/list/ienumerableptr/)) | Fügt alle Elemente aus einer Sammlung (oder sich selbst) am Ende der aktuellen Liste hinzu. |
...
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(const T\&) const | Sucht nach einem Element in einer sortierten Liste. |
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(const T\&, const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) const | Sucht nach einem Element in einer sortierten Liste. |
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(int, int, const T\&, const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) const | Sucht nach einem Element in einer sortierten Liste. |
...
| void [Clear](./clear/)() override | Deaktiviert das Bereinigen der Sammlung. |
| **bool** [Contains](../../system.collections.generic/list/contains/)(const T\&) const override | Überprüft, ob ein Element in der Liste vorhanden ist. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | Gibt einen Reverse-Iterator auf das letzte const-qualifizierte Element der Sammlung zurück (erstes in umgekehrter Reihenfolge). |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crend](../../system.collections.generic/list/crend/)() const | Gibt einen Reverse-Iterator für ein nicht existierendes const-qualifiziertes Element vor dem Beginn der Sammlung zurück. |
...
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | Überprüft, ob ein Element, das einem bestimmten Prädikat entspricht, in der Liste existiert. |
...
| int [get_Count](./get_count/)() const override | Gibt die Anzahl der Capture zurück. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Überprüft, ob die Sammlung eine feste Größe hat. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Markiert die Sammlung als schreibgeschützt. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | Markiert die Sammlung als nicht synchronisiert. |
...
| [IEnumeratorPtr](../../system.collections.generic/list/ienumeratorptr/) [GetEnumerator](../../system.collections.generic/list/getenumerator/)() override | Gibt einen Enumerator zurück, um über die Listenelemente zu iterieren. |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Durchsucht das angegebene Objekt und gibt den nullbasierten Index des letzten Vorkommens im Bereich der Elemente im [List](../../system.collections.generic/list/) zurück, der vom ersten Element bis zum angegebenen Index reicht. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Durchsucht das angegebene Objekt und gibt den nullbasierten Index des letzten Vorkommens im Bereich der Elemente im [List](../../system.collections.generic/list/) zurück, der die angegebene Anzahl von Elementen enthält und am angegebenen Index endet. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Berechnet den Mittelwert einer Sequenz von Werten, die durch Aufruf einer Transformationsfunktion für jedes Element der Eingangssequenz erhalten werden. |
...
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() | Gibt einen Reverse-Iterator auf das letzte Element der Sammlung zurück (erstes in umgekehrter Reihenfolge). |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() const | Gibt einen Reverse-Iterator auf das letzte Element der const-qualifizierten Sammlung zurück (erstes in umgekehrter Reihenfolge). |
...
| **bool** [Remove](./remove/)(const [CapturePtr](../captureptr/)\&) override | Deaktiviert die Änderung der Sammlung. |
...
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() | Gibt einen Reverse-Iterator für ein nicht existierendes Element vor dem Beginn der Sammlung zurück. |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() const | Gibt einen Reverse-Iterator für ein nicht existierendes Element vor dem Beginn der const-qualifizierten Sammlung zurück. |
| void [Reverse](../../system.collections.generic/list/reverse/)() | Kehrt die Reihenfolge aller Elemente der gesamten Liste um. |
| void [Reverse](../../system.collections.generic/list/reverse/)(int, int) | Kehrt die Reihenfolge der Elemente des Listenslices um. |
...
| void [Sort](../../system.collections.generic/list/sort/)() | Sortiert die Elemente in der Liste unter Verwendung des Standardvergleichs. |
