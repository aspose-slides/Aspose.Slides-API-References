...
description: "Ergebnis einer einzelnen Teilausdrucksübereinstimmung. Objekte dieser Klasse sollten nur über die Funktion System::MakeObject() alloziert werden. Erzeugen Sie niemals eine Instanz dieses Typs im Stack oder mittels operator new, da dies zu Laufzeitfehlern und/oder Assertion-Fehlern führen kann. Wickeln Sie diese Klasse immer in einen System::SmartPtr-Zeiger ein und verwenden Sie diesen Zeiger, um ihn als Argument an Funktionen zu übergeben."
type: docs
weight: 1
url: /de/system.text.regularexpressions/capture/
---
## Capture Klasse
...
| int [get_Index](./get_index/)() const | Liefert den Index des erfassten Teilstrings. |
| int [get_Length](./get_length/)() const | Liefert die Länge des erfassten Teilstrings. |
| [String](../../system/string/) [get_Value](./get_value/)() const | Liefert den erfassten Teilstring. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Liefert die Referenzzählungs-Datenstruktur, die dem Objekt zugeordnet ist. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Liefert den erfassten Teilstring. |
