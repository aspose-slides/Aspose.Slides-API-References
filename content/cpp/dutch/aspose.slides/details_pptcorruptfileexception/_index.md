...
description: Uitzondering die wordt gegooid wanneer het presentatiebestand waarschijnlijk corrupt is.
type: docs
weight: 651
url: /nl/aspose.slides/details_pptcorruptfileexception/
---
## Details_PptCorruptFileException klasse

Uitzondering die wordt gegooid wanneer het presentatiedbestand waarschijnlijk corrupt is.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl zwevend-kommagetallenvergelijking waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl zwevend-kommagetallenvergelijking waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Retourneert een 32-bit geheel getal dat een HRESULT-code is die is gekoppeld aan de uitzondering die door het huidige object wordt vertegenwoordigd. |
...
| void [Lock](../../system/object/lock/)() | Implementeert het lock()-statement van C#. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-waarborgen-object. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopie-constructor. Kopieert in feite niets, initialiseert alleen een nieuw object en maakt kopie-constructie van subklassen mogelijk. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een weak-pointer (in plaats van shared). Staat toe om pointers in containers naar de weak-modus te schakelen. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het lock()-statement van C# voor ontgrendeling. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-waarborgen-object. |
