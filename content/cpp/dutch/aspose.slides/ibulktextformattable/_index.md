...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-style floating point vergelijking waarbij twee NaN’s als gelijk worden beschouwd, ook al wordt volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-style floating point vergelijking waarbij twee NaN’s als gelijk worden beschouwd, ook al wordt volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
...
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Stelt gedefinieerde gedeelte-opmaak-eigenschappen in voor alle segmenten van het element. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Stelt gedefinieerde alinea-opmaak-eigenschappen in voor alle alinea's van het element. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Stelt gedefinieerde tekst-kader-opmaak-eigenschappen in voor alle tekstkaders van het element. |
