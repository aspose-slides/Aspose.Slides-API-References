...
description: Bevat de eigenschappen van het hoofdvlakrelief van de vorm.
type: docs
weight: 5097
...
Bevat de eigenschappen van shape's hoofdvlakrelief.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl floating-point vergelijking waarbij twee NaN-waarden als gelijk worden beschouwd, zelfs hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl floating-point vergelijking waarbij twee NaN-waarden als gelijk worden beschouwd, zelfs hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() override | Bevel-type. Lees [BevelPresetType](../bevelpresettype/). |
| **double** [get_Height](./get_height/)() override | Bevel-hoogte. Lees **double**. |
...
| **double** [get_Width](./get_width/)() override | Bevel-breedte. Lees **double**. |
...
| void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) override | Bevel-type. Schrijf [BevelPresetType](../bevelpresettype/). |
| void [set_Height](./set_height/)(**double**) override | Bevel-hoogte. Schrijf **double**. |
| void [set_Width](./set_width/)(**double**) override | Bevel-breedte. Schrijf **double**. |
...
|  [ShapeBevel](./shapebevel/)(**bool**) | Maakt nieuwe instantie. |
