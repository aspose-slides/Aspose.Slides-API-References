...
description: Stelt een uitzondering voor die wordt gegooid wanneer een fout bij het bewerken van de presentatie wordt gedetecteerd.
type: docs
weight: 716
url: /nl/aspose.slides/details_pptxeditexception/
---
## Details_PptxEditException klasse

Representeert een uitzondering die wordt gegooid wanneer een fout bij het bewerken van de presentatie wordt gedetecteerd.
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Retourneert een 32-bit geheel getal dat een HRESULT-code is die is gekoppeld aan de uitzondering die door het huidige object wordt gerepresenteerd. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie vertegenwoordigt van het door targetType beschreven type. Analoge van de C# 'is'-operator. |
...
|  [Object](../../system/object/object/)() | Creeërt een object. Initialiseert alle interne datastructuren. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieconstructor. Kopieert niets, initialiseert gewoon een nieuw object en maakt het mogelijk om subklassen te kopiëren. |
