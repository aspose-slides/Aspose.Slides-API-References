...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Retourneert een kopie van de gegevens van een afbeelding. Alleen-lezen **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Retourneert een MIME-type van een afbeelding, gecodeerd in [IPPImage::get_BinaryData](./get_binarydata/). Alleen-lezen [System::String](../../system/string/). |
| virtual **int32_t** [get_Height](./get_height/)() | Retourneert de hoogte van een afbeelding. Alleen-lezen **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [get_Image](./get_image/)() | Retourneert een kopie van een afbeelding. Alleen-lezen [System::Drawing::Image](../../system.drawing/image/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\> [get_SvgImage](./get_svgimage/)() const | Retourneert [ISvgImage](../isvgimage/) object [ISvgImage](../isvgimage/) |
| virtual **int32_t** [get_Width](./get_width/)() | Retourneert de breedte van een afbeelding. Alleen-lezen **int32_t**. |
| virtual **int32_t** [get_X](./get_x/)() | Retourneert een X-offset van een afbeelding. Alleen-lezen **int32_t**. |
| virtual **int32_t** [get_Y](./get_y/)() | Retourneert een Y-offset van een afbeelding. Alleen-lezen **int32_t**. |
...
| virtual void [ReplaceImage](./replaceimage/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Vervangt afbeeldingsgegevens. |
| virtual void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\>) | Vervangt afbeelding. |
| virtual void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](./)\>) | Vervangt afbeelding. |
| virtual void [set_SvgImage](./set_svgimage/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\>) | Stelt [ISvgImage](../isvgimage/) object [ISvgImage](../isvgimage/) in |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Stelt toe pointers in containers te schakelen naar zwakke modus. |
