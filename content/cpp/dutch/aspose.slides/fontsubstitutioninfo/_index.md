...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevendekommagereedsvergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevendekommagereedsvergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
|  [FontSubstitutionInfo](./fontsubstitutioninfo/)([System::String](../../system/string/), [System::String](../../system/string/)) | Maakt een instantie van [FontSubstitutionInfo](./) klasse. |
| [System::String](../../system/string/) [get_OriginalFontName](./get_originalfontname/)() | Geeft de naam van het bronlettertype in de presentatie aan. Alleen-lezen [System::String](../../system/string/) |
| [System::String](../../system/string/) [get_SubstitutedFontName](./get_substitutedfontname/)() | Geeft de vervangende lettertype-naam voor het originele lettertype aan. Alleen-lezen [System::String](../../system/string/) |
...
| void [Lock](../../system/object/lock/)() | Implementeert C# lock()-statement locken. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-wachto-object. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Staat wisselen van pointers in containers naar zwakke modus toe. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert C# lock()-statement ontgrendelen. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-wachto-object. |
