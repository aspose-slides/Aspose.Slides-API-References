...
---
## IBaseTableFormatEffectiveData klasse
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderBottom](./get_borderbottom/)() | Retourneert de effectieve waarde van het onderste randlijnformaat. Alleen-lezen [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalDown](./get_borderdiagonaldown/)() | Retourneert de effectieve waarde van de neerwaartse diagonale lijnformat. Alleen-lezen [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalUp](./get_borderdiagonalup/)() | Retourneert de effectieve waarde van de opwaartse diagonale lijnformat. Alleen-lezen [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderLeft](./get_borderleft/)() | Retourneert de effectieve waarde van de linkerrandlijnformaat. Alleen-lezen [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderRight](./get_borderright/)() | Retourneert de effectieve waarde van de rechterrandlijnformaat. Alleen-lezen [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderTop](./get_bordertop/)() | Retourneert de effectieve waarde van de bovenrandlijnformaat. Alleen-lezen [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | Retourneert de effectieve waarde van het opvulformaat. Alleen-lezen [IFillFormatEffectiveData](../ifillformateffectivedata/). |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Verhoogt zwakke referentietelling. Mag niet rechtstreeks worden aangeroepen; gebruik in plaats daarvan slimme pointers of ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Verlaagt zwakke referentietelling. Mag niet rechtstreeks worden aangeroepen; gebruik in plaats daarvan slimme pointers of ThisProtector. |
