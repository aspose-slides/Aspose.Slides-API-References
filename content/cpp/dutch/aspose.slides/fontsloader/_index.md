...
description: Klasse voor het laden van door de gebruiker gedefinieerde aangepaste lettertypen. Moet worden gebruikt voordat presentatie-objecten worden aangemaakt.
type: docs
weight: 976
...
Klasse voor het laden van door de gebruiker gedefinieerde aangepaste lettertypen. Moet worden gebruikt voordat er presentatie-objecten worden gemaakt.
...
| --- | --- |
| static void [ClearCache](./clearcache/)() | Verwijdert alle door de gebruiker gedefinieerde aangepaste lettertypen |
...
| static [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetFontFolders](./getfontfolders/)() | Haalt lettertype-mappen op. Retourneert mappen die zijn toegevoegd met LoadExternalFonts-methode, evenals systeem-lettertype-mappen |
...
| static void [LoadExternalFont](./loadexternalfont/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Voegt een lettertype toe vanuit de binaire gegevens. |
| static void [LoadExternalFonts](./loadexternalfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Voegt extra mappen toe om naar lettertypen te zoeken. |
| void [Lock](../../system/object/lock/)() | Implementeert vergrendeling via C# lock()-statement. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-bewakingsobject. |
