...
description: Biedt gemakkelijke toegang tot de ingesloten hyperlinks.
type: docs
weight: 1262
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetAnyHyperlinks](./getanyhyperlinks/)() override | Haalt alle [IHyperlinkContainer](../ihyperlinkcontainer/) subobjecten op die een niet-null HyperlinkMouseOver bevatten. Met het gegeven [IHyperlinkContainer](../ihyperlinkcontainer/)-object kun je de hyperlink beheren (lezen, bijwerken of verwijderen). Zie interface [IHyperlinkContainer](../ihyperlinkcontainer/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetHyperlinkClicks](./gethyperlinkclicks/)() override | Haalt alle [IHyperlinkContainer](../ihyperlinkcontainer/) subobjecten op die een niet-null HyperlinkClick bevatten. Met het gegeven [IHyperlinkContainer](../ihyperlinkcontainer/)-object kun je de hyperlink beheren (lezen, bijwerken of verwijderen). Zie interface [IHyperlinkContainer](../ihyperlinkcontainer/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkContainer](../ihyperlinkcontainer/)\>\>\> [GetHyperlinkMouseOvers](./gethyperlinkmouseovers/)() override | Haalt alle [IHyperlinkContainer](../ihyperlinkcontainer/) subobjecten op die een niet-null HyperlinkMouseOver bevatten. Met het gegeven [IHyperlinkContainer](../ihyperlinkcontainer/)-object kun je de hyperlink beheren (lezen, bijwerken of verwijderen). Zie interface [IHyperlinkContainer](../ihyperlinkcontainer/). |
...
| void [RemoveAllHyperlinks](./removeallhyperlinks/)() override | Verwijdert alle opgenomen HyperlinkClick- en HyperlinkMouseOver-hyperlinks (in alle [IHyperlinkContainer](../ihyperlinkcontainer/) subobjecten). |
