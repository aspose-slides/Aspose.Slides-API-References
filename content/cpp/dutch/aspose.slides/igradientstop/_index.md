...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | Geeft de kleur van een gradient stop terug. Alleen-lezen [IColorFormat](../icolorformat/). |
| virtual **float** [get_Position](./get_position/)() | Geeft de positie (0..1) van een gradient stop terug. Lezen **float**. |
...
| virtual void [set_Position](./set_position/)(**float**) | Stelt de positie (0..1) van een gradient stop in. Schrijf **float**. |
