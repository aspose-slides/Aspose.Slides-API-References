...
description: Haalt de effectieve vulopmaakgegevens op met de toegepaste overerving.
type: docs
weight: 105
...
Dit voorbeeld demonstreert het ophalen van de effectieve vulopmaak-eigenschappen van een vorm. 
```cpp
