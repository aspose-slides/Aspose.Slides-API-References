...
description: Vertegenwoordigt de gesloten WebVTT-ondertiteling.
type: docs
weight: 1613
...
Vertegenwoordigt de gesloten WebVTT-ondertiteling.
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Retourneert de binaire gegevens van de ondertiteling. Alleen-lezen **uint8_t**[]. |
| virtual [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() | Retourneert de wereldwijd unieke identifier (GUID) van de ondertiteling. Alleen-lezen [System::Guid](../../system/guid/). |
| virtual [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() | Retourneert de ondertitelingsgegevens als UTF-8 gecodeerde string. Alleen-lezen [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Label](./get_label/)() | Retourneert het label van de ondertiteling. Alleen-lezen [System::String](../../system/string/). |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Equivalent van C# [Object.GetHashCode()](../../system/object/gethashcode/) methode. Stelt hash-generatie van aangepaste objecten mogelijk. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Haalt het werkelijke type van het object op. Equivalent van C# [System.Object.GetType()](../../system/object/gettype/) oproep. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie is van het door targetType beschreven type. Equivalent van C# 'is' operator. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Equivalent van C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) methode. Stelt klonen van aangepaste types mogelijk. |
...
| virtual void [set_Label](./set_label/)([System::String](../../system/string/)) | Stelt het label van de ondertiteling in. Schrijf [System::String](../../system/string/). |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Equivalent van C# [Object.ToString()](../../system/object/tostring/) methode. Stelt conversie van aangepaste objecten naar string mogelijk. |
