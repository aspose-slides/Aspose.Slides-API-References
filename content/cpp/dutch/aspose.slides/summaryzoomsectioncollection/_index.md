...
Geeft een verzameling van Summary Zoom [Section](../section/) objecten weer.
...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [AddSummaryZoomSection](./addsummaryzoomsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Maakt een nieuw Summary Zoom [Section](../section/) object aan en voegt het toe aan de collectie |
...
| void [Clear](./clear/)() override | Verwijdert alle [SummaryZoomSection](../summaryzoomsection/) objecten uit de collectie. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\>\>, **int32_t**) override | Kopieert de volledige collectie naar de opgegeven array. |
...
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Retourneert een waarde die aangeeft of toegang tot de collectie gesynchroniseerd (thread-veilig) is. Alleen-lezen **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de collectie itereert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [GetSummarySection](./getsummarysection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Retourneert Summary Zoom [Section](../section/) element voor de opgegeven sectie. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [idx_get](./idx_get/)(**int32_t**) override | Haalt het element op op de opgegeven index. Alleen-lezen [ISummaryZoomSection](../isummaryzoomsection/). |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\>) override | Retourneert een index van het opgegeven [SummaryZoomSection](../summaryzoomsection/) object. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instelling van het type betreft dat wordt beschreven door targetType. Analoge van C# 'is' operator. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Where](../../system.collections.generic/ienumerable/linq_where/)(std::function\<**bool**(T)>) | Filtert een reeks gebaseerd |
...
| void [RemoveSummaryZoomSection](./removesummaryzoomsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Verwijdert Summary Zoom [Section](../section/) object uit de collectie. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n'th sjabloon-argument in op een zwakke pointer (in plaats van gedeeld). Staat het omwisselen van pointers in containers naar zwakke modus toe. |
