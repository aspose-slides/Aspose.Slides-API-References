...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_BackColor](./get_backcolor/)() | Geeft de achtergrondpatroonkleur terug. Alleen-lezen [IColorFormat](../icolorformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ForeColor](./get_forecolor/)() | Geeft de voorgrondpatroonkleur terug. Alleen-lezen [IColorFormat](../icolorformat/). |
| virtual [Aspose::Slides::PatternStyle](../patternstyle/) [get_PatternStyle](./get_patternstyle/)() | Geeft de patroonstijl terug. Lezen [Slides::PatternStyle](../patternstyle/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/), [System::Drawing::Color](../../system.drawing/color/)) | Maakt een tegelafbeelding voor de patroonvulling met opgegeven kleuren. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/)) | Maakt een tegelafbeelding voor de patroonvulling. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie van het type beschreven door targetType vertegenwoordigt. Analoge van C#-operator 'is'. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert niets, echt niet; initialiseert alleen een nieuw object en maakt het mogelijk subklassen te kopiëren. |
...
| virtual void [set_PatternStyle](./set_patternstyle/)([Aspose::Slides::PatternStyle](../patternstyle/)) | Stelt de patroonstijl in. Schrijf [Slides::PatternStyle](../patternstyle/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n-de template-argument in op een zwakke pointer (in plaats van gedeeld). Stelt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
