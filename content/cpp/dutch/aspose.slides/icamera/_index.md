...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) type Lezen [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 graad, gezichtsveld) Lezen **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) zoom (positieve waarde in percentage) Lezen **float**. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Een rotatie wordt gedefinieerd door gebruik van een breedtegraadcoördinaat, een lengtegraadcoördinaat en een revolutie rond de as als de breedtegraad- en lengtegraadcoördinaten. eerste element in teruggeeft-array - breedtegraad, tweede - lengtegraad, derde - revolutie. Retourneert null als er geen rotatie is gedefinieerd. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopie-constructor. Kopieert eigenlijk niets, initialiseert gewoon een nieuw object en maakt kopie-constructie van subklassen mogelijk. |
...
| virtual void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) | [Camera](../camera/) type Schrijven [CameraPresetType](../camerapresettype/). |
| virtual void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) | [Camera](../camera/) FOV (0-180 graad, gezichtsveld) Schrijven **float**. |
| virtual void [set_Zoom](./set_zoom/)(**float**) | [Camera](../camera/) zoom (positieve waarde in percentage) Schrijven **float**. |
| virtual void [SetRotation](./setrotation/)(**float**, **float**, **float**) | Een rotatie wordt gedefinieerd door gebruik van een breedtegraadcoördinaat, een lengtegraadcoördinaat en een revolutie rond de as als de breedtegraad- en lengtegraadcoördinaten. Als een coördinaatwaarde std::numeric_limits<float>::quiet_NaN() is, is de volledige rotatie ongedefinieerd. |
