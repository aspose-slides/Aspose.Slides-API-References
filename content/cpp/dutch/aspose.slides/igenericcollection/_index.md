...
description: Auxiliaire generieke collectie-interface.
type: docs
weight: 2328
url: /nl/aspose.slides/igenericcollection/
---
## IGenericCollection klasse

Auxiliaire generieke collectie-interface.
...
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Kopieert alle elementen van de collectie naar de opgegeven array. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Retourneert het aantal gedragingen in een collectie. Alleen-lezen **int32_t**. |
| virtual **bool** [get_IsSynchronized](./get_issynchronized/)() | Retourneert een waarde die aangeeft of de toegang tot de collectie gesynchroniseerd (thread-safe) is. Alleen-lezen **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() | Retourneert een synchronisatieroot. Alleen-lezen [System::Object](../../system/object/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als zwakke pointer (in plaats van gedeelde). Staat toe om pointers in containers naar zwakke modus te schakelen. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het lock()-statement van C# voor ontgrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) waakhondobject. |
