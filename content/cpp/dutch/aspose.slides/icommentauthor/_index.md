...
description: Vertegenwoordigt een auteur van opmerkingen.
type: docs
weight: 1795
url: /nl/aspose.slides/icommentauthor/
---
## ICommentAuthor klasse

Representeert een auteur van opmerkingen.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevend-kommaget vergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan een waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevend-kommaget vergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan een waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) | Retourneert opmerking gemaakt door deze auteur op de opgegeven index. Alleen-lezen [Aspose::Slides::IComment](../icomment/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() | Retourneert de verzameling opmerkingen gemaakt door deze auteur. Alleen-lezen [ICommentCollection](../icommentcollection/). |
| virtual [System::String](../../system/string/) [get_Initials](./get_initials/)() | Retourneert de initialen van de auteur. Lezen [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Retourneert de naam van de auteur. Lezen [System::String](../../system/string/). |
...
| virtual void [Remove](./remove/)() | Verwijdert de auteur uit de bovenliggende verzameling. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verlaagt de gedeelde referentieteller met de opgegeven waarde. |
| virtual void [set_Initials](./set_initials/)([System::String](../../system/string/)) | Stelt de initialen van de auteur in. Schrijf [System::String](../../system/string/). |
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Stelt de naam van de auteur in. Schrijf [System::String](../../system/string/). |
