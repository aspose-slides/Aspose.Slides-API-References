...
description: Vertegenwoordigt een masterdia voor notities.
type: docs
weight: 2887
url: /nl/aspose.slides/imasternotesslide/
---
## IMasterNotesSlide klasse

Vertegenwoordigt een masterdia voor notities.
...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../../aspose.slides.theme/ithemeeffectivedata/)\> [CreateThemeEffective](../../aspose.slides.theme/ithemeable/createthemeeffective/)() | Retourneert een effectief thema voor dit tematisierbare object. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [FindShapeByAltText](../ibaseslide/findshapebyalttext/)([System::String](../../system/string/)) | Zoekt het eerste voorkomen van een vorm met de opgegeven alternatieve tekst. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | Retourneert een collectie van tekengidsen voor de masternotitiesdia. Alleen-lezen [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlideHeaderFooterManager](../imasternotesslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() | Retourneert de HeaderFooter-beheerder van de masternotitiesdia. Alleen-lezen [IMasterNotesSlideHeaderFooterManager](../imasternotesslideheaderfootermanager/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkQueries](../ihyperlinkqueries/)\> [get_HyperlinkQueries](../ibaseslide/get_hyperlinkqueries/)() | Biedt gemakkelijke toegang tot opgenomen hyperlinks. Alleen-lezen [IHyperlinkQueries](../ihyperlinkqueries/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextStyle](../itextstyle/)\> [get_NotesStyle](./get_notesstyle/)() | Retourneert de stijl van een notitietekst. Alleen-lezen [ITextStyle](../itextstyle/). |
...
| virtual **bool** [get_ShowMasterShapes](../ibaseslide/get_showmastershapes/)() | Specificeert of vormen op de masterdia al dan niet getoond moeten worden op dia's. Voor de masterdia zelf geeft deze eigenschap altijd **false** terug. Lezen **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterThemeManager](../../aspose.slides.theme/imasterthememanager/)\> [get_ThemeManager](../../aspose.slides.theme/imasterthemeable/get_thememanager/)() | Retourneert de masterthemabeheerder. Alleen-lezen [IMasterThemeManager](../../aspose.slides.theme/imasterthememanager/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAnimationTimeLine](../ianimationtimeline/)\> [get_Timeline](../ibaseslide/get_timeline/)() | Retourneert het animatietijdlijnobject. Alleen-lezen [IAnimationTimeLine](../ianimationtimeline/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Vergelijkt referentieel een waarde-typen object met nullptr. |
...
| virtual void [set_ShowMasterShapes](../ibaseslide/set_showmastershapes/)(**bool**) | Specificeert of vormen op de masterdia al dan niet getoond moeten worden op dia's. Voor de masterdia zelf geeft deze eigenschap altijd **false** terug. Schrijf **bool**. |
