...
Beschrijft het formaat van een tabelrij.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IRowFormatEffectiveData](../irowformateffectivedata/)\> [GetEffective](./geteffective/)() override | Haal de effectieve tabelrij-opmaak-eigenschappen op met overerving en toegepaste tabelstijlen. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleer of het object een instantie is van het type dat door targetType wordt beschreven. Analoge aan C#-operator 'is'. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stel het n-de sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Maakt het wisselen van pointers in containers naar zwakke modus mogelijk. |
