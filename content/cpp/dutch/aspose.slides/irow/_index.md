...
| static **bool** [Equals](../../system/object/equals/)(**float** const&, **float** const&) | Bootst C#-achtige floating-point vergelijking na waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const&, **double** const&) | Bootst C#-achtige floating-point vergelijking na waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| virtual **double** [get_Height](./get_height/)() | Retourneert de hoogte van een rij. Alleen-lezen **double**. |
...
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Retourneert de minimaal mogelijke hoogte van een rij. Alleen-lezen **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | Retourneert het [RowFormat](../rowformat/)-object dat opmaak-eigenschappen voor deze rij bevat. Alleen-lezen [IRowFormat](../irowformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Retourneert een cel op basis van zijn positie. Alleen-lezen [ICell](../icell/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const&) | Kopieerconstructor. Kopieert niet echt iets, initialiseert alleen een nieuw object en stelt het kopiëren van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const&) | Toewijzingsoperator. Kopieert niet echt iets, initialiseert alleen een nieuw object en stelt het kopiëren van subklassen mogelijk. |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Stelt de minimaal mogelijke hoogte van een rij in. Schrijf **double**. |
...
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Stelt gedefinieerde portion-opmaak-eigenschappen in voor alle portions van het element. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Stelt gedefinieerde alinea-opmaak-eigenschappen in voor alle alinea's van het element. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Stelt gedefinieerde tekstframe-opmaak-eigenschappen in voor alle tekstframes van het element. |
...
* Klasse [ICellCollection](../icellcollection/)
