...
description: Representeert de WebVTT-ondertitels.
type: docs
weight: 274
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Retourneert de binaire gegevens van de ondertitels. Alleen-lezen **uint8_t**[]. |
| [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() override | Retourneert de globaal unieke identifier (GUID) van de ondertitels. Alleen-lezen [System::Guid](../../system/guid/). |
| [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() override | Retourneert de ondertitels-gegevens als UTF-8 gecodeerde string. Alleen-lezen [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Label](./get_label/)() override | Retourneert het label van de ondertitels. Alleen-lezen [System::String](../../system/string/). |
...
| void [set_Label](./set_label/)([System::String](../../system/string/)) override | Stelt het label van de ondertitels in. Schrijf [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Sta toe dat pointers in containers naar zwakke-modus worden geschakeld. |
