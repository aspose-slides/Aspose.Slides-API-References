...
description: Representeert een rij in een tabel.
type: docs
weight: 4967
...
Representeert een rij in een tabel.
...
| void [CopyTo](../cellcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>\>, **int32_t**) override | Kopieert alle elementen uit de collectie naar de opgegeven array. |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Kopieert alle elementen uit de collectie in de opgegeven array. |
...
| **double** [get_Height](./get_height/)() override | Retourneert de hoogte van een rij. Alleen-lezen **double**. |
| **bool** [get_IsSynchronized](../cellcollection/get_issynchronized/)() override | Retourneert een waarde die aangeeft of de toegang tot de collectie gesynchroniseerd (thread-safe) is. Alleen-lezen **bool**. |
| **double** [get_MinimalHeight](./get_minimalheight/)() override | Retourneert de minimaal mogelijke hoogte van een rij. Lees **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() override | Retourneert het [RowFormat](../rowformat/) object dat opmaak-eigenschappen voor deze rij bevat. Alleen-lezen [IRowFormat](../irowformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../cellcollection/get_syncroot/)() override | Retourneert een synchronisatieroot. Alleen-lezen [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>\>\> [GetEnumerator](../cellcollection/getenumerator/)() override | Retourneert een enumerator die door de collectie itereren. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Assignatie-operator. Kopieert niets echt, initialiseert alleen een nieuw object en maakt kopiëren van subklassen mogelijk. |
...
| void [set_MinimalHeight](./set_minimalheight/)(**double**) override | Stelt de minimaal mogelijke hoogte van een rij in. Schrijf **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n-de sjabloonargument in op een weak-pointer (in plaats van shared). Maakt het wisselen van pointers in containers naar weak-modus mogelijk. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | Stelt gedefinieerde portion-formateigenschappen in voor alle portions van rij-cellen. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | Stelt gedefinieerde alinea-formateigenschappen in voor alle alinea's van rij-cellen. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | Stelt gedefinieerde tekstframe-formateigenschappen in voor alle tekstframes van rij-cellen. |
