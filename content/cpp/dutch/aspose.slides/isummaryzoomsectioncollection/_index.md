...
description: Vertegenwoordigt een verzameling Summary Zoom Section-objecten.
type: docs
weight: 3940
url: /nl/aspose.slides/isummaryzoomsectioncollection/
---
## ISummaryZoomSectionCollection klasse


Vertegenwoordigt een verzameling Summary Zoom [Section](../section/) objecten.
...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [AddSummaryZoomSection](./addsummaryzoomsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | Maakt een nieuw Summary Zoom [Section](../section/) object aan en voegt het toe aan de verzameling |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Haalt een iterator op die naar het eerste element (indien aanwezig) van de verzameling wijst. Deze iterator kan niet worden gebruikt om een verwijzend object te wijzigen omdat [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) een kopie-object van T retourneert. |
...
| virtual void [Clear](./clear/)() | Verwijdert alle [SummaryZoomSection](../summaryzoomsection/) objecten uit de verzameling. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Haalt een iterator op die direct na het laatste element (indien aanwezig) van de verzameling wijst. Deze iterator kan niet worden gebruikt om een verwijzend object te wijzigen omdat [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) een kopie-object van T retourneert. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [GetSummarySection](./getsummarysection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | Retourneert Summary Zoom [Section](../section/) element voor de opgegeven sectie. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [idx_get](./idx_get/)(**int32_t**) | Haalt het element op op de opgegeven index. Alleen-lezen [ISummaryZoomSection](../isummaryzoomsection/). |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\>) | Retourneert de index van het opgegeven [SummaryZoomSection](../summaryzoomsection/) object. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Berekent het gemiddelde van een reeks waarden die zijn verkregen door een transformatie-functie toe te passen op elk element van de invoerreeks. |
...
| virtual void [RemoveSummaryZoomSection](./removesummaryzoomsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | Verwijder Summary Zoom [Section](../section/) object uit de collectie. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Haalt de implementatie van const-begin-iterator voor de huidige container op. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Haalt de implementatie van const-end-iterator voor de huidige container op. |
