...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Retourneert de kleur van een gradiëntstop. Alleen-lezen [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Retourneert de positie (0..1) van een gradiëntstop. Lees **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Stelt de positie (0..1) van een gradiëntstop in. Schrijf **float**. |
