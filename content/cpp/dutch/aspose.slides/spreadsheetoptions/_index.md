...
Stelt opties voor die kunnen worden gebruikt om extra spreadsheetgedrag te specificeren.
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() override | Haalt de voorkeurscultuur-informatie op die nodig is voor het berekenen van sommige functies bedoeld voor gebruik met talen die de double-byte character set (DBCS) gebruiken. |
| **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() override | Als de gegevensbron voor de grafiek een extern werkboek is en niet beschikbaar is, wordt deze teruggehaald uit de grafiekcache. |
...
| void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) override | Stelt de voorkeurscultuur-informatie in voor het berekenen van sommige functies bedoeld voor gebruik met talen die de double-byte character set (DBCS) gebruiken. |
| void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) override | Als de gegevensbron voor de grafiek een extern werkboek is en niet beschikbaar is, wordt deze teruggehaald uit de grafiekcache. |
...
|  [SpreadsheetOptions](./spreadsheetoptions/)() | Initialiseert een nieuwe instantie van de [SpreadsheetOptions](./) klasse. |
...
* Klasse [ISpreadsheetOptions](../ispreadsheetoptions/)
