...
description: Callback-interface gebruikt om het laden van externe bronnen te beheren.
type: docs
weight: 3498
url: /nl/aspose.slides/iresourceloadingcallback/
---
## IResourceLoadingCallback klasse

Callback-interface gebruikt om het laden van externe bronnen te beheren.
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleer of het object een instantie is van het type beschreven door targetType. Analoge van de C#-operator 'is'. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert niets echt, initialiseert enkel een nieuw object en maakt kopie-constructie van subklassen mogelijk. |
...
| virtual [ResourceLoadingAction](../resourceloadingaction/) [ResourceLoading](./resourceloading/)([System::SharedPtr](../../system/sharedptr/)\<[IResourceLoadingArgs](../iresourceloadingargs/)\>) | Callback-methode die het laden van externe bronnen regelt. |
