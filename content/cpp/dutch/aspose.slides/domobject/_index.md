...
type: docs
weight: 807
url: /nl/aspose.slides/domobject/
---
## DomObject klasse

Basis [DOM](../../aspose.slides.dom/) object
...
| --- | --- |
| TParent | Type van bovenliggend [DOM](../../aspose.slides.dom/) object |
## Methoden
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert niets echt, initialiseert enkel een nieuw object en maakt copy-constructie van subklassen mogelijk. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n'te sjabloonargument in op een zwakke pointer (in plaats van gedeelde). Staat het omschakelen van pointers in containers naar zwakke modus toe. |
