...
description: Stelt een verzameling van kleurtransformatie-bewerkingen voor.
type: docs
weight: 1717
url: /nl/aspose.slides/icoloroperationcollection/
---
## IColorOperationCollection klasse

Stelt een verzameling van kleurtransformatie-bewerkingen voor.
...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) | Voegt een nieuwe bewerking toe aan het einde van de collectie. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) | Voegt een nieuwe bewerking toe aan het einde van de collectie. |
...
| virtual void [Clear](./clear/)() | Verwijdert alle kleurbewerkingen. |
...
| virtual T [CloneT](../igenericcloneable/clonet/)() | Maakt een nieuw object dat een kopie is van de huidige instantie. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) | Retourneert de bewerking op de opgegeven index. Lezen [IColorOperation](../icoloroperation/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) | Stelt de bewerking in op de opgegeven index. Schrijven [IColorOperation](../icoloroperation/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) | Voegt de nieuwe bewerking toe aan een collectie. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) | Voegt de nieuwe bewerking toe aan een collectie. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Sla een opgegeven aantal opeenvolgende elementen vanaf het begin van een reeks over en retourneer de rest. |
...
| void [Lock](../../system/object/lock/)() | Implementeert de lock()-statement van C#. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) bewakingsobject. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert niets, maar initialiseert een nieuw object en maakt het mogelijk om subklassen te kopiëren. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Verwijdert de kleurbewerking uit een collectie. |
