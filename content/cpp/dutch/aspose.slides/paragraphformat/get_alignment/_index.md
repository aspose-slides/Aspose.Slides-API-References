...
description: Retourneert de tekstuitlijning in een alinea zonder overerving. Lees TextAlignment.
type: docs
weight: 1
url: /nl/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() methode

Retourneert de tekstuitlijning in een alinea zonder overerving. Lees [TextAlignment](../../textalignment/).
...
De volgende voorbeeldcode laat zien hoe Tekst Alinea's uit te lijnen in PowerPoint [Presentation](../../presentation/). 
```cpp
