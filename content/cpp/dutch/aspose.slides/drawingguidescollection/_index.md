...
description: Vertegenwoordigt een verzameling van de verstelbare tekengidsen.
type: docs
weight: 833
...
Representeert een verzameling van de verstelbare tekengidsen.
...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [Add](./add/)([Orientation](../orientation/), **float**) override | Voegt de tekengids toe aan het einde van de verzameling. |
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\>\>, **int32_t**) | Kopieert alle elementen van de verzameling naar de opgegeven array. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de verzameling iterereert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [idx_get](./idx_get/)(**int32_t**) override | Retourneert de tekengids op index. Alleen-lezen [IDrawingGuide](../idrawingguide/). |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Retourneert het eerste element van de reeks dat aan een voorwaarde voldoet, of een standaardwaarde als dergelijk element niet wordt gevonden. |
...
| void [Lock](../../system/object/lock/)() | Implementeert C# lock()-statement vergrendeling. Direct aanroepen of [LockContext](../../system/lockcontext/) sentinel-object gebruiken. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const&) | Copy-constructor. Kopieert niets, initialiseert eigenlijk een nieuw object en maakt het mogelijk om subklassen te copy-constructeren. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const&) | Toewijzingsoperator. Kopieert niets, initialiseert eigenlijk een nieuw object en maakt het mogelijk om subklassen te copy-constructeren. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Verwijdert de tekengids op de opgegeven index. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert C# lock()-statement ontgrendeling. Direct aanroepen of [LockContext](../../system/lockcontext/) sentinel-object gebruiken. |
...
| Typedef | Omschrijving |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Een verzameltype waarvan de iterator-types worden gebruikt als iterator-types in de huidige verzameling. |
