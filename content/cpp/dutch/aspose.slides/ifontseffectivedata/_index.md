...
---
## IFontsEffectiveData klasse

Onveranderlijk object dat de effectieve lettertypenset bevat.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_ComplexScriptFont](./get_complexscriptfont/)() | Retourneert het complexe scriptlettertype. Alleen-lezen [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_EastAsianFont](./get_eastasianfont/)() | Retourneert het Oost-Aziatische lettertype. Alleen-lezen [IFontData](../ifontdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_LatinFont](./get_latinfont/)() | Retourneert het Latijnse lettertype. Alleen-lezen [IFontData](../ifontdata/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in op een zwakke pointer (in plaats van gedeelde). Hiermee kunnen pointers in containers naar zwakke modus worden geschakeld. |
...
Deze interface wordt gebruikt als onderdeel van de [IBasePortionFormatEffectiveData](../ibaseportionformateffectivedata/) en [Theme::IFontSchemeEffectiveData](../../aspose.slides.theme/ifontschemeeffectivedata/) interfaces. 
## Zie ook
