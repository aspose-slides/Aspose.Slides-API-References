...
description: Stelt een verzameling van GradientStopDataEx-objecten voor.
type: docs
weight: 2432
url: /nl/aspose.slides/igradientstopcollectioneffectivedata/
---
## IGradientStopCollectionEffectiveData klasse

Stelt een verzameling van GradientStopDataEx-objecten voor.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) | Retourneert de gradientstop op index. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk om pointers in containers om te schakelen naar zwakke modus. |
