...
description: Stelt een basisklasse voor voor een collectie van layoutdia's.
type: docs
weight: 2653
url: /nl/aspose.slides/ilayoutslidecollection/
---
## ILayoutSlideCollection klasse


Stelt een basisklasse voor voor een collectie van layoutdia's.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](./getbytype/)([SlideLayoutType](../slidelayouttype/)) | Retourneert de eerste layoutdia van het opgegeven type. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](./idx_get/)(**int32_t**) | Retourneert de layoutdia op index. Alleen-lezen [ILayoutSlide](../ilayoutslide/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie van het type dat wordt beschreven door targetType representeert. Analoge van C# 'is'-operator. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Retourneert het eerste element van de reeks dat aan een voorwaarde voldoet, of een standaardwaarde indien geen dergelijk element wordt gevonden. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Slaapt een opgegeven aantal opeenvolgende elementen over vanaf het begin van een reeks en retourneert de rest. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Verwijdert een layout uit de collectie. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verlaagt de gedeelde referentieteller met de opgegeven waarde. |
| virtual void [RemoveUnused](./removeunused/)() | Verwijdert ongebruikte layoutdia's (layoutdia's waarvan HasDependingSlides onwaar is). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th template-argument in op een zwakke pointer (in plaats van gedeelde). Stelt het wisselen van pointers in containers naar zwakke modus mogelijk. |
