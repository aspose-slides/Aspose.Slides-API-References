...
description: Stelt de manager voor die het gedrag van de dia-voettekst, datum-tijd- en paginanummer-plaatsvervangers bevat.
type: docs
weight: 5201
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Haalt de waarde op die aangeeft dat een datum-tijd plaatsvervanger aanwezig is. Lezen**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | Haalt de waarde op die aangeeft dat een voettekst plaatsvervanger aanwezig is. Lezen **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Haalt de waarde op die aangeeft dat een paginanummer plaatsvervanger aanwezig is. Lezen**bool**. |
...
| void [Lock](../../system/object/lock/)() | Implementeert de vergrendeling van de C# lock()-instructie. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-wachobject. |
...
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | Stelt de tekst in voor de datum-tijd plaatshouder van de dia. |
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | Wijzigt de zichtbaarheid van de datum-tijd plaatshouder op de dia. |
| void [SetFooterText](../baseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) override | Stelt de tekst in voor de voettekstplaatshouder van de dia. |
| void [SetFooterVisibility](../baseslideheaderfootermanager/setfootervisibility/)(**bool**) override | Wijzigt de zichtbaarheid van de voettekstplaatshouder op de dia. |
| void [SetSlideNumberVisibility](../baseslideheaderfootermanager/setslidenumbervisibility/)(**bool**) override | Wijzigt de zichtbaarheid van de paginanummerplaatshouder op de dia. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het ontgrendelen van de C# lock()-instructie. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-wachobject. |
...
* Klasse [ISlideHeaderFooterManager](../islideheaderfootermanager/)
