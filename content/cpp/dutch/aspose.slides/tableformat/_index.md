...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Retourneert een tabelvul-eigenschappen-object. Alleen-lezen [IFillFormat](../ifillformat/). |
...
| **float** [get_Transparency](./get_transparency/)() override | Haalt de transparantie van de vulkleur op. Lezen **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() override | Haalt effectieve tabelopmaak-eigenschappen op met overerving en toegepaste tabelstijlen. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert niets, echt niet, alleen een nieuw object initialiseren en kopieerconstructie van subklassen mogelijk maken. |
...
| void [set_Transparency](./set_transparency/)(**float**) override | Stelt de transparantie van de vulkleur in. Schrijf **float**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n'th sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Stelt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
