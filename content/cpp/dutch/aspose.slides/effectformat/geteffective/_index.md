...
description: Haalt effectieve effect-opmaakgegevens op met de toegepaste overerving.
type: docs
weight: 430
url: /nl/aspose.slides/effectformat/geteffective/
---
## EffectFormat::GetEffective() methode


Haalt effectieve effect-opmaakgegevens op met de toegepaste overerving.
...
Dit voorbeeld toont het ophalen van enkele effectieve effecteigenschappen van een vorm. 
```cpp
