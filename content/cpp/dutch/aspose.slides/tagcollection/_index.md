...
description: Vertegenwoordigt de collectie van tags (door de gebruiker gedefinieerde paren van strings)
type: docs
weight: 5435
...
Representeert de collectie van tags (gebruiker gedefinieerde paren van strings)
...
| Method | Description |
| --- | --- |
| **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Voegt een nieuwe tag toe aan de collectie. |
...
| void [Clear](./clear/)() override | Verwijdert alle tags uit de collectie. |
| **bool** [Contains](./contains/)([System::String](../../system/string/)) override | Bepaalt of de collectie een specifieke naam bevat. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\>, **int32_t**) override | Kopieert alle elementen van de collectie naar de opgegeven array. |
...
| **int32_t** [get_Count](./get_count/)() override | Retourneert een aantal tags in de collectie. Alleen-lezen **int32_t**. |
...
| [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) override | Retourneert de sleutel van een tag op de opgegeven index. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() override | Retourneert de namen van tags. |
...
| [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) override | Retourneert de waarde van een tag op de opgegeven index. |
| [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) override | Retourneert een sleutel-en-waarde-paar van een tag. |
| void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Stelt een sleutel-en-waarde-paar van een tag in. |
| **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) override | Retourneert de nul-gebaseerde index van de opgegeven sleutel in de collectie. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie van het type dat door targetType wordt beschreven, vertegenwoordigt. Analog van C# ‘is’-operator. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Sla een opgegeven aantal opeenvolgende elementen over aan het begin van een reeks en retourneer de rest. |
...
| void [Lock](../../system/object/lock/)() | Implementeert de C# lock()-statement voor vergrendeling. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-waarschuwingsobject. |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | Verwijdert de tag met een opgegeven naam uit de collectie. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Verwijdert de tag op de opgegeven index. |
...
Het volgende voorbeeld toont hoe een tag toe te voegen aan een PowerPoint [Presentation](../presentation/).
```cpp
...
* Klasse [ITagCollection](../itagcollection/)
