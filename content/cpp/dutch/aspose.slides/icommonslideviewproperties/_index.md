...
description: Vertegenwoordigt algemene diaweergave-eigenschappen.
type: docs
weight: 1834
url: /nl/aspose.slides/icommonslideviewproperties/
---
## ICommonSlideViewProperties klasse


Representeert algemene diaweergave-eigenschappen.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-style zwevendekomma vergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-style zwevendekomma vergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) | Retourneert tekenhulp op de opgegeven index. Alleen-lezen [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | Retourneert de collectie van de tekenhulpen. Alleen-lezen [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **int32_t** [get_Scale](./get_scale/)() | Specificeert de weergave-schaalverhouding in procenten. Lees **int32_t**. |
| virtual **bool** [get_VariableScale](./get_variablescale/)() | Specificeert dat de weergave-inhoud automatisch moet schalen om het huidige venster optimaal te benutten. Lees **bool**. |
...
| virtual void [set_Scale](./set_scale/)(**int32_t**) | Specificeert de weergave-schaalverhouding in procenten. Schrijf **int32_t**. |
| virtual void [set_VariableScale](./set_variablescale/)(**bool**) | Specificeert dat de weergave-inhoud automatisch moet schalen om het huidige venster optimaal te benutten. Schrijf **bool**. |
