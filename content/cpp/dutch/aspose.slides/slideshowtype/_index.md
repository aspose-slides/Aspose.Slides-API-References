...
description: "Basisinstellingen voor diavoorstelling. Voorouders vertegenwoordigen typen van de diavoorstelling: PresentedBySpeaker Presentatie door een spreker (volledig scherm) BrowsedByIndividual Bekeken door een individu (venster) BrowsedAtKiosk Bekeken op een kiosk (volledig scherm)"
type: docs
weight: 5227
...
Basale instellingen voor diavoorstelling. Voorouders vertegenwoordigen typen van de diavoorstelling: [PresentedBySpeaker](../presentedbyspeaker/) Presentatie door een spreker (volledig scherm) [BrowsedByIndividual](../browsedbyindividual/) Bekeken door een individu (venster) [BrowsedAtKiosk](../browsedatkiosk/) Bekeken op een kiosk (volledig scherm)
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogie van C# [Object.GetHashCode()](../../system/object/gethashcode/)-methode. Staat hashing van aangepaste objecten toe. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogie van C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-methode. Staat klonen van aangepaste types toe. |
|  [Object](../../system/object/object/)() | Maakt een object aan. Initialiseert alle interne gegevensstructuren. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert niets echt, initialiseert alleen een nieuw object en maakt het mogelijk subklassen via copy-constructor te maken. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets echt, initialiseert alleen een nieuw object en maakt het mogelijk subklassen via copy-constructor te maken. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogie van C# [Object.ToString()](../../system/object/tostring/)-methode. Staat conversie van aangepaste objecten naar string toe. |
