...
description: Stelt het aantal kolommen in het tekstgebied in. Deze waarde moet een positief getal zijn. Anders wordt de waarde ingesteld op nul. Waarde 0 betekent een ongedefinieerde waarde. Schrijf int32_t.
type: docs
weight: 261
url: /nl/aspose.slides/textframeformat/set_columncount/
---
## TextFrameFormat::set_ColumnCount(int32_t) methode

Stelt het aantal kolommen in het tekstgebied in. Deze waarde moet een positief getal zijn. Anders wordt de waarde ingesteld op nul. Waarde 0 betekent een ongedefinieerde waarde. Schrijf **int32_t**.
...
De volgende voorbeeldcode laat zien hoe je een kolom toevoegt in een Tekstkader binnen een PowerPoint [Presentation](../../presentation/).
```cpp
