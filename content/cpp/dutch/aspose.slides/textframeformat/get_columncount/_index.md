...
description: Retourneert het aantal kolommen in het tekstgebied. Deze waarde moet een positief getal zijn. Anders wordt de waarde op nul gezet. Waarde 0 betekent een ongedefinieerde waarde. Lees int32_t.
type: docs
weight: 248
url: /nl/aspose.slides/textframeformat/get_columncount/
---
## TextFrameFormat::get_ColumnCount() methode

Retourneert het aantal kolommen in het tekstgebied. Deze waarde moet een positief getal zijn. Anders wordt de waarde op nul gezet. Waarde 0 betekent ongedefinieerde waarde. Lees **int32_t**.
...
De volgende voorbeeldcode toont hoe je een kolom toevoegt in een tekstkader binnen een PowerPoint [Presentation](../../presentation/). 
```cpp
