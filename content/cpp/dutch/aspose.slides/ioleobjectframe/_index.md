...
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | Eigenschap geeft aan hoe een vorm wordt weergegeven in zwart-wit weergavemodus. Lezen [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOleEmbeddedDataInfo](../ioleembeddeddatainfo/)\> [get_EmbeddedData](./get_embeddeddata/)() | Haalt informatie op over OLE-embedded data. Alleen-lezen [IOleEmbeddedDataInfo](../ioleembeddeddatainfo/). |
| virtual [System::String](../../system/string/) [get_EmbeddedFileLabel](./get_embeddedfilelabel/)() | Retourneert de bestandsnaam van het ingebedde OLE-object |
| virtual [System::String](../../system/string/) [get_EmbeddedFileName](./get_embeddedfilename/)() | Retourneert het pad van het ingebedde OLE-object |
...
| virtual **bool** [get_IsObjectIcon](./get_isobjecticon/)() | Bepaalt of een object zichtbaar is als pictogram. Lezen **bool**. |
| virtual **bool** [get_IsObjectLink](./get_isobjectlink/)() | Bepaalt of een object gekoppeld is aan een extern bestand. Alleen-lezen **bool**. |
...
| virtual [System::String](../../system/string/) [get_LinkFileName](./get_linkfilename/)() | Retourneert het volledige pad naar een gekoppeld bestand. Korte bestandsnaam wordt gebruikt. Alleen-lezen [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Retourneert het volledige pad naar een gekoppeld bestand. Lange bestandsnaam wordt gebruikt. Lezen [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_LinkPathRelative](./get_linkpathrelative/)() | Retourneert het relatieve pad naar een gekoppeld bestand indien aanwezig, anders een lege tekenreeks. Alleen-lezen [System::String](../../system/string/). |
...
| virtual [System::String](../../system/string/) [get_ObjectName](./get_objectname/)() | Retourneert de naam van een object. Lezen [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_ObjectProgId](./get_objectprogid/)() | Retourneert de ProgID van een object. Alleen-lezen [System::String](../../system/string/). |
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Retourneert een slide-gescope unieke identifier die gedurende de levensduur van de vorm constant blijft en PowerPoint of interop-code betrouwbaar laat refereren naar de vorm vanuit elk deel van het document. Alleen-lezen **uint32_t**. Zie ook [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_RawFrame](../ishape/get_rawframe/)() | Retourneert de ruwe vormframe-eigenschappen. Lezen [IShapeFrame](../ishapeframe/). |
| virtual **float** [get_Rotation](../ishape/get_rotation/)() | Retourneert het aantal graden waarmee de opgegeven vorm rond de z-as is geroteerd. Een positieve waarde duidt op een klokwijzerrotatie; een negatieve waarde duidt op tegenwijzerrotatie. Lezen **float**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_SubstitutePictureFormat](./get_substitutepictureformat/)() | Retourneert OleObject-afbeeldingsvul-eigenschappenobject. Alleen-lezen [IPictureFillFormat](../ipicturefillformat/). |
| virtual [System::String](../../system/string/) [get_SubstitutePictureTitle](./get_substitutepicturetitle/)() | Retourneert de titel voor OleObject-pictogram. Lezen [System::String](../../system/string/). |
...
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Retourneert een interne, op de presentatie gebaseerde identifier bedoeld voor gebruik door add-ins of andere code. Omdat deze waarde door de gebruiker of programmatisch kan worden herkend, mag deze niet worden beschouwd als een blijvende unieke sleutel. Alleen-lezen **uint32_t**. Zie ook [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
| virtual **bool** [get_UpdateAutomatic](./get_updateautomatic/)() | Bepaalt of het gekoppelde ingebedde object automatisch wordt bijgewerkt wanneer de presentatie wordt geopend of afgedrukt. Lezen **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../ishape/getbaseplaceholder/)() | Retourneert een basale placeholder-vorm (vorm afkomstig van de lay-out en/of masterslide waar de huidige vorm van erft). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetImage](../ishape/getimage/)() | Retourneert vorm-miniatuur. [ShapeThumbnailBounds::Shape](../shapethumbnailbounds/) vorm-miniatuurbereiktype wordt standaard gebruikt. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert niets echt, initialiseert enkel een nieuw object en maakt het mogelijk om subklassen te kopiëren. |
...
| virtual void [set_IsObjectIcon](./set_isobjecticon/)(**bool**) | Bepaalt of een object zichtbaar is als pictogram. Schrijf **bool**. |
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | Retourneert het volledige pad naar een gekoppeld bestand. Lange bestandsnaam wordt gebruikt. Schrijf [System::String](../../system/string/). |
...
| virtual void [set_ObjectName](./set_objectname/)([System::String](../../system/string/)) | Stelt de naam van een object in. Schrijf [System::String](../../system/string/). |
| virtual void [set_ObjectProgId](./set_objectprogid/)([System::String](../../system/string/)) | Retourneert de ProgID van een object. Alleen-lezen [System::String](../../system/string/). |
| virtual void [set_RawFrame](../ishape/set_rawframe/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\>) | Stelt de ruwe vormframe-eigenschappen in. Schrijf [IShapeFrame](../ishapeframe/). |
| virtual void [set_Rotation](../ishape/set_rotation/)(**float**) | Stelt het aantal graden in waarmee de opgegeven vorm rond de z-as is geroteerd. Een positieve waarde duidt op een klokwijzerrotatie; een negatieve waarde duidt op tegenwijzerrotatie. Schrijf **float**. |
| virtual void [set_SubstitutePictureTitle](./set_substitutepicturetitle/)([System::String](../../system/string/)) | Stelt de titel voor het OleObject-pictogram in. Schrijf [System::String](../../system/string/). |
| virtual void [set_UpdateAutomatic](./set_updateautomatic/)(**bool**) | Bepaalt of het gekoppelde ingebedde object automatisch wordt bijgewerkt wanneer de presentatie wordt geopend of afgedrukt. Schrijf **bool**. |
...
| virtual void [SetEmbeddedData](./setembeddeddata/)([System::SharedPtr](../../system/sharedptr/)\<[IOleEmbeddedDataInfo](../ioleembeddeddatainfo/)\>) | Stelt informatie in over OLE-embedded data. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n-de template-argument in als een zwakke pointer (in plaats van gedeelde). Maakt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
