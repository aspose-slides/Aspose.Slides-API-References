...
description: Vertegenwoordigt een collectie van gradientstops.
type: docs
weight: 1132
...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) override | Maakt een nieuwe gradientstop aan en voegt deze toe aan het einde van de collectie. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) override | Maakt een nieuwe gradientstop aan en voegt deze toe aan het einde van de collectie. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) override | Maakt een nieuwe gradientstop aan en voegt deze toe aan het einde van de collectie. |
...
| void [Clear](./clear/)() override | Verwijdert alle gradientstops uit een collectie. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>, **int32_t**) override | Kopieert alle elementen van de collectie naar de opgegeven array. |
...
| **int32_t** [get_Count](./get_count/)() override | Retourneert het aantal gradientstops in een collectie. Alleen-lezen **int32_t**. |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../ipviobject/get_parent_ipresentationcomponent/)() | Retourneert de ouder [IPresentationComponent](../ipresentationcomponent/). Alleen-lezen [IPresentationComponent](../ipresentationcomponent/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de collectie itereert. |
| **int32_t** [GetHashCode](../pviobject/gethashcode/)() const override | Retourneert een hash-code. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) override | Retourneert de gradientstop op basis van index. |
| void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) override | Maakt een nieuwe gradientstop aan en voegt deze in op de opgegeven index in de collectie. |
| void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) override | Maakt een nieuwe gradientstop aan en voegt deze in op de opgegeven index in de collectie. |
| void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) override | Maakt een nieuwe gradientstop aan en voegt deze in op de opgegeven index in de collectie. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie is van het type dat wordt beschreven door targetType. Analoge aan de C# ‘is’-operator. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Verwijdert een gradientstop op de opgegeven index. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analoge aan C# [Object.ToString()](../../system/object/tostring/)-methode. Maakt het converteren van aangepaste objecten naar string mogelijk. |
...
* Klasse [IGradientStopCollection](../igradientstopcollection/)
