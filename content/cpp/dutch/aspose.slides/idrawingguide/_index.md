...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Retourneert de kleur van de tekengids. Lees [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Retourneert de oriëntatie van de tekengids. Lees [Slides::Orientation](../orientation/). |
| virtual **float** [get_Position](./get_position/)() | Retourneert de positie van de tekengids in points vanaf de boven-linker hoek van de dia. Lees **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt het kopiëren van subklassen mogelijk. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Stelt de kleur van de tekengids in. Schrijf [System::Drawing::Color](../../system.drawing/color/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | Stelt de oriëntatie van de tekengids in. Schrijf [Slides::Orientation](../orientation/). |
| virtual void [set_Position](./set_position/)(**float**) | Stelt de positie van de tekengids in points vanaf de boven-linker hoek van de dia. Schrijf **float**. |
