...
Representeert [LightRig](../lightrig/).
...
| virtual [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() | Lichtrichting. Lees [LightingDirection](../lightingdirection/). |
| virtual [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() | Stelt een vooraf ingestelde lichte rechtskant voor die op een vorm kan worden toegepast. De lichtopstelling vertegenwoordigt een groep lichten die op een specifieke manier ten opzichte van een 3D-scene zijn georiënteerd. Lees [LightRigPresetType](../lightrigpresettype/). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Een rotatie wordt gedefinieerd door het gebruik van een breedtegraad-coördinaat, een lengtegraad-coördinaat en een omwenteling rond de as, met de breedte- en lengtegraad-coördinaten. eerste element in retourarray - breedtegraad, tweede - lengtegraad, derde - omwenteling. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleer of het object een instantie van het type beschrijft dat wordt aangegeven door targetType. Analoge van C#-operator 'is'. |
...
| virtual void [set_Direction](./set_direction/)([LightingDirection](../lightingdirection/)) | Lichtrichting. Schrijf [LightingDirection](../lightingdirection/). |
| virtual void [set_LightType](./set_lighttype/)([LightRigPresetType](../lightrigpresettype/)) | Stelt een vooraf ingestelde lichte rechtskant voor die op een vorm kan worden toegepast. De lichtopstelling vertegenwoordigt een groep lichten die op een specifieke manier ten opzichte van een 3D-scene zijn georiënteerd. Schrijf [LightRigPresetType](../lightrigpresettype/). |
| virtual void [SetRotation](./setrotation/)(**float**, **float**, **float**) | Een rotatie wordt gedefinieerd door het gebruik van een breedtegraad-coördinaat, een lengtegraad-coördinaat en een omwenteling rond de as, met de breedte- en lengtegraad-coördinaten. |
