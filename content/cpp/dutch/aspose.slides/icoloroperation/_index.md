...
description: Vertegenwoordigt verschillende kleuroperaties die worden gebruikt voor kleurovergangen.
type: docs
weight: 1704
url: /nl/aspose.slides/icoloroperation/
---
## IColorOperation klasse

Vertegenwoordigt verschillende kleuroperaties die worden gebruikt voor kleurovergangen.
...
| virtual [ColorTransformOperation](../colortransformoperation/) [get_OperationType](./get_operationtype/)() const | Retourneert het type van een bewerking. Alleen-lezen [ColorTransformOperation](../colortransformoperation/). |
| virtual **float** [get_Parameter](./get_parameter/)() | Retourneert een parameter van een bewerking. Alleen-lezen **float**. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Vergelijkt het waardetype-object met nullptr op referentie. |
