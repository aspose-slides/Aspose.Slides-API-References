...
| Parameter | Type | Beschrijving |
| --- | --- | --- |
| stream | [System::SharedPtr](../../../system/sharedptr/)\<[System::IO::Stream](../../../system.io/stream/)\> | Uitvoerstream. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Formaat van de geëxporteerde gegevens. |

## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) method

Slaat alle dia's van een presentatie op in een bestand met het opgegeven formaat en met aanvullende formatopties.
...
| fname | [System::String](../../../system/string/) | Pad naar het aangemaakte bestand. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Formaat van de geëxporteerde gegevens. |
| options | [System::SharedPtr](../../../system/sharedptr/)\<[Export::ISaveOptions](../../../aspose.slides.export/isaveoptions/)\> | Aanvullende formatopties. |

## Opmerkingen

 Het volgende voorbeeld toont hoe PowerPoint te converteren naar HTML met C++. 
```cpp
// Instantieert een presentatie-object dat een presentatie-bestand representeert, bijv. PPT, PPTX, ODP enz.
...
```
 Het volgende voorbeeld toont hoe PowerPoint naar responsieve HTML te converteren met C++. 
```cpp
...
// Slaat de presentation op naar HTML
presentation->Save(u"ConvertPresentationToResponsiveHTML_out.html", SaveFormat::Html, htmlOptions);
```
 Het volgende voorbeeld toont hoe PowerPoint naar HTML met notities te converteren met C++. 
```cpp
...
```
 Het volgende voorbeeld toont hoe PowerPoint naar HTML met originele lettertypen te converteren met C++. 
```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// Sluit standaard presentatielettertypen uit
...
```
 Het volgende voorbeeld toont hoe PowerPoint naar HTML met afbeeldingen van hoge kwaliteit op 150 DPI te converteren met C++. 
```cpp
...
```
 Het volgende voorbeeld toont hoe PowerPoint naar HTML met afbeeldingen van volledige kwaliteit te converteren met C++. 
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
 Het volgende voorbeeld toont hoe [Slide](../../slide/) naar HTML te converteren met C++. 
```cpp
```
...
```
 Het volgende voorbeeld toont hoe LinkAllFontsHtmlController is geïmplementeerd met C++. 
```cpp
...
```
 Het volgende voorbeeld toont hoe PowerPoint te converteren naar responsieve HTML met C++. 
```cpp
