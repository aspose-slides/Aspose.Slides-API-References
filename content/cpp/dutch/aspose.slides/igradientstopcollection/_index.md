...
description: Representeert een verzameling gradientstops.
type: docs
weight: 2419
url: /nl/aspose.slides/igradientstopcollection/
---
## IGradientStopCollection klasse


Representeert een verzameling gradientstops.
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) | Maakt de nieuwe gradientstop en voegt deze toe aan het einde van de collectie. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) | Maakt de nieuwe gradientstop en voegt deze toe aan het einde van de collectie. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) | Maakt de nieuwe gradientstop en voegt deze toe aan het einde van de collectie. |
...
| virtual void [Clear](./clear/)() | Verwijdert alle gradientstops uit een collectie. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl puntkommavergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl puntkommavergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Retourneert een waarde die aangeeft of toegang tot de collectie gesynchroniseerd is (thread-safe). Alleen-lezen **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) | Retourneert de gradientstop op index. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) | Maakt de nieuwe gradientstop en voegt deze in de collectie in op de opgegeven index. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) | Maakt de nieuwe gradientstop en voegt deze in de collectie in op de opgegeven index. |
| virtual void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) | Maakt de nieuwe gradientstop en voegt deze in de collectie in op de opgegeven index. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert geen gegevens, initialiseert alleen een nieuw object en schakelt copy-constructie van subklassen in. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert geen gegevens, initialiseert alleen een nieuw object en schakelt copy-constructie van subklassen in. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Verwijdert een gradientstop op de opgegeven index. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verlaagt de gedeelde referentieteller met de opgegeven waarde. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Staat toe om pointers in containers naar zwakke modus te wisselen. |
