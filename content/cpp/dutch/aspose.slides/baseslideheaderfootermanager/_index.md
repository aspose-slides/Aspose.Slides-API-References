...
description: Representeert manager die gedrag van voettekst-, datum-tijd- en paginanummer-plaatsaanduidingen voor alle dia-types bevat.
type: docs
weight: 183
...
Representeert manager die het gedrag van de voettekst-, datum-tijd- en paginanummer-plaatsaanduidingen voor alle dia-types bevat.
...
| **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() override | Haalt een waarde op die aangeeft dat een datum-tijd-plaatsaanduiding aanwezig is. Read**bool**. |
| **bool** [get_IsFooterVisible](./get_isfootervisible/)() override | Haalt een waarde op die aangeeft dat een voettekst-plaatsaanduiding aanwezig is. Read **bool**. |
| **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() override | Haalt een waarde op die aangeeft dat een paginanummer-plaatsaanduiding aanwezig is. Read**bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copyconstructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt het mogelijk kopieerconstructie van subklassen. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toekenning-operator. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt het mogelijk kopieerconstructie van subklassen. |
...
| void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) override | Stelt de tekst in voor de datum-tijd-plaatsaanduiding van de dia. |
| void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) override | Wijzigt de zichtbaarheid van de datum-tijd-plaatsaanduiding van de dia. |
| void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) override | Stelt de tekst in voor de voettekst-plaatsaanduiding van de dia. |
| void [SetFooterVisibility](./setfootervisibility/)(**bool**) override | Wijzigt de zichtbaarheid van de voettekst-plaatsaanduiding van de dia. |
| void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) override | Wijzigt de zichtbaarheid van de paginanummer-plaatsaanduiding van de dia. |
