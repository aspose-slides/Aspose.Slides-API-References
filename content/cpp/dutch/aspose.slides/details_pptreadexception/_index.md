...
description: Vertegenwoordigt een exceptie die wordt gegooid bij leesfouten van een presentatie.
type: docs
weight: 690
url: /nl/aspose.slides/details_pptreadexception/
---
## Details_PptReadException klasse


Vertegenwoordigt een exceptie die wordt gegooid bij fouten bij het lezen van een presentatie.
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Retourneert een 32-bit geheel getal dat een HRESULT-code is die is gekoppeld aan de exceptie die wordt weergegeven door het huidige object. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th template-argument in als een zwakke pointer (in plaats van gedeeld). Hiermee kun je pointers in containers naar zwakke modus schakelen. |
