...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() override | Retourneert de notitieslide voor de huidige slide en maakt er één aan als die er niet bestaat. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() override | Retourneert de notitieslide voor de huidige slide. Retourneert null als de slide geen notitieslide heeft. Alleen-lezen [INotesSlide](../inotesslide/). |
...
| void [Lock](../../system/object/lock/)() | Implementeert lock()-statement vergrendeling van C#. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-waarschuwingsobject. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopie-constructor. Kopieert niets echt, initialiseert alleen een nieuw object en maakt het mogelijk om subklassen te copy-constructeren. |
...
| void [RemoveNotesSlide](./removenotesslide/)() override | Verwijdert de notitieslide van de huidige slide. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n-de sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Stelt schakelen van pointers in containers naar zwakke modus mogelijk. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert lock()-statement ontgrendeling van C#. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-waarschuwingsobject. |
...
Het volgende voorbeeld toont hoe notities toe te voegen aan een specifieke PowerPoint [Presentation](../presentation/) slide.
```cpp
...
```
 Het volgende voorbeeld toont hoe notities te verwijderen van een specifieke slide van PowerPoint [Presentation](../presentation/).
```cpp
