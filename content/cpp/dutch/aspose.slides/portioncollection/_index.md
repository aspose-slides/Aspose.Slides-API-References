...
Vertegenwoordigt een verzameling van porties.
...
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Voegt een [Portion](../portion/) toe aan het einde van de collectie. |
| [iterator](./iterator/) [begin](./begin/)() | Haalt een iterator op die naar het eerste element (indien aanwezig) van de collectie wijst. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Haalt een iterator op die naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie wijst. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Haalt een iterator op die naar het eerste const-gekwalificeerde element (indien aanwezig) van de collectie wijst. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Haalt een iterator op die direct na het laatste const-gekwalificeerde element (indien aanwezig) van de collectie wijst. |
| void [Clear](./clear/)() override | Verwijdert alle elementen uit de collectie. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Bepaalt of de [ICollection](../../system.collections.generic/icollection/) een specifieke waarde bevat. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>\>, **int32_t**) | Kopieert de elementen van de [ICollection](../../system.collections.generic/icollection/) naar een [System::Array](../../system/array/), beginnend bij een bepaalde [System::Array](../../system/array/) index. |
| [iterator](./iterator/) [end](./end/)() | Haalt een iterator op die direct na het laatste element (indien aanwezig) van de collectie wijst. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Haalt een iterator op die direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie wijst. |
...
| **int32_t** [get_Count](./get_count/)() override | Haalt het aantal werkelijk in de collectie aanwezige elementen op. Alleen-lezen **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Haalt een waarde op die aangeeft of de [ICollection](../../system.collections.generic/icollection/) alleen-lezen is. Alleen-lezen **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haalt de referentieteller-datastructuur op die aan het object is gekoppeld. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de collectie iterereert. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analoge van C# [Object.GetHashCode()](../../system/object/gethashcode/)-methode. Maakt hashen van aangepaste objecten mogelijk. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Haalt het werkelijke type van het object op. Analoge van C# [System.Object.GetType()](../../system/object/gettype/)-aanroep. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [idx_get](./idx_get/)(**int32_t**) override | Haalt het element op op de opgegeven index. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | Haalt het element op op de opgegeven index. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Bepaalt de index van een specifiek item in de [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Voegt een [Portion](../portion/) toe aan de collectie op de opgegeven index. |
...
| void [Lock](../../system/object/lock/)() | Implementeert het C# lock()-statement voor vergrendeling. Direct aanroepen of gebruik [LockContext](../../system/lockcontext/) bewakingsobject. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiërende constructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt kopie-constructie van subklassen mogelijk. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) override | Verwijdert het eerste optreden van een specifiek object uit de [ICollection](../../system.collections.generic/icollection/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n-de sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Maakt het wisselen van pointers in containers naar zwakke modus mogelijk. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert C# lock()-statement voor ontgrendeling. Direct aanroepen of gebruik [LockContext](../../system/lockcontext/) bewakingsobject. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Haalt een iterator op die naar het eerste element (indien aanwezig)of de const-gekwalificeerde instantie van de collectie wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Haalt een iterator op die naar het eerste element (indien aanwezig) van de collectie wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Haalt een iterator op die direct na het laatste element (indien aanwezig)of de const-gekwalificeerde instantie van de collectie wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Haalt een iterator op die direct na het laatste element (indien aanwezig) van de collectie wijst. |
...
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Een verzamelingstype waarvan de iterator-types worden gebruikt als iterator-types in de huidige collectie. |
...
* Klasse [IPortionCollection](../iportioncollection/)
