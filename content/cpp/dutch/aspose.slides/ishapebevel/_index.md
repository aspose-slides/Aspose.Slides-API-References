...
description: Stelt de eigenschappen van het hoofdvlak van de vorm voor.
type: docs
weight: 3654
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Beveltype. Lees [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Bevelhoogte. Lees **double**. |
| virtual **double** [get_Width](./get_width/)() | Bevelbreedte. Lees **double**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieconstructor. Kopieert echt niets, initialiseert alleen een nieuw object en maakt copy-constructie van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert echt niets, initialiseert alleen een nieuw object en maakt copy-constructie van subklassen mogelijk. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | Beveltype. Schrijf [BevelPresetType](../bevelpresettype/). |
| virtual void [set_Height](./set_height/)(**double**) | Bevelhoogte. Schrijf **double**. |
| virtual void [set_Width](./set_width/)(**double**) | Bevelbreedte. Schrijf **double**. |
