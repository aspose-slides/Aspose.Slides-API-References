...
type: docs
weight: 4109
url: /nl/aspose.slides/itexthighlightingoptions/
---
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n'te sjabloonargument in als een zwakke pointer (in plaats van gedeelde). Maakt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
...
Verouderd
:   De interface [ITextHighlightingOptions](./) wordt verwijderd na de release van versie 24.10.
