...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)() | Creëert een lege tekstgedeelte. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)([System::String](../../system/string/)) | Creëert een tekstgedeelte van de opgegeven string. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | Creëert een gedeelte met gebruik van opgegeven gedeelte-gegevens. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl drijvende-kommagelijkcomparatie waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl drijvende-kommagelijkcomparatie waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt n'th sjabloon-argument in op een zwakke pointer (in plaats van gedeeld). Stelt het wisselen van pointers in containers naar zwakke modus mogelijk. |
