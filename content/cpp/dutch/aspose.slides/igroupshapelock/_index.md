...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-style zwevendekommagetalvergelijking waarbij twee NaNs als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-style zwevendekommagetalvergelijking waarbij twee NaNs als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| virtual **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() | Bepaalt of de vorm de beeldverhouding moet behouden bij het schalen. Lezen **bool**. |
...
| virtual **bool** [get_NoLocks](../ibaseshapelock/get_nolocks/)() | Retourneert true als alle lock-flags zijn uitgeschakeld. Alleen-lezen **bool**. |
...
| virtual **bool** [get_SizeLocked](./get_sizelocked/)() | Bepaalt of het dimensioneren van deze vorm verboden is. Lezen **bool**. |
| virtual **bool** [get_UngroupingLocked](./get_ungroupinglocked/)() | Bepaalt of het splitsen van deze groupshape verboden is. Lezen **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haalt de referentietellergegevensstructuur die bij het object hoort. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog van C# [Object.GetHashCode()](../../system/object/gethashcode/) methode. Maakt hashcode genereren voor aangepaste objecten mogelijk. |
...
| virtual void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) | Bepaalt of de vorm de beeldverhouding moet behouden bij het schalen. Schrijven **bool**. |
...
| virtual void [set_SizeLocked](./set_sizelocked/)(**bool**) | Bepaalt of het dimensioneren van deze vorm verboden is. Schrijven **bool**. |
| virtual void [set_UngroupingLocked](./set_ungroupinglocked/)(**bool**) | Bepaalt of het splitsen van deze groupshape verboden is. Schrijven **bool**. |
