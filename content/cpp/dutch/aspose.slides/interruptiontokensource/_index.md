...
description: Stelt de bron van InterruptionToken voor.
type: docs
weight: 3069
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl zwevendekommagelijk vergelijken waarbij twee NaN's als gelijk worden beschouwd, ook al is NaN volgens IEC 60559:1989 niet gelijk aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl zwevendekommagelijk vergelijken waarbij twee NaN's als gelijk worden beschouwd, ook al is NaN volgens IEC 60559:1989 niet gelijk aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Retourneert true als onderbreking is aangevraagd, anders false. |
| [System::SharedPtr](../../system/sharedptr/)\<[IInterruptionToken](../iinterruptiontoken/)\> [get_Token](./get_token/)() override | Retourneert een nieuw token gebonden aan deze [InterruptionTokenSource](./). |
...
| void [Interrupt](./interrupt/)() override | Initialiseer verzoek voor onderbreking. |
|  [InterruptionTokenSource](./interruptiontokensource/)() | Maakt een nieuw [InterruptionTokenSource](./) aan. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieer-constructor. Kopieert niets, initialiseert simpelweg een nieuw object en stelt het mogelijk om subklassen te kopiëren. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets, initialiseert simpelweg een nieuw object en stelt het mogelijk om subklassen te kopiëren. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'te sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Stelt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
...
* Klasse [IInterruptionTokenSource](../iinterruptiontokensource/)
