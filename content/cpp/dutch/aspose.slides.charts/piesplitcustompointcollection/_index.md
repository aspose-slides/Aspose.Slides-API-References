...
description: Stelt een verzameling punten voor voor het splitsen van een punt in een bar-of-pie of pie-of-pie grafiek met een aangepaste splitsing.
type: docs
weight: 1314
...
| Method | Beschrijving |
| --- | --- |
| void [Add](./add/)(const **int32_t**\&) override | Voegt een datapunt toe op basis van zijn index in de puntenverzameling van de bovenliggende serie. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Voegt een datapunt toe aan de verzameling. |
| [iterator](./iterator/) [begin](./begin/)() | Retourneert een iterator die naar het eerste element (indien aanwezig) van de verzameling wijst. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Retourneert een iterator die naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling wijst. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Retourneert een iterator die naar het eerste const-gekwalificeerde element (indien aanwezig) van de verzameling wijst. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Retourneert een iterator die direct na het laatste const-gekwalificeerde element (indien aanwezig) van de verzameling wijst. |
| void [Clear](./clear/)() override | Verwijdert alle items uit de [ICollection](../../system.collections.generic/icollection/). |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) const override | Bepaalt of de [ICollection](../../system.collections.generic/icollection/) een specifieke waarde bevat. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>, **int32_t**) override | Kopieert de elementen van de [ICollection](../../system.collections.generic/icollection/) naar een [System::Array](../../system/array/), beginnend bij een bepaalde [System::Array](../../system/array/) index. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopieert alle elementen van de verzameling naar bestaande array-elementen. |
| [iterator](./iterator/) [end](./end/)() | Retourneert een iterator die direct na het laatste element (indien aanwezig) van de verzameling wijst. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Retourneert een iterator die direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling wijst. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Vergelijkt objecten met behulp van C# [Object.Equals](../../system/object/equals/)-semantiek. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt referentietype-objecten in C#-stijl. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt waardetype-objecten in C#-stijl. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Draagt C#-stijl zwevendekomma-vergelijking na waarbij twee NaN's als gelijk worden beschouwd, ook al is volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Draagt C#-stijl zwevendekomma-vergelijking na waarbij twee NaN's als gelijk worden beschouwd, ook al is volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor interne doeleinden. |
| **int32_t** [get_Count](./get_count/)() const override | Retourneert het aantal grafiekdatapunten. Alleen-lezen **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Haalt een waarde op die aangeeft of de [ICollection](../../system.collections.generic/icollection/) alleen-lezen is. Alleen-lezen **bool**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() | Retourneert een waarde die aangeeft of de toegang tot de verzameling gesynchroniseerd (thread-safe) is. Alleen-lezen **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Retourneert een synchronisatieroot. Alleen-lezen [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de verzameling iterereert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) override | Retourneert het grafiekdatapunt voor de opgegeven index. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Sla een opgegeven aantal aaneengesloten elementen aan het begin van een reeks over en retourneer de rest. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert in feite niets, initialiseert gewoon een nieuw object en maakt copy-constructie van subklassen mogelijk. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Verwijdert een item uit de verzameling. |
| void [Remove](./remove/)(**int32_t**) override | Verwijdert een item uit de verzameling op basis van de index in de puntenverzameling van de bovenliggende serie. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Retourneert een iterator die naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Retourneert een iterator die naar het eerste element (indien aanwezig) van de verzameling wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Retourneert een iterator die direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Retourneert een iterator die direct na het laatste element (indien aanwezig) van de verzameling wijst. |
...
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Een verzamelingstype waarvan de iterator-types worden gebruikt als iterator-types in de huidige verzameling. |
...
* Klasse [IPieSplitCustomPointCollection](../ipiesplitcustompointcollection/)
