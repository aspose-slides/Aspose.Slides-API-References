...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Retourneert de wandvulling, lijn, effect, 3d-stijlen. Alleen-lezen [IFormat](../iformat/). |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | Retourneert of stelt het afbeeldingstype in. Lezen [PictureType](../picturetype/). |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | Retourneert de dikte van de wanden als een percentage van de grootste dimensie van het plotvolume. Lezen **int32_t**. |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | Retourneert of stelt het afbeeldingstype in. Schrijf [PictureType](../picturetype/). |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | Stelt de dikte van de wanden in als een percentage van de grootste dimensie van het plotvolume. Schrijf **int32_t**. |
