...
description: Vertegenwoordigt een verzameling van ChartCategory
type: docs
weight: 79
...
Vertegenwoordigt een verzameling van [ChartCategory](../chartcategory/)
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Als de categorie bestaat in de verzameling, retourneer deze. Anders wordt een nieuwe grafiekcategorie gemaakt van [IChartDataCell](../ichartdatacell/) en toegevoegd aan de verzameling. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Maakt een nieuw [ChartCategory](../chartcategory/) van de waarde en voegt het toe aan de verzameling. |
| [iterator](./iterator/) [begin](./begin/)() | Haalt iterator op die wijst naar het eerste element (indien aanwezig) van de verzameling. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Haalt iterator op die wijst naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Haalt iterator op die wijst naar het eerste const-gekwalificeerde element (indien aanwezig) van de verzameling. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Haalt iterator op die wijst direct na het laatste const-gekwalificeerde element (indien aanwezig) van de verzameling. |
| void [Clear](./clear/)() override | Verwijdert alle elementen uit de verzameling. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>, **int32_t**) override | Kopieert alle elementen van de verzameling naar de opgegeven array. |
| [iterator](./iterator/) [end](./end/)() | Haalt iterator op die wijst direct na het laatste element (indien aanwezig) van de verzameling. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Haalt iterator op die wijst direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Vergelijkt objecten met behulp van C# [Object.Equals](../../system/object/equals/)-semantiek. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt referentietype-objecten in C#-stijl. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt waardetype-objecten in C#-stijl. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert zwevend-kommagetallenvergelijking in C#-stijl waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert zwevend-kommagetallenvergelijking in C#-stijl waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() override | Retourneert het aantal gebruikte categorie-groeperingsniveaus. Is meer dan één voor meerlagige categorieën. Alleen-lezen **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Retourneert een waarde die aangeeft of de toegang tot de List gesynchroniseerd is (thread-safe). Alleen-lezen **bool**. |
...
| **bool** [get_UseCells](./get_usecells/)() override | Indien true wordt een werkblad gebruikt voor het opslaan van categorieën (dit geval ondersteunt meerlagige categorieën). Indien false wordt een werkblad NIET gebruikt voor het opslaan van waarden (en dit geval ondersteunt geen meerlagige categorieën). Alleen-lezen **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de verzameling iterereert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) override | Haalt het element op op de opgegeven index. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | Zoekt naar de opgegeven [ChartCategory](../chartcategory/) en retourneert de nul-gebaseerde index van de eerste verschijning binnen de gehele verzameling. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Sla een opgegeven aantal aaneengesloten elementen over aan het begin van een reeks en retourneer de rest. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) override | Verwijdert de opgegeven waarde. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Verwijdert het element op de opgegeven index. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Vermindert de gedeelde referentieteller met de opgegeven waarde. |
| void [set_UseCells](./set_usecells/)(**bool**) override | Indien true wordt een werkblad gebruikt voor het opslaan van categorieën (dit geval ondersteunt meerlagige categorieën). Indien false wordt een werkblad NIET gebruikt voor het opslaan van waarden (en dit geval ondersteunt geen meerlagige categorieën). Schrijf **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n'te sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Haalt iterator op die wijst direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Haalt iterator op die wijst direct na het laatste element (indien aanwezig) van de verzameling. |
