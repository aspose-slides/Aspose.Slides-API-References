...
| [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](./get_chart/)() override | Retourneert grafiek. Alleen-lezen [IChart](../ichart/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Retourneert de lijn-, vul- en effectstijlen van een object. Alleen-lezen [IFormat](../iformat/). |
| **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() override | Waar als de grafiekdatatabel horizontale celranden heeft. Lezen **bool**. |
| **bool** [get_HasBorderOutline](./get_hasborderoutline/)() override | Waar als de grafiekdatatabel omrande randen heeft. Lezen **bool**. |
| **bool** [get_HasBorderVertical](./get_hasbordervertical/)() override | Waar als de grafiekdatatabel verticale celranden heeft. Lezen **bool**. |
| **bool** [get_ShowLegendKey](./get_showlegendkey/)() override | Waar als de legenda-sleutel van het datalabel zichtbaar is. Lezen **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartTextFormat](../icharttextformat/)\> [get_TextFormat](./get_textformat/)() override | Retourneert tekstindeling. Alleen-lezen [IChartTextFormat](../icharttextformat/). |
...
| void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) override | Waar als de grafiekdatatabel horizontale celranden heeft. Schrijf **bool**. |
| void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) override | Waar als de grafiekdatatabel omrande randen heeft. Schrijf **bool**. |
| void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) override | Waar als de grafiekdatatabel verticale celranden heeft. Schrijf **bool**. |
| void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) override | Waar als de legenda-sleutel van het datalabel zichtbaar is. Schrijf **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n'te sjabloonargument in als een zwakke pointer (in plaats van shared). Maakt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
