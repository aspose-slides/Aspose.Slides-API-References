...
description: Vertegenwoordigt marker van een chert.
type: docs
weight: 1119
...
Vertegenwoordigt marker van een chert.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Haalt de marker-vulling op. Alleen-lezen [IFormat](../iformat/). |
| virtual **int32_t** [get_Size](./get_size/)() | Vertegenwoordigt de marker-grootte in een lijndiagram, spreidingsdiagram of radardiagram. Leest **int32_t**. |
| virtual [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() | Vertegenwoordigt de marker-stijl in een lijndiagram, spreidingsdiagram of radardiagram. Leest [MarkerStyleType](../markerstyletype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt het mogelijk om subclasses te kopiëren. |
...
| virtual void [set_Size](./set_size/)(**int32_t**) | Vertegenwoordigt de marker-grootte in een lijndiagram, spreidingsdiagram of radardiagram. Schrijf **int32_t**. |
| virtual void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) | Vertegenwoordigt de marker-stijl in een lijndiagram, spreidingsdiagram of radardiagram. Schrijf [MarkerStyleType](../markerstyletype/). |
