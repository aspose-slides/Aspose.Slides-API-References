...
description: Biedt toegang tot de assen van een grafiek.
type: docs
weight: 521
...
Biedt toegang tot de assen van een grafiek.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_HorizontalAxis](./get_horizontalaxis/)() | Haalt de horizontale as van de grafiek op. Alleen-lezen [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryHorizontalAxis](./get_secondaryhorizontalaxis/)() | Haalt de secundaire horizontale as van de grafiek op. Alleen-lezen [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SecondaryVerticalAxis](./get_secondaryverticalaxis/)() | Haalt de secundaire verticale as van de grafiek op. Alleen-lezen [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_SeriesAxis](./get_seriesaxis/)() | Haalt de seriesas van de grafiek op. Alleen-lezen [IAxis](../iaxis/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAxis](../iaxis/)\> [get_VerticalAxis](./get_verticalaxis/)() | Haalt de verticale as van de grafiek op. Alleen-lezen [IAxis](../iaxis/). |
