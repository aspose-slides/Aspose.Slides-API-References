...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [Add](./add/)([TrendlineType](../trendlinetype/)) | Voegt de nieuwe [Trendline](../trendline/) toe aan het einde van een collectie en retourneert deze. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Haalt het aantal elementen op dat daadwerkelijk in de collectie aanwezig is. Alleen-lezen **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [idx_get](./idx_get/)(**int32_t**) | Haalt het element op op de opgegeven index. Alleen-lezen [ITrendline](../itrendline/). |
...
| void [Lock](../../system/object/lock/)() | Implementeert C# lock() statement locking. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) waarschuwingsobject. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzings-operator. Kopieert niets echt, initialiseert alleen een nieuw object en maakt kopiëren van subklassen mogelijk. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\>) | Verwijdert de opgegeven waarde. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert C# lock() statement unlocking. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) waarschuwingsobject. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Haalt de implementatie van de const-eind-iterator voor de huidige container op. |
