...
description: Vertegenwoordigt een collectie van Trendline
type: docs
weight: 1379
...
Vertegenwoordigt een collectie van [Trendline](../trendline/)
...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [Add](./add/)([TrendlineType](../trendlinetype/)) override | Voegt de nieuwe [Trendline](../trendline/) toe aan het einde van een collectie en retourneert deze. |
| [iterator](./iterator/) [begin](./begin/)() | Haal iterator op die wijst naar het eerste element (indien aanwezig) van de collectie. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Haal iterator op die wijst naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Haal iterator op die wijst naar het eerste const-gekwalificeerde element (indien aanwezig) van de collectie. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Haal iterator op die wijst direct na het laatste const-gekwalificeerde element (indien aanwezig) van de collectie. |
| [iterator](./iterator/) [end](./end/)() | Haal iterator op die wijst direct na het laatste element (indien aanwezig) van de collectie. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Haal iterator op die wijst direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Vergelijkt objecten met C# [Object.Equals](../../system/object/equals/) semantiek. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt objecten van referentietype in C#-stijl. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt objecten van waardetype in C#-stijl. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl zwevend-punt vergelijking waarbij twee NaN-waarden als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl zwevend-punt vergelijking waarbij twee NaN-waarden als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| **int32_t** [get_Count](./get_count/)() override | Haal het aantal elementen op dat daadwerkelijk in de collectie aanwezig is. Alleen-lezen **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de collectie iterereert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\> [idx_get](./idx_get/)(**int32_t**) override | Haal het element op op de opgegeven index. Alleen-lezen [Trendline](../trendline/). |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Sorteert de elementen van een reeks in oplopende volgorde volgens de sleutelwaarden die zijn geselecteerd door keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Sorteert de elementen van een reeks in aflopende volgorde volgens de sleutelwaarden die zijn geselecteerd door keySelector. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert niets echt, initialiseert enkel een nieuw object en maakt het mogelijk om subklassen te copy-constructeren. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Assignatie-operator. Kopieert niets echt, initialiseert enkel een nieuw object en maakt het mogelijk om subklassen te copy-constructeren. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ITrendline](../itrendline/)\>) override | Verwijdert de opgegeven waarde. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verlaagt de gedeelde referentieteller met de opgegeven waarde. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n'te sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Hiermee kan men pointers in containers naar zwakke modus schakelen. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Haal iterator op die wijst naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Haal iterator op die wijst naar het eerste element (indien aanwezig) van de collectie. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Haal iterator op die wijst direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Haal iterator op die wijst direct na het laatste element (indien aanwezig) van de collectie. |
...
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Een collcatietype waarvan de iterator-typen worden gebruikt als iterator-typen in de huidige collectie. |
...
* Klasse [ITrendlineCollection](../itrendlinecollection/)
