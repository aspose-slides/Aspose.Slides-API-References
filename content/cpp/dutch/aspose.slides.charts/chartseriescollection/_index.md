...
description: Stelt een verzameling van ChartSeries voor
type: docs
weight: 287
...
Stelt een verzameling van [ChartSeries](../chartseries/) voor.
...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) override | Maakt een nieuwe chart series aan en voegt deze toe aan de verzameling. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) override | Maakt een nieuwe chart series aan vanuit [ChartDataCell](../chartdatacell/) en voegt deze toe aan de verzameling. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) override | Maakt een nieuwe chart series aan vanuit [ChartCellCollection](../chartcellcollection/) en voegt deze toe aan de verzameling. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) override | Maakt een nieuwe chart series aan vanuit een waarde en voegt deze toe aan de verzameling. |
| [iterator](./iterator/) [begin](./begin/)() | Geeft een iterator die naar het eerste element (indien aanwezig) van de verzameling wijst. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Geeft een iterator die naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling wijst. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Geeft een iterator die naar het eerste const-gekwalificeerde element (indien aanwezig) van de verzameling wijst. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Geeft een iterator die direct na het laatste const-gekwalificeerde element (indien aanwezig) van de verzameling wijst. |
| void [Clear](./clear/)() override | Verwijdert alle besturingselementen uit de verzameling. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>, **int32_t**) override | Kopieert alle elementen van de verzameling naar de opgegeven array. |
| [iterator](./iterator/) [end](./end/)() | Geeft een iterator die direct na het laatste element (indien aanwezig) van de verzameling wijst. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Geeft een iterator die direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling wijst. |
...
| **int32_t** [get_Count](./get_count/)() override | Retourneert het aantal objecten in de verzameling. Alleen-lezen **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de verzameling iterereert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [idx_get](./idx_get/)(**int32_t**) override | Geeft het element op de opgegeven index. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Zoekt naar de opgegeven [ChartSeries](../chartseries/) en retourneert de nulgebaseerde index van de eerste voorkoming in de volledige verzameling. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) override | Maakt een nieuwe chart series aan en voegt deze in de verzameling in. |
...
| void [Lock](../../system/object/lock/)() | Implementeert het vergrendelen van een C# lock()-statement. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-waarnemingsobject. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Verwijdert de opgegeven waarde. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Verwijdert een ActiveX-besturingselement dat op een opgegeven positie in de verzameling is opgeslagen. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verlaagt de gedeelde referentieteller met de opgegeven waarde. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n'te sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Stelt overschakelen van pointers in containers naar zwakke modus mogelijk. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het ontgrendelen van een C# lock()-statement. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-waarnemingsobject. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Geeft een iterator die naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Geeft een iterator die naar het eerste element (indien aanwezig) van de verzameling wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Geeft een iterator die direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Geeft een iterator die direct na het laatste element (indien aanwezig) van de verzameling wijst. |
...
| [virtualized_iterator_element](./virtualized_iterator_element/) | Vervirtualiseerd elementtype. |
| [virtualized_iterator](./virtualized_iterator/) | Vervirtualiseerd type. |
