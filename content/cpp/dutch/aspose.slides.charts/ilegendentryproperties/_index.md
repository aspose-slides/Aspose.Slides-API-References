...
description: Stelt legende-eigenschappen van een grafiek voor.
type: docs
weight: 1106
...
| virtual **bool** [get_Hide](./get_hide/)() | Retourneert de verbergingsvlag van legendavermelding. Lezen **bool**. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog van C# [Object.GetHashCode()](../../system/object/gethashcode/)-methode. Maakt het mogelijk aangepaste objecten te hashen. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert in feite niets, initialiseert alleen een nieuw object en maakt het mogelijk subklassen te copy-construeren. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert in feite niets, initialiseert alleen een nieuw object en maakt het mogelijk subklassen te copy-construeren. |
...
| virtual void [set_Hide](./set_hide/)(**bool**) | Stelt de verbergingsvlag van legendavermelding in. Schrijven **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n'th sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk pointers in containers over te schakelen naar zwakke modus. |
