...
description: Representeert gegevenslabel van gegevenspuntniveau. Toegepast op Treemap- en Sunburst-serietypen. Alleen-lezen IDataLabel.
type: docs
weight: 14
url: /nl/aspose.slides.charts/ichartdatapointlevel/get_label/
---
## IChartDataPointLevel::get_Label() methode

Stelt gegevenslabel van gegevenspuntniveau voor. Toegepast op Treemap- en Sunburst-series typen. Alleen-lezen [IDataLabel](../../idatalabel/).
