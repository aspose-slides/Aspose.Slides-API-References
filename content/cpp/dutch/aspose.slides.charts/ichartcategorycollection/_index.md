...
description: Stelt een verzameling van IChartCategory voor
type: docs
weight: 599
...
Stelt een verzameling van [IChartCategory](../ichartcategory/) voor
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Als de categorie bestaat in de verzameling, retourneer deze. Anders maakt het een nieuwe chartcategorie aan vanuit [IChartDataCell](../ichartdatacell/) en voegt deze toe aan de verzameling. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Maakt een nieuwe [IChartCategory](../ichartcategory/) van de waarde en voegt deze toe aan de verzameling. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Krijgt een iterator die wijst naar het eerste element (indien aanwezig) van de verzameling. Deze iterator kan niet worden gebruikt om een verwezen object te wijzigen omdat [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) een kopie-object van T retourneert. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Krijgt een iterator die wijst naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Krijgt een iterator die wijst naar het eerste const-gekwalificeerde element (indien aanwezig) van de verzameling. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Krijgt een iterator die direct na het laatste const-gekwalificeerde element (indien aanwezig) van de verzameling wijst. |
| virtual void [Clear](./clear/)() | Verwijdert alle elementen uit de verzameling. |
| virtual void [CopyTo](../../aspose.slides/igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Kopieert alle elementen uit de verzameling naar de opgegeven array. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Krijgt een iterator die direct na het laatste element (indien aanwezig) van de verzameling wijst. Deze iterator kan niet worden gebruikt om een verwezen object te wijzigen omdat [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) een kopie-object van T retourneert. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Krijgt een iterator die direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling wijst. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Vergelijkt objecten met behulp van C# [Object.Equals](../../system/object/equals/)-semantiek. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt referentietype-objecten in C#-stijl. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt waardetype-objecten in C#-stijl. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-achtige floating-point vergelijking waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan een waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-achtige floating-point vergelijking waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan een waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor interne doeleinden. |
| virtual **int32_t** [get_Count](../../aspose.slides/igenericcollection/get_count/)() | Retourneert het aantal gedragingen in een verzameling. Alleen-lezen **int32_t**. |
| virtual **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() | Retourneert het aantal gebruikte categorie-groeperingsniveaus. Is meer dan één voor meervoudige niveaus. Alleen-lezen **int32_t**. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Retourneert een waarde die aangeeft of de toegang tot de verzameling gesynchroniseerd (thread-safe) is. Alleen-lezen **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../../aspose.slides/igenericcollection/get_syncroot/)() | Retourneert een synchronisatiewortel. Alleen-lezen [System::Object](../../system/object/). |
| virtual **bool** [get_UseCells](./get_usecells/)() | Als waar, dan wordt een werkblad gebruikt voor het opslaan van categorieën (ondersteunt meervoudige niveaus). Als onwaar, dan wordt een werkblad NIET gebruikt voor het opslaan van waarden (en ondersteunt dan geen meervoudige niveaus). Leest **bool**. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../../system.collections.generic/ienumerable/getenumerator/)() | Krijgt een enumerator. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) | Krijgt het element op de opgegeven index. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Zoekt naar de opgegeven [IChartCategory](../ichartcategory/) en retourneert de nul-gebaseerde index van de eerste voorkoming binnen de gehele verzameling. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Berekent het gemiddelde van een reeks waarden die verkregen worden door een transformatiefunctie toe te passen op elk element van de invoerreeks. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Retourneert het eerste element van de reeks dat aan een voorwaarde voldoet, of een standaardwaarde als geen element voldoet. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projektert elk element van een reeks en combineert de resulterende reeksen tot één reeks. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert niets, maar initialiseert een nieuw object en maakt kopiëren van subklassen mogelijk. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Verwijdert de opgegeven waarde. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Verwijdert het element op de opgegeven index. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Vermindert de gedeelde referentieteller met de opgegeven waarde. |
| virtual void [set_UseCells](./set_usecells/)(**bool**) | Als waar, dan wordt een werkblad gebruikt voor het opslaan van categorieën (ondersteunt meervoudige niveaus). Als onwaar, dan wordt een werkblad NIET gebruikt voor het opslaan van waarden (en ondersteunt dan geen meervoudige niveaus). Schrijf **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n'te sjabloonargument in als een zwakke pointer (i.p.v. gedeeld). Maakt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
