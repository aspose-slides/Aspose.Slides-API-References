...
description: Specificeert de exacte positie van een grafiekonderdeel.
type: docs
weight: 1067
...
Specificeert de exacte positie van een grafiekonderdeel.
...
| virtual **float** [get_Bottom](./get_bottom/)() | Haalt de bovenkant van het grafiekelement op als een fractie van de hoogte van de grafiek. Alleen-lezen **float**. |
...
| virtual **float** [get_Height](./get_height/)() | Specificeert de hoogte van het grafiekelement als een fractie van de hoogte van de grafiek. Lezen **float**. |
...
| virtual **float** [get_Right](./get_right/)() | Haalt de rechterkant van het grafiekelement op als een fractie van de breedte van de grafiek. Alleen-lezen **float**. |
...
| virtual **float** [get_Width](./get_width/)() | Specificeert de breedte van het grafiekelement als een fractie van de breedte van de grafiek. Lezen **float**. |
| virtual **float** [get_X](./get_x/)() | Specificeert de x-positie (links) van het grafiekelement als een fractie van de breedte van de grafiek. Lezen **float**. |
| virtual **float** [get_Y](./get_y/)() | Specificeert de bovenkant van het grafiekelement als een fractie van de hoogte van de grafiek. Lezen **float**. |
...
| virtual void [set_Height](./set_height/)(**float**) | Specificeert de hoogte van het grafiekelement als een fractie van de hoogte van de grafiek. Schrijf **float**. |
| virtual void [set_Width](./set_width/)(**float**) | Specificeert de breedte van het grafiekelement als een fractie van de breedte van de grafiek. Schrijf **float**. |
| virtual void [set_X](./set_x/)(**float**) | Specificeert de x-positie (links) van het grafiekelement als een fractie van de breedte van de grafiek. Schrijf **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Specificeert de bovenkant van het grafiekelement als een fractie van de hoogte van de grafiek. Schrijf **float**. |
