...
description: Stelt een collectie punten voor die getekend moeten worden in de tweede taart of balk op een bar-of-pie of pie-of-pie grafiek met een aangepaste splitsing.
type: docs
weight: 1158
url: /nl/aspose.slides.charts/ipiesplitcustompointcollection/
---
## IPieSplitCustomPointCollection klasse

Stelt een collectie punten voor die getekend moeten worden in de tweede taart of balk bij een bar-of-pie- of pie-of-pie-grafiek met een aangepaste splitsing.
...
| --- | --- |
| virtual void [Add](./add/)(const **int32_t**\&) | Voegt een datapunt toe op basis van zijn index in de puntenverzameling van de bovenliggende reeks. |
...
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopieert alle elementen van de collectie naar bestaande array-elementen. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevende-kommapcomparatie waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevende-kommapcomparatie waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../../system.collections.generic/icollection/get_syncroot/)() const | Haalt het object op waardoor de collectie wordt gesynchroniseerd. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) | Retourneert een grafiekdatapunt op basis van index. |
...
| void [Lock](../../system/object/lock/)() | Implementeert de C# lock()-statement locken. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-bewakingsobject. |
...
| virtual void [Remove](./remove/)(**int32_t**) | Verwijdert een item uit de collectie op basis van zijn index in de puntenverzameling van de bovenliggende reeks. |
| virtual **bool** [Remove](../../system.collections.generic/icollection/remove/)(const T\&) | Verwijdert element uit de collectie. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Vermindert de gedeelde referentieteller met een opgegeven waarde. |
