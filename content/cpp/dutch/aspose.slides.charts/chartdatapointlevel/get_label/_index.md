...
description: Stelt het gegevenslabel van het datapunteniveau voor. Toegepast op Treemap- en Sunburst-series types. Alleen-lezen IDataLabel.
type: docs
weight: 14
url: /nl/aspose.slides.charts/chartdatapointlevel/get_label/
---
## ChartDataPointLevel::get_Label() methode


Stelt de gegevenslabel van het gegevenspuntniveau voor. Toegepast voor Treemap- en Sunburst-reeksen. Alleen-lezen [IDataLabel](../../idatalabel/).
