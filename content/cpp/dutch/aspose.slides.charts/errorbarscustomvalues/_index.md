...
description: Specificeert de foutbalkwaarden. Het mag alleen worden gebruikt wanneer het foutbalkwaarde-type Custom is.
type: docs
weight: 469
...
Specificeert de foutbalkwaarden. Het mag alleen worden gebruikt wanneer het foutbalkwaarde-type Custom is.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() override | Specificeert de foutbalkwaarde in de negatieve richting. Beschikbaar als foutbalkwaarde-type Custom is en ErrorBarsXFormat is toegestaan. In alle andere gevallen geeft deze eigenschap null terug. Alleen-lezen [IDoubleChartValue](../idoublechartvalue/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() override | Specificeert de foutbalkwaarde in de positieve richting. Beschikbaar als foutbalkwaarde-type Custom is en ErrorBarsXFormat is toegestaan. In alle andere gevallen geeft deze eigenschap null terug. Alleen-lezen [IDoubleChartValue](../idoublechartvalue/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() override | Specificeert de foutbalkwaarde in de negatieve richting. Beschikbaar als foutbalkwaarde-type Custom is en ErrorBarsYFormat is toegestaan. In alle andere gevallen geeft deze eigenschap null terug. Alleen-lezen [IDoubleChartValue](../idoublechartvalue/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() override | Specificeert de foutbalkwaarde in de positieve richting. Beschikbaar als foutbalkwaarde-type Custom is en ErrorBarsYFormat is toegestaan. In alle andere gevallen geeft deze eigenschap null terug. Alleen-lezen [IDoubleChartValue](../idoublechartvalue/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert niets echt, initialiseert slechts een nieuw object en maakt het mogelijk om subklassen te copy-constructeren. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n'te sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Stelt toe om pointers in containers naar zwakke modus te schakelen. |
...
* Klasse [IErrorBarsCustomValues](../ierrorbarscustomvalues/)
