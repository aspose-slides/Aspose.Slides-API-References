...
description: Stelt een diagramdatacel voor.
type: docs
weight: 1184
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() | Retourneert diagramdatacel. Lees [IChartDataCell](../ichartdatacell/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | Specificeert of de AsCell- of AsLiteralString- of AsLiteralDouble-eigenschap actueel is. Met andere woorden specificeert het het type waarde van de Data-eigenschap. Deze eigenschap is alleen-lezen. Om de waarde van deze eigenschap te wijzigen kun je een van de ChartDataPointCollection.DataSourceTypeFor<...> eigenschappen gebruiken. Lees [DataSourceType](../datasourcetype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiërende constructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt het kopiëren van subklassen mogelijk. |
...
| virtual void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Stelt diagramdatacel in. Schrijf [IChartDataCell](../ichartdatacell/). |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Specificeert of de AsCell- of AsLiteralString- of AsLiteralDouble-eigenschap actueel is. Met andere woorden specificeert het het type waarde van de Data-eigenschap. Deze eigenschap is alleen-lezen. Om de waarde van deze eigenschap te wijzigen kun je een van de ChartDataPointCollection.DataSourceTypeFor<...> eigenschappen gebruiken. Schrijf [DataSourceType](../datasourcetype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Stelt u in staat om pointers in containers naar zwakke modus te schakelen. |
