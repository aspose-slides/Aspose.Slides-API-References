...
description: Stelt wanden voor op 3d grafieken.
type: docs
weight: 352
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Geeft de wandvulling, lijn, effect, 3D-stijlen terug. Alleen-lezen [IFormat](../iformat/). |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | Retourneert of stelt het afbeeldingstype in. Alleen-lezen [Charts::PictureType](../picturetype/). |
| **int32_t** [get_Thickness](./get_thickness/)() override | Geeft de wanddikte terug als een percentage van de grootste dimensie van het plotvolume. Alleen-lezen **int32_t**. |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | Retourneert of stelt het afbeeldingstype in. Schrijf [Charts::PictureType](../picturetype/). |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | Stelt de wanddikte in als een percentage van de grootste dimensie van het plotvolume. Schrijf **int32_t**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n'th sjabloon-argument in als een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk pointers in containers te wisselen naar zwakke modus. |
