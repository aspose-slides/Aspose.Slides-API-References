...
| **int32_t** [get_Count](./get_count/)() override | Haalt het aantal alle data-labels in de collectie op. Alleen-lezen **int32_t**. |
| **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() override | Haalt het aantal zichtbare data-labels in de collectie op. Alleen-lezen **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() override | Haalt het standaard data-labelformaat op. Alleen-lezen [IDataLabelFormat](../idatalabelformat/). |
| **bool** [get_IsVisible](./get_isvisible/)() override | False betekent dat het data-label standaard niet zichtbaar is (en dus alle Show*-vlaggen (ShowValue, ...) van de DefaultDataLabelFormat-eigenschap false zijn). Alleen-lezen **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() override | Stelt het opmaak van leader lijnen van data-labels voor. Alleen-lezen [IChartLinesFormat](../ichartlinesformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() override | Haalt de bovenliggende serie op. Alleen-lezen [IChartSeries](../ichartseries/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de collectie iterert. |
...
| void [Hide](./hide/)() override | Verberg het data-label standaard door alle Show*-vlaggen (ShowValue, ...) van de DefaultDataLabelFormat-eigenschap op false te zetten. IsVisible zal daarna false zijn. |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) override | Haalt het data-label op voor het datapunt met de opgegeven index. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) override | Retourneert een index van de opgegeven [DataLabel](../datalabel/) in de collectie. |
...
| void [Lock](../../system/object/lock/)() | Implementeert de C# lock() statement vergrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) toezichthouderobject. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n'th sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Maakt het wisselen van pointers in containers naar zwakke modus mogelijk. |
