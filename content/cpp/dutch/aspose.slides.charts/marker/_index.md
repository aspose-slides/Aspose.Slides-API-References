...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Haalt de markervulling op. Alleen-lezen [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | Stelt de markergrootte voor in een lijndiagram, spreidingsdiagram of radardiagram. Lees **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | Stelt de markerstijl voor in een lijndiagram, spreidingsdiagram of radardiagram. Lees [MarkerStyleType](../markerstyletype/). |
...
| void [Lock](../../system/object/lock/)() | Implementeert de lock()-statementvergrendeling van C#. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-bewakingsobject. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt kopiekonstruktie van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt kopiekonstruktie van subklassen mogelijk. |
...
| void [set_Size](./set_size/)(**int32_t**) override | Stelt de markergrootte voor in een lijndiagram, spreidingsdiagram of radardiagram. Schrijf **int32_t**. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | Stelt de markerstijl voor in een lijndiagram, spreidingsdiagram of radardiagram. Schrijf [MarkerStyleType](../markerstyletype/). |
