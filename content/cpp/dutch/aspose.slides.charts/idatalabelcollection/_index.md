...
description: Stelt de labels van een serie voor.
type: docs
weight: 950
...
| virtual **int32_t** [get_Count](./get_count/)() | Haalt het aantal alle gegevenslabels in de collectie op. Alleen-lezen **int32_t**. |
| virtual **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() | Haalt het aantal zichtbare gegevenslabels in de collectie op. Alleen-lezen **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() | Retourneert het standaardformaat van alle gegevenslabels in de collectie. Alleen-lezen [IDataLabelFormat](../idatalabelformat/). |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | False betekent dat het gegevenslabel standaard niet zichtbaar is (en dus alle Show*-vlaggen (ShowValue, ...) van de eigenschap DefaultDataLabelFormat false zijn). Alleen-lezen **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() | Stelt het formaat van de leidende lijnen van gegevenslabels voor. Alleen-lezen [IChartLinesFormat](../ichartlinesformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() | Retourneert de bovenliggende grafiekreeks. Alleen-lezen [IChartSeries](../ichartseries/). |
...
| virtual void [Hide](./hide/)() | Verbergt het gegevenslabel standaard door alle Show*-vlaggen (ShowValue, ...) van de eigenschap DefaultDataLabelFormat op false te zetten. IsVisible zal daarna false zijn. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) | Haalt het gegevenslabel op voor het gegevenspunt met de opgegeven index. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) | Retourneert een index van de opgegeven [DataLabel](../datalabel/) in de collectie. |
