...
description: "Bevat attributen die gekoppeld zijn aan een grafisch metafile. Objecten van deze klasse mogen alleen worden gealloceerd met de System::MakeObject() functie. Maak nooit een instantie van dit type op de stack of met operator new, aangezien dit runtime-fouten en/of assertiefouten veroorzaakt. Wikkel deze klasse altijd in een System::SmartPtr-pointer en gebruik deze pointer om deze aan functies als argument door te geven."
type: docs
weight: 157
url: /nl/system.drawing.imaging/metafileheader/
---
## MetafileHeader klasse


Bevat attributen die geassocieerd zijn met een grafisch metafile. Objecten van deze klasse mogen alleen worden gealloceerd met de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit een instantie van dit type op de stack of met operator new, aangezien dit runtime-fouten en/of assertiefouten zal veroorzaken. Wikkel deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik deze pointer om deze aan functies als argument door te geven.
...
| [Rectangle](../../system.drawing/rectangle/) [get_Bounds](./get_bounds/)() const | Retourneert een begrenzende rechthoek van een metafile die bij het huidige object hoort. |
| **float** [get_DpiX](./get_dpix/)() const | NIET GEREALISEERD. |
| **float** [get_DpiY](./get_dpiy/)() const | NIET GEREALISEERD. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert niets, eigenlijk, maar initialiseert een nieuw object en maakt copy-constructie van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets, eigenlijk, maar initialiseert een nieuw object en maakt copy-constructie van subklassen mogelijk. |
...
| void [set_Bounds](./set_bounds/)(const [Rectangle](../../system.drawing/rectangle/)\&) | Stelt een begrenzende rechthoek van een metafile in die bij het huidige object hoort. |
