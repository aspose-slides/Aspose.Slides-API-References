...
| [Color](../../system.drawing/color/) [get_NewColor](./get_newcolor/)() const | Retourneert het nieuwe [Color](../../system.drawing/color/)-object dat de kleur vertegenwoordigt waarnaar geconverteerd moet worden. |
| [Color](../../system.drawing/color/) [get_OldColor](./get_oldcolor/)() const | Retourneert het oude [Color](../../system.drawing/color/)-object dat de te converteren kleur vertegenwoordigt. |
...
| void [set_NewColor](./set_newcolor/)(const [Color](../../system.drawing/color/)\&) | Stelt het nieuwe [Color](../../system.drawing/color/)-object in dat de kleur vertegenwoordigt waarnaar geconverteerd moet worden. |
| void [set_OldColor](./set_oldcolor/)(const [Color](../../system.drawing/color/)\&) | Stelt het oude [Color](../../system.drawing/color/)-object in dat de te converteren kleur vertegenwoordigt. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het unlock-gedeelte van het C# lock()-statement. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-bewakingsobject. |
