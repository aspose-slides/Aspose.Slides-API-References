...
description: De exceptie die wordt geworpen wanneer één of meer circulaire verwijzingen worden gedetecteerd waarbij een formule naar zijn eigen cel verwijst, direct of indirect.
type: docs
weight: 1
url: /nl/aspose.slides.spreadsheet/details_cellcircularreferenceexception/
---
## Details_CellCircularReferenceException klasse


De exceptie die wordt geworpen wanneer één of meer circulaire verwijzingen worden gedetecteerd waarbij een formule naar zijn eigen cel verwijst, direct of indirect.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevendekomma-vergelijking waarbij twee NaN's als gelijk worden beschouwd, ook al is NaN volgens IEC 60559:1989 niet gelijk aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevendekomma-vergelijking waarbij twee NaN's als gelijk worden beschouwd, ook al is NaN volgens IEC 60559:1989 niet gelijk aan enige waarde, inclusief NaN. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Retourneert een 32-bit geheel getal dat een HRESULT-code is die aan de exceptie wordt gekoppeld die door het huidige object wordt vertegenwoordigd. |
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Haalt een circulaire celreferentie op. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert niets, echt, maar initialiseert een nieuw object en maakt kopiëren van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toekenningsoperator. Kopieert niets, echt, maar initialiseert een nieuw object en maakt kopiëren van subklassen mogelijk. |
...
* Naamruimte [Aspose::Slides::Spreadsheet](../)
