...
description: De uitzondering die wordt opgegooid wanneer een ongeldige celverwijzing wordt aangetroffen.
type: docs
weight: 27
url: /nl/aspose.slides.spreadsheet/details_cellinvalidreferenceexception/
---
## Details_CellInvalidReferenceException klasse

De uitzondering die wordt opgegooid wanneer een ongeldige celverwijzing wordt aangetroffen.
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Retourneert een 32-bits gehele getalwaarde die een HRESULT-code is die geassocieerd is met de uitzondering die door het huidige object wordt weergegeven. |
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Haalt een ongeldige celverwijzing op. |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | Retourneert een kopie van het Exception-object dat de diepste interne uitzondering weergeeft. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Hiermee kan men pointers in containers overschakelen naar zwakke modus. |
