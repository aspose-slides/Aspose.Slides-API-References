...
| --- | --- |
|  [ByteArrayContent](./bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Construeert een nieuw exemplaar. |
|  [ByteArrayContent](./bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | Construeert een nieuw exemplaar. |
| void [Dispose](../httpcontent/dispose/)() override | Verwijdert de huidige instantie. Deze methode ruimt ook de stroom op die wordt geretourneerd door 'ReadAsStream' en de geheugenbuffer indien deze is aangemaakt. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpContentHeaders](../../system.net.http.headers/httpcontentheaders/)\> [get_Headers](../httpcontent/get_headers/)() | Retourneert de HTTP-inhoudskoppen. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een exemplaar vertegenwoordigt van het type beschreven door targetType. Analog van C# 'is'-operator. |
...
| **bool** [TryComputeLength](./trycomputelength/)(**int64_t**\&) override | Probeert de byte-array lengte te berekenen. |
