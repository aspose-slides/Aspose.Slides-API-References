...
description: Bevat de hulpprogrammamethoden.
type: docs
weight: 131
url: /nl/system.net.http/httputilities/
---
## HttpUtilities klasse


Bevat de hulpprogrammamethoden.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert een C#-achtige zwevend-kommagetallen-vergelijking waarbij twee NaN-waarden als gelijk worden beschouwd, ook al is volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert een C#-achtige zwevend-kommagetallen-vergelijking waarbij twee NaN-waarden als gelijk worden beschouwd, ook al is volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Controleert of de opgegeven URI een HTTP-URI is. |
...
| Veld | Beschrijving |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | De standaard HTTP-versie voor het verzenden van verzoeken. |
| static [DefaultResponseVersion](./defaultresponseversion/) | De standaard HTTP-versie voor het ontvangen van antwoorden. |
