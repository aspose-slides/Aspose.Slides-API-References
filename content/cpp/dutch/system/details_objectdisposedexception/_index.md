...
description: "ObjectDisposedException wordt gegooid wanneer een methode wordt aangeroepen op een verwijderd object. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de ObjectDisposedException-klasse. Verpak de exemplaren van de ObjectDisposedException-klasse nooit in System::SmartPtr."
type: docs
weight: 612
url: /nl/system/details_objectdisposedexception/
---
## Details_ObjectDisposedException klasse


ObjectDisposedException wordt gegooid wanneer een methode wordt aangeroepen op een verwijderd object. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de ObjectDisposedException-klasse. Verpak de exemplaren van de ObjectDisposedException-klasse nooit in [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl zwevendekommavergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl zwevendekommavergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Retourneert een 32-bit geheel getal dat een HRESULT-code is die is gekoppeld aan de exceptie die wordt weergegeven door het huidige object. |
