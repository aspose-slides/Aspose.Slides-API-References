...
description: "Een basisklasse voor klassen die applicatie- (in plaats van systeem-) uitzonderingen vertegenwoordigen. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de klasse ApplicationException. Verpak nooit de exemplaren van de klasse ApplicationException in System::SmartPtr."
type: docs
weight: 313
url: /nl/system/details_applicationexception/
---
## Details_ApplicationException klasse


Een basisklasse voor klassen die toepassings- (in plaats van systeem-) uitzonderingen vertegenwoordigen. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de klasse ApplicationException. Verpak nooit de exemplaren van de klasse ApplicationException in [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevend-kommagete vergelijking waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevend-kommagete vergelijking waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Retourneert een 32-bit geheel getal dat een HRESULT-code is die verbonden is met de uitzondering die door het huidige object wordt vertegenwoordigd. |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Retourneert een kopie van het Exception-object dat de binnenste uitzondering vertegenwoordigt. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopieconstructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt het mogelijk om subklassen te kopiëren. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Stelt het n'te sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk om pointers in containers te wisselen naar zwakke modus. |
...
| void [Unlock](../object/unlock/)() | Implementeert C# lock()-statement ontgrendeling. Roep direct aan of gebruik het [LockContext](../lockcontext/)-sentry-object. |
...
| virtual const char * [what](../details_exception/what/)() const | Implementeert de [what()](../details_exception/what/)-methode die wordt aangeroepen door de klasse [ExceptionWrapper](../exceptionwrapper/). Ondanks het feit dat deze klasse niet is afgeleid van std::exception, kunnen afgeleide klassen beschermde/private leden gebruiken om hun logica te implementeren. Het verplaatsen van deze methodimplementatie naar [ExceptionWrapper](../exceptionwrapper/) kan die logica breken. |
