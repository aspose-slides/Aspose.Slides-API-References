...
description: "StackOverflowException wordt gegooid wanneer de uitvoeringstack van de thread overloopt. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de StackOverflowException-klasse. Verpak de exemplaren van de StackOverflowException-klasse nooit in System::SmartPtr."
type: docs
weight: 690
url: /nl/system/details_stackoverflowexception/
---
## Details_StackOverflowException klasse


StackOverflowException wordt gegooid wanneer de uitvoeringstack van de thread overloopt. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de StackOverflowException-klasse. Verpak de exemplaren van de StackOverflowException-klasse nooit in [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-achtige vergelijking van zwevendkommagetallen waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-achtige vergelijking van zwevendkommagetallen waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Retourneert een 32-bits geheel getal dat een HRESULT-code is die geassocieerd is met de exceptie die door het huidige object wordt vertegenwoordigd. |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | Retourneert een referentie naar het object dat de binnenste exceptie vertegenwoordigt. |
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Haalt de gegevensstructuur van de referentieteller op die aan het object gekoppeld is. |
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analoge van de C# [Object.GetHashCode()](../object/gethashcode/)-methode. Schakelt hashing van aangepaste objecten in. |
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Haalt het werkelijke type van het object op. Analoge van de C# [System.Object.GetType()](../object/gettype/)-aanroep. |
| **bool** [Is](./is/)(const [System::TypeInfo](../typeinfo/)\&) const override |  |
| void [Lock](../object/lock/)() | Implementeert C# lock()-statement vergrendeling. Roep direct aan of gebruik het [LockContext](../lockcontext/)-wachtoObject. |
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analoge van de C# [Object.MemberwiseClone()](../object/memberwiseclone/)-methode. Schakelt het klonen van aangepaste types in. |
|  [Object](../object/object/)() | Creëert een object. Initialiseert alle interne gegevensstructuren. |
|  [Object](../object/object/)([Object](../object/) const\&) | Kopieconstructor. Kopieert niets, echt, initialiseert alleen een nieuw object en maakt kopie-construeren van subclasses mogelijk. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Toewijzingsoperator. Kopieert niets, echt, initialiseert alleen een nieuw object en maakt kopie-construeren van subclasses mogelijk. |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | Vergelijkt een waardetype-object referentiegewijs met nullptr. |
...
| void [Unlock](../object/unlock/)() | Implementeert C# lock()-statement ontgrendeling. Roep direct aan of gebruik het [LockContext](../lockcontext/)-wachtoObject. |
