...
description: "NotSupportedException wordt gegooid wanneer een aangeroepen methode niet wordt ondersteund of wanneer een bewerking op een stream niet wordt ondersteund. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de NotSupportedException-klasse. Wikkel de NotSupportedException-klasse nooit in System::SmartPtr."
type: docs
weight: 586
url: /nl/system/details_notsupportedexception/
---
## Details_NotSupportedException klasse


NotSupportedException wordt gegooid wanneer een aangeroepen methode niet wordt ondersteund of wanneer een bewerking op een stream niet wordt ondersteund. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de NotSupportedException-klasse. Wikkel de NotSupportedException-klasse-instanties nooit in [System::SmartPtr](../smartptr/).
...
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Geeft een woordenboek met aangepaste exceptie-gegevens terug. |
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Geeft een 32-bit integerwaarde terug die een HRESULT-code is die aan de uitzondering wordt geassocieerd die wordt weergegeven door het huidige object. |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | Geeft een referentie terug naar het object dat de inner-exception vertegenwoordigt. |
| virtual [String](../string/) [get_Message](../details_exception/get_message/)() const | Geeft de string terug die de foutbeschrijving bevat. |
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Geeft de string terug die de stack-trace bevat. |
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Geeft een kopie terug van het Exception-object dat de innermost exception vertegenwoordigt. |
...
| void [Lock](../object/lock/)() | Implementeert C# lock()-statement locken. Roep direct aan of gebruik [LockContext](../lockcontext/) sentinel-object. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopie-constructor. Kopieert niets echt, initialiseert alleen een nieuw object en maakt het mogelijk om subklassen te copy-constructeren. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Toewijzingsoperator. Kopieert niets echt, initialiseert alleen een nieuw object en maakt het mogelijk om subklassen te copy-constructeren. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloon-argument in op een zwakke pointer (in plaats van gedeeld). Maakt het wisselen van pointers in containers naar zwakke modus mogelijk. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Geeft de stringrepresentatie van het huidige object terug. |
| static const [System::TypeInfo](../typeinfo/)\& [Type](./type/)() |  |
| void [Unlock](../object/unlock/)() | Implementeert C# lock()-statement unlocken. Roep direct aan of gebruik [LockContext](../lockcontext/) sentinel-object. |
