...
type: docs
weight: 2107
url: /nl/system/operator_less_equal/
---
...
Bepaalt of de opgegeven waarde kleiner of gelijk is aan de waarde die wordt vertegenwoordigd door het opgegeven [Nullable](../nullable/)-object door [operator<=()](./) op deze waarden toe te passen.
...
True als de eerste vergelijkingswaarde kleiner of gelijk is aan de tweede vergelijkingswaarde, anders - false
