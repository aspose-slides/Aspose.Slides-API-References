...
description: "TimeoutException geeft aan of de tijd die is toegewezen voor een proces of bewerking verlopen is. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de TimeoutException-klasse. Wikkel de TimeoutException-klasse-exemplaren nooit in System::SmartPtr."
type: docs
weight: 716
url: /nl/system/details_timeoutexception/
---
## Details_TimeoutException klasse


TimeoutException geeft aan of de tijd die is toegewezen voor een proces of bewerking verstreken is. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de TimeoutException-klasse. Wikkel de TimeoutException-klasse-exemplaren nooit in [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-achtige floating-point vergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-achtige floating-point vergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Retourneert een 32-bit geheel getal dat een HRESULT-code is die gekoppeld is aan de exceptie die door het huidige object wordt gerepresenteerd. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Haalt het werkelijke type van het object op. Analog van de C# [System.Object.GetType()](../object/gettype/)-aanroep. |
| **bool** [Is](./is/)(const [System::TypeInfo](../typeinfo/)\&) const override |  |
| void [Lock](../object/lock/)() | Implementeert de C# lock()-statement voor vergrendeling. Roep direct aan of gebruik het [LockContext](../lockcontext/)-bewakingsobject. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Copy-constructor. Kopieert niets echt, initialiseert slechts een nieuw object en maakt copy-constructie van subklassen mogelijk. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Toewijzingsoperator. Kopieert niets echt, initialiseert slechts een nieuw object en maakt copy-constructie van subklassen mogelijk. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th template-argument in op een zwakke pointer (in plaats van gedeeld). Staat het omschakelen van pointers in containers naar zwakke modus toe. |
