...
description: "OperationCanceledException wordt gegooid in een thread bij het afbreken van een bewerking die de thread uitvoerde. Maak nooit handmatig instanties van deze klasse aan. Gebruik in plaats daarvan de OperationCanceledException-klasse. Wrap nooit de instanties van de OperationCanceledException-klasse in System::SmartPtr."
type: docs
weight: 625
url: /nl/system/details_operationcanceledexception/
---
## Details_OperationCanceledException klasse


OperationCanceledException wordt gegooid in een thread bij het afbreken van een bewerking die door de thread werd uitgevoerd. Maak nooit handmatig instanties van deze klasse aan. Gebruik in plaats daarvan de OperationCanceledException-klasse. Wrap nooit de OperationCanceledException-klasse-instanties in [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevendekommagelijk vergelijking waarbij twee NaN's als gelijk worden beschouwd, zelfs hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevendekommagelijk vergelijking waarbij twee NaN's als gelijk worden beschouwd, zelfs hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| virtual [SharedPtr](../sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../sharedptr/)\<[Object](../object/)\>, [SharedPtr](../sharedptr/)\<[Object](../object/)\>\>\> [get_Data](../details_exception/get_data/)() | Retourneert een map met aangepaste exceptiegegevens. |
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Retourneert een 32-bits geheel getal dat een HRESULT-code is geassocieerd met de exceptie die wordt vertegenwoordigd door het huidige object. |
...
| void [Lock](../object/lock/)() | Implementeert de C# lock()-statement vergrendeling. Roep direct aan of gebruik het [LockContext](../lockcontext/)-bewakingsobject. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Copy-constructor. Kopieert niets, echt, initialiseert slechts een nieuw object en maakt het mogelijk om subklassen te kopiëren. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Toewijzingsoperator. Kopieert niets, echt, initialiseert slechts een nieuw object en maakt het mogelijk om subklassen te kopiëren. |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | Vergelijkt referentiewaarde van waardetype-object met nullptr. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Stelt het n'te sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
...
| virtual  [~Object](../object/~object/)() | Vernietigt object. Vrijgeeft alle interne datastructuren. |
