...
description: Definieert een methode die de waarde van het huidige object formatteert met behulp van de opgegeven opmaakstring en opmaakprovider.
type: docs
weight: 1002
url: /nl/system/iformattable/
---
## IFormattable klasse

Definieert een methode die de waarde van het huidige object formatteert met behulp van de opgegeven opmaakstring en opmaakprovider.
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emuleert een C#-stijl drijvende-komma vergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emuleert een C#-stijl drijvende-komma vergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analog van de C# [Object.GetHashCode()](../object/gethashcode/)-methode. Maakt hashwaarden van aangepaste objecten mogelijk. |
...
| virtual **bool** [Is](../object/is/)(const [TypeInfo](../typeinfo/)\&) const | Controleert of het object een instantie vertegenwoordigt van het type beschreven door targetType. Analog van de C# 'is'-operator. |
| void [Lock](../object/lock/)() | Implementeert C# lock()-statement vergrendeling. Direct aanroepen of gebruik [LockContext](../lockcontext/) bewakingsobject. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopieerconstructor. Kopieert eigenlijk niets, initialiseert enkel een nieuw object en maakt het kopiëren van subklassen mogelijk. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Toewijzingsoperator. Kopieert eigenlijk niets, initialiseert enkel een nieuw object en maakt het kopiëren van subklassen mogelijk. |
...
| virtual [String](../string/) [ToString](../object/tostring/)() const | Analog van de C# [Object.ToString()](../object/tostring/)-methode. Maakt conversie van aangepaste objecten naar string mogelijk. |
| static const [TypeInfo](../typeinfo/)\& [Type](../object/type/)() | Implementeert de C# typeof([System.Object](../object/))-constructie. |
| void [Unlock](../object/unlock/)() | Implementeert het ontgrendelen van de C# lock()-statement. Direct aanroepen of gebruik [LockContext](../lockcontext/) bewakingsobject. |
