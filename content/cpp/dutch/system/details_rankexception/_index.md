...
description: "RankException wordt gegooid wanneer een array-argument met een aantal dimensies dat verschilt van het verwachte, aan een methode wordt doorgegeven. Maak nooit handmatig exemplaren van deze klasse. Gebruik in plaats daarvan de RankException-klasse. Wrap nooit de RankException-klasse-instanties in System::SmartPtr."
type: docs
weight: 677
url: /nl/system/details_rankexception/
---
## Details_RankException klasse

RankException wordt gegooid wanneer een array-argument met een verschillend aantal dimensies dan verwacht wordt doorgegeven aan een methode. Maak nooit handmatig exemplaren van deze klasse. Gebruik in plaats daarvan de RankException-klasse. Wrap nooit de RankException-klasse-instanties in [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevende-komma vergelijking waarbij twee NaN’s als gelijk worden beschouwd, zelfs hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevende-komma vergelijking waarbij twee NaN’s als gelijk worden beschouwd, zelfs hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | Retourneert een referentie naar het object dat de binnenste exceptie representeert. |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Retourneert een kopie van het Exception-object dat de meest interne exceptie representeert. |
...
| [Object](../object/object/)([Object](../object/) const\&) | Kopie-constructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt het mogelijk om subklassen via kopiëren te construeren. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Toewijzingsoperator. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt het mogelijk om subklassen via kopiëren te construeren. |
