...
description: "IndexOutOfRangeException wordt gegooid wanneer een toegang tot een element van een collectie wordt geprobeerd met een index die buiten de grenzen ligt. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik de IndexOutOfRangeException-klasse in plaats daarvan. Plaats nooit IndexOutOfRangeException-klasse-instanties in System::SmartPtr."
type: docs
weight: 482
url: /nl/system/details_indexoutofrangeexception/
---
## Details_IndexOutOfRangeException klasse

IndexOutOfRangeException wordt gegooid wanneer een toegang tot een element van een collectie wordt geprobeerd met een index die buiten de grenzen ligt. Maak nooit handmatig exemplaren van deze klasse. Gebruik in plaats daarvan de IndexOutOfRangeException klasse. Verpak de IndexOutOfRangeException klasse exemplaren nooit in [System::SmartPtr](../smartptr/).
