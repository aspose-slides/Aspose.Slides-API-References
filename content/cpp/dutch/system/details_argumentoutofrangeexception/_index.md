...
description: "ArgumentOutOfRangeException wordt gegooid wanneer een aangeroepen methode een argument krijgt dat buiten het verwachte bereik van waarden voor dat argument valt. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de ArgumentOutOfRangeException-klasse. Verpak de exemplaren van de ArgumentOutOfRangeException-klasse nooit in System::SmartPtr."
type: docs
weight: 352
url: /nl/system/details_argumentoutofrangeexception/
---
## Details_ArgumentOutOfRangeException klasse


ArgumentOutOfRangeException wordt gegooid wanneer een methode die wordt aangeroepen een argument ontvangt dat buiten het verwachte bereik van waarden voor dat argument valt. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de ArgumentOutOfRangeException-klasse. Verpak de ArgumentOutOfRangeException-klasseinstellingen nooit in [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevend-komma vergelijking waarbij twee NaN's als gelijk worden beschouwd, ook al is volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevend-komma vergelijking waarbij twee NaN's als gelijk worden beschouwd, ook al is volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Retourneert een 32-bit gehele getalwaarde die een HRESULT-code is die geassocieerd is met de exceptie die wordt vertegenwoordigd door het huidige object. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Copy-constructor. Kopieert niets, echt, initialiseert alleen een nieuw object en maakt copy-constructie van subclasses mogelijk. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Toewijzingsoperator. Kopieert niets, echt, initialiseert alleen een nieuw object en maakt copy-constructie van subclasses mogelijk. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk pointers in containers naar zwakke modus te schakelen. |
| int [SharedCount](../object/sharedcount/)() const | Haalt de huidige waarde van de gedeelde referentieteller op. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Verhoogt de gedeelde referentieteller. Mag niet direct aangeroepen worden; gebruik in plaats daarvan slimme pointers of ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Verlaagt en retourneert de gedeelde referentieteller. Mag niet direct aangeroepen worden; gebruik in plaats daarvan slimme pointers of ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Verhoogt de zwakke referentieteller. Mag niet direct aangeroepen worden; gebruik in plaats daarvan slimme pointers of ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Verlaagt de zwakke referentieteller. Mag niet direct aangeroepen worden; gebruik in plaats daarvan slimme pointers of ThisProtector. |
...
* Klasse [Details_ArgumentException](../details_argumentexception/)
* Naamruimte [System](../)
