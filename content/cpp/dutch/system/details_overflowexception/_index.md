...
description: "OverflowException wordt gegooid wanneer een bewerking resulteert in een overflow. Maak nooit handmatig exemplaren van deze klasse. Gebruik in plaats daarvan de OverflowException klasse. Verpak de OverflowException klasse-exemplaren nooit in System::SmartPtr."
type: docs
weight: 651
url: /nl/system/details_overflowexception/
---
## Details_OverflowException klasse


OverflowException wordt gegooid wanneer een bewerking resulteert in een overflow. Maak nooit handmatig exemplaren van deze klasse aan. Gebruik in plaats daarvan de OverflowException klasse. Verpak nooit de OverflowException klasse-exemplaren in [System::SmartPtr](../smartptr/).
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [get_InnerException](../details_exception/get_innerexception/)() const | Retourneert een referentie naar het object dat de inner-exceptie representeert. |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Retourneert een kopie van het Exception-object dat de inner-meeste exceptie representeert. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopie-constructor. Kopieert niets, initialiseert alleen een nieuw object en maakt kopiëren van subklassen mogelijk. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Toewijzingsoperator. Kopieert niets, initialiseert alleen een nieuw object en maakt kopiëren van subklassen mogelijk. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in op een zwakke pointer (in plaats van gedeelde). Hiermee kunnen pointers in containers naar zwakke modus worden geschakeld. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Retourneert de string-representatie van het huidige object. |
