...
description: Biedt informatie over beeldschermen. Alleen Windows. Dit is een singletontype met geheugenbeheer uitgevoerd door toegangsfunctie(s). Je moet nooit direct instanties ervan maken.
type: docs
weight: 40
url: /nl/system.windows.forms/screen/
---
## Screen klasse

Biedt informatie over beeldschermen. [Windows](../../system.windows/) alleen. Dit is een singletontype waarbij het geheugenbeheer wordt gedaan door toegangsfunctie(s). Je moet nooit direct instanties ervan maken.
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | Haalt schermgrenzen op. |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | Haalt informatie over het primaire beeldscherm op. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th-sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Stelt je in staat pointers in containers naar zwakke modus te schakelen. |
