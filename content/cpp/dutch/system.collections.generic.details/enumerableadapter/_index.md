...
description: Enumerable gebruikt door de IEnumerable.Cast() en IEnumerable.OfType() extensiemethoden.
type: docs
weight: 1
url: /nl/system.collections.generic.details/enumerableadapter/
---
## EnumerableAdapter klasse

Enumerable gebruikt door de IEnumerable.Cast() en IEnumerable.OfType() extensiemethoden.
...
| --- | --- |
| Source | Het brontype van de verzamelingselementen. |
| Result | Het resulttype van de verzamelingselementen. |
| EnumeratorAdapter | Het type van de enumerator-adapter. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Krijgt een iterator die net achter het laatste const-gekwalificeerde element (indien aanwezig) van de collectie wijst. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Krijgt een iterator die net achter het laatste element (indien aanwezig) van de collectie wijst. Deze iterator kan niet worden gebruikt om een verwezen object te wijzigen omdat [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) een kopie-object van T retourneert. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Krijgt een iterator die net achter het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie wijst. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../../system.collections.generic/ienumerator/)\<Result\>\> [GetEnumerator](./getenumerator/)() override | Krijgt enumerator. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Krijgt de implementatie van de const-begin-iterator voor de huidige container. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Krijgt de implementatie van de const-end-iterator voor de huidige container. |
...
| virtual  [~Object](../../system/object/~object/)() | Verwijdert object. Bevrijdt alle interne datastructuren. |
