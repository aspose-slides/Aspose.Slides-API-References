...
description: Enumerator gebruikt door de IEnumerable.Select() extensiemethode.
type: docs
weight: 79
url: /nl/system.collections.generic.details/enumeratorselectadapter/
---
## EnumeratorSelectAdapter klasse

Enumerator gebruikt door de IEnumerable.Select()-uitbreidingsmethode.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl zwevend-kommapuntvergelijking waarbij twee NaN’s als gelijk worden beschouwd, ook al wordt volgens IEC 60559:1989 NaN niet als gelijk beschouwd aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl zwevend-kommapuntvergelijking waarbij twee NaN’s als gelijk worden beschouwd, ook al wordt volgens IEC 60559:1989 NaN niet als gelijk beschouwd aan enige waarde, inclusief NaN. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haalt de referentie-tellende datastructuur op die aan het object is gekoppeld. |
...
| void [Lock](../../system/object/lock/)() | Implementeert het lock()-statement van C# voor vergrendeling. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-waarnemerobject. |
...
| **bool** [MoveNext](./movenext/)() override | Verplaatst de enumerator naar het volgende element. Als er eerder geen element werd gerefereerd, stelt het de referentie in op het eerste beschikbare element. Als het einde van de container is bereikt, doet het niets. |
|  [Object](../../system/object/object/)() | Creëert object. Initialiseert alle interne datastructuren. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert niets, in feite initialiseert het een nieuw object en maakt het kopie-constructie van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets, in feite initialiseert het een nieuw object en maakt het kopie-constructie van subklassen mogelijk. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het ontgrendelen van het C# lock()-statement. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-waarnemerobject. |
