...
description: De uitzondering die wordt gegooid wanneer een fout optreedt tijdens het verwerken van een XSLT-transformatie.
type: docs
weight: 14
url: /nl/system.xml.xsl/details_xsltexception/
---
## Details_XsltException klasse

De uitzondering die wordt gegooid wanneer een fout optreedt tijdens het verwerken van een XSLT-transformatie.
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Retourneert een 32-bits geheel getal dat een HRESULT-code is die geassocieerd is met de uitzondering die wordt vertegenwoordigd door het huidige object. |
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Retourneert het regelnummmer dat aangeeft waar de fout zich voordeed in het stylesheet. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Retourneert de regelpositie die aangeeft waar de fout zich voordeed in het stylesheet. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Retourneert het opgemaakte foutbericht dat de huidige uitzondering beschrijft. |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Retourneert het locatierpad van het stylesheet. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Een analogie van de C# [Object.GetHashCode()](../../system/object/gethashcode/)-methode. Maakt hash-generatie van aangepaste objecten mogelijk. |
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Haalt het werkelijke type van het object op. Analogie van de C# [System.Object.GetType()](../../system/object/gettype/)-aanroep. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogie van de C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-methode. Maakt het klonen van aangepaste types mogelijk. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Stelt HRESULT in, een gecodeerde numerieke waarde die aan een specifieke uitzondering is toegewezen. |
