...
| [Orientation](../../aspose.slides/orientation/) [get_Direction](./get_direction/)() override | Richting van de transitie. Lees [Orientation](../../aspose.slides/orientation/). |
...
| void [set_Direction](./set_direction/)([Orientation](../../aspose.slides/orientation/)) override | Richting van de transitie. Schrijf [Orientation](../../aspose.slides/orientation/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th template-argument in op een zwakke pointer (in plaats van gedeelde). Maakt het mogelijk pointers in containers naar zwakke modus te schakelen. |
