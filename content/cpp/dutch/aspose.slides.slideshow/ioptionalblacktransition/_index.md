...
---
## IOptionalBlackTransition klasse
...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Dit attribuut specificeert of de overgang start vanaf een zwart scherm (en vervolgens de nieuwe dia over zwart overgaat). Lezen **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert niets, echt niet, initialiseert alleen een nieuw object en maakt het kopiëren van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets, echt niet, initialiseert alleen een nieuw object en maakt het kopiëren van subklassen mogelijk. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Dit attribuut specificeert of de overgang start vanaf een zwart scherm (en vervolgens de nieuwe dia over zwart overgaat). Schrijf **bool**. |
