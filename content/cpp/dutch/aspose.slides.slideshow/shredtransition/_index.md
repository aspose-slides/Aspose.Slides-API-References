...
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | Specificeert de vorm van de visuals die tijdens de overgang worden gebruikt. Lees [TransitionShredPattern](../transitionshredpattern/). |
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Dient als hashfunctie voor een bepaald type, geschikt voor gebruik in hash-algoritmen en datastructuren zoals een hashtabel. |
...
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | Specificeert de vorm van de visuals die tijdens de overgang worden gebruikt. Schrijf [TransitionShredPattern](../transitionshredpattern/). |
