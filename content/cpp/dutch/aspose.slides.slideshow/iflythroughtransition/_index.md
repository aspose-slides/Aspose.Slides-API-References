...
description: Doorvoerende dia-overgangseffect.
type: docs
weight: 105
...
Doorvloeiend dia-overgangseffect.
...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Richting van de transitie. Lees [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual **bool** [get_HasBounce](./get_hasbounce/)() | Specificeert dat de beweging van de presentatie-dia's tijdens de transitie een stuiter bevat. Lees **bool**. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Richting van de transitie. Schrijf [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_HasBounce](./set_hasbounce/)(**bool**) | Specificeert dat de beweging van de presentatie-dia's tijdens de transitie een stuiter bevat. Schrijf **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt n'th template-argument in als een zwakke pointer (in plaats van gedeeld). Biedt de mogelijkheid om pointers in containers naar zwakke modus te schakelen. |
