...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Richting van de overgang. Lees [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() | Specificeert de vorm van de visuals die tijdens de overgang worden gebruikt. Lees [TransitionShredPattern](../transitionshredpattern/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Richting van de overgang. Schrijf [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) | Specificeert de vorm van de visuals die tijdens de overgang worden gebruikt. Schrijf [TransitionShredPattern](../transitionshredpattern/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n-de sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Stelt wisselen van pointers in containers naar zwakke modus mogelijk. |
