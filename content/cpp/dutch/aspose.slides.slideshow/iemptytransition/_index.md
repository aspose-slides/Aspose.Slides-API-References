...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevend-kommaget vergelijken waarbij twee NaN’s als gelijk worden beschouwd, ook al stelt IEC 60559:1989 dat NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevend-kommaget vergelijken waarbij twee NaN’s als gelijk worden beschouwd, ook al stelt IEC 60559:1989 dat NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| void [Lock](../../system/object/lock/)() | Implementeert het C# lock() statement voor vergrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) waarschuwingsobject. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n-de sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk om pointers in containers over te schakelen naar zwakke modus. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het C# lock() statement voor ontgrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) waarschuwingsobject. |
