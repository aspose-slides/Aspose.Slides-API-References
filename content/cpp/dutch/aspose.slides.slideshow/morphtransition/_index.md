...
| [TransitionMorphType](../transitionmorphtype/) [get_MorphType](./get_morphtype/)() override | Type van morph-transitie. Lees [TransitionMorphType](../transitionmorphtype/). |
...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Dient als hashfunctie voor een bepaald type, geschikt voor gebruik in hash-algoritmen en gegevensstructuren zoals een hashtabel. |
...
| void [Lock](../../system/object/lock/)() | Implementeert C# lock()-statement vergrendeling. Roep rechtstreeks aan of gebruik het [LockContext](../../system/lockcontext/)-bewakingsobject. |
...
| void [set_MorphType](./set_morphtype/)([TransitionMorphType](../transitionmorphtype/)) override | Type van morph-transitie. Schrijf [TransitionMorphType](../transitionmorphtype/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert C# lock()-statement ontgrendeling. Roep rechtstreeks aan of gebruik het [LockContext](../../system/lockcontext/)-bewakingsobject. |
...
* Klasse [IMorphTransition](../imorphtransition/)
