...
description: Vertegenwoordigt een collectie van VBA-projectreferenties.
type: docs
weight: 183
...
Stelt een verzameling van een VBA-projectreferenties voor.
...
| Method | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>) override | Voegt de nieuwe referentie toe aan de referentiesverzameling |
| [iterator](./iterator/) [begin](./begin/)() | Retourneert een iterator die wijst naar het eerste element (indien aanwezig) van de verzameling. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Retourneert een iterator die wijst naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Retourneert een iterator die wijst naar het eerste const-gekwalificeerde element (indien aanwezig) van de verzameling. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Retourneert een iterator die wijst net na het laatste const-gekwalificeerde element (indien aanwezig) van de verzameling. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>\>, **int32_t**) override | Kopieert alle elementen van de verzameling naar de gespecificeerde array. |
| [iterator](./iterator/) [end](./end/)() | Retourneert een iterator die wijst net na het laatste element (indien aanwezig) van de verzameling. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Retourneert een iterator die wijst net na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Vergelijkt objecten met behulp van C# [Object.Equals](../../system/object/equals/)-semantiek. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt referentietype-objecten in C#-stijl. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt waardetype-objecten in C#-stijl. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevendekommavergelijking waarbij twee NaN's als gelijk worden beschouwd, zelfs volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevendekommavergelijking waarbij twee NaN's als gelijk worden beschouwd, zelfs volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| **int32_t** [get_Count](./get_count/)() override | Retourneert het aantal elementen dat daadwerkelijk in de verzameling zit. Alleen-lezen **int32_t**. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Retourneert de referentieteller-gegevensstructuur die bij het object hoort. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de verzameling iterereert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [idx_get](./idx_get/)(**int32_t**) override | Retourneert het element op de gespecificeerde index. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | Retourneert het aantal elementen in de reeks die aan de gespecificeerde voorwaarde voldoen. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets echt, initialiseert enkel een nieuw object en maakt kopiëren van subklassen mogelijk. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in op een zwakke pointer (in plaats van gedeelde). Maakt het wisselen van pointers in containers naar zwakke modus mogelijk. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Retourneert een iterator die wijst naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Retourneert een iterator die wijst naar het eerste element (indien aanwezig) van de verzameling. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Retourneert een iterator die wijst net na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de verzameling. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Retourneert een iterator die wijst net na het laatste element (indien aanwezig) van de verzameling. |
...
| Typedef | Description |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Een verzamelings type waarvan de iterator types worden gebruikt als iterator types in de huidige collectie. |
| [iterator](./iterator/) | Iterator type. |
| [const_iterator](./const_iterator/) | Const iterator type. |
| [virtualized_iterator_element](./virtualized_iterator_element/) | Gevirtualiseerde elementtype. |
| [virtualized_iterator](./virtualized_iterator/) | Gevirtualiseerd type. |

## Zie ook

* Klasse [IVbaReferenceCollection](../ivbareferencecollection/)
