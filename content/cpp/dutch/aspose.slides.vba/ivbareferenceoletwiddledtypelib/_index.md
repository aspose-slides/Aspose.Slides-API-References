...
description: Vertegenwoordigt een gewijzigde OLE Automation typebibliotheekreferentie waarin alle bedieningselementen als uitbreidbaar zijn gemarkeerd.
type: docs
weight: 92
...
Vertegenwoordigt een gewijzigde OLE Automation typebibliotheekreferentie waarin alle bedieningselementen als uitbreidbaar zijn gemarkeerd.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th-sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Stelt u in staat om pointers in containers te wisselen naar zwakke modus. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert ontgrendeling van de C# lock()-statement. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-bewakingsobject. |
