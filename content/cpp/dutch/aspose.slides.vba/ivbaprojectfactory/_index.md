...
description: Staat toe om een VBA-project te maken via een COM-interface
type: docs
weight: 40
url: /nl/aspose.slides.vba/ivbaprojectfactory/
---
## IVbaProjectFactory klasse

Staat toe om een VBA-project te maken via een COM-interface
...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [CreateVbaProject](./createvbaproject/)() | Maakt een nieuw VBA-project aan. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [ReadVbaProject](./readvbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Leest VBA-project uit OLE-container. |
