...
| [String](../../system/string/) [get_Description](./get_description/)() | Haal een bericht op dat de XML [Web](../../system.web/) servicebeschrijving bevat. |
| [String](../../system/string/) [get_Name](./get_name/)() | Haal de naam van de XML [Web](../../system.web/) service op. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Haal de standaard namespace op die voor de XML [Web](../../system.web/) service moet worden gebruikt. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Haal het feitelijke type van het object op. Analoge van de C# [System.Object.GetType()](../../system/object/gettype/) aanroep. |
...
| void [set_Description](./set_description/)([String](../../system/string/)) | Stelt een bericht in dat de XML [Web](../../system.web/) servicebeschrijving bevat. |
| void [set_Name](./set_name/)([String](../../system/string/)) | Stelt de naam van de XML [Web](../../system.web/) service in. |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Stelt de standaard namespace in die voor de XML [Web](../../system.web/) service moet worden gebruikt. |
...
|  [WebServiceAttribute](./webserviceattribute/)() | Construeert een nieuw exemplaar. |
...
| Veld | Beschrijving |
| --- | --- |
| static [DefaultNamespace](./defaultnamespace/) | De standaardwaarde van de 'Namespace' eigenschap. |

## Zie ook

* Klasse [Attribute](../../system/attribute/)
* Naamruimte [System::Web::Services](../)
