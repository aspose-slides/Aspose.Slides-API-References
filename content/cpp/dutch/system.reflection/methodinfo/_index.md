...
description: Vertegenwoordigt informatie over klasse-methode.
type: docs
weight: 131
url: /nl/system.reflection/methodinfo/
---
## MethodInfo klasse

Representeert informatie over klasse-methode.
...
| --- | --- |
| void [AddAttribute](../memberinfo/addattribute/)(const [ObjectPtr](../memberinfo/objectptr/)\&) | Voegt attribuut toe aan collectie. |
...
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Haalt een MemberTypes-waarde op die aangeeft dat dit lid een methode is. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(const [TypeInfo](../../system/typeinfo/)\&, **bool**) const | Retourneert een array met objecten die alle aangepaste attributen vertegenwoordigen die op het type zijn toegepast dat door het huidige object wordt vertegenwoordigd. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [GetCustomAttributes](../memberinfo/getcustomattributes/)(**bool**) const | Retourneert een array met objecten die alle aangepaste attributen vertegenwoordigen die op het type zijn toegepast dat door het huidige object wordt vertegenwoordigd. |
...
|  [MethodInfo](./methodinfo/)(const [String](../../system/string/)\&) | Initialiseert een nieuw exemplaar van de [MethodInfo](./) klasse. |
|  [Object](../../system/object/object/)() | Creëert object. Initialiseert alle interne datastructuren. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copyconstructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt kopieerconstructie van subklassen mogelijk. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt n'th template-argument in op een zwakke pointer (in plaats van gedeelde). Stelt overschakelen van pointers in containers naar zwakke modus mogelijk. |
