...
description: "Een basisklasse voor geïnstalleerde en private lettertypecollecties. Objecten van deze klasse mogen alleen worden gealloceerd met de functie System::MakeObject(). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit leidt tot runtime-fouten en/of assertiefouten. Wrap deze klasse altijd in een System::SmartPtr-pointer en gebruik die pointer om deze als argument aan functies door te geven."
type: docs
weight: 1
url: /nl/system.drawing.text/fontcollection/
---
## FontCollection klasse

Een basisklasse voor geïnstalleerde en privé-lettertypecollecties. Objecten van deze klasse mogen alleen worden gealloceerd met de functie [System::MakeObject()](../../system/makeobject/). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit leidt tot runtime-fouten en/of assert-fouten. Wrap deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik die pointer om deze als argument aan functies door te geven.
...
| Method | Description |
| --- | --- |
| void [Dispose](./dispose/)() override | Vrijgeeft systeembronnen die door het huidige object zijn verkregen. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[FontFamily](../../system.drawing/fontfamily/)\>\> [get_Families](./get_families/)() | Retourneert een array van [FontFamily](../../system.drawing/fontfamily/)-objecten die bij de door het huidige object gerepresenteerde lettertypecollectie horen. |
...
| void [Lock](../../system/object/lock/)() | Implementeert de locking van de C# lock()-instructie. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-bewakingsobject. |
...
* Naamruimte [System::Drawing::Text](../)
