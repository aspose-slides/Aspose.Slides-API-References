...
description: Representeert een object dat het laag-niveau werk van het in wachtrij plaatsen van taken op threads afhandelt.
type: docs
weight: 79
url: /nl/system.threading.tasks/taskscheduler/
---
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | Maakt een [TaskScheduler](./) aan die is gekoppeld aan de huidige thread. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | Haalt de [TaskScheduler](./) op die is gekoppeld aan de momenteel uitgevoerde taak. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | Haalt de standaard [TaskScheduler](./)-instantie op die door het framework wordt geleverd. |
| **int32_t** [get_Id](./get_id/)() const | Haalt de unieke ID op voor deze [TaskScheduler](./). |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | Geeft het maximale concurrentieniveau aan dat deze [TaskScheduler](./) kan ondersteunen. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie van het type beschrijft die door targetType wordt gegeven. Analoge van de C# 'is'-operator. |
