...
description: Biedt de voltooiingsstatus van een parallelle lus.
type: docs
weight: 14
url: /nl/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult klasse


Biedt status van voltooiing van een [Parallel](../parallel/) loop.
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Geeft aan of de lus tot het einde is uitgevoerd. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Haalt de laagste iteratie-index op waarop een onderbreking optrad. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haalt de referentieteller-dattructuur op die met het object is geassocieerd. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Construeert een [ParallelLoopResult](./). |
...
Vertegenwoordigt het resultaat van een parallelle lusoperatie, inclusief of deze voltooid is en informatie over onderbrekingen. 
## Zie ook
