...
description: Stelt het World Wide Web Consortium (W3C) all-element (compositor) voor.
type: docs
weight: 92
url: /nl/system.xml.schema/xmlschemaall/
---
## XmlSchemaAll klasse
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Retourneert de collectie van [XmlSchemaElement](../xmlschemaelement/) elementen die zich bevinden binnen de **all** compositor. |
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | Retourneert het maximale aantal keren dat het partikel kan voorkomen. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Retourneert het getal als een tekenreekswaarde. Maximaal aantal keren dat het partikel kan voorkomen. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | Retourneert het minimale aantal keren dat het partikel kan voorkomen. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Retourneert het getal als een tekenreekswaarde. Het minimale aantal keren dat het partikel kan voorkomen. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Haalt het werkelijke type van het object op. Analoge van de C# [System.Object.GetType()](../../system/object/gettype/) oproep. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieconstructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt kopie-constructie van subklassen mogelijk. |
...
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Stelt het maximale aantal keren in dat het partikel kan voorkomen. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Stelt het getal in als een tekenreekswaarde. Maximaal aantal keren dat het partikel kan voorkomen. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Stelt het minimale aantal keren in dat het partikel kan voorkomen. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Stelt het getal in als een tekenreekswaarde. Het minimale aantal keren dat het partikel kan voorkomen. |
...
|  [XmlSchemaAll](./xmlschemaall/)() | Initialiseert een nieuwe instantie van de [XmlSchemaAll](./) klasse. |
...
Objecten van deze klasse mogen alleen worden gealloceerd met behulp van de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit instanties van dit type op de stack of met operator new, omdat dit zal leiden tot runtime-fouten en/of assertiefouten. Wrap deze klasse altijd in een [System::SmartPtr](../../system/smartptr/) pointer en gebruik deze pointer om hem als argument aan functies door te geven. 
