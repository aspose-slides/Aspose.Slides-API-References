...
description: Representeert het minExclusive-element van XML Schema zoals gespecificeerd door het World Wide Web Consortium (W3C). Deze klasse kan worden gebruikt om een beperking op te geven voor de minimumwaarde van een simpleType-element. De elementwaarde moet groter zijn dan de waarde van het minExclusive-element.
type: docs
weight: 612
url: /nl/system.xml.schema/xmlschemaminexclusivefacet/
---
## XmlSchemaMinExclusiveFacet klasse


Represents the **minExclusive** element from XML [Schema](../) as specified by the World Wide [Web](../../system.web/) Consortium (W3C). This klasse can be used to specify a restriction on the minimum value of a **simpleType** element. The element value must be greater than the value of the **minExclusive** element.
...
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Retourneert de bronlocatie van het bestand dat het schema laadde. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Retourneert de gekwalificeerde attributen die niet behoren tot de doelnamespace van het huidige schema. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Stelt de informatie in die aangeeft dat deze facet vast is. |
...
|  [XmlSchemaMinExclusiveFacet](./xmlschemaminexclusivefacet/)() | Initialiseert een nieuw exemplaar van de [XmlSchemaMinExclusiveFacet](./) klasse. |
...
Objecten van deze klasse mogen alleen worden toegewezen met de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit instanties van dit type op de stapel of met operator new, omdat dit zal leiden tot runtime-fouten en/of assert-fouten. Wikkel deze klasse altijd in een [System::SmartPtr](../../system/smartptr/) pointer en gebruik deze pointer om deze door te geven aan functies als argument. 
