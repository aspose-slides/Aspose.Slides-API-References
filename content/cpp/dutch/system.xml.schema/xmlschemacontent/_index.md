...
description: Een abstracte klasse voor schemainhoud.
type: docs
weight: 313
url: /nl/system.xml.schema/xmlschemacontent/
---
## XmlSchemaContent klasse

Een abstracte klasse voor schemainhoud.
...
| void [Lock](../../system/object/lock/)() | Implementeert C# lock() statement vergrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) wachobject. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Stelt overschakelen van pointers in containers naar zwakke modus toe. |
