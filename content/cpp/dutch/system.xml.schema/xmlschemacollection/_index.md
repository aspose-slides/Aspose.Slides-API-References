...
description: Bevat een cache van XML-schema-definitietaal (XSD) en XML-Data Reduced (XDR) schema's.
type: docs
weight: 222
url: /nl/system.xml.schema/xmlschemacollection/
---
## XmlSchemaCollection klasse

Bevat een cache van XML [Schema](../) definition language (XSD) en XML-Data Reduced (XDR) schema's.
...
| Method | Description |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Voegt het schema toe dat zich op de opgegeven URL bevindt toe aan de schemacollectie. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Voegt het schema dat in de [XmlReader](../../system.xml/xmlreader/) zit toe aan de schemacollectie. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Voegt het schema toe dat in de [XmlReader](../../system.xml/xmlreader/) zit aan de schemacollectie. De gespecificeerde [XmlResolver](../../system.xml/xmlresolver/) wordt gebruikt om externe bronnen op te lossen. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Voegt de [XmlSchema](../xmlschema/) toe aan de collectie. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Voegt de [XmlSchema](../xmlschema/) toe aan de collectie. De gespecificeerde [XmlResolver](../../system.xml/xmlresolver/) wordt gebruikt om externe referenties op te lossen. |
| void [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaCollection](./)\>\&) | Voegt alle namespaces die zijn gedefinieerd in de opgegeven collectie (inclusief hun bijbehorende schema's) toe aan deze collectie. |
...
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Retourneert een waarde die aangeeft of de **targetNamespace** van de gespecificeerde [XmlSchema](../xmlschema/) zich in de collectie bevindt. |
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) | Retourneert een waarde die aangeeft of een schema met de gespecificeerde namespace zich in de collectie bevindt. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\&, **int32_t**) | Kopieert alle [XmlSchema](../xmlschema/) objecten uit deze collectie naar de opgegeven array beginnend bij de opgegeven index. |
...
| **int32_t** [get_Count](./get_count/)() | Retourneert het aantal namespaces dat is gedefinieerd in deze collectie. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](./get_nametable/)() | Retourneert de standaard [XmlNameTable](../../system.xml/xmlnametable/) die door de [XmlSchemaCollection](./) wordt gebruikt bij het laden van nieuwe schema's. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\> [GetEnumerator](./getenumerator/)() override | Biedt ondersteuning voor iteratie over de verzameling schema's. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Retourneert de [XmlSchema](../xmlschema/) die is gekoppeld aan de opgegeven namespace-URI. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieconstructor. Kopieert niets werkelijk, initialiseert alleen een nieuw object en maakt kopieren van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets werkelijk, initialiseert alleen een nieuw object en maakt kopieren van subklassen mogelijk. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th template-argument in als een zwakke pointer (in plaats van gedeeld). Hiermee kunnen pointers in containers naar zwakke modus worden geschakeld. |
...
|  [XmlSchemaCollection](./xmlschemacollection/)() | Initialiseert een nieuw exemplaar van de [XmlSchemaCollection](./) klasse. |
|  [XmlSchemaCollection](./xmlschemacollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Initialiseert een nieuw exemplaar van de [XmlSchemaCollection](./) klasse met de opgegeven [XmlNameTable](../../system.xml/xmlnametable/). De [XmlNameTable](../../system.xml/xmlnametable/) wordt gebruikt bij het laden van schema's. |
...
Verouderd
:   De [XmlSchemaCollection](./) klasse is verouderd. Gebruik [XmlSchemaSet](../xmlschemaset/) in plaats daarvan.

Objecten van deze klasse mogen alleen worden gealloceerd met de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit instanties van dit type op de stack of met operator new, omdat dit tot runtime-fouten en/of assert-fouten leidt. Wikkel deze klasse altijd in een [System::SmartPtr](../../system/smartptr/) pointer en gebruik deze pointer om het als argument aan functies door te geven.
