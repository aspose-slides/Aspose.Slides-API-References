...
description: Representeert het World Wide Web Consortium (W3C) any element.
type: docs
weight: 131
url: /nl/system.xml.schema/xmlschemaany/
---
## XmlSchemaAny klasse


Representeert het World Wide [Web](../../system.web/) Consortium (W3C) **any** element.
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | Retourneert het maximale aantal keren dat het deeltje kan voorkomen. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Retourneert het getal als tekenreekswaarde. Maximale aantal keren dat het deeltje kan voorkomen. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | Retourneert het minimale aantal keren dat het deeltje kan voorkomen. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Retourneert het getal als tekenreekswaarde. Het minimale aantal keren dat het deeltje kan voorkomen. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Retourneert de namespaces die de elementen bevatten die kunnen worden gebruikt. |
...
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | Retourneert informatie over hoe een applicatie of XML-processor de validatie van XML-documenten moet afhandelen voor de elementen die zijn gespecificeerd door het **any** element. |
...
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Stelt de regelpositie in het bestand in waarnaar het **schema** element wijst. |
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Stelt het maximale aantal keren in dat het deeltje kan voorkomen. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Stelt het getal in als tekenreekswaarde. Maximale aantal keren dat het deeltje kan voorkomen. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Stelt het minimale aantal keren in dat het deeltje kan voorkomen. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Stelt het getal in als tekenreekswaarde. Het minimale aantal keren dat het deeltje kan voorkomen. |
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Stelt de namespaces in die de elementen bevatten die kunnen worden gebruikt. |
...
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | Stelt informatie in over hoe een applicatie of XML-processor de validatie van XML-documenten moet afhandelen voor de elementen die zijn gespecificeerd door het **any** element. |
...
|  [XmlSchemaAny](./xmlschemaany/)() | Initialiseert een nieuw exemplaar van de [XmlSchemaAny](./) klasse. |
...
|  [XmlSchemaParticle](../xmlschemaparticle/xmlschemaparticle/)() | Initialiseert een nieuw exemplaar van de [XmlSchemaParticle](../xmlschemaparticle/) klasse. |
...
Objecten van deze klasse mogen alleen worden gealloceerd met de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit exemplaren van dit type op de stack of met operator new, omdat dit runtime-fouten en/of assertiefouten veroorzaakt. Wikkel deze klasse altijd in een [System::SmartPtr](../../system/smartptr/) pointer en gebruik deze pointer om het als argument aan functies door te geven. 
