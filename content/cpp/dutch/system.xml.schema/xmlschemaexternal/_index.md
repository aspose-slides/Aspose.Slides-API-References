...
description: Geeft informatie over het meegeleverde schema.
type: docs
weight: 391
url: /nl/system.xml.schema/xmlschemaexternal/
---
## XmlSchemaExternal klasse
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [get_Schema](./get_schema/)() | Returns the [XmlSchema](../xmlschema/) for the referenced schema. |
| [String](../../system/string/) [get_SchemaLocation](./get_schemalocation/)() | Returns the Uniform Resource Identifier (URI) location for the schema, which tells the schema processor where the schema physically resides. |
...
| void [set_Schema](./set_schema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Sets the [XmlSchema](../xmlschema/) for the referenced schema. |
| void [set_SchemaLocation](./set_schemalocation/)(const [String](../../system/string/)\&) | Sets the Uniform Resource Identifier (URI) location for the schema, which tells the schema processor where the schema physically resides. |
...
Objecten van deze klasse moeten alleen worden toegewezen met [System::MakeObject()](../../system/makeobject/) functie. Maak nooit instanties van dit type op de stack of met operator new, omdat dit zal leiden tot runtime-fouten en/of assertiefouten. Wrap deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik die pointer om het als argument aan functies door te geven. 
