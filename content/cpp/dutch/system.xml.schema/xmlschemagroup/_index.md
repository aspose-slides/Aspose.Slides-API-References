...
description: Stelt het group-element uit XML-schema voor zoals gespecificeerd door het World Wide Web Consortium (W3C). Deze klasse definieert groepen op schematisch niveau die worden gerefereerd vanuit de complexe types. Het groepeert een reeks elementdeclaraties zodat ze als een groep in complexe type-definities kunnen worden opgenomen.
type: docs
weight: 430
url: /nl/system.xml.schema/xmlschemagroup/
---
## XmlSchemaGroup klasse


Stelt het **groep**-element uit XML [Schema](../) voor zoals gespecificeerd door het World Wide [Web](../../system.web/) Consortium (W3C). Deze klasse definieert groepen op **schema**-niveau die worden gerefereerd vanuit de complexe types. Het groepeert een reeks elementdeclaraties zodat ze als een groep kunnen worden opgenomen in complexe type-definities.
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Retourneert de regellocatie in het bestand waarnaar het **schema**-element verwijst. |
| [String](../../system/string/) [get_Name](./get_name/)() | Retourneert de naam van de schema-groep. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | Retourneert een van de [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) of [XmlSchemaSequence](../xmlschemasequence/)-klassen. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Retourneert de gekwalificeerde naam van de schema-groep. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzings-operator. Kopieert niets, initialiseert alleen nieuw object en maakt kopie-constructie van subklassen mogelijk. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Stelt de naam van de schema-groep in. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Stelt de XmlSerializerNamespaces in die met dit schema-object moet worden gebruikt. |
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Stelt de bovenliggende van deze [XmlSchemaObject](../xmlschemaobject/) in. |
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\>\&) | Stelt een van de [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) of [XmlSchemaSequence](../xmlschemasequence/)-klassen in. |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Stelt de bronlocatie voor het bestand dat het schema heeft geladen in. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n-de sjabloon-argument in als een zwakke pointer (in plaats van gedeelde). Maakt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
| int [SharedCount](../../system/object/sharedcount/)() const | Haalt de huidige waarde van de gedeelde referentieteller op. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Verhoogt de gedeelde referentieteller. Mag niet direct worden aangeroepen; gebruik in plaats daarvan slimme pointers of ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Verlaagt en retourneert de gedeelde referentieteller. Mag niet direct worden aangeroepen; gebruik in plaats daarvan slimme pointers of ThisProtector. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analoge van C# [Object.ToString()](../../system/object/tostring/)-methode. Maakt omzetten van aangepaste objecten naar tekenreeks mogelijk. |
...
| virtual  [~Object](../../system/object/~object/)() | Vernietigt object. Vrijgeven van alle interne datastructuren. |
...
Objecten van deze klasse mogen alleen worden gealloceerd met de functie [System::MakeObject()](../../system/makeobject/). Maak nooit instanties van dit type op de stack of met operator new, omdat dit leidt tot runtime-fouten en/of assertiefouten. Wikkel deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik deze pointer om deze als argument aan functies door te geven. 
