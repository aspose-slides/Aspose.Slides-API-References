...
description: Ondersteunt een eenvoudige iteratie over een verzameling. Deze klasse kan niet worden geërfd.
type: docs
weight: 235
url: /nl/system.xml.schema/xmlschemacollectionenumerator/
---
## XmlSchemaCollectionEnumerator klasse

Ondersteunt een eenvoudige iteratie over een verzameling. Deze klasse kan niet worden geërfd.
...
| System::Details::VirtualizedIteratorBase\<[SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchema](../xmlschema/)\>\> * [CloneIterator](./cloneiterator/)() const override | Kopieert de huidige iterator. |
...
| const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\& [get_Current](./get_current/)() const override | Retourneert de huidige [XmlSchema](../xmlschema/) in de verzameling. |
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Voert de eerste [MoveNext()](../../system.collections.generic/ienumerator/movenext/) oproep uit en bereidt het enumerator-object voor om te worden gebruikt door VirtualizedIterator. |
...
| **bool** [MoveNext](./movenext/)() override | Voortbeweegt de enumerator naar het volgende schema in de verzameling. |
...
Objecten van deze klasse mogen alleen worden gealloceerd met behulp van de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit instanties van dit type op de stack of met operator new, omdat dit leidt tot runtime-fouten en/of assert-fouten. Wikkel deze klasse altijd in een [System::SmartPtr](../../system/smartptr/) pointer en gebruik deze pointer om hem als argument aan functies door te geven. 
