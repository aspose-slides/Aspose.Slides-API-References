...
description: Stelt het restriction-element voor eenvoudige inhoud uit XML Schema voor, zoals gespecificeerd door de World Wide Web Consortium (W3C). Deze klasse kan worden gebruikt om eenvoudige types af te leiden door beperking. Dergelijke afleidingen kunnen worden gebruikt om het bereik van waarden voor het element te beperken tot een deelverzameling van de waarden die zijn gespecificeerd in het geërfde eenvoudige type.
type: docs
weight: 820
url: /nl/system.xml.schema/xmlschemasimplecontentrestriction/
---
## XmlSchemaSimpleContentRestriction klasse

Stelt het **restriction**-element voor eenvoudige inhoud uit XML [Schema](../) voor, zoals gespecificeerd door de World Wide [Web](../../system.web/) Consortium (W3C). Deze klasse kan worden gebruikt om eenvoudige types af te leiden door beperking. Dergelijke afleidingen kunnen worden gebruikt om het bereik van waarden voor het element te beperken tot een deelverzameling van de waarden die zijn gespecificeerd in het geërfde eenvoudige type.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevendekommagelijk vergelijkingen waarbij twee NaN-waarden als gelijk worden beschouwd, ook al is NaN volgens IEC 60559:1989 niet gelijk aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevendekommagelijk vergelijkingen waarbij twee NaN-waarden als gelijk worden beschouwd, ook al is NaN volgens IEC 60559:1989 niet gelijk aan enige waarde, inclusief NaN. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Retourneert een [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) die wordt gebruikt voor de attribuutwaarde. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Retourneert de [XmlSchemaAttribute](../xmlschemaattribute/)- en [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/)-collectie van attributen voor het eenvoudige type. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | Retourneert de basiswaarde van het eenvoudige type. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Retourneert de naam van het ingebouwde datatype of eenvoudige type waarvan dit type is afgeleid. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | Retourneert een [Xml](../../system.xml/)[Schema](../) facet. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Retourneert de XmlSerializerNamespaces die gebruikt moet worden met dit schemaobject. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analoge van C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-methode. Biedt klonen van aangepaste typen. |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Stelt een [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) in die gebruikt wordt voor de attribuutwaarde. |
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Stelt de basiswaarde van het eenvoudige type in. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Stelt de naam van het ingebouwde datatype of eenvoudige type waarvan dit type is afgeleid in. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Stelt de XmlSerializerNamespaces in die gebruikt moet worden met dit schemaobject. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt de n'th sjabloonparameter in als een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk om pointers in containers om te schakelen naar zwakke modus. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analoge van C# [Object.ToString()](../../system/object/tostring/)-methode. Biedt conversie van aangepaste objecten naar string. |
