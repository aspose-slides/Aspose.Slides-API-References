...
description: Biedt de uitzondering die wordt gegooid wanneer er een fout optreedt tijdens het verwerken van een XPath-expressie.
type: docs
weight: 1
url: /nl/system.xml.xpath/details_xpathexception/
---
## Details_XPathException klasse

Biedt de uitzondering die wordt gegooid wanneer een fout optreedt tijdens het verwerken van een [XPath](../) expressie.
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Retourneert een 32-bit integerwaarde die een HRESULT-code is die geassocieerd is met de uitzondering die wordt weergegeven door het huidige object. |
...
| [String](../../system/string/) [get_Message](./get_message/)() const override | Retourneert de beschrijving van de foutconditie voor deze uitzondering. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Stelt toe om pointers in containers te wisselen naar zwakke modus. |
