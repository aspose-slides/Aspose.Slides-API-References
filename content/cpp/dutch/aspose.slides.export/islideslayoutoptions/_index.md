...
description: Stelt de presentatielay-outmodus voor export voor.
type: docs
weight: 391
url: /nl/aspose.slides.export/islideslayoutoptions/
---
## ISlidesLayoutOptions klasse

Stelt de presentatielay-outmodus voor export voor.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevendekommagetalleng vergelijken waarbij twee NaN-waarden als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevendekommagetalleng vergelijken waarbij twee NaN-waarden als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het ontgrendelen van C# lock()-statement. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-waarnemingsobject. |
