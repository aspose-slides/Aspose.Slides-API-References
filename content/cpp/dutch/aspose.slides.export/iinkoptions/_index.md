...
Biedt opties die het uiterlijk van [Ink](../../aspose.slides.ink/)-objecten in een geëxporteerd document regelen.
...
| virtual **bool** [get_HideInk](./get_hideink/)() | Toont of verbergt [Ink](../../aspose.slides.ink/)-elementen in het geëxporteerde document. |
| virtual **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() | Gebruikt ROP-bewerking of Opacity voor het renderen van de penseel. |
...
| virtual void [set_HideInk](./set_hideink/)(**bool**) | Toont of verbergt [Ink](../../aspose.slides.ink/)-elementen in het geëxporteerde document. |
| virtual void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) | Gebruikt ROP-bewerking of Opacity voor het renderen van de penseel. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Sta het wisselen van pointers in containers naar zwakke modus toe. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Vermindert en retourneert de gedeelde referentietelling. Mag niet rechtstreeks worden aangeroepen; gebruik in plaats daarvan slimme pointers of ThisProtector. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Vermindert de zwakke referentietelling. Mag niet rechtstreeks worden aangeroepen; gebruik in plaats daarvan slimme pointers of ThisProtector. |
