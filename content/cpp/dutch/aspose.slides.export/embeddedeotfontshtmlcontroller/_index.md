...
description: De opmaakcontrollerklasse om te gebruiken voor het insluiten van lettertypen in EOT-formaat
type: docs
weight: 14
...
De opmaakcontroller-klasse om te gebruiken voor het insluiten van lettertypen in EOT-formaat
...
| --- | --- |
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)() | Creëert een nieuw exemplaar. |
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Creëert een nieuw exemplaar. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert niets echt, initialiseert alleen een nieuw object en maakt het mogelijk subclasses te copy-constructeren. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n'th sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Staat het omschakelen van pointers in containers naar zwakke modus toe. |
