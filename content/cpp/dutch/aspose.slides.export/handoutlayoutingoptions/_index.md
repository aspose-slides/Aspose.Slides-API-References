...
description: Stelt de handout-presentatie indelingsmodus voor export voor.
type: docs
weight: 66
...
Stelt de handout-presentatie-indelingsmodus voor export voor.
...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | Specificeert hoeveel dia's en in welke volgorde op de pagina [HandoutType](../handouttype/) worden geplaatst. |
| **bool** [get_PrintComments](./get_printcomments/)() const | Specificeert of opmerkingen op dia's getoond moeten worden. |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | Specificeert of er kaders rond de weergegeven dia's moeten worden getekend. |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | Specificeert of de weergegeven dia-nummers afgedrukt moeten worden. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt het mogelijk afgeleide klassen te kopiëren. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt het mogelijk afgeleide klassen te kopiëren. |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | Specificeert hoeveel dia's en in welke volgorde op de pagina [HandoutType](../handouttype/) worden geplaatst. |
| void [set_PrintComments](./set_printcomments/)(**bool**) | Specificeert of opmerkingen op dia's getoond moeten worden. |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | Specificeert of er kaders rond de weergegeven dia's moeten worden getekend. |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | Specificeert of de weergegeven dia-nummers afgedrukt moeten worden. |
