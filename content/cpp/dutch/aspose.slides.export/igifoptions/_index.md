...
| virtual **int32_t** [get_DefaultDelay](./get_defaultdelay/)() | Haalt de standaardvertragingstijd op [ms]. Deze waarde wordt gebruikt als de [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/)-methode niet werd aangeroepen. De standaardwaarde is 1000. |
...
| virtual **bool** [get_ExportHiddenSlides](./get_exporthiddenslides/)() | Bepaalt of verborgen dia's worden geëxporteerd. De standaardwaarde is false. |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_FrameSize](./get_framesize/)() | Haalt framegrootte op. |
| virtual [Aspose::Slides::GradientStyle](../../aspose.slides/gradientstyle/) [get_GradientStyle](../isaveoptions/get_gradientstyle/)() | Retourneert de visuele stijl van de gradient. Leest [GradientStyle](../../aspose.slides/gradientstyle/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IProgressCallback](../../aspose.slides/iprogresscallback/)\> [get_ProgressCallback](../isaveoptions/get_progresscallback/)() | Stelt een callback-object voor om voortgangsupdates in procenten op te slaan. Zie [IProgressCallback](../../aspose.slides/iprogresscallback/). |
| virtual **bool** [get_SkipJavaScriptLinks](../isaveoptions/get_skipjavascriptlinks/)() | Specificeert of hyperlinks met JavaScript-aanroepen moeten worden overgeslagen bij het opslaan van de presentatie. Leest **bool**. De standaardwaarde is **false**. |
| virtual **int32_t** [get_TransitionFps](./get_transitionfps/)() | Haalt overgang-FPS op [frames/sec]. De standaardwaarde is 25. |
...
| virtual void [set_DefaultDelay](./set_defaultdelay/)(**int32_t**) | Stelt de standaardvertragingstijd in [ms]. Deze waarde wordt gebruikt als de [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/)-methode niet werd aangeroepen. De standaardwaarde is 1000. |
...
| virtual void [set_ExportHiddenSlides](./set_exporthiddenslides/)(**bool**) | Bepaalt of verborgen dia's worden geëxporteerd. De standaardwaarde is false. |
| virtual void [set_FrameSize](./set_framesize/)([System::Drawing::Size](../../system.drawing/size/)) | Stelt framegrootte in. |
| virtual void [set_GradientStyle](../isaveoptions/set_gradientstyle/)([Aspose::Slides::GradientStyle](../../aspose.slides/gradientstyle/)) | Stelt de visuele stijl van de gradient in. Schrijft [GradientStyle](../../aspose.slides/gradientstyle/). |
| virtual void [set_ProgressCallback](../isaveoptions/set_progresscallback/)([System::SharedPtr](../../system/sharedptr/)\<[IProgressCallback](../../aspose.slides/iprogresscallback/)\>) | Stelt een callback-object voor om voortgangsupdates in procenten op te slaan. Zie [IProgressCallback](../../aspose.slides/iprogresscallback/). |
| virtual void [set_SkipJavaScriptLinks](../isaveoptions/set_skipjavascriptlinks/)(**bool**) | Specificeert of hyperlinks met JavaScript-aanroepen moeten worden overgeslagen bij het opslaan van de presentatie. Schrijft **bool**. De standaardwaarde is **false**. |
| virtual void [set_TransitionFps](./set_transitionfps/)(**int32_t**) | Stelt overgang-FPS in [frames/sec]. De standaardwaarde is 25. |
