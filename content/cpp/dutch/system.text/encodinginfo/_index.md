...
| int [get_CodePage](./get_codepage/)() const | Haalt codepagina-ID op. |
| const [String](../../system/string/)\& [get_DisplayName](./get_displayname/)() const | Haalt de volledige gelokaliseerde coderingnaam op. |
| const [String](../../system/string/)\& [get_Name](./get_name/)() const | Haalt de korte naam van de codering op. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haalt de referentieteller-datastructuur op die aan het object is gekoppeld. |
| [EncodingPtr](../../system/encodingptr/) [GetEncoding](./getencoding/)() | Haalt de codering op die door de info wordt beschreven. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th-templates argument in op een zwakke pointer (in plaats van gedeelde). Maakt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
