...
description: "Voorziet in een buffer voor fallback-implementatie. Objecten van deze klasse mogen alleen worden aangemaakt met de functie System::MakeObject(). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit tot runtime-fouten en/of assertion-fouten leidt. Wrap deze klasse altijd in een System::SmartPtr pointer en gebruik deze pointer om het als argument aan functies door te geven."
type: docs
weight: 183
url: /nl/system.text/encoderfallbackbuffer/
---
...
| virtual **bool** [Fallback](./fallback/)(char_t, int) | Implementeert de daadwerkelijke fallback-procedure. |
| virtual **bool** [Fallback](./fallback/)(char_t, char_t, int) | Implementeert de daadwerkelijke fallback-procedure. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| virtual int [get_Remaining](./get_remaining/)() const | Haalt het resterende aantal karakters op dat nog moet worden verwerkt. |
...
| virtual char_t [GetNextChar](./getnextchar/)() | Haalt het volgende teken uit de fallback-buffer. |
...
| virtual void [Reset](./reset/)() | Reset de buffer naar de oorspronkelijke toestand. |
