...
description: Definieert een algemene Tuple-implementatie die toegang tot Tuple-instantieleden mogelijk maakt zonder het onderliggende Tuple-type te kennen.
type: docs
weight: 53
url: /nl/system.runtime.compilerservices/ituple/
---
## ITuple klasse


Definieert een algemene [Tuple](../../system/tuple/) implementatie die toegang tot [Tuple](../../system/tuple/) instantieleden mogelijk maakt zonder het onderliggende [Tuple](../../system/tuple/) type te kennen.
...
| virtual **int32_t** [get_Length](./get_length/)() const | Retourneert het aantal posities in deze datastructuur. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | Retourneert het element op positie index. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Assignatie-operator. Kopieert niets echt, initialiseert slechts een nieuw object en maakt het mogelijk om subklassen te copy-constructeren. |
...
* Naamruimte [System::Runtime::CompilerServices](../)
