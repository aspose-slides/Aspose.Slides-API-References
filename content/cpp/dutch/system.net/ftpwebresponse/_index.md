...
| Method | Description |
| --- | --- |
| void [Close](./close/)() override | Niet geïmplementeerd. |
...
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Niet geïmplementeerd. |
| [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](./get_headers/)() override | Niet geïmplementeerd. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Uri](../../system/uri/)\> [get_ResponseUri](./get_responseuri/)() override | Niet geïmplementeerd. |
| virtual **bool** [get_SupportsHeaders](../webresponse/get_supportsheaders/)() | Retourneert een waarde die aangeeft of de huidige respons headers ondersteunt. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetResponseStream](./getresponsestream/)() override | Niet geïmplementeerd. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n-de sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk pointers in containers om te schakelen naar zwakke modus. |
