...
description: "Stelt een lijst van gesorteerde cookies voor. Objecten van deze klasse mogen alleen worden gealloceerd met de System::MakeObject()-functie. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit zal leiden tot runtime-fouten en/of assertiefouten. Omhul deze klasse altijd in een System::SmartPtr-pointer en gebruik deze pointer om deze door te geven aan functies als argument."
type: docs
weight: 14
url: /nl/system.net/cookiecollection/
---
## CookieCollection klasse

Stelt een lijst van gesorteerde cookies voor. Objecten van deze klasse mogen alleen worden gealloceerd met behulp van de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit zal resulteren in runtime-fouten en/of assertiefouten. Omhul altijd deze klasse in een [System::SmartPtr](../../system/smartptr/) pointer en gebruik deze pointer om deze door te geven aan functies als argument.
...
| Method | Beschrijving |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) override | Voegt een cookie toe aan de collectie. |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](./)\>) | Voegt cookies uit de opgegeven collectie toe aan de huidige collectie. |
...
| void [Clear](./clear/)() override | Verwijdert alle cookies uit de collectie. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) const override | Controleert of de collectie de opgegeven cookie bevat. |
|  [CookieCollection](./cookiecollection/)() | Construeert een nieuwe instantie. |
...
| **int32_t** [get_Count](./get_count/)() const override | Retourneert het aantal elementen in de collectie. |
| **bool** [get_IsOtherVersionSeen](./get_isotherversionseen/)() | Retourneert een waarde die aangeeft of de collectie een cookie bevat met een versie die niet gelijk is aan [Cookie::MaxSupportedVersion](../cookie/maxsupportedversion/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [idx_get](./idx_get/)(**int32_t**) | Retourneert een cookie uit de cookie-collectie op de opgegeven index. |
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [idx_get](./idx_get/)([String](../../system/string/)) | Retourneert een cookie uit de cookie-collectie op basis van de opgegeven naam. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>) | Retourneert de index van de opgegeven cookie. |
| **int32_t** [InternalAdd](./internaladd/)([System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>, **bool**) | Voegt de opgegeven cookie toe aan de collectie. |
...
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Roept een transformatie-functie aan op elk element van een generieke reeks en retourneert de minimum resulterende waarde. |
...
| void [Lock](../../system/object/lock/)() | Implementeert lock()-statement van C# voor vergrendeling. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/) wachtobject. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieconstructor. Kopieert niets, Initialiseert slechts een nieuw object en maakt copy-constructie van subklassen mogelijk. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\&) override | Verwijdert de opgegeven cookie uit de collectie. |
| void [RemoveAt](./removeat/)(**int32_t**) | Verwijdert een cookie op de opgegeven index. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verlaagt de gedeelde referentieteller met de opgegeven waarde. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n-de sjabloonargument in als een weak-pointer (in plaats van shared). Staat toe om pointers in containers naar weak-modus te schakelen. |
...
| [DateTime](../../system/datetime/) [TimeStamp](./timestamp/)([CookieCollection::Stamp](./stamp/)) | Werkt de timestamp bij volgens het opgegeven scenario en retourneert een nieuwe waarde. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert lock()-statement van C# voor ontgrendeling. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/) wachtobject. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Retourneert de implementatie van de begin-const-iterator voor de huidige container. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Retourneert de implementatie van de begin-iterator voor de huidige container. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Retourneert de implementatie van de end-const-iterator voor de huidige container. |
| System::Details::VirtualizedIteratorBase\<[System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\>\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Retourneert de implementatie van de end-iterator voor de huidige container. |
...
| Enum | Beschrijving |
| --- | --- |
| [Stamp](./stamp/) | Somt de timestamp-set-operaties op. |
