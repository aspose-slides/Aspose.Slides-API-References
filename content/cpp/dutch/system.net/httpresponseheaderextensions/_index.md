...
description: Bevat hulpprogramma-methoden om te werken met de HttpResponseHeader-enumeratiewaarden.
type: docs
weight: 235
url: /nl/system.net/httpresponseheaderextensions/
---
## HttpResponseHeaderExtensions klasse

Bevat hulpprogramma-methoden om te werken met de HttpResponseHeader-enumeratiewaarden.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl zwevend-kommagelijk vergelijkingen waarbij twee NaN-waarden als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl zwevend-kommagelijk vergelijkingen waarbij twee NaN-waarden als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| static [String](../../system/string/) [GetName](./getname/)([HttpResponseHeader](../httpresponseheader/)) | Retourneert de naam van de opgegeven header. |
...
|  [HttpResponseHeaderExtensions](./httpresponseheaderextensions/)() | De verwijderde standaardconstructor. |
...
| void [Lock](../../system/object/lock/)() | Implementeert C# lock()-statement locken. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-wachterobject. |
