...
type: docs
weight: 144
url: /nl/system.io/details_drivenotfoundexception/
---
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Retourneert een 32-bit geheel getal dat een HRESULT-code is die bij de exceptie hoort die door het huidige object wordt vertegenwoordigd. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](./gettype/)() const override | Haal het werkelijke type van het object op. Analoge van de C# [System.Object.GetType()](../../system/object/gettype/)-aanroep. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n'th-template-argument in op een zwakke pointer (in plaats van shared). Maakt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementeert de [what()](../../system/details_exception/what/)-methode die wordt aangeroepen door de [ExceptionWrapper](../../system/exceptionwrapper/)-klasse. Ondanks het feit dat deze klasse niet is afgeleid van std::exception, kunnen afgeleide klassen protected/private-leden gebruiken om hun logica te implementeren. Het verplaatsen van deze methode-implementatie naar de [ExceptionWrapper](../../system/exceptionwrapper/) kan die logica breken. |
