...
type: docs
weight: 157
url: /nl/system.io/details_endofstreamexception/
---
## Details_EndOfStreamException klasse
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert zwevend-kommagelijken vergelijking in C#-stijl waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert zwevend-kommagelijken vergelijking in C#-stijl waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Retourneert een 32-bit geheel getal dat een HRESULT-code is geassocieerd met de exceptie die door het huidige object wordt weergegeven. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haalt de data-structuur voor referentieteller op die aan het object is gekoppeld. |
...
| void [Lock](../../system/object/lock/)() | Implementeert de lock()-statement van C#. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-waarschuwingsobject. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het ontgrendelen van de C# lock()-statement. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-waarschuwingsobject. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Verhoogt de zwakke referentieteller. Moet niet direct worden aangeroepen; gebruik in plaats daarvan slimme pointers of ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Verlaagt de zwakke referentieteller. Moet niet direct worden aangeroepen; gebruik in plaats daarvan slimme pointers of ThisProtector. |
| virtual const char * [what](../../system/details_exception/what/)() const | Implementeert de [what()](../../system/details_exception/what/)-methode die wordt aangeroepen door de [ExceptionWrapper](../../system/exceptionwrapper/)-klasse. Ondanks het feit dat deze klasse niet is geërfd van std::exception, kunnen afgeleide klassen beschermde/private leden gebruiken om hun logica te implementeren. Het verplaatsen van deze methodenimplementatie naar de [ExceptionWrapper](../../system/exceptionwrapper/) kan die logica breken. |
