...
description: "SHA1 CSP-implementatie. Objecten van deze klasse mogen alleen worden toegewezen via de System::MakeObject() functie. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit leidt tot runtime-fouten en/of assertiefouten. Wikkel deze klasse altijd in een System::SmartPtr pointer en gebruik deze pointer om deze als argument aan functies door te geven."
type: docs
weight: 547
url: /nl/system.security.cryptography/sha1cryptoserviceprovider/
---
## SHA1CryptoServiceProvider klasse


[SHA1](../sha1/) CSP-implementatie. Objecten van deze klasse mogen alleen worden toegewezen via de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit leidt tot runtime-fouten en/of assertiefouten. Wikkel deze klasse altijd in een [System::SmartPtr](../../system/smartptr/) pointer en gebruik deze pointer om deze als argument aan functies door te geven.
...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)([SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> const\&) | Leest stream tot het einde en berekent een hash voor de gelezen gegevens. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA1](../sha1/)\> [Create](../sha1/create/)() | Maakt een instantie van de hash-algoritme. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA1](../sha1/)\> [Create](../sha1/create/)(const [String](../../system/string/)\&) | Maakt een instantie van de hash-algoritme. |
...
| virtual int [get_HashSize](../hashalgorithm/get_hashsize/)() | Haalt de grootte van de berekende hash-waarde op in bytes. |
