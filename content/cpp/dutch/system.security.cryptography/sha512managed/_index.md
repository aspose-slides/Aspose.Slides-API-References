...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Hasht buffer-deel. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)([SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> const\&) | Leest de stream tot het einde en berekent de hash voor de gelezen data. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](../sha512/)\> [Create](../sha512/create/)() | Maakt een instantie van het hash-algoritme. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](../sha512/)\> [Create](../sha512/create/)(const [String](../../system/string/)\&) | Maakt een instantie van het hash-algoritme. |
...
| virtual int [get_HashSize](../hashalgorithm/get_hashsize/)() | Haalt de grootte van de berekende hashwaarde in bytes op. |
...
| virtual void [Initialize](../hashalgorithm/initialize/)() | Reset de hasher naar de initiële staat. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieer-constructor. Kopieert niets echt, initialiseert alleen een nieuw object en maakt kopiëren-constructie van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets echt, initialiseert alleen een nieuw object en maakt kopiëren-constructie van subklassen mogelijk. |
