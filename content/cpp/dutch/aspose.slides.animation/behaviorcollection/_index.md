...
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Voegt een nieuw gedrag toe aan een collectie. |
| [iterator](./iterator/) [begin](./begin/)() | Geeft een iterator die wijst naar het eerste element (indien aanwezig) van de collectie. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Geeft een iterator die wijst naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Geeft een iterator die wijst naar het eerste const-gekwalificeerde element (indien aanwezig) van de collectie. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Geeft een iterator die wijst net na het laatste const-gekwalificeerde element (indien aanwezig) van de collectie. |
| void [Clear](./clear/)() override | Verwijdert alle gedragingen uit een collectie. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Bepaalt of [ICollection](../../system.collections.generic/icollection/) een specifieke waarde bevat. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>, **int32_t**) | Kopieert de elementen van de [ICollection](../../system.collections.generic/icollection/) naar een [System::Array](../../system/array/), beginnend bij een bepaalde [System::Array](../../system/array/)-index. |
| [iterator](./iterator/) [end](./end/)() | Geeft een iterator die wijst net na het laatste element (indien aanwezig) van de collectie. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Geeft een iterator die wijst net na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
...
| **int32_t** [get_Count](./get_count/)() override | Retourneert het aantal gedragingen in een collectie. Alleen-lezen **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Geeft een waarde die aangeeft of de [ICollection](../../system.collections.generic/icollection/) alleen-lezen is. Alleen-lezen **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de collectie itereert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) override | Retourneert een gedrag op de opgegeven index. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Retourneert een gedrag op de opgegeven index. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Bepaalt de index van een specifiek item in de [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Voegt nieuw gedrag toe aan een collectie op de opgegeven index. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert in feite niets, initialiseert alleen een nieuw object en schakelt het kopiëren van subklassen in. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert in feite niets, initialiseert alleen een nieuw object en schakelt het kopiëren van subklassen in. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Verwijdert gespecificeerd gedrag uit een collectie. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Verwijdert gedrag uit een collectie op de opgegeven index. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Geeft een iterator die wijst naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Geeft een iterator die wijst naar het eerste element (indien aanwezig) van de collectie. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Geeft een iterator die wijst net na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Geeft een iterator die wijst net na het laatste element (indien aanwezig) van de collectie. |
...
* Klasse [IBehaviorCollection](../ibehaviorcollection/)
