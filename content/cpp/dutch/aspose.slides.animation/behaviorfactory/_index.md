...
description: Standa toe animatie-effecten te maken
type: docs
weight: 40
...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorEffect](../icoloreffect/)\> [CreateColorEffect](./createcoloreffect/)() override | Creëert kleureffect. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommandEffect](../icommandeffect/)\> [CreateCommandEffect](./createcommandeffect/)() override | Creëert commando-effect. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFilterEffect](../ifiltereffect/)\> [CreateFilterEffect](./createfiltereffect/)() override | Creëert filtereffect. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMotionEffect](../imotioneffect/)\> [CreateMotionEffect](./createmotioneffect/)() override | Creëert bewegingseffect. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPropertyEffect](../ipropertyeffect/)\> [CreatePropertyEffect](./createpropertyeffect/)() override | Creëert eigenschapseffect. |
| [System::SharedPtr](../../system/sharedptr/)\<[IRotationEffect](../irotationeffect/)\> [CreateRotationEffect](./createrotationeffect/)() override | Creëert rotatie-effect. |
| [System::SharedPtr](../../system/sharedptr/)\<[IScaleEffect](../iscaleeffect/)\> [CreateScaleEffect](./createscaleeffect/)() override | Creëert schaal-effect. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISetEffect](../iseteffect/)\> [CreateSetEffect](./createseteffect/)() override | Creëert set-effect. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieconstructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt kopie-bouw van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt kopie-bouw van subklassen mogelijk. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n'th templates-argument in op een zwakke pointer (in plaats van gedeeld). Hiermee kun je pointers in containers naar zwakke modus schakelen. |
