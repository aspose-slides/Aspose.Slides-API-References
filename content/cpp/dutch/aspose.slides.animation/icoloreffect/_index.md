...
description: Vertegenwoordigt een kleureffect voor een animatiegedrag.
type: docs
weight: 209
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOffset](../icoloroffset/)\> [get_By](./get_by/)() | Beschrijft de relatieve offsetwaarde voor de kleuranimatie. Lees [IColorOffset](../icoloroffset/). |
| virtual [Aspose::Slides::Animation::ColorSpace](../colorspace/) [get_ColorSpace](./get_colorspace/)() | Stelt de kleurruimte van het gedrag voor. Lees [ColorSpace](../colorspace/). |
| virtual [ColorDirection](../colordirection/) [get_Direction](./get_direction/)() | Specificeert welke richting de tint rond het kleurenwiel moet cyclen. Lees [ColorDirection](../colordirection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_From](./get_from/)() | Deze waarde wordt gebruikt om de startkleur van het gedrag te specificeren. Lees [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](../ibehavior/get_properties/)() | Geeft de eigenschappen van het gedrag weer. Alleen-lezen [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../ibehavior/get_timing/)() | Geeft tijdseigenschappen voor het effectgedrag weer. Lees [ITiming](../itiming/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_To](./get_to/)() | Beschrijft de resulterende kleur voor de animatiekleurverandering. Lees [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual void [set_By](./set_by/)([System::SharedPtr](../../system/sharedptr/)\<[IColorOffset](../icoloroffset/)\>) | Beschrijft de relatieve offsetwaarde voor de kleuranimatie. Schrijf [IColorOffset](../icoloroffset/). |
| virtual void [set_ColorSpace](./set_colorspace/)([Aspose::Slides::Animation::ColorSpace](../colorspace/)) | Stelt de kleurruimte van het gedrag voor. Schrijf [ColorSpace](../colorspace/). |
| virtual void [set_Direction](./set_direction/)([ColorDirection](../colordirection/)) | Specificeert welke richting de tint rond het kleurenwiel moet cyclen. Schrijf [ColorDirection](../colordirection/). |
| virtual void [set_From](./set_from/)([System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\>) | Deze waarde wordt gebruikt om de startkleur van het gedrag te specificeren. Schrijf [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual void [set_Timing](../ibehavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | Geeft tijdseigenschappen voor het effectgedrag weer. Schrijf [ITiming](../itiming/). |
| virtual void [set_To](./set_to/)([System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\>) | Beschrijft de resulterende kleur voor de animatiekleurverandering. Schrijf [IColorFormat](../../aspose.slides/icolorformat/). |
