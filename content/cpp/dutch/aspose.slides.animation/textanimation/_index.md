...
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) override | Voegt een nieuw effect toe aan het einde van de huidige reeks tot het einde van de groeps-tekstanimaties. Alleen geldig als het aantal tekstparagrafen gelijk is aan of groter is dan het aantal effect-telkens van deze groep! |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl zwevende-kommagetallen vergelijking waarbij twee NaN’s als gelijk worden beschouwd, zelfs al zegt IEC 60559:1989 dat NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl zwevende-kommagetallen vergelijking waarbij twee NaN’s als gelijk worden beschouwd, zelfs al zegt IEC 60559:1989 dat NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() override | Lijst van bouwtype (bijv. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) van tekstanimatie. Lees [Animation::BuildType](../buildtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() override | Gelinkte vormeffect met groep of niet (null). Lees [IEffect](../ieffect/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert eigenlijk niets, initialiseert alleen nieuw object en schakelt kopie-constructie van subklassen in. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert eigenlijk niets, initialiseert alleen nieuw object en schakelt kopie-constructie van subklassen in. |
...
| void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) override | Lijst van bouwtype (bijv. [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) van tekstanimatie. Schrijf [Animation::BuildType](../buildtype/). |
| void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) override | Gelinkte vormeffect met groep of niet (null). Schrijf [IEffect](../ieffect/). |
...
* Klasse [ITextAnimation](../itextanimation/)
