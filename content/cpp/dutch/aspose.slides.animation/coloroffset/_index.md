...
| **float** [get_Value0](./get_value0/)() override | Definieert de eerste waarde van de offset. Leest **float**. |
| **float** [get_Value1](./get_value1/)() override | Definieert de tweede waarde van de offset. Leest **float**. |
| **float** [get_Value2](./get_value2/)() override | Definieert de derde waarde van de offset. Leest **float**. |
...
| void [set_Value0](./set_value0/)(**float**) override | Definieert de eerste waarde van de offset. Schrijft **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Definieert de tweede waarde van de offset. Schrijft **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Definieert de derde waarde van de offset. Schrijft **float**. |
