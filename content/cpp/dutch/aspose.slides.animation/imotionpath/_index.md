...
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\> [Add](./add/)([MotionCommandPathType](../motioncommandpathtype/), [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>, [MotionPathPointsType](../motionpathpointstype/), **bool**) | Voegt een nieuw commando toe aan het pad |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Haalt iterator op die naar het eerste element (indien aanwezig) van de collectie wijst. Deze iterator kan niet gebruikt worden om een verwezen object te wijzigen omdat [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) een kopie-object van T teruggeeft. |
...
| virtual void [Clear](./clear/)() | Verwijdert alle commando's uit de collectie. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Retourneert het aantal paden in de collectie. Alleen-lezen **int32_t**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haalt de referentietellergegevensstructuur op die bij het object hoort. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analoge van C# [Object.GetHashCode()](../../system/object/gethashcode/) methode. Stelt hashberekening van aangepaste objecten in staat. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\> [idx_get](./idx_get/)(**int32_t**) | Retourneert een commando op de opgegeven index. |
| virtual void [Insert](./insert/)(**int32_t**, [MotionCommandPathType](../motioncommandpathtype/), [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>, [MotionPathPointsType](../motionpathpointstype/), **bool**) | Voegt nieuw commando toe aan het pad |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\>) | Verwijdert opgegeven commando's uit de collectie. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Verwijdert een commando op de opgegeven index. |
...
| virtual  [~Object](../../system/object/~object/)() | Vernietigt object. Vrijtrekt alle interne datastructuren. |
