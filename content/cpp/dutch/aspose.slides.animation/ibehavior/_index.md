...
description: Vertegenwoordigt het basisklassen-gedrag van een effect.
type: docs
weight: 144
...
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](./get_accumulate/)() | Geeft aan of animatiegedragingen worden opgeteld. Lees [NullableBool](../../aspose.slides/nullablebool/). |
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](./get_additive/)() | Geeft aan of het huidige animatiegedrag wordt gecombineerd met andere lopende animaties. Lees [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](./get_properties/)() | Geeft eigenschappen van gedrag weer. Alleen-lezen [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](./get_timing/)() | Geeft timing-eigenschappen voor het effectgedrag weer. Lees [ITiming](../itiming/). |
...
| virtual void [set_Accumulate](./set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | Geeft aan of animatiegedragingen worden opgeteld. Schrijf [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [set_Additive](./set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | Geeft aan of het huidige animatiegedrag wordt gecombineerd met andere lopende animaties. Schrijf [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual void [set_Timing](./set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | Geeft timing-eigenschappen voor het effectgedrag weer. Schrijf [ITiming](../itiming/). |
