...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevendekomma-vergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel NaN volgens IEC 60559:1989 niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevendekomma-vergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel NaN volgens IEC 60559:1989 niet gelijk is aan enige waarde, inclusief NaN. |
...
| virtual [FilterEffectRevealType](../filtereffectrevealtype/) [get_Reveal](./get_reveal/)() | Geeft weer dat effect met gedrag moet worden onthuld (in/uit). Lees [FilterEffectRevealType](../filtereffectrevealtype/). |
| virtual [FilterEffectSubtype](../filtereffectsubtype/) [get_Subtype](./get_subtype/)() | Geeft subtype van filtereffect weer. Lees [FilterEffectSubtype](../filtereffectsubtype/). |
...
| virtual [FilterEffectType](../filtereffecttype/) [get_Type](./get_type/)() | Geeft type van filtereffect weer. Lees [FilterEffectType](../filtereffecttype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiëringsconstructor. Kopieert niets echt, initialiseert alleen een nieuw object en maakt kopieerconstructie van afgeleide klassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets echt, initialiseert alleen een nieuw object en maakt kopieerconstructie van afgeleide klassen mogelijk. |
...
| virtual void [set_Reveal](./set_reveal/)([FilterEffectRevealType](../filtereffectrevealtype/)) | Geeft weer dat effect met gedrag moet worden onthuld (in/uit). Schrijf [FilterEffectRevealType](../filtereffectrevealtype/). |
| virtual void [set_Subtype](./set_subtype/)([FilterEffectSubtype](../filtereffectsubtype/)) | Geeft subtype van filtereffect weer. Schrijf [FilterEffectSubtype](../filtereffectsubtype/). |
...
| virtual void [set_Type](./set_type/)([FilterEffectType](../filtereffecttype/)) | Geeft type van filtereffect weer. Schrijf [FilterEffectType](../filtereffecttype/). |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog van C# [Object.ToString()](../../system/object/tostring/)-methode. Stelt conversie van aangepaste objecten naar string mogelijk. |
