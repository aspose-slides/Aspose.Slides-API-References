...
description: Vertegenwoordigt timingeigenschappen voor het effectgedrag.
type: docs
weight: 196
url: /nl/aspose.slides.animation/ibehaviorpropertycollection/
---
## IBehaviorPropertyCollection klasse

Stelt de timingeigenschappen voor het effectgedrag voor.
...
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | Voegt een nieuwe eigenschap toe aan de collectie. |
...
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Bepaalt of de [ICollection](../../system.collections.generic/icollection/) een specifieke waarde bevat. |
...
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Haalt element op op de opgegeven index. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Stelt element in op de opgegeven index. |
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Bepaalt de index van een specifiek item op basis van de eigenschapswaarde in de [IList](../../system.collections.generic/ilist/). |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | Haalt de index op van de eerste verschijning van het item in de container. |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | Voegt een nieuwe eigenschap (met de opgegeven eigenschapswaarde) toe aan de collectie op de opgegeven index. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | Voegt element in op de opgegeven positie, waarbij andere elementen worden verschoven. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie van het door targetType beschreven type representeert. Analoge van C# 'is'-operator. |
...
| void [Lock](../../system/object/lock/)() | Implementeert het C# lock() statement vergrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) bewakingsobject. |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | Verwijdert de gespecificeerde eigenschap uit de collectie. |
| virtual **bool** [Remove](../../system.collections.generic/icollection/remove/)(const T\&) | Verwijdert element uit de collectie. |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | Verwijdert element op de opgegeven index. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert C# lock() statement ontgrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) surveillancesobject. |
