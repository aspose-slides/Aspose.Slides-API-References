...
| virtual **int32_t** [get_Count](./get_count/)() | Retourneert het aantal punten in de collectie. Alleen-lezen **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPoint](../ipoint/)\> [idx_get](./idx_get/)(**int32_t**) | Retourneert een punt op de opgegeven index. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert niets, initialiseert alleen een nieuw object en maakt het mogelijk copy-constructie van subklassen. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets, initialiseert alleen een nieuw object en maakt het mogelijk copy-constructie van subklassen. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'te sjabloonargument in als een zwakke pointer (in plaats van een gedeelde). Staat het wisselen van pointers in containers naar zwakke modus toe. |
