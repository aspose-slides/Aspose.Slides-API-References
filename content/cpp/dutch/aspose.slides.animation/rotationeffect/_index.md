...
description: Stelt het rotatiegedrag van een effect voor.
type: docs
weight: 534
...
Stelt het rotatiegedrag van een effect voor.
...
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../behavior/get_accumulate/)() override | Geeft weer of animatie-gedragingen worden opgeteld. Lees [NullableBool](../../aspose.slides/nullablebool/). |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | Geeft weer of het huidige animatie-gedrag wordt gecombineerd met andere lopende animaties. Lees [BehaviorAdditiveType](../behavioradditivetype/). |
| **float** [get_By](./get_by/)() override | Beschrijft de relatieve offsetwaarde voor de animatie. Lees **float**. |
| **float** [get_From](./get_from/)() override | Beschrijft de startwaarde voor de animatie. Lees **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | Geeft timing-eigenschappen voor het effectgedrag weer. Lees [ITiming](../itiming/). |
| **float** [get_To](./get_to/)() override | Beschrijft de eindwaarde voor de animatie. Lees **float**. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieer-constructor. Kopieert niets echt, initialiseert alleen een nieuw object en maakt het mogelijk subklassen te kopiëren. |
...
| void [set_Accumulate](../behavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | Geeft weer of animatie-gedragingen worden opgeteld. Schrijf [NullableBool](../../aspose.slides/nullablebool/). |
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Geeft weer of het huidige animatie-gedrag wordt gecombineerd met andere lopende animaties. Schrijf [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_By](./set_by/)(**float**) override | Beschrijft de relatieve offsetwaarde voor de animatie. Schrijf **float**. |
| void [set_From](./set_from/)(**float**) override | Beschrijft de startwaarde voor de animatie. Schrijf **float**. |
...
| void [set_To](./set_to/)(**float**) override | Beschrijft de eindwaarde voor de animatie. Schrijf **float**. |
