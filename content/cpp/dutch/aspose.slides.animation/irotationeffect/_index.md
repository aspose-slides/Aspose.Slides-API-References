...
| virtual **float** [get_By](./get_by/)() | Beschrijft de relatieve offsetwaarde voor de animatie. Lees **float**. |
| virtual **float** [get_From](./get_from/)() | Beschrijft de startwaarde voor de animatie. Lees **float**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](../ibehavior/get_properties/)() | Geeft eigenschappen van het gedrag weer. Alleen-lezen [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../ibehavior/get_timing/)() | Geeft timing-eigenschappen voor het effectgedrag weer. Lees [ITiming](../itiming/). |
| virtual **float** [get_To](./get_to/)() | Beschrijft de eindwaarde voor de animatie. Lees **float**. |
...
| virtual void [set_By](./set_by/)(**float**) | Beschrijft de relatieve offsetwaarde voor de animatie. Schrijf **float**. |
| virtual void [set_From](./set_from/)(**float**) | Beschrijft de startwaarde voor de animatie. Schrijf **float**. |
| virtual void [set_Timing](../ibehavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | Geeft timing-eigenschappen voor het effectgedrag weer. Schrijf [ITiming](../itiming/). |
| virtual void [set_To](./set_to/)(**float**) | Beschrijft de eindwaarde voor de animatie. Schrijf **float**. |
