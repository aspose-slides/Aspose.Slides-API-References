...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Voegt een nieuwe eigenschap toe aan de collectie. |
| void [Add](./add/)(const [System::String](../../system/string/)\&) override | Voegt een nieuwe eigenschap toe aan de collectie. |
| [iterator](./iterator/) [begin](./begin/)() | Geeft een iterator die naar het eerste element (indien aanwezig) van de collectie wijst. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Geeft een iterator die naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie wijst. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Geeft een iterator die naar het eerste const-gekwalificeerde element (indien aanwezig) van de collectie wijst. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Geeft een iterator die direct na het laatste const-gekwalificeerde element (indien aanwezig) van de collectie wijst. |
| void [Clear](./clear/)() override | Verwijdert alle eigenschappen uit de collectie. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | Bepaalt of de [ICollection](../../system.collections.generic/icollection/) een specifieke waarde bevat. |
| **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const override | Bepaalt of de [ICollection](../../system.collections.generic/icollection/) een specifieke waarde bevat. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>, **int32_t**) override | Kopieert de elementen van de [ICollection](../../system.collections.generic/icollection/) naar een [System::Array](../../system/array/), beginnend op een bepaalde [System::Array](../../system/array/) index. |
...
| [iterator](./iterator/) [end](./end/)() | Geeft een iterator die direct na het laatste element (indien aanwezig) van de collectie wijst. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Geeft een iterator die direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie wijst. |
...
| **int32_t** [get_Count](./get_count/)() const override | Retourneert het aantal eigenschappen dat in de collectie is opgeslagen. Alleen-lezen **int32_t**. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Geeft een waarde die aangeeft of de [ICollection](../../system.collections.generic/icollection/) alleen-lezen is. Alleen-lezen **bool**. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../../system.collections.generic/icollection/get_syncroot/)() const | Geeft het object waarmee de collectie wordt gesynchroniseerd. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Geeft de gegevensstructuur van de referentieteller die aan het object is gekoppeld. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de collectie iterereert. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\> [idx_get](./idx_get/)(**int32_t**) const override | Retourneert een eigenschap op de opgegeven index. |
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Geeft het element op de opgegeven index. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>) override | Retourneert een eigenschap op de opgegeven index. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Stelt het element in op de opgegeven index. |
| **int32_t** [IndexOf](./indexof/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | Bepaalt de index van een specifiek item in de [IList](../../system.collections.generic/ilist/). |
| **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const override | Bepaalt de index van een specifiek item op basis van de eigenschapswaarde in de [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Voegt een nieuwe eigenschap toe aan de collectie op de opgegeven index. |
| void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) override | Voegt een nieuwe eigenschap (met de opgegeven eigenschapswaarde) toe aan de collectie op de opgegeven index. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | Voegt een element in op de opgegeven positie, waarbij andere elementen worden verschoven. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleer of het object een instantie van het type beschreven door targetType representeert. Analoge van de C# 'is'-operator. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Roept een transformatiefunctie aan op elk element van een algemene reeks en retourneert de maximale resulterende waarde. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Roept een transformatiefunctie aan op elk element van een algemene reeks en retourneert de minimale resulterende waarde. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Transformeert elk element van een reeks naar een nieuwe vorm door de index van het element te verwerken. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Vergelijkt een waardetype-object met nulpointer per referentie. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | Specialisatie van [Object::ReferenceEquals](../../system/object/referenceequals/) voor geval van string en nulpointer. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | Specialisatie van [Object::ReferenceEquals](../../system/object/referenceequals/) voor geval van strings. |
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Verwijdert de opgegeven eigenschap uit de collectie. |
| **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) override | Verwijdert de opgegeven eigenschap uit de collectie. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Verwijdert de eigenschap op de opgegeven index. |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | Verwijdert het element op de opgegeven index. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Geeft een iterator die naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Geeft een iterator die naar het eerste element (indien aanwezig) van de collectie wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Geeft een iterator die direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Geeft een iterator die direct na het laatste element (indien aanwezig) van de collectie wijst. |
...
* Klasse [IBehaviorPropertyCollection](../ibehaviorpropertycollection/)
