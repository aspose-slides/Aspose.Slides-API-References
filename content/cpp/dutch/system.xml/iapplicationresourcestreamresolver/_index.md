...
description: Stelt een applicatie resource stream resolver voor.
type: docs
weight: 14
url: /nl/system.xml/iapplicationresourcestreamresolver/
---
## IApplicationResourceStreamResolver klasse

Stelt een applicatie resource stream resolver voor.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetApplicationResourceStream](./getapplicationresourcestream/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Retourneert een applicatie-resource-stroom van de opgegeven URI. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie van het type dat wordt beschreven door targetType vertegenwoordigt. Analoge van C#-operator 'is'. |
| void [Lock](../../system/object/lock/)() | Implementeert lock()-statement van C# voor vergrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-wachto-object. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th-templatesargument in als een zwakke pointer (in plaats van gedeeld). Stelt het wisselen van pointers in containers naar zwakke modus mogelijk. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert lock()-statement van C# voor ontgrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-wachto-object. |
