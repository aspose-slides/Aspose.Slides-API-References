...
description: Stelt het XML-declaratieknooppunt <?xml version='1.0'...?> voor.
type: docs
weight: 170
url: /nl/system.xml/xmldeclaration/
---
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | Retourneert het coderingsniveau van het XML-document. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Retourneert de samengevoegde waarden van de [XmlDeclaration](./). |
...
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | Retourneert de waarde van het standalone-attribuut. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Retourneert de waarde van de [XmlDeclaration](./). |
| [String](../../system/string/) [get_Version](./get_version/)() | Retourneert de XML-versie van het document. |
...
| void [Lock](../../system/object/lock/)() | Implementeert vergrendeling van een C# lock() statement. Roep rechtstreeks aan of gebruik het [LockContext](../../system/lockcontext/)-bewakingsobject. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Zet alle [XmlText](../xmltext/)-knooppunten in de volledige diepte van de sub-boom onder deze [XmlNode](../xmlnode/) om in een "normale" vorm waarbij alleen markup (dus tags, commentaren, verwerkingsinstructies, CDATA-secties en entiteitsverwijzingen) [XmlText](../xmltext/)-knooppunten scheidt, zodat er geen aangrenzende [XmlText](../xmltext/)-knooppunten zijn. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Voegt het opgegeven knooppunt toe aan het begin van de lijst met kindknooppunten van dit knooppunt. |
...
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | Stelt het coderingsniveau van het XML-document in. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Stelt de samengevoegde waarden van de [XmlDeclaration](./) in. |
...
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | Stelt de waarde van het standalone-attribuut in. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Stelt de waarde van de [XmlDeclaration](./) in. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Verlaagt de gedeelde referentieteller en retourneert deze. Moet niet direct aangeroepen worden; gebruik in plaats daarvan slimme pointers of ThisProtector. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert ontgrendeling van een C# lock() statement. Roep rechtstreeks aan of gebruik het [LockContext](../../system/lockcontext/)-bewakingsobject. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Slaat de kinderen van het knooppunt op in de opgegeven [XmlWriter](../xmlwriter/). Omdat [XmlDeclaration](./)-knooppunten geen kinderen hebben, heeft deze methode geen effect. |
...
Objecten van deze klasse mogen alleen worden gealloceerd met de [System::MakeObject()](../../system/makeobject/)-functie. Maak nooit instanties van dit type op de stack of met operator new, omdat dit zal leiden tot runtime-fouten en/of assert-fouten. Wrap deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik die pointer om deze als argument aan functies door te geven.
