...
description: Stelt witruimte in elementinhoud voor.
type: docs
weight: 560
url: /nl/system.xml/xmlwhitespace/
---
...
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](../xmlnode/appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Voegt de gespecificeerde knoop toe aan het einde van de lijst met onderliggende knopen van deze knoop. |
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Voegt de gespecificeerde tekenreeks toe aan het einde van de tekensgegevens van de knoop. |
...
| virtual void [DeleteData](../xmlcharacterdata/deletedata/)(**int32_t**, **int32_t**) | Verwijdert een reeks tekens uit de knoop. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [get_ChildNodes](../xmlnode/get_childnodes/)() | Retourneert alle onderliggende knopen van de knoop. |
| virtual [String](../../system/string/) [get_Data](../xmlcharacterdata/get_data/)() | Retourneert de gegevens van de knoop. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Retourneert een waarde die aangeeft of deze knoop onderliggende knopen heeft. |
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | Retourneert de aaneengeschakelde waarden van de knoop en alle onderliggende knopen. |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Retourneert de markup die alleen de onderliggende knopen van deze knoop weergeeft. |
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | Retourneert een waarde die aangeeft of de knoop alleen-lezen is. |
...
| [String](../../system/string/) [get_Name](./get_name/)() override | Retourneert de gekwalificeerde naam van de knoop. |
| virtual [String](../../system/string/) [get_NamespaceURI](../xmlnode/get_namespaceuri/)() | Retourneert de namespace-URI van deze knoop. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Retourneert de knoop die direct volgt op deze knoop. |
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | Retourneert het type van de knoop. |
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Retourneert de markup die deze knoop en al haar onderliggende knopen bevat. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](./get_previoustext/)() override | Retourneert de tekstknoop die direct voorafgaat aan deze knoop. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Retourneert een enumerator die door de onderliggende knopen in de huidige knoop iterereert. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](../xmlnode/insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Voegt de gespecificeerde knoop onmiddellijk na de opgegeven referentieknoop in. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](../xmlnode/insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Voegt de gespecificeerde knoop onmiddellijk vóór de opgegeven referentieknoop in. |
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Voegt de gespecificeerde tekenreeks in op de opgegeven teken-offset. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie van het type die door targetType wordt beschreven vertegenwoordigt. Analoge van de C# ‘is’-operator. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Bereken het gemiddelde van een reeks waarden die worden verkregen door een transformatie-functie aan elk element van de invoerreeks toe te passen. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | Retourneert het aantal elementen in de reeks dat aan de gespecificeerde voorwaarde voldoet. |
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Retourneert het element op een gespecificeerde index in een reeks. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Retourneert het element op een gespecificeerde index in een reeks. |
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)() | Retourneert het eerste element van een reeks. |
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)(const [Func](../../system/func/)\<T, **bool**\>\&) | Retourneert het eerste element van een reeks dat aan de gespecificeerde voorwaarde voldoet. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Voert een transformatie-functie uit op elk element van een generieke reeks en retourneert de maximale resulterende waarde. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Voert een transformatie-functie uit op elk element van een generieke reeks en retourneert de minimale resulterende waarde. |
...
| void [Lock](../../system/object/lock/)() | Implementeert de C# lock()-statement vergrendeling. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-wakerobject. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Zet alle [XmlText](../xmltext/) knopen in de volledige diepte van de subboom onder deze [XmlNode](../xmlnode/) in een “normale” vorm waarbij alleen markup (dat wil zeggen, tags, opmerkingen, verwerkingsinstructies, CDATA-secties en entiteit-referenties) [XmlText](../xmltext/) knopen scheidt, dat wil zeggen, er zijn geen aangrenzende [XmlText](../xmltext/) knopen. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Voegt de gespecificeerde knoop toe aan het begin van de lijst met onderliggende knopen voor deze knoop. |
...
| virtual void [RemoveAll](../xmlnode/removeall/)() | Verwijdert alle onderliggende knopen en/of attributen van de huidige knoop. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](../xmlnode/removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Verwijdert de opgegeven onderliggende knoop. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verlaagt de gedeelde referentieteller met de opgegeven waarde. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](../xmlnode/replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Vervangt de onderliggende knoop **oldChild** door de **newChild**-knoop. |
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Vervangt het opgegeven aantal tekens, beginnend bij de opgegeven offset, door de opgegeven tekenreeks. |
...
| virtual void [set_Data](../xmlcharacterdata/set_data/)([String](../../system/string/)) | Stelt de gegevens van de knoop in. |
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Stelt de aaneengeschakelde waarden van de knoop en alle onderliggende knopen in. |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Stelt de markup in die alleen de onderliggende knopen van deze knoop weergeeft. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een zwakke pointer (in plaats van een gedeelde). Hiermee kun je pointers in containers naar zwakke modus schakelen. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Haal een substring van de volledige string op uit het opgegeven bereik. |
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Test of de DOM-implementatie een specifieke functie ondersteunt. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert de C# lock()-statement ontgrendeling. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-wakerobject. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Slaat alle onderliggende knopen van de knoop op in de opgegeven [XmlWriter](../xmlwriter/). |
...
Objecten van deze klasse mogen alleen worden gealloceerd met de [System::MakeObject()](../../system/makeobject/)-functie. Maak nooit instanties van dit type op de stack of met operator new, omdat dit runtime-fouten en/of assertiefouten oplevert. Wrap deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik deze pointer om deze als argument aan functies door te geven. 
