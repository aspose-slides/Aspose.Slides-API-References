...
description: Stelt een verzameling knooppunten voor die benaderd kan worden op naam of index.
type: docs
weight: 287
url: /nl/system.xml/xmlnamednodemap/
---
## XmlNamedNodeMap class


Stelt een verzameling knooppunten voor die benaderd kan worden op naam of index.
...
| Method | Description |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() const | Gets iterator to the first element of collection. |
...
| [iterator](./iterator/) [cbegin](./cbegin/)() const | Gets iterator to the first element of collection. |
| [iterator](./iterator/) [cend](./cend/)() const | Gets iterator for a non-existent element behind the last element of the collection. |
| [iterator](./iterator/) [end](./end/)() const | Gets iterator for a non-existent element behind the last element of the collection. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Returns the number of nodes in the [XmlNamedNodeMap](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Gets reference counter data structure associated with the object. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](./getenumerator/)() override | Provides support for iteration over the collection of nodes in the [XmlNamedNodeMap](./). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog of C# [Object.GetHashCode()](../../system/object/gethashcode/) method. Enables hashing of custom objects. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/)) | Retrieves an [XmlNode](../xmlnode/) specified by name. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/), [String](../../system/string/)) | Retrieves a node with the matching [XmlNode::get_LocalName](../xmlnode/get_localname/) and [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/) values. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Gets actual type of object. Analog of C# [System.Object.GetType()](../../system/object/gettype/) call. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Check if object represents an instance of type described by targetType. Analog of C# 'is' operator. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Item](./item/)(**int32_t**) | Retrieves the node at the specified index in the [XmlNamedNodeMap](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/)) | Removes the node from the [XmlNamedNodeMap](./). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/), [String](../../system/string/)) | Removes a node with the matching [XmlNode::get_LocalName](../xmlnode/get_localname/) and [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/) values. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SetNamedItem](./setnameditem/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Adds an [XmlNode](../xmlnode/) using its [XmlNode::get_Name](../xmlnode/get_name/) value. |
...
Objecten van deze klasse mogen alleen worden gealloceerd met behulp van de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit instanties van dit type op de stack of met operator new, omdat dit runtime-fouten en/of assertiefouten oplevert. Omhul deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik die pointer om deze als argument aan functies door te geven. 
