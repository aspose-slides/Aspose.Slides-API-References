...
description: Retourneert gedetailleerde informatie over de laatste uitzondering.
type: docs
weight: 1
url: /nl/system.xml/details_xmlexception/
---
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Retourneert een 32-bit geheel getal dat een HRESULT-code is die geassocieerd is met de uitzondering die door het huidige object wordt weergegeven. |
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Retourneert het regelnr. dat aangeeft waar de fout optrad. Reglennummers beginnen bij 1. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Retourneert de regelpositie die aangeeft waar de fout optrad. Regelposities beginnen bij 1. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Retourneert een bericht dat de huidige exceptie beschrijft. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Retourneert de locatie van het XML-bestand. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haalt de gegevensstructuur van de referentieteller die aan het object is gekoppeld. |
...
| void [Lock](../../system/object/lock/)() | Implementeert het lock()-statement van C#. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-wachtoject. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verlakt de gedeelde referentieteller met de opgegeven waarde. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het ontgrendelen van de C# lock()-statement. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/)-wachtoject. |
