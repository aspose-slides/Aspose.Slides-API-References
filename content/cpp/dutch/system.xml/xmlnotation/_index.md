...
description: Stelt een notatie-declaratie voor, zoals <!NOTATION... >.
type: docs
weight: 378
url: /nl/system.xml/xmlnotation/
---
## XmlNotation class


Stelt een notatie-declaratie voor, zoals **<!NOTATION... >**.
...
Objecten van deze klasse mogen alleen worden gealloceerd met behulp van de functie [System::MakeObject()](../../system/makeobject/). Maak nooit instanties van dit type op de stack of met operator new, omdat dit leidt tot runtime-fouten en/of assertiefouten. Wrap deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik die pointer om deze als argument aan functies door te geven. 
