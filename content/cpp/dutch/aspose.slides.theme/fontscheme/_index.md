...
description: Slaat door het thema gedefinieerde lettertypen op.
type: docs
weight: 118
...
Slaat door het thema gedefinieerde lettertypen op.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl zwevend-kommagelijken waarbij twee NaN’s als gelijk worden beschouwd, ook al geldt volgens IEC 60559:1989 dat NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl zwevend-kommagelijken waarbij twee NaN’s als gelijk worden beschouwd, ook al geldt volgens IEC 60559:1989 dat NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() override | Retourneert de fonts-collectie voor een \"koptekst\"-deel van de dia. Alleen-lezen [IFonts](../../aspose.slides/ifonts/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() override | Retourneert de fonts-collectie voor een \"inhoud\"-deel van de dia. Alleen-lezen [IFonts](../../aspose.slides/ifonts/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Retourneert de naam van het fontschema. Lees [System::String](../../system/string/). |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Retourneert de naam van het fontschema. Schrijf [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th-sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Sta toe pointers in containers naar zwakke modus te schakelen. |
