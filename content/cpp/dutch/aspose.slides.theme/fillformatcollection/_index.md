...
| Method | Description |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() | Krijgt iterator die wijst naar het eerste element (indien aanwezig) van de collectie. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Krijgt iterator die wijst naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Krijgt iterator die wijst naar het eerste const-gekwalificeerde element (indien aanwezig) van de collectie. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Krijgt iterator die wijst direct na het laatste const-gekwalificeerde element (indien aanwezig) van de collectie. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\>\>, **int32_t**) override | Kopieert alle elementen van de collectie naar de gespecificeerde array. |
| virtual void [CopyTo](../../aspose.slides/igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Kopieert alle elementen van de collectie naar de gespecificeerde array. |
| [iterator](./iterator/) [end](./end/)() | Krijgt iterator die wijst direct na het laatste element (indien aanwezig) van de collectie. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Krijgt iterator die wijst direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Vergelijkt objecten met C# [Object.Equals](../../system/object/equals/)-semantiek. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const&, T2 const&) | Vergelijkt referentietype-objecten in C#-stijl. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const&, T2 const&) | Vergelijkt waardetype-objecten in C#-stijl. |
| static **bool** [Equals](../../system/object/equals/)(**float** const&, **float** const&) | Imiteert C#-stijl zwevende-kommapuntenvergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const&, **double** const&) | Imiteert C#-stijl zwevende-kommapuntenvergelijking waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase&, void **) const | Alleen voor interne doeleinden. |
| **int32_t** [get_Count](./get_count/)() override | Retourneert het aantal werkelijk in de collectie aanwezige elementen. Alleen-lezen **int32_t**. |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Krijgt referentieteller-structuur geassocieerd met het object. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de collectie iterereert. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Krijgt het werkelijke type van het object. Analog van C# [System.Object.GetType()](../../system/object/gettype/)-aanroep. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [idx_get](./idx_get/)(**int32_t**) override | Krijgt het element op de gespecificeerde index. Alleen-lezen [IFillFormat](../../aspose.slides/ifillformat/). |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const&) | Copyconstructor. Kopieert niets, initialiseert alleen een nieuw object en maakt copy-constructie van subklassen mogelijk. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt n'th template-argument in als een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Krijgt iterator die wijst naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Krijgt iterator die wijst naar het eerste element (indien aanwezig) van de collectie. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Krijgt iterator die wijst direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Krijgt iterator die wijst direct na het laatste element (indien aanwezig) van de collectie. |
...
* Klasse [IFillFormatCollection](../ifillformatcollection/)
