...
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Past een extra kleurenpalet toe op een dia. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | Retourneert het thema-object. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Bepaalt of [OverrideTheme](../overridetheme/) het geërfde effectieve thema overschrijft of niet. Om [OverrideTheme](../overridetheme/) in te schakelen voor overschrijven, gebruik de OverrideTheme.Init*() methoden. Om [OverrideTheme](../overridetheme/) uit te schakelen voor overschrijven, gebruik de [OverrideTheme::Clear](../overridetheme/clear/) methode. Alleen-lezen **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Retourneert het overschrijf-thema-object. Lees [IOverrideTheme](../ioverridetheme/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instance van het door targetType beschreven type representeert. Analoge van C# 'is' operator. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiërende constructor. Kopieert niets werkelijk, initialiseert slechts een nieuw object en maakt het mogelijk om subklassen te kopiëren. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets werkelijk, initialiseert slechts een nieuw object en maakt het mogelijk om subklassen te kopiëren. |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Retourneert het overschrijf-thema-object. Schrijf [IOverrideTheme](../ioverridetheme/). |
...
* Klasse [IOverrideThemeManager](../ioverridethememanager/)
