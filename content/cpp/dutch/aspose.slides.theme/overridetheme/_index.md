...
Stelt een overschrijvend thema voor.
...
| --- | --- |
| void [Clear](./clear/)() override | Stel [ColorScheme](../colorscheme/), [FontScheme](../fontscheme/), [FormatScheme](../formatscheme/) in op null om alle overschrijvingen met dit themobject uit te schakelen. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() override | Retourneert het kleurschema. Alleen-lezen [IColorScheme](../icolorscheme/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](./get_fontscheme/)() override | Retourneert het lettertype-schema. Alleen-lezen [IFontScheme](../ifontscheme/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](./get_formatscheme/)() override | Retourneert het vormopmaakschema. Alleen-lezen [IFormatScheme](../iformatscheme/). |
| **bool** [get_IsEmpty](./get_isempty/)() override | Een ware waarde betekent dat [ColorScheme](../colorscheme/), [FontScheme](../fontscheme/), [FormatScheme](../formatscheme/) null zijn en alle overschrijvingen met dit themobject zijn uitgeschakeld. Alleen-lezen **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\> [get_Presentation](../theme/get_presentation/)() override | Retourneert de bovenliggende presentatie. Alleen-lezen [IPresentation](../../aspose.slides/ipresentation/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haalt de referentieteller-datastructuur op die aan het object is gekoppeld. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](../theme/geteffective/)() override | Haalt effectieve themagegevens op met de toegepaste overerving. |
...
| void [InitColorScheme](./initcolorscheme/)() override | Initialiseer [ColorScheme](../colorscheme/) met een nieuw object voor het overschrijven van [ColorScheme](../colorscheme/) van InheritedTheme. |
| void [InitColorSchemeFrom](./initcolorschemefrom/)([System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\>) override | Initialiseer [ColorScheme](../colorscheme/) met een nieuw object voor het overschrijven van [ColorScheme](../colorscheme/) van InheritedTheme. |
| void [InitColorSchemeFromInherited](./initcolorschemefrominherited/)() override | Initialiseer [ColorScheme](../colorscheme/) met een nieuw object voor het overschrijven van [ColorScheme](../colorscheme/) van InheritedTheme. En initialiseert de gegevens van dit nieuwe object met de gegevens van de [ColorScheme](../colorscheme/) van InheritedTheme. |
| void [InitFontScheme](./initfontscheme/)() override | Initialiseer [FontScheme](../fontscheme/) met een nieuw object voor het overschrijven van [FontScheme](../fontscheme/) van InheritedTheme. |
| void [InitFontSchemeFrom](./initfontschemefrom/)([System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\>) override | Initialiseer [FontScheme](../fontscheme/) met een nieuw object voor het overschrijven van [FontScheme](../fontscheme/) van InheritedTheme. |
| void [InitFontSchemeFromInherited](./initfontschemefrominherited/)() override | Initialiseer [FontScheme](../fontscheme/) met een nieuw object voor het overschrijven van [FontScheme](../fontscheme/) van InheritedTheme. En initialiseert de gegevens van dit nieuwe object met de gegevens van de [FontScheme](../fontscheme/) van InheritedTheme. |
| void [InitFormatScheme](./initformatscheme/)() override | Initialiseer [FormatScheme](../formatscheme/) met een nieuw object voor het overschrijven van [FormatScheme](../formatscheme/) van InheritedTheme. |
| void [InitFormatSchemeFrom](./initformatschemefrom/)([System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\>) override | Initialiseer [FormatScheme](../formatscheme/) met een nieuw object voor het overschrijven van [FormatScheme](../formatscheme/) van InheritedTheme. |
| void [InitFormatSchemeFromInherited](./initformatschemefrominherited/)() override | Initialiseer [FormatScheme](../formatscheme/) met een nieuw object voor het overschrijven van [FormatScheme](../formatscheme/) van InheritedTheme. En initialiseert de gegevens van dit nieuwe object met de gegevens van de [FormatScheme](../formatscheme/) van InheritedTheme. |
