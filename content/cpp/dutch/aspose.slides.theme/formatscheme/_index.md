...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_BackgroundFillStyle](./get_backgroundfillstyle/)(**int32_t**) override | Retourneert de thema-gedefinieerde achtergrondvullingsstijl op de opgegeven index. Alleen-lezen [Aspose::Slides::IFillFormat](../../aspose.slides/ifillformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollection](../ifillformatcollection/)\> [get_BackgroundFillStyles](./get_backgroundfillstyles/)() override | Retourneert een collectie van thema-gedefinieerde achtergrondvullingsstijlen. Alleen-lezen [IFillFormatCollection](../ifillformatcollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\> [get_EffectStyle](./get_effectstyle/)(**int32_t**) override | Retourneert de thema-gedefinieerde effectstijl op de opgegeven index. Alleen-lezen [Aspose::Slides::Theme::IEffectStyle](../ieffectstyle/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyleCollection](../ieffectstylecollection/)\> [get_EffectStyles](./get_effectstyles/)() override | Retourneert een collectie van thema-gedefinieerde effectstijlen. Alleen-lezen [IEffectStyleCollection](../ieffectstylecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillStyle](./get_fillstyle/)(**int32_t**) override | Retourneert de thema-gedefinieerde vullingsstijl op de opgegeven index. Alleen-lezen [Aspose::Slides::IFillFormat](../../aspose.slides/ifillformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollection](../ifillformatcollection/)\> [get_FillStyles](./get_fillstyles/)() override | Retourneert een collectie van thema-gedefinieerde vullingsstijlen. Alleen-lezen [IFillFormatCollection](../ifillformatcollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_LineStyle](./get_linestyle/)(**int32_t**) override | Retourneert de thema-gedefinieerde lijnstijl op de opgegeven index. Alleen-lezen [Aspose::Slides::ILineFormat](../../aspose.slides/ilineformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatCollection](../ilineformatcollection/)\> [get_LineStyles](./get_linestyles/)() override | Retourneert een collectie van thema-gedefinieerde lijnstijlen. Alleen-lezen [ILineFormatCollection](../ilineformatcollection/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'te templatetype in als een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk om pointers in containers naar zwakke modus om te schakelen. |
...
* Klasse [IFormatScheme](../iformatscheme/)
