...
description: Stelt de verzameling van vulstijlen voor.
type: docs
weight: 248
url: /nl/aspose.slides.theme/ifillformatcollection/
---
## IFillFormatCollection klasse

Stelt de verzameling van vulstijlen voor.
...
| virtual void [CopyTo](../../aspose.slides/igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Kopieert alle elementen uit de verzameling naar de gespecificeerde array. |
...
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Retourneert een waarde die aangeeft of de toegang tot de verzameling gesynchroniseerd is (thread-safe). Alleen-lezen **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [idx_get](./idx_get/)(**int32_t**) | Haalt het element op op de opgegeven index. Alleen-lezen [IFillFormat](../../aspose.slides/ifillformat/). |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Retourneert het eerste element van de reeks dat aan een voorwaarde voldoet, of een standaardwaarde als er geen dergelijk element gevonden wordt. |
...
| void [Lock](../../system/object/lock/)() | Implementeert het lock()-statement van C# voor vergrendeling. Direct aanroepen of gebruik het [LockContext](../../system/lockcontext/) bewakingsobject. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert in feite niets, alleen een nieuw object initialiseren en copy-constructie van subklassen mogelijk maken. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert in feite niets, alleen een nieuw object initialiseren en copy-constructie van subklassen mogelijk maken. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het lock()-statement van C# voor ontgrendeling. Direct aanroepen of gebruik het [LockContext](../../system/lockcontext/) bewakingsobject. |
