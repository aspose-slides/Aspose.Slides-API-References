...
| --- | --- |
| int [Add](./add/)(const [System::String](../../system/string/)\&) | Voegt een waarde toe aan het einde van de lijst. |
| void [AddRange](./addrange/)(const [ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>\&) | Voegt elementen toe aan de container. |
| [iterator](./iterator/) [begin](./begin/)() | Retourneert een iterator naar het eerste element van de container. Als de container leeg is, zal de geretourneerde iterator gelijk zijn aan [end()](./end/). |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Retourneert een iterator naar het eerste element van de const-gekwalificeerde container. Als de container leeg is, zal de geretourneerde iterator gelijk zijn aan [end()](./end/). |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Retourneert een iterator naar het eerste const-gekwalificeerde element van de container. Als de container leeg is, zal de geretourneerde iterator gelijk zijn aan [cend()](./cend/). |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Retourneert een iterator naar het element dat volgt op het laatste element van de container. Dit element fungeert als een placeholder; proberen er toegang toe te krijgen leidt tot ongedefinieerd gedrag. |
| void [Clear](./clear/)() | Verwijdert alle elementen. |
| **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Controleert of een specifieke string aanwezig is in de container. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>\&, const **int32_t**) const | Kopieert elementen naar bestaande array-elementen. |
| [const_reverse_iterator](./const_reverse_iterator/) [crbegin](./crbegin/)() const | Retourneert een reverse-iterator naar het eerste element van de omgekeerde container. Het correspondeert met het laatste element van de niet-omgekeerde container. Als de container leeg is, is de geretourneerde iterator gelijk aan [crend()](./crend/). |
| [const_reverse_iterator](./const_reverse_iterator/) [crend](./crend/)() const | Retourneert een reverse-iterator naar het element dat volgt op het laatste element van de omgekeerde container. Het correspondeert met het element dat voorafgaat aan het eerste element van de niet-omgekeerde container. Dit element fungeert als een placeholder; proberen er toegang toe te krijgen leidt tot ongedefinieerd gedrag. |
| std::vector\<[System::String](../../system/string/)\>\& [data](./data/)() | Toegang tot interne datastructuur. |
| const std::vector\<[System::String](../../system/string/)\>\& [data](./data/)() const | Toegang tot interne datastructuur. |
| [iterator](./iterator/) [end](./end/)() | Retourneert een iterator naar het element dat volgt op het laatste element van de container. Dit element fungeert als een placeholder; proberen er toegang toe te krijgen leidt tot ongedefinieerd gedrag. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Retourneert een iterator naar het element dat volgt op het laatste element van de const-gekwalificeerde container. Dit element fungeert als een placeholder; proberen er toegang toe te krijgen leidt tot ongedefinieerd gedrag. |
...
| int [get_Count](./get_count/)() const | Haalt het aantal elementen in de collectie op. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haalt de referentieteller-datastructuur op die bij het object hoort. |
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Haalt enumerator op die door de huidige collectie iterereert. |
...
| [System::String](../../system/string/) [idx_get](./idx_get/)(int) const | Haalt de waarde op op de gespecificeerde positie. |
| void [idx_set](./idx_set/)(int, const [System::String](../../system/string/)\&) | Stelt de waarde in op de gespecificeerde positie. |
| int [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Zoekt naar een specifieke string in de container. |
| void [Insert](./insert/)(int, const [System::String](../../system/string/)\&) | Voegt een specifieke waarde in de container in. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Berekent het gemiddelde van een reeks waarden die verkregen worden door een transformatie-functie op elk element van de invoerreeks aan te roepen. |
...
| **bool** [LINQ_Contains](../../system.collections.generic/ienumerable/linq_contains/)(T) | Bepaalt of een reeks een specifieke waarde bevat. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)(const [Func](../../system/func/)\<T, **bool**\>\&) | Retourneert het aantal elementen in de reeks die voldoen aan de gespecificeerde voorwaarde. |
...
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)(const [Func](../../system/func/)\<T, **bool**\>\&) | Retourneert het eerste element van een reeks dat voldoet aan de gespecificeerde voorwaarde. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Slaat een gespecificeerd aantal aaneengesloten elementen vanaf het begin van een reeks over en geeft de rest terug. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog van C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) methode. Maakt kloon van aangepaste types mogelijk. |
...
| [System::String](../../system/string/)\& [operator[]](./operator[]/)(int) | Accessor-functie. |
...
| void [Remove](./remove/)(const [System::String](../../system/string/)\&) | Verwijdert de eerste voorkoming van de opgegeven string. |
| void [RemoveAt](./removeat/)(int) | Verwijdert element op opgegeven positie. |
...
|  [StringCollection](./stringcollection/)() | Construeert een lege string-collectie. |
...
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Haalt de implementatie op van begin-const-iterator voor de huidige container. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Haalt de implementatie op van begin-iterator voor de huidige container. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Haalt de implementatie op van end-const-iterator voor de huidige container. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Haalt de implementatie op van end-iterator voor de huidige container. |
