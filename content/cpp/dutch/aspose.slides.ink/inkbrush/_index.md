...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Haalt de penseelkleur op voor een lijn. |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | Haalt het inkeffecttype op (bijv. Galaxy, Gold, Silver) dat de visuele stijl van de inktstreek definieert. De waarde wordt geparseerd uit de penseel-eigenschap "inkEffects". Als geen herkend effect is gespecificeerd, wordt [InkEffectType::NotDefined](../inkeffecttype/) geretourneerd. |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Haalt de penseelgrootte op voor een lijn in punten. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Stelt de penseelkleur in voor een lijn. |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | Stelt de penseelgrootte in voor een lijn in punten. |
