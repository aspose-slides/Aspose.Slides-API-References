...
description: "Lijst van capturengroepen in één enkele overeenkomst. Objecten van deze klasse mogen alleen worden gealloceerd met de System::MakeObject() functie. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit zal leiden tot runtime-fouten en/of assertiefouten. Wrap deze klasse altijd in een System::SmartPtr-pointer en gebruik deze pointer om deze als argument aan functies door te geven."
type: docs
weight: 40
url: /nl/system.text.regularexpressions/groupcollection/
---
## GroupCollection klasse


Lijst van capturengroepen in één enkele overeenkomst. Objecten van deze klasse mogen alleen worden gealloceerd met de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit zal leiden tot runtime-fouten en/of assertiefouten. Wrap deze klasse altijd in een [System::SmartPtr](../../system/smartptr/) pointer en gebruik deze pointer om deze als argument aan functies door te geven.
...
| void [Add](./add/)(const [GroupPtr](../groupptr/)\&) override | Schakelt het toevoegen van een element aan de collectie uit. |
| void [Add](../../system.collections.generic/list/add/)(const T\&) override | Voegt een element toe aan het einde van de lijst. |
| void [AddGroup](./addgroup/)(const [GroupPtr](../groupptr/)\&) | Voegt een groep toe aan de collectie. |
...
| void [Clear](./clear/)() override | Schakelt het verwijderen van elementen uit de collectie uit. |
...
| [SharedPtr](../../system/sharedptr/)\<[List](../../system.collections.generic/list/)\<OutputType\>\> [ConvertAll](../../system.collections.generic/list/convertall/)([Converter](../../system/converter/)\<T, OutputType\>) | Creëert een lijst van elementen geconverteerd naar een ander type. |
...
| void [CopyTo](../../system.collections.generic/list/copyto/)(int, const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&, int, int) | Kopieert elementen beginnend bij de opgegeven index naar bestaande array-elementen. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl drijvende-komma-vergelijking waarbij twee NaN’s als gelijk worden beschouwd, ook al stelt IEC 60559:1989 dat NaN niet gelijk is aan een waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl drijvende-komma-vergelijking waarbij twee NaN’s als gelijk worden beschouwd, ook al stelt IEC 60559:1989 dat NaN niet gelijk is aan een waarde, inclusief NaN. |
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | Controleert of er een element bestaat dat aan een specifieke predicaat voldoet in de lijst. |
...
| int [get_Count](../../system.collections.generic/list/get_count/)() const override | Verkrijgt het aantal elementen in de huidige lijst. |
...
| [IEnumeratorPtr](../../system.collections.generic/list/ienumeratorptr/) [GetEnumerator](../../system.collections.generic/list/getenumerator/)() override | Verkrijgt een enumerator om door lijst-elementen te itereren. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Verkrijgt het daadwerkelijke type van het object. Analog van C# [System.Object.GetType()](../../system/object/gettype/)-aanroep. |
...
| void [idx_set](../../system.collections.generic/list/idx_set/)(int, T) override | Stelt een element in op een specifieke positie. |
...
| void [InsertRange](../../system.collections.generic/list/insertrange/)(int, [IEnumerablePtr](../../system.collections.generic/list/ienumerableptr/)) | Voegt een gegevensbereik in op een gespecificeerde positie. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of een object een instantie is van het type beschreven door targetType. Analog van de C# 'is' operator. |
| **bool** [IsReadOnly](./isreadonly/)() const | Markeert de collectie als alleen-lezen. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | Zoekt naar het opgegeven object en retourneert de nul-gebaseerde index van de laatste verschijning in de volledige lijst. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Zoekt naar het opgegeven object en retourneert de nul-gebaseerde index van de laatste verschijning binnen het bereik van elementen in de [List](../../system.collections.generic/list/) dat zich uitstrekt van het eerste element tot de opgegeven index. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Zoekt naar het opgegeven object en retourneert de nul-gebaseerde index van de laatste verschijning binnen het bereik van elementen in de [List](../../system.collections.generic/list/) dat het opgegeven aantal elementen bevat en eindigt op de opgegeven index. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Sorteert de elementen van een reeks in oplopende volgorde overeenkomstig de sleutelwaarden geselecteerd door keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Sorteert de elementen van een reeks in aflopende volgorde overeenkomstig de sleutelwaarden geselecteerd door keySelector. |
...
|  [List](../../system.collections.generic/list/list/)(int) | Maakt een lijst aan met een vooraf bepaalde capaciteit. |
|  [List](../../system.collections.generic/list/list/)([IEnumerablePtr](../../system.collections.generic/list/ienumerableptr/)) | Copy-constructor. |
| void [Lock](../../system/object/lock/)() | Implementeert het C# lock()-statement voor locken. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/) waarschuwingsobject. |
...
| **bool** [Remove](./remove/)(const [GroupPtr](../groupptr/)\&) override | Schakelt het verwijderen van een element uit de collectie uit. |
...
| int [RemoveAll](../../system.collections.generic/list/removeall/)([Predicate](../../system/predicate/)\<T\>) | Verwijdert alle elementen die voldoen aan een specifiek predicaat. |
...
| void [Reverse](../../system.collections.generic/list/reverse/)() | Keert de volgorde van de elementen van de hele lijst om. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n-de template-argument in als een weak-pointer (in plaats van shared). Hiermee kunnen pointers in containers naar weak-modus worden geschakeld. |
...
| void [Sort](../../system.collections.generic/list/sort/)() | Sorteert elementen in de lijst met de standaardcomparator. |
...
| void [TrimExcess](../../system.collections.generic/list/trimexcess/)() | Past de capaciteit van de lijst aan op de grootte. |
| **bool** [TrueForAll](../../system.collections.generic/list/trueforall/)([System::Predicate](../../system/predicate/)\<T\>) | Bepaalt of elk element in de collectie voldoet aan de door het opgegeven predicaat gedefinieerde voorwaarden. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementeert de C# typeof([System.Object](../../system/object/)) constructie. |
| void [Unlock](../../system/object/unlock/)() | Implementeert het C# lock()-statement voor ontgrendelen. Roep direct aan of gebruik het [LockContext](../../system/lockcontext/) waarschuwingsobject. |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../../system.collections.generic/list/virtualizeendconstiterator/)() const override | Verkrijgt de implementatie van de end-const-iterator voor de huidige container. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](../../system.collections.generic/list/virtualizeenditerator/)() override | Verkrijgt de implementatie van de end-iterator voor de huidige container. |
