...
description: "Stelt een rechthoekige kwast voor met een hatch-stijl, een voorgrondkleur en een achtergrondkleur. Objecten van deze klasse mogen alleen worden gealloceerd met de functie System::MakeObject(). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit runtime-fouten en/of assertiefouten zal veroorzaken. Wrap altijd deze klasse in een System::SmartPtr-pointer en gebruik deze pointer om deze aan functies als argument door te geven."
type: docs
weight: 92
url: /nl/system.drawing.drawing2d/hatchbrush/
---
## HatchBrush klasse
...
| Method | Description |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | Maakt een exacte kopie van het huidige object. |
...
| [Color](../../system.drawing/color/) [get_BackgroundColor](./get_backgroundcolor/)() const | Retourneert een waarde die de achtergrondkleur van deze kwast aangeeft. |
| [Color](../../system.drawing/color/) [get_ForegroundColor](./get_foregroundcolor/)() const | Retourneert een waarde die de voorgrondkleur van deze kwast aangeeft. |
| [HatchStyle](../hatchstyle/) [get_HatchStyle](./get_hatchstyle/)() const | Retourneert een waarde die de hatch-stijl van deze kwast aangeeft. |
...
|  [HatchBrush](./hatchbrush/)([HatchStyle](../hatchstyle/), [Color](../../system.drawing/color/), [Color](../../system.drawing/color/)) | Construeert een nieuw exemplaar van de [HatchBrush](./) klasse die een kwast voorstelt met de opgegeven hatch-stijl, voorgrondkleur en achtergrondkleur. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n'te sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Hiermee kan men pointers in containers omschakelen naar zwakke modus. |
