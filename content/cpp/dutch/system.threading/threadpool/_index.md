...
description: Thread pool API die het mogelijk maakt taken in de wachtrij te plaatsen om gelezen te worden door een pool van werker threads. Dit is een statisch type zonder instantie services. Je mag nooit instanties ervan maken op welke manier dan ook.
type: docs
weight: 222
url: /nl/system.threading/threadpool/
---
## ThreadPool klasse


[Thread](../thread/) pool API die het mogelijk maakt taken in de wachtrij te plaatsen om gelezen te worden door een pool van werk-threads. Dit is een statisch type zonder instantie-services. Je mag nooit instanties ervan maken op welke manier dan ook.
...
| static void [GetAvailableThreads](./getavailablethreads/)(int\&, int\&) | Haalt het aantal beschikbare threads op. |
...
| static [ThreadPoolImpl](../threadpoolimpl/)\& [GetInstance](./getinstance/)() | Implementatie-instantie die een lijst met taken en andere parameters bevat. |
| static void [GetMaxThreads](./getmaxthreads/)(int\&, int\&) | Haalt het maximale aantal gelijktijdige threads op. |
| static void [GetMinThreads](./getminthreads/)(int\&, int\&) | Haalt het minimale aantal threads op dat door de pool wordt aangemaakt. |
...
| static void [JoinAllThreads](./joinallthreads/)() | Wacht op alle eigen threads. Wacht oneindig. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiërende constructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt het mogelijk subklassen te kopiëren. |
| void [operator=](./operator_equal/)(const [ThreadPool](./)\&) | Geen kopiëren. |
...
| static **bool** [QueueUserWorkItem](./queueuserworkitem/)([WaitCallback](../waitcallback/)) | Plaatst werkitem in de wachtrij die aanwezig is met callback zonder parameters. |
| static **bool** [QueueUserWorkItem](./queueuserworkitem/)([WaitCallback](../waitcallback/), const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Plaatst werkitem in de wachtrij die aanwezig is met callback zonder parameters. |
...
| static **bool** [SetMaxThreads](./setmaxthreads/)(int, int) | Stelt het aantal threads dat de pool bezit in. |
| static **bool** [SetMinThreads](./setminthreads/)(int, int) | Stelt het minimale aantal threads dat de pool bezit in. |
...
Achtergrond: True, Threadpool: True, Thread-ID: 1
Achtergrond: True, Threadpool: True, Thread-ID: 3
Achtergrond: True, Threadpool: True, Thread-ID: 5
Achtergrond: True, Threadpool: True, Thread-ID: 6
Achtergrond: True, Threadpool: True, Thread-ID: 9
Achtergrond: True, Threadpool: True, Thread-ID: 1
Achtergrond: True, Threadpool: True, Thread-ID: 7
Achtergrond: True, Threadpool: True, Thread-ID: 2
Achtergrond: True, Threadpool: True, Thread-ID: 4
Achtergrond: True, Threadpool: True, Thread-ID: 3
Achtergrond: True, Threadpool: True, Thread-ID: 12
Achtergrond: True, Threadpool: True, Thread-ID: 8
Achtergrond: True, Threadpool: True, Thread-ID: 5
Achtergrond: True, Threadpool: True, Thread-ID: 6
Achtergrond: True, Threadpool: True, Thread-ID: 16
Achtergrond: True, Threadpool: True, Thread-ID: 11
*/
```
