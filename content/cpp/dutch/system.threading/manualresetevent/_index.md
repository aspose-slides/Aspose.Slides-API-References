...
| --- | --- |
| virtual void [Close](../waithandle/close/)() | Geeft alle met het handle geassocieerde bronnen vrij. |
...
| virtual **bool** [Reset](../eventwaithandle/reset/)() | Stelt het evenement in op niet-signalerende toestand. |
| virtual **bool** [Set](../eventwaithandle/set/)() | Stelt het evenement in op signalerende toestand. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Verhoogt gedeelde referentieteller. Zou niet rechtstreeks aangeroepen moeten worden; gebruik in plaats daarvan slimme pointers of ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Verlaagt en retourneert gedeelde referentieteller. Zou niet rechtstreeks aangeroepen moeten worden; gebruik in plaats daarvan slimme pointers of ThisProtector. |
...
| virtual **bool** [WaitOne](../waithandle/waitone/)() | Wacht onbeperkt op het afvuren van de handle. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Verhoogt zwakke referentieteller. Zou niet rechtstreeks aangeroepen moeten worden; gebruik in plaats daarvan slimme pointers of ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Verlaagt zwakke referentieteller. Zou niet rechtstreeks aangeroepen moeten worden; gebruik in plaats daarvan slimme pointers of ThisProtector. |
...
| Veld | Beschrijving |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Speciale waarde die door de functie wordt geretourneerd, anders wordt de index van het gesignaleerde object in de array geretourneerd, als de tijdslimiet wordt overschreden en er niets signaleert. |
## Zie ook
