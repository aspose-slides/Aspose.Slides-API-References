...
description: "Evenement om wachtende thread te informeren die automatisch reset. Objecten van deze klasse mogen alleen worden toegewezen met de System::MakeObject() functie. Creëer nooit een instantie van dit type op de stack of met operator new, omdat dit runtime-fouten en/of assertiefouten veroorzaakt. Wikkel deze klasse altijd in een System::SmartPtr pointer en gebruik deze pointer om deze als argument aan functies door te geven."
type: docs
weight: 1
url: /nl/system.threading/autoresetevent/
---
## AutoResetEvent klasse

Evenement om wachtende thread te informeren dat automatisch reset. Objecten van deze klasse mogen alleen worden toegewezen met de functie [System::MakeObject()](../../system/makeobject/). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit runtime-fouten en/of assertiefouten veroorzaakt. Wikkel deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik deze pointer om deze als argument aan functies door te geven.
...
| virtual void [Close](../waithandle/close/)() | Geeft alle bronnen vrij die aan de handle zijn gekoppeld. |
...
| virtual **bool** [Reset](../eventwaithandle/reset/)() | Zet het event in een niet-signalerende toestand. |
| virtual **bool** [Set](../eventwaithandle/set/)() | Zet het event in een signalerende toestand. |
...
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Wacht totdat alle handles afgevuurd hebben. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Wacht totdat alle handles afgevuurd hebben. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Wacht totdat alle handles afgevuurd hebben. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Wacht totdat een van de handles afgevuurd heeft. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Wacht totdat een van de handles afgevuurd heeft. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Wacht totdat een van de handles afgevuurd heeft. |
| virtual **bool** [WaitOne](../waithandle/waitone/)() | Wacht onbeperkt tot de handle afgevuurd wordt. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int) | Wacht tot de handle afgevuurd wordt. |
...
| Veld | Beschrijving |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Speciale waarde die door de functie wordt geretourneerd, anders index van het gesignaleerde object in de array, als time-out overschrijdt en niets signaleert. |
## Opmerkingen
