...
description: 2D-vector met double componenten
type: docs
weight: 66
url: /nl/aspose.slides.drawing/vector2d64d/
---
## Vector2d64d klasse

2D-vector met **double** componenten
...
| --- | --- |
| **double** [Dot](./dot/)([Vector2d64d](./)) | Berekent het scalair product van twee vectoren. |
...
| **double** [get_Length](./get_length/)() | Haalt de scalair lengte van de vector op. Alleen-lezen **double**. |
| [Vector2d64d](./) [get_Norm](./get_norm/)() | Haalt de normale vector op. Alleen-lezen [Vector2d64d](./). |
...
| [Vector2d64d](./) [Normalize](./normalize/)() | Creëert een collineaire vector met lengte = 1. Deze vector mag geen lengte nul hebben. |
| [Object](../../system/object/object/)() | Creëert een object. Initialiseert alle interne datastructuren. |
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiënconstructor. Kopieert eigenlijk niets, initialiseert alleen een nieuw object en maakt kopiëren van subklassen mogelijk. |
...
| void [SwapXY](./swapxy/)() | Wissel X en Y |
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Analog van C# [Object.ToString()](../../system/object/tostring/)-methode. Maakt het converteren van aangepaste objecten naar string mogelijk. |
| [Vector2d32f](../vector2d32f/) [ToVector2d32f](./tovector2d32f/)() | Naar [Vector2d32f](../vector2d32f/) |
