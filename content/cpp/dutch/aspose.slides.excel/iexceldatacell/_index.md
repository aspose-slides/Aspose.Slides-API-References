...
| virtual **int32_t** [get_Column](./get_column/)() | Haalt de nulgebaseerde index van de kolom op in het werkblad waar de cel zich bevindt. Alleen-lezen **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Haalt de naam op van de grafiek-datacel. Alleen-lezen [System::String](../../system/string/). |
| virtual **int32_t** [get_Row](./get_row/)() | Haalt de nulgebaseerde index van de rij op in het werkblad waar de cel zich bevindt. Alleen-lezen **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() | Haalt de waarde op die in de [Excel](../)-cel zit. Alleen-lezen [System::Object](../../system/object/). |
...
| void [Lock](../../system/object/lock/)() | Implementeert C# lock()-statement vergrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-bewakersobject. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert niets, echt niet, alleen een nieuw object initialiseren en kopieer-constructie van subklassen mogelijk maken. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets, echt niet, alleen een nieuw object initialiseren en kopieer-constructie van subklassen mogelijk maken. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert C# lock()-statement ontgrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-bewakersobject. |
...
| virtual  [~Object](../../system/object/~object/)() | Vernietigt het object. Vrijeft alle interne datastructuren. |
