...
description: Zoekt de index van het eerste element dat buiten het opgegeven bereik ligt in een ReadOnlySpan<T>
type: docs
weight: 183
url: /nl/system.memoryextensions/indexofanyexceptinrange/
---
## System::MemoryExtensions::IndexOfAnyExceptInRange(const ReadOnlySpan\<T\>\&, const T\&, const T\&) functie

Vindt de index van het eerste element dat buiten het opgegeven bereik ligt in een ReadOnlySpan<T>
...
De nulgebaseerde index van het eerste element buiten het bereik, of -1 indien niet gevonden

## System::MemoryExtensions::IndexOfAnyExceptInRange(const Span\<T\>\&, const T\&, const T\&) functie

Vindt de index van het eerste element dat buiten het opgegeven bereik ligt in een Span<T>
