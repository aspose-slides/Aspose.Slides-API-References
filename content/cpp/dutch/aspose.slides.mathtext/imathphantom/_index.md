...
description: "Stelt een phantom wiskundig object (<m:phant>) voor dat de lay-out van het onderliggende element beïnvloedt zonder het noodzakelijkerwijs weer te geven. Een phantom kan de basisuitdrukking verbergen terwijl de breedte, hoogte of diepte behouden blijft om formules uit te lijnen of ruimte te reserveren. Zichtbaarheid en geometrisch gedrag worden geregeld door eigenschappen zoals Show, ZeroWid, ZeroAsc, ZeroDesc en Transp."
type: docs
weight: 482
...
Stelt een phantom wiskundig object (<m:phant>) voor dat de lay-out van zijn onderliggende element beïnvloedt zonder het noodzakelijkerwijs weer te geven. Een phantom kan zijn basisuitdrukking verbergen terwijl de breedte, hoogte of diepte behouden blijft om formules uit te lijnen of ruimte te reserveren. Zichtbaarheid en geometrisch gedrag worden geregeld door eigenschappen zoals Show, ZeroWid, ZeroAsc, ZeroDesc, en Transp.
...
| virtual **bool** [get_Show](./get_show/)() | Gets a value indicating whether the base element is displayed. |
| virtual **bool** [get_Transp](./get_transp/)() | Gets a value indicating whether the phantom is transparent for class-based spacing rules. |
| virtual **bool** [get_ZeroAsc](./get_zeroasc/)() | Gets a value indicating whether the ascent (height above baseline) of the base element should be treated as zero. |
| virtual **bool** [get_ZeroDesc](./get_zerodesc/)() | Gets a value indicating whether the descent (depth below baseline) of the base element should be treated as zero. |
| virtual **bool** [get_ZeroWidth](./get_zerowidth/)() | Gets a value indicating whether the width of the base element should be treated as zero. |
...
| virtual void [set_Show](./set_show/)(**bool**) | Sets a value indicating whether the base element is displayed. |
| virtual void [set_Transp](./set_transp/)(**bool**) | Sets a value indicating whether the phantom is transparent for class-based spacing rules. |
| virtual void [set_ZeroAsc](./set_zeroasc/)(**bool**) | Sets a value indicating whether the ascent (height above baseline) of the base element should be treated as zero. |
| virtual void [set_ZeroDesc](./set_zerodesc/)(**bool**) | Sets a value indicating whether the descent (depth below baseline) of the base element should be treated as zero. |
| virtual void [set_ZeroWidth](./set_zerowidth/)(**bool**) | Sets a value indicating whether the width of the base element should be treated as zero. |
...
phantom->set_ZeroWidth(false); // Behoud de breedte
```
