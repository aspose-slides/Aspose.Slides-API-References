...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) override | Maakt een breuk van het gespecificeerde type met deze teller en de opgegeven noemer |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) override | Maakt een breuk van het gespecificeerde type met deze teller en de opgegeven noemer |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Omvat een wiskundig element in opgegeven tekens, zoals haakjes of andere tekens als omlijsting |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) override | Retourneert het item op de opgegeven index van de array. Alleen-lezen [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() override | De set van items van de array |
| [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() override | Specificeert de uitlijning van de array ten opzichte van de omringende tekst. Tekst buiten de array kan worden uitgelijnd met de onderkant, bovenkant of het midden van een array-object. Standaardwaarde: Center |
| **bool** [get_MaximumDistribution](./get_maximumdistribution/)() override | Maximum distributie: wanneer true, wordt de array gespreid tot de maximale breedte van het omvattende element (pagina, kolom, cel, enz.). |
| **bool** [get_ObjectDistribution](./get_objectdistribution/)() override | Objectdistributie: wanneer true, wordt de inhoud van de array gespreid tot de maximale breedte van het array-object. |
| **uint32_t** [get_RowSpacing](./get_rowspacing/)() override | Afstand tussen rijen van een array. Wordt alleen gebruikt wanneer RowSpacingRule is ingesteld op 3; dan is de meeteenheid punten, of bij Multiple de meeteenheid halve regels. Standaard: 0 |
| [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() override | Het type verticale ruimte tussen array-elementen. Standaard: SingleLineGap |
...
|  [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Creëert een wiskundige array en plaatst het opgegeven element erin |
|  [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>\>\>) | Creëert een wiskundige array en plaatst opgegeven elementen erin |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert niets, initialiseert alleen een nieuw object en maakt kopie-constructie van subklassen mogelijk. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../mathelementbase/overbar/)() override | Plaatst een balk bovenop dit element |
...
| void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) override | Specificeert de uitlijning van de array ten opzichte van de omringende tekst. Tekst buiten de array kan worden uitgelijnd met de onderkant, bovenkant of het midden van een array-object. Standaardwaarde: Center |
| void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) override | Maximum distributie: wanneer true, wordt de array gespreid tot de maximale breedte van het omvattende element (pagina, kolom, cel, enz.). |
| void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) override | Objectdistributie: wanneer true, wordt de inhoud van de array gespreid tot de maximale breedte van het array-object. |
| void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) override | Afstand tussen rijen van een array. Wordt alleen gebruikt wanneer RowSpacingRule is ingesteld op 3; dan is de meeteenheid punten, of bij Multiple de meeteenheid halve regels. Standaard: 0 |
| void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) override | Het type verticale ruimte tussen array-elementen. Standaard: SingleLineGap |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathSubscriptElement](../imathsubscriptelement/)\> [SetSubscript](../mathelementbase/setsubscript/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Creëert een subscript |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathSubscriptElement](../imathsubscriptelement/)\> [SetSubscript](../mathelementbase/setsubscript/)([System::String](../../system/string/)) override | Creëert een subscript |
