...
description: Staat toe een wiskundig vak te maken
type: docs
weight: 183
...
Staat toe een wiskundig vak te maken
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [CreateMathBox](./createmathbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Maak een wiskundig vak door het toe te passen op het element |
...
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haal referentieteller-gegevensstructuur op die aan het object is gekoppeld. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Sta toe pointers in containers om te schakelen naar zwakke modus. |
