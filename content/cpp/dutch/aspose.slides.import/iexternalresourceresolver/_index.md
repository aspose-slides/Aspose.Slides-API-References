...
description: Callback interface die wordt gebruikt om externe bronnen op te lossen tijdens de import van Html en Svg documenten.
type: docs
weight: 40
url: /nl/aspose.slides.import/iexternalresourceresolver/
---
## IExternalResourceResolver klasse

Callback-interface die wordt gebruikt om externe bronnen op te lossen tijdens de import van Html- en Svg-documenten.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) | Koppelt een URI aan een object dat de daadwerkelijke bron bevat. |
...
| virtual [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | Lost de absolute URI op uit de basis- en relatieve URI's. |
