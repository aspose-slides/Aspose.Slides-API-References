...
type: docs
weight: 1
url: /nl/system.web/details_httpexception/
---
## Details_HttpException klasse
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-achtige drijvende-kommagelijken waarbij twee NaN-waarden als gelijk worden beschouwd, zelfs hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-achtige drijvende-kommagelijken waarbij twee NaN-waarden als gelijk worden beschouwd, zelfs hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Retourneert een 32-bit geheel getal dat een HRESULT-code is gekoppeld aan de exceptie die wordt vertegenwoordigd door het huidige object. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](./gettype/)() const override | Haalt het daadwerkelijke type van het object op. Analoge van C# [System.Object.GetType()](../../system/object/gettype/) aanroep. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiërende constructor. Kopieert niets, eigenlijk, initialiseert alleen een nieuw object en maakt kopie-construeren van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets, eigenlijk, initialiseert alleen een nieuw object en maakt kopie-construeren van subklassen mogelijk. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Implementeert [what()](../../system/details_exception/what/) methode die wordt aangeroepen door [ExceptionWrapper](../../system/exceptionwrapper/) klasse. Ondanks het feit dat deze klasse niet erfde van std::exception kunnen afgeleide klassen protected/private leden gebruiken om hun logica te implementeren. Het verplaatsen van deze methodimplementatie naar de [ExceptionWrapper](../../system/exceptionwrapper/) kan die logica breken. |
