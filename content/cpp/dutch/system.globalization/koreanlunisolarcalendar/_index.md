...
description: "Koreaanse lunisolaire kalender. Niet geïmplementeerd. Objecten van deze klasse mogen alleen worden toegewezen met de functie System::MakeObject(). Nooit een instantie van dit type op de stack of met operator new maken, omdat dit zal leiden tot runtime-fouten en/of assertiefouten. Zet deze klasse altijd in een System::SmartPtr-pointer en gebruik die pointer om deze als argument aan functies door te geven."
type: docs
weight: 235
url: /nl/system.globalization/koreanlunisolarcalendar/
---
## KoreanLunisolarCalendar klasse


Koreaanse lunisolaire kalender. Niet geïmplementeerd. Objecten van deze klasse mogen alleen worden toegewezen met de functie [System::MakeObject()](../../system/makeobject/). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit zal leiden tot runtime-fouten en/of assertiefouten. Zet deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik die pointer om deze als argument aan functies door te geven.
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | Maakt een kopie van het huidige object en retourneert een gedeelde pointer ernaar. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Vergelijkt objecten met C# [Object.Equals](../../system/object/equals/)-semantiek. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt referentietype-objecten in C#-stijl. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt waardetype-objecten in C#-stijl. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert een C#-achtige zwevend-komma vergelijking waarbij twee NaN's als gelijk worden beschouwd, ook al is volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert een C#-achtige zwevend-komma vergelijking waarbij twee NaN's als gelijk worden beschouwd, ook al is volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
...
| int [get_CurrentEra](../calendar/get_currentera/)() const | Haalt de index van het huidige tijdperk op. |
| int [get_CurrentEraValue](../calendar/get_currenteravalue/)() const | Haalt de waarde van het huidige tijdperk op. |
| [ArrayPtr](../../system/arrayptr/)\<int\> [get_Eras](./get_eras/)() const override | Haalt de lijst met tijdperken op die in de kalender bestaan. |
...
| virtual int [GetDaysInMonth](../calendar/getdaysinmonth/)(int, int) const | Haalt het aantal dagen in een specifieke maand op. |
| virtual int [GetDaysInMonth](../calendar/getdaysinmonth/)(int, int, int) const | Haalt het aantal dagen in een specifieke maand op. |
| virtual int [GetDaysInYear](../calendar/getdaysinyear/)(int) const | Haalt het aantal dagen in een specifiek jaar op. |
| virtual int [GetDaysInYear](../calendar/getdaysinyear/)(int, int) const | Haalt het aantal dagen in een specifiek jaar op. |
| virtual int [GetEra](../calendar/getera/)([DateTime](../../system/datetime/)) const | Haalt het tijdperk op voor het opgegeven tijdstip. |
...
| virtual int [GetSexagenaryYear](../eastasianlunisolarcalendar/getsexagenaryyear/)([DateTime](../../system/datetime/)) const | Haalt het jaar op in de sextaginaire cyclus. |
| int [GetTerrestrialBranch](../eastasianlunisolarcalendar/getterrestrialbranch/)(int) const | Haalt de aardse tak op. |
...
| virtual int [GetYear](../calendar/getyear/)([DateTime](../../system/datetime/)) const | Haalt het jaar op voor het opgegeven tijdstip. |
...
| virtual **bool** [IsLeapMonth](../calendar/isleapmonth/)(int, int) const | Controleert of de maand een schrikkeldag (maand) is. |
| virtual **bool** [IsLeapMonth](../calendar/isleapmonth/)(int, int, int) const | Controleert of de maand een schrikkeldag (maand) is. |
...
| **bool** [IsValidDay](../calendar/isvalidday/)(int, int, int, int) const | Controleert jaar-, maand-, dag- en tijdperkwaarden. |
...
| static [CalendarPtr](../calendarptr/) [ReadOnly](../calendar/readonly/)(const [CalendarPtr](../calendarptr/)\&) | Haalt de alleen-lezen versie van de kalender op. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeelde). Maakt het wisselen van pointers in containers naar zwakke modus mogelijk. |
