...
description: "Collectie van waarden van Dictionary. Verwijst naar de collectie, kopieert niets. Objecten van deze klasse mogen alleen worden gealloceerd met de functie System::MakeObject(). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit runtime-fouten en/of assert-fouten oplevert. Verpak deze klasse altijd in een System::SmartPtr-pointer en gebruik deze pointer om deze door te geven aan functies als argument."
type: docs
weight: 27
url: /nl/system.collections.generic/_valuecollection/
---
## _ValueCollection klasse


Collectie van waarden van [Dictionary](../dictionary/). Referentieverzameling, kopieert niets. Objecten van deze klasse mogen alleen worden toegewezen met de functie [System::MakeObject()](../../system/makeobject/). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit leidt tot runtime-fouten en/of assert-fouten. Verpak deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik die pointer om deze door te geven aan functies als argument.
...
| --- | --- |
|  [_ValueCollection](./_valuecollection/)(const typename Dict::Ptr\&) | Initialiseert een collectie die naar het opgegeven woordenboek verwijst. |
| void [Add](../ikvcollection/add/)(const T\&) override | Voegt een item toe aan de container. |
|  [BaseKVCollection](../basekvcollection/basekvcollection/)(const typename Dict::Ptr\&) | Maakt een collectie. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Geeft een iterator die naar het eerste element (indien aanwezig) van de collectie wijst. Deze iterator kan niet worden gebruikt om een verwezen object te wijzigen omdat [GetEnumerator()](../ienumerable/getenumerator/) een kopie-object van T retourneert. |
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Geeft een iterator die naar het eerste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie wijst. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Geeft een iterator die naar het eerste const-gekwalificeerde element (indien aanwezig) van de collectie wijst. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Geeft een iterator die direct na het laatste const-gekwalificeerde element (indien aanwezig) van de collectie wijst. |
| void [Clear](../ikvcollection/clear/)() override | Verwijdert alle elementen uit de container. |
| **bool** [Contains](./contains/)(const [TValue](./tvalue/)\&) const override | Controleert of een item aanwezig is in de container. |
...
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Geeft een iterator die direct na het laatste element (indien aanwezig) van de collectie wijst. Deze iterator kan niet worden gebruikt om een verwezen object te wijzigen omdat [GetEnumerator()](../ienumerable/getenumerator/) een kopie-object van T retourneert. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Geeft een iterator die direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie wijst. |
...
| int [get_Count](../basekvcollection/get_count/)() const override | Geeft het aantal elementen. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../icollection/get_syncroot/)() const | Geeft het object waarmee de collectie wordt gesynchroniseerd. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Geeft de gegevensstructuur van de referentieteller die bij het object hoort. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TValue](./tvalue/)\>\> [GetEnumerator](./getenumerator/)() override | Geeft een enumerator die door de waarden iterereert. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analoge van C# [Object.GetHashCode()](../../system/object/gethashcode/)-methode. Maakt hashen van aangepaste objecten mogelijk. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Geeft het werkelijke type van het object. Analoge van C# [System.Object.GetType()](../../system/object/gettype/)-aanroep. |
...
| [TValue](./tvalue/) [idx_get](./idx_get/)(int) const override | Implementeert [IList](../ilist/)-methode. Niet ondersteund. |
| void [idx_set](../ikvcollection/idx_set/)(int, T) override | Setter-functie. |
| int [IndexOf](../ikvcollection/indexof/)(const T\&) const override | Geeft de index van een item in de container. |
...
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Bereken het gemiddelde van een reeks waarden die worden verkregen door een transformatiefunctie aan te roepen op elk element van de invoerreeks. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Sorteert de elementen van een reeks in oplopende volgorde op basis van de sleutelwaarden die door keySelector worden geselecteerd. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Sorteert de elementen van een reeks in aflopende volgorde op basis van de sleutelwaarden die door keySelector worden geselecteerd. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | Slaat een opgegeven aantal opeenvolgende elementen aan het begin van een reeks over en retourneert de rest. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<T\> [LINQ_ToArray](../ienumerable/linq_toarray/)() | Creëert een array uit een reeks. |
| [SharedPtr](../../system/sharedptr/)\<[List](../list/)\<T\>\> [LINQ_ToList](../ienumerable/linq_tolist/)() | Creëert een List<T> uit een reeks. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert eigenlijk niets, alleen een nieuw object initialiseren en kopieerconstructie van subclasses mogelijk maken. |
| [ICollection](../icollection/)\& [operator=](../icollection/operator_equal/)([ICollection](../icollection/)\&&) | Verplaats-assignatie-operator. |
| [ICollection](../icollection/)\& [operator=](../icollection/operator_equal/)(const [ICollection](../icollection/)\&) | Verplaats-assignatie-operator. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Assignatie-operator. Kopieert eigenlijk niets, alleen een nieuw object initialiseren en kopieerconstructie van subclasses mogelijk maken. |
...
| void [SetTemplateWeakPtr](../basekvcollection/settemplateweakptr/)(**uint32_t**) override | Staat compilatie toe, maar doet niets omdat deze structuur geen data bezit. |
...
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Geeft de implementatie van de begin-const-iterator voor de huidige container. |
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Geeft de implementatie van de begin-iterator voor de huidige container. |
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Geeft de implementatie van de eind-const-iterator voor de huidige container. |
| System::Details::VirtualizedIteratorBase\<[TValue](./tvalue/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Geeft de implementatie van de eind-iterator voor de huidige container. |
...
| --- | --- |
| [TValue](./tvalue/) | Waardetype. |

## Zie ook

* Klasse [BaseKVCollection](../basekvcollection/)
