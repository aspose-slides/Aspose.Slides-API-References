...
| --- | --- |
| virtual int [Compare](./compare/)([args_type](./args_type/), [args_type](./args_type/)) const | [Comparison](../../system/comparison/) functie. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th template-argument in op een zwakke pointer (in plaats van gedeeld). Stelt u in staat pointers in containers naar zwakke modus te schakelen. |
...
| --- | --- |
| [args_type](./args_type/) | [Comparison](../../system/comparison/) argumenttype. |
