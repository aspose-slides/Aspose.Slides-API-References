...
description: "Interface van container die sleutels of waarden van de dictionary-achtige container bevat. Objecten van deze klasse mogen alleen worden gealloceerd met de functie System::MakeObject(). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit runtime-fouten en/of assertiefouten oplevert. Wikkel deze klasse altijd in een System::SmartPtr-pointer en gebruik die pointer om deze als argument aan functies door te geven."
type: docs
weight: 326
url: /nl/system.collections.generic/ikvcollection/
---
...
| --- | --- |
| void [Add](./add/)(const T\&) override | Voegt een item toe aan de container. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Haalt een iterator op die naar het eerste element (indien aanwezig) van de collectie wijst. Deze iterator kan niet worden gebruikt om een gerefereerd object te wijzigen omdat [GetEnumerator()](../ienumerable/getenumerator/) een kopie-object van T retourneert. |
...
| void [Clear](./clear/)() override | Verwijdert alle elementen uit de container. |
| **bool** [Contains](./contains/)(const T\&) const override | Controleert of het item aanwezig is in de container. |
| virtual void [CopyTo](../icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Kopieert alle collectierelementen naar bestaande array-elementen. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert een C#-achtige vergelijking van floating-point waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert een C#-achtige vergelijking van floating-point waarbij twee NaN’s als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| virtual int [get_Count](./get_count/)() const | Haalt het aantal elementen in de container op. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Controleert of de collectie een vaste grootte heeft. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Controleert of de container alleen-lezen is. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../icollection/get_syncroot/)() const | Haalt het object op waardoor de collectie gesynchroniseerd wordt. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Haalt de referentieteller-datastructuur op die bij het object hoort. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() | Haalt een enumerator voor de container op. |
...
| virtual T [idx_get](./idx_get/)(int) const | Getter-functie. |
| void [idx_set](./idx_set/)(int, T) override | Setter-functie. |
| int [IndexOf](./indexof/)(const T\&) const override | Haalt de index van een item in de container op. |
| void [Insert](./insert/)(int, const T\&) override | Voegt een item in op de opgegeven positie. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Cast](../ienumerable/linq_cast/)() | Casteert de elementen naar het opgegeven type. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analoge van de C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-methode. Stelt het klonen van aangepaste types in staat. |
...
| **bool** [Remove](./remove/)(const T\&) override | Verwijdert een item uit de container. |
| void [RemoveAt](./removeat/)(int) override | Verwijdert een item op de opgegeven positie. |
