...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Geeft een menselijk leesbare beschrijving van deze waarschuwing terug. Alleen-lezen [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](./get_warningtype/)() | Geeft een type waarschuwing terug. Alleen-lezen [IWarningInfo::get_WarningType](./get_warningtype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructor. Kopieert niets, maar initialiseert een nieuw object en maakt het mogelijk subklassen via kopiëren te construeren. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets, maar initialiseert een nieuw object en maakt het mogelijk subklassen via kopiëren te construeren. |
...
| virtual void [SendWarning](./sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Als ontvanger niet null is eindigt de waarschuwing naar een opgegeven ontvanger en gooit de AbortRequestedException als de ontvanger besluit een bewerking af te breken. |
