...
description: Stelt een waarschuwing weer over een bekend probleem dat niet in de nabije toekomst zal worden opgelost.
type: docs
weight: 1
...
Stelt een waarschuwing weer over een bekend probleem dat in de nabije toekomst niet zal worden opgelost.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl drijvende-kommagelijk vergelijk waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl drijvende-kommagelijk vergelijk waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Als ontvanger niet null is, beëindigt de waarschuwing bij een gespecificeerde ontvanger en gooit de AbortRequestedException als de ontvanger besluit een bewerking af te breken. |
