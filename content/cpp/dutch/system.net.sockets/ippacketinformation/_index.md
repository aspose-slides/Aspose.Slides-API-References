...
description: "Bevat informatie over het pakket. Objecten van deze klasse mogen alleen worden gealloceerd met de functie System::MakeObject() function. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit runtime errors en/of assertiefouten veroorzaakt. Wrap deze klasse altijd in een System::SmartPtr pointer en gebruik deze pointer om deze door te geven aan functies als argument."
type: docs
weight: 14
url: /nl/system.net.sockets/ippacketinformation/
---
## IPPacketInformation klasse


Stelt informatie over het pakket voor. Objecten van deze klasse mogen alleen worden toegewezen met behulp van de functie [System::MakeObject()](../../system/makeobject/). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit runtime-fouten en/of assertiefouten zal veroorzaken. Wrap deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik deze pointer om deze door te geven aan functies als argument.
...
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Vergelijkt twee objecten met behulp van C# [Object.Equals](../../system/object/equals/)-semantiek. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../../system.net/ipaddress/)\> [get_Address](./get_address/)() | Retourneert het adres vanwaar het pakket wordt ontvangen. |
| **int32_t** [get_Interface](./get_interface/)() | Retourneert informatie over de netwerkinterface. |
...
|  [IPPacketInformation](./ippacketinformation/)([System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../../system.net/ipaddress/)\>, **int32_t**) | Maakt een nieuwe instantie aan. |
|  [IPPacketInformation](./ippacketinformation/)() | Maakt een nieuwe instantie aan. |
