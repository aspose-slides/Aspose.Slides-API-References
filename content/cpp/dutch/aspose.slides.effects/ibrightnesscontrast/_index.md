...
Vertegenwoordigt een [BrightnessContrast](../brightnesscontrast/) effect. Past helderheid en contrast aan
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in als een weak-pointer (in plaats van shared). Maakt het wisselen van pointers in containers naar weak-modus mogelijk. |
