...
description: Onveranderlijk object dat een Alpha Modulate-effect vertegenwoordigt. Effect-alpha (opacity) waarden worden vermenigvuldigd met een vast percentage. De effectcontainer specificeert een effect dat alfa-waarden moduleert.
type: docs
weight: 352
url: /nl/aspose.slides.effects/ialphamodulateeffectivedata/
---
## IAlphaModulateEffectiveData klasse

Onveranderlijk object dat een Alpha Modulate-effect vertegenwoordigt. Effect-alpha (opacity) waarden worden vermenigvuldigd met een vast percentage. De effectcontainer specificeert een effect dat alfa-waarden moduleert.
