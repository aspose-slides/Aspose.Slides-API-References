...
description: Stelt een Luminance-effect voor. Helderheid verschuift lineair alle kleuren dichter naar wit of zwart. Contrast schaalt alle kleuren zodat ze dichter bij elkaar of verder uit elkaar liggen.
type: docs
weight: 1028
...
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bepaalt of de opgegeven [Luminance](./) gelijk is aan de huidige [Luminance](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminanceEffectiveData](../iluminanceeffectivedata/)\> [GetEffective](./geteffective/)() override | Haalt effectieve [Luminance](./)-effectgegevens op met de toegepaste overerving. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'te sjabloonargument in als een zwakke pointer (in plaats van gedeelde). Staat toe dat pointers in containers worden omgeschakeld naar zwakke modus. |
