...
description: Stelt een Alpha Bi-Level effect voor. Alpha (Opacity)-waarden kleiner dan de drempel worden veranderd naar 0 (volledig transparant) en alpha-waarden groter dan of gelijk aan de drempel worden veranderd naar 100% (volledig ondoorzichtig).
type: docs
weight: 235
...
Stelt een Alpha Bi-Level effect voor. Alpha (Opacity)-waarden kleiner dan de drempel worden veranderd naar 0 (volledig transparant) en alpha-waarden groter dan of gelijk aan de drempel worden veranderd naar 100% (volledig ondoorzichtig).
...
| virtual **float** [get_Threshold](./get_threshold/)() | Retourneert de drempelwaarde van het effect. Lezen **float**. |
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Haalt de effectieve gegevens op met de erfelijkheid toegepast. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copyconstructor. Kopieert niets echt, initialiseert slechts een nieuw object en maakt het mogelijk subklassen te kopiëren bij constructie. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets echt, initialiseert slechts een nieuw object en maakt het mogelijk subklassen te kopiëren bij constructie. |
...
| virtual void [set_Threshold](./set_threshold/)(**float**) | Retourneert de drempelwaarde van het effect. Schrijf **float**. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Haalt de huidige waarde van de gedeelde referentie-teller op. |
...
Gebruik [ImageTransformOperationFactory](../imagetransformoperationfactory/) om instanties in COM te maken.
