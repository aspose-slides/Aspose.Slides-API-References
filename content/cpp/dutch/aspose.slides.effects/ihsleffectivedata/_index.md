...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl zwevend-kommageregel waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl zwevend-kommageregel waarbij twee NaN's als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| virtual **float** [get_Hue](./get_hue/)() | Retourneert hue-percentage. Alleen-lezen **float**. |
| virtual **float** [get_Luminance](./get_luminance/)() | Retourneert luminance-percentage. Alleen-lezen **float**. |
| virtual **float** [get_Saturation](./get_saturation/)() | Retourneert saturation-percentage. Alleen-lezen **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copyconstructor. Kopieert eigenlijk niets, Initialiseert enkel een nieuw object en maakt het mogelijk subklassen te copy-constructeren. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert eigenlijk niets, Initialiseert enkel een nieuw object en maakt het mogelijk subklassen te copy-constructeren. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt n'th template-argument in op een zwakke pointer (in plaats van gedeelde). Maakt het mogelijk pointers in containers om te schakelen naar zwakke modus. |
