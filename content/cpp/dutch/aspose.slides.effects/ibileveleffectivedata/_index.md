...
description: Onveranderlijk object dat een Bi-Level (zwart/wit) effect voorstelt. Invoerkleuren waarvan de luminantie kleiner is dan de opgegeven drempelwaarde, worden zwart gemaakt. Invoerkleuren waarvan de luminantie groter dan of gelijk aan de opgegeven waarde is, worden wit ingesteld. De alfawardeffecten blijven door dit effect onaangedaan.
type: docs
weight: 443
url: /nl/aspose.slides.effects/ibileveleffectivedata/
---
## IBiLevelEffectiveData klasse

Onveranderlijk object dat een Bi-Level (zwart/wit) effect voorstelt. Invoerkleuren waarvan de luminantie kleiner is dan de gespecificeerde drempelwaarde, worden zwart gemaakt. Invoerkleuren waarvan de luminantie groter dan of gelijk aan de gespecificeerde waarde is, worden wit ingesteld. De alfa-effectwaarden blijven onaangedaan door dit effect.
...
| virtual **float** [get_Threshold](./get_threshold/)() | Retourneert de drempelwaarde. Alleen-lezen **float**. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of object een instantie van het type die wordt beschreven door targetType vertegenwoordigt. Analoge van C# 'is' operator. |
| void [Lock](../../system/object/lock/)() | Implementeert C# lock()-statement vergrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) wachtersobject. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert C# lock()-statement ontgrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) wachtersobject. |
