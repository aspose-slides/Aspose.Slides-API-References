...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) radius. Lees **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Richting van de schaduw. Lees **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Afstand van de schaduw. Lees **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Kleur van de schaduw. Alleen-lezen [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Haalt effectieve data op met de erfenis toegepast. |
...
| virtual void [set_Direction](./set_direction/)(**float**) | Richting van de schaduw. Schrijf **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Afstand van de schaduw. Schrijf **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n'te sjabloonargument in op een zwakke pointer (in plaats van een gedeelde). Stelt het wisselen van pointers in containers naar zwakke modus mogelijk. |
