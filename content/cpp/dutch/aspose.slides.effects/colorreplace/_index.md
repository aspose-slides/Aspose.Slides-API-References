...
description: Representeert een kleurvervangingseffect. Alle effectkleuren worden veranderd naar een vaste kleur. Alfa-waarden blijven onaangedaan.
type: docs
weight: 144
...
Stelt een kleurvervangingseffect voor. Alle effectkleuren worden veranderd naar een vaste kleur. Alfa-waarden blijven onaangedaan.
...
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bepaalt of de opgegeven [ColorReplace](./) gelijk is aan de huidige [ColorReplace](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | Retourneert kleurformaat dat de kleur van elke pixel zal vervangen. Alleen-lezen [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplaceEffectiveData](../icolorreplaceeffectivedata/)\> [GetEffective](./geteffective/)() override | Haalt effectieve Color Replacement-effectgegevens op met de geërfde instellingen toegepast. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie van het type vertegenwoordigt dat door targetType wordt beschreven. Analogie van de C#-operator 'is'. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopie-constructor. Kopieert werkelijk niets, initialiseert alleen een nieuw object en maakt kopiëren-constructoren van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert werkelijk niets, initialiseert alleen een nieuw object en maakt kopiëren-constructoren van subklassen mogelijk. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogie van C# [Object.ToString()](../../system/object/tostring/)-methode. Maakt het mogelijk aangepaste objecten naar een string te converteren. |
...
* Klasse [IColorReplace](../icolorreplace/)
