...
Immutable object dat een alleen-lezen collectie van effectieve afbeeldingstransformatie-effecten vertegenwoordigt.
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Verkrijgt iterator die direct na het laatste const-gekwalificeerde element (indien aanwezig) van de collectie wijst. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>, **int32_t**) override | Kopieert alle elementen van de collectie naar de gespecificeerde array. |
| [iterator](./iterator/) [end](./end/)() | Verkrijgt iterator die direct na het laatste element (indien aanwezig) van de collectie wijst. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Verkrijgt iterator die direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie wijst. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bepaalt of het opgegeven object gelijk is aan het huidige object. |
...
| **int32_t** [get_Count](./get_count/)() override | Retourneert het aantal afbeeldingseffecten in een collectie. Alleen-lezen **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retourneert een enumerator die door de collectie itereert. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Dient als hash-functie voor een specifiek type, geschikt voor gebruik in hash-algoritmen en datastructuren zoals een hashtabel. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Verkrijgt het werkelijke type van het object. Analoge functie van C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) override | Retourneert element op index. |
|  [ImageTransformOCollectionEffectiveData](./imagetransformocollectioneffectivedata/)() |  |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Controleert of het object een instantie van het type vertegenwoordigt dat wordt beschreven door targetType. Analoge functie van C#-operator 'is'. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analoge functie van C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-methode. Stelt het klonen van aangepaste types mogelijk. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analoge functie van C# [Object.ToString()](../../system/object/tostring/)-methode. Maakt het mogelijk aangepaste objecten naar string te converteren. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Verkrijgt iterator die direct na het laatste element (indien aanwezig) van de const-gekwalificeerde instantie van de collectie wijst. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Verkrijgt iterator die direct na het laatste element (indien aanwezig) van de collectie wijst. |
...
Naam IImageTransformOperationCollectionEffectiveData afgekort tot [IImageTransformOCollectionEffectiveData](../iimagetransformocollectioneffectivedata/) omdat de lengte van COM-namen niet meer dan 39 mag zijn. 
