...
description: Representeert een Alpha Modulate Fixed-effect. Effect alfa (ondoorzichtigheid) waarden worden vermenigvuldigd met een vast percentage.
type: docs
weight: 365
...
| virtual **float** [get_Amount](./get_amount/)() | Retourneert een hoeveelheid effect in procenten. Lees **float**. |
...
| virtual void [set_Amount](./set_amount/)(**float**) | Retourneert een hoeveelheid effect in procenten. Schrijf **float**. |
