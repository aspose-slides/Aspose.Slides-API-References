...
Vertegenwoordigt een [Blur](../blur/)-effect dat wordt toegepast op de volledige vorm, inclusief de vulling. Alle kleurkanalen, inclusief alfa, worden beïnvloed.
...
| virtual **bool** [get_Grow](./get_grow/)() | Bepaalt of de grenzen van het object moeten worden vergroot als gevolg van de vervaging. True geeft aan dat de grenzen worden vergroot, terwijl false aangeeft dat dat niet gebeurt. Lees **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Retourneert de vervagingsradius. Lees **double**. |
...
| void [Lock](../../system/object/lock/)() | Implementeert het C# lock()-statement voor vergrendeling. Roep rechtstreeks aan of gebruik [LockContext](../../system/lockcontext/) sentry-object. |
...
| virtual void [set_Grow](./set_grow/)(**bool**) | Bepaalt of de grenzen van het object moeten worden vergroot als gevolg van de vervaging. True geeft aan dat de grenzen worden vergroot, terwijl false aangeeft dat dat niet gebeurt. Schrijf **bool**. |
| virtual void [set_Radius](./set_radius/)(**double**) | Stelt de vervagingsradius in. Schrijf **double**. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert het C# lock()-statement voor ontgrendeling. Roep rechtstreeks aan of gebruik [LockContext](../../system/lockcontext/) sentry-object. |
