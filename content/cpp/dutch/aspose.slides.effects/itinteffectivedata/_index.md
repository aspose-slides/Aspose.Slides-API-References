...
description: Onveranderlijk object dat een Tint-effect vertegenwoordigt. Verschuift de kleureffectwaarden naar of van de tint volgens de opgegeven hoeveelheid.
type: docs
weight: 1002
url: /nl/aspose.slides.effects/itinteffectivedata/
---
## ITintEffectiveData klasse

Immutable object which represents a [Tint](../tint/) effect. Shifts effect color values towards/away from hue by the specified amount.
...
| virtual **float** [get_Amount](./get_amount/)() | Retourneert de hoeveelheid van het effect. Alleen-lezen **float**. |
| virtual **float** [get_Hue](./get_hue/)() | Retourneert de tint. Alleen-lezen **float**. |
