...
description: Stelt een Blur effect voor dat wordt toegepast op de gehele vorm, inclusief de vulling. Alle kleurkanalen, inclusief alfa, worden beïnvloed.
type: docs
weight: 105
...
Stelt een [Blur](./) effect voor dat wordt toegepast op de gehele vorm, inclusief de vulling. Alle kleurkanalen, inclusief alfa, worden beïnvloed.
...
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bepaalt of de opgegeven [Blur](./) gelijk is aan de huidige [Blur](./). |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Vergelijkt objecten met C# [Object.Equals](../../system/object/equals/) semantiek. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Vergelijkt referentietype objecten in C# stijl. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Imiteert C#-stijl zwevend-kommag vergelijken waarbij twee NaN-waarden als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Imiteert C#-stijl zwevend-kommag vergelijken waarbij twee NaN-waarden als gelijk worden beschouwd, hoewel volgens IEC 60559:1989 NaN niet gelijk is aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| **bool** [get_Grow](./get_grow/)() override | Bepaalt of de grenzen van het object moeten worden uitgebreid als gevolg van het vervagen. Waar geeft aan dat de grenzen worden vergroot, onwaar geeft aan dat dit niet gebeurt. Lezen **bool**. |
...
| **double** [get_Radius](./get_radius/)() override | Retourneert blur straal. Lezen **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBlurEffectiveData](../iblureffectivedata/)\> [GetEffective](./geteffective/)() override | Haalt effectieve [Blur](./) effectgegevens op met de toegepaste overerving. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Copy-constructeur. Kopieert niets echt, initialiseert alleen een nieuw object en maakt het mogelijk om subklassen te kopiëren. |
...
| void [set_Grow](./set_grow/)(**bool**) override | Bepaalt of de grenzen van het object moeten worden uitgebreid als gevolg van het vervagen. Waar geeft aan dat de grenzen worden vergroot, onwaar geeft aan dat dit niet gebeurt. Schrijf **bool**. |
| void [set_Radius](./set_radius/)(**double**) override | Stelt blur straal in. Schrijf **double**. |
