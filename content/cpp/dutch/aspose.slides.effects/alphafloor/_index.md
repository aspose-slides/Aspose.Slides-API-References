...
description: Representeert een Alpha Floor effect. Alpha (doorzichtigheid) waarden minder dan 100% worden veranderd naar nul. Met andere woorden, alles dat gedeeltelijk transparant is wordt volledig transparant.
type: docs
weight: 27
...
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bepaalt of de opgegeven [AlphaFloor](./) gelijk is aan de huidige [AlphaFloor](./). |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../../aspose.slides/idomobject/)\> [get_Parent_Immediate](../../aspose.slides/idomobject/get_parent_immediate/)() | Geeft Parent_Immediate object terug. Alleen-lezen [IDOMObject](../../aspose.slides/idomobject/). |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | Geeft ouder [IPresentationComponent](../../aspose.slides/ipresentationcomponent/) terug. Alleen-lezen [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloorEffectiveData](../ialphaflooreffectivedata/)\> [GetEffective](./geteffective/)() override | Haalt effectieve Alpha Floor effect-gegevens op met de geërfde instellingen toegepast. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Dient als een hashfunctie voor een specifiek type. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Vergelijkt een waarde-typen object met nullptr per referentie. |
...
* Klasse [IAlphaFloor](../ialphafloor/)
