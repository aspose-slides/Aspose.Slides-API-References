...
description: Stelt een Glow-effect voor, waarbij een kleurvervagte omtrek buiten de randen van het object wordt toegevoegd.
type: docs
weight: 638
...
Vertegenwoordigt een [Glow](../glow/) effect, waarbij een kleurvervagen rand buiten de randen van het object wordt toegevoegd.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | Kleurformaat. Alleen-lezen [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual **double** [get_Radius](./get_radius/)() | Straal. Lees **double**. |
...
| void [Lock](../../system/object/lock/)() | Implementeert C# lock() instructie vergrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) waakhondobject. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Straal. Schrijf **double**. |
