...
description: Stelt een Alpha Modulate Fixed effect voor. Effect alfa (opaciteit) waarden worden vermenigvuldigd met een vast percentage.
type: docs
weight: 66
...
Vertegenwoordigt een Alpha Modulate Fixed effect. Effect alfa (opaciteit) waarden worden vermenigvuldigd met een vast percentage.
...
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bepaalt of de opgegeven [AlphaModulateFixed](./) gelijk is aan de huidige [AlphaModulateFixed](./). |
...
| **float** [get_Amount](./get_amount/)() override | Retourneert een hoeveelheid effect in procenten. Lezen **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | Haalt effectieve Alpha Modulate Fixed effect-data op met de toegepaste overerving. |
...
| void [set_Amount](./set_amount/)(**float**) override | Retourneert een hoeveelheid effect in procenten. Schrijf **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloon-argument in op een zwakke pointer (in plaats van gedeeld). Stelt schakelen van pointers in containers naar zwakke modus mogelijk. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert C# lock() statement vrijgave. Roep direct aan of gebruik [LockContext](../../system/lockcontext/) waakhond-object. |
