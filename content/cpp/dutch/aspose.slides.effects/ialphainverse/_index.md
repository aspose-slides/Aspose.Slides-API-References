...
description: Stelt een Alpha Inverse effect voor. Alpha (doorzichtigheid) waarden worden omgekeerd door ze van 100% af te trekken.
type: docs
weight: 313
url: /nl/aspose.slides.effects/ialphainverse/
---
## IAlphaInverse klasse
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Haal effectieve gegevens op met de toegepaste overerving. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stel het n'th sjabloonargument in als een zwakke pointer (in plaats van gedeeld). Stelt wisselen van pointers in containers naar zwakke modus mogelijk. |
