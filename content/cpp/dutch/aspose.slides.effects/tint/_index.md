...
description: Stelt een Tint-effect voor. Verschuift de kleureffectwaarden naar of van de tint met de opgegeven hoeveelheid.
type: docs
weight: 1093
...
Stelt een [Tint](./) effect voor. Verschuift de kleureffectwaarden naar of van de tint met de opgegeven hoeveelheid.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Bepaalt of de opgegeven [Tint](./) gelijk is aan de huidige [Tint](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | Haalt de effectieve [Tint](./) effectgegevens op met de geërfde instellingen toegepast. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Dient als een hash-functie voor een specifiek type. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopieerconstructor. Kopieert niets, initialiseert enkel een nieuw object en maakt kopiëren van subklassen mogelijk. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Toewijzingsoperator. Kopieert niets, initialiseert enkel een nieuw object en maakt kopiëren van subklassen mogelijk. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th-sjabloonargument in als een zwakke pointer (in plaats van shared). Staat toe om pointers in containers naar zwakke modus te schakelen. |
