...
description: "Stelt de publieke-sleutelinformatie van een X509-certificaat voor. Objecten van deze klasse mogen alleen worden gealloceerd met de functie System::MakeObject(). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit runtime-fouten en/of assertiefouten veroorzaakt. Wikkel deze klasse altijd in een System::SmartPtr-pointer en gebruik die pointer om deze als argument aan functies door te geven."
type: docs
weight: 1
url: /nl/system.security.cryptography.x509certificates/publickey/
---
## PublicKey klasse

Stelt de publieke-sleutelinformatie van een X509-certificaat voor. Objecten van deze klasse mogen alleen worden gealloceerd met de functie [System::MakeObject()](../../system/makeobject/). Maak nooit een instantie van dit type op de stack of met operator new, omdat dit runtime-fouten en/of assertiefouten veroorzaakt. Wikkel deze klasse altijd in een [System::SmartPtr](../../system/smartptr/)-pointer en gebruik die pointer om hem als argument aan functies door te geven.
...
| [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](../../system.security.cryptography/asnencodeddata/)\> [get_EncodedKeyValue](./get_encodedkeyvalue/)() const | Haalt de ASN.1-gecodeerde publieke-sleutelwaarde op. |
| [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](../../system.security.cryptography/asnencodeddata/)\> [get_EncodedParameters](./get_encodedparameters/)() const | Haalt de ASN.1-gecodeerde publieke-sleutelparameters op. |
| [SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](../../system.security.cryptography/asymmetricalgorithm/)\> [get_Key](./get_key/)() const | Haalt een [RSACryptoServiceProvider](../../system.security.cryptography/rsacryptoserviceprovider/) of [DSACryptoServiceProvider](../../system.security.cryptography/dsacryptoserviceprovider/) op. |
| [SharedPtr](../../system/sharedptr/)\<[Oid](../../system.security.cryptography/oid/)\> [get_Oid](./get_oid/)() const | Haalt de identifier (OID) van de publieke sleutel op. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analoge van C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/)-methode. Maakt het mogelijk aangepaste typen te klonen. |
