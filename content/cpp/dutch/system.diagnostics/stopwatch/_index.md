...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emuleert C#-stijl zwevende-kommagelijkheid waarbij twee NaN's als gelijk worden beschouwd, ook al is volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emuleert C#-stijl zwevende-kommagelijkheid waarbij twee NaN's als gelijk worden beschouwd, ook al is volgens IEC 60559:1989 NaN niet gelijk aan enige waarde, inclusief NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Alleen voor intern gebruik. |
| [TimeSpan](../../system/timespan/) [get_Elapsed](./get_elapsed/)() const | Haalt de totale verstreken tijd op die door de huidige instantie gemeten is. |
| **int64_t** [get_ElapsedMilliseconds](./get_elapsedmilliseconds/)() const | Haalt de totale verstreken tijd op die door de huidige instantie gemeten is, in milliseconden. |
| **int64_t** [get_ElapsedTicks](./get_elapsedticks/)() const | Haalt de totale verstreken tijd op die door de huidige instantie gemeten is, in timer-ticks. |
| **bool** [get_IsRunning](./get_isrunning/)() const | Controleert of de stopwatch loopt. |
...
| void [Lock](../../system/object/lock/)() | Implementeert C# lock()-statement voor vergrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-bewakerobject. |
...
| void [Reset](./reset/)() | Stopt tijdmeting, stelt de gemeten interval in op nul. |
| void [Restart](./restart/)() | Stelt de gemeten interval in op nul, waarna tijdmeting wordt gestart. |
...
| void [Start](./start/)() | Start tijdmeting. |
| static [SharedPtr](../../system/sharedptr/)\<[Stopwatch](./)\> [StartNew](./startnew/)() | Creëert een nieuw [Stopwatch](./)-object en start de meting. |
| void [Stop](./stop/)() | Stopt tijdmeting. |
...
| void [Unlock](../../system/object/unlock/)() | Implementeert C# lock()-statement voor ontgrendeling. Roep direct aan of gebruik [LockContext](../../system/lockcontext/)-bewakerobject. |
