...
description: "Dummy-klasse voor PerformanceCounter-gebruikende vertaalde code om te compileren. Objecten van deze klasse moeten alleen worden gealloceerd met de System::MakeObject() functie. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit zal leiden tot runtime-fouten en/of assertiefouten. Wikkel deze klasse altijd in een System::SmartPtr pointer en gebruik deze pointer om deze door te geven aan functies als argument."
type: docs
weight: 14
url: /nl/system.diagnostics/performancecounter/
---
## PerformanceCounter klasse

Dummy-klasse voor PerformanceCounter-gebruikende vertaalde code om te compileren. Objecten van deze klasse moeten alleen worden gealloceerd met de [System::MakeObject()](../../system/makeobject/) functie. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit zal leiden tot runtime-fouten en/of assertiefouten. Wikkel deze klasse altijd in een [System::SmartPtr](../../system/smartptr/) pointer en gebruik deze pointer om het door te geven aan functies als argument.
...
| --- | --- |
| void [Close](./close/)() | Stopt alle performance-telling operaties. |
...
| **float** [NextValue](./nextvalue/)() | Haalt de volgende gemeten waarde op. |
...
|  [PerformanceCounter](./performancecounter/)() | Creëert een performance counter. |
|  [PerformanceCounter](./performancecounter/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Creëert een performance counter van een specifieke categorie. |
|  [PerformanceCounter](./performancecounter/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Creëert een performance counter van een specifieke categorie en instantienaam. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Stelt het n'th sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Staat het overschakelen van pointers in containers naar zwakke modus toe. |
