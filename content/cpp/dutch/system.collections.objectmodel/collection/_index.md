...
| --- | --- |
| void [Add](./add/)(const T\&) override | Voegt een waarde toe aan de container. |
...
|  [Collection](./collection/)() | Maakt een lege collectie aan. |
|  [Collection](./collection/)([SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) |  |
| **bool** [Contains](./contains/)(const T\&) const override | Controleert of het item aanwezig is in de collectie. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Kopieert collectie-elementen naar bestaande array-elementen. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](./get_items/)() | Interne datastructuur-toegangsfunctie. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](./get_items/)() const | Interne datastructuur-toegangsfunctie. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Haalt een enumerator op om door de collectie te itereren. |
...
| T [idx_get](./idx_get/)(int) const override | Haalt de waarde op op de opgegeven index. |
| void [idx_set](./idx_set/)(int, T) override | Stelt de waarde in op de opgegeven index. |
| int [IndexOf](./indexof/)(const T\&) const override | Zoekt naar element in de collectie. |
| void [Insert](./insert/)(int, const T\&) override | Voegt item in op de opgegeven positie. |
...
| T\& [operator[]](./operator[]/)(int) | Haalt de waarde op op de opgegeven index. |
| const T\& [operator[]](./operator[]/)(int) const | Haalt de waarde op op de opgegeven index. |
...
| **bool** [Remove](./remove/)(const T\&) override | Verwijdert specifiek item. |
| void [RemoveAt](./removeat/)(int) override | Verwijdert item op een specifieke positie. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Maakt opgeslagen pointers zwak (indien van toepassing). |
