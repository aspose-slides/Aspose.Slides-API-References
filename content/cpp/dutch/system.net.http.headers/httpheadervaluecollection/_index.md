...
description: "Stelt de collectie van headerwaarden voor. Objecten van deze klasse mogen alleen worden gealloceerd met de System::MakeObject() functie. Maak nooit een instantie van dit type op de stack of met operator new, omdat dit leidt tot runtime-fouten en/of assert-fouten. Wikkel deze klasse altijd in een System::SmartPtr-pointer en gebruik deze pointer om deze door te geven aan functies als argument."
type: docs
weight: 92
url: /nl/system.net.http.headers/httpheadervaluecollection/
---
## HttpHeaderValueCollection klasse
...
| --- | --- |
| The | type van de headerwaarden die in de collectie worden weergegeven. |
## Methoden

| Methode | Beschrijving |
| --- | --- |
| void [Add](./add/)(const T\&) override | Voegt een element toe aan de collectie. |
...
| **bool** [Contains](./contains/)(const T\&) const override | Controleert of een element aanwezig is in de collectie. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) override | Kopieert alle collectie-elementen naar bestaande array-elementen. |
...
| **int32_t** [get_Count](./get_count/)() const override | Haalt het aantal elementen in de collectie op. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Haalt een waarde op die aangeeft of de huidige collectie alleen-lezen is. |
...
| **bool** [get_IsSpecialValueSet](./get_isspecialvalueset/)() | Haalt een waarde op die aangeeft of de huidige collectie een \"speciale waarde\" bevat. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Haalt enumerator op. |
...
| [String](../../system/string/) [GetHeaderStringWithoutSpecial](./getheaderstringwithoutspecial/)() | Retourneert een tekenreeksrepresentatie van de huidige collectie zonder een \"speciale waarde\". |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Haalt het werkelijke type van het object op. Analoge van C# [System.Object.GetType()](../../system/object/gettype/) aanroep. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>) | Construeert een nieuwe instantie. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Construeert een nieuwe instantie. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T) | Construeert een nieuwe instantie. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Construeert een nieuwe instantie. |
|  [ICollection](../../system.collections.generic/icollection/icollection/)() | Standaardconstructor. |
|  [ICollection](../../system.collections.generic/icollection/icollection/)(const [ICollection](../../system.collections.generic/icollection/)\&) | Kopiëringsconstructor. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Bereken het gemiddelde van een reeks waarden die worden verkregen door voor elk element van de invoerreeks een transform-functie aan te roepen. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Zet de elementen om naar het gespecificeerde type. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopiëringsconstructor. Kopieert in feite niets, alleen een nieuw object initialiseren en toestaan dat subklassen gekopieerd worden. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Assignment-operator. Kopieert in feite niets, alleen een nieuw object initialiseren en toestaan dat subklassen gekopieerd worden. |
| void [ParseAdd](./parseadd/)([String](../../system/string/)) | Parseert een header-tekenreeksrepresentatie en voegt deze toe aan de huidige collectie. |
...
| **bool** [Remove](./remove/)(const T\&) override | Verwijdert element uit de collectie. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Verlaagt de gedeelde referentieteller met de opgegeven waarde. |
| void [RemoveSpecialValue](./removespecialvalue/)() | Verwijdert een \"speciale waarde\". |
| void [SetSpecialValue](./setspecialvalue/)() | Stelt een \"speciale waarde\" in. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Stelt het n-de sjabloonargument in op een zwakke pointer (in plaats van gedeeld). Maakt het mogelijk om pointers in containers naar zwakke modus te schakelen. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Analoge van C# [Object.ToString()](../../system/object/tostring/) methode. Maakt het mogelijk om aangepaste objecten naar een string te converteren. |
| **bool** [TryParseAdd](./tryparseadd/)([String](../../system/string/)) | Probeert een header-tekenreeksrepresentatie te parseren en toe te voegen aan de huidige collectie. |
