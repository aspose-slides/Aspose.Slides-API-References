...
description: "TargetInvocationException é lançada por métodos invocados por reflexão. Nunca crie instâncias desta classe manualmente. Use a classe TargetInvocationException em vez disso. Nunca envolva as instâncias da classe TargetInvocationException em System::SmartPtr."
type: docs
weight: 79
url: /pt/system.reflection/details_targetinvocationexception/
---
## Details_TargetInvocationException classe

TargetInvocationException é lançada por métodos invocados por reflexão. Nunca crie instâncias desta classe manualmente. Use a classe TargetInvocationException em vez disso. Nunca embrulhe as instâncias da classe TargetInvocationException em [System::SmartPtr](../../system/smartptr/).
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_applicationexception/gettype/)() const override | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
