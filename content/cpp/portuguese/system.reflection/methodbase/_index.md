...
description: "Informações básicas sobre o método. Objetos desta classe devem ser alocados apenas usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 118
url: /pt/system.reflection/methodbase/
---
## MethodBase classe

Informações básicas sobre o método. Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie uma instância desse tipo na pilha ou usando o operador new, pois resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Indica o tipo do membro – método, construtor, evento, etc. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[MemberInfo](../memberinfo/)\> [GetCurrentMethod](./getcurrentmethod/)(const [String](../../system/string/)\&) | Este método permite obter o nome do método atual. O tradutor substitui ASPOSE_CURRENT_FUNCTION como parâmetro automaticamente. |
...
|  [MethodBase](./methodbase/)() | Inicializa uma nova instância da classe [MethodBase](./). |
