...
description: "ReflectionTypeLoadException é lançada pelo método Module.GetTypes se alguma das classes em um módulo falhar ao carregar. Nunca crie instâncias desta classe manualmente. Use a classe ReflectionTypeLoadException em vez disso. Nunca encapsule as instâncias da classe ReflectionTypeLoadException em System::SmartPtr."
type: docs
weight: 66
url: /pt/system.reflection/details_reflectiontypeloadexception/
---
## Details_ReflectionTypeLoadException classe

ReflectionTypeLoadException é lançada pelo método Module.GetTypes se alguma das classes em um módulo falhar ao carregar. Nunca crie instâncias desta classe manualmente. Use a classe ReflectionTypeLoadException em vez disso. Nunca encapsule as instâncias da classe ReflectionTypeLoadException em [System::SmartPtr](../../system/smartptr/).
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Exception](../../system/exception/)\> [get_LoaderExceptions](./get_loaderexceptions/)() const | Retorna as exceções que causaram esta exceção. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::TypeInfo](../../system/typeinfo/)\> [get_Types](./get_types/)() const | Retorna as informações de tipo das causas da exceção. |
