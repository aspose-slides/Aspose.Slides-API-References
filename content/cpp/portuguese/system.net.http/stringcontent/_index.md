...
| Method | Description |
| --- | --- |
|  [ByteArrayContent](../bytearraycontent/bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Constrói uma nova instância. |
|  [ByteArrayContent](../bytearraycontent/bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | Constrói uma nova instância. |
| void [Dispose](../httpcontent/dispose/)() override | Descarta a instância atual. Este método também descarta o fluxo retornado por 'ReadAsStream' e o buffer de memória se ele for criado. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpContentHeaders](../../system.net.http.headers/httpcontentheaders/)\> [get_Headers](../httpcontent/get_headers/)() | Retorna os cabeçalhos do conteúdo HTTP. |
...
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)() | Serializa o conteúdo para um buffer de memória. |
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)(**int64_t**) | Serializa o conteúdo para um buffer de memória. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ReadAsByteArray](../httpcontent/readasbytearray/)() | Serializa o conteúdo e retorna um array de bytes. |
| [System::SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [ReadAsStream](../httpcontent/readasstream/)() | Serializa o conteúdo e retorna um fluxo. |
| [String](../../system/string/) [ReadAsString](../httpcontent/readasstring/)() | Serializa o conteúdo e retorna uma string. |
...
|  [StringContent](./stringcontent/)([String](../../system/string/)) | Constrói uma nova instância. |
|  [StringContent](./stringcontent/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>) | Constrói uma nova instância. |
|  [StringContent](./stringcontent/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>, [String](../../system/string/)) | Constrói uma nova instância. |
...
| **bool** [TryComputeLength](../bytearraycontent/trycomputelength/)(**int64_t**\&) override | Tenta calcular o comprimento do array de bytes. |
...
| Field | Description |
| --- | --- |
| static [DefaultStringEncoding](../httpcontent/defaultstringencoding/) | A codificação padrão. |
| static [MaxBufferSize](../httpcontent/maxbuffersize/) | O número máximo de bytes. |
