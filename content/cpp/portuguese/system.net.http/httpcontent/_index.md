...
description: "Representa o conteúdo de uma entidade HTTP. O objeto desta classe deve ser alocado apenas usando a função System::MakeObject() . Nunca crie instância deste tipo na pilha ou usando o operador new, pois resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 53
url: /pt/system.net.http/httpcontent/
---
## HttpContent classe

Representa o conteúdo de uma entidade HTTP. [Object](../../system/object/) desta classe deve ser alocada somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| Método | Descrição |
| --- | --- |
| void [Dispose](./dispose/)() override | Descarta a instância atual. Este método também descarta o stream retornado por 'ReadAsStream' e o buffer de memória se ele for criado. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpContentHeaders](../../system.net.http.headers/httpcontentheaders/)\> [get_Headers](./get_headers/)() | Retorna os cabeçalhos de conteúdo HTTP. |
...
| void [LoadIntoBuffer](./loadintobuffer/)() | Serializa o conteúdo para um buffer de memória. |
| void [LoadIntoBuffer](./loadintobuffer/)(**int64_t**) | Serializa o conteúdo para um buffer de memória. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ReadAsByteArray](./readasbytearray/)() | Serializa o conteúdo e retorna um array de bytes. |
| [System::SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [ReadAsStream](./readasstream/)() | Serializa o conteúdo e retorna um stream. |
| [String](../../system/string/) [ReadAsString](./readasstring/)() | Serializa o conteúdo e retorna uma string. |
...
| virtual **bool** [TryComputeLength](./trycomputelength/)(**int64_t**\&) | Tenta calcular o tamanho do conteúdo. |
...
| Campo | Descrição |
| --- | --- |
| static [DefaultStringEncoding](./defaultstringencoding/) | A codificação padrão. |
| static [MaxBufferSize](./maxbuffersize/) | O número máximo de bytes. |
