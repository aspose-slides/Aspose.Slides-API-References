...
| Método | Descrição |
| --- | --- |
| void [Dispose](./dispose/)() override | Descarta a instância atual. Este método também descarta o conteúdo da resposta HTTP. |
| [System::SharedPtr](../../system/sharedptr/)\<[HttpResponseMessage](./)\> [EnsureSuccessStatusCode](./ensuresuccessstatuscode/)() | Verifica o código de status. HttpRequestException será lançado quando o código de status não pertencer ao intervalo 2xx. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[HttpContent](../httpcontent/)\> [get_Content](./get_content/)() const | Obtém o conteúdo da resposta HTTP. |
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpResponseHeaders](../../system.net.http.headers/httpresponseheaders/)\> [get_Headers](./get_headers/)() const | Retorna os cabeçalhos de conteúdo HTTP. |
| **bool** [get_IsSuccessStatusCode](./get_issuccessstatuscode/)() const | Verifica se o código de status indica que a ação solicitada pelo cliente foi recebida, compreendida e aceita. |
| [String](../../system/string/) [get_ReasonPhrase](./get_reasonphrase/)() const | Obtém a frase de motivo (Reason-Phrase) enviada pelos servidores juntamente com o código de status. |
| [System::SharedPtr](../../system/sharedptr/)\<[HttpRequestMessage](../httprequestmessage/)\> [get_RequestMessage](./get_requestmessage/)() const | Obtém a mensagem de requisição HTTP. |
| [HttpStatusCode](../../system.net/httpstatuscode/) [get_StatusCode](./get_statuscode/)() const | Obtém o código de status HTTP. |
| [System::Version](../../system/version/) [get_Version](./get_version/)() const | Obtém a versão HTTP. |
...
|  [HttpResponseMessage](./httpresponsemessage/)() | Constrói uma nova instância. |
|  [HttpResponseMessage](./httpresponsemessage/)([HttpStatusCode](../../system.net/httpstatuscode/)) | Constrói uma nova instância. |
...
| void [set_Content](./set_content/)([System::SharedPtr](../../system/sharedptr/)\<[HttpContent](../httpcontent/)\>) | Define o conteúdo da resposta HTTP. |
| void [set_ReasonPhrase](./set_reasonphrase/)([String](../../system/string/)) | Define a frase de motivo (Reason-Phrase) enviada pelos servidores juntamente com o código de status. |
| void [set_RequestMessage](./set_requestmessage/)([System::SharedPtr](../../system/sharedptr/)\<[HttpRequestMessage](../httprequestmessage/)\>) | Define a mensagem de requisição HTTP. |
| void [set_StatusCode](./set_statuscode/)([HttpStatusCode](../../system.net/httpstatuscode/)) | Define o código de status HTTP. |
| void [set_Version](./set_version/)([System::Version](../../system/version/)) | Define a versão HTTP. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de template como um ponteiro fraco (em vez de compartilhado). Permite a troca de ponteiros em contêineres para modo fraco. |
