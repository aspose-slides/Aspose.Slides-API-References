...
description: Contém os métodos utilitários.
type: docs
weight: 131
url: /pt/system.net.http/httputilities/
---
## HttpUtilities classe


Contém os métodos utilitários.
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Verifica se o URI especificado é o URI HTTP. |
...
| Campo | Descrição |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | A versão HTTP padrão para enviar solicitações. |
| static [DefaultResponseVersion](./defaultresponseversion/) | A versão HTTP padrão para receber respostas. |
