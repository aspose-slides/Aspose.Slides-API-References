...
description: Classe utilitária interna que implementa IEnumerable sobre uma fila de itens.
type: docs
weight: 1
url: /pt/system.linq.details/cachedenumerable/
---
## CachedEnumerable classe

Classe utilitária interna implementa IEnumerable sobre uma fila de itens.
...
| Parâmetro | Descrição |
| --- | --- |
| TItem | O tipo do elemento em uma fila. |
## Métodos
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<TItem\>\> [GetEnumerator](./getenumerator/)() override | Obtém enumerador. |
...
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)() | Retorna o primeiro elemento da sequência. |
...
| T [LINQ_Last](../../system.collections.generic/ienumerable/linq_last/)() | Retorna o último elemento da sequência. |
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Retorna o último elemento da sequência, ou um valor padrão se a sequência estiver vazia. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo ao método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Habilita a clonagem de tipos personalizados. |
