...
description: Implementa a interface IEnumerable para uma coleção genérica vazia.
type: docs
weight: 14
url: /pt/system.linq.details/emptyenumerable/
---
## EmptyEnumerable classe

Implementa a interface IEnumerable para uma coleção genérica vazia.
...
| Parâmetro | Descrição |
| --- | --- |
| T | O tipo do elemento em uma coleção. |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Obtém enumerador. |
