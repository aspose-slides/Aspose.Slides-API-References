...
description: Implementa a interface IEnumerator para uma coleção genérica vazia.
type: docs
weight: 27
url: /pt/system.linq.details/emptyenumerator/
---
## EmptyEnumerator classe

Implementa a interface IEnumerator para uma coleção genérica vazia.
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const override | Obtém o elemento atual. |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | Marca o enumerador possuído pelo iterador virtualizado. |
