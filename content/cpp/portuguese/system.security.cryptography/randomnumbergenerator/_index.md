...
| Método | Descrição |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[RandomNumberGenerator](./)\> [Create](./create/)() | Cria uma instância da implementação padrão de um gerador de números aleatórios criptográfico que pode ser usado para gerar dados aleatórios. Não implementado. |
...
| virtual void [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Preenche os elementos existentes da matriz com bytes aleatórios. |
| virtual void [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Preenche a fatia existente da matriz com bytes aleatórios. |
| virtual void [GetBytes](./getbytes/)(System::Details::ArrayView\<**uint8_t**\>) | Preenche os elementos existentes da visualização da matriz com bytes aleatórios. |
| virtual void [GetBytes](./getbytes/)(System::Details::ArrayView\<**uint8_t**\>, int, int) | Preenche a fatia existente da visualização da matriz com bytes aleatórios. |
| void [GetBytes](./getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | Preenche os elementos existentes da matriz de pilha com bytes aleatórios. |
| void [GetBytes](./getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&, int, int) | Preenche a fatia existente da matriz de pilha com bytes aleatórios. |
...
| virtual void [GetNonZeroBytes](./getnonzerobytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Preenche os elementos existentes da matriz com bytes aleatórios diferentes de zero. |
| virtual void [GetNonZeroBytes](./getnonzerobytes/)(System::Details::ArrayView\<**uint8_t**\>) | Preenche os elementos existentes da visualização da matriz com bytes aleatórios diferentes de zero. |
| void [GetNonZeroBytes](./getnonzerobytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | Preenche os elementos existentes da matriz de pilha com bytes aleatórios diferentes de zero. |
