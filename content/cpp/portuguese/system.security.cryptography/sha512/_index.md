...
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](./)\> [Create](./create/)() | Cria uma instância do algoritmo de hash. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Cria uma instância do algoritmo de hash. |
