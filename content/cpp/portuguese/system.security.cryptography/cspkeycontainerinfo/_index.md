...
description: Informações adicionais sobre um par de chaves criptográficas.
type: docs
weight: 66
url: /pt/system.security.cryptography/cspkeycontainerinfo/
---
## CspKeyContainerInfo classe

Informações adicionais sobre um par de chaves criptográficas.
...
| Método | Descrição |
| --- | --- |
|  [CspKeyContainerInfo](./cspkeycontainerinfo/)(const [SharedPtr](../../system/sharedptr/)\<[CspParameters](../cspparameters/)\>\&) | Construtor. |
...
| **bool** [get_Accessible](./get_accessible/)() const | Obtém um indicador que indica se uma chave em um contêiner é acessível. |
| **bool** [get_Exportable](./get_exportable/)() const | Obtém um indicador que indica se uma chave pode ser exportada de um contêiner. |
| **bool** [get_HardwareDevice](./get_hardwaredevice/)() const | Obtém um indicador que indica se uma chave é uma chave de hardware. |
| [String](../../system/string/) [get_KeyContainerName](./get_keycontainername/)() const | Obtém o nome do contêiner de chave. |
| [SharedPtr](../../system/sharedptr/)\<[KeyNumber](../keynumber/)\> [get_KeyNumber](./get_keynumber/)() const | Obtém um objeto KeyNumber. |
| **bool** [get_MachineKeyStore](./get_machinekeystore/)() const | Obtém um indicador que indica se uma chave foi carregada da loja de chaves da máquina. |
| **bool** [get_Protected](./get_protected/)() const | Obtém um indicador que indica se uma chave está protegida contra cópia. |
| [String](../../system/string/) [get_ProviderName](./get_providername/)() const | Obtém o nome do provedor. |
| **int32_t** [get_ProviderType](./get_providertype/)() const | Obtém o tipo do provedor. |
| **bool** [get_RandomlyGenerated](./get_randomlygenerated/)() const | Obtém um indicador que indica se uma chave foi gerada aleatoriamente. |
| **bool** [get_Removable](./get_removable/)() const | Obtém um indicador que indica se uma chave pode ser removida de um contêiner. |
| [String](../../system/string/) [get_UniqueKeyContainerName](./get_uniquekeycontainername/)() const | Obtém um nome de contêiner único. |
