...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Calcula hash da fatia do buffer. |
...
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](../sha512/)\> [Create](../sha512/create/)() | Cria uma instância do algoritmo de hash. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](../sha512/)\> [Create](../sha512/create/)(const [String](../../system/string/)\&) | Cria uma instância do algoritmo de hash. |
...
| virtual void [Initialize](../hashalgorithm/initialize/)() | Redefine o hashador para o estado inicial. |
...
| [SHA512Managed](./sha512managed/)() | Construtor. |
