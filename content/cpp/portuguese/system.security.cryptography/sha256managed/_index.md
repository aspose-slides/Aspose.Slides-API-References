...
| static [SharedPtr](../../system/sharedptr/)\<[SHA256](../sha256/)\> [Create](../sha256/create/)() | Cria uma instância do algoritmo de hash. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA256](../sha256/)\> [Create](../sha256/create/)(const [String](../../system/string/)\&) | Cria uma instância do algoritmo de hash. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de template como ponteiro fraco (em vez de compartilhado). Permite mudar ponteiros em contêineres para o modo fraco. |
| [SHA256Managed](./sha256managed/)() | Construtor. |
