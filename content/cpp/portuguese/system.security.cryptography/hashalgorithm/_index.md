...
description: "Classe base para algoritmos de hash. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-la a funções como argumento."
type: docs
weight: 222
url: /pt/system.security.cryptography/hashalgorithm/
---
...
| Método | Descrição |
| --- | --- |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Calcula o hash do buffer. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Calcula hash de uma parte do buffer. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)([SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> const\&) | Lê o fluxo até o fim e calcula o hash dos dados lidos. |
| static [SharedPtr](../../system/sharedptr/)\<[HashAlgorithm](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Cria algoritmo de hash com base no nome. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Hash](./get_hash/)() | Obtém o valor do código hash calculado. |
| virtual int [get_HashSize](./get_hashsize/)() | Obtém o tamanho do valor de hash calculado em bytes. |
| int [get_InputBlockSize](./get_inputblocksize/)() override | Tamanho do bloco de entrada. |
| int [get_OutputBlockSize](./get_outputblocksize/)() override | Tamanho do bloco de saída. |
...
| virtual void [Initialize](./initialize/)() | Redefine o hasher para o estado inicial. |
...
| int [TransformBlock](./transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Processa um bloco de dados e copia os dados para o array de saída. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](./transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) override | Processa o último bloco de dados e calcula o hash. |
...
| virtual  [~HashAlgorithm](./~hashalgorithm/)() | Destrutor. |
