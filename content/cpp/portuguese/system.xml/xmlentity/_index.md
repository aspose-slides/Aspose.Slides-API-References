...
description: Representa uma declaração de entidade, como <!ENTITY... >.
type: docs
weight: 235
url: /pt/system.xml/xmlentity/
---
## XmlEntity classe
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Cria uma cópia deste nó. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Cria uma cópia deste nó. Nós de entidade não podem ser clonados. Chamar este método em um objeto [XmlEntity](./) lança uma exceção. |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Retorna o Identificador Uniforme de Recursos (URI) base do nó atual. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Retorna um valor indicando se este nó possui algum nó filho. |
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Retorna os valores concatenados do nó de entidade e de todos os seus filhos. |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Retorna a marcação que representa os filhos deste nó. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | Retorna um valor indicando se o nó é somente-leitura. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | Retorna o último filho do nó. |
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Retorna o nome do nó sem o prefixo de namespace. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Retorna o nome do nó. |
| virtual [String](../../system/string/) [get_NamespaceURI](../xmlnode/get_namespaceuri/)() | Retorna o URI do namespace deste nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Retorna o nó imediatamente seguinte a este nó. |
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | Retorna o tipo do nó. |
| [String](../../system/string/) [get_NotationName](./get_notationname/)() | Retorna o nome do atributo NDATA opcional na declaração da entidade. |
| [String](../../system/string/) [get_OuterXml](./get_outerxml/)() override | Retorna a marcação que representa este nó e todos os seus filhos. |
...
| virtual [String](../../system/string/) [get_Prefix](../xmlnode/get_prefix/)() | Retorna o prefixo de namespace deste nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Retorna o nó imediatamente precedente a este nó. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Retorna o valor do identificador público na declaração da entidade. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Retorna o conjunto de informações pós-validação de esquema que foi atribuído a este nó como resultado da validação de esquema. |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Retorna o valor do identificador de sistema na declaração da entidade. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Busca a declaração **xmlns** mais próxima para o prefixo fornecido que esteja no escopo do nó atual e retorna o URI do namespace na declaração. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Busca a declaração **xmlns** mais próxima para o URI de namespace fornecido que esteja no escopo do nó atual e retorna o prefixo definido nessa declaração. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Coloca todos os nós [XmlText](../xmltext/) em toda a profundidade da sub-árvore abaixo deste [XmlNode](../xmlnode/) em uma forma "normal", onde somente a marcação (ou seja, tags, comentários, instruções de processamento, seções CDATA e referências de entidade) separa nós [XmlText](../xmltext/), ou seja, não há nós [XmlText](../xmltext/) adjacentes. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referências compartilhadas por um valor especificado. |
...
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Define os valores concatenados do nó de entidade e de todos os seus filhos. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Define a marcação que representa os filhos deste nó. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Define o prefixo de namespace deste nó. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva todos os filhos do nó no [XmlWriter](../xmlwriter/) especificado. Para nós [XmlEntity](./), este método não tem efeito. |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva o nó no [XmlWriter](../xmlwriter/) especificado. Para nós [XmlEntity](./), este método não tem efeito. |
