...
description: Retorna informações detalhadas sobre a última exceção.
type: docs
weight: 1
url: /pt/system.xml/details_xmlexception/
---
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Retorna o número da linha que indica onde o erro ocorreu. Os números das linhas começam em 1. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Retorna a posição na linha que indica onde o erro ocorreu. A posição na linha começa em 1. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Retorna uma mensagem descrevendo a exceção atual. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Retorna a localização do arquivo XML. |
