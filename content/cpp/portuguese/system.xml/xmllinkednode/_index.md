...
description: Retorna o nó imediatamente precedente ou subsequente a este nó.
type: docs
weight: 274
url: /pt/system.xml/xmllinkednode/
---
## XmlLinkedNode classe


Retorna o nó imediatamente precedente ou subsequente a este nó.
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Obtém o iterador apontando para o primeiro elemento const-qualificado (se houver) da coleção. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Obtém o iterador apontando logo após o último elemento const-qualificado (se houver) da coleção. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Cria uma duplicata deste nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Cria uma duplicata do nó, quando sobrescrito em uma classe derivada. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtém o iterador apontando logo após o último elemento (se houver) da instância const-qualificada da coleção. |
...
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Retorna a marcação que representa somente os nós filhos deste nó. |
...
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | Retorna o nome local do nó, quando sobrescrito em uma classe derivada. |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | Retorna o nome qualificado do nó, quando sobrescrito em uma classe derivada. |
| virtual [String](../../system/string/) [get_NamespaceURI](../xmlnode/get_namespaceuri/)() | Retorna o URI do namespace deste nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Retorna o nó imediatamente subsequente a este nó. |
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | Retorna o tipo do nó atual, quando sobrescrito em uma classe derivada. |
...
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Procura a declaração **xmlns** mais próxima para o URI do namespace fornecido que está no escopo do nó atual e retorna o prefixo definido na declaração. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](../xmlnode/prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Adiciona o nó especificado ao início da lista de nós filhos para este nó. |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Define os valores concatenados do nó e de todos os seus nós filhos. |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Define a marcação que representa somente os nós filhos deste nó. |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Salva todos os nós filhos do nó no [XmlWriter](../xmlwriter/) especificado, quando sobrescrito em uma classe derivada. |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Salva o nó atual no [XmlWriter](../xmlwriter/) especificado, quando sobrescrito em uma classe derivada. |
