...
description: Representa uma declaração de notação, como <!NOTATION... >.
type: docs
weight: 378
url: /pt/system.xml/xmlnotation/
---
## XmlNotation classe
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Cria uma duplicata deste nó. Nós de notação não podem ser clonados. Chamar este método em um objeto [XmlNotation](./) lança uma exceção. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de ponto flutuante no estilo C#, onde dois NaNs são considerados iguais, embora segundo a IEC 60559:1989 NaN não seja igual a nenhum valor, inclusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de ponto flutuante no estilo C#, onde dois NaNs são considerados iguais, embora segundo a IEC 60559:1989 NaN não seja igual a nenhum valor, inclusive NaN. |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Retorna o nome do nó atual sem o prefixo de namespace. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Retorna o nome do nó atual. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Retorna o valor do identificador público na declaração de notação. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Retorna o conjunto de informações de validação de esquema pós-validação que foi atribuído a este nó como resultado da validação de esquema. |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Retorna o valor do identificador de sistema na declaração de notação. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Coloca todos os nós [XmlText](../xmltext/) em toda a profundidade da sub-árvore sob este [XmlNode](../xmlnode/) em uma forma "normal" onde apenas a marcação (isto é, tags, comentários, instruções de processamento, seções CDATA e referências de entidade) separa os nós [XmlText](../xmltext/), ou seja, não há nós [XmlText](../xmltext/) adjacentes. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva os filhos do nó no [XmlWriter](../xmlwriter/) especificado. Este método não tem efeito em nós [XmlNotation](./). |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva o nó no [XmlWriter](../xmlwriter/) especificado. Este método não tem efeito em nós [XmlNotation](./). |
