...
description: Permite que uma classe retorne um XmlNode do contexto ou posição atual.
type: docs
weight: 27
url: /pt/system.xml/ihasxmlnode/
---
## IHasXmlNode classe
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNode](./getnode/)() | Retorna o [XmlNode](../xmlnode/) para a posição atual. |
