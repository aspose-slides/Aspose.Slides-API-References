...
description: Representa o nó de declaração XML <?xml version='1.0'...?>.
type: docs
weight: 170
url: /pt/system.xml/xmldeclaration/
---
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | Retorna o nível de codificação do documento XML. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Retorna os valores concatenados do [XmlDeclaration](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | Retorna o nó de texto que antecede imediatamente este nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Retorna o infoset de validação de esquema pós que foi atribuído a este nó como resultado da validação de esquema. |
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | Retorna o valor do atributo standalone. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Retorna o valor do [XmlDeclaration](./). |
| [String](../../system/string/) [get_Version](./get_version/)() | Retorna a versão XML do documento. |
...
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | Define o nível de codificação do documento XML. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Define os valores concatenados do [XmlDeclaration](./). |
...
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | Define o valor do atributo standalone. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Define o valor do [XmlDeclaration](./). |
...
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Testa se a implementação DOM suporta um recurso específico. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva os filhos do nó no [XmlWriter](../xmlwriter/) especificado. Como os nós [XmlDeclaration](./) não têm filhos, este método não tem efeito. |
