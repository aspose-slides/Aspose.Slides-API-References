...
description: Representa o conteúdo de um comentário XML.
type: docs
weight: 144
url: /pt/system.xml/xmlcomment/
---
## XmlComment classe
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo do método [Object.GetHashCode()](../../system/object/gethashcode/) do C#. Permite a hash de objetos personalizados. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Localiza a declaração **xmlns** mais próxima para o prefixo fornecido que está em escopo para o nó atual e retorna o URI do namespace na declaração. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Localiza a declaração **xmlns** mais próxima para o URI de namespace fornecido que está em escopo para o nó atual e retorna o prefixo definido nessa declaração. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Coloca todos os nós [XmlText](../xmltext/) em toda a profundidade da sub-árvore sob este [XmlNode](../xmlnode/) em uma forma "normal" onde somente marcação (ou seja, tags, comentários, instruções de processamento, seções CDATA e referências de entidade) separa os nós [XmlText](../xmltext/), isto é, não há nós [XmlText](../xmltext/) adjacentes. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Recupera uma substring da string completa a partir do intervalo especificado. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Salva todos os filhos do nó no [XmlWriter](../xmlwriter/) especificado. Como nós de comentário não têm filhos, este método não tem efeito. |
