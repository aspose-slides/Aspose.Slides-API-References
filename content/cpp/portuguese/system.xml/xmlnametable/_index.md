...
description: Tabela de objetos de strings atomizadas.
type: docs
weight: 313
url: /pt/system.xml/xmlnametable/
---
## XmlNameTable classe


Tabela de objetos de strings atomizadas.
...
| Método | Descrição |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Quando substituído em uma classe derivada, atomiza a string especificada e a adiciona ao [XmlNameTable](./). |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | Quando substituído em uma classe derivada, atomiza a string especificada e a adiciona ao [XmlNameTable](./). |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Quando substituído em uma classe derivada, obtém a string atomizada contendo os mesmos caracteres do intervalo especificado de caracteres no array fornecido. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | Quando substituído em uma classe derivada, obtém a string atomizada contendo o mesmo valor da string especificada. |
