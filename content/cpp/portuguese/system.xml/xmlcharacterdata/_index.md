...
description: Fornece métodos de manipulação de texto que são usados por várias classes.
type: docs
weight: 118
url: /pt/system.xml/xmlcharacterdata/
---
## classe XmlCharacterData
...
| virtual void [AppendData](./appenddata/)([String](../../system/string/)) | Anexa a string especificada ao final dos dados de caracteres do nó. |
...
| virtual void [DeleteData](./deletedata/)(**int32_t**, **int32_t**) | Remove um intervalo de caracteres do nó. |
...
| virtual [String](../../system/string/) [get_Data](./get_data/)() | Retorna os dados do nó. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Retorna os valores concatenados do nó e de todos os seus filhos. |
...
| virtual **int32_t** [get_Length](./get_length/)() | Retorna o comprimento dos dados, em caracteres. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Retorna o nó pai deste nó (para nós que podem ter pais). |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógico ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hashing de objetos customizados. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Busca a declaração **xmlns** mais próxima para o prefixo fornecido que está no escopo do nó atual e retorna o URI do namespace na declaração. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Busca a declaração **xmlns** mais próxima para o URI de namespace fornecido que está no escopo do nó atual e retorna o prefixo definido nessa declaração. |
...
| virtual void [InsertData](./insertdata/)(**int32_t**, [String](../../system/string/)) | Insere a string especificada no deslocamento de caracteres especificado. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analítico ao método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonagem de tipos customizados. |
| virtual void [Normalize](../xmlnode/normalize/)() | Põe todos os [XmlText](../xmltext/) nós na profundidade total da subárvore sob este [XmlNode](../xmlnode/) em uma forma "normal" onde apenas marcação (ou seja, tags, comentários, instruções de processamento, seções CDATA e referências de entidade) separa nós [XmlText](../xmltext/), isto é, não há nós [XmlText](../xmltext/) adjacentes. |
...
| virtual void [ReplaceData](./replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Substitui o número especificado de caracteres a partir do deslocamento especificado pela string especificada. |
...
| virtual void [set_Data](./set_data/)([String](../../system/string/)) | Define os dados do nó. |
...
| virtual [String](../../system/string/) [Substring](./substring/)(**int32_t**, **int32_t**) | Recupera uma subcadeia da string completa a partir do intervalo especificado. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analógico ao método C# [Object.ToString()](../../system/object/tostring/). Permite converter objetos customizados para string. |
