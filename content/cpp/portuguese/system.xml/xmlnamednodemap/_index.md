...
description: Representa uma coleção de nós que podem ser acessados por nome ou índice.
type: docs
weight: 287
url: /pt/system.xml/xmlnamednodemap/
---
...
| Método | Descrição |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() const | Obtém o iterador para o primeiro elemento da coleção. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Obtém o iterador que aponta para o primeiro elemento (se houver) da coleção. Esse iterador não pode ser usado para alterar um objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) retorna um objeto-cópia de T. |
| [iterator](./iterator/) [cbegin](./cbegin/)() const | Obtém o iterador para o primeiro elemento da coleção. |
| [iterator](./iterator/) [cend](./cend/)() const | Obtém o iterador para um elemento inexistente após o último elemento da coleção. |
| [iterator](./iterator/) [end](./end/)() const | Obtém o iterador para um elemento inexistente após o último elemento da coleção. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Obtém o iterador que aponta imediatamente após o último elemento (se houver) da coleção. Esse iterador não pode ser usado para alterar um objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) retorna um objeto-cópia de T. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Retorna o número de nós em [XmlNamedNodeMap](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](./getenumerator/)() override | Fornece suporte à iteração sobre a coleção de nós em [XmlNamedNodeMap](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/)) | Recupera um [XmlNode](../xmlnode/) especificado por nome. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/), [String](../../system/string/)) | Recupera um nó com os valores correspondentes de [XmlNode::get_LocalName](../xmlnode/get_localname/) e [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica se o objeto representa uma instância do tipo descrito por targetType. Análogo ao operador C# 'is'. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Item](./item/)(**int32_t**) | Recupera o nó no índice especificado em [XmlNamedNodeMap](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/)) | Remove o nó do [XmlNamedNodeMap](./). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/), [String](../../system/string/)) | Remove um nó com os valores correspondentes de [XmlNode::get_LocalName](../xmlnode/get_localname/) e [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SetNamedItem](./setnameditem/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Adiciona um [XmlNode](../xmlnode/) usando seu valor [XmlNode::get_Name](../xmlnode/get_name/). |
