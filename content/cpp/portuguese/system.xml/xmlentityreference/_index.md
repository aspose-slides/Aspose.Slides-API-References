...
description: Representa um nó de referência de entidade.
type: docs
weight: 248
url: /pt/system.xml/xmlentityreference/
---
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Retorna o conjunto de informações de validação pós-esquema que foi atribuído a este nó como resultado da validação do esquema. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Localiza a declaração **xmlns** mais próxima para o prefixo fornecido que está no escopo do nó atual e retorna o URI do namespace na declaração. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Localiza a declaração **xmlns** mais próxima para o URI do namespace fornecido que está no escopo do nó atual e retorna o prefixo definido naquela declaração. |
...
Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro ao passá-lo como argumento para funções.
