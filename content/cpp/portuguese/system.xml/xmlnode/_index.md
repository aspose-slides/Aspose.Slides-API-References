...
description: Representa um único nó no documento XML.
type: docs
weight: 326
url: /pt/system.xml/xmlnode/
---
## XmlNode classe

Representa um nó único no documento XML.
...
| Método | Descrição |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [AppendChild](./appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Adiciona o nó especificado ao final da lista de nós filhos deste nó. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Obtém um iterador apontando imediatamente após o último elemento qualificado como const (se houver) da coleção. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [Clone](./clone/)() | Cria uma duplicata deste nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [CloneNode](./clonenode/)(**bool**) | Cria uma duplicata do nó, quando sobrescrito em uma classe derivada. |
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](./createnavigator/)() override | Cria um XPathNavigator para percorrer este objeto. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Obtém um iterador apontando imediatamente após o último elemento (se houver) da coleção. Este iterador não pode ser usado para alterar um objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) retorna um objeto cópia de T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtém um iterador apontando imediatamente após o último elemento (se houver) da instância da coleção qualificada como const. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttributeCollection](../xmlattributecollection/)\> [get_Attributes](./get_attributes/)() | Retorna um [XmlAttributeCollection](../xmlattributecollection/) contendo os atributos deste nó. |
| virtual [String](../../system/string/) [get_BaseURI](./get_baseuri/)() | Retorna o URI base do nó atual. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [get_ChildNodes](./get_childnodes/)() | Retorna todos os nós filhos do nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_FirstChild](./get_firstchild/)() | Retorna o primeiro filho do nó. |
| virtual **bool** [get_HasChildNodes](./get_haschildnodes/)() | Retorna um valor indicando se este nó possui nós filhos. |
| virtual [String](../../system/string/) [get_InnerText](./get_innertext/)() | Retorna os valores concatenados do nó e de todos os seus nós filhos. |
| virtual [String](../../system/string/) [get_InnerXml](./get_innerxml/)() | Retorna a marcação que representa apenas os nós filhos deste nó. |
| virtual **bool** [get_IsReadOnly](./get_isreadonly/)() | Retorna um valor indicando se o nó é somente leitura. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_LastChild](./get_lastchild/)() | Retorna o último filho do nó. |
| virtual [String](../../system/string/) [get_LocalName](./get_localname/)() | Retorna o nome local do nó, quando sobrescrito em uma classe derivada. |
| virtual [String](../../system/string/) [get_Name](./get_name/)() | Retorna o nome qualificado do nó, quando sobrescrito em uma classe derivada. |
| virtual [String](../../system/string/) [get_NamespaceURI](./get_namespaceuri/)() | Retorna o URI do namespace deste nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_NextSibling](./get_nextsibling/)() | Retorna o nó imediatamente após este nó. |
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() | Retorna o tipo do nó atual, quando sobrescrito em uma classe derivada. |
| virtual [String](../../system/string/) [get_OuterXml](./get_outerxml/)() | Retorna a marcação que contém este nó e todos os seus nós filhos. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](./get_ownerdocument/)() | Retorna o [XmlDocument](../xmldocument/) ao qual este nó pertence. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_ParentNode](./get_parentnode/)() | Retorna o pai deste nó (para nós que podem ter pais). |
| virtual [String](../../system/string/) [get_Prefix](./get_prefix/)() | Retorna o prefixo do namespace deste nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_PreviousSibling](./get_previoussibling/)() | Retorna o nó imediatamente antes deste nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [get_PreviousText](./get_previoustext/)() | Retorna o nó de texto que precede imediatamente este nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() | Retorna o conjunto de informações de validação pós-esquema que foi atribuído a este nó como resultado da validação de esquema. |
| virtual [String](../../system/string/) [get_Value](./get_value/)() | Retorna o valor do nó. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera pelos nós filhos no nó atual. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](./getnamespaceofprefix/)([String](../../system/string/)) | Procura a declaração **xmlns** mais próxima para o prefixo fornecido que está no escopo do nó atual e retorna o URI do namespace na declaração. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](./getprefixofnamespace/)([String](../../system/string/)) | Procura a declaração **xmlns** mais próxima para o URI de namespace fornecido que está no escopo do nó atual e retorna o prefixo definido nessa declaração. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](./idx_get/)([String](../../system/string/)) | Retorna o primeiro elemento filho com o [XmlNode::get_Name](./get_name/) especificado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](./idx_get/)([String](../../system/string/), [String](../../system/string/)) | Retorna o primeiro elemento filho com os valores [XmlNode::get_LocalName](./get_localname/) e [XmlNode::get_NamespaceURI](./get_namespaceuri/) especificados. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [InsertAfter](./insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Insere o nó especificado imediatamente após o nó de referência especificado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [InsertBefore](./insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Insere o nó especificado imediatamente antes do nó de referência especificado. |
...
| virtual void [Normalize](./normalize/)() | Coloca todos os nós [XmlText](../xmltext/) na profundidade total da sub-árvore sob este [XmlNode](./) em uma forma "normal" onde apenas a marcação (ou seja, tags, comentários, instruções de processamento, seções CDATA e referências de entidade) separa os nós [XmlText](../xmltext/), ou seja, não há nós [XmlText](../xmltext/) adjacentes. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [PrependChild](./prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Adiciona o nó especificado ao início da lista de nós filhos deste nó. |
...
| virtual void [RemoveAll](./removeall/)() | Remove todos os nós filhos e/ou atributos do nó atual. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [RemoveChild](./removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Remove o nó filho especificado. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [ReplaceChild](./replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\>) | Substitui o nó filho **oldChild** pelo nó **newChild**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](./selectnodes/)(const [String](../../system/string/)\&) | Seleciona uma lista de nós que correspondem à expressão [XPath](../../system.xml.xpath/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](./selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Seleciona uma lista de nós que correspondem à expressão [XPath](../../system.xml.xpath/). Qualquer prefixo encontrado na expressão [XPath](../../system.xml.xpath/) é resolvido usando o [XmlNamespaceManager](../xmlnamespacemanager/) fornecido. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [SelectSingleNode](./selectsinglenode/)(const [String](../../system/string/)\&) | Seleciona o primeiro [XmlNode](./) que corresponde à expressão [XPath](../../system.xml.xpath/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](./)\> [SelectSingleNode](./selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Seleciona o primeiro [XmlNode](./) que corresponde à expressão [XPath](../../system.xml.xpath/). Qualquer prefixo encontrado na expressão [XPath](../../system.xml.xpath/) é resolvido usando o [XmlNamespaceManager](../xmlnamespacemanager/) fornecido. |
| virtual void [set_InnerText](./set_innertext/)([String](../../system/string/)) | Define os valores concatenados do nó e de todos os seus nós filhos. |
| virtual void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) | Define a marcação que representa apenas os nós filhos deste nó. |
| virtual void [set_Prefix](./set_prefix/)([String](../../system/string/)) | Define o prefixo do namespace deste nó. |
| virtual void [set_Value](./set_value/)([String](../../system/string/)) | Define o valor do nó. |
...
| virtual **bool** [Supports](./supports/)([String](../../system/string/), [String](../../system/string/)) | Testa se a implementação DOM suporta um recurso específico. |
...
| virtual void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Salva todos os nós filhos do nó no [XmlWriter](../xmlwriter/) especificado, quando sobrescrito em uma classe derivada. |
| virtual void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Salva o nó atual no [XmlWriter](../xmlwriter/) especificado, quando sobrescrito em uma classe derivada. |
