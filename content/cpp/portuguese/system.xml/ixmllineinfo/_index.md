...
description: Fornece uma interface que permite a uma classe retornar informações de linha e posição.
type: docs
weight: 40
url: /pt/system.xml/ixmllineinfo/
---
## IXmlLineInfo classe
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Retorna o número da linha atual. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Retorna a posição atual da linha. |
...
| virtual **bool** [HasLineInfo](./haslineinfo/)() | Retorna um valor que indica se a classe pode retornar informações de linha. |
