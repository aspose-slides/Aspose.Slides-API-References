...
description: Resolve recursos XML externos nomeados por um Identificador Uniforme de Recurso (URI).
type: docs
weight: 456
url: /pt/system.xml/xmlresolver/
---
## XmlResolver classe


Resolve recursos XML externos nomeados por um Identificador Uniforme de Recurso (URI).
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetEntity](./getentity/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), const [TypeInfo](../../system/typeinfo/)\&) | Quando sobrescrito em uma classe derivada, mapeia um URI para um objeto que contém o recurso real. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) | Quando sobrescrito em uma classe derivada, resolve o URI absoluto a partir do base e URIs relativos. |
| virtual void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) | Quando sobrescrito em uma classe derivada, define as credenciais usadas para autenticar solicitações web. |
...
| virtual **bool** [SupportsType](./supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | Permite que o resolvedor retorne tipos diferentes de Stream. |
