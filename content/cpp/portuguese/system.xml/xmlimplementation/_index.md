...
description: Define o contexto para um conjunto de objetos XmlDocument.
type: docs
weight: 261
url: /pt/system.xml/xmlimplementation/
---
## XmlImplementation classe

Define o contexto para um conjunto de objetos [XmlDocument](../xmldocument/).
...
| Método | Descrição |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [CreateDocument](./createdocument/)() | Cria um novo [XmlDocument](../xmldocument/). |
...
| **bool** [HasFeature](./hasfeature/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Teste se a implementação do Modelo de Documento [Object](../../system/object/) (DOM) implementa um recurso específico. |
...
|  [XmlImplementation](./xmlimplementation/)() | Inicializa uma nova instância da classe [XmlImplementation](./). |
|  [XmlImplementation](./xmlimplementation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | Inicializa uma nova instância da classe [XmlImplementation](./) com o [XmlNameTable](../xmlnametable/) especificado. |
