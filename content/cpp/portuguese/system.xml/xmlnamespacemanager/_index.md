...
description: Resolve, adiciona e remove namespaces de uma coleção e fornece gerenciamento de escopo para esses namespaces.
type: docs
weight: 300
url: /pt/system.xml/xmlnamespacemanager/
---
...
| Method | Description |
| --- | --- |
| virtual void [AddNamespace](./addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Adiciona o namespace fornecido à coleção. |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](./get_defaultnamespace/)() | Retorna o URI do namespace padrão. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\> [get_NameTable](./get_nametable/)() | Retorna o [XmlNameTable](../xmlnametable/) associado a este objeto. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador para percorrer os namespaces em [XmlNamespaceManager](./). |
...
| virtual **bool** [HasNamespace](./hasnamespace/)([String](../../system/string/)) | Retorna um valor indicando se o prefixo fornecido tem um namespace definido para o escopo empilhado atual. |
...
| [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) override | Retorna o URI do namespace para o prefixo especificado. |
| [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) override | Encontra o prefixo declarado para o URI de namespace fornecido. |
...
| virtual **bool** [PopScope](./popscope/)() | Remove um escopo de namespace da pilha. |
| virtual void [PushScope](./pushscope/)() | Empilha um escopo de namespace na pilha. |
...
| virtual void [RemoveNamespace](./removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Remove o namespace fornecido para o prefixo dado. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Obtém a implementação do iterador const begin para o container atual. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../../system.collections.generic/ienumerable/virtualizebeginiterator/)() | Obtém a implementação do iterador begin para o container atual. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Obtém a implementação do iterador const end para o container atual. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../../system.collections.generic/ienumerable/virtualizeenditerator/)() | Obtém a implementação do iterador end para o container atual. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa o contador de referência fraca. Não deve ser chamado diretamente; use ponteiros inteligentes ou ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa o contador de referência fraca. Não deve ser chamado diretamente; use ponteiros inteligentes ou ThisProtector. |
|  [XmlNamespaceManager](./xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | Inicializa uma nova instância da classe [XmlNamespaceManager](./) com o [XmlNameTable](../xmlnametable/) especificado. |
