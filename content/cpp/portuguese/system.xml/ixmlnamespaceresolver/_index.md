...
description: Fornece acesso somente leitura a um conjunto de mapeamentos de prefixo e namespace.
type: docs
weight: 53
url: /pt/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver classe
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógico ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Habilita o hash de objetos personalizados. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](./getnamespacesinscope/)([XmlNamespaceScope](../xmlnamespacescope/)) | Retorna uma coleção de mapeamentos de prefixo-namespace definidos que estão atualmente em escopo. |
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | Retorna o URI do namespace mapeado para o prefixo especificado. |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | Retorna o prefixo que está mapeado para o URI de namespace especificado. |
