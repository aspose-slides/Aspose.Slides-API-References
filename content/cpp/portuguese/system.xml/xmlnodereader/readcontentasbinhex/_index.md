...
type: docs
weight: 456
url: /pt/system.xml/xmlnodereader/readcontentasbinhex/
---
...
| --- | --- | --- |
| buffer | [ArrayPtr](../../../system/arrayptr/)\<**uint8_t**\> | O buffer para o qual copiar o texto resultante. Este valor não pode ser **nullptr**. |
| index | **int32_t** | O deslocamento dentro do buffer onde começar a copiar o resultado. |
