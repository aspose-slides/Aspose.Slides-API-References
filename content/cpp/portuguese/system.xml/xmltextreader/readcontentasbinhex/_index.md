...
description: Lê o conteúdo e retorna os bytes binários decodificados BinHex.
type: docs
weight: 664
url: /pt/system.xml/xmltextreader/readcontentasbinhex/
---
## XmlTextReader::ReadContentAsBinHex(ArrayPtr\<uint8_t\>, int32_t, int32_t) método
