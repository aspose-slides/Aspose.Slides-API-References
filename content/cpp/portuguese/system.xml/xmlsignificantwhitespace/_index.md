...
description: "Representa espaço em branco entre marcações em um nó de conteúdo misto ou espaço em branco dentro de um escopo xml:space='preserve'. Também é referido como espaço em branco significativo."
type: docs
weight: 482
url: /pt/system.xml/xmlsignificantwhitespace/
---
## XmlSignificantWhitespace classe

Representa espaço em branco entre marcações em um nó de conteúdo misto ou espaço em branco dentro de um escopo **xml:space='preserve'**. Também é referido como espaço em branco significativo.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Cria um duplicado deste nó. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Cria um duplicado deste nó. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Retorna o infoset de validação de esquema posterior que foi atribuído a este nó como resultado da validação de esquema. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hashing de objetos customizados. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Análogo ao método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonar tipos customizados. |
| virtual void [Normalize](../xmlnode/normalize/)() | Coloca todos os nós [XmlText](../xmltext/) na profundidade total da sub-árvore sob este [XmlNode](../xmlnode/) em uma forma "normal" onde apenas marcações (ou seja, tags, comentários, instruções de processamento, seções CDATA e referências de entidade) separam nós [XmlText](../xmltext/), ou seja, não há nós [XmlText](../xmltext/) adjacentes. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Substitui o número especificado de caracteres começando no deslocamento especificado pela string especificada. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Recupera uma subcadeia da string completa a partir do intervalo especificado. |
