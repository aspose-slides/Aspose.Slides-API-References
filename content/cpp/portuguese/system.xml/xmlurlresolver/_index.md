...
description: Resolve recursos XML externos nomeados por um Identificador Uniforme de Recursos (URI).
type: docs
weight: 534
url: /pt/system.xml/xmlurlresolver/
---
...
| [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) override | Resolve o URI absoluto a partir dos URIs base e relativo. |
| void [set_CachePolicy](./set_cachepolicy/)(const [SharedPtr](../../system/sharedptr/)\<[Net::Cache::RequestCachePolicy](../../system.net.cache/requestcachepolicy/)\>\&) | Define a política de cache para o objeto WebRequest subjacente. |
| void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) override | Define credenciais usadas para autenticar solicitações web. |
| void [set_Proxy](./set_proxy/)(const [SharedPtr](../../system/sharedptr/)\<[Net::IWebProxy](../../system.net/iwebproxy/)\>\&) | Define o proxy de rede para o objeto WebRequest subjacente. |
...
|  [XmlUrlResolver](./xmlurlresolver/)() | Inicializa uma nova instância da classe [XmlUrlResolver](./). |
