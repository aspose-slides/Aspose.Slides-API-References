...
description: Representa um atributo. Valores válidos e padrão para o atributo são definidos em uma definição de tipo de documento (DTD) ou esquema.
type: docs
weight: 79
url: /pt/system.xml/xmlattribute/
---
## XmlAttribute classe
...
| Method | Description |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](./appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Adiciona o nó especificado ao final da lista de nós filhos deste nó. |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Retorna o Uniform Resource Identifier (URI) base do nó. |
...
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Retorna um valor que indica se este nó tem algum nó filho. |
...
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | Retorna um valor que indica se o nó é somente leitura. |
...
| [String](../../system/string/) [get_NamespaceURI](./get_namespaceuri/)() override | Retorna o URI do namespace deste nó. |
...
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Retorna a marcação que contém este nó e todos os seus nós filhos. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [get_OwnerElement](./get_ownerelement/)() | Retorna o [XmlElement](../xmlelement/) ao qual o atributo pertence. |
...
| [String](../../system/string/) [get_Prefix](./get_prefix/)() override | Retorna o prefixo do namespace deste nó. |
...
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | Retorna o post-schema-validation-infoset que foi atribuído a este nó como resultado da validação de esquema. |
| virtual **bool** [get_Specified](./get_specified/)() | Retorna um valor que indica se o valor do atributo foi definido explicitamente. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](./insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Insere o nó especificado imediatamente após o nó de referência especificado. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](./insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Insere o nó especificado imediatamente antes do nó de referência especificado. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](./prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Adiciona o nó especificado ao início da lista de nós filhos deste nó. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](./removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Remove o nó filho especificado. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](./replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Substitui o nó filho especificado pelo novo nó filho especificado. |
...
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Define o valor do atributo. |
| void [set_Prefix](./set_prefix/)([String](../../system/string/)) override | Define o prefixo do namespace deste nó. |
