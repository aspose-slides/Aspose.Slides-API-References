...
description: Representa um resolvedor de fluxo de recurso de aplicativo.
type: docs
weight: 14
url: /pt/system.xml/iapplicationresourcestreamresolver/
---
## IApplicationResourceStreamResolver classe


Representa um resolvedor de fluxo de recurso de aplicativo.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetApplicationResourceStream](./getapplicationresourcestream/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Retorna um fluxo de recurso de aplicativo a partir do URI especificado. |
