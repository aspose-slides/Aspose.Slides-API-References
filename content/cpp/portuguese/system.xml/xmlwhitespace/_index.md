...
description: Representa espaço em branco no conteúdo do elemento.
type: docs
weight: 560
url: /pt/system.xml/xmlwhitespace/
---
## XmlWhitespace classe

Representa espaço em branco no conteúdo do elemento.
...
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Anexa a string especificada ao final dos dados de caracteres do nó. |
...
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](../xmlnode/createnavigator/)() override | Cria um XPathNavigator para percorrer este objeto. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtém iterador apontando imediatamente após o último elemento (se houver) da instância da coleção qualificada como const. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](./get_previoustext/)() override | Retorna o nó de texto que precede imediatamente este nó. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Retorna o infoset de pós-validação de esquema que foi atribuído a este nó como resultado da validação de esquema. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Procura a declaração **xmlns** mais próxima para o prefixo fornecido que está em escopo para o nó atual e retorna o URI do namespace na declaração. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Procura a declaração **xmlns** mais próxima para o URI de namespace fornecido que está em escopo para o nó atual e retorna o prefixo definido nessa declaração. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Retorna o primeiro elemento filho com os valores especificados [XmlNode::get_LocalName](../xmlnode/get_localname/) e [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/). |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Insere a string especificada no deslocamento de caracteres especificado. |
...
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Define os valores concatenados do nó e de todos os seus filhos. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Recupera uma substring da string completa dentro do intervalo especificado. |
