...
| virtual int [get_CodePage](../encoding/get_codepage/)() | Obtém o ID da codepage [Windows](../../system.windows/). |
...
| virtual **bool** [get_IsSingleByte](../encoding/get_issinglebyte/)() | Verifica se a codificação é de um único byte. |
...
| static [EncodingPtr](../../system/encodingptr/) [get_UTF8Unmarked](../encoding/get_utf8unmarked/)() | Somente interno, para ser usado pelas bibliotecas de classes: não marcado e sem validação de entrada. |
| virtual [String](../../system/string/) [get_WebName](../encoding/get_webname/)() | Obtém o nome da codificação compatível com IANA. |
| virtual int [get_WindowsCodePage](../encoding/get_windowscodepage/)() | Obtém o ID da codepage [Windows](../../system.windows/). |
...
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(int) | Obtém a codificação por codepage. |
| static [EncodingPtr](../../system/encodingptr/) [GetEncoding](../encoding/getencoding/)(int, const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&, const [DecoderFallbackPtr](../../system/decoderfallbackptr/)\&) | Obtém a codificação por codepage. |
...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetPreamble](./getpreamble/)() override | Retorna uma sequência de bytes que denota a codificação (ex.: BOM). |
...
|  [ICUEncoding](./icuencoding/)(const Details::EncodingInfoInternal *) | Construtor. |
...
| **bool** [operator==](./operator_equal_equal/)(const [ICUEncoding](./)\&) const | Compara codificações usando codepages. |
...
| Field | Description |
| --- | --- |
| static constexpr [DEFAULT_CODE_PAGE](../encoding/default_code_page/) | Valor padrão da codepage. |
