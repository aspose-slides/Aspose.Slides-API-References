...
| Método | Descrição |
| --- | --- |
| virtual [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() | Obtém o buffer associado ao algoritmo de fallback. |
...
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](./get_exceptionfallback/)() | Obtém a implementação padrão de fallback de exceção. |
| virtual int [get_MaxCharCount](./get_maxcharcount/)() const | Obtém o número máximo de caracteres que podem ser retornados pelo fallback. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](./get_replacementfallback/)() | Obtém a implementação padrão de fallback de substituição. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](./get_standardsafefallback/)() | Obtém a implementação padrão de fallback seguro padrão. |
