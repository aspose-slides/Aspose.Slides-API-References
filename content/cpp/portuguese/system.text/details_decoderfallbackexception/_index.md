...
description: "Exceção lançada por DecoderExceptionFallback quando a decodificação falha. Nunca crie instâncias desta classe manualmente. Use a classe DecoderFallbackException. Nunca encapsule instâncias da classe DecoderFallbackException em System::SmartPtr."
type: docs
weight: 105
url: /pt/system.text/details_decoderfallbackexception/
---
## Details_DecoderFallbackException classe


Exceção lançada por [DecoderExceptionFallback](../decoderexceptionfallback/) quando a decodificação falha. Nunca crie instâncias desta classe manualmente. Use a classe DecoderFallbackException. Nunca encapsule instâncias da classe DecoderFallbackException em [System::SmartPtr](../../system/smartptr/).
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | Obtém o array de bytes que provocou o erro. |
...
| int [get_Index](./get_index/)() | Obtém a posição do byte que provocou o erro no array de entrada. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Obtém o tipo real do objeto. Análogo da chamada C# [System.Object.GetType()](../../system/object/gettype/). |
