...
| Método | Descrição |
| --- | --- |
| [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Cria um buffer de fallback. |
|  [EncoderExceptionFallback](./encoderexceptionfallback/)() | Construtor. |
...
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ExceptionFallback](../encoderfallback/get_exceptionfallback/)() | Obtém a implementação padrão de fallback de exceção. |
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Obtém o número máximo de caracteres que a instância pode retornar. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_ReplacementFallback](../encoderfallback/get_replacementfallback/)() | Obtém a implementação padrão de fallback de substituição. |
| static const [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_StandardSafeFallback](../encoderfallback/get_standardsafefallback/)() | Obtém a implementação padrão de fallback seguro padrão. |
