...
| Método | Descrição |
| --- | --- |
|  [ASCIIEncoding](./asciiencoding/)() | Construtor. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](../encoding/clone/)() | Clona objeto de codificação. |
...
| static [EncodingPtr](../../system/encodingptr/) [get_ASCII](../encoding/get_ascii/)() | Obtém codificação ASCII. |
...
| virtual int [get_CodePage](../encoding/get_codepage/)() | Obtém o ID de página de código [Windows](../../system.windows/). |
...
| virtual [String](../../system/string/) [get_EncodingName](../encoding/get_encodingname/)() | Obtém o nome legível da codificação. |
...
| static [EncodingPtr](../../system/encodingptr/) [get_Latin1](../encoding/get_latin1/)() | Obtém codificação Latin1. PARA USO INTERNO. |
...
| virtual int [get_WindowsCodePage](../encoding/get_windowscodepage/)() | Obtém o ID de página de código [Windows](../../system.windows/). |
...
| static [ArrayPtr](../../system/arrayptr/)\<[EncodingInfoPtr](../../system/encodinginfoptr/)\> [GetEncodings](../encoding/getencodings/)() | Obtém lista de codificações conhecidas. |
| int [GetHashCode](../encoding/gethashcode/)() const override | Gera hash da codificação. |
| int [GetMaxByteCount](./getmaxbytecount/)(int) override | Obtém a contagem máxima de bytes possível para armazenar uma string de contagem de caracteres conhecida. |
...
| static constexpr [DEFAULT_CODE_PAGE](../encoding/default_code_page/) | Valor padrão de página de código. |
