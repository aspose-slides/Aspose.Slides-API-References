...
description: Buffer para substituir a estratégia de fallback de decodificação.
type: docs
weight: 92
url: /pt/system.text/decoderreplacementfallbackbuffer/
---
## DecoderReplacementFallbackBuffer classe

[Buffer](../../system/buffer/) para substituir a estratégia de fallback de decodificação.
...
| Método | Descrição |
| --- | --- |
|  [DecoderReplacementFallbackBuffer](./decoderreplacementfallbackbuffer/)(const [DecoderReplacementFallbackPtr](../../system/decoderreplacementfallbackptr/)\&) | Construtor. |
...
| void [Reset](./reset/)() override | Redefine o buffer ao estado inicial (antes da chamada [Fallback()](./fallback/)). |
