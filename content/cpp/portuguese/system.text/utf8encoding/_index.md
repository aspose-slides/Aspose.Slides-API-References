...
description: "Codificação UTF-8. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 378
url: /pt/system.text/utf8encoding/
---
## Classe UTF8Encoding

Codificação UTF-8. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| virtual [String](../../system/string/) [get_BodyName](../encoding/get_bodyname/)() | Obtém o nome de codificação compatível com o corpo do agente de correio. |
...
| virtual [String](../../system/string/) [get_HeaderName](../encoding/get_headername/)() | Obtém o nome de codificação compatível com o cabeçalho do agente de correio. |
...
| virtual **bool** [get_IsMailNewsDisplay](../encoding/get_ismailnewsdisplay/)() | Verifica se a codificação pode ser usada no cliente de correio para exibir conteúdo. |
| virtual **bool** [get_IsMailNewsSave](../encoding/get_ismailnewssave/)() | Verifica se a codificação pode ser usada no cliente de correio para salvar conteúdo. |
...
| static [EncodingPtr](../../system/encodingptr/) [get_UTF8Unmarked](../encoding/get_utf8unmarked/)() | Somente interno, para uso pelas bibliotecas de classes: Não marcado e sem validação de entrada. |
...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetPreamble](./getpreamble/)() override | Obtém o preambulo da pagina de codigo. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Analog da chamada C# [System.Object.GetType()](../../system/object/gettype/). |
|  [ICUEncoding](../icuencoding/icuencoding/)(const Details::EncodingInfoInternal *) | Construtor. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica se o objeto representa uma instância do tipo descrito por targetType. Analog do operador C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementa o bloqueio da instrução C# lock(). Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog do método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonar tipos customizados. |
...
| **bool** [operator==](./operator_equal_equal/)(const [UTF8Encoding](./)\&) const | Compara os parâmetros das codificações. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analog do método C# [Object.ToString()](../../system/object/tostring/). Permite converter objetos customizados para string. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementa a construção C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | Implementa o desbloqueio da instrução C# lock(). Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
|  [UTF8Encoding](./utf8encoding/)() | Construtor. |
|  [UTF8Encoding](./utf8encoding/)(**bool**) | Construtor. |
|  [UTF8Encoding](./utf8encoding/)(**bool**, **bool**) | Construtor. |
...
| static constexpr [UTF8_CODE_PAGE](./utf8_code_page/) | Informação RTTI. |
