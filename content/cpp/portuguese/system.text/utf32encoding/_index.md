...
description: "Codificação UTF-32. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 352
url: /pt/system.text/utf32encoding/
---
## UTF32Encoding classe

Codificação UTF-32. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| static [EncodingPtr](../../system/encodingptr/) [get_Latin1](../encoding/get_latin1/)() | Obtém a codificação Latin1. USO INTERNO. |
...
| static [EncodingPtr](../../system/encodingptr/) [get_UTF8Unmarked](../encoding/get_utf8unmarked/)() | Apenas interno, para uso pelas bibliotecas de classes: não marcado e sem validação de entrada. |
...
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [GetPreamble](./getpreamble/)() override | Obtém o preâmbulo da página de código. |
...
| **bool** [operator==](./operator_equal_equal/)(const [UTF32Encoding](./)\&) const | Compara os parâmetros das codificações. |
...
|  [UTF32Encoding](./utf32encoding/)() | Construtor. |
|  [UTF32Encoding](./utf32encoding/)(**bool**, **bool**) | Construtor. |
|  [UTF32Encoding](./utf32encoding/)(**bool**, **bool**, **bool**) | Construtor. |
...
| Field | Description |
| --- | --- |
| static constexpr [BIG_UTF32_CODE_PAGE](./big_utf32_code_page/) | Número mágico usado por [Windows](../../system.windows/) para o ID da página de código UTF-32 big-endian. |
| static constexpr [DEFAULT_CODE_PAGE](../encoding/default_code_page/) | Valor padrão da página de código. |
| static constexpr [UTF32_CODE_PAGE](./utf32_code_page/) | Número mágico usado por [Windows](../../system.windows/) para o ID da página de código UTF-32 little-endian. |
