...
description: IEnumerable é a interface base para todas as coleções não genéricas que podem ser enumeradas.
type: docs
weight: 53
url: /pt/system.collections/ienumerable/
---
## IEnumerable classe
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | Retorna um enumerador que itera através de uma coleção. |
