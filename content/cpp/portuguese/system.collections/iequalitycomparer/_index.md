...
type: docs
weight: 105
url: /pt/system.collections/iequalitycomparer/
---
...
| Método | Descrição |
| --- | --- |
| virtual **bool** [Equals](./equals/)(const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) const | Verifica se dois objetos são iguais. |
...
| virtual int [GetHashCode](./gethashcode/)(const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) const | Obtém o código hash para algum objeto. |
...
|  [RTTI_INFO_TEMPLATE_CLASS](./rtti_info_template_class/)([System::Collections::IEqualityComparer](./), System::BaseTypesInfo\<[System::Object](../../system/object/)\>) | informação RTTI. |
