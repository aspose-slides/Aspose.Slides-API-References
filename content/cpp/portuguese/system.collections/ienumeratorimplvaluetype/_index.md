...
description: Wrapper que cria implementação não genérica de IEnumerator sobre o Iterator genérico IEnumeratorImplRefType - wrapper para os tipos de valor.
type: docs
weight: 92
url: /pt/system.collections/ienumeratorimplvaluetype/
---
## IEnumeratorImplValueType classe


Wrapper que cria implementação não genérica [IEnumerator](../ienumerator/) sobre o iterador genérico [IEnumeratorImplRefType](../ienumeratorimplreftype/) - wrapper para os tipos de valor.
...
|  [IEnumeratorImplValueType](./ienumeratorimplvaluetype/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\>) | construtor wrapper |
