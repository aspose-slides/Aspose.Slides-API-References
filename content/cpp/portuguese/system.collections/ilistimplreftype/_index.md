...
description: "Stub que implementa a interface System::Collections::IList no objeto System::Collections::Generic::List implementação para tipos de referência."
type: docs
weight: 131
url: /pt/system.collections/ilistimplreftype/
---
## IListImplRefType classe


Stub que implementa a interface [System::Collections::IList](../ilist/) no objeto [System::Collections::Generic::List](../../system.collections.generic/list/) Implementação para tipos de referência.
...
| static [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [BoxValue](./boxvalue/)([System::SharedPtr](../../system/sharedptr/)\<T\>) | Converte referência de tipo em valor de objeto. |
...
| int [get_Count](./get_count/)() const override | Implementação dos métodos [ICollection.get_Count()](../icollection/get_count/) Obtém o número de elementos na coleção. |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() override | Implementação [IEnumerable.GetEnumerator()](../ienumerable/getenumerator/) Retorna um enumerador que itera sobre uma coleção. |
...
|  [IListImplRefType](./ilistimplreftype/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::List](../../system.collections.generic/list/)\<[System::SharedPtr](../../system/sharedptr/)\<T\>\>\>) | Cria nova instância de objeto. |
...
| void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Remove a primeira ocorrência de um item específico da lista. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<T\> [UnboxValue](./unboxvalue/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Convertendo valor de objeto em referência de tipo particular. |
