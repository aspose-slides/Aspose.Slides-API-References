...
description: "Representa uma matriz de objetos EncoderParameter. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 79
url: /pt/system.drawing.imaging/encoderparameters/
---
## EncoderParameters classe


Representa uma matriz de objetos [EncoderParameter](../encoderparameter/). Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| Method | Description |
| --- | --- |
|  [EncoderParameters](./encoderparameters/)(int) | Constrói uma nova instância do [EncoderParameters](./) classe. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\> [get_Param](./get_param/)() const | Retorna uma matriz de objetos [EncoderParameter](../encoderparameter/) representados pelo objeto [EncoderParameters](./) atual. |
...
| void [set_Param](./set_param/)(const [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\>\&) | Atribui uma matriz de objetos [EncoderParameter](../encoderparameter/) ao objeto [EncoderParameters](./) atual. |
