...
| [Guid](../../system/guid/) [get_FormatID](./get_formatid/)() const | Retorna um GUID associado ao formato do codec representado pelo objeto atual. |
| [System::String](../../system/string/) [get_MimeType](./get_mimetype/)() | Retorna o tipo Multipurpose Internet Mail Extensions (MIME) do codec representado pelo objeto atual. |
...
| static [System::ArrayPtr](../../system/arrayptr/)\<[ImageCodecInfoPtr](../imagecodecinfoptr/)\> [GetImageDecoders](./getimagedecoders/)() | Retorna uma matriz de objetos [ImageCodecInfo](./) que representam decodificadores de imagem suportados. |
| static [System::ArrayPtr](../../system/arrayptr/)\<[ImageCodecInfoPtr](../imagecodecinfoptr/)\> [GetImageEncoders](./getimageencoders/)() | Retorna uma matriz de objetos [ImageCodecInfo](./) que representam codificadores de imagem suportados. |
...
| void [set_FormatID](./set_formatid/)(const [Guid](../../system/guid/)\&) | Define um GUID associado ao formato do codec representado pelo objeto atual. |
