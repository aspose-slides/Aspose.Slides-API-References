...
| [Rectangle](../../system.drawing/rectangle/) [get_Bounds](./get_bounds/)() const | Retorna um retângulo delimitador de um metafile associado ao objeto atual. |
| **float** [get_DpiX](./get_dpix/)() const | NÃO IMPLEMENTADO. |
| **float** [get_DpiY](./get_dpiy/)() const | NÃO IMPLEMENTADO. |
...
| void [set_Bounds](./set_bounds/)(const [Rectangle](../../system.drawing/rectangle/)\&) | Define um retângulo delimitador de um metafile associado ao objeto atual. |
