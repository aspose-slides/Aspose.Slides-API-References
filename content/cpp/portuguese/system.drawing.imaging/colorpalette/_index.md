...
| [System::ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\> [get_Entries](./get_entries/)() const | Retorna um array de objetos [Color](../../system.drawing/color/) representados pelo objeto atual. |
| int [get_Flags](./get_flags/)() const | Retorna um valor que especifica como os valores de cor no array de cores devem ser interpretados. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analógico do método [Object.ToString()](../../system/object/tostring/) do C#. Permite converter objetos personalizados em string. |
