...
description: "Representa uma propriedade de metadados a ser incluída em um arquivo de imagem. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 170
url: /pt/system.drawing.imaging/propertyitem/
---
## classe PropertyItem

Representa uma propriedade de metadados a ser incluída em um arquivo de imagem. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| **int32_t** [get_Id](./get_id/)() const | Retorna o ID da propriedade representada pelo objeto atual. |
| **int32_t** [get_Len](./get_len/)() const | Retorna o comprimento da propriedade representada pelo objeto atual em bytes. |
| **int16_t** [get_Type](./get_type/)() const | Retorna o tipo da propriedade representada pelo objeto atual em bytes. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Value](./get_value/)() const | Retorna o valor da propriedade representada pelo objeto atual em bytes. |
...
| void [Lock](../../system/object/lock/)() | Implementa o bloqueio da declaração C# lock(). Chame diretamente ou use o objeto sentry [LockContext](../../system/lockcontext/). |
...
|  [PropertyItem](./propertyitem/)() | Constrói uma nova instância da classe [PropertyItem](./). |
...
| void [set_Id](./set_id/)(**int32_t**) | Define o ID da propriedade representada pelo objeto atual. |
| void [set_Len](./set_len/)(**int32_t**) | Define o comprimento da propriedade representada pelo objeto atual em bytes. |
| void [set_Type](./set_type/)(**int16_t**) | Define o tipo da propriedade representada pelo objeto atual em bytes. |
| void [set_Value](./set_value/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Define o tipo da propriedade representada pelo objeto atual em bytes. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa o desbloqueio da declaração C# lock(). Chame diretamente ou use o objeto sentry [LockContext](../../system/lockcontext/). |
