...
description: "Representa um GUID que está associado a um conjunto de parâmetros de codificador de imagem. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 53
url: /pt/system.drawing.imaging/encoder/
---
## Classe Encoder

Representa um GUID que está associado a um conjunto de parâmetros de codificador de imagem. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| Método | Descrição |
| --- | --- |
|  [Encoder](./encoder/)(const [Guid](../../system/guid/)\&) | Constrói uma nova instância da classe [Encoder](./). |
...
| [Guid](../../system/guid/) [get_Guid](./get_guid/)() const | Retorna um GUID que especifica um conjunto de parâmetros de codificador de imagem que o objeto atual representa. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análoga ao método [Object.GetHashCode()](../../system/object/gethashcode/) do C#. Habilita hash de objetos personalizados. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Análoga ao método [Object.MemberwiseClone()](../../system/object/memberwiseclone/) do C#. Habilita clonagem de tipos personalizados. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Análoga ao método [Object.ToString()](../../system/object/tostring/) do C#. Habilita a conversão de objetos personalizados para string. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Implementa o construto typeof([System.Object](../../system/object/)) do C#. |
...
| Campo | Descrição |
| --- | --- |
| static [ChrominanceTable](./chrominancetable/) | Uma instância da classe [Encoder](./) que representa a categoria de parâmetro da tabela de crominância. |
| static [ColorDepth](./colordepth/) | Uma instância da classe [Encoder](./) que representa a categoria de parâmetro de profundidade de cor. |
| static [Compression](./compression/) | Uma instância da classe [Encoder](./) que representa a categoria de parâmetro de compressão. |
| static [LuminanceTable](./luminancetable/) | Uma instância da classe [Encoder](./) que representa a categoria de parâmetro da tabela de luminância. |
| static [Quality](./quality/) | Uma instância da classe [Encoder](./) que representa a categoria de parâmetro de qualidade. |
| static [RenderMethod](./rendermethod/) | Uma instância da classe [Encoder](./) que representa a categoria de parâmetro do método de renderização. |
| static [SaveFlag](./saveflag/) | Uma instância da classe [Encoder](./) que representa a categoria de parâmetro da bandeira de salvamento. |
| static [ScanMethod](./scanmethod/) | Uma instância da classe [Encoder](./) que representa a categoria de parâmetro do método de varredura. |
| static [Transformation](./transformation/) | Uma instância da classe [Encoder](./) que representa a categoria de parâmetro de transformação. |
| static [Version](./version/) | Uma instância da classe [Encoder](./) que representa a categoria de parâmetro de versão. |

## Veja Também

* Classe [Object](../../system/object/)
* Espaço de nomes [System::Drawing::Imaging](../)
