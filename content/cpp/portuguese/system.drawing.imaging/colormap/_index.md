...
description: "Representa um mapa para conversão de cores. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando operator new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 14
url: /pt/system.drawing.imaging/colormap/
---
## ColorMap classe

Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compara objetos de tipo referência em estilo C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compara objetos de tipo valor em estilo C#. |
...
| [Color](../../system.drawing/color/) [get_NewColor](./get_newcolor/)() const | Retorna o novo objeto [Color](../../system.drawing/color/) que representa a cor para a qual converter. |
| [Color](../../system.drawing/color/) [get_OldColor](./get_oldcolor/)() const | Retorna o antigo objeto [Color](../../system.drawing/color/) que representa a cor a ser convertida. |
...
| void [set_NewColor](./set_newcolor/)(const [Color](../../system.drawing/color/)\&) | Define o novo objeto [Color](../../system.drawing/color/) que representa a cor para a qual converter. |
| void [set_OldColor](./set_oldcolor/)(const [Color](../../system.drawing/color/)\&) | Define o antigo objeto [Color](../../system.drawing/color/) que representa a cor a ser convertida. |
