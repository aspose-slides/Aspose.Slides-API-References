...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](./equals/)([FrameDimensionPtr](../framedimensionptr/)) | Determina se o objeto [FrameDimension](./) especificado é equivalente ao objeto atual. |
...
|  [FrameDimension](./framedimension/)(const [System::Guid](../../system/guid/)\&) | Constrói um novo objeto [FrameDimension](./) e o inicializa com o GUID especificado. |
| [System::Guid](../../system/guid/) [get_Guid](./get_guid/)() const | Retorna o GUID associado ao objeto atual. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Page](./get_page/)() | Retorna a dimensão da página. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Resolution](./get_resolution/)() | Retorna a dimensão da resolução. |
| static [FrameDimensionPtr](../framedimensionptr/) [get_Time](./get_time/)() | Retorna a dimensão do tempo. |
