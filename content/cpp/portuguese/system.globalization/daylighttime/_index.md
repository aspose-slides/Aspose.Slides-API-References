...
| Método | Descrição |
| --- | --- |
|  [DaylightTime](./daylighttime/)([DateTime](../../system/datetime/), [DateTime](../../system/datetime/), [TimeSpan](../../system/timespan/)) | informação RTTI. |
...
| [TimeSpan](../../system/timespan/) [get_Delta](./get_delta/)() const | Obtém a diferença entre o horário padrão e o horário de verão. |
| [DateTime](../../system/datetime/) [get_End](./get_end/)() const | Obtém a data e hora em que o horário de verão termina. |
| [DateTime](../../system/datetime/) [get_Start](./get_start/)() const | Obtém a data e hora em que o horário de verão começa. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrementa o contador de referência compartilhado. Não deve ser chamado diretamente; ao invés, use ponteiros inteligentes ou ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementa e retorna o contador de referência compartilhado. Não deve ser chamado diretamente; ao invés, use ponteiros inteligentes ou ThisProtector. |
