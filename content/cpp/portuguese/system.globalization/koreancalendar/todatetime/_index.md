...
description: Constrói objeto DateTime a partir de componentes.
type: docs
weight: 235
url: /pt/system.globalization/koreancalendar/todatetime/
---
## KoreanCalendar::ToDateTime(int, int, int, int, int, int, int, int) const método


Constrói o objeto [DateTime](../../../system/datetime/) a partir de componentes.
...
| minute | int | Minuto. |
| second | int | Segundo. |
| millisecond | int | Milissegundo. |
| era | int | Era. |

### Valor de Retorno

[DateTime](../../../system/datetime/) objeto que tem os componentes especificados.

## KoreanCalendar::ToDateTime(int, int, int, int, int, int, int) const método
