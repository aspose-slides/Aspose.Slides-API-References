...
|  [ChineseLunisolarCalendar](./chineselunisolarcalendar/)() | Construtor padrão. |
...
| virtual [DateTime](../../system/datetime/) [ToDateTime](../calendar/todatetime/)(int, int, int, int, int, int, int) const | Constrói o objeto [DateTime](../../system/datetime/) a partir dos componentes. |
| virtual [DateTime](../../system/datetime/) [ToDateTime](../calendar/todatetime/)(int, int, int, int, int, int, int, int) const | Constrói o objeto [DateTime](../../system/datetime/) a partir dos componentes. |
| virtual int [ToFourDigitYear](../calendar/tofourdigityear/)(int) const | Converte o ano para ano de 4 dígitos usando a propriedade TwoDigitYearMax. |
...
| Campo | Descrição |
| --- | --- |
| static constexpr [ChineseEra](./chineseera/) | Era chinesa atual. |
