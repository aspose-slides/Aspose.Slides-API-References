...
|  [JapaneseLunisolarCalendar](./japaneselunisolarcalendar/)() | Construtor. |
| void [Lock](../../system/object/lock/)() | Implementa o bloqueio da instrução C# lock(). Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogia do método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonagem de tipos personalizados. |
...
| virtual [DateTime](../../system/datetime/) [ToDateTime](../calendar/todatetime/)(int, int, int, int, int, int, int) const | Constrói [DateTime](../../system/datetime/) objeto a partir de componentes. |
| virtual [DateTime](../../system/datetime/) [ToDateTime](../calendar/todatetime/)(int, int, int, int, int, int, int, int) const | Constrói [DateTime](../../system/datetime/) objeto a partir de componentes. |
...
| Field | Description |
| --- | --- |
| static constexpr [JapaneseEra](./japaneseera/) | Era japonesa atual. |
