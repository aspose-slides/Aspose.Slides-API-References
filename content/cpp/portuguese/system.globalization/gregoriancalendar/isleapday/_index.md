...
type: docs
weight: 248
url: /pt/system.globalization/gregoriancalendar/isleapday/
---
## GregorianCalendar::IsLeapDay(int, int, int, int) const método
...
True se a data especificada for bissexto, false caso contrário.

## GregorianCalendar::IsLeapDay(int, int, int) const método
