...
description: "CultureNotFoundException é lançada quando uma tentativa é feita para construir uma cultura que não está disponível. Nunca crie instâncias desta classe manualmente. Use a classe CultureNotFoundException em vez disso. Nunca envolva as instâncias da classe CultureNotFoundException em System::SmartPtr."
type: docs
weight: 92
url: /pt/system.globalization/details_culturenotfoundexception/
---
## Details_CultureNotFoundException classe


CultureNotFoundException é lançada quando uma tentativa é feita para construir uma cultura que não está disponível. Nunca crie instâncias desta classe manualmente. Use a classe CultureNotFoundException em vez disso. Nunca envolva as instâncias da classe CultureNotFoundException em [System::SmartPtr](../../system/smartptr/).
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Obtém o tipo real do objeto. Analoga à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
