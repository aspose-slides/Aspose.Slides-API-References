...
| int [GetDaysInMonth](./getdaysinmonth/)(int, int, int) const override | Obtém o número de dias no mês especificado. |
| virtual int [GetDaysInMonth](../calendar/getdaysinmonth/)(int, int) const | Obtém o número de dias no mês especificado. |
| virtual int [GetDaysInYear](../calendar/getdaysinyear/)(int) const | Obtém o número de dias no ano especificado. |
| virtual int [GetDaysInYear](../calendar/getdaysinyear/)(int, int) const | Obtém o número de dias no ano especificado. |
...
|  [HebrewCalendar](./hebrewcalendar/)() | Construtor. |
...
| [DateTime](../../system/datetime/) [ToDateTime](./todatetime/)(int, int, int, int, int, int, int, int) const override | Constrói o objeto [DateTime](../../system/datetime/) a partir de componentes. |
...
| virtual int [ToFourDigitYear](../calendar/tofourdigityear/)(int) const | Converte o ano para um ano de quatro dígitos usando a propriedade TwoDigitYearMax. |
...
| Field | Description |
| --- | --- |
| static constexpr [HebrewEra](./hebrewera/) | Era hebraica atual. |
