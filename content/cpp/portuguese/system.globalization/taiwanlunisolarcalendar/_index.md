...
description: "Calendário lunissolar de Taiwan. Não implementado. Objetos desta classe devem ser alocados somente usando a função System::MakeObject() . Nunca crie uma instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use este ponteiro para passá-lo a funções como argumento."
type: docs
weight: 339
url: /pt/system.globalization/taiwanlunisolarcalendar/
---
...
| [CalendarAlgorithmType](../calendaralgorithmtype/) [get_AlgorithmType](../eastasianlunisolarcalendar/get_algorithmtype/)() const override | Informação RTTI. |
...
| virtual int [get_TwoDigitYearMax](../calendar/get_twodigityearmax/)() const | Obtém o último ano que pode ser representado por 2 dígitos. |
| int [GetCelestialStem](../eastasianlunisolarcalendar/getcelestialstem/)(int) const | Obtém o tronco celestial. |
...
| int [GetDaysInMonth](./getdaysinmonth/)(int, int, int) const override | Obtém o número de dias em um mês específico. |
| virtual int [GetDaysInMonth](./getdaysinmonth/)(int, int) const | Obtém o número de dias em um mês específico. |
| virtual int [GetDaysInMonth](./getdaysinmonth/)(int, int, int) const | Obtém o número de dias em um mês específico. |
...
| virtual int [GetSexagenaryYear](../eastasianlunisolarcalendar/getsexagenaryyear/)([DateTime](../../system/datetime/)) const | Obtém o ano no ciclo sexagenário. |
| int [GetTerrestrialBranch](../eastasianlunisolarcalendar/getterrestrialbranch/)(int) const | Obtém o ramo terrestre. |
...
| virtual void [set_TwoDigitYearMax](../calendar/set_twodigityearmax/)(int) | Define o último ano que pode ser representado por 2 dígitos. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Diminui e retorna o contador de referência compartilhada. Não deve ser chamado diretamente; ao invés, use smart pointers ou ThisProtector. |
|  [TaiwanLunisolarCalendar](./taiwanlunisolarcalendar/)() | Construtor. |
| virtual [DateTime](../../system/datetime/) [ToDateTime](../calendar/todatetime/)(int, int, int, int, int, int, int) const | Constrói objeto [DateTime](../../system/datetime/) a partir de componentes. |
| virtual [DateTime](../../system/datetime/) [ToDateTime](../calendar/todatetime/)(int, int, int, int, int, int, int, int) const | Constrói objeto [DateTime](../../system/datetime/) a partir de componentes. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Diminui o contador de referência fraca. Não deve ser chamado diretamente; ao invés, use smart pointers ou ThisProtector. |
