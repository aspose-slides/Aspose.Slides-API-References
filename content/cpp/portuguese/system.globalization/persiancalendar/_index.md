...
| virtual int [GetDaysInMonth](./getdaysinmonth/)(int, int) const | Informação RTTI. |
| virtual int [GetDaysInMonth](./getdaysinmonth/)(int, int, int) const | Informação RTTI. |
...
|  [PersianCalendar](./persiancalendar/)() | Construtor. |
...
| Campo | Descrição |
| --- | --- |
| static constexpr [PersianEra](./persianera/) | Era persa atual. |
