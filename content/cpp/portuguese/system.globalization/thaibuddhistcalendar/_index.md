...
| int [get_CurrentEra](../calendar/get_currentera/)() const | Obtém o índice da era corrente. |
| int [get_CurrentEraValue](../calendar/get_currenteravalue/)() const | Obtém o valor da era corrente. |
...
|  [ThaiBuddhistCalendar](./thaibuddhistcalendar/)() | Construtor. |
...
| Campo | Descrição |
| --- | --- |
| static constexpr [ThaiBuddhistEra](./thaibuddhistera/) | Era Thai Buddhist atual. |
