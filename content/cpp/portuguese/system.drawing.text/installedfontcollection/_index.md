...
description: "Representa a coleção das fontes instaladas no sistema. NÃO IMPLEMENTADO. Objetos desta classe devem ser alocados apenas usando a função System::MakeObject(). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 14
url: /pt/system.drawing.text/installedfontcollection/
---
## InstalledFontCollection classe

Representa a coleção das fontes instaladas no sistema. NOT IMPLEMENTED. Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into [System::SmartPtr](../../system/smartptr/) pointer and use this pointer to pass it to functions as argument.
...
| Método | Descrição |
| --- | --- |
| void [Dispose](../fontcollection/dispose/)() override | Libera os recursos do sistema operacional adquiridos pelo objeto atual. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[FontFamily](../../system.drawing/fontfamily/)\>\> [get_Families](../fontcollection/get_families/)() | Retorna um array de objetos [FontFamily](../../system.drawing/fontfamily/) associados à coleção de fontes representada pelo objeto atual. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo do método [Object.GetHashCode()](../../system/object/gethashcode/) do C#. Permite hash de objetos personalizados. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo da chamada [System.Object.GetType()](../../system/object/gettype/) do C#. |
|  [InstalledFontCollection](./installedfontcollection/)() | Constrói uma nova instância da classe [InstalledFontCollection](./). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica se o objeto representa uma instância do tipo descrito por targetType. Análogo do operador 'is' do C#. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Análogo do método [Object.MemberwiseClone()](../../system/object/memberwiseclone/) do C#. Permite clonar tipos personalizados. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Análogo do método [Object.ToString()](../../system/object/tostring/) do C#. Permite converter objetos personalizados para string. |
...
* Espaço de nomes [System::Drawing::Text](../)
