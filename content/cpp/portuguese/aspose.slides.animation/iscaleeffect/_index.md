...
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_By](./get_by/)() | descreve o valor de deslocamento relativo para a animação (em porcentagem). Leia [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_From](./get_from/)() | Especifica uma coordenada x/y para iniciar a animação (em porcentagem). Leia [System::Drawing::PointF](../../system.drawing/pointf/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../ibehavior/get_timing/)() | Representa propriedades de temporização para o comportamento do efeito. Leia [ITiming](../itiming/). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [get_To](./get_to/)() | Especifica a localização de destino para um efeito de escala de animação (em porcentagem). Leia [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_ZoomContent](./get_zoomcontent/)() | Determina se um conteúdo deve ser ampliado. Leia [NullableBool](../../aspose.slides/nullablebool/). |
...
| virtual void [set_By](./set_by/)([System::Drawing::PointF](../../system.drawing/pointf/)) | descreve o valor de deslocamento relativo para a animação (em porcentagem). Escrita [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_From](./set_from/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Especifica uma coordenada x/y para iniciar a animação (em porcentagem). Escrita [System::Drawing::PointF](../../system.drawing/pointf/). |
...
| virtual void [set_To](./set_to/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Especifica a localização de destino para um efeito de escala de animação (em porcentagem). Escrita [System::Drawing::PointF](../../system.drawing/pointf/). |
| virtual void [set_ZoomContent](./set_zoomcontent/)([NullableBool](../../aspose.slides/nullablebool/)) | Determina se um conteúdo deve ser ampliado. Escrita [NullableBool](../../aspose.slides/nullablebool/). |
