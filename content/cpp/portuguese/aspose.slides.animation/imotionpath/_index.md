...
| Método | Descrição |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\> [Add](./add/)([MotionCommandPathType](../motioncommandpathtype/), [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>, [MotionPathPointsType](../motionpathpointstype/), **bool**) | Adiciona novo comando ao caminho |
...
| virtual void [Clear](./clear/)() | Remove todos os comandos da coleção. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Retorna o número de caminhos na coleção. **int32_t** somente leitura. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\> [idx_get](./idx_get/)(**int32_t**) | Retorna um comando no índice especificado. |
| virtual void [Insert](./insert/)(**int32_t**, [MotionCommandPathType](../motioncommandpathtype/), [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>, [MotionPathPointsType](../motionpathpointstype/), **bool**) | Insere novo comando ao caminho |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMotionCmdPath](../imotioncmdpath/)\>) | Remove os comandos especificados da coleção. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove um comando no índice especificado. |
