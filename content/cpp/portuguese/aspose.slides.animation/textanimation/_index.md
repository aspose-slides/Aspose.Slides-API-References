...
| Método | Descrição |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) override | Adiciona um novo efeito ao final da sequência atual até o final das animações de texto em grupo. Válido apenas se a contagem de parágrafos de texto for igual ou maior que a contagem de efeitos deste grupo! |
...
| [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() override | Lista do tipo de construção (por exemplo [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) da animação de texto. Leia [Animation::BuildType](../buildtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() override | Efeito de forma vinculada ao grupo ou não (null). Leia [IEffect](../ieffect/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógico ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite o hashing de objetos personalizados. |
...
| void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) override | Lista do tipo de construção (por exemplo [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) da animação de texto. Grave [Animation::BuildType](../buildtype/). |
| void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) override | Efeito de forma vinculada ao grupo ou não (null). Grave [IEffect](../ieffect/). |
