...
| Method | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Adiciona um novo comportamento à coleção. |
| [iterator](./iterator/) [begin](./begin/)() | Obtém o iterador que aponta para o primeiro elemento (se houver) da coleção. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtém o iterador que aponta para o primeiro elemento (se houver) da instância qualificada como const da coleção. |
...
| void [Clear](./clear/)() override | Remove todos os comportamentos de uma coleção. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Determina se o [ICollection](../../system.collections.generic/icollection/) contém um valor específico. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>, **int32_t**) | Copia os elementos do [ICollection](../../system.collections.generic/icollection/) para um [System::Array](../../system/array/), começando em um índice [System::Array](../../system/array/) específico. |
| [iterator](./iterator/) [end](./end/)() | Obtém o iterador que aponta logo após o último elemento (se houver) da coleção. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtém o iterador que aponta logo após o último elemento (se houver) da instância qualificada como const da coleção. |
...
| **int32_t** [get_Count](./get_count/)() override | Retorna o número de comportamentos em uma coleção. Somente leitura **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Obtém um valor que indica se o [ICollection](../../system.collections.generic/icollection/) é somente leitura. Somente leitura **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera através da coleção. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) override | Retorna um comportamento no índice especificado. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Retorna um comportamento no índice especificado. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Determina o índice de um item específico em [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Insere um novo comportamento em uma coleção no índice especificado. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Transformar elementos de uma sequência. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Remove o comportamento especificado de uma coleção. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Remove o comportamento de uma coleção no índice especificado. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtém o iterador que aponta para o primeiro elemento (se houver) da instância qualificada como const da coleção. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtém o iterador que aponta logo após o último elemento (se houver) da instância qualificada como const da coleção. |
