...
| virtual **bool** [get_IsCustom](./get_iscustom/)() | Indica se esta propriedade não pertence à lista de propriedades predefinidas na especificação: [https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx) |
| virtual [System::String](../../system/string/) [get_Value](./get_value/)() | Valor da propriedade |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa o contador de referências fracas. Não deve ser chamado diretamente; em vez disso, use ponteiros inteligentes ou ThisProtetor. |
