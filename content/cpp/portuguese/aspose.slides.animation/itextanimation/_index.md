...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | Adiciona um novo efeito ao final da sequência atual até o final das animações de texto do grupo. Válido somente se a contagem de parágrafos de texto for igual ou maior que a contagem de efeitos deste grupo! |
...
| virtual [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() | Lista do tipo de compilação (por exemplo [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) da animação de texto. Leia [BuildType](../buildtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() | Efeito de forma vinculada ao grupo ou não (null). Leia [IEffect](../ieffect/). |
...
| virtual void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) | Lista do tipo de compilação (por exemplo [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) da animação de texto. Grave [BuildType](../buildtype/). |
| virtual void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) | Efeito de forma vinculada ao grupo ou não (null). Grave [IEffect](../ieffect/). |
