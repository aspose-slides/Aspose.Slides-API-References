...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_To](./get_to/)() | Especifica o determinado atributo de um efeito após um efeito de animação. Representa valor pontual. Apenas: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Leia [System::Object](../../system/object/). |
...
| virtual void [set_Accumulate](../ibehavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | Representa se os comportamentos de animação são acumulados. Escreva [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [set_Additive](../ibehavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | Representa se o comportamento de animação atual é combinado com outras animações em execução. Escreva [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual void [set_Timing](../ibehavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | Representa propriedades de temporização para o comportamento do efeito. Escreva [ITiming](../itiming/). |
| virtual void [set_To](./set_to/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Especifica o determinado atributo de um efeito após um efeito de animação. Representa valor pontual. Apenas: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Escreva [System::Object](../../system/object/). |
