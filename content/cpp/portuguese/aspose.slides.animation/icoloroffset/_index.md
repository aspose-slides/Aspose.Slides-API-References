...
| virtual **float** [get_Value0](./get_value0/)() | Define o primeiro valor do deslocamento. Leitura **float**. |
| virtual **float** [get_Value1](./get_value1/)() | Define o segundo valor do deslocamento. Leitura **float**. |
| virtual **float** [get_Value2](./get_value2/)() | Define o terceiro valor do deslocamento. Leitura **float**. |
...
| virtual void [set_Value0](./set_value0/)(**float**) | Define o primeiro valor do deslocamento. Escrita **float**. |
| virtual void [set_Value1](./set_value1/)(**float**) | Define o segundo valor do deslocamento. Escrita **float**. |
| virtual void [set_Value2](./set_value2/)(**float**) | Define o terceiro valor do deslocamento. Escrita **float**. |
