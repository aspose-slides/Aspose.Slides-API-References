...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](../behavior/get_properties/)() override | Representa propriedades do comportamento. Apenas leitura [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | Representa propriedades de tempo para o comportamento do efeito. Leia [ITiming](../itiming/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_To](./get_to/)() override | Especifica o determinado atributo de um efeito após um efeito de animação. Representa valor pontual. Apenas: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Leia [System::Object](../../system/object/). |
...
| void [set_Accumulate](../behavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | Representa se os comportamentos de animação são acumulados. Escrita [NullableBool](../../aspose.slides/nullablebool/). |
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Representa se o comportamento de animação atual é combinado com outras animações em execução. Escrita [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Representa propriedades de tempo para o comportamento do efeito. Escrita [ITiming](../itiming/). |
| void [set_To](./set_to/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Especifica o determinado atributo de um efeito após um efeito de animação. Representa valor pontual. Apenas: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Escrita [System::Object](../../system/object/). |
