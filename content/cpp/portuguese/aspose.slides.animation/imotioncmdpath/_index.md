...
| virtual [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() | Especifica o tipo de comando. Leia [MotionCommandPathType](../motioncommandpathtype/). |
| virtual **bool** [get_IsRelative](./get_isrelative/)() | Determina se as coordenadas do comando são relativas ou não. Leia **bool**. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | Especifica os pontos do comando. Leia [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| virtual [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() | Especifica o tipo dos pontos do comando. Leia [MotionPathPointsType](../motionpathpointstype/). |
...
| virtual void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) | Especifica o tipo de comando. Escreva [MotionCommandPathType](../motioncommandpathtype/). |
| virtual void [set_IsRelative](./set_isrelative/)(**bool**) | Determina se as coordenadas do comando são relativas ou não. Escreva **bool**. |
| virtual void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) | Especifica os pontos do comando. Escreva [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| virtual void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) | Especifica o tipo dos pontos do comando. Escreva [MotionPathPointsType](../motionpathpointstype/). |
