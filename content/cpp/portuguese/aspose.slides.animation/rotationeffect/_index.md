...
| **float** [get_By](./get_by/)() override | Descreve o valor de deslocamento relativo para a animação. Leia **float**. |
| **float** [get_From](./get_from/)() override | Descreve o valor inicial para a animação. Leia **float**. |
...
| **float** [get_To](./get_to/)() override | Descreve o valor final para a animação. Leia **float**. |
...
| void [set_By](./set_by/)(**float**) override | Descreve o valor de deslocamento relativo para a animação. Escreva **float**. |
| void [set_From](./set_from/)(**float**) override | Descreve o valor inicial para a animação. Escreva **float**. |
...
| void [set_To](./set_to/)(**float**) override | Descreve o valor final para a animação. Escreva **float**. |
