...
| Método | Descrição |
| --- | --- |
|  [CommandEffect](./commandeffect/)() | Cria nova instância. |
...
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | Representa se o comportamento de animação atual está combinado com outras animações em execução. Leia [BehaviorAdditiveType](../behavioradditivetype/). |
| [System::String](../../system/string/) [get_CommandString](./get_commandstring/)() override | Define a string de comando. Leia [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_ShapeTarget](./get_shapetarget/)() override | Define o alvo de forma do efeito de comando. Leia [IShape](../../aspose.slides/ishape/). |
...
| [CommandEffectType](../commandeffecttype/) [get_Type](./get_type/)() override | Define o tipo de efeito de comando do comportamento. Leia [CommandEffectType](../commandeffecttype/). |
...
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Representa se o comportamento de animação atual está combinado com outras animações em execução. Escreva [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_CommandString](./set_commandstring/)([System::String](../../system/string/)) override | Define a string de comando. Escreva [System::String](../../system/string/). |
| void [set_ShapeTarget](./set_shapetarget/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | Define o alvo de forma do efeito de comando. Escreva [IShape](../../aspose.slides/ishape/). |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Representa propriedades de tempo para o comportamento do efeito. Escreva [ITiming](../itiming/). |
| void [set_Type](./set_type/)([CommandEffectType](../commandeffecttype/)) override | Define o tipo de efeito de comando do comportamento. Escreva [CommandEffectType](../commandeffecttype/). |
