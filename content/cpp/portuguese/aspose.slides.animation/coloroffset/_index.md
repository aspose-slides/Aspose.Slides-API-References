...
Representa deslocamento de cor.
...
| **float** [get_Value0](./get_value0/)() override | Define o primeiro valor do deslocamento. Leia **float**. |
| **float** [get_Value1](./get_value1/)() override | Define o segundo valor do deslocamento. Leia **float**. |
| **float** [get_Value2](./get_value2/)() override | Define o terceiro valor do deslocamento. Leia **float**. |
...
| void [set_Value0](./set_value0/)(**float**) override | Define o primeiro valor do deslocamento. Escreva **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Define o segundo valor do deslocamento. Escreva **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Define o terceiro valor do deslocamento. Escreva **float**. |
