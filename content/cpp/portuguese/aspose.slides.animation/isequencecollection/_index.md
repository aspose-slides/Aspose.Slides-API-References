...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Adiciona uma nova sequência interativa. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Obtém um iterador apontando para o primeiro elemento da coleção qualificado como const (se houver). |
...
| virtual void [Clear](./clear/)() | Remove todas as sequências de uma coleção. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Retorna o número de elementos em uma coleção **int32_t** somente leitura. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo do método [Object.GetHashCode()](../../system/object/gethashcode/) do C#. Habilita o hash de objetos personalizados. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [idx_get](./idx_get/)(**int32_t**) | Retorna uma sequência no índice especificado. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo do método [Object.MemberwiseClone()](../../system/object/memberwiseclone/) do C#. Habilita a clonagem de tipos personalizados. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>) | Remove a sequência especificada de uma coleção. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove a sequência no índice especificado. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogo do método [Object.ToString()](../../system/object/tostring/) do C#. Habilita a conversão de objetos personalizados para string. |
