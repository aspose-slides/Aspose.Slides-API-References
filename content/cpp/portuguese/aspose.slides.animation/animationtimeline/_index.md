...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) override | Retorna a sequência interativa no índice especificado. Esta sequência pode conter apenas efeitos de \"click on shape\" com a forma de destino especificada. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequenceCollection](../isequencecollection/)\> [get_InteractiveSequences](./get_interactivesequences/)() override | Retorna a coleção de sequências interativas. Estas sequências podem conter apenas efeitos de \"click on shape\" com a forma de destino especificada. Somente leitura [ISequenceCollection](../isequencecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_MainSequence](./get_mainsequence/)() override | Retorna a sequência principal que pode conter apenas a coleção de efeitos principais. Somente leitura [ISequence](../isequence/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) override | Retorna o efeito da sequência principal no índice especificado. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) override | Retorna a animação de texto no índice especificado. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimationCollection](../itextanimationcollection/)\> [get_TextAnimationCollection](./get_textanimationcollection/)() override | Retorna a coleção de animações de texto. Somente leitura [ITextAnimationCollection](../itextanimationcollection/). |
