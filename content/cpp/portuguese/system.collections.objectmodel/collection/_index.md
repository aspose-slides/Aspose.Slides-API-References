...
description: "Tipo base para coleção genérica. Objetos desta classe devem ser alocados apenas usando a função System::MakeObject(). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-la a funções como argumento."
type: docs
weight: 1
url: /pt/system.collections.objectmodel/collection/
---
## Classe de Coleção

Tipo base para coleção genérica. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-la a funções como argumento.
...
| Método | Descrição |
| --- | --- |
| void [Add](./add/)(const T\&) override | Adiciona valor ao contêiner. |
...
| [Collection](./collection/)() | Cria coleção vazia. |
| [Collection](./collection/)([SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) |  |
| **bool** [Contains](./contains/)(const T\&) const override | Verifica se o item está presente na coleção. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copia elementos da coleção para elementos de array existentes. |
...
| [const_reverse_iterator](./const_reverse_iterator/) [crend](./crend/)() const | Obtém um iterador reverso para um elemento const-qualificado inexistente antes do início da coleção. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](./get_items/)() | Acessador da estrutura de dados interna. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](./get_items/)() const | Acessador da estrutura de dados interna. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Obtém enumerador para iterar pela coleção. |
...
| T [idx_get](./idx_get/)(int) const override | Obtém o valor no índice especificado. |
| void [idx_set](./idx_set/)(int, T) override | Define o valor no índice especificado. |
| int [IndexOf](./indexof/)(const T\&) const override | Busca elemento na coleção. |
...
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)([ICollection](../../system.collections.generic/icollection/)\&&) | Operador de atribuição de movimento. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)(const [ICollection](../../system.collections.generic/icollection/)\&) | Operador de atribuição de movimento. |
...
| T\& [operator[]](./operator[]/)(int) | Obtém o valor no índice especificado. |
| const T\& [operator[]](./operator[]/)(int) const | Obtém o valor no índice especificado. |
...
| **bool** [Remove](./remove/)(const T\&) override | Remove item específico. |
| void [RemoveAt](./removeat/)(int) override | Remove item em posição específica. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Torna os ponteiros armazenados fracos (se aplicável). |
...
* Espaço de nomes [System::Collections::ObjectModel](../)
