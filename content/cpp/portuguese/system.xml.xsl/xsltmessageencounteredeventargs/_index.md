...
description: "Fornece dados para o evento XsltArgumentList::XsltMessageEncountered."
type: docs
weight: 92
url: /pt/system.xml.xsl/xsltmessageencounteredeventargs/
---
## XsltMessageEncounteredEventArgs classe


Fornece dados para o evento **XsltArgumentList::XsltMessageEncountered**.
...
| virtual [String](../../system/string/) [get_Message](./get_message/)() | Retorna o conteúdo do elemento **xsl:message**. |
