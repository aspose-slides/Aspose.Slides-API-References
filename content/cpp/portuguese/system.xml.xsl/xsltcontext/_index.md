...
description: Encapsula o contexto de execução atual do processador Extensible Stylesheet Language for Transformations (XSLT), permitindo que a linguagem XML Path (XPath) resolva funções, parâmetros e namespaces dentro de expressões XPath.
type: docs
weight: 79
url: /pt/system.xml.xsl/xsltcontext/
---
## XsltContext classe

Encapsula o contexto de execução atual do processador Extensible Stylesheet Language for Transformations (XSLT), permitindo que a XML Path Language ([XPath](../../system.xml.xpath/)) resolva funções, parâmetros e namespaces dentro de expressões [XPath](../../system.xml.xpath/).
...
| Método | Descrição |
| --- | --- |
| virtual void [AddNamespace](../../system.xml/xmlnamespacemanager/addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Adiciona o namespace fornecido à coleção. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtém o iterador apontando para o primeiro elemento (se houver) da instância qualificada como const da coleção. |
...
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | Quando substituído em uma classe derivada, compara os Uniform Resource Identifiers (URIs) base de dois documentos com base na ordem em que os documentos foram carregados pelo processador XSLT (isto é, a classe [XslTransform](../xsltransform/)). |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtém o iterador apontando logo após o último elemento (se houver) da instância qualificada como const da coleção. |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | Retorna o URI do namespace padrão. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | Retorna o [XmlNameTable](../../system.xml/xmlnametable/) associado a este objeto. |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | Quando substituído em uma classe derivada, obtém um valor indicando se deve incluir nós de espaço em branco na saída. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | Retorna um enumerador para iterar pelos namespaces em [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/). |
...
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](../../system.xml/xmlnamespacemanager/getnamespacesinscope/)([XmlNamespaceScope](../../system.xml/xmlnamespacescope/)) override | Retorna uma coleção de nomes de namespace indexados por prefixo que pode ser usada para enumerar os namespaces atualmente em escopo. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [HasNamespace](../../system.xml/xmlnamespacemanager/hasnamespace/)([String](../../system/string/)) | Retorna um valor indicando se o prefixo fornecido possui um namespace definido para o escopo atual empilhado. |
...
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | Retorna o URI do namespace para o prefixo especificado. |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | Encontra o prefixo declarado para o URI de namespace fornecido. |
...
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | Remove um escopo de namespace da pilha. |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | Quando substituído em uma classe derivada, avalia se deve preservar nós de espaço em branco ou removê-los para o contexto fornecido. |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | Empurra um escopo de namespace para a pilha. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Compara objetos por referência. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Compara objetos por referência. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Compara referência de objeto de tipo valor com nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | Especialização de [Object::ReferenceEquals](../../system/object/referenceequals/) para o caso de string e nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | Especialização de [Object::ReferenceEquals](../../system/object/referenceequals/) para o caso de strings. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Remove o namespace fornecido para o prefixo especificado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextFunction](../ixsltcontextfunction/)\> [ResolveFunction](./resolvefunction/)([String](../../system/string/), [String](../../system/string/), [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\>) | Quando substituído em uma classe derivada, resolve uma referência de função e retorna um [IXsltContextFunction](../ixsltcontextfunction/) que representa a função. O [IXsltContextFunction](../ixsltcontextfunction/) é usado no tempo de execução para obter o valor de retorno da função. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | Quando substituído em uma classe derivada, resolve uma referência de variável e retorna um [IXsltContextVariable](../ixsltcontextvariable/) que representa a variável. |
...
|  [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Inicializa uma nova instância da classe [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) com o [XmlNameTable](../../system.xml/xmlnametable/) especificado. |
