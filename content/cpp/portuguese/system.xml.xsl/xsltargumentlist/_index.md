...
description: Contém um número variável de argumentos que são parâmetros XSLT ou objetos de extensão.
type: docs
weight: 66
url: /pt/system.xml.xsl/xsltargumentlist/
---
...
| Método | Descrição |
| --- | --- |
| void [AddExtensionObject](./addextensionobject/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Adiciona um novo objeto ao [XsltArgumentList](./) e o associa ao URI do namespace. |
| void [AddParam](./addparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Adiciona um parâmetro ao [XsltArgumentList](./) e o associa ao nome qualificado do namespace. |
| void [Clear](./clear/)() | Remove todos os parâmetros e objetos de extensão do [XsltArgumentList](./). |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetExtensionObject](./getextensionobject/)(const [String](../../system/string/)\&) | Retorna o objeto associado ao namespace fornecido. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hash de objetos personalizados. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetParam](./getparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Retorna o parâmetro associado ao nome qualificado do namespace. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [RemoveExtensionObject](./removeextensionobject/)(const [String](../../system/string/)\&) | Remove o objeto com o URI do namespace do [XsltArgumentList](./). |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [RemoveParam](./removeparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Remove o parâmetro do [XsltArgumentList](./). |
...
| [XsltArgumentList](./xsltargumentlist/)() | Implementa uma nova instância do [XsltArgumentList](./). |
...
Objetos desta classe só devem ser alocados usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento. 
