...
description: A exceção lançada quando ocorre um erro ao processar uma transformação XSLT.
type: docs
weight: 14
url: /pt/system.xml.xsl/details_xsltexception/
---
## Details_XsltException classe

A exceção lançada quando ocorre um erro ao processar uma transformação XSLT.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de ponto flutuante no estilo C#, onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não seja igual a qualquer valor, incluindo NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de ponto flutuante no estilo C#, onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não seja igual a qualquer valor, incluindo NaN. |
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Retorna o número da linha indicando onde o erro ocorreu na folha de estilo. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Retorna a posição da linha indicando onde o erro ocorreu na folha de estilo. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Retorna a mensagem de erro formatada que descreve a exceção atual. |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Retorna o caminho de localização da folha de estilo. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo do método C# [Object.GetHashCode()](../../system/object/gethashcode/). Habilita hash de objetos personalizados. |
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Obtém o tipo real do objeto. Analogo da chamada C# [System.Object.GetType()](../../system/object/gettype/). |
| **bool** [Is](../../system/details_systemexception/is/)(const [System::TypeInfo](../../system/typeinfo/)\&) const override |  |
| void [Lock](../../system/object/lock/)() | Implementa o bloqueio da instrução C# lock(). Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo do método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Habilita clonagem de tipos personalizados. |
...
| --- | --- |
| [Ptr](./ptr/) | Um apelido para ponteiro compartilhado para uma instância desta classe. |
