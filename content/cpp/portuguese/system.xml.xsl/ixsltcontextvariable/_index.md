...
description: Fornece uma interface para uma variável especificada que é definida na folha de estilo durante a execução em tempo de execução.
type: docs
weight: 40
url: /pt/system.xml.xsl/ixsltcontextvariable/
---
## IXsltContextVariable classe

Fornece uma interface para uma variável especificada que é definida na folha de estilo durante a execução em tempo de execução.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Evaluate](./evaluate/)([SharedPtr](../../system/sharedptr/)\<[XsltContext](../xsltcontext/)\>) | Avalia a variável em tempo de execução e retorna um objeto que representa o valor da variável. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Somente para uso interno. |
| virtual **bool** [get_IsLocal](./get_islocal/)() | Retorna um valor indicando se a variável é local. |
| virtual **bool** [get_IsParam](./get_isparam/)() | Retorna um valor indicando se a variável é um parâmetro Extensible Stylesheet Language Transformations (XSLT). Isso pode ser um parâmetro para uma folha de estilo ou um modelo. |
| virtual [System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/) [get_VariableType](./get_variabletype/)() | Retorna o XPathResultType que representa o tipo da Linguagem de Caminho XML ([XPath](../../system.xml.xpath/)) da variável. |
