...
description: "Marca o alvo do atributo como um elemento raiz XML e controla sua serialização XML. Objetos desta classe devem ser alocados somente usando a função System::MakeObject() function. Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 27
url: /pt/system.xml.serialization/xmlrootattribute/
---
## XmlRootAttribute classe

Marca o alvo do atributo como um elemento raiz XML e controla sua serialização XML. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| void [Unlock](../../system/object/unlock/)() | Implementa o destravamento da instrução C# lock(). Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
...
|  [XmlRootAttribute](./xmlrootattribute/)() | Constrói uma nova instância da classe [XmlRootAttribute](./). |
|  [XmlRootAttribute](./xmlrootattribute/)(const [System::String](../../system/string/)\&) | Constrói uma nova instância da classe [XmlRootAttribute](./) e a inicializa com o nome de elemento especificado. |
