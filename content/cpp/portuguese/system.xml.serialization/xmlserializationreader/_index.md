...
description: Classe de serviço que melhora a experiência do XmlReader.
type: docs
weight: 40
url: /pt/system.xml.serialization/xmlserializationreader/
---
## XmlSerializationReader classe

Classe de serviço que melhora a experiência [XmlReader](../../system.xml/xmlreader/).
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método [Object.GetHashCode()](../../system/object/gethashcode/) do C#. Permite a criação de hash para objetos personalizados. |
...
| void [Initialize](./initialize/)([System::SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>, [System::SharedPtr](../../system/sharedptr/)\<[XmlSerializer](../xmlserializer/)\>) | Inicializa a classe [XmlSerializationReader](./). |
