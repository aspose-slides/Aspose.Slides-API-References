...
description: "Fornece formatação personalizada para serialização e desserialização XML. Objetos desta classe devem ser alocados apenas usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro ao passá-lo para funções como argumento."
type: docs
weight: 1
url: /pt/system.xml.serialization/ixmlserializable/
---
## IXmlSerializable classe

Fornece formatação personalizada para serialização e desserialização XML. Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de ponto flutuante ao estilo C#, onde dois NaNs são considerados iguais apesar de, de acordo com IEC 60559:1989, NaN não ser igual a nenhum valor, incluindo NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de ponto flutuante ao estilo C#, onde dois NaNs são considerados iguais apesar de, de acordo com IEC 60559:1989, NaN não ser igual a nenhum valor, incluindo NaN. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Xml::Schema::XmlSchema](../../system.xml.schema/xmlschema/)\> [GetSchema](./getschema/)() | Um objeto XmlSchema que descreve a representação XML do objeto que é retornado pelo método [WriteXml()](./writexml/) e aceito pelo método [ReadXml()](./readxml/). |
...
| virtual void [ReadXml](./readxml/)([System::SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlReader](../../system.xml/xmlreader/)\>) | Desserializa o objeto de sua representação XML. |
...
| virtual void [WriteXml](./writexml/)([System::SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlWriter](../../system.xml/xmlwriter/)\>) | Serializa o objeto atual para representação XML. |
| virtual  [~IXmlSerializable](./~ixmlserializable/)() | Destrutor. |
