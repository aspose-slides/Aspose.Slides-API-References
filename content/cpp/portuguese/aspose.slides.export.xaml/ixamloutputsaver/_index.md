...
description: Representa uma implementação de salvamento de saída para transferir dados para o armazenamento externo.
type: docs
weight: 14
...
Representa uma implementação de salvamento de saída para transferir dados para o armazenamento externo.
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Salva um array de bytes em um local de destino. |
