...
description: "Representa um valor do cabeçalho 'If-Range'. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 235
url: /pt/system.net.http.headers/rangeconditionheadervalue/
---
...
| [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](../entitytagheadervalue/)\> [get_EntityTag](./get_entitytag/)() | Retorna um valor de cabeçalho 'ETag'. |
...
| static **int32_t** [GetRangeConditionLength](./getrangeconditionlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Converte uma string passada a partir do índice especificado para uma instância da classe [RangeConditionHeaderValue](./). |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[RangeConditionHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Converte uma string passada para uma instância da classe [RangeConditionHeaderValue](./). |
|  [RangeConditionHeaderValue](./rangeconditionheadervalue/)([DateTimeOffset](../../system/datetimeoffset/)) | Constrói uma nova instância. |
|  [RangeConditionHeaderValue](./rangeconditionheadervalue/)([System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](../entitytagheadervalue/)\>) | Constrói uma nova instância. |
|  [RangeConditionHeaderValue](./rangeconditionheadervalue/)([String](../../system/string/)) | Constrói uma nova instância. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[RangeConditionHeaderValue](./)\>\&) | Tenta converter uma string passada para uma instância da classe [RangeConditionHeaderValue](./). |
