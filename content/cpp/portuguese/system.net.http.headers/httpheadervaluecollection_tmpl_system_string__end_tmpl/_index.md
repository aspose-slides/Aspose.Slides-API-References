...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&) override | Adiciona elemento à coleção. |
...
| void [Clear](./clear/)() override | Exclui todos os elementos da coleção. |
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) const override | Verifica se o elemento está presente na coleção. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\>, **int32_t**) override |  |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia todos os elementos da coleção para elementos de vetor existentes. |
...
| **int32_t** [get_Count](./get_count/)() const override | Obtém o número de elementos na coleção. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Obtém enumerador. |
...
| **bool** [Remove](./remove/)(const [String](../../system/string/)\&) override | Remove elemento da coleção. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Análogo ao método C# [Object.ToString()](../httpheadervaluecollection/tostring/). Habilita a conversão de objetos personalizados para string. |
