...
description: "Representa a exceção lançada quando ocorre um erro de socket. Nunca crie instâncias desta classe manualmente. Use a classe SocketException em vez disso. Nunca encapsule as instâncias da classe SocketException em System::SmartPtr."
type: docs
weight: 1
url: /pt/system.net.sockets/details_socketexception/
---
## Details_SocketException classe

Representa a exceção lançada quando ocorre um erro de socket. Nunca crie instâncias desta classe manualmente. Use a classe SocketException em vez disso. Nunca encapsule as instâncias da classe SocketException em [System::SmartPtr](../../system/smartptr/).
...
| **int32_t** [get_ErrorCode](./get_errorcode/)() | Obtém o código de erro. |
...
| [SocketError](../socketerror/) [get_SocketErrorCode](./get_socketerrorcode/)() | Obtém o código de erro de socket. |
...
| void [set_ErrorCode](./set_errorcode/)(**int32_t**) | Define o código de erro. |
...
| void [set_SocketErrorCode](./set_socketerrorcode/)([SocketError](../socketerror/)) | Define o código de erro de socket. |
