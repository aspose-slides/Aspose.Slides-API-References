...
description: Este aviso indica que um comportamento obsoleto de bloqueio de apresentação está sendo usado.
type: docs
weight: 27
...
Este aviso indica que um comportamento obsoleto de bloqueio de apresentação está sendo usado.
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Retorna uma descrição legível deste aviso. Somente leitura [System::String](../../system/string/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Se o receptor não for nulo, finaliza o aviso para um receptor especificado e lança AbortRequestedException se o receptor decidir abortar a operação. |
...
* Espaço de nomes [Aspose::Slides::Warnings](../)
