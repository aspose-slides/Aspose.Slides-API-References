...
description: Este aviso indica que a apresentação sendo lida tem a assinatura e que esta assinatura será removida durante o processamento.
type: docs
weight: 40
...
Esta advertência indica que a apresentação sendo lida tem a assinatura e que esta assinatura será removida durante o processamento.
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Retorna uma descrição legível por humanos deste aviso. Somente leitura [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Retorna um tipo de aviso. Somente leitura [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Se o receptor não for nulo, termina o aviso para um receptor especificado e lança a AbortRequestedException se o receptor decidir abortar a operação. |
