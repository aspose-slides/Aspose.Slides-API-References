...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Retorna uma descrição legível desta advertência. Somente leitura [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](./get_warningtype/)() | Retorna um tipo de advertência. Somente leitura [IWarningInfo::get_WarningType](./get_warningtype/). |
...
| virtual void [SendWarning](./sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Se o receptor não for nulo, encerra o aviso para um receptor especificado e lança AbortRequestedException se o receptor decidir abortar a operação. |
