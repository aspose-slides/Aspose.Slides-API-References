...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Retorna uma descrição legível desta advertência. Somente leitura [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Retorna um tipo de advertência. Somente leitura [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Se o receptor não for nulo, encerra o aviso para um receptor especificado e lança a AbortRequestedException se o receptor decidir abortar a operação. |
