...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Usa a função especificada usando esta instância como argumento e argumento adicional especificado |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) override | Usa a função especificada usando esta instância como argumento e argumento adicional especificado |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Usa uma função de argumento usando esta instância como nome da função |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::String](../../system/string/)) override | Usa uma função de argumento usando esta instância como nome da função |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() override | Argumento base |
| **bool** [get_HideBottom](./get_hidebottom/)() override | Oculta a borda inferior (padrão é false) – especifica o estado oculto ou exibido da borda inferior da caixa de borda. |
| **bool** [get_HideLeft](./get_hideleft/)() override | Oculta a borda esquerda (padrão é false) – especifica o estado oculto ou exibido da borda esquerda da caixa de borda. |
| **bool** [get_HideRight](./get_hideright/)() override | Oculta a borda direita (padrão é false) – especifica o estado oculto ou exibido da borda direita da caixa de borda. |
| **bool** [get_HideTop](./get_hidetop/)() override | Oculta a borda superior (padrão é false) – especifica o estado oculto ou exibido da borda superior da caixa de borda. |
| **bool** [get_StrikethroughBottomLeftToTopRight](./get_strikethroughbottomlefttotopright/)() override | Traço diagonal de baixo-esquerda para cima-direita (padrão é false). Especifica o estado oculto ou exibido de uma linha diagonal de traço do canto inferior esquerdo ao canto superior direito da caixa de borda. |
| **bool** [get_StrikethroughHorizontal](./get_strikethroughhorizontal/)() override | Traço horizontal (padrão é false) – especifica o estado oculto ou exibido de uma linha horizontal de traço. |
| **bool** [get_StrikethroughTopLeftToBottomRight](./get_strikethroughtoplefttobottomright/)() override | Traço diagonal de cima-esquerda para baixo-direita (padrão é false). Especifica o estado oculto ou exibido de uma linha diagonal de traço do canto superior esquerdo ao canto inferior direito da caixa de borda. |
| **bool** [get_StrikethroughVertical](./get_strikethroughvertical/)() override | Traço vertical (padrão é false) – especifica o estado oculto ou exibido de uma linha vertical de traço. |
...
|  [MathBorderBox](./mathborderbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Cria um elemento [MathBorderBox](./) com borda retangular |
|  [MathBorderBox](./mathborderbox/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) | Cria um elemento [MathBorderBox](./) |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Construtor de cópia. Não copia nada, realmente, apenas inicializa um novo objeto e permite copiar construtores de subclasses. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de atribuição. Não copia nada, realmente, apenas inicializa um novo objeto e permite copiar construtores de subclasses. |
...
| void [set_HideBottom](./set_hidebottom/)(**bool**) override | Oculta a borda inferior (padrão é false) – especifica o estado oculto ou exibido da borda inferior da caixa de borda. |
| void [set_HideLeft](./set_hideleft/)(**bool**) override | Oculta a borda esquerda (padrão é false) – especifica o estado oculto ou exibido da borda esquerda da caixa de borda. |
| void [set_HideRight](./set_hideright/)(**bool**) override | Oculta a borda direita (padrão é false) – especifica o estado oculto ou exibido da borda direita da caixa de borda. |
| void [set_HideTop](./set_hidetop/)(**bool**) override | Oculta a borda superior (padrão é false) – especifica o estado oculto ou exibido da borda superior da caixa de borda. |
| void [set_StrikethroughBottomLeftToTopRight](./set_strikethroughbottomlefttotopright/)(**bool**) override | Traço diagonal de baixo-esquerda para cima-direita (padrão é false). Especifica o estado oculto ou exibido de uma linha diagonal de traço do canto inferior esquerdo ao canto superior direito da caixa de borda. |
| void [set_StrikethroughHorizontal](./set_strikethroughhorizontal/)(**bool**) override | Traço horizontal (padrão é false) – especifica o estado oculto ou exibido de uma linha horizontal de traço. |
| void [set_StrikethroughTopLeftToBottomRight](./set_strikethroughtoplefttobottomright/)(**bool**) override | Traço diagonal de cima-esquerda para baixo-direita (padrão é false). Especifica o estado oculto ou exibido de uma linha diagonal de traço do canto superior esquerdo ao canto inferior direito da caixa de borda. |
| void [set_StrikethroughVertical](./set_strikethroughvertical/)(**bool**) override | Traço vertical (padrão é false) – especifica o estado oculto ou exibido de uma linha vertical de traço. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../mathelementbase/setlowerlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Obtém limite inferior |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetLowerLimit](../mathelementbase/setlowerlimit/)([System::String](../../system/string/)) override | Obtém limite inferior |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathSubscriptElement](../imathsubscriptelement/)\> [SetSubscript](../mathelementbase/setsubscript/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Cria subescrito |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathSubscriptElement](../imathsubscriptelement/)\> [SetSubscript](../mathelementbase/setsubscript/)([System::String](../../system/string/)) override | Cria subescrito |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLeftSubSuperscriptElement](../imathleftsubsuperscriptelement/)\> [SetSubSuperscriptOnTheLeft](../mathelementbase/setsubsuperscriptontheleft/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Cria subescrito e sobrescrito à esquerda |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLeftSubSuperscriptElement](../imathleftsubsuperscriptelement/)\> [SetSubSuperscriptOnTheLeft](../mathelementbase/setsubsuperscriptontheleft/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Cria subescrito e sobrescrito à esquerda |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRightSubSuperscriptElement](../imathrightsubsuperscriptelement/)\> [SetSubSuperscriptOnTheRight](../mathelementbase/setsubsuperscriptontheright/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Cria subescrito e sobrescrito à direita |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRightSubSuperscriptElement](../imathrightsubsuperscriptelement/)\> [SetSubSuperscriptOnTheRight](../mathelementbase/setsubsuperscriptontheright/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Cria subescrito e sobrescrito à direita |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetUpperLimit](../mathelementbase/setupperlimit/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Obtém limite superior |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLimit](../imathlimit/)\> [SetUpperLimit](../mathelementbase/setupperlimit/)([System::String](../../system/string/)) override | Obtém limite superior |
