...
description: Especifica o objeto Sub-Superescrito, que consiste em uma base e um subscrito e sobrescrito posicionados à direita da base.
type: docs
weight: 534
...
Especifica o objeto Sub-Superescrito, que consiste em uma base e um subscrito e sobrescrito posicionados à direita da base.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Aceita uma função de argumento usando esta instância como nome da função |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | Aceita uma função de argumento usando esta instância como nome da função |
| virtual **bool** [get_AlignScripts](./get_alignscripts/)() | Especifica o alinhamento de subscrito/sobrescrito. Quando verdadeiro, subscrito e sobrescrito são alinhados horizontalmente entre si. Quando falso, são ajustados à forma da base. Valor padrão é false. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | Argumento base |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Subscript](./get_subscript/)() | Argumento de subscrito |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Superscript](./get_superscript/)() | Argumento de sobrescrito |
...
| virtual void [set_AlignScripts](./set_alignscripts/)(**bool**) | Especifica o alinhamento de subscrito/sobrescrito. Quando verdadeiro, subscrito e sobrescrito são alinhados horizontalmente entre si. Quando falso, são ajustados à forma da base. Valor padrão é false. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRightSubSuperscriptElement](./)\> [SetSubSuperscriptOnTheRight](../imathelement/setsubsuperscriptontheright/)([System::String](../../system/string/), [System::String](../../system/string/)) | Cria subscrito e sobrescrito à direita |
