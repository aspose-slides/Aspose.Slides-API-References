...
| Método | Descrição |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Adiciona [IMathBlock](../imathblock/) ao final da coleção. |
...
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Determina se a coleção contém um valor específico. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Obtém o número de elementos realmente contidos na coleção. Apenas leitura **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) | Obtém o item no índice especificado. Apenas leitura [IMathBlock](../imathblock/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Obtém o item no índice especificado. Apenas leitura [IMathBlock](../imathblock/). |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Determina o índice de um [IMathBlock](../imathblock/) específico na coleção. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Insere [IMathBlock](../imathblock/) na coleção no índice especificado. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Retorna o primeiro elemento da sequência que satisfaz a condição ou um valor padrão se nenhum elemento for encontrado. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Remove a primeira ocorrência de um objeto específico da coleção/>. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove um item no índice especificado da coleção. |
