...
description: IMathElement com Propriedades de Caractere de Controle
type: docs
weight: 14
url: /pt/aspose.slides.mathtext/ihascontrolcharacterproperties/
---
## IHasControlCharacterProperties classe

[IMathElement](../imathelement/) com [Control](../../aspose.slides/control/) Propriedades de Caractere
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Compara por referência o objeto de tipo de valor com nullptr. |
