...
description: Fornece uma classe base para implementações da interface genérica System.Collections.Generic.IComparer.
type: docs
weight: 105
url: /pt/system.collections.generic/comparer/
---
## Comparer classe

Fornece uma classe base para implementações da interface genérica [System.Collections.Generic.IComparer](../icomparer/).
...
| Parâmetro | Descrição |
| --- | --- |
| T | O tipo de objetos a serem comparados. |

## Métodos

| Método | Descrição |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) função. |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | Retorna um comparador de ordem de classificação padrão para o tipo especificado pelo argumento genérico. |
