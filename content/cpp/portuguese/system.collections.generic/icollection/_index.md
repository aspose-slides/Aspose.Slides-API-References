...
| Método | Descrição |
| --- | --- |
| virtual void [Add](./add/)(const T\&) | Adiciona elemento à coleção. |
...
| virtual **bool** [Contains](./contains/)(const T\&) const | Verifica se o elemento está presente na coleção. |
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia todos os elementos da coleção para elementos de um array existente. |
...
| virtual int [get_Count](./get_count/)() const | Obtém o número de elementos na coleção. |
| virtual **bool** [get_IsReadOnly](./get_isreadonly/)() const | Verifica se a coleção é somente leitura. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Obtém o objeto pelo qual a coleção está sendo sincronizada. |
...
|  [ICollection](./icollection/)() | Construtor padrão. |
|  [ICollection](./icollection/)(const [ICollection](./)\&) | Construtor de cópia. |
|  [ICollection](./icollection/)([ICollection](./)\&&) | Construtor de movimento. |
...
| ResultType [LINQ_Average](../ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Calcula a média de uma sequência de valores que são obtidos invocando uma função de transformação em cada elemento da sequência de entrada. |
...
| [ICollection](./)\& [operator=](./operator_equal/)([ICollection](./)\&&) | Operador de atribuição por movimento. |
| [ICollection](./)\& [operator=](./operator_equal/)(const [ICollection](./)\&) | Operador de atribuição por movimento. |
...
| virtual **bool** [Remove](./remove/)(const T\&) | Remove elemento da coleção. |
...
| virtual  [~ICollection](./~icollection/)() | Destrutor. |
...
| --- | --- |
| [ValueType](./valuetype/) | Nome do tipo de valor. |
| [ThisType](./thistype/) | Nome do tipo de coleção. |
