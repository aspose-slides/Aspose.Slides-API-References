...
description: "Contém código comum para coleções de chaves ou valores. Objetos desta classe devem ser alocados apenas usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-la a funções como argumento."
type: docs
weight: 79
url: /pt/system.collections.generic/basekvcollection/
---
## BaseKVCollection classe

Contém código comum para coleções de chaves ou valores. Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-la a funções como argumento.
...
| KV | Tipo de chave ou valor, dependendo da interface que está sendo usada. |

## Métodos

| Método | Descrição |
| --- | --- |
| void [Add](../ikvcollection/add/)(const T\&) override | Adiciona item ao contêiner. |
| [BaseKVCollection](./basekvcollection/)(const typename Dict::Ptr\&) | Cria coleção. |
...
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Obtém iterador apontando para o primeiro elemento (se houver) da instância qualificada como const da coleção. |
...
| void [Clear](../ikvcollection/clear/)() override | Remove todos os elementos do contêiner. |
| **bool** [Contains](../ikvcollection/contains/)(const T\&) const override | Verifica se o item está presente no contêiner. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | Copia dados para elementos de array existentes. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtém iterador apontando logo após o último elemento (se houver) da coleção. Este iterador não pode ser usado para alterar um objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) retorna um objeto cópia de T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Obtém iterador apontando logo após o último elemento (se houver) da instância qualificada como const da coleção. |
...
| int [get_Count](./get_count/)() const override | Obtém o número de elementos. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](../ikvcollection/getenumerator/)() | Obtém enumerador para o contêiner. |
...
| virtual T [idx_get](../ikvcollection/idx_get/)(int) const | Função getter. |
...
| void [Insert](../ikvcollection/insert/)(int, const T\&) override | Insere item na posição especificada. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | Pula um número especificado de elementos contíguos a partir do início de uma sequência e retorna o restante. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Construtor de cópia. Na verdade não copia nada, apenas inicializa novo objeto e permite a construção de cópia de subclasses. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de atribuição. Na verdade não copia nada, apenas inicializa novo objeto e permite a construção de cópia de subclasses. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Permite compilação, mas não faz nada, pois esta estrutura não possui dados. |
...
* Classe [IKVCollection](../ikvcollection/)
