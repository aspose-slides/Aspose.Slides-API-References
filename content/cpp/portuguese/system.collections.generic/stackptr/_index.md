...
description: Ponteiro de pilha. Este tipo é um ponteiro para gerenciar a exclusão de outros objetos. Deve ser alocado na pilha e passado para funções por valor ou por referência constante.
type: docs
weight: 612
url: /pt/system.collections.generic/stackptr/
---
## StackPtr classe

[Stack](../stack/) ponteiro. Este tipo é um ponteiro para gerenciar a exclusão de outros objetos. Ele deve ser alocado na pilha e passado para funções por valor ou por referência constante.
...
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | Verifica se o ponteiro aponta para outro objeto que não o de propriedade (criado por um construtor aliasing). |
...
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&) | Copia-atribui o objeto [SmartPtr](../../system/smartptr/). Efetua as conversões de tipo necessárias. |
...
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | Remove o aliasing (criado por um construtor aliasing) do ponteiro, garantindo que ele gerencie (se compartilhado) ou acompanhe (se fraco) o mesmo objeto ao qual aponta. |
...
|  [StackPtr](./stackptr/)() | Constrói ponteiro nulo. |
|  [StackPtr](./stackptr/)(const [SharedPtr](../../system/sharedptr/)\<[Stack](../stack/)\<T\>\>\&) | Constrói ponteiro referenciando uma pilha específica. |
...
| [SmartPtr](../../system/smartptr/)\<[Object](../../system/object/)\> [ToObjectPtr](../../system/smartptr/toobjectptr/)() const | Converte qualquer tipo de ponteiro para ponteiro de [Object](../../system/object/). Não exige que o tipo Pointee_ esteja completo. |
