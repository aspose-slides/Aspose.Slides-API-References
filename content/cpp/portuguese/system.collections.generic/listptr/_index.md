...
description: Ponteiro de lista com operadores de acesso. Este tipo é um ponteiro para gerenciar a exclusão de objetos de outro. Deve ser alocado na pilha e passado para funções por valor ou por referência const.
type: docs
weight: 456
url: /pt/system.collections.generic/listptr/
---
## ListPtr classe

[List](../list/) ponteiro com operadores de acesso. Este tipo é um ponteiro para gerenciar a exclusão de objetos de outro. Deve ser alocado na pilha e passado para funções por valor ou por referência const.
...
| [ListPtr](./listptr/)(std::nullptr_t) | Inicializa ponteiro nulo. |
| [ListPtr](./listptr/)(const [SharedPtr](../../system/sharedptr/)\<[List](../list/)\<T\>\>\&) | Inicializa o ponteiro para a lista especificada. |
...
| **bool** [operator==](./operator_equal_equal/)(std::nullptr_t) const | Verifica se o ponteiro [List](../list/) é nulo. |
| std::vector\<T\>::reference [operator[]](./operator[]/)(int) | Acessador. |
| std::vector\<T\>::const_reference [operator[]](./operator[]/)(int) const | Acessador. |
...
| [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Constrói cópia do objeto [SmartPtr](../../system/smartptr/). Ambos os ponteiros apontam para o mesmo objeto depois. Executa a conversão de tipo se permitida. |
