...
description: Declaração antecipada da classe SortedSet.
type: docs
weight: 573
url: /pt/system.collections.generic/sortedset/
---
## SortedSet classe

Forward declaration of [SortedSet](./) classe.
...
| virtual void [Clear](../icollection/clear/)() | Remove todos os elementos da coleção. |
...
| T [get_Max](./get_max/)() const | Obtém o valor máximo no [SortedSet](./). |
...
| virtual **bool** [Remove](../icollection/remove/)(const T\&) | Remove elemento da coleção. |
...
|  [SortedSet](./sortedset/)() | Cria conjunto vazio. |
|  [SortedSet](./sortedset/)(int) | Cria conjunto vazio com capacidade especificada. |
|  [SortedSet](./sortedset/)(const [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\>\&) | Cria conjunto vazio que utiliza o comparador de igualdade especificado. |
|  [SortedSet](./sortedset/)(const [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\>\&) | Cria [SortedSet](./) baseado em valores enumeráveis. |
