...
description: Declaração antecipada da classe HashSet.
type: docs
weight: 222
url: /pt/system.collections.generic/hashset/
---
## HashSet classe

Declaração antecipada da classe [HashSet](./).
...
| Method | Description |
| --- | --- |
| virtual void [Add](../icollection/add/)(const T\&) | Adiciona elemento à coleção. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Obtém iterador apontando para o primeiro elemento (se houver) da coleção. Este iterador não pode ser usado para alterar o objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) retorna um objeto cópia de T. |
...
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtém iterador apontando logo após o último elemento (se houver) da coleção. Este iterador não pode ser usado para alterar o objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) retorna um objeto cópia de T. |
...
| virtual int [get_Count](../icollection/get_count/)() const | Obtém número de elementos na coleção. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Verifica se a coleção é somente leitura. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../icollection/get_syncroot/)() const | Obtém o objeto pelo qual a coleção está sincronizada. |
...
| [HashSet](./hashset/)() | Informação RTTI. |
| [HashSet](./hashset/)(int) | Cria conjunto vazio com capacidade especificada. |
| [HashSet](./hashset/)(const [SharedPtr](../../system/sharedptr/)\<[IEqualityComparer](../iequalitycomparer/)\<T\>\>\&) | Cria conjunto vazio que utiliza o comparador de igualdade especificado. |
| [HashSet](./hashset/)(const [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\>\&) | Cria hashset baseado em valores enumeráveis. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | Ignora um número especificado de elementos contíguos desde o início de uma sequência e retorna o restante. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Take](../ienumerable/linq_take/)(**int32_t**) | Retorna um número especificado de elementos contíguos desde o início de uma sequência. |
...
| virtual **bool** [Remove](../icollection/remove/)(const T\&) | Exclui elemento da coleção. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de template como weak pointer (em vez de shared). Permite mudar ponteiros em contêineres para modo fraco. |
...
| Typedef | Description |
| --- | --- |
| [ThisType](./thistype/) | Tipo próprio. |
| [BaseType](./basetype/) | Tipo base. |
| [ThisPtr](./thisptr/) | Tipo ponteiro. |

## Observações

Implementação de conjunto baseada em hash. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros em tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-la a funções como argumento.
