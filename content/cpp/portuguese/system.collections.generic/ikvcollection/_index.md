...
| Método | Descrição |
| --- | --- |
| void [Add](./add/)(const T\&) override | Adiciona item ao contêiner. |
...
| **bool** [Contains](./contains/)(const T\&) const override | Verifica se o item está presente no contêiner. |
...
| virtual int [get_Count](./get_count/)() const | Obtém o número de elementos no contêiner. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Verifica se a coleção tem tamanho fixo. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Verifica se o contêiner é somente leitura. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() | Obtém enumerador para o contêiner. |
...
| virtual T [idx_get](./idx_get/)(int) const | Função getter. |
| void [idx_set](./idx_set/)(int, T) override | Função setter. |
| int [IndexOf](./indexof/)(const T\&) const override | Obtém o índice do item no contêiner. |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina se algum elemento da sequência existe ou satisfaz uma condição. |
...
| [ICollection](../icollection/)\& [operator=](../icollection/operator_equal/)([ICollection](../icollection/)\&&) | Operador de atribuição de movimentação. |
| [ICollection](../icollection/)\& [operator=](../icollection/operator_equal/)(const [ICollection](../icollection/)\&) | Operador de atribuição de movimentação. |
...
| **bool** [Remove](./remove/)(const T\&) override | Remove item do contêiner. |
| void [RemoveAt](./removeat/)(int) override | Remove item na posição especificada. |
