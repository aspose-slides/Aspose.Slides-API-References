...
| Parâmetro | Descrição |
| --- | --- |
| Container | Tipo de contêiner no estilo STL. |
| Element | Tipo do elemento. |
## Métodos

| Método | Descrição |
| --- | --- |
| [IEnumerator](../ienumerator/) * [AsVirtualizedIterator](../ienumerator/asvirtualizediterator/)() | Prepara o iterador para ser usado pela classe VirtualizedIterator. |
| [BaseEnumerator](./baseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | Inicializa o iterador. |
| System::Details::VirtualizedIteratorBase\<T\> * [CloneIterator](../ienumerator/cloneiterator/)() const override | Clona o iterador atual. |
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](../ienumerator/get_current/)() const | Obtém o elemento atual. |
...
| void [IncrementIterator](../ienumerator/incrementiterator/)() override | Move o iterador um passo adiante. |
| void [InitializeIterator](../ienumerator/initializeiterator/)() override | Executa a primeira chamada [MoveNext()](../ienumerator/movenext/) e prepara o objeto enumerador para ser usado por VirtualizedIterator. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica se o objeto representa uma instância do tipo descrito por targetType. Análogo ao operador C# 'is'. |
| **bool** [IsValid](./isvalid/)() const | Verifica se [MoveNext()](./movenext/) foi chamado e o fim não foi alcançado. |
| void [Lock](../../system/object/lock/)() | Implementa o bloqueio da instrução C# lock(). Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
| void [MarkOwnedByVirtualizedIterator](../ienumerator/markownedbyvirtualizediterator/)() | Marca o enumerador como pertencente ao iterador virtualizado. |
...
| **bool** [MoveNext](./movenext/)() override | Incremento no estilo enumerador. |
...
| void [Reset](./reset/)() override | Redefine o enumerador para permitir reenumerar os elementos. |
