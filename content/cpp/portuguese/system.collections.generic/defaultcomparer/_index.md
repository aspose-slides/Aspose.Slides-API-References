...
| Parâmetro | Descrição |
| --- | --- |
| T | Tipo sendo comparado. |
## Métodos

| Método | Descrição |
| --- | --- |
| int [Compare](./compare/)(typename [ThisType::args_type](../icomparer/args_type/), typename [ThisType::args_type](../icomparer/args_type/)) const override | Comparação real dos dados. |
