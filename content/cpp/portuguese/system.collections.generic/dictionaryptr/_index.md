...
description: Classe de ponteiro de dicionário com sobrecarga de operadores. Este tipo é um ponteiro para gerenciar a exclusão de outros objetos. Deve ser alocado na pilha e passado para funções tanto por valor quanto por referência constante.
type: docs
weight: 170
url: /pt/system.collections.generic/dictionaryptr/
---
## DictionaryPtr classe


[Dictionary](../dictionary/) classe ponteiro com sobrecarga de operadores. Este tipo é um ponteiro para gerenciar a deleção de outros objetos. Deve ser alocado na pilha e passado para funções tanto por valor quanto por referência constante.
...
| std::enable_if_t\<std::is_same\<Y, T\>::value, [SmartPtr](../../system/smartptr/)\<Y\>\> [Cast](../../system/smartptr/cast/)() const | Converte o ponteiro para o seu próprio tipo. |
...
| std::enable_if_t\<Check::value\&&\!std::is_same\<Y, T\>::value\&&\!std::is_base_of\<Y, T\>::value, [SmartPtr](../../system/smartptr/)\<Y\>\> [Cast](../../system/smartptr/cast/)() const | Converte o ponteiro para um tipo derivado usando dynamic_cast. |
| std::enable_if_t<\!Check::value\&&\!std::is_same\<Y, T\>::value\&&\!std::is_base_of\<Y, T\>::value, [SmartPtr](../../system/smartptr/)\<Y\>\> [Cast](../../system/smartptr/cast/)() const | Converte o ponteiro para um tipo derivado usando dynamic_cast. |
...
|  [DictionaryPtr](./dictionaryptr/)() | Inicializa ponteiro nulo. |
|  [DictionaryPtr](./dictionaryptr/)(const [SharedPtr](../../system/sharedptr/)\<[Dictionary](../dictionary/)\<T, V\>\>\&) | Converte o tipo do ponteiro. |
...
| [Pointee_](../../system/smartptr/pointee_/) * [get_shared](../../system/smartptr/get_shared/)() const | Obtém o objeto apontado, mas verifica que o ponteiro está no modo compartilhado. |
| int [get_shared_count](../../system/smartptr/get_shared_count/)() const | Obtém o número de ponteiros compartilhados existentes para o objeto referenciado, incluindo o atual. Verifica que o ponteiro atual está no modo compartilhado. |
...
| [Object](../../system/object/) * [GetObjectOrNull](../../system/smartptr/getobjectornull/)() const | Obtém o objeto apontado (se houver) ou nullptr. Mesmo que [get()](../../system/smartptr/get/). |
| [Object](../../system/object/) * [GetObjectOwner](../../system/smartptr/getobjectowner/)() const | Obtém o objeto referenciado. |
| [Pointee_](../../system/smartptr/pointee_/) * [GetPointer](../../system/smartptr/getpointer/)() const | Obtém o objeto apontado (se houver) ou nullptr. Mesmo que [get()](../../system/smartptr/get/). |
...
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | Verifica se o ponteiro aponta para outro objeto que não o próprio (criado por um construtor de alias). |
...
| [Pointee_](../../system/smartptr/pointee_/)\& [operator*](../../system/smartptr/operator_star/)() const | Obtém referência ao objeto apontado. Verifica que o ponteiro não é nulo. |
| [Pointee_](../../system/smartptr/pointee_/) * [operator->](../../system/smartptr/operator_minus_greater/)() const | Permite acessar os membros do objeto referenciado. |
...
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&) | Move-assigna objeto [SmartPtr](../../system/smartptr/). x torna-se inutilizável. |
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr_](../../system/smartptr/smartptr_/)\&) | Copy-assigna objeto [SmartPtr](../../system/smartptr/). |
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&) | Copy-assigna objeto [SmartPtr](../../system/smartptr/). Realiza as conversões de tipo necessárias. |
...
| V\& [operator[]](./operator[]/)(const X\&) const | Operador de acesso para trabalhar com conversão de tipo de chave. |
| V\& [operator[]](./operator[]/)(const T\&) const | Operador de acesso. |
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | Remove o aliasing (criado por um construtor de alias) do ponteiro, garantindo que ele gerencia (se compartilhado) ou rastreia (se fraco) o mesmo objeto ao qual aponta. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr_](../../system/smartptr/smartptr_/)\&, [SmartPtrMode](../../system/smartptrmode/)) | Constrói cópia do objeto [SmartPtr](../../system/smartptr/). Ambos os ponteiros apontam para o mesmo objeto depois. |
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Constrói cópia do objeto [SmartPtr](../../system/smartptr/). Ambos os ponteiros apontam para o mesmo objeto depois. Realiza conversão de tipo se permitida. |
|  [SmartPtr](../../system/smartptr/smartptr/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&, [SmartPtrMode](../../system/smartptrmode/)) | Move-constrói objeto [SmartPtr](../../system/smartptr/). Basicamente, troca dois ponteiros, se ambos estiverem no mesmo modo. x pode ficar inutilizável após a chamada. |
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<[Array](../../system/array/)\<Y\>\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Converte o tipo do array referenciado criando um novo array de tipo diferente. Útil se no C# houver um cast de tipo de array que não é suportado em C++. |
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const Y\&) | Inicializa array vazio. Usado para traduzir alguns construções de código C#. |
...
| static const [System::TypeInfo](../../system/typeinfo/)\& [Type](../../system/smartptr/type/)() | Atalho para obter objeto [System::TypeInfo](../../system/typeinfo/) para o tipo Pointee_. |
|  [~SmartPtr](../../system/smartptr/~smartptr/)() | Destrói o objeto [SmartPtr](../../system/smartptr/). Se necessário, diminui o contador de referência do objeto apontado e o exclui. |
