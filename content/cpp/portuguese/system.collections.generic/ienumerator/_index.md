...
description: "Interface de enumerador que pode ser usada para iterar através de alguns elementos. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie uma instância deste tipo na pilha ou usando operator new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 300
url: /pt/system.collections.generic/ienumerator/
---
## IEnumerator classe

Interface de enumerador que pode ser usado para iterar através de alguns elementos. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie uma instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| Método | Descrição |
| --- | --- |
| [IEnumerator](./) * [AsVirtualizedIterator](./asvirtualizediterator/)() | Prepara o iterador para ser usado pela classe VirtualizedIterator. |
| System::Details::VirtualizedIteratorBase\<T\> * [CloneIterator](./cloneiterator/)() const override | Clona o iterador atual. |
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](./current/)() const | Obtém o elemento atual. |
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const | Obtém o elemento atual. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hash de objetos personalizados. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
|  [IEnumerator](./ienumerator/)() |  |
| void [IncrementIterator](./incrementiterator/)() override | Avança o iterador um passo. |
| void [InitializeIterator](./initializeiterator/)() override | Faz a primeira chamada [MoveNext()](./movenext/) e prepara o objeto enumerador para ser usado por VirtualizedIterator. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica se o objeto representa uma instância do tipo descrito por targetType. Análogo ao operador C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementa o bloqueio da instrução C# lock(). Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
| void [MarkOwnedByVirtualizedIterator](./markownedbyvirtualizediterator/)() | Marca o enumerador pertencente ao iterador virtualizado. |
...
| virtual **bool** [MoveNext](./movenext/)() | Move o enumerador para o próximo elemento. Se nenhum elemento foi referenciado antes, define a referência para o primeiro elemento disponível. Se o fim do contêiner for atingido, não faz nada. |
...
| virtual void [Reset](./reset/)() | Redefine o enumerador para a posição antes do primeiro elemento. |
...
int main()
{
  // Crie a instância da classe List.
  ...
  // Obtenha o enumerador da lista.
  auto enumerator = collection->GetEnumerator();

  while (enumerator->MoveNext())
  {
    // Obtenha o elemento atual e imprima-o.
    std::cout << enumerator->get_Current() << ' ';
  }

  // Redefina o enumerador.
  enumerator->Reset();
