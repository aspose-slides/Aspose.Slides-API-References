...
| Método | Descrição |
| --- | --- |
| virtual void [Add](./add/)(const TKey\&, const TValue\&) | Adiciona um par chave-valor ao contêiner. |
...
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Obtém um iterador apontando para o primeiro elemento (se houver) da instância qualificada como const da coleção. |
...
| virtual void [Clear](../icollection/clear/)() | Apaga todos os elementos da coleção. |
| virtual **bool** [Contains](../icollection/contains/)(const T\&) const | Verifica se o elemento está presente na coleção. |
| virtual **bool** [ContainsKey](./containskey/)(const TKey\&) const | Verifica se o contêiner contém a chave. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<[KeyValuePair](../keyvaluepair/)\<TKey, TValue\>\>, int) override | Copia o conteúdo do dicionário para elementos de array existentes. |
...
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Obtém um iterador apontando logo após o último elemento (se houver) da instância qualificada como const da coleção. |
...
| **bool** [get_IsFixedSize](./get_isfixedsize/)() const | Verifica se o tamanho da coleção é fixo. |
| virtual **bool** [get_IsReadOnly](../icollection/get_isreadonly/)() const | Verifica se a coleção é somente leitura. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() const | Verifica se o contêiner é seguro para threads. |
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TKey\>\> [get_Keys](./get_keys/)() const | Acessa a coleção de chaves. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[ICollection](../icollection/)\<TValue\>\> [get_Values](./get_values/)() const | Acessa a coleção de valores. |
...
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey\&) const | Retorna o valor se encontrado; ou **Value()** caso contrário. |
| virtual TValue [GetValueOrDefault](./getvalueordefault/)(const TKey\&, const TValue\&) const | Retorna o valor se encontrado; ou **defaultValue** caso contrário. |
| virtual TValue [GetValueOrNull](./getvalueornull/)(const TKey\&) const | Retorna o valor se encontrado; ou **null** caso contrário, faz sentido apenas para tipos de referência. |
...
| virtual TValue [idx_get](./idx_get/)(const TKey\&) const | Função getter. |
| virtual void [idx_set](./idx_set/)(const TKey\&, TValue) | Função setter. |
...
| virtual **bool** [Remove](./remove/)(const TKey\&) | Remove a chave do contêiner. |
| virtual **bool** [Remove](../icollection/remove/)(const T\&) | Apaga o elemento da coleção. |
...
| virtual **bool** [TryGetValue](./trygetvalue/)(const TKey\&, TValue\&) const | Procura o valor e o recupera se encontrado. |
...
| Typedef | Descrição |
| --- | --- |
| [BaseType](./basetype/) | Tipo de interface base. |
| [KeyValuePairType](./keyvaluepairtype/) | Tipo de par chave-valor. |
