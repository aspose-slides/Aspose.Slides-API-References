...
description: "Lista ordenada envolvendo a estrutura FlatMap. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 547
url: /pt/system.collections.generic/sortedlist/
---
## SortedList classe

Lista ordenada envolvendo a estrutura FlatMap. Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou usando o operador new, pois resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| Método | Descrição |
| --- | --- |
| virtual void [Add](../idictionary/add/)(const TKey\&, const TValue\&) | Adiciona par chave-valor ao contêiner. |
...
| [const_reverse_iterator](./const_reverse_iterator/) [crend](./crend/)() const | Obtém um iterador reverso para um elemento qualificado como const inexistente antes do início da coleção. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtém iterador apontando imediatamente após o último elemento (se houver) da coleção. Este iterador não pode ser usado para alterar o objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) retorna um objeto cópia de T. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IList](../ilist/)\<TKey\>\> [get_Keys](./get_keys/)() const | Acessa a coleção de chaves. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IList](../ilist/)\<TValue\>\> [get_Values](./get_values/)() const | Acessa a coleção de valores. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referências associada ao objeto. |
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Obtém enumerador que itera pela lista atual. |
...
| virtual TValue [GetValueOrNull](../idictionary/getvalueornull/)(const TKey\&) const | Retorna o valor se encontrado; caso contrário **null**, aplicável apenas a tipos de referência. |
...
| int [IndexOfKey](./indexofkey/)(TKey) const | Procura por uma chave específica. |
| int [IndexOfValue](./indexofvalue/)(TValue) const | Procura por um valor específico. |
...
| void [RemoveAt](./removeat/)(int) | Remove o item na posição especificada. |
...
| void [set_Capacity](./set_capacity/)(int) | Define a capacidade atual da lista. |
...
| [SortedList](./sortedlist/)() | Constrói lista vazia. |
| [SortedList](./sortedlist/)(const [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<TKey\>\>\&) | Constrói lista vazia. |
| [SortedList](./sortedlist/)(const [SharedPtr](../../system/sharedptr/)\<[IDictionary](../idictionary/)\<TKey, TValue\>\>\&) | Construtor de cópia. |
| [SortedList](./sortedlist/)(const [map_t](./map_t/)\&) | Construtor de cópia. |
| [SortedList](./sortedlist/)(int) | Constrói lista vazia. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Análogo ao método C# [Object.ToString()](../../system/object/tostring/). Habilita converter objetos personalizados para string. |
...
| [IEnumerablePtr](./ienumerableptr/) | Coleção do mesmo tipo de pares. |
