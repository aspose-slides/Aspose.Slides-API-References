...
type: docs
weight: 92
url: /pt/system.collections.generic/baseset/
---
## BaseSet classe
...
| void [Add](./add/)(const T\&) override | Adiciona elemento ao conjunto. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtém iterador para o primeiro elemento da coleção qualificada como const. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtém iterador para o primeiro elemento qualificado como const da coleção. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtém iterador para um elemento const inexistente após o final da coleção. |
| void [Clear](./clear/)() override | Remove todos os elementos do conjunto. |
| **bool** [Contains](./contains/)(const T\&) const override | Verifica se o elemento está presente no conjunto. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copia o conteúdo do hash para elementos de array existentes. |
| [set_t](./set_t/)\& [data](./data/)() | Acessor da estrutura de dados subjacente. |
| const [set_t](./set_t/)\& [data](./data/)() const | Acessor da estrutura de dados subjacente. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtém iterador para um elemento inexistente após o final da coleção qualificada como const. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula comparação de ponto flutuante no estilo C# onde dois NaN são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não seja igual a nenhum valor, inclusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula comparação de ponto flutuante no estilo C# onde dois NaN são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não seja igual a nenhum valor, inclusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Somente para uso interno. |
| int [get_Count](./get_count/)() const override | Obtém o número de elementos no conjunto. |
| virtual int [get_Count](./get_count/)() const | Mantendo [get_Count()](./get_count/) de ocultar. |
...
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Cria enumerador. |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina se existe algum elemento em uma sequência ou se satisfaz uma condição. |
...
| **bool** [Remove](./remove/)(const T\&) override | Remove elemento do conjunto. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
|  [RTTI_INFO_TEMPLATE_CLASS](./rtti_info_template_class/)([ThisType](./thistype/), System::BaseTypesInfo\<[System::Object](../../system/object/)\>) | Informação RTTI. |
...
| **bool** [TryAdd](./tryadd/)(const T\&) | Adiciona elemento ao conjunto. |
...
| [set_t](./set_t/) | Tipo de dados subjacente. |
...
| [IEnumerablePtr](./ienumerableptr/) | Ponteiro da interface enumerable. |
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator** ponteiro. |
