...
description: "Implementa lista dos valores de um dicionário. Objetos desta classe devem ser alocados apenas usando a função System::MakeObject() . Nunca crie instância deste tipo na pilha ou usando o operador new, pois resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 40
url: /pt/system.collections.generic/_valuelist/
---
## _ValueList classe

Implementa uma lista dos valores de um dicionário. Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie uma instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| Método | Descrição |
| --- | --- |
| [_ValueCollection](../_valuecollection/_valuecollection/)(const typename Dict::Ptr\&) | Inicializa a coleção referenciando o dicionário especificado. |
| [_ValueList](./_valuelist/)(const typename Dict::Ptr\&) | Inicializa a coleção referenciando o dicionário especificado. |
| void [Add](../ikvcollection/add/)(const T\&) override | Adiciona um item ao contêiner. |
| [BaseKVCollection](../basekvcollection/basekvcollection/)(const typename Dict::Ptr\&) | Cria a coleção. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Obtém um iterador apontando para o primeiro elemento (se houver) da coleção. Este iterador não pode ser usado para modificar um objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) retorna um objeto cópia de T. |
...
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Obtém um iterador apontando para o primeiro elemento qualificado como const (se houver) da coleção. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Obtém um iterador apontando logo após o último elemento qualificado como const (se houver) da coleção. |
| void [Clear](../ikvcollection/clear/)() override | Exclui todos os elementos do contêiner. |
| **bool** [Contains](../_valuecollection/contains/)(const [TValue](../_valuecollection/tvalue/)\&) const override | Verifica se o item está presente no contêiner. |
| void [CopyTo](../basekvcollection/copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | Copia os dados para os elementos de array existentes. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtém um iterador apontando logo após o último elemento (se houver) da coleção. Este iterador não pode ser usado para modificar um objeto referenciado porque [GetEnumerator()](../ienumerable/getenumerator/) retorna um objeto cópia de T. |
...
| int [get_Count](../basekvcollection/get_count/)() const override | Obtém o número de elementos. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Verifica se a coleção tem tamanho fixo. |
| **bool** [get_IsReadOnly](../ikvcollection/get_isreadonly/)() const override | Verifica se o contêiner é somente leitura. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TValue](../_valuecollection/tvalue/)\>\> [GetEnumerator](../_valuecollection/getenumerator/)() override | Obtém enumerador que itera pelos valores. |
...
| virtual [TValue](../_valuecollection/tvalue/) [idx_get](./idx_get/)(int) const | Obtém o valor na posição especificada. |
| void [idx_set](../ikvcollection/idx_set/)(int, T) override | Função setter. |
| int [IndexOf](../ikvcollection/indexof/)(const T\&) const override | Obtém o índice do item no contêiner. |
| void [Insert](../ikvcollection/insert/)(int, const T\&) override | Insere o item na posição especificada. |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)() | Determina se a sequência contém algum elemento. |
...
| ResultType [LINQ_Max](../ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Invoca uma função de transformação em cada elemento de uma sequência genérica e retorna o maior valor resultante. |
| ResultType [LINQ_Max](../ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Invoca uma função de transformação em cada elemento de uma sequência genérica e retorna o menor valor resultante. |
...
| **bool** [Remove](../ikvcollection/remove/)(const T\&) override | Remove item do contêiner. |
| void [RemoveAt](../ikvcollection/removeat/)(int) override | Remove item na posição especificada. |
...
| void [SetTemplateWeakPtr](../basekvcollection/settemplateweakptr/)(**uint32_t**) override | Permite compilação, mas na prática não faz nada, pois esta estrutura não possui dados. |
...
| System::Details::VirtualizedIteratorBase\<[TValue](../_valuecollection/tvalue/)\> * [virtualizeBeginConstIterator](../_valuecollection/virtualizebeginconstiterator/)() const override | Obtém a implementação do iterador begin const para o contêiner atual. |
| System::Details::VirtualizedIteratorBase\<[TValue](../_valuecollection/tvalue/)\> * [virtualizeBeginIterator](../_valuecollection/virtualizebeginiterator/)() override | Obtém a implementação do iterador begin para o contêiner atual. |
| System::Details::VirtualizedIteratorBase\<[TValue](../_valuecollection/tvalue/)\> * [virtualizeEndConstIterator](../_valuecollection/virtualizeendconstiterator/)() const override | Obtém a implementação do iterador end const para o contêiner atual. |
| System::Details::VirtualizedIteratorBase\<[TValue](../_valuecollection/tvalue/)\> * [virtualizeEndIterator](../_valuecollection/virtualizeenditerator/)() override | Obtém a implementação do iterador end para o contêiner atual. |
