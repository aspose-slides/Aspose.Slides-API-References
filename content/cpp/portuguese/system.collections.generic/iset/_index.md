...
| virtual void [CopyTo](../icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copia todos os elementos da coleção para elementos de um array existente. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula comparação de ponto flutuante ao estilo C#, onde dois NaNs são considerados iguais mesmo que, segundo IEC 60559:1989, NaN não seja igual a nenhum valor, incluindo NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula comparação de ponto flutuante ao estilo C#, onde dois NaNs são considerados iguais mesmo que, segundo IEC 60559:1989, NaN não seja igual a nenhum valor, incluindo NaN. |
| virtual void [ExceptWith](./exceptwith/)([IEnumerablePtr](./ienumerableptr/)) | Remove um grupo de elementos. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](../ienumerable/getenumerator/)() | Obtém enumerador. |
...
| virtual void [IntersectWith](./intersectwith/)([IEnumerablePtr](./ienumerableptr/)) | Remove elementos que não estão presentes em outro contêiner. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica se o objeto representa uma instância do tipo descrito por targetType. Análogo ao operador C# 'is'. |
| virtual **bool** [IsProperSubsetOf](./ispropersubsetof/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se o conjunto atual é um subconjunto estrito de outro contêiner. |
| virtual **bool** [IsProperSupersetOf](./ispropersupersetof/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se o conjunto atual é um superconjunto estrito de outro contêiner. |
| virtual **bool** [IsSubsetOf](./issubsetof/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se o conjunto atual é um subconjunto de outro contêiner. |
| virtual **bool** [IsSupersetOf](./issupersetof/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se o conjunto atual é um superconjunto de outro contêiner. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Skip](../ienumerable/linq_skip/)(**int32_t**) | Ignora um número especificado de elementos contíguos a partir do início de uma sequência e retorna o restante. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\> [LINQ_Take](../ienumerable/linq_take/)(**int32_t**) | Retorna um número especificado de elementos contíguos a partir do início de uma sequência. |
...
| virtual **bool** [Overlaps](./overlaps/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se o conjunto se sobrepõe a outro contêiner. |
...
| virtual **bool** [SetEquals](./setequals/)([IEnumerablePtr](./ienumerableptr/)) | Verifica se o conjunto e o contêiner contêm os mesmos elementos. |
...
| virtual void [SymmetricExceptWith](./symmetricexceptwith/)([IEnumerablePtr](./ienumerableptr/)) | Calcula a exceção simétrica de dois contêineres. Remove todos os elementos que estão presentes em ambos os contêineres, mas ao mesmo tempo adiciona todos os elementos presentes em **other**, mas não no conjunto atual. |
...
| virtual void [UnionWith](./unionwith/)([IEnumerablePtr](./ienumerableptr/)) | Adiciona elementos da coleção especificada que ainda não estão presentes no conjunto atual. |
...
| Typedef | Descrição |
| --- | --- |
| [IEnumerablePtr](./ienumerableptr/) | Tipo enumerável para comparar o conteúdo do conjunto atual com. |
