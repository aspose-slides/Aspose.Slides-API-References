...
| Método | Descrição |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[DbCommand](../dbcommand/)\> [CreateCommand](./createcommand/)() | Informação RTTI. |
| virtual [SharedPtr](../../system/sharedptr/)\<[DbConnection](../dbconnection/)\> [CreateConnection](./createconnection/)() | Cria conexão com o banco de dados. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-esimo argumento de modelo como um ponteiro fraco (em vez de compartilhado). Permite trocar ponteiros em contêineres para modo fraco. |
