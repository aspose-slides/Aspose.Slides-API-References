...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de template como um ponteiro fraco (ao invés de compartilhado). Permite alternar ponteiros em contêineres para modo fraco. |
