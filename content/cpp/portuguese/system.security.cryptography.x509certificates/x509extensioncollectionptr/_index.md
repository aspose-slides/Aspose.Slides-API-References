...
description: Ponteiro para coleção de extensões X509. Este tipo é um ponteiro para gerenciar a exclusão de outros objetos. Deve ser alocado na pilha e passado para funções por valor ou por referência const.
type: docs
weight: 170
url: /pt/system.security.cryptography.x509certificates/x509extensioncollectionptr/
---
...
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | Verifica se o ponteiro aponta para outro objeto diferente do proprietário (criado por um construtor de aliasing). |
...
| [SharedPtr](../../system/sharedptr/)\<[X509Extension](../x509extension/)\>\& [operator[]](./operator[]/)(**int32_t**) const | Acessor. |
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | Remove aliasing (criado por um construtor de aliasing) do ponteiro, garantindo que ele gerencia (se compartilhado) ou rastreia (se fraco) o mesmo objeto ao qual aponta. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(std::nullptr_t, [SmartPtrMode](../../system/smartptrmode/)) | Cria objeto [SmartPtr](../../system/smartptr/) nulo no modo requerido. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Constrói por cópia o objeto [SmartPtr](../../system/smartptr/). Ambos os ponteiros apontam para o mesmo objeto depois. Executa conversão de tipo se permitido. |
...
|  [X509ExtensionCollectionPtr](./x509extensioncollectionptr/)() | Construtor de ponteiro nulo. |
|  [X509ExtensionCollectionPtr](./x509extensioncollectionptr/)(const [SharedPtr](../../system/sharedptr/)\<[X509ExtensionCollection](../x509extensioncollection/)\>\&) | Construtor. |
