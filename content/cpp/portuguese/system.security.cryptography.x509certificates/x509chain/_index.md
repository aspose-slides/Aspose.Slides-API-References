...
| Método | Descrição |
| --- | --- |
| **bool** [Build](./build/)([SharedPtr](../../system/sharedptr/)\<[X509Certificate2](../x509certificate2/)\>) | NÃO IMPLEMENTADO. |
...
| [SharedPtr](../../system/sharedptr/)\<[X509ChainPolicy](../x509chainpolicy/)\> [get_ChainPolicy](./get_chainpolicy/)() | NÃO IMPLEMENTADO. |
| [ArrayPtr](../../system/arrayptr/)\<[X509ChainStatus](../x509chainstatus/)\> [get_ChainStatus](./get_chainstatus/)() | NÃO IMPLEMENTADO. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento template como ponteiro fraco (em vez de compartilhado). Permite mudar ponteiros em contêineres para modo fraco. |
