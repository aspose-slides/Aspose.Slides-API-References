...
| virtual [Aspose::Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/) [get_BlackWhiteMode](../../aspose.slides/ishape/get_blackwhitemode/)() | Propriedade que especifica como uma forma será renderizada no modo de exibição preto-e-branco. Leia [Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/). |
...
| virtual **float** [get_Height](../../aspose.slides/ishape/get_height/)() | Obtém a altura da forma, medida em pontos. Somente leitura **float**. |
| virtual **bool** [get_Hidden](../../aspose.slides/ishape/get_hidden/)() | Determina se a forma está oculta. Somente leitura **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGroupShape](../../aspose.slides/igroupshape/)\> [get_ParentGroup](../../aspose.slides/ishape/get_parentgroup/)() | Retorna o objeto pai [GroupShape](../../aspose.slides/groupshape/) se a forma estiver agrupada. Caso contrário, retorna null. Somente leitura [IGroupShape](../../aspose.slides/igroupshape/). |
...
| virtual **float** [get_Rotation](../../aspose.slides/ishape/get_rotation/)() | Retorna o número de graus que a forma especificada está rotacionada ao redor do eixo z. Um valor positivo indica rotação horário; um valor negativo indica rotação anti-horário. Somente leitura **float**. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IInkTrace](../iinktrace/)\>\> [get_Traces](./get_traces/)() | Obtém todos os traços contidos no elemento [IInk](./) [IInkTrace](../iinktrace/). Somente leitura. |
...
| virtual **float** [get_Width](../../aspose.slides/ishape/get_width/)() | Obtém a largura da forma, medida em pontos. Somente leitura **float**. |
| virtual **float** [get_X](../../aspose.slides/ishape/get_x/)() | Obtém a coordenada x do canto superior esquerdo da forma, medida em pontos. Somente leitura **float**. |
| virtual **float** [get_Y](../../aspose.slides/ishape/get_y/)() | Obtém a coordenada y do canto superior esquerdo da forma, medida em pontos. Somente leitura **float**. |
| virtual **int32_t** [get_ZOrderPosition](../../aspose.slides/ishape/get_zorderposition/)() | Retorna a posição de uma forma na ordem Z. Shapes[0] retorna a forma mais ao fundo da ordem Z, e Shapes[Shapes.Count - 1] retorna a forma mais à frente da ordem Z. Somente leitura **int32_t**. |
...
| virtual void [set_BlackWhiteMode](../../aspose.slides/ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/)) | Propriedade que especifica como uma forma será renderizada no modo de exibição preto-e-branco. Escreva [Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/). |
...
| virtual void [set_Rotation](../../aspose.slides/ishape/set_rotation/)(**float**) | Define o número de graus que a forma especificada está rotacionada ao redor do eixo z. Um valor positivo indica rotação horário; um valor negativo indica rotação anti-horário. Escreva **float**. |
