...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se duas instâncias de [TransitionValueBase](../transitionvaluebase/) são iguais. |
...
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | Especifica a forma dos elementos visuais usados durante a transição. Leia [TransitionShredPattern](../transitionshredpattern/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Serve como função de hash para um tipo específico, adequada para uso em algoritmos de hash e estruturas de dados como uma tabela de hash. |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Direção da transição. Grava [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | Especifica a forma dos elementos visuais usados durante a transição. Grava [TransitionShredPattern](../transitionshredpattern/). |
