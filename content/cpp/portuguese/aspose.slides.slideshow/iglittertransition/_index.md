...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula comparação de ponto flutuante em estilo C# onde dois NaN são considerados iguais ainda que, de acordo com IEC 60559:1989, NaN não seja igual a nenhum valor, inclusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula comparação de ponto flutuante em estilo C# onde dois NaN são considerados iguais ainda que, de acordo com IEC 60559:1989, NaN não seja igual a nenhum valor, inclusive NaN. |
...
| virtual [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() | Especifica a forma dos visuais usados durante a transição. Leia [TransitionPattern](../transitionpattern/). |
...
| virtual void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) | Especifica a forma dos visuais usados durante a transição. Grava [TransitionPattern](../transitionpattern/). |
