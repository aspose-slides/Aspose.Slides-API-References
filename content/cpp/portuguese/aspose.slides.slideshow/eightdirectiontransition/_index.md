...
| [TransitionEightDirectionType](../transitioneightdirectiontype/) [get_Direction](./get_direction/)() override | Direção da transição. Leia [TransitionEightDirectionType](../transitioneightdirectiontype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Funciona como uma função hash para um tipo específico, adequada para uso em algoritmos de hashing e estruturas de dados como uma tabela hash. |
...
| void [set_Direction](./set_direction/)([TransitionEightDirectionType](../transitioneightdirectiontype/)) override | Direção da transição. Escreva [TransitionEightDirectionType](../transitioneightdirectiontype/). |
...
* Classe [IEightDirectionTransition](../ieightdirectiontransition/)
