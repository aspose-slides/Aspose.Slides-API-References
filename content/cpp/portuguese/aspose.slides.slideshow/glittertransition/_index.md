...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se as duas instâncias de [TransitionValueBase](../transitionvaluebase/) são iguais. |
...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | Direção da transição. Leia [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | Especifica a forma dos elementos visuais usados durante a transição. Leia [TransitionPattern](../transitionpattern/). |
...
| void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) override | Direção da transição. Grave [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | Especifica a forma dos elementos visuais usados durante a transição. Grave [TransitionPattern](../transitionpattern/). |
