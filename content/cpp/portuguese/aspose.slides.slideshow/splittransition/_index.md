...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Direção da divisão de transição. Leia [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() override | Orientação da divisão de transição. Leia [Slides::Orientation](../../aspose.slides/orientation/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Funciona como uma função hash para um tipo específico, adequada para uso em algoritmos de hash e estruturas de dados como uma tabela hash. |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Direção da divisão de transição. Grave [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) override | Orientação da divisão de transição. Grave [Slides::Orientation](../../aspose.slides/orientation/). |
