...
description: Efeito de transição deslizante da roda.
type: docs
weight: 287
...
Efeito de transição deslizante da roda.
...
| virtual **uint32_t** [get_Spokes](./get_spokes/)() | Número de raios da transição da roda. Leitura **uint32_t**. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analítico do método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonar tipos personalizados. |
...
| virtual void [set_Spokes](./set_spokes/)(**uint32_t**) | Número de raios da transição da roda. Escrita **uint32_t**. |
