...
description: Efeito de transição de slide na direção lateral.
type: docs
weight: 391
...
Efeito de transição de slide na direção lateral.
...
| void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) override | Direção da transição. Escreva [TransitionSideDirectionType](../transitionsidedirectiontype/). |
