...
description: Efeito de transição de roda deslizante.
type: docs
weight: 443
...
Efeito de transição de roda deslizante.
...
| **uint32_t** [get_Spokes](./get_spokes/)() override | Número de raios da transição de roda. Leitura de **uint32_t**. |
...
| void [set_Spokes](./set_spokes/)(**uint32_t**) override | Número de raios da transição de roda. Escrita de **uint32_t**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n'th argumento de modelo como um ponteiro fraco (em vez de compartilhado). Permite alternar ponteiros em contêineres para modo fraco. |
...
* Classe [IWheelTransition](../iwheeltransition/)
