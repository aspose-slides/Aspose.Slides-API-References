...
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Funciona como função hash para um tipo específico, adequado para uso em algoritmos de hash e estruturas de dados como uma tabela hash. |
...
* Classe [IEmptyTransition](../iemptytransition/)
