...
description: Efeito de transição de slide Shred.
type: docs
weight: 235
...
Efeito de transição de slide Shred.
...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Direção da transição. Leia [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() | Especifica a forma dos visuais usados durante a transição. Leia [TransitionShredPattern](../transitionshredpattern/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Direção da transição. Escreva [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) | Especifica a forma dos visuais usados durante a transição. Escreva [TransitionShredPattern](../transitionshredpattern/). |
