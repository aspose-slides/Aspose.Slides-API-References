...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Este atributo especifica se a transição iniciará a partir de uma tela preta (e então transitará o novo slide sobre o preto). Leia **bool**. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analítico ao método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonagem de tipos personalizados. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Este atributo especifica se a transição iniciará a partir de uma tela preta (e então transitará o novo slide sobre o preto). Grave **bool**. |
