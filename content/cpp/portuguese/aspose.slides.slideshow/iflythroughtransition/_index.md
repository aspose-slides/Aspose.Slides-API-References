...
| virtual **bool** [get_HasBounce](./get_hasbounce/)() | Especifica que o movimento dos slides da apresentação durante a transição inclui um salto. Leia **bool**. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Direção da transição. Grave [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_HasBounce](./set_hasbounce/)(**bool**) | Especifica que o movimento dos slides da apresentação durante a transição inclui um salto. Grave **bool**. |
