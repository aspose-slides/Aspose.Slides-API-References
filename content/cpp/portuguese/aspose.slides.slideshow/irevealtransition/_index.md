...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | Direção da transição. Leia [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| virtual **bool** [get_ThroughBlack](./get_throughblack/)() | Especifica se a transição desfoca através do preto. Leia **bool**. |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | Direção da transição. Grava [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
| virtual void [set_ThroughBlack](./set_throughblack/)(**bool**) | Especifica se a transição desvanece através do preto. Grava **bool**. |
