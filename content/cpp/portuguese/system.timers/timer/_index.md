...
description: Timer que chama delegate em um loop.
type: docs
weight: 14
url: /pt/system.timers/timer/
---
## Timer classe


[Timer](./) que chama delegate em um loop.
...
| Método | Descrição |
| --- | --- |
| void [Close](./close/)() | Interrompe o timer, libera os recursos alocados. |
|  [Component](../../system.componentmodel/component/component/)() | Informação RTTI. |
| void [Dispose](./dispose/)() | Interrompe o timer, libera os recursos alocados. |
| void [Dispose](../../system.componentmodel/component/dispose/)(**bool**) | Suporte ao padrão Disposable; não faz nada. |
...
| **bool** [get_AutoReset](./get_autoreset/)() const | Verifica se o timer está no modo de auto-reinício. |
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | Verifica se o componente está no modo de design. |
| **bool** [get_Enabled](./get_enabled/)() const | Verifica se o timer está ativo. |
| **double** [get_Interval](./get_interval/)() const | Obtém o intervalo do timer. |
| **bool** [get_IsStopped](./get_isstopped/)() const | Verifica se o timer está parado. |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | Define o timer no modo de auto-reinício ou o desativa. |
| void [set_Enabled](./set_enabled/)(**bool**) | Inicia ou para o timer. Iniciar o timer não reinicia a contagem de tempo se o timer já estiver em execução. |
| void [set_Interval](./set_interval/)(**double**) | Define o intervalo do timer. |
...
| void [Start](./start/)() | Inicia o timer. Não reinicia a contagem de tempo se o timer já estiver em execução. |
| void [Stop](./stop/)() | Para o timer. |
|  [Timer](./timer/)() | Informação RTTI. |
|  [Timer](./timer/)(**double**) | Constrói um timer parado com o intervalo especificado. |
