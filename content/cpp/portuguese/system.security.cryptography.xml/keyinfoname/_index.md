...
description: "Representa o subelemento 'KeyName' do XMLDSIG ou o elemento de criptografia XML 'KeyInfo'. Objetos desta classe devem ser alocados apenas usando a função System::MakeObject(). Nunca crie uma instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo às funções como argumento."
type: docs
weight: 53
url: /pt/system.security.cryptography.xml/keyinfoname/
---
## KeyInfoName classe

Representa o subelemento 'KeyName' do XMLDSIG ou o elemento de criptografia XML '[KeyInfo](../keyinfo/)'. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie uma instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo às funções como argumento.
...
* Espaço de nomes [System::Security::Cryptography::Xml](../)
