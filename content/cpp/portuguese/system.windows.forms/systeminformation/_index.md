...
description: Classe fictícia para tornar o código traduzido que usa a classe SystemInformation compilável. Métodos não estão implementados. Este é um tipo estático sem serviços de instância. Você nunca deve criar instâncias dela por nenhum meio.
type: docs
weight: 53
url: /pt/system.windows.forms/systeminformation/
---
## SystemInformation struct

Classe fictícia para tornar o código traduzido que usa a classe [SystemInformation](./) compilável. Métodos não estão implementados. Este é um tipo estático sem serviços de instância. Você nunca deve criar instâncias dele por nenhum meio.
