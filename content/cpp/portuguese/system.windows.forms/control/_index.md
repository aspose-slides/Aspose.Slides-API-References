...
description: "Classe fictícia para tornar o código traduzido que usa a classe Control compilável. Os métodos não são implementados. Objetos desta classe devem ser alocados somente usando a função System::MakeObject() . Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 1
url: /pt/system.windows.forms/control/
---
## Classe de controle

Classe fictícia para tornar o código traduzido que utiliza a classe [Control](./) compilável. Os métodos não são implementados. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| Método | Descrição |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Drawing::Graphics](../../system.drawing/graphics/)\> [CreateGraphics](./creategraphics/)() | Informação RTTI. |
...
| void [Lock](../../system/object/lock/)() | Implementa a declaração C# lock() travando. Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
...
* Espaço de nomes [System::Windows::Forms](../)
