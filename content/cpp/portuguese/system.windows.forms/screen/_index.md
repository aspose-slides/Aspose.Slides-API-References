...
description: Fornece informações sobre monitores. Apenas Windows. Este é um tipo singleton com gerenciamento de memória feito por função(s) de acesso. Você nunca deve criar instâncias dele diretamente.
type: docs
weight: 40
url: /pt/system.windows.forms/screen/
---
## Screen classe

Fornece informações sobre monitores. [Windows](../../system.windows/) apenas. Este é um tipo singleton com gerenciamento de memória feito por função(s) de acesso. Você nunca deve criar instâncias dele diretamente.
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | Obtém os limites da tela. |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | Obtém informações sobre o monitor principal. |
