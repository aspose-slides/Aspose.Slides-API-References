...
description: "Classe fictícia para tornar o código traduzido que usa a interface IButtonControl compilável. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 27
url: /pt/system.windows.forms/ibuttoncontrol/
---
## IButtonControl classe


Classe fictícia para tornar o código traduzido que usa a interface [IButtonControl](./) compilável. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou utilizando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| virtual [DialogResult](../dialogresult/) [get_DialogResult](./get_dialogresult/)() | Obtém o resultado de diálogo associado ao botão. |
...
| virtual void [NotifyDefault](./notifydefault/)(**bool**) | Define o controle como padrão ou não padrão. |
...
| virtual void [PerformClick](./performclick/)() | Executa um clique no botão. |
...
| virtual void [set_DialogResult](./set_dialogresult/)([DialogResult](../dialogresult/)) | Define o resultado de diálogo associado ao botão. |
