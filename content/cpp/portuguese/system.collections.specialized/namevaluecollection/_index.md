...
description: Coleção de chaves String associadas e valores String que podem ser acessados tanto pela chave quanto pelo índice.
type: docs
weight: 14
url: /pt/system.collections.specialized/namevaluecollection/
---
## NameValueCollection classe


Coleção de [String](../../system/string/) chaves associadas e [String](../../system/string/) valores que podem ser acessados tanto pela chave quanto pelo índice.
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const [String](../../system/string/)\&) override | Sobrescreve o método [ICollection](../../system.collections/icollection/) – não implementado. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | Copia as entradas no [NameValueCollection](./) especificado para a atual. |
| virtual void [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Adiciona uma entrada com o nome e o valor especificados. |
...
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) const override | Verifica se o item está presente na coleção. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\>, **int32_t**) override | Copia os elementos da coleção para elementos de array existentes. |
...
| virtual [String](../../system/string/) [Get](./get/)(const [String](../../system/string/)\&) | Obtém os valores associados à chave especificada. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [get_AllKeys](./get_allkeys/)() | Obtém todas as chaves. |
| int [get_Count](./get_count/)() const override | Obtém o número de pares chave/valor. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[String](../../system/string/)\>\> [get_Keys](./get_keys/)() | Obtém todas as chaves. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Obtém enumerador para iterar através da coleção. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[String](../../system/string/)\> [GetValues](./getvalues/)(const [String](../../system/string/)\&) | Obtém os valores associados à chave especificada. |
| **bool** [HasKeys](./haskeys/)() | Obtém um valor indicando se o [NameValueCollection](./) contém chaves que não são nulas. |
...
| [String](../../system/string/) [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Obtém valor no índice especificado. |
| void [idx_set](./idx_set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Define o valor de uma entrada. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Retorna o primeiro elemento da sequência que satisfaça a condição ou um valor padrão se nenhum elemento for encontrado. |
...
|  [NameValueCollection](./namevaluecollection/)() | Inicializa uma nova instância da classe [NameValueCollection](./) que está vazia. |
|  [NameValueCollection](./namevaluecollection/)(const [System::SharedPtr](../../system/sharedptr/)\<[NameValueCollection](./)\>\&) | Copia as entradas do [NameValueCollection](./) especificado para um novo [NameValueCollection](./). |
...
| **bool** [Remove](./remove/)(const [String](../../system/string/)\&) override | Remove item específico. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| virtual void [Set](./set/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Define o valor de uma entrada. |
...
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtém a implementação do iterador begin const para o container atual. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Obtém a implementação do iterador begin para o container atual. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtém a implementação do iterador end const para o container atual. |
| System::Details::VirtualizedIteratorBase\<[System::String](../../system/string/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtém a implementação do iterador end para o container atual. |
