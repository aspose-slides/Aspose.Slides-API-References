...
description: Coleção de strings ponteiro com operador de acesso.
type: docs
weight: 40
url: /pt/system.collections.specialized/stringcollectionptr/
---
## StringCollectionPtr classe

Coleção de strings ponteiro com operador de acesso.
...
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | Verifica se o ponteiro aponta para um objeto diferente do proprietário (criado por um construtor de alias). |
...
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&) | Copia-atribui o objeto [SmartPtr](../../system/smartptr/). Realiza as conversões de tipo necessárias. |
...
| [System::String](../../system/string/)\& [operator[]](./operator[]/)(int) const | Função de acesso. |
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | Remove o alias (criado por um construtor de alias) do ponteiro, garantindo que ele gerencie (se compartilhado) ou rastreie (se fraco) o mesmo objeto ao qual aponta. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(std::nullptr_t, [SmartPtrMode](../../system/smartptrmode/)) | Cria um objeto [SmartPtr](../../system/smartptr/) nulo no modo requerido. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr_](../../system/smartptr/smartptr_/)\&, [SmartPtrMode](../../system/smartptrmode/)) | Constrói por cópia o objeto [SmartPtr](../../system/smartptr/). Ambos os ponteiros apontam para o mesmo objeto posteriormente. |
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Constrói por cópia o objeto [SmartPtr](../../system/smartptr/). Ambos os ponteiros apontam para o mesmo objeto posteriormente. Realiza conversão de tipo se permitido. |
|  [SmartPtr](../../system/smartptr/smartptr/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&, [SmartPtrMode](../../system/smartptrmode/)) | Move-constroi o objeto [SmartPtr](../../system/smartptr/). Efetivamente troca dois ponteiros, se ambos estiverem no mesmo modo. x pode ficar inutilizável após a chamada. |
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<[Array](../../system/array/)\<Y\>\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Converte o tipo da matriz referenciada criando uma nova matriz de tipo diferente. Útil se em C# houver um cast de tipo de matriz que não é suportado em C++. |
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const Y\&) | Inicializa uma matriz vazia. Usado para traduzir alguns construtos de código C#. |
...
|  [StringCollectionPtr](./stringcollectionptr/)() | Constrói ponteiro nulo. |
|  [StringCollectionPtr](./stringcollectionptr/)(const [SharedPtr](../../system/sharedptr/)\<[StringCollection](../stringcollection/)\>\&) | Constrói ponteiro para uma coleção específica. |
| [SmartPtr](../../system/smartptr/)\<[Object](../../system/object/)\> [ToObjectPtr](../../system/smartptr/toobjectptr/)() const | Converte qualquer tipo de ponteiro para ponteiro a [Object](../../system/object/). Não requer que o tipo Pointee_ seja completo. |
...
|  [~SmartPtr](../../system/smartptr/~smartptr/)() | Destroi o objeto [SmartPtr](../../system/smartptr/). Se necessário, diminui o contador de referências do objeto apontado e exclui o objeto. |

## Veja Também

* Classe [SmartPtr](../../system/smartptr/)
* Espaço de nomes [System::Collections::Specialized](../)
