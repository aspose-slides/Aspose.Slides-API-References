...
description: "Dicionário de string para string. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 53
url: /pt/system.collections.specialized/stringdictionary/
---
## StringDictionary classe


[String](../../system/string/) para dicionário de strings. Objetos desta classe só devem ser alocados usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| Método | Descrição |
| --- | --- |
| virtual void [Add](../../system.collections.generic/idictionary/add/)(const TKey\&, const TValue\&) | Adiciona um par chave-valor ao contêiner. |
| virtual void [Add](../../system.collections.generic/icollection/add/)(const T\&) | Adiciona um elemento à coleção. |
...
| void [CopyTo](../../system.collections.generic/idictionary/copyto/)([ArrayPtr](../../system/arrayptr/)\<[KeyValuePair](../../system.collections.generic/keyvaluepair/)\<TKey, TValue\>\>, int) override | Copia o conteúdo do dicionário para elementos existentes de um array. |
|  [Dictionary](../../system.collections.generic/dictionary/dictionary/)() | Cria um dicionário vazio. |
...
|  [Dictionary](../../system.collections.generic/dictionary/dictionary/)(int) | Sobrecarga que corresponde à criação de um dicionário pré-alocado; na prática não realiza alocação. |
...
|  [Dictionary](../../system.collections.generic/dictionary/dictionary/)(const [SharedPtr](../../system/sharedptr/)\<[IEqualityComparer](../../system.collections.generic/iequalitycomparer/)\<TKey\>\>\&) | Cria um dicionário vazio. |
|  [Dictionary](../../system.collections.generic/dictionary/dictionary/)(int, const [SharedPtr](../../system/sharedptr/)\<[IEqualityComparer](../../system.collections.generic/iequalitycomparer/)\<TKey\>\>\&) | Cria um dicionário vazio. |
...
| **bool** [get_IsSynchronized](../../system.collections.generic/idictionary/get_issynchronized/)() const | Verifica se o contêiner é seguro para threads. |
...
| [IEnumeratorPtr](../../system.collections.generic/dictionary/ienumeratorptr/) [GetEnumerator](../../system.collections.generic/dictionary/getenumerator/)() override | Cria um objeto enumerador. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hash de objetos personalizados. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey\&) const | Retorna o valor se encontrado; caso contrário, **Value()**. |
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey\&, const TValue\&) const | Retorna o valor se encontrado; caso contrário, **defaultValue**. |
| virtual TValue [GetValueOrNull](../../system.collections.generic/idictionary/getvalueornull/)(const TKey\&) const | Retorna o valor se encontrado; caso contrário, **null**, o que faz sentido apenas para tipos de referência. |
...
| [String](../../system/string/) [idx_get](./idx_get/)(const [String](../../system/string/)\&) const override | Obtém o valor de uma chave específica. |
...
| virtual **bool** [Remove](../../system.collections.generic/idictionary/remove/)(const TKey\&) | Remove a chave do contêiner. |
