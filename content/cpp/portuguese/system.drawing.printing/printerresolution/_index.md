...
description: "Representa uma resolução de uma impressora. Objetos desta classe devem ser alocados apenas usando a função System::MakeObject() . Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 66
url: /pt/system.drawing.printing/printerresolution/
---
## PrinterResolution classe

Representa uma resolução de uma impressora. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| int [get_X](./get_x/)() const | Retorna a resolução horizontal. |
| int [get_Y](./get_y/)() const | Retorna a resolução vertical. |
...
| void [set_X](./set_x/)(int) | Define a resolução horizontal. |
| void [set_Y](./set_y/)(int) | Define a resolução vertical. |
