...
type: docs
weight: 27
url: /pt/system.drawing.printing/papersize/
---
## PaperSize classe
...
| **int32_t** [get_Height](./get_height/)() const | Obtém a altura do papel, em centésimos de polegada. |
| [PaperKind](../paperkind/) [get_Kind](./get_kind/)() const | Obtém o tipo de papel. |
| [System::String](../../system/string/) [get_PaperName](./get_papername/)() const | Obtém o nome do tipo de papel. |
| **int32_t** [get_RawKind](./get_rawkind/)() const | Obtém um inteiro representando um dos valores [System::Drawing::Printing::PaperSize](./) ou um valor personalizado. |
| **int32_t** [get_Width](./get_width/)() const | Obtém a largura do papel, em centésimos de polegada. |
...
|  [PaperSize](./papersize/)() | Inicializa uma nova instância da classe [System::Drawing::Printing::PaperSize](./). |
|  [PaperSize](./papersize/)([PaperKind](../paperkind/), [System::String](../../system/string/), **int32_t**, **int32_t**) | Inicializa uma nova instância da classe [System::Drawing::Printing::PaperSize](./). |
|  [PaperSize](./papersize/)([System::String](../../system/string/), **int32_t**, **int32_t**) | Inicializa uma nova instância da classe [System::Drawing::Printing::PaperSize](./). |
...
| void [set_Height](./set_height/)(**int32_t**) | Define a altura do papel, em centésimos de polegada. |
| void [set_PaperName](./set_papername/)([System::String](../../system/string/)) | Define o nome do tipo de papel. |
| void [set_RawKind](./set_rawkind/)(**int32_t**) | Define um inteiro representando um dos valores [System::Drawing::Printing::PaperSize](./) ou um valor personalizado. |
| void [set_Width](./set_width/)(**int32_t**) | Define a largura do papel, em centésimos de polegada. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Fornece informações sobre o [System::Drawing::Printing::PaperSize](./) em forma de string. |
...
* Espaço de nomes [System::Drawing::Printing](../)
