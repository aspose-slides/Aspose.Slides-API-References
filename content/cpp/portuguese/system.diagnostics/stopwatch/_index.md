...
description: "Permite a medição de tempo. Objetos desta classe devem ser alocados apenas usando a função System::MakeObject(). Nunca crie uma instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo às funções como argumento."
type: docs
weight: 79
url: /pt/system.diagnostics/stopwatch/
---
## Stopwatch classe

Permite a medição de tempo. Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie uma instância deste tipo na pilha ou usando operator new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo às funções como argumento.
...
| [TimeSpan](../../system/timespan/) [get_Elapsed](./get_elapsed/)() const | Obtém o tempo total decorrido medido pela instância atual. |
| **int64_t** [get_ElapsedMilliseconds](./get_elapsedmilliseconds/)() const | Obtém o tempo total decorrido medido pela instância atual, em milissegundos. |
| **int64_t** [get_ElapsedTicks](./get_elapsedticks/)() const | Obtém o tempo total decorrido medido pela instância atual, em ticks do temporizador. |
| **bool** [get_IsRunning](./get_isrunning/)() const | Verifica se o cronômetro está em execução. |
...
| void [Reset](./reset/)() | Interrompe a medição de tempo, define o intervalo medido como zero. |
| void [Restart](./restart/)() | Define o intervalo medido como zero e, então, inicia a medição de tempo. |
...
| void [Start](./start/)() | Inicia a medição de tempo. |
| static [SharedPtr](../../system/sharedptr/)\<[Stopwatch](./)\> [StartNew](./startnew/)() | Cria um novo objeto [Stopwatch](./) e inicia a medição. |
| void [Stop](./stop/)() | Interrompe a medição de tempo. |
| [Stopwatch](./stopwatch/)() | Informação RTTI. |
...
| virtual  [~Stopwatch](./~stopwatch/)() | Destruidor. |
