...
description: "Classe fictícia para código traduzido que usa PerformanceCounter para compilar. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo às funções como argumento."
type: docs
weight: 14
url: /pt/system.diagnostics/performancecounter/
---
## PerformanceCounter classe

Classe fictícia para código traduzido que usa PerformanceCounter para compilar. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo às funções como argumento.
...
| Método | Descrição |
| --- | --- |
| void [Close](./close/)() | Interrompe todas as operações de contagem de desempenho. |
...
| **float** [NextValue](./nextvalue/)() | Obtém o próximo valor medido. |
...
|  [PerformanceCounter](./performancecounter/)() | Cria contador de desempenho. |
|  [PerformanceCounter](./performancecounter/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Cria contador de desempenho de categoria específica. |
|  [PerformanceCounter](./performancecounter/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Cria contador de desempenho de categoria e nome de instância específicos. |
