...
description: Uma fonte de token de cancelamento que pode ser usada para disparar notificações de cancelamento.
type: docs
weight: 40
url: /pt/system.threading/cancellationtokensource/
---
## CancellationTokenSource classe

Uma fonte de token de cancelamento que pode ser usada para disparar notificações de cancelamento.
...
| Método | Descrição |
| --- | --- |
| void [Cancel](./cancel/)() | Comunica uma solicitação de cancelamento. |
| [CancellationTokenSource](./cancellationtokensource/)() | Constrói um novo [CancellationTokenSource](./). |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | Cria uma fonte de token vinculada que cancela quando qualquer um dos tokens fornecidos cancela. |
| void [Dispose](./dispose/)() override | Libera todos os recursos usados pelo [CancellationTokenSource](./). |
...
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | Obtém se o cancelamento foi solicitado. |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | Obtém o token de cancelamento associado a esta fonte. |
...
Fornece mecanismos para criar e controlar tokens de cancelamento para cancelamento cooperativo de operações.
