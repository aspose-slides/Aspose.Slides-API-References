...
description: Fornece a funcionalidade básica para propagar um contexto de sincronização através de várias operações de sincronização.
type: docs
weight: 196
url: /pt/system.threading/synchronizationcontext/
---
## SynchronizationContext classe

Fornece a funcionalidade básica para propagar um contexto de sincronização através de várias operações de sincronização.
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | Obtém o contexto de sincronização para a thread atual. |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Executa o callback de forma assíncrona. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Executa o callback de forma síncrona. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | Define o contexto de sincronização para a thread atual. |
...
|  [SynchronizationContext](./synchronizationcontext/)() | Constrói uma nova instância de [SynchronizationContext](./). |
...
Esta classe permite a propagação do contexto de sincronização entre threads e é usada para encaminhar callbacks ou invocações para a thread ou contexto de sincronização apropriado. 
