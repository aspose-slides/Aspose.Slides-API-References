...
| Método | Descrição |
| --- | --- |
| virtual void [Close](../waithandle/close/)() | Libera qualquer recurso associado ao handle. |
...
|  [EventWaitHandle](../eventwaithandle/eventwaithandle/)(**bool**, [EventResetMode](../eventresetmode/)) | Construtor. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Somente para fins internos. |
| [wait_handle_t](../wait_handle_t/) [get_Handle](../waithandle/get_handle/)() | Obtém o handle. |
...
|  [ManualResetEvent](./manualresetevent/)(**bool**) | Construtor. |
...
| virtual **bool** [Reset](../eventwaithandle/reset/)() | Define o evento para estado não sinalizador. |
| virtual **bool** [Set](../eventwaithandle/set/)() | Define o evento para estado sinalizador. |
...
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Aguarda todos os handles dispararem. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Aguarda todos os handles dispararem. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Aguarda todos os handles dispararem. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Aguarda que qualquer um dos handles dispare. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Aguarda que qualquer um dos handles dispare. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Aguarda que qualquer um dos handles dispare. |
| virtual **bool** [WaitOne](../waithandle/waitone/)() | Aguarda que o handle dispare por período ilimitado. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int) | Aguarda que o handle dispare. |
| virtual **bool** [WaitOne](../waithandle/waitone/)([TimeSpan](../../system/timespan/)) | Aguarda que o handle dispare. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int, **bool**) | Aguarda que o handle dispare. |
...
|  [~EventWaitHandle](../eventwaithandle/~eventwaithandle/)() | Destrutor. |
...
| Campo | Descrição |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Valor especial a ser retornado pela função, que caso contrário retornaria o índice do objeto sinalizado no array, se o tempo limite expirar e nada sinalizar. |
