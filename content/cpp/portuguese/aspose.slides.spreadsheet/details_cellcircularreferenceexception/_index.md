...
description: A exceção lançada quando uma ou mais referências circulares são detectadas onde uma fórmula refere-se à sua própria célula, seja direta ou indiretamente.
type: docs
weight: 1
url: /pt/aspose.slides.spreadsheet/details_cellcircularreferenceexception/
---
## Details_CellCircularReferenceException classe


A exceção lançada quando uma ou mais referências circulares são detectadas onde uma fórmula refere-se à sua própria célula, seja direta ou indiretamente.
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Obtém uma referência de célula circular. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Define HRESULT, um valor numérico codificado atribuído a uma exceção específica. |
