...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | Retorna os dados de arquivo de um objeto OLE incorporado somente leitura **uint8_t**[]. |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | Retorna a extensão de arquivo para o objeto OLE incorporado atual somente leitura [System::String](../../system/string/). |
...
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)() | Cria novas informações de dados incorporados para objeto OLE. |
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | Cria uma nova instância de informações de dados incorporados para objeto OLE. |
