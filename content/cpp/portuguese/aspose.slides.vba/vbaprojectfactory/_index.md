...
| Método | Descrição |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [CreateVbaProject](./createvbaproject/)() override | Cria um novo projeto VBA. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaProjectFactory](./)\> [get_Instance](./get_instance/)() | Instância estática da fábrica de projetos VBA. Somente leitura [VbaProjectFactory](./). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Construtor de cópia. Na verdade não copia nada, apenas inicializa um novo objeto e permite a cópia de construtores nas subclasses. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de atribuição. Na verdade não copia nada, apenas inicializa um novo objeto e permite a cópia de construtores nas subclasses. |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [ReadVbaProject](./readvbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Lê o projeto VBA do contêiner OLE. |
...
* Classe [IVbaProjectFactory](../ivbaprojectfactory/)
