...
| Método | Descrição |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)\> [CreateOleTypeLibReference](./createoletypelibreference/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Cria uma nova referência de biblioteca de tipos OLE Automation. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaReferenceFactory](./)\> [get_Instance](./get_instance/)() | Instância estática da fábrica de referências de projetos VBA. Somente leitura [VbaReferenceFactory](./). |
...
* Classe [IVbaReferenceFactory](../ivbareferencefactory/)
