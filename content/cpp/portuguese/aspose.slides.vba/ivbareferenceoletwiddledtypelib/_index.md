...
description: Representa uma referência de biblioteca de tipos OLE Automation modificada na qual todos os controles são marcados como extensíveis.
type: docs
weight: 92
...
Representa uma referência de biblioteca de tipos OLE Automation modificada em que todos os controles são marcados como extensíveis.
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compara objetos do tipo referência no estilo do C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compara objetos do tipo valor no estilo do C#. |
...
| virtual [System::String](../../system/string/) [get_Name](../ivbareference/get_name/)() | Representa o nome da referência ao projeto VBA. Leia [System::String](../../system/string/). |
...
| virtual void [set_Name](../ivbareference/set_name/)([System::String](../../system/string/)) | Representa o nome da referência ao projeto VBA. Escreva [System::String](../../system/string/). |
