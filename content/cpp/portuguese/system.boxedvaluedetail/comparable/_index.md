...
description: Implementação simples de IComparable<>
type: docs
weight: 1
url: /pt/system.boxedvaluedetail/comparable/
---
## Comparable classe

Implementação simples de IComparable<>
...
| Método | Descrição |
| --- | --- |
| int [CompareTo](./compareto/)(T) override | Compara o objeto atual com o objeto especificado. |
