...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de ponto flutuante ao estilo C#, onde dois NaNs são considerados iguais, apesar de que de acordo com IEC 60559:1989 NaN não é igual a nenhum valor, incluindo NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de ponto flutuante ao estilo C#, onde dois NaNs são considerados iguais, apesar de que de acordo com IEC 60559:1989 NaN não é igual a nenhum valor, incluindo NaN. |
...
| virtual **bool** [get_Hide](./get_hide/)() | Retorna o sinalizador de ocultação da entrada da legenda. Leitura **bool**. |
...
| virtual void [set_Hide](./set_hide/)(**bool**) | Define o sinalizador de ocultação da entrada da legenda. Grava **bool**. |
