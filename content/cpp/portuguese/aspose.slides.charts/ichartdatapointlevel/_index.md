...
---
## IChartDataPointLevel classe


Representa o nível do ponto de dados. Aplicável aos gráficos Treemap e Sunburst.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Representa as propriedades de formatação do nível do ponto de dados. Leia [IFormat](../iformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | Representa o rótulo de dados do nível do ponto de dados. Aplicado aos tipos de séries Treemap e Sunburst. Somente leitura [IDataLabel](../idatalabel/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n'th argumento de template como um ponteiro fraco (em vez de compartilhado). Permite mudar ponteiros em contêineres para modo fraco. |
