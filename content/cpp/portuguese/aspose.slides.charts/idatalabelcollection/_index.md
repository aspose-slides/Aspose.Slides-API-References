...
| virtual **int32_t** [get_Count](./get_count/)() | Obtém o número de todos os rótulos de dados na coleção. Somente leitura **int32_t**. |
| virtual **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() | Obtém o número de rótulos de dados visíveis na coleção. Somente leitura **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() | Retorna o formato padrão de todos os rótulos de dados na coleção. Somente leitura [IDataLabelFormat](../idatalabelformat/). |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | Falso indica que o rótulo de dados não está visível por padrão (e, portanto, todas as flags Show* (ShowValue, ...) da propriedade DefaultDataLabelFormat são falsas). Somente leitura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() | Representa o formato das linhas de ligação dos rótulos de dados. Somente leitura [IChartLinesFormat](../ichartlinesformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() | Retorna a série de gráfico pai. Somente leitura [IChartSeries](../ichartseries/). |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método [Object.GetHashCode()](../../system/object/gethashcode/) do C#. Permite a geração de hash de objetos personalizados. |
...
| virtual void [Hide](./hide/)() | Torna o rótulo de dados oculto por padrão, definindo todas as flags Show* (ShowValue, ...) da propriedade DefaultDataLabelFormat para o estado falso. IsVisible será falso após isso. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) | Obtém o rótulo de dados para o ponto de dados com o índice especificado. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) | Retorna o índice do [DataLabel](../datalabel/) especificado na coleção. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Calcula a média de uma sequência de valores que são obtidos invocando uma função de transformação em cada elemento da sequência de entrada. |
...
| void [Lock](../../system/object/lock/)() | Implementa o bloqueio (lock()) da instrução C#. Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa o desbloqueio (unlock()) da instrução C# lock(). Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
