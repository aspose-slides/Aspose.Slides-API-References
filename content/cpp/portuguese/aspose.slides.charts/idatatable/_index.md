...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Retorna os estilos de linha, preenchimento e efeito de um objeto. Somente leitura [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | Verdadeiro se a tabela de dados do gráfico possui bordas de célula horizontais. Leitura **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | Verdadeiro se a tabela de dados do gráfico possui bordas de contorno. Leitura **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | Verdadeiro se a tabela de dados do gráfico possui bordas de célula verticais. Leitura **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | Verdadeiro se a chave da legenda do rótulo de dados está visível. Leitura **bool**. |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | Verdadeiro se a tabela de dados do gráfico possui bordas de célula horizontais. Grava **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | Verdadeiro se a tabela de dados do gráfico possui bordas de contorno. Grava **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | Verdadeiro se a tabela de dados do gráfico possui bordas de célula verticais. Grava **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | Verdadeiro se a chave da legenda do rótulo de dados está visível. Grava **bool**. |
