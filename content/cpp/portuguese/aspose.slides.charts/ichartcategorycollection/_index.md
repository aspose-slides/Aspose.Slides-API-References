...
description: Representa a coleção de IChartCategory
type: docs
weight: 599
...
Representa a coleção de [IChartCategory](../ichartcategory/)
...
| Método | Descrição |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Se a categoria existir na coleção, retorne-a. Caso contrário, cria uma nova categoria de gráfico a partir de [IChartDataCell](../ichartdatacell/) e a adiciona à coleção. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Cria um novo [IChartCategory](../ichartcategory/) a partir do valor e o adiciona à coleção. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais, embora segundo a IEC 60559:1989 NaN não seja igual a nenhum valor, inclusive NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais, embora segundo a IEC 60559:1989 NaN não seja igual a nenhum valor, inclusive NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Apenas para uso interno. |
| virtual **int32_t** [get_Count](../../aspose.slides/igenericcollection/get_count/)() | Retorna o número de comportamentos em uma coleção. Só leitura **int32_t**. |
| virtual **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() | Retorna a contagem de níveis de agrupamento de categorias usados. É maior que um para categorias multiníveis. Só leitura **int32_t**. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Retorna um valor indicando se o acesso à coleção é sincronizado (thread-safe). Só leitura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../../aspose.slides/igenericcollection/get_syncroot/)() | Retorna uma raiz de sincronização. Só leitura [System::Object](../../system/object/). |
| virtual **bool** [get_UseCells](./get_usecells/)() | Se verdadeiro, a planilha é usada para armazenar categorias (este caso suporta categorias multiníveis). Se falso, a planilha NÃO é usada para armazenar valores (e este caso não suporta categorias multiníveis). Só leitura **bool**. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analoga ao método [Object.GetHashCode()](../../system/object/gethashcode/) do C#. Habilita hash de objetos personalizados. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) | Obtém o elemento no índice especificado. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Busca o [IChartCategory](../ichartcategory/) especificado e retorna o índice baseado em zero da primeira ocorrência em toda a coleção. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Casta os elementos para o tipo especificado. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analoga ao método [Object.MemberwiseClone()](../../system/object/memberwiseclone/) do C#. Habilita clonagem de tipos personalizados. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Remove o valor especificado. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove o elemento no índice especificado. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| virtual void [set_UseCells](./set_usecells/)(**bool**) | Se verdadeiro, a planilha é usada para armazenar categorias (este caso suporta categorias multiníveis). Se falso, a planilha NÃO é usada para armazenar valores (e este caso não suporta categorias multiníveis). Grava **bool**. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analoga ao método [Object.ToString()](../../system/object/tostring/) do C#. Habilita a conversão de objetos personalizados para string. |
