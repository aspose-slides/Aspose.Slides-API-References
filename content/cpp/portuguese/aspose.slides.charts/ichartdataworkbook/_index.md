...
description: Fornece acesso ao workbook Excel incorporado
type: docs
weight: 729
url: /pt/aspose.slides.charts/ichartdataworkbook/
---
## IChartDataWorkbook classe

Fornece acesso ao workbook [Excel](../../aspose.slides.excel/) incorporado
...
| Método | Descrição |
| --- | --- |
| virtual void [CalculateFormulas](./calculateformulas/)() | Calcula todas as fórmulas no workbook e atualiza os valores das células correspondentes. |
| virtual void [Clear](./clear/)(**int32_t**) | Limpa todos os valores das células na planilha. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\> [get_Worksheet](./get_worksheet/)(**int32_t**) | Retorna a planilha deste workbook no índice especificado. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheetCollection](../ichartdataworksheetcollection/)\> [get_Worksheets](./get_worksheets/)() | Obtém uma coleção de planilhas. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)([System::String](../../system/string/), **int32_t**, **int32_t**) | Obtém a célula que pode ser usada para séries ou categorias de gráfico. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, **int32_t**, **int32_t**) | Obtém a célula que pode ser usada para séries ou categorias de gráfico. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, [System::String](../../system/string/)) | Obtém a célula que pode ser usada para séries ou categorias de gráfico. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, [System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Obtém a célula que pode ser usada para séries ou categorias de gráfico. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [GetCell](./getcell/)(**int32_t**, **int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Obtém a célula que pode ser usada para séries ou categorias de gráfico. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [GetCellCollection](./getcellcollection/)([System::String](../../system/string/), **bool**) | Obtém o conjunto de células. |
