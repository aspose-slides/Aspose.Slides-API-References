...
description: "Representa valor de string ou double que pode ser armazenado em documento de apresentação pptx de duas maneiras: 1) em célula/células da pasta de trabalho relacionada ao gráfico; 2) como valor literal."
type: docs
weight: 1210
...
Representa valor de string ou double que pode ser armazenado em documento de apresentação pptx de duas maneiras: 1) em célula/células da pasta de trabalho relacionada ao gráfico; 2) como valor literal.
...
| virtual **double** [get_AsLiteralDouble](./get_asliteraldouble/)() | Retorna o double literal se a propriedade DataSourceType for [DataSourceType::DoubleLiterals](../datasourcetype/). Leia **double**. |
| virtual [System::String](../../system/string/) [get_AsLiteralString](./get_asliteralstring/)() | Retorna a string literal se a propriedade DataSourceType for [DataSourceType::StringLiterals](../datasourcetype/). Leia [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | Especifica se a propriedade AsCell, AsLiteralString ou AsLiteralDouble está atual. Em outras palavras, especifica o tipo de valor da propriedade Data. Esta propriedade é somente leitura. Para alterar o valor desta propriedade, você pode usar uma das propriedades ChartDataPointCollection.DataSourceTypeFor<...>. Leia [DataSourceType](../datasourcetype/). |
...
| virtual void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) | Define o double literal se a propriedade DataSourceType for [DataSourceType::DoubleLiterals](../datasourcetype/). Escreva **double**. |
| virtual void [set_AsLiteralString](./set_asliteralstring/)([System::String](../../system/string/)) | Define a string literal se a propriedade DataSourceType for [DataSourceType::StringLiterals](../datasourcetype/). Escreva [System::String](../../system/string/). |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Especifica se a propriedade AsCell, AsLiteralString ou AsLiteralDouble está atual. Em outras palavras, especifica o tipo de valor da propriedade Data. Esta propriedade é somente leitura. Para alterar o valor desta propriedade, você pode usar uma das propriedades ChartDataPointCollection.DataSourceTypeFor<...>. Escreva [DataSourceType](../datasourcetype/). |
...
| virtual **double** [ToDouble](./todouble/)() | Converte o valor para double. |
