...
description: Representa uma coleção de pontos que devem ser desenhados na segunda pizza ou barra de um gráfico de barra-em-pizza ou pizza-em-pizza com uma divisão personalizada.
type: docs
weight: 1158
...
Representa uma coleção de pontos que devem ser desenhados no segundo gráfico de pizza ou barra em um gráfico de barra-em-pizza ou pizza-em-pizza com uma divisão personalizada.
...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)(const **int32_t**\&) | Adiciona um ponto de dados pelo seu índice na coleção de pontos da série pai. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) | Retorna o ponto de dados do gráfico por índice. |
...
| virtual void [Remove](./remove/)(**int32_t**) | Remove item da coleção pelo seu índice na coleção de pontos da série pai. |
