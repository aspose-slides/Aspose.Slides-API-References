...
| Método | Descrição |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Adiciona uma nova célula à coleção. |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Cria [IChartDataCell](../ichartdatacell/) a partir do valor especificado e o adiciona à coleção. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Obtém um iterador apontando para o primeiro elemento (se existir) da coleção. Este iterador não pode ser usado para alterar o objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) retorna um objeto cópia de T. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Obtém a contagem de células na coleção. Somente leitura **int32_t**. |
| virtual [System::String](../../system/string/) [GetCellsAddress](./getcellsaddress/)() | Retorna o endereço do conjunto de células na pasta de trabalho. |
| virtual [System::String](../../system/string/) [GetConcatenatedValuesFromCells](./getconcatenatedvaluesfromcells/)() | String de concatenação a partir dos valores de string de todas as células. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | Retorna uma célula ([IChartDataCell](../ichartdatacell/)) por índice. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove uma célula da coleção por índice. |
