...
description: Representa a coleção de IChartSeries
type: docs
weight: 833
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) | Cria uma nova série de gráfico e a adiciona à coleção. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) | Cria uma nova série de gráfico a partir de [IChartDataCell](../ichartdatacell/) e a adiciona à coleção. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) | Cria uma nova série de gráfico a partir de [IChartCellCollection](../ichartcellcollection/) e a adiciona à coleção. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) | Cria uma nova série de gráfico a partir de um valor e a adiciona à coleção. |
...
| virtual void [Clear](./clear/)() | Remove todos os elementos (incluindo o estilo do gráfico) da coleção. |
...
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Pesquisa o [IChartSeries](../ichartseries/) especificado e retorna o índice baseado em zero da primeira ocorrência em toda a Coleção. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) | Cria uma nova série de gráfico e a insere na coleção. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Remove o valor especificado. |
