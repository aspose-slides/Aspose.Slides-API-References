...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Obtém o preenchimento do marcador. Somente leitura [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | Representa o tamanho do marcador em um gráfico de linhas, gráfico de dispersão ou gráfico de radar. Somente leitura **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | Representa o estilo do marcador em um gráfico de linhas, gráfico de dispersão ou gráfico de radar. Somente leitura [MarkerStyleType](../markerstyletype/). |
...
| void [set_Size](./set_size/)(**int32_t**) override | Representa o tamanho do marcador em um gráfico de linhas, gráfico de dispersão ou gráfico de radar. Grava **int32_t**. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | Representa o estilo do marcador em um gráfico de linhas, gráfico de dispersão ou gráfico de radar. Grava [MarkerStyleType](../markerstyletype/). |
