...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Retorna o preenchimento da parede, linha, efeito, estilos 3d. Somente leitura [IFormat](../iformat/). |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | Retorna ou define o tipo de imagem. Somente leitura [Charts::PictureType](../picturetype/). |
| **int32_t** [get_Thickness](./get_thickness/)() override | Retorna a espessura das paredes como porcentagem da maior dimensão do volume do gráfico. Somente leitura **int32_t**. |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | Retorna ou define o tipo de imagem. Grava [Charts::PictureType](../picturetype/). |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | Define a espessura das paredes como porcentagem da maior dimensão do volume do gráfico. Grava **int32_t**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Define o n-ésimo argumento de modelo como um ponteiro fraco (ao invés de compartilhado). Permite mudar ponteiros em contêineres para modo fraco. |
