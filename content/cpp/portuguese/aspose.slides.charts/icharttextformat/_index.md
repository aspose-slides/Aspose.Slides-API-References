...
description: Gráficos operam com um conjunto restrito de propriedades de formato de texto. As interfaces IChartTextFormat, IChartTextBlockFormat, IChartParagraphFormat e IChartPortionFormat descrevem esse conjunto restrito.
type: docs
weight: 898
...
[Chart](../chart/) opera com um conjunto restrito de propriedades de formato de texto. [IChartTextFormat](./), [IChartTextBlockFormat](../icharttextblockformat/), [IChartParagraphFormat](../ichartparagraphformat/), [IChartPortionFormat](../ichartportionformat/) interfaces descrevem este conjunto restrito.
...
| Method | Description |
| --- | --- |
| virtual void [CopyFrom](./copyfrom/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) | Copia o formato de texto de um quadro de texto especificado. |
| virtual void [CopyTo](./copyto/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) | Copia o formato de texto para um quadro de texto especificado. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartParagraphFormat](../ichartparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() | Retorna o formato do parágrafo. Somente leitura [IChartParagraphFormat](../ichartparagraphformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartPortionFormat](../ichartportionformat/)\> [get_PortionFormat](./get_portionformat/)() | Retorna o formato da porção. Somente leitura [IChartPortionFormat](../ichartportionformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartTextBlockFormat](../icharttextblockformat/)\> [get_TextBlockFormat](./get_textblockformat/)() | Retorna o formato dos elementos de texto do gráfico. Somente leitura [IChartTextBlockFormat](../icharttextblockformat/). |
