...
| virtual **float** [get_Bottom](./get_bottom/)() | Obtém a parte superior do elemento do gráfico como uma fração da altura do gráfico. Somente leitura **float**. |
...
| virtual **float** [get_Height](./get_height/)() | Especifica a altura do elemento do gráfico como uma fração da altura do gráfico. Lê **float**. |
...
| virtual **float** [get_Right](./get_right/)() | Obtém a parte direita do elemento do gráfico como uma fração da largura do gráfico. Somente leitura **float**. |
...
| virtual **float** [get_Width](./get_width/)() | Especifica a largura do elemento do gráfico como uma fração da largura do gráfico. Lê **float**. |
| virtual **float** [get_X](./get_x/)() | Especifica a localização x (esquerda) do elemento do gráfico como uma fração da largura do gráfico. Lê **float**. |
| virtual **float** [get_Y](./get_y/)() | Especifica a parte superior do elemento do gráfico como uma fração da altura do gráfico. Lê **float**. |
...
| virtual void [set_Height](./set_height/)(**float**) | Especifica a altura do elemento do gráfico como uma fração da altura do gráfico. Grava **float**. |
| virtual void [set_Width](./set_width/)(**float**) | Especifica a largura do elemento do gráfico como uma fração da largura do gráfico. Grava **float**. |
| virtual void [set_X](./set_x/)(**float**) | Especifica a localização x (esquerda) do elemento do gráfico como uma fração da largura do gráfico. Grava **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Especifica a parte superior do elemento do gráfico como uma fração da altura do gráfico. Grava **float**. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa o contador de referência fraco. Não deve ser chamado diretamente; ao invés disso, use ponteiros inteligentes ou ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa o contador de referência fraco. Não deve ser chamado diretamente; ao invés disso, use ponteiros inteligentes ou ThisProtector. |
