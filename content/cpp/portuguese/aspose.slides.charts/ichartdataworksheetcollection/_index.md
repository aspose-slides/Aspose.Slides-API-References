...
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Retorna um valor que indica se o acesso à coleção é sincronizado (thread-safe). **bool** somente leitura. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\> [idx_get](./idx_get/)(**int32_t**) | Retorna a planilha pelo índice. |
