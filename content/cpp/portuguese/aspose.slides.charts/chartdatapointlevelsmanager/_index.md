...
description: Contêiner de níveis de pontos de dados. Aplicado para as séries Treeamp e Sunburst. A indexação dos níveis de pontos de dados começa em zero.
type: docs
weight: 183
...
Contêiner de níveis de pontos de dados. Aplicado para as séries Treeamp e Sunburst. A indexação dos níveis de pontos de dados começa em zero.
...
| **int32_t** [get_Count](./get_count/)() override | Retorna a contagem de níveis de pontos de dados. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPointLevel](../ichartdatapointlevel/)\> [idx_get](./idx_get/)(**int32_t**) override | Retorna o objeto [IChartDataPointLevel](../ichartdatapointlevel/) para o nível definido. |
