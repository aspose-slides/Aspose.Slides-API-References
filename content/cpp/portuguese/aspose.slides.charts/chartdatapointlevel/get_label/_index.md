...
description: Representa o rótulo de dados do nível de ponto de dados. Aplicado para tipos de séries Treemap e Sunburst. Somente leitura IDataLabel.
type: docs
weight: 14
url: /pt/aspose.slides.charts/chartdatapointlevel/get_label/
---
## ChartDataPointLevel::get_Label() método

Representa o rótulo de dados do nível de ponto de dados. Aplicado para tipos de séries Treemap e Sunburst. Somente leitura [IDataLabel](../../idatalabel/).
