...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Retorna os estilos de linha, preenchimento e efeito de um objeto. Somente leitura [IFormat](../iformat/). |
| **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() override | Verdadeiro se a tabela de dados do gráfico tem bordas de célula horizontais. Leia **bool**. |
| **bool** [get_HasBorderOutline](./get_hasborderoutline/)() override | Verdadeiro se a tabela de dados do gráfico tem bordas de contorno. Leia **bool**. |
| **bool** [get_HasBorderVertical](./get_hasbordervertical/)() override | Verdadeiro se a tabela de dados do gráfico tem bordas de célula verticais. Leia **bool**. |
| **bool** [get_ShowLegendKey](./get_showlegendkey/)() override | Verdadeiro se a chave da legenda do rótulo de dados está visível. Leia **bool**. |
...
| void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) override | Verdadeiro se a tabela de dados do gráfico tem bordas de célula horizontais. Grava **bool**. |
| void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) override | Verdadeiro se a tabela de dados do gráfico tem bordas de contorno. Grava **bool**. |
| void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) override | Verdadeiro se a tabela de dados do gráfico tem bordas de célula verticais. Grava **bool**. |
| void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) override | Verdadeiro se a chave da legenda do rótulo de dados está visível. Grava **bool**. |
