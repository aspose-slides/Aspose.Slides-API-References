...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Retorna o preenchimento da parede, linha, efeito, estilos 3D. Somente leitura [IFormat](../iformat/). |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | Retorna ou define o tipo de imagem. Leitura [PictureType](../picturetype/). |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | Retorna a espessura das paredes como uma porcentagem da maior dimensão do volume do gráfico. Leitura **int32_t**. |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | Retorna ou define o tipo de imagem. Grava [PictureType](../picturetype/). |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | Define a espessura das paredes como uma porcentagem da maior dimensão do volume do gráfico. Grava **int32_t**. |
