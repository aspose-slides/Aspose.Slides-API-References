...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não é igual a qualquer valor, incluindo NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não é igual a qualquer valor, incluindo NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Somente para uso interno. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() override | Retorna o objeto [IChartDataCell](../ichartdatacell/). Se a categoria for de vários níveis, então usa o objeto [IChartDataCell](../ichartdatacell/) para o nível "0". Leia [IChartDataCell](../ichartdatacell/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_AsLiteral](./get_asliteral/)() override | Retorna o objeto AsLiteral. Leia [System::Object](../../system/object/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_GroupingLevel](./get_groupinglevel/)(**int32_t**) override | Retorna um nível de agrupamento de categoria de gráfico no índice especificado. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)\> [get_GroupingLevels](./get_groupinglevels/)() override | Contêiner gerenciado dos valores dos níveis de agrupamento da categoria de gráfico. Categoria de vários níveis contém mais de um nível de agrupamento. A indexação dos níveis de agrupamento começa em zero. Somente leitura [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/). |
| **bool** [get_UseCell](./get_usecell/)() override | Se verdadeiro, a propriedade AsCell está efetiva. Em outras palavras, a planilha é usada para armazenar a categoria (este caso suporta uma categoria de vários níveis). Se falso, a propriedade AsLiteral está efetiva. Em outras palavras, a planilha NÃO é usada para armazenar a categoria (e este caso não suporta categorias de vários níveis). Somente leitura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() override | Se UseCell for verdadeiro, então esta propriedade representa a propriedade [get_AsCell()](./get_ascell/)->get(set)_Value(). Se UseCell for falso, então esta propriedade representa a propriedade AsLiteral. Leia [System::Object](../../system/object/). |
...
| void [Remove](./remove/)() override | Remove a categoria do gráfico. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Define o objeto [IChartDataCell](../ichartdatacell/). Se a categoria for de vários níveis, então usa o objeto [IChartDataCell](../ichartdatacell/) para o nível "0". Escreva [IChartDataCell](../ichartdatacell/). |
| void [set_AsLiteral](./set_asliteral/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Define o objeto AsLiteral. Escreva [System::Object](../../system/object/). |
| void [set_Value](./set_value/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Se UseCell for verdadeiro, então esta propriedade representa a propriedade [get_AsCell()](./get_ascell/)->get(set)_Value(). Se UseCell for falso, então esta propriedade representa a propriedade AsLiteral. Escreva [System::Object](../../system/object/). |
