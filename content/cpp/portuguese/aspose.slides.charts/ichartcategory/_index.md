...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() | Retorna o objeto [IChartDataCell](../ichartdatacell/). Se a categoria for de múltiplos níveis, então usa o objeto [IChartDataCell](../ichartdatacell/) para o nível "0". Leia [IChartDataCell](../ichartdatacell/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_AsLiteral](./get_asliteral/)() | Retorna AsLiteral se UseCell for false. Leia [System::Object](../../system/object/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_GroupingLevel](./get_groupinglevel/)(**int32_t**) | Retorna um nível de agrupamento de categoria de gráfico no índice especificado. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)\> [get_GroupingLevels](./get_groupinglevels/)() | Contêiner gerenciado dos valores dos níveis de agrupamento da categoria de gráfico. Categoria de múltiplos níveis contém mais de um nível de agrupamento. A indexação dos níveis de agrupamento inicia em zero. Somente leitura [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/). |
| virtual **bool** [get_UseCell](./get_usecell/)() | Se true, a propriedade AsCell é efetiva. Em outras palavras, a planilha é usada para armazenar a categoria (este caso suporta uma categoria de múltiplos níveis). Se false, a propriedade AsLiteral é efetiva. Em outras palavras, a planilha NÃO é usada para armazenar a categoria (e este caso não suporta categorias de múltiplos níveis). Somente leitura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() | Se UseCell for true, então esta propriedade representa a propriedade [get_AsCell()](./get_ascell/)->get(set)_Value(). Se UseCell for false, então esta propriedade representa a propriedade AsLiteral. Leia [System::Object](../../system/object/). |
...
| virtual void [Remove](./remove/)() | Remove a categoria do gráfico. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| virtual void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Define o objeto [IChartDataCell](../ichartdatacell/). Se a categoria for de múltiplos níveis, então usa o objeto [IChartDataCell](../ichartdatacell/) para o nível "0". Escreva [IChartDataCell](../ichartdatacell/). |
| virtual void [set_AsLiteral](./set_asliteral/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Define AsLiteral se UseCell for false. Escreva [System::Object](../../system/object/). |
| virtual void [set_Value](./set_value/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Se UseCell for true, então esta propriedade representa a propriedade [get_AsCell()](./get_ascell/)->get(set)_Value(). Se UseCell for false, então esta propriedade representa a propriedade AsLiteral. Escreva [System::Object](../../system/object/). |
