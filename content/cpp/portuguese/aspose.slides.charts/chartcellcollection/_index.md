...
| Method | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Adiciona uma nova célula à coleção. |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Cria [ChartDataCell](../chartdatacell/) a partir do valor especificado e o adiciona à coleção. |
...
| **int32_t** [get_Count](./get_count/)() override | Obtém a contagem de células na coleção. Somente leitura **int32_t**. |
| [System::String](../../system/string/) [GetCellsAddress](./getcellsaddress/)() override | Retorna o endereço do conjunto de células na pasta de trabalho. |
| [System::String](../../system/string/) [GetConcatenatedValuesFromCells](./getconcatenatedvaluesfromcells/)() override | Cadeia de concatenação a partir de todos os valores de string das células. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera pela coleção. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) override | Retorna uma célula ([IChartDataCell](../ichartdatacell/)) por índice. |
...
| **bool** [LINQ_Contains](../../system.collections.generic/ienumerable/linq_contains/)(T) | Determina se uma sequência contém um valor específico. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Remove uma célula da coleção por índice. |
