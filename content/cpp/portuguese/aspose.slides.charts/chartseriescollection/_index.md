...
description: Representa coleção de ChartSeries
type: docs
weight: 287
...
Representa coleção de [ChartSeries](../chartseries/)
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) override | Cria uma nova série de gráfico e a adiciona à coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) override | Cria uma nova série de gráfico a partir de [ChartDataCell](../chartdatacell/) e a adiciona à coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) override | Cria uma nova série de gráfico a partir de [ChartCellCollection](../chartcellcollection/) e a adiciona à coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) override | Cria uma nova série de gráfico a partir de um valor e a adiciona à coleção. |
| [iterator](./iterator/) [begin](./begin/)() | Obtém um iterador apontando para o primeiro elemento (se houver) da coleção. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtém um iterador apontando para o primeiro elemento (se houver) da instância qualificada como const da coleção. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtém um iterador apontando para o primeiro elemento const (se houver) da coleção. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtém um iterador apontando logo após o último elemento const (se houver) da coleção. |
| void [Clear](./clear/)() override | Remove todos os controles da coleção. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>, **int32_t**) override | Copia todos os elementos da coleção para o array especificado. |
| [iterator](./iterator/) [end](./end/)() | Obtém um iterador apontando logo após o último elemento (se houver) da coleção. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtém um iterador apontando logo após o último elemento (se houver) da instância qualificada como const da coleção. |
...
| **int32_t** [get_Count](./get_count/)() override | Retorna o número de objetos na coleção. Somente leitura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera pela coleção. |
...
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Procura o [ChartSeries](../chartseries/) especificado e retorna o índice baseado em zero da primeira ocorrência em toda a Coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) override | Cria uma nova série de gráfico e a insere na coleção. |
...
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | Aplica uma função acumuladora em uma sequência. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Retorna o primeiro elemento da sequência que satisfaça uma condição ou um valor padrão caso nenhum elemento seja encontrado. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Ordena os elementos de uma sequência em ordem ascendente conforme os valores de chave selecionados por keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Ordena os elementos de uma sequência em ordem descendente conforme os valores de chave selecionados por keySelector. |
...
| void [Lock](../../system/object/lock/)() | Implementa a instrução C# lock() travando. Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Remove o valor especificado. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Remove um controle ActiveX armazenado na posição especificada da coleção. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Define o n-ésimo argumento do modelo como ponteiro fraco (em vez de compartilhado). Permite alternar ponteiros em contêineres para modo fraco. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtém um iterador apontando para o primeiro elemento (se houver) da instância qualificada como const da coleção. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Obtém um iterador apontando para o primeiro elemento (se houver) da coleção. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtém um iterador apontando logo após o último elemento (se houver) da instância qualificada como const da coleção. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtém um iterador apontando logo após o último elemento (se houver) da coleção. |
...
* Classe [IChartSeriesCollection](../ichartseriescollection/)
