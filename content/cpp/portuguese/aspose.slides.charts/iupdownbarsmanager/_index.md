...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | Retorna o formato das barras inferiores. Somente leitura [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | Retorna a largura do intervalo. Leitura **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | Determina se o gráfico tem barras de alta/baixa. Leitura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | Retorna o formato das barras superiores. Somente leitura [IFormat](../iformat/). |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | Define a largura do intervalo. Escreve **int32_t**. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | Determina se o gráfico tem barras de alta/baixa. Escreve **bool**. |
