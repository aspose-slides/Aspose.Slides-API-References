...
description: "O tipo base de exceção para todas as exceções de interop COM e exceções de tratamento estruturado de exceções (SEH). Nunca crie instâncias desta classe manualmente. Use a classe ExternalException em vez disso. Nunca envolva as instâncias da classe ExternalException em System::SmartPtr."
type: docs
weight: 1
url: /pt/system.runtime.interopservices/details_externalexception/
---
## Details_ExternalException classe


O tipo base de exceção para todas as exceções de interop COM e exceções de tratamento estruturado de exceções (SEH). Nunca crie instâncias desta classe manualmente. Use a classe ExternalException em vez disso. Nunca envolva as instâncias da classe ExternalException em [System::SmartPtr](../../system/smartptr/).
...
| virtual **int32_t** [get_ErrorCode](../../system/details_exceptionwitherrorcode/get_errorcode/)() const | Obtém o HRESULT do erro. |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | Retorna uma cópia do objeto Exception que representa a exceção mais interna. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
