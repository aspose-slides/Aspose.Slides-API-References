...
| Method | Description |
| --- | --- |
| void [AddCapture](./addcapture/)(const [CapturePtr](../captureptr/)\&) | Adiciona captura ao grupo. |
...
| [CaptureCollectionPtr](../capturecollectionptr/) [get_Captures](./get_captures/)() | Obtém capturas disponíveis. |
| int [get_Index](../capture/get_index/)() const | Obtém o índice da sub-string capturada. |
| int [get_Length](../capture/get_length/)() const | Obtém o comprimento da sub-string capturada. |
| **bool** [get_Success](./get_success/)() | Verifica se a captura foi bem-sucedida para este grupo. |
| [String](../../system/string/) [get_Value](../capture/get_value/)() const | Obtém a sub-string capturada. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Analógia à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
| [Group](./group/)(const [UStringPtr](../ustringptr/)\&, int, int) | Construtor. |
| [Group](./group/)() | Construtor de grupo vazio. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica se o objeto representa uma instância do tipo descrito por targetType. Analógia ao operador C# 'is'. |
| void [Lock](../../system/object/lock/)() | Implementa o bloqueio da instrução C# lock(). Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analógia ao método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonar tipos personalizados. |
...
| [String](../../system/string/) [ToString](../capture/tostring/)() const override | Obtém a sub-string capturada. |
