...
description: Ponteiro de coleção de grupo. Este tipo é um ponteiro para gerenciar a exclusão de outro objeto. Deve ser alocado na pilha e passado para funções por valor ou por referência const.
type: docs
weight: 53
url: /pt/system.text.regularexpressions/groupcollectionptr/
---
## GroupCollectionPtr classe

[Group](../group/) ponteiro de coleção. Este tipo é um ponteiro para gerenciar a exclusão de outro objeto. Deve ser alocado na pilha e passado para funções por valor ou por referência const.
...
|  [GroupCollectionPtr](./groupcollectionptr/)() | Construtor de ponteiro nulo. |
|  [GroupCollectionPtr](./groupcollectionptr/)(const [SharedPtr](../../system/sharedptr/)\<[GroupCollection](../groupcollection/)\>\&) | Construtor de conversão de tipo. |
| **bool** [Is](../../system/smartptr/is/)(const [System::TypeInfo](../../system/typeinfo/)\&) const | Verifica se o objeto apontado é de um tipo específico ou de seu tipo filho. Segue a semântica de 'is' do C#. |
| **bool** [IsAliasingPtr](../../system/smartptr/isaliasingptr/)() const | Verifica se o ponteiro aponta para um objeto diferente do que possui (criado por um construtor de aliasing). |
...
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr_](../../system/smartptr/smartptr_/)\&) | Copia-atribui objeto [SmartPtr](../../system/smartptr/). |
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&) | Copia-atribui objeto [SmartPtr](../../system/smartptr/). Executa as conversões de tipo necessárias. |
...
| [GroupPtr](../groupptr/) [operator[]](./operator[]/)(size_t) const | Acessador [Group](../group/). |
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | Remove aliasing (criado por um construtor de aliasing) do ponteiro, garantindo que ele gerencie (se compartilhado) ou rastreie (se fraco) o mesmo objeto ao qual aponta. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)([SmartPtrMode](../../system/smartptrmode/)) | Cria um objeto [SmartPtr](../../system/smartptr/) no modo requerido. |
|  [SmartPtr](../../system/smartptr/smartptr/)(std::nullptr_t, [SmartPtrMode](../../system/smartptrmode/)) | Cria um objeto [SmartPtr](../../system/smartptr/) de ponteiro nulo no modo requerido. |
...
|  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Constrói cópia do objeto [SmartPtr](../../system/smartptr/). Ambos os ponteiros apontam para o mesmo objeto depois. Executa conversão de tipo se permitida. |
|  [SmartPtr](../../system/smartptr/smartptr/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&, [SmartPtrMode](../../system/smartptrmode/)) | Move-constroi objeto [SmartPtr](../../system/smartptr/). Efetivamente troca dois ponteiros, se ambos estiverem no mesmo modo. x pode ficar inutilizável após a chamada. |
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<[Array](../../system/array/)\<Y\>\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Converte o tipo do array referenciado criando um novo array de tipo diferente. Útil quando em C# há um cast de array que não é suportado em C++. |
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const Y\&) | Inicializa array vazio. Utilizado para traduzir alguns constructos de código C#. |
...
| [SmartPtr](../../system/smartptr/)\<[Object](../../system/object/)\> [ToObjectPtr](../../system/smartptr/toobjectptr/)() const | Converte qualquer tipo de ponteiro para ponteiro de [Object](../../system/object/). Não necessita que o tipo Pointee_ esteja completo. |
...
|  [~SmartPtr](../../system/smartptr/~smartptr/)() | Destrói objeto [SmartPtr](../../system/smartptr/). Se necessário, diminui o contador de referência do objeto apontado e exclui o objeto. |
