...
| Método | Descrição |
| --- | --- |
|  [Capture](./capture/)(const [UStringPtr](../ustringptr/)\&, int, int) | Construtor. |
...
| int [get_Index](./get_index/)() const | Obtém o índice da subcadeia capturada. |
| int [get_Length](./get_length/)() const | Obtém o comprimento da subcadeia capturada. |
| [String](../../system/string/) [get_Value](./get_value/)() const | Obtém a subcadeia capturada. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Decrementa e devolve o contador de referências compartilhadas. Não deve ser chamado diretamente; ao invés disso, use ponteiros inteligentes ou ThisProtector. |
| [String](../../system/string/) [ToString](./tostring/)() const override | Obtém a subcadeia capturada. |
