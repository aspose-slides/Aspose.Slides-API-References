...
description: "Coleção de correspondências realizadas ao aplicar repetidamente regexp a uma string. Objetos desta classe devem ser alocados apenas usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando operator new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 79
url: /pt/system.text.regularexpressions/matchcollection/
---
## MatchCollection classe

Coleta de correspondências feitas ao aplicar repetidamente regexp a uma string. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instância deste tipo na pilha ou usando operator new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(const T\&) const | Busca item em uma lista ordenada. |
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(const T\&, const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) const | Busca item em uma lista ordenada. |
| int [BinarySearch](../../system.collections.generic/list/binarysearch/)(int, int, const T\&, const [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>\&) const | Busca item em uma lista ordenada. |
...
| void [CopyTo](../../system.collections.generic/list/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copia elementos da lista em elementos de array existentes. |
| void [CopyTo](../../system.collections.generic/list/copyto/)(const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&) | Copia todos os elementos em elementos de array existentes. |
| void [CopyTo](../../system.collections.generic/list/copyto/)(int, const [System::ArrayPtr](../../system/arrayptr/)\<T\>\&, int, int) | Copia elementos a partir do índice especificado em elementos de array existentes. |
...
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | Verifica se existe elemento que atende a um predicado específico na lista. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Somente para uso interno. |
| T [Find](../../system.collections.generic/list/find/)([System::Predicate](../../system/predicate/)\<T\>) | Busca elemento que cumpre um predicado específico. |
| [ListPtr](../../system.collections.generic/listptr/)\<T\> [FindAll](../../system.collections.generic/list/findall/)([System::Predicate](../../system/predicate/)\<T\>) | Busca elementos que cumprem um predicado específico. |
| int [FindIndex](../../system.collections.generic/list/findindex/)([System::Predicate](../../system/predicate/)\<T\>) | Busca elemento que cumpre um predicado específico. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, [System::Predicate](../../system/predicate/)\<T\>) | Busca elemento que cumpre um predicado específico. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, int, [System::Predicate](../../system/predicate/)\<T\>) | Busca elemento que cumpre um predicado específico. |
| T [FindLast](../../system.collections.generic/list/findlast/)([System::Predicate](../../system/predicate/)\<T\>) | Busca o último elemento que cumpre um predicado específico. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método [Object.GetHashCode()](../../system/object/gethashcode/) de C#. Habilita hash de objetos personalizados. |
...
| T [idx_get](../../system.collections.generic/list/idx_get/)(int) const override | Obtém o elemento em posição específica. |
| void [idx_set](../../system.collections.generic/list/idx_set/)(int, T) override | Define o elemento em posição específica. |
| int [IndexOf](../../system.collections.generic/list/indexof/)(const T\&) const override | Obtém o primeiro índice do item específico. |
| int [IndexOf](../../system.collections.generic/list/indexof/)(const T\&, int) const | Busca um item específico na lista. |
...
| **bool** [IsReadOnly](./isreadonly/)() const | Marca a coleção como somente leitura. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | Pesquisa o objeto especificado e retorna o índice baseado em zero da última ocorrência em toda a lista. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Pesquisa o objeto especificado e retorna o índice baseado em zero da última ocorrência dentro do intervalo de elementos em [List](../../system.collections.generic/list/) que se estende do primeiro elemento até o índice especificado. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Pesquisa o objeto especificado e retorna o índice baseado em zero da última ocorrência dentro do intervalo de elementos em [List](../../system.collections.generic/list/) que contém o número especificado de elementos e termina no índice especificado. |
...
| void [Lock](../../system/object/lock/)() | Implementa o bloqueio da instrução lock() de C#. Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Análogo ao método [Object.MemberwiseClone()](../../system/object/memberwiseclone/) de C#. Habilita clonagem de tipos personalizados. |
...
| void [RemoveAt](../../system.collections.generic/list/removeat/)(int) override | Remove o item na posição especificada. |
...
| void [RemoveRange](../../system.collections.generic/list/removerange/)(int, int) | Remove uma fatia da lista. |
...
| void [Sort](../../system.collections.generic/list/sort/)() | Ordena os elementos na lista usando o comparador padrão. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Análogo ao método [Object.ToString()](../../system/object/tostring/) de C#. Habilita a conversão de objetos personalizados para string. |
| void [TrimExcess](../../system.collections.generic/list/trimexcess/)() | Ajusta a capacidade da lista ao seu tamanho. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa o desbloqueio da instrução lock() de C#. Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
