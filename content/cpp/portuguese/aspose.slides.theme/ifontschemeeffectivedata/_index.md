...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Major](./get_major/)() | Retorna a coleção de fontes para a parte "heading" do slide. Somente leitura [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Minor](./get_minor/)() | Retorna a coleção de fontes para a parte "body" do slide. Somente leitura [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Retorna o nome do esquema de fontes. Somente leitura [System::String](../../system/string/). |
