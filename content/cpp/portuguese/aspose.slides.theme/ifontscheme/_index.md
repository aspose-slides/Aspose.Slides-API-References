...
description: Armazena fontes definidas por tema.
type: docs
weight: 274
...
Armazena fontes definidas por tema.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() | Retorna a coleção de fontes para a parte "heading" do slide. Somente leitura [IFonts](../../aspose.slides/ifonts/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() | Retorna a coleção de fontes para a parte "body" do slide. Somente leitura [IFonts](../../aspose.slides/ifonts/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Retorna o nome do esquema de fontes. Leitura [System::String](../../system/string/). |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Define o nome do esquema de fontes. Escrita [System::String](../../system/string/). |
