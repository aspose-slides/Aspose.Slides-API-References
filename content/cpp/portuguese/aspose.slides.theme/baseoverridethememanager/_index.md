...
| Método | Descrição |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Aplica esquema de cores extra a um slide. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | Retorna o objeto de tema. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Determina se [OverrideTheme](../overridetheme/) sobrescreve o tema efetivo herdado ou não. Para habilitar [OverrideTheme](../overridetheme/) para sobrescrita, use os métodos OverrideTheme.Init*(). Para desabilitar [OverrideTheme](../overridetheme/) da sobrescrita, use o método [OverrideTheme::Clear](../overridetheme/clear/). Somente leitura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Retorna o objeto de tema sobrescrito. Leia [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Retorna o objeto de tema sobrescrito. Escreva [IOverrideTheme](../ioverridetheme/). |
