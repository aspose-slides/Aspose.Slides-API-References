...
description: Representa objetos que podem ser tematizados com ITheme.
type: docs
weight: 443
...
| Método | Descrição |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() | Retorna um tema efetivo para este objeto tematizável. |
