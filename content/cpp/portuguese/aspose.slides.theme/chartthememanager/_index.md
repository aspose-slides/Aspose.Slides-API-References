...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Determina se [OverrideTheme](../overridetheme/) substitui o tema efetivo herdado ou não. Para habilitar [OverrideTheme](../overridetheme/) para substituição, use os métodos OverrideTheme.Init*(). Para desabilitar [OverrideTheme](../overridetheme/) de substituição, use o método [OverrideTheme::Clear](../overridetheme/clear/). Somente leitura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | Retorna o objeto de tema que está sendo sobrescrito. Leia [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Retorna o objeto de tema que está sendo sobrescrito. Escrita [IOverrideTheme](../ioverridetheme/). |
