...
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | Determina se [OverrideTheme](../overridetheme/) substitui o tema efetivo herdado ou não. Para habilitar [OverrideTheme](../overridetheme/) para substituição, use os métodos OverrideTheme.Init*(). Para desabilitar [OverrideTheme](../overridetheme/) da substituição, use o método [get_OverrideTheme()](./get_overridetheme/)->Clear(). Somente leitura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() | Retorna o objeto de tema de substituição. Leia [IOverrideTheme](../ioverridetheme/). |
...
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) | Retorna o objeto de tema de substituição. Escreva [IOverrideTheme](../ioverridetheme/). |
