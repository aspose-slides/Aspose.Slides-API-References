...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compara objetos de tipo por referência no estilo C#. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Determina se [OverrideTheme](../overridetheme/) substitui o tema efetivo herdado ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) ou não. Leitura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Retorna o objeto de tema de sobrescrição. Leitura [IMasterTheme](../imastertheme/). |
...
| void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) override | Determina se [OverrideTheme](../overridetheme/) substitui o tema efetivo herdado ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) ou não. Grava **bool**. |
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) override | Retorna o objeto de tema de sobrescrição. Grava [IMasterTheme](../imastertheme/). |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogo do método C# [Object.ToString()](../../system/object/tostring/). Habilita conversão de objetos personalizados para string. |
