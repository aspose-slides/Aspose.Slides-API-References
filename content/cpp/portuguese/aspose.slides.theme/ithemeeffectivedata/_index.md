...
description: Objeto imutável que contém propriedades efetivas de tema.
type: docs
weight: 456
...
Objeto imutável que contém propriedades efetivas de tema.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontSchemeEffectiveData](../ifontschemeeffectivedata/)\> [get_FontScheme](./get_fontscheme/)() | Retorna o esquema de fontes. Somente leitura [IFontSchemeEffectiveData](../ifontschemeeffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormatSchemeEffectiveData](../iformatschemeeffectivedata/)\> [get_FormatScheme](./get_formatscheme/)() | Retorna o esquema de formato de forma. Somente leitura [IFormatSchemeEffectiveData](../iformatschemeeffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorSchemeEffectiveData](../icolorschemeeffectivedata/)\> [GetColorScheme](./getcolorscheme/)([System::Drawing::Color](../../system.drawing/color/)) | Retorna o esquema de cores. |
...
Esta interface é usada junto com a interface [ITheme](../itheme/) para retornar valores de formatação efetiva com herança aplicada. 
