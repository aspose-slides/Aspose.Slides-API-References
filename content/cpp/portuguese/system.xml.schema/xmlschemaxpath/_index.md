...
description: Representa o elemento selector do World Wide Web Consortium (W3C).
type: docs
weight: 963
url: /pt/system.xml.schema/xmlschemaxpath/
---
## XmlSchemaXPath classe

Representa o elemento **selector** do Consórcio World Wide [Web](../../system.web/) (W3C).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de ponto flutuante no estilo C#, onde dois NaNs são considerados iguais mesmo que, segundo IEC 60559:1989, NaN não seja igual a nenhum valor, incluindo NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de ponto flutuante no estilo C#, onde dois NaNs são considerados iguais mesmo que, segundo IEC 60559:1989, NaN não seja igual a nenhum valor, incluindo NaN. |
...
| [String](../../system/string/) [get_XPath](./get_xpath/)() | Retorna o atributo para a expressão [XPath](../../system.xml.xpath/). |
...
| void [set_XPath](./set_xpath/)(const [String](../../system/string/)\&) | Define o atributo para a expressão [XPath](../../system.xml.xpath/). |
