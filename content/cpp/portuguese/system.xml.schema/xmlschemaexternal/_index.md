...
description: Fornece informações sobre o esquema incluído.
type: docs
weight: 391
url: /pt/system.xml.schema/xmlschemaexternal/
---
## XmlSchemaExternal classe

Fornece informações sobre o esquema incluído.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [get_Schema](./get_schema/)() | Retorna o [XmlSchema](../xmlschema/) para o esquema referenciado. |
| [String](../../system/string/) [get_SchemaLocation](./get_schemalocation/)() | Retorna o Uniform Resource Identifier (URI) da localização do esquema, que informa ao processador de esquemas onde o esquema está fisicamente localizado. |
...
| void [set_Schema](./set_schema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Define o [XmlSchema](../xmlschema/) para o esquema referenciado. |
| void [set_SchemaLocation](./set_schemalocation/)(const [String](../../system/string/)\&) | Define o Uniform Resource Identifier (URI) da localização do esquema, que informa ao processador de esquemas onde o esquema está fisicamente localizado. |
...
|  [XmlSchemaExternal](./xmlschemaexternal/)() | Inicializa uma nova instância da classe [XmlSchemaExternal](./). |
