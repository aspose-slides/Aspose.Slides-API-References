...
description: Representa o elemento notation do XML Schema conforme especificado pelo World Wide Web Consortium (W3C). Uma declaração XML Schemanotation é uma reconstrução das declarações NOTATION do XML 1.0. O objetivo das notações é descrever o formato de dados não-XML dentro de um documento XML.
type: docs
weight: 651
url: /pt/system.xml.schema/xmlschemanotation/
---
## XmlSchemaNotation classe

Representa o elemento **notation** do XML [Schema](../) conforme especificado pelo Consórcio World Wide [Web](../../system.web/) (W3C). Uma declaração de **notation** XML [Schema](../) é uma reconstrução das declarações NOTATION do **XML** 1.0. O objetivo das notações é descrever o formato de dados não-XML dentro de um documento XML.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Retorna o nome da notação. |
...
| [String](../../system/string/) [get_Public](./get_public/)() | Retorna o identificador **public**. |
...
| [String](../../system/string/) [get_System](./get_system/)() | Retorna o identificador **system**. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Define o nome da notação. |
...
| void [set_Public](./set_public/)(const [String](../../system/string/)\&) | Define o identificador **public**. |
...
| void [set_System](./set_system/)(const [String](../../system/string/)\&) | Define o identificador **system**. |
...
|  [XmlSchemaNotation](./xmlschemanotation/)() | Inicializa uma nova instância da classe [XmlSchemaNotation](./). |
