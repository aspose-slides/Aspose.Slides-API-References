...
description: Representa a classe raiz para a hierarquia do modelo de objetos de esquema Xml e serve como classe base para classes como a classe XmlSchema.
type: docs
weight: 677
url: /pt/system.xml.schema/xmlschemaobject/
---
## Classe XmlSchemaObject

Representa a classe raiz para a hierarquia do modelo de objetos de esquema [Xml](../../system.xml/) e serve como classe base para classes como a classe [XmlSchema](../xmlschema/).
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Retorna o número da linha no arquivo ao qual o elemento **schema** se refere. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Retorna a posição da linha no arquivo ao qual o elemento **schema** se refere. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](./get_namespaces/)() | Retorna o XmlSerializerNamespaces a ser usado com este objeto de esquema. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\> [get_Parent](./get_parent/)() | Retorna o pai deste [XmlSchemaObject](./). |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Retorna a localização de origem do arquivo que carregou o esquema. |
...
| void [set_LineNumber](./set_linenumber/)(**int32_t**) | Define o número da linha no arquivo ao qual o elemento **schema** se refere. |
| void [set_LinePosition](./set_lineposition/)(**int32_t**) | Define a posição da linha no arquivo ao qual o elemento **schema** se refere. |
| void [set_Namespaces](./set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Define o XmlSerializerNamespaces a ser usado com este objeto de esquema. |
| void [set_Parent](./set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\>\&) | Define o pai deste [XmlSchemaObject](./). |
| void [set_SourceUri](./set_sourceuri/)(const [String](../../system/string/)\&) | Define a localização de origem do arquivo que carregou o esquema. |
...
|  [XmlSchemaObject](./xmlschemaobject/)() | Inicializa uma nova instância da classe [XmlSchemaObject](./). |
