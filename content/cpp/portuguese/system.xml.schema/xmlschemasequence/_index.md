...
description: Representa o elemento sequence (compositor) do XML Schema conforme especificado pelo World Wide Web Consortium (W3C). O sequence requer que os elementos no grupo apareçam na sequência especificada dentro do elemento contêiner.
type: docs
weight: 768
url: /pt/system.xml.schema/xmlschemasequence/
---
## XmlSchemaSequence classe


Representa o elemento **sequence** (compositor) do XML [Schema](../) conforme especificado pelo World Wide [Web](../../system.web/) Consortium (W3C). O **sequence** requer que os elementos no grupo apareçam na sequência especificada dentro do elemento contêiner.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Os elementos contidos dentro do compositor. Coleção de [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaSequence](./) ou [XmlSchemaAny](../xmlschemaany/). |
...
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Retorna o número como valor de string. Número mínimo de vezes que a partícula pode ocorrer. |
...
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Define o número como valor de string. Número mínimo de vezes que a partícula pode ocorrer. |
...
| [XmlSchemaSequence](./xmlschemasequence/)() | Inicializa uma nova instância da classe [XmlSchemaSequence](./). |
