...
description: Representa o elemento complexContent do XML Schema conforme especificado pelo World Wide Web Consortium (W3C). Esta classe representa o modelo de conteúdo complexo para tipos complexos. Ela contém extensões ou restrições em um tipo complexo que possui somente elementos ou conteúdo misto.
type: docs
weight: 261
url: /pt/system.xml.schema/xmlschemacomplexcontent/
---
## XmlSchemaComplexContent classe

Representa o elemento **complexContent** do XML [Schema](../) conforme especificado pelo World Wide [Web](../../system.web/) Consortium (W3C). Esta classe representa o modelo de conteúdo complexo para tipos complexos. Ele contém extensões ou restrições em um tipo complexo que possui apenas elementos ou conteúdo misto.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | Retorna o conteúdo. |
| [String](../../system/string/) [get_Id](../xmlschemaannotated/get_id/)() | Retorna o identificador da string. |
| **bool** [get_IsMixed](./get_ismixed/)() | Retorna informação que determina se o tipo tem um modelo de conteúdo misto. |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | Define o conteúdo. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Define o identificador da string. |
| void [set_IsMixed](./set_ismixed/)(**bool**) | Define a informação que determina se o tipo tem um modelo de conteúdo misto. |
...
|  [XmlSchemaComplexContent](./xmlschemacomplexcontent/)() | Inicializa uma nova instância da classe [XmlSchemaComplexContent](./). |
