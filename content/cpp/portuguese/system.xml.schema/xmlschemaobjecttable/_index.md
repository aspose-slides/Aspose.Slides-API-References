...
description: Fornece as coleções para os elementos contidos na classe XmlSchema (por exemplo, Attributes, AttributeGroups, Elements e assim por diante).
type: docs
weight: 716
url: /pt/system.xml.schema/xmlschemaobjecttable/
---
## XmlSchemaObjectTable classe

Fornece as coleções para os elementos contidos na classe [XmlSchema](../xmlschema/) (por exemplo, Attributes, AttributeGroups, Elements, e assim por diante).
...
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Determina se o nome qualificado especificado existe na coleção. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtém um iterador apontando imediatamente após o último elemento (se houver) da instância qualificada como const da coleção. |
...
| **int32_t** [get_Count](./get_count/)() | Retorna o número de itens contidos em [XmlSchemaObjectTable](./). |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\> [get_Names](./get_names/)() | Retorna uma coleção de todos os elementos nomeados em [XmlSchemaObjectTable](./). |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [get_Values](./get_values/)() | Retorna uma coleção de todos os valores de todos os elementos em [XmlSchemaObjectTable](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referências associada ao objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que pode percorrer o [XmlSchemaObjectTable](./). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogamente ao método [Object.GetHashCode()](../../system/object/gethashcode/) do C#. Permite a hash de objetos personalizados. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Retorna o elemento em [XmlSchemaObjectTable](./) especificado pelo nome qualificado. |
...
| Definição | Descrição |
| --- | --- |
| [Ptr](./ptr/) | Um alias para um ponteiro compartilhado para uma instância desta classe. |
