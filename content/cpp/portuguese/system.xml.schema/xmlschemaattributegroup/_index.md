...
description: Representa o elemento attributeGroup do XML Schema conforme especificado pelo Consórcio World Wide Web (W3C). AttributesGroups fornece um mecanismo para agrupar um conjunto de declarações de atributos de modo que possam ser incorporados como um grupo em definições de tipos complexos.
type: docs
weight: 183
url: /pt/system.xml.schema/xmlschemaattributegroup/
---
## XmlSchemaAttributeGroup classe

Representa o elemento **attributeGroup** do XML [Schema](../) conforme especificado pelo Consórcio World Wide [Web](../../system.web/) (W3C). AttributesGroups fornece um mecanismo para agrupar um conjunto de declarações de atributos de modo que possam ser incorporados como um grupo em definições de tipos complexos.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Retorna o componente [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) do grupo de atributos. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Retorna a coleção de atributos do grupo de atributos. Contém elementos [XmlSchemaAttribute](../xmlschemaattribute/) e [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Retorna o nome do grupo de atributos. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Retorna o nome qualificado do grupo de atributos. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttributeGroup](./)\> [get_RedefinedAttributeGroup](./get_redefinedattributegroup/)() | Retorna a propriedade de grupo de atributos redefinida do XML [Schema](../). |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Define o componente [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) do grupo de atributos. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Define o nome do grupo de atributos. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de modelo como ponteiro fraco (em vez de compartilhado). Permite troca de ponteiros em contêineres para modo fraco. |
...
|  [XmlSchemaAttributeGroup](./xmlschemaattributegroup/)() | Inicializa uma nova instância da classe [XmlSchemaAttributeGroup](./). |
...
Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-la a funções como argumento. 
