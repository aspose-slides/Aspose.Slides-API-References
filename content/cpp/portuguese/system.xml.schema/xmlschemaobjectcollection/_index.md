...
description: Uma coleção de XmlSchemaObjects.
type: docs
weight: 690
url: /pt/system.xml.schema/xmlschemaobjectcollection/
---
...
| Method | Description |
| --- | --- |
| **int32_t** [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Adiciona um [XmlSchemaObject](../xmlschemaobject/) ao [XmlSchemaObjectCollection](./). |
...
| void [Clear](../../system.collections/collectionbase/clear/)() | Remove todos os objetos da instância da coleção. Este método não pode ser sobrescrito. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Indica se o [XmlSchemaObject](../xmlschemaobject/) especificado está no [XmlSchemaObjectCollection](./). |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\&, **int32_t**) | Copia todos os XmlSchemaObjects da coleção para o array fornecido, começando no índice especificado. |
...
| **int32_t** [get_Capacity](../../system.collections/collectionbase/get_capacity/)() | Retorna o número de elementos que a coleção pode conter. |
| **int32_t** [get_Count](../../system.collections/collectionbase/get_count/)() | Retorna o número de elementos contidos na instância da coleção. Este método não pode ser sobrescrito. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador para iterar pelos XmlSchemaObjects contidos no [XmlSchemaObjectCollection](./). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hash de objetos personalizados. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(**int32_t**) | Retorna o [XmlSchemaObject](../xmlschemaobject/) no índice especificado. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>) | Define o [XmlSchemaObject](../xmlschemaobject/) no índice especificado. |
| **int32_t** [IndexOf](./indexof/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Retorna o índice da coleção correspondente ao [XmlSchemaObject](../xmlschemaobject/) especificado. |
| void [Insert](./insert/)(**int32_t**, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Insere um [XmlSchemaObject](../xmlschemaobject/) no [XmlSchemaObjectCollection](./). |
...
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Remove um [XmlSchemaObject](../xmlschemaobject/) do [XmlSchemaObjectCollection](./). |
| void [RemoveAt](../../system.collections/collectionbase/removeat/)(**int32_t**) | Remove o elemento no índice especificado da instância da coleção. Este método não pode ser sobrescrito. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| void [set_Capacity](../../system.collections/collectionbase/set_capacity/)(**int32_t**) | Define o número de elementos que a coleção pode conter. |
...
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)() | Inicializa uma nova instância da classe [XmlSchemaObjectCollection](./). |
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Inicializa uma nova instância da classe [XmlSchemaObjectCollection](./) que aceita um [XmlSchemaObject](../xmlschemaobject/). |
