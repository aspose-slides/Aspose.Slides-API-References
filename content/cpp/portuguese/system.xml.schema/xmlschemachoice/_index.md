...
description: Representa o elemento choice (compositor) do XML Schema conforme especificado pelo Consórcio World Wide Web (W3C). O choice permite que apenas um de seus filhos apareça em uma instância.
type: docs
weight: 209
url: /pt/system.xml.schema/xmlschemachoice/
---
## Classe XmlSchemaChoice

Representa o elemento **choice** (compositor) do XML [Schema](../) conforme especificado pelo Consórcio World Wide [Web](../../system.web/) (W3C). O **choice** permite que apenas um de seus filhos apareça em uma instância.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Retorna a coleção dos elementos contidos no compositor (**choice**): [XmlSchemaElement](../xmlschemaelement/), [XmlSchemaGroupRef](../xmlschemagroupref/), [XmlSchemaChoice](./), [XmlSchemaSequence](../xmlschemasequence/) ou [XmlSchemaAny](../xmlschemaany/). |
...
|  [XmlSchemaChoice](./xmlschemachoice/)() | Inicializa uma nova instância da classe [XmlSchemaChoice](./). |
