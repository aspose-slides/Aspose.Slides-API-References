...
description: Representa o elemento de anotação do World Wide Web Consortium (W3C).
type: docs
weight: 118
url: /pt/system.xml.schema/xmlschemaannotation/
---
...
| [String](../../system/string/) [get_Id](./get_id/)() | Retorna o ID de string. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() | Retorna a coleção **Items** que é usada para armazenar os elementos filho **appinfo** e **documentation**. |
...
| void [set_Id](./set_id/)(const [String](../../system/string/)\&) | Define o ID de string. |
...
|  [XmlSchemaAnnotation](./xmlschemaannotation/)() | Inicializa uma nova instância da classe [XmlSchemaAnnotation](./). |
