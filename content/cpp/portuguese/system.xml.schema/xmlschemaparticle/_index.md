...
description: Uma classe base que é a classe base para todos os tipos de partícula (por exemplo, XmlSchemaAny).
type: docs
weight: 729
url: /pt/system.xml.schema/xmlschemaparticle/
---
## XmlSchemaParticle classe
...
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | Retorna o número da linha no arquivo ao qual o elemento **schema** faz referência. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Retorna a posição da linha no arquivo ao qual o elemento **schema** faz referência. |
| [Decimal](../../system/decimal/) [get_MaxOccurs](./get_maxoccurs/)() | Retorna o número máximo de vezes que a partícula pode ocorrer. |
| [String](../../system/string/) [get_MaxOccursString](./get_maxoccursstring/)() | Retorna o número como um valor string. Número máximo de vezes que a partícula pode ocorrer. |
| [Decimal](../../system/decimal/) [get_MinOccurs](./get_minoccurs/)() | Retorna o número mínimo de vezes que a partícula pode ocorrer. |
| [String](../../system/string/) [get_MinOccursString](./get_minoccursstring/)() | Retorna o número como um valor string. O número mínimo de vezes que a partícula pode ocorrer. |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | Define o número da linha no arquivo ao qual o elemento **schema** faz referência. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Define a posição da linha no arquivo ao qual o elemento **schema** faz referência. |
| void [set_MaxOccurs](./set_maxoccurs/)([Decimal](../../system/decimal/)) | Define o número máximo de vezes que a partícula pode ocorrer. |
| void [set_MaxOccursString](./set_maxoccursstring/)(const [String](../../system/string/)\&) | Define o número como valor string. Número máximo de vezes que a partícula pode ocorrer. |
| void [set_MinOccurs](./set_minoccurs/)([Decimal](../../system/decimal/)) | Define o número mínimo de vezes que a partícula pode ocorrer. |
| void [set_MinOccursString](./set_minoccursstring/)(const [String](../../system/string/)\&) | Define o número como valor string. O número mínimo de vezes que a partícula pode ocorrer. |
...
|  [XmlSchemaObject](../xmlschemaobject/xmlschemaobject/)() | Inicia uma nova instância da classe [XmlSchemaObject](../xmlschemaobject/). |
|  [XmlSchemaParticle](./xmlschemaparticle/)() | Inicia uma nova instância da classe [XmlSchemaParticle](./). |
