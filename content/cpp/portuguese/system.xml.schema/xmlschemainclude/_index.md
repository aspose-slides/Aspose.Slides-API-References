...
description: Representa o elemento include do XML Schema conforme especificado pelo World Wide Web Consortium (W3C). Esta classe é usada para incluir declarações e definições de um schema externo. As declarações e definições incluídas ficam então disponíveis para processamento no schema contêiner.
type: docs
weight: 495
url: /pt/system.xml.schema/xmlschemainclude/
---
## XmlSchemaInclude classe

Representa o elemento **include** do XML [Schema](../) conforme especificado pelo Consórcio World Wide [Web](../../system.web/) (W3C). Esta classe é usada para incluir declarações e definições de um schema externo. As declarações e definições incluídas ficam então disponíveis para processamento no schema contêiner.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\> [get_Annotation](./get_annotation/)() | Retorna o valor da **annotation**. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [get_Schema](../xmlschemaexternal/get_schema/)() | Retorna o [XmlSchema](../xmlschema/) para o schema referenciado. |
| [String](../../system/string/) [get_SchemaLocation](../xmlschemaexternal/get_schemalocation/)() | Retorna o local do Uniform Resource Identifier (URI) para o schema, que informa ao processador de schema onde o schema está fisicamente localizado. |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Retorna o local de origem do arquivo que carregou o schema. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaexternal/get_unhandledattributes/)() | Retorna os atributos qualificados, que não pertencem ao namespace de destino do schema. |
...
| void [set_Annotation](./set_annotation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\>\&) | Define o valor da **annotation**. |
...
| void [set_Schema](../xmlschemaexternal/set_schema/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Define o [XmlSchema](../xmlschema/) para o schema referenciado. |
| void [set_SchemaLocation](../xmlschemaexternal/set_schemalocation/)(const [String](../../system/string/)\&) | Define o local do Uniform Resource Identifier (URI) para o schema, que informa ao processador de schema onde o schema está fisicamente localizado. |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Define o local de origem do arquivo que carregou o schema. |
| void [set_UnhandledAttributes](../xmlschemaexternal/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Define os atributos qualificados, que não pertencem ao namespace de destino do schema. |
...
|  [XmlSchemaInclude](./xmlschemainclude/)() | Inicializa uma nova instância da classe [XmlSchemaInclude](./). |
