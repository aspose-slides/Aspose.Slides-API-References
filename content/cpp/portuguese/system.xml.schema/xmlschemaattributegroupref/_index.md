...
description: Representa o elemento attributeGroup com o atributo ref do XML Schema conforme especificado por . AttributesGroupRef é a referência para um attributeGroup, a propriedade name contém o grupo de atributos referenciado.
type: docs
weight: 196
url: /pt/system.xml.schema/xmlschemaattributegroupref/
---
## XmlSchemaAttributeGroupRef classe

Representa o elemento **attributeGroup** com o atributo **ref** do XML [Schema](../) conforme especificado por [World Wide Web Consortium (W3C)](https://go.microsoft.com/fwlink/?LinkId=49454). AttributesGroupRef é a referência para um attributeGroup, a propriedade name contém o grupo de atributos referenciado.
...
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Retorna o XmlSerializerNamespaces a ser usado com este objeto schema. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Retorna o nome do elemento **attributeGroup** referenciado. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Define o XmlSerializerNamespaces a ser usado com este objeto schema. |
...
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Define o nome do elemento **attributeGroup** referenciado. |
...
|  [XmlSchemaAttributeGroupRef](./xmlschemaattributegroupref/)() | Inicializa uma nova instância da classe [XmlSchemaAttributeGroupRef](./). |
