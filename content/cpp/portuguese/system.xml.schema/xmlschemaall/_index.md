...
description: Representa o elemento all (compositor) do World Wide Web Consortium (W3C).
type: docs
weight: 92
url: /pt/system.xml.schema/xmlschemaall/
---
## XmlSchemaAll classe

Representa o World Wide [Web](../../system.web/) Consortium (W3C) **all** element (compositor).
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Retorna a coleção de elementos [XmlSchemaElement](../xmlschemaelement/) contidos dentro do compositor **all**. |
...
|  [XmlSchemaAll](./xmlschemaall/)() | Inicializa uma nova instância da classe [XmlSchemaAll](./). |
