...
description: Uma classe base para classes de conteúdo de tipo simples.
type: docs
weight: 846
url: /pt/system.xml.schema/xmlschemasimpletypecontent/
---
## XmlSchemaSimpleTypeContent classe

Uma classe base para classes de conteúdo de tipo simples.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n'th argumento de template como ponteiro fraco (em vez de compartilhado). Permite trocar ponteiros em contêineres para modo fraco. |
