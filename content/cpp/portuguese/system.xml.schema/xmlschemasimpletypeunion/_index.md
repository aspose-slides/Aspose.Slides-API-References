...
description: Representa o elemento union para tipos simples do XML Schema conforme especificado pelo World Wide Web Consortium (W3C). Um tipo de dados union pode ser usado para especificar o conteúdo de um simpleType. O valor do elemento simpleType deve ser qualquer um de um conjunto de tipos de dados alternativos especificados na união. Os tipos union são sempre tipos derivados e devem compreender pelo menos dois tipos de dados alternativos.
type: docs
weight: 885
url: /pt/system.xml.schema/xmlschemasimpletypeunion/
---
## XmlSchemaSimpleTypeUnion classe


Representa o elemento **union** para tipos simples do XML [Schema](../) conforme especificado pelo World Wide [Web](../../system.web/) Consortium (W3C). Um tipo de dados **union** pode ser usado para especificar o conteúdo de um **simpleType**. O valor do elemento **simpleType** deve ser qualquer um de um conjunto de tipos de dados alternativos especificados na união. Os tipos de união são sempre tipos derivados e devem compreender pelo menos dois tipos de dados alternativos.
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\> [get_BaseMemberTypes](./get_basemembertypes/)() | Retorna um array de objetos [XmlSchemaSimpleType](../xmlschemasimpletype/) representando o tipo do elemento **simpleType** baseado nos valores [XmlSchemaSimpleTypeUnion::get_BaseTypes](./get_basetypes/) e [XmlSchemaSimpleTypeUnion::get_MemberTypes](./get_membertypes/) do tipo simples. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_BaseTypes](./get_basetypes/)() | Retorna a coleção de tipos base. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\> [get_MemberTypes](./get_membertypes/)() | Retorna o array de nomes de membros qualificados de tipos de dados embutidos ou elementos **simpleType** definidos neste esquema (ou em outro esquema indicado pelo namespace especificado). |
...
| void [set_MemberTypes](./set_membertypes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\&) | Define o array de nomes de membros qualificados de tipos de dados embutidos ou elementos **simpleType** definidos neste esquema (ou em outro esquema indicado pelo namespace especificado). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de modelo como um ponteiro fraco (ao invés de compartilhado). Permite trocar ponteiros em contêineres para modo fraco. |
...
|  [XmlSchemaSimpleTypeUnion](./xmlschemasimpletypeunion/)() | Inicializa uma nova instância da classe [XmlSchemaSimpleTypeUnion](./). |
