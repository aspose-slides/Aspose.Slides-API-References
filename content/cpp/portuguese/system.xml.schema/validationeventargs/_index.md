...
description: Retorna informações detalhadas relacionadas ao ValidationEventHandler.
type: docs
weight: 53
url: /pt/system.xml.schema/validationeventargs/
---
...
| [XmlSchemaException](../xmlschemaexception/) [get_Exception](./get_exception/)() | Retorna o XmlSchemaException associado ao evento de validação. |
| [String](../../system/string/) [get_Message](./get_message/)() | Retorna a descrição de texto correspondente ao evento de validação. |
| [XmlSeverityType](../xmlseveritytype/) [get_Severity](./get_severity/)() | Retorna a gravidade do evento de validação. |
