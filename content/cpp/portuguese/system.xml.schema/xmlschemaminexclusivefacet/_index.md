...
description: Representa o elemento minExclusive do XML Schema conforme especificado pelo World Wide Web Consortium (W3C). Esta classe pode ser usada para especificar uma restrição ao valor mínimo de um elemento simpleType. O valor do elemento deve ser maior que o valor do elemento minExclusive.
type: docs
weight: 612
url: /pt/system.xml.schema/xmlschemaminexclusivefacet/
---
## XmlSchemaMinExclusiveFacet classe


Representa o elemento **minExclusive** do XML [Schema](../) conforme especificado pelo World Wide [Web](../../system.web/) Consortium (W3C). Esta classe pode ser usada para especificar uma restrição ao valor mínimo de um elemento **simpleType**. O valor do elemento deve ser maior que o valor do elemento **minExclusive**.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Retorna informações que indicam que este facet está fixo. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Define informações que indicam que este facet está fixo. |
...
|  [XmlSchemaMinExclusiveFacet](./xmlschemaminexclusivefacet/)() | Inicializa uma nova instância da classe [XmlSchemaMinExclusiveFacet](./). |
