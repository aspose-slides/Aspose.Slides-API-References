...
description: Uma classe abstrata para XmlSchemaAll, XmlSchemaChoice ou XmlSchemaSequence.
type: docs
weight: 443
url: /pt/system.xml.schema/xmlschemagroupbase/
---
## XmlSchemaGroupBase classe

Uma classe abstrata para [XmlSchemaAll](../xmlschemaall/), [XmlSchemaChoice](../xmlschemachoice/) ou [XmlSchemaSequence](../xmlschemasequence/).
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() | Esta coleção é usada para adicionar novos elementos ao compositor. |
