...
description: Uma classe base para todas as facetas que são usadas quando tipos simples são derivados por restrição.
type: docs
weight: 404
url: /pt/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet classe


Uma classe base para todas as facetas que são usadas quando tipos simples são derivados por restrição.
...
| virtual **bool** [get_IsFixed](./get_isfixed/)() | Retorna informação que indica que esta faceta está fixa. |
...
| [String](../../system/string/) [get_Value](./get_value/)() | Retorna o atributo **value** da faceta. |
...
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | Define informação que indica que esta faceta está fixa. |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Define o atributo **value** da faceta. |
...
|  [XmlSchemaFacet](./xmlschemafacet/)() | Inicializa uma nova instância da classe [XmlSchemaFacet](./). |
