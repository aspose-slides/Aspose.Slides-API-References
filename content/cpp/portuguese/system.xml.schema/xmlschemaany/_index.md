...
description: Representa o elemento any do World Wide Web Consortium (W3C).
type: docs
weight: 131
url: /pt/system.xml.schema/xmlschemaany/
---
## XmlSchemaAny classe


Representa o consórcio World Wide [Web](../../system.web/) (W3C) elemento **any**.
...
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Retorna os namespaces que contêm os elementos que podem ser usados. |
...
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | Retorna informações sobre como um aplicativo ou processador XML deve lidar com a validação de documentos XML para os elementos especificados pelo elemento **any**. |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Define os namespaces que contêm os elementos que podem ser usados. |
...
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | Define informações sobre como um aplicativo ou processador XML deve lidar com a validação de documentos XML para os elementos especificados pelo elemento **any**. |
...
|  [XmlSchemaAny](./xmlschemaany/)() | Inicializa uma nova instância da classe [XmlSchemaAny](./). |
