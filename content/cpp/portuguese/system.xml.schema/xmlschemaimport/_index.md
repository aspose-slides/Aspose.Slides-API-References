...
description: Representa o elemento import do XML Schema conforme especificado pelo World Wide Web Consortium (W3C). Esta classe é usada para importar componentes de esquema de outros esquemas.
type: docs
weight: 482
url: /pt/system.xml.schema/xmlschemaimport/
---
...
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Retorna o namespace de destino para o esquema importado como uma referência de Identificador Uniforme de Recurso (URI). |
...
| [String](../../system/string/) [get_SchemaLocation](../xmlschemaexternal/get_schemalocation/)() | Retorna a localização do Identificador Uniforme de Recurso (URI) para o esquema, que informa ao processador de esquemas onde o esquema está fisicamente localizado. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaexternal/get_unhandledattributes/)() | Retorna os atributos qualificados, que não pertencem ao namespace de destino do esquema. |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Define o namespace de destino para o esquema importado como uma referência de Identificador Uniforme de Recurso (URI). |
...
| void [set_SchemaLocation](../xmlschemaexternal/set_schemalocation/)(const [String](../../system/string/)\&) | Define a localização do Identificador Uniforme de Recurso (URI) para o esquema, que informa ao processador de esquemas onde o esquema está fisicamente localizado. |
...
| void [set_UnhandledAttributes](../xmlschemaexternal/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Define os atributos qualificados, que não pertencem ao namespace de destino do esquema. |
...
|  [XmlSchemaImport](./xmlschemaimport/)() | Inicializa uma nova instância da classe [XmlSchemaImport](./). |
