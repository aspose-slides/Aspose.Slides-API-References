...
description: Fornece opções de compilação de esquema para a classe XmlSchemaSet. Esta classe não pode ser herdada.
type: docs
weight: 248
url: /pt/system.xml.schema/xmlschemacompilationsettings/
---
## XmlSchemaCompilationSettings classe


Fornece opções de compilação de esquema para a [XmlSchemaSet](../xmlschemaset/) classe Esta classe não pode ser herdada.
...
| **bool** [get_EnableUpaCheck](./get_enableupacheck/)() | Retorna um valor indicando se o [XmlSchemaSet](../xmlschemaset/) deve verificar violações de Atribuição Única de Partículas (UPA). |
...
| void [set_EnableUpaCheck](./set_enableupacheck/)(**bool**) | Define um valor indicando se o [XmlSchemaSet](../xmlschemaset/) deve verificar violações de Atribuição Única de Partículas (UPA). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa a liberação da instrução C# lock(). Chame diretamente ou use o objeto sentry [LockContext](../../system/lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa o contador de referência fraca. Não deve ser chamado diretamente; use ponteiros inteligentes ou ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa o contador de referência fraca. Não deve ser chamado diretamente; use ponteiros inteligentes ou ThisProtector. |
|  [XmlSchemaCompilationSettings](./xmlschemacompilationsettings/)() | Inicializa uma nova instância da classe [XmlSchemaCompilationSettings](./). |
