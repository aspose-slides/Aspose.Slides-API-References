...
description: Representa o elemento maxInclusive do XML Schema conforme especificado pelo World Wide Web Consortium (W3C). Esta classe pode ser usada para especificar uma restrição ao valor máximo de um elemento simpleType. O valor do elemento deve ser menor ou igual ao valor do elemento maxInclusive.
type: docs
weight: 586
url: /pt/system.xml.schema/xmlschemamaxinclusivefacet/
---
## XmlSchemaMaxInclusiveFacet classe

Representa o elemento **maxInclusive** do XML [Schema](../) conforme especificado pelo Consórcio World Wide [Web](../../system.web/) (W3C). Esta classe pode ser usada para especificar uma restrição no valor máximo de um elemento **simpleType**. O valor do elemento deve ser menor ou igual ao valor do elemento **maxInclusive**.
...
|  [XmlSchemaMaxInclusiveFacet](./xmlschemamaxinclusivefacet/)() | Inicializa uma nova instância da classe [XmlSchemaMaxInclusiveFacet](./). |
