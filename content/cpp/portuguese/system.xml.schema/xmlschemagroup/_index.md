...
description: Representa o elemento group do XML Schema conforme especificado pelo World Wide Web Consortium (W3C). Esta classe define grupos no nível do schema que são referenciados a partir dos tipos complexos. Ela agrupa um conjunto de declarações de elementos para que possam ser incorporados como um grupo nas definições de tipos complexos.
type: docs
weight: 430
url: /pt/system.xml.schema/xmlschemagroup/
---
## XmlSchemaGroup classe

Representa o elemento **group** do XML [Schema](../) conforme especificado pelo Consórcio World Wide [Web](../../system.web/) (W3C). Esta classe define grupos no nível do **schema** que são referenciados a partir dos tipos complexos. Ela agrupa um conjunto de declarações de elementos para que possam ser incorporados como um grupo nas definições de tipos complexos.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Retorna o nome do grupo de schema. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | Retorna uma das classes [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) ou [XmlSchemaSequence](../xmlschemasequence/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Retorna o nome qualificado do grupo de schema. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Define o nome do grupo de schema. |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\>\&) | Define uma das classes [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) ou [XmlSchemaSequence](../xmlschemasequence/). |
...
|  [XmlSchemaGroup](./xmlschemagroup/)() | Inicializa uma nova instância da classe [XmlSchemaGroup](./). |
