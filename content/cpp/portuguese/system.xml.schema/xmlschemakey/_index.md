...
description: Esta classe representa o elemento key do XMLSchema conforme especificado pelo World Wide Web Consortium (W3C).
type: docs
weight: 534
url: /pt/system.xml.schema/xmlschemakey/
---
## XmlSchemaKey classe

Esta classe representa o elemento **key** do XMLSchema, conforme especificado pelo Consórcio World Wide [Web](../../system.web/) (W3C).
