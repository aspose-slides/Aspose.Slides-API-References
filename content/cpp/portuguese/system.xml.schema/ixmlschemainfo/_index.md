...
description: Define o conjunto de informações pós-validação de esquema de um nó XML validado.
type: docs
weight: 40
url: /pt/system.xml.schema/ixmlschemainfo/
---
...
| virtual **bool** [get_IsDefault](./get_isdefault/)() | Retorna um valor indicando se este nó XML validado foi definido como resultado de um valor padrão aplicado durante a validação do esquema XML [Schema](../) Definition Language (XSD). |
| virtual **bool** [get_IsNil](./get_isnil/)() | Retorna um valor indicando se o valor deste nó XML validado é **nil**. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | Retorna o tipo de esquema dinâmico para este nó XML validado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | Retorna o [XmlSchemaAttribute](../xmlschemaattribute/) compilado que corresponde a este nó XML validado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | Retorna o [XmlSchemaElement](../xmlschemaelement/) compilado que corresponde a este nó XML validado. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | Retorna o tipo de esquema estático XML [Schema](../) Definition Language (XSD) deste nó XML validado. |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | Retorna o valor XmlSchemaValidity deste nó XML validado. |
