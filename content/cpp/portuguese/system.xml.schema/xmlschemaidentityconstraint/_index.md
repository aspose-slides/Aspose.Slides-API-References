...
description: "Classe para as restrições de identidade: elementos key, keyref e unique."
type: docs
weight: 469
url: /pt/system.xml.schema/xmlschemaidentityconstraint/
---
## classe XmlSchemaIdentityConstraint

Classe para as restrições de identidade: **key**, **keyref** e elementos **unique**.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | Retorna a coleção de campos que se aplicam como filhos para o seletor de expressão da Linguagem de Caminho XML ([XPath](../../system.xml.xpath/)). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Retorna o nome da restrição de identidade. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Retorna o nome qualificado da restrição de identidade, que contém a interpretação pós-compilação do valor **QualifiedName**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | Retorna o elemento **selector** da expressão [XPath](../../system.xml.xpath/). |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Define o nome da restrição de identidade. |
...
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Define o elemento **selector** da expressão [XPath](../../system.xml.xpath/). |
...
|  [XmlSchemaIdentityConstraint](./xmlschemaidentityconstraint/)() | Inicializa uma nova instância da classe [XmlSchemaIdentityConstraint](./). |
