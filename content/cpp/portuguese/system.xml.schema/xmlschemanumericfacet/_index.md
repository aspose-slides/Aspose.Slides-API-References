...
description: Uma classe vaso para definir facetas numéricas. Esta classe é a classe base para classes de facetas numéricas, como XmlSchemaMinLengthFacet.
type: docs
weight: 664
url: /pt/system.xml.schema/xmlschemanumericfacet/
---
## XmlSchemaNumericFacet classe

Uma classe base para definição de facetas **numéricas**. Esta classe é a classe base para classes de facetas numéricas, como [XmlSchemaMinLengthFacet](../xmlschemaminlengthfacet/).
