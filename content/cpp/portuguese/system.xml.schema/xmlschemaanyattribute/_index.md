...
description: Representa o elemento anyAttribute do World Wide Web Consortium (W3C).
type: docs
weight: 144
url: /pt/system.xml.schema/xmlschemaanyattribute/
---
## XmlSchemaAnyAttribute classe

Representa o World Wide [Web](../../system.web/) Consortium (W3C) **anyAttribute** element.
...
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Retorna os namespaces que contêm os atributos que podem ser usados. |
...
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | Retorna informações sobre como um aplicativo ou processador XML deve lidar com a validação de documentos XML para os atributos especificados pelo elemento **anyAttribute**. |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Define os namespaces que contêm os atributos que podem ser usados. |
...
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | Define informações sobre como um aplicativo ou processador XML deve lidar com a validação de documentos XML para os atributos especificados pelo elemento **anyAttribute**. |
...
|  [XmlSchemaAnyAttribute](./xmlschemaanyattribute/)() | Inicializa uma nova instância da classe [XmlSchemaAnyAttribute](./). |
...
Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo como argumento a funções.
