...
description: Representa a facet de comprimento do XML Schema conforme especificado pelo World Wide Web Consortium (W3C). Esta classe pode ser usada para especificar uma restrição ao comprimento de um elemento simpleType no tipo de dado.
type: docs
weight: 560
url: /pt/system.xml.schema/xmlschemalengthfacet/
---
## XmlSchemaLengthFacet classe


Representa a **comprimento** facet do XML [Schema](../) conforme especificado pelo Consórcio World Wide [Web](../../system.web/) (W3C). Esta classe pode ser usada para especificar uma restrição ao **comprimento** de um elemento **simpleType** no tipo de dado.
...
|  [XmlSchemaLengthFacet](./xmlschemalengthfacet/)() | Inicializa uma nova instância da classe [XmlSchemaLengthFacet](./). |
