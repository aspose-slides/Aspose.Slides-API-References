...
second_title: Referência da API de Aspose.Slides para C++
description: Retorna informações sobre erros encontrados pela classe XmlSchemaInference ao inferir um esquema a partir de um documento XML.
type: docs
weight: 14
url: /pt/system.xml.schema/details_xmlschemainferenceexception/
---
## Details_XmlSchemaInferenceException classe


Retorna informações sobre erros encontrados pela classe [XmlSchemaInference](../xmlschemainference/) ao inferir um esquema a partir de um documento XML.
...
| [String](../../system/string/) [get_SourceUri](../details_xmlschemaexception/get_sourceuri/)() | Retorna o local do Identificador Uniforme de Recurso (URI) do esquema que causou a exceção. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Obtém o tipo real do objeto. Análogo da chamada C# [System.Object.GetType()](../../system/object/gettype/). |
