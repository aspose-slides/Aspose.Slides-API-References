...
description: Representa a faceta de enumeração do XML Schema conforme especificado pelo World Wide Web Consortium (W3C). Esta classe especifica uma lista de valores válidos para um elemento simpleType. A declaração está contida dentro de uma declaração de restrição.
type: docs
weight: 378
url: /pt/system.xml.schema/xmlschemaenumerationfacet/
---
## XmlSchemaEnumerationFacet classe


Representa a faceta **enumeration** do XML [Schema](../) conforme especificado pelo Consórcio World Wide [Web](../../system.web/) (W3C). Esta classe especifica uma lista de valores válidos para um elemento simpleType. A declaração está contida dentro de uma declaração **restriction**.
...
|  [XmlSchemaEnumerationFacet](./xmlschemaenumerationfacet/)() | Inicializa uma nova instância da classe [XmlSchemaEnumerationFacet](./). |
