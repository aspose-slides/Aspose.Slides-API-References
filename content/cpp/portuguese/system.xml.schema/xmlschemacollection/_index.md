...
description: Contém um cache de esquemas da linguagem de definição XML (XSD) e XML-Data Reduced (XDR).
type: docs
weight: 222
url: /pt/system.xml.schema/xmlschemacollection/
---
...
| Método | Descrição |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Adiciona o esquema localizado pela URL fornecida à coleção de esquemas. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Adiciona o esquema contido em [XmlReader](../../system.xml/xmlreader/) à coleção de esquemas. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Adiciona o esquema contido em [XmlReader](../../system.xml/xmlreader/) à coleção de esquemas. O [XmlResolver](../../system.xml/xmlresolver/) especificado é usado para resolver quaisquer recursos externos. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Adiciona o [XmlSchema](../xmlschema/) à coleção. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[System::Xml::XmlResolver](../../system.xml/xmlresolver/)\>\&) | Adiciona o [XmlSchema](../xmlschema/) à coleção. O [XmlResolver](../../system.xml/xmlresolver/) especificado é usado para resolver quaisquer referências externas. |
| void [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaCollection](./)\>\&) | Adiciona todos os espaços de nomes definidos na coleção fornecida (incluindo seus esquemas associados) a esta coleção. |
...
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\&) | Retorna um valor indicando se o **targetNamespace** do [XmlSchema](../xmlschema/) especificado está na coleção. |
| **bool** [Contains](./contains/)(const [String](../../system/string/)\&) | Retorna um valor indicando se um esquema com o espaço de nomes especificado está na coleção. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\&, **int32_t**) | Copia todos os objetos [XmlSchema](../xmlschema/) desta coleção para a matriz fornecida começando no índice informado. |
...
| **int32_t** [get_Count](./get_count/)() | Retorna o número de espaços de nomes definidos nesta coleção. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](./get_nametable/)() | Retorna o [XmlNameTable](../../system.xml/xmlnametable/) padrão usado pelo [XmlSchemaCollection](./) ao carregar novos esquemas. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\>\>\> [GetEnumerator](./getenumerator/)() override | Fornece suporte à iteração sobre a coleção de esquemas. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchema](../xmlschema/)\> [idx_get](./idx_get/)(const [String](../../system/string/)\&) | Retorna o [XmlSchema](../xmlschema/) associado ao URI do espaço de nomes fornecido. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Retorna um número especificado de elementos contíguos desde o início de uma sequência. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Construtor de cópia. Não copia nada, realmente, apenas inicializa um novo objeto e permite a construção de cópia de subclasses. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de atribuição. Não copia nada, realmente, apenas inicializa um novo objeto e permite a construção de cópia de subclasses. |
...
|  [XmlSchemaCollection](./xmlschemacollection/)() | Inicializa uma nova instância da classe [XmlSchemaCollection](./). |
|  [XmlSchemaCollection](./xmlschemacollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Inicializa uma nova instância da classe [XmlSchemaCollection](./) com o [XmlNameTable](../../system.xml/xmlnametable/) especificado. O [XmlNameTable](../../system.xml/xmlnametable/) é usado ao carregar esquemas. |
...
Obsoleto
:   A classe [XmlSchemaCollection](./) está obsoleta. Use [XmlSchemaSet](../xmlschemaset/) em vez disso.
