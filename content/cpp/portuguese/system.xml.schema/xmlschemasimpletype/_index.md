...
description: Representa o elemento simpleType para conteúdo simples de XML Schema conforme especificado pelo World Wide Web Consortium (W3C). Esta classe define um tipo simples. Tipos simples podem especificar informações e restrições para o valor de atributos ou elementos com conteúdo apenas de texto.
type: docs
weight: 833
url: /pt/system.xml.schema/xmlschemasimpletype/
---
## XmlSchemaSimpleType classe

Representa o elemento **simpleType** para conteúdo simples de XML [Schema](../) conforme especificado pelo Consórcio World Wide [Web](../../system.web/) (W3C). Esta classe define um tipo simples. Tipos simples podem especificar informações e restrições para o valor de atributos ou elementos com conteúdo apenas de texto.
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_BaseSchemaType](../xmlschematype/get_baseschematype/)() | Retorna o tipo de objeto pós-compilação ou o tipo de dado da Linguagem de Definição XML [Schema](../) (XSD) incorporada, elemento simpleType ou elemento complexType. Este é um valor de conjunto de informações pós-compilação de esquema. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleTypeContent](../xmlschemasimpletypecontent/)\> [get_Content](./get_content/)() | Retorna um dos [XmlSchemaSimpleTypeUnion](../xmlschemasimpletypeunion/), [XmlSchemaSimpleTypeList](../xmlschemasimpletypelist/) ou [XmlSchemaSimpleTypeRestriction](../xmlschemasimpletyperestriction/). |
...
| [XmlSchemaDerivationMethod](../xmlschemaderivationmethod/) [get_DerivedBy](../xmlschematype/get_derivedby/)() | Retorna as informações pós-compilação sobre como este elemento foi derivado do seu tipo base. |
...
| virtual **bool** [get_IsMixed](../xmlschematype/get_ismixed/)() | Retorna um valor indicando se este tipo tem um modelo de conteúdo misto. Esta chamada é válida apenas em um tipo complexo. |
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Retorna a posição na linha no arquivo ao qual o elemento **schema** se refere. |
...
| static [SharedPtr](../../system/sharedptr/)\<[XmlSchemaComplexType](../xmlschemacomplextype/)\> [GetBuiltInComplexType](../xmlschematype/getbuiltincomplextype/)([XmlTypeCode](../xmltypecode/)) | Retorna um [XmlSchemaComplexType](../xmlschemacomplextype/) que representa o tipo complexo embutido do tipo complexo especificado. |
| static [SharedPtr](../../system/sharedptr/)\<[XmlSchemaComplexType](../xmlschemacomplextype/)\> [GetBuiltInComplexType](../xmlschematype/getbuiltincomplextype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Retorna um [XmlSchemaComplexType](../xmlschemacomplextype/) que representa o tipo complexo embutido do tipo complexo especificado por nome qualificado. |
| static [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](./)\> [GetBuiltInSimpleType](../xmlschematype/getbuiltinsimpletype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Retorna um [XmlSchemaSimpleType](./) que representa o tipo simples embutido do tipo simples especificado pelo nome qualificado. |
| static [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](./)\> [GetBuiltInSimpleType](../xmlschematype/getbuiltinsimpletype/)([XmlTypeCode](../xmltypecode/)) | Retorna um [XmlSchemaSimpleType](./) que representa o tipo simples embutido do tipo simples especificado. |
...
| void [set_Content](./set_content/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleTypeContent](../xmlschemasimpletypecontent/)\>\&) | Define um dos [XmlSchemaSimpleTypeUnion](../xmlschemasimpletypeunion/), [XmlSchemaSimpleTypeList](../xmlschemasimpletypelist/) ou [XmlSchemaSimpleTypeRestriction](../xmlschemasimpletyperestriction/). |
| void [set_Final](../xmlschematype/set_final/)([XmlSchemaDerivationMethod](../xmlschemaderivationmethod/)) | Define o atributo final da derivação do tipo que indica se derivação adicional é permitida. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Define o id da string. |
| virtual void [set_IsMixed](../xmlschematype/set_ismixed/)(**bool**) | Define um valor indicando se este tipo tem um modelo de conteúdo misto. Esta chamada é válida apenas em um tipo complexo. |
...
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Define a posição na linha no arquivo ao qual o elemento **schema** se refere. |
...
|  [XmlSchemaSimpleType](./xmlschemasimpletype/)() | Inicializa uma nova instância da classe [XmlSchemaSimpleType](./). |
