...
description: Representa o elemento de restrição para conteúdo simples do XML Schema, conforme especificado pelo World Wide Web Consortium (W3C). Esta classe pode ser usada para derivar tipos simples por restrição. Essas derivações podem ser usadas para restringir o intervalo de valores do elemento a um subconjunto dos valores especificados no tipo simples herdado.
type: docs
weight: 820
url: /pt/system.xml.schema/xmlschemasimplecontentrestriction/
---
## XmlSchemaSimpleContentRestriction classe

Representa o elemento **restrição** para conteúdo simples de XML [Schema](../) conforme especificado pelo World Wide [Web](../../system.web/) Consortium (W3C). Esta classe pode ser usada para derivar tipos simples por restrição. Tais derivações podem ser usadas para restringir o intervalo de valores do elemento a um subconjunto dos valores especificados no tipo simples herdado.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Retorna um [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) a ser usado para o valor do atributo. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Retorna a coleção de atributos [XmlSchemaAttribute](../xmlschemaattribute/) e [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) para o tipo simples. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | Retorna o valor base do tipo simples. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Retorna o nome do tipo de dado interno ou tipo simples do qual este tipo é derivado. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | Retorna uma faceta [Xml](../../system.xml/)[Schema](../). |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Define um [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) a ser usado para o valor do atributo. |
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Define o valor base do tipo simples. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Define o nome do tipo de dado interno ou tipo simples do qual este tipo é derivado. |
...
|  [XmlSchemaSimpleContentRestriction](./xmlschemasimplecontentrestriction/)() | Inicializa uma nova instância da classe [XmlSchemaSimpleContentRestriction](./). |
| virtual  [~Object](../../system/object/~object/)() | Destrói o objeto. Libera todas as estruturas internas. |
