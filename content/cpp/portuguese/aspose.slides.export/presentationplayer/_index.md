...
description: Representa o reprodutor de animações associado à Apresentação.
type: docs
weight: 625
...
| Método | Descrição |
| --- | --- |
| void [Dispose](./dispose/)() override | Descarta a instância do [PresentationPlayer](./). |
...
| **int32_t** [get_FrameIndex](./get_frameindex/)() | Obtém o índice do quadro. |
...
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | Cria uma nova instância do [PresentationPlayer](./). |
...
| Definição | Descrição |
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | Representa o manipulador de tick de quadro do evento **PresentationPlayer::FrameTick**. |
