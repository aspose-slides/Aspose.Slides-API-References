...
| virtual ASPOSE_SLIDES_LOCAL_API **double** [get_Duration](./get_duration/)() | Obtém a duração da animação [ms] |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referências associada ao objeto. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IImage](../../aspose.slides/iimage/)\> [GetFrame](./getframe/)() | Obtém o quadro para a posição de tempo atual previamente definida com o método [IPresentationAnimationPlayer::SetTimePosition](./settimeposition/). |
...
| virtual ASPOSE_SLIDES_LOCAL_API void [SetTimePosition](./settimeposition/)(**double**) | Define a posição de tempo da animação dentro do [IPresentationAnimationPlayer::get_Duration](./get_duration/). |
...
Animações geradas por [PresentationAnimationsGenerator](../presentationanimationsgenerator/) através do seu evento **PresentationAnimationsGenerator::NewAnimation**. 
