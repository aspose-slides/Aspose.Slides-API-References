...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | Especifica quantos slides e em que sequência serão colocados na página [HandoutType](../handouttype/). |
| **bool** [get_PrintComments](./get_printcomments/)() const | Especifica se exibir ou não comentários nos slides |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | Especifica se desenhar molduras ao redor dos slides exibidos ou não. |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | Especifica se imprimir ou não os números dos slides exibidos. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógia do método C# [Object.GetHashCode()](../../system/object/gethashcode/). Habilita hashing de objetos personalizados. |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | Especifica quantos slides e em que sequência serão colocados na página [HandoutType](../handouttype/). |
| void [set_PrintComments](./set_printcomments/)(**bool**) | Especifica se exibir ou não comentários nos slides |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | Especifica se desenhar molduras ao redor dos slides exibidos ou não. |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | Especifica se imprimir ou não os números dos slides exibidos. |
