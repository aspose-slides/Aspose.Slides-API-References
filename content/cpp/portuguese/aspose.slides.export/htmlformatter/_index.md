...
| Método | Descrição |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateCustomFormatter](./createcustomformatter/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Cria e retorna um formatador HTML para geração de HTML personalizada baseada em callbacks. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateDocumentFormatter](./createdocumentformatter/)([System::String](../../system/string/), **bool**) | Cria e retorna um formatador HTML para uma visualização simples de documento que consiste em sequências de slides um abaixo do outro. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HtmlFormatter](./)\> [CreateSlideShowFormatter](./createslideshowformatter/)([System::String](../../system/string/), **bool**) | Cria e retorna um formatador HTML para uma apresentação de slides simples que exibe os slides um após o outro. |
