...
description: Representa opções de exportação GIF.
type: docs
weight: 157
...
Representa opções de exportação GIF.
...
| virtual **int32_t** [get_DefaultDelay](./get_defaultdelay/)() | Obtém o tempo de atraso padrão [ms]. Este valor será usado se o método [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/) não for chamado. O valor padrão é 1000. |
...
| virtual **bool** [get_ExportHiddenSlides](./get_exporthiddenslides/)() | Determina se slides ocultos serão exportados. O valor padrão é false. |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_FrameSize](./get_framesize/)() | Obtém o tamanho do quadro. |
...
| virtual **int32_t** [get_TransitionFps](./get_transitionfps/)() | Obtém FPS de transição [frames/seg] O valor padrão é 25. |
...
| virtual void [set_DefaultDelay](./set_defaultdelay/)(**int32_t**) | Define o tempo de atraso padrão [ms]. Este valor será usado se o método [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/) não for chamado. O valor padrão é 1000. |
...
| virtual void [set_ExportHiddenSlides](./set_exporthiddenslides/)(**bool**) | Determina se slides ocultos serão exportados. O valor padrão é false. |
| virtual void [set_FrameSize](./set_framesize/)([System::Drawing::Size](../../system.drawing/size/)) | Define o tamanho do quadro. |
...
| virtual void [set_SkipJavaScriptLinks](../isaveoptions/set_skipjavascriptlinks/)(**bool**) | Especifica se deve ignorar hyperlinks com chamadas JavaScript ao salvar a apresentação. Grava **bool**. O valor padrão é **false**. |
| virtual void [set_TransitionFps](./set_transitionfps/)(**int32_t**) | Define FPS de transição [frames/seg] O valor padrão é 25. |
