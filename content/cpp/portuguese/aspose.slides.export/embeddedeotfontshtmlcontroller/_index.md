...
description: A classe controladora de formatação a ser usada para incorporação de fontes no formato EOT
type: docs
weight: 14
...
A classe controladora de formatação a ser usada para incorporação de fontes no formato EOT
...
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Cria uma nova instância. |
