...
| virtual void [set_DrawSlidesFrame](./set_drawslidesframe/)(**bool**) | Verdadeiro para desenhar uma borda preta ao redor de cada slide. Escreve **bool**. |
...
| virtual void [set_SaveMetafilesAsPng](./set_savemetafilesaspng/)(**bool**) | Verdadeiro para converter todos os metarquivos usados em uma apresentação em imagens PNG. Escreve **bool**. |
...
| virtual void [set_SkipJavaScriptLinks](../isaveoptions/set_skipjavascriptlinks/)(**bool**) | Especifica se deve pular hyperlinks com chamadas JavaScript ao salvar a apresentação. Escreve **bool**. O valor padrão é **false**. |
