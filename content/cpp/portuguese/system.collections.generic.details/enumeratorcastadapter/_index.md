...
description: Enumerador usado pelo método de extensão IEnumerable.Cast().
type: docs
weight: 53
url: /pt/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter classe

Enumerador usado pelo método de extensão IEnumerable.Cast().
...
| --- | --- |
| Source | O tipo de origem dos elementos da coleção. |
| Result | O tipo de resultado dos elementos da coleção. |
## Métodos
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | Marca o enumerador como pertencente ao iterador virtualizado. |
...
| **bool** [MoveNext](./movenext/)() override | Move o enumerador para o próximo elemento. Se nenhum elemento foi referenciado antes, define a referência para o primeiro elemento disponível. Se o fim do contêiner for atingido, não faz nada. |
