...
description: Enumerable usado pelos métodos de extensão IEnumerable.Cast() e IEnumerable.OfType().
type: docs
weight: 1
url: /pt/system.collections.generic.details/enumerableadapter/
---
## EnumerableAdapter classe

Enumerable usado pelos métodos de extensão IEnumerable.Cast() e IEnumerable.OfType().
...
| EnumeratorAdapter | O tipo do adaptador de enumerador. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../../system.collections.generic/ienumerator/)\<Result\>\> [GetEnumerator](./getenumerator/)() override | Obtém o enumerador. |
