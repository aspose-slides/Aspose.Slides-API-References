...
type: docs
weight: 92
url: /pt/system.collections.generic.details/enumeratorselectindexadapter/
---
## EnumeratorSelectIndexAdapter classe
...
| Método | Descrição |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Prepara o iterador a ser usado pela classe VirtualizedIterator. |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Move o iterador um passo adiante. |
...
| void [Lock](../../system/object/lock/)() | Implementa o bloqueio da instrução C# lock(). Chame diretamente ou use [LockContext](../../system/lockcontext/) sentry object. |
...
| **bool** [MoveNext](./movenext/)() override | Move o enumerador para o próximo elemento. Se nenhum elemento foi referenciado antes, define a referência para o primeiro elemento disponível. Se o final do contêiner for alcançado, não faz nada. |
...
| void [Reset](./reset/)() override | Reinicia o enumerador para a posição antes do primeiro elemento. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de modelo como um ponteiro fraco (ao invés de compartilhado). Permite alternar ponteiros em contêineres para o modo fraco. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa o desbloqueio da instrução C# lock(). Chame diretamente ou use [LockContext](../../system/lockcontext/) sentry object. |
