...
description: Enumerador usado pelo método de extensão IEnumerable.OfType().
type: docs
weight: 66
url: /pt/system.collections.generic.details/enumeratoroftypeadapter/
---
...
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Faz a primeira chamada [MoveNext()](../../system.collections.generic/ienumerator/movenext/) e prepara o objeto enumerador para ser usado pelo VirtualizedIterator. |
...
| **bool** [MoveNext](./movenext/)() override | Avança o enumerador para o próximo elemento. Se nenhum elemento foi referenciado antes, define a referência para o primeiro elemento disponível. Se o fim do contêiner for alcançado, não faz nada. |
