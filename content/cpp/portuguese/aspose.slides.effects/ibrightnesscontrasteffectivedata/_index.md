...
Objeto imutável que representa um efeito [BrightnessContrast](../brightnesscontrast/). Ajusta brilho e contraste
...
| virtual **float** [get_Brightness](./get_brightness/)() | Retorna brilho. **float** somente leitura. |
| virtual **float** [get_Contrast](./get_contrast/)() | Retorna contraste. **float** somente leitura. |
