...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se o [FillOverlay](./) especificado é igual ao [FillOverlay](./) atual. |
...
| [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() override | FillBlendMode. Leitura [FillBlendMode](../../aspose.slides/fillblendmode/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Formato de preenchimento. Somente leitura [IFillFormat](../../aspose.slides/ifillformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlayEffectiveData](../ifilloverlayeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtém os dados efetivos do efeito Fill Overlay com a herança aplicada. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Funciona como uma função de hash para um tipo específico. |
...
| void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) override | FillBlendMode. Escrita [FillBlendMode](../../aspose.slides/fillblendmode/). |
...
* Classe [IFillOverlay](../ifilloverlay/)
