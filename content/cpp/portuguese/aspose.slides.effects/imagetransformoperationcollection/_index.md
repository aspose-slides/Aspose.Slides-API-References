...
| Método | Descrição |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) override | Adiciona o novo efeito de imagem ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevel](../ialphabilevel/)\> [AddAlphaBiLevelEffect](./addalphabileveleffect/)(**float**) override | Adiciona o novo efeito Alpha Bi-Level ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeiling](../ialphaceiling/)\> [AddAlphaCeilingEffect](./addalphaceilingeffect/)() override | Adiciona o novo efeito Alpha Ceiling ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloor](../ialphafloor/)\> [AddAlphaFloorEffect](./addalphaflooreffect/)() override | Adiciona o novo efeito Alpha Floor ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverse](../ialphainverse/)\> [AddAlphaInverseEffect](./addalphainverseeffect/)() override | Adiciona o novo efeito Alpha Inverse ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulate](../ialphamodulate/)\> [AddAlphaModulateEffect](./addalphamodulateeffect/)() override | Adiciona o novo efeito Alpha Modulate ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixed](../ialphamodulatefixed/)\> [AddAlphaModulateFixedEffect](./addalphamodulatefixedeffect/)(**float**) override | Adiciona o novo efeito Alpha Modulate Fixed ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplace](../ialphareplace/)\> [AddAlphaReplaceEffect](./addalphareplaceeffect/)(**float**) override | Adiciona o novo efeito Alpha Replace ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevel](../ibilevel/)\> [AddBiLevelEffect](./addbileveleffect/)(**float**) override | Adiciona o novo efeito Bi-Level (preto/branco) ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlur](../iblur/)\> [AddBlurEffect](./addblureffect/)(**double**, **bool**) override | Adiciona o novo [Blur](../blur/) efeito ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBrightnessContrast](../ibrightnesscontrast/)\> [AddBrightnessContrastEffect](./addbrightnesscontrasteffect/)(**float**, **float**) override | Adiciona o novo [BrightnessContrast](../brightnesscontrast/) efeito ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorChange](../icolorchange/)\> [AddColorChangeEffect](./addcolorchangeeffect/)() override | Adiciona o novo efeito Color Change ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplace](../icolorreplace/)\> [AddColorReplaceEffect](./addcolorreplaceeffect/)() override | Adiciona o novo efeito Color Replacement ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotone](../iduotone/)\> [AddDuotoneEffect](./addduotoneeffect/)() override | Adiciona o novo [Duotone](../duotone/) efeito ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlay](../ifilloverlay/)\> [AddFillOverlayEffect](./addfilloverlayeffect/)() override | Adiciona o novo efeito Fill Overlay ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGrayScale](../igrayscale/)\> [AddGrayScaleEffect](./addgrayscaleeffect/)() override | Adiciona o novo efeito Gray Scale ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHSL](../ihsl/)\> [AddHSLEffect](./addhsleffect/)(**float**, **float**, **float**) override | Adiciona o novo efeito Hue/Saturation/Luminance ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminance](../iluminance/)\> [AddLuminanceEffect](./addluminanceeffect/)(**float**, **float**) override | Adiciona o novo [Luminance](../luminance/) efeito ao final de uma coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITint](../itint/)\> [AddTintEffect](./addtinteffect/)(**float**, **float**) override | Adiciona o novo [Tint](../tint/) efeito ao final de uma coleção. |
...
| void [Clear](./clear/)() override | Remove todos os efeitos de imagem de uma coleção. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) const override | Determina se o [ICollection](../../system.collections.generic/icollection/) contém um valor específico. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\>, **int32_t**) override | Copia os elementos de [ICollection](../../system.collections.generic/icollection/) para um [System::Array](../../system/array/), iniciando em um índice [System::Array](../../system/array/) específico. |
...
| **int32_t** [get_Count](./get_count/)() const override | Retorna o número de efeitos de imagem em uma coleção. Somente leitura **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Obtém um valor indicando se o [ICollection](../../system.collections.generic/icollection/) é somente leitura. Somente leitura **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera sobre a coleção. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\> [idx_get](./idx_get/)(**int32_t**) override | Retorna um [ImageTransformOperation](../imagetransformoperation/) da coleção pelo seu índice. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) override | Remove a primeira ocorrência de um objeto específico da [ICollection](../../system.collections.generic/icollection/). |
| void [RemoveAt](./removeat/)(**int32_t**) override | Remove um efeito de imagem de uma coleção no índice especificado. |
