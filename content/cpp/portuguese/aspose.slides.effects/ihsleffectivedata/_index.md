...
description: Representa um efeito de matiz/saturação/luminosidade. A matiz, saturação e luminosidade podem ser ajustadas individualmente em relação ao seu valor atual.
type: docs
weight: 703
...
Representa um efeito de matiz/saturação/luminosidade. A matiz, saturação e luminosidade podem ser ajustadas individualmente em relação ao seu valor atual.
...
| virtual **float** [get_Hue](./get_hue/)() | Retorna a porcentagem de matiz. Somente leitura **float**. |
| virtual **float** [get_Luminance](./get_luminance/)() | Retorna a porcentagem de luminosidade. Somente leitura **float**. |
| virtual **float** [get_Saturation](./get_saturation/)() | Retorna a porcentagem de saturação. Somente leitura **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Construtor de cópia. Na prática não copia nada, apenas inicializa um novo objeto e permite a cópia ao construir subclasses. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de atribuição. Na prática não copia nada, apenas inicializa um novo objeto e permite a cópia ao construir subclasses. |
