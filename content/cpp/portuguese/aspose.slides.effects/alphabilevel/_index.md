...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se o [AlphaBiLevel](./) especificado é igual ao [AlphaBiLevel](./) atual. |
...
| **float** [get_Threshold](./get_threshold/)() override | Retorna o limiar do efeito. Lê **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevelEffectiveData](../ialphabileveleffectivedata/)\> [GetEffective](./geteffective/)() override | Obtém os dados efetivos do efeito Alpha Bi-Level com a herança aplicada. |
...
| void [set_Threshold](./set_threshold/)(**float**) override | Retorna o limiar do efeito. Escrita **float**. |
