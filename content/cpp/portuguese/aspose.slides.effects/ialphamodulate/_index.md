...
description: Representa um efeito Alpha Modulate. Os valores de alfa (opacidade) do efeito são multiplicados por uma porcentagem fixa. O contêiner de efeito especifica um efeito contendo valores alfa para modular.
type: docs
weight: 339
