...
description: Representa um efeito Alpha Modulate Fixed. Valores de alfa (opacidade) do efeito são multiplicados por uma porcentagem fixa.
type: docs
weight: 66
...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se o [AlphaModulateFixed](./) especificado é igual ao [AlphaModulateFixed](./) atual. |
...
| **float** [get_Amount](./get_amount/)() override | Retorna uma quantidade do efeito em porcentagens. Leitura **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtém os dados efetivos do efeito Alpha Modulate Fixed com a herança aplicada. |
...
| void [set_Amount](./set_amount/)(**float**) override | Retorna uma quantidade do efeito em porcentagens. Escrita **float**. |
