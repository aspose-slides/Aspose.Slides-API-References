...
description: Objeto imutável que representa um efeito Alpha Modulate Fixed. Os valores alfa (opacidade) do efeito são multiplicados por uma porcentagem fixa.
type: docs
weight: 378
...
Objeto imutável que representa um efeito Alpha Modulate Fixed. Os valores alfa (opacidade) do efeito são multiplicados por uma porcentagem fixa.
...
| virtual **float** [get_Amount](./get_amount/)() | Retorna a quantidade de efeito em percentuais. **float** somente leitura. |
