...
description: Objeto imutável que representa um efeito Alpha Floor. Valores de Alpha (opacidade) menores que 100 % são alterados para zero. Em outras palavras, tudo que é parcialmente transparente torna-se totalmente transparente.
type: docs
weight: 300
...
Objeto imutável que representa um efeito Alpha Floor. Valores de Alpha (opacidade) menores que 100% são alterados para zero. Em outras palavras, qualquer coisa parcialmente transparente torna-se totalmente transparente.
