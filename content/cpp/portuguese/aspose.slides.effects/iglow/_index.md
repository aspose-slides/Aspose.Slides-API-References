...
Representa um efeito [Glow](../glow/), no qual um contorno borrado de cor é adicionado fora das bordas do objeto.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | Formato de cor. Somente leitura [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual **double** [get_Radius](./get_radius/)() | Raio. Leia **double**. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Raio. Grava **double**. |
