...
description: Representa um efeito Bi-Level (preto/branco). As cores de entrada cuja luminância é menor que o valor limite especificado são alteradas para preto. As cores de entrada cuja luminância é maior ou igual ao valor especificado são definidas como branco. Os valores de efeito alfa não são afetados por este efeito.
type: docs
weight: 92
...
Representa um efeito Bi-Level (preto/branco). As cores de entrada cuja luminância é menor que o valor limiar especificado são alteradas para preto. As cores de entrada cuja luminância é maior ou igual ao valor especificado são definidas como branco. Os valores de efeito alfa não são afetados por este efeito.
...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se o [BiLevel](./) especificado é igual ao [BiLevel](./) atual. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevelEffectiveData](../ibileveleffectivedata/)\> [GetEffective](./geteffective/)() override | Obtém os dados efetivos do efeito Bi-Level com a herança aplicada. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de template como um ponteiro fraco (em vez de compartilhado). Permite mudar os ponteiros em contêineres para modo fraco. |
