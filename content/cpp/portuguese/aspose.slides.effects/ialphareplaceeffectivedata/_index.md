...
description: Objeto imutável que representa um efeito Alpha Replace. Os valores alfa (opacidade) do efeito são substituídos por um alfa fixo.
type: docs
weight: 404
url: /pt/aspose.slides.effects/ialphareplaceeffectivedata/
---
## IAlphaReplaceEffectiveData classe


Objeto imutável que representa um efeito Alpha Replace. Os valores alfa (opacidade) do efeito são substituídos por um alfa fixo.
...
| virtual **float** [get_Alpha](./get_alpha/)() | Retorna novo valor alfa no intervalo [0..1] somente leitura **float**. |
