...
description: Representa um efeito Alpha Ceiling. Valores Alpha (opacidade) maiores que zero são alterados para 100%. Em outras palavras, tudo que é parcialmente opaco torna-se totalmente opaco.
type: docs
weight: 14
...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se o [AlphaCeiling](./) especificado é igual ao [AlphaCeiling](./) atual. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeilingEffectiveData](../ialphaceilingeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtém os dados efetivos do efeito Alpha Ceiling com a herança aplicada. |
