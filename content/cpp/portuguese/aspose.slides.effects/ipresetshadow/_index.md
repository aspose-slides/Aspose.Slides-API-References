...
type: docs
weight: 911
url: /pt/aspose.slides.effects/ipresetshadow/
---
...
| virtual **float** [get_Direction](./get_direction/)() | Direção da sombra. Lê **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Distância da sombra. Lê **double**. |
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | Predefinição. Lê [PresetShadowType](../../aspose.slides/presetshadowtype/). |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hash de objetos customizados. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo ao método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonagem de tipos customizados. |
...
| virtual void [set_Direction](./set_direction/)(**float**) | Direção da sombra. Escreve **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Distância da sombra. Escreve **double**. |
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | Predefinição. Escreve [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de modelo como ponteiro fraco (em vez de compartilhado). Permite a troca de ponteiros em contêineres para modo fraco. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analogo ao método C# [Object.ToString()](../../system/object/tostring/). Permite converter objetos customizados para string. |
