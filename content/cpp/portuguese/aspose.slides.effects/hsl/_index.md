...
Representa um efeito de Matiz/Saturação/Luminosidade. A matiz, a saturação e a luminosidade podem ser ajustadas individualmente em relação ao seu valor atual.
...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se o [HSL](./) especificado é igual ao [HSL](./) atual. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHSLEffectiveData](../ihsleffectivedata/)\> [GetEffective](./geteffective/)() override | Obtém os dados efetivos do efeito Matiz/Saturação/Luminosidade com a herança aplicada. |
