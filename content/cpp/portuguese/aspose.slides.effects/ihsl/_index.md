...
description: Representa um efeito Matiz/Saturação/Luminância. O matiz, a saturação e a luminância podem ser ajustados individualmente em relação ao seu valor atual.
type: docs
weight: 690
...
Representa um efeito Hue/Saturation/Luminance. O hue, a saturation e a luminance podem ser ajustados individualmente em relação ao seu valor atual.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n'th argumento do modelo como ponteiro fraco (ao invés de compartilhado). Permite trocar ponteiros em contêineres para modo fraco. |
