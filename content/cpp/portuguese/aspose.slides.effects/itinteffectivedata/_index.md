...
description: Objeto imutável que representa um efeito Tint. Desloca os valores de cor do efeito em direção ou afastamento do matiz na quantidade especificada.
type: docs
weight: 1002
...
Objeto imutável que representa um [Tint](../tint/) effect. Desloca os valores de cor do efeito em direção/afastamento do matiz em uma quantidade especificada.
...
| virtual **float** [get_Amount](./get_amount/)() | Retorna a quantidade do efeito. **float** somente leitura. |
| virtual **float** [get_Hue](./get_hue/)() | Retorna o matiz. **float** somente leitura. |
