...
description: Representa um efeito de Luminância. O brilho desloca linearmente todas as cores mais próximas do branco ou do preto. O contraste escala todas as cores para que fiquem mais próximas ou mais distantes umas das outras.
type: docs
weight: 807
...
Representa um [Luminance](../luminance/) efeito. O brilho desloca linearmente todas as cores mais próximas do branco ou do preto. O contraste escala todas as cores para que fiquem mais próximas ou mais distantes umas das outras.
...
| virtual **float** [get_Brightness](./get_brightness/)() | Brilho. Somente leitura **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Contraste. Somente leitura **float**. |
