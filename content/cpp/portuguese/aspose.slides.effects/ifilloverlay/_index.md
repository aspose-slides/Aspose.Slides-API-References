...
description: Representa um efeito de preenchimento de sobreposição. Um preenchimento de sobreposição pode ser usado para especificar um preenchimento adicional para um objeto e mesclar os dois preenchimentos juntos.
type: docs
weight: 612
...
Representa um efeito de preenchimento de sobreposição. Um preenchimento de sobreposição pode ser usado para especificar um preenchimento adicional para um objeto e mesclar os dois preenchimentos juntos.
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode. Leitura [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Formato de preenchimento. Somente leitura [IFillFormat](../../aspose.slides/ifillformat/). |
...
| virtual void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) | FillBlendMode. Escrita [FillBlendMode](../../aspose.slides/fillblendmode/). |
