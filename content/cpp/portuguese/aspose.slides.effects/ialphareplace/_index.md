...
---
## IAlphaReplace classe


Representa a interface base [IImageTransformOperation](../iimagetransformoperation/).
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa o contador de referência fraca. Não deve ser chamado diretamente; ao invés disso, use smart pointers ou ThisProteitor. |
