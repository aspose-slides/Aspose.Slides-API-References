...
description: Objeto imutável que representa um efeito em escala de cinza. Converte todos os valores de cor do efeito para um tom de cinza, correspondente à sua luminância. Os valores alfa (opacidade) do efeito não são alterados.
type: docs
weight: 677
...
Objeto imutável que representa um efeito em escala de cinza. Converte todos os valores de cor do efeito para um tom de cinza, correspondente à sua luminância. Os valores alfa (opacidade) do efeito não são alterados.
