...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se o [SoftEdge](./) especificado é igual ao [SoftEdge](./) atual. |
...
| **double** [get_Radius](./get_radius/)() override | Especifica o raio de desfoque a ser aplicado nas bordas. Leitura **double**. |
| virtual ASPOSE_SLIDES_LOCAL_API **uint32_t** [get_Version](../../aspose.slides/ipviobject/get_version/)() | Versão. **uint32_t** somente leitura. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtém os dados efetivos do efeito Soft Edge com a herança aplicada. |
...
| void [set_Radius](./set_radius/)(**double**) override | Especifica o raio de desfoque a ser aplicado nas bordas. **double** de escrita. |
