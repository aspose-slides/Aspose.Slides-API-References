...
description: Representa um efeito Alpha Bi-Level. Valores Alpha (Opacidade) menores que o limiar são alterados para 0 (totalmente transparente) e valores alpha maiores ou iguais ao limiar são alterados para 100% (totalmente opaco).
type: docs
weight: 235
url: /pt/aspose.slides.effects/ialphabilevel/
---
## IAlphaBiLevel classe
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compara objetos do tipo referência em estilo C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compara objetos do tipo valor em estilo C#. |
...
| virtual **float** [get_Threshold](./get_threshold/)() | Retorna o limiar do efeito. Leitura **float**. |
...
| virtual void [set_Threshold](./set_threshold/)(**float**) | Retorna o limiar do efeito. Escrita **float**. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Análogo ao método C# [Object.ToString()](../../system/object/tostring/). Permite a conversão de objetos personalizados para string. |
...
Use [ImageTransformOperationFactory](../imagetransformoperationfactory/) para criar instâncias em COM.
