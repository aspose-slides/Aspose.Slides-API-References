...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | Raio [Blur](../blur/). Somente leitura **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Direção da sombra. Somente leitura **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Distância da sombra. Somente leitura **double**. |
...
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | Especifica se a sombra deve girar com a forma quando a forma é girada. Somente leitura **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | Especifica o fator de escala horizontal; escala negativa provoca inversão. Somente leitura **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | Especifica o fator de escala vertical; escala negativa provoca inversão. Somente leitura **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ShadowColor](./get_shadowcolor/)() | Cor da sombra. Somente leitura [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | Especifica o ângulo de inclinação horizontal (em graus). Somente leitura **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | Especifica o ângulo de inclinação vertical (em graus). Somente leitura **double**. |
