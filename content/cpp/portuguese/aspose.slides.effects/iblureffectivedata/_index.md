...
description: Objeto imutável que representa um efeito de desfoque aplicado a toda a forma, incluindo seu preenchimento. Todos os canais de cor, incluindo alfa, são afetados.
type: docs
weight: 469
...
Objeto imutável que representa um efeito [Blur](../blur/) aplicado a toda a forma, incluindo seu preenchimento. Todos os canais de cor, incluindo alfa, são afetados.
...
| virtual **bool** [get_Grow](./get_grow/)() | Determina se os limites do objeto devem ser ampliados como resultado do desfoque. True indica que os limites são ampliados enquanto false indica que não são. Somente leitura **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Retorna o raio do desfoque. Somente leitura **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogia ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Habilita a criação de hash para objetos personalizados. |
