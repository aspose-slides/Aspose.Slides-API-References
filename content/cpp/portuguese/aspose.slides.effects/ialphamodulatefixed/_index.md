...
description: Representa um efeito Alpha Modulate Fixed. Os valores alfa (opacidade) do efeito são multiplicados por uma porcentagem fixa.
type: docs
weight: 365
...
| virtual **float** [get_Amount](./get_amount/)() | Retorna uma quantidade do efeito em porcentagem. Leitura **float**. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogo do método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite a geração de hash de objetos personalizados. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo do método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite a clonagem de tipos personalizados. |
...
| virtual void [set_Amount](./set_amount/)(**float**) | Retorna uma quantidade do efeito em porcentagem. Escrita **float**. |
