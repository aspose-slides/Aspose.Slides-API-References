...
description: Objeto imutável que representa um efeito bi-nível (preto/branco). Cores de entrada cuja luminância é menor que o valor de limiar especificado são alteradas para preto. Cores de entrada cuja luminância é maior ou igual ao valor especificado são definidas como branco. Os valores de efeito alfa não são afetados por este efeito.
type: docs
weight: 443
...
Objeto imutável que representa um efeito bi-nível (preto/branco). Cores de entrada cuja luminância é menor que o valor de limiar especificado são alteradas para preto. Cores de entrada cuja luminância é maior ou igual ao valor especificado são definidas como branco. Os valores de efeito alfa não são afetados por este efeito.
...
| virtual **float** [get_Threshold](./get_threshold/)() | Retorna o valor de limiar. **float** somente leitura. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de template como ponteiro fraco (ao invés de compartilhado). Permite alternar ponteiros em contêineres para modo fraco. |
