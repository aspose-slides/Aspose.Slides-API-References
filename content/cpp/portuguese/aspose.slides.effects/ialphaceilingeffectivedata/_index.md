...
description: Objeto imutável que representa um efeito Alpha Ceiling. Valores Alpha (opacidade) maiores que zero são alterados para 100%. Em outras palavras, tudo que é parcialmente opaco torna-se totalmente opaco.
type: docs
weight: 274
...
Objeto imutável que representa um efeito Alpha Ceiling. Valores Alpha (opacidade) maiores que zero são alterados para 100%. Em outras palavras, tudo que é parcialmente opaco torna-se totalmente opaco.
