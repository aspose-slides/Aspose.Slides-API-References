...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) raio. Leitura **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Direção da sombra. Leitura **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Distância da sombra. Leitura **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Cor da sombra. Somente leitura [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual void [set_BlurRadius](./set_blurradius/)(**double**) | Raio [Blur](../blur/). Escreva **double**. |
| virtual void [set_Direction](./set_direction/)(**float**) | Direção da sombra. Escreva **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Distância da sombra. Escreva **double**. |
