...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se o [InnerShadow](./) especificado é igual ao [InnerShadow](./) atual. |
...
| **double** [get_BlurRadius](./get_blurradius/)() override | [Blur](../blur/) raio. Leia **double**. |
| **float** [get_Direction](./get_direction/)() override | Direção da sombra. Leia **float**. |
| **double** [get_Distance](./get_distance/)() override | Distância da sombra. Leia **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() override | Cor da sombra. Somente leitura [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IInnerShadowEffectiveData](../iinnershadoweffectivedata/)\> [GetEffective](./geteffective/)() override | Obtém os dados efetivos do efeito Inner Shadow com a herança aplicada. |
...
| void [set_BlurRadius](./set_blurradius/)(**double**) override | [Blur](../blur/) raio. Grave **double**. |
| void [set_Direction](./set_direction/)(**float**) override | Direção da sombra. Grave **float**. |
| void [set_Distance](./set_distance/)(**double**) override | Distância da sombra. Grave **double**. |
