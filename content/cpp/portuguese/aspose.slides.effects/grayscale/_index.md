...
description: Representa um efeito de escala de cinza. Converte todos os valores de cor do efeito para um tom de cinza, correspondendo à sua luminância. Os valores alfa (opacidade) do efeito não são afetados.
type: docs
weight: 209
...
Representa um efeito de escala de cinza. Converte todos os valores de cor do efeito para um tom de cinza, correspondente à sua luminância. Os valores alfa (opacidade) do efeito não são afetados.
...
| Método | Descrição |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se o [GrayScale](./) especificado é igual ao [GrayScale](./) atual. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de pontos flutuantes ao estilo C# onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não é igual a nenhum valor, incluindo NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de pontos flutuantes ao estilo C# onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não é igual a nenhum valor, incluindo NaN. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGrayScaleEffectiveData](../igrayscaleeffectivedata/)\> [GetEffective](./geteffective/)() override | Obtém os dados efetivos do efeito Gray Scale com a herança aplicada. |
