...
Representa um efeito [Blur](../blur/) que é aplicado a toda a forma, incluindo seu preenchimento. Todos os canais de cor, incluindo alfa, são afetados.
...
| virtual **bool** [get_Grow](./get_grow/)() | Determina se os limites do objeto devem ser ampliados como resultado do desfoque. True indica que os limites são ampliados, enquanto false indica que não são. Leitura **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Retorna o raio do desfoque. Leitura **double**. |
...
| virtual void [set_Grow](./set_grow/)(**bool**) | Determina se os limites do objeto devem ser ampliados como resultado do desfoque. True indica que os limites são ampliados, enquanto false indica que não são. Escrita **bool**. |
| virtual void [set_Radius](./set_radius/)(**double**) | Define o raio do desfoque. Escrita **double**. |
