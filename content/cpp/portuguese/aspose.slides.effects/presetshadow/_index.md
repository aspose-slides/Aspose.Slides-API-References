...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Determina se o [PresetShadow](./) especificado é igual ao [PresetShadow](./) atual. |
...
| **float** [get_Direction](./get_direction/)() override | Direção da sombra. Leitura **float**. |
| **double** [get_Distance](./get_distance/)() override | Distância da sombra. Leitura **double**. |
...
| [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() override | Predefinição. Leitura [PresetShadowType](../../aspose.slides/presetshadowtype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadowEffectiveData](../ipresetshadoweffectivedata/)\> [GetEffective](./geteffective/)() override | Obtém os dados efetivos do efeito Preset Shadow com a herança aplicada. |
...
| void [set_Direction](./set_direction/)(**float**) override | Direção da sombra. Escrita **float**. |
| void [set_Distance](./set_distance/)(**double**) override | Distância da sombra. Escrita **double**. |
| void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) override | Predefinição. Escrita [PresetShadowType](../../aspose.slides/presetshadowtype/). |
