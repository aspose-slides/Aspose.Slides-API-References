...
| void [Dispose](./dispose/)(**bool**) override | Não faz nada. |
...
| int [Peek](./peek/)() override | Lê um único caractere do fluxo sem alterar a posição do fluxo. |
| int [Read](./read/)() override | Lê um único caractere do fluxo. |
| int [Read](./read/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) override | Lê o número especificado de caracteres do fluxo para o array de caracteres especificado, começando na posição especificada. |
...
| [String](../../system/string/) [ReadLine](./readline/)() override | Lê caracteres do fluxo até o final da linha atual. |
| [String](../../system/string/) [ReadToEnd](./readtoend/)() override | Lê caracteres do fluxo até o final do fluxo. |
...
|  [StringReader](./stringreader/)(const [String](../../system/string/)\&) | Constrói uma nova instância da classe [StringReader](./) que lê caracteres da string especificada. |
