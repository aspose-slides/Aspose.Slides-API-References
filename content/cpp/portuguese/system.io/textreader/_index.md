...
| virtual int [Peek](./peek/)() | Lê um único caractere do fluxo sem mudar o cursor de leitura do fluxo. |
| virtual int [Read](./read/)() | Lê um único caractere do fluxo. |
| virtual int [Read](./read/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) | Lê o número especificado de caracteres do fluxo e grava-os no array de caracteres especificado a partir da posição especificada. |
| virtual int [ReadBlock](./readblock/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int) | Lê o número máximo especificado de caracteres do leitor de texto atual e grava os dados em um buffer, começando no índice especificado. |
| virtual [System::String](../../system/string/) [ReadLine](./readline/)() | Lê caracteres do fluxo até o fim da linha atual. |
| virtual [System::String](../../system/string/) [ReadToEnd](./readtoend/)() | Lê caracteres do fluxo até o fim do fluxo. |
