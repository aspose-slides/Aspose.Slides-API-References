...
description: Escreve caracteres de terminador de linha no fluxo.
type: docs
weight: 92
url: /pt/system.io/streamwriter/writeline/
---
## StreamWriter::WriteLine() método

Escreve caracteres de terminador de linha no fluxo.
...
Escreve a string especificada seguida pelos caracteres de terminação de linha no fluxo.
...
Escreve a representação em string do objeto especificado seguida pelos caracteres de terminação de linha no fluxo.
...
Escreve todos os caracteres do array especificado seguida pelos caracteres de terminação de linha no fluxo.
...
Escreve o subintervalo especificado de caracteres UTF-16 do array de caracteres especificado seguida pelos caracteres de terminação de linha no fluxo.
...
| --- | --- | --- |
| buffer | const [ArrayPtr](../../../system/arrayptr/)\<char_t\>\& | O array contendo os caracteres a serem escritos |
| index | **int32_t** | Um índice baseado em 0 do elemento em **buffer** onde o subintervalo a ser escrito começa |
...
Escreve a c-string especificada seguida pelos caracteres de terminação de linha no fluxo.
