...
description: Fornece o status de conclusão de um loop paralelo.
type: docs
weight: 14
url: /pt/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult classe


Fornece o status de conclusão de um loop [Parallel](../parallel/).
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Obtém se o loop foi concluído. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Obtém o índice de iteração mais baixo no qual ocorreu um break. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Constrói um [ParallelLoopResult](./). |
...
Representa o resultado de uma operação de loop paralelo, incluindo se foi concluído e informações sobre quebras. 
