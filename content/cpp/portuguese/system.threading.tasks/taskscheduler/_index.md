...
description: Representa um objeto que manipula o trabalho de baixo nível de enfileiramento de tarefas em threads.
type: docs
weight: 79
url: /pt/system.threading.tasks/taskscheduler/
---
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | Cria um [TaskScheduler](./) associado ao thread atual. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | Obtém o [TaskScheduler](./) associado à tarefa em execução. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | Obtém a instância padrão [TaskScheduler](./) fornecida pela estrutura. |
| **int32_t** [get_Id](./get_id/)() const | Obtém o ID único para este [TaskScheduler](./). |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | Indica o nível máximo de concorrência que este [TaskScheduler](./) pode suportar. |
