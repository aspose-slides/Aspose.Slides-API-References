...
description: Fornece um resultado aguardável de uma operação assíncrona.
type: docs
weight: 92
url: /pt/system.threading.tasks/valuetask/
---
## ValueTask classe
...
| Método | Descrição |
| --- | --- |
| [TaskPtr](../../system/taskptr/) [AsTask](./astask/)() const | Converte este [ValueTask](./) para um ponteiro compartilhado de [Task](../task/). |
| [Runtime::CompilerServices::ConfiguredValueTaskAwaitable](../../system.runtime.compilerservices/configuredvaluetaskawaitable/) [ConfigureAwait](./configureawait/)(**bool**) const | Configura um aguardador para esta tarefa. |
| **bool** [Equals](./equals/)([ValueTask](./)) override | Determina se esta instância é igual a outra instância [ValueTask](./). |
...
| [Runtime::CompilerServices::ValueTaskAwaiter](../../system.runtime.compilerservices/valuetaskawaiter/) [GetAwaiter](./getawaiter/)() const | Obtém um awaiter para esta tarefa para suportar expressões await. |
...
| **bool** [operator!=](./operator_not_equal/)(const [ValueTask](./)\&) const | Operador de desigualdade para [ValueTask](./). |
...
| **bool** [operator==](./operator_equal_equal/)(const [ValueTask](./)\&) const | Operador de igualdade para [ValueTask](./). |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Análogo do método [Object.ToString()](../../system/object/tostring/) do C#. Permite converter objetos personalizados em string. |
...
|  [ValueTask](./valuetask/)() | Constrói um [ValueTask](./) vazio e não inicializado. |
|  [ValueTask](./valuetask/)(const [TaskPtr](../../system/taskptr/)\&) | Constrói um [ValueTask](./) a partir de um ponteiro compartilhado para um [Task](../task/). |
