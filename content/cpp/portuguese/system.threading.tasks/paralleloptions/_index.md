...
description: Armazena opções que configuram a operação dos métodos na classe Parallel.
type: docs
weight: 27
url: /pt/system.threading.tasks/paralleloptions/
---
## ParallelOptions classe


Armazena opções que configuram a operação dos métodos na classe [Parallel](../parallel/).
...
| const [CancellationToken](../../system.threading/cancellationtoken/)\& [get_CancellationToken](./get_cancellationtoken/)() | Obtém o [CancellationToken](../../system.threading/cancellationtoken/) associado a esta instância de [ParallelOptions](./). |
| **int32_t** [get_MaxDegreeOfParallelism](./get_maxdegreeofparallelism/)() | Obtém o grau máximo de paralelismo habilitado por esta instância de [ParallelOptions](./). |
| const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](../taskscheduler/)\>\& [get_TaskScheduler](./get_taskscheduler/)() | Obtém o [TaskScheduler](../taskscheduler/) associado a esta instância de [ParallelOptions](./). |
...
|  [ParallelOptions](./paralleloptions/)() | Constrói uma instância de [ParallelOptions](./) com valores padrão. |
...
| void [set_CancellationToken](./set_cancellationtoken/)(const [CancellationToken](../../system.threading/cancellationtoken/)\&) | Define o [CancellationToken](../../system.threading/cancellationtoken/) associado a esta instância de [ParallelOptions](./). |
| void [set_MaxDegreeOfParallelism](./set_maxdegreeofparallelism/)(**int32_t**) | Define o grau máximo de paralelismo habilitado por esta instância de [ParallelOptions](./). |
| void [set_TaskScheduler](./set_taskscheduler/)(const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](../taskscheduler/)\>\&) | Define o [TaskScheduler](../taskscheduler/) associado a esta instância de [ParallelOptions](./). |
