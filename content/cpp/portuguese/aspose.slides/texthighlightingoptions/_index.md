...
description: Representa opções que podem ser usadas para realçar texto em um quadro de texto.
type: docs
weight: 5474
url: /pt/aspose.slides/texthighlightingoptions/
---
## TextHighlightingOptions classe


Representa opções que podem ser usadas para realçar texto em um quadro de texto.
...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Defina como verdadeiro para usar busca que diferencia maiúsculas e minúsculas, falso caso contrário. Leia **bool**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Defina como verdadeiro para corresponder apenas palavras inteiras, falso caso contrário. Leia **bool**. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analógia do método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonar tipos personalizados. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Defina como verdadeiro para usar busca que diferencia maiúsculas e minúsculas, falso caso contrário. Grave **bool**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Defina como verdadeiro para corresponder apenas palavras inteiras, falso caso contrário. Grave **bool**. |
...
|  [TextHighlightingOptions](./texthighlightingoptions/)() | Cria novas opções padrão de realce de texto. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Analógia do método C# [Object.ToString()](../../system/object/tostring/). Permite converter objetos personalizados para string. |
...
Obsoleto
:   A interface [ITextHighlightingOptions](../itexthighlightingoptions/) será removida após o lançamento da versão 24.10.
