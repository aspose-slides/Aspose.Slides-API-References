...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Retorna a descrição de texto do objeto Summary Zoom [Section](../section/). |
...
| virtual **bool** [get_ShowBackground](../izoomobject/get_showbackground/)() | Obtém o valor que especifica se o Zoom usará o fundo do slide de destino. Somente leitura **bool**. Valor padrão: true |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](../isectionzoomframe/get_targetsection/)() | Obtém o objeto de seção ao qual o objeto Zoom [Section](../section/) está vinculado. Leia [ISection](../isection/). |
...
| virtual [System::String](../../system/string/) [get_Title](./get_title/)() | Retorna o título de texto do objeto Summary Zoom [Section](../section/). |
...
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | Retorna a posição de uma forma na ordem Z. Shapes[0] retorna a forma mais no fundo da ordem Z, e Shapes[Shapes.Count - 1] retorna a forma mais à frente da ordem Z. Somente leitura **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetImage](../ishape/getimage/)() | Retorna a miniatura da forma. [ShapeThumbnailBounds::Shape](../shapethumbnailbounds/) o tipo de limites da miniatura da forma é usado por padrão. |
...
| virtual void [set_Description](./set_description/)([System::String](../../system/string/)) | Define a descrição de texto do objeto Summary Zoom [Section](../section/). |
...
| virtual void [set_HyperlinkMouseOver](../ihyperlinkcontainer/set_hyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) | Define o hyperlink definido para mouse over. Escreva [IHyperlink](../ihyperlink/). |
| virtual void [set_ImageType](../izoomobject/set_imagetype/)([ZoomImageType](../zoomimagetype/)) | Define o tipo de imagem de um objeto zoom. Escreva [ZoomImageType](../zoomimagetype/). Valor padrão: Preview |
...
| virtual void [set_ReturnToParent](../izoomobject/set_returntoparent/)(**bool**) | Define o comportamento de navegação na apresentação de slides. Escreva **bool**. Valor padrão: false |
...
| virtual void [set_ShowBackground](../izoomobject/set_showbackground/)(**bool**) | Define o valor que especifica se o Zoom usará o fundo do slide de destino. Escreva **bool**. Valor padrão: true |
| virtual void [set_TargetSection](../isectionzoomframe/set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | Define o objeto de seção ao qual o objeto Zoom [Section](../section/) está vinculado. Escreva [ISection](../isection/). |
| virtual void [set_Title](./set_title/)([System::String](../../system/string/)) | Define o título de texto do objeto Summary Zoom [Section](../section/). |
| virtual void [set_TransitionDuration](../izoomobject/set_transitionduration/)(**float**) | Define a duração da transição entre Zoom e slide. Escreva **float**. Valor padrão: 1.0f |
...
| virtual void [set_ZoomImage](../izoomobject/set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | Define a imagem para o objeto zoom. Escreva [IPPImage](../ippimage/). |
