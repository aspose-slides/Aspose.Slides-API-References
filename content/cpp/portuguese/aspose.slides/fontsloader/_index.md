...
description: Classe para carregamento de fontes personalizadas definidas pelo usuário. Deve ser usada antes de criar quaisquer objetos de apresentação.
type: docs
weight: 976
...
Classe para carregamento de fontes personalizadas definidas pelo usuário. Deve ser usada antes de criar quaisquer objetos de apresentação.
...
| Método | Descrição |
| --- | --- |
| static void [ClearCache](./clearcache/)() | Libera todas as fontes personalizadas definidas pelo usuário |
...
| static [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetFontFolders](./getfontfolders/)() | Obtém pastas de fontes. Retorna pastas que foram adicionadas com o método LoadExternalFonts, bem como pastas de fontes do sistema |
...
| static void [LoadExternalFont](./loadexternalfont/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Adiciona fonte a partir dos dados binários |
| static void [LoadExternalFonts](./loadexternalfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Adiciona pastas adicionais para procurar fontes. |
