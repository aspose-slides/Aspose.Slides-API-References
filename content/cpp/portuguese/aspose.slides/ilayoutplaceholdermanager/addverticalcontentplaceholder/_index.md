...
Criado [IAutoShape](../../iautoshape/) com um espaço reservado Content (Vertical).
## Remarks



O exemplo a seguir mostra como adicionar a forma de espaço reservado Content (Vertical) ao slide de layout. 
```cpp
