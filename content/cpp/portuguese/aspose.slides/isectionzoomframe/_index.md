...
Representa um objeto [Section](../section/) Zoom em um slide.
...
| virtual **bool** [get_ReturnToParent](../izoomobject/get_returntoparent/)() | Obtém o comportamento de navegação na apresentação de slides. Leia **bool**. Valor padrão: false. |
...
| virtual **bool** [get_ShowBackground](../izoomobject/get_showbackground/)() | Obtém o valor que especifica se o Zoom usará o fundo do slide de destino. Leia **bool**. Valor padrão: true. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](./get_targetsection/)() | Obtém o objeto de seção ao qual o objeto Zoom [Section](../section/) está vinculado. Leia [ISection](../isection/). |
...
| virtual **float** [get_TransitionDuration](../izoomobject/get_transitionduration/)() | Obtém a duração da transição entre Zoom e slide. Leia **float**. Valor padrão: 1.0f. |
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Retorna um identificador interno de escopo de apresentação destinado ao uso por complementos ou outro código. Como esse valor pode ser redefinido pelo usuário ou programaticamente, ele não deve ser tratado como uma chave única persistente. Somente leitura **uint32_t**. Veja também [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
...
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | Retorna a posição de uma forma na ordem Z. Shapes[0] devolve a forma na parte traseira da ordem Z, e Shapes[Shapes.Count - 1] devolve a forma na frente da ordem Z. Somente leitura **int32_t**. |
...
| virtual void [set_ImageType](../izoomobject/set_imagetype/)([ZoomImageType](../zoomimagetype/)) | Define o tipo de imagem de um objeto Zoom. Escrita [ZoomImageType](../zoomimagetype/). Valor padrão: Preview. |
...
| virtual void [set_ReturnToParent](../izoomobject/set_returntoparent/)(**bool**) | Define o comportamento de navegação na apresentação de slides. Escrita **bool**. Valor padrão: false. |
...
| virtual void [set_ShowBackground](../izoomobject/set_showbackground/)(**bool**) | Define o valor que especifica se o Zoom usará o fundo do slide de destino. Escrita **bool**. Valor padrão: true. |
| virtual void [set_TargetSection](./set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) | Define o objeto de seção ao qual o objeto Zoom [Section](../section/) está vinculado. Escrita [ISection](../isection/). |
| virtual void [set_TransitionDuration](../izoomobject/set_transitionduration/)(**float**) | Define a duração da transição entre Zoom e slide. Escrita **float**. Valor padrão: 1.0f. |
...
| virtual void [set_ZoomImage](../izoomobject/set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | Define a imagem para o objeto Zoom. Escrita [IPPImage](../ippimage/). |
