...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | Retorna o comentário feito por este autor no índice especificado. Somente leitura [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | Retorna a coleção de comentários feitos por este autor. Somente leitura [ICommentCollection](../icommentcollection/). |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | Retorna as iniciais do autor. Leitura [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Retorna o nome do autor. Leitura [System::String](../../system/string/). |
...
| void [Remove](./remove/)() override | Remove o autor da coleção pai. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | Define as iniciais do autor. Grava [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Define o nome do autor. Grava [System::String](../../system/string/). |
