...
description: Representa a propriedade 'Heading pair' do documento. Indica o nome do grupo das partes do documento e o número de partes no grupo.
type: docs
weight: 1223
...
Representa a propriedade 'Heading pair' do documento. Indica o nome do grupo das partes do documento e o número de partes no grupo.
...
| **int32_t** [get_Count](./get_count/)() override | Retorna o número de partes no grupo. Somente leitura **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Retorna o nome do grupo das partes do documento. Somente leitura [System::String](../../system/string/). |
