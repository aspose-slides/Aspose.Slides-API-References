...
description: Representa o gerenciador que contém o comportamento do rodapé do slide de notas mestre, dos marcadores de data/hora, número de página e todos os marcadores filhos. Marcadores filhos significam que os marcadores estão contidos em slides de notas dependentes. Slides de notas dependentes usam e dependem do slide de notas mestre.
type: docs
weight: 2900
...
| virtual **bool** [get_IsDateTimeVisible](../ibaseslideheaderfootermanager/get_isdatetimevisible/)() | Obtém valor indicando que um marcador de data/hora está presente. Leitura**bool**. |
| virtual **bool** [get_IsFooterVisible](../ibaseslideheaderfootermanager/get_isfootervisible/)() | Obtém valor indicando que um marcador de rodapé está presente. Leitura **bool**. |
| virtual **bool** [get_IsHeaderVisible](../ibasehandoutnotesslideheaderfootermanag/get_isheadervisible/)() | Obtém valor indicando que um marcador de cabeçalho está presente. Leitura **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](../ibaseslideheaderfootermanager/get_isslidenumbervisible/)() | Obtém valor indicando que um marcador de número de página está presente. Leitura**bool**. |
...
| virtual void [SetDateTimeAndChildDateTimesText](./setdatetimeandchilddatetimestext/)([System::String](../../system/string/)) | Define o texto no marcador de data/hora do slide de notas mestre e em todos os marcadores de data/hora filhos. Marcadores filhos significam que os marcadores estão contidos em slides de notas dependentes. Slides de notas dependentes usam e dependem do slide de notas mestre. |
...
| virtual void [SetFooterAndChildFootersText](./setfooterandchildfooterstext/)([System::String](../../system/string/)) | Define o texto no marcador de rodapé do slide de notas mestre e em todos os marcadores de rodapé filhos. Marcadores filhos significam que os marcadores estão contidos em slides de notas dependentes. Slides de notas dependentes usam e dependem do slide de notas mestre. |
...
| virtual void [SetHeaderAndChildHeadersText](./setheaderandchildheaderstext/)([System::String](../../system/string/)) | Define o texto no marcador de cabeçalho do slide de notas mestre e em todos os marcadores de cabeçalho filhos. Marcadores filhos significam que os marcadores estão contidos em slides de notas dependentes. Slides de notas dependentes usam e dependem do slide de notas mestre. |
...
| virtual void [SetHeaderText](../ibasehandoutnotesslideheaderfootermanag/setheadertext/)([System::String](../../system/string/)) | Define o texto no marcador de cabeçalho do slide. |
| virtual void [SetHeaderVisibility](../ibasehandoutnotesslideheaderfootermanag/setheadervisibility/)(**bool**) | Altera a visibilidade do marcador de cabeçalho do slide. |
