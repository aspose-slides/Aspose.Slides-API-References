...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Retorna a cor do guia de desenho. Leitura [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Retorna a orientação do guia de desenho. Leitura [Slides::Orientation](../orientation/). |
| virtual **float** [get_Position](./get_position/)() | Retorna a posição do guia de desenho em pontos a partir do canto superior esquerdo do slide. Leitura **float**. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Define a cor do guia de desenho. Escrita [System::Drawing::Color](../../system.drawing/color/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | Define a orientação do guia de desenho. Escrita [Slides::Orientation](../orientation/). |
| virtual void [set_Position](./set_position/)(**float**) | Define a posição do guia de desenho em pontos a partir do canto superior esquerdo do slide. Escrita **float**. |
