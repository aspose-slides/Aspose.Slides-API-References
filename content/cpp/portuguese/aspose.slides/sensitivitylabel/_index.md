...
| [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() override | Retorna o método de atribuição para o rótulo de sensibilidade. Leia [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() override | Retorna a lista de tipos de marcação de conteúdo que devem ser aplicados a um arquivo. |
| [System::String](../../system/string/) [get_Id](./get_id/)() override | Retorna o id do rótulo de sensibilidade. Leia [System::String](../../system/string/). |
| **bool** [get_IsEnabled](./get_isenabled/)() override | Indica se o rótulo de sensibilidade está habilitado. |
| **bool** [get_IsRemoved](./get_isremoved/)() override | Indica se o rótulo de sensibilidade foi removido. |
| [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() override | Retorna o identificador do site Azure Active Directory (Azure AD) correspondente à política de rótulo de sensibilidade que descreve o rótulo de sensibilidade. Leia [System::Guid](../../system/guid/). |
...
| void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) override | Define o método de atribuição para o rótulo de sensibilidade. Escreva [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | Define o id do rótulo de sensibilidade. Escreva [System::String](../../system/string/). |
| void [set_IsEnabled](./set_isenabled/)(**bool**) override | Indica se o rótulo de sensibilidade está habilitado. |
| void [set_IsRemoved](./set_isremoved/)(**bool**) override | Indica se o rótulo de sensibilidade foi removido. |
| void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) override | Define o identificador do site Azure Active Directory (Azure AD) correspondente à política de rótulo de sensibilidade que descreve o rótulo de sensibilidade. Escreva [System::Guid](../../system/guid/). |
