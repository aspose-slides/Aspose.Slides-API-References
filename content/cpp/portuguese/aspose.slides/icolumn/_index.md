...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormat](../icolumnformat/)\> [get_ColumnFormat](./get_columnformat/)() | Retorna o objeto [ColumnFormat](../columnformat/) que contém propriedades de formatação para esta coluna. Somente leitura [IColumnFormat](../icolumnformat/). |
...
| virtual **double** [get_Width](./get_width/)() | Retorna a largura de uma coluna. Somente leitura **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Retorna uma célula pela sua posição. Somente leitura [ICell](../icell/). |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina se qualquer elemento de uma sequência existe ou satisfaz uma condição. |
...
| virtual void [set_Width](./set_width/)(**double**) | Define a largura de uma coluna. Grava **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de template como um ponteiro fraco (em vez de compartilhado). Permite alternar ponteiros em containers para modo fraco. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Define as propriedades de formato de porção definidas para todas as porções do elemento. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Define as propriedades de formato de parágrafo definidas para todos os parágrafos do elemento. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Define as propriedades de formato de quadro de texto definidas para todos os quadros de texto do elemento. |
