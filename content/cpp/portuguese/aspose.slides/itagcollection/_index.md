...
| Método | Descrição |
| --- | --- |
| virtual **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | Adiciona uma nova tag à coleção. |
...
| virtual void [Clear](./clear/)() | Remove todas as tags da coleção. |
| virtual **bool** [Contains](./contains/)([System::String](../../system/string/)) | Determina se a coleção contém um nome específico. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula comparação de ponto flutuante estilo C# onde dois NaNs são considerados iguais, embora segundo IEC 60559:1989 NaN não seja igual a nenhum valor, incluindo NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula comparação de ponto flutuante estilo C# onde dois NaNs são considerados iguais, embora segundo IEC 60559:1989 NaN não seja igual a nenhum valor, incluindo NaN. |
...
| virtual [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) | Retorna a chave de uma tag no índice especificado. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() | Retorna os nomes das tags. |
...
| virtual [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) | Retorna o valor de uma tag no índice especificado. |
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) | Retorna um par chave e valor de uma tag. |
| virtual void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) | Define um par chave e valor de uma tag. |
| virtual **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) | Retorna o índice baseado em zero da chave especificada na coleção. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Remove a tag com um nome especificado da coleção. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove a tag no índice especificado. |
