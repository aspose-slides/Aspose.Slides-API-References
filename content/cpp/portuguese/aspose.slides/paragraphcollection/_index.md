...
| Method | Descrição |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Adiciona um [Paragraph](../paragraph/) ao final da coleção. |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Adiciona o conteúdo de [ParagraphCollection](./) ao final da coleção. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) override | Adiciona texto a partir da string HTML especificada à coleção. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) override | Adiciona texto a partir da string HTML especificada à coleção. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtém iterador apontando logo após o último elemento qualificado como const (se houver) da coleção. |
| void [Clear](./clear/)() override | Remove todos os elementos da coleção. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Determina se o [ICollection](../../system.collections.generic/icollection/) contém um valor específico. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>, **int32_t**) | Copia os elementos de [ICollection](../../system.collections.generic/icollection/) para um [System::Array](../../system/array/), começando em um índice [System::Array](../../system/array/) específico. |
| [iterator](./iterator/) [end](./end/)() | Obtém iterador apontando logo após o último elemento (se houver) da coleção. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtém iterador apontando logo após o último elemento (se houver) da instância da coleção qualificada como const. |
...
| [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) override | Converte os parágrafos especificados para HTML e o retorna como objeto String. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Obtém um valor que indica se [ICollection](../../system.collections.generic/icollection/) é somente leitura. Somente leitura **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera através da coleção. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) override | Obtém o elemento no índice especificado. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Determina o índice de um item específico no [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Insere um [Paragraph](../paragraph/) na coleção no índice especificado. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Insere o conteúdo de [ParagraphCollection](./) na coleção no índice especificado. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Remove a primeira ocorrência de um objeto específico do [ICollection](../../system.collections.generic/icollection/). |
| void [RemoveAt](./removeat/)(**int32_t**) override | Remove o elemento no índice especificado da coleção. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Define o enésimo argumento de template como um ponteiro fraco (em vez de compartilhado). Permite alternar ponteiros em contêineres para modo fraco. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtém iterador apontando logo após o último elemento (se houver)da instância da coleção qualificada como const. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtém iterador apontando logo após o último elemento (se houver) da coleção. |
