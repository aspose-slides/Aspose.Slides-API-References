...
description: Interface base para objetos imutáveis que contêm propriedades efetivas de formatação de tabela.
type: docs
weight: 1522
...
Interface base para objetos imutáveis que contêm propriedades efetivas de formatação de tabela.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderBottom](./get_borderbottom/)() | Retorna o valor efetivo do formato da linha da borda inferior. Somente leitura [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalDown](./get_borderdiagonaldown/)() | Retorna o valor efetivo do formato da linha da diagonal descendente. Somente leitura [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalUp](./get_borderdiagonalup/)() | Retorna o valor efetivo do formato da linha da diagonal ascendente. Somente leitura [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderLeft](./get_borderleft/)() | Retorna o valor efetivo do formato da linha da borda esquerda. Somente leitura [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderRight](./get_borderright/)() | Retorna o valor efetivo do formato da linha da borda direita. Somente leitura [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderTop](./get_bordertop/)() | Retorna o valor efetivo do formato da linha da borda superior. Somente leitura [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | Retorna o valor efetivo do formato de preenchimento. Somente leitura [IFillFormatEffectiveData](../ifillformateffectivedata/). |
