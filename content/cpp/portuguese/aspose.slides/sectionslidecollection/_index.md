...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>\>, **int32_t**) override | Copia toda a coleção para a matriz especificada. |
...
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Retorna um valor que indica se o acesso à coleção está sincronizado (thread-safe). **bool** somente leitura. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [idx_get](./idx_get/)(**int32_t**) override | Obtém o elemento no índice especificado. [ISlide](../islide/) somente leitura. |
