...
| Método | Descrição |
| --- | --- |
| **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Adiciona uma nova tag à coleção. |
...
| void [Clear](./clear/)() override | Remove todas as tags da coleção. |
| **bool** [Contains](./contains/)([System::String](../../system/string/)) override | Determina se a coleção contém um nome específico. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\>, **int32_t**) override | Copia todos os elementos da coleção para a matriz especificada. |
...
| **int32_t** [get_Count](./get_count/)() override | Retorna um número de tags na coleção. Somente leitura **int32_t**. |
...
| [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) override | Retorna a chave de uma tag no índice especificado. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() override | Retorna os nomes das tags. |
...
| [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) override | Retorna o valor de uma tag no índice especificado. |
| [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) override | Retorna um par chave-valor de uma tag. |
| void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Define um par chave-valor de uma tag. |
| **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) override | Retorna o índice baseado em zero da chave especificada na coleção. |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | Remove a tag com um nome especificado da coleção. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Remove a tag no índice especificado. |
...
O exemplo a seguir mostra como adicionar uma tag a um PowerPoint [Presentation](../presentation/).
```cpp
