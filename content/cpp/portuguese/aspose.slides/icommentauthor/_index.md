...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) | Retorna o comentário feito por este autor no índice especificado. Somente leitura [Aspose::Slides::IComment](../icomment/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() | Retorna a coleção de comentários feitos por este autor. Somente leitura [ICommentCollection](../icommentcollection/). |
| virtual [System::String](../../system/string/) [get_Initials](./get_initials/)() | Retorna as iniciais do autor. Leitura [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Retorna o nome do autor. Leitura [System::String](../../system/string/). |
...
| virtual void [Remove](./remove/)() | Remove o autor da coleção pai. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| virtual void [set_Initials](./set_initials/)([System::String](../../system/string/)) | Define as iniciais do autor. Gravação [System::String](../../system/string/). |
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Define o nome do autor. Gravação [System::String](../../system/string/). |
