...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtém o iterador que aponta para o primeiro elemento (se houver) da instância da coleção qualificada como const. |
...
| void [CopyTo](../cellcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>\>, **int32_t**) override | Copia todos os elementos da coleção para a matriz especificada. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtém o iterador que aponta logo após o último elemento (se houver) da instância da coleção qualificada como const. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColumnFormat](../icolumnformat/)\> [get_ColumnFormat](./get_columnformat/)() override | Retorna o objeto [ColumnFormat](../columnformat/) que contém as propriedades de formatação para esta coluna. Somente leitura [IColumnFormat](../icolumnformat/). |
| **int32_t** [get_Count](../cellcollection/get_count/)() override | Retorna o número de células em uma coleção. Somente leitura **int32_t**. |
| **bool** [get_IsSynchronized](../cellcollection/get_issynchronized/)() override | Retorna um valor que indica se o acesso à coleção é sincronizado (thread-safe). Somente leitura **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](../cellcollection/get_presentation/)() override | Retorna a apresentação pai de um [CellCollection](../cellcollection/). Somente leitura [IPresentation](../ipresentation/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../cellcollection/get_slide/)() override | Retorna o slide pai de um [CellCollection](../cellcollection/). Somente leitura [IBaseSlide](../ibaseslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../cellcollection/get_syncroot/)() override | Retorna uma raiz de sincronização. Somente leitura [System::Object](../../system/object/). |
| **double** [get_Width](./get_width/)() override | Retorna a largura de uma coluna. Leitura **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referências associada ao objeto. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>\>\> [GetEnumerator](../cellcollection/getenumerator/)() override | Retorna um enumerador que itera através da coleção. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../cellcollection/idx_get/)(**int32_t**) override | Retorna uma célula pela sua posição. Somente leitura [Cell](../cell/). |
...
| [System::ArrayPtr](../../system/arrayptr/)\<T\> [LINQ_ToArray](../../system.collections.generic/ienumerable/linq_toarray/)() | Cria uma matriz a partir de uma sequência. |
...
| void [set_Width](./set_width/)(**double**) override | Define a largura de uma coluna. Escrita **double**. |
...
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | Define as propriedades de formato de porção definidas em todas as porções das células da coluna. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | Define as propriedades de formato de parágrafo definidas em todos os parágrafos das células da coluna. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | Define as propriedades de formato de quadro de texto definidas em todos os quadros de texto das células da coluna. |
