...
description: Especifica o dimensionamento da região de slide ((largura quando filho de restoredTop, altura quando filho de restoredLeft) da visualização normal, quando a região tem um tamanho restaurado variável (nem minimizado nem maximizado).
type: docs
weight: 2991
...
Especifica o dimensionamento da região de slide ((largura quando filho de restoredTop, altura quando filho de restoredLeft) da visualização normal, quando a região tem um tamanho restaurado variável (nem minimizado nem maximizado).
...
| Método | Descrição |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Compara objetos usando C# [Object.Equals](../../system/object/equals/) semântica. |
...
| virtual **bool** [get_AutoAdjust](./get_autoadjust/)() | Especifica se o tamanho da região de conteúdo lateral deve compensar o novo tamanho ao redimensionar a janela que contém a visualização dentro da aplicação Leitura **bool**. |
| virtual **float** [get_DimensionSize](./get_dimensionsize/)() | Especifica o tamanho da região de slide (largura quando filho de RestoredTop, altura quando filho de RestoredLeft). Leitura **float**. |
...
| virtual void [set_AutoAdjust](./set_autoadjust/)(**bool**) | Especifica se o tamanho da região de conteúdo lateral deve compensar o novo tamanho ao redimensionar a janela que contém a visualização dentro da aplicação Escrita **bool**. |
| virtual void [set_DimensionSize](./set_dimensionsize/)(**float**) | Especifica o tamanho da região de slide (largura quando filho de RestoredTop, altura quando filho de RestoredLeft). Escrita **float**. |
