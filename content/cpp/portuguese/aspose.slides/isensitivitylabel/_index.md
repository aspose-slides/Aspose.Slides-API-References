...
| virtual [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() | Retorna o método de atribuição para o rótulo de sensibilidade. Leia [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() | Retorna a lista de tipos de marcação de conteúdo que devem ser aplicados a um arquivo. |
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | Retorna o id do rótulo de sensibilidade. Leia [System::String](../../system/string/). |
| virtual **bool** [get_IsEnabled](./get_isenabled/)() | Indica se o rótulo de sensibilidade está habilitado. |
| virtual **bool** [get_IsRemoved](./get_isremoved/)() | Indica se o rótulo de sensibilidade foi removido. |
| virtual [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() | Retorna o identificador do site do Azure Active Directory (Azure AD) correspondente à política de rótulo de sensibilidade que descreve o rótulo de sensibilidade. Leia [System::Guid](../../system/guid/). |
...
| virtual void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | Define o método de atribuição para o rótulo de sensibilidade. Grave [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | Define o id do rótulo de sensibilidade. Grave [System::String](../../system/string/). |
| virtual void [set_IsEnabled](./set_isenabled/)(**bool**) | Indica se o rótulo de sensibilidade está habilitado. |
| virtual void [set_IsRemoved](./set_isremoved/)(**bool**) | Indica se o rótulo de sensibilidade foi removido. |
| virtual void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) | Define o identificador do site do Azure Active Directory (Azure AD) correspondente à política de rótulo de sensibilidade que descreve o rótulo de sensibilidade. Grave [System::Guid](../../system/guid/). |
