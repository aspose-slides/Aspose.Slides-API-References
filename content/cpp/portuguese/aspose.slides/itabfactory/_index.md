...
Permite criar instâncias de [ITab](../itab/) ```cpp
...
| Método | Descrição |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\> [CreateTab](./createtab/)(**double**, [TabAlignment](../tabalignment/)) | Cria uma nova instância de [ITab](../itab/). |
