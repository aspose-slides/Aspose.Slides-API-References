...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Retorna a cor de um ponto de parada de gradiente. Somente leitura [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Retorna a posição (0..1) de um ponto de parada de gradiente. Leitura **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Define a posição (0..1) de um ponto de parada de gradiente. Escrita **float**. |
...
* Classe [IGradientStop](../igradientstop/)
