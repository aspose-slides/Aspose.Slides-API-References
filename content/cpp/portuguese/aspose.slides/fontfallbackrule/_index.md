...
| Método | Descrição |
| --- | --- |
| void [AddFallBackFonts](./addfallbackfonts/)([System::String](../../system/string/)) override | Adiciona uma(s) nova(s) fonte(s) à lista de fontes FallBack. |
| void [AddFallBackFonts](./addfallbackfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) override | Adiciona novas fontes à lista de fontes FallBack. |
| void [Clear](./clear/)() override | Remove todas as fontes da lista. |
...
|  [FontFallBackRule](./fontfallbackrule/)(**uint32_t**, **uint32_t**, [System::String](../../system/string/)) | Cria uma nova instância. |
|  [FontFallBackRule](./fontfallbackrule/)(**uint32_t**, **uint32_t**, [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Cria uma nova instância. |
| **int32_t** [get_Count](./get_count/)() override | Obtém o número de fontes realmente definidas para o intervalo. **int32_t** somente leitura. |
| **uint32_t** [get_RangeEndIndex](./get_rangeendindex/)() override | Obtém o último índice do intervalo Unicode contínuo. |
| **uint32_t** [get_RangeStartIndex](./get_rangestartindex/)() override | Obtém o primeiro índice do intervalo Unicode contínuo. |
...
| [System::String](../../system/string/) [idx_get](./idx_get/)(**int32_t**) override | Obtém o nome da fonte no índice especificado. Somente leitura [IFontFallBackRule](../ifontfallbackrule/). |
| **int32_t** [IndexOf](./indexof/)([System::String](../../system/string/)) override | Retorna um índice da regra especificada na coleção. |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | Remove a primeira ocorrência de uma fonte FallBack específica da lista. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Remove a fonte FallBack no índice especificado da lista. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| void [set_RangeEndIndex](./set_rangeendindex/)(**uint32_t**) | Obtém o último índice do intervalo Unicode contínuo. |
| void [set_RangeStartIndex](./set_rangestartindex/)(**uint32_t**) | Obtém o primeiro índice do intervalo Unicode contínuo. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)() override | Cria e retorna um array com todas as fontes FallBack para esta regra. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)(**int32_t**, **int32_t**) override | Cria e retorna um array com todas as fontes FallBack do intervalo especificado na lista. |
