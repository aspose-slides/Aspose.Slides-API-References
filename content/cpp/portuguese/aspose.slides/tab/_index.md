...
| Method | Descrição |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | Compara a instância atual com outro objeto do mesmo tipo. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | Retorna o estilo de alinhamento de uma tabulação. Leia [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | Retorna a posição de uma tabulação. Atribuir esta propriedade pode alterar o índice da tabulação na coleção e invalidar o Enumerador. Leia **double**. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | Define o estilo de alinhamento de uma tabulação. Escrita [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | Define a posição de uma tabulação. Atribuir esta propriedade pode mudar o índice da tabulação na coleção e invalidar o Enumerador. Escrita **double**. |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | Cria novo [Tab](./) |
