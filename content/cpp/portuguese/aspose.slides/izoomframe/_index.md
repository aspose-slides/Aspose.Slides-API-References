...
Representa um [Slide](../slide/) objeto Zoom em um slide.
...
| virtual [ZoomImageType](../zoomimagetype/) [get_ImageType](../izoomobject/get_imagetype/)() | Obtém o tipo de imagem de um objeto zoom. Leia [ZoomImageType](../zoomimagetype/). Valor padrão: Preview |
...
| virtual **bool** [get_ReturnToParent](../izoomobject/get_returntoparent/)() | Obtém o comportamento de navegação na apresentação de slides. Somente leitura **bool**. Valor padrão: false |
...
| virtual **bool** [get_ShowBackground](../izoomobject/get_showbackground/)() | Obtém o valor que especifica se o Zoom usará o plano de fundo do slide de destino. Somente leitura **bool**. Valor padrão: true |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_TargetSlide](./get_targetslide/)() | Obtém o objeto slide ao qual o objeto [Slide](../slide/) Zoom está vinculado. Leia [ISlide](../islide/). |
...
| virtual **float** [get_TransitionDuration](../izoomobject/get_transitionduration/)() | Obtém a duração da transição entre Zoom e slide. Somente leitura **float**. Valor padrão: 1.0f |
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Retorna um identificador interno, de escopo de apresentação, destinado ao uso por complementos ou outro código. Como esse valor pode ser reatribuído pelo usuário ou programaticamente, ele não deve ser tratado como uma chave única persistente. Somente leitura **uint32_t**. Veja também [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](../izoomobject/get_zoomimage/)() | Obtém a imagem para o objeto zoom. Leia [IPPImage](../ippimage/). |
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | Retorna a posição de uma forma na ordem z. Shapes[0] retorna a forma na parte traseira da ordem z, e Shapes[Shapes.Count - 1] retorna a forma na parte dianteira da ordem z. Somente leitura **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../ishape/getbaseplaceholder/)() | Retorna uma forma placeholder básica (forma do layout e/ou do slide mestre da qual a forma atual é herdada). |
...
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | A propriedade especifica como uma forma será renderizada no modo preto e branco. Grava [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual void [set_HyperlinkMouseOver](../ihyperlinkcontainer/set_hyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) | Define o hiperlink definido para passagem do mouse. Grava [IHyperlink](../ihyperlink/). |
| virtual void [set_ImageType](../izoomobject/set_imagetype/)([ZoomImageType](../zoomimagetype/)) | Define o tipo de imagem de um objeto zoom. Grava [ZoomImageType](../zoomimagetype/). Valor padrão: Preview |
...
| virtual void [set_ReturnToParent](../izoomobject/set_returntoparent/)(**bool**) | Define o comportamento de navegação na apresentação de slides. Grava **bool**. Valor padrão: false |
...
| virtual void [set_ShowBackground](../izoomobject/set_showbackground/)(**bool**) | Define o valor que especifica se o Zoom usará o plano de fundo do slide de destino. Grava **bool**. Valor padrão: true |
| virtual void [set_TargetSlide](./set_targetslide/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) | Define o objeto slide ao qual o objeto [Slide](../slide/) Zoom está vinculado. Grava [ISlide](../islide/). |
| virtual void [set_TransitionDuration](../izoomobject/set_transitionduration/)(**float**) | Define a duração da transição entre Zoom e slide. Grava **float**. Valor padrão: 1.0f |
...
| virtual void [set_ZoomImage](../izoomobject/set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | Define a imagem para o objeto zoom. Grava [IPPImage](../ippimage/). |
