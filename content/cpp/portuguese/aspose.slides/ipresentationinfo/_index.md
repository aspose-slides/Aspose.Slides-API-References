...
| Método | Descrição |
| --- | --- |
| virtual **bool** [CheckPassword](./checkpassword/)([System::String](../../system/string/)) | Verifica se uma senha está correta para uma apresentação protegida com senha de abertura. |
| virtual **bool** [CheckWriteProtection](./checkwriteprotection/)([System::String](../../system/string/)) | Verifica se uma senha de modificação está correta para uma apresentação protegida contra gravação. |
...
| virtual **bool** [get_IsEncrypted](./get_isencrypted/)() | Obtém True se a apresentação vinculada estiver criptografada, caso contrário False. Somente leitura **bool**. |
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | Obtém um valor que indica se a apresentação vinculada está protegida por uma senha de abertura. |
| virtual [NullableBool](../nullablebool/) [get_IsWriteProtected](./get_iswriteprotected/)() | Obtém um valor que indica se a apresentação vinculada está protegida contra gravação. |
| virtual [Aspose::Slides::LoadFormat](../loadformat/) [get_LoadFormat](./get_loadformat/)() | Obtém o formato da apresentação vinculada. Somente leitura [Slides::LoadFormat](../loadformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\> [ReadDocumentProperties](./readdocumentproperties/)() | Obtém as propriedades do documento da apresentação vinculada. |
...
| virtual void [UpdateDocumentProperties](./updatedocumentproperties/)([System::SharedPtr](../../system/sharedptr/)\<[IDocumentProperties](../idocumentproperties/)\>) | Atualiza as propriedades da apresentação vinculada. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrementa o contador de referência fraca. Não deve ser chamado diretamente; em vez disso, use ponteiros inteligentes ou ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Decrementa o contador de referência fraca. Não deve ser chamado diretamente; em vez disso, use ponteiros inteligentes ou ThisProtector. |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Escreve a apresentação vinculada em um fluxo. |
| virtual void [WriteBindedPresentation](./writebindedpresentation/)([System::String](../../system/string/)) | Escreve a apresentação vinculada em um arquivo. |
