...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [FindShapeByAltText](./findshapebyalttext/)([System::String](../../system/string/)) | Encontra a primeira ocorrência de uma forma com o texto alternativo especificado. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackground](../ibackground/)\> [get_Background](./get_background/)() | Retorna o plano de fundo do slide. Somente leitura [IBackground](../ibackground/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [get_Control](./get_control/)(**int32_t**) | Retorna o controle ActiveX no índice especificado. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IControlCollection](../icontrolcollection/)\> [get_Controls](./get_controls/)() | Retorna a coleção de controles ActiveX em um slide. Somente leitura [IControlCollection](../icontrolcollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomData](../icustomdata/)\> [get_CustomData](./get_customdata/)() | Retorna os dados personalizados do slide. Somente leitura [ICustomData](../icustomdata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkQueries](../ihyperlinkqueries/)\> [get_HyperlinkQueries](./get_hyperlinkqueries/)() | Fornece acesso fácil aos hyperlinks contidos. Somente leitura [IHyperlinkQueries](../ihyperlinkqueries/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Retorna o nome de um slide. Somente leitura [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [get_Shape](./get_shape/)(**int32_t**) | Retorna a forma no índice especificado. Somente leitura [Aspose::Slides::IShape](../ishape/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeCollection](../ishapecollection/)\> [get_Shapes](./get_shapes/)() | Retorna as formas de um slide. Somente leitura [IShapeCollection](../ishapecollection/). |
| virtual **bool** [get_ShowMasterShapes](./get_showmastershapes/)() | Especifica se as formas no slide mestre devem ser exibidas nos slides ou não. Para o próprio slide mestre esta propriedade sempre retorna **false**. Somente leitura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](./)\> [get_Slide](../islidecomponent/get_slide/)() | Retorna o slide base. Somente leitura [IBaseSlide](./). |
| virtual **uint32_t** [get_SlideId](./get_slideid/)() | Retorna o ID de um slide. Somente leitura **uint32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISlideShowTransition](../islideshowtransition/)\> [get_SlideShowTransition](./get_slideshowtransition/)() | Retorna o objeto TransitionEx que contém informações sobre como o slide especificado avança durante uma apresentação. Somente leitura [ISlideShowTransition](../islideshowtransition/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAnimationTimeLine](../ianimationtimeline/)\> [get_Timeline](./get_timeline/)() | Retorna o objeto da linha do tempo de animação. Somente leitura [IAnimationTimeLine](../ianimationtimeline/). |
...
| virtual void [JoinPortionsWithSameFormatting](./joinportionswithsameformatting/)() | Une execuções com a mesma formatação em todos os parágrafos em todas as formas aceitas. |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Define o nome de um slide. Grava [System::String](../../system/string/). |
| virtual void [set_ShowMasterShapes](./set_showmastershapes/)(**bool**) | Especifica se as formas no slide mestre devem ser exibidas nos slides ou não. Para o próprio slide mestre esta propriedade sempre retorna **false**. Grava **bool**. |
