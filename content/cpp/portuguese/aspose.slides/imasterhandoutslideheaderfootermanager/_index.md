...
description: Representa o gerenciador que contém o comportamento dos marcadores de espaço reservado da lâmina mestra de folheto, incluindo o marcador de cabeçalho.
type: docs
weight: 2848
...
Representa o gerenciador que contém o comportamento dos marcadores de espaço reservado da lâmina mestra de folheto, incluindo o marcador de cabeçalho.
...
| virtual **bool** [get_IsDateTimeVisible](../ibaseslideheaderfootermanager/get_isdatetimevisible/)() | Obtém o valor que indica que um marcador de data/hora está presente. Leitura**bool**. |
| virtual **bool** [get_IsFooterVisible](../ibaseslideheaderfootermanager/get_isfootervisible/)() | Obtém o valor que indica que um marcador de rodapé está presente. Leitura **bool**. |
| virtual **bool** [get_IsHeaderVisible](../ibasehandoutnotesslideheaderfootermanag/get_isheadervisible/)() | Obtém o valor que indica que um marcador de cabeçalho está presente. Leitura **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](../ibaseslideheaderfootermanager/get_isslidenumbervisible/)() | Obtém o valor que indica que um marcador de número de página está presente. Leitura**bool**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n'th argumento de modelo como um ponteiro fraco (em vez de compartilhado). Permite trocar ponteiros em contêineres para o modo fraco. |
