...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() | Obtém informações de cultura preferida para calcular algumas funções destinadas ao uso com idiomas que utilizam o conjunto de caracteres de dois bytes (DBCS). |
| virtual **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() | Se a fonte de dados para o gráfico for uma pasta de trabalho externa e não estiver disponível, será recuperada do cache do gráfico. |
...
| virtual void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) | Define informações de cultura preferida para calcular algumas funções destinadas ao uso com idiomas que utilizam o conjunto de caracteres de dois bytes (DBCS). |
| virtual void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) | Se a fonte de dados para o gráfico for uma pasta de trabalho externa e não estiver disponível, será recuperada do cache do gráfico. |
