...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtém um iterador que aponta para o primeiro elemento (se houver) da instância da coleção qualificada como const. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtém um iterador que aponta imediatamente após o último elemento (se houver) da instância da coleção qualificada como const. |
...
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | Retorna o número de comportamentos em uma coleção. **int32_t** somente leitura. |
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Retorna um valor indicando se o acesso à coleção está sincronizado (thread-safe). **bool** somente leitura. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | Retorna uma raiz de sincronização. [System::Object](../../system/object/) somente leitura. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](./getbytype/)([SlideLayoutType](../slidelayouttype/)) | Retorna o primeiro slide de layout do tipo especificado. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referências associada ao objeto. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../../system.collections.generic/ienumerable/getenumerator/)() | Obtém um enumerador. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](./idx_get/)(**int32_t**) | Retorna o slide de layout por índice. [ILayoutSlide](../ilayoutslide/) somente leitura. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina se algum elemento da sequência existe ou satisfaz uma condição. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Remove um layout da coleção. |
...
| virtual void [RemoveUnused](./removeunused/)() | Remove slides de layout não utilizados (slides de layout cujo HasDependingSlides é false). |
