...
| Método | Descrição |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [AddControl](./addcontrol/)([ControlType](../controltype/), **float**, **float**, **float**, **float**) override | Cria e adiciona um novo controle à coleção. |
| [iterator](./iterator/) [begin](./begin/)() | Obtém o iterador que aponta para o primeiro elemento (se existir) da coleção. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtém o iterador que aponta para o primeiro elemento (se existir) da instância da coleção qualificada como const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtém o iterador que aponta para o primeiro elemento qualificado como const (se existir) da coleção. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtém o iterador que aponta imediatamente após o último elemento qualificado como const (se existir) da coleção. |
| void [Clear](./clear/)() override | Remove todos os controles da coleção. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>\>, **int32_t**) override | Copia a coleção inteira para o array especificado. |
...
| [iterator](./iterator/) [end](./end/)() | Obtém o iterador que aponta imediatamente após o último elemento (se existir) da coleção. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtém o iterador que aponta imediatamente após o último elemento (se existir) da instância da coleção qualificada como const. |
...
| **int32_t** [get_Count](./get_count/)() override | Retorna o número de objetos na coleção. **int32_t** somente leitura. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Retorna um valor indicando se o acesso à coleção está sincronizado (thread-safe). **bool** somente leitura. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera sobre a coleção. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [idx_get](./idx_get/)(**int32_t**) override | Retorna um controle na posição especificada. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>) override | Remove um controle ActiveX da coleção. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtém o iterador que aponta imediatamente após o último elemento (se houver) da instância da coleção qualificada como const. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtém o iterador que aponta imediatamente após o último elemento (se houver) da coleção. |
