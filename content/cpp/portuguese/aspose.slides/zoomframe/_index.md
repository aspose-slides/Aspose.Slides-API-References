...
Representa um objeto Zoom [Slide](../slide/) em um slide.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Emula comparação de ponto flutuante estilo C# onde dois NaNs são considerados iguais, embora de acordo com IEC 60559:1989 NaN não seja igual a nenhum valor, incluindo NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Emula comparação de ponto flutuante estilo C# onde dois NaNs são considerados iguais, embora de acordo com IEC 60559:1989 NaN não seja igual a nenhum valor, incluindo NaN. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](../shape/get_effectformat/)() override | Retorna o objeto [EffectFormat](../effectformat/) que contém efeitos de pixel aplicados a uma forma. Observação: pode retornar nulo para certos tipos de forma que não possuem propriedades de efeito. Somente leitura [IEffectFormat](../ieffectformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](../shape/get_fillformat/)() override | Retorna o objeto [FillFormat](../fillformat/) que contém propriedades de formatação de preenchimento para uma forma. Observação: pode retornar nulo para certos tipos de forma que não possuem propriedades de preenchimento. Somente leitura [IFillFormat](../ifillformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkManager](../ihyperlinkmanager/)\> [get_HyperlinkManager](../shape/get_hyperlinkmanager/)() override | Retorna o gerenciador de hiperlink. Somente leitura [IHyperlinkManager](../ihyperlinkmanager/). |
...
| [ZoomImageType](../zoomimagetype/) [get_ImageType](../zoomobject/get_imagetype/)() override | Obtém o tipo de imagem de um objeto zoom. Leia [ZoomImageType](../zoomimagetype/). Valor padrão: Preview |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_LineFormat](../shape/get_lineformat/)() override | Retorna o objeto [LineFormat](../lineformat/) que contém propriedades de formatação de linha para uma forma. Observação: pode retornar nulo para certos tipos de forma que não possuem propriedades de linha. Somente leitura [ILineFormat](../ilineformat/). |
| [System::String](../../system/string/) [get_Name](../shape/get_name/)() override | Retorna o nome de uma forma. Não pode ser nulo. Use uma string vazia se necessário. Leia [System::String](../../system/string/). |
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | Retorna um identificador único de escopo de slide que permanece constante durante a vida útil da forma e permite que o PowerPoint ou código interop faça referência confiável à forma de qualquer lugar no documento. Somente leitura **uint32_t**. Veja também [Shape::get_UniqueId](../shape/get_uniqueid/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [get_Placeholder](../shape/get_placeholder/)() override | Retorna o placeholder de uma forma. Retorna nulo se a forma não tem placeholder. Somente leitura [IPlaceholder](../iplaceholder/). |
...
| **bool** [get_ReturnToParent](../zoomobject/get_returntoparent/)() override | Obtém o comportamento de navegação na apresentação de slides. Somente leitura **bool**. Valor padrão: false |
...
| **bool** [get_ShowBackground](../zoomobject/get_showbackground/)() override | Obtém o valor que especifica se o Zoom usará o fundo do slide de destino. Somente leitura **bool**. Valor padrão: true |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_TargetSlide](./get_targetslide/)() override | Obtém o objeto slide ao qual o objeto Zoom [Slide](../slide/) está ligado. Leia [ISlide](../islide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../ithreedformat/)\> [get_ThreeDFormat](../shape/get_threedformat/)() override | Retorna o objeto [ThreeDFormat](../threedformat/) que contém propriedades de efeito 3d para uma forma. Observação: pode retornar nulo para certos tipos de forma que não possuem propriedades 3d. Somente leitura [IThreeDFormat](../ithreedformat/). |
| **float** [get_TransitionDuration](../zoomobject/get_transitionduration/)() override | Obtém a duração da transição entre Zoom e slide. Somente leitura **float**. Valor padrão: 1.0f |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](../zoomobject/get_zoomimage/)() override | Obtém a imagem para o objeto zoom. Leia [IPPImage](../ippimage/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../shape/getbaseplaceholder/)() override | Retorna uma forma placeholder básica (forma do layout e/ou do slide mestre da qual a forma atual é herdada). |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Construtor de cópia. Não copia nada, realmente, apenas inicializa um novo objeto e permite cópia ao construir subclasses. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de atribuição. Não copia nada, realmente, apenas inicializa um novo objeto e permite cópia ao construir subclasses. |
...
| void [set_BlackWhiteMode](../shape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) override | A propriedade especifica como a forma será renderizada no modo preto e branco. Escrita [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| void [set_ImageType](../zoomobject/set_imagetype/)([ZoomImageType](../zoomimagetype/)) override | Define o tipo de imagem de um objeto zoom. Escrita [ZoomImageType](../zoomimagetype/). Valor padrão: Preview |
| void [set_IsDecorative](../shape/set_isdecorative/)(**bool**) override | Define a opção 'Marcar como decorativo'. Leitura/gravação **bool**. |
| void [set_Name](../shape/set_name/)([System::String](../../system/string/)) override | Define o nome de uma forma. Não pode ser nulo. Use string vazia se necessário. Escrita [System::String](../../system/string/). |
...
| void [set_ReturnToParent](../zoomobject/set_returntoparent/)(**bool**) override | Define o comportamento de navegação na apresentação de slides. Escrita **bool**. Valor padrão: false |
| void [set_Rotation](../shape/set_rotation/)(**float**) override | Define o número de graus que a forma especificada está rotacionada ao redor do eixo z. Um valor positivo indica rotação no sentido horário; um valor negativo indica rotação no sentido anti-horário. Escrita **float**. |
| void [set_ShowBackground](../zoomobject/set_showbackground/)(**bool**) override | Define o valor que especifica se o Zoom usará o fundo do slide de destino. Escrita **bool**. Valor padrão: true |
| void [set_TargetSlide](./set_targetslide/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | Define o objeto slide ao qual o objeto Zoom [Slide](../slide/) está ligado. Escrita [ISlide](../islide/). |
| void [set_TransitionDuration](../zoomobject/set_transitionduration/)(**float**) override | Define a duração da transição entre Zoom e slide. Escrita **float**. Valor padrão: 1.0f |
...
| void [set_ZoomImage](../zoomobject/set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) override | Define a imagem para o objeto zoom. Escrita [IPPImage](../ippimage/). |
