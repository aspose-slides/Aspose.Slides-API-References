...
| virtual **uint32_t** [get_Index](./get_index/)() | Obtém o índice de um placeholder. Somente leitura **uint32_t**. |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Obtém a orientação de um placeholder. Somente leitura [Slides::Orientation](../orientation/). |
| virtual [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() | Obtém o tamanho de um placeholder. Somente leitura [PlaceholderSize](../placeholdersize/). |
| virtual [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() | Obtém o tipo de um placeholder. Somente leitura [PlaceholderType](../placeholdertype/). |
