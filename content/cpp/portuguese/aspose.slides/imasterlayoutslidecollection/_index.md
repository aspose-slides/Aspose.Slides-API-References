...
description: Representa uma coleção de todos os slides de layout de um slide mestre definido. Estende a interface ILayoutSlideCollection com métodos para adicionar/inserir/remover/clonar slides de layout no contexto das coleções individuais de slides de layout do mestre.
type: docs
weight: 2874
...
Representa uma coleção de todos os slides de layout de um slide mestre definido. Estende a interface [ILayoutSlideCollection](../ilayoutslidecollection/) com métodos para adicionar/inserir/remover/clonar slides de layout no contexto das coleções individuais de slides de layout do mestre.
...
| Método | Descrição |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Adiciona um novo slide de layout ao final da coleção. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Adiciona uma cópia de um slide de layout especificado ao final da coleção. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Obtém iterador apontando para o primeiro elemento (se houver) da coleção. Esse iterador não pode ser usado para alterar um objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) retorna um objeto cópia de T. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Obtém iterador apontando logo após o último elemento (se houver) da coleção. Esse iterador não pode ser usado para alterar um objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) retorna um objeto cópia de T. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Retorna um valor indicando se o acesso à coleção está sincronizado (thread-safe). Somente leitura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../igenericcollection/get_syncroot/)() | Retorna a raiz de sincronização. Somente leitura [System::Object](../../system/object/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../ilayoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) | Retorna o primeiro slide de layout do tipo especificado. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../ilayoutslidecollection/idx_get/)(**int32_t**) | Retorna o slide de layout por índice. Somente leitura [ILayoutSlide](../ilayoutslide/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Insert](./insert/)(**int32_t**, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Insere um novo slide de layout na posição especificada da coleção. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Insere uma cópia de um slide de layout especificado na posição especificada da coleção. |
...
| virtual void [Remove](../ilayoutslidecollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Remove um layout da coleção. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove o elemento no índice especificado da coleção. |
...
| virtual void [RemoveUnused](../ilayoutslidecollection/removeunused/)() | Remove slides de layout não utilizados (slides de layout cujo HasDependingSlides é false). |
| virtual void [Reorder](./reorder/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Move o slide de layout da coleção para a posição especificada. |
