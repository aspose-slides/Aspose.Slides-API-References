...
description: Retorna o alinhamento de texto em um parágrafo sem herança. Leia TextAlignment.
type: docs
weight: 1
url: /pt/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() método

Retorna o alinhamento de texto em um parágrafo sem herança. Leia [TextAlignment](../../textalignment/).
