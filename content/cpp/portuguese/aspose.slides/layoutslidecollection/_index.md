...
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtém o iterador apontando para o primeiro elemento (se houver) da instância com qualificador const da coleção. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtém o iterador apontando para o primeiro elemento com qualificador const (se houver) da coleção. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtém o iterador apontando logo após o último elemento com qualificador const (se houver) da coleção. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>, **int32_t**) override | Copia todos os elementos da coleção para o array especificado. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtém o iterador apontando logo após o último elemento (se houver) da instância com qualificador const da coleção. |
...
| **int32_t** [get_Count](./get_count/)() override | Retorna o número de slides de layout em uma coleção. Somente leitura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](./getbytype/)([SlideLayoutType](../slidelayouttype/)) override | Retorna o primeiro slide de layout do tipo especificado. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera pela coleção. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hash de objetos personalizados. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](./idx_get/)(**int32_t**) override | Retorna o slide de layout por índice. Somente leitura [LayoutSlide](../layoutslide/). |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) override | Remove um layout da coleção. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| void [RemoveUnused](./removeunused/)() override | Remove slides de layout não usados (slides de layout cujo HasDependingSlides é false). |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtém o iterador apontando para o primeiro elemento (se houver) da instância com qualificador const da coleção. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtém o iterador apontando logo após o último elemento (se houver) da instância com qualificador const da coleção. |
