...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Retorna a cor do guia de desenho. Leia [System::Drawing::Color](../../system.drawing/color/). |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Retorna a orientação do guia de desenho. Leia [Slides::Orientation](../orientation/). |
| **float** [get_Position](./get_position/)() override | Retorna a posição do guia de desenho em pontos a partir do canto superior esquerdo do slide. Leia **float**. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Define a cor do guia de desenho. Escreva [System::Drawing::Color](../../system.drawing/color/). |
| void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) override | Define a orientação do guia de desenho. Escreva [Slides::Orientation](../orientation/). |
| void [set_Position](./set_position/)(**float**) override | Define a posição do guia de desenho em pontos a partir do canto superior esquerdo do slide. Escreva **float**. |
