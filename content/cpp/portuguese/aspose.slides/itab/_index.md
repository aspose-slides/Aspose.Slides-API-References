...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Retorna o estilo de alinhamento de uma tabulação. Leia [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Retorna a posição de uma tabulação. Definir esta propriedade pode alterar o índice da tabulação na coleção e invalidar o Enumerador. Leia **double**. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogue ao método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonar tipos personalizados. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Define o estilo de alinhamento de uma tabulação. Escreva [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Define a posição de uma tabulação. Definir esta propriedade pode alterar o índice da tabulação na coleção e invalidar o Enumerador. Escreva **double**. |
