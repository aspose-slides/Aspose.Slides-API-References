...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Retorna os dados binários das legendas fechadas. Somente leitura **uint8_t**[]. |
| virtual [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() | Retorna o identificador globalmente único (GUID) das legendas fechadas. Somente leitura [System::Guid](../../system/guid/). |
| virtual [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() | Retorna os dados das legendas fechadas como string codificada em UTF-8. Somente leitura [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Label](./get_label/)() | Retorna o rótulo das legendas fechadas. Leitura [System::String](../../system/string/). |
...
| virtual void [set_Label](./set_label/)([System::String](../../system/string/)) | Define o rótulo das legendas fechadas. Escrita [System::String](../../system/string/). |
