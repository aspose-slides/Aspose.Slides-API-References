...
description: Determina quais operações estão desativadas no GraphicalObjectEx pai.
type: docs
weight: 2471
...
| virtual **bool** [get_AspectRatioLocked](./get_aspectratiolocked/)() | Determina se a forma deve preservar a proporção ao redimensionar. Leia **bool**. |
| virtual **bool** [get_DrilldownLocked](./get_drilldownlocked/)() | Determina se a seleção de subformas deste objeto é proibida. Leia **bool**. |
| virtual **bool** [get_GroupingLocked](./get_groupinglocked/)() | Determina se a adição desta forma a um grupo é proibida. Leia **bool**. |
| virtual **bool** [get_NoLocks](../ibaseshapelock/get_nolocks/)() | Retorna verdadeiro se todas as flags de bloqueio estiverem desativadas. **bool** somente leitura. |
| virtual **bool** [get_PositionLocked](./get_positionlocked/)() | Determina se mover esta forma é proibido. Leia **bool**. |
| virtual **bool** [get_SelectLocked](./get_selectlocked/)() | Determina se selecionar esta forma é proibido. Leia **bool**. |
| virtual **bool** [get_SizeLocked](./get_sizelocked/)() | Determina se redimensionar esta forma é proibido. Leia **bool**. |
...
| virtual void [set_AspectRatioLocked](./set_aspectratiolocked/)(**bool**) | Determina se a forma deve preservar a proporção ao redimensionar. Grave **bool**. |
| virtual void [set_DrilldownLocked](./set_drilldownlocked/)(**bool**) | Determina se a seleção de subformas deste objeto é proibida. Grave **bool**. |
| virtual void [set_GroupingLocked](./set_groupinglocked/)(**bool**) | Determina se a adição desta forma a um grupo é proibida. Grave **bool**. |
| virtual void [set_PositionLocked](./set_positionlocked/)(**bool**) | Determina se mover esta forma é proibido. Grave **bool**. |
| virtual void [set_SelectLocked](./set_selectlocked/)(**bool**) | Determina se selecionar esta forma é proibido. Grave **bool**. |
| virtual void [set_SizeLocked](./set_sizelocked/)(**bool**) | Determina se redimensionar esta forma é proibido. Grave **bool**. |
