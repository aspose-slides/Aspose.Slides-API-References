...
description: Objeto imutável que contém propriedades efetivas da imagem.
type: docs
weight: 3212
url: /pt/aspose.slides/ipictureeffectivedata/
---
## IPictureEffectiveData classe

Objeto imutável que contém as propriedades efetivas da imagem.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() | Retorna a imagem incorporada. Somente leitura [IPPImage](../ippimage/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/)\> [get_ImageTransform](./get_imagetransform/)() | Retorna a coleção de efeitos de transformação de imagem. Somente leitura [Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IEffectEffectiveData](../../aspose.slides.effects/ieffecteffectivedata/)\> [get_ImageTransformEffect](./get_imagetransformeffect/)(**int32_t**) | Retorna o efeito de transformação de imagem especificado no índice. |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Retorna a URL da imagem vinculada. Somente leitura [System::String](../../system/string/). |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogo do método [Object.MemberwiseClone()](../../system/object/memberwiseclone/) do C#. Permite clonagem de tipos personalizados. |
