...
Representa o caminho geométrico de [GeometryShape](../geometryshape/)
...
| Método | Descrição |
| --- | --- |
| virtual void [ArcTo](./arcto/)(**float**, **float**, **float**, **float**) | Anexa o arco especificado ao caminho. |
| virtual void [CloseFigure](./closefigure/)() | Fecha a figura atual deste caminho |
| virtual void [CubicBezierTo](./cubicbezierto/)([System::Drawing::PointF](../../system.drawing/pointf/), [System::Drawing::PointF](../../system.drawing/pointf/), [System::Drawing::PointF](../../system.drawing/pointf/)) | Adiciona curva cúbica de Bézier ao final do caminho |
| virtual void [CubicBezierTo](./cubicbezierto/)(**float**, **float**, **float**, **float**, **float**, **float**) | Adiciona curva cúbica de Bézier ao final do caminho |
| virtual void [CubicBezierTo](./cubicbezierto/)([System::Drawing::PointF](../../system.drawing/pointf/), [System::Drawing::PointF](../../system.drawing/pointf/), [System::Drawing::PointF](../../system.drawing/pointf/), **uint32_t**) | Adiciona curva cúbica de Bézier ao local especificado do caminho |
| virtual void [CubicBezierTo](./cubicbezierto/)(**float**, **float**, **float**, **float**, **float**, **float**, **uint32_t**) | Adiciona curva cúbica de Bézier ao local especificado do caminho |
...
| virtual [PathFillModeType](../pathfillmodetype/) [get_FillMode](./get_fillmode/)() | Define o modo de preenchimento |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IPathSegment](../ipathsegment/)\>\> [get_PathData](./get_pathdata/)() | Retorna o caminho geométrico de [GeometryShape](../geometryshape/) como uma matriz de segmentos de caminho. |
| virtual **bool** [get_Stroke](./get_stroke/)() | Define a aparência do traço |
...
| virtual void [LineTo](./lineto/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Adiciona linha ao final do caminho |
| virtual void [LineTo](./lineto/)(**float**, **float**) | Adiciona linha ao final do caminho |
| virtual void [LineTo](./lineto/)([System::Drawing::PointF](../../system.drawing/pointf/), **uint32_t**) | Adiciona linha ao local especificado do caminho |
| virtual void [LineTo](./lineto/)(**float**, **float**, **uint32_t**) | Adiciona linha ao local especificado do caminho |
...
| virtual void [MoveTo](./moveto/)([System::Drawing::PointF](../../system.drawing/pointf/)) | Define a posição do próximo ponto. |
| virtual void [MoveTo](./moveto/)(**float**, **float**) | Define a posição do próximo ponto. |
...
| virtual void [QuadraticBezierTo](./quadraticbezierto/)([System::Drawing::PointF](../../system.drawing/pointf/), [System::Drawing::PointF](../../system.drawing/pointf/)) | Adiciona curva quadrática de Bézier ao final do caminho |
| virtual void [QuadraticBezierTo](./quadraticbezierto/)(**float**, **float**, **float**, **float**) | Adiciona curva quadrática de Bézier ao final do caminho |
| virtual void [QuadraticBezierTo](./quadraticbezierto/)([System::Drawing::PointF](../../system.drawing/pointf/), [System::Drawing::PointF](../../system.drawing/pointf/), **uint32_t**) | Adiciona curva quadrática de Bézier ao local especificado do caminho |
| virtual void [QuadraticBezierTo](./quadraticbezierto/)(**float**, **float**, **float**, **float**, **uint32_t**) | Adiciona curva quadrática de Bézier ao local especificado do caminho |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove segmento no índice especificado do caminho geométrico. |
...
| virtual void [set_FillMode](./set_fillmode/)([PathFillModeType](../pathfillmodetype/)) | Define o modo de preenchimento |
| virtual void [set_Stroke](./set_stroke/)(**bool**) | Define a aparência do traço |
