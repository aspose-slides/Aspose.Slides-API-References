...
| virtual **int32_t** [get_Count](./get_count/)() | Retorna o número de partes no grupo. Somente leitura **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Retorna o nome do grupo de partes do documento. Somente leitura [System::String](../../system/string/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n'th argumento de modelo como um ponteiro fraco (em vez de compartilhado). Permite trocar ponteiros em contêineres para modo fraco. |
