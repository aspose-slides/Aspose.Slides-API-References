...
| [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../shape/get_blackwhitemode/)() override | A propriedade especifica como uma forma será renderizada no modo de exibição em preto e branco. Leia [Slides::BlackWhiteMode](../blackwhitemode/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\> [get_Column](./get_column/)(**int32_t**) override | Retorna uma coluna no índice especificado. Somente leitura [Aspose::Slides::IColumn](../icolumn/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColumnCollection](../icolumncollection/)\> [get_Columns](./get_columns/)() override | Retorna a coleção de colunas. Somente leitura [IColumnCollection](../icolumncollection/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Retorna um objeto [TableFormat::get_FillFormat](../tableformat/get_fillformat/) que contém a formatação de preenchimento para o [Table](./). Somente leitura [IFillFormat](../ifillformat/). |
| **bool** [get_FirstCol](./get_firstcol/)() override | Determina se a primeira coluna de uma tabela deve ser desenhada com formatação especial. Leia **bool**. |
| **bool** [get_FirstRow](./get_firstrow/)() override | Determina se a primeira linha de uma tabela deve ser desenhada com formatação especial. Leia **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_Frame](../shape/get_frame/)() override | Retorna as propriedades da moldura da forma. Leia [IShapeFrame](../ishapeframe/). |
...
| **bool** [get_HorizontalBanding](./get_horizontalbanding/)() override | Determina se as linhas pares devem ser desenhadas com formatação diferente. Leia **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkClick](../shape/get_hyperlinkclick/)() override | Retorna o hiperlink definido para clique do mouse. Leia [IHyperlink](../ihyperlink/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkMouseOver](../shape/get_hyperlinkmouseover/)() override | Retorna o hiperlink definido para passagem do mouse. Leia [IHyperlink](../ihyperlink/). |
...
| **bool** [get_LastCol](./get_lastcol/)() override | Determina se a última coluna de uma tabela deve ser desenhada com formatação especial. Leia **bool**. |
| **bool** [get_LastRow](./get_lastrow/)() override | Determina se a última linha de uma tabela deve ser desenhada com formatação especial. Leia **bool**. |
...
| [System::String](../../system/string/) [get_Name](../shape/get_name/)() override | Retorna o nome de uma forma. Deve ser não nulo. Use o valor de string vazia se necessário. Leia [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_RawFrame](../shape/get_rawframe/)() override | Retorna as propriedades brutas da moldura da forma. Leia [IShapeFrame](../ishapeframe/). |
| **bool** [get_RightToLeft](./get_righttoleft/)() override | Determina se a tabela tem ordem de leitura da direita para a esquerda. Lê **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\> [get_Row](./get_row/)(**int32_t**) override | Retorna uma linha no índice especificado. |
| [System::SharedPtr](../../system/sharedptr/)\<[IRowCollection](../irowcollection/)\> [get_Rows](./get_rows/)() override | Retorna a coleção de linhas. Somente leitura [IRowCollection](../irowcollection/). |
...
| [TableStylePreset](../tablestylepreset/) [get_StylePreset](./get_stylepreset/)() override | Obtém o estilo de tabela embutido. Leia [TableStylePreset](../tablestylepreset/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITableFormat](../itableformat/)\> [get_TableFormat](./get_tableformat/)() override | Retorna o objeto [TableFormat](../tableformat/) que contém propriedades de formatação para esta tabela. Somente leitura [ITableFormat](../itableformat/). |
...
| **bool** [get_VerticalBanding](./get_verticalbanding/)() override | Determina se as colunas pares devem ser desenhadas com formatação diferente. Leia **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../shape/getbaseplaceholder/)() override | Retorna uma forma placeholder básica (forma do layout e/ou slide mestre da qual a forma atual foi herdada). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](./idx_get/)(**int32_t**, **int32_t**) override | Retorna a célula nos índices de coluna e linha especificados. Somente leitura [Cell](../cell/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [MergeCells](./mergecells/)([System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>, **bool**) override | Mescla células vizinhas. |
...
| void [set_FirstCol](./set_firstcol/)(**bool**) override | Determina se a primeira coluna de uma tabela deve ser desenhada com formatação especial. Escreva **bool**. |
| void [set_FirstRow](./set_firstrow/)(**bool**) override | Determina se a primeira linha de uma tabela deve ser desenhada com formatação especial. Escreva **bool**. |
...
| void [set_HorizontalBanding](./set_horizontalbanding/)(**bool**) override | Determina se as linhas pares devem ser desenhadas com formatação diferente. Escreva **bool**. |
...
| void [set_HyperlinkMouseOver](../shape/set_hyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\>) override | Define o hiperlink definido para passagem do mouse. Escreva [IHyperlink](../ihyperlink/). |
| void [set_IsDecorative](../shape/set_isdecorative/)(**bool**) override | Define a opção 'Marcar como decorativo' Leitura/gravação **bool**. |
| void [set_LastCol](./set_lastcol/)(**bool**) override | Determina se a última coluna de uma tabela deve ser desenhada com formatação especial. Escreva **bool**. |
| void [set_LastRow](./set_lastrow/)(**bool**) override | Determina se a última linha de uma tabela deve ser desenhada com formatação especial. Escreva **bool**. |
| void [set_Name](../shape/set_name/)([System::String](../../system/string/)) override | Define o nome de uma forma. Deve ser não nulo. Use o valor de string vazia se necessário. Escreva [System::String](../../system/string/). |
| void [set_RawFrame](../shape/set_rawframe/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\>) override | Define as propriedades da moldura da forma bruta. Escreva [IShapeFrame](../ishapeframe/). |
| void [set_RightToLeft](./set_righttoleft/)(**bool**) override | Determina se a tabela tem ordem de leitura da direita para a esquerda. Escreve **bool**. |
...
| void [set_StylePreset](./set_stylepreset/)([TableStylePreset](../tablestylepreset/)) override | Define o estilo de tabela embutido. Escreva [TableStylePreset](../tablestylepreset/). |
| void [set_VerticalBanding](./set_verticalbanding/)(**bool**) override | Determina se as colunas pares devem ser desenhadas com formatação diferente. Escreva **bool**. |
...
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | Define as propriedades de formato de porção definidas para todas as porções das células da tabela. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | Define as propriedades de formato de parágrafo definidas para todos os parágrafos das células da tabela. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | Define as propriedades de formato de quadro de texto definidas para todos os quadros de texto das células da tabela. |
