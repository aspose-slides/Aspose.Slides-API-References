...
description: Representa o gerenciador que contém o comportamento dos marcadores de posição do slide de notas, incluindo o marcador de posição de cabeçalho.
type: docs
weight: 3030
url: /pt/aspose.slides/inotesslideheaderfootermanager/
---
## INotesSlideHeaderFooterManager classe

Representa o gerenciador que contém o comportamento dos marcadores de posição do slide de notas, incluindo o marcador de posição de cabeçalho.
...
| virtual **bool** [get_IsDateTimeVisible](../ibaseslideheaderfootermanager/get_isdatetimevisible/)() | Obtém valor indicando que um marcador de posição de data/hora está presente. Leitura **bool**. |
| virtual **bool** [get_IsFooterVisible](../ibaseslideheaderfootermanager/get_isfootervisible/)() | Obtém valor indicando que um marcador de posição de rodapé está presente. Leitura **bool**. |
| virtual **bool** [get_IsHeaderVisible](../ibasehandoutnotesslideheaderfootermanag/get_isheadervisible/)() | Obtém valor indicando que um marcador de posição de cabeçalho está presente. Leitura **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](../ibaseslideheaderfootermanager/get_isslidenumbervisible/)() | Obtém valor indicando que um marcador de posição de número de página está presente. Leitura **bool**. |
...
| virtual void [SetDateTimeText](../ibaseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) | Define o texto no marcador de posição de data/hora do slide. |
| virtual void [SetDateTimeVisibility](../ibaseslideheaderfootermanager/setdatetimevisibility/)(**bool**) | Altera a visibilidade do marcador de posição de data/hora do slide. |
| virtual void [SetFooterText](../ibaseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) | Define o texto no marcador de posição de rodapé do slide. |
| virtual void [SetFooterVisibility](../ibaseslideheaderfootermanager/setfootervisibility/)(**bool**) | Altera a visibilidade do marcador de posição de rodapé do slide. |
| virtual void [SetHeaderText](../ibasehandoutnotesslideheaderfootermanag/setheadertext/)([System::String](../../system/string/)) | Define o texto no marcador de posição de cabeçalho do slide. |
| virtual void [SetHeaderVisibility](../ibasehandoutnotesslideheaderfootermanag/setheadervisibility/)(**bool**) | Altera a visibilidade do marcador de posição de cabeçalho do slide. |
| virtual void [SetSlideNumberVisibility](../ibaseslideheaderfootermanager/setslidenumbervisibility/)(**bool**) | Altera a visibilidade do marcador de posição de número de página do slide. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de modelo como ponteiro fraco (em vez de compartilhado). Permite alterar ponteiros em contêineres para modo fraco. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Diminui e retorna o contador de referência compartilhado. Não deve ser chamado diretamente; em vez disso, use ponteiros inteligentes ou ThisProtector. |
