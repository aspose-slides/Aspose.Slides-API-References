...
| Método | Descrição |
| --- | --- |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) override | Cria uma cópia da linha de modelo especificada e a insere na parte inferior de uma tabela. |
| [iterator](./iterator/) [begin](./begin/)() | Obtém o iterador que aponta para o primeiro elemento (se houver) da coleção. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtém o iterador que aponta para o primeiro elemento (se houver) da coleção. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtém o iterador que aponta imediatamente após o último elemento qualificado como const (se houver) da coleção. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\>, **int32_t**) override | Copia todos os elementos da coleção para o array especificado. |
...
| [iterator](./iterator/) [end](./end/)() | Obtém o iterador que aponta imediatamente após o último elemento (se houver) da coleção. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtém o iterador que aponta imediatamente após o último elemento (se houver) da instância qualificada como const da coleção. |
...
| **int32_t** [get_Count](./get_count/)() override | Obtém o número de linhas realmente contidas na coleção. Somente leitura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera pela coleção. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\> [idx_get](./idx_get/)(**int32_t**) override | Retorna a linha no índice especificado. Somente leitura [Row](../row/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\>, **bool**) override | Cria uma cópia da linha de modelo especificada e a insere na posição especificada em uma tabela. |
...
| void [RemoveAt](./removeat/)(**int32_t**, **bool**) override | Remove uma linha na posição especificada de uma tabela. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Define o n-ésimo argumento de template como um ponteiro fraco (em vez de compartilhado). Permite trocar ponteiros em contêineres para modo fraco. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtém o iterador que aponta imediatamente após o último elemento (se houver) da instância qualificada como const da coleção. |
