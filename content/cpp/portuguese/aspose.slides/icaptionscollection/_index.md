...
description: Representa uma coleção de legendas ocultas.
type: docs
weight: 1626
...
Representa uma coleção de legendas ocultas.
...
| Método | Descrição |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) | Adiciona legendas fechadas WebVTT ao final da coleção. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) | Adiciona legendas fechadas WebVTT ao final da coleção a partir de um fluxo. |
...
| virtual void [Clear](./clear/)() | Remove todas as legendas fechadas da coleção. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Retorna o número de elementos na coleção. Somente leitura **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [idx_get](./idx_get/)(**int32_t**) | Retorna as legendas fechadas no índice especificado. Somente leitura [ICaptions](../icaptions/). |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\>) | Remove as legendas fechadas especificadas da coleção. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove as legendas fechadas no índice especificado. |
