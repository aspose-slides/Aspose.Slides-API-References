...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [get_MasterNotesSlide](./get_masternotesslide/)() | Retorna um mestre para todos os slides de notas desta apresentação se houver um, caso contrário retorna null. Somente leitura [IMasterNotesSlide](../imasternotesslide/). |
...
| virtual void [RemoveMasterNotesSlide](./removemasternotesslide/)() | Remove o slide mestre de notas. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlide](../imasternotesslide/)\> [SetDefaultMasterNotesSlide](./setdefaultmasternotesslide/)() | Define o slide mestre de notas padrão para o slide de notas relacionado. |
