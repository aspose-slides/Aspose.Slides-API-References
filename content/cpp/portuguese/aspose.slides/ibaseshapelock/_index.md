...
description: Representa o bloqueio da forma (operação desativada).
type: docs
weight: 1483
...
Representa o bloqueio [Shape](../shape/) (operação desativada).
...
| virtual **bool** [get_NoLocks](./get_nolocks/)() | Retorna true se todas as bandeiras de bloqueio estiverem desativadas. Somente leitura **bool**. |
