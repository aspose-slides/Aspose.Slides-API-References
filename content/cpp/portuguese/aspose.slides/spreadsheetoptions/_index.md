...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() override | Obtém informações de cultura preferida para calcular algumas funções destinadas a uso com idiomas que utilizam o conjunto de caracteres de dois bytes (DBCS). |
| **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() override | Se a fonte de dados para o gráfico for uma pasta de trabalho externa e não estiver disponível, será recuperada do cache do gráfico. |
...
| void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) override | Define informações de cultura preferida para calcular algumas funções destinadas a uso com idiomas que utilizam o conjunto de caracteres de dois bytes (DBCS). |
| void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) override | Se a fonte de dados para o gráfico for uma pasta de trabalho externa e não estiver disponível, será recuperada do cache do gráfico. |
...
|  [SpreadsheetOptions](./spreadsheetoptions/)() | Inicializa uma nova instância da classe [SpreadsheetOptions](./). |
