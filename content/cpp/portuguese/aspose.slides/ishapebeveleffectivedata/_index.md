...
description: Objeto imutável que contém as propriedades de relevo da face da forma efetiva.
type: docs
weight: 3667
url: /pt/aspose.slides/ishapebeveleffectivedata/
---
## classe IShapeBevelEffectiveData
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Tipo de chanfradura. Somente leitura [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Altura da chanfradura. Somente leitura **double**. |
| virtual **double** [get_Width](./get_width/)() | Largura da chanfradura. Somente leitura **double**. |
