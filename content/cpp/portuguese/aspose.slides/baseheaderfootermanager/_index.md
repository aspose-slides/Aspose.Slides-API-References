...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-th argumento de modelo como weak pointer (em vez de shared). Permite mudar ponteiros em contêineres para modo fraco. |
