...
description: Representa o gerenciador que mantém o comportamento de todos os marcadores de rodapé, data/hora e número de página da apresentação.
type: docs
weight: 3407
...
Representa o gerenciador que mantém o comportamento de todos os marcadores de rodapé, data/hora e número de página da apresentação.
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógia ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Habilita hash de objetos personalizados. |
...
| virtual void [SetAllDateTimesText](./setalldatetimestext/)([System::String](../../system/string/)) | Define texto para todos os marcadores de data/hora, incluindo slides mestre, slides de layout e slides. |
| virtual void [SetAllDateTimesVisibility](./setalldatetimesvisibility/)(**bool**) | Altera a visibilidade de todos os marcadores de data/hora, incluindo slides mestre, slides de layout e slides. |
| virtual void [SetAllFootersText](./setallfooterstext/)([System::String](../../system/string/)) | Define texto para todos os marcadores de rodapé, incluindo slides mestre, slides de layout e slides. |
| virtual void [SetAllFootersVisibility](./setallfootersvisibility/)(**bool**) | Altera a visibilidade de todos os marcadores de rodapé, incluindo slides mestre, slides de layout e slides. |
| virtual void [SetAllHeadersText](./setallheaderstext/)([System::String](../../system/string/)) | Define texto para todos os marcadores de cabeçalho, incluindo notas mestre, notas de slides e mestre de folhetos. |
| virtual void [SetAllHeadersVisibility](./setallheadersvisibility/)(**bool**) | Altera a visibilidade de todos os marcadores de cabeçalho, incluindo notas mestre, notas de slides e mestre de folhetos. |
| virtual void [SetAllSlideNumbersVisibility](./setallslidenumbersvisibility/)(**bool**) | Altera a visibilidade de todos os marcadores de número de página, incluindo slides mestre, slides de layout e slides. |
