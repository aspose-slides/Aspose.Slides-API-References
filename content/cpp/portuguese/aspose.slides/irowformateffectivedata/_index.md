...
description: Objeto imutável que contém propriedades efetivas de formatação de linhas de tabela.
type: docs
weight: 3550
...
Objeto imutável que contém propriedades efetivas de formatação de linhas de tabela.
...
Esta interface é usada juntamente com a interface [IRowFormat](../irowformat/) para retornar valores efetivos de formatação com herança e estilos de tabela aplicados.
