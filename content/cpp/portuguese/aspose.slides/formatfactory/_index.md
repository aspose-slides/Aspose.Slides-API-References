...
| Método | Descrição |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [CreateParagraphFormat](./createparagraphformat/)() override | Cria novo [IParagraphFormat](../iparagraphformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [CreatePortionFormat](./createportionformat/)() override | Cria novo [IPortionFormat](../iportionformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\> [CreateTextFrameFormat](./createtextframeformat/)() override | Cria novo [ITextFrameFormat](../itextframeformat/). |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[FormatFactory](./)\> [get_Instance](./get_instance/)() | Instância estática da fábrica de formatos. Somente leitura [FormatFactory](./). |
...
| void [Lock](../../system/object/lock/)() | Implementa o bloqueio da instrução lock() do C#. Chame diretamente ou use o objeto sentry [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa o desbloqueio da instrução lock() do C#. Chame diretamente ou use o objeto sentry [LockContext](../../system/lockcontext/). |
