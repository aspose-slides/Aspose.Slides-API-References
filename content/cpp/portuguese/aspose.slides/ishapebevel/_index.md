...
description: Representa propriedades do relevo da face principal da forma.
type: docs
weight: 3654
...
Representa propriedades do relevo da face principal da forma.
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Tipo de chanfro. Leitura [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Altura do chanfro. Leitura **double**. |
| virtual **double** [get_Width](./get_width/)() | Largura do chanfro. Leitura **double**. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | Tipo de chanfro. Escrita [BevelPresetType](../bevelpresettype/). |
| virtual void [set_Height](./set_height/)(**double**) | Altura do chanfro. Escrita **double**. |
| virtual void [set_Width](./set_width/)(**double**) | Largura do chanfro. Escrita **double**. |
