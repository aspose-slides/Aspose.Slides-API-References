...
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | Propriedade especifica como uma forma será renderizada no modo de exibição em preto e branco. Leia [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [get_HyperlinkMouseOver](../ihyperlinkcontainer/get_hyperlinkmouseover/)() | Retorna o hyperlink definido para mouse over. Leia [IHyperlink](../ihyperlink/). |
...
| virtual [ZoomLayout](../zoomlayout/) [get_Layout](./get_layout/)() | Obtém o layout das Seções de Summary Zoom na moldura. O valor padrão é GridLayout. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSectionCollection](../isummaryzoomsectioncollection/)\> [get_SummaryZoomCollection](./get_summaryzoomcollection/)() | Obtém [ISummaryZoomSectionCollection](../isummaryzoomsectioncollection/) para o objeto Summary Zoom Frame. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [get_SummaryZoomSection](./get_summaryzoomsection/)(**int32_t**) | Retorna o objeto Summary Zoom [Section](../section/) no slide no índice especificado. Somente leitura [Aspose::Slides::ISummaryZoomSection](../isummaryzoomsection/). |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógico do método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite o hash de objetos personalizados. |
