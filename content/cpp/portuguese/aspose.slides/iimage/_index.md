...
| virtual **int32_t** [get_Height](./get_height/)() | Obtém a altura da imagem em pixels. |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_Size](./get_size/)() | Obtém o tamanho da imagem. |
| virtual **int32_t** [get_Width](./get_width/)() | Obtém a largura da imagem em pixels. |
...
| virtual void [Save](./save/)([System::String](../../system/string/)) | Salva a imagem em um arquivo. |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/)) | Salva a imagem em um arquivo no formato especificado. |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/)) | Salva a imagem em um fluxo no formato especificado. |
| virtual void [Save](./save/)([System::String](../../system/string/), [ImageFormat](../imageformat/), **int32_t**) | Salva a imagem em um arquivo no formato e qualidade especificados. |
| virtual void [Save](./save/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [ImageFormat](../imageformat/), **int32_t**) | Salva a imagem em um fluxo no formato e qualidade especificados. |
...
Esta interface fornece uma abstração comum para manipular tanto imagens raster quanto vetoriais. 

 As implementações podem variar dependendo do tipo subjacente da imagem. 
