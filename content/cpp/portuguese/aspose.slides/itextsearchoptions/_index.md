...
description: Representa opções que podem ser usadas para pesquisar texto em uma Apresentação, Slide ou TextFrame.
type: docs
weight: 4122
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Defina true para usar pesquisa sensível a maiúsculas e minúsculas, false caso contrário. Leia **bool**. |
| virtual **bool** [get_IncludeNotes](./get_includenotes/)() | Defina **true** para incluir texto contido nas notas dos slides ao executar pesquisa de texto, substituição ou realce. O valor padrão é **false**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Defina true para corresponder apenas a palavras inteiras, false caso contrário. Leia **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referências associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método [Object.GetHashCode()](../../system/object/gethashcode/) de C#. Permite hash de objetos personalizados. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Análogo ao método [Object.MemberwiseClone()](../../system/object/memberwiseclone/) de C#. Permite clonagem de tipos personalizados. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Defina true para usar pesquisa sensível a maiúsculas e minúsculas, false caso contrário. Grave **bool**. |
| virtual void [set_IncludeNotes](./set_includenotes/)(**bool**) | Defina **true** para incluir texto contido nas notas dos slides ao executar pesquisa de texto, substituição ou realce. O valor padrão é **false**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Defina true para corresponder apenas a palavras inteiras, false caso contrário. Grave **bool**. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | Análogo ao método [Object.ToString()](../../system/object/tostring/) de C#. Permite converter objetos personalizados para string. |
