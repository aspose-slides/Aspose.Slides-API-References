...
description: Objeto imutável que contém as propriedades do preenchimento de imagem.
type: docs
weight: 3238
...
Imutável objeto que contém as propriedades do preenchimento de imagem.
...
| virtual **float** [get_CropBottom](./get_cropbottom/)() | Retorna o número de por cento da altura real da imagem que é recortada na parte inferior da imagem. Somente leitura **float**. |
| virtual **float** [get_CropLeft](./get_cropleft/)() | Retorna o número de por cento da largura real da imagem que é recortada no lado esquerdo da imagem. Somente leitura **float**. |
| virtual **float** [get_CropRight](./get_cropright/)() | Retorna o número de por cento da largura real da imagem que é recortada no lado direito da imagem. Somente leitura **float**. |
| virtual **float** [get_CropTop](./get_croptop/)() | Retorna o número de por cento da altura real da imagem que é recortada na parte superior da imagem. Somente leitura **float**. |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | Retorna o dpi usado para preencher a imagem. Somente leitura **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | Retorna a imagem. Somente leitura [IPictureEffectiveData](../ipictureeffectivedata/). |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | Retorna o modo de preenchimento da imagem. Somente leitura [Slides::PictureFillMode](../picturefillmode/). |
...
| void [Lock](../../system/object/lock/)() | Implementa a instrução lock() do C# bloqueando. Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
...
Esta interface é usada como parte do [IFillFormatEffectiveData](../ifillformateffectivedata/). 
