...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_BackColor](./get_backcolor/)() | Retorna a cor de fundo do padrão. Somente leitura [IColorFormat](../icolorformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ForeColor](./get_forecolor/)() | Retorna a cor de primeiro plano do padrão. Somente leitura [IColorFormat](../icolorformat/). |
| virtual [Aspose::Slides::PatternStyle](../patternstyle/) [get_PatternStyle](./get_patternstyle/)() | Retorna o estilo do padrão. Leitura [Slides::PatternStyle](../patternstyle/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/), [System::Drawing::Color](../../system.drawing/color/)) | Cria uma imagem de mosaico para o preenchimento de padrão com cores especificadas. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/)) | Cria uma imagem de mosaico para o preenchimento de padrão. |
...
| virtual void [set_PatternStyle](./set_patternstyle/)([Aspose::Slides::PatternStyle](../patternstyle/)) | Define o estilo do padrão. Grava [Slides::PatternStyle](../patternstyle/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de modelo como ponteiro fraco (ao invés de compartilhado). Permite mudar ponteiros em contêineres para modo fraco. |
