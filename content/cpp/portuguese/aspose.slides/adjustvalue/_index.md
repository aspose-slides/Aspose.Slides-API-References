...
description: Representa o valor de ajuste de uma forma geométrica. Esses valores afetam a forma da forma.
type: docs
weight: 1
...
| **float** [get_AngleValue](./get_anglevalue/)() override | Retorna o valor, interpretando-o como ângulo em graus. Lê **float**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Retorna um nome deste valor de ajuste. Somente leitura [System::String](../../system/string/). |
| **int64_t** [get_RawValue](./get_rawvalue/)() override | Retorna o valor de ajuste "como está". Lê **int64_t**. |
| [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() override | Retorna o tipo do ajuste da forma. Somente leitura [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| void [set_AngleValue](./set_anglevalue/)(**float**) override | Define o valor, interpretando-o como ângulo em graus. Escrita **float**. |
| void [set_RawValue](./set_rawvalue/)(**int64_t**) override | Define o valor de ajuste "como está". Escrita **int64_t**. |
