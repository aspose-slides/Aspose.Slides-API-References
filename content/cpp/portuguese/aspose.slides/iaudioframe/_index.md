...
| virtual **int32_t** [get_AudioCdEndTrack](./get_audiocdendtrack/)() | Retorna o índice da última faixa. Leitura **int32_t**. |
| virtual **int32_t** [get_AudioCdEndTrackTime](./get_audiocdendtracktime/)() | Retorna o tempo da última faixa. Leitura **int32_t**. |
| virtual **int32_t** [get_AudioCdStartTrack](./get_audiocdstarttrack/)() | Retorna o índice da faixa inicial. Leitura **int32_t**. |
| virtual **int32_t** [get_AudioCdStartTrackTime](./get_audiocdstarttracktime/)() | Retorna o tempo da faixa inicial. Leitura **int32_t**. |
| virtual [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../ishape/get_blackwhitemode/)() | A propriedade especifica como uma shape será renderizada em modo preto-e-branco. Leitura [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| virtual **bool** [get_Embedded](./get_embedded/)() | Determina se um som está incorporado a uma apresentação. Somente leitura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [get_EmbeddedAudio](./get_embeddedaudio/)() | Retorna o objeto de áudio incorporado. Leitura [IAudio](../iaudio/). |
| virtual **float** [get_FadeInDuration](./get_fadeinduration/)() | Especifica a duração em milissegundos para o fade-in inicial da mídia. Leitura **float**. |
| virtual **float** [get_FadeOutDuration](./get_fadeoutduration/)() | Especifica a duração em milissegundos para o fade-out final da mídia. Leitura **float**. |
...
| virtual **bool** [get_HideAtShowing](./get_hideatshowing/)() | Determina se um [AudioFrame](../audioframe/) está oculto. Leitura **bool**. |
...
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Retorna o nome de um arquivo de áudio vinculado a um [AudioFrame](../audioframe/). Leitura [System::String](../../system/string/). |
...
| virtual **uint32_t** [get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/)() | Retorna um identificador exclusivo de escopo de slide que permanece constante durante a vida da shape e permite que PowerPoint ou código interop referenciem a shape de forma confiável a partir de qualquer ponto do documento. Somente leitura **uint32_t**. Veja também [IShape::get_UniqueId](../ishape/get_uniqueid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_PictureFormat](../ipictureframe/get_pictureformat/)() | Retorna o objeto [PictureFillFormat](../picturefillformat/) de um quadro de imagem. Somente leitura [IPictureFillFormat](../ipicturefillformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFrameLock](../ipictureframelock/)\> [get_PictureFrameLock](../ipictureframe/get_pictureframelock/)() | Retorna os bloqueios de [PictureFrame](../pictureframe/). Somente leitura [IPictureFrameLock](../ipictureframelock/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../iplaceholder/)\> [get_Placeholder](../ishape/get_placeholder/)() | Retorna o placeholder de uma shape. Somente leitura [IPlaceholder](../iplaceholder/). |
| virtual **bool** [get_PlayAcrossSlides](./get_playacrossslides/)() | Determina se um áudio está sendo reproduzido em todas as slides. Leitura **bool**. |
| virtual **bool** [get_PlayLoopMode](./get_playloopmode/)() | Determina se um áudio está em loop. Leitura **bool**. |
| virtual [AudioPlayModePreset](../audioplaymodepreset/) [get_PlayMode](./get_playmode/)() | Retorna o modo de reprodução do áudio. Leitura [AudioPlayModePreset](../audioplaymodepreset/). |
...
| virtual **float** [get_RelativeScaleHeight](../ipictureframe/get_relativescaleheight/)() | Retorna a escala de altura (relativa ao tamanho original da imagem) do quadro de imagem. Valor 1.0 corresponde a 100%. Leitura **float**. |
| virtual **float** [get_RelativeScaleWidth](../ipictureframe/get_relativescalewidth/)() | Retorna a escala de largura (relativa ao tamanho original da imagem) do quadro de imagem. Valor 1.0 corresponde a 100%. Leitura **float**. |
| virtual **bool** [get_RewindAudio](./get_rewindaudio/)() | Determina se um áudio é automaticamente retornado ao início após a reprodução. Leitura **bool**. |
...
| virtual [Aspose::Slides::ShapeType](../shapetype/) [get_ShapeType](../igeometryshape/get_shapetype/)() | Retorna o tipo preset de geometria. Nota: ao mudar o valor, todos os valores de ajuste serão redefinidos para seus valores padrão. Leitura [Slides::ShapeType](../shapetype/). |
...
| virtual **float** [get_TrimFromEnd](./get_trimfromend/)() | Especifica a duração em milissegundos a ser removida do fim da mídia durante a reprodução. Leitura **float**. |
| virtual **float** [get_TrimFromStart](./get_trimfromstart/)() | Especifica a duração em milissegundos a ser removida do início da mídia durante a reprodução. Leitura **float**. |
...
| virtual **float** [get_VolumeValue](./get_volumevalue/)() | Retorna o volume do áudio em porcentagem. Leitura **float**. |
...
| virtual **int32_t** [get_ZOrderPosition](../ishape/get_zorderposition/)() | Retorna a posição de uma shape na ordem z. Shapes[0] retorna a shape na parte traseira da ordem z, e Shapes[Shapes.Count - 1] retorna a shape na frente da ordem z. Somente leitura **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [GetBasePlaceholder](../ishape/getbaseplaceholder/)() | Retorna uma shape placeholder básica (shape do layout e/ou slide mestre da qual a shape atual foi herdada). |
...
| virtual void [set_AudioCdEndTrack](./set_audiocdendtrack/)(**int32_t**) | Define o índice da última faixa Gravação **int32_t**. |
| virtual void [set_AudioCdEndTrackTime](./set_audiocdendtracktime/)(**int32_t**) | Define o tempo da última faixa Gravação **int32_t**. |
| virtual void [set_AudioCdStartTrack](./set_audiocdstarttrack/)(**int32_t**) | Define o índice da faixa inicial Gravação **int32_t**. |
| virtual void [set_AudioCdStartTrackTime](./set_audiocdstarttracktime/)(**int32_t**) | Define o tempo da faixa inicial Gravação **int32_t**. |
| virtual void [set_BlackWhiteMode](../ishape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) | A propriedade especifica como uma shape será renderizada em modo preto-e-branco. Gravação [Slides::BlackWhiteMode](../blackwhitemode/). |
| virtual void [set_EmbeddedAudio](./set_embeddedaudio/)([System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\>) | Define o objeto de áudio incorporado. Gravação [IAudio](../iaudio/). |
| virtual void [set_FadeInDuration](./set_fadeinduration/)(**float**) | Especifica a duração em milissegundos para o fade-in inicial da mídia. Gravação **float**. |
| virtual void [set_FadeOutDuration](./set_fadeoutduration/)(**float**) | Especifica a duração em milissegundos para o fade-out final da mídia. Gravação **float**. |
...
| virtual void [set_HideAtShowing](./set_hideatshowing/)(**bool**) | Determina se um [AudioFrame](../audioframe/) está oculto. Gravação **bool**. |
...
| virtual void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) | Define o nome de um arquivo de áudio vinculado a um [AudioFrame](../audioframe/). Gravação [System::String](../../system/string/). |
...
| virtual void [set_PlayAcrossSlides](./set_playacrossslides/)(**bool**) | Determina se um áudio está sendo reproduzido em todas as slides. Gravação **bool**. |
| virtual void [set_PlayLoopMode](./set_playloopmode/)(**bool**) | Determina se um áudio está em loop. Gravação **bool**. |
| virtual void [set_PlayMode](./set_playmode/)([AudioPlayModePreset](../audioplaymodepreset/)) | Define o modo de reprodução do áudio. Gravação [AudioPlayModePreset](../audioplaymodepreset/). |
...
| virtual void [set_RelativeScaleHeight](../ipictureframe/set_relativescaleheight/)(**float**) | Define a escala de altura (relativa ao tamanho original da imagem) do quadro de imagem. Valor 1.0 corresponde a 100%. Gravação **float**. |
| virtual void [set_RelativeScaleWidth](../ipictureframe/set_relativescalewidth/)(**float**) | Define a escala de largura (relativa ao tamanho original da imagem) do quadro de imagem. Valor 1.0 corresponde a 100%. Gravação **float**. |
| virtual void [set_RewindAudio](./set_rewindaudio/)(**bool**) | Determina se um áudio é automaticamente retornado ao início após a reprodução. Gravação **bool**. |
...
| virtual void [set_ShapeType](../igeometryshape/set_shapetype/)([Aspose::Slides::ShapeType](../shapetype/)) | Define o tipo preset de geometria. Nota: ao mudar o valor, todos os valores de ajuste serão redefinidos para seus valores padrão. Gravação [Slides::ShapeType](../shapetype/). |
| virtual void [set_TrimFromEnd](./set_trimfromend/)(**float**) | Especifica a duração em milissegundos a ser removida do fim da mídia durante a reprodução. Gravação **float**. |
| virtual void [set_TrimFromStart](./set_trimfromstart/)(**float**) | Especifica a duração em milissegundos a ser removida do início da mídia durante a reprodução. Gravação **float**. |
...
| virtual void [set_VolumeValue](./set_volumevalue/)(**float**) | Define o volume do áudio em porcentagem. Gravação **float**. |
