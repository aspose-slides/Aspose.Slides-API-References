...
Representa uma coleção de Summary Zoom [Section](../section/) objetos.
...
| Método | Descrição |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [AddSummaryZoomSection](./addsummaryzoomsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Cria um novo objeto Summary Zoom [Section](../section/) e o adiciona à coleção |
...
| void [Clear](./clear/)() override | Remove todos os objetos [SummaryZoomSection](../summaryzoomsection/) da coleção. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\>\>, **int32_t**) override | Copia toda a coleção para o array especificado. |
...
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Retorna um valor indicando se o acesso à coleção está sincronizado (thread-safe). Somente leitura **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera através da coleção. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [GetSummarySection](./getsummarysection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Retorna o elemento Summary Zoom [Section](../section/) para a seção fornecida. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\> [idx_get](./idx_get/)(**int32_t**) override | Obtém o elemento no índice especificado. Somente leitura [ISummaryZoomSection](../isummaryzoomsection/). |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[ISummaryZoomSection](../isummaryzoomsection/)\>) override | Retorna o índice do objeto [SummaryZoomSection](../summaryzoomsection/) especificado. |
...
| void [RemoveSummaryZoomSection](./removesummaryzoomsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Remove o objeto Summary Zoom [Section](../section/) da coleção. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Define o n-ésimo argumento de modelo como weak pointer (em vez de shared). Permite alternar ponteiros em contêineres para modo weak. |
...
| Typedef | Descrição |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Um tipo de coleção cujo tipo de iterador é usado como tipos de iterador na coleção atual. |
