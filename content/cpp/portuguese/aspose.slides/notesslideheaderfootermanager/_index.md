...
description: Representa o gerenciador que mantém o comportamento dos marcadores de posição do slide de notas, incluindo o marcador de posição do cabeçalho.
type: docs
weight: 4577
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Obtém valor indicando que um marcador de posição de data/hora está presente. Lê**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | Obtém valor indicando que um marcador de posição de rodapé está presente. Lê **bool**. |
| **bool** [get_IsHeaderVisible](../basehandoutnotesslideheaderfootermanager/get_isheadervisible/)() override | Obtém valor indicando que um marcador de posição de cabeçalho está presente. Lê **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Obtém valor indicando que um marcador de posição de número de página está presente. Lê**bool**. |
...
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | Define o texto no marcador de posição de data/hora do slide. |
| void [SetDateTimeVisibility](../baseslideheaderfootermanager/setdatetimevisibility/)(**bool**) override | Altera a visibilidade do marcador de posição de data/hora do slide. |
| void [SetFooterText](../baseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) override | Define o texto no marcador de posição de rodapé do slide. |
| void [SetFooterVisibility](../baseslideheaderfootermanager/setfootervisibility/)(**bool**) override | Altera a visibilidade do marcador de posição de rodapé do slide. |
| void [SetHeaderText](../basehandoutnotesslideheaderfootermanager/setheadertext/)([System::String](../../system/string/)) override | Define o texto no marcador de posição de cabeçalho do slide. |
| void [SetHeaderVisibility](../basehandoutnotesslideheaderfootermanager/setheadervisibility/)(**bool**) override | Altera a visibilidade do marcador de posição de cabeçalho do slide. |
| void [SetSlideNumberVisibility](../baseslideheaderfootermanager/setslidenumbervisibility/)(**bool**) override | Altera a visibilidade do marcador de posição de número de página do slide. |
