...
| [ShapeElementFillSource](../shapeelementfillsource/) [get_FillSource](./get_fillsource/)() | Retorna informações sobre como preencher um elemento. Somente leitura [ShapeElementFillSource](../shapeelementfillsource/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Shape](../shape/)\> [get_ParentShape](./get_parentshape/)() | Retorna um Shape_PPT para o qual o elemento foi criado. Somente leitura [Shape](../shape/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_PathPoints](./get_pathpoints/)() | Obtém um array de pontos que definem a geometria do caminho do elemento. |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_PathTypes](./get_pathtypes/)() | Obtém um array de valores byte que especificam o tipo de cada ponto no caminho do elemento. |
| [ShapeElementStrokeSource](../shapeelementstrokesource/) [get_StrokeSource](./get_strokesource/)() | Retorna informações sobre como traçar um elemento. Somente leitura [ShapeElementStrokeSource](../shapeelementstrokesource/). |
