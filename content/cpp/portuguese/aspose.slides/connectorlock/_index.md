...
Determina quais operações são desativadas no pai [Connector](../connector/).
...
| **bool** [get_ArrowheadsLocked](./get_arrowheadslocked/)() override | Determina se a alteração de pontas de seta é proibida. Leitura **bool**. |
...
| **bool** [get_PositionMove](./get_positionmove/)() override | Determina se mover esta forma é proibido. Leitura **bool**. |
...
| **bool** [get_ShapeTypeLocked](./get_shapetypelocked/)() override | Determina se a mudança do tipo de forma é proibida. Leitura **bool**. |
...
| void [set_ArrowheadsLocked](./set_arrowheadslocked/)(**bool**) override | Determina se a alteração de pontas de seta é proibida. Escrita **bool**. |
...
| void [set_PositionMove](./set_positionmove/)(**bool**) override | Determina se mover esta forma é proibido. Escrita **bool**. |
...
| void [set_ShapeTypeLocked](./set_shapetypelocked/)(**bool**) override | Determina se a mudança do tipo de forma é proibida. Escrita **bool**. |
