...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)() | Cria uma porção de texto vazia. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)([System::String](../../system/string/)) | Cria uma porção de texto a partir da string especificada. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [CreatePortion](./createportion/)([System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\>) | Cria uma porção usando os dados de uma porção especificada. |
