...
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_EndParagraphPortionFormat](./get_endparagraphportionformat/)() override | Especifica as propriedades da porção que devem ser usadas se outra porção for inserida após a última. |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() override | Retorna o objeto de formatação para este parágrafo. Somente leitura [IParagraphFormat](../iparagraphformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [get_Portion](./get_portion/)(**int32_t**) override | Retorna uma porção de texto no índice especificado. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionCollection](../iportioncollection/)\> [get_Portions](./get_portions/)() override | Retorna a coleção de porções de texto. Somente leitura [IPortionCollection](../iportioncollection/). |
| [System::String](../../system/string/) [get_Text](./get_text/)() override | Obtém o texto simples de um parágrafo. Leia [System::String](../../system/string/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hash de objetos personalizados. |
| **int32_t** [GetLinesCount](./getlinescount/)() override | Obtém o número de linhas em um parágrafo. |
| [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() override | Obtém as coordenadas do retângulo que delimita o parágrafo. O retângulo inclui todas as linhas de texto no parágrafo, incluindo linhas vazias. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Verifica se o objeto representa uma instância do tipo descrito por targetType. Análogo ao operador C# 'is'. |
| void [JoinPortionsWithSameFormatting](./joinportionswithsameformatting/)() override | Une execuções com a mesma formatação. |
...
|  [Paragraph](./paragraph/)([System::SharedPtr](../../system/sharedptr/)\<[Paragraph](./)\>) | Construtor de cópia que inicializa uma nova instância de uma classe [Paragraph](./). |
...
| void [set_EndParagraphPortionFormat](./set_endparagraphportionformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | Especifica as propriedades da porção que devem ser usadas se outra porção for inserida após a última. |
| void [set_Text](./set_text/)([System::String](../../system/string/)) override | Define o texto simples de um parágrafo. Escrita [System::String](../../system/string/). |
