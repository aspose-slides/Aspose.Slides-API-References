...
---
## Presentation::Save(System::String, Export::SaveFormat) método
...
## Presentation::Save(System::SharedPtr\<System::IO::Stream\>, Export::SaveFormat) método
...
## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) método
...
| fname | [System::String](../../../system/string/) | Caminho para o arquivo criado. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Formato dos dados exportados. |
| options | [System::SharedPtr](../../../system/sharedptr/)\<[Export::ISaveOptions](../../../aspose.slides.export/isaveoptions/)\> | Opções de formato adicionais. |
## Observações



O exemplo a seguir demonstra como converter PowerPoint para HTML usando C++. 
```cpp
// Instancia um objeto de apresentação que representa um arquivo de apresentação, por exemplo PPT, PPTX, ODP etc.
...
```
 O exemplo a seguir demonstra como converter PowerPoint para HTML responsivo usando C++. 
```cpp
...
// Salva a apresentação em HTML
presentation->Save(u"ConvertPresentationToResponsiveHTML_out.html", SaveFormat::Html, htmlOptions);
```
 O exemplo a seguir demonstra como converter PowerPoint para HTML com notas usando C++. 
```cpp
...
// Salva páginas de notas
pres->Save(u"Output.html", SaveFormat::Html, opt);
```
 O exemplo a seguir demonstra como converter PowerPoint para HTML com fontes originais usando C++. 
```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// Exclui as fontes padrão da apresentação
...
```
 O exemplo a seguir demonstra como converter PowerPoint para HTML com imagens de alta qualidade a 150 DPI usando C++. 
```cpp
...
```
 O exemplo a seguir demonstra como converter PowerPoint para HTML com imagens em qualidade total usando C++. 
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
 O exemplo a seguir demonstra como converter [Slide](../../slide/) para HTML usando C++. 
```cpp
```
