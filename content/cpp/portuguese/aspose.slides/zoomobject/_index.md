...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](../shape/get_effectformat/)() override | Retorna o objeto [EffectFormat](../effectformat/) que contém efeitos de pixel aplicados a uma forma. Observação: pode retornar nulo para certos tipos de formas que não têm propriedades de efeito. Somente leitura [IEffectFormat](../ieffectformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](../shape/get_fillformat/)() override | Retorna o objeto [FillFormat](../fillformat/) que contém propriedades de formatação de preenchimento para uma forma. Observação: pode retornar nulo para certos tipos de formas que não têm propriedades de preenchimento. Somente leitura [IFillFormat](../ifillformat/). |
...
| [ZoomImageType](../zoomimagetype/) [get_ImageType](./get_imagetype/)() override | Obtém o tipo de imagem de um objeto zoom. Leia [ZoomImageType](../zoomimagetype/). Valor padrão: Preview |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_LineFormat](../shape/get_lineformat/)() override | Retorna o objeto [LineFormat](../lineformat/) que contém propriedades de formatação de linha para uma forma. Observação: pode retornar nulo para certos tipos de formas que não têm propriedades de linha. Somente leitura [ILineFormat](../ilineformat/). |
| [System::String](../../system/string/) [get_Name](../shape/get_name/)() override | Retorna o nome de uma forma. Não deve ser nulo. Use valor de string vazia se necessário. Leia [System::String](../../system/string/). |
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | Retorna um identificador único no escopo do slide que permanece constante durante a vida útil da forma e permite que o PowerPoint ou código interop referenciem a forma de forma confiável a partir de qualquer lugar no documento. Somente leitura **uint32_t**. Veja também [Shape::get_UniqueId](../shape/get_uniqueid/). |
...
| **bool** [get_ReturnToParent](./get_returntoparent/)() override | Obtém o comportamento de navegação na apresentação de slides. Leia **bool**. Valor padrão: false |
| **float** [get_Rotation](../shape/get_rotation/)() override | Retorna o número de graus que a forma especificada está rotacionada ao redor do eixo z. Um valor positivo indica rotação horária; um valor negativo indica rotação anti-horária. Leia **float**. |
...
| **bool** [get_ShowBackground](./get_showbackground/)() override | Obtém o valor que especifica se o Zoom usará o plano de fundo do slide de destino. Leia **bool**. Valor padrão: true |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../ithreedformat/)\> [get_ThreeDFormat](../shape/get_threedformat/)() override | Retorna o objeto [ThreeDFormat](../threedformat/) que contém propriedades de efeito 3D para uma forma. Observação: pode retornar nulo para certos tipos de formas que não têm propriedades 3D. Somente leitura [IThreeDFormat](../ithreedformat/). |
| **float** [get_TransitionDuration](./get_transitionduration/)() override | Obtém a duração da transição entre Zoom e slide. Leia **float**. Valor padrão: 1.0f |
| **uint32_t** [get_UniqueId](../shape/get_uniqueid/)() override | Retorna um identificador interno, no escopo da apresentação, destinado ao uso por complementos ou outro código. Como esse valor pode ser reatribuído pelo usuário ou programaticamente, ele não deve ser tratado como uma chave única persistente. Somente leitura **uint32_t**. Veja também [Shape::get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](./get_zoomimage/)() override | Obtém a imagem para o objeto zoom. Leia [IPPImage](../ippimage/). |
| **int32_t** [get_ZOrderPosition](../shape/get_zorderposition/)() override | Retorna a posição de uma forma na ordem Z. Shapes[0] retorna a forma na parte traseira da ordem Z, e Shapes[Shapes.Count - 1] retorna a forma na frente da ordem Z. Somente leitura **int32_t**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Construtor de cópia. Não copia nada, na verdade, apenas inicializa um novo objeto e permite copiar subclasses. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de atribuição. Não copia nada, na verdade, apenas inicializa um novo objeto e permite copiar subclasses. |
...
| void [set_ImageType](./set_imagetype/)([ZoomImageType](../zoomimagetype/)) override | Define o tipo de imagem de um objeto zoom. Escreva [ZoomImageType](../zoomimagetype/). Valor padrão: Preview |
| void [set_IsDecorative](../shape/set_isdecorative/)(**bool**) override | Define a opção 'Marcar como decorativo' leitura/gravação **bool**. |
| void [set_Name](../shape/set_name/)([System::String](../../system/string/)) override | Define o nome de uma forma. Não deve ser nulo. Use valor de string vazia se necessário. Escreva [System::String](../../system/string/). |
...
| void [set_ReturnToParent](./set_returntoparent/)(**bool**) override | Define o comportamento de navegação na apresentação de slides. Escreva **bool**. Valor padrão: false |
| void [set_Rotation](../shape/set_rotation/)(**float**) override | Define o número de graus que a forma especificada está rotacionada ao redor do eixo z. Um valor positivo indica rotação horária; um valor negativo indica rotação anti-horária. Escreva **float**. |
| void [set_ShowBackground](./set_showbackground/)(**bool**) override | Define o valor que especifica se o Zoom usará o plano de fundo do slide de destino. Escreva **bool**. Valor padrão: true |
| void [set_TransitionDuration](./set_transitionduration/)(**float**) override | Define a duração da transição entre Zoom e slide. Escreva **float**. Valor padrão: 1.0f |
...
| void [set_ZoomImage](./set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) override | Define a imagem para o objeto zoom. Escreva [IPPImage](../ippimage/). |
