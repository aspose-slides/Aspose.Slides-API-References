...
Determina quais operações são desativadas no pai [PictureFrame](../pictureframe/).
...
| **bool** [get_AdjustHandlesLocked](./get_adjusthandleslocked/)() override | Determina se a alteração de valores de ajuste é proibida. Leitura **bool**. |
| **bool** [get_ArrowheadsLocked](./get_arrowheadslocked/)() override | Determina se a alteração de pontas de flecha é proibida. Leitura **bool**. |
...
| **bool** [get_CropLocked](./get_croplocked/)() override | Determina se o recorte de imagem é proibido. Leitura **bool**. |
...
| **bool** [get_NoLocks](../baseshapelock/get_nolocks/)() override | Retorna true se todas as bandeiras de bloqueio estiverem desativadas. Somente leitura **bool**. |
| **bool** [get_PositionLocked](./get_positionlocked/)() override | Determina se mover esta forma é proibido. Leitura **bool**. |
| **bool** [get_RotationLocked](./get_rotationlocked/)() override | Determina se a alteração do ângulo de rotação desta forma é proibida. Leitura **bool**. |
...
| void [set_AdjustHandlesLocked](./set_adjusthandleslocked/)(**bool**) override | Determina se a alteração de valores de ajuste é proibida. Escrita **bool**. |
| void [set_ArrowheadsLocked](./set_arrowheadslocked/)(**bool**) override | Determina se a alteração de pontas de flecha é proibida. Escrita **bool**. |
...
| void [set_CropLocked](./set_croplocked/)(**bool**) override | Determina se o recorte de imagem é proibido. Escrita **bool**. |
...
| void [set_RotationLocked](./set_rotationlocked/)(**bool**) override | Determina se a alteração do ângulo de rotação desta forma é proibida. Escrita **bool**. |
