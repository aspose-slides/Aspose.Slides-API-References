...
description: Representa as propriedades da moldura de forma.
type: docs
weight: 3706
...
| virtual **float** [get_CenterX](./get_centerx/)() | Retorna a coordenada X do centro de uma moldura. Somente leitura **float**. |
| virtual **float** [get_CenterY](./get_centery/)() | Retorna a coordenada Y do centro de uma moldura. Somente leitura **float**. |
| virtual [NullableBool](../nullablebool/) [get_FlipH](./get_fliph/)() | Determina se uma moldura está invertida horizontalmente. Somente leitura [NullableBool](../nullablebool/). |
| virtual [NullableBool](../nullablebool/) [get_FlipV](./get_flipv/)() | Determina se uma moldura está invertida verticalmente. Somente leitura [NullableBool](../nullablebool/). |
| virtual **float** [get_Height](./get_height/)() | Retorna a altura de uma moldura. Somente leitura **float**. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [get_Rectangle](./get_rectangle/)() | Retorna as coordenadas de uma moldura. Somente leitura [System::Drawing::RectangleF](../../system.drawing/rectanglef/). |
| virtual **float** [get_Rotation](./get_rotation/)() | Retorna o número de graus que uma moldura está rotacionada ao redor do eixo z. Um valor positivo indica rotação no sentido horário; um valor negativo indica rotação no sentido anti-horário. Somente leitura **float**. |
| virtual **float** [get_Width](./get_width/)() | Retorna a largura de uma moldura. Somente leitura **float**. |
| virtual **float** [get_X](./get_x/)() | Retorna a coordenada X do canto superior esquerdo de uma moldura. Somente leitura **float**. |
| virtual **float** [get_Y](./get_y/)() | Retorna a coordenada Y do canto superior esquerdo de uma moldura. Somente leitura **float**. |
