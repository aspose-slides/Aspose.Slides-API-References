...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Retorna um objeto de propriedades de preenchimento de tabela. Somente leitura [IFillFormat](../ifillformat/). |
...
| **float** [get_Transparency](./get_transparency/)() override | Obtém a transparência da cor de preenchimento. Somente **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() override | Obtém propriedades de formatação de tabela efetivas com herança e estilos de tabela aplicados. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada por valor especificado. |
| void [set_Transparency](./set_transparency/)(**float**) override | Define a transparência da cor de preenchimento. Escrita **float**. |
