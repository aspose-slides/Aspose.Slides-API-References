...
| Método | Descrição |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\>) | Adiciona a assinatura ao final da coleção. |
...
| virtual void [Clear](./clear/)() | Remove todas as assinaturas da coleção. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDigitalSignature](../idigitalsignature/)\> [idx_get](./idx_get/)(**int32_t**) | Retorna a assinatura pelo índice. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove a assinatura no índice especificado. |
