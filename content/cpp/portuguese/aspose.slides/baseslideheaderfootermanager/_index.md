...
| **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() override | Obtém valor que indica que um marcador de data e hora está presente. Read**bool**. |
| **bool** [get_IsFooterVisible](./get_isfootervisible/)() override | Obtém valor que indica que um marcador de rodapé está presente. Read **bool**. |
| **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() override | Obtém valor que indica que um marcador de número de página está presente. Read**bool**. |
...
| void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) override | Define o texto para o marcador de data e hora do slide. |
| void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) override | Altera a visibilidade do marcador de data e hora do slide. |
| void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) override | Define o texto para o marcador de rodapé do slide. |
| void [SetFooterVisibility](./setfootervisibility/)(**bool**) override | Altera a visibilidade do marcador de rodapé do slide. |
| void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) override | Altera a visibilidade do marcador de número de página do slide. |
