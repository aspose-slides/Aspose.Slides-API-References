...
| Método | Descrição |
| --- | --- |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::String](../../system/string/)) | Adiciona uma(s) nova(s) fonte(s) à lista de fontes FallBack. |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Adiciona novas fontes à lista de fontes FallBack. |
| virtual void [Clear](./clear/)() | Remove todas as fontes da lista. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Obtém o número de fontes realmente definidas para o intervalo. |
| virtual **uint32_t** [get_RangeEndIndex](./get_rangeendindex/)() | Obtém o último índice do intervalo Unicode contínuo. |
| virtual **uint32_t** [get_RangeStartIndex](./get_rangestartindex/)() | Obtém o primeiro índice do intervalo Unicode contínuo. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógico do método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite o hashing de objetos personalizados. |
...
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)(**int32_t**) | Obtém o nome da fonte no índice especificado. |
| virtual **int32_t** [IndexOf](./indexof/)([System::String](../../system/string/)) | Retorna um índice da regra especificada na coleção. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Remove a primeira ocorrência de uma fonte FallBack específica da lista. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove a fonte FallBack no índice especificado da lista. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)() | Cria e retorna um array com todas as fontes FallBack para esta regra. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)(**int32_t**, **int32_t**) | Cria e retorna um array com todas as fontes FallBack do intervalo especificado na lista. |
