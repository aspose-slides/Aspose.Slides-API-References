...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_ActiveXControlBinary](./get_activexcontrolbinary/)() override | Especifica a persistência de um controle ActiveX quando o método usado para persistir é PersistStream, PersistStreamInit ou PersistStorage. |
| [System::Guid](../../system/guid/) [get_ClassId](./get_classid/)() override | Obtém o ID da classe deste controle. Somente leitura [System::Guid](../../system/guid/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\> [get_Frame](./get_frame/)() override | Retorna o quadro do controle. Leitura [IShapeFrame](../ishapeframe/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Obtém o nome deste controle. Leitura [System::String](../../system/string/). |
| [PersistenceType](../persistencetype/) [get_Persistence](./get_persistence/)() override | Obtém o método usado para armazenar propriedades do controle ActiveX. Somente leitura [PersistenceType](../persistencetype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IControlPropertiesCollection](../icontrolpropertiescollection/)\> [get_Properties](./get_properties/)() override | Retorna uma coleção de propriedades ActiveX. |
| [System::String](../../system/string/) [get_Property](./get_property/)([System::String](../../system/string/)) override | Retorna uma propriedade ActiveX no índice especificado. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_SubstitutePictureFormat](./get_substitutepictureformat/)() override | Retorna o objeto de propriedades de preenchimento de imagem [Control](./). Somente leitura [IPictureFillFormat](../ipicturefillformat/). |
...
| void [set_ClassId](./set_classid/)([System::Guid](../../system/guid/)) | Obtém o ID da classe deste controle. Somente leitura [System::Guid](../../system/guid/). |
| void [set_Frame](./set_frame/)([System::SharedPtr](../../system/sharedptr/)\<[IShapeFrame](../ishapeframe/)\>) override | Define o quadro do controle. Grava [IShapeFrame](../ishapeframe/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Define o nome deste controle. Grava [System::String](../../system/string/). |
| void [set_Property](./set_property/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Define uma propriedade ActiveX no índice especificado. |
