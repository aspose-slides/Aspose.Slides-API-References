...
description: Interface auxiliar de coleção genérica.
type: docs
weight: 2328
url: /pt/aspose.slides/igenericcollection/
---
## IGenericCollection classe

Interface auxiliar de coleção genérica.
...
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Copia todos os elementos da coleção para a matriz especificada. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtém o iterador apontando imediatamente após o último elemento (se houver) da instância da coleção qualificada como const. |
...
| virtual **bool** [get_IsSynchronized](./get_issynchronized/)() | Retorna um valor que indica se o acesso à coleção é sincronizado (thread-safe). Somente leitura **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() | Retorna a raiz de sincronização. Somente leitura [System::Object](../../system/object/). |
