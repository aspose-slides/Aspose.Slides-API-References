...
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) override | Retorna a parte XML personalizada no índice especificado. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() override | Retorna a coleção de partes XML personalizadas. Somente leitura [ICustomXmlPartCollection](../icustomxmlpartcollection/). |
| [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) override | Retorna a Tag de Dados do Cliente especificada no índice. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() override | Retorna a coleção de Tags de Dados do Cliente. Somente leitura [ITagCollection](../itagcollection/). |
...
| void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Define a Tag de Dados do Cliente especificada no índice. |
...
* Classe [ICustomData](../icustomdata/)
