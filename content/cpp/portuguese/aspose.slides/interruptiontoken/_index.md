...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Retorna **bool**.true se a interrupção foi solicitada. |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | Representa um token de interrupção vazio. |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | Lança um  se a interrupção foi solicitada. |
