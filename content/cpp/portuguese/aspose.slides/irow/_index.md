...
| virtual **double** [get_Height](./get_height/)() | Retorna a altura de uma linha. Somente leitura **double**. |
...
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Retorna a altura mínima possível de uma linha. Somente leitura **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | Retorna o objeto [RowFormat](../rowformat/) que contém as propriedades de formatação desta linha. Somente leitura [IRowFormat](../irowformat/). |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Define a altura mínima possível de uma linha. Grave **double**. |
