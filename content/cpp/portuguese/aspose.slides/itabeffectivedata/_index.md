...
description: Objeto imutável que contém as propriedades de parada de tabulação do texto efetivo.
type: docs
weight: 3992
url: /pt/aspose.slides/itabeffectivedata/
---
## ITabEffectiveData classe
...
| Método | Descrição |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | Compara o objeto atual com o objeto especificado. |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Retorna o estilo de alinhamento de uma tabulação. Somente leitura [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Retorna a posição de uma tabulação. Atribuir esta propriedade pode mudar o índice da tabulação na coleção e invalidar o Enumerador. Somente leitura **double**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o enésimo argumento de modelo como um ponteiro fraco (em vez de compartilhado). Permite trocar ponteiros em contêineres para modo fraco. |
