...
description: Objeto imutável que contém propriedades de câmera efetivas.
type: docs
weight: 1600
...
Objeto imutável que contém propriedades de câmera efetivas.
...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) tipo. Somente leitura [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 deg, campo de Visão). Somente leitura **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) zoom (valor positivo em porcentagem). Somente leitura **float**. |
