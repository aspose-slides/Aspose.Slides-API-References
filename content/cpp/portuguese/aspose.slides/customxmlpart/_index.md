...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Para uso interno somente. |
| [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() override | Especifica um identificador globalmente único (GUID) que identifica de forma única uma única parte XML personalizada dentro de um documento Office Open XML. Somente leitura [System::Guid](../../system/guid/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() override | Retorna os esquemas XML da coleção que estão associados à parte XML personalizada. Somente leitura [System::String](../../system/string/)[]. |
| [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() override | Retorna os dados XML como string UTF-8. Leitura [System::String](../../system/string/). |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() override | Retorna os dados XML. Leitura **uint8_t**[]. |
...
| void [Remove](./remove/)() override | Remove a parte XML personalizada da apresentação. |
...
| void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) override | Especifica um identificador globalmente único (GUID) que identifica de forma única uma única parte XML personalizada dentro de um documento Office Open XML. Somente leitura [System::Guid](../../system/guid/). |
| void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) override | Define os dados XML como string UTF-8. Grava [System::String](../../system/string/). |
| void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Define os dados XML. Grava **uint8_t**[]. |
