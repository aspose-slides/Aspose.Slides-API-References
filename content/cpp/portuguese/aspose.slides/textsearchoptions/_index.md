...
Representa opções que podem ser usadas para pesquisar texto em um [Presentation](../presentation/), [Slide](../slide/) ou [TextFrame](../textframe/).
...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Defina true para usar pesquisa sensível a maiúsculas/minúsculas, false - caso contrário. Leia **bool**. |
| **bool** [get_IncludeNotes](./get_includenotes/)() override | Defina **true** para incluir texto contido nas notas do slide ([NotesSlide](../notesslide/)) ao executar pesquisa de texto, substituição ou realce. O valor padrão é **false**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Defina true para corresponder apenas palavras inteiras, false - caso contrário. Leia **bool**. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Defina true para usar pesquisa sensível a maiúsculas/minúsculas, false - caso contrário. Escreva **bool**. |
| void [set_IncludeNotes](./set_includenotes/)(**bool**) override | Defina **true** para incluir texto contido nas notas do slide ([NotesSlide](../notesslide/)) ao executar pesquisa de texto, substituição ou realce. O valor padrão é **false**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Defina true para corresponder apenas palavras inteiras, false - caso contrário. Escreva **bool**. |
