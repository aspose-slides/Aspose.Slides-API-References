...
Representa um objeto Summary Zoom [Section](../section/) em um quadro Summary Zoom.
...
| [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../shape/get_blackwhitemode/)() override | A propriedade especifica como uma forma será renderizada no modo de exibição preto-e-branco. Consulte [Slides::BlackWhiteMode](../blackwhitemode/). |
...
| [System::String](../../system/string/) [get_Description](./get_description/)() override | Retorna a descrição de texto do objeto Summary Zoom [Section](../section/). |
...
| [ZoomImageType](../zoomimagetype/) [get_ImageType](../zoomobject/get_imagetype/)() override | Obtém o tipo de imagem de um objeto zoom. Consulte [ZoomImageType](../zoomimagetype/). Valor padrão: Preview |
...
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | Retorna um identificador exclusivo com escopo de slide que permanece constante durante a vida útil da forma e permite que o PowerPoint ou código interoperável referenciem a forma de forma confiável a partir de qualquer ponto do documento. Somente leitura **uint32_t**. Veja também [Shape::get_UniqueId](../shape/get_uniqueid/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](../shape/get_presentation/)() override | Retorna a apresentação principal de um slide. Somente leitura [IPresentation](../ipresentation/). |
...
| **bool** [get_ReturnToParent](../zoomobject/get_returntoparent/)() override | Obtém o comportamento de navegação na apresentação de slides. Leia **bool**. Valor padrão: false |
| **float** [get_Rotation](../shape/get_rotation/)() override | Retorna o número de graus que a forma especificada está girada em torno do eixo Z. Um valor positivo indica rotação no sentido horário; um valor negativo indica rotação no sentido anti-horário. Leia **float**. |
...
| **bool** [get_ShowBackground](../zoomobject/get_showbackground/)() override | Obtém o valor que especifica se o Zoom usará o plano de fundo do slide de destino. Leia **bool**. Valor padrão: true |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](../sectionzoomframe/get_targetsection/)() override | Obtém o objeto de seção ao qual o objeto Zoom [Section](../section/) está vinculado. Consulte [ISection](../isection/). |
...
| [System::String](../../system/string/) [get_Title](./get_title/)() override | Retorna o título de texto do objeto Summary Zoom [Section](../section/). |
| **float** [get_TransitionDuration](../zoomobject/get_transitionduration/)() override | Obtém a duração da transição entre Zoom e slide. Leia **float**. Valor padrão: 1.0f |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](../zoomobject/get_zoomimage/)() override | Obtém imagem para o objeto zoom. Consulte [IPPImage](../ippimage/). |
| **int32_t** [get_ZOrderPosition](../shape/get_zorderposition/)() override | Retorna a posição de uma forma na ordem Z. Shapes[0] retorna a forma mais atrás na ordem Z, e Shapes[Shapes.Count - 1] retorna a forma mais à frente na ordem Z. Somente leitura **int32_t**. |
...
| void [set_BlackWhiteMode](../shape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) override | A propriedade especifica como a forma será renderizada no modo preto-e-branco. Escreva [Slides::BlackWhiteMode](../blackwhitemode/). |
| void [set_Description](./set_description/)([System::String](../../system/string/)) override | Retorna a descrição de texto do objeto Summary Zoom [Section](../section/). |
...
| void [set_ImageType](../zoomobject/set_imagetype/)([ZoomImageType](../zoomimagetype/)) override | Define o tipo de imagem de um objeto zoom. Escreva [ZoomImageType](../zoomimagetype/). Valor padrão: Preview |
| void [set_IsDecorative](../shape/set_isdecorative/)(**bool**) override | Define a opção 'Marcar como decorativo' Leitura/gravação **bool**. |
| void [set_Name](../shape/set_name/)([System::String](../../system/string/)) override | Define o nome de uma forma. Não deve ser nulo. Use string vazia se necessário. Escreva [System::String](../../system/string/). |
...
| void [set_ReturnToParent](../zoomobject/set_returntoparent/)(**bool**) override | Define o comportamento de navegação na apresentação de slides. Escreva **bool**. Valor padrão: false |
| void [set_Rotation](../shape/set_rotation/)(**float**) override | Define o número de graus que a forma especificada está girada em torno do eixo Z. Um valor positivo indica rotação no sentido horário; um valor negativo indica rotação no sentido anti-horário. Escreva **float**. |
| void [set_ShowBackground](../zoomobject/set_showbackground/)(**bool**) override | Define o valor que especifica se o Zoom usará o plano de fundo do slide de destino. Escreva **bool**. Valor padrão: true |
| void [set_TargetSection](../sectionzoomframe/set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Define o objeto de seção ao qual o objeto Zoom [Section](../section/) está vinculado. Escreva [ISection](../isection/). |
| void [set_Title](./set_title/)([System::String](../../system/string/)) override | Retorna o título de texto do objeto Summary Zoom [Section](../section/). |
| void [set_TransitionDuration](../zoomobject/set_transitionduration/)(**float**) override | Define a duração da transição entre Zoom e slide. Escreva **float**. Valor padrão: 1.0f |
...
| void [set_ZoomImage](../zoomobject/set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) override | Define a imagem para o objeto zoom. Escreva [IPPImage](../ippimage/). |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Obtém o valor corrente do contador de referência compartilhada. |
