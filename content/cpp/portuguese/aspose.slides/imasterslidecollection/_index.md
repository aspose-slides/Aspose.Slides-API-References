...
| Método | Descrição |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Adiciona uma cópia de um slide mestre especificado ao final da coleção. Slides de layout vinculados também serão copiados. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógia do método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hash de objetos personalizados. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [idx_get](./idx_get/)(**int32_t**) | Obtém o elemento no índice especificado. Somente leitura [IMasterSlide](../imasterslide/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Insere uma cópia de um slide mestre especificado na posição especificada da coleção. Slides de layout vinculados também serão copiados. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const&) | Construtor de cópia. Não copia nada, realmente, apenas inicializa um novo objeto e habilita a construção de cópias de subclasses. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const&) | Operador de atribuição. Não copia nada, realmente, apenas inicializa um novo objeto e habilita a construção de cópias de subclasses. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Remove a primeira ocorrência de um objeto específico da coleção. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove o elemento no índice especificado da coleção. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminui o contador de referência compartilhada pelo valor especificado. |
| virtual void [RemoveUnused](./removeunused/)(**bool**) | Remove slides mestres não utilizados. |
