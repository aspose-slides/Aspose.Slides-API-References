...
| **bool** [get_IsDecorative](../shape/get_isdecorative/)() override | Obtém a opção 'Marcar como decorativo' Leitura/escrita **bool**. |
...
| **uint32_t** [get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/)() override | Retorna um identificador único com escopo de slide que permanece constante durante a vida da forma e permite que o PowerPoint ou código de interop façam referência confiável à forma de qualquer lugar do documento. Somente leitura **uint32_t**. Veja também [Shape::get_UniqueId](../shape/get_uniqueid/). |
...
| **bool** [get_ShowBackground](../zoomobject/get_showbackground/)() override | Obtém o valor que especifica se o Zoom usará o plano de fundo do slide de destino. Somente leitura **bool**. Valor padrão: true |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\> [get_TargetSection](./get_targetsection/)() override | Obtém o objeto de seção ao qual o objeto Zoom [Section](../section/) está vinculado. Leia [ISection](../isection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../ithreedformat/)\> [get_ThreeDFormat](../shape/get_threedformat/)() override | Retorna o objeto [ThreeDFormat](../threedformat/) que contém propriedades de efeito 3D para uma forma. Observação: pode retornar nulo para certos tipos de forma que não possuam propriedades 3D. Somente leitura [IThreeDFormat](../ithreedformat/). |
...
| **uint32_t** [get_UniqueId](../shape/get_uniqueid/)() override | Retorna um identificador interno com escopo de apresentação destinado ao uso por add-ins ou outro código. Como esse valor pode ser reatribuído pelo usuário ou programaticamente, não deve ser tratado como uma chave única persistente. Somente leitura **uint32_t**. Veja também [Shape::get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/). |
...
| void [set_IsDecorative](../shape/set_isdecorative/)(**bool**) override | Define a opção 'Marcar como decorativo' Leitura/escrita **bool**. |
...
| void [set_TargetSection](./set_targetsection/)([System::SharedPtr](../../system/sharedptr/)\<[ISection](../isection/)\>) override | Define o objeto de seção ao qual o objeto Zoom [Section](../section/) está vinculado. Escreva [ISection](../isection/). |
