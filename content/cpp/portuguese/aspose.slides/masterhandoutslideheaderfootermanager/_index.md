...
description: Representa o gerenciador que contém o comportamento dos marcadores de posição de slide mestre de anotações, incluindo o marcador de posição de cabeçalho.
type: docs
weight: 4421
...
Representa o gerenciador que contém o comportamento dos marcadores de posição de slide mestre de anotações, incluindo o marcador de posição de cabeçalho.
...
| **bool** [get_IsDateTimeVisible](../baseslideheaderfootermanager/get_isdatetimevisible/)() override | Obtém valor indicando que um placeholder de data/hora está presente. Leitura**bool**. |
| **bool** [get_IsFooterVisible](../baseslideheaderfootermanager/get_isfootervisible/)() override | Obtém valor indicando que um placeholder de rodapé está presente. Leitura **bool**. |
| **bool** [get_IsHeaderVisible](../basehandoutnotesslideheaderfootermanager/get_isheadervisible/)() override | Obtém valor indicando que um placeholder de cabeçalho está presente. Leitura **bool**. |
| **bool** [get_IsSlideNumberVisible](../baseslideheaderfootermanager/get_isslidenumbervisible/)() override | Obtém valor indicando que um placeholder de número de página está presente. Leitura**bool**. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analítico do método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite clonagem de tipos personalizados. |
...
| void [SetDateTimeText](../baseslideheaderfootermanager/setdatetimetext/)([System::String](../../system/string/)) override | Define texto para o placeholder de data/hora do slide. |
...
| void [SetFooterText](../baseslideheaderfootermanager/setfootertext/)([System::String](../../system/string/)) override | Define texto para o placeholder de rodapé do slide. |
...
| void [SetHeaderText](../basehandoutnotesslideheaderfootermanager/setheadertext/)([System::String](../../system/string/)) override | Define texto para o placeholder de cabeçalho do slide. |
