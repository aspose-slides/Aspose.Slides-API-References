...
description: Objeto imutável que contém propriedades efetivas de preenchimento gradiente.
type: docs
weight: 2393
...
Objeto imutável que contém propriedades efetivas de preenchimento gradiente.
...
| virtual [Aspose::Slides::GradientDirection](../gradientdirection/) [get_GradientDirection](./get_gradientdirection/)() | Retorna o estilo de um gradiente. Somente leitura [Slides::GradientDirection](../gradientdirection/). |
| virtual [Aspose::Slides::GradientShape](../gradientshape/) [get_GradientShape](./get_gradientshape/)() | Retorna a forma de um gradiente. Somente leitura [Slides::GradientShape](../gradientshape/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopEffectiveData](../igradientstopeffectivedata/)\> [get_GradientStop](./get_gradientstop/)(**int32_t**) | Retorna um ponto de gradiente no índice especificado. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/)\> [get_GradientStops](./get_gradientstops/)() | Retorna a coleção de pontos de gradiente. Somente leitura [IGradientStopCollectionEffectiveData](../igradientstopcollectioneffectivedata/). |
| virtual **float** [get_LinearGradientAngle](./get_lineargradientangle/)() | Retorna o ângulo de um gradiente. Somente leitura **float**. |
| virtual **bool** [get_LinearGradientScaled](./get_lineargradientscaled/)() | Determina se um gradiente está escalado. Somente leitura **bool**. |
| virtual [Aspose::Slides::TileFlip](../tileflip/) [get_TileFlip](./get_tileflip/)() | Retorna o modo de inversão para um gradiente. Somente leitura [Slides::TileFlip](../tileflip/). |
