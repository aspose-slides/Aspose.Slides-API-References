...
| Método | Descrição |
| --- | --- |
| virtual void [AddField](./addfield/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) | Converte esta porção para o campo automaticamente atualizado. |
| virtual void [AddField](./addfield/)([System::String](../../system/string/)) | Converte esta porção para o campo automaticamente atualizado. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IField](../ifield/)\> [get_Field](./get_field/)() | Retorna um campo desta porção. Somente leitura [IField](../ifield/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_PortionFormat](./get_portionformat/)() | Retorna o objeto de formatação que contém as propriedades de formatação explicitamente definidas da porção de texto sem herança aplicada. Somente leitura [IPortionFormat](../iportionformat/). |
...
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Obtém o texto simples de uma porção. Leia [System::String](../../system/string/). |
| virtual [System::Drawing::PointF](../../system.drawing/pointf/) [GetCoordinates](./getcoordinates/)() | Obtém as coordenadas do início da porção. A coordenada X do ponto representa o início da porção a partir do primeiro caractere, incluindo a margem esquerda. A coordenada Y inclui a margem superior. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hash de objetos personalizados. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() | Obtém as coordenadas do retângulo que delimita a porção. O retângulo inclui todas as linhas de texto na porção, incluindo as vazias. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Construtor de cópia. Na realidade não copia nada, apenas inicializa um novo objeto e permite a cópia ao construir subclasses. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de atribuição. Na realidade não copia nada, apenas inicializa um novo objeto e permite a cópia ao construir subclasses. |
...
| virtual void [RemoveField](./removefield/)() | Converte esta porção de campo para a porção simples. |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | Define o texto simples de uma porção. Escreva [System::String](../../system/string/). |
