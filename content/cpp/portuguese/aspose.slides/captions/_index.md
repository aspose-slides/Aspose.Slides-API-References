...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Returns the binary data of the closed captions. Somente leitura **uint8_t**[]. |
| [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() override | Returns the globally unique identifier (GUID) of the closed captions. Somente leitura [System::Guid](../../system/guid/). |
| [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() override | Returns the closed captions data as UTF-8 encoded string Somente leitura [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Label](./get_label/)() override | Returns the label of the closed captions. Somente leitura [System::String](../../system/string/). |
...
| void [set_Label](./set_label/)([System::String](../../system/string/)) override | Define o rótulo das legendas fechadas. Escrita [System::String](../../system/string/). |
