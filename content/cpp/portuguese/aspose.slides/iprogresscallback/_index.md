...
description: Representa um objeto de callback para atualizações de progresso de salvamento em porcentagem.
type: docs
weight: 3446
url: /pt/aspose.slides/iprogresscallback/
---
## IProgressCallback classe

Representa um objeto de callback para atualizações de progresso de salvamento em porcentagem.
...
| virtual void [Reporting](./reporting/)(**double**) | Relata uma atualização de progresso. |
