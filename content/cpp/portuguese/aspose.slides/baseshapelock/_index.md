...
description: Representa uma classe base para travas (operação desativada).
type: docs
weight: 157
...
| **bool** [get_NoLocks](./get_nolocks/)() override | Retorna true se todas as flags de bloqueio estiverem desativadas. **bool** somente leitura. |
