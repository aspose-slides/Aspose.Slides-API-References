...
| **uint32_t** [get_Index](./get_index/)() override | Obtém o índice de um placeholder. Somente leitura **uint32_t**. |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Obtém a orientação de um placeholder. Somente leitura [Slides::Orientation](../orientation/). |
| [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() override | Obtém o tamanho de um placeholder. Somente leitura [PlaceholderSize](../placeholdersize/). |
| [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() override | Obtém o tipo de um placeholder. Somente leitura [PlaceholderType](../placeholdertype/). |
