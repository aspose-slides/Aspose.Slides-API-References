...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() | Retorna os dados do arquivo do objeto OLE incorporado Somente leitura **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() | Retorna a extensão de arquivo do objeto OLE incorporado atual Somente leitura [System::String](../../system/string/). |
