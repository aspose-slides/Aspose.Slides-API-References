...
| Método | Descrição |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) | Adiciona uma nova operação ao final da coleção. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) | Adiciona uma nova operação ao final da coleção. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Obtém o iterador apontando para o primeiro elemento (se existir) da coleção. Esse iterador não pode ser usado para alterar um objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) retorna um objeto cópia de T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtém o iterador apontando para o primeiro elemento (se existir) da instância qualificada como const da coleção. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Obtém o iterador apontando para o primeiro elemento qualificado como const (se existir) da coleção. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Obtém o iterador apontando logo após o último elemento qualificado como const (se existir) da coleção. |
| virtual void [Clear](./clear/)() | Remove todas as operações de cor. |
...
| virtual T [CloneT](../igenericcloneable/clonet/)() | Cria um novo objeto que é uma cópia da instância atual. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Obtém o iterador apontando logo após o último elemento (se existir) da coleção. Esse iterador não pode ser usado para alterar um objeto referenciado porque [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) retorna um objeto cópia de T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtém o iterador apontando logo após o último elemento (se existir) da instância qualificada como const da coleção. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Retorna um valor que indica se o acesso à coleção está sincronizado (thread-safe). Somente leitura **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) | Retorna a operação no índice especificado. Leitura [IColorOperation](../icoloroperation/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) | Define a operação no índice especificado. Escrita [IColorOperation](../icoloroperation/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) | Insere a nova operação em uma coleção. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) | Insere a nova operação em uma coleção. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Remove a operação de cor de uma coleção. |
