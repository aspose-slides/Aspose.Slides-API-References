...
description: Representa uma coleção de paradas de degradê.
type: docs
weight: 1132
...
Representa uma coleção de paradas de degradê.
...
| Método | Descrição |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [System::Drawing::Color](../../system.drawing/color/)) override | Cria a nova parada de degradê e a adiciona ao final da coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [PresetColor](../presetcolor/)) override | Cria a nova parada de degradê e a adiciona ao final da coleção. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [Add](./add/)(**float**, [SchemeColor](../schemecolor/)) override | Cria a nova parada de degradê e a adiciona ao final da coleção. |
...
| void [Clear](./clear/)() override | Remove todas as paradas de degradê de uma coleção. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>, **int32_t**) override | Copia todos os elementos da coleção para a matriz especificada. |
...
| **int32_t** [get_Count](./get_count/)() override | Retorna o número de paradas de degradê em uma coleção. Somente leitura **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera através da coleção. |
| **int32_t** [GetHashCode](../pviobject/gethashcode/)() const override | Retorna o código hash. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientStop](../igradientstop/)\> [idx_get](./idx_get/)(**int32_t**) override | Retorna a parada de degradê por índice. |
| void [Insert](./insert/)(**int32_t**, **float**, [System::Drawing::Color](../../system.drawing/color/)) override | Cria a nova parada de degradê e a insere no índice especificado da coleção. |
| void [Insert](./insert/)(**int32_t**, **float**, [PresetColor](../presetcolor/)) override | Cria a nova parada de degradê e a insere no índice especificado da coleção. |
| void [Insert](./insert/)(**int32_t**, **float**, [SchemeColor](../schemecolor/)) override | Cria a nova parada de degradê e a insere no índice especificado da coleção. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Determina se algum elemento de uma sequência existe ou atende a uma condição. |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Retorna o elemento no índice especificado em uma sequência. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Retorna o elemento no índice especificado em uma sequência. |
...
| void [Lock](../../system/object/lock/)() | Implementa a declaração C# lock() bloqueando. Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Remove uma parada de degradê no índice especificado. |
...
| void [Unlock](../../system/object/unlock/)() | Implementa a declaração C# lock() desbloqueando. Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
...
* Classe [IGradientStopCollection](../igradientstopcollection/)
