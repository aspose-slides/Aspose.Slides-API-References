...
| virtual [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() | Obtém a orientação do slide. |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Obtém as dimensões do slide em pontos. Atribuir um novo valor redefine o valor [ISlideSize::get_Type](./get_type/) para [SlideSizeType::Custom](../slidesizetype/) e define [ISlideSize::get_Orientation](./get_orientation/). |
| virtual [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() | Obtém o tipo de tamanho do slide. Atribuir qualquer valor exceto [SlideSizeType::Custom](../slidesizetype/) ajusta o [ISlideSize::get_Size](./get_size/) de acordo com as dimensões predefinidas, mantendo o [ISlideSize::get_Orientation](./get_orientation/) atual. |
...
| virtual void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) | Define a orientação do slide. |
| virtual void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) | Define o tamanho do slide por tipo e escala o conteúdo existente. Atribuir qualquer valor diferente de [SlideSizeType::Custom](../slidesizetype/) ajusta o [ISlideSize::get_Size](./get_size/) com base no tipo selecionado, preservando [ISlideSize::get_Orientation](./get_orientation/). |
| virtual void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) | Define explicitamente as dimensões do slide e escala o conteúdo existente. Isso redefine o valor [ISlideSize::get_Type](./get_type/) para [SlideSizeType::Custom](../slidesizetype/) e define [ISlideSize::get_Orientation](./get_orientation/). |
