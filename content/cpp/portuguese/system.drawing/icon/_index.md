...
| **int32_t** [get_Height](./get_height/)() const | Retorna a altura do ícone. |
| **int32_t** [get_Width](./get_width/)() const | Retorna a largura do ícone. |
...
|  [Icon](./icon/)(const [String](../../system/string/)\&) | Constrói uma nova instância da classe [Icon](./) que representa um ícone a partir do arquivo especificado. |
...
| [SharedPtr](../../system/sharedptr/)\<[Bitmap](../bitmap/)\> [ToBitmap](./tobitmap/)() | Converte o objeto atual para um objeto [Bitmap](../bitmap/). |
