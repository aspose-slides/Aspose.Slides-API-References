...
description: "Contém informações usadas pela aplicação para conectar ao serviço. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 118
url: /pt/system.net/dnsendpoint/
---
## DnsEndPoint classe

Contém informações usadas pela aplicação para conectar ao serviço. Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| Método | Descrição |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[EndPoint](../endpoint/)\> [Create](../endpoint/create/)([System::SharedPtr](../../system/sharedptr/)\<[SocketAddress](../socketaddress/)\>) | Cria uma nova instância da classe [EndPoint](../endpoint/) usando o endereço de socket especificado. |
|  [DnsEndPoint](./dnsendpoint/)([String](../../system/string/), **int32_t**) | Constrói uma nova instância. |
|  [DnsEndPoint](./dnsendpoint/)([String](../../system/string/), **int32_t**, [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/)) | Constrói uma nova instância. |
...
| [String](../../system/string/) [get_Host](./get_host/)() | Retorna um nome de host. |
| **int32_t** [get_Port](./get_port/)() | Retorna o número da porta. |
...
| virtual [ImplPtr](../endpoint/implptr/) [GetImpl](../endpoint/getimpl/)() const | Retorna um ponteiro para a implementação. |
