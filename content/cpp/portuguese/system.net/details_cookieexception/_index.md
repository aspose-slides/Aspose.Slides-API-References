...
description: "Representa uma exceção lançada quando o tamanho de CookieContainer é maior que o valor da propriedade MaxCookieSize. Nunca crie instâncias desta classe manualmente. Use a classe CookieException em vez disso. Nunca encapsule as instâncias da classe CookieException em System::SmartPtr."
type: docs
weight: 79
url: /pt/system.net/details_cookieexception/
---
## Details_CookieException classe

Representa uma exceção lançada quando o tamanho de [CookieContainer](../cookiecontainer/) é maior que o valor da propriedade MaxCookieSize. Nunca crie instâncias desta classe manualmente. Use a classe CookieException em vez disso. Nunca encapsule as instâncias da classe CookieException em [System::SmartPtr](../../system/smartptr/).
...
| Método | Descrição |
| --- | --- |
|  [Details_CookieException](./details_cookieexception/)() | Constrói uma nova instância. |
|  [Details_CookieException](./details_cookieexception/)(std::nullptr_t) | Constrói uma nova instância. |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/)) | Constrói uma nova instância. |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Constrói uma nova instância. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógia do método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hashing de objetos personalizados. |
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_formatexception/gettype/)() const override | Obtém o tipo real do objeto. Analogia da chamada C# [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analógia do método C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permite a clonagem de tipos personalizados. |
...
| virtual  [~Details_CookieException](./~details_cookieexception/)() | Destrói a instância atual. |
| virtual  [~Object](../../system/object/~object/)() | Destrói o objeto. Libera todas as estruturas de dados internas. |

## Veja Também

* Classe [Details_FormatException](../../system/details_formatexception/)
