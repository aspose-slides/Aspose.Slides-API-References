...
description: "Representa a resposta web HTTP. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 287
url: /pt/system.net/httpwebresponse/
---
## HttpWebResponse classe

Representa a resposta web HTTP. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| Método | Descrição |
| --- | --- |
| void [Close](./close/)() override | Fecha o fluxo de resposta. |
...
| [System::String](../../system/string/) [get_CharacterSet](./get_characterset/)() | Não implementado. |
| **int64_t** [get_ContentLength](./get_contentlength/)() override | Retorna o número de bytes do recurso. |
| [String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Retorna o tipo MIME do recurso. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[CookieCollection](../cookiecollection/)\> [get_Cookies](./get_cookies/)() | Retorna os cookies associados à resposta web. |
| [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](./get_headers/)() override | Retorna a coleção dos cabeçalhos associados à resposta atual. |
| virtual [String](../../system/string/) [get_Method](./get_method/)() | Retorna o método HTTP. |
| [System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [get_ResponseUri](./get_responseuri/)() override | Retorna o URI do recurso. |
| virtual [HttpStatusCode](../httpstatuscode/) [get_StatusCode](./get_statuscode/)() | Retorna o código de status HTTP associado à resposta web. |
| virtual [String](../../system/string/) [get_StatusDescription](./get_statusdescription/)() | Retorna a representação em string do código de status. |
| **bool** [get_SupportsHeaders](./get_supportsheaders/)() override | Retorna um valor que indica se a resposta atual suporta cabeçalhos. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referências associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hash de objetos personalizados. |
| [String](../../system/string/) [GetResponseHeader](./getresponseheader/)([String](../../system/string/)) | Retorna o valor correspondente ao nome do cabeçalho especificado. |
| [System::SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetResponseStream](./getresponsestream/)() override | Retorna o fluxo de resposta. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
|  [HttpWebResponse](./httpwebresponse/)([System::SharedPtr](../../system/sharedptr/)\<[Http::HttpResponseMessage](../../system.net.http/httpresponsemessage/)\>, [System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [System::SharedPtr](../../system/sharedptr/)\<[CookieContainer](../cookiecontainer/)\>) | Constrói uma nova instância. |
