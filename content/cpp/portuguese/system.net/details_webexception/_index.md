...
description: "Representa a exceção lançada por WebRequest quando ocorre um erro. Nunca crie instâncias desta classe manualmente. Use a classe WebException em vez disso. Nunca encapsule as instâncias da classe WebException em System::SmartPtr."
type: docs
weight: 92
url: /pt/system.net/details_webexception/
---
## Details_WebException classe


Representa a exceção lançada por [WebRequest](../webrequest/) quando ocorre um erro. Nunca crie instâncias desta classe manualmente. Use a classe WebException em vez disso. Nunca encapsule as instâncias da classe WebException em [System::SmartPtr](../../system/smartptr/).
...
| Método | Descrição |
| --- | --- |
| static [Exception](../../system/exception/) [CreateCompatibleException](./createcompatibleexception/)([Exception](../../system/exception/)) | Não está implementado. |
|  [Details_WebException](./details_webexception/)() | Constrói uma nova instância. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/)) | Constrói uma nova instância. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Constrói uma nova instância. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [WebExceptionStatus](../webexceptionstatus/)) | Constrói uma nova instância. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [Exception](../../system/exception/), [WebExceptionStatus](../webexceptionstatus/), [System::SharedPtr](../../system/sharedptr/)\<[WebResponse](../webresponse/)\>) | Constrói uma nova instância. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[WebResponse](../webresponse/)\> [get_Response](./get_response/)() | Retorna a resposta web associada à exceção atual. |
...
| [WebExceptionStatus](../webexceptionstatus/) [get_Status](./get_status/)() | Retorna o código de status. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analoga ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite a hash de objetos personalizados. |
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_invalidoperationexception/gettype/)() const override | Obtém o tipo real do objeto. Analoga à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Construtor de cópia. Na verdade não copia nada, apenas inicializa um novo objeto e permite a cópia de construção de subclasses. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operador de atribuição. Na verdade não copia nada, apenas inicializa um novo objeto e permite a cópia de construção de subclasses. |
...
| virtual  [~Details_WebException](./~details_webexception/)() | Destrói a instância atual. |
