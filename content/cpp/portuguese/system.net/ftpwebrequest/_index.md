...
description: Implementa um cliente File Transfer Protocol (FTP). Classe fictícia que possibilita vincular código traduzido com referências FtpWebRequest, mas não o executa. Não contém membros implementados corretamente.
type: docs
weight: 170
url: /pt/system.net/ftpwebrequest/
---
## FtpWebRequest classe


Implementa um cliente File Transfer Protocol (FTP). Classe fictícia que possibilita vincular código traduzido com referências [FtpWebRequest](./), mas não o executa. Não contém membros implementados corretamente.
...
| Método | Descrição |
| --- | --- |
| virtual void [Abort](../webrequest/abort/)() | Aborta a solicitação atual. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAsyncResult](../../system/iasyncresult/)\> [BeginGetRequestStream](../webrequest/begingetrequeststream/)([AsyncCallback](../../system/asynccallback/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Inicia uma operação assíncrona para obter um fluxo para gravar dados no recurso. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAsyncResult](../../system/iasyncresult/)\> [BeginGetResponse](../webrequest/begingetresponse/)([AsyncCallback](../../system/asynccallback/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Inicia uma solicitação assíncrona para o recurso. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [EndGetRequestStream](../webrequest/endgetrequeststream/)([System::SharedPtr](../../system/sharedptr/)\<[IAsyncResult](../../system/iasyncresult/)\>) | Aguarda até que a operação assíncrona especificada para obter um fluxo seja concluída. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[WebResponse](../webresponse/)\> [EndGetResponse](../webrequest/endgetresponse/)([System::SharedPtr](../../system/sharedptr/)\<[IAsyncResult](../../system/iasyncresult/)\>) | Aguarda até que a solicitação assíncrona especificada para o recurso seja concluída. |
...
| virtual [String](../../system/string/) [get_ContentType](../webrequest/get_contenttype/)() | Obtém o tipo MIME da solicitação. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](../webrequest/get_headers/)() | Obtém a coleção dos cabeçalhos HTTP. |
| virtual [String](../../system/string/) [get_Method](../webrequest/get_method/)() | Obtém o método HTTP. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [get_RequestUri](../webrequest/get_requesturi/)() | Retorna o URI da solicitação. |
| virtual **int32_t** [get_Timeout](../webrequest/get_timeout/)() | Obtém um intervalo de tempo em milissegundos após o qual a solicitação expirará. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetRequestStream](../webrequest/getrequeststream/)() | Retorna o fluxo para gravação de dados no recurso. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[WebResponse](../webresponse/)\> [GetResponse](../webrequest/getresponse/)() | Retorna a resposta web associada à solicitação web atual. |
...
| virtual void [set_ContentType](../webrequest/set_contenttype/)([String](../../system/string/)) | Define o tipo MIME da solicitação. |
...
| virtual void [set_Headers](../webrequest/set_headers/)([System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\>) | Define a coleção dos cabeçalhos HTTP. |
| virtual void [set_Method](../webrequest/set_method/)([String](../../system/string/)) | Define o método HTTP. |
