...
| Campo | Descrição |
| --- | --- |
| static [Http](./http/) | A representação em string HTTP. |
| static [Https](./https/) | A representação em string HTTPS. |
| static [SchemeDelimiter](./schemedelimiter/) | A string que representa o delimitador do esquema. |
| static [Ws](./ws/) | A representação em string WS. |
| static [Wss](./wss/) | A representação em string WSS. |
