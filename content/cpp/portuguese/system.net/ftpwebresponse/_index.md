...
| Método | Descrição |
| --- | --- |
| void [Close](./close/)() override | Não implementado. |
| void [Dispose](../webresponse/dispose/)() override | Não faz nada. |
...
| **int64_t** [get_ContentLength](./get_contentlength/)() override | Informação RTTI. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Não implementado. |
| [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](./get_headers/)() override | Não implementado. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Uri](../../system/uri/)\> [get_ResponseUri](./get_responseuri/)() override | Não implementado. |
| virtual **bool** [get_SupportsHeaders](../webresponse/get_supportsheaders/)() | Retorna um valor que indica se a resposta atual suporta cabeçalhos. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetResponseStream](./getresponsestream/)() override | Não implementado. |
...
| void [Lock](../../system/object/lock/)() | Implementa bloqueio da instrução lock() do C#. Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Implementa desbloqueio da instrução lock() do C#. Chame diretamente ou use o objeto sentinela [LockContext](../../system/lockcontext/). |
