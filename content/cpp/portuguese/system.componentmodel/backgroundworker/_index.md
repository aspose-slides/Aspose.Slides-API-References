...
description: "Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 14
url: /pt/system.componentmodel/backgroundworker/
---
...
| Método | Descrição |
| --- | --- |
|  [BackgroundWorker](./backgroundworker/)() | Informação RTTI. |
|  [Component](../component/component/)() | Informação RTTI. |
| void [Dispose](../component/dispose/)(**bool**) | Suporte ao padrão disposable; não faz nada. |
...
| **bool** [get_DesignMode](../component/get_designmode/)() | Verifica se o componente está no modo de design. |
| **bool** [get_WorkerReportsProgress](./get_workerreportsprogress/)() const | Obtém um valor que indica se [System::ComponentModel::BackgroundWorker](./) pode relatar atualizações de progresso. |
...
| void [ReportProgress](./reportprogress/)(int) | Aciona o evento **System::ComponentModel::BackgroundWorker::ProgressChanged**. |
| void [ReportProgress](./reportprogress/)(int, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Aciona o evento **System::ComponentModel::BackgroundWorker::ProgressChanged** com o objeto userState. |
| void [RunWorkerAsync](./runworkerasync/)() | Inicia a execução de uma operação em segundo plano. |
| void [RunWorkerAsync](./runworkerasync/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Inicia a execução de uma operação em segundo plano. |
| void [set_WorkerReportsProgress](./set_workerreportsprogress/)(**bool**) | Define um valor que indica se [System::ComponentModel::BackgroundWorker](./) pode relatar atualizações de progresso. |
...
|  [~BackgroundWorker](./~backgroundworker/)() | Destrutor. |
