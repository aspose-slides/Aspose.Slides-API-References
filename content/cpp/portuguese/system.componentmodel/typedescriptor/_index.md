...
type: docs
weight: 209
url: /pt/system.componentmodel/typedescriptor/
---
## TypeDescriptor classe

Classe fictícia para código que usa TypeDescriptor compilar após a tradução. Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie instâncias deste tipo na pilha ou usando o operador new, pois resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| static [System::SharedPtr](../../system/sharedptr/)\<[TypeConverter](../typeconverter/)\> [GetConverter](./getconverter/)(const [TypeInfo](../../system/typeinfo/)\&) | Informação RTTI. |
