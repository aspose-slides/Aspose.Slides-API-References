...
type: docs
weight: 183
url: /pt/system.componentmodel/runworkercompletedeventargs/
---
...
| Método | Descrição |
| --- | --- |
|  [AsyncCompletedEventArgs](../asynccompletedeventargs/asynccompletedeventargs/)() | Construtor. |
|  [AsyncCompletedEventArgs](../asynccompletedeventargs/asynccompletedeventargs/)(const [System::Exception](../../system/exception/)\&, **bool**, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Inicializa uma nova instância da classe [System.ComponentModel.AsyncCompletedEventArgs](../asynccompletedeventargs/). |
...
| **bool** [get_Cancelled](../asynccompletedeventargs/get_cancelled/)() const | Obtém um valor que indica se uma operação assíncrona foi cancelada. true se a operação em segundo plano foi cancelada; caso contrário, false. O padrão é false. |
| const [System::Exception](../../system/exception/)\& [get_Error](../asynccompletedeventargs/get_error/)() const | Obtém um valor que indica qual erro ocorreu durante uma operação assíncrona. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Result](./get_result/)() const | Obtém um valor que representa o resultado de uma operação assíncrona. |
| [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_UserState](../asynccompletedeventargs/get_userstate/)() const | Obtém o identificador exclusivo da tarefa assíncrona. Uma referência de objeto que identifica exclusivamente a tarefa assíncrona; caso contrário, null se nenhum valor foi definido. |
...
|  [RunWorkerCompletedEventArgs](./runworkercompletedeventargs/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&, const [System::Exception](../../system/exception/)\&, **bool**) | Construtor. |
