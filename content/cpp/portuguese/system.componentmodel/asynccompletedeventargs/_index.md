...
type: docs
weight: 1
url: /pt/system.componentmodel/asynccompletedeventargs/
---
## AsyncCompletedEventArgs classe


Uma instância desta classe é passada como argumento para o delegate AsyncCompletedEventHandler. Objetos desta classe devem ser alocados apenas usando a função [System::MakeObject()](../../system/makeobject/). Nunca crie uma instância desse tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre encapsule esta classe em um ponteiro [System::SmartPtr](../../system/smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
|  [AsyncCompletedEventArgs](./asynccompletedeventargs/)(const [System::Exception](../../system/exception/)\&, **bool**, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Inicializa uma nova instância da classe [System.ComponentModel.AsyncCompletedEventArgs](./). |
...
| **bool** [get_Cancelled](./get_cancelled/)() const | Obtém um valor que indica se uma operação assíncrona foi cancelada. true se a operação em segundo plano foi cancelada; caso contrário, false. O padrão é false. |
| const [System::Exception](../../system/exception/)\& [get_Error](./get_error/)() const | Obtém um valor que indica qual erro ocorreu durante uma operação assíncrona. |
| [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_UserState](./get_userstate/)() const | Obtém o identificador exclusivo da tarefa assíncrona. Uma referência de objeto que identifica de forma única a tarefa assíncrona; caso contrário, null se nenhum valor foi definido. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtém a estrutura de dados do contador de referência associada ao objeto. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analógico ao método [Object.GetHashCode()](../../system/object/gethashcode/) do C#. Permite a geração de hash de objetos personalizados. |
