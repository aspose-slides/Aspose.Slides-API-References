...
Representa uma coleção de [SmartArt](../smartart/) formas
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtShape](../ismartartshape/)\> [idx_get](./idx_get/)(**int32_t**) | Obtém o elemento no índice especificado. [ISmartArtShape](../ismartartshape/) somente leitura. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Retorna o primeiro elemento da sequência que satisfaça uma condição ou um valor padrão se nenhum tal elemento for encontrado. |
