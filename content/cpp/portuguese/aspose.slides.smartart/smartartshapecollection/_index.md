...
Representa uma coleção de [SmartArt](../smartart/) shapes
...
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtém o iterador que aponta para o primeiro elemento (se houver) da instância const da coleção. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtém o iterador que aponta para o primeiro elemento const (se houver) da coleção. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtém o iterador que aponta logo após o último elemento const (se houver) da coleção. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISmartArtShape](../ismartartshape/)\>\>, **int32_t**) override | Copia todos os elementos da coleção para o array especificado. |
| [iterator](./iterator/) [end](./end/)() | Obtém o iterador que aponta logo após o último elemento (se houver) da coleção. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtém o iterador que aponta logo após o último elemento (se houver) da instância const da coleção. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISmartArtShape](../ismartartshape/)\>\>\> [GetEnumerator](./getenumerator/)() override | Retorna um enumerador que itera sobre a coleção. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../../system/object/gethashcode/). Permite hash de objetos personalizados. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtém o tipo real do objeto. Análogo à chamada C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtShape](../ismartartshape/)\> [idx_get](./idx_get/)(**int32_t**) override | Obtém o elemento no índice especificado. Somente leitura [SmartArtShape](../smartartshape/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de modelo como weak pointer (em vez de shared). Permite mudar ponteiros em contêineres para modo weak. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtém o iterador que aponta para o primeiro elemento (se houver) da instância const da coleção. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtém o iterador que aponta logo após o último elemento (se houver) da instância const da coleção. |
