...
| Method | Description |
| --- | --- |
|  [AsyncCompletedEventArgs](../../system.componentmodel/asynccompletedeventargs/asynccompletedeventargs/)() | Construtor. |
|  [AsyncCompletedEventArgs](../../system.componentmodel/asynccompletedeventargs/asynccompletedeventargs/)(const [System::Exception](../../system/exception/)\&, **bool**, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Inicializa uma nova instância da classe [System.ComponentModel.AsyncCompletedEventArgs](../../system.componentmodel/asynccompletedeventargs/). |
...
| **bool** [get_Cancelled](../../system.componentmodel/asynccompletedeventargs/get_cancelled/)() const | Obtém um valor indicando se uma operação assíncrona foi cancelada. true se a operação em segundo plano foi cancelada; caso contrário, false. O padrão é false. |
| const [System::Exception](../../system/exception/)\& [get_Error](../../system.componentmodel/asynccompletedeventargs/get_error/)() const | Obtém um valor indicando qual erro ocorreu durante uma operação assíncrona. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\> [get_Results](./get_results/)() | Retorna uma coleção de resultados de operações assíncronas. |
| [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_UserState](../../system.componentmodel/asynccompletedeventargs/get_userstate/)() const | Obtém o identificador exclusivo da tarefa assíncrona. Uma referência de objeto que identifica exclusivamente a tarefa assíncrona; caso contrário, null se nenhum valor foi definido. |
...
|  [InvokeCompletedEventArgs](./invokecompletedeventargs/)([Exception](../../system/exception/), **bool**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>) | Constrói uma nova instância. |
...
| Campo | Descrição |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Um membro estático que representa um ponteiro compartilhado \"empty\" [EventArgs](../../system/eventargs/) (ponteiro nulo). |
