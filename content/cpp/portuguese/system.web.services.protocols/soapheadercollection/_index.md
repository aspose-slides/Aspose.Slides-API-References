...
description: Contém uma coleção de instâncias da classe SoapHeader.
type: docs
weight: 105
url: /pt/system.web.services.protocols/soapheadercollection/
---
...
| Method | Description |
| --- | --- |
| void [_add_range](../../system.collections.generic/list/_add_range/)(std::initializer_list\<T\>) | Específico do C++. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | Obtém um iterador reverso para o último elemento qualificado como const da coleção (primeiro em reverso). |
...
| **bool** [Exists](../../system.collections.generic/list/exists/)([System::Predicate](../../system/predicate/)\<T\>) | Verifica se existe elemento que cumpre um predicado específico na lista. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Apenas para uso interno. |
| T [Find](../../system.collections.generic/list/find/)([System::Predicate](../../system/predicate/)\<T\>) | Procura elemento que cumpre um predicado específico. |
| [ListPtr](../../system.collections.generic/listptr/)\<T\> [FindAll](../../system.collections.generic/list/findall/)([System::Predicate](../../system/predicate/)\<T\>) | Procura elementos que cumprem um predicado específico. |
| int [FindIndex](../../system.collections.generic/list/findindex/)([System::Predicate](../../system/predicate/)\<T\>) | Procura elemento que cumpre um predicado específico. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, [System::Predicate](../../system/predicate/)\<T\>) | Procura elemento que cumpre um predicado específico. |
| int [FindIndex](../../system.collections.generic/list/findindex/)(int, int, [System::Predicate](../../system/predicate/)\<T\>) | Procura elemento que cumpre um predicado específico. |
| T [FindLast](../../system.collections.generic/list/findlast/)([System::Predicate](../../system/predicate/)\<T\>) | Procura o último elemento que cumpre um predicado específico. |
...
| **ThisPtr** [GetRange](../../system.collections.generic/list/getrange/)(int, int) | Cria um trecho da lista. |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Busca o objeto especificado e retorna o índice baseado em zero da última ocorrência dentro do intervalo de elementos no [List](../../system.collections.generic/list/) que se estende do primeiro elemento até o índice especificado. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Busca o objeto especificado e retorna o índice baseado em zero da última ocorrência dentro do intervalo de elementos no [List](../../system.collections.generic/list/) que contém o número especificado de elementos e termina no índice especificado. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Retorna o número de elementos da sequência (calculado por contagem direta). |
...
| void [RemoveRange](../../system.collections.generic/list/removerange/)(int, int) | Remove trecho da lista. |
...
| void [Reverse](../../system.collections.generic/list/reverse/)(int, int) | Inverte a ordem dos elementos do trecho da lista. |
...
|  [SoapHeaderCollection](./soapheadercollection/)() | Inicializa uma nova instância da classe [SoapHeaderCollection](./). |
...
| void [Sort](../../system.collections.generic/list/sort/)(int, int, [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>) | Ordena os elementos no trecho da lista. |
