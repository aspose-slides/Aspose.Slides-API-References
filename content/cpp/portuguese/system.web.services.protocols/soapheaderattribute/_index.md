...
| [SoapHeaderDirection](../soapheaderdirection/) [get_Direction](./get_direction/)() | Obtém a direção do cabeçalho SOAP. |
| [String](../../system/string/) [get_MemberName](./get_membername/)() | Obtém o nome de uma variável membro do serviço XML SOAP usado para receber o conteúdo do cabeçalho SOAP. |
| **bool** [get_Required](./get_required/)() | Obtém um valor que indica se o cabeçalho SOAP deve ser compreendido e processado pelo serviço XML [Web](../../system.web/) receptor ou pelo cliente de serviço XML [Web](../../system.web/). |
...
| void [set_Direction](./set_direction/)([SoapHeaderDirection](../soapheaderdirection/)) | Define a direção do cabeçalho SOAP. |
| void [set_MemberName](./set_membername/)([String](../../system/string/)) | Define o nome de uma variável membro do serviço XML SOAP usado para receber o conteúdo do cabeçalho SOAP. |
| void [set_Required](./set_required/)(**bool**) | Define um valor que indica se o cabeçalho SOAP deve ser compreendido e processado pelo serviço XML [Web](../../system.web/) receptor ou pelo cliente de serviço XML [Web](../../system.web/). |
...
|  [SoapHeaderAttribute](./soapheaderattribute/)([String](../../system/string/)) | Constrói uma nova instância. |
