...
description: Fornece um acessador para a classe XPathNavigator.
type: docs
weight: 14
url: /pt/system.xml.xpath/ixpathnavigable/
---
## IXPathNavigable classe

Fornece um acessador para a [XPathNavigator](../xpathnavigator/) classe.
...
| Método | Descrição |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() | Retorna um novo objeto [XPathNavigator](../xpathnavigator/). |
