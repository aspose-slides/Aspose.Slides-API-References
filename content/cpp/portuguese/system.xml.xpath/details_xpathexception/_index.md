...
description: Fornece a exceção lançada quando ocorre um erro ao processar uma expressão XPath.
type: docs
weight: 1
url: /pt/system.xml.xpath/details_xpathexception/
---
## Details_XPathException classe

Fornece a exceção lançada quando ocorre um erro ao processar uma [XPath](../) expressão.
...
| [String](../../system/string/) [get_Message](./get_message/)() const override | Retorna a descrição da condição de erro para esta exceção. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Obtém o tipo real do objeto. Análogo à chamada [System.Object.GetType()](../../system/object/gettype/) do C#. |
