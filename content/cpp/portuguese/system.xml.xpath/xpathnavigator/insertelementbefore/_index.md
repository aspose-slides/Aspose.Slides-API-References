...
description: Cria um novo elemento irmão antes do nó atual usando o prefixo de namespace, o nome local e o URI de namespace especificados, com o valor especificado.
type: docs
weight: 1015
url: /pt/system.xml.xpath/xpathnavigator/insertelementbefore/
---
## XPathNavigator::InsertElementBefore(String, String, String, String) método

Cria um novo elemento irmão antes do nó atual usando o prefixo de namespace, o nome local e o URI de namespace especificados, com o valor especificado.
