...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de ponto flutuante ao estilo C#, onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não seja igual a nenhum valor, inclusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de ponto flutuante ao estilo C#, onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não seja igual a nenhum valor, inclusive NaN. |
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | Somente para fins internos. |
| static [TimeZonePtr](../timezoneptr/) [get_CurrentTimeZone](./get_currenttimezone/)() | Retorna uma nova instância da classe [TimeZone](./) que representa o fuso horário atual. |
| virtual [String](../string/) [get_DaylightName](./get_daylightname/)() const | Retorna um nome para o horário de verão do fuso horário representado pelo objeto atual. |
| virtual [String](../string/) [get_StandardName](./get_standardname/)() const | Retorna um nome para o horário padrão do fuso horário representado pelo objeto atual. |
...
| virtual [Globalization::DaylightTimePtr](../../system.globalization/daylighttimeptr/) [GetDaylightChanges](./getdaylightchanges/)(**int32_t**) | Retorna o período de horário de verão para um determinado ano. |
...
| virtual [TimeSpan](../timespan/) [GetUtcOffset](./getutcoffset/)([DateTime](../datetime/)) | Retorna o deslocamento UTC para a hora local especificada. |
...
| virtual **bool** [IsDaylightSavingTime](./isdaylightsavingtime/)([DateTime](../datetime/)) | Determina se o valor de data e hora representado pelo objeto [DateTime](../datetime/) especificado está dentro do intervalo de horário de verão para o fuso horário representado pelo objeto [TimeZone](./) atual. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de modelo como ponteiro fraco (em vez de compartilhado). Permite trocar ponteiros em contêineres para modo fraco. |
...
| virtual [String](../string/) [ToString](../object/tostring/)() const | Análogo ao método C# [Object.ToString()](../object/tostring/). Permite converter objetos personalizados em string. |
