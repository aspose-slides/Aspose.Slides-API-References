...
description: "ObjectDisposedException é lançada quando um método é invocado em um objeto descartado. Nunca crie instâncias desta classe manualmente. Use a classe ObjectDisposedException em vez disso. Nunca encapsule as instâncias da classe ObjectDisposedException em System::SmartPtr."
type: docs
weight: 612
url: /pt/system/details_objectdisposedexception/
---
## Details_ObjectDisposedException classe


ObjectDisposedException é lançada quando um método é invocado em um objeto descartado. Nunca crie instâncias desta classe manualmente. Use a classe ObjectDisposedException em vez disso. Nunca encapsule as instâncias da classe ObjectDisposedException em [System::SmartPtr](../smartptr/).
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analoga ao método [Object.GetHashCode()](../object/gethashcode/) do C#. Permite hash de objetos personalizados. |
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Obtém o tipo real do objeto. Analoga à chamada [System.Object.GetType()](../object/gettype/) do C#. |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analoga ao método [Object.MemberwiseClone()](../object/memberwiseclone/) do C#. Permite clonagem de tipos personalizados. |
...
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Decremente e retorna o contador de referência compartilhada. Não deve ser chamado diretamente; em vez disso, use ponteiros inteligentes ou ThisProtector. |
...
| void [WeakRefRemoved](../object/weakrefremoved/)() | Decremente o contador de referência fraca. Não deve ser chamado diretamente; em vez disso, use ponteiros inteligentes ou ThisProtector. |
