...
description: "RankException é lançada quando um argumento de array com número de dimensões diferente do esperado é passado a um método. Nunca crie instâncias desta classe manualmente. Use a classe RankException em vez disso. Nunca encapsule as instâncias da classe RankException em System::SmartPtr."
type: docs
weight: 677
url: /pt/system/details_rankexception/
---
## Details_RankException classe

RankException é lançada quando um argumento de array com número de dimensões diferente do esperado é passado a um método. Nunca crie instâncias desta classe manualmente. Use a classe RankException em vez disso. Nunca encapsule as instâncias da classe RankException em [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não é igual a nenhum valor, incluindo NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não é igual a nenhum valor, incluindo NaN. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Obtém o tipo real do objeto. Analógico à chamada C# [System.Object.GetType()](../object/gettype/). |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analógico ao método C# [Object.MemberwiseClone()](../object/memberwiseclone/). Permite clonagem de tipos personalizados. |
