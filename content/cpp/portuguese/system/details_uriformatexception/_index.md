...
description: "UriFormatException é lançada quando o formato do URI não é válido. Nunca crie instâncias desta classe manualmente. Use a classe UriFormatException em vez disso. Nunca encapsule as instâncias da classe UriFormatException em System::SmartPtr."
type: docs
weight: 768
url: /pt/system/details_uriformatexception/
---
## Details_UriFormatException classe


UriFormatException é lançada quando o formato do URI não é válido. Nunca crie instâncias desta classe manualmente. Use a classe UriFormatException em vez disso. Nunca encapsule as instâncias da classe UriFormatException em [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emula comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais, embora segundo IEC 60559:1989 NaN não seja igual a nenhum valor, inclusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emula comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais, embora segundo IEC 60559:1989 NaN não seja igual a nenhum valor, inclusive NaN. |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Retorna uma cópia do objeto Exception que representa a exceção mais interna. |
...
| void [Lock](../object/lock/)() | Implementa a instrução C# lock() bloqueando. Chame diretamente ou use o objeto sentinela [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Construtor de cópia. Não copia nada, realmente, apenas inicializa um novo objeto e permite a construção de cópias de subclasses. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operador de atribuição. Não copia nada, realmente, apenas inicializa um novo objeto e permite a construção de cópias de subclasses. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Define o HRESULT, um valor numérico codificado atribuído a uma exceção específica. |
...
| void [Unlock](../object/unlock/)() | Implementa a instrução C# lock() desbloqueando. Chame diretamente ou use o objeto sentinela [LockContext](../lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Incrementa o contador de referências fracas. Não deve ser chamado diretamente; use ponteiros inteligentes ou ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Decrementa o contador de referências fracas. Não deve ser chamado diretamente; use ponteiros inteligentes ou ThisProtector. |
...
* Classe [Details_FormatException](../details_formatexception/)
