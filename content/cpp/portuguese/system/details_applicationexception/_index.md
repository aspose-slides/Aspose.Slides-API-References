...
description: "Uma classe base para classes que representam exceções de aplicação (e não de sistema). Nunca crie instâncias desta classe manualmente. Use a classe ApplicationException em vez disso. Nunca encapsule as instâncias da classe ApplicationException em System::SmartPtr."
type: docs
weight: 313
url: /pt/system/details_applicationexception/
---
## Details_ApplicationException classe

Uma classe base para classes que representam exceções de aplicação (e não de sistema). Nunca crie instâncias desta classe manualmente. Use a classe ApplicationException em vez disso. Nunca encapsule as instâncias da classe ApplicationException em [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emula comparação de ponto flutuante no estilo C# onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não seja igual a nenhum valor, incluindo NaN. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de modelo como um ponteiro fraco (em vez de compartilhado). Permite mudar ponteiros em containers para modo fraco. |
