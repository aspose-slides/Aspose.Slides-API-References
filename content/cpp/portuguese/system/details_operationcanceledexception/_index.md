...
description: "OperationCanceledException é lançada em uma thread quando uma operação que a thread estava executando é cancelada. Nunca crie instâncias desta classe manualmente. Use a classe OperationCanceledException em vez disso. Nunca encapsule as instâncias da classe OperationCanceledException em System::SmartPtr."
type: docs
weight: 625
url: /pt/system/details_operationcanceledexception/
---
## Details_OperationCanceledException classe


OperationCanceledException é lançada em uma thread quando uma operação que a thread estava executando é cancelada. Nunca crie instâncias desta classe manualmente. Use a classe OperationCanceledException em vez disso. Nunca encapsule as instâncias da classe OperationCanceledException em [System::SmartPtr](../smartptr/).
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../object/gethashcode/). Permite a criação de hash de objetos personalizados. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de template como um ponteiro fraco (em vez de compartilhado). Permite trocar ponteiros em contêineres para o modo fraco. |
