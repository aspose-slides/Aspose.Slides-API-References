...
description: "MemberAccessException é lançada quando se tenta acessar um método inexistente ou quando o acesso ao método não é permitido. Nunca crie instâncias desta classe manualmente. Use a classe MethodAccessException em vez disso. Nunca encapsule as instâncias da classe MethodAccessException em System::SmartPtr."
type: docs
weight: 560
url: /pt/system/details_methodaccessexception/
---
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais apesar de, segundo IEC 60559:1989, NaN não ser igual a nenhum valor, incluindo NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais apesar de, segundo IEC 60559:1989, NaN não ser igual a nenhum valor, incluindo NaN. |
