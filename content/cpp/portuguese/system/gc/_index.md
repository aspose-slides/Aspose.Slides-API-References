...
description: Representa uma coleta de lixo emulada que funciona mais como um stub que efetivamente não faz nada. Este é um tipo estático sem serviços de instância. Você nunca deve criar instâncias dele por nenhum meio.
type: docs
weight: 872
url: /pt/system/gc/
---
...
Representa uma coleta de lixo emulada que funciona mais como um stub que efetivamente não faz nada. Este é um tipo estático sem serviços de instância. Você nunca deve criar instâncias dele por nenhum meio.
...
| static **int64_t** [GetTotalAllocatedBytes](./gettotalallocatedbytes/)(**bool**) | Retorna o total de bytes alocados. |
| static **int64_t** [GetTotalMemory](./gettotalmemory/)(**bool**) | Retorna o número de bytes de memória privada atualmente alocados pelo processo atual. |
