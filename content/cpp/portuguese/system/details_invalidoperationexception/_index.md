...
description: "A exceção que é lançada quando um método é invocado em um objeto que está em um estado inconsistente com esta chamada. Nunca crie instâncias desta classe manualmente. Use a classe InvalidOperationException em vez disso. Nunca encapsule as instâncias da classe InvalidOperationException em System::SmartPtr."
type: docs
weight: 508
url: /pt/system/details_invalidoperationexception/
---
## Details_InvalidOperationException classe


A exceção que é lançada quando um método é invocado em um objeto que está em um estado inconsistente com esta chamada. Nunca crie instâncias desta classe manualmente. Use a InvalidOperationException classe em vez disso. Nunca encapsule as instâncias da InvalidOperationException classe em [System::SmartPtr](../smartptr/).
