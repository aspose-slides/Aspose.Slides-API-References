...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analógico ao método [Object.GetHashCode()](../object/gethashcode/) do C#. Permite hash de objetos personalizados. |
| virtual const [TypeInfo](../typeinfo/)\& [GetType](../object/gettype/)() const | Obtém o tipo real do objeto. Analógico à chamada [System.Object.GetType()](../object/gettype/) do C#. |
| virtual [TypeCode](../typecode/) [GetTypeCode](./gettypecode/)() const | Retorna o valor que representa o tipo do valor encapsulado representado pelo objeto atual. |
| virtual **uint64_t** [GetUnsignedLongLongValue](./getunsignedlonglongvalue/)() const | Converte o valor encapsulado representado pelo objeto atual para um valor inteiro de 64 bits. |
| virtual **bool** [Is](../object/is/)(const [TypeInfo](../typeinfo/)\&) const | Verifica se o objeto representa uma instância do tipo descrito por targetType. Analítico ao operador 'is' do C#. |
| virtual **bool** [IsBoxedEnum](./isboxedenum/)() | Determina se o objeto atual representa um valor encapsulado de tipo enum. |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analógico ao método [Object.MemberwiseClone()](../object/memberwiseclone/) do C#. Permite clonar tipos personalizados. |
...
| static [SharedPtr](../sharedptr/)\<[Object](../object/)\> [Parse](./parse/)(const [TypeInfo](../typeinfo/)\&, const [String](../string/)\&, **bool**) | Encapsula o valor da constante de enumeração da enumeração especificada com o nome especificado. Um parâmetro indica se a diferenciação entre maiúsculas e minúsculas deve ser ignorada ao interpretar a string que especifica o nome da constante de enumeração. |
| static [SharedPtr](../sharedptr/)\<[Object](../object/)\> [Parse](./parse/)(const [TypeInfo](../typeinfo/)\&, const [String](../string/)\&) | Encapsula o valor da constante de enumeração da enumeração especificada com o nome especificado. |
...
| [System::String](../string/) [ToString](./tostring/)(const [System::String](../string/)\&) const | Converte o objeto encapsulado para string usando a string de formato especificada. |
| virtual [String](../string/) [ToString](./tostring/)() const | Analógico ao método [Object.ToString()](../object/tostring/) do C#. Permite converter objetos personalizados para string. |
