...
description: "PlatformNotSupportedException é lançada quando um recurso não é executado em uma plataforma específica. Nunca crie instâncias desta classe manualmente. Use a classe PlatformNotSupportedException. Nunca encapsule as instâncias da classe PlatformNotSupportedException em System::SmartPtr."
type: docs
weight: 664
url: /pt/system/details_platformnotsupportedexception/
---
## Details_PlatformNotSupportedException classe

PlatformNotSupportedException é lançada quando um recurso não é executado em uma plataforma específica. Nunca crie instâncias desta classe manualmente. Use a classe PlatformNotSupportedException. Nunca encapsule as instâncias da classe PlatformNotSupportedException em [System::SmartPtr](../smartptr/).
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de modelo como ponteiro fraco (em vez de compartilhado). Permite trocar ponteiros em contêineres para o modo fraco. |
