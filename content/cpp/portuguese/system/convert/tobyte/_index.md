...
description: Converte o valor booleano especificado para um inteiro sem sinal de 8 bits equivalente.
type: docs
weight: 92
url: /pt/system/convert/tobyte/
---
## Convert::ToByte(bool) método

Converte o valor booleano especificado para um inteiro sem sinal de 8 bits equivalente.
...
Retorna o inteiro sem sinal de 8 bits especificado.
...
Converte o inteiro com sinal de 8 bits especificado para um inteiro sem sinal de 8 bits equivalente.
...
Converte o inteiro sem sinal de 16 bits especificado para um inteiro sem sinal de 8 bits equivalente.
...
Converte o inteiro com sinal de 16 bits especificado para um inteiro sem sinal de 8 bits equivalente.
...
Converte o inteiro sem sinal de 32 bits especificado para um inteiro sem sinal de 8 bits equivalente.
...
Converte o inteiro com sinal de 32 bits especificado para um inteiro sem sinal de 8 bits equivalente.
...
Converte o inteiro sem sinal de 64 bits especificado para um inteiro sem sinal de 8 bits equivalente.
...
Converte o inteiro com sinal de 64 bits especificado para um inteiro sem sinal de 8 bits equivalente.
...
Converte o número em ponto flutuante especificado para um inteiro sem sinal de 8 bits equivalente.
...
Converte o número double especificado para um inteiro sem sinal de 8 bits equivalente.
...
Converte o número decimal especificado para um inteiro sem sinal de 8 bits equivalente.
...
Converte o caractere Unicode especificado para um inteiro sem sinal de 8 bits equivalente.
...
Converte a string nula especificada para o valor inteiro sem sinal de 8 bits equivalente.
...
Converte a c-string especificada contendo a representação textual de um número para o valor inteiro sem sinal de 8 bits equivalente.
...
O valor inteiro sem sinal de 8 bits igual ao número representado pela c-string especificada

## Convert::ToByte(const String\&) método

Converte a string especificada contendo a representação textual de um número para o valor inteiro sem sinal de 8 bits equivalente.
...
O valor inteiro sem sinal de 8 bits igual ao número representado pela string especificada

## Convert::ToByte(const String\&, int) método

Converte a string especificada contendo a representação textual de um número na base especificada para o valor inteiro sem sinal de 8 bits equivalente.
...
Converte a string especificada contendo a representação textual de um número para o valor inteiro sem sinal de 8 bits equivalente usando as informações de formatação fornecidas.
...
Converte a string especificada contendo a representação textual de um número para o valor inteiro sem sinal de 8 bits equivalente usando as informações de formatação e o estilo numérico fornecidos.
...
Converte o valor encapsulado especificado para o valor inteiro sem sinal de 8 bits equivalente.
...
Um valor inteiro sem sinal de 8 bits equivalente ao valor encapsulado especificado
