...
description: Converte o valor booleano especificado para um inteiro sem sinal de 64 bits equivalente.
type: docs
weight: 196
url: /pt/system/convert/touint64/
---
## Convert::ToUInt64(bool) método

Converte o valor booleano especificado para um inteiro sem sinal de 64 bits equivalente.
...
Converte o inteiro sem sinal de 8 bits especificado para um inteiro sem sinal de 64 bits equivalente.
...
Converte o inteiro com sinal de 8 bits especificado para um inteiro sem sinal de 64 bits equivalente.
...
Converte o inteiro sem sinal de 16 bits especificado para um inteiro sem sinal de 64 bits equivalente.
...
Converte o inteiro com sinal de 16 bits especificado para um inteiro sem sinal de 64 bits equivalente.
...
Converte o inteiro sem sinal de 32 bits especificado para um inteiro sem sinal de 64 bits equivalente.
...
Converte o inteiro com sinal de 32 bits especificado para um inteiro sem sinal de 64 bits equivalente.
...
Retorna o inteiro sem sinal de 64 bits especificado.
...
Converte o inteiro com sinal de 64 bits especificado para um inteiro sem sinal de 64 bits equivalente.
...
Converte o número float especificado para um inteiro sem sinal de 64 bits equivalente.
...
Converte o número double especificado para um inteiro sem sinal de 64 bits equivalente.
...
Converte o número decimal especificado para um inteiro sem sinal de 64 bits equivalente.
...
Converte o caractere unicode especificado para um inteiro sem sinal de 64 bits equivalente.
...
Converte a cadeia nula especificada para o valor inteiro sem sinal de 64 bits equivalente.
...
Converte a c-string especificada que contém a representação textual de um número para o valor inteiro sem sinal de 64 bits equivalente.
...
O valor inteiro sem sinal de 64 bits igual ao número representado pela c-string especificada

## Convert::ToUInt64(const String\&) método


Converte a string especificada que contém a representação textual de um número para o valor inteiro sem sinal de 64 bits equivalente.
...
O valor inteiro sem sinal de 64 bits igual ao número representado pela string especificada

## Convert::ToUInt64(const String\&, int) método


Converte a string especificada que contém a representação textual de um número na base especificada para o valor inteiro sem sinal de 64 bits equivalente.
...
Converte a string especificada que contém a representação textual de um número para o valor inteiro sem sinal de 64 bits equivalente usando as informações de formatação fornecidas.
...
Converte a string especificada que contém a representação textual de um número para o valor inteiro sem sinal de 64 bits equivalente usando as informações de formatação fornecidas e o estilo numérico.
...
Converte o valor encapsulado especificado para o valor inteiro sem sinal de 64 bits equivalente.
...
Um valor inteiro sem sinal de 64 bits equivalente ao valor encapsulado especificado
