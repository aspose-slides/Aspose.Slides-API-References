...
description: "UnauthorizedAccessException é lançada quando o acesso é negado pelo sistema operacional devido a um erro de E/S ou um erro de segurança. Nunca crie instâncias desta classe manualmente. Use a classe UnauthorizedAccessException em vez disso. Nunca encapsule instâncias da classe UnauthorizedAccessException em System::SmartPtr."
type: docs
weight: 755
url: /pt/system/details_unauthorizedaccessexception/
---
## Details_UnauthorizedAccessException classe


UnauthorizedAccessException é lançada quando o acesso é negado pelo sistema operacional devido a um erro de E/S ou um erro de segurança. Nunca crie instâncias desta classe manualmente. Use a classe UnauthorizedAccessException em vez disso. Nunca encapsule instâncias da classe UnauthorizedAccessException em [System::SmartPtr](../smartptr/).
