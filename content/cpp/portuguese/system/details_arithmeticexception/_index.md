...
description: "ArithmeticException é lançada quando ocorre um erro durante a execução de operações aritméticas, conversão ou operações de casting. Nunca crie instâncias desta classe manualmente. Use a classe ArithmeticException em vez disso. Nunca encapsule as instâncias da classe ArithmeticException em System::SmartPtr."
type: docs
weight: 365
url: /pt/system/details_arithmeticexception/
---
## Details_ArithmeticException classe

ArithmeticException é lançada quando ocorre um erro durante a execução de operações aritméticas, conversão ou operações de casting. Nunca crie instâncias desta classe manualmente. Use a classe ArithmeticException em vez disso. Nunca encapsule as instâncias da classe ArithmeticException em [System::SmartPtr](../smartptr/).
...
| virtual [String](../string/) [get_Message](../details_exception/get_message/)() const | Retorna a cadeia de caracteres contendo a descrição do erro. |
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Retorna a cadeia de caracteres contendo o rastreamento da pilha. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Obtém o tipo real do objeto. Análogo à chamada [System.Object.GetType()](../object/gettype/) do C#. |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Análogo ao método [Object.MemberwiseClone()](../object/memberwiseclone/) do C#. Permite clonagem de tipos personalizados. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento do modelo como um ponteiro fraco (em vez de compartilhado). Permite mudar ponteiros em contêineres para modo fraco. |
...
| [String](../string/) [ToString](../details_exception/tostring/)() const override | Retorna a representação em cadeia de caracteres do objeto atual. |
