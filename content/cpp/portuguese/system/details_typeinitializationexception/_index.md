...
type: docs
weight: 742
url: /pt/system/details_typeinitializationexception/
---
## Details_TypeInitializationException classe
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analógica ao método C# [Object.GetHashCode()](../object/gethashcode/). Permite hash de objetos personalizados. |
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Obtém o tipo real do objeto. Analógica à chamada C# [System.Object.GetType()](../object/gettype/). |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analógica ao método C# [Object.MemberwiseClone()](../object/memberwiseclone/). Permite clonagem de tipos personalizados. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento de template como ponteiro fraco (em vez de compartilhado). Permite trocar ponteiros em contêineres para o modo fraco. |
| int [SharedCount](../object/sharedcount/)() const | Obtém o valor atual do contador de referência compartilhado. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Incrementa o contador de referência compartilhado. Não deve ser chamado diretamente; ao invés disso, use smart pointers ou ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Decrementa e retorna o contador de referência compartilhado. Não deve ser chamado diretamente; ao invés disso, use smart pointers ou ThisProtector. |
