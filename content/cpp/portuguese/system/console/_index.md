...
description: Fornece métodos para enviar dados ao fluxo de saída padrão. Este é um tipo estático sem serviços de instância. Você nunca deve criar instâncias dele por qualquer meio.
type: docs
weight: 196
url: /pt/system/console/
---
## Classe Console

Fornece métodos para enviar dados ao fluxo de saída padrão. Este é um tipo estático sem serviços de instância. Você nunca deve criar instâncias dele por nenhum meio.
...
int main()
{
  ...
  // Cria uma instância da classe 'std::array'.
