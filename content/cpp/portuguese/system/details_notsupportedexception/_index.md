...
description: "NotSupportedException é lançada quando um método invocado não é suportado ou quando uma operação tentada em um fluxo não é suportada. Nunca crie instâncias desta classe manualmente. Use a classe NotSupportedException em vez disso. Nunca encapsule as instâncias da classe NotSupportedException em System::SmartPtr."
type: docs
weight: 586
url: /pt/system/details_notsupportedexception/
---
## Details_NotSupportedException classe


NotSupportedException é lançada quando um método invocado não é suportado ou quando uma operação tentada em um fluxo não é suportada. Nunca crie instâncias desta classe manualmente. Use a classe NotSupportedException em vez disso. Nunca encapsule as instâncias da classe NotSupportedException em [System::SmartPtr](../smartptr/).
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Análogo ao método C# [Object.GetHashCode()](../object/gethashcode/). Permite a geração de hash para objetos personalizados. |
...
| void [Lock](../object/lock/)() | Implementa o bloqueio do statement C# lock(). Chame diretamente ou use o objeto sentinela [LockContext](../lockcontext/). |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Diminui o contador de referências compartilhadas em um valor especificado. |
...
| void [Unlock](../object/unlock/)() | Implementa o desbloqueio do statement C# lock(). Chame diretamente ou use o objeto sentinela [LockContext](../lockcontext/). |
