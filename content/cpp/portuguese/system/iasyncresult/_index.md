...
description: "Representa o status de uma operação assíncrona. Objetos desta classe devem ser alocados somente usando a função System::MakeObject(). Nunca crie uma instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro System::SmartPtr e use esse ponteiro para passá-lo a funções como argumento."
type: docs
weight: 898
url: /pt/system/iasyncresult/
---
## IAsyncResult classe

Representa o status de uma operação assíncrona. Objetos desta classe devem ser alocados somente usando a função [System::MakeObject()](../makeobject/). Nunca crie uma instância deste tipo na pilha ou usando o operador new, pois isso resultará em erros de tempo de execução e/ou falhas de asserção. Sempre envolva esta classe em um ponteiro [System::SmartPtr](../smartptr/) e use esse ponteiro para passá-lo a funções como argumento.
...
| virtual [SharedPtr](../sharedptr/)\<[System::Object](../object/)\> [get_AsyncState](./get_asyncstate/)() | Retorna um objeto que contém as informações sobre a operação assíncrona. |
| virtual [SharedPtr](../sharedptr/)\<[System::Threading::WaitHandle](../../system.threading/waithandle/)\> [get_AsyncWaitHandle](./get_asyncwaithandle/)() | Retorna uma instância de WaitHandle que pode ser usada para aguardar a conclusão da operação assíncrona. |
| virtual **bool** [get_CompletedSynchronously](./get_completedsynchronously/)() | Retorna um valor que indica se a operação assíncrona foi concluída de forma síncrona. |
| virtual **bool** [get_IsCompleted](./get_iscompleted/)() | Retorna um valor que indica se a operação assíncrona foi concluída. |
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analógico do método [Object.GetHashCode()](../object/gethashcode/) do C#. Permite hash de objetos personalizados. |
| virtual const [TypeInfo](../typeinfo/)\& [GetType](../object/gettype/)() const | Obtém o tipo real do objeto. Analógico da chamada [System.Object.GetType()](../object/gettype/) do C#. |
| virtual **bool** [Is](../object/is/)(const [TypeInfo](../typeinfo/)\&) const | Verifica se o objeto representa uma instância do tipo descrito por targetType. Analógico do operador 'is' do C#. |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analógico do método [Object.MemberwiseClone()](../object/memberwiseclone/) do C#. Permite clonar tipos personalizados. |
|  [Object](../object/object/)() | Cria o objeto. Inicializa todas as estruturas de dados internas. |
|  [Object](../object/object/)([Object](../object/) const\&) | Construtor de cópia. Na verdade não copia nada, apenas inicializa um novo objeto e permite a cópia de construtores nas subclasses. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operador de atribuição. Na verdade não copia nada, apenas inicializa um novo objeto e permite a cópia de construtores nas subclasses. |
...
| virtual [String](../string/) [ToString](../object/tostring/)() const | Analógico do método [Object.ToString()](../object/tostring/) do C#. Permite converter objetos personalizados para string. |
...
| virtual  [~IAsyncResult](./~iasyncresult/)() | Destrutor. |
...
| Typedef | Description |
| --- | --- |
| [smart_ptr](./smart_ptr/) | Ponteiro compartilhado para [IAsyncResult](./). |
