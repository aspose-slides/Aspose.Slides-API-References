...
| static [Object::ptr](../object/ptr/) [GetCustomAttribute](./getcustomattribute/)(const [TypeInfo](../typeinfo/)\&, const [TypeInfo](../typeinfo/)\&) | Retorna um atributo personalizado de um tipo especificado aplicado a um tipo especificado. |
| static [ArrayPtr](../arrayptr/)\<[Object::ptr](../object/ptr/)\> [GetCustomAttributes](./getcustomattributes/)(const [TypeInfo](../typeinfo/)\&) | Retorna todos os atributos personalizados aplicados a um tipo especificado. |
...
| virtual [String](../string/) [ToString](../object/tostring/)() const | Análogo ao método C# [Object.ToString()](../object/tostring/). Permite converter objetos personalizados para string. |
