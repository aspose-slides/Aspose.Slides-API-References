...
description: ExecutionEngineException está presente apenas por razões de compatibilidade.
type: docs
weight: 456
url: /pt/system/details_executionengineexception/
---
## Details_ExecutionEngineException classe

ExecutionEngineException está presente apenas por razões de compatibilidade.
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emula comparação de ponto flutuante no estilo C# onde dois NaNs são considerados iguais, embora segundo IEC 60559:1989 NaN não seja igual a nenhum valor, inclusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emula comparação de ponto flutuante no estilo C# onde dois NaNs são considerados iguais, embora segundo IEC 60559:1989 NaN não seja igual a nenhum valor, inclusive NaN. |
