...
description: "IndexOutOfRangeException é lançada quando um acesso a um elemento de uma coleção é tentado usando um índice que está fora dos seus limites. Nunca crie instâncias desta classe manualmente. Use a classe IndexOutOfRangeException. Nunca envolva as instâncias da classe IndexOutOfRangeException em System::SmartPtr."
type: docs
weight: 482
url: /pt/system/details_indexoutofrangeexception/
---
## Details_IndexOutOfRangeException classe


IndexOutOfRangeException é lançada quando um acesso a um elemento de uma coleção é tentado usando um índice que está fora dos seus limites. Nunca crie instâncias desta classe manualmente. Use a classe IndexOutOfRangeException. Nunca envolva as instâncias da classe IndexOutOfRangeException em [System::SmartPtr](../smartptr/).
...
| Detail::SmartPtrCounter * [GetCounter](../object/getcounter/)() | Obtém a estrutura de dados do contador de referência associado ao objeto. |
...
| virtual const char * [what](../details_exception/what/)() const | Implementa o método [what()](../details_exception/what/) que é chamado pela classe [ExceptionWrapper](../exceptionwrapper/). Apesar de que esta classe não herda de std::exception, classes derivadas podem usar membros protegidos/privados para implementar sua lógica. Mover a implementação deste método para o [ExceptionWrapper](../exceptionwrapper/) pode quebrar essa lógica. |
