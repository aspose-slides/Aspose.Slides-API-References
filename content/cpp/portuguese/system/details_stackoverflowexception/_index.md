...
description: "StackOverflowException é lançada quando a pilha de execução da thread estoura. Nunca crie instâncias desta classe manualmente. Use a classe StackOverflowException em vez disso. Nunca envolva as instâncias da classe StackOverflowException em System::SmartPtr."
type: docs
weight: 690
url: /pt/system/details_stackoverflowexception/
---
## Details_StackOverflowException classe


StackOverflowException é lançada quando a pilha de execução da thread estoura. Nunca crie instâncias desta classe manualmente. Use a classe StackOverflowException em vez disso. Nunca envolva as instâncias da classe StackOverflowException em [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de ponto flutuante no estilo C# onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não seja igual a nenhum valor, inclusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de ponto flutuante no estilo C# onde dois NaNs são considerados iguais mesmo que, de acordo com IEC 60559:1989, NaN não seja igual a nenhum valor, inclusive NaN. |
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analógia ao método C# [Object.GetHashCode()](../object/gethashcode/). Permite o hash de objetos personalizados. |
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Obtém o tipo real do objeto. Analógia à chamada C# [System.Object.GetType()](../object/gettype/). |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analógia ao método C# [Object.MemberwiseClone()](../object/memberwiseclone/). Permite clonar tipos personalizados. |
