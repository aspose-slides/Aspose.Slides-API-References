...
description: "ArgumentOutOfRangeException é lançada quando um método invocado recebe um argumento que está fora do intervalo esperado de valores para esse argumento. Nunca crie instâncias desta classe manualmente. Use a classe ArgumentOutOfRangeException. Nunca envolva as instâncias da classe ArgumentOutOfRangeException em System::SmartPtr."
type: docs
weight: 352
url: /pt/system/details_argumentoutofrangeexception/
---
## Details_ArgumentOutOfRangeException classe

ArgumentOutOfRangeException é lançada quando um método invocado recebe um argumento que está fora do intervalo esperado de valores para esse argumento. Nunca crie instâncias desta classe manualmente. Use a classe ArgumentOutOfRangeException. Nunca envolva as instâncias da classe ArgumentOutOfRangeException em [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emula comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais, embora de acordo com IEC 60559:1989 NaN não seja igual a nenhum valor, inclusive NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emula comparação de ponto flutuante ao estilo C# onde dois NaNs são considerados iguais, embora de acordo com IEC 60559:1989 NaN não seja igual a nenhum valor, inclusive NaN. |
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analoga ao método C# [Object.GetHashCode()](../object/gethashcode/). Permite hashing de objetos personalizados. |
