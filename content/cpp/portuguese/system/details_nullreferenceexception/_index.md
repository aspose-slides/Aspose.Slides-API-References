...
description: "NullReferenceException é lançada quando se tenta desreferenciar uma referência nula. Nunca crie instâncias desta classe manualmente. Use a classe NullReferenceException em vez disso. Nunca envolva as instâncias da classe NullReferenceException em System::SmartPtr."
type: docs
weight: 599
url: /pt/system/details_nullreferenceexception/
---
## Details_NullReferenceException classe

NullReferenceException é lançada quando se tenta desreferenciar uma referência nula. Nunca crie instâncias desta classe manualmente. Use a classe NullReferenceException em vez disso. Nunca envolva as instâncias da classe NullReferenceException em [System::SmartPtr](../smartptr/).
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Define o n-ésimo argumento do modelo como um ponteiro fraco (em vez de compartilhado). Permite trocar ponteiros em contêineres para o modo fraco. |
