...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | Emula a comparação de ponto flutuante ao estilo C#, onde dois NaNs são considerados iguais, embora segundo IEC 60559:1989 NaN não seja igual a nenhum valor, incluindo NaN. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emula a comparação de ponto flutuante ao estilo C#, onde dois NaNs são considerados iguais, embora segundo IEC 60559:1989 NaN não seja igual a nenhum valor, incluindo NaN. |
|  [EventArgs](./eventargs/)() | Construtor. |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Análogo ao método [Object.MemberwiseClone()](../object/memberwiseclone/) do C#. Permite clonar tipos personalizados. |
...
| virtual [String](../string/) [ToString](../object/tostring/)() const | Análogo ao método [Object.ToString()](../object/tostring/) do C#. Permite converter objetos personalizados para string. |
...
| Campo | Descrição |
| --- | --- |
| static [Empty](./empty/) | Um membro estático que representa um ponteiro compartilhado "vazio" [EventArgs](./) (ponteiro nulo). |
## Ver também
