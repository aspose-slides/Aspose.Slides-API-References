...
description: "NotImplementedException é lançada quando um método não está implementado e serve como um stub. Nunca crie instâncias desta classe manualmente. Use a classe NotImplementedException em vez disso. Nunca envolva as instâncias da classe NotImplementedException em System::SmartPtr."
type: docs
weight: 573
url: /pt/system/details_notimplementedexception/
---
## Details_NotImplementedException classe

NotImplementedException é lançada quando um método não está implementado e serve como um stub. Nunca crie instâncias desta classe manualmente. Use a classe NotImplementedException em vez disso. Nunca envolva as instâncias da classe NotImplementedException em [System::SmartPtr](../smartptr/).
...
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | Emula comparação de ponto flutuante no estilo C# onde dois NaNs são considerados iguais, embora de acordo com IEC 60559:1989 NaN não seja igual a nenhum valor, inclusive NaN. |
