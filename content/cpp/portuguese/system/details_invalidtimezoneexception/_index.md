...
description: "InvalidTimeZoneException é lançada quando as informações de fuso horário são inválidas. Nunca crie instâncias desta classe manualmente. Use a classe InvalidTimeZoneException em vez disso. Nunca encapsule as instâncias da classe InvalidTimeZoneException em System::SmartPtr."
type: docs
weight: 534
url: /pt/system/details_invalidtimezoneexception/
---
## Details_InvalidTimeZoneException classe


InvalidTimeZoneException é lançada quando as informações de fuso horário são inválidas. Nunca crie instâncias desta classe manualmente. Use a classe InvalidTimeZoneException em vez disso. Nunca encapsule as instâncias da classe InvalidTimeZoneException em [System::SmartPtr](../smartptr/).
...
|  [Object](../object/object/)() | Cria objeto. Inicializa todas as estruturas internas de dados. |
...
| virtual  [~Object](../object/~object/)() | Destrói o objeto. Libera todas as estruturas internas de dados. |
## Veja Também
