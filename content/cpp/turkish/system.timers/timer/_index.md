...
description: Döngü içinde delegeyi çağıran zamanlayıcı.
type: docs
weight: 14
url: /tr/system.timers/timer/
---
## Timer sınıfı

[Timer](./) döngü içinde delegeyi çağıran.
...
| Metot | Açıklama |
| --- | --- |
| void [Close](./close/)() | Zamanlayıcıyı durdurur, tahsis edilen kaynakları serbest bırakır. |
|  [Component](../../system.componentmodel/component/component/)() | RTTI bilgisi. |
| void [Dispose](./dispose/)() | Zamanlayıcıyı durdurur, tahsis edilen kaynakları serbest bırakır. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'da NaN hiçbir değerle, NaN dahil, eşit değilken, iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'da NaN hiçbir değerle, NaN dahil, eşit değilken, iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **bool** [get_AutoReset](./get_autoreset/)() const | Zamanlayıcının otomatik sıfırlama modunda olup olmadığını kontrol eder. |
...
| **bool** [get_Enabled](./get_enabled/)() const | Zamanlayıcının aktif olup olmadığını kontrol eder. |
| **double** [get_Interval](./get_interval/)() const | Zamanlayıcı aralığını alır. |
| **bool** [get_IsStopped](./get_isstopped/)() const | Zamanlayıcının durdurulup durdurulmadığını kontrol eder. |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | Zamanlayıcıyı otomatik sıfırlama moduna ayarlar veya bu moddan çıkarır. |
| void [set_Enabled](./set_enabled/)(**bool**) | Zamanlayıcıyı başlatır veya durdurur. Zamanlayıcı zaten çalışıyorsa başlatma zaman sayımını yeniden başlatmaz. |
| void [set_Interval](./set_interval/)(**double**) | Zamanlayıcı aralığını ayarlar. |
...
| void [Start](./start/)() | Zamanlayıcıyı başlatır. Zamanlayıcı zaten çalışıyorsa zaman sayımını yeniden başlatmaz. |
| void [Stop](./stop/)() | Zamanlayıcıyı durdurur. |
|  [Timer](./timer/)() | RTTI bilgisi. |
|  [Timer](./timer/)(**double**) | Belirtilen aralıkla durdurulmuş zamanlayıcı oluşturur. |
