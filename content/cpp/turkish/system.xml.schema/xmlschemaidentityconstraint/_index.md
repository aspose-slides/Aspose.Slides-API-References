...
description: "Kimlik kısıtlamaları: key, keyref ve unique öğeleri için sınıf."
type: docs
weight: 469
url: /tr/system.xml.schema/xmlschemaidentityconstraint/
---
## XmlSchemaIdentityConstraint sınıfı

Kimlik kısıtlamaları (**key**, **keyref**, ve **unique** öğeleri) için sınıf.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | XML Path Language ([XPath](../../system.xml.xpath/)) ifade seçicisi için çocuk olarak uygulanan alanların koleksiyonunu döndürür. |
...
| [String](../../system/string/) [get_Name](./get_name/)() | kimlik kısıtlamasının adını döndürür. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Bu [XmlSchemaObject](../xmlschemaobject/)'in üst nesnesini döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Kimlik kısıtlamasının nitelikli adını döndürür; bu, **QualifiedName** değerinin derleme sonrası yorumlamasını içerir. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | [XPath](../../system.xml.xpath/) ifadesinin **selector** öğesini döndürür. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | kimlik kısıtlamasının adını ayarlar. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Bu [XmlSchemaObject](../xmlschemaobject/)'in üst nesnesini ayarlar. |
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | [XPath](../../system.xml.xpath/) ifadesinin **selector** öğesini ayarlar. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() deyiminin kilidinin kaldırılmasını uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
...
Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak ayrılmalıdır. Yeni operatörüyle veya yığında bu tipin örneklerini oluşturmayın; bu, çalışma zamanı hatalarına ve/veya assert hatalarına neden olur. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
