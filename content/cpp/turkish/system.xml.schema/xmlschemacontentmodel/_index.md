...
description: Bir tipin alt öğelerinin sırasını ve yapısını belirtir.
type: docs
weight: 326
url: /tr/system.xml.schema/xmlschemacontentmodel/
---
## XmlSchemaContentModel sınıfı

Bir tipin alt öğelerinin sırasını ve yapısını belirtir.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() | Tipin içeriğini döndürür. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | Dizeler için [Object::ReferenceEquals](../../system/object/referenceequals/) özelleştirmesi. |
...
| virtual void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) | Tipin içeriğini ayarlar. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki göstergeleri zayıf moda geçirmeye izin verir. |
