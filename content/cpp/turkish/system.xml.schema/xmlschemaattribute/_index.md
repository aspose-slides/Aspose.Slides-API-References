...
description: XML Şema tarafından World Wide Web Consortium (W3C) tarafından tanımlandığı gibi öznitelik öğesini temsil eder. Öznitelikler diğer belge öğeleri için ek bilgi sağlar. Öznitelik etiketi, şema için bir belgenin öğesinin etiketleri arasında yer alır. XML belgesi, öznitelikleri bir öğenin açılış etiketinde adlandırılmış öğeler olarak gösterir.
type: docs
weight: 170
url: /tr/system.xml.schema/xmlschemaattribute/
---
## XmlSchemaAttribute sınıfı


Represents the **öznitelik** element from the XML [Schema](../) as specified by the World Wide [Web](../../system.web/) Consortium (W3C). Attributes provide additional information for other document elements. The attribute tag is nested between the tags of a document's element for the schema. The XML document displays attributes as named items in the opening tag of an element.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_AttributeSchemaType](./get_attributeschematype/)() | Öznitelik değerinin [XmlSchemaAttribute::get_SchemaType](./get_schematype/) veya [XmlSchemaAttribute::get_SchemaTypeName](./get_schematypename/) değerine dayalı olarak öznitelik türünü temsil eden bir [XmlSchemaSimpleType](../xmlschemasimpletype/) nesnesini döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_AttributeType](./get_attributetype/)() | **AttributeType** değerinin derleme sonrası yorumlamasını tutan [XmlSchemaAttribute::get_SchemaType](./get_schematype/) veya [XmlSchemaAttribute::get_SchemaTypeName](./get_schematypename/) değerine dayalı nesneyi döndürür. |
| [String](../../system/string/) [get_DefaultValue](./get_defaultvalue/)() | Öznitelik için varsayılan değeri döndürür. |
| [String](../../system/string/) [get_FixedValue](./get_fixedvalue/)() | Öznitelik için sabit değeri döndürür. |
| [XmlSchemaForm](../xmlschemaform/) [get_Form](./get_form/)() | Öznitelik için formu döndürür. |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Öznitelik adını döndürür. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Bu [XmlSchemaObject](../xmlschemaobject/) öğesinin üst nesnesini döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Öznitelik için nitelikli adı döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_RefName](./get_refname/)() | Bu şemada (veya belirtilen ad alanı tarafından gösterilen başka bir şemada) bildirilen bir öznitelik adını döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_SchemaType](./get_schematype/)() | Öznitelik türünü basit bir tipe döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_SchemaTypeName](./get_schematypename/)() | Bu şemada (veya belirtilen ad alanı tarafından gösterilen başka bir şemada) tanımlanan basit tipin adını döndürür. |
...
| [XmlSchemaUse](../xmlschemause/) [get_Use](./get_use/)() | Özniteliğin nasıl kullanıldığına dair bilgiyi döndürür. |
...
| void [set_DefaultValue](./set_defaultvalue/)(const [String](../../system/string/)\&) | Öznitelik için varsayılan değeri ayarlar. |
| void [set_FixedValue](./set_fixedvalue/)(const [String](../../system/string/)\&) | Öznitelik için sabit değeri ayarlar. |
| void [set_Form](./set_form/)([XmlSchemaForm](../xmlschemaform/)) | Öznitelik için formu ayarlar. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Öznitelik adını ayarlar. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Bu [XmlSchemaObject](../xmlschemaobject/) öğesinin üst nesnesini ayarlar. |
| void [set_RefName](./set_refname/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Bu şemada (veya belirtilen ad alanı tarafından gösterilen başka bir şemada) bildirilen bir öznitelik adını ayarlar. |
| void [set_SchemaType](./set_schematype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Öznitelik türünü basit bir tipe ayarlar. |
| void [set_SchemaTypeName](./set_schematypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Bu şemada (veya belirtilen ad alanı tarafından gösterilen başka bir şemada) tanımlanan basit tipin adını ayarlar. |
...
| void [set_Use](./set_use/)([XmlSchemaUse](../xmlschemause/)) | Özniteliğin nasıl kullanıldığına dair bilgiyi ayarlar. |
...
|  [XmlSchemaAttribute](./xmlschemaattribute/)() | [XmlSchemaAttribute](./) sınıfının yeni bir örneğini başlatır. |
...
Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak ayrılmalıdır. Bu tipin örneklerini yığında veya operator new kullanarak oluşturmayın; bu, çalışma zamanı hatalarına ve/veya doğrulama hatalarına neden olur. Her zaman bu sınıfı [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin. 
