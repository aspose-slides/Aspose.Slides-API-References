...
description: XML Şema tarafından World Wide Web Consortium (W3C) tarafından tanımlandığı şekilde grup öğesini temsil eder. Bu sınıf, karmaşık tiplerden referans verilen şema düzeyinde grupları tanımlar. Bir dizi element bildirimini gruplar, böylece bunlar karmaşık tip tanımlarına grup olarak dahil edilebilir.
type: docs
weight: 430
url: /tr/system.xml.schema/xmlschemagroup/
---
## XmlSchemaGroup sınıf

XML [Schema](../) öğesindeki **grup** elementini, World Wide [Web](../../system.web/) Consortium (W3C) tarafından tanımlandığı şekilde temsil eder. Bu sınıf, **şema** düzeyinde kompleks tiplerden referans verilen grupları tanımlar. Bir dizi element bildirimini gruplar, böylece bunlar kompleks tip tanımlarına bir grup olarak dahil edilebilir.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989’a göre NaN’ın herhangi bir değere eşit olmamasına rağmen, iki NaN’ın eşit kabul edildiği C#-stili kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989’a göre NaN’ın herhangi bir değere eşit olmamasına rağmen, iki NaN’ın eşit kabul edildiği C#-stili kayan nokta karşılaştırmasını taklit eder. |
...
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | **şema** öğesinin referans verdiği dosyadaki satır numarasını döndürür. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | **şema** öğesinin referans verdiği dosyadaki satır konumunu döndürür. |
| [String](../../system/string/) [get_Name](./get_name/)() | Şema grubunun adını döndürür. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Bu [XmlSchemaObject](../xmlschemaobject/) üst nesnesini döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) veya [XmlSchemaSequence](../xmlschemasequence/) sınıflarından birini döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Şema grubu için nitelikli adı döndürür. |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | **şema** öğesinin referans verdiği dosyadaki satır numarasını ayarlar. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | **şema** öğesinin referans verdiği dosyadaki satır konumunu ayarlar. |
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Şema grubunun adını ayarlar. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Bu [XmlSchemaObject](../xmlschemaobject/) üst nesnesini ayarlar. |
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\>\&) | [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/) veya [XmlSchemaSequence](../xmlschemasequence/) sınıflarından birini ayarlar. |
...
| Tip Tanımı | Açıklama |
| --- | --- |
| [Ptr](./ptr/) | Bu sınıfın bir örneğine ortak göstergeç için bir takma addır. |

## Açıklamalar

Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak tahsis edilmelidir. Yığını (stack) üzerinde veya operator new kullanarak bu tipin örneklerini oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) göstergeç içinde sarın ve bu göstergeçi fonksiyonlara argüman olarak aktarın. 
