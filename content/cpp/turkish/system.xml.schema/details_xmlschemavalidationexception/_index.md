...
description: Doğrulanan bir XML belgesinde XML Şema Tanım Dili (XSD) şema doğrulama hataları ve uyarılarıyla karşılaşıldığında atılan istisnayı temsil eder.
type: docs
weight: 27
url: /tr/system.xml.schema/details_xmlschemavalidationexception/
---
## Details_XmlSchemaValidationException sınıfı

XML [Schema](../) Tanım Dili (XSD) şema doğrulama hataları ve uyarılarıyla karşılaşıldığında atılan istisnayı temsil eder.
...
| [String](../../system/string/) [get_Message](../details_xmlschemaexception/get_message/)() const override | Bu istisnanın hata koşulunun açıklamasını döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SourceObject](./get_sourceobject/)() | Bu XmlSchemaValidationException'ı oluşturan XML düğümünü döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](../details_xmlschemaexception/get_sourceschemaobject/)() | XmlSchemaException'ı üreten **[XmlSchemaObject](../xmlschemaobject/)**. |
| [String](../../system/string/) [get_SourceUri](../details_xmlschemaexception/get_sourceuri/)() | İstisnaya neden olan şemanın Uniform Resource Identifier (URI) konumunu döndürür. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) metodunun bir benzeridir. Özel nesnelerin karma (hash) oluşturmasını sağlar. |
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Nesnenin gerçek tipini alır. C# [System.Object.GetType()](../../system/object/gettype/) çağrısının bir benzeridir. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) metodunun bir benzeridir. Özel tiplerin kopyalanmasını (klonlanmasını) sağlar. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [ExceptionWrapper](../../system/exceptionwrapper/) sınıfı tarafından çağrılan [what()](../../system/details_exception/what/) metodunu uygular. Bu sınıf std::exception'dan türetilmemiş olsa da, türetilen sınıflar korumalı/özel üyeleri kullanarak mantıklarını uygulayabilir. Bu metodun implementasyonunu [ExceptionWrapper](../../system/exceptionwrapper/)'e taşımak bu mantığı bozabilir. |
