...
description: XmlSchemaObjects öğelerinin bir koleksiyonu.
type: docs
weight: 690
url: /tr/system.xml.schema/xmlschemaobjectcollection/
---
## XmlSchemaObjectCollection sınıf

XmlSchemaObjects öğelerinin bir koleksiyonu.
...
| Yöntem | Açıklama |
| --- | --- |
| **int32_t** [Add](./add/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Bir [XmlSchemaObject](../xmlschemaobject/) öğesini [XmlSchemaObjectCollection](./)'ye ekler. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Koleksiyonun son const nitelikli öğesinden hemen sonrasına işaret eden yineleyiciyi alır. |
| void [Clear](../../system.collections/collectionbase/clear/)() | Koleksiyon örneğinden tüm nesneleri kaldırır. Bu yöntem geçersiz kılınamaz. |
| **bool** [Contains](./contains/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Belirtilen [XmlSchemaObject](../xmlschemaobject/)'nin [XmlSchemaObjectCollection](./) içinde olup olmadığını gösterir. |
| void [CopyTo](./copyto/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\&, **int32_t**) | Belirtilen dizideki verilen indeksten başlayarak koleksiyondaki tüm XmlSchemaObjects öğelerini kopyalar. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Koleksiyonun son öğesinden hemen sonrasına işaret eden yineleyiciyi alır. Bu yineleyici, [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) bir T kopya-nesnesi döndürdüğü için referans verilen nesneyi değiştirmek için kullanılamaz. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Koleksiyonun const nitelikli örneğinin son öğesinden hemen sonrasına işaret eden yineleyiciyi alır. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit olmamakla birlikte iki NaN'in eşit kabul edildiği C# tarzı çift hassasiyetli kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili kullanım içindir. |
| **int32_t** [get_Capacity](../../system.collections/collectionbase/get_capacity/)() | Koleksiyonun içerebileceği öğe sayısını döndürür. |
| **int32_t** [get_Count](../../system.collections/collectionbase/get_count/)() | Koleksiyon örneğinde bulunan öğe sayısını döndürür. Bu yöntem geçersiz kılınamaz. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkilendirilmiş referans sayacı veri yapısını alır. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\>\> [GetEnumerator](./getenumerator/)() override | [XmlSchemaObjectCollection](./) içinde bulunan XmlSchemaObjects öğelerini yinelemek için bir enumeratör döndürür. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [idx_get](./idx_get/)(**int32_t**) | Belirtilen indeksteki [XmlSchemaObject](../xmlschemaobject/)'i döndürür. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>) | Belirtilen indeksteki [XmlSchemaObject](../xmlschemaobject/)'i ayarlar. |
| **int32_t** [IndexOf](./indexof/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Belirtilen [XmlSchemaObject](../xmlschemaobject/)'ye karşılık gelen koleksiyon indeksini döndürür. |
| void [Insert](./insert/)(**int32_t**, const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | [XmlSchemaObjectCollection](./)'ye bir [XmlSchemaObject](../xmlschemaobject/) ekler. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Girdi dizisindeki her öğeye bir dönüşüm işlevi uygulayarak elde edilen değerlerin ortalamasını hesaplar. |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitlemesini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) izci nesnesini kullanın. |
...
| void [Remove](./remove/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | [XmlSchemaObjectCollection](./)'den bir [XmlSchemaObject](../xmlschemaobject/) kaldırır. |
| void [RemoveAt](../../system.collections/collectionbase/removeat/)(**int32_t**) | Koleksiyon örneğinde belirtilen indeksteki öğeyi kaldırır. Bu yöntem geçersiz kılınamaz. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| void [set_Capacity](../../system.collections/collectionbase/set_capacity/)(**int32_t**) | Koleksiyonun içerebileceği öğe sayısını ayarlar. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'inci şablon argümanını paylaşımlı yerine zayıf gösterici olarak ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçişe izin verir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açma bölümünü uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) izci nesnesini kullanın. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Geçerli kapsayıcının begin const yineleyicisinin uygulanmasını alır. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../../system.collections.generic/ienumerable/virtualizebeginiterator/)() | Geçerli kapsayıcının begin yineleyicisinin uygulanmasını alır. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Geçerli kapsayıcının end const yineleyicisinin uygulanmasını alır. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../../system.collections.generic/ienumerable/virtualizeenditerator/)() | Geçerli kapsayıcının end yineleyicisinin uygulanmasını alır. |
...
|  [XmlSchemaObjectCollection](./xmlschemaobjectcollection/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | [XmlSchemaObjectCollection](./) sınıfının bir [XmlSchemaObject](../xmlschemaobject/) alan yeni bir örneğini başlatır. |
...
Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak ayrılmalıdır. Bu türden örnekleri yığına (stack) veya new operatörüyle oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Her zaman bu sınıfı [System::SmartPtr](../../system/smartptr/) göstericisine sarın ve bu göstericiyi işlevlere argüman olarak geçirin. 

## Diğer Bağlantılar

* Sınıf [CollectionBase](../../system.collections/collectionbase/)
