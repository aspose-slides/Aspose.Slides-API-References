...
description: Şema içeriği için soyut bir sınıf.
type: docs
weight: 313
url: /tr/system.xml.schema/xmlschemacontent/
---
## XmlSchemaContent sınıf

Şema içeriği için soyut bir sınıf.
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | String ve nullptr durumu için [Object::ReferenceEquals](../../system/object/referenceequals/)'un özelleştirilmesi. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açma işlemini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) sentry nesnesini kullanın. |
