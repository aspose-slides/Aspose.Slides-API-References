...
description: World Wide Web Consortium (W3C) tarafından belirlenen XML Şema'daki simpleContent öğesini temsil eder. Bu sınıf basit içerik modeline sahip basit ve karmaşık tipler içindir.
type: docs
weight: 794
url: /tr/system.xml.schema/xmlschemasimplecontent/
---
## XmlSchemaSimpleContent sınıfı


XML [Schema](../)'deki **simpleContent** öğesini World Wide [Web](../../system.web/) Consortium (W3C) tarafından belirlenen şekilde temsil eder. Bu sınıf basit içerik modeline sahip basit ve karmaşık tipler içindir.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() override | [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) ya da [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/)'den birini döndürür. |
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | **schema** öğesinin işaret ettiği dosyadaki konum numarasını döndürür. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin hedefType tarafından tanımlanan bir örnek olup olmadığını denetler. C# 'is' operatörünün analoğu. |
...
| void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) override | [XmlSchemaSimpleContentRestriction](../xmlschemasimplecontentrestriction/) ya da [XmlSchemaSimpleContentExtension](../xmlschemasimplecontentextension/)'den birini döndürür. |
...
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | **schema** öğesinin işaret ettiği dosyadaki konum numarasını ayarlar. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi olarak ayarlar (paylaşımlı değil). Kapsayıcılardaki işaretçileri zayıf moda geçirmek için kullanılır. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Paylaşımlı referans sayacını azaltır ve sonucunu döndürür. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler ya da ThisProtector kullanılmalıdır. |
