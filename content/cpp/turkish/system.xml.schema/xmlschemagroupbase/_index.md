...
description: XmlSchemaAll, XmlSchemaChoice veya XmlSchemaSequence için soyut bir sınıf.
type: docs
weight: 443
url: /tr/system.xml.schema/xmlschemagroupbase/
---
## XmlSchemaGroupBase sınıf


Soyut sınıf [XmlSchemaAll](../xmlschemaall/), [XmlSchemaChoice](../xmlschemachoice/) veya [XmlSchemaSequence](../xmlschemasequence/) için.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# stilinde kayan nokta karşılaştırmasını taklit eder; iki NaN, IEC 60559:1989'da NaN'ın herhangi bir değere, NaN dahil, eşit olmaması gerektiği halde eşit kabul edilir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# stilinde kayan nokta karşılaştırmasını taklit eder; iki NaN, IEC 60559:1989'da NaN'ın herhangi bir değere, NaN dahil, eşit olmaması gerektiği halde eşit kabul edilir. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() | Bu koleksiyon, kompozitöre yeni öğeler eklemek için kullanılır. |
...
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Sayının dize değerini döndürür. Parçacığın meydana gelebileceği azami sayıyı. |
...
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Sayının dize değerini döndürür. Parçacığın meydana gelebileceği asgari sayıyı. |
...
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Parçacığın meydana gelebileceği azami sayıyı ayarlar. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Sayının dize değerini ayarlar. Parçacığın meydana gelebileceği azami sayıyı. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Parçacığın meydana gelebileceği asgari sayıyı ayarlar. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Sayının dize değerini ayarlar. Parçacığın meydana gelebileceği asgari sayıyı. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon bağımsız değişkeni zayıf gösterici (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki göstericilerin zayıf moda geçmesini sağlar. |
