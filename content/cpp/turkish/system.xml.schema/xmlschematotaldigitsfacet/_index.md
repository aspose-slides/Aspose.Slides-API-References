...
description: XML Şema'dan totalDigits facet'ini Dünya Çapında Web Konsorsiyumu (W3C) tarafından belirtildiği şekilde temsil eder. Bu sınıf, bir simpleType öğesinin değeri için girilebilecek rakam sayısı üzerinde bir kısıtlama belirtmek için kullanılabilir. totalDigits değerinin pozitif bir tam sayı olması gerekir.
type: docs
weight: 898
url: /tr/system.xml.schema/xmlschematotaldigitsfacet/
---
## XmlSchemaTotalDigitsFacet sınıfı

XML [Schema](../)'den **totalDigits** facet'ini, Dünya Çapında [Web](../../system.web/) Konsorsiyumu (W3C) tarafından belirtilen şekilde temsil eder. Bu sınıf, bir **simpleType** öğesinin değerinde girilebilecek rakam sayısı üzerinde bir kısıtlama belirtmek için kullanılabilir. **totalDigits** değerinin pozitif bir tam sayı olması gerekir.
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | nesnenin targetType tarafından tanımlanan tipin örneği olup olmadığını denetler. C# 'is' operatörünün benzeri. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | bu şema nesnesiyle birlikte kullanılacak XmlSerializerNamespaces'i ayarlar. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 'n'inci şablon argümanını zayıf gösterici (shared yerine) olarak ayarlar. Kapsayıcılardaki göstergeleri zayıf moda geçirir. |
...
|  [XmlSchemaTotalDigitsFacet](./xmlschematotaldigitsfacet/)() | [XmlSchemaTotalDigitsFacet](./) sınıfının yeni bir örneğini başlatır. |
...
Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak ayrılmalıdır. Bu tipin örneklerini yığını üzerinde veya operator new kullanarak oluşturmayın; bu, çalışma zamanı hatalarına ve/veya assert hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin. 
