...
description: World Wide Web Consortium (W3C) tarafından belirtilen XML Şeması'ndan basit tipler için kısıtlama öğesini temsil eder. Bu sınıf simpleType öğesini kısıtlamak için kullanılabilir.
type: docs
weight: 872
url: /tr/system.xml.schema/xmlschemasimpletyperestriction/
---
## XmlSchemaSimpleTypeRestriction sınıf


XML [Schema](../)'den gelen basit tipler için **restriction** öğesini temsil eder ve Dünya Çapında [Web](../../system.web/) Konsorsiyumu (W3C) tarafından belirtildiği gibi. Bu sınıf **simpleType** öğesini kısıtlamak için kullanılabilir.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | Temel tip hakkındaki bilgileri döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Nitelikli temel tipin adını döndürür. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | Bir [Xml](../../system.xml/)[Schema](../) özelliğini döndürür. |
...
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Temel tip hakkındaki bilgileri ayarlar. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Nitelikli temel tipin adını ayarlar. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını paylaşılan yerine zayıf işaretçi olarak belirler. Kapsayıcılardaki işaretçileri zayıf moda geçirmeye izin verir. |
...
|  [XmlSchemaSimpleTypeRestriction](./xmlschemasimpletyperestriction/)() | [XmlSchemaSimpleTypeRestriction](./) sınıfının yeni bir örneğini başlatır. |
...
| Tip Tanımı | Açıklama |
| --- | --- |
| [Ptr](./ptr/) | Bu sınıfın bir örneğine yönelik paylaşımlı işaretçi için takma addır. |

## Açıklamalar

Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak ayrılmalıdır. Bu tipin örneklerini yığıt üzerinde veya new operatörüyle oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisiyle sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirmek için kullanın.
