...
description: Doğrulanmış bir XML düğümünün şema doğrulama sonrası bilgi kümesini tanımlar.
type: docs
weight: 40
url: /tr/system.xml.schema/ixmlschemainfo/
---
## IXmlSchemaInfo sınıfı
...
| virtual **bool** [get_IsDefault](./get_isdefault/)() | Bu doğrulanmış XML düğümünün, XML [Schema](../) Tanım Dili (XSD) şema doğrulaması sırasında bir varsayılanın uygulanması sonucu ayarlanıp ayarlanmadığını gösteren bir değer döndürür. |
| virtual **bool** [get_IsNil](./get_isnil/)() | Bu doğrulanmış XML düğümünün değeri **nil** ise bunu gösteren bir değer döndürür. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | Bu doğrulanmış XML düğümünün dinamik şema tipini döndürür. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | Bu doğrulanmış XML düğümüne karşılık gelen derlenmiş [XmlSchemaAttribute](../xmlschemaattribute/) döndürür. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | Bu doğrulanmış XML düğümüne karşılık gelen derlenmiş [XmlSchemaElement](../xmlschemaelement/) döndürür. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | Bu doğrulanmış XML düğümünün statik XML [Schema](../) Tanım Dili (XSD) şema tipini döndürür. |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | Bu doğrulanmış XML düğümünün XmlSchemaValidity değerini döndürür. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi olarak ayarlar (paylaşılan yerine). Kaplardaki işaretçileri zayıf moda geçişine izin verir. |
