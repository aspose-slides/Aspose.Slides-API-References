...
description: "İş parçacığı güvenli sözlük uygulaması. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu türün örneğini yığıt üzerinde veya new operatörüyle asla oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisiyle sarmalayın ve bu işaretçiyi işlevlere argüman olarak geçirin."
type: docs
weight: 1
url: /tr/system.collections.concurrent/concurrentdictionary/
---
## ConcurrentDictionary sınıf

İş parçacığı güvenli sözlük uygulaması. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak ayrılmalıdır. Bu türün örneğini yığıt üzerinde veya new operatörü kullanarak asla oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisiyle sarmalayın ve bu işaretçiyi işlevlere argüman olarak geçirin.
...
| Yöntem | Açıklama |
| --- | --- |
| void [Add](./add/)(const TKey&, const TValue&) override | Sözlüğe değer ekler. |
| virtual void [Add](../../system.collections.generic/idictionary/add/)(const TKey&, const TValue&) | Konteyner içine anahtar-değer çifti ekler. |
...
| void [Clear](./clear/)() override | Konteynerdeki tüm öğeleri siler. |
| virtual **bool** [Contains](../../system.collections.generic/icollection/contains/)(const T&) const | Öğenin koleksiyonda bulunup bulunmadığını kontrol eder. |
| virtual **bool** [ContainsKey](../../system.collections.generic/idictionary/containskey/)(const TKey&) const | Konteynerin anahtar içerip içermediğini kontrol eder. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)<TKey, TValue>>, int) override | Konteyner öğelerini mevcut dizi öğelerine kopyalar. |
| void [CopyTo](../../system.collections.generic/idictionary/copyto/)([ArrayPtr](../../system/arrayptr/)<[KeyValuePair](../../system.collections.generic/keyvaluepair/)<TKey, TValue>>, int) override | Sözlük içeriğini mevcut dizi öğelerine kopyalar. |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)() | Boş sözlük oluşturur. |
...
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(int) | Önceden ayrılmış sözlük oluşturulmasına karşılık gelen aşırı yükleme; aslında bir ayırma yapmaz. |
...
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(const [SharedPtr](../../system/sharedptr/)<[IEqualityComparer](../../system.collections.generic/iequalitycomparer/)<TKey>> &) | Boş sözlük oluşturur. |
| [Dictionary](../../system.collections.generic/dictionary/dictionary/)(int, const [SharedPtr](../../system/sharedptr/)<[IEqualityComparer](../../system.collections.generic/iequalitycomparer/)<TKey>> &) | Boş sözlük oluşturur. |
...
| **bool** [get_IsFixedSize](../../system.collections.generic/idictionary/get_isfixedsize/)() const | Koleksiyon boyutunun sabit olup olmadığını kontrol eder. |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | Koleksiyonun yalnızca okunur olup olmadığını kontrol eder. |
| **bool** [get_IsSynchronized](../../system.collections.generic/idictionary/get_issynchronized/)() const | Konteynerin iş parçacığı güvenli olup olmadığını kontrol eder. |
...
| [SharedPtr](../../system/sharedptr/)<typename [ThisType::KeyCollection](../../system.collections.generic/dictionary/keycollection/)> [get_KeysInternal](./get_keysinternal/)() const override | Sözlüğün anahtarlarına erişmek için sarmalayıcı koleksiyonu alır. |
...
| [IEnumeratorPtr](../../system.collections.generic/dictionary/ienumeratorptr/) [GetEnumerator](../../system.collections.generic/dictionary/getenumerator/)() override | Sıralayıcı nesne oluşturur. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) metodunun analogu. Özel nesnelerin karma işlemesini sağlar. |
...
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey&) const | Bulunursa değeri döndürür; aksi takdirde **Value()** döndürür. |
| virtual TValue [GetValueOrDefault](../../system.collections.generic/idictionary/getvalueordefault/)(const TKey&, const TValue&) const | Bulunursa değeri döndürür; aksi takdirde **defaultValue** döndürür. |
| virtual TValue [GetValueOrNull](../../system.collections.generic/idictionary/getvalueornull/)(const TKey&) const | Bulunursa değeri döndürür; aksi takdirde **null** döndürür, yalnızca referans tipleri için anlamlıdır. |
...
| void [idx_set](./idx_set/)(const TKey&, TValue) override | Öğeyi belirli konuma ayarlar. |
| virtual void [idx_set](../../system.collections.generic/idictionary/idx_set/)(const TKey&, TValue) | Ayarlayıcı işlev. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)&) const | Nesnenin hedefTür tarafından tanımlanan tipe bir örnek olup olmadığını kontrol eder. C# 'is' operatörünün analogu. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Bir dizinin ilk öğesini döndürür, ya da dizi boşsa varsayılan bir değer döndürür. |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function<**bool**(T)>) | Bir koşulu sağlayan dizinin ilk öğesini veya böyle bir öğe bulunamazsa varsayılan bir değeri döndürür. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Bir dizinin son öğesini döndürür, ya da dizi boşsa varsayılan bir değer döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)<T, ResultType>&) | Genel bir dizinin her öğesine dönüşüm işlevi çağırır ve ortaya çıkan maksimum değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)<Source, ResultType>&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)<T, ResultType>&) | Genel bir dizinin her öğesine dönüşüm işlevi çağırır ve ortaya çıkan minimum değeri döndürür. |
...
| [SharedPtr](../../system/sharedptr/)<[IEnumerable](../../system.collections.generic/ienumerable/)<ResultType>> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)<T, [SharedPtr](../../system/sharedptr/)<[IEnumerable](../../system.collections.generic/ienumerable/)<ResultType>>> &) | Bir dizinin her öğesini yansıtır ve ortaya çıkan dizileri tek bir dizi içinde birleştirir. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const&, [String](../../system/string/) const&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'in dize durumuna özgü özelleştirmesi. |
| **bool** [Remove](./remove/)(const TKey&) override | Konteynerden öğeyi kaldırır. |
...
| **bool** [TryAdd](./tryadd/)(const TKey&, const TValue&) | Sözlüğe anahtar/değer çifti eklemeyi dener. |
| virtual **bool** [TryGetValue](../../system.collections.generic/idictionary/trygetvalue/)(const TKey&, TValue&) const | Değeri arar ve bulunursa getirir. |
...
| [BaseType](./basetype/) | Uygulama tipi. |
## Açıklamalar
...
int main()
{
  ...
  // ConcurrentDictionary'yi doldur.
...
* Ad alanı [System::Collections::Concurrent](../)
