...
description: Metin için 3d efekt özelliklerini temsil eden ThreeDFormat nesnesini döndürür. Salt okunur IThreeDFormat.
type: docs
weight: 300
url: /tr/aspose.slides/itextframeformat/get_threedformat/
---
## ITextFrameFormat::get_ThreeDFormat() metot


Metin için 3d efekt özelliklerini temsil eden [ThreeDFormat](../../threedformat/) nesnesini döndürür. Salt okunur [IThreeDFormat](../../ithreedformat/).
...
* Sınıf [IThreeDFormat](../../ithreedformat/)
* Sınıf [ITextFrameFormat](../)
