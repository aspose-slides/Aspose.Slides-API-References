...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Belirtilen ana slaytın bir kopyasını koleksiyonun sonuna ekler. Bağlantılı layout slaytları da kopyalanacaktır. |
| [iterator](./iterator/) [begin](./begin/)() | Koleksiyondaki (varsa) ilk öğeyi gösteren yineleyiciyi alır. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Koleksiyonun const-nitelikli örneğindeki (varsa) ilk öğeyi gösteren yineleyiciyi alır. |
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>, **int32_t**) override | Koleksiyondaki tüm öğeleri belirtilen diziye kopyalar. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Koleksiyonun const-nitelikli örneğindeki (varsa) son öğenin hemen sonrasını gösteren yineleyiciyi alır. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 standardına göre NaN hiçbir değere, NaN dahil, eşit olmaması gerektiği halde, iki NaN'in eşit kabul edildiği C# tarzı **float** karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 standardına göre NaN hiçbir değere, NaN dahil, eşit olmaması gerektiği halde, iki NaN'in eşit kabul edildiği C# tarzı **double** karşılaştırmasını taklit eder. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Koleksiyon içinde yineleme yapan bir numaralandırıcı (enumerator) döndürür. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [idx_get](./idx_get/)(**int32_t**) override | Belirtilen indeksteki öğeyi alır. Salt okunur [MasterSlide](../masterslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Belirtilen ana slaytın bir kopyasını koleksiyonun belirtilen konumuna ekler. Bağlantılı layout slaytları da kopyalanacaktır. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Bir dizinin ilk öğesini, dizi boş ise varsayılan bir değer olarak döndürür. |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Bir koşulu sağlayan dizinin ilk öğesini, bulunamazsa varsayılan bir değer olarak döndürür. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Bir dizinin son öğesini, dizi boş ise varsayılan bir değer olarak döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüşüm fonksiyonu uygulayarak oluşan maksimum değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüşüm fonksiyonu uygulayarak oluşan minimum değeri döndürür. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) metodunun analoğu. Özelleştirilmiş türlerin klonlanmasını sağlar. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Belirli bir nesnenin koleksiyondaki ilk ortaya çıkışını kaldırır. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Koleksiyondaki belirtilen indeksteki öğeyi kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| void [RemoveUnused](./removeunused/)(**bool**) override | Kullanılmayan ana slaytları kaldırır. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'inci şablon argümanını zayıf gösterici (paylaşımlı değil) olarak ayarlar. Kaplarda göstericileri zayıf moda geçirmeye izin verir. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Koleksiyonun const-nitelikli örneğindeki (varsa) ilk öğeyi gösteren yineleyiciyi alır. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Koleksiyonun const-nitelikli örneğindeki (varsa) son öğenin hemen sonrasını gösteren yineleyiciyi alır. |
...
| [virtualized_iterator_element](./virtualized_iterator_element/) | Sanal öğe türü. |
| [virtualized_iterator](./virtualized_iterator/) | Sanal tür. |
