...
| virtual **int32_t** [get_Count](./get_count/)() | Bir koleksiyondaki davranış sayısını döndürür. Yalnızca okuma **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [idx_get](./idx_get/)(**int32_t**) | Dizine göre ayarlamayı döndürür. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidini açar. Direkt çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
