...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# stilindeki kayan nokta karşılaştırmasını taklit eder; iki NaN, IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmamasına rağmen, eşit kabul edilir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# stilindeki kayan nokta karşılaştırmasını taklit eder; iki NaN, IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmamasına rağmen, eşit kabul edilir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() | Office Open XML belgesi içinde tek bir özel XML bölümünü benzersiz şekilde tanımlayan genel bir benzersiz tanımlayıcı (GUID) belirler. Yalnızca okuma [System::Guid](../../system/guid/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() | Özel XML bölümüyle ilişkili XML şema koleksiyonunu döndürür. Yalnızca okuma [System::String](../../system/string/)[]. |
| virtual [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() | XML verisini UTF-8 dizesi olarak döndürür. Oku [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() | XML verisini döndürür. Oku **uint8_t**[]. |
...
| virtual void [Remove](./remove/)() | Özel XML bölümünü sunumdan kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşımlı referans sayacını belirtilen değer kadar azaltır. |
| virtual void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) | Office Open XML belgesi içinde tek bir özel XML bölümünü benzersiz şekilde tanımlayan genel bir benzersiz tanımlayıcı (GUID) belirler. Yalnızca okuma [System::Guid](../../system/guid/). |
| virtual void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) | XML verisini UTF-8 dizesi olarak ayarlar. Yaz [System::String](../../system/string/). |
| virtual void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | XML verisini ayarlar. Yaz **uint8_t**[]. |
