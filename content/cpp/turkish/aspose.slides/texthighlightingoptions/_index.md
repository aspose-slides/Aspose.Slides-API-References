...
description: Metin çerçevesindeki metni vurgulamak için kullanılabilecek seçenekleri temsil eder.
type: docs
weight: 5474
url: /tr/aspose.slides/texthighlightingoptions/
---
## TextHighlightingOptions sınıfı
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN değerine eşit kabul edildiği, IEC 60559:1989 standardına göre NaN'in hiçbir değere, NaN dahil, eşit olmaması gerektiği halde, C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN değerine eşit kabul edildiği, IEC 60559:1989 standardına göre NaN'in hiçbir değere, NaN dahil, eşit olmaması gerektiği halde, C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Küçük/büyük harfe duyarlı arama için true, aksi takdirde false ayarlar. **bool** okur. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Sadece tam kelimelerle eşleşmek için true, aksi takdirde false ayarlar. **bool** okur. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Küçük/büyük harfe duyarlı arama için true, aksi takdirde false ayarlar. **bool** yazar. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Sadece tam kelimelerle eşleşmek için true, aksi takdirde false ayarlar. **bool** yazar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını paylaşılan yerine zayıf gösterici olarak ayarlar. Kaplardaki göstergeleri zayıf moda geçişine izin verir. |
...
|  [TextHighlightingOptions](./texthighlightingoptions/)() | Yeni varsayılan metin vurgulama seçenekleri oluşturur. |
...
:   [ITextHighlightingOptions](../itexthighlightingoptions/) arayüzü, 24.10 sürümünün yayınlanmasının ardından kaldırılacak.
