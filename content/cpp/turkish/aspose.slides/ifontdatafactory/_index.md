...
description: FontData fabrika arayüzü
type: docs
weight: 2172
url: /tr/aspose.slides/ifontdatafactory/
---
## IFontDataFactory sınıfı


[FontData](../fontdata/) fabrika arayüzü
...
| Yöntem | Açıklama |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [CreateFontData](./createfontdata/)([System::String](../../system/string/)) | Belirtilen yazı tipi adıyla [FontData](../fontdata/) oluşturur. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin targetType tarafından tanımlanan türe ait bir örnek temsil edip etmediğini kontrol eder. C# 'is' operatörünün analoğu. |
