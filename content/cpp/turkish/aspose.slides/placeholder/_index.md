...
| **uint32_t** [get_Index](./get_index/)() override | Bir yer tutucunun indeksini alır. Salt okunur **uint32_t**. |
| [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() override | Bir yer tutucunun yönünü alır. Salt okunur [Slides::Orientation](../orientation/). |
| [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() override | Bir yer tutucunun boyutunu alır. Salt okunur [PlaceholderSize](../placeholdersize/). |
| [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() override | Bir yer tutucunun tipini alır. Salt okunur [PlaceholderType](../placeholdertype/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşılan yerine) olarak ayarlar. Kaplarda işaretçileri zayıf moda geçişine izin verir. |
...
* Sınıf [IPlaceholder](../iplaceholder/)
