...
description: Etiketlerin (kullanıcı tanımlı çift string) koleksiyonunu temsil eder
type: docs
weight: 5435
...
| Yöntem | Açıklama |
| --- | --- |
| **int32_t** [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Koleksiyona yeni bir etiket ekler. |
...
| void [Clear](./clear/)() override | Koleksiyondaki tüm etiketleri kaldırır. |
| **bool** [Contains](./contains/)([System::String](../../system/string/)) override | Koleksiyonun belirli bir adı içerip içermediğini belirler. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Collections::Generic::KeyValuePair](../../system.collections.generic/keyvaluepair/)\<[System::String](../../system/string/), [System::String](../../system/string/)\>\>, **int32_t**) override | Koleksiyondaki tüm öğeleri belirtilen diziye kopyalar. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Koleksiyonun const nitelikli örneğinin son öğesinden hemen sonra işaret eden yineleyiciyi alır. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN, IEC 60559:1989'a göre hiçbir değere eşit olmamasına rağmen burada eşit kabul edilir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN, IEC 60559:1989'a göre hiçbir değere eşit olmamasına rağmen burada eşit kabul edilir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili kullanım içindir. |
| **int32_t** [get_Count](./get_count/)() override | Koleksiyondaki etiket sayısını döndürür. Salt okunur **int32_t**. |
...
| [System::String](../../system/string/) [GetNameByIndex](./getnamebyindex/)(**int32_t**) override | Belirtilen indeksteki bir etiketin anahtarını döndürür. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [GetNamesOfTags](./getnamesoftags/)() override | Etiketlerin adlarını döndürür. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Nesnenin gerçek tipini alır. C# [System.Object.GetType()](../../system/object/gettype/) çağrısının analoğu. |
| [System::String](../../system/string/) [GetValueByIndex](./getvaluebyindex/)(**int32_t**) override | Belirtilen indeksteki bir etiketin değerini döndürür. |
| [System::String](../../system/string/) [idx_get](./idx_get/)([System::String](../../system/string/)) override | Bir etiketin anahtar ve değer çiftini döndürür. |
| void [idx_set](./idx_set/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Bir etiketin anahtar ve değer çiftini ayarlar. |
| **int32_t** [IndexOfName](./indexofname/)([System::String](../../system/string/)) override | Belirtilen anahtarın koleksiyondaki sıfır tabanlı indeksini döndürür. |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Belirtilen indeksteki elemanı döndürür. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Belirtilen indeksteki elemanı döndürür. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Koşulu sağlayan dizinin ilk elemanını, bulunamazsa varsayılan değer döndürür. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Aslında hiçbir şey kopyalamaz, yalnızca yeni nesneyi başlatır ve alt sınıfların kopya yapımını etkinleştirir. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Aslında hiçbir şey kopyalamaz, yalnızca yeni nesneyi başlatır ve alt sınıfların kopya yapımını etkinleştirir. |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | Belirtilen ada sahip etiketi koleksiyondan kaldırır. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Belirtilen indeksteki etiketi kaldırır. |
