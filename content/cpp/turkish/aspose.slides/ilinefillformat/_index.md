...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN eşit kabul edilirken IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit olmadığı halde C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN eşit kabul edilirken IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit olmadığı halde C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() | Dolgu tipini döndürür. Okuyun [Slides::FillType](../filltype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() | Gradyan dolgu biçimini döndürür. Yalnızca okunabilir [IGradientFormat](../igradientformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() | Desen dolgu biçimini döndürür. Yalnızca okunabilir [IPatternFormat](../ipatternformat/). |
| virtual [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() | Dolgunun bir şekil ile döndürülüp döndürülmeyeceğini belirler. Okuyun [NullableBool](../nullablebool/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() | Katı dolgunun rengini döndürür. Yalnızca okunabilir [IColorFormat](../icolorformat/). |
...
| virtual void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) | Dolgu tipini ayarlar. Yaz [Slides::FillType](../filltype/). |
| virtual void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) | Dolgunun bir şekil ile döndürülüp döndürülmeyeceğini belirler. Yaz [NullableBool](../nullablebool/). |
