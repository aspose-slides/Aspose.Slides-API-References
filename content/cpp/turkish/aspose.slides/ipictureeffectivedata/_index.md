...
description: Etkili resim özelliklerini içeren değiştirilemez nesne.
type: docs
weight: 3212
url: /tr/aspose.slides/ipictureeffectivedata/
---
## IPictureEffectiveData sınıf
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'ın herhangi bir değer, NaN dahil, eşit olmadığı halde, iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'ın herhangi bir değer, NaN dahil, eşit olmadığı halde, iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() | Gömülü resmi döndürür. Salt okunur [IPPImage](../ippimage/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/)\> [get_ImageTransform](./get_imagetransform/)() | Resim dönüşüm efektleri koleksiyonunu döndürür. Salt okunur [Effects::IImageTransformOCollectionEffectiveData](../../aspose.slides.effects/iimagetransformocollectioneffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Effects::IEffectEffectiveData](../../aspose.slides.effects/ieffecteffectivedata/)\> [get_ImageTransformEffect](./get_imagetransformeffect/)(**int32_t**) | Belirtilen indeksteki resim dönüşüm efektini döndürür. |
| virtual [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() | Bağlantılı resmin URL'sini döndürür. Salt okunur [System::String](../../system/string/). |
...
Bu arayüz [IPictureFillFormatEffectiveData](../ipicturefillformateffectivedata/) ve [IBulletFormatEffectiveData](../ibulletformateffectivedata/)'in bir parçası olarak kullanılır.
