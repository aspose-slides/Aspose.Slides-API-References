...
description: "Temel gösteri ayarları. Atalar gösteri türlerini temsil eder: PresentedBySpeaker bir konuşmacı tarafından sunulur (tam ekran) BrowsedByIndividual bireysel olarak görüntülenir (pencere) BrowsedAtKiosk bir kioskte görüntülenir (tam ekran)"
type: docs
weight: 5227
...
Temel gösteri ayarları. Ata sınıflar gösteri tiplerini temsil eder: [PresentedBySpeaker](../presentedbyspeaker/) Sunucu tarafından sunulur (tam ekran) [BrowsedByIndividual](../browsedbyindividual/) Bireysel olarak görüntülenir (pencere) [BrowsedAtKiosk](../browsedatkiosk/) Kiosk'ta görüntülenir (tam ekran)
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) metodunun karşılığı. Özel nesnelerin hashlemesini sağlar. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n\.ıncı şablon argümanını zayıf gösterici (shared yerine) olarak ayarlar. Kapsayıcılardaki göstericilerin zayıf moda geçmesini sağlar. |
