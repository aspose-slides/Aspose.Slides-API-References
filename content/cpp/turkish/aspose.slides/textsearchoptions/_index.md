...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Büyük/küçük harf duyarlı arama için doğru, aksi takdirde yanlış olarak ayarlar. **bool** okunur. |
| **bool** [get_IncludeNotes](./get_includenotes/)() override | **true** olarak ayarlayın, metin arama, değiştirme veya vurgulama işlemleri sırasında slayt notlarında ([NotesSlide](../notesslide/)) bulunan metni dahil etsin. Varsayılan değer **false**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Yalnızca tam kelimelerle eşleşmesi için doğru, aksi takdirde yanlış olarak ayarlar. **bool** okunur. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Değer türü nesnesini nullptr ile referans yoluyla karşılaştırır. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Büyük/küçük harf duyarlı arama için doğru, aksi takdirde yanlış olarak ayarlar. **bool** yazılır. |
| void [set_IncludeNotes](./set_includenotes/)(**bool**) override | **true** olarak ayarlayın, metin arama, değiştirme veya vurgulama işlemleri sırasında slayt notlarında ([NotesSlide](../notesslide/)) bulunan metni dahil etsin. Varsayılan değer **false**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Yalnızca tam kelimelerle eşleşmesi için doğru, aksi takdirde yanlış olarak ayarlar. **bool** yazılır. |
