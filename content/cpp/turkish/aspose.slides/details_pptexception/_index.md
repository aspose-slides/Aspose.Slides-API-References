...
type: docs
weight: 677
url: /tr/aspose.slides/details_pptexception/
---
## Details_PptException sınıfı
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki işaretçlerin zayıf moda geçirilmesini sağlar. |
