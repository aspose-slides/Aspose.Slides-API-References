...
description: Metin için bir sekme temsili.
type: docs
weight: 5370
...
| Yöntem | Açıklama |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | Geçerli örneği aynı türdeki başka bir nesneyle karşılaştırır. |
...
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | Sekmenin hizalama stilini alır. Oku [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | Sekmenin konumunu döndürür. Bu özelliği atamak, sekmenin koleksiyondaki dizinini değiştirebilir ve Enumerator'ı geçersiz kılabilir. Oku **double**. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | Sekmenin hizalama stilini ayarlar. Yaz [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | Sekmenin konumunu ayarlar. Bu özelliği atamak, sekmenin koleksiyondaki dizinini değiştirebilir ve Enumerator'ı geçersiz kılabilir. Yaz **double**. |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | Yeni bir [Tab](./) oluşturur. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesiyle kilitlemeyi açar. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
