...
Ortak slayt görüntü özelliklerini temsil eder.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [get_DrawingGuide](./get_drawingguide/)(**int32_t**) override | Belirtilen indeksteki çizim kılavuzunu döndürür. Yalnızca okunur [Aspose::Slides::IDrawingGuide](../idrawingguide/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Çizim kılavuzlarının koleksiyonunu döndürür. Yalnızca okunur [IDrawingGuidesCollection](../idrawingguidescollection/) |
| **int32_t** [get_Scale](./get_scale/)() override | Görünüm ölçekleme oranını yüzde olarak belirtir. Okur **int32_t**. |
| **bool** [get_VariableScale](./get_variablescale/)() override | Görünüm içeriğinin mevcut pencere boyutuna en iyi şekilde otomatik olarak ölçeklenmesi gerektiğini belirtir. Okur **bool**. |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitlemesini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) izleme nesnesini kullanın. |
...
| void [set_Scale](./set_scale/)(**int32_t**) override | Görünüm ölçekleme oranını yüzde olarak belirtir. Yazar **int32_t**. |
| void [set_VariableScale](./set_variablescale/)(**bool**) override | Görünüm içeriğinin mevcut pencere boyutuna en iyi şekilde otomatik olarak ölçeklenmesi gerektiğini belirtir. Yazar **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açmasını uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) izleme nesnesini kullanın. |
...
Aşağıdaki örnek, PowerPoint [Presentation](../presentation/) slaytı için yakınlaştırma değerinin nasıl ayarlanacağını gösterir.
```cpp
// Bir sunum dosyasını temsil eden Presentation nesnesi oluşturuluyor
auto presentation = System::MakeObject<Presentation>(u"demo.pptx");

// Presentation'ın Görünüm Özelliklerini ayarlama
presentation->get_ViewProperties()->get_SlideViewProperties()->set_Scale(100);
// Slayt görünümü için yüzde olarak yakınlaştırma değeri
presentation->get_ViewProperties()->get_NotesViewProperties()->set_Scale(100);
// Not görünümü için yüzde olarak yakınlaştırma değeri
presentation->Save(u"Zoom_out.pptx", SaveFormat::Pptx);
```

## İlgili

* Sınıf [ICommonSlideViewProperties](../icommonslideviewproperties/)
