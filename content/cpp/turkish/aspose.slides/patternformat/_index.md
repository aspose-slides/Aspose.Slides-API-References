...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_BackColor](./get_backcolor/)() override | Arka plan desen rengini döndürür. Salt okunur [IColorFormat](../icolorformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ForeColor](./get_forecolor/)() override | Ön plan desen rengini döndürür. Salt okunur [IColorFormat](../icolorformat/). |
...
| [Aspose::Slides::PatternStyle](../patternstyle/) [get_PatternStyle](./get_patternstyle/)() override | Desen stilini döndürür. Okunur [Slides::PatternStyle](../patternstyle/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| **int32_t** [GetHashCode](../pviobject/gethashcode/)() const override | Karma kodu döndürür. |
| [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/), [System::Drawing::Color](../../system.drawing/color/)) override | Belirtilen renklerle desen doldurması için bir karo görüntüsü oluşturur. |
| [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/)) override | Desen doldurması için bir karo görüntüsü oluşturur. |
...
| void [set_PatternStyle](./set_patternstyle/)([Aspose::Slides::PatternStyle](../patternstyle/)) override | Desen stilini ayarlar. Yaz [Slides::PatternStyle](../patternstyle/). |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesi kilidini açmayı uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
...
* Sınıf [IPatternFormat](../ipatternformat/)
