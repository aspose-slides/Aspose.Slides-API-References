...
type: docs
weight: 755
url: /tr/aspose.slides/details_pptxunsupportedformatexception/
---
## Details_PptxUnsupportedFormatException sınıf
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) işlevinin dize ve nullptr durumu için özelleştirilmiş hali. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) işlevinin dize durumları için özelleştirilmiş hali. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Belirtilen değer kadar paylaşılan referans sayacını azaltır. |
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Belirli bir istisnaya atanmış kodlanmış sayısal bir değer olan HRESULT'ı ayarlar. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) yöntemini uygular; bu yöntem [ExceptionWrapper](../../system/exceptionwrapper/) sınıfı tarafından çağrılır. Bu sınıfın std::exception'tan türetilmemiş olmasına rağmen türev sınıflar korumalı/özel üyeleri kullanarak kendi mantıklarını uygulayabilir. Bu yöntemin uygulamasını [ExceptionWrapper](../../system/exceptionwrapper/)'ye taşımak bu mantığı bozabilir. |
| virtual  [~Object](../../system/object/~object/)() | Nesneyi yok eder. Tüm dahili veri yapılarını serbest bırakır. |
## İlgili

* Sınıf [Details_PptxReadException](../details_pptxreadexception/)
