...
| Yöntem | Açıklama |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | C# [Object.Equals](../../system/object/equals/) söz dizimi kullanarak nesneleri karşılaştırır. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'in herhangi bir değer, NaN dahil, eşit olmadığı halde iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in herhangi bir değer, NaN dahil, eşit olmadığı halde iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) | Bu yazarın belirtilen dizindeki yorumunu döndürür. Sadece okunabilir [Aspose::Slides::IComment](../icomment/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() | Bu yazarın yaptığı yorum koleksiyonunu döndürür. Sadece okunabilir [ICommentCollection](../icommentcollection/). |
| virtual [System::String](../../system/string/) [get_Initials](./get_initials/)() | Yazarın baş harflerini döndürür. Okuma [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Yazarın adını döndürür. Okuma [System::String](../../system/string/). |
...
| virtual void [Remove](./remove/)() | Yazarın üst koleksiyondan kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Belirtilen değer kadar paylaşılan referans sayacını azaltır. |
| virtual void [set_Initials](./set_initials/)([System::String](../../system/string/)) | Yazarın baş harflerini ayarlar. Yaz [System::String](../../system/string/). |
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Yazarın adını ayarlar. Yaz [System::String](../../system/string/). |
