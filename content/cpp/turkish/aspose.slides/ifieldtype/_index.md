...
description: Bir alan türünü temsil eder. Bu değer, alan bölümünün güncellendiğinde hangi metnin ayarlanacağını belirler.
type: docs
weight: 2094
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN değerinin eşit kabul edildiği, IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmadığı halde C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN değerinin eşit kabul edildiği, IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmadığı halde C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [System::String](../../system/string/) [get_InternalString](./get_internalstring/)() | Bu FieldTypeEx nesnesinin dahili adını döndürür. Okuyun [System::String](../../system/string/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Değer türü nesneyi nullptr ile referans yoluyla karşılaştırır. |
...
| virtual void [set_InternalString](./set_internalstring/)([System::String](../../system/string/)) | Bu FieldTypeEx nesnesinin dahili adını döndürür. Yazın [System::String](../../system/string/). |
