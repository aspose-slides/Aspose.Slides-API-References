...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Ses verisinin bir kopyasını döndürür. Büyük miktarda veri durumunda, ses verisinin belleğe gereksiz yüklenmesini veya OutOfMemoryException oluşmasını önlemek için [IAudio::GetStream](./getstream/) yönteminin kullanılmasını düşünün. Yalnızca okuma **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Sesin MIME türünü [IAudio::get_BinaryData](./get_binarydata/) içinde kodlanmış olarak döndürür. Yalnızca okuma [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | Okuma için bir Stream döndürür. Kullanımdan sonra 'using' kullanın veya akışı kapatın. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir gösterici (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki göstergeleri zayıf moda geçişine izin verir. |
