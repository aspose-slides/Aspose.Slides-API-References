...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989’a göre NaN hiçbir değere eşit olmayıp NaN da dahil olmak üzere iki NaN’ın eşit kabul edildiği C#-stili kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989’a göre NaN hiçbir değere eşit olmayıp NaN da dahil olmak üzere iki NaN’ın eşit kabul edildiği C#-stili kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Sadece dahili amaçlar için. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Çizim kılavuzunun rengini döndürür. [System::Drawing::Color](../../system.drawing/color/)'yi okuyun. |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Çizim kılavuzunun yönünü döndürür. [Slides::Orientation](../orientation/)'yi okuyun. |
| virtual **float** [get_Position](./get_position/)() | Çizim kılavuzunun konumunu, slaytın sol üst köşesinden ölçülen puan cinsinden döndürür. **float**'ı okuyun. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Çizim kılavuzunun rengini ayarlar. [System::Drawing::Color](../../system.drawing/color/)'yi yazın. |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | Çizim kılavuzunun yönünü ayarlar. [Slides::Orientation](../orientation/)'yi yazın. |
| virtual void [set_Position](./set_position/)(**float**) | Çizim kılavuzunun konumunu, slaytın sol üst köşesinden ölçülen puan cinsinden ayarlar. **float**'ı yazın. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n-inci şablon argümanını zayıf işaretçi (paylaşımlı değil) olarak ayarlar. Kapsayıcılarda işaretçileri zayıf moda geçişe izin verir. |
