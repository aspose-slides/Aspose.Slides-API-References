...
---
## IPatternFormatEffectiveData sınıf
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_BackColor](./get_backcolor/)() | Arka plan desen rengini döndürür. Salt okunur [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ForeColor](./get_forecolor/)() | Ön plan desen rengini döndürür. Salt okunur [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::PatternStyle](../patternstyle/) [get_PatternStyle](./get_patternstyle/)() | Desen stilini döndürür. Salt okunur [Slides::PatternStyle](../patternstyle/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTileIImage](./gettileiimage/)([System::Drawing::Color](../../system.drawing/color/), [System::Drawing::Color](../../system.drawing/color/)) | Belirtilen renklerle desen dolgu için bir döşeme resmi oluşturur. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Değer türü nesneyi nullptr ile referans bazında karşılaştırır. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir gösterici (paylaşılan yerine) ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçirmeye olanak tanır. |
...
Bu arayüz [IFillFormatEffectiveData](../ifillformateffectivedata/) ve [ILineFillFormatEffectiveData](../ilinefillformateffectivedata/)'nin bir parçası olarak kullanılır.
