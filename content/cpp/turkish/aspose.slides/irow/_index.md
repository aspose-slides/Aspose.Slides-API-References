...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN herhangi bir değere (NaN dahil) eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN herhangi bir değere (NaN dahil) eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
...
| virtual **double** [get_Height](./get_height/)() | Bir satırın yüksekliğini döndürür. Salt okunur **double**. |
...
| virtual **double** [get_MinimalHeight](./get_minimalheight/)() | Bir satırın alabileceği en düşük yüksekliği döndürür. Okunur **double**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() | [RowFormat](../rowformat/) nesnesini döndürür; bu nesne bu satırın biçimlendirme özelliklerini içerir. Salt okunur [IRowFormat](../irowformat/). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../../system.collections.generic/ienumerable/getenumerator/)() | Enumeratörü alır. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../icellcollection/idx_get/)(**int32_t**) | Pozisyonuna göre bir hücre döndürür. Salt okunur [ICell](../icell/). |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Bir dizide herhangi bir elemanın mevcut olup olmadığını veya bir koşulu sağlayıp sağlamadığını belirler. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Bir dizinin ilk elemanını döndürür; dizin boşsa varsayılan bir değer döndürür. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her elemanına bir dönüştürme işlevi uygular ve en büyük elde edilen değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her elemanına bir dönüştürme işlevi uygular ve en küçük elde edilen değeri döndürür. |
...
| virtual void [set_MinimalHeight](./set_minimalheight/)(**double**) | Bir satırın alabileceği en düşük yüksekliği ayarlar. **double** yazın. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi olarak ayarlar (paylaşılan yerine). Kaplardaki işaretçileri zayıf moda geçişe izin verir. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Tanımlı bölüm format özelliklerini tüm öğenin bölümlerine ayarlar. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Tanımlı paragraf format özelliklerini tüm öğenin paragraflarına ayarlar. |
| virtual void [SetTextFormat](../ibulktextformattable/settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Tanımlı metin çerçevesi format özelliklerini tüm öğenin metin çerçevelerine ayarlar. |
...
* Sınıf [ICellCollection](../icellcollection/)
