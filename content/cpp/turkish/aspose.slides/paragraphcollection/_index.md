...
| Yöntem | Açıklama |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Koleksiyonun sonuna bir [Paragraph](../paragraph/) ekler. |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | [ParagraphCollection](./) içeriğini koleksiyonun sonuna ekler. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) override | Belirtilen html dizesinden metni koleksiyona ekler. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) override | Belirtilen html dizesinden metni koleksiyona ekler. |
...
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | [ICollection](../../system.collections.generic/icollection/) içinde belirli bir değerin olup olmadığını belirler. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>, **int32_t**) | [ICollection](../../system.collections.generic/icollection/) öğelerini belirli bir [System::Array](../../system/array/) indeksinden başlayarak bir [System::Array](../../system/array/)'ya kopyalar. |
| [iterator](./iterator/) [end](./end/)() | Koleksiyondaki (varsa) son öğenin hemen sonrasını gösteren yineleyiciyi alır. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Koleksiyonun const nitelikli örneğinin (varsa) son öğesinin hemen sonrasını gösteren yineleyiciyi alır. |
...
| [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) override | Belirtilen paragrafları HTML'e dönüştürür ve String nesnesi olarak döndürür. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() | [ICollection](../../system.collections.generic/icollection/)'nin salt okunur olup olmadığını gösteren değeri alır. Salt Okunur **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>\> [GetEnumerator](./getenumerator/)() override | Koleksiyon içinde yinelemeye olan bir enumeratörü döndürür. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) override | Belirtilen indeksteki öğeyi alır. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | [IList](../../system.collections.generic/ilist/) içinde belirli bir öğenin indeksini belirler. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | [Paragraph](../paragraph/) öğesini belirtilen indekste koleksiyona ekler. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | [ParagraphCollection](./) içeriğini belirtilen indekste koleksiyona ekler. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Giriş dizisindeki her öğe üzerinde bir dönüşüm fonksiyonu çağırılarak elde edilen değerlerin ortalamasını hesaplar. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesinde bir dönüşüm fonksiyonu yürütür ve elde edilen maksimum değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesinde bir dönüşüm fonksiyonu yürütür ve elde edilen minimum değeri döndürür. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Bir dizinin her öğesini projekte eder ve oluşan dizileri tek bir dizide birleştirir. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<Source, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<Result\>\>\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Bir dizinin başından belirli sayıda ardışık öğeyi atlar ve kalan kısmı döndürür. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Belirtilen nesnenin [ICollection](../../system.collections.generic/icollection/)'deki ilk oluşumunu kaldırır. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Koleksiyonda belirtilen indeksteki öğeyi kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'inci şablon argümanını zayıf gösterici (shared yerine) olarak ayarlar. Kaplarda göstericileri zayıf moda geçirmeye izin verir. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) metodunun benzeri. Özel nesneleri string'e dönüştürmeyi sağlar. |
...
* Sınıf [IParagraphCollection](../iparagraphcollection/)
