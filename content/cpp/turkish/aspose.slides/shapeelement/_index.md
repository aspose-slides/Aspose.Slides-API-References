...
Aynı dış hat ve dolgu özelliklerine sahip şeklin bir parçasını temsil eder.
...
| [ShapeElementFillSource](../shapeelementfillsource/) [get_FillSource](./get_fillsource/)() | Bir elemanın nasıl doldurulacağını hakkında bilgi döndürür. Salt okunur [ShapeElementFillSource](../shapeelementfillsource/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Shape](../shape/)\> [get_ParentShape](./get_parentshape/)() | Elemanın oluşturulduğu bir Shape_PPT döndürür. Salt okunur [Shape](../shape/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_PathPoints](./get_pathpoints/)() | Elemanın yolunun geometrisini tanımlayan nokta dizisini alır. |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_PathTypes](./get_pathtypes/)() | Elemanın yolundaki her noktanın tipini belirten bayt değerleri dizisini alır. |
| [ShapeElementStrokeSource](../shapeelementstrokesource/) [get_StrokeSource](./get_strokesource/)() | Bir elemanın nasıl çizileceği hakkında bilgi döndürür. Salt okunur [ShapeElementStrokeSource](../shapeelementstrokesource/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 'n'uncu şablon argümanını zayıf gösterge (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki göstergelerin zayıf moda geçmesini sağlar. |
...
* Sınıf [IShapeElement](../ishapeelement/)
