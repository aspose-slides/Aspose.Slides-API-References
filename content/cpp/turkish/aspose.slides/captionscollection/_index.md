...
| Method | Açıklama |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::String](../../system/string/)) override | WebVTT kapalı altyazılarını koleksiyonun sonuna ekler. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [Add](./add/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | WebVTT kapalı altyazılarını bir akıştan koleksiyonun sonuna ekler. |
| [iterator](./iterator/) [begin](./begin/)() | Koleksiyondaki (varsa) ilk öğeyi işaret eden yineleyiciyi alır. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Koleksiyonun const nitelikli örneğindeki (varsa) ilk öğeyi işaret eden yineleyiciyi alır. |
...
| void [Clear](./clear/)() override | Koleksiyondan tüm kapalı altyazıları kaldırır. |
| [iterator](./iterator/) [end](./end/)() | Koleksiyondaki (varsa) son öğenin hemen sonrasını işaret eden yineleyiciyi alır. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Koleksiyonun const nitelikli örneğindeki (varsa) son öğenin hemen sonrasını işaret eden yineleyiciyi alır. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN, IEC 60559:1989'a göre NaN hiçbir değere eşit olmasa da, eşit kabul edilir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN, IEC 60559:1989'a göre NaN hiçbir değere eşit olmasa da, eşit kabul edilir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **int32_t** [get_Count](./get_count/)() override | Koleksiyondaki öğe sayısını döndürür. Yalnızca okuma **int32_t**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\>\>\> [GetEnumerator](./getenumerator/)() override | Koleksiyon içinde yineleme yapan bir numaralandırıcı döndürür. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\> [idx_get](./idx_get/)(**int32_t**) override | Belirtilen indeksteki kapalı altyazıyı döndürür. Yalnızca okuma [ICaptions](../icaptions/). |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüştürme işlevi uygulayarak en büyük sonucu döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüştürme işlevi uygulayarak en küçük sonucu döndürür. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) için string ve nullptr durumuna özgü bir özel durum. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICaptions](../icaptions/)\>) override | Belirtilen kapalı altyazıyı koleksiyondan kaldırır. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Belirtilen indeksteki kapalı altyazıyı kaldırır. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Koleksiyonun const nitelikli örneğindeki (varsa) ilk öğeyi işaret eden yineleyiciyi alır. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Koleksiyonun const nitelikli örneğindeki (varsa) son öğenin hemen sonrasını işaret eden yineleyiciyi alır. |
