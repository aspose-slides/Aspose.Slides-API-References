...
| **int32_t** [get_Count](./get_count/)() override | Ayarlamaların sayısını döndürür. Salt okunur **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAdjustValue](../iadjustvalue/)\> [idx_get](./idx_get/)(**int32_t**) override | İndeks ile ayarlamayı döndürür. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'inci şablon argümanını zayıf gösterici (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçişine izin verir. |
...
* Sınıf [IAdjustValueCollection](../iadjustvaluecollection/)
