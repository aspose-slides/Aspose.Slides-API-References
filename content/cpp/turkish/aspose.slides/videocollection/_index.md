...
Bir [Video](../video/) nesnesi koleksiyonunu temsil eder.
...
| Yöntem | Açıklama |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\> [AddVideo](./addvideo/)([System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\>) override | Başka bir sunumdan bir video dosyasının kopyasını ekler. |
| [System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\> [AddVideo](./addvideo/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [LoadingStreamBehavior](../loadingstreambehavior/)) override | Bir akıştan bir sunuma video oluşturur ve ekler. |
| [System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\> [AddVideo](./addvideo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Bir byte dizisinden bir sunuma video oluşturur ve ekler. |
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\>\>, **int32_t**) override | Videoları belirtilen dizine, belirtilen indeksten başlayarak kopyalar. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# stilinde kayan nokta karşılaştırmasını taklit eder; iki NaN eşit kabul edilir, IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# stilinde kayan nokta karşılaştırmasını taklit eder; iki NaN eşit kabul edilir, IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **int32_t** [get_Count](./get_count/)() override | Koleksiyondaki video dosyalarının sayısını döndürür. Salt okunur **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Koleksiyon erişiminin eşzamanlı (iş parçacığı güvenli) olup olmadığını belirten değeri döndürür. Salt okunur **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\>\>\> [GetEnumerator](./getenumerator/)() override | Koleksiyon üzerinde yineleme yapan bir enumerator döndürür. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVideo](../ivideo/)\> [idx_get](./idx_get/)(**int32_t**) override | Belirtilen indeksteki öğeyi alır. Salt okunur [IVideo](../ivideo/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin targetType tarafından açıklanan tipe ait bir örnek olup olmadığını denetler. C# 'is' operatörünün analogu. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüştürme işlevi çağırır ve en büyük sonucu döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüştürme işlevi çağırır ve en küçük sonucu döndürür. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'inci şablon argümanını zayıf gösterici (shared yerine) olarak ayarlar. Kapsayıcılardaki göstergeleri zayıf kipine geçişine izin verir. |
| int [SharedCount](../../system/object/sharedcount/)() const | Paylaşılan referans sayacının mevcut değerini alır. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Paylaşılan referans sayacını arttırır. Doğrudan çağrılmamalıdır; bunun yerine akıllı göstergeler ya da ThisProtector kullanılmalıdır. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Paylaşılan referans sayacını azaltır ve döndürür. Doğrudan çağrılmamalıdır; bunun yerine akıllı göstergeler ya da ThisProtector kullanılmalıdır. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açmasını uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) muhafaza nesnesini kullanın. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zayıf referans sayacını arttırır. Doğrudan çağrılmamalıdır; bunun yerine akıllı göstergeler ya da ThisProtector kullanılmalıdır. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zayıf referans sayacını azaltır. Doğrudan çağrılmamalıdır; bunun yerine akıllı göstergeler ya da ThisProtector kullanılmalıdır. |
...
| Typedef | Açıklama |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Geçerli koleksiyonda iteratör tipleri olarak kullanılan bir koleksiyon tipidir. |
| [iterator](./iterator/) | İteratör tipi. |
| [const_iterator](./const_iterator/) | Const iteratör tipi. |
| [virtualized_iterator_element](./virtualized_iterator_element/) | Sanalleştirilmiş öğe tipi. |
| [virtualized_iterator](./virtualized_iterator/) | Sanalleştirilmiş tip. |

## Ayrıca Bakınız

* Sınıf [DomObject](../domobject/)
* Sınıf [IVideoCollection](../ivideocollection/)
