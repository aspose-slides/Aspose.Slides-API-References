...
description: Kilitler için temel sınıfı temsil eder (devre dışı bırakılmış işlem).
type: docs
weight: 157
...
Kilitler için temel sınıfı temsil eder (devre dışı bırakılmış işlem).
...
| **bool** [get_NoLocks](./get_nolocks/)() override | Tüm kilit bayrakları devre dışı bırakılmışsa true döndürür. Salt okunur **bool**. |
