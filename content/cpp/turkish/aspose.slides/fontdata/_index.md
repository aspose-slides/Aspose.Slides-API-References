...
description: Bir font tanımını temsil eder. Değiştirilemez.
type: docs
weight: 911
...
| Yöntem | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | İki [FontData](./) örneğinin eşit olup olmadığını belirler. |
...
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca iç kullanım amaçları için. |
| [FontData](./fontdata/)([System::String](../../system/string/)) | Belirtilen font adını kullanarak yeni bir [FontData](./) nesnesi oluşturur. |
| [System::String](../../system/string/) [get_FontName](./get_fontname/)() override | Font adını döndürür. [System::String](../../system/string/) okuyun. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| [System::String](../../system/string/) [GetFontName](./getfontname/)([System::SharedPtr](../../system/sharedptr/)\<[Theme::IThemeEffectiveData](../../aspose.slides.theme/ithemeeffectivedata/)\>) override | Tema referansını kullanılan gerçek bir fontla değiştirerek font adını döndürür. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Belirli bir tip için bir karma (hash) fonksiyonu olarak hizmet verir; karma algoritmaları ve hash tablosu gibi veri yapılarına uygundur. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Gerçekte hiçbir şeyi kopyalamaz; sadece yeni nesneyi başlatır ve alt sınıfların kopya yapıcılarıyla oluşturulmasını sağlar. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Gerçekte hiçbir şeyi kopyalamaz; sadece yeni nesneyi başlatır ve alt sınıfların kopya yapıcılarıyla oluşturulmasını sağlar. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | String temsilini döndürür. |
