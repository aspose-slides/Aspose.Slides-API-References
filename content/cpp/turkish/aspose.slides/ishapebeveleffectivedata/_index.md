...
description: Etkili şeklin yüz relief özelliklerini içeren değiştirilemez nesne.
type: docs
weight: 3667
url: /tr/aspose.slides/ishapebeveleffectivedata/
---
## IShapeBevelEffectiveData sınıfı

Etkili şeklin yüz relief özelliklerini içeren değiştirilemez nesne.
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Bevel türü. Salt okunur [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Bevel yüksekliği. Salt okunur **double**. |
| virtual **double** [get_Width](./get_width/)() | Bevel genişliği. Salt okunur **double**. |
