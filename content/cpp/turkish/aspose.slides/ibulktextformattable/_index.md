...
description: Alt metin öğelerinin biçimlerini toplu olarak ayarlama olanağına sahip bir nesneyi temsil eder.
type: docs
weight: 1548
url: /tr/aspose.slides/ibulktextformattable/
---
## IBulkTextFormattable sınıfı

Alt metin öğelerinin biçimlerini toplu olarak ayarlama olanağına sahip bir nesneyi temsil eder.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit olmasa da, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit olmasa da, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
...
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Tanımlı bölüm biçim özelliklerini tüm öğenin bölümlerine uygular. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) | Tanımlı paragraf biçim özelliklerini tüm öğenin paragraflarına uygular. |
| virtual void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) | Tanımlı metin çerçevesi biçim özelliklerini tüm öğenin metin çerçevelerine uygular. |
