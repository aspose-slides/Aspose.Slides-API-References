...
description: Bu sınıf, uzun süren görevlerde kesmenin istendiğini bildirmek için kullanılacak belirteci temsil eder.
type: docs
weight: 3056
url: /tr/aspose.slides/interruptiontoken/
---
## InterruptionToken sınıfı

Bu sınıf, uzun süren görevlerde kesmenin istenip istenmediğini bildirmek için kullanılacak belirteci temsil eder.
...
| **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() override | Kesmenin istendiği durumda **bool**.true döndürür. |
| static [System::SharedPtr](../../system/sharedptr/)\<[InterruptionToken](./)\> [get_None](./get_none/)() | Boş bir kesinti belirteci temsil eder. |
...
| void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() override | Kesmenin istendiği durumda bir istisna fırlatır. |
