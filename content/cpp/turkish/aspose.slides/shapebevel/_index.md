...
description: Şeklin ana yüz rölyef özelliklerini içerir.
type: docs
weight: 5097
...
Şeklin ana yüz rölyef özelliklerini içerir.
...
| [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() override | Kemer tipi. [BevelPresetType](../bevelpresettype/) oku. |
| **double** [get_Height](./get_height/)() override | Kemer yüksekliği. **double** oku. |
...
| **double** [get_Width](./get_width/)() override | Kemer genişliği. **double** oku. |
...
| void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) override | Kemer tipi. [BevelPresetType](../bevelpresettype/) yaz. |
| void [set_Height](./set_height/)(**double**) override | Kemer yüksekliği. **double** yaz. |
| void [set_Width](./set_width/)(**double**) override | Kemer genişliği. **double** yaz. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon bağımsız değişkeni zayıf işaretçi (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki işaretçilerin zayıf moda geçmesini sağlar. |
