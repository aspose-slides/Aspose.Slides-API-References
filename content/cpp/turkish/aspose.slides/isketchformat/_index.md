...
description: Satır çizim formatı için özellikleri temsil eder.
type: docs
weight: 3732
url: /tr/aspose.slides/isketchformat/
---
## ISketchFormat sınıfı

Satır çizim formatı için özellikleri temsil eder.
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | Çizim tipini döndürür. [Slides::LineSketchType](../linesketchtype/)'yi okuyun. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucusu. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya oluşturmasını mümkün kılar. |
...
| virtual void [set_SketchType](./set_sketchtype/)([LineSketchType](../linesketchtype/)) | Çizim tipini ayarlar. [Slides::LineSketchType](../linesketchtype/)'yi yazın. |
