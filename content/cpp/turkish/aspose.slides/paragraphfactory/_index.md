...
| Yöntem | Açıklama |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [CreateParagraph](./createparagraph/)() override | Yeni boş bir paragraf oluşturur. |
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [CreateParagraph](./createparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Belirtilen paragraf verileriyle yeni bir paragraf oluşturur. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 'n'üncü şablon argümanını zayıf gösterici (paylaşımlı yerine) olarak ayarlar (paylaşımlı yerine). Kapsayıcılardaki göstericilerin zayıf moda geçmesini sağlar. |
...
* Sınıf [IParagraphFactory](../iparagraphfactory/)
