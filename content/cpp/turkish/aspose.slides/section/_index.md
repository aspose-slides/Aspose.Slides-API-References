...
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Bölümün adı. |
| [System::Guid](../../system/guid/) [get_SectionId](./get_sectionid/)() override | [Section](./) Kimliği. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_StartedFromSlide](./get_startedfromslide/)() override | Bölümün ilk slaytını döndürür. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISectionSlideCollection](../isectionslidecollection/)\> [GetSlidesListOfSection](./getslideslistofsection/)() override | Bölümdeki slaytların listesini döndürür. |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Bölümün adı. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'inci şablon argümanını paylaşımlı yerine zayıf işaretçi olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçiş yapmaya izin verir. |
