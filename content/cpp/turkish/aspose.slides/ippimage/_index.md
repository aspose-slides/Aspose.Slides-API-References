...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Bir görüntünün verisinin bir kopyasını döndürür. Salt okunur **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Bir görüntünün MIME tipini [IPPImage::get_BinaryData](./get_binarydata/) içinde kodlanmış olarak döndürür. Salt okunur [System::String](../../system/string/). |
| virtual **int32_t** [get_Height](./get_height/)() | Bir görüntünün yüksekliğini döndürür. Salt okunur **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [get_Image](./get_image/)() | Bir görüntünün bir kopyasını döndürür. Salt okunur [System::Drawing::Image](../../system.drawing/image/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\> [get_SvgImage](./get_svgimage/)() const | Döndürür [ISvgImage](../isvgimage/) nesnesi [ISvgImage](../isvgimage/). |
| virtual **int32_t** [get_Width](./get_width/)() | Bir görüntünün genişliğini döndürür. Salt okunur **int32_t**. |
| virtual **int32_t** [get_X](./get_x/)() | Bir görüntünün X-ötelemesini döndürür. Salt okunur **int32_t**. |
| virtual **int32_t** [get_Y](./get_y/)() | Bir görüntünün Y-ötelemesini döndürür. Salt okunur **int32_t**. |
...
| virtual void [ReplaceImage](./replaceimage/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Görüntü verisini değiştirir. |
| virtual void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\>) | Görüntüyü değiştirir. |
| virtual void [ReplaceImage](./replaceimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](./)\>) | Görüntüyü değiştirir. |
| virtual void [set_SvgImage](./set_svgimage/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgImage](../isvgimage/)\>) | [ISvgImage](../isvgimage/) nesnesi [ISvgImage](../isvgimage/) ayarlar. |
