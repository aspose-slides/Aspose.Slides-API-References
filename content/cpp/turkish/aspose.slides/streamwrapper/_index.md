...
| Yöntem | Açıklama |
| --- | --- |
| void [Close](./close/)() override | Geçerli akışı kapatır ve tüm kaynakları serbest bırakır. |
...
| void [Flush](./flush/)() override | Bu akış için tüm tamponları temizler ve tamponlanmış verilerin temel aygıta yazılmasını sağlar. |
| **bool** [get_CanRead](./get_canread/)() override | Geçerli akışın okuma destekleyip desteklemediğini gösteren bir değer döndürür. Salt okunur **bool**. |
| **bool** [get_CanSeek](./get_canseek/)() override | Geçerli akışın arama (seek) destekleyip desteklemediğini gösteren bir değer döndürür. Salt okunur **bool**. |
| **bool** [get_CanWrite](./get_canwrite/)() override | Geçerli akışın yazma destekleyip desteklemediğini gösteren bir değer döndürür. Salt okunur **bool**. |
| **int64_t** [get_Length](./get_length/)() override | Akışın bayt cinsinden uzunluğunu alır. Salt okunur **int64_t**. |
| **int64_t** [get_Position](./get_position/)() override | Geçerli akış içindeki konumu alır. Salt okunur **int64_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [get_Stream](./get_stream/)() override | Bir akış alır. Salt okunur [System::IO::Stream](../../system.io/stream/). |
...
| void [Read](./read/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) override | Geçerli akıştan bir bayt dizisini okur ve akış içindeki konumu okunan bayt sayısı kadar ilerletir. |
| **int32_t** [ReadByte](./readbyte/)() override | Akıştan bir bayt okur ve akış içindeki konumu bir bayt ilerletir; akışın sonundaysa -1 döndürür. |
...
| **int64_t** [Seek](./seek/)(**int64_t**, [System::IO::SeekOrigin](../../system.io/seekorigin/)) override | Geçerli akış içindeki konumu ayarlar |
...
| void [Write](./write/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) override | Geçerli akışa bir bayt dizisi yazar ve bu akıştaki mevcut konumu yazılan bayt sayısı kadar ilerletir. |
| void [WriteByte](./writebyte/)(**uint8_t**) override | Akıştaki mevcut konuma bir bayt yazar ve akış içindeki konumu bir bayt ilerletir. |
