...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | [EffectFormat](../effectformat/) döndürür [BackgroundType::OwnBackground](../backgroundtype/) doldurma için. Salt okunur [IEffectFormat](../ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | [FillFormat](../fillformat/) döndürür [BackgroundType::OwnBackground](../backgroundtype/) doldurma için. Salt okunur [IFillFormat](../ifillformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | [ColorFormat](../colorformat/) döndürür [BackgroundType::Themed](../backgroundtype/) doldurma için. Salt okunur [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | [BackgroundType::Themed](../backgroundtype/) doldurmanın arka plan teması koleksiyonundaki indeksini döndürür. 0, dolgu olmadığını gösterir. 1..999 - indeks. **uint16_t** okunur. |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | Arka plan dolgusunun tipini döndürür. [BackgroundType](../backgroundtype/) okunur. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | Uygulanan kalıtım ile etkili arka plan verisini alır. |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | [BackgroundType::Themed](../backgroundtype/) doldurmanın arka plan teması koleksiyonundaki indeksini döndürür. 0, dolgu olmadığını gösterir. 1..999 - indeks. **uint16_t** yazılır. |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | Arka plan dolgusunun tipini döndürür. [BackgroundType](../backgroundtype/) yazılır. |
