...
| Metot | Açıklama |
| --- | --- |
| void [AddField](./addfield/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) override | Bu bölümü otomatik olarak güncellenen alana dönüştürür. |
| void [AddField](./addfield/)([System::String](../../system/string/)) override | Bu bölümü otomatik olarak güncellenen alana dönüştürür. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IField](../ifield/)\> [get_Field](./get_field/)() override | Bu bölümün bir alanını döndürür. Salt okunur [IField](../ifield/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_PortionFormat](./get_portionformat/)() override | Biçimlendirme nesnesini döndürür; bu nesne, metin bölümünün açıkça ayarlanmış biçim özelliklerini, kalıtım uygulanmadan içerir. Salt okunur [IPortionFormat](../iportionformat/). |
| [System::String](../../system/string/) [get_Text](./get_text/)() override | Bir bölümün düz metnini alır. Okunur [System::String](../../system/string/). |
| [System::Drawing::PointF](../../system.drawing/pointf/) [GetCoordinates](./getcoordinates/)() override | Bölümün başlangıç koordinatlarını alır. Noktanın X koordinatı, sol kenar boşluğu dahil ilk karakterden itibaren bölümün başlangıcını temsil eder. Y koordinatı üst kenar boşluğunu içerir. |
...
| [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() override | Bölümü sınırlayan dikdörtgenin koordinatlarını alır. Dikdörtgen, boş satırlar dahil, bölümdeki tüm metin satırlarını içerir. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Nesnenin gerçek tipini alır. C# [System.Object.GetType()](../../system/object/gettype/) çağrısının benzeri. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin targetType ile tanımlanan tipin bir örneği olup olmadığını kontrol eder. C# 'is' operatörünün benzeri. |
...
|  [Portion](./portion/)([System::String](../../system/string/)) | [Portion](./) sınıfının yeni bir örneğini başlatır. |
|  [Portion](./portion/)([System::SharedPtr](../../system/sharedptr/)\<[Portion](./)\>) | [Portion](./) sınıfının yeni bir örneğini başlatır. |
...
| void [RemoveField](./removefield/)() override | Bu alan bölümünü basit bölüme dönüştürür. |
| void [set_Text](./set_text/)([System::String](../../system/string/)) override | Bir bölümün düz metnini ayarlar. Yaz [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir gösterici (paylaşılan yerine) olarak ayarlar. Kaplarda göstericileri zayıf moda geçişine izin verir. |
