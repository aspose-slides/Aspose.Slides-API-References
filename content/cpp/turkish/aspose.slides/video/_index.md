...
description: Bir sunuma gömülmüş görüntüyü temsil eder.
type: docs
weight: 5526
...
Bir sunuma gömülmüş görüntüyü temsil eder.
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Bir sesin verisinin kopyasını döndürür. Büyük miktarda veri durumunda videonun verisinin belleğe gereksiz şekilde yüklenmesini veya OutOfMemoryException oluşmasını önlemek için [Video::GetStream](./getstream/) metodunu kullanmayı düşünün. Salt okunur **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Bir videonun [Video::get_BinaryData](./get_binarydata/) ile kodlanmış MIME tipini döndürür. Salt okunur [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | Okuma için bir Stream döndürür. 'using' kullanın veya kullanım sonrasında akışı kapatın. |
...
|  [Object](../../system/object/object/)() | Nesneyi oluşturur. Tüm dahili veri yapısını başlatır. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını ortak (shared) yerine zayıf (weak) bir işaretçi olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçişe izin verir. |
...
| virtual  [~Object](../../system/object/~object/)() | Nesneyi yok eder. Tüm dahili veri yapısını serbest bırakır. |
## İlgili
