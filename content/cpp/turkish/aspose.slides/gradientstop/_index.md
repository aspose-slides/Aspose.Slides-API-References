...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989 standardına göre NaN'ın hiçbir değerle, NaN dahil, eşit olmamasına rağmen, C# tarzı nokta sayısı karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989 standardına göre NaN'ın hiçbir değerle, NaN dahil, eşit olmamasına rağmen, C# tarzı çift nokta sayısı karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Bir gradient durak rengini döndürür. Salt okunur [IColorFormat](../icolorformat/). |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../ipviobject/get_parent_ipresentationcomponent/)() | Ebeveyn [IPresentationComponent](../ipresentationcomponent/) nesnesini döndürür. Salt okunur [IPresentationComponent](../ipresentationcomponent/). |
| **float** [get_Position](./get_position/)() override | Bir gradient durakının konumunu (0..1) döndürür. Oku **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Bir gradient durakının konumunu (0..1) ayarlar. Yaz **float**. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit kaldırmasını uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) nöbetçi nesnesini kullanın. |
...
* Sınıf [IGradientStop](../igradientstop/)
