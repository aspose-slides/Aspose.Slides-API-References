...
description: Sunumdaki tüm düzen slaytlarının bir koleksiyonunu temsil eder. ILayoutSlideCollection arayüzünü, ana düzen slaytlarının bireysel koleksiyonlarını birleştirme bağlamında düzen slaytları ekleme/kopyalama yöntemleriyle genişletir.
type: docs
weight: 2367
url: /tr/aspose.slides/igloballayoutslidecollection/
---
## IGlobalLayoutSlideCollection sınıf

Sunumdaki tüm düzen slaytlarının bir koleksiyonunu temsil eder. [ILayoutSlideCollection](../ilayoutslidecollection/) arayüzünü, ana düzen slaytlarının bireysel koleksiyonlarını birleştirme bağlamında düzen slaytları ekleme/kopyalama yöntemleriyle genişletir.
...
| Metot | Açıklama |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Sunuma yeni bir düzen slaytı ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Belirtilen bir düzen slaytının kopyasını sunuma ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Belirtilen bir düzen slaytının kopyasını sunuma ekler. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Koleksiyonun (varsa) son const nitelikli öğesinden hemen sonrasını işaret eden yineleyiciyi alır. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Koleksiyonun (varsa) son öğesinden hemen sonrasını işaret eden yineleyiciyi alır. Bu yineleyici, [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) T'nin bir kopya nesnesini döndürdüğü için referans verilen nesneyi değiştirmek için kullanılamaz. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Koleksiyonun const nitelikli örneğinin (varsa) son öğesinden hemen sonrasını işaret eden yineleyiciyi alır. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../ilayoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) | Belirtilen tipteki ilk düzen slaytını döndürür. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../ilayoutslidecollection/idx_get/)(**int32_t**) | Dizine göre düzen slaytını döndürür. Salt okunur [ILayoutSlide](../ilayoutslide/). |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | Sayısal değerlerin bir dizisinin ortalamasını hesaplar. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizideki her öğeye dönüşüm fonksiyonu uygulayıp oluşan en büyük değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizideki her öğeye dönüşüm fonksiyonu uygulayıp oluşan en küçük değeri döndürür. |
...
| virtual void [Remove](../ilayoutslidecollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Koleksiyondan bir düzen kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| virtual void [RemoveUnused](../ilayoutslidecollection/removeunused/)() | Kullanılmayan düzen slaytlarını kaldırır (HasDependingSlides false olan düzen slaytları). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir gösterici (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki göstergeleri zayıf moda geçiş yapmaya izin verir. |
