...
description: Gömülü ses dosyalarından oluşan bir koleksiyonu temsil eder.
type: docs
weight: 40
...
Gömülü ses dosyalarından oluşan bir koleksiyonu temsil eder.
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [AddAudio](./addaudio/)([System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\>) override | Başka bir sunumdan bir ses dosyasının kopyasını ekler. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [AddAudio](./addaudio/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Bir akıştan ses oluşturur ve bir sunuma ekler. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [AddAudio](./addaudio/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>, [LoadingStreamBehavior](../loadingstreambehavior/)) override | Bir akıştan ses oluşturur ve bir sunuma ekler. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [AddAudio](./addaudio/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Bir bayt dizisinden ses oluşturur ve bir sunuma ekler. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Koleksiyonun (varsa) ilk const niteliğine sahip elemanını gösteren yineleyiciyi alır. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Koleksiyonun (varsa) son const niteliğine sahip elemanının hemen ardından gösteren yineleyiciyi alır. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\>\>, **int32_t**) override | Sesleri belirtilen diziye, belirtilen indeksden başlayarak kopyalar. |
...
| [iterator](./iterator/) [end](./end/)() | Koleksiyonun (varsa) son elemanının hemen ardından gösteren yineleyiciyi alır. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Koleksiyonun const nitelikli örneğinin (varsa) son elemanının hemen ardından gösteren yineleyiciyi alır. |
...
| **int32_t** [get_Count](./get_count/)() override | Koleksiyondaki ses dosyalarının sayısını döndürür. Salt okunur **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Koleksiyona erişimin senkronize (iplik güvenli) olup olmadığını gösteren bir değer döndürür. Salt okunur **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\>\>\> [GetEnumerator](./getenumerator/)() override | Koleksiyon içinde yineleme yapan bir enumeratörü döndürür. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAudio](../iaudio/)\> [idx_get](./idx_get/)(**int32_t**) override | Belirtilen indeksteki elemanı alır. Salt okunur [IAudio](../iaudio/). |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her elemanına dönüştürme fonksiyonu uygular ve ortaya çıkan en büyük değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her elemanına dönüştürme fonksiyonu uygular ve ortaya çıkan en küçük değeri döndürür. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Koleksiyonun const nitelikli örneğinin (varsa) son elemanının hemen ardından gösteren yineleyiciyi alır. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Koleksiyonun (varsa) son elemanının hemen ardından gösteren yineleyiciyi alır. |
