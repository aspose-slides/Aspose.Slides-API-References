...
| [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() override | Bir Office Open XML belgesi içinde tek bir özel XML bölümü benzersiz şekilde tanımlayan küresel benzersiz tanımlayıcıyı (GUID) belirtir. Yalnızca okunur [System::Guid](../../system/guid/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() override | Özel XML bölümüyle ilişkili XML şemaları koleksiyonunu döndürür. Yalnızca okunur [System::String](../../system/string/)[]. |
| [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() override | XML verisini UTF-8 dizgesi olarak döndürür. Oku [System::String](../../system/string/). |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() override | XML verisini döndürür. Oku **uint8_t**[]. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayaç veri yapısını alır. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) metodunun benzeridir. Özel nesnelerin karma oluşturmasını sağlar. |
...
| void [Remove](./remove/)() override | Özel xml bölümünü sunumdan kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) override | Bir Office Open XML belgesi içinde tek bir özel XML bölümü benzersiz şekilde tanımlayan küresel benzersiz tanımlayıcıyı (GUID) belirtir. Yalnızca okunur [System::Guid](../../system/guid/). |
| void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) override | XML verisini UTF-8 dizgesi olarak ayarlar. Yaz [System::String](../../system/string/). |
| void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | XML verisini ayarlar. Yaz **uint8_t**[]. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) metodunun benzeridir. Özel nesnelerin dizeye dönüştürülmesini sağlar. |
