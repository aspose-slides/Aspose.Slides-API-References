...
type: docs
weight: 898
url: /tr/aspose.slides/floatcolor/
---
## FloatColor sınıfı
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | C# Object.GetHashCode() metodunun analoğu. Özel nesnelerin hash'lenmesini sağlar. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya ile inşa edilmesini sağlar. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya ile inşa edilmesini sağlar. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi olarak ayarlar (paylaşılan yerine). Kapsayıcılardaki işaretçilerin zayıf moda geçirilmesini sağlar. |
