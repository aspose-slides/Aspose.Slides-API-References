...
| **bool** [get_Loop](./get_loop/)() | Döngü [Slide](../slide/) Göster |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_PenColor](./get_pencolor/)() | Kalem Rengi [Slide](../slide/) Gösterimi için |
| **bool** [get_ShowAnimation](./get_showanimation/)() | [Animation](../../aspose.slides.animation/)'i [Slide](../slide/) Gösterimde göster |
| **bool** [get_ShowMediaControls](./get_showmediacontrols/)() const | Medya Kontrollerini Göster |
| **bool** [get_ShowNarration](./get_shownarration/)() | [Slide](../slide/) Gösterimde Anlatımı Göster |
| [System::SharedPtr](../../system/sharedptr/)\<[SlidesRange](../slidesrange/)\> [get_Slides](./get_slides/)() const | [Slides](../) aralığı |
| [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::SlideShowType](../slideshowtype/)\> [get_SlideShowType](./get_slideshowtype/)() | Slayt gösterisi tipini alır. Aşağıdaki [SlideShowType](../slideshowtype/) ataları tarafından temsil edilir: [BrowsedAtKiosk](../browsedatkiosk/), [PresentedBySpeaker](../presentedbyspeaker/) ve [BrowsedByIndividual](../browsedbyindividual/) |
| **bool** [get_UseTimings](./get_usetimings/)() | [Slide](../slide/) Gösterimde Zamanlamaları Kullan |
...
| void [set_Loop](./set_loop/)(**bool**) | Döngü [Slide](../slide/) Göster |
| void [set_ShowAnimation](./set_showanimation/)(**bool**) | [Animation](../../aspose.slides.animation/)'i [Slide](../slide/) Gösterimde göster |
| void [set_ShowMediaControls](./set_showmediacontrols/)(**bool**) | Medya Kontrollerini Göster |
| void [set_ShowNarration](./set_shownarration/)(**bool**) | [Slide](../slide/) Gösterimde Anlatımı Göster |
| void [set_Slides](./set_slides/)([System::SharedPtr](../../system/sharedptr/)\<[SlidesRange](../slidesrange/)\>) | [Slides](../) aralığı |
| void [set_SlideShowType](./set_slideshowtype/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::SlideShowType](../slideshowtype/)\>) | Slayt gösterisi tipini ayarlar. Aşağıdaki [SlideShowType](../slideshowtype/) ataları tarafından temsil edilir: [BrowsedAtKiosk](../browsedatkiosk/), [PresentedBySpeaker](../presentedbyspeaker/) ve [BrowsedByIndividual](../browsedbyindividual/) |
| void [set_UseTimings](./set_usetimings/)(**bool**) | [Slide](../slide/) Gösterimde Zamanlamaları Kullan |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi olarak ayarlar (paylaşılan yerine). Kapsayıcılardaki işaretçileri zayıf moda değiştirmeye izin verir. |
