...
description: Etkili ışık rig özelliklerini içeren değiştirilemez nesne.
type: docs
weight: 2718
url: /tr/aspose.slides/ilightrigeffectivedata/
---
## ILightRigEffectiveData sınıf
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 standardına göre NaN hiçbir değere eşit değildir, NaN dahil, olsa da iki NaN'ın eşit kabul edildiği C# stilinde kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 standardına göre NaN hiçbir değere eşit değildir, NaN dahil, olsa da iki NaN'ın eşit kabul edildiği C# stilinde kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() | Işık yönü. Salt okunur [LightingDirection](../lightingdirection/). |
| virtual [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() | Bir şekle uygulanabilen önceden ayarlanmış ışık yönünü temsil eder. Işık kafesi, 3B sahneye göre belirli bir yönde konumlandırılmış bir grup ışığı temsil eder. Salt okunur [LightRigPresetType](../lightrigpresettype/). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Dönme, enlem koordinatı, boylam koordinatı ve eksen etrafındaki devrimle, enlem ve boylam koordinatları olarak tanımlanır. Dönen dizi'nin ilk öğesi - enlem, ikincisi - boylam, üçüncüsü - devrim. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçiş yapmayı sağlar. |
