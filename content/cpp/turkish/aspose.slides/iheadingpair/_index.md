...
description: Belgenin 'Heading pair' özelliğini temsil eder. Belge bölümlerinin grup adını ve grup içindeki bölüm sayısını gösterir.
type: docs
weight: 2510
...
Belge içinde bir 'Heading pair' özelliğini temsil eder. Bu, belge bölümlerinin grup adını ve grup içindeki bölüm sayısını gösterir.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN'in eşit kabul edildiği C#-tarzı kayan nokta karşılaştırmasını taklit eder; ancak IEC 60559:1989'a göre NaN, NaN dahil hiçbir değere eşit değildir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'in eşit kabul edildiği C#-tarzı kayan nokta karşılaştırmasını taklit eder; ancak IEC 60559:1989'a göre NaN, NaN dahil hiçbir değere eşit değildir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual **int32_t** [get_Count](./get_count/)() | Gruptaki bölüm sayısını döndürür. Salt okunur **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Belge bölümlerinin grup adını döndürür. Salt okunur [System::String](../../system/string/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya oluşturucu. Aslında hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya oluşturmasını sağlar. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'ın string ve nullptr durumları için özelleştirmesidir. |
