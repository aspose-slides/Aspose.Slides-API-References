...
description: Harici kaynak yükleme bağımsız değişkenleri için arabirim.
type: docs
weight: 3485
url: /tr/aspose.slides/iresourceloadingargs/
---
## IResourceLoadingArgs sınıfı


Harici kaynak yükleme bağımsız değişkenleri için arabirim.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; burada iki NaN eşit kabul edilir, ancak IEC 60559:1989’a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; burada iki NaN eşit kabul edilir, ancak IEC 60559:1989’a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [System::String](../../system/string/) [get_OriginalUri](./get_originaluri/)() | İçe aktarılan sunumda belirtilen kaynağın orijinal URI'si. |
| virtual [System::String](../../system/string/) [get_Uri](./get_uri/)() | [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) [ResourceLoadingAction::Default](../resourceloadingaction/) döndürürse indirme için kullanılan kaynağın URI'si. Başlangıçta kaynağın orijinal URI'sine ayarlanır, ancak herhangi bir değere yeniden tanımlanabilir. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) yöntemine benzer. Özel nesnelerin hashlenmesini sağlar. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) fonksiyonunun dize ve nullptr durumuna özgü özelleştirmesi. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) fonksiyonunun dize durumuna özgü özelleştirmesi. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| virtual void [set_Uri](./set_uri/)([System::String](../../system/string/)) | [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) [ResourceLoadingAction::Default](../resourceloadingaction/) döndürürse indirme için kullanılan kaynağın URI'si. Başlangıçta orijinal URI'ye ayarlanır, ancak herhangi bir değere yeniden tanımlanabilir. |
| virtual void [SetData](./setdata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) [ResourceLoadingAction::UserProvided](../resourceloadingaction/) döndürürse kullanılan kaynağın kullanıcı tarafından sağlanan verisini ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir gösterici olarak ayarlar (paylaşılan değil). Konteynerlerdeki göstericilerin zayıf moda geçişine izin verir. |
