...
type: docs
weight: 599
url: /tr/aspose.slides/details_odpexception/
---
## Details_OdpException sınıfı

Standart dahili bir istisna tipini temsil eder.
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) yönteminin benzeri. Özel nesnelerin hash edilmesini sağlar. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf göstergeci (paylaşılan yerine) ayarlar. Kapsayıcılardaki göstergeçlerin zayıf moda geçmesine izin verir. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) metodunu uygular; bu metod [ExceptionWrapper](../../system/exceptionwrapper/) sınıfı tarafından çağrılır. Bu sınıf std::exception'dan türetilmemiş olsa da türev sınıflar korumalı/özel üyelere erişerek kendi mantıklarını uygulayabilir. Bu metodun uygulamasını [ExceptionWrapper](../../system/exceptionwrapper/) içine taşımak bu mantığı bozabilir. |
