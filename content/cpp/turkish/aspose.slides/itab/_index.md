...
description: Metin için bir sekme temsili sağlar.
type: docs
weight: 3966
...
Metin için bir sekme temsili sağlar.
...
| Yöntem | Açıklama |
| --- | --- |
| virtual int [CompareTo](../../system/icomparable/compareto/)(T) | Geçerli nesneyi belirtilen nesneyle karşılaştırır. |
...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Bir sekmenin hizalama stilini döndürür. Oku [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Bir sekmenin konumunu döndürür. Bu özelliği atamak, sekmenin koleksiyondaki dizinini değiştirebilir ve Enumerator'ı geçersiz kılabilir. Oku **double**. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Bir sekmenin hizalama stilini ayarlar. Yaz [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Bir sekmenin konumunu ayarlar. Bu özelliği atamak, sekmenin koleksiyondaki dizinini değiştirebilir ve Enumerator'ı geçersiz kılabilir. Yaz **double**. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidini açma işlevi uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
