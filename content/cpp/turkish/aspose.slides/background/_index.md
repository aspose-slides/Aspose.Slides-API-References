...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989'a göre NaN'ın hiçbir değere, NaN dahil, eşit olmadığı halde, C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989'a göre NaN'ın hiçbir değere, NaN dahil, eşit olmadığı halde, C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() override | [EffectFormat](../effectformat/) döndürür [BackgroundType::OwnBackground](../backgroundtype/) doldurma amacıyla. Salt okunur [IEffectFormat](../ieffectformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | [FillFormat](../fillformat/) döndürür [BackgroundType::OwnBackground](../backgroundtype/) doldurma amacıyla. Salt okunur [IFillFormat](../ifillformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](./get_presentation/)() override | Bir slaytın üst sunumunu döndürür. Salt okunur [IPresentation](../ipresentation/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() override | Bir [BackgroundType::Themed](../backgroundtype/) doldurma için [ColorFormat](../colorformat/) döndürür. Salt okunur [IColorFormat](../icolorformat/). |
| **uint16_t** [get_StyleIndex](./get_styleindex/)() override | [BackgroundType::Themed](../backgroundtype/) doldurmanın arka plan teması koleksiyonundaki indeksini döndürür. 0, doldurma olmadığını gösterir. 1..999 - indeks. **uint16_t** okunur. |
| [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() override | Arka plan doldurmanın tipini döndürür. [BackgroundType](../backgroundtype/) okunur. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() override | Uygulanan kalıtımla etkin arka plan verisini alır. |
...
| void [set_StyleIndex](./set_styleindex/)(**uint16_t**) override | [BackgroundType::Themed](../backgroundtype/) doldurmanın arka plan teması koleksiyonundaki indeksini döndürür. 0, doldurma olmadığını gösterir. 1..999 - indeks. **uint16_t** yazılır. |
| void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) override | Arka plan doldurmanın tipini döndürür. [BackgroundType](../backgroundtype/) yazılır. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() deyiminin kilidini açmayı uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
