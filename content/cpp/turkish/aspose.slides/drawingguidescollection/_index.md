...
| Yöntem | Açıklama |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [Add](./add/)([Orientation](../orientation/), **float**) override | Çizim kılavuzunu koleksiyonun sonuna ekler. |
| [iterator](./iterator/) [begin](./begin/)() | Koleksiyondaki (varsa) ilk öğeye işaret eden yineleyiciyi alır. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Koleksiyonun const-nitelikli örneğinde (varsa) ilk öğeye işaret eden yineleyiciyi alır. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Koleksiyondaki (varsa) ilk const-nitelikli öğeye işaret eden yineleyiciyi alır. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Koleksiyondaki (varsa) son const-nitelikli öğeden hemen sonrasına işaret eden yineleyiciyi alır. |
| void [Clear](./clear/)() override | Koleksiyondaki tüm öğeleri kaldırır. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\>\>, **int32_t**) | Koleksiyondaki tüm öğeleri belirtilen diziye kopyalar. |
| [iterator](./iterator/) [end](./end/)() | Koleksiyondaki (varsa) son öğeden hemen sonrasına işaret eden yineleyiciyi alır. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Koleksiyonun const-nitelikli örneğinde (varsa) son öğeden hemen sonrasına işaret eden yineleyiciyi alır. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989 standardına göre NaN'ın herhangi bir değere, NaN dahil, eşit olmadığı halde C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989 standardına göre NaN'ın herhangi bir değere, NaN dahil, eşit olmadığı halde C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **int32_t** [get_Count](./get_count/)() override | Koleksiyondaki öğe sayısını döndürür. Salt okunur **int32_t**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Koleksiyonu yineleyen bir numaralandırıcı döndürür. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) metodunun analogudur. Özelleştirilmiş nesnelerin hash'lemesini sağlar. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuide](../idrawingguide/)\> [idx_get](./idx_get/)(**int32_t**) override | İndeksle çizim kılavuzunu döndürür. Salt okunur [IDrawingGuide](../idrawingguide/). |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Dizi içindeki öğe sayısını döndürür (doğrudan sayma yöntemiyle hesaplanır). |
...
|  [Object](../../system/object/object/)() | Nesne oluşturur. Tüm iç veri yapılarının başlatılmasını gerçekleştirir. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Gerçekte bir şey kopyalamaz; yeni nesneyi başlatır ve alt sınıfların kopya yapımını sağlar. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Gerçekte bir şey kopyalamaz; yeni nesneyi başlatır ve alt sınıfların kopya yapımını sağlar. |
...
| void [RemoveAt](./removeat/)(**int32_t**) override | Belirtilen indeksteki çizim kılavuzunu kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n. şablon argümanını zayıf bir işaretçi olarak ayarlar (paylaşılan yerine). Kapsayıcılardaki işaretçileri zayıf moda geçişine izin verir. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Koleksiyondaki (varsa) ilk öğeye işaret eden yineleyiciyi alır. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Koleksiyonun const-nitelikli örneğinde (varsa) son öğeden hemen sonrasına işaret eden yineleyiciyi alır. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Koleksiyondaki (varsa) son öğeden hemen sonrasına işaret eden yineleyiciyi alır. |
...
| Tip Tanımı | Açıklama |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | İteratör tiplerinin mevcut koleksiyonda iteratör tipleri olarak kullanıldığı bir koleksiyon tipidir. |
