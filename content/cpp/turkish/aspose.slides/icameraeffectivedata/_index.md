...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'da NaN'ın hiçbir değerle (NaN dahil) eşit olmadığına rağmen iki NaN eşit kabul edilir; C#-style kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'da NaN'ın hiçbir değerle (NaN dahil) eşit olmadığına rağmen iki NaN eşit kabul edilir; C#-style kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) tipi. Salt okunur [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 derece, görüş alanı). Salt okunur **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) yakınlaştırma (yüzde olarak pozitif değer). Salt okunur **float**. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Döndürme, enlem ve boylam koordinatları ve eksen etrafında bir devir kullanılarak tanımlanır. Dönen dizi içinde ilk öğe - enlem, ikinci - boylam, üçüncü - devir. Tanımlı bir döndürme yoksa null döndürür. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nın string ve nullptr durumuna özel bir uyarlaması. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir işaretçi (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçirmeye izin verir. |
...
| virtual  [~Object](../../system/object/~object/)() | Nesneyi yok eder. Tüm dahili veri yapılarının belleğini serbest bırakır. |
