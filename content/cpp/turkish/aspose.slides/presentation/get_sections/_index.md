...
description: Sunumda tanımlı olan tüm slayt bölümlerinin listesini döndürür. Salt okunur ISectionCollection.
type: docs
weight: 66
url: /tr/aspose.slides/presentation/get_sections/
---
## Presentation::get_Sections() yöntemi

Sunumda tanımlı olan tüm slayt Sections listesini döndürür. Salt okunur [ISectionCollection](../../isectioncollection/).
...
Aşağıdaki örnekler, bir PowerPoint [Presentation](../) içinde Sections oluşturmayı gösterir. 
```cpp
...
```
 Aşağıdaki örnekler, Sections adlarının nasıl değiştirileceğini gösterir. 
```cpp
...
* Sınıf [ISectionCollection](../../isectioncollection/)
* Sınıf [Presentation](../)
