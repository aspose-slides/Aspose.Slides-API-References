...
---
## Presentation::Save(System::String, Export::SaveFormat) yöntemi
...
## Presentation::Save(System::SharedPtr\<System::IO::Stream\>, Export::SaveFormat) yöntemi
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| stream | [System::SharedPtr](../../../system/sharedptr/)\<[System::IO::Stream](../../../system.io/stream/)\> | Çıkış akışı. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | Dışa aktarılan verinin formatı. |

## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) yöntemi
...
Aşağıdaki örnek, PowerPoint'i C++ kullanarak HTML'ye dönüştürmeyi gösterir. ```cpp
// Bir sunum dosyasını (ör. PPT, PPTX, ODP vb.) temsil eden bir sunum nesnesi oluşturur.
...
// Sunumu HTML olarak kaydeder
presentation->Save(u"ConvertWholePresentationToHTML_out.html", SaveFormat::Html, htmlOpt);
```
Aşağıdaki örnek, PowerPoint'i C++ kullanarak duyarlı HTML'ye dönüştürmeyi gösterir. ```cpp
...
```
Aşağıdaki örnek, PowerPoint'i C++ kullanarak notlarla birlikte HTML'ye dönüştürmeyi gösterir. ```cpp
...
// Not sayfalarını kaydeder
pres->Save(u"Output.html", SaveFormat::Html, opt);
```
Aşağıdaki örnek, PowerPoint'i C++ kullanarak özgün yazı tipleriyle HTML'ye dönüştürmeyi gösterir. ```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// Varsayılan sunum fontlarını hariç tutar
...
```
Aşağıdaki örnek, PowerPoint'i C++ kullanarak 150 DPI'de yüksek kaliteli görüntülerle HTML'ye dönüştürmeyi gösterir. ```cpp
...
```
Aşağıdaki örnek, PowerPoint'i C++ kullanarak tam kalite görüntülerle HTML'ye dönüştürmeyi gösterir. ```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
Aşağıdaki örnek, [Slide](../../slide/)'i C++ kullanarak HTML'ye dönüştürmeyi gösterir. ```cpp
```
