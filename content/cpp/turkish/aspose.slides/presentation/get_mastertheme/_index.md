...
description: "Ana temayı döndürür. Salt okunur Theme::IMasterTheme."
type: docs
weight: 404
url: /tr/aspose.slides/presentation/get_mastertheme/
---
## Presentation::get_MasterTheme() metod

Ana temayı döndürür. Salt okunur [Theme::IMasterTheme](../../../aspose.slides.theme/imastertheme/).
...
Aşağıdaki örnekler, PowerPoint [Presentation](../) öğelerinin parçalarını değiştirerek bir tema etkisini nasıl değiştireceğinizi gösterir.
```cpp
...
* Sınıf [IMasterTheme](../../../aspose.slides.theme/imastertheme/)
* Sınıf [Presentation](../)
