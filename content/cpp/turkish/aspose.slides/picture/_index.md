...
| Yöntem | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen nesne ile karşılaştırır. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_Image](./get_image/)() override | Gömülü resmi döndürür. Okuyun [IPPImage](../ippimage/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/)\> [get_ImageTransform](./get_imagetransform/)() override | Resim dönüşüm etkileri koleksiyonunu döndürür. Salt-okunur [IImageTransformOperationCollection](../../aspose.slides.effects/iimagetransformoperationcollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[Effects::IImageTransformOperation](../../aspose.slides.effects/iimagetransformoperation/)\> [get_ImageTransformOperation](./get_imagetransformoperation/)(**int32_t**) override | Belirtilen dizindeki resim dönüşüm işlemini döndürür. |
| [System::String](../../system/string/) [get_LinkPathLong](./get_linkpathlong/)() override | Bağlı resmin URL'sini döndürür. Okuyun [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](./get_presentation/)() override | Sunumu döndürür. Salt-okunur [IPresentation](../ipresentation/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](./get_slide/)() override | Resmin üst slaytını döndürür. Salt-okunur [IBaseSlide](../ibaseslide/). |
...
| **int32_t** [GetHashCode](./gethashcode/)() const override | Karma değerini döndürür. |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesi kilitlemesini uygular. Doğrudan çağırın ya da [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
...
| void [set_Image](./set_image/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) override | Gömülü resmi ayarlar. Yaz [IPPImage](../ippimage/). |
| void [set_LinkPathLong](./set_linkpathlong/)([System::String](../../system/string/)) override | Bağlı resmin URL'sini ayarlar. Yaz [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesi kilit açma işlemini uygular. Doğrudan çağırın ya da [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
...
* Sınıf [ISlidesPicture](../islidespicture/)
