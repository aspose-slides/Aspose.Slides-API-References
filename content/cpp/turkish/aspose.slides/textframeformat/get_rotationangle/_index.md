...
description: Sınır kutusu içindeki metne uygulanacak özel dönüşü belirtir. Belirtilmezse, eşlik eden şeklin dönüşü kullanılır. Belirtilirse, bu dönüş şekilden bağımsız olarak uygulanır. Yani şekil, metnin kendisine de bir dönüş uygulanmışken ek bir dönüşe sahip olabilir. Görsel metin dönüşünün bu özellikten ve TextVerticalType özelliğindeki önceden tanımlı dikey türden özetlenen sonuc değeri. **float** olarak okunur.
type: docs
weight: 300
url: /tr/aspose.slides/textframeformat/get_rotationangle/
---
