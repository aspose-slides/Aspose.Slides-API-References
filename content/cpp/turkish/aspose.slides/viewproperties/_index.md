...
| **float** [get_GridSpacing](./get_gridspacing/)() override | Sunum belgesinin altındaki ızgara için kullanılacak ızgara aralığını (puan cinsinden) döndürür. **float** okunur. |
| [ViewType](../viewtype/) [get_LastView](./get_lastview/)() override | Sunum belgesi en son kaydedildiğinde kullanılan görünüm modunu belirtir. [ViewType](../viewtype/) okunur. |
| [System::SharedPtr](../../system/sharedptr/)\<[INormalViewProperties](../inormalviewproperties/)\> [get_NormalViewProperties](./get_normalviewproperties/)() override | Normal görünüm özelliklerini temsil eder. Normal görünüm üç içerik bölgesinden oluşur: slayt, yan içerik bölgesi ve alt içerik bölgesi. [INormalViewProperties](../inormalviewproperties/) salt okunur. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommonSlideViewProperties](../icommonslideviewproperties/)\> [get_NotesViewProperties](./get_notesviewproperties/)() override | Notlar görünüm modu ile ilişkili ortak görünüm özelliklerini belirtir. [ICommonSlideViewProperties](../icommonslideviewproperties/) salt okunur. |
| [NullableBool](../nullablebool/) [get_ShowComments](./get_showcomments/)() override | Slayt yorumlarının gösterilip gösterilmeyeceğini belirtir. [NullableBool](../nullablebool/) okunur. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommonSlideViewProperties](../icommonslideviewproperties/)\> [get_SlideViewProperties](./get_slideviewproperties/)() override | Slayt görünüm modu ile ilişkili ortak görünüm özelliklerini belirtir. [ICommonSlideViewProperties](../icommonslideviewproperties/) salt okunur. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Değer türü nesnesi ile nullptr’i referansla karşılaştırır. |
...
| void [set_GridSpacing](./set_gridspacing/)(**float**) override | Sunum belgesinin altındaki ızgara için kullanılacak ızgara aralığını (puan cinsinden) ayarlar. **float** yazılır. |
| void [set_LastView](./set_lastview/)([ViewType](../viewtype/)) override | Sunum belgesi en son kaydedildiğinde kullanılan görünüm modunu belirtir. [ViewType](../viewtype/) yazılır. |
| void [set_ShowComments](./set_showcomments/)([NullableBool](../nullablebool/)) override | Slayt yorumlarının gösterilip gösterilmeyeceğini belirtir. [NullableBool](../nullablebool/) yazılır. |
...
* Sınıf [IViewProperties](../iviewproperties/)
