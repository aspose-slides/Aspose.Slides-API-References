...
description: COM arayüzü aracılığıyla formatlar oluşturmayı sağlar.
type: docs
weight: 2302
url: /tr/aspose.slides/iformatfactory/
---
## IFormatFactory sınıfı

COM arayüzü aracılığıyla formatlar oluşturmayı sağlar.
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [CreateParagraphFormat](./createparagraphformat/)() | Yeni [IParagraphFormat](../iparagraphformat/) oluşturur. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [CreatePortionFormat](./createportionformat/)() | Yeni [IPortionFormat](../iportionformat/) oluşturur. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\> [CreateTextFrameFormat](./createtextframeformat/)() | Yeni [ITextFrameFormat](../itextframeformat/) oluşturur. |
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Başvuru türü nesnelerini C# tarzında karşılaştırır. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) yönteminin analoğu. Özelleştirilmiş nesnelerin karmasını oluşturmayı sağlar. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Değer türü nesnesini nullptr ile başvuru karşılaştırması yapar. |
