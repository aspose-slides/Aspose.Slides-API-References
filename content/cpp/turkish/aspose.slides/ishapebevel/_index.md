...
description: Şeklin ana yüzey kabartısının özelliklerini temsil eder.
type: docs
weight: 3654
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Kemer türü. [BevelPresetType](../bevelpresettype/) oku. |
| virtual **double** [get_Height](./get_height/)() | Kemer yüksekliği. **double** oku. |
| virtual **double** [get_Width](./get_width/)() | Kemer genişliği. **double** oku. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | Kemer türü. [BevelPresetType](../bevelpresettype/) yaz. |
| virtual void [set_Height](./set_height/)(**double**) | Kemer yüksekliği. **double** yaz. |
| virtual void [set_Width](./set_width/)(**double**) | Kemer genişliği. **double** yaz. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilitleme açma işlevini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözetleme nesnesini kullanın. |
