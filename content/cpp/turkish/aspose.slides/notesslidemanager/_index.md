...
| Yöntem | Açıklama |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() override | Mevcut slayt için not slaytını döndürür, yoksa oluşturur. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() override | Mevcut slayt için not slaytını döndürür. Slaytın not slaytı yoksa null döner. Yalnızca okuma [INotesSlide](../inotesslide/). |
...
| void [RemoveNotesSlide](./removenotesslide/)() override | Mevcut slaytın not slaytını kaldırır. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'inci şablon argümanını güçlü (shared) yerine zayıf bir gösterici olarak ayarlar. Kapsayıcılardaki göstericilerin zayıf moda geçmesini sağlar. |
...
Aşağıdaki örnek, belirli bir PowerPoint [Presentation](../presentation/) slaytına Not eklemeyi gösterir.
```cpp
...
```
Aşağıdaki örnek, PowerPoint [Presentation](../presentation/)'nin belirli bir slaytından Notları kaldırmayı gösterir.
```cpp
// Sunum dosyasını temsil eden bir Presentation nesnesi oluşturun
auto presentation = System::MakeObject<Presentation>(dataDir + u"AccessSlides.pptx");
...
* Sınıf [INotesSlideManager](../inotesslidemanager/)
