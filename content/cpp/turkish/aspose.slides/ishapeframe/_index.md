...
| virtual T [CloneT](../igenericcloneable/clonet/)() | Mevcut örneğin bir kopyası olan yeni bir nesne oluşturur. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'in herhangi bir değerle, NaN dahil, eşit olmadığı halde, iki NaN'in eşit kabul edildiği C#-style kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in herhangi bir değerle, NaN dahil, eşit olmadığı halde, iki NaN'in eşit kabul edildiği C#-style kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual **float** [get_CenterX](./get_centerx/)() | Bir çerçevenin merkezinin X koordinatını döndürür. Salt okunur **float**. |
| virtual **float** [get_CenterY](./get_centery/)() | Bir çerçevenin merkezinin Y koordinatını döndürür. Salt okunur **float**. |
| virtual [NullableBool](../nullablebool/) [get_FlipH](./get_fliph/)() | Bir çerçevenin yatay olarak çevrilip çevrilmediğini belirler. Salt okunur [NullableBool](../nullablebool/). |
| virtual [NullableBool](../nullablebool/) [get_FlipV](./get_flipv/)() | Bir çerçevenin dikey olarak çevrilip çevrilmediğini belirler. Salt okunur [NullableBool](../nullablebool/). |
| virtual **float** [get_Height](./get_height/)() | Bir çerçevenin yüksekliğini döndürür. Salt okunur **float**. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [get_Rectangle](./get_rectangle/)() | Bir çerçevenin koordinatlarını döndürür. Salt okunur [System::Drawing::RectangleF](../../system.drawing/rectanglef/). |
| virtual **float** [get_Rotation](./get_rotation/)() | Bir çerçevenin z-ekseninde döndürüldüğü derece sayısını döndürür. Pozitif değer saat yönünde dönüşü, negatif değer saat yönünün tersine dönüşü gösterir. Salt okunur **float**. |
| virtual **float** [get_Width](./get_width/)() | Bir çerçevenin genişliğini döndürür. Salt okunur **float**. |
| virtual **float** [get_X](./get_x/)() | Bir çerçevenin sol-üst köşesinin X koordinatını döndürür. Salt okunur **float**. |
| virtual **float** [get_Y](./get_y/)() | Bir çerçevenin sol-üst köşesinin Y koordinatını döndürür. Salt okunur **float**. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | String ve nullptr durumuna özel [Object::ReferenceEquals](../../system/object/referenceequals/). |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | Stringler durumuna özel [Object::ReferenceEquals](../../system/object/referenceequals/). |
