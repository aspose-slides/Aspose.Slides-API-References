...
| Yöntem | Açıklama |
| --- | --- |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::String](../../system/string/)) | Yeni bir yazı tipini FallBack yazı tipleri listesine ekler. |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Yeni bir yazı tipini FallBack yazı tipleri listesine ekler. |
| virtual void [Clear](./clear/)() | Listedeki tüm yazı tiplerini kaldırır. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN eşit kabul edilir, IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN eşit kabul edilir, IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual **int32_t** [get_Count](./get_count/)() | Aralık için tanımlı olan yazı tiplerinin sayısını alır. |
| virtual **uint32_t** [get_RangeEndIndex](./get_rangeendindex/)() | Sürekli Unicode aralığının son indeksini alır. |
| virtual **uint32_t** [get_RangeStartIndex](./get_rangestartindex/)() | Sürekli Unicode aralığının ilk indeksini alır. |
...
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)(**int32_t**) | Belirtilen indeksdeki yazı tipi adını alır. |
| virtual **int32_t** [IndexOf](./indexof/)([System::String](../../system/string/)) | Koleksiyondaki belirtilen kuralın indeksini döndürür. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Listeden belirli bir FallBack yazı tipinin ilk oluşumunu kaldırır. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Listede belirtilen indeksteki FallBack yazı tipini kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Belirtilen değer kadar paylaşımlı referans sayacını azaltır. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçişe olanak tanır. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)() | Bu kural için tüm FallBack yazı tiplerini içeren bir dizi oluşturur ve döndürür. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)(**int32_t**, **int32_t**) | Listede belirtilen aralıktaki tüm FallBack yazı tiplerini içeren bir dizi oluşturur ve döndürür. |
