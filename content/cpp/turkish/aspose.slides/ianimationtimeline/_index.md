...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ISequence](../../aspose.slides.animation/isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) | Belirtilen indeksteki etkileşimli diziyi döndürür. Bu dizi yalnızca \"click on shape\" ile belirtilen hedef şekil etkilerini içerebilir. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ISequenceCollection](../../aspose.slides.animation/isequencecollection/)\> [get_InteractiveSequences](./get_interactivesequences/)() | Etkileşimli dizilerin koleksiyonunu döndürür. Bu diziler yalnızca \"click on shape\" ile belirtilen hedef şekil etkilerini içerebilir. Salt okunur [Animation::ISequenceCollection](../../aspose.slides.animation/isequencecollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ISequence](../../aspose.slides.animation/isequence/)\> [get_MainSequence](./get_mainsequence/)() | Yalnızca ana etkiler koleksiyonunu içerebilen ana diziyi döndürür. Salt okunur [Animation::ISequence](../../aspose.slides.animation/isequence/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::IEffect](../../aspose.slides.animation/ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) | Belirtilen indeksteki ana diziden etkisi döndürür. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ITextAnimation](../../aspose.slides.animation/itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) | Belirtilen indeksteki metin animasyonunu döndürür. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Animation::ITextAnimationCollection](../../aspose.slides.animation/itextanimationcollection/)\> [get_TextAnimationCollection](./get_textanimationcollection/)() | Metin animasyonlarının koleksiyonunu döndürür. Salt okunur [Animation::ITextAnimationCollection](../../aspose.slides.animation/itextanimationcollection/). |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesi kilitlemesini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) guard nesnesini kullanın. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşılan değil) olarak ayarlar. Kapsayıcılardaki göstericilerin zayıf moda geçmesine izin verir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesi kilidini açmayı uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) guard nesnesini kullanın. |
