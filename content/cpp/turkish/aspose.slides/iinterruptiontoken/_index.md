...
description: Bu sınıf, uzun süren görevlerin kesintinin istenip istenmediğini belirtmek için kullanılacak token'ı temsil eder.
type: docs
weight: 2601
url: /tr/aspose.slides/iinterruptiontoken/
---
## IInterruptionToken sınıfı


Bu sınıf, uzun süren görevlerin kesintinin istenip istenmediğini belirlemek için kullanılacak token'ı temsil eder.
...
| virtual **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() | Kesinti istendiğinde **bool**.true döndürür. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucu. Gerçekten hiçbir şey kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapımını sağlar. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını güçlü (shared) yerine zayıf bir işaretçi olarak ayarlar. Kapsayıcılardaki işaretçilerin zayıf moda geçmesini sağlar. |
...
| virtual void [ThrowIfInterruptionRequested](./throwifinterruptionrequested/)() | Kesinti istendiğinde bir istisna fırlatır. |
