...
| Yöntem | Açıklama |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | C# [Object.Equals](../../system/object/equals/) semantics kullanarak nesneleri karşılaştırır. |
...
| **bool** [IsLicensed](./islicensed/)() override | Lisansın bileşene uygulanıp uygulanmadığını kontrol eder |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin string ve nullptr durumuna özelleştirilmesi. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin string durumuna özelleştirilmesi. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| void [ResetLicense](./resetlicense/)() override | Lisansı sıfırla |
| void [SetLicense](./setlicense/)([System::String](../../system/string/)) override | Bileşeni lisanslar. |
| void [SetLicense](./setlicense/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Bileşeni lisanslar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçiş yapmaya izin verir. |
...
Bu örnekte, bileşeni içeren klasörde, çağıran derlemi içeren klasörde, giriş derleminin klasöründe ve ardından çağıran derlemin gömülü kaynaklarında MyLicense.lic adlı lisans dosyasını bulma girişiminde bulunulacaktır. 
```cpp
