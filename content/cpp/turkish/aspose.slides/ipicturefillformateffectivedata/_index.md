...
description: Görsel doldurmanın özelliklerini içeren değiştirilemez nesne.
type: docs
weight: 3238
url: /tr/aspose.slides/ipicturefillformateffectivedata/
---
## IPictureFillFormatEffectiveData sınıf

Değiştirilemez nesne ve görsel doldurmanın özelliklerini içerir.
...
| virtual **float** [get_CropBottom](./get_cropbottom/)() | Resmin alt kısmından kırpılan gerçek görüntü yüksekliğinin yüzde oranını döndürür. Yalnızca okunabilir **float**. |
| virtual **float** [get_CropLeft](./get_cropleft/)() | Resmin sol kısmından kırpılan gerçek görüntü genişliğinin yüzde oranını döndürür. Yalnızca okunabilir **float**. |
| virtual **float** [get_CropRight](./get_cropright/)() | Resmin sağ kısmından kırpılan gerçek görüntü genişliğinin yüzde oranını döndürür. Yalnızca okunabilir **float**. |
| virtual **float** [get_CropTop](./get_croptop/)() | Resmin üst kısmından kırpılan gerçek görüntü yüksekliğinin yüzde oranını döndürür. Yalnızca okunabilir **float**. |
| virtual **int32_t** [get_Dpi](./get_dpi/)() | Resmi doldurmak için kullanılan dpi değerini döndürür. Yalnızca okunabilir **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureEffectiveData](../ipictureeffectivedata/)\> [get_Picture](./get_picture/)() | Resmi döndürür. Yalnızca okunabilir [IPictureEffectiveData](../ipictureeffectivedata/). |
| virtual [Aspose::Slides::PictureFillMode](../picturefillmode/) [get_PictureFillMode](./get_picturefillmode/)() | Resim doldurma modunu döndürür. Yalnızca okunabilir [Slides::PictureFillMode](../picturefillmode/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin hedefTür tarafından tanımlanan tipin bir örneği olup olmadığını denetler. C# 'is' operatörünün benzeri. |
...
Bu arayüz [IFillFormatEffectiveData](../ifillformateffectivedata/)'nin bir parçası olarak kullanılır.
