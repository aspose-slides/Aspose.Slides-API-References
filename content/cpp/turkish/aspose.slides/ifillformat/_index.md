...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN'ın IEC 60559:1989'a göre NaN'ın herhangi bir değere, NaN dahil, eşit olmaması gerekse de eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'ın IEC 60559:1989'a göre NaN'ın herhangi bir değere, NaN dahil, eşit olmaması gerekse de eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Sadece dahili amaçlar için. |
| virtual [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() | Doldurma tipini döndürür. [Slides::FillType](../filltype/) okuyun. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() | Gradyan doldurma biçimini döndürür. Salt okunur [IGradientFormat](../igradientformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() | Desen doldurma biçimini döndürür. Salt okunur [IPatternFormat](../ipatternformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPictureFillFormat](../ipicturefillformat/)\> [get_PictureFillFormat](./get_picturefillformat/)() | Resim doldurma biçimini döndürür. Salt okunur [IPictureFillFormat](../ipicturefillformat/). |
| virtual [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() | Doldurmanın şekille birlikte döndürülüp döndürülmeyeceğini belirler. [NullableBool](../nullablebool/) okuyun. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() | Doldurma rengini döndürür. Salt okunur [IColorFormat](../icolorformat/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../ifillformateffectivedata/)\> [GetEffective](./geteffective/)() | Kalıtım uygulanmış etkili doldurma biçimlendirme verisini alır. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin hedefTip tarafından tanımlanan tipin bir örneği olup olmadığını denetler. C# 'is' operatörüne benzer. |
...
| virtual void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) | Doldurma tipini ayarlar. [Slides::FillType](../filltype/) yazın. |
| virtual void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) | Doldurmanın şekille birlikte döndürülüp döndürülmeyeceğini belirler. [NullableBool](../nullablebool/) yazın. |
