...
Köprü yönetimini sağlar (ekleme, kaldırma).
...
| void [RemoveHyperlinkClick](./removehyperlinkclick/)() override | Tıklama sırasında köprüyü kaldırır. |
| void [RemoveHyperlinkMouseOver](./removehyperlinkmouseover/)() override | Fare üzerine geldiğinde köprüyü kaldırır. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkClick](./setexternalhyperlinkclick/)([System::String](../../system/string/)) override | Tıklama sırasında harici köprüyü ayarlar. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetExternalHyperlinkMouseOver](./setexternalhyperlinkmouseover/)([System::String](../../system/string/)) override | Fare üzerine geldiğinde harici köprüyü ayarlar. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkClick](./setinternalhyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | Tıklama sırasında dahili köprüyü ayarlar. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetInternalHyperlinkMouseOver](./setinternalhyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>) override | Fare üzerine geldiğinde dahili köprüyü ayarlar. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../ihyperlink/)\> [SetMacroHyperlinkClick](./setmacrohyperlinkclick/)([System::String](../../system/string/)) override | Tıklama sırasında Makro köprüyü ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki göstergeleri zayıf moda geçişe izin verir. |
...
* Sınıf [IHyperlinkManager](../ihyperlinkmanager/)
