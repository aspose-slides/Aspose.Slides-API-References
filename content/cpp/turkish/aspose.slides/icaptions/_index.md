...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Kapalı altyazıların ikili verilerini döndürür. Salt okunur **uint8_t**[]. |
| virtual [System::Guid](../../system/guid/) [get_CaptionId](./get_captionid/)() | Kapalı altyazıların küresel benzersiz tanımlayıcısını (GUID) döndürür. Salt okunur [System::Guid](../../system/guid/). |
| virtual [System::String](../../system/string/) [get_DataAsString](./get_dataasstring/)() | Kapalı altyazı verilerini UTF-8 kodlamalı dize olarak döndürür. Salt okunur [System::String](../../system/string/). |
| virtual [System::String](../../system/string/) [get_Label](./get_label/)() | Kapalı altyazıların etiketini döndürür. Okuma [System::String](../../system/string/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) yönteminin bir analoğu. Özelleştirilmiş nesnelerin hashlenmesini sağlar. |
...
| virtual void [set_Label](./set_label/)([System::String](../../system/string/)) | Kapalı altyazıların etiketini ayarlar. Yazma [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici olarak ayarlar (paylaşılan yerine). Kapsayıcılardaki göstergelerin zayıf moda geçişine izin verir. |
