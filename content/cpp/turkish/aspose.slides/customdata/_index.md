...
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) override | Belirtilen indeksteki özel XML bölümünü döndürür. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() override | Özel xml bölümleri koleksiyonunu döndürür. Salt okunur [ICustomXmlPartCollection](../icustomxmlpartcollection/). |
| [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) override | Belirtilen indeksteki Müşteri Veri Etiketini döndürür. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() override | Müşteri Veri Etiketleri koleksiyonunu döndürür. Salt okunur [ITagCollection](../itagcollection/). |
...
| void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Belirtilen indeksteki Müşteri Veri Etiketini ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki göstericilerin zayıf moda geçirilmesini sağlar. |
