...
---
## ITextFrameFormatEffectiveData sınıf

Değiştirilemez nesne, etkili metin çerçevesi biçimlendirme özelliklerini içerir.
...
| virtual [TextAnchorType](../textanchortype/) [get_AnchoringType](./get_anchoringtype/)() | Bir [TextFrame](../textframe/) içinde dikey çapa metnini döndürür. Yalnızca okunabilir [TextAnchorType](../textanchortype/). |
| virtual [TextAutofitType](../textautofittype/) [get_AutofitType](./get_autofittype/)() | Metin otomatik sığdırma modunu döndürür. Yalnızca okunabilir [TextAutofitType](../textautofittype/). |
| virtual **bool** [get_CenterText](./get_centertext/)() | Metnin yatay olarak kutuya ortalanıp ortalanmayacağını döndürür. Yalnızca okunabilir **bool**. |
| virtual **int32_t** [get_ColumnCount](./get_columncount/)() | Sınırlayıcı dikdörtgendeki metin sütun sayısını belirtir. Yalnızca okunabilir **int32_t**. |
| virtual **float** [get_ColumnSpacing](./get_columnspacing/)() | Metin alanındaki metin sütunları arasındaki boşluğu (puan cinsinden) belirtir. Yalnızca okunabilir **float**. |
| virtual **double** [get_MarginBottom](./get_marginbottom/)() | [TextFrame](../textframe/) içinde alt kenar boşluğunu (puan) döndürür. Yalnızca okunabilir **double**. |
| virtual **double** [get_MarginLeft](./get_marginleft/)() | [TextFrame](../textframe/) içinde sol kenar boşluğunu (puan) döndürür. Yalnızca okunabilir **double**. |
| virtual **double** [get_MarginRight](./get_marginright/)() | [TextFrame](../textframe/) içinde sağ kenar boşluğunu (puan) döndürür. Yalnızca okunabilir **double**. |
| virtual **double** [get_MarginTop](./get_margintop/)() | [TextFrame](../textframe/) içinde üst kenar boşluğunu (puan) döndürür. Yalnızca okunabilir **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextStyleEffectiveData](../itextstyleeffectivedata/)\> [get_TextStyle](./get_textstyle/)() | Etkili metnin stilini döndürür. Yalnızca okunabilir [ITextStyleEffectiveData](../itextstyleeffectivedata/). |
| virtual [Aspose::Slides::TextVerticalType](../textverticaltype/) [get_TextVerticalType](./get_textverticaltype/)() | Metin yönlendirmesini döndürür. Yalnızca okunabilir [Slides::TextVerticalType](../textverticaltype/). |
| virtual **bool** [get_WrapText](./get_wraptext/)() | Metnin [TextFrame](../textframe/) kenar boşluklarında kaydırılıp kaydırılmadığını döndürür. Yalnızca okunabilir **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Aslında hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapıcılarını etkinleştirir. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Aslında hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapıcılarını etkinleştirir. |
...
[ITextFrameFormat](../itextframeformat/) arayüzüyle birlikte, bu arayüz, kalıtımın uygulandığı etkili biçimlendirme değerlerini döndürmek için kullanılır. 
