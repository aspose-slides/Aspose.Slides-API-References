...
Yazı tipi tanımını temsil eder.
...
| virtual [System::String](../../system/string/) [get_FontName](./get_fontname/)() | Yazı tipinin adını döndürür. Yalnızca okunur [System::String](../../system/string/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual [System::String](../../system/string/) [GetFontName](./getfontname/)([System::SharedPtr](../../system/sharedptr/)\<[Theme::IThemeEffectiveData](../../aspose.slides.theme/ithemeeffectivedata/)\>) | Tema referansını kullanılan gerçek yazı tipiyle değiştirerek yazı tipinin adını döndürür. |
