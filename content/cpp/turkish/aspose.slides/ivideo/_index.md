...
description: Bir sunuma gömülü videoyu temsil eder.
type: docs
weight: 4200
...
Sunuma gömülü bir video temsil eder.
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Ses verisinin bir kopyasını döndürür. Büyük miktarda veri durumunda, videonun verisinin belleğe gereksiz yüklenmesini veya OutOfMemoryException oluşmasını önlemek için [IVideo::GetStream](./getstream/) metodunu kullanmayı düşünün. Salt okunur **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Bir videonun MIME tipini [IVideo::get_BinaryData](./get_binarydata/) kodlamasıyla döndürür. Salt okunur [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | Okuma için bir Stream akışı döndürür. 'using' kullanın veya kullandıktan sonra akışı kapatın. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir işaretçi (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçiş yapmayı mümkün kılar. |
