...
---
## IShapeCollection::InsertZoomFrame(int32_t, float, float, float, float, System::SharedPtr\<ISlide\>) yöntemi
...
| --- | --- | --- |
| index | **int32_t** | Zoom çerçevesinin ekleneceği sıfır-tabanlı dizin. |
...
Bu örnek, bir koleksiyonun belirtilen dizininde bir Zoom nesnesi oluşturmayı ve eklemeyi göstermektedir (\"Presentation.pptx\" sunumunda en az iki slayt olduğunu varsayın): 
```cpp
...
## IShapeCollection::InsertZoomFrame(int32_t, float, float, float, float, System::SharedPtr\<ISlide\>, System::SharedPtr\<IPPImage\>) yöntemi

Yeni bir Zoom çerçevesi önceden tanımlı bir görüntüyle oluşturur ve belirtilen dizinde şekil koleksiyonuna ekler.
