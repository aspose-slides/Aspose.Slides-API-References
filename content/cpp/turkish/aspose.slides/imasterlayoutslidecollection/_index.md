...
description: Tanımlı ana slaydın tüm yerleşim slaytlarının koleksiyonunu temsil eder. ILayoutSlideCollection arabirimini, ana slaydların yerleşim slaytlarının bireysel koleksiyonları bağlamında ekleme, yerleştirme, çıkarma ve kopyalama yöntemleriyle genişletir.
type: docs
weight: 2874
url: /tr/aspose.slides/imasterlayoutslidecollection/
---
## IMasterLayoutSlideCollection sınıf

Tanımlı ana slaydın tüm yerleşim slaytlarının koleksiyonunu temsil eder. [ILayoutSlideCollection](../ilayoutslidecollection/) arabirimini, ana slaydların yerleşim slaytlarının bireysel koleksiyonları bağlamında ekleme, yerleştirme, çıkarma ve kopyalama metodlarıyla genişletir.
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Koleksiyonun sonuna yeni bir yerleşim slaytı ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Belirtilen yerleşim slaytının bir kopyasını koleksiyonun sonuna ekler. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [GetByType](../ilayoutslidecollection/getbytype/)([SlideLayoutType](../slidelayouttype/)) | Belirtilen türdeki ilk yerleşim slaytını döndürür. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../ilayoutslidecollection/idx_get/)(**int32_t**) | İndex ile yerleşim slaytını döndürür. Salt okunur [ILayoutSlide](../ilayoutslide/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Insert](./insert/)(**int32_t**, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Koleksiyonun belirtilen konumuna yeni bir yerleşim slaytı ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Koleksiyonun belirtilen konumuna belirtilen yerleşim slaytının bir kopyasını ekler. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Bir dizinin herhangi bir öğesinin var olup olmadığını ya da bir koşulu sağlayıp sağlamadığını belirler. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Giriş dizisinin her öğesi üzerinde bir dönüşüm fonksiyonu çağırılarak elde edilen değerlerin ortalamasını hesaplar. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Bir dizinin ilk öğesini döndürür; dizi boşsa varsayılan bir değeri döndürür. |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Koşulu sağlayan dizinin ilk öğesini döndürür; böyle bir öğe bulunamazsa varsayılan bir değeri döndürür. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Bir dizinin son öğesini döndürür; dizi boşsa varsayılan bir değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesi üzerinde bir dönüşüm fonksiyonu çağırır ve elde edilen en büyük değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesi üzerinde bir dönüşüm fonksiyonu çağırır ve elde edilen en küçük değeri döndürür. |
...
| virtual void [Remove](../ilayoutslidecollection/remove/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Koleksiyondan bir yerleşim (layout) kaldırır. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Koleksiyonun belirtilen indeksindeki öğeyi kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| virtual void [RemoveUnused](../ilayoutslidecollection/removeunused/)() | Kullanılmayan yerleşim slaytlarını (HasDependingSlides false olan slaytlar) kaldırır. |
| virtual void [Reorder](./reorder/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Yerleşim slaytını koleksiyondan belirtilen konuma taşır. |
