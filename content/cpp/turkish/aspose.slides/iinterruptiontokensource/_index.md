...
description: IInterruptionToken kaynağını temsil eder.
type: docs
weight: 2614
url: /tr/aspose.slides/iinterruptiontokensource/
---
## IInterruptionTokenSource sınıf
...
| virtual **bool** [get_IsInterruptionRequested](./get_isinterruptionrequested/)() | Kesinti istenmişse true, aksi takdirde false döndürür. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IInterruptionToken](../iinterruptiontoken/)\> [get_Token](./get_token/)() | Bu [IInterruptionTokenSource](./)'ye bağlı yeni bir token döndürür. |
...
| virtual void [Interrupt](./interrupt/)() | Kesinti isteğini başlatır. |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitlemesini uygular. Doğrudan çağırılabilir veya [LockContext](../../system/lockcontext/) gözetmen nesnesi kullanılabilir. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici olarak ayarlar (paylaşımlı yerine). Kapsayıcılardaki göstericileri zayıf moda geçiş yapmayı sağlar. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açma işlemini uygular. Doğrudan çağırılabilir veya [LockContext](../../system/lockcontext/) gözetmen nesnesi kullanılabilir. |
