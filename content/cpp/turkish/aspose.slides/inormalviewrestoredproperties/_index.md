...
description: Normal görünümde, bölge değişken bir geri yüklenmiş boyutta (ne küçültülmüş ne de büyütülmüş) olduğunda, kaydırımsız bölgenin (restoredTop çocuğu olduğunda genişlik, restoredLeft çocuğu olduğunda yükseklik) boyutlandırılmasını belirtir.
type: docs
weight: 2991
url: /tr/aspose.slides/inormalviewrestoredproperties/
---
## INormalViewRestoredProperties sınıf

Kaydırımsız görünümde, bölge değişken bir geri yüklenmiş boyutta (küçültülmüş ya da büyütülmüş değil) olduğunda, normal görünümün kaydırımsız bölgesinin (restoredTop çocuğu olduğunda genişlik, restoredLeft çocuğu olduğunda yükseklik) boyutlandırılmasını belirtir.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder; fakat IEC 60559:1989’a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder; fakat IEC 60559:1989’a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual **bool** [get_AutoAdjust](./get_autoadjust/)() | Yan içerik bölgesinin boyutunun, uygulama içinde görünümü içeren pencere yeniden boyutlandırıldığında yeni boyuta göre telafi edilip edilmeyeceğini belirtir. Oku **bool**. |
| virtual **float** [get_DimensionSize](./get_dimensionsize/)() | Kaydırımsız bölgenin (RestoredTop çocuğu olduğunda genişlik, RestoredLeft çocuğu olduğunda yükseklik) boyutunu belirtir. Oku **float**. |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitleme işlevini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcüsü nesnesini kullanın. |
...
| virtual void [set_AutoAdjust](./set_autoadjust/)(**bool**) | Yan içerik bölgesinin boyutunun, uygulama içinde görünümü içeren pencere yeniden boyutlandırıldığında yeni boyuta göre telafi edilip edilmeyeceğini belirtir. Yaz **bool**. |
| virtual void [set_DimensionSize](./set_dimensionsize/)(**float**) | Kaydırımsız bölgenin (RestoredTop çocuğu olduğunda genişlik, RestoredLeft çocuğu olduğunda yükseklik) boyutunu belirtir. Yaz **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki göstergelerin zayıf moda geçişini sağlar. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açma işlevini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcüsü nesnesini kullanın. |
