...
description: Kalıtım uygulanmış etkili efekt biçimlendirme verilerini alır.
type: docs
weight: 430
url: /tr/aspose.slides/effectformat/geteffective/
---
## EffectFormat::GetEffective() metodu
...
Bu örnek, şeklin bazı etkili efekt özelliklerini almayı gösterir. 
```cpp
