...
description: Microsoft Purview Information Protection'dan duyarlılık etiketini temsil eder.
type: docs
weight: 3615
url: /tr/aspose.slides/isensitivitylabel/
---
## ISensitivityLabel sınıf


Temsili Microsoft Purview Information Protection’tan duyarlılık etiketidir.
...
| virtual [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/) [get_AssignmentMethodType](./get_assignmentmethodtype/)() | Hassasiyet etiketinin atama yöntemini döndürür. Oku [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IList](../../system.collections.generic/ilist/)\<[SensitivityLabelContentType](../sensitivitylabelcontenttype/)\>\> [get_ContentMarkTypes](./get_contentmarktypes/)() | Bir dosyaya uygulanması gereken içerik işaretleme türlerinin listesini döndürür. |
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | Hassasiyet etiketinin kimliğini döndürür. Oku [System::String](../../system/string/). |
| virtual **bool** [get_IsEnabled](./get_isenabled/)() | Hassasiyet etiketinin etkin olup olmadığını gösterir. |
| virtual **bool** [get_IsRemoved](./get_isremoved/)() | Hassasiyet etiketinin kaldırılıp kaldırılmadığını gösterir. |
| virtual [System::Guid](../../system/guid/) [get_SiteId](./get_siteid/)() | Hassasiyet etiketini tanımlayan hassasiyet etiketi politikasına karşılık gelen Azure Active Directory (Azure AD) site kimliğini döndürür. Oku [System::Guid](../../system/guid/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin hedefTip tarafından tanımlanan tipin bir örneğini temsil edip etmediğini denetler. C# 'is' operatörünün benzeri. |
...
| virtual void [set_AssignmentMethodType](./set_assignmentmethodtype/)([SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | Hassasiyet etiketinin atama yöntemini ayarlar. Yaz [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/). |
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | Hassasiyet etiketinin kimliğini ayarlar. Yaz [System::String](../../system/string/). |
| virtual void [set_IsEnabled](./set_isenabled/)(**bool**) | Hassasiyet etiketinin etkin olup olmadığını gösterir. |
| virtual void [set_IsRemoved](./set_isremoved/)(**bool**) | Hassasiyet etiketinin kaldırılıp kaldırılmadığını gösterir. |
| virtual void [set_SiteId](./set_siteid/)([System::Guid](../../system/guid/)) | Hassasiyet etiketini tanımlayan politikaya karşılık gelen Azure Active Directory (Azure AD) site kimliğini ayarlar. Yaz [System::Guid](../../system/guid/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf göstergeci (paylaşılan yerine) ayarlar. Kapsayıcılardaki göstergeçleri zayıf moda geçişe izin verir. |
