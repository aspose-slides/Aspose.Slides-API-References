...
description: Belge içinde bir 'Heading pair' özelliğini temsil eder. Belge parçalarının grup adını ve gruptaki parça sayısını gösterir.
type: docs
weight: 1223
...
Belge içinde bir 'Heading pair' özelliğini temsil eder. Belge parçalarının grup adını ve gruptaki parça sayısını gösterir.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir, ancak C#-tarzı kayan nokta karşılaştırmasını taklit eder ve iki NaN'ı eşit kabul eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir, ancak C#-tarzı kayan nokta karşılaştırmasını taklit eder ve iki NaN'ı eşit kabul eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **int32_t** [get_Count](./get_count/)() override | Gruptaki parça sayısını döndürür. Salt okunur **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Belge parçalarının grup adını döndürür. Salt okunur [System::String](../../system/string/). |
...
* Sınıf [IHeadingPair](../iheadingpair/)
