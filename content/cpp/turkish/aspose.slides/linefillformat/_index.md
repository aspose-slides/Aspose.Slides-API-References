...
description: Çizgilerin doldurulması için özellikleri temsil eder.
type: docs
weight: 4369
...
Çizgilerin doldurulması için özellikleri temsil eder.
...
| [Aspose::Slides::FillType](../filltype/) [get_FillType](./get_filltype/)() override | Dolgu tipini döndürür. Okuyun [Slides::FillType](../filltype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IGradientFormat](../igradientformat/)\> [get_GradientFormat](./get_gradientformat/)() override | Gradyan dolgu biçimini döndürür. Salt-okunur [IGradientFormat](../igradientformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPatternFormat](../ipatternformat/)\> [get_PatternFormat](./get_patternformat/)() override | Desen dolgu biçimini döndürür. Salt-okunur [IPatternFormat](../ipatternformat/). |
| [NullableBool](../nullablebool/) [get_RotateWithShape](./get_rotatewithshape/)() override | Dolgunun bir şekil ile döndürülüp döndürülmeyeceğini belirler. Okuyun [NullableBool](../nullablebool/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_SolidFillColor](./get_solidfillcolor/)() override | Katı dolgunun rengini döndürür. Salt-okunur [IColorFormat](../icolorformat/). |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesi kilitlemeyi uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) nöbetçi nesnesini kullanın. |
...
| void [set_FillType](./set_filltype/)([Aspose::Slides::FillType](../filltype/)) override | Dolgu tipini ayarlar. [Slides::FillType](../filltype/)'yi yazın. |
| void [set_RotateWithShape](./set_rotatewithshape/)([NullableBool](../nullablebool/)) override | Dolgunun bir şekil ile döndürülüp döndürülmeyeceğini belirler. [NullableBool](../nullablebool/)'yi yazın. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesi kilidini kaldırmayı uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) nöbetçi nesnesini kullanın. |
...
* Sınıf [ILineFillFormat](../ilinefillformat/)
