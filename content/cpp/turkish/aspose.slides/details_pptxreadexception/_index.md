...
type: docs
weight: 742
url: /tr/aspose.slides/details_pptxreadexception/
---
## Details_PptxReadException sınıfı

Sunum okuma hatalarında oluşturulan bir istisnayı temsil eder.
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Geçerli nesne tarafından temsil edilen istisna ile ilişkili HRESULT kodu olan 32 bitlik bir tamsayı değerini döndürür. |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | En iç istisnayı temsil eden Exception nesnesinin bir kopyasını döndürür. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidini açma işlemini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) koruma nesnesini kullanın. |
