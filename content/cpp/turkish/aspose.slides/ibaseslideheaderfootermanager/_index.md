...
description: Tüm slayt türleri için altbilgi, tarih-zaman ve sayfa numarası yer tutucularının davranışlarını tutan yöneticiyi temsil eder.
type: docs
weight: 1509
url: /tr/aspose.slides/ibaseslideheaderfootermanager/
---
## IBaseSlideHeaderFooterManager sınıfı

Tüm slayt türleri için altbilgi, tarih-zaman ve sayfa numarası yer tutucularının davranışlarını tutan yöneticiyi temsil eder.
...
| virtual **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() | Bir tarih-zaman yer tutucusunun mevcut olduğunu gösteren değeri alır. Read**bool**. |
| virtual **bool** [get_IsFooterVisible](./get_isfootervisible/)() | Bir altbilgi yer tutucusunun mevcut olduğunu gösteren değeri alır. Read **bool**. |
| virtual **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() | Bir sayfa numarası yer tutucusunun mevcut olduğunu gösteren değeri alır. Read**bool**. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin hedefTür tarafından tanımlanan türe ait bir örnek olup olmadığını denetler. C# ‘is’ operatörünün analoğu. |
...
| virtual void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) | Slayt tarih-zaman yer tutucusuna metin ayarlar. |
| virtual void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) | Slayt tarih-zaman yer tutucusunun görünürlüğünü değiştirir. |
| virtual void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) | Slayt altbilgi yer tutucusuna metin ayarlar. |
| virtual void [SetFooterVisibility](./setfootervisibility/)(**bool**) | Slayt altbilgi yer tutucusunun görünürlüğünü değiştirir. |
| virtual void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) | Slayt sayfa numarası yer tutucusunun görünürlüğünü değiştirir. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşımlı değil) olarak ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçirmeyi sağlar. |
