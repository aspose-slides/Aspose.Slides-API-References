...
description: Paragrafta kalıtım olmadan metin hizalamasını döndürür. TextAlignment'ı okuyun.
type: docs
weight: 1
url: /tr/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() yöntemi

Paragrafta kalıtım olmadan metin hizalamasını döndürür. Oku [TextAlignment](../../textalignment/).
...
Aşağıdaki örnek kod, PowerPoint'te Metin Paragraflarını Hizalamayı gösterir [Presentation](../../presentation/).
```cpp
