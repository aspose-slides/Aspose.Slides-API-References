...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değerle, NaN dahil, eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C# stilinde kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değerle, NaN dahil, eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C# stilinde kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() | Light direction. Oku [LightingDirection](../lightingdirection/). |
| virtual [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() | Bir şekle uygulanabilen önceden ayarlanmış bir ışık yönünü temsil eder. Light rig, 3D sahneye göre belirli bir şekilde yönlendirilmiş bir grup ışığı temsil eder. Oku [LightRigPresetType](../lightrigpresettype/). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Bir dönüş, enlem koordinatı, boylam koordinatı ve eksen etrafında bir devir kullanılarak tanımlanır; bu koordinatlar enlem ve boylam koordinatlarıdır. dönen dizideki ilk öğe - enlem, ikinci - boylam, üçüncü - devir. |
...
| virtual void [set_Direction](./set_direction/)([LightingDirection](../lightingdirection/)) | Light direction. Yaz [LightingDirection](../lightingdirection/). |
| virtual void [set_LightType](./set_lighttype/)([LightRigPresetType](../lightrigpresettype/)) | Bir şekle uygulanabilen önceden ayarlanmış bir ışık yönünü temsil eder. Light rig, 3D sahneye göre belirli bir şekilde yönlendirilmiş bir grup ışığı temsil eder. Yaz [LightRigPresetType](../lightrigpresettype/). |
| virtual void [SetRotation](./setrotation/)(**float**, **float**, **float**) | Bir dönüş, enlem koordinatı, boylam koordinatı ve eksen etrafında bir devir kullanılarak tanımlanır; bu koordinatlar enlem ve boylam koordinatlarıdır. |
