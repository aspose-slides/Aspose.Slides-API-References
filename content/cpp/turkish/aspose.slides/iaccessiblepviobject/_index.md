...
description: Kalıtım uygulanmış şekilde karşılık gelen etkili veriyi döndürebilen bir tipi temsil eder.
type: docs
weight: 1275
url: /tr/aspose.slides/iaccessiblepviobject/
---
## IAccessiblePVIObject sınıf
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989’a göre NaN’ın hiçbir değerle, NaN dahil, eşit olmamasına rağmen, iki NaN’ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını uygular. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989’a göre NaN’ın hiçbir değerle, NaN dahil, eşit olmamasına rağmen, iki NaN’ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını uygular. |
...
| virtual T [GetEffective](./geteffective/)() | Kalıtım uygulanmış etkili veriyi alır. |
