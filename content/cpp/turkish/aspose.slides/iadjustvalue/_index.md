...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | Değeri derece cinsinden bir açı olarak yorumlar. Oku **float**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Bu ayarlama değerinin adını döndürür. Sadece okunabilir [System::String](../../system/string/). |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | Ayarlama değerini "olduğu gibi" döndürür. Oku **int64_t**. |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | Şekil ayarlamasının tipini döndürür. Sadece okunabilir [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin targetType tarafından tanımlanan bir tip örneği olup olmadığını kontrol eder. C# 'is' operatörünün analogu. |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | Değeri derece cinsinden bir açı olarak yorumlayarak ayarlar. **float** yaz. |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | Ayarlama değerini "olduğu gibi" ayarlar. **int64_t** yaz. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon bağımsız değişkeni bir zayıf gösterici (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki göstergeleri zayıf moda geçişe izin verir. |
