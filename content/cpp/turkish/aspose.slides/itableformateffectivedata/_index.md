...
---
## ITableFormatEffectiveData sınıf
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalDown](../ibasetableformateffectivedata/get_borderdiagonaldown/)() | Aşağı doğru diyagonal çizgi biçimi etkili değerini döndürür. Salt okunur [ILineFormatEffectiveData](../ilineformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatEffectiveData](../ilineformateffectivedata/)\> [get_BorderDiagonalUp](../ibasetableformateffectivedata/get_borderdiagonalup/)() | Yukarı doğru diyagonal çizgi biçimi etkili değerini döndürür. Salt okunur [ILineFormatEffectiveData](../ilineformateffectivedata/). |
...
| virtual **float** [get_Transparency](./get_transparency/)() | Dolgu renginin saydamlığını alır. **float** okur. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını paylaşımlı yerine zayıf bir işaretçiye ayarlar. Kapsayıcılardaki işaretçilerin zayıf moda geçmesini sağlar. |
...
Bu arayüz, [ITableFormat](../itableformat/) arayüzüyle birlikte, miras ve tablo stilleri uygulanmış etkili biçimlendirme değerlerini döndürmek için kullanılır.
