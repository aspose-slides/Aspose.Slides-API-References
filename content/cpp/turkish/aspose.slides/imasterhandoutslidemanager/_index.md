...
description: Ana el kitapçığı slayt yöneticisi.
type: docs
weight: 2861
url: /tr/aspose.slides/imasterhandoutslidemanager/
---
## IMasterHandoutSlideManager sınıf

Master el kitapçığı slayt yöneticisi.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 standardına göre NaN hiçbir değere, NaN dahil, eşit değildir; buna rağmen iki NaN'ın eşit kabul edildiği C#-style kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 standardına göre NaN hiçbir değere, NaN dahil, eşit değildir; buna rağmen iki NaN'ın eşit kabul edildiği C#-style kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [get_MasterHandoutSlide](./get_masterhandoutslide/)() | Bu sunumdaki tüm not slaytları için bir ana slayt döndürür; eğer varsa, yoksa null döndürür. Salt okunur [IMasterHandoutSlide](../imasterhandoutslide/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) yönteminin benzeri. Özel nesnelerin karmasını (hash) sağlayabilir. |
...
| virtual void [RemoveMasterHandoutSlide](./removemasterhandoutslide/)() | Ana el kitapçığı slaytını kaldırır. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterHandoutSlide](../imasterhandoutslide/)\> [SetDefaultMasterHandoutSlide](./setdefaultmasterhandoutslide/)() | Varsayılan ana el kitapçığı slaytını ilgili el kitapçığı slaytına ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (shared yerine) olarak ayarlar. Kapsayıcılardaki göstergelerin zayıf moda geçişini sağlar. |
