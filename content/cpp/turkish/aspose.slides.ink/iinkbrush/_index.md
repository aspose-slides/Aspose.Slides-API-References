...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Bir satır için fırça rengini alır. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | Mürekkep darbesinin görsel stilini tanımlayan mürekkep efekti türünü getirir (ör. Galaxy, Gold, Silver). Değer, fırça özelliği "inkEffects" içinde ayrıştırılır. Tanımlanan bir efekt yoksa, [InkEffectType::NotDefined](../inkeffecttype/) döndürülür. |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Bir satır için fırça boyutunu puan cinsinden alır. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) metodunun benzeri. Özelleştirilmiş nesnelerin hash'lenmesini etkinleştirir. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) metodunun benzeri. Özelleştirilmiş tiplerin klonlanmasını etkinleştirir. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Bir satır için fırça rengini ayarlar. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Bir satır için fırça boyutunu puan cinsinden ayarlar. |
