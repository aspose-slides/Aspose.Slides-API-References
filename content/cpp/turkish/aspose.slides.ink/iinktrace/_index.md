...
Bir [Ink](../ink/) nesnesindeki el yazısı çizgiyi temsil eder.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IInkBrush](../iinkbrush/)\> [get_Brush](./get_brush/)() | IInkLine [IInkBrush](../iinkbrush/) için fırçayı alır. Salt okunur. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | IInkLine [System::Drawing::PointF](../../system.drawing/pointf/) için noktaları alır. Salt okunur. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesi kilidini açmayı uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözetmen nesnesini kullanın. |
