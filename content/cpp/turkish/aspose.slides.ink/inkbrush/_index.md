...
| [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() override | Bir satır için fırça rengini alır. |
| [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() override | Mürekkep etkisi türünü (ör. Galaxy, Gold, Silver) alır; bu, mürekkep darbesinin görsel stilini tanımlar. Değer fırça özelliği "inkEffects"tan ayrıştırılır. Tanınan bir etki belirtilmezse [InkEffectType::NotDefined](../inkeffecttype/) döndürülür. |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Bir satır için fırça boyutunu puan cinsinden alır. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Değer tipindeki nesneyi nullptr ile başvuru karşılaştırır. |
...
| void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) override | Bir satır için fırça rengini ayarlar. |
| void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) override | Bir satır için fırça boyutunu puan cinsinden ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici olarak ayarlar (paylaşımlı yerine). Kapsayıcılardaki göstergeleri zayıf moda geçiş yapmayı sağlar. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidi açmasını uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözetmen nesnesini kullanın. |
