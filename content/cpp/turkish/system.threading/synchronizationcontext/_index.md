...
description: Bir senkronizasyon bağlamını çeşitli senkronizasyon işlemleri boyunca yaymak için temel işlevselliği sağlar.
type: docs
weight: 196
url: /tr/system.threading/synchronizationcontext/
---
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | Mevcut iş parçacığı için senkronizasyon bağlamını alır. |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Geri çağırmayı asenkron olarak çalıştırır. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Geri çağırmayı senkron olarak çalıştırır. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | Mevcut iş parçacığı için senkronizasyon bağlamını ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon bağımsız değişkeni zayıf bir işaretçi (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçişe izin verir. |
| int [SharedCount](../../system/object/sharedcount/)() const | Paylaşılan referans sayacının mevcut değerini alır. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Paylaşılan referans sayacını artırır. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler veya ThisProtector kullanılmalıdır. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Paylaşılan referans sayacını azaltır ve döndürür. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler veya ThisProtector kullanılmalıdır. |
|  [SynchronizationContext](./synchronizationcontext/)() | [SynchronizationContext](./)'nin yeni bir örneğini oluşturur. |
...
Bu sınıf, senkronizasyon bağlamının iş parçacıkları arasında yayılmasını sağlar ve geri çağırma veya çağrıları uygun iş parçacığına veya senkronizasyon bağlamına yönlendirmek için kullanılır. Sahte uygulama. 
