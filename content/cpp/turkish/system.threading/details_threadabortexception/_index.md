...
type: docs
weight: 79
url: /tr/system.threading/details_threadabortexception/
---
## Details_ThreadAbortException sınıf
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Belirli bir istisnaya atanan kodlanmış sayısal değer olan HRESULT'i ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını güçlü (shared) yerine zayıf bir işaretçi olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçirmeye izin verir. |
