...
description: "Otomatik olarak sıfırlanmayan bekleyen iş parçacığını bildiren olay. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak tahsis edilmelidir. Bu türün örneğini yığında veya new operatörüyle asla oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisiyle sarmalayın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 144
url: /tr/system.threading/manualresetevent/
---
...
|  [ManualResetEvent](./manualresetevent/)(**bool**) | Yapıcı. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Referansla değer tipinde nesneyi nullptr ile karşılaştırır. |
...
| virtual **bool** [WaitOne](../waithandle/waitone/)() | Handle'ın sınırsız bir süre için tetiklenmesini bekler. |
...
| Field | Description |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Zaman aşımı geçer ve hiçbir şey sinyal vermediğinde, fonksiyonun döndüreceği özel değer; aksi takdirde işaretlenen nesnenin dizideki indeksini döndürür. |
