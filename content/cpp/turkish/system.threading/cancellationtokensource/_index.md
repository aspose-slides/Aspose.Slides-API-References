...
description: İptal bildirimi tetiklemek için kullanılabilen bir iptal token kaynağı.
type: docs
weight: 40
url: /tr/system.threading/cancellationtokensource/
---
...
| Metot | Açıklama |
| --- | --- |
| void [Cancel](./cancel/)() | İptal talebini iletir. |
| [CancellationTokenSource](./cancellationtokensource/)() | Yeni bir [CancellationTokenSource](./) oluşturur. |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | Sağlanan tokenlerden herhangi biri iptal edildiğinde iptal olan bağlanmış bir token kaynağı oluşturur. |
| void [Dispose](./dispose/)() override | [CancellationTokenSource](./) tarafından kullanılan tüm kaynakları serbest bırakır. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN hiçbir değerle, NaN dahil, eşit olmamasına rağmen, iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN hiçbir değerle, NaN dahil, eşit olmamasına rağmen, iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | İptalin istekte bulunulup bulunmadığını alır. |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | Bu kaynakla ilişkilendirilmiş iptal token'ını alır. |
...
İşlemlerin işbirlikçi iptali için iptal token'ları oluşturma ve kontrol etme mekanizmaları sağlar. 
## Bkz
