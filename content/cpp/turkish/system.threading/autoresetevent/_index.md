...
description: "Otomatik olarak sıfırlanan bir bekleyen iş parçacığını bilgilendiren olay. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak allocate edilmelidir. Bu tipin bir örneğini yığın üzerinde ya da operator new ile oluşturmamaya dikkat edin; aksi takdirde çalışma zamanı hataları ve/veya assertion hataları oluşur. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 1
url: /tr/system.threading/autoresetevent/
---
## AutoResetEvent sınıfı
...
| Method | Description |
| --- | --- |
|  [AutoResetEvent](./autoresetevent/)(**bool**) | Yapıcı. |
| virtual void [Close](../waithandle/close/)() | Handle ile ilişkili herhangi bir kaynağı serbest bırakır. |
...
|  [EventWaitHandle](../eventwaithandle/eventwaithandle/)(**bool**, [EventResetMode](../eventresetmode/)) | Yapıcı. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Belirtilen değer kadar paylaştırılmış referans sayacını azaltır. |
| virtual **bool** [Reset](../eventwaithandle/reset/)() | Olayı sinyal vermeyen duruma ayarlar. |
| virtual **bool** [Set](../eventwaithandle/set/)() | Olayı sinyal veren duruma ayarlar. |
...
| virtual **bool** [WaitOne](../waithandle/waitone/)() | Handle'ın sınırsız süre bekleyerek tetiklenmesini bekler. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int) | Handle'ın tetiklenmesini bekler. |
...
|  [~EventWaitHandle](../eventwaithandle/~eventwaithandle/)() | Yıkıcı. |
...
| Field | Description |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Zaman aşımı aşıldığında ve hiçbir şey sinyal vermediğinde, dizi içindeki sinyal verilen nesnenin indeksini döndüren fonksiyonun aksi takdirde döndüreceği özel değer. |
...
* Sınıf [EventWaitHandle](../eventwaithandle/)
