...
description: "XML imzasının 'X509IssuerSerial' öğesini temsil eder. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tipin örneğini yığına (stack) ya da new operatörüyle oluşturmaktan kaçının; aksi takdirde çalışma zamanı hataları ve/veya hata durumları ortaya çıkabilir. Bu sınıfı her zaman System::SmartPtr işaretçisiyle sarmalayıp, bu işaretçiyi işlevlere argüman olarak geçirin."
type: docs
weight: 157
url: /tr/system.security.cryptography.xml/x509issuerserial/
---
## X509IssuerSerial sınıfı
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitleme işlevini gerçekleştirir. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözetleyici nesnesini kullanın. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Değer türü nesnesini nullptr ile referans tabanlı karşılaştırır. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | C# typeof([System.Object](../../system/object/)) yapılandırmasını gerçekleştirir. |
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açma işlevini gerçekleştirir. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözetleyici nesnesini kullanın. |
