...
description: "Dikdörtgen bir tarama stiline, ön plan rengine ve arka plan rengine sahip bir fırça temsil eder. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tür bir örneği yığıt üzerinde veya yeni operatörüyle oluşturmayın, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisiyle sarmalayın ve bu işaretçiyi işlevlere argüman olarak geçirin."
type: docs
weight: 92
url: /tr/system.drawing.drawing2d/hatchbrush/
---
## HatchBrush sınıf
...
| Yöntem | Açıklama |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | Mevcut nesnenin tam bir kopyasını oluşturur. |
...
| [Color](../../system.drawing/color/) [get_BackgroundColor](./get_backgroundcolor/)() const | Bu fırçanın arka plan rengini gösteren bir değer döndürür. |
| [Color](../../system.drawing/color/) [get_ForegroundColor](./get_foregroundcolor/)() const | Bu fırçanın ön plan rengini gösteren bir değer döndürür. |
| [HatchStyle](../hatchstyle/) [get_HatchStyle](./get_hatchstyle/)() const | Bu fırçanın tarama stilini gösteren bir değer döndürür. |
...
| [HatchBrush](./hatchbrush/)([HatchStyle](../hatchstyle/), [Color](../../system.drawing/color/), [Color](../../system.drawing/color/)) | Belirtilen tarama stili, ön plan rengi ve arka plan rengiyle bir [HatchBrush](./) sınıfının yeni bir örneğini oluşturur. |
