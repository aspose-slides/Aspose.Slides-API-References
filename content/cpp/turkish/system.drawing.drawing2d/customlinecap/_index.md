...
| Method | Description |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[CustomLineCap](./)\> [Clone](./clone/)() | Mevcut nesnenin bir kopyasını döndürür. |
|  [CustomLineCap](./customlinecap/)(const [SharedPtr](../../system/sharedptr/)\<[GraphicsPath](../graphicspath/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[GraphicsPath](../graphicspath/)\>\&, [LineCap](../linecap/), **float**) | [CustomLineCap](./) sınıfının belirtilen özelliklerle kullanıcı tanımlı bir çizgi ucu temsil eden yeni bir örneğini oluşturur. |
...
| [LineCap](../linecap/) [get_BaseCap](./get_basecap/)() const | Bu özel ucun oluşturulduğu temel çizgi ucunu döndürür. |
| **float** [get_BaseInset](./get_baseinset/)() const | Çizgi ile uç arasındaki mesafeyi döndürür. |
| [LineJoin](../linejoin/) [get_StrokeJoin](./get_strokejoin/)() const | Bu özel ucun çizgilerinin nasıl birleştirileceğini belirleyen LineJoin değerini döndürür. |
| **float** [get_WidthScale](./get_widthscale/)() const | Bu özel ucun ölçeğini döndürür. |
...
| void [GetStrokeCaps](./getstrokecaps/)([LineCap](../linecap/)\&, [LineCap](../linecap/)\&) | Mevcut nesne tarafından temsil edilen özel ucun başlangıç ve bitiş çizgi uçlarını alır. |
...
| void [set_BaseCap](./set_basecap/)([LineCap](../linecap/)) | Bu özel uc için temel çizgi ucunu ayarlar. |
| void [set_BaseInset](./set_baseinset/)(**float**) | Çizgi ile uç arasındaki mesafeyi ayarlar. |
| void [set_StrokeJoin](./set_strokejoin/)([LineJoin](../linejoin/)) | Bu özel ucun çizgilerinin nasıl birleştirileceğini belirleyen LineJoin değerini ayarlar. |
| void [set_WidthScale](./set_widthscale/)(**float**) | Bu özel ucun ölçek değerini ayarlar. |
| void [SetStrokeCaps](./setstrokecaps/)([LineCap](../linecap/), [LineCap](../linecap/)) | Mevcut nesne tarafından temsil edilen özel ucun başlangıç ve bitiş çizgi uçlarını ayarlar. |
