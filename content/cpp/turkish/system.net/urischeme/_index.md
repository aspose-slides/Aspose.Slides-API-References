...
description: "URI şemasını temsil eder. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak allocate edilmelidir. Bu tipin bir örneğini yığında veya new operatörüyle yaratmayın, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına sebep olur. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."  
type: docs  
weight: 456  
url: /tr/system.net/urischeme/  
---
## UriScheme sınıfı
...
| Alan | Açıklama |
| --- | --- |
| static [Http](./http/) | HTTP dizesi temsili. |
| static [Https](./https/) | HTTPS dizesi temsili. |
| static [SchemeDelimiter](./schemedelimiter/) | Şema ayırıcıyı temsil eden dize. |
| static [Ws](./ws/) | WS dizesi temsili. |
| static [Wss](./wss/) | WSS dizesi temsili. |
