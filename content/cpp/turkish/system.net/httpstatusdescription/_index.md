...
description: HTTP durumunun dize temsili elde etmek için yardımcı yöntemleri içerir.
type: docs
weight: 248
url: /tr/system.net/httpstatusdescription/
---

## HttpStatusDescription sınıfı

HTTP durum kodunun dize temsili elde etmek için yardımcı yöntemleri içerir.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'ın hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'ı eşit kabul eden C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'ın hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'ı eşit kabul eden C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| static [String](../../system/string/) [Get](./get/)([HttpStatusCode](../httpstatuscode/)) | Belirtilen HTTP durum kodunun dize açıklamasını döndürür. |
| static [String](../../system/string/) [Get](./get/)(**int32_t**) | Belirtilen HTTP durum kodunun dize açıklamasını döndürür. |
...
|  [HttpStatusDescription](./httpstatusdescription/)() | Silinmiş varsayılan yapıcı. |
