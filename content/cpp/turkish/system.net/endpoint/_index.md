...
| Yöntem | Açıklama |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[EndPoint](./)\> [Create](./create/)([System::SharedPtr](../../system/sharedptr/)\<[SocketAddress](../socketaddress/)\>) | Belirtilen soket adresini kullanarak [EndPoint](./) sınıfının yeni bir örneğini oluşturur. |
...
| virtual [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/) [get_AddressFamily](./get_addressfamily/)() | Geçerli örneğin ait olduğu adres ailesini döndürür. |
...
| virtual [ImplPtr](./implptr/) [GetImpl](./getimpl/)() const | Uygulamaya bir işaretçi döndürür. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) yönteminin analoğu. Özel türlerin kopyalanmasını (klonlanmasını) sağlar. |
