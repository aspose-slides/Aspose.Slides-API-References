...
description: "BeginPrint ve EndPrint olayları için veri sağlar. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak allocate edilmelidir. Bu tipin örneği yığına (stack) veya new operatörüyle oluşturulmamalıdır, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 92
url: /tr/system.drawing.printing/printeventargs/
---
## PrintEventArgs sınıfı
...
| Yöntem | Açıklama |
| --- | --- |
|  [CancelEventArgs](../../system.componentmodel/canceleventargs/canceleventargs/)(**bool**) | Yapıcı. |
|  [CancelEventArgs](../../system.componentmodel/canceleventargs/canceleventargs/)() | Yapıcı; Cancel özelliğini false olarak ayarlar. |
...
| **bool** [get_Cancel](../../system.componentmodel/canceleventargs/get_cancel/)() | İşlemin iptal edilip edilmeyeceğini gösteren değeri alır. |
| [PrintAction](../printaction/) [get_PrintAction](./get_printaction/)() | Geçerli nesne tarafından temsil edilen bir yazdırma eylemini belirten bir değer döndürür. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) metodunun benzeri. Özel tiplerin kopyalanmasını (klonlanmasını) sağlar. |
...
|  [PrintEventArgs](./printeventargs/)() | Yeni bir [PrintEventArgs](./) nesnesi örneği oluşturur. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | String ve nullptr durumları için [Object::ReferenceEquals](../../system/object/referenceequals/)'nin özel durumu. |
...
| void [set_Cancel](../../system.componentmodel/canceleventargs/set_cancel/)(**bool**) | İşlemin iptal edilip edilmeyeceğini gösteren değeri ayarlar. |
...
| Alan | Açıklama |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Bir "boş" [EventArgs](../../system/eventargs/) paylaşılan işaretçiyi (null-pointer) temsil eden statik bir üye. |

## Ayrıca bakınız

* Sınıf [CancelEventArgs](../../system.componentmodel/canceleventargs/)
* Ad alanı [System::Drawing::Printing](../)
