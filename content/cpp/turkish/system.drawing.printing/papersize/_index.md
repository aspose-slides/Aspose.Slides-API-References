...
type: docs
weight: 27
url: /tr/system.drawing.printing/papersize/
---
## PaperSize sınıfı
...
| **int32_t** [get_Height](./get_height/)() const | Kağıdın yüksekliğini, inçin yüzde bir biriminde alır. |
| [PaperKind](../paperkind/) [get_Kind](./get_kind/)() const | Kağıt tipini alır. |
| [System::String](../../system/string/) [get_PaperName](./get_papername/)() const | Kağıt tipinin adını alır. |
| **int32_t** [get_RawKind](./get_rawkind/)() const | [System::Drawing::Printing::PaperSize](./) değerlerinden birini veya özel bir değeri temsil eden bir tamsayı alır. |
| **int32_t** [get_Width](./get_width/)() const | Kağıdın genişliğini, inçin yüzde bir biriminde alır. |
...
|  [PaperSize](./papersize/)() | Yeni bir [System::Drawing::Printing::PaperSize](./) sınıfı örneği başlatır. |
|  [PaperSize](./papersize/)([PaperKind](../paperkind/), [System::String](../../system/string/), **int32_t**, **int32_t**) | Yeni bir [System::Drawing::Printing::PaperSize](./) sınıfı örneği başlatır. |
|  [PaperSize](./papersize/)([System::String](../../system/string/), **int32_t**, **int32_t**) | Yeni bir [System::Drawing::Printing::PaperSize](./) sınıfı örneği başlatır. |
...
| void [set_Height](./set_height/)(**int32_t**) | Kağıdın yüksekliğini, inçin yüzde bir biriminde ayarlar. |
| void [set_PaperName](./set_papername/)([System::String](../../system/string/)) | Kağıt tipinin adını ayarlar. |
| void [set_RawKind](./set_rawkind/)(**int32_t**) | [System::Drawing::Printing::PaperSize](./) değerlerinden birini veya özel bir değeri temsil eden bir tamsayı ayarlar. |
| void [set_Width](./set_width/)(**int32_t**) | Kağıdın genişliğini, inçin yüzde bir biriminde ayarlar. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | [System::Drawing::Printing::PaperSize](./) hakkında bilgiyi dize biçiminde sağlar. |
...
* AdAlanı [System::Drawing::Printing](../)
