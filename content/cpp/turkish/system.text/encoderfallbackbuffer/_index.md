...
description: "Yedekleme uygulaması için tampon sağlar. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak tahsis edilmelidir. Bu tipin örneği yığında veya operator new ile oluşturulmamalıdır, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 183
url: /tr/system.text/encoderfallbackbuffer/
---
## EncoderFallbackBuffer sınıfı

Yedekleme uygulaması için tampon sağlar. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak tahsis edilmelidir. Bu tür bir örnek hiçbir zaman yığında veya operator new kullanılarak oluşturulmamalıdır, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına neden olur. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 standartına göre NaN hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 standartına göre NaN hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [Fallback](./fallback/)(char_t, int) | Gerçek yedekleme prosedürünü uygular. |
| virtual **bool** [Fallback](./fallback/)(char_t, char_t, int) | Gerçek yedekleme prosedürünü uygul ar. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual int [get_Remaining](./get_remaining/)() const | İşlenecek kalan karakter sayısını alır. |
...
| virtual char_t [GetNextChar](./getnextchar/)() | Yedekleme tamponundaki bir sonraki karakteri çıkartır. |
...
| virtual **bool** [MovePrevious](./moveprevious/)() | Mümkünse tampon konumunu bir adım geriye kaydırır. |
...
| virtual void [Reset](./reset/)() | Tamponu başlangıç durumuna sıfırlar. |
