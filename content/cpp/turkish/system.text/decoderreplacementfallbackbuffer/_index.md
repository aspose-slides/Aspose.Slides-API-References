...
description: Kod çözümleme geri dönüş stratejisini değiştirmek için tampon.
type: docs
weight: 92
url: /tr/system.text/decoderreplacementfallbackbuffer/
---
## DecoderReplacementFallbackBuffer sınıfı

[Buffer](../../system/buffer/) kod çözücü geri dönüş stratejisini değiştirmek için.
...
| Metot | Açıklama |
| --- | --- |
|  [DecoderReplacementFallbackBuffer](./decoderreplacementfallbackbuffer/)(const [DecoderReplacementFallbackPtr](../../system/decoderreplacementfallbackptr/)\&) | Yapıcı. |
...
| **bool** [Fallback](./fallback/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Kod çözümleme hatasını ele alır. |
...
| void [Reset](./reset/)() override | Arabellegi ilk durumuna ([Fallback()](./fallback/) çağrısından önce) sıfırlar. |
