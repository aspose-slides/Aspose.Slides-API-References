...
description: "İstisna fırlatan kod çözücü geri dönüş stratejisi için tampon. Aslında hiçbir şey depolamaz, ancak bunun yerine fırlatır. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak tahsis edilmelidir. Bu tipin örneği yığıt üzerinde veya operator new kullanılarak oluşturulmamalıdır, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi işlevlere argüman olarak geçirmek için kullanın."
type: docs
weight: 40
url: /tr/system.text/decoderexceptionfallbackbuffer/
---
## DecoderExceptionFallbackBuffer sınıfı

[Buffer](../../system/buffer/) istisna fırlatan kod çözücü geri dönüş stratejisi için. Aslında hiçbir şey depolamaz, ancak bunun yerine fırlatır. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) fonksiyonu kullanılarak tahsis edilmelidir. Bu tür bir örnek hiçbir zaman yığıt üzerinde veya operator new kullanılarak oluşturulmamalıdır, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi işlevlere argüman olarak geçirmek için kullanın.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'ın eşit kabul edildiği C#-stili kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'ın eşit kabul edildiği C#-stili kayan nokta karşılaştırmasını taklit eder. |
| **bool** [Fallback](./fallback/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Kod çözme hatasını ele alır. |
...
| virtual void [Reset](../decoderfallbackbuffer/reset/)() | Arabelleği başlangıç durumuna sıfırlar. |
...
* Sınıf [DecoderFallbackBuffer](../decoderfallbackbuffer/)
