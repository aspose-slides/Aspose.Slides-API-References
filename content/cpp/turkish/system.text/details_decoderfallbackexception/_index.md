...
description: "Kod çözücü başarısız olduğunda DecoderExceptionFallback tarafından atılan istisna. Bu sınıfın örneklerini manuel olarak oluşturmayın. Bunun yerine DecoderFallbackException sınıfını kullanın. DecoderFallbackException sınıfı örneklerini System::SmartPtr içine asla sarmalamayın."
type: docs
weight: 105
url: /tr/system.text/details_decoderfallbackexception/
---
## Details_DecoderFallbackException sınıfı
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | Hatanın tetiklendiği bayt dizisini alır. |
...
| int [get_Index](./get_index/)() | Giriş dizisinde hatayı tetikleyen baytın konumunu alır. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Belirli bir istisna için atanmış kodlu sayısal bir değer olan HRESULT'u ayarlar. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) metodunu uygular; bu metod [ExceptionWrapper](../../system/exceptionwrapper/) sınıfı tarafından çağrılır. Bu sınıf std::exception'tan türetilmediği halde türetilen sınıflar korumalı/özel üyeleri mantıklarını uygulamak için kullanabilir. Bu metodun uygulanmasını [ExceptionWrapper](../../system/exceptionwrapper/)'ye taşımak bu mantığı bozabilir. |
