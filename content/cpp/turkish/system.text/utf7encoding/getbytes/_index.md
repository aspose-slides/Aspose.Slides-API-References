...
description: Bir karakter tamponunu kodlamaktan elde edilen baytları alır.
type: docs
weight: 66
url: /tr/system.text/utf7encoding/getbytes/
---
## UTF7Encoding::GetBytes(ArrayPtr\<char_t\>, int, int, ArrayPtr\<uint8_t\>, int) yöntem


Karakter tamponunu kodlamadan elde edilen baytları alır.
...
## UTF7Encoding::GetBytes(const char_t *, int, uint8_t *, int) yöntem
...
## UTF7Encoding::GetBytes(const String\&, int, int, ArrayPtr\<uint8_t\>, int) yöntem
...
## UTF7Encoding::GetBytes(System::Details::ArrayView\<char_t\>, int, int, System::Details::ArrayView\<uint8_t\>, int) yöntem
...
## UTF7Encoding::GetBytes(System::Details::StackArray\<char_t, SC\>\&, int, int, System::Details::StackArray\<uint8_t, SB\>\&, int) yöntem
...
## UTF7Encoding::GetBytes(const String\&) yöntem
...
[Buffer](../../../system/buffer/) kodlanan karakterlerin temsili tutan bir dizi.

## UTF7Encoding::GetBytes(ArrayPtr\<char_t\>, int, int) yöntem
...
## UTF7Encoding::GetBytes(const System::Details::ArrayView\<char_t\>\&, int, int) yöntem
...
## UTF7Encoding::GetBytes(const System::Details::StackArray\<char_t, N\>\&, int, int) yöntem
...
## UTF7Encoding::GetBytes(ArrayPtr\<char_t\>) yöntem
