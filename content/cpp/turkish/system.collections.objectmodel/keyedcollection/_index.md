...
description: "Gömülü anahtarlarla öğelerin soyut koleksiyonu. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tipin örneğini stack üzerinde veya operator new kullanarak asla oluşturmayın; aksi takdirde çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirmek için kullanın."
type: docs
weight: 14
url: /tr/system.collections.objectmodel/keyedcollection/
---
## KeyedCollection sınıfı

Yerleşik anahtarlarla öğelerin soyut koleksiyonu. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak ayrılmalıdır. Bu türden bir örnek hiç stack üzerinde veya operator new kullanılarak oluşturulmamalıdır, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisiyle sarmalayın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| Metot | Açıklama |
| --- | --- |
| void [Add](./add/)(const TItem\&) override | Öğeyi kapsayıcının sonuna ekle. |
...
| void [Clear](../collection/clear/)() override | Tüm öğeleri siler. |
| [Collection](../collection/collection/)() | Boş bir koleksiyon oluşturur. |
| [Collection](../collection/collection/)([SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\>) |  |
| **bool** [Contains](./contains/)(TKey) | Anahtarın kapsayıcıda bulunup bulunmadığını kontrol eder. |
| **bool** [Contains](../collection/contains/)(const T\&) const override | Öğenin koleksiyonda bulunup bulunmadığını kontrol eder. |
| void [CopyTo](../collection/copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Koleksiyon öğelerini mevcut dizi öğelerine kopyalar. |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [crbegin](../collection/crbegin/)() const | Koleksiyonun (terste ilk) son const nitelikli öğesine ters yineleyici alır. |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [crend](../collection/crend/)() const | Koleksiyonun başlangıcından önceki var olmayan const nitelikli öğe için ters yineleyici alır. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN hiçbir değere eşit olmamasına rağmen iki NaN'in eşit kabul edildiği C# tarzı çift duyarlı (double) karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEqualityComparer](../../system.collections.generic/iequalitycomparer/)\<TKey\>\> [get_Comparer](./get_comparer/)() | Karşılaştırıcıyı alır. |
| int [get_Count](../collection/get_count/)() const override | Öğe sayısını alır. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](../collection/get_items/)() | İç veri yapısı erişicisi. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](../collection/get_items/)() const | İç veri yapısı erişicisi. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../collection/getenumerator/)() override | Koleksiyon içinde yinelemek için enumeratörü alır. |
...
| TItem [idx_get](./idx_get/)(TKey) | Belirli bir indeksdeki öğeyi alır. |
| T [idx_get](../collection/idx_get/)(int) const override | Belirtilen indeksteki değeri alır. |
| void [idx_set](../collection/idx_set/)(int, T) override | Belirtilen indeksteki değeri ayarlar. |
| int [IndexOf](../collection/indexof/)(const T\&) const override | Koleksiyonda öğeyi arar. |
| void [Insert](../collection/insert/)(int, const T\&) override | Öğeyi belirtilen konuma ekler. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin hedefTür tarafından tanımlanan tipe ait bir örnek olup olmadığını kontrol eder. C# 'is' operatörünün analoğu. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine dönüşüm fonksiyonu uygular ve en büyük sonucu döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine dönüşüm fonksiyonu uygular ve en küçük sonucu döndürür. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Her öğenin indeksini ekleyerek bir dizinin her öğesini yeni bir forma dönüştürür. |
...
| T\& [operator[]](../collection/operator[]/)(int) | Belirtilen indeksteki değeri alır. |
| const T\& [operator[]](../collection/operator[]/)(int) const | Belirtilen indeksteki değeri alır. |
| [reverse_iterator](../collection/reverse_iterator/) [rbegin](../collection/rbegin/)() | Koleksiyonun son öğesine (terste ilk) ters yineleyici alır. |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [rbegin](../collection/rbegin/)() const | Const nitelikli koleksiyonun son öğesine (terste ilk) ters yineleyici alır. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin stringler durumuna özel bir türevi. |
| **bool** [Remove](./remove/)(TKey) | Anahtarı kapsayıcıdan kaldırır. |
| **bool** [Remove](../collection/remove/)(const T\&) override | Belirli öğeyi kaldırır. |
| void [RemoveAt](../collection/removeat/)(int) override | Belirli konumdaki öğeyi kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| [reverse_iterator](../collection/reverse_iterator/) [rend](../collection/rend/)() | Koleksiyonun başlangıcından önceki var olmayan öğe için ters yineleyici alır. |
| [const_reverse_iterator](../collection/const_reverse_iterator/) [rend](../collection/rend/)() const | Const nitelikli koleksiyonun başlangıcından önceki var olmayan öğe için ters yineleyici alır. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Belirli şablon argümanını, uygun ise, paylaşılan işaretçi yerine zayıf işaretçi olarak işler. |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../collection/virtualizebeginconstiterator/)() const override | Mevcut kapsayıcı için begin const yineleyici uygulamasını alır. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginIterator](../collection/virtualizebeginiterator/)() override | Mevcut kapsayıcı için begin yineleyici uygulamasını alır. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../collection/virtualizeendconstiterator/)() const override | Mevcut kapsayıcı için end const yineleyici uygulamasını alır. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](../collection/virtualizeenditerator/)() override | Mevcut kapsayıcı için end yineleyici uygulamasını alır. |
