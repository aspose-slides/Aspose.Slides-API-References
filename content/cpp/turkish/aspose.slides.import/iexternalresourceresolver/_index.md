...
description: HTML ve SVG belgeleri içe aktarılırken dış kaynakları çözmek için kullanılan geri çağırma arayüzü.
type: docs
weight: 40
url: /tr/aspose.slides.import/iexternalresourceresolver/
---
## IExternalResourceResolver sınıf
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](./getentity/)([System::String](../../system/string/)) | Bir URI'yi gerçek kaynağı içeren bir nesneyle eşleştirir. |
...
| virtual [System::String](../../system/string/) [ResolveUri](./resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | Temel ve göreli URI'lardan mutlak URI'yi çözer. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 'n'inci şablon argümanını zayıf gösterge (shared yerine) olarak ayarlar. Kapsayıcılardaki göstergeleri zayıf moda geçişine izin verir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilitlemesini kaldırır. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
