...
description: HTML içe aktarma rutininde görüntüler gibi referans verilen nesneleri elde etmek için kullanılan geri çağırma arayüzü.
type: docs
weight: 53
url: /tr/aspose.slides.import/ihtmlexternalresolver/
---
## IHtmlExternalResolver sınıf

HTML içe aktarma rutininde görüntüler gibi referans verilen nesneleri elde etmek için kullanılan geri çağırma arayüzü.
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# biçiminde referans tipindeki nesneleri karşılaştırır. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# biçiminde değer tipindeki nesneleri karşılaştırır. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetEntity](../iexternalresourceresolver/getentity/)([System::String](../../system/string/)) | Bir URI'yı gerçek kaynağı içeren bir nesneye eşler. |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitlemesini uygular. Doğrudan çağırılabilir veya [LockContext](../../system/lockcontext/) gözlem nesnesi kullanılabilir. |
...
| virtual [System::String](../../system/string/) [ResolveUri](../iexternalresourceresolver/resolveuri/)([System::String](../../system/string/), [System::String](../../system/string/)) | Temel ve göreli URI'lerden mutlak URI'yi çözer. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açmasını uygular. Doğrudan çağırılabilir veya [LockContext](../../system/lockcontext/) gözlem nesnesi kullanılabilir. |
...
Kullanım Dışı
:   Eski. [IExternalResourceResolver](../iexternalresourceresolver/) yerine kullanın. 17.12 sürümünde kaldırılacak.

## Ayrıca Bakınız

* Sınıf [IExternalResourceResolver](../iexternalresourceresolver/)
