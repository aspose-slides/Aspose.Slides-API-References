...
| **bool** [get_DetectTables](./get_detecttables/)() const | PDF dosyası içe aktarılırken tabloların algılanıp algılanmayacağını belirler. |
...
| void [set_DetectTables](./set_detecttables/)(**bool**) | PDF dosyası içe aktarılırken tabloların algılanıp algılanmayacağını belirler. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidini açma işlevini uygular. Doğrudan çağırılabilir veya [LockContext](../../system/lockcontext/) gözetleme nesnesi kullanılabilir. |
