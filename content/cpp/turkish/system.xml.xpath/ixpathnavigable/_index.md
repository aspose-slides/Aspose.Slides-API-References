...
description: XPathNavigator sınıfına bir erişim sağlayıcı sunar.
type: docs
weight: 14
url: /tr/system.xml.xpath/ixpathnavigable/
---
## IXPathNavigable sınıf
...
| Yöntem | Açıklama |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() | Yeni bir [XPathNavigator](../xpathnavigator/) nesnesi döndürür. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 'n'üncü şablon argümanını zayıf bir gösterici olarak ayarlar (paylaşımlı yerine). Kapsayıcılardaki göstergelerin zayıf moda geçmesini sağlar. |
