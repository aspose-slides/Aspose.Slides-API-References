...
description: XPath veri modelini kullanarak bir XML belgesinin hızlı, salt okunur, bellek içi temsilini sağlar.
type: docs
weight: 27
url: /tr/system.xml.xpath/xpathdocument/
---
## XPathDocument sınıfı
...
| Metot | Açıklama |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() override | Bu [XPathDocument](./) içindeki düğümler arasında gezinmek için salt okunur [XPathNavigator](../xpathnavigator/) nesnesi başlatır. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | [Object.GetHashCode()](../../system/object/gethashcode/) metodunun C# analogudur. Özel nesnelerin hashlemesini sağlar. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | string'ler durumu için [Object::ReferenceEquals](../../system/object/referenceequals/) özel durumudur. |
...
|  [XPathDocument](./xpathdocument/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&) | Belirtilen [XmlReader](../../system.xml/xmlreader/) nesnesinde bulunan XML verilerinden [XPathDocument](./) sınıfının yeni bir örneğini başlatır. |
|  [XPathDocument](./xpathdocument/)(const [SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>\&, [XmlSpace](../../system.xml/xmlspace/)) | Belirtilen [XmlReader](../../system.xml/xmlreader/) nesnesinde bulunan XML verilerinden, belirtilen boşluk işleme yöntemiyle [XPathDocument](./) sınıfının yeni bir örneğini başlatır. |
|  [XPathDocument](./xpathdocument/)(const [SharedPtr](../../system/sharedptr/)\<[IO::TextReader](../../system.io/textreader/)\>\&) | Belirtilen TextReader nesnesinde bulunan XML verilerinden [XPathDocument](./) sınıfının yeni bir örneğini başlatır. |
|  [XPathDocument](./xpathdocument/)(const [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\>\&) | Belirtilen Stream nesnesindeki XML verilerinden [XPathDocument](./) sınıfının yeni bir örneğini başlatır. |
|  [XPathDocument](./xpathdocument/)(const [String](../../system/string/)\&) | Belirtilen dosyadaki XML verilerinden [XPathDocument](./) sınıfının yeni bir örneğini başlatır. |
|  [XPathDocument](./xpathdocument/)(const [String](../../system/string/)\&, [XmlSpace](../../system.xml/xmlspace/)) | Belirtilen boşluk işleme yöntemiyle belirtilen dosyadaki XML verilerinden [XPathDocument](./) sınıfının yeni bir örneğini başlatır. |
