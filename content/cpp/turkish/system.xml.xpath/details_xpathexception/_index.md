...
description: XPath ifadesi işlenirken bir hata oluştuğunda atılan istisnayı sağlar.
type: docs
weight: 1
url: /tr/system.xml.xpath/details_xpathexception/
---
## Details_XPathException sınıfı
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | Özel istisna verileriyle sözlük döndürür. |
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Geçerli nesne tarafından temsil edilen istisna ile ilişkili bir HRESULT kodu olan 32-bitlik bir tamsayı değeri döndürür. |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | İç istisna nesnesini temsil eden referansı döndürür. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Bu istisna için hata durumunun açıklamasını döndürür. |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | En içteki istisna nesnesinin kopyasını döndürür. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Değer tipini nullptr ile referans karşılaştırır. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) metodunu uygular; bu metod [ExceptionWrapper](../../system/exceptionwrapper/) sınıfı tarafından çağrılır. Bu sınıfın std::exception'tan türememiş olması rağmen türetilmiş sınıflar korumalı/özel üyelere erişerek mantıklarını uygular. Bu metodun uygulamasını [ExceptionWrapper](../../system/exceptionwrapper/)'e taşımak bu mantığı bozabilir. |
...
| Typedef | Description |
| --- | --- |
| [Ptr](./ptr/) | Bu sınıfın bir örneğine paylaşımlı göstericinin bir takma adı. |
