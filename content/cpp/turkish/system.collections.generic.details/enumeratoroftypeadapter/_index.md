...
description: IEnumerable.OfType() uzantı yöntemi tarafından kullanılan enumeratör.
type: docs
weight: 66
url: /tr/system.collections.generic.details/enumeratoroftypeadapter/
---
## EnumeratorOfTypeAdapter sınıf

IEnumerable.OfType() uzantı yöntemi tarafından kullanılan enumeratör.
...
| Parametre | Açıklama |
| --- | --- |
| Source | Koleksiyon öğelerinin kaynak tipi. |
| Result | Koleksiyon öğelerinin sonuç tipi. |
...
| **bool** [MoveNext](./movenext/)() override | Enumeratörü bir sonraki öğeye taşır. Daha önce hiçbir öğeye başvurulmamışsa, referansı mevcut ilk öğeye ayarlar. Kapsayıcının sonuna gelinmişse, hiçbir şey yapmaz. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | String ve nullptr durumları için [Object::ReferenceEquals](../../system/object/referenceequals/) uzmanlaşması. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) için string durumları uzmanlaşması. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Belirtilen değer kadar paylaşılan referans sayacını azaltır. |
| void [Reset](./reset/)() override | Enumeratörü ilk öğeden önceki konuma sıfırlar. |
