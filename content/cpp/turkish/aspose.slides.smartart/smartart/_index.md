...
| [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNodeCollection](../ismartartnodecollection/)\> [get_AllNodes](./get_allnodes/)() override | [SmartArt](./) nesnesindeki tüm düğümlerin koleksiyonlarını döndürür. Salt okunur [ISmartArtNodeCollection](../ismartartnodecollection/). |
...
| [Aspose::Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/) [get_BlackWhiteMode](../../aspose.slides/shape/get_blackwhitemode/)() override | Özellik, bir şeklin siyah-beyaz görüntü modunda nasıl render edileceğini belirtir. Okuma [Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/). |
| [SmartArtColorType](../smartartcolortype/) [get_ColorStyle](./get_colorstyle/)() override | [SmartArt](./) nesnesinin renk stilini döndürür. Okuma [SmartArtColorType](../smartartcolortype/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomData](../../aspose.slides/icustomdata/)\> [get_CustomData](../../aspose.slides/shape/get_customdata/)() override | Şeklin özel verisini döndürür. Salt okunur [ICustomData](../../aspose.slides/icustomdata/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_EffectFormat](../../aspose.slides/shape/get_effectformat/)() override | [EffectFormat](../../aspose.slides/effectformat/) nesnesini döndürür; bu nesne bir şekle uygulanan piksel efektlerini içerir. Not: efekt özellikleri olmayan belirli şekil türleri için null döndürebilir. Salt okunur [IEffectFormat](../../aspose.slides/ieffectformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../../aspose.slides/ihyperlink/)\> [get_HyperlinkClick](../../aspose.slides/shape/get_hyperlinkclick/)() override | Fare tıklaması için tanımlanan hiperlinki döndürür. Okuma [IHyperlink](../../aspose.slides/ihyperlink/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkManager](../../aspose.slides/ihyperlinkmanager/)\> [get_HyperlinkManager](../../aspose.slides/shape/get_hyperlinkmanager/)() override | Hiperlink yöneticisini döndürür. Salt okunur [IHyperlinkManager](../../aspose.slides/ihyperlinkmanager/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../../aspose.slides/ihyperlink/)\> [get_HyperlinkMouseOver](../../aspose.slides/shape/get_hyperlinkmouseover/)() override | Fare üzerindeyken tanımlanan hiperlinki döndürür. Okuma [IHyperlink](../../aspose.slides/ihyperlink/). |
...
| **bool** [get_IsReversed](./get_isreversed/)() override | [SmartArt](./) diyagramının (soldan sağa) LTR veya (sağdan sola) RTL durumunu döndürür veya ayarlar, diyagram ters çevirmeyi destekliyorsa. Okuma **bool**. |
...
| [SmartArtLayoutType](../smartartlayouttype/) [get_Layout](./get_layout/)() override | [SmartArt](./) nesnesinin düzenini döndürür. Okuma [SmartArtLayoutType](../smartartlayouttype/). |
...
| [System::String](../../system/string/) [get_Name](../../aspose.slides/shape/get_name/)() override | Bir şeklin adını döndürür. Null olmamalıdır. Gerekirse boş dize değeri kullanın. Okuma [System::String](../../system/string/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [get_Node](./get_node/)(**int32_t**) override | [SmartArt](./) nesnesindeki kök düğüm koleksiyonundan belirtilen indeksdeki bir düğümü döndürür. Salt okunur [Aspose::Slides::SmartArt::ISmartArtNode](../ismartartnode/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNode](../ismartartnode/)\> [get_NodeFromAll](./get_nodefromall/)(**int32_t**) override | [SmartArt](./) nesnesindeki tüm düğümleri içeren koleksiyondan belirtilen indeksdeki bir düğümü döndürür. Salt okunur [Aspose::Slides::SmartArt::ISmartArtNode](../ismartartnode/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ISmartArtNodeCollection](../ismartartnodecollection/)\> [get_Nodes](./get_nodes/)() override | [SmartArt](./) nesnesindeki kök düğümlerin koleksiyonlarını döndürür. Salt okunur [ISmartArtNodeCollection](../ismartartnodecollection/). |
| **uint32_t** [get_OfficeInteropShapeId](../../aspose.slides/shape/get_officeinteropshapeid/)() override | Slayt kapsamlı, şeklin ömrü boyunca sabit kalan benzersiz bir tanımlayıcı döndürür. Salt okunur **uint32_t**. Ayrıca bakınız [Shape::get_UniqueId](../../aspose.slides/shape/get_uniqueid/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IGroupShape](../../aspose.slides/igroupshape/)\> [get_ParentGroup](../../aspose.slides/shape/get_parentgroup/)() override | Şekil gruplanmışsa üst [GroupShape](../../aspose.slides/groupshape/) nesnesini döndürür. Aksi takdirde null döndürür. Salt okunur [IGroupShape](../../aspose.slides/igroupshape/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPlaceholder](../../aspose.slides/iplaceholder/)\> [get_Placeholder](../../aspose.slides/shape/get_placeholder/)() override | Bir şekil için yer tutucuyu döndürür. Şeklin yer tutucusu yoksa null döndürür. Salt okunur [IPlaceholder](../../aspose.slides/iplaceholder/). |
...
| [SmartArtQuickStyleType](../smartartquickstyletype/) [get_QuickStyle](./get_quickstyle/)() override | [SmartArt](./) nesnesinin hızlı stilini döndürür. Okuma [SmartArtQuickStyleType](../smartartquickstyletype/). |
...
| **float** [get_Rotation](../../aspose.slides/shape/get_rotation/)() override | Belirtilen şeklin z ekseni etrafında döndürüldüğü derece sayısını döndürür. Pozitif değer saat yönünde, negatif değer saat yönünün tersine döndürür. Okuma **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../../aspose.slides/ithreedformat/)\> [get_ThreeDFormat](../../aspose.slides/shape/get_threedformat/)() override | [ThreeDFormat](../../aspose.slides/threedformat/) nesnesini döndürür; bu nesne bir şeklin 3B efekt özelliklerini içerir. Not: 3B özellikleri olmayan belirli şekil türleri için null döndürebilir. Salt okunur [IThreeDFormat](../../aspose.slides/ithreedformat/). |
| **uint32_t** [get_UniqueId](../../aspose.slides/shape/get_uniqueid/)() override | Eklentiler veya diğer kodlar tarafından kullanılmak üzere içsel, sunum kapsamlı bir tanımlayıcı döndürür. Bu değer kullanıcı veya program tarafından yeniden atanabileceği için kalıcı benzersiz anahtar olarak kullanılmamalıdır. Salt okunur **uint32_t**. Ayrıca bakınız [Shape::get_OfficeInteropShapeId](../../aspose.slides/shape/get_officeinteropshapeid/). |
...
| **int32_t** [get_ZOrderPosition](../../aspose.slides/shape/get_zorderposition/)() override | Şeklin z-sırasındaki konumunu döndürür. Shapes[0] z-sırasının arkasındaki şekli, Shapes[Shapes.Count - 1] ise önündeki şekli döndürür. Salt okunur **int32_t**. |
...
| [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetVisualBounds](../../aspose.slides/shape/getvisualbounds/)() | Şeklin görsel sınırlarını, render edilen içeriğinden hesaplanmış olarak alır. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucu. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapısını sağlar. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapısını sağlar. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin dize ve nullptr durumuna özel birleştirmesi. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin dize durumuna özel birleştirmesi. |
...
| void [set_BlackWhiteMode](../../aspose.slides/shape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/)) override | Özellik, bir şeklin siyah-beyaz görüntü modunda nasıl render edileceğini belirtir. Yazma [Slides::BlackWhiteMode](../../aspose.slides/blackwhitemode/). |
| void [set_ColorStyle](./set_colorstyle/)([SmartArtColorType](../smartartcolortype/)) override | [SmartArt](./) nesnesinin renk stilini ayarlar. Yazma [SmartArtColorType](../smartartcolortype/). |
...
| void [set_Hidden](../../aspose.slides/shape/set_hidden/)(**bool**) override | Şeklin gizli durumunu ayarlar. Yazma **bool**. |
| void [set_HyperlinkClick](../../aspose.slides/shape/set_hyperlinkclick/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../../aspose.slides/ihyperlink/)\>) override | Fare tıklaması için tanımlanan hiperlinki ayarlar. Yazma [IHyperlink](../../aspose.slides/ihyperlink/). |
| void [set_HyperlinkMouseOver](../../aspose.slides/shape/set_hyperlinkmouseover/)([System::SharedPtr](../../system/sharedptr/)\<[IHyperlink](../../aspose.slides/ihyperlink/)\>) override | Fare üzerindeyken tanımlanan hiperlinki ayarlar. Yazma [IHyperlink](../../aspose.slides/ihyperlink/). |
...
| void [set_IsReversed](./set_isreversed/)(**bool**) override | [SmartArt](./) diyagramının (soldan sağa) LTR veya (sağdan sola) RTL durumunu döndürür veya ayarlar, diyagram ters çevirmeyi destekliyorsa. Yazma **bool**. |
| void [set_Layout](./set_layout/)([SmartArtLayoutType](../smartartlayouttype/)) override | [SmartArt](./) nesnesinin düzenini ayarlar. Yazma [SmartArtLayoutType](../smartartlayouttype/). |
| void [set_Name](../../aspose.slides/shape/set_name/)([System::String](../../system/string/)) override | Bir şeklin adını ayarlar. Null olmamalıdır. Gerekirse boş dize değeri kullanın. Yazma [System::String](../../system/string/). |
| void [set_QuickStyle](./set_quickstyle/)([SmartArtQuickStyleType](../smartartquickstyletype/)) override | [SmartArt](./) nesnesinin hızlı stilini ayarlar. Yazma [SmartArtQuickStyleType](../smartartquickstyletype/). |
...
| void [set_Rotation](../../aspose.slides/shape/set_rotation/)(**float**) override | Belirtilen şeklin z ekseni etrafında döndürüldüğü derece sayısını ayarlar. Pozitif değer saat yönünde, negatif değer saat yönünün tersine döndürür. Yazma **float**. |
