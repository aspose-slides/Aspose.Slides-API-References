...
type: docs
weight: 131
url: /tr/system.io/details_directorynotfoundexception/
---
## Details_DirectoryNotFoundException sınıfı
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Geçerli nesne tarafından temsil edilen istisna ile ilişkili HRESULT kodu olan 32 bitlik bir tamsayı değeri döndürür. |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitlemesini uygular. Direk çağırılabilir veya [LockContext](../../system/lockcontext/) gözcü nesnesi kullanılabilir. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Belirli bir istisna için atanan kodlu sayısal bir değer olan HRESULT'yi ayarlar. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açma kısmını uygular. Direk çağırılabilir veya [LockContext](../../system/lockcontext/) gözcü nesnesi kullanılabilir. |
