...
type: docs
weight: 209
url: /tr/system.io/details_ioexception/
---
## Details_IOException sınıf
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | Özel istisna verileri içeren sözlük döndürür. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Belirli bir istisna için atanan kodlu sayısal bir değer olan HRESULT'ı ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki göstericilerin zayıf moda geçmesine izin verir. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) metodunu uygular; bu metod [ExceptionWrapper](../../system/exceptionwrapper/) sınıfı tarafından çağrılır. Bu sınıf std::exception'dan türetilmemiş olmasına rağmen türetilen sınıflar korunmuş/özel üyeleri kullanarak mantıklarını uygulayabilirler. Bu metodun uygulamasını [ExceptionWrapper](../../system/exceptionwrapper/)'a taşımak bu mantığı bozabilir. |
