...
description: "2 boyutlu bir düzlemdeki bir noktanın tamsayı X ve Y koordinat çiftini temsil eder. Bu tip yığıt (stack) üzerinde allocate edilmeli ve fonksiyonlara değer ya da referans olarak aktarılmalıdır. Bu tipin nesnelerini yönetmek için System::SmartPtr sınıfını asla kullanmayın."
type: docs
weight: 209
url: /tr/system.drawing/point/
---
## Point sınıfı

Represents a pair of integer X and Y coordinates of a point on a 2-dimensional plane. This type should be allocated on stack and passed to functions by value or by reference. Never use [System::SmartPtr](../../system/smartptr/) sınıfını manage objects of this type.
