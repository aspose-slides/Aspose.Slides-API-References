...
description: Windows görüntü öğelerinde metin görüntülemek için kullanılan yazı tiplerini temsil eden önceden oluşturulmuş Font nesnelerinin bir kümesini sağlar. Bu, örnek hizmetleri olmayan statik bir türdür. Onun hiçbir şekilde örneklerini oluşturmayın.
type: docs
weight: 339
url: /tr/system.drawing/systemfonts/
---
## SystemFonts sınıfı
...
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_DefaultFont](./get_defaultfont/)() | Uygulamanın ileti kutuları ve formlar için kullanabileceği varsayılan yazı tipini temsil eden bir [Font](../font/) nesnesi döndürür. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin hedefTür tarafından tanımlanan türün bir örneği olup olmadığını denetler. C# 'is' operatörünün analoğu. |
| void [Lock](../../system/object/lock/)() | C# lock() deyiminin kilitlemesini uygular. Direkt çağırın veya [LockContext](../../system/lockcontext/) koruyucu nesnesini kullanın. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) metodunun analoğu. Özel nesneleri dizeye dönüştürmeyi sağlar. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | C# typeof([System.Object](../../system/object/)) yapısını uygular. |
| void [Unlock](../../system/object/unlock/)() | C# lock() deyiminin kilidini açar. Direkt çağırın veya [LockContext](../../system/lockcontext/) koruyucu nesnesini kullanın. |
