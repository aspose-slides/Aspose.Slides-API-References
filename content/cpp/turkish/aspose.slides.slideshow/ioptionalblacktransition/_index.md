...
---
## IOptionalBlackTransition sınıfı
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 standardına göre NaN'in hiçbir değer, NaN dahil, eşit olmadığı halde iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 standardına göre NaN'in hiçbir değer, NaN dahil, eşit olmadığı halde iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Bu öznitelik, geçişin siyah bir ekrandan başlayıp yeni slaytı siyah üzerinden geçiş yapıp yapmayacağını belirtir. Okuma **bool**. |
...
| void [Lock](../../system/object/lock/)() | C# lock() deyiminin kilitleme işlevini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Bu öznitelik, geçişin siyah bir ekrandan başlayıp yeni slaytı siyah üzerinden geçiş yapıp yapmayacağını belirtir. Yazma **bool**. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() deyiminin kilit kaldırma işlevini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
