...
description: Fly-through slayt geçiş efekti.
type: docs
weight: 40
url: /tr/aspose.slides.slideshow/flythroughtransition/
---
## FlyThroughTransition sınıf

Fly-through slayt geçiş efekti.
...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Geçişin yönü. Okuyun [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| **bool** [get_HasBounce](./get_hasbounce/)() override | Geçiş sırasında sunum slaytlarının hareketinin bir sekme içermesini belirtir. Okuyun **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Belirli bir tip için, hash tabloları gibi veri yapılarında ve hashleme algoritmalarında kullanılabilecek bir hash işlevi olarak hizmet eder. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'in dizgi ve nullptr durumu için özelleştirilmesi. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'in dizgiler durumu için özelleştirilmesi. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Geçişin yönü. Yazın [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| void [set_HasBounce](./set_hasbounce/)(**bool**) override | Geçiş sırasında sunum slaytlarının hareketinin bir sekme içermesini belirtir. Yazın **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir işaretçi olarak ayarlar (paylaşılan yerine). Kapsayıcılardaki işaretçileri zayıf moda geçişe izin verir. |
...
* Sınıf [IFlyThroughTransition](../iflythroughtransition/)
