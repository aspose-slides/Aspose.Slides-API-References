...
| [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() override | Geçiş yönü. [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) oku. |
| **bool** [get_ThroughBlack](./get_throughblack/)() override | Geçişin siyah üzerinden solup solmadığını belirtir. **bool** oku. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Belirli bir tip için hash fonksiyonu olarak hizmet eder; hash tablosu gibi hashleme algoritmaları ve veri yapılarına uygundur. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin string ve nullptr durumları için uzmanlaştırması. |
...
| void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) override | Geçiş yönü. [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) yaz. |
| void [set_ThroughBlack](./set_throughblack/)(**bool**) override | Geçişin siyah üzerinden solup solmadığını belirtir. **bool** yaz. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici olarak ayarlar (paylaşımlı yerine). Kapsayıcılardaki göstergeleri zayıf moda geçirmeyi sağlar. |
...
* Sınıf [IRevealTransition](../irevealtransition/)
