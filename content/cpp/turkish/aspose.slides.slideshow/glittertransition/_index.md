...
| [TransitionSideDirectionType](../transitionsidedirectiontype/) [get_Direction](./get_direction/)() override | Geçiş yönü. Oku [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| [TransitionPattern](../transitionpattern/) [get_Pattern](./get_pattern/)() override | Geçiş sırasında kullanılan görsellerin şeklini belirler. Oku [TransitionPattern](../transitionpattern/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Belirli bir tip için hash fonksiyonu olarak hizmet eder, hash tabloları gibi veri yapılarında ve hash algoritmalarında kullanılmak için uygundur. |
...
| void [set_Direction](./set_direction/)([TransitionSideDirectionType](../transitionsidedirectiontype/)) override | Geçiş yönü. Yaz [TransitionSideDirectionType](../transitionsidedirectiontype/). |
| void [set_Pattern](./set_pattern/)([TransitionPattern](../transitionpattern/)) override | Geçiş sırasında kullanılan görsellerin şeklini belirler. Yaz [TransitionPattern](../transitionpattern/). |
...
* Sınıf [IGlitterTransition](../iglittertransition/)
