...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Geçiş yönü. [TransitionInOutDirectionType](../transitioninoutdirectiontype/) okuma. |
| virtual [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() | Geçiş sırasında kullanılan görsellerin şeklini belirler. [TransitionShredPattern](../transitionshredpattern/) okuma. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Geçiş yönü. [TransitionInOutDirectionType](../transitioninoutdirectiontype/) yaz. |
| virtual void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) | Geçiş sırasında kullanılan görsellerin şeklini belirler. [TransitionShredPattern](../transitionshredpattern/) yaz. |
