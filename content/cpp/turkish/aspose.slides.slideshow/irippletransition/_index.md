...
| virtual [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/) [get_Direction](./get_direction/)() | Geçiş yönü. [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/)'yi okuyun. |
...
| virtual void [set_Direction](./set_direction/)([TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/)) | Geçiş yönü. [TransitionCornerAndCenterDirectionType](../transitioncornerandcenterdirectiontype/)'yi yazın. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını paylaşımlı yerine zayıf bir gösterici olarak ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçiş yapmayı sağlar. |
