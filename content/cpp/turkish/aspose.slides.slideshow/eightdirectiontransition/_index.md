...
| [TransitionEightDirectionType](../transitioneightdirectiontype/) [get_Direction](./get_direction/)() override | Geçiş yönü. [TransitionEightDirectionType](../transitioneightdirectiontype/)'yi okuyun. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Belirli bir tür için hash işlevi olarak hizmet verir, hash tablo gibi veri yapıları ve hash algoritmalarında kullanılmaya uygundur. |
...
| void [set_Direction](./set_direction/)([TransitionEightDirectionType](../transitioneightdirectiontype/)) override | Geçiş yönü. [TransitionEightDirectionType](../transitioneightdirectiontype/)'yi yazın. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını bir zayıf gösterici (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçiş yapmaya izin verir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidini açma işlevini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) denetim nesnesini kullanın. |
...
* Sınıf [IEightDirectionTransition](../ieightdirectiontransition/)
