...
description: Slayt geçiş etkisini ortaya çıkar.
type: docs
weight: 209
url: /tr/aspose.slides.slideshow/irevealtransition/
---
## IRevealTransition sınıfı

Reveal slide transition effect.

```cpp
class IRevealTransition : public virtual Aspose::Slides::SlideShow::ITransitionValueBase
```
...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | Geçiş yönü. [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) okuyun. |
| virtual **bool** [get_ThroughBlack](./get_throughblack/)() | Geçişin siyah üzerinden solup solmadığını belirtir. **bool** okuyun. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) yönteminin benzeri. Özel nesnelerin karmalanmasını sağlar. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Nesnenin gerçek tipini alır. C# [System.Object.GetType()](../../system/object/gettype/) çağrısının benzeri. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin hedefTip tarafından tanımlanan tipe ait bir örnek olup olmadığını kontrol eder. C# 'is' operatörünün benzeri. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) yönteminin benzeri. Özel tiplerin çoğaltılmasını sağlar. |
|  [Object](../../system/object/object/)() | Nesne oluşturur. Tüm dahili veri yapıları başlatılır. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucusu. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya oluşturmalarına imkan verir. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya oluşturmalarına imkan verir. |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | Geçiş yönü. [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) yazın. |
| virtual void [set_ThroughBlack](./set_throughblack/)(**bool**) | Geçişin siyah üzerinden solup solmadığını belirtir. **bool** yazın. |
...
* Sınıf [ITransitionValueBase](../itransitionvaluebase/)
* AdAlanı [Aspose::Slides::SlideShow](../)
