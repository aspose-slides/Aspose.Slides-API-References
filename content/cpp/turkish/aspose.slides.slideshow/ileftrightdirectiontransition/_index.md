...
---
## ILeftRightDirectionTransition sınıf
...
| virtual [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/) [get_Direction](./get_direction/)() | Geçiş yönü. Oku [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)) | Geçiş yönü. [TransitionLeftRightDirectionType](../transitionleftrightdirectiontype/)'yi yazın. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşılan yerine) olarak ayarlar. Kapasitelerdeki işaretçileri zayıf moda geçişine izin verir. |
