...
| Yöntem | Açıklama |
| --- | --- |
| **bool** [Equals](../transitionvaluebase/equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | İki [TransitionValueBase](../transitionvaluebase/) örneklerinin eşit olup olmadığını belirler. |
...
| [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() override | Geçiş yönü. [TransitionInOutDirectionType](../transitioninoutdirectiontype/)'yi okuyun. |
| [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() override | Geçiş sırasında kullanılan görsellerin şeklini belirler. [TransitionShredPattern](../transitionshredpattern/)'yi okuyun. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Belirli bir tip için hash işlevi sağlar; hash algoritmaları ve hash tablosu gibi veri yapılarında kullanılmaya uygundur. |
...
| void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) override | Geçiş yönü. [TransitionInOutDirectionType](../transitioninoutdirectiontype/)'ye yazın. |
| void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) override | Geçiş sırasında kullanılan görsellerin şeklini belirler. [TransitionShredPattern](../transitionshredpattern/)'ye yazın. |
...
* Sınıf [IShredTransition](../ishredtransition/)
* Ad uzayı [Aspose::Slides::SlideShow](../)
