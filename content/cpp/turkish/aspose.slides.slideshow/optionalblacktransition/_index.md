...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN değeri, IEC 60559:1989 standardına göre NaN'in herhangi bir değere, NaN dahil, eşit olmaması gerekirken eşit kabul edilir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN değeri, IEC 60559:1989 standardına göre NaN'in herhangi bir değere, NaN dahil, eşit olmaması gerekirken eşit kabul edilir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **bool** [get_FromBlack](./get_fromblack/)() override | Bu nitelik, geçişin siyah bir ekrandan başlayıp (ve ardından yeni slaytı siyah üzerinden geçiş yapacağını) belirler. Okuma **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| **int32_t** [GetHashCode](../transitionvaluebase/gethashcode/)() const override | Belirli bir tip için hash fonksiyonu görevi görür; hash algoritmaları ve hash tablosu gibi veri yapılarında kullanılmaya uygundur. |
...
| void [set_FromBlack](./set_fromblack/)(**bool**) override | Bu nitelik, geçişin siyah bir ekrandan başlayıp (ve ardından yeni slaytı siyah üzerinden geçiş yapacağını) belirler. Yazma **bool**. |
...
* Sınıf [IOptionalBlackTransition](../ioptionalblacktransition/)
