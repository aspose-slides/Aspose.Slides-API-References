...
description: Ekranlar hakkında bilgi sağlar. Yalnızca Windows. Bu, bellek yönetimi erişim fonksiyon(ları) ile gerçekleştirilen bir tek örnek (singleton) tiptir. Doğrudan örneklerini oluşturmayınız.
type: docs
weight: 40
url: /tr/system.windows.forms/screen/
---
## Screen sınıfı

Ekranlar hakkında bilgi sağlar. [Windows](../../system.windows/) yalnız. Bu, bellek yönetimi erişim fonksiyon(lar)ı tarafından gerçekleştirilen bir tek örnek (singleton) tiptir. Doğrudan örneklerini oluşturmayınız.
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | Ekran sınırlarını alır. |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | Birincil ekran hakkında bilgi alır. |
