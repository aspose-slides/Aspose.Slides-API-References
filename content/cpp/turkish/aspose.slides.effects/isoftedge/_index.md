...
description: Bir Soft Edge etkisini temsil eder. Şeklin kenarları bulanıktır, ancak dolgu etkilenmez.
type: docs
weight: 963
...
Bir Soft Edge etkisini temsil eder. Şeklin kenarları bulanıktır, ancak dolgu etkilenmez.
...
| virtual **double** [get_Radius](./get_radius/)() | Kenarlar için uygulanacak bulanıklaşma yarıçapını belirtir. Okur **double**. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nın string ve nullptr durumuna özel bir uygulaması. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Kenarlar için uygulanacak bulanıkleşma yarıçapını belirtir. Yazar **double**. |
