...
description: Tint etkisini temsil eden değiştirilemez nesne. Etki renk değerlerini ton yönüne doğru veya tersine belirtilen miktarda kaydırır.
type: docs
weight: 1002
url: /tr/aspose.slides.effects/itinteffectivedata/
---
## ITintEffectiveData sınıf

[Tint](../tint/) etkisini temsil eden değiştirilemez nesne. Etki renk değerlerini ton yönüne doğru veya tersine belirtilen miktarda kaydırır.
...
| virtual **float** [get_Amount](./get_amount/)() | Efekt miktarını döndürür. Yalnızca okunabilir **float**. |
| virtual **float** [get_Hue](./get_hue/)() | Ton değerini döndürür. Yalnızca okunabilir **float**. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) özel durumunun string ve nullptr durumları için uygulanması. |
