...
description: Bir Duotone etkisini temsil eder. Her piksel için, Color1 ve Color2'yi doğrusal bir enterpolasyonla birleştirerek o pikselin yeni rengini belirler.
type: docs
weight: 157
...
Bir [Duotone](./) etkisini temsil eder. Her piksel için, Color1 ve Color2'yi doğrusal bir enterpolasyonla birleştirerek o pikselin yeni rengini belirler.
...
| Method | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen [Duotone](./)'nin mevcut [Duotone](./) ile eşit olup olmadığını belirler. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color1](./get_color1/)() override | Koyu pikseller için hedef renk biçimini döndürür. Salt okunur [IColorFormat](../../aspose.slides/icolorformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color2](./get_color2/)() override | Açık pikseller için hedef renk biçimini döndürür. Salt okunur [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotoneEffectiveData](../iduotoneeffectivedata/)\> [GetEffective](./geteffective/)() override | Kalıtım uygulanmış etkili [Duotone](./) etkisi verisini alır. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Belirli bir tip için bir karma işlevi olarak hizmet eder. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucu. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapısını etkinleştirir. |
