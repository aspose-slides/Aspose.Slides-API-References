...
description: Alpha Katmanı etkisini temsil eder. %100'den düşük Alpha (opaklık) değerleri sıfıra ayarlanır. Diğer bir deyişle, kısmen şeffaf olan her şey tamamen şeffaf olur.
type: docs
weight: 287
...
Alpha Katmanı etkisini temsil eder. Alpha (opaklık) değerleri %100'den az ise sıfıra ayarlanır. Diğer bir deyişle, kısmen şeffaf olan her şey tamamen şeffaf olur.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C# stili kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C# stili kayan nokta karşılaştırmasını taklit eder. |
