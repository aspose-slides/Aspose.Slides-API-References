...
description: Alfa Zemin etkisini temsil eden değişmez nesne. %100'den düşük alfa (opaklık) değerleri sıfıra dönüştürülür. Başka bir deyişle, kısmen saydam olan her şey tamamen saydam hâle gelir.
type: docs
weight: 300
url: /tr/aspose.slides.effects/ialphaflooreffectivedata/
---
## IAlphaFloorEffectiveData sınıf

Değişmez nesne, bir Alpha Zemin etkisini temsil eder. %100'den düşük alfa (opaklık) değerleri sıfıra dönüştürülür. Başka bir deyişle, kısmen saydam olan her şey tamamen saydam hâle gelir.
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidini açma işlevini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözetmen nesnesini kullanın. |
