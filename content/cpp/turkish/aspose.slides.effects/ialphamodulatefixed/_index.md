...
---
## IAlphaModulateFixed sınıf

Alpha Modulate Fixed etkisini temsil eder. Etkinin alfa (opaklık) değerleri sabit bir yüzdeyle çarpılır.
...
| virtual **float** [get_Amount](./get_amount/)() | Etki miktarını yüzde olarak döndürür. Okunur **float**. |
...
| virtual void [set_Amount](./set_amount/)(**float**) | Etki miktarını yüzde olarak döndürür. **float** yaz. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşılan yerine) olarak ayarlar. Kapsayıcılar içindeki göstericilerin zayıf moda geçmesini sağlar. |
