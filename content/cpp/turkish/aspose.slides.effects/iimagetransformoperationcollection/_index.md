...
---
## IImageTransformOperationCollection sınıf
...
| Metot | Açıklama |
| --- | --- |
| virtual void [Add](../../system.collections.generic/icollection/add/)(const T\&) | Koleksiyona bir öğe ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevel](../ialphabilevel/)\> [AddAlphaBiLevelEffect](./addalphabileveleffect/)(**float**) | Yeni Alpha Bi-Level etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeiling](../ialphaceiling/)\> [AddAlphaCeilingEffect](./addalphaceilingeffect/)() | Yeni Alpha Ceiling etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloor](../ialphafloor/)\> [AddAlphaFloorEffect](./addalphaflooreffect/)() | Yeni Alpha Floor etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverse](../ialphainverse/)\> [AddAlphaInverseEffect](./addalphainverseeffect/)() | Yeni Alpha Inverse etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulate](../ialphamodulate/)\> [AddAlphaModulateEffect](./addalphamodulateeffect/)() | Yeni Alpha Modulate etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixed](../ialphamodulatefixed/)\> [AddAlphaModulateFixedEffect](./addalphamodulatefixedeffect/)(**float**) | Yeni Alpha Modulate Fixed etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplace](../ialphareplace/)\> [AddAlphaReplaceEffect](./addalphareplaceeffect/)(**float**) | Yeni Alpha Replace etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBiLevel](../ibilevel/)\> [AddBiLevelEffect](./addbileveleffect/)(**float**) | Yeni Bi-Level (siyah/beyaz) etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBlur](../iblur/)\> [AddBlurEffect](./addblureffect/)(**double**, **bool**) | Koleksiyonun sonuna yeni [Blur](../blur/) etkisini ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBrightnessContrast](../ibrightnesscontrast/)\> [AddBrightnessContrastEffect](./addbrightnesscontrasteffect/)(**float**, **float**) | Koleksiyonun sonuna yeni [BrightnessContrast](../brightnesscontrast/) etkisini ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorChange](../icolorchange/)\> [AddColorChangeEffect](./addcolorchangeeffect/)() | Yeni Color Change etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorReplace](../icolorreplace/)\> [AddColorReplaceEffect](./addcolorreplaceeffect/)() | Yeni Color Replacement etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDuotone](../iduotone/)\> [AddDuotoneEffect](./addduotoneeffect/)() | Koleksiyonun sonuna yeni [Duotone](../duotone/) etkisini ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlay](../ifilloverlay/)\> [AddFillOverlayEffect](./addfilloverlayeffect/)() | Yeni Fill Overlay etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGrayScale](../igrayscale/)\> [AddGrayScaleEffect](./addgrayscaleeffect/)() | Yeni Gray Scale etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHSL](../ihsl/)\> [AddHSLEffect](./addhsleffect/)(**float**, **float**, **float**) | Yeni Hue/Saturation/Luminance etkisini bir koleksiyonun sonuna ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILuminance](../iluminance/)\> [AddLuminanceEffect](./addluminanceeffect/)(**float**, **float**) | Koleksiyonun sonuna yeni [Luminance](../luminance/) etkisini ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITint](../itint/)\> [AddTintEffect](./addtinteffect/)(**float**, **float**) | Koleksiyonun sonuna yeni [Tint](../tint/) etkisini ekler. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Koleksiyonun (varsa) ilk öğesine işaret eden yineleyiciyi alır. Bu yineleyici, [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) bir T nesnesinin kopyasını döndürdüğü için referans verilen nesneyi değiştirmek için kullanılamaz. |
...
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | Koleksiyonun sadece okunur olup olmadığını kontrol eder. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\> [idx_get](./idx_get/)(**int32_t**) | Koleksiyondan indeksine göre bir [IImageTransformOperation](../iimagetransformoperation/) döndürür. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Bir dizideki herhangi bir öğenin var olup olmadığını veya bir koşulu karşılayıp karşılamadığını belirler. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Bir dizinin ilk öğesini, dizinin boş olması durumunda varsayılan bir değerle döndürür. |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Koşulu karşılayan dizinin ilk öğesini, böyle bir öğe bulunamazsa varsayılan değerle döndürür. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Bir dizinin son öğesini, dizinin boş olması durumunda varsayılan bir değerle döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine dönüşüm fonksiyonu uygular ve ortaya çıkan en büyük değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine dönüşüm fonksiyonu uygular ve ortaya çıkan en küçük değeri döndürür. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin string ve nullptr durumuna özel türleştirmesi. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin string durumuna özel türleştirmesi. |
| virtual **bool** [Remove](../../system.collections.generic/icollection/remove/)(const T\&) | Koleksiyondan öğeyi siler. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Belirtilen indeksteki bir görüntü etkisini bir koleksiyondan kaldırır. |
