...
description: Bir Fill Overlay etkisini temsil eder. Fill overlay, bir nesne için ek bir doldurma belirlemek ve iki doldurmayı birleştirmek amacıyla kullanılabilir.
type: docs
weight: 183
...
| Metot | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen [FillOverlay](./)'in mevcut [FillOverlay](./) ile eşit olup olmadığını belirler. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C# tarzı çift duyarlıklı (double) kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() override | FillBlendMode. [FillBlendMode](../../aspose.slides/fillblendmode/) okunur. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Doldurma biçimi. Sadece okuma [IFillFormat](../../aspose.slides/ifillformat/). |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IDOMObject](../../aspose.slides/idomobject/)\> [get_Parent_Immediate](../../aspose.slides/idomobject/get_parent_immediate/)() | Parent_Immediate nesnesini döndürür. Sadece okuma [IDOMObject](../../aspose.slides/idomobject/). |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | [IPresentationComponent](../../aspose.slides/ipresentationcomponent/) üst nesneyi döndürür. Sadece okuma [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlayEffectiveData](../ifilloverlayeffectivedata/)\> [GetEffective](./geteffective/)() override | Kalıtım uygulanmış etkili Fill Overlay efekt verisini alır. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Belirli bir tür için hash işlevi olarak hizmet verir. |
...
| void [set_Blend](./set_blend/)([FillBlendMode](../../aspose.slides/fillblendmode/)) override | FillBlendMode. [FillBlendMode](../../aspose.slides/fillblendmode/) yazılır. |
...
* Sınıf [IFillOverlay](../ifilloverlay/)
