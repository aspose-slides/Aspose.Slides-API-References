...
description: Renk Değiştirme etkisini temsil eden değiştirilemez nesne. Tüm etki renkleri sabit bir renge değiştirilir. Alfa değerleri etkilenmez.
type: docs
weight: 547
...
Değiştirilemez nesne, bir Renk Değiştirme etkisini temsil eder. Tüm etki renkleri sabit bir renge değiştirilir. Alfa değerleri etkilenmez.
...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Her pikselin rengini değiştirecek renk biçimini döndürür. Salt-okunur [System::Drawing::Color](../../system.drawing/color/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | 'n.' template argümanını zayıf işaretçi (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçişine izin verir. |
