...
description: Ön ayarlı gölge etkisini temsil eden değiştirilemez nesne.
type: docs
weight: 924
url: /tr/aspose.slides.effects/ippresetshadoweffectivedata/
---
## IPresetShadowEffectiveData sınıf

Preset Shadow etkisini temsil eden değiştirilemez nesne.
...
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | Öni ayar. Salt okunur [PresetShadowType](../../aspose.slides/presetshadowtype/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir işaretçi (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçirmeye olanak tanır. |
