...
description: Etkileri temsil eden değişmez nesneler için temel sınıf.
type: docs
weight: 586
url: /tr/aspose.slides.effects/ieffecteffectivedata/
---
## IEffectEffectiveData sınıfı


Değiştirilemez nesneler için temel sınıf, etkileri temsil eder.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stilinde kayan nokta karşılaştırmasını benzetir; iki NaN değeri eşit kabul edilir, ancak IEC 60559:1989’a göre NaN herhangi bir değere, NaN dahil, eşit değildir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stilinde kayan nokta karşılaştırmasını benzetir; iki NaN değeri eşit kabul edilir, ancak IEC 60559:1989’a göre NaN herhangi bir değere, NaN dahil, eşit değildir. |
...
| void [Lock](../../system/object/lock/)() | C# lock() deyimini kilitlemeyi uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözetleme nesnesini kullanın. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() deyimini kilit açmayı uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözetleme nesnesini kullanın. |
