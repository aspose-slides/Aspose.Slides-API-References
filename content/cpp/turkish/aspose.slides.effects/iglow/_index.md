...
description: Bir nesnenin kenarları dışına renkli bulanık bir kontur eklenen Glow etkisini temsil eder.
type: docs
weight: 638
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | Renk biçimi. Salt-okunur [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual **double** [get_Radius](./get_radius/)() | Yarıçap. **double** okunur. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Yarıçap. **double** yazar. |
