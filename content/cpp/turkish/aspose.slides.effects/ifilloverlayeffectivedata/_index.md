...
description: Dolgu Kaplaması etkisini temsil eden değişmez nesne. Bir dolgu kaplaması, bir nesne için ek bir dolgu belirlemek ve iki dolguyu birleştirmek için kullanılabilir.
type: docs
weight: 625
url: /tr/aspose.slides.effects/ifilloverlayeffectivedata/
---
## IFillOverlayEffectiveData sınıfı

Değişmez nesne, bir Fill Overlay etkisini temsil eder. Bir Fill Overlay, bir nesne için ek bir dolgu belirlemek ve iki dolguyu birleştirmek için kullanılabilir.
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode. Yalnızca okuma [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | Dolgu formatı. Yalnızca okuma [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin, hedefTür tarafından tanımlanan türün bir örneği olup olmadığını kontrol eder. C# 'is' operatörünün analoğu. |
