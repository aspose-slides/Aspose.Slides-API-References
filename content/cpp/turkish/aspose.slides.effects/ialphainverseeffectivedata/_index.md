...
description: Alpha Inverse etkisini temsil eden değiştirilemez nesne. Alpha (opaklık) değerleri %100'den çıkarılarak tersine çevrilir.
type: docs
weight: 326
url: /tr/aspose.slides.effects/ialphainverseeffectivedata/
---
## IAlphaInverseEffectiveData sınıf

Alpha Inverse etkisini temsil eden değiştirilemez nesne. Alpha (opaklık) değerleri %100'den çıkarılarak tersine çevrilir.
...
| void [Lock](../../system/object/lock/)() | C# lock() deyiminin kilitleme işlevini uygular. Direkt olarak çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() deyiminin kilit açma işlevini uygular. Direkt olarak çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
