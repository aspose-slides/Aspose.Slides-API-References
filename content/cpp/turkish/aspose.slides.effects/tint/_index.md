...
description: Bir Tint etkisini temsil eder. Etki renk değerlerini belirtilen miktarda ton yönüne doğru ya da tersine kaydırır.
type: docs
weight: 1093
...
| Yöntem | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen [Tint](./)'in geçerli [Tint](./) ile eşit olup olmadığını belirler. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989’a göre NaN’ın herhangi bir değere, NaN dahil, eşit olmaması gerektiği halde, C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989’a göre NaN'ın herhangi bir değere, NaN dahil, eşit olmaması gerektiği halde, C# tarzı kayan nokta karşılaştırmasını taklit eder. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | [Tint](./) etkisi verisini, kalıtım uygulanmış şekilde alır. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit çözümlemesini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
