...
description: Gray Scale efektini temsil eder. Etkinin tüm renk değerlerini parlaklıklarına karşılık gelen bir gri tonuna dönüştürür. Etki alfa (opakite) değerleri etkilenmez.
type: docs
weight: 209
...
Bir Gray Scale etkisini temsil eder. Etkinin tüm renk değerlerini parlaklıklarına karşılık gelen bir gri tonu haline dönüştürür. Etki alfa (opakite) değerleri etkilenmez.
...
| Yöntem | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen [GrayScale](./)'in geçerli [GrayScale](./) ile eşit olup olmadığını belirler. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGrayScaleEffectiveData](../igrayscaleeffectivedata/)\> [GetEffective](./geteffective/)() override | Kalıtım uygulanmış etkili Gray Scale efekti verisini alır. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Belirli bir tip için bir karma fonksiyonu olarak hizmet eder. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin stringler durumları için özelleştirilmesi. |
