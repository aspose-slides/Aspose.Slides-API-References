...
| Metot | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen [InnerShadow](./)'nin mevcut [InnerShadow](./)'ye eşit olup olmadığını belirler. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# stilinde iki NaN'ın eşit kabul edileceği bir kayan nokta karşılaştırmasını taklit eder; ancak IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# stilinde iki NaN'ın eşit kabul edileceği bir kayan nokta karşılaştırmasını taklit eder; ancak IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **double** [get_BlurRadius](./get_blurradius/)() override | [Blur](../blur/) yarıçapı. **double** okunur. |
| **float** [get_Direction](./get_direction/)() override | Gölgenin yönü. **float** okunur. |
| **double** [get_Distance](./get_distance/)() override | Gölgenin mesafesi. **double** okunur. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() override | Gölgenin rengi. Salt okunur [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IInnerShadowEffectiveData](../iinnershadoweffectivedata/)\> [GetEffective](./geteffective/)() override | Kalıtım uygulanmış etkili İç Gölge etkisi verisini alır. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Belirli bir tip için bir karma (hash) işlevi olarak hizmet eder. |
...
| void [set_BlurRadius](./set_blurradius/)(**double**) override | [Blur](../blur/) yarıçapı. **double** yazılır. |
| void [set_Direction](./set_direction/)(**float**) override | Gölgenin yönü. **float** yazılır. |
| void [set_Distance](./set_distance/)(**double**) override | Gölgenin mesafesi. **double** yazılır. |
...
* Sınıf [IInnerShadow](../iinnershadow/)
