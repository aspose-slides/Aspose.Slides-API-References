...
description: Alpha Modulate etkisini temsil eder. Etki alpha (opaklık) değerleri sabit bir yüzdeyle çarpılır. Etki kapsayıcısı, modüle edilecek alpha değerlerini içeren bir etki belirtir.
type: docs
weight: 53
...
Alpha Modulate etkisini temsil eder. Etki alpha (opaklık) değerleri sabit bir yüzde ile çarpılır. Etki kapsayıcısı, modüle edilecek alpha değerlerini içeren bir etki belirtir.
...
| Yöntem | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen [AlphaModulate](./)'nin mevcut [AlphaModulate](./)'ye eşit olup olmadığını belirler. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateEffectiveData](../ialphamodulateeffectivedata/)\> [GetEffective](./geteffective/)() override | Uygulanan kalıtımla etkili Alpha Modulate etkisi verilerini alır. |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesi kilitlemeyi uygular. Direkt olarak çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucusu. Gerçekten bir şey kopyalamaz, yalnızca yeni nesneyi başlatır ve alt sınıfların kopya oluşturmasını sağlar. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama işleci. Gerçekten bir şey kopyalamaz, yalnızca yeni nesneyi başlatır ve alt sınıfların kopya oluşturmasını sağlar. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici olarak ayarlar (paylaşımlı yerine). Kaplardaki göstericileri zayıf moda geçişe izin verir. |
...
* Sınıf [IAlphaModulate](../ialphamodulate/)
