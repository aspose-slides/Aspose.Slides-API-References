...
description: Alfa Modülasyonu etkisini temsil eder. Etki alfa (opaklık) değerleri sabit bir yüzde ile çarpılır. Etki konteyneri, modüle edilecek alfa değerlerini içeren bir etki belirtir.
type: docs
weight: 339
url: /tr/aspose.slides.effects/ialphamodulate/
---
## IAlphaModulate sınıf

Alfa Modülasyonu etkisini temsil eder. Etki alfa (opaklık) değerleri sabit bir yüzde ile çarpılır. Etki konteyneri, modüle edilecek alfa değerlerini içeren bir etki belirtir.
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir gösterici (paylaşımlı yerine) olarak ayarlar. Konteynerlerdeki göstericilerin zayıf moda geçmesini sağlar. |
