...
description: Yumuşak kenar efekti temsil eder. Şeklin kenarları bulanıklaştırılır, doldurma ise etkilenmez.
type: docs
weight: 1080
...
Yumuşak kenar efekti temsil eder. Şeklin kenarları bulanıklaştırılır, doldurma etkilenmez.
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen [SoftEdge](./)'nin mevcut [SoftEdge](./) ile eşit olup olmadığını belirler. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Nesneleri C# [Object.Equals](../../system/object/equals/) semantiği kullanarak karşılaştırır. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Referans tipi nesneleri C# tarzında karşılaştırır. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değerle eşit olmaması gerekirken, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değerle eşit olmaması gerekirken, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
...
| **double** [get_Radius](./get_radius/)() override | Kenarların bulanıklaştırılması için uygulanacak yarıçapı belirtir. **double** okur. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | Kalıtım uygulanmış etkili Soft Edge efekti verilerini alır. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Belirli bir tip için hash işlevi olarak hizmet verir. |
...
| void [set_Radius](./set_radius/)(**double**) override | Kenarların bulanıklaştırılması için uygulanacak yarıçapı belirtir. **double** yazar. |
