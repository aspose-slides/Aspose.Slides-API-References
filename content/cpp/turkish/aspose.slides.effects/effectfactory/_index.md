...
| Metot | Açıklama |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IGlow](../iglow/)\> [CreateGlow](./createglow/)() override | [Glow](../glow/) etkisini oluşturur. |
| [System::SharedPtr](../../system/sharedptr/)\<[IInnerShadow](../iinnershadow/)\> [CreateInnerShadow](./createinnershadow/)() override | İç gölge etkisini oluşturur. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOuterShadow](../ioutershadow/)\> [CreateOuterShadow](./createoutershadow/)() override | Dış gölge etkisini oluşturur. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadow](../ipresetshadow/)\> [CreatePresetShadow](./createpresetshadow/)() override | Ön tanımlı gölge etkisini oluşturur. |
| [System::SharedPtr](../../system/sharedptr/)\<[IReflection](../ireflection/)\> [CreateReflection](./createreflection/)() override | [Reflection](../reflection/) etkisini oluşturur. |
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdge](../isoftedge/)\> [CreateSoftEdge](./createsoftedge/)() override | Yumuşak Kenar etkisini oluşturur. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Değer tipi nesneyi nullptr ile referans olarak kıyaslar. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | C# typeof([System.Object](../../system/object/)) yapılandırmasını uygular. |
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesi kilit açma işlemini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
...
*  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *
* Sınıf [IEffectFactory](../ieffectfactory/)
