...
description: Alfa Floor etkisini temsil eder. Alfa (opaklık) değerleri %100'den az ise sıfıra ayarlanır. Başka bir deyişle, kısmen saydam olan her şey tamamen saydam olur.
type: docs
weight: 27
...
Alpha Floor etkisini temsil eder. Alfa (opaklık) değerleri %100'den az ise sıfıra ayarlanır. Başka bir deyişle, kısmen saydam olan her şey tamamen saydam olur.
...
| Metot | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen [AlphaFloor](./)'nin mevcut [AlphaFloor](./) ile eşit olup olmadığını belirler. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloorEffectiveData](../ialphaflooreffectivedata/)\> [GetEffective](./geteffective/)() override | Kalıtım uygulanmış etkili Alpha Floor verisini alır. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) metodunun analoğu. Özel türlerin kopyalanmasını etkinleştirir. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşılan yerine) ayarlar. Kapsayıcılardaki işaretçilerin zayıf moda geçişini sağlar. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesi kilit açmasını uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
