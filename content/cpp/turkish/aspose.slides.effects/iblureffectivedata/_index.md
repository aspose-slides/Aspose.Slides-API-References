...
description: Bütün şekle, dolgu dahil, uygulanan bir Bulanıklaştırma etkisini temsil eden değiştirilemez nesne. Alfa da dahil olmak üzere tüm renk kanalları etkilenir.
type: docs
weight: 469
url: /tr/aspose.slides.effects/iblureffectivedata/
---
## IBlurEffectiveData sınıf


Tüm şekle, dolgu dahil, uygulanmış bir [Blur](../blur/) etkisini temsil eden değiştirilemez nesne. Alfa da dahil olmak üzere tüm renk kanalları etkilenir.
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# stiliyle referans tip nesneleri karşılaştırır. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# stiliyle değer tip nesneleri karşılaştırır. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmamasına rağmen iki NaN'in eşit kabul edildiği C# stili kayan nokta karşılaştırması yapar. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmamasına rağmen iki NaN'in eşit kabul edildiği C# stili kayan nokta karşılaştırması yapar. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca iç amaçlıdır. |
| virtual **bool** [get_Grow](./get_grow/)() | Nesnenin bulanıklaştırma sonucu sınırlarının büyütülüp büyütülmeyeceğini belirler. true ise sınırlar büyütülür, false ise büyütülmez. Salt-okunur **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Bulanıklaştırma yarıçapını döndürür. Salt-okunur **double**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) metodunun analoğu. Özel nesnelerin karma oluşturmalarını sağlar. |
