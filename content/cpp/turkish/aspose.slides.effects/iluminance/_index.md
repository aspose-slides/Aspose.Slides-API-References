...
description: Luminance etkisini temsil eder. Parlaklık, tüm renkleri lineer olarak beyaza ya da siyaha yaklaştırır. Kontrast, tüm renkleri daha yakın ya da daha uzak olacak şekilde ölçeklendirir.
type: docs
weight: 794
...
Bir [Luminance](../luminance/) etkisini temsil eder. Parlaklık, tüm renkleri lineer olarak beyaza ya da siyaha yaklaştırır. Kontrast, tüm renkleri daha yakın ya da daha uzak olacak şekilde ölçeklendirir.
...
| virtual T [GetEffective](../../aspose.slides/iaccessiblepviobject/geteffective/)() | Kalıtım uygulanmış etkin veriyi alır. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() deyiminin kilidini açma işlemini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
