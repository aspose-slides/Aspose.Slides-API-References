...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) yarıçapı. Okunur **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Gölgenin yönü. Okunur **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Gölgenin mesafesi. Okunur **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Gölgenin rengi. Yalnızca okunur [IColorFormat](../../aspose.slides/icolorformat/). |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin string ve nullptr durumuna özelleşmesi. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin string durumuna özelleşmesi. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Belirtilen değer kadar paylaşılan referans sayacını azaltır. |
| virtual void [set_BlurRadius](./set_blurradius/)(**double**) | [Blur](../blur/) yarıçapı. **double** yazılır. |
| virtual void [set_Direction](./set_direction/)(**float**) | Gölgenin yönü. **float** yazılır. |
| virtual void [set_Distance](./set_distance/)(**double**) | Gölgenin mesafesi. **double** yazılır. |
