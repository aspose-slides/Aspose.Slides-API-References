...
description: Bir Bulanıklaştırma etkisini temsil eder; bu etki şeklin tamamına, doldurması dahil, uygulanır. Alfa dahil olmak üzere tüm renk kanalları etkilenir.
type: docs
weight: 105
...
| Metot | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen [Blur](./)'nin mevcut [Blur](./)'ye eşit olup olmadığını belirler. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989'a göre NaN'ın hiçbir değere, NaN dahil, eşit olmaması gerektiği halde C#-style kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989'a göre NaN'ın hiçbir değere, NaN dahil, eşit olmaması gerektiği halde C#-style kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **bool** [get_Grow](./get_grow/)() override | Bulanıklaştırma sonucu nesnenin sınırlarının genişletilip genişletilmeyeceğini belirler. True sınırların genişletildiğini, false ise genişletilmediğini gösterir. **bool** okunur. |
...
| **double** [get_Radius](./get_radius/)() override | Bulanıklaştırma yarıçapını döndürür. **double** okunur. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlurEffectiveData](../iblureffectivedata/)\> [GetEffective](./geteffective/)() override | Miras uygulanmış etkili [Blur](./) efekt verisini alır. |
...
| void [set_Grow](./set_grow/)(**bool**) override | Bulanıklaştırma sonucu nesnenin sınırlarının genişletilip genişletilmeyeceğini belirler. True sınırların genişletildiğini, false ise genişletilmediğini gösterir. **bool** yazılır. |
| void [set_Radius](./set_radius/)(**double**) override | Bulanıklaştırma yarıçapını ayarlar. **double** yazılır. |
