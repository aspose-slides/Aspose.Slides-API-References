...
description: Alpha Inverse etkisini temsil eder. Alpha (opaklık) değerleri %100'den çıkarılarak tersine çevrilir.
type: docs
weight: 313
url: /tr/aspose.slides.effects/ialphainverse/
---
## IAlphaInverse sınıfı

Alpha Inverse etkisini temsil eder. Alpha (opaklık) değerleri %100'den çıkarılarak tersine çevrilir.
