...
description: Bir Alpha Ceiling etkisini temsil eder. Sıfırdan büyük alfa (opaklık) değerleri %100'e değiştirilir. Başka bir deyişle, kısmen opak olan her şey tamamen opak hâle gelir.
type: docs
weight: 14
...
Bir Alpha Ceiling etkisini temsil eder. Sıfırdan büyük alfa (opaklık) değerleri %100'e değiştirilir. Başka bir deyişle, kısmen opak olan her şey tamamen opak hâle gelir.
...
| Yöntem | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen [AlphaCeiling](./)'nin mevcut [AlphaCeiling](./)'e eşit olup olmadığını belirler. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeilingEffectiveData](../ialphaceilingeffectivedata/)\> [GetEffective](./geteffective/)() override | Kalıtım uygulanmış etkili Alpha Ceiling efekti verisini alır. |
...
* Sınıf [IAlphaCeiling](../ialphaceiling/)
