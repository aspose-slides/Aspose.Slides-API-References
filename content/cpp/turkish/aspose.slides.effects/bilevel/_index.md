...
description: Bi-Level (siyah/beyaz) bir etkiyi temsil eder. Belirtilen eşik değerinden düşük ışık şiddetine sahip giriş renkleri siyaha dönüştürülür. Belirtilen değere eşit veya daha yüksek ışık şiddetine sahip giriş renkleri beyaza ayarlanır. Alfa etki değerleri bu etki tarafından etkilenmez.
type: docs
weight: 92
...
Bi-Level (siyah/beyaz) bir etkiyi temsil eder. Belirtilen eşik değerinden düşük ışık şiddetine sahip giriş renkleri siyaha dönüştürülür. Belirtilen değere eşit veya daha yüksek ışık şiddetine sahip giriş renkleri beyaza ayarlanır. Alfa etki değerleri bu etki tarafından etkilenmez.
...
| Metod | Açıklama |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Belirtilen [BiLevel](./)'nin mevcut [BiLevel](./) ile eşit olup olmadığını belirler. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevelEffectiveData](../ibileveleffectivedata/)\> [GetEffective](./geteffective/)() override | Kalıtım uygulanmış etkili Bi-Level efekt verilerini alır. |
