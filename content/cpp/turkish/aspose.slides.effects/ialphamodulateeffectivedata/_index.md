...
description: Alfa Modülasyon etkisini temsil eden değiştirilemez nesne. Etki alfa (opaklık) değerleri sabit bir yüzdeyle çarpılır. Etki kapsayıcısı, modüle edilecek alfa değerlerini içeren bir etki belirtir.
type: docs
weight: 352
url: /tr/aspose.slides.effects/ialphamodulateeffectivedata/
---
## IAlphaModulateEffectiveData sınıfı
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 standardına göre NaN hiçbir değere, NaN dahil, eşit değildir; yine de iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 standardına göre NaN hiçbir değere, NaN dahil, eşit değildir; yine de iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Nesnenin gerçek tipini alır. [System.Object.GetType()](../../system/object/gettype/) C# çağrısının analogu. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | [Object.MemberwiseClone()](../../system/object/memberwiseclone/) C# metodunun analogu. Özel tiplerin kopyalanmasını (klonlanmasını) sağlar. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'ıncı şablon argümanını zayıf gösterici (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki göstericilerin zayıf moda geçişine izin verir. |
