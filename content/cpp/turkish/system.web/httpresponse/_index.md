...
description: "Çevrilen kodun HttpResponse referanslarıyla bağlanmasını mümkün kılan sahte sınıf, ancak çalıştırmaz. Doğru bir şekilde uygulanmış üye içermez. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak tahsis edilmelidir. Bu tipin örneğini yığıt üzerinde veya new operatörüyle oluşturmayın; aksi takdirde çalışma zamanı hataları ve/veya doğrulama hataları oluşur. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 27
url: /tr/system.web/httpresponse/
---
## HttpResponse sınıfı

Bu sınıf, [HttpResponse](./) referanslarıyla çevrilen kodun bağlanmasını mümkün kılar, ancak çalıştırmaz. Doğru bir şekilde uygulanmış üye içermez. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak tahsis edilmelidir. Bu tür bir örnek yığıt üzerinde ya da new operatörüyle oluşturulmamalıdır, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| Metot | Açıklama |
| --- | --- |
| void [AddHeader](./addheader/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Henüz uygulanmadı. |
| void [BinaryWrite](./binarywrite/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Henüz uygulanmadı. |
| void [Clear](./clear/)() | Henüz uygulanmadı. |
| void [ClearContent](./clearcontent/)() | Henüz uygulanmadı. |
| void [ClearHeaders](./clearheaders/)() | Henüz uygulanmadı. |
| void [End](./end/)() | Henüz uygulanmadı. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN değeri, IEC 60559:1989 standardına göre NaN'in hiçbir değerle, NaN dahil, eşit olmamasına rağmen eşit kabul edilir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN değeri, IEC 60559:1989 standardına göre NaN'in hiçbir değerle, NaN dahil, eşit olmamasına rağmen eşit kabul edilir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| [SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [get_OutputStream](./get_outputstream/)() | Henüz uygulanmadı. |
...
|  [HttpResponse](./httpresponse/)(const [System::SharedPtr](../../system/sharedptr/)\<[System::IO::TextWriter](../../system.io/textwriter/)\>\&) | Henüz uygulanmadı. |
...
| void [set_ContentType](./set_contenttype/)(const [String](../../system/string/)\&) | Henüz uygulanmadı. |
