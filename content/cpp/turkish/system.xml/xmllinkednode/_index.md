...
description: Bu düğümden hemen önce gelen ya da hemen sonra gelen düğümü döndürür.
type: docs
weight: 274
url: /tr/system.xml/xmllinkednode/
---
## XmlLinkedNode sınıfı

Bu düğümden hemen önce gelen ya da hemen sonra gelen düğümü döndürür.
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Geçerli düğüm için kapsamda olan verilen önek için en yakın **xmlns** bildirgesini bulur ve bildirgedeki ad alanı URI'sını döndürür. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Geçerli düğüm için kapsamda olan verilen ad alanı URI'si için en yakın **xmlns** bildirgesini bulur ve o bildirgede tanımlı önek'i döndürür. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin targetType tarafından tanımlanan tipe bir örnek olup olmadığını denetler. C# 'is' operatörünün bir benzeri. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Giriş dizisinin her bir öğesi üzerinde bir dönüştürme fonksiyonu çağırarak elde edilen değerlerin ortalamasını hesaplar. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesi üzerinde bir dönüştürme fonksiyonu çağırır ve oluşan maksimum değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesi üzerinde bir dönüştürme fonksiyonu çağırır ve oluşan minimum değeri döndürür. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Her öğeyi projekte eder ve oluşan dizileri tek bir dizi içinde birleştirir. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<T\> [LINQ_ToArray](../../system.collections.generic/ienumerable/linq_toarray/)() | Bir dizi üzerinden bir dizi oluşturur. |
| [SharedPtr](../../system/sharedptr/)\<[List](../../system.collections.generic/list/)\<T\>\> [LINQ_ToList](../../system.collections.generic/ienumerable/linq_tolist/)() | Bir dizi üzerinden bir List<T> oluşturur. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | [XmlNode](../xmlnode/) altındaki alt ağaçta bulunan tüm [XmlText](../xmltext/) düğümlerini, yalnızca işaretleme (yani etiketler, yorumlar, işleme talimatları, CDATA bölümleri ve varlık referansları) [XmlText](../xmltext/) düğümlerini ayıran bir \"normal\" forma, yani yan yana [XmlText](../xmltext/) düğüm olmaksızın, tam derinliğe getirir. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin dize ve nullptr durumuna özgü bir özelleştirmesi. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin dize durumuna özgü bir özelleştirmesi. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&) | [XPath](../../system.xml.xpath/) ifadesine uyan bir düğüm listesi seçer. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | [XPath](../../system.xml.xpath/) ifadesine uyan bir düğüm listesi seçer. [XPath](../../system.xml.xpath/) ifadesinde bulunan tüm önekler sağlanan [XmlNamespaceManager](../xmlnamespacemanager/) ile çözülür. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&) | [XPath](../../system.xml.xpath/) ifadesine uyan ilk [XmlNode](../xmlnode/)'yu seçer. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | [XPath](../../system.xml.xpath/) ifadesine uyan ilk [XmlNode](../xmlnode/)'yi seçer. [XPath](../../system.xml.xpath/) ifadesinde bulunan tüm önekler sağlanan [XmlNamespaceManager](../xmlnamespacemanager/) ile çözülür. |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Düğümün tüm alt düğümlerini belirtilen [XmlWriter](../xmlwriter/)'a kaydeder, türetilmiş bir sınıfta geçersiz kılındığında. |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Geçerli düğümü belirtilen [XmlWriter](../xmlwriter/)'a kaydeder, türetilmiş bir sınıfta geçersiz kılındığında. |
