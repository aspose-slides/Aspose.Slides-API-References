...
description: Eleman içeriğinde boşluk karakterlerini temsil eder.
type: docs
weight: 560
url: /tr/system.xml/xmlwhitespace/
---
## XmlWhitespace sınıfı
...
Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak ayrılmalıdır. Bu tipteki örnekleri yığını üzerinde veya new operatörü kullanarak oluşturmayın; aksi takdirde çalışma zamanı hataları ve/veya doğrulama hataları ortaya çıkar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
