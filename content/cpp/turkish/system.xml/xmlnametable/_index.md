...
description: Atomize edilmiş dize nesnelerinin tablosu.
type: docs
weight: 313
url: /tr/system.xml/xmlnametable/
---
## XmlNameTable sınıf

Atomize edilmiş dize nesnelerinin tablosu.
...
| Yöntem | Açıklama |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Türev bir sınıfta geçersiz kılındığında, belirtilen dizeyi atomize eder ve [XmlNameTable](./)'ye ekler. |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | Türev bir sınıfta geçersiz kılındığında, belirtilen dizeyi atomize eder ve [XmlNameTable](./)'ye ekler. |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Türev bir sınıfta geçersiz kılındığında, verilen dizideki belirtilen karakter aralığıyla aynı karakterleri içeren atomize edilmiş dizeyi alır. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | Türev bir sınıfta geçersiz kılındığında, belirtilen dizeyle aynı değeri içeren atomize edilmiş dizeyi alır. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Paylaşımlı referans sayacını azaltır ve geri döndürür. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler veya ThisProtector kullanılmalıdır. |
