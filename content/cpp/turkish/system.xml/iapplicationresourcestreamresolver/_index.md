...
description: Bir uygulama kaynak akış çözücüsünü temsil eder.
type: docs
weight: 14
url: /tr/system.xml/iapplicationresourcestreamresolver/
---
## IApplicationResourceStreamResolver sınıfı

Uygulama kaynak akışı çözücüsünü temsil eder.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetApplicationResourceStream](./getapplicationresourcestream/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Belirtilen URI'den bir uygulama kaynak akışı döndürür. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşılan değil) olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçirmeye izin verir. |
