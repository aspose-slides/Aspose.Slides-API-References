...
description: Ağaç ekleme işlemleri için kullanışlı, hafif bir nesneyi temsil eder.
type: docs
weight: 196
url: /tr/system.xml/xmldocumentfragment/
---
## XmlDocumentFragment sınıfı

Ağaç ekleme işlemleri için kullanışlı, hafif bir nesneyi temsil eder.
...
| Tip Tanımı | Açıklama |
| --- | --- |
| [Ptr](./ptr/) | Bu sınıfın bir örneğine ortak işaretçi için takma addır. |

## Açıklamalar

Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak oluşturulmalıdır. Bu tipin örneklerini yığıt üzerinde veya new operatörüyle oluşturmayın; çünkü bu, çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Her zaman bu sınıfı [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
