...
type: docs
weight: 1
url: /tr/system.xml/details_xmlexception/
---
## Details_XmlException sınıfı
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN de dahil, eşit olmamasına rağmen iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN de dahil, eşit olmamasına rağmen iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Hatanın gerçekleştiği satır numarasını döndürür. Satır numaraları 1'den başlar. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Hatanın gerçekleştiği satır konumunu döndürür. Satır konumu 1'den başlar. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Geçerli istisnayı açıklayan bir mesaj döndürür. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | XML dosyasının konumunu döndürür. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşımlı değil) olarak ayarlar. Kaplarda işaretçileri zayıf moda geçiş yapmayı sağlar. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) metodunu uygular; bu metod [ExceptionWrapper](../../system/exceptionwrapper/) sınıfı tarafından çağrılır. Bu sınıfın std::exception'dan türetilmemiş olmasına rağmen türetilen sınıflar korumalı/özel üyeleri mantıklarını uygulamak için kullanabilir. Bu metodun uygulanmasını [ExceptionWrapper](../../system/exceptionwrapper/)'ye taşıma, bu mantığı bozabilir. |
...
| Tip Tanımı | Açıklama |
| --- | --- |
| [Ptr](./ptr/) | Bu sınıfın bir örneğine paylaşımlı işaretçi takma adıdır. |
