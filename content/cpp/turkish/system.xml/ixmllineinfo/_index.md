...
description: Bir sınıfın satır ve konum bilgilerini döndürmesini sağlayan bir arayüz sunar.
type: docs
weight: 40
url: /tr/system.xml/ixmllineinfo/
---
## IXmlLineInfo sınıfı


Bir sınıfın satır ve konum bilgilerini döndürmesini sağlayan bir arayüz sunar.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Geçerli satır numarasını döndürür. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Geçerli satır konumunu döndürür. |
...
| virtual **bool** [HasLineInfo](./haslineinfo/)() | Sınıfın satır bilgisi döndürüp döndüremeyeceğini belirten bir değer döndürür. |
