...
description: "rbegin() ve rend() işlevlerini kullanarak öğeleri doğrudan tutan basit kapsayıcılar için yineleyici sınıfı. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak tahsis edilmelidir. Bu tipin bir örneğini yığına ya da new operatörüyle asla oluşturmayın; aksi takdirde çalışma zamanı hataları ve/veya doğrulama hataları oluşur. Her zaman bu sınıfı System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 508
url: /tr/system.collections.generic/simpleenumerator/
---
## SimpleEnumerator sınıfı

Iterator sınıfı, rbegin() ve rend() işlevlerini kullanarak öğeleri doğrudan tutan basit kapsayıcılar için. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak tahsis edilmelidir. Bu tipin örneği yığına ya da new operatörüyle asla yaratılmamalıdır; aksi takdirde çalışma zamanı hataları ve/veya doğrulama hataları oluşur. Her zaman bu sınıfı [System::SmartPtr](../../system/smartptr/) işaretçisiyle sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| Parametre | Açıklama |
| --- | --- |
| Container | İçinden yineleme yapılacak kapsayıcı türü. |
| Element | Eleman türü. |
...
| Yöntem | Açıklama |
| --- | --- |
| [IEnumerator](../ienumerator/) * [AsVirtualizedIterator](../ienumerator/asvirtualizediterator/)() | VirtualizedIterator sınıfı tarafından kullanılmak üzere yineleyiciyi hazırlar. |
| [BaseEnumerator](../baseenumerator/baseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | Yineleyiciyi başlatır. |
| System::Details::VirtualizedIteratorBase\<Element\> * [CloneIterator](./cloneiterator/)() const override | Mevcut yineleyiciyi klonlar. |
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](../ienumerator/current/)() const | Mevcut elemanı alır. |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Element\> [get_Current](./get_current/)() const override | 'current' elemanı alır. |
...
| void [IncrementIterator](../ienumerator/incrementiterator/)() override | Yineleyiciyi bir adım ileri taşır. |
| void [InitializeIterator](../ienumerator/initializeiterator/)() override | İlk [MoveNext()](../ienumerator/movenext/) çağrısını yapar ve sayıcı nesnesini VirtualizedIterator tarafından kullanılmak üzere hazırlar. |
...
| **bool** [IsValid](../baseenumerator/isvalid/)() const | [MoveNext()](../baseenumerator/movenext/) çağrısı yapıldı mı ve sonuna ulaşılıp ulaşılmadığını denetler. |
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitlemesini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
| void [MarkOwnedByVirtualizedIterator](../ienumerator/markownedbyvirtualizediterator/)() | Sanallaştırılmış yineleyiciye ait sayıcıyı işaretler. |
...
| **bool** [MoveNext](../baseenumerator/movenext/)() override | Sayıcı tarzı artış. |
...
| void [Reset](../baseenumerator/reset/)() override | Elemanları yeniden yinelemek için sayıcıyı sıfırlar. |
...
| [SimpleEnumerator](./simpleenumerator/)([Object::ptr](../../system/object/ptr/), Container\&) | Basit yineleyici oluşturur. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidi açma işlemini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
...
* Sınıf [BaseEnumerator](../baseenumerator/)
