...
description: System.Collections.Generic.IComparer jenerik arayüzünün uygulamaları için temel bir sınıf sağlar.
type: docs
weight: 105
url: /tr/system.collections.generic/comparer/
---
## Comparer sınıf

[System.Collections.Generic.IComparer](../icomparer/) jenerik arayüzünün uygulamaları için bir temel sınıf sağlar.
...
| Parametre | Açıklama |
| --- | --- |
| T | Karşılaştırılacak nesnelerin tipi. |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) fonksiyon. |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | Genel argüman tarafından belirtilen tip için varsayılan sıralama sırası karşılaştırıcısını döndürür. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki göstericilerin zayıf moda geçişine olanak tanır. |
