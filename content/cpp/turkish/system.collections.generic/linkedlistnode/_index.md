...
description: "Bağlantılı listenin düğümü. Bağlantılı listede sarılmış std::list yineleyicisi üzerine bir sarmalayıcı uygular. Bu sınıfın nesneleri yalnızca System::MakeObject() fonksiyonu kullanılarak ayrılmalıdır. Yığını üzerinde veya operator new ile bu tipin örneği oluşturulmamalıdır, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıf her zaman System::SmartPtr işaretçisine sarılmalı ve bu işaretçi fonksiyonlara argüman olarak geçirilmelidir."
type: docs
weight: 417
url: /tr/system.collections.generic/linkedlistnode/
---
## LinkedListNode sınıf
...
| [SharedPtr](../../system/sharedptr/)\<[LinkedList](../linkedlist/)\<T\>\> [get_List](./get_list/)() const | İçeren listeyi alır. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Next](./get_next/)() const | Sonraki düğümü alır. |
| [SharedPtr](../../system/sharedptr/)\<[LinkedListNode](./)\<T\>\> [get_Previous](./get_previous/)() const | Önceki düğümü alır. |
| T [get_Value](./get_value/)() const | Depolanan değeri alır. |
...
| void [set_Value](./set_value/)(const T\&) | Depolanan değeri ayarlar. |
