...
description: "Kap içinde ters yönde yineleme yapan Enumerator. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tipin örneğini yığıt üzerinde veya new operatörüyle oluşturmayın; aksi takdirde çalışma zamanı hataları ve/veya doğrulama hataları ortaya çıkar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirmek için kullanın."
type: docs
weight: 495
url: /tr/system.collections.generic/reverseenumerator/
---
## ReverseEnumerator sınıfı
...
| Parametre | Açıklama |
| --- | --- |
| Container | İçinde yinelemeye yapılacak kapsayıcı. |
...
| Yöntem | Açıklama |
| --- | --- |
| [IEnumerator](../ienumerator/) * [AsVirtualizedIterator](../ienumerator/asvirtualizediterator/)() | Iteratori VirtualizedIterator sınıfı tarafından kullanılmak üzere hazırlar. |
| System::Details::VirtualizedIteratorBase\<T\> * [CloneIterator](../ienumerator/cloneiterator/)() const override | Geçerli iterator'ı klonlar. |
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [Current](../ienumerator/current/)() const | Geçerli öğeyi alır. |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Element\> [get_Current](./get_current/)() const override | 'geçerli' öğeyi alır. |
...
| void [IncrementIterator](../ienumerator/incrementiterator/)() override | Iteratori bir adım ileri taşır. |
| void [InitializeIterator](../ienumerator/initializeiterator/)() override | İlk [MoveNext()](../ienumerator/movenext/) çağrısını yapar ve enumerator nesnesini VirtualizedIterator tarafından kullanılmak üzere hazırlar. |
...
| **bool** [IsValid](./isvalid/)() const | [MoveNext()](./movenext/) çağrılıp sonuna ulaşılmadığını kontrol eder. |
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitlemesini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
| void [MarkOwnedByVirtualizedIterator](../ienumerator/markownedbyvirtualizediterator/)() | Sanal iterator tarafından sahiplenilen enumerator'ı işaretler. |
...
| **bool** [MoveNext](./movenext/)() override | Enumerator tarzı artırma. |
| [Object](../../system/object/object/)() | Nesneyi yaratır. Tüm iç veri yapılarını başlatır. |
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Gerçekten bir şey kopyalamaz, yalnızca yeni nesneyi başlatır ve türev sınıfların kopya yapımını mümkün kılar. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Gerçekten bir şey kopyalamaz, yalnızca yeni nesneyi başlatır ve türev sınıfların kopya yapımını mümkün kılar. |
...
| void [Reset](./reset/)() override | Enumerator'i sıfırlar, öğeleri yeniden yinelemeye izin verir. |
| [ReverseEnumerator](./reverseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | Iteratori başlatır. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi olarak ayarlar (paylaşımlı yerine). Kapsayıcılardaki işaretçileri zayıf moda geçiş yapmaya izin verir. |
