...
description: XmlReader deneyimini geliştiren hizmet sınıfı.
type: docs
weight: 40
url: /tr/system.xml.serialization/xmlserializationreader/
---
## XmlSerializationReader sınıfı

Service sınıfı, [XmlReader](../../system.xml/xmlreader/) deneyimini iyileştirir.
...
| void [Initialize](./initialize/)([System::SharedPtr](../../system/sharedptr/)\<[XmlReader](../../system.xml/xmlreader/)\>, [System::SharedPtr](../../system/sharedptr/)\<[XmlSerializer](../xmlserializer/)\>) | [XmlSerializationReader](./) sınıfını başlatır. |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitlemesini gerçekleştirir. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit kaldırmasını gerçekleştirir. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
