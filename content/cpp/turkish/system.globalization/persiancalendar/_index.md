...
description: "Persian takvimi. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak tahsis edilmelidir. Bu tipin örneğini yığın üzerinde ya da new operatörüyle asla oluşturmayın, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisi olarak sarmalayın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 261
url: /tr/system.globalization/persiancalendar/
---
## PersianCalendar sınıfı


Persian takvimi. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak tahsis edilmelidir. Bu tipin örneğini yığın üzerinde ya da new operatörüyle asla oluşturmayın, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisi olarak sarmalayın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| [ArrayPtr](../../system/arrayptr/)\<int\> [get_Eras](./get_eras/)() const override | Takvimde mevcut çağların listesini alır. |
| **bool** [get_IsReadOnly](../calendar/get_isreadonly/)() const | Takvimin yalnızca okunabilir olup olmadığını denetler. |
| [DateTime](../../system/datetime/) [get_MaxSupportedDateTime](./get_maxsupporteddatetime/)() const override | Takvim tarafından desteklenen en yüksek zaman noktası. |
| [DateTime](../../system/datetime/) [get_MinSupportedDateTime](./get_minsupporteddatetime/)() const override | Takvim tarafından desteklenen en düşük zaman noktası. |
| virtual int [get_TwoDigitYearMax](../calendar/get_twodigityearmax/)() const | 2 basamaklı temsil edilebilen son yılı alır. |
...
| virtual int [GetDaysInMonth](./getdaysinmonth/)(int, int) const | RTTI bilgisi. |
| virtual int [GetDaysInMonth](./getdaysinmonth/)(int, int, int) const | RTTI bilgisi. |
| int [GetDaysInYear](./getdaysinyear/)(int, int) const override | Belirli bir yılda gün sayısını alır. |
...
| virtual int [GetEra](../calendar/getera/)([DateTime](../../system/datetime/)) const | Belirtilen zaman noktası için çağı alır. |
...
| int [GetMonthsInYear](./getmonthsinyear/)(int, int) const override | Belirlenen yılda ay sayısını alır. |
| virtual int [GetMonthsInYear](./getmonthsinyear/)(int) const | Belirlenen yılda ay sayısını alır. |
| virtual int [GetMonthsInYear](./getmonthsinyear/)(int, int) const | Belirlenen yılda ay sayısını alır. |
| virtual int [GetSecond](../calendar/getsecond/)([DateTime](../../system/datetime/)) const | Belirtilen zaman noktasının saniyeyi alır. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Aslında hiçbir şey kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapısını etkinleştirir. |
...
| virtual void [set_TwoDigitYearMax](../calendar/set_twodigityearmax/)(int) | 2 basamaklı temsil edilebilen son yılı ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını paylaşılan yerine zayıf işaretçi olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçiş yapmayı sağlar. |
...
| virtual int [ToFourDigitYear](../calendar/tofourdigityear/)(int) const | Yılı TwoDigitYearMax özelliği ile 4 basamaklı yıla dönüştürür. |
...
| Alan | Açıklama |
| --- | --- |
| static constexpr [PersianEra](./persianera/) | Mevcut persian çağı. |
