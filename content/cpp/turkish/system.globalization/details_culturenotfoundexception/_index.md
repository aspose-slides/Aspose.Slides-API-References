...
description: "CultureNotFoundException, mevcut olmayan bir kültür oluşturulmaya çalışıldığında fırlatılır. Bu sınıfın örneklerini manuel olarak oluşturmayın. Bunun yerine CultureNotFoundException sınıfını kullanın. CultureNotFoundException sınıfı örneklerini System::SmartPtr içine asla sarmalamayın."
type: docs
weight: 92
url: /tr/system.globalization/details_culturenotfoundexception/
---
## Details_CultureNotFoundException sınıf

CultureNotFoundException, mevcut olmayan bir kültür oluşturulmaya çalışıldığında fırlatılır. Bu sınıfın örneklerini manuel olarak oluşturmayın. Bunun yerine CultureNotFoundException sınıfını kullanın. CultureNotFoundException sınıfı örneklerini [System::SmartPtr](../../system/smartptr/) içine asla sarmalamayın.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | Özel istisna verileriyle bir sözlük döndürür. |
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Geçerli nesne tarafından temsil edilen istisna ile ilişkili 32-bit HRESULT kodunu döndürür. |
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [get_InnerException](../../system/details_exception/get_innerexception/)() const | İç istisna nesnesine bir referans döndürür. |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | En içteki istisna nesnesinin bir kopyasını döndürür. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Nesnenin gerçek tipini alır. C# [System.Object.GetType()](../../system/object/gettype/) çağrısının analoğu. |
...
|  [Object](../../system/object/object/)() | Nesneyi yaratır. Tüm iç veri yapılarını başlatır. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Belirli bir istisna için atanmış kodlu sayısal değeri (HRESULT) ayarlar. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Mevcut paylaşımlı referans sayacı değerini alır. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Paylaşımlı referans sayacını artırır. Doğrudan çağrılmamalıdır; akıllı işaretçiler veya ThisProtector kullanılmalıdır. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Paylaşımlı referans sayacını azaltır ve değerini döndürür. Doğrudan çağrılmamalıdır; akıllı işaretçiler veya ThisProtector kullanılmalıdır. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) metodunu uygular; bu metod [ExceptionWrapper](../../system/exceptionwrapper/) sınıfı tarafından çağrılır. std::exception’tan türetilmemiş sınıflar, mantığını uygulamak için korumalı/özel üyeleri kullanabilir. Bu metodun uygulanmasını [ExceptionWrapper](../../system/exceptionwrapper/)'ye taşımak bu mantığı bozabilir. |
| virtual  [~Object](../../system/object/~object/)() | Nesneyi yok eder. Tüm iç veri yapılarını serbest bırakır. |

## İlgili

* Sınıf [Details_ArgumentException](../../system/details_argumentexception/)
