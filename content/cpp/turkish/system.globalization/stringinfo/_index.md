...
description: "Dize parçaları üzerinde yineleme yapmak için ayırıcı. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tipin bir örneğini yığında veya new operatörüyle oluşturmaya çalışmayın; bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Her zaman bu sınıfı System::SmartPtr işaretçisine sarın ve bu işaretçiyi işlevlere argüman olarak geçirin."
type: docs
weight: 313
url: /tr/system.globalization/stringinfo/
---
## StringInfo sınıfı
...
| int [get_LengthInTextElements](./get_lengthintextelements/)() const | [StringInfo](./) nesnesindeki metin öğelerinin sayısını alır. |
| [String](../../system/string/) [get_String](./get_string/)() const | [StringInfo](./) nesnesinin değerini alır. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| int [GetHashCode](./gethashcode/)() const override | C# [Object.GetHashCode()](../../system/object/gethashcode/) yönteminin analoğu. Özel nesnelerin karma (hash) yapılmasını sağlar. |
| static [String](../../system/string/) [GetNextTextElement](./getnexttextelement/)(const [String](../../system/string/)\&) | Belirtilen dizedeki ilk öğeyi alır. |
| static [String](../../system/string/) [GetNextTextElement](./getnexttextelement/)(const [String](../../system/string/)\&, int) | Belirtilen dizedeki belirtilen indeksteki öğeyi alır. |
| static [SharedPtr](../../system/sharedptr/)\<[TextElementEnumerator](../textelementenumerator/)\> [GetTextElementEnumerator](./gettextelementenumerator/)(const [String](../../system/string/)\&) | Dizinin karakterleri üzerinde yineleme yapmak için bir yineleyici oluşturur. |
| static [SharedPtr](../../system/sharedptr/)\<[TextElementEnumerator](../textelementenumerator/)\> [GetTextElementEnumerator](./gettextelementenumerator/)(const [String](../../system/string/)\&, int) | Belirtilen indexten başlayarak dizenin karakterleri üzerinde yineleme yapmak için bir yineleyici oluşturur. |
...
| static [ArrayPtr](../../system/arrayptr/)\<int\> [ParseCombiningCharacters](./parsecombiningcharacters/)(const [String](../../system/string/)\&) | Temel karakterlerin, yüksek surrogatların ve kontrol karakterlerinin dizinlerini alır. |
...
| void [set_String](./set_string/)(const [String](../../system/string/)\&) | [StringInfo](./) nesnesinin değerini ayarlar. |
...
|  [StringInfo](./stringinfo/)(const [String](../../system/string/)\&) | Yapıcı. |
|  [StringInfo](./stringinfo/)(const [StringInfo](./)\&) |  |
| [String](../../system/string/) [SubstringByTextElements](./substringbytextelements/)(int) const | Belirtilen metin öğesinden son metin öğesine kadar metin öğelerinin alt dizisini alır. |
| [String](../../system/string/) [SubstringByTextElements](./substringbytextelements/)(int, int) const | Belirtilen metin öğesinden belirtilen sayıdaki metin öğesine kadar alt diziyi alır. |
