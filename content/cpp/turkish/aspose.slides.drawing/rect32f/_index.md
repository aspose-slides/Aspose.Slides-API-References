...
description: Rectangle yapı
type: docs
weight: 27
url: /tr/aspose.slides.drawing/rect32f/
---
## Rect32f sınıf
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) yöntemine benzer. Özel tiplerin kopyalanmasını (klonlanmasını) sağlar. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Değer tipi nesneyi nullptr ile referans açısından karşılaştırır. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zayıf referans sayacını azaltır. Doğrudan çağrılmamalıdır; bunun yerine akıllı göstericileri ve ThisProtector'ı kullanın. |
