...
description: Temel ve isteğe bağlı bir dereceden oluşan radikal fonksiyonu belirtir. Radikal nesnesine örnek \\u221A\\uD835\\uDC65.
type: docs
weight: 508
...
Kök fonksiyonunu belirtir, bir temel ve isteğe bağlı bir derece içerir. Kök nesnesine örnek \\u221A\\uD835\\uDC65.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Bu örnek kullanılarak belirtilen işlevi argüman olarak alır |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([System::String](../../system/string/)) | Bu örnek kullanılarak belirtilen işlevi argüman olarak alır |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../imathelement/asargumentoffunction/)([MathFunctionsOfOneArgument](../mathfunctionsofoneargument/)) | Bu örnek kullanılarak belirtilen işlevi argüman olarak alır |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Bu örnek kullanılarak bir argüman fonksiyonu alır |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | Bu örnek kullanılarak bir argüman fonksiyonu alır |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | Temel argüman |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Degree](./get_degree/)() | Derece argümanı |
| virtual **bool** [get_HideDegree](./get_hidedegree/)() | Dereceyi gizle. True olduğunda, derecesi gösterilmez, örneğin \\u221A\\uD835\\uDC65 gibi |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | Bu öğeyi alt köşeli parantez gibi bir gruplama karakteri kullanarak bir gruba yerleştirir |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathNaryOperator](../imathnaryoperator/)\> [Integral](../imathelement/integral/)([MathIntegralTypes](../mathintegraltypes/)) | Sınırlarsız integral alır |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../imathelement/join/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Bir matematik öğesini birleştirerek bir matematik bloğu oluşturur |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../imathelement/join/)([System::String](../../system/string/)) | Bir matematik metnini birleştirerek bir matematik bloğu oluşturur |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../imathelement/overbar/)() | Bu öğenin üstüne bir çubuk ayarlar |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Belirtilen argümandan verilen derecenin matematiksel kökünü belirtir. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Belirtilen argümandan verilen derecenin matematiksel kökünü belirtir. |
...
| virtual void [set_HideDegree](./set_hidedegree/)(**bool**) | Dereceyi gizle. True olduğunda, derecesi gösterilmez, örneğin \\u221A\\uD835\\uDC65 gibi |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Bu öğeyi görsel olmayan bir kutuya (mantıksal gruplama) yerleştirir; bu kutu, bir denklem veya diğer matematiksel metin örneklerinin bileşenlerini gruplayıp, örneğin bir operatör emülatörü gibi hizmet verebilir, satır kesme noktası olarak kullanılabilir veya satır kesmelerinin olmaması için gruplanabilir. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Underbar](../imathelement/underbar/)() | Bu öğenin altına bir çubuk ayarlar |
