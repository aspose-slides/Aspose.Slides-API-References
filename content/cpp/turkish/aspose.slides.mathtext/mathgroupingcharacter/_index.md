...
description: Bir ifadeyi üstte ya da altta gruplayan bir sembol belirler, genellikle öğeler arasındaki ilişkiyi vurgulamak için
type: docs
weight: 885
...
Bir ifadeye üstte ya da altta bir gruplanma sembolü belirler, genellikle öğeler arasındaki ilişkiyi vurgulamak için
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../mathelementbase/accent/)(char16_t) override | Bu öğenin üstünde bir karakter olan aksan işaretini ayarlar |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Bu örneği argüman ve belirtilen ek argüman olarak kullanarak belirli bir işlevi alır |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfTwoArguments](../mathfunctionsoftwoarguments/), [System::String](../../system/string/)) override | Bu örneği argüman ve belirtilen ek argüman olarak kullanarak belirli bir işlevi alır |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) override | Belirtilen türde, bu pay ve belirtilen payda ile bir kesir oluşturur |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) override | Belirtilen türde, bu pay ve belirtilen payda ile bir kesir oluşturur |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Bir matematik öğesini, parantez gibi belirtilen karakterlerle ya da başka karakterlerle çerçeve içine alır |
...
| char16_t [get_Character](./get_character/)() override | Grouping Character Varsayılan değeri: U+23DF (BOTTOM CURLY BRACKET) |
| [MathTopBotPositions](../mathtopbotpositions/) [get_Position](./get_position/)() override | Gruplama karakterinin konumu. Varsayılan: Alt |
| [MathTopBotPositions](../mathtopbotpositions/) [get_VerticalJustification](./get_verticaljustification/)() override | Grup karakterinin dikey hizalaması. Nesnenin temel çizgiye göre hizalanmasını belirler. Örneğin, grup karakteri nesnenin üstünde olduğunda, VerticalJustification Top, nesnenin üstünün temel çizgiye denk geldiğini gösterir; VerticalJustification Bottom olduğunda, nesnenin altı temel çizgiye denk gelir. Varsayılan: Position=Top için Bottom, Position=Bottom için Top |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | Bu öğeyi alt kıvırcık parantez gibi bir grup karakteri ya da başka bir karakter kullanarak bir gruba yerleştirir |
...
|  [MathGroupingCharacter](./mathgroupingcharacter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | [MathGroupingCharacter](./) sınıfının yeni bir örneğini varsayılan grup karakteri U+23DF (BOTTOM CURLY BRACKET) ile başlatır |
|  [MathGroupingCharacter](./mathgroupingcharacter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | [MathGroupingCharacter](./) sınıfının yeni bir örneğini başlatır. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Verilen dereceden belirtilen argüman ile matematiksel kökü belirtir. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | Verilen dereceden belirtilen argüman ile matematiksel kökü belirtir. |
...
| void [set_Character](./set_character/)(char16_t) override | Grouping Character Varsayılan değeri: U+23DF (BOTTOM CURLY BRACKET) |
| void [set_Position](./set_position/)([MathTopBotPositions](../mathtopbotpositions/)) override | Gruplama karakterinin konumu. Varsayılan: Alt |
| void [set_VerticalJustification](./set_verticaljustification/)([MathTopBotPositions](../mathtopbotpositions/)) override | Grup karakterinin dikey hizalaması. Nesnenin temel çizgiye göre hizalanmasını belirler. Örneğin, grup karakteri nesnenin üstünde olduğunda, VerticalJustification Top, nesnenin üstünün temel çizgiye denk geldiğini gösterir; VerticalJustification Bottom olduğunda, nesnenin altı temel çizgiye denk gelir. Varsayılan: Position=Top için Bottom, Position=Bottom için Top |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Bu öğeyi, bir denklemin veya diğer bir matematik metninin bileşenlerini gruplamak için kullanılan, görsel olmayan bir kutuya (mantıksal gruplama) yerleştirir. Kutulu bir nesne, örneğin, hizalama noktasıyla ya da olmadan bir operatör taklitçisi, satır sonu noktası olarak hizmet edebilir ya da içinde satır sonlarına izin vermeyecek şekilde gruplanabilir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidini açar. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) nöbetçi nesnesini kullanın. |
