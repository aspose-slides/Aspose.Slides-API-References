...
description: Control Character Özelliklerine sahip IMathElement
type: docs
weight: 14
url: /tr/aspose.slides.mathtext/ihascontrolcharacterproperties/
---
## IHasControlCharacterProperties sınıf


[IMathElement](../imathelement/) ile [Control](../../aspose.slides/control/) Karakter Özellikleri
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir gösterici olarak ayarlar (paylaşımlı yerine). Kapsayıcılardaki göstericilerin zayıf moda geçişine izin verir. |
