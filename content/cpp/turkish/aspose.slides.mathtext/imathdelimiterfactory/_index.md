...
description: Matematik sınırlayıcı oluşturmayı sağlar
type: docs
weight: 209
url: /tr/aspose.slides.mathtext/imathdelimiterfactory/
---
## IMathDelimiterFactory sınıf

Eleman uygulayarak bir matematik sınırlayıcı oluşturur.
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [CreateMathDelimiter](./createmathdelimiter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Elemanı uygulayarak bir matematik sınırlayıcı oluşturur |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [CreateMathDelimiter](./createmathdelimiter/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\>) | Elemanı uygulayarak bir matematik sınırlayıcı oluşturur |
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# tarzı referans tip nesnelerini karşılaştırır. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# tarzı değer tip nesnelerini karşılaştırır. |
