...
description: Sıralı bir diziyi temsil eder.
type: docs
weight: 27
url: /tr/system.linq/iorderedenumerable/
---
## IOrderedEnumerable sınıf
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Koleksiyonun son const nitelikli elemanından hemen sonra işaret eden yineleyiciyi alır (varsa). |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Koleksiyonun son elemanından hemen sonra işaret eden yineleyiciyi alır (varsa). Bu yineleyici, [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) bir T kopya-nesnesi döndürdüğü için başvurulan nesneyi değiştirmek için kullanılamaz. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Koleksiyonun const nitelikli örneğinin son elemanından hemen sonra işaret eden yineleyiciyi alır (varsa). |
...
| [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Enumeratörü alır. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Dizinin ilk elemanını döndürür; dizi boşsa varsayılan bir değer döndürür. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[System::Linq::IGrouping](../igrouping/)\<Key, T\>\>\>\> [LINQ_GroupBy](../../system.collections.generic/ienumerable/linq_groupby/)([System::Func](../../system/func/)\<T, Key\>) | Bir dizinin elemanlarını gruplayarak toplar. |
| [System::SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[System::Linq::IGrouping](../igrouping/)\<Key, Element\>\>\>\> [LINQ_GroupBy](../../system.collections.generic/ienumerable/linq_groupby/)([System::Func](../../system/func/)\<T, Key\>, [System::Func](../../system/func/)\<T, Element\>) | Bir dizinin elemanlarını gruplayarak toplar. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Dizinin son elemanını döndürür; dizi boşsa varsayılan bir değer döndürür. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](./)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector tarafından seçilen anahtar değerlerine göre bir dizinin elemanlarını artan sırada sıralar. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](./)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | keySelector tarafından seçilen anahtar değerlerine göre bir dizinin elemanlarını azalan sırada sıralar. |
...
| [SharedPtr](../../system/sharedptr/)\<[IOrderedEnumerable](./)\<T\>\> [LINQ_ThenBy](./linq_thenby/)(const [Func](../../system/func/)\<T, Key\>\&) | Bir dizinin elemanlarını bir anahtara göre artan şekilde sonraki bir sıralamaya tabi tutar. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya üreticisi. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya üretimini sağlar. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını bir weak pointer (shared değil) olarak ayarlar. Kapsayıcılardaki pointerleri weak moda geçişine izin verir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidi açma işlevini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) koruyucu nesnesini kullanın. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Weak referans sayacını artırır. Doğrudan çağrılmamalıdır; bunun yerine akıllı pointerlar veya ThisProtector kullanılmalıdır. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Weak referans sayacını azaltır. Doğrudan çağrılmamalıdır; bunun yerine akıllı pointerlar veya ThisProtector kullanılmalıdır. |
