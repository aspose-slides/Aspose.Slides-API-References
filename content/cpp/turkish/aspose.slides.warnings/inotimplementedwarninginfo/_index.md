...
---
## INotImplementedWarningInfo sınıf


Yakın gelecekte uygulanmayacak bilinen uygulanmamış bir özellik hakkında uyarıyı temsil eder.
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Bu uyarının insan tarafından okunabilir bir tanımını döndürür. Salt okunur [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | Uyarının tipini döndürür. Salt okunur [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Alıcı null değilse, uyarıyı belirtilen alıcıya sonlandırır ve alıcı bir işlemi iptal etme kararı verirse AbortRequestedException fırlatır. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını bir zayıf işaretçi (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki işaretçilerin zayıf moda geçişine izin verir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit çözmesini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) koruma nesnesini kullanın. |
