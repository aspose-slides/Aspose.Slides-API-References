...
description: Yakın gelecekte çözülemeyecek bilinen bir sorun hakkında uyarı temsil eder.
type: docs
weight: 1
url: /tr/aspose.slides.warnings/iknownissuewarninginfo/
---
## IKnownIssueWarningInfo sınıfı

Yakın gelecekte düzeltilmeyecek bilinen bir sorun hakkında uyarı temsil eder.
...
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | Bu uyarının insan tarafından okunabilir bir açıklamasını döndürür. Salt okunur [System::String](../../system/string/). |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Alıcı null değilse uyarıyı belirtilen alıcıya sonlandırır ve alıcı bir işlemi iptal etmeye karar verirse AbortRequestedException istisnasını fırlatır. |
