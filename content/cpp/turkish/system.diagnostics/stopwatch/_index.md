...
description: "Zaman ölçümüne izin verir. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak tahsis edilmelidir. Bu tipin bir örneğini yığın üzerinde veya operator new ile oluşturmayın, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 79
url: /tr/system.diagnostics/stopwatch/
---
## Stopwatch class

Zaman ölçümüne olanak tanır. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak tahsis edilmelidir. Bu tür bir örnek asla yığıt üzerine ya da new operatörü ile oluşturulmamalıdır, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına neden olur. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| [TimeSpan](../../system/timespan/) [get_Elapsed](./get_elapsed/)() const | Geçerli örnek tarafından ölçülen toplam geçen süreyi alır. |
| **int64_t** [get_ElapsedMilliseconds](./get_elapsedmilliseconds/)() const | Geçerli örnek tarafından ölçülen toplam geçen süreyi milisaniye cinsinden alır. |
| **int64_t** [get_ElapsedTicks](./get_elapsedticks/)() const | Geçerli örnek tarafından ölçülen toplam geçen süreyi zamanlayıcı tikleri cinsinden alır. |
| **bool** [get_IsRunning](./get_isrunning/)() const | Kronometrenin çalışıp çalışmadığını kontrol eder. |
...
| void [Reset](./reset/)() | Zaman ölçümünü durdurur, ölçülen aralığı sıfıra ayarlar. |
| void [Restart](./restart/)() | Ölçülen aralığı sıfıra ayarlar, ardından zaman ölçümüne başlar. |
...
| void [Start](./start/)() | Zaman ölçümüne başlar. |
| static [SharedPtr](../../system/sharedptr/)\<[Stopwatch](./)\> [StartNew](./startnew/)() | Yeni [Stopwatch](./) nesnesi oluşturur ve ölçümü başlatır. |
| void [Stop](./stop/)() | Zaman ölçümünü durdurur. |
