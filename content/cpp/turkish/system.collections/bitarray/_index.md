...
description: "İndeks ile adreslenebilen bitlerden oluşan dizi. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak allocate edilmelidir. Bu tipin örneğini yığında (stack) veya operator new kullanarak oluşturmayın, çünkü çalışma zamanı hatalarına ve/veya assertion hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirmek için kullanın."
type: docs
weight: 1
url: /tr/system.collections/bitarray/
---
## BitArray sınıfı

[Array](../../system/array/) indeksle erişilebilen bitlerden oluşur. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) fonksiyonu kullanılarak allocate edilmelidir. Bu türün örneğini stack üzerinde ya da operator new kullanarak oluşturmayın, çünkü çalışma zamanı hatalarına ve/veya assertion hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| Metod | Açıklama |
| --- | --- |
| void [Add](./add/)(const **bool**\&) override | Konteynerin sonuna değeri ekler. |
| [BitArrayPtr](../bitarrayptr/) [And](./and/)(const [BitArrayPtr](../bitarrayptr/)\&) | İki BitSet arasında bit seviyesinde 'and' işlemini hesaplar. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Koleksiyonun (varsa) ilk elemanına işaret eden iteratorı alır. Bu iterator, [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) T'nin bir kopya nesnesi döndürdüğü için referans verilen nesneyi değiştirmek için kullanılamaz. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Koleksiyonun const nitelikli örneğinin (varsa) ilk elemanına işaret eden iteratorı alır. |
| [BitArray](./bitarray/)(const [bitset](./bitset/)\&) | Kopya kurucu. |
| [BitArray](./bitarray/)(const [BitArray](./)\&) | Kopya kurucu. |
| [BitArray](./bitarray/)(const [BitArrayPtr](../bitarrayptr/)\&) | Kopya kurucu. |
| [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**bool**\>\&) | Kopya kurucu. |
| [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Kopya kurucu. |
| [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<int\>\&) | Kopya kurucu. |
| [BitArray](./bitarray/)(int, **bool**) | Doldurma kurucusu. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Koleksiyonun (varsa) ilk const nitelikli elemanına işaret eden iteratorı alır. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Koleksiyonun (varsa) son const nitelikli elemanından hemen sonra işaret eden iteratorı alır. |
| void [Clear](./clear/)() override | Tüm elemanları siler. |
| **bool** [Contains](./contains/)(const **bool**\&) const override | Konteynerde belirli bir değerin bulunup bulunmadığını denetler. Uygulanmadı. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<**bool**\>, int) override | Mevcut dizi elemanlarına verileri kopyalar. |
| [bitset](./bitset/)\& [data](./data/)() | Temel veri yapısına erişim. |
| const [bitset](./bitset/)\& [data](./data/)() const | Temel veri yapısına erişim. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Koleksiyonun (varsa) son elemanından hemen sonra işaret eden iteratorı alır. Bu iterator, [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) T'nin bir kopya nesnesi döndürdüğü için referans verilen nesneyi değiştirmek için kullanılamaz. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Koleksiyonun const nitelikli örneğinin (varsa) son elemanından hemen sonra işaret eden iteratorı alır. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 standardına göre NaN'ların hiçbir değere eşit olmamasına rağmen, C# tarzı iki NaN'ın eşit kabul edildiği kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 standardına göre NaN'ların hiçbir değere eşit olmamasına rağmen, C# tarzı iki NaN'ın eşit kabul edildiği kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **bool** [Get](./get/)(int) const | [BitArray](./) elemanını alır. |
| int [get_Count](./get_count/)() const override | Konteyner boyutunu alır. |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | Koleksiyonun yalnızca okunur olup olmadığını denetler. |
| int [get_Length](./get_length/)() const | Konteyner boyutunu alır. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<**bool**\>\> [GetEnumerator](./getenumerator/)() override | Enumerator nesnesi oluşturur. |
...
| **bool** [idx_get](./idx_get/)(int) const | Alıcı fonksiyon. |
| void [idx_set](./idx_set/)(int, **bool**) | Ayarlayıcı fonksiyon. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Dizi içindeki eleman sayısını döndürür (doğrudan sayma ile hesaplanır). |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Koşulu sağlayan dizinin ilk elemanını veya böyle bir eleman bulunamazsa varsayılan değeri döndürür. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her elemanına bir dönüşüm fonksiyonu uygular ve elde edilen maksimum değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her elemanına bir dönüşüm fonksiyonu uygular ve elde edilen minimum değeri döndürür. |
...
| [BitArrayPtr](../bitarrayptr/) [Not](./not/)() | BitSet'i olumsuzlar. |
| [Object](../../system/object/object/)() | Nesne oluşturur. Tüm iç veri yapılarını başlatır. |
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucu. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya kurulmasını sağlar. |
| **bool** [operator!=](./operator_not_equal/)(const [BitArray](./)\&) const | Bit düzeyinde karşılaştırma operatörü. |
...
| **bool** [operator==](./operator_equal_equal/)(const [BitArray](./)\&) const | Bit düzeyinde karşılaştırma operatörü. |
| **Reference** [operator[]](./operator[]/)(int) | Erişimci fonksiyon. |
| [BitArrayPtr](../bitarrayptr/) [Or](./or/)(const [BitArrayPtr](../bitarrayptr/)\&) | İki BitSet arasında bit düzeyinde 'or' işlemini hesaplar. |
...
| **bool** [Remove](./remove/)(const **bool**\&) override | Belirtilen değerin ilk oluşumunu döndürür. Uygulanmadı. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| void [Set](./set/)(int, **bool**) | [BitArray](./) elemanını ayarlar. |
| void [SetAll](./setall/)(**bool**) | Tüm elemanları belirli bir değere ayarlar. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Zayıf şablon argümanları mekanizmasının resmi uygulaması; bu sınıfa uygulanamaz. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açmasını uygular. Doğrudan çağırın ya da [LockContext](../../system/lockcontext/) koruma nesnesini kullanın. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Geçerli konteyner için begin const iteratorun uygulamasını alır. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Geçerli konteyner için begin iteratorun uygulamasını alır. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Geçerli konteyner için end const iteratorun uygulamasını alır. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Geçerli konteyner için end iteratorun uygulamasını alır. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zayıf referans sayacını artırır. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler veya ThisProtector kullanılmalıdır. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zayıf referans sayacını azaltır. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler veya ThisProtector kullanılmalıdır. |
| [BitArrayPtr](../bitarrayptr/) [Xor](./xor/)(const [BitArrayPtr](../bitarrayptr/)\&) | İki BitSet arasında bit düzeyinde 'xor' işlemini hesaplar. |
