...
description: IEnumerable, yineleme yapılabilen tüm generic olmayan koleksiyonlar için temel arayüzdür.
type: docs
weight: 53
url: /tr/system.collections/ienumerable/
---
## IEnumerable sınıfı

[IEnumerable](./) yalnızca yineleme yapılabilen tüm generic olmayan koleksiyonlar için temel arayüzdür.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | Bir koleksiyon üzerinde yineleme yapan bir enumeratör döndürür. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir işaretçi (paylaşılmış yerine) olarak ayarlar. Kaplardaki işaretçilerin zayıf moda geçmesini sağlar. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit kaldırma işlevini uygular. Doğrudan çağırın ya da [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
