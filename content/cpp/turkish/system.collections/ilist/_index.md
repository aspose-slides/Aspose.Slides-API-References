...
description: IList, indeks ile bireysel olarak erişilebilen nesnelerin jeneriksiz bir koleksiyonunu temsil eder.
type: docs
weight: 118
url: /tr/system.collections/ilist/
---
## IList sınıfı


[IList](./) Nesnelerin bireysel olarak indeks ile erişilebilen jeneriksiz bir koleksiyonunu temsil eder.
...
| Metod | Açıklama |
| --- | --- |
| virtual int [Add](./add/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Listenin sonuna öğe ekler. |
| virtual void [Clear](./clear/)() | Listedeki tüm öğeleri kaldırır. |
| virtual **bool** [Contains](./contains/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Öğenin listede olup olmadığını denetler. |
...
| virtual **bool** [get_IsFixedSize](./get_isfixedsize/)() const | Listenin sabit boyuta sahip olup olmadığını gösteren bir değer alır. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](../ienumerable/getenumerator/)() | Bir koleksiyon üzerinde yineleme yapan bir enumeratör döndürür. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [idx_get](./idx_get/)(int, int) const | Belirtilen indeksteki öğeyi alır. |
| virtual int [IndexOf](./indexof/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) const | Belirtilen öğenin ilk indeksini alır. |
| virtual void [Insert](./insert/)(int, [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Ögeyi belirtilen indekste listeye ekler. |
...
| virtual void [Remove](./remove/)([SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Belirtilen öğenin listedeki ilk örneğini kaldırır. |
| virtual void [RemoveAt](./removeat/)(int) | Belirtilen indekste listedeki öğeyi kaldırır. |
