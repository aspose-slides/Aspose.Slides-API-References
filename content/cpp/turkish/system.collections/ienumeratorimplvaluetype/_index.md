...
description: Jenerik olmayan IEnumerator uygulamasını, jenerik Iterator IEnumeratorImplRefType üzerine oluşturan sarmalayıcı - değer tipleri için sarmalayıcı.
type: docs
weight: 92
url: /tr/system.collections/ienumeratorimplvaluetype/
---
## IEnumeratorImplValueType sınıf

Genel Iterator [IEnumeratorImplRefType](../ienumeratorimplreftype/) üzerine jenerik olmayan [IEnumerator](../ienumerator/) uygulamasını oluşturan sarmalayıcı - değer tipleri için sarmalayıcı.
...
| Yöntem | Açıklama |
| --- | --- |
| virtual const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\& [Current](../ienumerator/current/)() const | Geçerli öğeyi alır. |
...
| const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\& [get_Current](./get_current/)() const override | Geçerli öğeyi alır. |
...
|  [IEnumeratorImplValueType](./ienumeratorimplvaluetype/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\>) | sarmalayıcı yapıcı |
...
| **bool** [MoveNext](./movenext/)() override | İteratörü bir sonraki öğeye taşır. Daha önce bir öğe referans edilmemişse, mevcut öğeyi ilk erişilebilir öğeye ayarlar. Kapsayıcı sonuna gelinirse, hiçbir şey yapmaz. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Belirtilen değer kadar paylaşılan referans sayacını azaltır. |
| virtual void [Reset](../ienumerator/reset/)() | İteratörü ilk öğeden önceki konuma sıfırlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşımlı yerine) olarak ayarlar. Kapsayıcılarda işaretçileri zayıf moda geçişe izin verir. |
