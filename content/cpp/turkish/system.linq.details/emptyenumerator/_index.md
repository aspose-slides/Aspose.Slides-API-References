...
description: Boş bir genel koleksiyon için IEnumerator arayüzünü uygular.
type: docs
weight: 27
url: /tr/system.linq.details/emptyenumerator/
---
## EmptyEnumerator sınıfı
...
| Yöntem | Açıklama |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | İteratörü VirtualizedIterator sınıfı tarafından kullanılmak üzere hazırlar. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C# tarzı çift nokta kayan karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const override | Mevcut öğeyi alır. |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | İteratörü bir adım ileri taşır. |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | İlk [MoveNext()](../../system.collections.generic/ienumerator/movenext/) çağrısını yapar ve enumeratör nesnesini VirtualizedIterator tarafından kullanılmak üzere hazırlar. |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | Virtualized iterator tarafından sahip olunan enumeratörü işaretler. |
...
| **bool** [MoveNext](./movenext/)() override | Enumeratörü bir sonraki öğeye taşır. Daha önce herhangi bir öğe referans edilmemişse, referansı mevcut ilk öğeye ayarlar. Kapsayıcının sonuna gelinirse, hiçbir şey yapmaz. |
|  [Object](../../system/object/object/)() | Nesneyi oluşturur. Tüm dahili veri yapılarını başlatır. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Aslında bir şey kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapıcı olmasını sağlar. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Aslında bir şey kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapıcı olmasını sağlar. |
...
| void [Reset](./reset/)() override | Enumeratörü ilk öğe öncesi konuma sıfırlar. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açma işlemini uygular. Direk çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
