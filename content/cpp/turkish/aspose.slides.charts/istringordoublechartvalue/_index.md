...
description: "pptx sunum belgesinde iki şekilde saklanabilen string veya double değerini temsil eder: 1) grafiğe ilişkin çalışma kitabının hücre/hücrelerinde; 2) literal değer olarak."
type: docs
weight: 1210
url: /tr/aspose.slides.charts/istringordoublechartvalue/
---
## IStringOrDoubleChartValue sınıfı


Pptx sunum belgesinde iki şekilde saklanabilen string veya double değerini temsil eder: 1) grafikle ilişkili çalışma kitabının hücre/hucrelerinde; 2) doğrudan değer olarak.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# stilinde kayan nokta karşılaştırmasını taklit eder; iki NaN eşit kabul edilir, ancak IEC 60559:1989 standardına göre NaN hiçbir değere eşit değildir, NaN dahil. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# stilinde kayan nokta karşılaştırmasını taklit eder; iki NaN eşit kabul edilir, ancak IEC 60559:1989 standardına göre NaN hiçbir değere eşit değildir, NaN dahil. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](../isinglecellchartvalue/get_ascell/)() | Grafik veri hücresini döndürür. Oku [IChartDataCell](../ichartdatacell/). |
| virtual **double** [get_AsLiteralDouble](./get_asliteraldouble/)() | DataSourceType özelliği [DataSourceType::DoubleLiterals](../datasourcetype/) ise literal double değerini döndürür. Oku **double**. |
| virtual [System::String](../../system/string/) [get_AsLiteralString](./get_asliteralstring/)() | DataSourceType özelliği [DataSourceType::StringLiterals](../datasourcetype/) ise literal string değerini döndürür. Oku [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](../ibasechartvalue/get_data/)() |  |
| virtual [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../ibasechartvalue/get_datasourcetype/)() | AsCell, AsLiteralString veya AsLiteralDouble özelliğinin hangisinin geçerli olduğunu belirtir. Başka bir deyişle Data özelliğinin değer tipini belirtir. Bu özellik yalnızca okunabilir. Bu özelliğin değerini değiştirmek için ChartDataPointCollection.DataSourceTypeFor<...> özelliklerinden birini kullanabilirsiniz. Oku [DataSourceType](../datasourcetype/). |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucusu. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya oluşturmalarını etkinleştirir. |
...
| virtual void [set_AsCell](../isinglecellchartvalue/set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Grafik veri hücresini ayarlar. Yaz [IChartDataCell](../ichartdatacell/). |
| virtual void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) | DataSourceType özelliği [DataSourceType::DoubleLiterals](../datasourcetype/) ise literal double değerini ayarlar. Yaz **double**. |
| virtual void [set_AsLiteralString](./set_asliteralstring/)([System::String](../../system/string/)) | DataSourceType özelliği [DataSourceType::StringLiterals](../datasourcetype/) ise literal string değerini ayarlar. Yaz [System::String](../../system/string/). |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | AsCell, AsLiteralString veya AsLiteralDouble özelliğinin hangisinin geçerli olduğunu belirtir. Başka bir deyişle Data özelliğinin değer tipini belirtir. Bu özellik yalnızca okunabilir. Bu özelliğin değerini değiştirmek için ChartDataPointCollection.DataSourceTypeFor<...> özelliklerinden birini kullanabilirsiniz. Yaz [DataSourceType](../datasourcetype/). |
...
| virtual **double** [ToDouble](./todouble/)() | Değeri double'a dönüştürür. |
...
* Sınıf [ISingleCellChartValue](../isinglecellchartvalue/)
