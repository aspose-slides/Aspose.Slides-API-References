...
description: Satır ya da Hisse grafiğinin yukarı/aşağı çubuklarına erişim sağlar.
type: docs
weight: 1392
...
Satır veya Hisse grafiğinin yukarı/aşağı çubuklarına erişim sağlar.
...
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# biçiminde referans türündeki nesneleri karşılaştırır. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | C# biçiminde değer türündeki nesneleri karşılaştırır. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() override | DownBars biçimini döndürür. Yalnızca okunur [IFormat](../iformat/). |
| **int32_t** [get_GapWidth](./get_gapwidth/)() override | GapWidth. Oku **int32_t**. |
| **bool** [get_HasUpDownBars](./get_hasupdownbars/)() override | HasUpDownBars. Oku **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() override | UpBars biçimini döndürür. Yalnızca okunur [IFormat](../iformat/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) metodunun analogu. Özel nesnelerin karma oluşturulmasını sağlar. |
...
| void [set_GapWidth](./set_gapwidth/)(**int32_t**) override | GapWidth. Yaz **int32_t**. |
| void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) override | HasUpDownBars. Yaz **bool**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'inci şablon argümanını zayıf işaretçi (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçişine izin verir. |
...
* Sınıf [IUpDownBarsManager](../iupdownbarsmanager/)
