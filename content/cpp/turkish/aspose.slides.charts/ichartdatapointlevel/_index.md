...
description: Veri nokta seviyesini temsil eder. Treemap ve Sunburst grafikleri için uygulanır.
type: docs
weight: 703
url: /tr/aspose.slides.charts/ichartdatapointlevel/
---
## IChartDataPointLevel sınıf

Veri nokta seviyesini temsil eder. Treemap ve Sunburst grafikleri için uygulanır.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Veri nokta seviyesinin biçimlendirme özelliklerini temsil eder. Okuyun [IFormat](../iformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | Veri nokta seviyesinin veri etiketini temsil eder. Treemap ve Sunburst seri tipleri için uygulanır. Salt okunur [IDataLabel](../idatalabel/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucu. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya inşasını sağlar. |
