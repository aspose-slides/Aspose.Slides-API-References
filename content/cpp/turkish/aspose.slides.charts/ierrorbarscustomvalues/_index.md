...
---
## IErrorBarsCustomValues sınıfı


Hata çubuğu değerlerini belirtir. Yalnızca Hata çubukları değer türü Custom olduğunda kullanılmalıdır.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN'in eşit kabul edildiği C#-style kayan nokta karşılaştırmasını, IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmamasına rağmen taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'in eşit kabul edildiği C#-style kayan nokta karşılaştırmasını, IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmamasına rağmen taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XMinus](./get_xminus/)() | Negatif yönde hata çubuğu değerini belirtir. Hata çubukları değer türü Custom ve ErrorBarsXFormat izin verildiğinde kullanılabilir. Diğer tüm durumlarda bu özellik null döndürür. Salt okunur [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_XPlus](./get_xplus/)() | Pozitif yönde hata çubuğu değerini belirtir. Hata çubukları değer türü Custom ve ErrorBarsXFormat izin verildiğinde kullanılabilir. Diğer tüm durumlarda bu özellik null döndürür. Salt okunur [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YMinus](./get_yminus/)() | Negatif yönde hata çubuğu değerini belirtir. Hata çubukları değer türü Custom ve ErrorBarsYFormat izin verildiğinde kullanılabilir. Diğer tüm durumlarda bu özellik null döndürür. Salt okunur [IDoubleChartValue](../idoublechartvalue/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDoubleChartValue](../idoublechartvalue/)\> [get_YPlus](./get_yplus/)() | Pozitif yönde hata çubuğu değerini belirtir. Hata çubukları değer türü Custom ve ErrorBarsYFormat izin verildiğinde kullanılabilir. Diğer tüm durumlarda bu özellik null döndürür. Salt okunur [IDoubleChartValue](../idoublechartvalue/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin targetType tarafından tanımlanan tipin bir örneği olup olmadığını denetler. C# 'is' operatörünün bir analoğu. |
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitleme işlevini uygular. Doğrudan çağırın ya da [LockContext](../../system/lockcontext/) koruma nesnesini kullanın. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) metodunun bir analoğu. Özel tiplerin klonlanmasını sağlar. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) metodunun bir analoğu. Özel nesnelerin stringe dönüştürülmesini sağlar. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | C# typeof([System.Object](../../system/object/)) yapısını uygular. |
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açma işlevini uygular. Doğrudan çağırın ya da [LockContext](../../system/lockcontext/) koruma nesnesini kullanın. |
