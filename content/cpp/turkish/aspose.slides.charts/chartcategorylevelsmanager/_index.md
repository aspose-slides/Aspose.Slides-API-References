...
description: Grafik kategori seviyelerinin değerlerini yöneten kapsayıcı.
type: docs
weight: 92
url: /tr/aspose.slides.charts/chartcategorylevelsmanager/
---
## ChartCategoryLevelsManager sınıfı
...
| Metot | Açıklama |
| --- | --- |
| void [DeleteGroupingItem](./deletegroupingitem/)(**int32_t**) override | Tanımlı seviye için gruplama öğesini sil. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) override | Tanımlı seviye için [IChartDataCell](../ichartdatacell/) nesnesini döndürür. |
...
| void [SetGroupingItem](./setgroupingitem/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Tanımlı seviye için gruplama öğesini ayarlar. |
...
* Sınıf [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)
