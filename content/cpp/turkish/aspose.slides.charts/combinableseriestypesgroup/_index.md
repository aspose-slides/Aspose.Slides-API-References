...
description: "Birleştirilebilir seri tiplerinin gruplarının enum'ı. Her öğe, bir ChartSeriesGroup içinde aynı anda var olabilen grafik serileri türleri grubuna ilişkilidir. Örneğin: ChartType::PercentsStackedArea serileri, bir ChartSeriesGroup içinde ChartType::StackedArea serileriyle aynı anda bulunamaz. Ancak iki veya daha fazla ChartType::PercentsStackedArea bir ChartSeriesGroup içinde aynı anda bulunabilir (CombinableSeriesTypesGroup::AreaChart_PercentsStackedArea). Ve ChartType::Line serileri, ChartType::LineWithMarkers serileriyle aynı anda bir CombinableSeriesTypesGroup::LineChart_LineChartSeriesGroup içinde bulunabilir."
type: docs
weight: 1496
...
Birleştirilebilir seri tiplerinin gruplarının enum'ı. Her öğe, bir [ChartSeriesGroup](../chartseriesgroup/) içinde aynı anda var olabilen grafik serileri türleri grubuna ilişkilidir. Örneğin: [ChartType::PercentsStackedArea](../charttype/) serileri, bir [ChartSeriesGroup](../chartseriesgroup/) içinde [ChartType::StackedArea](../charttype/) serileriyle aynı anda bulunamaz. Ancak iki veya daha fazla [ChartType::PercentsStackedArea](../charttype/) aynı anda bir [ChartSeriesGroup](../chartseriesgroup/) içinde bulunabilir ([CombinableSeriesTypesGroup::AreaChart_PercentsStackedArea](./)). Ve [ChartType::Line](../charttype/) serileri, bir [CombinableSeriesTypesGroup::LineChart_Line](./)[ChartSeriesGroup](../chartseriesgroup/) içinde [ChartType::LineWithMarkers](../charttype/) serileriyle aynı anda bulunabilir.
