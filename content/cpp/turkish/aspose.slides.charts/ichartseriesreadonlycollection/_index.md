...
description: IChartSeries'in yalnızca okuma koleksiyonunu temsil eder.
type: docs
weight: 872
url: /tr/aspose.slides.charts/ichartseriesreadonlycollection/
---
## IChartSeriesReadonlyCollection sınıf

[IChartSeries](../ichartseries/)'nin yalnızca okuma koleksiyonunu temsil eder.
```cpp
...
| virtual **int32_t** [get_Count](../../aspose.slides/igenericcollection/get_count/)() | Koleksiyondaki davranış sayısını döndürür. Yalnızca-okunur **int32_t**. |
| virtual **bool** [get_IsSynchronized](../../aspose.slides/igenericcollection/get_issynchronized/)() | Koleksiyona erişimin senkronize (iş parçacığı güvenli) olup olmadığını belirten değeri döndürür. Yalnızca-okunur **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [idx_get](./idx_get/)(**int32_t**) | Belirtilen indeksdeki öğeyi alır. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Dizideki öğe sayısını döndürür (doğrudan sayım yoluyla). |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Bir koşulu sağlayan dizinin ilk öğesini döndürür; böyle bir öğe yoksa varsayılan değer döndürür. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine dönüşüm fonksiyonu uygulayıp en büyük sonucu döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine dönüşüm fonksiyonu uygulayıp en küçük sonucu döndürür. |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitlemeyi uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin string ve nullptr durumuna özgü özel bir versiyonu. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const&, [String](../../system/string/) const&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin string durumuna özgü özel bir versiyonu. |
