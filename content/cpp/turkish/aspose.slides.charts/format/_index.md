...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_Effect](./get_effect/)() override | Bir grafik için kullanılan efektleri döndürür. Salt okunur [IEffectFormat](../../aspose.slides/ieffectformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../../aspose.slides/ithreedformat/)\> [get_Effect3D](./get_effect3d/)() override | Bir grafiğin 3B biçimini döndürür. Salt okunur [IThreeDFormat](../../aspose.slides/ithreedformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_Fill](./get_fill/)() override | Bir grafiğin dolgu stili özelliklerini döndürür. Salt okunur [IFillFormat](../../aspose.slides/ifillformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_Line](./get_line/)() override | Bir grafiğin çizgi stili özelliklerini döndürür. Salt okunur [ILineFormat](../../aspose.slides/ilineformat/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterge (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki göstergeyi zayıf moda geçişine izin verir. |
