...
| **int32_t** [get_Count](./get_count/)() override | Lejant girdilerinin sayısını alır. Salt okunur **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILegendEntryProperties](../ilegendentryproperties/)\> [idx_get](./idx_get/)(**int32_t**) override | [Chart::get_ChartData()](../chart/get_chartdata/)->get_Series()[0].DataPoints[index] ifadesine karşılık gelen lejant girdisinin özelliklerini, şu grafik tiplerinden biri olduğunda alır: [ChartType::BarOfPie](../charttype/), [ChartType::ExplodedPie](../charttype/), [ChartType::ExplodedPie3D](../charttype/), [ChartType::Pie](../charttype/), [ChartType::Pie3D](../charttype/), [ChartType::PieOfPie](../charttype/); ya da diğer grafik tipleri için [Chart::get_ChartData()](../chart/get_chartdata/)->get_Series()[index] ifadesine karşılık geleni. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin targetType tarafından tanımlanan bir türün örneği olup olmadığını denetler. C# 'is' operatörünün analoğu. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan başvurunun sayacını belirtilen değer kadar azaltır. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon bağımsız değişkeni zayıf gösterici (shared yerine) olarak ayarlar. Kapsayıcılarda göstergelerin zayıf moda geçmesini sağlar. |
| int [SharedCount](../../system/object/sharedcount/)() const | Paylaşılan başvuru sayacının mevcut değerini alır. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Paylaşılan başvuru sayacını artırır. Doğrudan çağrılmamalıdır; bunun yerine akıllı göstergeler veya ThisProtector kullanılmalıdır. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Paylaşılan başvuru sayacını azaltır ve değerini döndürür. Doğrudan çağrılmamalıdır; bunun yerine akıllı göstergeler veya ThisProtector kullanılmalıdır. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zayıf başvuru sayacını artırır. Doğrudan çağrılmamalıdır; bunun yerine akıllı göstergeler veya ThisProtector kullanılmalıdır. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zayıf başvuru sayacını azaltır. Doğrudan çağrılmamalıdır; bunun yerine akıllı göstergeler veya ThisProtector kullanılmalıdır. |
| virtual  [~Object](../../system/object/~object/)() | Nesneyi yok eder. Tüm dahili veri yapılarını serbest bırakır. |
## İlgili

* Sınıf [ILegendEntryCollection](../ilegendentrycollection/)
