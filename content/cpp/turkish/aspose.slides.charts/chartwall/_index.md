...
description: 3B grafiklerdeki duvarları temsil eder.
type: docs
weight: 352
...
3B grafiklerde duvarları temsil eder.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'nin herhangi bir değere, NaN dahil, eşit olmadığı halde, iki NaN'nin eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'nin herhangi bir değere, NaN dahil, eşit olmadığı halde, iki NaN'nin eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Duvar dolgu, çizgi, efekt ve 3B stillerini döndürür. Yalnızca okuma [IFormat](../iformat/). |
| [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() override | Resim tipini döndürür veya ayarlar. Okur [Charts::PictureType](../picturetype/). |
| **int32_t** [get_Thickness](./get_thickness/)() override | Duvar kalınlığını, çizim hacminin en büyük boyutunun yüzdesi olarak döndürür. Okur **int32_t**. |
...
| void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) override | Resim tipini döndürür veya ayarlar. Yazar [Charts::PictureType](../picturetype/). |
| void [set_Thickness](./set_thickness/)(**int32_t**) override | Duvar kalınlığını çizim hacminin en büyük boyutunun yüzdesi olarak ayarlar. Yazar **int32_t**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'inci şablon argümanını **uint32_t** zayıf işaretçi (paylaşılan yerine) olarak ayarlar. Kaplardaki işaretçileri zayıf moda geçiş yapmayı sağlar. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açmasını uygular. Direkt olarak çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
