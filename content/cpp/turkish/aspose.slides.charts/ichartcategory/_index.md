...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() | [IChartDataCell](../ichartdatacell/) nesnesini döndürür. Kategori çok seviyeli ise seviye "0" için [IChartDataCell](../ichartdatacell/) nesnesi kullanılır. Oku [IChartDataCell](../ichartdatacell/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_AsLiteral](./get_asliteral/)() | UseCell false ise AsLiteral döndürür. Oku [System::Object](../../system/object/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_GroupingLevel](./get_groupinglevel/)(**int32_t**) | Belirtilen indeksdeki grafik kategori gruplama seviyesini döndürür. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategoryLevelsManager](../ichartcategorylevelsmanager/)\> [get_GroupingLevels](./get_groupinglevels/)() | Grafik kategori gruplama seviyelerinin değerlerinin yönetilen kapsayıcısı. Çok seviyeli kategori birden fazla gruplama seviyesi içerir. Gruplama seviyeleri indekslemesi sıfır tabanlıdır. Yalnızca-okunur [IChartCategoryLevelsManager](../ichartcategorylevelsmanager/). |
| virtual **bool** [get_UseCell](./get_usecell/)() | True ise AsCell özelliği geçerlidir. Başka bir deyişle, çalışma sayfası kategori depolamak için kullanılır (bu durumda çok seviyeli kategori desteklenir). False ise AsLiteral özelliği geçerlidir. Başka bir deyişle, çalışma sayfası kategori depolamak için KULLANILMAZ (ve bu durumda çok seviyeli kategori desteklenmez). Yalnızca-okunur **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() | UseCell true ise bu özellik [get_AsCell()](./get_ascell/)->get(set)_Value() özelliğini temsil eder. UseCell false ise bu özellik AsLiteral özelliğini temsil eder. Oku [System::Object](../../system/object/). |
...
| virtual void [Remove](./remove/)() | Kategoriyi grafikten kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Belirtilen değer kadar paylaşımlı referans sayacını azaltır. |
| virtual void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | [IChartDataCell](../ichartdatacell/) nesnesini ayarlar. Kategori çok seviyeli ise seviye "0" için [IChartDataCell](../ichartdatacell/) nesnesi kullanılır. Yaz [IChartDataCell](../ichartdatacell/). |
| virtual void [set_AsLiteral](./set_asliteral/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | UseCell false ise AsLiteral ayarlar. Yaz [System::Object](../../system/object/). |
| virtual void [set_Value](./set_value/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | UseCell true ise bu özellik [get_AsCell()](./get_ascell/)->get(set)_Value() özelliğini temsil eder. UseCell false ise bu özellik AsLiteral özelliğini temsil eder. Yaz [System::Object](../../system/object/). |
