...
description: Özel bir bölme ile bar-of-pie veya pie-of-pie grafiğinde ikinci pasta ya da çubukta çizilecek noktaların bir koleksiyonunu temsil eder.
type: docs
weight: 1158
url: /tr/aspose.slides.charts/ipiesplitcustompointcollection/
---
## IPieSplitCustomPointCollection sınıfı
...
| Metot | Açıklama |
| --- | --- |
| virtual void [Add](./add/)(const **int32_t**\&) | Veri noktasını ebeveyn serisi nokta koleksiyonundaki indeksine göre ekler. |
| virtual void [Add](../../system.collections.generic/icollection/add/)(const T\&) | Elemanı koleksiyona ekler. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Koleksiyondaki (varsa) son const nitelikli öğeden hemen sonra işaret eden yineleyiciyi alır. |
| virtual void [Clear](../../system.collections.generic/icollection/clear/)() | Koleksiyondaki tüm öğeleri siler. |
| virtual **bool** [Contains](../../system.collections.generic/icollection/contains/)(const T\&) const | Öğenin koleksiyonda var olup olmadığını kontrol eder. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Tüm koleksiyon öğelerini mevcut dizi öğelerine kopyalar. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Koleksiyondaki (varsa) son öğeden hemen sonra işaret eden yineleyiciyi alır. Bu yineleyici, [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) bir T kopya nesnesi döndürdüğü için başvurulan nesneyi değiştirmek için kullanılamaz. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Koleksiyonun const nitelikli örneğindeki (varsa) son öğeden hemen sonra işaret eden yineleyiciyi alır. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../../system.collections.generic/icollection/get_syncroot/)() const | Koleksiyonun senkronizasyon için kullanıldığı nesneyi alır. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) | İndexe göre grafik veri noktasını döndürür. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Bir koşulu sağlayan dizinin ilk öğesini, aksi takdirde bulunamazsa varsayılan bir değer döndürür. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüşüm fonksiyonu uygulayıp en büyük sonucu döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüşüm fonksiyonu uygulayıp en küçük sonucu döndürür. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Bir dizinin başlangıcından belirli sayıda ardışık öğeyi atlayıp geri kalanını döndürür. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucu. Gerçekte bir şey kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya oluşturmasını sağlar. |
...
| virtual void [Remove](./remove/)(**int32_t**) | Ebeveyn seri nokta koleksiyonundaki indeksine göre koleksiyondan öğeyi kaldırır. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir işaretçi (shared yerine) olarak ayarlar. Kapsayıcılardaki işaretçilerin zayıf moda geçmesini sağlar. |
