...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | Aşağı çubukların biçimini döndürür. Salt okunur [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | Boşluk genişliğini döndürür. **int32_t** okur. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | Grafiğin yukarı/aşağı çubuklara sahip olup olmadığını belirler. **bool** okur. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | Yukarı çubukların biçimini döndürür. Salt okunur [IFormat](../iformat/). |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | Boşluk genişliğini ayarlar. **int32_t** yazar. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | Grafiğin yukarı/aşağı çubuklara sahip olup olmadığını belirler. **bool** yazar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterge (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki göstergelerin zayıf moda geçişine izin verir. |
