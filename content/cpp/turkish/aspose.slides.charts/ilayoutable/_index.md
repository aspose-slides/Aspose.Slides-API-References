...
| virtual **float** [get_Bottom](./get_bottom/)() | Grafiğin yüksekliğinin bir kesri olarak grafik öğesinin üst kısmını alır. Yalnızca okunabilir **float**. |
...
| virtual **float** [get_Height](./get_height/)() | Grafiğin yüksekliğinin bir kesri olarak grafik öğesinin yüksekliğini belirtir. Okunur **float**. |
...
| virtual **float** [get_Right](./get_right/)() | Grafiğin genişliğinin bir kesri olarak grafik öğesinin sağını alır. Yalnızca okunabilir **float**. |
...
| virtual **float** [get_Width](./get_width/)() | Grafiğin genişliğinin bir kesri olarak grafik öğesinin genişliğini belirtir. Okunur **float**. |
| virtual **float** [get_X](./get_x/)() | Grafiğin genişliğinin bir kesri olarak grafik öğesinin x konumunu (sol) belirtir. Okunur **float**. |
| virtual **float** [get_Y](./get_y/)() | Grafiğin yüksekliğinin bir kesri olarak grafik öğesinin üst kısmını belirtir. Okunur **float**. |
...
| virtual void [set_Height](./set_height/)(**float**) | Grafiğin yüksekliğinin bir kesri olarak grafik öğesinin yüksekliğini belirtir. Yazılır **float**. |
| virtual void [set_Width](./set_width/)(**float**) | Grafiğin genişliğinin bir kesri olarak grafik öğesinin genişliğini belirtir. Yazılır **float**. |
| virtual void [set_X](./set_x/)(**float**) | Grafiğin genişliğinin bir kesri olarak grafik öğesinin x konumunu (sol) belirtir. Yazılır **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Grafiğin yüksekliğinin bir kesri olarak grafik öğesinin üst kısmını belirtir. Yazılır **float**. |
