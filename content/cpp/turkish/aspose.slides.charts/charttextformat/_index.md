...
| Metod | Açıklama |
| --- | --- |
| void [CopyFrom](./copyfrom/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) override | Belirtilen metin çerçevesinden metin biçimini kopyalar. |
| void [CopyTo](./copyto/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\>) override | Belirtilen metin çerçevesine metin biçimini kopyalar. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartParagraphFormat](../ichartparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() override | [ParagraphFormat](../../aspose.slides/paragraphformat/). Yalnızca okunur [IChartParagraphFormat](../ichartparagraphformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartPortionFormat](../ichartportionformat/)\> [get_PortionFormat](./get_portionformat/)() override | [PortionFormat](../../aspose.slides/portionformat/). Yalnızca okunur [IChartPortionFormat](../ichartportionformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartTextBlockFormat](../icharttextblockformat/)\> [get_TextBlockFormat](./get_textblockformat/)() override | TextBlockFormat. Yalnızca okunur [IChartTextBlockFormat](../icharttextblockformat/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşımlı yerine) olarak ayarlar. Kaplardaki işaretçilerin zayıf moda geçmesini sağlar. |
...
* Sınıf [IChartTextFormat](../icharttextformat/)
