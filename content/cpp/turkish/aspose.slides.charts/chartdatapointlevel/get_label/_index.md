...
description: Veri noktası seviyesinin veri etiketini temsil eder. Treemap ve Sunburst sereis tipleri için uygulanır. Salt okunur IDataLabel.
type: docs
weight: 14
url: /tr/aspose.slides.charts/chartdatapointlevel/get_label/
---
## ChartDataPointLevel::get_Label() metodu


Veri noktası seviyesinin veri etiketini temsil eder. Treemap ve Sunburst serileri için uygulanır. Salt okunur [IDataLabel](../../idatalabel/).
