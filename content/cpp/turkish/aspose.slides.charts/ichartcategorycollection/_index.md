...
description: IChartCategory koleksiyonunu temsil eder
type: docs
weight: 599
url: /tr/aspose.slides.charts/ichartcategorycollection/
---
## IChartCategoryCollection sınıf

[IChartCategory](../ichartcategory/) koleksiyonunu temsil eder
...
| Yöntem | Açıklama |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Eğer kategori koleksiyonda mevcutsa, onu döndürür. Aksi takdirde [IChartDataCell](../ichartdatacell/)'den yeni bir grafik kategorisi oluşturur ve koleksiyona ekler. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Değerden yeni bir [IChartCategory](../ichartcategory/) oluşturur ve koleksiyona ekler. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Koleksiyondaki (varsa) ilk öğeyi işaret eden yineleyiciyi alır. Bu yineleyici, [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) bir kopya nesnesi döndürdüğü için referans alınan nesneyi değiştirmek için kullanılamaz. |
...
| virtual **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() | Kullanılan kategori gruplama seviyelerinin sayısını döndürür. Çok seviyeli kategoriler için birden fazla olabilir. Salt okunur **int32_t**. |
...
| virtual **bool** [get_UseCells](./get_usecells/)() | Doğru ise çalışma sayfası kategorileri depolamak için kullanılır (bu durum çok seviyeli kategorileri destekler). Yanlış ise çalışma sayfası değerleri depolamak için KULLANILMAZ (ve bu durum çok seviyeli kategorileri desteklemez). **bool** okunur. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../../system.collections.generic/ienumerable/getenumerator/)() | Yineleteci alır. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) | Belirtilen indeksdeki öğeyi alır. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Belirtilen [IChartCategory](../ichartcategory/)'yi arar ve tüm Koleksiyon içinde ilk oluşumun sıfır tabanlı indeksini döndürür. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Giriş dizisinin her öğesi üzerinde bir dönüşüm fonksiyonu çalıştırılarak elde edilen değerlerin ortalamasını hesaplar. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Belirtilen değeri kaldırır. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Verilen indeksteki öğeyi kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Belirtilen değer kadar paylaşılan referans sayacını azaltır. |
| virtual void [set_UseCells](./set_usecells/)(**bool**) | Doğru ise çalışma sayfası kategorileri depolamak için kullanılır (bu durum çok seviyeli kategorileri destekler). Yanlış ise çalışma sayfası değerleri depolamak için KULLANILMAZ (ve bu durum çok seviyeli kategorileri desteklemez). **bool** yazılır. |
