...
description: Bir çertin işaretleyicisini temsil eder.
type: docs
weight: 1301
...
Bir çertin işaretleyicisini temsil eder.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmadığı halde, iki NaN'in eşit kabul edildiği C#-style kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmadığı halde, iki NaN'in eşit kabul edildiği C#-style kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | İşaretleyici dolgusunu alır. Salt okunur [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | Çizgi grafiği, dağılım grafiği veya radar grafiğinde işaretleyici boyutunu temsil eder. Salt okunur **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | Çizgi grafiği, dağılım grafiği veya radar grafiğinde işaretleyici stilini temsil eder. Salt okunur [MarkerStyleType](../markerstyletype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucu. Aslında hiçbir şeyi kopyalamaz, yalnızca yeni nesneyi başlatır ve alt sınıfların kopya oluşturmasını sağlar. |
...
| void [set_Size](./set_size/)(**int32_t**) override | Çizgi grafiği, dağılım grafiği veya radar grafiğinde işaretleyici boyutunu temsil eder. **int32_t** yazılır. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | Çizgi grafiği, dağılım grafiği veya radar grafiğinde işaretleyici stilini temsil eder. [MarkerStyleType](../markerstyletype/) yazılır. |
