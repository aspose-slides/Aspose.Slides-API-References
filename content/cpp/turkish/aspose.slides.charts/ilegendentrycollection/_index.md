...
| virtual **int32_t** [get_Count](./get_count/)() | Koleksiyonda gerçekte bulunan öğe sayısını alır. Yalnızca okuma **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILegendEntryProperties](../ilegendentryproperties/)\> [idx_get](./idx_get/)(**int32_t**) | Bu listedeki grafik tiplerinden biri olduğunda Chart.ChartData.Series[0].DataPoints[index] için ilgili gösterge girişinin özelliklerini alır: [ChartType::BarOfPie](../charttype/), [ChartType::ExplodedPie](../charttype/), [ChartType::ExplodedPie3D](../charttype/), [ChartType::Pie](../charttype/), [ChartType::Pie3D](../charttype/), [ChartType::PieOfPie](../charttype/); diğer grafik tiplerinde ise Chart.ChartData.Series[index] için ilgili gösterge girişinin özelliklerini alır. |
