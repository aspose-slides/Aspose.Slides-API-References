...
description: ChartSeries koleksiyonunu temsil eder
type: docs
weight: 287
url: /tr/aspose.slides.charts/chartseriescollection/
---
## ChartSeriesCollection sınıfı
...
| Method | Açıklama |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) override | Yeni bir grafik serisi oluşturur ve koleksiyona ekler. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) override | [ChartDataCell](../chartdatacell/) kaynağından yeni bir grafik serisi oluşturur ve koleksiyona ekler. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) override | [ChartCellCollection](../chartcellcollection/) kaynağından yeni bir grafik serisi oluşturur ve koleksiyona ekler. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) override | Değerden yeni bir grafik serisi oluşturur ve koleksiyona ekler. |
| [iterator](./iterator/) [begin](./begin/)() | Koleksiyondaki (varsa) ilk öğeyi gösteren bir yineleyici alır. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Koleksiyonun const-nitelikli örneğinde (varsa) ilk öğeyi gösteren bir yineleyici alır. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Koleksiyondaki (varsa) ilk const-nitelikli öğeyi gösteren bir yineleyici alır. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Koleksiyondaki (varsa) son const-nitelikli öğenin hemen sonrasını gösteren bir yineleyici alır. |
| void [Clear](./clear/)() override | Koleksiyondan tüm kontrolleri kaldırır. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>, **int32_t**) override | Koleksiyondaki tüm öğeleri belirtilen diziye kopyalar. |
| [iterator](./iterator/) [end](./end/)() | Koleksiyondaki (varsa) son öğenin hemen sonrasını gösteren bir yineleyici alır. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Koleksiyonun const-nitelikli örneğinde (varsa) son öğenin hemen sonrasını gösteren bir yineleyici alır. |
...
| **int32_t** [get_Count](./get_count/)() override | Koleksiyondaki nesne sayısını döndürür. Salt okunur **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Koleksiyona erişimin senkronize (iş parçacığı güvenli) olup olmadığını belirten bir değer döndürür. Salt okunur **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>\> [GetEnumerator](./getenumerator/)() override | Koleksiyon üzerinde yineleme yapan bir enumeratör döndürür. |
...
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Belirtilen [ChartSeries](../chartseries/) öğesini arar ve tüm Koleksiyon içinde ilk bulunuşun sıfır tabanlı indeksini döndürür. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) override | Yeni bir grafik serisi oluşturur ve koleksiyona ekler. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Bir dizideki herhangi bir öğenin var olup olmadığını veya bir koşulu sağladığını belirler. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Gen

el bir dizinin her öğesine dönüşüm fonksiyonu uygular ve ortaya çıkan maksimum değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Gen

el bir dizinin her öğesine dönüşüm fonksiyonu uygular ve ortaya çıkan minimum değeri döndürür. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucusu. Aslında hiçbir şey kopyalamaz; sadece yeni nesneyi başlatır ve alt sınıfların kopya oluşturmasını sağlar. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Belirtilen değeri kaldırır. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Koleksiyondan belirtilen konumda saklanan bir ActiveX denetimini kaldırır. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'inci şablon argümanını paylaşılan yerine zayıf bir işaretçi olarak ayarlar. Kapsayıcılardaki işaretçilerin zayıf moda geçmesini sağlar. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Koleksiyonun const-nitelikli örneğinde (varsa) ilk öğeyi gösteren bir yineleyici alır. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Koleksiyondaki (varsa) ilk öğeyi gösteren bir yineleyici alır. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Koleksiyonun const-nitelikli örneğinde (varsa) son öğenin hemen sonrasını gösteren bir yineleyici alır. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Koleksiyondaki (varsa) son öğenin hemen sonrasını gösteren bir yineleyici alır. |
...
* Sınıf [IChartSeriesCollection](../ichartseriescollection/)
