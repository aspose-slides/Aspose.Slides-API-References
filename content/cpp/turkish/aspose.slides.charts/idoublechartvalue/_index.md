...
description: "pptx sunum belgesinde iki şekilde saklanabilen çift (double) değeri temsil eder: 1) grafiğe bağlı çalışma kitabındaki hücre/hücrelerde; 2) doğrudan değer olarak."
type: docs
weight: 1002
url: /tr/aspose.slides.charts/idoublechartvalue/
---
## IDoubleChartValue sınıfı

pptx sunum belgesinde iki şekilde saklanabilen çift (double) değeri temsil eder: 1) grafiğe ilişkin çalışma kitabındaki hücre/ hücrelerde; 2) doğrudan değer olarak.
...
| virtual **double** [get_AsLiteralDouble](./get_asliteraldouble/)() | DataSourceType = [Charts::DataSourceType::DoubleLiterals](../datasourcetype/) ise doğrudan double değerini döndürür. Oku **double**. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) metodunun analoğu. Özel nesnelerin karmalaşmasını (hash) etkinleştirir. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin stringler için özelleştirilmiş hali. |
...
| virtual void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) | DataSourceType = [Charts::DataSourceType::DoubleLiterals](../datasourcetype/) ise doğrudan double değerini ayarlar. Yaz **double**. |
...
| virtual **double** [ToDouble](./todouble/)() | double'a dönüştürür. |
