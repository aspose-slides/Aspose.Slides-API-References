...
description: Bir grafiğin lejant özelliklerini temsil eder.
type: docs
weight: 1288
...
Bir grafiğin lejant özelliklerini temsil eder.
...
| **bool** [get_Hide](./get_hide/)() override | Lejant girişinin gizli olup olmadığını belirler. Okur **bool**. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'in string ve nullptr durumuna özel bir uygulanması. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'in string durumuna özel bir uygulanması. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| void [set_Hide](./set_hide/)(**bool**) override | Lejant girişinin gizli olup olmadığını belirler. **bool** yazar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf göstergeç olarak ayarlar (paylaşılan yerine). Kapsayıcılardaki göstergeçleri zayıf moda geçişe izin verir. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Paylaşılan referans sayacını azaltır ve geri döndürür. Doğrudan çağrılmamalıdır; bunun yerine akıllı göstergeçler veya ThisProtector kullanılmalıdır. |
...
* Sınıf [ILegendEntryProperties](../ilegendentryproperties/)
