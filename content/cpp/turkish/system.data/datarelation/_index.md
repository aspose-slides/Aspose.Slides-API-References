...
description: "Tablolar arasındaki ebeveyn-çocuk ilişkisini tanımlar. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tipin örneğini yığında ya da new operatörüyle oluşturmayın, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 27
url: /tr/system.data/datarelation/
---
## DataRelation sınıfı

Tables arasında ebeveyn-çocuk ilişkisini tanımlar. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak allocate edilmelidir. Bu tipin örneğini yığında ya da new operatörüyle oluşturmayın, aksi takdirde çalışma zamanı hataları ve/veya assertion hataları ortaya çıkar. Her zaman bu sınıfı [System::SmartPtr](../../system/smartptr/) işaretçisi içinde tutun ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN hiçbir değere eşit olmasa da iki NaN'ın eşit kabul edildiği C#-stilindeki kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN hiçbir değere eşit olmasa da iki NaN'ın eşit kabul edildiği C#-stilindeki kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Data::DataTable](../datatable/)\> [get_ChildTable](./get_childtable/)() | Alt tablo bilgisini alır. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Data::DataTable](../datatable/)\> [get_ParentTable](./get_parenttable/)() | RTTI bilgisi. |
