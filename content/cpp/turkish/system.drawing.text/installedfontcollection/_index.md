...
description: "Sistemde yüklü yazı tiplerinin koleksiyonunu temsil eder. HENÜZ UYGULANMAMIŞTIR. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak tahsis edilmelidir. Bu tipin örneğini yığına veya operator new ile oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına neden olur. Bu sınıfı her zaman System::SmartPtr göstergesine sarın ve bu göstergiyi işlevlere argüman olarak geçirin."
type: docs
weight: 14
url: /tr/system.drawing.text/installedfontcollection/
---
## InstalledFontCollection sınıf


Sistemde yüklü yazı tiplerinin koleksiyonunu temsil eder. NOT IMPLEMENTED. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak tahsis edilmelidir. Bu tipin örneğini yığına veya operator new kullanarak oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına neden olur. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) göstericisiyle sarmalayın ve bu göstericiyi fonksiyonlara argüman olarak geçirin.
...
| virtual [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[FontFamily](../../system.drawing/fontfamily/)\>\> [get_Families](../fontcollection/get_families/)() | Mevcut nesne tarafından temsil edilen yazı tipi koleksiyonu ile ilişkili [FontFamily](../../system.drawing/fontfamily/) nesnelerinin bir dizisini döndürür. |
...
|  [InstalledFontCollection](./installedfontcollection/)() | [InstalledFontCollection](./) sınıfının yeni bir örneğini oluşturur. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını paylaşılan yerine zayıf bir gösterici olarak ayarlar. Kapsayıcılardaki göstericilerin zayıf moda geçmesine izin verir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açma işlemini gerçekleştirir. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözetleme nesnesini kullanın. |
