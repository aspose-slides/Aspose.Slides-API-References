...
type: docs
weight: 14
url: /tr/aspose.slides.spreadsheet/details_cellinvalidformulaexception/
---
## Details_CellInvalidFormulaException sınıf
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Mevcut nesne tarafından temsil edilen istisna ile ilişkili bir HRESULT kodu olan 32 bit tam sayı değerini döndürür. |
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Geçersiz formülü içeren bir hücre referansı alır. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | [Object.GetHashCode()](../../system/object/gethashcode/) metodunun C# analogüdür. Özel nesnelerin karma oluşturmasını sağlar. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Nesnenin gerçek tipini alır. [System.Object.GetType()](../../system/object/gettype/) çağrısının C# analogüdür. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin, hedefTür tarafından tanımlanan tipin bir örneği olup olmadığını kontrol eder. C# 'is' operatörünün analogüdür. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | [Object.MemberwiseClone()](../../system/object/memberwiseclone/) metodunun C# analogüdür. Özel tiplerin klonlanmasını sağlar. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Belirli bir istisna için atanan kodlu sayısal bir değer olan HRESULT'i ayarlar. |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | Mevcut nesnenin dize temsilini döndürür. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | C# typeof([System.Object](../../system/object/)) yapısını uygular. |
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidi kaldırma kısmını uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözcü nesnesini kullanın. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Zayıf referans sayacını artırır. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler veya ThisProtector kullanılmalıdır. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zayıf referans sayacını azaltır. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler veya ThisProtector kullanılmalıdır. |
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) yöntemini uygular; bu yöntem [ExceptionWrapper](../../system/exceptionwrapper/) sınıfı tarafından çağrılır. Bu sınıf std::exception'dan türetilmemiş olsa da türetilen sınıflar korumalı/özel üyeleri kullanarak mantıklarını uygulayabilir. Bu yöntem uygulamasını [ExceptionWrapper](../../system/exceptionwrapper/)'ye taşımak bu mantığı bozabilir. |
| virtual  [~Object](../../system/object/~object/)() | Nesneyi yok eder. Tüm dahili veri yapılarını serbest bırakır. |

## Bakınız

* Sınıf [Details_PptxEditException](../../aspose.slides/details_pptxeditexception/)
* Ad alanı [Aspose::Slides::Spreadsheet](../)
