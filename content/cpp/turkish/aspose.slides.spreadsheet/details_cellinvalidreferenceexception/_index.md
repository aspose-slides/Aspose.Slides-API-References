...
description: Geçersiz bir hücre referansıyle karşılaşıldığında fırlatılan istisna.
type: docs
weight: 27
url: /tr/aspose.slides.spreadsheet/details_cellinvalidreferenceexception/
---
## Details_CellInvalidReferenceException sınıfı
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Geçersiz bir hücre referansını alır. |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | En içteki istisnayla temsil edilen Exception nesnesinin bir kopyasını döndürür. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin hedefTip tarafından tanımlanan bir örnek olup olmadığını kontrol eder. C# ‘is’ operatörünün analogudur. |
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitlemesini gerçekleştirir. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) koruyucu nesnesini kullanın. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Belirli bir istisna için atanmış kodlanmış sayısal değeri olan HRESULT’ı ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n-inci şablon argümanını zayıf işaretçi (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçirmeyi sağlar. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) metodunu uygular; bu metot [ExceptionWrapper](../../system/exceptionwrapper/) sınıfı tarafından çağrılır. Bu sınıf std::exception’tan türetilmediği halde korumalı/özel üyeler kullanılarak mantık uygulanabilir. Bu metodun [ExceptionWrapper](../../system/exceptionwrapper/)’ye taşınması bu mantığı bozabilir. |
