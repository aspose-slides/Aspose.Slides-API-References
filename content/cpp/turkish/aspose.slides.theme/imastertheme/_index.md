...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989 standardına göre NaN'ın herhangi bir değere, NaN dahil, eşit olmadığı gerçeğine rağmen, C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'ın eşit kabul edildiği, IEC 60559:1989 standardına göre NaN'ın herhangi bir değere, NaN dahil, eşit olmadığı gerçeğine rağmen, C# tarzı kayan nokta karşılaştırmasını taklit eder. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) | Belirtilen dizindeki ek renk şemasını döndürür. Bu şema sunumun görünümünü etkilemez, bir slayt için ana renk şeması olarak seçilebilir. Salt okunur [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() | Ek renk şemalarının koleksiyonunu döndürür. Bu şemalar sunumun görünümünü etkilemez, bir slayt için ana renk şeması olarak seçilebilir. Salt okunur [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
...
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Bir temanın adını döndürür. Okunur [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [GetEffective](../itheme/geteffective/)() | Kalıtım uygulanmış etkili tema verilerini alır. |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Bir temanın adını döndürür. Yaz [System::String](../../system/string/). |
