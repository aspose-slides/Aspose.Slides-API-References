...
description: Farklı türde geçersiz bırakılmış temalara erişim sağlayan sınıflar için temel sınıf.
type: docs
weight: 1
...
Farklı türde geçersiz bırakılmış temalara erişim sağlayan sınıflar için temel sınıf.
...
| Metot | Açıklama |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Bir slayta ek renk şeması uygular. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | Tema nesnesini döndürür. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | [OverrideTheme](../overridetheme/)'ın devralınan etkili temayı geçersiz kılıp kılmadığını belirler. [OverrideTheme](../overridetheme/)'ı geçersiz kılma için OverrideTheme.Init*() yöntemlerini kullanın. [OverrideTheme](../overridetheme/)'ın geçersiz kılmasını devre dışı bırakmak için [OverrideTheme::Clear](../overridetheme/clear/) yöntemini kullanın. Salt okunur **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Geçersiz kılan tema nesnesini döndürür. [IOverrideTheme](../ioverridetheme/)'ı okuyun. |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Geçersiz kılan tema nesnesini döndürür. [IOverrideTheme](../ioverridetheme/)'a yaz. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon bağımsız değişkeni zayıf bir işaretçi (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki işaretçilerin zayıf moda geçişine izin verir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilidini açma işlemini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) gözlem nesnesini kullanın. |
...
* Sınıf [IOverrideThemeManager](../ioverridethememanager/)
