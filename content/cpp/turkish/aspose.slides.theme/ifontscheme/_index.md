...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; IEC 60559:1989'a göre iki NaN eşit kabul edilir, ancak NaN herhangi bir değerle, NaN dahil, eşit değildir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; IEC 60559:1989'a göre iki NaN eşit kabul edilir, ancak NaN herhangi bir değerle, NaN dahil, eşit değildir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Sadece dahili amaçlar için. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Major](./get_major/)() | Slaytın "heading" kısmı için yazı tipi koleksiyonunu döndürür. Yalnızca okuma [IFonts](../../aspose.slides/ifonts/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFonts](../../aspose.slides/ifonts/)\> [get_Minor](./get_minor/)() | Slaytın "body" kısmı için yazı tipi koleksiyonunu döndürür. Yalnızca okuma [IFonts](../../aspose.slides/ifonts/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Yazı tipi şeması adını döndürür. Okunur [System::String](../../system/string/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucu. Gerçekte hiçbir şeyi kopyalamaz, yalnızca yeni nesneyi başlatır ve sınıf alt tiplerinin kopya oluşturulmasını sağlar. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Gerçekte hiçbir şeyi kopyalamaz, yalnızca yeni nesneyi başlatır ve sınıf alt tiplerinin kopya oluşturulmasını sağlar. |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | Yazı tipi şeması adını döndürür. [System::String](../../system/string/) yazar. |
