...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorScheme](../icolorscheme/)\> [get_ColorScheme](./get_colorscheme/)() override | Renk şemasını döndürür. Salt okunur [IColorScheme](../icolorscheme/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) override | Belirtilen dizindeki ek renk şemasını döndürür. Bu şema sunumun görünümünü etkilemez, bir slayt için ana renk şeması olarak seçilebilir. Salt okunur [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() override | Ek renk şemalarının koleksiyonunu döndürür. Bu şemalar sunumun görünümünü etkilemez, bir slayt için ana renk şeması olarak seçilebilirler. Salt okunur [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFontScheme](../ifontscheme/)\> [get_FontScheme](./get_fontscheme/)() override | Yazı tipi şemasını döndürür. Salt okunur [IFontScheme](../ifontscheme/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFormatScheme](../iformatscheme/)\> [get_FormatScheme](./get_formatscheme/)() override | Şekil biçimi şemasını döndürür. Salt okunur [IFormatScheme](../iformatscheme/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Bir temanın adını döndürür. Okunur [System::String](../../system/string/). |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | Üst [IPresentationComponent](../../aspose.slides/ipresentationcomponent/) öğesini döndürür. Salt okunur [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Bir temanın adını döndürür. Yaz [System::String](../../system/string/). |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit kaldırmasını uygular. Doğrudan çağırılabilir veya [LockContext](../../system/lockcontext/) gözetmen nesnesi kullanılabilir. |
...
* Sınıf [Theme](../theme/)
* Sınıf [IMasterTheme](../imastertheme/)
