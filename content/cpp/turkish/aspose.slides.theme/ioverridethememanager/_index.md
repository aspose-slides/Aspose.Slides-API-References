...
description: Farklı tiplerde geçersiz kılınmış temalara erişim sağlar.
type: docs
weight: 417
url: /tr/aspose.slides.theme/ioverridethememanager/
---
## IOverrideThemeManager sınıf

Farklı türlerde geçersiz kılınmış temalara erişim sağlar.
...
| Yöntem | Açıklama |
| --- | --- |
| virtual void [ApplyColorScheme](../ithememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) | Bir slayda ek renk şeması uygular. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stilinde, iki NaN'in eşit kabul edildiği (IEC 60559:1989'da NaN'in hiçbir değere, NaN dahil, eşit olmadığı belirtilse de) kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stilinde, iki NaN'in eşit kabul edildiği (IEC 60559:1989'da NaN'in hiçbir değere, NaN dahil, eşit olmadığı belirtilse de) kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() | [OverrideTheme](../overridetheme/)'nin kalıtsal etkili temayı geçersiz kılıp kılmadığını belirler. Geçersiz kılma için [OverrideTheme](../overridetheme/)'yi etkinleştirmek amacıyla OverrideTheme.Init*() yöntemlerini kullanın. [OverrideTheme](../overridetheme/)'nin geçersiz kılmasını devre dışı bırakmak için [get_OverrideTheme()](./get_overridetheme/)->Clear() yöntemini kullanın. Yalnızca okunur **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() | Geçersiz kılan tema nesnesini döndürür. [IOverrideTheme](../ioverridetheme/)'yi okuyun. |
...
| virtual void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) | Geçersiz kılan tema nesnesini döndürür. [IOverrideTheme](../ioverridetheme/) yazın. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit kaldırma işlemini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
