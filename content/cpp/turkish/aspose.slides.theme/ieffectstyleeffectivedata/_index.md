...
---
## IEffectStyleEffectiveData sınıfı

Değiştirilemez nesne, etkili efekt stil özelliklerini içerir.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormatEffectiveData](../../aspose.slides/ieffectformateffectivedata/)\> [get_EffectFormat](./get_effectformat/)() | Bir efekt formatı döndürür. Yalnızca okuma [IEffectFormatEffectiveData](../../aspose.slides/ieffectformateffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormatEffectiveData](../../aspose.slides/ithreedformateffectivedata/)\> [get_ThreeDFormat](./get_threedformat/)() | Bir 3d formatı döndürür. Yalnızca okuma [IThreeDFormatEffectiveData](../../aspose.slides/ithreedformateffectivedata/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) yönteminin analoğu. Özel nesnelerin karmalanmasını etkinleştirir. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n-inci şablon argümanını zayıf gösterici (paylaşılan yerine) ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçişine izin verir. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Paylaşılan referans sayacını azaltır ve sonucunu döndürür. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler veya ThisProtector kullanılmalıdır. |
...
Bu arabirim [IEffectStyleCollectionEffectiveData](../ieffectstylecollectioneffectivedata/) bölümünün bir parçası olarak kullanılır.
