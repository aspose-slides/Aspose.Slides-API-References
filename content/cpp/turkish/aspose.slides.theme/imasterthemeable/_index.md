...
| Yöntem | Açıklama |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../ithemeable/createthemeeffective/)() | Bu temalı nesne için etkili bir temayı döndürür. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'da NaN'in herhangi bir değere, NaN dahil, eşit olmadığına rağmen, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'da NaN'in herhangi bir değere, NaN dahil, eşit olmadığına rağmen, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterThemeManager](../imasterthememanager/)\> [get_ThemeManager](./get_thememanager/)() | Ana tema yöneticisini döndürür. Salt okunur [IMasterThemeManager](../imasterthememanager/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir gösterici (paylaşılan yerine) ayarlar. Kapsayıcılardaki göstericilerin zayıf moda geçmesini sağlar. |
