...
description: Not slayt teması üzerine yazmaya erişim sağlar.
type: docs
weight: 534
...
Not slayt teması üzerine yazma erişimi sağlar.
...
| Metot | Açıklama |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Bir slayta ek renk şeması uygular. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../baseoverridethememanager/createthemeeffective/)() override | Tema nesnesini döndürür. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN, IEC 60559:1989'a göre hiçbir değere eşit olmamasına rağmen, eşit sayılır. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN, IEC 60559:1989'a göre hiçbir değere eşit olmamasına rağmen, eşit sayılır. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Belirler [OverrideTheme](../overridetheme/)'in kalıtılan etkin temayı geçersiz kılıp kılmadığını. Geçersiz kılmayı etkinleştirmek için [OverrideTheme](../overridetheme/)'i OverrideTheme.Init*() yöntemleriyle kullanın. [OverrideTheme](../overridetheme/)'ın geçersiz kılmasını devre dışı bırakmak için [OverrideTheme::Clear](../overridetheme/clear/) yöntemini kullanın. Salt okunur **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | Geçersiz kılan tema nesnesini döndürür. Okunur [IOverrideTheme](../ioverridetheme/). |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Değer türü nesneyi nullptr ile referans üzerinden karşılaştırır. |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Geçersiz kılan tema nesnesini döndürür. [IOverrideTheme](../ioverridetheme/) yazın. |
