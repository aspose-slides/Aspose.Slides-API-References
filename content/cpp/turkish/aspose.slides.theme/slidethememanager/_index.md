...
description: Slayt teması geçersiz kılmaya erişim sağlar.
type: docs
weight: 560
url: /tr/aspose.slides.theme/slidethememanager/
---
## SlideThemeManager sınıf


Slayt teması geçersiz kılmaya erişim sağlar.
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | [OverrideTheme](../overridetheme/) geçersiz kılar mı belirler. [OverrideTheme](../overridetheme/)'yi geçersiz kılma için etkinleştirmek OverrideTheme.Init*() yöntemlerini kullanın. [OverrideTheme](../overridetheme/)'yi geçersiz kılmadan kaldırmak için [OverrideTheme::Clear](../overridetheme/clear/) yöntemini kullanın. Salt okunur **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | Geçersiz kılan tema nesnesini döndürür. [IOverrideTheme](../ioverridetheme/) oku. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | String durumları için [Object::ReferenceEquals](../../system/object/referenceequals/)'nin özelleştirmesi. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşılmış yerine) olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçişine izin verir. |
