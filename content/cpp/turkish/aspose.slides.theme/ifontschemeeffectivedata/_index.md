...
description: Etkili font şeması özelliklerini içeren değişmez nesne.
type: docs
weight: 287
url: /tr/aspose.slides.theme/ifontschemeeffectivedata/
---
## IFontSchemeEffectiveData sınıfı

Etkili font şeması özelliklerini içeren değişmez nesne.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'ın hiçbir değerle, NaN da dahil olmak üzere eşit olmamasına rağmen, iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'ın hiçbir değerle, NaN da dahil olmak üzere eşit olmamasına rağmen, iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Major](./get_major/)() | Slaydın "başlık" kısmı için font koleksiyonunu döndürür. Salt okunur [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Minor](./get_minor/)() | Slaydın "gövde" kısmı için font koleksiyonunu döndürür. Salt okunur [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Font şeması adını döndürür. Salt okunur [System::String](../../system/string/). |
...
Bu arayüz [IThemeEffectiveData](../ithemeeffectivedata/) içinde bir parça olarak kullanılır.
