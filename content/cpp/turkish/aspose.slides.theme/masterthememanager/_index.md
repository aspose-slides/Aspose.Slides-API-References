...
| Method | Description |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Bir slayta ekstra renk şeması uygular. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | [OverrideTheme](../overridetheme/)'in devralınan etkili temayı ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) geçersiz kılıp kılımladığını belirler. Okur **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Geçersiz kılan tema nesnesini döndürür. Okur [IMasterTheme](../imastertheme/). |
...
| void [set_IsOverrideThemeEnabled](./set_isoverridethemeenabled/)(**bool**) override | [OverrideTheme](../overridetheme/)'in devralınan etkili temayı ([Presentation::get_MasterTheme](../../aspose.slides/presentation/get_mastertheme/)) geçersiz kılıp kılımladığını belirler. Yazar **bool**. |
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterTheme](../imastertheme/)\>) override | Geçersiz kılan tema nesnesini döndürür. Yazar [IMasterTheme](../imastertheme/). |
...
* Sınıf [IMasterThemeManager](../imasterthememanager/)
