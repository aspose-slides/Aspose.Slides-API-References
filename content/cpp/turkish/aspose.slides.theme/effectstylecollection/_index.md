...
description: Etki stillerinden oluşan bir koleksiyonu temsil eder.
type: docs
weight: 66
...
Koleksiyonun etkili stil öğelerinden oluşan bir koleksiyonu temsil eder.
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Koleksiyonun (varsa) ilk const niteliğindeki elemanına işaret eden yineleyiciyi alır. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Koleksiyonun (varsa) son const niteliğindeki elemanından hemen sonrasına işaret eden yineleyiciyi alır. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\>\>, **int32_t**) override | Koleksiyondaki tüm elemanları belirtilen diziye kopyalar. |
...
| **int32_t** [get_Count](./get_count/)() override | Koleksiyondaki eleman sayısını döndürür. Salt-okunur **int32_t**, Salt-okunur **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Koleksiyona erişimin eşzamanlı (thread-safe) olup olmadığını gösteren bir değer döndürür. Salt-okunur **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\>\>\> [GetEnumerator](./getenumerator/)() override | Koleksiyon üzerinde yineleme yapan bir enumerator döndürür. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\> [idx_get](./idx_get/)(**int32_t**) override | Belirtilen konumdaki bir elemanı döndürür. Salt-okunur [EffectStyle](../effectstyle/). |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her elemanına bir dönüştürme fonksiyonu uygular ve elde edilen maksimum değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her elemanına bir dönüştürme fonksiyonu uygular ve elde edilen minimum değeri döndürür. |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_OfType](../../system.collections.generic/ienumerable/linq_oftype/)() | Dizi elemanlarını belirtilen tipe göre filtreler. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | n'inci şablon argümanını zayıf işaretçi (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki işaretçilerin zayıf moda geçmesini sağlar. |
...
* Sınıf [IEffectStyleCollection](../ieffectstylecollection/)
