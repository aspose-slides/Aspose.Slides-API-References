...
description: "Temel istisna sınıfı HttpClient ve HttpMessageHandler sınıfları tarafından atılır. Bu sınıfın örneklerini manuel olarak asla oluşturmayın. Bunun yerine HttpRequestException sınıfını kullanın. HttpRequestException sınıfı örneklerini System::SmartPtr içine asla sarmalamayın."
type: docs
weight: 14
url: /tr/system.net.http/details_httprequestexception/
---
## Details_HttpRequestException sınıf

Temel istisna sınıfı [HttpClient](../httpclient/) ve [HttpMessageHandler](../httpmessagehandler/) sınıfları tarafından atılır. Bu sınıfın örneklerini manuel olarak asla oluşturmayın. Bunun yerine HttpRequestException sınıfını kullanın. HttpRequestException sınıfı örneklerini [System::SmartPtr](../../system/smartptr/) içine asla sarmalamayın.
...
| Yöntem | Açıklama |
| --- | --- |
| [Details_HttpRequestException](./details_httprequestexception/)() | Yeni bir örnek oluşturur. |
| [Details_HttpRequestException](./details_httprequestexception/)(std::nullptr_t) | Yeni bir örnek oluşturur. |
| [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/)) | Yeni bir örnek oluşturur. |
| [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Yeni bir örnek oluşturur. |
| virtual void [DoThrow](../../system/details_exception/dothrow/)(const [ExceptionPtr](../../system/exceptionptr/)\&) const | İstisna sarmalayıcı tarafından sarılmış istisna örneğini fırlatır. |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) metodunun bir eşdeğeri. Özel nesnelerin hash'lenmesini sağlar. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) metodunun bir eşdeğeri. Özel tiplerin klonlanmasını sağlar. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Belirli bir istisna için atanmış kodlu sayısal değer olan HRESULT'i ayarlar. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Paylaşılan referans sayacını azaltır ve değeri döndürür. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler veya ThisProtector kullanılmalıdır. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | [what()](../../system/details_exception/what/) metodunu uygular; bu metod [ExceptionWrapper](../../system/exceptionwrapper/) sınıfı tarafından çağrılır. Bu sınıf std::exception'tan türetilmemiş olsa da türetilen sınıflar, mantıklarını uygulamak için korumalı/özel üyeleri kullanabilir. Bu metodun uygulamasını [ExceptionWrapper](../../system/exceptionwrapper/)'e taşıma, o mantığı bozabilir. |
...
* Sınıf [Details_Exception](../../system/details_exception/)
