...
description: "'Entity-Tag' başlığının bir değerini temsil eder. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tipin örneğini yığıt (stack) üzerinde veya new operatörüyle oluşturmaya çalışmayın; çünkü çalışma zamanı hataları ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 53
url: /tr/system.net.http.headers/entitytagheadervalue/
---
## EntityTagHeaderValue sınıfı
...
| Yöntem | Açıklama |
| --- | --- |
|  [EntityTagHeaderValue](./entitytagheadervalue/)([String](../../system/string/)) | Yeni bir örnek oluşturur. |
|  [EntityTagHeaderValue](./entitytagheadervalue/)([String](../../system/string/), **bool**) | Yeni bir örnek oluşturur. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Nesneleri C# [Object.Equals](../../system/object/equals/) sözdizimiyle karşılaştırır. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\> [get_Any](./get_any/)() | ‘ETag’ başlığının değerini alır. |
| **bool** [get_IsWeak](./get_isweak/)() | Mevcut örneğin zayıf bir doğrulayıcı olup olmadığını gösteren bir değer alır. |
| [String](../../system/string/) [get_Tag](./get_tag/)() | Bir EntityTagHeaderValue sınıfı örneğinin dize temsili alınır. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkili referans sayacı veri yapısını alır. |
| static **int32_t** [GetEntityTagLength](./getentitytaglength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\>\&) | Belirtilen indeksden verilen dizeyi [EntityTagHeaderValue](./) sınıfının bir örneğine dönüştürür. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Verilen dizeyi [EntityTagHeaderValue](./) sınıfının bir örneğine dönüştürür. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/) öğesinin dize ve nullptr durumuna özgü bir özelleştirmesidir. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/) öğesinin dize durumuna özgü bir özelleştirmesidir. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Belirtilen değer kadar paylaşılan referans sayacını azaltır. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını paylaşılan yerine zayıf bir işaretçiye ayarlar. Kapsayıcıdaki işaretçilerin zayıf moda geçmesini sağlar. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\>\&) | Verilen dizeyi [EntityTagHeaderValue](./) sınıfının bir örneğine dönüştürmeye çalışır. |
