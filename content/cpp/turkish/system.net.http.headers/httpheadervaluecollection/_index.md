...
description: "Başlık değerlerinin koleksiyonunu temsil eder. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tipin bir örneğini yığında veya new operatörüyle oluşturmaya çalışmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına neden olur. Bu sınıfı her zaman System::SmartPtr işaretçisine sarmalayın ve bu işaretçiyi işlevlere argüman olarak geçirin."
type: docs
weight: 92
url: /tr/system.net.http.headers/httpheadervaluecollection/
---
## HttpHeaderValueCollection sınıfı

Başlık değerlerinin koleksiyonunu temsil eder. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak ayrılmalıdır. Bu tipin bir örneğini yığında veya new operatörüyle oluşturmaya çalışmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına neden olur. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisiyle sarmalayın ve bu işaretçiyi işlevlere argüman olarak geçirin.
...
| Parametre | Açıklama |
| --- | --- |
| The | koleksiyonda temsil edilen başlık değerlerinin tipi. |

## Metotlar

| Metot | Açıklama |
| --- | --- |
| void [Add](./add/)(const T\&) override | Koleksiyona bir öğe ekler. |
...
| void [Clear](./clear/)() override | Koleksiyondaki tüm öğeleri siler. |
| **bool** [Contains](./contains/)(const T\&) const override | Öğenin koleksiyonda mevcut olup olmadığını kontrol eder. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) override | Tüm koleksiyon öğelerini mevcut dizi elemanlarına kopyalar. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Mevcut dizi elemanlarına tüm koleksiyon öğelerini kopyalar. |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'da NaN'in hiçbir değere, NaN dahil, eşit olmamasına rağmen iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Mevcut koleksiyonun yalnızca okunur olup olmadığını gösteren bir değer alır. |
...
| **bool** [get_IsSpecialValueSet](./get_isspecialvalueset/)() | Mevcut koleksiyonun bir "özel değer" içerip içermediğini gösteren bir değer alır. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Yineleyiciyi alır. |
...
| [String](../../system/string/) [GetHeaderStringWithoutSpecial](./getheaderstringwithoutspecial/)() | "özel değer" olmadan mevcut koleksiyonun string temsilini döndürür. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Nesnenin gerçek tipini alır. C# [System.Object.GetType()](../../system/object/gettype/) çağrısının benzeri. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>) | Yeni bir örnek oluşturur. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Yeni bir örnek oluşturur. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T) | Yeni bir örnek oluşturur. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Yeni bir örnek oluşturur. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüştürme işlevi çağırır ve en yüksek sonucu döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüştürme işlevi çağırır ve en düşük sonucu döndürür. |
...
|  [Object](../../system/object/object/)() | Nesne oluşturur. Tüm iç veri yapalarını başlatır. |
...
| void [ParseAdd](./parseadd/)([String](../../system/string/)) | Bir başlık dizesi temsilini ayrıştırır ve mevcut koleksiyona ekler. |
...
| **bool** [Remove](./remove/)(const T\&) override | Koleksiyondan öğeyi siler. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Paylaşılan referans sayacını belirtilen değer kadar azaltır. |
| void [RemoveSpecialValue](./removespecialvalue/)() | "özel değeri" kaldırır. |
| void [SetSpecialValue](./setspecialvalue/)() | "özel değeri" ayarlar. |
...
| **bool** [TryParseAdd](./tryparseadd/)([String](../../system/string/)) | Bir başlık dizesi temsilini ayrıştırmayı dener ve mevcut koleksiyona ekler. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Mevcut kapsayıcının const başlatıcı yineleyicisinin implementasyonunu alır. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginIterator](../../system.collections.generic/ienumerable/virtualizebeginiterator/)() | Mevcut kapsayıcının başlatıcı yineleyicisinin implementasyonunu alır. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Mevcut kapsayıcının const bitiş yineleyicisinin implementasyonunu alır. |
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndIterator](../../system.collections.generic/ienumerable/virtualizeenditerator/)() | Mevcut kapsayıcının bitiş yineleyicisinin implementasyonunu alır. |
