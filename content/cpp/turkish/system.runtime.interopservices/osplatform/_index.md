...
type: docs
weight: 53
url: /tr/system.runtime.interopservices/osplatform/
---
## OSPlatform sınıfı
...
| virtual **bool** [Equals](../../system/iequatable/equals/)(T) | Belirtilen nesnelerin mevcut nesne ile eşit olup olmadığını belirler. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 uyarınca NaN'in herhangi bir değerle, NaN dahil, eşit olmaması gerektiğine rağmen, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 uyarınca NaN'in herhangi bir değerle, NaN dahil, eşit olmaması gerektiğine rağmen, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
