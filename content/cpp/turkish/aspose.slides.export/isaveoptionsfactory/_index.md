...
description: Kaydetme seçeneklerinin örneklerini oluşturmaya izin verir
type: docs
weight: 365
url: /tr/aspose.slides.export/isaveoptionsfactory/
---
## ISaveOptionsFactory sınıf

Kaydetme seçeneklerinin örneklerini oluşturmaya izin verir
...
| Method | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPptxOptions](../ipptxoptions/)\> [CreatePptxOptions](./createpptxoptions/)() | PPTX kaydetme seçeneklerini oluşturur. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf bir işaretçiye (paylaşımlı yerine) ayarlar. Kaplarda işaretçileri zayıf moda geçişine izin verir. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Paylaşımlı referans sayacını decrement edip değerini döndürür. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler veya ThisProtector kullanılmalı. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Zayıf referans sayacını decrement eder. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçiler veya ThisProtector kullanılmalı. |
