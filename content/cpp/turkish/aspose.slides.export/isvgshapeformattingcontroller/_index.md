...
description: SVG şekil oluşturmasını kontrol eder.
type: docs
weight: 443
url: /tr/aspose.slides.export/isvgshapeformattingcontroller/
---
## ISvgShapeFormattingController sınıfı
...
| virtual void [FormatShape](./formatshape/)([System::SharedPtr](../../system/sharedptr/)\<[ISvgShape](../isvgshape/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Bu fonksiyon, şeklin SVG'ye render edilmesinden önce çağrılır ve kullanıcının oluşan SVG'yi kontrol etmesini sağlar. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Nesneyle ilişkilendirilmiş referans sayacı veri yapısını alır. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | C# [Object.GetHashCode()](../../system/object/gethashcode/) yönteminin benzeri. Özel nesnelerin hash oluşturmasını sağlar. |
