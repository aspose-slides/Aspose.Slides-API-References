...
description: Kaydetme sırasında nesnenin nasıl işleneceğini belirlemek için kullanılan geri çağırma arayüzü.
type: docs
weight: 248
...
Nesnenin kaydedilirken nasıl işleneceğini belirlemek için kullanılan geri çağırma arayüzü.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'ın hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'ın eşit kabul edildiği C#-style nokta sayı karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'ın hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'ın eşit kabul edildiği C#-style nokta sayı karşılaştırmasını taklit eder. |
...
| virtual [LinkEmbedDecision](../linkembeddecision/) [GetObjectStoringLocation](./getobjectstoringlocation/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) | Nesnenin nerede saklanması gerektiğini belirler. Bu yöntem, her nesne kimliği için bir kez çağrılır. Aynı veri, semanticName ve contentType'a sahip iki nesnenin farklı kimliklere sahip olamayacağı garantilenmez. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Nesnenin gerçek tipini alır. C# [System.Object.GetType()](../../system/object/gettype/) çağrısının benzeri. |
| virtual [System::String](../../system/string/) [GetUrl](./geturl/)(**int32_t**, **int32_t**) | Harici bir nesneye bir URL döndürür. Bu yöntem, [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/) [LinkEmbedDecision::Link](../linkembeddecision/) döndürdüğünde her zaman çağrılır ve [ILinkEmbedController::GetObjectStoringLocation](./getobjectstoringlocation/) [LinkEmbedDecision::Embed](../linkembeddecision/) döndürdüğünde ancak gömme mümkün olmadığında çağrılabilir. Aynı nesne kimliği için birden fazla kez çağrılabilir. |
...
| void [Lock](../../system/object/lock/)() | C# lock() deyiminin kilitleme işlevini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) koruma nesnesini kullanın. |
...
| virtual void [SaveExternal](./saveexternal/)(**int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Harici nesneyi kaydeder. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() deyiminin kilit açma işlevini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) koruma nesnesini kullanın. |
