...
description: WOFF formatında font gömmek için kullanılacak biçimlendirme denetleyici sınıfı
type: docs
weight: 27
url: /tr/aspose.slides.export/embeddedwofffontshtmlcontroller/
---
## EmbeddedWoffFontsHtmlController sınıf
...
|  [EmbeddedWoffFontsHtmlController](./embeddedwofffontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | Yeni bir örnek oluşturur. |
...
* Sınıf [IEmbeddedWoffFontsHtmlController](../iembeddedwofffontshtmlcontroller/)
