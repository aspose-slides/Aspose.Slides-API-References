...
Dışa aktarılan belgede [Ink](../../aspose.slides.ink/) nesnelerinin görünümünü kontrol eden seçenekleri sağlar.
...
| virtual **bool** [get_HideInk](./get_hideink/)() | Dışa aktarılan belgede [Ink](../../aspose.slides.ink/) öğelerini gösterir veya gizler. |
| virtual **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() | Fırça işleme için ROP işlemini veya Opacity'i kullanır. |
...
| virtual void [set_HideInk](./set_hideink/)(**bool**) | Dışa aktarılan belgede [Ink](../../aspose.slides.ink/) öğelerini gösterir veya gizler. |
| virtual void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) | Fırça işleme için ROP işlemini veya Opacity'i kullanır. |
