...
description: Dışa aktarma için el ilanı sunumu düzen modunu temsil eder.
type: docs
weight: 66
url: /tr/aspose.slides.export/handoutlayoutingoptions/
---
## HandoutLayoutingOptions sınıf

Dışa aktarma için el ilanı sunumu düzen modu temsil eder.
...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | Sayfada kaç slayt ve hangi sırada yer alacağını [HandoutType](../handouttype/) belirler. |
| **bool** [get_PrintComments](./get_printcomments/)() const | Slaytlarda yorumların gösterilip gösterilmeyeceğini belirtir. |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | Gösterilen slaytların etrafına çerçeve çizilip çizilmeyeceğini belirtir. |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | Gösterilen slayt numaralarının basılıp basılmayacağını belirtir. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapımına olanak tanır. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapımına olanak tanır. |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | Sayfada kaç slayt ve hangi sırada yer alacağını [HandoutType](../handouttype/) belirler. |
| void [set_PrintComments](./set_printcomments/)(**bool**) | Slaytlarda yorumların gösterilip gösterilmeyeceğini belirtir. |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | Gösterilen slaytların etrafına çerçeve çizilip çizilmeyeceğini belirtir. |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | Gösterilen slayt numaralarının basılıp basılmayacağını belirtir. |
