...
description: VideoPlayerHtmlController oluşturmayı sağlar.
type: docs
weight: 794
...
| Yöntem | Açıklama |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVideoPlayerHtmlController](../ivideoplayerhtmlcontroller/)\> [CreateVideoPlayerHtmlController](./createvideoplayerhtmlcontroller/)([System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) override | Yeni **[VideoPlayerHtmlController](../videoplayerhtmlcontroller/)** oluşturur. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşımlı yerine) ayarlar. Kapsayıcılardaki işaretçilerin zayıf moda geçişine izin verir. |
...
* Class [IVideoPlayerHtmlControllerFactory](../ivideoplayerhtmlcontrollerfactory/)
