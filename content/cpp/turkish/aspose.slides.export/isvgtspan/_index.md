...
| virtual [System::String](../../system/string/) [get_Id](./get_id/)() | "tspan" öğesi için kimliği alır. |
...
| virtual void [set_Id](./set_id/)([System::String](../../system/string/)) | "tspan" öğesi için kimliği ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşımlı yerine) olarak ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçişe izin verir. |
