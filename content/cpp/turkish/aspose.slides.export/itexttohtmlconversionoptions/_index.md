...
---
## ITextToHtmlConversionOptions sınıf
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN'in IEEE 60559:1989'da herhangi bir değerle, NaN dahil, eşit olmadığına rağmen, C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN eşit kabul edilir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'in IEEE 60559:1989'da herhangi bir değerle, NaN dahil, eşit olmadığına rağmen, C# tarzı kayan nokta karşılaştırmasını taklit eder; iki NaN eşit kabul edilir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual **bool** [get_AddClipboardFragmentHeader](./get_addclipboardfragmentheader/)() | Clipboard başlıklarının eklenip eklenmeyeceğini gösteren değeri döndürür. **bool** okur. |
| virtual [System::String](../../system/string/) [get_EncodingName](./get_encodingname/)() | HTML kodlama adını döndürür. Bu değer üretilen HTML dosyasına kaydedilir, ancak dosyanın bu kodlamada kaydedileceği garanti çağırıcıya aittir. [System::String](../../system/string/) okur. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[Export::ILinkEmbedController](../ilinkembedcontroller/)\> [get_LinkEmbedController](./get_linkembedcontroller/)() | Dış nesnenin nasıl depolanacağını kontrol eden bir geri çağırma nesnesi döndürür. [Export::ILinkEmbedController](../ilinkembedcontroller/) okur. |
| virtual [Aspose::Slides::Export::TextInheritanceLimit](../textinheritancelimit/) [get_TextInheritanceLimit](./get_textinheritancelimit/)() | Metin özellikleri için içsel derinliği döndürür. [TextInheritanceLimit](../textinheritancelimit/) okur. |
...
| virtual void [set_AddClipboardFragmentHeader](./set_addclipboardfragmentheader/)(**bool**) | Clipboard başlıklarının eklenip eklenmeyeceğini gösteren değeri ayarlar. **bool** yazar. |
| virtual void [set_EncodingName](./set_encodingname/)([System::String](../../system/string/)) | HTML kodlama adını ayarlar. Bu değer üretilen HTML dosyasına kaydedilir, ancak dosyanın bu kodlamada kaydedileceği garanti çağırıcıya aittir. [System::String](../../system/string/) yazar. |
| virtual void [set_LinkEmbedController](./set_linkembedcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[Export::ILinkEmbedController](../ilinkembedcontroller/)\>) | Dış nesnenin nasıl depolanacağını kontrol eden bir geri çağırma nesnesi ayarlar. [Export::ILinkEmbedController](../ilinkembedcontroller/) yazar. |
| virtual void [set_TextInheritanceLimit](./set_textinheritancelimit/)([Aspose::Slides::Export::TextInheritanceLimit](../textinheritancelimit/)) | Metin özellikleri için içsel derinliği ayarlar. [TextInheritanceLimit](../textinheritancelimit/) yazar. |
