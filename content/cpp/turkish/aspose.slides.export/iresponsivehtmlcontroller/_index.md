...
description: Responsive HTML Kontrolcüsü
type: docs
weight: 339
url: /tr/aspose.slides.export/iresponsivehtmlcontroller/
---
## IResponsiveHtmlController sınıfı
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | C#-stilinde iki NaN'ın eşit kabul edildiği, IEC 60559:1989'a göre NaN'ın hiçbir değere, NaN dahil, eşit olmadığı halde, kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | C#-stilinde iki NaN'ın eşit kabul edildiği, IEC 60559:1989'a göre NaN'ın hiçbir değere, NaN dahil, eşit olmadığı halde, kayan nokta karşılaştırmasını taklit eder. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Aslında hiçbir şeyi kopyalamaz, yalnızca yeni nesneyi başlatır ve alt sınıfların kopya oluşturulmasını sağlar. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Aslında hiçbir şeyi kopyalamaz, yalnızca yeni nesneyi başlatır ve alt sınıfların kopya oluşturulmasını sağlar. |
...
| virtual void [WriteDocumentEnd](../ihtmlformattingcontroller/writedocumentend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\>) | HTML belge altbilgisini yazmak için çağrılır. Sunum dönüşüm başına bir kez çağrılır. |
| virtual void [WriteDocumentStart](../ihtmlformattingcontroller/writedocumentstart/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../../aspose.slides/ipresentation/)\>) | HTML belge üstbilgisini yazmak için çağrılır. Sunum dönüşüm başına bir kez çağrılır. |
| virtual void [WriteShapeEnd](../ihtmlformattingcontroller/writeshapeend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Şekil render edilmeden önce çağrılır. Her şekil için bir kez çağrılır. Bu işlev generator'a bir şey yazar ise mevcut slayt görseli oluşturulması tamamlanır, eklenen html parçacığı eklenir ve yeni görsel öncekinin üzerine başlatılır. |
...
| virtual void [WriteSlideEnd](../ihtmlformattingcontroller/writeslideend/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>) | HTML slayt altbilgisini yazmak için çağrılır. Her slayt için bir kez çağrılır. |
| virtual void [WriteSlideStart](../ihtmlformattingcontroller/writeslidestart/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlGenerator](../ihtmlgenerator/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>) | HTML slayt üstbilgisini yazmak için çağrılır. Her slayt için bir kez çağrılır. |
