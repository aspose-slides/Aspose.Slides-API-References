...
| **bool** [get_HideInk](./get_hideink/)() override | [Ink](../../aspose.slides.ink/) öğelerini ihraç edilen belgede gösterir veya gizler. |
| **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() override | Fırça oluşturmak için ROP işlemi veya Opaklık kullanır. |
...
|  [Object](../../system/object/object/)() | Nesne oluşturur. Tüm dahili veri yapılarının ilk değerlerini ayarlar. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Gerçekte hiç bir şey kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapıcı ile oluşturulmasını sağlar. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Gerçekte hiçbir şey kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapıcı ile oluşturulmasını sağlar. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nın dize ve nullptr durumu için özelleştirilmiş hali. |
...
| void [set_HideInk](./set_hideink/)(**bool**) override | [Ink](../../aspose.slides.ink/) öğelerini ihraç edilen belgede gösterir veya gizler. |
| void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) override | Fırça oluşturmak için ROP işlemi veya Opaklık kullanır. |
