...
description: "ArgumentException, çağrılan bir metoda geçirilen argüman geçersiz olduğunda fırlatılır. Bu sınıfın örneklerini manuel olarak oluşturmayın. Bunun yerine ArgumentException sınıfını kullanın. ArgumentException sınıfı örneklerini System::SmartPtr içine asla sarmalamayın."
type: docs
weight: 326
url: /tr/system/details_argumentexception/
---
## Details_ArgumentException sınıfı

ArgumentException, çağrılan bir metoda geçirilen argüman geçersiz olduğunda fırlatılır. Bu sınıfın örneklerini manuel olarak oluşturmayın. Bunun yerine ArgumentException sınıfını kullanın. ArgumentException sınıfı örneklerini [System::SmartPtr](../smartptr/) içine asla sarmalamayın.
...
| static std::enable_if\<[IsSmartPtr](../issmartptr/)\<T1\>::value\&&[IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | Referans türü nesneleri C# tarzında karşılaştırır. |
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../object/equals/)(T1 const\&, T2 const\&) | Değer türü nesneleri C# tarzında karşılaştırır. |
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmadığı halde, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmadığı halde, iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
...
| virtual [String](../string/) [get_Message](../details_exception/get_message/)() const | Hata açıklamasını içeren dizgiyi döndürür. |
| [String](../string/) [get_ParamName](./get_paramname/)() |  |
| virtual [String](../string/) [get_StackTrace](../details_exception/get_stacktrace/)() const | Yığın izini içeren dizgiyi döndürür. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Nesnenin gerçek türünü alır. C# [System.Object.GetType()](../object/gettype/) çağrısının analoğu. |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | Değer türü nesneyi nullptr ile referans olarak karşılaştırır. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını bir zayıf işaretçi olarak ayarlar (paylaşılan yerine). Kapsayıcılardaki işaretçilerin zayıf moda geçişine izin verir. |
...
| virtual const char * [what](../details_exception/what/)() const | [what()](../details_exception/what/) metodunu uygular; bu metod [ExceptionWrapper](../exceptionwrapper/) sınıfı tarafından çağrılır. Bu sınıfın std::exception'tan türetilmemiş olmasına rağmen türetilen sınıflar, mantıklarını uygulamak için korumalı/özel üyeleri kullanabilir. Bu metodun uygulamasını [ExceptionWrapper](../exceptionwrapper/)'ya taşımak bu mantığı bozabilir. |
| virtual  [~Object](../object/~object/)() | Nesneyi yok eder. Tüm iç veri yapılarını serbest bırakır. |

## Açıklamalar

ArgumentNullException, bir metodun çağrıldığında, metodun null olmayan bir değer beklediği halde null argüman geçirilmesi durumunda fırlatılır. Bu sınıfın örneklerini manuel olarak oluşturmayın. Bunun yerine ArgumentNullException sınıfını kullanın. ArgumentNullException sınıfı örneklerini [System::SmartPtr](../smartptr/) içine asla sarmalamayın. 
## İlgili
