...
description: "Sistem (uygulama değil) istisnalarını temsil eden sınıflar için temel bir sınıftır. Bu sınıfın örneklerini manuel olarak oluşturmayın. Bunun yerine SystemException sınıfını kullanın. SystemException sınıfı örneklerini System::SmartPtr içine asla paketlemeyin."
type: docs
weight: 703
url: /tr/system/details_systemexception/
---
## Details_SystemException sınıf

Sistem (uygulama değil) istisnalarını temsil eden sınıflar için bir temel sınıftır. Bu sınıfın örneklerini manuel olarak oluşturmayın. Bunun yerine SystemException sınıfını kullanın. SystemException sınıfının örneklerini [System::SmartPtr](../smartptr/) içine asla paketlemeyin.
...
| static **bool** [Equals](../object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN'in herhangi bir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C#-stilinde kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in herhangi bir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C#-stilinde kayan nokta karşılaştırmasını taklit eder. |
...
| **int32_t** [get_HResult](../details_exception/get_hresult/)() const | Mevcut nesne tarafından temsil edilen istisna ile ilişkili bir HRESULT kodu olan 32-bit tam sayı değerini döndürür. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Kopya kurucu. Aslında hiçbir şeyi kopyalamaz, yalnızca yeni nesneyi başlatır ve alt sınıfların kopya oluşturmasını sağlar. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Atama operatörü. Aslında hiçbir şeyi kopyalamaz, yalnızca yeni nesneyi başlatır ve alt sınıfların kopya oluşturmasını sağlar. |
...
| void [Unlock](../object/unlock/)() | C# lock() ifadesinin kilit açmasını uygular. Doğrudan çağırın veya [LockContext](../lockcontext/) gözetmen nesnesini kullanın. |
