...
description: "InvalidProgramException yalnızca uyumluluk nedenleriyle mevcuttur. Bu sınıfın örneklerini manuel olarak asla oluşturmayın. Bunun yerine InvalidProgramException sınıfını kullanın. InvalidProgramException sınıfı örneklerini System::SmartPtr içine asla sarmalamayın."
type: docs
weight: 521
url: /tr/system/details_invalidprogramexception/
---
## Details_InvalidProgramException sınıfı

InvalidProgramException yalnızca uyumluluk nedenleriyle bulunur. Bu sınıfın örneklerini manuel olarak asla oluşturmayın. Bunun yerine InvalidProgramException sınıfını kullanın. InvalidProgramException sınıfı örneklerini [System::SmartPtr](../smartptr/) içine asla sarmalamayın.
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | C# [Object.GetHashCode()](../object/gethashcode/) yönteminin benzeri. Özel nesnelerin karma (hash) oluşturmasını sağlar. |
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Nesnenin gerçek türünü alır. C# [System.Object.GetType()](../object/gettype/) çağrısının benzeri. |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../object/memberwiseclone/) yönteminin benzeri. Özel türlerin klonlanmasını sağlar. |
|  [Object](../object/object/)() | Nesneyi oluşturur. Tüm iç veri yapılarını başlatır. |
|  [Object](../object/object/)([Object](../object/) const\&) | Kopya kurucusu. Gerçekte hiçbir şey kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya oluşturmalarını etkinleştirir. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Atama operatörü. Gerçekte hiçbir şey kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya oluşturmalarını etkinleştirir. |
...
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../object/referenceequals/)'in dize ve nullptr durumu için özelleştirilmiş hali. |
| **bool** [ReferenceEquals](../object/referenceequals/)([String](../string/) const\&, [String](../string/) const\&) | [Object::ReferenceEquals](../object/referenceequals/)'in dize durumu için özelleştirilmiş hali. |
