...
description: Bir emüle edilmiş Çöp Toplama'yı temsil eder ve etkili bir şekilde hiçbir şey yapmayan bir stub gibi davranır. Bu, örnek hizmeti olmayan statik bir türdür. Herhangi bir yolla örnekleri asla oluşturulmamalıdır.
type: docs
weight: 872
url: /tr/system/gc/
---
...
Emüle edilmiş bir Çöp Toplama'yı temsil eder ve aslında hiçbir şey yapmayan bir stub gibi davranır. Bu, örnek hizmeti olmayan statik bir türdür. Herhangi bir yolla örnekleri asla oluşturulmamalıdır.
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | C# [Object.GetHashCode()](../object/gethashcode/) yöntemine analoğudur. Özel nesnelerin hash'lenmesini sağlar. |
| static **int64_t** [GetTotalAllocatedBytes](./gettotalallocatedbytes/)(**bool**) | Toplam tahsis edilen baytları döndürür. |
| static **int64_t** [GetTotalMemory](./gettotalmemory/)(**bool**) | Geçerli süreç tarafından şu anda tahsis edilen özel bellek bayt sayısını döndürür. |
| virtual const [TypeInfo](../typeinfo/)\& [GetType](../object/gettype/)() const | Nesnenin gerçek tipini alır. C# [System.Object.GetType()](../object/gettype/) çağırmasına analoğudur. |
...
| void [Lock](../object/lock/)() | C# lock() deyiminin kilitlemesini uygular. Doğrudan çağırın veya [LockContext](../lockcontext/) gözlemci nesnesini kullanın. |
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../object/memberwiseclone/) yönteminin analoğudur. Özel tiplerin klonlanmasını sağlar. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşılan yerine) olarak belirler. Kapsayıcılardaki işaretçileri zayıf moda geçişine izin verir. |
...
| virtual [String](../string/) [ToString](../object/tostring/)() const | C# [Object.ToString()](../object/tostring/) yöntemine analoğudur. Özel nesnelerin dizeye dönüştürülmesini sağlar. |
| static const [TypeInfo](../typeinfo/)\& [Type](../object/type/)() | C# typeof([System.Object](../object/)) yapısını uygular. |
| void [Unlock](../object/unlock/)() | C# lock() deyiminin kilit açmasını uygular. Doğrudan çağırın veya [LockContext](../lockcontext/) gözlemci nesnesini kullanın. |
