...
| **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() override | VBAProject'in proje özelliklerini görüntülemek için bir parola ile korup korumadığını gösterir. Salt okunur **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) override | Belirtilen indeksde bulunan VBA projesindeki modülü döndürür. |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() override | VBA projesinde bulunan tüm modüllerin listesini döndürür. Salt okunur [IVbaModuleCollection](../ivbamodulecollection/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | VBA projesinin adını döndürür. Salt okunur [System::String](../../system/string/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) override | Belirtilen indeksde bulunan VBA projesindeki referansı döndürür. |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() override | VBA projesinde bulunan tüm referansların listesini döndürür. Salt okunur [IVbaReferenceCollection](../ivbareferencecollection/). |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() override | VBA projesinin ikili temsili olarak OLE konteynerini döndürür |
...
|  [VbaProject](./vbaproject/)() | Bu yapıcı, sıfırdan yeni bir VBA projesi oluşturur. Proje 1252 Windows Latin 1 (ANSI) kod sayfasında oluşturulacaktır |
|  [VbaProject](./vbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Bu yapıcı, OLE konteynerinin ikili temsili üzerinden VBA projesini yükler. |
