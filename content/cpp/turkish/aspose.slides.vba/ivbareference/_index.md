...
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | VBA proje referansının adını temsil eder. [System::String](../../system/string/) okunur. |
...
| virtual void [set_Name](./set_name/)([System::String](../../system/string/)) | VBA proje referansının adını temsil eder. [System::String](../../system/string/) yazın. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını bir zayıf işaretçi (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki işaretçileri zayıf moda geçirmeyi sağlar. |
