...
| [System::String](../../system/string/) [get_Libid](./get_libid/)() override | Automation tür kütüphanesinin tanımlayıcısını temsil eder. Okuyun [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | VBA proje referansının adını temsil eder. Okuyun [System::String](../../system/string/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin targetType tarafından tanımlanan tipe ait bir örnek olup olmadığını denetler. C# 'is' operatörünün analoğudur. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/) yönteminin analoğudur. Özel tiplerin klonlanmasını etkinleştirir. |
...
| void [set_Libid](./set_libid/)([System::String](../../system/string/)) override | Automation tür kütüphanesinin tanımlayıcısını temsil eder. Yazın [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | VBA proje referansının adını temsil eder. Yazın [System::String](../../system/string/). |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | C# [Object.ToString()](../../system/object/tostring/) yönteminin analoğudur. Özel nesnelerin dizeye dönüştürülmesini etkinleştirir. |
...
|  [VbaReferenceOleTypeLib](./vbareferenceoletypelib/)([System::String](../../system/string/), [System::String](../../system/string/)) | Bu kurucu yeni OLE Automation tür kitaplığı referansı oluşturur. |
...
* Sınıf [IVbaReferenceOleTypeLib](../ivbareferenceoletypelib/)
