...
| Yöntem | Açıklama |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [CreateVbaProject](./createvbaproject/)() override | Yeni VBA projesi oluşturur. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | İki NaN değerinin eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder; IEC 60559:1989 standardına göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN değerinin eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder; IEC 60559:1989 standardına göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Sadece dahili amaçlar için. |
| static [System::SharedPtr](../../system/sharedptr/)\<[VbaProjectFactory](./)\> [get_Instance](./get_instance/)() | VBA proje fabrikası statik örneği. Salt okunur [VbaProjectFactory](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaProject](../ivbaproject/)\> [ReadVbaProject](./readvbaproject/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | OLE konteynerinden VBA projesini okur. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit dışı bırakmasını uygular. Doğrudan çağırılabilir veya [LockContext](../../system/lockcontext/) gözlemci nesnesi kullanılabilir. |
...
* Sınıf [IVbaProjectFactory](../ivbaprojectfactory/)
