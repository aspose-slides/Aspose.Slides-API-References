...
| Method | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>) override | Yeni referansı referanslar koleksiyonuna ekler |
| [iterator](./iterator/) [begin](./begin/)() | Koleksiyonda (varsa) ilk öğeyi gösteren yineleyici döndürür. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Koleksiyonun const nitelikli örneğinde (varsa) ilk öğeyi gösteren yineleyici döndürür. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Koleksiyondaki (varsa) ilk const nitelikli öğeyi gösteren yineleyici döndürür. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Koleksiyondaki (varsa) son const nitelikli öğeden hemen sonra başlayan yineleyici döndürür. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>\>, **int32_t**) override | Tüm öğeleri koleksiyondan belirtilen diziye kopyalar. |
| [iterator](./iterator/) [end](./end/)() | Koleksiyondaki (varsa) son öğeden hemen sonra başlayan yineleyici döndürür. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Koleksiyonun const nitelikli örneğinde (varsa) son öğeden hemen sonra başlayan yineleyici döndürür. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN hiçbir değere eşit değildir, NaN dahil, ancak iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN hiçbir değere eşit değildir, NaN dahil, ancak iki NaN'ın eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| **int32_t** [get_Count](./get_count/)() override | Koleksiyonda gerçekte bulunan öğe sayısını döndürür. Salt okunur **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\>\>\> [GetEnumerator](./getenumerator/)() override | Koleksiyon boyunca yineleme yapan bir enumeratör döndürür. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [idx_get](./idx_get/)(**int32_t**) override | Belirtilen indeksteki öğeyi döndürür. |
...
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Giriş dizisindeki her öğeye bir dönüşüm fonksiyonu uygulayarak elde edilen değerlerin ortalamasını hesaplar. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüşüm fonksiyonu uygulayıp, elde edilen maksimum değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine bir dönüşüm fonksiyonu uygulayıp, elde edilen minimum değeri döndürür. |
...
| void [Lock](../../system/object/lock/)() | C# lock() deyiminin kilitlemesini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Gerçekten bir şey kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapımını etkinleştirir. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Gerçekten bir şey kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya yapımını etkinleştirir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() deyiminin kilit açma işlemini uygular. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) bekçi nesnesini kullanın. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Koleksiyonun const nitelikli örneğinde (varsa) ilk öğeyi gösteren yineleyici döndürür. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Koleksiyonun (varsa) ilk öğesini gösteren yineleyici döndürür. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Koleksiyonun const nitelikli örneğinde (varsa) son öğeden hemen sonra başlayan yineleyici döndürür. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Koleksiyonun (varsa) son öğeden hemen sonra başlayan yineleyici döndürür. |
...
| [virtualized_iterator](./virtualized_iterator/) | Sanal (virtual) tip. |

## Bakınız

* Sınıf [IVbaReferenceCollection](../ivbareferencecollection/)
