...
description: "Renkleri dönüştürmek için bir harita temsil eder. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak allocate edilmelidir. Bu tipin bir örneğini yığıt üzerinde veya operator new kullanarak oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya assertion hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 14
url: /tr/system.drawing.imaging/colormap/
---
## ColorMap sınıfı


Renkleri dönüştürmek için bir haritayı temsil eder. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak allocate (ayrılmalıdır). Bu türün bir örneğini yığıt üzerinde veya new operatörüyle oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya assert hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN'in hiçbir değere, NaN dahil, eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C# tarzı double kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| [Color](../../system.drawing/color/) [get_NewColor](./get_newcolor/)() const | Dönüştürülecek rengi temsil eden yeni [Color](../../system.drawing/color/) nesnesini döndürür. |
| [Color](../../system.drawing/color/) [get_OldColor](./get_oldcolor/)() const | Dönüştürülecek rengi temsil eden eski [Color](../../system.drawing/color/) nesnesini döndürür. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin targetType tarafından tanımlanan tipte bir örnek olup olmadığını denetler. C# 'is' operatörünün analoğu. |
...
| void [set_NewColor](./set_newcolor/)(const [Color](../../system.drawing/color/)\&) | Dönüştürülecek rengi temsil eden yeni [Color](../../system.drawing/color/) nesnesini ayarlar. |
| void [set_OldColor](./set_oldcolor/)(const [Color](../../system.drawing/color/)\&) | Dönüştürülecek rengi temsil eden eski [Color](../../system.drawing/color/) nesnesini ayarlar. |
