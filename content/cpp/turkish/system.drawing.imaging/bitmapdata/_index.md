...
description: "Bir bitmap görüntüsünün bir dizi niteliğini temsil eder. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak tahsis edilmelidir. Bu tipin bir örneğini yığında veya new operatörüyle asla oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına neden olur. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirmek için kullanın."
type: docs
weight: 1
url: /tr/system.drawing.imaging/bitmapdata/
---
## BitmapData sınıf

Bitmap görüntüsünün bir dizi niteliğini temsil eder. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak tahsis edilmelidir. Yığında veya new operatörüyle bu tipin bir örneğini asla oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'ın eşit kabul edildiği C# tarzı çift duyarlıklı kayan nokta karşılaştırmasını taklit eder, ancak IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| int [get_Height](./get_height/)() const | Görüntünün piksel cinsinden yüksekliğini döndürür. |
| [PixelFormat](../pixelformat/) [get_PixelFormat](./get_pixelformat/)() const | Bitmap görüntüsünün piksel biçimini döndürür. |
| IntPtr [get_Scan0](./get_scan0/)() const | Bitmap'teki ilk piksel verisinin adresini döndürür. |
| int [get_Stride](./get_stride/)() const | Görüntünün bayt cinsinden sıralama genişliğini döndürür. |
| int [get_Width](./get_width/)() const | Görüntünün piksel cinsinden genişliğini döndürür. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Nesnenin hedefTip tarafından tanımlanan türün bir örneği olup olmadığını kontrol eder. C# 'is' operatörünün analogu. |
...
| void [set_Height](./set_height/)(int) | Görüntünün yüksekliğini piksel olarak ayarlar. |
| void [set_PixelFormat](./set_pixelformat/)([PixelFormat](../pixelformat/)) | Bitmap görüntüsünün piksel biçimini ayarlar. |
| void [set_Scan0](./set_scan0/)(IntPtr) | Bitmap'teki ilk piksel verisinin adresini ayarlar. |
| void [set_Stride](./set_stride/)(int) | Görüntünün bayt cinsinden sıralama genişliğini ayarlar. |
| void [set_Width](./set_width/)(int) | Görüntünün genişliğini piksel olarak ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf işaretçi (paylaşılan yerine) olarak ayarlar. Kapsayıcılardaki işaretçilerin zayıf moda geçişine olanak tanır. |
