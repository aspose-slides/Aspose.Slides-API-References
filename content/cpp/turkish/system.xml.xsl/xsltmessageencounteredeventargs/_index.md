...
description: "XsltArgumentList::XsltMessageEncountered olayına ilişkin verileri sağlar."
type: docs
weight: 92
url: /tr/system.xml.xsl/xsltmessageencounteredeventargs/
---
## XsltMessageEncounteredEventArgs sınıfı

Bu **XsltArgumentList::XsltMessageEncountered** olayı için veri sağlar.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir; ancak iki NaN'nin eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir; ancak iki NaN'nin eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
|  [EventArgs](../../system/eventargs/eventargs/)() | Yapıcı. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [String](../../system/string/) [get_Message](./get_message/)() | **xsl:message** öğesinin içeriğini döndürür. |
...
| Alan | Açıklama |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Boş bir "[EventArgs](../../system/eventargs/)" paylaşılan işaretçi (null-pointer) temsil eden statik bir üye. |

## Typedef'ler

| Typedef | Açıklama |
| --- | --- |
| [Ptr](./ptr/) | Bu sınıfın bir örneğine ortak işaretçiyi temsil eden bir takma addır. |
