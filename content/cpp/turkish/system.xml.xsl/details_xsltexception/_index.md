...
description: XSLT dönüşümü işlenirken bir hata oluştuğunda atılan istisna.
type: docs
weight: 14
url: /tr/system.xml.xsl/details_xsltexception/
---
## Details_XsltException sınıfı


XSLT dönüşümü işlenirken bir hata oluştuğunda atılan istisna.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Stil sayfasında hatanın oluştuğu satır numarasını döndürür. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Stil sayfasında hatanın oluştuğu satır konumunu döndürür. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Geçerli istisnayı açıklayan biçimlendirilmiş hata mesajını döndürür. |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Stil sayfasının konum yolunu döndürür. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Belirli bir istisnaya atanan kodlu sayısal bir değer olan HRESULT'ı ayarlar. |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | Geçerli nesnenin dize temsiliini döndürür. |
