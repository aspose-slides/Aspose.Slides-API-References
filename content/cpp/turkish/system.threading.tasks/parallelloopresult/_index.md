...
description: Paralel bir döngünün tamamlanma durumunu sağlar.
type: docs
weight: 14
url: /tr/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult sınıfı


Bir [Parallel](../parallel/) döngüsünün tamamlanma durumunu sağlar.
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Döngünün tamamlanıp tamamlanmadığını alır. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Bir kırılmanın gerçekleştiği en düşük yineleme indeksini alır. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Bir [ParallelLoopResult](./) oluşturur. |
...
Tamamlanıp tamamlanmadığı ve kırılmalar hakkında bilgi dahil olmak üzere paralel döngü işleminin sonucunu temsil eder.
