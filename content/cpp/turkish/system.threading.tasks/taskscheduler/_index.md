...
description: İş parçacıklarına görevleri kuyruklama işleminin düşük seviyeli işini yöneten bir nesneyi temsil eder.
type: docs
weight: 79
url: /tr/system.threading.tasks/taskscheduler/
---
## TaskScheduler sınıfı

İş parçacıklarına görevleri kuyruklama işleminin düşük seviyeli işini yöneten bir nesneyi temsil eder.
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | İki NaN'ın eşit kabul edildiği C# tarzı çift hassasiyetli kayan nokta karşılaştırmasını taklit eder; IEC 60559:1989'a göre NaN hiçbir değere, NaN dahil, eşit değildir. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | Mevcut iş parçacığıyla ilişkili bir [TaskScheduler](./) oluşturur. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | Şu anda yürütülen görevle ilişkili [TaskScheduler](./)'i alır. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | Çerçeve tarafından sağlanan varsayılan [TaskScheduler](./) örneğini alır. |
| **int32_t** [get_Id](./get_id/)() const | Bu [TaskScheduler](./) için benzersiz kimliği alır. |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | Bu [TaskScheduler](./)'nin destekleyebileceği maksimum eşzamanlılık seviyesini gösterir. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya kurucu. Gerçekte hiçbir şeyi kopyalamaz, sadece yeni nesneyi başlatır ve alt sınıfların kopya oluşturmalarını etkinleştirir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açma (unlock) işlevini uygular. Doğrudan çağırılabilir veya [LockContext](../../system/lockcontext/) gözcü nesnesi kullanılabilir. |
