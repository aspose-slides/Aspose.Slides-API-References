...
description: Parallel sınıfı üzerindeki yöntemlerin çalışmasını yapılandıran seçenekleri saklar.
type: docs
weight: 27
url: /tr/system.threading.tasks/paralleloptions/
---
## ParallelOptions sınıf

[Parallel](../parallel/) sınıfı üzerindeki yöntemlerin çalışmasını yapılandıran seçenekleri saklar.
...
| const [CancellationToken](../../system.threading/cancellationtoken/)\& [get_CancellationToken](./get_cancellationtoken/)() | Bu [ParallelOptions](./) örneğiyle ilişkili [CancellationToken](../../system.threading/cancellationtoken/) değerini alır. |
| **int32_t** [get_MaxDegreeOfParallelism](./get_maxdegreeofparallelism/)() | Bu [ParallelOptions](./) örneği tarafından etkinleştirilen maksimum paralellik derecesini alır. |
| const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](../taskscheduler/)\>\& [get_TaskScheduler](./get_taskscheduler/)() | Bu [ParallelOptions](./) örneğiyle ilişkili [TaskScheduler](../taskscheduler/) değerini alır. |
...
|  [ParallelOptions](./paralleloptions/)() | [ParallelOptions](./) örneğini varsayılan değerlerle oluşturur. |
...
| void [set_CancellationToken](./set_cancellationtoken/)(const [CancellationToken](../../system.threading/cancellationtoken/)\&) | Bu [ParallelOptions](./) örneğiyle ilişkili [CancellationToken](../../system.threading/cancellationtoken/) değerini ayarlar. |
| void [set_MaxDegreeOfParallelism](./set_maxdegreeofparallelism/)(**int32_t**) | Bu [ParallelOptions](./) örneği tarafından etkinleştirilen maksimum paralellik derecesini ayarlar. |
| void [set_TaskScheduler](./set_taskscheduler/)(const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](../taskscheduler/)\>\&) | Bu [ParallelOptions](./) örneğiyle ilişkili [TaskScheduler](../taskscheduler/) değerini ayarlar. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını zayıf gösterici (paylaşılan yerine) ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçirmek için izin verir. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilitlemesini kaldırır. Doğrudan çağırın veya [LockContext](../../system/lockcontext/) koruyucu nesnesini kullanın. |
