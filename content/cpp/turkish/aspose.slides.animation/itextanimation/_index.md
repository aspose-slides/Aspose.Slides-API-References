...
| Yöntem | Açıklama |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | Mevcut sekansın sonuna yeni bir etki ekler ve grup metin animasyonlarının sonuna yerleştirir. Yalnızca metin paragraflarının sayısı bu grubun etki sayısına eşit veya daha büyükse geçerlidir! |
...
| virtual [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() | Metin animasyonunun yapı türü listesini (örnek [Paragraph](../../aspose.slides/paragraph/) 1,2,3, Hepsi Birlikte) sağlar. [BuildType](../buildtype/) okunur. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() | Grup ile birlikte veya olmadan (null) bağlantılı şekil etkisi. [IEffect](../ieffect/) okunur. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'ın dize ve nullptr durumları için özelleştirmesi. |
...
| virtual void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) | Metin animasyonunun yapı türü listesini (örnek [Paragraph](../../aspose.slides/paragraph/) 1,2,3, Hepsi Birlikte) sağlar. [BuildType](../buildtype/) yazılır. |
| virtual void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) | Grup ile birlikte veya olmadan (null) bağlantılı şekil etkisi. [IEffect](../ieffect/) yazılır. |
