...
| virtual **float** [get_Value0](./get_value0/)() | Offset'in ilk değerini tanımlar. **float** okunur. |
| virtual **float** [get_Value1](./get_value1/)() | Offset'in ikinci değerini tanımlar. **float** okunur. |
| virtual **float** [get_Value2](./get_value2/)() | Offset'in üçüncü değerini tanımlar. **float** okunur. |
...
| virtual void [set_Value0](./set_value0/)(**float**) | Offset'in ilk değerini tanımlar. **float** yazar. |
| virtual void [set_Value1](./set_value1/)(**float**) | Offset'in ikinci değerini tanımlar. **float** yazar. |
| virtual void [set_Value2](./set_value2/)(**float**) | Offset'in üçüncü değerini tanımlar. **float** yazar. |
