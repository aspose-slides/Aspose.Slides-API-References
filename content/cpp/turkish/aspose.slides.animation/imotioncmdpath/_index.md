...
| virtual [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() | Komut tipini belirtir. Okuyun [MotionCommandPathType](../motioncommandpathtype/). |
| virtual **bool** [get_IsRelative](./get_isrelative/)() | Komut koordinatlarının göreceli olup olmadığını belirler. **bool**'ı okuyun. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() | Komut noktalarını belirtir. Okuyun [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| virtual [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() | Komut noktalarının tipini belirtir. Okuyun [MotionPathPointsType](../motionpathpointstype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Kopya yapıcı. Gerçekte hiçbir şeyi kopyalamaz, yalnızca yeni nesneyi başlatır ve alt sınıfların kopya oluşumunu sağlar. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Atama operatörü. Gerçekte hiçbir şeyi kopyalamaz, yalnızca yeni nesneyi başlatır ve alt sınıfların kopya oluşumunu sağlar. |
...
| virtual void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) | Komut tipini belirtir. Yazın [MotionCommandPathType](../motioncommandpathtype/). |
| virtual void [set_IsRelative](./set_isrelative/)(**bool**) | Komut koordinatlarının göreceli olup olmadığını belirler. **bool**'yi yaz. |
| virtual void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) | Komut noktalarını belirtir. Yazın [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| virtual void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) | Komut noktalarının tipini belirtir. Yazın [MotionPathPointsType](../motionpathpointstype/). |
