...
description: Animasyon davranışı için özellik türlerini temsil eder.  ve'den özellikler listesini takip eder.
type: docs
weight: 183
url: /tr/aspose.slides.animation/ibehaviorproperty/
---
## IBehaviorProperty sınıfı
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | IEC 60559:1989 standardına göre NaN hiçbir değerle eşit değildir, NaN dahil, olmasına rağmen iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 standardına göre NaN hiçbir değerle eşit değildir, NaN dahil, olmasına rağmen iki NaN'in eşit kabul edildiği C# tarzı kayan nokta karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual **bool** [get_IsCustom](./get_iscustom/)() | Bu özelliğin, [https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx) spesifikasyonundaki önceden tanımlı özellikler listesine ait olup olmadığını gösterir. |
| virtual [System::String](../../system/string/) [get_Value](./get_value/)() | Özelliğin değeri |
