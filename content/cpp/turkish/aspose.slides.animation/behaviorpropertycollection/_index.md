...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Koleksiyona yeni bir özellik ekler. |
| void [Add](./add/)(const [System::String](../../system/string/)\&) override | Koleksiyona yeni bir özellik ekler. |
...
| void [Clear](./clear/)() override | Koleksiyondaki tüm özellikleri kaldırır. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | [ICollection](../../system.collections.generic/icollection/) içinde belirli bir değerin olup olmadığını belirler. |
| **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const override | [ICollection](../../system.collections.generic/icollection/) içinde belirli bir değerin olup olmadığını belirler. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>, **int32_t**) override | [ICollection](../../system.collections.generic/icollection/) öğelerini belirli bir [System::Array](../../system/array/) indeksinden başlayarak bir [System::Array](../../system/array/)'ye kopyalar. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Koleksiyonun tüm öğelerini mevcut dizi öğelerine kopyalar. |
...
| **int32_t** [get_Count](./get_count/)() const override | Koleksiyonda depolanan özellik sayısını döndürür. Salt okunur **int32_t**. |
| **bool** [get_IsFixedSize](../../system.collections.generic/ilist/get_isfixedsize/)() | Koleksiyonun sabit boyutta olup olmadığını kontrol eder. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | [ICollection](../../system.collections.generic/icollection/)'ün salt okunur olup olmadığını gösteren değeri alır. Salt okunur **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\>\> [GetEnumerator](./getenumerator/)() override | Koleksiyon üzerinde yineleme yapan bir enumerator döndürür. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\> [idx_get](./idx_get/)(**int32_t**) const override | Belirtilen indeksteki bir özelliği döndürür. |
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Belirtilen indeksteki öğeyi alır. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>) override | Belirtilen indeksteki bir özelliği döndürür. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Belirtilen indeksteki öğeyi ayarlar. |
| **int32_t** [IndexOf](./indexof/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) const override | [IList](../../system.collections.generic/ilist/) içinde belirli bir öğenin indeksini belirler. |
| **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const override | [IList](../../system.collections.generic/ilist/) içinde özellik değerine göre belirli bir öğenin indeksini belirler. |
| void [Insert](./insert/)(**int32_t**, const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Belirtilen indekste koleksiyona yeni bir özellik ekler. |
| void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) override | Belirtilen indekste koleksiyona yeni bir özellik (belirtilen özellik değeri ile) ekler. |
| virtual void [Insert](../../system.collections.generic/ilist/insert/)(int, const T\&) | Belirtilen konuma öğe ekler, diğer öğeleri kaydırır. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine dönüşüm fonksiyonu uygular ve oluşan maksimum değeri döndürür. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Genel bir dizinin her öğesine dönüşüm fonksiyonu uygular ve oluşan minimum değeri döndürür. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nun string durumları için özelleştirilmesi. |
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorProperty](../ibehaviorproperty/)\>\&) override | Koleksiyondan belirtilen özelliği kaldırır. |
| **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) override | Koleksiyondan belirtilen özelliği kaldırır. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Belirtilen indeksteki özelliği kaldırır. |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | Belirtilen indeksteki öğeyi kaldırır. |
...
* Sınıf [IBehaviorPropertyCollection](../ibehaviorpropertycollection/)
* İsimAlanı [Aspose::Slides::Animation](../)
