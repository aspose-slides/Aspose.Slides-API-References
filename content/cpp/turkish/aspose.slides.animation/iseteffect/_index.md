...
description: Bir animasyon davranışı için ayar etkisini temsil eder.
type: docs
weight: 404
...
Bir animasyon davranışı için ayar etkisini temsil eder.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_To](./get_to/)() | Animasyon etkisinden sonra bir etkinin belirli özelliğini belirtir. Nokta değerini temsil eder. Sadece: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Oku [System::Object](../../system/object/). |
...
| virtual void [set_To](./set_to/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Animasyon etkisinden sonra bir etkinin belirli özelliğini belirtir. Nokta değerini temsil eder. Sadece: bool, [ColorFormat](../../aspose.slides/colorformat/), float, int, string. Yaz [System::Object](../../system/object/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon bağımsız değişkenini zayıf gösterici (paylaşımlı yerine) ayarlar. Kapsayıcılardaki göstericileri zayıf moda geçişe izin verir. |
