...
Efektin dönüş davranışını temsil eder.
...
| **float** [get_By](./get_by/)() override | Animasyon için göreceli ofset değerini tanımlar. **float** oku. |
| **float** [get_From](./get_from/)() override | Animasyon için göreceli ofset değerini tanımlar. **float** oku. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | Etki davranışının zamanlama özelliklerini temsil eder. [ITiming](../itiming/) oku. |
| **float** [get_To](./get_to/)() override | Animasyonun bitiş değerini tanımlar. **float** oku. |
...
| void [set_By](./set_by/)(**float**) override | Animasyon için göreceli ofset değerini tanımlar. **float** yaz. |
| void [set_From](./set_from/)(**float**) override | Animasyon için göreceli ofset değerini tanımlar. **float** yaz. |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Etki davranışının zamanlama özelliklerini temsil eder. [ITiming](../itiming/) yaz. |
| void [set_To](./set_to/)(**float**) override | Animasyonun bitiş değerini tanımlar. **float** yaz. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Paylaşılan referans sayacını arttırır. Doğrudan çağrılmamalıdır; bunun yerine akıllı işaretçileri veya ThisProtector'ı kullanın. |
...
* Sınıf [IRotationEffect](../irotationeffect/)
