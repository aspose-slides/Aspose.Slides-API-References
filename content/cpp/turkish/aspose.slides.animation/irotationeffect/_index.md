...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | IEC 60559:1989 standardına göre NaN hiçbir değere eşit olmamasına rağmen, iki NaN'in eşit kabul edildiği C# benzeri çift duyarlıklı karşılaştırmasını taklit eder. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Yalnızca dahili amaçlar için. |
| virtual [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](../ibehavior/get_accumulate/)() | Animasyon davranışlarının birikimli olup olmadığını temsil eder. Oku [NullableBool](../../aspose.slides/nullablebool/). |
| virtual [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../ibehavior/get_additive/)() | Mevcut animasyon davranışının diğer çalışan animasyonlarla birleştirilip birleştirilmediğini gösterir. Oku [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual **float** [get_By](./get_by/)() | Animasyonun göreceli ofset değerini tanımlar. Oku **float**. |
| virtual **float** [get_From](./get_from/)() | Animasyonun başlangıç değerini tanımlar. Oku **float**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](../ibehavior/get_properties/)() | Davranış özelliklerini temsil eder. Salt okunur [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../ibehavior/get_timing/)() | Efekt davranışının zamanlama özelliklerini temsil eder. Oku [ITiming](../itiming/). |
| virtual **float** [get_To](./get_to/)() | Animasyonun bitiş değerini tanımlar. Oku **float**. |
...
| virtual void [set_Accumulate](../ibehavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) | Animasyon davranışlarının birikimli olup olmadığını temsil eder. Yaz [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [set_Additive](../ibehavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) | Mevcut animasyon davranışının diğer çalışan animasyonlarla birleştirilip birleştirilmediğini gösterir. Yaz [BehaviorAdditiveType](../behavioradditivetype/). |
| virtual void [set_By](./set_by/)(**float**) | Animasyonun göreceli ofset değerini tanımlar. Yaz **float**. |
| virtual void [set_From](./set_from/)(**float**) | Animasyonun başlangıç değerini tanımlar. Yaz **float**. |
| virtual void [set_Timing](../ibehavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) | Efekt davranışının zamanlama özelliklerini temsil eder. Yaz [ITiming](../itiming/). |
| virtual void [set_To](./set_to/)(**float**) | Animasyonun bitiş değerini tanımlar. Yaz **float**. |
