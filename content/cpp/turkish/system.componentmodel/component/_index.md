...
description: "Sahte sınıf, Component sınıfını kullanan çevrilen kodun derlenebilir olmasını sağlar. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tipin örneğini yığıt üzerinde veya new operatörüyle asla oluşturmayın; aksi takdirde çalışma zamanı hataları ve/veya doğrulama hatalarına neden olur. Bu sınıfı her zaman System::SmartPtr göstericisine sarın ve bu göstericiyi fonksiyonlara argüman olarak geçirmek için kullanın."
type: docs
weight: 40
url: /tr/system.componentmodel/component/
---
## Bileşen sınıfı

Sahte sınıf, [Component](./) sınıfını kullanan çevrilen kodun derlenebilir olmasını sağlar. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) fonksiyonu ile ayrılmalıdır. Bu tipin örneğini yığıt üzerinde veya new operatörüyle asla oluşturmayın; aksi takdirde çalışma zamanı hataları ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) göstericisine sarın ve bu göstericiyi fonksiyonlara argüman olarak geçirin.
...
| void [Dispose](./dispose/)(**bool**) | Disposable desen desteği; hiçbir şey yapmaz. |
...
| **bool** [get_DesignMode](./get_designmode/)() | Bileşenin tasarım kipinde olup olmadığını kontrol eder. |
...
| void [Lock](../../system/object/lock/)() | C# lock() ifadesinin kilitlemesini uygular. Direkt olarak çağırın veya [LockContext](../../system/lockcontext/) gözlemci nesnesini kullanın. |
...
| void [Unlock](../../system/object/unlock/)() | C# lock() ifadesinin kilit açma işlemini uygular. Direkt olarak çağırın veya [LockContext](../../system/lockcontext/) gözlemci nesnesini kullanın. |
...
* Sınıf [MarshalByRefObject](../../system/marshalbyrefobject/)
* Sınıf [IComponent](../icomponent/)
* İsimAlanı [System::ComponentModel](../)
