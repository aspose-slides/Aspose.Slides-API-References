...
type: docs
weight: 66
url: /tr/system.componentmodel/details_invalidenumargumentexception/
---
## Details_InvalidEnumArgumentException sınıf
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | n'inci şablon argümanını paylaşımlı yerine zayıf pointer olarak ayarlar. Kapsayıcılardaki pointerların zayıf moda geçişini sağlar. |
