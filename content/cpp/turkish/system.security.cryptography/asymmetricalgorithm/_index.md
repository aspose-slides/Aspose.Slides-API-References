...
description: "Simetrik olmayan şifreleme algoritmaları için soyut temel sınıf. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak tahsis edilmelidir. Bu tür bir örneği yığını üzerinde veya new operatörüyle oluşturmayın, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 14
url: /tr/system.security.cryptography/asymmetricalgorithm/
---
## AsymmetricAlgorithm sınıfı

Asimetrik şifreleme algoritmaları için soyut temel sınıf. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak tahsis edilmelidir. Bu tipin örneğini yığını üzerinde veya new operatörüyle oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Her zaman bu sınıfı [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| static [SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](./)\> [Create](./create/)() | Varsayılan bir algoritma oluşturur. Henüz uygulanmadı. |
| static [SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](./)\> [Create](./create/)(const [String](../../system/string/)\&) | İsimle algoritma oluşturur. Henüz uygulanmadı. |
| void [Dispose](./dispose/)() override | Geçerli nesnenin sahip olduğu kaynakları serbest bırakır. |
...
| virtual void [FromXmlString](./fromxmlstring/)([String](../../system/string/)) | Algoritma parametrelerini XML dizesinden okur. |
| virtual [String](../../system/string/) [get_KeyExchangeAlgorithm](./get_keyexchangealgorithm/)() | Kullanılacak anahtar değişim algoritmasını alır. |
| virtual **int32_t** [get_KeySize](./get_keysize/)() | Anahtar boyutunu alır. |
| virtual [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[KeySizes](../keysizes/)\>\> [get_LegalKeySizes](./get_legalkeysizes/)() | İzin verilen anahtar boyutlarının dizisini alır. |
| virtual [String](../../system/string/) [get_SignatureAlgorithm](./get_signaturealgorithm/)() | Kullanılacak imza algoritmasını alır. |
...
| virtual void [set_KeySize](./set_keysize/)(**int32_t**) | Anahtar boyutunu ayarlar. |
...
| virtual [String](../../system/string/) [ToXmlString](./toxmlstring/)(**bool**) | Algoritma parametrelerini XML dizesine yazar. |
