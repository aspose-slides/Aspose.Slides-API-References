...
description: RSA imza oluşturma veya doğrulama işlemleri için dolgu modu ve parametreleri.
type: docs
weight: 521
url: /tr/system.security.cryptography/rsasignaturepadding/
---
## RSASignaturePadding sınıf

Dolgu modu ve [RSA](../rsa/) imza oluşturma veya doğrulama işlemleri için parametreler.
...
| [RSASignaturePaddingMode](../rsasignaturepaddingmode/) [get_Mode](./get_mode/)() const | Dolgu modunu alır. |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pkcs1](./get_pkcs1/)() | PKCS #1 v1.5 modunu alır. |
| static [SharedPtr](../../system/sharedptr/)\<[RSASignaturePadding](./)\> [get_Pss](./get_pss/)() | PSS modunu alır. |
