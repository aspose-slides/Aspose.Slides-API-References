...
description: "DSA algoritması parametrelerinin veri yapısı. Bu tip yığıt üzerinde tahsis edilmeli ve fonksiyonlara değerle veya referansla geçirilmelidir. Bu tipin nesnelerini yönetmek için System::SmartPtr sınıfını asla kullanmayın."
type: docs
weight: 703
url: /tr/system.security.cryptography/dsaparameters/
---
## DSAParameters yapı


[Data](../../system.data/) yapısı [DSA](../dsa/) algoritması parametrelerini içerir. Bu tip yığıt üzerinde tahsis edilmeli ve fonksiyonlara değerle ya da referansla geçirilmelidir. [System::SmartPtr](../../system/smartptr/) sınıfını bu tipin nesnelerini yönetmek için asla kullanmayın.
...
| Yöntem | Açıklama |
| --- | --- |
|  [DSAParameters](./dsaparameters/)() | Yapıcı. |
