...
description: "Yönetilen SHA384 özetleyici. Henüz uygulanmadı. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tipin örneğini yığında veya new operatörüyle asla oluşturmayın, çünkü bu çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirmek için kullanın."
type: docs
weight: 638
url: /tr/system.security.cryptography/sha512managed/
---
## SHA512Managed sınıf
...
| Yöntem | Açıklama |
| --- | --- |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Arabelleği hashler. |
...
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](../sha512/)\> [Create](../sha512/create/)() | Hash algoritması örneği oluşturur. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA512](../sha512/)\> [Create](../sha512/create/)(const [String](../../system/string/)\&) | Hash algoritması örneği oluşturur. |
...
| virtual int [get_HashSize](../hashalgorithm/get_hashsize/)() | Hesaplanan hash değerinin boyutunu bayt olarak alır. |
| int [get_InputBlockSize](../hashalgorithm/get_inputblocksize/)() override | Giriş bloğu boyutu. |
| int [get_OutputBlockSize](../hashalgorithm/get_outputblocksize/)() override | Çıkış bloğu boyutu. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin dizge ve nullptr durumu için özelleştirmesi. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | [Object::ReferenceEquals](../../system/object/referenceequals/)'nin dizgeler durumu için özelleştirmesi. |
