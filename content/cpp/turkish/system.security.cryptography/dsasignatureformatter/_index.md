...
description: "DSA imzası oluşturmak için kullanılır. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Bu tipin örneğini yığına ya da operator new ile asla oluşturmayın; aksi takdirde çalışma zamanı hataları ve/veya doğrulama hataları meydana gelir. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin."
type: docs
weight: 170
url: /tr/system.security.cryptography/dsasignatureformatter/
---
## DSASignatureFormatter sınıf

Bir [DSA](../dsa/) imzası oluşturmak için kullanılır. Bu sınıfın nesneleri yalnızca [System::MakeObject()](../../system/makeobject/) işlevi kullanılarak ayrılmalıdır. Bu tipin örneğini yığına ya da operator new ile asla oluşturmayın; aksi takdirde çalışma zamanı hataları ve/veya doğrulama hataları oluşur. Bu sınıfı her zaman [System::SmartPtr](../../system/smartptr/) işaretçisine sarın ve bu işaretçiyi fonksiyonlara argüman olarak geçirin.
...
| Yöntem | Açıklama |
| --- | --- |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [CreateSignature](./createsignature/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | YAPILMADI. |
...
| void [SetHashAlgorithm](./sethashalgorithm/)([String](../../system/string/)) override | YAPILMADI. |
| void [SetKey](./setkey/)([SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](../asymmetricalgorithm/)\>) override | YAPILMADI. |
