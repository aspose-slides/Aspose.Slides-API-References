...
description: "يوفر مخزنًا لتنفيذ الاسترجاع. يجب تخصيص كائنات هذه الفئة فقط باستخدام الدالة System::MakeObject(). لا تقم بإنشاء نسخة من هذا النوع على المكدس أو باستخدام العامل new، لأنه سيؤدي إلى أخطاء تشغيلية و/أو أخطاء تأكيد. دائمًا غلف هذه الفئة في مؤشر System::SmartPtr واستخدم هذا المؤذر لتمريره إلى الدوال كوسيط."
type: docs
weight: 183
url: /ar/system.text/encoderfallbackbuffer/
---
## فئة EncoderFallbackBuffer

يوفر مخزن للتنفيذ الاحتياطي. يجب تخصيص كائنات هذه الفئة فقط باستخدام الدالة [System::MakeObject()](../../system/makeobject/). لا تقم بإنشاء نسخة من هذا النوع على المكدس أو باستخدام العامل new، لأن ذلك سيؤدي إلى أخطاء تشغيلية و/أو أخطاء تأكيد. دائمًا غلف هذه الفئة في مؤشر [System::SmartPtr](../../system/smartptr/) واستخدم هذا المؤشر لتمريره إلى الدوال كوسيط.
...
| virtual **bool** [Fallback](./fallback/)(char_t, int) | يطبق إجراء الاسترجاع الفعلي. |
| virtual **bool** [Fallback](./fallback/)(char_t, char_t, int) | يطبق إجراء الاسترجاع الفعلي. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | للاستخدام الداخلي فقط. |
| virtual int [get_Remaining](./get_remaining/)() const | يحصل على عدد الأحرف المتبقية ليتم معالجتها. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | يحصل على بنية عداد المرجع المرتبط بالكائن. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | مماثل لطريقة C# [Object.GetHashCode()](../../system/object/gethashcode/). يتيح تجزئة الكائنات المخصصة. |
| virtual char_t [GetNextChar](./getnextchar/)() | يستخرج الحرف التالي في مخزن الاسترجاع. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | يحصل على النوع الفعلي للكائن. مماثل لاستدعاء C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يتحقق ما إذا كان الكائن يمثل نسخة من النوع الموضح بواسطة targetType. مماثل لمعامل C# `is`. |
| void [Lock](../../system/object/lock/)() | يطبق قفل العبارة C# lock(). استدعِه مباشرة أو استخدم كائن الحارس [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | مماثل لطريقة C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). يتيح استنساخ الأنواع المخصصة. |
| virtual **bool** [MovePrevious](./moveprevious/)() | يحرك موضع المخزن خطوةً واحدةً إلى الخلف إذا أمكن. |
...
| virtual void [Reset](./reset/)() | يعيد تهيئة المخزن إلى وضعه الأولي. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يحدد الوسيط القالبية الـ n كمؤشر ضعيف (بدلاً من المشترك). يسمح بتحويل المؤشرات في الحاويات إلى الوضع الضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | يطبق إلغاء قفل العبارة C# lock(). استدعِه مباشرة أو استخدم كائن الحارس [LockContext](../../system/lockcontext/). |
...
| virtual  [~Object](../../system/object/~object/)() | يدمر الكائن. يفرغ جميع هياكل البيانات الداخلية. |
