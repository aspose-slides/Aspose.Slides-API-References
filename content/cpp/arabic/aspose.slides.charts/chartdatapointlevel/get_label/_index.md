...
description: يمثل تسمية البيانات لمستوى نقطة البيانات. يُطبق على أنواع Treemap و Sunburst sereis. للقراءة فقط IDataLabel.
type: docs
weight: 14
url: /ar/aspose.slides.charts/chartdatapointlevel/get_label/
---
## ChartDataPointLevel::get_Label() طريقة


يمثّل تسمية البيانات لمستوى نقطة البيانات. يُطبق على أنواع Treemap و Sunburst sereis. للقراءة فقط [IDataLabel](../../idatalabel/).
