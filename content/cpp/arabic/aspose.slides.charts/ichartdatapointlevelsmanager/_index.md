...
---
## IChartDataPointLevelsManager فئة
...
| virtual **int32_t** [get_Count](./get_count/)() | يعيد عدد مستويات نقاط البيانات. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPointLevel](../ichartdatapointlevel/)\> [idx_get](./idx_get/)(**int32_t**) | يعيد كائن [IChartDataPointLevel](../ichartdatapointlevel/) للمستوى المحدد. |
...
| void [Lock](../../system/object/lock/)() | ينفذ قفل بيان C# lock(). يُستدعى مباشرة أو يستخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط النمطي n إلى مؤشر ضعيف (بدلاً من المشترك). يسمح بتحويل المؤشرات في الحاويات إلى وضع ضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | ينفذ إلغاء قفل بيان C# lock(). يُستدعى مباشرة أو يستخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
