...
description: "تمثيل قيمة مزدوجة يمكن تخزينها في مستند عرض تقديمي بصيغة pptx بطريقتين: 1) في خلية/خلايا من مصنف مرتبط بالمخطط؛ 2) كقيمة حرفية."
type: docs
weight: 456
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث يُعتبر NaNs متساويين على الرغم من أن IEC 60559:1989 يحدد أن NaN ليس مساوٍ لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث يُعتبر NaNs متساويين على الرغم من أن IEC 60559:1989 يحدد أن NaN ليس مساوٍ لأي قيمة، بما في ذلك NaN. |
...
| **double** [get_AsLiteralDouble](./get_asliteraldouble/)() override | يرجع القيمة كقيمة مزدوجة حرفية. اقرأ **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](./get_data/)() override | يرجع كائن البيانات. اقرأ [System::Object](../../system/object/). |
| [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](../basechartvalue/get_datasourcetype/)() override | يحدد ما إذا كانت خاصية AsCell أو AsCells أو AsLiteralString أو AsLiteralDouble هي الفعلية في الفئات المشتقة. بمعنى آخر، يحدد نوع قيمة خاصية Data. اقرأ [Charts::DataSourceType](../datasourcetype/). |
...
| void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) override | يضبط القيمة كقيمة مزدوجة حرفية. اكتب **double**. |
| void [set_Data](./set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | يضبط كائن البيانات. اكتب [System::Object](../../system/object/). |
| void [set_DataSourceType](../basechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) override | يحدد ما إذا كانت خاصية AsCell أو AsCells أو AsLiteralString أو AsLiteralDouble هي الفعلية في الفئات المشتقة. بمعنى آخر، يحدد نوع قيمة خاصية Data. اكتب [Charts::DataSourceType](../datasourcetype/). |
...
| **double** [ToDouble](./todouble/)() override | يحوّل إلى **double**. |
...
* فئة [IDoubleChartValue](../idoublechartvalue/)
