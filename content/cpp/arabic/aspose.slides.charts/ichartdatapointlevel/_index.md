...
description: يمثل مستوى نقطة البيانات. ينطبق على مخطط Treemap ومخطط Sunburst.
type: docs
weight: 703
url: /ar/aspose.slides.charts/ichartdatapointlevel/
---
## IChartDataPointLevel فئة

يمثل مستوى نقطة البيانات. ينطبق على مخطط Treemap ومخطط Sunburst.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | يمثل خصائص تنسيق مستوى نقطة البيانات. اقرأ [IFormat](../iformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | يمثل تسمية البيانات لمستوى نقطة البيانات. يُطبق على أنواع سلاسل Treemap و Sunburst. للقراءة فقط [IDataLabel](../idatalabel/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط المتغيّر النمطي الـ n إلى مؤشر ضعيف (بدلاً من المشترك). يسمح بتحويل المؤشرات في الحاويات إلى الوضع الضعيف. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | ينقص ويعيد عداد الإشارة المشتركة. لا يجب استدعاؤه مباشرة؛ استعمل المؤشرات الذكية أو ThisProtector. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | ينقص عداد الإشارة الضعيفة. لا يجب استدعاؤه مباشرة؛ استعمل المؤشرات الذكية أو ThisProtector. |
