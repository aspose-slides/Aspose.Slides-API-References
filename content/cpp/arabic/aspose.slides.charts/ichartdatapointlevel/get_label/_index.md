...
description: يمثل تسمية البيانات لمستوى نقطة البيانات. يُطبق على نوعي Treemap و Sunburst sereis. قراءة فقط IDataLabel.
type: docs
weight: 14
url: /ar/aspose.slides.charts/ichartdatapointlevel/get_label/
---
## IChartDataPointLevel::get_Label() طريقة

يمثل تسمية البيانات لمستوى نقطة البيانات. يُطبق على نوعي Treemap و Sunburst sereis. قراءة فقط [IDataLabel](../../idatalabel/).
...
* فئة [IDataLabel](../../idatalabel/)
* فئة [IChartDataPointLevel](../)
