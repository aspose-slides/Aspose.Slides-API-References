...
description: يمثل نصًا قابلًا للتجاوز لمخطط.
type: docs
weight: 1145
url: /ar/aspose.slides.charts/ioverridabletext/
---
## IOverridableText فئة
...
| الطريقة | الوصف |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\> [AddTextFrameForOverriding](./addtextframeforoverriding/)([System::String](../../system/string/)) | تهيئة TextFrameForOverriding بالنص الموجود في المتغير "text". إذا كان TextFrameForOverriding قد تم تهيئته بالفعل فسيتم تعديل نصه فقط. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextFrame](../../aspose.slides/itextframe/)\> [get_TextFrameForOverriding](./get_textframeforoverriding/)() | يمكن أن يحتوي على نص منسق غني. إذا لم تكن هذه الخاصية null فستتجاوز قيمة النص المنسق النص المولد تلقائيًا. النص المولد تلقائيًا هو خاصية ضمنية لتسمية البيانات، تسمية وحدة العرض للمحور القيمي، عنوان المحور، عنوان المخطط، تسمية خط الاتجاه. يُنسق النص المولد تلقائيًا باستخدام الخاصية [IFormattedTextContainer::get_TextFormat](../iformattedtextcontainer/get_textformat/). للقراءة فقط [ITextFrame](../../aspose.slides/itextframe/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط معامل القالب رقم n'th إلى مؤشر ضعيف (بدلاً من المشترك). يسمح بتحويل المؤشرات داخل الحاويات إلى الوضع الضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | يطبق فك قفل عبارة C# lock(). استدعِ مباشرة أو استخدم كائن الحارس [LockContext](../../system/lockcontext/). |
