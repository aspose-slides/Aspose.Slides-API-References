...
description: يوفر إمكانية الوصول إلى أشرطة الصعود/الهبوط في مخطط الخط أو المخطط الشريطي.
type: docs
weight: 1249
url: /ar/aspose.slides.charts/iupdownbarsmanager/
---
## IUpDownBarsManager فئة

يوفر إمكانية الوصول إلى أشرطة الصعود/الهبوط في مخطط الخط أو المخطط الشريطي.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | يعيد تنسيق الأشرطة السفلية. للقراءة فقط [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | يعيد عرض الفجوة. قراءة **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | يحدد ما إذا كان المخطط يحتوي على أشرطة صعود/هبوط. قراءة **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | يعيد تنسيق الأشرطة العلوية. للقراءة فقط [IFormat](../iformat/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يتحقق مما إذا كان الكائن يمثل مثالا للنوع الموصوف بـ targetType. مكافئ لمعامل C# 'is'. |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | يضبط عرض الفجوة. كتابة **int32_t**. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | يحدد ما إذا كان المخطط يحتوي على أشرطة صعود/هبوط. كتابة **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط القالبي الـ n'th ليكون مؤشرًا ضعيفًا (بدلاً من المشترك). يسمح بتحويل المؤشرات في الحاويات إلى الوضع الضعيف. |
