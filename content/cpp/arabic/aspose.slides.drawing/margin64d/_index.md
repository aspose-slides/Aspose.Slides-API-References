...
type: docs
weight: 14
url: /ar/aspose.slides.drawing/margin64d/
---
## Margin64d فئة
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaNين متساويتين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaNين متساويتين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
...
| void [Lock](../../system/object/lock/)() | ينفذ قفل عبارة C# lock(). يتم استدعاؤه مباشرة أو باستخدام كائن [LockContext](../../system/lockcontext/) الحارس. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ نسخ. لا ينسخ شيئاً فعلياً، بل يهيئ كائناً جديداً ويسمح بإنشاء نسخ فرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عامل الإسناد. لا ينسخ شيئاً فعلياً، بل يهيئ كائناً جديداً ويسمح بإنشاء نسخ فرعية. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | تناظر طريقة C# Object.ToString(). يتيح تحويل الكائنات المخصصة إلى سلسلة. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | ينفذ بناء جملة C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | ينفذ إلغاء قفل عبارة C# lock(). يتم استدعاؤه مباشرة أو باستخدام كائن [LockContext](../../system/lockcontext/) الحارس. |
