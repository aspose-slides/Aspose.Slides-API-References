...
description: كائن غير قابل للتغيير يمثل تأثير صبغة. يغيّر قيم لون التأثير نحو/بعيدًا عن اللون الأساسي بالمقدار المحدد.
type: docs
weight: 1002
url: /ar/aspose.slides.effects/itinteffectivedata/
---
## ITintEffectiveData فئة

كائن غير قابل للتغيير يمثل تأثير [Tint](../tint/). يغيّر قيم لون التأثير نحو/بعيدًا عن اللون الأساسي بالمقدار المحدد.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaNs مساوية على الرغم من أن IEC 60559:1989 تنص على أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaNs مساوية على الرغم من أن IEC 60559:1989 تنص على أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| virtual **float** [get_Amount](./get_amount/)() | يرجع مقدار التأثير. للقراءة فقط **float**. |
| virtual **float** [get_Hue](./get_hue/)() | يرجع اللون الأساسي. للقراءة فقط **float**. |
