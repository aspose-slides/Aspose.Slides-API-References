...
description: يمثل تأثير ظل مُحدَّد مسبقًا.
type: docs
weight: 911
...
| virtual [PresetShadowType](../../aspose.slides/presetshadowtype/) [get_Preset](./get_preset/)() | الإعداد المسبق. قراءة [PresetShadowType](../../aspose.slides/presetshadowtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | لون الظل. للقراءة فقط [IColorFormat](../../aspose.slides/icolorformat/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ النسخ. لا ينسخ أي شيء فعليًا، بل يهيّء كائنًا جديدًا ويفتح إمكانية إنشاء نسخ من الفئات الفرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عامل الإسناد. لا ينسخ أي شيء فعليًا، بل يهيّء كائنًا جديدًا ويفتح إمكانية إنشاء نسخ من الفئات الفرعية. |
...
| virtual void [set_Preset](./set_preset/)([PresetShadowType](../../aspose.slides/presetshadowtype/)) | الإعداد المسبق. كتابة [PresetShadowType](../../aspose.slides/presetshadowtype/). |
