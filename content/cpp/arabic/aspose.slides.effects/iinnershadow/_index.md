...
type: docs
weight: 768
url: /ar/aspose.slides.effects/iinnershadow/
---
## IInnerShadow فئة
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يقلد مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaNانان متساويتين بالرغم من أن معيار IEC 60559:1989 يحدد أن NaN لا تساوي أي قيمة، بما فيها NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يقلد مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaNانان متساويتين بالرغم من أن معيار IEC 60559:1989 يحدد أن NaN لا تساوي أي قيمة، بما فيها NaN. |
...
| virtual **float** [get_Direction](./get_direction/)() | اتجاه الظل. قراءة **float**. |
| virtual **double** [get_Distance](./get_distance/)() | مسافة الظل. قراءة **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | لون الظل. قراءة فقط [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | تحقق ما إذا كان الكائن يمثل نسخة من النوع الوصَف بـ targetType. مماثل لمشغل C# 'is'. |
...
| virtual void [set_Direction](./set_direction/)(**float**) | اتجاه الظل. كتابة **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | مسافة الظل. كتابة **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط القالب الـ n كإشارة ضعيفة (بدلاً من المشتركة). يتيح تحويل الإشارات في الحاويات إلى الوضع الضعيف. |
