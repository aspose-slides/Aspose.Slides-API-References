...
description: يمثل تأثير Blur يُطبق على الشكل بالكامل، بما في ذلك التعبئة. جميع قنوات اللون، بما في ذلك قناة ألفا، تتأثر.
type: docs
weight: 456
...
يمثل تأثير [Blur](../blur/) يُطبق على الشكل بأكمله، بما في ذلك التعبئة. تتأثر جميع قنوات اللون، بما في ذلك ألفا.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | تحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعتبر NaNانان متساويين بالرغم من أنه وفقًا للمعيار IEC 60559:1989 لا يُعد NaN مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | تحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعتبر NaNانان متساويين بالرغم من أنه وفقًا للمعيار IEC 60559:1989 لا يُعد NaN مساويًا لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| virtual **bool** [get_Grow](./get_grow/)() | يحدد ما إذا كان يجب توسيع حدود الكائن نتيجة للتشويه. يشير True إلى توسيع الحدود بينما يشير false إلى عدم ذلك. قراءة **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | يعيد نصف قطر الضبابية. قراءة **double**. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | تحقق مما إذا كان الكائن يمثل نسخة من النوع الموصوف بواسطة targetType. تمثيل لمشغل C# 'is'. |
...
| virtual void [set_Grow](./set_grow/)(**bool**) | يحدد ما إذا كان يجب توسيع حدود الكائن نتيجة للتشويه. يشير True إلى توسيع الحدود بينما يشير false إلى عدم ذلك. كتابة **bool**. |
| virtual void [set_Radius](./set_radius/)(**double**) | يضبط نصف قطر الضبابية. كتابة **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط القالب n'th إلى مؤشر ضعيف (بدلاً من مشترك). يسمح بتبديل المؤشرات في الحاويات إلى وضع ضعيف. |
