...
second_title: المرجع API لـ Aspose.Slides للـ C++
description: كائن غير قابل للتغيير يمثل تأثير Alpha Bi-Level. قيم Alpha (الشفافية) الأقل من العتبة تتحول إلى 0 (شفاف بالكامل) والقيم الأكبر من أو المساوية للعتبة تتحول إلى 100% (معتم بالكامل).
type: docs
weight: 248
url: /ar/aspose.slides.effects/ialphabileveleffectivedata/
---
## IAlphaBiLevelEffectiveData فئة


كائن غير قابل للتغيير يمثل تأثير Alpha Bi-Level. قيم Alpha (Opacity) الأقل من الحد تُصبح 0 (شفافة بالكامل) والقيم الأكبر من أو المساوية للحد تُصبح 100% (معتمة بالكامل).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث تُعتبر NaN اثنان متساويين رغم أن IEC 60559:1989 تقول إن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث تُعتبر NaN اثنان متساويين رغم أن IEC 60559:1989 تقول إن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| virtual **float** [get_Threshold](./get_threshold/)() | يرجع حد التأثير. فقط للقراءة **float**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط النمطي n'th إلى مؤشر ضعيف (بدلاً من المشترك). يسمح بتحويل المؤشرات في الحاويات إلى وضع ضعيف. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | ينقص ويُعيد عداد المرجع المشترك. لا يجب استدعاؤه مباشرةً؛ بدلاً من ذلك، استخدم المؤشرات الذكية أو ThisProtector. |
