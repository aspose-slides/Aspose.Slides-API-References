...
يمثّل تأثير [BrightnessContrast](./). يضبط السطوع والتباين
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | يحدد ما إذا كان [BrightnessContrast](./) المحدد يساوي [BrightnessContrast](./) الحالي. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaNانٍ متساويتين بالرغم من أن IEC 60559:1989 تُعرّف NaN بأنها غير مساوية لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaNانٍ متساويتين بالرغم من أن IEC 60559:1989 تُعرّف NaN بأنها غير مساوية لأي قيمة، بما في ذلك NaN. |
...
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IPresentationComponent](../../aspose.slides/ipresentationcomponent/)\> [get_Parent_IPresentationComponent](../../aspose.slides/ipviobject/get_parent_ipresentationcomponent/)() | يرجع العنصر الأصل [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). قراءة فقط [IPresentationComponent](../../aspose.slides/ipresentationcomponent/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | يحصل على بنية بيانات عداد المرجع المرتبطة بالكائن. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBrightnessContrastEffectiveData](../ibrightnesscontrasteffectivedata/)\> [GetEffective](./geteffective/)() override | يحصل على بيانات تأثير [BrightnessContrast](./) الفعّالة مع تطبيق الوراثة. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط وسيطة القالب n كإشارة ضعيفة (بدلاً من مشتركة). يسمح بتحويل المؤشرات في الحاويات إلى وضع ضعيف. |
...
* فئة [IBrightnessContrast](../ibrightnesscontrast/)
