...
description: كائن غير قابل للتغيير يمثل تأثير تغيير اللون. يتم استبدال مثيلات FromColor بمثيلات ToColor.
type: docs
weight: 521
url: /ar/aspose.slides.effects/icolorchangeeffectivedata/
---
## IColorChangeEffectiveData فئة

كائن غير قابل للتغيير يمثل تأثير تغيير اللون. يتم استبدال مثيلات FromColor بمثيلات ToColor.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث تُعتبر NaN مساوية ل NaN بالرغم من أن IEC 60559:1989 تُنص على أن NaN لا تساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث تُعتبر NaN مساوية ل NaN بالرغم من أن IEC 60559:1989 تُنص على أن NaN لا تساوي أي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | للأغراض الداخلية فقط. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_FromColor](./get_fromcolor/)() | اللون الذي سيُستبدَل. لقراءة فقط [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ToColor](./get_tocolor/)() | اللون الذي سيستبدل. لقراءة فقط [System::Drawing::Color](../../system.drawing/color/). |
| virtual **bool** [get_UseAlpha](./get_usealpha/)() | يُعيد قيمة منطقية تحدد ما إذا كان ينبغي استخدام مكوّن ألفا. لقراءة فقط **bool**. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يتحقق ما إذا كان الكائن يمثل نسخة من النوع الموضح بـ targetType. تماثل عامل C# `is`. |
| void [Lock](../../system/object/lock/)() | ينفّذ تعبير القفل C# lock(). استدعِ مباشرة أو استخدم كائن الحارس [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | مُنشئ النسخ. لا ينسخ شيء فعليًا، بل يهيئ كائنًا جديدًا ويسمح بإنشاء نسخ من الفئات الفرعية. |
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | يقارن مرجعًا للكائن القيمي مع nullptr. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط القالب الـ n'th إلى مؤشر ضعيف (بدلاً من المشترك). يسمح بتغيير المؤشرات في الحاويات إلى الوضع الضعيف. |
