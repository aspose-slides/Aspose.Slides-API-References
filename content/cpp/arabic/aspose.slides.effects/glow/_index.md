...
description: يمثل تأثير Glow، حيث يتم إضافة حدود ملونة مشوشة خارج حواف الكائن.
type: docs
weight: 196
...
يمثل تأثير [Glow](./)، حيث يتم إضافة حدود ملونة مشوشة خارج حواف الكائن.
...
| طريقة | الوصف |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | يحدد ما إذا كان [Glow](./) المحدد يساوي [Glow](./) الحالي. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعامل NaNانان كمتساويين رغم أن معيار IEC 60559:1989 يحدد أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعامل NaNانان كمتساويين رغم أن معيار IEC 60559:1989 يحدد أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() override | تنسيق اللون. [IColorFormat](../../aspose.slides/icolorformat/) للقراءة فقط. |
...
| **double** [get_Radius](./get_radius/)() override | نصف القطر. قراءة **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IGlowEffectiveData](../igloweffectivedata/)\> [GetEffective](./geteffective/)() override | يحصل على بيانات تأثير [Glow](./) الفعلية مع تطبيق الوراثة. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يتحقق مما إذا كان الكائن يمثل مثيلاً للنوع الموصوف بـ targetType. مكافئ للمشغل C# 'is'. |
...
| void [set_Radius](./set_radius/)(**double**) override | نصف القطر. كتابة **double**. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | يقلل ويُعيد عداد المرجع المشترك. لا يجب استدعاؤه مباشرة؛ استخدم المؤشرات الذكية أو ThisProtector بدلاً من ذلك. |
