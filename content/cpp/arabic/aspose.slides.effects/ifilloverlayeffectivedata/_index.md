...
description: كائن غير قابل للتغيير يمثل تأثير Fill Overlay. قد يُستخدم Fill Overlay لتحديد تعبئة إضافية لكائن ودمج التعبئتين معًا.
type: docs
weight: 625
url: /ar/aspose.slides.effects/ifilloverlayeffectivedata/
---
## IFillOverlayEffectiveData فئة

كائن غير قابل للتغيير يمثل تأثير تغطية التعبئة. يمكن استخدام تغطية التعبئة لتحديد تعبئة إضافية لكائن ودمج التعبئتين معًا.
...
| virtual [FillBlendMode](../../aspose.slides/fillblendmode/) [get_Blend](./get_blend/)() | FillBlendMode. للقراءة فقط [FillBlendMode](../../aspose.slides/fillblendmode/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/)\> [get_FillFormat](./get_fillformat/)() | Fill format. للقراءة فقط [IFillFormatEffectiveData](../../aspose.slides/ifillformateffectivedata/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يتحقق مما إذا كان الكائن يمثل مثيلة من النوع الموصوف بـ targetType. تناظر عامل C# 'is'. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ النسخ. لا ينسخ أي شيء فعلاً، فقط يهيئ كائنًا جديدًا ويسمح بنسخ البنى للطبقات الفرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عامل الإسناد. لا ينسخ أي شيء فعلاً، فقط يهيئ كائنًا جديدًا ويسمح بنسخ البنى للطبقات الفرعية. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط القالبي n كإشارة ضعيفة (بدلاً من المشتركة). يسمح بتحويل المؤشرات في الحاويات إلى الوضع الضعيف. |
