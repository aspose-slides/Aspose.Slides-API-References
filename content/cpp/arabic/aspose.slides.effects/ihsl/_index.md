...
description: يمثل تأثير درجة اللون/الإشباع/الإضاءة. يمكن تعديل كل من درجة اللون والإشباع والإضاءة نسبة إلى قيمتها الحالية.
type: docs
weight: 690
...
يمثل تأثير درجة اللون/الإشباع/الإضاءة. يمكن تعديل كل من درجة اللون والإشباع والإضاءة نسبة إلى قيمتها الحالية.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث يُعتبر NaNانانين مساويين رغم أنه وفقًا للمعيار IEC 60559:1989 لا يُعتبر NaN مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث يُعتبر NaNانانين مساويين رغم أنه وفقًا للمعيار IEC 60559:1989 لا يُعتبر NaN مساويًا لأي قيمة، بما في ذلك NaN. |
...
| void [Lock](../../system/object/lock/)() | ينفذ قفل بيان C# lock(). يتم الاستدعاء مباشرة أو باستخدام كائن الحراسة [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيطة النموذجية رقم n إلى مؤشر ضعيف (بدلاً من المشترك). يسمح بتحويل المؤشرات في الحاويات إلى وضع ضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | ينفذ إلغاء قفل بيان C# lock(). يتم الاستدعاء مباشرة أو باستخدام كائن الحراسة [LockContext](../../system/lockcontext/). |
