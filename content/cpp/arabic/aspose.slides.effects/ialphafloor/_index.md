...
description: يمثل تأثير Alpha Floor. يتم تغيير قيم Alpha (الشفافية) الأقل من 100٪ إلى صفر. بعبارة أخرى، أي شيء شفاف جزئيًا يصبح شفافًا بالكامل.
type: docs
weight: 287
...
يمثل تأثير Alpha Floor. يتم تغيير قيم Alpha (الشفافية) الأقل من 100٪ إلى صفر. بعبارة أخرى، أي شيء شبه شفاف يصبح شفافًا بالكامل.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة الأعداد العائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين على الرغم من أنه وفقًا لـ IEC 60559:1989 لا يساوي NaN أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة الأعداد العائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين على الرغم من أنه وفقًا لـ IEC 60559:1989 لا يساوي NaN أي قيمة، بما في ذلك NaN. |
...
| void [Lock](../../system/object/lock/)() | ينفّذ قفل جملة C# lock(). يُستدعى مباشرة أو يُستخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | نظير طريقة C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). يتيح استنساخ الأنواع المخصصة. |
|  [Object](../../system/object/object/)() | ينشئ كائنًا. يهيء جميع بنى البيانات الداخلية. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ نسخة. لا ينسخ شيئًا فعليًا، بل يهيء كائنًا جديدًا ويسمح بالنسخ لبناء الفئات الفرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عامل الإسناد. لا ينسخ شيئًا فعليًا، بل يهيء كائنًا جديدًا ويسمح بالنسخ لبناء الفئات الفرعية. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط المعامل النمطي الـ n't إلى مؤشر ضعيف (بدلاً من المشترك). يسمح بتبديل المؤشرات في الحاويات إلى الوضع الضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | ينفّذ إلغاء قفل جملة C# lock(). يُستدعى مباشرة أو يُستخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
