...
description: يمثل تأثير Alpha Floor. يتم تحويل قيم ألفا (الشفافية) التي تقل عن 100٪ إلى صفر. بمعنى آخر، أي شيء شبه شفاف يصبح شفافًا بالكامل.
type: docs
weight: 27
...
| الطريقة | الوصف |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | يحدد ما إذا كان [AlphaFloor](./) المحدد يساوي [AlphaFloor](./) الحالي. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يقلد مقارنة الأعداد العائمة بأسلوب C# حيث تعتبر قيمتي NaN متساويتين رغم أن وفقًا للمعيار IEC 60559:1989 فإن NaN لا تساوي أي قيمة، بما فيها NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يقلد مقارنة الأعداد العائمة بأسلوب C# حيث تعتبر قيمتي NaN متساويتين رغم أن وفقًا للمعيار IEC 60559:1989 فإن NaN لا تساوي أي قيمة، بما فيها NaN. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloorEffectiveData](../ialphaflooreffectivedata/)\> [GetEffective](./geteffective/)() override | يحصل على بيانات تأثير Alpha Floor الفعلية مع تطبيق الوراثة. |
...
| void [Lock](../../system/object/lock/)() | يطبق عبارة القفل lock() في C#. استدعِها مباشرة أو استخدم كائن الحارس [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ النسخة. لا ينسخ شيئًا فعليًا، فقط يهيئ كائنًا جديدًا ويسمح بإنشاء نسخ من الفئات الفرعية. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط القالبي n كمرجع ضعيف (بدلاً من مشترك). يسمح بتحويل المؤشرات في الحاويات إلى الوضع الضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | يطبق بيان فك القفل lock() في C#. استدعِها مباشرة أو استخدم كائن الحارس [LockContext](../../system/lockcontext/). |
