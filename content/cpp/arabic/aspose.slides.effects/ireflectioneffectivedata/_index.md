...
description: كائن غير قابل للتغيير يمثل تأثير الانعكاس.
type: docs
weight: 950
url: /ar/aspose.slides.effects/ireflectioneffectivedata/
---
## فئة IReflectionEffectiveData

كائن غير قابل للتغيير يمثل تأثير [Reflection](../reflection/).
...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) نصف القطر. للقراءة فقط **double**. |
| virtual **float** [get_Direction](./get_direction/)() | اتجاه الانعكاس. للقراءة فقط **float**. |
| virtual **double** [get_Distance](./get_distance/)() | مسافة الانعكاس. للقراءة فقط **double**. |
| virtual **float** [get_EndPosAlpha](./get_endposalpha/)() | يحدد موضع النهاية (على مدرج تدرج ألفا) لقيمة ألفا النهائية (بنسبة مئوية). للقراءة فقط **float**. |
| virtual **float** [get_EndReflectionOpacity](./get_endreflectionopacity/)() | شفافية الانعكاس النهائية. (بنسبة مئوية). للقراءة فقط **float**. |
| virtual **float** [get_FadeDirection](./get_fadedirection/)() | يحدد الاتجاه لإزاحة الانعكاس. (زاوية). للقراءة فقط **float**. |
| virtual [RectangleAlignment](../../aspose.slides/rectanglealignment/) [get_RectangleAlign](./get_rectanglealign/)() | محاذاة المستطيل. للقراءة فقط [RectangleAlignment](../../aspose.slides/rectanglealignment/). |
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | يحدد ما إذا كان يجب أن يدور الانعكاس مع الشكل إذا تم تدوير الشكل. للقراءة فقط **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | يحدد عامل المقياس الأفقي، حيث يسبب المقياس السالب انعكاسًا. (بنسبة مئوية) للقراءة فقط **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | يحدد عامل المقياس العمودي، حيث يسبب المقياس السالب انعكاسًا. (بنسبة مئوية) للقراءة فقط **double**. |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | يحدد زاوية الانحراف الأفقي. للقراءة فقط **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | يحدد زاوية الانحراف العمودي. للقراءة فقط **double**. |
| virtual **float** [get_StartPosAlpha](./get_startposalpha/)() | يحدد موضع البداية (على مدرج تدرج ألفا) لقيمة ألفا البداية (بنسبة مئوية). للقراءة فقط **float**. |
| virtual **float** [get_StartReflectionOpacity](./get_startreflectionopacity/)() | شفافية الانعكاس الابتدائية. (بنسبة مئوية). للقراءة فقط **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ نسخة. لا ينسخ أي شيء فعلاً، فقط يهيئ كائنًا جديدًا ويسمح بإنشاء نسخ من الفئات الفرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عامل الإسناد. لا ينسخ أي شيء فعلاً، فقط يهيئ كائنًا جديدًا ويسمح بإنشاء نسخ من الفئات الفرعية. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | يقارن الكائنات بالمرجع. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | يقارن الكائنات بالمرجع. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | يقارن كائن النوع القيمي بالمرجع مع nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | تحصيل [Object::ReferenceEquals](../../system/object/referenceequals/) لحالة السلسلة و nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | تحصيل [Object::ReferenceEquals](../../system/object/referenceequals/) لحالة السلاسل. |
