...
description: كائن غير قابل للتغيير يمثل تأثير Duotone. لكل بكسل، يجمع clr1 و clr2 عبر استيفاء خطي لتحديد اللون الجديد لذلك البكسل.
type: docs
weight: 573
url: /ar/aspose.slides.effects/iduotoneeffectivedata/
---
## IDuotoneEffectiveData الصنف

كائن غير قابل للتغيير يمثل تأثير [Duotone](../duotone/). لكل بكسل، يجمع clr1 و clr2 عبر استيفاء خطي لتحديد اللون الجديد لذلك البكسل.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث يُعتبر NaNانان متساويين بالرغم من أنه وفقًا لـ IEC 60559:1989 لا يُعتبر NaN مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث يُعتبر NaNانان متساويين بالرغم من أنه وفقًا لـ IEC 60559:1989 لا يُعتبر NaN مساويًا لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | للاستخدامات الداخلية فقط. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color1](./get_color1/)() | يرجع تنسيق اللون المستهدف للبكسلات الداكنة. قراءة فقط [System::Drawing::Color](../../system.drawing/color/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color2](./get_color2/)() | يرجع تنسيق اللون المستهدف للبكسلات الفاتحة. قراءة فقط [System::Drawing::Color](../../system.drawing/color/). |
...
| void [Lock](../../system/object/lock/)() | ينفّذ تأمين عبارة C# lock(). يُستدعى مباشرة أو يستخدم كائن الحارس [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | مماثل لطريقة C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). يتيح استنساخ الأنواع المخصصة. |
|  [Object](../../system/object/object/)() | ينشئ الكائن. يهيئ جميع البُنى الداخلية. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط النوني للقالب كإشارة ضعيفة (بدلاً من مشتركة). يسمح بتحويل المؤشرات في الحاويات إلى الوضع الضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | ينفّذ إلغاء تأمين عبارة C# lock(). يُستدعى مباشرة أو يستخدم كائن الحارس [LockContext](../../system/lockcontext/). |
...
* الصنف [IEffectEffectiveData](../ieffecteffectivedata/)
