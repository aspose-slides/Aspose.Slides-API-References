...
description: يمثل تأثير عكس ألفا. قيم ألفا (الشفافية) تُعكس بطرحها من 100%.
type: docs
weight: 313
...
يمثل تأثير عكس ألفا. قيم ألفا (الشفافية) تُعكسة بطرحها من 100٪.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة نقطية عائمة بنمط C# حيث يُعتبر NaNان متساويين بالرغم من أن IEC 60559:1989 تقول إن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة نقطية عائمة بنمط C# حيث يُعتبر NaNان متساويين بالرغم من أن IEC 60559:1989 تقول إن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | تحقق مما إذا كان الكائن يمثل مثيلًا للنوع الموصوف بـ targetType. مماثل لمعامل C# 'is'. |
| void [Lock](../../system/object/lock/)() | ينفّذ عبارة القفل C# lock() للتأمين. استدعِ مباشرةً أو استخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | ينفّذ عبارة فك القفل C# lock() للتفكيك. استدعِ مباشرةً أو استخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
