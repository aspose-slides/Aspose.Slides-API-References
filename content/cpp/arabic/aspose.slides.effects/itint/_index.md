...
description: يمثل تأثير Tint. يغيّر قيم لون التأثير باتجاه/بعيدًا عن درجة اللون بالكمية المحددة.
type: docs
weight: 989
...
يمثل تأثير [Tint](../tint/). يغيّر قيم ألوان التأثير باتجاه/بعيدًا عن درجة اللون بالكمية المحددة.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يقوم بمحاكاة مقارنة الأعداد العائمة بأسلوب C# حيث يُعتبر NaNين متساويين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN ليس متساويًا مع أي قيمة، بما فيها NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يقوم بمحاكاة مقارنة الأعداد العائمة بأسلوب C# حيث يُعتبر NaNين متساويين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN ليس متساويًا مع أي قيمة، بما فيها NaN. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يفحص ما إذا كان الكائن يمثل نسخة من النوع الموصوف بواسطة targetType. تماثل معامل C# 'is'. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ النسخة. لا ينسخ شيئًا فعليًا، وإنما يهيئ كائنًا جديدًا ويسمح بإنشاء نسخ من الفئات الفرعية. |
