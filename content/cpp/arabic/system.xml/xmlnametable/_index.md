...
description: جدول كائنات السلاسل المُذَّات.
type: docs
weight: 313
url: /ar/system.xml/xmlnametable/
---
## XmlNameTable فئة

جدول كائنات السلاسل المُذَّات.
...
| الطريقة | الوصف |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | عند تجاوزها في فئة مشتقة، تُذَات السلسلة المحددة وتضيفها إلى [XmlNameTable](./). |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | عند تجاوزها في فئة مشتقة، تُذَات السلسلة المحددة وتضيفها إلى [XmlNameTable](./). |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | عند تجاوزها في فئة مشتقة، يحصل على السلسلة المُذَّات التي تحتوي على نفس الأحرف كما النطاق المحدد من الأحرف في المصفوفة المعطاة. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | عند تجاوزها في فئة مشتقة، يحصل على السلسلة المُذَّات التي تحتوي على نفس القيمة كالسلسلة المحددة. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | يحصل على هيكل بيانات عداد المرجع المرتبط بالكائن. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | تماثل طريقة C# [Object.GetHashCode()](../../system/object/gethashcode/). تمكّن تجزئة (hashing) الكائنات المخصصة. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | مُنشئ نسخ. لا ينسخ أي شيء فعليًا، بل يهيئ كائنًا جديدًا ويسمح بإنشاء نسخ فرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | معامل إسناد. لا ينسخ أي شيء فعليًا، بل يهيئ كائنًا جديدًا ويسمح بإنشاء نسخ فرعية. |
...
| void [Unlock](../../system/object/unlock/)() | يطبق إلغاء القفل لتعبير C# lock(). استدعِه مباشرة أو استخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
