...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقاط العائمة بأسلوب C# حيث يُعتَبَر NaNانان متساويين بالرغم من أن وفقًا لمعيار IEC 60559:1989 NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقاط العائمة بأسلوب C# حيث يُعتَبَر NaNانان متساويين بالرغم من أن وفقًا لمعيار IEC 60559:1989 NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../../aspose.slides/ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() override | يرجع تنسيق تأثير. فقط للقراءة [IEffectFormat](../../aspose.slides/ieffectformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../../aspose.slides/ithreedformat/)\> [get_ThreeDFormat](./get_threedformat/)() override | يرجع تنسيق ثلاثي الأبعاد. فقط للقراءة [IThreeDFormat](../../aspose.slides/ithreedformat/). |
...
| void [Lock](../../system/object/lock/)() | ينفذ قفل جملة C# lock(). يُستدعى مباشرةً أو يُستخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ نسخة. لا ينسخ شيئًا فعليًا، فقط يهيئ كائنًا جديدًا ويسمح ببناء النسخ من الفئات الفرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عامل الإسناد. لا ينسخ شيئًا فعليًا، فقط يهيئ كائنًا جديدًا ويسمح ببناء النسخ من الفئات الفرعية. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | يضبط المتغير النمطي الـ n't بمؤشر ضعيف (بدلاً من المشترك). يسمح بتحويل المؤشرات في الحاويات إلى وضع ضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | ينفذ إلغاء قفل جملة C# lock(). يُستدعى مباشرةً أو يُستخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
