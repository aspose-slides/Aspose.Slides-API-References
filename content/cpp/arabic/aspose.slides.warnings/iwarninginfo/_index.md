...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث يُ considered NaNانان متساويين على الرغم من أنه وفقًا لـ IEC 60559:1989 لا يكون NaN مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث يُ considered NaNانان متساويين على الرغم من أنه وفقًا لـ IEC 60559:1989 لا يكون NaN مساويًا لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | يرجع وصفًا قابلًا للقراءة للإنسان لهذا التحذير. للقراءة فقط [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](./get_warningtype/)() | يرجع نوعًا من التحذير. للقراءة فقط [IWarningInfo::get_WarningType](./get_warningtype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ نسخ. لا ينسخ شيئًا في الواقع، فقط يهيئ كائنًا جديدًا ويُتيح إنشاء نسخ من الفئات الفرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عامل الإسناد. لا ينسخ شيئًا في الواقع، فقط يهيئ كائنًا جديدًا ويُتيح إنشاء نسخ من الفئات الفرعية. |
...
| virtual void [SendWarning](./sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | إذا لم يكن المستقبل فارغًا، ينهي التحذير إلى المستقبل المحدد ويرمي استثناء AbortRequestedException إذا قرر المستقبل إلغاء العملية. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضع الوسيط n-th في القالب إلى مؤشر ضعيف (بدلاً من مشترك). يسمح بتبديل المؤشرات في الحاويات إلى وضع ضعيف. |
...
* مساحة اسم [Aspose::Slides::Warnings](../)
* مكتبة [Aspose.Slides](../../)