...
description: يمثل تحذيرًا حول مشكلة معروفة لن يتم إصلاحها في المستقبل القريب.
type: docs
weight: 1
url: /ar/aspose.slides.warnings/iknownissuewarninginfo/
---
## IKnownIssueWarningInfo فئة


يمثل تحذيرًا حول مشكلة معروفة لن يتم إصلاحها في المستقبل القريب.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة نقاط عائمة على نمط C# حيث تُعتبر قيمتا NaN متساويتين رغم أن IEC 60559:1989 تقول إن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة نقاط عائمة على نمط C# حيث تُعتبر قيمتا NaN متساويتين رغم أن IEC 60559:1989 تقول إن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| virtual [System::String](../../system/string/) [get_Description](../iwarninginfo/get_description/)() | يُعيد وصفًا قابلًا للقراءة من قبل الإنسان لهذا التحذير. قراءة فقط [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](../iwarninginfo/get_warningtype/)() | يُعيد نوع التحذير. قراءة فقط [IWarningInfo::get_WarningType](../iwarninginfo/get_warningtype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | مُنشئ نسخة. لا ينسخ أي شيء فعليًا، فقط يهيئ كائنًا جديدًا ويُمكّن من إنشاء نسخ فرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عامل الإسناد. لا ينسخ أي شيء فعليًا، فقط يهيئ كائنًا جديدًا ويُمكّن من إنشاء نسخ فرعية. |
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | إذا لم يكن المستقبل فارغًا، ينهي التحذير إلى المستقبل المحدد ويرمي استثناء AbortRequestedException إذا قرر المستقبل إلغاء العملية. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يعيّن الوسيط القالب الـ n إلى مؤشر ضعيف (بدلاً من مشترك). يسمح بتبديل المؤشرات في الحاويات إلى الوضع الضعيف. |
...
* نطاق الأسماء [Aspose::Slides::Warnings](../)
* مكتبة [Aspose.Slides](../../)