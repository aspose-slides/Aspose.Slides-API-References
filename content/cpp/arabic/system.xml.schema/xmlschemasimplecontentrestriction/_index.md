...
description: يمثل عنصر التقييد للمحتوى البسيط من مخطط XML كما هو محدد من قبل منظمة الويب العالمية (W3C). يمكن استخدام هذه الفئة لاشتقاق الأنواع البسيطة عن طريق التقييد. يمكن استخدام مثل هذه الاشتقاقات لتقليل نطاق القيم للعنصر إلى مجموعة فرعية من القيم المحددة في النوع البسيط الموروث.
type: docs
weight: 820
url: /ar/system.xml.schema/xmlschemasimplecontentrestriction/
---
## XmlSchemaSimpleContentRestriction الفئة


Represents the **restriction** element for simple content from XML [Schema](../) as specified by the World Wide [Web](../../system.web/) Consortium (W3C). This هذه الفئة can be used to derive simple types by restriction. Such derivations can be used to restrict the range of values for the element to a subset of the values specified in the inherited simple type.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعتبر NaNانين متساويين على الرغم من أن معيار IEC 60559:1989 ينص على أن NaN ليس مساوياً لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعتبر NaNانين متساويين على الرغم من أن معيار IEC 60559:1989 وينص على أن NaN ليس مساوياً لأي قيمة، بما في ذلك NaN. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | يرجع مجموعة السمات [XmlSchemaAttribute](../xmlschemaattribute/) و [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) للنوع البسيط. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | يرجع قيمة القاعدة للنوع البسيط. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | يرجع اسم نوع البيانات المدمج أو النوع البسيط الذي يُشتق منه هذا النوع. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | يرجع واجهة [Xml](../../system.xml/)[Schema](../). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يفحص ما إذا كان الكائن يمثل مثيلاً للنوع الموضّح بـ targetType. نظير عامل C# 'is'. |
| void [Lock](../../system/object/lock/)() | يطبق قفل بيان C# lock(). يستدعى مباشرة أو يستخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
...
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | يضبط قيمة القاعدة للنوع البسيط. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | يضبط اسم نوع البيانات المدمج أو النوع البسيط الذي يُشتق منه هذا النوع. |
...
| void [Unlock](../../system/object/unlock/)() | ينفّذ فك قفل بيان C# lock(). يستدعى مباشرة أو يستخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
...
|  [XmlSchemaObject](../xmlschemaobject/xmlschemaobject/)() | يُهيئ مثيلاً جديدًا للفئة [XmlSchemaObject](../xmlschemaobject/). |
|  [XmlSchemaSimpleContentRestriction](./xmlschemasimplecontentrestriction/)() | يُهيئ مثيلاً جديدًا للفئة [XmlSchemaSimpleContentRestriction](./). |
...
يجب إنشاء كائنات هذه الفئة فقط باستخدام الدالة [System::MakeObject()](../../system/makeobject/). لا تقم بإنشاء مثيلات من هذا النوع على المكدس أو باستخدام المشغل new، لأن ذلك سيؤدي إلى أخطاء وقت التشغيل و/أو أخطاء التحقق. احرص دائماً على تغليف هذه الفئة في مؤشر [System::SmartPtr](../../system/smartptr/) واستخدام هذا المؤشر لتمريره إلى الدوال كمعامل.

## أنظر أيضًا

* الفئة [XmlSchemaContent](../xmlschemacontent/)
* فضاء الاسم [System::Xml::Schema](../)
