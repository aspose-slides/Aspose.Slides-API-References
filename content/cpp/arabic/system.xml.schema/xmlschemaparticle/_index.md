...
description: فئة أساسية هي الفئة الأساسية لجميع أنواع الجسيمات (مثال XmlSchemaAny).
type: docs
weight: 729
url: /ar/system.xml.schema/xmlschemaparticle/
---
## XmlSchemaParticle فئة

فئة أساسية هي الفئة الأساسية لجميع أنواع الجسيمات (مثال [XmlSchemaAny](../xmlschemaany/)).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعتبر NaNانان مساويين بالرغم من أن IEC 60559:1989 تقول إن NaN لا يساوي أي قيمة، بما فيها NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعتبر NaNانان مساويين بالرغم من أن IEC 60559:1989 تقول إن NaN لا يساوي أي قيمة، بما فيها NaN. |
...
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | يعيد موقع السطر في الملف الذي يشير إليه عنصر **schema**. |
| [Decimal](../../system/decimal/) [get_MaxOccurs](./get_maxoccurs/)() | يعيد الحد الأقصى لعدد مرات حدوث الجسيم. |
| [String](../../system/string/) [get_MaxOccursString](./get_maxoccursstring/)() | يعيد العدد كقيمة نصية. الحد الأقصى لعدد مرات حدوث الجسيم. |
| [Decimal](../../system/decimal/) [get_MinOccurs](./get_minoccurs/)() | يعيد الحد الأدنى لعدد مرات حدوث الجسيم. |
| [String](../../system/string/) [get_MinOccursString](./get_minoccursstring/)() | يعيد العدد كقيمة نصية. الحد الأدنى لعدد مرات حدوث الجسيم. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | يعيد السمات المؤهلة التي لا تنتمي إلى مساحة الأسماء المستهدفة للمخطط الحالي. |
...
| void [Lock](../../system/object/lock/)() | يطبق قفل عبارة C# lock(). استدعها مباشرة أو استخدم كائن الحارس [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ نسخة. لا ينسخ شيئًا فعليًا، فقط يهيء كائنًا جديدًا ويمكن من نسخ بناء الفئات الفرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عامل الإسناد. لا ينسخ شيئًا فعليًا، فقط يهيء كائنًا جديدًا ويمكن من نسخ بناء الفئات الفرعية. |
...
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, std::nullptr_t) | تحويل [Object::ReferenceEquals](../../system/object/referenceequals/) لحالة السلسلة و nullptr. |
| **bool** [ReferenceEquals](../../system/object/referenceequals/)([String](../../system/string/) const\&, [String](../../system/string/) const\&) | تحويل [Object::ReferenceEquals](../../system/object/referenceequals/) لحالة السلاسل. |
...
| void [set_MaxOccurs](./set_maxoccurs/)([Decimal](../../system/decimal/)) | يضبط الحد الأقصى لعدد مرات حدوث الجسيم. |
| void [set_MaxOccursString](./set_maxoccursstring/)(const [String](../../system/string/)\&) | يضبط العدد كقيمة نصية. الحد الأقصى لعدد مرات حدوث الجسيم. |
| void [set_MinOccurs](./set_minoccurs/)([Decimal](../../system/decimal/)) | يضبط الحد الأدنى لعدد مرات حدوث الجسيم. |
| void [set_MinOccursString](./set_minoccursstring/)(const [String](../../system/string/)\&) | يضبط العدد كقيمة نصية. الحد الأدنى لعدد مرات حدوث الجسيم. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | يضبط أصل هذا [XmlSchemaObject](../xmlschemaobject/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الحجة النونية للقالب إلى مؤشر ضعيف (بدلاً من المشترك). يتيح تبديل المؤشرات في الحاويات إلى وضع ضعيف. |
...
|  [XmlSchemaParticle](./xmlschemaparticle/)() | يهيء نسخة جديدة من الفئة [XmlSchemaParticle](./). |
