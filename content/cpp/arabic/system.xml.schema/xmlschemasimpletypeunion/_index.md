...
description: يمثل عنصر union للأنواع البسيطة من XML Schema كما حُدد من قبل الاتحاد العالمي للويب (W3C). يمكن استخدام نوع بيانات union لتحديد محتوى simpleType. يجب أن تكون قيمة عنصر simpleType إحدى مجموعة من الأنواع البديلة المحددة في union. تكون أنواع union دائمًا أنواعًا مشتقة ويجب أن تتضمن على الأقل نوعين بديلين.
type: docs
weight: 885
url: /ar/system.xml.schema/xmlschemasimpletypeunion/
---
## فئة XmlSchemaSimpleTypeUnion

يمثل العنصر **union** للأنواع البسيطة من XML [Schema](../) كما هو محدد من قبل اتحاد الويب العالمي [Web](../../system.web/) (W3C). يمكن استخدام نوع بيانات **union** لتحديد محتوى **simpleType**. يجب أن تكون قيمة عنصر **simpleType** أحد مجموعة من أنواع البيانات البديلة المحددة في الـ **union**. تكون أنواع الـ **union** دائمًا أنواعًا مشتقة ويجب أن تضم على الأقل نوعين بديلين.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | تحاكي مقارنة النقطة العائمة بنمط C# حيث يتم اعتبار NaNين مساويين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | تحاكي مقارنة النقطة العائمة بنمط C# حيث يتم اعتبار NaNين مساويين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\> [get_BaseMemberTypes](./get_basemembertypes/)() | يرجع مصفوفة من كائنات [XmlSchemaSimpleType](../xmlschemasimpletype/) تمثل نوع العنصر **simpleType** استنادًا إلى قيمتي [XmlSchemaSimpleTypeUnion::get_BaseTypes](./get_basetypes/) و [XmlSchemaSimpleTypeUnion::get_MemberTypes](./get_membertypes/) للنوع البسيط. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_BaseTypes](./get_basetypes/)() | يرجع مجموعة الأنواع الأساسية. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\> [get_MemberTypes](./get_membertypes/)() | يرجع مصفوفة من أسماء الأعضاء المؤهلة لأنواع البيانات المدمجة أو عناصر **simpleType** المعرفة في هذا المخطط (أو مخطط آخر يحدده الفضاء الاسمي المحدد). |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | يرجع السمات المؤهلة التي لا تنتمي إلى مساحة الاسم الهدف الحالية للمخطط. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | يقوم بخفض عداد الإشارة المشتركة بالقيمة المحددة. |
...
| void [set_MemberTypes](./set_membertypes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\>\&) | يضبط مصفوفة أسماء الأعضاء المؤهلة لأنواع البيانات المدمجة أو عناصر **simpleType** المعرفة في هذا المخطط (أو مخطط آخر يحدده الفضاء الاسمي المحدد). |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | يضبط السمات المؤهلة التي لا تنتمي إلى مساحة الاسم الهدف الحالية للمخطط. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | ينقص ويُعيد عداد الإشارة المشتركة. لا ينبغي استدعاؤه مباشرة؛ استخدم المؤشرات الذكية أو ThisProtector. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | مماثل لطريقة C# [Object.ToString()](../../system/object/tostring/). يتيح تحويل الكائنات المخصصة إلى سلسلة. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | ينفّذ بنية C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | ينفّذ فك القفل لبيان C# lock(). استدعِه مباشرة أو استخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
...
|  [XmlSchemaObject](../xmlschemaobject/xmlschemaobject/)() | ينشئ نسخة جديدة من فئة [XmlSchemaObject](../xmlschemaobject/). |
|  [XmlSchemaSimpleTypeUnion](./xmlschemasimpletypeunion/)() | ينشئ نسخة جديدة من فئة [XmlSchemaSimpleTypeUnion](./). |
...
يجب تخصيص كائنات هذه الفئة فقط باستخدام الدالة [System::MakeObject()](../../system/makeobject/). لا تقم أبدًا بإنشاء نسخ من هذا النوع على مكدس أو باستخدام المشغل new، حيث سيؤدي ذلك إلى أخطاء وقت تشغيل أو أعطال تأكيد. احرص دائمًا على تغليف هذه الفئة في مؤشر [System::SmartPtr](../../system/smartptr/) واستخدام هذا المؤشر لتمريره إلى الدوال كمعامل. 
