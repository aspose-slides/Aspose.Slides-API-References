...
description: فئة أساسية لجميع الفواصل (facets) التي تُستخدم عندما يتم اشتقاق الأنواع البسيطة عبر التقييد.
type: docs
weight: 404
url: /ar/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet class

فئة أساسية لجميع الأنماط التي تُستخدم عندما يتم اشتقاق الأنواع البسيطة عبر التقييد.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaN مزدوجة متساوية على الرغم من أنه وفقًا للمعيار IEC 60559:1989 لا تكون NaN مساوية لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaN مزدوجة متساوية على الرغم من أنه وفقًا للمعيار IEC 60559:1989 لا تكون NaN مساوية لأي قيمة، بما في ذلك NaN. |
...
| virtual **bool** [get_IsFixed](./get_isfixed/)() | يعيد معلومات تشير إلى أن هذا facet ثابت. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | يعيد السمات المؤهلة التي لا تنتمي إلى النطاق الهدف للمخطط الحالي. |
| [String](../../system/string/) [get_Value](./get_value/)() | يعيد السمة **value** للـ facet. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يفحص ما إذا كان الكائن يمثل نسخة من النوع الموضّح بواسطة targetType. تناظر مشغل C# 'is'. |
...
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | يضبط معلومات تشير إلى أن هذا facet ثابت. |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | يضبط السمة **value** للـ facet. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط النوني للقالب كإشارة ضعيفة (بدلاً من مشتركة). يسمح بتحويل المؤشرات في الحاويات إلى وضع ضعيف. |
...
|  [XmlSchemaFacet](./xmlschemafacet/)() | يفعل مثيلاً جديدًا من الفئة [XmlSchemaFacet](./). |
|  [XmlSchemaObject](../xmlschemaobject/xmlschemaobject/)() | يفعل مثيلاً جديدًا من الفئة [XmlSchemaObject](../xmlschemaobject/). |
| virtual  [~Object](../../system/object/~object/)() | يفن الكائن. يحرّر جميع هياكل البيانات الداخلية. |
## Typedefs
...
يجب تخصيص كائنات هذه الفئة فقط باستخدام الدالة [System::MakeObject()](../../system/makeobject/). لا تُنشئ أبدًا نسخًا من هذا النوع على المكدس أو باستخدام المُعامل new، لأن ذلك سيؤدي إلى أخطاء أثناء التشغيل و/أو أخطاء تأكيد. دائمًا غلف هذه الفئة في مؤشر [System::SmartPtr](../../system/smartptr/) واستخدم هذا المؤشر لتمريره إلى الدوال كمعامل. 
