...
description: فئة أساسية لتعريف الجوانب العددية. هذه الفئة هي الفئة الأساسية لفئات الجوانب العددية مثل XmlSchemaMinLengthFacet.
type: docs
weight: 664
url: /ar/system.xml.schema/xmlschemanumericfacet/
---
## فئة XmlSchemaNumericFacet

فئة أساسية لتعريف **numeric** facets. هذه الفئة هي الفئة الأساسية لفئات الجوانب العددية مثل [XmlSchemaMinLengthFacet](../xmlschemaminlengthfacet/).
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعتبر NaNانان متساويين رغم أنه وفقًا لـ IEC 60559:1989 لا يُعتبر NaN مساويًا لأي قيمة، بما في ذلك NaN. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | يرجع السمة **value** للجانب. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يفحص إذا ما كان الكائن يمثل نسخة من النوع الموصوف بـ targetType. مكافئ لمشغل C# 'is'. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | يضبط السمة **value** للجانب. |
