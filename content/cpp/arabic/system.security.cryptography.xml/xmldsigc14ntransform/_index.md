...
description: "يمثل تحويل التقييس XML C14N لتوقيع رقمي بدون تعليقات. يجب تخصيص كائنات هذه الفئة فقط باستخدام الدالة System::MakeObject(). لا تقم أبداً بإنشاء نسخة من هذا النوع على المكدس أو باستخدام العامل new، لأن ذلك سيسبّب أخطاء وقت تشغيل أو أخطاء في التأكيد. دائماً غلف هذه الفئة بمؤشر System::SmartPtr واستخدم هذا المؤ marcador لتمريره إلى الدوال كوسيط."
type: docs
weight: 170
url: /ar/system.security.cryptography.xml/xmldsigc14ntransform/
---
## XmlDsigC14NTransform class

يمثل تحويل التقييس XML C14N لتوقيع رقمي بدون تعليقات. يجب أن تُنشأ كائنات هذه الفئة فقط باستخدام الدالة [System::MakeObject()](../../system/makeobject/). لا تقم أبداً بإنشاء نسخة من هذا النوع على المكدس أو باستخدام العامل new، لأن ذلك سيسبّب أخطاء وقت تشغيل أو أخطاء في التأكيد. دائماً غلف هذه الفئة بالمؤشر [System::SmartPtr](../../system/smartptr/) واستخدم هذا المؤشر لتمريره إلى الدوال كوسيط.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث يُ considered NaNين متساويين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث يُ considered NaNين متساويين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ النسخة. لا ينسخ أي شيء فعليًا، بل يهيّء كائنًا جديدًا ويسمح بإنشاء نسخ فرعية. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | يقلّ عدّاد المرجع المشترك بالقيمة المحددة. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط القالبي n كمرجع ضعيف (بدلاً من المشترك). يسمح بتحويل المؤشرات في الحاويات إلى الوضع الضعيف. |
