...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaN اثنان متساويتان بالرغم من أن معيار IEC 60559:1989 يحدد أن NaN غير مساوي لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaN اثنان متساويتان بالرغم من أن معيار IEC 60559:1989 يحدد أن NaN غير مساوي لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | يحصل على لون الفرشاة للخط. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | يحصل على نوع تأثير الحبر (مثال: Galaxy، Gold، Silver) الذي يحدد النمط البصري لضربة الحبر. يتم استخراج القيمة من الخاصية "inkEffects" للفرشاة. إذا لم يتم تحديد أي تأثير معروف، يتم إرجاع [InkEffectType::NotDefined](../inkeffecttype/). |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | يحصل على حجم الفرشاة للخط بالنقاط. |
...
| void [Lock](../../system/object/lock/)() | ينفذ عملية القفل في تعبير C# lock(). يتم الاستدعاء مباشرة أو باستخدام كائن [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)() | ينشئ كائنًا. يهيء جميع البنيات الداخلية. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | يضبط لون الفرشاة للخط. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | يضبط حجم الفرشاة للخط بالنقاط. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يعيّن الوسيط القالب رقم n إلى مؤشر ضعيف (بدلاً من المشترك). يسمح بتحويل المؤشرات في الحاويات إلى وضع ضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | ينفذ فك القفل في تعبير C# lock(). يتم الاستدعاء مباشرة أو باستخدام كائن [LockContext](../../system/lockcontext/). |
...
| virtual  [~Object](../../system/object/~object/)() | يدمر الكائن. يحرّر جميع البنيات الداخلية. |
