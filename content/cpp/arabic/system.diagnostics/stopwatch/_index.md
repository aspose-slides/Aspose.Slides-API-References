...
description: "يسمح بقياس الوقت. يجب تخصيص كائنات هذه الفئة فقط باستخدام الدالة System::MakeObject(). لا تُنشئ نسخة من هذا النوع على المكدس أو باستخدام العامل new، حيث سيتسبب ذلك في أخطاء وقت تشغيل أو أعطال في التأكيد. دائمًا غلف هذه الفئة في مؤشر System::SmartPtr واستخدم هذا المؤشر لتمريره إلى الدوال كمعامل."
type: docs
weight: 79
url: /ar/system.diagnostics/stopwatch/
---
## فئة Stopwatch
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | تحاكي مقارنة النقطة العائمة بنمط C# حيث يُعتبر NaNان متساويين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | تحاكي مقارنة النقطة العائمة بنمط C# حيث يُعتبر NaNان متساويين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| [TimeSpan](../../system/timespan/) [get_Elapsed](./get_elapsed/)() const | يحصل على الوقت المنقضي الكلي المقاس بواسطة النسخة الحالية. |
| **int64_t** [get_ElapsedMilliseconds](./get_elapsedmilliseconds/)() const | يحصل على الوقت المنقضي الكلي المقاس بواسطة النسخة الحالية، بالملليثانية. |
| **int64_t** [get_ElapsedTicks](./get_elapsedticks/)() const | يحصل على الوقت المنقضي الكلي المقاس بواسطة النسخة الحالية، بعدد نبضات المؤقت. |
| **bool** [get_IsRunning](./get_isrunning/)() const | يتحقق مما إذا كان Stopwatch جارى التشغيل. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ النسخ. لا ينسخ شيئًا في الواقع، فقط يهيئ كائنًا جديدًا ويمكّن إنشاء نسخ من الفئات الفرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عامل الإسناد. لا ينسخ شيئًا في الواقع، فقط يهيئ كائنًا جديدًا ويمكّن إنشاء نسخ من الفئات الفرعية. |
...
| void [Reset](./reset/)() | يوقف قياس الوقت، يضبط الفاصل الزمني المقاس إلى الصفر. |
| void [Restart](./restart/)() | يضبط الفاصل الزمني المقاس إلى الصفر، ثم يبدأ قياس الوقت. |
...
| void [Start](./start/)() | يبدأ قياس الوقت. |
| static [SharedPtr](../../system/sharedptr/)\<[Stopwatch](./)\> [StartNew](./startnew/)() | ينشئ كائن [Stopwatch](./) جديد ويبدأ القياس. |
| void [Stop](./stop/)() | يوقف قياس الوقت. |
...
| void [Unlock](../../system/object/unlock/)() | ينفّذ رفع القفل في عبارة C# lock(). استدعِه مباشرة أو استخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
...
* مساحة الأسماء [System::Diagnostics](../)
