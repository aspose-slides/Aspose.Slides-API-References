...
description: غلاف ينشئ تنفيذًا غير عام لـ IEnumerator فوق Iterator العام IEnumeratorImplRefType - غلاف للأنواع المرجعية.
type: docs
weight: 79
url: /ar/system.collections/ienumeratorimplreftype/
---
## IEnumeratorImplRefType فئة

الـ Wrapper الذي ينشئ تنفيذًا غير عام [IEnumerator](../ienumerator/) فوق Iterator عام [IEnumeratorImplRefType](./) - غلاف للأنواع المرجعية.
...
| الطريقة | الوصف |
| --- | --- |
| virtual const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\& [Current](../ienumerator/current/)() const | يحصل على العنصر الحالي. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يقوم بمحاكاة مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمة NaN مزدوجة متساوية على الرغم من أن IEC 60559:1989 تنص على أن NaN لا تساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يقوم بمحاكاة مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمة NaN مزدوجة متساوية على الرغم من أن IEC 60559:1989 تنص على أن NaN لا تساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يقوم بمحاكاة مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمة NaN مزدوجة متساوية على الرغم من أن IEC 60559:1989 تنص على أن NaN لا تساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يقوم بمحاكاة مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمة NaN مزدوجة متساوية على الرغم من أن IEC 60559:1989 تنص على أن NaN لا تساوي أي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| const [SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\& [get_Current](./get_current/)() const override | يحصل على العنصر الحالي. |
...
|  [IEnumeratorImplRefType](./ienumeratorimplreftype/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<T\>\>\>) | منشئ الغلاف |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | تحقق مما إذا كان الكائن يمثل مثالًا من النوع الموصوف بـ targetType. نظير عامل C# 'is'. |
...
| **bool** [MoveNext](./movenext/)() override | ينقل المتكرر إلى العنصر التالي. إذا لم يتم الإشارة إلى أي عنصر من قبل، يحدد المرجع على أول عنصر متاح. إذا تم الوصول إلى نهاية الحاوية، لا يفعل شيئًا. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | يقلل عداد المرجع المشترك بالقيمة المحددة. |
| virtual void [Reset](../ienumerator/reset/)() | يعيد تعيين المتكرر إلى الموضع قبل العنصر الأول. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط معامل القالب الـ n مؤشرًا ضعيفًا (بدلاً من المشترك). يسمح بتحويل المؤشرات في الحاويات إلى الوضع الضعيف. |
