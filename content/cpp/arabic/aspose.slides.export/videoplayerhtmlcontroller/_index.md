...
description: تتيح هذه الفئة تصدير ملفات الفيديو والصوت إلى HTML
type: docs
weight: 781
url: /ar/aspose.slides.export/videoplayerhtmlcontroller/
---
## VideoPlayerHtmlController فئة
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط النمطي n كمرجع ضعيف (بدلاً من مشترك). يسمح بتحويل المؤشرات في الحاويات إلى وضع ضعيف. |
...
|  [VideoPlayerHtmlController](./videoplayerhtmlcontroller/)([System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) | ينشئ نسخة جديدة من المتحكم |
...
* الفئة [IVideoPlayerHtmlController](../ivideoplayerhtmlcontroller/)
