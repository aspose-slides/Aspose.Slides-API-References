...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaN مزدوجة متساوية رغم أن معيار IEC 60559:1989 ينص على أن NaN ليست مساوية لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر NaN مزدوجة متساوية رغم أن معيار IEC 60559:1989 ينص على أن NaN ليست مساوية لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | للاستخدام الداخلي فقط. |
| **bool** [get_HideInk](./get_hideink/)() override | يعرض أو يخفي عناصر [Ink](../../aspose.slides.ink/) في المستند المُصدَّر. |
| **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() override | يستخدم عملية ROP أو الشفافية لتصيير الفرشاة. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يفحص ما إذا كان الكائن يمثل مثيلًا من النوع الموصوف بـ targetType. مماثل للمؤشر 'is' في C#. |
| void [Lock](../../system/object/lock/)() | يطبق قفل تعبير C# lock(). استدع مباشرة أو استخدم كائن المراقبة [LockContext](../../system/lockcontext/). |
...
| void [set_HideInk](./set_hideink/)(**bool**) override | يعرض أو يخفي عناصر [Ink](../../aspose.slides.ink/) في المستند المُصدَّر. |
| void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) override | يستخدم عملية ROP أو الشفافية لتصيير الفرشاة. |
...
| void [Unlock](../../system/object/unlock/)() | يطبق إلغاء قفل تعبير C# lock(). استدع مباشرة أو استخدم كائن المراقبة [LockContext](../../system/lockcontext/). |
...
* فئة [IInkOptions](../iinkoptions/)
* نطاق اسم [Aspose::Slides::Export](../)
* مكتبة [Aspose.Slides](../../)