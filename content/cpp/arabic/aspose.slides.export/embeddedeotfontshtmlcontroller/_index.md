...
description: فئة وحدة التحكم في التنسيق لاستخدامها في تضمين الخطوط بتنسيق EOT
type: docs
weight: 14
url: /ar/aspose.slides.export/embeddedeotfontshtmlcontroller/
---
## EmbeddedEotFontsHtmlController الفئة
...
| الطريقة | الوصف |
| --- | --- |
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)() | ينشئ مثيلًا جديدًا. |
|  [EmbeddedEotFontsHtmlController](./embeddedeotfontshtmlcontroller/)([System::SharedPtr](../../system/sharedptr/)\<[IHtmlFormattingController](../ihtmlformattingcontroller/)\>) | ينشئ مثيلًا جديدًا. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يمثل مقارنة نقطية عائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين بالرغم من أنه وفقًا لمعيار IEC 60559:1989 لا يكون NaN مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يمثل مقارنة نقطية عائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين بالرغم من أنه وفقًا لمعيار IEC 60559:1989 لا يكون NaN مساويًا لأي قيمة، بما في ذلك NaN. |
...
* الفئة [IEmbeddedEotFontsHtmlController](../iembeddedeotfontshtmlcontroller/)
