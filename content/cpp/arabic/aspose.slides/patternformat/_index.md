...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_BackColor](./get_backcolor/)() override | يرجع لون نمط الخلفية. قراءة فقط [IColorFormat](../icolorformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_ForeColor](./get_forecolor/)() override | يرجع لون نمط المقدمة. قراءة فقط [IColorFormat](../icolorformat/). |
...
| [Aspose::Slides::PatternStyle](../patternstyle/) [get_PatternStyle](./get_patternstyle/)() override | يرجع أسلوب النمط. قراءة [Slides::PatternStyle](../patternstyle/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | يحصل على بنية عداد المرجع المرتبطة بالكائن. |
| **int32_t** [GetHashCode](../pviobject/gethashcode/)() const override | يرجع قيمة التجزئة. |
| [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/), [System::Drawing::Color](../../system.drawing/color/)) override | ينشئ صورة بلاط لملء النمط بألوان محددة. |
| [System::SharedPtr](../../system/sharedptr/)\<[IImage](../iimage/)\> [GetTile](./gettile/)([System::Drawing::Color](../../system.drawing/color/)) override | ينشئ صورة بلاط لملء النمط. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ نسخ. لا ينسخ شيئًا في الواقع، وإنما يهيئ كائنًا جديدًا ويتيح إنشاء نسخ من الفئات الفرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | عامل الإسناد. لا ينسخ شيئًا في الواقع، وإنما يهيئ كائنًا جديدًا ويتيح إنشاء نسخ من الفئات الفرعية. |
...
| void [set_PatternStyle](./set_patternstyle/)([Aspose::Slides::PatternStyle](../patternstyle/)) override | يضبط نمط النمط. كتابة [Slides::PatternStyle](../patternstyle/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيطة النمذجية رقم n إلى مؤشر ضعيف (بدلاً من المشترك). يسمح بتبديل المؤشرات في الحاويات إلى الوضع الضعيف. |
...
* الفئة [IPatternFormat](../ipatternformat/)
