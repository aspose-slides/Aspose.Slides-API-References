...
type: docs
weight: 807
url: /ar/aspose.slides/domobject/
---
## فئة DomObject

الأساسي [DOM](../../aspose.slides.dom/) كائن
...
| المعامل | الوصف |
| --- | --- |
| TParent | نوع كائن [DOM](../../aspose.slides.dom/) الأب |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | تحقق ما إذا كان الكائن يمثل مثيلاً للنوع الموصوف بـ targetType. نظير عامل C# 'is'. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | يضبط الوسيط القالبي n كإشارة ضعيفة (بدلاً من مشاركة). يسمح بتحويل المؤشرات في الحاويات إلى وضع ضعيف. |
