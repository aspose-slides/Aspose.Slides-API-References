...
description: يراجع تنسيق ملء العلامة النقطية لفقرة. للقراءة فقط IFillFormatEffectiveData.
type: docs
weight: 131
url: /ar/aspose.slides/ibulletformateffectivedata/get_fillformat/
---
## IBulletFormatEffectiveData::get_FillFormat() طريقة

يرجع تنسيق ملء العلامة النقطية لفقرة. للقراءة فقط [IFillFormatEffectiveData](../../ifillformateffectivedata/).
...
هذا المثال يوضح استرجاع البيانات الفعلية لملء العلامة النقطية. 
```cpp
...
// إخراج معلومات حول نقاط الفقرات النصية
...
* فئة [IFillFormatEffectiveData](../../ifillformateffectivedata/)
* فئة [IBulletFormatEffectiveData](../)
