...
| الطريقة | الوصف |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::String](../../system/string/)) override | يضيف جزء XML مخصص جديد. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | يضيف جزء XML مخصص جديد. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | يضيف جزء XML مخصص جديد. |
| [iterator](./iterator/) [begin](./begin/)() | يحصل على مكرر يشير إلى العنصر الأول (إن وجد) من المجموعة. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | يحصل على مكرر يشير إلى العنصر الأول (إن وجد) من النسخة المؤهلة ثابتًا من المجموعة. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | يحصل على مكرر يشير إلى العنصر الأول الثابت (إن وجد) من المجموعة. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | يحصل على مكرر يشير مباشرة بعد العنصر الأخير الثابت (إن وجد) من المجموعة. |
| void [Clear](./clear/)() override | يزيل جميع العناصر من المجموعة. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>\>, **int32_t**) override | نسخ إلى المصفوفة المحددة. |
...
| [iterator](./iterator/) [end](./end/)() | يحصل على مكرر يشير مباشرة بعد العنصر الأخير (إن وجد) من المجموعة. |
| [const_iterator](./const_iterator/) [end](./end/)() const | يحصل على مكرر يشير مباشرة بعد العنصر الأخير (إن وجد) من النسخة المؤهلة ثابتًا من المجموعة. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة نقطية بنمط C# حيث تُعتبر NaN قيمتين مساويتين رغم أن معيار IEC 60559:1989 يحدد أن NaN لا يساوي أي قيمة، بما فيها NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة نقطية بنمط C# حيث تُعتبر NaN قيمتين مساويتين رغم أن معيار IEC 60559:1989 يحدد أن NaN لا يساوي أي قيمة، بما فيها NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | للأغراض الداخلية فقط. |
| **int32_t** [get_Count](./get_count/)() override | يعيد عدد أجزاء XML المخصصة في المجموعة. قراءة فقط **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | يعيد جذراً للمزامنة. قراءة فقط [System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | يحصل على بنية عداد المرجع المرتبط بالكائن. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>\>\> [GetEnumerator](./getenumerator/)() override | يعيد مُعددًا يتنقل عبر المجموعة. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [idx_get](./idx_get/)(**int32_t**) override | يعيد العنصر في الفهرس المحدد. |
...
| T [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)() | يحسب متوسط سلسلة من القيم العددية. |
| ResultType [LINQ_Average](../../system.collections.generic/ienumerable/linq_average/)(const [Func](../../system/func/)\<T, ResultType\>\&) | يحسب متوسط سلسلة من القيم التي يتم الحصول عليها عبر استدعاء دالة تحويل على كل عنصر من التسلسل المدخل. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | يرتّب عناصر التسلسل ترتيبًا تصاعديًا وفقًا لقيم المفتاح المختارة بواسطة keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | يرتّب عناصر التسلسل ترتيبًا تنازليًا وفقًا لقيم المفتاح المختارة بواسطة keySelector. |
...
| void [Lock](../../system/object/lock/)() | ينفذ قفل بيان C# lock(). استدعِ مباشرة أو استخدم كائن الحماية [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ النسخ. لا ينسخ شيئًا فعليًا، بل يهيئ كائنًا جديدًا ويتيح إنشاء نسخة من الفئات الفرعية. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\>) override | يزيل الظهور الأول لكائن محدد من المجموعة. |
| void [RemoveAt](./removeat/)(**int32_t**) override | يزيل جزء XML مخصص عند الفهرس المحدد. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | ينقص عداد المرجع المشترك بالقيمة المحددة. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط النمطي الـ n't إلى مؤشر ضعيف (بدلاً من مشترك). يسمح بتغيير المؤشرات في الحاويات إلى الوضع الضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | ينفذ إلغاء قفل بيان C# lock(). استدعِ مباشرة أو استخدم كائن الحماية [LockContext](../../system/lockcontext/). |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | يحصل على مكرر يشير إلى العنصر الأول (إن وجد) من النسخة المؤهلة ثابتًا من المجموعة. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | يحصل على مكرر يشير إلى العنصر الأول (إن وجد) من المجموعة. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | يحصل على مكرر يشير مباشرة بعد العنصر الأخير (إن وجد) من النسخة المؤهلة ثابتًا من المجموعة. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | يحصل على مكرر يشير مباشرة بعد العنصر الأخير (إن وجد) من المجموعة. |
...
| النوع المعرف | الوصف |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | نوع مجموعة يتم استخدام أنواع مكرّراتها كأنواع مكرّر للنوع الحالي. |
...
* الفئة [ICustomXmlPartCollection](../icustomxmlpartcollection/)
