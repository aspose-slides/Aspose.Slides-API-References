...
description: "إعدادات عرض الشرائح الأساسية. السلف يمثل أنواع عرض الشرائح: PresentedBySpeaker مقدَّم من قبل المتحدث (ملء الشاشة) BrowsedByIndividual مُستعرض بواسطة فرد (نافذة) BrowsedAtKiosk مُستعرض في كشك (ملء الشاشة)"
type: docs
weight: 5227
...
إعدادات عرض الشرائح الأساسية. السلف يمثل أنواع عرض الشرائح: [PresentedBySpeaker](../presentedbyspeaker/) مقدم من قبل المتحدث (ملء الشاشة) [BrowsedByIndividual](../browsedbyindividual/) تم تصفحه من قبل فرد (نافذة) [BrowsedAtKiosk](../browsedatkiosk/) تم تصفحه في كشك (ملء الشاشة)
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث تُ considered two NaNs متساويتين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN ليست مساوية لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث تُ considered two NaNs متساويتين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN ليست مساوية لأي قيمة، بما في ذلك NaN. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يفحص إذا ما كان الكائن يمثل نسخة من النوع الموصوف بواسطة targetType. مماثل لمعامل C# 'is'. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يعيّن الوسيط النمطي الـ n't مؤشرًا ضعيفًا (بدلاً من المشترك). يتيح تحويل المؤشرات في الحاويات إلى وضع ضعيف. |
