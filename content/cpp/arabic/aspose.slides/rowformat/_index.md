...
| virtual ASPOSE_SLIDES_LOCAL_API **uint32_t** [get_Version](../ipviobject/get_version/)() | الإصدار. قراءة فقط **uint32_t**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | يحصل على بنية عداد المرجع المرتبطة بالكائن. |
| [System::SharedPtr](../../system/sharedptr/)\<[IRowFormatEffectiveData](../irowformateffectivedata/)\> [GetEffective](./geteffective/)() override | يحصل على خصائص تنسيق صف الجدول الفعّالة مع تطبيق الوراثة وأنماط الجدول. |
...
| void [Lock](../../system/object/lock/)() | ينفّذ جملة C# lock() لتقفل. استدع مباشرة أو استخدم كائن الحارس [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | بناء نسخة. لا ينسخ شيئًا فعليًا، بل يهيّء كائنًا جديدًا ويتيح نسخ بناء الفئات الفرعية. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | معامل الإسناد. لا ينسخ شيئًا فعليًا، بل يهيّء كائنًا جديدًا ويتيح نسخ بناء الفئات الفرعية. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | يضبط الوسيط النمطي رقم n كضعيفة (بدلًا من مشتركة). يتيح تحويل المؤشرات في الحاويات إلى وضع الضعيفة. |
...
| void [Unlock](../../system/object/unlock/)() | ينفّذ جملة C# lock() لإلغاء القفل. استدع مباشرة أو استخدم كائن الحارس [LockContext](../../system/lockcontext/). |
