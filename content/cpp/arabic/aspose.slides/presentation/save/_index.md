...
description: يقوم بحفظ جميع شرائح العرض التقديمي إلى ملف بالتنسيق المحدد.
type: docs
weight: 443
...
يقوم بحفظ جميع الشرائح في عرض تقديمي إلى ملف بالتنسيق المحدد.
...
| --- | --- | --- |
| fname | [System::String](../../../system/string/) | مسار الملف الذي تم إنشاؤه. |
...
يقوم بحفظ جميع الشرائح في عرض تقديمي إلى تدفق بالتنسيق المحدد.
...
| Parameter | Type | Description |
| --- | --- | --- |
| stream | [System::SharedPtr](../../../system/sharedptr/)\<[System::IO::Stream](../../../system.io/stream/)\> | تدفق الإخراج. |
| format | [Export::SaveFormat](../../../aspose.slides.export/saveformat/) | تنسيق البيانات المصدرة. |

## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) method

يقوم بحفظ جميع الشرائح في عرض تقديمي إلى ملف بالتنسيق المحدد ومع خيارات إضافية.
...
يظهر المثال التالي كيفية تحويل PowerPoint إلى HTML باستخدام C++.
```cpp
// ينشئ كائن عرض تقديمي يمثل ملف عرض تقديمي مثل PPT ، PPTX ، ODP إلخ.
...
```
يظهر المثال التالي كيفية تحويل PowerPoint إلى HTML استجابي باستخدام C++.
```cpp
...
// يحفظ العرض التقديمي إلى HTML
presentation->Save(u"ConvertPresentationToResponsiveHTML_out.html", SaveFormat::Html, htmlOptions);
```
يظهر المثال التالي كيفية تحويل PowerPoint إلى HTML مع الملاحظات باستخدام C++.
```cpp
...
```
يظهر المثال التالي كيفية تحويل PowerPoint إلى HTML مع الخطوط الأصلية باستخدام C++.
```cpp
auto pres = System::MakeObject<Presentation>(u"input.pptx");

// يستثني خطوط العرض التقديمي الافتراضية
...
```
يظهر المثال التالي كيفية تحويل PowerPoint إلى HTML مع صور عالية الجودة بدقة 150 DPI باستخدام C++.
```cpp
...
```
يظهر المثال التالي كيفية تحويل PowerPoint إلى HTML مع صور بجودة كاملة باستخدام C++.
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
يظهر المثال التالي كيفية تحويل [Slide](../../slide/) إلى HTML باستخدام C++.
```cpp
```
...
* فئة [ISaveOptions](../../../aspose.slides.export/isaveoptions/)
* فئة [IXamlOptions](../../../aspose.slides.export.xaml/ixamloptions/)
