...
description: يحصل على بيانات تنسيق ثلاثية الأبعاد الفعّالة مع تطبيق الوراثة.
type: docs
weight: 183
...
هذا المثال يوضح كيفية الحصول على الخصائص الفعّالة للكاميرا، وإطار الإضاءة، والحافة العلوية للشكل.
```cpp
...
* فئة [IThreeDFormatEffectiveData](../../ithreedformateffectivedata/)
* فئة [ThreeDFormat](../)
