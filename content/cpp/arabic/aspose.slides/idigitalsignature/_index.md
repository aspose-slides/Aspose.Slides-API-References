...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُ considered القيم NaN متساوية على الرغم من أن IEC 60559:1989 تقول إن NaN غير مساوية لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُ considered القيم NaN متساوية على الرغم من أن IEC 60559:1989 تقول إن NaN غير مساوية لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\> [get_Certificate](./get_certificate/)() | كائن الشهادة الذي تم استخدامه لتوقيع المستند. قراءة فقط [X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/). |
| virtual [System::String](../../system/string/) [get_Comments](./get_comments/)() | غرض التوقيع. قراءة [System::String](../../system/string/). |
| virtual **bool** [get_IsValid](./get_isvalid/)() | إذا كان هذا التوقيع الرقمي صالحًا ولم يتم العبث بالمستند، ستكون القيمة صحيحة. قراءة فقط **bool**. |
| virtual [System::DateTime](../../system/datetime/) [get_SignTime](./get_signtime/)() | الوقت الذي تم فيه توقيع المستند. قراءة فقط [System::DateTime](../../system/datetime/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | تحقق مما إذا كان الكائن يمثل مثالًا للنوع الموصوف بواسطة targetType. تناظر لمعامل C# 'is'. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | إنقاص عداد المرجع المشترك بقيمة محددة. |
| virtual void [set_Comments](./set_comments/)([System::String](../../system/string/)) | غرض التوقيع. كتابة [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يعيّن الوسيط القالبي الـ n كإشارة ضعيفة (بدلاً من مشتركة). يتيح تحويل المؤشرات في الحاويات إلى وضعية ضعيفة. |
