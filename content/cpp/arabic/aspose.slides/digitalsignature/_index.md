...
| الطريقة | الوصف |
| --- | --- |
|  [DigitalSignature](./digitalsignature/)([System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\>) | ينشئ كائنًا جديدًا من نوع [DigitalSignature](./) باستخدام الشهادة المحددة. |
|  [DigitalSignature](./digitalsignature/)([System::String](../../system/string/), [System::String](../../system/string/)) | ينشئ كائنًا جديدًا من نوع [DigitalSignature](./) باستخدام مسار ملف الشهادة المحدد وكلمة المرور. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | يقارن الكائنات باستخدام قواعد C# [Object.Equals](../../system/object/equals/). |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | يقارن كائنات النوع المرجعي بأسلوب C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | يقارن كائنات النوع القيمي بأسلوب C#. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يقلّد مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين رغم أن معيار IEC 60559:1989 يحدد أن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يقلّد مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين رغم أن معيار IEC 60559:1989 يحدد أن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Security::Cryptography::X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\> [get_Certificate](./get_certificate/)() override | كائن الشهادة الذي استُخدم لتوقيع المستند. للقراءة فقط [X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/). |
| [System::String](../../system/string/) [get_Comments](./get_comments/)() override | غرض التوقيع. قراءة [System::String](../../system/string/). |
| **bool** [get_IsValid](./get_isvalid/)() override | إذا كان هذا التوقيع الرقمي صالحًا ولم يتم تعديل المستند، ستكون القيمة صحيحة. للقراءة فقط **bool**. |
| [System::DateTime](../../system/datetime/) [get_SignTime](./get_signtime/)() override | وقت توقيع المستند. للقراءة فقط [System::DateTime](../../system/datetime/). |
...
| void [Lock](../../system/object/lock/)() | ينفّذ عملية القفل في تعبير C# lock(). استدعِه مباشرة أو استخدم كائن الحارس [LockContext](../../system/lockcontext/). |
...
| void [set_Comments](./set_comments/)([System::String](../../system/string/)) override | غرض التوقيع. كتابة [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط المتغيّر القالب الـ n كإشارة ضعيفة (بدلاً من المشتركة). يسمح بتحويل مؤشرات الحاويات إلى وضع ضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | ينفّذ فك القفل في تعبير C# lock(). استدعِه مباشرة أو استخدم كائن الحارس [LockContext](../../system/lockcontext/). |
...
المثال التالي يوضح كيفية إضافة توقيع رقمي من شهادة PFX في PowerPoint [Presentation](../presentation/). 
```cpp
...
```
الكود النموذجي التالي يوضح كيفية التحقق من صحة التوقيع الرقمي في PowerPoint [Presentation](../presentation/). 
```cpp
// تهيئة كائن Presentation
...
* الفئة [IDigitalSignature](../idigitalsignature/)
