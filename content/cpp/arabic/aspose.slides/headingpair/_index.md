...
description: يمثل خاصية 'Heading pair' للمستند. يشير إلى اسم مجموعة أجزاء المستند وعدد الأجزاء في المجموعة.
type: docs
weight: 1223
...
يمثل خاصية 'Heading pair' للمستند. يشير إلى اسم المجموعة لأجزاء المستند وعدد الأجزاء في المجموعة.
...
| **int32_t** [get_Count](./get_count/)() override | يرجع عدد الأجزاء في المجموعة. **int32_t** للقراءة فقط. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | يرجع اسم المجموعة لأجزاء المستند. [System::String](../../system/string/) للقراءة فقط. |
...
| void [Lock](../../system/object/lock/)() | تنفيذ قفل عبارة C# lock(). استدعِه مباشرة أو استخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط المتغير القالب الـ n كإشارة ضعيفة (بدلاً من مشاركة). يسمح بتحويل المؤشرات في الحاويات إلى وضع ضعيف. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | تنفيذ بناء جملة C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | تنفيذ إلغاء قفل عبارة C# lock(). استدعِه مباشرة أو استخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
