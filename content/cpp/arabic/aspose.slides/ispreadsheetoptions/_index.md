...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين رغم أنه وفقًا لمعيار IEC 60559:1989 فإن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين رغم أنه وفقًا لمعيار IEC 60559:1989 فإن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\> [get_PreferredCulture](./get_preferredculture/)() | يحصل على معلومات الثقافة المفضلة لحساب بعض الدوال المخصصة للغات التي تستخدم مجموعة الأحرف مزدوجة البايت (DBCS). |
| virtual **bool** [get_RecoverWorkbookFromChartCache](./get_recoverworkbookfromchartcache/)() | إذا كان مصدر البيانات للمخطط هو مصنف خارجي وغير متوفر، فسيتم استرجاعه من ذاكرة مخبئ المخطط. |
...
| void [Lock](../../system/object/lock/)() | ينفذ قفل بيان C# lock(). استدعِه مباشرة أو استخدم كائن الحماية [LockContext](../../system/lockcontext/). |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | يقلل عدّد المرجع المشترك بالقيمة المحددة. |
| virtual void [set_PreferredCulture](./set_preferredculture/)([System::SharedPtr](../../system/sharedptr/)\<[System::Globalization::CultureInfo](../../system.globalization/cultureinfo/)\>) | يضبط معلومات الثقافة المفضلة لحساب بعض الدوال المخصصة للغات التي تستخدم مجموعة الأحرف مزدوجة البايت (DBCS). |
| virtual void [set_RecoverWorkbookFromChartCache](./set_recoverworkbookfromchartcache/)(**bool**) | إذا كان مصدر البيانات للمخطط هو مصنف خارجي وغير متوفر، فسيتم استرجاعه من ذاكرة مخبئ المخطط. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط المعامل النمطي الـ n كإشارة ضعيفة (بدلاً من مشتركة). يسمح بتحويل المؤشرات في الحاويات إلى وضع ضعيف. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | ينقص ويعيد عدد المراجع المشتركة. لا يجب استدعاؤه مباشرة؛ استخدم المؤشرات الذكية أو ThisProtector. |
...
| void [Unlock](../../system/object/unlock/)() | ينفذ فك قفل بيان C# lock(). استدعِه مباشرة أو استخدم كائن الحماية [LockContext](../../system/lockcontext/). |
