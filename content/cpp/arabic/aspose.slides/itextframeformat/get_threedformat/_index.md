...
description: إرجاع كائن ThreeDFormat الذي يمثل خصائص التأثير ثلاثي الأبعاد للنص. IThreeDFormat للقراءة فقط.
type: docs
weight: 300
url: /ar/aspose.slides/itextframeformat/get_threedformat/
---
## ITextFrameFormat::get_ThreeDFormat() طريقة

تُرجِع الكائن [ThreeDFormat](../../threedformat/) الذي يمثل خصائص التأثير ثلاثي الأبعاد للنص. للقراءة فقط [IThreeDFormat](../../ithreedformat/).
...
* فئة [IThreeDFormat](../../ithreedformat/)
* فئة [ITextFrameFormat](../)
