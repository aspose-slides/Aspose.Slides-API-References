...
description: يمثل تنسيقًا للجدولة للنص.
type: docs
weight: 5370
...
| الطريقة | الوصف |
| --- | --- |
| **int32_t** [CompareTo](./compareto/)([System::SharedPtr](../../system/sharedptr/)\<[ITab](../itab/)\>) override | يقارن النسخة الحالية مع كائن آخر من نفس النوع. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | محاكاة مقارنة النقطة العائمة بنمط C# حيث تُ considered NaNانين متساويتين رغم أنه وفقًا للمعيار IEC 60559:1989، لا تكون NaN مساوية لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | محاكاة مقارنة النقطة العائمة بنمط C# حيث تُ considered NaNانين متساويتين رغم أنه وفقًا للمعيار IEC 60559:1989، لا تكون NaN مساوية لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() override | يعيد نمط المحاذاة للعلامة. قراءة [TabAlignment](../tabalignment/). |
...
| **double** [get_Position](./get_position/)() override | يعيد موضع العلامة. تعيين هذه الخاصية قد يغير فهرس العلامة في المجموعة ويؤدي إلى إبطال المؤشر. قراءة **double**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ نسخة. لا ينسخ شيئًا فعليًا، بل يهيئ كائنًا جديدًا ويسمح بنسخ البناء للمتفرعات. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | مشغل الإسناد. لا ينسخ شيئًا فعليًا، بل يهيئ كائنًا جديدًا ويسمح بنسخ البناء للمتفرعات. |
...
| void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) override | يضبط نمط المحاذاة للعلامة. كتابة [TabAlignment](../tabalignment/). |
| void [set_Position](./set_position/)(**double**) override | يضبط موضع العلامة. تعيين هذه الخاصية قد يغير فهرس العلامة في المجموعة ويؤدي إلى إبطال المؤشر. كتابة **double**. |
...
|  [Tab](./tab/)(**double**, [TabAlignment](../tabalignment/)) | ينشئ [Tab](./) جديدًا. |
