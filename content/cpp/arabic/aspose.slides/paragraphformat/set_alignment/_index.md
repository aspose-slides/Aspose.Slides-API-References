...
description: يضبط محاذاة النص في فقرة دون وراثة. اكتب TextAlignment.
type: docs
weight: 14
url: /ar/aspose.slides/paragraphformat/set_alignment/
---
## ParagraphFormat::set_Alignment(TextAlignment) طريقة

يضبط محاذاة النص في فقرة دون وراثة. اكتب [TextAlignment](../../textalignment/).
...
يعرض رمز العينة التالي كيفية محاذاة فقرات النص في PowerPoint [Presentation](../../presentation/).
