...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة نقطية عائمة بأسلوب C# حيث يُعتبر NaNانان مساويين على الرغم من أن IEC 60559:1989 يحدد أن NaN ليس مساوياً لأي قيمة، بما فيها NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة نقطية عائمة بأسلوب C# حيث يُعتبر NaNانان مساويين على الرغم من أن IEC 60559:1989 يحدد أن NaN ليس مساوياً لأي قيمة، بما فيها NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | يعيد التعليق الذي قام به هذا المؤلف في الفهرس المحدد. للقراءة فقط [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | يعيد مجموعة التعليقات التي قام بها هذا المؤلف. للقراءة فقط [ICommentCollection](../icommentcollection/). |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | يعيد الأحرف الأولى للمؤلف. قراءة [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | يعيد اسم المؤلف. قراءة [System::String](../../system/string/). |
...
| void [Remove](./remove/)() override | يزيل المؤلف من المجموعة الأصلية. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | يقلل عدّاد المرجع المشترك بالقيمة المحددة. |
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | يضبط الأحرف الأولى للمؤلف. كتابة [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | يضبط اسم المؤلف. كتابة [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط وسيط القالب الـ n't إلى مؤشر ضعيف (بدلاً من المشترك). يسمح بتحويل المؤشرات في الحاويات إلى الوضع الضعيف. |
...
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | مماثلة لطريقة C# [Object.ToString()](../../system/object/tostring/). تمكّن من تحويل الكائنات المخصصة إلى سلسلة. |
...
* الفئة [ICommentAuthor](../icommentauthor/)
