...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين رغم أن IEC 60559:1989 تُعرّف أن NaN لا تساوي أي قيمة، بما فيها NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين رغم أن IEC 60559:1989 تُعرّف أن NaN لا تساوي أي قيمة، بما فيها NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | للاستخدام الداخلي فقط. |
| **bool** [get_Loop](./get_loop/)() | تكرار [Slide](../slide/) العرض |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_PenColor](./get_pencolor/)() | لون القلم لـ [Slide](../slide/) العرض |
| **bool** [get_ShowAnimation](./get_showanimation/)() | إظهار [Animation](../../aspose.slides.animation/) في [Slide](../slide/) العرض |
| **bool** [get_ShowMediaControls](./get_showmediacontrols/)() const | إظهار عناصر تحكم الوسائط |
| **bool** [get_ShowNarration](./get_shownarration/)() | إظهار التعليق الصوتي في [Slide](../slide/) العرض |
| [System::SharedPtr](../../system/sharedptr/)\<[SlidesRange](../slidesrange/)\> [get_Slides](./get_slides/)() const | [Slides](../) نطاق |
| [System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::SlideShowType](../slideshowtype/)\> [get_SlideShowType](./get_slideshowtype/)() | يحصل على نوع عرض الشرائح. ممثل من خلال الأسلاف [SlideShowType](../slideshowtype/) التالية: [BrowsedAtKiosk](../browsedatkiosk/)، [PresentedBySpeaker](../presentedbyspeaker/) و [BrowsedByIndividual](../browsedbyindividual/) |
| **bool** [get_UseTimings](./get_usetimings/)() | استخدام التوقيتات في [Slide](../slide/) العرض |
...
| void [set_Loop](./set_loop/)(**bool**) | تكرار [Slide](../slide/) العرض |
| void [set_ShowAnimation](./set_showanimation/)(**bool**) | إظهار [Animation](../../aspose.slides.animation/) في [Slide](../slide/) العرض |
| void [set_ShowMediaControls](./set_showmediacontrols/)(**bool**) | إظهار عناصر تحكم الوسائط |
| void [set_ShowNarration](./set_shownarration/)(**bool**) | إظهار التعليق الصوتي في عرض [Slide](../slide/) |
| void [set_Slides](./set_slides/)([System::SharedPtr](../../system/sharedptr/)\<[SlidesRange](../slidesrange/)\>) | [Slides](../) نطاق |
| void [set_SlideShowType](./set_slideshowtype/)([System::SharedPtr](../../system/sharedptr/)\<[Aspose::Slides::SlideShowType](../slideshowtype/)\>) | يضبط نوع عرض الشرائح. ممثل من خلال الأسلاف [SlideShowType](../slideshowtype/) التالية: [BrowsedAtKiosk](../browsedatkiosk/)، [PresentedBySpeaker](../presentedbyspeaker/) و [BrowsedByIndividual](../browsedbyindividual/) |
| void [set_UseTimings](./set_usetimings/)(**bool**) | استخدام التوقيتات في [Slide](../slide/) العرض |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | تعيين الوسيط النمطي الـ n'th كإشارة ضعيفة (بدلاً من المشتركة). يسمح بتحويل المؤشرات في الحاويات إلى الوضع الضعيف. |
