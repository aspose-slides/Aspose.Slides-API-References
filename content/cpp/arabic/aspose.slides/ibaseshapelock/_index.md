...
description: يمثل قفل الشكل (عملية معطلة).
type: docs
weight: 1483
...
يمثل قفل [Shape](../shape/) (عملية معطلة).
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة الع浮ية بأسلوب C# حيث يُعتبر NaNانان متساويين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة الع浮ية بأسلوب C# حيث يُعتبر NaNانان متساويين على الرغم من أن معيار IEC 60559:1989 يحدد أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | للاستخدامات الداخلية فقط. |
| virtual **bool** [get_NoLocks](./get_nolocks/)() | يعيد true إذا تم تعطيل جميع أعلام القفل. قراءة فقط **bool**. |
...
| virtual  [~Object](../../system/object/~object/)() | يدمر الكائن. يُحرر جميع بنى البيانات الداخلية. |
