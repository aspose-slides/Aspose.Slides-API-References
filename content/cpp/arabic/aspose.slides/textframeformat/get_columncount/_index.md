...
description: يعيد عدد الأعمدة في منطقة النص. يجب أن تكون هذه القيمة عددًا موجبًا. وإلا، سيتم تعيين القيمة إلى صفر. القيمة 0 تعني قيمة غير معرفة. قراءة int32_t.
type: docs
weight: 248
url: /ar/aspose.slides/textframeformat/get_columncount/
---
## TextFrameFormat::get_ColumnCount() طريقة

يعيد عدد الأعمدة في منطقة النص. يجب أن تكون هذه القيمة عددًا موجبًا. وإلا، سيتم تعيين القيمة إلى صفر. القيمة 0 تعني قيمة غير معرفة. قراءة **int32_t**.
