...
description: تُرجع الكائن ThreeDFormat الذي يمثل خصائص تأثير ثلاثي الأبعاد للنص. IThreeDFormat للقراءة فقط.
type: docs
weight: 1
url: /ar/aspose.slides/textframeformat/get_threedformat/
---
## TextFrameFormat::get_ThreeDFormat() طريقة


تُرجع الكائن [ThreeDFormat](../../threedformat/) الذي يمثل خصائص التأثير ثلاثي الأبعاد للنص. للقراءة فقط [IThreeDFormat](../../ithreedformat/).
