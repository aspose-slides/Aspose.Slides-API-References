...
description: يضبط عدد الأعمدة في منطقة النص. يجب أن تكون هذه القيمة رقمًا موجبًا. وإلا، سيتم ضبط القيمة إلى صفر. القيمة 0 تعني قيمة غير معرفة. اكتب int32_t.
type: docs
weight: 261
url: /ar/aspose.slides/textframeformat/set_columncount/
---
## TextFrameFormat::set_ColumnCount(int32_t) طريقة


يضبط عدد الأعمدة في منطقة النص. يجب أن تكون هذه القيمة رقمًا موجبًا. وإلا، سيتم ضبط القيمة إلى صفر. القيمة 0 تعني قيمة غير معرفة. اكتب **int32_t**.
...
يعرض الكود النموذجي التالي كيفية إضافة عمود في إطار النص داخل PowerPoint [Presentation](../../presentation/). 
```cpp
