...
description: "فئة تجريبية تجعل ربط الكود المترجم بإشارات DataGrid ممكنًا، ولكن لا يتم تنفيذها. لا تحتوي على أي أعضاء مُنفذة بشكل صحيح. يجب تخصيص كائنات هذه الفئة فقط باستخدام الدالة System::MakeObject(). لا تُنشئ أبدًا نسخة من هذا النوع على المكدس أو باستخدام المُعامل new، لأن ذلك سيؤدي إلى أخطاء وقت تشغيل أو أخطاء تأكيد. دائمًا قم بتغليف هذه الفئة في مؤشر System::SmartPtr واستخدم هذا المؤشر لتمريره إلى الدوال كمعامل."
type: docs
weight: 1
url: /ar/system.web.ui.webcontrols/datagrid/
---
## فئة DataGrid

فئة تجريبية تجعل الربط بين الكود المترجم وإشارات [DataGrid](./) ممكناً، ولكن لا يتم تنفيذها. لا تحتوي على أعضاء مُنفذة بشكل صحيح. يجب تخصيص كائنات هذه الفئة فقط باستخدام الدالة [System::MakeObject()](../../system/makeobject/). لا تُنشئ أبداً نسخة من هذا النوع على المكدس أو باستخدام المُعامل new، لأن ذلك سيسبّب أخطاءً وقت التشغيل أو أخطاءً في التأكيد. دائمًا قم بتغليف هذه الفئة في مؤشر [System::SmartPtr](../../system/smartptr/) واستخدم هذا المؤشر لتمريره إلى الدوال كمعامل.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث تُعتبر قيمتي NaN متساويتين رغم أنه وفقًا لـ IEC 60559:1989 لا تكون NaN مساوية لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث تُعتبر قيمتي NaN متساويتين رغم أنه وفقًا لـ IEC 60559:1989 لا تكون NaN مساوية لأي قيمة، بما في ذلك NaN. |
...
| Typedef | Description |
| --- | --- |
| [ptr](./ptr/) | نوع المؤشر الذاتي. |

## انظر أيضًا

* فئة [Object](../../system/object/)
* نطاق [System::Web::UI::WebControls](../)
* مكتبة [Aspose.Slides](../../)