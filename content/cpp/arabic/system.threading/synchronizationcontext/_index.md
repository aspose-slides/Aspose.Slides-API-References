...
description: يوفر الوظيفة الأساسية لنشر سياق المزامنة عبر عمليات المزامنة المختلفة.
type: docs
weight: 196
url: /ar/system.threading/synchronizationcontext/
---
## فئة SynchronizationContext

يوفر الوظيفة الأساسية لنشر سياق المزامنة عبر مختلف عمليات المزامنة.
...
| الطريقة | الوصف |
| --- | --- |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | يقارن الكائنات باستخدام صيغ [Object.Equals](../../system/object/equals/) الخاصة بـ C#. |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | يقارن كائنات النوع المرجعي بأسلوب C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | يقارن كائنات النوع القيمي بأسلوب C#. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة نقطية عائمة بأسلوب C# حيث تُ considered قيمتا NaN متساويتين بالرغم من أن معيار IEC 60559:1989 يُشير إلى أن NaN غير مساوي لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة نقطية عائمة بأسلوب C# حيث تُ considered قيمتا NaN متساويتين بالرغم من أن معيار IEC 60559:1989 يُشير إلى أن NaN غير مساوي لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | يحصل على سياق المزامنة للخط الحالي. |
...
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | ينفذ رد النداء بشكل غير متزامن. |
...
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | ينفذ رد النداء بشكل متزامن. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | يضبط سياق المزامنة للخط الحالي. |
...
|  [SynchronizationContext](./synchronizationcontext/)() | يبني نسخة جديدة من [SynchronizationContext](./). |
...
تمكن هذه الفئة من نقل سياق المزامنة بين الخيوط وتُستخدم لتوجيه ردود النداء أو الاستدعاءات إلى الخيط أو سياق المزامنة المناسب. تنفيذ تجريبي.
