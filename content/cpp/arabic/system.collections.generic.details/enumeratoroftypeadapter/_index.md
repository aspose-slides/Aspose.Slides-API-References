...
description: المكرّر المستخدم بواسطة طريقة الامتداد IEnumerable.OfType().
type: docs
weight: 66
url: /ar/system.collections.generic.details/enumeratoroftypeadapter/
---
## فئة EnumeratorOfTypeAdapter

Enumerator المستخدم بواسطة طريقة الامتداد IEnumerable.OfType().
...
| الطريقة | الوصف |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | يجهز iterator للاستخدام بواسطة فئة VirtualizedIterator. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | تحاكي مقارنة النقطة العائمة بنمط C# حيث يُعتبر NaNانان متساويين بالرغم من أن IEC 60559:1989 تنص على أن NaN غير مساوي لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | تحاكي مقارنة النقطة العائمة بنمط C# حيث يُعتبر NaNانان متساويين بالرغم من أن IEC 60559:1989 تنص على أن NaN غير مساوي لأي قيمة، بما في ذلك NaN. |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | ينقل iterator خطوة إلى الأمام. |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | يقوم بأول استدعاء [MoveNext()](../../system.collections.generic/ienumerator/movenext/) ويجهز كائن enumerator للاستخدام بواسطة VirtualizedIterator. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | يتحقق مما إذا كان الكائن يمثل مثيلًا للنوع الموصوف بواسطة targetType. نظير معامل C# 'is'. |
| void [Lock](../../system/object/lock/)() | ينفذ بيان القفل C# lock(). استدعِه مباشرة أو استخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | يضع علامة على الـ enumerator المملوك من قبل virtualized iterator. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | نظير طريقة C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). يتيح استنساخ الأنواع المخصصة. |
| **bool** [MoveNext](./movenext/)() override | ينقل الـ enumerator إلى العنصر التالي. إذا لم يتم الإشارة إلى أي عنصر مسبقًا، يعين المرجعية إلى أول عنصر متاح. إذا وصل إلى نهاية الحاوية، لا يفعل شيئًا. |
...
| void [Reset](./reset/)() override | يعيد تعيين الـ enumerator إلى الموقع قبل العنصر الأول. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | يُقلل عداد المرجع المشترك ويعيده. لا يجب استدعاؤه مباشرة؛ استخدم المؤشرات الذكية أو ThisProtector. |
| virtual [String](../../system/string/) [ToString](../../system/object/tostring/)() const | نظير طريقة C# [Object.ToString()](../../system/object/tostring/). يتيح تحويل الكائنات المخصصة إلى سلسلة. |
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | ينفذ بنية C# typeof([System.Object](../../system/object/)). |
| void [Unlock](../../system/object/unlock/)() | ينفذ فك القفل لبيان C# lock(). استدعِه مباشرة أو استخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | يُقلل عداد المرجع الضعيف. لا يجب استدعاؤه مباشرة؛ استخدم المؤشرات الذكية أو ThisProtector. |
