...
description: يمثل تنفيذًا لموفر إخراج لنقل البيانات إلى التخزين الخارجي.
type: docs
weight: 14
url: /ar/aspose.slides.export.xaml/ixamloutputsaver/
---
## IXamlOutputSaver الفئة


يمثل تنفيذًا لموفر إخراج لنقل البيانات إلى التخزين الخارجي.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعتبر NaNان متساويين بالرغم من أن IEC 60559:1989 يحدد أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعتبر NaNان متساويين بالرغم من أن IEC 60559:1989 يحدد أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
...
| virtual void [Save](./save/)([System::String](../../system/string/), [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | يحفظ مصفوفة بايتات إلى موقع الوجهة. |
