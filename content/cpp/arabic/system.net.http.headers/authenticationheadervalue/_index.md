...
description: "يمثّل قيم رؤوس 'Authorization' و 'ProxyAuthorization' و 'WWW-Authenticate' و 'Proxy-Authenticate'. يجب تخصيص كائنات هذه الفئة فقط باستخدام الدالة System::MakeObject(). لا تقم بإنشاء نسخة من هذا النوع على المكدس أو باستخدام عامل new، حيث سيؤدي ذلك إلى حدوث أخطاء وقت التشغيل أو أخطاء تأكيد. احفظ هذه الفئة دائمًا داخل مؤشر System::SmartPtr واستخدم هذا المؤشر لتمريره كوسيلة إلى الدوال."
type: docs
weight: 1
url: /ar/system.net.http.headers/authenticationheadervalue/
---
## فئة AuthenticationHeaderValue
...
| الطريقة | الوصف |
| --- | --- |
|  [AuthenticationHeaderValue](./authenticationheadervalue/)([String](../../system/string/)) | منشئ. |
|  [AuthenticationHeaderValue](./authenticationheadervalue/)([String](../../system/string/), [String](../../system/string/)) | منشئ. |
| [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | ينشئ نسخة من الكائن الحالي ويعيد مؤشرًا مشتركًا إليه. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | يقارن الكائنات باستخدام C# [Object.Equals](../../system/object/equals/) دلالات. |
...
| [String](../../system/string/) [get_Parameter](./get_parameter/)() | يحصل على بيانات الاعتماد التي تحتوي على معلومات المصادقة. |
| [String](../../system/string/) [get_Scheme](./get_scheme/)() | يحصل على النظام الذي يمكن استخدامه للمصادقة. |
| static **int32_t** [GetAuthenticationLength](./getauthenticationlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | يحلّل السلسلة المحددة ويعيد الفهرس الأخير لتمثيل السلسلة. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | يحصل على بنية بيانات عداد المرجع المرتبط بالكائن. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | تماثل طريقة C# [Object.GetHashCode()](../../system/object/gethashcode/). يتيح تجزئة الكائنات المخصصة. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | تحقق مما إذا كان الكائن يمثل نسخة من النوع الموصوف بواسطة targetType. تماثل معامل C# 'is'. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ نسخة. لا ينسخ شيئًا، بل يهيئ كائنًا جديدًا ويسمح بإنشاء نسخ من الفئات الفرعية. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[AuthenticationHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | يحوّل السلسلة الممررة إلى نسخة من فئة [AuthenticationHeaderValue](./). |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[AuthenticationHeaderValue](./)\>\&) | محاولة تحويل السلسلة الممررة إلى نسخة من فئة [AuthenticationHeaderValue](./). |
