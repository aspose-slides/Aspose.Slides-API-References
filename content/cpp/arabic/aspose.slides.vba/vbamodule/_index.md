...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يقلد مقارنة النقطة العائمة بأسلوب C# حيث يتم اعتبار NaNانٍ مساويين على الرغم من أن IEC 60559:1989 تنص على أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يقلد مقارنة النقطة العائمة بأسلوب C# حيث يتم اعتبار NaNانٍ مساويين على الرغم من أن IEC 60559:1989 تنص على أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | يحصل على اسم الوحدة. قراءة فقط [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_SourceCode](./get_sourcecode/)() override | يرجع شفرة المصدر للوحدة. قراءة [System::String](../../system/string/). |
...
| void [set_SourceCode](./set_sourcecode/)([System::String](../../system/string/)) override | يضبط شفرة المصدر للوحدة. كتابة [System::String](../../system/string/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط معامل القالب رقم n كإشارة ضعيفة (بدلاً من المشتركة). يسمح بتبديل المؤشرات في الحاويات إلى وضع ضعيف. |
...
| void [Unlock](../../system/object/unlock/)() | ينفّذ إلغاء قفل C# lock(). استدعِ مباشرة أو استخدم كائن الحراسة [LockContext](../../system/lockcontext/). |
