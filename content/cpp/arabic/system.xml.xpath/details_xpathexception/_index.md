...
description: يوفر الاستثناء الذي يُرمى عندما يحدث خطأ أثناء معالجة تعبير XPath.
type: docs
weight: 1
url: /ar/system.xml.xpath/details_xpathexception/
---
## Details_XPathException فئة
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | تحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعتبر NaNين متساويين رغم أن IEC 60559:1989 تصف أن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | تحاكي مقارنة النقطة العائمة بأسلوب C# حيث يُعتبر NaNين متساويين رغم أن IEC 60559:1989 تصف أن NaN لا يساوي أي قيمة، بما في ذلك NaN. |
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | يُعيد قيمة عدد صحيح 32-بت وهو رمز HRESULT المرتبط بالاستثناء المُمثَّل بواسطة الكائن الحالي. |
...
| [String](../../system/string/) [get_Message](./get_message/)() const override | يُعيد وصف حالة الخطأ لهذا الاستثناء. |
...
| virtual [ExceptionWrapper](../../system/exceptionwrapper/)\<[Details_Exception](../../system/details_exception/)\> [GetBaseException](../../system/details_exception/getbaseexception/)() const | يُعيد نسخة من كائن الاستثناء الذي يمثل الاستثناء الداخلي الأكثر عمقًا. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | منشئ نسخة. لا ينسخ شيئًا فعليًا، بل يهيئ كائنًا جديدًا ويتيح نسخ الفئات المشتقة. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | يضبط HRESULT، وهو قيمة عددية مشفّرة تُخصص إلى استثناء معين. |
