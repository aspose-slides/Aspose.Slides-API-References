...
---
## ISequence::AddEffect(System::SharedPtr\<IShape\>, EffectType, EffectSubtype, EffectTriggerType) طريقة
...
## ISequence::AddEffect(System::SharedPtr\<IParagraph\>, EffectType, EffectSubtype, EffectTriggerType) طريقة
...
## ISequence::AddEffect(System::SharedPtr\<Aspose::Slides::Charts::IChart\>, EffectChartMajorGroupingType, int32_t, EffectType, EffectSubtype, EffectTriggerType) طريقة

يضيف تأثيرًا حركيًا جديدًا للمخطط للفئة أو السلسلة إلى نهاية التسلسل.
...
## ISequence::AddEffect(System::SharedPtr\<Aspose::Slides::Charts::IChart\>, EffectChartMinorGroupingType, int32_t, int32_t, EffectType, EffectSubtype, EffectTriggerType) طريقة

يضيف تأثيرًا حركيًا جديدًا للمخطط لعناصر الفئة أو السلسلة إلى نهاية التسلسل.
