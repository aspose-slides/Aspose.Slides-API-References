...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C#-style حيث يُعتبر NaNان متساويين على الرغم من أن IEC 60559:1989 تُشير إلى أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C#-style حيث يُعتبر NaNان متساويين على الرغم من أن IEC 60559:1989 تُشير إلى أن NaN ليس مساويًا لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | للغرض الداخلي فقط. |
| [MotionCommandPathType](../motioncommandpathtype/) [get_CommandType](./get_commandtype/)() override | يحدد نوع الأمر. اقرأ [MotionCommandPathType](../motioncommandpathtype/). |
| **bool** [get_IsRelative](./get_isrelative/)() override | تحديد إحداثيات الأمر نسبية أم لا. اقرأ **bool**. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\> [get_Points](./get_points/)() override | يحدد نقاط الأمر. اقرأ [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| [MotionPathPointsType](../motionpathpointstype/) [get_PointsType](./get_pointstype/)() override | يحدد نوع نقاط الأمر. اقرأ [MotionPathPointsType](../motionpathpointstype/). |
...
| void [set_CommandType](./set_commandtype/)([MotionCommandPathType](../motioncommandpathtype/)) override | يحدد نوع الأمر. اكتب [MotionCommandPathType](../motioncommandpathtype/). |
| void [set_IsRelative](./set_isrelative/)(**bool**) override | تحديد إحداثيات الأمر نسبية أم لا. اكتب **bool**. |
| void [set_Points](./set_points/)([System::ArrayPtr](../../system/arrayptr/)\<[System::Drawing::PointF](../../system.drawing/pointf/)\>) override | يحدد نقاط الأمر. اكتب [System::Drawing::PointF](../../system.drawing/pointf/)[]. |
| void [set_PointsType](./set_pointstype/)([MotionPathPointsType](../motionpathpointstype/)) override | يحدد نوع نقاط الأمر. اكتب [MotionPathPointsType](../motionpathpointstype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | اضبط الوسيط القالب رقم n كإشارة ضعيفة (بدلاً من مشتركة). يسمح بتبديل المؤشرات في الحاويات إلى الوضع الضعيف. |
