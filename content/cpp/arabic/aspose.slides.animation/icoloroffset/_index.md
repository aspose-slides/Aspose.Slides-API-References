...
| virtual **float** [get_Value0](./get_value0/)() | يعرف القيمة الأولى للإزاحة. قراءة **float**. |
| virtual **float** [get_Value1](./get_value1/)() | يعرف القيمة الثانية للإزاحة. قراءة **float**. |
| virtual **float** [get_Value2](./get_value2/)() | يعرف القيمة الثالثة للإزاحة. قراءة **float**. |
...
| virtual void [set_Value0](./set_value0/)(**float**) | يعرف القيمة الأولى للإزاحة. كتابة **float**. |
| virtual void [set_Value1](./set_value1/)(**float**) | يعرف القيمة الثانية للإزاحة. كتابة **float**. |
| virtual void [set_Value2](./set_value2/)(**float**) | يعرف القيمة الثالثة للإزاحة. كتابة **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط النمطي رقم n إلى مؤشر ضعيف (بدلاً من المشترك). يسمح بتبديل المؤشرات في الحاويات إلى الوضع الضعيف. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | ينقص ويُعيد عداد المرجع المشترك. لا ينبغي استدعاؤه مباشرة؛ بدلاً من ذلك، استخدم المؤشرات الذكية أو ThisProtector. |
