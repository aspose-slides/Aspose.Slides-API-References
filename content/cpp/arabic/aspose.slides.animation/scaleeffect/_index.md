...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث تُعتبر قيمتي NaN متساويتين بالرغم من أن IEC 60559:1989 تذكر أن NaN لا تساوي أي قيمة، بما فيها NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بنمط C# حيث تُعتبر قيمتي NaN متساويتين بالرغم من أن IEC 60559:1989 تذكر أن NaN لا تساوي أي قيمة، بما فيها NaN. |
...
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](../behavior/get_additive/)() override | يمثل ما إذا كان سلوك الرسوم المتحركة الحالي يدمج مع الرسوم المتحركة الأخرى الجارية. قراءة [BehaviorAdditiveType](../behavioradditivetype/). |
| [System::Drawing::PointF](../../system.drawing/pointf/) [get_By](./get_by/)() override | يصف قيمة الإزاحة النسبية للرسوم المتحركة (بالنسبة المئوية). قراءة [System::Drawing::PointF](../../system.drawing/pointf/). |
| [System::Drawing::PointF](../../system.drawing/pointf/) [get_From](./get_from/)() override | يحدد إحداثي x/y لبدء الرسوم المتحركة من (بالنسبة المئوية). قراءة [System::Drawing::PointF](../../system.drawing/pointf/). |
...
| [System::Drawing::PointF](../../system.drawing/pointf/) [get_To](./get_to/)() override | يحدد الموقع المستهدف لتأثير مقياس الرسوم المتحركة (بالنسبة المئوية). قراءة [System::Drawing::PointF](../../system.drawing/pointf/). |
| [NullableBool](../../aspose.slides/nullablebool/) [get_ZoomContent](./get_zoomcontent/)() override | يحدد ما إذا كان يجب تكبير المحتوى. قراءة [NullableBool](../../aspose.slides/nullablebool/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | تحقق مما إذا كان الكائن يمثل مثلاً لنوع موصوف بـ targetType. نظير عامل C# 'is'. |
...
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | يمثل ما إذا كان سلوك الرسوم المتحركة الحالي يدمج مع الرسوم المتحركة الأخرى الجارية. كتابة [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_By](./set_by/)([System::Drawing::PointF](../../system.drawing/pointf/)) override | يصف قيمة الإزاحة النسبية للرسوم المتحركة (بالنسبة المئوية). كتابة [System::Drawing::PointF](../../system.drawing/pointf/). |
| void [set_From](./set_from/)([System::Drawing::PointF](../../system.drawing/pointf/)) override | يحدد إحداثي x/y لبدء الرسوم المتحركة من (بالنسبة المئوية). كتابة [System::Drawing::PointF](../../system.drawing/pointf/). |
...
| void [set_To](./set_to/)([System::Drawing::PointF](../../system.drawing/pointf/)) override | يحدد الموقع المستهدف لتأثير مقياس الرسوم المتحركة (بالنسبة المئوية). كتابة [System::Drawing::PointF](../../system.drawing/pointf/). |
| void [set_ZoomContent](./set_zoomcontent/)([NullableBool](../../aspose.slides/nullablebool/)) override | يحدد ما إذا كان يجب تكبير المحتوى. كتابة [NullableBool](../../aspose.slides/nullablebool/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | يضبط الوسيط القالب رقم n كمؤشر ضعيف (بدلاً من المشترك). يسمح بتبديل المؤشرات في الحاويات إلى وضع الضعيف. |
...
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | يقلل ويعيد عداد الإشارة المشترك. لا ينبغي استدعاؤه مباشرةً؛ بدلاً من ذلك، استخدم المؤشرات الذكية أو ThisProtector. |
