...
description: ينفّذ واجهة IEnumerator لمجموعة عامة فارغة.
type: docs
weight: 27
url: /ar/system.linq.details/emptyenumerator/
---
## فئة EmptyEnumerator

ينفّذ واجهة IEnumerator لمجموعة عامة فارغة.
...
| الطريقة | الوصف |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | يجهّز المُكرِّر للاستخدام بواسطة فئة VirtualizedIterator. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين رغم أن IEC 60559:1989 تنص على أن NaN غير مساوي لأي قيمة، بما في ذلك NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | يحاكي مقارنة النقطة العائمة بأسلوب C# حيث تُعتبر قيمتا NaN متساويتين رغم أن IEC 60559:1989 تنص على أن NaN غير مساوي لأي قيمة، بما في ذلك NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | لأغراض داخلية فقط. |
| [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](./get_current/)() const override | يحصل على العنصر الحالي. |
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | يتحرك بالمُكرِّر خطوة للأمام. |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | يقوم بأول استدعاء [MoveNext()](../../system.collections.generic/ienumerator/movenext/) ويجهّز كائن المُعدِّد للاستخدام بواسطة VirtualizedIterator. |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | يعلِّم المُعدِّد المملوك بواسطة المُكرِّر الظاهري. |
...
| **bool** [MoveNext](./movenext/)() override | ينقل المُعدِّد إلى العنصر التالي. إذا لم يُشار إلى أي عنصر سابقًا، يضع المرجع على أول عنصر متاح. إذا وصل إلى نهاية الحاوية، لا يفعل شيئًا. |
...
| void [Reset](./reset/)() override | يعيد ضبط المُعدِّد إلى الموضع قبل أول عنصر. |
...
* مساحة الاسم [System::Linq::Details](../)
* مكتبة [Aspose.Slides](../../)