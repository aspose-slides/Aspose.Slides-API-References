...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() override | Mengembalikan data berkas dari objek OLE tertanam Hanya baca **uint8_t**[]. |
| [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() override | Mengembalikan ekstensi berkas untuk objek OLE tertanam saat ini Hanya baca [System::String](../../system/string/). |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan lock() C# untuk mengunci. Panggil langsung atau gunakan [LockContext](../../system/lockcontext/) objek sentry. |
...
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)() | Membuat info data tertanam baru untuk objek OLE. |
|  [OleEmbeddedDataInfo](./oleembeddeddatainfo/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, [System::String](../../system/string/)) | Membuat instance baru dari info data tertanam untuk objek OLE. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan unlock() C#. Panggil langsung atau gunakan [LockContext](../../system/lockcontext/) objek sentry. |
...
* Kelas [IOleEmbeddedDataInfo](../../aspose.slides/ioleembeddeddatainfo/)
* Ruang nama [Aspose::Slides::DOM::Ole](../)
