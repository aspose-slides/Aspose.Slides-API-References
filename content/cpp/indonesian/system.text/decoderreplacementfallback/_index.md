...
description: "Menyediakan strategi cadangan untuk mengganti simbol yang salah dengan stub. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan error runtime dan/atau fault asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 79
url: /id/system.text/decoderreplacementfallback/
---
## DecoderReplacementFallback kelas

Menyediakan strategi cadangan untuk mengganti simbol yang salah dengan stub. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance dari tipe ini di stack atau menggunakan operator new, karena akan mengakibatkan error runtime dan/atau fault asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen.
...
| Metode | Deskripsi |
| --- | --- |
| [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Membuat buffer cadangan. |
...
| const [String](../../system/string/)\& [get_DefaultString](./get_defaultstring/)() const | Mendapatkan string pengganti. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](../decoderfallback/get_exceptionfallback/)() | Mendapatkan implementasi fallback pengecualian default. |
...
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](../decoderfallback/get_replacementfallback/)() | Mendapatkan implementasi fallback pengganti default. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](../decoderfallback/get_standardsafefallback/)() | Mendapatkan implementasi fallback aman standar default. |
...
* Kelas [DecoderFallback](../decoderfallback/)
