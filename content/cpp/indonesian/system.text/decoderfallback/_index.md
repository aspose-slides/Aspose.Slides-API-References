...
| Metode | Deskripsi |
| --- | --- |
| virtual [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() | Mendapatkan buffer yang terkait dengan algoritma fallback. |
...
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ExceptionFallback](./get_exceptionfallback/)() | Mendapatkan implementasi fallback pengecualian default. |
| virtual int [get_MaxCharCount](./get_maxcharcount/)() const | Mendapatkan jumlah maksimum karakter yang dapat dikembalikan oleh fallback. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_ReplacementFallback](./get_replacementfallback/)() | Mendapatkan implementasi fallback pengganti default. |
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](./get_standardsafefallback/)() | Mendapatkan implementasi fallback standar aman default. |
