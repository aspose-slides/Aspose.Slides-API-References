...
description: "Pengecualian yang dilempar oleh DecoderExceptionFallback ketika proses dekoding gagal. Jangan pernah membuat instansi kelas ini secara manual. Gunakan kelas DecoderFallbackException sebagai gantinya. Jangan pernah membungkus instansi kelas DecoderFallbackException ke dalam System::SmartPtr."
type: docs
weight: 105
url: /id/system.text/details_decoderfallbackexception/
---
## Details_DecoderFallbackException kelas

Pengecualian yang dilempar oleh [DecoderExceptionFallback](../decoderexceptionfallback/) ketika dekoding gagal. Jangan pernah membuat instansi kelas ini secara manual. Gunakan kelas DecoderFallbackException sebagai gantinya. Jangan pernah membungkus instansi kelas DecoderFallbackException ke dalam [System::SmartPtr](../../system/smartptr/).
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BytesUnknown](./get_bytesunknown/)() | Mendapatkan array byte yang memicu kesalahan. |
...
| int [get_Index](./get_index/)() | Mendapatkan posisi byte yang memicu kesalahan dalam array input. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Mendapatkan tipe aktual dari objek. Analog dari pemanggilan C# [System.Object.GetType()](../../system/object/gettype/). |
