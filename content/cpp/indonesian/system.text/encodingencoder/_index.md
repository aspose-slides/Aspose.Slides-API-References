...
description: "Encoder yang menggunakan objek encoding untuk enkoding. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 248
url: /id/system.text/encodingencoder/
---
## EncodingEncoder kelas

[Encoder](../encoder/) yang menggunakan objek encoding untuk enkoding. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen.
...
| [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_Fallback](../encoder/get_fallback/)() const | Mendapatkan fallback penanganan kesalahan. |
...
| virtual int [GetByteCount](../encoder/getbytecount/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, **bool**) | Mendapatkan jumlah byte yang dibutuhkan untuk mengenkode sebuah buffer. |
| virtual int [GetByteCount](../encoder/getbytecount/)(const char_t *, int, **bool**) | Mendapatkan jumlah byte yang dibutuhkan untuk mengenkode sebuah buffer. |
| virtual int [GetBytes](../encoder/getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, **bool**) | Mendapatkan byte yang dihasilkan dari pengenkodean sebuah buffer. |
| virtual int [GetBytes](../encoder/getbytes/)(const char_t *, int, **uint8_t** *, int, **bool**) | Mendapatkan byte yang dihasilkan dari pengenkodean sebuah buffer. |
...
| virtual void [Reset](../encoder/reset/)() | Membersihkan keadaan internal enkoder. |
| void [set_Fallback](../encoder/set_fallback/)(const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&) | Menetapkan fallback penanganan kesalahan. |
