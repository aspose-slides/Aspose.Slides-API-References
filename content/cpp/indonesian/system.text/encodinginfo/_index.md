...
description: "Info singkat tentang pengkodean. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan assertion. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk mengirimnya ke fungsi sebagai argumen."
type: docs
weight: 261
url: /id/system.text/encodinginfo/
---
## EncodingInfo kelas

Objek dari kelas ini sebaiknya hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan assertion. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk mengirimkannya ke fungsi sebagai argumen.
...
| int [get_CodePage](./get_codepage/)() const | Mendapatkan ID codepage. |
| const [String](../../system/string/)\& [get_DisplayName](./get_displayname/)() const | Mendapatkan nama pengkodean terlokalisasi lengkap. |
| const [String](../../system/string/)\& [get_Name](./get_name/)() const | Mendapatkan nama singkat pengkodean. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| [EncodingPtr](../../system/encodingptr/) [GetEncoding](./getencoding/)() | Mendapatkan pengkodean yang dijelaskan oleh info. |
