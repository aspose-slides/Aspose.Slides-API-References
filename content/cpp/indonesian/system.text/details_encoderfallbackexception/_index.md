...
description: "Exception yang dilempar oleh EncoderExceptionFallback ketika proses pengkodean gagal. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas EncoderFallbackException sebagai gantinya. Jangan pernah membungkus instance kelas EncoderFallbackException ke dalam System::SmartPtr."
type: docs
weight: 118
url: /id/system.text/details_encoderfallbackexception/
---
## Details_EncoderFallbackException kelas
...
| char_t [get_CharUnknown](./get_charunknown/)() | Mendapatkan karakter yang menyebabkan kesalahan. |
| char_t [get_CharUnknownHigh](./get_charunknownhigh/)() | Mendapatkan karakter tinggi dari pasangan yang menyebabkan kesalahan. |
| char_t [get_CharUnknownLow](./get_charunknownlow/)() | Mendapatkan karakter rendah dari pasangan yang menyebabkan kesalahan. |
...
| int [get_Index](./get_index/)() | Mendapatkan posisi karakter yang menyebabkan kesalahan dalam array input. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_argumentexception/gettype/)() const override | Mendapatkan tipe nyata objek. Analog dari pemanggilan C# [System.Object.GetType()](../../system/object/gettype/). |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Menetapkan HRESULT, nilai numerik yang dikodekan yang diberikan ke pengecualian tertentu. |
...
| virtual const char * [what](../../system/details_exception/what/)() const | Mengimplementasikan metode [what()](../../system/details_exception/what/) yang dipanggil oleh kelas [ExceptionWrapper](../../system/exceptionwrapper/). Meskipun fakta bahwa kelas ini tidak diwarisi dari std::exception, kelas turunan dapat menggunakan anggota protected/private untuk mengimplementasikan logika mereka. Memindahkan implementasi metode ini ke [ExceptionWrapper](../../system/exceptionwrapper/) dapat merusak logika tersebut. |
