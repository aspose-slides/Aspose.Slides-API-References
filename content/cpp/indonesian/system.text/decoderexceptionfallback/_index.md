...
type: docs
weight: 27
url: /id/system.text/decoderexceptionfallback/
---
## DecoderExceptionFallback kelas
...
| Method | Deskripsi |
| --- | --- |
| [DecoderFallbackBufferPtr](../../system/decoderfallbackbufferptr/) [CreateFallbackBuffer](./createfallbackbuffer/)() override | Membuat buffer fallback. |
...
| int [get_MaxCharCount](./get_maxcharcount/)() const override | Mendapatkan jumlah maksimal karakter yang dapat dikembalikan oleh instansi. |
...
| static const [DecoderFallbackPtr](../../system/decoderfallbackptr/) [get_StandardSafeFallback](../decoderfallback/get_standardsafefallback/)() | Mendapatkan implementasi fallback standar aman default. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek mewakili instansi tipe yang dijelaskan oleh targetType. Analogi operator C# 'is'. |
