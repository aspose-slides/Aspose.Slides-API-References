...
type: docs
weight: 248
url: /id/system.text/encoding/getbytes/
---
...
| --- | --- | --- |
| chars | [ArrayPtr](../../../system/arrayptr/)\<char_t\> | Karakter yang akan dikodekan. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| chars | System::Details::ArrayView\<char_t\> | Karakter yang akan dikodekan. |
| char_index | int | Awal irisan karakter. |
| char_count | int | Jumlah karakter yang akan dikonversi. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| chars | System::Details::StackArray\<char_t, SC\>\& | Karakter yang akan dikodekan. |
| char_index | int | Awal irisan karakter. |
| char_count | int | Jumlah karakter yang akan dikonversi. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| s | const [String](../../../system/string/)\& | [String](../../../system/string/) yang akan dikodekan. |
| char_index | int | Awal irisan karakter. |
| char_count | int | Jumlah karakter yang akan dikonversi. |
| bytes | [ArrayPtr](../../../system/arrayptr/)\<**uint8_t**\> | [Buffer](../../../system/buffer/) untuk menempatkan karakter ke. |
| byte_index | int | Offset buffer keluaran. |
...
[Buffer](../../../system/buffer/) yang berisi representasi karakter yang dikodekan.
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| chars | const System::Details::ArrayView\<char_t\>\& | Karakter yang akan dikodekan. |
| index | int | Awal irisan karakter. |
| count | int | Jumlah karakter yang akan dikonversi. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| chars | const System::Details::StackArray\<char_t, N\>\& | Karakter yang akan dikodekan. |
| index | int | Awal irisan karakter. |
| count | int | Jumlah karakter yang akan dikonversi. |
...
| Parameter | Tipe | Deskripsi |
| --- | --- | --- |
| chars | const char_t * | Karakter yang akan dikodekan. |
| char_count | int | Jumlah karakter yang akan dikonversi. |
