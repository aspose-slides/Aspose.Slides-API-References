...
| Method | Description |
| --- | --- |
| virtual void [Convert](./convert/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, **bool**, int\&, int\&, **bool**\&) | Mengonversi karakter menjadi byte. |
| virtual void [Convert](./convert/)(const char_t *, int, **uint8_t** *, int, **bool**, int\&, int\&, **bool**\&) | Mengonversi karakter menjadi byte. |
...
| [EncoderFallbackPtr](../../system/encoderfallbackptr/) [get_Fallback](../encoder/get_fallback/)() const | Mendapatkan fallback penanganan error. |
| const [EncoderFallbackBufferPtr](../../system/encoderfallbackbufferptr/) [get_FallbackBuffer](../encoder/get_fallbackbuffer/)() const | Mendapatkan buffer fallback. |
| virtual int [GetByteCount](./getbytecount/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, **bool**) | Mendapatkan jumlah byte yang diperlukan untuk mengenkode buffer. |
| virtual int [GetByteCount](./getbytecount/)(const char_t *, int, **bool**) | Mendapatkan jumlah byte yang diperlukan untuk mengenkode buffer. |
| virtual int [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<char_t\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, **bool**) | Mendapatkan byte yang dihasilkan dari enkoding buffer. |
| virtual int [GetBytes](./getbytes/)(const char_t *, int, **uint8_t** *, int, **bool**) | Mendapatkan byte yang dihasilkan dari enkoding buffer. |
...
| virtual void [Reset](./reset/)() | Mengatur variabel internal ke keadaan awal. |
| void [set_Fallback](../encoder/set_fallback/)(const [EncoderFallbackPtr](../../system/encoderfallbackptr/)\&) | Mengatur fallback penanganan error. |
