...
type: docs
weight: 183
url: /id/system.text/encoderfallbackbuffer/
---
...
| virtual **bool** [Fallback](./fallback/)(char_t, int) | Menerapkan prosedur fallback aktual. |
| virtual **bool** [Fallback](./fallback/)(char_t, char_t, int) | Menerapkan prosedur fallback aktual. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Hanya untuk tujuan internal. |
| virtual int [get_Remaining](./get_remaining/)() const | Mendapatkan jumlah sisa karakter yang akan diproses. |
...
| virtual char_t [GetNextChar](./getnextchar/)() | Mengambil karakter berikutnya dalam buffer fallback. |
