...
| virtual **float** [get_AngleValue](./get_anglevalue/)() | Mengembalikan nilai, menafsirkannya sebagai sudut dalam derajat. Baca **float**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Mengembalikan nama penyesuaian nilai ini. Hanya-baca [System::String](../../system/string/). |
| virtual **int64_t** [get_RawValue](./get_rawvalue/)() | Mengembalikan nilai penyesuaian "sebagaimana adanya". Baca **int64_t**. |
| virtual [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() | Mengembalikan tipe penyesuaian shape. Hanya-baca [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalinan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan mengaktifkan pembuatan salinan subclass. |
...
| virtual void [set_AngleValue](./set_anglevalue/)(**float**) | Mengatur nilai, menafsirkannya sebagai sudut dalam derajat. Tulis **float**. |
| virtual void [set_RawValue](./set_rawvalue/)(**int64_t**) | Mengatur nilai penyesuaian "sebagaimana adanya". Tulis **int64_t**. |
