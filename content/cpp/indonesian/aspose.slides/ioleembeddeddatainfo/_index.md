...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_EmbeddedFileData](./get_embeddedfiledata/)() | Mengembalikan data file objek OLE tertanam Hanya baca **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_EmbeddedFileExtension](./get_embeddedfileextension/)() | Mengembalikan ekstensi file untuk objek OLE tertanam saat ini Hanya baca [System::String](../../system/string/). |
