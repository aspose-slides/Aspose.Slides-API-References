...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [FindShapeByAltText](../baseslide/findshapebyalttext/)([System::String](../../system/string/)) override | Menemukan kejadian pertama dari sebuah bentuk dengan teks alternatif yang ditentukan. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IControlCollection](../icontrolcollection/)\> [get_Controls](../baseslide/get_controls/)() override | Mengembalikan koleksi kontrol ActiveX pada sebuah slide. Hanya-baca [IControlCollection](../icontrolcollection/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() override | Mengembalikan koleksi panduan gambar untuk master notes slide. Hanya-baca [IDrawingGuidesCollection](../idrawingguidescollection/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterNotesSlideHeaderFooterManager](../imasternotesslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() override | Mengembalikan manajer HeaderFooter dari master notes slide. Hanya-baca [IMasterHandoutSlideHeaderFooterManager](../imasterhandoutslideheaderfootermanager/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextStyle](../itextstyle/)\> [get_NotesStyle](./get_notesstyle/)() override | Mengembalikan gaya teks catatan. Hanya-baca [ITextStyle](../itextstyle/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShapeCollection](../ishapecollection/)\> [get_Shapes](../baseslide/get_shapes/)() override | Mengembalikan bentuk-bentuk slide. Hanya-baca [IShapeCollection](../ishapecollection/). |
| **bool** [get_ShowMasterShapes](./get_showmastershapes/)() override | Menentukan apakah bentuk pada master slide harus ditampilkan pada slide atau tidak. Untuk master slide sendiri properti ini selalu mengembalikan **false**. Baca **bool**. |
...
| void [set_Name](../baseslide/set_name/)([System::String](../../system/string/)) override | Mengatur nama slide. Tuliskan [System::String](../../system/string/). |
| void [set_ShowMasterShapes](./set_showmastershapes/)(**bool**) override | Menentukan apakah bentuk pada master slide harus ditampilkan pada slide atau tidak. Untuk master slide sendiri properti ini selalu mengembalikan **false**. Tulis **bool**. |
...
* Kelas [IMasterNotesSlide](../imasternotesslide/)
