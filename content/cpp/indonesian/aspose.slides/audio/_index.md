...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() override | Mengembalikan salinan data audio. Jika data berukuran besar, pertimbangkan menggunakan metode [Audio::GetStream](./getstream/) untuk mencegah pemuatan data audio ke memori yang tidak diperlukan atau bahkan OutOfMemoryException. Hanya-baca **uint8_t**[]. |
| [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Mengembalikan tipe MIME audio, yang di-encode dalam [Audio::get_BinaryData](./get_binarydata/). Hanya-baca [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() override | Mengembalikan aliran Stream untuk membaca. Gunakan 'using' atau tutup aliran setelah digunakan. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruktor salinan untuk subclass. |
...
| void [set_ContentType](./set_contenttype/)([System::String](../../system/string/)) | Mengembalikan tipe MIME audio, yang di-encode dalam [Audio::get_BinaryData](./get_binarydata/). Hanya-baca [System::String](../../system/string/). |
