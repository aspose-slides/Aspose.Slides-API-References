...
| Metode | Deskripsi |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Menambahkan [Paragraph](../paragraph/) ke akhir koleksi. |
| **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Menambahkan konten [ParagraphCollection](./) ke akhir koleksi. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/)) override | Menambahkan teks dari string html yang ditentukan ke koleksi. |
| void [AddFromHtml](./addfromhtml/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Import::IExternalResourceResolver](../../aspose.slides.import/iexternalresourceresolver/)\>, [System::String](../../system/string/)) override | Menambahkan teks dari string html yang ditentukan ke koleksi. |
...
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Mendapatkan iterator yang berada tepat setelah elemen const-qualified terakhir (jika ada) dalam koleksi. |
| void [Clear](./clear/)() override | Menghapus semua elemen dari koleksi. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Menentukan apakah [ICollection](../../system.collections.generic/icollection/) berisi nilai tertentu. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>, **int32_t**) | Menyalin elemen [ICollection](../../system.collections.generic/icollection/) ke [System::Array](../../system/array/), mulai dari indeks [System::Array](../../system/array/) tertentu. |
| [iterator](./iterator/) [end](./end/)() | Mendapatkan iterator yang berada tepat setelah elemen terakhir (jika ada) dalam koleksi. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Mendapatkan iterator yang berada tepat setelah elemen terakhir (jika ada) dari instance koleksi yang const-qualified. |
...
| [System::String](../../system/string/) [ExportToHtml](./exporttohtml/)(**int32_t**, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Export::ITextToHtmlConversionOptions](../../aspose.slides.export/itexttohtmlconversionoptions/)\>) override | Mengonversi paragraf yang ditentukan ke HTML dan mengembalikannya sebagai objek String. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator yang mengiterasi koleksi. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\> [idx_get](./idx_get/)(**int32_t**) override | Mendapatkan elemen pada indeks yang ditentukan. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) | Menentukan indeks item tertentu dalam [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Menyisipkan [Paragraph](../paragraph/) ke dalam koleksi pada indeks yang ditentukan. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IParagraphCollection](../iparagraphcollection/)\>) override | Menyisipkan konten [ParagraphCollection](./) ke dalam koleksi pada indeks yang ditentukan. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraph](../iparagraph/)\>) override | Menghapus kemunculan pertama objek tertentu dari [ICollection](../../system.collections.generic/icollection/). |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Menambah jumlah referensi bersama. Tidak boleh dipanggil langsung; gunakan smart pointer atau ThisProtector. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Mendapatkan iterator yang berada tepat setelah elemen terakhir (jika ada) dari instance koleksi yang const-qualified. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Mendapatkan iterator yang berada tepat setelah elemen terakhir (jika ada) dari koleksi. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah jumlah referensi lemah. Tidak boleh dipanggil langsung; gunakan smart pointer atau ThisProtector. |
...
* Kelas [IParagraphCollection](../iparagraphcollection/)
