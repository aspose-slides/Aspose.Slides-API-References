...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Meniru perbandingan point floating gaya C# dimana dua NaN dianggap sama meskipun menurut IEC 60559:1989 NaN tidak sama dengan nilai apa pun, termasuk NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Meniru perbandingan point floating gaya C# dimana dua NaN dianggap sama meskipun menurut IEC 60559:1989 NaN tidak sama dengan nilai apa pun, termasuk NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Hanya untuk keperluan internal. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Mengembalikan salinan data audio. Jika ada sejumlah besar data, pertimbangkan untuk menggunakan metode [IAudio::GetStream](./getstream/) guna mencegah pemuatan data audio yang tidak perlu ke memori atau bahkan OutOfMemoryException. Hanya-baca **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Mengembalikan tipe MIME audio, dienkode dalam [IAudio::get_BinaryData](./get_binarydata/). Hanya-baca [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | Mengembalikan aliran Stream untuk membaca. Gunakan 'using' atau tutup aliran setelah digunakan. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah penghitung referensi weak. Tidak seharusnya dipanggil langsung; gunakan smart pointer atau ThisProtector. |
