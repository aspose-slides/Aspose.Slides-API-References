...
description: Menetapkan jumlah kolom di area teks. Nilai ini harus berupa angka positif. Jika tidak, nilai akan diatur menjadi nol. Nilai 0 berarti nilai tidak terdefinisi. Tulis int32_t.
type: docs
weight: 261
url: /id/aspose.slides/textframeformat/set_columncount/
---
## TextFrameFormat::set_ColumnCount(int32_t) metode


Menetapkan jumlah kolom di area teks. Nilai ini harus berupa angka positif. Jika tidak, nilai akan diatur menjadi nol. Nilai 0 berarti nilai tidak terdefinisi. Tulis **int32_t**.
...
Kode contoh berikut menunjukkan cara menambahkan kolom dalam frame teks di dalam PowerPoint [Presentation](../../presentation/). 
```cpp
