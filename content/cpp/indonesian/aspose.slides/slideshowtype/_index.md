...
description: "Pengaturan tampilan slide dasar. Nenek moyang mewakili tipe tampilan slide: PresentedBySpeaker Disajikan oleh pembicara (layar penuh) BrowsedByIndividual Dijelajahi oleh individu (jendela) BrowsedAtKiosk Dijelajahi di kiosk (layar penuh)"
type: docs
weight: 5227
...
Pengaturan tampilan slide dasar. Nenek moyang mewakili tipe tampilan slide: [PresentedBySpeaker](../presentedbyspeaker/) Disajikan oleh pembicara (layar penuh) [BrowsedByIndividual](../browsedbyindividual/) Dijelajahi oleh individu (jendela) [BrowsedAtKiosk](../browsedatkiosk/) Dijelajahi di kiosk (layar penuh)
