...
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_Comment](./get_comment/)(**int32_t**) override | Mengembalikan komentar yang dibuat oleh penulis ini pada indeks yang ditentukan. Hanya-baca [Aspose::Slides::IComment](../icomment/) |
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentCollection](../icommentcollection/)\> [get_Comments](./get_comments/)() override | Mengembalikan koleksi komentar yang dibuat oleh penulis ini. Hanya-baca [ICommentCollection](../icommentcollection/). |
| [System::String](../../system/string/) [get_Initials](./get_initials/)() override | Mengembalikan inisial penulis. Baca [System::String](../../system/string/). |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Mengembalikan nama penulis. Baca [System::String](../../system/string/). |
...
| void [Remove](./remove/)() override | Menghapus penulis dari koleksi induk. |
...
| void [set_Initials](./set_initials/)([System::String](../../system/string/)) override | Menetapkan inisial penulis. Tulis [System::String](../../system/string/). |
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Menetapkan nama penulis. Tulis [System::String](../../system/string/). |
