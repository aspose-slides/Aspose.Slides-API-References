...
| [SlideOrientation](../slideorientation/) [get_Orientation](./get_orientation/)() override | Mengambil orientasi slide. |
| [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() override | Mengambil dimensi slide dalam poin. |
| [SlideSizeType](../slidesizetype/) [get_Type](./get_type/)() override | Mengambil tipe ukuran slide. |
...
| void [set_Orientation](./set_orientation/)([SlideOrientation](../slideorientation/)) override | Mengatur orientasi slide. |
| void [SetSize](./setsize/)([SlideSizeType](../slidesizetype/), [SlideSizeScaleType](../slidesizescaletype/)) override | Mengatur ukuran slide berdasarkan tipe dan menskalakan konten yang ada. |
| void [SetSize](./setsize/)(**float**, **float**, [SlideSizeScaleType](../slidesizescaletype/)) override | Mengatur dimensi slide secara eksplisit dan menskalakan konten yang ada. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Mengatur argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan mengubah pointer dalam kontainer menjadi mode lemah. |
