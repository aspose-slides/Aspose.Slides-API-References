...
| **bool** [get_IsDateTimeVisible](./get_isdatetimevisible/)() override | Mendapatkan nilai yang menunjukkan bahwa placeholder tanggal-waktu ada. Baca **bool**. |
| **bool** [get_IsFooterVisible](./get_isfootervisible/)() override | Mendapatkan nilai yang menunjukkan bahwa placeholder footer ada. Baca **bool**. |
| **bool** [get_IsSlideNumberVisible](./get_isslidenumbervisible/)() override | Mendapatkan nilai yang menunjukkan bahwa placeholder nomor halaman ada. Baca **bool**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruktor penyalin kelas turunan. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruktor penyalin kelas turunan. |
...
| void [SetDateTimeText](./setdatetimetext/)([System::String](../../system/string/)) override | Mengatur teks ke placeholder tanggal-waktu slide. |
| void [SetDateTimeVisibility](./setdatetimevisibility/)(**bool**) override | Mengubah visibilitas placeholder tanggal-waktu slide. |
| void [SetFooterText](./setfootertext/)([System::String](../../system/string/)) override | Mengatur teks ke placeholder footer slide. |
| void [SetFooterVisibility](./setfootervisibility/)(**bool**) override | Mengubah visibilitas placeholder footer slide. |
| void [SetSlideNumberVisibility](./setslidenumbervisibility/)(**bool**) override | Mengubah visibilitas placeholder nomor halaman slide. |
