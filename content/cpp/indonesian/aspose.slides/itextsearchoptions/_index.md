...
Mewakili opsi yang dapat digunakan untuk mencari teks dalam [Presentation](../presentation/), [Slide](../slide/) atau [TextFrame](../textframe/).
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Setel true untuk menggunakan pencarian peka huruf, false - sebaliknya. Baca **bool**. |
| virtual **bool** [get_IncludeNotes](./get_includenotes/)() | Set **true** untuk menyertakan teks yang terdapat dalam catatan slide saat melakukan pencarian teks, penggantian, atau operasi penyorotan. Nilai defaultnya adalah **false**. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Setel true untuk menggunakan pencarian peka huruf, false - sebaliknya. Tulis **bool**. |
| virtual void [set_IncludeNotes](./set_includenotes/)(**bool**) | Set **true** untuk menyertakan teks yang terdapat dalam catatan slide saat melakukan pencarian teks, penggantian, atau operasi penyorotan. Nilai defaultnya adalah **false**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setel argumen templat ke-n menjadi weak pointer (bukan shared). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
