...
description: Mewakili opsi yang dapat digunakan untuk menyorot teks dalam bingkai teks.
type: docs
weight: 4109
url: /id/aspose.slides/itexthighlightingoptions/
---
## ITextHighlightingOptions kelas


Mewakili opsi yang dapat digunakan untuk menyorot teks dalam bingkai teks.
...
| virtual **bool** [get_CaseSensitive](./get_casesensitive/)() | Setel true untuk menggunakan pencarian sensitif huruf, false - sebaliknya. Baca **bool**. |
| virtual **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() | Setel true untuk mencocokkan hanya kata utuh, false - sebaliknya. Baca **bool**. |
...
| virtual void [set_CaseSensitive](./set_casesensitive/)(**bool**) | Setel true untuk menggunakan pencarian sensitif huruf, false - sebaliknya. Tulis **bool**. |
| virtual void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) | Setel true untuk mencocokkan hanya kata utuh, false - sebaliknya. Tulis **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Setel argumen template ke- n menjadi weak pointer (bukan shared). Memungkinkan mengubah pointer dalam kontainer ke mode weak. |
...
Deprecated
:   Antarmuka [ITextHighlightingOptions](./) akan dihapus setelah rilis versi 24.10.
