...
description: Mewakili sebuah paragraf dari teks.
type: docs
weight: 3108
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_EndParagraphPortionFormat](./get_endparagraphportionformat/)() | Menentukan properti bagian yang akan digunakan jika bagian lain disisipkan setelah yang terakhir. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\> [get_ParagraphFormat](./get_paragraphformat/)() | Mengembalikan objek pemformatan untuk paragraf ini. Hanya-baca [IParagraphFormat](../iparagraphformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortion](../iportion/)\> [get_Portion](./get_portion/)(**int32_t**) | Mengembalikan bagian teks pada indeks yang ditentukan. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPortionCollection](../iportioncollection/)\> [get_Portions](./get_portions/)() | Mengembalikan koleksi bagian-bagian teks. Hanya-baca [IPortionCollection](../iportioncollection/). |
...
| virtual [System::String](../../system/string/) [get_Text](./get_text/)() | Mendapatkan teks polos dari sebuah paragraf. Baca [System::String](../../system/string/). |
...
| virtual **int32_t** [GetLinesCount](./getlinescount/)() | Mendapatkan jumlah baris dalam sebuah paragraf. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() | Mendapatkan koordinat persegi panjang yang membatasi paragraf. Persegi panjang tersebut mencakup semua baris teks dalam paragraf, termasuk yang kosong. |
...
| virtual void [JoinPortionsWithSameFormatting](./joinportionswithsameformatting/)() | Menggabungkan run dengan pemformatan yang sama. |
...
| virtual void [set_EndParagraphPortionFormat](./set_endparagraphportionformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) | Menentukan properti bagian yang akan digunakan jika bagian lain disisipkan setelah yang terakhir. |
| virtual void [set_Text](./set_text/)([System::String](../../system/string/)) | Menetapkan teks polos dari sebuah paragraf. Tulis [System::String](../../system/string/). |
