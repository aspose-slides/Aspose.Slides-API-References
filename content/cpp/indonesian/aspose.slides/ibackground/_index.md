...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](./get_effectformat/)() | Mengembalikan [EffectFormat](../effectformat/) untuk isian [BackgroundType::OwnBackground](../backgroundtype/). Hanya-baca [IEffectFormat](../ieffectformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() | Mengembalikan [FillFormat](../fillformat/) untuk isian [BackgroundType::OwnBackground](../backgroundtype/). Hanya-baca [IFillFormat](../ifillformat/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_StyleColor](./get_stylecolor/)() | Mengembalikan [ColorFormat](../colorformat/) untuk isian [BackgroundType::Themed](../backgroundtype/). Hanya-baca [IColorFormat](../icolorformat/). |
| virtual **uint16_t** [get_StyleIndex](./get_styleindex/)() | Mengembalikan indeks isian [BackgroundType::Themed](../backgroundtype/) dalam koleksi tema latar belakang. 0 berarti tidak ada isian. 1..999 - indeks. Baca **uint16_t**. |
| virtual [BackgroundType](../backgroundtype/) [get_Type](./get_type/)() | Mengembalikan tipe isian latar belakang. Baca [BackgroundType](../backgroundtype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBackgroundEffectiveData](../ibackgroundeffectivedata/)\> [GetEffective](./geteffective/)() | Mendapatkan data latar belakang efektif dengan penerapan pewarisan. |
...
| void [Lock](../../system/object/lock/)() | Menerapkan pernyataan kunci C# lock(). Panggil langsung atau gunakan objek pengawas [LockContext](../../system/lockcontext/). |
...
| virtual void [set_StyleIndex](./set_styleindex/)(**uint16_t**) | Mengembalikan indeks isian [BackgroundType::Themed](../backgroundtype/) dalam koleksi tema latar belakang. 0 berarti tidak ada isian. 1..999 - indeks. Tulis **uint16_t**. |
| virtual void [set_Type](./set_type/)([BackgroundType](../backgroundtype/)) | Mengembalikan tipe isian latar belakang. Tulis [BackgroundType](../backgroundtype/). |
...
| void [Unlock](../../system/object/unlock/)() | Menerapkan pernyataan pembuka kunci C# lock(). Panggil langsung atau gunakan objek pengawas [LockContext](../../system/lockcontext/). |
