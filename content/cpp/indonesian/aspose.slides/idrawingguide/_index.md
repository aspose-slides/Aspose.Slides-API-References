...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Mengembalikan warna panduan gambar. Baca [System::Drawing::Color](../../system.drawing/color/). |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Mengembalikan orientasi panduan gambar. Baca [Slides::Orientation](../orientation/). |
| virtual **float** [get_Position](./get_position/)() | Mengembalikan posisi panduan gambar dalam poin dari sudut kiri atas slide. Baca **float**. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Mengatur warna panduan gambar. Tulis [System::Drawing::Color](../../system.drawing/color/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../orientation/)) | Mengatur orientasi panduan gambar. Tulis [Slides::Orientation](../orientation/). |
| virtual void [set_Position](./set_position/)(**float**) | Mengatur posisi panduan gambar dalam poin dari sudut kiri atas slide. Tulis **float**. |
