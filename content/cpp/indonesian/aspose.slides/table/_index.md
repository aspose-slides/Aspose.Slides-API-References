...
| [Aspose::Slides::BlackWhiteMode](../blackwhitemode/) [get_BlackWhiteMode](../shape/get_blackwhitemode/)() override | Properti menentukan bagaimana sebuah shape akan ditampilkan dalam mode tampilan hitam-putih. Baca [Slides::BlackWhiteMode](../blackwhitemode/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColumn](../icolumn/)\> [get_Column](./get_column/)(**int32_t**) override | Mengembalikan kolom pada indeks yang ditentukan. Baca-saja [Aspose::Slides::IColumn](../icolumn/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColumnCollection](../icolumncollection/)\> [get_Columns](./get_columns/)() override | Mengembalikan kumpulan kolom. Baca-saja [IColumnCollection](../icolumncollection/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectFormat](../ieffectformat/)\> [get_EffectFormat](../shape/get_effectformat/)() override | Mengembalikan objek [EffectFormat](../effectformat/) yang berisi efek piksel yang diterapkan pada sebuah shape. Catatan: dapat mengembalikan null untuk jenis shape tertentu yang tidak memiliki properti efek. Baca-saja [IEffectFormat](../ieffectformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Mengembalikan objek [TableFormat::get_FillFormat](../tableformat/get_fillformat/) yang berisi format pengisian untuk [Table](./). Baca-saja [IFillFormat](../ifillformat/). |
| **bool** [get_FirstCol](./get_firstcol/)() override | Menentukan apakah kolom pertama tabel harus digambar dengan format khusus. Baca **bool**. |
| **bool** [get_FirstRow](./get_firstrow/)() override | Menentukan apakah baris pertama tabel harus digambar dengan format khusus. Baca **bool**. |
...
| **bool** [get_HorizontalBanding](./get_horizontalbanding/)() override | Menentukan apakah baris genap harus digambar dengan format yang berbeda. Baca **bool**. |
...
| **bool** [get_LastCol](./get_lastcol/)() override | Menentukan apakah kolom terakhir tabel harus digambar dengan format khusus. Baca **bool**. |
| **bool** [get_LastRow](./get_lastrow/)() override | Menentukan apakah baris terakhir tabel harus digambar dengan format khusus. Baca **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../ilineformat/)\> [get_LineFormat](../shape/get_lineformat/)() override | Mengembalikan objek [LineFormat](../lineformat/) yang berisi properti format garis untuk sebuah shape. Catatan: dapat mengembalikan null untuk jenis shape tertentu yang tidak memiliki properti garis. Baca-saja [ILineFormat](../ilineformat/). |
...
| **bool** [get_RightToLeft](./get_righttoleft/)() override | Menentukan apakah tabel memiliki urutan membaca kanan ke kiri. Baca **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IRow](../irow/)\> [get_Row](./get_row/)(**int32_t**) override | Mengembalikan baris pada indeks yang ditentukan. |
| [System::SharedPtr](../../system/sharedptr/)\<[IRowCollection](../irowcollection/)\> [get_Rows](./get_rows/)() override | Mengembalikan kumpulan baris. Baca-saja [IRowCollection](../irowcollection/). |
...
| [TableStylePreset](../tablestylepreset/) [get_StylePreset](./get_stylepreset/)() override | Mendapatkan gaya tabel bawaan. Baca [TableStylePreset](../tablestylepreset/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITableFormat](../itableformat/)\> [get_TableFormat](./get_tableformat/)() override | Mengembalikan objek [TableFormat](../tableformat/) yang berisi properti format untuk tabel ini. Baca-saja [ITableFormat](../itableformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IThreeDFormat](../ithreedformat/)\> [get_ThreeDFormat](../shape/get_threedformat/)() override | Mengembalikan objek [ThreeDFormat](../threedformat/) yang berisi properti efek 3d untuk sebuah shape. Catatan: dapat mengembalikan null untuk jenis shape tertentu yang tidak memiliki properti 3d. Baca-saja [IThreeDFormat](../ithreedformat/). |
| **uint32_t** [get_UniqueId](../shape/get_uniqueid/)() override | Mengembalikan pengidentifikasi internal berskala presentasi yang dimaksudkan untuk digunakan oleh add-in atau kode lain. Karena nilai ini dapat ditetapkan ulang oleh pengguna atau secara programatik, tidak boleh diperlakukan sebagai kunci unik persisten. Baca-saja **uint32_t**. Lihat juga [Shape::get_OfficeInteropShapeId](../shape/get_officeinteropshapeid/). |
| **bool** [get_VerticalBanding](./get_verticalbanding/)() override | Menentukan apakah kolom genap harus digambar dengan format yang berbeda. Baca **bool**. |
...
| **int32_t** [get_ZOrderPosition](../shape/get_zorderposition/)() override | Mengembalikan posisi sebuah shape dalam urutan z. Shapes[0] mengembalikan shape di bagian belakang urutan z, dan Shapes[Shapes.Count - 1] mengembalikan shape di bagian depan urutan z. Baca-saja **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](./idx_get/)(**int32_t**, **int32_t**) override | Mengembalikan sel pada indeks kolom dan baris yang ditentukan. Baca-saja [Cell](../cell/). |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan lock() C# yang mengunci. Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [MergeCells](./mergecells/)([System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>, [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>, **bool**) override | Menggabungkan sel tetangga. |
|  [Object](../../system/object/object/)() | Membuat objek. Menginisialisasi semua struktur data internal. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan menyalin konstruktor subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan menyalin konstruktor subclass. |
...
| void [set_BlackWhiteMode](../shape/set_blackwhitemode/)([Aspose::Slides::BlackWhiteMode](../blackwhitemode/)) override | Properti menentukan bagaimana shape akan ditampilkan dalam mode tampilan hitam-putih. Tulis [Slides::BlackWhiteMode](../blackwhitemode/). |
| void [set_FirstCol](./set_firstcol/)(**bool**) override | Menentukan apakah kolom pertama tabel harus digambar dengan format khusus. Tulis **bool**. |
| void [set_FirstRow](./set_firstrow/)(**bool**) override | Menentukan apakah baris pertama tabel harus digambar dengan format khusus. Tulis **bool**. |
...
| void [set_HorizontalBanding](./set_horizontalbanding/)(**bool**) override | Menentukan apakah baris genap harus digambar dengan format yang berbeda. Tulis **bool**. |
...
| void [set_LastCol](./set_lastcol/)(**bool**) override | Menentukan apakah kolom terakhir tabel harus digambar dengan format khusus. Tulis **bool**. |
| void [set_LastRow](./set_lastrow/)(**bool**) override | Menentukan apakah baris terakhir tabel harus digambar dengan format khusus. Tulis **bool**. |
| void [set_Name](../shape/set_name/)([System::String](../../system/string/)) override | Menetapkan nama shape. Harus tidak null. Gunakan nilai string kosong jika diperlukan. Tulis [System::String](../../system/string/). |
...
| void [set_RightToLeft](./set_righttoleft/)(**bool**) override | Menentukan apakah tabel memiliki urutan membaca kanan ke kiri. Menulis **bool**. |
| void [set_Rotation](../shape/set_rotation/)(**float**) override | Menetapkan jumlah derajat shape yang diputar sekitar sumbu z. Nilai positif menunjukkan rotasi searah jarum jam; nilai negatif menunjukkan rotasi berlawanan arah jarum jam. Tulis **float**. |
| void [set_StylePreset](./set_stylepreset/)([TableStylePreset](../tablestylepreset/)) override | Menetapkan gaya tabel bawaan. Tulis [TableStylePreset](../tablestylepreset/). |
| void [set_VerticalBanding](./set_verticalbanding/)(**bool**) override | Menentukan apakah kolom genap harus digambar dengan format yang berbeda. Tulis **bool**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen templat ke-n sebagai pointer lemah (bukan shared). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | Menetapkan properti format bagian yang didefinisikan ke semua bagian sel tabel. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | Menetapkan properti format paragraf yang didefinisikan ke semua paragraf sel tabel. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | Menetapkan properti format frame teks yang didefinisikan ke semua frame teks sel tabel. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan lock() C# yang membuka kunci. Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
