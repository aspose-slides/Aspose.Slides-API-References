...
type: docs
weight: 5474
url: /id/aspose.slides/texthighlightingoptions/
---
## TextHighlightingOptions kelas
...
| **bool** [get_CaseSensitive](./get_casesensitive/)() override | Atur true untuk menggunakan pencarian peka huruf, false - sebaliknya. Baca **bool**. |
| **bool** [get_WholeWordsOnly](./get_wholewordsonly/)() override | Atur true untuk mencocokkan hanya kata utuh, false - sebaliknya. Baca **bool**. |
...
| void [set_CaseSensitive](./set_casesensitive/)(**bool**) override | Atur true untuk menggunakan pencarian peka huruf, false - sebaliknya. Tulis **bool**. |
| void [set_WholeWordsOnly](./set_wholewordsonly/)(**bool**) override | Atur true untuk mencocokkan hanya kata utuh, false - sebaliknya. Tulis **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Atur argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
...
|  [TextHighlightingOptions](./texthighlightingoptions/)() | Membuat opsi penyorotan teks default baru. |
...
Tidak Digunakan
:   Antarmuka [ITextHighlightingOptions](../itexthighlightingoptions/) akan dihapus setelah rilis versi 24.10.
