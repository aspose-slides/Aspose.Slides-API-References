...
| virtual **int32_t** [get_ConnectionSiteCount](../ishape/get_connectionsitecount/)() | Mengembalikan jumlah titik koneksi pada shape. Baca-saja **int32_t**. |
...
| virtual [ZoomImageType](../zoomimagetype/) [get_ImageType](./get_imagetype/)() | Mendapatkan tipe gambar dari objek zoom. Baca [ZoomImageType](../zoomimagetype/). Nilai default: Preview |
...
| virtual **bool** [get_IsTextHolder](../ishape/get_istextholder/)() | Menentukan apakah shape merupakan TextHolder. Baca-saja **bool**. |
...
| virtual **bool** [get_ReturnToParent](./get_returntoparent/)() | Mendapatkan perilaku navigasi dalam slideshow. Baca **bool**. Nilai default: false |
...
| virtual **bool** [get_ShowBackground](./get_showbackground/)() | Mendapatkan nilai yang menentukan apakah Zoom akan menggunakan latar belakang slide tujuan. Baca **bool**. Nilai default: true |
...
| virtual **float** [get_TransitionDuration](./get_transitionduration/)() | Mendapatkan durasi transisi antara Zoom dan slide. Baca **float**. Nilai default: 1.0f |
| virtual **uint32_t** [get_UniqueId](../ishape/get_uniqueid/)() | Mengembalikan pengidentifikasi internal berskala presentasi yang ditujukan untuk penggunaan oleh add-in atau kode lain... Baca-saja **uint32_t**. Lihat juga [IShape::get_OfficeInteropShapeId](../ishape/get_officeinteropshapeid/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\> [get_ZoomImage](./get_zoomimage/)() | Mendapatkan gambar untuk objek zoom. Baca [IPPImage](../ippimage/). |
...
| virtual void [set_ImageType](./set_imagetype/)([ZoomImageType](../zoomimagetype/)) | Mengatur tipe gambar objek zoom. Tulis [ZoomImageType](../zoomimagetype/). Nilai default: Preview |
...
| virtual void [set_ReturnToParent](./set_returntoparent/)(**bool**) | Mengatur perilaku navigasi dalam slideshow. Tulis **bool**. Nilai default: false |
...
| virtual void [set_ShowBackground](./set_showbackground/)(**bool**) | Mengatur nilai yang menentukan apakah Zoom akan menggunakan latar belakang slide tujuan. Tulis **bool**. Nilai default: true |
| virtual void [set_TransitionDuration](./set_transitionduration/)(**float**) | Mengatur durasi transisi antara Zoom dan slide. Tulis **float**. Nilai default: 1.0f |
...
| virtual void [set_ZoomImage](./set_zoomimage/)([System::SharedPtr](../../system/sharedptr/)\<[IPPImage](../ippimage/)\>) | Mengatur gambar untuk objek zoom. Tulis [IPPImage](../ippimage/). |
