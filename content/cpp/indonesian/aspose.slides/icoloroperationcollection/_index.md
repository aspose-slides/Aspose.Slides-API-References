...
---
## IColorOperationCollection kelas
...
| Metode | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/), **float**) | Menambahkan operasi baru ke akhir koleksi. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Add](./add/)([ColorTransformOperation](../colortransformoperation/)) | Menambahkan operasi baru ke akhir koleksi. |
...
| virtual void [Clear](./clear/)() | Menghapus semua operasi warna. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Clone](../../system/icloneable/clone/)() | Membuat salinan objek saat ini dan mengembalikan shared pointer ke objek tersebut. |
| virtual T [CloneT](../igenericcloneable/clonet/)() | Membuat objek baru yang merupakan salinan dari instance saat ini. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Mengembalikan nilai yang menunjukkan apakah akses ke koleksi disinkronisasi (aman-untuk-thread). Hanya-baca **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [idx_get](./idx_get/)(**int32_t**) | Mengembalikan operasi pada indeks yang ditentukan. Baca [IColorOperation](../icoloroperation/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\>) | Menetapkan operasi pada indeks yang ditentukan. Tulis [IColorOperation](../icoloroperation/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/), **float**) | Menyisipkan operasi baru ke dalam koleksi. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorOperation](../icoloroperation/)\> [Insert](./insert/)(**int32_t**, [ColorTransformOperation](../colortransformoperation/)) | Menyisipkan operasi baru ke dalam koleksi. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Menghapus operasi warna dari sebuah koleksi. |
