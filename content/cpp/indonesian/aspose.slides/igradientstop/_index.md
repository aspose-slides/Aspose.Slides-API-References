...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() | Mengembalikan warna dari titik henti gradien. Hanya-baca [IColorFormat](../icolorformat/). |
| virtual **float** [get_Position](./get_position/)() | Mengembalikan posisi (0..1) dari titik henti gradien. Baca **float**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalinan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruktor ke subclass. |
...
| virtual void [set_Position](./set_position/)(**float**) | Mengatur posisi (0..1) dari titik henti gradien. Tulis **float**. |
