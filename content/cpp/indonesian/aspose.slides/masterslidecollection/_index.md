...
| Metode | Deskripsi |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Menambahkan salinan slide master yang ditentukan ke akhir koleksi. Slide tata letak yang terhubung juga akan disalin. |
| [iterator](./iterator/) [begin](./begin/)() | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dalam koleksi. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dari instansi koleksi yang bersifat const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama yang bersifat const (jika ada) dalam koleksi. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir yang bersifat const (jika ada) dalam koleksi. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>, **int32_t**) override | Menyalin semua elemen dari koleksi ke array yang ditentukan. |
...
| [const_iterator](./const_iterator/) [end](./end/)() const | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir (jika ada) dari instansi koleksi yang bersifat const. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator yang mengiterasi koleksi. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [idx_get](./idx_get/)(**int32_t**) override | Mendapatkan elemen pada indeks yang ditentukan. Hanya-baca [MasterSlide](../masterslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\> [InsertClone](./insertclone/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Menyisipkan salinan slide master yang ditentukan ke posisi tertentu dalam koleksi. Slide tata letak yang terhubung juga akan disalin. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Mengubah elemen-elemen urutan. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) override | Menghapus kemunculan pertama objek tertentu dari koleksi. |
...
| void [RemoveUnused](./removeunused/)(**bool**) override | Menghapus slide master yang tidak terpakai. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Menetapkan argumen template ke-n menjadi pointer lemah (bukan shared). Memungkinkan penggantian pointer dalam kontainer ke mode lemah. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dari instansi koleksi yang bersifat const. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir (jika ada) dari instansi koleksi yang bersifat const. |
