...
description: Mengembalikan perataan teks dalam sebuah paragraf tanpa pewarisan. Baca TextAlignment.
type: docs
weight: 1
url: /id/aspose.slides/paragraphformat/get_alignment/
---
## ParagraphFormat::get_Alignment() metode

Mengembalikan perataan teks dalam sebuah paragraf tanpa pewarisan. Baca [TextAlignment](../../textalignment/).
...
Kode contoh berikut menunjukkan cara Menyelaraskan Paragraf Teks di PowerPoint [Presentation](../../presentation/). 
```cpp
