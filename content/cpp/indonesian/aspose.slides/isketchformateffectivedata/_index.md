...
---
## ISketchFormatEffectiveData kelas
...
| virtual [LineSketchType](../linesketchtype/) [get_SketchType](./get_sketchtype/)() | Mengembalikan tipe sketsa. Hanya baca [Slides::LineSketchType](../linesketchtype/). |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan penguncian pernyataan C# lock(). Panggil secara langsung atau gunakan objek penahan [LockContext](../../system/lockcontext/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur n'th argumen template menjadi weak pointer (bukan shared). Memungkinkan beralih pointer dalam kontainer ke mode lemah. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pelepasan pernyataan C# lock(). Panggil secara langsung atau gunakan objek penahan [LockContext](../../system/lockcontext/). |
