...
description: Menentukan ukuran wilayah slide ((lebar ketika menjadi anak dari restoredTop, tinggi ketika menjadi anak dari restoredLeft) dari tampilan normal, ketika wilayah memiliki ukuran dipulihkan variabel(tidak diminimalkan maupun dimaksimalkan).
type: docs
weight: 4538
...
Menentukan ukuran wilayah slide ((lebar saat anak RestoredTop, tinggi saat anak RestoredLeft) dari tampilan normal, ketika wilayah memiliki ukuran dipulihkan yang variabel (tidak diminimalkan maupun dimaksimalkan).
...
| **bool** [get_AutoAdjust](./get_autoadjust/)() override | Menentukan apakah ukuran wilayah konten sisi harus mengkompensasi ukuran baru saat mengubah ukuran jendela yang berisi tampilan dalam aplikasi Baca **bool**. |
| **float** [get_DimensionSize](./get_dimensionsize/)() override | Menentukan ukuran wilayah slide (lebar saat anak RestoredTop, tinggi saat anak RestoredLeft). Baca **float**. |
...
| void [set_AutoAdjust](./set_autoadjust/)(**bool**) override | Menentukan apakah ukuran wilayah konten sisi harus mengkompensasi ukuran baru saat mengubah ukuran jendela yang berisi tampilan dalam aplikasi Tulis **bool**. |
| void [set_DimensionSize](./set_dimensionsize/)(**float**) override | Menentukan ukuran wilayah slide (lebar saat anak RestoredTop, tinggi saat anak RestoredLeft). Tulis **float**. |
...
* Kelas [INormalViewRestoredProperties](../inormalviewrestoredproperties/)
