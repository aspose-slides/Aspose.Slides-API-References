...
| [LightingDirection](../lightingdirection/) [get_Direction](./get_direction/)() override | Arah cahaya. Baca [LightingDirection](../lightingdirection/). |
| [LightRigPresetType](../lightrigpresettype/) [get_LightType](./get_lighttype/)() override | Mewakili preset cahaya kanan yang dapat diterapkan pada sebuah shape. Light rig mewakili sekumpulan cahaya yang diarahkan dengan cara tertentu relatif terhadap adegan 3D. Baca [LightRigPresetType](../lightrigpresettype/). |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() override | Rotasi didefinisikan melalui penggunaan koordinat lintang, koordinat bujur, dan revolusi sekitar sumbu sebagai koordinat lintang dan bujur. elemen pertama dalam array hasil - lintang, kedua - bujur, ketiga - revolusi. Mengembalikan null jika tidak ada rotasi yang didefinisikan. |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan lock() C# untuk penguncian. Panggil langsung atau gunakan objek penjaga [LockContext](../../system/lockcontext/). |
...
| void [set_Direction](./set_direction/)([LightingDirection](../lightingdirection/)) override | Arah cahaya. Tulis [LightingDirection](../lightingdirection/). |
| void [set_LightType](./set_lighttype/)([LightRigPresetType](../lightrigpresettype/)) override | Mewakili preset cahaya kanan yang dapat diterapkan pada sebuah shape. Light rig mewakili sekumpulan cahaya yang diarahkan dengan cara tertentu relatif terhadap adegan 3D. Tulis [LightRigPresetType](../lightrigpresettype/). |
| void [SetRotation](./setrotation/)(**float**, **float**, **float**) override | Rotasi didefinisikan melalui penggunaan koordinat lintang, koordinat bujur, dan revolusi sekitar sumbu sebagai koordinat lintang dan bujur. Jika salah satu nilai koordinat adalah std::numeric_limits<float>::quiet_NaN(), semua rotasi tidak terdefinisi. |
