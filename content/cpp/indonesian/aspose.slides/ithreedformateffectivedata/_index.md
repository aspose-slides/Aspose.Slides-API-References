...
description: Objek tidak dapat diubah yang mewakili properti pemformatan 3-D efektif.
type: docs
weight: 4174
...
Objek tidak dapat diubah yang mewakili properti pemformatan 3-D efektif.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevelEffectiveData](../ishapebeveleffectivedata/)\> [get_BevelBottom](./get_bevelbottom/)() | Mengembalikan tipe bevel 3D bawah. Hanya-baca [IShapeBevelEffectiveData](../ishapebeveleffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShapeBevelEffectiveData](../ishapebeveleffectivedata/)\> [get_BevelTop](./get_beveltop/)() | Mengembalikan tipe bevel 3D atas. Hanya-baca [IShapeBevelEffectiveData](../ishapebeveleffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICameraEffectiveData](../icameraeffectivedata/)\> [get_Camera](./get_camera/)() | Mengembalikan pengaturan kamera. Hanya-baca [ICameraEffectiveData](../icameraeffectivedata/). |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ContourColor](./get_contourcolor/)() | Mengembalikan warna kontur. Hanya-baca [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_ContourWidth](./get_contourwidth/)() | Mengembalikan lebar kontur 3D. Hanya-baca **double**. |
| virtual **double** [get_Depth](./get_depth/)() | Mengembalikan kedalaman bentuk 3D. Hanya-baca **double**. |
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_ExtrusionColor](./get_extrusioncolor/)() | Mengembalikan warna ekstrusi. Hanya-baca [System::Drawing::Color](../../system.drawing/color/). |
| virtual **double** [get_ExtrusionHeight](./get_extrusionheight/)() | Mengembalikan tinggi efek ekstrusi. Hanya-baca **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILightRigEffectiveData](../ilightrigeffectivedata/)\> [get_LightRig](./get_lightrig/)() | Mengembalikan tipe cahaya. Hanya-baca [ILightRigEffectiveData](../ilightrigeffectivedata/). |
| virtual [MaterialPresetType](../materialpresettype/) [get_Material](./get_material/)() | Mengembalikan tipe material. Hanya-baca [MaterialPresetType](../materialpresettype/). |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pembukaan penguncian pernyataan C# lock(). Panggil langsung atau gunakan objek penjaga [LockContext](../../system/lockcontext/). |
...
Antarmuka ini digunakan bersama dengan antarmuka [IThreeDFormat](../ithreedformat/) untuk mengembalikan nilai pemformatan efektif dengan penerapan pewarisan.
