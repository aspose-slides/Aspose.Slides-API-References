...
| [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../ifillformat/)\> [get_FillFormat](./get_fillformat/)() override | Mengembalikan objek properti isi tabel. Hanya-baca [IFillFormat](../ifillformat/). |
...
| **float** [get_Transparency](./get_transparency/)() override | Mendapatkan transparansi warna isi. Baca **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITableFormatEffectiveData](../itableformateffectivedata/)\> [GetEffective](./geteffective/)() override | Mendapatkan properti format tabel efektif dengan pewarisan dan gaya tabel yang diterapkan. |
...
| void [set_Transparency](./set_transparency/)(**float**) override | Mengatur transparansi warna isi. Tulis **float**. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Menyetel argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan mengubah pointer dalam kontainer ke mode weak. |
...
* Kelas [ITableFormat](../itableformat/)
