...
| Metode | Deskripsi |
| --- | --- |
| void [AddFallBackFonts](./addfallbackfonts/)([System::String](../../system/string/)) override | Menambahkan font baru ke daftar font FallBack. |
| void [AddFallBackFonts](./addfallbackfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) override | Menambahkan font baru ke daftar font FallBack. |
| void [Clear](./clear/)() override | Menghapus semua font dari daftar. |
...
|  [FontFallBackRule](./fontfallbackrule/)(**uint32_t**, **uint32_t**, [System::String](../../system/string/)) | Membuat instance baru. |
|  [FontFallBackRule](./fontfallbackrule/)(**uint32_t**, **uint32_t**, [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Membuat instance baru. |
| **int32_t** [get_Count](./get_count/)() override | Mendapatkan jumlah font yang sebenarnya didefinisikan untuk rentang. Hanya-baca **int32_t**. |
| **uint32_t** [get_RangeEndIndex](./get_rangeendindex/)() override | Mendapatkan indeks terakhir dari rentang unicode kontinu. |
| **uint32_t** [get_RangeStartIndex](./get_rangestartindex/)() override | Mendapatkan indeks pertama dari rentang unicode kontinu. |
...
| [System::String](../../system/string/) [idx_get](./idx_get/)(**int32_t**) override | Mendapatkan nama font pada indeks yang ditentukan. Hanya-baca [IFontFallBackRule](../ifontfallbackrule/). |
| **int32_t** [IndexOf](./indexof/)([System::String](../../system/string/)) override | Mengembalikan indeks aturan yang ditentukan dalam koleksi. |
...
| void [Remove](./remove/)([System::String](../../system/string/)) override | Menghapus kemunculan pertama dari font FallBack tertentu dari daftar. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Menghapus font FallBack pada indeks yang ditentukan dalam daftar. |
...
| void [set_RangeEndIndex](./set_rangeendindex/)(**uint32_t**) | Mendapatkan indeks terakhir dari rentang unicode kontinu. |
| void [set_RangeStartIndex](./set_rangestartindex/)(**uint32_t**) | Mendapatkan indeks pertama dari rentang unicode kontinu. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)() override | Membuat dan mengembalikan array dengan semua font FallBack untuk aturan ini. |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)(**int32_t**, **int32_t**) override | Membuat dan mengembalikan array dengan semua font FallBack dari rentang yang ditentukan dalam daftar. |
