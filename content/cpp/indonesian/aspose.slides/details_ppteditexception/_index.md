...
type: docs
weight: 664
url: /id/aspose.slides/details_ppteditexception/
---
## Details_PptEditException kelas
...
| virtual [String](../../system/string/) [get_Message](../../system/details_exception/get_message/)() const | Mengembalikan string yang berisi deskripsi error. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n sebagai pointer lemah (bukan berbagi). Mengizinkan pengalihan pointer dalam kontainer ke mode lemah. |
