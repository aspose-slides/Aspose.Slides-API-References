...
| Metode | Deskripsi |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [AddNotesSlide](./addnotesslide/)() override | Mengembalikan slide catatan untuk slide saat ini, membuat satu jika tidak ada. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[INotesSlide](../inotesslide/)\> [get_NotesSlide](./get_notesslide/)() override | Mengembalikan slide catatan untuk slide saat ini. Mengembalikan null jika slide tidak memiliki slide catatan. Hanya-baca [INotesSlide](../inotesslide/). |
...
| void [RemoveNotesSlide](./removenotesslide/)() override | Menghapus slide catatan dari slide saat ini. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Set argumen template ke-n sebagai weak pointer (bukan shared). Memungkinkan penggantian pointer dalam kontainer ke mode lemah. |
...
Contoh berikut menunjukkan cara Menambahkan Catatan ke slide PowerPoint [Presentation](../presentation/) tertentu. 
```cpp
...
```
 Contoh berikut menunjukkan cara menghapus Catatan dari slide tertentu PowerPoint [Presentation](../presentation/). 
```cpp
// Instansiasi objek Presentation yang mewakili file presentasi
auto presentation = System::MakeObject<Presentation>(dataDir + u"AccessSlides.pptx");
...
* Kelas [INotesSlideManager](../inotesslidemanager/)
