...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_BinaryData](./get_binarydata/)() | Mengembalikan salinan data audio. Jika data berukuran besar, pertimbangkan menggunakan metode [IVideo::GetStream](./getstream/) untuk mencegah pemuatan data video yang tidak perlu ke memori atau bahkan OutOfMemoryException. Hanya-baca **uint8_t**[]. |
| virtual [System::String](../../system/string/) [get_ContentType](./get_contenttype/)() | Mengembalikan tipe MIME video, dienkode dalam [IVideo::get_BinaryData](./get_binarydata/). Hanya-baca [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetStream](./getstream/)() | Mengembalikan stream Stream untuk membaca. Gunakan 'using' atau tutup stream setelah penggunaan. |
