...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../icolorformat/)\> [get_Color](./get_color/)() override | Mengembalikan warna dari satu titik gradien. Hanya-baca [IColorFormat](../icolorformat/). |
...
| **float** [get_Position](./get_position/)() override | Mengembalikan posisi (0..1) dari satu titik gradien. Baca **float**. |
...
| void [set_Position](./set_position/)(**float**) override | Mengatur posisi (0..1) dari satu titik gradien. Tulis **float**. |
...
* Kelas [IGradientStop](../igradientstop/)
