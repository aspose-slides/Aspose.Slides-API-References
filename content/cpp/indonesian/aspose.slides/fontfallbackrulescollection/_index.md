...
| Method | Deskripsi |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) override | Menambahkan aturan FallBack yang ditentukan ke akhir kumpulan. |
| [iterator](./iterator/) [begin](./begin/)() | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dari kumpulan. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dari instansi kumpulan yang bersifat const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama yang bersifat const (jika ada) dari kumpulan. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir yang bersifat const (jika ada) dari kumpulan. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>\>, **int32_t**) override | Menyalin semua elemen dari kumpulan ke array yang ditentukan. |
| virtual void [CopyTo](../igenericcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) | Menyalin semua elemen dari kumpulan ke dalam array yang ditentukan. |
| [iterator](./iterator/) [end](./end/)() | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir (jika ada) dari kumpulan. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir (jika ada) dari instansi kumpulan yang bersifat const. |
...
| **int32_t** [get_Count](./get_count/)() override | Mendapatkan jumlah aturan yang sebenarnya terdapat dalam kumpulan. Hanya-baca **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Mengembalikan nilai yang menunjukkan apakah akses ke kumpulan disinkronkan (aman terhadap thread). Hanya-baca **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator yang mengiterasi melalui kumpulan. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\> [idx_get](./idx_get/)(**int32_t**) override | Mendapatkan aturan pada indeks yang ditentukan. Hanya-baca [IFontFallBackRule](../ifontfallbackrule/). |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Mengembalikan elemen pertama dari urutan yang memenuhi kondisi atau nilai default jika tidak ditemukan elemen seperti itu. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Mengurutkan elemen-elemen urutan secara menurun berdasarkan nilai kunci yang dipilih oleh keySelector. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IFontFallBackRule](../ifontfallbackrule/)\>) override | Menghapus kemunculan pertama dari aturan FallBack tertentu dari kumpulan. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Mengurangi penghitung referensi bersama sebanyak nilai yang ditentukan. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen template ke-n menjadi pointer lemah (bukan berbagi). Memungkinkan pengalihan pointer dalam kontainer ke mode lemah. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dari instansi kumpulan yang bersifat const. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dari kumpulan. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir (jika ada) dari instansi kumpulan yang bersifat const. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir (jika ada) dari kumpulan. |
...
| Typedef | Deskripsi |
| --- | --- |
| [iterator_holder_type](./iterator_holder_type/) | Tipe kumpulan yang tipe iteratornya digunakan sebagai tipe iterator dalam kumpulan saat ini. |
