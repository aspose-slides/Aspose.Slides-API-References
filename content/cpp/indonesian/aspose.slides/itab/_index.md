...
| virtual [TabAlignment](../tabalignment/) [get_Alignment](./get_alignment/)() | Mengembalikan gaya penjajaran tab. Baca [TabAlignment](../tabalignment/). |
| virtual **double** [get_Position](./get_position/)() | Mengembalikan posisi tab. Menetapkan properti ini dapat mengubah indeks tab dalam koleksi dan membuat Enumerator tidak valid. Baca **double**. |
...
| virtual void [set_Alignment](./set_alignment/)([TabAlignment](../tabalignment/)) | Mengatur gaya penjajaran tab. Tulis [TabAlignment](../tabalignment/). |
| virtual void [set_Position](./set_position/)(**double**) | Mengatur posisi tab. Menetapkan properti ini dapat mengubah indeks tab dalam koleksi dan membuat Enumerator tidak valid. Tulis **double**. |
