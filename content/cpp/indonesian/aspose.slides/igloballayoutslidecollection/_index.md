...
description: Mewakili kumpulan semua slide tata letak dalam presentasi. Memperluas antarmuka ILayoutSlideCollection dengan metode untuk menambahkan/mengkloning slide tata letak dalam konteks penggabungan koleksi individual slide tata letak master.
type: docs
weight: 2367
url: /id/aspose.slides/igloballayoutslidecollection/
---
## IGlobalLayoutSlideCollection kelas
...
| Metode | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>, [SlideLayoutType](../slidelayouttype/), [System::String](../../system/string/)) | Menambahkan slide tata letak baru ke presentasi. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>) | Menambahkan salinan slide tata letak yang ditentukan ke presentasi. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [AddClone](./addclone/)([System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](../imasterslide/)\>) | Menambahkan salinan slide tata letak yang ditentukan ke presentasi. |
...
| virtual **bool** [get_IsSynchronized](../igenericcollection/get_issynchronized/)() | Mengembalikan nilai yang menunjukkan apakah akses ke koleksi disinkronkan (aman terhadap thread). Hanya-baca **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [idx_get](../ilayoutslidecollection/idx_get/)(**int32_t**) | Mengembalikan slide tata letak berdasarkan indeks. Hanya-baca [ILayoutSlide](../ilayoutslide/). |
