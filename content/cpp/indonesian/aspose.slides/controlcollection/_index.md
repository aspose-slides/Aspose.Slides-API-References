...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [AddControl](./addcontrol/)([ControlType](../controltype/), **float**, **float**, **float**, **float**) override | Membuat dan menambahkan kontrol baru ke dalam koleksi. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) yang const-qualified dari koleksi. |
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>\>, **int32_t**) override | Menyalin seluruh koleksi ke array yang ditentukan. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator yang mengiterasi koleksi. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\> [idx_get](./idx_get/)(**int32_t**) override | Mengembalikan kontrol pada posisi yang ditentukan. |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan C# lock() penguncian. Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IControl](../icontrol/)\>) override | Menghapus kontrol ActiveX dari koleksi. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Menghapus kontrol ActiveX yang disimpan pada posisi tertentu dari koleksi. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan C# lock() unlock. Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
...
* Kelas [IControlCollection](../icontrolcollection/)
