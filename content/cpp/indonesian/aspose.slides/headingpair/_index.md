...
description: Mewakili properti 'Heading pair' dari dokumen. Menunjukkan nama grup bagian dokumen dan jumlah bagian dalam grup.
type: docs
weight: 1223
...
| **int32_t** [get_Count](./get_count/)() override | Mengembalikan jumlah bagian dalam grup. Hanya-baca **int32_t**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Mengembalikan nama grup bagian dokumen. Hanya-baca [System::String](../../system/string/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek mewakili sebuah instansi dari tipe yang dijelaskan oleh targetType. Analogi operator C# 'is'. |
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan kunci C# lock() untuk mengunci. Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan kunci C# lock() untuk membuka kunci. Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
...
* Kelas [IHeadingPair](../iheadingpair/)
