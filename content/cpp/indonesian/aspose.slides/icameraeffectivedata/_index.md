...
description: Objek tak dapat diubah yang berisi properti kamera efektif.
type: docs
weight: 1600
url: /id/aspose.slides/icameraeffectivedata/
---
## ICameraEffectiveData kelas

Objek tak dapat diubah yang berisi properti kamera efektif.
...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) tipe. Hanya-baca [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 derajat, bidang pandang). Hanya-baca **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) zoom (nilai positif dalam persentase). Hanya-baca **float**. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Rotasi didefinisikan melalui penggunaan koordinat lintang, koordinat bujur, dan revolusi di sekitar sumbu sebagai koordinat lintang dan bujur. elemen pertama dalam array hasil - lintang, kedua - bujur, ketiga - revolusi. Mengembalikan null jika tidak ada rotasi yang didefinisikan. |
