...
| Metode | Deskripsi |
| --- | --- |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::String](../../system/string/)) | Menambahkan font baru ke daftar font FallBack. |
| virtual void [AddFallBackFonts](./addfallbackfonts/)([System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\>) | Menambahkan font baru ke daftar font FallBack. |
| virtual void [Clear](./clear/)() | Menghapus semua font dari daftar. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Mendapatkan jumlah font yang sebenarnya didefinisikan untuk rentang. |
| virtual **uint32_t** [get_RangeEndIndex](./get_rangeendindex/)() | Mendapatkan indeks terakhir dari rentang unicode berkelanjutan. |
| virtual **uint32_t** [get_RangeStartIndex](./get_rangestartindex/)() | Mendapatkan indeks pertama dari rentang unicode berkelanjutan. |
...
| virtual [System::String](../../system/string/) [idx_get](./idx_get/)(**int32_t**) | Mendapatkan nama font pada indeks yang ditentukan. |
| virtual **int32_t** [IndexOf](./indexof/)([System::String](../../system/string/)) | Mengembalikan indeks aturan yang ditentukan dalam koleksi. |
...
| virtual void [Remove](./remove/)([System::String](../../system/string/)) | Menghapus kemunculan pertama dari font FallBack tertentu dari daftar. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Menghapus font FallBack pada indeks tertentu dalam daftar. |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)() | Membuat dan mengembalikan array dengan semua font FallBack untuk aturan ini. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [ToArray](./toarray/)(**int32_t**, **int32_t**) | Membuat dan mengembalikan array dengan semua font FallBack dari rentang yang ditentukan dalam daftar. |
