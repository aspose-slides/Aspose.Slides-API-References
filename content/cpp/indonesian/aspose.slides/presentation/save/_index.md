...
---
## Presentation::Save(System::String, Export::SaveFormat) metode
...
## Presentation::Save(System::SharedPtr\<System::IO::Stream\>, Export::SaveFormat) metode
...
## Presentation::Save(System::String, Export::SaveFormat, System::SharedPtr\<Export::ISaveOptions\>) metode
...
Contoh berikut menunjukkan cara mengonversi PowerPoint ke HTML menggunakan C++. 
```cpp
// Membuat objek presentasi yang mewakili file presentasi, misalnya PPT, PPTX, ODP, dll.
...
```
 Contoh berikut menunjukkan cara mengonversi PowerPoint ke HTML responsif menggunakan C++. 
```cpp
...
```
 Contoh berikut menunjukkan cara mengonversi PowerPoint ke HTML dengan catatan menggunakan C++. 
```cpp
...
// Menyimpan halaman catatan
pres->Save(u"Output.html", SaveFormat::Html, opt);
```
 Contoh berikut menunjukkan cara mengonversi PowerPoint ke HTML dengan font asli menggunakan C++. 
```cpp
...
```
 Contoh berikut menunjukkan cara mengonversi PowerPoint ke HTML dengan gambar berkualitas tinggi pada 150 DPI menggunakan C++. 
```cpp
...
```
 Contoh berikut menunjukkan cara mengonversi PowerPoint ke HTML dengan gambar kualitas penuh menggunakan C++. 
```cpp
auto pres = System::MakeObject<Presentation>(u"InputDoc.pptx");
...
```
 Contoh berikut menunjukkan cara mengonversi [Slide](../../slide/) ke HTML menggunakan C++. 
```cpp
```
