...
description: Mewakili kontainer untuk data khusus.
type: docs
weight: 1912
...
Mewakili kontainer untuk data khusus.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPart](../icustomxmlpart/)\> [get_CustomXmlPart](./get_customxmlpart/)(**int32_t**) | Mengembalikan bagian XML khusus pada indeks yang ditentukan. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICustomXmlPartCollection](../icustomxmlpartcollection/)\> [get_CustomXmlParts](./get_customxmlparts/)() | Mengembalikan koleksi bagian xml khusus. Hanya-baca [ICustomXmlPartCollection](../icustomxmlpartcollection/). |
| virtual [System::String](../../system/string/) [get_Tag](./get_tag/)([System::String](../../system/string/)) | Mengembalikan Tag Data Pelanggan yang ditentukan pada indeks. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITagCollection](../itagcollection/)\> [get_Tags](./get_tags/)() | Mengembalikan koleksi Tag Data Pelanggan. Hanya-baca [ITagCollection](../itagcollection/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek merupakan contoh dari tipe yang dijelaskan oleh targetType. Analog dari operator 'is' C#. |
...
| virtual void [set_Tag](./set_tag/)([System::String](../../system/string/), [System::String](../../system/string/)) | Mengatur Tag Data Pelanggan yang ditentukan pada indeks. |
