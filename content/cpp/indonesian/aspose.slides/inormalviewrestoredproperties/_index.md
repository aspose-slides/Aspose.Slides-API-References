...
description: Menentukan ukuran wilayah slide ((lebar ketika menjadi anak restoredTop, tinggi ketika menjadi anak restoredLeft) dari tampilan normal, ketika wilayah memiliki ukuran restored variabel (tidak diminimalkan maupun dimaksimalkan).
type: docs
weight: 2991
url: /id/aspose.slides/inormalviewrestoredproperties/
---
## INormalViewRestoredProperties kelas

Menentukan ukuran wilayah slide ((lebar saat menjadi anak dari restoredTop, tinggi saat menjadi anak dari restoredLeft) pada tampilan normal, ketika wilayah memiliki ukuran restored variabel (tidak diminimalkan maupun dimaksimalkan).
...
| virtual **bool** [get_AutoAdjust](./get_autoadjust/)() | Menentukan apakah ukuran wilayah konten samping harus mengkompensasi ukuran baru saat mengubah ukuran jendela yang berisi tampilan dalam aplikasi. Baca **bool**. |
| virtual **float** [get_DimensionSize](./get_dimensionsize/)() | Menentukan ukuran wilayah slide (lebar ketika menjadi anak RestoredTop, tinggi ketika menjadi anak RestoredLeft). Baca **float**. |
...
| virtual void [set_AutoAdjust](./set_autoadjust/)(**bool**) | Menentukan apakah ukuran wilayah konten samping harus mengkompensasi ukuran baru saat mengubah ukuran jendela yang berisi tampilan dalam aplikasi. Tulis **bool**. |
| virtual void [set_DimensionSize](./set_dimensionsize/)(**float**) | Menentukan ukuran wilayah slide (lebar ketika menjadi anak RestoredTop, tinggi ketika menjadi anak RestoredLeft). Tulis **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen templat ke-n menjadi pointer lemah (bukan berbagi). Memungkinkan pengalihan pointer dalam kontainer ke mode lemah. |
