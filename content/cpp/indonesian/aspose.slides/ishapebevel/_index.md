...
description: Mewakili properti relief wajah utama shape.
type: docs
weight: 3654
...
Mewakili properti relief wajah utama shape.
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Tipe bevel. Baca [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Tinggi bevel. Baca **double**. |
| virtual **double** [get_Width](./get_width/)() | Lebar bevel. Baca **double**. |
...
| virtual void [set_BevelType](./set_beveltype/)([BevelPresetType](../bevelpresettype/)) | Tipe bevel. Tulis [BevelPresetType](../bevelpresettype/). |
| virtual void [set_Height](./set_height/)(**double**) | Tinggi bevel. Tulis **double**. |
| virtual void [set_Width](./set_width/)(**double**) | Lebar bevel. Tulis **double**. |
