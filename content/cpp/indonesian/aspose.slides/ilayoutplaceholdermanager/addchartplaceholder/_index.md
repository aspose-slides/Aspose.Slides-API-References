...
description: Menambahkan bentuk placeholder baru ke slide tata letak untuk menampung chart.
type: docs
weight: 66
url: /id/aspose.slides/ilayoutplaceholdermanager/addchartplaceholder/
---
## ILayoutPlaceholderManager::AddChartPlaceholder(float, float, float, float) metode


Menambahkan bentuk placeholder baru ke slide tata letak untuk menampung Chart.
