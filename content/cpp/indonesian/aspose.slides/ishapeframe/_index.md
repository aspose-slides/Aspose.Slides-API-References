...
| virtual **float** [get_CenterX](./get_centerx/)() | Mengembalikan koordinat X dari pusat sebuah frame. Baca-saja **float**. |
| virtual **float** [get_CenterY](./get_centery/)() | Mengembalikan koordinat Y dari pusat sebuah frame. Baca-saja **float**. |
| virtual [NullableBool](../nullablebool/) [get_FlipH](./get_fliph/)() | Menentukan apakah sebuah frame dibalik secara horizontal. Baca-saja [NullableBool](../nullablebool/). |
| virtual [NullableBool](../nullablebool/) [get_FlipV](./get_flipv/)() | Menentukan apakah sebuah frame dibalik secara vertikal. Baca-saja [NullableBool](../nullablebool/). |
| virtual **float** [get_Height](./get_height/)() | Mengembalikan tinggi sebuah frame. Baca-saja **float**. |
| virtual [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [get_Rectangle](./get_rectangle/)() | Mengembalikan koordinat sebuah frame. Baca-saja [System::Drawing::RectangleF](../../system.drawing/rectanglef/). |
| virtual **float** [get_Rotation](./get_rotation/)() | Mengembalikan jumlah derajat sebuah frame diputar di sekitar sumbu z. Nilai positif menunjukkan rotasi searah jarum jam; nilai negatif menunjukkan rotasi berlawanan arah jarum jam. Baca-saja **float**. |
| virtual **float** [get_Width](./get_width/)() | Mengembalikan lebar sebuah frame. Baca-saja **float**. |
| virtual **float** [get_X](./get_x/)() | Mengembalikan koordinat X dari sudut kiri atas sebuah frame. Baca-saja **float**. |
| virtual **float** [get_Y](./get_y/)() | Mengembalikan koordinat Y dari sudut kiri atas sebuah frame. Baca-saja **float**. |
