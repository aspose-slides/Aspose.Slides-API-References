...
| virtual [System::String](../../system/string/) [get_OriginalUri](./get_originaluri/)() | URI asli sumber daya sebagaimana ditentukan dalam presentasi yang diimpor. |
| virtual [System::String](../../system/string/) [get_Uri](./get_uri/)() | URI sumber daya yang digunakan untuk mengunduh jika [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) mengembalikan [ResourceLoadingAction::Default](../resourceloadingaction/). Awalnya diatur ke URI asli sumber daya, tetapi dapat diubah ke nilai apa pun. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogi metode C# [Object.GetHashCode()](../../system/object/gethashcode/). Mengaktifkan pembuatan hash objek kustom. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan subclass menyalin diri. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan subclass menyalin diri. |
...
| virtual void [set_Uri](./set_uri/)([System::String](../../system/string/)) | URI sumber daya yang digunakan untuk mengunduh jika [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) mengembalikan [ResourceLoadingAction::Default](../resourceloadingaction/). Awalnya diatur ke URI asli sumber daya, tetapi dapat diubah ke nilai apa pun. |
| virtual void [SetData](./setdata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Menetapkan data yang disediakan pengguna untuk sumber daya yang digunakan jika [IResourceLoadingCallback::ResourceLoading()](../iresourceloadingcallback/resourceloading/) mengembalikan [ResourceLoadingAction::UserProvided](../resourceloadingaction/). |
