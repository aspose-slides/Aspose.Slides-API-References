...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dari instance koleksi yang dikualifikasikan sebagai const. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama yang dikualifikasikan sebagai const (jika ada) dalam koleksi. |
...
| void [CopyTo](../cellcollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>\>, **int32_t**) override | Menyalin semua elemen dari koleksi ke array yang ditentukan. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir (jika ada) dari instance koleksi yang dikualifikasikan sebagai const. |
...
| **int32_t** [get_Count](../cellcollection/get_count/)() override | Mengembalikan jumlah sel dalam koleksi. Hanya baca **int32_t**. |
| **double** [get_Height](./get_height/)() override | Mengembalikan tinggi baris. Hanya baca **double**. |
| **bool** [get_IsSynchronized](../cellcollection/get_issynchronized/)() override | Mengembalikan nilai yang menunjukkan apakah akses ke koleksi disinkronkan (aman terhadap thread). Hanya baca **bool**. |
| **double** [get_MinimalHeight](./get_minimalheight/)() override | Mengembalikan tinggi minimal yang mungkin untuk sebuah baris. Baca **double**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](../cellcollection/get_presentation/)() override | Mengembalikan presentasi induk dari [CellCollection](../cellcollection/). Hanya baca [IPresentation](../ipresentation/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IRowFormat](../irowformat/)\> [get_RowFormat](./get_rowformat/)() override | Mengembalikan objek [RowFormat](../rowformat/) yang berisi properti pemformatan untuk baris ini. Hanya baca [IRowFormat](../irowformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../cellcollection/get_slide/)() override | Mengembalikan slide induk dari [CellCollection](../cellcollection/). Hanya baca [IBaseSlide](../ibaseslide/). |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](../cellcollection/get_syncroot/)() override | Mengembalikan akar sinkronisasi. Hanya baca [System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\>\>\> [GetEnumerator](../cellcollection/getenumerator/)() override | Mengembalikan enumerator yang mengiterasi melalui koleksi. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](../cellcollection/idx_get/)(**int32_t**) override | Mengembalikan sel berdasarkan posisinya. Hanya baca [Cell](../cell/). |
...
| void [set_MinimalHeight](./set_minimalheight/)(**double**) override | Mengatur tinggi minimal yang mungkin untuk baris. Tulis **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan pengubahan pointer dalam kontainer ke mode lemah. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\>) override | Mengatur properti format bagian yang ditentukan ke semua bagian sel baris. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[IParagraphFormat](../iparagraphformat/)\>) override | Mengatur properti format paragraf yang ditentukan ke semua paragraf sel baris. |
| void [SetTextFormat](./settextformat/)([System::SharedPtr](../../system/sharedptr/)\<[ITextFrameFormat](../itextframeformat/)\>) override | Mengatur properti format bingkai teks yang ditentukan ke semua bingkai teks sel baris. |
