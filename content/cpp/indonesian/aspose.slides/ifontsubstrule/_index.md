...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_DestFont](./get_destfont/)() | Font yang digunakan untuk substitusi Hanya-baca [IFontData](../ifontdata/). |
| virtual [FontSubstCondition](../fontsubstcondition/) [get_ReplaceFontCondition](./get_replacefontcondition/)() | Aturan yang diterapkan untuk substitusi Hanya-baca [FontSubstCondition](../fontsubstcondition/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontData](../ifontdata/)\> [get_SourceFont](./get_sourcefont/)() | Font yang disubstitusi Hanya-baca [IFontData](../ifontdata/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek mewakili sebuah instance tipe yang dijelaskan oleh targetType. Analog operator C# 'is'. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan lock() C# untuk pelepasan kunci. Panggil langsung atau gunakan objek pengawas [LockContext](../../system/lockcontext/). |
