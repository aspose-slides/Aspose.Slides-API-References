...
---
## ISensitivityLabelCollection kelas
...
| Method | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [Add](./add/)([System::String](../../system/string/), [System::Guid](../../system/guid/), **bool**, [SensitivityLabelAssignmentType](../sensitivitylabelassignmenttype/)) | Menambahkan label sensitivitas di akhir koleksi. |
| virtual **int32_t** [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\>) | Menambahkan [SensitivityLabel](../sensitivitylabel/) ke dalam koleksi. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Mendapatkan jumlah semua elemen dalam koleksi. Hanya-baca **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISensitivityLabel](../isensitivitylabel/)\> [idx_get](./idx_get/)(**int32_t**) | Mengembalikan label sensitivitas berdasarkan indeks. Hanya-baca [ISensitivityLabel](../isensitivitylabel/). |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Menghapus label sensitivitas pada indeks yang ditentukan. |
...
| void [Unlock](../../system/object/unlock/)() | Menerapkan pembukaan penguncian pernyataan C# lock(). Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
