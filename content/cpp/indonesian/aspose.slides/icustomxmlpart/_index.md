...
| virtual [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() | Menentukan pengenal global unik (GUID) yang secara unik mengidentifikasi satu bagian XML khusus dalam dokumen Office Open XML. Hanya-baca [System::Guid](../../system/guid/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() | Mengembalikan koleksi skema XML yang terkait dengan bagian XML khusus. Hanya-baca [System::String](../../system/string/)[]. |
| virtual [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() | Mengembalikan data xml sebagai string UTF-8. Baca [System::String](../../system/string/). |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() | Mengembalikan data xml. Baca **uint8_t**[]. |
...
| virtual void [Remove](./remove/)() | Menghapus bagian XML khusus dari presentasi. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Mengurangi penghitung referensi bersama sebesar nilai yang ditentukan. |
| virtual void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) | Menentukan pengenal global unik (GUID) yang secara unik mengidentifikasi satu bagian XML khusus dalam dokumen Office Open XML. Hanya-baca [System::Guid](../../system/guid/). |
| virtual void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) | Menetapkan data xml sebagai string UTF-8. Tulis [System::String](../../system/string/). |
| virtual void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Menetapkan data xml. Tulis **uint8_t**[]. |
