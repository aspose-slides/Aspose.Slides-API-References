...
description: Mewakili manajer yang memegang perilaku placeholder, termasuk placeholder header untuk semua jenis slide handout dan catatan.
type: docs
weight: 118
...
Mewakili manajer yang memegang perilaku placeholder, termasuk placeholder header untuk semua jenis slide handout dan catatan.
...
| **bool** [get_IsHeaderVisible](./get_isheadervisible/)() override | Mendapatkan nilai yang menunjukkan bahwa placeholder header ada. Baca **bool**. |
...
| void [SetHeaderText](./setheadertext/)([System::String](../../system/string/)) override | Menetapkan teks ke placeholder header slide. |
| void [SetHeaderVisibility](./setheadervisibility/)(**bool**) override | Mengubah visibilitas placeholder header slide. |
