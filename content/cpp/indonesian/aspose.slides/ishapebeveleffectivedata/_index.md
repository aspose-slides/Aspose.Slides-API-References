...
description: Objek tidak dapat diubah yang berisi properti relief permukaan bentuk yang efektif.
type: docs
weight: 3667
url: /id/aspose.slides/ishapebeveleffectivedata/
---
## IShapeBevelEffectiveData kelas

Objek tidak dapat diubah yang berisi properti relief permukaan bentuk yang efektif.
...
| virtual [BevelPresetType](../bevelpresettype/) [get_BevelType](./get_beveltype/)() | Tipe bevel. Hanya-baca [BevelPresetType](../bevelpresettype/). |
| virtual **double** [get_Height](./get_height/)() | Tinggi bevel. Hanya-baca **double**. |
| virtual **double** [get_Width](./get_width/)() | Lebar bevel. Hanya-baca **double**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Set argumen template ke-n sebagai pointer lemah (bukan bersama). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
