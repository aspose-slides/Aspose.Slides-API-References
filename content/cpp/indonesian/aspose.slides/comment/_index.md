...
| [System::SharedPtr](../../system/sharedptr/)\<[ICommentAuthor](../icommentauthor/)\> [get_Author](./get_author/)() override | Mengembalikan penulis komentar. Hanya-baca [ICommentAuthor](../icommentauthor/). |
| [System::DateTime](../../system/datetime/) [get_CreatedTime](./get_createdtime/)() override | Mengembalikan waktu pembuatan komentar. Menyetel properti ini ke [DateTime::MinValue](../../system/datetime/minvalue/) berarti tidak ada waktu komentar yang diatur. Baca [System::DateTime](../../system/datetime/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\> [get_ParentComment](./get_parentcomment/)() override | Mendapatkan komentar induk. Baca [IComment](../icomment/). |
| [System::Drawing::PointF](../../system.drawing/pointf/) [get_Position](./get_position/)() override | Mengembalikan posisi komentar pada slide. Baca [System::Drawing::PointF](../../system.drawing/pointf/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\> [get_Slide](./get_slide/)() override | Mengembalikan slide induk dari komentar. Hanya-baca [ISlide](../islide/). |
| [System::String](../../system/string/) [get_Text](./get_text/)() override | Mengembalikan teks polos komentar slide. Baca [System::String](../../system/string/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek merupakan contoh tipe yang dijelaskan oleh targetType. Analogi operator C# 'is'. |
...
| void [Remove](./remove/)() override | Menghapus komentar dan semua balasannya dari koleksi induk. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Mengurangi penghitung referensi bersama sebesar nilai yang ditentukan. |
| void [set_CreatedTime](./set_createdtime/)([System::DateTime](../../system/datetime/)) override | Mengatur waktu pembuatan komentar. Menyetel properti ini ke [DateTime::MinValue](../../system/datetime/minvalue/) berarti tidak ada waktu komentar yang diatur. Tulis [System::DateTime](../../system/datetime/). |
| void [set_ParentComment](./set_parentcomment/)([System::SharedPtr](../../system/sharedptr/)\<[IComment](../icomment/)\>) override | Mengatur komentar induk. Tulis [IComment](../icomment/). |
| void [set_Position](./set_position/)([System::Drawing::PointF](../../system.drawing/pointf/)) override | Mengatur posisi komentar pada slide. Tulis [System::Drawing::PointF](../../system.drawing/pointf/). |
| void [set_Text](./set_text/)([System::String](../../system/string/)) override | Mengatur teks polos komentar slide. Tulis [System::String](../../system/string/). |
