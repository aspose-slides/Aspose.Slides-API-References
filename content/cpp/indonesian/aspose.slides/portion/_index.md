...
description: Mewakili sebagian teks di dalam sebuah paragraf teks.
type: docs
weight: 4772
...
Mewakili sebagian teks di dalam sebuah paragraf teks.
...
| Metode | Deskripsi |
| --- | --- |
| void [AddField](./addfield/)([System::SharedPtr](../../system/sharedptr/)\<[IFieldType](../ifieldtype/)\>) override | Mengonversi bagian ini menjadi bidang yang diperbarui secara otomatis. |
| void [AddField](./addfield/)([System::String](../../system/string/)) override | Mengonversi bagian ini menjadi bidang yang diperbarui secara otomatis. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IField](../ifield/)\> [get_Field](./get_field/)() override | Mengembalikan bidang dari bagian ini. Hanya baca [IField](../ifield/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../iportionformat/)\> [get_PortionFormat](./get_portionformat/)() override | Mengembalikan objek format yang berisi properti format yang ditetapkan secara eksplisit dari bagian teks tanpa pewarisan yang diterapkan. Hanya baca [IPortionFormat](../iportionformat/). |
| [System::String](../../system/string/) [get_Text](./get_text/)() override | Mendapatkan teks polos dari sebuah bagian. Baca [System::String](../../system/string/). |
| [System::Drawing::PointF](../../system.drawing/pointf/) [GetCoordinates](./getcoordinates/)() override | Mendapatkan koordinat awal bagian. Koordinat X titik mewakili awal bagian dari karakter pertama termasuk bearing sisi kiri. Koordinat Y termasuk bearing sisi atas. |
...
| [System::Drawing::RectangleF](../../system.drawing/rectanglef/) [GetRect](./getrect/)() override | Mendapatkan koordinat kotak yang membatasi bagian. Kotak termasuk semua baris teks dalam bagian, termasuk yang kosong. |
...
|  [Portion](./portion/)([System::String](../../system/string/)) | Menginisialisasi instance baru dari kelas [Portion](./). |
|  [Portion](./portion/)([System::SharedPtr](../../system/sharedptr/)\<[Portion](./)\>) | Menginisialisasi instance baru dari kelas [Portion](./). |
...
| void [RemoveField](./removefield/)() override | Mengonversi bagian bidang ini menjadi bagian sederhana. |
| void [set_Text](./set_text/)([System::String](../../system/string/)) override | Mengatur teks polos dari sebuah bagian. Tulis [System::String](../../system/string/). |
