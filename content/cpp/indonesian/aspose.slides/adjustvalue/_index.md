...
description: Mewakili nilai penyesuaian bentuk geometri. Nilai-nilai ini memengaruhi bentuk shape.
type: docs
weight: 1
...
Mewakili nilai penyesuaian bentuk geometri. Nilai-nilai ini memengaruhi bentuk shape.
...
| **float** [get_AngleValue](./get_anglevalue/)() override | Mengembalikan nilai, menginterpretasikannya sebagai sudut dalam derajat. Baca **float**. |
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Mengembalikan nama nilai penyesuaian ini. Hanya-baca [System::String](../../system/string/). |
| **int64_t** [get_RawValue](./get_rawvalue/)() override | Mengembalikan nilai penyesuaian "sebagaimana adanya". Baca **int64_t**. |
| [ShapeAdjustmentType](../shapeadjustmenttype/) [get_Type](./get_type/)() override | Mengembalikan tipe penyesuaian shape. Hanya-baca [ShapeAdjustmentType](../shapeadjustmenttype/). |
...
| void [set_AngleValue](./set_anglevalue/)(**float**) override | Mengatur nilai, menginterpretasikannya sebagai sudut dalam derajat. Tulis **float**. |
| void [set_RawValue](./set_rawvalue/)(**int64_t**) override | Mengatur nilai penyesuaian "sebagaimana adanya". Tulis **int64_t**. |
...
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Menurunkan penghitung referensi weak. Tidak boleh dipanggil secara langsung; gunakan smart pointers atau ThisProtector. |
| virtual  [~Object](../../system/object/~object/)() | Menghancurkan objek. Membebaskan semua struktur data internal. |

## Lihat Juga

* Kelas [IAdjustValue](../iadjustvalue/)
