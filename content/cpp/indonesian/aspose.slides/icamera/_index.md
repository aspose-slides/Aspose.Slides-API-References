...
| virtual [CameraPresetType](../camerapresettype/) [get_CameraType](./get_cameratype/)() | [Camera](../camera/) type Baca [CameraPresetType](../camerapresettype/). |
| virtual **float** [get_FieldOfViewAngle](./get_fieldofviewangle/)() | [Camera](../camera/) FOV (0-180 deg, field of View) Baca **float**. |
| virtual **float** [get_Zoom](./get_zoom/)() | [Camera](../camera/) zoom (nilai positif dalam persentase) Baca **float**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog dari metode C# [Object.GetHashCode()](../../system/object/gethashcode/). Mengaktifkan hashing objek khusus. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**float**\> [GetRotation](./getrotation/)() | Rotasi didefinisikan melalui penggunaan koordinat lintang, koordinat bujur, dan revolusi tentang sumbu sebagai koordinat lintang dan bujur. elemen pertama dalam array hasil - lintang, kedua - bujur, ketiga - revolusi. Mengembalikan null jika tidak ada rotasi yang didefinisikan. |
...
| virtual void [set_CameraType](./set_cameratype/)([CameraPresetType](../camerapresettype/)) | [Camera](../camera/) tipe Tulis [CameraPresetType](../camerapresettype/). |
| virtual void [set_FieldOfViewAngle](./set_fieldofviewangle/)(**float**) | [Camera](../camera/) FOV (0-180 deg, field of View) Tulis **float**. |
| virtual void [set_Zoom](./set_zoom/)(**float**) | [Camera](../camera/) zoom (nilai positif dalam persentase) Tulis **float**. |
| virtual void [SetRotation](./setrotation/)(**float**, **float**, **float**) | Rotasi didefinisikan melalui penggunaan koordinat lintang, koordinat bujur, dan revolusi tentang sumbu sebagai koordinat lintang dan bujur. Jika salah satu nilai koordinat adalah std::numeric_limits<float>::quiet_NaN(), semua rotasi menjadi tidak terdefinisi. |
