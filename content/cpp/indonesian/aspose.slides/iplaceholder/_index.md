...
| virtual **uint32_t** [get_Index](./get_index/)() | Mendapatkan indeks placeholder. Hanya-baca **uint32_t**. |
| virtual [Aspose::Slides::Orientation](../orientation/) [get_Orientation](./get_orientation/)() | Mendapatkan orientasi placeholder. Hanya-baca [Slides::Orientation](../orientation/). |
| virtual [PlaceholderSize](../placeholdersize/) [get_Size](./get_size/)() | Mendapatkan ukuran placeholder. Hanya-baca [PlaceholderSize](../placeholdersize/). |
| virtual [PlaceholderType](../placeholdertype/) [get_Type](./get_type/)() | Mendapatkan jenis placeholder. Hanya-baca [PlaceholderType](../placeholdertype/). |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan kunci C# lock(). Panggil secara langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan unlock C# lock(). Panggil secara langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
