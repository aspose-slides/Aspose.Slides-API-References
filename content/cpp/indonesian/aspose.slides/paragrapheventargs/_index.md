...
description: Kelas argumen peristiwa untuk peristiwa terkait paragraf.
type: docs
weight: 4642
url: /id/aspose.slides/paragrapheventargs/
---
## ParagraphEventArgs kelas

Kelas argumen peristiwa untuk peristiwa terkait paragraf.
...
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Membandingkan nilai tipe objek referensi dengan nullptr. |
...
| Bidang | Deskripsi |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Anggota statis yang mewakili sebuah pointer bersama "kosong" [EventArgs](../../system/eventargs/) (null-pointer). |
