...
| virtual **int32_t** [get_Count](../igenericcollection/get_count/)() | Mengembalikan jumlah perilaku dalam sebuah koleksi. **int32_t** baca-saja. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPresentation](../ipresentation/)\> [get_Presentation](../ipresentationcomponent/get_presentation/)() | Mengembalikan presentasi. [IPresentation](../ipresentation/) baca-saja. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\> [get_Slide](../islidecomponent/get_slide/)() | Mengembalikan slide dasar. [IBaseSlide](../ibaseslide/) baca-saja. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICell](../icell/)\> [idx_get](./idx_get/)(**int32_t**) | Mengembalikan sel berdasarkan posisinya. [ICell](../icell/) baca-saja. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Mengurutkan elemen-elemen dari sebuah urutan dalam urutan menurun berdasarkan nilai kunci yang dipilih oleh keySelector. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi weak pointer (bukan shared). Mengizinkan perubahan pointer dalam kontainer ke mode weak. |
