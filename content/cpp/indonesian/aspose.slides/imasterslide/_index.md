...
| Metode | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlide](./)\> [ApplyExternalThemeToDependingSlides](./applyexternalthemetodependingslides/)([System::String](../../system/string/)) | Membuat slide master baru berdasarkan slide saat ini, menerapkan tema eksternal padanya, dan menerapkan slide master yang dibuat ke semua slide yang bergantung. |
...
| virtual **bool** [Equals](../ibaseslide/equals/)([System::SharedPtr](../../system/sharedptr/)\<[IBaseSlide](../ibaseslide/)\>) | Menentukan apakah dua instance [IBaseSlide](../ibaseslide/) sama. Nilai yang dikembalikan dihitung berdasarkan struktur slide dan konten statis. Dua slide dianggap sama jika semua bentuk, gaya, teks, animasi, dan pengaturan lainnya, dll., sama. Perbandingan ini tidak memperhitungkan nilai pengenal unik, misalnya SlideId, dan konten dinamis, misalnya nilai tanggal saat ini dalam Date [Placeholder](../placeholder/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../ishape/)\> [FindShapeByAltText](../ibaseslide/findshapebyalttext/)([System::String](../../system/string/)) | Menemukan kejadian pertama sebuah bentuk dengan teks alternatif yang ditentukan. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextStyle](../itextstyle/)\> [get_BodyStyle](./get_bodystyle/)() | Mengembalikan gaya teks badan. Baca-saja [ITextStyle](../itextstyle/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IControlCollection](../icontrolcollection/)\> [get_Controls](../ibaseslide/get_controls/)() | Mengembalikan koleksi kontrol ActiveX pada slide. Baca-saja [IControlCollection](../icontrolcollection/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDrawingGuidesCollection](../idrawingguidescollection/)\> [get_DrawingGuides](./get_drawingguides/)() | Mengembalikan koleksi panduan gambar untuk slide master. Baca-saja [IDrawingGuidesCollection](../idrawingguidescollection/) |
| virtual **bool** [get_HasDependingSlides](./get_hasdependingslides/)() | Mengembalikan true jika ada setidaknya satu slide yang bergantung pada slide master ini. Baca-saja **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterSlideHeaderFooterManager](../imasterslideheaderfootermanager/)\> [get_HeaderFooterManager](./get_headerfootermanager/)() | Mengembalikan manajer HeaderFooter dari slide master. Baca-saja [IMasterSlideHeaderFooterManager](../imasterslideheaderfootermanager/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IHyperlinkQueries](../ihyperlinkqueries/)\> [get_HyperlinkQueries](../ibaseslide/get_hyperlinkqueries/)() | Menyediakan akses mudah ke hyperlink yang terkandung. Baca-saja [IHyperlinkQueries](../ihyperlinkqueries/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILayoutSlide](../ilayoutslide/)\> [get_LayoutSlide](./get_layoutslide/)(**int32_t**) | Mengembalikan slide tata letak anak untuk slide master ini pada indeks yang ditentukan. Baca-saja [Aspose::Slides::ILayoutSlide](../ilayoutslide/) |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMasterLayoutSlideCollection](../imasterlayoutslidecollection/)\> [get_LayoutSlides](./get_layoutslides/)() | Mengembalikan koleksi slide tata letak anak untuk slide master ini. Baca-saja [IMasterLayoutSlideCollection](../imasterlayoutslidecollection/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextStyle](../itextstyle/)\> [get_OtherStyle](./get_otherstyle/)() | Mengembalikan gaya teks lain. Baca-saja [ITextStyle](../itextstyle/). |
...
| virtual **bool** [get_Preserve](./get_preserve/)() | Menentukan apakah master yang bersangkutan dihapus ketika semua slide yang mengikuti master tersebut dihapus. Catatan: [Aspose.Slides](../) tidak akan pernah menghapus master yang tidak terpakai sendiri, untuk benar-benar menghapus master yang tidak terpakai panggil [IMasterSlideCollection::RemoveUnused](../imasterslidecollection/removeunused/) Baca **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ITextStyle](../itextstyle/)\> [get_TitleStyle](./get_titlestyle/)() | Mengembalikan gaya teks judul. Baca-saja [ITextStyle](../itextstyle/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../islide/)\>\> [GetDependingSlides](./getdependingslides/)() | Mengembalikan array dengan semua slide yang bergantung pada slide master ini. |
...
| virtual void [JoinPortionsWithSameFormatting](../ibaseslide/joinportionswithsameformatting/)() | Menggabungkan run dengan pemformatan yang sama dalam semua paragraf di semua bentuk yang dapat diterima. |
...
| virtual void [set_Preserve](./set_preserve/)(**bool**) | Menentukan apakah master yang bersangkutan dihapus ketika semua slide yang mengikuti master tersebut dihapus. Catatan: [Aspose.Slides](../) tidak akan pernah menghapus master yang tidak terpakai sendiri, untuk benar-benar menghapus master yang tidak terpakai panggil [IMasterSlideCollection::RemoveUnused](../imasterslidecollection/removeunused/) Tulis **bool**. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen templat ke-n menjadi weak pointer (bukan shared). Memungkinkan beralih pointer dalam kontainer ke mode weak. |
| int [SharedCount](../../system/object/sharedcount/)() const | Mendapatkan nilai saat ini dari penghitung referensi bersama. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Meningkatkan penghitung referensi bersama. Jangan dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Meningkatkan penghitung referensi lemah. Jangan dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
