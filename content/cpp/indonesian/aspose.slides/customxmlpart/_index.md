...
| [System::Guid](../../system/guid/) [get_ItemId](./get_itemid/)() override | Menentukan pengidentifikasi unik global (GUID) yang secara unik mengidentifikasi satu bagian XML khusus dalam dokumen Office Open XML. Hanya-baca [System::Guid](../../system/guid/). |
| [System::ArrayPtr](../../system/arrayptr/)\<[System::String](../../system/string/)\> [get_NamespaceSchemas](./get_namespaceschemas/)() override | Mengembalikan kumpulan skema XML yang terkait dengan bagian XML khusus. Hanya-baca [System::String](../../system/string/)[]. |
| [System::String](../../system/string/) [get_XmlAsString](./get_xmlasstring/)() override | Mengembalikan data xml sebagai string UTF-8. Baca [System::String](../../system/string/). |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_XmlData](./get_xmldata/)() override | Mengembalikan data xml. Baca **uint8_t**[]. |
...
| void [Remove](./remove/)() override | Menghapus bagian xml khusus dari presentasi. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Mengurangi penghitung referensi bersama sebesar nilai yang ditentukan. |
| void [set_ItemId](./set_itemid/)([System::Guid](../../system/guid/)) override | Menentukan pengidentifikasi unik global (GUID) yang secara unik mengidentifikasi satu bagian XML khusus dalam dokumen Office Open XML. Hanya-baca [System::Guid](../../system/guid/). |
| void [set_XmlAsString](./set_xmlasstring/)([System::String](../../system/string/)) override | Menetapkan data xml sebagai string UTF-8. Tulis [System::String](../../system/string/). |
| void [set_XmlData](./set_xmldata/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Menetapkan data xml. Tulis **uint8_t**[]. |
