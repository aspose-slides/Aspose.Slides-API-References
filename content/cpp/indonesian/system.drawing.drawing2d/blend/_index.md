...
description: "Mewakili pola blend untuk objek LinearGradientBrush. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer tersebut untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 14
url: /id/system.drawing.drawing2d/blend/
---
## Blend kelas

Mewakili pola blend untuk objek [LinearGradientBrush](../lineargradientbrush/). Objek kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer tersebut untuk memberikannya ke fungsi sebagai argumen.
...
| Method | Description |
| --- | --- |
|  [Blend](./blend/)() | Membuat instance baru dari kelas [Blend](./). |
|  [Blend](./blend/)(int) | Membuat instance baru dari kelas [Blend](./). |
...
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Factors](./get_factors/)() const | Mengembalikan array faktor blend dari gradien. |
| [ArrayPtr](../../system/arrayptr/)\<**float**\> [get_Positions](./get_positions/)() const | Mengembalikan array posisi blend dari gradien. |
...
| void [set_Factors](./set_factors/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | Mengatur array faktor blend dari gradien. |
| void [set_Positions](./set_positions/)(const [ArrayPtr](../../system/arrayptr/)\<**float**\>\&) | Mengatur array posisi blend dari gradien. |
