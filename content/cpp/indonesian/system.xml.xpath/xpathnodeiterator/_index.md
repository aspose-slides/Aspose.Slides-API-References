...
description: Menyediakan iterator atas sekumpulan node yang dipilih.
type: docs
weight: 79
url: /id/system.xml.xpath/xpathnodeiterator/
---
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNodeIterator](./)\> [Clone](./clone/)() | Ketika dioverride dalam kelas turunan, mengembalikan klon dari objek [XPathNodeIterator](./) ini. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Mengembalikan indeks node terakhir dalam sekumpulan node yang dipilih. |
| virtual const [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\& [get_Current](./get_current/)() | Ketika dioverride dalam kelas turunan, memperoleh objek [XPathNavigator](../xpathnavigator/) untuk [XPathNodeIterator](./) ini, yang diposisikan pada node konteks saat ini. |
| virtual **int32_t** [get_CurrentPosition](./get_currentposition/)() | Ketika dioverride dalam kelas turunan, memperoleh indeks posisi saat ini dalam sekumpulan node yang dipilih. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan objek IEnumerator untuk mengiterasi sekumpulan node yang dipilih. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Mendapatkan tipe sebenarnnya dari objek. Analog panggilan C# [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual **bool** [MoveNext](./movenext/)() | Ketika dioverride dalam kelas turunan, memindahkan objek [XPathNavigator](../xpathnavigator/) yang dikembalikan oleh metode [XPathNodeIterator::get_Current](./get_current/) ke node berikutnya dalam sekumpulan node yang dipilih. |
...
| [XPathNodeIterator](./xpathnodeiterator/)() | Menginisialisasi instance baru dari kelas [XPathNodeIterator](./). |
...
| Typedef | Deskripsi |
| --- | --- |
| [Ptr](./ptr/) | Alias untuk shared pointer ke suatu instance kelas ini. |
