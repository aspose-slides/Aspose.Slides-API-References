...
description: "Digunakan untuk mencocokkan nama cookie dan spesifikasi. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam penunjuk System::SmartPtr dan gunakan penunjuk ini untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 196
url: /id/system.net/headervariantinfo/
---
## HeaderVariantInfo kelas

Digunakan untuk mencocokkan nama cookie dan spesifikasi. Objek dari kelas ini harus hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instansi tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam penunjuk [System::SmartPtr](../../system/smartptr/) dan gunakan penunjuk ini untuk melewatkannya ke fungsi sebagai argumen.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Mengembalikan nama cookie. |
| [CookieVariant](../cookievariant/) [get_Variant](./get_variant/)() | Mengembalikan spesifikasi cookie. |
...
|  [HeaderVariantInfo](./headervariantinfo/)([String](../../system/string/), [CookieVariant](../cookievariant/)) | Membuat instansi baru. |
|  [HeaderVariantInfo](./headervariantinfo/)() | Membuat instansi baru. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi penunjuk lemah (bukan bersama). Memungkinkan mengganti penunjuk dalam kontainer ke mode lemah. |
