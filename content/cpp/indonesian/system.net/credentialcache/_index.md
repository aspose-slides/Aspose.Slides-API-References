...
| Metode | Deskripsi |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](../networkcredential/)\>) | Menambahkan kredensial jaringan yang ditentukan ke cache. |
| void [Add](./add/)([String](../../system/string/), **int32_t**, [String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](../networkcredential/)\>) | Menambahkan kredensial jaringan yang ditentukan ke cache. |
|  [CredentialCache](./credentialcache/)() | Membuat sebuah instance baru. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[ICredentials](../icredentials/)\> [get_DefaultCredentials](./get_defaultcredentials/)() | Mengembalikan kredensial sistem dari aplikasi. |
| static [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](../networkcredential/)\> [get_DefaultNetworkCredentials](./get_defaultnetworkcredentials/)() | Mengembalikan kredensial jaringan dari pengguna atau aplikasi saat ini. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](../networkcredential/)\> [GetCredential](./getcredential/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) override | Mengembalikan kredensial untuk awalan URI dan tipe autentikasi yang ditentukan. |
| [System::SharedPtr](../../system/sharedptr/)\<[NetworkCredential](../networkcredential/)\> [GetCredential](./getcredential/)([String](../../system/string/), **int32_t**, [String](../../system/string/)) override | Mengembalikan kredensial untuk nama host, port, dan tipe autentikasi yang ditentukan. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) | Menghapus kredensial jaringan untuk awalan URI dan tipe autentikasi yang ditentukan. |
| void [Remove](./remove/)([String](../../system/string/), **int32_t**, [String](../../system/string/)) | Menghapus kredensial jaringan untuk nama host, port, dan tipe autentikasi yang ditentukan. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pelepasan pernyataan lock() C#. Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
...
* Kelas [ICredentials](../icredentials/)
* Kelas [ICredentialsByHost](../icredentialsbyhost/)
