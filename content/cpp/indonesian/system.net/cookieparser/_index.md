...
description: "Digunakan untuk mengurai header cookie dan membuat sebuah instance dari kelas Cookie. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini pada stack atau menggunakan operator new, karena akan menyebabkan error runtime dan/atau kegagalan assert. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 53
url: /id/system.net/cookieparser/
---
## CookieParser kelas

Digunakan untuk mengurai header cookie dan membuat sebuah instance dari kelas [Cookie](../cookie/). Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini pada stack atau menggunakan operator new, karena akan menghasilkan error runtime dan/atau kesalahan assert. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen.
...
| Metode | Deskripsi |
| --- | --- |
| static [String](../../system/string/) [CheckQuoted](./checkquoted/)([String](../../system/string/)) | Memeriksa apakah string yang ditentukan dibungkus dalam tanda kutip. |
| [CookieParser](./cookieparser/)([String](../../system/string/)) | Membuat sebuah instance baru. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [Get](./get/)() | Mengembalikan sebuah instance berdasarkan string yang ditentukan. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Cookie](../cookie/)\> [GetServer](./getserver/)() | Mendapatkan cookie server. |
| [String](../../system/string/) [GetString](./getstring/)() | Mengembalikan representasi string dari header cookie. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalinan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengaktifkan pembuatan salinan konstruktor pada subclass. |
