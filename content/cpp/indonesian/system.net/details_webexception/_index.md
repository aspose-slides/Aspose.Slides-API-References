...
description: "Mewakili pengecualian yang dilemparkan oleh WebRequest ketika terjadi kesalahan. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas WebException sebagai gantinya. Jangan pernah membungkus instance kelas WebException ke dalam System::SmartPtr."
type: docs
weight: 92
url: /id/system.net/details_webexception/
---
## Details_WebException kelas


Mewakili pengecualian yang dilemparkan oleh [WebRequest](../webrequest/) ketika terjadi kesalahan. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas WebException sebagai gantinya. Jangan pernah membungkus instance kelas WebException ke dalam [System::SmartPtr](../../system/smartptr/).
...
| Metode | Deskripsi |
| --- | --- |
| static [Exception](../../system/exception/) [CreateCompatibleException](./createcompatibleexception/)([Exception](../../system/exception/)) | Tidak diimplementasikan. |
|  [Details_WebException](./details_webexception/)() | Membuat instance baru. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/)) | Membuat instance baru. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Membuat instance baru. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [WebExceptionStatus](../webexceptionstatus/)) | Membuat instance baru. |
|  [Details_WebException](./details_webexception/)([String](../../system/string/), [Exception](../../system/exception/), [WebExceptionStatus](../webexceptionstatus/), [System::SharedPtr](../../system/sharedptr/)\<[WebResponse](../webresponse/)\>) | Membuat instance baru. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[WebResponse](../webresponse/)\> [get_Response](./get_response/)() | Mengembalikan respons web yang terkait dengan pengecualian saat ini. |
...
| [WebExceptionStatus](../webexceptionstatus/) [get_Status](./get_status/)() | Mengembalikan kode status. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_invalidoperationexception/gettype/)() const override | Mendapatkan tipe aktual objek. Analog dari pemanggilan C# [System.Object.GetType()](../../system/object/gettype/). |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Mengatur HRESULT, sebuah nilai numerik terkode yang ditetapkan ke pengecualian tertentu. |
