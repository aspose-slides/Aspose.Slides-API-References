...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi pointer lemah (bukan bersama). Mengizinkan penggantian pointer dalam kontainer ke mode lemah. |
...
| Bidang | Deskripsi |
| --- | --- |
| static [Http](./http/) | Representasi string HTTP. |
| static [Https](./https/) | Representasi string HTTPS. |
| static [SchemeDelimiter](./schemedelimiter/) | String yang mewakili pemisah skema. |
| static [Ws](./ws/) | Representasi string WS. |
| static [Wss](./wss/) | Representasi string WSS. |
