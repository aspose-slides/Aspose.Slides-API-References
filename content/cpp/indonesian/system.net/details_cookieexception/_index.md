...
description: "Mewakili pengecualian yang dilemparkan ketika ukuran CookieContainer lebih besar dari nilai properti MaxCookieSize. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas CookieException sebagai gantinya. Jangan pernah membungkus instance kelas CookieException ke dalam System::SmartPtr."
type: docs
weight: 79
url: /id/system.net/details_cookieexception/
---
## Details_CookieException kelas

Mewakili sebuah pengecualian yang dilemparkan ketika ukuran [CookieContainer](../cookiecontainer/) lebih besar dari nilai properti MaxCookieSize. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas CookieException sebagai gantinya. Jangan pernah membungkus instance kelas CookieException ke dalam [System::SmartPtr](../../system/smartptr/).
...
| Metode | Deskripsi |
| --- | --- |
|  [Details_CookieException](./details_cookieexception/)() | Membuat instance baru. |
|  [Details_CookieException](./details_cookieexception/)(std::nullptr_t) | Membuat instance baru. |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/)) | Membuat instance baru. |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Membuat instance baru. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_formatexception/gettype/)() const override | Mendapatkan tipe aktual objek. Analog dari pemanggilan C# [System.Object.GetType()](../../system/object/gettype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruk penyalinan pada subclass. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Mengatur HRESULT, nilai numerik terkode yang diberikan kepada pengecualian tertentu. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Mendapatkan nilai current penghitung referensi bersama. |
...
| virtual  [~Details_CookieException](./~details_cookieexception/)() | Menghancurkan instance saat ini. |
| virtual  [~Object](../../system/object/~object/)() | Menghancurkan objek. Membebaskan semua struktur data internal. |

## Lihat Juga

* Kelas [Details_FormatException](../../system/details_formatexception/)
