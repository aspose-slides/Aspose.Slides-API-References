...
description: "Struktur data parameter algoritma DSA. Tipe ini harus dialokasikan pada stack dan diteruskan ke fungsi dengan nilai atau referensi. Jangan pernah menggunakan kelas System::SmartPtr untuk mengelola objek dari tipe ini."
type: docs
weight: 703
url: /id/system.security.cryptography/dsaparameters/
---
## DSAParameters struktur


[Data](../../system.data/) struktur dari parameter algoritma [DSA](../dsa/). Tipe ini harus dialokasikan pada stack dan diteruskan ke fungsi dengan nilai atau referensi. Jangan pernah menggunakan kelas [System::SmartPtr](../../system/smartptr/) untuk mengelola objek dari tipe ini.
...
| Metode | Deskripsi |
| --- | --- |
|  [DSAParameters](./dsaparameters/)() | Konstruktor. |
...
| void [Unlock](../../system/object/unlock/)() | Menerapkan pembongkaran pernyataan C# lock(). Panggil secara langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
