...
| static [SharedPtr](../../system/sharedptr/)\<[DSA](./)\> [Create](./create/)() | Membuat implementasi default algoritma [DSA](./). |
| static [SharedPtr](../../system/sharedptr/)\<[DSA](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Membuat implementasi default algoritma [DSA](./). |
| static [SharedPtr](../../system/sharedptr/)\<[DSA](./)\> [Create](./create/)(**int32_t**) | Membuat implementasi default algoritma [DSA](./) dengan ukuran kunci yang ditentukan. |
| static [SharedPtr](../../system/sharedptr/)\<[DSA](./)\> [Create](./create/)(const [DSAParameters](../dsaparameters/)\&) | Membuat implementasi default algoritma [DSA](./) dengan parameter yang ditentukan. |
| static [SharedPtr](../../system/sharedptr/)\<[DSA](./)\> [CreateFromXmlString](./createfromxmlstring/)(const [String](../../system/string/)\&) | Membuat implementasi default algoritma [DSA](./) dengan parameter yang dienkode XML. |
| virtual [ByteArrayPtr](../../system/bytearrayptr/) [CreateSignature](./createsignature/)([ByteArrayPtr](../../system/bytearrayptr/)) | Membuat tanda tangan [DSA](./) untuk data yang ditentukan. |
...
| virtual [DSAParameters](../dsaparameters/) [ExportParameters](./exportparameters/)(**bool**) | Mengekspor semua parameter. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Hanya untuk keperluan internal. |
| void [FromXmlString](./fromxmlstring/)([String](../../system/string/)) override | Menginisialisasi objek menggunakan parameter yang dienkode XML. |
| virtual [String](../../system/string/) [get_KeyExchangeAlgorithm](../asymmetricalgorithm/get_keyexchangealgorithm/)() | Mendapatkan algoritma pertukaran kunci yang akan digunakan. |
...
| virtual [String](../../system/string/) [get_SignatureAlgorithm](../asymmetricalgorithm/get_signaturealgorithm/)() | Mendapatkan algoritma tanda tangan yang akan digunakan. |
...
| virtual void [ImportParameters](./importparameters/)([DSAParameters](../dsaparameters/)) | Mengimpor semua parameter dari struktur data. |
...
| virtual **bool** [VerifySignature](./verifysignature/)([ByteArrayPtr](../../system/bytearrayptr/), [ByteArrayPtr](../../system/bytearrayptr/)) | Memverifikasi tanda tangan [DSA](./) untuk data yang ditentukan. |
