...
description: "Generator angka acak yang mengikuti konsep CSP. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 443
url: /id/system.security.cryptography/rngcryptoserviceprovider/
---
...
| Metode | Deskripsi |
| --- | --- |
| static [System::SharedPtr](../../system/sharedptr/)\<[RandomNumberGenerator](../randomnumbergenerator/)\> [Create](../randomnumbergenerator/create/)() | Membuat sebuah instance dari implementasi default generator angka acak kriptografi yang dapat digunakan untuk menghasilkan data acak. Tidak diimplementasikan. |
...
| void [GetBytes](./getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Mengisi elemen array yang ada dengan byte acak. |
| void [GetBytes](./getbytes/)(System::Details::ArrayView\<**uint8_t**\>) override | Mengisi elemen tampilan array yang ada dengan byte acak. |
| virtual void [GetBytes](../randomnumbergenerator/getbytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Mengisi potongan array yang ada dengan byte acak. |
| virtual void [GetBytes](../randomnumbergenerator/getbytes/)(System::Details::ArrayView\<**uint8_t**\>, int, int) | Mengisi potongan tampilan array yang ada dengan byte acak. |
| void [GetBytes](../randomnumbergenerator/getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | Mengisi elemen stack array yang ada dengan byte acak. |
| void [GetBytes](../randomnumbergenerator/getbytes/)(System::Details::StackArray\<**uint8_t**, N\>\&, int, int) | Mengisi potongan stack array yang ada dengan byte acak. |
...
| void [GetNonZeroBytes](./getnonzerobytes/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) override | Mengisi elemen array yang ada dengan byte acak non-nol. |
| void [GetNonZeroBytes](./getnonzerobytes/)(System::Details::ArrayView\<**uint8_t**\>) override | Mengisi elemen tampilan array yang ada dengan byte acak non-nol. |
| void [GetNonZeroBytes](../randomnumbergenerator/getnonzerobytes/)(System::Details::StackArray\<**uint8_t**, N\>\&) | Mengisi elemen stack array yang ada dengan byte acak non-nol. |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog dari metode C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Memungkinkan mengkloning tipe khusus. |
...
| virtual  [~RNGCryptoServiceProvider](./~rngcryptoserviceprovider/)() | Penghancur. |

## Lihat Juga

* Kelas [RandomNumberGenerator](../randomnumbergenerator/)
