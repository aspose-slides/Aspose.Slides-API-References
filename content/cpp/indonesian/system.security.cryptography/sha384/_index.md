...
description: "Menghitung hash SHA384 untuk data masukan. Dalam C++ SHA384 bukan kelas abstrak. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini pada stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu balut kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer tersebut untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 599
url: /id/system.security.cryptography/sha384/
---
## SHA384 kelas

Menghitung hash [SHA384](./) untuk data masukan. Dalam C++ [SHA384](./) bukan kelas abstrak. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini pada stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu balut kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer tersebut untuk melewatkannya ke fungsi sebagai argumen.
...
| Metode | Deskripsi |
| --- | --- |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Menghasilkan hash buffer. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Menghasilkan hash potongan buffer. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](../hashalgorithm/computehash/)([SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> const\&) | Membaca aliran sampai akhir dan menghitung hash untuk data yang dibaca. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA384](./)\> [Create](./create/)() | Membuat instance algoritma hash. |
| static [SharedPtr](../../system/sharedptr/)\<[SHA384](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Membuat instance algoritma hash. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menyetel argumen template ke- n menjadi pointer lemah (bukan pointer bersama). Mengizinkan penggantian pointer dalam kontainer ke mode lemah. |
