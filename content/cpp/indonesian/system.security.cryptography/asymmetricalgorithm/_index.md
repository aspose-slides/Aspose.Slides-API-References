...
description: "Kelas dasar abstrak untuk algoritma enkripsi asimetris. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena hal itu akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer tersebut untuk mengirimnya ke fungsi sebagai argumen."
type: docs
weight: 14
url: /id/system.security.cryptography/asymmetricalgorithm/
---
## AsymmetricAlgorithm kelas

Kelas dasar abstrak untuk algoritma enkripsi asimetris. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena hal itu akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer tersebut untuk mengirimkannya ke fungsi sebagai argumen.
...
| Metode | Deskripsi |
| --- | --- |
| void [Clear](./clear/)() | Melepaskan semua sumber daya. |
| static [SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](./)\> [Create](./create/)() | Membuat algoritma default. Tidak diimplementasikan. |
| static [SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Membuat algoritma berdasarkan nama. Tidak diimplementasikan. |
| void [Dispose](./dispose/)() override | Melepaskan sumber daya yang dimiliki oleh objek saat ini. |
...
| virtual void [FromXmlString](./fromxmlstring/)([String](../../system/string/)) | Membaca parameter algoritma dari string XML. |
| virtual [String](../../system/string/) [get_KeyExchangeAlgorithm](./get_keyexchangealgorithm/)() | Mendapatkan algoritma pertukaran kunci yang akan digunakan. |
| virtual **int32_t** [get_KeySize](./get_keysize/)() | Mendapatkan ukuran kunci. |
| virtual [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[KeySizes](../keysizes/)\>\> [get_LegalKeySizes](./get_legalkeysizes/)() | Mendapatkan array ukuran kunci yang diizinkan. |
| virtual [String](../../system/string/) [get_SignatureAlgorithm](./get_signaturealgorithm/)() | Mendapatkan algoritma tanda tangan yang akan digunakan. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salinan. Tidak benar-benar menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan konstruktor salinan pada subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak benar-benar menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan konstruktor salinan pada subclass. |
...
| virtual void [set_KeySize](./set_keysize/)(**int32_t**) | Mengatur ukuran kunci. |
...
| virtual [String](../../system/string/) [ToXmlString](./toxmlstring/)(**bool**) | Menulis parameter algoritma ke string XML. |
