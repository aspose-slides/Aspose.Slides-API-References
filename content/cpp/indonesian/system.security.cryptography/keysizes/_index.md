...
description: "Serangkaian ukuran kunci yang diterima oleh algoritma simetris. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini pada stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu balut kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 300
url: /id/system.security.cryptography/keysizes/
---
## KeySizes kelas


Kumpulan ukuran kunci yang diterima oleh algoritma simetris. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini pada stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kesalahan asersi. Selalu balut kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen.
...
| int [get_MaxSize](./get_maxsize/)() const | Mendapatkan ukuran kunci maksimum yang valid. |
| int [get_MinSize](./get_minsize/)() const | Mendapatkan ukuran kunci minimum yang valid. |
| int [get_SkipSize](./get_skipsize/)() const | Mendapatkan langkah ukuran kunci yang valid. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Periksa apakah objek mewakili sebuah instansi tipe yang dijelaskan oleh targetType. Analog dari operator C# 'is'. |
|  [KeySizes](./keysizes/)(int, int, int) | Informasi RTTI. |
