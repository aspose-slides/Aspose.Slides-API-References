...
description: "Kelas dasar untuk algoritma Rijndael. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan waktu jalan dan/atau kegagalan asersi. Selalu balut kelas ini dalam pointer System::SmartPtr dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 404
url: /id/system.security.cryptography/rijndael/
---
## Kelas Rijndael

Kelas dasar untuk algoritma [Rijndael](./). Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat contoh (instance) tipe ini di stack atau menggunakan operator new, karena akan mengakibatkan kesalahan waktu jalan dan/atau kegagalan asersi. Selalu balut kelas ini dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen.
...
| virtual int [get_BlockSize](../symmetricalgorithm/get_blocksize/)() | Mendapatkan ukuran blok operasi kriptografis. |
| virtual int [get_FeedbackSize](../symmetricalgorithm/get_feedbacksize/)() | Mendapatkan ukuran umpan balik operasi kriptografis. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_IV](../symmetricalgorithm/get_iv/)() | Mendapatkan nilai awal operasi kriptografis. Membuat baru jika belum dibuat. |
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Key](../symmetricalgorithm/get_key/)() | Mendapatkan kunci operasi kriptografis. Membuat baru jika belum dibuat. |
| virtual int [get_KeySize](../symmetricalgorithm/get_keysize/)() | Mendapatkan ukuran kunci operasi kriptografis. |
| virtual [CipherMode](../ciphermode/) [get_Mode](../symmetricalgorithm/get_mode/)() | Mendapatkan mode operasi kriptografis. |
| virtual [PaddingMode](../paddingmode/) [get_Padding](../symmetricalgorithm/get_padding/)() | Mendapatkan padding operasi kriptografis. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek mewakili sebuah contoh dari tipe yang dijelaskan oleh targetType. Analogi operator C# 'is'. |
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan lock() C# yang mengunci. Panggil langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
...
| virtual void [set_BlockSize](../symmetricalgorithm/set_blocksize/)(int) | Menetapkan ukuran blok operasi kriptografis. |
| virtual void [set_FeedbackSize](../symmetricalgorithm/set_feedbacksize/)(int) | Menetapkan ukuran umpan balik operasi kriptografis. |
| virtual void [set_IV](../symmetricalgorithm/set_iv/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Menetapkan nilai awal operasi kriptografis. |
| virtual void [set_Key](../symmetricalgorithm/set_key/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Menetapkan kunci operasi kriptografis. |
| virtual void [set_KeySize](../symmetricalgorithm/set_keysize/)(int) | Menetapkan ukuran kunci operasi kriptografis. |
| virtual void [set_Mode](../symmetricalgorithm/set_mode/)([CipherMode](../ciphermode/)) | Menetapkan mode operasi kriptografis. |
| virtual void [set_Padding](../symmetricalgorithm/set_padding/)([PaddingMode](../paddingmode/)) | Menetapkan padding operasi kriptografis. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan lock() C# yang membuka kunci. Panggil langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
