...
description: "Mengonversi instance kelas CryptoStream ke base 64. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject() . Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu balut kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 664
url: /id/system.security.cryptography/tobase64transform/
---
## ToBase64Transform kelas


Mengonversi instance [CryptoStream](../cryptostream/) kelas ke base 64. Objek kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu balut kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen.
...
| void [Dispose](./dispose/)() | Melepaskan sumber daya sistem operasi yang diperoleh oleh objek saat ini. |
...
| virtual **bool** [get_CanReuseTransform](./get_canreusetransform/)() | Mendapatkan nilai yang menunjukkan apakah transformasi saat ini dapat digunakan kembali. |
| **bool** [get_CanTransformMultipleBlocks](./get_cantransformmultipleblocks/)() | Mendapatkan nilai yang menunjukkan apakah beberapa blok dapat ditransformasikan. |
| virtual **int32_t** [get_InputBlockSize](./get_inputblocksize/)() | Ukuran blok masukan. |
| virtual **int32_t** [get_OutputBlockSize](./get_outputblocksize/)() | Ukuran blok keluaran. |
...
| **int32_t** [TransformBlock](./transformblock/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**, [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**) | Memproses blok data dan menyalin data ke array keluaran. |
| virtual int [TransformBlock](../icryptotransform/transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) | Memproses blok data dan menyalin data ke array keluaran. |
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](./transformfinalblock/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | Memproses blok data terakhir dan menghitung nilai keluaran. |
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](../icryptotransform/transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) | Memproses blok data terakhir dan menghitung nilai keluaran. |
