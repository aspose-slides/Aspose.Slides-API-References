...
description: "Kelas dasar untuk algoritma hashing. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan error runtime dan/atau kegagalan assert. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 222
url: /id/system.security.cryptography/hashalgorithm/
---
## HashAlgorithm kelas
...
| Method | Deskripsi |
| --- | --- |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Membuat hash buffer. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)(const [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int, int) | Membuat hash potongan buffer. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ComputeHash](./computehash/)([SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> const\&) | Membaca aliran hingga akhir dan menghitung hash untuk data yang dibaca. |
| static [SharedPtr](../../system/sharedptr/)\<[HashAlgorithm](./)\> [Create](./create/)(const [String](../../system/string/)\&) | Membuat algoritma hash berdasarkan nama. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Hash](./get_hash/)() | Mendapatkan nilai kode hash yang dihitung. |
| virtual int [get_HashSize](./get_hashsize/)() | Mendapatkan ukuran nilai hash yang dihitung dalam byte. |
| int [get_InputBlockSize](./get_inputblocksize/)() override | Ukuran blok input. |
| int [get_OutputBlockSize](./get_outputblocksize/)() override | Ukuran blok output. |
...
| virtual void [Initialize](./initialize/)() | Mengatur ulang hasher ke keadaan awal. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek mewakili contoh tipe yang dijelaskan oleh targetType. Analog dari operator 'is' C#. |
...
| int [TransformBlock](./transformblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int, [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int) override | Memproses blok data dan menyalin data ke array output. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [TransformFinalBlock](./transformfinalblock/)([ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, int, int) override | Memproses blok data terakhir dan menghitung hash. |
