...
| virtual [String](../../system/string/) [get_ConnectionString](./get_connectionstring/)() const | Informasi RTTI. |
...
| virtual void [Open](./open/)() | Membuka koneksi ke basis data. |
...
| virtual void [set_ConnectionString](./set_connectionstring/)([String](../../system/string/)) const | Menetapkan informasi koneksi (mis. server dan port). |
