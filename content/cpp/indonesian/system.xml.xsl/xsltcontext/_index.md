...
description: Membungkus konteks eksekusi saat ini dari proses Extensible Stylesheet Language for Transformations (XSLT) yang memungkinkan XML Path Language (XPath) untuk menyelesaikan fungsi, parameter, dan namespace dalam ekspresi XPath.
type: docs
weight: 79
url: /id/system.xml.xsl/xsltcontext/
---
## XsltContext kelas

Membungkus konteks eksekusi saat ini dari proses Extensible Stylesheet Language for Transformations (XSLT) yang memungkinkan XML Path Language ([XPath](../../system.xml.xpath/)) untuk menyelesaikan fungsi, parameter, dan namespace dalam ekspresi [XPath](../../system.xml.xpath/).
...
| Metode | Deskripsi |
| --- | --- |
| virtual void [AddNamespace](../../system.xml/xmlnamespacemanager/addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Menambahkan namespace yang diberikan ke koleksi. |
...
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | Ketika dioverride dalam kelas turunan, membandingkan Uniform Resource Identifier (URI) dasar dari dua dokumen berdasarkan urutan dokumen dimuat oleh proses XSLT (yaitu kelas [XslTransform](../xsltransform/)). |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | Mengembalikan URI namespace untuk namespace default. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | Mengembalikan [XmlNameTable](../../system.xml/xmlnametable/) yang terkait dengan objek ini. |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | Ketika dioverride dalam kelas turunan, mendapatkan nilai yang menunjukkan apakah node spasi putih harus disertakan dalam output. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | Mengembalikan enumerator untuk mengiterasi namespace dalam [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/). |
...
| virtual **bool** [HasNamespace](../../system.xml/xmlnamespacemanager/hasnamespace/)([String](../../system/string/)) | Mengembalikan nilai yang menunjukkan apakah prefiks yang diberikan memiliki namespace yang didefinisikan untuk ruang lingkup yang sedang didorong. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Mengubah elemen dalam sebuah urutan. |
...
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | Mengembalikan URI namespace untuk prefiks yang ditentukan. |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | Menemukan prefiks yang dideklarasikan untuk URI namespace yang diberikan. |
...
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | Membuang satu ruang lingkup namespace dari stack. |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | Ketika dioverride dalam kelas turunan, mengevaluasi apakah harus mempertahankan node spasi putih atau menghilangkannya untuk konteks yang diberikan. |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | Mendorong satu ruang lingkup namespace ke stack. |
...
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Menghapus namespace yang diberikan untuk prefiks yang diberikan. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextFunction](../ixsltcontextfunction/)\> [ResolveFunction](./resolvefunction/)([String](../../system/string/), [String](../../system/string/), [ArrayPtr](../../system/arrayptr/)\<[System::Xml::XPath::XPathResultType](../../system.xml.xpath/xpathresulttype/)\>) | Ketika dioverride dalam kelas turunan, menyelesaikan referensi fungsi dan mengembalikan [IXsltContextFunction](../ixsltcontextfunction/) yang mewakili fungsi tersebut. [IXsltContextFunction](../ixsltcontextfunction/) digunakan pada saat eksekusi untuk mendapatkan nilai kembali fungsi. |
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | Ketika dioverride dalam kelas turunan, menyelesaikan referensi variabel dan mengembalikan [IXsltContextVariable](../ixsltcontextvariable/) yang mewakili variabel. |
...
|  [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Menginisialisasi instance baru dari kelas [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) dengan [XmlNameTable](../../system.xml/xmlnametable/) yang ditentukan. |
