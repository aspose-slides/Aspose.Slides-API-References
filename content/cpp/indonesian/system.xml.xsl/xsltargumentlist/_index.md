...
description: Berisi sejumlah variabel argumen yang merupakan parameter XSLT atau objek ekstensi.
type: docs
weight: 66
url: /id/system.xml.xsl/xsltargumentlist/
---
## XsltArgumentList kelas

Berisi sejumlah variabel argumen yang merupakan parameter XSLT atau objek ekstensi.
...
| Metode | Deskripsi |
| --- | --- |
| void [AddExtensionObject](./addextensionobject/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Menambahkan objek baru ke [XsltArgumentList](./) dan mengaitkannya dengan namespace URI. |
| void [AddParam](./addparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Menambahkan parameter ke [XsltArgumentList](./) dan mengaitkannya dengan nama yang memenuhi namespace. |
| void [Clear](./clear/)() | Menghapus semua parameter dan objek ekstensi dari [XsltArgumentList](./). |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetExtensionObject](./getextensionobject/)(const [String](../../system/string/)\&) | Mengembalikan objek yang terkait dengan namespace yang diberikan. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetParam](./getparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Mengembalikan parameter yang terkait dengan nama yang memenuhi namespace. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek merupakan contoh tipe yang dijelaskan oleh targetType. Analog dari operator C# 'is'. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [RemoveExtensionObject](./removeextensionobject/)(const [String](../../system/string/)\&) | Menghapus objek dengan namespace URI dari [XsltArgumentList](./). |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [RemoveParam](./removeparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Menghapus parameter dari [XsltArgumentList](./). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen template ke-n menjadi pointer lemah (bukan shared). Memungkinkan mengubah pointer di dalam kontainer ke mode lemah. |
...
|  [XsltArgumentList](./xsltargumentlist/)() | Menerapkan sebuah instansi baru dari [XsltArgumentList](./). |
