...
description: IEnumerable adalah antarmuka dasar untuk semua koleksi non-generic yang dapat di-enumerasi.
type: docs
weight: 53
url: /id/system.collections/ienumerable/
---
## IEnumerable kelas

[IEnumerable](./) adalah antarmuka dasar untuk semua koleksi non-generic yang dapat di-enumerasi.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | Mengembalikan enumerator yang mengiterasi melalui koleksi. |
