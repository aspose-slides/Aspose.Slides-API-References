...
description: Membandingkan array atau daftar secara setara.
type: docs
weight: 40
url: /id/system.testpredicates.details.sharedptrasserts/notnullareequalimpl/
---
## System::TestPredicates::Details::SharedPtrAsserts::NotNullAreEqualImpl(const char *, const char *, const T1\&, const T2\&, long long) fungsi

Membandingkan array atau daftar secara setara.
...
Membandingkan instance IEnumerable secara setara.
...
## System::TestPredicates::Details::SharedPtrAsserts::NotNullAreEqualImpl(const char *, const char *, const T1\&, const T2\&, int32_t) fungsi

Membandingkan tipe tidak dikenal secara setara menggunakan metode Equals.
