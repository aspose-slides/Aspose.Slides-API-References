...
description: Timer yang memanggil delegasi dalam loop.
type: docs
weight: 14
url: /id/system.timers/timer/
---
## Kelas Timer


[Timer](./) yang memanggil delegasi dalam loop.
...
| Method | Description |
| --- | --- |
| void [Close](./close/)() | Menghentikan timer, membebaskan sumber daya yang dialokasikan. |
|  [Component](../../system.componentmodel/component/component/)() | informasi RTTI. |
| void [Dispose](./dispose/)() | Menghentikan timer, membebaskan sumber daya yang dialokasikan. |
...
| **bool** [get_AutoReset](./get_autoreset/)() const | Memeriksa apakah timer berada dalam mode auto-reset. |
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | Memeriksa apakah komponen berada dalam mode desain. |
| **bool** [get_Enabled](./get_enabled/)() const | Memeriksa apakah timer aktif. |
| **double** [get_Interval](./get_interval/)() const | Mendapatkan interval timer. |
| **bool** [get_IsStopped](./get_isstopped/)() const | Memeriksa apakah timer dihentikan. |
...
| void [set_AutoReset](./set_autoreset/)(**bool**) | Mengatur timer ke mode auto-reset atau keluar dari mode tersebut. |
| void [set_Enabled](./set_enabled/)(**bool**) | Memulai atau menghentikan timer. Memulai timer tidak memulai kembali penghitungan waktu jika timer sudah berjalan. |
| void [set_Interval](./set_interval/)(**double**) | Mengatur interval timer. |
...
| void [Start](./start/)() | Memulai timer. Tidak memulai kembali penghitungan waktu jika timer sudah berjalan. |
| void [Stop](./stop/)() | Menghentikan timer. |
|  [Timer](./timer/)() | informasi RTTI. |
|  [Timer](./timer/)(**double**) | Membuat timer berhenti dengan interval yang ditentukan. |
