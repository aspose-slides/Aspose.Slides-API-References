...
| Metode | Deskripsi |
| --- | --- |
| void [Dispose](./dispose/)() override | Tidak melakukan apa-pun. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Net::CookieContainer](../../system.net/cookiecontainer/)\> [get_CookieContainer](./get_cookiecontainer/)() | Mendapatkan kontainer cookie yang digunakan untuk menyimpan cookie server. |
| [System::SharedPtr](../../system/sharedptr/)\<[ICredentials](../../system.net/icredentials/)\> [get_Credentials](./get_credentials/)() | Mendapatkan informasi otentikasi. |
...
| [HttpClientHandler](./httpclienthandler/)() | Membuat instance baru. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[HttpResponseMessage](../httpresponsemessage/)\> [Send](./send/)([System::SharedPtr](../../system/sharedptr/)\<[HttpRequestMessage](../httprequestmessage/)\>) override | Mengirim permintaan yang ditentukan. |
| void [set_CookieContainer](./set_cookiecontainer/)([System::SharedPtr](../../system/sharedptr/)\<[System::Net::CookieContainer](../../system.net/cookiecontainer/)\>) | Menetapkan kontainer cookie yang digunakan untuk menyimpan cookie server. |
| void [set_Credentials](./set_credentials/)([System::SharedPtr](../../system/sharedptr/)\<[ICredentials](../../system.net/icredentials/)\>) | Menetapkan informasi otentikasi. |
| void [set_Proxy](./set_proxy/)([System::SharedPtr](../../system/sharedptr/)\<[IWebProxy](../../system.net/iwebproxy/)\>) | Menetapkan informasi proxy. |
| void [set_Timeout](./set_timeout/)(**int32_t**) | Mendapatkan jumlah waktu dalam milidetik setelah mana permintaan akan kedaluwarsa. |
| void [set_UseCookies](./set_usecookies/)(**bool**) | Menetapkan nilai yang menunjukkan apakah instance saat ini menggunakan kontainer cookie untuk menyimpan cookie server dan apakah instance tersebut menggunakan cookie server saat mengirim permintaan. |
| void [set_UseProxy](./set_useproxy/)(**bool**) | Menetapkan nilai yang menunjukkan apakah instance saat ini menggunakan proxy untuk mengirim permintaan. |
...
* Kelas [HttpMessageHandler](../httpmessagehandler/)
