...
description: Berisi metode utilitas.
type: docs
weight: 131
url: /id/system.net.http/httputilities/
---
## HttpUtilities kelas


Berisi metode utilitas.
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Memeriksa apakah URI yang ditentukan adalah URI HTTP. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Atur argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
...
| Bidang | Deskripsi |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | Versi HTTP default untuk mengirim permintaan. |
| static [DefaultResponseVersion](./defaultresponseversion/) | Versi HTTP default untuk menerima respons. |
