...
| Method | Description |
| --- | --- |
| void [ApplyColorScheme](./applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Menerapkan skema warna tambahan ke slide. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() override | Mengembalikan objek tema. |
...
| **bool** [get_IsOverrideThemeEnabled](./get_isoverridethemeenabled/)() override | Menentukan apakah [OverrideTheme](../overridetheme/) mengganti tema efektif yang diwarisi atau tidak. Untuk mengaktifkan [OverrideTheme](../overridetheme/) untuk penggantian gunakan metode OverrideTheme.Init*(). Untuk menonaktifkan [OverrideTheme](../overridetheme/) dari penggantian gunakan metode [OverrideTheme::Clear](../overridetheme/clear/). Hanya-baca **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](./get_overridetheme/)() override | Mengembalikan objek tema yang menggantikan. Baca [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](./set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Mengembalikan objek tema yang menggantikan. Tulis [IOverrideTheme](../ioverridetheme/). |
...
* Kelas [IOverrideThemeManager](../ioverridethememanager/)
