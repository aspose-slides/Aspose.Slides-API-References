...
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [get_ExtraColorScheme](./get_extracolorscheme/)(**int32_t**) override | Mengembalikan skema warna tambahan pada indeks yang ditentukan. Skema ini tidak memengaruhi tampilan presentasi, dapat dipilih sebagai skema warna utama untuk sebuah slide. Hanya-baca [Aspose::Slides::Theme::IExtraColorScheme](../iextracolorscheme/) |
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorSchemeCollection](../iextracolorschemecollection/)\> [get_ExtraColorSchemes](./get_extracolorschemes/)() override | Mengembalikan koleksi skema warna tambahan. Skema ini tidak memengaruhi tampilan presentasi, dapat dipilih sebagai skema warna utama untuk sebuah slide. Hanya-baca [IExtraColorSchemeCollection](../iextracolorschemecollection/). |
...
| [System::String](../../system/string/) [get_Name](./get_name/)() override | Mengembalikan nama tema. Baca [System::String](../../system/string/). |
...
| void [set_Name](./set_name/)([System::String](../../system/string/)) override | Mengembalikan nama tema. Tulis [System::String](../../system/string/). |
...
* Kelas [Theme](../theme/)
* Kelas [IMasterTheme](../imastertheme/)
