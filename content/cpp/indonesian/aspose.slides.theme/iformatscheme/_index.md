...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_BackgroundFillStyle](./get_backgroundfillstyle/)(**int32_t**) | Mengembalikan gaya isian latar belakang yang ditentukan tema pada indeks yang ditentukan. Hanya-baca [Aspose::Slides::IFillFormat](../../aspose.slides/ifillformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollection](../ifillformatcollection/)\> [get_BackgroundFillStyles](./get_backgroundfillstyles/)() | Mengembalikan koleksi gaya isian latar belakang yang ditentukan tema. Hanya-baca [IFillFormatCollection](../ifillformatcollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyle](../ieffectstyle/)\> [get_EffectStyle](./get_effectstyle/)(**int32_t**) | Mengembalikan gaya efek yang ditentukan tema pada indeks yang ditentukan. Hanya-baca [Aspose::Slides::Theme::IEffectStyle](../ieffectstyle/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffectStyleCollection](../ieffectstylecollection/)\> [get_EffectStyles](./get_effectstyles/)() | Mengembalikan koleksi gaya efek yang ditentukan tema. Hanya-baca [IEffectStyleCollection](../ieffectstylecollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormat](../../aspose.slides/ifillformat/)\> [get_FillStyle](./get_fillstyle/)(**int32_t**) | Mengembalikan gaya isian yang ditentukan tema pada indeks yang ditentukan. Hanya-baca [Aspose::Slides::IFillFormat](../../aspose.slides/ifillformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFillFormatCollection](../ifillformatcollection/)\> [get_FillStyles](./get_fillstyles/)() | Mengembalikan koleksi gaya isian yang ditentukan tema. Hanya-baca [IFillFormatCollection](../ifillformatcollection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormat](../../aspose.slides/ilineformat/)\> [get_LineStyle](./get_linestyle/)(**int32_t**) | Mengembalikan gaya garis yang ditentukan tema pada indeks yang ditentukan. Hanya-baca [Aspose::Slides::ILineFormat](../../aspose.slides/ilineformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ILineFormatCollection](../ilineformatcollection/)\> [get_LineStyles](./get_linestyles/)() | Mengembalikan koleksi gaya garis yang ditentukan tema. Hanya-baca [ILineFormatCollection](../ilineformatcollection/). |
...
* Kelas [ISlideComponent](../../aspose.slides/islidecomponent/)
