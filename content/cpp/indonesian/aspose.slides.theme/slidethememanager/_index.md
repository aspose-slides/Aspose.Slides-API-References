...
Menyediakan akses ke tema slide yang ditimpa.
...
| Metode | Deskripsi |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Menerapkan skema warna tambahan ke sebuah slide. |
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Menentukan apakah [OverrideTheme](../overridetheme/) menimpa tema efektif yang diwarisi atau tidak. Untuk mengaktifkan [OverrideTheme](../overridetheme/) untuk penimpaan gunakan metode OverrideTheme.Init*(). Untuk menonaktifkan [OverrideTheme](../overridetheme/) dari penimpaan gunakan metode [OverrideTheme::Clear](../overridetheme/clear/). Hanya-baca **bool**. |
