...
description: Mewakili sekumpulan skema warna tambahan.
type: docs
weight: 92
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>\>, **int32_t**) override | Menyalin semua elemen koleksi ke array yang ditentukan. |
...
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Mengembalikan nilai yang menunjukkan apakah akses ke ArrayList disinkronkan (aman untuk thread). Hanya-baca **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator yang mengiterasi koleksi. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\> [idx_get](./idx_get/)(**int32_t**) override | Mengembalikan skema warna berdasarkan indeks. Hanya-baca [ExtraColorScheme](../extracolorscheme/). |
...
* Kelas [IExtraColorSchemeCollection](../iextracolorschemecollection/)
