...
description: Objek tidak dapat diubah yang berisi properti skema font yang efektif.
type: docs
weight: 287
url: /id/aspose.slides.theme/ifontschemeeffectivedata/
---
## IFontSchemeEffectiveData kelas


Objek tidak dapat diubah yang berisi properti skema font yang efektif.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Major](./get_major/)() | Mengembalikan koleksi font untuk bagian "heading" pada slide. Hanya-baca [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/)\> [get_Minor](./get_minor/)() | Mengembalikan koleksi font untuk bagian "body" pada slide. Hanya-baca [IFontsEffectiveData](../../aspose.slides/ifontseffectivedata/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Mengembalikan nama skema font. Hanya-baca [System::String](../../system/string/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salin. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan mengaktifkan pembuatan salinan subkelas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan mengaktifkan pembuatan salinan subkelas. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Atur argumen template ke-n menjadi pointer lemah (bukan shared). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
