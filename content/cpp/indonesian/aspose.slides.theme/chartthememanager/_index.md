...
description: Menyediakan akses ke tema diagram yang ditimpa.
type: docs
weight: 27
...
Menyediakan akses ke tema diagram yang ditimpa.
...
| Metode | Deskripsi |
| --- | --- |
| void [ApplyColorScheme](../baseoverridethememanager/applycolorscheme/)([System::SharedPtr](../../system/sharedptr/)\<[IExtraColorScheme](../iextracolorscheme/)\>) override | Menerapkan skema warna tambahan ke slide. |
| [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](../baseoverridethememanager/createthemeeffective/)() override | Mengembalikan objek tema. |
...
| **bool** [get_IsOverrideThemeEnabled](../baseoverridethememanager/get_isoverridethemeenabled/)() override | Menentukan apakah [OverrideTheme](../overridetheme/) menimpa tema efektif yang diwarisi atau tidak. Untuk mengaktifkan [OverrideTheme](../overridetheme/) agar dapat menimpa gunakan metode OverrideTheme.Init*(). Untuk menonaktifkan [OverrideTheme](../overridetheme/) dari menimpa gunakan metode [OverrideTheme::Clear](../overridetheme/clear/). Hanya-baca **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\> [get_OverrideTheme](../baseoverridethememanager/get_overridetheme/)() override | Mengembalikan objek tema yang menimpa. Baca [IOverrideTheme](../ioverridetheme/). |
...
| void [set_OverrideTheme](../baseoverridethememanager/set_overridetheme/)([System::SharedPtr](../../system/sharedptr/)\<[IOverrideTheme](../ioverridetheme/)\>) override | Mengembalikan objek tema yang menimpa. Tulis [IOverrideTheme](../ioverridetheme/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Atur argumen template ke-n menjadi weak pointer (bukan shared). Mengizinkan penggantian pointer dalam kontainer ke mode lemah. |
