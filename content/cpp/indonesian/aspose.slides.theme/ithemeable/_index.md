...
description: Mewakili objek yang dapat diberi tema dengan ITheme.
type: docs
weight: 443
...
Mewakili objek yang dapat diatur temanya dengan [ITheme](../itheme/).
...
| Metode | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IThemeEffectiveData](../ithemeeffectivedata/)\> [CreateThemeEffective](./createthemeeffective/)() | Mengembalikan tema efektif untuk objek yang dapat diatur temanya ini. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah hitungan referensi weak. Tidak seharusnya dipanggil langsung; gunakan smart pointer atau ThisProtector. |
