...
| Metode | Deskripsi |
| --- | --- |
| void [AddFont](./addfont/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int) | Menambahkan font yang ditentukan ke koleksi. |
| void [AddFontFile](./addfontfile/)(const [String](../../system/string/)\&) | Menambahkan font dari file yang ditentukan ke koleksi. |
| void [Dispose](../fontcollection/dispose/)() override | Melepaskan sumber daya sistem operasi yang diperoleh oleh objek saat ini. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[FontFamily](../../system.drawing/fontfamily/)\>\> [get_Families](./get_families/)() override | Mengembalikan array objek [FontFamily](../../system.drawing/fontfamily/) yang terkait dengan koleksi font yang diwakili oleh objek saat ini. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Mengecek apakah objek merupakan instance dari tipe yang dijelaskan oleh targetType. Analog dari operator C# 'is'. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salin. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan konstruk penyalinan subkelas. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n sebagai pointer lemah (bukan bersama). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
...
* Kelas [FontCollection](../fontcollection/)
