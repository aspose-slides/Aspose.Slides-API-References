...
description: "Mewakili koleksi font yang terpasang di sistem. TIDAK DIIMPLEMENTASIKAN. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan assert. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer tersebut untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 14
url: /id/system.drawing.text/installedfontcollection/
---
## InstalledFontCollection kelas

Mewakili koleksi font yang terpasang di sistem. TIDAK DIIMPLEMENTASIKAN. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan assert. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer itu untuk meneruskannya ke fungsi sebagai argumen.
...
| virtual [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[FontFamily](../../system.drawing/fontfamily/)\>\> [get_Families](../fontcollection/get_families/)() | Mengembalikan sebuah array objek [FontFamily](../../system.drawing/fontfamily/) yang terkait dengan koleksi font yang diwakili oleh objek saat ini. |
...
|  [InstalledFontCollection](./installedfontcollection/)() | Membuat sebuah instance baru dari kelas [InstalledFontCollection](./). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan pembuatan salinan subclass. |
...
* Ruang nama [System::Drawing::Text](../)
