...
description: Menyediakan akses baca-saja ke sekumpulan pemetaan prefiks dan ruang nama.
type: docs
weight: 53
url: /id/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver kelas

Menyediakan akses baca-saja ke sekumpulan pemetaan prefiks dan ruang nama.
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | Mengembalikan URI namespace yang dipetakan ke prefiks yang ditentukan. |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | Mengembalikan prefiks yang dipetakan ke URI namespace yang ditentukan. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen templat ke-n menjadi weak pointer (bukan shared). Memungkinkan pergantian pointer dalam kontainer ke mode lemah. |
