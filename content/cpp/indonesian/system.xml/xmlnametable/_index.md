...
description: Tabel objek string yang diatomkan.
type: docs
weight: 313
url: /id/system.xml/xmlnametable/
---
## XmlNameTable kelas

Tabel objek string yang diatomkan.
...
| Method | Deskripsi |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Ketika di-override dalam kelas turunan, mengatomkan string yang ditentukan dan menambahkannya ke [XmlNameTable](./). |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | Ketika di-override dalam kelas turunan, mengatomkan string yang ditentukan dan menambahkannya ke [XmlNameTable](./). |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Ketika di-override dalam kelas turunan, mendapatkan string yang diatomkan yang berisi karakter yang sama dengan rentang karakter yang ditentukan dalam array yang diberikan. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | Ketika di-override dalam kelas turunan, mendapatkan string yang diatomkan yang berisi nilai yang sama dengan string yang ditentukan. |
