...
description: Mewakili sebuah atribut. Nilai yang valid dan nilai default untuk atribut didefinisikan dalam definisi tipe dokumen (DTD) atau skema.
type: docs
weight: 79
url: /id/system.xml/xmlattribute/
---
## XmlAttribute kelas

Mewakili sebuah atribut. Nilai yang valid dan nilai default untuk atribut didefinisikan dalam definisi tipe dokumen (DTD) atau skema.
...
| Metode | Deskripsi |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](./appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Menambahkan node yang ditentukan ke akhir daftar node anak dari node ini. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama yang const-qualified (jika ada) dari koleksi. |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Mengembalikan Uniform Resource Identifier (URI) dasar dari node. |
...
| virtual [String](../../system/string/) [get_InnerText](../xmlnode/get_innertext/)() | Mengembalikan nilai yang dikonkatenasi dari node dan semua node anaknya. |
...
| [String](../../system/string/) [get_Name](./get_name/)() override | Mengembalikan nama yang qualified dari node. |
| [String](../../system/string/) [get_NamespaceURI](./get_namespaceuri/)() override | Mengembalikan namespace URI dari node ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Mengembalikan node yang segera mengikuti node ini. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](./get_ownerdocument/)() override | Mengembalikan [XmlDocument](../xmldocument/) tempat node ini berada. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [get_OwnerElement](./get_ownerelement/)() | Mengembalikan [XmlElement](../xmlelement/) tempat atribut ini berada. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Mengembalikan induk (parent) dari node ini (untuk node yang dapat memiliki induk). |
| [String](../../system/string/) [get_Prefix](./get_prefix/)() override | Mengembalikan prefiks namespace dari node ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Mengembalikan node yang segera mendahului node ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | Mengembalikan node teks yang segera mendahului node ini. |
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | Mengembalikan post-schema-validation-infoset yang telah ditetapkan ke node ini sebagai hasil dari validasi skema. |
| virtual **bool** [get_Specified](./get_specified/)() | Mengembalikan nilai yang menunjukkan apakah nilai atribut telah ditetapkan secara eksplisit. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Mengembalikan nilai dari node. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Mengembalikan enumerator yang mengiterasi node anak dalam node saat ini. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog dari metode C# [Object.GetHashCode()](../../system/object/gethashcode/). Mengaktifkan hashing objek khusus. |
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Mencari deklarasi **xmlns** terdekat untuk prefiks yang diberikan yang berada dalam lingkup node saat ini dan mengembalikan namespace URI dalam deklarasi tersebut. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Mencari deklarasi **xmlns** terdekat untuk namespace URI yang diberikan yang berada dalam lingkup node saat ini dan mengembalikan prefiks yang didefinisikan dalam deklarasi tersebut. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](./insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Menyisipkan node yang ditentukan tepat setelah node referensi yang ditentukan. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](./insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Menyisipkan node yang ditentukan tepat sebelum node referensi yang ditentukan. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)() | Menentukan apakah suatu urutan mengandung elemen apa pun. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Mengkonversi elemen ke tipe yang ditentukan. |
...
| **bool** [LINQ_Contains](../../system.collections.generic/ienumerable/linq_contains/)(T) | Menentukan apakah urutan mengandung nilai tertentu. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Mentransformasi elemen urutan. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Mentransformasi setiap elemen urutan menjadi bentuk baru dengan menyertakan indeks elemen. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Menempatkan semua node [XmlText](../xmltext/) dalam kedalaman penuh sub-pohon di bawah [XmlNode](../xmlnode/) ini ke dalam bentuk "normal" di mana hanya markup (yaitu, tag, komentar, instruksi pemrosesan, bagian CDATA, dan referensi entitas) yang memisahkan node [XmlText](../xmltext/), sehingga tidak ada node [XmlText](../xmltext/) yang bersebelahan. |
|  [Object](../../system/object/object/)() | Membuat objek. Menginisialisasi semua struktur data internal. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalinan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan pembuatan salinan subclass. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](./prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Menambahkan node yang ditentukan ke awal daftar node anak untuk node ini. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](./removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Menghapus node anak yang ditentukan. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Mengurangi penghitung referensi bersama sebesar nilai yang ditentukan. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](./replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Mengganti node anak yang ditentukan dengan node anak baru yang ditentukan. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Memilih daftar node yang cocok dengan ekspresi [XPath](../../system.xml.xpath/). Setiap prefiks yang ditemukan dalam ekspresi [XPath](../../system.xml.xpath/) diselesaikan menggunakan [XmlNamespaceManager](../xmlnamespacemanager/) yang disediakan. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Memilih [XmlNode](../xmlnode/) pertama yang cocok dengan ekspresi [XPath](../../system.xml.xpath/). Setiap prefiks yang ditemukan dalam ekspresi [XPath](../../system.xml.xpath/) diselesaikan menggunakan [XmlNamespaceManager](../xmlnamespacemanager/) yang disediakan. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Menetapkan nilai yang dikonkatenasi dari node dan semua anaknya. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Menetapkan nilai atribut. |
| void [set_Prefix](./set_prefix/)([String](../../system/string/)) override | Menetapkan prefiks namespace dari node ini. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Mendapatkan nilai current dari penghitung referensi bersama. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Meningkatkan penghitung referensi bersama. Tidak boleh dipanggil langsung; gunakan smart pointer atau ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Mengurangi dan mengembalikan penghitung referensi bersama. Tidak boleh dipanggil langsung; gunakan smart pointer atau ThisProtector. |
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Menguji apakah implementasi DOM mendukung fitur spesifik. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Menyimpan semua anak node ke [XmlWriter](../xmlwriter/) yang ditentukan. |
