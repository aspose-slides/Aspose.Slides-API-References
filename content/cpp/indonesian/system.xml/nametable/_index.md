...
description: Mengimplementasikan XmlNameTable berthread tunggal.
type: docs
weight: 66
url: /id/system.xml/nametable/
---
## NameTable kelas
...
| Metode | Deskripsi |
| --- | --- |
| const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) override | Membuat atom string yang ditentukan dan menambahkannya ke [NameTable](./). |
| const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | Membuat atom string yang ditentukan dan menambahkannya ke [NameTable](./). |
...
| const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) override | Mengembalikan string yang diatomkan dengan nilai yang ditentukan. |
| const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) override | Mengembalikan string yang diatomkan yang berisi karakter yang sama dengan rentang karakter yang ditentukan dalam array yang diberikan. |
...
|  [NameTable](./nametable/)() | Menginisialisasi instance baru dari kelas [NameTable](./). |
