...
description: Memungkinkan sebuah kelas mengembalikan XmlNode dari konteks atau posisi saat ini.
type: docs
weight: 27
url: /id/system.xml/ihasxmlnode/
---
## IHasXmlNode kelas

Memungkinkan sebuah kelas untuk mengembalikan sebuah [XmlNode](../xmlnode/) dari konteks atau posisi saat ini.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNode](./getnode/)() | Mengembalikan [XmlNode](../xmlnode/) untuk posisi saat ini. |
