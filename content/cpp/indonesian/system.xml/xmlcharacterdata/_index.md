...
description: Menyediakan metode manipulasi teks yang digunakan oleh beberapa kelas.
type: docs
weight: 118
url: /id/system.xml/xmlcharacterdata/
---
## Kelas XmlCharacterData
...
| virtual void [AppendData](./appenddata/)([String](../../system/string/)) | Menambahkan string yang ditentukan ke akhir data karakter node. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dalam koleksi. Iterator ini tidak dapat digunakan untuk mengubah objek yang direferensikan karena [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) mengembalikan objek salinan dari T. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Mendapatkan iterator yang menunjuk ke elemen const pertama (jika ada) dalam koleksi. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Mendapatkan iterator yang menunjuk tepat setelah elemen const terakhir (jika ada) dalam koleksi. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Membuat duplikat dari node ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Membuat duplikat dari node, ketika ditimpa dalam kelas turunan. |
...
| virtual void [DeleteData](./deletedata/)(**int32_t**, **int32_t**) | Menghapus rentang karakter dari node. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir (jika ada) dalam koleksi. Iterator ini tidak dapat digunakan untuk mengubah objek yang direferensikan karena [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) mengembalikan objek salinan dari T. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttributeCollection](../xmlattributecollection/)\> [get_Attributes](../xmlnode/get_attributes/)() | Mengembalikan [XmlAttributeCollection](../xmlattributecollection/) yang berisi atribut node ini. |
...
| virtual [String](../../system/string/) [get_Data](./get_data/)() | Mengembalikan data node. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Mengembalikan nilai yang digabungkan dari node dan semua anak node. |
...
| virtual **int32_t** [get_Length](./get_length/)() | Mengembalikan panjang data, dalam karakter. |
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | Mengembalikan nama lokal node, ketika ditimpa dalam kelas turunan. |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | Mengembalikan nama terkuantisasi node, ketika ditimpa dalam kelas turunan. |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | Mengembalikan tipe node saat ini, ketika ditimpa dalam kelas turunan. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](../xmlnode/get_ownerdocument/)() | Mengembalikan [XmlDocument](../xmldocument/) yang menjadi milik node ini. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Mengembalikan infoset validasi skema pasca yang telah ditetapkan ke node ini sebagai hasil dari validasi skema. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Mengembalikan nilai node. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Mencari deklarasi **xmlns** terdekat untuk prefiks yang diberikan yang berada dalam cakupan node saat ini dan mengembalikan URI namespace dalam deklarasi. |
...
| virtual void [InsertData](./insertdata/)(**int32_t**, [String](../../system/string/)) | Menyisipkan string yang ditentukan pada offset karakter yang ditentukan. |
...
| void [Lock](../../system/object/lock/)() | Menerapkan pernyataan C# lock() untuk mengunci. Panggil langsung atau gunakan objek pengawas [LockContext](../../system/lockcontext/). |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Menempatkan semua node [XmlText](../xmltext/) pada kedalaman penuh sub-pohon di bawah [XmlNode](../xmlnode/) ini ke dalam bentuk "normal" di mana hanya markup (yaitu tag, komentar, instruksi pemrosesan, seksi CDATA, dan referensi entitas) yang memisahkan node [XmlText](../xmltext/), sehingga tidak ada node [XmlText](../xmltext/) yang bersebelahan. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan pembuatan salinan pada subclass. |
...
| virtual void [ReplaceData](./replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Mengganti sejumlah karakter yang dimulai pada offset yang ditentukan dengan string yang ditentukan. |
...
| virtual void [set_Data](./set_data/)([String](../../system/string/)) | Mengatur data node. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Mengatur nilai yang digabungkan dari node dan semua anak node. |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Mengatur markup yang hanya mewakili node anak dari node ini. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Mengatur prefiks namespace node ini. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Mengatur nilai node. |
...
| virtual [String](../../system/string/) [Substring](./substring/)(**int32_t**, **int32_t**) | Mengambil sub-string dari string lengkap dalam rentang yang ditentukan. |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Menyimpan semua node anak dari node ke [XmlWriter](../xmlwriter/) yang ditentukan, ketika ditimpa dalam kelas turunan. |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Menyimpan node saat ini ke [XmlWriter](../xmlwriter/) yang ditentukan, ketika ditimpa dalam kelas turunan. |
...
* Kelas [XmlLinkedNode](../xmllinkednode/)
