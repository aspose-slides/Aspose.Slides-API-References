...
description: Mengembalikan informasi terperinci tentang pengecualian terakhir.
type: docs
weight: 1
url: /id/system.xml/details_xmlexception/
---
## Details_XmlException kelas
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Mengembalikan nomor baris yang menunjukkan tempat terjadinya kesalahan. Nomor baris dimulai dari 1. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Mengembalikan posisi baris yang menunjukkan tempat terjadinya kesalahan. Posisi baris dimulai dari 1. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Mengembalikan pesan yang menggambarkan pengecualian saat ini. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Mengembalikan lokasi file XML. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_systemexception/gettype/)() const override | Mendapatkan tipe aktual objek. Analog dari pemanggilan C# [System.Object.GetType()](../../system/object/gettype/). |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Mengatur HRESULT, nilai numerik terkode yang ditetapkan pada pengecualian tertentu. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n sebagai weak pointer (bukan shared). Memungkinkan pengalihan pointer di kontainer ke mode lemah. |
