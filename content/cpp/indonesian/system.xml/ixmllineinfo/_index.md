...
description: Menyediakan antarmuka untuk memungkinkan sebuah kelas mengembalikan informasi baris dan posisi.
type: docs
weight: 40
url: /id/system.xml/ixmllineinfo/
---
## IXmlLineInfo kelas


Menyediakan antarmuka untuk memungkinkan sebuah kelas mengembalikan informasi baris dan posisi.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Mengembalikan nomor baris saat ini. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Mengembalikan posisi baris saat ini. |
...
| virtual **bool** [HasLineInfo](./haslineinfo/)() | Mengembalikan nilai yang menunjukkan apakah kelas dapat mengembalikan informasi baris. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen templat ke-nth menjadi pointer lemah (bukan berbagi). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
