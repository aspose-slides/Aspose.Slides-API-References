...
description: Mewakili koleksi node yang dapat diakses melalui nama atau indeks.
type: docs
weight: 287
url: /id/system.xml/xmlnamednodemap/
---
## XmlNamedNodeMap kelas

Mewakili koleksi node yang dapat diakses melalui nama atau indeks.
...
| Method | Deskripsi |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() const | Mendapatkan iterator ke elemen pertama dari koleksi. |
...
| [iterator](./iterator/) [cbegin](./cbegin/)() const | Mendapatkan iterator ke elemen pertama dari koleksi. |
| [iterator](./iterator/) [cend](./cend/)() const | Mendapatkan iterator untuk elemen yang tidak ada di belakang elemen terakhir koleksi. |
| [iterator](./iterator/) [end](./end/)() const | Mendapatkan iterator untuk elemen yang tidak ada di belakang elemen terakhir koleksi. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Mengembalikan jumlah node dalam [XmlNamedNodeMap](./). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](./getenumerator/)() override | Menyediakan dukungan untuk iterasi atas koleksi node dalam [XmlNamedNodeMap](./). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog dari metode C# [Object.GetHashCode()](../../system/object/gethashcode/). Memungkinkan penghashan objek kustom. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/)) | Mengambil sebuah [XmlNode](../xmlnode/) yang ditentukan oleh nama. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNamedItem](./getnameditem/)([String](../../system/string/), [String](../../system/string/)) | Mengambil sebuah node dengan nilai [XmlNode::get_LocalName](../xmlnode/get_localname/) dan [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/) yang cocok. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Item](./item/)(**int32_t**) | Mengambil node pada indeks yang ditentukan dalam [XmlNamedNodeMap](./). |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/)) | Menghapus node dari [XmlNamedNodeMap](./). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveNamedItem](./removenameditem/)([String](../../system/string/), [String](../../system/string/)) | Menghapus node dengan nilai [XmlNode::get_LocalName](../xmlnode/get_localname/) dan [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/) yang cocok. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SetNamedItem](./setnameditem/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) | Menambahkan sebuah [XmlNode](../xmlnode/) menggunakan nilai [XmlNode::get_Name](../xmlnode/get_name/)-nya. |
