...
description: Mewakili sebuah bagian CDATA.
type: docs
weight: 105
url: /id/system.xml/xmlcdatasection/
---
## XmlCDataSection kelas
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttributeCollection](../xmlattributecollection/)\> [get_Attributes](../xmlnode/get_attributes/)() | Mengembalikan sebuah [XmlAttributeCollection](../xmlattributecollection/) yang berisi atribut dari node ini. |
...
| [String](../../system/string/) [get_Value](../xmlcharacterdata/get_value/)() override | Mengembalikan nilai dari node. |
...
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Mencari deklarasi **xmlns** terdekat untuk URI namespace yang diberikan yang berada dalam lingkup node saat ini dan mengembalikan prefiks yang didefinisikan dalam deklarasi tersebut. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Menempatkan semua node [XmlText](../xmltext/) pada kedalaman penuh sub-pohon di bawah [XmlNode](../xmlnode/) ini ke dalam bentuk "normal" di mana hanya markup (yaitu tag, komentar, instruksi pemrosesan, bagian CDATA, dan referensi entitas) yang memisahkan node [XmlText](../xmltext/), yaitu tidak ada node [XmlText](../xmltext/) yang berdekatan. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Mengganti sejumlah karakter yang dimulai pada offset tertentu dengan string yang ditentukan. |
...
| virtual void [set_Data](../xmlcharacterdata/set_data/)([String](../../system/string/)) | Mengatur data node. |
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Mengatur nilai yang digabungkan dari node dan semua anaknya. |
...
| void [set_Value](../xmlcharacterdata/set_value/)([String](../../system/string/)) override | Mengatur nilai node. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Mengambil substring dari string lengkap dalam rentang yang ditentukan. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeBeginConstIterator](../../system.collections.generic/ienumerable/virtualizebeginconstiterator/)() const | Mendapatkan implementasi begin iterator const untuk kontainer saat ini. |
...
| virtual [virtualized_iterator](../../system.collections.generic/ienumerable/virtualized_iterator/) * [virtualizeEndConstIterator](../../system.collections.generic/ienumerable/virtualizeendconstiterator/)() const | Mendapatkan implementasi end iterator const untuk kontainer saat ini. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Menyimpan anak node ke [XmlWriter](../xmlwriter/) yang ditentukan. |
