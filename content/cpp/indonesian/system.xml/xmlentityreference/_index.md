...
description: Mewakili node referensi entitas.
type: docs
weight: 248
url: /id/system.xml/xmlentityreference/
---
## XmlEntityReference kelas
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Mengembalikan Uniform Resource Identifier (URI) dasar dari node saat ini. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_FirstChild](../xmlnode/get_firstchild/)() | Mengembalikan node anak pertama dari node. |
| virtual **bool** [get_HasChildNodes](../xmlnode/get_haschildnodes/)() | Mengembalikan nilai yang menunjukkan apakah node ini memiliki node anak apa pun. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() override | Mengembalikan nilai yang menunjukkan apakah node bersifat read-only. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_LastChild](../xmlnode/get_lastchild/)() | Mengembalikan node anak terakhir dari node. |
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Mengembalikan nama lokal node. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Mengembalikan nama node. |
...
| [XmlNodeType](../xmlnodetype/) [get_NodeType](./get_nodetype/)() override | Mengembalikan tipe node. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Mengembalikan post schema validation infoset yang telah diberikan ke node ini sebagai hasil validasi skema. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Mencari deklarasi **xmlns** terdekat untuk prefiks yang diberikan yang berada dalam cakupan node saat ini dan mengembalikan namespace URI dalam deklarasi tersebut. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Mencari deklarasi **xmlns** terdekat untuk namespace URI yang diberikan yang berada dalam cakupan node saat ini dan mengembalikan prefiks yang didefinisikan dalam deklarasi tersebut. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Mengembalikan elemen pertama dalam urutan yang memenuhi kondisi atau nilai default jika tidak ada elemen tersebut. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Skip](../../system.collections.generic/ienumerable/linq_skip/)(**int32_t**) | Melewati sejumlah elemen kontigu yang ditentukan dari awal urutan dan mengembalikan sisanya. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Take](../../system.collections.generic/ienumerable/linq_take/)(**int32_t**) | Mengembalikan sejumlah elemen kontigu yang ditentukan dari awal urutan. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Menempatkan semua node [XmlText](../xmltext/) pada kedalaman penuh dari sub-pohon di bawah [XmlNode](../xmlnode/) ini ke dalam bentuk "normal" di mana hanya markup (yaitu tag, komentar, instruksi pemrosesan, bagian CDATA, dan referensi entitas) yang memisahkan node [XmlText](../xmltext/), yaitu tidak ada node [XmlText](../xmltext/) yang berdekatan. |
...
| virtual void [RemoveAll](../xmlnode/removeall/)() | Menghapus semua node anak dan/atau atribut node saat ini. |
...
| virtual void [set_InnerText](../xmlnode/set_innertext/)([String](../../system/string/)) | Mengatur nilai yang digabungkan dari node dan semua node anaknya. |
...
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Mengatur prefiks namespace dari node ini. |
...
Objek kelas ini harus hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan error runtime dan/atau fault assert. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen. 
