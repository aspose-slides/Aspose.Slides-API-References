...
description: Mewakili node deklarasi XML <?xml version='1.0'...?>.
type: docs
weight: 170
url: /id/system.xml/xmldeclaration/
---
## XmlDeclaration kelas
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dari instance koleksi yang bertipe const. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama yang bertipe const (jika ada) dari koleksi. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir (jika ada) dari instance koleksi yang bertipe const. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Membandingkan objek menggunakan semantik C# [Object.Equals](../../system/object/equals/). |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Membandingkan objek tipe referensi dengan gaya C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Membandingkan objek tipe nilai dengan gaya C#. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Mensimulasikan perbandingan titik mengambang ala C# di mana dua NaN dianggap sama meskipun menurut IEC 60559:1989 NaN tidak sama dengan nilai apa pun, termasuk NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Mensimulasikan perbandingan titik mengambang ala C# di mana dua NaN dianggap sama meskipun menurut IEC 60559:1989 NaN tidak sama dengan nilai apa pun, termasuk NaN. |
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | Mengembalikan tingkat enkoding dari dokumen XML. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Mengembalikan nilai yang digabungkan dari [XmlDeclaration](./). |
...
| virtual [String](../../system/string/) [get_NamespaceURI](../xmlnode/get_namespaceuri/)() | Mengembalikan URI ruang nama dari node ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NextSibling](../xmlnode/get_nextsibling/)() | Mengembalikan node yang berada tepat setelah node ini. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](../xmlnode/get_ownerdocument/)() | Mengembalikan [XmlDocument](../xmldocument/) yang dimiliki node ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Mengembalikan induk node ini (untuk node yang dapat memiliki induk). |
| virtual [String](../../system/string/) [get_Prefix](../xmlnode/get_prefix/)() | Mengembalikan prefiks ruang nama dari node ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Mengembalikan node yang berada tepat sebelum node ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | Mengembalikan node teks yang berada tepat sebelum node ini. |
...
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | Mengembalikan nilai atribut standalone. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Mengembalikan nilai [XmlDeclaration](./). |
| [String](../../system/string/) [get_Version](./get_version/)() | Mengembalikan versi XML dari dokumen. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Mencari deklarasi **xmlns** terdekat untuk prefiks yang diberikan yang berada dalam jangkauan node saat ini dan mengembalikan URI ruang nama dalam deklarasi tersebut. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Mencari deklarasi **xmlns** terdekat untuk URI ruang nama yang diberikan yang berada dalam jangkauan node saat ini dan mengembalikan prefiks yang didefinisikan dalam deklarasi tersebut. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Menentukan apakah ada elemen dalam urutan atau apakah elemen tersebut memenuhi suatu kondisi. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Mengembalikan jumlah elemen dalam urutan (dihitung dengan penghitungan langsung). |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Menempatkan semua node [XmlText](../xmltext/) pada kedalaman penuh sub-pohon di bawah [XmlNode](../xmlnode/) ini ke dalam bentuk "normal" di mana hanya markup (yaitu tag, komentar, instruksi pemrosesan, bagian CDATA, dan referensi entitas) yang memisahkan node [XmlText](../xmltext/), sehingga tidak ada node [XmlText](../xmltext/) yang berdekatan. |
...
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | Mengatur tingkat enkoding dokumen XML. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Mengatur nilai yang digabungkan dari [XmlDeclaration](./). |
| virtual void [set_InnerXml](../xmlnode/set_innerxml/)([String](../../system/string/)) | Mengatur markup yang mewakili hanya node anak dari node ini. |
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Mengatur prefiks ruang nama node ini. |
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | Mengatur nilai atribut standalone. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Mengatur nilai [XmlDeclaration](./). |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Menyimpan anak node ke [XmlWriter](../xmlwriter/) yang ditentukan. Karena node [XmlDeclaration](./) tidak memiliki anak, metode ini tidak berpengaruh. |
...
Objek dari kelas ini sebaiknya hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance dari tipe ini di stack atau dengan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan assert. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer tersebut untuk melewatkannya ke fungsi sebagai argumen. 
