...
description: Mewakili deklarasi notasi, seperti <!NOTATION... >.
type: docs
weight: 378
url: /id/system.xml/xmlnotation/
---
## XmlNotation kelas
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](./clonenode/)(**bool**) override | Membuat duplikat dari node ini. Node notasi tidak dapat diklon. Memanggil metode ini pada objek [XmlNotation](./) melemparkan pengecualian. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttributeCollection](../xmlattributecollection/)\> [get_Attributes](../xmlnode/get_attributes/)() | Mengembalikan [XmlAttributeCollection](../xmlattributecollection/) yang berisi atribut-atribut dari node ini. |
...
| virtual [String](../../system/string/) [get_InnerText](../xmlnode/get_innertext/)() | Mengembalikan nilai yang digabungkan dari node ini dan semua node anaknya. |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Mengembalikan markup yang mewakili anak-anak node ini. |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Mengembalikan nama node saat ini tanpa prefiks namespace. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Mengembalikan nama node saat ini. |
...
| [String](../../system/string/) [get_OuterXml](./get_outerxml/)() override | Mengembalikan markup yang mewakili node ini dan semua anaknya. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Mengembalikan node yang langsung berada sebelum node ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](../xmlnode/get_previoustext/)() | Mengembalikan node teks yang langsung berada sebelum node ini. |
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Mengembalikan nilai pengidentifikasi publik pada deklarasi notasi. |
...
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Mengembalikan nilai pengidentifikasi sistem pada deklarasi notasi. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Mencari deklarasi **xmlns** terdekat untuk prefix yang diberikan yang berada dalam cakupan node saat ini dan mengembalikan URI namespace dalam deklarasi tersebut. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Menjalankan fungsi transformasi pada setiap elemen dari urutan generik dan mengembalikan nilai maksimum yang dihasilkan. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Menjalankan fungsi transformasi pada setiap elemen dari urutan generik dan mengembalikan nilai minimum yang dihasilkan. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Menempatkan semua node [XmlText](../xmltext/) dalam kedalaman penuh sub-tree di bawah [XmlNode](../xmlnode/) ini ke dalam bentuk "normal" dimana hanya markup (yaitu tag, komentar, instruksi pemrosesan, bagian CDATA, dan referensi entitas) yang memisahkan node [XmlText](../xmltext/), artinya tidak ada node [XmlText](../xmltext/) yang berdekatan. |
...
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Menetapkan markup yang mewakili anak-anak node ini. |
...
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Menguji apakah implementasi DOM mengimplementasikan fitur tertentu. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pembukaan pernyataan C# lock(). Panggil secara langsung atau gunakan objek pengaman [LockContext](../../system/lockcontext/). |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Menyimpan anak-anak node ke [XmlWriter](../xmlwriter/) yang ditentukan. Metode ini tidak berpengaruh pada node [XmlNotation](./). |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Menyimpan node ke [XmlWriter](../xmlwriter/) yang ditentukan. Metode ini tidak berpengaruh pada node [XmlNotation](./). |
