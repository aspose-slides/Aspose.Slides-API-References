...
description: Menyelesaikan, menambahkan, dan menghapus namespace ke dalam koleksi serta menyediakan manajemen ruang lingkup untuk namespace ini.
type: docs
weight: 300
url: /id/system.xml/xmlnamespacemanager/
---
## XmlNamespaceManager kelas

Menyelesaikan, menambahkan, dan menghapus namespace ke dalam koleksi serta menyediakan manajemen ruang lingkup untuk namespace ini.
...
| Metode | Deskripsi |
| --- | --- |
| virtual void [AddNamespace](./addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Menambahkan namespace yang diberikan ke dalam koleksi. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir yang diberi qualifier const (jika ada) dalam koleksi. |
...
| virtual [String](../../system/string/) [get_DefaultNamespace](./get_defaultnamespace/)() | Mengembalikan URI namespace untuk namespace default. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\> [get_NameTable](./get_nametable/)() | Mengembalikan [XmlNameTable](../xmlnametable/) yang terkait dengan objek ini. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator untuk iterasi melalui namespace di [XmlNamespaceManager](./). |
...
| virtual **bool** [HasNamespace](./hasnamespace/)([String](../../system/string/)) | Mengembalikan nilai yang menunjukkan apakah prefiks yang diberikan memiliki namespace yang didefinisikan untuk ruang lingkup yang sedang didorong. |
...
| void [Lock](../../system/object/lock/)() | Menerapkan pernyataan C# lock() untuk penguncian. Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
...
| [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) override | Menemukan prefiks yang dideklarasikan untuk URI namespace yang diberikan. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salin. Tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan copy constructing pada subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan copy constructing pada subclass. |
| virtual **bool** [PopScope](./popscope/)() | Membuang ruang lingkup namespace dari stack. |
| virtual void [PushScope](./pushscope/)() | Menambahkan ruang lingkup namespace ke stack. |
...
| virtual void [RemoveNamespace](./removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Menghapus namespace yang diberikan untuk prefiks yang diberikan. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan berpindah pointer dalam kontainer ke mode lemah. |
...
|  [XmlNamespaceManager](./xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../xmlnametable/)\>\&) | Menginisialisasi instance baru dari kelas [XmlNamespaceManager](./) dengan [XmlNameTable](../xmlnametable/) yang ditentukan. |
