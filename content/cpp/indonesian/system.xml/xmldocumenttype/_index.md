...
description: Mewakili deklarasi tipe dokumen.
type: docs
weight: 209
url: /id/system.xml/xmldocumenttype/
---
## XmlDocumentType kelas
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttributeCollection](../xmlattributecollection/)\> [get_Attributes](../xmlnode/get_attributes/)() | Mengembalikan [XmlAttributeCollection](../xmlattributecollection/) yang berisi atribut-atribut node ini. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Entities](./get_entities/)() | Mengembalikan koleksi node [XmlEntity](../xmlentity/) yang dideklarasikan dalam deklarasi tipe dokumen. |
...
| [String](../../system/string/) [get_InternalSubset](./get_internalsubset/)() | Mengembalikan nilai dari subset internal definisi tipe dokumen (DTD) pada deklarasi DOCTYPE. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Notations](./get_notations/)() | Mengembalikan koleksi node [XmlNotation](../xmlnotation/) yang ada dalam deklarasi tipe dokumen. |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Mengembalikan nilai dari pengidentifikasi publik pada deklarasi DOCTYPE. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Mengembalikan infoset validasi skema pasca yang telah ditetapkan pada node ini sebagai hasil dari validasi skema. |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Mengembalikan nilai dari pengidentifikasi sistem pada deklarasi DOCTYPE. |
| virtual [String](../../system/string/) [get_Value](../xmlnode/get_value/)() | Mengembalikan nilai dari node. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_OfType](../../system.collections.generic/ienumerable/linq_oftype/)() | Menyaring elemen dalam urutan berdasarkan tipe yang ditentukan. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Menempatkan semua node [XmlText](../xmltext/) pada kedalaman penuh sub-pohon di bawah [XmlNode](../xmlnode/) ini ke dalam bentuk "normal" dimana hanya markup (yaitu tag, komentar, instruksi proses, bagian CDATA, dan referensi entitas) yang memisahkan node [XmlText](../xmltext/), sehingga tidak ada node [XmlText](../xmltext/) yang bersebelahan. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Meningkatkan penghitung referensi bersama. Tidak seharusnya dipanggil langsung; sebaliknya, gunakan smart pointer atau ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Mengurangi dan mengembalikan penghitung referensi bersama. Tidak seharusnya dipanggil langsung; sebaliknya, gunakan smart pointer atau ThisProtector. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Menyimpan semua anak node ke [XmlWriter](../xmlwriter/) yang ditentukan. Untuk node [XmlDocumentType](./), metode ini tidak berpengaruh. |
