...
| virtual [System::Drawing::Color](../../system.drawing/color/) [get_Color](./get_color/)() | Mendapatkan warna kuas untuk sebuah garis. |
| virtual [InkEffectType](../inkeffecttype/) [get_InkEffect](./get_inkeffect/)() | Mendapatkan jenis efek tinta (mis., Galaxy, Gold, Silver) yang menentukan gaya visual coretan tinta. Nilai diurai dari properti kuas \"inkEffects\". Jika tidak ada efek yang dikenali, [InkEffectType::NotDefined](../inkeffecttype/) dikembalikan. |
| virtual [System::Drawing::SizeF](../../system.drawing/sizef/) [get_Size](./get_size/)() | Mendapatkan ukuran kuas untuk sebuah garis dalam poin. |
...
| virtual void [set_Color](./set_color/)([System::Drawing::Color](../../system.drawing/color/)) | Mengatur warna kuas untuk sebuah garis. |
| virtual void [set_Size](./set_size/)([System::Drawing::SizeF](../../system.drawing/sizef/)) | Mengatur ukuran kuas untuk sebuah garis dalam poin. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Meningkatkan penghitung weak reference. Seharusnya tidak dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
...
| virtual  [~Object](../../system/object/~object/)() | Mendesak objek. Membebaskan semua struktur data internal. |
## Lihat Juga
