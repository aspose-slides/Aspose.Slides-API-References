...
description: "Mewakili nilai dari header 'Range'. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini pada stack atau menggunakan operator new, karena akan menyebabkan error runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 248
url: /id/system.net.http.headers/rangeheadervalue/
---
## RangeHeaderValue kelas

Mewakili nilai dari header '[Range](../../system/range/)'. Objek dari kelas ini harus hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance dari tipe ini di stack atau menggunakan operator new, karena akan mengakibatkan kesalahan runtime dan/atau kegagalan assert. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen.
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::SharedPtr](../../system/sharedptr/)\<[RangeItemHeaderValue](../rangeitemheadervalue/)\>\>\> [get_Ranges](./get_ranges/)() | Mengembalikan koleksi rentang. |
| [String](../../system/string/) [get_Unit](./get_unit/)() | Mendapatkan unit. |
...
| static **int32_t** [GetRangeLength](./getrangelength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Mengonversi string yang diberikan dari indeks yang ditentukan menjadi sebuah instance dari kelas [RangeHeaderValue](./). |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[RangeHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Mengonversi string yang diberikan menjadi sebuah instance dari kelas [RangeHeaderValue](./). |
| [RangeHeaderValue](./rangeheadervalue/)() | Membangun sebuah instance baru. |
| [RangeHeaderValue](./rangeheadervalue/)([Nullable](../../system/nullable/)\<**int64_t**\>, [Nullable](../../system/nullable/)\<**int64_t**\>) | Membangun sebuah instance baru. |
...
| void [set_Unit](./set_unit/)([String](../../system/string/)) | Mengatur unit. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan mengganti pointer dalam wadah ke mode lemah. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Analog dari metode C# [Object.ToString()](../../system/object/tostring/). Mengaktifkan konversi objek khusus menjadi string. |
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[RangeHeaderValue](./)\>\&) | Mencoba mengonversi string yang diberikan menjadi sebuah instance dari kelas [RangeHeaderValue](./). |
