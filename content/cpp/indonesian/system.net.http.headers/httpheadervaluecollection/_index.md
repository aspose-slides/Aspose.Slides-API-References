...
| Parameter | Deskripsi |
| --- | --- |
| The | tipe nilai header yang direpresentasikan dalam koleksi. |

## Metode

| Metode | Deskripsi |
| --- | --- |
| void [Add](./add/)(const T\&) override | Menambahkan elemen ke dalam koleksi. |
...
| **bool** [Contains](./contains/)(const T\&) const override | Memeriksa apakah elemen ada dalam koleksi. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) override | Menyalin semua elemen koleksi ke elemen array yang sudah ada. |
...
| **int32_t** [get_Count](./get_count/)() const override | Mendapatkan jumlah elemen dalam koleksi. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Mendapatkan nilai yang menunjukkan apakah koleksi saat ini bersifat read-only. |
| virtual **bool** [get_IsReadOnly](../../system.collections.generic/icollection/get_isreadonly/)() const | Memeriksa apakah koleksi bersifat read only. |
| **bool** [get_IsSpecialValueSet](./get_isspecialvalueset/)() | Mendapatkan nilai yang menunjukkan apakah koleksi saat ini mengandung "special value". |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Mendapatkan enumerator. |
...
| [String](../../system/string/) [GetHeaderStringWithoutSpecial](./getheaderstringwithoutspecial/)() | Mengembalikan representasi string dari koleksi saat ini tanpa "special value". |
...
| [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>) | Membuat sebuah instance baru. |
| [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Membuat sebuah instance baru. |
| [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T) | Membuat sebuah instance baru. |
| [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Membuat sebuah instance baru. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Mentranformasi elemen-elemen dalam urutan. |
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Mentranformasi setiap elemen urutan menjadi bentuk baru dengan memasukkan indeks elemen. |
...
| void [ParseAdd](./parseadd/)([String](../../system/string/)) | Mengurai representasi string header dan menambahkannya ke koleksi saat ini. |
...
| **bool** [Remove](./remove/)(const T\&) override | Menghapus elemen dari koleksi. |
...
| void [RemoveSpecialValue](./removespecialvalue/)() | Menghapus "special value". |
| void [SetSpecialValue](./setspecialvalue/)() | Menetapkan "special value". |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Menetapkan argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan mengubah pointer di dalam kontainer menjadi mode weak. |
| int [SharedCount](../../system/object/sharedcount/)() const | Mendapatkan nilai saat ini dari penghitung referensi bersama. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Menambah satu penghitung referensi bersama. Tidak boleh dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
...
| **bool** [TryParseAdd](./tryparseadd/)([String](../../system/string/)) | Mencoba mengurai representasi string header dan menambahkannya ke koleksi saat ini. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah satu penghitung referensi lemah. Tidak boleh dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
