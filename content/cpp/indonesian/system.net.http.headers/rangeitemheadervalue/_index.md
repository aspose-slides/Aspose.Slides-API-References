...
description: "Mewakili rentang byte dalam nilai header 'Range'. Objek kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 261
url: /id/system.net.http.headers/rangeitemheadervalue/
---
## RangeItemHeaderValue kelas

Mewakili rentang byte dalam nilai header '[Range](../../system/range/)'. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance dari tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk meneruskan ke fungsi sebagai argumen.
...
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_From](./get_from/)() | Mengembalikan posisi di mana pengiriman data harus dimulai. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_To](./get_to/)() | Mengembalikan posisi di mana pengiriman data harus dihentikan. |
...
| static **int32_t** [GetRangeItemLength](./getrangeitemlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[RangeItemHeaderValue](./)\>\&) | Mengonversi string yang diberikan dari indeks yang ditentukan menjadi sebuah instance dari kelas [RangeItemHeaderValue](./). |
| static **int32_t** [GetRangeItemListLength](./getrangeitemlistlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::SharedPtr](../../system/sharedptr/)\<[RangeItemHeaderValue](./)\>\>\>) | Mengonversi string yang diberikan dari posisi yang ditentukan menjadi koleksi instance RangeItemHeaderValue-class. |
...
|  [RangeItemHeaderValue](./rangeitemheadervalue/)([Nullable](../../system/nullable/)\<**int64_t**\>, [Nullable](../../system/nullable/)\<**int64_t**\>) | Membuat sebuah instance baru. |
