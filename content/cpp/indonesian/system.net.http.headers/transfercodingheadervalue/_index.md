...
description: "Mewakili nilai header 'Accept-Encoding'. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan waktu jalan dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer tersebut untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 300
url: /id/system.net.http.headers/transfercodingheadervalue/
---
## TransferCodingHeaderValue kelas
...
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::SharedPtr](../../system/sharedptr/)\<[NameValueHeaderValue](../namevalueheadervalue/)\>\>\> [get_Parameters](./get_parameters/)() | Mengembalikan parameter. |
| [String](../../system/string/) [get_Value](./get_value/)() | Mengembalikan sebuah nilai. |
...
| static **int32_t** [GetTransferCodingLength](./gettransfercodinglength/)([String](../../system/string/), **int32_t**, const [HeaderFunc](../headerfunc/)\<[System::SharedPtr](../../system/sharedptr/)\<[TransferCodingHeaderValue](./)\>\>\&, [System::SharedPtr](../../system/sharedptr/)\<[TransferCodingHeaderValue](./)\>\&) | Mengonversi string yang diteruskan dari indeks tertentu menjadi sebuah instance dari kelas [TransferCodingHeaderValue](./). |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[TransferCodingHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Mengonversi string yang diteruskan menjadi sebuah instance dari kelas [TransferCodingHeaderValue](./). |
...
| [TransferCodingHeaderValue](./transfercodingheadervalue/)() | Membuat sebuah instance baru. |
| [TransferCodingHeaderValue](./transfercodingheadervalue/)([String](../../system/string/)) | Membuat sebuah instance baru. |
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[TransferCodingHeaderValue](./)\>\&) | Mencoba mengonversi string yang diteruskan menjadi sebuah instance dari kelas [TransferCodingHeaderValue](./). |
