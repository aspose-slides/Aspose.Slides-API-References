...
description: "Mewakili tipe MIME dalam nilai header 'Content-Type'. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer tersebut untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 144
url: /id/system.net.http.headers/mediatypeheadervalue/
---
## MediaTypeHeaderValue kelas
...
| [String](../../system/string/) [get_CharSet](./get_charset/)() | Mendapatkan set karakter. |
| [String](../../system/string/) [get_MediaType](./get_mediatype/)() | Mendapatkan nilai header media-type. |
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::ICollection](../../system.collections.generic/icollection/)\<[System::SharedPtr](../../system/sharedptr/)\<[NameValueHeaderValue](../namevalueheadervalue/)\>\>\> [get_Parameters](./get_parameters/)() | Mengembalikan parameter nilai dari header media-type. |
...
| static **int32_t** [GetMediaTypeLength](./getmediatypelength/)([String](../../system/string/), **int32_t**, [HeaderFunc](../headerfunc/)\<[System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\>\>, [System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\>\&) | Mengonversi string yang diberikan dari indeks yang ditentukan menjadi instance kelas [MediaTypeHeaderValue](./). |
...
| [MediaTypeHeaderValue](./mediatypeheadervalue/)([String](../../system/string/)) | Membuat instance baru. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalinan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruktor subclass. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Mengonversi string yang diberikan menjadi instance kelas [MediaTypeHeaderValue](./). |
...
| void [set_CharSet](./set_charset/)([String](../../system/string/)) | Mengatur set karakter. |
| void [set_MediaType](./set_mediatype/)([String](../../system/string/)) | Mengatur nilai header media-type. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Analog metode C# [Object.ToString()](../../system/object/tostring/). Mengaktifkan konversi objek kustom ke string. |
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[MediaTypeHeaderValue](./)\>\&) | Mencoba mengonversi string yang diberikan menjadi instance kelas [MediaTypeHeaderValue](./). |
