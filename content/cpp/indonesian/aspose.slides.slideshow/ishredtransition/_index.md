...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Arah transisi. Baca [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual [TransitionShredPattern](../transitionshredpattern/) [get_Pattern](./get_pattern/)() | Menentukan bentuk visual yang digunakan selama transisi. Baca [TransitionShredPattern](../transitionshredpattern/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek mewakili contoh tipe yang dijelaskan oleh targetType. Analog dari operator C# 'is'. |
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan lock() C#. Panggil secara langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Arah transisi. Tulis [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_Pattern](./set_pattern/)([TransitionShredPattern](../transitionshredpattern/)) | Menentukan bentuk visual yang digunakan selama transisi. Tulis [TransitionShredPattern](../transitionshredpattern/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Set n'th argumen templat menjadi weak pointer (bukan shared). Memungkinkan penggantian pointer dalam kontainer ke mode lemah. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan unlock() C#. Panggil secara langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
