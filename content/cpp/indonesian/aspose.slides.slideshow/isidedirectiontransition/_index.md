...
---
## ISideDirectionTransition kelas
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Set argumen template ke-n menjadi pointer lemah (bukan berbagi). Mengizinkan penggantian pointer dalam kontainer ke mode lemah. |
