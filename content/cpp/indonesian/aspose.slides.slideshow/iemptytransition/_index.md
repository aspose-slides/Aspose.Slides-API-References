...
---
## IEmptyTransition kelas

Efek transisi slide kosong.

```cpp
class IEmptyTransition : public virtual Aspose::Slides::SlideShow::ITransitionValueBase
```
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menyetel argumen templat ke-nth menjadi pointer lemah (bukan shared). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pembukaan penguncian pernyataan C# lock(). Panggil langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
