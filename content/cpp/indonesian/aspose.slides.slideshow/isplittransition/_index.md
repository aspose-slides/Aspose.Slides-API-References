...
| virtual [TransitionInOutDirectionType](../transitioninoutdirectiontype/) [get_Direction](./get_direction/)() | Arah pembelahan transisi. Baca [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual [Aspose::Slides::Orientation](../../aspose.slides/orientation/) [get_Orientation](./get_orientation/)() | Orientasi pembelahan transisi. Baca [Slides::Orientation](../../aspose.slides/orientation/). |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog dari metode [Object.MemberwiseClone()](../../system/object/memberwiseclone/) C#. Mengaktifkan pengklonan tipe khusus. |
...
| virtual void [set_Direction](./set_direction/)([TransitionInOutDirectionType](../transitioninoutdirectiontype/)) | Arah pembelahan transisi. Tulis [TransitionInOutDirectionType](../transitioninoutdirectiontype/). |
| virtual void [set_Orientation](./set_orientation/)([Aspose::Slides::Orientation](../../aspose.slides/orientation/)) | Orientasi pembelahan transisi. Tulis [Slides::Orientation](../../aspose.slides/orientation/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen templat ke-n menjadi pointer lemah (bukan bersama). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
...
* Kelas [ITransitionValueBase](../itransitionvaluebase/)
