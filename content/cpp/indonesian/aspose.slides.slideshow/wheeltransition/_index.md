...
| **uint32_t** [get_Spokes](./get_spokes/)() override | Jumlah jari-jari transisi roda. Baca **uint32_t**. |
...
| void [set_Spokes](./set_spokes/)(**uint32_t**) override | Jumlah jari-jari transisi roda. Tulis **uint32_t**. |
...
* Kelas [IWheelTransition](../iwheeltransition/)
