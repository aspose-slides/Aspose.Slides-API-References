...
| virtual **uint32_t** [get_Spokes](./get_spokes/)() | Jumlah spoke transisi roda. Baca **uint32_t**. |
...
| virtual void [set_Spokes](./set_spokes/)(**uint32_t**) | Jumlah spoke transisi roda. Tulis **uint32_t**. |
