...
| [TransitionMorphType](../transitionmorphtype/) [get_MorphType](./get_morphtype/)() override | Tipe transisi morph. Baca [TransitionMorphType](../transitionmorphtype/). |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan penguncian pernyataan C# lock(). Panggil secara langsung atau gunakan objek sentri [LockContext](../../system/lockcontext/). |
...
| void [set_MorphType](./set_morphtype/)([TransitionMorphType](../transitionmorphtype/)) override | Tipe transisi morph. Tulis [TransitionMorphType](../transitionmorphtype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Tetapkan argumen templat ke-n menjadi pointer lemah (bukan bersama). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pembukaan kunci pernyataan C# lock(). Panggil secara langsung atau gunakan objek sentri [LockContext](../../system/lockcontext/). |
...
* Kelas [IMorphTransition](../imorphtransition/)
