...
---
## IOptionalBlackTransition kelas
...
| virtual **bool** [get_FromBlack](./get_fromblack/)() | Atribut ini menentukan apakah transisi akan dimulai dari layar hitam (dan kemudian mentransisikan slide baru di atas hitam). Baca **bool**. |
...
| virtual void [set_FromBlack](./set_fromblack/)(**bool**) | Atribut ini menentukan apakah transisi akan dimulai dari layar hitam (dan kemudian mentransisikan slide baru di atas hitam). Tulis **bool**. |
