...
---
## IPieSplitCustomPointCollection kelas
...
| Metode | Deskripsi |
| --- | --- |
| virtual void [Add](./add/)(const **int32_t**\&) | Menambahkan titik data berdasarkan indeksnya dalam koleksi titik seri induk. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../../system.collections.generic/icollection/get_syncroot/)() const | Mendapatkan objek yang dijadikan sinkronisasi koleksi. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) | Mengembalikan titik data bagan berdasarkan indeks. |
...
| T [LINQ_First](../../system.collections.generic/ienumerable/linq_first/)(const [Func](../../system/func/)\<T, **bool**\>\&) | Mengembalikan elemen pertama dalam urutan yang memenuhi kondisi tertentu. |
...
| virtual void [Remove](./remove/)(**int32_t**) | Menghapus item dari koleksi berdasarkan indeksnya dalam koleksi titik seri induk. |
