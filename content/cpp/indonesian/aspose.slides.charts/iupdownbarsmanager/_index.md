...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | Mengembalikan format bar menurun. Hanya-baca [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | Mengembalikan lebar celah. Baca **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | Menentukan apakah diagram memiliki bar naik/turun. Baca **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | Mengembalikan format bar naik. Hanya-baca [IFormat](../iformat/). |
...
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | Mengatur lebar celah. Tulis **int32_t**. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | Menentukan apakah diagram memiliki bar naik/turun. Tulis **bool**. |
