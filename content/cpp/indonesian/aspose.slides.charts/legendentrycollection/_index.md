...
| **int32_t** [get_Count](./get_count/)() override | Mendapatkan jumlah entri legenda. Baca-saja **int32_t**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ILegendEntryProperties](../ilegendentryproperties/)\> [idx_get](./idx_get/)(**int32_t**) override | Mendapatkan properti entri legenda yang sesuai dengan [Chart::get_ChartData()](../chart/get_chartdata/)->get_Series()[0].DataPoints[index] dalam kasus tipe diagram dari daftar ini: [ChartType::BarOfPie](../charttype/), [ChartType::ExplodedPie](../charttype/), [ChartType::ExplodedPie3D](../charttype/), [ChartType::Pie](../charttype/), [ChartType::Pie3D](../charttype/), [ChartType::PieOfPie](../charttype/); atau yang sesuai dengan [Chart::get_ChartData()](../chart/get_chartdata/)->get_Series()[index] untuk tipe diagram lainnya. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi pointer lemah (bukan bersama). Memungkinkan beralih pointer dalam kontainer ke mode lemah. |
...
* Kelas [ILegendEntryCollection](../ilegendentrycollection/)
