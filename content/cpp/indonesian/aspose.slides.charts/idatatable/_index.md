...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChart](../ichart/)\> [get_Chart](../ichartcomponent/get_chart/)() | Mengembalikan diagram. Baca-saja [IChart](../ichart/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Mengembalikan gaya garis, isi, dan efek dari sebuah objek. Baca-saja [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | Benar jika tabel data diagram memiliki batas sel horizontal. Baca **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | Benar jika tabel data diagram memiliki batas kerangka. Baca **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | Benar jika tabel data diagram memiliki batas sel vertikal. Baca **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | Benar jika kunci legenda label data terlihat. Baca **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartTextFormat](../icharttextformat/)\> [get_TextFormat](../iformattedtextcontainer/get_textformat/)() | Mengembalikan format teks diagram. Baca-saja [IChartTextFormat](../icharttextformat/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Periksa apakah objek mewakili instansi tipe yang dijelaskan oleh targetType. Analogi operator 'is' C#. |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | Benar jika tabel data diagram memiliki batas sel horizontal. Tulis **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | Benar jika tabel data diagram memiliki batas kerangka. Tulis **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | Benar jika tabel data diagram memiliki batas sel vertikal. Tulis **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | Benar jika kunci legenda label data terlihat. Tulis **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen templat ke-n menjadi weak pointer (bukan shared). Mengizinkan penggantian pointer dalam kontainer ke mode weak. |
