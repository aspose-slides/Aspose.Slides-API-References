...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Data](./get_data/)() | Data. Baca [System::Object](../../system/object/). |
| [Aspose::Slides::Charts::DataSourceType](../datasourcetype/) [get_DataSourceType](./get_datasourcetype/)() override | Menentukan apakah properti AsCell, AsCells, AsLiteralString, atau AsLiteralDouble aktif pada turunan. Dengan kata lain, ini menentukan tipe nilai dari properti Data. Baca [Charts::DataSourceType](../datasourcetype/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalinan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruksi subclass. |
...
| virtual void [set_Data](./set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Data. Tulis [System::Object](../../system/object/). |
| void [set_DataSourceType](./set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) override | Menentukan apakah properti AsCell, AsCells, AsLiteralString, atau AsLiteralDouble aktif pada turunan. Dengan kata lain, ini menentukan tipe nilai dari properti Data. Tulis [Charts::DataSourceType](../datasourcetype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen templat ke-n menjadi pointer lemah (bukan bersama). Memungkinkan mengubah pointer dalam kontainer menjadi mode lemah. |
...
* Kelas [IBaseChartValue](../ibasechartvalue/)
