...
description: Mewakili koleksi IChartSeries
type: docs
weight: 833
url: /id/aspose.slides.charts/ichartseriescollection/
---
## IChartSeriesCollection kelas
...
| Metode | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) | Membuat seri diagram baru dan menambahkannya ke dalam koleksi. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) | Membuat seri diagram baru dari [IChartDataCell](../ichartdatacell/) dan menambahkannya ke dalam koleksi. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) | Membuat seri diagram baru dari [IChartCellCollection](../ichartcellcollection/) dan menambahkannya ke dalam koleksi. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) | Membuat seri diagram baru dari nilai dan menambahkannya ke dalam koleksi. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Menemukan iterator yang menunjuk ke elemen pertama (jika ada) dari koleksi. Iterator ini tidak dapat digunakan untuk mengubah objek yang direferensikan karena [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) mengembalikan objek salinan dari T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Menemukan iterator yang menunjuk ke elemen pertama (jika ada) dari instance koleksi yang bertipe const. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Menemukan iterator yang menunjuk ke elemen pertama yang bertipe const (jika ada) dari koleksi. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Menemukan iterator yang tepat setelah elemen const terakhir (jika ada) dari koleksi. |
| virtual void [Clear](./clear/)() | Menghapus semua elemen (termasuk gaya diagram) dari koleksi. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Menemukan iterator yang tepat setelah elemen terakhir (jika ada) dari koleksi. Iterator ini tidak dapat digunakan untuk mengubah objek yang direferensikan karena [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) mengembalikan objek salinan dari T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Menemukan iterator yang tepat setelah elemen terakhir (jika ada) dari instance koleksi yang bertipe const. |
...
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Mencari [IChartSeries](../ichartseries/) yang ditentukan dan mengembalikan indeks berbasis nol dari kejadian pertama di seluruh koleksi. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) | Membuat seri diagram baru dan menyisipkannya ke dalam koleksi. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Menghapus nilai yang ditentukan. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Menghapus elemen pada indeks yang ditentukan |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Menambah penghitung referensi bersama. Seharusnya tidak dipanggil langsung; gunakan smart pointer atau ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah penghitung referensi lemah. Seharusnya tidak dipanggil langsung; gunakan smart pointer atau ThisProtector. |
