...
description: Merepresentasikan penanda dari sebuah chert.
type: docs
weight: 1301
...
Merepresentasikan penanda dari sebuah chert.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Mendapatkan isian penanda. Hanya-baca [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | Mewakili ukuran penanda dalam diagram garis, diagram sebar, atau diagram radar. Baca **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | Mewakili gaya penanda dalam diagram garis, diagram sebar, atau diagram radar. Baca [MarkerStyleType](../markerstyletype/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog dari metode C# [Object.GetHashCode()](../../system/object/gethashcode/). Mengaktifkan hashing objek khusus. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Mendapatkan tipe nyata dari objek. Analog dari panggilan C# [System.Object.GetType()](../../system/object/gettype/). |
...
| void [set_Size](./set_size/)(**int32_t**) override | Mewakili ukuran penanda dalam diagram garis, diagram sebar, atau diagram radar. Tulis **int32_t**. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | Mewakili gaya penanda dalam diagram garis, diagram sebar, atau diagram radar. Tulis [MarkerStyleType](../markerstyletype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Set argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
