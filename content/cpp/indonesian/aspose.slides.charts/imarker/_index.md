...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Mendapatkan isi penanda. Hanya-baca [IFormat](../iformat/). |
| virtual **int32_t** [get_Size](./get_size/)() | Mewakili ukuran penanda dalam diagram garis, diagram sebar, atau diagram radar. Baca **int32_t**. |
| virtual [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() | Mewakili gaya penanda dalam diagram garis, diagram sebar, atau diagram radar. Baca [MarkerStyleType](../markerstyletype/). |
...
| virtual void [set_Size](./set_size/)(**int32_t**) | Mewakili ukuran penanda dalam diagram garis, diagram sebar, atau diagram radar. Tulis **int32_t**. |
| virtual void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) | Mewakili gaya penanda dalam diagram garis, diagram sebar, atau diagram radar. Tulis [MarkerStyleType](../markerstyletype/). |
