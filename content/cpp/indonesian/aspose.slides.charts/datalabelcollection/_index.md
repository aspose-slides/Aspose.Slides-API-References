...
| **int32_t** [get_Count](./get_count/)() override | Mendapatkan jumlah semua label data dalam koleksi. Baca-saja **int32_t**. |
| **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() override | Mendapatkan jumlah label data yang terlihat dalam koleksi. Baca-saja **int32_t**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() override | Mendapatkan format label data default. Baca-saja [IDataLabelFormat](../idatalabelformat/). |
| **bool** [get_IsVisible](./get_isvisible/)() override | False berarti label data tidak terlihat secara default (dan sehingga semua flag Show*- (ShowValue, ...) dari properti DefaultDataLabelFormat bernilai false). Baca-saja **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() override | Mewakili format garis pemimpin label data. Baca-saja [IChartLinesFormat](../ichartlinesformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() override | Mendapatkan seri induk. Baca-saja [IChartSeries](../ichartseries/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator yang mengiterasi koleksi. |
...
| void [Hide](./hide/)() override | Membuat label data tersembunyi secara default dengan mengatur semua flag Show*- (ShowValue, ...) dari properti DefaultDataLabelFormat ke keadaan false. IsVisible akan menjadi false setelah ini. |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) override | Mendapatkan label data untuk titik data dengan indeks yang ditentukan. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) override | Mengembalikan indeks dari [DataLabel](../datalabel/) yang ditentukan dalam koleksi. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Mengatur argumen templat ke-n menjadi pointer lemah (bukan shared). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
...
* Kelas [IDataLabelCollection](../idatalabelcollection/)
