...
description: Mewakili kumpulan sel diagram.
type: docs
weight: 1132
url: /id/aspose.slides.charts/imultiplecellchartvalue/
---
## IMultipleCellChartValue kelas


Mewakili kumpulan sel diagram.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)(**int32_t**) | Mengembalikan sel grafik pada indeks yang ditentukan. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\> [get_AsCells](./get_ascells/)() | Mengembalikan koleksi sel grafik. Baca [IChartCellCollection](../ichartcellcollection/). |
...
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogi metode C# [Object.GetHashCode()](../../system/object/gethashcode/). Mengaktifkan penghashan objek kustom. |
...
| virtual void [set_AsCells](./set_ascells/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>) | Mengatur koleksi sel grafik. Tulis [IChartCellCollection](../ichartcellcollection/). |
| virtual void [set_Data](../ibasechartvalue/set_data/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) |  |
| virtual void [set_DataSourceType](../ibasechartvalue/set_datasourcetype/)([Aspose::Slides::Charts::DataSourceType](../datasourcetype/)) | Menentukan apakah properti AsCell atau AsLiteralString atau AsLiteralDouble yang aktual. Dengan kata lain, ini menentukan tipe nilai dari properti Data. Properti ini hanya-baca. Untuk mengubah nilai properti ini, Anda dapat menggunakan salah satu properti ChartDataPointCollection.DataSourceTypeFor<...>. Tulis [DataSourceType](../datasourcetype/). |
