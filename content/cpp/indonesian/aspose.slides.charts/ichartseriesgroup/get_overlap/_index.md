...
type: docs
weight: 183
url: /id/aspose.slides.charts/ichartseriesgroup/get_overlap/
---
## IChartSeriesGroup::get_Overlap() metode

Menentukan seberapa banyak batang dan kolom harus saling tumpang tindih pada diagram 2-D, sebagai persentase (dari -100% hingga 100%).
...
* 100%: Tumpang tindih maksimum (batang sepenuhnya tumpang tindih satu sama lain). Properti ini dapat dibaca/ditulis **int8_t**.
