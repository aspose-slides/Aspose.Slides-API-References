...
description: Mewakili koleksi ChartSeries
type: docs
weight: 287
...
| Metode | Deskripsi |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) override | Membuat seri diagram baru dan menambahkannya ke koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) override | Membuat seri diagram baru dari [ChartDataCell](../chartdatacell/) dan menambahkannya ke koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) override | Membuat seri diagram baru dari [ChartCellCollection](../chartcellcollection/) dan menambahkannya ke koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) override | Membuat seri diagram baru dari nilai dan menambahkannya ke koleksi. |
...
| void [Clear](./clear/)() override | Menghapus semua kontrol dari koleksi. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>, **int32_t**) override | Menyalin semua elemen dari koleksi ke dalam array yang ditentukan. |
...
| **int32_t** [get_Count](./get_count/)() override | Mengembalikan jumlah objek dalam koleksi. Hanya-baca **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Mengembalikan nilai yang menunjukkan apakah akses ke koleksi disinkronkan (aman dari thread). Hanya-baca **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator yang mengiterasi melalui koleksi. |
...
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Mencari [ChartSeries](../chartseries/) yang ditentukan dan mengembalikan indeks berbasis nol dari kemunculan pertama dalam seluruh Koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) override | Membuat seri diagram baru dan menyisipkannya ke dalam koleksi. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../../system.collections.generic/ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Mengurutkan elemen urutan secara menaik berdasarkan nilai kunci yang dipilih oleh keySelector. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) override | Menghapus nilai yang ditentukan. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Menghapus kontrol ActiveX yang disimpan pada posisi yang ditentukan dari koleksi. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Mengurangi penghitung referensi bersama sebesar nilai yang ditentukan. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Mengatur argumen templat ke-n menjadi pointer lemah (bukan bersama). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Mengimplementasikan construct C# typeof([System.Object](../../system/object/)). |
...
| [virtualized_iterator_element](./virtualized_iterator_element/) | Tipe elemen yang di-virtualkan. |
| [virtualized_iterator](./virtualized_iterator/) | Tipe yang di-virtualkan. |

## Lihat Juga

* Kelas [DomObject](../../aspose.slides/domobject/)
* Kelas [IChartSeriesCollection](../ichartseriescollection/)
