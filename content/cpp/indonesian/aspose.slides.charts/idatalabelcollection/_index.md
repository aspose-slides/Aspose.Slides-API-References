...
| virtual **int32_t** [get_Count](./get_count/)() | Mendapatkan jumlah semua label data dalam koleksi. Hanya-baca **int32_t**. |
| virtual **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() | Mendapatkan jumlah label data yang terlihat dalam koleksi. Hanya-baca **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() | Mengembalikan format default semua label data dalam koleksi. Hanya-baca [IDataLabelFormat](../idatalabelformat/). |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | False berarti label data tidak terlihat secara default (sehingga semua flag Show*- (ShowValue, ...) dari properti DefaultDataLabelFormat menjadi false). Hanya-baca **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() | Mewakili format garis pemimpin label data. Hanya-baca [IChartLinesFormat](../ichartlinesformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() | Mengembalikan seri chart induk. Hanya-baca [IChartSeries](../ichartseries/). |
...
| virtual void [Hide](./hide/)() | Membuat label data tersembunyi secara default dengan mengatur semua flag Show*- (ShowValue, ...) dari properti DefaultDataLabelFormat ke keadaan false. IsVisible akan menjadi false setelah ini. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) | Mendapatkan label data untuk titik data dengan indeks yang ditentukan. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) | Mengembalikan indeks dari [DataLabel](../datalabel/) yang ditentukan dalam koleksi. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n sebagai weak pointer (bukan shared). Memungkinkan mengubah pointer dalam kontainer menjadi mode weak. |
...
| void [Unlock](../../system/object/unlock/)() | Menerapkan pembebasan pernyataan C# lock(). Panggil langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
