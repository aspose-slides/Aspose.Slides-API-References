...
| Metode | Deskripsi |
| --- | --- |
| void [Add](./add/)(const **int32_t**\&) override | Menambahkan titik data berdasarkan indeksnya dalam koleksi titik seri induk. |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Menambahkan titik data ke koleksi. |
...
| void [Clear](./clear/)() override | Menghapus semua item dari [ICollection](../../system.collections.generic/icollection/). |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) const override | Menentukan apakah [ICollection](../../system.collections.generic/icollection/) berisi nilai tertentu. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\>, **int32_t**) override | Menyalin elemen [ICollection](../../system.collections.generic/icollection/) ke [System::Array](../../system/array/), dimulai pada indeks [System::Array](../../system/array/) tertentu. |
...
| **int32_t** [get_Count](./get_count/)() const override | Mengembalikan jumlah titik data bagan. Hanya-baca **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Mengambil nilai yang menunjukkan apakah [ICollection](../../system.collections.generic/icollection/) bersifat hanya-baca. Hanya-baca **bool**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() | Mengembalikan nilai yang menunjukkan apakah akses ke koleksi disinkronkan (aman terhadap thread). Hanya-baca **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Mengembalikan akar sinkronisasi. Hanya-baca [System::Object](../../system/object/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\> [idx_get](./idx_get/)(**int32_t**) override | Mengembalikan titik data bagan untuk indeks yang ditentukan. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Mengubah setiap elemen urutan menjadi bentuk baru dengan mengikutsertakan indeks elemen. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPoint](../ichartdatapoint/)\>\&) override | Menghapus item dari koleksi. |
| void [Remove](./remove/)(**int32_t**) override | Menghapus item dari koleksi berdasarkan indeksnya dalam koleksi titik seri induk. |
...
* Kelas [IPieSplitCustomPointCollection](../ipiesplitcustompointcollection/)
