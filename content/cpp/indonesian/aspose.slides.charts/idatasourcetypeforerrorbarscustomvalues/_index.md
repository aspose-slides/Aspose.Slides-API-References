...
---
## IDataSourceTypeForErrorBarsCustomValues kelas
...
| virtual [DataSourceType](../datasourcetype/) [get_DataSourceTypeForXMinusValues](./get_datasourcetypeforxminusvalues/)() | Menentukan apakah properti AsCell atau AsLiteralString atau AsLiteralDouble aktual dalam objek properti XMinus pada poin data untuk nilai khusus batang kesalahan. Dengan kata lain, ini menentukan jenis nilai properti ChartDataPoint.ErrorBarsCustomValues.XMinus.Data. Baca [DataSourceType](../datasourcetype/). |
| virtual [DataSourceType](../datasourcetype/) [get_DataSourceTypeForXPlusValues](./get_datasourcetypeforxplusvalues/)() | Menentukan apakah properti AsCell atau AsLiteralString atau AsLiteralDouble aktual dalam objek properti XPlus pada poin data untuk nilai khusus batang kesalahan. Dengan kata lain, ini menentukan jenis nilai properti ChartDataPoint.ErrorBarsCustomValues.XPlus.Data. Baca [DataSourceType](../datasourcetype/). |
| virtual [DataSourceType](../datasourcetype/) [get_DataSourceTypeForYMinusValues](./get_datasourcetypeforyminusvalues/)() | Menentukan apakah properti AsCell atau AsLiteralString atau AsLiteralDouble aktual dalam objek properti YMinus pada poin data untuk nilai khusus batang kesalahan. Dengan kata lain, ini menentukan jenis nilai properti ChartDataPointEx.ErrorBarsCustomValues.YMinus.Data. Baca [DataSourceType](../datasourcetype/). |
| virtual [DataSourceType](../datasourcetype/) [get_DataSourceTypeForYPlusValues](./get_datasourcetypeforyplusvalues/)() | Menentukan apakah properti AsCell atau AsLiteralString atau AsLiteralDouble aktual dalam objek properti YPlus pada poin data untuk nilai khusus batang kesalahan. Dengan kata lain, ini menentukan jenis nilai properti ChartDataPointEx.ErrorBarsCustomValues.YPlus.Data. Baca [DataSourceType](../datasourcetype/). |
...
| virtual void [set_DataSourceTypeForXMinusValues](./set_datasourcetypeforxminusvalues/)([DataSourceType](../datasourcetype/)) | Menentukan apakah properti AsCell atau AsLiteralString atau AsLiteralDouble aktual dalam objek properti XMinus pada poin data untuk nilai khusus batang kesalahan. Dengan kata lain, ini menentukan jenis nilai properti ChartDataPoint.ErrorBarsCustomValues.XMinus.Data. Tulis [DataSourceType](../datasourcetype/). |
| virtual void [set_DataSourceTypeForXPlusValues](./set_datasourcetypeforxplusvalues/)([DataSourceType](../datasourcetype/)) | Menentukan apakah properti AsCell atau AsLiteralString atau AsLiteralDouble aktual dalam objek properti XPlus pada poin data untuk nilai khusus batang kesalahan. Dengan kata lain, ini menentukan jenis nilai properti ChartDataPoint.ErrorBarsCustomValues.XPlus.Data. Tulis [DataSourceType](../datasourcetype/). |
| virtual void [set_DataSourceTypeForYMinusValues](./set_datasourcetypeforyminusvalues/)([DataSourceType](../datasourcetype/)) | Menentukan apakah properti AsCell atau AsLiteralString atau AsLiteralDouble aktual dalam objek properti YMinus pada poin data untuk nilai khusus batang kesalahan. Dengan kata lain, ini menentukan jenis nilai properti ChartDataPointEx.ErrorBarsCustomValues.YMinus.Data. Tulis [DataSourceType](../datasourcetype/). |
| virtual void [set_DataSourceTypeForYPlusValues](./set_datasourcetypeforyplusvalues/)([DataSourceType](../datasourcetype/)) | Menentukan apakah properti AsCell atau AsLiteralString atau AsLiteralDouble aktual dalam objek properti YPlus pada poin data untuk nilai khusus batang kesalahan. Dengan kata lain, ini menentukan jenis nilai properti ChartDataPointEx.ErrorBarsCustomValues.YPlus.Data. Tulis [DataSourceType](../datasourcetype/). |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menyetel argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
