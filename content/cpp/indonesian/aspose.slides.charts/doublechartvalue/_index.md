...
description: "Mewakili nilai double yang dapat disimpan dalam dokumen presentasi pptx dengan dua cara: 1) di sel/sel-sel workbook yang terkait dengan diagram; 2) sebagai nilai literal."
type: docs
weight: 456
...
Mewakili nilai double yang dapat disimpan dalam dokumen presentasi pptx dalam dua cara: 1) dalam sel/sel-sel workbook yang terkait dengan diagram; 2) sebagai nilai literal.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [get_AsCell](./get_ascell/)() override | Mengembalikan sel data diagram. Baca [IChartDataCell](../ichartdatacell/). |
| **double** [get_AsLiteralDouble](./get_asliteraldouble/)() override | Mengembalikan nilai sebagai double literal. Baca **double**. |
...
| void [set_AsCell](./set_ascell/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) override | Menetapkan sel data diagram. Tulis [IChartDataCell](../ichartdatacell/). |
| void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) override | Menetapkan nilai sebagai double literal. Tulis **double**. |
...
| **double** [ToDouble](./todouble/)() override | Mengonversi ke **double**. |
...
* Kelas [IDoubleChartValue](../idoublechartvalue/)
