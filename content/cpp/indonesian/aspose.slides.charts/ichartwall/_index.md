...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Mengembalikan pengisian dinding, garis, efek, gaya 3d. Hanya-baca [IFormat](../iformat/). |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | Mengembalikan atau mengatur tipe gambar. Baca [PictureType](../picturetype/). |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | Mengembalikan ketebalan dinding sebagai persentase dari dimensi terbesar volume plot. Baca **int32_t**. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengizinkan penyalinan konstruktor subclass. |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | Mengembalikan atau mengatur tipe gambar. Tulis [PictureType](../picturetype/). |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | Mengatur ketebalan dinding sebagai persentase dari dimensi terbesar volume plot. Tulis **int32_t**. |
