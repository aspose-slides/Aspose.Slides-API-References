...
description: Mewakili tingkat titik data. Berlaku untuk diagram Treemap dan Sunburst.
type: docs
weight: 170
...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Mewakili properti pemformatan tingkat titik data. Baca [IFormat](../iformat/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() override | Mewakili label data tingkat titik data. Diterapkan untuk tipe seri Treemap dan Sunburst. Hanya-baca [IDataLabel](../idatalabel/). |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruktor penyalinan pada subkelas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruktor penyalinan pada subkelas. |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Menyetel argumen template ke-n menjadi pointer lemah (bukan shared). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
...
* Kelas [IChartDataPointLevel](../ichartdatapointlevel/)
