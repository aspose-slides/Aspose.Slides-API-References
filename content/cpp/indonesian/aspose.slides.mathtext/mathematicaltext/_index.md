...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Membungkus elemen matematika dalam karakter yang ditentukan seperti kurung atau karakter lain sebagai pembingkaian |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\> [get_Format](./get_format/)() override | Properti pemformatan teks |
| [System::String](../../system/string/) [get_Value](./get_value/)() override | Nilai teks |
...
|  [MathematicalText](./mathematicaltext/)() | Konstruktor default (membuat nilai String::Empty) |
|  [MathematicalText](./mathematicaltext/)(char16_t) | Membuat [MathText](../) dengan satu simbol |
|  [MathematicalText](./mathematicaltext/)([System::String](../../system/string/)) | Membuat [MathematicalText](./) dari teks |
|  [MathematicalText](./mathematicaltext/)([System::String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[IPortionFormat](../../aspose.slides/iportionformat/)\>) | Membuat [MathematicalText](./) dari teks dan pengaturan format |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruksi subkelas. |
...
| void [set_Value](./set_value/)([System::String](../../system/string/)) override | Nilai teks |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)() override | Menempatkan elemen ini dalam kotak border |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBorderBox](../imathborderbox/)\> [ToBorderBox](../mathelementbase/toborderbox/)(**bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**, **bool**) override | Menempatkan elemen ini dalam kotak border |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Menempatkan elemen ini dalam kotak non-visual (pengelompokan logis) yang digunakan untuk mengelompokkan komponen persamaan atau instance teks matematika lainnya. Objek yang dikotakkan dapat (misalnya) berfungsi sebagai emulator operator dengan atau tanpa titik penyelarasan, berfungsi sebagai titik pemutus baris, atau dikelompokkan sehingga tidak mengizinkan pemutusan baris di dalamnya. |
