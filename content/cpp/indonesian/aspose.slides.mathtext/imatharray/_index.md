...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Membungkus elemen ini dengan karakter yang ditentukan seperti tanda kurung atau karakter lain sebagai pembingkaian |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Meniru perbandingan titik mengambang gaya C# untuk double di mana dua NaN dianggap sama meskipun menurut IEC 60559:1989 NaN tidak sama dengan nilai apa pun, termasuk NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Hanya untuk keperluan internal. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Mengambil fungsi sebuah argumen menggunakan instance ini sebagai nama fungsi |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | Mengambil fungsi sebuah argumen menggunakan instance ini sebagai nama fungsi |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) | Mengembalikan item pada indeks yang ditentukan dari array. Hanya baca [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() | Kumpulan item array |
| virtual [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() | Menentukan perataan array relatif terhadap teks di sekitarnya. Teks di luar array dapat diratakan dengan bagian bawah, atas, atau tengah objek array. Nilai default: Center |
| virtual **bool** [get_MaximumDistribution](./get_maximumdistribution/)() | Distribusi Maksimum. Ketika true, array diberikan jarak hingga lebar maksimum elemen yang memuatnya (halaman, kolom, sel, dll.). |
| virtual **bool** [get_ObjectDistribution](./get_objectdistribution/)() | Distribusi Objek. Ketika true, isi array diberikan jarak hingga lebar maksimum objek array. |
| virtual **uint32_t** [get_RowSpacing](./get_rowspacing/)() | Jarak antara baris array. Hanya digunakan ketika RowSpacingRule diatur ke 3 Exact, dimana satuan ukur adalah poin, atau Multiple, dimana satuan ukur adalah setengah baris. Default: 0 |
| virtual [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() | Tipe jarak vertikal antara elemen array |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | Menempatkan elemen ini dalam grup menggunakan karakter pengelompokan seperti kurung kurawal bawah atau karakter lainnya |
...
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analog metode C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Mengizinkan kloning tipe kustom. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruktor menyalin subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruktor menyalin subclass. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Menentukan akar matematika dengan derajat tertentu dari argumen yang ditentukan. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Menentukan akar matematika dengan derajat tertentu dari argumen yang ditentukan. |
...
| virtual void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) | Menentukan perataan array relatif terhadap teks di sekitarnya. Teks di luar array dapat diratakan dengan bagian bawah, atas, atau tengah objek array. Nilai default: Center |
| virtual void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) | Distribusi Maksimum. Ketika true, array diberikan jarak hingga lebar maksimum elemen yang memuatnya (halaman, kolom, sel, dll.). |
| virtual void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) | Distribusi Objek. Ketika true, isi array diberikan jarak hingga lebar maksimum objek array. |
| virtual void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) | Jarak antara baris array. Hanya digunakan ketika RowSpacingRule diatur ke 3 Exact, dimana satuan ukur adalah poin, atau Multiple, dimana satuan ukur adalah setengah baris. Default: 0 |
| virtual void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) | Tipe jarak vertikal antara elemen array |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathArray](./)\> [ToMathArray](../imathelement/tomatharray/)() | Menempatkan dalam array vertikal |
