...
description: Paragraf matematis yang merupakan wadah untuk blok matematis (IMathBlock)
type: docs
weight: 1002
...
Paragraf matematis yang merupakan wadah untuk blok matematis ([IMathBlock](../imathblock/))
...
| Method | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Menambahkan [IMathBlock](../imathblock/) ke akhir koleksi. |
...
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Menentukan apakah koleksi berisi nilai tertentu. |
...
| [MathJustification](../mathjustification/) [get_Justification](./get_justification/)() override | [Paragraph](../../aspose.slides/paragraph/) Justifikasi Nilai Default: CenteredAsGroup |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) override | Mendapatkan item pada indeks yang ditentukan. Hanya-baca [IMathBlock](../imathblock/). |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Mendapatkan item pada indeks yang ditentukan. Hanya-baca [IMathBlock](../imathblock/). |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Menentukan indeks dari [IMathBlock](../imathblock/) tertentu dalam koleksi. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Menyisipkan [IMathBlock](../imathblock/) ke dalam koleksi pada indeks yang ditentukan. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../../system.collections.generic/ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Mengurutkan elemen-elemen dari urutan dalam urutan menurun berdasarkan nilai kunci yang dipilih oleh keySelector. |
...
|  [MathParagraph](./mathparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Menginisialisasi instance baru dari kelas [MathParagraph](./). |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Menghapus kemunculan pertama dari objek tertentu dari koleksi/>. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Menghapus item pada indeks yang ditentukan dalam koleksi. |
...
| void [set_Justification](./set_justification/)([MathJustification](../mathjustification/)) override | [Paragraph](../../aspose.slides/paragraph/) Justifikasi Nilai Default: CenteredAsGroup |
...
| [System::String](../../system/string/) [ToLatex](./tolatex/)() override | Mendapatkan persamaan matematis dalam format LaTeX. |
...
| void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Menyimpan konten [MathParagraph](./) ini sebagai MathML. |
