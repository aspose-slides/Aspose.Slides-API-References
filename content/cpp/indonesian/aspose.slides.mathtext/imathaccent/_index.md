...
description: "Menentukan fungsi aksen, terdiri dari dasar dan tanda diakritik gabungan Contoh: \\uD835\\uDC4E\\u0301"
type: docs
weight: 27
...
| Metode | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](./)\> [Accent](../imathelement/accent/)(char16_t) | Mengatur tanda aksen (karakter di bagian atas elemen ini) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Mengambil fungsi dengan argumen menggunakan instance ini sebagai nama fungsi |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | Mengambil fungsi dengan argumen menggunakan instance ini sebagai nama fungsi |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | Argumen ke mana aksen diterapkan |
| virtual char16_t [get_Character](./get_character/)() | Karakter Aksen Nilai harus berada dalam rentang (U+0300\\u2013U+036F) atau (U+20D0\\u2013U+20EF) Nilai default: Combining Circumflex Accent (U+0302) |
...
| void [Lock](../../system/object/lock/)() | Menerapkan pernyataan lock() C# untuk mengunci. Panggil secara langsung atau gunakan objek penjaga [LockContext](../../system/lockcontext/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Menentukan akar matematika dengan derajat yang diberikan dari argumen yang ditentukan. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Menentukan akar matematika dengan derajat yang diberikan dari argumen yang ditentukan. |
...
| virtual void [set_Character](./set_character/)(char16_t) | Karakter Aksen Nilai harus berada dalam rentang (U+0300\\u2013U+036F) atau (U+20D0\\u2013U+20EF) Nilai default: Combining Circumflex Accent (U+0302) |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen template ke-n menjadi pointer lemah (bukan berbagi). Memungkinkan penggantian pointer dalam kontainer ke mode lemah. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Menempatkan elemen ini dalam kotak non-visual (pengelompokan logis) yang digunakan untuk mengelompokkan komponen persamaan atau instance teks matematika lainnya. Sebuah objek dalam kotak dapat (misalnya) berfungsi sebagai emulator operator dengan atau tanpa titik aligment, berfungsi sebagai titik pemutus baris, atau dikelompokkan sehingga tidak mengizinkan pemutusan baris di dalamnya. |
...
| void [Unlock](../../system/object/unlock/)() | Menerapkan pernyataan unlock() C# untuk membuka kunci. Panggil secara langsung atau gunakan objek penjaga [LockContext](../../system/lockcontext/). |
