...
description: Menentukan sebuah array vertikal dari persamaan atau objek matematika apa pun
type: docs
weight: 638
...
Menentukan sebuah array vertikal dari persamaan atau objek matematika apa pun
...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../mathelementbase/accent/)(char16_t) override | Mengatur tanda aksen (karakter di bagian atas elemen ini) |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Mengambil fungsi yang ditentukan dengan menggunakan instance ini sebagai argumen |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([System::String](../../system/string/)) override | Mengambil fungsi yang ditentukan dengan menggunakan instance ini sebagai argumen |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [AsArgumentOfFunction](../mathelementbase/asargumentoffunction/)([MathFunctionsOfOneArgument](../mathfunctionsofoneargument/)) override | Mengambil fungsi yang ditentukan dengan menggunakan instance ini sebagai argumen |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) override | Membuat fraksi dengan tipe yang ditentukan dengan pembilang ini dan penyebut yang ditentukan |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) override | Membuat fraksi dengan tipe yang ditentukan dengan pembilang ini dan penyebut yang ditentukan |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Membungkus elemen matematika dalam karakter yang ditentukan seperti tanda kurung atau karakter lain sebagai bingkai |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Mengambil fungsi argumen dengan menggunakan instance ini sebagai nama fungsi |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::String](../../system/string/)) override | Mengambil fungsi argumen dengan menggunakan instance ini sebagai nama fungsi |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) override | Mengembalikan item pada indeks yang ditentukan dari array. Baca-saja [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() override | Sekumpulan item dari array |
| [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() override | Menentukan perataan array relatif terhadap teks sekitarnya. Teks di luar array dapat disejajarkan dengan bagian bawah, atas, atau tengah objek array. Nilai default: Tengah |
| **bool** [get_MaximumDistribution](./get_maximumdistribution/)() override | Distribusi Maksimum. Ketika benar, array diberi jarak hingga lebar maksimum elemen yang memuatnya (halaman, kolom, sel, dll.). |
| **bool** [get_ObjectDistribution](./get_objectdistribution/)() override | Distribusi Objek. Ketika benar, konten array diberi jarak hingga lebar maksimum objek array. |
| **uint32_t** [get_RowSpacing](./get_rowspacing/)() override | Jarak antar baris dalam array. Hanya digunakan ketika RowSpacingRule diatur ke 3, tepatnya dalam kasus unit pengukuran adalah poin atau Multiple dalam kasus unit pengukuran adalah setengah baris. Nilai default: 0 |
| [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() override | Jenis jarak vertikal antar elemen array. Default: SingleLineGap |
...
| void [Lock](../../system/object/lock/)() | Menerapkan pernyataan lock() C#. Panggil secara langsung atau gunakan objek penjaga [LockContext](../../system/lockcontext/). |
| [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Membuat array matematika dan menempatkan elemen yang ditentukan di dalamnya |
| [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>\>\>) | Membuat array matematika dan menempatkan elemen-elemen yang ditentukan di dalamnya |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruksi subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruksi subclass. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Menentukan akar matematika dengan pangkat tertentu dari argumen yang diberikan. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | Menentukan akar matematika dengan pangkat tertentu dari argumen yang diberikan. |
...
| void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) override | Menentukan perataan array relatif terhadap teks sekitarnya. Teks di luar array dapat disejajarkan dengan bagian bawah, atas, atau tengah objek array. Nilai default: Tengah |
| void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) override | Distribusi Maksimum. Ketika benar, array diberi jarak hingga lebar maksimum elemen yang memuatnya (halaman, kolom, sel, dll.). |
| void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) override | Distribusi Objek. Ketika benar, konten array diberi jarak hingga lebar maksimum objek array. |
| void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) override | Jarak antar baris dalam array. Hanya digunakan ketika RowSpacingRule diatur ke 3, tepatnya dalam kasus unit pengukuran adalah poin atau Multiple dalam kasus unit pengukuran adalah setengah baris. Nilai default: 0 |
| void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) override | Jenis jarak vertikal antar elemen array. Default: SingleLineGap |
...
| void [Unlock](../../system/object/unlock/)() | Menerapkan pernyataan unlock() C#. Panggil secara langsung atau gunakan objek penjaga [LockContext](../../system/lockcontext/). |
