...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](./)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Membuat pecahan dengan pembilang ini dan penyebut yang ditentukan |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](./)\> [Divide](../imathelement/divide/)([System::String](../../system/string/)) | Membuat pecahan dengan pembilang ini dan penyebut yang ditentukan |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](./)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) | Membuat pecahan tipe yang ditentukan dengan pembilang ini dan penyebut yang ditentukan |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](./)\> [Divide](../imathelement/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) | Membuat pecahan tipe yang ditentukan dengan pembilang ini dan penyebut yang ditentukan |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Denominator](./get_denominator/)() | Penyebut |
| virtual [MathFractionTypes](../mathfractiontypes/) [get_FractionType](./get_fractiontype/)() | Tipe pecahan Default: Bar |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Numerator](./get_numerator/)() | Pembilang |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | Menempatkan elemen ini dalam grup menggunakan karakter pengelompok seperti kurung kurawal bawah atau karakter lain |
...
| void [Lock](../../system/object/lock/)() | Menerapkan pernyataan lock() C# untuk mengunci. Panggil secara langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
...
| virtual void [set_FractionType](./set_fractiontype/)([MathFractionTypes](../mathfractiontypes/)) | Tipe pecahan Default: Bar |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambahkan hitungan referensi lemah. Tidak boleh dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
