...
description: Menentukan fungsi radikal, terdiri dari basis, dan derajat opsional. Contoh objek radikal adalah \\u221A\\uD835\\uDC65.
type: docs
weight: 1054
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Degree](./get_degree/)() override | Argumen derajat |
| **bool** [get_HideDegree](./get_hidedegree/)() override | Sembunyikan derajat. Ketika true, derajat tidak ditampilkan, seperti pada \\u221A\\uD835\\uDC65 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | Menempatkan elemen ini dalam grup menggunakan karakter pengelompokan seperti kurung kurawal bawah atau lainnya |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan lock() C# untuk penguncian. Panggil secara langsung atau gunakan [LockContext](../../system/lockcontext/) sentry object. |
|  [MathRadical](./mathradical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Menginisialisasi instance baru dari kelas [MathRadical](./). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruktor pada subkelas. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Menentukan akar matematika dengan derajat yang diberikan dari argumen yang ditentukan. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | Menentukan akar matematika dengan derajat yang diberikan dari argumen yang ditentukan. |
...
| void [set_HideDegree](./set_hidedegree/)(**bool**) override | Sembunyikan derajat. Ketika true, derajat tidak ditampilkan, seperti pada \\u221A\\uD835\\uDC65 |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Menambah penghitung referensi bersama. Tidak boleh dipanggil secara langsung; sebaiknya gunakan smart pointers atau ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Mengurangi dan mengembalikan penghitung referensi bersama. Tidak boleh dipanggil secara langsung; sebaiknya gunakan smart pointers atau ThisProtector. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan lock() C# untuk membuka kunci. Panggil secara langsung atau gunakan [LockContext](../../system/lockcontext/) sentry object. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah penghitung referensi lemah. Tidak boleh dipanggil secara langsung; sebaiknya gunakan smart pointers atau ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Mengurangi penghitung referensi lemah. Tidak boleh dipanggil secara langsung; sebaiknya gunakan smart pointers atau ThisProtector. |
