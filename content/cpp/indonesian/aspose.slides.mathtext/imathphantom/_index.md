...
description: "Mewakili objek matematika phantom (<m:phant>) yang memengaruhi tata letak elemen anaknya tanpa harus menampilkannya. Sebuah phantom dapat menyembunyikan ekspresi dasarnya sambil mempertahankan lebar, tinggi, atau kedalamannya untuk menyelaraskan formula atau memesan ruang. Visibilitas dan perilaku geometri dikontrol oleh properti seperti Show, ZeroWid, ZeroAsc, ZeroDesc, dan Transp."
type: docs
weight: 482
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Mengemulasi perbandingan titik mengambang gaya C# dimana dua NaN dianggap sama meskipun menurut IEC 60559:1989 NaN tidak sama dengan nilai apapun, termasuk NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Mengemulasi perbandingan titik mengambang gaya C# dimana dua NaN dianggap sama meskipun menurut IEC 60559:1989 NaN tidak sama dengan nilai apapun, termasuk NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | Hanya untuk keperluan internal. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Mengambil fungsi dari sebuah argumen menggunakan instance ini sebagai nama fungsi |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | Mengambil fungsi dari sebuah argumen menggunakan instance ini sebagai nama fungsi |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | Argumen dasar |
| virtual **bool** [get_Show](./get_show/)() | Mendapatkan nilai yang menunjukkan apakah elemen dasar ditampilkan. |
| virtual **bool** [get_Transp](./get_transp/)() | Mendapatkan nilai yang menunjukkan apakah phantom transparan untuk aturan spasi berbasis kelas. |
| virtual **bool** [get_ZeroAsc](./get_zeroasc/)() | Mendapatkan nilai yang menunjukkan apakah kenaikan (tinggi di atas garis dasar) elemen dasar harus diperlakukan sebagai nol. |
| virtual **bool** [get_ZeroDesc](./get_zerodesc/)() | Mendapatkan nilai yang menunjukkan apakah penurunan (kedalaman di bawah garis dasar) elemen dasar harus diperlakukan sebagai nol. |
| virtual **bool** [get_ZeroWidth](./get_zerowidth/)() | Mendapatkan nilai yang menunjukkan apakah lebar elemen dasar harus diperlakukan sebagai nol. |
...
| void [Lock](../../system/object/lock/)() | Menerapkan pernyataan lock() C# untuk penguncian. Panggil langsung atau gunakan objek pengawal [LockContext](../../system/lockcontext/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Menentukan akar matematika dengan pangkat tertentu dari argumen yang ditentukan. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Menentukan akar matematika dengan pangkat tertentu dari argumen yang ditentukan. |
...
| virtual void [set_Show](./set_show/)(**bool**) | Menetapkan nilai yang menunjukkan apakah elemen dasar ditampilkan. |
| virtual void [set_Transp](./set_transp/)(**bool**) | Menetapkan nilai yang menunjukkan apakah phantom transparan untuk aturan spasi berbasis kelas. |
| virtual void [set_ZeroAsc](./set_zeroasc/)(**bool**) | Menetapkan nilai yang menunjukkan apakah kenaikan (tinggi di atas garis dasar) elemen dasar harus diperlakukan sebagai nol. |
| virtual void [set_ZeroDesc](./set_zerodesc/)(**bool**) | Menetapkan nilai yang menunjukkan apakah penurunan (kedalaman di bawah garis dasar) elemen dasar harus diperlakukan sebagai nol. |
| virtual void [set_ZeroWidth](./set_zerowidth/)(**bool**) | Menetapkan nilai yang menunjukkan apakah lebar elemen dasar harus diperlakukan sebagai nol. |
...
| void [Unlock](../../system/object/unlock/)() | Menerapkan pernyataan unlock() C# untuk membuka kunci. Panggil langsung atau gunakan objek pengawal [LockContext](../../system/lockcontext/). |
...
phantom->set_Show(false); // Sembunyikan konten
phantom->set_ZeroWidth(false); // Pertahankan lebar
```
