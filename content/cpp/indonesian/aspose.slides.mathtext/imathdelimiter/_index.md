...
description: "Menentukan objek pembatas, terdiri dari karakter pembuka dan penutup (seperti tanda kurung, kurung kurawal, kurung siku, dan garis vertikal), serta satu atau lebih elemen matematika di dalamnya, dipisahkan oleh karakter yang ditentukan. Contoh: (\\uD835\\uDC652); [\\uD835\\uDC652|\\uD835\\uDC662]"
type: docs
weight: 196
...
Menentukan objek pembatas, terdiri dari karakter pembuka dan penutup (seperti tanda kurung, kurung kurawal, kurung siku, dan garis vertikal), serta satu atau lebih elemen matematika di dalamnya, dipisahkan oleh karakter yang ditentukan. Contoh: (\\uD835\\uDC652); [\\uD835\\uDC652|\\uD835\\uDC662]
...
| Metode | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../imathelement/accent/)(char16_t) | Mengatur tanda aksen (karakter pada bagian atas elemen ini) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](./)\> [Delimit](./delimit/)(char16_t) | Membatasi argumen menggunakan karakter pembatas yang ditentukan |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) | Membuat pecahan tipe yang ditentukan dengan pembilang ini dan penyebut yang ditentukan |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../imathelement/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) | Membuat pecahan tipe yang ditentukan dengan pembilang ini dan penyebut yang ditentukan |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](./)\> [Enclose](../imathelement/enclose/)() | Membungkus elemen matematika dalam tanda kurung |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](./)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Membungkus elemen ini dengan karakter yang ditentukan seperti tanda kurung atau karakter lain sebagai bingkai |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) | Mengembalikan elemen matematika pada indeks yang ditentukan dalam array. Hanya-baca [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() | Satu atau lebih elemen matematika yang dipisahkan oleh karakter pembatas |
| virtual char16_t [get_BeginningCharacter](./get_beginningcharacter/)() | Karakter Awal Pembatas menentukan karakter pembatas awal, atau pembuka. Pembatas matematika adalah karakter penutup seperti tanda kurung, kurung siku, dan kurung kurawal. Nilai default: '('. |
| virtual [MathDelimiterShape](../mathdelimitershape/) [get_DelimiterShape](./get_delimitershape/)() | Menentukan bentuk pembatas dalam objek pembatas. Ketika [MathDelimiterShape::Centered](../mathdelimitershape/), pembatas diposisikan di tengah sumbu matematika dari teks matematika dan masih dapat disesuaikan agar menutupi seluruh tinggi kontennya. Ketika [MathDelimiterShape::Match](../mathdelimitershape/), tinggi dan bentuknya diubah agar cocok persis dengan kontennya. |
| virtual char16_t [get_EndingCharacter](./get_endingcharacter/)() | Karakter Akhir Pembatas menentukan karakter pembatas akhir, atau penutup. Pembatas matematika adalah karakter penutup seperti tanda kurung, kurung siku, dan kurung kurawal. Nilai default: ')'. |
| virtual **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() | Menentukan pertumbuhan KarakterAwal, KarakterPemisor, KarakterAkhir. Ketika true, pembatas tumbuh secara vertikal untuk menyesuaikan tinggi operannya. Nilai default true |
| virtual char16_t [get_SeparatorCharacter](./get_separatorcharacter/)() | Karakter Pemisor Pembatas menentukan karakter yang memisahkan argumen dalam objek pembatas. Nilai default: '|'. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | Menempatkan elemen ini dalam grup menggunakan karakter pengelompokan seperti kurung kurawal bawah atau lainnya |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan lock() C# untuk mengunci. Panggil langsung atau gunakan objek pengaman [LockContext](../../system/lockcontext/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBar](../imathbar/)\> [Overbar](../imathelement/overbar/)() | Menetapkan bar di bagian atas elemen ini |
...
| virtual void [set_BeginningCharacter](./set_beginningcharacter/)(char16_t) | Karakter Awal Pembatas menentukan karakter pembatas awal, atau pembuka. Pembatas matematika adalah karakter penutup seperti tanda kurung, kurung siku, dan kurung kurawal. Nilai default: '('. |
| virtual void [set_DelimiterShape](./set_delimitershape/)([MathDelimiterShape](../mathdelimitershape/)) | Menentukan bentuk pembatas dalam objek pembatas. Ketika [MathDelimiterShape::Centered](../mathdelimitershape/), pembatas diposisikan di tengah sumbu matematika dari teks matematika dan masih dapat disesuaikan agar menutupi seluruh tinggi kontennya. Ketika [MathDelimiterShape::Match](../mathdelimitershape/), tinggi dan bentuknya diubah agar cocok persis dengan kontennya. |
| virtual void [set_EndingCharacter](./set_endingcharacter/)(char16_t) | Karakter Akhir Pembatas menentukan karakter pembatas akhir, atau penutup. Pembatas matematika adalah karakter penutup seperti tanda kurung, kurung siku, dan kurung kurawal. Nilai default: ')'. |
| virtual void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) | Menentukan pertumbuhan KarakterAwal, KarakterPemisor, KarakterAkhir. Ketika true, pembatas tumbuh secara vertikal untuk menyesuaikan tinggi operannya. Nilai default true |
| virtual void [set_SeparatorCharacter](./set_separatorcharacter/)(char16_t) | Karakter Pemisor Pembatas menentukan karakter yang memisahkan argumen dalam objek pembatas. Nilai default: '|'. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen templat ke- n sebagai weak pointer (bukan shared). Mengizinkan mengubah pointer dalam kontainer ke mode weak. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan lock() C# untuk membuka kunci. Panggil langsung atau gunakan objek pengaman [LockContext](../../system/lockcontext/). |
