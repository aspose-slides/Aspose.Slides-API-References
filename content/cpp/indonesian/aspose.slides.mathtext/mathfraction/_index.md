...
description: Menentukan objek pecahan, yang terdiri dari pembilang dan penyebut yang dipisahkan oleh garis pecahan. Garis pecahan dapat horizontal atau diagonal, tergantung pada properti pecahan. Objek pecahan juga digunakan untuk merepresentasikan fungsi stack, yang menempatkan satu elemen di atas elemen lain, tanpa garis pecahan.
type: docs
weight: 833
...
Menentukan objek pecahan, yang terdiri dari pembilang dan penyebut yang dipisahkan oleh garis pecahan. Garis pecahan dapat horizontal atau diagonal, tergantung pada properti pecahan. Objek pecahan juga digunakan untuk merepresentasikan fungsi stack, yang menempatkan satu elemen di atas elemen lain, tanpa garis pecahan.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Membungkus elemen matematika dalam karakter yang ditentukan seperti kurung atau karakter lain sebagai bingkai |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Mengambil fungsi argumen menggunakan instance ini sebagai nama fungsi |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../mathelementbase/function/)([System::String](../../system/string/)) override | Mengambil fungsi argumen menggunakan instance ini sebagai nama fungsi |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Denominator](./get_denominator/)() override | Penyebut |
| [MathFractionTypes](../mathfractiontypes/) [get_FractionType](./get_fractiontype/)() override | Tipe pecahan Default: Bar |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Numerator](./get_numerator/)() override | Pembilang |
...
|  [MathFraction](./mathfraction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) | Menginisialisasi [MathFraction](./) dengan pembilang, penyebut, dan tipe yang ditentukan |
|  [MathFraction](./mathfraction/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Menginisialisasi [MathFraction](./) tipe 'Bar' dengan pembilang dan penyebut yang ditentukan |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruk penyalinan subkelas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruk penyalinan subkelas. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Menentukan akar matematis dari pangkat yang diberikan dari argumen yang ditentukan. |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](../imathradical/)\> [Radical](../mathelementbase/radical/)([System::String](../../system/string/)) override | Menentukan akar matematis dari pangkat yang diberikan dari argumen yang ditentukan. |
...
| void [set_FractionType](./set_fractiontype/)([MathFractionTypes](../mathfractiontypes/)) override | Tipe pecahan Default: Bar |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Menambah hitungan referensi bersama. Seharusnya tidak dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Menempatkan elemen ini dalam kotak non-visual (pengelompokan logis) yang digunakan untuk mengelompokkan komponen persamaan atau instansi teks matematika lainnya. Objek berkotak dapat (misalnya) berfungsi sebagai emulator operator dengan atau tanpa titik penyelarasan, berfungsi sebagai titik putus baris, atau dikelompokkan sehingga tidak mengizinkan pemisahan baris di dalamnya. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah hitungan referensi lemah. Seharusnya tidak dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Mengurangi hitungan referensi lemah. Seharusnya tidak dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
