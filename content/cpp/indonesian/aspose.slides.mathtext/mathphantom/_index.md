...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](../imathaccent/)\> [Accent](../mathelementbase/accent/)(char16_t) override | Menetapkan tanda aksen (karakter pada bagian atas elemen ini) |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Membuat sebuah pecahan dengan pembilang ini dan penyebut yang ditentukan |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::String](../../system/string/)) override | Membuat sebuah pecahan dengan pembilang ini dan penyebut yang ditentukan |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [MathFractionTypes](../mathfractiontypes/)) override | Membuat pecahan dengan tipe yang ditentukan menggunakan pembilang ini dan penyebut yang ditentukan |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathFraction](../imathfraction/)\> [Divide](../mathelementbase/divide/)([System::String](../../system/string/), [MathFractionTypes](../mathfractiontypes/)) override | Membuat pecahan dengan tipe yang ditentukan menggunakan pembilang ini dan penyebut yang ditentukan |
...
| **bool** [get_Show](./get_show/)() override | Mendapatkan nilai yang menunjukkan apakah elemen dasar ditampilkan. |
| **bool** [get_Transp](./get_transp/)() override | Mendapatkan nilai yang menunjukkan apakah phantom transparan untuk aturan spasi berbasis kelas. |
| **bool** [get_ZeroAsc](./get_zeroasc/)() override | Mendapatkan nilai yang menunjukkan apakah kenaikan (tinggi di atas garis dasar) elemen dasar harus dianggap nol. |
| **bool** [get_ZeroDesc](./get_zerodesc/)() override | Mendapatkan nilai yang menunjukkan apakah penurunan (kedalaman di bawah garis dasar) elemen dasar harus dianggap nol. |
| **bool** [get_ZeroWidth](./get_zerowidth/)() override | Mendapatkan nilai yang menunjukkan apakah lebar elemen dasar harus dianggap nol. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | Menempatkan elemen ini dalam grup menggunakan karakter pengelompokkan seperti kurung kurawal bawah atau karakter lain |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [Join](../mathelementbase/join/)([System::String](../../system/string/)) override | Menggabungkan elemen matematis dan membentuk blok matematis. |
...
|  [MathPhantom](./mathphantom/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Menginisialisasi instance baru dari kelas [MathPhantom](./) menggunakan elemen matematika dasar yang ditentukan. |
...
| void [set_Show](./set_show/)(**bool**) override | Menetapkan nilai yang menunjukkan apakah elemen dasar ditampilkan. |
| void [set_Transp](./set_transp/)(**bool**) override | Menetapkan nilai yang menunjukkan apakah phantom transparan untuk aturan spasi berbasis kelas. |
| void [set_ZeroAsc](./set_zeroasc/)(**bool**) override | Menetapkan nilai yang menunjukkan apakah kenaikan (tinggi di atas garis dasar) elemen dasar harus dianggap nol. |
| void [set_ZeroDesc](./set_zerodesc/)(**bool**) override | Menetapkan nilai yang menunjukkan apakah penurunan (kedalaman di bawah garis dasar) elemen dasar harus dianggap nol. |
| void [set_ZeroWidth](./set_zerowidth/)(**bool**) override | Menetapkan nilai yang menunjukkan apakah lebar elemen dasar harus dianggap nol. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-nth menjadi weak pointer (bukan shared). Memungkinkan mengganti pointer dalam kontainer ke mode weak. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Menempatkan elemen ini dalam kotak non-visual (pengelompokan logis) yang digunakan untuk mengelompokkan komponen persamaan atau contoh teks matematis lainnya. Objek dalam kotak dapat (misalnya) berfungsi sebagai emulator operator dengan atau tanpa titik penjajaran, berfungsi sebagai titik jeda baris, atau dikelompokkan sehingga tidak mengizinkan jeda baris di dalamnya. |
...
| void [Unlock](../../system/object/unlock/)() | Menerapkan pernyataan C# lock() untuk membuka kunci. Panggil langsung atau gunakan objek penjaga [LockContext](../../system/lockcontext/). |
...
* Kelas [IMathPhantom](../imathphantom/)
