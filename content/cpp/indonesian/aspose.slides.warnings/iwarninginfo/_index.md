...
| virtual [System::String](../../system/string/) [get_Description](./get_description/)() | Mengembalikan deskripsi yang dapat dibaca manusia dari peringatan ini. Hanya-baca [System::String](../../system/string/). |
| virtual [Aspose::Slides::Warnings::WarningType](../warningtype/) [get_WarningType](./get_warningtype/)() | Mengembalikan jenis peringatan. Hanya-baca [IWarningInfo::get_WarningType](./get_warningtype/). |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan penguncian pernyataan C# lock(). Panggil secara langsung atau gunakan objek pengawal [LockContext](../../system/lockcontext/). |
...
| virtual void [SendWarning](./sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Jika penerima tidak null, mengakhiri peringatan ke penerima tertentu dan melempar AbortRequestedException jika penerima memutuskan untuk membatalkan operasi. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pembukaan kunci pernyataan C# lock(). Panggil secara langsung atau gunakan objek pengawal [LockContext](../../system/lockcontext/). |
