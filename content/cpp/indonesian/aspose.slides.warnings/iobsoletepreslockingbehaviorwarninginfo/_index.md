...
description: Peringatan ini menunjukkan bahwa perilaku penguncian presentasi yang usang sedang digunakan.
type: docs
weight: 27
url: /id/aspose.slides.warnings/iobsoletepreslockingbehaviorwarninginfo/
---
## IObsoletePresLockingBehaviorWarningInfo kelas

Peringatan ini menunjukkan bahwa perilaku penguncian presentasi yang usang sedang digunakan.
...
| virtual void [SendWarning](../iwarninginfo/sendwarning/)([System::SharedPtr](../../system/sharedptr/)\<[IWarningCallback](../iwarningcallback/)\>) | Jika receiver tidak null mengakhiri peringatan ke receiver yang ditentukan dan melempar AbortRequestedException jika receiver memutuskan untuk menghentikan operasi. |
