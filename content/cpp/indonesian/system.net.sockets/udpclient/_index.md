...
| Metode | Deskripsi |
| --- | --- |
| void [Close](./close/)() | Menutup koneksi UDP. |
| void [Connect](./connect/)([String](../../system/string/), **int32_t**) | Membuat koneksi ke port yang ditentukan pada host yang ditentukan. |
| void [Connect](./connect/)([System::SharedPtr](../../system/sharedptr/)\<[IPAddress](../../system.net/ipaddress/)\>, **int32_t**) | Membuat koneksi dengan host pada alamat yang ditentukan di port yang ditentukan. |
| void [Connect](./connect/)([System::SharedPtr](../../system/sharedptr/)\<[IPEndPoint](../../system.net/ipendpoint/)\>) | Membuat koneksi ke titik akhir remote. |
| void [Dispose](./dispose/)() override | Melepaskan sumber daya terkelola dan tidak terkelola yang digunakan oleh [UdpClient](./). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Socket](../socket/)\> [get_Client](./get_client/)() | Digunakan untuk menyediakan soket jaringan yang mendasari. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [Receive](./receive/)([System::SharedPtr](../../system/sharedptr/)\<[IPEndPoint](../../system.net/ipendpoint/)\>\&) | Mengembalikan datagram yang dikirim oleh server. |
...
| **int32_t** [Send](./send/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IPEndPoint](../../system.net/ipendpoint/)\>) | Mengirim datagram UDP ke host pada titik akhir remote. |
| **int32_t** [Send](./send/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, [String](../../system/string/), **int32_t**) | Mengirim datagram UDP ke port yang ditentukan pada host remote yang ditentukan. |
| **int32_t** [Send](./send/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**) | Mengirim datagram UDP ke host remote. |
| void [set_Client](./set_client/)([System::SharedPtr](../../system/sharedptr/)\<[Socket](../socket/)\>) | Digunakan untuk menyediakan soket jaringan yang mendasari. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Menambah penghitung referensi bersama. Tidak boleh dipanggil langsung; sebaiknya gunakan smart pointer atau ThisProtector. |
...
|  [UdpClient](./udpclient/)([AddressFamily](../addressfamily/)) | Menginisialisasi instance baru dari kelas [UdpClient](./). |
|  [UdpClient](./udpclient/)(**int32_t**) | Menginisialisasi instance baru dari kelas [UdpClient](./). |
|  [UdpClient](./udpclient/)(**int32_t**, [AddressFamily](../addressfamily/)) | Menginisialisasi instance baru dari kelas [UdpClient](./). |
|  [UdpClient](./udpclient/)([System::SharedPtr](../../system/sharedptr/)\<[IPEndPoint](../../system.net/ipendpoint/)\>) | Menginisialisasi instance baru dari kelas [UdpClient](./). param local EP titik akhir lokal tempat Anda mengikat koneksi UDP. |
|  [UdpClient](./udpclient/)([String](../../system/string/), **int32_t**) | Membuat instance baru dari kelas [UdpClient](./) dan menghubungkan ke host remote yang ditentukan pada port yang ditentukan. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah penghitung referensi lemah. Tidak boleh dipanggil langsung; sebaiknya gunakan smart pointer atau ThisProtector. |
