...
description: Mendefinisikan implementasi Tuple tujuan umum yang memungkinkan akses ke anggota instance Tuple tanpa mengetahui tipe Tuple yang mendasari.
type: docs
weight: 53
url: /id/system.runtime.compilerservices/ituple/
---
## ITuple kelas

Mendefinisikan implementasi [Tuple](../../system/tuple/) tujuan umum yang memungkinkan akses ke anggota instance [Tuple](../../system/tuple/) tanpa mengetahui tipe [Tuple](../../system/tuple/) yang mendasari.
...
| virtual **int32_t** [get_Length](./get_length/)() const | Mengembalikan jumlah posisi dalam struktur data ini. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [idx_get](./idx_get/)(**int32_t**) const | Mengembalikan elemen pada indeks posisi. |
