...
type: docs
weight: 92
url: /id/system.collections.generic/baseset/
---
## BaseSet kelas
...
| void [Add](./add/)(const T\&) override | Menambahkan elemen ke dalam set. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Mendapatkan iterator ke elemen pertama dari koleksi yang bersifat const. |
...
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Mendapatkan iterator ke elemen pertama yang bersifat const dalam koleksi. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Mendapatkan iterator untuk elemen const yang tidak ada di belakang akhir koleksi. |
| void [Clear](./clear/)() override | Menghapus semua elemen dalam set. |
| **bool** [Contains](./contains/)(const T\&) const override | Memeriksa apakah elemen ada dalam set. |
| void [CopyTo](./copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Menyalin isi hash ke dalam elemen array yang ada. |
| [set_t](./set_t/)\& [data](./data/)() | Akses ke struktur data dasar. |
| const [set_t](./set_t/)\& [data](./data/)() const | Akses ke struktur data dasar. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Mendapatkan iterator untuk elemen yang tidak ada di belakang akhir koleksi yang bersifat const. |
...
| int [get_Count](./get_count/)() const override | Mendapatkan jumlah elemen dalam set. |
| virtual int [get_Count](./get_count/)() const | Menjaga [get_Count()](./get_count/) agar tidak tersembunyi. |
...
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Membuat enumerator. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Mengurutkan elemen urutan secara naik menurut nilai kunci yang dipilih oleh keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Mengurutkan elemen urutan secara turun menurut nilai kunci yang dipilih oleh keySelector. |
...
| **bool** [Remove](./remove/)(const T\&) override | Menghapus elemen dari set. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Mengurangi penghitung referensi bersama sebesar nilai yang ditentukan. |
| [RTTI_INFO_TEMPLATE_CLASS](./rtti_info_template_class/)([ThisType](./thistype/), System::BaseTypesInfo\<[System::Object](../../system/object/)\>) | Informasi RTTI. |
...
| **bool** [TryAdd](./tryadd/)(const T\&) | Menambahkan elemen ke dalam set. |
...
| virtual  [~ICollection](../icollection/~icollection/)() | Penghancur. |
...
| [IEnumerablePtr](./ienumerableptr/) | Penunjuk antarmuka enumerable. |
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator** penunjuk. |
