...
description: "Definisi enumerator untuk membungkus tipe bergaya STL agar dapat digunakan seperti C#. Tidak membuat asumsi tentang struktur kontainer kecuali keberadaan iterator berurutan. Menggunakan fungsi begin() dan end(). Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan waktu jalan dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer tersebut untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 66
url: /id/system.collections.generic/baseenumerator/
---
## Kelas BaseEnumerator
...
| [BaseEnumerator](./baseenumerator/)(const [Object::ptr](../../system/object/ptr/)\&, Container\&) | Menginisialisasi iterator. |
| System::Details::VirtualizedIteratorBase\<T\> * [CloneIterator](../ienumerator/cloneiterator/)() const override | Mengkloning iterator saat ini. |
...
| virtual [MakeConstRef_t](../../system/makeconstref_t/)\<T\> [get_Current](../ienumerator/get_current/)() const | Mendapatkan elemen saat ini. |
...
| void [IncrementIterator](../ienumerator/incrementiterator/)() override | Membawa iterator satu langkah maju. |
| void [InitializeIterator](../ienumerator/initializeiterator/)() override | Melakukan pemanggilan [MoveNext()](../ienumerator/movenext/) pertama dan mempersiapkan objek enumerator untuk digunakan oleh VirtualizedIterator. |
...
| **bool** [MoveNext](./movenext/)() override | Inkrement gaya enumerator. |
