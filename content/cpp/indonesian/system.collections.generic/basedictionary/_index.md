...
| Metode | Deskripsi |
| --- | --- |
| void [_add_range](./_add_range/)(std::initializer_list\<typename Map::value_type\>) | Spesifik C++. |
| void [Add](./add/)(const key_t\&, const mapped_t\&) override | Menambahkan pasangan kunci-nilai ke dalam kamus. |
| [BaseDictionary](./basedictionary/)() | Membuat struktur data kosong. |
| [BaseDictionary](./basedictionary/)(int, const Args\&...) | Konstruktor forwarding untuk meneruskan argumen ke konstruktor peta mendasar. |
| [BaseDictionary](./basedictionary/)([BaseType](./basetype/) *, const Args\&...) | Konstruktor penyalinan. |
| [BaseDictionary](./basedictionary/)([BaseType](./basetype/) *) | Konstruktor penyalinan. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Mengembalikan iterator ke pembungkus KVPair untuk elemen kunci-nilai dari kontainer. Diimplementasikan dalam gaya C# - iterator harus mengembalikan objek KVPair dengan antarmuka get_Key() dan get_Value(). Jika kontainer kosong, iterator yang dikembalikan akan sama dengan [end()](../ienumerable/end/). |
...
| stl_const_iterator [cbegin](./cbegin/)() const | Mengembalikan iterator ke elemen pertama dari kontainer. Diimplementasikan dalam gaya STL. Jika kontainer kosong, iterator yang dikembalikan akan sama dengan [end()](../ienumerable/end/). |
| stl_const_iterator [cend](./cend/)() const | Mengembalikan iterator ke elemen yang mengikuti elemen terakhir dari kontainer. Diimplementasikan dalam gaya STL. Elemen ini berfungsi sebagai placeholder; mencoba mengaksesnya mengakibatkan perilaku tak terdefinisi. |
| void [Clear](./clear/)() override | Menghapus semua elemen. |
| **bool** [ContainsKey](./containskey/)(const key_t\&) const override | Memeriksa apakah kunci ada di dalam kamus. |
| **bool** [ContainsValue](./containsvalue/)(const mapped_t\&) | Memeriksa apakah nilai ada di dalam kamus. Menggunakan operator == untuk membandingkan nilai. |
| void [CopyTo](../idictionary/copyto/)([ArrayPtr](../../system/arrayptr/)\<[KeyValuePair](../keyvaluepair/)\<TKey, TValue\>\>, int) override | Menyalin isi kamus ke elemen array yang sudah ada. |
| Map\& [data](./data/)() | Pengakses penyimpanan data dasar. |
| const Map\& [data](./data/)() const | Pengakses penyimpanan data dasar. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Mengembalikan iterator ke pembungkus KVPair untuk elemen kunci-nilai yang mengikuti elemen terakhir dari kontainer. Diimplementasikan dalam gaya C# - iterator harus mengembalikan objek KVPair dengan antarmuka get_Key() dan get_Value(). Elemen ini berfungsi sebagai placeholder; mencoba mengaksesnya mengakibatkan perilaku tak terdefinisi. |
...
| **int32_t** [get_Count](./get_count/)() const override | Mendapatkan jumlah elemen. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[KeyValuePair](../keyvaluepair/)\<key_t, mapped_t\>\>\> [GetEnumerator](./getenumerator/)() | Membuat instance enumerator, harus diimplementasikan oleh subclass. |
...
| mapped_t [GetValueOrDefault](./getvalueordefault/)(const key_t\&) const override | Mengembalikan nilai jika ditemukan; atau **Value()** jika tidak. |
| mapped_t [GetValueOrDefault](./getvalueordefault/)(const key_t\&, const mapped_t\&) const override | Mengembalikan nilai jika ditemukan; atau **defaultValue** jika tidak. |
| mapped_t [GetValueOrNull](./getvalueornull/)(const key_t\&) const override | Mengembalikan nilai jika ditemukan; atau **null** jika tidak. Hanya masuk akal untuk tipe referensi. |
...
| mapped_t [idx_get](./idx_get/)(const key_t\&) const override | Fungsi getter dengan kunci. |
| void [idx_set](./idx_set/)(const key_t\&, mapped_t) override | Fungsi setter dengan kunci. Mengubah atau membuat elemen. |
...
| T [LINQ_Aggregate](../ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | Menerapkan fungsi akumulator pada suatu urutan. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Mengurutkan elemen dalam urutan secara naik berdasarkan nilai kunci yang dipilih oleh keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Mengurutkan elemen dalam urutan secara menurun berdasarkan nilai kunci yang dipilih oleh keySelector. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalinan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan subclass menyalin konstruksi. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan subclass menyalin konstruksi. |
| virtual mapped_t\& [operator[]](./operator[]/)(const key_t\&) | Fungsi accessor. |
...
| **bool** [Remove](./remove/)(const key_t\&) override | Menghapus kunci tertentu dari kamus. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Mendapatkan nilai saatini dari penghitung referensi bersama. |
...
| **bool** [TryGetValue](./trygetvalue/)(const key_t\&, mapped_t\&) const override | Mencari nilai dengan kunci dan mengambilnya jika ditemukan. |
...
| System::Details::VirtualizedIteratorBase\<[KVPair](./kvpair/)\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Mendapatkan implementasi iterator begin const untuk kontainer saat ini. |
| System::Details::VirtualizedIteratorBase\<[KVPair](./kvpair/)\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Mendapatkan implementasi iterator begin untuk kontainer saat ini. |
| System::Details::VirtualizedIteratorBase\<[KVPair](./kvpair/)\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Mendapatkan implementasi iterator end const untuk kontainer saat ini. |
| System::Details::VirtualizedIteratorBase\<[KVPair](./kvpair/)\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Mendapatkan implementasi iterator end untuk kontainer saat ini. |
...
| [KeyCollection](./keycollection/) | Pastikan kita menggunakan allocator yang tepat dengan tipe penyimpanan dasar. |
