...
description: Deklarasi maju kelas Queue.
type: docs
weight: 469
url: /id/system.collections.generic/queue/
---
## Queue kelas

[Queue](./) deklarasi maju kelas.
...
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dari instance koleksi yang dikualifikasikan const. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama yang dikualifikasikan const (jika ada) dari koleksi. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir yang dikualifikasikan const (jika ada) dari koleksi. |
| virtual void [Clear](./clear/)() | Menghapus semua elemen dalam antrian. |
| virtual **bool** [Contains](./contains/)(const T\&) const | Memeriksa apakah antrian berisi elemen tertentu menggunakan operator == untuk membandingkan elemen. |
| [queue_t](./queue_t/)\& [data](./data/)() | Pengakses struktur data dasar. |
| const [queue_t](./queue_t/)\& [data](./data/)() const | Pengakses struktur data dasar. |
| T [Dequeue](./dequeue/)() | Mendapatkan item dari awal antrian. |
...
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir (jika ada) dari instance koleksi yang dikualifikasikan const. |
| void [Enqueue](./enqueue/)(const T\&) | Menempatkan item ke akhir antrian. |
...
| virtual int [get_Count](./get_count/)() const | Mendapatkan jumlah elemen dalam antrian. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| [IEnumeratorPtr](./ienumeratorptr/) [GetEnumerator](./getenumerator/)() override | Mendapatkan enumerator untuk mengiterasi antrian. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Mengurutkan elemen-elemen dari urutan dalam urutan naik sesuai nilai kunci yang dipilih oleh keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Mengurutkan elemen-elemen dari urutan dalam urutan turun sesuai nilai kunci yang dipilih oleh keySelector. |
...
| T [Peek](./peek/)() | Mendapatkan item dari awal antrian, tetapi tidak menghapusnya dari antrian. |
|  [Queue](./queue/)() | Membuat antrian kosong. |
|  [Queue](./queue/)(int) | Membuat antrian kosong. |
|  [Queue](./queue/)(const [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\>\&) | Konstruktor penyalinan. |
...
| [queue_t](./queue_t/) | Tipe data dasar. |
| [IEnumerablePtr](./ienumerableptr/) | Kontainer elemen tipe yang sama. |
| [IEnumeratorPtr](./ienumeratorptr/) | **Enumerator** tipe. |

## Catatan

[Queue](./) container yang membungkus STL list. Objects of this class should only be allocated using [System::MakeObject()](../../system/makeobject/) function. Never create instance of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into [System::SmartPtr](../../system/smartptr/) pointer and use this pointer to pass it to functions as argument.
...
int main()
{
  ...
  // Menampilkan item pertama antrian. Metode Peek tidak menghapus item dari antrian.
  std::cout << queue->Peek() << std::endl;
  // Menampilkan item-item antrian.
  PrintItems(queue);

  // Menampilkan item pertama antrian. Metode Dequeue menghapus item dari antrian.
