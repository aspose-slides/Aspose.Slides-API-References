...
description: "Antarmuka kontainer yang berisi kunci atau nilai dari kontainer yang mirip kamus. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 326
url: /id/system.collections.generic/ikvcollection/
---
## IKVCollection kelas

Antarmuka kontainer yang berisi kunci atau nilai dari kontainer yang mirip kamus. Objek dari kelas ini hanya boleh dialokasikan menggunakan [System::MakeObject()](../../system/makeobject/) fungsi. Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen.
...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const T\&) override | Menambahkan item ke kontainer. |
...
| void [Clear](./clear/)() override | Menghapus semua elemen dari kontainer. |
| **bool** [Contains](./contains/)(const T\&) const override | Memeriksa apakah item ada di dalam kontainer. |
...
| virtual int [get_Count](./get_count/)() const | Mendapatkan jumlah elemen dalam kontainer. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Memeriksa apakah koleksi memiliki ukuran tetap. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Memeriksa apakah kontainer hanya-baca. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() | Mendapatkan enumerator untuk kontainer. |
...
| virtual T [idx_get](./idx_get/)(int) const | Fungsi pengambil nilai (getter). |
| void [idx_set](./idx_set/)(int, T) override | Fungsi penetap nilai (setter). |
| int [IndexOf](./indexof/)(const T\&) const override | Mendapatkan indeks item dalam kontainer. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<ResultType\>\> [LINQ_Select](../ienumerable/linq_select/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Mengubah elemen-elemen dalam urutan. |
...
| **bool** [Remove](./remove/)(const T\&) override | Menghapus item dari kontainer. |
