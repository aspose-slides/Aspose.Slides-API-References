...
description: Menyediakan kelas dasar untuk implementasi antarmuka generik System.Collections.Generic.IComparer.
type: docs
weight: 105
url: /id/system.collections.generic/comparer/
---
## Comparer kelas

Menyediakan kelas dasar untuk implementasi antarmuka generik [System.Collections.Generic.IComparer](../icomparer/).
...
| Parameter | Deskripsi |
| --- | --- |
| T | Tipe objek yang akan dibandingkan. |

## Metode

| Metode | Deskripsi |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) fungsi. |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | Mengembalikan pembanding urutan sortir default untuk tipe yang ditentukan oleh argumen generik. |
