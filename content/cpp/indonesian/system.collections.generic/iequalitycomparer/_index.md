...
| Parameter | Deskripsi |
| --- | --- |
| T | Tipe yang sedang dibandingkan. |

## Metode

| Metode | Deskripsi |
| --- | --- |
| virtual **bool** [Equals](./equals/)(T, T) const | Memeriksa apakah dua objek sama. |
...
| virtual int [GetHashCode](./gethashcode/)(T) const | Mendapatkan kode hash untuk sebuah objek. |
...
| [RTTI_INFO_TEMPLATE_CLASS](./rtti_info_template_class/)([System::Collections::Generic::IEqualityComparer](./)\<T\>, System::BaseTypesInfo\<[System::Object](../../system/object/)\>) | Informasi RTTI. |
