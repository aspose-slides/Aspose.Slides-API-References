...
| Metode | Deskripsi |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) override | Tambahkan efek baru ke akhir urutan saat ini hingga akhir animasi teks grup. Hanya valid jika jumlah paragraf teks sama atau lebih besar dari jumlah efek grup ini! |
...
| [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() override | Daftar tipe build (misalnya [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) dari animasi teks. Baca [Animation::BuildType](../buildtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() override | Efek bentuk tertaut dengan grup atau tidak (null). Baca [IEffect](../ieffect/). |
...
| void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) override | Daftar tipe build (misalnya [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) dari animasi teks. Tulis [Animation::BuildType](../buildtype/). |
| void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) override | Efek bentuk tertaut dengan grup atau tidak (null). Tulis [IEffect](../ieffect/). |
...
* Kelas [ITextAnimation](../itextanimation/)
