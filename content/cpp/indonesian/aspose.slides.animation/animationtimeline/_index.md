...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_InteractiveSequence](./get_interactivesequence/)(**int32_t**) override | Mengembalikan urutan interaktif pada indeks yang ditentukan. Urutan ini hanya dapat berisi efek dengan \"click on shape\" yang menentukan bentuk target. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [get_MainSequence](./get_mainsequence/)() override | Mengembalikan urutan utama yang hanya dapat berisi koleksi efek utama. Hanya-baca [ISequence](../isequence/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_MainSequenceEffect](./get_mainsequenceeffect/)(**int32_t**) override | Mengembalikan efek dari urutan utama pada indeks yang ditentukan. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimation](../itextanimation/)\> [get_TextAnimation](./get_textanimation/)(**int32_t**) override | Mengembalikan animasi teks pada indeks yang ditentukan. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITextAnimationCollection](../itextanimationcollection/)\> [get_TextAnimationCollection](./get_textanimationcollection/)() override | Mengembalikan koleksi animasi teks. Hanya-baca [ITextAnimationCollection](../itextanimationcollection/). |
...
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Menetapkan argumen template n'th menjadi pointer lemah (bukan bersama). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
...
* Kelas [IAnimationTimeLine](../../aspose.slides/ianimationtimeline/)
