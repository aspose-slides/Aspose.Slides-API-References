...
| **float** [get_Value0](./get_value0/)() override | Mendefinisikan nilai pertama dari offset. Baca **float**. |
| **float** [get_Value1](./get_value1/)() override | Mendefinisikan nilai kedua dari offset. Baca **float**. |
| **float** [get_Value2](./get_value2/)() override | Mendefinisikan nilai ketiga dari offset. Baca **float**. |
...
| void [set_Value0](./set_value0/)(**float**) override | Mendefinisikan nilai pertama dari offset. Tulis **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Mendefinisikan nilai kedua dari offset. Tulis **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Mendefinisikan nilai ketiga dari offset. Tulis **float**. |
...
* Kelas [IColorOffset](../icoloroffset/)
