...
| [System::String](../../system/string/) [get_CommandString](./get_commandstring/)() override | Mendefinisikan string perintah. Baca [System::String](../../system/string/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_ShapeTarget](./get_shapetarget/)() override | Mendefinisikan target bentuk dari efek perintah. Baca [IShape](../../aspose.slides/ishape/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | Mewakili properti timing untuk perilaku efek. Baca [ITiming](../itiming/). |
| [CommandEffectType](../commandeffecttype/) [get_Type](./get_type/)() override | Mendefinisikan tipe efek perintah dari perilaku. Baca [CommandEffectType](../commandeffecttype/). |
...
| void [set_CommandString](./set_commandstring/)([System::String](../../system/string/)) override | Mendefinisikan string perintah. Tulis [System::String](../../system/string/). |
| void [set_ShapeTarget](./set_shapetarget/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) override | Mendefinisikan target bentuk dari efek perintah. Tulis [IShape](../../aspose.slides/ishape/). |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Mewakili properti timing untuk perilaku efek. Tulis [ITiming](../itiming/). |
| void [set_Type](./set_type/)([CommandEffectType](../commandeffecttype/)) override | Mendefinisikan tipe efek perintah dari perilaku. Tulis [CommandEffectType](../commandeffecttype/). |
...
* Kelas [ICommandEffect](../icommandeffect/)
