...
| Metode | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Menambahkan urutan interaktif baru. |
...
| virtual void [Clear](./clear/)() | Menghapus semua urutan dari sebuah koleksi. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Mengembalikan jumlah elemen dalam sebuah koleksi baca-saja **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [idx_get](./idx_get/)(**int32_t**) | Mengembalikan urutan pada indeks yang ditentukan. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>) | Menghapus urutan yang ditentukan dari sebuah koleksi. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Menghapus urutan pada indeks yang ditentukan. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menyetel argumen template ke-n menjadi pointer lemah (bukan shared). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
