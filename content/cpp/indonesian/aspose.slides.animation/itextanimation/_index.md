...
| Method | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [AddEffect](./addeffect/)([EffectType](../effecttype/), [EffectSubtype](../effectsubtype/), [EffectTriggerType](../effecttriggertype/)) | Menambahkan efek baru ke akhir urutan saat ini hingga akhir animasi teks grup. Hanya valid jika jumlah paragraf teks sama atau lebih besar dari jumlah efek grup ini! |
...
| virtual [Aspose::Slides::Animation::BuildType](../buildtype/) [get_BuildType](./get_buildtype/)() | Daftar tipe bangun (misalnya [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) animasi teks. Baca [BuildType](../buildtype/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\> [get_EffectAnimateBackgroundShape](./get_effectanimatebackgroundshape/)() | Efek bentuk tertaut dengan grup atau tidak (null) Baca [IEffect](../ieffect/). |
...
| virtual void [set_BuildType](./set_buildtype/)([Aspose::Slides::Animation::BuildType](../buildtype/)) | Daftar tipe bangun (misalnya [Paragraph](../../aspose.slides/paragraph/) 1,2,3, All at Once) animasi teks. Tulis [BuildType](../buildtype/). |
| virtual void [set_EffectAnimateBackgroundShape](./set_effectanimatebackgroundshape/)([System::SharedPtr](../../system/sharedptr/)\<[IEffect](../ieffect/)\>) | Efek bentuk tertaut dengan grup atau tidak (null) Tulis [IEffect](../ieffect/). |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pembukaan pernyataan kunci C# lock(). Panggil langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
