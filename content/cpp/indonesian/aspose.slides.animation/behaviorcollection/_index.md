...
| Method | Deskripsi |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Menambahkan perilaku baru ke koleksi. |
...
| void [Clear](./clear/)() override | Menghapus semua perilaku dari koleksi. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Menentukan apakah [ICollection](../../system.collections.generic/icollection/) berisi nilai tertentu. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>, **int32_t**) | Menyalin elemen [ICollection](../../system.collections.generic/icollection/) ke [System::Array](../../system/array/), dimulai pada indeks [System::Array](../../system/array/) tertentu. |
...
| **int32_t** [get_Count](./get_count/)() override | Mengembalikan jumlah perilaku dalam koleksi. Hanya-baca **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Mendapatkan nilai yang menunjukkan apakah [ICollection](../../system.collections.generic/icollection/) hanya-baca. Hanya-baca **bool**. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator yang mengiterasi koleksi. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) override | Mengembalikan perilaku pada indeks yang ditentukan. |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Mengembalikan perilaku pada indeks yang ditentukan. |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Menentukan indeks item tertentu dalam [IList](../../system.collections.generic/ilist/). |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Menyisipkan perilaku baru ke koleksi pada indeks yang ditentukan. |
...
| void [Lock](../../system/object/lock/)() | Menerapkan pernyataan C# lock() untuk penguncian. Panggil langsung atau gunakan objek pengawas [LockContext](../../system/lockcontext/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalinan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan menyalin konstruktor subkelas. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) override | Menghapus perilaku yang ditentukan dari koleksi. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Menghapus perilaku dari koleksi pada indeks yang ditentukan. |
...
* Kelas [IBehaviorCollection](../ibehaviorcollection/)
