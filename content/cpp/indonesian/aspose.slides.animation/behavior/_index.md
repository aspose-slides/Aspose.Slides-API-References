...
| [NullableBool](../../aspose.slides/nullablebool/) [get_Accumulate](./get_accumulate/)() override | Mewakili apakah perilaku animasi dikumpulkan. Baca [NullableBool](../../aspose.slides/nullablebool/). |
| [BehaviorAdditiveType](../behavioradditivetype/) [get_Additive](./get_additive/)() override | Mewakili apakah perilaku animasi saat ini digabungkan dengan animasi lain yang sedang berjalan. Baca [BehaviorAdditiveType](../behavioradditivetype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IBehaviorPropertyCollection](../ibehaviorpropertycollection/)\> [get_Properties](./get_properties/)() override | Mewakili properti perilaku. Hanya-baca [IBehaviorPropertyCollection](../ibehaviorpropertycollection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](./get_timing/)() override | Mewakili properti waktu untuk perilaku efek. Baca [ITiming](../itiming/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek mewakili sebuah contoh dari tipe yang dijelaskan oleh targetType. Analog operator C# 'is'. |
...
| void [set_Accumulate](./set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | Mewakili apakah perilaku animasi dikumpulkan. Tulis [NullableBool](../../aspose.slides/nullablebool/). |
| void [set_Additive](./set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Mewakili apakah perilaku animasi saat ini digabungkan dengan animasi lain yang sedang berjalan. Tulis [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_Timing](./set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Mewakili properti waktu untuk perilaku efek. Tulis [ITiming](../itiming/). |
