...
| virtual **float** [get_Value0](./get_value0/)() | Mendefinisikan nilai pertama dari offset. Baca **float**. |
| virtual **float** [get_Value1](./get_value1/)() | Mendefinisikan nilai kedua dari offset. Baca **float**. |
| virtual **float** [get_Value2](./get_value2/)() | Mendefinisikan nilai ketiga dari offset. Baca **float**. |
...
| virtual void [set_Value0](./set_value0/)(**float**) | Mendefinisikan nilai pertama offset. Tulis **float**. |
| virtual void [set_Value1](./set_value1/)(**float**) | Mendefinisikan nilai kedua offset. Tulis **float**. |
| virtual void [set_Value2](./set_value2/)(**float**) | Mendefinisikan nilai ketiga offset. Tulis **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menyetel argumen template ke-n sebagai weak pointer (bukan shared). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
