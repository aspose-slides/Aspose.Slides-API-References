...
| Metode | Deskripsi |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Menambahkan perilaku baru ke dalam koleksi. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama yang memiliki qualifier const (jika ada) dalam koleksi. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Mendapatkan iterator yang menunjuk tepat setelah elemen terakhir yang memiliki qualifier const (jika ada) dalam koleksi. |
| virtual void [Clear](./clear/)() | Menghapus semua perilaku dari sebuah koleksi. |
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Menentukan apakah [ICollection](../../system.collections.generic/icollection/) berisi nilai tertentu. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Mengembalikan jumlah perilaku dalam sebuah koleksi. **int32_t** hanya-baca. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) | Mengembalikan perilaku pada indeks yang ditentukan. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Mengembalikan perilaku pada indeks yang ditentukan. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Menentukan indeks dari item tertentu dalam [IList](../../system.collections.generic/ilist/). |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Menyisipkan perilaku baru ke dalam koleksi pada indeks yang ditentukan. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)() | Mengembalikan elemen pertama dari urutan, atau nilai bawaan jika urutan kosong. |
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Mengembalikan elemen pertama dari urutan yang memenuhi kondisi atau nilai bawaan jika tidak ada elemen yang ditemukan. |
...
| T [LINQ_LastOrDefault](../../system.collections.generic/ienumerable/linq_lastordefault/)() | Mengembalikan elemen terakhir dari urutan, atau nilai bawaan jika urutan kosong. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salin. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruktor ke subclass. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Menghapus perilaku yang ditentukan dari sebuah koleksi. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Menghapus perilaku dari koleksi pada indeks yang ditentukan. |
...
| virtual  [~Object](../../system/object/~object/)() | Menghapus objek. Membebaskan semua struktur data internal. |
