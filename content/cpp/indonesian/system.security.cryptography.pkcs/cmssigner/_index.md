...
description: "Menyediakan API untuk menandatangani objek menggunakan CMS. Tidak menandatangani objek secara langsung, gunakan kelas SignedCMS untuk melakukannya. Tidak diimplementasikan. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kesalahan asersi. Selalu bungkus kelas ini dalam pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 1
url: /id/system.security.cryptography.pkcs/cmssigner/
---
## CmsSigner kelas

Menyediakan API untuk menandatangani objek menggunakan CMS. Tidak menandatangani objek secara langsung, gunakan kelas SignedCMS untuk melakukannya. Tidak diimplementasikan. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan waktu jalan dan/atau fault asersi. Selalu bungkus kelas ini dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen.
...
| Metode | Deskripsi |
| --- | --- |
|  [CmsSigner](./cmssigner/)(const [SharedPtr](../../system/sharedptr/)\<[X509Certificates::X509Certificate2](../../system.security.cryptography.x509certificates/x509certificate2/)\>\&) | Menginisialisasi signer dengan sertifikat X509. |
...
| [SharedPtr](../../system/sharedptr/)\<[Oid](../../system.security.cryptography/oid/)\> [get_DigestAlgorithm](./get_digestalgorithm/)() const | Mendapatkan algoritma hash yang digunakan dengan tanda tangan. |
| [X509Certificates::X509IncludeOption](../../system.security.cryptography.x509certificates/x509includeoption/) [get_IncludeOption](./get_includeoption/)() const | Memeriksa sertifikat mana dari rantai yang akan dimasukkan ke dalam tanda tangan. |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan C# lock() yang mengunci. Panggil secara langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
...
| void [set_DigestAlgorithm](./set_digestalgorithm/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](../../system.security.cryptography/oid/)\>\&) | Menetapkan algoritma hash yang digunakan dengan tanda tangan. |
| void [set_IncludeOption](./set_includeoption/)([X509Certificates::X509IncludeOption](../../system.security.cryptography.x509certificates/x509includeoption/)) | Menentukan sertifikat mana dari rantai yang akan dimasukkan ke dalam tanda tangan. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan C# lock() yang membuka kunci. Panggil secara langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
...
* Ruang nama [System::Security::Cryptography::Pkcs](../)
