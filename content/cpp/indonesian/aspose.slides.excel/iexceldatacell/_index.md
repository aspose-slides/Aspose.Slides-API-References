...
| virtual **int32_t** [get_Column](./get_column/)() | Mendapatkan indeks nol berbasis kolom di lembar kerja tempat sel berada. Hanya-baca **int32_t**. |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Mendapatkan nama sel data diagram. Hanya-baca [System::String](../../system/string/). |
| virtual **int32_t** [get_Row](./get_row/)() | Mendapatkan indeks nol berbasis baris di lembar kerja tempat sel berada. Hanya-baca **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_Value](./get_value/)() | Mendapatkan nilai yang terdapat dalam sel [Excel](../). Hanya-baca [System::Object](../../system/object/). |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Menambah jumlah penghitung referensi bersama. Tidak seharusnya dipanggil secara langsung; gunakan smart pointers atau ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Mengurangi dan mengembalikan jumlah penghitung referensi bersama. Tidak seharusnya dipanggil secara langsung; gunakan smart pointers atau ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah jumlah penghitung referensi lemah. Tidak seharusnya dipanggil secara langsung; gunakan smart pointers atau ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Mengurangi jumlah penghitung referensi lemah. Tidak seharusnya dipanggil secara langsung; gunakan smart pointers atau ThisProtector. |
