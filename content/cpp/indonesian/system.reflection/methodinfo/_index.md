...
description: Mewakili informasi tentang metode kelas.
type: docs
weight: 131
url: /id/system.reflection/methodinfo/
---
## MethodInfo kelas

Mewakili informasi tentang metode kelas.
...
| [TypeInfo](../../system/typeinfo/) [get_DeclaringType](../memberinfo/get_declaringtype/)() const | Mengambil tipe deklarasi. |
| const [String](../../system/string/)\& [get_FullName](../memberinfo/get_fullname/)() const | Mengambil nama penuh anggota. Bisa berbeda pada bagian yang diimplementasikan secara manual. |
| [MemberTypes](../membertypes/) [get_MemberType](./get_membertype/)() const override | Mengambil nilai MemberTypes yang menunjukkan bahwa anggota ini adalah metode. |
| const [String](../../system/string/)\& [get_Name](../memberinfo/get_name/)() const | Mengambil nama anggota. |
| [TypeInfo](../../system/typeinfo/) [get_ReflectedType](../memberinfo/get_reflectedtype/)() const | Mengambil tipe yang dipantulkan. |
...
|  [MethodInfo](./methodinfo/)(const [String](../../system/string/)\&) | Menginisialisasi sebuah instansi baru dari kelas [MethodInfo](./). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi pointer lemah (bukan berbagi). Memungkinkan pengalihan pointer dalam kontainer ke mode lemah. |
| int [SharedCount](../../system/object/sharedcount/)() const | Mengambil nilai terkini dari penghitung referensi bersama. |
