...
description: "Kalender Jepang. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 183
url: /id/system.globalization/japanesecalendar/
---
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [Clone](./clone/)() override | Membuat salinan objek saat ini dan mengembalikan shared pointer kepadanya. |
...
| virtual int [GetLeapMonth](./getleapmonth/)(int) const | Mendapatkan bulan kabisat untuk tahun tertentu. |
| virtual int [GetLeapMonth](./getleapmonth/)(int, int) const | Mendapatkan bulan kabisat untuk tahun tertentu. |
...
| int [GetMonthsInYear](./getmonthsinyear/)(int, int) const override | Mendapatkan jumlah bulan dalam tahun tertentu. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengizinkan penyalinan konstruktor pada subclass. |
...
| virtual int [ToFourDigitYear](../calendar/tofourdigityear/)(int) const | Mengkonversi tahun menjadi tahun 4 digit menggunakan properti TwoDigitYearMax. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pembongkaran pernyataan lock() C#. Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
