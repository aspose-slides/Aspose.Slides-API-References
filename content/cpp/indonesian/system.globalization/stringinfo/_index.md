...
description: "Pemecah untuk mengiterasi bagian-bagian string. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instansi tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 313
url: /id/system.globalization/stringinfo/
---
## StringInfo kelas
...
| int [get_LengthInTextElements](./get_lengthintextelements/)() const | Mendapatkan jumlah elemen teks dalam objek [StringInfo](./). |
| [String](../../system/string/) [get_String](./get_string/)() const | Mendapatkan nilai dari objek [StringInfo](./). |
...
| static [String](../../system/string/) [GetNextTextElement](./getnexttextelement/)(const [String](../../system/string/)\&) | Mendapatkan elemen pertama dalam string yang ditentukan. |
| static [String](../../system/string/) [GetNextTextElement](./getnexttextelement/)(const [String](../../system/string/)\&, int) | Mendapatkan elemen pada indeks yang ditentukan dari string yang ditentukan. |
| static [SharedPtr](../../system/sharedptr/)\<[TextElementEnumerator](../textelementenumerator/)\> [GetTextElementEnumerator](./gettextelementenumerator/)(const [String](../../system/string/)\&) | Membuat enumerator untuk mengiterasi karakter-karakter string. |
| static [SharedPtr](../../system/sharedptr/)\<[TextElementEnumerator](../textelementenumerator/)\> [GetTextElementEnumerator](./gettextelementenumerator/)(const [String](../../system/string/)\&, int) | Membuat enumerator untuk mengiterasi karakter-karakter string mulai dari indeks yang ditentukan. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalinan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruktor pada subkelas. |
...
| static [ArrayPtr](../../system/arrayptr/)\<int\> [ParseCombiningCharacters](./parsecombiningcharacters/)(const [String](../../system/string/)\&) | Mendapatkan indeks karakter dasar, surrogate tinggi, dan karakter kontrol. |
...
| void [set_String](./set_string/)(const [String](../../system/string/)\&) | Mengatur nilai objek [StringInfo](./). |
...
| [String](../../system/string/) [SubstringByTextElements](./substringbytextelements/)(int) const | Mendapatkan substring elemen teks dari elemen teks yang ditentukan hingga elemen teks terakhir. |
| [String](../../system/string/) [SubstringByTextElements](./substringbytextelements/)(int, int) const | Mendapatkan substring elemen teks dari elemen teks yang ditentukan hingga jumlah elemen teks yang ditentukan. |
