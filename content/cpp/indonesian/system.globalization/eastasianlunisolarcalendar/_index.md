...
description: "Kalender lunisolar Asia Timur. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance dari tipe ini pada stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kesalahan asersi. Selalu bungkus kelas ini ke dalam penunjuk System::SmartPtr dan gunakan penunjuk ini untuk melewatkannya ke fungsi sebagai argumen."
type: docs
weight: 105
url: /id/system.globalization/eastasianlunisolarcalendar/
---
## EastAsianLunisolarCalendar kelas

Kalender lunisolar Asia Timur. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance dari tipe ini pada stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kesalahan asersi. Selalu bungkus kelas ini ke dalam penunjuk [System::SmartPtr](../../system/smartptr/) dan gunakan penunjuk ini untuk melewatkannya ke fungsi sebagai argumen.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [Clone](../../system/icloneable/clone/)() | Membuat salinan objek saat ini dan mengembalikan penunjuk bersama ke objek tersebut. |
...
| [CalendarAlgorithmType](../calendaralgorithmtype/) [get_AlgorithmType](./get_algorithmtype/)() const override | informasi RTTI. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<int\> [get_Eras](../calendar/get_eras/)() const | Mendapatkan daftar era yang ada dalam kalender. |
| virtual [Details::CalendarId](../../system.globalization.details/calendarid/) [get_ID](../calendar/get_id/)() const | Mendapatkan pengidentifikasi kalender. |
| **bool** [get_IsReadOnly](../calendar/get_isreadonly/)() const | Memeriksa apakah kalender bersifat hanya baca. |
| virtual [DateTime](../../system/datetime/) [get_MaxSupportedDateTime](../calendar/get_maxsupporteddatetime/)() const | Titik waktu maksimal yang didukung oleh kalender. |
| virtual [DateTime](../../system/datetime/) [get_MinSupportedDateTime](../calendar/get_minsupporteddatetime/)() const | Titik waktu minimal yang didukung oleh kalender. |
...
| int [GetCelestialStem](./getcelestialstem/)(int) const | Mendapatkan batang selestial. |
...
| virtual int [GetLeapMonth](../calendar/getleapmonth/)(int) const | Mendapatkan bulan kabisat untuk tahun yang ditentukan. |
| virtual int [GetLeapMonth](../calendar/getleapmonth/)(int, int) const | Mendapatkan bulan kabisat untuk tahun yang ditentukan. |
...
| virtual int [GetSexagenaryYear](./getsexagenaryyear/)([DateTime](../../system/datetime/)) const | Mendapatkan tahun dalam siklus sexagenari. |
| int [GetTerrestrialBranch](./getterrestrialbranch/)(int) const | Mendapatkan cabang bumi. |
...
| virtual **bool** [IsLeapDay](../calendar/isleapday/)(int, int, int) const | Memeriksa apakah hari tersebut adalah hari kabisat. |
| virtual **bool** [IsLeapDay](../calendar/isleapday/)(int, int, int, int) const | Memeriksa apakah hari tersebut adalah hari kabisat. |
| virtual **bool** [IsLeapMonth](../calendar/isleapmonth/)(int, int) const | Memeriksa apakah bulan tersebut adalah bulan kabisat. |
| virtual **bool** [IsLeapMonth](../calendar/isleapmonth/)(int, int, int) const | Memeriksa apakah bulan tersebut adalah bulan kabisat. |
| virtual **bool** [IsLeapYear](../calendar/isleapyear/)(int) const | Memeriksa apakah tahun tersebut adalah tahun kabisat. |
| virtual **bool** [IsLeapYear](../calendar/isleapyear/)(int, int) const | Memeriksa apakah tahun tersebut adalah tahun kabisat. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi penunjuk lemah (bukan penunjuk bersama). Memungkinkan penggantian penunjuk dalam kontainer ke mode lemah. |
| int [SharedCount](../../system/object/sharedcount/)() const | Mendapatkan nilai saat ini dari penghitung referensi bersama. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Meningkatkan penghitung referensi bersama. Tidak boleh dipanggil secara langsung; gunakan penunjuk pintar atau ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Mengurangi dan mengembalikan penghitung referensi bersama. Tidak boleh dipanggil secara langsung; gunakan penunjuk pintar atau ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Meningkatkan penghitung referensi lemah. Tidak boleh dipanggil secara langsung; gunakan penunjuk pintar atau ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Mengurangi penghitung referensi lemah. Tidak boleh dipanggil secara langsung; gunakan penunjuk pintar atau ThisProtector. |
