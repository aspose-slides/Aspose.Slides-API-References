...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Mensimulasikan perbandingan floating point ala C# di mana dua NaN dianggap sama meskipun menurut IEC 60559:1989 NaN tidak sama dengan nilai apa pun, termasuk NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Mensimulasikan perbandingan floating point ala C# di mana dua NaN dianggap sama meskipun menurut IEC 60559:1989 NaN tidak sama dengan nilai apa pun, termasuk NaN. |
...
| virtual int [get_TwoDigitYearMax](../calendar/get_twodigityearmax/)() const | Mendapatkan tahun terakhir yang dapat direpresentasikan oleh 2 digit. |
...
| virtual **bool** [IsLeapMonth](../calendar/isleapmonth/)(int, int) const | Memeriksa apakah bulan adalah kabisat. |
| virtual **bool** [IsLeapMonth](../calendar/isleapmonth/)(int, int, int) const | Memeriksa apakah bulan adalah kabisat. |
...
| virtual void [set_TwoDigitYearMax](../calendar/set_twodigityearmax/)(int) | Menetapkan tahun terakhir yang dapat direpresentasikan oleh 2 digit. |
