...
description: Memeriksa apakah hari tersebut merupakan hari kabisat.
type: docs
weight: 144
url: /id/system.globalization/hijricalendar/isleapday/
---
## HijriCalendar::IsLeapDay(int, int, int, int) const metode


Memeriksa apakah hari tersebut merupakan hari kabisat.
...
## HijriCalendar::IsLeapDay(int, int, int) const metode
