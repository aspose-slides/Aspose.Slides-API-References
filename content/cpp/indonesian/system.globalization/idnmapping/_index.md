...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Membandingkan dua objek [IdnMapping](./). |
...
| **bool** [get_AllowUnassigned](./get_allowunassigned/)() const | Mendapatkan flag yang menunjukkan apakah titik kode yang tidak ditetapkan digunakan dalam operasi. |
| **bool** [get_UseStd3AsciiRules](./get_usestd3asciirules/)() const | Mendapatkan flag yang menunjukkan apakah konvensi penamaan standar digunakan dalam operasi. |
| [String](../../system/string/) [GetAscii](./getascii/)(const [String](../../system/string/)\&) const | [Convert](../../system/convert/) nama domain unicode ke ekivalen ascii. |
| [String](../../system/string/) [GetAscii](./getascii/)(const [String](../../system/string/)\&, int) const | [Convert](../../system/convert/) nama domain unicode ke ekivalen ascii. |
| [String](../../system/string/) [GetAscii](./getascii/)(const [String](../../system/string/)\&, int, int) const | [Convert](../../system/convert/) nama domain unicode ke ekivalen ascii. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| int [GetHashCode](./gethashcode/)() const override | Mendapatkan kode hash untuk objek [IdnMapping](./) saat ini. |
...
| [String](../../system/string/) [GetUnicode](./getunicode/)(const [String](../../system/string/)\&) const | [Convert](../../system/convert/) nama domain ascii ke ekivalen unicode. |
| [String](../../system/string/) [GetUnicode](./getunicode/)(const [String](../../system/string/)\&, int) const | [Convert](../../system/convert/) nama domain ascii ke ekivalen unicode. |
| [String](../../system/string/) [GetUnicode](./getunicode/)(const [String](../../system/string/)\&, int, int) const | [Convert](../../system/convert/) nama domain ascii ke ekivalen unicode. |
...
| void [set_AllowUnassigned](./set_allowunassigned/)(**bool**) | Mengatur flag yang menunjukkan apakah titik kode yang tidak ditetapkan digunakan dalam operasi. |
| void [set_UseStd3AsciiRules](./set_usestd3asciirules/)(**bool**) | Mengatur flag yang menunjukkan apakah konvensi penamaan standar digunakan dalam operasi. |
