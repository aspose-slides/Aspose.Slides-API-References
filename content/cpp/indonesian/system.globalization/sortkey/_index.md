...
| Metode | Deskripsi |
| --- | --- |
| static int [Compare](./compare/)(const [SortKeyPtr](../sortkeyptr/)\&, const [SortKeyPtr](../sortkeyptr/)\&) | Membandingkan dua kunci urutan. |
| **bool** [Equals](./equals/)([SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Memeriksa apakah objek yang ditentukan sama dengan objek [SortKey](./) saat ini. |
...
| virtual [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_KeyData](./get_keydata/)() | Mendapatkan array byte yang mewakili objek saat ini. |
| virtual [String](../../system/string/) [get_OriginalString](./get_originalstring/)() | Mendapatkan string asli yang digunakan untuk membuat objek ini. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Mendapatkan struktur data penghitung referensi yang terkait dengan objek. |
| int [GetHashCode](./gethashcode/)() const override | Mendapatkan kode hash untuk objek [SortKey](./) saat ini. |
...
| [String](../../system/string/) [ToString](./tostring/)() const override | Mengonversi objek saat ini ke representasi string-nya. |
