...
description: Menyediakan status penyelesaian dari loop paralel.
type: docs
weight: 14
url: /id/system.threading.tasks/parallelloopresult/
---
## ParallelLoopResult kelas

Menyediakan status penyelesaian dari loop [Parallel](../parallel/).
...
| **bool** [get_IsCompleted](./get_iscompleted/)() | Mendapatkan apakah loop berjalan sampai selesai. |
| [Nullable](../../system/nullable/)\<**int64_t**\> [get_LowestBreakIteration](./get_lowestbreakiteration/)() | Mendapatkan indeks iterasi terendah di mana break terjadi. |
...
|  [ParallelLoopResult](./parallelloopresult/)() | Membuat sebuah [ParallelLoopResult](./). |
...
Mewakili hasil operasi loop paralel, termasuk apakah selesai dan informasi tentang break.

## Lihat Juga

* Kelas [Object](../../system/object/)
* RuangNama [System::Threading::Tasks](../)
