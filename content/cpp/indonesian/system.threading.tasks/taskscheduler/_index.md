...
description: Mewakili objek yang menangani pekerjaan tingkat rendah dalam mengantri tugas ke thread.
type: docs
weight: 79
url: /id/system.threading.tasks/taskscheduler/
---
## TaskScheduler kelas
...
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [FromCurrentSynchronizationContext](./fromcurrentsynchronizationcontext/)() | Membuat sebuah [TaskScheduler](./) yang terkait dengan thread saat ini. |
| static [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\> [get_Current](./get_current/)() | Mendapatkan [TaskScheduler](./) yang terkait dengan tugas yang sedang dijalankan. |
| static const [SharedPtr](../../system/sharedptr/)\<[TaskScheduler](./)\>\& [get_Default](./get_default/)() | Mendapatkan instance [TaskScheduler](./) default yang disediakan oleh kerangka kerja. |
| **int32_t** [get_Id](./get_id/)() const | Mendapatkan ID unik untuk [TaskScheduler](./) ini. |
| virtual **int32_t** [get_MaximumConcurrencyLevel](./get_maximumconcurrencylevel/)() const | Menunjukkan tingkat konkruensi maksimum yang dapat didukung oleh [TaskScheduler](./) ini. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Menambah jumlah referensi bersama. Tidak seharusnya dipanggil langsung; gunakan smart pointer atau ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah jumlah referensi weak. Tidak seharusnya dipanggil langsung; gunakan smart pointer atau ThisProtector. |
