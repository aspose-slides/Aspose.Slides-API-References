...
description: Menyediakan satu set objek Font yang telah dibuat sebelumnya yang mewakili font yang digunakan untuk menampilkan teks dalam elemen tampilan Windows. Ini adalah tipe statis tanpa layanan instance. Anda tidak pernah harus membuat instance darinya dengan cara apa pun.
type: docs
weight: 339
url: /id/system.drawing/systemfonts/
---
## SystemFonts kelas


Menyediakan satu set objek [Font](../font/) yang telah dibuat sebelumnya yang mewakili font yang digunakan untuk menampilkan teks dalam elemen tampilan [Windows](../../system.windows/). Ini adalah tipe statis tanpa layanan instance. Anda tidak pernah harus membuat instance darinya dengan cara apa pun.
...
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_CaptionFont](./get_captionfont/)() | BELUM DIIMPLEMENTASIKAN. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_DefaultFont](./get_defaultfont/)() | Mengembalikan objek [Font](../font/) yang mewakili font default yang dapat digunakan aplikasi untuk kotak dialog dan formulir. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_IconTitleFont](./get_icontitlefont/)() | BELUM DIIMPLEMENTASIKAN. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MenuFont](./get_menufont/)() | BELUM DIIMPLEMENTASIKAN. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_MessageBoxFont](./get_messageboxfont/)() | BELUM DIIMPLEMENTASIKAN. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_SmallCaptionFont](./get_smallcaptionfont/)() | BELUM DIIMPLEMENTASIKAN. |
| static [SharedPtr](../../system/sharedptr/)\<[Font](../font/)\> [get_StatusFont](./get_statusfont/)() | BELUM DIIMPLEMENTASIKAN. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengaktifkan pembuatan salinan untuk subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengaktifkan pembuatan salinan untuk subclass. |
