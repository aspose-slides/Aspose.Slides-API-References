...
description: "Implementasi Mutex. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan runtime errors dan/atau assertion faults. Selalu balut kelas ini dengan pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 170
url: /id/system.threading/mutex/
---
## Kelas Mutex


[Mutex](./) implementasi. Objek dari kelas ini harus hanya dialokasikan menggunakan [System::MakeObject()](../../system/makeobject/) function. Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan runtime errors dan/atau assertion faults. Selalu balut kelas ini dengan [System::SmartPtr](../../system/smartptr/) pointer dan gunakan pointer ini untuk meneruskannya ke functions as argument.
...
|  [Mutex](./mutex/)() | Membuat mutex yang tidak dimiliki. |
...
| void [ReleaseMutex](./releasemutex/)() | Melepaskan mutex. |
| static **bool** [Remove](./remove/)(const [String](../../system/string/)\&) | Menghapus mutex bernama dari sistem. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Mengurangi penghitung referensi bersama sebesar nilai yang ditentukan. |
| virtual **bool** [Reset](./reset/)() | Mengatur ulang status mutex. Tidak diimplementasikan. |
| virtual **bool** [Set](./set/)() | Menetapkan mutex ke status terindikasi. Tidak diimplementasikan. |
...
| **bool** [WaitOne](./waitone/)() override | Mengunci mutex. Melakukan penunggu tak terbatas jika diperlukan. |
| **bool** [WaitOne](./waitone/)(int) override | Mengunci mutex. Melakukan penunggu jika diperlukan. |
| **bool** [WaitOne](./waitone/)([TimeSpan](../../system/timespan/)) override | Mengunci mutex. Melakukan penunggu jika diperlukan. |
...
| Bidang | Deskripsi |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Nilai khusus yang dikembalikan oleh fungsi, jika tidak mengembalikan indeks objek yang terindikasi dalam array, bila batas waktu terlampaui dan tidak ada yang memberi sinyal. |
