...
description: "Peristiwa yang dapat dikirim ke thread yang menunggu. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject() . Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan error runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 118
url: /id/system.threading/eventwaithandle/
---
## EventWaitHandle kelas

Peristiwa yang dapat dikirim ke thread yang menunggu. Objek dari kelas ini sebaiknya hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer tersebut untuk melewatkannya ke fungsi sebagai argumen.
...
| Metode | Deskripsi |
| --- | --- |
| virtual void [Close](../waithandle/close/)() | Melepaskan semua sumber daya yang terkait dengan handle. |
...
| virtual **bool** [Reset](./reset/)() | Mengatur peristiwa ke kondisi non-signalling. |
| virtual **bool** [Set](./set/)() | Mengatur peristiwa ke keadaan signalling. |
...
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Menunggu semua handle untuk memicu. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Menunggu semua handle untuk memicu. |
| static **bool** [WaitAll](../waithandle/waitall/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Menunggu semua handle untuk memicu. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, int) | Menunggu salah satu handle memicu. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&, [TimeSpan](../../system/timespan/)) | Menunggu salah satu handle memicu. |
| static int [WaitAny](../waithandle/waitany/)(const [System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[WaitHandle](../waithandle/)\>\>\&) | Menunggu salah satu handle memicu. |
| virtual **bool** [WaitOne](../waithandle/waitone/)() | Menunggu handle memicu untuk periode tak terbatas. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int) | Menunggu handle memicu. |
| virtual **bool** [WaitOne](../waithandle/waitone/)([TimeSpan](../../system/timespan/)) | Menunggu handle memicu. |
| virtual **bool** [WaitOne](../waithandle/waitone/)(int, **bool**) | Menunggu handle memicu. |
...
| Bidang | Deskripsi |
| --- | --- |
| static [WaitTimeout](../waithandle/waittimeout/) | Nilai khusus yang akan dikembalikan oleh fungsi, selain mengembalikan indeks objek yang disinyalkan dalam array, jika batas waktu terlampaui dan tidak ada yang menyinyal. |

## Lihat Juga

* Kelas [WaitHandle](../waithandle/)
