...
description: Sebuah sumber token pembatalan yang dapat digunakan untuk memicu notifikasi pembatalan.
type: docs
weight: 40
url: /id/system.threading/cancellationtokensource/
---
## CancellationTokenSource kelas


Sebuah sumber token pembatalan yang dapat digunakan untuk memicu notifikasi pembatalan.
...
| Metode | Deskripsi |
| --- | --- |
| void [Cancel](./cancel/)() | Menyampaikan permintaan pembatalan. |
|  [CancellationTokenSource](./cancellationtokensource/)() | Membuat [CancellationTokenSource](./) baru. |
| static [SharedPtr](../../system/sharedptr/)\<[CancellationTokenSource](./)\> [CreateLinkedTokenSource](./createlinkedtokensource/)(const [CancellationToken](../cancellationtoken/)\&, const [CancellationToken](../cancellationtoken/)\&) | Membuat sumber token tertaut yang membatalkan ketika salah satu token yang diberikan dibatalkan. |
| void [Dispose](./dispose/)() override | Melepaskan semua sumber daya yang digunakan oleh [CancellationTokenSource](./). |
...
| **bool** [get_IsCancellationRequested](./get_iscancellationrequested/)() const | Mendapatkan apakah pembatalan telah diminta. |
| [CancellationToken](../cancellationtoken/) [get_Token](./get_token/)() const | Mendapatkan token pembatalan yang terkait dengan sumber ini. |
...
Menyediakan mekanisme untuk membuat dan mengendalikan token pembatalan untuk pembatalan kooperatif operasi. 
