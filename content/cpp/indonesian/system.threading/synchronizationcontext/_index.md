...
description: Menyediakan fungsionalitas dasar untuk menyebarkan konteks sinkronisasi di berbagai operasi sinkronisasi.
type: docs
weight: 196
url: /id/system.threading/synchronizationcontext/
---
## SynchronizationContext Kelas

Menyediakan fungsionalitas dasar untuk menyebarkan konteks sinkronisasi di berbagai operasi sinkronisasi.
...
| static const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\& [get_Current](./get_current/)() | Mendapatkan konteks sinkronisasi untuk thread saat ini. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengizinkan konstruksi penyalinan subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengizinkan konstruksi penyalinan subclass. |
| virtual void [Post](./post/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Menjalankan panggilan balik secara asinkron. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Menurunkan penghitung referensi berbagi dengan nilai yang ditentukan. |
| virtual void [Send](./send/)([SendOrPostCallback](../sendorpostcallback/), [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) | Menjalankan panggilan balik secara sinkron. |
| static void [SetSynchronizationContext](./setsynchronizationcontext/)(const [SharedPtr](../../system/sharedptr/)\<[SynchronizationContext](./)\>\&) | Mengatur konteks sinkronisasi untuk thread saat ini. |
...
|  [SynchronizationContext](./synchronizationcontext/)() | Membuat instance baru dari [SynchronizationContext](./). |
...
Kelas ini memungkinkan penyebaran konteks sinkronisasi antar thread dan digunakan untuk mengatur panggilan balik atau invokasi ke thread atau konteks sinkronisasi yang tepat. Implementasi dummy. 
