...
description: Menentukan ukuran selembar kertas.
type: docs
weight: 27
url: /id/system.drawing.printing/papersize/
---
## Kelas PaperSize
...
| **int32_t** [get_Height](./get_height/)() const | Mengambil tinggi kertas, dalam satuan satu per seratus inci. |
| [PaperKind](../paperkind/) [get_Kind](./get_kind/)() const | Mengambil tipe kertas. |
| [System::String](../../system/string/) [get_PaperName](./get_papername/)() const | Mengambil nama tipe kertas. |
| **int32_t** [get_RawKind](./get_rawkind/)() const | Mengambil integer yang mewakili salah satu nilai [System::Drawing::Printing::PaperSize](./) atau nilai khusus. |
| **int32_t** [get_Width](./get_width/)() const | Mengambil lebar kertas, dalam satuan satu per seratus inci. |
...
|  [PaperSize](./papersize/)() | Menginisialisasi instance baru dari kelas [System::Drawing::Printing::PaperSize](./). |
|  [PaperSize](./papersize/)([PaperKind](../paperkind/), [System::String](../../system/string/), **int32_t**, **int32_t**) | Menginisialisasi instance baru dari kelas [System::Drawing::Printing::PaperSize](./). |
|  [PaperSize](./papersize/)([System::String](../../system/string/), **int32_t**, **int32_t**) | Menginisialisasi instance baru dari kelas [System::Drawing::Printing::PaperSize](./). |
...
| void [set_Height](./set_height/)(**int32_t**) | Mengatur tinggi kertas, dalam satuan satu per seratus inci. |
| void [set_PaperName](./set_papername/)([System::String](../../system/string/)) | Mengatur nama tipe kertas. |
| void [set_RawKind](./set_rawkind/)(**int32_t**) | Mengatur integer yang mewakili salah satu nilai [System::Drawing::Printing::PaperSize](./) atau nilai khusus. |
| void [set_Width](./set_width/)(**int32_t**) | Mengatur lebar kertas, dalam satuan satu per seratus inci. |
...
| [System::String](../../system/string/) [ToString](./tostring/)() const override | Memberikan informasi tentang [System::Drawing::Printing::PaperSize](./) dalam bentuk string. |
