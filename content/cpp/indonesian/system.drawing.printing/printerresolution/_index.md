...
| int [get_X](./get_x/)() const | Mengembalikan resolusi horizontal. |
| int [get_Y](./get_y/)() const | Mengembalikan resolusi vertikal. |
...
| void [set_X](./set_x/)(int) | Mengatur resolusi horizontal. |
| void [set_Y](./set_y/)(int) | Mengatur resolusi vertikal. |
