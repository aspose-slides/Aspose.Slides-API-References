...
description: Mewakili faset totalDigits dari XML Schema sebagaimana ditentukan oleh World Wide Web Consortium (W3C). Kelas ini dapat digunakan untuk menentukan pembatasan pada jumlah digit yang dapat dimasukkan untuk nilai elemen simpleType. Nilai totalDigits harus berupa bilangan bulat positif.
type: docs
weight: 898
url: /id/system.xml.schema/xmlschematotaldigitsfacet/
---
## XmlSchemaTotalDigitsFacet kelas

Mewakili faset **totalDigits** dari XML [Schema](../) sebagaimana ditentukan oleh Konsorsium World Wide [Web](../../system.web/) (W3C). Kelas ini dapat digunakan untuk menentukan pembatasan pada jumlah digit yang dapat dimasukkan untuk nilai elemen **simpleType**. Nilai **totalDigits** tersebut harus berupa bilangan bulat positif.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Mengembalikan informasi yang menunjukkan bahwa faset ini bersifat tetap. |
...
| [String](../../system/string/) [get_Value](../xmlschemafacet/get_value/)() | Mengembalikan atribut **value** dari faset. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek mewakili sebuah instansi tipe yang dijelaskan oleh targetType. Analog dari operator C# 'is'. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Mengatur informasi yang menunjukkan bahwa faset ini bersifat tetap. |
...
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Mengatur atribut **value** dari faset. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan mengubah pointer di dalam kontainer ke mode lemah. |
...
|  [XmlSchemaFacet](../xmlschemafacet/xmlschemafacet/)() | Menginisialisasi instansi baru dari kelas [XmlSchemaFacet](../xmlschemafacet/). |
...
|  [XmlSchemaTotalDigitsFacet](./xmlschematotaldigitsfacet/)() | Menginisialisasi instansi baru dari kelas [XmlSchemaTotalDigitsFacet](./). |
...
Objek dari kelas ini sebaiknya hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instansi tipe ini pada stack atau menggunakan operator new, karena akan mengakibatkan error waktu jalan dan/atau kegagalan assert. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen. 

## Lihat Juga

* Kelas [XmlSchemaNumericFacet](../xmlschemanumericfacet/)
