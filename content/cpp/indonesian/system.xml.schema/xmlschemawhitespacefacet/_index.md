...
description: Mewakili facet whiteSpace dari World Wide Web Consortium (W3C).
type: docs
weight: 950
url: /id/system.xml.schema/xmlschemawhitespacefacet/
---
## XmlSchemaWhiteSpaceFacet kelas


Mewakili Konsorsium World Wide [Web](../../system.web/) (W3C) **whiteSpace** facet.
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Menetapkan XmlSerializerNamespaces yang digunakan dengan objek skema ini. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Menetapkan atribut yang memenuhi syarat yang tidak termasuk dalam namespace target skema saat ini. |
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Menetapkan atribut **value** dari facet. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan mengubah pointer dalam container ke mode weak. |
...
|  [XmlSchemaWhiteSpaceFacet](./xmlschemawhitespacefacet/)() | Menginisialisasi instance baru dari kelas [XmlSchemaWhiteSpaceFacet](./). |
