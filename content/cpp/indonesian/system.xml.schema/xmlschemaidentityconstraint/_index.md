...
description: "Kelas untuk batas identitas: elemen key, keyref, dan unique."
type: docs
weight: 469
url: /id/system.xml.schema/xmlschemaidentityconstraint/
---
## XmlSchemaIdentityConstraint kelas

Kelas untuk batas identitas: elemen **key**, **keyref**, dan **unique**.
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Fields](./get_fields/)() | Mengembalikan koleksi bidang yang berlaku sebagai anak untuk pemilih ekspresi XML Path Language ([XPath](../../system.xml.xpath/)). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Mengembalikan nama dari batas identitas. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Mengembalikan nama terkualifikasi dari batas identitas, yang menyimpan interpretasi pasca-kompilasi nilai **QualifiedName**. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\> [get_Selector](./get_selector/)() | Mengembalikan elemen **selector** ekspresi [XPath](../../system.xml.xpath/). |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Mengembalikan atribut terkualifikasi yang tidak termasuk dalam ruang nama target skema saat ini. |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | Menetapkan nomor baris dalam file yang direferensikan oleh elemen **schema**. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Menetapkan posisi baris dalam file yang direferensikan oleh elemen **schema**. |
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Menetapkan nama batas identitas. |
...
| void [set_Selector](./set_selector/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaXPath](../xmlschemaxpath/)\>\&) | Menetapkan elemen **selector** ekspresi [XPath](../../system.xml.xpath/). |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Menetapkan atribut terkualifikasi yang tidak termasuk dalam ruang nama target skema saat ini. |
...
|  [XmlSchemaIdentityConstraint](./xmlschemaidentityconstraint/)() | Menginisialisasi instansi baru dari kelas [XmlSchemaIdentityConstraint](./). |
...
| Typedef | Deskripsi |
| --- | --- |
| [Ptr](./ptr/) | Alih nama untuk shared pointer ke sebuah instansi kelas ini. |

## Catatan

Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instansi tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen. 
