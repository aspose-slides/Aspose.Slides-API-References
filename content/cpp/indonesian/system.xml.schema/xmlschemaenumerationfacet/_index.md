...
description: Mewakili facet enumerasi dari XML Schema sebagaimana ditetapkan oleh World Wide Web Consortium (W3C). Kelas ini menentukan daftar nilai yang valid untuk elemen simpleType. Deklarasi berada dalam deklarasi restriction.
type: docs
weight: 378
url: /id/system.xml.schema/xmlschemaenumerationfacet/
---
## XmlSchemaEnumerationFacet kelas

Represents the **enumeration** facet from XML [Schema](../) as specified by the World Wide [Web](../../system.web/) Consortium (W3C). This kelas specifies a list of valid values for a simpleType element. Declaration is contained within a **restriction** declaration.
...
|  [XmlSchemaEnumerationFacet](./xmlschemaenumerationfacet/)() | Menginisialisasi sebuah instance baru dari kelas [XmlSchemaEnumerationFacet](./). |
