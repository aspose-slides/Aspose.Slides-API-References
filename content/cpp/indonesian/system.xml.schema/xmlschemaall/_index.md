...
description: Mewakili elemen all (kompositor) dari World Wide Web Consortium (W3C).
type: docs
weight: 92
url: /id/system.xml.schema/xmlschemaall/
---
## XmlSchemaAll kelas

Mewakili World Wide [Web](../../system.web/) Consortium (W3C) **all** elemen (kompositor).
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() override | Mengembalikan koleksi elemen [XmlSchemaElement](../xmlschemaelement/) yang terdapat dalam kompositor **all**. |
| **int32_t** [get_LineNumber](../xmlschemaobject/get_linenumber/)() | Mengembalikan nomor baris dalam file yang direferensikan oleh elemen **schema**. |
| **int32_t** [get_LinePosition](../xmlschemaobject/get_lineposition/)() | Mengembalikan posisi baris dalam file yang direferensikan oleh elemen **schema**. |
| [Decimal](../../system/decimal/) [get_MaxOccurs](../xmlschemaparticle/get_maxoccurs/)() | Mengembalikan jumlah maksimum kemunculan partikel. |
| [String](../../system/string/) [get_MaxOccursString](../xmlschemaparticle/get_maxoccursstring/)() | Mengembalikan angka sebagai nilai string. Jumlah maksimum kemunculan partikel. |
| [Decimal](../../system/decimal/) [get_MinOccurs](../xmlschemaparticle/get_minoccurs/)() | Mengembalikan jumlah minimum kemunculan partikel. |
| [String](../../system/string/) [get_MinOccursString](../xmlschemaparticle/get_minoccursstring/)() | Mengembalikan angka sebagai nilai string. Jumlah minimum kemunculan partikel. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Mengembalikan atribut yang berkualifikasi yang tidak termasuk dalam namespace target skema saat ini. |
...
| void [set_LineNumber](../xmlschemaobject/set_linenumber/)(**int32_t**) | Mengatur nomor baris dalam file yang direferensikan oleh elemen **schema**. |
| void [set_LinePosition](../xmlschemaobject/set_lineposition/)(**int32_t**) | Mengatur posisi baris dalam file yang direferensikan oleh elemen **schema**. |
| void [set_MaxOccurs](../xmlschemaparticle/set_maxoccurs/)([Decimal](../../system/decimal/)) | Mengatur jumlah maksimum kemunculan partikel. |
| void [set_MaxOccursString](../xmlschemaparticle/set_maxoccursstring/)(const [String](../../system/string/)\&) | Mengatur angka sebagai nilai string. Jumlah maksimum kemunculan partikel. |
| void [set_MinOccurs](../xmlschemaparticle/set_minoccurs/)([Decimal](../../system/decimal/)) | Mengatur jumlah minimum kemunculan partikel. |
| void [set_MinOccursString](../xmlschemaparticle/set_minoccursstring/)(const [String](../../system/string/)\&) | Mengatur angka sebagai nilai string. Jumlah minimum kemunculan partikel. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Mengatur atribut yang berkualifikasi yang tidak termasuk dalam namespace target skema saat ini. |
...
|  [XmlSchemaAll](./xmlschemaall/)() | Menginisialisasi instansi baru dari kelas [XmlSchemaAll](./). |
