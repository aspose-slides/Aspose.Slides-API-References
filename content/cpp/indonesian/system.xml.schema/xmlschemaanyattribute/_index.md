...
description: Mewakili elemen anyAttribute dari World Wide Web Consortium (W3C).
type: docs
weight: 144
url: /id/system.xml.schema/xmlschemaanyattribute/
---
## XmlSchemaAnyAttribute kelas

Mewakili elemen **anyAttribute** World Wide [Web](../../system.web/) Consortium (W3C).
...
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Mengembalikan namespace yang berisi atribut yang dapat digunakan. |
...
| [XmlSchemaContentProcessing](../xmlschemacontentprocessing/) [get_ProcessContents](./get_processcontents/)() | Mengembalikan informasi tentang cara aplikasi atau pemroses XML harus menangani validasi dokumen XML untuk atribut yang ditentukan oleh elemen **anyAttribute**. |
...
| void [set_Namespace](./set_namespace/)(const [String](../../system/string/)\&) | Mengatur namespace yang berisi atribut yang dapat digunakan. |
...
| void [set_ProcessContents](./set_processcontents/)([XmlSchemaContentProcessing](../xmlschemacontentprocessing/)) | Mengatur informasi tentang cara aplikasi atau pemroses XML harus menangani validasi dokumen XML untuk atribut yang ditentukan oleh elemen **anyAttribute**. |
...
|  [XmlSchemaAnyAttribute](./xmlschemaanyattribute/)() | Menginisialisasi instance baru dari kelas [XmlSchemaAnyAttribute](./). |
