...
description: Mengembalikan informasi terperinci tentang pengecualian skema.
type: docs
weight: 1
url: /id/system.xml.schema/details_xmlschemaexception/
---
## Details_XmlSchemaException kelas
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Mengembalikan nomor baris yang menunjukkan di mana kesalahan terjadi. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Mengembalikan posisi baris yang menunjukkan di mana kesalahan terjadi. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Mengembalikan deskripsi kondisi kesalahan dari pengecualian ini. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_SourceSchemaObject](./get_sourceschemaobject/)() | **[XmlSchemaObject](../xmlschemaobject/)** yang menghasilkan XmlSchemaException. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Mengembalikan lokasi Uniform Resource Identifier (URI) dari skema yang menyebabkan pengecualian. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen templat ke-n menjadi weak pointer (daripada shared). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
