...
description: Kelas dasar untuk itu adalah kelas dasar untuk semua tipe partikel (misalnya XmlSchemaAny).
type: docs
weight: 729
url: /id/system.xml.schema/xmlschemaparticle/
---
## XmlSchemaParticle kelas
...
| [Decimal](../../system/decimal/) [get_MaxOccurs](./get_maxoccurs/)() | Mengembalikan jumlah maksimum kali partikel dapat muncul. |
| [String](../../system/string/) [get_MaxOccursString](./get_maxoccursstring/)() | Mengembalikan angka sebagai nilai string. Jumlah maksimum kali partikel dapat muncul. |
| [Decimal](../../system/decimal/) [get_MinOccurs](./get_minoccurs/)() | Mengembalikan jumlah minimum kali partikel dapat muncul. |
| [String](../../system/string/) [get_MinOccursString](./get_minoccursstring/)() | Mengembalikan angka sebagai nilai string. Jumlah minimum kali partikel dapat muncul. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengaktifkan konstruksi penyalinan subclass. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengaktifkan konstruksi penyalinan subclass. |
...
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Menetapkan id string. |
...
| void [set_MaxOccurs](./set_maxoccurs/)([Decimal](../../system/decimal/)) | Menetapkan jumlah maksimum kali partikel dapat muncul. |
| void [set_MaxOccursString](./set_maxoccursstring/)(const [String](../../system/string/)\&) | Menetapkan angka sebagai nilai string. Jumlah maksimum kali partikel dapat muncul. |
| void [set_MinOccurs](./set_minoccurs/)([Decimal](../../system/decimal/)) | Menetapkan jumlah minimum kali partikel dapat muncul. |
| void [set_MinOccursString](./set_minoccursstring/)(const [String](../../system/string/)\&) | Menetapkan angka sebagai nilai string. Jumlah minimum kali partikel dapat muncul. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Menetapkan atribut yang memenuhi syarat yang tidak termasuk dalam ruang nama target skema saat ini. |
...
|  [XmlSchemaParticle](./xmlschemaparticle/)() | Menginisialisasi instansi baru dari kelas [XmlSchemaParticle](./). |
...
Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instansi tipe ini pada stack atau menggunakan operator new, karena akan menyebabkan error runtime dan/atau kegagalan assertion. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen. 
