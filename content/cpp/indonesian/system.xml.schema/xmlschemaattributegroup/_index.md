...
description: Mewakili elemen attributeGroup dari XML Schema sebagaimana ditentukan oleh World Wide Web Consortium (W3C). AttributesGroups menyediakan mekanisme untuk mengelompokkan sekumpulan deklarasi atribut sehingga dapat dimasukkan sebagai grup ke dalam definisi tipe kompleks.
type: docs
weight: 183
url: /id/system.xml.schema/xmlschemaattributegroup/
---
## XmlSchemaAttributeGroup kelas
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Mengembalikan komponen [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) dari grup atribut. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Mengembalikan koleksi atribut untuk grup atribut. Berisi elemen [XmlSchemaAttribute](../xmlschemaattribute/) dan [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/). |
...
| [String](../../system/string/) [get_Name](./get_name/)() | Mengembalikan nama grup atribut. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Mengembalikan nama yang memenuhi syarat dari grup atribut. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttributeGroup](./)\> [get_RedefinedAttributeGroup](./get_redefinedattributegroup/)() | Mengembalikan properti grup atribut yang didefinisikan ulang dari XML [Schema](../). |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Mengatur komponen [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) dari grup atribut. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Mengatur nama grup atribut. |
...
|  [XmlSchemaAttributeGroup](./xmlschemaattributegroup/)() | Menginisialisasi sebuah instance baru dari kelas [XmlSchemaAttributeGroup](./). |
