...
description: Mewakili elemen minInclusive dari XML Schema sebagaimana ditentukan oleh World Wide Web Consortium (W3C). Kelas ini dapat digunakan untuk menentukan pembatasan pada nilai minimum dari elemen simpleType. Nilai elemen harus lebih besar dari atau sama dengan nilai elemen minInclusive.
type: docs
weight: 625
url: /id/system.xml.schema/xmlschemamininclusivefacet/
---
## XmlSchemaMinInclusiveFacet kelas


Mewakili elemen **minInclusive** dari XML [Schema](../) sebagaimana ditentukan oleh Konsorsium World Wide [Web](../../system.web/) (W3C). Kelas ini dapat digunakan untuk menentukan pembatasan pada nilai minimum dari elemen simpleType. Nilai elemen harus lebih besar dari atau sama dengan nilai elemen **minInclusive**.
