...
description: Mengembalikan informasi tentang kesalahan yang ditemui oleh kelas XmlSchemaInference saat menyimpulkan skema dari dokumen XML.
type: docs
weight: 14
url: /id/system.xml.schema/details_xmlschemainferenceexception/
---
## Details_XmlSchemaInferenceException kelas

Mengembalikan informasi tentang kesalahan yang ditemui oleh kelas [XmlSchemaInference](../xmlschemainference/) saat menyimpulkan skema dari dokumen XML.
...
| **int32_t** [get_LineNumber](../details_xmlschemaexception/get_linenumber/)() | Mengembalikan nomor baris yang menunjukkan lokasi terjadinya kesalahan. |
| **int32_t** [get_LinePosition](../details_xmlschemaexception/get_lineposition/)() | Mengembalikan posisi baris yang menunjukkan lokasi terjadinya kesalahan. |
...
| [String](../../system/string/) [get_SourceUri](../details_xmlschemaexception/get_sourceuri/)() | Mengembalikan lokasi Uniform Resource Identifier (URI) dari skema yang menyebabkan pengecualian. |
| virtual [String](../../system/string/) [get_StackTrace](../../system/details_exception/get_stacktrace/)() const | Mengembalikan string yang berisi jejak stack trace. |
