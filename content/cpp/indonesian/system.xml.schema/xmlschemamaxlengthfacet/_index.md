...
description: Mewakili elemen maxLength dari XML Schema sebagaimana ditetapkan oleh World Wide Web Consortium (W3C). Kelas ini dapat digunakan untuk menentukan pembatasan pada panjang maksimum nilai data dari elemen simpleType. Panjang harus kurang dari nilai elemen maxLength.
type: docs
weight: 599
url: /id/system.xml.schema/xmlschemamaxlengthfacet/
---
## XmlSchemaMaxLengthFacet kelas

Mewakili elemen **maxLength** dari XML [Schema](../) sebagaimana ditentukan oleh Konsorsium World Wide [Web](../../system.web/) (W3C). Kelas ini dapat digunakan untuk menentukan pembatasan pada panjang maksimum nilai data dari elemen **simpleType**. Panjang harus kurang dari nilai elemen **maxLength**.
...
| virtual **bool** [get_IsFixed](../xmlschemafacet/get_isfixed/)() | Mengembalikan informasi yang menunjukkan bahwa facet ini tetap. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Mengembalikan atribut yang memenuhi kualifikasi yang tidak termasuk dalam namespace target skema saat ini. |
...
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Mengatur informasi yang menunjukkan bahwa facet ini tetap. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Mengatur atribut yang memenuhi kualifikasi yang tidak termasuk dalam namespace target skema saat ini. |
...
|  [XmlSchemaMaxLengthFacet](./xmlschemamaxlengthfacet/)() | Menginisialisasi instansi baru dari kelas [XmlSchemaMaxLengthFacet](./). |
