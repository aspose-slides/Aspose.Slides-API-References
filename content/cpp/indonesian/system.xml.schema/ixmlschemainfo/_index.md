...
description: Mendefinisikan infoset pasca-validasi skema dari sebuah node XML yang telah divalidasi.
type: docs
weight: 40
url: /id/system.xml.schema/ixmlschemainfo/
---
## IXmlSchemaInfo kelas

Mendefinisikan infoset pasca-validasi skema dari sebuah node XML yang telah divalidasi.
...
| virtual **bool** [get_IsDefault](./get_isdefault/)() | Mengembalikan nilai yang menunjukkan apakah node XML yang divalidasi ini diatur sebagai hasil dari nilai default yang diterapkan selama validasi skema XML [Schema](../) Definition Language (XSD). |
| virtual **bool** [get_IsNil](./get_isnil/)() | Mengembalikan nilai yang menunjukkan apakah nilai untuk node XML yang divalidasi ini adalah **nil**. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_MemberType](./get_membertype/)() | Mengembalikan tipe skema dinamis untuk node XML yang divalidasi ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAttribute](../xmlschemaattribute/)\> [get_SchemaAttribute](./get_schemaattribute/)() | Mengembalikan [XmlSchemaAttribute](../xmlschemaattribute/) yang telah dikompilasi yang sesuai dengan node XML yang divalidasi ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaElement](../xmlschemaelement/)\> [get_SchemaElement](./get_schemaelement/)() | Mengembalikan [XmlSchemaElement](../xmlschemaelement/) yang telah dikompilasi yang sesuai dengan node XML yang divalidasi ini. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaType](../xmlschematype/)\> [get_SchemaType](./get_schematype/)() | Mengembalikan tipe skema XML [Schema](../) Definition Language (XSD) statis dari node XML yang divalidasi ini. |
| virtual [XmlSchemaValidity](../xmlschemavalidity/) [get_Validity](./get_validity/)() | Mengembalikan nilai XmlSchemaValidity dari node XML yang divalidasi ini. |
