...
description: Mewakili elemen anotasi World Wide Web Consortium (W3C).
type: docs
weight: 118
url: /id/system.xml.schema/xmlschemaannotation/
---
## XmlSchemaAnnotation kelas
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Items](./get_items/)() | Mengembalikan koleksi **Items** yang digunakan untuk menyimpan elemen anak **appinfo** dan **documentation**. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](./get_unhandledattributes/)() | Mengembalikan atribut berkualifikasi yang tidak termasuk dalam namespace target skema. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Mengambil tipe aktual objek. Analog pemanggilan C# [System.Object.GetType()](../../system/object/gettype/). |
...
| void [set_Id](./set_id/)(const [String](../../system/string/)\&) | Menetapkan id string. |
...
| void [set_UnhandledAttributes](./set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Menetapkan atribut berkualifikasi yang tidak termasuk dalam namespace target skema. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen templat ke-n menjadi pointer lemah (bukan shared). Memungkinkan pergantian pointer dalam kontainer ke mode lemah. |
