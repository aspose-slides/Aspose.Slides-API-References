...
description: Menyediakan opsi kompilasi skema untuk kelas XmlSchemaSet. Kelas ini tidak dapat diwarisi.
type: docs
weight: 248
url: /id/system.xml.schema/xmlschemacompilationsettings/
---
## Kelas XmlSchemaCompilationSettings


Menyediakan opsi kompilasi skema untuk kelas [XmlSchemaSet](../xmlschemaset/). Kelas ini tidak dapat diwarisi.
...
| **bool** [get_EnableUpaCheck](./get_enableupacheck/)() | Mengembalikan nilai yang menunjukkan apakah [XmlSchemaSet](../xmlschemaset/) harus memeriksa pelanggaran Unique Particle Attribution (UPA). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan mengizinkan penyalinan konstruktor subkelas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan mengizinkan penyalinan konstruktor subkelas. |
...
| void [set_EnableUpaCheck](./set_enableupacheck/)(**bool**) | Mengatur nilai yang menunjukkan apakah [XmlSchemaSet](../xmlschemaset/) harus memeriksa pelanggaran Unique Particle Attribution (UPA). |
...
|  [XmlSchemaCompilationSettings](./xmlschemacompilationsettings/)() | Menginisialisasi sebuah instance baru dari kelas [XmlSchemaCompilationSettings](./). |
...
Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini pada stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu balut kelas ini dengan pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen. 
