...
description: Mewakili elemen dokumentasi dari XML Schema sebagaimana ditentukan oleh World Wide Web Consortium (W3C). Kelas ini menentukan informasi yang dapat dibaca atau digunakan oleh manusia dalam sebuah anotasi.
type: docs
weight: 352
url: /id/system.xml.schema/xmlschemadocumentation/
---
## XmlSchemaDocumentation kelas


Mewakili elemen **documentation** dari XML [Schema](../) sebagaimana ditentukan oleh Konsorsium World Wide [Web](../../system.web/) (W3C). Kelas ini menentukan informasi yang dapat dibaca atau digunakan oleh manusia dalam sebuah **annotation**.
...
| [String](../../system/string/) [get_Language](./get_language/)() | Mengembalikan atribut **xml:lang**. Ini berfungsi sebagai indikator bahasa yang digunakan dalam konten. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Mengembalikan array objek [XmlNode](../../system.xml/xmlnode/) yang mewakili node anak dokumentasi. |
...
| [String](../../system/string/) [get_Source](./get_source/)() | Mengembalikan Uniform Resource Identifier (URI) sumber informasi. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Mendapatkan tipe sesungguhnya dari objek. Analog dari panggilan C# [System.Object.GetType()](../../system/object/gettype/). |
...
| void [set_Language](./set_language/)(const [String](../../system/string/)\&) | Menetapkan atribut **xml:lang**. Ini berfungsi sebagai indikator bahasa yang digunakan dalam konten. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Menetapkan array objek [XmlNode](../../system.xml/xmlnode/) yang mewakili node anak dokumentasi. |
...
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Menetapkan Uniform Resource Identifier (URI) sumber informasi. |
...
Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan mengakibatkan kesalahan waktu jalan dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer tersebut untuk meneruskannya ke fungsi sebagai argumen. 
