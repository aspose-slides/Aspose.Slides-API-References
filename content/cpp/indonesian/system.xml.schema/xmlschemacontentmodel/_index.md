...
description: Menentukan urutan dan struktur elemen anak dari suatu tipe.
type: docs
weight: 326
url: /id/system.xml.schema/xmlschemacontentmodel/
---
## XmlSchemaContentModel kelas

Menentukan urutan dan struktur elemen anak dari suatu tipe.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\> [get_Content](./get_content/)() | Mengembalikan konten dari tipe tersebut. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek mewakili contoh dari tipe yang dijelaskan oleh targetType. Analog operator 'is' C#. |
...
| virtual void [set_Content](./set_content/)([SharedPtr](../../system/sharedptr/)\<[XmlSchemaContent](../xmlschemacontent/)\>) | Mengatur konten tipe. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi weak pointer (bukan shared). Mengizinkan penggantian pointer dalam kontainer ke mode weak. |
