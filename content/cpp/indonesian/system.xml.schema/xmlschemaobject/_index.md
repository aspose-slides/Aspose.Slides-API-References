...
description: Mewakili kelas akar untuk hierarki model objek skema Xml dan berfungsi sebagai kelas dasar untuk kelas seperti kelas XmlSchema.
type: docs
weight: 677
url: /id/system.xml.schema/xmlschemaobject/
---
## XmlSchemaObject kelas


Mewakili kelas akar untuk hierarki model objek skema [Xml](../../system.xml/) dan berfungsi sebagai kelas dasar untuk kelas seperti kelas [XmlSchema](../xmlschema/).
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Mengembalikan nomor baris dalam file yang menjadi referensi elemen **skema**. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Mengembalikan posisi baris dalam file yang menjadi referensi elemen **skema**. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](./get_namespaces/)() | Mengembalikan XmlSerializerNamespaces yang digunakan dengan objek skema ini. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\> [get_Parent](./get_parent/)() | Mengembalikan induk dari [XmlSchemaObject](./) ini. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Mengembalikan lokasi sumber untuk file yang memuat skema. |
...
| void [set_LineNumber](./set_linenumber/)(**int32_t**) | Mengatur nomor baris dalam file yang menjadi referensi elemen **skema**. |
| void [set_LinePosition](./set_lineposition/)(**int32_t**) | Mengatur posisi baris dalam file yang menjadi referensi elemen **skema**. |
| void [set_Namespaces](./set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Mengatur XmlSerializerNamespaces yang akan digunakan dengan objek skema ini. |
| void [set_Parent](./set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](./)\>\&) | Mengatur induk dari [XmlSchemaObject](./) ini. |
| void [set_SourceUri](./set_sourceuri/)(const [String](../../system/string/)\&) | Mengatur lokasi sumber untuk file yang memuat skema. |
...
| static const [TypeInfo](../../system/typeinfo/)\& [Type](../../system/object/type/)() | Mengimplementasikan konstruk tipe typeof([System.Object](../../system/object/)) C#. |
...
Objek dari kelas ini sebaiknya hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance dari tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer tersebut untuk meneruskannya ke fungsi sebagai argumen. 
