...
description: Mewakili elemen minExclusive dari XML Schema sebagaimana ditentukan oleh World Wide Web Consortium (W3C). Kelas ini dapat digunakan untuk menentukan pembatasan pada nilai minimum dari elemen simpleType. Nilai elemen harus lebih besar daripada nilai elemen minExclusive.
type: docs
weight: 612
url: /id/system.xml.schema/xmlschemaminexclusivefacet/
---
## XmlSchemaMinExclusiveFacet kelas

Mewakili elemen **minExclusive** dari XML [Schema](../) sebagaimana ditentukan oleh Konsorsium World Wide [Web](../../system.web/) (W3C). Kelas ini dapat digunakan untuk menentukan pembatasan pada nilai minimum dari elemen **simpleType**. Nilai elemen harus lebih besar daripada nilai elemen **minExclusive**.
...
|  [XmlSchemaFacet](../xmlschemafacet/xmlschemafacet/)() | Menginisialisasi contoh baru dari kelas [XmlSchemaFacet](../xmlschemafacet/). |
|  [XmlSchemaMinExclusiveFacet](./xmlschemaminexclusivefacet/)() | Menginisialisasi contoh baru dari kelas [XmlSchemaMinExclusiveFacet](./). |
...
Objek dari kelas ini harus hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat contoh tipe ini di stack atau menggunakan operator new, karena hal itu akan menyebabkan kesalahan waktu jalan dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer tersebut untuk meneruskannya ke fungsi sebagai argumen. 
