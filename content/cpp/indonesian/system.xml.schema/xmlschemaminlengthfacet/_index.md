...
description: Mewakili elemen minLength dari XML Schema sebagaimana ditentukan oleh World Wide Web Consortium (W3C). Kelas ini dapat digunakan untuk menentukan batasan pada panjang minimum nilai data dari elemen simpleType. Panjang harus lebih besar daripada nilai elemen minLength.
type: docs
weight: 638
url: /id/system.xml.schema/xmlschemaminlengthfacet/
---
## XmlSchemaMinLengthFacet kelas


Mewakili elemen **minLength** dari XML [Schema](../) sebagaimana ditentukan oleh Konsorsium World Wide [Web](../../system.web/) (W3C). Kelas ini dapat digunakan untuk menentukan batasan pada panjang minimum nilai data dari elemen **simpleType**. Panjang harus lebih besar daripada nilai elemen **minLength**.
...
|  [XmlSchemaMinLengthFacet](./xmlschemaminlengthfacet/)() | Menginisialisasi instance baru dari kelas [XmlSchemaMinLengthFacet](./). |
