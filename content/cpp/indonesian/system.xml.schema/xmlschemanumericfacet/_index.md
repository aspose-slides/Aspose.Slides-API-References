...
description: Sebuah kelas vas untuk mendefinisikan facet numerik. Kelas ini adalah kelas dasar untuk kelas facet numerik seperti XmlSchemaMinLengthFacet.
type: docs
weight: 664
url: /id/system.xml.schema/xmlschemanumericfacet/
---
## XmlSchemaNumericFacet kelas


Sebuah kelas vas untuk mendefinisikan **numerik** facet. Kelas ini adalah kelas dasar untuk kelas facet numerik seperti [XmlSchemaMinLengthFacet](../xmlschemaminlengthfacet/).
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Mengembalikan orang tua dari [XmlSchemaObject](../xmlschemaobject/) ini. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Mengembalikan atribut terkuantifikasi yang tidak termasuk dalam namespace target skema saat ini. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor salin. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan konstruk penyalinan pada subclass. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Menetapkan orang tua dari [XmlSchemaObject](../xmlschemaobject/) ini. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Menetapkan atribut terkuantifikasi yang tidak termasuk dalam namespace target skema saat ini. |
