...
description: Mewakili elemen maxExclusive dari XML Schema sebagaimana ditetapkan oleh World Wide Web Consortium (W3C). Kelas ini dapat digunakan untuk menentukan pembatasan pada nilai maksimum elemen simpleType. Nilai elemen harus lebih kecil dari nilai elemen maxExclusive.
type: docs
weight: 573
url: /id/system.xml.schema/xmlschemamaxexclusivefacet/
---
## XmlSchemaMaxExclusiveFacet kelas


Mewakili elemen **maxExclusive** dari XML [Schema](../) sebagaimana ditetapkan oleh Konsorsium World Wide [Web](../../system.web/) (W3C). Kelas ini dapat digunakan untuk menentukan pembatasan pada nilai maksimum elemen **simpleType**. Nilai elemen harus lebih kecil dari nilai elemen **maxExclusive**.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, hanya menginisialisasi objek baru dan mengaktifkan penyalinan konstruktor subclass. |
...
| void [set_Annotation](../xmlschemaannotated/set_annotation/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnnotation](../xmlschemaannotation/)\>\&) | Menetapkan properti **annotation**. |
| void [set_Id](../xmlschemaannotated/set_id/)(const [String](../../system/string/)\&) | Menetapkan string id. |
| virtual void [set_IsFixed](../xmlschemafacet/set_isfixed/)(**bool**) | Menetapkan informasi yang menunjukkan bahwa facet ini bersifat tetap. |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Menetapkan atribut berkualifikasi yang tidak termasuk dalam namespace target skema saat ini. |
| void [set_Value](../xmlschemafacet/set_value/)(const [String](../../system/string/)\&) | Menetapkan atribut **value** dari facet. |
...
|  [XmlSchemaMaxExclusiveFacet](./xmlschemamaxexclusivefacet/)() | Menginisialisasi instance baru dari kelas [XmlSchemaMaxExclusiveFacet](./). |
...
Objek dari kelas ini sebaiknya hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena dapat menyebabkan kesalahan runtime dan/atau kegagalan assertion. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer tersebut untuk menyampaikannya ke fungsi sebagai argumen. 
