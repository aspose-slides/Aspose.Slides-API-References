...
description: Mewakili elemen restriction untuk konten sederhana dari XML Schema sebagaimana ditentukan oleh World Wide Web Consortium (W3C). Kelas ini dapat digunakan untuk menghasilkan tipe sederhana dengan pembatasan. Derivasi semacam itu dapat digunakan untuk membatasi rentang nilai elemen ke subset nilai yang ditentukan dalam tipe sederhana yang diwarisi.
type: docs
weight: 820
url: /id/system.xml.schema/xmlschemasimplecontentrestriction/
---
## XmlSchemaSimpleContentRestriction kelas
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\> [get_AnyAttribute](./get_anyattribute/)() | Mengembalikan sebuah [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) untuk digunakan sebagai nilai atribut. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Attributes](./get_attributes/)() | Mengembalikan koleksi [XmlSchemaAttribute](../xmlschemaattribute/) dan [XmlSchemaAttributeGroupRef](../xmlschemaattributegroupref/) atribut untuk tipe sederhana. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | Mengembalikan nilai dasar tipe sederhana. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Mengembalikan nama tipe data bawaan atau tipe sederhana dari mana tipe ini diturunkan. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | Mengembalikan facet [Xml](../../system.xml/)[Schema](../). |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Mengembalikan induk [XmlSchemaObject](../xmlschemaobject/). |
...
| void [set_AnyAttribute](./set_anyattribute/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaAnyAttribute](../xmlschemaanyattribute/)\>\&) | Menetapkan [XmlSchemaAnyAttribute](../xmlschemaanyattribute/) untuk digunakan sebagai nilai atribut. |
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Menetapkan nilai dasar tipe sederhana. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Menetapkan nama tipe data bawaan atau tipe sederhana dari mana tipe ini diturunkan. |
...
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Menetapkan XmlSerializerNamespaces untuk digunakan dengan objek skema ini. |
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Menetapkan induk [XmlSchemaObject](../xmlschemaobject/). |
...
|  [XmlSchemaSimpleContentRestriction](./xmlschemasimplecontentrestriction/)() | Menginisialisasi instance baru dari kelas [XmlSchemaSimpleContentRestriction](./). |
...
Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini pada stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu balut kelas ini dengan pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer tersebut untuk melewatkannya ke fungsi sebagai argumen. 
