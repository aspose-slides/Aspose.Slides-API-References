...
description: Kelas dasar untuk semua facet yang digunakan ketika tipe sederhana diturunkan dengan pembatasan.
type: docs
weight: 404
url: /id/system.xml.schema/xmlschemafacet/
---
## XmlSchemaFacet kelas
...
| virtual **bool** [get_IsFixed](./get_isfixed/)() | Returns information that indicates that this facet is fixed. |
...
| [String](../../system/string/) [get_Value](./get_value/)() | Returns the **value** attribute of the facet. |
...
| virtual void [set_IsFixed](./set_isfixed/)(**bool**) | Sets information that indicates that this facet is fixed. |
...
| void [set_Value](./set_value/)(const [String](../../system/string/)\&) | Sets the **value** attribute of the facet. |
...
Objek dari kelas ini hanya boleh dialokasikan menggunakan [System::MakeObject()](../../system/makeobject/) function. Never create instances of this type on stack or using operator new, as it will result in runtime errors and/or assertion faults. Always wrap this class into [System::SmartPtr](../../system/smartptr/) pointer and use this pointer to pass it to functions as argument. 
