...
description: Mewakili elemen restriction untuk tipe sederhana dari XML Schema sebagaimana ditentukan oleh World Wide Web Consortium (W3C). Kelas ini dapat digunakan untuk membatasi elemen simpleType.
type: docs
weight: 872
url: /id/system.xml.schema/xmlschemasimpletyperestriction/
---
## XmlSchemaSimpleTypeRestriction kelas
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\> [get_BaseType](./get_basetype/)() | Mengembalikan informasi tentang tipe dasar. |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_BaseTypeName](./get_basetypename/)() | Mengembalikan nama tipe dasar yang memenuhi syarat. |
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObjectCollection](../xmlschemaobjectcollection/)\> [get_Facets](./get_facets/)() | Mengembalikan sebuah facet [Xml](../../system.xml/)[Schema](../). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek merepresentasikan sebuah contoh dari tipe yang dijelaskan oleh targetType. Analog operator 'is' C#. |
...
| void [set_BaseType](./set_basetype/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaSimpleType](../xmlschemasimpletype/)\>\&) | Mengatur informasi tentang tipe dasar. |
| void [set_BaseTypeName](./set_basetypename/)(const [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\>\&) | Mengatur nama tipe dasar yang memenuhi syarat. |
...
|  [XmlSchemaSimpleTypeRestriction](./xmlschemasimpletyperestriction/)() | Menginisialisasi instansi baru dari kelas [XmlSchemaSimpleTypeRestriction](./). |
