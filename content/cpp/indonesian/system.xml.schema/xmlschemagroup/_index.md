...
description: Mewakili elemen group dari XML Schema sebagaimana ditentukan oleh World Wide Web Consortium (W3C). Kelas ini mendefinisikan grup pada tingkat schema yang dirujuk dari tipe kompleks. Ini mengelompokkan sekumpulan deklarasi elemen sehingga dapat dimasukkan sebagai grup ke dalam definisi tipe kompleks.
type: docs
weight: 430
url: /id/system.xml.schema/xmlschemagroup/
---
## XmlSchemaGroup kelas

Mewakili elemen **group** dari XML [Schema](../) sebagaimana ditentukan oleh Konsorsium World Wide [Web](../../system.web/) (W3C). Kelas ini mendefinisikan grup pada tingkat **schema** yang direferensikan dari tipe kompleks. Ini mengelompokkan sekumpulan deklarasi elemen sehingga dapat dimasukkan sebagai grup ke dalam definisi tipe kompleks.
...
| [String](../../system/string/) [get_Name](./get_name/)() | Mengembalikan nama grup schema. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Mengembalikan XmlSerializerNamespaces yang digunakan dengan objek schema ini. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\> [get_Particle](./get_particle/)() | Mengembalikan salah satu dari kelas [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/), atau [XmlSchemaSequence](../xmlschemasequence/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlQualifiedName](../../system.xml/xmlqualifiedname/)\> [get_QualifiedName](./get_qualifiedname/)() | Mengembalikan nama yang memenuhi syarat dari grup schema. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Mengembalikan atribut yang memenuhi syarat yang tidak termasuk dalam ruang nama target schema saat ini. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Mengatur nama grup schema. |
...
| void [set_Particle](./set_particle/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaGroupBase](../xmlschemagroupbase/)\>\&) | Mengatur salah satu kelas [XmlSchemaChoice](../xmlschemachoice/), [XmlSchemaAll](../xmlschemaall/), atau [XmlSchemaSequence](../xmlschemasequence/). |
...
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Mengatur atribut yang memenuhi syarat yang tidak termasuk dalam ruang nama target schema saat ini. |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Mendapatkan nilai terkini dari penghitung referensi bersama. |
...
Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance dari tipe ini pada stack atau menggunakan operator new, karena akan menghasilkan kesalahan waktu jalan dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam penunjuk [System::SmartPtr](../../system/smartptr/) dan gunakan penunjuk tersebut untuk mengirimkannya ke fungsi sebagai argumen. 

## Lihat Juga

* Kelas [XmlSchemaAnnotated](../xmlschemaannotated/)
