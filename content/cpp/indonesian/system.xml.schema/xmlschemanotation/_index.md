...
description: Mewakili elemen notation dari XML Schema sebagaimana ditentukan oleh World Wide Web Consortium (W3C). Deklarasi XML Schemanotation merupakan rekonstruksi dari deklarasi NOTATION XML 1.0. Tujuan notasi adalah untuk mendeskripsikan format data non-XML di dalam dokumen XML.
type: docs
weight: 651
url: /id/system.xml.schema/xmlschemanotation/
---
...
| [String](../../system/string/) [get_Name](./get_name/)() | Mengembalikan nama notasi. |
| [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\> [get_Namespaces](../xmlschemaobject/get_namespaces/)() | Mengembalikan XmlSerializerNamespaces yang akan digunakan dengan objek schema ini. |
...
| [String](../../system/string/) [get_Public](./get_public/)() | Mengembalikan identifier **public**. |
| [String](../../system/string/) [get_SourceUri](../xmlschemaobject/get_sourceuri/)() | Mengembalikan lokasi sumber untuk file yang memuat schema. |
| [String](../../system/string/) [get_System](./get_system/)() | Mengembalikan identifier **system**. |
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\> [get_UnhandledAttributes](../xmlschemaannotated/get_unhandledattributes/)() | Mengembalikan atribut yang memenuhi syarat yang tidak termasuk dalam namespace target schema saat ini. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalinan. Tidak menyalin apa pun, benar-benar, hanya menginisialisasi objek baru dan mengaktifkan penyalinan konstruktor subkelas. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operator penugasan. Tidak menyalin apa pun, benar-benar, hanya menginisialisasi objek baru dan mengaktifkan penyalinan konstruktor subkelas. |
...
| void [set_Name](./set_name/)(const [String](../../system/string/)\&) | Mengatur nama notasi. |
| void [set_Namespaces](../xmlschemaobject/set_namespaces/)(const [SharedPtr](../../system/sharedptr/)\<[System::Xml::Serialization::XmlSerializerNamespaces](../../system.xml.serialization/xmlserializernamespaces/)\>\&) | Mengatur XmlSerializerNamespaces yang akan digunakan dengan objek schema ini. |
...
| void [set_Public](./set_public/)(const [String](../../system/string/)\&) | Mengatur identifier **public**. |
| void [set_SourceUri](../xmlschemaobject/set_sourceuri/)(const [String](../../system/string/)\&) | Mengatur lokasi sumber untuk file yang memuat schema. |
| void [set_System](./set_system/)(const [String](../../system/string/)\&) | Mengatur identifier **system**. |
| void [set_UnhandledAttributes](../xmlschemaannotated/set_unhandledattributes/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../../system.xml/xmlattribute/)\>\>\&) | Mengatur atribut yang memenuhi syarat yang tidak termasuk dalam namespace target schema saat ini. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen template ke-n menjadi pointer lemah (bukan bersama). Memungkinkan penggantian pointer dalam kontainer ke mode lemah. |
...
|  [XmlSchemaNotation](./xmlschemanotation/)() | Menginisialisasi instance baru dari kelas [XmlSchemaNotation](./). |
...
Objek dari kelas ini sebaiknya hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance dari tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu balut kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk melewatkannya ke fungsi sebagai argumen. 
