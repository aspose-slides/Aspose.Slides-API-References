...
description: Mewakili elemen appinfo dari World Wide Web Consortium (W3C).
type: docs
weight: 157
url: /id/system.xml.schema/xmlschemaappinfo/
---
## XmlSchemaAppInfo kelas

Mewakili elemen **appinfo** dari World Wide [Web](../../system.web/) Consortium (W3C).
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\> [get_Markup](./get_markup/)() | Mengembalikan array objek [XmlNode](../../system.xml/xmlnode/) yang mewakili node anak **appinfo**. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\> [get_Parent](../xmlschemaobject/get_parent/)() | Mengembalikan induk (parent) dari [XmlSchemaObject](../xmlschemaobject/) ini. |
| [String](../../system/string/) [get_Source](./get_source/)() | Mengembalikan sumber informasi aplikasi. |
...
| void [set_Markup](./set_markup/)(const [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../../system.xml/xmlnode/)\>\>\&) | Mengatur array objek [XmlNode](../../system.xml/xmlnode/) yang mewakili node anak **appinfo**. |
...
| void [set_Parent](../xmlschemaobject/set_parent/)(const [SharedPtr](../../system/sharedptr/)\<[XmlSchemaObject](../xmlschemaobject/)\>\&) | Mengatur induk (parent) dari [XmlSchemaObject](../xmlschemaobject/) ini. |
| void [set_Source](./set_source/)(const [String](../../system/string/)\&) | Mengatur sumber informasi aplikasi. |
