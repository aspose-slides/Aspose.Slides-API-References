...
description: "Menambahkan informasi tambahan ke layanan Web XML. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan error runtime dan/atau kesalahan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 27
url: /id/system.web.services/webserviceattribute/
---
## WebServiceAttribute kelas

Menambahkan informasi tambahan ke layanan XML [Web](../../system.web/). Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menghasilkan error runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen.
...
| [String](../../system/string/) [get_Description](./get_description/)() | Mendapatkan pesan yang berisi deskripsi layanan XML [Web](../../system.web/). |
| [String](../../system/string/) [get_Name](./get_name/)() | Mendapatkan nama layanan XML [Web](../../system.web/). |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Mendapatkan namespace default yang digunakan untuk layanan XML [Web](../../system.web/). |
...
| void [set_Description](./set_description/)([String](../../system/string/)) | Mengatur pesan yang berisi deskripsi layanan XML [Web](../../system.web/). |
| void [set_Name](./set_name/)([String](../../system/string/)) | Mengatur nama layanan XML [Web](../../system.web/). |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Mengatur namespace default yang digunakan untuk layanan XML [Web](../../system.web/). |
...
|  [WebServiceAttribute](./webserviceattribute/)() | Membuat instance baru. |
...
| Field | Description |
| --- | --- |
| static [DefaultNamespace](./defaultnamespace/) | Nilai default dari properti 'Namespace'. |

## Lihat Juga

* Kelas [Attribute](../../system/attribute/)
* Ruang Nama [System::Web::Services](../)
