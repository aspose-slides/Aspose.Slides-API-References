...
| int [get_Height](./get_height/)() const | Mengembalikan tinggi gambar dalam piksel. |
| [PixelFormat](../pixelformat/) [get_PixelFormat](./get_pixelformat/)() const | Mengembalikan format piksel dari gambar bitmap. |
| IntPtr [get_Scan0](./get_scan0/)() const | Mengembalikan alamat data piksel pertama dalam bitmap. |
| int [get_Stride](./get_stride/)() const | Mengembalikan lebar stride gambar dalam byte. |
| int [get_Width](./get_width/)() const | Mengembalikan lebar gambar dalam piksel. |
...
| void [set_Height](./set_height/)(int) | Mengatur tinggi gambar dalam piksel. |
| void [set_PixelFormat](./set_pixelformat/)([PixelFormat](../pixelformat/)) | Mengatur format piksel gambar bitmap. |
| void [set_Scan0](./set_scan0/)(IntPtr) | Mengatur alamat data piksel pertama dalam bitmap. |
| void [set_Stride](./set_stride/)(int) | Mengatur lebar stride gambar dalam byte. |
| void [set_Width](./set_width/)(int) | Mengatur lebar gambar dalam piksel. |
