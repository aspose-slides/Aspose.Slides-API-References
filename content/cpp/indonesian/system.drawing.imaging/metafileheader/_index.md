...
| [Rectangle](../../system.drawing/rectangle/) [get_Bounds](./get_bounds/)() const | Mengembalikan persegi panjang pembatas dari metafile yang terkait dengan objek saat ini. |
| **float** [get_DpiX](./get_dpix/)() const | TIDAK DIIMPLEMENTASIKAN. |
| **float** [get_DpiY](./get_dpiy/)() const | TIDAK DIIMPLEMENTASIKAN. |
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan pernyataan lock() C# dengan mengunci. Panggil secara langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
...
| void [set_Bounds](./set_bounds/)(const [Rectangle](../../system.drawing/rectangle/)\&) | Menetapkan persegi panjang pembatas dari metafile yang terkait dengan objek saat ini. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Set argumen templat ke-n menjadi weak pointer (bukan shared). Mengizinkan penggantian pointer dalam kontainer ke mode weak. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan lock() C# dengan membuka kunci. Panggil secara langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
