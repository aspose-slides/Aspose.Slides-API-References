...
description: "Kelas tiruan untuk membuat kode yang diterjemahkan yang menggunakan antarmuka IButtonControl dapat dikompilasi. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 27
url: /id/system.windows.forms/ibuttoncontrol/
---
## IButtonControl kelas

Kelas tiruan untuk membuat kode yang diterjemahkan yang menggunakan antarmuka [IButtonControl](./) dapat dikompilasi. Objek dari kelas ini sebaiknya hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena hal itu akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk meneruskan ke fungsi sebagai argumen.
...
| virtual [DialogResult](../dialogresult/) [get_DialogResult](./get_dialogresult/)() | Mendapatkan hasil dialog yang terkait dengan tombol. |
...
| virtual void [NotifyDefault](./notifydefault/)(**bool**) | Menjadikan kontrol default atau tidak default. |
...
| virtual void [PerformClick](./performclick/)() | Melakukan klik pada tombol. |
...
| virtual void [set_DialogResult](./set_dialogresult/)([DialogResult](../dialogresult/)) | Mengatur hasil dialog yang terkait dengan tombol. |
