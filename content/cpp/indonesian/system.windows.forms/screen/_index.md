...
description: Memberikan informasi tentang tampilan. Hanya Windows. Ini adalah tipe singleton dengan manajemen memori yang dilakukan oleh fungsi akses. Anda tidak boleh membuat instance secara langsung.
type: docs
weight: 40
url: /id/system.windows.forms/screen/
---
## Screen kelas

Menyediakan informasi tentang tampilan. [Windows](../../system.windows/) only. Ini adalah tipe singleton dengan manajemen memori yang dilakukan oleh fungsi akses. Anda tidak boleh membuat instance secara langsung.
...
| **Rectangle_** [get_Bounds](./get_bounds/)() const | Mendapatkan batas layar. |
| static [SharedPtr](../../system/sharedptr/)\<[Screen](./)\> [get_PrimaryScreen](./get_primaryscreen/)() | Mendapatkan informasi tentang tampilan utama. |
