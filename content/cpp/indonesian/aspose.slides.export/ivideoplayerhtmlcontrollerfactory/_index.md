...
---
## IVideoPlayerHtmlControllerFactory kelas

Mengizinkan pembuatan [VideoPlayerHtmlController](../videoplayerhtmlcontroller/).
...
| Metode | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVideoPlayerHtmlController](../ivideoplayerhtmlcontroller/)\> [CreateVideoPlayerHtmlController](./createvideoplayerhtmlcontroller/)([System::String](../../system/string/), [System::String](../../system/string/), [System::String](../../system/string/)) | Membuat pengontrol HTML pemutar video. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan menyalin konstruktor subkelas. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen templat ke-nth menjadi pointer lemah (daripada shared). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
| int [SharedCount](../../system/object/sharedcount/)() const | Mendapatkan nilai saat ini dari penghitung referensi shared. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Meningkatkan penghitung referensi shared. Tidak boleh dipanggil langsung; gunakan smart pointers atau ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Mengurangi dan mengembalikan penghitung referensi shared. Tidak boleh dipanggil langsung; gunakan smart pointers atau ThisProtector. |
