...
description: Mewakili generator animasi dalam Presentasi.
type: docs
weight: 612
...
| Method | Description |
| --- | --- |
| void [Dispose](./dispose/)() override | Membuang instance [PresentationAnimationsGenerator](./). |
...
| **int32_t** [get_DefaultDelay](./get_defaultdelay/)() const | Mendapatkan waktu tunda default [ms]. |
| **int32_t** [get_ExportedSlides](./get_exportedslides/)() const | Mendapatkan jumlah slide yang diekspor. |
| **bool** [get_IncludeHiddenSlides](./get_includehiddenslides/)() const | Mendapatkan atau mengatur apakah slide tersembunyi harus disertakan. |
...
|  [PresentationAnimationsGenerator](./presentationanimationsgenerator/)([System::SharedPtr](../../system/sharedptr/)\<[Presentation](../../aspose.slides/presentation/)\>) | Membuat instance baru dari [PresentationAnimationsGenerator](./). |
|  [PresentationAnimationsGenerator](./presentationanimationsgenerator/)([System::Drawing::Size](../../system.drawing/size/)) | Membuat instance baru dari [PresentationAnimationsGenerator](./). |
...
| void [Run](./run/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>\>\>) | Menjalankan pembuatan peristiwa animasi untuk setiap slide. |
| void [Run](./run/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[ISlide](../../aspose.slides/islide/)\>\>\>, **int32_t**, [PresentationPlayer::FrameTickHandler](../presentationplayer/frametickhandler/)) | Menjalankan pembuatan peristiwa animasi untuk setiap slide. |
| void [set_DefaultDelay](./set_defaultdelay/)(**int32_t**) | Mengatur waktu tunda default [ms]. |
| void [set_IncludeHiddenSlides](./set_includehiddenslides/)(**bool**) | Mendapatkan atau mengatur apakah slide tersembunyi harus disertakan. |
