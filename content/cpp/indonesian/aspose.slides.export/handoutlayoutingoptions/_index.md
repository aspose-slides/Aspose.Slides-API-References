...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | Menentukan berapa banyak slide dan dalam urutan apa yang akan ditempatkan pada halaman [HandoutType](../handouttype/). |
| **bool** [get_PrintComments](./get_printcomments/)() const | Menentukan apakah akan menampilkan komentar pada slide atau tidak |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | Menentukan apakah akan menggambar bingkai di sekitar slide yang ditampilkan atau tidak. |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | Menentukan apakah akan mencetak nomor slide yang ditampilkan atau tidak. |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | Menentukan berapa banyak slide dan dalam urutan apa yang akan ditempatkan pada halaman [HandoutType](../handouttype/). |
| void [set_PrintComments](./set_printcomments/)(**bool**) | Menentukan apakah akan menampilkan komentar pada slide atau tidak |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | Menentukan apakah akan menggambar bingkai di sekitar slide yang ditampilkan atau tidak. |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | Menentukan apakah akan mencetak nomor slide yang ditampilkan atau tidak. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Menambah penghitung referensi bersama. Jangan panggil secara langsung; gunakan smart pointer atau ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah penghitung referensi lemah. Jangan panggil secara langsung; gunakan smart pointer atau ThisProtector. |
