...
| virtual **bool** [get_SaveMetafilesAsPng](./get_savemetafilesaspng/)() | True untuk mengonversi semua metafile yang digunakan dalam sebuah presentasi menjadi gambar PNG. Baca **bool**. |
| virtual **bool** [get_ShowHiddenSlides](./get_showhiddenslides/)() | Menentukan apakah dokumen yang dihasilkan harus menyertakan slide tersembunyi atau tidak. Bawaan adalah **false**. |
| virtual **bool** [get_SkipJavaScriptLinks](../isaveoptions/get_skipjavascriptlinks/)() | Menentukan apakah akan melewatkan hyperlink dengan panggilan JavaScript saat menyimpan presentasi. Baca **bool**. Nilai bawaan adalah **false**. |
...
| virtual void [set_SaveMetafilesAsPng](./set_savemetafilesaspng/)(**bool**) | True untuk mengonversi semua metafile yang digunakan dalam sebuah presentasi menjadi gambar PNG. Tulis **bool**. |
| virtual void [set_ShowHiddenSlides](./set_showhiddenslides/)(**bool**) | Menentukan apakah dokumen yang dihasilkan harus menyertakan slide tersembunyi atau tidak. Bawaan adalah **false**. |
| virtual void [set_SkipJavaScriptLinks](../isaveoptions/set_skipjavascriptlinks/)(**bool**) | Menentukan apakah akan melewatkan hyperlink dengan panggilan JavaScript saat menyimpan presentasi. Tulis **bool**. Nilai bawaan adalah **false**. |
