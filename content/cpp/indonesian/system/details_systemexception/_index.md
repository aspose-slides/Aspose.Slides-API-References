...
description: "Kelas dasar untuk kelas yang mewakili pengecualian sistem (bukan aplikasi). Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas SystemException sebagai gantinya. Jangan pernah membungkus instance kelas SystemException ke dalam System::SmartPtr."
type: docs
weight: 703
url: /id/system/details_systemexception/
---
## Details_SystemException kelas


Sebagai kelas dasar untuk kelas yang mewakili pengecualian sistem (bukan aplikasi). Jangan pernah membuat instance dari kelas ini secara manual. Gunakan kelas SystemException sebagai gantinya. Jangan pernah membungkus instance kelas SystemException ke dalam [System::SmartPtr](../smartptr/).
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Mengatur HRESULT, nilai numerik terkode yang ditetapkan pada pengecualian tertentu. |
...
| void [Unlock](../object/unlock/)() | Mengimplementasikan pernyataan C# lock() pembuka kunci. Panggil secara langsung atau gunakan objek penjaga [LockContext](../lockcontext/). |
