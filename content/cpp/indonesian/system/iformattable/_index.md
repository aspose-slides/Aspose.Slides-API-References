...
description: Mendefinisikan sebuah metode yang memformat nilai objek saat ini menggunakan string format yang ditentukan dan penyedia format.
type: docs
weight: 1002
url: /id/system/iformattable/
---
## IFormattable kelas


Mendefinisikan sebuah metode yang memformat nilai objek saat ini menggunakan string format yang ditentukan dan penyedia format.
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengaktifkan pembuatan salinan subkelas. |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Mengurangi jumlah penghitung referensi bersama sebesar nilai yang ditentukan. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Set argumen templat ke-n menjadi weak pointer (bukan shared). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
