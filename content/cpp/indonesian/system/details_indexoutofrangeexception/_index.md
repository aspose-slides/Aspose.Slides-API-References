...
description: "IndexOutOfRangeException dilempar ketika akses ke elemen koleksi dilakukan menggunakan indeks yang berada di luar batasnya. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas IndexOutOfRangeException sebagai gantinya. Jangan pernah membungkus instance kelas IndexOutOfRangeException ke dalam System::SmartPtr."
type: docs
weight: 482
url: /id/system/details_indexoutofrangeexception/
---
## Details_IndexOutOfRangeException kelas


IndexOutOfRangeException dilempar ketika akses ke elemen koleksi dilakukan menggunakan indeks yang berada di luar batasnya. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas IndexOutOfRangeException sebagai gantinya. Jangan pernah membungkus instance kelas IndexOutOfRangeException ke dalam [System::SmartPtr](../smartptr/).
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analogi metode C# [Object.GetHashCode()](../object/gethashcode/). Mengizinkan hashing objek khusus. |
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analogi metode C# [Object.MemberwiseClone()](../object/memberwiseclone/). Mengizinkan penggandaan tipe khusus. |
|  [Object](../object/object/)() | Membuat objek. Menginisialisasi semua struktur data internal. |
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor penyalinan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruktor subclass. |
...
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Menambah penghitung referensi bersama. Tidak boleh dipanggil langsung; gunakan smart pointer atau ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Menambah penghitung referensi lemah. Tidak boleh dipanggil langsung; gunakan smart pointer atau ThisProtector. |
