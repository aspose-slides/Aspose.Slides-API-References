...
description: "OperationCanceledException dilemparkan dalam sebuah thread ketika operasi yang dijalankan thread tersebut dibatalkan. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas OperationCanceledException sebagai gantinya. Jangan pernah membungkus instance kelas OperationCanceledException ke dalam System::SmartPtr."
type: docs
weight: 625
url: /id/system/details_operationcanceledexception/
---
## Details_OperationCanceledException kelas


OperationCanceledException dilemparkan dalam sebuah thread ketika operasi yang sedang dijalankan thread tersebut dibatalkan. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas OperationCanceledException sebagai gantinya. Jangan pernah membungkus instance kelas OperationCanceledException ke dalam [System::SmartPtr](../smartptr/).
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Mengembalikan salinan objek Exception yang merepresentasikan pengecualian terdalam. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor salin. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan konstruk salin pada subclass. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator penugasan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan konstruk salin pada subclass. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi pointer lemah (bukan shared). Memungkinkan penggantian pointer dalam kontainer ke mode lemah. |
| int [SharedCount](../object/sharedcount/)() const | Mendapatkan nilai saat ini dari penghitung referensi bersama. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Menambah penghitung referensi bersama. Seharusnya tidak dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Mengurangi dan mengembalikan penghitung referensi bersama. Seharusnya tidak dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
...
| void [Unlock](../object/unlock/)() | Mengimplementasikan pelepasan pernyataan C# lock(). Panggil langsung atau gunakan objek penjaga [LockContext](../lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Menambah penghitung referensi lemah. Seharusnya tidak dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Mengurangi penghitung referensi lemah. Seharusnya tidak dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
