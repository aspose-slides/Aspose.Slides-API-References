...
description: "NullReferenceException dilemparkan ketika dereferensi referensi-nol dicoba. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas NullReferenceException sebagai gantinya. Jangan pernah membungkus instance kelas NullReferenceException ke dalam System::SmartPtr."
type: docs
weight: 599
url: /id/system/details_nullreferenceexception/
---
## Details_NullReferenceException kelas

NullReferenceException dilemparkan ketika dereferensi referensi-nol dicoba. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas NullReferenceException sebagai gantinya. Jangan pernah membungkus instance kelas NullReferenceException ke dalam [System::SmartPtr](../smartptr/).
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Mendapatkan tipe nyata objek. Analogi panggilan C# [System.Object.GetType()](../object/gettype/). |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Mengatur HRESULT, nilai numerik terkode yang ditetapkan pada pengecualian spesifik. |
...
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Meningkatkan penghitung referensi bersama. Tidak boleh dipanggil secara langsung; sebaiknya gunakan smart pointer atau ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Mengurangi dan mengembalikan penghitung referensi bersama. Tidak boleh dipanggil secara langsung; sebaiknya gunakan smart pointer atau ThisProtector. |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Meningkatkan penghitung referensi lemah. Tidak boleh dipanggil secara langsung; sebaiknya gunakan smart pointer atau ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Mengurangi penghitung referensi lemah. Tidak boleh dipanggil secara langsung; sebaiknya gunakan smart pointer atau ThisProtector. |
