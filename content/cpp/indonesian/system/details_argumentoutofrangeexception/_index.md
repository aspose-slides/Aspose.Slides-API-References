...
description: "ArgumentOutOfRangeException dilemparkan ketika sebuah metode yang dipanggil diberikan argumen yang berada di luar rentang nilai yang diharapkan untuk argumen tersebut. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas ArgumentOutOfRangeException sebagai gantinya. Jangan pernah membungkus instance kelas ArgumentOutOfRangeException ke dalam System::SmartPtr."
type: docs
weight: 352
url: /id/system/details_argumentoutofrangeexception/
---
## Details_ArgumentOutOfRangeException kelas

ArgumentOutOfRangeException dilemparkan ketika metode yang dipanggil menerima argumen yang berada di luar rentang nilai yang diharapkan untuk argumen tersebut. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas ArgumentOutOfRangeException sebagai gantinya. Jangan pernah membungkus instance kelas ArgumentOutOfRangeException ke dalam [System::SmartPtr](../smartptr/).
...
| virtual **bool** [FastCast](../object/fastcast/)(const Details::FastRttiBase\&, void **) const | Untuk keperluan internal saja. |
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Mengembalikan salinan objek Exception yang merepresentasikan pengecualian paling dalam. |
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Mendapatkan tipe sebenarnya dari objek. Analog dari panggilan C# [System.Object.GetType()](../object/gettype/). |
| **bool** [Is](./is/)(const [System::TypeInfo](../typeinfo/)\&) const override |  |
| void [Lock](../object/lock/)() | Mengimplementasikan pernyataan lock() C# yang mengunci. Panggil langsung atau gunakan objek sentry [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor penyalinan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan menyalin konstruktor subclass. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan menyalin konstruktor subclass. |
...
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, std::nullptr_t) | Membandingkan tipe nilai objek dengan nullptr. |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Mengurangi penghitung referensi bersama dengan nilai yang ditentukan. |
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Mengatur HRESULT, nilai numerik yang dikodekan yang ditetapkan ke pengecualian tertentu. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen template ke-nth menjadi pointer lemah (bukan bersama). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
...
| void [Unlock](../object/unlock/)() | Mengimplementasikan pernyataan lock() C# yang membuka kunci. Panggil langsung atau gunakan objek sentry [LockContext](../lockcontext/). |
...
* Kelas [Details_ArgumentException](../details_argumentexception/)
* Namespace [System](../)
