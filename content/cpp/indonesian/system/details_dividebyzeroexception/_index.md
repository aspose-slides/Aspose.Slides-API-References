...
description: "DivideByZeroException dilemparkan ketika pembagian dengan 0 dicoba dalam operasi aritmetika. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas DivideByZeroException sebagai gantinya. Jangan pernah membungkus instance kelas DivideByZeroException ke dalam System::SmartPtr."
type: docs
weight: 404
url: /id/system/details_dividebyzeroexception/
---
## Details_DivideByZeroException kelas


DivideByZeroException dilemparkan ketika pembagian dengan 0 dicoba dalam operasi aritmetika. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas DivideByZeroException sebagai gantinya. Jangan pernah membungkus instance kelas DivideByZeroException ke dalam [System::SmartPtr](../smartptr/).
...
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Meningkatkan hitungan weak reference. Tidak boleh dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Mengurangi hitungan weak reference. Tidak boleh dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
...
OutOfMemoryException dilemparkan ketika aplikasi kehabisan memori. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas OutOfMemoryException sebagai gantinya. Jangan pernah membungkus instance kelas OutOfMemoryException ke dalam [System::SmartPtr](../smartptr/). 
## Lihat Juga

* Kelas [Details_ArithmeticException](../details_arithmeticexception/)
* Ruang Nama [System](../)
