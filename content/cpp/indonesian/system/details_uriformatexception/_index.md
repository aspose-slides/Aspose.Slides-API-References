...
description: "UriFormatException dilemparkan ketika format URI tidak valid. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas UriFormatException sebagai gantinya. Jangan pernah membungkus instance kelas UriFormatException ke dalam System::SmartPtr."
type: docs
weight: 768
url: /id/system/details_uriformatexception/
---
## Details_UriFormatException kelas

UriFormatException dilemparkan ketika format URI tidak valid. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas UriFormatException sebagai gantinya. Jangan pernah membungkus instance kelas UriFormatException ke dalam [System::SmartPtr](../smartptr/).
...
| void [Lock](../object/lock/)() | Menerapkan penguncian pernyataan C# lock(). Panggil secara langsung atau gunakan objek sentry [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor salin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengaktifkan konstruktor salin untuk subclass. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan mengaktifkan konstruktor salin untuk subclass. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Mengatur HRESULT, nilai numerik terkode yang ditetapkan ke pengecualian spesifik. |
...
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Meningkatkan penghitung referensi bersama. Jangan dipanggil secara langsung; gunakan smart pointers atau ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Mengurangi dan mengembalikan penghitung referensi bersama. Jangan dipanggil secara langsung; gunakan smart pointers atau ThisProtector. |
...
| void [Unlock](../object/unlock/)() | Menerapkan pelepasan pernyataan C# lock(). Panggil secara langsung atau gunakan objek sentry [LockContext](../lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Meningkatkan penghitung weak reference. Jangan dipanggil secara langsung; gunakan smart pointers atau ThisProtector. |
| void [WeakRefRemoved](../object/weakrefremoved/)() | Mengurangi penghitung weak reference. Jangan dipanggil secara langsung; gunakan smart pointers atau ThisProtector. |
...
* Kelas [Details_FormatException](../details_formatexception/)
* Ruang Nama [System](../)
