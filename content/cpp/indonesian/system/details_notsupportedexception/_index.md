...
description: "NotSupportedException dilempar ketika sebuah metode yang dipanggil tidak didukung atau ketika operasi yang dicoba pada aliran tidak didukung. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas NotSupportedException sebagai gantinya. Jangan pernah membungkus instance kelas NotSupportedException ke dalam System::SmartPtr."
type: docs
weight: 586
url: /id/system/details_notsupportedexception/
---
## Details_NotSupportedException kelas

NotSupportedException dilempar ketika sebuah metode yang dipanggil tidak didukung atau ketika sebuah operasi yang dicoba pada aliran tidak didukung. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas NotSupportedException sebagai gantinya. Jangan pernah membungkus instance kelas NotSupportedException ke dalam [System::SmartPtr](../smartptr/).
...
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analog dari metode C# [Object.MemberwiseClone()](../object/memberwiseclone/). Mengaktifkan duplikasi tipe khusus. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
