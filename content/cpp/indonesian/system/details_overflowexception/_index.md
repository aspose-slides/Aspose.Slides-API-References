...
description: "OverflowException dilempar ketika sebuah operasi menghasilkan overflow. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas OverflowException sebagai gantinya. Jangan pernah membungkus instance kelas OverflowException ke dalam System::SmartPtr."
type: docs
weight: 651
url: /id/system/details_overflowexception/
---
## Details_OverflowException kelas

OverflowException dilempar ketika sebuah operasi menghasilkan overflow. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas OverflowException sebagai gantinya. Jangan pernah membungkus instance kelas OverflowException ke dalam [System::SmartPtr](../smartptr/).
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Mendapatkan tipe sebenarnya dari objek. Analog panggilan C# [System.Object.GetType()](../object/gettype/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor penyalin. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan konstruksi salinan subclass. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator penugasan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan konstruksi salinan subclass. |
| static **bool** [ReferenceEquals](../object/referenceequals/)([ptr](../object/ptr/) const\&, [ptr](../object/ptr/) const\&) | Membandingkan objek dengan referensi. |
| static std::enable_if<\![IsSmartPtr](../issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../object/referenceequals/)(T const\&, T const\&) | Membandingkan objek dengan referensi. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Menetapkan HRESULT, nilai numerik yang dikodekan yang ditugaskan ke pengecualian spesifik. |
