...
description: "StackOverflowException dilemparkan ketika tumpukan eksekusi thread meluap. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas StackOverflowException sebagai gantinya. Jangan pernah membungkus instance kelas StackOverflowException ke dalam System::SmartPtr."
type: docs
weight: 690
url: /id/system/details_stackoverflowexception/
---
## Details_StackOverflowException kelas


StackOverflowException dilemparkan ketika tumpukan eksekusi thread meluap. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas StackOverflowException sebagai gantinya. Jangan pernah membungkus instance kelas StackOverflowException ke dalam [System::SmartPtr](../smartptr/).
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Mengembalikan salinan objek Exception yang mewakili pengecualian terdalaman. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor penyalinan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruksi subclass. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruksi subclass. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi pointer lemah (bukan bersama). Memungkinkan penggantian pointer dalam kontainer ke mode lemah. |
...
| virtual const char * [what](../details_exception/what/)() const | Mengimplementasikan metode [what()](../details_exception/what/) yang dipanggil oleh kelas [ExceptionWrapper](../exceptionwrapper/). Meskipun kelas ini tidak mewarisi dari std::exception, kelas turunan dapat menggunakan anggota protected/private untuk mengimplementasikan logika mereka. Memindahkan implementasi metode ini ke [ExceptionWrapper](../exceptionwrapper/) dapat merusak logika tersebut. |
