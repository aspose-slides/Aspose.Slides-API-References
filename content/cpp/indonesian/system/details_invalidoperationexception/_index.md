...
description: "Pengecualian yang dilemparkan ketika sebuah metode dipanggil pada objek yang berada dalam keadaan tidak konsisten dengan pemanggilan ini. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas InvalidOperationException sebagai gantinya. Jangan pernah membungkus instance kelas InvalidOperationException ke dalam System::SmartPtr."
type: docs
weight: 508
url: /id/system/details_invalidoperationexception/
---
## Details_InvalidOperationException kelas
...
| void [Lock](../object/lock/)() | Mengimplementasikan penguncian pernyataan C# lock(). Panggil secara langsung atau gunakan objek pengawas [LockContext](../lockcontext/). |
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analog dari metode C# [Object.MemberwiseClone()](../object/memberwiseclone/). Mengaktifkan pengklonan tipe khusus. |
|  [Object](../object/object/)() | Membuat objek. Menginisialisasi semua struktur data internal. |
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor penyalinan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruktor pada subclass. |
...
| void [Unlock](../object/unlock/)() | Mengimplementasikan pelepasan pernyataan C# lock(). Panggil secara langsung atau gunakan objek pengawas [LockContext](../lockcontext/). |
