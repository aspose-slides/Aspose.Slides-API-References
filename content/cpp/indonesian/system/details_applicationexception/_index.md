...
description: "Kelas dasar untuk kelas yang mewakili pengecualian aplikasi (bukan sistem). Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas ApplicationException sebagai gantinya. Jangan pernah membungkus instance kelas ApplicationException ke dalam System::SmartPtr."
type: docs
weight: 313
url: /id/system/details_applicationexception/
---
## Details_ApplicationException kelas

Kelas dasar untuk kelas yang mewakili pengecualian aplikasi (bukan sistem). Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas ApplicationException sebagai gantinya. Jangan pernah membungkus instance kelas ApplicationException ke dalam [System::SmartPtr](../smartptr/).
...
| virtual const char * [what](../details_exception/what/)() const | Mengimplementasikan metode [what()](../details_exception/what/) yang dipanggil oleh kelas [ExceptionWrapper](../exceptionwrapper/). Meskipun fakta bahwa kelas ini tidak diwarisi dari std::exception, kelas yang diturunkan dapat menggunakan anggota protected/private untuk mengimplementasikan logika mereka. Memindahkan implementasi metode ini ke [ExceptionWrapper](../exceptionwrapper/) dapat merusak logika tersebut. |
