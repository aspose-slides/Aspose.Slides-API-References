...
description: "ArgumentException dilemparkan ketika argumen yang diberikan ke metode yang dipanggil tidak valid. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas ArgumentException sebagai gantinya. Jangan pernah membungkus instance kelas ArgumentException ke dalam System::SmartPtr."
type: docs
weight: 326
url: /id/system/details_argumentexception/
---
## Details_ArgumentException kelas


ArgumentException dilemparkan ketika sebuah argumen yang diberikan ke metode yang dipanggil tidak valid. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas ArgumentException sebagai gantinya. Jangan pernah membungkus instance kelas ArgumentException ke dalam [System::SmartPtr](../smartptr/).
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analog metode C# [Object.GetHashCode()](../object/gethashcode/). Mengaktifkan hash objek khusus. |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruktor subclass. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruktor subclass. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Menyetel argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan penggantian pointer dalam kontainer ke mode lemah. |
...
ArgumentNullException dilemparkan ketika sebuah metode yang dipanggil menerima argumen null sementara metode mengharapkan nilai non-null. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas ArgumentNullException sebagai gantinya. Jangan pernah membungkus instance kelas ArgumentNullException ke dalam [System::SmartPtr](../smartptr/). 
