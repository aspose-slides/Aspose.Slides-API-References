...
description: "PlatformNotSupportedException dilemparkan ketika sebuah fitur tidak berjalan pada platform tertentu. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas PlatformNotSupportedException sebagai gantinya. Jangan pernah membungkus instance kelas PlatformNotSupportedException ke dalam System::SmartPtr."
type: docs
weight: 664
url: /id/system/details_platformnotsupportedexception/
---
## Details_PlatformNotSupportedException kelas


PlatformNotSupportedException dilemparkan ketika sebuah fitur tidak berjalan pada platform tertentu. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas PlatformNotSupportedException sebagai gantinya. Jangan pernah membungkus instance kelas PlatformNotSupportedException ke dalam [System::SmartPtr](../smartptr/).
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Mengurangi penghitung referensi berbagi dengan nilai yang ditentukan. |
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Mengatur HRESULT, nilai numerik berkode yang ditetapkan pada pengecualian tertentu. |
...
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Meningkatkan penghitung referensi berbagi. Tidak boleh dipanggil langsung; sebaliknya, gunakan smart pointer atau ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Mengurangi dan mengembalikan penghitung referensi berbagi. Tidak boleh dipanggil langsung; sebaliknya, gunakan smart pointer atau ThisProtector. |
...
* Kelas [Details_NotSupportedException](../details_notsupportedexception/)
* Ruang nama [System](../)
