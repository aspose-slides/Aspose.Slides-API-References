...
description: "RankException dilemparkan ketika argumen array dengan jumlah dimensi yang berbeda dari yang diharapkan diberikan ke sebuah metode. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas RankException sebagai gantinya. Jangan pernah membungkus instance kelas RankException ke dalam System::SmartPtr."
type: docs
weight: 677
url: /id/system/details_rankexception/
---
## Details_RankException kelas


RankException dilemparkan ketika argumen array dengan jumlah dimensi yang berbeda dari yang diharapkan diberikan ke sebuah metode. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas RankException sebagai gantinya. Jangan pernah membungkus instance kelas RankException ke dalam [System::SmartPtr](../smartptr/).
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Menetapkan HRESULT, nilai numerik yang dikodekan yang diberikan kepada pengecualian tertentu. |
