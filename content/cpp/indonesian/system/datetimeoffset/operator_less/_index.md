...
description: Menentukan apakah objek saat ini mewakili nilai tanggal dan waktu yang lebih awal daripada nilai yang diwakili oleh objek DateTimeOffset yang ditentukan.
type: docs
weight: 560
url: /id/system/datetimeoffset/operator_less/
---
...
| --- | --- | --- |
| other | const [DateTimeOffset](../)\& | Objek [DateTimeOffset](../) untuk membandingkan objek saat ini dengan |
...
## DateTimeOffset::operator<(std::nullptr_t) const metode
