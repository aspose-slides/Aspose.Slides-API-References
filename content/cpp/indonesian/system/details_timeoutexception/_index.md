...
description: "TimeoutException menunjukkan apakah waktu yang dialokasikan untuk proses atau operasi telah habis. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas TimeoutException sebagai gantinya. Jangan pernah membungkus instance kelas TimeoutException ke dalam System::SmartPtr."
type: docs
weight: 716
url: /id/system/details_timeoutexception/
---
## Details_TimeoutException kelas

TimeoutException menunjukkan apakah waktu yang dialokasikan untuk proses atau operasi telah habis. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas TimeoutException sebagai gantinya. Jangan pernah membungkus instance kelas TimeoutException ke dalam [System::SmartPtr](../smartptr/).
...
| virtual **int32_t** [GetHashCode](../object/gethashcode/)() const | Analog dari metode [Object.GetHashCode()](../object/gethashcode/) C#. Mengaktifkan hashing objek khusus. |
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Mendapatkan tipe sebenarnya dari objek. Analog dari panggilan [System.Object.GetType()](../object/gettype/) C#. |
| **bool** [Is](./is/)(const [System::TypeInfo](../typeinfo/)\&) const override |  |
| void [Lock](../object/lock/)() | Menerapkan penguncian pernyataan lock() C#. Panggil secara langsung atau gunakan objek penjaga [LockContext](../lockcontext/). |
| virtual [ptr](../object/ptr/) [MemberwiseClone](../object/memberwiseclone/)() const | Analog dari metode [Object.MemberwiseClone()](../object/memberwiseclone/) C#. Mengaktifkan kloning tipe khusus. |
| [Object](../object/object/)() | Membuat objek. Menginisialisasi semua struktur data internal. |
| [Object](../object/object/)([Object](../object/) const\&) | Konstruktor salin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan pembuatan salinan kelas turunan. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan pembuatan salinan kelas turunan. |
...
| void [Unlock](../object/unlock/)() | Menerapkan pelepasan pernyataan lock() C#. Panggil secara langsung atau gunakan objek penjaga [LockContext](../lockcontext/). |
