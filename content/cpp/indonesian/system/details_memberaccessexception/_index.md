...
description: "MemberAccessException dilemparkan ketika akses ke anggota kelas yang tidak ada dicoba atau ketika akses ke anggota tersebut tidak diizinkan. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas MemberAccessException sebagai gantinya. Jangan pernah membungkus instance kelas MemberAccessException ke dalam System::SmartPtr."
type: docs
weight: 547
url: /id/system/details_memberaccessexception/
---
## Details_MemberAccessException kelas


MemberAccessException dilemparkan ketika akses ke anggota kelas yang tidak ada dicoba atau ketika akses ke anggota tersebut tidak diizinkan. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas MemberAccessException sebagai gantinya. Jangan pernah membungkus instance kelas MemberAccessException ke dalam [System::SmartPtr](../smartptr/).
...
| virtual [ExceptionWrapper](../exceptionwrapper/)\<[Details_Exception](../details_exception/)\> [GetBaseException](../details_exception/getbaseexception/)() const | Mengembalikan salinan objek Exception yang mewakili pengecualian paling dalam. |
...
| void [Lock](../object/lock/)() | Menerapkan penguncian pernyataan C# lock(). Panggil secara langsung atau gunakan objek sentinel [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor penyalin. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruktor pada subclass. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator penugasan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan penyalinan konstruktor pada subclass. |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Menetapkan HRESULT, nilai numerik terkode yang ditetapkan ke pengecualian tertentu. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen templat ke-n menjadi weak pointer (bukan shared). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
...
| void [Unlock](../object/unlock/)() | Menerapkan pembukaan kunci pernyataan C# lock(). Panggil secara langsung atau gunakan objek sentinel [LockContext](../lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Menambah penghitung referensi lemah. Tidak boleh dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
