...
description: "MemberAccessException dilemparkan ketika akses ke metode yang tidak ada dicoba atau ketika akses ke metode tidak diizinkan. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas MethodAccessException sebagai gantinya. Jangan pernah membungkus instance kelas MethodAccessException ke dalam System::SmartPtr."
type: docs
weight: 560
url: /id/system/details_methodaccessexception/
---
## Details_MethodAccessException kelas


MemberAccessException dilemparkan ketika akses ke metode yang tidak ada dicoba atau ketika akses ke metode tidak diizinkan. Jangan pernah membuat instance kelas ini secara manual. Gunakan kelas MethodAccessException sebagai gantinya. Jangan pernah membungkus instance kelas MethodAccessException ke dalam [System::SmartPtr](../smartptr/).
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Mendapatkan tipe aktual objek. Analog panggilan C# [System.Object.GetType()](../object/gettype/). |
...
| void [set_HResult](../details_exception/set_hresult/)(**int32_t**) | Mengatur HRESULT, nilai numerik yang dikodekan yang diberikan kepada pengecualian tertentu. |
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen template ke-n menjadi weak pointer (bukan shared). Memungkinkan penggantian pointer dalam kontainer ke mode lemah. |
| int [SharedCount](../object/sharedcount/)() const | Mendapatkan nilai saat ini dari penghitung referensi bersama. |
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Meningkatkan penghitung referensi bersama. Seharusnya tidak dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
...
| void [Unlock](../object/unlock/)() | Mengimplementasikan pembukaan kunci pernyataan C# lock(). Panggil secara langsung atau gunakan objek penjaga [LockContext](../lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Meningkatkan penghitung referensi lemah. Seharusnya tidak dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
...
* Kelas [Details_MemberAccessException](../details_memberaccessexception/)
* Namespace [System](../)
