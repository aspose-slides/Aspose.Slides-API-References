...
type: docs
weight: 339
url: /id/system/details_argumentnullexception/
---
## Details_ArgumentNullException kelas
...
| void [Lock](../object/lock/)() | Mengimplementasikan pernyataan lock() C# untuk mengunci. Panggil secara langsung atau gunakan objek sentinel [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor penyalin. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruktor penyalin untuk subclass. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator penugasan. Tidak menyalin apa pun, sebenarnya, hanya menginisialisasi objek baru dan memungkinkan konstruktor penyalin untuk subclass. |
...
| int [RemovedSharedRefs](../object/removedsharedrefs/)(int) | Mengurangi hitungan referensi berbagi sebesar nilai yang ditentukan. |
...
| [Object](../object/) * [SharedRefAdded](../object/sharedrefadded/)() | Menambah hitungan referensi berbagi. Tidak boleh dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
| int [SharedRefRemovedSafe](../object/sharedrefremovedsafe/)() | Mengurangi dan mengembalikan hitungan referensi berbagi. Tidak boleh dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
...
| void [Unlock](../object/unlock/)() | Mengimplementasikan pernyataan lock() C# untuk membuka kunci. Panggil secara langsung atau gunakan objek sentinel [LockContext](../lockcontext/). |
| Detail::SmartPtrCounter * [WeakRefAdded](../object/weakrefadded/)() | Menambah hitungan referensi lemah. Tidak boleh dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
