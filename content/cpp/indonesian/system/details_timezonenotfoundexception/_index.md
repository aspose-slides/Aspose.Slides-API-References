...
description: "TimeZoneNotFoundException dilemparkan ketika informasi zona waktu tidak ditemukan. Jangan pernah membuat instance dari kelas ini secara manual. Gunakan kelas TimeZoneNotFoundException sebagai gantinya. Jangan pernah membungkus instance kelas TimeZoneNotFoundException ke dalam System::SmartPtr."
type: docs
weight: 729
url: /id/system/details_timezonenotfoundexception/
---
## Details_TimeZoneNotFoundException kelas


TimeZoneNotFoundException dilemparkan ketika informasi zona waktu tidak ditemukan. Jangan pernah membuat instance dari kelas ini secara manual. Gunakan kelas TimeZoneNotFoundException sebagai gantinya. Jangan pernah membungkus instance kelas TimeZoneNotFoundException ke dalam [System::SmartPtr](../smartptr/).
...
| const [System::TypeInfo](../typeinfo/)\& [GetType](./gettype/)() const override | Mendapatkan tipe sebenarnya dari objek. Analog dari pemanggilan C# [System.Object.GetType()](../object/gettype/). |
| **bool** [Is](./is/)(const [System::TypeInfo](../typeinfo/)\&) const override |  |
| void [Lock](../object/lock/)() | Mengimplementasikan penguncian pernyataan lock() C#. Panggil langsung atau gunakan objek pengawas [LockContext](../lockcontext/). |
...
|  [Object](../object/object/)([Object](../object/) const\&) | Konstruktor salinan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan konstruktor salinan untuk subclass. |
| [Object](../object/)\& [operator=](../object/operator_equal/)([Object](../object/) const\&) | Operator penugasan. Sebenarnya tidak menyalin apa pun, hanya menginisialisasi objek baru dan memungkinkan konstruktor salinan untuk subclass. |
...
| virtual void [SetTemplateWeakPtr](../object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi pointer lemah (bukan shared). Memungkinkan pengalihan pointer dalam kontainer ke mode lemah. |
...
| void [Unlock](../object/unlock/)() | Mengimplementasikan pelepasan pernyataan lock() C#. Panggil langsung atau gunakan objek pengawas [LockContext](../lockcontext/). |
