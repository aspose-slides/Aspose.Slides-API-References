...
| **bool** [get_Cancel](./get_cancel/)() | Mendapatkan nilai yang menunjukkan apakah peristiwa harus dibatalkan. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek mewakili sebuah instans dari tipe yang dijelaskan oleh targetType. Analog dari operator 'is' C#. |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Menurunkan jumlah penghitung referensi bersama sebesar nilai yang ditentukan. |
| void [set_Cancel](./set_cancel/)(**bool**) | Mengatur nilai yang menunjukkan apakah peristiwa harus dibatalkan. |
...
| Bidang | Deskripsi |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Anggota statis yang merepresentasikan pointer bersama \"kosong\" [EventArgs](../../system/eventargs/) (null-pointer). |
