...
type: docs
weight: 1
url: /id/system.componentmodel/asynccompletedeventargs/
---
...
|  [AsyncCompletedEventArgs](./asynccompletedeventargs/)(const [System::Exception](../../system/exception/)\&, **bool**, const [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>\&) | Menginisialisasi instance baru dari kelas [System.ComponentModel.AsyncCompletedEventArgs](./). |
...
| **bool** [get_Cancelled](./get_cancelled/)() const | Mendapatkan nilai yang menunjukkan apakah operasi asynchronous telah dibatalkan. true jika operasi latar belakang telah dibatalkan; jika tidak false. Nilai default adalah false. |
| const [System::Exception](../../system/exception/)\& [get_Error](./get_error/)() const | Mendapatkan nilai yang menunjukkan kesalahan mana yang terjadi selama operasi asynchronous. |
| [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_UserState](./get_userstate/)() const | Mendapatkan pengidentifikasi unik untuk tugas asynchronous. Referensi objek yang secara unik mengidentifikasi tugas asynchronous; jika tidak, null jika tidak ada nilai yang diatur. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi pointer lemah (bukan shared). Memungkinkan pergantian pointer dalam kontainer ke mode lemah. |
...
| Field | Description |
| --- | --- |
| static [Empty](../../system/eventargs/empty/) | Anggota statis yang merepresentasikan "kosong" [EventArgs](../../system/eventargs/) shared pointer (null-pointer). |
