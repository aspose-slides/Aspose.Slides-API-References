...
description: Kelas internal untuk digunakan dengan XmlSerializer.
type: docs
weight: 79
url: /id/system.xml.serialization/xmlserializerimplementation/
---
## XmlSerializerImplementation kelas

Kelas internal untuk digunakan dengan [XmlSerializer](../xmlserializer/).
...
| void [Lock](../../system/object/lock/)() | Mengimplementasikan penguncian pernyataan lock() C#. Panggil secara langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pembukaan kunci pernyataan lock() C#. Panggil secara langsung atau gunakan objek sentinel [LockContext](../../system/lockcontext/). |
