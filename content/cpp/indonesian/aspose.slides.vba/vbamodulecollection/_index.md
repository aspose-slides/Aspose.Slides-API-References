...
| Method | Description |
| --- | --- |
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [AddEmptyModule](./addemptymodule/)([System::String](../../system/string/)) override | Menambahkan modul kosong baru ke VBA Project. |
| [iterator](./iterator/) [begin](./begin/)() | Mendapatkan iterator yang mengarah ke elemen pertama (jika ada) dari koleksi. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Mendapatkan iterator yang mengarah ke elemen pertama (jika ada) dari instansi koleksi yang const-qualified. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Mendapatkan iterator yang mengarah ke elemen pertama yang const-qualified (jika ada) dari koleksi. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Mendapatkan iterator yang mengarah tepat setelah elemen const-qualified terakhir (jika ada) dari koleksi. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\>\>, **int32_t**) override | Menyalin semua elemen dari koleksi ke array yang ditentukan. |
| [iterator](./iterator/) [end](./end/)() | Mendapatkan iterator yang mengarah tepat setelah elemen terakhir (jika ada) dari koleksi. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Mendapatkan iterator yang mengarah tepat setelah elemen terakhir (jika ada) dari instansi koleksi yang const-qualified. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator yang mengiterasi koleksi. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [idx_get](./idx_get/)(**int32_t**) override | Mendapatkan elemen pada indeks yang ditentukan. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Select](../../system.collections.generic/ienumerable/linq_select/)(const [Func](../../system/func/)\<T, **int32_t**, ResultType\>\&) | Mengubah setiap elemen urutan ke bentuk baru dengan memasukkan indeks elemen. |
...
| void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\>) override | Menghapus kemunculan pertama dari objek spesifik dari koleksi. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Mendapatkan iterator yang mengarah ke elemen pertama (jika ada) dari instansi koleksi yang const-qualified. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Mendapatkan iterator yang mengarah tepat setelah elemen terakhir (jika ada) dari instansi koleksi yang const-qualified. |
...
* Kelas [IVbaModuleCollection](../ivbamodulecollection/)
