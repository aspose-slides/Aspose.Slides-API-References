...
| virtual **bool** [get_IsPasswordProtected](./get_ispasswordprotected/)() | Menunjukkan apakah VBAProject dilindungi oleh kata sandi untuk melihat properti proyek. Baca-saja **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModule](../ivbamodule/)\> [get_Module](./get_module/)(**int32_t**) | Mengembalikan modul yang terdapat dalam proyek VBA pada indeks yang ditentukan. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaModuleCollection](../ivbamodulecollection/)\> [get_Modules](./get_modules/)() | Mengembalikan daftar semua modul yang terdapat dalam proyek VBA. Baca-saja [IVbaModuleCollection](../ivbamodulecollection/). |
| virtual [System::String](../../system/string/) [get_Name](./get_name/)() | Mengembalikan nama proyek VBA. Baca-saja [System::String](../../system/string/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReference](../ivbareference/)\> [get_Reference](./get_reference/)(**int32_t**) | Mengembalikan referensi yang terdapat dalam proyek VBA pada indeks yang ditentukan. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IVbaReferenceCollection](../ivbareferencecollection/)\> [get_References](./get_references/)() | Mengembalikan daftar semua referensi yang terdapat dalam proyek VBA. Baca-saja [IVbaReferenceCollection](../ivbareferencecollection/). |
...
| virtual [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ToBinary](./tobinary/)() | Mengembalikan representasi biner proyek VBA sebagai kontainer OLE. Baca-saja **uint8_t**[]. |
