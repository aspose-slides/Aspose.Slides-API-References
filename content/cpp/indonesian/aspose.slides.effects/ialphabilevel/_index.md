...
| virtual **float** [get_Threshold](./get_threshold/)() | Mengembalikan ambang efek. Baca **float**. |
...
| virtual void [set_Threshold](./set_threshold/)(**float**) | Mengembalikan ambang efek. Tulis **float**. |
...
Gunakan [ImageTransformOperationFactory](../imagetransformoperationfactory/) untuk membuat instance di COM.
