...
description: Objek tak dapat diubah yang mewakili efek Alpha Replace. Nilai alpha (opacity) efek diganti dengan alpha tetap.
type: docs
weight: 404
url: /id/aspose.slides.effects/ialphareplaceeffectivedata/
---
## IAlphaReplaceEffectiveData kelas

Objek tak dapat diubah yang mewakili efek Alpha Replace. Nilai alpha (opacity) efek diganti dengan alpha tetap.
...
| virtual **float** [get_Alpha](./get_alpha/)() | Mengembalikan nilai alpha baru dalam interval [0..1] Hanya-baca **float**. |
