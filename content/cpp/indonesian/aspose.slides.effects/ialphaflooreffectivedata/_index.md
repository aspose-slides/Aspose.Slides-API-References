...
description: Objek tidak dapat diubah yang mewakili efek Alpha Floor. Nilai Alpha (opacity) yang kurang dari 100% diubah menjadi nol. Dengan kata lain, apa pun yang sebagian transparan menjadi sepenuhnya transparan.
type: docs
weight: 300
url: /id/aspose.slides.effects/ialphaflooreffectivedata/
---
## IAlphaFloorEffectiveData kelas

Objek tidak dapat diubah yang mewakili efek Alpha Floor. Nilai Alpha (opacity) yang kurang dari 100% diubah menjadi nol. Dengan kata lain, apa pun yang sebagian transparan menjadi sepenuhnya transparan.
