...
description: Objek tak dapat diubah yang mewakili efek Alpha Ceiling. Nilai Alpha (opacity) yang lebih besar dari nol diubah menjadi 100%. Dengan kata lain, apa pun yang sebagian transparan menjadi sepenuhnya transparan.
type: docs
weight: 274
url: /id/aspose.slides.effects/ialphaceilingeffectivedata/
---
## IAlphaCeilingEffectiveData kelas

Objek tak dapat diubah yang mewakili efek Alpha Ceiling. Nilai Alpha (opacity) yang lebih besar dari nol diubah menjadi 100%. Dengan kata lain, apa pun yang sebagian transparan menjadi sepenuhnya transparan.
