...
description: Mewakili efek Tint. Menggeser nilai warna efek menuju/menjauh dari hue dengan jumlah yang ditentukan.
type: docs
weight: 1093
...
Mewakili efek [Tint](./). Menggeser nilai warna efek menuju/menjauh dari hue dengan jumlah yang ditentukan.
...
| Metode | Deskripsi |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Menentukan apakah [Tint](./) yang ditentukan sama dengan [Tint](./) saat ini. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITintEffectiveData](../itinteffectivedata/)\> [GetEffective](./geteffective/)() override | Mendapatkan data efek [Tint](./) yang efektif dengan pewarisan yang diterapkan. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen templat ke-n menjadi pointer lemah (bukan shared). Memungkinkan pengalihan pointer dalam kontainer ke mode lemah. |
