...
description: Mewakili efek Alpha Modulate. Nilai alpha (opasitas) efek dikalikan dengan persentase tetap. Kontainer efek menentukan efek yang berisi nilai alpha untuk dimodulasi.
type: docs
weight: 53
...
| Metode | Deskripsi |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Menentukan apakah [AlphaModulate](./) yang ditentukan sama dengan [AlphaModulate](./) saat ini. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateEffectiveData](../ialphamodulateeffectivedata/)\> [GetEffective](./geteffective/)() override | Mengetahui data efek Alpha Modulate yang efektif dengan pewarisan yang diterapkan. |
...
* Kelas [IAlphaModulate](../ialphamodulate/)
