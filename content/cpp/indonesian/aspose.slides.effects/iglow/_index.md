...
description: Mewakili efek Glow, di mana sebuah outline berwarna yang blur ditambahkan di luar tepi objek.
type: docs
weight: 638
...
Mewakili efek [Glow](../glow/), di mana sebuah outline berwarna yang blur ditambahkan di luar tepi objek.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_Color](./get_color/)() | Format warna. Hanya baca [IColorFormat](../../aspose.slides/icolorformat/). |
| virtual **double** [get_Radius](./get_radius/)() | Radius. Baca **double**. |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek mewakili instansi dari tipe yang dijelaskan oleh targetType. Analog dari operator 'is' C#. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Radius. Tulis **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Set argumen templat ke-n menjadi weak pointer (bukan shared). Memungkinkan mengubah pointer dalam kontainer ke mode lemah. |
