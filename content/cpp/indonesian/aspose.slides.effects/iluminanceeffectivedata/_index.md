...
description: Mewakili efek Luminance. Kecerahan menggeser semua warna secara linier lebih dekat ke putih atau hitam. Kontras menskalakan semua warna supaya menjadi lebih dekat atau lebih jauh satu sama lain.
type: docs
weight: 807
url: /id/aspose.slides.effects/iluminanceeffectivedata/
---
## ILuminanceEffectiveData kelas


Mewakili efek [Luminance](../luminance/). Kecerahan menggeser semua warna secara linier lebih dekat ke putih atau hitam. Kontras menyesuaikan semua warna agar menjadi lebih dekat atau lebih jauh satu sama lain.
...
| virtual **float** [get_Brightness](./get_brightness/)() | Kecerahan. **float** hanya-baca. |
| virtual **float** [get_Contrast](./get_contrast/)() | Kontras. **float** hanya-baca. |
