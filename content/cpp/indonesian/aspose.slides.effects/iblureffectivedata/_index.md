...
description: Objek tak dapat diubah yang mewakili efek Blur yang diterapkan pada seluruh bentuk, termasuk isinya. Semua saluran warna, termasuk alfa, terpengaruh.
type: docs
weight: 469
url: /id/aspose.slides.effects/iblureffectivedata/
---
## IBlurEffectiveData kelas

Objek tak dapat diubah yang mewakili efek [Blur](../blur/) yang diterapkan pada seluruh bentuk, termasuk isinya. Semua saluran warna, termasuk alfa, terpengaruh.
...
| virtual **bool** [get_Grow](./get_grow/)() | Menentukan apakah batas objek harus diperluas sebagai akibat dari proses blur. True menunjukkan batas diperluas sementara false menunjukkan tidak. **bool** hanya-baca. |
| virtual **double** [get_Radius](./get_radius/)() | Mengembalikan radius blur. **double** hanya-baca. |
