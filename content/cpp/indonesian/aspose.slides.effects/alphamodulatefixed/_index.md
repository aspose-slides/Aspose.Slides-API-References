...
| Metode | Deskripsi |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Menentukan apakah [AlphaModulateFixed](./) yang ditentukan sama dengan [AlphaModulateFixed](./) saat ini. |
...
| **float** [get_Amount](./get_amount/)() override | Mengembalikan jumlah efek dalam persen. Baca **float**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixedEffectiveData](../ialphamodulatefixedeffectivedata/)\> [GetEffective](./geteffective/)() override | Mendapatkan data efek Alpha Modulate Fixed yang efektif dengan warisan yang diterapkan. |
...
| void [set_Amount](./set_amount/)(**float**) override | Mengembalikan jumlah efek dalam persen. Tulis **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Mengatur argumen templat ke-n menjadi weak pointer (bukan shared). Memungkinkan peralihan pointer dalam kontainer ke mode lemah. |
...
| void [Unlock](../../system/object/unlock/)() | Menerapkan pelepasan pernyataan lock() C#. Panggil secara langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
...
* Kelas [IAlphaModulateFixed](../ialphamodulatefixed/)
