...
description: Objek tak dapat diubah yang mewakili efek Alpha Modulate Fixed. Nilai alpha efek (opasitas) dikalikan dengan persentase tetap.
type: docs
weight: 378
url: /id/aspose.slides.effects/ialphamodulatefixedeffectivedata/
---
## IAlphaModulateFixedEffectiveData kelas

Objek tak dapat diubah yang mewakili efek Alpha Modulate Fixed. Nilai alpha efek (opasitas) dikalikan dengan persentase tetap.
...
| virtual **float** [get_Amount](./get_amount/)() | Mengembalikan jumlah efek dalam persen. Hanya-baca **float**. |
