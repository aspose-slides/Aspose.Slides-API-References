...
description: Objek tidak dapat diubah yang mewakili efek Alpha Modulate. Nilai alpha (keburaman) efek dikalikan dengan persentase tetap. Kontainer efek menentukan efek yang berisi nilai alpha untuk dimodulasi.
type: docs
weight: 352
url: /id/aspose.slides.effects/ialphamodulateeffectivedata/
---
## IAlphaModulateEffectiveData kelas

Objek tak dapat diubah yang mewakili efek Alpha Modulate. Nilai alpha (keburaman) efek dikalikan dengan persentase tetap. Kontainer efek menentukan efek yang berisi nilai alpha untuk dimodulasi.
