...
| virtual **float** [get_Direction](./get_direction/)() | Arah bayangan. Baca **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Jarak bayangan. Baca **double**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_ShadowColor](./get_shadowcolor/)() | Warna bayangan. Hanya-baca [IColorFormat](../../aspose.slides/icolorformat/). |
...
| virtual void [set_BlurRadius](./set_blurradius/)(**double**) | [Blur](../blur/) jari-jari. Tulis **double**. |
| virtual void [set_Direction](./set_direction/)(**float**) | Arah bayangan. Tulis **float**. |
| virtual void [set_Distance](./set_distance/)(**double**) | Jarak bayangan. Tulis **double**. |
