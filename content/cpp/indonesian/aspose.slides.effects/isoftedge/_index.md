...
description: Mewakili efek Soft Edge. Tepi bentuk menjadi buram, sementara isi tidak terpengaruh.
type: docs
weight: 963
...
Mewakili efek Soft Edge. Tepi bentuk menjadi buram, sementara isi tidak terpengaruh.
...
| virtual **double** [get_Radius](./get_radius/)() | Menentukan radius blur yang diterapkan pada tepi. Baca **double**. |
...
| virtual void [set_Radius](./set_radius/)(**double**) | Menentukan radius blur yang diterapkan pada tepi. Tulis **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menyetel argumen template ke-n sebagai weak pointer (bukan shared). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
