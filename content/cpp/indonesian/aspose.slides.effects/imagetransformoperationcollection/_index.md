...
| Metode | Deskripsi |
| --- | --- |
| void [Add](./add/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) override | Menambahkan efek gambar baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaBiLevel](../ialphabilevel/)\> [AddAlphaBiLevelEffect](./addalphabileveleffect/)(**float**) override | Menambahkan efek Alpha Bi-Level baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaCeiling](../ialphaceiling/)\> [AddAlphaCeilingEffect](./addalphaceilingeffect/)() override | Menambahkan efek Alpha Ceiling baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaFloor](../ialphafloor/)\> [AddAlphaFloorEffect](./addalphaflooreffect/)() override | Menambahkan efek Alpha Floor baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaInverse](../ialphainverse/)\> [AddAlphaInverseEffect](./addalphainverseeffect/)() override | Menambahkan efek Alpha Inverse baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulate](../ialphamodulate/)\> [AddAlphaModulateEffect](./addalphamodulateeffect/)() override | Menambahkan efek Alpha Modulate baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaModulateFixed](../ialphamodulatefixed/)\> [AddAlphaModulateFixedEffect](./addalphamodulatefixedeffect/)(**float**) override | Menambahkan efek Alpha Modulate Fixed baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAlphaReplace](../ialphareplace/)\> [AddAlphaReplaceEffect](./addalphareplaceeffect/)(**float**) override | Menambahkan efek Alpha Replace baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBiLevel](../ibilevel/)\> [AddBiLevelEffect](./addbileveleffect/)(**float**) override | Menambahkan efek Bi-Level (hitam/putih) baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBlur](../iblur/)\> [AddBlurEffect](./addblureffect/)(**double**, **bool**) override | Menambahkan efek [Blur](../blur/) baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IBrightnessContrast](../ibrightnesscontrast/)\> [AddBrightnessContrastEffect](./addbrightnesscontrasteffect/)(**float**, **float**) override | Menambahkan efek [BrightnessContrast](../brightnesscontrast/) baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorChange](../icolorchange/)\> [AddColorChangeEffect](./addcolorchangeeffect/)() override | Menambahkan efek Color Change baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorReplace](../icolorreplace/)\> [AddColorReplaceEffect](./addcolorreplaceeffect/)() override | Menambahkan efek Color Replacement baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IDuotone](../iduotone/)\> [AddDuotoneEffect](./addduotoneeffect/)() override | Menambahkan efek [Duotone](../duotone/) baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IFillOverlay](../ifilloverlay/)\> [AddFillOverlayEffect](./addfilloverlayeffect/)() override | Menambahkan efek Fill Overlay baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IGrayScale](../igrayscale/)\> [AddGrayScaleEffect](./addgrayscaleeffect/)() override | Menambahkan efek Gray Scale baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[IHSL](../ihsl/)\> [AddHSLEffect](./addhsleffect/)(**float**, **float**, **float**) override | Menambahkan efek Hue/Saturation/Luminance baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[ILuminance](../iluminance/)\> [AddLuminanceEffect](./addluminanceeffect/)(**float**, **float**) override | Menambahkan efek [Luminance](../luminance/) baru ke akhir koleksi. |
| [System::SharedPtr](../../system/sharedptr/)\<[ITint](../itint/)\> [AddTintEffect](./addtinteffect/)(**float**, **float**) override | Menambahkan efek [Tint](../tint/) baru ke akhir koleksi. |
...
| void [Clear](./clear/)() override | Menghapus semua efek gambar dari sebuah koleksi. |
| **bool** [Contains](./contains/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) const override | Menentukan apakah [ICollection](../../system.collections.generic/icollection/) berisi nilai tertentu. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\>, **int32_t**) override | Menyalin elemen [ICollection](../../system.collections.generic/icollection/) ke sebuah [System::Array](../../system/array/), dimulai pada indeks [System::Array](../../system/array/) tertentu. |
...
| **int32_t** [get_Count](./get_count/)() const override | Mengembalikan jumlah efek gambar dalam koleksi. Baca-saja **int32_t**. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Mendapatkan nilai yang menunjukkan apakah [ICollection](../../system.collections.generic/icollection/) bersifat baca-saja. Baca-saja **bool**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator yang mengiterasi koleksi. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\> [idx_get](./idx_get/)(**int32_t**) override | Mengembalikan [ImageTransformOperation](../imagetransformoperation/) dari koleksi berdasarkan indeksnya. |
...
| **bool** [Remove](./remove/)(const [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperation](../iimagetransformoperation/)\>\&) override | Menghapus kemunculan pertama dari objek tertentu dari [ICollection](../../system.collections.generic/icollection/). |
| void [RemoveAt](./removeat/)(**int32_t**) override | Menghapus efek gambar dari koleksi pada indeks yang ditentukan. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Menambah hitungan referensi bersama. Tidak seharusnya dipanggil langsung; gunakan smart pointers atau ThisProtector. |
...
| void [Unlock](../../system/object/unlock/)() | Menerapkan pernyataan C# lock() untuk membuka kunci. Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
...
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Menambah hitungan referensi weak. Tidak seharusnya dipanggil langsung; gunakan smart pointers atau ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Mengurangi hitungan referensi weak. Tidak seharusnya dipanggil langsung; gunakan smart pointers atau ThisProtector. |
...
* Kelas [IImageTransformOperationCollection](../iimagetransformoperationcollection/)
