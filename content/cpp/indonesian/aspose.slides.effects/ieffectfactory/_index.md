...
description: Mengizinkan membuat instansi efek
type: docs
weight: 599
url: /id/aspose.slides.effects/ieffectfactory/
---
## IEffectFactory kelas


Mengizinkan membuat instansi efek
...
| Metode | Deskripsi |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IGlow](../iglow/)\> [CreateGlow](./createglow/)() | Membuat efek [Glow](../glow/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IInnerShadow](../iinnershadow/)\> [CreateInnerShadow](./createinnershadow/)() | Membuat efek bayangan dalam. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IOuterShadow](../ioutershadow/)\> [CreateOuterShadow](./createoutershadow/)() | Membuat efek bayangan luar. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IPresetShadow](../ipresetshadow/)\> [CreatePresetShadow](./createpresetshadow/)() | Membuat efek bayangan preset. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IReflection](../ireflection/)\> [CreateReflection](./createreflection/)() | Membuat efek [Reflection](../reflection/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdge](../isoftedge/)\> [CreateSoftEdge](./createsoftedge/)() | Membuat efek Soft Edge. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IImageTransformOperationFactory](../iimagetransformoperationfactory/)\> [get_ImageTransformOperationFactory](./get_imagetransformoperationfactory/)() | Mengembalikan [ImageTransformOperationFactory](../imagetransformoperationfactory/). Hanya-baca [IImageTransformOperationFactory](../iimagetransformoperationfactory/). |
...
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Memeriksa apakah objek merupakan instansi tipe yang dijelaskan oleh targetType. Analog operator C# 'is'. |
...
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Menambah penghitung referensi berbagi. Tidak boleh dipanggil secara langsung; gunakan smart pointer atau ThisProtector. |
