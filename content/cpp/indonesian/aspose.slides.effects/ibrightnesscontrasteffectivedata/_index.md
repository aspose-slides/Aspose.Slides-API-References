...
---
## IBrightnessContrastEffectiveData kelas

Objek tak berubah yang mewakili efek [BrightnessContrast](../brightnesscontrast/). Menyesuaikan kecerahan dan kontras
...
| virtual **float** [get_Brightness](./get_brightness/)() | Mengembalikan kecerahan. Hanya-baca **float**. |
| virtual **float** [get_Contrast](./get_contrast/)() | Mengembalikan kontras. Hanya-baca **float**. |
