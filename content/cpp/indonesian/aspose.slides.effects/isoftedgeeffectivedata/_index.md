...
description: Objek tak dapat diubah yang mewakili efek tepi lembut. Tepi bentuk menjadi buram, sementara isian tidak terpengaruh.
type: docs
weight: 976
url: /id/aspose.slides.effects/isoftedgeeffectivedata/
---
## ISoftEdgeEffectiveData kelas

Objek tidak dapat diubah yang mewakili efek tepi lembut. Tepi bentuk menjadi buram, sementara isian tidak terpengaruh.

```cpp
class ISoftEdgeEffectiveData : public virtual Aspose::Slides::Effects::IEffectEffectiveData
```
...
| virtual **double** [get_Radius](./get_radius/)() | Menentukan radius blur yang diterapkan pada tepi. **double** baca-saja. |
