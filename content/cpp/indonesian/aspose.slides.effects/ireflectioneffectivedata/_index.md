...
description: Objek tak dapat diubah yang mewakili efek Refleksi.
type: docs
weight: 950
url: /id/aspose.slides.effects/ireflectioneffectivedata/
---
## IReflectionEffectiveData kelas

Objek tak dapat diubah yang mewakili sebuah efek [Reflection](../reflection/).
...
| virtual **double** [get_BlurRadius](./get_blurradius/)() | [Blur](../blur/) radius. Hanya baca **double**. |
| virtual **float** [get_Direction](./get_direction/)() | Arah refleksi. Hanya baca **float**. |
| virtual **double** [get_Distance](./get_distance/)() | Jarak refleksi. Hanya baca **double**. |
| virtual **float** [get_EndPosAlpha](./get_endposalpha/)() | Menentukan posisi akhir (pada ramp gradien alfa) nilai alfa akhir (persen). Hanya baca **float**. |
| virtual **float** [get_EndReflectionOpacity](./get_endreflectionopacity/)() | Opasitas akhir refleksi. (persen). Hanya baca **float**. |
| virtual **float** [get_FadeDirection](./get_fadedirection/)() | Menentukan arah offset refleksi. (sudut). Hanya baca **float**. |
| virtual [RectangleAlignment](../../aspose.slides/rectanglealignment/) [get_RectangleAlign](./get_rectanglealign/)() | Penyelarasan persegi panjang. Hanya baca [RectangleAlignment](../../aspose.slides/rectanglealignment/). |
| virtual **bool** [get_RotateShadowWithShape](./get_rotateshadowwithshape/)() | Menentukan apakah refleksi harus berputar bersama bentuk jika bentuk diputar. Hanya baca **bool**. |
| virtual **double** [get_ScaleHorizontal](./get_scalehorizontal/)() | Menentukan faktor skala horizontal, skala negatif menyebabkan pembalikan. (persen) Hanya baca **double**. |
| virtual **double** [get_ScaleVertical](./get_scalevertical/)() | Menentukan faktor skala vertikal, skala negatif menyebabkan pembalikan. (persen) Hanya baca **double**. |
| virtual **double** [get_SkewHorizontal](./get_skewhorizontal/)() | Menentukan sudut kemiringan horizontal. Hanya baca **double**. |
| virtual **double** [get_SkewVertical](./get_skewvertical/)() | Menentukan sudut kemiringan vertikal. Hanya baca **double**. |
| virtual **float** [get_StartPosAlpha](./get_startposalpha/)() | Menentukan posisi awal (pada ramp gradien alfa) nilai alfa awal (persen). Hanya baca **float**. |
| virtual **float** [get_StartReflectionOpacity](./get_startreflectionopacity/)() | Opasitas awal refleksi. (persen). Hanya baca **float**. |
