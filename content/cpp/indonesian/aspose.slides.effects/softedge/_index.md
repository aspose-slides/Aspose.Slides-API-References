...
description: Mewakili efek tepi lembut. Tepi bentuk menjadi kabur, sementara isi tidak terpengaruh.
type: docs
weight: 1080
...
| Method | Description |
| --- | --- |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Menentukan apakah [SoftEdge](./) yang ditentukan sama dengan [SoftEdge](./) saat ini. |
...
| **double** [get_Radius](./get_radius/)() override | Menentukan radius blur yang diterapkan pada tepi. Baca **double**. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ISoftEdgeEffectiveData](../isoftedgeeffectivedata/)\> [GetEffective](./geteffective/)() override | Mendapatkan data efek Soft Edge efektif dengan pewarisan yang diterapkan. |
...
| void [set_Radius](./set_radius/)(**double**) override | Menentukan radius blur yang diterapkan pada tepi. Tulis **double**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi pointer lemah (bukan berbagi). Memungkinkan pergantian pointer dalam kontainer ke mode lemah. |
...
| void [Unlock](../../system/object/unlock/)() | Mengimplementasikan pernyataan lock() C# untuk pembukaan kunci. Panggil langsung atau gunakan objek sentry [LockContext](../../system/lockcontext/). |
