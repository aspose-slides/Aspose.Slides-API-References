...
description: Merepresentasikan efek Blur yang diterapkan pada seluruh bentuk, termasuk isinya. Semua saluran warna, termasuk alpha, dipengaruhi.
type: docs
weight: 456
...
Merepresentasikan efek [Blur](../blur/) yang diterapkan pada seluruh bentuk, termasuk isinya. Semua saluran warna, termasuk alpha, dipengaruhi.
...
| virtual **bool** [get_Grow](./get_grow/)() | Menentukan apakah batas objek harus diperluas sebagai hasil dari blur. True menunjukkan batas diperluas sementara false menunjukkan tidak. Baca **bool**. |
| virtual **double** [get_Radius](./get_radius/)() | Mengembalikan radius blur. Baca **double**. |
...
| virtual void [set_Grow](./set_grow/)(**bool**) | Menentukan apakah batas objek harus diperluas sebagai hasil dari blur. True menunjukkan batas diperluas sementara false menunjukkan tidak. Tuliskan **bool**. |
| virtual void [set_Radius](./set_radius/)(**double**) | Mengatur radius blur. Tuliskan **double**. |
