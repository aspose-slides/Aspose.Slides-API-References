...
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) dari instance koleksi yang bertipe const. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Mendapatkan iterator yang menunjuk ke elemen pertama (jika ada) yang bersifat const dari koleksi. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Mendapatkan iterator yang menunjukkan tepat setelah elemen terakhir yang bersifat const (jika ada) dari koleksi. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>, **int32_t**) override | Menyalin semua elemen dari koleksi ke dalam array yang ditentukan. |
| [iterator](./iterator/) [end](./end/)() | Mendapatkan iterator yang menunjukkan tepat setelah elemen terakhir (jika ada) dari koleksi. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Mendapatkan iterator yang menunjukkan tepat setelah elemen terakhir (jika ada) dari instance koleksi yang bersifat const. |
| **bool** [Equals](./equals/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) override | Menentukan apakah objek yang disebutkan sama dengan objek saat ini. |
...
| **int32_t** [get_Count](./get_count/)() override | Mengembalikan jumlah efek gambar dalam koleksi. **int32_t** hanya-baca. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Mengembalikan nilai yang menunjukkan apakah akses ke koleksi disinkronkan (aman untuk benang). **bool** hanya-baca. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\>\>\> [GetEnumerator](./getenumerator/)() override | Mengembalikan enumerator yang mengiterasi melalui koleksi. |
| **int32_t** [GetHashCode](./gethashcode/)() const override | Berfungsi sebagai fungsi hash untuk tipe tertentu, cocok untuk algoritma hashing dan struktur data seperti tabel hash. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IEffectEffectiveData](../ieffecteffectivedata/)\> [idx_get](./idx_get/)(**int32_t**) override | Mengembalikan elemen berdasarkan indeks. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen template ke-n menjadi pointer lemah (bukan berbagi). Memungkinkan beralih pointer dalam kontainer ke mode lemah. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Mendapatkan iterator yang menunjukkan tepat setelah elemen terakhir (jika ada) dari instance koleksi yang bersifat const. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Mendapatkan iterator yang menunjukkan tepat setelah elemen terakhir (jika ada) dari koleksi. |
...
Nama IImageTransformOperationCollectionEffectiveData dipotong menjadi [IImageTransformOCollectionEffectiveData](../iimagetransformocollectioneffectivedata/) karena panjang nama COM tidak boleh lebih dari 39.

## Lihat Juga

* Kelas [IEffectiveData](../../aspose.slides/ieffectivedata/)
* Kelas [IImageTransformOCollectionEffectiveData](../iimagetransformocollectioneffectivedata/)
