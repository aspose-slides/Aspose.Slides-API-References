...
description: Enumerable yang digunakan oleh metode ekstensi IEnumerable.Select().
type: docs
weight: 14
url: /id/system.collections.generic.details/enumerableselectadapter/
---
## EnumerableSelectAdapter kelas

Enumerable yang digunakan oleh metode ekstensi IEnumerable.Select().
...
| Parameter | Deskripsi |
| --- | --- |
| Source | Tipe sumber dari elemen koleksi. |
| Result | Tipe hasil dari elemen koleksi. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Mendapatkan tipe nyata dari objek. Analogi panggilan C# [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen templat ke-n menjadi weak pointer (bukan shared). Memungkinkan mengganti pointer dalam kontainer ke mode weak. |
