...
description: Enumerator yang digunakan oleh metode ekstensi IEnumerable.Select().
type: docs
weight: 79
url: /id/system.collections.generic.details/enumeratorselectadapter/
---
## EnumeratorSelectAdapter kelas

Enumerator yang digunakan oleh metode ekstensi IEnumerable.Select().
...
| Parameter | Deskripsi |
| --- | --- |
| Source | Tipe sumber elemen koleksi. |
| Result | Tipe hasil elemen koleksi. |
## Metode
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Mendorong iterator satu langkah ke depan. |
...
| **bool** [MoveNext](./movenext/)() override | Memindahkan enumerator ke elemen berikutnya. Jika tidak ada elemen yang direferensikan sebelumnya, mengatur referensi ke elemen pertama yang tersedia. Jika akhir kontainer tercapai, tidak melakukan apa-apa. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Menetapkan argumen templat ke-nth menjadi pointer lemah (bukan shared). Memungkinkan mengganti pointer dalam kontainer ke mode lemah. |
