...
| [TimeSpan](../../system/timespan/) [get_Elapsed](./get_elapsed/)() const | Mendapatkan total waktu yang berlalu yang diukur oleh instance saat ini. |
| **int64_t** [get_ElapsedMilliseconds](./get_elapsedmilliseconds/)() const | Mendapatkan total waktu yang berlalu yang diukur oleh instance saat ini, dalam milidetik. |
| **int64_t** [get_ElapsedTicks](./get_elapsedticks/)() const | Mendapatkan total waktu yang berlalu yang diukur oleh instance saat ini, dalam tick timer. |
| **bool** [get_IsRunning](./get_isrunning/)() const | Memeriksa apakah stopwatch sedang berjalan. |
...
| void [Reset](./reset/)() | Menghentikan pengukuran waktu, mengatur interval yang diukur menjadi nol. |
| void [Restart](./restart/)() | Mengatur interval yang diukur menjadi nol, kemudian memulai pengukuran waktu. |
...
| void [Start](./start/)() | Memulai pengukuran waktu. |
| static [SharedPtr](../../system/sharedptr/)\<[Stopwatch](./)\> [StartNew](./startnew/)() | Membuat objek [Stopwatch](./) baru dan memulai pengukuran. |
| void [Stop](./stop/)() | Menghentikan pengukuran waktu. |
