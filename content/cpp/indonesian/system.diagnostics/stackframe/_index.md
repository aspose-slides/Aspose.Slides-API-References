...
description: "Mendapatkan informasi pada satu frame stack. Hanya MSVS. Objek-objek kelas ini harus hanya dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance dari tipe ini pada stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kesalahan asersi. Selalu balut kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen."
type: docs
weight: 53
url: /id/system.diagnostics/stackframe/
---
## StackFrame kelas

Mendapatkan informasi pada satu frame stack. Hanya MSVS. Objek dari kelas ini harus hanya dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance dari tipe ini pada stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kesalahan asersi. Selalu balut kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk meneruskannya ke fungsi sebagai argumen.
...
| virtual int [GetFileColumnNumber](./getfilecolumnnumber/)() | Mendapatkan nomor colnum. |
| virtual int [GetFileLineNumber](./getfilelinenumber/)() | Mendapatkan nomor baris. |
| virtual [System::String](../../system/string/) [GetFileName](./getfilename/)() | Mendapatkan nama file. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analog dari metode C# [Object.GetHashCode()](../../system/object/gethashcode/). Mengaktifkan hashing objek khusus. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Reflection::MethodBase](../../system.reflection/methodbase/)\> [GetMethod](./getmethod/)() | Mendapatkan informasi metode. |
...
| const [StackFrame](./)\& [operator=](./operator_equal/)(const [StackFrame](./)\&) const | Tidak ada perubahan. |
...
|  [StackFrame](./stackframe/)(const [StackFrame](./)\&) | Tidak menyalin. |
