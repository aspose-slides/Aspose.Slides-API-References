...
description: "Menjelaskan parameter start proses. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi System::MakeObject(). Jangan pernah membuat instance tipe ini di stack atau menggunakan operator new, karena akan menyebabkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer System::SmartPtr dan gunakan pointer tersebut untuk mengirimkannya ke fungsi sebagai argumen."
type: docs
weight: 40
url: /id/system.diagnostics/processstartinfo/
---
## ProcessStartInfo kelas

Menjelaskan parameter start proses. Objek dari kelas ini hanya boleh dialokasikan menggunakan fungsi [System::MakeObject()](../../system/makeobject/). Jangan pernah membuat instance dari tipe ini di stack atau menggunakan operator new, karena akan menghasilkan kesalahan runtime dan/atau kegagalan asersi. Selalu bungkus kelas ini ke dalam pointer [System::SmartPtr](../../system/smartptr/) dan gunakan pointer ini untuk mengirimkannya ke fungsi sebagai argumen.
...
| [String](../../system/string/) [get_Arguments](./get_arguments/)() const | Mengambil argumen proses. |
| **bool** [get_CreateNoWindow](./get_createnowindow/)() const | Mengambil properti NoWindow. |
| [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::Dictionary](../../system.collections.generic/dictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [get_EnvironmentVariables](./get_environmentvariables/)() const | Mengambil variabel lingkungan proses. |
| [String](../../system/string/) [get_FileName](./get_filename/)() const | Mengambil nama file proses. |
| **bool** [get_RedirectStandardError](./get_redirectstandarderror/)() const | Mengambil properti RedirectStandardError. |
| **bool** [get_RedirectStandardInput](./get_redirectstandardinput/)() const | Mengambil properti RedirectStandardInput. |
| **bool** [get_RedirectStandardOutput](./get_redirectstandardoutput/)() const | Mengambil properti RedirectStandardOutput. |
| **bool** [get_UseShellExecute](./get_useshellexecute/)() const | Mengambil properti UseShellExecute. |
| [ProcessWindowStyle](../processwindowstyle/) [get_WindowStyle](./get_windowstyle/)() const | Mengambil gaya jendela. |
| [String](../../system/string/) [get_WorkingDirectory](./get_workingdirectory/)() const | Mengambil direktori kerja proses. |
...
| void [Lock](../../system/object/lock/)() | Menerapkan penguncian pernyataan lock() C#. Panggil langsung atau gunakan objek pengawas [LockContext](../../system/lockcontext/). |
...
|  [ProcessStartInfo](./processstartinfo/)() | Membuat objek start info kosong. |
|  [ProcessStartInfo](./processstartinfo/)(const [String](../../system/string/)\&) | Membuat objek start info. |
|  [ProcessStartInfo](./processstartinfo/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Membuat objek start info. |
...
| void [set_Arguments](./set_arguments/)(const [String](../../system/string/)\&) | Mengatur argumen proses. |
| void [set_CreateNoWindow](./set_createnowindow/)(**bool**) | Mengatur properti NoWindow. |
| void [set_FileName](./set_filename/)(const [String](../../system/string/)\&) | Mengatur nama file proses. |
| void [set_RedirectStandardError](./set_redirectstandarderror/)(**bool**) | Mengatur properti RedirectStandardError. |
| void [set_RedirectStandardInput](./set_redirectstandardinput/)(**bool**) | Mengatur properti RedirectStandardInput. |
| void [set_RedirectStandardOutput](./set_redirectstandardoutput/)(**bool**) | Mengatur properti RedirectStandardOutput. |
| void [set_UseShellExecute](./set_useshellexecute/)(**bool**) | Mengatur properti UseShellExecute. |
| void [set_WindowStyle](./set_windowstyle/)([ProcessWindowStyle](../processwindowstyle/)) | Mengatur gaya jendela. |
| void [set_WorkingDirectory](./set_workingdirectory/)(const [String](../../system/string/)\&) | Mengatur direktori kerja proses. |
...
| void [Unlock](../../system/object/unlock/)() | Menerapkan pelepasan pernyataan lock() C#. Panggil langsung atau gunakan objek pengawas [LockContext](../../system/lockcontext/). |
