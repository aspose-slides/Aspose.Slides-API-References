...
description: Renvoie une valeur déterminant la qualité des images JPEG à l'intérieur du document PDF. Lecture uint8_t.
type: docs
weight: 79
url: /fr/aspose.slides.export/ihtmloptions/get_jpegquality/
---
## IHtmlOptions::get_JpegQuality() méthode


Renvoie une valeur déterminant la qualité des images JPEG à l'intérieur du document PDF. Lecture **uint8_t**.
