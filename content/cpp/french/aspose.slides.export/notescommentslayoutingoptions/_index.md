...
Fournit des options qui contrôlent l'aspect de la mise en page des notes et des commentaires dans le document exporté.
...
| [System::Drawing::Color](../../system.drawing/color/) [get_CommentsAreaColor](./get_commentsareacolor/)() | Obtient la couleur de la zone des commentaires (Applicable uniquement si les commentaires sont affichés à droite). |
| **int32_t** [get_CommentsAreaWidth](./get_commentsareawidth/)() | Obtient la largeur de la zone de sortie des commentaires en pixels (Applicable uniquement si les commentaires sont affichés à droite). |
| [CommentsPositions](../commentspositions/) [get_CommentsPosition](./get_commentsposition/)() | Obtient la position des commentaires sur la page. |
| [NotesPositions](../notespositions/) [get_NotesPosition](./get_notesposition/)() | Obtient la position des notes sur la page. |
| **bool** [get_ShowCommentsByNoAuthor](./get_showcommentsbynoauthor/)() | Obtient la visibilité des commentaires sans auteur. Si vrai, les commentaires seront affichés. (Applicable uniquement si les commentaires sont affichés). |
...
| void [set_CommentsAreaColor](./set_commentsareacolor/)([System::Drawing::Color](../../system.drawing/color/)) | Définit la couleur de la zone des commentaires (Applicable uniquement si les commentaires sont affichés à droite). |
| void [set_CommentsAreaWidth](./set_commentsareawidth/)(**int32_t**) | Définit la largeur de la zone de sortie des commentaires en pixels (Applicable uniquement si les commentaires sont affichés à droite). |
| void [set_CommentsPosition](./set_commentsposition/)([CommentsPositions](../commentspositions/)) | Définit la position des commentaires sur la page. |
| void [set_NotesPosition](./set_notesposition/)([NotesPositions](../notespositions/)) | Définit la position des notes sur la page. |
| void [set_ShowCommentsByNoAuthor](./set_showcommentsbynoauthor/)(**bool**) | Définit la visibilité des commentaires sans auteur. Si vrai, les commentaires seront affichés. (Applicable uniquement si les commentaires sont affichés). |
