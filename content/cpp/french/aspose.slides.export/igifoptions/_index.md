...
| virtual **int32_t** [get_DefaultDelay](./get_defaultdelay/)() | Obtient le délai par défaut [ms]. Cette valeur sera utilisée si la méthode [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/) n'a pas été appelée. La valeur par défaut est 1000. |
| virtual [System::String](../../system/string/) [get_DefaultRegularFont](../isaveoptions/get_defaultregularfont/)() | Renvoie la police utilisée lorsqu'une police source n'est pas trouvée. Lit [System::String](../../system/string/). |
| virtual **bool** [get_ExportHiddenSlides](./get_exporthiddenslides/)() | Détermine si les diapositives cachées seront exportées. La valeur par défaut est false. |
| virtual [System::Drawing::Size](../../system.drawing/size/) [get_FrameSize](./get_framesize/)() | Obtient la taille du cadre. |
...
| virtual **bool** [get_SkipJavaScriptLinks](../isaveoptions/get_skipjavascriptlinks/)() | Spécifie si les hyperliens contenant des appels JavaScript doivent être ignorés lors de l'enregistrement de la présentation. Lire **bool**. La valeur par défaut est **false**. |
| virtual **int32_t** [get_TransitionFps](./get_transitionfps/)() | Obtient les FPS de transition [images/s] La valeur par défaut est 25. |
...
| virtual void [set_DefaultDelay](./set_defaultdelay/)(**int32_t**) | Définit le délai par défaut [ms]. Cette valeur sera utilisée si la méthode [ISlideShowTransition::set_AdvanceAfterTime()](../../aspose.slides/islideshowtransition/set_advanceaftertime/) n'a pas été appelée. La valeur par défaut est 1000. |
| virtual void [set_DefaultRegularFont](../isaveoptions/set_defaultregularfont/)([System::String](../../system/string/)) | Définit la police utilisée lorsqu'une police source n'est pas trouvée. Écrit [System::String](../../system/string/). |
| virtual void [set_ExportHiddenSlides](./set_exporthiddenslides/)(**bool**) | Détermine si les diapositives cachées seront exportées. La valeur par défaut est false. |
| virtual void [set_FrameSize](./set_framesize/)([System::Drawing::Size](../../system.drawing/size/)) | Définit la taille du cadre. |
...
| virtual void [set_SkipJavaScriptLinks](../isaveoptions/set_skipjavascriptlinks/)(**bool**) | Spécifie si les hyperliens contenant des appels JavaScript doivent être ignorés lors de l'enregistrement de la présentation. Écrire **bool**. La valeur par défaut est **false**. |
| virtual void [set_TransitionFps](./set_transitionfps/)(**int32_t**) | Définit les FPS de transition [images/s] La valeur par défaut est 25. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉᵐ argument de modèle comme pointeur faible (plutôt que partagé). Permet de basculer les pointeurs dans les conteneurs en mode faible. |
