...
type: docs
weight: 27
url: /fr/aspose.slides.export/inkoptions/get_interpretmaskopasopacity/
---
## InkOptions::get_InterpretMaskOpAsOpacity() méthode
...
L'exemple suivant montre comment configurer l'utilisation de ROP pour l'exportation des éléments [Ink](../../../aspose.slides.ink/) :
```cpp
