...
Fournit des options qui contrôlent l'apparence des objets [Ink](../../aspose.slides.ink/) dans le document exporté.
...
| **bool** [get_HideInk](./get_hideink/)() override | Affiche ou masque les éléments [Ink](../../aspose.slides.ink/) dans le document exporté. |
| **bool** [get_InterpretMaskOpAsOpacity](./get_interpretmaskopasopacity/)() override | Utilise l'opération ROP ou l'opacité pour le rendu du pinceau. |
...
| void [set_HideInk](./set_hideink/)(**bool**) override | Affiche ou masque les éléments [Ink](../../aspose.slides.ink/) dans le document exporté. |
| void [set_InterpretMaskOpAsOpacity](./set_interpretmaskopasopacity/)(**bool**) override | Utilise l'opération ROP ou l'opacité pour le rendu du pinceau. |
