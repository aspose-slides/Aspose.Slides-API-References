...
description: Représente le mode de mise en page de la présentation handout pour l'exportation.
type: docs
weight: 66
...
Représente le mode de mise en page de la présentation handout pour l'exportation.
...
| [HandoutType](../handouttype/) [get_Handout](./get_handout/)() const | Spécifie le nombre de diapositives et la séquence dans laquelle elles seront placées sur la page [HandoutType](../handouttype/). |
| **bool** [get_PrintComments](./get_printcomments/)() const | Spécifie s’il faut afficher les commentaires sur les diapositives ou non |
| **bool** [get_PrintFrameSlide](./get_printframeslide/)() const | Spécifie s’il faut dessiner des cadres autour des diapositives affichées ou non. |
| **bool** [get_PrintSlideNumbers](./get_printslidenumbers/)() const | Spécifie s’il faut imprimer les numéros de diapositives affichés ou non. |
...
| void [set_Handout](./set_handout/)([HandoutType](../handouttype/)) | Spécifie le nombre de diapositives et la séquence dans laquelle elles seront placées sur la page [HandoutType](../handouttype/). |
| void [set_PrintComments](./set_printcomments/)(**bool**) | Spécifie s’il faut afficher les commentaires sur les diapositives ou non |
| void [set_PrintFrameSlide](./set_printframeslide/)(**bool**) | Spécifie s’il faut dessiner des cadres autour des diapositives affichées ou non. |
| void [set_PrintSlideNumbers](./set_printslidenumbers/)(**bool**) | Spécifie s’il faut imprimer les numéros de diapositives affichés ou non. |
