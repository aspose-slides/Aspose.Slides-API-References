...
---
## IPresentationAnimationPlayer classe
...
| virtual ASPOSE_SLIDES_LOCAL_API **double** [get_Duration](./get_duration/)() | Obtient la durée de l'animation [ms] |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| virtual ASPOSE_SLIDES_LOCAL_API [System::SharedPtr](../../system/sharedptr/)\<[IImage](../../aspose.slides/iimage/)\> [GetFrame](./getframe/)() | Obtient la trame pour la position temporelle actuelle précédemment définie avec la méthode [IPresentationAnimationPlayer::SetTimePosition](./settimeposition/). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, vraiment, il initialise juste le nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, vraiment, il initialise juste le nouvel objet et permet la construction par copie des sous-classes. |
...
| virtual ASPOSE_SLIDES_LOCAL_API void [SetTimePosition](./settimeposition/)(**double**) | Définit la position temporelle de l'animation dans le [IPresentationAnimationPlayer::get_Duration](./get_duration/). |
...
Animations générées par [PresentationAnimationsGenerator](../presentationanimationsgenerator/) via son événement **PresentationAnimationsGenerator::NewAnimation**. 
