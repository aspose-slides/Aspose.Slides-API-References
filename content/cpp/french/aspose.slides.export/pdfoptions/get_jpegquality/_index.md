...
description: Renvoie une valeur déterminant la qualité des images JPEG à l'intérieur du document PDF. Lire uint8_t.
type: docs
weight: 222
url: /fr/aspose.slides.export/pdfoptions/get_jpegquality/
---
## PdfOptions::get_JpegQuality() méthode


Renvoie une valeur déterminant la qualité des images JPEG à l'intérieur du document PDF. Lire **uint8_t**.
