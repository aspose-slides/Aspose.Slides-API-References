...
description: Représente les options pour la partie texte SVG (\"tspan\").
type: docs
weight: 729
...
Représente les options pour la partie texte SVG ("tspan").
...
| [System::String](../../system/string/) [get_Id](./get_id/)() override | Obtient l'id de l'élément "tspan" |
...
| void [set_Id](./set_id/)([System::String](../../system/string/)) override | Obtient l'id de l'élément "tspan" |
