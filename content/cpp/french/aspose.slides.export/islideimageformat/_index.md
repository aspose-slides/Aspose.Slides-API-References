...
description: Détermine le format dans lequel l'image de diapositive sera enregistrée pour la présentation lors de l'exportation HTML.
type: docs
weight: 378
url: /fr/aspose.slides.export/islideimageformat/
---
## ISlideImageFormat classe


Détermine le format dans lequel l'image de diapositive sera enregistrée pour la présentation lors de l'exportation HTML.
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il se contente d'initialiser un nouvel objet et permet de construire par copie les sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, en réalité, il se contente d'initialiser un nouvel objet et permet de construire par copie les sous-classes. |
