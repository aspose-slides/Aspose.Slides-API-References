...
description: Représente le lecteur d'animations associé à la présentation.
type: docs
weight: 625
...
| Method | Description |
| --- | --- |
| void [Dispose](./dispose/)() override | Libère l'instance du [PresentationPlayer](./). |
...
| **int32_t** [get_FrameIndex](./get_frameindex/)() | Obtient l'index de la trame. |
...
|  [PresentationPlayer](./presentationplayer/)([System::SharedPtr](../../system/sharedptr/)\<[PresentationAnimationsGenerator](../presentationanimationsgenerator/)\>, **double**) | Crée une nouvelle instance du [PresentationPlayer](./). |
...
| Typedef | Description |
| --- | --- |
| [FrameTickHandler](./frametickhandler/) | Représente le gestionnaire de tick de trame de l'événement **PresentationPlayer::FrameTick**. |
