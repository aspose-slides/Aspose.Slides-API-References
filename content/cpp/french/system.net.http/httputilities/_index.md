...
description: Contient les méthodes utilitaires.
type: docs
weight: 131
url: /fr/system.net.http/httputilities/
---
...
| static **bool** [IsHttpUri](./ishttpuri/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Vérifie si l'URI spécifié est l'URI HTTP. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'assignation. Ne copie rien, vraiment, il initialise simplement un nouvel objet et permet la construction de copies des sous-classes. |
...
| Champ | Description |
| --- | --- |
| static [DefaultRequestVersion](./defaultrequestversion/) | Version HTTP par défaut pour l'envoi des requêtes. |
| static [DefaultResponseVersion](./defaultresponseversion/) | Version HTTP par défaut pour la réception des réponses. |
