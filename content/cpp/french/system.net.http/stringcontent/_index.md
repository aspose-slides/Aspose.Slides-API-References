...
description: "Représente le contenu HTTP sous forme de chaîne. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction System::MakeObject(). Ne créez jamais d’instance de ce type sur la pile ou en utilisant l’opérateur new, car cela entraînerait des erreurs d’exécution et/ou des défauts d’assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le transmettre aux fonctions en tant qu’argument."
type: docs
weight: 144
url: /fr/system.net.http/stringcontent/
---
## StringContent classe

Représente le contenu HTTP sous forme de chaîne. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d’instance de ce type sur la pile ou en utilisant l’opérateur new, car cela entraînerait des erreurs d’exécution et/ou des fautes d’assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le transmettre aux fonctions en tant qu’argument.
...
| Méthode | Description |
| --- | --- |
|  [ByteArrayContent](../bytearraycontent/bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>) | Construit une nouvelle instance. |
|  [ByteArrayContent](../bytearraycontent/bytearraycontent/)([System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>, **int32_t**, **int32_t**) | Construit une nouvelle instance. |
| void [Dispose](../httpcontent/dispose/)() override | Libère l'instance actuelle. Cette méthode libère également le flux renvoyé par 'ReadAsStream' et le tampon mémoire s'il est créé. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[Headers::HttpContentHeaders](../../system.net.http.headers/httpcontentheaders/)\> [get_Headers](../httpcontent/get_headers/)() | Renvoie les en-têtes du contenu HTTP. |
...
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)() | Sérialise le contenu dans un tampon mémoire. |
| void [LoadIntoBuffer](../httpcontent/loadintobuffer/)(**int64_t**) | Sérialise le contenu dans un tampon mémoire. |
...
| [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [ReadAsByteArray](../httpcontent/readasbytearray/)() | Sérialise le contenu et renvoie un tableau d'octets. |
| [System::SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [ReadAsStream](../httpcontent/readasstream/)() | Sérialise le contenu et renvoie un flux. |
| [String](../../system/string/) [ReadAsString](../httpcontent/readasstring/)() | Sérialise le contenu et renvoie une chaîne. |
...
| [StringContent](./stringcontent/)([String](../../system/string/)) | Construit une nouvelle instance. |
| [StringContent](./stringcontent/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>) | Construit une nouvelle instance. |
| [StringContent](./stringcontent/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>, [String](../../system/string/)) | Construit une nouvelle instance. |
...
| **bool** [TryComputeLength](../bytearraycontent/trycomputelength/)(**int64_t**\&) override | Tente de calculer la longueur du tableau d'octets. |
...
| Champ | Description |
| --- | --- |
| static [DefaultStringEncoding](../httpcontent/defaultstringencoding/) | Encodage par défaut. |
| static [MaxBufferSize](../httpcontent/maxbuffersize/) | Nombre maximal d'octets. |
