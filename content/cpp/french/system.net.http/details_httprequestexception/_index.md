...
description: "La classe d'exception de base est levée par les classes HttpClient et HttpMessageHandler. Ne créez jamais d'instances de cette classe manuellement. Utilisez plutôt la classe HttpRequestException. Ne jamais encapsuler les instances de la classe HttpRequestException dans System::SmartPtr."
type: docs
weight: 14
url: /fr/system.net.http/details_httprequestexception/
---
## Details_HttpRequestException classe


La classe d'exception de base est levée par les classes [HttpClient](../httpclient/) et [HttpMessageHandler](../httpmessagehandler/). Ne créez jamais d'instances de cette classe manuellement. Utilisez plutôt la classe HttpRequestException. Ne encapsulez jamais les instances de la classe HttpRequestException dans [System::SmartPtr](../../system/smartptr/).
...
| Méthode | Description |
| --- | --- |
|  [Details_HttpRequestException](./details_httprequestexception/)() | Construit une nouvelle instance. |
|  [Details_HttpRequestException](./details_httprequestexception/)(std::nullptr_t) | Construit une nouvelle instance. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/)) | Construit une nouvelle instance. |
|  [Details_HttpRequestException](./details_httprequestexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Construit une nouvelle instance. |
| virtual void [DoThrow](../../system/details_exception/dothrow/)(const [ExceptionPtr](../../system/exceptionptr/)\&) const | Lance l'instance d'exception enveloppée par le wrapper d'exception. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>, [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\>\> [get_Data](../../system/details_exception/get_data/)() | Renvoie un dictionnaire avec des données d'exception personnalisées. |
...
| void [set_HResult](../../system/details_exception/set_hresult/)(**int32_t**) | Définit le HRESULT, une valeur numérique codée assignée à une exception spécifique. |
