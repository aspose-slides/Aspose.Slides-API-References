...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Ajoute une nouvelle séquence interactive. |
...
| virtual void [Clear](./clear/)() | Supprime toutes les séquences d'une collection. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Renvoie le nombre d'éléments dans une collection en lecture seule **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie une séquence à l'index spécifié. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[ISequence](../isequence/)\>) | Supprime la séquence spécifiée d'une collection. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime la séquence à l'index spécifié. |
