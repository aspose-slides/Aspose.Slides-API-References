...
| [FilterEffectRevealType](../filtereffectrevealtype/) [get_Reveal](./get_reveal/)() override | Représente que l'effet avec le comportement doit dévoiler (entrée/sortie). Lire [FilterEffectRevealType](../filtereffectrevealtype/). |
| [FilterEffectSubtype](../filtereffectsubtype/) [get_Subtype](./get_subtype/)() override | Représente le sous-type de l'effet de filtre. Lire [FilterEffectSubtype](../filtereffectsubtype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | Représente les propriétés de synchronisation pour le comportement de l'effet. Lire [ITiming](../itiming/). |
| [FilterEffectType](../filtereffecttype/) [get_Type](./get_type/)() override | Représente le type d'effet de filtre. Lire [FilterEffectType](../filtereffecttype/). |
...
| void [set_Accumulate](../behavior/set_accumulate/)([NullableBool](../../aspose.slides/nullablebool/)) override | Représente si les comportements d'animation sont accumulés. Écrire [NullableBool](../../aspose.slides/nullablebool/). |
| void [set_Additive](../behavior/set_additive/)([BehaviorAdditiveType](../behavioradditivetype/)) override | Représente si le comportement d'animation actuel est combiné avec d'autres animations en cours. Écrire [BehaviorAdditiveType](../behavioradditivetype/). |
| void [set_Reveal](./set_reveal/)([FilterEffectRevealType](../filtereffectrevealtype/)) override | Représente que l'effet avec le comportement doit dévoiler (entrée/sortie). Écrire [FilterEffectRevealType](../filtereffectrevealtype/). |
| void [set_Subtype](./set_subtype/)([FilterEffectSubtype](../filtereffectsubtype/)) override | Représente le sous-type de l'effet de filtre. Écrire [FilterEffectSubtype](../filtereffectsubtype/). |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Représente les propriétés de synchronisation pour le comportement de l'effet. Écrire [ITiming](../itiming/). |
| void [set_Type](./set_type/)([FilterEffectType](../filtereffecttype/)) override | Représente le type d'effet de filtre. Écrire [FilterEffectType](../filtereffecttype/). |
...
* Classe [IFilterEffect](../ifiltereffect/)
