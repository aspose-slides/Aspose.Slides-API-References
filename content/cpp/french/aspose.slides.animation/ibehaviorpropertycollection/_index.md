...
| Méthode | Description |
| --- | --- |
| virtual void [Add](./add/)(const [System::String](../../system/string/)\&) | Ajoute une nouvelle propriété à la collection. |
...
| virtual **bool** [Contains](./contains/)(const [System::String](../../system/string/)\&) const | Détermine si le [ICollection](../../system.collections.generic/icollection/) contient une valeur spécifique. |
...
| virtual T [idx_get](../../system.collections.generic/ilist/idx_get/)(int) const | Obtient l'élément à l'index spécifié. |
| virtual void [idx_set](../../system.collections.generic/ilist/idx_set/)(int, T) | Définit l'élément à l'index spécifié. |
| virtual **int32_t** [IndexOf](./indexof/)(const [System::String](../../system/string/)\&) const | Détermine l'index d'un élément spécifique par valeur de propriété dans le [IList](../../system.collections.generic/ilist/). |
| virtual int [IndexOf](../../system.collections.generic/ilist/indexof/)(const T\&) const | Obtient l'index de la première apparition de l'élément dans le conteneur. |
| virtual void [Insert](./insert/)(**int32_t**, [System::String](../../system/string/)) | Insère une nouvelle propriété (avec la valeur de propriété spécifiée) dans la collection à l'index spécifié. |
...
| virtual **bool** [Remove](./remove/)(const [System::String](../../system/string/)\&) | Supprime la propriété spécifiée de la collection. |
| virtual **bool** [Remove](../../system.collections.generic/icollection/remove/)(const T\&) | Supprime l'élément de la collection. |
| virtual void [RemoveAt](../../system.collections.generic/ilist/removeat/)(int) | Supprime l'élément à l'index spécifié. |
