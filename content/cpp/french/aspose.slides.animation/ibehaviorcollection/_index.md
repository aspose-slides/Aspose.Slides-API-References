...
| Méthode | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Ajoute un nouveau comportement à une collection. |
...
| virtual void [Clear](./clear/)() | Supprime tous les comportements d'une collection. |
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Détermine si [ICollection](../../system.collections.generic/icollection/) contient une valeur spécifique. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Renvoie le nombre de comportements dans une collection. **int32_t** en lecture seule. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie un comportement à l'index spécifié. |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Renvoie un comportement à l'index spécifié. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Détermine l'index d'un élément spécifique dans le [IList](../../system.collections.generic/ilist/). |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Insère un nouveau comportement dans une collection à l'index spécifié. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IBehavior](../ibehavior/)\>) | Supprime le comportement spécifié d'une collection. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime un comportement d'une collection à l'index spécifié. |
