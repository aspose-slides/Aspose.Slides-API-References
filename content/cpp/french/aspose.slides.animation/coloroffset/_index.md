...
| **float** [get_Value0](./get_value0/)() override | Définit la première valeur du décalage. Lecture **float**. |
| **float** [get_Value1](./get_value1/)() override | Définit la deuxième valeur du décalage. Lecture **float**. |
| **float** [get_Value2](./get_value2/)() override | Définit la troisième valeur du décalage. Lecture **float**. |
...
| void [set_Value0](./set_value0/)(**float**) override | Définit la première valeur du décalage. Écriture **float**. |
| void [set_Value1](./set_value1/)(**float**) override | Définit la deuxième valeur du décalage. Écriture **float**. |
| void [set_Value2](./set_value2/)(**float**) override | Définit la troisième valeur du décalage. Écriture **float**. |
