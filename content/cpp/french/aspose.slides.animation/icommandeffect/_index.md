...
| virtual [System::String](../../system/string/) [get_CommandString](./get_commandstring/)() | Définit la chaîne de commande. Lire [System::String](../../system/string/). |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\> [get_ShapeTarget](./get_shapetarget/)() | Définit la cible de forme de l'effet de commande. Lire [IShape](../../aspose.slides/ishape/). |
...
| virtual [CommandEffectType](../commandeffecttype/) [get_Type](./get_type/)() | Définit le type d'effet de commande du comportement. Lire [CommandEffectType](../commandeffecttype/). |
...
| virtual void [set_CommandString](./set_commandstring/)([System::String](../../system/string/)) | Définit la chaîne de commande. Écriture [System::String](../../system/string/). |
| virtual void [set_ShapeTarget](./set_shapetarget/)([System::SharedPtr](../../system/sharedptr/)\<[IShape](../../aspose.slides/ishape/)\>) | Définit la cible de forme de l'effet de commande. Écriture [IShape](../../aspose.slides/ishape/). |
...
| virtual void [set_Type](./set_type/)([CommandEffectType](../commandeffecttype/)) | Définit le type d'effet de commande du comportement. Écriture [CommandEffectType](../commandeffecttype/). |
