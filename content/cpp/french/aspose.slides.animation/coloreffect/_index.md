...
| [System::SharedPtr](../../system/sharedptr/)\<[IColorOffset](../icoloroffset/)\> [get_By](./get_by/)() override | Décrit la valeur de décalage relative pour l'animation de couleur. Lecture [IColorOffset](../icoloroffset/). |
| [Aspose::Slides::Animation::ColorSpace](../colorspace/) [get_ColorSpace](./get_colorspace/)() override | Représente l'espace couleur du comportement. Lecture [Animation::ColorSpace](../colorspace/). |
| [ColorDirection](../colordirection/) [get_Direction](./get_direction/)() override | Spécifie la direction du cycle de la teinte autour du cercle chromatique. Lecture [ColorDirection](../colordirection/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_From](./get_from/)() override | Cette valeur est utilisée pour spécifier la couleur de départ du comportement. Lecture [IColorFormat](../../aspose.slides/icolorformat/). |
...
| [System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\> [get_Timing](../behavior/get_timing/)() override | Représente les propriétés de synchronisation pour le comportement d'effet. Lecture [ITiming](../itiming/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\> [get_To](./get_to/)() override | Décrit la couleur résultante pour le changement de couleur d'animation. Lecture [IColorFormat](../../aspose.slides/icolorformat/). |
...
| void [set_By](./set_by/)([System::SharedPtr](../../system/sharedptr/)\<[IColorOffset](../icoloroffset/)\>) override | Décrit la valeur de décalage relative pour l'animation de couleur. Écriture [IColorOffset](../icoloroffset/). |
| void [set_ColorSpace](./set_colorspace/)([Aspose::Slides::Animation::ColorSpace](../colorspace/)) override | Représente l'espace couleur du comportement. Écriture [Animation::ColorSpace](../colorspace/). |
| void [set_Direction](./set_direction/)([ColorDirection](../colordirection/)) override | Spécifie la direction du cycle de la teinte autour du cercle chromatique. Écriture [ColorDirection](../colordirection/). |
| void [set_From](./set_from/)([System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\>) override | Cette valeur est utilisée pour spécifier la couleur de départ du comportement. Écriture [IColorFormat](../../aspose.slides/icolorformat/). |
| void [set_Timing](../behavior/set_timing/)([System::SharedPtr](../../system/sharedptr/)\<[ITiming](../itiming/)\>) override | Représente les propriétés de synchronisation pour le comportement d'effet. Écriture [ITiming](../itiming/). |
| void [set_To](./set_to/)([System::SharedPtr](../../system/sharedptr/)\<[IColorFormat](../../aspose.slides/icolorformat/)\>) override | Décrit la couleur résultante pour le changement de couleur d'animation. Écriture [IColorFormat](../../aspose.slides/icolorformat/). |
