...
Représente les types de propriétés pour le comportement d'animation. Suit la liste des propriétés de [https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx) et [https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/documentformat.openxml.presentation.attributename(v=office.15).aspx)
...
| virtual **bool** [get_IsCustom](./get_iscustom/)() | Indique si cette propriété ne fait pas partie de la liste des propriétés prédéfinies dans la spécification : [https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx](https://msdn.microsoft.com/en-us/library/dd949052(v=office.15).aspx) |
| virtual [System::String](../../system/string/) [get_Value](./get_value/)() | Valeur de la propriété |
