...
| **float** [get_By](./get_by/)() override | Décrit la valeur de décalage relatif pour l'animation. Lire **float**. |
| **float** [get_From](./get_from/)() override | Décrit la valeur de départ pour l'animation. Lire **float**. |
...
| **float** [get_To](./get_to/)() override | Décrit la valeur finale pour l'animation. Lire **float**. |
...
| void [set_By](./set_by/)(**float**) override | Décrit la valeur de décalage relatif pour l'animation. Écriture **float**. |
| void [set_From](./set_from/)(**float**) override | Décrit la valeur de départ pour l'animation. Écriture **float**. |
...
| void [set_To](./set_to/)(**float**) override | Décrit la valeur finale pour l'animation. Écriture **float**. |
...
* Classe [IRotationEffect](../irotationeffect/)
