...
| virtual **float** [get_Value0](./get_value0/)() | Définit la première valeur du décalage. Lecture **float**. |
| virtual **float** [get_Value1](./get_value1/)() | Définit la deuxième valeur du décalage. Lecture **float**. |
| virtual **float** [get_Value2](./get_value2/)() | Définit la troisième valeur du décalage. Lecture **float**. |
...
| virtual void [set_Value0](./set_value0/)(**float**) | Définit la première valeur du décalage. Écriture **float**. |
| virtual void [set_Value1](./set_value1/)(**float**) | Définit la deuxième valeur du décalage. Écriture **float**. |
| virtual void [set_Value2](./set_value2/)(**float**) | Définit la troisième valeur du décalage. Écriture **float**. |
