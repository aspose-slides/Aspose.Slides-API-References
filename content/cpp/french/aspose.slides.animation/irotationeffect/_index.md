...
| virtual **float** [get_By](./get_by/)() | Décrit la valeur de décalage relative pour l'animation. Lire **float**. |
| virtual **float** [get_From](./get_from/)() | Décrit la valeur de départ pour l'animation. Lire **float**. |
...
| virtual **float** [get_To](./get_to/)() | Décrit la valeur finale pour l'animation. Lire **float**. |
...
| virtual void [set_By](./set_by/)(**float**) | Décrit la valeur de décalage relative pour l'animation. Écrire **float**. |
| virtual void [set_From](./set_from/)(**float**) | Décrit la valeur de départ pour l'animation. Écrire **float**. |
...
| virtual void [set_To](./set_to/)(**float**) | Décrit la valeur finale pour l'animation. Écrire **float**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument du modèle comme pointeur faible (plutôt que partagé). Permet de changer les pointeurs dans les conteneurs en mode faible. |
