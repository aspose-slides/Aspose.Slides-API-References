...
description: Fournit l'exception levée lorsqu'une erreur se produit lors du traitement d'une expression XPath.
type: docs
weight: 1
url: /fr/system.xml.xpath/details_xpathexception/
---
## Details_XPathException classe

Fournit l'exception levée lorsqu'une erreur se produit lors du traitement d'une expression [XPath](../).
...
| [String](../../system/string/) [get_Message](./get_message/)() const override | Renvoie la description de la condition d'erreur pour cette exception. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il initialise simplement un nouvel objet et permet la construction copiée des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, en réalité, il initialise simplement un nouvel objet et permet la construction copiée des sous-classes. |
...
| [String](../../system/string/) [ToString](../../system/details_exception/tostring/)() const override | Renvoie la représentation chaîne de caractères de l'objet actuel. |
