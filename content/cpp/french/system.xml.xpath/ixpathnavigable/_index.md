...
description: Fournit un accès à la classe XPathNavigator.
type: docs
weight: 14
url: /fr/system.xml.xpath/ixpathnavigable/
---
## IXPathNavigable classe

Fournit un accès à la classe [XPathNavigator](../xpathnavigator/).
...
| Méthode | Description |
| --- | --- |
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\> [CreateNavigator](./createnavigator/)() | Retourne un nouvel objet [XPathNavigator](../xpathnavigator/). |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison en virgule flottante de type C# où deux NaN sont considérés comme égaux bien que, selon la norme IEC 60559:1989, NaN ne soit égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison en virgule flottante de type C# où deux NaN sont considérés comme égaux bien que, selon la norme IEC 60559:1989, NaN ne soit égal à aucune valeur, y compris NaN. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Operateur d'affectation. Ne copie rien, en réalité, il se contente d'initialiser un nouvel objet et permet la construction par copie des sous-classes. |
