...
description: Fournit un itérateur sur un ensemble de nœuds sélectionnés.
type: docs
weight: 79
url: /fr/system.xml.xpath/xpathnodeiterator/
---
## XPathNodeIterator classe

Fournit un itérateur sur un ensemble de nœuds sélectionnés.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XPathNodeIterator](./)\> [Clone](./clone/)() | Lorsqu'elle est redéfinie dans une classe dérivée, renvoie un clone de cet objet [XPathNodeIterator](./). |
...
| virtual **int32_t** [get_Count](./get_count/)() | Renvoie l'index du dernier nœud dans l'ensemble de nœuds sélectionnés. |
| virtual const [SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\& [get_Current](./get_current/)() | Lorsqu'elle est redéfinie dans une classe dérivée, obtient l'objet [XPathNavigator](../xpathnavigator/) pour ce [XPathNodeIterator](./), positionné sur le nœud de contexte actuel. |
| virtual **int32_t** [get_CurrentPosition](./get_currentposition/)() | Lorsqu'elle est redéfinie dans une classe dérivée, obtient l'index de la position actuelle dans l'ensemble de nœuds sélectionnés. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XPathNavigator](../xpathnavigator/)\>\>\> [GetEnumerator](./getenumerator/)() override | Renvoie un objet IEnumerator pour itérer à travers l'ensemble de nœuds sélectionnés. |
...
| virtual **bool** [MoveNext](./movenext/)() | Lorsqu'elle est redéfinie dans une classe dérivée, déplace l'objet [XPathNavigator](../xpathnavigator/) renvoyé par la méthode [XPathNodeIterator::get_Current](./get_current/) vers le nœud suivant dans l'ensemble de nœuds sélectionnés. |
