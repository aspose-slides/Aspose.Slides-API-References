...
type: docs
weight: 79
url: /fr/system.security.cryptography.x509certificates/x509certificatecollection/
---
## X509CertificateCollection classe


Collection d'objets de certificat X509. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne jamais créer d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des fautes d'assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument.
...
| void [AddRange](../../system.collections.generic/list/addrange/)([IEnumerablePtr](../../system.collections.generic/list/ienumerableptr/)) | Ajoute tous les éléments de la collection (ou d'elle-même) à la fin de la liste actuelle. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/list/begin/)() const | Obtient un itérateur vers le premier élément de la collection qualifiée en const. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/list/cbegin/)() const | Obtient un itérateur vers le premier élément qualifié en const de la collection. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crbegin](../../system.collections.generic/list/crbegin/)() const | Obtient un itérateur inverse vers le dernier élément qualifié en const de la collection (premier en sens inverse). |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [crend](../../system.collections.generic/list/crend/)() const | Obtient un itérateur inverse pour un élément const non existant avant le début de la collection. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/list/end/)() const | Obtient un itérateur pour un élément non existant situé après la fin de la collection qualifiée en const. |
...
| T [idx_get](../../system.collections.generic/list/idx_get/)(int) const override | Obtient l'élément à la position spécifiée. |
| void [idx_set](../../system.collections.generic/list/idx_set/)(int, T) override | Définit l'élément à la position spécifiée. |
...
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&) const | Recherche l'objet spécifié et renvoie l'indice zéro-bas de la dernière occurrence dans la liste entière. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**) const | Recherche l'objet spécifié et renvoie l'indice zéro-bas de la dernière occurrence dans la plage d'éléments du [List](../../system.collections.generic/list/) qui s'étend du premier élément jusqu'à l'indice spécifié. |
| **int32_t** [LastIndexOf](../../system.collections.generic/list/lastindexof/)(const T\&, **int32_t**, **int32_t**) const | Recherche l'objet spécifié et renvoie l'indice zéro-bas de la dernière occurrence dans la plage d'éléments du [List](../../system.collections.generic/list/) qui contient le nombre d'éléments spécifié et se termine à l'indice spécifié. |
...
| T [LINQ_ElementAt](../../system.collections.generic/ienumerable/linq_elementat/)(int) | Renvoie l'élément à l'indice spécifié dans une séquence. |
| T [LINQ_ElementAtOrDefault](../../system.collections.generic/ienumerable/linq_elementatordefault/)(int) | Renvoie l'élément à l'indice spécifié dans une séquence. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'assignation. Ne copie rien, en fait, il initialise simplement le nouvel objet et permet la construction par copie des sous-classes. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)([ICollection](../../system.collections.generic/icollection/)\&&) | Opérateur d'assignation par déplacement. |
| [ICollection](../../system.collections.generic/icollection/)\& [operator=](../../system.collections.generic/icollection/operator_equal/)(const [ICollection](../../system.collections.generic/icollection/)\&) | Opérateur d'assignation par déplacement. |
...
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rbegin](../../system.collections.generic/list/rbegin/)() const | Obtient un itérateur inverse vers le dernier élément de la collection qualifiée en const (premier en sens inverse). |
...
| [reverse_iterator](../../system.collections.generic/list/reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() | Obtient un itérateur inverse pour un élément non existant avant le début de la collection. |
| [const_reverse_iterator](../../system.collections.generic/list/const_reverse_iterator/) [rend](../../system.collections.generic/list/rend/)() const | Obtient un itérateur inverse pour un élément non existant avant le début de la collection qualifiée en const. |
| void [Reverse](../../system.collections.generic/list/reverse/)() | Inverse l'ordre des éléments de la liste entière. |
| void [Reverse](../../system.collections.generic/list/reverse/)(int, int) | Inverse l'ordre des éléments de la tranche de la liste. |
...
| void [Sort](../../system.collections.generic/list/sort/)(int, int, [SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IComparer](../../system.collections.generic/icomparer/)\<T\>\>) | Trie les éléments de la tranche de la liste. |
