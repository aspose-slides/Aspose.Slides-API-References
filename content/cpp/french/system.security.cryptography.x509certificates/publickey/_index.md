...
description: "Représente les informations de clé publique d'un certificat X509. Les objets de cette classe doivent être alloués uniquement à l'aide de la fonction System::MakeObject() . Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des défauts d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 1
url: /fr/system.security.cryptography.x509certificates/publickey/
---
## PublicKey classe
...
| [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](../../system.security.cryptography/asnencodeddata/)\> [get_EncodedKeyValue](./get_encodedkeyvalue/)() const | Obtient la valeur de clé publique encodée en ASN.1. |
| [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](../../system.security.cryptography/asnencodeddata/)\> [get_EncodedParameters](./get_encodedparameters/)() const | Obtient les paramètres de clé publique encodés en ASN.1. |
| [SharedPtr](../../system/sharedptr/)\<[AsymmetricAlgorithm](../../system.security.cryptography/asymmetricalgorithm/)\> [get_Key](./get_key/)() const | Obtient un [RSACryptoServiceProvider](../../system.security.cryptography/rsacryptoserviceprovider/) ou [DSACryptoServiceProvider](../../system.security.cryptography/dsacryptoserviceprovider/). |
| [SharedPtr](../../system/sharedptr/)\<[Oid](../../system.security.cryptography/oid/)\> [get_Oid](./get_oid/)() const | Obtient l'identifiant (OID) de la clé publique. |
...
|  [PublicKey](./publickey/)(const [SharedPtr](../../system/sharedptr/)\<[Oid](../../system.security.cryptography/oid/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](../../system.security.cryptography/asnencodeddata/)\>\&, const [SharedPtr](../../system/sharedptr/)\<[AsnEncodedData](../../system.security.cryptography/asnencodeddata/)\>) | Constructeur. |
