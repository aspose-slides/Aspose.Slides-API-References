...
description: "Représente un tableau d'objets EncoderParameter. Les objets de cette classe doivent être alloués uniquement en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des fautes d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le transmettre aux fonctions en tant qu'argument."
type: docs
weight: 79
url: /fr/system.drawing.imaging/encoderparameters/
---
## EncoderParameters classe

Représente un tableau d'objets [EncoderParameter](../encoderparameter/). Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des fautes d'assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument.
...
| Méthode | Description |
| --- | --- |
|  [EncoderParameters](./encoderparameters/)(int) | Construit une nouvelle instance de la classe [EncoderParameters](./). |
...
| [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\> [get_Param](./get_param/)() const | Renvoie un tableau d'objets [EncoderParameter](../encoderparameter/) représentés par l'objet [EncoderParameters](./) actuel. |
...
| void [set_Param](./set_param/)(const [System::ArrayPtr](../../system/arrayptr/)\<[EncoderParameterPtr](../encoderparameterptr/)\>\&) | Assigne un tableau d'objets [EncoderParameter](../encoderparameter/) à l'objet [EncoderParameters](./) actuel. |
