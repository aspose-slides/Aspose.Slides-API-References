...
| Method | Description |
| --- | --- |
|  [Encoder](./encoder/)(const [Guid](../../system/guid/)\&) | Construit une nouvelle instance de la classe [Encoder](./). |
...
| [Guid](../../system/guid/) [get_Guid](./get_guid/)() const | Renvoie un GUID qui spécifie l'ensemble des paramètres d'encodeur d'image que représente l'objet actuel. |
...
| Field | Description |
| --- | --- |
| static [ChrominanceTable](./chrominancetable/) | Une instance de la classe [Encoder](./) qui représente la catégorie de paramètre de table de chrominance. |
...
| static [SaveFlag](./saveflag/) | Une instance de la classe [Encoder](./) qui représente la catégorie de paramètre de drapeau de sauvegarde. |
