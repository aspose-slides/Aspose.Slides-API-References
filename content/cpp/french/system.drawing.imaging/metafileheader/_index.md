...
description: "Contient les attributs associés à un métafichier graphique. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou avec l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échoués d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant que l'argument."
type: docs
weight: 157
url: /fr/system.drawing.imaging/metafileheader/
---
## MetafileHeader classe

Contient les attributs associés à un métafichier graphique. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d’instance de ce type sur la pile ou en utilisant l’opérateur new, car cela entraînera des erreurs d’exécution et/ou des violations d’assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu’argument.
...
| [Rectangle](../../system.drawing/rectangle/) [get_Bounds](./get_bounds/)() const | Renvoie un rectangle englobant d’un métafichier associé à l’objet actuel. |
| **float** [get_DpiX](./get_dpix/)() const | NON IMPLEMENTÉ. |
| **float** [get_DpiY](./get_dpiy/)() const | NON IMPLEMENTÉ. |
...
| void [set_Bounds](./set_bounds/)(const [Rectangle](../../system.drawing/rectangle/)\&) | Définit un rectangle englobant d’un métafichier associé à l’objet actuel. |
