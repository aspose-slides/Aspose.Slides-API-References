...
description: "Représente une propriété de métadonnées à inclure dans un fichier image. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 170
url: /fr/system.drawing.imaging/propertyitem/
---
## PropertyItem classe
...
| **int32_t** [get_Id](./get_id/)() const | Renvoie l'ID de la propriété représentée par l'objet actuel. |
| **int32_t** [get_Len](./get_len/)() const | Renvoie la longueur de la propriété représentée par l'objet actuel en octets. |
| **int16_t** [get_Type](./get_type/)() const | Renvoie le type de la propriété représentée par l'objet actuel en octets. |
| [ArrayPtr](../../system/arrayptr/)\<**uint8_t**\> [get_Value](./get_value/)() const | Renvoie la valeur de la propriété représentée par l'objet actuel en octets. |
...
| void [set_Id](./set_id/)(**int32_t**) | Définit l'ID de la propriété représentée par l'objet actuel. |
| void [set_Len](./set_len/)(**int32_t**) | Définit la longueur de la propriété représentée par l'objet actuel en octets. |
| void [set_Type](./set_type/)(**int16_t**) | Définit le type de la propriété représentée par l'objet actuel en octets. |
| void [set_Value](./set_value/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Définit le type de la propriété représentée par l'objet actuel en octets. |
