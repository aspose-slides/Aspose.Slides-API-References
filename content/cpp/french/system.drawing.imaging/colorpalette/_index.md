...
| [System::ArrayPtr](../../system/arrayptr/)\<[Color](../../system.drawing/color/)\> [get_Entries](./get_entries/)() const | Renvoie un tableau d'objets [Color](../../system.drawing/color/) représentés par l'objet actuel. |
| int [get_Flags](./get_flags/)() const | Renvoie une valeur qui spécifie comment les valeurs de couleur dans le tableau de couleurs doivent être interprétées. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, mais initialise un nouvel objet et permet la copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie rien, mais initialise un nouvel objet et permet la copie des sous-classes. |
