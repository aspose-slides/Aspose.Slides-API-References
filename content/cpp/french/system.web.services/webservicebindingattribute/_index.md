...
| [System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\> [get_ConformsTo](./get_conformsto/)() | Obtient la spécification WSI. |
| **bool** [get_EmitConformanceClaims](./get_emitconformanceclaims/)() | Obtient une valeur indiquant si la liaison émet des revendications de conformité. |
| [String](../../system/string/) [get_Location](./get_location/)() | Obtient l'emplacement où la liaison est définie. |
| [String](../../system/string/) [get_Name](./get_name/)() | Obtient le nom de la liaison. |
| [String](../../system/string/) [get_Namespace](./get_namespace/)() | Obtient l'espace de noms associé à la liaison. |
...
| void [set_ConformsTo](./set_conformsto/)([System::SharedPtr](../../system/sharedptr/)\<WsiProfiles\>) | Définit la spécification WSI. |
| void [set_EmitConformanceClaims](./set_emitconformanceclaims/)(**bool**) | Définit une valeur indiquant si la liaison émet des revendications de conformité. |
| void [set_Location](./set_location/)([String](../../system/string/)) | Définit l'emplacement où la liaison est définie. |
| void [set_Name](./set_name/)([String](../../system/string/)) | Définit le nom de la liaison. |
| void [set_Namespace](./set_namespace/)([String](../../system/string/)) | Définit l'espace de noms associé à la liaison. |
...
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/)) | Construit une nouvelle instance. |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/)) | Construit une nouvelle instance. |
|  [WebServiceBindingAttribute](./webservicebindingattribute/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | Construit une nouvelle instance. |
