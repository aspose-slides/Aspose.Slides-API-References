...
description: Contient un nombre variable d'arguments qui sont soit des paramètres XSLT, soit des objets d'extension.
type: docs
weight: 66
url: /fr/system.xml.xsl/xsltargumentlist/
---
...
| Méthode | Description |
| --- | --- |
| void [AddExtensionObject](./addextensionobject/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Ajoute un nouvel objet au [XsltArgumentList](./) et l’associe à l’URI de l’espace de noms. |
| void [AddParam](./addparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Ajoute un paramètre au [XsltArgumentList](./) et l’associe au nom qualifié de l’espace de noms. |
| void [Clear](./clear/)() | Supprime tous les paramètres et objets d'extension du [XsltArgumentList](./). |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetExtensionObject](./getextensionobject/)(const [String](../../system/string/)\&) | Renvoie l’objet associé à l’espace de noms donné. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetParam](./getparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Renvoie le paramètre associé au nom qualifié de l’espace de noms. |
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [RemoveExtensionObject](./removeextensionobject/)(const [String](../../system/string/)\&) | Supprime l’objet avec l’URI de l’espace de noms du [XsltArgumentList](./). |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [RemoveParam](./removeparam/)(const [String](../../system/string/)\&, const [String](../../system/string/)\&) | Supprime le paramètre du [XsltArgumentList](./). |
...
|  [XsltArgumentList](./xsltargumentlist/)() | Met en œuvre une nouvelle instance du [XsltArgumentList](./). |
