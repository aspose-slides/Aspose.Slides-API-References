...
description: "Fournit des données pour l'événement XsltArgumentList::XsltMessageEncountered."
type: docs
weight: 92
url: /fr/system.xml.xsl/xsltmessageencounteredeventargs/
---
## XsltMessageEncounteredEventArgs classe

Fournit des données pour l'événement **XsltArgumentList::XsltMessageEncountered**.
...
| virtual [String](../../system/string/) [get_Message](./get_message/)() | Renvoie le contenu de l'élément **xsl:message**. |
