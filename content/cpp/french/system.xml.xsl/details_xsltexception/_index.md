...
description: L'exception qui est levée lorsqu'une erreur se produit lors du traitement d'une transformation XSLT.
type: docs
weight: 14
url: /fr/system.xml.xsl/details_xsltexception/
---
## Details_XsltException classe

L'exception qui est levée lorsqu'une erreur se produit lors du traitement d'une transformation XSLT.
...
| virtual **int32_t** [get_LineNumber](./get_linenumber/)() | Renvoie le numéro de ligne indiquant où l'erreur s'est produite dans la feuille de style. |
| virtual **int32_t** [get_LinePosition](./get_lineposition/)() | Renvoie la position de la ligne indiquant où l'erreur s'est produite dans la feuille de style. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Renvoie le message d'erreur formaté décrivant l'exception actuelle. |
| virtual [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Renvoie le chemin d'emplacement de la feuille de style. |
