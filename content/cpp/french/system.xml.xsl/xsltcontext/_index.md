...
description: Encapsule le contexte d'exécution actuel du processeur Extensible Stylesheet Language for Transformations (XSLT) permettant au langage de chemin XML (XPath) de résoudre les fonctions, les paramètres et les espaces de noms dans les expressions XPath.
type: docs
weight: 79
url: /fr/system.xml.xsl/xsltcontext/
---
## classe XsltContext

Encapsule le contexte d'exécution actuel du processeur Extensible Stylesheet Language for Transformations (XSLT) permettant au langage de requête XML ([XPath](../../system.xml.xpath/)) de résoudre les fonctions, les paramètres et les espaces de noms dans les expressions [XPath](../../system.xml.xpath/).
...
| Méthode | Description |
| --- | --- |
| virtual void [AddNamespace](../../system.xml/xmlnamespacemanager/addnamespace/)([String](../../system/string/), [String](../../system/string/)) | Ajoute l'espace de noms donné à la collection. |
...
| virtual **int32_t** [CompareDocument](./comparedocument/)([String](../../system/string/), [String](../../system/string/)) | Lorsqu'elle est remplacée dans une classe dérivée, compare les identifiants de ressource uniformes (URI) de base de deux documents en fonction de l'ordre dans lequel les documents ont été chargés par le processeur XSLT (c'est-à-dire la classe [XslTransform](../xsltransform/)). |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison flottante de type C# où deux NaN sont considérés égaux bien que, selon IEC 60559:1989, NaN ne soit égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison flottante de type C# où deux NaN sont considérés égaux bien que, selon IEC 60559:1989, NaN ne soit égal à aucune valeur, y compris NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | À des fins internes uniquement. |
| virtual [String](../../system/string/) [get_DefaultNamespace](../../system.xml/xmlnamespacemanager/get_defaultnamespace/)() | Renvoie l'URI de l'espace de noms pour l'espace de noms par défaut. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\> [get_NameTable](../../system.xml/xmlnamespacemanager/get_nametable/)() | Renvoie le [XmlNameTable](../../system.xml/xmlnametable/) associé à cet objet. |
| virtual **bool** [get_Whitespace](./get_whitespace/)() | Lorsqu'elle est remplacée dans une classe dérivée, obtient une valeur indiquant s'il faut inclure les nœuds d'espacement blanc dans la sortie. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[String](../../system/string/)\>\> [GetEnumerator](../../system.xml/xmlnamespacemanager/getenumerator/)() override | Renvoie un énumérateur à utiliser pour parcourir les espaces de noms dans le [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/). |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogue de la méthode C# [Object.GetHashCode()](../../system/object/gethashcode/). Permet le hachage d'objets personnalisés. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IDictionary](../../system.collections.generic/idictionary/)\<[String](../../system/string/), [String](../../system/string/)\>\> [GetNamespacesInScope](../../system.xml/xmlnamespacemanager/getnamespacesinscope/)([XmlNamespaceScope](../../system.xml/xmlnamespacescope/)) override | Renvoie une collection de noms d'espaces de noms indexés par préfixe pouvant être utilisée pour énumérer les espaces de noms actuellement en portée. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtient le type réel de l'objet. Analogue de l'appel C# [System.Object.GetType()](../../system/object/gettype/). |
| virtual **bool** [HasNamespace](../../system.xml/xmlnamespacemanager/hasnamespace/)([String](../../system/string/)) | Renvoie une valeur indiquant si le préfixe fourni a un espace de noms défini pour la portée actuelle poussée. |
...
| [String](../../system/string/) [LookupNamespace](../../system.xml/xmlnamespacemanager/lookupnamespace/)(const [String](../../system/string/)\&) override | Renvoie l'URI de l'espace de noms pour le préfixe spécifié. |
| [String](../../system/string/) [LookupPrefix](../../system.xml/xmlnamespacemanager/lookupprefix/)(const [String](../../system/string/)\&) override | Trouve le préfixe déclaré pour l'URI d'espace de noms donné. |
...
| virtual **bool** [PopScope](../../system.xml/xmlnamespacemanager/popscope/)() | Dépile une portée d'espace de noms de la pile. |
| virtual **bool** [PreserveWhitespace](./preservewhitespace/)([SharedPtr](../../system/sharedptr/)\<[System::Xml::XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\>) | Lorsqu'elle est remplacée dans une classe dérivée, évalue s'il faut conserver les nœuds d'espacement blanc ou les supprimer pour le contexte donné. |
| virtual void [PushScope](../../system.xml/xmlnamespacemanager/pushscope/)() | Empile une portée d'espace de noms sur la pile. |
...
| virtual void [RemoveNamespace](../../system.xml/xmlnamespacemanager/removenamespace/)([String](../../system/string/), [String](../../system/string/)) | Supprime l'espace de noms donné pour le préfixe donné. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IXsltContextVariable](../ixsltcontextvariable/)\> [ResolveVariable](./resolvevariable/)([String](../../system/string/), [String](../../system/string/)) | Lorsqu'elle est remplacée dans une classe dérivée, résout une référence de variable et renvoie un [IXsltContextVariable](../ixsltcontextvariable/) représentant la variable. |
...
|  [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/xmlnamespacemanager/)(const [SharedPtr](../../system/sharedptr/)\<[XmlNameTable](../../system.xml/xmlnametable/)\>\&) | Initialise une nouvelle instance de la classe [XmlNamespaceManager](../../system.xml/xmlnamespacemanager/) avec le [XmlNameTable](../../system.xml/xmlnametable/) spécifié. |
