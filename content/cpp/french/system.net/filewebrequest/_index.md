...
type: docs
weight: 144
url: /fr/system.net/filewebrequest/
---
...
| Méthode | Description |
| --- | --- |
| void [Abort](./abort/)() override | Annule la requête en cours. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAsyncResult](../../system/iasyncresult/)\> [BeginGetRequestStream](./begingetrequeststream/)([AsyncCallback](../../system/asynccallback/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Démarre une opération asynchrone pour obtenir un flux d'écriture des données vers la ressource. |
| [System::SharedPtr](../../system/sharedptr/)\<[IAsyncResult](../../system/iasyncresult/)\> [BeginGetResponse](./begingetresponse/)([AsyncCallback](../../system/asynccallback/), [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>) override | Démarre une requête asynchrone pour la ressource. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[HttpWebRequest](../httpwebrequest/)\> [CreateHttp](../webrequest/createhttp/)([String](../../system/string/)) | Crée une nouvelle instance de la classe [WebRequest](../webrequest/) en utilisant l'URI spécifié. |
| static [System::SharedPtr](../../system/sharedptr/)\<[HttpWebRequest](../httpwebrequest/)\> [CreateHttp](../webrequest/createhttp/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Crée une nouvelle instance de la classe [WebRequest](../webrequest/) en utilisant l'URI spécifié. |
...
|  [FileWebRequest](./filewebrequest/)([System::SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Construit une nouvelle instance. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::Net::Cache::RequestCachePolicy](../../system.net.cache/requestcachepolicy/)\> [get_CachePolicy](../webrequest/get_cachepolicy/)() | Obtient la stratégie de cache. |
...
| [String](../../system/string/) [get_ContentType](./get_contenttype/)() override | Obtient le type MIME de la requête. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[ICredentials](../icredentials/)\> [get_Credentials](../webrequest/get_credentials/)() | Obtient les informations d'authentification associées à la requête actuelle. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[WebHeaderCollection](../webheadercollection/)\> [get_Headers](./get_headers/)() override | Obtient la collection des en-têtes HTTP. |
| [String](../../system/string/) [get_Method](./get_method/)() override | Obtient la méthode HTTP. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\> [GetRequestStream](../webrequest/getrequeststream/)() | Renvoie le flux d'écriture des données vers la ressource. |
...
| virtual void [set_CachePolicy](../webrequest/set_cachepolicy/)([System::SharedPtr](../../system/sharedptr/)\<[System::Net::Cache::RequestCachePolicy](../../system.net.cache/requestcachepolicy/)\>) | Définit la stratégie de cache. |
...
| virtual void [set_Credentials](../webrequest/set_credentials/)([System::SharedPtr](../../system/sharedptr/)\<[ICredentials](../icredentials/)\>) | Définit les informations d'authentification associées à la requête actuelle. |
...
| void [set_Timeout](./set_timeout/)(int) override | Définit une durée en millisecondes après laquelle la requête expirera. |
