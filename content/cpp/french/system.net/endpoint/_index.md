...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[EndPoint](./)\> [Create](./create/)([System::SharedPtr](../../system/sharedptr/)\<[SocketAddress](../socketaddress/)\>) | Crée une nouvelle instance de la classe [EndPoint](./) en utilisant l'adresse socket spécifiée. |
...
| virtual [System::Net::Sockets::AddressFamily](../../system.net.sockets/addressfamily/) [get_AddressFamily](./get_addressfamily/)() | Renvoie la famille d'adresses à laquelle l'instance actuelle appartient. |
...
| virtual [ImplPtr](./implptr/) [GetImpl](./getimpl/)() const | Renvoie un pointeur vers l'implémentation. |
