...
description: "WebClient fournit des méthodes communes pour l'envoi et la réception de données. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou avec l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des défauts d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le transmettre aux fonctions en argument."
type: docs
weight: 469
url: /fr/system.net/webclient/
---
## WebClient classe


[WebClient](./) fournit des méthodes communes pour envoyer et recevoir des données. Les objets de cette classe ne doivent être alloués qu'à l'aide de la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des défauts d'assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions comme argument.
...
| Méthode | Description |
| --- | --- |
|  [Component](../../system.componentmodel/component/component/)() | Informations RTTI. |
| void [Dispose](../../system.componentmodel/component/dispose/)(**bool**) | Prise en charge du modèle disposable ; ne fait rien. |
| [ByteArrayPtr](../../system/bytearrayptr/) [DownloadData](./downloaddata/)(const [String](../../system/string/)\&) const | Télécharge la ressource spécifiée sous forme de tableau d'octets. |
| [ByteArrayPtr](../../system/bytearrayptr/) [DownloadData](./downloaddata/)(const [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>\&) const | Télécharge la ressource spécifiée sous forme de tableau d'octets. |
| [String](../../system/string/) [DownloadString](./downloadstring/)(const [String](../../system/string/)\&) const | Télécharge la ressource spécifiée sous forme de chaîne. |
| [String](../../system/string/) [DownloadString](./downloadstring/)(const [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>\&) const | Télécharge la ressource spécifiée sous forme de chaîne. |
...
| **bool** [get_DesignMode](../../system.componentmodel/component/get_designmode/)() | Vérifie si le composant est en mode conception. |
| [SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\> [get_Encoding](./get_encoding/)() const | Obtient l'encodage utilisé pour télécharger ou téléverser des chaînes. |
...
| void [set_Encoding](./set_encoding/)(const [SharedPtr](../../system/sharedptr/)\<[Text::Encoding](../../system.text/encoding/)\>\&) | Définit l'encodage utilisé pour télécharger ou téléverser des chaînes. |
| void [set_UseDefaultCredentials](./set_usedefaultcredentials/)(**bool**) | NON IMPLÉMENTÉ. |
...
|  [WebClient](./webclient/)() | Construit une nouvelle instance. |
