...
description: "Représente une exception levée lorsque la taille de CookieContainer est supérieure à la valeur de la propriété MaxCookieSize. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe CookieException à la place. Ne placez jamais les instances de la classe CookieException dans System::SmartPtr."
type: docs
weight: 79
url: /fr/system.net/details_cookieexception/
---
## Details_CookieException classe

Représente une exception levée lorsque la taille de [CookieContainer](../cookiecontainer/) dépasse la valeur de la propriété MaxCookieSize. Ne créez jamais d'instances de cette classe manuellement. Utilisez plutôt la classe CookieException. Ne encapsulez jamais les instances de la classe CookieException dans [System::SmartPtr](../../system/smartptr/).
...
| Méthode | Description |
| --- | --- |
|  [Details_CookieException](./details_cookieexception/)() | Construit une nouvelle instance. |
|  [Details_CookieException](./details_cookieexception/)(std::nullptr_t) | Construit une nouvelle instance. |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/)) | Construit une nouvelle instance. |
|  [Details_CookieException](./details_cookieexception/)([String](../../system/string/), [Exception](../../system/exception/)) | Construit une nouvelle instance. |
...
| const [System::TypeInfo](../../system/typeinfo/)\& [GetType](../../system/details_formatexception/gettype/)() const override | Obtient le type réel de l'objet. Analogue de l'appel C# [System.Object.GetType()](../../system/object/gettype/). |
...
| virtual  [~Details_CookieException](./~details_cookieexception/)() | Détruit l'instance actuelle. |
