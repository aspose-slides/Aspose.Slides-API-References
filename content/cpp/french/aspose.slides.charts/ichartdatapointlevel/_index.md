...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Représente les propriétés de formatage du niveau du point de données. Lire [IFormat](../iformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [get_Label](./get_label/)() | Représente l'étiquette de données du niveau du point de données. Appliqué aux types de séries Treemap et Sunburst. Lecture seule [IDataLabel](../idatalabel/). |
