...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Renvoie le remplissage du mur, la ligne, l'effet, les styles 3D. Lecture seule [IFormat](../iformat/). |
| virtual [Aspose::Slides::Charts::PictureType](../picturetype/) [get_PictureType](./get_picturetype/)() | Renvoie ou définit le type d'image. Lecture [PictureType](../picturetype/). |
| virtual **int32_t** [get_Thickness](./get_thickness/)() | Renvoie l'épaisseur des murs en pourcentage de la plus grande dimension du volume du tracé. Lecture **int32_t**. |
...
| virtual void [set_PictureType](./set_picturetype/)([Aspose::Slides::Charts::PictureType](../picturetype/)) | Renvoie ou définit le type d'image. Écriture [PictureType](../picturetype/). |
| virtual void [set_Thickness](./set_thickness/)(**int32_t**) | Définit l'épaisseur des murs en pourcentage de la plus grande dimension du volume du tracé. Écriture **int32_t**. |
