...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Renvoie les styles de ligne, de remplissage et d'effet d'un objet. Lecture seule [IFormat](../iformat/). |
| virtual **bool** [get_HasBorderHorizontal](./get_hasborderhorizontal/)() | Vrai si le tableau de données du graphique possède des bordures de cellules horizontales. Lecture **bool**. |
| virtual **bool** [get_HasBorderOutline](./get_hasborderoutline/)() | Vrai si le tableau de données du graphique possède des bordures extérieures. Lecture **bool**. |
| virtual **bool** [get_HasBorderVertical](./get_hasbordervertical/)() | Vrai si le tableau de données du graphique possède des bordures de cellules verticales. Lecture **bool**. |
...
| virtual **bool** [get_ShowLegendKey](./get_showlegendkey/)() | Vrai si la clé de légende de l'étiquette de données est visible. Lecture **bool**. |
...
| virtual void [set_HasBorderHorizontal](./set_hasborderhorizontal/)(**bool**) | Vrai si le tableau de données du graphique possède des bordures de cellules horizontales. Écriture **bool**. |
| virtual void [set_HasBorderOutline](./set_hasborderoutline/)(**bool**) | Vrai si le tableau de données du graphique possède des bordures extérieures. Écriture **bool**. |
| virtual void [set_HasBorderVertical](./set_hasbordervertical/)(**bool**) | Vrai si le tableau de données du graphique possède des bordures de cellules verticales. Écriture **bool**. |
| virtual void [set_ShowLegendKey](./set_showlegendkey/)(**bool**) | Vrai si la clé de légende de l'étiquette de données est visible. Écriture **bool**. |
