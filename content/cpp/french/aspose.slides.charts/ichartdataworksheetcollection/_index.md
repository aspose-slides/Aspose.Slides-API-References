...
---
## IChartDataWorksheetCollection classe
...
| virtual **int32_t** [get_Count](../../aspose.slides/igenericcollection/get_count/)() | Renvoie le nombre d’behaviors dans une collection. Lecture seule **int32_t**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie la feuille de calcul par indice. |
