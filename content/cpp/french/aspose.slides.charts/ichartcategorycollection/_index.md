...
description: Représente une collection d'IChartCategory
type: docs
weight: 599
...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Si la catégorie existe dans la collection, la retourne. Sinon crée une nouvelle catégorie de diagramme à partir de [IChartDataCell](../ichartdatacell/) et l'ajoute à la collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Crée un nouveau [IChartCategory](../ichartcategory/) à partir de la valeur et l'ajoute à la collection. |
...
| virtual **int32_t** [get_GroupingLevelCount](./get_groupinglevelcount/)() | Renvoie le nombre de niveaux de regroupement de catégories utilisés. Est supérieur à un pour les catégories multiniveaux. Lecture seule **int32_t**. |
...
| virtual **bool** [get_UseCells](./get_usecells/)() | Si vrai alors la feuille de calcul est utilisée pour stocker les catégories (ce cas supporte des catégories multiniveaux). Si faux alors la feuille de calcul n'est PAS utilisée pour stocker les valeurs (et ce cas ne supporte pas de catégories multiniveaux). Lecture **bool**. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\> [idx_get](./idx_get/)(**int32_t**) | Obtient l'élément à l'index spécifié. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Recherche le [IChartCategory](../ichartcategory/) spécifié et renvoie l'index de base zéro de la première occurrence dans l'ensemble de la Collection. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<T\>\> [LINQ_Reverse](../../system.collections.generic/ienumerable/linq_reverse/)() | Inverser l'ordre des éléments dans une séquence. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'assignation. Ne copie rien, en réalité, il initialise simplement le nouvel objet et permet la construction par copie des sous-classes. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCategory](../ichartcategory/)\>) | Supprime la valeur spécifiée. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime l'élément à l'index donné. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées de la valeur spécifiée. |
| virtual void [set_UseCells](./set_usecells/)(**bool**) | Si vrai alors la feuille de calcul est utilisée pour stocker les catégories (ce cas supporte des catégories multiniveaux). Si faux alors la feuille de calcul n'est PAS utilisée pour stocker les valeurs (et ce cas ne supporte pas de catégories multiniveaux). Écriture **bool**. |
