...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() | Obtient le remplissage du marqueur. Lecture seule [IFormat](../iformat/). |
| virtual **int32_t** [get_Size](./get_size/)() | Représente la taille du marqueur dans un graphique linéaire, un nuage de points ou un graphique radar. Lecture **int32_t**. |
| virtual [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() | Représente le style du marqueur dans un graphique linéaire, un nuage de points ou un graphique radar. Lecture [MarkerStyleType](../markerstyletype/). |
...
| virtual void [set_Size](./set_size/)(**int32_t**) | Représente la taille du marqueur dans un graphique linéaire, un nuage de points ou un graphique radar. Écriture **int32_t**. |
| virtual void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) | Représente le style du marqueur dans un graphique linéaire, un nuage de points ou un graphique radar. Écriture [MarkerStyleType](../markerstyletype/). |
