...
| virtual **int32_t** [get_Count](./get_count/)() | Renvoie le nombre de niveaux de points de données. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataPointLevel](../ichartdatapointlevel/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie l'objet [IChartDataPointLevel](../ichartdatapointlevel/) pour le niveau défini. |
