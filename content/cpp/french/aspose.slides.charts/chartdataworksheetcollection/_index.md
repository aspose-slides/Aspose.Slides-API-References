...
description: Représente la collection de feuilles de calcul du classeur de données du diagramme.
type: docs
weight: 222
...
Représente la collection de feuilles de calcul du classeur de données du diagramme.
...
| Méthode | Description |
| --- | --- |
| [iterator](./iterator/) [begin](./begin/)() | Obtenir l'itérateur pointant vers le premier élément (le cas échéant) de la collection. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtenir l'itérateur pointant vers le premier élément (le cas échéant) de l'instance qualifiée const de la collection. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtenir l'itérateur pointant vers le premier élément qualifié const (le cas échéant) de la collection. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtenir l'itérateur pointant juste après le dernier élément qualifié const (le cas échéant) de la collection. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\>\>, **int32_t**) override | Copier dans le tableau spécifié. |
| [iterator](./iterator/) [end](./end/)() | Obtenir l'itérateur pointant juste après le dernier élément (le cas échéant) de la collection. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtenir l'itérateur pointant juste après le dernier élément (le cas échéant) de l'instance qualifiée const de la collection. |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Comparer les objets en utilisant la sémantique C# [Object.Equals](../../system/object/equals/). |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Comparer les objets de type référence dans le style C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Comparer les objets de type valeur dans le style C#. |
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émuler la comparaison de nombres flottants à la C# où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émuler la comparaison de nombres à virgule flottante à la C# où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | À usage interne uniquement. |
| **int32_t** [get_Count](./get_count/)() override | Renvoie le nombre. Lecture seule **int32_t**. |
| **bool** [get_IsSynchronized](./get_issynchronized/)() override | Renvoie une valeur indiquant si l'accès à la collection est synchronisé (thread-safe). Lecture seule **bool**. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() override | Renvoie la racine de synchronisation. Lecture seule [System::Object](../../system/object/). |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtenir la structure de données du compteur de références associée à l'objet. |
| [System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\>\>\> [GetEnumerator](./getenumerator/)() override | Renvoie un énumérateur qui parcourt la collection. |
...
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtenir le type réel de l'objet. Analogique de l'appel C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IChartDataWorksheet](../ichartdataworksheet/)\> [idx_get](./idx_get/)(**int32_t**) override | Renvoie la feuille de calcul par index. |
| virtual **bool** [Is](../../system/object/is/)(const [TypeInfo](../../system/typeinfo/)\&) const | Vérifier si l'objet représente une instance du type décrit par targetType. Analogique de l'opérateur C# 'is'. |
| T [LINQ_Aggregate](../../system.collections.generic/ienumerable/linq_aggregate/)(const [Func](../../system/func/)\<T, T, T\>\&) | Appliquer une fonction accumulateur sur une séquence. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Renvoie le nombre d'éléments de la séquence (calculé par comptage direct). |
...
| int [SharedCount](../../system/object/sharedcount/)() const | Obtenir la valeur actuelle du compteur de références partagées. |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtenir l'itérateur pointant vers le premier élément (le cas échéant) de l'instance qualifiée const de la collection. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Obtenir l'itérateur pointant vers le premier élément (le cas échéant) de la collection. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtenir l'itérateur pointant juste après le dernier élément (le cas échéant) de l'instance qualifiée const de la collection. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtenir l'itérateur pointant juste après le dernier élément (le cas échéant) de la collection. |
