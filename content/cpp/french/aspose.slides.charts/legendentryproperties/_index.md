...
| **bool** [get_Hide](./get_hide/)() override | Détermine si l'entrée de légende est masquée. Lecture **bool**. |
...
| void [set_Hide](./set_hide/)(**bool**) override | Détermine si l'entrée de légende est masquée. Écriture **bool**. |
