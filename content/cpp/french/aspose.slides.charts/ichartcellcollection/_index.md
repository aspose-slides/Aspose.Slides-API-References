...
| Méthode | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>) | Ajoute une nouvelle cellule à la collection. |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[System::Object](../../system/object/)\>) | Crée [IChartDataCell](../ichartdatacell/) à partir de la valeur spécifiée et l'ajoute à la collection. |
...
| virtual **int32_t** [get_Count](./get_count/)() | Obtient le nombre de cellules dans la collection. Lecture seule **int32_t**. |
| virtual [System::String](../../system/string/) [GetCellsAddress](./getcellsaddress/)() | Renvoie l'adresse de l'ensemble de cellules dans le classeur. |
| virtual [System::String](../../system/string/) [GetConcatenatedValuesFromCells](./getconcatenatedvaluesfromcells/)() | Chaîne de concaténation à partir de toutes les valeurs de chaînes des cellules. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\> [idx_get](./idx_get/)(**int32_t**) | Renvoie une cellule ([IChartDataCell](../ichartdatacell/)) par indice. |
...
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime une cellule de la collection par indice. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées de la valeur spécifiée. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le nᵉ argument template comme pointeur faible (plutôt que partagé). Permet de passer les pointeurs dans les conteneurs en mode faible. |
