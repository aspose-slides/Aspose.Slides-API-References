...
description: Fournit un accès aux barres haut/bas des graphiques en ligne ou boursier.
type: docs
weight: 1249
...
Fournit un accès aux barres haut/bas des graphiques en ligne ou boursier.
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_DownBarsFormat](./get_downbarsformat/)() | Renvoie le format des barres descendantes. Lecture seule [IFormat](../iformat/). |
| virtual **int32_t** [get_GapWidth](./get_gapwidth/)() | Renvoie la largeur de l'écart. Lire **int32_t**. |
| virtual **bool** [get_HasUpDownBars](./get_hasupdownbars/)() | Détermine si le graphique possède des barres haut/bas. Lire **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_UpBarsFormat](./get_upbarsformat/)() | Renvoie le format des barres ascendantes. Lecture seule [IFormat](../iformat/). |
...
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de référence partagé du nombre indiqué. |
| virtual void [set_GapWidth](./set_gapwidth/)(**int32_t**) | Définit la largeur de l'écart. Écrire **int32_t**. |
| virtual void [set_HasUpDownBars](./set_hasupdownbars/)(**bool**) | Détermine si le graphique possède des barres haut/bas. Écrire **bool**. |
