...
| virtual **bool** [get_Hide](./get_hide/)() | Renvoie le drapeau de masquage de l'entrée de légende. Lecture **bool**. |
...
| virtual void [set_Hide](./set_hide/)(**bool**) | Définit le drapeau de masquage de l'entrée de légende. Écriture **bool**. |
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument modèle en tant que pointeur faible (plutôt que partagé). Permet de changer les pointeurs dans les conteneurs vers le mode faible. |
