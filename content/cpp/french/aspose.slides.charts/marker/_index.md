...
| [System::SharedPtr](../../system/sharedptr/)\<[IFormat](../iformat/)\> [get_Format](./get_format/)() override | Obtient le remplissage du marqueur. Lecture seule [IFormat](../iformat/). |
| **int32_t** [get_Size](./get_size/)() override | Représente la taille du marqueur dans un graphique linéaire, un nuage de points ou un graphique radar. Lecture **int32_t**. |
| [MarkerStyleType](../markerstyletype/) [get_Symbol](./get_symbol/)() override | Représente le style du marqueur dans un graphique linéaire, un nuage de points ou un graphique radar. Lecture [MarkerStyleType](../markerstyletype/). |
...
| void [set_Size](./set_size/)(**int32_t**) override | Représente la taille du marqueur dans un graphique linéaire, un nuage de points ou un graphique radar. Écriture **int32_t**. |
| void [set_Symbol](./set_symbol/)([MarkerStyleType](../markerstyletype/)) override | Représente le style du marqueur dans un graphique linéaire, un nuage de points ou un graphique radar. Écriture [MarkerStyleType](../markerstyletype/). |
