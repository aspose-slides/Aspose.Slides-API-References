...
| virtual **int32_t** [get_Count](./get_count/)() | Obtient le nombre de toutes les étiquettes de données dans la collection. Lecture seule **int32_t**. |
| virtual **int32_t** [get_CountOfVisibleDataLabels](./get_countofvisibledatalabels/)() | Obtient le nombre d'étiquettes de données visibles dans la collection. Lecture seule **int32_t**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabelFormat](../idatalabelformat/)\> [get_DefaultDataLabelFormat](./get_defaultdatalabelformat/)() | Renvoie le format par défaut de toutes les étiquettes de données dans la collection. Lecture seule [IDataLabelFormat](../idatalabelformat/). |
| virtual **bool** [get_IsVisible](./get_isvisible/)() | False signifie que l'étiquette de données n'est pas visible par défaut (et donc tous les drapeaux Show* (ShowValue, ...) de la propriété DefaultDataLabelFormat sont à false). Lecture seule **bool**. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartLinesFormat](../ichartlinesformat/)\> [get_LeaderLinesFormat](./get_leaderlinesformat/)() | Représente le format des lignes de leader des étiquettes de données. Lecture seule [IChartLinesFormat](../ichartlinesformat/). |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [get_ParentSeries](./get_parentseries/)() | Renvoie la série de diagramme parent. Lecture seule [IChartSeries](../ichartseries/). |
...
| virtual void [Hide](./hide/)() | Rend l'étiquette de données cachée par défaut en définissant tous les drapeaux Show* (ShowValue, ...) de la propriété DefaultDataLabelFormat à l'état false. IsVisible sera false après cela. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\> [idx_get](./idx_get/)(**int32_t**) | Obtient l'étiquette de données pour le point de données avec l'indice spécifié. |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IDataLabel](../idatalabel/)\>) | Renvoie l'indice du [DataLabel](../datalabel/) spécifié dans la collection. |
...
| T [LINQ_FirstOrDefault](../../system.collections.generic/ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Renvoie le premier élément de la séquence qui satisfait une condition ou une valeur par défaut si aucun élément de ce type n'est trouvé. |
