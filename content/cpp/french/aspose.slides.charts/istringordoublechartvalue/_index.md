...
description: "Représente une valeur string ou double qui peut être stockée dans un document de présentation pptx de deux manières: 1) dans la ou les cellules du classeur liées au graphique; 2) en tant que valeur littérale."
type: docs
weight: 1210
url: /fr/aspose.slides.charts/istringordoublechartvalue/
---
## IStringOrDoubleChartValue classe

Représente une valeur string ou double qui peut être stockée dans un document de présentation pptx de deux manières : 1) dans la ou les cellules du classeur liées au graphique ; 2) en tant que valeur littérale.
...
| virtual **double** [get_AsLiteralDouble](./get_asliteraldouble/)() | Renvoie le double littéral si la propriété DataSourceType est [DataSourceType::DoubleLiterals](../datasourcetype/). Lire **double**. |
...
| virtual void [set_AsLiteralDouble](./set_asliteraldouble/)(**double**) | Définit le double littéral si la propriété DataSourceType est [DataSourceType::DoubleLiterals](../datasourcetype/). Écrire **double**. |
...
| virtual **double** [ToDouble](./todouble/)() | Convertit la valeur en double. |
