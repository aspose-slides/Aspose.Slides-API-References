...
description: Représente la collection de IChartSeries
type: docs
weight: 833
url: /fr/aspose.slides.charts/ichartseriescollection/
---
## IChartSeriesCollection classe
...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([ChartType](../charttype/)) | Crée une nouvelle série de graphique et l'ajoute à la collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartDataCell](../ichartdatacell/)\>, [ChartType](../charttype/)) | Crée une nouvelle série de graphique à partir de [IChartDataCell](../ichartdatacell/) et l'ajoute à la collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IChartCellCollection](../ichartcellcollection/)\>, [ChartType](../charttype/)) | Crée une nouvelle série de graphique à partir de [IChartCellCollection](../ichartcellcollection/) et l'ajoute à la collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Add](./add/)([System::String](../../system/string/), [ChartType](../charttype/)) | Crée une nouvelle série de graphique à partir d'une valeur et l'ajoute à la collection. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Obtient un itérateur pointant vers le premier élément (le cas échéant) de la collection. Cet itérateur ne peut pas être utilisé pour modifier un objet référencé car [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) renvoie une copie d'objet de T. |
...
| virtual void [Clear](./clear/)() | Supprime tous les éléments (y compris le style du graphique) de la collection. |
...
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Recherche le [IChartSeries](../ichartseries/) spécifié et renvoie l'index basé sur zéro de la première occurrence dans l'ensemble de la Collection. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\> [Insert](./insert/)(**int32_t**, [ChartType](../charttype/)) | Crée une nouvelle série de graphique et l'insère dans la collection. |
...
| virtual void [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IChartSeries](../ichartseries/)\>) | Supprime la valeur spécifiée. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime l'élément à l'index spécifié. |
