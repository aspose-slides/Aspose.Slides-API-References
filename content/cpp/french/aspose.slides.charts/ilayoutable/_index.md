...
| virtual **float** [get_Bottom](./get_bottom/)() | Obtient le haut de l'élément de graphique en tant que fraction de la hauteur du graphique. Lecture seule **float**. |
...
| virtual **float** [get_Height](./get_height/)() | Spécifie la hauteur de l'élément de graphique en tant que fraction de la hauteur du graphique. Lecture **float**. |
...
| virtual **float** [get_Right](./get_right/)() | Obtient le côté droit de l'élément de graphique en tant que fraction de la largeur du graphique. Lecture seule **float**. |
...
| virtual **float** [get_Width](./get_width/)() | Spécifie la largeur de l'élément de graphique en tant que fraction de la largeur du graphique. Lecture **float**. |
| virtual **float** [get_X](./get_x/)() | Spécifie la position x (gauche) de l'élément de graphique en tant que fraction de la largeur du graphique. Lecture **float**. |
| virtual **float** [get_Y](./get_y/)() | Spécifie le haut de l'élément de graphique en tant que fraction de la hauteur du graphique. Lecture **float**. |
...
| virtual void [set_Height](./set_height/)(**float**) | Spécifie la hauteur de l'élément de graphique en tant que fraction de la hauteur du graphique. Écriture **float**. |
| virtual void [set_Width](./set_width/)(**float**) | Spécifie la largeur de l'élément de graphique en tant que fraction de la largeur du graphique. Écriture **float**. |
| virtual void [set_X](./set_x/)(**float**) | Spécifie la position x (gauche) de l'élément de graphique en tant que fraction de la largeur du graphique. Écriture **float**. |
| virtual void [set_Y](./set_y/)(**float**) | Spécifie le haut de l'élément de graphique en tant que fraction de la hauteur du graphique. Écriture **float**. |
