...
| Méthode | Description |
| --- | --- |
| void [AddFont](./addfont/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&, int) | Ajoute la police spécifiée à la collection. |
| void [AddFontFile](./addfontfile/)(const [String](../../system/string/)\&) | Ajoute une police du fichier spécifié à la collection. |
...
| [ArrayPtr](../../system/arrayptr/)\<[SharedPtr](../../system/sharedptr/)\<[FontFamily](../../system.drawing/fontfamily/)\>\> [get_Families](./get_families/)() override | Renvoie un tableau d'objets [FontFamily](../../system.drawing/fontfamily/) associés à la collection de polices représentée par l'objet actuel. |
