...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Encadre un élément mathématique avec les caractères spécifiés tels que parenthèses ou d’autres caractères de cadrage |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Argument](./get_argument/)(**int32_t**) override | Renvoie l’élément à l’indice spécifié du tableau. Lecture seule [Aspose::Slides::MathText::IMathElement](../imathelement/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElementCollection](../imathelementcollection/)\> [get_Arguments](./get_arguments/)() override | L’ensemble d’éléments du tableau |
| [MathVerticalAlignment](../mathverticalalignment/) [get_BaseJustification](./get_basejustification/)() override | Spécifie l’alignement du tableau par rapport au texte environnant. Le texte extérieur au tableau peut être aligné en bas, en haut ou au centre de l’objet tableau. Valeur par défaut : Centre |
| **bool** [get_MaximumDistribution](./get_maximumdistribution/)() override | Distribution maximale : lorsque vrai, le tableau est espacé sur toute la largeur de l’élément conteneur (page, colonne, cellule, etc.). |
| **bool** [get_ObjectDistribution](./get_objectdistribution/)() override | Distribution d’objet : lorsque vrai, le contenu du tableau est espacé sur toute la largeur de l’objet tableau. |
| **uint32_t** [get_RowSpacing](./get_rowspacing/)() override | Espacement entre les lignes d’un tableau. Utilisé uniquement lorsque RowSpacingRule vaut 3 : exactement, l’unité de mesure est le point, ou Multiple, où l’unité est la demi-ligne. Valeur par défaut : 0 |
| [MathRowSpacingRule](../mathrowspacingrule/) [get_RowSpacingRule](./get_rowspacingrule/)() override | Le type d’espacement vertical entre les éléments du tableau. Valeur par défaut : SingleLineGap |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)() override | Place cet élément dans un groupe en utilisant une accolade basse |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../mathelementbase/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) override | Place cet élément dans un groupe en utilisant un caractère de regroupement tel qu’une accolade basse ou un autre |
...
|  [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Crée un tableau mathématique et y place l’élément spécifié |
|  [MathArray](./matharray/)([System::SharedPtr](../../system/sharedptr/)\<[System::Collections::Generic::IEnumerable](../../system.collections.generic/ienumerable/)\<[System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>\>\>) | Crée un tableau mathématique et y place les éléments spécifiés |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien ; il initialise simplement un nouvel objet et autorise la construction de copies dans les sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie rien ; il initialise simplement un nouvel objet et autorise la construction de copies dans les sous-classes. |
...
| void [set_BaseJustification](./set_basejustification/)([MathVerticalAlignment](../mathverticalalignment/)) override | Spécifie l’alignement du tableau par rapport au texte environnant. Le texte extérieur au tableau peut être aligné en bas, en haut ou au centre de l’objet tableau. Valeur par défaut : Centre |
| void [set_MaximumDistribution](./set_maximumdistribution/)(**bool**) override | Distribution maximale : lorsque vrai, le tableau est espacé sur toute la largeur de l’élément conteneur (page, colonne, cellule, etc.). |
| void [set_ObjectDistribution](./set_objectdistribution/)(**bool**) override | Distribution d’objet : lorsque vrai, le contenu du tableau est espacé sur toute la largeur de l’objet tableau. |
| void [set_RowSpacing](./set_rowspacing/)(**uint32_t**) override | Espacement entre les lignes d’un tableau. Utilisé uniquement lorsque RowSpacingRule vaut 3 : exactement, l’unité est le point, ou Multiple, où l’unité est la demi-ligne. Valeur par défaut : 0 |
| void [set_RowSpacingRule](./set_rowspacingrule/)([MathRowSpacingRule](../mathrowspacingrule/)) override | Le type d’espacement vertical entre les éléments du tableau. Valeur par défaut : SingleLineGap |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathSubscriptElement](../imathsubscriptelement/)\> [SetSubscript](../mathelementbase/setsubscript/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Crée un indice inférieur |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathSubscriptElement](../imathsubscriptelement/)\> [SetSubscript](../mathelementbase/setsubscript/)([System::String](../../system/string/)) override | Crée un indice inférieur |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLeftSubSuperscriptElement](../imathleftsubsuperscriptelement/)\> [SetSubSuperscriptOnTheLeft](../mathelementbase/setsubsuperscriptontheleft/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Crée un indice inférieur et un exposant à gauche |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathLeftSubSuperscriptElement](../imathleftsubsuperscriptelement/)\> [SetSubSuperscriptOnTheLeft](../mathelementbase/setsubsuperscriptontheleft/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Crée un indice inférieur et un exposant à gauche |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRightSubSuperscriptElement](../imathrightsubsuperscriptelement/)\> [SetSubSuperscriptOnTheRight](../mathelementbase/setsubsuperscriptontheright/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) override | Crée un indice inférieur et un exposant à droite |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathRightSubSuperscriptElement](../imathrightsubsuperscriptelement/)\> [SetSubSuperscriptOnTheRight](../mathelementbase/setsubsuperscriptontheright/)([System::String](../../system/string/), [System::String](../../system/string/)) override | Crée un indice inférieur et un exposant à droite |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Place cet élément dans une boîte non visuelle (groupement logique) utilisée pour regrouper les composants d’une équation ou d’un autre texte mathématique. Un objet encadré peut, par exemple, servir d’émulateur d’opérateur avec ou sans point d’alignement, servir de point de rupture de ligne, ou être groupé afin d’interdire les sauts de ligne à l’intérieur. |
