...
Spécifie la fonction d'accent, consistant en une base et une marque diacritique combinée Exemple : \\uD835\\uDC4E\\u0301
...
| Méthode | Description |
| --- | --- |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathAccent](./)\> [Accent](../imathelement/accent/)(char16_t) | Définit une marque d'accent (un caractère sur le dessus de cet élément) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Entoure cet élément avec les caractères spécifiés tels que des parenthèses ou d'autres caractères d'encadrement |
| virtual **bool** [Equals](../../system/object/equals/)([ptr](../../system/object/ptr/)) | Compare les objets en utilisant la sémantique C# [Object.Equals](../../system/object/equals/). |
| static std::enable_if\<[IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&[IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type référence façon C#. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T1\>::value\&&\![IsSmartPtr](../../system/issmartptr/)\<T2\>::value, **bool**\>::type [Equals](../../system/object/equals/)(T1 const\&, T2 const\&) | Compare les objets de type valeur façon C#. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Utilise une fonction d'argument en utilisant cette instance comme nom de fonction |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathFunction](../imathfunction/)\> [Function](../imathelement/function/)([System::String](../../system/string/)) | Utilise une fonction d'argument en utilisant cette instance comme nom de fonction |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Base](./get_base/)() | L'argument auquel l'accent a été appliqué |
| virtual char16_t [get_Character](./get_character/)() | Caractère d'accent La valeur doit être dans la plage (U+0300\\u2013U+036F) ou (U+20D0\\u2013U+20EF) Valeur par défaut : Accent circonflexe combiné (U+0302) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | Place cet élément dans un groupe en utilisant un caractère de groupement tel qu'une accolade ouvrante ou un autre |
...
| virtual void [set_Character](./set_character/)(char16_t) | Caractère d'accent La valeur doit être dans la plage (U+0300\\u2013U+036F) ou (U+20D0\\u2013U+20EF) Valeur par défaut : Accent circonflexe combiné (U+0302) |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Place cet élément dans une boîte non visible (groupement logique) qui est utilisée pour regrouper les composants d'une équation ou d'une autre instance de texte mathématique. Un objet encadré peut (par exemple) servir d'émulateur d'opérateur avec ou sans point d'alignement, servir de point de rupture de ligne, ou être groupé afin d'empêcher les ruptures de ligne à l'intérieur. |
