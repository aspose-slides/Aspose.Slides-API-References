...
Spécifie les propriétés de [IMathNaryOperator](../imathnaryoperator/)
...
| virtual **bool** [get_GrowToMatchOperandHeight](./get_growtomatchoperandheight/)() | Le caractère opérateur s’étire verticalement pour correspondre à la hauteur de son opérande |
| virtual **bool** [get_HideSubscript](./get_hidesubscript/)() | Masquer l’indice |
| virtual **bool** [get_HideSuperscript](./get_hidesuperscript/)() | Masquer l’exposant |
| virtual [MathLimitLocations](../mathlimitlocations/) [get_LimitLocation](./get_limitlocation/)() | L’emplacement des limites (indice et exposant) |
| virtual char16_t [get_Operator](./get_operator/)() | Caractère opérateur n-aire Par exemple : '\\u2211', '\\u222B' |
...
| virtual void [set_GrowToMatchOperandHeight](./set_growtomatchoperandheight/)(**bool**) | Le caractère opérateur s’étire verticalement pour correspondre à la hauteur de son opérande |
| virtual void [set_HideSubscript](./set_hidesubscript/)(**bool**) | Masquer l’indice |
| virtual void [set_HideSuperscript](./set_hidesuperscript/)(**bool**) | Masquer l’exposant |
| virtual void [set_LimitLocation](./set_limitlocation/)([MathLimitLocations](../mathlimitlocations/)) | L’emplacement des limites (indice et exposant) |
| virtual void [set_Operator](./set_operator/)(char16_t) | Caractère opérateur n-aire Par exemple : '\\u2211', '\\u222B' |
