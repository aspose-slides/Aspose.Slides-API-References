...
| Method | Description |
| --- | --- |
| void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Ajoute [IMathBlock](../imathblock/) à la fin de la collection. |
| [iterator](./iterator/) [begin](./begin/)() | Obtient l'itérateur pointant vers le premier élément (s'il existe) de la collection. |
| [const_iterator](./const_iterator/) [begin](./begin/)() const | Obtient l'itérateur pointant vers le premier élément (s'il existe) de l'instance const de la collection. |
| [const_iterator](./const_iterator/) [cbegin](./cbegin/)() const | Obtient l'itérateur pointant vers le premier élément const (s'il existe) de la collection. |
| [const_iterator](./const_iterator/) [cend](./cend/)() const | Obtient l'itérateur pointant juste après le dernier élément const (s'il existe) de la collection. |
| void [Clear](./clear/)() override | Supprime tous les éléments de la collection. |
| **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Détermine si la collection contient une valeur spécifique. |
| [iterator](./iterator/) [end](./end/)() | Obtient l'itérateur pointant juste après le dernier élément (s'il existe) de la collection. |
| [const_iterator](./const_iterator/) [end](./end/)() const | Obtient l'itérateur pointant juste après le dernier élément (s'il existe) de l'instance const de la collection. |
...
| [MathJustification](../mathjustification/) [get_Justification](./get_justification/)() override | [Paragraph](../../aspose.slides/paragraph/) Justification Valeur par défaut : CenteredAsGroup |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogue de la méthode C# [Object.GetHashCode()](../../system/object/gethashcode/). Permet le hachage d'objets personnalisés. |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtient le type réel de l'objet. Analogue de l'appel C# [System.Object.GetType()](../../system/object/gettype/). |
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) override | Obtient l'élément à l'index spécifié. Lecture seule [IMathBlock](../imathblock/). |
| void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Obtient l'élément à l'index spécifié. Lecture seule [IMathBlock](../imathblock/). |
| **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Détermine l'index d'un [IMathBlock](../imathblock/) spécifique dans la collection. |
| void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Insère [IMathBlock](../imathblock/) dans la collection à l'index spécifié. |
...
|  [MathParagraph](./mathparagraph/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Initialise une nouvelle instance de la classe [MathParagraph](./). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogue de la méthode C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permet le clonage de types personnalisés. |
|  [Object](../../system/object/object/)() | Crée l'objet. Initialise toutes les structures de données internes. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet la construction de copies dans les sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il initialise simplement un nouvel objet et permet la construction de copies dans les sous-classes. |
...
| **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) override | Supprime la première occurrence d'un objet spécifique de la collection/>. |
| void [RemoveAt](./removeat/)(**int32_t**) override | Supprime un élément à l'index spécifié de la collection. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées de la valeur spécifiée. |
| void [set_Justification](./set_justification/)([MathJustification](../mathjustification/)) override | [Paragraph](../../aspose.slides/paragraph/) Justification Valeur par défaut : CenteredAsGroup |
...
| [System::String](../../system/string/) [ToLatex](./tolatex/)() override | Obtient l'équation mathématique au format LaTeX |
...
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtient l'itérateur pointant vers le premier élément (s'il existe) de l'instance const de la collection. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Obtient l'itérateur pointant vers le premier élément (s'il existe) de la collection. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtient l'itérateur pointant juste après le dernier élément (s'il existe) de l'instance const de la collection. |
| [virtualized_iterator](./virtualized_iterator/) * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtient l'itérateur pointant juste après le dernier élément (s'il existe) de la collection. |
| Detail::SmartPtrCounter * [WeakRefAdded](../../system/object/weakrefadded/)() | Incrémente le compteur de références faibles. Ne doit pas être appelé directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
| void [WeakRefRemoved](../../system/object/weakrefremoved/)() | Décrémente le compteur de références faibles. Ne doit pas être appelé directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
| void [WriteAsMathMl](./writeasmathml/)([System::SharedPtr](../../system/sharedptr/)\<[System::IO::Stream](../../system.io/stream/)\>) override | Enregistre le contenu de ce [MathParagraph](./) au format MathML |
