...
description: Spécifie la fonction radicale, constituée d'une base et d'un degré facultatif. Exemple d'objet radical est \\u221A\\uD835\\uDC65.
type: docs
weight: 1054
...
Spécifie la fonction radicale, constituée d'une base et d'un degré optionnel. Exemple d'objet radical est \\u221A\\uD835\\uDC65.
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../mathelementbase/enclose/)(char16_t, char16_t) override | Enveloppe un élément mathématique dans les caractères spécifiés, tels que des parenthèses ou d'autres caractères d'encadrement |
...
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison de nombres flottants à la manière de C# où deux NaN sont considérés égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Degree](./get_degree/)() override | Argument de degré |
| **bool** [get_HideDegree](./get_hidedegree/)() override | Masque le degré. Lorsque true, le degré n'est pas affiché, comme dans \\u221A\\uD835\\uDC65 |
...
|  [MathRadical](./mathradical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>, [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Initialise une nouvelle instance de la classe [MathRadical](./). |
...
| void [set_HideDegree](./set_hidedegree/)(**bool**) override | Masque le degré. Lorsque true, le degré n'est pas affiché, comme dans \\u221A\\uD835\\uDC65 |
...
| [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../mathelementbase/tobox/)() override | Place cet élément dans une boîte non visuelle (groupement logique) utilisée pour regrouper les composants d'une équation ou d'une autre instance de texte mathématique. Un objet encadré peut (par exemple) servir d'émulateur d'opérateur avec ou sans point d'alignement, servir de point de rupture de ligne, ou être groupé de manière à interdire les sauts de ligne à l'intérieur. |
