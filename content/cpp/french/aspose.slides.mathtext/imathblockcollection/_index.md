...
| Method | Description |
| --- | --- |
| virtual void [Add](./add/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Ajoute [IMathBlock](../imathblock/) à la fin de la collection. |
...
| virtual **bool** [Contains](./contains/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Détermine si la collection contient une valeur spécifique. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison de nombres flottants de type C# où deux NaN sont considérés comme égaux même si selon IEC 60559:1989 le NaN n’est égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison de nombres flottants de type C# où deux NaN sont considérés comme égaux même si selon IEC 60559:1989 le NaN n’est égal à aucune valeur, y compris NaN. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\> [idx_get](./idx_get/)(**int32_t**) | Obtient l'élément à l'index spécifié. Lecture seule [IMathBlock](../imathblock/). |
| virtual void [idx_set](./idx_set/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Obtient l'élément à l'index spécifié. Lecture seule [IMathBlock](../imathblock/). |
| virtual **int32_t** [IndexOf](./indexof/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Détermine l'index d'un [IMathBlock](../imathblock/) spécifique dans la collection. |
| virtual void [Insert](./insert/)(**int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Insère [IMathBlock](../imathblock/) dans la collection à l'index spécifié. |
...
| virtual **bool** [Remove](./remove/)([System::SharedPtr](../../system/sharedptr/)\<[IMathBlock](../imathblock/)\>) | Supprime la première occurrence d'un objet spécifique de la collection/>. |
| virtual void [RemoveAt](./removeat/)(**int32_t**) | Supprime un élément à l'index spécifié de la collection. |
