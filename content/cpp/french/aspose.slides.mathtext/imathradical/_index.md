...
description: Spécifie la fonction radicale, composée d'une base et d'un degré optionnel. Exemple d'objet radical : \\u221A\\uD835\\uDC65.
type: docs
weight: 508
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathDelimiter](../imathdelimiter/)\> [Enclose](../imathelement/enclose/)(char16_t, char16_t) | Encadre cet élément avec les caractères spécifiés, comme des parenthèses ou d'autres caractères |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\> [get_Degree](./get_degree/)() | Argument de degré |
| virtual **bool** [get_HideDegree](./get_hidedegree/)() | Masquer le degré. Quand vrai, le degré n'est pas affiché, comme dans \\u221A\\uD835\\uDC65 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathGroupingCharacter](../imathgroupingcharacter/)\> [Group](../imathelement/group/)(char16_t, [MathTopBotPositions](../mathtopbotpositions/), [MathTopBotPositions](../mathtopbotpositions/)) | Place cet élément dans un groupe en utilisant un caractère de regroupement tel qu'une accolade ouvrante ou autre |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie réellement rien, il initialise simplement un nouvel objet et permet la construction copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie réellement rien, il initialise simplement un nouvel objet et permet la construction copie des sous-classes. |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::SharedPtr](../../system/sharedptr/)\<[IMathElement](../imathelement/)\>) | Spécifie la racine mathématique du degré donné à partir de l'argument spécifié. |
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathRadical](./)\> [Radical](../imathelement/radical/)([System::String](../../system/string/)) | Spécifie la racine mathématique du degré donné à partir de l'argument spécifié. |
...
| virtual void [set_HideDegree](./set_hidedegree/)(**bool**) | Masquer le degré. Quand true, le degré n'est pas affiché, comme dans \\u221A\\uD835\\uDC65 |
...
| virtual [System::SharedPtr](../../system/sharedptr/)\<[IMathBox](../imathbox/)\> [ToBox](../imathelement/tobox/)() | Place cet élément dans une boîte non visuelle (groupement logique) utilisée pour regrouper des composants d’une équation ou d’une autre instance de texte mathématique. Un objet mis en boîte peut (par exemple) servir d’émulateur d’opérateur avec ou sans point d’alignement, servir de point de rupture de ligne, ou être groupé de façon à empêcher les retours à la ligne à l’intérieur. |
...
| void [Unlock](../../system/object/unlock/)() | Implémente l'instruction C# lock() pour le déverrouillage. Appelez directement ou utilisez l'objet sentinelle [LockContext](../../system/lockcontext/). |
