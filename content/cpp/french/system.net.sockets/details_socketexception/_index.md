...
description: "Représente l'exception levée lorsqu'une erreur de socket se produit. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe SocketException à la place. Ne jamais encapsuler les instances de la classe SocketException dans System::SmartPtr."
type: docs
weight: 1
url: /fr/system.net.sockets/details_socketexception/
---
## Details_SocketException classe

Représente l'exception levée lorsqu'une erreur de socket se produit. Ne créez jamais d'instances de cette classe manuellement. Utilisez la classe SocketException à la place. Ne jamais encapsuler les instances de la classe SocketException dans [System::SmartPtr](../../system/smartptr/).
...
| **int32_t** [get_ErrorCode](./get_errorcode/)() | Obtient le code d'erreur. |
...
| [SocketError](../socketerror/) [get_SocketErrorCode](./get_socketerrorcode/)() | Obtient le code d'erreur du socket. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il initialise simplement un nouvel objet et permet la copie lors de la construction de sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, en réalité, il initialise simplement un nouvel objet et permet la copie lors de la construction de sous-classes. |
...
| void [set_ErrorCode](./set_errorcode/)(**int32_t**) | Définit le code d'erreur. |
...
| void [set_SocketErrorCode](./set_socketerrorcode/)([SocketError](../socketerror/)) | Définit le code d'erreur du socket. |
