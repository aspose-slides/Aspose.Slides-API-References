...
description: "Classe factice pour rendre le code traduit qui utilise l'interface IButtonControl compilable. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne jamais créer d'instance de ce type sur la pile ou en utilisant l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des violations d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 27
url: /fr/system.windows.forms/ibuttoncontrol/
---
## IButtonControl classe


Classe factice pour rendre le code traduit qui utilise [IButtonControl](./) interface compilable. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d’instance de ce type sur la pile ou en utilisant l’opérateur new, car cela entraînera des erreurs d’exécution et/ou des violations d’assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le transmettre aux fonctions en argument.
...
| virtual [DialogResult](../dialogresult/) [get_DialogResult](./get_dialogresult/)() | Obtient le résultat du dialogue associé au bouton. |
...
| virtual void [NotifyDefault](./notifydefault/)(**bool**) | Rend le contrôle par défaut ou non par défaut. |
|  [Object](../../system/object/object/)() | Crée l’objet. Initialise toutes les structures de données internes. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, il initialise simplement le nouvel objet et permet la construction par copie de sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie rien, il initialise simplement le nouvel objet et permet la construction par copie de sous-classes. |
| virtual void [PerformClick](./performclick/)() | Effectue un clic sur le bouton. |
...
| virtual void [set_DialogResult](./set_dialogresult/)([DialogResult](../dialogresult/)) | Définit le résultat du dialogue associé au bouton. |
