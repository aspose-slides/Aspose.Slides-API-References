...
description: L'exception qui est levée lorsqu'une ou plusieurs références circulaires sont détectées, une formule référant à sa propre cellule directement ou indirectement.
type: docs
weight: 1
url: /fr/aspose.slides.spreadsheet/details_cellcircularreferenceexception/
---
## Details_CellCircularReferenceException classe

L’exception qui est levée lorsqu’une ou plusieurs références circulaires sont détectées, une formule référant à sa propre cellule directement ou indirectement.
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison de nombres à virgule flottante de type C# où deux NaN sont considérés comme égaux bien que selon IEC 60559:1989 le NaN ne soit égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison de nombres à virgule flottante de type C# où deux NaN sont considérés comme égaux bien que selon IEC 60559:1989 le NaN ne soit égal à aucune valeur, y compris NaN. |
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Obtient une référence de cellule circulaire. |
