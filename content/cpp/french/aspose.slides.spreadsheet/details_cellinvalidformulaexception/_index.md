...
type: docs
weight: 14
url: /fr/aspose.slides.spreadsheet/details_cellinvalidformulaexception/
---
## Details_CellInvalidFormulaException classe

L'exception qui est levée lorsque une formule calculée n'est pas correcte ou n'a pas été analysée.
...
| **int32_t** [get_HResult](../../system/details_exception/get_hresult/)() const | Renvoie une valeur entière 32 bits qui est un code HRESULT associé à l'exception représentée par l'objet courant. |
...
| [System::String](../../system/string/) [get_Reference](./get_reference/)() | Obtient une référence de cellule contenant la formule invalide. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Configure le n-ième argument de modèle en pointeur faible (plutôt que partagé). Permet de basculer les pointeurs dans les conteneurs en mode faible. |
