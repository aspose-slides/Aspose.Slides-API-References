...
description: Fournit des méthodes de manipulation de texte utilisées par plusieurs classes.
type: docs
weight: 118
url: /fr/system.xml/xmlcharacterdata/
---
...
| virtual void [AppendData](./appenddata/)([String](../../system/string/)) | Ajoute la chaîne spécifiée à la fin des données de caractères du nœud. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtient un itérateur pointant vers le premier élément (le cas échéant) de l'instance qualifiée const de la collection. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Crée un duplicata du nœud lorsqu’il est redéfini dans une classe dérivée. |
...
| virtual void [DeleteData](./deletedata/)(**int32_t**, **int32_t**) | Supprime une plage de caractères du nœud. |
...
| virtual [String](../../system/string/) [get_Data](./get_data/)() | Renvoie les données du nœud. |
...
| virtual **int32_t** [get_Length](./get_length/)() | Renvoie la longueur des données, en caractères. |
...
| virtual [String](../../system/string/) [get_Prefix](../xmlnode/get_prefix/)() | Renvoie le préfixe de l'espace de noms de ce nœud. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Renvoie le jeu d'informations post-validation de schéma qui a été attribué à ce nœud suite à la validation de schéma. |
...
| virtual void [InsertData](./insertdata/)(**int32_t**, [String](../../system/string/)) | Insère la chaîne spécifiée à la position de caractère spécifiée. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Place tous les nœuds [XmlText](../xmltext/) à pleine profondeur du sous-arbre sous ce [XmlNode](../xmlnode/) dans une forme « normale » où seul le balisage (c’est-à-dix les balises, commentaires, instructions de traitement, sections CDATA et références d’entité) sépare les nœuds [XmlText](../xmltext/), c’est-à-dix qu’il n’y a aucun nœud [XmlText](../xmltext/) adjacent. |
...
| virtual void [ReplaceData](./replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Remplace le nombre spécifié de caractères à partir du décalage spécifié par la chaîne spécifiée. |
...
| virtual void [set_Data](./set_data/)([String](../../system/string/)) | Définit les données du nœud. |
...
| virtual void [set_Prefix](../xmlnode/set_prefix/)([String](../../system/string/)) | Définit le préfixe de l’espace de noms de ce nœud. |
...
| virtual [String](../../system/string/) [Substring](./substring/)(**int32_t**, **int32_t**) | Récupère une sous-chaîne de la chaîne complète à partir de la plage spécifiée. |
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Teste si l’implémentation DOM prend en charge une fonction spécifique. |
