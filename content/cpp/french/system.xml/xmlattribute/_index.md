...
description: Représente un attribut. Les valeurs valides et par défaut de l'attribut sont définies dans une définition de type de document (DTD) ou un schéma.
type: docs
weight: 79
url: /fr/system.xml/xmlattribute/
---
## XmlAttribute classe

Représente un attribut. Des valeurs valides et par défaut pour l'attribut sont définies dans une définition de type de document (DTD) ou un schéma.
...
| Méthode | Description |
| --- | --- |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [AppendChild](./appendchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Ajoute le nœud spécifié à la fin de la liste des nœuds enfants de ce nœud. |
...
| [SharedPtr](../../system/sharedptr/)\<[XPath::XPathNavigator](../../system.xml.xpath/xpathnavigator/)\> [CreateNavigator](../xmlnode/createnavigator/)() override | Crée un XPathNavigator pour naviguer dans cet objet. |
...
| [String](../../system/string/) [get_BaseURI](./get_baseuri/)() override | Renvoie l'identifiant uniforme de ressource (URI) de base du nœud. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](./get_ownerdocument/)() override | Renvoie le [XmlDocument](../xmldocument/) auquel appartient ce nœud. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [get_OwnerElement](./get_ownerelement/)() | Renvoie le [XmlElement](../xmlelement/) auquel appartient l'attribut. |
...
| [String](../../system/string/) [get_Prefix](./get_prefix/)() override | Renvoie le préfixe d'espace de noms de ce nœud. |
...
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | Renvoie le post-schema-validation-infoset qui a été attribué à ce nœud suite à la validation du schéma. |
| virtual **bool** [get_Specified](./get_specified/)() | Renvoie une valeur indiquant si la valeur de l'attribut a été définie explicitement. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Renvoie la valeur du nœud. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Renvoie un énumérateur qui parcourt les nœuds enfants dans le nœud actuel. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertAfter](./insertafter/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Insère le nœud spécifié immédiatement après le nœud de référence spécifié. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [InsertBefore](./insertbefore/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Insère le nœud spécifié immédiatement avant le nœud de référence spécifié. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [PrependChild](./prependchild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Ajoute le nœud spécifié au début de la liste des nœuds enfants de ce nœud. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveChild](./removechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Supprime le nœud enfant spécifié. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées de la valeur spécifiée. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [ReplaceChild](./replacechild/)([SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>, [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>) override | Remplace le nœud enfant spécifié par le nouveau nœud enfant spécifié. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Sélectionne une liste de nœuds correspondant à l'expression [XPath](../../system.xml.xpath/). Tous les préfixes trouvés dans l'expression [XPath](../../system.xml.xpath/) sont résolus à l'aide de [XmlNamespaceManager](../xmlnamespacemanager/) fourni. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Sélectionne le premier [XmlNode](../xmlnode/) correspondant à l'expression [XPath](../../system.xml.xpath/). Tous les préfixes trouvés dans l'expression [XPath](../../system.xml.xpath/) sont résolus à l'aide de [XmlNamespaceManager](../xmlnamespacemanager/) fourni. |
...
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Définit la valeur de l'attribut. |
| void [set_Prefix](./set_prefix/)([String](../../system/string/)) override | Définit le préfixe d'espace de noms de ce nœud. |
