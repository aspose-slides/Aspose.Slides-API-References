...
description: Représente le contenu texte d'un élément ou d'un attribut.
type: docs
weight: 495
url: /fr/system.xml/xmltext/
---
## XmlText classe
...
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Ajoute la chaîne spécifiée à la fin des données de caractères du nœud. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtient un itérateur pointant sur le premier élément (le cas échéant) de l'instance const de la collection. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Obtient un itérateur pointant sur le premier élément const (le cas échéant) de la collection. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Renvoie l’ensemble d’informations post-validation de schéma assigné à ce nœud suite à la validation de schéma. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Renvoie le premier élément enfant ayant le [XmlNode::get_Name](../xmlnode/get_name/) spécifié. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](../xmlelement/)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Renvoie le premier élément enfant ayant les valeurs [XmlNode::get_LocalName](../xmlnode/get_localname/) et [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/) spécifiées. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Insère la chaîne spécifiée à la position de caractère indiquée. |
...
| **bool** [LINQ_Any](../../system.collections.generic/ienumerable/linq_any/)(std::function\<**bool**(T)>) | Détermine si un quelconque élément d’une séquence satisfait une condition. |
...
| void [Lock](../../system/object/lock/)() | Implémente l’instruction C# `lock()` en verrouillant. Appeler directement ou utiliser l’objet sentinelle [LockContext](../../system/lockcontext/). |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogue de la méthode C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permet le clonage de types personnalisés. |
| virtual void [Normalize](../xmlnode/normalize/)() | Met tous les nœuds [XmlText](./) de la profondeur complète du sous-arbre sous ce [XmlNode](../xmlnode/) dans une forme « normale » où seul le balisage (c’est-à-dire les balises, commentaires, instructions de traitement, sections CDATA et références d’entité) sépare les nœuds [XmlText](./), c’est-à-dire qu’il n’y a pas de nœuds [XmlText](./) adjacents. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlText](./)\> [SplitText](./splittext/)(**int32_t**) | Divise le nœud en deux nœuds à l’offset indiqué, en conservant les deux comme frères dans l’arbre. |
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Récupère une sous-chaîne de la chaîne complète depuis la plage spécifiée. |
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Vérifie si l’implémentation DOM implémente une fonctionnalité spécifique. |
...
| void [Unlock](../../system/object/unlock/)() | Implémente l’instruction C# `lock()` en déverrouillant. Appeler directement ou utiliser l’objet sentinelle [LockContext](../../system/lockcontext/). |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Enregistre tous les enfants du nœud dans le [XmlWriter](../xmlwriter/) spécifié. Les nœuds [XmlText](./) n’ont pas d’enfants, donc cette méthode n’a aucun effet. |
...
Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d’instanciation de ce type sur la pile ou avec l’opérateur new, car cela entraînerait des erreurs d’exécution et/ou des violations d’assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu’argument. 
