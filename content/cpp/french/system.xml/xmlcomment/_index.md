...
description: "Représente le contenu d'un commentaire XML."
type: docs
weight: 144
url: /fr/system.xml/xmlcomment/
---
## XmlComment classe
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Obtient un itérateur pointant vers le premier élément (s'il existe) de la collection. Cet itérateur ne peut pas être utilisé pour modifier un objet référencé parce que [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) renvoie un objet copie de T. |
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [end](../../system.collections.generic/ienumerable/end/)() | Obtient un itérateur pointant juste après le dernier élément (s'il existe) de la collection. Cet itérateur ne peut pas être utilisé pour modifier un objet référencé parce que [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) renvoie un objet copie de T. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Renvoie le jeu d'informations post-validation de schéma qui a été attribué à ce nœud à la suite de la validation du schéma. |
| [String](../../system/string/) [get_Value](../xmlcharacterdata/get_value/)() override | Renvoie la valeur du nœud. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Insère la chaîne spécifiée à l'offset de caractère spécifié. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Place tous les nœuds [XmlText](../xmltext/) à la profondeur maximale de la sous-arborescence sous ce [XmlNode](../xmlnode/) dans une forme "normale" où seul le balisage (c'est-à-dire les balises, commentaires, instructions de traitement, sections CDATA et références d'entité) sépare les nœuds [XmlText](../xmltext/), c’est-à-dire qu'il n'y a pas de nœuds [XmlText](../xmltext/) adjacents. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Remplace le nombre spécifié de caractères à partir de l'offset spécifié par la chaîne spécifiée. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Sélectionne une liste de nœuds correspondant à l'expression [XPath](../../system.xml.xpath/). Les préfixes trouvés dans l'expression [XPath](../../system.xml.xpath/) sont résolus à l'aide du [XmlNamespaceManager](../xmlnamespacemanager/) fourni. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Sélectionne le premier [XmlNode](../xmlnode/) qui correspond à l'expression [XPath](../../system.xml.xpath/). Les préfixes trouvés dans l'expression [XPath](../../system.xml.xpath/) sont résolus à l'aide du [XmlNamespaceManager](../xmlnamespacemanager/) fourni. |
...
| void [set_Value](../xmlcharacterdata/set_value/)([String](../../system/string/)) override | Définit la valeur du nœud. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Enregistre tous les enfants du nœud dans le [XmlWriter](../xmlwriter/) spécifié. Comme les nœuds de commentaire n'ont pas d'enfants, cette méthode n'a aucun effet. |
...
Les objets de cette classe ne doivent être alloués qu'à l'aide de la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d'instances de ce type sur la pile ou à l'aide de l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des échecs d'assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument. 
