...
description: Représente une instruction de traitement, que XML définit pour conserver des informations spécifiques au processeur dans le texte du document.
type: docs
weight: 404
url: /fr/system.xml/xmlprocessinginstruction/
---
...
| [String](../../system/string/) [get_Data](./get_data/)() | Renvoie le contenu de l'instruction de traitement, à l'exclusion de la cible. |
...
| [String](../../system/string/) [get_Target](./get_target/)() | Renvoie la cible de l'instruction de traitement. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Recherche la déclaration **xmlns** la plus proche pour le préfixe donné qui est en vigueur pour le nœud actuel et renvoie l'URI de l'espace de noms dans la déclaration. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Recherche la déclaration **xmlns** la plus proche pour l'URI d'espace de noms donnée qui est en vigueur pour le nœud actuel et renvoie le préfixe défini dans cette déclaration. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_Cast](../../system.collections.generic/ienumerable/linq_cast/)() | Cast les éléments au type spécifié. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Place tous les nœuds [XmlText](../xmltext/) sur toute la profondeur du sous-arbre sous ce [XmlNode](../xmlnode/) dans une forme "normale" où seul le balisage (c’est-à-dire les balises, commentaires, instructions de traitement, sections CDATA et références d'entité) sépare les nœuds [XmlText](../xmltext/), c'est-à-dire qu'il n'existe aucun nœud [XmlText](../xmltext/) adjacent. |
|  [Object](../../system/object/object/)() | Crée l'objet. Initialise toutes les structures de données internes. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en réalité, il se contente d'initialiser un nouvel objet et permet la copie lors de la construction de sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, en réalité, il se contente d'initialiser un nouvel objet et permet la copie lors de la construction de sous-classes. |
...
| void [set_Data](./set_data/)(const [String](../../system/string/)\&) | Définit le contenu de l'instruction de traitement, à l'exclusion de la cible. |
...
| virtual **bool** [Supports](../xmlnode/supports/)([String](../../system/string/), [String](../../system/string/)) | Teste si l'implémentation DOM supporte une fonctionnalité spécifique. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Enregistre tous les enfants du nœud dans le [XmlWriter](../xmlwriter/) spécifié. Puisque les nœuds ProcessingInstruction n'ont pas d'enfants, cette méthode n'a aucun effet. |
