...
description: Représente un objet léger utile pour les opérations d'insertion dans l'arbre.
type: docs
weight: 196
url: /fr/system.xml/xmldocumentfragment/
---
## XmlDocumentFragment classe

Représente un objet léger utile pour les opérations d’insertion dans l’arbre.
...
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Renvoie le balisage représentant les enfants de ce nœud. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Renvoie l’ensemble d’informations post validation de schéma qui a été assigné à ce nœud à la suite d’une validation de schéma. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Place tous les nœuds [XmlText](../xmltext/) à la profondeur maximale du sous-arbre sous ce [XmlNode](../xmlnode/) dans une forme « normale » où seul le balisage (c’est-à-dire les balises, commentaires, instructions de traitement, sections CDATA et références d’entités) sépare les nœuds [XmlText](../xmltext/), c’est-à-dire qu’il n’y a pas de nœuds [XmlText](../xmltext/) adjacents. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [SelectNodes](../xmlnode/selectnodes/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Sélectionne une liste de nœuds correspondant à l’expression [XPath](../../system.xml.xpath/). Tous les préfixes trouvés dans l’expression [XPath](../../system.xml.xpath/) sont résolus avec le [XmlNamespaceManager](../xmlnamespacemanager/) fourni. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Sélectionne le premier [XmlNode](../xmlnode/) qui correspond à l’expression [XPath](../../system.xml.xpath/). Tous les préfixes trouvés dans l’expression [XPath](../../system.xml.xpath/) sont résolus avec le [XmlNamespaceManager](../xmlnamespacemanager/) fourni. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument modèle comme pointeur faible (plutôt que partagé). Permet de passer les pointeurs des conteneurs en mode faible. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sauvegarde tous les enfants du nœud dans le [XmlWriter](../xmlwriter/) spécifié. |
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Sauvegarde le nœud dans le [XmlWriter](../xmlwriter/) spécifié. |
