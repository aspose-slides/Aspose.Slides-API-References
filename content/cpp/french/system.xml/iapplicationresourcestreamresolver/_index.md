...
description: Représente un résolveur de flux de ressources d'application.
type: docs
weight: 14
url: /fr/system.xml/iapplicationresourcestreamresolver/
---
## IApplicationResourceStreamResolver classe


Représente un résolveur de flux de ressources d'application.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IO::Stream](../../system.io/stream/)\> [GetApplicationResourceStream](./getapplicationresourcestream/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>) | Retourne un flux de ressources d'application depuis l'URI spécifié. |
