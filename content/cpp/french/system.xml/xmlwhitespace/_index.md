...
description: Représente les espaces blancs dans le contenu d'un élément.
type: docs
weight: 560
url: /fr/system.xml/xmlwhitespace/
---
...
| virtual void [AppendData](../xmlcharacterdata/appenddata/)([String](../../system/string/)) | Ajoute la chaîne spécifiée à la fin des données caractères du nœud. |
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Obtient un itérateur pointant vers le premier élément (le cas échéant) de la collection. Cet itérateur ne peut pas être utilisé pour modifier l'objet référencé parce que [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) renvoie un objet copie de T. |
...
| virtual void [DeleteData](../xmlcharacterdata/deletedata/)(**int32_t**, **int32_t**) | Supprime une plage de caractères du nœud. |
...
| virtual [String](../../system/string/) [get_Data](../xmlcharacterdata/get_data/)() | Renvoie les données du nœud. |
...
| [String](../../system/string/) [get_InnerText](../xmlcharacterdata/get_innertext/)() override | Renvoie les valeurs concaténées du nœud et de tous ses enfants. |
...
| virtual **int32_t** [get_Length](../xmlcharacterdata/get_length/)() | Renvoie la longueur des données, en caractères. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousText](./get_previoustext/)() override | Renvoie le nœud texte qui précède immédiatement ce nœud. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Renvoie l'ensemble d'informations post-validation du schéma qui a été attribué à ce nœud à la suite de la validation du schéma. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Insère la chaîne spécifiée à l'offset de caractère indiqué. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Implémente une fonction de transformation sur chaque élément d'une séquence générique et renvoie la valeur maximale résultante. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Implémente une fonction de transformation sur chaque élément d'une séquence générique et renvoie la valeur minimale résultante. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\> [LINQ_SelectMany](../../system.collections.generic/ienumerable/linq_selectmany/)(const [Func](../../system/func/)\<T, [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../../system.collections.generic/ienumerable/)\<ResultType\>\>\>\&) | Projecte chaque élément d'une séquence et combine les séquences résultantes en une seule séquence. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Place tous les nœuds [XmlText](../xmltext/) à toute la profondeur du sous-arbre sous ce [XmlNode](../xmlnode/) dans une forme « normale » où seul le balisage (c’est-à-dire les balises, commentaires, instructions de traitement, sections CDATA et références d’entité) sépare les nœuds [XmlText](../xmltext/), c’est-à-dire qu’il n’y a pas de nœuds [XmlText](../xmltext/) adjacents. |
|  [Object](../../system/object/object/)() | Crée l'objet. Initialise toutes les structures de données internes. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, il initialise simplement un nouvel objet et permet la construction de copies des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'assignation. Ne copie rien, il initialise simplement un nouvel objet et permet la construction de copies des sous-classes. |
...
| virtual void [ReplaceData](../xmlcharacterdata/replacedata/)(**int32_t**, **int32_t**, [String](../../system/string/)) | Remplace le nombre spécifié de caractères à partir de l'offset indiqué par la chaîne spécifiée. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Sélectionne le premier [XmlNode](../xmlnode/) qui correspond à l'expression [XPath](../../system.xml.xpath/). Tous les préfixes trouvés dans l'expression [XPath](../../system.xml.xpath/) sont résolus à l'aide de [XmlNamespaceManager](../xmlnamespacemanager/) fourni. |
| virtual void [set_Data](../xmlcharacterdata/set_data/)([String](../../system/string/)) | Définit les données du nœud. |
| void [set_InnerText](../xmlcharacterdata/set_innertext/)([String](../../system/string/)) override | Définit les valeurs concaténées du nœud et de tous ses enfants. |
...
| virtual [String](../../system/string/) [Substring](../xmlcharacterdata/substring/)(**int32_t**, **int32_t**) | Récupère une sous-chaîne de la chaîne complète à partir de la plage spécifiée. |
