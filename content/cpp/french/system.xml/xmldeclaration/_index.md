...
description: Représente le nœud de déclaration XML <?xml version='1.0'...?>.
type: docs
weight: 170
url: /fr/system.xml/xmldeclaration/
---
## XmlDeclaration classe
...
| [String](../../system/string/) [get_Encoding](./get_encoding/)() | Retourne le niveau d'encodage du document XML. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Retourne les valeurs concaténées du [XmlDeclaration](./). |
| virtual [String](../../system/string/) [get_InnerXml](../xmlnode/get_innerxml/)() | Retourne le balisage représentant uniquement les nœuds enfants de ce nœud. |
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | Retourne une valeur indiquant si le nœud est en lecture seule. |
...
| [String](../../system/string/) [get_LocalName](./get_localname/)() override | Retourne le nom local du nœud. |
| [String](../../system/string/) [get_Name](./get_name/)() override | Retourne le nom qualifié du nœud. |
...
| virtual [String](../../system/string/) [get_OuterXml](../xmlnode/get_outerxml/)() | Retourne le balisage contenant ce nœud et tous ses nœuds enfants. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Retourne le jeu d'informations post-validation du schéma qui a été attribué à ce nœud à la suite d'une validation de schéma. |
| [String](../../system/string/) [get_Standalone](./get_standalone/)() | Retourne la valeur de l'attribut standalone. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Retourne la valeur du [XmlDeclaration](./). |
| [String](../../system/string/) [get_Version](./get_version/)() | Retourne la version XML du document. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Recherche la déclaration **xmlns** la plus proche pour le préfixe donné qui est en portée du nœud actuel et renvoie l'URI de l'espace de noms dans la déclaration. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Appelle une fonction de transformation sur chaque élément d'une séquence générique et retourne la valeur maximale obtenue. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Appelle une fonction de transformation sur chaque élément d'une séquence générique et retourne la valeur minimale obtenue. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Place tous les nœuds [XmlText](../xmltext/) dans toute la profondeur du sous-arbre sous ce [XmlNode](../xmlnode/) sous forme "normale" où seul le balisage (c’est-à-dire les balises, les commentaires, les instructions de traitement, les sections CDATA et les références d’entité) sépare les nœuds [XmlText](../xmltext/), c’est-à-dire qu’il n’y a pas de nœuds [XmlText](../xmltext/) adjacents. |
...
| void [set_Encoding](./set_encoding/)(const [String](../../system/string/)\&) | Définit le niveau d'encodage du document XML. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Définit les valeurs concaténées du [XmlDeclaration](./). |
...
| void [set_Standalone](./set_standalone/)(const [String](../../system/string/)\&) | Définit la valeur de l'attribut standalone. |
| void [set_Value](./set_value/)([String](../../system/string/)) override | Définit la valeur du [XmlDeclaration](./). |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Enregistre les enfants du nœud dans le [XmlWriter](../xmlwriter/) spécifié. Comme les nœuds [XmlDeclaration](./) n'ont pas d'enfants, cette méthode n'a aucun effet. |
...
Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d'instances de ce type sur la pile ou à l'aide de l'opérateur new, car cela entraînerait des erreurs d'exécution et/ou des échecs d'assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument. 
