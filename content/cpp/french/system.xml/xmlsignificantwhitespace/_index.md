...
description: "Représente les espaces blancs entre le balisage dans un nœud à contenu mixte ou les espaces blancs dans une portée xml:space='preserve'. On l'appelle également espace blanc significatif."
type: docs
weight: 482
url: /fr/system.xml/xmlsignificantwhitespace/
---
## XmlSignificantWhitespace classe


Représente l’espace blanc entre le balisage dans un nœud à contenu mixte ou l’espace blanc à l’intérieur d’une portée **xml:space='preserve'**. Ceci est également appelé espace blanc significatif.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Renvoie l'ensemble d'informations de validation post-schéma qui a été assigné à ce nœud suite à la validation du schéma. |
| [String](../../system/string/) [get_Value](./get_value/)() override | Renvoie la valeur du nœud. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| [SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<[SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\>\>\> [GetEnumerator](../xmlnode/getenumerator/)() override | Renvoie un énumérateur qui itère à travers les nœuds enfants du nœud actuel. |
...
| virtual void [InsertData](../xmlcharacterdata/insertdata/)(**int32_t**, [String](../../system/string/)) | Insère la chaîne spécifiée à l'offset caractère indiqué. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Place tous les nœuds [XmlText](../xmltext/) dans toute la profondeur du sous-arbre sous ce [XmlNode](../xmlnode/) en forme "normale" où seul le balisage (c’est-à-dire les balises, commentaires, instructions de traitement, sections CDATA et références d’entité) sépare les nœuds [XmlText](../xmltext/), c’est-à-dire qu’il n’y a pas de nœuds [XmlText](../xmltext/) adjacents. |
