...
description: Tableau d'objets chaînes atomisées.
type: docs
weight: 313
url: /fr/system.xml/xmlnametable/
---
## XmlNameTable classe

Tableau d'objets chaînes atomisées.
...
| Méthode | Description |
| --- | --- |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Lorsqu'elle est remplacée dans une classe dérivée, atomise la chaîne spécifiée et l'ajoute au [XmlNameTable](./). |
| virtual const [String](../../system/string/)\& [Add](./add/)(const [String](../../system/string/)\&) | Lorsqu'elle est remplacée dans une classe dérivée, atomise la chaîne spécifiée et l'ajoute au [XmlNameTable](./). |
...
| virtual const [String](../../system/string/)\& [Get](./get/)(const [ArrayPtr](../../system/arrayptr/)\<char16_t\>\&, **int32_t**, **int32_t**) | Lorsqu'elle est remplacée dans une classe dérivée, obtient la chaîne atomisée contenant les mêmes caractères que la plage spécifiée de caractères dans le tableau donné. |
| virtual const [String](../../system/string/)\& [Get](./get/)(const [String](../../system/string/)\&) | Lorsqu'elle est remplacée dans une classe dérivée, obtient la chaîne atomisée contenant la même valeur que la chaîne spécifiée. |
