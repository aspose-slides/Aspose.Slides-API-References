...
description: Représente un élément.
type: docs
weight: 222
url: /fr/system.xml/xmlelement/
---
## XmlElement classe
...
| virtual [String](../../system/string/) [get_BaseURI](../xmlnode/get_baseuri/)() | Renvoie l'URI de base du nœud actuel. |
...
| virtual **bool** [get_HasAttributes](./get_hasattributes/)() | Renvoie une valeur **bool** indiquant si le nœud actuel possède des attributs. |
...
| [String](../../system/string/) [get_InnerText](./get_innertext/)() override | Renvoie les valeurs concaténées du nœud et de tous ses enfants. |
| [String](../../system/string/) [get_InnerXml](./get_innerxml/)() override | Renvoie le balisage représentant uniquement les enfants de ce nœud. |
| **bool** [get_IsEmpty](./get_isempty/)() | Renvoie le format de balise de l'élément. |
| virtual **bool** [get_IsReadOnly](../xmlnode/get_isreadonly/)() | Renvoie une valeur indiquant si le nœud est en lecture seule. |
...
| [String](../../system/string/) [get_NamespaceURI](./get_namespaceuri/)() override | Renvoie l'URI de l'espace de noms de ce nœud. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](./get_ownerdocument/)() override | Renvoie le [XmlDocument](../xmldocument/) auquel ce nœud appartient. |
...
| [String](../../system/string/) [get_Prefix](./get_prefix/)() override | Renvoie le préfixe de l'espace de noms de ce nœud. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_PreviousSibling](../xmlnode/get_previoussibling/)() | Renvoie le nœud immédiatement précédant ce nœud. |
...
| [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](./get_schemainfo/)() override | Renvoie l'ensemble d'informations post-validation de schéma qui a été attribué à ce nœud à la suite de la validation du schéma. |
| virtual [String](../../system/string/) [get_Value](../xmlnode/get_value/)() | Renvoie la valeur du nœud. |
| virtual [String](../../system/string/) [GetAttribute](./getattribute/)([String](../../system/string/)) | Renvoie la valeur de l'attribut portant le nom spécifié. |
| virtual [String](../../system/string/) [GetAttribute](./getattribute/)([String](../../system/string/), [String](../../system/string/)) | Renvoie la valeur de l'attribut portant le nom local et l'URI d'espace de noms spécifiés. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [GetAttributeNode](./getattributenode/)([String](../../system/string/)) | Renvoie le [XmlAttribute](../xmlattribute/) avec le nom spécifié. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [GetAttributeNode](./getattributenode/)([String](../../system/string/), [String](../../system/string/)) | Renvoie le [XmlAttribute](../xmlattribute/) avec le nom local et l'URI d'espace de noms spécifiés. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [GetElementsByTagName](./getelementsbytagname/)([String](../../system/string/)) | Renvoie un [XmlNodeList](../xmlnodelist/) contenant une liste de tous les éléments descendants correspondant au [XmlElement::get_Name](./get_name/) spécifié. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNodeList](../xmlnodelist/)\> [GetElementsByTagName](./getelementsbytagname/)([String](../../system/string/), [String](../../system/string/)) | Renvoie un [XmlNodeList](../xmlnodelist/) contenant une liste de tous les éléments descendants correspondant aux valeurs [XmlElement::get_LocalName](./get_localname/) et [XmlElement::get_NamespaceURI](./get_namespaceuri/) spécifiées. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Recherche la déclaration **xmlns** la plus proche pour le préfixe donné qui est en portée du nœud actuel et renvoie l'URI d'espace de noms de la déclaration. |
...
| virtual **bool** [HasAttribute](./hasattribute/)([String](../../system/string/)) | Détermine si le nœud actuel possède un attribut portant le nom spécifié. |
| virtual **bool** [HasAttribute](./hasattribute/)([String](../../system/string/), [String](../../system/string/)) | Détermine si le nœud actuel possède un attribut portant le nom local et l'URI d'espace de noms spécifiés. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](./)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/)) | Renvoie le premier élément enfant avec le [XmlNode::get_Name](../xmlnode/get_name/) spécifié. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlElement](./)\> [idx_get](../xmlnode/idx_get/)([String](../../system/string/), [String](../../system/string/)) | Renvoie le premier élément enfant avec les valeurs [XmlNode::get_LocalName](../xmlnode/get_localname/) et [XmlNode::get_NamespaceURI](../xmlnode/get_namespaceuri/) spécifiées. |
...
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Applique une fonction de transformation à chaque élément d'une séquence générique et renvoie la valeur maximale résultante. |
| ResultType [LINQ_Max](../../system.collections.generic/ienumerable/linq_max/)(const [Func](../../system/func/)\<Source, ResultType\>\&) |  |
| ResultType [LINQ_Min](../../system.collections.generic/ienumerable/linq_min/)(const [Func](../../system/func/)\<T, ResultType\>\&) | Applique une fonction de transformation à chaque élément d'une séquence générique et renvoie la valeur minimale résultante. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Place tous les nœuds [XmlText](../xmltext/) dans toute la profondeur du sous-arbre sous ce [XmlNode](../xmlnode/) en une forme « normale » où seul le balisage (c'est-à-dire les balises, commentaires, instructions de traitement, sections CDATA et références d'entité) sépare les nœuds [XmlText](../xmltext/), c’est-à-dire qu'il n’y a pas de nœuds [XmlText](../xmltext/) adjacents. |
|  [Object](../../system/object/object/)() | Crée l'objet. Initialise toutes les structures de données internes. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, initialise simplement un nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, initialise simplement un nouvel objet et permet la construction par copie des sous-classes. |
...
| void [RemoveAll](./removeall/)() override | Supprime tous les attributs et enfants spécifiés du nœud actuel. Les attributs par défaut ne sont pas supprimés. |
| virtual void [RemoveAllAttributes](./removeallattributes/)() | Supprime tous les attributs spécifiés de l'élément. Les attributs par défaut ne sont pas supprimés. |
| virtual void [RemoveAttribute](./removeattribute/)([String](../../system/string/)) | Supprime un attribut par son nom. |
| virtual void [RemoveAttribute](./removeattribute/)([String](../../system/string/), [String](../../system/string/)) | Supprime un attribut avec le nom local et l'URI d'espace de noms spécifiés. (Si l'attribut supprimé a une valeur par défaut, elle est immédiatement remplacée). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [RemoveAttributeAt](./removeattributeat/)(**int32_t**) | Supprime le nœud d'attribut avec l'index spécifié de l'élément. (Si l'attribut supprimé a une valeur par défaut, elle est immédiatement remplacée). |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [RemoveAttributeNode](./removeattributenode/)([SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>) | Supprime le [XmlAttribute](../xmlattribute/) spécifié. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [RemoveAttributeNode](./removeattributenode/)([String](../../system/string/), [String](../../system/string/)) | Supprime le [XmlAttribute](../xmlattribute/) spécifié par le nom local et l'URI d'espace de noms. (Si l'attribut supprimé a une valeur par défaut, elle est immédiatement remplacée). |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&) | Sélectionne le premier [XmlNode](../xmlnode/) correspondant à l'expression [XPath](../../system.xml.xpath/). |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [SelectSingleNode](../xmlnode/selectsinglenode/)(const [String](../../system/string/)\&, const [SharedPtr](../../system/sharedptr/)\<[XmlNamespaceManager](../xmlnamespacemanager/)\>\&) | Sélectionne le premier [XmlNode](../xmlnode/) correspondant à l'expression [XPath](../../system.xml.xpath/). Tous les préfixes trouvés dans l'expression [XPath](../../system.xml.xpath/) sont résolus à l'aide du [XmlNamespaceManager](../xmlnamespacemanager/) fourni. |
| void [set_InnerText](./set_innertext/)([String](../../system/string/)) override | Définit les valeurs concaténées du nœud et de tous ses enfants. |
| void [set_InnerXml](./set_innerxml/)([String](../../system/string/)) override | Définit le balisage représentant uniquement les enfants de ce nœud. |
| void [set_IsEmpty](./set_isempty/)(**bool**) | Définit le format de balise de l'élément. |
| void [set_Prefix](./set_prefix/)([String](../../system/string/)) override | Définit le préfixe de l'espace de noms de ce nœud. |
| virtual void [set_Value](../xmlnode/set_value/)([String](../../system/string/)) | Définit la valeur du nœud. |
| virtual void [SetAttribute](./setattribute/)([String](../../system/string/), [String](../../system/string/)) | Définit la valeur de l'attribut portant le nom spécifié. |
| virtual [String](../../system/string/) [SetAttribute](./setattribute/)([String](../../system/string/), [String](../../system/string/), [String](../../system/string/)) | Définit la valeur de l'attribut portant le nom local et l'URI d'espace de noms spécifiés. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [SetAttributeNode](./setattributenode/)([SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\>) | Ajoute le [XmlAttribute](../xmlattribute/) spécifié. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlAttribute](../xmlattribute/)\> [SetAttributeNode](./setattributenode/)([String](../../system/string/), [String](../../system/string/)) | Ajoute le [XmlAttribute](../xmlattribute/) spécifié. |
...
| void [WriteTo](./writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Enregistre le nœud actuel dans le [XmlWriter](../xmlwriter/) spécifié. |
