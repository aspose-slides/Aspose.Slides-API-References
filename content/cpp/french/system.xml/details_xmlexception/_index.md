...
description: Renvoie des informations détaillées sur la dernière exception.
type: docs
weight: 1
url: /fr/system.xml/details_xmlexception/
---
## Details_XmlException classe

Renvoie des informations détaillées sur la dernière exception.
...
| **int32_t** [get_LineNumber](./get_linenumber/)() | Renvoie le numéro de ligne indiquant où l'erreur s'est produite. Les numéros de ligne commencent à 1. |
| **int32_t** [get_LinePosition](./get_lineposition/)() | Renvoie la position de ligne indiquant où l'erreur s'est produite. La position de ligne commence à 1. |
| [String](../../system/string/) [get_Message](./get_message/)() const override | Renvoie un message décrivant l'exception actuelle. |
| [String](../../system/string/) [get_SourceUri](./get_sourceuri/)() | Renvoie l'emplacement du fichier XML. |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le nᶦᵉᵐᵉ argument de modèle comme pointeur faible (plutôt que partagé). Permet de basculer les pointeurs dans les conteneurs en mode faible. |
