...
description: "Fournit des données pour les événements XmlDocument::NodeChanged, XmlDocument::NodeChanging, XmlDocument::NodeInserted, XmlDocument::NodeInserting, XmlDocument::NodeRemoved et XmlDocument::NodeRemoving."
type: docs
weight: 339
url: /fr/system.xml/xmlnodechangedeventargs/
---
...
| [XmlNodeChangedAction](../xmlnodechangedaction/) [get_Action](./get_action/)() | Renvoie une valeur indiquant le type d'événement de modification de nœud en cours. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_NewParent](./get_newparent/)() | Renvoie la valeur de [XmlNode::get_ParentNode](../xmlnode/get_parentnode/) après la fin de l'opération. |
| [String](../../system/string/) [get_NewValue](./get_newvalue/)() | Renvoie la nouvelle valeur du nœud. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_Node](./get_node/)() | Renvoie le [XmlNode](../xmlnode/) qui est ajouté, retiré ou modifié. |
| [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_OldParent](./get_oldparent/)() | Renvoie la valeur du [XmlNode::get_ParentNode](../xmlnode/get_parentnode/) avant le début de l'opération. |
| [String](../../system/string/) [get_OldValue](./get_oldvalue/)() | Renvoie la valeur originale du nœud. |
