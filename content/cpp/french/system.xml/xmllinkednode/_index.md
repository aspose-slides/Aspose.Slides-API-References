...
description: Retourne le nœud immédiatement précédent ou suivant ce nœud.
type: docs
weight: 274
url: /fr/system.xml/xmllinkednode/
---
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [Clone](../xmlnode/clone/)() | Crée un double de ce nœud. |
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [CloneNode](../xmlnode/clonenode/)(**bool**) | Crée un double du nœud, lorsqu'il est redéfini dans une classe dérivée. |
...
| virtual [String](../../system/string/) [get_LocalName](../xmlnode/get_localname/)() | Renvoie le nom local du nœud, lorsqu'il est redéfini dans une classe dérivée. |
| virtual [String](../../system/string/) [get_Name](../xmlnode/get_name/)() | Renvoie le nom qualifié du nœud, lorsqu'il est redéfini dans une classe dérivée. |
...
| virtual [XmlNodeType](../xmlnodetype/) [get_NodeType](../xmlnode/get_nodetype/)() | Renvoie le type du nœud actuel, lorsqu'il est redéfini dans une classe dérivée. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlDocument](../xmldocument/)\> [get_OwnerDocument](../xmlnode/get_ownerdocument/)() | Renvoie le [XmlDocument](../xmldocument/) auquel appartient ce nœud. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Renvoie l'ensemble d'informations post-validation de schéma qui a été assigné à ce nœud suite à la validation de schéma. |
...
| virtual [String](../../system/string/) [GetNamespaceOfPrefix](../xmlnode/getnamespaceofprefix/)([String](../../system/string/)) | Recherche la déclaration **xmlns** la plus proche pour le préfixe donné qui est dans la portée du nœud actuel et renvoie l'URI d'espace de noms dans la déclaration. |
| virtual [String](../../system/string/) [GetPrefixOfNamespace](../xmlnode/getprefixofnamespace/)([String](../../system/string/)) | Recherche la déclaration **xmlns** la plus proche pour l'URI d'espace de noms donné qui est dans la portée du nœud actuel et renvoie le préfixe défini dans cette déclaration. |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Place tous les nœuds [XmlText](../xmltext/) dans la pleine profondeur du sous-arbre sous ce [XmlNode](../xmlnode/) dans une forme "normale" où seul le balisage (c’est-à-dire les balises, commentaires, instructions de traitement, sections CDATA et références d’entité) sépare les nœuds [XmlText](../xmltext/), c’est-à-dire qu’il n’y a aucun nœud [XmlText](../xmltext/) adjacent. |
...
| virtual void [WriteContentTo](../xmlnode/writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Enregistre tous les nœuds enfants du nœud dans le [XmlWriter](../xmlwriter/) spécifié, lorsqu'il est redéfini dans une classe dérivée. |
| virtual void [WriteTo](../xmlnode/writeto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) | Enregistre le nœud actuel dans le [XmlWriter](../xmlwriter/) spécifié, lorsqu'il est redéfini dans une classe dérivée. |
