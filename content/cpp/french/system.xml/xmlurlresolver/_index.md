...
description: Résout les ressources XML externes nommées par un Uniform Resource Identifier (URI).
type: docs
weight: 534
url: /fr/system.xml/xmlurlresolver/
---
...
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetEntity](./getentity/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), const [TypeInfo](../../system/typeinfo/)\&) override | Mappe une URI à un objet contenant la ressource réelle. |
...
| void [set_CachePolicy](./set_cachepolicy/)(const [SharedPtr](../../system/sharedptr/)\<[Net::Cache::RequestCachePolicy](../../system.net.cache/requestcachepolicy/)\>\&) | Définit la politique de cache pour l’objet WebRequest sous-jacent. |
...
| void [set_Proxy](./set_proxy/)(const [SharedPtr](../../system/sharedptr/)\<[Net::IWebProxy](../../system.net/iwebproxy/)\>\&) | Définit le proxy réseau pour l’objet WebRequest sous-jacent. |
