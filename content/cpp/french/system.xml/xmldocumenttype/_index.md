...
description: Représente la déclaration de type de document.
type: docs
weight: 209
url: /fr/system.xml/xmldocumenttype/
---
...
| [iterator](../../system.collections.generic/ienumerable/iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() | Obtient un itérateur pointant sur le premier élément (s'il existe) de la collection. Cet itérateur ne peut pas être utilisé pour modifier un objet référencé car [GetEnumerator()](../../system.collections.generic/ienumerable/getenumerator/) renvoie un objet copie de T. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtient un itérateur pointant sur le premier élément (s'il existe) de l'instance const-qualified de la collection. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Obtient un itérateur pointant sur le premier élément const-qualified (s'il existe) de la collection. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cend](../../system.collections.generic/ienumerable/cend/)() const | Obtient un itérateur pointant juste après le dernier élément const-qualified (s'il existe) de la collection. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [end](../../system.collections.generic/ienumerable/end/)() const | Obtient un itérateur pointant juste après le dernier élément (s'il existe) de l'instance const-qualified de la collection. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Entities](./get_entities/)() | Renvoie la collection de nœuds [XmlEntity](../xmlentity/) déclarés dans la déclaration de type de document. |
...
| [String](../../system/string/) [get_InternalSubset](./get_internalsubset/)() | Renvoie la valeur du sous-ensemble interne de la définition de type de document (DTD) dans la déclaration DOCTYPE. |
...
| [SharedPtr](../../system/sharedptr/)\<[XmlNamedNodeMap](../xmlnamednodemap/)\> [get_Notations](./get_notations/)() | Renvoie la collection de nœuds [XmlNotation](../xmlnotation/) présents dans la déclaration de type de document. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [get_ParentNode](../xmlnode/get_parentnode/)() | Renvoie le parent de ce nœud (pour les nœuds pouvant avoir un parent). |
...
| [String](../../system/string/) [get_PublicId](./get_publicid/)() | Renvoie la valeur de l'identifiant public dans la déclaration DOCTYPE. |
| virtual [SharedPtr](../../system/sharedptr/)\<[Schema::IXmlSchemaInfo](../../system.xml.schema/ixmlschemainfo/)\> [get_SchemaInfo](../xmlnode/get_schemainfo/)() | Renvoie l'ensemble d'informations post-validation du schéma qui a été assigné à ce nœud suite à la validation du schéma. |
| [String](../../system/string/) [get_SystemId](./get_systemid/)() | Renvoie la valeur de l'identifiant système dans la déclaration DOCTYPE. |
...
| int [LINQ_Count](../../system.collections.generic/ienumerable/linq_count/)() | Renvoie le nombre d’éléments dans la séquence (calculé via comptage direct). |
...
| virtual void [Normalize](../xmlnode/normalize/)() | Place tous les nœuds [XmlText](../xmltext/) à toute profondeur du sous-arbre sous ce [XmlNode](../xmlnode/) dans une forme \"normale\" où seul le balisage (c’est-à-dire les balises, commentaires, instructions de traitement, sections CDATA et références d’entité) sépare les nœuds [XmlText](../xmltext/), c’est-à-dire qu’il n’y a pas de nœuds [XmlText](../xmltext/) adjacents. |
...
| void [WriteContentTo](./writecontentto/)(const [SharedPtr](../../system/sharedptr/)\<[XmlWriter](../xmlwriter/)\>\&) override | Enregistre tous les enfants du nœud dans le [XmlWriter](../xmlwriter/) spécifié. Pour les nœuds [XmlDocumentType](./), cette méthode n’a aucun effet. |
