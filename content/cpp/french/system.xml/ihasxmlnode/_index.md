...
description: Permet à une classe de renvoyer un XmlNode depuis le contexte ou la position actuelle.
type: docs
weight: 27
url: /fr/system.xml/ihasxmlnode/
---
## IHasXmlNode classe

Permet à une classe de renvoyer un [XmlNode](../xmlnode/) depuis le contexte ou la position actuelle.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[XmlNode](../xmlnode/)\> [GetNode](./getnode/)() | Renvoie le [XmlNode](../xmlnode/) pour la position actuelle. |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie en réalité rien, il initialise seulement un nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie en réalité rien, il initialise seulement un nouvel objet et permet la construction par copie des sous-classes. |
