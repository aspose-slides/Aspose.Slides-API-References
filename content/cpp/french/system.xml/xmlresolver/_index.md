...
description: Résout les ressources XML externes nommées par un Identifiant Uniforme de Ressource (URI).
type: docs
weight: 456
url: /fr/system.xml/xmlresolver/
---
## XmlResolver classe

Résout les ressources XML externes nommées par un Identifiant Uniforme de Ressource (URI).
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [GetEntity](./getentity/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/), const [TypeInfo](../../system/typeinfo/)\&) | Lorsqu'elle est redéfinie dans une classe dérivée, associe un URI à un objet contenant la ressource réelle. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\> [ResolveUri](./resolveuri/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, [String](../../system/string/)) | Lorsqu'elle est redéfinie dans une classe dérivée, résout l'URI absolu à partir des URI de base et relatifs. |
| virtual void [set_Credentials](./set_credentials/)([SharedPtr](../../system/sharedptr/)\<[Net::ICredentials](../../system.net/icredentials/)\>) | Lorsqu'elle est redéfinie dans une classe dérivée, définit les informations d'identification utilisées pour authentifier les requêtes web. |
...
| virtual **bool** [SupportsType](./supportstype/)([SharedPtr](../../system/sharedptr/)\<[Uri](../../system/uri/)\>, const [TypeInfo](../../system/typeinfo/)\&) | Permet au résolveur de retourner des types autres que Stream. |
