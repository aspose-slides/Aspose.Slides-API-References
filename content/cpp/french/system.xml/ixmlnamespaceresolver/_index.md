...
description: Fournit un accès en lecture seule à un ensemble de préfixes et de mappages d'espaces de noms.
type: docs
weight: 53
url: /fr/system.xml/ixmlnamespaceresolver/
---
## IXmlNamespaceResolver classe


Fournit un accès en lecture seule à un ensemble de préfixes et de mappages d'espaces de noms.
...
| virtual [String](../../system/string/) [LookupNamespace](./lookupnamespace/)(const [String](../../system/string/)\&) | Renvoie l'URI d'espace de noms associé au préfixe spécifié. |
| virtual [String](../../system/string/) [LookupPrefix](./lookupprefix/)(const [String](../../system/string/)\&) | Renvoie le préfixe qui est associé à l'URI d'espace de noms spécifié. |
