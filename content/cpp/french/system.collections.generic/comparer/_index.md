...
description: Fournit une classe de base pour les implémentations de l'interface générique System.Collections.Generic.IComparer.
type: docs
weight: 105
url: /fr/system.collections.generic/comparer/
---
## Comparer classe

Fournit une classe de base pour les implémentations de l'interface générique [System.Collections.Generic.IComparer](../icomparer/).
...
| --- | --- |
| T | Le type des objets à comparer. |
## Méthodes

| Méthode | Description |
| --- | --- |
| virtual int [Compare](../icomparer/compare/)([args_type](../icomparer/args_type/), [args_type](../icomparer/args_type/)) const | [Comparison](../../system/comparison/) fonction. |
...
| static [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\> [get_Default](./get_default/)() | Renvoie un comparateur d'ordre de tri par défaut pour le type spécifié par l'argument générique. |
