...
description: Pointeur de file d'attente. Ce type est un pointeur permettant de gérer la suppression d'un autre objet. Il doit être alloué sur la pile et passé aux fonctions soit par valeur, soit par référence const.
type: docs
weight: 482
url: /fr/system.collections.generic/queueptr/
---
## QueuePtr classe

[Queue](../queue/) pointeur. Ce type est un pointeur permettant de gérer la suppression d'un autre objet. Il doit être alloué sur la pile et transmis aux fonctions soit par valeur, soit par référence const.
...
| Méthode | Description |
| --- | --- |
| auto [begin](../../system/smartptr/begin/)() | Accesseur de la méthode [begin()](../../system/smartptr/begin/) d'une collection sous-jacente. Ne compile que si SmartPtr_ est un type de spécialisation avec la méthode [begin()](../../system/smartptr/begin/). |
| auto [begin](../../system/smartptr/begin/)() const | Accesseur de la méthode [begin()](../../system/smartptr/begin/) d'une collection sous-jacente. Ne compile que si SmartPtr_ est un type de spécialisation avec la méthode [begin()](../../system/smartptr/begin/). |
...
| std::enable_if_t<\!Check::value\&&\!std::is_same\<Y, T\>::value\&&\!std::is_base_of\<Y, T\>::value, [SmartPtr](../../system/smartptr/)\<Y\>\> [Cast](../../system/smartptr/cast/)() const | Convertit le pointeur en type dérivé avec dynamic_cast. |
| auto [cbegin](../../system/smartptr/cbegin/)() const | Accesseur de la méthode [cbegin()](../../system/smartptr/cbegin/) d'une collection sous-jacente. Ne compile que si SmartPtr_ est un type de spécialisation avec la méthode [cbegin()](../../system/smartptr/cbegin/). |
| auto [cend](../../system/smartptr/cend/)() const | Accesseur de la méthode [cend()](../../system/smartptr/cend/) d'une collection sous-jacente. Ne compile que si SmartPtr_ est un type de spécialisation avec la méthode [cend()](../../system/smartptr/cend/). |
...
| auto [end](../../system/smartptr/end/)() | Accesseur de la méthode [end()](../../system/smartptr/end/) d'une collection sous-jacente. Ne compile que si SmartPtr_ est un type de spécialisation avec la méthode [end()](../../system/smartptr/end/). |
| auto [end](../../system/smartptr/end/)() const | Accesseur de la méthode [end()](../../system/smartptr/end/) d'une collection sous-jacente. Ne compile que si SmartPtr_ est un type de spécialisation avec la méthode [end()](../../system/smartptr/end/). |
| [Pointee_](../../system/smartptr/pointee_/) * [get](../../system/smartptr/get/)() const | Renvoie l'objet pointé. |
| [SmartPtrMode](../../system/smartptrmode/) [get_Mode](../../system/smartptr/get_mode/)() const | Renvoie le mode du pointeur. |
| [Pointee_](../../system/smartptr/pointee_/) * [get_shared](../../system/smartptr/get_shared/)() const | Renvoie l'objet pointé, mais vérifie que le pointeur est en mode partagé. |
| int [get_shared_count](../../system/smartptr/get_shared_count/)() const | Renvoie le nombre de pointeurs partagés existants vers l'objet référencé, y compris celui courant. Vérifie que le pointeur actuel est en mode partagé. |
| int [GetHashCode](../../system/smartptr/gethashcode/)() const | Appelle [GetHashCode()](../../system/smartptr/gethashcode/) sur l'objet pointé. |
| T * [GetObjectNotNull](../../system/smartptr/getobjectnotnull/)() const | Renvoie l'objet actuellement référencé (s'il existe) ou lève une exception. |
| [Object](../../system/object/) * [GetObjectOrNull](../../system/smartptr/getobjectornull/)() const | Renvoie l'objet pointé (s'il existe) ou nullptr. Identique à [get()](../../system/smartptr/get/). |
| [Object](../../system/object/) * [GetObjectOwner](../../system/smartptr/getobjectowner/)() const | Renvoie l'objet référencé. |
| [Pointee_](../../system/smartptr/pointee_/) * [GetPointer](../../system/smartptr/getpointer/)() const | Renvoie l'objet pointé (s'il existe) ou nullptr. Identique à [get()](../../system/smartptr/get/). |
...
| [Pointee_](../../system/smartptr/pointee_/)\& [operator*](../../system/smartptr/operator_star/)() const | Renvoie une référence à l'objet pointé. Vérifie que le pointeur n'est pas nul. |
...
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&) | Effectue l'assignation par déplacement de l'objet [SmartPtr](../../system/smartptr/). x devient inutilisable. |
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr_](../../system/smartptr/smartptr_/)\&) | Effectue l'assignation par copie de l'objet [SmartPtr](../../system/smartptr/). |
| [SmartPtr_](../../system/smartptr/smartptr_/)\& [operator=](../../system/smartptr/operator_equal/)(const [SmartPtr](../../system/smartptr/)\<Q\>\&) | Effectue l'assignation par copie de l'objet [SmartPtr](../../system/smartptr/). Effectue les conversions de type nécessaires. |
...
| [QueuePtr](./queueptr/)(const [SharedPtr](../../system/sharedptr/)\<[Queue](../queue/)\<T\>\>\&) | Construit un pointeur vers une file d'attente spécifique. |
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | Supprime l'alias (créé par un constructeur d'alias) du pointeur, en veillant à ce qu'il gère (si partagé) ou suive (si faible) le même objet auquel il pointe. |
...
| explicit  [SmartPtr](../../system/smartptr/smartptr/)(const [SmartPtr](../../system/smartptr/)\<[Array](../../system/array/)\<Y\>\>\&, [SmartPtrMode](../../system/smartptrmode/)) | Convertit le type du tableau référencé en créant un nouveau tableau d'un type différent. Utile si en C# il existe une conversion de type de tableau non prise en charge en C++. |
