...
description: "Interface d'une collection d'éléments. Les objets de cette classe ne doivent être alloués qu'en utilisant la fonction System::MakeObject(). Ne créez jamais d'instance de ce type sur la pile ou avec l'opérateur new, car cela entraînera des erreurs d'exécution et/ou des défauts d'assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu'argument."
type: docs
weight: 248
url: /fr/system.collections.generic/icollection/
---
## ICollection classe
...
| Méthode | Description |
| --- | --- |
| virtual void [Add](./add/)(const T\&) | Ajoute un élément à la collection. |
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Obtient un itérateur pointant vers le premier élément (le cas échéant) de la collection. Cet itérateur ne peut pas être utilisé pour modifier l'objet référencé parce que [GetEnumerator()](../ienumerable/getenumerator/) renvoie un objet copie de T. |
...
| virtual **bool** [Contains](./contains/)(const T\&) const | Vérifie si l'élément est présent dans la collection. |
| virtual void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copie tous les éléments de la collection dans des éléments de tableau existants. |
...
| virtual int [get_Count](./get_count/)() const | Obtient le nombre d'éléments dans la collection. |
| virtual **bool** [get_IsReadOnly](./get_isreadonly/)() const | Vérifie si la collection est en lecture seule. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](./get_syncroot/)() const | Obtient l'objet avec lequel la collection est synchronisée. |
...
| [SharedPtr](../../system/sharedptr/)\<[List](../list/)\<T\>\> [LINQ_ToList](../ienumerable/linq_tolist/)() | Crée un List<T> à partir d'une séquence. |
...
| [ICollection](./)\& [operator=](./operator_equal/)([ICollection](./)\&&) | Opérateur d'affectation par déplacement. |
| [ICollection](./)\& [operator=](./operator_equal/)(const [ICollection](./)\&) | Opérateur d'affectation par déplacement. |
...
| virtual **bool** [Remove](./remove/)(const T\&) | Supprime l'élément de la collection. |
...
| virtual  [~Object](../../system/object/~object/)() | Detruit l'objet. Libère toutes les structures de données internes. |

## Alias de type

| Alias de type | Description |
| --- | --- |
| [ValueType](./valuetype/) | Nom du type valeur. |
| [ThisType](./thistype/) | Nom du type collection. |
