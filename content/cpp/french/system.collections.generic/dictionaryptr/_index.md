...
description: Classe pointeur de dictionnaire avec surcharge d'opérateurs. Ce type est un pointeur permettant de gérer la suppression d'un autre objet. Il doit être alloué sur la pile et transmis aux fonctions soit par valeur, soit par référence const.
type: docs
weight: 170
url: /fr/system.collections.generic/dictionaryptr/
---
## DictionaryPtr classe

[Dictionary](../dictionary/) classe pointeur avec surcharge d'opérateurs. Ce type est un pointeur permettant de gérer la suppression d'un autre objet. Il doit être alloué sur la pile et transmis aux fonctions soit par valeur, soit par référence const.
...
| [DictionaryPtr](./dictionaryptr/)(const [SharedPtr](../../system/sharedptr/)\<[Dictionary](../dictionary/)\<T, V\>\>\&) | Convertit le type du pointeur. |
...
| V\& [operator[]](./operator[]/)(const X\&) const | Opérateur d'accès pour travailler avec la conversion du type clé. |
| V\& [operator[]](./operator[]/)(const T\&) const | Opérateur d'accès. |
| [SmartPtr_](../../system/smartptr/smartptr_/) [RemoveAliasing](../../system/smartptr/removealiasing/)() const | Supprime l'aliasage (créé par un constructeur d'alias) du pointeur, en s'assurant qu'il gère (en mode partagé) ou suit (en mode faible) le même objet auquel il pointe. |
...
| [SmartPtr](../../system/smartptr/smartptr/)([SmartPtr_](../../system/smartptr/smartptr_/)\&&, [SmartPtrMode](../../system/smartptrmode/)) | Construit par déplacement un objet [SmartPtr](../../system/smartptr/). Concrètement, échange deux pointeurs s'ils sont tous deux du même mode. x peut devenir inutilisable après l'appel. |
