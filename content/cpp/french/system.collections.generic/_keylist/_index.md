...
description: "Implémente la liste des clés d’un dictionnaire. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction System::MakeObject(). Ne créez jamais d’instance de ce type sur la pile ou en utilisant l’opérateur new, car cela entraînera des erreurs d’exécution et/ou des fautes d’assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu’argument."
type: docs
weight: 14
url: /fr/system.collections.generic/_keylist/
---
## _KeyList classe

Implémente une liste des clés d’un dictionnaire. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d’instance de ce type sur la pile ou en utilisant l’opérateur new, car cela entraînera des erreurs d’exécution et/ou des fautes d’assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le passer aux fonctions en tant qu’argument.
...
| Méthode | Description |
| --- | --- |
| [_KeyCollection](../_keycollection/_keycollection/)(const typename Dict::Ptr\&) | Initialise la collection en référant le dictionnaire spécifié. |
| [_KeyList](./_keylist/)(const typename Dict::Ptr\&) | Initialise la collection en référant le dictionnaire spécifié. |
...
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Renvoie un itérateur pointant sur le premier élément (le cas échéant) de la collection. Cet itérateur ne peut pas être utilisé pour modifier l’objet référencé car [GetEnumerator()](../ienumerable/getenumerator/) renvoie une copie de T. |
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Renvoie un itérateur pointant sur le premier élément (le cas échéant) de l’instance en lecture seule de la collection. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Renvoie un itérateur pointant sur le premier élément en lecture seule (le cas échéant) de la collection. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Renvoie un itérateur pointant juste après le dernier élément en lecture seule (le cas échéant) de la collection. |
| void [Clear](../ikvcollection/clear/)() override | Supprime tous les éléments du conteneur. |
| **bool** [Contains](./contains/)(const [TKey](../_keycollection/tkey/)\&) const override | Vérifie si la clé spécifiée est présente dans la collection. |
| void [CopyTo](../basekvcollection/copyto/)([ArrayPtr](../../system/arrayptr/)\<KV\>, int) override | Copie les données dans les éléments existants du tableau. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Renvoie un itérateur pointant juste après le dernier élément (le cas échéant) de la collection. Cet itérateur ne peut pas être utilisé pour modifier l’objet référencé car [GetEnumerator()](../ienumerable/getenumerator/) renvoie une copie de T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Renvoie un itérateur pointant juste après le dernier élément (le cas échéant) de l’instance en lecture seule de la collection. |
...
| int [get_Count](../basekvcollection/get_count/)() const override | Renvoie le nombre d’éléments. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Indique si la collection a une taille fixe. |
| **bool** [get_IsReadOnly](../ikvcollection/get_isreadonly/)() const override | Indique si le conteneur est en lecture seule. |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../icollection/get_syncroot/)() const | Renvoie l’objet avec lequel la collection est synchronisée. |
...
| [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<[TKey](../_keycollection/tkey/)\>\> [GetEnumerator](../_keycollection/getenumerator/)() override | Renvoie un énumérateur parcourant les clés. |
...
| [TKey](../_keycollection/tkey/) [idx_get](./idx_get/)(int) const override | Renvoie la clé à la position spécifiée. |
| void [idx_set](../ikvcollection/idx_set/)(int, T) override | Fonction de mutateur. |
| int [IndexOf](../ikvcollection/indexof/)(const T\&) const override | Renvoie l’indice de l’élément dans le conteneur. |
| void [Insert](../ikvcollection/insert/)(int, const T\&) override | Insère un élément à la position spécifiée. |
...
| **bool** [LINQ_Any](../ienumerable/linq_any/)() | Détermine si une séquence contient au moins un élément. |
...
| T [LINQ_ElementAt](../ienumerable/linq_elementat/)(int) | Retourne l’élément à l’indice spécifié dans une séquence. |
| T [LINQ_ElementAtOrDefault](../ienumerable/linq_elementatordefault/)(int) | Retourne l’élément à l’indice spécifié dans une séquence. |
...
| T [LINQ_FirstOrDefault](../ienumerable/linq_firstordefault/)(std::function\<**bool**(T)>) | Retourne le premier élément de la séquence qui satisfait une condition ou une valeur par défaut si aucun élément ne correspond. |
...
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<T, Key\>\&) | Trie les éléments d’une séquence en ordre croissant selon les valeurs de clé sélectionnées par keySelector. |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<Source\>\> [LINQ_OrderBy](../ienumerable/linq_orderby/)(const [Func](../../system/func/)\<Source, Key\>\&) |  |
| [SharedPtr](../../system/sharedptr/)\<[Linq::IOrderedEnumerable](../../system.linq/iorderedenumerable/)\<T\>\> [LINQ_OrderByDescending](../ienumerable/linq_orderbydescending/)(const [Func](../../system/func/)\<T, Key\>\&) | Trie les éléments d’une séquence en ordre décroissant selon les valeurs de clé sélectionnées par keySelector. |
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, il initialise simplement le nouvel objet et permet la construction de copies des sous-classes. |
...
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d’affectation. Ne copie rien, il initialise simplement le nouvel objet et permet la construction de copies des sous-classes. |
| static **bool** [ReferenceEquals](../../system/object/referenceequals/)([ptr](../../system/object/ptr/) const\&, [ptr](../../system/object/ptr/) const\&) | Compare les objets par référence. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, T const\&) | Compare les objets par référence. |
| static std::enable_if<\![IsSmartPtr](../../system/issmartptr/)\<T\>::value, **bool**\>::type [ReferenceEquals](../../system/object/referenceequals/)(T const\&, std::nullptr_t) | Compare un objet de type valeur avec nullptr par référence. |
...
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeBeginConstIterator](../_keycollection/virtualizebeginconstiterator/)() const override | Renvoie l’implémentation de l’itérateur const begin pour le conteneur actuel. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeBeginIterator](../_keycollection/virtualizebeginiterator/)() override | Renvoie l’implémentation de l’itérateur begin pour le conteneur actuel. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeEndConstIterator](../_keycollection/virtualizeendconstiterator/)() const override | Renvoie l’implémentation de l’itérateur const end pour le conteneur actuel. |
| System::Details::VirtualizedIteratorBase\<[TKey](../_keycollection/tkey/)\> * [virtualizeEndIterator](../_keycollection/virtualizeenditerator/)() override | Renvoie l’implémentation de l’itérateur end pour le conteneur actuel. |
