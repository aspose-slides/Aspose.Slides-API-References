...
description: Déclaration anticipée de la classe SortedSet.
type: docs
weight: 573
url: /fr/system.collections.generic/sortedset/
---
## Classe SortedSet
...
| [iterator](../ienumerable/iterator/) [begin](../ienumerable/begin/)() | Obtient un itérateur pointant sur le premier élément (s'il existe) de la collection. Cet itérateur ne peut pas être utilisé pour modifier un objet référencé car [GetEnumerator()](../ienumerable/getenumerator/) renvoie un objet copie de T. |
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Obtient un itérateur pointant sur le premier élément (s'il existe) de l'instance en lecture seule de la collection. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Obtient un itérateur pointant sur le premier élément en lecture seule (s'il existe) de la collection. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Obtient un itérateur pointant immédiatement après le dernier élément en lecture seule (s'il existe) de la collection. |
...
| virtual void [CopyTo](../icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copie tous les éléments de la collection vers les éléments d'un tableau existant. |
| [iterator](../ienumerable/iterator/) [end](../ienumerable/end/)() | Obtient un itérateur pointant immédiatement après le dernier élément (s'il existe) de la collection. Cet itérateur ne peut pas être utilisé pour modifier un objet référencé car [GetEnumerator()](../ienumerable/getenumerator/) renvoie un objet copie de T. |
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Obtient un itérateur pointant immédiatement après le dernier élément (s'il existe) de l'instance en lecture seule de la collection. |
...
| T [get_Max](./get_max/)() const | Obtient la valeur maximale dans le [SortedSet](./). |
...
| virtual void [SetTemplateWeakPtr](../../system/object/settemplateweakptr/)(**uint32_t**) | Définit le n-ième argument de modèle comme un pointeur faible (plutôt que partagé). Autorise le passage des pointeurs des conteneurs en mode faible. |
| int [SharedCount](../../system/object/sharedcount/)() const | Obtient la valeur actuelle du compteur de références partagées. |
| [Object](../../system/object/) * [SharedRefAdded](../../system/object/sharedrefadded/)() | Incrémente le compteur de références partagées. Ne doit pas être appelé directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
| int [SharedRefRemovedSafe](../../system/object/sharedrefremovedsafe/)() | Décrémente et renvoie le compteur de références partagées. Ne doit pas être appelé directement ; utilisez plutôt des pointeurs intelligents ou ThisProtector. |
| [SortedSet](./sortedset/)() | Crée un ensemble vide. |
| [SortedSet](./sortedset/)(int) | Crée un ensemble vide avec la capacité spécifiée. |
| [SortedSet](./sortedset/)(const [SharedPtr](../../system/sharedptr/)\<[IComparer](../icomparer/)\<T\>\>\&) | Crée un ensemble vide qui utilise le comparateur d'égalité spécifié. |
| [SortedSet](./sortedset/)(const [SharedPtr](../../system/sharedptr/)\<[IEnumerable](../ienumerable/)\<T\>\>\&) | Crée [SortedSet](./) basé sur des valeurs énumérables. |
