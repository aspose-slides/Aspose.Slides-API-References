...
| Méthode | Description |
| --- | --- |
| void [Add](./add/)(const T\&) override | Ajoute un élément au conteneur. |
...
| [const_iterator](../ienumerable/const_iterator/) [begin](../ienumerable/begin/)() const | Obtient un itérateur pointant vers le premier élément (s'il existe) de l'instance const de la collection. |
| [const_iterator](../ienumerable/const_iterator/) [cbegin](../ienumerable/cbegin/)() const | Obtient un itérateur pointant vers le premier élément const (s'il existe) de la collection. |
| [const_iterator](../ienumerable/const_iterator/) [cend](../ienumerable/cend/)() const | Obtient un itérateur pointant juste après le dernier élément const (s'il existe) de la collection. |
| void [Clear](./clear/)() override | Supprime tous les éléments du conteneur. |
| **bool** [Contains](./contains/)(const T\&) const override | Vérifie si l'élément est présent dans le conteneur. |
| virtual void [CopyTo](../icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copie tous les éléments de la collection vers des éléments de tableau existants. |
...
| [const_iterator](../ienumerable/const_iterator/) [end](../ienumerable/end/)() const | Obtient un itérateur pointant juste après le dernier élément (s'il existe) de l'instance const de la collection. |
...
| virtual int [get_Count](./get_count/)() const | Obtient le nombre d'éléments dans le conteneur. |
| **bool** [get_IsFixedSize](../ilist/get_isfixedsize/)() | Vérifie si la collection a une taille fixe. |
| **bool** [get_IsReadOnly](./get_isreadonly/)() const override | Vérifie si le conteneur est en lecture seule. |
...
| virtual [SharedPtr](../../system/sharedptr/)\<[IEnumerator](../ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() | Obtient l'énumérateur du conteneur. |
...
| virtual T [idx_get](./idx_get/)(int) const | Fonction d'accès (getter). |
| void [idx_set](./idx_set/)(int, T) override | Fonction de définition (setter). |
| int [IndexOf](./indexof/)(const T\&) const override | Obtient l'index de l'élément dans le conteneur. |
...
| **bool** [Remove](./remove/)(const T\&) override | Supprime l'élément du conteneur. |
