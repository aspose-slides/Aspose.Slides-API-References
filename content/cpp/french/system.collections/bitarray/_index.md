...
| Method | Description |
| --- | --- |
| void [Add](./add/)(const **bool**\&) override | Ajoute la valeur à la fin du conteneur. |
| [BitArrayPtr](../bitarrayptr/) [And](./and/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calcule le 'and' binaire entre deux BitSets. |
...
|  [BitArray](./bitarray/)(const [bitset](./bitset/)\&) | Constructeur de copie. |
|  [BitArray](./bitarray/)(const [BitArray](./)\&) | Constructeur de copie. |
|  [BitArray](./bitarray/)(const [BitArrayPtr](../bitarrayptr/)\&) | Constructeur de copie. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**bool**\>\&) | Constructeur de copie. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<**uint8_t**\>\&) | Constructeur de copie. |
|  [BitArray](./bitarray/)(const [System::ArrayPtr](../../system/arrayptr/)\<int\>\&) | Constructeur de copie. |
...
| **bool** [Contains](./contains/)(const **bool**\&) const override | Vérifie si une valeur spécifique est présente dans le conteneur. Non implémenté. |
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<**bool**\>, int) override | Copie les données vers les éléments existants du tableau. |
| [bitset](./bitset/)\& [data](./data/)() | Accès à la structure de données sous-jacente. |
| const [bitset](./bitset/)\& [data](./data/)() const | Accès à la structure de données sous-jacente. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison flottante de style C# où deux NaN sont considérés comme égaux bien que, selon IEC 60559:1989, NaN ne soit égal à aucune valeur, y compris NaN. |
| static **bool** [Equals](../../system/object/equals/)(**double** const\&, **double** const\&) | Émule la comparaison flottante de style C# où deux NaN sont considérés comme égaux bien que, selon IEC 60559:1989, NaN ne soit égal à aucune valeur, y compris NaN. |
| virtual **bool** [FastCast](../../system/object/fastcast/)(const Details::FastRttiBase\&, void **) const | À usage interne uniquement. |
| **bool** [Get](./get/)(int) const | Obtient l'élément [BitArray](./). |
| int [get_Count](./get_count/)() const override | Obtient la taille du conteneur. |
...
| int [get_Length](./get_length/)() const | Obtient la taille du conteneur. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<**bool**\>\> [GetEnumerator](./getenumerator/)() override | Crée un objet énumérateur. |
...
| **bool** [idx_get](./idx_get/)(int) const | Fonction d'accès (getter). |
| void [idx_set](./idx_set/)(int, **bool**) | Fonction de modification (setter). |
...
| [BitArrayPtr](../bitarrayptr/) [Not](./not/)() | Négatif BitSet. |
...
| **bool** [operator!=](./operator_not_equal/)(const [BitArray](./)\&) const | Opérateur de comparaison bit à bit. |
...
| **bool** [operator==](./operator_equal_equal/)(const [BitArray](./)\&) const | Opérateur de comparaison bit à bit. |
| **Reference** [operator[]](./operator[]/)(int) | Fonction d'accès. |
| [BitArrayPtr](../bitarrayptr/) [Or](./or/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calcule le 'or' binaire entre deux BitSets. |
...
| **bool** [Remove](./remove/)(const **bool**\&) override | Renvoie la première occurrence de la valeur spécifiée. Non implémenté. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées du nombre spécifié. |
| void [Set](./set/)(int, **bool**) | Définit l'élément [BitArray](./). |
| void [SetAll](./setall/)(**bool**) | Définit tous les éléments à une valeur spécifique. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Implémentation formelle du mécanisme d'arguments de modèle faible ; non applicable à cette classe. |
...
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginConstIterator](./virtualizebeginconstiterator/)() const override | Obtient l'implémentation de l'itérateur const begin pour le conteneur actuel. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeBeginIterator](./virtualizebeginiterator/)() override | Obtient l'implémentation de l'itérateur begin pour le conteneur actuel. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndConstIterator](./virtualizeendconstiterator/)() const override | Obtient l'implémentation de l'itérateur const end pour le conteneur actuel. |
| System::Details::VirtualizedIteratorBase\<**bool**\> * [virtualizeEndIterator](./virtualizeenditerator/)() override | Obtient l'implémentation de l'itérateur end pour le conteneur actuel. |
...
| [BitArrayPtr](../bitarrayptr/) [Xor](./xor/)(const [BitArrayPtr](../bitarrayptr/)\&) | Calcule le 'xor' binaire entre deux BitSets. |
...
| Typedef | Description |
| --- | --- |
| [bitset](./bitset/) | Type de données sous-jacent. |
