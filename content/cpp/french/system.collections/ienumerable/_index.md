...
description: IEnumerable est l'interface de base pour toutes les collections non génériques qui peuvent être énumérées.
type: docs
weight: 53
url: /fr/system.collections/ienumerable/
---
## IEnumerable classe
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](./getenumerator/)() | Renvoie un énumérateur qui parcourt une collection. |
