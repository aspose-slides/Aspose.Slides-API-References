...
description: Définit une interface de collection non générique.
type: docs
weight: 40
url: /fr/system.collections/icollection/
---
## classe ICollection

Définit une interface de collection non générique.
...
| virtual [SharedPtr](../../system/sharedptr/)\<[System::Collections::IEnumerator](../ienumerator/)\> [GetEnumerator](../ienumerable/getenumerator/)() | Renvoie un itérateur qui parcourt la collection. |
