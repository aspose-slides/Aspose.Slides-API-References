...
type: docs
weight: 53
url: /fr/system.net.http.headers/entitytagheadervalue/
---
## EntityTagHeaderValue classe
...
| Méthode | Description |
| --- | --- |
|  [EntityTagHeaderValue](./entitytagheadervalue/)([String](../../system/string/)) | Construit une nouvelle instance. |
|  [EntityTagHeaderValue](./entitytagheadervalue/)([String](../../system/string/), **bool**) | Construit une nouvelle instance. |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\> [get_Any](./get_any/)() | Obtient une valeur de l'en-tête 'ETag'. |
| **bool** [get_IsWeak](./get_isweak/)() | Obtient une valeur indiquant si l'instance actuelle est un validateur faible. |
| [String](../../system/string/) [get_Tag](./get_tag/)() | Obtient une représentation sous forme de chaîne d'une instance de EntityTagHeaderValue-classe. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l'objet. |
| static **int32_t** [GetEntityTagLength](./getentitytaglength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\>\&) | Convertit une chaîne passée depuis l'index spécifié en une instance de la classe [EntityTagHeaderValue](./). |
...
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il initialise simplement le nouvel objet et permet la copie de construction des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il initialise simplement le nouvel objet et permet la copie de construction des sous-classes. |
| static [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Convertit une chaîne passée en une instance de la classe [EntityTagHeaderValue](./). |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](./)\>\&) | Tente de convertir une chaîne passée en une instance de la classe [EntityTagHeaderValue](./). |
