...
description: "Représente la collection des valeurs des en-têtes. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction System::MakeObject(). Ne créez jamais d’instance de ce type sur la pile ou avec l’opérateur new, car cela entraînera des erreurs d’exécution et/ou des violations d’assertion. Enveloppez toujours cette classe dans un pointeur System::SmartPtr et utilisez ce pointeur pour le passer aux fonctions en tant qu’argument."
type: docs
weight: 92
url: /fr/system.net.http.headers/httpheadervaluecollection/
---
## HttpHeaderValueCollection classe

Représente la collection des valeurs d’en-tête. Les objets de cette classe ne doivent être alloués qu’en utilisant la fonction [System::MakeObject()](../../system/makeobject/). Ne créez jamais d’instance de ce type sur la pile ou en utilisant l’opérateur new, car cela entraînera des erreurs d’exécution et/ou des violations d’assertion. Enveloppez toujours cette classe dans un pointeur [System::SmartPtr](../../system/smartptr/) et utilisez ce pointeur pour le transmettre aux fonctions en tant qu’argument.
...
| --- | --- |
| The | type des valeurs d’en-tête représentées dans la collection. |

## Méthodes

| Méthode | Description |
| --- | --- |
| void [Add](./add/)(const T\&) override | Ajoute un élément à la collection. |
...
| void [CopyTo](./copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, **int32_t**) override | Copie tous les éléments de la collection dans les éléments d’un tableau existant. |
| virtual void [CopyTo](../../system.collections.generic/icollection/copyto/)([System::ArrayPtr](../../system/arrayptr/)\<T\>, int) | Copie tous les éléments de la collection dans les éléments d’un tableau existant. |
...
| **bool** [get_IsReadOnly](./get_isreadonly/)() | Obtient une valeur indiquant si la collection actuelle est en lecture seule. |
...
| **bool** [get_IsSpecialValueSet](./get_isspecialvalueset/)() | Obtient une valeur indiquant si la collection actuelle contient une « valeur spéciale ». |
| [SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\> [get_SyncRoot](../../system.collections.generic/icollection/get_syncroot/)() const | Obtient l’objet par lequel la collection est synchronisée. |
| Detail::SmartPtrCounter * [GetCounter](../../system/object/getcounter/)() | Obtient la structure de données du compteur de références associée à l’objet. |
| [System::SharedPtr](../../system/sharedptr/)\<[Collections::Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](./getenumerator/)() override | Obtient l’énumérateur. |
| virtual **int32_t** [GetHashCode](../../system/object/gethashcode/)() const | Analogue de la méthode C# [Object.GetHashCode()](../../system/object/gethashcode/). Permet le hachage d’objets personnalisés. |
| [String](../../system/string/) [GetHeaderStringWithoutSpecial](./getheaderstringwithoutspecial/)() | Renvoie une représentation sous forme de chaîne de la collection actuelle sans « valeur spéciale ». |
| virtual const [TypeInfo](../../system/typeinfo/)\& [GetType](../../system/object/gettype/)() const | Obtient le type réel de l’objet. Analogue de l’appel C# [System.Object.GetType()](../../system/object/gettype/). |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>) | Construit une nouvelle instance. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Construit une nouvelle instance. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T) | Construit une nouvelle instance. |
|  [HttpHeaderValueCollection](./httpheadervaluecollection/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[HttpHeaders](../httpheaders/)\>, T, [Action](../../system/action/)\<[System::SharedPtr](../../system/sharedptr/)\<[HttpHeaderValueCollection](./)\<T\>\>, T\>) | Construit une nouvelle instance. |
...
| void [ParseAdd](./parseadd/)([String](../../system/string/)) | Analyse une représentation de chaîne d’en-tête et l’ajoute à la collection actuelle. |
...
| **bool** [Remove](./remove/)(const T\&) override | Supprime l’élément de la collection. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées du nombre spécifié. |
| void [RemoveSpecialValue](./removespecialvalue/)() | Supprime une « valeur spéciale ». |
| void [SetSpecialValue](./setspecialvalue/)() | Définit une « valeur spéciale ». |
...
| **bool** [TryParseAdd](./tryparseadd/)([String](../../system/string/)) | Tente d’analyser une représentation de chaîne d’en-tête et de l’ajouter à la collection actuelle. |
