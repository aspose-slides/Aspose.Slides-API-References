...
type: docs
weight: 235
url: /fr/system.net.http.headers/rangeconditionheadervalue/
---
...
| [Nullable](../../system/nullable/)\<[DateTimeOffset](../../system/datetimeoffset/)\> [get_Date](./get_date/)() | Renvoie une valeur de date. |
| [System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](../entitytagheadervalue/)\> [get_EntityTag](./get_entitytag/)() | Renvoie une valeur d'en-tête 'ETag'. |
...
| static **int32_t** [GetRangeConditionLength](./getrangeconditionlength/)([String](../../system/string/), **int32_t**, [System::SharedPtr](../../system/sharedptr/)\<[Object](../../system/object/)\>\&) | Convertit une chaîne transmise depuis l'index spécifié en une instance de la classe [RangeConditionHeaderValue](./). |
...
| static [System::SharedPtr](../../system/sharedptr/)\<[RangeConditionHeaderValue](./)\> [Parse](./parse/)([String](../../system/string/)) | Convertit une chaîne transmise en une instance de la classe [RangeConditionHeaderValue](./). |
| [RangeConditionHeaderValue](./rangeconditionheadervalue/)([DateTimeOffset](../../system/datetimeoffset/)) | Construit une nouvelle instance. |
| [RangeConditionHeaderValue](./rangeconditionheadervalue/)([System::SharedPtr](../../system/sharedptr/)\<[EntityTagHeaderValue](../entitytagheadervalue/)\>) | Construit une nouvelle instance. |
| [RangeConditionHeaderValue](./rangeconditionheadervalue/)([String](../../system/string/)) | Construit une nouvelle instance. |
...
| static **bool** [TryParse](./tryparse/)([String](../../system/string/), [System::SharedPtr](../../system/sharedptr/)\<[RangeConditionHeaderValue](./)\>\&) | Essaie de convertir une chaîne transmise en une instance de la classe [RangeConditionHeaderValue](./). |
