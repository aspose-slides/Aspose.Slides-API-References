...
description: Représente la collection des objets.
type: docs
weight: 196
url: /fr/system.net.http.headers/objectcollection/
---
## classe ObjectCollection
...
| Méthode | Description |
| --- | --- |
| void [Add](../../system.collections.objectmodel/collection/add/)(const T&) override | Ajoute une valeur au conteneur. |
...
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [begin](../../system.collections.generic/ienumerable/begin/)() const | Obtient un itérateur pointant sur le premier élément (le cas échéant) de l'instance const-qualified de la collection. |
| [const_iterator](../../system.collections.generic/ienumerable/const_iterator/) [cbegin](../../system.collections.generic/ienumerable/cbegin/)() const | Obtient un itérateur pointant sur le premier élément const-qualified (le cas échéant) de la collection. |
...
| void [Clear](../../system.collections.objectmodel/collection/clear/)() override | Supprime tous les éléments. |
| [Collection](../../system.collections.objectmodel/collection/collection/)() | Crée une collection vide. |
...
| **bool** [Contains](../../system.collections.objectmodel/collection/contains/)(const T&) const override | Vérifie si l'élément est présent dans la collection. |
| void [CopyTo](../../system.collections.objectmodel/collection/copyto/)([ArrayPtr](../../system/arrayptr/)\<T\>, int) override | Copie les éléments de la collection dans les éléments d'un tableau existant. |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [crbegin](../../system.collections.objectmodel/collection/crbegin/)() const | Obtient un itérateur inverse vers le dernier élément const-qualified de la collection (premier en ordre inverse). |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [crend](../../system.collections.objectmodel/collection/crend/)() const | Obtient un itérateur inverse pour un élément const-qualified inexistant avant le début de la collection. |
...
| int [get_Count](../../system.collections.objectmodel/collection/get_count/)() const override | Obtient le nombre d'éléments. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IList](../../system.collections.generic/ilist/)\<T\>\> [get_Items](../../system.collections.objectmodel/collection/get_items/)() | Accesseur de la structure de données interne. |
| const [Generic::ListPtr](../../system.collections.generic/listptr/)\<T\> [get_Items](../../system.collections.objectmodel/collection/get_items/)() const | Accesseur de la structure de données interne. |
...
| [SharedPtr](../../system/sharedptr/)\<[Generic::IEnumerator](../../system.collections.generic/ienumerator/)\<T\>\> [GetEnumerator](../../system.collections.objectmodel/collection/getenumerator/)() override | Obtient un énumérateur pour parcourir la collection. |
...
| T [idx_get](../../system.collections.objectmodel/collection/idx_get/)(int) const override | Obtient la valeur à l'index spécifié. |
| void [idx_set](../../system.collections.objectmodel/collection/idx_set/)(int, T) override | Définit la valeur à l'index spécifié. |
| int [IndexOf](../../system.collections.objectmodel/collection/indexof/)(const T&) const override | Recherche un élément dans la collection. |
| void [Insert](../../system.collections.objectmodel/collection/insert/)(int, const T&) override | Insère un élément à la position spécifiée. |
...
| [ObjectCollection](./objectcollection/)() | Construit une nouvelle instance. |
| [ObjectCollection](./objectcollection/)([Action](../../system/action/)\<T\>) | Construit une nouvelle instance. |
...
| T\& [operator[]](../../system.collections.objectmodel/collection/operator[]/)(int) | Obtient la valeur à l'index spécifié. |
| const T\& [operator[]](../../system.collections.objectmodel/collection/operator[]/)(int) const | Obtient la valeur à l'index spécifié. |
| [reverse_iterator](../../system.collections.objectmodel/collection/reverse_iterator/) [rbegin](../../system.collections.objectmodel/collection/rbegin/)() | Obtient un itérateur inverse vers le dernier élément de la collection (premier en ordre inverse). |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [rbegin](../../system.collections.objectmodel/collection/rbegin/)() const | Obtient un itérateur inverse vers le dernier élément de la collection const-qualified (premier en ordre inverse). |
...
| **bool** [Remove](../../system.collections.objectmodel/collection/remove/)(const T&) override | Supprime un élément spécifique. |
| void [RemoveAt](../../system.collections.objectmodel/collection/removeat/)(int) override | Supprime l'élément à la position spécifiée. |
| int [RemovedSharedRefs](../../system/object/removedsharedrefs/)(int) | Diminue le compteur de références partagées de la valeur spécifiée. |
| [reverse_iterator](../../system.collections.objectmodel/collection/reverse_iterator/) [rend](../../system.collections.objectmodel/collection/rend/)() | Obtient un itérateur inverse pour un élément inexistant avant le début de la collection. |
| [const_reverse_iterator](../../system.collections.objectmodel/collection/const_reverse_iterator/) [rend](../../system.collections.objectmodel/collection/rend/)() const | Obtient un itérateur inverse pour un élément inexistant avant le début de la collection const-qualified. |
| void [SetTemplateWeakPtr](./settemplateweakptr/)(**uint32_t**) override | Définit le nième argument de modèle comme pointeur faible (plutôt que partagé). Permet de passer les pointeurs des conteneurs en mode faible. |
...
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginConstIterator](../../system.collections.objectmodel/collection/virtualizebeginconstiterator/)() const override | Obtient l'implémentation de l'itérateur begin const pour le conteneur actuel. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeBeginIterator](../../system.collections.objectmodel/collection/virtualizebeginiterator/)() override | Obtient l'implémentation de l'itérateur begin pour le conteneur actuel. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndConstIterator](../../system.collections.objectmodel/collection/virtualizeendconstiterator/)() const override | Obtient l'implémentation de l'itérateur end const pour le conteneur actuel. |
| System::Details::VirtualizedIteratorBase\<T\> * [virtualizeEndIterator](../../system.collections.objectmodel/collection/virtualizeenditerator/)() override | Obtient l'implémentation de l'itérateur end pour le conteneur actuel. |
