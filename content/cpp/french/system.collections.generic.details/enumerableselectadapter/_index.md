...
description: Enumerable utilisé par la méthode d'extension IEnumerable.Select().
type: docs
weight: 14
url: /fr/system.collections.generic.details/enumerableselectadapter/
---
## EnumerableSelectAdapter classe

Enumerable utilisé par la méthode d'extension IEnumerable.Select().
...
| [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie rien, en fait, il initialise juste le nouvel objet et permet la construction par copie des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie rien, en fait, il initialise juste le nouvel objet et permet la construction par copie des sous-classes. |
