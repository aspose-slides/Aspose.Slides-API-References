...
description: Énumérateur utilisé par la méthode d'extension IEnumerable.Select().
type: docs
weight: 79
url: /fr/system.collections.generic.details/enumeratorselectadapter/
---
## EnumeratorSelectAdapter classe

Énumérateur utilisé par la méthode d'extension IEnumerable.Select().
...
| **bool** [MoveNext](./movenext/)() override | Déplace l'énumérateur vers l'élément suivant. Si aucun élément n'avait été référencé auparavant, établit la référence sur le premier élément disponible. Si la fin du conteneur est atteinte, ne fait rien. |
