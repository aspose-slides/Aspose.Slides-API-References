...
type: docs
weight: 105
url: /fr/system.collections.generic.details/enumeratorselectmanyadapter/
---
## EnumeratorSelectManyAdapter classe
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Déplace l'itérateur d'un pas vers l'avant. |
...
| **bool** [MoveNext](./movenext/)() override | Déplace l'énumérateur vers l'élément suivant. Si aucun élément n'avait été référencé auparavant, définit la référence sur le premier élément disponible. Si la fin du conteneur est atteinte, ne fait rien. |
