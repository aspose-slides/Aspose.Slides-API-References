...
description: Énumérateur utilisé par la méthode d'extension IEnumerable.Cast().
type: docs
weight: 53
url: /fr/system.collections.generic.details/enumeratorcastadapter/
---
## EnumeratorCastAdapter classe

Énumérateur utilisé par la méthode d'extension IEnumerable.Cast().
...
| --- | --- |
| Source | Le type source des éléments de la collection. |
| Result | Le type résultat des éléments de la collection. |

## Méthodes

| Méthode | Description |
| --- | --- |
| [IEnumerator](../../system.collections.generic/ienumerator/) * [AsVirtualizedIterator](../../system.collections.generic/ienumerator/asvirtualizediterator/)() | Prépare l'itérateur pour être utilisé par la classe VirtualizedIterator. |
...
| static **bool** [Equals](../../system/object/equals/)(**float** const\&, **float** const\&) | Émule la comparaison de nombres flottants à la C# où deux NaN sont considérés comme égaux même si, selon IEC 60559:1989, NaN n'est égal à aucune valeur, y compris NaN. |
...
| [MakeConstRef_t](../../system/makeconstref_t/)\<Result\> [get_Current](./get_current/)() const override | Obtient l'élément actuel. |
...
| void [MarkOwnedByVirtualizedIterator](../../system.collections.generic/ienumerator/markownedbyvirtualizediterator/)() | Marque l'énumérateur appartenant à l'itérateur virtualisé. |
| virtual [ptr](../../system/object/ptr/) [MemberwiseClone](../../system/object/memberwiseclone/)() const | Analogue de la méthode C# [Object.MemberwiseClone()](../../system/object/memberwiseclone/). Permet le clonage de types personnalisés. |
| **bool** [MoveNext](./movenext/)() override | Déplace l'énumérateur vers l'élément suivant. Si aucun élément n'était référencé auparavant, définit la référence sur le premier élément disponible. Si la fin du conteneur est atteinte, ne fait rien. |
|  [Object](../../system/object/object/)() | Crée l'objet. Initialise toutes les structures de données internes. |
|  [Object](../../system/object/object/)([Object](../../system/object/) const\&) | Constructeur de copie. Ne copie réellement rien, initialise simplement un nouvel objet et permet la construction de copies des sous-classes. |
| [Object](../../system/object/)\& [operator=](../../system/object/operator_equal/)([Object](../../system/object/) const\&) | Opérateur d'affectation. Ne copie réellement rien, initialise simplement un nouvel objet et permet la construction de copies des sous-classes. |
...
| void [Reset](./reset/)() override | Réinitialise l'énumérateur à la position avant le premier élément. |
