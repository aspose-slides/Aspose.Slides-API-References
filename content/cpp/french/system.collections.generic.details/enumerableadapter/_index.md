...
description: Enumerable utilisé par les méthodes d'extension IEnumerable.Cast() et IEnumerable.OfType().
type: docs
weight: 1
url: /fr/system.collections.generic.details/enumerableadapter/
---
## EnumerableAdapter classe

Enumerable utilisé par les méthodes d'extension IEnumerable.Cast() et IEnumerable.OfType().
...
| EnumeratorAdapter | Le type de l'adaptateur d'énumérateur. |
