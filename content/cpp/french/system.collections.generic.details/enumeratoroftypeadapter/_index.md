...
description: Énumérateur utilisé par la méthode d'extension IEnumerable.OfType().
type: docs
weight: 66
url: /fr/system.collections.generic.details/enumeratoroftypeadapter/
---
## EnumeratorOfTypeAdapter classe


Énumérateur utilisé par la méthode d'extension IEnumerable.OfType().
...
| void [IncrementIterator](../../system.collections.generic/ienumerator/incrementiterator/)() override | Avance l'itérateur d'un pas. |
| void [InitializeIterator](../../system.collections.generic/ienumerator/initializeiterator/)() override | Effectue le premier appel [MoveNext()](../../system.collections.generic/ienumerator/movenext/) et prépare l'objet énumérateur pour être utilisé par VirtualizedIterator. |
...
| **bool** [MoveNext](./movenext/)() override | Déplace l'énumérateur vers l'élément suivant. Si aucun élément n'avait été référencé auparavant, définit la référence au premier élément disponible. Si la fin du conteneur est atteinte, ne fait rien. |
...
| void [Reset](./reset/)() override | Réinitialise l'énumérateur à la position précédant le premier élément. |
